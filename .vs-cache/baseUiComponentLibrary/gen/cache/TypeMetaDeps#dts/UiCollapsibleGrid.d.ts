// TypeScript definitions for the C3 type UiCollapsibleGrid

/**
 * A component focused on visualizing a spreadsheet.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiCollapsibleGrid
 */
declare interface IUiCollapsibleGrid {
 ...
 */
declare class UiCollapsibleGrid extends Obj  {

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): UiCollapsibleGrid;

  /**
   * Unique identifier for the logical object that instance of this type represents.
   */
  readonly id?: string;
  withId(id: string | null): UiCollapsibleGrid;

  /**
   * The name of the component. Optional field for informational purposes only.
   */
  readonly name?: string;
  withName(name: string | null): UiCollapsibleGrid;

  /**
   * The specification used for retrieving data displayed by the component.
   */
  readonly dataSpec?: UiCollapsibleGridDataSpec;
  withDataSpec(dataSpec: IUiCollapsibleGridDataSpec | null): UiCollapsibleGrid;

  /**
   * Disable if you want to avoid sending any and all requests for this component on first render.
   */
  readonly disableDataRequestOnFirstRender?: boolean;
  withDisableDataRequestOnFirstRender(disableDataRequestOnFirstRender: boolean): UiCollapsibleGrid;

  /**
   * Whether the effect triggers and epics have been registered
   */
  readonly triggersRegistered?: boolean;
  withTriggersRegistered(triggersRegistered: boolean): UiCollapsibleGrid;

  /**
   * Whether to wrap the component with a div which has a class name of its metdata id. Useful for targeting with css.
   */
  readonly wrapWithMetadataId?: boolean;
  withWrapWithMetadataId(wrapWithMetadataId: boolean): UiCollapsibleGrid;

  /**
   * The component header.
   */
  readonly header?: UiSdlComponentTitle;
  withHeader(header: IUiSdlComponentTitle | null): UiCollapsibleGrid;

  /**
   * The empty state for this component.
   */
  readonly emptyState?: UiSdlEmptyState;
  withEmptyState(emptyState: IUiSdlEmptyState | null): UiCollapsibleGrid;

  /**
   * Holds the data for the component.
   */
  readonly componentData?: UiCollapsibleGridTree;
  withComponentData(componentData: IUiCollapsibleGridTree | null): UiCollapsibleGrid;

  /**
   * Whether numerical data that are zero-valued should be hidden.
   */
  readonly hideZeroValuedData?: boolean;
  withHideZeroValuedData(hideZeroValuedData: boolean): UiCollapsibleGrid;

  /**
   * Whether grouping should be collapsible.
   */
  readonly groupCollapsible?: boolean;
  withGroupCollapsible(groupCollapsible: boolean): UiCollapsibleGrid;

  /**
   * If {@link groupCollapsible} is true, whether groups should be expanded on first render.
   */
  readonly expandGroupsOnFirstRender?: boolean;
  withExpandGroupsOnFirstRender(expandGroupsOnFirstRender: boolean): UiCollapsibleGrid;

  /**
   * Whether the data should be exportable.
   */
  readonly exportable?: boolean;
  withExportable(exportable: boolean): UiCollapsibleGrid;
  ...
  withExportableFlattened(exportableFlattened: boolean): UiCollapsibleGrid;

  /**
   * The number of rows from the top that should be sticky.
   */
  readonly stickyTopRowsNum?: number;
  withStickyTopRowsNum(stickyTopRowsNum: number | null): UiCollapsibleGrid;
  ...
  withStickyLeftColumnsNum(stickyLeftColumnsNum: number | null): UiCollapsibleGrid;
  ...
  withStickyRightColumnsNum(stickyRightColumnsNum: number | null): UiCollapsibleGrid;

  /**
   * Specifies whether checkboxes will be prepended to each row in the grid.
   */
  readonly checkboxes?: boolean;
  withCheckboxes(checkboxes: boolean): UiCollapsibleGrid;
  ...
  withSelectedRows(selectedRows: Array_Type<UiCollapsibleGridTreeNode> | Array<IUiCollapsibleGridTreeNode> | null): UiCollapsibleGrid;
  ...
  withDetectAllSelectedRows(detectAllSelectedRows: boolean): UiCollapsibleGrid;
  ...
  withAvailableViewportHeightReduction(availableViewportHeightReduction: number | null): UiCollapsibleGrid;
  ...
  withAvailableViewportWidthReduction(availableViewportWidthReduction: number | null): UiCollapsibleGrid;

  /**
   * Additional css stylings applied to the css-collapsible-grid element. Write with semicolons; i.e. "margin: 20px;"
   */
  readonly additionalGridStyling?: string;
  withAdditionalGridStyling(additionalGridStyling: string | null): UiCollapsibleGrid;
  ...
  withSpreadsheetMaxHeight(spreadsheetMaxHeight: number | null): UiCollapsibleGrid;
  ...
  withWidthSiblingSelectors(widthSiblingSelectors: Array_Type<string> | Array<string> | null): UiCollapsibleGrid;
  ...
  withHeightSiblingSelectors(heightSiblingSelectors: Array_Type<string> | Array<string> | null): UiCollapsibleGrid;

  /**
   * Element(s) in dom which are observed for changes that might require a rerender of spreadsheet width/height
   */
  readonly rerenderSiblingSelectors?: Array_Type<string>;
  withRerenderSiblingSelectors(rerenderSiblingSelectors: Array_Type<string> | Array<string> | null): UiCollapsibleGrid;

  /**
   * Required if using sticky rows. This is the parent selector for the spreadsheet.
   */
  readonly parentSelector?: string;
  withParentSelector(parentSelector: string | null): UiCollapsibleGrid;
  ...
  withSheetActions(sheetActions: Array_Type<UiSdlActionGroup> | Array<IUiSdlActionGroup> | null): UiCollapsibleGrid;
  ...
  withSheetActionsCollapseThreshold(sheetActionsCollapseThreshold: number | null): UiCollapsibleGrid;

  /**
   * Defines whether the context menu should be displayed on right click.
   */
  readonly showContextMenu?: boolean;
  withShowContextMenu(showContextMenu: boolean): UiCollapsibleGrid;
  ...
  withCollapsedRowIds(collapsedRowIds: any | null): UiCollapsibleGrid;

  /**
   * It enables multi-selection with mouse drag/click.
   */
  readonly enableRangeSelection?: boolean;
  withEnableRangeSelection(enableRangeSelection: boolean): UiCollapsibleGrid;
  ...
  withRightClickActions(rightClickActions: Array_Type<UiCollapsibleGridRightClickAction> | Array<IUiCollapsibleGridRightClickAction> | null): UiCollapsibleGrid;
   ...
   * @see #toJson
   */
  static fromJson(json: any): UiCollapsibleGrid | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): UiCollapsibleGrid | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): UiCollapsibleGrid | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): UiCollapsibleGrid | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiCollapsibleGrid;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): UiCollapsibleGrid;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): UiCollapsibleGrid;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<UiCollapsibleGrid>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<UiCollapsibleGrid>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): UiCollapsibleGrid;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiCollapsibleGrid;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiCollapsibleGrid;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiCollapsibleGrid;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiCollapsibleGrid;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiCollapsibleGrid;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): UiCollapsibleGrid;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiCollapsibleGrid;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiCollapsibleGrid;
   ...
   * @see #removeField
   */
  withoutField(field: string): UiCollapsibleGrid;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): UiCollapsibleGrid;
   ...
   */
  withoutFields(fields: Array_Type<string>): UiCollapsibleGrid;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): UiCollapsibleGrid;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiCollapsibleGrid;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): UiCollapsibleGrid;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiCollapsibleGrid;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiCollapsibleGrid;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiCollapsibleGrid;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiCollapsibleGrid;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiCollapsibleGrid;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiCollapsibleGrid;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): UiCollapsibleGrid;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): UiCollapsibleGrid;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): UiCollapsibleGrid;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): UiCollapsibleGrid;

  mergeJson(json: any): UiCollapsibleGrid;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): UiCollapsibleGrid;
   ...
   */
  sumObj(other: Obj, deep?: boolean): UiCollapsibleGrid;
   ...
   */
  singletonArray(): Array_Type<UiCollapsibleGrid>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<UiCollapsibleGrid> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiCollapsibleGrid> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<UiCollapsibleGrid>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiCollapsibleGrid> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, UiCollapsibleGrid> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiCollapsibleGrid> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiCollapsibleGrid>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiCollapsibleGrid>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): UiCollapsibleGrid;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): UiCollapsibleGrid;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): UiCollapsibleGrid;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiCollapsibleGrid;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): UiCollapsibleGrid;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiCollapsibleGrid;
   ...
   * @see #fromString
   */
  static make(s: string): UiCollapsibleGrid | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): UiCollapsibleGrid;
   ...
   */
  static cachedEmptyInst(): UiCollapsibleGrid;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<UiCollapsibleGrid> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): UiCollapsibleGrid;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<UiCollapsibleGrid>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiCollapsibleGrid>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<UiCollapsibleGrid> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<UiCollapsibleGrid>> | null;
   ...
   */
  dependencies(): MetadataDeps<UiCollapsibleGrid>;

  save(subPath?: string, contentType?: string): UiCollapsibleGrid;
  ...
  update(srcObj?: UiCollapsibleGrid, spec?: UpsertSpec): UiCollapsibleGrid | null;

  upsert(srcObj?: UiCollapsibleGrid, spec?: UpsertSpec): UiCollapsibleGrid | null;
   ...
   * @see #toString
   */
  static fromString(s: string): UiCollapsibleGrid | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string, failIfMissing?: boolean): UiCollapsibleGrid | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiCollapsibleGrid, state: UiSdlReduxState): UiCollapsibleGrid | null;
