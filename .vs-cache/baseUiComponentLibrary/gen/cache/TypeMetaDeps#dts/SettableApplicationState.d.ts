// TypeScript definitions for the C3 type SettableApplicationState

/**
 * Application state that provides functions to conveniently set fields and clear fields.
 * If you would like to explicitly define fields or add new functions,
 * create a new type that mixes {@link SettableApplicationState}.
 *
 * @remarks this represents a value passed to a method that expects an instance of SettableApplicationState
 */
declare interface ISettableApplicationState {
 ...
 * create a new type that mixes {@link SettableApplicationState}.
 *
 * @remarks this represents a made instance of SettableApplicationState
 */
declare class SettableApplicationState extends Obj  {

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): SettableApplicationState;

  /**
   * Unique identifier for the logical object that instance of this type represents.
   */
  readonly id?: string;
  withId(id: string | null): SettableApplicationState;

  /**
   * The name of the component. Optional field for informational purposes only.
   */
  readonly name?: string;
  withName(name: string | null): SettableApplicationState;
  ...
  withDataSpec(dataSpec: IUiSdlNoData | null): SettableApplicationState;

  /**
   * Disable if you want to avoid sending any and all requests for this component on first render.
   */
  readonly disableDataRequestOnFirstRender?: boolean;
  withDisableDataRequestOnFirstRender(disableDataRequestOnFirstRender: boolean): SettableApplicationState;

  /**
   * Whether the effect triggers and epics have been registered
   */
  readonly triggersRegistered?: boolean;
  withTriggersRegistered(triggersRegistered: boolean): SettableApplicationState;

  /**
   * Whether to wrap the component with a div which has a class name of its metdata id. Useful for targeting with css.
   */
  readonly wrapWithMetadataId?: boolean;
  withWrapWithMetadataId(wrapWithMetadataId: boolean): SettableApplicationState;

  /**
   * The Redux namespace for the application state to indicate where the application data is stored in the Redux state.
   */
  readonly REDUX_NAMESPACE?: string;
  withREDUX_NAMESPACE(REDUX_NAMESPACE: string | null): SettableApplicationState;

  /**
   * Collection of extra async {@link UiSdlEffectTrigger}.
   */
  readonly effectTriggers?: Array_Type<UiSdlEffectTrigger>;
  withEffectTriggers(effectTriggers: Array_Type<UiSdlEffectTrigger> | Array<IUiSdlEffectTrigger> | null): SettableApplicationState;
   ...
   * @see #toJson
   */
  static fromJson(json: any): SettableApplicationState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): SettableApplicationState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): SettableApplicationState | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): SettableApplicationState | null;
   ...
   */
  replaceType(old: Type, new_: Type): SettableApplicationState;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): SettableApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): SettableApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<SettableApplicationState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<SettableApplicationState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): SettableApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SettableApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SettableApplicationState;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SettableApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SettableApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SettableApplicationState;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): SettableApplicationState;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SettableApplicationState;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SettableApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: string): SettableApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): SettableApplicationState;
   ...
   */
  withoutFields(fields: Array_Type<string>): SettableApplicationState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): SettableApplicationState;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SettableApplicationState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): SettableApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SettableApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SettableApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: string): SettableApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SettableApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: string): SettableApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SettableApplicationState;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): SettableApplicationState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): SettableApplicationState;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): SettableApplicationState;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): SettableApplicationState;

  mergeJson(json: any): SettableApplicationState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): SettableApplicationState;
   ...
   */
  sumObj(other: Obj, deep?: boolean): SettableApplicationState;
   ...
   */
  singletonArray(): Array_Type<SettableApplicationState>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<SettableApplicationState> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SettableApplicationState> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<SettableApplicationState>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SettableApplicationState> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, SettableApplicationState> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SettableApplicationState> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SettableApplicationState>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SettableApplicationState>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): SettableApplicationState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): SettableApplicationState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): SettableApplicationState;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SettableApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): SettableApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SettableApplicationState;
   ...
   * @see #fromString
   */
  static make(s: string): SettableApplicationState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): SettableApplicationState;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SettableApplicationState;
   ...
   */
  static cachedEmptyInst(): SettableApplicationState;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<SettableApplicationState> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): SettableApplicationState;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<SettableApplicationState>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SettableApplicationState>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<SettableApplicationState> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<SettableApplicationState>> | null;
   ...
   */
  dependencies(): MetadataDeps<SettableApplicationState>;

  save(subPath?: string, contentType?: string): SettableApplicationState;
  ...
  update(srcObj?: SettableApplicationState, spec?: UpsertSpec): SettableApplicationState | null;

  upsert(srcObj?: SettableApplicationState, spec?: UpsertSpec): SettableApplicationState | null;
   ...
   * @see #toString
   */
  static fromString(s: string): SettableApplicationState | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string, failIfMissing?: boolean): SettableApplicationState | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: SettableApplicationState, state: UiSdlReduxState): SettableApplicationState | null;
