...
# Python definitions for the C3 type ChipsCellArrangement


class ChipsCellArrangement():
    """
    ...
    ```
    """
    def __init__(self, NONE: Optional[str]=None, SORT: Optional[str]=None, GROUP: Optional[str]=None) -> None: ...
