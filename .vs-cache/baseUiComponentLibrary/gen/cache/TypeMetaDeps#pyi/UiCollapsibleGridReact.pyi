...
from c3.baseUiComponentLibrary.UiCollapsibleGridTreeNode import UiCollapsibleGridTreeNode
...
from c3.baseUiComponentLibrary.UiCollapsibleGridTree import UiCollapsibleGridTree
...
from c3.baseUiComponentLibrary.UiCollapsibleGridRightClickAction import UiCollapsibleGridRightClickAction
from c3.baseUiComponentLibrary.UiCollapsibleGridTreeNodeDatum import UiCollapsibleGridTreeNodeDatum
from c3.platform.UiSdlInitialRenderAction import UiSdlInitialRenderAction
from c3.platform.Expr.CompileOptions import Expr.CompileOptions
from c3.uiComponentLibrary.UiSdlEmptyState import UiSdlEmptyState
from c3.platform.FieldValue import FieldValue
from c3.platform.Obj.MakeSpec import Obj.MakeSpec
from c3.platform.ScanSpec import ScanSpec
from c3.baseUiComponentLibrary.UiCollapsibleGridDataSpec import UiCollapsibleGridDataSpec
from c3.platform.ExistsSpec import ExistsSpec

# Python definitions for the C3 type UiCollapsibleGridReact


class UiCollapsibleGridReact(ReactFunction, UiCollapsibleGrid):
    """
    ...
    dataSpec: Optional[UiCollapsibleGridDataSpec]=None
    """
    ...
    header: Optional[UiSdlComponentTitle]=None
    """
    The component header.
    """

    emptyState: Optional[UiSdlEmptyState]=None
    """
    The empty state for this component.
    """

    componentData: Optional[UiCollapsibleGridTree]=None
    """
    Holds the data for the component.
    """

    hideZeroValuedData: Optional[bool]=None
    """
    Whether numerical data that are zero-valued should be hidden.
    """

    groupCollapsible: Optional[bool]=None
    """
    Whether grouping should be collapsible.
    """

    expandGroupsOnFirstRender: Optional[bool]=None
    """
    ...
    exportableFlattened: Optional[bool]=None
    """
    ...
    stickyTopRowsNum: Optional[int]=None
    """
    The number of rows from the top that should be sticky.
    """

    stickyLeftColumnsNum: Optional[int]=None
    """
    ...
    stickyRightColumnsNum: Optional[int]=None
    """
    ...
    selectedRows: Optional[Array[UiCollapsibleGridTreeNode]]=None
    """
    ...
    detectAllSelectedRows: Optional[bool]=None
    """
    ...
    availableViewportHeightReduction: Optional[int]=None
    """
    ...
    availableViewportWidthReduction: Optional[int]=None
    """
    ...
    widthSiblingSelectors: Optional[Array[str]]=None
    """
    ...
    heightSiblingSelectors: Optional[Array[str]]=None
    """
    ...
    rerenderSiblingSelectors: Optional[Array[str]]=None
    """
    ...
    sheetActions: Optional[Array[UiSdlActionGroup]]=None
    """
    ...
    sheetActionsCollapseThreshold: Optional[int]=None
    """
    ...
    showContextMenu: Optional[bool]=None
    """
    Defines whether the context menu should be displayed on right click.
    """

    collapsedRowIds: Optional[any]=None
    """
    ...
    enableRangeSelection: Optional[bool]=None
    """
    It enables multi-selection with mouse drag/click.
    """

    rightClickActions: Optional[Array[UiCollapsibleGridRightClickAction]]=None
    """
    ...
    """
    def __init__(self, meta: Optional[Meta]=None, id: Optional[str]=None, name: Optional[str]=None, dataSpec: Optional[UiCollapsibleGridDataSpec]=None, disableDataRequestOnFirstRender: Optional[bool]=None, triggersRegistered: Optional[bool]=None, wrapWithMetadataId: Optional[bool]=None, header: Optional[UiSdlComponentTitle]=None, emptyState: Optional[UiSdlEmptyState]=None, componentData: Optional[UiCollapsibleGridTree]=None, hideZeroValuedData: Optional[bool]=None, groupCollapsible: Optional[bool]=None, expandGroupsOnFirstRender: Optional[bool]=None, exportable: Optional[bool]=None, exportableFlattened: Optional[bool]=None, stickyTopRowsNum: Optional[int]=None, stickyLeftColumnsNum: Optional[int]=None, stickyRightColumnsNum: Optional[int]=None, checkboxes: Optional[bool]=None, selectedRows: Optional[Array[UiCollapsibleGridTreeNode]]=None, detectAllSelectedRows: Optional[bool]=None, availableViewportHeightReduction: Optional[int]=None, availableViewportWidthReduction: Optional[int]=None, additionalGridStyling: Optional[str]=None, spreadsheetMaxHeight: Optional[int]=None, widthSiblingSelectors: Optional[Array[str]]=None, heightSiblingSelectors: Optional[Array[str]]=None, rerenderSiblingSelectors: Optional[Array[str]]=None, parentSelector: Optional[str]=None, sheetActions: Optional[Array[UiSdlActionGroup]]=None, sheetActionsCollapseThreshold: Optional[int]=None, showContextMenu: Optional[bool]=None, collapsedRowIds: Optional[any]=None, enableRangeSelection: Optional[bool]=None, rightClickActions: Optional[Array[UiCollapsibleGridRightClickAction]]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[UiCollapsibleGridReact]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[UiCollapsibleGridReact]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[UiCollapsibleGridReact]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[UiCollapsibleGridReact]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> UiCollapsibleGridReact:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> UiCollapsibleGridReact:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> UiCollapsibleGridReact:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[UiCollapsibleGridReact]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[UiCollapsibleGridReact]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> UiCollapsibleGridReact:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> UiCollapsibleGridReact:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> UiCollapsibleGridReact:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> UiCollapsibleGridReact:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> UiCollapsibleGridReact:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> UiCollapsibleGridReact:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> UiCollapsibleGridReact:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> UiCollapsibleGridReact:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> UiCollapsibleGridReact:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> UiCollapsibleGridReact:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> UiCollapsibleGridReact:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> UiCollapsibleGridReact:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> UiCollapsibleGridReact:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> UiCollapsibleGridReact:
    """
    @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> UiCollapsibleGridReact:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> UiCollapsibleGridReact:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> UiCollapsibleGridReact:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> UiCollapsibleGridReact:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> UiCollapsibleGridReact:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> UiCollapsibleGridReact:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> UiCollapsibleGridReact:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> UiCollapsibleGridReact:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> UiCollapsibleGridReact:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> UiCollapsibleGridReact:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> UiCollapsibleGridReact:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> UiCollapsibleGridReact:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> UiCollapsibleGridReact:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> UiCollapsibleGridReact:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[UiCollapsibleGridReact]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[UiCollapsibleGridReact]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[UiCollapsibleGridReact]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[UiCollapsibleGridReact]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[UiCollapsibleGridReact]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, UiCollapsibleGridReact]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, UiCollapsibleGridReact]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[UiCollapsibleGridReact]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[UiCollapsibleGridReact]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> UiCollapsibleGridReact:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> UiCollapsibleGridReact:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> UiCollapsibleGridReact:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> UiCollapsibleGridReact:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> UiCollapsibleGridReact:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> UiCollapsibleGridReact:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[UiCollapsibleGridReact]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> UiCollapsibleGridReact:
    """
    ...
    """
        ...
    def afterMake(self) -> UiCollapsibleGridReact:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> UiCollapsibleGridReact:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[UiCollapsibleGridReact]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> UiCollapsibleGridReact:
    """
    ...
    """
        ...
    @classmethod
    def render(cls, props: UiCollapsibleGridReact=None) -> None:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[UiCollapsibleGridReact]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[UiCollapsibleGridReact]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[UiCollapsibleGridReact]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[UiCollapsibleGridReact]]]:
    """
    ...
    """
        ...
    def dependencies(self) -> MetadataDeps[UiCollapsibleGridReact]:
    """
    Retrieves dependencies to types or other metadata elements for the given instance of metadata.
    """
        ...
    def save(self, subPath: str=None, contentType: str=None) -> UiCollapsibleGridReact:
        ...
    ...
    def removeAll(cls, removeFilter: str=None) -> int:
        ...
    def update(self, srcObj: UiCollapsibleGridReact=None, spec: UpsertSpec=None) -> Union[UiCollapsibleGridReact]:
        ...
    def upsert(self, srcObj: UiCollapsibleGridReact=None, spec: UpsertSpec=None) -> Union[UiCollapsibleGridReact]:
        ...
    @classmethod
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[UiCollapsibleGridReact]:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[UiCollapsibleGridReact]:
    """
    ...
    def jsonify(cls, value: Any=None) -> Union[str]:
        ...
    @classmethod
    def doDataMerge(cls, componentId: str, dataSpecFieldName: str, dataDestinationFieldName: str, props: UiCollapsibleGridReact, state: UiSdlReduxState) -> Union[UiCollapsibleGridReact]:
    """
    ...
    """
        ...
    @classmethod
    def generateRowId(cls, parentId: Any=None, index: Any=None) -> Union[str]:
    """
    ...
    """
        ...
    @classmethod
    def triggerSheetAction(cls, id: str=None, actionSuffix: str=None, args: any=None) -> Union[UiSdlReduxAction[Any]]:
    """
    ...
    """
        ...
    @classmethod
    def selectRowsAction(cls, id: str=None, selectedRows: Array[UiCollapsibleGridTreeNode]=None) -> Union[UiSdlReduxAction[Any]]:
    """
    ...
    """
        ...
    @classmethod
    def rowsSelectReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def clearSelectedRowsAction(cls, id: str) -> Union[UiSdlReduxAction[Any]]:
    """
    ...
    """
        ...
    @classmethod
    def selectedRowsClearReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def triggerCellAction(cls, id: str=None, actionSuffix: str=None, cellData: UiCollapsibleGridTreeNodeDatum=None) -> Union[UiSdlReduxAction[Any]]:
    """
    ...
    """
        ...
    @classmethod
    def clickCellButtonAction(cls, id: str, actionSuffix: str, cellData: UiCollapsibleGridTreeNodeDatum, args: any=None) -> Union[UiSdlReduxAction[Any]]:
    """
    ...
    """
        ...
    @classmethod
    def triggerEditCellAction(cls, id: str, cellData: UiCollapsibleGridTreeNodeDatum) -> UiSdlReduxAction[Any]:
    """
    ...
    """
        ...
    @classmethod
    def triggerDropdownCellAction(cls, id: str, cellData: UiCollapsibleGridTreeNodeDatum) -> UiSdlReduxAction[Any]:
    """
    ...
    """
        ...
    @classmethod
    def updateHeaderAction(cls, id: str=None, header: UiSdlComponentTitle=None) -> Union[UiSdlReduxAction[Any]]:
    """
    ...
    """
        ...
    @classmethod
    def rowVisibilityChangeAction(cls, id: str=None, rowIds: Array[str]=None, level: int=None, expand: bool=None) -> Union[UiSdlReduxAction[Any]]:
    """
    ...
    """
        ...
    @classmethod
    def headerUpdateReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
    ...
    """
        ...
    @classmethod
    def rowVisibilityChangeReducer(cls, state: UiSdlReduxState, action: UiSdlReduxAction[Any]) -> UiSdlReduxState:
    """
