// TypeScript definitions for the C3 type ScheduledTransitionTriggers
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ScheduledTransitionTriggers
 */
declare interface IScheduledTransitionTriggers {
 ...
 */
declare class ScheduledTransitionTriggers extends Obj  {

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun;
  withRun(run: IBatchJobRun | null): ScheduledTransitionTriggers;

  /**
   * previous job executions for this instance
   */
  readonly runs?: Array_Type<BatchJobRun>;
  withRuns(runs: Array_Type<BatchJobRun> | Array<IBatchJobRun> | null): ScheduledTransitionTriggers;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj;
  withOptions(options: IObj | null): ScheduledTransitionTriggers;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): ScheduledTransitionTriggers;
  ...
  withPriority(priority: number | null): ScheduledTransitionTriggers;
  ...
  withDisabled(disabled: boolean): ScheduledTransitionTriggers;
  ...
  withMaxConcurrency(maxConcurrency: number | null): ScheduledTransitionTriggers;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): ScheduledTransitionTriggers;
  ...
  withRunAsUser(runAsUser: boolean): ScheduledTransitionTriggers;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string;
  withNodePool(nodePool: string | null): ScheduledTransitionTriggers;
  ...
  withSkipIfRunning(skipIfRunning: boolean): ScheduledTransitionTriggers;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): ScheduledTransitionTriggers;
  ...
  withTypeIdent(typeIdent: string | null): ScheduledTransitionTriggers;
   ...
   */
  readonly id: string;
  withId(id: string): ScheduledTransitionTriggers;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): ScheduledTransitionTriggers;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): ScheduledTransitionTriggers;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): ScheduledTransitionTriggers;
  ...
  withVersion(version: number | null): ScheduledTransitionTriggers;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): ScheduledTransitionTriggers;
  ...
  withAbortOnError(abortOnError: boolean): ScheduledTransitionTriggers;
   ...
   * @see #toJson
   */
  static fromJson(json: any): ScheduledTransitionTriggers | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ScheduledTransitionTriggers | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ScheduledTransitionTriggers | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ScheduledTransitionTriggers | null;
   ...
   */
  replaceType(old: Type, new_: Type): ScheduledTransitionTriggers;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ScheduledTransitionTriggers;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ScheduledTransitionTriggers;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ScheduledTransitionTriggers>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ScheduledTransitionTriggers>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ScheduledTransitionTriggers;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ScheduledTransitionTriggers;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ScheduledTransitionTriggers;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ScheduledTransitionTriggers;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ScheduledTransitionTriggers;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ScheduledTransitionTriggers;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ScheduledTransitionTriggers;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ScheduledTransitionTriggers;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ScheduledTransitionTriggers;
   ...
   * @see #removeField
   */
  withoutField(field: string): ScheduledTransitionTriggers;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ScheduledTransitionTriggers;
   ...
   */
  withoutFields(fields: Array_Type<string>): ScheduledTransitionTriggers;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ScheduledTransitionTriggers;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ScheduledTransitionTriggers;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ScheduledTransitionTriggers;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ScheduledTransitionTriggers;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ScheduledTransitionTriggers;
   ...
   * @see #removeField
   */
  unsetField(field: string): ScheduledTransitionTriggers;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ScheduledTransitionTriggers;
   ...
   * @see #unsetField
   */
  removeField(field: string): ScheduledTransitionTriggers;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ScheduledTransitionTriggers;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ScheduledTransitionTriggers;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ScheduledTransitionTriggers;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ScheduledTransitionTriggers;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ScheduledTransitionTriggers;

  mergeJson(json: any): ScheduledTransitionTriggers;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ScheduledTransitionTriggers;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ScheduledTransitionTriggers;
   ...
   */
  singletonArray(): Array_Type<ScheduledTransitionTriggers>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ScheduledTransitionTriggers> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ScheduledTransitionTriggers> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ScheduledTransitionTriggers>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ScheduledTransitionTriggers> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ScheduledTransitionTriggers> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ScheduledTransitionTriggers> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ScheduledTransitionTriggers>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ScheduledTransitionTriggers>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ScheduledTransitionTriggers;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ScheduledTransitionTriggers;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ScheduledTransitionTriggers;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ScheduledTransitionTriggers;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ScheduledTransitionTriggers;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ScheduledTransitionTriggers;
   ...
   * @see #fromString
   */
  static make(s: string): ScheduledTransitionTriggers | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ScheduledTransitionTriggers;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ScheduledTransitionTriggers;
   ...
   */
  static cachedEmptyInst(): ScheduledTransitionTriggers;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ScheduledTransitionTriggers> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ScheduledTransitionTriggers;
   ...
   */
  start(options?: ScheduledTransitionsBatchJobOptions): BatchJobStatus | null;
   ...
   */
  cleanup(options?: ScheduledTransitionsBatchJobOptions): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun, BatchJobStatus, ScheduledTransitionsBatchJobOptions> | null;

  failJob(run: JobRun<BatchJobStatusBase>): JobBase<BatchJobRun, BatchJobStatus, ScheduledTransitionsBatchJobOptions> | null;
  ...
  validateStart(options?: ScheduledTransitionsBatchJobOptions): void;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<ScheduledTransitionTriggers>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ScheduledTransitionTriggers>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<ScheduledTransitionTriggers> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<ScheduledTransitionTriggers>> | null;
   ...
   */
  get(include?: string): ScheduledTransitionTriggers | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): ScheduledTransitionTriggers | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ScheduledTransitionTriggers;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): ScheduledTransitionTriggers | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ScheduledTransitionTriggers;
   ...
   * @see #toString
   */
  static fromString(s: string): ScheduledTransitionTriggers | null;
   ...
   */
  create(spec?: UpsertSpec): ScheduledTransitionTriggers | null;
   ...
   */
  static createBatch(objs: Array_Type<ScheduledTransitionTriggers>, spec?: UpsertSpec): ObjList<ScheduledTransitionTriggers> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ScheduledTransitionTriggers>, spec?: CreateBatchObjStreamSpec): ObjList<ScheduledTransitionTriggers> | null;
   ...
   */
  update(srcObj?: ScheduledTransitionTriggers, spec?: UpsertSpec): ScheduledTransitionTriggers | null;
   ...
   */
  upsert(srcObj?: ScheduledTransitionTriggers, spec?: UpsertSpec): ScheduledTransitionTriggers | null;
   ...
   */
  merge(spec?: MergeSpec): ScheduledTransitionTriggers | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): ScheduledTransitionTriggers | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): ScheduledTransitionTriggers | null;
   ...
   */
  static updateBatch(objs: Array_Type<ScheduledTransitionTriggers>, srcObjs?: Array_Type<ScheduledTransitionTriggers>, spec?: UpsertSpec): ObjList<ScheduledTransitionTriggers> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<ScheduledTransitionTriggers> | null>, spec?: UpsertSpec): ObjList<ScheduledTransitionTriggers> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<ScheduledTransitionTriggers>, srcObjs?: Array_Type<ScheduledTransitionTriggers>, spec?: UpsertSpec): ObjList<ScheduledTransitionTriggers> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<ScheduledTransitionTriggers> | null>, spec?: UpsertSpec): ObjList<ScheduledTransitionTriggers> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<ScheduledTransitionTriggers>, spec?: TouchSpec): ObjList<ScheduledTransitionTriggers> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ScheduledTransitionTriggers>, spec?: MergeSpec): ObjList<ScheduledTransitionTriggers> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<ScheduledTransitionTriggers>, mergeInclude: string, spec?: MergeSpec): ObjList<ScheduledTransitionTriggers> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<ScheduledTransitionTriggers> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<ScheduledTransitionTriggers> | null;
   ...
   */
  static mergeAll(mergeObj: ScheduledTransitionTriggers, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ScheduledTransitionTriggers, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<ScheduledTransitionTriggers>, spec?: UpsertSpec): ObjList<ScheduledTransitionTriggers> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<ScheduledTransitionTriggers>, spec?: UpsertSpec): ObjList<ScheduledTransitionTriggers> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ScheduledTransitionTriggers | null;
   ...
   */
  static beforeCreate(objs: Array_Type<ScheduledTransitionTriggers>): ObjList<ScheduledTransitionTriggers>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<ScheduledTransitionTriggers>): ObjList<ScheduledTransitionTriggers>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<ScheduledTransitionTriggers>): ObjList<ScheduledTransitionTriggers>;
   ...
   */
  static afterCreate(objs: Array_Type<ScheduledTransitionTriggers>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<ScheduledTransitionTriggers>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<ScheduledTransitionTriggers>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<ScheduledTransitionTriggers>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<ScheduledTransitionTriggers>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): ScheduledTransitionTriggers | null;
   ...
   */
  withoutIdentity(): ScheduledTransitionTriggers | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<ScheduledTransitionTriggers>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: ScheduledTransitionTriggers, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<ScheduledTransitionTriggers>, callback?: λFunction<ScheduledTransitionTriggers | null, ScheduledTransitionTriggers | null>): ObjList<ScheduledTransitionTriggers>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<ScheduledTransitionTriggers>, callback?: λFunction<ScheduledTransitionTriggers | null, ScheduledTransitionTriggers | null>): Array_Type<ObjError> | null;
   ...
   * @inheritdoc
   */
  static doStart(job?: ScheduledTransitionTriggers, options?: ScheduledTransitionsBatchJobOptions): void;

  /**
   * @inheritdoc
   */
  static processBatch(batch?: ScheduledTransitionsBatchJobBatch, job?: ScheduledTransitionTriggers, options?: ScheduledTransitionsBatchJobOptions): void;
   ...
   */
  static allComplete(job: ScheduledTransitionTriggers, options?: ScheduledTransitionsBatchJobOptions): string | null;
   ...
   *           Options the job was run with.
   */
  static failed(job: ScheduledTransitionTriggers, status: BatchJobStatus, options?: ScheduledTransitionsBatchJobOptions): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: ScheduledTransitionsBatchJobBatch): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: Array_Type<ScheduledTransitionsBatchJobBatch>): void;
   ...
   */
  static scheduleObjBatch(job?: ScheduledTransitionTriggers, objBatch?: ObjBatch, logPrefix?: string): number | null;
   ...
   */
  static startJob(options: ScheduledTransitionsBatchJobOptions): ScheduledTransitionTriggers;
}
