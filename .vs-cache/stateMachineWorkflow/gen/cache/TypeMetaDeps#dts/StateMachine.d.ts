// TypeScript definitions for the C3 type StateMachine

/**
 * Abstract Type representing a state machine.
 *
 * @remarks this represents a value passed to a method that expects an instance of StateMachine
 */
declare interface IStateMachine<SMH, SMS, SMT> {
 ...
 */
declare class StateMachine<SMH, SMS, SMT> extends Obj  {
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): StateMachine;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): StateMachine;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): StateMachine;
  ...
  withVersion(version: number | null): StateMachine;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): StateMachine;

  /**
   * A stored calc field representing the current state - uses a {@link StateMachineHistory} to keep track.
   */
  readonly currentState?: SMS;
  withCurrentState(currentState: SMS | null): StateMachine;

  /**
   * A collection of the states this {@link StateMachine} has passed through.
   */
  readonly stateHistories?: Array_Type<SMH>;
  withStateHistories(stateHistories: Array_Type<SMH> | Array<SMH> | null): StateMachine;

  /**
   * Transitions available from the current state
   */
  readonly transitions?: Array_Type<SMT>;
  withTransitions(transitions: Array_Type<SMT> | Array<SMT> | null): StateMachine;

  /**
   * Calc field to get the current state history
   */
  readonly currentStateHistory?: SMH;
  withCurrentStateHistory(currentStateHistory: SMH | null): StateMachine;
   ...
   * @see #toJson
   */
  static fromJson(json: any): StateMachine<SMH, SMS, SMT> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): StateMachine<SMH, SMS, SMT> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): StateMachine<SMH, SMS, SMT> | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): StateMachine<SMH, SMS, SMT> | null;
   ...
   */
  replaceType(old: Type, new_: Type): StateMachine<SMH, SMS, SMT>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): StateMachine<SMH, SMS, SMT>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): StateMachine<SMH, SMS, SMT>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<StateMachine<SMH, SMS, SMT>>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<StateMachine<SMH, SMS, SMT>>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): StateMachine<SMH, SMS, SMT>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): StateMachine<SMH, SMS, SMT>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): StateMachine<SMH, SMS, SMT>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): StateMachine<SMH, SMS, SMT>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): StateMachine<SMH, SMS, SMT>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): StateMachine<SMH, SMS, SMT>;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): StateMachine<SMH, SMS, SMT>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): StateMachine<SMH, SMS, SMT>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): StateMachine<SMH, SMS, SMT>;
   ...
   * @see #removeField
   */
  withoutField(field: string): StateMachine<SMH, SMS, SMT>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): StateMachine<SMH, SMS, SMT>;
   ...
   */
  withoutFields(fields: Array_Type<string>): StateMachine<SMH, SMS, SMT>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): StateMachine<SMH, SMS, SMT>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): StateMachine<SMH, SMS, SMT>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): StateMachine<SMH, SMS, SMT>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): StateMachine<SMH, SMS, SMT>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): StateMachine<SMH, SMS, SMT>;
   ...
   * @see #removeField
   */
  unsetField(field: string): StateMachine<SMH, SMS, SMT>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): StateMachine<SMH, SMS, SMT>;
   ...
   * @see #unsetField
   */
  removeField(field: string): StateMachine<SMH, SMS, SMT>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): StateMachine<SMH, SMS, SMT>;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): StateMachine<SMH, SMS, SMT>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): StateMachine<SMH, SMS, SMT>;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): StateMachine<SMH, SMS, SMT>;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): StateMachine<SMH, SMS, SMT>;

  mergeJson(json: any): StateMachine<SMH, SMS, SMT>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): StateMachine<SMH, SMS, SMT>;
   ...
   */
  sumObj(other: Obj, deep?: boolean): StateMachine<SMH, SMS, SMT>;
   ...
   */
  singletonArray(): Array_Type<StateMachine<SMH, SMS, SMT>>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<StateMachine<SMH, SMS, SMT>> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<StateMachine<SMH, SMS, SMT>> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<StateMachine<SMH, SMS, SMT>>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<StateMachine<SMH, SMS, SMT>> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, StateMachine<SMH, SMS, SMT>> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, StateMachine<SMH, SMS, SMT>> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<StateMachine<SMH, SMS, SMT>>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<StateMachine<SMH, SMS, SMT>>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): StateMachine<SMH, SMS, SMT>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): StateMachine<SMH, SMS, SMT>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): StateMachine<SMH, SMS, SMT>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): StateMachine<SMH, SMS, SMT>;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): StateMachine<SMH, SMS, SMT>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): StateMachine<SMH, SMS, SMT>;
   ...
   * @see #fromString
   */
  static make(s: string): StateMachine<SMH, SMS, SMT> | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): StateMachine<SMH, SMS, SMT>;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): StateMachine<SMH, SMS, SMT>;
   ...
   */
  static cachedEmptyInst(): StateMachine<SMH, SMS, SMT>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<StateMachine<SMH, SMS, SMT>> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): StateMachine<SMH, SMS, SMT>;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<StateMachine<SMH, SMS, SMT>>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<StateMachine<SMH, SMS, SMT>>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<StateMachine<SMH, SMS, SMT>> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<StateMachine<SMH, SMS, SMT>>> | null;
   ...
   */
  get(include?: string): StateMachine<SMH, SMS, SMT> | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): StateMachine<SMH, SMS, SMT> | null;
   ...
   */
  getMissing(spec: GetMissingSpec): StateMachine<SMH, SMS, SMT>;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): StateMachine<SMH, SMS, SMT> | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): StateMachine<SMH, SMS, SMT>;
   ...
   * @see #toString
   */
  static fromString(s: string): StateMachine<SMH, SMS, SMT> | null;
   ...
   */
  create(spec?: UpsertSpec): StateMachine<SMH, SMS, SMT> | null;
   ...
   */
  static createBatch(objs: Array_Type<StateMachine<SMH, SMS, SMT>>, spec?: UpsertSpec): ObjList<StateMachine<SMH, SMS, SMT>> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<StateMachine<SMH, SMS, SMT>>, spec?: CreateBatchObjStreamSpec): ObjList<StateMachine<SMH, SMS, SMT>> | null;
   ...
   */
  update(srcObj?: StateMachine<SMH, SMS, SMT>, spec?: UpsertSpec): StateMachine<SMH, SMS, SMT> | null;
   ...
   */
  upsert(srcObj?: StateMachine<SMH, SMS, SMT>, spec?: UpsertSpec): StateMachine<SMH, SMS, SMT> | null;
   ...
   */
  merge(spec?: MergeSpec): StateMachine<SMH, SMS, SMT> | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): StateMachine<SMH, SMS, SMT> | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): StateMachine<SMH, SMS, SMT> | null;
   ...
   */
  static updateBatch(objs: Array_Type<StateMachine<SMH, SMS, SMT>>, srcObjs?: Array_Type<StateMachine<SMH, SMS, SMT>>, spec?: UpsertSpec): ObjList<StateMachine<SMH, SMS, SMT>> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<StateMachine<SMH, SMS, SMT>> | null>, spec?: UpsertSpec): ObjList<StateMachine<SMH, SMS, SMT>> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<StateMachine<SMH, SMS, SMT>>, srcObjs?: Array_Type<StateMachine<SMH, SMS, SMT>>, spec?: UpsertSpec): ObjList<StateMachine<SMH, SMS, SMT>> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<StateMachine<SMH, SMS, SMT>> | null>, spec?: UpsertSpec): ObjList<StateMachine<SMH, SMS, SMT>> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<StateMachine<SMH, SMS, SMT>>, spec?: TouchSpec): ObjList<StateMachine<SMH, SMS, SMT>> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<StateMachine<SMH, SMS, SMT>>, spec?: MergeSpec): ObjList<StateMachine<SMH, SMS, SMT>> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<StateMachine<SMH, SMS, SMT>>, mergeInclude: string, spec?: MergeSpec): ObjList<StateMachine<SMH, SMS, SMT>> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<StateMachine<SMH, SMS, SMT>> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<StateMachine<SMH, SMS, SMT>> | null;
   ...
   */
  static mergeAll(mergeObj: StateMachine<SMH, SMS, SMT>, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: StateMachine<SMH, SMS, SMT>, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<StateMachine<SMH, SMS, SMT>>, spec?: UpsertSpec): ObjList<StateMachine<SMH, SMS, SMT>> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<StateMachine<SMH, SMS, SMT>>, spec?: UpsertSpec): ObjList<StateMachine<SMH, SMS, SMT>> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): StateMachine<SMH, SMS, SMT> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<StateMachine<SMH, SMS, SMT>>): ObjList<StateMachine<SMH, SMS, SMT>>;
   ...
   */
  static beforeUpdate(objs: Array_Type<StateMachine<SMH, SMS, SMT>>): ObjList<StateMachine<SMH, SMS, SMT>>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<StateMachine<SMH, SMS, SMT>>): ObjList<StateMachine<SMH, SMS, SMT>>;

  /**
   * See {@link PersistableWritable#afterCreate}
   */
  static afterCreate(objs: Array_Type<StateMachine<SMH, SMS, SMT>>): Array_Type<ObjError> | null;
   ...
   */
  static afterUpdate(objs: Array_Type<StateMachine<SMH, SMS, SMT>>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<StateMachine<SMH, SMS, SMT>>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<StateMachine<SMH, SMS, SMT>>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<StateMachine<SMH, SMS, SMT>>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): StateMachine<SMH, SMS, SMT> | null;
   ...
   */
  withoutIdentity(): StateMachine<SMH, SMS, SMT> | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<StateMachine<SMH, SMS, SMT>>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: StateMachine<SMH, SMS, SMT>, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<StateMachine<SMH, SMS, SMT>>, callback?: λFunction<StateMachine<SMH, SMS, SMT> | null, StateMachine<SMH, SMS, SMT> | null>): ObjList<StateMachine<SMH, SMS, SMT>>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<StateMachine<SMH, SMS, SMT>>, callback?: λFunction<StateMachine<SMH, SMS, SMT> | null, StateMachine<SMH, SMS, SMT> | null>): Array_Type<ObjError> | null;
   ...
   */
  static transitionBatch(stateMachines: Array_Type<StateMachine>, toState: SMS, retry?: number, stateHistoryParams?: SMH): Array_Type<StateMachineTransitionStatus<SMH, SMT>>;
   ...
   */
  static forceTransitionBatch(stateMachines: Array_Type<StateMachine>, toState: SMS, stateHistoryParams?: SMH): Map_Type<string, boolean>;
   ...
   */
  static stateRecoverBatch(stateMachines: Array_Type<StateMachine>): Map_Type<string, boolean>;
   ...
   */
  static doBeforeCreate(objs: Array_Type<StateMachine>): ObjList<StateMachine> | null;
   ...
   */
  static doAfterUpdate(objs: Array_Type<StateMachine>): Array_Type<ObjError> | null;
   ...
   */
  static doAfterCreate(objs: Array_Type<StateMachine>): ObjList<StateMachine> | null;
   ...
   */
  static transitionBatchAndRefreshCurrentState(stateMachines: Array_Type<StateMachine>, toState: SMS, retry?: number, stateHistoryParams?: SMH): Array_Type<StateMachineTransitionStatus<SMH, SMT>>;
