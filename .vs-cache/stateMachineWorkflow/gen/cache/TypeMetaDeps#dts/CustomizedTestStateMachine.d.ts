// TypeScript definitions for the C3 type CustomizedTestStateMachine

/**
 * Entity type `CustomizedTestStateMachine` represents a state machine schema that includes fields for testing
 *
 * @remarks this represents a value passed to a method that expects an instance of CustomizedTestStateMachine
 */
declare interface ICustomizedTestStateMachine {
   ...
   */
  currentState?: ICustomizedTestStateMachineState;

  /**
   * A collection of the states this {@link StateMachine} has passed through.
   */
  stateHistories?: Array_Type<CustomizedTestStateMachineHistory> | Array<ICustomizedTestStateMachineHistory>;

  /**
   * Transitions available from the current state
   */
  transitions?: Array_Type<CustomizedTestStateMachineTransition> | Array<ICustomizedTestStateMachineTransition>;

  /**
   * Calc field to get the current state history
   */
  currentStateHistory?: ICustomizedTestStateMachineHistory;
}
 ...
 */
declare class CustomizedTestStateMachine extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): CustomizedTestStateMachine;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): CustomizedTestStateMachine;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): CustomizedTestStateMachine;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): CustomizedTestStateMachine;
  ...
  withVersion(version: number | null): CustomizedTestStateMachine;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): CustomizedTestStateMachine;

  /**
   * A stored calc field representing the current state - uses a {@link StateMachineHistory} to keep track.
   */
  readonly currentState?: CustomizedTestStateMachineState;
  withCurrentState(currentState: ICustomizedTestStateMachineState | null): CustomizedTestStateMachine;

  /**
   * A collection of the states this {@link StateMachine} has passed through.
   */
  readonly stateHistories?: Array_Type<CustomizedTestStateMachineHistory>;
  withStateHistories(stateHistories: Array_Type<CustomizedTestStateMachineHistory> | Array<ICustomizedTestStateMachineHistory> | null): CustomizedTestStateMachine;

  /**
   * Transitions available from the current state
   */
  readonly transitions?: Array_Type<CustomizedTestStateMachineTransition>;
  withTransitions(transitions: Array_Type<CustomizedTestStateMachineTransition> | Array<ICustomizedTestStateMachineTransition> | null): CustomizedTestStateMachine;

  /**
   * Calc field to get the current state history
   */
  readonly currentStateHistory?: CustomizedTestStateMachineHistory;
  withCurrentStateHistory(currentStateHistory: ICustomizedTestStateMachineHistory | null): CustomizedTestStateMachine;
   ...
   * @see #toJson
   */
  static fromJson(json: any): CustomizedTestStateMachine | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): CustomizedTestStateMachine | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): CustomizedTestStateMachine | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): CustomizedTestStateMachine | null;
   ...
   */
  replaceType(old: Type, new_: Type): CustomizedTestStateMachine;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): CustomizedTestStateMachine;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): CustomizedTestStateMachine;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<CustomizedTestStateMachine>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<CustomizedTestStateMachine>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): CustomizedTestStateMachine;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CustomizedTestStateMachine;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CustomizedTestStateMachine;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): CustomizedTestStateMachine;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): CustomizedTestStateMachine;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): CustomizedTestStateMachine;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): CustomizedTestStateMachine;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): CustomizedTestStateMachine;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): CustomizedTestStateMachine;
   ...
   * @see #removeField
   */
  withoutField(field: string): CustomizedTestStateMachine;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): CustomizedTestStateMachine;
   ...
   */
  withoutFields(fields: Array_Type<string>): CustomizedTestStateMachine;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): CustomizedTestStateMachine;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): CustomizedTestStateMachine;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): CustomizedTestStateMachine;
   ...
   * @see #unsetField
   */
  defaultField(field: string): CustomizedTestStateMachine;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): CustomizedTestStateMachine;
   ...
   * @see #removeField
   */
  unsetField(field: string): CustomizedTestStateMachine;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): CustomizedTestStateMachine;
   ...
   * @see #unsetField
   */
  removeField(field: string): CustomizedTestStateMachine;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): CustomizedTestStateMachine;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): CustomizedTestStateMachine;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): CustomizedTestStateMachine;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): CustomizedTestStateMachine;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): CustomizedTestStateMachine;

  mergeJson(json: any): CustomizedTestStateMachine;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): CustomizedTestStateMachine;
   ...
   */
  sumObj(other: Obj, deep?: boolean): CustomizedTestStateMachine;
   ...
   */
  singletonArray(): Array_Type<CustomizedTestStateMachine>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<CustomizedTestStateMachine> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<CustomizedTestStateMachine> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<CustomizedTestStateMachine>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<CustomizedTestStateMachine> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, CustomizedTestStateMachine> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, CustomizedTestStateMachine> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<CustomizedTestStateMachine>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<CustomizedTestStateMachine>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): CustomizedTestStateMachine;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): CustomizedTestStateMachine;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): CustomizedTestStateMachine;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): CustomizedTestStateMachine;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): CustomizedTestStateMachine;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): CustomizedTestStateMachine;
   ...
   * @see #fromString
   */
  static make(s: string): CustomizedTestStateMachine | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): CustomizedTestStateMachine;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): CustomizedTestStateMachine;
   ...
   */
  static cachedEmptyInst(): CustomizedTestStateMachine;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<CustomizedTestStateMachine> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): CustomizedTestStateMachine;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<CustomizedTestStateMachine>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<CustomizedTestStateMachine>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<CustomizedTestStateMachine> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<CustomizedTestStateMachine>> | null;
   ...
   */
  get(include?: string): CustomizedTestStateMachine | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): CustomizedTestStateMachine | null;
   ...
   */
  getMissing(spec: GetMissingSpec): CustomizedTestStateMachine;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): CustomizedTestStateMachine | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): CustomizedTestStateMachine;
   ...
   * @see #toString
   */
  static fromString(s: string): CustomizedTestStateMachine | null;
   ...
   */
  create(spec?: UpsertSpec): CustomizedTestStateMachine | null;
   ...
   */
  static createBatch(objs: Array_Type<CustomizedTestStateMachine>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachine> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<CustomizedTestStateMachine>, spec?: CreateBatchObjStreamSpec): ObjList<CustomizedTestStateMachine> | null;
   ...
   */
  update(srcObj?: CustomizedTestStateMachine, spec?: UpsertSpec): CustomizedTestStateMachine | null;
   ...
   */
  upsert(srcObj?: CustomizedTestStateMachine, spec?: UpsertSpec): CustomizedTestStateMachine | null;
   ...
   */
  merge(spec?: MergeSpec): CustomizedTestStateMachine | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): CustomizedTestStateMachine | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): CustomizedTestStateMachine | null;
   ...
   */
  static updateBatch(objs: Array_Type<CustomizedTestStateMachine>, srcObjs?: Array_Type<CustomizedTestStateMachine>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachine> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<CustomizedTestStateMachine> | null>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachine> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<CustomizedTestStateMachine>, srcObjs?: Array_Type<CustomizedTestStateMachine>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachine> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<CustomizedTestStateMachine> | null>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachine> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<CustomizedTestStateMachine>, spec?: TouchSpec): ObjList<CustomizedTestStateMachine> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<CustomizedTestStateMachine>, spec?: MergeSpec): ObjList<CustomizedTestStateMachine> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<CustomizedTestStateMachine>, mergeInclude: string, spec?: MergeSpec): ObjList<CustomizedTestStateMachine> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<CustomizedTestStateMachine> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<CustomizedTestStateMachine> | null;
   ...
   */
  static mergeAll(mergeObj: CustomizedTestStateMachine, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: CustomizedTestStateMachine, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<CustomizedTestStateMachine>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachine> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<CustomizedTestStateMachine>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachine> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): CustomizedTestStateMachine | null;
   ...
   */
  static beforeCreate(objs: Array_Type<CustomizedTestStateMachine>): ObjList<CustomizedTestStateMachine>;
   ...
   */
  static beforeUpdate(objs: Array_Type<CustomizedTestStateMachine>): ObjList<CustomizedTestStateMachine>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<CustomizedTestStateMachine>): ObjList<CustomizedTestStateMachine>;

  /**
   * See {@link PersistableWritable#afterCreate}
   */
  static afterCreate(objs: Array_Type<CustomizedTestStateMachine>): Array_Type<ObjError> | null;
   ...
   */
  static afterUpdate(objs: Array_Type<CustomizedTestStateMachine>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<CustomizedTestStateMachine>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<CustomizedTestStateMachine>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<CustomizedTestStateMachine>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): CustomizedTestStateMachine | null;
   ...
   */
  withoutIdentity(): CustomizedTestStateMachine | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<CustomizedTestStateMachine>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: CustomizedTestStateMachine, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<CustomizedTestStateMachine>, callback?: λFunction<CustomizedTestStateMachine | null, CustomizedTestStateMachine | null>): ObjList<CustomizedTestStateMachine>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<CustomizedTestStateMachine>, callback?: λFunction<CustomizedTestStateMachine | null, CustomizedTestStateMachine | null>): Array_Type<ObjError> | null;
   ...
   */
  static transitionBatch(stateMachines: Array_Type<CustomizedTestStateMachine>, toState: CustomizedTestStateMachineState, retry?: number, stateHistoryParams?: CustomizedTestStateMachineHistory): Array_Type<StateMachineTransitionStatus<CustomizedTestStateMachineHistory, CustomizedTestStateMachineTransition>>;
   ...
   */
  transition(toState: CustomizedTestStateMachineState, testOnly?: boolean, stateHistoryParams?: CustomizedTestStateMachineHistory): StateMachineTransitionStatus<CustomizedTestStateMachineHistory, CustomizedTestStateMachineTransition>;
   ...
   */
  checkTransition(toState: CustomizedTestStateMachineState): boolean;
   ...
   */
  possibleStates(): Array_Type<CustomizedTestStateMachineState> | null;

  /**
   * Return list of all states in the {@link StateMachine}.
   */
  static allStates(): Array_Type<CustomizedTestStateMachineState> | null;

  /**
   * Return list of transitions possible from the current state given the current user permissions and current conditions.
   */
  possibleTransitions(): Array_Type<CustomizedTestStateMachineTransition> | null;
   ...
   */
  static allTransitions(fromState?: CustomizedTestStateMachineState, toState?: CustomizedTestStateMachineState): Array_Type<CustomizedTestStateMachineTransition> | null;
   ...
   */
  forceTransition(toState: CustomizedTestStateMachineState, stateHistoryParams?: CustomizedTestStateMachineHistory): boolean;
   ...
   */
  static forceTransitionBatch(stateMachines: Array_Type<CustomizedTestStateMachine>, toState: CustomizedTestStateMachineState, stateHistoryParams?: CustomizedTestStateMachineHistory): Map_Type<string, boolean>;
   ...
   */
  static stateRecoverBatch(stateMachines: Array_Type<CustomizedTestStateMachine>): Map_Type<string, boolean>;

  /**
   * Transition with a valid transition in the transitions array
   */
  transitionWithTransitions(transitions?: Array_Type<CustomizedTestStateMachineTransition>, testOnly?: boolean, stateHistoryParams?: CustomizedTestStateMachineHistory): StateMachineTransitionStatus<CustomizedTestStateMachineHistory, CustomizedTestStateMachineTransition>;
   ...
   */
  static doBeforeCreate(objs: Array_Type<CustomizedTestStateMachine>): ObjList<CustomizedTestStateMachine> | null;
   ...
   */
  static doAfterUpdate(objs: Array_Type<CustomizedTestStateMachine>): Array_Type<ObjError> | null;
   ...
   */
  static doAfterCreate(objs: Array_Type<CustomizedTestStateMachine>): ObjList<CustomizedTestStateMachine> | null;
   ...
   */
  executeTransition(transition: CustomizedTestStateMachineTransition, stateOrderCounter: number, stateHistoryParams?: CustomizedTestStateMachineHistory): CustomizedTestStateMachineHistory;
   ...
   */
  findTransitions(allTransitions: Array_Type<CustomizedTestStateMachineTransition>): Array_Type<CustomizedTestStateMachineTransition> | null;

  /**
   * Internal use only.
   * Implements a statemachine db lock.
   */
  reserveStateOrderCounter(): StateMachineTransitionStatus<CustomizedTestStateMachineHistory, CustomizedTestStateMachineTransition>;

  /**
   * Internal use only.
   * Verify whether the state machine is in error state.
   */
  checkStateMachine(): StateMachineTransitionStatus<CustomizedTestStateMachineHistory, CustomizedTestStateMachineTransition>;
   ...
   */
  transitionAndRefreshCurrentState(toState: CustomizedTestStateMachineState, stateHistoryParams?: CustomizedTestStateMachineHistory): StateMachineTransitionStatus<CustomizedTestStateMachineHistory, CustomizedTestStateMachineTransition>;

  /**
   * Used from the UI to batch transition and refresh currentState stored calc.
   */
  static transitionBatchAndRefreshCurrentState(stateMachines: Array_Type<CustomizedTestStateMachine>, toState: CustomizedTestStateMachineState, retry?: number, stateHistoryParams?: CustomizedTestStateMachineHistory): Array_Type<StateMachineTransitionStatus<CustomizedTestStateMachineHistory, CustomizedTestStateMachineTransition>>;
