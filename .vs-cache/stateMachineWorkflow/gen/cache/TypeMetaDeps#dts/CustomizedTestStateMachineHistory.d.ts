// TypeScript definitions for the C3 type CustomizedTestStateMachineHistory

/**
 * Entity type `CustomizedTestStateMachineHistory` represents the history of a state machine for a customized
 * process. It tracks the state transitions and includes additional fields for storing relevant information.
 *
 * @remarks this represents a value passed to a method that expects an instance of CustomizedTestStateMachineHistory
 */
declare interface ICustomizedTestStateMachineHistory {
   ...
   */
  parent: ICustomizedTestStateMachine;

  /**
   * All transition are disabled when `error` is true.
   */
  error?: boolean;

  /**
   * A field for populating an error message if an error occurs.
   */
  errorMessage?: string;

  /**
   * Will be incremented every time state changes. This is to be able to differentiate state history if more than 1 automatic transition occurs in a second.
   * Note: DateTime milliseconds are not persisted.
   */
  stateOrderCounter: number;

  /**
   * The state of this step in the {@link StateMachineHistory}.
   */
  state: ICustomizedTestStateMachineState;

  /**
   * If null, the new state is set through automatic transition.
   */
  updatedBy?: IUser;

  /**
   * If null, the new state is set without evaluating any transition conditions.
   */
  transition?: ICustomizedTestStateMachineTransition;
  ...
  /**
   * `fieldA`: A `string` field used to store additional information related to the state machine's history.
   */
  fieldA?: string;

  /**
   * `fieldB`: A `string` field used to store another piece of information or identifier for the state machine's history.
   */
  fieldB?: string;
}
 ...
 * process. It tracks the state transitions and includes additional fields for storing relevant information.
 *
 * @remarks this represents a made instance of CustomizedTestStateMachineHistory
 */
declare class CustomizedTestStateMachineHistory extends Obj  {

  /**
   * Timestamp for the value.
   */
  readonly timestamp: DateTime;
  withTimestamp(timestamp: DateTime | Date | string): CustomizedTestStateMachineHistory;

  /**
   * Parent/owning obj instance.
   */
  readonly parent: CustomizedTestStateMachine;
  withParent(parent: ICustomizedTestStateMachine): CustomizedTestStateMachineHistory;

  /**
   * All transition are disabled when `error` is true.
   */
  readonly error?: boolean;
  withError(error: boolean): CustomizedTestStateMachineHistory;

  /**
   * A field for populating an error message if an error occurs.
   */
  readonly errorMessage?: string;
  withErrorMessage(errorMessage: string | null): CustomizedTestStateMachineHistory;

  /**
   * Will be incremented every time state changes. This is to be able to differentiate state history if more than 1 automatic transition occurs in a second.
   * Note: DateTime milliseconds are not persisted.
   */
  readonly stateOrderCounter: number;
  withStateOrderCounter(stateOrderCounter: number): CustomizedTestStateMachineHistory;

  /**
   * The state of this step in the {@link StateMachineHistory}.
   */
  readonly state: CustomizedTestStateMachineState;
  withState(state: ICustomizedTestStateMachineState): CustomizedTestStateMachineHistory;

  /**
   * If null, the new state is set through automatic transition.
   */
  readonly updatedBy?: User;
  withUpdatedBy(updatedBy: IUser | null): CustomizedTestStateMachineHistory;

  /**
   * If null, the new state is set without evaluating any transition conditions.
   */
  readonly transition?: CustomizedTestStateMachineTransition;
  withTransition(transition: ICustomizedTestStateMachineTransition | null): CustomizedTestStateMachineHistory;
   ...
   */
  readonly id: string;
  withId(id: string): CustomizedTestStateMachineHistory;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): CustomizedTestStateMachineHistory;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): CustomizedTestStateMachineHistory;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): CustomizedTestStateMachineHistory;
  ...
  withVersion(version: number | null): CustomizedTestStateMachineHistory;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): CustomizedTestStateMachineHistory;

  /**
   * `fieldA`: A `string` field used to store additional information related to the state machine's history.
   */
  readonly fieldA?: string;
  withFieldA(fieldA: string | null): CustomizedTestStateMachineHistory;

  /**
   * `fieldB`: A `string` field used to store another piece of information or identifier for the state machine's history.
   */
  readonly fieldB?: string;
  withFieldB(fieldB: string | null): CustomizedTestStateMachineHistory;
   ...
   * @see #toJson
   */
  static fromJson(json: any): CustomizedTestStateMachineHistory | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): CustomizedTestStateMachineHistory | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): CustomizedTestStateMachineHistory | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): CustomizedTestStateMachineHistory | null;
   ...
   */
  replaceType(old: Type, new_: Type): CustomizedTestStateMachineHistory;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): CustomizedTestStateMachineHistory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): CustomizedTestStateMachineHistory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<CustomizedTestStateMachineHistory>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<CustomizedTestStateMachineHistory>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): CustomizedTestStateMachineHistory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CustomizedTestStateMachineHistory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CustomizedTestStateMachineHistory;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): CustomizedTestStateMachineHistory;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): CustomizedTestStateMachineHistory;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): CustomizedTestStateMachineHistory;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): CustomizedTestStateMachineHistory;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): CustomizedTestStateMachineHistory;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): CustomizedTestStateMachineHistory;
   ...
   * @see #removeField
   */
  withoutField(field: string): CustomizedTestStateMachineHistory;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): CustomizedTestStateMachineHistory;
   ...
   */
  withoutFields(fields: Array_Type<string>): CustomizedTestStateMachineHistory;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): CustomizedTestStateMachineHistory;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): CustomizedTestStateMachineHistory;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): CustomizedTestStateMachineHistory;
   ...
   * @see #unsetField
   */
  defaultField(field: string): CustomizedTestStateMachineHistory;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): CustomizedTestStateMachineHistory;
   ...
   * @see #removeField
   */
  unsetField(field: string): CustomizedTestStateMachineHistory;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): CustomizedTestStateMachineHistory;
   ...
   * @see #unsetField
   */
  removeField(field: string): CustomizedTestStateMachineHistory;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): CustomizedTestStateMachineHistory;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): CustomizedTestStateMachineHistory;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): CustomizedTestStateMachineHistory;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): CustomizedTestStateMachineHistory;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): CustomizedTestStateMachineHistory;

  mergeJson(json: any): CustomizedTestStateMachineHistory;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): CustomizedTestStateMachineHistory;
   ...
   */
  sumObj(other: Obj, deep?: boolean): CustomizedTestStateMachineHistory;
   ...
   */
  singletonArray(): Array_Type<CustomizedTestStateMachineHistory>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<CustomizedTestStateMachineHistory> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<CustomizedTestStateMachineHistory> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<CustomizedTestStateMachineHistory>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<CustomizedTestStateMachineHistory> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, CustomizedTestStateMachineHistory> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, CustomizedTestStateMachineHistory> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<CustomizedTestStateMachineHistory>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<CustomizedTestStateMachineHistory>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): CustomizedTestStateMachineHistory;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): CustomizedTestStateMachineHistory;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): CustomizedTestStateMachineHistory;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): CustomizedTestStateMachineHistory;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): CustomizedTestStateMachineHistory;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): CustomizedTestStateMachineHistory;
   ...
   * @see #fromString
   */
  static make(s: string): CustomizedTestStateMachineHistory | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): CustomizedTestStateMachineHistory;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): CustomizedTestStateMachineHistory;
   ...
   */
  static cachedEmptyInst(): CustomizedTestStateMachineHistory;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<CustomizedTestStateMachineHistory> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): CustomizedTestStateMachineHistory;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<CustomizedTestStateMachineHistory>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<CustomizedTestStateMachineHistory>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<CustomizedTestStateMachineHistory> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<CustomizedTestStateMachineHistory>> | null;
   ...
   */
  get(include?: string): CustomizedTestStateMachineHistory | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): CustomizedTestStateMachineHistory | null;
   ...
   */
  getMissing(spec: GetMissingSpec): CustomizedTestStateMachineHistory;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): CustomizedTestStateMachineHistory | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): CustomizedTestStateMachineHistory;
   ...
   * @see #toString
   */
  static fromString(s: string): CustomizedTestStateMachineHistory | null;
   ...
   */
  create(spec?: UpsertSpec): CustomizedTestStateMachineHistory | null;
   ...
   */
  static createBatch(objs: Array_Type<CustomizedTestStateMachineHistory>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachineHistory> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<CustomizedTestStateMachineHistory>, spec?: CreateBatchObjStreamSpec): ObjList<CustomizedTestStateMachineHistory> | null;
   ...
   */
  update(srcObj?: CustomizedTestStateMachineHistory, spec?: UpsertSpec): CustomizedTestStateMachineHistory | null;
   ...
   */
  upsert(srcObj?: CustomizedTestStateMachineHistory, spec?: UpsertSpec): CustomizedTestStateMachineHistory | null;
   ...
   */
  merge(spec?: MergeSpec): CustomizedTestStateMachineHistory | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): CustomizedTestStateMachineHistory | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): CustomizedTestStateMachineHistory | null;
   ...
   */
  static updateBatch(objs: Array_Type<CustomizedTestStateMachineHistory>, srcObjs?: Array_Type<CustomizedTestStateMachineHistory>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachineHistory> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<CustomizedTestStateMachineHistory> | null>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachineHistory> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<CustomizedTestStateMachineHistory>, srcObjs?: Array_Type<CustomizedTestStateMachineHistory>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachineHistory> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<CustomizedTestStateMachineHistory> | null>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachineHistory> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<CustomizedTestStateMachineHistory>, spec?: TouchSpec): ObjList<CustomizedTestStateMachineHistory> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<CustomizedTestStateMachineHistory>, spec?: MergeSpec): ObjList<CustomizedTestStateMachineHistory> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<CustomizedTestStateMachineHistory>, mergeInclude: string, spec?: MergeSpec): ObjList<CustomizedTestStateMachineHistory> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<CustomizedTestStateMachineHistory> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<CustomizedTestStateMachineHistory> | null;
   ...
   */
  static mergeAll(mergeObj: CustomizedTestStateMachineHistory, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: CustomizedTestStateMachineHistory, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<CustomizedTestStateMachineHistory>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachineHistory> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<CustomizedTestStateMachineHistory>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachineHistory> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): CustomizedTestStateMachineHistory | null;
   ...
   */
  static beforeCreate(objs: Array_Type<CustomizedTestStateMachineHistory>): ObjList<CustomizedTestStateMachineHistory>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<CustomizedTestStateMachineHistory>): ObjList<CustomizedTestStateMachineHistory>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<CustomizedTestStateMachineHistory>): ObjList<CustomizedTestStateMachineHistory>;
   ...
   */
  static afterCreate(objs: Array_Type<CustomizedTestStateMachineHistory>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<CustomizedTestStateMachineHistory>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<CustomizedTestStateMachineHistory>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<CustomizedTestStateMachineHistory>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<CustomizedTestStateMachineHistory>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): CustomizedTestStateMachineHistory | null;
   ...
   */
  withoutIdentity(): CustomizedTestStateMachineHistory | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<CustomizedTestStateMachineHistory>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: CustomizedTestStateMachineHistory, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<CustomizedTestStateMachineHistory>, callback?: λFunction<CustomizedTestStateMachineHistory | null, CustomizedTestStateMachineHistory | null>): ObjList<CustomizedTestStateMachineHistory>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<CustomizedTestStateMachineHistory>, callback?: λFunction<CustomizedTestStateMachineHistory | null, CustomizedTestStateMachineHistory | null>): Array_Type<ObjError> | null;
