// TypeScript definitions for the C3 type BatchTestStateMachineTransition

/**
 * Entity type `BatchTestStateMachineTransition` represents a transition within the `BatchTestStateMachine`.
 * It defines the various transitions between states in the machine.
 *
 * @remarks this represents a value passed to a method that expects an instance of BatchTestStateMachineTransition
 */
declare interface IBatchTestStateMachineTransition {
   ...
   */
  from: IBatchTestStateMachineState;

  /**
   * The {@link StateMachineState} to transition to.
   */
  to: IBatchTestStateMachineState;
 ...
 * It defines the various transitions between states in the machine.
 *
 * @remarks this represents a made instance of BatchTestStateMachineTransition
 */
declare class BatchTestStateMachineTransition extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): BatchTestStateMachineTransition;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): BatchTestStateMachineTransition;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): BatchTestStateMachineTransition;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): BatchTestStateMachineTransition;
  ...
  withVersion(version: number | null): BatchTestStateMachineTransition;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): BatchTestStateMachineTransition;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): BatchTestStateMachineTransition;
  ...
  withHidden(hidden: boolean): BatchTestStateMachineTransition;
  ...
  withUserOwned(userOwned: boolean): BatchTestStateMachineTransition;

  /**
   * List of {@link AclEntry} entries governing who can read/update/remove Objs.
   */
  readonly acl?: Array_Type<AclEntry>;
  withAcl(acl: Array_Type<AclEntry> | Array<IAclEntry> | null): BatchTestStateMachineTransition;

  /**
   * The {@link StateMachineState} to transition from.
   */
  readonly from: BatchTestStateMachineState;
  withFrom(from: IBatchTestStateMachineState): BatchTestStateMachineTransition;

  /**
   * The {@link StateMachineState} to transition to.
   */
  readonly to: BatchTestStateMachineState;
  withTo(to: IBatchTestStateMachineState): BatchTestStateMachineTransition;

  /**
   * Used to soft delete a record so all state histories still have valid pointers.
   */
  readonly deleted?: boolean;
  withDeleted(deleted: boolean): BatchTestStateMachineTransition;

  /**
   * A transition is only valid if the {@link from}, {@link to}, and itself are not deleted.
   */
  readonly isValid?: boolean;
  withIsValid(isValid: boolean): BatchTestStateMachineTransition;

  /**
   * The trigger that must be satisfied in order for this transition to take place.
   */
  readonly trigger?: TransitionTrigger;
  withTrigger(trigger: ITransitionTrigger | null): BatchTestStateMachineTransition;
  ...
  withCondition(condition: string | null): BatchTestStateMachineTransition;

  /**
   * Used to include fields on the source type for exitAction and entryAction.
   */
  readonly includeSpec?: string;
  withIncludeSpec(includeSpec: string | null): BatchTestStateMachineTransition;

  /**
   * The action to be taken during this {@link StateMachineTransition}.
   */
  readonly action?: λConsumer<any | null>;
  withAction(action: λConsumer<any | null> | null): BatchTestStateMachineTransition;
   ...
   * @see #toJson
   */
  static fromJson(json: any): BatchTestStateMachineTransition | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): BatchTestStateMachineTransition | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): BatchTestStateMachineTransition | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): BatchTestStateMachineTransition | null;
   ...
   */
  replaceType(old: Type, new_: Type): BatchTestStateMachineTransition;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): BatchTestStateMachineTransition;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): BatchTestStateMachineTransition;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<BatchTestStateMachineTransition>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<BatchTestStateMachineTransition>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): BatchTestStateMachineTransition;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BatchTestStateMachineTransition;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BatchTestStateMachineTransition;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): BatchTestStateMachineTransition;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): BatchTestStateMachineTransition;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): BatchTestStateMachineTransition;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): BatchTestStateMachineTransition;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BatchTestStateMachineTransition;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): BatchTestStateMachineTransition;
   ...
   * @see #removeField
   */
  withoutField(field: string): BatchTestStateMachineTransition;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): BatchTestStateMachineTransition;
   ...
   */
  withoutFields(fields: Array_Type<string>): BatchTestStateMachineTransition;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): BatchTestStateMachineTransition;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): BatchTestStateMachineTransition;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): BatchTestStateMachineTransition;
   ...
   * @see #unsetField
   */
  defaultField(field: string): BatchTestStateMachineTransition;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): BatchTestStateMachineTransition;
   ...
   * @see #removeField
   */
  unsetField(field: string): BatchTestStateMachineTransition;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): BatchTestStateMachineTransition;
   ...
   * @see #unsetField
   */
  removeField(field: string): BatchTestStateMachineTransition;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): BatchTestStateMachineTransition;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): BatchTestStateMachineTransition;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): BatchTestStateMachineTransition;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): BatchTestStateMachineTransition;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): BatchTestStateMachineTransition;

  mergeJson(json: any): BatchTestStateMachineTransition;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): BatchTestStateMachineTransition;
   ...
   */
  sumObj(other: Obj, deep?: boolean): BatchTestStateMachineTransition;
   ...
   */
  singletonArray(): Array_Type<BatchTestStateMachineTransition>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<BatchTestStateMachineTransition> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BatchTestStateMachineTransition> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<BatchTestStateMachineTransition>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BatchTestStateMachineTransition> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, BatchTestStateMachineTransition> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BatchTestStateMachineTransition> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BatchTestStateMachineTransition>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BatchTestStateMachineTransition>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): BatchTestStateMachineTransition;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): BatchTestStateMachineTransition;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): BatchTestStateMachineTransition;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): BatchTestStateMachineTransition;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): BatchTestStateMachineTransition;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): BatchTestStateMachineTransition;
   ...
   * @see #fromString
   */
  static make(s: string): BatchTestStateMachineTransition | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): BatchTestStateMachineTransition;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): BatchTestStateMachineTransition;
   ...
   */
  static cachedEmptyInst(): BatchTestStateMachineTransition;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<BatchTestStateMachineTransition> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): BatchTestStateMachineTransition;
   ...
   */
  static allCached(): Stream<BatchTestStateMachineTransition> | null;
   ...
   */
  static find(filter?: string): Stream<BatchTestStateMachineTransition> | null;
   ...
   *         Otherwise no population will be performed.
   */
  static findBy(field: string, value: any): Stream<BatchTestStateMachineTransition> | null;

  /**
   * @return cached instance.
   */
  getCached(): BatchTestStateMachineTransition | null;

  /**
   * @return cached instance by the key.
   */
  static forCacheKey(key: string): BatchTestStateMachineTransition | null;
   ...
   */
  static produce(key: string): BatchTestStateMachineTransition | null;

  /**
   * Should produces the entire content for the cached data. Will populate the cache with the produced data.
   */
  static produceAll(): Map_Type<string, BatchTestStateMachineTransition> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<BatchTestStateMachineTransition>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<BatchTestStateMachineTransition>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<BatchTestStateMachineTransition> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<BatchTestStateMachineTransition>> | null;
   ...
   */
  get(include?: string): BatchTestStateMachineTransition | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): BatchTestStateMachineTransition | null;
   ...
   */
  getMissing(spec: GetMissingSpec): BatchTestStateMachineTransition;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): BatchTestStateMachineTransition | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): BatchTestStateMachineTransition;
   ...
   * @see #toString
   */
  static fromString(s: string): BatchTestStateMachineTransition | null;
   ...
   */
  create(spec?: UpsertSpec): BatchTestStateMachineTransition | null;
   ...
   */
  static createBatch(objs: Array_Type<BatchTestStateMachineTransition>, spec?: UpsertSpec): ObjList<BatchTestStateMachineTransition> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<BatchTestStateMachineTransition>, spec?: CreateBatchObjStreamSpec): ObjList<BatchTestStateMachineTransition> | null;
   ...
   */
  update(srcObj?: BatchTestStateMachineTransition, spec?: UpsertSpec): BatchTestStateMachineTransition | null;
   ...
   */
  upsert(srcObj?: BatchTestStateMachineTransition, spec?: UpsertSpec): BatchTestStateMachineTransition | null;
   ...
   */
  merge(spec?: MergeSpec): BatchTestStateMachineTransition | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): BatchTestStateMachineTransition | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): BatchTestStateMachineTransition | null;
   ...
   */
  static updateBatch(objs: Array_Type<BatchTestStateMachineTransition>, srcObjs?: Array_Type<BatchTestStateMachineTransition>, spec?: UpsertSpec): ObjList<BatchTestStateMachineTransition> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<BatchTestStateMachineTransition> | null>, spec?: UpsertSpec): ObjList<BatchTestStateMachineTransition> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<BatchTestStateMachineTransition>, srcObjs?: Array_Type<BatchTestStateMachineTransition>, spec?: UpsertSpec): ObjList<BatchTestStateMachineTransition> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<BatchTestStateMachineTransition> | null>, spec?: UpsertSpec): ObjList<BatchTestStateMachineTransition> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<BatchTestStateMachineTransition>, spec?: TouchSpec): ObjList<BatchTestStateMachineTransition> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<BatchTestStateMachineTransition>, spec?: MergeSpec): ObjList<BatchTestStateMachineTransition> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<BatchTestStateMachineTransition>, mergeInclude: string, spec?: MergeSpec): ObjList<BatchTestStateMachineTransition> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<BatchTestStateMachineTransition> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<BatchTestStateMachineTransition> | null;
   ...
   */
  static mergeAll(mergeObj: BatchTestStateMachineTransition, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: BatchTestStateMachineTransition, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<BatchTestStateMachineTransition>, spec?: UpsertSpec): ObjList<BatchTestStateMachineTransition> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<BatchTestStateMachineTransition>, spec?: UpsertSpec): ObjList<BatchTestStateMachineTransition> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): BatchTestStateMachineTransition | null;
   ...
   */
  static beforeCreate(objs: Array_Type<BatchTestStateMachineTransition>): ObjList<BatchTestStateMachineTransition>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<BatchTestStateMachineTransition>): ObjList<BatchTestStateMachineTransition>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<BatchTestStateMachineTransition>): ObjList<BatchTestStateMachineTransition>;
   ...
   */
  static afterCreate(objs: Array_Type<BatchTestStateMachineTransition>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<BatchTestStateMachineTransition>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<BatchTestStateMachineTransition>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<BatchTestStateMachineTransition>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<BatchTestStateMachineTransition>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): BatchTestStateMachineTransition | null;
   ...
   */
  withoutIdentity(): BatchTestStateMachineTransition | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<BatchTestStateMachineTransition>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: BatchTestStateMachineTransition, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<BatchTestStateMachineTransition>, callback?: λFunction<BatchTestStateMachineTransition | null, BatchTestStateMachineTransition | null>): ObjList<BatchTestStateMachineTransition>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<BatchTestStateMachineTransition>, callback?: λFunction<BatchTestStateMachineTransition | null, BatchTestStateMachineTransition | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): BatchTestStateMachineTransition;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<BatchTestStateMachineTransition> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): BatchTestStateMachineTransition | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<BatchTestStateMachineTransition> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): BatchTestStateMachineTransition | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<BatchTestStateMachineTransition> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): BatchTestStateMachineTransition | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<BatchTestStateMachineTransition> | null;
  ...
  dependencies(): SeedDataDeps<BatchTestStateMachineTransition> | null;
   ...
   */
  static populateAcl(objs?: Array_Type<BatchTestStateMachineTransition>): number | null;
   ...
   */
  grantMemberReadUpdateRemove(member: AccessControlEntity): BatchTestStateMachineTransition;
   ...
   */
  mergeAclEntry(entry: AclEntry): BatchTestStateMachineTransition;
   ...
   * @return the obj with the new acl after merging the indicated entry.
   */
  mergeAclEntries(entries: Array_Type<AclEntry>): BatchTestStateMachineTransition;
