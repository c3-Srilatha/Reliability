// TypeScript definitions for the C3 type TestStateMachineTransition
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of TestStateMachineTransition
 */
declare interface ITestStateMachineTransition {
   ...
   */
  from: ITestStateMachineState;

  /**
   * The {@link StateMachineState} to transition to.
   */
  to: ITestStateMachineState;
 ...
 */
declare class TestStateMachineTransition extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): TestStateMachineTransition;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): TestStateMachineTransition;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): TestStateMachineTransition;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): TestStateMachineTransition;
  ...
  withVersion(version: number | null): TestStateMachineTransition;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): TestStateMachineTransition;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): TestStateMachineTransition;
  ...
  withHidden(hidden: boolean): TestStateMachineTransition;
  ...
  withUserOwned(userOwned: boolean): TestStateMachineTransition;

  /**
   * List of {@link AclEntry} entries governing who can read/update/remove Objs.
   */
  readonly acl?: Array_Type<AclEntry>;
  withAcl(acl: Array_Type<AclEntry> | Array<IAclEntry> | null): TestStateMachineTransition;

  /**
   * The {@link StateMachineState} to transition from.
   */
  readonly from: TestStateMachineState;
  withFrom(from: ITestStateMachineState): TestStateMachineTransition;

  /**
   * The {@link StateMachineState} to transition to.
   */
  readonly to: TestStateMachineState;
  withTo(to: ITestStateMachineState): TestStateMachineTransition;

  /**
   * Used to soft delete a record so all state histories still have valid pointers.
   */
  readonly deleted?: boolean;
  withDeleted(deleted: boolean): TestStateMachineTransition;

  /**
   * A transition is only valid if the {@link from}, {@link to}, and itself are not deleted.
   */
  readonly isValid?: boolean;
  withIsValid(isValid: boolean): TestStateMachineTransition;

  /**
   * The trigger that must be satisfied in order for this transition to take place.
   */
  readonly trigger?: TransitionTrigger;
  withTrigger(trigger: ITransitionTrigger | null): TestStateMachineTransition;
  ...
  withCondition(condition: string | null): TestStateMachineTransition;

  /**
   * Used to include fields on the source type for exitAction and entryAction.
   */
  readonly includeSpec?: string;
  withIncludeSpec(includeSpec: string | null): TestStateMachineTransition;

  /**
   * The action to be taken during this {@link StateMachineTransition}.
   */
  readonly action?: λConsumer<any | null>;
  withAction(action: λConsumer<any | null> | null): TestStateMachineTransition;
   ...
   * @see #toJson
   */
  static fromJson(json: any): TestStateMachineTransition | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): TestStateMachineTransition | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): TestStateMachineTransition | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): TestStateMachineTransition | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestStateMachineTransition;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TestStateMachineTransition;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TestStateMachineTransition;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<TestStateMachineTransition>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<TestStateMachineTransition>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): TestStateMachineTransition;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestStateMachineTransition;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestStateMachineTransition;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestStateMachineTransition;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestStateMachineTransition;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestStateMachineTransition;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): TestStateMachineTransition;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestStateMachineTransition;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestStateMachineTransition;
   ...
   * @see #removeField
   */
  withoutField(field: string): TestStateMachineTransition;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): TestStateMachineTransition;
   ...
   */
  withoutFields(fields: Array_Type<string>): TestStateMachineTransition;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): TestStateMachineTransition;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestStateMachineTransition;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): TestStateMachineTransition;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestStateMachineTransition;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestStateMachineTransition;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestStateMachineTransition;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestStateMachineTransition;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestStateMachineTransition;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestStateMachineTransition;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): TestStateMachineTransition;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): TestStateMachineTransition;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): TestStateMachineTransition;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): TestStateMachineTransition;

  mergeJson(json: any): TestStateMachineTransition;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): TestStateMachineTransition;
   ...
   */
  sumObj(other: Obj, deep?: boolean): TestStateMachineTransition;
   ...
   */
  singletonArray(): Array_Type<TestStateMachineTransition>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<TestStateMachineTransition> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestStateMachineTransition> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<TestStateMachineTransition>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestStateMachineTransition> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, TestStateMachineTransition> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestStateMachineTransition> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestStateMachineTransition>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestStateMachineTransition>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): TestStateMachineTransition;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): TestStateMachineTransition;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): TestStateMachineTransition;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestStateMachineTransition;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): TestStateMachineTransition;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestStateMachineTransition;
   ...
   * @see #fromString
   */
  static make(s: string): TestStateMachineTransition | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): TestStateMachineTransition;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): TestStateMachineTransition;
   ...
   */
  static cachedEmptyInst(): TestStateMachineTransition;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<TestStateMachineTransition> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): TestStateMachineTransition;
   ...
   */
  static allCached(): Stream<TestStateMachineTransition> | null;
   ...
   */
  static find(filter?: string): Stream<TestStateMachineTransition> | null;
   ...
   *         Otherwise no population will be performed.
   */
  static findBy(field: string, value: any): Stream<TestStateMachineTransition> | null;

  /**
   * @return cached instance.
   */
  getCached(): TestStateMachineTransition | null;

  /**
   * @return cached instance by the key.
   */
  static forCacheKey(key: string): TestStateMachineTransition | null;
   ...
   */
  static produce(key: string): TestStateMachineTransition | null;

  /**
   * Should produces the entire content for the cached data. Will populate the cache with the produced data.
   */
  static produceAll(): Map_Type<string, TestStateMachineTransition> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<TestStateMachineTransition>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestStateMachineTransition>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<TestStateMachineTransition> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<TestStateMachineTransition>> | null;
   ...
   */
  get(include?: string): TestStateMachineTransition | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): TestStateMachineTransition | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestStateMachineTransition;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): TestStateMachineTransition | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestStateMachineTransition;
   ...
   * @see #toString
   */
  static fromString(s: string): TestStateMachineTransition | null;
   ...
   */
  create(spec?: UpsertSpec): TestStateMachineTransition | null;
   ...
   */
  static createBatch(objs: Array_Type<TestStateMachineTransition>, spec?: UpsertSpec): ObjList<TestStateMachineTransition> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestStateMachineTransition>, spec?: CreateBatchObjStreamSpec): ObjList<TestStateMachineTransition> | null;
   ...
   */
  update(srcObj?: TestStateMachineTransition, spec?: UpsertSpec): TestStateMachineTransition | null;
   ...
   */
  upsert(srcObj?: TestStateMachineTransition, spec?: UpsertSpec): TestStateMachineTransition | null;
   ...
   */
  merge(spec?: MergeSpec): TestStateMachineTransition | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): TestStateMachineTransition | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): TestStateMachineTransition | null;
   ...
   */
  static updateBatch(objs: Array_Type<TestStateMachineTransition>, srcObjs?: Array_Type<TestStateMachineTransition>, spec?: UpsertSpec): ObjList<TestStateMachineTransition> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<TestStateMachineTransition> | null>, spec?: UpsertSpec): ObjList<TestStateMachineTransition> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<TestStateMachineTransition>, srcObjs?: Array_Type<TestStateMachineTransition>, spec?: UpsertSpec): ObjList<TestStateMachineTransition> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<TestStateMachineTransition> | null>, spec?: UpsertSpec): ObjList<TestStateMachineTransition> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<TestStateMachineTransition>, spec?: TouchSpec): ObjList<TestStateMachineTransition> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TestStateMachineTransition>, spec?: MergeSpec): ObjList<TestStateMachineTransition> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TestStateMachineTransition>, mergeInclude: string, spec?: MergeSpec): ObjList<TestStateMachineTransition> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<TestStateMachineTransition> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<TestStateMachineTransition> | null;
   ...
   */
  static mergeAll(mergeObj: TestStateMachineTransition, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestStateMachineTransition, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<TestStateMachineTransition>, spec?: UpsertSpec): ObjList<TestStateMachineTransition> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<TestStateMachineTransition>, spec?: UpsertSpec): ObjList<TestStateMachineTransition> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TestStateMachineTransition | null;
   ...
   */
  static beforeCreate(objs: Array_Type<TestStateMachineTransition>): ObjList<TestStateMachineTransition>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<TestStateMachineTransition>): ObjList<TestStateMachineTransition>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<TestStateMachineTransition>): ObjList<TestStateMachineTransition>;
   ...
   */
  static afterCreate(objs: Array_Type<TestStateMachineTransition>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<TestStateMachineTransition>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<TestStateMachineTransition>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<TestStateMachineTransition>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<TestStateMachineTransition>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): TestStateMachineTransition | null;
   ...
   */
  withoutIdentity(): TestStateMachineTransition | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<TestStateMachineTransition>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: TestStateMachineTransition, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<TestStateMachineTransition>, callback?: λFunction<TestStateMachineTransition | null, TestStateMachineTransition | null>): ObjList<TestStateMachineTransition>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<TestStateMachineTransition>, callback?: λFunction<TestStateMachineTransition | null, TestStateMachineTransition | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): TestStateMachineTransition;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<TestStateMachineTransition> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): TestStateMachineTransition | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<TestStateMachineTransition> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): TestStateMachineTransition | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<TestStateMachineTransition> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): TestStateMachineTransition | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<TestStateMachineTransition> | null;
  ...
  dependencies(): SeedDataDeps<TestStateMachineTransition> | null;
   ...
   */
  static populateAcl(objs?: Array_Type<TestStateMachineTransition>): number | null;
   ...
   */
  grantMemberReadUpdateRemove(member: AccessControlEntity): TestStateMachineTransition;
   ...
   */
  mergeAclEntry(entry: AclEntry): TestStateMachineTransition;
   ...
   * @return the obj with the new acl after merging the indicated entry.
   */
  mergeAclEntries(entries: Array_Type<AclEntry>): TestStateMachineTransition;
