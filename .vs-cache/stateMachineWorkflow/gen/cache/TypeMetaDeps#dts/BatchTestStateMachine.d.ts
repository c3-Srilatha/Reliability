// TypeScript definitions for the C3 type BatchTestStateMachine

/**
 * Entity type that represents a state machine schema that includes fields for testing
 *
 * @remarks this represents a value passed to a method that expects an instance of BatchTestStateMachine
 */
declare interface IBatchTestStateMachine {
   ...
   */
  currentState?: IBatchTestStateMachineState;

  /**
   * A collection of the states this {@link StateMachine} has passed through.
   */
  stateHistories?: Array_Type<BatchTestStateMachineHistory> | Array<IBatchTestStateMachineHistory>;

  /**
   * Transitions available from the current state
   */
  transitions?: Array_Type<BatchTestStateMachineTransition> | Array<IBatchTestStateMachineTransition>;

  /**
   * Calc field to get the current state history
   */
  currentStateHistory?: IBatchTestStateMachineHistory;
}
 ...
 */
declare class BatchTestStateMachine extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): BatchTestStateMachine;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): BatchTestStateMachine;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): BatchTestStateMachine;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): BatchTestStateMachine;
  ...
  withVersion(version: number | null): BatchTestStateMachine;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): BatchTestStateMachine;

  /**
   * A stored calc field representing the current state - uses a {@link StateMachineHistory} to keep track.
   */
  readonly currentState?: BatchTestStateMachineState;
  withCurrentState(currentState: IBatchTestStateMachineState | null): BatchTestStateMachine;

  /**
   * A collection of the states this {@link StateMachine} has passed through.
   */
  readonly stateHistories?: Array_Type<BatchTestStateMachineHistory>;
  withStateHistories(stateHistories: Array_Type<BatchTestStateMachineHistory> | Array<IBatchTestStateMachineHistory> | null): BatchTestStateMachine;

  /**
   * Transitions available from the current state
   */
  readonly transitions?: Array_Type<BatchTestStateMachineTransition>;
  withTransitions(transitions: Array_Type<BatchTestStateMachineTransition> | Array<IBatchTestStateMachineTransition> | null): BatchTestStateMachine;

  /**
   * Calc field to get the current state history
   */
  readonly currentStateHistory?: BatchTestStateMachineHistory;
  withCurrentStateHistory(currentStateHistory: IBatchTestStateMachineHistory | null): BatchTestStateMachine;
   ...
   * @see #toJson
   */
  static fromJson(json: any): BatchTestStateMachine | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): BatchTestStateMachine | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): BatchTestStateMachine | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): BatchTestStateMachine | null;
   ...
   */
  replaceType(old: Type, new_: Type): BatchTestStateMachine;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): BatchTestStateMachine;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): BatchTestStateMachine;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<BatchTestStateMachine>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<BatchTestStateMachine>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): BatchTestStateMachine;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BatchTestStateMachine;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BatchTestStateMachine;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): BatchTestStateMachine;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): BatchTestStateMachine;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): BatchTestStateMachine;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): BatchTestStateMachine;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BatchTestStateMachine;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): BatchTestStateMachine;
   ...
   * @see #removeField
   */
  withoutField(field: string): BatchTestStateMachine;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): BatchTestStateMachine;
   ...
   */
  withoutFields(fields: Array_Type<string>): BatchTestStateMachine;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): BatchTestStateMachine;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): BatchTestStateMachine;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): BatchTestStateMachine;
   ...
   * @see #unsetField
   */
  defaultField(field: string): BatchTestStateMachine;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): BatchTestStateMachine;
   ...
   * @see #removeField
   */
  unsetField(field: string): BatchTestStateMachine;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): BatchTestStateMachine;
   ...
   * @see #unsetField
   */
  removeField(field: string): BatchTestStateMachine;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): BatchTestStateMachine;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): BatchTestStateMachine;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): BatchTestStateMachine;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): BatchTestStateMachine;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): BatchTestStateMachine;

  mergeJson(json: any): BatchTestStateMachine;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): BatchTestStateMachine;
   ...
   */
  sumObj(other: Obj, deep?: boolean): BatchTestStateMachine;
   ...
   */
  singletonArray(): Array_Type<BatchTestStateMachine>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<BatchTestStateMachine> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BatchTestStateMachine> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<BatchTestStateMachine>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BatchTestStateMachine> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, BatchTestStateMachine> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BatchTestStateMachine> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BatchTestStateMachine>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BatchTestStateMachine>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): BatchTestStateMachine;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): BatchTestStateMachine;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): BatchTestStateMachine;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): BatchTestStateMachine;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): BatchTestStateMachine;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): BatchTestStateMachine;
   ...
   * @see #fromString
   */
  static make(s: string): BatchTestStateMachine | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): BatchTestStateMachine;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): BatchTestStateMachine;
   ...
   */
  static cachedEmptyInst(): BatchTestStateMachine;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<BatchTestStateMachine> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): BatchTestStateMachine;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<BatchTestStateMachine>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<BatchTestStateMachine>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<BatchTestStateMachine> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<BatchTestStateMachine>> | null;
   ...
   */
  get(include?: string): BatchTestStateMachine | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): BatchTestStateMachine | null;
   ...
   */
  getMissing(spec: GetMissingSpec): BatchTestStateMachine;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): BatchTestStateMachine | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): BatchTestStateMachine;
   ...
   * @see #toString
   */
  static fromString(s: string): BatchTestStateMachine | null;
   ...
   */
  create(spec?: UpsertSpec): BatchTestStateMachine | null;
   ...
   */
  static createBatch(objs: Array_Type<BatchTestStateMachine>, spec?: UpsertSpec): ObjList<BatchTestStateMachine> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<BatchTestStateMachine>, spec?: CreateBatchObjStreamSpec): ObjList<BatchTestStateMachine> | null;
   ...
   */
  update(srcObj?: BatchTestStateMachine, spec?: UpsertSpec): BatchTestStateMachine | null;
   ...
   */
  upsert(srcObj?: BatchTestStateMachine, spec?: UpsertSpec): BatchTestStateMachine | null;
   ...
   */
  merge(spec?: MergeSpec): BatchTestStateMachine | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): BatchTestStateMachine | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): BatchTestStateMachine | null;
   ...
   */
  static updateBatch(objs: Array_Type<BatchTestStateMachine>, srcObjs?: Array_Type<BatchTestStateMachine>, spec?: UpsertSpec): ObjList<BatchTestStateMachine> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<BatchTestStateMachine> | null>, spec?: UpsertSpec): ObjList<BatchTestStateMachine> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<BatchTestStateMachine>, srcObjs?: Array_Type<BatchTestStateMachine>, spec?: UpsertSpec): ObjList<BatchTestStateMachine> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<BatchTestStateMachine> | null>, spec?: UpsertSpec): ObjList<BatchTestStateMachine> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<BatchTestStateMachine>, spec?: TouchSpec): ObjList<BatchTestStateMachine> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<BatchTestStateMachine>, spec?: MergeSpec): ObjList<BatchTestStateMachine> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<BatchTestStateMachine>, mergeInclude: string, spec?: MergeSpec): ObjList<BatchTestStateMachine> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<BatchTestStateMachine> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<BatchTestStateMachine> | null;
   ...
   */
  static mergeAll(mergeObj: BatchTestStateMachine, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: BatchTestStateMachine, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<BatchTestStateMachine>, spec?: UpsertSpec): ObjList<BatchTestStateMachine> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<BatchTestStateMachine>, spec?: UpsertSpec): ObjList<BatchTestStateMachine> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): BatchTestStateMachine | null;
   ...
   */
  static beforeCreate(objs: Array_Type<BatchTestStateMachine>): ObjList<BatchTestStateMachine>;
   ...
   */
  static beforeUpdate(objs: Array_Type<BatchTestStateMachine>): ObjList<BatchTestStateMachine>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<BatchTestStateMachine>): ObjList<BatchTestStateMachine>;

  /**
   * See {@link PersistableWritable#afterCreate}
   */
  static afterCreate(objs: Array_Type<BatchTestStateMachine>): Array_Type<ObjError> | null;
   ...
   */
  static afterUpdate(objs: Array_Type<BatchTestStateMachine>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<BatchTestStateMachine>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<BatchTestStateMachine>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<BatchTestStateMachine>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): BatchTestStateMachine | null;
   ...
   */
  withoutIdentity(): BatchTestStateMachine | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<BatchTestStateMachine>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: BatchTestStateMachine, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<BatchTestStateMachine>, callback?: λFunction<BatchTestStateMachine | null, BatchTestStateMachine | null>): ObjList<BatchTestStateMachine>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<BatchTestStateMachine>, callback?: λFunction<BatchTestStateMachine | null, BatchTestStateMachine | null>): Array_Type<ObjError> | null;
   ...
   */
  static transitionBatch(stateMachines: Array_Type<BatchTestStateMachine>, toState: BatchTestStateMachineState, retry?: number, stateHistoryParams?: BatchTestStateMachineHistory): Array_Type<StateMachineTransitionStatus<BatchTestStateMachineHistory, BatchTestStateMachineTransition>>;
   ...
   */
  transition(toState: BatchTestStateMachineState, testOnly?: boolean, stateHistoryParams?: BatchTestStateMachineHistory): StateMachineTransitionStatus<BatchTestStateMachineHistory, BatchTestStateMachineTransition>;
   ...
   */
  checkTransition(toState: BatchTestStateMachineState): boolean;
   ...
   */
  possibleStates(): Array_Type<BatchTestStateMachineState> | null;

  /**
   * Return list of all states in the {@link StateMachine}.
   */
  static allStates(): Array_Type<BatchTestStateMachineState> | null;

  /**
   * Return list of transitions possible from the current state given the current user permissions and current conditions.
   */
  possibleTransitions(): Array_Type<BatchTestStateMachineTransition> | null;
   ...
   */
  static allTransitions(fromState?: BatchTestStateMachineState, toState?: BatchTestStateMachineState): Array_Type<BatchTestStateMachineTransition> | null;
   ...
   */
  forceTransition(toState: BatchTestStateMachineState, stateHistoryParams?: BatchTestStateMachineHistory): boolean;
   ...
   */
  static forceTransitionBatch(stateMachines: Array_Type<BatchTestStateMachine>, toState: BatchTestStateMachineState, stateHistoryParams?: BatchTestStateMachineHistory): Map_Type<string, boolean>;
   ...
   */
  static stateRecoverBatch(stateMachines: Array_Type<BatchTestStateMachine>): Map_Type<string, boolean>;

  /**
   * Transition with a valid transition in the transitions array
   */
  transitionWithTransitions(transitions?: Array_Type<BatchTestStateMachineTransition>, testOnly?: boolean, stateHistoryParams?: BatchTestStateMachineHistory): StateMachineTransitionStatus<BatchTestStateMachineHistory, BatchTestStateMachineTransition>;
   ...
   */
  static doBeforeCreate(objs: Array_Type<BatchTestStateMachine>): ObjList<BatchTestStateMachine> | null;
   ...
   */
  static doAfterUpdate(objs: Array_Type<BatchTestStateMachine>): Array_Type<ObjError> | null;
   ...
   */
  static doAfterCreate(objs: Array_Type<BatchTestStateMachine>): ObjList<BatchTestStateMachine> | null;
   ...
   */
  executeTransition(transition: BatchTestStateMachineTransition, stateOrderCounter: number, stateHistoryParams?: BatchTestStateMachineHistory): BatchTestStateMachineHistory;
   ...
   */
  findTransitions(allTransitions: Array_Type<BatchTestStateMachineTransition>): Array_Type<BatchTestStateMachineTransition> | null;

  /**
   * Internal use only.
   * Implements a statemachine db lock.
   */
  reserveStateOrderCounter(): StateMachineTransitionStatus<BatchTestStateMachineHistory, BatchTestStateMachineTransition>;

  /**
   * Internal use only.
   * Verify whether the state machine is in error state.
   */
  checkStateMachine(): StateMachineTransitionStatus<BatchTestStateMachineHistory, BatchTestStateMachineTransition>;
   ...
   */
  transitionAndRefreshCurrentState(toState: BatchTestStateMachineState, stateHistoryParams?: BatchTestStateMachineHistory): StateMachineTransitionStatus<BatchTestStateMachineHistory, BatchTestStateMachineTransition>;

  /**
   * Used from the UI to batch transition and refresh currentState stored calc.
   */
  static transitionBatchAndRefreshCurrentState(stateMachines: Array_Type<BatchTestStateMachine>, toState: BatchTestStateMachineState, retry?: number, stateHistoryParams?: BatchTestStateMachineHistory): Array_Type<StateMachineTransitionStatus<BatchTestStateMachineHistory, BatchTestStateMachineTransition>>;
