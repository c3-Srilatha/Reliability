// TypeScript definitions for the C3 type StateMachineState

/**
 * Type to represent a state in a state machine.
 *
 * @remarks this represents a value passed to a method that expects an instance of StateMachineState
 */
declare interface IStateMachineState<S, T> {
   ...
   */
  autoTransitions?: Array_Type<T> | Array<T>;
   ...
   */
  periodicTransitions?: Array_Type<T> | Array<T>;
 ...
 * Type to represent a state in a state machine.
 *
 * @remarks this represents a made instance of StateMachineState
 */
declare class StateMachineState<S, T> extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): StateMachineState;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): StateMachineState;

  /**
   * The name of this {@link StateMachineState}.
   */
  readonly name?: string;
  withName(name: string | null): StateMachineState;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): StateMachineState;
  ...
  withVersion(version: number | null): StateMachineState;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): StateMachineState;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): StateMachineState;
  ...
  withHidden(hidden: boolean): StateMachineState;
  ...
  withUserOwned(userOwned: boolean): StateMachineState;
  ...
  withDisplayName(displayName: string | null): StateMachineState;
  ...
  withInitialState(initialState: boolean): StateMachineState;

  /**
   * Used to soft delete a record so all state histories still have valid pointers.
   */
  readonly deleted?: boolean;
  withDeleted(deleted: boolean): StateMachineState;

  /**
   * Used to include fields on the source type for exitAction and entryAction.
   */
  readonly includeSpec?: string;
  withIncludeSpec(includeSpec: string | null): StateMachineState;

  /**
   * Action to be triggered when leaving this state.
   */
  readonly exitAction?: λConsumer<any | null>;
  withExitAction(exitAction: λConsumer<any | null> | null): StateMachineState;

  /**
   * Action to be triggered when entering this state.
   */
  readonly entryAction?: λConsumer<any | null>;
  withEntryAction(entryAction: λConsumer<any | null> | null): StateMachineState;

  /**
   * The list of automatic transitions from this state to another that are {@link StateMachineTransition#isValid}.
   */
  readonly autoTransitions?: Array_Type<T>;
  withAutoTransitions(autoTransitions: Array_Type<T> | Array<T> | null): StateMachineState;

  /**
   * Whether this state has automatic transitions.
   */
  readonly hasAutoTransition?: boolean;
  withHasAutoTransition(hasAutoTransition: boolean): StateMachineState;

  /**
   * The list of periodic transitions from this state to another that are {@link StateMachineTransition#isValid}.
   */
  readonly periodicTransitions?: Array_Type<T>;
  withPeriodicTransitions(periodicTransitions: Array_Type<T> | Array<T> | null): StateMachineState;

  /**
   * Whether this state has periodic transitions.
   */
  readonly hasPeriodicTransitions?: boolean;
  withHasPeriodicTransitions(hasPeriodicTransitions: boolean): StateMachineState;

  /**
   * {@link StateMachineTransition}s that originate from this {@link StateMachineState}.
   */
  readonly fromTransitions?: Array_Type<T>;
  withFromTransitions(fromTransitions: Array_Type<T> | Array<T> | null): StateMachineState;

  /**
   * {@link StateMachineTransition}s that lead into this {@link StateMachineState}.
   */
  readonly toTransitions?: Array_Type<T>;
  withToTransitions(toTransitions: Array_Type<T> | Array<T> | null): StateMachineState;
   ...
   * @see #toJson
   */
  static fromJson(json: any): StateMachineState<S, T> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): StateMachineState<S, T> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): StateMachineState<S, T> | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): StateMachineState<S, T> | null;
   ...
   */
  replaceType(old: Type, new_: Type): StateMachineState<S, T>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): StateMachineState<S, T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): StateMachineState<S, T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<StateMachineState<S, T>>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<StateMachineState<S, T>>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): StateMachineState<S, T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): StateMachineState<S, T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): StateMachineState<S, T>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): StateMachineState<S, T>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): StateMachineState<S, T>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): StateMachineState<S, T>;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): StateMachineState<S, T>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): StateMachineState<S, T>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): StateMachineState<S, T>;
   ...
   * @see #removeField
   */
  withoutField(field: string): StateMachineState<S, T>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): StateMachineState<S, T>;
   ...
   */
  withoutFields(fields: Array_Type<string>): StateMachineState<S, T>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): StateMachineState<S, T>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): StateMachineState<S, T>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): StateMachineState<S, T>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): StateMachineState<S, T>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): StateMachineState<S, T>;
   ...
   * @see #removeField
   */
  unsetField(field: string): StateMachineState<S, T>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): StateMachineState<S, T>;
   ...
   * @see #unsetField
   */
  removeField(field: string): StateMachineState<S, T>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): StateMachineState<S, T>;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): StateMachineState<S, T>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): StateMachineState<S, T>;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): StateMachineState<S, T>;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): StateMachineState<S, T>;

  mergeJson(json: any): StateMachineState<S, T>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): StateMachineState<S, T>;
   ...
   */
  sumObj(other: Obj, deep?: boolean): StateMachineState<S, T>;
   ...
   */
  singletonArray(): Array_Type<StateMachineState<S, T>>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<StateMachineState<S, T>> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<StateMachineState<S, T>> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<StateMachineState<S, T>>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<StateMachineState<S, T>> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, StateMachineState<S, T>> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, StateMachineState<S, T>> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<StateMachineState<S, T>>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<StateMachineState<S, T>>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): StateMachineState<S, T>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): StateMachineState<S, T>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): StateMachineState<S, T>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): StateMachineState<S, T>;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): StateMachineState<S, T>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): StateMachineState<S, T>;
   ...
   * @see #fromString
   */
  static make(s: string): StateMachineState<S, T> | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): StateMachineState<S, T>;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): StateMachineState<S, T>;
   ...
   */
  static cachedEmptyInst(): StateMachineState<S, T>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<StateMachineState<S, T>> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): StateMachineState<S, T>;
   ...
   */
  static allCached(): Stream<StateMachineState<S, T>> | null;
   ...
   */
  static find(filter?: string): Stream<StateMachineState<S, T>> | null;
   ...
   *         Otherwise no population will be performed.
   */
  static findBy(field: string, value: any): Stream<StateMachineState<S, T>> | null;

  /**
   * @return cached instance.
   */
  getCached(): StateMachineState<S, T> | null;

  /**
   * @return cached instance by the key.
   */
  static forCacheKey(key: string): StateMachineState<S, T> | null;
   ...
   */
  static produce(key: string): StateMachineState<S, T> | null;

  /**
   * Should produces the entire content for the cached data. Will populate the cache with the produced data.
   */
  static produceAll(): Map_Type<string, StateMachineState<S, T>> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<StateMachineState<S, T>>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<StateMachineState<S, T>>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<StateMachineState<S, T>> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<StateMachineState<S, T>>> | null;
   ...
   */
  get(include?: string): StateMachineState<S, T> | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): StateMachineState<S, T> | null;
   ...
   */
  getMissing(spec: GetMissingSpec): StateMachineState<S, T>;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): StateMachineState<S, T> | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): StateMachineState<S, T>;
   ...
   * @see #toString
   */
  static fromString(s: string): StateMachineState<S, T> | null;
   ...
   */
  create(spec?: UpsertSpec): StateMachineState<S, T> | null;
   ...
   */
  static createBatch(objs: Array_Type<StateMachineState<S, T>>, spec?: UpsertSpec): ObjList<StateMachineState<S, T>> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<StateMachineState<S, T>>, spec?: CreateBatchObjStreamSpec): ObjList<StateMachineState<S, T>> | null;
   ...
   */
  update(srcObj?: StateMachineState<S, T>, spec?: UpsertSpec): StateMachineState<S, T> | null;
   ...
   */
  upsert(srcObj?: StateMachineState<S, T>, spec?: UpsertSpec): StateMachineState<S, T> | null;
   ...
   */
  merge(spec?: MergeSpec): StateMachineState<S, T> | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): StateMachineState<S, T> | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): StateMachineState<S, T> | null;
   ...
   */
  static updateBatch(objs: Array_Type<StateMachineState<S, T>>, srcObjs?: Array_Type<StateMachineState<S, T>>, spec?: UpsertSpec): ObjList<StateMachineState<S, T>> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<StateMachineState<S, T>> | null>, spec?: UpsertSpec): ObjList<StateMachineState<S, T>> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<StateMachineState<S, T>>, srcObjs?: Array_Type<StateMachineState<S, T>>, spec?: UpsertSpec): ObjList<StateMachineState<S, T>> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<StateMachineState<S, T>> | null>, spec?: UpsertSpec): ObjList<StateMachineState<S, T>> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<StateMachineState<S, T>>, spec?: TouchSpec): ObjList<StateMachineState<S, T>> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<StateMachineState<S, T>>, spec?: MergeSpec): ObjList<StateMachineState<S, T>> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<StateMachineState<S, T>>, mergeInclude: string, spec?: MergeSpec): ObjList<StateMachineState<S, T>> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<StateMachineState<S, T>> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<StateMachineState<S, T>> | null;
   ...
   */
  static mergeAll(mergeObj: StateMachineState<S, T>, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: StateMachineState<S, T>, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<StateMachineState<S, T>>, spec?: UpsertSpec): ObjList<StateMachineState<S, T>> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<StateMachineState<S, T>>, spec?: UpsertSpec): ObjList<StateMachineState<S, T>> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): StateMachineState<S, T> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<StateMachineState<S, T>>): ObjList<StateMachineState<S, T>>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<StateMachineState<S, T>>): ObjList<StateMachineState<S, T>>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<StateMachineState<S, T>>): ObjList<StateMachineState<S, T>>;
   ...
   */
  static afterCreate(objs: Array_Type<StateMachineState<S, T>>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<StateMachineState<S, T>>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<StateMachineState<S, T>>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<StateMachineState<S, T>>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<StateMachineState<S, T>>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): StateMachineState<S, T> | null;
   ...
   */
  withoutIdentity(): StateMachineState<S, T> | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<StateMachineState<S, T>>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: StateMachineState<S, T>, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<StateMachineState<S, T>>, callback?: λFunction<StateMachineState<S, T> | null, StateMachineState<S, T> | null>): ObjList<StateMachineState<S, T>>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<StateMachineState<S, T>>, callback?: λFunction<StateMachineState<S, T> | null, StateMachineState<S, T> | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): StateMachineState<S, T>;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<StateMachineState<S, T>> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): StateMachineState<S, T> | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<StateMachineState<S, T>> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): StateMachineState<S, T> | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<StateMachineState<S, T>> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): StateMachineState<S, T> | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<StateMachineState<S, T>> | null;
  ...
  dependencies(): SeedDataDeps<StateMachineState<S, T>> | null;
