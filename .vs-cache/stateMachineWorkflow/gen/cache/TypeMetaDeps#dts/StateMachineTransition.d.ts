// TypeScript definitions for the C3 type StateMachineTransition

/**
 * Type to represent a transition between two {@link StateMachineState}s.
 *
 * @remarks this represents a value passed to a method that expects an instance of StateMachineTransition
 */
declare interface IStateMachineTransition<S, T> {
 ...
 */
declare class StateMachineTransition<S, T> extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): StateMachineTransition;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): StateMachineTransition;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): StateMachineTransition;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): StateMachineTransition;
  ...
  withVersion(version: number | null): StateMachineTransition;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): StateMachineTransition;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): StateMachineTransition;
  ...
  withHidden(hidden: boolean): StateMachineTransition;
  ...
  withUserOwned(userOwned: boolean): StateMachineTransition;

  /**
   * List of {@link AclEntry} entries governing who can read/update/remove Objs.
   */
  readonly acl?: Array_Type<AclEntry>;
  withAcl(acl: Array_Type<AclEntry> | Array<IAclEntry> | null): StateMachineTransition;

  /**
   * The {@link StateMachineState} to transition from.
   */
  readonly from: S;
  withFrom(from: S): StateMachineTransition;

  /**
   * The {@link StateMachineState} to transition to.
   */
  readonly to: S;
  withTo(to: S): StateMachineTransition;

  /**
   * Used to soft delete a record so all state histories still have valid pointers.
   */
  readonly deleted?: boolean;
  withDeleted(deleted: boolean): StateMachineTransition;

  /**
   * A transition is only valid if the {@link from}, {@link to}, and itself are not deleted.
   */
  readonly isValid?: boolean;
  withIsValid(isValid: boolean): StateMachineTransition;

  /**
   * The trigger that must be satisfied in order for this transition to take place.
   */
  readonly trigger?: TransitionTrigger;
  withTrigger(trigger: ITransitionTrigger | null): StateMachineTransition;
  ...
  withCondition(condition: string | null): StateMachineTransition;

  /**
   * Used to include fields on the source type for exitAction and entryAction.
   */
  readonly includeSpec?: string;
  withIncludeSpec(includeSpec: string | null): StateMachineTransition;

  /**
   * The action to be taken during this {@link StateMachineTransition}.
   */
  readonly action?: λConsumer<any | null>;
  withAction(action: λConsumer<any | null> | null): StateMachineTransition;
   ...
   * @see #toJson
   */
  static fromJson(json: any): StateMachineTransition<S, T> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): StateMachineTransition<S, T> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): StateMachineTransition<S, T> | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): StateMachineTransition<S, T> | null;
   ...
   */
  replaceType(old: Type, new_: Type): StateMachineTransition<S, T>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): StateMachineTransition<S, T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): StateMachineTransition<S, T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<StateMachineTransition<S, T>>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<StateMachineTransition<S, T>>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): StateMachineTransition<S, T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): StateMachineTransition<S, T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): StateMachineTransition<S, T>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): StateMachineTransition<S, T>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): StateMachineTransition<S, T>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): StateMachineTransition<S, T>;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): StateMachineTransition<S, T>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): StateMachineTransition<S, T>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): StateMachineTransition<S, T>;
   ...
   * @see #removeField
   */
  withoutField(field: string): StateMachineTransition<S, T>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): StateMachineTransition<S, T>;
   ...
   */
  withoutFields(fields: Array_Type<string>): StateMachineTransition<S, T>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): StateMachineTransition<S, T>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): StateMachineTransition<S, T>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): StateMachineTransition<S, T>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): StateMachineTransition<S, T>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): StateMachineTransition<S, T>;
   ...
   * @see #removeField
   */
  unsetField(field: string): StateMachineTransition<S, T>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): StateMachineTransition<S, T>;
   ...
   * @see #unsetField
   */
  removeField(field: string): StateMachineTransition<S, T>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): StateMachineTransition<S, T>;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): StateMachineTransition<S, T>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): StateMachineTransition<S, T>;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): StateMachineTransition<S, T>;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): StateMachineTransition<S, T>;

  mergeJson(json: any): StateMachineTransition<S, T>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): StateMachineTransition<S, T>;
   ...
   */
  sumObj(other: Obj, deep?: boolean): StateMachineTransition<S, T>;
   ...
   */
  singletonArray(): Array_Type<StateMachineTransition<S, T>>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<StateMachineTransition<S, T>> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<StateMachineTransition<S, T>> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<StateMachineTransition<S, T>>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<StateMachineTransition<S, T>> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, StateMachineTransition<S, T>> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, StateMachineTransition<S, T>> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<StateMachineTransition<S, T>>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<StateMachineTransition<S, T>>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): StateMachineTransition<S, T>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): StateMachineTransition<S, T>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): StateMachineTransition<S, T>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): StateMachineTransition<S, T>;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): StateMachineTransition<S, T>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): StateMachineTransition<S, T>;
   ...
   * @see #fromString
   */
  static make(s: string): StateMachineTransition<S, T> | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): StateMachineTransition<S, T>;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): StateMachineTransition<S, T>;
   ...
   */
  static cachedEmptyInst(): StateMachineTransition<S, T>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<StateMachineTransition<S, T>> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): StateMachineTransition<S, T>;
   ...
   */
  static allCached(): Stream<StateMachineTransition<S, T>> | null;
   ...
   */
  static find(filter?: string): Stream<StateMachineTransition<S, T>> | null;
   ...
   *         Otherwise no population will be performed.
   */
  static findBy(field: string, value: any): Stream<StateMachineTransition<S, T>> | null;

  /**
   * @return cached instance.
   */
  getCached(): StateMachineTransition<S, T> | null;

  /**
   * @return cached instance by the key.
   */
  static forCacheKey(key: string): StateMachineTransition<S, T> | null;
   ...
   */
  static produce(key: string): StateMachineTransition<S, T> | null;

  /**
   * Should produces the entire content for the cached data. Will populate the cache with the produced data.
   */
  static produceAll(): Map_Type<string, StateMachineTransition<S, T>> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<StateMachineTransition<S, T>>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<StateMachineTransition<S, T>>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<StateMachineTransition<S, T>> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<StateMachineTransition<S, T>>> | null;
   ...
   */
  get(include?: string): StateMachineTransition<S, T> | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): StateMachineTransition<S, T> | null;
   ...
   */
  getMissing(spec: GetMissingSpec): StateMachineTransition<S, T>;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): StateMachineTransition<S, T> | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): StateMachineTransition<S, T>;
   ...
   * @see #toString
   */
  static fromString(s: string): StateMachineTransition<S, T> | null;
   ...
   */
  create(spec?: UpsertSpec): StateMachineTransition<S, T> | null;
   ...
   */
  static createBatch(objs: Array_Type<StateMachineTransition<S, T>>, spec?: UpsertSpec): ObjList<StateMachineTransition<S, T>> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<StateMachineTransition<S, T>>, spec?: CreateBatchObjStreamSpec): ObjList<StateMachineTransition<S, T>> | null;
   ...
   */
  update(srcObj?: StateMachineTransition<S, T>, spec?: UpsertSpec): StateMachineTransition<S, T> | null;
   ...
   */
  upsert(srcObj?: StateMachineTransition<S, T>, spec?: UpsertSpec): StateMachineTransition<S, T> | null;
   ...
   */
  merge(spec?: MergeSpec): StateMachineTransition<S, T> | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): StateMachineTransition<S, T> | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): StateMachineTransition<S, T> | null;
   ...
   */
  static updateBatch(objs: Array_Type<StateMachineTransition<S, T>>, srcObjs?: Array_Type<StateMachineTransition<S, T>>, spec?: UpsertSpec): ObjList<StateMachineTransition<S, T>> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<StateMachineTransition<S, T>> | null>, spec?: UpsertSpec): ObjList<StateMachineTransition<S, T>> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<StateMachineTransition<S, T>>, srcObjs?: Array_Type<StateMachineTransition<S, T>>, spec?: UpsertSpec): ObjList<StateMachineTransition<S, T>> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<StateMachineTransition<S, T>> | null>, spec?: UpsertSpec): ObjList<StateMachineTransition<S, T>> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<StateMachineTransition<S, T>>, spec?: TouchSpec): ObjList<StateMachineTransition<S, T>> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<StateMachineTransition<S, T>>, spec?: MergeSpec): ObjList<StateMachineTransition<S, T>> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<StateMachineTransition<S, T>>, mergeInclude: string, spec?: MergeSpec): ObjList<StateMachineTransition<S, T>> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<StateMachineTransition<S, T>> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<StateMachineTransition<S, T>> | null;
   ...
   */
  static mergeAll(mergeObj: StateMachineTransition<S, T>, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: StateMachineTransition<S, T>, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<StateMachineTransition<S, T>>, spec?: UpsertSpec): ObjList<StateMachineTransition<S, T>> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<StateMachineTransition<S, T>>, spec?: UpsertSpec): ObjList<StateMachineTransition<S, T>> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): StateMachineTransition<S, T> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<StateMachineTransition<S, T>>): ObjList<StateMachineTransition<S, T>>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<StateMachineTransition<S, T>>): ObjList<StateMachineTransition<S, T>>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<StateMachineTransition<S, T>>): ObjList<StateMachineTransition<S, T>>;
   ...
   */
  static afterCreate(objs: Array_Type<StateMachineTransition<S, T>>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<StateMachineTransition<S, T>>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<StateMachineTransition<S, T>>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<StateMachineTransition<S, T>>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<StateMachineTransition<S, T>>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): StateMachineTransition<S, T> | null;
   ...
   */
  withoutIdentity(): StateMachineTransition<S, T> | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<StateMachineTransition<S, T>>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: StateMachineTransition<S, T>, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<StateMachineTransition<S, T>>, callback?: λFunction<StateMachineTransition<S, T> | null, StateMachineTransition<S, T> | null>): ObjList<StateMachineTransition<S, T>>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<StateMachineTransition<S, T>>, callback?: λFunction<StateMachineTransition<S, T> | null, StateMachineTransition<S, T> | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): StateMachineTransition<S, T>;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<StateMachineTransition<S, T>> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): StateMachineTransition<S, T> | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<StateMachineTransition<S, T>> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): StateMachineTransition<S, T> | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<StateMachineTransition<S, T>> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): StateMachineTransition<S, T> | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<StateMachineTransition<S, T>> | null;
  ...
  dependencies(): SeedDataDeps<StateMachineTransition<S, T>> | null;
   ...
   */
  static populateAcl(objs?: Array_Type<StateMachineTransition<S, T>>): number | null;
   ...
   */
  grantMemberReadUpdateRemove(member: AccessControlEntity): StateMachineTransition<S, T>;
   ...
   */
  mergeAclEntry(entry: AclEntry): StateMachineTransition<S, T>;
   ...
   * @return the obj with the new acl after merging the indicated entry.
   */
  mergeAclEntries(entries: Array_Type<AclEntry>): StateMachineTransition<S, T>;
