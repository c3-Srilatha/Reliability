// TypeScript definitions for the C3 type AbstractStateMachine

/**
 * Type to test that {@link ScheduledTransitionTriggers#doStart} handles abstract types.
 *
 * @remarks this represents a value passed to a method that expects an instance of AbstractStateMachine
 */
declare interface IAbstractStateMachine<SMH, SMS, SMT> {
   ...
   */
  stateHistories?: Array_Type<SMH> | Array<SMH>;

  /**
   * Transitions available from the current state
   */
  transitions?: Array_Type<SMT> | Array<SMT>;

  /**
   * Calc field to get the current state history
   */
  currentStateHistory?: SMH;
}
 ...
 */
declare class AbstractStateMachine<SMH, SMS, SMT> extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): AbstractStateMachine;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): AbstractStateMachine;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): AbstractStateMachine;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): AbstractStateMachine;
  ...
  withVersion(version: number | null): AbstractStateMachine;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): AbstractStateMachine;

  /**
   * A stored calc field representing the current state - uses a {@link StateMachineHistory} to keep track.
   */
  readonly currentState?: SMS;
  withCurrentState(currentState: SMS | null): AbstractStateMachine;

  /**
   * A collection of the states this {@link StateMachine} has passed through.
   */
  readonly stateHistories?: Array_Type<SMH>;
  withStateHistories(stateHistories: Array_Type<SMH> | Array<SMH> | null): AbstractStateMachine;

  /**
   * Transitions available from the current state
   */
  readonly transitions?: Array_Type<SMT>;
  withTransitions(transitions: Array_Type<SMT> | Array<SMT> | null): AbstractStateMachine;

  /**
   * Calc field to get the current state history
   */
  readonly currentStateHistory?: SMH;
  withCurrentStateHistory(currentStateHistory: SMH | null): AbstractStateMachine;
   ...
   * @see #toJson
   */
  static fromJson(json: any): AbstractStateMachine<SMH, SMS, SMT> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): AbstractStateMachine<SMH, SMS, SMT> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): AbstractStateMachine<SMH, SMS, SMT> | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): AbstractStateMachine<SMH, SMS, SMT> | null;
   ...
   */
  replaceType(old: Type, new_: Type): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<AbstractStateMachine<SMH, SMS, SMT>>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<AbstractStateMachine<SMH, SMS, SMT>>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AbstractStateMachine<SMH, SMS, SMT>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   * @see #removeField
   */
  withoutField(field: string): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   */
  withoutFields(fields: Array_Type<string>): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): AbstractStateMachine<SMH, SMS, SMT>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   * @see #removeField
   */
  unsetField(field: string): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   * @see #unsetField
   */
  removeField(field: string): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): AbstractStateMachine<SMH, SMS, SMT>;

  mergeJson(json: any): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   */
  sumObj(other: Obj, deep?: boolean): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   */
  singletonArray(): Array_Type<AbstractStateMachine<SMH, SMS, SMT>>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<AbstractStateMachine<SMH, SMS, SMT>> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<AbstractStateMachine<SMH, SMS, SMT>> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<AbstractStateMachine<SMH, SMS, SMT>>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<AbstractStateMachine<SMH, SMS, SMT>> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, AbstractStateMachine<SMH, SMS, SMT>> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, AbstractStateMachine<SMH, SMS, SMT>> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<AbstractStateMachine<SMH, SMS, SMT>>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<AbstractStateMachine<SMH, SMS, SMT>>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): AbstractStateMachine<SMH, SMS, SMT>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   * @see #fromString
   */
  static make(s: string): AbstractStateMachine<SMH, SMS, SMT> | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   */
  static cachedEmptyInst(): AbstractStateMachine<SMH, SMS, SMT>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<AbstractStateMachine<SMH, SMS, SMT>> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<AbstractStateMachine<SMH, SMS, SMT>>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<AbstractStateMachine<SMH, SMS, SMT>>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<AbstractStateMachine<SMH, SMS, SMT>> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<AbstractStateMachine<SMH, SMS, SMT>>> | null;
   ...
   */
  get(include?: string): AbstractStateMachine<SMH, SMS, SMT> | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): AbstractStateMachine<SMH, SMS, SMT> | null;
   ...
   */
  getMissing(spec: GetMissingSpec): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): AbstractStateMachine<SMH, SMS, SMT> | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): AbstractStateMachine<SMH, SMS, SMT>;
   ...
   * @see #toString
   */
  static fromString(s: string): AbstractStateMachine<SMH, SMS, SMT> | null;
   ...
   */
  create(spec?: UpsertSpec): AbstractStateMachine<SMH, SMS, SMT> | null;
   ...
   */
  static createBatch(objs: Array_Type<AbstractStateMachine<SMH, SMS, SMT>>, spec?: UpsertSpec): ObjList<AbstractStateMachine<SMH, SMS, SMT>> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<AbstractStateMachine<SMH, SMS, SMT>>, spec?: CreateBatchObjStreamSpec): ObjList<AbstractStateMachine<SMH, SMS, SMT>> | null;
   ...
   */
  update(srcObj?: AbstractStateMachine<SMH, SMS, SMT>, spec?: UpsertSpec): AbstractStateMachine<SMH, SMS, SMT> | null;
   ...
   */
  upsert(srcObj?: AbstractStateMachine<SMH, SMS, SMT>, spec?: UpsertSpec): AbstractStateMachine<SMH, SMS, SMT> | null;
   ...
   */
  merge(spec?: MergeSpec): AbstractStateMachine<SMH, SMS, SMT> | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): AbstractStateMachine<SMH, SMS, SMT> | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): AbstractStateMachine<SMH, SMS, SMT> | null;
   ...
   */
  static updateBatch(objs: Array_Type<AbstractStateMachine<SMH, SMS, SMT>>, srcObjs?: Array_Type<AbstractStateMachine<SMH, SMS, SMT>>, spec?: UpsertSpec): ObjList<AbstractStateMachine<SMH, SMS, SMT>> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<AbstractStateMachine<SMH, SMS, SMT>> | null>, spec?: UpsertSpec): ObjList<AbstractStateMachine<SMH, SMS, SMT>> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<AbstractStateMachine<SMH, SMS, SMT>>, srcObjs?: Array_Type<AbstractStateMachine<SMH, SMS, SMT>>, spec?: UpsertSpec): ObjList<AbstractStateMachine<SMH, SMS, SMT>> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<AbstractStateMachine<SMH, SMS, SMT>> | null>, spec?: UpsertSpec): ObjList<AbstractStateMachine<SMH, SMS, SMT>> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<AbstractStateMachine<SMH, SMS, SMT>>, spec?: TouchSpec): ObjList<AbstractStateMachine<SMH, SMS, SMT>> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<AbstractStateMachine<SMH, SMS, SMT>>, spec?: MergeSpec): ObjList<AbstractStateMachine<SMH, SMS, SMT>> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<AbstractStateMachine<SMH, SMS, SMT>>, mergeInclude: string, spec?: MergeSpec): ObjList<AbstractStateMachine<SMH, SMS, SMT>> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<AbstractStateMachine<SMH, SMS, SMT>> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<AbstractStateMachine<SMH, SMS, SMT>> | null;
   ...
   */
  static mergeAll(mergeObj: AbstractStateMachine<SMH, SMS, SMT>, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: AbstractStateMachine<SMH, SMS, SMT>, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<AbstractStateMachine<SMH, SMS, SMT>>, spec?: UpsertSpec): ObjList<AbstractStateMachine<SMH, SMS, SMT>> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<AbstractStateMachine<SMH, SMS, SMT>>, spec?: UpsertSpec): ObjList<AbstractStateMachine<SMH, SMS, SMT>> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): AbstractStateMachine<SMH, SMS, SMT> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<AbstractStateMachine<SMH, SMS, SMT>>): ObjList<AbstractStateMachine<SMH, SMS, SMT>>;
   ...
   */
  static beforeUpdate(objs: Array_Type<AbstractStateMachine<SMH, SMS, SMT>>): ObjList<AbstractStateMachine<SMH, SMS, SMT>>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<AbstractStateMachine<SMH, SMS, SMT>>): ObjList<AbstractStateMachine<SMH, SMS, SMT>>;

  /**
   * See {@link PersistableWritable#afterCreate}
   */
  static afterCreate(objs: Array_Type<AbstractStateMachine<SMH, SMS, SMT>>): Array_Type<ObjError> | null;
   ...
   */
  static afterUpdate(objs: Array_Type<AbstractStateMachine<SMH, SMS, SMT>>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<AbstractStateMachine<SMH, SMS, SMT>>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<AbstractStateMachine<SMH, SMS, SMT>>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<AbstractStateMachine<SMH, SMS, SMT>>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): AbstractStateMachine<SMH, SMS, SMT> | null;
   ...
   */
  withoutIdentity(): AbstractStateMachine<SMH, SMS, SMT> | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<AbstractStateMachine<SMH, SMS, SMT>>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: AbstractStateMachine<SMH, SMS, SMT>, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<AbstractStateMachine<SMH, SMS, SMT>>, callback?: λFunction<AbstractStateMachine<SMH, SMS, SMT> | null, AbstractStateMachine<SMH, SMS, SMT> | null>): ObjList<AbstractStateMachine<SMH, SMS, SMT>>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<AbstractStateMachine<SMH, SMS, SMT>>, callback?: λFunction<AbstractStateMachine<SMH, SMS, SMT> | null, AbstractStateMachine<SMH, SMS, SMT> | null>): Array_Type<ObjError> | null;
   ...
   */
  static transitionBatch(stateMachines: Array_Type<AbstractStateMachine<SMH, SMS, SMT>>, toState: SMS, retry?: number, stateHistoryParams?: SMH): Array_Type<StateMachineTransitionStatus<SMH, SMT>>;
   ...
   */
  transition(toState: SMS, testOnly?: boolean, stateHistoryParams?: SMH): StateMachineTransitionStatus<SMH, SMT>;
   ...
   */
  checkTransition(toState: SMS): boolean;
   ...
   */
  static allTransitions(fromState?: SMS, toState?: SMS): Array_Type<SMT> | null;
   ...
   */
  forceTransition(toState: SMS, stateHistoryParams?: SMH): boolean;
   ...
   */
  static forceTransitionBatch(stateMachines: Array_Type<AbstractStateMachine<SMH, SMS, SMT>>, toState: SMS, stateHistoryParams?: SMH): Map_Type<string, boolean>;
   ...
   */
  static stateRecoverBatch(stateMachines: Array_Type<AbstractStateMachine<SMH, SMS, SMT>>): Map_Type<string, boolean>;

  /**
   * Transition with a valid transition in the transitions array
   */
  transitionWithTransitions(transitions?: Array_Type<SMT>, testOnly?: boolean, stateHistoryParams?: SMH): StateMachineTransitionStatus<SMH, SMT>;
   ...
   */
  static doBeforeCreate(objs: Array_Type<AbstractStateMachine<SMH, SMS, SMT>>): ObjList<AbstractStateMachine<SMH, SMS, SMT>> | null;
   ...
   */
  static doAfterUpdate(objs: Array_Type<AbstractStateMachine<SMH, SMS, SMT>>): Array_Type<ObjError> | null;
   ...
   */
  static doAfterCreate(objs: Array_Type<AbstractStateMachine<SMH, SMS, SMT>>): ObjList<AbstractStateMachine<SMH, SMS, SMT>> | null;
   ...
   */
  executeTransition(transition: SMT, stateOrderCounter: number, stateHistoryParams?: SMH): SMH;
   ...
   */
  findTransitions(allTransitions: Array_Type<SMT>): Array_Type<SMT> | null;

  /**
   * Internal use only.
   * Implements a statemachine db lock.
   */
  reserveStateOrderCounter(): StateMachineTransitionStatus<SMH, SMT>;

  /**
   * Internal use only.
   * Verify whether the state machine is in error state.
   */
  checkStateMachine(): StateMachineTransitionStatus<SMH, SMT>;
   ...
   */
  transitionAndRefreshCurrentState(toState: SMS, stateHistoryParams?: SMH): StateMachineTransitionStatus<SMH, SMT>;

  /**
   * Used from the UI to batch transition and refresh currentState stored calc.
   */
  static transitionBatchAndRefreshCurrentState(stateMachines: Array_Type<AbstractStateMachine<SMH, SMS, SMT>>, toState: SMS, retry?: number, stateHistoryParams?: SMH): Array_Type<StateMachineTransitionStatus<SMH, SMT>>;
