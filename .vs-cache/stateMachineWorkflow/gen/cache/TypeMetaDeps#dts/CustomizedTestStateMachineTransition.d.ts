// TypeScript definitions for the C3 type CustomizedTestStateMachineTransition

/**
 * Entity type `CustomizedTestStateMachineTransition` represents a transition within the `CustomizedTestStateMachine`.
 *
 * @remarks this represents a value passed to a method that expects an instance of CustomizedTestStateMachineTransition
 */
declare interface ICustomizedTestStateMachineTransition {
   ...
   */
  from: ICustomizedTestStateMachineState;

  /**
   * The {@link StateMachineState} to transition to.
   */
  to: ICustomizedTestStateMachineState;
 ...
 * Entity type `CustomizedTestStateMachineTransition` represents a transition within the `CustomizedTestStateMachine`.
 *
 * @remarks this represents a made instance of CustomizedTestStateMachineTransition
 */
declare class CustomizedTestStateMachineTransition extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): CustomizedTestStateMachineTransition;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): CustomizedTestStateMachineTransition;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): CustomizedTestStateMachineTransition;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): CustomizedTestStateMachineTransition;
  ...
  withVersion(version: number | null): CustomizedTestStateMachineTransition;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): CustomizedTestStateMachineTransition;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): CustomizedTestStateMachineTransition;
  ...
  withHidden(hidden: boolean): CustomizedTestStateMachineTransition;
  ...
  withUserOwned(userOwned: boolean): CustomizedTestStateMachineTransition;

  /**
   * List of {@link AclEntry} entries governing who can read/update/remove Objs.
   */
  readonly acl?: Array_Type<AclEntry>;
  withAcl(acl: Array_Type<AclEntry> | Array<IAclEntry> | null): CustomizedTestStateMachineTransition;

  /**
   * The {@link StateMachineState} to transition from.
   */
  readonly from: CustomizedTestStateMachineState;
  withFrom(from: ICustomizedTestStateMachineState): CustomizedTestStateMachineTransition;

  /**
   * The {@link StateMachineState} to transition to.
   */
  readonly to: CustomizedTestStateMachineState;
  withTo(to: ICustomizedTestStateMachineState): CustomizedTestStateMachineTransition;

  /**
   * Used to soft delete a record so all state histories still have valid pointers.
   */
  readonly deleted?: boolean;
  withDeleted(deleted: boolean): CustomizedTestStateMachineTransition;

  /**
   * A transition is only valid if the {@link from}, {@link to}, and itself are not deleted.
   */
  readonly isValid?: boolean;
  withIsValid(isValid: boolean): CustomizedTestStateMachineTransition;

  /**
   * The trigger that must be satisfied in order for this transition to take place.
   */
  readonly trigger?: TransitionTrigger;
  withTrigger(trigger: ITransitionTrigger | null): CustomizedTestStateMachineTransition;
  ...
  withCondition(condition: string | null): CustomizedTestStateMachineTransition;

  /**
   * Used to include fields on the source type for exitAction and entryAction.
   */
  readonly includeSpec?: string;
  withIncludeSpec(includeSpec: string | null): CustomizedTestStateMachineTransition;

  /**
   * The action to be taken during this {@link StateMachineTransition}.
   */
  readonly action?: λConsumer<any | null>;
  withAction(action: λConsumer<any | null> | null): CustomizedTestStateMachineTransition;
   ...
   * @see #toJson
   */
  static fromJson(json: any): CustomizedTestStateMachineTransition | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): CustomizedTestStateMachineTransition | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): CustomizedTestStateMachineTransition | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): CustomizedTestStateMachineTransition | null;
   ...
   */
  replaceType(old: Type, new_: Type): CustomizedTestStateMachineTransition;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): CustomizedTestStateMachineTransition;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): CustomizedTestStateMachineTransition;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<CustomizedTestStateMachineTransition>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<CustomizedTestStateMachineTransition>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): CustomizedTestStateMachineTransition;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CustomizedTestStateMachineTransition;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CustomizedTestStateMachineTransition;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): CustomizedTestStateMachineTransition;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): CustomizedTestStateMachineTransition;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): CustomizedTestStateMachineTransition;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): CustomizedTestStateMachineTransition;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): CustomizedTestStateMachineTransition;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): CustomizedTestStateMachineTransition;
   ...
   * @see #removeField
   */
  withoutField(field: string): CustomizedTestStateMachineTransition;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): CustomizedTestStateMachineTransition;
   ...
   */
  withoutFields(fields: Array_Type<string>): CustomizedTestStateMachineTransition;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): CustomizedTestStateMachineTransition;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): CustomizedTestStateMachineTransition;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): CustomizedTestStateMachineTransition;
   ...
   * @see #unsetField
   */
  defaultField(field: string): CustomizedTestStateMachineTransition;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): CustomizedTestStateMachineTransition;
   ...
   * @see #removeField
   */
  unsetField(field: string): CustomizedTestStateMachineTransition;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): CustomizedTestStateMachineTransition;
   ...
   * @see #unsetField
   */
  removeField(field: string): CustomizedTestStateMachineTransition;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): CustomizedTestStateMachineTransition;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): CustomizedTestStateMachineTransition;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): CustomizedTestStateMachineTransition;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): CustomizedTestStateMachineTransition;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): CustomizedTestStateMachineTransition;

  mergeJson(json: any): CustomizedTestStateMachineTransition;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): CustomizedTestStateMachineTransition;
   ...
   */
  sumObj(other: Obj, deep?: boolean): CustomizedTestStateMachineTransition;
   ...
   */
  singletonArray(): Array_Type<CustomizedTestStateMachineTransition>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<CustomizedTestStateMachineTransition> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<CustomizedTestStateMachineTransition> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<CustomizedTestStateMachineTransition>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<CustomizedTestStateMachineTransition> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, CustomizedTestStateMachineTransition> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, CustomizedTestStateMachineTransition> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<CustomizedTestStateMachineTransition>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<CustomizedTestStateMachineTransition>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): CustomizedTestStateMachineTransition;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): CustomizedTestStateMachineTransition;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): CustomizedTestStateMachineTransition;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): CustomizedTestStateMachineTransition;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): CustomizedTestStateMachineTransition;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): CustomizedTestStateMachineTransition;
   ...
   * @see #fromString
   */
  static make(s: string): CustomizedTestStateMachineTransition | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): CustomizedTestStateMachineTransition;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): CustomizedTestStateMachineTransition;
   ...
   */
  static cachedEmptyInst(): CustomizedTestStateMachineTransition;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<CustomizedTestStateMachineTransition> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): CustomizedTestStateMachineTransition;
   ...
   */
  static allCached(): Stream<CustomizedTestStateMachineTransition> | null;
   ...
   */
  static find(filter?: string): Stream<CustomizedTestStateMachineTransition> | null;
   ...
   *         Otherwise no population will be performed.
   */
  static findBy(field: string, value: any): Stream<CustomizedTestStateMachineTransition> | null;

  /**
   * @return cached instance.
   */
  getCached(): CustomizedTestStateMachineTransition | null;

  /**
   * @return cached instance by the key.
   */
  static forCacheKey(key: string): CustomizedTestStateMachineTransition | null;
   ...
   */
  static produce(key: string): CustomizedTestStateMachineTransition | null;

  /**
   * Should produces the entire content for the cached data. Will populate the cache with the produced data.
   */
  static produceAll(): Map_Type<string, CustomizedTestStateMachineTransition> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<CustomizedTestStateMachineTransition>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<CustomizedTestStateMachineTransition>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<CustomizedTestStateMachineTransition> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<CustomizedTestStateMachineTransition>> | null;
   ...
   */
  get(include?: string): CustomizedTestStateMachineTransition | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): CustomizedTestStateMachineTransition | null;
   ...
   */
  getMissing(spec: GetMissingSpec): CustomizedTestStateMachineTransition;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): CustomizedTestStateMachineTransition | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): CustomizedTestStateMachineTransition;
   ...
   * @see #toString
   */
  static fromString(s: string): CustomizedTestStateMachineTransition | null;
   ...
   */
  create(spec?: UpsertSpec): CustomizedTestStateMachineTransition | null;
   ...
   */
  static createBatch(objs: Array_Type<CustomizedTestStateMachineTransition>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachineTransition> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<CustomizedTestStateMachineTransition>, spec?: CreateBatchObjStreamSpec): ObjList<CustomizedTestStateMachineTransition> | null;
   ...
   */
  update(srcObj?: CustomizedTestStateMachineTransition, spec?: UpsertSpec): CustomizedTestStateMachineTransition | null;
   ...
   */
  upsert(srcObj?: CustomizedTestStateMachineTransition, spec?: UpsertSpec): CustomizedTestStateMachineTransition | null;
   ...
   */
  merge(spec?: MergeSpec): CustomizedTestStateMachineTransition | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): CustomizedTestStateMachineTransition | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): CustomizedTestStateMachineTransition | null;
   ...
   */
  static updateBatch(objs: Array_Type<CustomizedTestStateMachineTransition>, srcObjs?: Array_Type<CustomizedTestStateMachineTransition>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachineTransition> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<CustomizedTestStateMachineTransition> | null>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachineTransition> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<CustomizedTestStateMachineTransition>, srcObjs?: Array_Type<CustomizedTestStateMachineTransition>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachineTransition> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<CustomizedTestStateMachineTransition> | null>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachineTransition> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<CustomizedTestStateMachineTransition>, spec?: TouchSpec): ObjList<CustomizedTestStateMachineTransition> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<CustomizedTestStateMachineTransition>, spec?: MergeSpec): ObjList<CustomizedTestStateMachineTransition> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<CustomizedTestStateMachineTransition>, mergeInclude: string, spec?: MergeSpec): ObjList<CustomizedTestStateMachineTransition> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<CustomizedTestStateMachineTransition> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<CustomizedTestStateMachineTransition> | null;
   ...
   */
  static mergeAll(mergeObj: CustomizedTestStateMachineTransition, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: CustomizedTestStateMachineTransition, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<CustomizedTestStateMachineTransition>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachineTransition> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<CustomizedTestStateMachineTransition>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachineTransition> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): CustomizedTestStateMachineTransition | null;
   ...
   */
  static beforeCreate(objs: Array_Type<CustomizedTestStateMachineTransition>): ObjList<CustomizedTestStateMachineTransition>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<CustomizedTestStateMachineTransition>): ObjList<CustomizedTestStateMachineTransition>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<CustomizedTestStateMachineTransition>): ObjList<CustomizedTestStateMachineTransition>;
   ...
   */
  static afterCreate(objs: Array_Type<CustomizedTestStateMachineTransition>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<CustomizedTestStateMachineTransition>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<CustomizedTestStateMachineTransition>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<CustomizedTestStateMachineTransition>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<CustomizedTestStateMachineTransition>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): CustomizedTestStateMachineTransition | null;
   ...
   */
  withoutIdentity(): CustomizedTestStateMachineTransition | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<CustomizedTestStateMachineTransition>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: CustomizedTestStateMachineTransition, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<CustomizedTestStateMachineTransition>, callback?: λFunction<CustomizedTestStateMachineTransition | null, CustomizedTestStateMachineTransition | null>): ObjList<CustomizedTestStateMachineTransition>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<CustomizedTestStateMachineTransition>, callback?: λFunction<CustomizedTestStateMachineTransition | null, CustomizedTestStateMachineTransition | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): CustomizedTestStateMachineTransition;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachineTransition> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): CustomizedTestStateMachineTransition | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachineTransition> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): CustomizedTestStateMachineTransition | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachineTransition> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): CustomizedTestStateMachineTransition | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<CustomizedTestStateMachineTransition> | null;
  ...
  dependencies(): SeedDataDeps<CustomizedTestStateMachineTransition> | null;
   ...
   */
  static populateAcl(objs?: Array_Type<CustomizedTestStateMachineTransition>): number | null;
   ...
   */
  grantMemberReadUpdateRemove(member: AccessControlEntity): CustomizedTestStateMachineTransition;
   ...
   */
  mergeAclEntry(entry: AclEntry): CustomizedTestStateMachineTransition;
   ...
   * @return the obj with the new acl after merging the indicated entry.
   */
  mergeAclEntries(entries: Array_Type<AclEntry>): CustomizedTestStateMachineTransition;
