// TypeScript definitions for the C3 type TestStateMachineWithAfterUpdate

/**
 * Test state machine type to test `afterUpdate` usage of `doAfterUpdate`.
 *
 * @remarks this represents a value passed to a method that expects an instance of TestStateMachineWithAfterUpdate
 */
declare interface ITestStateMachineWithAfterUpdate {
   ...
   */
  currentState?: ITestStateMachineState;

  /**
   * A collection of the states this {@link StateMachine} has passed through.
   */
  stateHistories?: Array_Type<TestStateMachineHistory> | Array<ITestStateMachineHistory>;

  /**
   * Transitions available from the current state
   */
  transitions?: Array_Type<TestStateMachineTransition> | Array<ITestStateMachineTransition>;

  /**
   * Calc field to get the current state history
   */
  currentStateHistory?: ITestStateMachineHistory;

  /**
   * `fieldA`: A `string` field that holds general information or identifier for the state machine.
   */
  fieldA?: string;

  /**
   * `fieldB`: A `string` field that holds additional information related to the state machine.
   */
  fieldB?: string;

  /**
   * `numWorkOrdersOpen`: A calculated `int` field that stores the count of work orders that are currently
   * in the 'open' status. It uses a calculation based on the status of work orders.
   */
  numWorkOrdersOpen?: number;

  /**
   * `workOrders`: A relationship field that holds a list of `WorkOrderPerfTest` entities related to this
   * state machine instance. This field tracks the associated work orders and their performance data.
   */
  workOrders?: Array_Type<WorkOrderPerfTest> | Array<IWorkOrderPerfTest>;
}

/**
 * Test state machine type to test `afterUpdate` usage of `doAfterUpdate`.
 *
 * @remarks this represents a made instance of TestStateMachineWithAfterUpdate
 */
declare class TestStateMachineWithAfterUpdate extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): TestStateMachineWithAfterUpdate;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): TestStateMachineWithAfterUpdate;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): TestStateMachineWithAfterUpdate;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): TestStateMachineWithAfterUpdate;
  ...
  withVersion(version: number | null): TestStateMachineWithAfterUpdate;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): TestStateMachineWithAfterUpdate;

  /**
   * A stored calc field representing the current state - uses a {@link StateMachineHistory} to keep track.
   */
  readonly currentState?: TestStateMachineState;
  withCurrentState(currentState: ITestStateMachineState | null): TestStateMachineWithAfterUpdate;

  /**
   * A collection of the states this {@link StateMachine} has passed through.
   */
  readonly stateHistories?: Array_Type<TestStateMachineHistory>;
  withStateHistories(stateHistories: Array_Type<TestStateMachineHistory> | Array<ITestStateMachineHistory> | null): TestStateMachineWithAfterUpdate;

  /**
   * Transitions available from the current state
   */
  readonly transitions?: Array_Type<TestStateMachineTransition>;
  withTransitions(transitions: Array_Type<TestStateMachineTransition> | Array<ITestStateMachineTransition> | null): TestStateMachineWithAfterUpdate;

  /**
   * Calc field to get the current state history
   */
  readonly currentStateHistory?: TestStateMachineHistory;
  withCurrentStateHistory(currentStateHistory: ITestStateMachineHistory | null): TestStateMachineWithAfterUpdate;

  /**
   * `fieldA`: A `string` field that holds general information or identifier for the state machine.
   */
  readonly fieldA?: string;
  withFieldA(fieldA: string | null): TestStateMachineWithAfterUpdate;

  /**
   * `fieldB`: A `string` field that holds additional information related to the state machine.
   */
  readonly fieldB?: string;
  withFieldB(fieldB: string | null): TestStateMachineWithAfterUpdate;

  /**
   * `numWorkOrdersOpen`: A calculated `int` field that stores the count of work orders that are currently
   * in the 'open' status. It uses a calculation based on the status of work orders.
   */
  readonly numWorkOrdersOpen?: number;
  withNumWorkOrdersOpen(numWorkOrdersOpen: number | null): TestStateMachineWithAfterUpdate;

  /**
   * `workOrders`: A relationship field that holds a list of `WorkOrderPerfTest` entities related to this
   * state machine instance. This field tracks the associated work orders and their performance data.
   */
  readonly workOrders?: Array_Type<WorkOrderPerfTest>;
  withWorkOrders(workOrders: Array_Type<WorkOrderPerfTest> | Array<IWorkOrderPerfTest> | null): TestStateMachineWithAfterUpdate;
   ...
   * @see #toJson
   */
  static fromJson(json: any): TestStateMachineWithAfterUpdate | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): TestStateMachineWithAfterUpdate | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): TestStateMachineWithAfterUpdate | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): TestStateMachineWithAfterUpdate | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestStateMachineWithAfterUpdate;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TestStateMachineWithAfterUpdate;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TestStateMachineWithAfterUpdate;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<TestStateMachineWithAfterUpdate>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<TestStateMachineWithAfterUpdate>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): TestStateMachineWithAfterUpdate;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestStateMachineWithAfterUpdate;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestStateMachineWithAfterUpdate;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestStateMachineWithAfterUpdate;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestStateMachineWithAfterUpdate;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestStateMachineWithAfterUpdate;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): TestStateMachineWithAfterUpdate;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestStateMachineWithAfterUpdate;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestStateMachineWithAfterUpdate;
   ...
   * @see #removeField
   */
  withoutField(field: string): TestStateMachineWithAfterUpdate;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): TestStateMachineWithAfterUpdate;
   ...
   */
  withoutFields(fields: Array_Type<string>): TestStateMachineWithAfterUpdate;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): TestStateMachineWithAfterUpdate;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestStateMachineWithAfterUpdate;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): TestStateMachineWithAfterUpdate;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestStateMachineWithAfterUpdate;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestStateMachineWithAfterUpdate;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestStateMachineWithAfterUpdate;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestStateMachineWithAfterUpdate;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestStateMachineWithAfterUpdate;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestStateMachineWithAfterUpdate;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): TestStateMachineWithAfterUpdate;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): TestStateMachineWithAfterUpdate;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): TestStateMachineWithAfterUpdate;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): TestStateMachineWithAfterUpdate;

  mergeJson(json: any): TestStateMachineWithAfterUpdate;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): TestStateMachineWithAfterUpdate;
   ...
   */
  sumObj(other: Obj, deep?: boolean): TestStateMachineWithAfterUpdate;
   ...
   */
  singletonArray(): Array_Type<TestStateMachineWithAfterUpdate>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<TestStateMachineWithAfterUpdate> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestStateMachineWithAfterUpdate> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<TestStateMachineWithAfterUpdate>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestStateMachineWithAfterUpdate> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, TestStateMachineWithAfterUpdate> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestStateMachineWithAfterUpdate> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestStateMachineWithAfterUpdate>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestStateMachineWithAfterUpdate>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): TestStateMachineWithAfterUpdate;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): TestStateMachineWithAfterUpdate;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): TestStateMachineWithAfterUpdate;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestStateMachineWithAfterUpdate;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): TestStateMachineWithAfterUpdate;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestStateMachineWithAfterUpdate;
   ...
   * @see #fromString
   */
  static make(s: string): TestStateMachineWithAfterUpdate | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): TestStateMachineWithAfterUpdate;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): TestStateMachineWithAfterUpdate;
   ...
   */
  static cachedEmptyInst(): TestStateMachineWithAfterUpdate;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<TestStateMachineWithAfterUpdate> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): TestStateMachineWithAfterUpdate;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<TestStateMachineWithAfterUpdate>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestStateMachineWithAfterUpdate>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<TestStateMachineWithAfterUpdate> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<TestStateMachineWithAfterUpdate>> | null;
   ...
   */
  get(include?: string): TestStateMachineWithAfterUpdate | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): TestStateMachineWithAfterUpdate | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestStateMachineWithAfterUpdate;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): TestStateMachineWithAfterUpdate | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestStateMachineWithAfterUpdate;
   ...
   * @see #toString
   */
  static fromString(s: string): TestStateMachineWithAfterUpdate | null;
   ...
   */
  create(spec?: UpsertSpec): TestStateMachineWithAfterUpdate | null;
   ...
   */
  static createBatch(objs: Array_Type<TestStateMachineWithAfterUpdate>, spec?: UpsertSpec): ObjList<TestStateMachineWithAfterUpdate> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestStateMachineWithAfterUpdate>, spec?: CreateBatchObjStreamSpec): ObjList<TestStateMachineWithAfterUpdate> | null;
   ...
   */
  update(srcObj?: TestStateMachineWithAfterUpdate, spec?: UpsertSpec): TestStateMachineWithAfterUpdate | null;
   ...
   */
  upsert(srcObj?: TestStateMachineWithAfterUpdate, spec?: UpsertSpec): TestStateMachineWithAfterUpdate | null;
   ...
   */
  merge(spec?: MergeSpec): TestStateMachineWithAfterUpdate | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): TestStateMachineWithAfterUpdate | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): TestStateMachineWithAfterUpdate | null;
   ...
   */
  static updateBatch(objs: Array_Type<TestStateMachineWithAfterUpdate>, srcObjs?: Array_Type<TestStateMachineWithAfterUpdate>, spec?: UpsertSpec): ObjList<TestStateMachineWithAfterUpdate> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<TestStateMachineWithAfterUpdate> | null>, spec?: UpsertSpec): ObjList<TestStateMachineWithAfterUpdate> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<TestStateMachineWithAfterUpdate>, srcObjs?: Array_Type<TestStateMachineWithAfterUpdate>, spec?: UpsertSpec): ObjList<TestStateMachineWithAfterUpdate> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<TestStateMachineWithAfterUpdate> | null>, spec?: UpsertSpec): ObjList<TestStateMachineWithAfterUpdate> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<TestStateMachineWithAfterUpdate>, spec?: TouchSpec): ObjList<TestStateMachineWithAfterUpdate> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TestStateMachineWithAfterUpdate>, spec?: MergeSpec): ObjList<TestStateMachineWithAfterUpdate> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TestStateMachineWithAfterUpdate>, mergeInclude: string, spec?: MergeSpec): ObjList<TestStateMachineWithAfterUpdate> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<TestStateMachineWithAfterUpdate> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<TestStateMachineWithAfterUpdate> | null;
   ...
   */
  static mergeAll(mergeObj: TestStateMachineWithAfterUpdate, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestStateMachineWithAfterUpdate, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<TestStateMachineWithAfterUpdate>, spec?: UpsertSpec): ObjList<TestStateMachineWithAfterUpdate> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<TestStateMachineWithAfterUpdate>, spec?: UpsertSpec): ObjList<TestStateMachineWithAfterUpdate> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TestStateMachineWithAfterUpdate | null;
   ...
   */
  static beforeCreate(objs: Array_Type<TestStateMachineWithAfterUpdate>): ObjList<TestStateMachineWithAfterUpdate>;
   ...
   */
  static beforeUpdate(objs: Array_Type<TestStateMachineWithAfterUpdate>): ObjList<TestStateMachineWithAfterUpdate>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<TestStateMachineWithAfterUpdate>): ObjList<TestStateMachineWithAfterUpdate>;

  /**
   * See {@link PersistableWritable#afterCreate}
   */
  static afterCreate(objs: Array_Type<TestStateMachineWithAfterUpdate>): Array_Type<ObjError> | null;
   ...
   */
  static afterUpdate(objs: Array_Type<TestStateMachineWithAfterUpdate>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<TestStateMachineWithAfterUpdate>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<TestStateMachineWithAfterUpdate>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<TestStateMachineWithAfterUpdate>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): TestStateMachineWithAfterUpdate | null;
   ...
   */
  withoutIdentity(): TestStateMachineWithAfterUpdate | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<TestStateMachineWithAfterUpdate>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: TestStateMachineWithAfterUpdate, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<TestStateMachineWithAfterUpdate>, callback?: λFunction<TestStateMachineWithAfterUpdate | null, TestStateMachineWithAfterUpdate | null>): ObjList<TestStateMachineWithAfterUpdate>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<TestStateMachineWithAfterUpdate>, callback?: λFunction<TestStateMachineWithAfterUpdate | null, TestStateMachineWithAfterUpdate | null>): Array_Type<ObjError> | null;
   ...
   */
  static transitionBatch(stateMachines: Array_Type<TestStateMachineWithAfterUpdate>, toState: TestStateMachineState, retry?: number, stateHistoryParams?: TestStateMachineHistory): Array_Type<StateMachineTransitionStatus<TestStateMachineHistory, TestStateMachineTransition>>;
   ...
   */
  transition(toState: TestStateMachineState, testOnly?: boolean, stateHistoryParams?: TestStateMachineHistory): StateMachineTransitionStatus<TestStateMachineHistory, TestStateMachineTransition>;
   ...
   */
  checkTransition(toState: TestStateMachineState): boolean;
   ...
   */
  possibleStates(): Array_Type<TestStateMachineState> | null;

  /**
   * Return list of all states in the {@link StateMachine}.
   */
  static allStates(): Array_Type<TestStateMachineState> | null;

  /**
   * Return list of transitions possible from the current state given the current user permissions and current conditions.
   */
  possibleTransitions(): Array_Type<TestStateMachineTransition> | null;
   ...
   */
  static allTransitions(fromState?: TestStateMachineState, toState?: TestStateMachineState): Array_Type<TestStateMachineTransition> | null;
   ...
   */
  forceTransition(toState: TestStateMachineState, stateHistoryParams?: TestStateMachineHistory): boolean;
   ...
   */
  static forceTransitionBatch(stateMachines: Array_Type<TestStateMachineWithAfterUpdate>, toState: TestStateMachineState, stateHistoryParams?: TestStateMachineHistory): Map_Type<string, boolean>;
   ...
   */
  static stateRecoverBatch(stateMachines: Array_Type<TestStateMachineWithAfterUpdate>): Map_Type<string, boolean>;

  /**
   * Transition with a valid transition in the transitions array
   */
  transitionWithTransitions(transitions?: Array_Type<TestStateMachineTransition>, testOnly?: boolean, stateHistoryParams?: TestStateMachineHistory): StateMachineTransitionStatus<TestStateMachineHistory, TestStateMachineTransition>;
   ...
   */
  static doBeforeCreate(objs: Array_Type<TestStateMachineWithAfterUpdate>): ObjList<TestStateMachineWithAfterUpdate> | null;
   ...
   */
  static doAfterUpdate(objs: Array_Type<TestStateMachineWithAfterUpdate>): Array_Type<ObjError> | null;
   ...
   */
  static doAfterCreate(objs: Array_Type<TestStateMachineWithAfterUpdate>): ObjList<TestStateMachineWithAfterUpdate> | null;
   ...
   */
  executeTransition(transition: TestStateMachineTransition, stateOrderCounter: number, stateHistoryParams?: TestStateMachineHistory): TestStateMachineHistory;
   ...
   */
  findTransitions(allTransitions: Array_Type<TestStateMachineTransition>): Array_Type<TestStateMachineTransition> | null;

  /**
   * Internal use only.
   * Implements a statemachine db lock.
   */
  reserveStateOrderCounter(): StateMachineTransitionStatus<TestStateMachineHistory, TestStateMachineTransition>;

  /**
   * Internal use only.
   * Verify whether the state machine is in error state.
   */
  checkStateMachine(): StateMachineTransitionStatus<TestStateMachineHistory, TestStateMachineTransition>;
   ...
   */
  transitionAndRefreshCurrentState(toState: TestStateMachineState, stateHistoryParams?: TestStateMachineHistory): StateMachineTransitionStatus<TestStateMachineHistory, TestStateMachineTransition>;

  /**
   * Used from the UI to batch transition and refresh currentState stored calc.
   */
  static transitionBatchAndRefreshCurrentState(stateMachines: Array_Type<TestStateMachineWithAfterUpdate>, toState: TestStateMachineState, retry?: number, stateHistoryParams?: TestStateMachineHistory): Array_Type<StateMachineTransitionStatus<TestStateMachineHistory, TestStateMachineTransition>>;
