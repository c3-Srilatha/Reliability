// TypeScript definitions for the C3 type TestStateMachineState

/**
 * Entity type `TestStateMachineState` represents a state within the `TestStateMachine`.
 * It defines the various states the machine can be in and the transitions between them.
 *
 * @remarks this represents a value passed to a method that expects an instance of TestStateMachineState
 */
declare interface ITestStateMachineState {
   ...
   */
  autoTransitions?: Array_Type<TestStateMachineTransition> | Array<ITestStateMachineTransition>;
   ...
   */
  periodicTransitions?: Array_Type<TestStateMachineTransition> | Array<ITestStateMachineTransition>;
   ...
   */
  fromTransitions?: Array_Type<TestStateMachineTransition> | Array<ITestStateMachineTransition>;

  /**
   * {@link StateMachineTransition}s that lead into this {@link StateMachineState}.
   */
  toTransitions?: Array_Type<TestStateMachineTransition> | Array<ITestStateMachineTransition>;
}
 ...
 * It defines the various states the machine can be in and the transitions between them.
 *
 * @remarks this represents a made instance of TestStateMachineState
 */
declare class TestStateMachineState extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): TestStateMachineState;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): TestStateMachineState;

  /**
   * The name of this {@link StateMachineState}.
   */
  readonly name?: string;
  withName(name: string | null): TestStateMachineState;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): TestStateMachineState;
  ...
  withVersion(version: number | null): TestStateMachineState;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): TestStateMachineState;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): TestStateMachineState;
  ...
  withHidden(hidden: boolean): TestStateMachineState;
  ...
  withUserOwned(userOwned: boolean): TestStateMachineState;
  ...
  withDisplayName(displayName: string | null): TestStateMachineState;
  ...
  withInitialState(initialState: boolean): TestStateMachineState;

  /**
   * Used to soft delete a record so all state histories still have valid pointers.
   */
  readonly deleted?: boolean;
  withDeleted(deleted: boolean): TestStateMachineState;

  /**
   * Used to include fields on the source type for exitAction and entryAction.
   */
  readonly includeSpec?: string;
  withIncludeSpec(includeSpec: string | null): TestStateMachineState;

  /**
   * Action to be triggered when leaving this state.
   */
  readonly exitAction?: λConsumer<any | null>;
  withExitAction(exitAction: λConsumer<any | null> | null): TestStateMachineState;

  /**
   * Action to be triggered when entering this state.
   */
  readonly entryAction?: λConsumer<any | null>;
  withEntryAction(entryAction: λConsumer<any | null> | null): TestStateMachineState;

  /**
   * The list of automatic transitions from this state to another that are {@link StateMachineTransition#isValid}.
   */
  readonly autoTransitions?: Array_Type<TestStateMachineTransition>;
  withAutoTransitions(autoTransitions: Array_Type<TestStateMachineTransition> | Array<ITestStateMachineTransition> | null): TestStateMachineState;

  /**
   * Whether this state has automatic transitions.
   */
  readonly hasAutoTransition?: boolean;
  withHasAutoTransition(hasAutoTransition: boolean): TestStateMachineState;

  /**
   * The list of periodic transitions from this state to another that are {@link StateMachineTransition#isValid}.
   */
  readonly periodicTransitions?: Array_Type<TestStateMachineTransition>;
  withPeriodicTransitions(periodicTransitions: Array_Type<TestStateMachineTransition> | Array<ITestStateMachineTransition> | null): TestStateMachineState;

  /**
   * Whether this state has periodic transitions.
   */
  readonly hasPeriodicTransitions?: boolean;
  withHasPeriodicTransitions(hasPeriodicTransitions: boolean): TestStateMachineState;

  /**
   * {@link StateMachineTransition}s that originate from this {@link StateMachineState}.
   */
  readonly fromTransitions?: Array_Type<TestStateMachineTransition>;
  withFromTransitions(fromTransitions: Array_Type<TestStateMachineTransition> | Array<ITestStateMachineTransition> | null): TestStateMachineState;

  /**
   * {@link StateMachineTransition}s that lead into this {@link StateMachineState}.
   */
  readonly toTransitions?: Array_Type<TestStateMachineTransition>;
  withToTransitions(toTransitions: Array_Type<TestStateMachineTransition> | Array<ITestStateMachineTransition> | null): TestStateMachineState;
   ...
   * @see #toJson
   */
  static fromJson(json: any): TestStateMachineState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): TestStateMachineState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): TestStateMachineState | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): TestStateMachineState | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestStateMachineState;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TestStateMachineState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TestStateMachineState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<TestStateMachineState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<TestStateMachineState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): TestStateMachineState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestStateMachineState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestStateMachineState;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestStateMachineState;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestStateMachineState;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestStateMachineState;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): TestStateMachineState;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestStateMachineState;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestStateMachineState;
   ...
   * @see #removeField
   */
  withoutField(field: string): TestStateMachineState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): TestStateMachineState;
   ...
   */
  withoutFields(fields: Array_Type<string>): TestStateMachineState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): TestStateMachineState;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestStateMachineState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): TestStateMachineState;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestStateMachineState;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestStateMachineState;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestStateMachineState;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestStateMachineState;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestStateMachineState;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestStateMachineState;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): TestStateMachineState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): TestStateMachineState;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): TestStateMachineState;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): TestStateMachineState;

  mergeJson(json: any): TestStateMachineState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): TestStateMachineState;
   ...
   */
  sumObj(other: Obj, deep?: boolean): TestStateMachineState;
   ...
   */
  singletonArray(): Array_Type<TestStateMachineState>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<TestStateMachineState> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestStateMachineState> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<TestStateMachineState>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestStateMachineState> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, TestStateMachineState> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestStateMachineState> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestStateMachineState>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestStateMachineState>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): TestStateMachineState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): TestStateMachineState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): TestStateMachineState;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestStateMachineState;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): TestStateMachineState;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestStateMachineState;
   ...
   * @see #fromString
   */
  static make(s: string): TestStateMachineState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): TestStateMachineState;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): TestStateMachineState;
   ...
   */
  static cachedEmptyInst(): TestStateMachineState;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<TestStateMachineState> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): TestStateMachineState;
   ...
   */
  static allCached(): Stream<TestStateMachineState> | null;
   ...
   */
  static find(filter?: string): Stream<TestStateMachineState> | null;
   ...
   *         Otherwise no population will be performed.
   */
  static findBy(field: string, value: any): Stream<TestStateMachineState> | null;

  /**
   * @return cached instance.
   */
  getCached(): TestStateMachineState | null;

  /**
   * @return cached instance by the key.
   */
  static forCacheKey(key: string): TestStateMachineState | null;
   ...
   */
  static produce(key: string): TestStateMachineState | null;

  /**
   * Should produces the entire content for the cached data. Will populate the cache with the produced data.
   */
  static produceAll(): Map_Type<string, TestStateMachineState> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<TestStateMachineState>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestStateMachineState>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<TestStateMachineState> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<TestStateMachineState>> | null;
   ...
   */
  get(include?: string): TestStateMachineState | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): TestStateMachineState | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestStateMachineState;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): TestStateMachineState | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestStateMachineState;
   ...
   * @see #toString
   */
  static fromString(s: string): TestStateMachineState | null;
   ...
   */
  create(spec?: UpsertSpec): TestStateMachineState | null;
   ...
   */
  static createBatch(objs: Array_Type<TestStateMachineState>, spec?: UpsertSpec): ObjList<TestStateMachineState> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestStateMachineState>, spec?: CreateBatchObjStreamSpec): ObjList<TestStateMachineState> | null;
   ...
   */
  update(srcObj?: TestStateMachineState, spec?: UpsertSpec): TestStateMachineState | null;
   ...
   */
  upsert(srcObj?: TestStateMachineState, spec?: UpsertSpec): TestStateMachineState | null;
   ...
   */
  merge(spec?: MergeSpec): TestStateMachineState | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): TestStateMachineState | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): TestStateMachineState | null;
   ...
   */
  static updateBatch(objs: Array_Type<TestStateMachineState>, srcObjs?: Array_Type<TestStateMachineState>, spec?: UpsertSpec): ObjList<TestStateMachineState> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<TestStateMachineState> | null>, spec?: UpsertSpec): ObjList<TestStateMachineState> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<TestStateMachineState>, srcObjs?: Array_Type<TestStateMachineState>, spec?: UpsertSpec): ObjList<TestStateMachineState> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<TestStateMachineState> | null>, spec?: UpsertSpec): ObjList<TestStateMachineState> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<TestStateMachineState>, spec?: TouchSpec): ObjList<TestStateMachineState> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TestStateMachineState>, spec?: MergeSpec): ObjList<TestStateMachineState> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TestStateMachineState>, mergeInclude: string, spec?: MergeSpec): ObjList<TestStateMachineState> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<TestStateMachineState> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<TestStateMachineState> | null;
   ...
   */
  static mergeAll(mergeObj: TestStateMachineState, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestStateMachineState, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<TestStateMachineState>, spec?: UpsertSpec): ObjList<TestStateMachineState> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<TestStateMachineState>, spec?: UpsertSpec): ObjList<TestStateMachineState> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TestStateMachineState | null;
   ...
   */
  static beforeCreate(objs: Array_Type<TestStateMachineState>): ObjList<TestStateMachineState>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<TestStateMachineState>): ObjList<TestStateMachineState>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<TestStateMachineState>): ObjList<TestStateMachineState>;
   ...
   */
  static afterCreate(objs: Array_Type<TestStateMachineState>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<TestStateMachineState>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<TestStateMachineState>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<TestStateMachineState>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<TestStateMachineState>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): TestStateMachineState | null;
   ...
   */
  withoutIdentity(): TestStateMachineState | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<TestStateMachineState>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: TestStateMachineState, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<TestStateMachineState>, callback?: λFunction<TestStateMachineState | null, TestStateMachineState | null>): ObjList<TestStateMachineState>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<TestStateMachineState>, callback?: λFunction<TestStateMachineState | null, TestStateMachineState | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): TestStateMachineState;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<TestStateMachineState> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): TestStateMachineState | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<TestStateMachineState> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): TestStateMachineState | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<TestStateMachineState> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): TestStateMachineState | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<TestStateMachineState> | null;
  ...
  dependencies(): SeedDataDeps<TestStateMachineState> | null;
