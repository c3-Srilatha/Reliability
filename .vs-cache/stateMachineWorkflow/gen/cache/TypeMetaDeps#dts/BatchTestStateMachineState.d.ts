// TypeScript definitions for the C3 type BatchTestStateMachineState

/**
 * Entity type `BatchTestStateMachineState` represents a state within the `BatchTestStateMachine`.
 * It defines the various states the machine can be in and the transitions between them.
 *
 * @remarks this represents a value passed to a method that expects an instance of BatchTestStateMachineState
 */
declare interface IBatchTestStateMachineState {
   ...
   */
  autoTransitions?: Array_Type<BatchTestStateMachineTransition> | Array<IBatchTestStateMachineTransition>;
   ...
   */
  periodicTransitions?: Array_Type<BatchTestStateMachineTransition> | Array<IBatchTestStateMachineTransition>;
   ...
   */
  fromTransitions?: Array_Type<BatchTestStateMachineTransition> | Array<IBatchTestStateMachineTransition>;

  /**
   * {@link StateMachineTransition}s that lead into this {@link StateMachineState}.
   */
  toTransitions?: Array_Type<BatchTestStateMachineTransition> | Array<IBatchTestStateMachineTransition>;
}
 ...
 * It defines the various states the machine can be in and the transitions between them.
 *
 * @remarks this represents a made instance of BatchTestStateMachineState
 */
declare class BatchTestStateMachineState extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): BatchTestStateMachineState;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): BatchTestStateMachineState;

  /**
   * The name of this {@link StateMachineState}.
   */
  readonly name?: string;
  withName(name: string | null): BatchTestStateMachineState;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): BatchTestStateMachineState;
  ...
  withVersion(version: number | null): BatchTestStateMachineState;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): BatchTestStateMachineState;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): BatchTestStateMachineState;
  ...
  withHidden(hidden: boolean): BatchTestStateMachineState;
  ...
  withUserOwned(userOwned: boolean): BatchTestStateMachineState;
  ...
  withDisplayName(displayName: string | null): BatchTestStateMachineState;
  ...
  withInitialState(initialState: boolean): BatchTestStateMachineState;

  /**
   * Used to soft delete a record so all state histories still have valid pointers.
   */
  readonly deleted?: boolean;
  withDeleted(deleted: boolean): BatchTestStateMachineState;

  /**
   * Used to include fields on the source type for exitAction and entryAction.
   */
  readonly includeSpec?: string;
  withIncludeSpec(includeSpec: string | null): BatchTestStateMachineState;

  /**
   * Action to be triggered when leaving this state.
   */
  readonly exitAction?: λConsumer<any | null>;
  withExitAction(exitAction: λConsumer<any | null> | null): BatchTestStateMachineState;

  /**
   * Action to be triggered when entering this state.
   */
  readonly entryAction?: λConsumer<any | null>;
  withEntryAction(entryAction: λConsumer<any | null> | null): BatchTestStateMachineState;

  /**
   * The list of automatic transitions from this state to another that are {@link StateMachineTransition#isValid}.
   */
  readonly autoTransitions?: Array_Type<BatchTestStateMachineTransition>;
  withAutoTransitions(autoTransitions: Array_Type<BatchTestStateMachineTransition> | Array<IBatchTestStateMachineTransition> | null): BatchTestStateMachineState;

  /**
   * Whether this state has automatic transitions.
   */
  readonly hasAutoTransition?: boolean;
  withHasAutoTransition(hasAutoTransition: boolean): BatchTestStateMachineState;

  /**
   * The list of periodic transitions from this state to another that are {@link StateMachineTransition#isValid}.
   */
  readonly periodicTransitions?: Array_Type<BatchTestStateMachineTransition>;
  withPeriodicTransitions(periodicTransitions: Array_Type<BatchTestStateMachineTransition> | Array<IBatchTestStateMachineTransition> | null): BatchTestStateMachineState;

  /**
   * Whether this state has periodic transitions.
   */
  readonly hasPeriodicTransitions?: boolean;
  withHasPeriodicTransitions(hasPeriodicTransitions: boolean): BatchTestStateMachineState;

  /**
   * {@link StateMachineTransition}s that originate from this {@link StateMachineState}.
   */
  readonly fromTransitions?: Array_Type<BatchTestStateMachineTransition>;
  withFromTransitions(fromTransitions: Array_Type<BatchTestStateMachineTransition> | Array<IBatchTestStateMachineTransition> | null): BatchTestStateMachineState;

  /**
   * {@link StateMachineTransition}s that lead into this {@link StateMachineState}.
   */
  readonly toTransitions?: Array_Type<BatchTestStateMachineTransition>;
  withToTransitions(toTransitions: Array_Type<BatchTestStateMachineTransition> | Array<IBatchTestStateMachineTransition> | null): BatchTestStateMachineState;
   ...
   * @see #toJson
   */
  static fromJson(json: any): BatchTestStateMachineState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): BatchTestStateMachineState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): BatchTestStateMachineState | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): BatchTestStateMachineState | null;
   ...
   */
  replaceType(old: Type, new_: Type): BatchTestStateMachineState;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): BatchTestStateMachineState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): BatchTestStateMachineState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<BatchTestStateMachineState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<BatchTestStateMachineState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): BatchTestStateMachineState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BatchTestStateMachineState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BatchTestStateMachineState;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): BatchTestStateMachineState;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): BatchTestStateMachineState;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): BatchTestStateMachineState;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): BatchTestStateMachineState;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BatchTestStateMachineState;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): BatchTestStateMachineState;
   ...
   * @see #removeField
   */
  withoutField(field: string): BatchTestStateMachineState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): BatchTestStateMachineState;
   ...
   */
  withoutFields(fields: Array_Type<string>): BatchTestStateMachineState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): BatchTestStateMachineState;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): BatchTestStateMachineState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): BatchTestStateMachineState;
   ...
   * @see #unsetField
   */
  defaultField(field: string): BatchTestStateMachineState;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): BatchTestStateMachineState;
   ...
   * @see #removeField
   */
  unsetField(field: string): BatchTestStateMachineState;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): BatchTestStateMachineState;
   ...
   * @see #unsetField
   */
  removeField(field: string): BatchTestStateMachineState;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): BatchTestStateMachineState;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): BatchTestStateMachineState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): BatchTestStateMachineState;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): BatchTestStateMachineState;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): BatchTestStateMachineState;

  mergeJson(json: any): BatchTestStateMachineState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): BatchTestStateMachineState;
   ...
   */
  sumObj(other: Obj, deep?: boolean): BatchTestStateMachineState;
   ...
   */
  singletonArray(): Array_Type<BatchTestStateMachineState>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<BatchTestStateMachineState> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BatchTestStateMachineState> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<BatchTestStateMachineState>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BatchTestStateMachineState> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, BatchTestStateMachineState> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BatchTestStateMachineState> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BatchTestStateMachineState>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BatchTestStateMachineState>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): BatchTestStateMachineState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): BatchTestStateMachineState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): BatchTestStateMachineState;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): BatchTestStateMachineState;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): BatchTestStateMachineState;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): BatchTestStateMachineState;
   ...
   * @see #fromString
   */
  static make(s: string): BatchTestStateMachineState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): BatchTestStateMachineState;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): BatchTestStateMachineState;
   ...
   */
  static cachedEmptyInst(): BatchTestStateMachineState;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<BatchTestStateMachineState> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): BatchTestStateMachineState;
   ...
   */
  static allCached(): Stream<BatchTestStateMachineState> | null;
   ...
   */
  static find(filter?: string): Stream<BatchTestStateMachineState> | null;
   ...
   *         Otherwise no population will be performed.
   */
  static findBy(field: string, value: any): Stream<BatchTestStateMachineState> | null;

  /**
   * @return cached instance.
   */
  getCached(): BatchTestStateMachineState | null;

  /**
   * @return cached instance by the key.
   */
  static forCacheKey(key: string): BatchTestStateMachineState | null;
   ...
   */
  static produce(key: string): BatchTestStateMachineState | null;

  /**
   * Should produces the entire content for the cached data. Will populate the cache with the produced data.
   */
  static produceAll(): Map_Type<string, BatchTestStateMachineState> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<BatchTestStateMachineState>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<BatchTestStateMachineState>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<BatchTestStateMachineState> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<BatchTestStateMachineState>> | null;
   ...
   */
  get(include?: string): BatchTestStateMachineState | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): BatchTestStateMachineState | null;
   ...
   */
  getMissing(spec: GetMissingSpec): BatchTestStateMachineState;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): BatchTestStateMachineState | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): BatchTestStateMachineState;
   ...
   * @see #toString
   */
  static fromString(s: string): BatchTestStateMachineState | null;
   ...
   */
  create(spec?: UpsertSpec): BatchTestStateMachineState | null;
   ...
   */
  static createBatch(objs: Array_Type<BatchTestStateMachineState>, spec?: UpsertSpec): ObjList<BatchTestStateMachineState> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<BatchTestStateMachineState>, spec?: CreateBatchObjStreamSpec): ObjList<BatchTestStateMachineState> | null;
   ...
   */
  update(srcObj?: BatchTestStateMachineState, spec?: UpsertSpec): BatchTestStateMachineState | null;
   ...
   */
  upsert(srcObj?: BatchTestStateMachineState, spec?: UpsertSpec): BatchTestStateMachineState | null;
   ...
   */
  merge(spec?: MergeSpec): BatchTestStateMachineState | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): BatchTestStateMachineState | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): BatchTestStateMachineState | null;
   ...
   */
  static updateBatch(objs: Array_Type<BatchTestStateMachineState>, srcObjs?: Array_Type<BatchTestStateMachineState>, spec?: UpsertSpec): ObjList<BatchTestStateMachineState> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<BatchTestStateMachineState> | null>, spec?: UpsertSpec): ObjList<BatchTestStateMachineState> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<BatchTestStateMachineState>, srcObjs?: Array_Type<BatchTestStateMachineState>, spec?: UpsertSpec): ObjList<BatchTestStateMachineState> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<BatchTestStateMachineState> | null>, spec?: UpsertSpec): ObjList<BatchTestStateMachineState> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<BatchTestStateMachineState>, spec?: TouchSpec): ObjList<BatchTestStateMachineState> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<BatchTestStateMachineState>, spec?: MergeSpec): ObjList<BatchTestStateMachineState> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<BatchTestStateMachineState>, mergeInclude: string, spec?: MergeSpec): ObjList<BatchTestStateMachineState> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<BatchTestStateMachineState> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<BatchTestStateMachineState> | null;
   ...
   */
  static mergeAll(mergeObj: BatchTestStateMachineState, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: BatchTestStateMachineState, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<BatchTestStateMachineState>, spec?: UpsertSpec): ObjList<BatchTestStateMachineState> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<BatchTestStateMachineState>, spec?: UpsertSpec): ObjList<BatchTestStateMachineState> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): BatchTestStateMachineState | null;
   ...
   */
  static beforeCreate(objs: Array_Type<BatchTestStateMachineState>): ObjList<BatchTestStateMachineState>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<BatchTestStateMachineState>): ObjList<BatchTestStateMachineState>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<BatchTestStateMachineState>): ObjList<BatchTestStateMachineState>;
   ...
   */
  static afterCreate(objs: Array_Type<BatchTestStateMachineState>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<BatchTestStateMachineState>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<BatchTestStateMachineState>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<BatchTestStateMachineState>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<BatchTestStateMachineState>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): BatchTestStateMachineState | null;
   ...
   */
  withoutIdentity(): BatchTestStateMachineState | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<BatchTestStateMachineState>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: BatchTestStateMachineState, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<BatchTestStateMachineState>, callback?: λFunction<BatchTestStateMachineState | null, BatchTestStateMachineState | null>): ObjList<BatchTestStateMachineState>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<BatchTestStateMachineState>, callback?: λFunction<BatchTestStateMachineState | null, BatchTestStateMachineState | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): BatchTestStateMachineState;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<BatchTestStateMachineState> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): BatchTestStateMachineState | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<BatchTestStateMachineState> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): BatchTestStateMachineState | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<BatchTestStateMachineState> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): BatchTestStateMachineState | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<BatchTestStateMachineState> | null;
  ...
  dependencies(): SeedDataDeps<BatchTestStateMachineState> | null;
