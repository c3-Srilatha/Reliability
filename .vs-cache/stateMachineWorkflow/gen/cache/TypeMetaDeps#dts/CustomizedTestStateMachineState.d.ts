// TypeScript definitions for the C3 type CustomizedTestStateMachineState

/**
 * Entity type `CustomizedTestStateMachineState` represents a state within a customized state machine.
 * It defines the different states that a state machine can be in and the transitions between those states.
 *
 * @remarks this represents a value passed to a method that expects an instance of CustomizedTestStateMachineState
 */
declare interface ICustomizedTestStateMachineState {
   ...
   */
  exitAction?: λConsumer<any | null>;

  /**
   * Action to be triggered when entering this state.
   */
  entryAction?: λConsumer<any | null>;

  /**
   * The list of automatic transitions from this state to another that are {@link StateMachineTransition#isValid}.
   */
  autoTransitions?: Array_Type<CustomizedTestStateMachineTransition> | Array<ICustomizedTestStateMachineTransition>;

  /**
   * Whether this state has automatic transitions.
   */
  hasAutoTransition?: boolean;

  /**
   * The list of periodic transitions from this state to another that are {@link StateMachineTransition#isValid}.
   */
  periodicTransitions?: Array_Type<CustomizedTestStateMachineTransition> | Array<ICustomizedTestStateMachineTransition>;

  /**
   * Whether this state has periodic transitions.
   */
  hasPeriodicTransitions?: boolean;

  /**
   * {@link StateMachineTransition}s that originate from this {@link StateMachineState}.
   */
  fromTransitions?: Array_Type<CustomizedTestStateMachineTransition> | Array<ICustomizedTestStateMachineTransition>;

  /**
   * {@link StateMachineTransition}s that lead into this {@link StateMachineState}.
   */
  toTransitions?: Array_Type<CustomizedTestStateMachineTransition> | Array<ICustomizedTestStateMachineTransition>;
}
 ...
 * It defines the different states that a state machine can be in and the transitions between those states.
 *
 * @remarks this represents a made instance of CustomizedTestStateMachineState
 */
declare class CustomizedTestStateMachineState extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): CustomizedTestStateMachineState;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): CustomizedTestStateMachineState;

  /**
   * The name of this {@link StateMachineState}.
   */
  readonly name?: string;
  withName(name: string | null): CustomizedTestStateMachineState;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): CustomizedTestStateMachineState;
  ...
  withVersion(version: number | null): CustomizedTestStateMachineState;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): CustomizedTestStateMachineState;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): CustomizedTestStateMachineState;
  ...
  withHidden(hidden: boolean): CustomizedTestStateMachineState;
  ...
  withUserOwned(userOwned: boolean): CustomizedTestStateMachineState;
  ...
  withDisplayName(displayName: string | null): CustomizedTestStateMachineState;
  ...
  withInitialState(initialState: boolean): CustomizedTestStateMachineState;

  /**
   * Used to soft delete a record so all state histories still have valid pointers.
   */
  readonly deleted?: boolean;
  withDeleted(deleted: boolean): CustomizedTestStateMachineState;

  /**
   * Used to include fields on the source type for exitAction and entryAction.
   */
  readonly includeSpec?: string;
  withIncludeSpec(includeSpec: string | null): CustomizedTestStateMachineState;

  /**
   * Action to be triggered when leaving this state.
   */
  readonly exitAction?: λConsumer<any | null>;
  withExitAction(exitAction: λConsumer<any | null> | null): CustomizedTestStateMachineState;

  /**
   * Action to be triggered when entering this state.
   */
  readonly entryAction?: λConsumer<any | null>;
  withEntryAction(entryAction: λConsumer<any | null> | null): CustomizedTestStateMachineState;

  /**
   * The list of automatic transitions from this state to another that are {@link StateMachineTransition#isValid}.
   */
  readonly autoTransitions?: Array_Type<CustomizedTestStateMachineTransition>;
  withAutoTransitions(autoTransitions: Array_Type<CustomizedTestStateMachineTransition> | Array<ICustomizedTestStateMachineTransition> | null): CustomizedTestStateMachineState;

  /**
   * Whether this state has automatic transitions.
   */
  readonly hasAutoTransition?: boolean;
  withHasAutoTransition(hasAutoTransition: boolean): CustomizedTestStateMachineState;

  /**
   * The list of periodic transitions from this state to another that are {@link StateMachineTransition#isValid}.
   */
  readonly periodicTransitions?: Array_Type<CustomizedTestStateMachineTransition>;
  withPeriodicTransitions(periodicTransitions: Array_Type<CustomizedTestStateMachineTransition> | Array<ICustomizedTestStateMachineTransition> | null): CustomizedTestStateMachineState;

  /**
   * Whether this state has periodic transitions.
   */
  readonly hasPeriodicTransitions?: boolean;
  withHasPeriodicTransitions(hasPeriodicTransitions: boolean): CustomizedTestStateMachineState;

  /**
   * {@link StateMachineTransition}s that originate from this {@link StateMachineState}.
   */
  readonly fromTransitions?: Array_Type<CustomizedTestStateMachineTransition>;
  withFromTransitions(fromTransitions: Array_Type<CustomizedTestStateMachineTransition> | Array<ICustomizedTestStateMachineTransition> | null): CustomizedTestStateMachineState;

  /**
   * {@link StateMachineTransition}s that lead into this {@link StateMachineState}.
   */
  readonly toTransitions?: Array_Type<CustomizedTestStateMachineTransition>;
  withToTransitions(toTransitions: Array_Type<CustomizedTestStateMachineTransition> | Array<ICustomizedTestStateMachineTransition> | null): CustomizedTestStateMachineState;
   ...
   * @see #toJson
   */
  static fromJson(json: any): CustomizedTestStateMachineState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): CustomizedTestStateMachineState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): CustomizedTestStateMachineState | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): CustomizedTestStateMachineState | null;
   ...
   */
  replaceType(old: Type, new_: Type): CustomizedTestStateMachineState;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): CustomizedTestStateMachineState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): CustomizedTestStateMachineState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<CustomizedTestStateMachineState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<CustomizedTestStateMachineState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): CustomizedTestStateMachineState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CustomizedTestStateMachineState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CustomizedTestStateMachineState;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): CustomizedTestStateMachineState;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): CustomizedTestStateMachineState;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): CustomizedTestStateMachineState;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): CustomizedTestStateMachineState;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): CustomizedTestStateMachineState;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): CustomizedTestStateMachineState;
   ...
   * @see #removeField
   */
  withoutField(field: string): CustomizedTestStateMachineState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): CustomizedTestStateMachineState;
   ...
   */
  withoutFields(fields: Array_Type<string>): CustomizedTestStateMachineState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): CustomizedTestStateMachineState;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): CustomizedTestStateMachineState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): CustomizedTestStateMachineState;
   ...
   * @see #unsetField
   */
  defaultField(field: string): CustomizedTestStateMachineState;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): CustomizedTestStateMachineState;
   ...
   * @see #removeField
   */
  unsetField(field: string): CustomizedTestStateMachineState;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): CustomizedTestStateMachineState;
   ...
   * @see #unsetField
   */
  removeField(field: string): CustomizedTestStateMachineState;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): CustomizedTestStateMachineState;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): CustomizedTestStateMachineState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): CustomizedTestStateMachineState;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): CustomizedTestStateMachineState;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): CustomizedTestStateMachineState;

  mergeJson(json: any): CustomizedTestStateMachineState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): CustomizedTestStateMachineState;
   ...
   */
  sumObj(other: Obj, deep?: boolean): CustomizedTestStateMachineState;
   ...
   */
  singletonArray(): Array_Type<CustomizedTestStateMachineState>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<CustomizedTestStateMachineState> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<CustomizedTestStateMachineState> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<CustomizedTestStateMachineState>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<CustomizedTestStateMachineState> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, CustomizedTestStateMachineState> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, CustomizedTestStateMachineState> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<CustomizedTestStateMachineState>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<CustomizedTestStateMachineState>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): CustomizedTestStateMachineState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): CustomizedTestStateMachineState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): CustomizedTestStateMachineState;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): CustomizedTestStateMachineState;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): CustomizedTestStateMachineState;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): CustomizedTestStateMachineState;
   ...
   * @see #fromString
   */
  static make(s: string): CustomizedTestStateMachineState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): CustomizedTestStateMachineState;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): CustomizedTestStateMachineState;
   ...
   */
  static cachedEmptyInst(): CustomizedTestStateMachineState;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<CustomizedTestStateMachineState> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): CustomizedTestStateMachineState;
   ...
   */
  static allCached(): Stream<CustomizedTestStateMachineState> | null;
   ...
   */
  static find(filter?: string): Stream<CustomizedTestStateMachineState> | null;
   ...
   *         Otherwise no population will be performed.
   */
  static findBy(field: string, value: any): Stream<CustomizedTestStateMachineState> | null;

  /**
   * @return cached instance.
   */
  getCached(): CustomizedTestStateMachineState | null;

  /**
   * @return cached instance by the key.
   */
  static forCacheKey(key: string): CustomizedTestStateMachineState | null;
   ...
   */
  static produce(key: string): CustomizedTestStateMachineState | null;

  /**
   * Should produces the entire content for the cached data. Will populate the cache with the produced data.
   */
  static produceAll(): Map_Type<string, CustomizedTestStateMachineState> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<CustomizedTestStateMachineState>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<CustomizedTestStateMachineState>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<CustomizedTestStateMachineState> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<CustomizedTestStateMachineState>> | null;
   ...
   */
  get(include?: string): CustomizedTestStateMachineState | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): CustomizedTestStateMachineState | null;
   ...
   */
  getMissing(spec: GetMissingSpec): CustomizedTestStateMachineState;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): CustomizedTestStateMachineState | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): CustomizedTestStateMachineState;
   ...
   * @see #toString
   */
  static fromString(s: string): CustomizedTestStateMachineState | null;
   ...
   */
  create(spec?: UpsertSpec): CustomizedTestStateMachineState | null;
   ...
   */
  static createBatch(objs: Array_Type<CustomizedTestStateMachineState>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachineState> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<CustomizedTestStateMachineState>, spec?: CreateBatchObjStreamSpec): ObjList<CustomizedTestStateMachineState> | null;
   ...
   */
  update(srcObj?: CustomizedTestStateMachineState, spec?: UpsertSpec): CustomizedTestStateMachineState | null;
   ...
   */
  upsert(srcObj?: CustomizedTestStateMachineState, spec?: UpsertSpec): CustomizedTestStateMachineState | null;
   ...
   */
  merge(spec?: MergeSpec): CustomizedTestStateMachineState | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): CustomizedTestStateMachineState | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): CustomizedTestStateMachineState | null;
   ...
   */
  static updateBatch(objs: Array_Type<CustomizedTestStateMachineState>, srcObjs?: Array_Type<CustomizedTestStateMachineState>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachineState> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<CustomizedTestStateMachineState> | null>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachineState> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<CustomizedTestStateMachineState>, srcObjs?: Array_Type<CustomizedTestStateMachineState>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachineState> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<CustomizedTestStateMachineState> | null>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachineState> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<CustomizedTestStateMachineState>, spec?: TouchSpec): ObjList<CustomizedTestStateMachineState> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<CustomizedTestStateMachineState>, spec?: MergeSpec): ObjList<CustomizedTestStateMachineState> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<CustomizedTestStateMachineState>, mergeInclude: string, spec?: MergeSpec): ObjList<CustomizedTestStateMachineState> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<CustomizedTestStateMachineState> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<CustomizedTestStateMachineState> | null;
   ...
   */
  static mergeAll(mergeObj: CustomizedTestStateMachineState, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: CustomizedTestStateMachineState, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<CustomizedTestStateMachineState>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachineState> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<CustomizedTestStateMachineState>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachineState> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): CustomizedTestStateMachineState | null;
   ...
   */
  static beforeCreate(objs: Array_Type<CustomizedTestStateMachineState>): ObjList<CustomizedTestStateMachineState>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<CustomizedTestStateMachineState>): ObjList<CustomizedTestStateMachineState>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<CustomizedTestStateMachineState>): ObjList<CustomizedTestStateMachineState>;
   ...
   */
  static afterCreate(objs: Array_Type<CustomizedTestStateMachineState>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<CustomizedTestStateMachineState>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<CustomizedTestStateMachineState>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<CustomizedTestStateMachineState>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<CustomizedTestStateMachineState>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): CustomizedTestStateMachineState | null;
   ...
   */
  withoutIdentity(): CustomizedTestStateMachineState | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<CustomizedTestStateMachineState>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: CustomizedTestStateMachineState, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<CustomizedTestStateMachineState>, callback?: λFunction<CustomizedTestStateMachineState | null, CustomizedTestStateMachineState | null>): ObjList<CustomizedTestStateMachineState>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<CustomizedTestStateMachineState>, callback?: λFunction<CustomizedTestStateMachineState | null, CustomizedTestStateMachineState | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): CustomizedTestStateMachineState;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachineState> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): CustomizedTestStateMachineState | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachineState> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): CustomizedTestStateMachineState | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<CustomizedTestStateMachineState> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): CustomizedTestStateMachineState | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<CustomizedTestStateMachineState> | null;
  ...
  dependencies(): SeedDataDeps<CustomizedTestStateMachineState> | null;
