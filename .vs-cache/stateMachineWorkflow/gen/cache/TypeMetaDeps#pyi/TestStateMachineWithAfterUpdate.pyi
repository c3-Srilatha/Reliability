...
from c3.stateMachineWorkflow.TestStateMachineHistory import TestStateMachineHistory
...
from c3.stateMachineWorkflow.TestStateMachineTransition import TestStateMachineTransition
...
from c3.stateMachineWorkflow.TestStateMachineState import TestStateMachineState
from c3.platform.ValidateObjResult import ValidateObjResult
from c3.platform.FetchResult import FetchResult
from c3.platform.Promise import Promise
from c3.stateMachineWorkflow.WorkOrderPerfTest import WorkOrderPerfTest
...
# Python definitions for the C3 type TestStateMachineWithAfterUpdate


class TestStateMachineWithAfterUpdate(TestStateMachine):
    """
    ...
    currentState: Optional[TestStateMachineState]=None
    """
    A stored calc field representing the current state - uses a {@link StateMachineHistory} to keep track.
    """

    stateHistories: Optional[Array[TestStateMachineHistory]]=None
    """
    A collection of the states this {@link StateMachine} has passed through.
    """

    transitions: Optional[Array[TestStateMachineTransition]]=None
    """
    Transitions available from the current state
    """

    currentStateHistory: Optional[TestStateMachineHistory]=None
    """
    ...
    numWorkOrdersOpen: Optional[int]=None
    """
    ...
    workOrders: Optional[Array[WorkOrderPerfTest]]=None
    """
    ...
    """
    def __init__(self, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, currentState: Optional[TestStateMachineState]=None, stateHistories: Optional[Array[TestStateMachineHistory]]=None, transitions: Optional[Array[TestStateMachineTransition]]=None, currentStateHistory: Optional[TestStateMachineHistory]=None, fieldA: Optional[str]=None, fieldB: Optional[str]=None, numWorkOrdersOpen: Optional[int]=None, workOrders: Optional[Array[WorkOrderPerfTest]]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[TestStateMachineWithAfterUpdate]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[TestStateMachineWithAfterUpdate]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[TestStateMachineWithAfterUpdate]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[TestStateMachineWithAfterUpdate]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> TestStateMachineWithAfterUpdate:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> TestStateMachineWithAfterUpdate:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> TestStateMachineWithAfterUpdate:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[TestStateMachineWithAfterUpdate]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[TestStateMachineWithAfterUpdate]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> TestStateMachineWithAfterUpdate:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> TestStateMachineWithAfterUpdate:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> TestStateMachineWithAfterUpdate:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> TestStateMachineWithAfterUpdate:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> TestStateMachineWithAfterUpdate:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> TestStateMachineWithAfterUpdate:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> TestStateMachineWithAfterUpdate:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> TestStateMachineWithAfterUpdate:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> TestStateMachineWithAfterUpdate:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> TestStateMachineWithAfterUpdate:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> TestStateMachineWithAfterUpdate:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> TestStateMachineWithAfterUpdate:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> TestStateMachineWithAfterUpdate:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> TestStateMachineWithAfterUpdate:
    """
    @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> TestStateMachineWithAfterUpdate:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> TestStateMachineWithAfterUpdate:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> TestStateMachineWithAfterUpdate:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> TestStateMachineWithAfterUpdate:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> TestStateMachineWithAfterUpdate:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> TestStateMachineWithAfterUpdate:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> TestStateMachineWithAfterUpdate:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> TestStateMachineWithAfterUpdate:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> TestStateMachineWithAfterUpdate:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> TestStateMachineWithAfterUpdate:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> TestStateMachineWithAfterUpdate:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> TestStateMachineWithAfterUpdate:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> TestStateMachineWithAfterUpdate:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> TestStateMachineWithAfterUpdate:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[TestStateMachineWithAfterUpdate]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[TestStateMachineWithAfterUpdate]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[TestStateMachineWithAfterUpdate]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[TestStateMachineWithAfterUpdate]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[TestStateMachineWithAfterUpdate]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, TestStateMachineWithAfterUpdate]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, TestStateMachineWithAfterUpdate]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[TestStateMachineWithAfterUpdate]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[TestStateMachineWithAfterUpdate]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> TestStateMachineWithAfterUpdate:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> TestStateMachineWithAfterUpdate:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> TestStateMachineWithAfterUpdate:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> TestStateMachineWithAfterUpdate:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> TestStateMachineWithAfterUpdate:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> TestStateMachineWithAfterUpdate:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[TestStateMachineWithAfterUpdate]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> TestStateMachineWithAfterUpdate:
    """
    ...
    """
        ...
    def afterMake(self) -> TestStateMachineWithAfterUpdate:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> TestStateMachineWithAfterUpdate:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[TestStateMachineWithAfterUpdate]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> TestStateMachineWithAfterUpdate:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[TestStateMachineWithAfterUpdate]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[TestStateMachineWithAfterUpdate]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[TestStateMachineWithAfterUpdate]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[TestStateMachineWithAfterUpdate]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[TestStateMachineWithAfterUpdate]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[TestStateMachineWithAfterUpdate]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> TestStateMachineWithAfterUpdate:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[TestStateMachineWithAfterUpdate]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> TestStateMachineWithAfterUpdate:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[TestStateMachineWithAfterUpdate]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[TestStateMachineWithAfterUpdate]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[TestStateMachineWithAfterUpdate], spec: UpsertSpec=None) -> Union[ObjList[TestStateMachineWithAfterUpdate]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[TestStateMachineWithAfterUpdate], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[TestStateMachineWithAfterUpdate]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: TestStateMachineWithAfterUpdate=None, spec: UpsertSpec=None) -> Union[TestStateMachineWithAfterUpdate]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: TestStateMachineWithAfterUpdate=None, spec: UpsertSpec=None) -> Union[TestStateMachineWithAfterUpdate]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[TestStateMachineWithAfterUpdate]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[TestStateMachineWithAfterUpdate]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[TestStateMachineWithAfterUpdate]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[TestStateMachineWithAfterUpdate], srcObjs: Array[TestStateMachineWithAfterUpdate]=None, spec: UpsertSpec=None) -> Union[ObjList[TestStateMachineWithAfterUpdate]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[TestStateMachineWithAfterUpdate]]], spec: UpsertSpec=None) -> Union[ObjList[TestStateMachineWithAfterUpdate]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[TestStateMachineWithAfterUpdate], srcObjs: Array[TestStateMachineWithAfterUpdate]=None, spec: UpsertSpec=None) -> Union[ObjList[TestStateMachineWithAfterUpdate]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[TestStateMachineWithAfterUpdate]]], spec: UpsertSpec=None) -> Union[ObjList[TestStateMachineWithAfterUpdate]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[TestStateMachineWithAfterUpdate], spec: TouchSpec=None) -> Union[ObjList[TestStateMachineWithAfterUpdate]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[TestStateMachineWithAfterUpdate], spec: MergeSpec=None) -> Union[ObjList[TestStateMachineWithAfterUpdate]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[TestStateMachineWithAfterUpdate], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[TestStateMachineWithAfterUpdate]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[TestStateMachineWithAfterUpdate]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[TestStateMachineWithAfterUpdate]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: TestStateMachineWithAfterUpdate, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: TestStateMachineWithAfterUpdate, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[TestStateMachineWithAfterUpdate], spec: UpsertSpec=None) -> Union[ObjList[TestStateMachineWithAfterUpdate]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[TestStateMachineWithAfterUpdate], spec: UpsertSpec=None) -> Union[ObjList[TestStateMachineWithAfterUpdate]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[TestStateMachineWithAfterUpdate]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[TestStateMachineWithAfterUpdate]) -> ObjList[TestStateMachineWithAfterUpdate]:
    """
    See {@link PersistableWritable#beforeCreate}
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[TestStateMachineWithAfterUpdate]) -> ObjList[TestStateMachineWithAfterUpdate]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[TestStateMachineWithAfterUpdate]) -> ObjList[TestStateMachineWithAfterUpdate]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[TestStateMachineWithAfterUpdate]) -> Union[Array[ObjError]]:
    """
    See {@link PersistableWritable#afterCreate}
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[TestStateMachineWithAfterUpdate]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[TestStateMachineWithAfterUpdate]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[TestStateMachineWithAfterUpdate]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[TestStateMachineWithAfterUpdate]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[TestStateMachineWithAfterUpdate]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[TestStateMachineWithAfterUpdate]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[TestStateMachineWithAfterUpdate]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: TestStateMachineWithAfterUpdate=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[TestStateMachineWithAfterUpdate], callback: Callable[[Union[TestStateMachineWithAfterUpdate]], Union[TestStateMachineWithAfterUpdate]]=None) -> ObjList[TestStateMachineWithAfterUpdate]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[TestStateMachineWithAfterUpdate], callback: Callable[[Union[TestStateMachineWithAfterUpdate]], Union[TestStateMachineWithAfterUpdate]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def transitionBatch(cls, stateMachines: Array[TestStateMachineWithAfterUpdate], toState: TestStateMachineState, retry: int=None, stateHistoryParams: TestStateMachineHistory=None) -> Array[StateMachineTransitionStatus[TestStateMachineHistory, TestStateMachineTransition]]:
    """
    Transition an array of state machines to a new state
    """
        ...
    def transition(self, toState: TestStateMachineState, testOnly: bool=None, stateHistoryParams: TestStateMachineHistory=None) -> StateMachineTransitionStatus[TestStateMachineHistory, TestStateMachineTransition]:
    """
    ...
    """
        ...
    def checkTransition(self, toState: TestStateMachineState) -> bool:
    """
    ...
    """
        ...
    def possibleStates(self) -> Union[Array[TestStateMachineState]]:
    """
    ...
    """
        ...
    @classmethod
    def allStates(cls) -> Union[Array[TestStateMachineState]]:
    """
    Return list of all states in the {@link StateMachine}.
    """
        ...
    def possibleTransitions(self) -> Union[Array[TestStateMachineTransition]]:
    """
    Return list of transitions possible from the current state given the current user permissions and current conditions.
    """
        ...
    @classmethod
    def allTransitions(cls, fromState: TestStateMachineState=None, toState: TestStateMachineState=None) -> Union[Array[TestStateMachineTransition]]:
    """
    ...
    """
        ...
    def forceTransition(self, toState: TestStateMachineState, stateHistoryParams: TestStateMachineHistory=None) -> bool:
    """
    ...
    """
        ...
    @classmethod
    def forceTransitionBatch(cls, stateMachines: Array[TestStateMachineWithAfterUpdate], toState: TestStateMachineState, stateHistoryParams: TestStateMachineHistory=None) -> Map[str, bool]:
    """
    ...
    """
        ...
    @classmethod
    def stateRecoverBatch(cls, stateMachines: Array[TestStateMachineWithAfterUpdate]) -> Map[str, bool]:
    """
    ...
    """
        ...
    def transitionWithTransitions(self, transitions: Array[TestStateMachineTransition]=None, testOnly: bool=None, stateHistoryParams: TestStateMachineHistory=None) -> StateMachineTransitionStatus[TestStateMachineHistory, TestStateMachineTransition]:
    """
    Transition with a valid transition in the transitions array
    """
        ...
    @classmethod
    def doBeforeCreate(cls, objs: Array[TestStateMachineWithAfterUpdate]) -> Union[ObjList[TestStateMachineWithAfterUpdate]]:
    """
    ...
    """
        ...
    @classmethod
    def doAfterUpdate(cls, objs: Array[TestStateMachineWithAfterUpdate]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def doAfterCreate(cls, objs: Array[TestStateMachineWithAfterUpdate]) -> Union[ObjList[TestStateMachineWithAfterUpdate]]:
    """
    ...
    """
        ...
    def executeTransition(self, transition: TestStateMachineTransition, stateOrderCounter: int, stateHistoryParams: TestStateMachineHistory=None) -> TestStateMachineHistory:
    """
    Internal use only.
    ...
    """
        ...
    def findTransitions(self, allTransitions: Array[TestStateMachineTransition]) -> Union[Array[TestStateMachineTransition]]:
    """
    Internal use only.
    ...
    """
        ...
    def reserveStateOrderCounter(self) -> StateMachineTransitionStatus[TestStateMachineHistory, TestStateMachineTransition]:
    """
    Internal use only.
    Implements a statemachine db lock.
    """
        ...
    def checkStateMachine(self) -> StateMachineTransitionStatus[TestStateMachineHistory, TestStateMachineTransition]:
    """
    Internal use only.
    ...
    """
        ...
    def transitionAndRefreshCurrentState(self, toState: TestStateMachineState, stateHistoryParams: TestStateMachineHistory=None) -> StateMachineTransitionStatus[TestStateMachineHistory, TestStateMachineTransition]:
    """
    Used from the UI to transition and refresh currentState stored calc.
    """
        ...
    @classmethod
    def transitionBatchAndRefreshCurrentState(cls, stateMachines: Array[TestStateMachineWithAfterUpdate], toState: TestStateMachineState, retry: int=None, stateHistoryParams: TestStateMachineHistory=None) -> Array[StateMachineTransitionStatus[TestStateMachineHistory, TestStateMachineTransition]]:
    """
