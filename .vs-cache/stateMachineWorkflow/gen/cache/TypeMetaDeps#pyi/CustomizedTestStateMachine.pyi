...
from c3.stateMachineWorkflow.CustomizedTestStateMachineHistory import CustomizedTestStateMachineHistory
...
from c3.stateMachineWorkflow.CustomizedTestStateMachineTransition import CustomizedTestStateMachineTransition
...
from c3.stateMachineWorkflow.CustomizedTestStateMachineState import CustomizedTestStateMachineState
...
# Python definitions for the C3 type CustomizedTestStateMachine


class CustomizedTestStateMachine(StateMachine[CustomizedTestStateMachineHistory, CustomizedTestStateMachineState, CustomizedTestStateMachineTransition]):
    """
    Entity type `CustomizedTestStateMachine` represents a state machine schema that includes fields for testing
    
    @remarks this represents a made instance of CustomizedTestStateMachine
    """
    ...
    currentState: Optional[CustomizedTestStateMachineState]=None
    """
    A stored calc field representing the current state - uses a {@link StateMachineHistory} to keep track.
    """

    stateHistories: Optional[Array[CustomizedTestStateMachineHistory]]=None
    """
    A collection of the states this {@link StateMachine} has passed through.
    """

    transitions: Optional[Array[CustomizedTestStateMachineTransition]]=None
    """
    Transitions available from the current state
    """

    currentStateHistory: Optional[CustomizedTestStateMachineHistory]=None
    """
    Calc field to get the current state history
    """
    def __init__(self, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, currentState: Optional[CustomizedTestStateMachineState]=None, stateHistories: Optional[Array[CustomizedTestStateMachineHistory]]=None, transitions: Optional[Array[CustomizedTestStateMachineTransition]]=None, currentStateHistory: Optional[CustomizedTestStateMachineHistory]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[CustomizedTestStateMachine]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[CustomizedTestStateMachine]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[CustomizedTestStateMachine]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[CustomizedTestStateMachine]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> CustomizedTestStateMachine:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> CustomizedTestStateMachine:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> CustomizedTestStateMachine:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[CustomizedTestStateMachine]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[CustomizedTestStateMachine]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> CustomizedTestStateMachine:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> CustomizedTestStateMachine:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> CustomizedTestStateMachine:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> CustomizedTestStateMachine:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> CustomizedTestStateMachine:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> CustomizedTestStateMachine:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> CustomizedTestStateMachine:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> CustomizedTestStateMachine:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> CustomizedTestStateMachine:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> CustomizedTestStateMachine:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> CustomizedTestStateMachine:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> CustomizedTestStateMachine:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> CustomizedTestStateMachine:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> CustomizedTestStateMachine:
    """
    @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> CustomizedTestStateMachine:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> CustomizedTestStateMachine:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> CustomizedTestStateMachine:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> CustomizedTestStateMachine:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> CustomizedTestStateMachine:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> CustomizedTestStateMachine:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> CustomizedTestStateMachine:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> CustomizedTestStateMachine:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> CustomizedTestStateMachine:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> CustomizedTestStateMachine:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> CustomizedTestStateMachine:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> CustomizedTestStateMachine:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> CustomizedTestStateMachine:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> CustomizedTestStateMachine:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[CustomizedTestStateMachine]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[CustomizedTestStateMachine]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[CustomizedTestStateMachine]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[CustomizedTestStateMachine]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[CustomizedTestStateMachine]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, CustomizedTestStateMachine]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, CustomizedTestStateMachine]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[CustomizedTestStateMachine]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[CustomizedTestStateMachine]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> CustomizedTestStateMachine:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> CustomizedTestStateMachine:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> CustomizedTestStateMachine:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> CustomizedTestStateMachine:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> CustomizedTestStateMachine:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> CustomizedTestStateMachine:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[CustomizedTestStateMachine]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> CustomizedTestStateMachine:
    """
    ...
    """
        ...
    def afterMake(self) -> CustomizedTestStateMachine:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> CustomizedTestStateMachine:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[CustomizedTestStateMachine]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> CustomizedTestStateMachine:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[CustomizedTestStateMachine]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[CustomizedTestStateMachine]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[CustomizedTestStateMachine]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[CustomizedTestStateMachine]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[CustomizedTestStateMachine]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[CustomizedTestStateMachine]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> CustomizedTestStateMachine:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[CustomizedTestStateMachine]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> CustomizedTestStateMachine:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[CustomizedTestStateMachine]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[CustomizedTestStateMachine]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[CustomizedTestStateMachine], spec: UpsertSpec=None) -> Union[ObjList[CustomizedTestStateMachine]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[CustomizedTestStateMachine], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[CustomizedTestStateMachine]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: CustomizedTestStateMachine=None, spec: UpsertSpec=None) -> Union[CustomizedTestStateMachine]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: CustomizedTestStateMachine=None, spec: UpsertSpec=None) -> Union[CustomizedTestStateMachine]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[CustomizedTestStateMachine]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[CustomizedTestStateMachine]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[CustomizedTestStateMachine]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[CustomizedTestStateMachine], srcObjs: Array[CustomizedTestStateMachine]=None, spec: UpsertSpec=None) -> Union[ObjList[CustomizedTestStateMachine]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[CustomizedTestStateMachine]]], spec: UpsertSpec=None) -> Union[ObjList[CustomizedTestStateMachine]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[CustomizedTestStateMachine], srcObjs: Array[CustomizedTestStateMachine]=None, spec: UpsertSpec=None) -> Union[ObjList[CustomizedTestStateMachine]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[CustomizedTestStateMachine]]], spec: UpsertSpec=None) -> Union[ObjList[CustomizedTestStateMachine]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[CustomizedTestStateMachine], spec: TouchSpec=None) -> Union[ObjList[CustomizedTestStateMachine]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[CustomizedTestStateMachine], spec: MergeSpec=None) -> Union[ObjList[CustomizedTestStateMachine]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[CustomizedTestStateMachine], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[CustomizedTestStateMachine]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[CustomizedTestStateMachine]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[CustomizedTestStateMachine]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: CustomizedTestStateMachine, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: CustomizedTestStateMachine, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[CustomizedTestStateMachine], spec: UpsertSpec=None) -> Union[ObjList[CustomizedTestStateMachine]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[CustomizedTestStateMachine], spec: UpsertSpec=None) -> Union[ObjList[CustomizedTestStateMachine]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[CustomizedTestStateMachine]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[CustomizedTestStateMachine]) -> ObjList[CustomizedTestStateMachine]:
    """
    See {@link PersistableWritable#beforeCreate}
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[CustomizedTestStateMachine]) -> ObjList[CustomizedTestStateMachine]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[CustomizedTestStateMachine]) -> ObjList[CustomizedTestStateMachine]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[CustomizedTestStateMachine]) -> Union[Array[ObjError]]:
    """
    See {@link PersistableWritable#afterCreate}
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[CustomizedTestStateMachine]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[CustomizedTestStateMachine]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[CustomizedTestStateMachine]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[CustomizedTestStateMachine]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[CustomizedTestStateMachine]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[CustomizedTestStateMachine]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[CustomizedTestStateMachine]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: CustomizedTestStateMachine=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[CustomizedTestStateMachine], callback: Callable[[Union[CustomizedTestStateMachine]], Union[CustomizedTestStateMachine]]=None) -> ObjList[CustomizedTestStateMachine]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[CustomizedTestStateMachine], callback: Callable[[Union[CustomizedTestStateMachine]], Union[CustomizedTestStateMachine]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def transitionBatch(cls, stateMachines: Array[CustomizedTestStateMachine], toState: CustomizedTestStateMachineState, retry: int=None, stateHistoryParams: CustomizedTestStateMachineHistory=None) -> Array[StateMachineTransitionStatus[CustomizedTestStateMachineHistory, CustomizedTestStateMachineTransition]]:
    """
    Transition an array of state machines to a new state
    """
        ...
    def transition(self, toState: CustomizedTestStateMachineState, testOnly: bool=None, stateHistoryParams: CustomizedTestStateMachineHistory=None) -> StateMachineTransitionStatus[CustomizedTestStateMachineHistory, CustomizedTestStateMachineTransition]:
    """
    ...
    """
        ...
    def checkTransition(self, toState: CustomizedTestStateMachineState) -> bool:
    """
    ...
    """
        ...
    def possibleStates(self) -> Union[Array[CustomizedTestStateMachineState]]:
    """
    ...
    """
        ...
    @classmethod
    def allStates(cls) -> Union[Array[CustomizedTestStateMachineState]]:
    """
    Return list of all states in the {@link StateMachine}.
    """
        ...
    def possibleTransitions(self) -> Union[Array[CustomizedTestStateMachineTransition]]:
    """
    Return list of transitions possible from the current state given the current user permissions and current conditions.
    """
        ...
    @classmethod
    def allTransitions(cls, fromState: CustomizedTestStateMachineState=None, toState: CustomizedTestStateMachineState=None) -> Union[Array[CustomizedTestStateMachineTransition]]:
    """
    ...
    """
        ...
    def forceTransition(self, toState: CustomizedTestStateMachineState, stateHistoryParams: CustomizedTestStateMachineHistory=None) -> bool:
    """
    ...
    """
        ...
    @classmethod
    def forceTransitionBatch(cls, stateMachines: Array[CustomizedTestStateMachine], toState: CustomizedTestStateMachineState, stateHistoryParams: CustomizedTestStateMachineHistory=None) -> Map[str, bool]:
    """
    ...
    """
        ...
    @classmethod
    def stateRecoverBatch(cls, stateMachines: Array[CustomizedTestStateMachine]) -> Map[str, bool]:
    """
    ...
    """
        ...
    def transitionWithTransitions(self, transitions: Array[CustomizedTestStateMachineTransition]=None, testOnly: bool=None, stateHistoryParams: CustomizedTestStateMachineHistory=None) -> StateMachineTransitionStatus[CustomizedTestStateMachineHistory, CustomizedTestStateMachineTransition]:
    """
    Transition with a valid transition in the transitions array
    """
        ...
    @classmethod
    def doBeforeCreate(cls, objs: Array[CustomizedTestStateMachine]) -> Union[ObjList[CustomizedTestStateMachine]]:
    """
    ...
    """
        ...
    @classmethod
    def doAfterUpdate(cls, objs: Array[CustomizedTestStateMachine]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def doAfterCreate(cls, objs: Array[CustomizedTestStateMachine]) -> Union[ObjList[CustomizedTestStateMachine]]:
    """
    ...
    """
        ...
    def executeTransition(self, transition: CustomizedTestStateMachineTransition, stateOrderCounter: int, stateHistoryParams: CustomizedTestStateMachineHistory=None) -> CustomizedTestStateMachineHistory:
    """
    Internal use only.
    ...
    """
        ...
    def findTransitions(self, allTransitions: Array[CustomizedTestStateMachineTransition]) -> Union[Array[CustomizedTestStateMachineTransition]]:
    """
    Internal use only.
    ...
    """
        ...
    def reserveStateOrderCounter(self) -> StateMachineTransitionStatus[CustomizedTestStateMachineHistory, CustomizedTestStateMachineTransition]:
    """
    Internal use only.
    Implements a statemachine db lock.
    """
        ...
    def checkStateMachine(self) -> StateMachineTransitionStatus[CustomizedTestStateMachineHistory, CustomizedTestStateMachineTransition]:
    """
    Internal use only.
    ...
    """
        ...
    def transitionAndRefreshCurrentState(self, toState: CustomizedTestStateMachineState, stateHistoryParams: CustomizedTestStateMachineHistory=None) -> StateMachineTransitionStatus[CustomizedTestStateMachineHistory, CustomizedTestStateMachineTransition]:
    """
    Used from the UI to transition and refresh currentState stored calc.
    """
        ...
    @classmethod
    def transitionBatchAndRefreshCurrentState(cls, stateMachines: Array[CustomizedTestStateMachine], toState: CustomizedTestStateMachineState, retry: int=None, stateHistoryParams: CustomizedTestStateMachineHistory=None) -> Array[StateMachineTransitionStatus[CustomizedTestStateMachineHistory, CustomizedTestStateMachineTransition]]:
    """
