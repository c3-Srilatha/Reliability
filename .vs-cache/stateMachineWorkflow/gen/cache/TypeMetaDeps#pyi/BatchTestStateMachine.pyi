...
from c3.stateMachineWorkflow.BatchTestStateMachineTransition import BatchTestStateMachineTransition
...
from c3.stateMachineWorkflow.BatchTestStateMachineHistory import BatchTestStateMachineHistory
...
from c3.stateMachineWorkflow.BatchTestStateMachineState import BatchTestStateMachineState
...
# Python definitions for the C3 type BatchTestStateMachine


class BatchTestStateMachine(StateMachine[BatchTestStateMachineHistory, BatchTestStateMachineState, BatchTestStateMachineTransition]):
    """
    Entity type that represents a state machine schema that includes fields for testing
    
    @remarks this represents a made instance of BatchTestStateMachine
    """
    ...
    currentState: Optional[BatchTestStateMachineState]=None
    """
    A stored calc field representing the current state - uses a {@link StateMachineHistory} to keep track.
    """

    stateHistories: Optional[Array[BatchTestStateMachineHistory]]=None
    """
    A collection of the states this {@link StateMachine} has passed through.
    """

    transitions: Optional[Array[BatchTestStateMachineTransition]]=None
    """
    Transitions available from the current state
    """

    currentStateHistory: Optional[BatchTestStateMachineHistory]=None
    """
    Calc field to get the current state history
    """
    def __init__(self, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, currentState: Optional[BatchTestStateMachineState]=None, stateHistories: Optional[Array[BatchTestStateMachineHistory]]=None, transitions: Optional[Array[BatchTestStateMachineTransition]]=None, currentStateHistory: Optional[BatchTestStateMachineHistory]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[BatchTestStateMachine]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[BatchTestStateMachine]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[BatchTestStateMachine]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[BatchTestStateMachine]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> BatchTestStateMachine:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> BatchTestStateMachine:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> BatchTestStateMachine:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[BatchTestStateMachine]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[BatchTestStateMachine]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> BatchTestStateMachine:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> BatchTestStateMachine:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> BatchTestStateMachine:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> BatchTestStateMachine:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> BatchTestStateMachine:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> BatchTestStateMachine:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> BatchTestStateMachine:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> BatchTestStateMachine:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> BatchTestStateMachine:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> BatchTestStateMachine:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> BatchTestStateMachine:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> BatchTestStateMachine:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> BatchTestStateMachine:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> BatchTestStateMachine:
    """
    @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> BatchTestStateMachine:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> BatchTestStateMachine:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> BatchTestStateMachine:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> BatchTestStateMachine:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> BatchTestStateMachine:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> BatchTestStateMachine:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> BatchTestStateMachine:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> BatchTestStateMachine:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> BatchTestStateMachine:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> BatchTestStateMachine:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> BatchTestStateMachine:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> BatchTestStateMachine:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> BatchTestStateMachine:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> BatchTestStateMachine:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[BatchTestStateMachine]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[BatchTestStateMachine]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[BatchTestStateMachine]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[BatchTestStateMachine]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[BatchTestStateMachine]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, BatchTestStateMachine]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, BatchTestStateMachine]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[BatchTestStateMachine]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[BatchTestStateMachine]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> BatchTestStateMachine:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> BatchTestStateMachine:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> BatchTestStateMachine:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> BatchTestStateMachine:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> BatchTestStateMachine:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> BatchTestStateMachine:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[BatchTestStateMachine]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> BatchTestStateMachine:
    """
    ...
    """
        ...
    def afterMake(self) -> BatchTestStateMachine:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> BatchTestStateMachine:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[BatchTestStateMachine]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> BatchTestStateMachine:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[BatchTestStateMachine]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[BatchTestStateMachine]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[BatchTestStateMachine]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[BatchTestStateMachine]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[BatchTestStateMachine]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[BatchTestStateMachine]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> BatchTestStateMachine:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[BatchTestStateMachine]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> BatchTestStateMachine:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[BatchTestStateMachine]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[BatchTestStateMachine]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[BatchTestStateMachine], spec: UpsertSpec=None) -> Union[ObjList[BatchTestStateMachine]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[BatchTestStateMachine], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[BatchTestStateMachine]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: BatchTestStateMachine=None, spec: UpsertSpec=None) -> Union[BatchTestStateMachine]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: BatchTestStateMachine=None, spec: UpsertSpec=None) -> Union[BatchTestStateMachine]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[BatchTestStateMachine]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[BatchTestStateMachine]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[BatchTestStateMachine]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[BatchTestStateMachine], srcObjs: Array[BatchTestStateMachine]=None, spec: UpsertSpec=None) -> Union[ObjList[BatchTestStateMachine]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[BatchTestStateMachine]]], spec: UpsertSpec=None) -> Union[ObjList[BatchTestStateMachine]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[BatchTestStateMachine], srcObjs: Array[BatchTestStateMachine]=None, spec: UpsertSpec=None) -> Union[ObjList[BatchTestStateMachine]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[BatchTestStateMachine]]], spec: UpsertSpec=None) -> Union[ObjList[BatchTestStateMachine]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[BatchTestStateMachine], spec: TouchSpec=None) -> Union[ObjList[BatchTestStateMachine]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[BatchTestStateMachine], spec: MergeSpec=None) -> Union[ObjList[BatchTestStateMachine]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[BatchTestStateMachine], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[BatchTestStateMachine]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[BatchTestStateMachine]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[BatchTestStateMachine]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: BatchTestStateMachine, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: BatchTestStateMachine, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[BatchTestStateMachine], spec: UpsertSpec=None) -> Union[ObjList[BatchTestStateMachine]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[BatchTestStateMachine], spec: UpsertSpec=None) -> Union[ObjList[BatchTestStateMachine]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[BatchTestStateMachine]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[BatchTestStateMachine]) -> ObjList[BatchTestStateMachine]:
    """
    See {@link PersistableWritable#beforeCreate}
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[BatchTestStateMachine]) -> ObjList[BatchTestStateMachine]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[BatchTestStateMachine]) -> ObjList[BatchTestStateMachine]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[BatchTestStateMachine]) -> Union[Array[ObjError]]:
    """
    See {@link PersistableWritable#afterCreate}
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[BatchTestStateMachine]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[BatchTestStateMachine]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[BatchTestStateMachine]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[BatchTestStateMachine]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[BatchTestStateMachine]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[BatchTestStateMachine]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[BatchTestStateMachine]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: BatchTestStateMachine=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[BatchTestStateMachine], callback: Callable[[Union[BatchTestStateMachine]], Union[BatchTestStateMachine]]=None) -> ObjList[BatchTestStateMachine]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[BatchTestStateMachine], callback: Callable[[Union[BatchTestStateMachine]], Union[BatchTestStateMachine]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def transitionBatch(cls, stateMachines: Array[BatchTestStateMachine], toState: BatchTestStateMachineState, retry: int=None, stateHistoryParams: BatchTestStateMachineHistory=None) -> Array[StateMachineTransitionStatus[BatchTestStateMachineHistory, BatchTestStateMachineTransition]]:
    """
    Transition an array of state machines to a new state
    """
        ...
    def transition(self, toState: BatchTestStateMachineState, testOnly: bool=None, stateHistoryParams: BatchTestStateMachineHistory=None) -> StateMachineTransitionStatus[BatchTestStateMachineHistory, BatchTestStateMachineTransition]:
    """
    ...
    """
        ...
    def checkTransition(self, toState: BatchTestStateMachineState) -> bool:
    """
    ...
    """
        ...
    def possibleStates(self) -> Union[Array[BatchTestStateMachineState]]:
    """
    ...
    """
        ...
    @classmethod
    def allStates(cls) -> Union[Array[BatchTestStateMachineState]]:
    """
    Return list of all states in the {@link StateMachine}.
    """
        ...
    def possibleTransitions(self) -> Union[Array[BatchTestStateMachineTransition]]:
    """
    Return list of transitions possible from the current state given the current user permissions and current conditions.
    """
        ...
    @classmethod
    def allTransitions(cls, fromState: BatchTestStateMachineState=None, toState: BatchTestStateMachineState=None) -> Union[Array[BatchTestStateMachineTransition]]:
    """
    ...
    """
        ...
    def forceTransition(self, toState: BatchTestStateMachineState, stateHistoryParams: BatchTestStateMachineHistory=None) -> bool:
    """
    ...
    """
        ...
    @classmethod
    def forceTransitionBatch(cls, stateMachines: Array[BatchTestStateMachine], toState: BatchTestStateMachineState, stateHistoryParams: BatchTestStateMachineHistory=None) -> Map[str, bool]:
    """
    ...
    """
        ...
    @classmethod
    def stateRecoverBatch(cls, stateMachines: Array[BatchTestStateMachine]) -> Map[str, bool]:
    """
    ...
    """
        ...
    def transitionWithTransitions(self, transitions: Array[BatchTestStateMachineTransition]=None, testOnly: bool=None, stateHistoryParams: BatchTestStateMachineHistory=None) -> StateMachineTransitionStatus[BatchTestStateMachineHistory, BatchTestStateMachineTransition]:
    """
    Transition with a valid transition in the transitions array
    """
        ...
    @classmethod
    def doBeforeCreate(cls, objs: Array[BatchTestStateMachine]) -> Union[ObjList[BatchTestStateMachine]]:
    """
    ...
    """
        ...
    @classmethod
    def doAfterUpdate(cls, objs: Array[BatchTestStateMachine]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def doAfterCreate(cls, objs: Array[BatchTestStateMachine]) -> Union[ObjList[BatchTestStateMachine]]:
    """
    ...
    """
        ...
    def executeTransition(self, transition: BatchTestStateMachineTransition, stateOrderCounter: int, stateHistoryParams: BatchTestStateMachineHistory=None) -> BatchTestStateMachineHistory:
    """
    Internal use only.
    ...
    """
        ...
    def findTransitions(self, allTransitions: Array[BatchTestStateMachineTransition]) -> Union[Array[BatchTestStateMachineTransition]]:
    """
    Internal use only.
    ...
    """
        ...
    def reserveStateOrderCounter(self) -> StateMachineTransitionStatus[BatchTestStateMachineHistory, BatchTestStateMachineTransition]:
    """
    Internal use only.
    Implements a statemachine db lock.
    """
        ...
    def checkStateMachine(self) -> StateMachineTransitionStatus[BatchTestStateMachineHistory, BatchTestStateMachineTransition]:
    """
    Internal use only.
    ...
    """
        ...
    def transitionAndRefreshCurrentState(self, toState: BatchTestStateMachineState, stateHistoryParams: BatchTestStateMachineHistory=None) -> StateMachineTransitionStatus[BatchTestStateMachineHistory, BatchTestStateMachineTransition]:
    """
    Used from the UI to transition and refresh currentState stored calc.
    """
        ...
    @classmethod
    def transitionBatchAndRefreshCurrentState(cls, stateMachines: Array[BatchTestStateMachine], toState: BatchTestStateMachineState, retry: int=None, stateHistoryParams: BatchTestStateMachineHistory=None) -> Array[StateMachineTransitionStatus[BatchTestStateMachineHistory, BatchTestStateMachineTransition]]:
    """
