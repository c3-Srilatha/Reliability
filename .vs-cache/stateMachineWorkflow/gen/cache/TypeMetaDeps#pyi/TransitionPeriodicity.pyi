...
# Python definitions for the C3 type TransitionPeriodicity


class TransitionPeriodicity():
    """
    ...
    """
    def __init__(self, HOUR: Optional[str]=None, DAY: Optional[str]=None, MONTH: Optional[str]=None, YEAR: Optional[str]=None) -> None: ...
