// TypeScript definitions for the C3 type SensorHealthAlertState

/**
 * A state that a {@link SensorHealthAlert} can be in.
 *
 * @remarks this represents a value passed to a method that expects an instance of SensorHealthAlertState
 */
declare interface ISensorHealthAlertState {
   ...
   */
  autoTransitions?: Array_Type<SensorHealthAlertStateTransition> | Array<ISensorHealthAlertStateTransition>;
   ...
   */
  periodicTransitions?: Array_Type<SensorHealthAlertStateTransition> | Array<ISensorHealthAlertStateTransition>;
   ...
   */
  fromTransitions?: Array_Type<SensorHealthAlertStateTransition> | Array<ISensorHealthAlertStateTransition>;

  /**
   * {@link StateMachineTransition}s that lead into this {@link StateMachineState}.
   */
  toTransitions?: Array_Type<SensorHealthAlertStateTransition> | Array<ISensorHealthAlertStateTransition>;
}
 ...
 * A state that a {@link SensorHealthAlert} can be in.
 *
 * @remarks this represents a made instance of SensorHealthAlertState
 */
declare class SensorHealthAlertState extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): SensorHealthAlertState;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): SensorHealthAlertState;

  /**
   * The name of this {@link StateMachineState}.
   */
  readonly name?: string;
  withName(name: string | null): SensorHealthAlertState;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): SensorHealthAlertState;
  ...
  withVersion(version: number | null): SensorHealthAlertState;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): SensorHealthAlertState;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): SensorHealthAlertState;
  ...
  withHidden(hidden: boolean): SensorHealthAlertState;
  ...
  withUserOwned(userOwned: boolean): SensorHealthAlertState;
  ...
  withDisplayName(displayName: string | null): SensorHealthAlertState;
  ...
  withInitialState(initialState: boolean): SensorHealthAlertState;

  /**
   * Used to soft delete a record so all state histories still have valid pointers.
   */
  readonly deleted?: boolean;
  withDeleted(deleted: boolean): SensorHealthAlertState;

  /**
   * Used to include fields on the source type for exitAction and entryAction.
   */
  readonly includeSpec?: string;
  withIncludeSpec(includeSpec: string | null): SensorHealthAlertState;

  /**
   * Action to be triggered when leaving this state.
   */
  readonly exitAction?: λConsumer<any | null>;
  withExitAction(exitAction: λConsumer<any | null> | null): SensorHealthAlertState;

  /**
   * Action to be triggered when entering this state.
   */
  readonly entryAction?: λConsumer<any | null>;
  withEntryAction(entryAction: λConsumer<any | null> | null): SensorHealthAlertState;

  /**
   * The list of automatic transitions from this state to another that are {@link StateMachineTransition#isValid}.
   */
  readonly autoTransitions?: Array_Type<SensorHealthAlertStateTransition>;
  withAutoTransitions(autoTransitions: Array_Type<SensorHealthAlertStateTransition> | Array<ISensorHealthAlertStateTransition> | null): SensorHealthAlertState;

  /**
   * Whether this state has automatic transitions.
   */
  readonly hasAutoTransition?: boolean;
  withHasAutoTransition(hasAutoTransition: boolean): SensorHealthAlertState;

  /**
   * The list of periodic transitions from this state to another that are {@link StateMachineTransition#isValid}.
   */
  readonly periodicTransitions?: Array_Type<SensorHealthAlertStateTransition>;
  withPeriodicTransitions(periodicTransitions: Array_Type<SensorHealthAlertStateTransition> | Array<ISensorHealthAlertStateTransition> | null): SensorHealthAlertState;

  /**
   * Whether this state has periodic transitions.
   */
  readonly hasPeriodicTransitions?: boolean;
  withHasPeriodicTransitions(hasPeriodicTransitions: boolean): SensorHealthAlertState;

  /**
   * {@link StateMachineTransition}s that originate from this {@link StateMachineState}.
   */
  readonly fromTransitions?: Array_Type<SensorHealthAlertStateTransition>;
  withFromTransitions(fromTransitions: Array_Type<SensorHealthAlertStateTransition> | Array<ISensorHealthAlertStateTransition> | null): SensorHealthAlertState;

  /**
   * {@link StateMachineTransition}s that lead into this {@link StateMachineState}.
   */
  readonly toTransitions?: Array_Type<SensorHealthAlertStateTransition>;
  withToTransitions(toTransitions: Array_Type<SensorHealthAlertStateTransition> | Array<ISensorHealthAlertStateTransition> | null): SensorHealthAlertState;
   ...
   * @see #toJson
   */
  static fromJson(json: any): SensorHealthAlertState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): SensorHealthAlertState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): SensorHealthAlertState | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): SensorHealthAlertState | null;
   ...
   */
  replaceType(old: Type, new_: Type): SensorHealthAlertState;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): SensorHealthAlertState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): SensorHealthAlertState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<SensorHealthAlertState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<SensorHealthAlertState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): SensorHealthAlertState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SensorHealthAlertState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SensorHealthAlertState;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SensorHealthAlertState;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SensorHealthAlertState;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SensorHealthAlertState;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): SensorHealthAlertState;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SensorHealthAlertState;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SensorHealthAlertState;
   ...
   * @see #removeField
   */
  withoutField(field: string): SensorHealthAlertState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): SensorHealthAlertState;
   ...
   */
  withoutFields(fields: Array_Type<string>): SensorHealthAlertState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): SensorHealthAlertState;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SensorHealthAlertState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): SensorHealthAlertState;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SensorHealthAlertState;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SensorHealthAlertState;
   ...
   * @see #removeField
   */
  unsetField(field: string): SensorHealthAlertState;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SensorHealthAlertState;
   ...
   * @see #unsetField
   */
  removeField(field: string): SensorHealthAlertState;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SensorHealthAlertState;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): SensorHealthAlertState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): SensorHealthAlertState;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): SensorHealthAlertState;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): SensorHealthAlertState;

  mergeJson(json: any): SensorHealthAlertState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): SensorHealthAlertState;
   ...
   */
  sumObj(other: Obj, deep?: boolean): SensorHealthAlertState;
   ...
   */
  singletonArray(): Array_Type<SensorHealthAlertState>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<SensorHealthAlertState> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SensorHealthAlertState> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<SensorHealthAlertState>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SensorHealthAlertState> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, SensorHealthAlertState> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SensorHealthAlertState> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SensorHealthAlertState>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SensorHealthAlertState>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): SensorHealthAlertState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): SensorHealthAlertState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): SensorHealthAlertState;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SensorHealthAlertState;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): SensorHealthAlertState;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SensorHealthAlertState;
   ...
   * @see #fromString
   */
  static make(s: string): SensorHealthAlertState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): SensorHealthAlertState;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SensorHealthAlertState;
   ...
   */
  static cachedEmptyInst(): SensorHealthAlertState;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<SensorHealthAlertState> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): SensorHealthAlertState;
   ...
   */
  static allCached(): Stream<SensorHealthAlertState> | null;
   ...
   */
  static find(filter?: string): Stream<SensorHealthAlertState> | null;
   ...
   *         Otherwise no population will be performed.
   */
  static findBy(field: string, value: any): Stream<SensorHealthAlertState> | null;

  /**
   * @return cached instance.
   */
  getCached(): SensorHealthAlertState | null;

  /**
   * @return cached instance by the key.
   */
  static forCacheKey(key: string): SensorHealthAlertState | null;
   ...
   */
  static produce(key: string): SensorHealthAlertState | null;

  /**
   * Should produces the entire content for the cached data. Will populate the cache with the produced data.
   */
  static produceAll(): Map_Type<string, SensorHealthAlertState> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<SensorHealthAlertState>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SensorHealthAlertState>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<SensorHealthAlertState> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<SensorHealthAlertState>> | null;
   ...
   */
  get(include?: string): SensorHealthAlertState | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): SensorHealthAlertState | null;
   ...
   */
  getMissing(spec: GetMissingSpec): SensorHealthAlertState;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): SensorHealthAlertState | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): SensorHealthAlertState;
   ...
   * @see #toString
   */
  static fromString(s: string): SensorHealthAlertState | null;
   ...
   */
  create(spec?: UpsertSpec): SensorHealthAlertState | null;
   ...
   */
  static createBatch(objs: Array_Type<SensorHealthAlertState>, spec?: UpsertSpec): ObjList<SensorHealthAlertState> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<SensorHealthAlertState>, spec?: CreateBatchObjStreamSpec): ObjList<SensorHealthAlertState> | null;
   ...
   */
  update(srcObj?: SensorHealthAlertState, spec?: UpsertSpec): SensorHealthAlertState | null;
   ...
   */
  upsert(srcObj?: SensorHealthAlertState, spec?: UpsertSpec): SensorHealthAlertState | null;
   ...
   */
  merge(spec?: MergeSpec): SensorHealthAlertState | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): SensorHealthAlertState | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): SensorHealthAlertState | null;
   ...
   */
  static updateBatch(objs: Array_Type<SensorHealthAlertState>, srcObjs?: Array_Type<SensorHealthAlertState>, spec?: UpsertSpec): ObjList<SensorHealthAlertState> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<SensorHealthAlertState> | null>, spec?: UpsertSpec): ObjList<SensorHealthAlertState> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<SensorHealthAlertState>, srcObjs?: Array_Type<SensorHealthAlertState>, spec?: UpsertSpec): ObjList<SensorHealthAlertState> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<SensorHealthAlertState> | null>, spec?: UpsertSpec): ObjList<SensorHealthAlertState> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<SensorHealthAlertState>, spec?: TouchSpec): ObjList<SensorHealthAlertState> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<SensorHealthAlertState>, spec?: MergeSpec): ObjList<SensorHealthAlertState> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<SensorHealthAlertState>, mergeInclude: string, spec?: MergeSpec): ObjList<SensorHealthAlertState> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<SensorHealthAlertState> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<SensorHealthAlertState> | null;
   ...
   */
  static mergeAll(mergeObj: SensorHealthAlertState, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: SensorHealthAlertState, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<SensorHealthAlertState>, spec?: UpsertSpec): ObjList<SensorHealthAlertState> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<SensorHealthAlertState>, spec?: UpsertSpec): ObjList<SensorHealthAlertState> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): SensorHealthAlertState | null;
   ...
   */
  static beforeCreate(objs: Array_Type<SensorHealthAlertState>): ObjList<SensorHealthAlertState>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<SensorHealthAlertState>): ObjList<SensorHealthAlertState>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<SensorHealthAlertState>): ObjList<SensorHealthAlertState>;
   ...
   */
  static afterCreate(objs: Array_Type<SensorHealthAlertState>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<SensorHealthAlertState>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<SensorHealthAlertState>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<SensorHealthAlertState>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<SensorHealthAlertState>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): SensorHealthAlertState | null;
   ...
   */
  withoutIdentity(): SensorHealthAlertState | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<SensorHealthAlertState>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: SensorHealthAlertState, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<SensorHealthAlertState>, callback?: λFunction<SensorHealthAlertState | null, SensorHealthAlertState | null>): ObjList<SensorHealthAlertState>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<SensorHealthAlertState>, callback?: λFunction<SensorHealthAlertState | null, SensorHealthAlertState | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): SensorHealthAlertState;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<SensorHealthAlertState> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): SensorHealthAlertState | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<SensorHealthAlertState> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): SensorHealthAlertState | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<SensorHealthAlertState> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): SensorHealthAlertState | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<SensorHealthAlertState> | null;
  ...
  dependencies(): SeedDataDeps<SensorHealthAlertState> | null;
