// TypeScript definitions for the C3 type ReliabilitySensorAlertSchemaUpgrade

/**
 * Moves entities from legacy {@link ReliabilitySensorAlert} Type to
 * renamed {@link SensorHealthAlert} Type.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReliabilitySensorAlertSchemaUpgrade
 */
declare interface IReliabilitySensorAlertSchemaUpgrade {
}
 ...
 */
declare class ReliabilitySensorAlertSchemaUpgrade extends Obj  {
   ...
   * @see #toJson
   */
  static fromJson(json: any): ReliabilitySensorAlertSchemaUpgrade | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): ReliabilitySensorAlertSchemaUpgrade | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): ReliabilitySensorAlertSchemaUpgrade | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): ReliabilitySensorAlertSchemaUpgrade | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReliabilitySensorAlertSchemaUpgrade;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilitySensorAlertSchemaUpgrade;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): ReliabilitySensorAlertSchemaUpgrade;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilitySensorAlertSchemaUpgrade>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<ReliabilitySensorAlertSchemaUpgrade>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): ReliabilitySensorAlertSchemaUpgrade;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilitySensorAlertSchemaUpgrade;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReliabilitySensorAlertSchemaUpgrade;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReliabilitySensorAlertSchemaUpgrade;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReliabilitySensorAlertSchemaUpgrade;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReliabilitySensorAlertSchemaUpgrade;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): ReliabilitySensorAlertSchemaUpgrade;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReliabilitySensorAlertSchemaUpgrade;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReliabilitySensorAlertSchemaUpgrade;
   ...
   * @see #removeField
   */
  withoutField(field: string): ReliabilitySensorAlertSchemaUpgrade;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): ReliabilitySensorAlertSchemaUpgrade;
   ...
   */
  withoutFields(fields: Array_Type<string>): ReliabilitySensorAlertSchemaUpgrade;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): ReliabilitySensorAlertSchemaUpgrade;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReliabilitySensorAlertSchemaUpgrade;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): ReliabilitySensorAlertSchemaUpgrade;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReliabilitySensorAlertSchemaUpgrade;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReliabilitySensorAlertSchemaUpgrade;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReliabilitySensorAlertSchemaUpgrade;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReliabilitySensorAlertSchemaUpgrade;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReliabilitySensorAlertSchemaUpgrade;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReliabilitySensorAlertSchemaUpgrade;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): ReliabilitySensorAlertSchemaUpgrade;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): ReliabilitySensorAlertSchemaUpgrade;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): ReliabilitySensorAlertSchemaUpgrade;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): ReliabilitySensorAlertSchemaUpgrade;

  mergeJson(json: any): ReliabilitySensorAlertSchemaUpgrade;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): ReliabilitySensorAlertSchemaUpgrade;
   ...
   */
  sumObj(other: Obj, deep?: boolean): ReliabilitySensorAlertSchemaUpgrade;
   ...
   */
  singletonArray(): Array_Type<ReliabilitySensorAlertSchemaUpgrade>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<ReliabilitySensorAlertSchemaUpgrade> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReliabilitySensorAlertSchemaUpgrade> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<ReliabilitySensorAlertSchemaUpgrade>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReliabilitySensorAlertSchemaUpgrade> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, ReliabilitySensorAlertSchemaUpgrade> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReliabilitySensorAlertSchemaUpgrade> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReliabilitySensorAlertSchemaUpgrade>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReliabilitySensorAlertSchemaUpgrade>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): ReliabilitySensorAlertSchemaUpgrade;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): ReliabilitySensorAlertSchemaUpgrade;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): ReliabilitySensorAlertSchemaUpgrade;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReliabilitySensorAlertSchemaUpgrade;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): ReliabilitySensorAlertSchemaUpgrade;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReliabilitySensorAlertSchemaUpgrade;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): ReliabilitySensorAlertSchemaUpgrade;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ReliabilitySensorAlertSchemaUpgrade;
   ...
   */
  static cachedEmptyInst(): ReliabilitySensorAlertSchemaUpgrade;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<ReliabilitySensorAlertSchemaUpgrade> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): ReliabilitySensorAlertSchemaUpgrade;
   ...
   */
  static migrateReliabilitySensorAlert_1(): void;
}
