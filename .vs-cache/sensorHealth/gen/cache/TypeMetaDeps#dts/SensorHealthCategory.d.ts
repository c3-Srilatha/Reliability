// TypeScript definitions for the C3 type SensorHealthCategory

/**
 * A category of sensor health alerts.
 *
 * @remarks this represents a value passed to a method that expects an instance of SensorHealthCategory
 */
declare interface ISensorHealthCategory {
  ...
  /**
   * Translated name of the alert category
   */
  displayName?: string;

  /**
   * Metric expression to evaluate this category. The category is evaluated to true
   * if the data of the metric result are all true.
   * The expression will be evaluated on {@link Sensor}
   */
  expression: string;
  ...
  /**
   * When multiple categories need to be evaluated at the same time.
   * Categories with lower priority values are evaluated first
   */
  priority: number;

  /**
   * The values of the map are metric expressions.
   * The keys are names of the bindings in the evaluation of {@link expression}
   * Some bindings are dynamic. This field is used to generate those bindings.
   * The first value from the expression evaluation time series is used as a binding.
   */
  metricBindings?: Map_Type<string, string> | {[key: string]: string};
  ...
  /**
   * The horizon is used to determine the start of the metric evaluation.
   */
  horizon: number;
}
 ...
 * A category of sensor health alerts.
 *
 * @remarks this represents a made instance of SensorHealthCategory
 */
declare class SensorHealthCategory extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): SensorHealthCategory;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): SensorHealthCategory;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): SensorHealthCategory;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): SensorHealthCategory;
  ...
  withVersion(version: number | null): SensorHealthCategory;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): SensorHealthCategory;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): SensorHealthCategory;
  ...
  withHidden(hidden: boolean): SensorHealthCategory;
  ...
  withUserOwned(userOwned: boolean): SensorHealthCategory;

  /**
   * Description of the alert category
   */
  readonly description?: string;
  withDescription(description: string | null): SensorHealthCategory;

  /**
   * Translated name of the alert category
   */
  readonly displayName?: string;
  withDisplayName(displayName: string | null): SensorHealthCategory;
  ...
  withExpression(expression: string): SensorHealthCategory;

  /**
   * Metric bindings
   */
  readonly bindings?: Map_Type<string, any>;
  withBindings(bindings: Map_Type<string, any> | {[key: string]: any} | null): SensorHealthCategory;
  ...
  withPriority(priority: number): SensorHealthCategory;
   ...
   * The first value from the expression evaluation time series is used as a binding.
   */
  readonly metricBindings?: Map_Type<string, string>;
  withMetricBindings(metricBindings: Map_Type<string, string> | {[key: string]: string} | null): SensorHealthCategory;

  /**
   * Metric evaluation interval
   */
  readonly interval: string;
  withInterval(interval: string): SensorHealthCategory;

  /**
   * The horizon is used to determine the start of the metric evaluation.
   */
  readonly horizon: number;
  withHorizon(horizon: number): SensorHealthCategory;
   ...
   * @see #toJson
   */
  static fromJson(json: any): SensorHealthCategory | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): SensorHealthCategory | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): SensorHealthCategory | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): SensorHealthCategory | null;
   ...
   */
  replaceType(old: Type, new_: Type): SensorHealthCategory;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): SensorHealthCategory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): SensorHealthCategory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<SensorHealthCategory>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<SensorHealthCategory>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): SensorHealthCategory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SensorHealthCategory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SensorHealthCategory;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SensorHealthCategory;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SensorHealthCategory;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SensorHealthCategory;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): SensorHealthCategory;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SensorHealthCategory;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SensorHealthCategory;
   ...
   * @see #removeField
   */
  withoutField(field: string): SensorHealthCategory;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): SensorHealthCategory;
   ...
   */
  withoutFields(fields: Array_Type<string>): SensorHealthCategory;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): SensorHealthCategory;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SensorHealthCategory;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): SensorHealthCategory;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SensorHealthCategory;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SensorHealthCategory;
   ...
   * @see #removeField
   */
  unsetField(field: string): SensorHealthCategory;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SensorHealthCategory;
   ...
   * @see #unsetField
   */
  removeField(field: string): SensorHealthCategory;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SensorHealthCategory;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): SensorHealthCategory;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): SensorHealthCategory;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): SensorHealthCategory;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): SensorHealthCategory;

  mergeJson(json: any): SensorHealthCategory;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): SensorHealthCategory;
   ...
   */
  sumObj(other: Obj, deep?: boolean): SensorHealthCategory;
   ...
   */
  singletonArray(): Array_Type<SensorHealthCategory>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<SensorHealthCategory> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SensorHealthCategory> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<SensorHealthCategory>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SensorHealthCategory> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, SensorHealthCategory> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SensorHealthCategory> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SensorHealthCategory>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SensorHealthCategory>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): SensorHealthCategory;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): SensorHealthCategory;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): SensorHealthCategory;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SensorHealthCategory;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): SensorHealthCategory;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SensorHealthCategory;
   ...
   * @see #fromString
   */
  static make(s: string): SensorHealthCategory | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): SensorHealthCategory;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SensorHealthCategory;
   ...
   */
  static cachedEmptyInst(): SensorHealthCategory;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<SensorHealthCategory> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): SensorHealthCategory;
   ...
   */
  static allCached(): Stream<SensorHealthCategory> | null;
   ...
   */
  static find(filter?: string): Stream<SensorHealthCategory> | null;
   ...
   *         Otherwise no population will be performed.
   */
  static findBy(field: string, value: any): Stream<SensorHealthCategory> | null;

  /**
   * @return cached instance.
   */
  getCached(): SensorHealthCategory | null;

  /**
   * @return cached instance by the key.
   */
  static forCacheKey(key: string): SensorHealthCategory | null;
   ...
   */
  static produce(key: string): SensorHealthCategory | null;

  /**
   * Should produces the entire content for the cached data. Will populate the cache with the produced data.
   */
  static produceAll(): Map_Type<string, SensorHealthCategory> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<SensorHealthCategory>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SensorHealthCategory>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<SensorHealthCategory> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<SensorHealthCategory>> | null;
   ...
   */
  get(include?: string): SensorHealthCategory | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): SensorHealthCategory | null;
   ...
   */
  getMissing(spec: GetMissingSpec): SensorHealthCategory;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): SensorHealthCategory | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): SensorHealthCategory;
   ...
   * @see #toString
   */
  static fromString(s: string): SensorHealthCategory | null;
   ...
   */
  create(spec?: UpsertSpec): SensorHealthCategory | null;
   ...
   */
  static createBatch(objs: Array_Type<SensorHealthCategory>, spec?: UpsertSpec): ObjList<SensorHealthCategory> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<SensorHealthCategory>, spec?: CreateBatchObjStreamSpec): ObjList<SensorHealthCategory> | null;
   ...
   */
  update(srcObj?: SensorHealthCategory, spec?: UpsertSpec): SensorHealthCategory | null;
   ...
   */
  upsert(srcObj?: SensorHealthCategory, spec?: UpsertSpec): SensorHealthCategory | null;
   ...
   */
  merge(spec?: MergeSpec): SensorHealthCategory | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): SensorHealthCategory | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): SensorHealthCategory | null;
   ...
   */
  static updateBatch(objs: Array_Type<SensorHealthCategory>, srcObjs?: Array_Type<SensorHealthCategory>, spec?: UpsertSpec): ObjList<SensorHealthCategory> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<SensorHealthCategory> | null>, spec?: UpsertSpec): ObjList<SensorHealthCategory> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<SensorHealthCategory>, srcObjs?: Array_Type<SensorHealthCategory>, spec?: UpsertSpec): ObjList<SensorHealthCategory> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<SensorHealthCategory> | null>, spec?: UpsertSpec): ObjList<SensorHealthCategory> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<SensorHealthCategory>, spec?: TouchSpec): ObjList<SensorHealthCategory> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<SensorHealthCategory>, spec?: MergeSpec): ObjList<SensorHealthCategory> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<SensorHealthCategory>, mergeInclude: string, spec?: MergeSpec): ObjList<SensorHealthCategory> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<SensorHealthCategory> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<SensorHealthCategory> | null;
   ...
   */
  static mergeAll(mergeObj: SensorHealthCategory, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: SensorHealthCategory, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<SensorHealthCategory>, spec?: UpsertSpec): ObjList<SensorHealthCategory> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<SensorHealthCategory>, spec?: UpsertSpec): ObjList<SensorHealthCategory> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): SensorHealthCategory | null;
   ...
   */
  static beforeCreate(objs: Array_Type<SensorHealthCategory>): ObjList<SensorHealthCategory>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<SensorHealthCategory>): ObjList<SensorHealthCategory>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<SensorHealthCategory>): ObjList<SensorHealthCategory>;
   ...
   */
  static afterCreate(objs: Array_Type<SensorHealthCategory>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<SensorHealthCategory>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<SensorHealthCategory>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<SensorHealthCategory>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<SensorHealthCategory>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): SensorHealthCategory | null;
   ...
   */
  withoutIdentity(): SensorHealthCategory | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<SensorHealthCategory>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: SensorHealthCategory, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<SensorHealthCategory>, callback?: λFunction<SensorHealthCategory | null, SensorHealthCategory | null>): ObjList<SensorHealthCategory>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<SensorHealthCategory>, callback?: λFunction<SensorHealthCategory | null, SensorHealthCategory | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): SensorHealthCategory;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<SensorHealthCategory> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): SensorHealthCategory | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<SensorHealthCategory> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): SensorHealthCategory | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<SensorHealthCategory> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): SensorHealthCategory | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<SensorHealthCategory> | null;
  ...
  dependencies(): SeedDataDeps<SensorHealthCategory> | null;
  ...
  /**
   * Evaluate whether the alert category should be triggered
   * @param sensor
   *        The {@link Sensor} to evaluate the alert category on
   * @param start
   *        `start` of the metric evaluation. If null, `start` is calculated to be `end - period (horizon, interval)`
   * @param end
   *        `end` of the metric evaluation. If null, `end` is now
   * @param interval
   *        metric evaluation interval. If null, use {@link interval}
   * @return whether the condition of the alert is met.
   */
  evaluateAlert(sensor: Sensor, start?: DateTime, end?: DateTime, interval?: string): boolean;
}
