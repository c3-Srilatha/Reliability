// TypeScript definitions for the C3 type SensorHealthAlertStateTransition

/**
 * `SensorHealthAlertStateTransition` represents a state transition in a sensor health alert system.
 * It is part of a state machine that tracks the progression between different states of the sensor health alert.
 *
 * This entity type mixes with `StateMachineTransition` to inherit the necessary functionality for state transitions.
 *
 * @remarks this represents a value passed to a method that expects an instance of SensorHealthAlertStateTransition
 */
declare interface ISensorHealthAlertStateTransition {
   ...
   */
  from: ISensorHealthAlertState;

  /**
   * The {@link StateMachineState} to transition to.
   */
  to: ISensorHealthAlertState;
 ...
 * This entity type mixes with `StateMachineTransition` to inherit the necessary functionality for state transitions.
 *
 * @remarks this represents a made instance of SensorHealthAlertStateTransition
 */
declare class SensorHealthAlertStateTransition extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): SensorHealthAlertStateTransition;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): SensorHealthAlertStateTransition;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): SensorHealthAlertStateTransition;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): SensorHealthAlertStateTransition;
  ...
  withVersion(version: number | null): SensorHealthAlertStateTransition;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): SensorHealthAlertStateTransition;
  ...
  withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): SensorHealthAlertStateTransition;
  ...
  withHidden(hidden: boolean): SensorHealthAlertStateTransition;
  ...
  withUserOwned(userOwned: boolean): SensorHealthAlertStateTransition;

  /**
   * List of {@link AclEntry} entries governing who can read/update/remove Objs.
   */
  readonly acl?: Array_Type<AclEntry>;
  withAcl(acl: Array_Type<AclEntry> | Array<IAclEntry> | null): SensorHealthAlertStateTransition;

  /**
   * The {@link StateMachineState} to transition from.
   */
  readonly from: SensorHealthAlertState;
  withFrom(from: ISensorHealthAlertState): SensorHealthAlertStateTransition;

  /**
   * The {@link StateMachineState} to transition to.
   */
  readonly to: SensorHealthAlertState;
  withTo(to: ISensorHealthAlertState): SensorHealthAlertStateTransition;

  /**
   * Used to soft delete a record so all state histories still have valid pointers.
   */
  readonly deleted?: boolean;
  withDeleted(deleted: boolean): SensorHealthAlertStateTransition;

  /**
   * A transition is only valid if the {@link from}, {@link to}, and itself are not deleted.
   */
  readonly isValid?: boolean;
  withIsValid(isValid: boolean): SensorHealthAlertStateTransition;

  /**
   * The trigger that must be satisfied in order for this transition to take place.
   */
  readonly trigger?: TransitionTrigger;
  withTrigger(trigger: ITransitionTrigger | null): SensorHealthAlertStateTransition;
  ...
  withCondition(condition: string | null): SensorHealthAlertStateTransition;

  /**
   * Used to include fields on the source type for exitAction and entryAction.
   */
  readonly includeSpec?: string;
  withIncludeSpec(includeSpec: string | null): SensorHealthAlertStateTransition;

  /**
   * The action to be taken during this {@link StateMachineTransition}.
   */
  readonly action?: λConsumer<any | null>;
  withAction(action: λConsumer<any | null> | null): SensorHealthAlertStateTransition;
   ...
   * @see #toJson
   */
  static fromJson(json: any): SensorHealthAlertStateTransition | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): SensorHealthAlertStateTransition | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): SensorHealthAlertStateTransition | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): SensorHealthAlertStateTransition | null;
   ...
   */
  replaceType(old: Type, new_: Type): SensorHealthAlertStateTransition;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): SensorHealthAlertStateTransition;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): SensorHealthAlertStateTransition;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<SensorHealthAlertStateTransition>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<SensorHealthAlertStateTransition>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): SensorHealthAlertStateTransition;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SensorHealthAlertStateTransition;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SensorHealthAlertStateTransition;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SensorHealthAlertStateTransition;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SensorHealthAlertStateTransition;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SensorHealthAlertStateTransition;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): SensorHealthAlertStateTransition;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SensorHealthAlertStateTransition;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SensorHealthAlertStateTransition;
   ...
   * @see #removeField
   */
  withoutField(field: string): SensorHealthAlertStateTransition;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): SensorHealthAlertStateTransition;
   ...
   */
  withoutFields(fields: Array_Type<string>): SensorHealthAlertStateTransition;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): SensorHealthAlertStateTransition;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SensorHealthAlertStateTransition;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): SensorHealthAlertStateTransition;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SensorHealthAlertStateTransition;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SensorHealthAlertStateTransition;
   ...
   * @see #removeField
   */
  unsetField(field: string): SensorHealthAlertStateTransition;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SensorHealthAlertStateTransition;
   ...
   * @see #unsetField
   */
  removeField(field: string): SensorHealthAlertStateTransition;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SensorHealthAlertStateTransition;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): SensorHealthAlertStateTransition;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): SensorHealthAlertStateTransition;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): SensorHealthAlertStateTransition;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): SensorHealthAlertStateTransition;

  mergeJson(json: any): SensorHealthAlertStateTransition;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): SensorHealthAlertStateTransition;
   ...
   */
  sumObj(other: Obj, deep?: boolean): SensorHealthAlertStateTransition;
   ...
   */
  singletonArray(): Array_Type<SensorHealthAlertStateTransition>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<SensorHealthAlertStateTransition> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SensorHealthAlertStateTransition> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<SensorHealthAlertStateTransition>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SensorHealthAlertStateTransition> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, SensorHealthAlertStateTransition> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SensorHealthAlertStateTransition> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SensorHealthAlertStateTransition>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SensorHealthAlertStateTransition>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): SensorHealthAlertStateTransition;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): SensorHealthAlertStateTransition;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): SensorHealthAlertStateTransition;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SensorHealthAlertStateTransition;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): SensorHealthAlertStateTransition;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SensorHealthAlertStateTransition;
   ...
   * @see #fromString
   */
  static make(s: string): SensorHealthAlertStateTransition | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): SensorHealthAlertStateTransition;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SensorHealthAlertStateTransition;
   ...
   */
  static cachedEmptyInst(): SensorHealthAlertStateTransition;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<SensorHealthAlertStateTransition> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): SensorHealthAlertStateTransition;
   ...
   */
  static allCached(): Stream<SensorHealthAlertStateTransition> | null;
   ...
   */
  static find(filter?: string): Stream<SensorHealthAlertStateTransition> | null;
   ...
   *         Otherwise no population will be performed.
   */
  static findBy(field: string, value: any): Stream<SensorHealthAlertStateTransition> | null;

  /**
   * @return cached instance.
   */
  getCached(): SensorHealthAlertStateTransition | null;

  /**
   * @return cached instance by the key.
   */
  static forCacheKey(key: string): SensorHealthAlertStateTransition | null;
   ...
   */
  static produce(key: string): SensorHealthAlertStateTransition | null;

  /**
   * Should produces the entire content for the cached data. Will populate the cache with the produced data.
   */
  static produceAll(): Map_Type<string, SensorHealthAlertStateTransition> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<SensorHealthAlertStateTransition>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SensorHealthAlertStateTransition>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<SensorHealthAlertStateTransition> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<SensorHealthAlertStateTransition>> | null;
   ...
   */
  get(include?: string): SensorHealthAlertStateTransition | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): SensorHealthAlertStateTransition | null;
   ...
   */
  getMissing(spec: GetMissingSpec): SensorHealthAlertStateTransition;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): SensorHealthAlertStateTransition | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): SensorHealthAlertStateTransition;
   ...
   * @see #toString
   */
  static fromString(s: string): SensorHealthAlertStateTransition | null;
   ...
   */
  create(spec?: UpsertSpec): SensorHealthAlertStateTransition | null;
   ...
   */
  static createBatch(objs: Array_Type<SensorHealthAlertStateTransition>, spec?: UpsertSpec): ObjList<SensorHealthAlertStateTransition> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<SensorHealthAlertStateTransition>, spec?: CreateBatchObjStreamSpec): ObjList<SensorHealthAlertStateTransition> | null;
   ...
   */
  update(srcObj?: SensorHealthAlertStateTransition, spec?: UpsertSpec): SensorHealthAlertStateTransition | null;
   ...
   */
  upsert(srcObj?: SensorHealthAlertStateTransition, spec?: UpsertSpec): SensorHealthAlertStateTransition | null;
   ...
   */
  merge(spec?: MergeSpec): SensorHealthAlertStateTransition | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): SensorHealthAlertStateTransition | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): SensorHealthAlertStateTransition | null;
   ...
   */
  static updateBatch(objs: Array_Type<SensorHealthAlertStateTransition>, srcObjs?: Array_Type<SensorHealthAlertStateTransition>, spec?: UpsertSpec): ObjList<SensorHealthAlertStateTransition> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<SensorHealthAlertStateTransition> | null>, spec?: UpsertSpec): ObjList<SensorHealthAlertStateTransition> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<SensorHealthAlertStateTransition>, srcObjs?: Array_Type<SensorHealthAlertStateTransition>, spec?: UpsertSpec): ObjList<SensorHealthAlertStateTransition> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<SensorHealthAlertStateTransition> | null>, spec?: UpsertSpec): ObjList<SensorHealthAlertStateTransition> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<SensorHealthAlertStateTransition>, spec?: TouchSpec): ObjList<SensorHealthAlertStateTransition> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<SensorHealthAlertStateTransition>, spec?: MergeSpec): ObjList<SensorHealthAlertStateTransition> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<SensorHealthAlertStateTransition>, mergeInclude: string, spec?: MergeSpec): ObjList<SensorHealthAlertStateTransition> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<SensorHealthAlertStateTransition> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<SensorHealthAlertStateTransition> | null;
   ...
   */
  static mergeAll(mergeObj: SensorHealthAlertStateTransition, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: SensorHealthAlertStateTransition, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<SensorHealthAlertStateTransition>, spec?: UpsertSpec): ObjList<SensorHealthAlertStateTransition> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<SensorHealthAlertStateTransition>, spec?: UpsertSpec): ObjList<SensorHealthAlertStateTransition> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): SensorHealthAlertStateTransition | null;
   ...
   */
  static beforeCreate(objs: Array_Type<SensorHealthAlertStateTransition>): ObjList<SensorHealthAlertStateTransition>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<SensorHealthAlertStateTransition>): ObjList<SensorHealthAlertStateTransition>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<SensorHealthAlertStateTransition>): ObjList<SensorHealthAlertStateTransition>;
   ...
   */
  static afterCreate(objs: Array_Type<SensorHealthAlertStateTransition>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<SensorHealthAlertStateTransition>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<SensorHealthAlertStateTransition>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<SensorHealthAlertStateTransition>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<SensorHealthAlertStateTransition>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): SensorHealthAlertStateTransition | null;
   ...
   */
  withoutIdentity(): SensorHealthAlertStateTransition | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<SensorHealthAlertStateTransition>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: SensorHealthAlertStateTransition, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<SensorHealthAlertStateTransition>, callback?: λFunction<SensorHealthAlertStateTransition | null, SensorHealthAlertStateTransition | null>): ObjList<SensorHealthAlertStateTransition>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<SensorHealthAlertStateTransition>, callback?: λFunction<SensorHealthAlertStateTransition | null, SensorHealthAlertStateTransition | null>): Array_Type<ObjError> | null;
   ...
   */
  publish(subPath?: string, contentType?: string): SensorHealthAlertStateTransition;
   ...
   */
  static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<SensorHealthAlertStateTransition> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec): SensorHealthAlertStateTransition | null;
   ...
   */
  static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<SensorHealthAlertStateTransition> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): SensorHealthAlertStateTransition | null;
   ...
   */
  static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<SensorHealthAlertStateTransition> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec): SensorHealthAlertStateTransition | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<SensorHealthAlertStateTransition> | null;
  ...
  dependencies(): SeedDataDeps<SensorHealthAlertStateTransition> | null;
   ...
   */
  static populateAcl(objs?: Array_Type<SensorHealthAlertStateTransition>): number | null;
   ...
   */
  grantMemberReadUpdateRemove(member: AccessControlEntity): SensorHealthAlertStateTransition;
   ...
   */
  mergeAclEntry(entry: AclEntry): SensorHealthAlertStateTransition;
   ...
   * @return the obj with the new acl after merging the indicated entry.
   */
  mergeAclEntries(entries: Array_Type<AclEntry>): SensorHealthAlertStateTransition;
