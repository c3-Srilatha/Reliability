...
# Python definitions for the C3 type UiSdlUseDataStatus


class UiSdlUseDataStatus():
    """
    ...
    """
    def __init__(self, INITIAL: Optional[str]=None, LOADING: Optional[str]=None, SUCCESS: Optional[str]=None, ERROR: Optional[str]=None) -> None: ...
