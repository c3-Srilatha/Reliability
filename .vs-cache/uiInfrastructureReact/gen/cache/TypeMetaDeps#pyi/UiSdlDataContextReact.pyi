...
from c3.uiInfrastructure.UiSdlDataTypeUpdateAction import UiSdlDataTypeUpdateAction
...
from c3.uiInfrastructure.UiSdlCancelDataRequestAction import UiSdlCancelDataRequestAction
...
from c3.platform.SetBuilder import SetBuilder
from c3.uiInfrastructure.UiSdlDataRequestAction import UiSdlDataRequestAction
from c3.uiInfrastructure.UiSdlErrorReceiveAction import UiSdlErrorReceiveAction
from c3.uiInfrastructure.UiSdlIdCreateAction import UiSdlIdCreateAction
...
from c3.uiInfrastructure.UiSdlDataSetAction import UiSdlDataSetAction
from c3.uiInfrastructure.UiSdlDataTransform.Context import UiSdlDataTransform.Context
from c3.uiInfrastructure.UiSdlDataLoadedAction import UiSdlDataLoadedAction
from c3.platform.MapBuilder import MapBuilder
from c3.platform.ReferenceType import ReferenceType
from c3.uiInfrastructure.UiSdlChangeCancelAction import UiSdlChangeCancelAction
...
from c3.uiInfrastructure.UiSdlDataReceiveAction import UiSdlDataReceiveAction
from c3.platform.Stream import Stream
from c3.platform.ValidateObjResult import ValidateObjResult
from c3.uiInfrastructure.UiSdlDataAddAction import UiSdlDataAddAction
from c3.platform.Promise import Promise
from c3.uiInfrastructure.UiSdlDataModifyAction import UiSdlDataModifyAction
...
from c3.uiInfrastructure.UiSdlArgumentsMergeAction import UiSdlArgumentsMergeAction
from c3.uiInfrastructure.UiSdlPersistChangeErrorUpdateAction import UiSdlPersistChangeErrorUpdateAction
from c3.uiInfrastructure.UiSdlDataConfigUpdateAction import UiSdlDataConfigUpdateAction
from c3.uiInfrastructure.UiSdlDataDeleteAction import UiSdlDataDeleteAction
from c3.uiInfrastructure.UiSdlUpdateDataCountAction import UiSdlUpdateDataCountAction
...
# Python definitions for the C3 type UiSdlDataContextReact


class UiSdlDataContextReact(ReactFunction, UiSdlDataContext):
    """
    React implementation of {@link UiSdlDataContext}.
    
    @remarks this represents a made instance of UiSdlDataContextReact
    """
    ...
    REDUX_METADATA_NAMESPACE: Optional[str]=None
    """
    ...
    c3arguments: Optional[any]=None
    """
    The arguments to be provided with the data request.
    """

    additionalFilters: Optional[Map[str, str]]=None
    """
    ...
    edits: Optional[Map[str, Array[str]]]=None
    """
    The changes that are made to the data source. This key is `id`; value is an array of fields modified .
    """

    deletions: Optional[Array[str]]=None
    """
    The deleted record ids
    """

    additions: Optional[Array[str]]=None
    """
    Newly added record
    """

    persistChangeErrors: Optional[Array[str]]=None
    """
    ...
    """
    def __init__(self, meta: Optional[Meta]=None, id: Optional[str]=None, name: Optional[str]=None, dataSpec: Optional[UiSdlNoData]=None, disableDataRequestOnFirstRender: Optional[bool]=None, triggersRegistered: Optional[bool]=None, wrapWithMetadataId: Optional[bool]=None, REDUX_METADATA_NAMESPACE: Optional[str]=None, effectTriggers: Optional[Array[UiSdlEffectTrigger]]=None, contextVars: Optional[Map[str, UiSdlDynamicValueSpecParam]]=None, sendRequestWithFalsyContextVars: Optional[bool]=None, dataTransforms: Optional[Array[str]]=None, tunnelConfiguration: Optional[UiSdlTunnelConfiguration]=None, c3arguments: Optional[any]=None, additionalFilters: Optional[Map[str, str]]=None, edits: Optional[Map[str, Array[str]]]=None, deletions: Optional[Array[str]]=None, additions: Optional[Array[str]]=None, persistChangeErrors: Optional[Array[str]]=None, children: Optional[Array[UiSdlComponentRef[UiSdlComponent[UiSdlNoData]]]]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[UiSdlDataContextReact]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[UiSdlDataContextReact]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[UiSdlDataContextReact]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[UiSdlDataContextReact]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> UiSdlDataContextReact:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> UiSdlDataContextReact:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> UiSdlDataContextReact:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[UiSdlDataContextReact]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[UiSdlDataContextReact]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> UiSdlDataContextReact:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> UiSdlDataContextReact:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> UiSdlDataContextReact:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> UiSdlDataContextReact:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> UiSdlDataContextReact:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> UiSdlDataContextReact:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> UiSdlDataContextReact:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> UiSdlDataContextReact:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> UiSdlDataContextReact:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> UiSdlDataContextReact:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> UiSdlDataContextReact:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> UiSdlDataContextReact:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> UiSdlDataContextReact:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> UiSdlDataContextReact:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> UiSdlDataContextReact:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> UiSdlDataContextReact:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> UiSdlDataContextReact:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> UiSdlDataContextReact:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> UiSdlDataContextReact:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> UiSdlDataContextReact:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> UiSdlDataContextReact:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> UiSdlDataContextReact:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> UiSdlDataContextReact:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> UiSdlDataContextReact:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> UiSdlDataContextReact:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> UiSdlDataContextReact:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> UiSdlDataContextReact:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> UiSdlDataContextReact:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[UiSdlDataContextReact]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[UiSdlDataContextReact]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[UiSdlDataContextReact]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[UiSdlDataContextReact]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[UiSdlDataContextReact]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, UiSdlDataContextReact]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, UiSdlDataContextReact]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[UiSdlDataContextReact]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[UiSdlDataContextReact]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> UiSdlDataContextReact:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> UiSdlDataContextReact:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> UiSdlDataContextReact:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> UiSdlDataContextReact:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> UiSdlDataContextReact:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> UiSdlDataContextReact:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[UiSdlDataContextReact]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> UiSdlDataContextReact:
    """
    ...
    """
        ...
    def afterMake(self) -> UiSdlDataContextReact:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> UiSdlDataContextReact:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[UiSdlDataContextReact]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> UiSdlDataContextReact:
    """
    ...
    """
        ...
    @classmethod
    def render(cls, props: UiSdlDataContextReact=None) -> None:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[UiSdlDataContextReact]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[UiSdlDataContextReact]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[UiSdlDataContextReact]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[UiSdlDataContextReact]]]:
    """
    ...
    """
        ...
    def dependencies(self) -> MetadataDeps[UiSdlDataContextReact]:
    """
    Retrieves dependencies to types or other metadata elements for the given instance of metadata.
    """
        ...
    def save(self, subPath: str=None, contentType: str=None) -> UiSdlDataContextReact:
        ...
    ...
    def removeAll(cls, removeFilter: str=None) -> int:
        ...
    def update(self, srcObj: UiSdlDataContextReact=None, spec: UpsertSpec=None) -> Union[UiSdlDataContextReact]:
        ...
    def upsert(self, srcObj: UiSdlDataContextReact=None, spec: UpsertSpec=None) -> Union[UiSdlDataContextReact]:
        ...
    @classmethod
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[UiSdlDataContextReact]:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[UiSdlDataContextReact]:
    """
    ...
    def jsonify(cls, value: Any=None) -> Union[str]:
        ...
    @classmethod
    def doDataMerge(cls, componentId: str, dataSpecFieldName: str, dataDestinationFieldName: str, props: UiSdlDataContextReact, state: UiSdlReduxState) -> Union[UiSdlDataContextReact]:
    """
    ...
    """
        ...
    @classmethod
    def updatePersistChangeErrorAction(cls, id: str=None, errors: Array[str]=None) -> Union[UiSdlPersistChangeErrorUpdateAction]:
    """
    ...
    """
        ...
    @classmethod
    def mergeArgumentsAction(cls, id: str, args: Map[str, Any], sourceMetadataId: str=None) -> UiSdlArgumentsMergeAction:
    """
    ...
    """
        ...
    def updateDataTypeAction(self, newType: str, id: str=None) -> UiSdlDataTypeUpdateAction:
    """
    ...
    """
        ...
    def updateDataConfigAction(self, newConfig: Map[str, Any], id: str=None, contextVars: Map[str, Any]=None, metadataId: str=None) -> UiSdlDataConfigUpdateAction:
    """
    ...
    """
        ...
    @classmethod
    def updateCountDataAction(cls, id: str=None) -> Union[UiSdlUpdateDataCountAction]:
    """
    ...
    """
        ...
    def requestDataAction(self, id: str=None, actionTransforms: Array[str]=None, mode: str=None, args: any=None, dataSourceComponentId: str=None) -> UiSdlDataRequestAction:
    """
    ...
    """
        ...
    def cancelRequestDataAction(self, id: str=None) -> UiSdlCancelDataRequestAction:
    """
    ...
    """
        ...
    @classmethod
    def receiveDataAction(cls, id: str=None, response: Any=None, isError: bool=None, dataSourceComponentId: str=None) -> UiSdlDataReceiveAction:
    """
    ...
    """
        ...
    @classmethod
    def receiveErrorAction(cls, id: str=None, errorMessage: str=None) -> UiSdlErrorReceiveAction:
    """
    ...
    """
        ...
    @classmethod
    def setDataAction(cls, id: str=None, originalData: Any=None, modifiedData: Any=None) -> UiSdlDataSetAction:
    """
    ...
    """
        ...
    @classmethod
    def loadedDataAction(cls, id: str=None, response: Any=None, isError: bool=None) -> UiSdlDataLoadedAction:
    """
    ...
    """
        ...
    def handleLoadedDataAction(self, id: str=None) -> Union[UiSdlLoadedDataHandleAction]:
    """
    ...
    """
        ...
    def saveDataAction(self, id: str=None, dataSourceComponentId: str=None) -> UiSdlDataSaveAction:
    """
    ...
    """
        ...
    def deleteDataAction(self, ids: Array[str], id: str=None) -> UiSdlDataDeleteAction:
    """
    ...
    """
        ...
    @classmethod
    def addDataAction(cls, id: str=None, itemId: str=None, isError: bool=None, insertLocation: str=None) -> UiSdlDataAddAction:
    """
    ...
    """
        ...
    def createUniqueIdAction(self, id: str=None) -> UiSdlIdCreateAction:
    """
    ...
    """
        ...
    @classmethod
    def modifyDataAction(cls, fieldName: str, newValue: str, id: str=None, itemId: str=None) -> UiSdlDataModifyAction:
    """
    ...
    """
        ...
    def cancelChangeAction(self, id: str=None, loadOriginalData: bool=None) -> UiSdlChangeCancelAction:
    """
    ...
    """
        ...
    def mapStateToData(self, state: UiSdlReduxState, id: str=None) -> UiSdlReduxState:
    """
    ...
    """
        ...
    def mapStateToOriginalData(self, id: str, state: UiSdlReduxState) -> UiSdlReduxState:
    """
    ...
    """
        ...
    def mapStateToMetadata(self, id: str, state: UiSdlReduxState) -> UiSdlReduxState:
    """
    ...
    """
        ...
    def mapStateToDataAdditions(self, state: UiSdlReduxState) -> Union[Any]:
    """
    ...
    """
        ...
    def dataSetEffect(self, state: UiSdlReduxState, action: UiSdlDataSetAction) -> UiSdlReduxState:
    """
    Sets data in the state.  Depending on the action sets it in modified or original slice of redux state
    """
        ...
    def persistChangeErrorUpdateEffect(self, state: UiSdlReduxState, action: UiSdlPersistChangeErrorUpdateAction) -> UiSdlReduxState:
    """
    Set new error message to state
    """
        ...
    @classmethod
    def loadedDataHandleReducer(cls, state: UiSdlReduxState=None, action: UiSdlLoadedDataHandleAction=None) -> Union[UiSdlReduxState]:
    """
    ...
    """
        ...
    def dataReceiveEffect(self, state: UiSdlReduxState, action: UiSdlDataReceiveAction) -> UiSdlReduxState:
    """
    Sets the received data into the data source state
    """
        ...
    def errorReceiveEffect(self, state: UiSdlReduxState, action: UiSdlErrorReceiveAction) -> UiSdlReduxState:
    """
    Sets the received error into the data source state
    """
        ...
    def argumentsMergeEffect(self, state: UiSdlReduxState, action: UiSdlArgumentsMergeAction) -> UiSdlReduxState:
    """
    Deeply merges the passed arguments.
    """
        ...
    def dataTypeUpdateEffect(self, state: UiSdlReduxState, action: UiSdlDataTypeUpdateAction) -> UiSdlReduxState:
    """
    Update dataSource data type.
    """
        ...
    def dataConfigUpdateEffect(self, state: UiSdlReduxState, action: UiSdlDataConfigUpdateAction) -> UiSdlReduxState:
    """
    Update dataSource data config.
    """
        ...
    def dataDeleteReducer(self, state: UiSdlReduxState, action: UiSdlDataDeleteAction) -> UiSdlReduxState:
    """
    ...
    """
        ...
    def dataAddEffect(self, state: UiSdlReduxState, action: UiSdlDataAddAction) -> UiSdlReduxState:
    """
    ...
    """
        ...
    def dataModifyEffect(self, state: UiSdlReduxState, action: UiSdlDataModifyAction) -> UiSdlReduxState:
    """
    ...
    """
        ...
    def changeCancelEffect(self, state: UiSdlReduxState, action: UiSdlChangeCancelAction) -> UiSdlReduxState:
    """
    ...
    """
        ...
    def tunneledAjax(self, state: UiSdlReduxState, siteId: str=None, typeName: str=None, actionName: str=None, actionArguments: Map[str, Any]=None, timeoutSecs: int=None, tunnelConfiguration: UiSdlTunnelConfiguration=None) -> UiSdlObservable:
    """
    ...
    """
        ...
    @classmethod
    def ajax(cls, typeName: str=None, actionName: str=None, actionArguments: Map[str, Any]=None, tunnelConfiguration: UiSdlTunnelConfiguration=None) -> UiSdlObservable:
    """
    Returns an RxJS ajax observable for a particular server side API.
    ...
    """
        ...
    def dataReceiveEpic(self, actionStream: UiSdlActionsObservable, stateStream: UiSdlStatesObservable) -> UiSdlActionsObservable:
    """
