// TypeScript definitions for the C3 type UiSdlApplicationStateTestType

/**
 * Test type created for testing the application state rendering during dynamic
 * component rendering flow.
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlApplicationStateTestType
 */
declare interface IUiSdlApplicationStateTestType {
 ...
 * component rendering flow.
 *
 * @remarks this represents a made instance of UiSdlApplicationStateTestType
 */
declare class UiSdlApplicationStateTestType extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlApplicationStateTestType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlApplicationStateTestType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlApplicationStateTestType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlApplicationStateTestType | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlApplicationStateTestType;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlApplicationStateTestType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlApplicationStateTestType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlApplicationStateTestType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlApplicationStateTestType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlApplicationStateTestType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlApplicationStateTestType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlApplicationStateTestType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlApplicationStateTestType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlApplicationStateTestType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlApplicationStateTestType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlApplicationStateTestType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlApplicationStateTestType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlApplicationStateTestType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlApplicationStateTestType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlApplicationStateTestType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlApplicationStateTestType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlApplicationStateTestType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlApplicationStateTestType;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlApplicationStateTestType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlApplicationStateTestType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlApplicationStateTestType;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlApplicationStateTestType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlApplicationStateTestType;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlApplicationStateTestType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlApplicationStateTestType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlApplicationStateTestType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlApplicationStateTestType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlApplicationStateTestType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlApplicationStateTestType;

  mergeJson(json: any | null): UiSdlApplicationStateTestType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlApplicationStateTestType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlApplicationStateTestType;
   ...
   */
  singletonArray(): C3.Array<UiSdlApplicationStateTestType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlApplicationStateTestType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlApplicationStateTestType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlApplicationStateTestType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlApplicationStateTestType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlApplicationStateTestType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlApplicationStateTestType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlApplicationStateTestType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlApplicationStateTestType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlApplicationStateTestType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlApplicationStateTestType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlApplicationStateTestType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlApplicationStateTestType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlApplicationStateTestType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlApplicationStateTestType;
   ...
   * @see #fromString
   */
  static make(s: string | null): UiSdlApplicationStateTestType | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlApplicationStateTestType;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlApplicationStateTestType;
   ...
   */
  static cachedEmptyInst(): UiSdlApplicationStateTestType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlApplicationStateTestType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlApplicationStateTestType;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<UiSdlApplicationStateTestType | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<UiSdlApplicationStateTestType | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<UiSdlApplicationStateTestType | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<UiSdlApplicationStateTestType | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<UiSdlApplicationStateTestType | null>;

  save(subPath?: string | null, contentType?: string | null): UiSdlApplicationStateTestType;
  ...
  update(srcObj?: UiSdlApplicationStateTestType | null, spec?: UpsertSpec | null): UiSdlApplicationStateTestType | null;

  upsert(srcObj?: UiSdlApplicationStateTestType | null, spec?: UpsertSpec | null): UiSdlApplicationStateTestType | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): UiSdlApplicationStateTestType | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): UiSdlApplicationStateTestType | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: UiSdlApplicationStateTestType, state: UiSdlReduxState): UiSdlApplicationStateTestType | null;
