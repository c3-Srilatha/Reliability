// TypeScript definitions for the C3 type UiSdlSpecHelper

/**
 * @remarks this represents a value passed to a method that expects an instance of UiSdlSpecHelper
 */
declare interface IUiSdlSpecHelper {
}

/**
 * @remarks this represents a made instance of UiSdlSpecHelper
 */
declare class UiSdlSpecHelper extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlSpecHelper | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlSpecHelper | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlSpecHelper | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlSpecHelper | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlSpecHelper;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlSpecHelper;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlSpecHelper;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlSpecHelper | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlSpecHelper | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlSpecHelper;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlSpecHelper;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlSpecHelper;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlSpecHelper;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlSpecHelper;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlSpecHelper;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlSpecHelper;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlSpecHelper;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlSpecHelper;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlSpecHelper;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlSpecHelper;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlSpecHelper;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlSpecHelper;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlSpecHelper;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlSpecHelper;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlSpecHelper;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlSpecHelper;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlSpecHelper;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlSpecHelper;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlSpecHelper;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlSpecHelper;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlSpecHelper;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlSpecHelper;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlSpecHelper;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlSpecHelper;

  mergeJson(json: any | null): UiSdlSpecHelper;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlSpecHelper;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlSpecHelper;
   ...
   */
  singletonArray(): C3.Array<UiSdlSpecHelper | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlSpecHelper | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlSpecHelper | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlSpecHelper | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlSpecHelper | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlSpecHelper | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlSpecHelper | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlSpecHelper | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlSpecHelper | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlSpecHelper;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlSpecHelper;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlSpecHelper;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlSpecHelper;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlSpecHelper;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlSpecHelper;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlSpecHelper;
   ...
   */
  static cachedEmptyInst(): UiSdlSpecHelper;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlSpecHelper>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlSpecHelper;
