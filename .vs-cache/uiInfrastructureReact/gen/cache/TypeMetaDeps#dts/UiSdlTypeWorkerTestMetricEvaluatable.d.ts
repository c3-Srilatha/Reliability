// TypeScript definitions for the C3 type UiSdlTypeWorkerTestMetricEvaluatable

/**
 * Type used for testing the logic of {@link UiSdlTypeWorker#getMetricList getMetricList}
 *
 * @remarks this represents a value passed to a method that expects an instance of UiSdlTypeWorkerTestMetricEvaluatable
 */
declare interface IUiSdlTypeWorkerTestMetricEvaluatable {

  /**
   * Reference field for metric path
   */
  referenceField?: IUiSdlTypeWorkerTestMeasurementType | null;
}
 ...
 */
declare class UiSdlTypeWorkerTestMetricEvaluatable extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UiSdlTypeWorkerTestMetricEvaluatable | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UiSdlTypeWorkerTestMetricEvaluatable | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UiSdlTypeWorkerTestMetricEvaluatable | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UiSdlTypeWorkerTestMetricEvaluatable | null;
   ...
   */
  replaceType(old: Type, new_: Type): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlTypeWorkerTestMetricEvaluatable | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UiSdlTypeWorkerTestMetricEvaluatable | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UiSdlTypeWorkerTestMetricEvaluatable;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UiSdlTypeWorkerTestMetricEvaluatable;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   * @see #removeField
   */
  unsetField(field: string): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   * @see #unsetField
   */
  removeField(field: string): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UiSdlTypeWorkerTestMetricEvaluatable;

  mergeJson(json: any | null): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   */
  singletonArray(): C3.Array<UiSdlTypeWorkerTestMetricEvaluatable | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UiSdlTypeWorkerTestMetricEvaluatable | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UiSdlTypeWorkerTestMetricEvaluatable | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UiSdlTypeWorkerTestMetricEvaluatable | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UiSdlTypeWorkerTestMetricEvaluatable | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UiSdlTypeWorkerTestMetricEvaluatable | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UiSdlTypeWorkerTestMetricEvaluatable | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UiSdlTypeWorkerTestMetricEvaluatable | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UiSdlTypeWorkerTestMetricEvaluatable | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UiSdlTypeWorkerTestMetricEvaluatable;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UiSdlTypeWorkerTestMetricEvaluatable;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): UiSdlTypeWorkerTestMetricEvaluatable;
   ...
   */
  static cachedEmptyInst(): UiSdlTypeWorkerTestMetricEvaluatable;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UiSdlTypeWorkerTestMetricEvaluatable>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UiSdlTypeWorkerTestMetricEvaluatable;
