...
class DataValidationRunConfiguration(Config, Singleton):
    ...
    """
    def __init__(self, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, subjectArgKey: Optional[str]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def allCached(cls) -> Union[Stream[DataValidationRunConfiguration]]:
    """
    @return stream of all available Cached instances.
    """
        ...
    @classmethod
    def find(cls, filter: str=None) -> Union[Stream[DataValidationRunConfiguration]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any) -> Union[Stream[DataValidationRunConfiguration]]:
    """
    @return existing instances of this type that satisfy filter from data cache. Will call `produceAll`
            if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
            Otherwise no population will be performed.
