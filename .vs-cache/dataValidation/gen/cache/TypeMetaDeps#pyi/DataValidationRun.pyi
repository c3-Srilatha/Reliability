...
from c3.dataValidation.DataValidationPersistedRulesetResult import DataValidationPersistedRulesetResult
...
from c3.dataValidation.DataValidationPersistedResult import DataValidationPersistedResult
from c3.dataValidation.DataValidationSubject import DataValidationSubject
from c3.platform.Stream import Stream
from c3.platform.RunCreatedOrUpdatedBatchJob import RunCreatedOrUpdatedBatchJob
from c3.dataValidation.DataValidationStatus import DataValidationStatus
...
from c3.platform.Promise import Promise
from c3.dataValidation.DataValidationRulesetResult import DataValidationRulesetResult
...
# Python definitions for the C3 type DataValidationRun


class DataValidationRun():
    """
    ...
    @remarks this represents a made instance of DataValidationRun
    """
    ...
    rootRuleset: Optional[DataValidationRuleset]
    """
    The root ruleset whose rules and all descendant rules were run.
    """

    subject: Optional[DataValidationSubject]=None
    """
    ...
    results: Optional[Array[DataValidationResult]]=None
    """
    ...
    persistedResults: Optional[Array[DataValidationPersistedResult]]=None
    """
    The results found by this run that are persisted.
    Please use {DataValidationRun#getResults} to get the results from a run.
    """

    rulesetResults: Optional[Array[DataValidationRulesetResult]]=None
    """
    ...
    persistedRulesetResults: Optional[Array[DataValidationPersistedRulesetResult]]=None
    """
    The ruleset results found by this run that are persisted.
    Please use {DataValidationRun#getRulesetResults} to get the results from a run.
    """

    numViolations: Optional[int]=None
    """
    Number of data violations found by this run.
    """

    job: Optional[Union[DataValidationMapReduceJob,DataValidationBatchJob]]=None
    """
    ...
    validationStatus: Optional[DataValidationStatus]=None
    """
    The status of the {@link DataValidationRuleset} rules ouput.
    """
    def __init__(self, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, timestamp: Optional[datetime]=None, rootRuleset: Optional[DataValidationRuleset]=None, subject: Optional[DataValidationSubject]=None, args: Optional[Map[str, Any]]=None, results: Optional[Array[DataValidationResult]]=None, persistedResults: Optional[Array[DataValidationPersistedResult]]=None, rulesetResults: Optional[Array[DataValidationRulesetResult]]=None, persistedRulesetResults: Optional[Array[DataValidationPersistedRulesetResult]]=None, numViolations: Optional[int]=None, job: Optional[Union[DataValidationMapReduceJob,DataValidationBatchJob]]=None, jobId: Optional[str]=None, jobError: Optional[str]=None, runStatus: Optional[str]=None, validationStatus: Optional[DataValidationStatus]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[DataValidationRun]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[DataValidationRun]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[DataValidationRun]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[DataValidationRun]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> DataValidationRun:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataValidationRun:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataValidationRun:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataValidationRun]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataValidationRun]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> DataValidationRun:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataValidationRun:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataValidationRun:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> DataValidationRun:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> DataValidationRun:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> DataValidationRun:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> DataValidationRun:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> DataValidationRun:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> DataValidationRun:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> DataValidationRun:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> DataValidationRun:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> DataValidationRun:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> DataValidationRun:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> DataValidationRun:
    """
    @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> DataValidationRun:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> DataValidationRun:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> DataValidationRun:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> DataValidationRun:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> DataValidationRun:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> DataValidationRun:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> DataValidationRun:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> DataValidationRun:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> DataValidationRun:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> DataValidationRun:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> DataValidationRun:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> DataValidationRun:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> DataValidationRun:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> DataValidationRun:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[DataValidationRun]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[DataValidationRun]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[DataValidationRun]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[DataValidationRun]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[DataValidationRun]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, DataValidationRun]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, DataValidationRun]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[DataValidationRun]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[DataValidationRun]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> DataValidationRun:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> DataValidationRun:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> DataValidationRun:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> DataValidationRun:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> DataValidationRun:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> DataValidationRun:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[DataValidationRun]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> DataValidationRun:
    """
    ...
    """
        ...
    def afterMake(self) -> DataValidationRun:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> DataValidationRun:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[DataValidationRun]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> DataValidationRun:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[DataValidationRun]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[DataValidationRun]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[DataValidationRun]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[DataValidationRun]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[DataValidationRun]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[DataValidationRun]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> DataValidationRun:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[DataValidationRun]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> DataValidationRun:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[DataValidationRun]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[DataValidationRun]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[DataValidationRun], spec: UpsertSpec=None) -> Union[ObjList[DataValidationRun]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[DataValidationRun], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[DataValidationRun]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: DataValidationRun=None, spec: UpsertSpec=None) -> Union[DataValidationRun]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: DataValidationRun=None, spec: UpsertSpec=None) -> Union[DataValidationRun]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[DataValidationRun]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[DataValidationRun]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[DataValidationRun]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[DataValidationRun], srcObjs: Array[DataValidationRun]=None, spec: UpsertSpec=None) -> Union[ObjList[DataValidationRun]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[DataValidationRun]]], spec: UpsertSpec=None) -> Union[ObjList[DataValidationRun]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[DataValidationRun], srcObjs: Array[DataValidationRun]=None, spec: UpsertSpec=None) -> Union[ObjList[DataValidationRun]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[DataValidationRun]]], spec: UpsertSpec=None) -> Union[ObjList[DataValidationRun]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[DataValidationRun], spec: TouchSpec=None) -> Union[ObjList[DataValidationRun]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[DataValidationRun], spec: MergeSpec=None) -> Union[ObjList[DataValidationRun]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[DataValidationRun], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[DataValidationRun]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[DataValidationRun]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[DataValidationRun]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: DataValidationRun, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: DataValidationRun, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[DataValidationRun], spec: UpsertSpec=None) -> Union[ObjList[DataValidationRun]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[DataValidationRun], spec: UpsertSpec=None) -> Union[ObjList[DataValidationRun]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[DataValidationRun]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[DataValidationRun]) -> ObjList[DataValidationRun]:
    """
    @inheritdoc
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[DataValidationRun]) -> ObjList[DataValidationRun]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[DataValidationRun]) -> ObjList[DataValidationRun]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[DataValidationRun]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[DataValidationRun]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[DataValidationRun]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[DataValidationRun]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[DataValidationRun]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[DataValidationRun]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[DataValidationRun]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[DataValidationRun]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: DataValidationRun=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[DataValidationRun], callback: Callable[[Union[DataValidationRun]], Union[DataValidationRun]]=None) -> ObjList[DataValidationRun]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[DataValidationRun], callback: Callable[[Union[DataValidationRun]], Union[DataValidationRun]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    def getResults(self, include: str=None) -> Union[Array[DataValidationResult]]:
    """
    ...
    """
        ...
    def getRulesetResults(self, include: str=None) -> Union[Array[DataValidationRulesetResult]]:
    """
    ...
    """
        ...
    def setRunStatus(self, status: str, errorMessage: str=None) -> None:
    """
    A function to set the {@link DataValidationRun#runStatus} of the run.
    """
        ...
    def generateResult(self, persistResults: bool=None) -> None:
    """
    ...
    """
        ...
    def updateRulesetResult(self, ruleset: DataValidationRuleset, persistResults: bool=None) -> None:
    """
