...
declare class DataValidationRunConfiguration extends Obj  {
   ...
   */
  static allCached(): Stream<DataValidationRunConfiguration> | null;
   ...
   */
  static find(filter?: string): Stream<DataValidationRunConfiguration> | null;
   ...
   *         Otherwise no population will be performed.
   */
  static findBy(field: string, value: any): Stream<DataValidationRunConfiguration> | null;
