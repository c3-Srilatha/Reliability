// TypeScript definitions for the C3 type DataValidationRulesetHierarchicalRelation

/**
 * Relation type containing fields to explain the relationship between {@link DataValidationRuleset}s
 *
 * @remarks this represents a value passed to a method that expects an instance of DataValidationRulesetHierarchicalRelation
 */
declare interface IDataValidationRulesetHierarchicalRelation {
  ...
  /**
   * The {@link DataValidationRuleset} this relation comes from. This is the parent ruleset.
   */
  from: IDataValidationRuleset;

  /**
   * The {@link DataValidationRuleset} this relation connects to. This is the child ruleset.
   */
  to: IDataValidationRuleset;
}

/**
 * Relation type containing fields to explain the relationship between {@link DataValidationRuleset}s
 *
 * @remarks this represents a made instance of DataValidationRulesetHierarchicalRelation
 */
declare class DataValidationRulesetHierarchicalRelation extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): DataValidationRulesetHierarchicalRelation;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): DataValidationRulesetHierarchicalRelation;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): DataValidationRulesetHierarchicalRelation;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): DataValidationRulesetHierarchicalRelation;
  ...
  withVersion(version: number | null): DataValidationRulesetHierarchicalRelation;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): DataValidationRulesetHierarchicalRelation;

  /**
   * The {@link DataValidationRuleset} this relation comes from. This is the parent ruleset.
   */
  readonly from: DataValidationRuleset;
  withFrom(from: IDataValidationRuleset): DataValidationRulesetHierarchicalRelation;

  /**
   * The {@link DataValidationRuleset} this relation connects to. This is the child ruleset.
   */
  readonly to: DataValidationRuleset;
  withTo(to: IDataValidationRuleset): DataValidationRulesetHierarchicalRelation;
   ...
   * @see #toJson
   */
  static fromJson(json: any): DataValidationRulesetHierarchicalRelation | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): DataValidationRulesetHierarchicalRelation | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): DataValidationRulesetHierarchicalRelation | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): DataValidationRulesetHierarchicalRelation | null;
   ...
   */
  replaceType(old: Type, new_: Type): DataValidationRulesetHierarchicalRelation;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DataValidationRulesetHierarchicalRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DataValidationRulesetHierarchicalRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<DataValidationRulesetHierarchicalRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<DataValidationRulesetHierarchicalRelation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): DataValidationRulesetHierarchicalRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataValidationRulesetHierarchicalRelation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataValidationRulesetHierarchicalRelation;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DataValidationRulesetHierarchicalRelation;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DataValidationRulesetHierarchicalRelation;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DataValidationRulesetHierarchicalRelation;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): DataValidationRulesetHierarchicalRelation;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataValidationRulesetHierarchicalRelation;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DataValidationRulesetHierarchicalRelation;
   ...
   * @see #removeField
   */
  withoutField(field: string): DataValidationRulesetHierarchicalRelation;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): DataValidationRulesetHierarchicalRelation;
   ...
   */
  withoutFields(fields: Array_Type<string>): DataValidationRulesetHierarchicalRelation;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): DataValidationRulesetHierarchicalRelation;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DataValidationRulesetHierarchicalRelation;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): DataValidationRulesetHierarchicalRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DataValidationRulesetHierarchicalRelation;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DataValidationRulesetHierarchicalRelation;
   ...
   * @see #removeField
   */
  unsetField(field: string): DataValidationRulesetHierarchicalRelation;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DataValidationRulesetHierarchicalRelation;
   ...
   * @see #unsetField
   */
  removeField(field: string): DataValidationRulesetHierarchicalRelation;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DataValidationRulesetHierarchicalRelation;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): DataValidationRulesetHierarchicalRelation;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): DataValidationRulesetHierarchicalRelation;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): DataValidationRulesetHierarchicalRelation;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): DataValidationRulesetHierarchicalRelation;

  mergeJson(json: any): DataValidationRulesetHierarchicalRelation;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): DataValidationRulesetHierarchicalRelation;
   ...
   */
  sumObj(other: Obj, deep?: boolean): DataValidationRulesetHierarchicalRelation;
   ...
   */
  singletonArray(): Array_Type<DataValidationRulesetHierarchicalRelation>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<DataValidationRulesetHierarchicalRelation> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DataValidationRulesetHierarchicalRelation> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<DataValidationRulesetHierarchicalRelation>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DataValidationRulesetHierarchicalRelation> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, DataValidationRulesetHierarchicalRelation> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataValidationRulesetHierarchicalRelation> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DataValidationRulesetHierarchicalRelation>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DataValidationRulesetHierarchicalRelation>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): DataValidationRulesetHierarchicalRelation;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): DataValidationRulesetHierarchicalRelation;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): DataValidationRulesetHierarchicalRelation;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DataValidationRulesetHierarchicalRelation;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): DataValidationRulesetHierarchicalRelation;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DataValidationRulesetHierarchicalRelation;
   ...
   * @see #fromString
   */
  static make(s: string): DataValidationRulesetHierarchicalRelation | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): DataValidationRulesetHierarchicalRelation;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): DataValidationRulesetHierarchicalRelation;
   ...
   */
  static cachedEmptyInst(): DataValidationRulesetHierarchicalRelation;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<DataValidationRulesetHierarchicalRelation> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): DataValidationRulesetHierarchicalRelation;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<DataValidationRulesetHierarchicalRelation>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<DataValidationRulesetHierarchicalRelation>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<DataValidationRulesetHierarchicalRelation> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<DataValidationRulesetHierarchicalRelation>> | null;
   ...
   */
  get(include?: string): DataValidationRulesetHierarchicalRelation | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): DataValidationRulesetHierarchicalRelation | null;
   ...
   */
  getMissing(spec: GetMissingSpec): DataValidationRulesetHierarchicalRelation;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): DataValidationRulesetHierarchicalRelation | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): DataValidationRulesetHierarchicalRelation;
   ...
   * @see #toString
   */
  static fromString(s: string): DataValidationRulesetHierarchicalRelation | null;
   ...
   */
  create(spec?: UpsertSpec): DataValidationRulesetHierarchicalRelation | null;
   ...
   */
  static createBatch(objs: Array_Type<DataValidationRulesetHierarchicalRelation>, spec?: UpsertSpec): ObjList<DataValidationRulesetHierarchicalRelation> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<DataValidationRulesetHierarchicalRelation>, spec?: CreateBatchObjStreamSpec): ObjList<DataValidationRulesetHierarchicalRelation> | null;
   ...
   */
  update(srcObj?: DataValidationRulesetHierarchicalRelation, spec?: UpsertSpec): DataValidationRulesetHierarchicalRelation | null;
   ...
   */
  upsert(srcObj?: DataValidationRulesetHierarchicalRelation, spec?: UpsertSpec): DataValidationRulesetHierarchicalRelation | null;
   ...
   */
  merge(spec?: MergeSpec): DataValidationRulesetHierarchicalRelation | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): DataValidationRulesetHierarchicalRelation | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): DataValidationRulesetHierarchicalRelation | null;
   ...
   */
  static updateBatch(objs: Array_Type<DataValidationRulesetHierarchicalRelation>, srcObjs?: Array_Type<DataValidationRulesetHierarchicalRelation>, spec?: UpsertSpec): ObjList<DataValidationRulesetHierarchicalRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<DataValidationRulesetHierarchicalRelation> | null>, spec?: UpsertSpec): ObjList<DataValidationRulesetHierarchicalRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<DataValidationRulesetHierarchicalRelation>, srcObjs?: Array_Type<DataValidationRulesetHierarchicalRelation>, spec?: UpsertSpec): ObjList<DataValidationRulesetHierarchicalRelation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<DataValidationRulesetHierarchicalRelation> | null>, spec?: UpsertSpec): ObjList<DataValidationRulesetHierarchicalRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<DataValidationRulesetHierarchicalRelation>, spec?: TouchSpec): ObjList<DataValidationRulesetHierarchicalRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<DataValidationRulesetHierarchicalRelation>, spec?: MergeSpec): ObjList<DataValidationRulesetHierarchicalRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<DataValidationRulesetHierarchicalRelation>, mergeInclude: string, spec?: MergeSpec): ObjList<DataValidationRulesetHierarchicalRelation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<DataValidationRulesetHierarchicalRelation> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<DataValidationRulesetHierarchicalRelation> | null;
   ...
   */
  static mergeAll(mergeObj: DataValidationRulesetHierarchicalRelation, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: DataValidationRulesetHierarchicalRelation, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<DataValidationRulesetHierarchicalRelation>, spec?: UpsertSpec): ObjList<DataValidationRulesetHierarchicalRelation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<DataValidationRulesetHierarchicalRelation>, spec?: UpsertSpec): ObjList<DataValidationRulesetHierarchicalRelation> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): DataValidationRulesetHierarchicalRelation | null;
   ...
   */
  static beforeCreate(objs: Array_Type<DataValidationRulesetHierarchicalRelation>): ObjList<DataValidationRulesetHierarchicalRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<DataValidationRulesetHierarchicalRelation>): ObjList<DataValidationRulesetHierarchicalRelation>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<DataValidationRulesetHierarchicalRelation>): ObjList<DataValidationRulesetHierarchicalRelation>;
   ...
   */
  static afterCreate(objs: Array_Type<DataValidationRulesetHierarchicalRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<DataValidationRulesetHierarchicalRelation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<DataValidationRulesetHierarchicalRelation>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<DataValidationRulesetHierarchicalRelation>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<DataValidationRulesetHierarchicalRelation>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): DataValidationRulesetHierarchicalRelation | null;
   ...
   */
  withoutIdentity(): DataValidationRulesetHierarchicalRelation | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<DataValidationRulesetHierarchicalRelation>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: DataValidationRulesetHierarchicalRelation, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<DataValidationRulesetHierarchicalRelation>, callback?: λFunction<DataValidationRulesetHierarchicalRelation | null, DataValidationRulesetHierarchicalRelation | null>): ObjList<DataValidationRulesetHierarchicalRelation>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<DataValidationRulesetHierarchicalRelation>, callback?: λFunction<DataValidationRulesetHierarchicalRelation | null, DataValidationRulesetHierarchicalRelation | null>): Array_Type<ObjError> | null;
