// TypeScript definitions for the C3 type DataValidationMapReduceJob
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of DataValidationMapReduceJob
 */
declare interface IDataValidationMapReduceJob {
   ...
   */
  targetFilter?: IDataValidationSubject;
   ...
   */
  sortRules: Array_Type<DataValidationRule> | Array<IDataValidationRule>;
 ...
 */
declare class DataValidationMapReduceJob extends Obj  {

  /**
   * current or last job execution for this instance
   */
  readonly run?: MapReduceRun;
  withRun(run: IMapReduceRun | null): DataValidationMapReduceJob;

  /**
   * previous job executions for this instance
   */
  readonly runs?: Array_Type<MapReduceRun>;
  withRuns(runs: Array_Type<MapReduceRun> | Array<IMapReduceRun> | null): DataValidationMapReduceJob;

  /**
   * Options to run this job with
   */
  readonly options?: MapReduceOptions;
  withOptions(options: IMapReduceOptions | null): DataValidationMapReduceJob;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): DataValidationMapReduceJob;
  ...
  withPriority(priority: number | null): DataValidationMapReduceJob;
  ...
  withDisabled(disabled: boolean): DataValidationMapReduceJob;
  ...
  withMaxConcurrency(maxConcurrency: number | null): DataValidationMapReduceJob;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): DataValidationMapReduceJob;
  ...
  withRunAsUser(runAsUser: boolean): DataValidationMapReduceJob;

  /**
   * Don't set this field in the MapReduce job, set it in the MapReduceOptions when calling `start`.
   */
  readonly nodePool?: string;
  withNodePool(nodePool: string | null): DataValidationMapReduceJob;
  ...
  withSkipIfRunning(skipIfRunning: boolean): DataValidationMapReduceJob;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): DataValidationMapReduceJob;
  ...
  withTargetType(targetType: IType | null): DataValidationMapReduceJob;
  ...
  withUseFileSystemForInterVals(useFileSystemForInterVals: boolean): DataValidationMapReduceJob;
  ...
  withUseBatchIdsForReadInput(useBatchIdsForReadInput: boolean): DataValidationMapReduceJob;
  ...
  withInclude(include: string | null): DataValidationMapReduceJob;

  /**
   * optional filter spec
   */
  readonly filter?: string;
  withFilter(filter: string | null): DataValidationMapReduceJob;
  ...
  withOrder(order: string | null): DataValidationMapReduceJob;
  ...
  withLimit(limit: number | null): DataValidationMapReduceJob;
  ...
  withSamplePct(samplePct: number | null): DataValidationMapReduceJob;
  ...
  withBatchSize(batchSize: number | null): DataValidationMapReduceJob;
  ...
  withSubBatchSize(subBatchSize: number | null): DataValidationMapReduceJob;
  ...
  withNumBatches(numBatches: number | null): DataValidationMapReduceJob;
  ...
  withAbortOnError(abortOnError: boolean): DataValidationMapReduceJob;
  ...
  withTypeIdent(typeIdent: string | null): DataValidationMapReduceJob;
   ...
   */
  readonly id: string;
  withId(id: string): DataValidationMapReduceJob;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): DataValidationMapReduceJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): DataValidationMapReduceJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): DataValidationMapReduceJob;
  ...
  withVersion(version: number | null): DataValidationMapReduceJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): DataValidationMapReduceJob;

  /**
   * Optional target type instance to be used as the filter for the job.  When specified, the {~link map} function will
   * only be called for that obj.
   */
  readonly targetFilter?: DataValidationSubject;
  withTargetFilter(targetFilter: IDataValidationSubject | null): DataValidationMapReduceJob;
  ...
  withDataValidationRuns(dataValidationRuns: Array_Type<DataValidationRun> | Array<IDataValidationRun> | null): DataValidationMapReduceJob;

  /**
   * The sorted rules this batch job is responsible for running in each subject.
   * Rules need to be sorted by {@link DataValidationRule#topologicalSort}
   */
  readonly sortRules: Array_Type<DataValidationRule>;
  withSortRules(sortRules: Array_Type<DataValidationRule> | Array<IDataValidationRule>): DataValidationMapReduceJob;

  /**
   * Indicates whether the {@link DataValidationResult} and {@link DataValidationRulesetResult} are going to be persisted or not.
   */
  readonly persistResults?: boolean;
  withPersistResults(persistResults: boolean): DataValidationMapReduceJob;

  /**
   * If true, the {@link DataValidationRun} will not be marked with a runStatus of complete this job finishes.
   */
  readonly doNotMarkComplete?: boolean;
  withDoNotMarkComplete(doNotMarkComplete: boolean): DataValidationMapReduceJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any): DataValidationMapReduceJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): DataValidationMapReduceJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): DataValidationMapReduceJob | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): DataValidationMapReduceJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): DataValidationMapReduceJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DataValidationMapReduceJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DataValidationMapReduceJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<DataValidationMapReduceJob>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<DataValidationMapReduceJob>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): DataValidationMapReduceJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataValidationMapReduceJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataValidationMapReduceJob;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DataValidationMapReduceJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DataValidationMapReduceJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DataValidationMapReduceJob;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): DataValidationMapReduceJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataValidationMapReduceJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DataValidationMapReduceJob;
   ...
   * @see #removeField
   */
  withoutField(field: string): DataValidationMapReduceJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): DataValidationMapReduceJob;
   ...
   */
  withoutFields(fields: Array_Type<string>): DataValidationMapReduceJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): DataValidationMapReduceJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DataValidationMapReduceJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): DataValidationMapReduceJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DataValidationMapReduceJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DataValidationMapReduceJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): DataValidationMapReduceJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DataValidationMapReduceJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): DataValidationMapReduceJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DataValidationMapReduceJob;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): DataValidationMapReduceJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): DataValidationMapReduceJob;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): DataValidationMapReduceJob;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): DataValidationMapReduceJob;

  mergeJson(json: any): DataValidationMapReduceJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): DataValidationMapReduceJob;
   ...
   */
  sumObj(other: Obj, deep?: boolean): DataValidationMapReduceJob;
   ...
   */
  singletonArray(): Array_Type<DataValidationMapReduceJob>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<DataValidationMapReduceJob> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DataValidationMapReduceJob> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<DataValidationMapReduceJob>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DataValidationMapReduceJob> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, DataValidationMapReduceJob> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataValidationMapReduceJob> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DataValidationMapReduceJob>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DataValidationMapReduceJob>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): DataValidationMapReduceJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): DataValidationMapReduceJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): DataValidationMapReduceJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DataValidationMapReduceJob;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): DataValidationMapReduceJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DataValidationMapReduceJob;
   ...
   * @see #fromString
   */
  static make(s: string): DataValidationMapReduceJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): DataValidationMapReduceJob;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): DataValidationMapReduceJob;
   ...
   */
  static cachedEmptyInst(): DataValidationMapReduceJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<DataValidationMapReduceJob> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): DataValidationMapReduceJob;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<DataValidationMapReduceJob>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<DataValidationMapReduceJob>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<DataValidationMapReduceJob> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<DataValidationMapReduceJob>> | null;
   ...
   */
  get(include?: string): DataValidationMapReduceJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): DataValidationMapReduceJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): DataValidationMapReduceJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): DataValidationMapReduceJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): DataValidationMapReduceJob;
   ...
   * @see #toString
   */
  static fromString(s: string): DataValidationMapReduceJob | null;
   ...
   */
  create(spec?: UpsertSpec): DataValidationMapReduceJob | null;
   ...
   */
  static createBatch(objs: Array_Type<DataValidationMapReduceJob>, spec?: UpsertSpec): ObjList<DataValidationMapReduceJob> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<DataValidationMapReduceJob>, spec?: CreateBatchObjStreamSpec): ObjList<DataValidationMapReduceJob> | null;
   ...
   */
  update(srcObj?: DataValidationMapReduceJob, spec?: UpsertSpec): DataValidationMapReduceJob | null;
   ...
   */
  upsert(srcObj?: DataValidationMapReduceJob, spec?: UpsertSpec): DataValidationMapReduceJob | null;
   ...
   */
  merge(spec?: MergeSpec): DataValidationMapReduceJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): DataValidationMapReduceJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): DataValidationMapReduceJob | null;
   ...
   */
  static updateBatch(objs: Array_Type<DataValidationMapReduceJob>, srcObjs?: Array_Type<DataValidationMapReduceJob>, spec?: UpsertSpec): ObjList<DataValidationMapReduceJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<DataValidationMapReduceJob> | null>, spec?: UpsertSpec): ObjList<DataValidationMapReduceJob> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<DataValidationMapReduceJob>, srcObjs?: Array_Type<DataValidationMapReduceJob>, spec?: UpsertSpec): ObjList<DataValidationMapReduceJob> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<DataValidationMapReduceJob> | null>, spec?: UpsertSpec): ObjList<DataValidationMapReduceJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<DataValidationMapReduceJob>, spec?: TouchSpec): ObjList<DataValidationMapReduceJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<DataValidationMapReduceJob>, spec?: MergeSpec): ObjList<DataValidationMapReduceJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<DataValidationMapReduceJob>, mergeInclude: string, spec?: MergeSpec): ObjList<DataValidationMapReduceJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<DataValidationMapReduceJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<DataValidationMapReduceJob> | null;
   ...
   */
  static mergeAll(mergeObj: DataValidationMapReduceJob, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: DataValidationMapReduceJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<DataValidationMapReduceJob>, spec?: UpsertSpec): ObjList<DataValidationMapReduceJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<DataValidationMapReduceJob>, spec?: UpsertSpec): ObjList<DataValidationMapReduceJob> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): DataValidationMapReduceJob | null;
   ...
   */
  static beforeCreate(objs: Array_Type<DataValidationMapReduceJob>): ObjList<DataValidationMapReduceJob>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<DataValidationMapReduceJob>): ObjList<DataValidationMapReduceJob>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<DataValidationMapReduceJob>): ObjList<DataValidationMapReduceJob>;
   ...
   */
  static afterCreate(objs: Array_Type<DataValidationMapReduceJob>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<DataValidationMapReduceJob>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<DataValidationMapReduceJob>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<DataValidationMapReduceJob>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<DataValidationMapReduceJob>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): DataValidationMapReduceJob | null;
   ...
   */
  withoutIdentity(): DataValidationMapReduceJob | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<DataValidationMapReduceJob>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: DataValidationMapReduceJob, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<DataValidationMapReduceJob>, callback?: λFunction<DataValidationMapReduceJob | null, DataValidationMapReduceJob | null>): ObjList<DataValidationMapReduceJob>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<DataValidationMapReduceJob>, callback?: λFunction<DataValidationMapReduceJob | null, DataValidationMapReduceJob | null>): Array_Type<ObjError> | null;
   ...
   * @inheritdoc
   */
  static map(batch?: number, objs?: Array_Type<DataValidationSubject>, job?: MapReduce<DataValidationSubject, string, DataValidationRun, DataValidationRun>, subBatch?: number): Map_Type<string, DataValidationRun> | null;

  /**
   * @inheritdoc
   */
  static reduce(outKey?: string, interValues?: Array_Type<DataValidationRun>, job?: MapReduce<DataValidationSubject, string, DataValidationRun, DataValidationRun>): DataValidationRun | Array_Type<DataValidationRun> | null;
   ...
   */
  static mapCompleted(job?: MapReduce<DataValidationSubject, string, DataValidationRun, DataValidationRun>): void;

  /**
   * @inheritdoc
   */
  static completed(job?: MapReduce<DataValidationSubject, string, DataValidationRun, DataValidationRun>): string | null;

  /**
   * @inheritdoc
   */
  static failed(job: MapReduce<DataValidationSubject, string, DataValidationRun, DataValidationRun>, status: MapReduceStatus, options?: MapReduceOptions): void;
   ...
   */
  results(limit?: number = '10000'): Map_Type<string, DataValidationRun | Array_Type<DataValidationRun>> | null;
   ...
   *    The created job.
   */
  static createJob(subjectType: Type, sortRules: Array_Type<DataValidationRule>, filter: Filter, spec: DataValidationExecutionSpec): DataValidationMapReduceJob;
