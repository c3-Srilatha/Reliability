// TypeScript definitions for the C3 type TestDataValidationSubject

/**
 * Test data type for {@link DataValidationSubject}
 *
 * @remarks this represents a value passed to a method that expects an instance of TestDataValidationSubject
 */
declare interface ITestDataValidationSubject {
 ...
 */
declare class TestDataValidationSubject extends Obj  {
   ...
   */
  readonly id: string;
  withId(id: string): TestDataValidationSubject;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): TestDataValidationSubject;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): TestDataValidationSubject;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): TestDataValidationSubject;
  ...
  withVersion(version: number | null): TestDataValidationSubject;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): TestDataValidationSubject;
  ...
  withDataValidationRuns(dataValidationRuns: Array_Type<DataValidationRun> | Array<IDataValidationRun> | null): TestDataValidationSubject;
  ...
  withLatestDataValidationRun(latestDataValidationRun: IDataValidationRun | null): TestDataValidationSubject;

  /**
   * Field used for filtering in the subjects.
   */
  readonly passFilter?: boolean;
  withPassFilter(passFilter: boolean): TestDataValidationSubject;
   ...
   * @see #toJson
   */
  static fromJson(json: any): TestDataValidationSubject | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): TestDataValidationSubject | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): TestDataValidationSubject | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): TestDataValidationSubject | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestDataValidationSubject;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TestDataValidationSubject;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): TestDataValidationSubject;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<TestDataValidationSubject>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<TestDataValidationSubject>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): TestDataValidationSubject;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestDataValidationSubject;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestDataValidationSubject;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestDataValidationSubject;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestDataValidationSubject;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestDataValidationSubject;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): TestDataValidationSubject;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestDataValidationSubject;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestDataValidationSubject;
   ...
   * @see #removeField
   */
  withoutField(field: string): TestDataValidationSubject;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): TestDataValidationSubject;
   ...
   */
  withoutFields(fields: Array_Type<string>): TestDataValidationSubject;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): TestDataValidationSubject;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestDataValidationSubject;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): TestDataValidationSubject;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestDataValidationSubject;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestDataValidationSubject;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestDataValidationSubject;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestDataValidationSubject;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestDataValidationSubject;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestDataValidationSubject;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): TestDataValidationSubject;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): TestDataValidationSubject;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): TestDataValidationSubject;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): TestDataValidationSubject;

  mergeJson(json: any): TestDataValidationSubject;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): TestDataValidationSubject;
   ...
   */
  sumObj(other: Obj, deep?: boolean): TestDataValidationSubject;
   ...
   */
  singletonArray(): Array_Type<TestDataValidationSubject>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<TestDataValidationSubject> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestDataValidationSubject> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<TestDataValidationSubject>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestDataValidationSubject> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, TestDataValidationSubject> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestDataValidationSubject> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestDataValidationSubject>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestDataValidationSubject>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): TestDataValidationSubject;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): TestDataValidationSubject;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): TestDataValidationSubject;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestDataValidationSubject;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): TestDataValidationSubject;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestDataValidationSubject;
   ...
   * @see #fromString
   */
  static make(s: string): TestDataValidationSubject | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): TestDataValidationSubject;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): TestDataValidationSubject;
   ...
   */
  static cachedEmptyInst(): TestDataValidationSubject;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<TestDataValidationSubject> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): TestDataValidationSubject;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<TestDataValidationSubject>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestDataValidationSubject>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<TestDataValidationSubject> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<TestDataValidationSubject>> | null;
   ...
   */
  get(include?: string): TestDataValidationSubject | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): TestDataValidationSubject | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestDataValidationSubject;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): TestDataValidationSubject | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestDataValidationSubject;
   ...
   * @see #toString
   */
  static fromString(s: string): TestDataValidationSubject | null;
   ...
   */
  create(spec?: UpsertSpec): TestDataValidationSubject | null;
   ...
   */
  static createBatch(objs: Array_Type<TestDataValidationSubject>, spec?: UpsertSpec): ObjList<TestDataValidationSubject> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestDataValidationSubject>, spec?: CreateBatchObjStreamSpec): ObjList<TestDataValidationSubject> | null;
   ...
   */
  update(srcObj?: TestDataValidationSubject, spec?: UpsertSpec): TestDataValidationSubject | null;
   ...
   */
  upsert(srcObj?: TestDataValidationSubject, spec?: UpsertSpec): TestDataValidationSubject | null;
   ...
   */
  merge(spec?: MergeSpec): TestDataValidationSubject | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): TestDataValidationSubject | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): TestDataValidationSubject | null;
   ...
   */
  static updateBatch(objs: Array_Type<TestDataValidationSubject>, srcObjs?: Array_Type<TestDataValidationSubject>, spec?: UpsertSpec): ObjList<TestDataValidationSubject> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<TestDataValidationSubject> | null>, spec?: UpsertSpec): ObjList<TestDataValidationSubject> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<TestDataValidationSubject>, srcObjs?: Array_Type<TestDataValidationSubject>, spec?: UpsertSpec): ObjList<TestDataValidationSubject> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<TestDataValidationSubject> | null>, spec?: UpsertSpec): ObjList<TestDataValidationSubject> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<TestDataValidationSubject>, spec?: TouchSpec): ObjList<TestDataValidationSubject> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TestDataValidationSubject>, spec?: MergeSpec): ObjList<TestDataValidationSubject> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<TestDataValidationSubject>, mergeInclude: string, spec?: MergeSpec): ObjList<TestDataValidationSubject> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<TestDataValidationSubject> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<TestDataValidationSubject> | null;
   ...
   */
  static mergeAll(mergeObj: TestDataValidationSubject, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestDataValidationSubject, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<TestDataValidationSubject>, spec?: UpsertSpec): ObjList<TestDataValidationSubject> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<TestDataValidationSubject>, spec?: UpsertSpec): ObjList<TestDataValidationSubject> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TestDataValidationSubject | null;
   ...
   */
  static beforeCreate(objs: Array_Type<TestDataValidationSubject>): ObjList<TestDataValidationSubject>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<TestDataValidationSubject>): ObjList<TestDataValidationSubject>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<TestDataValidationSubject>): ObjList<TestDataValidationSubject>;
   ...
   */
  static afterCreate(objs: Array_Type<TestDataValidationSubject>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<TestDataValidationSubject>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<TestDataValidationSubject>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<TestDataValidationSubject>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<TestDataValidationSubject>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): TestDataValidationSubject | null;
   ...
   */
  withoutIdentity(): TestDataValidationSubject | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<TestDataValidationSubject>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: TestDataValidationSubject, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<TestDataValidationSubject>, callback?: λFunction<TestDataValidationSubject | null, TestDataValidationSubject | null>): ObjList<TestDataValidationSubject>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<TestDataValidationSubject>, callback?: λFunction<TestDataValidationSubject | null, TestDataValidationSubject | null>): Array_Type<ObjError> | null;
