// TypeScript definitions for the C3 type DataValidationBatchJob

/**
 * The batch job to evaluate {@link DataValidationRule data validation rules}.
 *
 * @remarks this represents a value passed to a method that expects an instance of DataValidationBatchJob
 */
declare interface IDataValidationBatchJob {
   ...
   */
  options?: IDataValidationBatchJobOptions;
   ...
   */
  dataValidationRun?: IDataValidationRun;
}
 ...
 */
declare class DataValidationBatchJob extends Obj  {

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun;
  withRun(run: IBatchJobRun | null): DataValidationBatchJob;

  /**
   * previous job executions for this instance
   */
  readonly runs?: Array_Type<BatchJobRun>;
  withRuns(runs: Array_Type<BatchJobRun> | Array<IBatchJobRun> | null): DataValidationBatchJob;

  /**
   * The options to use while running this job
   */
  readonly options?: DataValidationBatchJobOptions;
  withOptions(options: IDataValidationBatchJobOptions | null): DataValidationBatchJob;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): DataValidationBatchJob;
  ...
  withPriority(priority: number | null): DataValidationBatchJob;
  ...
  withDisabled(disabled: boolean): DataValidationBatchJob;
  ...
  withMaxConcurrency(maxConcurrency: number | null): DataValidationBatchJob;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): DataValidationBatchJob;
  ...
  withRunAsUser(runAsUser: boolean): DataValidationBatchJob;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string;
  withNodePool(nodePool: string | null): DataValidationBatchJob;
  ...
  withSkipIfRunning(skipIfRunning: boolean): DataValidationBatchJob;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): DataValidationBatchJob;
  ...
  withTypeIdent(typeIdent: string | null): DataValidationBatchJob;
   ...
   */
  readonly id: string;
  withId(id: string): DataValidationBatchJob;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): DataValidationBatchJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): DataValidationBatchJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): DataValidationBatchJob;
  ...
  withVersion(version: number | null): DataValidationBatchJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): DataValidationBatchJob;
  ...
  withAbortOnError(abortOnError: boolean): DataValidationBatchJob;

  /**
   * The rules this batch job is responsible for running.
   */
  readonly rules: Array_Type<DataValidationRule>;
  withRules(rules: Array_Type<DataValidationRule> | Array<IDataValidationRule>): DataValidationBatchJob;

  /**
   * The run this batch job is responsible for generating results for.
   */
  readonly dataValidationRun?: DataValidationRun;
  withDataValidationRun(dataValidationRun: IDataValidationRun | null): DataValidationBatchJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any): DataValidationBatchJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): DataValidationBatchJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): DataValidationBatchJob | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): DataValidationBatchJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): DataValidationBatchJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DataValidationBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): DataValidationBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<DataValidationBatchJob>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<DataValidationBatchJob>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): DataValidationBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataValidationBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataValidationBatchJob;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DataValidationBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DataValidationBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DataValidationBatchJob;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): DataValidationBatchJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataValidationBatchJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DataValidationBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: string): DataValidationBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): DataValidationBatchJob;
   ...
   */
  withoutFields(fields: Array_Type<string>): DataValidationBatchJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): DataValidationBatchJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DataValidationBatchJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): DataValidationBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DataValidationBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DataValidationBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): DataValidationBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DataValidationBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): DataValidationBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DataValidationBatchJob;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): DataValidationBatchJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): DataValidationBatchJob;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): DataValidationBatchJob;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): DataValidationBatchJob;

  mergeJson(json: any): DataValidationBatchJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): DataValidationBatchJob;
   ...
   */
  sumObj(other: Obj, deep?: boolean): DataValidationBatchJob;
   ...
   */
  singletonArray(): Array_Type<DataValidationBatchJob>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<DataValidationBatchJob> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DataValidationBatchJob> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<DataValidationBatchJob>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DataValidationBatchJob> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, DataValidationBatchJob> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataValidationBatchJob> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DataValidationBatchJob>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DataValidationBatchJob>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): DataValidationBatchJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): DataValidationBatchJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): DataValidationBatchJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DataValidationBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): DataValidationBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DataValidationBatchJob;
   ...
   * @see #fromString
   */
  static make(s: string): DataValidationBatchJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): DataValidationBatchJob;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): DataValidationBatchJob;
   ...
   */
  static cachedEmptyInst(): DataValidationBatchJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<DataValidationBatchJob> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): DataValidationBatchJob;
   ...
   */
  start(options?: DataValidationBatchJobOptions): BatchJobStatus | null;
   ...
   */
  cleanup(options?: DataValidationBatchJobOptions): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun, BatchJobStatus, DataValidationBatchJobOptions> | null;

  failJob(run: JobRun<BatchJobStatusBase>): JobBase<BatchJobRun, BatchJobStatus, DataValidationBatchJobOptions> | null;
  ...
  validateStart(options?: DataValidationBatchJobOptions): void;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<DataValidationBatchJob>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<DataValidationBatchJob>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<DataValidationBatchJob> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<DataValidationBatchJob>> | null;
   ...
   */
  get(include?: string): DataValidationBatchJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): DataValidationBatchJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): DataValidationBatchJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): DataValidationBatchJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): DataValidationBatchJob;
   ...
   * @see #toString
   */
  static fromString(s: string): DataValidationBatchJob | null;
   ...
   */
  create(spec?: UpsertSpec): DataValidationBatchJob | null;
   ...
   */
  static createBatch(objs: Array_Type<DataValidationBatchJob>, spec?: UpsertSpec): ObjList<DataValidationBatchJob> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<DataValidationBatchJob>, spec?: CreateBatchObjStreamSpec): ObjList<DataValidationBatchJob> | null;
   ...
   */
  update(srcObj?: DataValidationBatchJob, spec?: UpsertSpec): DataValidationBatchJob | null;
   ...
   */
  upsert(srcObj?: DataValidationBatchJob, spec?: UpsertSpec): DataValidationBatchJob | null;
   ...
   */
  merge(spec?: MergeSpec): DataValidationBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): DataValidationBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): DataValidationBatchJob | null;
   ...
   */
  static updateBatch(objs: Array_Type<DataValidationBatchJob>, srcObjs?: Array_Type<DataValidationBatchJob>, spec?: UpsertSpec): ObjList<DataValidationBatchJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<DataValidationBatchJob> | null>, spec?: UpsertSpec): ObjList<DataValidationBatchJob> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<DataValidationBatchJob>, srcObjs?: Array_Type<DataValidationBatchJob>, spec?: UpsertSpec): ObjList<DataValidationBatchJob> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<DataValidationBatchJob> | null>, spec?: UpsertSpec): ObjList<DataValidationBatchJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<DataValidationBatchJob>, spec?: TouchSpec): ObjList<DataValidationBatchJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<DataValidationBatchJob>, spec?: MergeSpec): ObjList<DataValidationBatchJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<DataValidationBatchJob>, mergeInclude: string, spec?: MergeSpec): ObjList<DataValidationBatchJob> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<DataValidationBatchJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<DataValidationBatchJob> | null;
   ...
   */
  static mergeAll(mergeObj: DataValidationBatchJob, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: DataValidationBatchJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<DataValidationBatchJob>, spec?: UpsertSpec): ObjList<DataValidationBatchJob> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<DataValidationBatchJob>, spec?: UpsertSpec): ObjList<DataValidationBatchJob> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): DataValidationBatchJob | null;
   ...
   */
  static beforeCreate(objs: Array_Type<DataValidationBatchJob>): ObjList<DataValidationBatchJob>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<DataValidationBatchJob>): ObjList<DataValidationBatchJob>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<DataValidationBatchJob>): ObjList<DataValidationBatchJob>;
   ...
   */
  static afterCreate(objs: Array_Type<DataValidationBatchJob>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<DataValidationBatchJob>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<DataValidationBatchJob>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<DataValidationBatchJob>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<DataValidationBatchJob>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): DataValidationBatchJob | null;
   ...
   */
  withoutIdentity(): DataValidationBatchJob | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<DataValidationBatchJob>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: DataValidationBatchJob, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<DataValidationBatchJob>, callback?: λFunction<DataValidationBatchJob | null, DataValidationBatchJob | null>): ObjList<DataValidationBatchJob>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<DataValidationBatchJob>, callback?: λFunction<DataValidationBatchJob | null, DataValidationBatchJob | null>): Array_Type<ObjError> | null;
   ...
   * @inheritdoc
   */
  static doStart(job?: DataValidationBatchJob, options?: DataValidationBatchJobOptions): void;

  /**
   * @inheritdoc
   */
  static processBatch(batch?: DataValidationBatch, job?: DataValidationBatchJob, options?: DataValidationBatchJobOptions): void;

  /**
   * @inheritdoc
   */
  static allComplete(job: DataValidationBatchJob, options?: DataValidationBatchJobOptions): string | null;
   ...
   */
  static failed(job: DataValidationBatchJob, status: BatchJobStatus, options?: DataValidationBatchJobOptions): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: DataValidationBatch): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: Array_Type<DataValidationBatch>): void;
   ...
   */
  static scheduleObjBatch(job?: DataValidationBatchJob, objBatch?: ObjBatch, logPrefix?: string): number | null;
   ...
   */
  static createJob(rules: Array_Type<DataValidationRule>, dataValidationRun: DataValidationRun, spec: DataValidationExecutionSpec): DataValidationBatchJob;
}
