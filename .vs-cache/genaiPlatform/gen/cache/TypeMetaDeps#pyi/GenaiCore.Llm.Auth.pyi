...
# Python definitions for the C3 type GenaiCore.Llm.Auth


class Auth(DefaultInstance, Named, Config):
    """
    ...
    @remarks this represents a made instance of GenaiCore.Llm.Auth
    """
    ...
    """
    def __init__(self, name: Optional[str]=None, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, auths: Optional[Array[GenaiCore.Llm.Auth]]=None) -> None: ...

    @classmethod
    def inst(cls) -> GenaiCore.Llm.Auth:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[GenaiCore.Llm.Auth]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[GenaiCore.Llm.Auth]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[GenaiCore.Llm.Auth]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[GenaiCore.Llm.Auth]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> GenaiCore.Llm.Auth:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> GenaiCore.Llm.Auth:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> GenaiCore.Llm.Auth:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[GenaiCore.Llm.Auth]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[GenaiCore.Llm.Auth]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> GenaiCore.Llm.Auth:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> GenaiCore.Llm.Auth:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> GenaiCore.Llm.Auth:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> GenaiCore.Llm.Auth:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> GenaiCore.Llm.Auth:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> GenaiCore.Llm.Auth:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> GenaiCore.Llm.Auth:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> GenaiCore.Llm.Auth:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> GenaiCore.Llm.Auth:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> GenaiCore.Llm.Auth:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> GenaiCore.Llm.Auth:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> GenaiCore.Llm.Auth:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> GenaiCore.Llm.Auth:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> GenaiCore.Llm.Auth:
    """
    @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> GenaiCore.Llm.Auth:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> GenaiCore.Llm.Auth:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> GenaiCore.Llm.Auth:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> GenaiCore.Llm.Auth:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> GenaiCore.Llm.Auth:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> GenaiCore.Llm.Auth:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> GenaiCore.Llm.Auth:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> GenaiCore.Llm.Auth:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> GenaiCore.Llm.Auth:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> GenaiCore.Llm.Auth:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> GenaiCore.Llm.Auth:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> GenaiCore.Llm.Auth:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> GenaiCore.Llm.Auth:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> GenaiCore.Llm.Auth:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[GenaiCore.Llm.Auth]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[GenaiCore.Llm.Auth]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[GenaiCore.Llm.Auth]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[GenaiCore.Llm.Auth]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[GenaiCore.Llm.Auth]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, GenaiCore.Llm.Auth]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, GenaiCore.Llm.Auth]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[GenaiCore.Llm.Auth]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[GenaiCore.Llm.Auth]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> GenaiCore.Llm.Auth:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> GenaiCore.Llm.Auth:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> GenaiCore.Llm.Auth:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> GenaiCore.Llm.Auth:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> GenaiCore.Llm.Auth:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> GenaiCore.Llm.Auth:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[GenaiCore.Llm.Auth]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> GenaiCore.Llm.Auth:
    """
    ...
    """
        ...
    def afterMake(self) -> GenaiCore.Llm.Auth:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> GenaiCore.Llm.Auth:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[GenaiCore.Llm.Auth]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> GenaiCore.Llm.Auth:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[GenaiCore.Llm.Auth]:
    """
    ...
    """
        ...
    @classmethod
    def forName(cls, name: str, failIfMissing: bool=None) -> Union[GenaiCore.Llm.Auth]:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls) -> Union[Stream[GenaiCore.Llm.Auth]]:
    """
    @return stream of all available Cached instances.
    """
        ...
    @classmethod
    def find(cls, filter: str=None) -> Union[Stream[GenaiCore.Llm.Auth]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any) -> Union[Stream[GenaiCore.Llm.Auth]]:
    """
    @return existing instances of this type that satisfy filter from data cache. Will call `produceAll`
            if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
            Otherwise no population will be performed.
    """
        ...
    def getCached(self) -> Union[GenaiCore.Llm.Auth]:
    """
    @return cached instance.
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[GenaiCore.Llm.Auth]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[GenaiCore.Llm.Auth]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, GenaiCore.Llm.Auth]]:
    """
    ...
    """
        ...
    def getConfig(self) -> GenaiCore.Llm.Auth:
    """
    ...
    """
        ...
    def getSecret(self) -> GenaiCore.Llm.Auth:
    """
    ...
    """
        ...
    def withConfigKey(self, configKey: str) -> GenaiCore.Llm.Auth:
    """
    ...
    """
        ...
    def withoutConfigKey(self) -> GenaiCore.Llm.Auth:
    """
    @return copy without config key.
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[GenaiCore.Llm.Auth]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[GenaiCore.Llm.Auth]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: GenaiCore.Llm.Auth, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[GenaiCore.Llm.Auth]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[GenaiCore.Llm.Auth]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[GenaiCore.Llm.Auth]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> GenaiCore.Llm.Auth:
    """
    ...
    class Secret(Named, Config):
        """
        PrivilegedActions can only allow access to otherwise restricted actions on specific types, not subtypes. This means that allowing {@link GenaiCore.Llm.Auth#getSecret} does not allow
        `getSecret` on any of its concrete subtypes. In order to enable {@link GenaiCore.Llm.Auth} extensibility and integration with the PrivilegedAction framework, we store the secrets in
        this (single) concrete config type, which is then used by the {@link GenaiCore.Llm.Auth} types to retrieve the secrets.
        
        @remarks this represents a made instance of GenaiCore.Llm.Auth.Secret
        """
        ...
        authSecret: Optional[any]
        """
        The secret value
        """
        def __init__(self, name: Optional[str]=None, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, authSecret: Optional[any]=None) -> None: ...
        ...
        """
            ...
        @classmethod
        def fromJson(cls, json: any) -> Union[GenaiCore.Llm.Auth.Secret]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromJsonString(cls, json: str) -> Union[GenaiCore.Llm.Auth.Secret]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromXmlString(cls, xml: str) -> Union[GenaiCore.Llm.Auth.Secret]:
        """
        Load the XML-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def deserialize(cls, contentStr: str, contentType: str) -> Union[GenaiCore.Llm.Auth.Secret]:
        """
        Load from contentType representation and reconstruct the corresponding object.
        ...
        """
            ...
        def replaceType(self, old: Type, new: Type) -> GenaiCore.Llm.Auth.Secret:
        """
        Returns new instance with all references to old type, including result of #type, replaced with new type. If new
        type does not contain fields from old or field value types are not convertable then drops the field.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> GenaiCore.Llm.Auth.Secret:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> GenaiCore.Llm.Auth.Secret:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[GenaiCore.Llm.Auth.Secret]:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the asynchronous `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[GenaiCore.Llm.Auth.Secret]:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        asynchronous `mapper` invocation.
        ...
        """
            ...
        def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> GenaiCore.Llm.Auth.Secret:
        """
        Result of this function call is a copy of current instance with specified field value replaced based on result of
        the `mapper` invocation.
        @param field
        ...
        """
            ...
        @overload
        def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> GenaiCore.Llm.Auth.Secret:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> GenaiCore.Llm.Auth.Secret:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def validateObj(self) -> GenaiCore.Llm.Auth.Secret:
        """
        Populates all missing default values and throws error if any constraint is violated.
        """
            ...
        ...
        """
            ...
        @overload
        def withField(self, field: str, value: Any, doNotConvert: bool=None) -> GenaiCore.Llm.Auth.Secret:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        @overload
        def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> GenaiCore.Llm.Auth.Secret:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> GenaiCore.Llm.Auth.Secret:
        """
        Builds a new Obj instance by adding the provided fields in it. The name must correspond to an existing fields
        defined on this type or its mixins. The values must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> GenaiCore.Llm.Auth.Secret:
        """
        Builds a new Obj with the value at the specified path field. If the field is null, the field #isFieldSet to null.
        If you would like to #unsetField, you should call #withoutFieldAtPath instead.
        ...
        """
            ...
        def withoutFieldAtPath(self, path: str) -> GenaiCore.Llm.Auth.Secret:
        """
        Builds a new Obj without the specified path field.
        ...
        """
            ...
        @overload
        def withoutField(self, field: str) -> GenaiCore.Llm.Auth.Secret:
        """
        Builds a new Obj, removing the field with the provided name.
        ...
        """
            ...
        @overload
        def withoutField(self, field: FieldType) -> GenaiCore.Llm.Auth.Secret:
        """
        Builds a new Obj, removing the field with the provided field type.
        ...
        """
            ...
        def withoutFields(self, fields: Array[str]) -> GenaiCore.Llm.Auth.Secret:
        """
        Builds a new Obj, removing the fields with the provided names.
        ...
        """
            ...
        def withoutFieldsByType(self, fields: Array[FieldType]) -> GenaiCore.Llm.Auth.Secret:
        """
        Builds a new Obj, removing the fields with the provided field types. Be sure to use the FieldType instance for the
        exact same type as the type of the obj to respect the "ordinal" of the field type
        ...
        """
            ...
        def withoutSecretFields(self) -> GenaiCore.Llm.Auth.Secret:
        """
        @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
        """
            ...
        def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> GenaiCore.Llm.Auth.Secret:
        """
        Builds a new Obj instance by adding the default values (if defined) for all unset fields. This is implemented by
        calling {@link FieldType#defaultValue defaultValue} for a field if it is not already set and
        {@link FieldType#hasDefault has a default}. It will also set {@see ValueType#initialValue initial values} for
        ...
        """
            ...
        @overload
        def defaultField(self, field: str) -> GenaiCore.Llm.Auth.Secret:
        """
        Builds a new Obj, by setting a field on this `Obj` to the field's default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def defaultField(self, field: FieldType) -> GenaiCore.Llm.Auth.Secret:
        """
        Builds a new Obj, by setting a field on this `Obj` to the fields default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def unsetField(self, field: str) -> GenaiCore.Llm.Auth.Secret:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def unsetField(self, field: FieldType) -> GenaiCore.Llm.Auth.Secret:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def removeField(self, field: str) -> GenaiCore.Llm.Auth.Secret:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def removeField(self, field: FieldType) -> GenaiCore.Llm.Auth.Secret:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> GenaiCore.Llm.Auth.Secret:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence unless otherwise specified by the fieldPathMergeSpec
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> GenaiCore.Llm.Auth.Secret:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence.
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> GenaiCore.Llm.Auth.Secret:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist on other Obj and do not exist on this Obj will not be added to final Obj.
        @param deep
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> GenaiCore.Llm.Auth.Secret:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist other Obj and do not exist on this Obj will not be added to final Obj or evaluated. Does not
        traverse child reference and collection fields.
        ...
        """
            ...
        def mergeJson(self, json: any) -> GenaiCore.Llm.Auth.Secret:
            ...
        def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> GenaiCore.Llm.Auth.Secret:
        """
        Merge the obj references within the current obj
        @param deep
               If set, traverses the reference fields within the obj as well for a deep merge
        ...
        """
            ...
        def sumObj(self, other: Obj, deep: bool=None) -> GenaiCore.Llm.Auth.Secret:
        """
        Adds the numeric Obj fields with the other Objs respective fields.
        If deep is set it will traverse reference and collection fields and sum corresponding numeric fields in
        references with same name and collection elements at same index or key.
        """
            ...
        def singletonArray(self) -> Array[GenaiCore.Llm.Auth.Secret]:
        """
        Build an array of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def array(cls, *elements: Array[Any]) -> Union[Array[GenaiCore.Llm.Auth.Secret]]:
        """
        Creates an array of instances of this type.
        """
            ...
        @classmethod
        def arrayBuilder(cls) -> Union[ArrayBuilder[GenaiCore.Llm.Auth.Secret]]:
        """
        Creates an array of instances of this type.
        """
            ...
        def singletonSet(self) -> Set[GenaiCore.Llm.Auth.Secret]:
        """
        Build an set of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def setBuilder(cls) -> Union[SetBuilder[GenaiCore.Llm.Auth.Secret]]:
        """
        Creates a set of instances of this type.
        """
            ...
        @classmethod
        def mapBuilder(cls) -> Union[MapBuilder[str, GenaiCore.Llm.Auth.Secret]]:
        """
        Create a map of string to elements of this type.
        """
            ...
        @classmethod
        def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, GenaiCore.Llm.Auth.Secret]]:
        """
        Create a map with the given key type and elements of this type.
        """
            ...
        ...
        def myStreamType(cls) -> StreamType:
            ...
        def toBuilder(self) -> ObjBuilder[GenaiCore.Llm.Auth.Secret]:
        """
        @return new ObjBuilder with initial state set to fields of this instance.
        """
            ...
        @classmethod
        def builder(cls) -> ObjBuilder[GenaiCore.Llm.Auth.Secret]:
        """
        @return new ObjBuilder of this instance.
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> GenaiCore.Llm.Auth.Secret:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> GenaiCore.Llm.Auth.Secret:
        """
        Construct an instance of this type from provided fields
        @param fields
                   Fields to construct the instance of the obj with
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> GenaiCore.Llm.Auth.Secret:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def make(cls, withDefaults: bool=None) -> GenaiCore.Llm.Auth.Secret:
        """
        Construct an instance of this type with no non-default field values unless explicitly specified by passing param true
        @param withDefaults
                   If set, then the Obj is made with default & initial values (required primitive fields e.g. !int32 -> 0)
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> GenaiCore.Llm.Auth.Secret:
        """
        Construct an instance from provided fields
        @param fields
                   Fields (in the format <field_name, value>) to construct an instance of the obj. Note that "type" as a
        ...
        @overload
        @classmethod
        def make(cls, fields: Any, withDefaults: bool=None) -> GenaiCore.Llm.Auth.Secret:
        """
        Construct an instance of this type from provided fields. Note it is more efficient to use #fromFields and other overloads
        ...
        @overload
        @classmethod
        def make(cls, s: str) -> Union[GenaiCore.Llm.Auth.Secret]:
        """
        Construct an instance of this type from the string. This is an alias for #fromString, as a specific overload
        when the argument is a known string.
        ...
        """
            ...
        @classmethod
        def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> GenaiCore.Llm.Auth.Secret:
        """
        Construct an instance of this type from provided instance of a subtype or a "duck type".
        """
            ...
        ...
        """
            ...
        def afterMake(self) -> GenaiCore.Llm.Auth.Secret:
        """
        Optional override that will be called after every instance creation.
        ...
        """
            ...
        @classmethod
        def cachedEmptyInst(cls) -> GenaiCore.Llm.Auth.Secret:
        """
        Creates an empty inst using `MyType.make()` and caches it. Avoid recreating multiple copies of the spec for
        every action dispatch. The cached inst can also be used for comparing whether the object is an empty or not
        Will only create empty instance for immutable Obj e.g. if an Obj is Mutable, this method will throw an error
        ...
        """
            ...
        @classmethod
        def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[GenaiCore.Llm.Auth.Secret]]:
        """
        Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
        value is read.
        """
            ...
        @classmethod
        def generateObj(cls, spec: Obj.GenerateSpec=None) -> GenaiCore.Llm.Auth.Secret:
        """
        Generate a single instance of this type. The base implementation uses {@link DataGenObj} to generate uniform
        random (gibberish) values for all fields, but it may be overridden by specific types with custom logic that
        populates fields in a more realistic way.
        ...
        """
            ...
        @classmethod
        def fromString(cls, s: str) -> Union[GenaiCore.Llm.Auth.Secret]:
        """
        Parse the string-based representation and reconstruct the corresponding instance. This must be implemented to
        provide deserialization.
        ...
        """
            ...
        @classmethod
        def forName(cls, name: str, failIfMissing: bool=None) -> Union[GenaiCore.Llm.Auth.Secret]:
        """
        @return single instance of this Nameable type by name. Note that if this type is also Cached then it will
        retrieve instance from cache.
        """
        ...
        """
            ...
        @classmethod
        def allCached(cls) -> Union[Stream[GenaiCore.Llm.Auth.Secret]]:
        """
        @return stream of all available Cached instances.
        """
            ...
        @classmethod
        def find(cls, filter: str=None) -> Union[Stream[GenaiCore.Llm.Auth.Secret]]:
        """
        @return existing instances of this type that satisfy filter from data cache. Will call `produceAll`
                if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
                Otherwise no population will be performed.
        """
            ...
        @classmethod
        def findBy(cls, field: str, value: Any) -> Union[Stream[GenaiCore.Llm.Auth.Secret]]:
        """
        @return existing instances of this type that satisfy filter from data cache. Will call `produceAll`
                if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
                Otherwise no population will be performed.
        """
            ...
        def getCached(self) -> Union[GenaiCore.Llm.Auth.Secret]:
        """
        @return cached instance.
        """
            ...
        @classmethod
        def forCacheKey(cls, key: str) -> Union[GenaiCore.Llm.Auth.Secret]:
        """
        Returns cached instance by key, with secrets removed.
        """
            ...
        ...
        """
            ...
        @classmethod
        def produce(cls, key: str) -> Union[GenaiCore.Llm.Auth.Secret]:
        """
        Should produce an entry for the cache key. This method should not be called directly.
        """
            ...
        @classmethod
        def produceAll(cls) -> Union[Map[str, GenaiCore.Llm.Auth.Secret]]:
        """
        Should produces the entire content for the cached data. Will populate the cache with the produced data.
        """
            ...
        ...
        """
            ...
        def getConfig(self) -> GenaiCore.Llm.Auth.Secret:
        """
        Return cached instance of configuration. For Identifiable configurations `id` field is required. For Nameable
        configurations `name` field is required.
        ...
        """
            ...
        def getSecret(self) -> GenaiCore.Llm.Auth.Secret:
        """
        Return cached instance of configuration containing only secret values. For Identifiable configuration, `id` field
        is required. For Nameable configurations `name` field is required.
        ...
        """
            ...
        def withConfigKey(self, configKey: str) -> GenaiCore.Llm.Auth.Secret:
        """
        @return copy of the config with updated `id` if {@link Indentifiable} or `name` if {@link Nameable}, hence changing
        the computed {@link Config#configKey}.
        Note that configs set at USER level will still have user's Id as part of the config key. Config types with
        ...
        """
            ...
        def withoutConfigKey(self) -> GenaiCore.Llm.Auth.Secret:
        """
        @return copy without config key.
        """
            ...
        @classmethod
        def forConfigKey(cls, configKey: str) -> Union[GenaiCore.Llm.Auth.Secret]:
        """
        @return return cached config instance for provided config key.
        """
            ...
        ...
        """
            ...
        @classmethod
        def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[GenaiCore.Llm.Auth.Secret]]:
        """
        @param
        ...
        """
            ...
        @overload
        def setConfigValues(self, from_: GenaiCore.Llm.Auth.Secret, override: str=None) -> None:
        """
        Sets multiple field values to the be the same as the passed instance.
        ...
        """
            ...
        @classmethod
        def loadConfigAndSecret(cls, configKey: str) -> Union[GenaiCore.Llm.Auth.Secret]:
        """
         Loads config and secret by key if exists, default config, or `null` if `doNotDefaultIfMissing` config annotation is
        true and config does not exist.
         Note that this skips caching and directly fetches config from the config store, and secret from vault.
        ...
        """
            ...
        def removeSecrets(self) -> Union[GenaiCore.Llm.Auth.Secret]:
        """
        @return this config without any secret values.
        """
            ...
        def removeNonSecrets(self) -> Union[GenaiCore.Llm.Auth.Secret]:
        """
        @return this config with only secret values.
        """
            ...
        def validate(self) -> GenaiCore.Llm.Auth.Secret:
        """
        Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
        validation and setup.
        """
        ...
        """
            ...
        @classmethod
        def forAuthConfig(cls, cfg: GenaiCore.Llm.Auth) -> GenaiCore.Llm.Auth.Secret:
        """
        Given an instance of a concrete {@link GenaiCore.Llm.Auth} type, return the #name corresponding for the GenaiCore.Llm.Auth.Secret instance.
        
        @param cfg
                 concrete auth instance.
        @return the secret corresponding to the auth instance.
        """
            ...
        @classmethod
        def getSecretValueForConfig(cls, cfg: GenaiCore.Llm.Auth) -> any:
        """
        Given an instance of a concrete {@link GenaiCore.Llm.Auth} type, return the #authSecret.
        
        @param cfg
                 concrete auth instance.
        @return the secret value corresponding to the auth instance.
        """
            ...
        @classmethod
        def setSecretValueForConfig(cls, cfg: GenaiCore.Llm.Auth, override: str=None) -> None:
        """
        Set the {@link GenaiCore.Llm.Auth.Secret} instance for the given concrete {@link GenaiCore.Llm.Auth}.
        
        @param cfg
                 concrete auth instance to set.
        @param override
                 override level to set the auth instance for.
        """
            ...
        @classmethod
        def clearSecretValueForConfig(cls, cfg: GenaiCore.Llm.Auth, override: str=None) -> None:
        """
        Clear the secret value for the given config instance and override.
        
        @param cfg
                 concrete auth instance to clear.
        @param override
                 override level to clear the auth instance for.
        """
            ...
        @classmethod
        def clearSecretValueForConfigAllOverrides(cls, cfg: GenaiCore.Llm.Auth) -> None:
        """
        Clear the secret value for the given config instance and all overrides.
        ...
        """
            ...
        @classmethod
        def clearAllConfigAndSecretOverridesForAuthType(cls, authType: Type, override: str, confirm: bool=None) -> None:
        """
        Clear the secret value for all configs of the given type at the specified override.
        
        @param authType
                 clear all the secret values on this auth type.
        @param override
                 override level to clear the secrets for.
        @param confirm
                 set to `true` to confirm the operation.
        """
            ...
