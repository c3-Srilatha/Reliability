...
from c3.genaiPlatform.GenaiCore.Tool.C3Method.Spec import GenaiCore.Tool.C3Method.Spec
...
# Python definitions for the C3 type GenaiCore.Tool.C3MemberMethod


class C3MemberMethod(GenaiCore.Tool.C3Method):
    """
    A subtype of {@link GenaiCore.Tool.C3Method} that wraps a member method on an instance
    
    @remarks this represents a made instance of GenaiCore.Tool.C3MemberMethod
    """
    ...
    """
    The tool will invoke #call and #func on this instance.
    """

    instantiationMethod: Optional[str]
    """
    Indicates how {@link GenaiCore.Tool.C3MemberMethod#instance} should be instantiated for use.
    By default,
         * {@link Persistable} (entity) instances will be instantiated via `forId`
         * {@link Engine} instances will be instantiated via `forName`
         * All other instances will be instantiated via `make` using the full instance json at the time
           {@link GenaiCore.Tool.C3MemberMethod#createFromMethodType} was called)
    """
    def __init__(self, name: Optional[str]=None, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, userUpdatedFields: Optional[Array[str]]=None, hidden: Optional[bool]=None, userOwned: Optional[bool]=None, typeIdent: Optional[str]=None, isPublished: Optional[bool]=None, initKwargs: Optional[any]=None, description: Optional[str]=None, descriptionForLlm: Optional[str]=None, argsSchema: Optional[any]=None, outputPyType: Optional[any]=None, methodType: Optional[MethodTypeRef]=None, standaloneFuncCode: Optional[str]=None, instance: Optional[Obj]=None, instantiationMethod: Optional[str]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[GenaiCore.Tool.C3MemberMethod]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[GenaiCore.Tool.C3MemberMethod]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[GenaiCore.Tool.C3MemberMethod]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[GenaiCore.Tool.C3MemberMethod]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[GenaiCore.Tool.C3MemberMethod]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[GenaiCore.Tool.C3MemberMethod]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> GenaiCore.Tool.C3MemberMethod:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> GenaiCore.Tool.C3MemberMethod:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> GenaiCore.Tool.C3MemberMethod:
    """
    @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> GenaiCore.Tool.C3MemberMethod:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> GenaiCore.Tool.C3MemberMethod:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> GenaiCore.Tool.C3MemberMethod:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> GenaiCore.Tool.C3MemberMethod:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> GenaiCore.Tool.C3MemberMethod:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[GenaiCore.Tool.C3MemberMethod]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[GenaiCore.Tool.C3MemberMethod]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[GenaiCore.Tool.C3MemberMethod]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[GenaiCore.Tool.C3MemberMethod]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[GenaiCore.Tool.C3MemberMethod]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, GenaiCore.Tool.C3MemberMethod]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, GenaiCore.Tool.C3MemberMethod]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[GenaiCore.Tool.C3MemberMethod]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[GenaiCore.Tool.C3MemberMethod]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> GenaiCore.Tool.C3MemberMethod:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[GenaiCore.Tool.C3MemberMethod]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    """
        ...
    def afterMake(self) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[GenaiCore.Tool.C3MemberMethod]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls) -> Union[Stream[GenaiCore.Tool.C3MemberMethod]]:
    """
    @return stream of all available Cached instances.
    """
        ...
    @classmethod
    def find(cls, filter: str=None) -> Union[Stream[GenaiCore.Tool.C3MemberMethod]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any) -> Union[Stream[GenaiCore.Tool.C3MemberMethod]]:
    """
    @return existing instances of this type that satisfy filter from data cache. Will call `produceAll`
            if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
            Otherwise no population will be performed.
    """
        ...
    def getCached(self) -> Union[GenaiCore.Tool.C3MemberMethod]:
    """
    @return cached instance.
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[GenaiCore.Tool.C3MemberMethod]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[GenaiCore.Tool.C3MemberMethod]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, GenaiCore.Tool.C3MemberMethod]]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[GenaiCore.Tool.C3MemberMethod]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[GenaiCore.Tool.C3MemberMethod]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[GenaiCore.Tool.C3MemberMethod]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[GenaiCore.Tool.C3MemberMethod]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[GenaiCore.Tool.C3MemberMethod]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[GenaiCore.Tool.C3MemberMethod]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[GenaiCore.Tool.C3MemberMethod]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[GenaiCore.Tool.C3MemberMethod]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[GenaiCore.Tool.C3MemberMethod]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[GenaiCore.Tool.C3MemberMethod], spec: UpsertSpec=None) -> Union[ObjList[GenaiCore.Tool.C3MemberMethod]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[GenaiCore.Tool.C3MemberMethod], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[GenaiCore.Tool.C3MemberMethod]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: GenaiCore.Tool.C3MemberMethod=None, spec: UpsertSpec=None) -> Union[GenaiCore.Tool.C3MemberMethod]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: GenaiCore.Tool.C3MemberMethod=None, spec: UpsertSpec=None) -> Union[GenaiCore.Tool.C3MemberMethod]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[GenaiCore.Tool.C3MemberMethod]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[GenaiCore.Tool.C3MemberMethod]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[GenaiCore.Tool.C3MemberMethod]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[GenaiCore.Tool.C3MemberMethod], srcObjs: Array[GenaiCore.Tool.C3MemberMethod]=None, spec: UpsertSpec=None) -> Union[ObjList[GenaiCore.Tool.C3MemberMethod]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[GenaiCore.Tool.C3MemberMethod]]], spec: UpsertSpec=None) -> Union[ObjList[GenaiCore.Tool.C3MemberMethod]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[GenaiCore.Tool.C3MemberMethod], srcObjs: Array[GenaiCore.Tool.C3MemberMethod]=None, spec: UpsertSpec=None) -> Union[ObjList[GenaiCore.Tool.C3MemberMethod]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[GenaiCore.Tool.C3MemberMethod]]], spec: UpsertSpec=None) -> Union[ObjList[GenaiCore.Tool.C3MemberMethod]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[GenaiCore.Tool.C3MemberMethod], spec: TouchSpec=None) -> Union[ObjList[GenaiCore.Tool.C3MemberMethod]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[GenaiCore.Tool.C3MemberMethod], spec: MergeSpec=None) -> Union[ObjList[GenaiCore.Tool.C3MemberMethod]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[GenaiCore.Tool.C3MemberMethod], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[GenaiCore.Tool.C3MemberMethod]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[GenaiCore.Tool.C3MemberMethod]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[GenaiCore.Tool.C3MemberMethod]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: GenaiCore.Tool.C3MemberMethod, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: GenaiCore.Tool.C3MemberMethod, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[GenaiCore.Tool.C3MemberMethod], spec: UpsertSpec=None) -> Union[ObjList[GenaiCore.Tool.C3MemberMethod]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[GenaiCore.Tool.C3MemberMethod], spec: UpsertSpec=None) -> Union[ObjList[GenaiCore.Tool.C3MemberMethod]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[GenaiCore.Tool.C3MemberMethod]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[GenaiCore.Tool.C3MemberMethod]) -> ObjList[GenaiCore.Tool.C3MemberMethod]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[GenaiCore.Tool.C3MemberMethod]) -> ObjList[GenaiCore.Tool.C3MemberMethod]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[GenaiCore.Tool.C3MemberMethod]) -> ObjList[GenaiCore.Tool.C3MemberMethod]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[GenaiCore.Tool.C3MemberMethod]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[GenaiCore.Tool.C3MemberMethod]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[GenaiCore.Tool.C3MemberMethod]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[GenaiCore.Tool.C3MemberMethod]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[GenaiCore.Tool.C3MemberMethod]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[GenaiCore.Tool.C3MemberMethod]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[GenaiCore.Tool.C3MemberMethod]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[GenaiCore.Tool.C3MemberMethod]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: GenaiCore.Tool.C3MemberMethod=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[GenaiCore.Tool.C3MemberMethod], callback: Callable[[Union[GenaiCore.Tool.C3MemberMethod]], Union[GenaiCore.Tool.C3MemberMethod]]=None) -> ObjList[GenaiCore.Tool.C3MemberMethod]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[GenaiCore.Tool.C3MemberMethod], callback: Callable[[Union[GenaiCore.Tool.C3MemberMethod]], Union[GenaiCore.Tool.C3MemberMethod]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    def publish(self, subPath: str=None, contentType: str=None) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    """
        ...
    @classmethod
    def removeSeedDataBatch(cls, objs: Array[SeedData]=None, spec: UpsertSpec=None) -> Union[ObjList[GenaiCore.Tool.C3MemberMethod]]:
    """
    ...
    """
        ...
    def createSeedData(self, spec: UpsertSpec=None) -> Union[GenaiCore.Tool.C3MemberMethod]:
    """
    ...
    """
        ...
    @classmethod
    def createSeedDataBatch(cls, objs: Array[SeedData]=None, spec: UpsertSpec=None) -> Union[ObjList[GenaiCore.Tool.C3MemberMethod]]:
    """
    ...
    """
        ...
    def updateSeedData(self, srcObj: SeedData=None, spec: UpsertSpec=None) -> Union[GenaiCore.Tool.C3MemberMethod]:
    """
    ...
    """
        ...
    @classmethod
    def updateSeedDataBatch(cls, objs: Array[SeedData]=None, srcObjs: Array[SeedData]=None, spec: UpsertSpec=None) -> Union[ObjList[GenaiCore.Tool.C3MemberMethod]]:
    """
    ...
    """
        ...
    def clearUserUpdates(self, spec: MergeSpec=None) -> Union[GenaiCore.Tool.C3MemberMethod]:
    """
    ...
    """
        ...
    @classmethod
    def clearUserUpdatesBatch(cls, objs: Array[SeedData]=None, spec: MergeSpec=None) -> Union[ObjList[GenaiCore.Tool.C3MemberMethod]]:
    """
    ...
    """
        ...
    def dependencies(self) -> Union[SeedDataDeps[GenaiCore.Tool.C3MemberMethod]]:
        ...
    ...
    **NOTE** this method can only be invoked from Python.
    ...
    """
        ...
    @classmethod
    def createFromMethodName(cls, type: Type, methodName: str, spec: GenaiCore.Tool.C3Method.Spec=None) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    **NOTE**: If the method has more than one overload, then {@link GenaiCore.Tool.C3Method.Spec#overload}
    ...
    """
        ...
    @classmethod
    def createFromMethodType(cls, methodTypeRef: MethodTypeRef, spec: GenaiCore.Tool.C3Method.Spec=None) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    """
        ...
    @classmethod
    def doCreateFromMethodType(cls, methodTypeRef: MethodTypeRef, calleeInstantiator: str, spec: GenaiCore.Tool.C3Method.Spec=None) -> GenaiCore.Tool.C3MemberMethod:
    """
    ...
    """
        ...
    @classmethod
    def createFromObjAndMethodName(cls, instance: Obj, methodName: str, spec: GenaiCore.Tool.C3MemberMethod.Spec=None) -> GenaiCore.Tool.C3MemberMethod:
    """
    Given an instance and method, return a corresponding C3MemberMethod tool instance.
    **NOTE**: If the method has more than one overload, then GenaiCore.Tool.C3MemberMethod.Spec#overload must be specified.
    ...
    """
        ...
    @classmethod
    def createFromObjAndMethodType(cls, instance: Obj, methodTypeRef: MethodTypeRef, spec: GenaiCore.Tool.C3MemberMethod.Spec=None) -> GenaiCore.Tool.C3MemberMethod:
    """
    Given a {@link MethodType}, return a corresponding C3MemberMethod tool instance.
    ...
    class Spec(GenaiCore.Tool.C3Method.Spec):
        """
        A subtype of {@link GenaiCore.Tool.C3Method.Spec} to add additional
        fields specific to {@link GenaiCore.Tool.C3MemberMethod}
        
        @remarks this represents a made instance of GenaiCore.Tool.C3MemberMethod.Spec
        """
        ...
        instantiationMethod: Optional[str]=None
        """
        Indicates how {@link GenaiCore.Tool.C3MemberMethod#instance} should be instantiated for use.
        By default,
             * {@link Persistable} (entity) instances will be instantiated via `forId`
        ...
        This field is **optional** and is only necessary if you want to override the default behavior described above.
        """
        def __init__(self, toolId: Optional[str]=None, skipValidation: Optional[bool]=None, overload: Optional[int]=None, doNotUpsert: Optional[bool]=None, instantiationMethod: Optional[str]=None) -> None: ...
        ...
        """
            ...
        @classmethod
        def fromJson(cls, json: any) -> Union[GenaiCore.Tool.C3MemberMethod.Spec]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromJsonString(cls, json: str) -> Union[GenaiCore.Tool.C3MemberMethod.Spec]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromXmlString(cls, xml: str) -> Union[GenaiCore.Tool.C3MemberMethod.Spec]:
        """
        Load the XML-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def deserialize(cls, contentStr: str, contentType: str) -> Union[GenaiCore.Tool.C3MemberMethod.Spec]:
        """
        Load from contentType representation and reconstruct the corresponding object.
        ...
        """
            ...
        def replaceType(self, old: Type, new: Type) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Returns new instance with all references to old type, including result of #type, replaced with new type. If new
        type does not contain fields from old or field value types are not convertable then drops the field.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[GenaiCore.Tool.C3MemberMethod.Spec]:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the asynchronous `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[GenaiCore.Tool.C3MemberMethod.Spec]:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        asynchronous `mapper` invocation.
        ...
        """
            ...
        def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Result of this function call is a copy of current instance with specified field value replaced based on result of
        the `mapper` invocation.
        @param field
        ...
        """
            ...
        @overload
        def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def validateObj(self) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Populates all missing default values and throws error if any constraint is violated.
        """
            ...
        ...
        """
            ...
        @overload
        def withField(self, field: str, value: Any, doNotConvert: bool=None) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        @overload
        def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Builds a new Obj instance by adding the provided fields in it. The name must correspond to an existing fields
        defined on this type or its mixins. The values must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Builds a new Obj with the value at the specified path field. If the field is null, the field #isFieldSet to null.
        If you would like to #unsetField, you should call #withoutFieldAtPath instead.
        ...
        """
            ...
        def withoutFieldAtPath(self, path: str) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Builds a new Obj without the specified path field.
        ...
        """
            ...
        @overload
        def withoutField(self, field: str) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Builds a new Obj, removing the field with the provided name.
        ...
        """
            ...
        @overload
        def withoutField(self, field: FieldType) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Builds a new Obj, removing the field with the provided field type.
        ...
        """
            ...
        def withoutFields(self, fields: Array[str]) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Builds a new Obj, removing the fields with the provided names.
        ...
        """
            ...
        def withoutFieldsByType(self, fields: Array[FieldType]) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Builds a new Obj, removing the fields with the provided field types. Be sure to use the FieldType instance for the
        exact same type as the type of the obj to respect the "ordinal" of the field type
        ...
        """
            ...
        def withoutSecretFields(self) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
        """
            ...
        def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Builds a new Obj instance by adding the default values (if defined) for all unset fields. This is implemented by
        calling {@link FieldType#defaultValue defaultValue} for a field if it is not already set and
        {@link FieldType#hasDefault has a default}. It will also set {@see ValueType#initialValue initial values} for
        ...
        """
            ...
        @overload
        def defaultField(self, field: str) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Builds a new Obj, by setting a field on this `Obj` to the field's default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def defaultField(self, field: FieldType) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Builds a new Obj, by setting a field on this `Obj` to the fields default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def unsetField(self, field: str) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def unsetField(self, field: FieldType) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def removeField(self, field: str) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def removeField(self, field: FieldType) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence unless otherwise specified by the fieldPathMergeSpec
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence.
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist on other Obj and do not exist on this Obj will not be added to final Obj.
        @param deep
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist other Obj and do not exist on this Obj will not be added to final Obj or evaluated. Does not
        traverse child reference and collection fields.
        ...
        """
            ...
        def mergeJson(self, json: any) -> GenaiCore.Tool.C3MemberMethod.Spec:
            ...
        def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Merge the obj references within the current obj
        @param deep
               If set, traverses the reference fields within the obj as well for a deep merge
        ...
        """
            ...
        def sumObj(self, other: Obj, deep: bool=None) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Adds the numeric Obj fields with the other Objs respective fields.
        If deep is set it will traverse reference and collection fields and sum corresponding numeric fields in
        references with same name and collection elements at same index or key.
        """
            ...
        def singletonArray(self) -> Array[GenaiCore.Tool.C3MemberMethod.Spec]:
        """
        Build an array of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def array(cls, *elements: Array[Any]) -> Union[Array[GenaiCore.Tool.C3MemberMethod.Spec]]:
        """
        Creates an array of instances of this type.
        """
            ...
        @classmethod
        def arrayBuilder(cls) -> Union[ArrayBuilder[GenaiCore.Tool.C3MemberMethod.Spec]]:
        """
        Creates an array of instances of this type.
        """
            ...
        def singletonSet(self) -> Set[GenaiCore.Tool.C3MemberMethod.Spec]:
        """
        Build an set of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def setBuilder(cls) -> Union[SetBuilder[GenaiCore.Tool.C3MemberMethod.Spec]]:
        """
        Creates a set of instances of this type.
        """
            ...
        @classmethod
        def mapBuilder(cls) -> Union[MapBuilder[str, GenaiCore.Tool.C3MemberMethod.Spec]]:
        """
        Create a map of string to elements of this type.
        """
            ...
        @classmethod
        def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, GenaiCore.Tool.C3MemberMethod.Spec]]:
        """
        Create a map with the given key type and elements of this type.
        """
            ...
        ...
        def myStreamType(cls) -> StreamType:
            ...
        def toBuilder(self) -> ObjBuilder[GenaiCore.Tool.C3MemberMethod.Spec]:
        """
        @return new ObjBuilder with initial state set to fields of this instance.
        """
            ...
        @classmethod
        def builder(cls) -> ObjBuilder[GenaiCore.Tool.C3MemberMethod.Spec]:
        """
        @return new ObjBuilder of this instance.
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Construct an instance of this type from provided fields
        @param fields
                   Fields to construct the instance of the obj with
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def make(cls, withDefaults: bool=None) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Construct an instance of this type with no non-default field values unless explicitly specified by passing param true
        @param withDefaults
                   If set, then the Obj is made with default & initial values (required primitive fields e.g. !int32 -> 0)
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Construct an instance from provided fields
        @param fields
                   Fields (in the format <field_name, value>) to construct an instance of the obj. Note that "type" as a
        ...
        @overload
        @classmethod
        def make(cls, fields: Any, withDefaults: bool=None) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Construct an instance of this type from provided fields. Note it is more efficient to use #fromFields and other overloads
        ...
        """
            ...
        @classmethod
        def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Construct an instance of this type from provided instance of a subtype or a "duck type".
        """
            ...
        ...
        """
            ...
        def afterMake(self) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Optional override that will be called after every instance creation.
        ...
        """
            ...
        @classmethod
        def cachedEmptyInst(cls) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Creates an empty inst using `MyType.make()` and caches it. Avoid recreating multiple copies of the spec for
        every action dispatch. The cached inst can also be used for comparing whether the object is an empty or not
        Will only create empty instance for immutable Obj e.g. if an Obj is Mutable, this method will throw an error
        ...
        """
            ...
        @classmethod
        def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[GenaiCore.Tool.C3MemberMethod.Spec]]:
        """
        Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
        value is read.
        """
            ...
        @classmethod
        def generateObj(cls, spec: Obj.GenerateSpec=None) -> GenaiCore.Tool.C3MemberMethod.Spec:
        """
        Generate a single instance of this type. The base implementation uses {@link DataGenObj} to generate uniform
        random (gibberish) values for all fields, but it may be overridden by specific types with custom logic that
        populates fields in a more realistic way.
