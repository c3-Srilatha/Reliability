...
from c3.genaiPlatform.GenaiCore.Agent.DeploySpec import GenaiCore.Agent.DeploySpec
...
from c3.genaiPlatform.GenaiCore.Tool import GenaiCore.Tool
...
from c3.genaiPlatform.GenaiCore.Agent.Draft import GenaiCore.Agent.Draft
...
from c3.genaiPlatform.GenaiCore.Agent.CreateDraftSpec import GenaiCore.Agent.CreateDraftSpec
...
from c3.genaiPlatform.GenaiCore.Agent import GenaiCore.Agent
...
from c3.genaiPlatform.GenaiCore.Agent.Deployment import GenaiCore.Agent.Deployment
...
from c3.genaiPlatform.GenaiCore.Agent.InitSpec import GenaiCore.Agent.InitSpec
from c3.platform.VersionEdit import VersionEdit
from c3.platform.ExistsSpec import ExistsSpec

# Python definitions for the C3 type GenaiCore.Agent.FunctionCalling


class FunctionCalling(GenaiCore.Agent):
    """
    Abstract base type for function calling agents
    
    Currently supports:
    - {@link GenaiCore.Agent.LlamaIndex}
    
    @remarks this represents a made instance of GenaiCore.Agent.FunctionCalling
    """
    ...
    NOTE: this is not the same as the description that is set on {@link GenaiCore.Agent.Draft} during {@link #createDraft}, and
    it is also not the same as the description that is set on {@link GenaiCore.Agent.Deployment} during {@link #deploy}!
    """

    systemPrompt: Optional[str]=None
    """
    System prompt used to define the behavior of this agent.
    """

    llmClient: Optional[GenaiCore.Llm.Client]=None
    """
    {@link Llm client GenaiCore.Llm.Client} that manages auth, routing strategy, configurations, etc.
    """

    tools: Optional[Array[Union[GenaiCore.Tool,GenaiCore.Toolkit]]]=None
    """
    {@link Toolkit GenaiCore.Toolkit} used by this agent. Note that it could be nested, use {@link GenaiCore.Toolkit#allTools} to get all tools available.
    """

    shortTermMemoryStore: Optional[GenaiCore.SessionStore]=None
    """
    {@link Session store GenaiCore.SessionStore} used by this agent, for short term memory only.
    """
    def __init__(self, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, userUpdatedFields: Optional[Array[str]]=None, hidden: Optional[bool]=None, userOwned: Optional[bool]=None, typeIdent: Optional[str]=None, description: Optional[str]=None, systemPrompt: Optional[str]=None, llmClient: Optional[GenaiCore.Llm.Client]=None, tools: Optional[Array[Union[GenaiCore.Tool,GenaiCore.Toolkit]]]=None, shortTermMemoryStore: Optional[GenaiCore.SessionStore]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[GenaiCore.Agent.FunctionCalling]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[GenaiCore.Agent.FunctionCalling]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[GenaiCore.Agent.FunctionCalling]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[GenaiCore.Agent.FunctionCalling]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[GenaiCore.Agent.FunctionCalling]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[GenaiCore.Agent.FunctionCalling]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> GenaiCore.Agent.FunctionCalling:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> GenaiCore.Agent.FunctionCalling:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> GenaiCore.Agent.FunctionCalling:
    """
    @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> GenaiCore.Agent.FunctionCalling:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> GenaiCore.Agent.FunctionCalling:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> GenaiCore.Agent.FunctionCalling:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> GenaiCore.Agent.FunctionCalling:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> GenaiCore.Agent.FunctionCalling:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[GenaiCore.Agent.FunctionCalling]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[GenaiCore.Agent.FunctionCalling]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[GenaiCore.Agent.FunctionCalling]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[GenaiCore.Agent.FunctionCalling]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[GenaiCore.Agent.FunctionCalling]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, GenaiCore.Agent.FunctionCalling]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, GenaiCore.Agent.FunctionCalling]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[GenaiCore.Agent.FunctionCalling]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[GenaiCore.Agent.FunctionCalling]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> GenaiCore.Agent.FunctionCalling:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[GenaiCore.Agent.FunctionCalling]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    """
        ...
    def afterMake(self) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[GenaiCore.Agent.FunctionCalling]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls) -> Union[Stream[GenaiCore.Agent.FunctionCalling]]:
    """
    @return stream of all available Cached instances.
    """
        ...
    @classmethod
    def find(cls, filter: str=None) -> Union[Stream[GenaiCore.Agent.FunctionCalling]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any) -> Union[Stream[GenaiCore.Agent.FunctionCalling]]:
    """
    @return existing instances of this type that satisfy filter from data cache. Will call `produceAll`
            if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
            Otherwise no population will be performed.
    """
        ...
    def getCached(self) -> Union[GenaiCore.Agent.FunctionCalling]:
    """
    @return cached instance.
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[GenaiCore.Agent.FunctionCalling]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[GenaiCore.Agent.FunctionCalling]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, GenaiCore.Agent.FunctionCalling]]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[GenaiCore.Agent.FunctionCalling]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[GenaiCore.Agent.FunctionCalling]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[GenaiCore.Agent.FunctionCalling]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[GenaiCore.Agent.FunctionCalling]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[GenaiCore.Agent.FunctionCalling]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[GenaiCore.Agent.FunctionCalling]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[GenaiCore.Agent.FunctionCalling]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[GenaiCore.Agent.FunctionCalling]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[GenaiCore.Agent.FunctionCalling]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[GenaiCore.Agent.FunctionCalling], spec: UpsertSpec=None) -> Union[ObjList[GenaiCore.Agent.FunctionCalling]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[GenaiCore.Agent.FunctionCalling], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[GenaiCore.Agent.FunctionCalling]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: GenaiCore.Agent.FunctionCalling=None, spec: UpsertSpec=None) -> Union[GenaiCore.Agent.FunctionCalling]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: GenaiCore.Agent.FunctionCalling=None, spec: UpsertSpec=None) -> Union[GenaiCore.Agent.FunctionCalling]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[GenaiCore.Agent.FunctionCalling]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[GenaiCore.Agent.FunctionCalling]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[GenaiCore.Agent.FunctionCalling]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[GenaiCore.Agent.FunctionCalling], srcObjs: Array[GenaiCore.Agent.FunctionCalling]=None, spec: UpsertSpec=None) -> Union[ObjList[GenaiCore.Agent.FunctionCalling]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[GenaiCore.Agent.FunctionCalling]]], spec: UpsertSpec=None) -> Union[ObjList[GenaiCore.Agent.FunctionCalling]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[GenaiCore.Agent.FunctionCalling], srcObjs: Array[GenaiCore.Agent.FunctionCalling]=None, spec: UpsertSpec=None) -> Union[ObjList[GenaiCore.Agent.FunctionCalling]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[GenaiCore.Agent.FunctionCalling]]], spec: UpsertSpec=None) -> Union[ObjList[GenaiCore.Agent.FunctionCalling]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[GenaiCore.Agent.FunctionCalling], spec: TouchSpec=None) -> Union[ObjList[GenaiCore.Agent.FunctionCalling]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[GenaiCore.Agent.FunctionCalling], spec: MergeSpec=None) -> Union[ObjList[GenaiCore.Agent.FunctionCalling]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[GenaiCore.Agent.FunctionCalling], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[GenaiCore.Agent.FunctionCalling]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[GenaiCore.Agent.FunctionCalling]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[GenaiCore.Agent.FunctionCalling]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: GenaiCore.Agent.FunctionCalling, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: GenaiCore.Agent.FunctionCalling, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[GenaiCore.Agent.FunctionCalling], spec: UpsertSpec=None) -> Union[ObjList[GenaiCore.Agent.FunctionCalling]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[GenaiCore.Agent.FunctionCalling], spec: UpsertSpec=None) -> Union[ObjList[GenaiCore.Agent.FunctionCalling]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[GenaiCore.Agent.FunctionCalling]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[GenaiCore.Agent.FunctionCalling]) -> ObjList[GenaiCore.Agent.FunctionCalling]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[GenaiCore.Agent.FunctionCalling]) -> ObjList[GenaiCore.Agent.FunctionCalling]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[GenaiCore.Agent.FunctionCalling]) -> ObjList[GenaiCore.Agent.FunctionCalling]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[GenaiCore.Agent.FunctionCalling]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[GenaiCore.Agent.FunctionCalling]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[GenaiCore.Agent.FunctionCalling]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[GenaiCore.Agent.FunctionCalling]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[GenaiCore.Agent.FunctionCalling]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[GenaiCore.Agent.FunctionCalling]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[GenaiCore.Agent.FunctionCalling]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[GenaiCore.Agent.FunctionCalling]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: GenaiCore.Agent.FunctionCalling=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[GenaiCore.Agent.FunctionCalling], callback: Callable[[Union[GenaiCore.Agent.FunctionCalling]], Union[GenaiCore.Agent.FunctionCalling]]=None) -> ObjList[GenaiCore.Agent.FunctionCalling]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[GenaiCore.Agent.FunctionCalling], callback: Callable[[Union[GenaiCore.Agent.FunctionCalling]], Union[GenaiCore.Agent.FunctionCalling]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    def publish(self, subPath: str=None, contentType: str=None) -> GenaiCore.Agent.FunctionCalling:
    """
    ...
    """
        ...
    @classmethod
    def removeSeedDataBatch(cls, objs: Array[SeedData]=None, spec: UpsertSpec=None) -> Union[ObjList[GenaiCore.Agent.FunctionCalling]]:
    """
    ...
    """
        ...
    def createSeedData(self, spec: UpsertSpec=None) -> Union[GenaiCore.Agent.FunctionCalling]:
    """
    ...
    """
        ...
    @classmethod
    def createSeedDataBatch(cls, objs: Array[SeedData]=None, spec: UpsertSpec=None) -> Union[ObjList[GenaiCore.Agent.FunctionCalling]]:
    """
    ...
    """
        ...
    def updateSeedData(self, srcObj: SeedData=None, spec: UpsertSpec=None) -> Union[GenaiCore.Agent.FunctionCalling]:
    """
    ...
    """
        ...
    @classmethod
    def updateSeedDataBatch(cls, objs: Array[SeedData]=None, srcObjs: Array[SeedData]=None, spec: UpsertSpec=None) -> Union[ObjList[GenaiCore.Agent.FunctionCalling]]:
    """
    ...
    """
        ...
    def clearUserUpdates(self, spec: MergeSpec=None) -> Union[GenaiCore.Agent.FunctionCalling]:
    """
    ...
    """
        ...
    @classmethod
    def clearUserUpdatesBatch(cls, objs: Array[SeedData]=None, spec: MergeSpec=None) -> Union[ObjList[GenaiCore.Agent.FunctionCalling]]:
    """
    ...
    """
        ...
    def dependencies(self) -> Union[SeedDataDeps[GenaiCore.Agent.FunctionCalling]]:
        ...
    ...
    """
        ...
    def run(self, query: Any=None, kwargs: Map[str, Any]=None) -> Union[Any]:
    """
    Run a query using the agent.
    
    @param query
               query used to run the agent
    @param kwargs
               additional keyword args passed to run the agent
    @return result of running this agent
    """
        ...
    def doRun(self, query: Any=None, kwargs: Map[str, Any]=None) -> Union[Any]:
    """
    This API is the same as {@link #run} and is called from the default implementation of
    {@link #run}. This is the preferred function to override for concrete
    implementations of {@link GenaiCore.Agent}, because {@link #run}
    ...
    """
        ...
    @classmethod
    def uiConfigurableFields(cls) -> Union[Map[str, Any]]:
    """
    @return a map of the agent's fields that are configurable in the UI, with the corresponding values.
    """
        ...
    def createDraft(self, spec: GenaiCore.Agent.CreateDraftSpec=None) -> GenaiCore.Agent.Draft:
    """
    Clone this agent into a draft, for editability.
    NOTE: this will create a new {@link GenaiCore.Agent.Draft} instance and upsert it to the database!
    
    @param spec
             optional params for draft creation.
    @return the created draft.
    """
        ...
    def deploy(self, spec: GenaiCore.Agent.DeploySpec=None) -> GenaiCore.Agent.Deployment:
    """
    Deploy this agent so that it is persistently running and accessible within the app.
    NOTE: this will create a new {@link GenaiCore.Agent.Deployment} instance and upsert it to the database!
    
    @param spec
            optional params for deployment.
    @return the created deployment.
    """
        ...
    def initialize(self, force: bool=None, spec: GenaiCore.Agent.InitSpec=None) -> Union[GenaiCore.Agent]:
    """
    Initialize the agent. Note that this will be no-op if the agent is already initialized.
    
    @param force
               If set to true, force re-initialize this tool.
    @param spec
               Specs to customize the behavior of agent initialization
    """
        ...
