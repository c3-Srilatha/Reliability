...
# Python definitions for the C3 type GenaiCore.PrivilegedAction
...
class PrivilegedAction(Value):
    ...
    @classmethod
    def getSecretInvokeTaskWithAuth(cls, model: GenaiCore.Llm.Model, auth: GenaiCore.Llm.Auth, taskWithAuth: str, kwargs: Any=None) -> Any:
    """
