// TypeScript definitions for the C3 type GenaiCore.Llm.Mock.OtherAuth
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Llm.Mock.OtherAuth
 */
declare namespace GenaiCore.Llm.Mock {
  export interface IOtherAuth {
     ...
     */
    auths?: Array_Type<GenaiCore.Llm.Auth> | Array<IGenaiCore.Llm.Auth>;

    /**
     * The non-secret string.
     */
    nonSecretString?: string;
 ...
 */
declare namespace GenaiCore.Llm.Mock {
  export class OtherAuth extends Obj  {

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): GenaiCore.Llm.Mock.OtherAuth;
    ...
    withConfigOverride(configOverride: string | null): GenaiCore.Llm.Mock.OtherAuth;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): GenaiCore.Llm.Mock.OtherAuth;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * "keychain" concept may be used.
     */
    readonly auths?: Array_Type<GenaiCore.Llm.Auth>;
    withAuths(auths: Array_Type<GenaiCore.Llm.Auth> | Array<IGenaiCore.Llm.Auth> | null): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * "keychain" concept may be used.
     */
    static readonly auths?: Array_Type<GenaiCore.Llm.Auth>;

    /**
     * The non-secret string.
     */
    readonly nonSecretString?: string;
    withNonSecretString(nonSecretString: string | null): GenaiCore.Llm.Mock.OtherAuth;

    /**
     * The non-secret string.
     */
    static readonly nonSecretString?: string;

    /**
     * The non-secret integer.
     */
    readonly nonSecretInt?: number;
    withNonSecretInt(nonSecretInt: number | null): GenaiCore.Llm.Mock.OtherAuth;

    /**
     * The non-secret integer.
     */
    static readonly nonSecretInt?: number;

    /**
     * The secret string.
     */
    readonly secretString?: string;
    withSecretString(secretString: string | null): GenaiCore.Llm.Mock.OtherAuth;

    /**
     * The secret string.
     */
    static readonly secretString?: string;
     ...
     */
    static inst(): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Llm.Mock.OtherAuth | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Llm.Mock.OtherAuth | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Llm.Mock.OtherAuth | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Llm.Mock.OtherAuth | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): GenaiCore.Llm.Mock.OtherAuth;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Llm.Mock.OtherAuth;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Llm.Mock.OtherAuth;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Llm.Mock.OtherAuth;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Llm.Mock.OtherAuth;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Llm.Mock.OtherAuth>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Llm.Mock.OtherAuth>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Llm.Mock.OtherAuth>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Llm.Mock.OtherAuth>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Llm.Mock.OtherAuth;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Llm.Mock.OtherAuth;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Llm.Mock.OtherAuth;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Llm.Mock.OtherAuth;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Llm.Mock.OtherAuth;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Llm.Mock.OtherAuth;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Llm.Mock.OtherAuth;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @see #removeField
     */
    static withoutField(field: string): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): GenaiCore.Llm.Mock.OtherAuth;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Llm.Mock.OtherAuth;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Llm.Mock.OtherAuth;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): GenaiCore.Llm.Mock.OtherAuth;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @see #removeField
     */
    static unsetField(field: string): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @see #unsetField
     */
    static removeField(field: string): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): GenaiCore.Llm.Mock.OtherAuth;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Llm.Mock.OtherAuth;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Llm.Mock.OtherAuth;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Llm.Mock.OtherAuth;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Llm.Mock.OtherAuth;

    mergeJson(json: any): GenaiCore.Llm.Mock.OtherAuth;

    static mergeJson(json: any): GenaiCore.Llm.Mock.OtherAuth;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Llm.Mock.OtherAuth;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): GenaiCore.Llm.Mock.OtherAuth;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Llm.Mock.OtherAuth>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<GenaiCore.Llm.Mock.OtherAuth>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Llm.Mock.OtherAuth> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Llm.Mock.OtherAuth> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Llm.Mock.OtherAuth>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<GenaiCore.Llm.Mock.OtherAuth>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Llm.Mock.OtherAuth> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Llm.Mock.OtherAuth> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Llm.Mock.OtherAuth> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Llm.Mock.OtherAuth>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<GenaiCore.Llm.Mock.OtherAuth>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Llm.Mock.OtherAuth>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Llm.Mock.OtherAuth;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.Llm.Mock.OtherAuth | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): GenaiCore.Llm.Mock.OtherAuth;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Llm.Mock.OtherAuth;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Llm.Mock.OtherAuth> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.Llm.Mock.OtherAuth | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): GenaiCore.Llm.Mock.OtherAuth | null;
     ...
     */
    static allCached(): Stream<GenaiCore.Llm.Mock.OtherAuth> | null;
     ...
     */
    static find(filter?: string): Stream<GenaiCore.Llm.Mock.OtherAuth> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<GenaiCore.Llm.Mock.OtherAuth> | null;

    /**
     * @return cached instance.
     */
    getCached(): GenaiCore.Llm.Mock.OtherAuth | null;

    /**
     * @return cached instance.
     */
    static getCached(): GenaiCore.Llm.Mock.OtherAuth | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): GenaiCore.Llm.Mock.OtherAuth | null;
     ...
     */
    static produce(key: string): GenaiCore.Llm.Mock.OtherAuth | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, GenaiCore.Llm.Mock.OtherAuth> | null;
     ...
     */
    getConfig(): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): GenaiCore.Llm.Mock.OtherAuth;
     ...
     */
    getSecret(): GenaiCore.Llm.Mock.OtherAuth;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): GenaiCore.Llm.Mock.OtherAuth;
     ...
     */
    withConfigKey(configKey: string): GenaiCore.Llm.Mock.OtherAuth;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): GenaiCore.Llm.Mock.OtherAuth;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): GenaiCore.Llm.Mock.OtherAuth;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): GenaiCore.Llm.Mock.OtherAuth;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): GenaiCore.Llm.Mock.OtherAuth | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<GenaiCore.Llm.Mock.OtherAuth> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: GenaiCore.Llm.Mock.OtherAuth, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: GenaiCore.Llm.Mock.OtherAuth, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): GenaiCore.Llm.Mock.OtherAuth | null;
     ...
     */
    removeSecrets(): GenaiCore.Llm.Mock.OtherAuth | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): GenaiCore.Llm.Mock.OtherAuth | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): GenaiCore.Llm.Mock.OtherAuth | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): GenaiCore.Llm.Mock.OtherAuth | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): GenaiCore.Llm.Mock.OtherAuth;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): GenaiCore.Llm.Mock.OtherAuth;
     ...
     */
    flattenedAuths(): Array_Type<GenaiCore.Llm.Auth>;
     ...
     *         recursively, until there only exist instances that have empty {@link #auths}.
     */
    static flattenedAuths(): Array_Type<GenaiCore.Llm.Auth>;
     ...
     */
    static secretStringsFromAuthSecret(authSecret: GenaiCore.Llm.Auth): Array_Type<string> | null;
     ...
     */
    clearAuthSecret(override?: string): void;
     ...
     *          override level to clear.
     */
    static clearAuthSecret(override?: string): void;

    /**
     * Clear the secret value for the all overrides.
     */
    clearAuthSecretAllOverrides(): void;

    /**
     * Clear the secret value for the all overrides.
     */
    static clearAuthSecretAllOverrides(): void;
     ...
     *          override level to clear.
     */
    clearConfigAndAuthSecretOverride(override: string): void;
     ...
     *          override level to clear.
     */
    static clearConfigAndAuthSecretOverride(override: string): void;

    /**
     * Clear the config and secret for all overrides.
     */
    clearConfigAndAuthSecretAllOverrides(): void;

    /**
     * Clear the config and secret for all overrides.
     */
    static clearConfigAndAuthSecretAllOverrides(): void;
     ...
     */
    static clearAllConfigAndAuthSecretOverrides(override: string, confirm?: boolean): void;
  }
}
