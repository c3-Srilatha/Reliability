// TypeScript definitions for the C3 type GenaiCore.Llm.VertexAi.BatchRequestJob

/**
 * Customized BatchRequestJob field/method implemented for Vertex AI service
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Llm.VertexAi.BatchRequestJob
 */
declare namespace GenaiCore.Llm.VertexAi {
  export interface IBatchRequestJob<C> {
 ...
 */
declare namespace GenaiCore.Llm.VertexAi {
  export class BatchRequestJob<C> extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): GenaiCore.Llm.VertexAi.BatchRequestJob;
     ...
     */
    readonly id: string;
    withId(id: string): GenaiCore.Llm.VertexAi.BatchRequestJob;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GenaiCore.Llm.VertexAi.BatchRequestJob;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): GenaiCore.Llm.VertexAi.BatchRequestJob;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): GenaiCore.Llm.VertexAi.BatchRequestJob;
    ...
    withVersion(version: number | null): GenaiCore.Llm.VertexAi.BatchRequestJob;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): GenaiCore.Llm.VertexAi.BatchRequestJob;

    /**
     * LiteLLM model used for submitting this batch request job
     */
    readonly model: GenaiCore.Llm.LiteLlm;
    withModel(model: IGenaiCore.Llm.LiteLlm): GenaiCore.Llm.VertexAi.BatchRequestJob;

    /**
     * The id of the batch request job
     */
    readonly jobId: string;
    withJobId(jobId: string): GenaiCore.Llm.VertexAi.BatchRequestJob;

    /**
     * The JSONL file containing the prompts passed to the LLM.
     */
    readonly inputFile: File;
    withInputFile(inputFile: IFile): GenaiCore.Llm.VertexAi.BatchRequestJob;
     ...
     * this uses {@link File} to represent the directory.
     */
    readonly outputDir: File;
    withOutputDir(outputDir: IFile): GenaiCore.Llm.VertexAi.BatchRequestJob;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Llm.VertexAi.BatchRequestJob<C> | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Llm.VertexAi.BatchRequestJob<C> | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Llm.VertexAi.BatchRequestJob<C> | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Llm.VertexAi.BatchRequestJob<C> | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;

    mergeJson(json: any): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Llm.VertexAi.BatchRequestJob<C>> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Llm.VertexAi.BatchRequestJob<C>> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Llm.VertexAi.BatchRequestJob<C>> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Llm.VertexAi.BatchRequestJob<C>> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Llm.VertexAi.BatchRequestJob<C>> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.Llm.VertexAi.BatchRequestJob<C> | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Llm.VertexAi.BatchRequestJob<C>> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     */
    responses(): Array_Type<string> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<GenaiCore.Llm.VertexAi.BatchRequestJob<C>> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>> | null;
     ...
     */
    get(include?: string): GenaiCore.Llm.VertexAi.BatchRequestJob<C> | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): GenaiCore.Llm.VertexAi.BatchRequestJob<C> | null;
     ...
     */
    getMissing(spec: GetMissingSpec): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): GenaiCore.Llm.VertexAi.BatchRequestJob<C> | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.Llm.VertexAi.BatchRequestJob<C> | null;
     ...
     */
    create(spec?: UpsertSpec): GenaiCore.Llm.VertexAi.BatchRequestJob<C> | null;
     ...
     */
    static createBatch(objs: Array_Type<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>, spec?: UpsertSpec): ObjList<GenaiCore.Llm.VertexAi.BatchRequestJob<C>> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>, spec?: CreateBatchObjStreamSpec): ObjList<GenaiCore.Llm.VertexAi.BatchRequestJob<C>> | null;
     ...
     */
    update(srcObj?: GenaiCore.Llm.VertexAi.BatchRequestJob<C>, spec?: UpsertSpec): GenaiCore.Llm.VertexAi.BatchRequestJob<C> | null;
     ...
     */
    upsert(srcObj?: GenaiCore.Llm.VertexAi.BatchRequestJob<C>, spec?: UpsertSpec): GenaiCore.Llm.VertexAi.BatchRequestJob<C> | null;
     ...
     */
    merge(spec?: MergeSpec): GenaiCore.Llm.VertexAi.BatchRequestJob<C> | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): GenaiCore.Llm.VertexAi.BatchRequestJob<C> | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): GenaiCore.Llm.VertexAi.BatchRequestJob<C> | null;
     ...
     */
    static updateBatch(objs: Array_Type<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>, srcObjs?: Array_Type<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>, spec?: UpsertSpec): ObjList<GenaiCore.Llm.VertexAi.BatchRequestJob<C>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<GenaiCore.Llm.VertexAi.BatchRequestJob<C>> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Llm.VertexAi.BatchRequestJob<C>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>, srcObjs?: Array_Type<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>, spec?: UpsertSpec): ObjList<GenaiCore.Llm.VertexAi.BatchRequestJob<C>> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<GenaiCore.Llm.VertexAi.BatchRequestJob<C>> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Llm.VertexAi.BatchRequestJob<C>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>, spec?: TouchSpec): ObjList<GenaiCore.Llm.VertexAi.BatchRequestJob<C>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>, spec?: MergeSpec): ObjList<GenaiCore.Llm.VertexAi.BatchRequestJob<C>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Llm.VertexAi.BatchRequestJob<C>> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<GenaiCore.Llm.VertexAi.BatchRequestJob<C>> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Llm.VertexAi.BatchRequestJob<C>> | null;
     ...
     */
    static mergeAll(mergeObj: GenaiCore.Llm.VertexAi.BatchRequestJob<C>, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: GenaiCore.Llm.VertexAi.BatchRequestJob<C>, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>, spec?: UpsertSpec): ObjList<GenaiCore.Llm.VertexAi.BatchRequestJob<C>> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>, spec?: UpsertSpec): ObjList<GenaiCore.Llm.VertexAi.BatchRequestJob<C>> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): GenaiCore.Llm.VertexAi.BatchRequestJob<C> | null;
     ...
     */
    static beforeCreate(objs: Array_Type<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>): ObjList<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>): ObjList<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>;

    /**
     * Cancels then deletes the job, and deletes the input file and output directory before removing.
     */
    static beforeRemove(objs: Array_Type<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>): ObjList<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>;
     ...
     */
    static afterCreate(objs: Array_Type<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.Llm.VertexAi.BatchRequestJob<C> | null;
     ...
     */
    withoutIdentity(): GenaiCore.Llm.VertexAi.BatchRequestJob<C> | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: GenaiCore.Llm.VertexAi.BatchRequestJob<C>, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>, callback?: λFunction<GenaiCore.Llm.VertexAi.BatchRequestJob<C> | null, GenaiCore.Llm.VertexAi.BatchRequestJob<C> | null>): ObjList<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<GenaiCore.Llm.VertexAi.BatchRequestJob<C>>, callback?: λFunction<GenaiCore.Llm.VertexAi.BatchRequestJob<C> | null, GenaiCore.Llm.VertexAi.BatchRequestJob<C> | null>): Array_Type<ObjError> | null;
     ...
     */
    static createInputFile(path: string, spec: GenaiCore.Llm.LiteLlm.BatchRequestJob.InputFileSpec): void;
     ...
     */
    static createJob(model: GenaiCore.Llm.Model, inputFilePath: string, jobId?: string): GenaiCore.Llm.VertexAi.BatchRequestJob<C>;
     ...
     */
    static uploadInputFile(path: string, model?: GenaiCore.Llm.Model): string;
