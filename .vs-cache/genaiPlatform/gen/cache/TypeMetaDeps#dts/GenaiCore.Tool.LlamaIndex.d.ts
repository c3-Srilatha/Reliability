// TypeScript definitions for the C3 type GenaiCore.Tool.LlamaIndex
 ...
 * ```
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Tool.LlamaIndex
 */
 ...
 */
declare namespace GenaiCore.Tool {
  export class LlamaIndex extends Obj  {

    /**
     * The name of this instance.
     */
    readonly name?: string;
    withName(name: string | null): GenaiCore.Tool.LlamaIndex;
     ...
     */
    readonly id: string;
    withId(id: string): GenaiCore.Tool.LlamaIndex;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GenaiCore.Tool.LlamaIndex;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): GenaiCore.Tool.LlamaIndex;
    ...
    withVersion(version: number | null): GenaiCore.Tool.LlamaIndex;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): GenaiCore.Tool.LlamaIndex;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): GenaiCore.Tool.LlamaIndex;
    ...
    withHidden(hidden: boolean): GenaiCore.Tool.LlamaIndex;
    ...
    withUserOwned(userOwned: boolean): GenaiCore.Tool.LlamaIndex;
    ...
    withTypeIdent(typeIdent: string | null): GenaiCore.Tool.LlamaIndex;

    /**
     * The flag used to mark whether the tool has been published. Defaults to `false`.
     */
    readonly isPublished?: boolean;
    withIsPublished(isPublished: boolean): GenaiCore.Tool.LlamaIndex;

    /**
     * Optional persisted kwargs that will be passed to #initialize
     */
    readonly initKwargs?: any;
    withInitKwargs(initKwargs: any | null): GenaiCore.Tool.LlamaIndex;
    ...
    withDescription(description: string | null): GenaiCore.Tool.LlamaIndex;
    ...
    withDescriptionForLlm(descriptionForLlm: string): GenaiCore.Tool.LlamaIndex;
    ...
    withArgsSchema(argsSchema: any | null): GenaiCore.Tool.LlamaIndex;
    ...
    withOutputPyType(outputPyType: any | null): GenaiCore.Tool.LlamaIndex;

    /**
     * This field represents the serialized version of the LlamaIndex native tools.
     */
    readonly nativeTool: string;
    withNativeTool(nativeTool: string): GenaiCore.Tool.LlamaIndex;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Tool.LlamaIndex | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Tool.LlamaIndex | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Tool.LlamaIndex | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Tool.LlamaIndex | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Tool.LlamaIndex;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Tool.LlamaIndex;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Tool.LlamaIndex;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Tool.LlamaIndex>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Tool.LlamaIndex>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Tool.LlamaIndex;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Tool.LlamaIndex;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Tool.LlamaIndex;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Tool.LlamaIndex;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Tool.LlamaIndex;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Tool.LlamaIndex;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Tool.LlamaIndex;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Tool.LlamaIndex;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Tool.LlamaIndex;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Tool.LlamaIndex;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Tool.LlamaIndex;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Tool.LlamaIndex;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Tool.LlamaIndex;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Tool.LlamaIndex;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Tool.LlamaIndex;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Tool.LlamaIndex;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Tool.LlamaIndex;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Tool.LlamaIndex;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Tool.LlamaIndex;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Tool.LlamaIndex;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Tool.LlamaIndex;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Tool.LlamaIndex;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Tool.LlamaIndex;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Tool.LlamaIndex;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Tool.LlamaIndex;

    mergeJson(json: any): GenaiCore.Tool.LlamaIndex;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Tool.LlamaIndex;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Tool.LlamaIndex;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Tool.LlamaIndex>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Tool.LlamaIndex> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Tool.LlamaIndex> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Tool.LlamaIndex>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Tool.LlamaIndex> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Tool.LlamaIndex> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Tool.LlamaIndex> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Tool.LlamaIndex>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Tool.LlamaIndex>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Tool.LlamaIndex;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Tool.LlamaIndex;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Tool.LlamaIndex;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Tool.LlamaIndex;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Tool.LlamaIndex;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Tool.LlamaIndex;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.Tool.LlamaIndex | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Tool.LlamaIndex;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Tool.LlamaIndex;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Tool.LlamaIndex;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Tool.LlamaIndex> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Tool.LlamaIndex;
     ...
     */
    static allCached(): Stream<GenaiCore.Tool.LlamaIndex> | null;
     ...
     */
    static find(filter?: string): Stream<GenaiCore.Tool.LlamaIndex> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<GenaiCore.Tool.LlamaIndex> | null;

    /**
     * @return cached instance.
     */
    getCached(): GenaiCore.Tool.LlamaIndex | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): GenaiCore.Tool.LlamaIndex | null;
     ...
     */
    static produce(key: string): GenaiCore.Tool.LlamaIndex | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, GenaiCore.Tool.LlamaIndex> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<GenaiCore.Tool.LlamaIndex>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<GenaiCore.Tool.LlamaIndex>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<GenaiCore.Tool.LlamaIndex> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenaiCore.Tool.LlamaIndex>> | null;
     ...
     */
    get(include?: string): GenaiCore.Tool.LlamaIndex | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): GenaiCore.Tool.LlamaIndex | null;
     ...
     */
    getMissing(spec: GetMissingSpec): GenaiCore.Tool.LlamaIndex;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): GenaiCore.Tool.LlamaIndex | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): GenaiCore.Tool.LlamaIndex;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.Tool.LlamaIndex | null;
     ...
     */
    create(spec?: UpsertSpec): GenaiCore.Tool.LlamaIndex | null;
     ...
     */
    static createBatch(objs: Array_Type<GenaiCore.Tool.LlamaIndex>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.LlamaIndex> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<GenaiCore.Tool.LlamaIndex>, spec?: CreateBatchObjStreamSpec): ObjList<GenaiCore.Tool.LlamaIndex> | null;
     ...
     */
    update(srcObj?: GenaiCore.Tool.LlamaIndex, spec?: UpsertSpec): GenaiCore.Tool.LlamaIndex | null;
     ...
     */
    upsert(srcObj?: GenaiCore.Tool.LlamaIndex, spec?: UpsertSpec): GenaiCore.Tool.LlamaIndex | null;
     ...
     */
    merge(spec?: MergeSpec): GenaiCore.Tool.LlamaIndex | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): GenaiCore.Tool.LlamaIndex | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): GenaiCore.Tool.LlamaIndex | null;
     ...
     */
    static updateBatch(objs: Array_Type<GenaiCore.Tool.LlamaIndex>, srcObjs?: Array_Type<GenaiCore.Tool.LlamaIndex>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.LlamaIndex> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<GenaiCore.Tool.LlamaIndex> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.LlamaIndex> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<GenaiCore.Tool.LlamaIndex>, srcObjs?: Array_Type<GenaiCore.Tool.LlamaIndex>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.LlamaIndex> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<GenaiCore.Tool.LlamaIndex> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.LlamaIndex> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<GenaiCore.Tool.LlamaIndex>, spec?: TouchSpec): ObjList<GenaiCore.Tool.LlamaIndex> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Tool.LlamaIndex>, spec?: MergeSpec): ObjList<GenaiCore.Tool.LlamaIndex> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Tool.LlamaIndex>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Tool.LlamaIndex> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<GenaiCore.Tool.LlamaIndex> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Tool.LlamaIndex> | null;
     ...
     */
    static mergeAll(mergeObj: GenaiCore.Tool.LlamaIndex, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: GenaiCore.Tool.LlamaIndex, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<GenaiCore.Tool.LlamaIndex>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.LlamaIndex> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<GenaiCore.Tool.LlamaIndex>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.LlamaIndex> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): GenaiCore.Tool.LlamaIndex | null;
     ...
     */
    static beforeCreate(objs: Array_Type<GenaiCore.Tool.LlamaIndex>): ObjList<GenaiCore.Tool.LlamaIndex>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<GenaiCore.Tool.LlamaIndex>): ObjList<GenaiCore.Tool.LlamaIndex>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<GenaiCore.Tool.LlamaIndex>): ObjList<GenaiCore.Tool.LlamaIndex>;
     ...
     */
    static afterCreate(objs: Array_Type<GenaiCore.Tool.LlamaIndex>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<GenaiCore.Tool.LlamaIndex>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<GenaiCore.Tool.LlamaIndex>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<GenaiCore.Tool.LlamaIndex>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GenaiCore.Tool.LlamaIndex>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.Tool.LlamaIndex | null;
     ...
     */
    withoutIdentity(): GenaiCore.Tool.LlamaIndex | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<GenaiCore.Tool.LlamaIndex>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: GenaiCore.Tool.LlamaIndex, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<GenaiCore.Tool.LlamaIndex>, callback?: λFunction<GenaiCore.Tool.LlamaIndex | null, GenaiCore.Tool.LlamaIndex | null>): ObjList<GenaiCore.Tool.LlamaIndex>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<GenaiCore.Tool.LlamaIndex>, callback?: λFunction<GenaiCore.Tool.LlamaIndex | null, GenaiCore.Tool.LlamaIndex | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): GenaiCore.Tool.LlamaIndex;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.LlamaIndex> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): GenaiCore.Tool.LlamaIndex | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.LlamaIndex> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): GenaiCore.Tool.LlamaIndex | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.LlamaIndex> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): GenaiCore.Tool.LlamaIndex | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<GenaiCore.Tool.LlamaIndex> | null;
    ...
    dependencies(): SeedDataDeps<GenaiCore.Tool.LlamaIndex> | null;
     ...
     */
    static createFromLlamaTool(tool: any): GenaiCore.Tool.LlamaIndex;
  }
}
