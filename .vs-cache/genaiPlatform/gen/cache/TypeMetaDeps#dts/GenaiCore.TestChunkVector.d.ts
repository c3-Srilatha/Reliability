// TypeScript definitions for the C3 type GenaiCore.TestChunkVector

/**
 * Test vector to be used with {@link GenaiCore.Unstructured.Job}.
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.TestChunkVector
 */
declare namespace GenaiCore {
  export interface ITestChunkVector {
    ...
    /**
     * The number of chunks that was produced from the corresponding source.
     */
    totalChunks?: number;

    /**
     * The index of this embedded chunk in the total number of chunks.
     */
    chunkIndex?: number;
  }
}
 ...
 * Test vector to be used with {@link GenaiCore.Unstructured.Job}.
 *
 * @remarks this represents a made instance of GenaiCore.TestChunkVector
 */
declare namespace GenaiCore {
  export class TestChunkVector extends Obj  {
    ...
    withContent(content: string | null): GenaiCore.TestChunkVector;
    ...
    withContentToEmbed(contentToEmbed: string | null): GenaiCore.TestChunkVector;
    ...
    withEmbedding(embedding: string): GenaiCore.TestChunkVector;

    /**
     * The unique 'name' (often including complete path) of the source file, e.g. "/my/directory/boiler-repair-manual.pdf"
     */
    readonly source?: string;
    withSource(source: string | null): GenaiCore.TestChunkVector;

    /**
     * ID of the job run that generated the vector.
     */
    readonly jobRunId?: string;
    withJobRunId(jobRunId: string | null): GenaiCore.TestChunkVector;

    /**
     * The type of the job run that generated the vector.
     */
    readonly jobRunType?: string;
    withJobRunType(jobRunType: string | null): GenaiCore.TestChunkVector;
    ...
    withDetails(details: Map_Type<string, any> | {[key: string]: any} | null): GenaiCore.TestChunkVector;
    ...
    withJobId(jobId: string | null): GenaiCore.TestChunkVector;

    /**
     * The type of the parent job of the job run that generated the vector.
     */
    readonly jobType?: string;
    withJobType(jobType: string | null): GenaiCore.TestChunkVector;
     ...
     */
    readonly id: string;
    withId(id: string): GenaiCore.TestChunkVector;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GenaiCore.TestChunkVector;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): GenaiCore.TestChunkVector;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): GenaiCore.TestChunkVector;
    ...
    withVersion(version: number | null): GenaiCore.TestChunkVector;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): GenaiCore.TestChunkVector;

    /**
     * The number of chunks that was produced from the corresponding source.
     */
    readonly totalChunks?: number;
    withTotalChunks(totalChunks: number | null): GenaiCore.TestChunkVector;

    /**
     * The index of this embedded chunk in the total number of chunks.
     */
    readonly chunkIndex?: number;
    withChunkIndex(chunkIndex: number | null): GenaiCore.TestChunkVector;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.TestChunkVector | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.TestChunkVector | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.TestChunkVector | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.TestChunkVector | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.TestChunkVector;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.TestChunkVector;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.TestChunkVector;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.TestChunkVector>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.TestChunkVector>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.TestChunkVector;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.TestChunkVector;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.TestChunkVector;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.TestChunkVector;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.TestChunkVector;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.TestChunkVector;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.TestChunkVector;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.TestChunkVector;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.TestChunkVector;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.TestChunkVector;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.TestChunkVector;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.TestChunkVector;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.TestChunkVector;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.TestChunkVector;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.TestChunkVector;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.TestChunkVector;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.TestChunkVector;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.TestChunkVector;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.TestChunkVector;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.TestChunkVector;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.TestChunkVector;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.TestChunkVector;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.TestChunkVector;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.TestChunkVector;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.TestChunkVector;

    mergeJson(json: any): GenaiCore.TestChunkVector;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.TestChunkVector;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.TestChunkVector;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.TestChunkVector>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.TestChunkVector> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.TestChunkVector> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.TestChunkVector>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.TestChunkVector> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.TestChunkVector> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.TestChunkVector> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.TestChunkVector>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.TestChunkVector>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.TestChunkVector;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.TestChunkVector;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.TestChunkVector;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.TestChunkVector;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.TestChunkVector;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.TestChunkVector;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.TestChunkVector | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.TestChunkVector;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.TestChunkVector;
     ...
     */
    static cachedEmptyInst(): GenaiCore.TestChunkVector;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.TestChunkVector> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.TestChunkVector;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<GenaiCore.TestChunkVector>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<GenaiCore.TestChunkVector>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<GenaiCore.TestChunkVector> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenaiCore.TestChunkVector>> | null;
     ...
     */
    get(include?: string): GenaiCore.TestChunkVector | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): GenaiCore.TestChunkVector | null;
     ...
     */
    getMissing(spec: GetMissingSpec): GenaiCore.TestChunkVector;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): GenaiCore.TestChunkVector | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): GenaiCore.TestChunkVector;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.TestChunkVector | null;
     ...
     */
    create(spec?: UpsertSpec): GenaiCore.TestChunkVector | null;
     ...
     */
    static createBatch(objs: Array_Type<GenaiCore.TestChunkVector>, spec?: UpsertSpec): ObjList<GenaiCore.TestChunkVector> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<GenaiCore.TestChunkVector>, spec?: CreateBatchObjStreamSpec): ObjList<GenaiCore.TestChunkVector> | null;
     ...
     */
    update(srcObj?: GenaiCore.TestChunkVector, spec?: UpsertSpec): GenaiCore.TestChunkVector | null;
     ...
     */
    upsert(srcObj?: GenaiCore.TestChunkVector, spec?: UpsertSpec): GenaiCore.TestChunkVector | null;
     ...
     */
    merge(spec?: MergeSpec): GenaiCore.TestChunkVector | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): GenaiCore.TestChunkVector | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): GenaiCore.TestChunkVector | null;
     ...
     */
    static updateBatch(objs: Array_Type<GenaiCore.TestChunkVector>, srcObjs?: Array_Type<GenaiCore.TestChunkVector>, spec?: UpsertSpec): ObjList<GenaiCore.TestChunkVector> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<GenaiCore.TestChunkVector> | null>, spec?: UpsertSpec): ObjList<GenaiCore.TestChunkVector> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<GenaiCore.TestChunkVector>, srcObjs?: Array_Type<GenaiCore.TestChunkVector>, spec?: UpsertSpec): ObjList<GenaiCore.TestChunkVector> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<GenaiCore.TestChunkVector> | null>, spec?: UpsertSpec): ObjList<GenaiCore.TestChunkVector> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<GenaiCore.TestChunkVector>, spec?: TouchSpec): ObjList<GenaiCore.TestChunkVector> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.TestChunkVector>, spec?: MergeSpec): ObjList<GenaiCore.TestChunkVector> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.TestChunkVector>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.TestChunkVector> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<GenaiCore.TestChunkVector> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.TestChunkVector> | null;
     ...
     */
    static mergeAll(mergeObj: GenaiCore.TestChunkVector, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: GenaiCore.TestChunkVector, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<GenaiCore.TestChunkVector>, spec?: UpsertSpec): ObjList<GenaiCore.TestChunkVector> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<GenaiCore.TestChunkVector>, spec?: UpsertSpec): ObjList<GenaiCore.TestChunkVector> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): GenaiCore.TestChunkVector | null;
     ...
     */
    static beforeCreate(objs: Array_Type<GenaiCore.TestChunkVector>): ObjList<GenaiCore.TestChunkVector>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<GenaiCore.TestChunkVector>): ObjList<GenaiCore.TestChunkVector>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<GenaiCore.TestChunkVector>): ObjList<GenaiCore.TestChunkVector>;
     ...
     */
    static afterCreate(objs: Array_Type<GenaiCore.TestChunkVector>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<GenaiCore.TestChunkVector>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<GenaiCore.TestChunkVector>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<GenaiCore.TestChunkVector>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GenaiCore.TestChunkVector>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.TestChunkVector | null;
     ...
     */
    withoutIdentity(): GenaiCore.TestChunkVector | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<GenaiCore.TestChunkVector>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: GenaiCore.TestChunkVector, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<GenaiCore.TestChunkVector>, callback?: λFunction<GenaiCore.TestChunkVector | null, GenaiCore.TestChunkVector | null>): ObjList<GenaiCore.TestChunkVector>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<GenaiCore.TestChunkVector>, callback?: λFunction<GenaiCore.TestChunkVector | null, GenaiCore.TestChunkVector | null>): Array_Type<ObjError> | null;
