// TypeScript definitions for the C3 type GenaiCore.Embedder.Persistable
 ...
 * @inheritdoc
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Embedder.Persistable
 */
...
declare namespace GenaiCore.Embedder {
  export class Persistable extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): GenaiCore.Embedder.Persistable;

    /**
     * The name of this instance.
     */
    readonly name?: string;
    withName(name: string | null): GenaiCore.Embedder.Persistable;

    /**
     * The default kwargs for this embedder. Caller-provided kwargs values will be merged and take precedence.
     */
    readonly defaultKwargs?: any;
    withDefaultKwargs(defaultKwargs: any | null): GenaiCore.Embedder.Persistable;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GenaiCore.Embedder.Persistable;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): GenaiCore.Embedder.Persistable;
    ...
    withVersion(version: number | null): GenaiCore.Embedder.Persistable;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): GenaiCore.Embedder.Persistable;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): GenaiCore.Embedder.Persistable;
    ...
    withHidden(hidden: boolean): GenaiCore.Embedder.Persistable;
    ...
    withUserOwned(userOwned: boolean): GenaiCore.Embedder.Persistable;
    ...
    withTypeIdent(typeIdent: string | null): GenaiCore.Embedder.Persistable;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Embedder.Persistable | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Embedder.Persistable | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Embedder.Persistable | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Embedder.Persistable | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Embedder.Persistable;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Embedder.Persistable;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Embedder.Persistable;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Embedder.Persistable>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Embedder.Persistable>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Embedder.Persistable;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Embedder.Persistable;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Embedder.Persistable;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Embedder.Persistable;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Embedder.Persistable;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Embedder.Persistable;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Embedder.Persistable;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Embedder.Persistable;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Embedder.Persistable;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Embedder.Persistable;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Embedder.Persistable;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Embedder.Persistable;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Embedder.Persistable;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Embedder.Persistable;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Embedder.Persistable;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Embedder.Persistable;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Embedder.Persistable;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Embedder.Persistable;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Embedder.Persistable;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Embedder.Persistable;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Embedder.Persistable;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Embedder.Persistable;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Embedder.Persistable;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Embedder.Persistable;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Embedder.Persistable;

    mergeJson(json: any): GenaiCore.Embedder.Persistable;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Embedder.Persistable;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Embedder.Persistable;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Embedder.Persistable>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Embedder.Persistable> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Embedder.Persistable> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Embedder.Persistable>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Embedder.Persistable> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Embedder.Persistable> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Embedder.Persistable> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Embedder.Persistable>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Embedder.Persistable>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Embedder.Persistable;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Embedder.Persistable;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Embedder.Persistable;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Embedder.Persistable;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Embedder.Persistable;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Embedder.Persistable;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.Embedder.Persistable | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Embedder.Persistable;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Embedder.Persistable;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Embedder.Persistable;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Embedder.Persistable> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Embedder.Persistable;
     ...
     */
    initialize(force?: boolean): GenaiCore.Embedder.Persistable | null;
     ...
     */
    static allCached(): Stream<GenaiCore.Embedder.Persistable> | null;
     ...
     */
    static find(filter?: string): Stream<GenaiCore.Embedder.Persistable> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<GenaiCore.Embedder.Persistable> | null;

    /**
     * @return cached instance.
     */
    getCached(): GenaiCore.Embedder.Persistable | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): GenaiCore.Embedder.Persistable | null;
     ...
     */
    static produce(key: string): GenaiCore.Embedder.Persistable | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, GenaiCore.Embedder.Persistable> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<GenaiCore.Embedder.Persistable>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<GenaiCore.Embedder.Persistable>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<GenaiCore.Embedder.Persistable> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenaiCore.Embedder.Persistable>> | null;
     ...
     */
    get(include?: string): GenaiCore.Embedder.Persistable | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): GenaiCore.Embedder.Persistable | null;
     ...
     */
    getMissing(spec: GetMissingSpec): GenaiCore.Embedder.Persistable;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): GenaiCore.Embedder.Persistable | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): GenaiCore.Embedder.Persistable;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.Embedder.Persistable | null;
     ...
     */
    create(spec?: UpsertSpec): GenaiCore.Embedder.Persistable | null;
     ...
     */
    static createBatch(objs: Array_Type<GenaiCore.Embedder.Persistable>, spec?: UpsertSpec): ObjList<GenaiCore.Embedder.Persistable> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<GenaiCore.Embedder.Persistable>, spec?: CreateBatchObjStreamSpec): ObjList<GenaiCore.Embedder.Persistable> | null;
     ...
     */
    update(srcObj?: GenaiCore.Embedder.Persistable, spec?: UpsertSpec): GenaiCore.Embedder.Persistable | null;
     ...
     */
    upsert(srcObj?: GenaiCore.Embedder.Persistable, spec?: UpsertSpec): GenaiCore.Embedder.Persistable | null;
     ...
     */
    merge(spec?: MergeSpec): GenaiCore.Embedder.Persistable | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): GenaiCore.Embedder.Persistable | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): GenaiCore.Embedder.Persistable | null;
     ...
     */
    static updateBatch(objs: Array_Type<GenaiCore.Embedder.Persistable>, srcObjs?: Array_Type<GenaiCore.Embedder.Persistable>, spec?: UpsertSpec): ObjList<GenaiCore.Embedder.Persistable> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<GenaiCore.Embedder.Persistable> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Embedder.Persistable> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<GenaiCore.Embedder.Persistable>, srcObjs?: Array_Type<GenaiCore.Embedder.Persistable>, spec?: UpsertSpec): ObjList<GenaiCore.Embedder.Persistable> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<GenaiCore.Embedder.Persistable> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Embedder.Persistable> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<GenaiCore.Embedder.Persistable>, spec?: TouchSpec): ObjList<GenaiCore.Embedder.Persistable> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Embedder.Persistable>, spec?: MergeSpec): ObjList<GenaiCore.Embedder.Persistable> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Embedder.Persistable>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Embedder.Persistable> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<GenaiCore.Embedder.Persistable> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Embedder.Persistable> | null;
     ...
     */
    static mergeAll(mergeObj: GenaiCore.Embedder.Persistable, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: GenaiCore.Embedder.Persistable, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<GenaiCore.Embedder.Persistable>, spec?: UpsertSpec): ObjList<GenaiCore.Embedder.Persistable> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<GenaiCore.Embedder.Persistable>, spec?: UpsertSpec): ObjList<GenaiCore.Embedder.Persistable> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): GenaiCore.Embedder.Persistable | null;
     ...
     */
    static beforeCreate(objs: Array_Type<GenaiCore.Embedder.Persistable>): ObjList<GenaiCore.Embedder.Persistable>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<GenaiCore.Embedder.Persistable>): ObjList<GenaiCore.Embedder.Persistable>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<GenaiCore.Embedder.Persistable>): ObjList<GenaiCore.Embedder.Persistable>;
     ...
     */
    static afterCreate(objs: Array_Type<GenaiCore.Embedder.Persistable>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<GenaiCore.Embedder.Persistable>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<GenaiCore.Embedder.Persistable>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<GenaiCore.Embedder.Persistable>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GenaiCore.Embedder.Persistable>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.Embedder.Persistable | null;
     ...
     */
    withoutIdentity(): GenaiCore.Embedder.Persistable | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<GenaiCore.Embedder.Persistable>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: GenaiCore.Embedder.Persistable, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<GenaiCore.Embedder.Persistable>, callback?: λFunction<GenaiCore.Embedder.Persistable | null, GenaiCore.Embedder.Persistable | null>): ObjList<GenaiCore.Embedder.Persistable>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<GenaiCore.Embedder.Persistable>, callback?: λFunction<GenaiCore.Embedder.Persistable | null, GenaiCore.Embedder.Persistable | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): GenaiCore.Embedder.Persistable;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Embedder.Persistable> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): GenaiCore.Embedder.Persistable | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Embedder.Persistable> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): GenaiCore.Embedder.Persistable | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Embedder.Persistable> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): GenaiCore.Embedder.Persistable | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<GenaiCore.Embedder.Persistable> | null;
    ...
    dependencies(): SeedDataDeps<GenaiCore.Embedder.Persistable> | null;
