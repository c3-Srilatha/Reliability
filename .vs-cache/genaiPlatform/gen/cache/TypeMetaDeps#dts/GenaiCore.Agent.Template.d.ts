// TypeScript definitions for the C3 type GenaiCore.Agent.Template
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Agent.Template
 */
declare namespace GenaiCore.Agent {
  export interface ITemplate {
     ...
     */
    agentFieldValues?: Map_Type<string, any> | {[key: string]: any};
...
declare namespace GenaiCore.Agent {
  export class Template extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): GenaiCore.Agent.Template;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GenaiCore.Agent.Template;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): GenaiCore.Agent.Template;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): GenaiCore.Agent.Template;
    ...
    withVersion(version: number | null): GenaiCore.Agent.Template;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): GenaiCore.Agent.Template;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): GenaiCore.Agent.Template;
    ...
    withHidden(hidden: boolean): GenaiCore.Agent.Template;
    ...
    withUserOwned(userOwned: boolean): GenaiCore.Agent.Template;
    ...
    withAgentTypeName(agentTypeName: string): GenaiCore.Agent.Template;
     ...
     * The key of the map represents the field name and the value represents the field value.
     */
    readonly agentFieldValues?: Map_Type<string, any>;
    withAgentFieldValues(agentFieldValues: Map_Type<string, any> | {[key: string]: any} | null): GenaiCore.Agent.Template;
    ...
    withDescription(description: string | null): GenaiCore.Agent.Template;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Agent.Template | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Agent.Template | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Agent.Template | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Agent.Template | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Agent.Template;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Agent.Template;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Agent.Template;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Agent.Template>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Agent.Template>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Agent.Template;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Agent.Template;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Agent.Template;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Agent.Template;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Agent.Template;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Agent.Template;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Agent.Template;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Agent.Template;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Agent.Template;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Agent.Template;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Agent.Template;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Agent.Template;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Agent.Template;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Agent.Template;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Agent.Template;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Agent.Template;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Agent.Template;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Agent.Template;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Agent.Template;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Agent.Template;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Agent.Template;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Agent.Template;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Agent.Template;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Agent.Template;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Agent.Template;

    mergeJson(json: any): GenaiCore.Agent.Template;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Agent.Template;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Agent.Template;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Agent.Template>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Agent.Template> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Agent.Template> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Agent.Template>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Agent.Template> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Agent.Template> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Agent.Template> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Agent.Template>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Agent.Template>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Agent.Template;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Agent.Template;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Agent.Template;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Agent.Template;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Agent.Template;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Agent.Template;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.Agent.Template | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Agent.Template;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Agent.Template;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Agent.Template;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Agent.Template> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Agent.Template;
     ...
     */
    static allCached(): Stream<GenaiCore.Agent.Template> | null;
     ...
     */
    static find(filter?: string): Stream<GenaiCore.Agent.Template> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<GenaiCore.Agent.Template> | null;

    /**
     * @return cached instance.
     */
    getCached(): GenaiCore.Agent.Template | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): GenaiCore.Agent.Template | null;
     ...
     */
    static produce(key: string): GenaiCore.Agent.Template | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, GenaiCore.Agent.Template> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<GenaiCore.Agent.Template>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<GenaiCore.Agent.Template>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<GenaiCore.Agent.Template> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenaiCore.Agent.Template>> | null;
     ...
     */
    get(include?: string): GenaiCore.Agent.Template | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): GenaiCore.Agent.Template | null;
     ...
     */
    getMissing(spec: GetMissingSpec): GenaiCore.Agent.Template;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): GenaiCore.Agent.Template | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): GenaiCore.Agent.Template;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.Agent.Template | null;
     ...
     */
    create(spec?: UpsertSpec): GenaiCore.Agent.Template | null;
     ...
     */
    static createBatch(objs: Array_Type<GenaiCore.Agent.Template>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.Template> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<GenaiCore.Agent.Template>, spec?: CreateBatchObjStreamSpec): ObjList<GenaiCore.Agent.Template> | null;
     ...
     */
    update(srcObj?: GenaiCore.Agent.Template, spec?: UpsertSpec): GenaiCore.Agent.Template | null;
     ...
     */
    upsert(srcObj?: GenaiCore.Agent.Template, spec?: UpsertSpec): GenaiCore.Agent.Template | null;
     ...
     */
    merge(spec?: MergeSpec): GenaiCore.Agent.Template | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): GenaiCore.Agent.Template | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): GenaiCore.Agent.Template | null;
     ...
     */
    static updateBatch(objs: Array_Type<GenaiCore.Agent.Template>, srcObjs?: Array_Type<GenaiCore.Agent.Template>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.Template> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<GenaiCore.Agent.Template> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.Template> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<GenaiCore.Agent.Template>, srcObjs?: Array_Type<GenaiCore.Agent.Template>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.Template> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<GenaiCore.Agent.Template> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.Template> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<GenaiCore.Agent.Template>, spec?: TouchSpec): ObjList<GenaiCore.Agent.Template> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Agent.Template>, spec?: MergeSpec): ObjList<GenaiCore.Agent.Template> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Agent.Template>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Agent.Template> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<GenaiCore.Agent.Template> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Agent.Template> | null;
     ...
     */
    static mergeAll(mergeObj: GenaiCore.Agent.Template, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: GenaiCore.Agent.Template, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<GenaiCore.Agent.Template>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.Template> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<GenaiCore.Agent.Template>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.Template> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): GenaiCore.Agent.Template | null;
     ...
     */
    static beforeCreate(objs: Array_Type<GenaiCore.Agent.Template>): ObjList<GenaiCore.Agent.Template>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<GenaiCore.Agent.Template>): ObjList<GenaiCore.Agent.Template>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<GenaiCore.Agent.Template>): ObjList<GenaiCore.Agent.Template>;
     ...
     */
    static afterCreate(objs: Array_Type<GenaiCore.Agent.Template>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<GenaiCore.Agent.Template>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<GenaiCore.Agent.Template>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<GenaiCore.Agent.Template>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GenaiCore.Agent.Template>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.Agent.Template | null;
     ...
     */
    withoutIdentity(): GenaiCore.Agent.Template | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<GenaiCore.Agent.Template>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: GenaiCore.Agent.Template, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<GenaiCore.Agent.Template>, callback?: λFunction<GenaiCore.Agent.Template | null, GenaiCore.Agent.Template | null>): ObjList<GenaiCore.Agent.Template>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<GenaiCore.Agent.Template>, callback?: λFunction<GenaiCore.Agent.Template | null, GenaiCore.Agent.Template | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): GenaiCore.Agent.Template;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.Template> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): GenaiCore.Agent.Template | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.Template> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): GenaiCore.Agent.Template | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.Template> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): GenaiCore.Agent.Template | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<GenaiCore.Agent.Template> | null;
    ...
    dependencies(): SeedDataDeps<GenaiCore.Agent.Template> | null;
