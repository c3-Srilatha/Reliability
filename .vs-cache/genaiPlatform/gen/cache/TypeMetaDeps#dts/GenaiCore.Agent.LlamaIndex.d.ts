// TypeScript definitions for the C3 type GenaiCore.Agent.LlamaIndex

/**
 * Represents a LlamaIndex-based agent capable of handling queries using a customizable set of tools
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Agent.LlamaIndex
 */
...
declare namespace GenaiCore.Agent {
  export class LlamaIndex extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): GenaiCore.Agent.LlamaIndex;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GenaiCore.Agent.LlamaIndex;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): GenaiCore.Agent.LlamaIndex;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): GenaiCore.Agent.LlamaIndex;
    ...
    withVersion(version: number | null): GenaiCore.Agent.LlamaIndex;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): GenaiCore.Agent.LlamaIndex;

    /**
     * Session store for persisting session state between queries.
     */
    readonly sessionStore: GenaiCore.SessionStore;
    withSessionStore(sessionStore: IGenaiCore.SessionStore): GenaiCore.Agent.LlamaIndex;

    /**
     * Collection of tools available to the agent
     */
    readonly toolkit: GenaiCore.Toolkit;
    withToolkit(toolkit: IGenaiCore.Toolkit): GenaiCore.Agent.LlamaIndex;

    /**
     * The system prompt that defines the behavior of the agent.
     */
    readonly systemPrompt?: string;
    withSystemPrompt(systemPrompt: string | null): GenaiCore.Agent.LlamaIndex;

    /**
     * The llm used by the agent.
     */
    readonly llm: GenaiCore.Llm.Client;
    withLlm(llm: IGenaiCore.Llm.Client): GenaiCore.Agent.LlamaIndex;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Agent.LlamaIndex | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Agent.LlamaIndex | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Agent.LlamaIndex | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Agent.LlamaIndex | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Agent.LlamaIndex;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Agent.LlamaIndex;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Agent.LlamaIndex;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Agent.LlamaIndex>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Agent.LlamaIndex>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Agent.LlamaIndex;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Agent.LlamaIndex;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Agent.LlamaIndex;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Agent.LlamaIndex;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Agent.LlamaIndex;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Agent.LlamaIndex;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Agent.LlamaIndex;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Agent.LlamaIndex;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Agent.LlamaIndex;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Agent.LlamaIndex;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Agent.LlamaIndex;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Agent.LlamaIndex;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Agent.LlamaIndex;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Agent.LlamaIndex;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Agent.LlamaIndex;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Agent.LlamaIndex;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Agent.LlamaIndex;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Agent.LlamaIndex;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Agent.LlamaIndex;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Agent.LlamaIndex;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Agent.LlamaIndex;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Agent.LlamaIndex;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Agent.LlamaIndex;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Agent.LlamaIndex;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Agent.LlamaIndex;

    mergeJson(json: any): GenaiCore.Agent.LlamaIndex;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Agent.LlamaIndex;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Agent.LlamaIndex;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Agent.LlamaIndex>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Agent.LlamaIndex> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Agent.LlamaIndex> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Agent.LlamaIndex>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Agent.LlamaIndex> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Agent.LlamaIndex> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Agent.LlamaIndex> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Agent.LlamaIndex>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Agent.LlamaIndex>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Agent.LlamaIndex;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Agent.LlamaIndex;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Agent.LlamaIndex;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Agent.LlamaIndex;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Agent.LlamaIndex;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Agent.LlamaIndex;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.Agent.LlamaIndex | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Agent.LlamaIndex;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Agent.LlamaIndex;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Agent.LlamaIndex;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Agent.LlamaIndex> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Agent.LlamaIndex;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<GenaiCore.Agent.LlamaIndex>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<GenaiCore.Agent.LlamaIndex>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<GenaiCore.Agent.LlamaIndex> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenaiCore.Agent.LlamaIndex>> | null;
     ...
     */
    get(include?: string): GenaiCore.Agent.LlamaIndex | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): GenaiCore.Agent.LlamaIndex | null;
     ...
     */
    getMissing(spec: GetMissingSpec): GenaiCore.Agent.LlamaIndex;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): GenaiCore.Agent.LlamaIndex | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): GenaiCore.Agent.LlamaIndex;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.Agent.LlamaIndex | null;
     ...
     */
    create(spec?: UpsertSpec): GenaiCore.Agent.LlamaIndex | null;
     ...
     */
    static createBatch(objs: Array_Type<GenaiCore.Agent.LlamaIndex>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.LlamaIndex> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<GenaiCore.Agent.LlamaIndex>, spec?: CreateBatchObjStreamSpec): ObjList<GenaiCore.Agent.LlamaIndex> | null;
     ...
     */
    update(srcObj?: GenaiCore.Agent.LlamaIndex, spec?: UpsertSpec): GenaiCore.Agent.LlamaIndex | null;
     ...
     */
    upsert(srcObj?: GenaiCore.Agent.LlamaIndex, spec?: UpsertSpec): GenaiCore.Agent.LlamaIndex | null;
     ...
     */
    merge(spec?: MergeSpec): GenaiCore.Agent.LlamaIndex | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): GenaiCore.Agent.LlamaIndex | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): GenaiCore.Agent.LlamaIndex | null;
     ...
     */
    static updateBatch(objs: Array_Type<GenaiCore.Agent.LlamaIndex>, srcObjs?: Array_Type<GenaiCore.Agent.LlamaIndex>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.LlamaIndex> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<GenaiCore.Agent.LlamaIndex> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.LlamaIndex> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<GenaiCore.Agent.LlamaIndex>, srcObjs?: Array_Type<GenaiCore.Agent.LlamaIndex>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.LlamaIndex> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<GenaiCore.Agent.LlamaIndex> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.LlamaIndex> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<GenaiCore.Agent.LlamaIndex>, spec?: TouchSpec): ObjList<GenaiCore.Agent.LlamaIndex> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Agent.LlamaIndex>, spec?: MergeSpec): ObjList<GenaiCore.Agent.LlamaIndex> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Agent.LlamaIndex>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Agent.LlamaIndex> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<GenaiCore.Agent.LlamaIndex> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Agent.LlamaIndex> | null;
     ...
     */
    static mergeAll(mergeObj: GenaiCore.Agent.LlamaIndex, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: GenaiCore.Agent.LlamaIndex, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<GenaiCore.Agent.LlamaIndex>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.LlamaIndex> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<GenaiCore.Agent.LlamaIndex>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.LlamaIndex> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): GenaiCore.Agent.LlamaIndex | null;
     ...
     */
    static beforeCreate(objs: Array_Type<GenaiCore.Agent.LlamaIndex>): ObjList<GenaiCore.Agent.LlamaIndex>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<GenaiCore.Agent.LlamaIndex>): ObjList<GenaiCore.Agent.LlamaIndex>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<GenaiCore.Agent.LlamaIndex>): ObjList<GenaiCore.Agent.LlamaIndex>;
     ...
     */
    static afterCreate(objs: Array_Type<GenaiCore.Agent.LlamaIndex>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<GenaiCore.Agent.LlamaIndex>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<GenaiCore.Agent.LlamaIndex>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<GenaiCore.Agent.LlamaIndex>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GenaiCore.Agent.LlamaIndex>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.Agent.LlamaIndex | null;
     ...
     */
    withoutIdentity(): GenaiCore.Agent.LlamaIndex | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<GenaiCore.Agent.LlamaIndex>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: GenaiCore.Agent.LlamaIndex, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<GenaiCore.Agent.LlamaIndex>, callback?: λFunction<GenaiCore.Agent.LlamaIndex | null, GenaiCore.Agent.LlamaIndex | null>): ObjList<GenaiCore.Agent.LlamaIndex>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<GenaiCore.Agent.LlamaIndex>, callback?: λFunction<GenaiCore.Agent.LlamaIndex | null, GenaiCore.Agent.LlamaIndex | null>): Array_Type<ObjError> | null;
     ...
     */
    runQuery(query: string, sessionId?: string): any;
     ...
     */
    initialize(agentName?: string = '"FunctionAgent"', force?: boolean): any;
  }
}
