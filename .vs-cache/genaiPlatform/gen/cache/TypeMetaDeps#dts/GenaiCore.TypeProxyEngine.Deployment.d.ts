// TypeScript definitions for the C3 type GenaiCore.TypeProxyEngine.Deployment

/**
 * Deployment configuration to associate fields to {@link GenaiCore.TypeProxyEngine}.
 * @see GenaiCore.TypeProxyEngine.DeployBase
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.TypeProxyEngine.Deployment
 */
declare namespace GenaiCore.TypeProxyEngine {
...
declare namespace GenaiCore.TypeProxyEngine {
  export class Deployment extends Obj  {
    ...
    withName(name: string): GenaiCore.TypeProxyEngine.Deployment;
    ...
    withNodeRole(nodeRole: string | null): GenaiCore.TypeProxyEngine.Deployment;
    ...
    withAltNodeRoles(altNodeRoles: Array_Type<string> | Array<string> | null): GenaiCore.TypeProxyEngine.Deployment;
    ...
    withNodePools(nodePools: Array_Type<string> | Array<string> | null): GenaiCore.TypeProxyEngine.Deployment;
    ...
    withDedicatedThreadPool(dedicatedThreadPool: boolean): GenaiCore.TypeProxyEngine.Deployment;

    /**
     * If set to `true` then this {@link Engine} will auto start on every node of every target node-pool.
     */
    readonly autoStart?: boolean;
    withAutoStart(autoStart: boolean): GenaiCore.TypeProxyEngine.Deployment;
    ...
    withInactive(inactive: boolean): GenaiCore.TypeProxyEngine.Deployment;
    ...
    withFailActionIfEngineNotReady(failActionIfEngineNotReady: boolean): GenaiCore.TypeProxyEngine.Deployment;
    ...
    withInitializingNodeAvoidanceDuration(initializingNodeAvoidanceDuration: string | null): GenaiCore.TypeProxyEngine.Deployment;

    readonly configOverride?: string;
    withConfigOverride(configOverride: string | null): GenaiCore.TypeProxyEngine.Deployment;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): GenaiCore.TypeProxyEngine.Deployment;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: Array_Type<string>;
    withIssues(issues: Array_Type<string> | Array<string> | null): GenaiCore.TypeProxyEngine.Deployment;

    /**
     * The {@link GenaiCore.TypeProxyEngine} will invoke all actions on this instance.
     */
    readonly instance: Obj;
    withInstance(instance: IObj): GenaiCore.TypeProxyEngine.Deployment;

    /**
     * Initialization and all subsequent actions will be run in an runtime that meets this action requirement.
     */
    readonly actionRequirement: string;
    withActionRequirement(actionRequirement: string): GenaiCore.TypeProxyEngine.Deployment;
    ...
    withInitFuncName(initFuncName: string | null): GenaiCore.TypeProxyEngine.Deployment;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.TypeProxyEngine.Deployment | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.TypeProxyEngine.Deployment | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.TypeProxyEngine.Deployment | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.TypeProxyEngine.Deployment | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.TypeProxyEngine.Deployment;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.TypeProxyEngine.Deployment;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.TypeProxyEngine.Deployment;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.TypeProxyEngine.Deployment>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.TypeProxyEngine.Deployment>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.TypeProxyEngine.Deployment;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.TypeProxyEngine.Deployment;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.TypeProxyEngine.Deployment;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.TypeProxyEngine.Deployment;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.TypeProxyEngine.Deployment;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.TypeProxyEngine.Deployment;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.TypeProxyEngine.Deployment;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.TypeProxyEngine.Deployment;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.TypeProxyEngine.Deployment;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.TypeProxyEngine.Deployment;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.TypeProxyEngine.Deployment;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.TypeProxyEngine.Deployment;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.TypeProxyEngine.Deployment;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.TypeProxyEngine.Deployment;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.TypeProxyEngine.Deployment;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.TypeProxyEngine.Deployment;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.TypeProxyEngine.Deployment;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.TypeProxyEngine.Deployment;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.TypeProxyEngine.Deployment;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.TypeProxyEngine.Deployment;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.TypeProxyEngine.Deployment;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.TypeProxyEngine.Deployment;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.TypeProxyEngine.Deployment;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.TypeProxyEngine.Deployment;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.TypeProxyEngine.Deployment;

    mergeJson(json: any): GenaiCore.TypeProxyEngine.Deployment;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.TypeProxyEngine.Deployment;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.TypeProxyEngine.Deployment;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.TypeProxyEngine.Deployment>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.TypeProxyEngine.Deployment> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.TypeProxyEngine.Deployment> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.TypeProxyEngine.Deployment>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.TypeProxyEngine.Deployment> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.TypeProxyEngine.Deployment> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.TypeProxyEngine.Deployment> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.TypeProxyEngine.Deployment>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.TypeProxyEngine.Deployment>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.TypeProxyEngine.Deployment;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.TypeProxyEngine.Deployment;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.TypeProxyEngine.Deployment;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.TypeProxyEngine.Deployment;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.TypeProxyEngine.Deployment;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.TypeProxyEngine.Deployment;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.TypeProxyEngine.Deployment | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.TypeProxyEngine.Deployment;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.TypeProxyEngine.Deployment;
     ...
     */
    static cachedEmptyInst(): GenaiCore.TypeProxyEngine.Deployment;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.TypeProxyEngine.Deployment> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.TypeProxyEngine.Deployment;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.TypeProxyEngine.Deployment | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): GenaiCore.TypeProxyEngine.Deployment | null;
     ...
     */
    static allCached(): Stream<GenaiCore.TypeProxyEngine.Deployment> | null;
     ...
     */
    static find(filter?: string): Stream<GenaiCore.TypeProxyEngine.Deployment> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<GenaiCore.TypeProxyEngine.Deployment> | null;

    /**
     * @return cached instance.
     */
    getCached(): GenaiCore.TypeProxyEngine.Deployment | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): GenaiCore.TypeProxyEngine.Deployment | null;
     ...
     */
    static produce(key: string): GenaiCore.TypeProxyEngine.Deployment | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, GenaiCore.TypeProxyEngine.Deployment> | null;
     ...
     */
    getConfig(): GenaiCore.TypeProxyEngine.Deployment;
     ...
     */
    getSecret(): GenaiCore.TypeProxyEngine.Deployment;
     ...
     */
    withConfigKey(configKey: string): GenaiCore.TypeProxyEngine.Deployment;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): GenaiCore.TypeProxyEngine.Deployment;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): GenaiCore.TypeProxyEngine.Deployment | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<GenaiCore.TypeProxyEngine.Deployment> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: GenaiCore.TypeProxyEngine.Deployment, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): GenaiCore.TypeProxyEngine.Deployment | null;
     ...
     */
    engineType(): Type<<GenaiCore.TypeProxyEngine>> | null;
     ...
     */
    static fromDeploySpec(spec: Engine.DeploySpec): GenaiCore.TypeProxyEngine.Deployment | null;
  }
}
