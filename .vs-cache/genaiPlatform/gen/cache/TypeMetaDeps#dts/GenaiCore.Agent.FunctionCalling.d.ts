// TypeScript definitions for the C3 type GenaiCore.Agent.FunctionCalling
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Agent.FunctionCalling
 */
declare namespace GenaiCore.Agent {
  export interface IFunctionCalling {
     ...
     */
    llmClient?: IGenaiCore.Llm.Client;
     ...
     */
    tools?: Array_Type<GenaiCore.Tool | GenaiCore.Toolkit> | Array<IGenaiCore.Tool | IGenaiCore.Toolkit>;

    /**
     * {@link Session store GenaiCore.SessionStore} used by this agent, for short term memory only.
     */
    shortTermMemoryStore?: IGenaiCore.SessionStore;
  }
}
 ...
 */
declare namespace GenaiCore.Agent {
  export class FunctionCalling extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): GenaiCore.Agent.FunctionCalling;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GenaiCore.Agent.FunctionCalling;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): GenaiCore.Agent.FunctionCalling;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): GenaiCore.Agent.FunctionCalling;
    ...
    withVersion(version: number | null): GenaiCore.Agent.FunctionCalling;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): GenaiCore.Agent.FunctionCalling;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): GenaiCore.Agent.FunctionCalling;
    ...
    withHidden(hidden: boolean): GenaiCore.Agent.FunctionCalling;
    ...
    withUserOwned(userOwned: boolean): GenaiCore.Agent.FunctionCalling;
    ...
    withTypeIdent(typeIdent: string | null): GenaiCore.Agent.FunctionCalling;
    ...
    withDescription(description: string | null): GenaiCore.Agent.FunctionCalling;

    /**
     * System prompt used to define the behavior of this agent.
     */
    readonly systemPrompt?: string;
    withSystemPrompt(systemPrompt: string | null): GenaiCore.Agent.FunctionCalling;

    /**
     * {@link Llm client GenaiCore.Llm.Client} that manages auth, routing strategy, configurations, etc.
     */
    readonly llmClient?: GenaiCore.Llm.Client;
    withLlmClient(llmClient: IGenaiCore.Llm.Client | null): GenaiCore.Agent.FunctionCalling;

    /**
     * {@link Toolkit GenaiCore.Toolkit} used by this agent. Note that it could be nested, use {@link GenaiCore.Toolkit#allTools} to get all tools available.
     */
    readonly tools?: Array_Type<GenaiCore.Tool | GenaiCore.Toolkit>;
    withTools(tools: Array_Type<GenaiCore.Tool | GenaiCore.Toolkit> | Array<IGenaiCore.Tool | IGenaiCore.Toolkit> | null): GenaiCore.Agent.FunctionCalling;

    /**
     * {@link Session store GenaiCore.SessionStore} used by this agent, for short term memory only.
     */
    readonly shortTermMemoryStore?: GenaiCore.SessionStore;
    withShortTermMemoryStore(shortTermMemoryStore: IGenaiCore.SessionStore | null): GenaiCore.Agent.FunctionCalling;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Agent.FunctionCalling | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Agent.FunctionCalling | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Agent.FunctionCalling | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Agent.FunctionCalling | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Agent.FunctionCalling;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Agent.FunctionCalling;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Agent.FunctionCalling;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Agent.FunctionCalling>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Agent.FunctionCalling>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Agent.FunctionCalling;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Agent.FunctionCalling;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Agent.FunctionCalling;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Agent.FunctionCalling;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Agent.FunctionCalling;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Agent.FunctionCalling;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Agent.FunctionCalling;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Agent.FunctionCalling;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Agent.FunctionCalling;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Agent.FunctionCalling;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Agent.FunctionCalling;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Agent.FunctionCalling;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Agent.FunctionCalling;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Agent.FunctionCalling;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Agent.FunctionCalling;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Agent.FunctionCalling;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Agent.FunctionCalling;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Agent.FunctionCalling;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Agent.FunctionCalling;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Agent.FunctionCalling;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Agent.FunctionCalling;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Agent.FunctionCalling;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Agent.FunctionCalling;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Agent.FunctionCalling;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Agent.FunctionCalling;

    mergeJson(json: any): GenaiCore.Agent.FunctionCalling;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Agent.FunctionCalling;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Agent.FunctionCalling;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Agent.FunctionCalling>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Agent.FunctionCalling> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Agent.FunctionCalling> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Agent.FunctionCalling>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Agent.FunctionCalling> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Agent.FunctionCalling> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Agent.FunctionCalling> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Agent.FunctionCalling>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Agent.FunctionCalling>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Agent.FunctionCalling;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Agent.FunctionCalling;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Agent.FunctionCalling;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Agent.FunctionCalling;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Agent.FunctionCalling;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Agent.FunctionCalling;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.Agent.FunctionCalling | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Agent.FunctionCalling;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Agent.FunctionCalling;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Agent.FunctionCalling;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Agent.FunctionCalling> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Agent.FunctionCalling;
     ...
     */
    static allCached(): Stream<GenaiCore.Agent.FunctionCalling> | null;
     ...
     */
    static find(filter?: string): Stream<GenaiCore.Agent.FunctionCalling> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<GenaiCore.Agent.FunctionCalling> | null;

    /**
     * @return cached instance.
     */
    getCached(): GenaiCore.Agent.FunctionCalling | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): GenaiCore.Agent.FunctionCalling | null;
     ...
     */
    static produce(key: string): GenaiCore.Agent.FunctionCalling | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, GenaiCore.Agent.FunctionCalling> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<GenaiCore.Agent.FunctionCalling>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<GenaiCore.Agent.FunctionCalling>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<GenaiCore.Agent.FunctionCalling> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenaiCore.Agent.FunctionCalling>> | null;
     ...
     */
    get(include?: string): GenaiCore.Agent.FunctionCalling | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): GenaiCore.Agent.FunctionCalling | null;
     ...
     */
    getMissing(spec: GetMissingSpec): GenaiCore.Agent.FunctionCalling;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): GenaiCore.Agent.FunctionCalling | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): GenaiCore.Agent.FunctionCalling;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.Agent.FunctionCalling | null;
     ...
     */
    create(spec?: UpsertSpec): GenaiCore.Agent.FunctionCalling | null;
     ...
     */
    static createBatch(objs: Array_Type<GenaiCore.Agent.FunctionCalling>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.FunctionCalling> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<GenaiCore.Agent.FunctionCalling>, spec?: CreateBatchObjStreamSpec): ObjList<GenaiCore.Agent.FunctionCalling> | null;
     ...
     */
    update(srcObj?: GenaiCore.Agent.FunctionCalling, spec?: UpsertSpec): GenaiCore.Agent.FunctionCalling | null;
     ...
     */
    upsert(srcObj?: GenaiCore.Agent.FunctionCalling, spec?: UpsertSpec): GenaiCore.Agent.FunctionCalling | null;
     ...
     */
    merge(spec?: MergeSpec): GenaiCore.Agent.FunctionCalling | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): GenaiCore.Agent.FunctionCalling | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): GenaiCore.Agent.FunctionCalling | null;
     ...
     */
    static updateBatch(objs: Array_Type<GenaiCore.Agent.FunctionCalling>, srcObjs?: Array_Type<GenaiCore.Agent.FunctionCalling>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.FunctionCalling> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<GenaiCore.Agent.FunctionCalling> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.FunctionCalling> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<GenaiCore.Agent.FunctionCalling>, srcObjs?: Array_Type<GenaiCore.Agent.FunctionCalling>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.FunctionCalling> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<GenaiCore.Agent.FunctionCalling> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.FunctionCalling> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<GenaiCore.Agent.FunctionCalling>, spec?: TouchSpec): ObjList<GenaiCore.Agent.FunctionCalling> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Agent.FunctionCalling>, spec?: MergeSpec): ObjList<GenaiCore.Agent.FunctionCalling> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Agent.FunctionCalling>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Agent.FunctionCalling> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<GenaiCore.Agent.FunctionCalling> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Agent.FunctionCalling> | null;
     ...
     */
    static mergeAll(mergeObj: GenaiCore.Agent.FunctionCalling, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: GenaiCore.Agent.FunctionCalling, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<GenaiCore.Agent.FunctionCalling>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.FunctionCalling> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<GenaiCore.Agent.FunctionCalling>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.FunctionCalling> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): GenaiCore.Agent.FunctionCalling | null;
     ...
     */
    static beforeCreate(objs: Array_Type<GenaiCore.Agent.FunctionCalling>): ObjList<GenaiCore.Agent.FunctionCalling>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<GenaiCore.Agent.FunctionCalling>): ObjList<GenaiCore.Agent.FunctionCalling>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<GenaiCore.Agent.FunctionCalling>): ObjList<GenaiCore.Agent.FunctionCalling>;
     ...
     */
    static afterCreate(objs: Array_Type<GenaiCore.Agent.FunctionCalling>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<GenaiCore.Agent.FunctionCalling>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<GenaiCore.Agent.FunctionCalling>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<GenaiCore.Agent.FunctionCalling>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GenaiCore.Agent.FunctionCalling>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.Agent.FunctionCalling | null;
     ...
     */
    withoutIdentity(): GenaiCore.Agent.FunctionCalling | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<GenaiCore.Agent.FunctionCalling>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: GenaiCore.Agent.FunctionCalling, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<GenaiCore.Agent.FunctionCalling>, callback?: λFunction<GenaiCore.Agent.FunctionCalling | null, GenaiCore.Agent.FunctionCalling | null>): ObjList<GenaiCore.Agent.FunctionCalling>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<GenaiCore.Agent.FunctionCalling>, callback?: λFunction<GenaiCore.Agent.FunctionCalling | null, GenaiCore.Agent.FunctionCalling | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): GenaiCore.Agent.FunctionCalling;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.FunctionCalling> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): GenaiCore.Agent.FunctionCalling | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.FunctionCalling> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): GenaiCore.Agent.FunctionCalling | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.FunctionCalling> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): GenaiCore.Agent.FunctionCalling | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<GenaiCore.Agent.FunctionCalling> | null;
    ...
    dependencies(): SeedDataDeps<GenaiCore.Agent.FunctionCalling> | null;
     ...
     */
    run(query?: any, kwargs?: Map_Type<string, any>): any | null;
     ...
     * @return result of running this agent
     */
    doRun(query?: any, kwargs?: Map_Type<string, any>): any | null;
     ...
     */
    static uiConfigurableFields(): Map_Type<string, any> | null;
     ...
     */
    createDraft(spec?: GenaiCore.Agent.CreateDraftSpec): GenaiCore.Agent.Draft;
     ...
     */
    deploy(spec?: GenaiCore.Agent.DeploySpec): GenaiCore.Agent.Deployment;
     ...
     */
    initialize(force?: boolean, spec?: GenaiCore.Agent.InitSpec): GenaiCore.Agent | null;
  }
}
