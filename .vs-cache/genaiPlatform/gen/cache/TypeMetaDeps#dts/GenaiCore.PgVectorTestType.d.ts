// TypeScript definitions for the C3 type GenaiCore.PgVectorTestType

/**
 * Example entity vector type, used to test {@link GenaiCore.VectorStore.Pg}.
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.PgVectorTestType
 */
declare namespace GenaiCore {
  export interface IPgVectorTestType {

    /**
     * The content that corresponds to this vector. {@see #contentToEmbed}
     * e.g. "To address fault code AXZ, first replace part A...."
     */
    content?: string;

    /**
     * The content that was passed to the embedding model to generate #embedding. This may differ from #content if
     * one wants to add additional context or metadata to actual source content in order to improve the quality of
     * similarity search.
     * e.g. "Excerpt from Boiler Repair Manual pdf: To address fault code AXZ, first replace part A..."
     */
    ...
    /**
     * The unique 'name' (often including complete path) of the source file, e.g. "/my/directory/boiler-repair-manual.pdf"
     */
    source?: string;

    /**
     * ID of the job run that generated the vector.
     */
    jobRunId?: string;

    /**
     * The type of the job run that generated the vector.
     */
    jobRunType?: string;

    /**
     * Extra information associated with the vector.
     * NOTE: due to the free-form nature of this field, the values of the map are not indexed and therefore will not
     * be available for metadata filtering in {@link GenaiCore.SimilaritySearchSpec#metadataFilter}.
     */
    details?: Map_Type<string, any> | {[key: string]: any};

    /**
     * ID of the parent job of the job run that generated the vector. This allows tracing the vector back to the
     * originating job if the job run has been cleaned up by `unstructured-job-run-cleanup`.
     */
    jobId?: string;

    /**
     * The type of the parent job of the job run that generated the vector.
     */
    jobType?: string;
    ...
    /**
     * The second vector of the entity.
     */
    emb2?: string;
     ...
     * The document
     */
    doc?: IGenaiCore.DocumentTestType;

    /**
     * The tags
     */
    tags?: Array_Type<string> | Array<string>;
  }
}
 ...
 * Example entity vector type, used to test {@link GenaiCore.VectorStore.Pg}.
 *
 * @remarks this represents a made instance of GenaiCore.PgVectorTestType
 */
declare namespace GenaiCore {
  export class PgVectorTestType extends Obj  {
    ...
    withContent(content: string | null): GenaiCore.PgVectorTestType;
     ...
     * e.g. "Excerpt from Boiler Repair Manual pdf: To address fault code AXZ, first replace part A..."
     */
    readonly contentToEmbed?: string;
    withContentToEmbed(contentToEmbed: string | null): GenaiCore.PgVectorTestType;
    ...
    withEmbedding(embedding: string): GenaiCore.PgVectorTestType;

    /**
     * The unique 'name' (often including complete path) of the source file, e.g. "/my/directory/boiler-repair-manual.pdf"
     */
    readonly source?: string;
    withSource(source: string | null): GenaiCore.PgVectorTestType;

    /**
     * ID of the job run that generated the vector.
     */
    readonly jobRunId?: string;
    withJobRunId(jobRunId: string | null): GenaiCore.PgVectorTestType;

    /**
     * The type of the job run that generated the vector.
     */
    readonly jobRunType?: string;
    withJobRunType(jobRunType: string | null): GenaiCore.PgVectorTestType;
     ...
     * be available for metadata filtering in {@link GenaiCore.SimilaritySearchSpec#metadataFilter}.
     */
    readonly details?: Map_Type<string, any>;
    withDetails(details: Map_Type<string, any> | {[key: string]: any} | null): GenaiCore.PgVectorTestType;
    ...
    withJobId(jobId: string | null): GenaiCore.PgVectorTestType;

    /**
     * The type of the parent job of the job run that generated the vector.
     */
    readonly jobType?: string;
    withJobType(jobType: string | null): GenaiCore.PgVectorTestType;
     ...
     */
    readonly id: string;
    withId(id: string): GenaiCore.PgVectorTestType;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GenaiCore.PgVectorTestType;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): GenaiCore.PgVectorTestType;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): GenaiCore.PgVectorTestType;
    ...
    withVersion(version: number | null): GenaiCore.PgVectorTestType;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): GenaiCore.PgVectorTestType;

    /**
     * The text of the entity.
     */
    readonly text?: string;
    withText(text: string | null): GenaiCore.PgVectorTestType;

    /**
     * The vector of the entity.
     */
    readonly emb1?: string;
    withEmb1(emb1: string | null): GenaiCore.PgVectorTestType;

    /**
     * The second vector of the entity.
     */
    readonly emb2?: string;
    withEmb2(emb2: string | null): GenaiCore.PgVectorTestType;

    /**
     * The page number
     */
    readonly pageNumber?: number;
    withPageNumber(pageNumber: number | null): GenaiCore.PgVectorTestType;

    /**
     * The chunk number
     */
    readonly chunkNumber?: number;
    withChunkNumber(chunkNumber: number | null): GenaiCore.PgVectorTestType;

    /**
     * The document
     */
    readonly doc?: GenaiCore.DocumentTestType;
    withDoc(doc: IGenaiCore.DocumentTestType | null): GenaiCore.PgVectorTestType;

    /**
     * The tags
     */
    readonly tags?: Array_Type<string>;
    withTags(tags: Array_Type<string> | Array<string> | null): GenaiCore.PgVectorTestType;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.PgVectorTestType | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.PgVectorTestType | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.PgVectorTestType | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.PgVectorTestType | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.PgVectorTestType;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.PgVectorTestType;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.PgVectorTestType;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.PgVectorTestType>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.PgVectorTestType>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.PgVectorTestType;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.PgVectorTestType;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.PgVectorTestType;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.PgVectorTestType;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.PgVectorTestType;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.PgVectorTestType;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.PgVectorTestType;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.PgVectorTestType;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.PgVectorTestType;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.PgVectorTestType;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.PgVectorTestType;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.PgVectorTestType;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.PgVectorTestType;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.PgVectorTestType;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.PgVectorTestType;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.PgVectorTestType;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.PgVectorTestType;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.PgVectorTestType;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.PgVectorTestType;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.PgVectorTestType;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.PgVectorTestType;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.PgVectorTestType;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.PgVectorTestType;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.PgVectorTestType;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.PgVectorTestType;

    mergeJson(json: any): GenaiCore.PgVectorTestType;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.PgVectorTestType;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.PgVectorTestType;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.PgVectorTestType>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.PgVectorTestType> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.PgVectorTestType> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.PgVectorTestType>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.PgVectorTestType> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.PgVectorTestType> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.PgVectorTestType> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.PgVectorTestType>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.PgVectorTestType>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.PgVectorTestType;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.PgVectorTestType;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.PgVectorTestType;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.PgVectorTestType;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.PgVectorTestType;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.PgVectorTestType;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.PgVectorTestType | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.PgVectorTestType;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.PgVectorTestType;
     ...
     */
    static cachedEmptyInst(): GenaiCore.PgVectorTestType;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.PgVectorTestType> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.PgVectorTestType;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<GenaiCore.PgVectorTestType>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<GenaiCore.PgVectorTestType>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<GenaiCore.PgVectorTestType> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenaiCore.PgVectorTestType>> | null;
     ...
     */
    get(include?: string): GenaiCore.PgVectorTestType | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): GenaiCore.PgVectorTestType | null;
     ...
     */
    getMissing(spec: GetMissingSpec): GenaiCore.PgVectorTestType;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): GenaiCore.PgVectorTestType | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): GenaiCore.PgVectorTestType;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.PgVectorTestType | null;
     ...
     */
    create(spec?: UpsertSpec): GenaiCore.PgVectorTestType | null;
     ...
     */
    static createBatch(objs: Array_Type<GenaiCore.PgVectorTestType>, spec?: UpsertSpec): ObjList<GenaiCore.PgVectorTestType> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<GenaiCore.PgVectorTestType>, spec?: CreateBatchObjStreamSpec): ObjList<GenaiCore.PgVectorTestType> | null;
     ...
     */
    update(srcObj?: GenaiCore.PgVectorTestType, spec?: UpsertSpec): GenaiCore.PgVectorTestType | null;
     ...
     */
    upsert(srcObj?: GenaiCore.PgVectorTestType, spec?: UpsertSpec): GenaiCore.PgVectorTestType | null;
     ...
     */
    merge(spec?: MergeSpec): GenaiCore.PgVectorTestType | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): GenaiCore.PgVectorTestType | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): GenaiCore.PgVectorTestType | null;
     ...
     */
    static updateBatch(objs: Array_Type<GenaiCore.PgVectorTestType>, srcObjs?: Array_Type<GenaiCore.PgVectorTestType>, spec?: UpsertSpec): ObjList<GenaiCore.PgVectorTestType> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<GenaiCore.PgVectorTestType> | null>, spec?: UpsertSpec): ObjList<GenaiCore.PgVectorTestType> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<GenaiCore.PgVectorTestType>, srcObjs?: Array_Type<GenaiCore.PgVectorTestType>, spec?: UpsertSpec): ObjList<GenaiCore.PgVectorTestType> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<GenaiCore.PgVectorTestType> | null>, spec?: UpsertSpec): ObjList<GenaiCore.PgVectorTestType> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<GenaiCore.PgVectorTestType>, spec?: TouchSpec): ObjList<GenaiCore.PgVectorTestType> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.PgVectorTestType>, spec?: MergeSpec): ObjList<GenaiCore.PgVectorTestType> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.PgVectorTestType>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.PgVectorTestType> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<GenaiCore.PgVectorTestType> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.PgVectorTestType> | null;
     ...
     */
    static mergeAll(mergeObj: GenaiCore.PgVectorTestType, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: GenaiCore.PgVectorTestType, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<GenaiCore.PgVectorTestType>, spec?: UpsertSpec): ObjList<GenaiCore.PgVectorTestType> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<GenaiCore.PgVectorTestType>, spec?: UpsertSpec): ObjList<GenaiCore.PgVectorTestType> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): GenaiCore.PgVectorTestType | null;
     ...
     */
    static beforeCreate(objs: Array_Type<GenaiCore.PgVectorTestType>): ObjList<GenaiCore.PgVectorTestType>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<GenaiCore.PgVectorTestType>): ObjList<GenaiCore.PgVectorTestType>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<GenaiCore.PgVectorTestType>): ObjList<GenaiCore.PgVectorTestType>;
     ...
     */
    static afterCreate(objs: Array_Type<GenaiCore.PgVectorTestType>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<GenaiCore.PgVectorTestType>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<GenaiCore.PgVectorTestType>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<GenaiCore.PgVectorTestType>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GenaiCore.PgVectorTestType>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.PgVectorTestType | null;
     ...
     */
    withoutIdentity(): GenaiCore.PgVectorTestType | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<GenaiCore.PgVectorTestType>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: GenaiCore.PgVectorTestType, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<GenaiCore.PgVectorTestType>, callback?: λFunction<GenaiCore.PgVectorTestType | null, GenaiCore.PgVectorTestType | null>): ObjList<GenaiCore.PgVectorTestType>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<GenaiCore.PgVectorTestType>, callback?: λFunction<GenaiCore.PgVectorTestType | null, GenaiCore.PgVectorTestType | null>): Array_Type<ObjError> | null;
