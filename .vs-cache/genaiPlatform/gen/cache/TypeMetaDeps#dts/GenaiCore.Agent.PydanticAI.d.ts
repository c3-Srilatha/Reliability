// TypeScript definitions for the C3 type GenaiCore.Agent.PydanticAI
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Agent.PydanticAI
 */
declare namespace GenaiCore.Agent {
  export interface IPydanticAI {
     ...
     */
    sessionStore: IGenaiCore.SessionStore;

    /**
     * Collection of tools available to the agent
     */
    toolkit: IGenaiCore.Toolkit;
 ...
 */
declare namespace GenaiCore.Agent {
  export class PydanticAI extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): GenaiCore.Agent.PydanticAI;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GenaiCore.Agent.PydanticAI;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): GenaiCore.Agent.PydanticAI;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): GenaiCore.Agent.PydanticAI;
    ...
    withVersion(version: number | null): GenaiCore.Agent.PydanticAI;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): GenaiCore.Agent.PydanticAI;

    /**
     * Session store for persisting session state between queries.
     */
    readonly sessionStore: GenaiCore.SessionStore;
    withSessionStore(sessionStore: IGenaiCore.SessionStore): GenaiCore.Agent.PydanticAI;

    /**
     * Collection of tools available to the agent
     */
    readonly toolkit: GenaiCore.Toolkit;
    withToolkit(toolkit: IGenaiCore.Toolkit): GenaiCore.Agent.PydanticAI;

    /**
     * The system prompt that defines the behavior of the agent.
     */
    readonly systemPrompt: string;
    withSystemPrompt(systemPrompt: string): GenaiCore.Agent.PydanticAI;

    /**
     * The llm used by the agent. Auth is set manually, and usage of this llm is currently ignored.
     */
    readonly llm: GenaiCore.Llm.Client;
    withLlm(llm: IGenaiCore.Llm.Client): GenaiCore.Agent.PydanticAI;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Agent.PydanticAI | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Agent.PydanticAI | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Agent.PydanticAI | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Agent.PydanticAI | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Agent.PydanticAI;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Agent.PydanticAI;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Agent.PydanticAI;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Agent.PydanticAI>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Agent.PydanticAI>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Agent.PydanticAI;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Agent.PydanticAI;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Agent.PydanticAI;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Agent.PydanticAI;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Agent.PydanticAI;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Agent.PydanticAI;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Agent.PydanticAI;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Agent.PydanticAI;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Agent.PydanticAI;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Agent.PydanticAI;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Agent.PydanticAI;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Agent.PydanticAI;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Agent.PydanticAI;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Agent.PydanticAI;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Agent.PydanticAI;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Agent.PydanticAI;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Agent.PydanticAI;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Agent.PydanticAI;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Agent.PydanticAI;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Agent.PydanticAI;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Agent.PydanticAI;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Agent.PydanticAI;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Agent.PydanticAI;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Agent.PydanticAI;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Agent.PydanticAI;

    mergeJson(json: any): GenaiCore.Agent.PydanticAI;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Agent.PydanticAI;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Agent.PydanticAI;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Agent.PydanticAI>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Agent.PydanticAI> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Agent.PydanticAI> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Agent.PydanticAI>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Agent.PydanticAI> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Agent.PydanticAI> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Agent.PydanticAI> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Agent.PydanticAI>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Agent.PydanticAI>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Agent.PydanticAI;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Agent.PydanticAI;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Agent.PydanticAI;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Agent.PydanticAI;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Agent.PydanticAI;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Agent.PydanticAI;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.Agent.PydanticAI | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Agent.PydanticAI;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Agent.PydanticAI;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Agent.PydanticAI;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Agent.PydanticAI> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Agent.PydanticAI;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<GenaiCore.Agent.PydanticAI>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<GenaiCore.Agent.PydanticAI>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<GenaiCore.Agent.PydanticAI> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenaiCore.Agent.PydanticAI>> | null;
     ...
     */
    get(include?: string): GenaiCore.Agent.PydanticAI | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): GenaiCore.Agent.PydanticAI | null;
     ...
     */
    getMissing(spec: GetMissingSpec): GenaiCore.Agent.PydanticAI;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): GenaiCore.Agent.PydanticAI | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): GenaiCore.Agent.PydanticAI;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.Agent.PydanticAI | null;
     ...
     */
    create(spec?: UpsertSpec): GenaiCore.Agent.PydanticAI | null;
     ...
     */
    static createBatch(objs: Array_Type<GenaiCore.Agent.PydanticAI>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.PydanticAI> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<GenaiCore.Agent.PydanticAI>, spec?: CreateBatchObjStreamSpec): ObjList<GenaiCore.Agent.PydanticAI> | null;
     ...
     */
    update(srcObj?: GenaiCore.Agent.PydanticAI, spec?: UpsertSpec): GenaiCore.Agent.PydanticAI | null;
     ...
     */
    upsert(srcObj?: GenaiCore.Agent.PydanticAI, spec?: UpsertSpec): GenaiCore.Agent.PydanticAI | null;
     ...
     */
    merge(spec?: MergeSpec): GenaiCore.Agent.PydanticAI | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): GenaiCore.Agent.PydanticAI | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): GenaiCore.Agent.PydanticAI | null;
     ...
     */
    static updateBatch(objs: Array_Type<GenaiCore.Agent.PydanticAI>, srcObjs?: Array_Type<GenaiCore.Agent.PydanticAI>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.PydanticAI> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<GenaiCore.Agent.PydanticAI> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.PydanticAI> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<GenaiCore.Agent.PydanticAI>, srcObjs?: Array_Type<GenaiCore.Agent.PydanticAI>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.PydanticAI> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<GenaiCore.Agent.PydanticAI> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.PydanticAI> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<GenaiCore.Agent.PydanticAI>, spec?: TouchSpec): ObjList<GenaiCore.Agent.PydanticAI> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Agent.PydanticAI>, spec?: MergeSpec): ObjList<GenaiCore.Agent.PydanticAI> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Agent.PydanticAI>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Agent.PydanticAI> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<GenaiCore.Agent.PydanticAI> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Agent.PydanticAI> | null;
     ...
     */
    static mergeAll(mergeObj: GenaiCore.Agent.PydanticAI, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: GenaiCore.Agent.PydanticAI, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<GenaiCore.Agent.PydanticAI>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.PydanticAI> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<GenaiCore.Agent.PydanticAI>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.PydanticAI> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): GenaiCore.Agent.PydanticAI | null;
     ...
     */
    static beforeCreate(objs: Array_Type<GenaiCore.Agent.PydanticAI>): ObjList<GenaiCore.Agent.PydanticAI>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<GenaiCore.Agent.PydanticAI>): ObjList<GenaiCore.Agent.PydanticAI>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<GenaiCore.Agent.PydanticAI>): ObjList<GenaiCore.Agent.PydanticAI>;
     ...
     */
    static afterCreate(objs: Array_Type<GenaiCore.Agent.PydanticAI>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<GenaiCore.Agent.PydanticAI>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<GenaiCore.Agent.PydanticAI>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<GenaiCore.Agent.PydanticAI>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GenaiCore.Agent.PydanticAI>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.Agent.PydanticAI | null;
     ...
     */
    withoutIdentity(): GenaiCore.Agent.PydanticAI | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<GenaiCore.Agent.PydanticAI>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: GenaiCore.Agent.PydanticAI, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<GenaiCore.Agent.PydanticAI>, callback?: λFunction<GenaiCore.Agent.PydanticAI | null, GenaiCore.Agent.PydanticAI | null>): ObjList<GenaiCore.Agent.PydanticAI>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<GenaiCore.Agent.PydanticAI>, callback?: λFunction<GenaiCore.Agent.PydanticAI | null, GenaiCore.Agent.PydanticAI | null>): Array_Type<ObjError> | null;
     ...
     */
    runQuery(query: string, sessionId?: string): GenaiCore.Agent.PydanticAI.QueryResult;
