// TypeScript definitions for the C3 type GenaiCore.Llm.Mis.Model
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Llm.Mis.Model
 */
declare namespace GenaiCore.Llm.Mis {
...
declare namespace GenaiCore.Llm.Mis {
  export class Model extends Obj  {
    ...
    withModel(model: string): GenaiCore.Llm.Mis.Model;
    ...
    withAuth(auth: IGenaiCore.Llm.Auth | null): GenaiCore.Llm.Mis.Model;
    ...
    withProcessor(processor: IGenaiCore.Llm.Processor | null): GenaiCore.Llm.Mis.Model;
    ...
    withDefaultOptions(defaultOptions: any | null): GenaiCore.Llm.Mis.Model;

    /**
     * If set, then the legacy single-completion API {@link ModelInference#completion} will be used.
     * If not, then the {@link ModelInference} chat completion API will be used.
     */
    readonly useLegacyMisApi?: boolean;
    withUseLegacyMisApi(useLegacyMisApi: boolean): GenaiCore.Llm.Mis.Model;

    /**
     * Set this to `true` if {@link #model} supports image inputs for chat completion.
     */
    readonly inferenceSupportsVision?: boolean;
    withInferenceSupportsVision(inferenceSupportsVision: boolean): GenaiCore.Llm.Mis.Model;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Llm.Mis.Model | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Llm.Mis.Model | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Llm.Mis.Model | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Llm.Mis.Model | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Llm.Mis.Model;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Llm.Mis.Model;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Llm.Mis.Model;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Llm.Mis.Model>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Llm.Mis.Model>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Llm.Mis.Model;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Llm.Mis.Model;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Llm.Mis.Model;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Llm.Mis.Model;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Llm.Mis.Model;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Llm.Mis.Model;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Llm.Mis.Model;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Llm.Mis.Model;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Llm.Mis.Model;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Llm.Mis.Model;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Llm.Mis.Model;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Llm.Mis.Model;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Llm.Mis.Model;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Llm.Mis.Model;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Llm.Mis.Model;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Llm.Mis.Model;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Llm.Mis.Model;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Llm.Mis.Model;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Llm.Mis.Model;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Llm.Mis.Model;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Llm.Mis.Model;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Llm.Mis.Model;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Llm.Mis.Model;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Llm.Mis.Model;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Llm.Mis.Model;

    mergeJson(json: any): GenaiCore.Llm.Mis.Model;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Llm.Mis.Model;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Llm.Mis.Model;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Llm.Mis.Model>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Llm.Mis.Model> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Llm.Mis.Model> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Llm.Mis.Model>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Llm.Mis.Model> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Llm.Mis.Model> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Llm.Mis.Model> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Llm.Mis.Model>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Llm.Mis.Model>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Llm.Mis.Model;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Llm.Mis.Model;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Llm.Mis.Model;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Llm.Mis.Model;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Llm.Mis.Model;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Llm.Mis.Model;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Llm.Mis.Model;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Llm.Mis.Model;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Llm.Mis.Model;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Llm.Mis.Model> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Llm.Mis.Model;
