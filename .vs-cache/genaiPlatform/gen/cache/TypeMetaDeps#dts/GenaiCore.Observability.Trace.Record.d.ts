// TypeScript definitions for the C3 type GenaiCore.Observability.Trace.Record

/**
 * Entity type storing {@link GenaiCore.Observability.Trace}
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Observability.Trace.Record
 */
declare namespace GenaiCore.Observability.Trace {
  export interface IRecord {
     ...
     */
    spans?: Array_Type<Observability.Span.Record> | Array<IObservability.Span.Record>;
  }
}
...
declare namespace GenaiCore.Observability.Trace {
  export class Record extends Obj  {
    ...
    withName(name: string | null): GenaiCore.Observability.Trace.Record;
    ...
    withStartTime(startTime: DateTime | Date | string | null): GenaiCore.Observability.Trace.Record;
    ...
    withEndTime(endTime: DateTime | Date | string | null): GenaiCore.Observability.Trace.Record;
    ...
    withDurationInMillis(durationInMillis: number | null): GenaiCore.Observability.Trace.Record;

    /**
     * Number of {@link Observability.Span}s in this {@link Observability.Trace}.
     */
    readonly spanCount?: number;
    withSpanCount(spanCount: number | null): GenaiCore.Observability.Trace.Record;

    /**
     * Number of {@link Observability.Span}s in this {@link Observability.Trace} that have errors.
     */
    readonly errorCount?: number;
    withErrorCount(errorCount: number | null): GenaiCore.Observability.Trace.Record;

    /**
     * The status code of this {@link Observability.Trace}.
     */
    readonly status?: string;
    withStatus(status: string | null): GenaiCore.Observability.Trace.Record;

    /**
     * True if there were errors during aggregation
     */
    readonly hasAggregationErrors?: boolean;
    withHasAggregationErrors(hasAggregationErrors: boolean): GenaiCore.Observability.Trace.Record;

    /**
     * Input for trace - uses "APPEND" aggregation
     */
    readonly input?: Array_Type<string>;
    withInput(input: Array_Type<string> | Array<string> | null): GenaiCore.Observability.Trace.Record;

    /**
     * Output for trace - uses "APPEND" aggregation
     */
    readonly output?: Array_Type<string>;
    withOutput(output: Array_Type<string> | Array<string> | null): GenaiCore.Observability.Trace.Record;

    /**
     * Number of total tokens, uses "SUM" aggregation
     */
    readonly llmCallsTokenSum?: number;
    withLlmCallsTokenSum(llmCallsTokenSum: number | null): GenaiCore.Observability.Trace.Record;

    /**
     * Number of total tokens, uses "MAX" aggregation
     */
    readonly llmCallsMaxTokens?: number;
    withLlmCallsMaxTokens(llmCallsMaxTokens: number | null): GenaiCore.Observability.Trace.Record;

    /**
     * Latency of all LLM calls in seconds, uses "SUM" aggregation
     */
    readonly llmCallsLatencySum?: number;
    withLlmCallsLatencySum(llmCallsLatencySum: number | null): GenaiCore.Observability.Trace.Record;

    /**
     * Latency of LLM calls in seconds, uses "MAX" aggregation
     */
    readonly llmCallsMaxLatency?: number;
    withLlmCallsMaxLatency(llmCallsMaxLatency: number | null): GenaiCore.Observability.Trace.Record;
     ...
     */
    readonly id: string;
    withId(id: string): GenaiCore.Observability.Trace.Record;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GenaiCore.Observability.Trace.Record;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): GenaiCore.Observability.Trace.Record;
    ...
    withVersion(version: number | null): GenaiCore.Observability.Trace.Record;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): GenaiCore.Observability.Trace.Record;

    /**
     * {@link Observability.Span.Record}s in this {@link GenaiCore.Observability.Trace.Record}
     */
    readonly spans?: Array_Type<Observability.Span.Record>;
    withSpans(spans: Array_Type<Observability.Span.Record> | Array<IObservability.Span.Record> | null): GenaiCore.Observability.Trace.Record;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Observability.Trace.Record | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Observability.Trace.Record | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Observability.Trace.Record | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Observability.Trace.Record | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Observability.Trace.Record;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Observability.Trace.Record;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Observability.Trace.Record;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Observability.Trace.Record>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Observability.Trace.Record>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Observability.Trace.Record;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Observability.Trace.Record;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Observability.Trace.Record;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Observability.Trace.Record;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Observability.Trace.Record;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Observability.Trace.Record;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Observability.Trace.Record;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Observability.Trace.Record;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Observability.Trace.Record;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Observability.Trace.Record;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Observability.Trace.Record;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Observability.Trace.Record;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Observability.Trace.Record;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Observability.Trace.Record;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Observability.Trace.Record;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Observability.Trace.Record;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Observability.Trace.Record;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Observability.Trace.Record;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Observability.Trace.Record;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Observability.Trace.Record;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Observability.Trace.Record;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Observability.Trace.Record;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Observability.Trace.Record;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Observability.Trace.Record;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Observability.Trace.Record;

    mergeJson(json: any): GenaiCore.Observability.Trace.Record;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Observability.Trace.Record;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Observability.Trace.Record;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Observability.Trace.Record>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Observability.Trace.Record> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Observability.Trace.Record> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Observability.Trace.Record>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Observability.Trace.Record> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Observability.Trace.Record> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Observability.Trace.Record> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Observability.Trace.Record>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Observability.Trace.Record>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Observability.Trace.Record;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Observability.Trace.Record;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Observability.Trace.Record;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Observability.Trace.Record;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Observability.Trace.Record;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Observability.Trace.Record;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.Observability.Trace.Record | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Observability.Trace.Record;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Observability.Trace.Record;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Observability.Trace.Record;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Observability.Trace.Record> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Observability.Trace.Record;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<GenaiCore.Observability.Trace.Record>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<GenaiCore.Observability.Trace.Record>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<GenaiCore.Observability.Trace.Record> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenaiCore.Observability.Trace.Record>> | null;
     ...
     */
    get(include?: string): GenaiCore.Observability.Trace.Record | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): GenaiCore.Observability.Trace.Record | null;
     ...
     */
    getMissing(spec: GetMissingSpec): GenaiCore.Observability.Trace.Record;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): GenaiCore.Observability.Trace.Record | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): GenaiCore.Observability.Trace.Record;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.Observability.Trace.Record | null;
     ...
     */
    create(spec?: UpsertSpec): GenaiCore.Observability.Trace.Record | null;
     ...
     */
    static createBatch(objs: Array_Type<GenaiCore.Observability.Trace.Record>, spec?: UpsertSpec): ObjList<GenaiCore.Observability.Trace.Record> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<GenaiCore.Observability.Trace.Record>, spec?: CreateBatchObjStreamSpec): ObjList<GenaiCore.Observability.Trace.Record> | null;
     ...
     */
    update(srcObj?: GenaiCore.Observability.Trace.Record, spec?: UpsertSpec): GenaiCore.Observability.Trace.Record | null;
     ...
     */
    upsert(srcObj?: GenaiCore.Observability.Trace.Record, spec?: UpsertSpec): GenaiCore.Observability.Trace.Record | null;
     ...
     */
    merge(spec?: MergeSpec): GenaiCore.Observability.Trace.Record | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): GenaiCore.Observability.Trace.Record | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): GenaiCore.Observability.Trace.Record | null;
     ...
     */
    static updateBatch(objs: Array_Type<GenaiCore.Observability.Trace.Record>, srcObjs?: Array_Type<GenaiCore.Observability.Trace.Record>, spec?: UpsertSpec): ObjList<GenaiCore.Observability.Trace.Record> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<GenaiCore.Observability.Trace.Record> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Observability.Trace.Record> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<GenaiCore.Observability.Trace.Record>, srcObjs?: Array_Type<GenaiCore.Observability.Trace.Record>, spec?: UpsertSpec): ObjList<GenaiCore.Observability.Trace.Record> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<GenaiCore.Observability.Trace.Record> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Observability.Trace.Record> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<GenaiCore.Observability.Trace.Record>, spec?: TouchSpec): ObjList<GenaiCore.Observability.Trace.Record> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Observability.Trace.Record>, spec?: MergeSpec): ObjList<GenaiCore.Observability.Trace.Record> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Observability.Trace.Record>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Observability.Trace.Record> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<GenaiCore.Observability.Trace.Record> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Observability.Trace.Record> | null;
     ...
     */
    static mergeAll(mergeObj: GenaiCore.Observability.Trace.Record, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: GenaiCore.Observability.Trace.Record, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<GenaiCore.Observability.Trace.Record>, spec?: UpsertSpec): ObjList<GenaiCore.Observability.Trace.Record> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<GenaiCore.Observability.Trace.Record>, spec?: UpsertSpec): ObjList<GenaiCore.Observability.Trace.Record> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): GenaiCore.Observability.Trace.Record | null;
     ...
     */
    static beforeCreate(objs: Array_Type<GenaiCore.Observability.Trace.Record>): ObjList<GenaiCore.Observability.Trace.Record>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<GenaiCore.Observability.Trace.Record>): ObjList<GenaiCore.Observability.Trace.Record>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<GenaiCore.Observability.Trace.Record>): ObjList<GenaiCore.Observability.Trace.Record>;
     ...
     */
    static afterCreate(objs: Array_Type<GenaiCore.Observability.Trace.Record>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<GenaiCore.Observability.Trace.Record>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<GenaiCore.Observability.Trace.Record>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<GenaiCore.Observability.Trace.Record>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GenaiCore.Observability.Trace.Record>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.Observability.Trace.Record | null;
     ...
     */
    withoutIdentity(): GenaiCore.Observability.Trace.Record | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<GenaiCore.Observability.Trace.Record>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: GenaiCore.Observability.Trace.Record, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<GenaiCore.Observability.Trace.Record>, callback?: λFunction<GenaiCore.Observability.Trace.Record | null, GenaiCore.Observability.Trace.Record | null>): ObjList<GenaiCore.Observability.Trace.Record>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<GenaiCore.Observability.Trace.Record>, callback?: λFunction<GenaiCore.Observability.Trace.Record | null, GenaiCore.Observability.Trace.Record | null>): Array_Type<ObjError> | null;
