// TypeScript definitions for the C3 type GenaiCore.TypeProxyEngine
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.TypeProxyEngine
 */
declare namespace GenaiCore {
  export interface ITypeProxyEngine {
 ...
 */
declare namespace GenaiCore {
  export class TypeProxyEngine extends Obj  {

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): GenaiCore.TypeProxyEngine;

    /**
     * The unique and required id of this instance.
     */
    readonly id: string;
    withId(id: string): GenaiCore.TypeProxyEngine;
    ...
    with_deploymentCache(_deploymentCache: any | null): GenaiCore.TypeProxyEngine;

    /**
     * Errors that are captured during engine start
     */
    readonly _onStartError?: string;
    with_onStartError(_onStartError: string | null): GenaiCore.TypeProxyEngine;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.TypeProxyEngine | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.TypeProxyEngine | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.TypeProxyEngine | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.TypeProxyEngine | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.TypeProxyEngine;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.TypeProxyEngine;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.TypeProxyEngine;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.TypeProxyEngine>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.TypeProxyEngine>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.TypeProxyEngine;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.TypeProxyEngine;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.TypeProxyEngine;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.TypeProxyEngine;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.TypeProxyEngine;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.TypeProxyEngine;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.TypeProxyEngine;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.TypeProxyEngine;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.TypeProxyEngine;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.TypeProxyEngine;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.TypeProxyEngine;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.TypeProxyEngine;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.TypeProxyEngine;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.TypeProxyEngine;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.TypeProxyEngine;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.TypeProxyEngine;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.TypeProxyEngine;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.TypeProxyEngine;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.TypeProxyEngine;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.TypeProxyEngine;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.TypeProxyEngine;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.TypeProxyEngine;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.TypeProxyEngine;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.TypeProxyEngine;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.TypeProxyEngine;

    mergeJson(json: any): GenaiCore.TypeProxyEngine;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.TypeProxyEngine;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.TypeProxyEngine;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.TypeProxyEngine>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.TypeProxyEngine> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.TypeProxyEngine> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.TypeProxyEngine>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.TypeProxyEngine> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.TypeProxyEngine> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.TypeProxyEngine> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.TypeProxyEngine>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.TypeProxyEngine>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.TypeProxyEngine;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.TypeProxyEngine;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.TypeProxyEngine;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.TypeProxyEngine;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.TypeProxyEngine;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.TypeProxyEngine;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.TypeProxyEngine | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.TypeProxyEngine;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.TypeProxyEngine;
     ...
     */
    static cachedEmptyInst(): GenaiCore.TypeProxyEngine;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.TypeProxyEngine> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.TypeProxyEngine;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.TypeProxyEngine | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): GenaiCore.TypeProxyEngine | null;

    /**
     * @return single instance of this Identified type by id.
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.TypeProxyEngine | null;
     ...
     */
    static deploy(spec: GenaiCore.TypeProxyEngine.DeploySpec): GenaiCore.TypeProxyEngine;
     ...
     */
    restart(): GenaiCore.TypeProxyEngine;
     ...
     */
    start(waitForReady?: boolean, spec?: WaitableSpec): GenaiCore.TypeProxyEngine | null;

    doStart(): GenaiCore.TypeProxyEngine;
     ...
     */
    call(action: Lambda<function(engine: GenaiCore.TypeProxyEngine): T | null>): T | null;
     ...
     */
    onStart(): GenaiCore.TypeProxyEngine;
     ...
     * @see: #terminate
     */
    static list(): Array_Type<GenaiCore.TypeProxyEngine> | null;
     ...
     */
    static createFromObj(instance: Obj, actionRequirement: string, initFuncName?: string, spec?: Engine.DeploySpec): GenaiCore.TypeProxyEngine;
