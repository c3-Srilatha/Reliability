// TypeScript definitions for the C3 type GenaiCore.Tool.C3MemberMethod

/**
 * A subtype of {@link GenaiCore.Tool.C3Method} that wraps a member method on an instance
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Tool.C3MemberMethod
 */
declare namespace GenaiCore.Tool {
  export interface IC3MemberMethod {
     ...
     */
    methodType: IMethodTypeRef;

    /**
     * The code used for #standalonePyFuncCode
     */
    standaloneFuncCode: string;
 ...
 */
declare namespace GenaiCore.Tool {
  export class C3MemberMethod extends Obj  {

    /**
     * The name of this instance.
     */
    readonly name?: string;
    withName(name: string | null): GenaiCore.Tool.C3MemberMethod;
     ...
     */
    readonly id: string;
    withId(id: string): GenaiCore.Tool.C3MemberMethod;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GenaiCore.Tool.C3MemberMethod;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): GenaiCore.Tool.C3MemberMethod;
    ...
    withVersion(version: number | null): GenaiCore.Tool.C3MemberMethod;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): GenaiCore.Tool.C3MemberMethod;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): GenaiCore.Tool.C3MemberMethod;
    ...
    withHidden(hidden: boolean): GenaiCore.Tool.C3MemberMethod;
    ...
    withUserOwned(userOwned: boolean): GenaiCore.Tool.C3MemberMethod;
    ...
    withTypeIdent(typeIdent: string | null): GenaiCore.Tool.C3MemberMethod;

    /**
     * The flag used to mark whether the tool has been published. Defaults to `false`.
     */
    readonly isPublished?: boolean;
    withIsPublished(isPublished: boolean): GenaiCore.Tool.C3MemberMethod;

    /**
     * Optional persisted kwargs that will be passed to #initialize
     */
    readonly initKwargs?: any;
    withInitKwargs(initKwargs: any | null): GenaiCore.Tool.C3MemberMethod;
    ...
    withDescription(description: string | null): GenaiCore.Tool.C3MemberMethod;
     ...
     * {@see description}
     */
    readonly descriptionForLlm: string;
    withDescriptionForLlm(descriptionForLlm: string): GenaiCore.Tool.C3MemberMethod;
     ...
     *          ```
     */
    readonly argsSchema?: any;
    withArgsSchema(argsSchema: any | null): GenaiCore.Tool.C3MemberMethod;

    /**
     * A serialized representation of the Python type that the tool's `call` function returns.
     * e.g. `"int"`, `"str"`, `"typing.List[str]"`
     */
    readonly outputPyType?: any;
    withOutputPyType(outputPyType: any | null): GenaiCore.Tool.C3MemberMethod;

    /**
     * A reference to the {@link MethodType} corresponding to this C3Method tool.
     */
    readonly methodType: MethodTypeRef;
    withMethodType(methodType: IMethodTypeRef): GenaiCore.Tool.C3MemberMethod;

    /**
     * The code used for #standalonePyFuncCode
     */
    readonly standaloneFuncCode: string;
    withStandaloneFuncCode(standaloneFuncCode: string): GenaiCore.Tool.C3MemberMethod;

    /**
     * The tool will invoke #call and #func on this instance.
     */
    readonly instance: Obj;
    withInstance(instance: IObj): GenaiCore.Tool.C3MemberMethod;
     ...
     *        {@link GenaiCore.Tool.C3MemberMethod#createFromMethodType} was called)
     */
    readonly instantiationMethod: string;
    withInstantiationMethod(instantiationMethod: string): GenaiCore.Tool.C3MemberMethod;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Tool.C3MemberMethod | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Tool.C3MemberMethod | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Tool.C3MemberMethod | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Tool.C3MemberMethod | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Tool.C3MemberMethod;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Tool.C3MemberMethod;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Tool.C3MemberMethod;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Tool.C3MemberMethod>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Tool.C3MemberMethod>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Tool.C3MemberMethod;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Tool.C3MemberMethod;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Tool.C3MemberMethod;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Tool.C3MemberMethod;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Tool.C3MemberMethod;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Tool.C3MemberMethod;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Tool.C3MemberMethod;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Tool.C3MemberMethod;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Tool.C3MemberMethod;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Tool.C3MemberMethod;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Tool.C3MemberMethod;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Tool.C3MemberMethod;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Tool.C3MemberMethod;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Tool.C3MemberMethod;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Tool.C3MemberMethod;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Tool.C3MemberMethod;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Tool.C3MemberMethod;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Tool.C3MemberMethod;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Tool.C3MemberMethod;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Tool.C3MemberMethod;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Tool.C3MemberMethod;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Tool.C3MemberMethod;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Tool.C3MemberMethod;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Tool.C3MemberMethod;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Tool.C3MemberMethod;

    mergeJson(json: any): GenaiCore.Tool.C3MemberMethod;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Tool.C3MemberMethod;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Tool.C3MemberMethod;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Tool.C3MemberMethod>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Tool.C3MemberMethod> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Tool.C3MemberMethod> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Tool.C3MemberMethod>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Tool.C3MemberMethod> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Tool.C3MemberMethod> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Tool.C3MemberMethod> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Tool.C3MemberMethod>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Tool.C3MemberMethod>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Tool.C3MemberMethod;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Tool.C3MemberMethod;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Tool.C3MemberMethod;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Tool.C3MemberMethod;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Tool.C3MemberMethod;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Tool.C3MemberMethod;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.Tool.C3MemberMethod | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Tool.C3MemberMethod;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Tool.C3MemberMethod;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Tool.C3MemberMethod;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Tool.C3MemberMethod> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Tool.C3MemberMethod;
     ...
     */
    static allCached(): Stream<GenaiCore.Tool.C3MemberMethod> | null;
     ...
     */
    static find(filter?: string): Stream<GenaiCore.Tool.C3MemberMethod> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<GenaiCore.Tool.C3MemberMethod> | null;

    /**
     * @return cached instance.
     */
    getCached(): GenaiCore.Tool.C3MemberMethod | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): GenaiCore.Tool.C3MemberMethod | null;
     ...
     */
    static produce(key: string): GenaiCore.Tool.C3MemberMethod | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, GenaiCore.Tool.C3MemberMethod> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<GenaiCore.Tool.C3MemberMethod>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<GenaiCore.Tool.C3MemberMethod>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<GenaiCore.Tool.C3MemberMethod> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenaiCore.Tool.C3MemberMethod>> | null;
     ...
     */
    get(include?: string): GenaiCore.Tool.C3MemberMethod | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): GenaiCore.Tool.C3MemberMethod | null;
     ...
     */
    getMissing(spec: GetMissingSpec): GenaiCore.Tool.C3MemberMethod;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): GenaiCore.Tool.C3MemberMethod | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): GenaiCore.Tool.C3MemberMethod;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.Tool.C3MemberMethod | null;
     ...
     */
    create(spec?: UpsertSpec): GenaiCore.Tool.C3MemberMethod | null;
     ...
     */
    static createBatch(objs: Array_Type<GenaiCore.Tool.C3MemberMethod>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.C3MemberMethod> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<GenaiCore.Tool.C3MemberMethod>, spec?: CreateBatchObjStreamSpec): ObjList<GenaiCore.Tool.C3MemberMethod> | null;
     ...
     */
    update(srcObj?: GenaiCore.Tool.C3MemberMethod, spec?: UpsertSpec): GenaiCore.Tool.C3MemberMethod | null;
     ...
     */
    upsert(srcObj?: GenaiCore.Tool.C3MemberMethod, spec?: UpsertSpec): GenaiCore.Tool.C3MemberMethod | null;
     ...
     */
    merge(spec?: MergeSpec): GenaiCore.Tool.C3MemberMethod | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): GenaiCore.Tool.C3MemberMethod | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): GenaiCore.Tool.C3MemberMethod | null;
     ...
     */
    static updateBatch(objs: Array_Type<GenaiCore.Tool.C3MemberMethod>, srcObjs?: Array_Type<GenaiCore.Tool.C3MemberMethod>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.C3MemberMethod> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<GenaiCore.Tool.C3MemberMethod> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.C3MemberMethod> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<GenaiCore.Tool.C3MemberMethod>, srcObjs?: Array_Type<GenaiCore.Tool.C3MemberMethod>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.C3MemberMethod> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<GenaiCore.Tool.C3MemberMethod> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.C3MemberMethod> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<GenaiCore.Tool.C3MemberMethod>, spec?: TouchSpec): ObjList<GenaiCore.Tool.C3MemberMethod> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Tool.C3MemberMethod>, spec?: MergeSpec): ObjList<GenaiCore.Tool.C3MemberMethod> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Tool.C3MemberMethod>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Tool.C3MemberMethod> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<GenaiCore.Tool.C3MemberMethod> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Tool.C3MemberMethod> | null;
     ...
     */
    static mergeAll(mergeObj: GenaiCore.Tool.C3MemberMethod, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: GenaiCore.Tool.C3MemberMethod, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<GenaiCore.Tool.C3MemberMethod>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.C3MemberMethod> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<GenaiCore.Tool.C3MemberMethod>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.C3MemberMethod> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): GenaiCore.Tool.C3MemberMethod | null;
     ...
     */
    static beforeCreate(objs: Array_Type<GenaiCore.Tool.C3MemberMethod>): ObjList<GenaiCore.Tool.C3MemberMethod>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<GenaiCore.Tool.C3MemberMethod>): ObjList<GenaiCore.Tool.C3MemberMethod>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<GenaiCore.Tool.C3MemberMethod>): ObjList<GenaiCore.Tool.C3MemberMethod>;
     ...
     */
    static afterCreate(objs: Array_Type<GenaiCore.Tool.C3MemberMethod>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<GenaiCore.Tool.C3MemberMethod>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<GenaiCore.Tool.C3MemberMethod>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<GenaiCore.Tool.C3MemberMethod>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GenaiCore.Tool.C3MemberMethod>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.Tool.C3MemberMethod | null;
     ...
     */
    withoutIdentity(): GenaiCore.Tool.C3MemberMethod | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<GenaiCore.Tool.C3MemberMethod>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: GenaiCore.Tool.C3MemberMethod, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<GenaiCore.Tool.C3MemberMethod>, callback?: λFunction<GenaiCore.Tool.C3MemberMethod | null, GenaiCore.Tool.C3MemberMethod | null>): ObjList<GenaiCore.Tool.C3MemberMethod>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<GenaiCore.Tool.C3MemberMethod>, callback?: λFunction<GenaiCore.Tool.C3MemberMethod | null, GenaiCore.Tool.C3MemberMethod | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): GenaiCore.Tool.C3MemberMethod;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.C3MemberMethod> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): GenaiCore.Tool.C3MemberMethod | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.C3MemberMethod> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): GenaiCore.Tool.C3MemberMethod | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.C3MemberMethod> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): GenaiCore.Tool.C3MemberMethod | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<GenaiCore.Tool.C3MemberMethod> | null;
    ...
    dependencies(): SeedDataDeps<GenaiCore.Tool.C3MemberMethod> | null;
     ...
     */
    call(args?: any, kwargs?: any): any | null;
     ...
     */
    static validateReferenceType(referenceType: Type): void;
     ...
     * @return The Python type that corresponds to the given {@link ValueType}.
     */
    static valueTypeToPyType(valueType: ValueType, allowReferenceTypes?: boolean): any;
     ...
     */
    static pydanticTuplesForFieldOrParam(fieldOrParam?: FunctionParam | FieldType, methodTypeParamDocParsed?: ParameterDocumentation): any;
     ...
     * @return Whether the given {@link ValueType} is supported by the GenaiCore.Tool framework.
     */
    static isSupportedValueType(valueType: ValueType, allowReferenceTypes?: boolean): boolean;
     ...
     */
    static pyTypeToStr(pyType: any): string;
     ...
     */
    static allowMemberMethods(): boolean;
     ...
     */
    static createFromMethodName(type: Type, methodName: string, spec?: GenaiCore.Tool.C3Method.Spec): GenaiCore.Tool.C3MemberMethod;
     ...
     * @return the created instance
     */
    static createFromMethodType(methodTypeRef: MethodTypeRef, spec?: GenaiCore.Tool.C3Method.Spec): GenaiCore.Tool.C3MemberMethod;
     ...
     * @return the created instance
     */
    static doCreateFromMethodType(methodTypeRef: MethodTypeRef, calleeInstantiator: string, spec?: GenaiCore.Tool.C3Method.Spec): GenaiCore.Tool.C3MemberMethod;
     ...
     *            Whether to allow member methods
     */
    static validateMethodType(methodType: MethodType, allowMemberMethods?: boolean): void;
     ...
     */
    static methodTypeFromNameAndSpec(typeMeta: TypeMeta, methodName: string, spec?: GenaiCore.Tool.C3Method.Spec): MethodTypeRef;

    /**
     * @return the template string used to create #standaloneFuncCode
     */
    static funcTemplateString(): string;
     ...
     */
    static convertPydanticInputs(args?: any, kwargs?: any): any;
     ...
     */
    static createFromObjAndMethodName(instance: Obj, methodName: string, spec?: GenaiCore.Tool.C3MemberMethod.Spec): GenaiCore.Tool.C3MemberMethod;
     ...
     * @return the created tool instance
     */
    static createFromObjAndMethodType(instance: Obj, methodTypeRef: MethodTypeRef, spec?: GenaiCore.Tool.C3MemberMethod.Spec): GenaiCore.Tool.C3MemberMethod;
  }
}
