// TypeScript definitions for the C3 type GenaiCore.Unstructured.BatchJob
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Unstructured.BatchJob
 */
 ...
 */
declare namespace GenaiCore.Unstructured {
  export class BatchJob extends Obj  {

    /**
     * current or last job execution for this instance
     */
    readonly run?: BatchJobRun;
    withRun(run: IBatchJobRun | null): GenaiCore.Unstructured.BatchJob;

    /**
     * previous job executions for this instance
     */
    readonly runs?: Array_Type<BatchJobRun>;
    withRuns(runs: Array_Type<BatchJobRun> | Array<IBatchJobRun> | null): GenaiCore.Unstructured.BatchJob;

    /**
     * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
     */
    readonly options?: Obj;
    withOptions(options: IObj | null): GenaiCore.Unstructured.BatchJob;
    ...
    withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): GenaiCore.Unstructured.BatchJob;
    ...
    withPriority(priority: number | null): GenaiCore.Unstructured.BatchJob;
    ...
    withDisabled(disabled: boolean): GenaiCore.Unstructured.BatchJob;
    ...
    withMaxConcurrency(maxConcurrency: number | null): GenaiCore.Unstructured.BatchJob;
    ...
    withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): GenaiCore.Unstructured.BatchJob;
    ...
    withRunAsUser(runAsUser: boolean): GenaiCore.Unstructured.BatchJob;

    /**
     * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
     */
    readonly nodePool?: string;
    withNodePool(nodePool: string | null): GenaiCore.Unstructured.BatchJob;
    ...
    withSkipIfRunning(skipIfRunning: boolean): GenaiCore.Unstructured.BatchJob;

    /**
     * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
     */
    readonly numAutoRecoveryAttempts?: number;
    withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): GenaiCore.Unstructured.BatchJob;
    ...
    withTypeIdent(typeIdent: string | null): GenaiCore.Unstructured.BatchJob;
     ...
     */
    readonly id: string;
    withId(id: string): GenaiCore.Unstructured.BatchJob;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GenaiCore.Unstructured.BatchJob;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): GenaiCore.Unstructured.BatchJob;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): GenaiCore.Unstructured.BatchJob;
    ...
    withVersion(version: number | null): GenaiCore.Unstructured.BatchJob;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): GenaiCore.Unstructured.BatchJob;
    ...
    withAbortOnError(abortOnError: boolean): GenaiCore.Unstructured.BatchJob;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Unstructured.BatchJob | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Unstructured.BatchJob | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Unstructured.BatchJob | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Unstructured.BatchJob | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Unstructured.BatchJob;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Unstructured.BatchJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Unstructured.BatchJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Unstructured.BatchJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Unstructured.BatchJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Unstructured.BatchJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Unstructured.BatchJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Unstructured.BatchJob;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Unstructured.BatchJob;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Unstructured.BatchJob;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Unstructured.BatchJob;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Unstructured.BatchJob;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Unstructured.BatchJob;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Unstructured.BatchJob;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Unstructured.BatchJob;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Unstructured.BatchJob;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Unstructured.BatchJob;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Unstructured.BatchJob;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Unstructured.BatchJob;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Unstructured.BatchJob;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Unstructured.BatchJob;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Unstructured.BatchJob;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Unstructured.BatchJob;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Unstructured.BatchJob;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Unstructured.BatchJob;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Unstructured.BatchJob;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Unstructured.BatchJob;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Unstructured.BatchJob;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Unstructured.BatchJob;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Unstructured.BatchJob;

    mergeJson(json: any): GenaiCore.Unstructured.BatchJob;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Unstructured.BatchJob;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Unstructured.BatchJob;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Unstructured.BatchJob>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Unstructured.BatchJob> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Unstructured.BatchJob> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Unstructured.BatchJob>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Unstructured.BatchJob> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Unstructured.BatchJob> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Unstructured.BatchJob> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Unstructured.BatchJob>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Unstructured.BatchJob>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Unstructured.BatchJob;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Unstructured.BatchJob;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Unstructured.BatchJob;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Unstructured.BatchJob;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Unstructured.BatchJob;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Unstructured.BatchJob;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.Unstructured.BatchJob | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Unstructured.BatchJob;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Unstructured.BatchJob;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Unstructured.BatchJob;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Unstructured.BatchJob> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Unstructured.BatchJob;
     ...
     */
    start(options?: GenaiCore.Unstructured.BatchJob.Options): BatchJobStatus | null;
     ...
     */
    cleanup(options?: GenaiCore.Unstructured.BatchJob.Options): void;
    ...
    cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun, BatchJobStatus, GenaiCore.Unstructured.BatchJob.Options> | null;

    failJob(run: JobRun<BatchJobStatusBase>): JobBase<BatchJobRun, BatchJobStatus, GenaiCore.Unstructured.BatchJob.Options> | null;
    ...
    validateStart(options?: GenaiCore.Unstructured.BatchJob.Options): void;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<GenaiCore.Unstructured.BatchJob>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<GenaiCore.Unstructured.BatchJob>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<GenaiCore.Unstructured.BatchJob> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenaiCore.Unstructured.BatchJob>> | null;
     ...
     */
    get(include?: string): GenaiCore.Unstructured.BatchJob | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): GenaiCore.Unstructured.BatchJob | null;
     ...
     */
    getMissing(spec: GetMissingSpec): GenaiCore.Unstructured.BatchJob;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): GenaiCore.Unstructured.BatchJob | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): GenaiCore.Unstructured.BatchJob;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.Unstructured.BatchJob | null;
     ...
     */
    create(spec?: UpsertSpec): GenaiCore.Unstructured.BatchJob | null;
     ...
     */
    static createBatch(objs: Array_Type<GenaiCore.Unstructured.BatchJob>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.BatchJob> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<GenaiCore.Unstructured.BatchJob>, spec?: CreateBatchObjStreamSpec): ObjList<GenaiCore.Unstructured.BatchJob> | null;
     ...
     */
    update(srcObj?: GenaiCore.Unstructured.BatchJob, spec?: UpsertSpec): GenaiCore.Unstructured.BatchJob | null;
     ...
     */
    upsert(srcObj?: GenaiCore.Unstructured.BatchJob, spec?: UpsertSpec): GenaiCore.Unstructured.BatchJob | null;
     ...
     */
    merge(spec?: MergeSpec): GenaiCore.Unstructured.BatchJob | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): GenaiCore.Unstructured.BatchJob | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): GenaiCore.Unstructured.BatchJob | null;
     ...
     */
    static updateBatch(objs: Array_Type<GenaiCore.Unstructured.BatchJob>, srcObjs?: Array_Type<GenaiCore.Unstructured.BatchJob>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.BatchJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<GenaiCore.Unstructured.BatchJob> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.BatchJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<GenaiCore.Unstructured.BatchJob>, srcObjs?: Array_Type<GenaiCore.Unstructured.BatchJob>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.BatchJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<GenaiCore.Unstructured.BatchJob> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.BatchJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<GenaiCore.Unstructured.BatchJob>, spec?: TouchSpec): ObjList<GenaiCore.Unstructured.BatchJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Unstructured.BatchJob>, spec?: MergeSpec): ObjList<GenaiCore.Unstructured.BatchJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Unstructured.BatchJob>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Unstructured.BatchJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<GenaiCore.Unstructured.BatchJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Unstructured.BatchJob> | null;
     ...
     */
    static mergeAll(mergeObj: GenaiCore.Unstructured.BatchJob, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: GenaiCore.Unstructured.BatchJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<GenaiCore.Unstructured.BatchJob>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.BatchJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<GenaiCore.Unstructured.BatchJob>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.BatchJob> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): GenaiCore.Unstructured.BatchJob | null;
     ...
     */
    static beforeCreate(objs: Array_Type<GenaiCore.Unstructured.BatchJob>): ObjList<GenaiCore.Unstructured.BatchJob>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<GenaiCore.Unstructured.BatchJob>): ObjList<GenaiCore.Unstructured.BatchJob>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<GenaiCore.Unstructured.BatchJob>): ObjList<GenaiCore.Unstructured.BatchJob>;
     ...
     */
    static afterCreate(objs: Array_Type<GenaiCore.Unstructured.BatchJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<GenaiCore.Unstructured.BatchJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<GenaiCore.Unstructured.BatchJob>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<GenaiCore.Unstructured.BatchJob>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GenaiCore.Unstructured.BatchJob>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.Unstructured.BatchJob | null;
     ...
     */
    withoutIdentity(): GenaiCore.Unstructured.BatchJob | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<GenaiCore.Unstructured.BatchJob>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: GenaiCore.Unstructured.BatchJob, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<GenaiCore.Unstructured.BatchJob>, callback?: λFunction<GenaiCore.Unstructured.BatchJob | null, GenaiCore.Unstructured.BatchJob | null>): ObjList<GenaiCore.Unstructured.BatchJob>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<GenaiCore.Unstructured.BatchJob>, callback?: λFunction<GenaiCore.Unstructured.BatchJob | null, GenaiCore.Unstructured.BatchJob | null>): Array_Type<ObjError> | null;
     ...
     */
    static doStart(job?: GenaiCore.Unstructured.BatchJob, options?: GenaiCore.Unstructured.BatchJob.Options): void;
     ...
     */
    static processBatch(batch?: GenaiCore.Unstructured.BatchJob.Batch, job?: GenaiCore.Unstructured.BatchJob, options?: GenaiCore.Unstructured.BatchJob.Options): void;
     ...
     */
    static allComplete(job: GenaiCore.Unstructured.BatchJob, options?: GenaiCore.Unstructured.BatchJob.Options): string | null;
     ...
     *           Options the job was run with.
     */
    static failed(job: GenaiCore.Unstructured.BatchJob, status: BatchJobStatus, options?: GenaiCore.Unstructured.BatchJob.Options): void;
     ...
     *        Batch to schedule.
     */
    scheduleBatch(batch?: GenaiCore.Unstructured.BatchJob.Batch): void;
     ...
     *        Batches to schedule.
     */
    scheduleBatches(batches?: Array_Type<GenaiCore.Unstructured.BatchJob.Batch>): void;
     ...
     */
    static scheduleObjBatch(job?: GenaiCore.Unstructured.BatchJob, objBatch?: ObjBatch, logPrefix?: string): number | null;
     ...
     */
    static doStartHelper(job: GenaiCore.Unstructured.BatchJob, options: GenaiCore.Unstructured.BatchJob.Options): void;
     ...
     *          the options for the processing job.
     */
    static processBatchHelper(batch: GenaiCore.Unstructured.BatchJob.Batch, job: GenaiCore.Unstructured.BatchJob, options: GenaiCore.Unstructured.BatchJob.Options): void;
  }
}
