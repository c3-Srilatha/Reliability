// TypeScript definitions for the C3 type GenaiCore.Embedder.Engine

/**
 * A standalone {@link Engine} to perform embedding. Wraps around a {@link GenaiCore.Embedder} to provide
 * low-latency embedding.
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Embedder.Engine
 */
...
declare namespace GenaiCore.Embedder {
  export class Engine extends Obj  {
    ...
    withName(name: string): GenaiCore.Embedder.Engine;

    /**
     * The unique and required id of this instance.
     */
    readonly id: string;
    withId(id: string): GenaiCore.Embedder.Engine;
    ...
    with_deploymentCache(_deploymentCache: any | null): GenaiCore.Embedder.Engine;

    /**
     * Errors that are captured during engine start
     */
    readonly _onStartError?: string;
    with_onStartError(_onStartError: string | null): GenaiCore.Embedder.Engine;

    /**
     * The default kwargs for this embedder. Caller-provided kwargs values will be merged and take precedence.
     */
    readonly defaultKwargs?: any;
    withDefaultKwargs(defaultKwargs: any | null): GenaiCore.Embedder.Engine;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Embedder.Engine | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Embedder.Engine | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Embedder.Engine | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Embedder.Engine | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Embedder.Engine;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Embedder.Engine;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Embedder.Engine;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Embedder.Engine>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Embedder.Engine>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Embedder.Engine;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Embedder.Engine;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Embedder.Engine;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Embedder.Engine;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Embedder.Engine;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Embedder.Engine;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Embedder.Engine;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Embedder.Engine;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Embedder.Engine;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Embedder.Engine;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Embedder.Engine;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Embedder.Engine;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Embedder.Engine;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Embedder.Engine;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Embedder.Engine;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Embedder.Engine;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Embedder.Engine;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Embedder.Engine;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Embedder.Engine;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Embedder.Engine;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Embedder.Engine;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Embedder.Engine;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Embedder.Engine;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Embedder.Engine;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Embedder.Engine;

    mergeJson(json: any): GenaiCore.Embedder.Engine;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Embedder.Engine;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Embedder.Engine;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Embedder.Engine>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Embedder.Engine> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Embedder.Engine> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Embedder.Engine>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Embedder.Engine> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Embedder.Engine> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Embedder.Engine> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Embedder.Engine>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Embedder.Engine>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Embedder.Engine;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Embedder.Engine;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Embedder.Engine;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Embedder.Engine;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Embedder.Engine;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Embedder.Engine;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.Embedder.Engine | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Embedder.Engine;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Embedder.Engine;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Embedder.Engine;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Embedder.Engine> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Embedder.Engine;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.Embedder.Engine | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): GenaiCore.Embedder.Engine | null;

    /**
     * @return single instance of this Identified type by id.
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.Embedder.Engine | null;
     ...
     */
    static deploy(spec: GenaiCore.TypeProxyEngine.DeploySpec): GenaiCore.Embedder.Engine;
     ...
     */
    restart(): GenaiCore.Embedder.Engine;
     ...
     */
    start(waitForReady?: boolean, spec?: WaitableSpec): GenaiCore.Embedder.Engine | null;

    doStart(): GenaiCore.Embedder.Engine;
     ...
     */
    call(action: Lambda<function(engine: GenaiCore.Embedder.Engine): T | null>): T | null;
     ...
     */
    onStart(): GenaiCore.Embedder.Engine;
     ...
     * @see: #terminate
     */
    static list(): Array_Type<GenaiCore.Embedder.Engine> | null;
     ...
     */
    static createFromObj(instance: Obj, actionRequirement: string, initFuncName?: string, spec?: Engine.DeploySpec): GenaiCore.Embedder.Engine;
     ...
     */
    initialize(force?: boolean): GenaiCore.Embedder.Engine | null;
     ...
     * @return the newly created/deployed engine
     */
    static createFromEmbedder(embedder: GenaiCore.Embedder, spec?: Engine.DeploySpec): GenaiCore.Embedder.Engine;
  }
}
