// TypeScript definitions for the C3 type GenaiCore.Unstructured.Job.SourceRun

/**
 * Tracks the checkpoints/progress/errors of the processor/embedding/vectorStore execution
 * for a single source instance.
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Unstructured.Job.SourceRun
 */
declare namespace GenaiCore.Unstructured.Job {
  export interface ISourceRun {
     ...
     */
    jobRun: IGenaiCore.Unstructured.Job.Run;
     ...
     * Value - error message
     */
    errors?: Map_Type<string, string> | {[key: string]: string};
     ...
     */
    checkpoints?: Map_Type<string, GenaiCore.Unstructured.Job.Checkpoint> | {[key: string]: IGenaiCore.Unstructured.Job.Checkpoint};
  }
}
 ...
 */
declare namespace GenaiCore.Unstructured.Job {
  export class SourceRun extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): GenaiCore.Unstructured.Job.SourceRun;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GenaiCore.Unstructured.Job.SourceRun;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): GenaiCore.Unstructured.Job.SourceRun;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): GenaiCore.Unstructured.Job.SourceRun;
    ...
    withVersion(version: number | null): GenaiCore.Unstructured.Job.SourceRun;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): GenaiCore.Unstructured.Job.SourceRun;

    /**
     * Path or id of the source that was processed.
     */
    readonly source: string;
    withSource(source: string): GenaiCore.Unstructured.Job.SourceRun;

    /**
     * Reference to the job run.
     */
    readonly jobRun: GenaiCore.Unstructured.Job.Run;
    withJobRun(jobRun: IGenaiCore.Unstructured.Job.Run): GenaiCore.Unstructured.Job.SourceRun;

    /**
     * The status of source processing.
     */
    readonly status: string;
    withStatus(status: string): GenaiCore.Unstructured.Job.SourceRun;
    ...
    withProcessorChunkCount(processorChunkCount: number | null): GenaiCore.Unstructured.Job.SourceRun;
    ...
    withVectorCount(vectorCount: number | null): GenaiCore.Unstructured.Job.SourceRun;
     ...
     * Value - error message
     */
    readonly errors?: Map_Type<string, string>;
    withErrors(errors: Map_Type<string, string> | {[key: string]: string} | null): GenaiCore.Unstructured.Job.SourceRun;
     ...
     * Value is the checkpoint instance, which holds the path to the checkpoint file.
     */
    readonly checkpoints?: Map_Type<string, GenaiCore.Unstructured.Job.Checkpoint>;
    withCheckpoints(checkpoints: Map_Type<string, GenaiCore.Unstructured.Job.Checkpoint> | {[key: string]: IGenaiCore.Unstructured.Job.Checkpoint} | null): GenaiCore.Unstructured.Job.SourceRun;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Unstructured.Job.SourceRun | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Unstructured.Job.SourceRun | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Unstructured.Job.SourceRun | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Unstructured.Job.SourceRun | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Unstructured.Job.SourceRun;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Unstructured.Job.SourceRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Unstructured.Job.SourceRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Unstructured.Job.SourceRun>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Unstructured.Job.SourceRun>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Unstructured.Job.SourceRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Unstructured.Job.SourceRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Unstructured.Job.SourceRun;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Unstructured.Job.SourceRun;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Unstructured.Job.SourceRun;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Unstructured.Job.SourceRun;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Unstructured.Job.SourceRun;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Unstructured.Job.SourceRun;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Unstructured.Job.SourceRun;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Unstructured.Job.SourceRun;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Unstructured.Job.SourceRun;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Unstructured.Job.SourceRun;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Unstructured.Job.SourceRun;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Unstructured.Job.SourceRun;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Unstructured.Job.SourceRun;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Unstructured.Job.SourceRun;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Unstructured.Job.SourceRun;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Unstructured.Job.SourceRun;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Unstructured.Job.SourceRun;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Unstructured.Job.SourceRun;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Unstructured.Job.SourceRun;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Unstructured.Job.SourceRun;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Unstructured.Job.SourceRun;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Unstructured.Job.SourceRun;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Unstructured.Job.SourceRun;

    mergeJson(json: any): GenaiCore.Unstructured.Job.SourceRun;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Unstructured.Job.SourceRun;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Unstructured.Job.SourceRun;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Unstructured.Job.SourceRun>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Unstructured.Job.SourceRun> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Unstructured.Job.SourceRun> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Unstructured.Job.SourceRun>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Unstructured.Job.SourceRun> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Unstructured.Job.SourceRun> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Unstructured.Job.SourceRun> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Unstructured.Job.SourceRun>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Unstructured.Job.SourceRun>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Unstructured.Job.SourceRun;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Unstructured.Job.SourceRun;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Unstructured.Job.SourceRun;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Unstructured.Job.SourceRun;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Unstructured.Job.SourceRun;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Unstructured.Job.SourceRun;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.Unstructured.Job.SourceRun | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Unstructured.Job.SourceRun;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Unstructured.Job.SourceRun;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Unstructured.Job.SourceRun;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Unstructured.Job.SourceRun> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Unstructured.Job.SourceRun;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<GenaiCore.Unstructured.Job.SourceRun>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<GenaiCore.Unstructured.Job.SourceRun>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<GenaiCore.Unstructured.Job.SourceRun> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenaiCore.Unstructured.Job.SourceRun>> | null;
     ...
     */
    get(include?: string): GenaiCore.Unstructured.Job.SourceRun | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): GenaiCore.Unstructured.Job.SourceRun | null;
     ...
     */
    getMissing(spec: GetMissingSpec): GenaiCore.Unstructured.Job.SourceRun;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): GenaiCore.Unstructured.Job.SourceRun | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): GenaiCore.Unstructured.Job.SourceRun;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.Unstructured.Job.SourceRun | null;
     ...
     */
    create(spec?: UpsertSpec): GenaiCore.Unstructured.Job.SourceRun | null;
     ...
     */
    static createBatch(objs: Array_Type<GenaiCore.Unstructured.Job.SourceRun>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Job.SourceRun> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<GenaiCore.Unstructured.Job.SourceRun>, spec?: CreateBatchObjStreamSpec): ObjList<GenaiCore.Unstructured.Job.SourceRun> | null;
     ...
     */
    update(srcObj?: GenaiCore.Unstructured.Job.SourceRun, spec?: UpsertSpec): GenaiCore.Unstructured.Job.SourceRun | null;
     ...
     */
    upsert(srcObj?: GenaiCore.Unstructured.Job.SourceRun, spec?: UpsertSpec): GenaiCore.Unstructured.Job.SourceRun | null;
     ...
     */
    merge(spec?: MergeSpec): GenaiCore.Unstructured.Job.SourceRun | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): GenaiCore.Unstructured.Job.SourceRun | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): GenaiCore.Unstructured.Job.SourceRun | null;
     ...
     */
    static updateBatch(objs: Array_Type<GenaiCore.Unstructured.Job.SourceRun>, srcObjs?: Array_Type<GenaiCore.Unstructured.Job.SourceRun>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Job.SourceRun> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<GenaiCore.Unstructured.Job.SourceRun> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Job.SourceRun> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<GenaiCore.Unstructured.Job.SourceRun>, srcObjs?: Array_Type<GenaiCore.Unstructured.Job.SourceRun>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Job.SourceRun> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<GenaiCore.Unstructured.Job.SourceRun> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Job.SourceRun> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<GenaiCore.Unstructured.Job.SourceRun>, spec?: TouchSpec): ObjList<GenaiCore.Unstructured.Job.SourceRun> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Unstructured.Job.SourceRun>, spec?: MergeSpec): ObjList<GenaiCore.Unstructured.Job.SourceRun> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Unstructured.Job.SourceRun>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Unstructured.Job.SourceRun> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<GenaiCore.Unstructured.Job.SourceRun> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Unstructured.Job.SourceRun> | null;
     ...
     */
    static mergeAll(mergeObj: GenaiCore.Unstructured.Job.SourceRun, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: GenaiCore.Unstructured.Job.SourceRun, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<GenaiCore.Unstructured.Job.SourceRun>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Job.SourceRun> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<GenaiCore.Unstructured.Job.SourceRun>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Job.SourceRun> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): GenaiCore.Unstructured.Job.SourceRun | null;
     ...
     */
    static beforeCreate(objs: Array_Type<GenaiCore.Unstructured.Job.SourceRun>): ObjList<GenaiCore.Unstructured.Job.SourceRun>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<GenaiCore.Unstructured.Job.SourceRun>): ObjList<GenaiCore.Unstructured.Job.SourceRun>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<GenaiCore.Unstructured.Job.SourceRun>): ObjList<GenaiCore.Unstructured.Job.SourceRun>;
     ...
     */
    static afterCreate(objs: Array_Type<GenaiCore.Unstructured.Job.SourceRun>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<GenaiCore.Unstructured.Job.SourceRun>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<GenaiCore.Unstructured.Job.SourceRun>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<GenaiCore.Unstructured.Job.SourceRun>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GenaiCore.Unstructured.Job.SourceRun>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.Unstructured.Job.SourceRun | null;
     ...
     */
    withoutIdentity(): GenaiCore.Unstructured.Job.SourceRun | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<GenaiCore.Unstructured.Job.SourceRun>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: GenaiCore.Unstructured.Job.SourceRun, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<GenaiCore.Unstructured.Job.SourceRun>, callback?: λFunction<GenaiCore.Unstructured.Job.SourceRun | null, GenaiCore.Unstructured.Job.SourceRun | null>): ObjList<GenaiCore.Unstructured.Job.SourceRun>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<GenaiCore.Unstructured.Job.SourceRun>, callback?: λFunction<GenaiCore.Unstructured.Job.SourceRun | null, GenaiCore.Unstructured.Job.SourceRun | null>): Array_Type<ObjError> | null;
