// TypeScript definitions for the C3 type GenaiCore.DynamicPy.Service.BasePipe

/**
 * A wrapper around {@link GenaiCore.DynamicPy.Base} to make it deployable to MIS via {@link GenaiCore.DynamicPy.Service}
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.DynamicPy.Service.BasePipe
 */
declare namespace GenaiCore.DynamicPy.Service {
  export interface IBasePipe {
     ...
     */
    base: IGenaiCore.DynamicPy.Base;
  }
}
 ...
 */
declare namespace GenaiCore.DynamicPy.Service {
  export class BasePipe extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): GenaiCore.DynamicPy.Service.BasePipe;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GenaiCore.DynamicPy.Service.BasePipe;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): GenaiCore.DynamicPy.Service.BasePipe;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): GenaiCore.DynamicPy.Service.BasePipe;
    ...
    withVersion(version: number | null): GenaiCore.DynamicPy.Service.BasePipe;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): GenaiCore.DynamicPy.Service.BasePipe;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): GenaiCore.DynamicPy.Service.BasePipe;
    ...
    withHidden(hidden: boolean): GenaiCore.DynamicPy.Service.BasePipe;
    ...
    withUserOwned(userOwned: boolean): GenaiCore.DynamicPy.Service.BasePipe;
    ...
    withTypeIdent(typeIdent: string | null): GenaiCore.DynamicPy.Service.BasePipe;

    /**
     * If true, then the pipe shall not be retrained
     */
    readonly frozen?: boolean;
    withFrozen(frozen: boolean): GenaiCore.DynamicPy.Service.BasePipe;

    /**
     * True if training has succeeded and false otherwise.
     */
    readonly trained?: boolean;
    withTrained(trained: boolean): GenaiCore.DynamicPy.Service.BasePipe;

    /**
     * Errors from training.
     */
    readonly trainingErrors?: string;
    withTrainingErrors(trainingErrors: string | null): GenaiCore.DynamicPy.Service.BasePipe;

    /**
     * If true, the underlying model only accepts flattened input.
     */
    readonly flattenInput?: boolean;
    withFlattenInput(flattenInput: boolean): GenaiCore.DynamicPy.Service.BasePipe;

    /**
     * The hyperparameters overridden of a native model or pipe.
     */
    readonly hyperparamOverrides?: Map_Type<string, any>;
    withHyperparamOverrides(hyperparamOverrides: Map_Type<string, any> | {[key: string]: any} | null): GenaiCore.DynamicPy.Service.BasePipe;
    ...
    withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): GenaiCore.DynamicPy.Service.BasePipe;
    ...
    withHpoSpec(hpoSpec: IHpo.Spec | null): GenaiCore.DynamicPy.Service.BasePipe;

    /**
     * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
     */
    readonly hpoExperiment?: Hpo.Experiment;
    withHpoExperiment(hpoExperiment: IHpo.Experiment | null): GenaiCore.DynamicPy.Service.BasePipe;

    /**
     * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
     */
    readonly experiment?: any;
    withExperiment(experiment: any | null): GenaiCore.DynamicPy.Service.BasePipe;
    ...
    withModelFiles(modelFiles: Map_Type<string, Url> | {[key: string]: IUrl} | null): GenaiCore.DynamicPy.Service.BasePipe;
    ...
    withCustomModelCode(customModelCode: Map_Type<string, any> | {[key: string]: any} | null): GenaiCore.DynamicPy.Service.BasePipe;

    /**
     * Name for the function on the native model to call to do {@link MlProcessable#process}.
     */
    readonly processFunc?: string;
    withProcessFunc(processFunc: string | null): GenaiCore.DynamicPy.Service.BasePipe;
    ...
    withActionRequirement(actionRequirement: string | null): GenaiCore.DynamicPy.Service.BasePipe;

    /**
     * The instance that implements the service
     */
    readonly base: GenaiCore.DynamicPy.Base;
    withBase(base: IGenaiCore.DynamicPy.Base): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.DynamicPy.Service.BasePipe | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.DynamicPy.Service.BasePipe | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.DynamicPy.Service.BasePipe | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.DynamicPy.Service.BasePipe | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.DynamicPy.Service.BasePipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.DynamicPy.Service.BasePipe>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.DynamicPy.Service.BasePipe;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.DynamicPy.Service.BasePipe;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.DynamicPy.Service.BasePipe;

    mergeJson(json: any): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.DynamicPy.Service.BasePipe>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.DynamicPy.Service.BasePipe> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.DynamicPy.Service.BasePipe> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.DynamicPy.Service.BasePipe>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.DynamicPy.Service.BasePipe> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.DynamicPy.Service.BasePipe> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.DynamicPy.Service.BasePipe> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.DynamicPy.Service.BasePipe>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.DynamicPy.Service.BasePipe>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.DynamicPy.Service.BasePipe;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.DynamicPy.Service.BasePipe | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     */
    static cachedEmptyInst(): GenaiCore.DynamicPy.Service.BasePipe;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.DynamicPy.Service.BasePipe> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     */
    static allCached(): Stream<GenaiCore.DynamicPy.Service.BasePipe> | null;
     ...
     */
    static find(filter?: string): Stream<GenaiCore.DynamicPy.Service.BasePipe> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<GenaiCore.DynamicPy.Service.BasePipe> | null;

    /**
     * @return cached instance.
     */
    getCached(): GenaiCore.DynamicPy.Service.BasePipe | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): GenaiCore.DynamicPy.Service.BasePipe | null;
     ...
     */
    static produce(key: string): GenaiCore.DynamicPy.Service.BasePipe | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, GenaiCore.DynamicPy.Service.BasePipe> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<GenaiCore.DynamicPy.Service.BasePipe>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<GenaiCore.DynamicPy.Service.BasePipe>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<GenaiCore.DynamicPy.Service.BasePipe> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenaiCore.DynamicPy.Service.BasePipe>> | null;
     ...
     */
    get(include?: string): GenaiCore.DynamicPy.Service.BasePipe | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): GenaiCore.DynamicPy.Service.BasePipe | null;
     ...
     */
    getMissing(spec: GetMissingSpec): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): GenaiCore.DynamicPy.Service.BasePipe | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.DynamicPy.Service.BasePipe | null;
     ...
     */
    create(spec?: UpsertSpec): GenaiCore.DynamicPy.Service.BasePipe | null;
     ...
     */
    static createBatch(objs: Array_Type<GenaiCore.DynamicPy.Service.BasePipe>, spec?: UpsertSpec): ObjList<GenaiCore.DynamicPy.Service.BasePipe> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<GenaiCore.DynamicPy.Service.BasePipe>, spec?: CreateBatchObjStreamSpec): ObjList<GenaiCore.DynamicPy.Service.BasePipe> | null;
     ...
     */
    update(srcObj?: GenaiCore.DynamicPy.Service.BasePipe, spec?: UpsertSpec): GenaiCore.DynamicPy.Service.BasePipe | null;
     ...
     */
    upsert(srcObj?: GenaiCore.DynamicPy.Service.BasePipe, spec?: UpsertSpec): GenaiCore.DynamicPy.Service.BasePipe | null;
     ...
     */
    merge(spec?: MergeSpec): GenaiCore.DynamicPy.Service.BasePipe | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): GenaiCore.DynamicPy.Service.BasePipe | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): GenaiCore.DynamicPy.Service.BasePipe | null;
     ...
     */
    static updateBatch(objs: Array_Type<GenaiCore.DynamicPy.Service.BasePipe>, srcObjs?: Array_Type<GenaiCore.DynamicPy.Service.BasePipe>, spec?: UpsertSpec): ObjList<GenaiCore.DynamicPy.Service.BasePipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<GenaiCore.DynamicPy.Service.BasePipe> | null>, spec?: UpsertSpec): ObjList<GenaiCore.DynamicPy.Service.BasePipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<GenaiCore.DynamicPy.Service.BasePipe>, srcObjs?: Array_Type<GenaiCore.DynamicPy.Service.BasePipe>, spec?: UpsertSpec): ObjList<GenaiCore.DynamicPy.Service.BasePipe> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<GenaiCore.DynamicPy.Service.BasePipe> | null>, spec?: UpsertSpec): ObjList<GenaiCore.DynamicPy.Service.BasePipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<GenaiCore.DynamicPy.Service.BasePipe>, spec?: TouchSpec): ObjList<GenaiCore.DynamicPy.Service.BasePipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.DynamicPy.Service.BasePipe>, spec?: MergeSpec): ObjList<GenaiCore.DynamicPy.Service.BasePipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.DynamicPy.Service.BasePipe>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.DynamicPy.Service.BasePipe> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<GenaiCore.DynamicPy.Service.BasePipe> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.DynamicPy.Service.BasePipe> | null;
     ...
     */
    static mergeAll(mergeObj: GenaiCore.DynamicPy.Service.BasePipe, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: GenaiCore.DynamicPy.Service.BasePipe, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<GenaiCore.DynamicPy.Service.BasePipe>, spec?: UpsertSpec): ObjList<GenaiCore.DynamicPy.Service.BasePipe> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<GenaiCore.DynamicPy.Service.BasePipe>, spec?: UpsertSpec): ObjList<GenaiCore.DynamicPy.Service.BasePipe> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): GenaiCore.DynamicPy.Service.BasePipe | null;
     ...
     */
    static beforeCreate(objs: Array_Type<GenaiCore.DynamicPy.Service.BasePipe>): ObjList<GenaiCore.DynamicPy.Service.BasePipe>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<GenaiCore.DynamicPy.Service.BasePipe>): ObjList<GenaiCore.DynamicPy.Service.BasePipe>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<GenaiCore.DynamicPy.Service.BasePipe>): ObjList<GenaiCore.DynamicPy.Service.BasePipe>;
     ...
     */
    static afterCreate(objs: Array_Type<GenaiCore.DynamicPy.Service.BasePipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<GenaiCore.DynamicPy.Service.BasePipe>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<GenaiCore.DynamicPy.Service.BasePipe>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<GenaiCore.DynamicPy.Service.BasePipe>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GenaiCore.DynamicPy.Service.BasePipe>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.DynamicPy.Service.BasePipe | null;
     ...
     */
    withoutIdentity(): GenaiCore.DynamicPy.Service.BasePipe | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<GenaiCore.DynamicPy.Service.BasePipe>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: GenaiCore.DynamicPy.Service.BasePipe, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<GenaiCore.DynamicPy.Service.BasePipe>, callback?: λFunction<GenaiCore.DynamicPy.Service.BasePipe | null, GenaiCore.DynamicPy.Service.BasePipe | null>): ObjList<GenaiCore.DynamicPy.Service.BasePipe>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<GenaiCore.DynamicPy.Service.BasePipe>, callback?: λFunction<GenaiCore.DynamicPy.Service.BasePipe | null, GenaiCore.DynamicPy.Service.BasePipe | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.DynamicPy.Service.BasePipe> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): GenaiCore.DynamicPy.Service.BasePipe | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.DynamicPy.Service.BasePipe> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): GenaiCore.DynamicPy.Service.BasePipe | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.DynamicPy.Service.BasePipe> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): GenaiCore.DynamicPy.Service.BasePipe | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<GenaiCore.DynamicPy.Service.BasePipe> | null;
    ...
    dependencies(): SeedDataDeps<GenaiCore.DynamicPy.Service.BasePipe> | null;
     ...
     */
    train(x: any, y?: , spec?: MlOperationSpec): MlOperationRun<any>;

    /**
     * Note: This function is dispatched to the runtime that {@link #doTrain} specifies.
     */
    trainSync(x: any, y?: , spec?: MlOperationSpec): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     */
    process(x: any, spec?: MlOperationSpec): MlOperationRun<any> | null;

    /**
     * Note: This function is dispatched to the runtime that {@link #doProcess} specifies.
     */
    processSync(x: any, spec?: MlOperationSpec): any | null;
     ...
     */
    score(x: any, y?: , context?: , spec?: MlOperationSpec): MlOperationRun<Map_Type<string, number>> | null;

    /**
     * Blocking, synchronous version of {@link #score}.
     */
    scoreSync(x: any, y?: , context?: , spec?: MlOperationSpec): Map_Type<string, number> | null;
     ...
     *           the operation run object to query status and to get the final result.
     */
    scoreAll(x: any, y?: , context?: , spec?: MlOperationSpec): MlOperationRun<Map_Type<string, number>> | null;

    /**
     * Blocking, synchronous version of {@link #scoreAll}.
     */
    scoreAllSync(x: any, y?: , context?: , spec?: MlOperationSpec): Map_Type<string, number> | null;
     ...
     *           the operation run object to query status and to get the final result.
     */
    interpret(x: any, spec?: MlOperationSpec): MlOperationRun<> | null;

    /**
     * Blocking, synchronous version of {@link #interpret}.
     */
    interpretSync(x: any, context?: Map_Type<string, any>, spec?: MlOperationSpec): void;
     ...
     */
    newAuthoringVertex(x?: any, y?: , context?: , suffix?: string = '""', spec?: MlConvertSpec): MlPipeline.PipeVertex.Authoring;
     ...
     * be returned as-is.
     */
    byReference(): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     */
    updateModelFiles(modelFiles: Map_Type<string, Url>, spec?: MlOperationSpec): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     */
    afterTrain(doTrainOutputs: any, spec?: MlOperationSpec): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     */
    convertPipeInputsToNative(x: any, y?: , spec?: MlOperationSpec): any;
     ...
     */
    convertXToNative(x: any, spec?: MlOperationSpec): any;
     ...
     */
    convertNativeToPipeOutputs(output: any, datasetId?: string): any;
     ...
     */
    withNewSpec(spec?: MlConvertSpec): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     */
    afterConvert(model: any, spec?: MlConvertSpec): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     */
    static getInputDatasetId(x?: any): string;
     ...
     */
    withHyperparamSpaces(paramSpaces: Map_Type<string, Hp.ParamSpace>): GenaiCore.DynamicPy.Service.BasePipe;
     ...
     */
    static fromBase(base: GenaiCore.DynamicPy.Base): GenaiCore.DynamicPy.Service.BasePipe;
  }
}
