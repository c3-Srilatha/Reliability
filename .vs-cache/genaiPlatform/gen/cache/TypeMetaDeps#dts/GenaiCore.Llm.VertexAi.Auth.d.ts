// TypeScript definitions for the C3 type GenaiCore.Llm.VertexAi.Auth

/**
 * Authentication information for the Vertex AI LLM Service.
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Llm.VertexAi.Auth
 */
...
declare namespace GenaiCore.Llm.VertexAi {
  export class Auth extends Obj  {
    ...
    withName(name: string): GenaiCore.Llm.VertexAi.Auth;
    ...
    withConfigOverride(configOverride: string | null): GenaiCore.Llm.VertexAi.Auth;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): GenaiCore.Llm.VertexAi.Auth;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): GenaiCore.Llm.VertexAi.Auth;
    ...
    withAuths(auths: Array_Type<GenaiCore.Llm.Auth> | Array<IGenaiCore.Llm.Auth> | null): GenaiCore.Llm.VertexAi.Auth;
    ...
    withServiceAccountInfo(serviceAccountInfo: string | null): GenaiCore.Llm.VertexAi.Auth;
     ...
     * An example of this can be found on {@link https://docs.litellm.ai/docs/providers/vertex#system-message}.
     */
    static readonly serviceAccountInfo?: string;

    /**
     * The Google Cloud Project ID or number.
     */
    readonly project?: string;
    withProject(project: string | null): GenaiCore.Llm.VertexAi.Auth;
    ...
    withLocation(location: string | null): GenaiCore.Llm.VertexAi.Auth;
     ...
     */
    static inst(): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Llm.VertexAi.Auth | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Llm.VertexAi.Auth | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Llm.VertexAi.Auth | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Llm.VertexAi.Auth | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Llm.VertexAi.Auth;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): GenaiCore.Llm.VertexAi.Auth;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Llm.VertexAi.Auth;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Llm.VertexAi.Auth;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Llm.VertexAi.Auth;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Llm.VertexAi.Auth;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Llm.VertexAi.Auth>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Llm.VertexAi.Auth>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Llm.VertexAi.Auth>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Llm.VertexAi.Auth>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Llm.VertexAi.Auth;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Llm.VertexAi.Auth;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Llm.VertexAi.Auth;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Llm.VertexAi.Auth;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Llm.VertexAi.Auth;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Llm.VertexAi.Auth;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Llm.VertexAi.Auth;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @see #removeField
     */
    static withoutField(field: string): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): GenaiCore.Llm.VertexAi.Auth;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Llm.VertexAi.Auth;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Llm.VertexAi.Auth;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): GenaiCore.Llm.VertexAi.Auth;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @see #removeField
     */
    static unsetField(field: string): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @see #unsetField
     */
    static removeField(field: string): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): GenaiCore.Llm.VertexAi.Auth;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Llm.VertexAi.Auth;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Llm.VertexAi.Auth;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Llm.VertexAi.Auth;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Llm.VertexAi.Auth;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Llm.VertexAi.Auth;

    mergeJson(json: any): GenaiCore.Llm.VertexAi.Auth;

    static mergeJson(json: any): GenaiCore.Llm.VertexAi.Auth;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Llm.VertexAi.Auth;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Llm.VertexAi.Auth;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): GenaiCore.Llm.VertexAi.Auth;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Llm.VertexAi.Auth>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<GenaiCore.Llm.VertexAi.Auth>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Llm.VertexAi.Auth> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Llm.VertexAi.Auth> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Llm.VertexAi.Auth>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<GenaiCore.Llm.VertexAi.Auth>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Llm.VertexAi.Auth> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Llm.VertexAi.Auth> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Llm.VertexAi.Auth> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Llm.VertexAi.Auth>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<GenaiCore.Llm.VertexAi.Auth>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Llm.VertexAi.Auth>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Llm.VertexAi.Auth;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.Llm.VertexAi.Auth | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Llm.VertexAi.Auth;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Llm.VertexAi.Auth;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): GenaiCore.Llm.VertexAi.Auth;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Llm.VertexAi.Auth;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Llm.VertexAi.Auth> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Llm.VertexAi.Auth;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.Llm.VertexAi.Auth | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): GenaiCore.Llm.VertexAi.Auth | null;
     ...
     */
    static allCached(): Stream<GenaiCore.Llm.VertexAi.Auth> | null;
     ...
     */
    static find(filter?: string): Stream<GenaiCore.Llm.VertexAi.Auth> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<GenaiCore.Llm.VertexAi.Auth> | null;

    /**
     * @return cached instance.
     */
    getCached(): GenaiCore.Llm.VertexAi.Auth | null;

    /**
     * @return cached instance.
     */
    static getCached(): GenaiCore.Llm.VertexAi.Auth | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): GenaiCore.Llm.VertexAi.Auth | null;
     ...
     */
    static produce(key: string): GenaiCore.Llm.VertexAi.Auth | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, GenaiCore.Llm.VertexAi.Auth> | null;
     ...
     */
    getConfig(): GenaiCore.Llm.VertexAi.Auth;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): GenaiCore.Llm.VertexAi.Auth;
     ...
     */
    getSecret(): GenaiCore.Llm.VertexAi.Auth;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): GenaiCore.Llm.VertexAi.Auth;
     ...
     */
    withConfigKey(configKey: string): GenaiCore.Llm.VertexAi.Auth;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): GenaiCore.Llm.VertexAi.Auth;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): GenaiCore.Llm.VertexAi.Auth;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): GenaiCore.Llm.VertexAi.Auth;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): GenaiCore.Llm.VertexAi.Auth | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<GenaiCore.Llm.VertexAi.Auth> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: GenaiCore.Llm.VertexAi.Auth, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: GenaiCore.Llm.VertexAi.Auth, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): GenaiCore.Llm.VertexAi.Auth | null;
     ...
     */
    removeSecrets(): GenaiCore.Llm.VertexAi.Auth | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): GenaiCore.Llm.VertexAi.Auth | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): GenaiCore.Llm.VertexAi.Auth | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): GenaiCore.Llm.VertexAi.Auth | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): GenaiCore.Llm.VertexAi.Auth;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): GenaiCore.Llm.VertexAi.Auth;
