// TypeScript definitions for the C3 type GenaiCore.Unstructured.TestFailProcessor

/**
 * Test type for a {@link GenaiCore.Unstructured.Processor} that always fails.
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Unstructured.TestFailProcessor
 */
declare namespace GenaiCore.Unstructured {
  export interface ITestFailProcessor {
     ...
     * @see #componentOrder
     */
    components: Map_Type<string, GenaiCore.Unstructured.ProcessorComponent> | {[key: string]: IGenaiCore.Unstructured.ProcessorComponent};
     ...
     */
    componentOrder: Array_Type<string> | Array<string>;
 ...
 * Test type for a {@link GenaiCore.Unstructured.Processor} that always fails.
 *
 * @remarks this represents a made instance of GenaiCore.Unstructured.TestFailProcessor
 */
declare namespace GenaiCore.Unstructured {
  export class TestFailProcessor extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): GenaiCore.Unstructured.TestFailProcessor;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GenaiCore.Unstructured.TestFailProcessor;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): GenaiCore.Unstructured.TestFailProcessor;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): GenaiCore.Unstructured.TestFailProcessor;
    ...
    withVersion(version: number | null): GenaiCore.Unstructured.TestFailProcessor;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): GenaiCore.Unstructured.TestFailProcessor;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): GenaiCore.Unstructured.TestFailProcessor;
    ...
    withHidden(hidden: boolean): GenaiCore.Unstructured.TestFailProcessor;
    ...
    withUserOwned(userOwned: boolean): GenaiCore.Unstructured.TestFailProcessor;
    ...
    withTypeIdent(typeIdent: string | null): GenaiCore.Unstructured.TestFailProcessor;
     ...
     * @see #componentOrder
     */
    readonly components: Map_Type<string, GenaiCore.Unstructured.ProcessorComponent>;
    withComponents(components: Map_Type<string, GenaiCore.Unstructured.ProcessorComponent> | {[key: string]: IGenaiCore.Unstructured.ProcessorComponent}): GenaiCore.Unstructured.TestFailProcessor;
     ...
     * in a format that can be embedded by the job's embedder.
     */
    readonly componentOrder: Array_Type<string>;
    withComponentOrder(componentOrder: Array_Type<string> | Array<string>): GenaiCore.Unstructured.TestFailProcessor;

    /**
     * The action requirement needed for the processor to run.
     */
    readonly actionRequirement?: string;
    withActionRequirement(actionRequirement: string | null): GenaiCore.Unstructured.TestFailProcessor;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Unstructured.TestFailProcessor | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Unstructured.TestFailProcessor | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Unstructured.TestFailProcessor | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Unstructured.TestFailProcessor | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Unstructured.TestFailProcessor;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Unstructured.TestFailProcessor;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Unstructured.TestFailProcessor;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Unstructured.TestFailProcessor>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Unstructured.TestFailProcessor>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Unstructured.TestFailProcessor;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Unstructured.TestFailProcessor;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Unstructured.TestFailProcessor;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Unstructured.TestFailProcessor;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Unstructured.TestFailProcessor;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Unstructured.TestFailProcessor;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Unstructured.TestFailProcessor;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Unstructured.TestFailProcessor;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Unstructured.TestFailProcessor;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Unstructured.TestFailProcessor;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Unstructured.TestFailProcessor;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Unstructured.TestFailProcessor;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Unstructured.TestFailProcessor;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Unstructured.TestFailProcessor;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Unstructured.TestFailProcessor;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Unstructured.TestFailProcessor;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Unstructured.TestFailProcessor;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Unstructured.TestFailProcessor;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Unstructured.TestFailProcessor;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Unstructured.TestFailProcessor;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Unstructured.TestFailProcessor;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Unstructured.TestFailProcessor;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Unstructured.TestFailProcessor;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Unstructured.TestFailProcessor;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Unstructured.TestFailProcessor;

    mergeJson(json: any): GenaiCore.Unstructured.TestFailProcessor;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Unstructured.TestFailProcessor;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Unstructured.TestFailProcessor;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Unstructured.TestFailProcessor>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Unstructured.TestFailProcessor> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Unstructured.TestFailProcessor> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Unstructured.TestFailProcessor>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Unstructured.TestFailProcessor> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Unstructured.TestFailProcessor> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Unstructured.TestFailProcessor> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Unstructured.TestFailProcessor>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Unstructured.TestFailProcessor>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Unstructured.TestFailProcessor;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Unstructured.TestFailProcessor;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Unstructured.TestFailProcessor;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Unstructured.TestFailProcessor;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Unstructured.TestFailProcessor;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Unstructured.TestFailProcessor;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.Unstructured.TestFailProcessor | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Unstructured.TestFailProcessor;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Unstructured.TestFailProcessor;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Unstructured.TestFailProcessor;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Unstructured.TestFailProcessor> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Unstructured.TestFailProcessor;
     ...
     */
    static allCached(): Stream<GenaiCore.Unstructured.TestFailProcessor> | null;
     ...
     */
    static find(filter?: string): Stream<GenaiCore.Unstructured.TestFailProcessor> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<GenaiCore.Unstructured.TestFailProcessor> | null;

    /**
     * @return cached instance.
     */
    getCached(): GenaiCore.Unstructured.TestFailProcessor | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): GenaiCore.Unstructured.TestFailProcessor | null;
     ...
     */
    static produce(key: string): GenaiCore.Unstructured.TestFailProcessor | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, GenaiCore.Unstructured.TestFailProcessor> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<GenaiCore.Unstructured.TestFailProcessor>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<GenaiCore.Unstructured.TestFailProcessor>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<GenaiCore.Unstructured.TestFailProcessor> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenaiCore.Unstructured.TestFailProcessor>> | null;
     ...
     */
    get(include?: string): GenaiCore.Unstructured.TestFailProcessor | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): GenaiCore.Unstructured.TestFailProcessor | null;
     ...
     */
    getMissing(spec: GetMissingSpec): GenaiCore.Unstructured.TestFailProcessor;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): GenaiCore.Unstructured.TestFailProcessor | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): GenaiCore.Unstructured.TestFailProcessor;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.Unstructured.TestFailProcessor | null;
     ...
     */
    create(spec?: UpsertSpec): GenaiCore.Unstructured.TestFailProcessor | null;
     ...
     */
    static createBatch(objs: Array_Type<GenaiCore.Unstructured.TestFailProcessor>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.TestFailProcessor> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<GenaiCore.Unstructured.TestFailProcessor>, spec?: CreateBatchObjStreamSpec): ObjList<GenaiCore.Unstructured.TestFailProcessor> | null;
     ...
     */
    update(srcObj?: GenaiCore.Unstructured.TestFailProcessor, spec?: UpsertSpec): GenaiCore.Unstructured.TestFailProcessor | null;
     ...
     */
    upsert(srcObj?: GenaiCore.Unstructured.TestFailProcessor, spec?: UpsertSpec): GenaiCore.Unstructured.TestFailProcessor | null;
     ...
     */
    merge(spec?: MergeSpec): GenaiCore.Unstructured.TestFailProcessor | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): GenaiCore.Unstructured.TestFailProcessor | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): GenaiCore.Unstructured.TestFailProcessor | null;
     ...
     */
    static updateBatch(objs: Array_Type<GenaiCore.Unstructured.TestFailProcessor>, srcObjs?: Array_Type<GenaiCore.Unstructured.TestFailProcessor>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.TestFailProcessor> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<GenaiCore.Unstructured.TestFailProcessor> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.TestFailProcessor> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<GenaiCore.Unstructured.TestFailProcessor>, srcObjs?: Array_Type<GenaiCore.Unstructured.TestFailProcessor>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.TestFailProcessor> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<GenaiCore.Unstructured.TestFailProcessor> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.TestFailProcessor> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<GenaiCore.Unstructured.TestFailProcessor>, spec?: TouchSpec): ObjList<GenaiCore.Unstructured.TestFailProcessor> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Unstructured.TestFailProcessor>, spec?: MergeSpec): ObjList<GenaiCore.Unstructured.TestFailProcessor> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Unstructured.TestFailProcessor>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Unstructured.TestFailProcessor> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<GenaiCore.Unstructured.TestFailProcessor> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Unstructured.TestFailProcessor> | null;
     ...
     */
    static mergeAll(mergeObj: GenaiCore.Unstructured.TestFailProcessor, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: GenaiCore.Unstructured.TestFailProcessor, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<GenaiCore.Unstructured.TestFailProcessor>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.TestFailProcessor> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<GenaiCore.Unstructured.TestFailProcessor>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.TestFailProcessor> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): GenaiCore.Unstructured.TestFailProcessor | null;
     ...
     */
    static beforeCreate(objs: Array_Type<GenaiCore.Unstructured.TestFailProcessor>): ObjList<GenaiCore.Unstructured.TestFailProcessor>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<GenaiCore.Unstructured.TestFailProcessor>): ObjList<GenaiCore.Unstructured.TestFailProcessor>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<GenaiCore.Unstructured.TestFailProcessor>): ObjList<GenaiCore.Unstructured.TestFailProcessor>;
     ...
     */
    static afterCreate(objs: Array_Type<GenaiCore.Unstructured.TestFailProcessor>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<GenaiCore.Unstructured.TestFailProcessor>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<GenaiCore.Unstructured.TestFailProcessor>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<GenaiCore.Unstructured.TestFailProcessor>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GenaiCore.Unstructured.TestFailProcessor>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.Unstructured.TestFailProcessor | null;
     ...
     */
    withoutIdentity(): GenaiCore.Unstructured.TestFailProcessor | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<GenaiCore.Unstructured.TestFailProcessor>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: GenaiCore.Unstructured.TestFailProcessor, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<GenaiCore.Unstructured.TestFailProcessor>, callback?: λFunction<GenaiCore.Unstructured.TestFailProcessor | null, GenaiCore.Unstructured.TestFailProcessor | null>): ObjList<GenaiCore.Unstructured.TestFailProcessor>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<GenaiCore.Unstructured.TestFailProcessor>, callback?: λFunction<GenaiCore.Unstructured.TestFailProcessor | null, GenaiCore.Unstructured.TestFailProcessor | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): GenaiCore.Unstructured.TestFailProcessor;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.TestFailProcessor> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): GenaiCore.Unstructured.TestFailProcessor | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.TestFailProcessor> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): GenaiCore.Unstructured.TestFailProcessor | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.TestFailProcessor> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): GenaiCore.Unstructured.TestFailProcessor | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<GenaiCore.Unstructured.TestFailProcessor> | null;
    ...
    dependencies(): SeedDataDeps<GenaiCore.Unstructured.TestFailProcessor> | null;
     ...
     */
    process(filePath: string): Array_Type<GenaiCore.Unstructured.Processor.OutputChunk>;
     ...
     */
    processBatch(filePaths: Array_Type<string>): GenaiCore.Unstructured.Processor.BatchOutput;
     ...
     * @return the output of processing.
     */
    processCheckpoints(checkpoints: Map_Type<string, Map_Type<string, any>>, afterComponentFunc?: any): GenaiCore.Unstructured.Processor.BatchOutput;
  }
}
