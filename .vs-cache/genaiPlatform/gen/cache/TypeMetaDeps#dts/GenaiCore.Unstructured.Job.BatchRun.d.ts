// TypeScript definitions for the C3 type GenaiCore.Unstructured.Job.BatchRun

/**
 * Tracks the details for a single batch run of an unstructured job.
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Unstructured.Job.BatchRun
 */
declare namespace GenaiCore.Unstructured.Job {
  export interface IBatchRun {
     ...
     */
    summary?: Map_Type<string, Map_Type<string, string>> | {[key: string]: Map_Type<string, string> | {[key: string]: string}};
  }
}
 ...
 */
declare namespace GenaiCore.Unstructured.Job {
  export class BatchRun extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): GenaiCore.Unstructured.Job.BatchRun;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GenaiCore.Unstructured.Job.BatchRun;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): GenaiCore.Unstructured.Job.BatchRun;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): GenaiCore.Unstructured.Job.BatchRun;
    ...
    withVersion(version: number | null): GenaiCore.Unstructured.Job.BatchRun;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): GenaiCore.Unstructured.Job.BatchRun;
    ...
    withRunNumber(runNumber: number): GenaiCore.Unstructured.Job.BatchRun;

    /**
     * Reference to the job run.
     */
    readonly jobRun: GenaiCore.Unstructured.Job.Run;
    withJobRun(jobRun: IGenaiCore.Unstructured.Job.Run): GenaiCore.Unstructured.Job.BatchRun;

    /**
     * A summary of the batch run represented by a mapping of job steps (e.g., initialization, processing
     * embedding, vector store) to their respective metrics.
     */
    readonly summary?: Map_Type<string, Map_Type<string, string>>;
    withSummary(summary: Map_Type<string, Map_Type<string, string>> | {[key: string]: Map_Type<string, string> | {[key: string]: string}} | null): GenaiCore.Unstructured.Job.BatchRun;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Unstructured.Job.BatchRun | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Unstructured.Job.BatchRun | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Unstructured.Job.BatchRun | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Unstructured.Job.BatchRun | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Unstructured.Job.BatchRun;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Unstructured.Job.BatchRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Unstructured.Job.BatchRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Unstructured.Job.BatchRun>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Unstructured.Job.BatchRun>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Unstructured.Job.BatchRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Unstructured.Job.BatchRun;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Unstructured.Job.BatchRun;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Unstructured.Job.BatchRun;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Unstructured.Job.BatchRun;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Unstructured.Job.BatchRun;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Unstructured.Job.BatchRun;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Unstructured.Job.BatchRun;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Unstructured.Job.BatchRun;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Unstructured.Job.BatchRun;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Unstructured.Job.BatchRun;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Unstructured.Job.BatchRun;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Unstructured.Job.BatchRun;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Unstructured.Job.BatchRun;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Unstructured.Job.BatchRun;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Unstructured.Job.BatchRun;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Unstructured.Job.BatchRun;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Unstructured.Job.BatchRun;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Unstructured.Job.BatchRun;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Unstructured.Job.BatchRun;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Unstructured.Job.BatchRun;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Unstructured.Job.BatchRun;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Unstructured.Job.BatchRun;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Unstructured.Job.BatchRun;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Unstructured.Job.BatchRun;

    mergeJson(json: any): GenaiCore.Unstructured.Job.BatchRun;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Unstructured.Job.BatchRun;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Unstructured.Job.BatchRun;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Unstructured.Job.BatchRun>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Unstructured.Job.BatchRun> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Unstructured.Job.BatchRun> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Unstructured.Job.BatchRun>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Unstructured.Job.BatchRun> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Unstructured.Job.BatchRun> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Unstructured.Job.BatchRun> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Unstructured.Job.BatchRun>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Unstructured.Job.BatchRun>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Unstructured.Job.BatchRun;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Unstructured.Job.BatchRun;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Unstructured.Job.BatchRun;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Unstructured.Job.BatchRun;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Unstructured.Job.BatchRun;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Unstructured.Job.BatchRun;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.Unstructured.Job.BatchRun | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Unstructured.Job.BatchRun;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Unstructured.Job.BatchRun;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Unstructured.Job.BatchRun;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Unstructured.Job.BatchRun> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Unstructured.Job.BatchRun;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<GenaiCore.Unstructured.Job.BatchRun>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<GenaiCore.Unstructured.Job.BatchRun>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<GenaiCore.Unstructured.Job.BatchRun> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenaiCore.Unstructured.Job.BatchRun>> | null;
     ...
     */
    get(include?: string): GenaiCore.Unstructured.Job.BatchRun | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): GenaiCore.Unstructured.Job.BatchRun | null;
     ...
     */
    getMissing(spec: GetMissingSpec): GenaiCore.Unstructured.Job.BatchRun;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): GenaiCore.Unstructured.Job.BatchRun | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): GenaiCore.Unstructured.Job.BatchRun;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.Unstructured.Job.BatchRun | null;
     ...
     */
    create(spec?: UpsertSpec): GenaiCore.Unstructured.Job.BatchRun | null;
     ...
     */
    static createBatch(objs: Array_Type<GenaiCore.Unstructured.Job.BatchRun>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Job.BatchRun> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<GenaiCore.Unstructured.Job.BatchRun>, spec?: CreateBatchObjStreamSpec): ObjList<GenaiCore.Unstructured.Job.BatchRun> | null;
     ...
     */
    update(srcObj?: GenaiCore.Unstructured.Job.BatchRun, spec?: UpsertSpec): GenaiCore.Unstructured.Job.BatchRun | null;
     ...
     */
    upsert(srcObj?: GenaiCore.Unstructured.Job.BatchRun, spec?: UpsertSpec): GenaiCore.Unstructured.Job.BatchRun | null;
     ...
     */
    merge(spec?: MergeSpec): GenaiCore.Unstructured.Job.BatchRun | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): GenaiCore.Unstructured.Job.BatchRun | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): GenaiCore.Unstructured.Job.BatchRun | null;
     ...
     */
    static updateBatch(objs: Array_Type<GenaiCore.Unstructured.Job.BatchRun>, srcObjs?: Array_Type<GenaiCore.Unstructured.Job.BatchRun>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Job.BatchRun> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<GenaiCore.Unstructured.Job.BatchRun> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Job.BatchRun> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<GenaiCore.Unstructured.Job.BatchRun>, srcObjs?: Array_Type<GenaiCore.Unstructured.Job.BatchRun>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Job.BatchRun> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<GenaiCore.Unstructured.Job.BatchRun> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Job.BatchRun> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<GenaiCore.Unstructured.Job.BatchRun>, spec?: TouchSpec): ObjList<GenaiCore.Unstructured.Job.BatchRun> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Unstructured.Job.BatchRun>, spec?: MergeSpec): ObjList<GenaiCore.Unstructured.Job.BatchRun> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Unstructured.Job.BatchRun>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Unstructured.Job.BatchRun> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<GenaiCore.Unstructured.Job.BatchRun> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Unstructured.Job.BatchRun> | null;
     ...
     */
    static mergeAll(mergeObj: GenaiCore.Unstructured.Job.BatchRun, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: GenaiCore.Unstructured.Job.BatchRun, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<GenaiCore.Unstructured.Job.BatchRun>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Job.BatchRun> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<GenaiCore.Unstructured.Job.BatchRun>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Job.BatchRun> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): GenaiCore.Unstructured.Job.BatchRun | null;
     ...
     */
    static beforeCreate(objs: Array_Type<GenaiCore.Unstructured.Job.BatchRun>): ObjList<GenaiCore.Unstructured.Job.BatchRun>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<GenaiCore.Unstructured.Job.BatchRun>): ObjList<GenaiCore.Unstructured.Job.BatchRun>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<GenaiCore.Unstructured.Job.BatchRun>): ObjList<GenaiCore.Unstructured.Job.BatchRun>;
     ...
     */
    static afterCreate(objs: Array_Type<GenaiCore.Unstructured.Job.BatchRun>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<GenaiCore.Unstructured.Job.BatchRun>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<GenaiCore.Unstructured.Job.BatchRun>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<GenaiCore.Unstructured.Job.BatchRun>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GenaiCore.Unstructured.Job.BatchRun>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.Unstructured.Job.BatchRun | null;
     ...
     */
    withoutIdentity(): GenaiCore.Unstructured.Job.BatchRun | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<GenaiCore.Unstructured.Job.BatchRun>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: GenaiCore.Unstructured.Job.BatchRun, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<GenaiCore.Unstructured.Job.BatchRun>, callback?: λFunction<GenaiCore.Unstructured.Job.BatchRun | null, GenaiCore.Unstructured.Job.BatchRun | null>): ObjList<GenaiCore.Unstructured.Job.BatchRun>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<GenaiCore.Unstructured.Job.BatchRun>, callback?: λFunction<GenaiCore.Unstructured.Job.BatchRun | null, GenaiCore.Unstructured.Job.BatchRun | null>): Array_Type<ObjError> | null;
