// TypeScript definitions for the C3 type GenaiCore.SessionStore.Persistable

/**
 * Mixin type for {@link GenaiCore.SessionStore} subtypes that are {@link Persistable} entity types.
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.SessionStore.Persistable
 */
...
declare namespace GenaiCore.SessionStore {
  export class Persistable extends Obj  {
    ...
    withSerializer(serializer: IGenaiCore.SessionStore.Serializer): GenaiCore.SessionStore.Persistable;
    ...
    withRetentionPolicy(retentionPolicy: IGenaiCore.SessionStore.RetentionPolicy | null): GenaiCore.SessionStore.Persistable;

    /**
     * Whether to disable tracing instrumentation for this session store.
     */
    readonly disableTracingInstrumentation?: boolean;
    withDisableTracingInstrumentation(disableTracingInstrumentation: boolean): GenaiCore.SessionStore.Persistable;
     ...
     */
    readonly id: string;
    withId(id: string): GenaiCore.SessionStore.Persistable;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GenaiCore.SessionStore.Persistable;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): GenaiCore.SessionStore.Persistable;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): GenaiCore.SessionStore.Persistable;
    ...
    withVersion(version: number | null): GenaiCore.SessionStore.Persistable;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): GenaiCore.SessionStore.Persistable;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): GenaiCore.SessionStore.Persistable;
    ...
    withHidden(hidden: boolean): GenaiCore.SessionStore.Persistable;
    ...
    withUserOwned(userOwned: boolean): GenaiCore.SessionStore.Persistable;
    ...
    withTypeIdent(typeIdent: string | null): GenaiCore.SessionStore.Persistable;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.SessionStore.Persistable | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.SessionStore.Persistable | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.SessionStore.Persistable | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.SessionStore.Persistable | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.SessionStore.Persistable;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.SessionStore.Persistable;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.SessionStore.Persistable;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.SessionStore.Persistable>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.SessionStore.Persistable>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.SessionStore.Persistable;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.SessionStore.Persistable;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.SessionStore.Persistable;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.SessionStore.Persistable;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.SessionStore.Persistable;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.SessionStore.Persistable;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.SessionStore.Persistable;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.SessionStore.Persistable;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.SessionStore.Persistable;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.SessionStore.Persistable;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.SessionStore.Persistable;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.SessionStore.Persistable;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.SessionStore.Persistable;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.SessionStore.Persistable;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.SessionStore.Persistable;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.SessionStore.Persistable;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.SessionStore.Persistable;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.SessionStore.Persistable;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.SessionStore.Persistable;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.SessionStore.Persistable;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.SessionStore.Persistable;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.SessionStore.Persistable;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.SessionStore.Persistable;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.SessionStore.Persistable;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.SessionStore.Persistable;

    mergeJson(json: any): GenaiCore.SessionStore.Persistable;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.SessionStore.Persistable;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.SessionStore.Persistable;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.SessionStore.Persistable>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.SessionStore.Persistable> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.SessionStore.Persistable> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.SessionStore.Persistable>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.SessionStore.Persistable> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.SessionStore.Persistable> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.SessionStore.Persistable> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.SessionStore.Persistable>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.SessionStore.Persistable>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.SessionStore.Persistable;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.SessionStore.Persistable;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.SessionStore.Persistable;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.SessionStore.Persistable;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.SessionStore.Persistable;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.SessionStore.Persistable;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.SessionStore.Persistable | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.SessionStore.Persistable;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.SessionStore.Persistable;
     ...
     */
    static cachedEmptyInst(): GenaiCore.SessionStore.Persistable;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.SessionStore.Persistable> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.SessionStore.Persistable;
     ...
     */
    static allCached(): Stream<GenaiCore.SessionStore.Persistable> | null;
     ...
     */
    static find(filter?: string): Stream<GenaiCore.SessionStore.Persistable> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<GenaiCore.SessionStore.Persistable> | null;

    /**
     * @return cached instance.
     */
    getCached(): GenaiCore.SessionStore.Persistable | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): GenaiCore.SessionStore.Persistable | null;
     ...
     */
    static produce(key: string): GenaiCore.SessionStore.Persistable | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, GenaiCore.SessionStore.Persistable> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<GenaiCore.SessionStore.Persistable>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<GenaiCore.SessionStore.Persistable>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<GenaiCore.SessionStore.Persistable> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenaiCore.SessionStore.Persistable>> | null;
     ...
     */
    get(include?: string): GenaiCore.SessionStore.Persistable | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): GenaiCore.SessionStore.Persistable | null;
     ...
     */
    getMissing(spec: GetMissingSpec): GenaiCore.SessionStore.Persistable;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): GenaiCore.SessionStore.Persistable | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): GenaiCore.SessionStore.Persistable;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.SessionStore.Persistable | null;
     ...
     */
    create(spec?: UpsertSpec): GenaiCore.SessionStore.Persistable | null;
     ...
     */
    static createBatch(objs: Array_Type<GenaiCore.SessionStore.Persistable>, spec?: UpsertSpec): ObjList<GenaiCore.SessionStore.Persistable> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<GenaiCore.SessionStore.Persistable>, spec?: CreateBatchObjStreamSpec): ObjList<GenaiCore.SessionStore.Persistable> | null;
     ...
     */
    update(srcObj?: GenaiCore.SessionStore.Persistable, spec?: UpsertSpec): GenaiCore.SessionStore.Persistable | null;
     ...
     */
    upsert(srcObj?: GenaiCore.SessionStore.Persistable, spec?: UpsertSpec): GenaiCore.SessionStore.Persistable | null;
     ...
     */
    merge(spec?: MergeSpec): GenaiCore.SessionStore.Persistable | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): GenaiCore.SessionStore.Persistable | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): GenaiCore.SessionStore.Persistable | null;
     ...
     */
    static updateBatch(objs: Array_Type<GenaiCore.SessionStore.Persistable>, srcObjs?: Array_Type<GenaiCore.SessionStore.Persistable>, spec?: UpsertSpec): ObjList<GenaiCore.SessionStore.Persistable> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<GenaiCore.SessionStore.Persistable> | null>, spec?: UpsertSpec): ObjList<GenaiCore.SessionStore.Persistable> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<GenaiCore.SessionStore.Persistable>, srcObjs?: Array_Type<GenaiCore.SessionStore.Persistable>, spec?: UpsertSpec): ObjList<GenaiCore.SessionStore.Persistable> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<GenaiCore.SessionStore.Persistable> | null>, spec?: UpsertSpec): ObjList<GenaiCore.SessionStore.Persistable> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<GenaiCore.SessionStore.Persistable>, spec?: TouchSpec): ObjList<GenaiCore.SessionStore.Persistable> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.SessionStore.Persistable>, spec?: MergeSpec): ObjList<GenaiCore.SessionStore.Persistable> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.SessionStore.Persistable>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.SessionStore.Persistable> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<GenaiCore.SessionStore.Persistable> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.SessionStore.Persistable> | null;
     ...
     */
    static mergeAll(mergeObj: GenaiCore.SessionStore.Persistable, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: GenaiCore.SessionStore.Persistable, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<GenaiCore.SessionStore.Persistable>, spec?: UpsertSpec): ObjList<GenaiCore.SessionStore.Persistable> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<GenaiCore.SessionStore.Persistable>, spec?: UpsertSpec): ObjList<GenaiCore.SessionStore.Persistable> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): GenaiCore.SessionStore.Persistable | null;
     ...
     */
    static beforeCreate(objs: Array_Type<GenaiCore.SessionStore.Persistable>): ObjList<GenaiCore.SessionStore.Persistable>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<GenaiCore.SessionStore.Persistable>): ObjList<GenaiCore.SessionStore.Persistable>;
     ...
     */
    static beforeRemove(objs: Array_Type<GenaiCore.SessionStore.Persistable>): ObjList<GenaiCore.SessionStore.Persistable>;
     ...
     */
    static afterCreate(objs: Array_Type<GenaiCore.SessionStore.Persistable>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<GenaiCore.SessionStore.Persistable>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<GenaiCore.SessionStore.Persistable>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<GenaiCore.SessionStore.Persistable>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GenaiCore.SessionStore.Persistable>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.SessionStore.Persistable | null;
     ...
     */
    withoutIdentity(): GenaiCore.SessionStore.Persistable | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<GenaiCore.SessionStore.Persistable>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: GenaiCore.SessionStore.Persistable, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<GenaiCore.SessionStore.Persistable>, callback?: λFunction<GenaiCore.SessionStore.Persistable | null, GenaiCore.SessionStore.Persistable | null>): ObjList<GenaiCore.SessionStore.Persistable>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<GenaiCore.SessionStore.Persistable>, callback?: λFunction<GenaiCore.SessionStore.Persistable | null, GenaiCore.SessionStore.Persistable | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): GenaiCore.SessionStore.Persistable;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.SessionStore.Persistable> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): GenaiCore.SessionStore.Persistable | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.SessionStore.Persistable> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): GenaiCore.SessionStore.Persistable | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.SessionStore.Persistable> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): GenaiCore.SessionStore.Persistable | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<GenaiCore.SessionStore.Persistable> | null;
    ...
    dependencies(): SeedDataDeps<GenaiCore.SessionStore.Persistable> | null;
     ...
     */
    static cleanUpSessions(spec?: FetchSpec): number;
     ...
     */
    safeSerializer(): GenaiCore.SessionStore.Serializer;
  }
}
