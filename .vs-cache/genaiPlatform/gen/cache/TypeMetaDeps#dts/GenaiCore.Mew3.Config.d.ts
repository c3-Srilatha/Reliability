// TypeScript definitions for the C3 type GenaiCore.Mew3.Config

/**
 * Configurations for {@link GenaiCore.Mew3}.
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Mew3.Config
 */
declare namespace GenaiCore.Mew3 {
  export interface IConfig {
     ...
     */
    defaultCreateSpec?: IGenaiCore.Mew3.ProcessorCreateSpec;
  }
}
...
declare namespace GenaiCore.Mew3 {
  export class Config extends Obj  {
    ...
    withConfigOverride(configOverride: string | null): GenaiCore.Mew3.Config;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): GenaiCore.Mew3.Config;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): GenaiCore.Mew3.Config;
     ...
     * The default spec to use for {@link GenaiCore.Mew3#createProcessor}.
     */
    readonly defaultCreateSpec?: GenaiCore.Mew3.ProcessorCreateSpec;
    withDefaultCreateSpec(defaultCreateSpec: IGenaiCore.Mew3.ProcessorCreateSpec | null): GenaiCore.Mew3.Config;

    /**
     * The default spec to use for {@link GenaiCore.Mew3#createProcessor}.
     */
    static readonly defaultCreateSpec?: GenaiCore.Mew3.ProcessorCreateSpec;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Mew3.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Mew3.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Mew3.Config | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Mew3.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Mew3.Config;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): GenaiCore.Mew3.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Mew3.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Mew3.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Mew3.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Mew3.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Mew3.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Mew3.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Mew3.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Mew3.Config>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Mew3.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Mew3.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Mew3.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Mew3.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Mew3.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Mew3.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Mew3.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): GenaiCore.Mew3.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Mew3.Config;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Mew3.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Mew3.Config;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Mew3.Config;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Mew3.Config;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Mew3.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Mew3.Config;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Mew3.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Mew3.Config;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): GenaiCore.Mew3.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Mew3.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: string): GenaiCore.Mew3.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Mew3.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): GenaiCore.Mew3.Config;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Mew3.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): GenaiCore.Mew3.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Mew3.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Mew3.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Mew3.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): GenaiCore.Mew3.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Mew3.Config;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Mew3.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Mew3.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): GenaiCore.Mew3.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Mew3.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): GenaiCore.Mew3.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Mew3.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: string): GenaiCore.Mew3.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Mew3.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): GenaiCore.Mew3.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Mew3.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: string): GenaiCore.Mew3.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Mew3.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): GenaiCore.Mew3.Config;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Mew3.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Mew3.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Mew3.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Mew3.Config;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Mew3.Config;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Mew3.Config;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Mew3.Config;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Mew3.Config;

    mergeJson(json: any): GenaiCore.Mew3.Config;

    static mergeJson(json: any): GenaiCore.Mew3.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Mew3.Config;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Mew3.Config;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Mew3.Config;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): GenaiCore.Mew3.Config;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Mew3.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<GenaiCore.Mew3.Config>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Mew3.Config> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Mew3.Config> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Mew3.Config>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<GenaiCore.Mew3.Config>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Mew3.Config> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Mew3.Config> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Mew3.Config> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Mew3.Config>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<GenaiCore.Mew3.Config>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Mew3.Config>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Mew3.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Mew3.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Mew3.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Mew3.Config;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Mew3.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Mew3.Config;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Mew3.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Mew3.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): GenaiCore.Mew3.Config;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Mew3.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Mew3.Config> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Mew3.Config;
     ...
     */
    static allCached(): Stream<GenaiCore.Mew3.Config> | null;
     ...
     */
    static find(filter?: string): Stream<GenaiCore.Mew3.Config> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<GenaiCore.Mew3.Config> | null;

    /**
     * @return cached instance.
     */
    getCached(): GenaiCore.Mew3.Config | null;

    /**
     * @return cached instance.
     */
    static getCached(): GenaiCore.Mew3.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): GenaiCore.Mew3.Config | null;
     ...
     */
    static produce(key: string): GenaiCore.Mew3.Config | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, GenaiCore.Mew3.Config> | null;
     ...
     */
    getConfig(): GenaiCore.Mew3.Config;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): GenaiCore.Mew3.Config;
     ...
     */
    getSecret(): GenaiCore.Mew3.Config;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): GenaiCore.Mew3.Config;
     ...
     */
    withConfigKey(configKey: string): GenaiCore.Mew3.Config;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): GenaiCore.Mew3.Config;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): GenaiCore.Mew3.Config;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): GenaiCore.Mew3.Config;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): GenaiCore.Mew3.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<GenaiCore.Mew3.Config> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: GenaiCore.Mew3.Config, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: GenaiCore.Mew3.Config, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): GenaiCore.Mew3.Config | null;
     ...
     */
    removeSecrets(): GenaiCore.Mew3.Config | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): GenaiCore.Mew3.Config | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): GenaiCore.Mew3.Config | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): GenaiCore.Mew3.Config | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): GenaiCore.Mew3.Config;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): GenaiCore.Mew3.Config;
     ...
     */
    static inst(): GenaiCore.Mew3.Config;
  }
}
