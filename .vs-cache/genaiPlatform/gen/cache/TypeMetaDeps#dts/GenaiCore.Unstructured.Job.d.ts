// TypeScript definitions for the C3 type GenaiCore.Unstructured.Job
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Unstructured.Job
 */
declare namespace GenaiCore.Unstructured {
  export interface IJob {
     ...
     */
    processor: IGenaiCore.Unstructured.Processor;
     ...
     */
    vectorStore?: IGenaiCore.VectorStore;
     ...
     */
    checkpointSerializer?: IGenaiCore.Unstructured.Job.Checkpoint.Serializer;
...
declare namespace GenaiCore.Unstructured {
  export class Job extends Obj  {
    ...
    withEnableCheckpointing(enableCheckpointing: boolean): GenaiCore.Unstructured.Job;

    /**
     * The processor that will be used to process the input files to produce output entries that can be embedded.
     */
    readonly processor: GenaiCore.Unstructured.Processor;
    withProcessor(processor: IGenaiCore.Unstructured.Processor): GenaiCore.Unstructured.Job;

    /**
     * If provided, the output entries of #processor will be embedded using this embedder.
     * If not provided, then #enableCheckpointing must be true so that the output entries of #processor are saved.
     */
    readonly embedder?: GenaiCore.Embedder;
    withEmbedder(embedder: IGenaiCore.Embedder | null): GenaiCore.Unstructured.Job;
     ...
     * If not provided, then #enableCheckpointing must be true so that the output entries of #processor or #embedder are saved.
     */
    readonly vectorStore?: GenaiCore.VectorStore;
    withVectorStore(vectorStore: IGenaiCore.VectorStore | null): GenaiCore.Unstructured.Job;
    ...
    withActionRequirement(actionRequirement: string | null): GenaiCore.Unstructured.Job;
    ...
    withNodePool(nodePool: string | null): GenaiCore.Unstructured.Job;

    /**
     * The serializer to use for saving and loading checkpoints.
     */
    readonly checkpointSerializer?: GenaiCore.Unstructured.Job.Checkpoint.Serializer;
    withCheckpointSerializer(checkpointSerializer: IGenaiCore.Unstructured.Job.Checkpoint.Serializer | null): GenaiCore.Unstructured.Job;

    /**
     * The number of items to process in each batch when embedding processor output.
     */
    readonly batchSize?: number;
    withBatchSize(batchSize: number | null): GenaiCore.Unstructured.Job;

    /**
     * The number of items to process in each batch when upserting embeddings output to vector store.
     */
    readonly upsertBatchSize?: number;
    withUpsertBatchSize(upsertBatchSize: number | null): GenaiCore.Unstructured.Job;

    /**
     * If set to true, then the `unstructured-job-run-cleanup` {@link CronJob} will not affect runs from this job.
     * See {@link GenaiCore.Unstructured.Job#cleanupJobRuns} for usage.
     */
    readonly disableJobRunCleanUp?: boolean;
    withDisableJobRunCleanUp(disableJobRunCleanUp: boolean): GenaiCore.Unstructured.Job;
    ...
    withTimeToLiveMinutes(timeToLiveMinutes: number | null): GenaiCore.Unstructured.Job;
     ...
     */
    readonly id: string;
    withId(id: string): GenaiCore.Unstructured.Job;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GenaiCore.Unstructured.Job;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): GenaiCore.Unstructured.Job;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): GenaiCore.Unstructured.Job;
    ...
    withVersion(version: number | null): GenaiCore.Unstructured.Job;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): GenaiCore.Unstructured.Job;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): GenaiCore.Unstructured.Job;
    ...
    withHidden(hidden: boolean): GenaiCore.Unstructured.Job;
    ...
    withUserOwned(userOwned: boolean): GenaiCore.Unstructured.Job;
    ...
    withTypeIdent(typeIdent: string | null): GenaiCore.Unstructured.Job;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Unstructured.Job | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Unstructured.Job | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Unstructured.Job | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Unstructured.Job | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Unstructured.Job;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Unstructured.Job;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Unstructured.Job;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Unstructured.Job>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Unstructured.Job>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Unstructured.Job;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Unstructured.Job;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Unstructured.Job;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Unstructured.Job;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Unstructured.Job;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Unstructured.Job;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Unstructured.Job;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Unstructured.Job;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Unstructured.Job;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Unstructured.Job;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Unstructured.Job;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Unstructured.Job;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Unstructured.Job;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Unstructured.Job;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Unstructured.Job;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Unstructured.Job;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Unstructured.Job;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Unstructured.Job;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Unstructured.Job;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Unstructured.Job;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Unstructured.Job;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Unstructured.Job;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Unstructured.Job;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Unstructured.Job;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Unstructured.Job;

    mergeJson(json: any): GenaiCore.Unstructured.Job;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Unstructured.Job;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Unstructured.Job;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Unstructured.Job>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Unstructured.Job> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Unstructured.Job> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Unstructured.Job>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Unstructured.Job> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Unstructured.Job> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Unstructured.Job> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Unstructured.Job>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Unstructured.Job>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Unstructured.Job;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Unstructured.Job;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Unstructured.Job;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Unstructured.Job;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Unstructured.Job;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Unstructured.Job;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.Unstructured.Job | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Unstructured.Job;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Unstructured.Job;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Unstructured.Job;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Unstructured.Job> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Unstructured.Job;
     ...
     */
    static allCached(): Stream<GenaiCore.Unstructured.Job> | null;
     ...
     */
    static find(filter?: string): Stream<GenaiCore.Unstructured.Job> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<GenaiCore.Unstructured.Job> | null;

    /**
     * @return cached instance.
     */
    getCached(): GenaiCore.Unstructured.Job | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): GenaiCore.Unstructured.Job | null;
     ...
     */
    static produce(key: string): GenaiCore.Unstructured.Job | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, GenaiCore.Unstructured.Job> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<GenaiCore.Unstructured.Job>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<GenaiCore.Unstructured.Job>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<GenaiCore.Unstructured.Job> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenaiCore.Unstructured.Job>> | null;
     ...
     */
    get(include?: string): GenaiCore.Unstructured.Job | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): GenaiCore.Unstructured.Job | null;
     ...
     */
    getMissing(spec: GetMissingSpec): GenaiCore.Unstructured.Job;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): GenaiCore.Unstructured.Job | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): GenaiCore.Unstructured.Job;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.Unstructured.Job | null;
     ...
     */
    create(spec?: UpsertSpec): GenaiCore.Unstructured.Job | null;
     ...
     */
    static createBatch(objs: Array_Type<GenaiCore.Unstructured.Job>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Job> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<GenaiCore.Unstructured.Job>, spec?: CreateBatchObjStreamSpec): ObjList<GenaiCore.Unstructured.Job> | null;
     ...
     */
    update(srcObj?: GenaiCore.Unstructured.Job, spec?: UpsertSpec): GenaiCore.Unstructured.Job | null;
     ...
     */
    upsert(srcObj?: GenaiCore.Unstructured.Job, spec?: UpsertSpec): GenaiCore.Unstructured.Job | null;
     ...
     */
    merge(spec?: MergeSpec): GenaiCore.Unstructured.Job | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): GenaiCore.Unstructured.Job | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): GenaiCore.Unstructured.Job | null;
     ...
     */
    static updateBatch(objs: Array_Type<GenaiCore.Unstructured.Job>, srcObjs?: Array_Type<GenaiCore.Unstructured.Job>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Job> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<GenaiCore.Unstructured.Job> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Job> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<GenaiCore.Unstructured.Job>, srcObjs?: Array_Type<GenaiCore.Unstructured.Job>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Job> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<GenaiCore.Unstructured.Job> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Job> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<GenaiCore.Unstructured.Job>, spec?: TouchSpec): ObjList<GenaiCore.Unstructured.Job> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Unstructured.Job>, spec?: MergeSpec): ObjList<GenaiCore.Unstructured.Job> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Unstructured.Job>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Unstructured.Job> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<GenaiCore.Unstructured.Job> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Unstructured.Job> | null;
     ...
     */
    static mergeAll(mergeObj: GenaiCore.Unstructured.Job, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: GenaiCore.Unstructured.Job, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<GenaiCore.Unstructured.Job>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Job> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<GenaiCore.Unstructured.Job>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Job> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): GenaiCore.Unstructured.Job | null;
     ...
     */
    static beforeCreate(objs: Array_Type<GenaiCore.Unstructured.Job>): ObjList<GenaiCore.Unstructured.Job>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<GenaiCore.Unstructured.Job>): ObjList<GenaiCore.Unstructured.Job>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<GenaiCore.Unstructured.Job>): ObjList<GenaiCore.Unstructured.Job>;
     ...
     */
    static afterCreate(objs: Array_Type<GenaiCore.Unstructured.Job>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<GenaiCore.Unstructured.Job>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<GenaiCore.Unstructured.Job>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<GenaiCore.Unstructured.Job>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GenaiCore.Unstructured.Job>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.Unstructured.Job | null;
     ...
     */
    withoutIdentity(): GenaiCore.Unstructured.Job | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<GenaiCore.Unstructured.Job>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: GenaiCore.Unstructured.Job, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<GenaiCore.Unstructured.Job>, callback?: λFunction<GenaiCore.Unstructured.Job | null, GenaiCore.Unstructured.Job | null>): ObjList<GenaiCore.Unstructured.Job>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<GenaiCore.Unstructured.Job>, callback?: λFunction<GenaiCore.Unstructured.Job | null, GenaiCore.Unstructured.Job | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): GenaiCore.Unstructured.Job;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Job> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): GenaiCore.Unstructured.Job | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Job> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): GenaiCore.Unstructured.Job | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Job> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): GenaiCore.Unstructured.Job | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<GenaiCore.Unstructured.Job> | null;
    ...
    dependencies(): SeedDataDeps<GenaiCore.Unstructured.Job> | null;
     ...
     */
    start(sourceDir: string, spec?: GenaiCore.Unstructured.Job.StartSpec): GenaiCore.Unstructured.Job.Run;
     ...
     */
    startFromCheckpoint(sourceDir: string, referenceRun: GenaiCore.Unstructured.Job.Run, checkpoint: string, spec?: GenaiCore.Unstructured.Job.StartSpec): GenaiCore.Unstructured.Job.Run;
