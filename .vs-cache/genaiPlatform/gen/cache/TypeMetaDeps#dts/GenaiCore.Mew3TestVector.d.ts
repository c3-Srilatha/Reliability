// TypeScript definitions for the C3 type GenaiCore.Mew3TestVector

/**
 * Test vector for mew3-related tests
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Mew3TestVector
 */
declare namespace GenaiCore {
  export interface IMew3TestVector {
 ...
 * Test vector for mew3-related tests
 *
 * @remarks this represents a made instance of GenaiCore.Mew3TestVector
 */
declare namespace GenaiCore {
  export class Mew3TestVector extends Obj  {
    ...
    withContent(content: string | null): GenaiCore.Mew3TestVector;
    ...
    withContentToEmbed(contentToEmbed: string | null): GenaiCore.Mew3TestVector;
    ...
    withEmbedding(embedding: string): GenaiCore.Mew3TestVector;

    /**
     * The unique 'name' (often including complete path) of the source file, e.g. "/my/directory/boiler-repair-manual.pdf"
     */
    readonly source?: string;
    withSource(source: string | null): GenaiCore.Mew3TestVector;

    /**
     * ID of the job run that generated the vector.
     */
    readonly jobRunId?: string;
    withJobRunId(jobRunId: string | null): GenaiCore.Mew3TestVector;

    /**
     * The type of the job run that generated the vector.
     */
    readonly jobRunType?: string;
    withJobRunType(jobRunType: string | null): GenaiCore.Mew3TestVector;
    ...
    withDetails(details: Map_Type<string, any> | {[key: string]: any} | null): GenaiCore.Mew3TestVector;
    ...
    withJobId(jobId: string | null): GenaiCore.Mew3TestVector;

    /**
     * The type of the parent job of the job run that generated the vector.
     */
    readonly jobType?: string;
    withJobType(jobType: string | null): GenaiCore.Mew3TestVector;
     ...
     */
    readonly id: string;
    withId(id: string): GenaiCore.Mew3TestVector;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GenaiCore.Mew3TestVector;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): GenaiCore.Mew3TestVector;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): GenaiCore.Mew3TestVector;
    ...
    withVersion(version: number | null): GenaiCore.Mew3TestVector;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): GenaiCore.Mew3TestVector;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Mew3TestVector | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Mew3TestVector | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Mew3TestVector | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Mew3TestVector | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Mew3TestVector;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Mew3TestVector;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Mew3TestVector;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Mew3TestVector>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Mew3TestVector>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Mew3TestVector;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Mew3TestVector;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Mew3TestVector;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Mew3TestVector;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Mew3TestVector;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Mew3TestVector;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Mew3TestVector;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Mew3TestVector;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Mew3TestVector;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Mew3TestVector;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Mew3TestVector;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Mew3TestVector;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Mew3TestVector;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Mew3TestVector;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Mew3TestVector;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Mew3TestVector;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Mew3TestVector;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Mew3TestVector;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Mew3TestVector;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Mew3TestVector;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Mew3TestVector;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Mew3TestVector;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Mew3TestVector;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Mew3TestVector;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Mew3TestVector;

    mergeJson(json: any): GenaiCore.Mew3TestVector;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Mew3TestVector;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Mew3TestVector;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Mew3TestVector>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Mew3TestVector> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Mew3TestVector> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Mew3TestVector>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Mew3TestVector> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Mew3TestVector> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Mew3TestVector> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Mew3TestVector>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Mew3TestVector>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Mew3TestVector;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Mew3TestVector;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Mew3TestVector;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Mew3TestVector;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Mew3TestVector;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Mew3TestVector;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.Mew3TestVector | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Mew3TestVector;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Mew3TestVector;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Mew3TestVector;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Mew3TestVector> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Mew3TestVector;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<GenaiCore.Mew3TestVector>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<GenaiCore.Mew3TestVector>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<GenaiCore.Mew3TestVector> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenaiCore.Mew3TestVector>> | null;
     ...
     */
    get(include?: string): GenaiCore.Mew3TestVector | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): GenaiCore.Mew3TestVector | null;
     ...
     */
    getMissing(spec: GetMissingSpec): GenaiCore.Mew3TestVector;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): GenaiCore.Mew3TestVector | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): GenaiCore.Mew3TestVector;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.Mew3TestVector | null;
     ...
     */
    create(spec?: UpsertSpec): GenaiCore.Mew3TestVector | null;
     ...
     */
    static createBatch(objs: Array_Type<GenaiCore.Mew3TestVector>, spec?: UpsertSpec): ObjList<GenaiCore.Mew3TestVector> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<GenaiCore.Mew3TestVector>, spec?: CreateBatchObjStreamSpec): ObjList<GenaiCore.Mew3TestVector> | null;
     ...
     */
    update(srcObj?: GenaiCore.Mew3TestVector, spec?: UpsertSpec): GenaiCore.Mew3TestVector | null;
     ...
     */
    upsert(srcObj?: GenaiCore.Mew3TestVector, spec?: UpsertSpec): GenaiCore.Mew3TestVector | null;
     ...
     */
    merge(spec?: MergeSpec): GenaiCore.Mew3TestVector | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): GenaiCore.Mew3TestVector | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): GenaiCore.Mew3TestVector | null;
     ...
     */
    static updateBatch(objs: Array_Type<GenaiCore.Mew3TestVector>, srcObjs?: Array_Type<GenaiCore.Mew3TestVector>, spec?: UpsertSpec): ObjList<GenaiCore.Mew3TestVector> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<GenaiCore.Mew3TestVector> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Mew3TestVector> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<GenaiCore.Mew3TestVector>, srcObjs?: Array_Type<GenaiCore.Mew3TestVector>, spec?: UpsertSpec): ObjList<GenaiCore.Mew3TestVector> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<GenaiCore.Mew3TestVector> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Mew3TestVector> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<GenaiCore.Mew3TestVector>, spec?: TouchSpec): ObjList<GenaiCore.Mew3TestVector> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Mew3TestVector>, spec?: MergeSpec): ObjList<GenaiCore.Mew3TestVector> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Mew3TestVector>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Mew3TestVector> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<GenaiCore.Mew3TestVector> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Mew3TestVector> | null;
     ...
     */
    static mergeAll(mergeObj: GenaiCore.Mew3TestVector, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: GenaiCore.Mew3TestVector, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<GenaiCore.Mew3TestVector>, spec?: UpsertSpec): ObjList<GenaiCore.Mew3TestVector> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<GenaiCore.Mew3TestVector>, spec?: UpsertSpec): ObjList<GenaiCore.Mew3TestVector> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): GenaiCore.Mew3TestVector | null;
     ...
     */
    static beforeCreate(objs: Array_Type<GenaiCore.Mew3TestVector>): ObjList<GenaiCore.Mew3TestVector>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<GenaiCore.Mew3TestVector>): ObjList<GenaiCore.Mew3TestVector>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<GenaiCore.Mew3TestVector>): ObjList<GenaiCore.Mew3TestVector>;
     ...
     */
    static afterCreate(objs: Array_Type<GenaiCore.Mew3TestVector>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<GenaiCore.Mew3TestVector>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<GenaiCore.Mew3TestVector>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<GenaiCore.Mew3TestVector>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GenaiCore.Mew3TestVector>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.Mew3TestVector | null;
     ...
     */
    withoutIdentity(): GenaiCore.Mew3TestVector | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<GenaiCore.Mew3TestVector>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: GenaiCore.Mew3TestVector, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<GenaiCore.Mew3TestVector>, callback?: λFunction<GenaiCore.Mew3TestVector | null, GenaiCore.Mew3TestVector | null>): ObjList<GenaiCore.Mew3TestVector>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<GenaiCore.Mew3TestVector>, callback?: λFunction<GenaiCore.Mew3TestVector | null, GenaiCore.Mew3TestVector | null>): Array_Type<ObjError> | null;
