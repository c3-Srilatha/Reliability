// TypeScript definitions for the C3 type GenaiCore.Unstructured.Job.Run

/**
 * A run of a {@link GenaiCore.Unstructured.Job}.
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Unstructured.Job.Run
 */
declare namespace GenaiCore.Unstructured.Job {
  export interface IRun {
     ...
     */
    job: IGenaiCore.Unstructured.Job;
     ...
     */
    batchJobRuns?: Array_Type<BatchJobRun> | Array<IBatchJobRun>;
     ...
     */
    computedSummary?: IGenaiCore.Unstructured.Job.Run.Summary;

    /**
     * The timestamp after which this job run is eligible for cleanup.
     */
    cleanUpAfter?: DateTime | Date | string;
...
declare namespace GenaiCore.Unstructured.Job {
  export class Run extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): GenaiCore.Unstructured.Job.Run;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GenaiCore.Unstructured.Job.Run;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): GenaiCore.Unstructured.Job.Run;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): GenaiCore.Unstructured.Job.Run;
    ...
    withVersion(version: number | null): GenaiCore.Unstructured.Job.Run;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): GenaiCore.Unstructured.Job.Run;

    /**
     * The job that owns this run.
     */
    readonly job: GenaiCore.Unstructured.Job;
    withJob(job: IGenaiCore.Unstructured.Job): GenaiCore.Unstructured.Job.Run;

    /**
     * The runs of {@link GenaiCore.Unstructured.BatchJob} that actually executed/implemented this run.
     * NOTE: there could be multiple due to {@link #retry}.
     */
    readonly batchJobRuns?: Array_Type<BatchJobRun>;
    withBatchJobRuns(batchJobRuns: Array_Type<BatchJobRun> | Array<IBatchJobRun> | null): GenaiCore.Unstructured.Job.Run;

    /**
     * The number of times this run has been run including retries.
     */
    readonly runCount: number;
    withRunCount(runCount: number): GenaiCore.Unstructured.Job.Run;

    /**
     * The current status of the job run.
     */
    readonly status?: string;
    withStatus(status: string | null): GenaiCore.Unstructured.Job.Run;

    /**
     * Once the run has finished, we can store the result of #summary so that it does not need to be recomputed
     * every time it is requested.
     */
    readonly computedSummary?: GenaiCore.Unstructured.Job.Run.Summary;
    withComputedSummary(computedSummary: IGenaiCore.Unstructured.Job.Run.Summary | null): GenaiCore.Unstructured.Job.Run;

    /**
     * The timestamp after which this job run is eligible for cleanup.
     */
    readonly cleanUpAfter?: DateTime;
    withCleanUpAfter(cleanUpAfter: DateTime | Date | string | null): GenaiCore.Unstructured.Job.Run;
     ...
     * **NOTE** This field is only updated when the run has finished or #summary is called.
     */
    readonly processorChunkCount?: number;
    withProcessorChunkCount(processorChunkCount: number | null): GenaiCore.Unstructured.Job.Run;
    ...
    withVectorCount(vectorCount: number | null): GenaiCore.Unstructured.Job.Run;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Unstructured.Job.Run | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Unstructured.Job.Run | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Unstructured.Job.Run | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Unstructured.Job.Run | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Unstructured.Job.Run;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Unstructured.Job.Run;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Unstructured.Job.Run;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Unstructured.Job.Run>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Unstructured.Job.Run>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Unstructured.Job.Run;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Unstructured.Job.Run;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Unstructured.Job.Run;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Unstructured.Job.Run;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Unstructured.Job.Run;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Unstructured.Job.Run;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Unstructured.Job.Run;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Unstructured.Job.Run;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Unstructured.Job.Run;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Unstructured.Job.Run;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Unstructured.Job.Run;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Unstructured.Job.Run;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Unstructured.Job.Run;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Unstructured.Job.Run;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Unstructured.Job.Run;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Unstructured.Job.Run;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Unstructured.Job.Run;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Unstructured.Job.Run;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Unstructured.Job.Run;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Unstructured.Job.Run;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Unstructured.Job.Run;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Unstructured.Job.Run;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Unstructured.Job.Run;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Unstructured.Job.Run;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Unstructured.Job.Run;

    mergeJson(json: any): GenaiCore.Unstructured.Job.Run;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Unstructured.Job.Run;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Unstructured.Job.Run;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Unstructured.Job.Run>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Unstructured.Job.Run> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Unstructured.Job.Run> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Unstructured.Job.Run>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Unstructured.Job.Run> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Unstructured.Job.Run> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Unstructured.Job.Run> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Unstructured.Job.Run>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Unstructured.Job.Run>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Unstructured.Job.Run;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Unstructured.Job.Run;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Unstructured.Job.Run;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Unstructured.Job.Run;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Unstructured.Job.Run;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Unstructured.Job.Run;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.Unstructured.Job.Run | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Unstructured.Job.Run;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Unstructured.Job.Run;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Unstructured.Job.Run;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Unstructured.Job.Run> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Unstructured.Job.Run;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<GenaiCore.Unstructured.Job.Run>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<GenaiCore.Unstructured.Job.Run>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<GenaiCore.Unstructured.Job.Run> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenaiCore.Unstructured.Job.Run>> | null;
     ...
     */
    get(include?: string): GenaiCore.Unstructured.Job.Run | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): GenaiCore.Unstructured.Job.Run | null;
     ...
     */
    getMissing(spec: GetMissingSpec): GenaiCore.Unstructured.Job.Run;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): GenaiCore.Unstructured.Job.Run | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): GenaiCore.Unstructured.Job.Run;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.Unstructured.Job.Run | null;
     ...
     */
    create(spec?: UpsertSpec): GenaiCore.Unstructured.Job.Run | null;
     ...
     */
    static createBatch(objs: Array_Type<GenaiCore.Unstructured.Job.Run>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Job.Run> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<GenaiCore.Unstructured.Job.Run>, spec?: CreateBatchObjStreamSpec): ObjList<GenaiCore.Unstructured.Job.Run> | null;
     ...
     */
    update(srcObj?: GenaiCore.Unstructured.Job.Run, spec?: UpsertSpec): GenaiCore.Unstructured.Job.Run | null;
     ...
     */
    upsert(srcObj?: GenaiCore.Unstructured.Job.Run, spec?: UpsertSpec): GenaiCore.Unstructured.Job.Run | null;
     ...
     */
    merge(spec?: MergeSpec): GenaiCore.Unstructured.Job.Run | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): GenaiCore.Unstructured.Job.Run | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): GenaiCore.Unstructured.Job.Run | null;
     ...
     */
    static updateBatch(objs: Array_Type<GenaiCore.Unstructured.Job.Run>, srcObjs?: Array_Type<GenaiCore.Unstructured.Job.Run>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Job.Run> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<GenaiCore.Unstructured.Job.Run> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Job.Run> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<GenaiCore.Unstructured.Job.Run>, srcObjs?: Array_Type<GenaiCore.Unstructured.Job.Run>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Job.Run> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<GenaiCore.Unstructured.Job.Run> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Job.Run> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<GenaiCore.Unstructured.Job.Run>, spec?: TouchSpec): ObjList<GenaiCore.Unstructured.Job.Run> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Unstructured.Job.Run>, spec?: MergeSpec): ObjList<GenaiCore.Unstructured.Job.Run> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Unstructured.Job.Run>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Unstructured.Job.Run> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<GenaiCore.Unstructured.Job.Run> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Unstructured.Job.Run> | null;
     ...
     */
    static mergeAll(mergeObj: GenaiCore.Unstructured.Job.Run, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: GenaiCore.Unstructured.Job.Run, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<GenaiCore.Unstructured.Job.Run>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Job.Run> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<GenaiCore.Unstructured.Job.Run>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Job.Run> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): GenaiCore.Unstructured.Job.Run | null;
     ...
     */
    static beforeCreate(objs: Array_Type<GenaiCore.Unstructured.Job.Run>): ObjList<GenaiCore.Unstructured.Job.Run>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<GenaiCore.Unstructured.Job.Run>): ObjList<GenaiCore.Unstructured.Job.Run>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<GenaiCore.Unstructured.Job.Run>): ObjList<GenaiCore.Unstructured.Job.Run>;
     ...
     */
    static afterCreate(objs: Array_Type<GenaiCore.Unstructured.Job.Run>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<GenaiCore.Unstructured.Job.Run>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<GenaiCore.Unstructured.Job.Run>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<GenaiCore.Unstructured.Job.Run>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GenaiCore.Unstructured.Job.Run>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.Unstructured.Job.Run | null;
     ...
     */
    withoutIdentity(): GenaiCore.Unstructured.Job.Run | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<GenaiCore.Unstructured.Job.Run>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: GenaiCore.Unstructured.Job.Run, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<GenaiCore.Unstructured.Job.Run>, callback?: λFunction<GenaiCore.Unstructured.Job.Run | null, GenaiCore.Unstructured.Job.Run | null>): ObjList<GenaiCore.Unstructured.Job.Run>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<GenaiCore.Unstructured.Job.Run>, callback?: λFunction<GenaiCore.Unstructured.Job.Run | null, GenaiCore.Unstructured.Job.Run | null>): Array_Type<ObjError> | null;
     ...
     */
    checkpointsForSource(source: string): Map_Type<string, GenaiCore.Unstructured.Job.Checkpoint> | null;
     ...
     */
    errors(spec?: FetchSpec): Map_Type<string, Map_Type<string, string>> | null;
     ...
     */
    retry(sourceDir: string, spec?: GenaiCore.Unstructured.Job.RetrySpec): GenaiCore.Unstructured.Job.Run;
     ...
     * @return a summary of the job run
     */
    summary(): GenaiCore.Unstructured.Job.Run.Summary | null;
     ...
     */
    onComplete(): GenaiCore.Unstructured.Job.Run;
     ...
     */
    consolidateToFinalStatus(): GenaiCore.Unstructured.Job.Run;
     ...
     */
    sourceRuns(spec?: FetchStreamSpec): Stream<GenaiCore.Unstructured.Job.SourceRun> | null;
     ...
     */
    latestBatchRuns(): Stream<GenaiCore.Unstructured.Job.BatchRun> | null;
     ...
     */
    sourceRun(source: string): GenaiCore.Unstructured.Job.SourceRun | null;
     ...
     */
    sourceRunIdFromSource(source: string): string;
     ...
     */
    static jobComponentFromProcessorComponent(processorComponent: string): string;
     ...
     */
    static processorComponentFromJobComponent(jobComponent: string): string;
  }
}
