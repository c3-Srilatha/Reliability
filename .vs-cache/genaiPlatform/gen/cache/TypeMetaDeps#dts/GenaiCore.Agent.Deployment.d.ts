// TypeScript definitions for the C3 type GenaiCore.Agent.Deployment
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Agent.Deployment
 */
 ...
 */
declare namespace GenaiCore.Agent {
  export class Deployment extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): GenaiCore.Agent.Deployment;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GenaiCore.Agent.Deployment;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): GenaiCore.Agent.Deployment;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): GenaiCore.Agent.Deployment;
    ...
    withVersion(version: number | null): GenaiCore.Agent.Deployment;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): GenaiCore.Agent.Deployment;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): GenaiCore.Agent.Deployment;
    ...
    withHidden(hidden: boolean): GenaiCore.Agent.Deployment;
    ...
    withUserOwned(userOwned: boolean): GenaiCore.Agent.Deployment;

    /**
     * The description of the agent deployment.
     */
    readonly description?: string;
    withDescription(description: string | null): GenaiCore.Agent.Deployment;

    /**
     * The agent that is deployed.
     */
    readonly agent: GenaiCore.Agent;
    withAgent(agent: IGenaiCore.Agent): GenaiCore.Agent.Deployment;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Agent.Deployment | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Agent.Deployment | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Agent.Deployment | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Agent.Deployment | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Agent.Deployment;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Agent.Deployment;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Agent.Deployment;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Agent.Deployment>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Agent.Deployment>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Agent.Deployment;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Agent.Deployment;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Agent.Deployment;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Agent.Deployment;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Agent.Deployment;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Agent.Deployment;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Agent.Deployment;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Agent.Deployment;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Agent.Deployment;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Agent.Deployment;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Agent.Deployment;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Agent.Deployment;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Agent.Deployment;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Agent.Deployment;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Agent.Deployment;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Agent.Deployment;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Agent.Deployment;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Agent.Deployment;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Agent.Deployment;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Agent.Deployment;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Agent.Deployment;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Agent.Deployment;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Agent.Deployment;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Agent.Deployment;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Agent.Deployment;

    mergeJson(json: any): GenaiCore.Agent.Deployment;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Agent.Deployment;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Agent.Deployment;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Agent.Deployment>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Agent.Deployment> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Agent.Deployment> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Agent.Deployment>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Agent.Deployment> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Agent.Deployment> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Agent.Deployment> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Agent.Deployment>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Agent.Deployment>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Agent.Deployment;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Agent.Deployment;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Agent.Deployment;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Agent.Deployment;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Agent.Deployment;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Agent.Deployment;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.Agent.Deployment | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Agent.Deployment;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Agent.Deployment;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Agent.Deployment;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Agent.Deployment> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Agent.Deployment;
     ...
     */
    static allCached(): Stream<GenaiCore.Agent.Deployment> | null;
     ...
     */
    static find(filter?: string): Stream<GenaiCore.Agent.Deployment> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<GenaiCore.Agent.Deployment> | null;

    /**
     * @return cached instance.
     */
    getCached(): GenaiCore.Agent.Deployment | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): GenaiCore.Agent.Deployment | null;
     ...
     */
    static produce(key: string): GenaiCore.Agent.Deployment | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, GenaiCore.Agent.Deployment> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<GenaiCore.Agent.Deployment>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<GenaiCore.Agent.Deployment>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<GenaiCore.Agent.Deployment> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenaiCore.Agent.Deployment>> | null;
     ...
     */
    get(include?: string): GenaiCore.Agent.Deployment | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): GenaiCore.Agent.Deployment | null;
     ...
     */
    getMissing(spec: GetMissingSpec): GenaiCore.Agent.Deployment;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): GenaiCore.Agent.Deployment | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): GenaiCore.Agent.Deployment;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.Agent.Deployment | null;
     ...
     */
    create(spec?: UpsertSpec): GenaiCore.Agent.Deployment | null;
     ...
     */
    static createBatch(objs: Array_Type<GenaiCore.Agent.Deployment>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.Deployment> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<GenaiCore.Agent.Deployment>, spec?: CreateBatchObjStreamSpec): ObjList<GenaiCore.Agent.Deployment> | null;
     ...
     */
    update(srcObj?: GenaiCore.Agent.Deployment, spec?: UpsertSpec): GenaiCore.Agent.Deployment | null;
     ...
     */
    upsert(srcObj?: GenaiCore.Agent.Deployment, spec?: UpsertSpec): GenaiCore.Agent.Deployment | null;
     ...
     */
    merge(spec?: MergeSpec): GenaiCore.Agent.Deployment | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): GenaiCore.Agent.Deployment | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): GenaiCore.Agent.Deployment | null;
     ...
     */
    static updateBatch(objs: Array_Type<GenaiCore.Agent.Deployment>, srcObjs?: Array_Type<GenaiCore.Agent.Deployment>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.Deployment> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<GenaiCore.Agent.Deployment> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.Deployment> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<GenaiCore.Agent.Deployment>, srcObjs?: Array_Type<GenaiCore.Agent.Deployment>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.Deployment> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<GenaiCore.Agent.Deployment> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.Deployment> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<GenaiCore.Agent.Deployment>, spec?: TouchSpec): ObjList<GenaiCore.Agent.Deployment> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Agent.Deployment>, spec?: MergeSpec): ObjList<GenaiCore.Agent.Deployment> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Agent.Deployment>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Agent.Deployment> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<GenaiCore.Agent.Deployment> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Agent.Deployment> | null;
     ...
     */
    static mergeAll(mergeObj: GenaiCore.Agent.Deployment, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: GenaiCore.Agent.Deployment, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<GenaiCore.Agent.Deployment>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.Deployment> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<GenaiCore.Agent.Deployment>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.Deployment> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): GenaiCore.Agent.Deployment | null;
     ...
     */
    static beforeCreate(objs: Array_Type<GenaiCore.Agent.Deployment>): ObjList<GenaiCore.Agent.Deployment>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<GenaiCore.Agent.Deployment>): ObjList<GenaiCore.Agent.Deployment>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<GenaiCore.Agent.Deployment>): ObjList<GenaiCore.Agent.Deployment>;
     ...
     */
    static afterCreate(objs: Array_Type<GenaiCore.Agent.Deployment>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<GenaiCore.Agent.Deployment>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<GenaiCore.Agent.Deployment>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<GenaiCore.Agent.Deployment>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GenaiCore.Agent.Deployment>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.Agent.Deployment | null;
     ...
     */
    withoutIdentity(): GenaiCore.Agent.Deployment | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<GenaiCore.Agent.Deployment>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: GenaiCore.Agent.Deployment, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<GenaiCore.Agent.Deployment>, callback?: λFunction<GenaiCore.Agent.Deployment | null, GenaiCore.Agent.Deployment | null>): ObjList<GenaiCore.Agent.Deployment>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<GenaiCore.Agent.Deployment>, callback?: λFunction<GenaiCore.Agent.Deployment | null, GenaiCore.Agent.Deployment | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): GenaiCore.Agent.Deployment;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.Deployment> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): GenaiCore.Agent.Deployment | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.Deployment> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): GenaiCore.Agent.Deployment | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.Deployment> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): GenaiCore.Agent.Deployment | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<GenaiCore.Agent.Deployment> | null;
    ...
    dependencies(): SeedDataDeps<GenaiCore.Agent.Deployment> | null;
