// TypeScript definitions for the C3 type GenaiCore.Llm.LiteLlm.BatchRequestJob

/**
 * Generic BatchRequestJob implemented through LiteLLM functionality
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Llm.LiteLlm.BatchRequestJob
 */
declare namespace GenaiCore.Llm.LiteLlm {
  export interface IBatchRequestJob {
 ...
 */
declare namespace GenaiCore.Llm.LiteLlm {
  export class BatchRequestJob extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     */
    readonly id: string;
    withId(id: string): GenaiCore.Llm.LiteLlm.BatchRequestJob;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GenaiCore.Llm.LiteLlm.BatchRequestJob;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): GenaiCore.Llm.LiteLlm.BatchRequestJob;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): GenaiCore.Llm.LiteLlm.BatchRequestJob;
    ...
    withVersion(version: number | null): GenaiCore.Llm.LiteLlm.BatchRequestJob;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): GenaiCore.Llm.LiteLlm.BatchRequestJob;

    /**
     * LiteLLM model used for submitting this batch request job
     */
    readonly model: GenaiCore.Llm.LiteLlm;
    withModel(model: IGenaiCore.Llm.LiteLlm): GenaiCore.Llm.LiteLlm.BatchRequestJob;

    /**
     * The id of the batch request job
     */
    readonly jobId: string;
    withJobId(jobId: string): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Llm.LiteLlm.BatchRequestJob | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Llm.LiteLlm.BatchRequestJob | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Llm.LiteLlm.BatchRequestJob | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Llm.LiteLlm.BatchRequestJob | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Llm.LiteLlm.BatchRequestJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Llm.LiteLlm.BatchRequestJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Llm.LiteLlm.BatchRequestJob;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Llm.LiteLlm.BatchRequestJob;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Llm.LiteLlm.BatchRequestJob;

    mergeJson(json: any): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Llm.LiteLlm.BatchRequestJob>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Llm.LiteLlm.BatchRequestJob> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Llm.LiteLlm.BatchRequestJob> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Llm.LiteLlm.BatchRequestJob>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Llm.LiteLlm.BatchRequestJob> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Llm.LiteLlm.BatchRequestJob> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Llm.LiteLlm.BatchRequestJob> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Llm.LiteLlm.BatchRequestJob>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Llm.LiteLlm.BatchRequestJob>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Llm.LiteLlm.BatchRequestJob;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.Llm.LiteLlm.BatchRequestJob | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Llm.LiteLlm.BatchRequestJob;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Llm.LiteLlm.BatchRequestJob> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<GenaiCore.Llm.LiteLlm.BatchRequestJob>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<GenaiCore.Llm.LiteLlm.BatchRequestJob>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<GenaiCore.Llm.LiteLlm.BatchRequestJob> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenaiCore.Llm.LiteLlm.BatchRequestJob>> | null;
     ...
     */
    get(include?: string): GenaiCore.Llm.LiteLlm.BatchRequestJob | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): GenaiCore.Llm.LiteLlm.BatchRequestJob | null;
     ...
     */
    getMissing(spec: GetMissingSpec): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): GenaiCore.Llm.LiteLlm.BatchRequestJob | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): GenaiCore.Llm.LiteLlm.BatchRequestJob;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.Llm.LiteLlm.BatchRequestJob | null;
     ...
     */
    create(spec?: UpsertSpec): GenaiCore.Llm.LiteLlm.BatchRequestJob | null;
     ...
     */
    static createBatch(objs: Array_Type<GenaiCore.Llm.LiteLlm.BatchRequestJob>, spec?: UpsertSpec): ObjList<GenaiCore.Llm.LiteLlm.BatchRequestJob> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<GenaiCore.Llm.LiteLlm.BatchRequestJob>, spec?: CreateBatchObjStreamSpec): ObjList<GenaiCore.Llm.LiteLlm.BatchRequestJob> | null;
     ...
     */
    update(srcObj?: GenaiCore.Llm.LiteLlm.BatchRequestJob, spec?: UpsertSpec): GenaiCore.Llm.LiteLlm.BatchRequestJob | null;
     ...
     */
    upsert(srcObj?: GenaiCore.Llm.LiteLlm.BatchRequestJob, spec?: UpsertSpec): GenaiCore.Llm.LiteLlm.BatchRequestJob | null;
     ...
     */
    merge(spec?: MergeSpec): GenaiCore.Llm.LiteLlm.BatchRequestJob | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): GenaiCore.Llm.LiteLlm.BatchRequestJob | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): GenaiCore.Llm.LiteLlm.BatchRequestJob | null;
     ...
     */
    static updateBatch(objs: Array_Type<GenaiCore.Llm.LiteLlm.BatchRequestJob>, srcObjs?: Array_Type<GenaiCore.Llm.LiteLlm.BatchRequestJob>, spec?: UpsertSpec): ObjList<GenaiCore.Llm.LiteLlm.BatchRequestJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<GenaiCore.Llm.LiteLlm.BatchRequestJob> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Llm.LiteLlm.BatchRequestJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<GenaiCore.Llm.LiteLlm.BatchRequestJob>, srcObjs?: Array_Type<GenaiCore.Llm.LiteLlm.BatchRequestJob>, spec?: UpsertSpec): ObjList<GenaiCore.Llm.LiteLlm.BatchRequestJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<GenaiCore.Llm.LiteLlm.BatchRequestJob> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Llm.LiteLlm.BatchRequestJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<GenaiCore.Llm.LiteLlm.BatchRequestJob>, spec?: TouchSpec): ObjList<GenaiCore.Llm.LiteLlm.BatchRequestJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Llm.LiteLlm.BatchRequestJob>, spec?: MergeSpec): ObjList<GenaiCore.Llm.LiteLlm.BatchRequestJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Llm.LiteLlm.BatchRequestJob>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Llm.LiteLlm.BatchRequestJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<GenaiCore.Llm.LiteLlm.BatchRequestJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Llm.LiteLlm.BatchRequestJob> | null;
     ...
     */
    static mergeAll(mergeObj: GenaiCore.Llm.LiteLlm.BatchRequestJob, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: GenaiCore.Llm.LiteLlm.BatchRequestJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<GenaiCore.Llm.LiteLlm.BatchRequestJob>, spec?: UpsertSpec): ObjList<GenaiCore.Llm.LiteLlm.BatchRequestJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<GenaiCore.Llm.LiteLlm.BatchRequestJob>, spec?: UpsertSpec): ObjList<GenaiCore.Llm.LiteLlm.BatchRequestJob> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): GenaiCore.Llm.LiteLlm.BatchRequestJob | null;
     ...
     */
    static beforeCreate(objs: Array_Type<GenaiCore.Llm.LiteLlm.BatchRequestJob>): ObjList<GenaiCore.Llm.LiteLlm.BatchRequestJob>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<GenaiCore.Llm.LiteLlm.BatchRequestJob>): ObjList<GenaiCore.Llm.LiteLlm.BatchRequestJob>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<GenaiCore.Llm.LiteLlm.BatchRequestJob>): ObjList<GenaiCore.Llm.LiteLlm.BatchRequestJob>;
     ...
     */
    static afterCreate(objs: Array_Type<GenaiCore.Llm.LiteLlm.BatchRequestJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<GenaiCore.Llm.LiteLlm.BatchRequestJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<GenaiCore.Llm.LiteLlm.BatchRequestJob>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<GenaiCore.Llm.LiteLlm.BatchRequestJob>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GenaiCore.Llm.LiteLlm.BatchRequestJob>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.Llm.LiteLlm.BatchRequestJob | null;
     ...
     */
    withoutIdentity(): GenaiCore.Llm.LiteLlm.BatchRequestJob | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<GenaiCore.Llm.LiteLlm.BatchRequestJob>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: GenaiCore.Llm.LiteLlm.BatchRequestJob, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<GenaiCore.Llm.LiteLlm.BatchRequestJob>, callback?: λFunction<GenaiCore.Llm.LiteLlm.BatchRequestJob | null, GenaiCore.Llm.LiteLlm.BatchRequestJob | null>): ObjList<GenaiCore.Llm.LiteLlm.BatchRequestJob>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<GenaiCore.Llm.LiteLlm.BatchRequestJob>, callback?: λFunction<GenaiCore.Llm.LiteLlm.BatchRequestJob | null, GenaiCore.Llm.LiteLlm.BatchRequestJob | null>): Array_Type<ObjError> | null;
     ...
     */
    static createJob(model: GenaiCore.Llm.Model, inputFilePath: string, jobId?: string): GenaiCore.Llm.LiteLlm.BatchRequestJob;
