// TypeScript definitions for the C3 type GenaiCore.Llm.Completion.Client
 ...
 * ```
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Llm.Completion.Client
 */
...
declare namespace GenaiCore.Llm.Completion {
  export class Client extends Obj  {
    ...
    withName(name: string): GenaiCore.Llm.Completion.Client;
    ...
    withConfigOverride(configOverride: string | null): GenaiCore.Llm.Completion.Client;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): GenaiCore.Llm.Completion.Client;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): GenaiCore.Llm.Completion.Client;
    ...
    withDescription(description: string | null): GenaiCore.Llm.Completion.Client;
    ...
    withModel(model: IGenaiCore.Llm.Model | Array_Type<GenaiCore.Llm.Model> | Array<IGenaiCore.Llm.Model>): GenaiCore.Llm.Completion.Client;
    ...
    withRouter(router: IGenaiCore.Llm.Router | null): GenaiCore.Llm.Completion.Client;
    ...
    withDefaultOptions(defaultOptions: any | null): GenaiCore.Llm.Completion.Client;
     ...
     */
    static inst(): GenaiCore.Llm.Completion.Client;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Llm.Completion.Client | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Llm.Completion.Client | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Llm.Completion.Client | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Llm.Completion.Client | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Llm.Completion.Client;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): GenaiCore.Llm.Completion.Client;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Llm.Completion.Client;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Llm.Completion.Client;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Llm.Completion.Client;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Llm.Completion.Client;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Llm.Completion.Client>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Llm.Completion.Client>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Llm.Completion.Client>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Llm.Completion.Client>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Llm.Completion.Client;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Llm.Completion.Client;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Llm.Completion.Client;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Llm.Completion.Client;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Llm.Completion.Client;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Llm.Completion.Client;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Llm.Completion.Client;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): GenaiCore.Llm.Completion.Client;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Llm.Completion.Client;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Llm.Completion.Client;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Llm.Completion.Client;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Llm.Completion.Client;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Llm.Completion.Client;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Llm.Completion.Client;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Llm.Completion.Client;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Llm.Completion.Client;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Llm.Completion.Client;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): GenaiCore.Llm.Completion.Client;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Llm.Completion.Client;
     ...
     * @see #removeField
     */
    static withoutField(field: string): GenaiCore.Llm.Completion.Client;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Llm.Completion.Client;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): GenaiCore.Llm.Completion.Client;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Llm.Completion.Client;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): GenaiCore.Llm.Completion.Client;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Llm.Completion.Client;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Llm.Completion.Client;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Llm.Completion.Client;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): GenaiCore.Llm.Completion.Client;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Llm.Completion.Client;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Llm.Completion.Client;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Llm.Completion.Client;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): GenaiCore.Llm.Completion.Client;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Llm.Completion.Client;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): GenaiCore.Llm.Completion.Client;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Llm.Completion.Client;
     ...
     * @see #removeField
     */
    static unsetField(field: string): GenaiCore.Llm.Completion.Client;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Llm.Completion.Client;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): GenaiCore.Llm.Completion.Client;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Llm.Completion.Client;
     ...
     * @see #unsetField
     */
    static removeField(field: string): GenaiCore.Llm.Completion.Client;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Llm.Completion.Client;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): GenaiCore.Llm.Completion.Client;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Llm.Completion.Client;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Llm.Completion.Client;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Llm.Completion.Client;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Llm.Completion.Client;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Llm.Completion.Client;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Llm.Completion.Client;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Llm.Completion.Client;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Llm.Completion.Client;

    mergeJson(json: any): GenaiCore.Llm.Completion.Client;

    static mergeJson(json: any): GenaiCore.Llm.Completion.Client;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Llm.Completion.Client;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Llm.Completion.Client;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Llm.Completion.Client;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): GenaiCore.Llm.Completion.Client;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Llm.Completion.Client>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<GenaiCore.Llm.Completion.Client>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Llm.Completion.Client> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Llm.Completion.Client> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Llm.Completion.Client>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<GenaiCore.Llm.Completion.Client>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Llm.Completion.Client> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Llm.Completion.Client> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Llm.Completion.Client> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Llm.Completion.Client>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<GenaiCore.Llm.Completion.Client>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Llm.Completion.Client>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Llm.Completion.Client;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Llm.Completion.Client;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Llm.Completion.Client;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Llm.Completion.Client;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Llm.Completion.Client;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Llm.Completion.Client;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.Llm.Completion.Client | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Llm.Completion.Client;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Llm.Completion.Client;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): GenaiCore.Llm.Completion.Client;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Llm.Completion.Client;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Llm.Completion.Client> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Llm.Completion.Client;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.Llm.Completion.Client | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): GenaiCore.Llm.Completion.Client | null;
     ...
     */
    static allCached(): Stream<GenaiCore.Llm.Completion.Client> | null;
     ...
     */
    static find(filter?: string): Stream<GenaiCore.Llm.Completion.Client> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<GenaiCore.Llm.Completion.Client> | null;

    /**
     * @return cached instance.
     */
    getCached(): GenaiCore.Llm.Completion.Client | null;

    /**
     * @return cached instance.
     */
    static getCached(): GenaiCore.Llm.Completion.Client | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): GenaiCore.Llm.Completion.Client | null;
     ...
     */
    static produce(key: string): GenaiCore.Llm.Completion.Client | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, GenaiCore.Llm.Completion.Client> | null;
     ...
     */
    getConfig(): GenaiCore.Llm.Completion.Client;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): GenaiCore.Llm.Completion.Client;
     ...
     */
    getSecret(): GenaiCore.Llm.Completion.Client;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): GenaiCore.Llm.Completion.Client;
     ...
     */
    withConfigKey(configKey: string): GenaiCore.Llm.Completion.Client;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): GenaiCore.Llm.Completion.Client;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): GenaiCore.Llm.Completion.Client;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): GenaiCore.Llm.Completion.Client;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): GenaiCore.Llm.Completion.Client | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<GenaiCore.Llm.Completion.Client> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: GenaiCore.Llm.Completion.Client, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: GenaiCore.Llm.Completion.Client, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): GenaiCore.Llm.Completion.Client | null;
     ...
     */
    removeSecrets(): GenaiCore.Llm.Completion.Client | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): GenaiCore.Llm.Completion.Client | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): GenaiCore.Llm.Completion.Client | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): GenaiCore.Llm.Completion.Client | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): GenaiCore.Llm.Completion.Client;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): GenaiCore.Llm.Completion.Client;
