// TypeScript definitions for the C3 type GenaiCore.Llm.AzureOpenAi.BatchRequestJob

/**
 * Customized BatchRequestJob field/method implemented for Azure Open AI service
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Llm.AzureOpenAi.BatchRequestJob
 */
...
declare namespace GenaiCore.Llm.AzureOpenAi {
  export class BatchRequestJob extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     */
    readonly id: string;
    withId(id: string): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
    ...
    withVersion(version: number | null): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;

    /**
     * LiteLLM model used for submitting this batch request job
     */
    readonly model: GenaiCore.Llm.LiteLlm;
    withModel(model: IGenaiCore.Llm.LiteLlm): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;

    /**
     * The id of the batch request job
     */
    readonly jobId: string;
    withJobId(jobId: string): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;

    /**
     * Id of the uploaded JSONL file containing the prompts passed to the LLM.
     */
    readonly inputFileId: string;
    withInputFileId(inputFileId: string): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;

    /**
     * Id of the output file containing the responses generated by the LLM. Only available after the output has been generated.
     */
    readonly outputFileId?: string;
    withOutputFileId(outputFileId: string | null): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Llm.AzureOpenAi.BatchRequestJob | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Llm.AzureOpenAi.BatchRequestJob | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Llm.AzureOpenAi.BatchRequestJob | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Llm.AzureOpenAi.BatchRequestJob | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;

    mergeJson(json: any): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Llm.AzureOpenAi.BatchRequestJob> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Llm.AzureOpenAi.BatchRequestJob> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Llm.AzureOpenAi.BatchRequestJob> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Llm.AzureOpenAi.BatchRequestJob> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Llm.AzureOpenAi.BatchRequestJob> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.Llm.AzureOpenAi.BatchRequestJob | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Llm.AzureOpenAi.BatchRequestJob> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<GenaiCore.Llm.AzureOpenAi.BatchRequestJob> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>> | null;
     ...
     */
    get(include?: string): GenaiCore.Llm.AzureOpenAi.BatchRequestJob | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): GenaiCore.Llm.AzureOpenAi.BatchRequestJob | null;
     ...
     */
    getMissing(spec: GetMissingSpec): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): GenaiCore.Llm.AzureOpenAi.BatchRequestJob | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.Llm.AzureOpenAi.BatchRequestJob | null;
     ...
     */
    create(spec?: UpsertSpec): GenaiCore.Llm.AzureOpenAi.BatchRequestJob | null;
     ...
     */
    static createBatch(objs: Array_Type<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>, spec?: UpsertSpec): ObjList<GenaiCore.Llm.AzureOpenAi.BatchRequestJob> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>, spec?: CreateBatchObjStreamSpec): ObjList<GenaiCore.Llm.AzureOpenAi.BatchRequestJob> | null;
     ...
     */
    update(srcObj?: GenaiCore.Llm.AzureOpenAi.BatchRequestJob, spec?: UpsertSpec): GenaiCore.Llm.AzureOpenAi.BatchRequestJob | null;
     ...
     */
    upsert(srcObj?: GenaiCore.Llm.AzureOpenAi.BatchRequestJob, spec?: UpsertSpec): GenaiCore.Llm.AzureOpenAi.BatchRequestJob | null;
     ...
     */
    merge(spec?: MergeSpec): GenaiCore.Llm.AzureOpenAi.BatchRequestJob | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): GenaiCore.Llm.AzureOpenAi.BatchRequestJob | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): GenaiCore.Llm.AzureOpenAi.BatchRequestJob | null;
     ...
     */
    static updateBatch(objs: Array_Type<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>, srcObjs?: Array_Type<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>, spec?: UpsertSpec): ObjList<GenaiCore.Llm.AzureOpenAi.BatchRequestJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<GenaiCore.Llm.AzureOpenAi.BatchRequestJob> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Llm.AzureOpenAi.BatchRequestJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>, srcObjs?: Array_Type<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>, spec?: UpsertSpec): ObjList<GenaiCore.Llm.AzureOpenAi.BatchRequestJob> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<GenaiCore.Llm.AzureOpenAi.BatchRequestJob> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Llm.AzureOpenAi.BatchRequestJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>, spec?: TouchSpec): ObjList<GenaiCore.Llm.AzureOpenAi.BatchRequestJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>, spec?: MergeSpec): ObjList<GenaiCore.Llm.AzureOpenAi.BatchRequestJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Llm.AzureOpenAi.BatchRequestJob> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<GenaiCore.Llm.AzureOpenAi.BatchRequestJob> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Llm.AzureOpenAi.BatchRequestJob> | null;
     ...
     */
    static mergeAll(mergeObj: GenaiCore.Llm.AzureOpenAi.BatchRequestJob, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: GenaiCore.Llm.AzureOpenAi.BatchRequestJob, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>, spec?: UpsertSpec): ObjList<GenaiCore.Llm.AzureOpenAi.BatchRequestJob> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>, spec?: UpsertSpec): ObjList<GenaiCore.Llm.AzureOpenAi.BatchRequestJob> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): GenaiCore.Llm.AzureOpenAi.BatchRequestJob | null;
     ...
     */
    static beforeCreate(objs: Array_Type<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>): ObjList<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>): ObjList<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>;

    /**
     * Cancels the job before removing.
     */
    static beforeRemove(objs: Array_Type<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>): ObjList<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>;
     ...
     */
    static afterCreate(objs: Array_Type<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.Llm.AzureOpenAi.BatchRequestJob | null;
     ...
     */
    withoutIdentity(): GenaiCore.Llm.AzureOpenAi.BatchRequestJob | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: GenaiCore.Llm.AzureOpenAi.BatchRequestJob, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>, callback?: λFunction<GenaiCore.Llm.AzureOpenAi.BatchRequestJob | null, GenaiCore.Llm.AzureOpenAi.BatchRequestJob | null>): ObjList<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<GenaiCore.Llm.AzureOpenAi.BatchRequestJob>, callback?: λFunction<GenaiCore.Llm.AzureOpenAi.BatchRequestJob | null, GenaiCore.Llm.AzureOpenAi.BatchRequestJob | null>): Array_Type<ObjError> | null;
     ...
     */
    static createJob(model: GenaiCore.Llm.Model, inputFilePath: string, jobId?: string): GenaiCore.Llm.AzureOpenAi.BatchRequestJob;
