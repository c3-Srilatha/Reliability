// TypeScript definitions for the C3 type GenaiCore.VectorStore.Pg
 ...
 * {@link #embeddingPath}.
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.VectorStore.Pg
 */
declare namespace GenaiCore.VectorStore {
  export interface IPg {
     ...
     */
    similaritySearchSpec?: IGenaiCore.SimilaritySearchSpec;

    /**
     * The entity type that should be queried for this vector store.
     */
    entityType: IType<<Persistable>>;
...
declare namespace GenaiCore.VectorStore {
  export class Pg extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): GenaiCore.VectorStore.Pg;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GenaiCore.VectorStore.Pg;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): GenaiCore.VectorStore.Pg;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): GenaiCore.VectorStore.Pg;
    ...
    withVersion(version: number | null): GenaiCore.VectorStore.Pg;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): GenaiCore.VectorStore.Pg;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): GenaiCore.VectorStore.Pg;
    ...
    withHidden(hidden: boolean): GenaiCore.VectorStore.Pg;
    ...
    withUserOwned(userOwned: boolean): GenaiCore.VectorStore.Pg;
    ...
    withTypeIdent(typeIdent: string | null): GenaiCore.VectorStore.Pg;
     ...
     * of the values provided in the default spec.
     */
    readonly similaritySearchSpec?: GenaiCore.SimilaritySearchSpec;
    withSimilaritySearchSpec(similaritySearchSpec: IGenaiCore.SimilaritySearchSpec | null): GenaiCore.VectorStore.Pg;

    /**
     * The entity type that should be queried for this vector store.
     */
    readonly entityType: Type<<Persistable>>;
    withEntityType(entityType: IType<<Persistable>>): GenaiCore.VectorStore.Pg;
    ...
    withEmbeddingPath(embeddingPath: string | null): GenaiCore.VectorStore.Pg;
    ...
    withContentPath(contentPath: string | null): GenaiCore.VectorStore.Pg;

    /**
     * The distance metric to use with pgvector.
     */
    readonly distanceMetric?: string;
    withDistanceMetric(distanceMetric: string | null): GenaiCore.VectorStore.Pg;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.VectorStore.Pg | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.VectorStore.Pg | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.VectorStore.Pg | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.VectorStore.Pg | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.VectorStore.Pg;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.VectorStore.Pg;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.VectorStore.Pg;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.VectorStore.Pg>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.VectorStore.Pg>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.VectorStore.Pg;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.VectorStore.Pg;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.VectorStore.Pg;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.VectorStore.Pg;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.VectorStore.Pg;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.VectorStore.Pg;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.VectorStore.Pg;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.VectorStore.Pg;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.VectorStore.Pg;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.VectorStore.Pg;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.VectorStore.Pg;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.VectorStore.Pg;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.VectorStore.Pg;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.VectorStore.Pg;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.VectorStore.Pg;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.VectorStore.Pg;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.VectorStore.Pg;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.VectorStore.Pg;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.VectorStore.Pg;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.VectorStore.Pg;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.VectorStore.Pg;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.VectorStore.Pg;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.VectorStore.Pg;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.VectorStore.Pg;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.VectorStore.Pg;

    mergeJson(json: any): GenaiCore.VectorStore.Pg;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.VectorStore.Pg;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.VectorStore.Pg;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.VectorStore.Pg>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.VectorStore.Pg> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.VectorStore.Pg> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.VectorStore.Pg>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.VectorStore.Pg> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.VectorStore.Pg> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.VectorStore.Pg> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.VectorStore.Pg>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.VectorStore.Pg>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.VectorStore.Pg;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.VectorStore.Pg;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.VectorStore.Pg;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.VectorStore.Pg;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.VectorStore.Pg;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.VectorStore.Pg;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.VectorStore.Pg | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.VectorStore.Pg;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.VectorStore.Pg;
     ...
     */
    static cachedEmptyInst(): GenaiCore.VectorStore.Pg;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.VectorStore.Pg> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.VectorStore.Pg;
     ...
     */
    static allCached(): Stream<GenaiCore.VectorStore.Pg> | null;
     ...
     */
    static find(filter?: string): Stream<GenaiCore.VectorStore.Pg> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<GenaiCore.VectorStore.Pg> | null;

    /**
     * @return cached instance.
     */
    getCached(): GenaiCore.VectorStore.Pg | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): GenaiCore.VectorStore.Pg | null;
     ...
     */
    static produce(key: string): GenaiCore.VectorStore.Pg | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, GenaiCore.VectorStore.Pg> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<GenaiCore.VectorStore.Pg>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<GenaiCore.VectorStore.Pg>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<GenaiCore.VectorStore.Pg> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenaiCore.VectorStore.Pg>> | null;
     ...
     */
    get(include?: string): GenaiCore.VectorStore.Pg | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): GenaiCore.VectorStore.Pg | null;
     ...
     */
    getMissing(spec: GetMissingSpec): GenaiCore.VectorStore.Pg;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): GenaiCore.VectorStore.Pg | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): GenaiCore.VectorStore.Pg;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.VectorStore.Pg | null;
     ...
     */
    create(spec?: UpsertSpec): GenaiCore.VectorStore.Pg | null;
     ...
     */
    static createBatch(objs: Array_Type<GenaiCore.VectorStore.Pg>, spec?: UpsertSpec): ObjList<GenaiCore.VectorStore.Pg> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<GenaiCore.VectorStore.Pg>, spec?: CreateBatchObjStreamSpec): ObjList<GenaiCore.VectorStore.Pg> | null;
     ...
     */
    update(srcObj?: GenaiCore.VectorStore.Pg, spec?: UpsertSpec): GenaiCore.VectorStore.Pg | null;
     ...
     */
    upsert(srcObj?: GenaiCore.VectorStore.Pg, spec?: UpsertSpec): GenaiCore.VectorStore.Pg | null;
     ...
     */
    merge(spec?: MergeSpec): GenaiCore.VectorStore.Pg | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): GenaiCore.VectorStore.Pg | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): GenaiCore.VectorStore.Pg | null;
     ...
     */
    static updateBatch(objs: Array_Type<GenaiCore.VectorStore.Pg>, srcObjs?: Array_Type<GenaiCore.VectorStore.Pg>, spec?: UpsertSpec): ObjList<GenaiCore.VectorStore.Pg> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<GenaiCore.VectorStore.Pg> | null>, spec?: UpsertSpec): ObjList<GenaiCore.VectorStore.Pg> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<GenaiCore.VectorStore.Pg>, srcObjs?: Array_Type<GenaiCore.VectorStore.Pg>, spec?: UpsertSpec): ObjList<GenaiCore.VectorStore.Pg> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<GenaiCore.VectorStore.Pg> | null>, spec?: UpsertSpec): ObjList<GenaiCore.VectorStore.Pg> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<GenaiCore.VectorStore.Pg>, spec?: TouchSpec): ObjList<GenaiCore.VectorStore.Pg> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.VectorStore.Pg>, spec?: MergeSpec): ObjList<GenaiCore.VectorStore.Pg> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.VectorStore.Pg>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.VectorStore.Pg> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<GenaiCore.VectorStore.Pg> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.VectorStore.Pg> | null;
     ...
     */
    static mergeAll(mergeObj: GenaiCore.VectorStore.Pg, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: GenaiCore.VectorStore.Pg, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<GenaiCore.VectorStore.Pg>, spec?: UpsertSpec): ObjList<GenaiCore.VectorStore.Pg> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<GenaiCore.VectorStore.Pg>, spec?: UpsertSpec): ObjList<GenaiCore.VectorStore.Pg> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): GenaiCore.VectorStore.Pg | null;
     ...
     */
    static beforeCreate(objs: Array_Type<GenaiCore.VectorStore.Pg>): ObjList<GenaiCore.VectorStore.Pg>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<GenaiCore.VectorStore.Pg>): ObjList<GenaiCore.VectorStore.Pg>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<GenaiCore.VectorStore.Pg>): ObjList<GenaiCore.VectorStore.Pg>;
     ...
     */
    static afterCreate(objs: Array_Type<GenaiCore.VectorStore.Pg>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<GenaiCore.VectorStore.Pg>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<GenaiCore.VectorStore.Pg>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<GenaiCore.VectorStore.Pg>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GenaiCore.VectorStore.Pg>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.VectorStore.Pg | null;
     ...
     */
    withoutIdentity(): GenaiCore.VectorStore.Pg | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<GenaiCore.VectorStore.Pg>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: GenaiCore.VectorStore.Pg, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<GenaiCore.VectorStore.Pg>, callback?: λFunction<GenaiCore.VectorStore.Pg | null, GenaiCore.VectorStore.Pg | null>): ObjList<GenaiCore.VectorStore.Pg>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<GenaiCore.VectorStore.Pg>, callback?: λFunction<GenaiCore.VectorStore.Pg | null, GenaiCore.VectorStore.Pg | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): GenaiCore.VectorStore.Pg;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.VectorStore.Pg> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): GenaiCore.VectorStore.Pg | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.VectorStore.Pg> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): GenaiCore.VectorStore.Pg | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.VectorStore.Pg> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): GenaiCore.VectorStore.Pg | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<GenaiCore.VectorStore.Pg> | null;
    ...
    dependencies(): SeedDataDeps<GenaiCore.VectorStore.Pg> | null;
     ...
     */
    mergeDefaultSimilaritySearchSpec(spec?: GenaiCore.SimilaritySearchSpec): GenaiCore.SimilaritySearchSpec;
     ...
     *          vectors first.
     */
    similaritySearch(queryVector: Array_Type<number>, spec?: GenaiCore.SimilaritySearchSpec): Array_Type<GenaiCore.VectorStore.SimilaritySearchResult> | null;
     ...
     */
    doSimilaritySearch(queryVector: Array_Type<number>, spec?: GenaiCore.SimilaritySearchSpec): Array_Type<GenaiCore.VectorStore.SimilaritySearchResult> | null;
     ...
     */
    addVectors(embeddings: Array_Type<Array_Type<number>>, metadata?: Array_Type<any>, options?: any): number;
     ...
     */
    doAddVectors(embeddings: Array_Type<Array_Type<number>>, metadata?: Array_Type<any>, options?: any): number;
     ...
     */
    static importExportMetadataFileName(): string;
     ...
     */
    static importExportVectorStatsFileName(): string;
     ...
     */
    static importFromFiles(id: string, path: string, spec?: GenaiCore.VectorStore.Pg.ImportSpec): GenaiCore.VectorStore.Pg;
     ...
     */
    exportToFiles(path: string, spec?: GenaiCore.VectorStore.Pg.ExportSpec): number;
  }
}
