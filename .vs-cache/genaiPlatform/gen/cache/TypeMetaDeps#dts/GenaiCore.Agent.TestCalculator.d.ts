// TypeScript definitions for the C3 type GenaiCore.Agent.TestCalculator

/**
 * A test calculator agent that uses function calling.
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Agent.TestCalculator
 */
declare namespace GenaiCore.Agent {
  export interface ITestCalculator {
 ...
 */
declare namespace GenaiCore.Agent {
  export class TestCalculator extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): GenaiCore.Agent.TestCalculator;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GenaiCore.Agent.TestCalculator;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): GenaiCore.Agent.TestCalculator;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): GenaiCore.Agent.TestCalculator;
    ...
    withVersion(version: number | null): GenaiCore.Agent.TestCalculator;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): GenaiCore.Agent.TestCalculator;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): GenaiCore.Agent.TestCalculator;
    ...
    withHidden(hidden: boolean): GenaiCore.Agent.TestCalculator;
    ...
    withUserOwned(userOwned: boolean): GenaiCore.Agent.TestCalculator;
    ...
    withTypeIdent(typeIdent: string | null): GenaiCore.Agent.TestCalculator;
    ...
    withDescription(description: string | null): GenaiCore.Agent.TestCalculator;

    /**
     * System prompt used to define the behavior of this agent.
     */
    readonly systemPrompt?: string;
    withSystemPrompt(systemPrompt: string | null): GenaiCore.Agent.TestCalculator;

    /**
     * {@link Llm client GenaiCore.Llm.Client} that manages auth, routing strategy, configurations, etc.
     */
    readonly llmClient?: GenaiCore.Llm.Client;
    withLlmClient(llmClient: IGenaiCore.Llm.Client | null): GenaiCore.Agent.TestCalculator;

    /**
     * {@link Toolkit GenaiCore.Toolkit} used by this agent. Note that it could be nested, use {@link GenaiCore.Toolkit#allTools} to get all tools available.
     */
    readonly tools?: Array_Type<GenaiCore.Tool | GenaiCore.Toolkit>;
    withTools(tools: Array_Type<GenaiCore.Tool | GenaiCore.Toolkit> | Array<IGenaiCore.Tool | IGenaiCore.Toolkit> | null): GenaiCore.Agent.TestCalculator;

    /**
     * {@link Session store GenaiCore.SessionStore} used by this agent, for short term memory only.
     */
    readonly shortTermMemoryStore?: GenaiCore.SessionStore;
    withShortTermMemoryStore(shortTermMemoryStore: IGenaiCore.SessionStore | null): GenaiCore.Agent.TestCalculator;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Agent.TestCalculator | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Agent.TestCalculator | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Agent.TestCalculator | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Agent.TestCalculator | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Agent.TestCalculator;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Agent.TestCalculator;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Agent.TestCalculator;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Agent.TestCalculator>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Agent.TestCalculator>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Agent.TestCalculator;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Agent.TestCalculator;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Agent.TestCalculator;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Agent.TestCalculator;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Agent.TestCalculator;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Agent.TestCalculator;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Agent.TestCalculator;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Agent.TestCalculator;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Agent.TestCalculator;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Agent.TestCalculator;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Agent.TestCalculator;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Agent.TestCalculator;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Agent.TestCalculator;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Agent.TestCalculator;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Agent.TestCalculator;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Agent.TestCalculator;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Agent.TestCalculator;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Agent.TestCalculator;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Agent.TestCalculator;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Agent.TestCalculator;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Agent.TestCalculator;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Agent.TestCalculator;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Agent.TestCalculator;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Agent.TestCalculator;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Agent.TestCalculator;

    mergeJson(json: any): GenaiCore.Agent.TestCalculator;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Agent.TestCalculator;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Agent.TestCalculator;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Agent.TestCalculator>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Agent.TestCalculator> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Agent.TestCalculator> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Agent.TestCalculator>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Agent.TestCalculator> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Agent.TestCalculator> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Agent.TestCalculator> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Agent.TestCalculator>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Agent.TestCalculator>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Agent.TestCalculator;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Agent.TestCalculator;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Agent.TestCalculator;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Agent.TestCalculator;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Agent.TestCalculator;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Agent.TestCalculator;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.Agent.TestCalculator | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Agent.TestCalculator;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Agent.TestCalculator;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Agent.TestCalculator;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Agent.TestCalculator> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Agent.TestCalculator;
     ...
     */
    static allCached(): Stream<GenaiCore.Agent.TestCalculator> | null;
     ...
     */
    static find(filter?: string): Stream<GenaiCore.Agent.TestCalculator> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<GenaiCore.Agent.TestCalculator> | null;

    /**
     * @return cached instance.
     */
    getCached(): GenaiCore.Agent.TestCalculator | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): GenaiCore.Agent.TestCalculator | null;
     ...
     */
    static produce(key: string): GenaiCore.Agent.TestCalculator | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, GenaiCore.Agent.TestCalculator> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<GenaiCore.Agent.TestCalculator>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<GenaiCore.Agent.TestCalculator>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<GenaiCore.Agent.TestCalculator> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenaiCore.Agent.TestCalculator>> | null;
     ...
     */
    get(include?: string): GenaiCore.Agent.TestCalculator | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): GenaiCore.Agent.TestCalculator | null;
     ...
     */
    getMissing(spec: GetMissingSpec): GenaiCore.Agent.TestCalculator;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): GenaiCore.Agent.TestCalculator | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): GenaiCore.Agent.TestCalculator;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.Agent.TestCalculator | null;
     ...
     */
    create(spec?: UpsertSpec): GenaiCore.Agent.TestCalculator | null;
     ...
     */
    static createBatch(objs: Array_Type<GenaiCore.Agent.TestCalculator>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.TestCalculator> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<GenaiCore.Agent.TestCalculator>, spec?: CreateBatchObjStreamSpec): ObjList<GenaiCore.Agent.TestCalculator> | null;
     ...
     */
    update(srcObj?: GenaiCore.Agent.TestCalculator, spec?: UpsertSpec): GenaiCore.Agent.TestCalculator | null;
     ...
     */
    upsert(srcObj?: GenaiCore.Agent.TestCalculator, spec?: UpsertSpec): GenaiCore.Agent.TestCalculator | null;
     ...
     */
    merge(spec?: MergeSpec): GenaiCore.Agent.TestCalculator | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): GenaiCore.Agent.TestCalculator | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): GenaiCore.Agent.TestCalculator | null;
     ...
     */
    static updateBatch(objs: Array_Type<GenaiCore.Agent.TestCalculator>, srcObjs?: Array_Type<GenaiCore.Agent.TestCalculator>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.TestCalculator> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<GenaiCore.Agent.TestCalculator> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.TestCalculator> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<GenaiCore.Agent.TestCalculator>, srcObjs?: Array_Type<GenaiCore.Agent.TestCalculator>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.TestCalculator> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<GenaiCore.Agent.TestCalculator> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.TestCalculator> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<GenaiCore.Agent.TestCalculator>, spec?: TouchSpec): ObjList<GenaiCore.Agent.TestCalculator> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Agent.TestCalculator>, spec?: MergeSpec): ObjList<GenaiCore.Agent.TestCalculator> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Agent.TestCalculator>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Agent.TestCalculator> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<GenaiCore.Agent.TestCalculator> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Agent.TestCalculator> | null;
     ...
     */
    static mergeAll(mergeObj: GenaiCore.Agent.TestCalculator, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: GenaiCore.Agent.TestCalculator, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<GenaiCore.Agent.TestCalculator>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.TestCalculator> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<GenaiCore.Agent.TestCalculator>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.TestCalculator> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): GenaiCore.Agent.TestCalculator | null;
     ...
     */
    static beforeCreate(objs: Array_Type<GenaiCore.Agent.TestCalculator>): ObjList<GenaiCore.Agent.TestCalculator>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<GenaiCore.Agent.TestCalculator>): ObjList<GenaiCore.Agent.TestCalculator>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<GenaiCore.Agent.TestCalculator>): ObjList<GenaiCore.Agent.TestCalculator>;
     ...
     */
    static afterCreate(objs: Array_Type<GenaiCore.Agent.TestCalculator>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<GenaiCore.Agent.TestCalculator>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<GenaiCore.Agent.TestCalculator>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<GenaiCore.Agent.TestCalculator>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GenaiCore.Agent.TestCalculator>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.Agent.TestCalculator | null;
     ...
     */
    withoutIdentity(): GenaiCore.Agent.TestCalculator | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<GenaiCore.Agent.TestCalculator>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: GenaiCore.Agent.TestCalculator, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<GenaiCore.Agent.TestCalculator>, callback?: λFunction<GenaiCore.Agent.TestCalculator | null, GenaiCore.Agent.TestCalculator | null>): ObjList<GenaiCore.Agent.TestCalculator>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<GenaiCore.Agent.TestCalculator>, callback?: λFunction<GenaiCore.Agent.TestCalculator | null, GenaiCore.Agent.TestCalculator | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): GenaiCore.Agent.TestCalculator;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.TestCalculator> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): GenaiCore.Agent.TestCalculator | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.TestCalculator> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): GenaiCore.Agent.TestCalculator | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.TestCalculator> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): GenaiCore.Agent.TestCalculator | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<GenaiCore.Agent.TestCalculator> | null;
    ...
    dependencies(): SeedDataDeps<GenaiCore.Agent.TestCalculator> | null;
