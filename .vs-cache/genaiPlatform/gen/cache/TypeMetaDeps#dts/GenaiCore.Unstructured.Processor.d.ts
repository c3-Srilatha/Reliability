// TypeScript definitions for the C3 type GenaiCore.Unstructured.Processor
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Unstructured.Processor
 */
 ...
 */
declare namespace GenaiCore.Unstructured {
  export class Processor extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): GenaiCore.Unstructured.Processor;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GenaiCore.Unstructured.Processor;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): GenaiCore.Unstructured.Processor;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): GenaiCore.Unstructured.Processor;
    ...
    withVersion(version: number | null): GenaiCore.Unstructured.Processor;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): GenaiCore.Unstructured.Processor;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): GenaiCore.Unstructured.Processor;
    ...
    withHidden(hidden: boolean): GenaiCore.Unstructured.Processor;
    ...
    withUserOwned(userOwned: boolean): GenaiCore.Unstructured.Processor;
    ...
    withTypeIdent(typeIdent: string | null): GenaiCore.Unstructured.Processor;
    ...
    withComponents(components: Map_Type<string, GenaiCore.Unstructured.ProcessorComponent> | {[key: string]: IGenaiCore.Unstructured.ProcessorComponent}): GenaiCore.Unstructured.Processor;
    ...
    withComponentOrder(componentOrder: Array_Type<string> | Array<string>): GenaiCore.Unstructured.Processor;

    /**
     * The action requirement needed for the processor to run.
     */
    readonly actionRequirement?: string;
    withActionRequirement(actionRequirement: string | null): GenaiCore.Unstructured.Processor;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Unstructured.Processor | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Unstructured.Processor | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Unstructured.Processor | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Unstructured.Processor | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Unstructured.Processor;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Unstructured.Processor;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Unstructured.Processor;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Unstructured.Processor>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Unstructured.Processor>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Unstructured.Processor;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Unstructured.Processor;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Unstructured.Processor;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Unstructured.Processor;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Unstructured.Processor;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Unstructured.Processor;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Unstructured.Processor;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Unstructured.Processor;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Unstructured.Processor;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Unstructured.Processor;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Unstructured.Processor;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Unstructured.Processor;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Unstructured.Processor;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Unstructured.Processor;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Unstructured.Processor;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Unstructured.Processor;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Unstructured.Processor;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Unstructured.Processor;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Unstructured.Processor;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Unstructured.Processor;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Unstructured.Processor;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Unstructured.Processor;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Unstructured.Processor;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Unstructured.Processor;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Unstructured.Processor;

    mergeJson(json: any): GenaiCore.Unstructured.Processor;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Unstructured.Processor;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Unstructured.Processor;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Unstructured.Processor>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Unstructured.Processor> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Unstructured.Processor> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Unstructured.Processor>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Unstructured.Processor> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Unstructured.Processor> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Unstructured.Processor> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Unstructured.Processor>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Unstructured.Processor>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Unstructured.Processor;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Unstructured.Processor;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Unstructured.Processor;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Unstructured.Processor;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Unstructured.Processor;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Unstructured.Processor;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.Unstructured.Processor | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Unstructured.Processor;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Unstructured.Processor;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Unstructured.Processor;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Unstructured.Processor> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Unstructured.Processor;
     ...
     */
    static allCached(): Stream<GenaiCore.Unstructured.Processor> | null;
     ...
     */
    static find(filter?: string): Stream<GenaiCore.Unstructured.Processor> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<GenaiCore.Unstructured.Processor> | null;

    /**
     * @return cached instance.
     */
    getCached(): GenaiCore.Unstructured.Processor | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): GenaiCore.Unstructured.Processor | null;
     ...
     */
    static produce(key: string): GenaiCore.Unstructured.Processor | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, GenaiCore.Unstructured.Processor> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<GenaiCore.Unstructured.Processor>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<GenaiCore.Unstructured.Processor>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<GenaiCore.Unstructured.Processor> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenaiCore.Unstructured.Processor>> | null;
     ...
     */
    get(include?: string): GenaiCore.Unstructured.Processor | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): GenaiCore.Unstructured.Processor | null;
     ...
     */
    getMissing(spec: GetMissingSpec): GenaiCore.Unstructured.Processor;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): GenaiCore.Unstructured.Processor | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): GenaiCore.Unstructured.Processor;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.Unstructured.Processor | null;
     ...
     */
    create(spec?: UpsertSpec): GenaiCore.Unstructured.Processor | null;
     ...
     */
    static createBatch(objs: Array_Type<GenaiCore.Unstructured.Processor>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Processor> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<GenaiCore.Unstructured.Processor>, spec?: CreateBatchObjStreamSpec): ObjList<GenaiCore.Unstructured.Processor> | null;
     ...
     */
    update(srcObj?: GenaiCore.Unstructured.Processor, spec?: UpsertSpec): GenaiCore.Unstructured.Processor | null;
     ...
     */
    upsert(srcObj?: GenaiCore.Unstructured.Processor, spec?: UpsertSpec): GenaiCore.Unstructured.Processor | null;
     ...
     */
    merge(spec?: MergeSpec): GenaiCore.Unstructured.Processor | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): GenaiCore.Unstructured.Processor | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): GenaiCore.Unstructured.Processor | null;
     ...
     */
    static updateBatch(objs: Array_Type<GenaiCore.Unstructured.Processor>, srcObjs?: Array_Type<GenaiCore.Unstructured.Processor>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Processor> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<GenaiCore.Unstructured.Processor> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Processor> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<GenaiCore.Unstructured.Processor>, srcObjs?: Array_Type<GenaiCore.Unstructured.Processor>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Processor> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<GenaiCore.Unstructured.Processor> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Processor> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<GenaiCore.Unstructured.Processor>, spec?: TouchSpec): ObjList<GenaiCore.Unstructured.Processor> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Unstructured.Processor>, spec?: MergeSpec): ObjList<GenaiCore.Unstructured.Processor> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Unstructured.Processor>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Unstructured.Processor> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<GenaiCore.Unstructured.Processor> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Unstructured.Processor> | null;
     ...
     */
    static mergeAll(mergeObj: GenaiCore.Unstructured.Processor, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: GenaiCore.Unstructured.Processor, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<GenaiCore.Unstructured.Processor>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Processor> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<GenaiCore.Unstructured.Processor>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Processor> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): GenaiCore.Unstructured.Processor | null;
     ...
     */
    static beforeCreate(objs: Array_Type<GenaiCore.Unstructured.Processor>): ObjList<GenaiCore.Unstructured.Processor>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<GenaiCore.Unstructured.Processor>): ObjList<GenaiCore.Unstructured.Processor>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<GenaiCore.Unstructured.Processor>): ObjList<GenaiCore.Unstructured.Processor>;
     ...
     */
    static afterCreate(objs: Array_Type<GenaiCore.Unstructured.Processor>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<GenaiCore.Unstructured.Processor>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<GenaiCore.Unstructured.Processor>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<GenaiCore.Unstructured.Processor>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GenaiCore.Unstructured.Processor>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.Unstructured.Processor | null;
     ...
     */
    withoutIdentity(): GenaiCore.Unstructured.Processor | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<GenaiCore.Unstructured.Processor>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: GenaiCore.Unstructured.Processor, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<GenaiCore.Unstructured.Processor>, callback?: λFunction<GenaiCore.Unstructured.Processor | null, GenaiCore.Unstructured.Processor | null>): ObjList<GenaiCore.Unstructured.Processor>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<GenaiCore.Unstructured.Processor>, callback?: λFunction<GenaiCore.Unstructured.Processor | null, GenaiCore.Unstructured.Processor | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): GenaiCore.Unstructured.Processor;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Processor> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): GenaiCore.Unstructured.Processor | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Processor> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): GenaiCore.Unstructured.Processor | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Unstructured.Processor> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): GenaiCore.Unstructured.Processor | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<GenaiCore.Unstructured.Processor> | null;
    ...
    dependencies(): SeedDataDeps<GenaiCore.Unstructured.Processor> | null;
