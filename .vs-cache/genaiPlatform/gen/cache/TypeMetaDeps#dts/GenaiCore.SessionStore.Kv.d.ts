// TypeScript definitions for the C3 type GenaiCore.SessionStore.Kv
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.SessionStore.Kv
 */
declare namespace GenaiCore.SessionStore {
  export interface IKv {
     ...
     */
    inMemoryCacheParams?: IGenaiCore.SessionStore.InMemory.CacheParams;
     ...
     */
    enableCacheTracingInstrumentation?: boolean;
  }
}
...
declare namespace GenaiCore.SessionStore {
  export class Kv extends Obj  {
    ...
    withSerializer(serializer: IGenaiCore.SessionStore.Serializer): GenaiCore.SessionStore.Kv;
    ...
    withRetentionPolicy(retentionPolicy: IGenaiCore.SessionStore.RetentionPolicy | null): GenaiCore.SessionStore.Kv;

    /**
     * Whether to disable tracing instrumentation for this session store.
     */
    readonly disableTracingInstrumentation?: boolean;
    withDisableTracingInstrumentation(disableTracingInstrumentation: boolean): GenaiCore.SessionStore.Kv;
     ...
     */
    readonly id: string;
    withId(id: string): GenaiCore.SessionStore.Kv;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GenaiCore.SessionStore.Kv;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): GenaiCore.SessionStore.Kv;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): GenaiCore.SessionStore.Kv;
    ...
    withVersion(version: number | null): GenaiCore.SessionStore.Kv;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): GenaiCore.SessionStore.Kv;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): GenaiCore.SessionStore.Kv;
    ...
    withHidden(hidden: boolean): GenaiCore.SessionStore.Kv;
    ...
    withUserOwned(userOwned: boolean): GenaiCore.SessionStore.Kv;
    ...
    withTypeIdent(typeIdent: string | null): GenaiCore.SessionStore.Kv;

    /**
     * If set, a {@link GenaiCore.SessionStore.InMemory} configured according to the params will be used
     * as an in-memory cache for the KvStore. This is useful for reducing the number of reads from the KvStore.
     */
    readonly inMemoryCacheParams?: GenaiCore.SessionStore.InMemory.CacheParams;
    withInMemoryCacheParams(inMemoryCacheParams: IGenaiCore.SessionStore.InMemory.CacheParams | null): GenaiCore.SessionStore.Kv;
     ...
     * By default, the tracing instrumentation is disabled for the in-memory cache.
     */
    readonly enableCacheTracingInstrumentation?: boolean;
    withEnableCacheTracingInstrumentation(enableCacheTracingInstrumentation: boolean): GenaiCore.SessionStore.Kv;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.SessionStore.Kv | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.SessionStore.Kv | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.SessionStore.Kv | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.SessionStore.Kv | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.SessionStore.Kv;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.SessionStore.Kv;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.SessionStore.Kv;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.SessionStore.Kv>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.SessionStore.Kv>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.SessionStore.Kv;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.SessionStore.Kv;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.SessionStore.Kv;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.SessionStore.Kv;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.SessionStore.Kv;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.SessionStore.Kv;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.SessionStore.Kv;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.SessionStore.Kv;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.SessionStore.Kv;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.SessionStore.Kv;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.SessionStore.Kv;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.SessionStore.Kv;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.SessionStore.Kv;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.SessionStore.Kv;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.SessionStore.Kv;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.SessionStore.Kv;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.SessionStore.Kv;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.SessionStore.Kv;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.SessionStore.Kv;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.SessionStore.Kv;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.SessionStore.Kv;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.SessionStore.Kv;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.SessionStore.Kv;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.SessionStore.Kv;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.SessionStore.Kv;

    mergeJson(json: any): GenaiCore.SessionStore.Kv;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.SessionStore.Kv;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.SessionStore.Kv;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.SessionStore.Kv>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.SessionStore.Kv> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.SessionStore.Kv> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.SessionStore.Kv>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.SessionStore.Kv> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.SessionStore.Kv> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.SessionStore.Kv> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.SessionStore.Kv>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.SessionStore.Kv>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.SessionStore.Kv;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.SessionStore.Kv;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.SessionStore.Kv;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.SessionStore.Kv;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.SessionStore.Kv;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.SessionStore.Kv;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.SessionStore.Kv | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.SessionStore.Kv;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.SessionStore.Kv;
     ...
     */
    static cachedEmptyInst(): GenaiCore.SessionStore.Kv;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.SessionStore.Kv> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.SessionStore.Kv;
     ...
     */
    static allCached(): Stream<GenaiCore.SessionStore.Kv> | null;
     ...
     */
    static find(filter?: string): Stream<GenaiCore.SessionStore.Kv> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<GenaiCore.SessionStore.Kv> | null;

    /**
     * @return cached instance.
     */
    getCached(): GenaiCore.SessionStore.Kv | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): GenaiCore.SessionStore.Kv | null;
     ...
     */
    static produce(key: string): GenaiCore.SessionStore.Kv | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, GenaiCore.SessionStore.Kv> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<GenaiCore.SessionStore.Kv>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<GenaiCore.SessionStore.Kv>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<GenaiCore.SessionStore.Kv> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenaiCore.SessionStore.Kv>> | null;
     ...
     */
    get(include?: string): GenaiCore.SessionStore.Kv | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): GenaiCore.SessionStore.Kv | null;
     ...
     */
    getMissing(spec: GetMissingSpec): GenaiCore.SessionStore.Kv;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): GenaiCore.SessionStore.Kv | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): GenaiCore.SessionStore.Kv;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.SessionStore.Kv | null;
     ...
     */
    create(spec?: UpsertSpec): GenaiCore.SessionStore.Kv | null;
     ...
     */
    static createBatch(objs: Array_Type<GenaiCore.SessionStore.Kv>, spec?: UpsertSpec): ObjList<GenaiCore.SessionStore.Kv> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<GenaiCore.SessionStore.Kv>, spec?: CreateBatchObjStreamSpec): ObjList<GenaiCore.SessionStore.Kv> | null;
     ...
     */
    update(srcObj?: GenaiCore.SessionStore.Kv, spec?: UpsertSpec): GenaiCore.SessionStore.Kv | null;
     ...
     */
    upsert(srcObj?: GenaiCore.SessionStore.Kv, spec?: UpsertSpec): GenaiCore.SessionStore.Kv | null;
     ...
     */
    merge(spec?: MergeSpec): GenaiCore.SessionStore.Kv | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): GenaiCore.SessionStore.Kv | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): GenaiCore.SessionStore.Kv | null;
     ...
     */
    static updateBatch(objs: Array_Type<GenaiCore.SessionStore.Kv>, srcObjs?: Array_Type<GenaiCore.SessionStore.Kv>, spec?: UpsertSpec): ObjList<GenaiCore.SessionStore.Kv> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<GenaiCore.SessionStore.Kv> | null>, spec?: UpsertSpec): ObjList<GenaiCore.SessionStore.Kv> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<GenaiCore.SessionStore.Kv>, srcObjs?: Array_Type<GenaiCore.SessionStore.Kv>, spec?: UpsertSpec): ObjList<GenaiCore.SessionStore.Kv> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<GenaiCore.SessionStore.Kv> | null>, spec?: UpsertSpec): ObjList<GenaiCore.SessionStore.Kv> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<GenaiCore.SessionStore.Kv>, spec?: TouchSpec): ObjList<GenaiCore.SessionStore.Kv> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.SessionStore.Kv>, spec?: MergeSpec): ObjList<GenaiCore.SessionStore.Kv> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.SessionStore.Kv>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.SessionStore.Kv> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<GenaiCore.SessionStore.Kv> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.SessionStore.Kv> | null;
     ...
     */
    static mergeAll(mergeObj: GenaiCore.SessionStore.Kv, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: GenaiCore.SessionStore.Kv, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<GenaiCore.SessionStore.Kv>, spec?: UpsertSpec): ObjList<GenaiCore.SessionStore.Kv> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<GenaiCore.SessionStore.Kv>, spec?: UpsertSpec): ObjList<GenaiCore.SessionStore.Kv> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): GenaiCore.SessionStore.Kv | null;
     ...
     */
    static beforeCreate(objs: Array_Type<GenaiCore.SessionStore.Kv>): ObjList<GenaiCore.SessionStore.Kv>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<GenaiCore.SessionStore.Kv>): ObjList<GenaiCore.SessionStore.Kv>;
     ...
     */
    static beforeRemove(objs: Array_Type<GenaiCore.SessionStore.Kv>): ObjList<GenaiCore.SessionStore.Kv>;
     ...
     */
    static afterCreate(objs: Array_Type<GenaiCore.SessionStore.Kv>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<GenaiCore.SessionStore.Kv>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<GenaiCore.SessionStore.Kv>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<GenaiCore.SessionStore.Kv>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GenaiCore.SessionStore.Kv>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.SessionStore.Kv | null;
     ...
     */
    withoutIdentity(): GenaiCore.SessionStore.Kv | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<GenaiCore.SessionStore.Kv>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: GenaiCore.SessionStore.Kv, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<GenaiCore.SessionStore.Kv>, callback?: λFunction<GenaiCore.SessionStore.Kv | null, GenaiCore.SessionStore.Kv | null>): ObjList<GenaiCore.SessionStore.Kv>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<GenaiCore.SessionStore.Kv>, callback?: λFunction<GenaiCore.SessionStore.Kv | null, GenaiCore.SessionStore.Kv | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): GenaiCore.SessionStore.Kv;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.SessionStore.Kv> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): GenaiCore.SessionStore.Kv | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.SessionStore.Kv> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): GenaiCore.SessionStore.Kv | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.SessionStore.Kv> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): GenaiCore.SessionStore.Kv | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<GenaiCore.SessionStore.Kv> | null;
    ...
    dependencies(): SeedDataDeps<GenaiCore.SessionStore.Kv> | null;
     ...
     */
    inMemoryCache(): GenaiCore.SessionStore.InMemory;
  }
}
