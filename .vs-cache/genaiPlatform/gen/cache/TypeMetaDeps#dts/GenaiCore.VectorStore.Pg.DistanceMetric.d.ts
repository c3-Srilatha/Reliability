// TypeScript definitions for the C3 type GenaiCore.VectorStore.Pg.DistanceMetric

/**
 * Enumeration of supported distance metrics for pgvector.
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.VectorStore.Pg.DistanceMetric
 */
...
declare namespace GenaiCore.VectorStore.Pg {
  export class DistanceMetric {
     ...
     */
    readonly L2?: string;
    withL2(L2: string | null): GenaiCore.VectorStore.Pg.DistanceMetric;

    /**
     * Represents the Euclidean distance between 2 sparse vectors.
     */
    readonly L2_SPARSE_VECTOR?: string;
    withL2_SPARSE_VECTOR(L2_SPARSE_VECTOR: string | null): GenaiCore.VectorStore.Pg.DistanceMetric;

    /**
     * Represents the Dot product between two vectors.
     */
    readonly INNER_PRODUCT?: string;
    withINNER_PRODUCT(INNER_PRODUCT: string | null): GenaiCore.VectorStore.Pg.DistanceMetric;

    /**
     * Represents the Dot product between two sparse vectors.
     */
    readonly INNER_PRODUCT_SPARSE_VECTOR?: string;
    withINNER_PRODUCT_SPARSE_VECTOR(INNER_PRODUCT_SPARSE_VECTOR: string | null): GenaiCore.VectorStore.Pg.DistanceMetric;

    /**
     * Cosine similarity uses the cosine of the angle between two sets of vectors to measure how similar they are.
     */
    readonly COSINE?: string;
    withCOSINE(COSINE: string | null): GenaiCore.VectorStore.Pg.DistanceMetric;

    /**
     * Cosine similarity uses the cosine of the angle between two sets of sparse vectors to measure how similar they are.
     */
    readonly COSINE_SPARSE_VECTOR?: string;
    withCOSINE_SPARSE_VECTOR(COSINE_SPARSE_VECTOR: string | null): GenaiCore.VectorStore.Pg.DistanceMetric;
     ...
     */
    readonly L1?: string;
    withL1(L1: string | null): GenaiCore.VectorStore.Pg.DistanceMetric;
    ...
    withL1_SPARSE_VECTOR(L1_SPARSE_VECTOR: string | null): GenaiCore.VectorStore.Pg.DistanceMetric;
    ...
    withHAMMING(HAMMING: string | null): GenaiCore.VectorStore.Pg.DistanceMetric;
    ...
    withJACCARD(JACCARD: string | null): GenaiCore.VectorStore.Pg.DistanceMetric;
