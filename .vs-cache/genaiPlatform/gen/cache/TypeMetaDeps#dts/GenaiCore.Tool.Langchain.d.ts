// TypeScript definitions for the C3 type GenaiCore.Tool.Langchain
 ...
 * ```
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Tool.Langchain
 */
 ...
 */
declare namespace GenaiCore.Tool {
  export class Langchain extends Obj  {

    /**
     * The name of this instance.
     */
    readonly name?: string;
    withName(name: string | null): GenaiCore.Tool.Langchain;
     ...
     */
    readonly id: string;
    withId(id: string): GenaiCore.Tool.Langchain;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GenaiCore.Tool.Langchain;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): GenaiCore.Tool.Langchain;
    ...
    withVersion(version: number | null): GenaiCore.Tool.Langchain;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): GenaiCore.Tool.Langchain;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): GenaiCore.Tool.Langchain;
    ...
    withHidden(hidden: boolean): GenaiCore.Tool.Langchain;
    ...
    withUserOwned(userOwned: boolean): GenaiCore.Tool.Langchain;
    ...
    withTypeIdent(typeIdent: string | null): GenaiCore.Tool.Langchain;

    /**
     * The flag used to mark whether the tool has been published. Defaults to `false`.
     */
    readonly isPublished?: boolean;
    withIsPublished(isPublished: boolean): GenaiCore.Tool.Langchain;

    /**
     * Optional persisted kwargs that will be passed to #initialize
     */
    readonly initKwargs?: any;
    withInitKwargs(initKwargs: any | null): GenaiCore.Tool.Langchain;
    ...
    withDescription(description: string | null): GenaiCore.Tool.Langchain;
    ...
    withDescriptionForLlm(descriptionForLlm: string): GenaiCore.Tool.Langchain;
    ...
    withArgsSchema(argsSchema: any | null): GenaiCore.Tool.Langchain;
    ...
    withOutputPyType(outputPyType: any | null): GenaiCore.Tool.Langchain;

    /**
     * This field represents the serialized string of the langchain native tools.
     */
    readonly nativeTool: string;
    withNativeTool(nativeTool: string): GenaiCore.Tool.Langchain;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Tool.Langchain | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Tool.Langchain | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Tool.Langchain | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Tool.Langchain | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Tool.Langchain;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Tool.Langchain;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Tool.Langchain;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Tool.Langchain>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Tool.Langchain>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Tool.Langchain;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Tool.Langchain;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Tool.Langchain;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Tool.Langchain;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Tool.Langchain;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Tool.Langchain;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Tool.Langchain;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Tool.Langchain;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Tool.Langchain;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Tool.Langchain;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Tool.Langchain;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Tool.Langchain;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Tool.Langchain;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Tool.Langchain;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Tool.Langchain;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Tool.Langchain;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Tool.Langchain;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Tool.Langchain;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Tool.Langchain;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Tool.Langchain;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Tool.Langchain;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Tool.Langchain;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Tool.Langchain;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Tool.Langchain;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Tool.Langchain;

    mergeJson(json: any): GenaiCore.Tool.Langchain;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Tool.Langchain;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Tool.Langchain;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Tool.Langchain>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Tool.Langchain> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Tool.Langchain> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Tool.Langchain>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Tool.Langchain> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Tool.Langchain> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Tool.Langchain> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Tool.Langchain>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Tool.Langchain>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Tool.Langchain;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Tool.Langchain;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Tool.Langchain;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Tool.Langchain;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Tool.Langchain;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Tool.Langchain;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.Tool.Langchain | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Tool.Langchain;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Tool.Langchain;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Tool.Langchain;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Tool.Langchain> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Tool.Langchain;
     ...
     */
    static allCached(): Stream<GenaiCore.Tool.Langchain> | null;
     ...
     */
    static find(filter?: string): Stream<GenaiCore.Tool.Langchain> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<GenaiCore.Tool.Langchain> | null;

    /**
     * @return cached instance.
     */
    getCached(): GenaiCore.Tool.Langchain | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): GenaiCore.Tool.Langchain | null;
     ...
     */
    static produce(key: string): GenaiCore.Tool.Langchain | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, GenaiCore.Tool.Langchain> | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<GenaiCore.Tool.Langchain>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<GenaiCore.Tool.Langchain>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<GenaiCore.Tool.Langchain> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenaiCore.Tool.Langchain>> | null;
     ...
     */
    get(include?: string): GenaiCore.Tool.Langchain | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): GenaiCore.Tool.Langchain | null;
     ...
     */
    getMissing(spec: GetMissingSpec): GenaiCore.Tool.Langchain;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): GenaiCore.Tool.Langchain | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): GenaiCore.Tool.Langchain;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.Tool.Langchain | null;
     ...
     */
    create(spec?: UpsertSpec): GenaiCore.Tool.Langchain | null;
     ...
     */
    static createBatch(objs: Array_Type<GenaiCore.Tool.Langchain>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.Langchain> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<GenaiCore.Tool.Langchain>, spec?: CreateBatchObjStreamSpec): ObjList<GenaiCore.Tool.Langchain> | null;
     ...
     */
    update(srcObj?: GenaiCore.Tool.Langchain, spec?: UpsertSpec): GenaiCore.Tool.Langchain | null;
     ...
     */
    upsert(srcObj?: GenaiCore.Tool.Langchain, spec?: UpsertSpec): GenaiCore.Tool.Langchain | null;
     ...
     */
    merge(spec?: MergeSpec): GenaiCore.Tool.Langchain | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): GenaiCore.Tool.Langchain | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): GenaiCore.Tool.Langchain | null;
     ...
     */
    static updateBatch(objs: Array_Type<GenaiCore.Tool.Langchain>, srcObjs?: Array_Type<GenaiCore.Tool.Langchain>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.Langchain> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<GenaiCore.Tool.Langchain> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.Langchain> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<GenaiCore.Tool.Langchain>, srcObjs?: Array_Type<GenaiCore.Tool.Langchain>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.Langchain> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<GenaiCore.Tool.Langchain> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.Langchain> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<GenaiCore.Tool.Langchain>, spec?: TouchSpec): ObjList<GenaiCore.Tool.Langchain> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Tool.Langchain>, spec?: MergeSpec): ObjList<GenaiCore.Tool.Langchain> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Tool.Langchain>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Tool.Langchain> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<GenaiCore.Tool.Langchain> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Tool.Langchain> | null;
     ...
     */
    static mergeAll(mergeObj: GenaiCore.Tool.Langchain, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: GenaiCore.Tool.Langchain, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<GenaiCore.Tool.Langchain>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.Langchain> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<GenaiCore.Tool.Langchain>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.Langchain> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): GenaiCore.Tool.Langchain | null;
     ...
     */
    static beforeCreate(objs: Array_Type<GenaiCore.Tool.Langchain>): ObjList<GenaiCore.Tool.Langchain>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<GenaiCore.Tool.Langchain>): ObjList<GenaiCore.Tool.Langchain>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<GenaiCore.Tool.Langchain>): ObjList<GenaiCore.Tool.Langchain>;
     ...
     */
    static afterCreate(objs: Array_Type<GenaiCore.Tool.Langchain>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<GenaiCore.Tool.Langchain>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<GenaiCore.Tool.Langchain>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<GenaiCore.Tool.Langchain>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GenaiCore.Tool.Langchain>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.Tool.Langchain | null;
     ...
     */
    withoutIdentity(): GenaiCore.Tool.Langchain | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<GenaiCore.Tool.Langchain>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: GenaiCore.Tool.Langchain, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<GenaiCore.Tool.Langchain>, callback?: λFunction<GenaiCore.Tool.Langchain | null, GenaiCore.Tool.Langchain | null>): ObjList<GenaiCore.Tool.Langchain>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<GenaiCore.Tool.Langchain>, callback?: λFunction<GenaiCore.Tool.Langchain | null, GenaiCore.Tool.Langchain | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): GenaiCore.Tool.Langchain;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.Langchain> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): GenaiCore.Tool.Langchain | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.Langchain> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): GenaiCore.Tool.Langchain | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.Langchain> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): GenaiCore.Tool.Langchain | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<GenaiCore.Tool.Langchain> | null;
    ...
    dependencies(): SeedDataDeps<GenaiCore.Tool.Langchain> | null;
     ...
     */
    static createFromLangchainTool(tool: any): GenaiCore.Tool.Langchain;
  }
}
