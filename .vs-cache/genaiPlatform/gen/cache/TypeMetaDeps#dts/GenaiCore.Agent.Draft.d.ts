// TypeScript definitions for the C3 type GenaiCore.Agent.Draft
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Agent.Draft
 */
 ...
 */
declare namespace GenaiCore.Agent {
  export class Draft extends Obj  {
    ...
    withAgentTypeName(agentTypeName: string): GenaiCore.Agent.Draft;
    ...
    withAgentFieldValues(agentFieldValues: Map_Type<string, any> | {[key: string]: any} | null): GenaiCore.Agent.Draft;
     ...
     */
    readonly id: string;
    withId(id: string): GenaiCore.Agent.Draft;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GenaiCore.Agent.Draft;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): GenaiCore.Agent.Draft;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): GenaiCore.Agent.Draft;
    ...
    withVersion(version: number | null): GenaiCore.Agent.Draft;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): GenaiCore.Agent.Draft;
    ...
    withDescription(description: string | null): GenaiCore.Agent.Draft;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Agent.Draft | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Agent.Draft | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Agent.Draft | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Agent.Draft | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Agent.Draft;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Agent.Draft;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Agent.Draft;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Agent.Draft>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Agent.Draft>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Agent.Draft;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Agent.Draft;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Agent.Draft;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Agent.Draft;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Agent.Draft;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Agent.Draft;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Agent.Draft;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Agent.Draft;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Agent.Draft;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Agent.Draft;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Agent.Draft;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Agent.Draft;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Agent.Draft;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Agent.Draft;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Agent.Draft;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Agent.Draft;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Agent.Draft;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Agent.Draft;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Agent.Draft;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Agent.Draft;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Agent.Draft;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Agent.Draft;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Agent.Draft;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Agent.Draft;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Agent.Draft;

    mergeJson(json: any): GenaiCore.Agent.Draft;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Agent.Draft;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Agent.Draft;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Agent.Draft>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Agent.Draft> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Agent.Draft> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Agent.Draft>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Agent.Draft> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Agent.Draft> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Agent.Draft> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Agent.Draft>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Agent.Draft>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Agent.Draft;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Agent.Draft;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Agent.Draft;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Agent.Draft;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Agent.Draft;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Agent.Draft;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.Agent.Draft | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Agent.Draft;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Agent.Draft;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Agent.Draft;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Agent.Draft> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Agent.Draft;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<GenaiCore.Agent.Draft>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<GenaiCore.Agent.Draft>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<GenaiCore.Agent.Draft> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenaiCore.Agent.Draft>> | null;
     ...
     */
    get(include?: string): GenaiCore.Agent.Draft | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): GenaiCore.Agent.Draft | null;
     ...
     */
    getMissing(spec: GetMissingSpec): GenaiCore.Agent.Draft;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): GenaiCore.Agent.Draft | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): GenaiCore.Agent.Draft;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.Agent.Draft | null;
     ...
     */
    create(spec?: UpsertSpec): GenaiCore.Agent.Draft | null;
     ...
     */
    static createBatch(objs: Array_Type<GenaiCore.Agent.Draft>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.Draft> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<GenaiCore.Agent.Draft>, spec?: CreateBatchObjStreamSpec): ObjList<GenaiCore.Agent.Draft> | null;
     ...
     */
    update(srcObj?: GenaiCore.Agent.Draft, spec?: UpsertSpec): GenaiCore.Agent.Draft | null;
     ...
     */
    upsert(srcObj?: GenaiCore.Agent.Draft, spec?: UpsertSpec): GenaiCore.Agent.Draft | null;
     ...
     */
    merge(spec?: MergeSpec): GenaiCore.Agent.Draft | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): GenaiCore.Agent.Draft | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): GenaiCore.Agent.Draft | null;
     ...
     */
    static updateBatch(objs: Array_Type<GenaiCore.Agent.Draft>, srcObjs?: Array_Type<GenaiCore.Agent.Draft>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.Draft> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<GenaiCore.Agent.Draft> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.Draft> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<GenaiCore.Agent.Draft>, srcObjs?: Array_Type<GenaiCore.Agent.Draft>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.Draft> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<GenaiCore.Agent.Draft> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.Draft> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<GenaiCore.Agent.Draft>, spec?: TouchSpec): ObjList<GenaiCore.Agent.Draft> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Agent.Draft>, spec?: MergeSpec): ObjList<GenaiCore.Agent.Draft> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Agent.Draft>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Agent.Draft> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<GenaiCore.Agent.Draft> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Agent.Draft> | null;
     ...
     */
    static mergeAll(mergeObj: GenaiCore.Agent.Draft, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: GenaiCore.Agent.Draft, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<GenaiCore.Agent.Draft>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.Draft> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<GenaiCore.Agent.Draft>, spec?: UpsertSpec): ObjList<GenaiCore.Agent.Draft> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): GenaiCore.Agent.Draft | null;
     ...
     */
    static beforeCreate(objs: Array_Type<GenaiCore.Agent.Draft>): ObjList<GenaiCore.Agent.Draft>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<GenaiCore.Agent.Draft>): ObjList<GenaiCore.Agent.Draft>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<GenaiCore.Agent.Draft>): ObjList<GenaiCore.Agent.Draft>;
     ...
     */
    static afterCreate(objs: Array_Type<GenaiCore.Agent.Draft>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<GenaiCore.Agent.Draft>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<GenaiCore.Agent.Draft>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<GenaiCore.Agent.Draft>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GenaiCore.Agent.Draft>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.Agent.Draft | null;
     ...
     */
    withoutIdentity(): GenaiCore.Agent.Draft | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<GenaiCore.Agent.Draft>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: GenaiCore.Agent.Draft, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<GenaiCore.Agent.Draft>, callback?: λFunction<GenaiCore.Agent.Draft | null, GenaiCore.Agent.Draft | null>): ObjList<GenaiCore.Agent.Draft>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<GenaiCore.Agent.Draft>, callback?: λFunction<GenaiCore.Agent.Draft | null, GenaiCore.Agent.Draft | null>): Array_Type<ObjError> | null;
     ...
     */
    createTemplate(spec?: GenaiCore.Agent.CreateTemplateSpec): GenaiCore.Agent.Template;
     ...
     */
    createAgent(spec?: GenaiCore.Agent.CreateSpec): GenaiCore.Agent;
  }
}
