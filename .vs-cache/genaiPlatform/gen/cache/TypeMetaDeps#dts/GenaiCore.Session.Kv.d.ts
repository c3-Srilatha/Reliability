// TypeScript definitions for the C3 type GenaiCore.Session.Kv

/**
 * Concrete session instance and corresponding state used for {@link GenaiCore.SessionStore.Kv}.
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Session.Kv
 */
declare namespace GenaiCore.Session {
...
declare namespace GenaiCore.Session {
  export class Kv extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): GenaiCore.Session.Kv;
    ...
    withSessionStoreId(sessionStoreId: string): GenaiCore.Session.Kv;
    ...
    withVersion(version: number | null): GenaiCore.Session.Kv;
     ...
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): GenaiCore.Session.Kv;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GenaiCore.Session.Kv;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): GenaiCore.Session.Kv;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): GenaiCore.Session.Kv;
     ...
     */
    readonly state?: any;
    withState(state: any | null): GenaiCore.Session.Kv;

    /**
     * If the session state is too large for cassandra, we persist it in this file instead. Only one of
     * #state or `stateFile` should be set.
     */
    readonly stateFile?: File;
    withStateFile(stateFile: IFile | null): GenaiCore.Session.Kv;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Session.Kv | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Session.Kv | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Session.Kv | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Session.Kv | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Session.Kv;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Session.Kv;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Session.Kv;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Session.Kv>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Session.Kv>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Session.Kv;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Session.Kv;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Session.Kv;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Session.Kv;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Session.Kv;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Session.Kv;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Session.Kv;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Session.Kv;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Session.Kv;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Session.Kv;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Session.Kv;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Session.Kv;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Session.Kv;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Session.Kv;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Session.Kv;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Session.Kv;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Session.Kv;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Session.Kv;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Session.Kv;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Session.Kv;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Session.Kv;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Session.Kv;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Session.Kv;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Session.Kv;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Session.Kv;

    mergeJson(json: any): GenaiCore.Session.Kv;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Session.Kv;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Session.Kv;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Session.Kv>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Session.Kv> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Session.Kv> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Session.Kv>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Session.Kv> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Session.Kv> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Session.Kv> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Session.Kv>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Session.Kv>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Session.Kv;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Session.Kv;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Session.Kv;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Session.Kv;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Session.Kv;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Session.Kv;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.Session.Kv | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Session.Kv;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Session.Kv;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Session.Kv;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Session.Kv> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Session.Kv;
     ...
     */
    static idFromName(store: GenaiCore.SessionStore, name?: string): string;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<GenaiCore.Session.Kv>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<GenaiCore.Session.Kv>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<GenaiCore.Session.Kv> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenaiCore.Session.Kv>> | null;
     ...
     */
    get(include?: string): GenaiCore.Session.Kv | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): GenaiCore.Session.Kv | null;
     ...
     */
    getMissing(spec: GetMissingSpec): GenaiCore.Session.Kv;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): GenaiCore.Session.Kv | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): GenaiCore.Session.Kv;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.Session.Kv | null;
     ...
     */
    create(spec?: UpsertSpec): GenaiCore.Session.Kv | null;
     ...
     */
    static createBatch(objs: Array_Type<GenaiCore.Session.Kv>, spec?: UpsertSpec): ObjList<GenaiCore.Session.Kv> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<GenaiCore.Session.Kv>, spec?: CreateBatchObjStreamSpec): ObjList<GenaiCore.Session.Kv> | null;
     ...
     */
    update(srcObj?: GenaiCore.Session.Kv, spec?: UpsertSpec): GenaiCore.Session.Kv | null;
     ...
     */
    upsert(srcObj?: GenaiCore.Session.Kv, spec?: UpsertSpec): GenaiCore.Session.Kv | null;
     ...
     */
    merge(spec?: MergeSpec): GenaiCore.Session.Kv | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): GenaiCore.Session.Kv | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): GenaiCore.Session.Kv | null;
     ...
     */
    static updateBatch(objs: Array_Type<GenaiCore.Session.Kv>, srcObjs?: Array_Type<GenaiCore.Session.Kv>, spec?: UpsertSpec): ObjList<GenaiCore.Session.Kv> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<GenaiCore.Session.Kv> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Session.Kv> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<GenaiCore.Session.Kv>, srcObjs?: Array_Type<GenaiCore.Session.Kv>, spec?: UpsertSpec): ObjList<GenaiCore.Session.Kv> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<GenaiCore.Session.Kv> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Session.Kv> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<GenaiCore.Session.Kv>, spec?: TouchSpec): ObjList<GenaiCore.Session.Kv> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Session.Kv>, spec?: MergeSpec): ObjList<GenaiCore.Session.Kv> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Session.Kv>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Session.Kv> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<GenaiCore.Session.Kv> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Session.Kv> | null;
     ...
     */
    static mergeAll(mergeObj: GenaiCore.Session.Kv, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: GenaiCore.Session.Kv, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<GenaiCore.Session.Kv>, spec?: UpsertSpec): ObjList<GenaiCore.Session.Kv> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<GenaiCore.Session.Kv>, spec?: UpsertSpec): ObjList<GenaiCore.Session.Kv> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): GenaiCore.Session.Kv | null;
     ...
     */
    static beforeCreate(objs: Array_Type<GenaiCore.Session.Kv>): ObjList<GenaiCore.Session.Kv>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<GenaiCore.Session.Kv>): ObjList<GenaiCore.Session.Kv>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<GenaiCore.Session.Kv>): ObjList<GenaiCore.Session.Kv>;
     ...
     */
    static afterCreate(objs: Array_Type<GenaiCore.Session.Kv>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<GenaiCore.Session.Kv>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<GenaiCore.Session.Kv>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<GenaiCore.Session.Kv>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GenaiCore.Session.Kv>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.Session.Kv | null;
     ...
     */
    withoutIdentity(): GenaiCore.Session.Kv | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<GenaiCore.Session.Kv>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: GenaiCore.Session.Kv, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<GenaiCore.Session.Kv>, callback?: λFunction<GenaiCore.Session.Kv | null, GenaiCore.Session.Kv | null>): ObjList<GenaiCore.Session.Kv>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<GenaiCore.Session.Kv>, callback?: λFunction<GenaiCore.Session.Kv | null, GenaiCore.Session.Kv | null>): Array_Type<ObjError> | null;
