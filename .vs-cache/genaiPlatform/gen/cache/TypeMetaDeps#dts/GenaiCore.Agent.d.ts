// TypeScript definitions for the C3 type GenaiCore.Agent

/**
 * This is the generic type that defines an agent in the C3 ecosystem. An agent is seedable and immutable.
 * It can be deployed or cloned as a draft for editing.
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Agent
 */
 ...
 * It can be deployed or cloned as a draft for editing.
 *
 * @remarks this represents a made instance of GenaiCore.Agent
 */
declare namespace GenaiCore {
  export class Agent extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): GenaiCore.Agent;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GenaiCore.Agent;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): GenaiCore.Agent;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): GenaiCore.Agent;
    ...
    withVersion(version: number | null): GenaiCore.Agent;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): GenaiCore.Agent;
    ...
    withUserUpdatedFields(userUpdatedFields: Array_Type<string> | Array<string> | null): GenaiCore.Agent;
    ...
    withHidden(hidden: boolean): GenaiCore.Agent;
    ...
    withUserOwned(userOwned: boolean): GenaiCore.Agent;
    ...
    withTypeIdent(typeIdent: string | null): GenaiCore.Agent;
    ...
    withDescription(description: string | null): GenaiCore.Agent;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Agent | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Agent | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Agent | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Agent | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Agent;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Agent;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Agent;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Agent>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Agent>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Agent;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Agent;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Agent;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Agent;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Agent;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Agent;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Agent;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Agent;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Agent;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Agent;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Agent;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Agent;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Agent;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Agent;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Agent;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Agent;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Agent;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Agent;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Agent;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Agent;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Agent;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Agent;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Agent;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Agent;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Agent;

    mergeJson(json: any): GenaiCore.Agent;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Agent;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Agent;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Agent>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Agent> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Agent> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Agent>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Agent> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Agent> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Agent> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Agent>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Agent>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Agent;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Agent;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Agent;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Agent;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Agent;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Agent;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.Agent | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Agent;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Agent;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Agent> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Agent;
     ...
     */
    static allCached(): Stream<GenaiCore.Agent> | null;
     ...
     */
    static find(filter?: string): Stream<GenaiCore.Agent> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<GenaiCore.Agent> | null;

    /**
     * @return cached instance.
     */
    getCached(): GenaiCore.Agent | null;

    /**
     * @return cached instance by the key.
     */
    static forCacheKey(key: string): GenaiCore.Agent | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<GenaiCore.Agent>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<GenaiCore.Agent>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<GenaiCore.Agent> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenaiCore.Agent>> | null;
     ...
     */
    get(include?: string): GenaiCore.Agent | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): GenaiCore.Agent | null;
     ...
     */
    getMissing(spec: GetMissingSpec): GenaiCore.Agent;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): GenaiCore.Agent | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): GenaiCore.Agent;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.Agent | null;
     ...
     */
    create(spec?: UpsertSpec): GenaiCore.Agent | null;
     ...
     */
    static createBatch(objs: Array_Type<GenaiCore.Agent>, spec?: UpsertSpec): ObjList<GenaiCore.Agent> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<GenaiCore.Agent>, spec?: CreateBatchObjStreamSpec): ObjList<GenaiCore.Agent> | null;
     ...
     */
    update(srcObj?: GenaiCore.Agent, spec?: UpsertSpec): GenaiCore.Agent | null;
     ...
     */
    upsert(srcObj?: GenaiCore.Agent, spec?: UpsertSpec): GenaiCore.Agent | null;
     ...
     */
    merge(spec?: MergeSpec): GenaiCore.Agent | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): GenaiCore.Agent | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): GenaiCore.Agent | null;
     ...
     */
    static updateBatch(objs: Array_Type<GenaiCore.Agent>, srcObjs?: Array_Type<GenaiCore.Agent>, spec?: UpsertSpec): ObjList<GenaiCore.Agent> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<GenaiCore.Agent> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Agent> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<GenaiCore.Agent>, srcObjs?: Array_Type<GenaiCore.Agent>, spec?: UpsertSpec): ObjList<GenaiCore.Agent> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<GenaiCore.Agent> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Agent> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<GenaiCore.Agent>, spec?: TouchSpec): ObjList<GenaiCore.Agent> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Agent>, spec?: MergeSpec): ObjList<GenaiCore.Agent> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Agent>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Agent> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<GenaiCore.Agent> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Agent> | null;
     ...
     */
    static mergeAll(mergeObj: GenaiCore.Agent, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: GenaiCore.Agent, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<GenaiCore.Agent>, spec?: UpsertSpec): ObjList<GenaiCore.Agent> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<GenaiCore.Agent>, spec?: UpsertSpec): ObjList<GenaiCore.Agent> | null;
     ...
     */
    static beforeCreate(objs: Array_Type<GenaiCore.Agent>): ObjList<GenaiCore.Agent>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<GenaiCore.Agent>): ObjList<GenaiCore.Agent>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<GenaiCore.Agent>): ObjList<GenaiCore.Agent>;
     ...
     */
    static afterCreate(objs: Array_Type<GenaiCore.Agent>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<GenaiCore.Agent>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<GenaiCore.Agent>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<GenaiCore.Agent>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GenaiCore.Agent>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.Agent | null;
     ...
     */
    withoutIdentity(): GenaiCore.Agent | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<GenaiCore.Agent>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: GenaiCore.Agent, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<GenaiCore.Agent>, callback?: λFunction<GenaiCore.Agent | null, GenaiCore.Agent | null>): ObjList<GenaiCore.Agent>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<GenaiCore.Agent>, callback?: λFunction<GenaiCore.Agent | null, GenaiCore.Agent | null>): Array_Type<ObjError> | null;
     ...
     */
    publish(subPath?: string, contentType?: string): GenaiCore.Agent;
     ...
     */
    static removeSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Agent> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec): GenaiCore.Agent | null;
     ...
     */
    static createSeedDataBatch(objs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Agent> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData, spec?: UpsertSpec): GenaiCore.Agent | null;
     ...
     */
    static updateSeedDataBatch(objs?: Array_Type<SeedData>, srcObjs?: Array_Type<SeedData>, spec?: UpsertSpec): ObjList<GenaiCore.Agent> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec): GenaiCore.Agent | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: Array_Type<SeedData>, spec?: MergeSpec): ObjList<GenaiCore.Agent> | null;
    ...
    dependencies(): SeedDataDeps<GenaiCore.Agent> | null;
