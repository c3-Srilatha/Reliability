// TypeScript definitions for the C3 type GenaiCore.Llm.AzureOpenAi.Auth

/**
 * Authentication information for the Azure OpenAi LLM Service.
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Llm.AzureOpenAi.Auth
 */
declare namespace GenaiCore.Llm.AzureOpenAi {
 ...
 */
declare namespace GenaiCore.Llm.AzureOpenAi {
  export class Auth extends Obj  {

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): GenaiCore.Llm.AzureOpenAi.Auth;
    ...
    withConfigOverride(configOverride: string | null): GenaiCore.Llm.AzureOpenAi.Auth;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): GenaiCore.Llm.AzureOpenAi.Auth;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): GenaiCore.Llm.AzureOpenAi.Auth;
    ...
    withAuths(auths: Array_Type<GenaiCore.Llm.Auth> | Array<IGenaiCore.Llm.Auth> | null): GenaiCore.Llm.AzureOpenAi.Auth;
    ...
    withApiKey(apiKey: string | null): GenaiCore.Llm.AzureOpenAi.Auth;
    ...
    withAzureEndpoint(azureEndpoint: string | null): GenaiCore.Llm.AzureOpenAi.Auth;

    /**
     * The Azure endpoint.
     */
    static readonly azureEndpoint?: string;

    /**
     * The API version.
     */
    readonly apiVersion?: string;
    withApiVersion(apiVersion: string | null): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     */
    static inst(): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Llm.AzureOpenAi.Auth | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Llm.AzureOpenAi.Auth | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Llm.AzureOpenAi.Auth | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Llm.AzureOpenAi.Auth | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Llm.AzureOpenAi.Auth>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Llm.AzureOpenAi.Auth>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Llm.AzureOpenAi.Auth>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Llm.AzureOpenAi.Auth>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Llm.AzureOpenAi.Auth;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Llm.AzureOpenAi.Auth;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @see #removeField
     */
    static withoutField(field: string): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Llm.AzureOpenAi.Auth;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Llm.AzureOpenAi.Auth;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @see #removeField
     */
    static unsetField(field: string): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @see #unsetField
     */
    static removeField(field: string): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Llm.AzureOpenAi.Auth;

    mergeJson(json: any): GenaiCore.Llm.AzureOpenAi.Auth;

    static mergeJson(json: any): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Llm.AzureOpenAi.Auth>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<GenaiCore.Llm.AzureOpenAi.Auth>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Llm.AzureOpenAi.Auth> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Llm.AzureOpenAi.Auth> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Llm.AzureOpenAi.Auth>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<GenaiCore.Llm.AzureOpenAi.Auth>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Llm.AzureOpenAi.Auth> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Llm.AzureOpenAi.Auth> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Llm.AzureOpenAi.Auth> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Llm.AzureOpenAi.Auth>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<GenaiCore.Llm.AzureOpenAi.Auth>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Llm.AzureOpenAi.Auth>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Llm.AzureOpenAi.Auth;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.Llm.AzureOpenAi.Auth | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Llm.AzureOpenAi.Auth;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Llm.AzureOpenAi.Auth> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.Llm.AzureOpenAi.Auth | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): GenaiCore.Llm.AzureOpenAi.Auth | null;
     ...
     */
    static allCached(): Stream<GenaiCore.Llm.AzureOpenAi.Auth> | null;
     ...
     */
    static find(filter?: string): Stream<GenaiCore.Llm.AzureOpenAi.Auth> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<GenaiCore.Llm.AzureOpenAi.Auth> | null;

    /**
     * @return cached instance.
     */
    getCached(): GenaiCore.Llm.AzureOpenAi.Auth | null;

    /**
     * @return cached instance.
     */
    static getCached(): GenaiCore.Llm.AzureOpenAi.Auth | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): GenaiCore.Llm.AzureOpenAi.Auth | null;
     ...
     */
    static produce(key: string): GenaiCore.Llm.AzureOpenAi.Auth | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, GenaiCore.Llm.AzureOpenAi.Auth> | null;
     ...
     */
    getConfig(): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     */
    getSecret(): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     */
    withConfigKey(configKey: string): GenaiCore.Llm.AzureOpenAi.Auth;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): GenaiCore.Llm.AzureOpenAi.Auth;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): GenaiCore.Llm.AzureOpenAi.Auth;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): GenaiCore.Llm.AzureOpenAi.Auth;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): GenaiCore.Llm.AzureOpenAi.Auth | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<GenaiCore.Llm.AzureOpenAi.Auth> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: GenaiCore.Llm.AzureOpenAi.Auth, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: GenaiCore.Llm.AzureOpenAi.Auth, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): GenaiCore.Llm.AzureOpenAi.Auth | null;
     ...
     */
    removeSecrets(): GenaiCore.Llm.AzureOpenAi.Auth | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): GenaiCore.Llm.AzureOpenAi.Auth | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): GenaiCore.Llm.AzureOpenAi.Auth | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): GenaiCore.Llm.AzureOpenAi.Auth | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): GenaiCore.Llm.AzureOpenAi.Auth;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): GenaiCore.Llm.AzureOpenAi.Auth;
