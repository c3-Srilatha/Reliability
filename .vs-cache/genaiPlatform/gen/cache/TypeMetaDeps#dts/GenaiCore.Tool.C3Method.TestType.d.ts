// TypeScript definitions for the C3 type GenaiCore.Tool.C3Method.TestType

/**
 * A test type for {@link GenaiCore.Tool.C3Method}.
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Tool.C3Method.TestType
 */
declare namespace GenaiCore.Tool.C3Method {
 ...
 */
declare namespace GenaiCore.Tool.C3Method {
  export class TestType extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): GenaiCore.Tool.C3Method.TestType;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): GenaiCore.Tool.C3Method.TestType;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): GenaiCore.Tool.C3Method.TestType;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): GenaiCore.Tool.C3Method.TestType;
    ...
    withVersion(version: number | null): GenaiCore.Tool.C3Method.TestType;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): GenaiCore.Tool.C3Method.TestType;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Tool.C3Method.TestType | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Tool.C3Method.TestType | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Tool.C3Method.TestType | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Tool.C3Method.TestType | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Tool.C3Method.TestType;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Tool.C3Method.TestType;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Tool.C3Method.TestType;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Tool.C3Method.TestType>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Tool.C3Method.TestType>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Tool.C3Method.TestType;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Tool.C3Method.TestType;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Tool.C3Method.TestType;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Tool.C3Method.TestType;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Tool.C3Method.TestType;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Tool.C3Method.TestType;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Tool.C3Method.TestType;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Tool.C3Method.TestType;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Tool.C3Method.TestType;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Tool.C3Method.TestType;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Tool.C3Method.TestType;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Tool.C3Method.TestType;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Tool.C3Method.TestType;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Tool.C3Method.TestType;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Tool.C3Method.TestType;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Tool.C3Method.TestType;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Tool.C3Method.TestType;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Tool.C3Method.TestType;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Tool.C3Method.TestType;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Tool.C3Method.TestType;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Tool.C3Method.TestType;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Tool.C3Method.TestType;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Tool.C3Method.TestType;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Tool.C3Method.TestType;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Tool.C3Method.TestType;

    mergeJson(json: any): GenaiCore.Tool.C3Method.TestType;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Tool.C3Method.TestType;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Tool.C3Method.TestType;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Tool.C3Method.TestType>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Tool.C3Method.TestType> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Tool.C3Method.TestType> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Tool.C3Method.TestType>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Tool.C3Method.TestType> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Tool.C3Method.TestType> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Tool.C3Method.TestType> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Tool.C3Method.TestType>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Tool.C3Method.TestType>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Tool.C3Method.TestType;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Tool.C3Method.TestType;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Tool.C3Method.TestType;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Tool.C3Method.TestType;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Tool.C3Method.TestType;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Tool.C3Method.TestType;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.Tool.C3Method.TestType | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Tool.C3Method.TestType;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Tool.C3Method.TestType;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Tool.C3Method.TestType;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Tool.C3Method.TestType> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Tool.C3Method.TestType;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<GenaiCore.Tool.C3Method.TestType>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<GenaiCore.Tool.C3Method.TestType>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<GenaiCore.Tool.C3Method.TestType> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenaiCore.Tool.C3Method.TestType>> | null;
     ...
     */
    get(include?: string): GenaiCore.Tool.C3Method.TestType | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): GenaiCore.Tool.C3Method.TestType | null;
     ...
     */
    getMissing(spec: GetMissingSpec): GenaiCore.Tool.C3Method.TestType;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): GenaiCore.Tool.C3Method.TestType | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): GenaiCore.Tool.C3Method.TestType;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.Tool.C3Method.TestType | null;
     ...
     */
    create(spec?: UpsertSpec): GenaiCore.Tool.C3Method.TestType | null;
     ...
     */
    static createBatch(objs: Array_Type<GenaiCore.Tool.C3Method.TestType>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.C3Method.TestType> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<GenaiCore.Tool.C3Method.TestType>, spec?: CreateBatchObjStreamSpec): ObjList<GenaiCore.Tool.C3Method.TestType> | null;
     ...
     */
    update(srcObj?: GenaiCore.Tool.C3Method.TestType, spec?: UpsertSpec): GenaiCore.Tool.C3Method.TestType | null;
     ...
     */
    upsert(srcObj?: GenaiCore.Tool.C3Method.TestType, spec?: UpsertSpec): GenaiCore.Tool.C3Method.TestType | null;
     ...
     */
    merge(spec?: MergeSpec): GenaiCore.Tool.C3Method.TestType | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): GenaiCore.Tool.C3Method.TestType | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): GenaiCore.Tool.C3Method.TestType | null;
     ...
     */
    static updateBatch(objs: Array_Type<GenaiCore.Tool.C3Method.TestType>, srcObjs?: Array_Type<GenaiCore.Tool.C3Method.TestType>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.C3Method.TestType> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<GenaiCore.Tool.C3Method.TestType> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.C3Method.TestType> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<GenaiCore.Tool.C3Method.TestType>, srcObjs?: Array_Type<GenaiCore.Tool.C3Method.TestType>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.C3Method.TestType> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<GenaiCore.Tool.C3Method.TestType> | null>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.C3Method.TestType> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<GenaiCore.Tool.C3Method.TestType>, spec?: TouchSpec): ObjList<GenaiCore.Tool.C3Method.TestType> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Tool.C3Method.TestType>, spec?: MergeSpec): ObjList<GenaiCore.Tool.C3Method.TestType> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<GenaiCore.Tool.C3Method.TestType>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Tool.C3Method.TestType> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<GenaiCore.Tool.C3Method.TestType> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<GenaiCore.Tool.C3Method.TestType> | null;
     ...
     */
    static mergeAll(mergeObj: GenaiCore.Tool.C3Method.TestType, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: GenaiCore.Tool.C3Method.TestType, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<GenaiCore.Tool.C3Method.TestType>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.C3Method.TestType> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<GenaiCore.Tool.C3Method.TestType>, spec?: UpsertSpec): ObjList<GenaiCore.Tool.C3Method.TestType> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): GenaiCore.Tool.C3Method.TestType | null;
     ...
     */
    static beforeCreate(objs: Array_Type<GenaiCore.Tool.C3Method.TestType>): ObjList<GenaiCore.Tool.C3Method.TestType>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<GenaiCore.Tool.C3Method.TestType>): ObjList<GenaiCore.Tool.C3Method.TestType>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<GenaiCore.Tool.C3Method.TestType>): ObjList<GenaiCore.Tool.C3Method.TestType>;
     ...
     */
    static afterCreate(objs: Array_Type<GenaiCore.Tool.C3Method.TestType>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<GenaiCore.Tool.C3Method.TestType>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<GenaiCore.Tool.C3Method.TestType>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<GenaiCore.Tool.C3Method.TestType>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<GenaiCore.Tool.C3Method.TestType>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): GenaiCore.Tool.C3Method.TestType | null;
     ...
     */
    withoutIdentity(): GenaiCore.Tool.C3Method.TestType | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<GenaiCore.Tool.C3Method.TestType>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: GenaiCore.Tool.C3Method.TestType, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<GenaiCore.Tool.C3Method.TestType>, callback?: λFunction<GenaiCore.Tool.C3Method.TestType | null, GenaiCore.Tool.C3Method.TestType | null>): ObjList<GenaiCore.Tool.C3Method.TestType>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<GenaiCore.Tool.C3Method.TestType>, callback?: λFunction<GenaiCore.Tool.C3Method.TestType | null, GenaiCore.Tool.C3Method.TestType | null>): Array_Type<ObjError> | null;
     ...
     * @return A double
     */
    static validMethod(s: string, i: number, d?: DateTime): number;
     ...
     *          A float
     */
    static validMethod(f?: number): void;
     ...
     * @return A string
     */
    static validMethod(f?: number, b?: boolean, s?: string = '"foo"'): string | null;
     ...
     * @return a string
     */
    static validMethodOneOverload(b?: boolean, i?: number = '42'): string;
     ...
     */
    static validMethodJson(in_?: any): any;
     ...
     * @return a set
     */
    static validMethodCollections(m?: Map_Type<string, number>, a?: Array_Type<number>): Set_Type<number>;
     ...
     */
    static validMethodSimpleReference(i?: number, o?: GenaiCore.Tool.C3Method.TestType.Simple): Array_Type<GenaiCore.Tool.C3Method.TestType.Simple>;
     ...
     */
    static invalidMethodComplexReference(i?: number, o?: GenaiCore.Tool.C3Method.TestType.Complex): Array_Type<string>;
     ...
     *          A test type.
     */
    static invalidMethod(s: string, t: GenaiCore.PgVectorTestType): void;
     ...
     * @return A FetchSpec
     */
    static invalidMethod(m?: Map_Type<string, GenaiCore.Tool.C3Method.TestType>, b?: boolean): FetchSpec;
     ...
     * @return A string
     */
    static invalidMethod(ts?: Array_Type<GenaiCore.Tool.C3Method.TestType>): string;

    static noDocsMethod(s: string, i: number, d?: DateTime): number;

    /**
     * A test method that has no parameters documented
     */
    static noParamsDocMethod(s: string, i: number, d?: DateTime): number;
     ...
     *        A datetime.
     */
    static notAllParamsDocMethod(s: string, i: number, d?: DateTime): number;
     ...
     */
    static calculate(input: GenaiCore.Tool.C3Method.TestType.CalculateInput): GenaiCore.Tool.C3Method.TestType.CalculateOutput;
     ...
     * @return the instance
     */
    static forName(name: string): GenaiCore.Tool.C3Method.TestType;
