// TypeScript definitions for the C3 type GenaiCore.Llm.Auth.Secret
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of GenaiCore.Llm.Auth.Secret
 */
declare namespace GenaiCore.Llm.Auth {
 ...
 */
declare namespace GenaiCore.Llm.Auth {
  export class Secret extends Obj  {

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): GenaiCore.Llm.Auth.Secret;

    readonly configOverride?: string;
    withConfigOverride(configOverride: string | null): GenaiCore.Llm.Auth.Secret;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): GenaiCore.Llm.Auth.Secret;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: Array_Type<string>;
    withIssues(issues: Array_Type<string> | Array<string> | null): GenaiCore.Llm.Auth.Secret;

    /**
     * The secret value
     */
    readonly authSecret: any;
    withAuthSecret(authSecret: any): GenaiCore.Llm.Auth.Secret;
     ...
     * @see #toJson
     */
    static fromJson(json: any): GenaiCore.Llm.Auth.Secret | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): GenaiCore.Llm.Auth.Secret | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): GenaiCore.Llm.Auth.Secret | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): GenaiCore.Llm.Auth.Secret | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenaiCore.Llm.Auth.Secret;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Llm.Auth.Secret;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenaiCore.Llm.Auth.Secret;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Llm.Auth.Secret>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenaiCore.Llm.Auth.Secret>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenaiCore.Llm.Auth.Secret;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Llm.Auth.Secret;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenaiCore.Llm.Auth.Secret;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenaiCore.Llm.Auth.Secret;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenaiCore.Llm.Auth.Secret;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenaiCore.Llm.Auth.Secret;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenaiCore.Llm.Auth.Secret;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenaiCore.Llm.Auth.Secret;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenaiCore.Llm.Auth.Secret;
     ...
     * @see #removeField
     */
    withoutField(field: string): GenaiCore.Llm.Auth.Secret;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): GenaiCore.Llm.Auth.Secret;
     ...
     */
    withoutFields(fields: Array_Type<string>): GenaiCore.Llm.Auth.Secret;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): GenaiCore.Llm.Auth.Secret;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenaiCore.Llm.Auth.Secret;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenaiCore.Llm.Auth.Secret;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenaiCore.Llm.Auth.Secret;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenaiCore.Llm.Auth.Secret;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenaiCore.Llm.Auth.Secret;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenaiCore.Llm.Auth.Secret;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenaiCore.Llm.Auth.Secret;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenaiCore.Llm.Auth.Secret;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenaiCore.Llm.Auth.Secret;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): GenaiCore.Llm.Auth.Secret;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenaiCore.Llm.Auth.Secret;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenaiCore.Llm.Auth.Secret;

    mergeJson(json: any): GenaiCore.Llm.Auth.Secret;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenaiCore.Llm.Auth.Secret;
     ...
     */
    sumObj(other: Obj, deep?: boolean): GenaiCore.Llm.Auth.Secret;
     ...
     */
    singletonArray(): Array_Type<GenaiCore.Llm.Auth.Secret>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<GenaiCore.Llm.Auth.Secret> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenaiCore.Llm.Auth.Secret> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<GenaiCore.Llm.Auth.Secret>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenaiCore.Llm.Auth.Secret> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, GenaiCore.Llm.Auth.Secret> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenaiCore.Llm.Auth.Secret> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenaiCore.Llm.Auth.Secret>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenaiCore.Llm.Auth.Secret>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenaiCore.Llm.Auth.Secret;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenaiCore.Llm.Auth.Secret;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenaiCore.Llm.Auth.Secret;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenaiCore.Llm.Auth.Secret;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenaiCore.Llm.Auth.Secret;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenaiCore.Llm.Auth.Secret;
     ...
     * @see #fromString
     */
    static make(s: string): GenaiCore.Llm.Auth.Secret | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenaiCore.Llm.Auth.Secret;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenaiCore.Llm.Auth.Secret;
     ...
     */
    static cachedEmptyInst(): GenaiCore.Llm.Auth.Secret;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<GenaiCore.Llm.Auth.Secret> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): GenaiCore.Llm.Auth.Secret;
     ...
     * @see #toString
     */
    static fromString(s: string): GenaiCore.Llm.Auth.Secret | null;
     ...
     */
    static forName(name: string, failIfMissing?: boolean): GenaiCore.Llm.Auth.Secret | null;
     ...
     */
    static allCached(): Stream<GenaiCore.Llm.Auth.Secret> | null;
     ...
     */
    static find(filter?: string): Stream<GenaiCore.Llm.Auth.Secret> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<GenaiCore.Llm.Auth.Secret> | null;

    /**
     * @return cached instance.
     */
    getCached(): GenaiCore.Llm.Auth.Secret | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): GenaiCore.Llm.Auth.Secret | null;
     ...
     */
    static produce(key: string): GenaiCore.Llm.Auth.Secret | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, GenaiCore.Llm.Auth.Secret> | null;
     ...
     */
    getConfig(): GenaiCore.Llm.Auth.Secret;
     ...
     */
    getSecret(): GenaiCore.Llm.Auth.Secret;
     ...
     */
    withConfigKey(configKey: string): GenaiCore.Llm.Auth.Secret;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): GenaiCore.Llm.Auth.Secret;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): GenaiCore.Llm.Auth.Secret | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<GenaiCore.Llm.Auth.Secret> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: GenaiCore.Llm.Auth.Secret, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): GenaiCore.Llm.Auth.Secret | null;
     ...
     */
    static forAuthConfig(cfg: GenaiCore.Llm.Auth): GenaiCore.Llm.Auth.Secret;
     ...
     */
    static getSecretValueForConfig(cfg: GenaiCore.Llm.Auth): any;
     ...
     */
    static setSecretValueForConfig(cfg: GenaiCore.Llm.Auth, override?: string): void;
     ...
     */
    static clearSecretValueForConfig(cfg: GenaiCore.Llm.Auth, override?: string): void;
     ...
     *          concrete auth instance to clear.
     */
    static clearSecretValueForConfigAllOverrides(cfg: GenaiCore.Llm.Auth): void;
     ...
     */
    static clearAllConfigAndSecretOverridesForAuthType(authType: Type, override: string, confirm?: boolean): void;
  }
}
