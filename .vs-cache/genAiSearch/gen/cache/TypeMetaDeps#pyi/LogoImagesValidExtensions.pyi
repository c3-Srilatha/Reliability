...
# Python definitions for the C3 type LogoImagesValidExtensions


class LogoImagesValidExtensions():
    """
    ...
    WEBP
    """
    def __init__(self, SVG: Optional[str]=None, JPG: Optional[str]=None, JPEG: Optional[str]=None, PNG: Optional[str]=None, WEBP: Optional[str]=None) -> None: ...
