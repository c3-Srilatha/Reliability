...
# Python definitions for the C3 type Genai.App.UserPreference
...
class UserPreference(Config, UserSingleton):
    ...
    onboardingModal: Optional[str]
    """
    Whether to skip showing the onboarding modal on load.
    """
    def __init__(self, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, onboardingModal: Optional[str]=None) -> None: ...
