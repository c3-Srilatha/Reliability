...
# Python definitions for the C3 type GenAiUiConfig


class GenAiUiConfig(Config, Singleton):
    """
    ...
    queryHistoryVisibility: Optional[str]
    """
    ...
    queryToolSelectorVisibility: Optional[str]
    """
    ...
    queryToolSelectorDefaultOption: Optional[str]
    """
    ...
    searchFilterBarVisibility: Optional[str]
    """
    ...
    interactiveVisualizationLoadingOffset: Optional[str]=None
    """
    ...
    interactiveVisualizationMinHeight: Optional[str]
    """
    ...
    appDataModelSyncStrategy: Optional[str]
    """
    ...
    suggestedFollowUpQueriesVisibility: Optional[str]
    """
    ...
    suggestedFollowUpQueryDefaultTool: Optional[str]
    """
    ...
    visualizationXAxisLabelStrategy: Optional[str]
    """
    ...
    visualizationXAxisLabelTruncation: Optional[bool]
    """
    Determines whether or not to use truncation on the labels of the X axis on {@link GenAiUiChart}.
    """

    visualizationXAxisLabelMaxWidth: Optional[int]=None
    """
    ...
    feedResultsLoadingOffset: Optional[str]
    """
    ...
    feedResultsMinHeight: Optional[str]
    """
    ...
    feedMaxResultsInState: Optional[int]
    """
    ...
    showExecuteSummaryStep: Optional[bool]
    """
    ...
    """
    def __init__(self, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, appDisplayName: Optional[str]=None, bannerTitle: Optional[str]=None, bannerSubTitle: Optional[str]=None, rationaleVisibility: Optional[str]=None, lazyLoadResults: Optional[bool]=None, queryHistoryVisibility: Optional[str]=None, queryToolSelectorVisibility: Optional[str]=None, queryToolSelectorDefaultOption: Optional[str]=None, searchFilterBarVisibility: Optional[str]=None, scoreVisibility: Optional[str]=None, tagsVisibility: Optional[str]=None, tagsPageVisibility: Optional[str]=None, llmPageVisibility: Optional[str]=None, multiToolResponseVisibility: Optional[str]=None, hideChatBox: Optional[bool]=None, suppressedFileTypes: Optional[Array[str]]=None, allowedVisualizationModes: Optional[Array[str]]=None, allowMultipleToolSelection: Optional[bool]=None, contactSalesUrl: Optional[str]=None, contactCustomerSupportUrl: Optional[str]=None, generalTutorialVisibility: Optional[str]=None, generalOnboardingVideoUrl: Optional[str]=None, interactiveVisualizationDoNotLazyLoad: Optional[bool]=None, interactiveVisualizationLoadingOffset: Optional[str]=None, interactiveVisualizationMinHeight: Optional[str]=None, appDataModelSyncStrategy: Optional[str]=None, suggestedFollowUpQueriesVisibility: Optional[str]=None, suggestedFollowUpQueryDefaultTool: Optional[str]=None, visualizationXAxisLabelStrategy: Optional[str]=None, visualizationXAxisLabelTruncation: Optional[bool]=None, visualizationXAxisLabelMaxWidth: Optional[int]=None, visualizationGridPageSizes: Optional[Array[int]]=None, attributionVisibility: Optional[str]=None, viewMode: Optional[str]=None, showPlanners: Optional[bool]=None, renderStringOutputWithMarkdown: Optional[bool]=None, removeCitationsFromCopiedAnswer: Optional[bool]=None, anchorTarget: Optional[str]=None, themeToggleVisibility: Optional[str]=None, seededQueriesLimit: Optional[int]=None, seededQueriesCategory: Optional[str]=None, helpButtonVisibility: Optional[str]=None, helpGuideUrl: Optional[str]=None, feedResultsDoNotLazyLoad: Optional[bool]=None, feedResultsLoadingOffset: Optional[str]=None, feedResultsMinHeight: Optional[str]=None, feedMaxResultsInState: Optional[int]=None, showExecuteSummaryStep: Optional[bool]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[GenAiUiConfig]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[GenAiUiConfig]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[GenAiUiConfig]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[GenAiUiConfig]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> GenAiUiConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> GenAiUiConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> GenAiUiConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[GenAiUiConfig]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[GenAiUiConfig]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> GenAiUiConfig:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> GenAiUiConfig:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> GenAiUiConfig:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> GenAiUiConfig:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> GenAiUiConfig:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> GenAiUiConfig:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> GenAiUiConfig:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> GenAiUiConfig:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> GenAiUiConfig:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> GenAiUiConfig:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> GenAiUiConfig:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> GenAiUiConfig:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> GenAiUiConfig:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> GenAiUiConfig:
    """
    @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> GenAiUiConfig:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> GenAiUiConfig:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> GenAiUiConfig:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> GenAiUiConfig:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> GenAiUiConfig:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> GenAiUiConfig:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> GenAiUiConfig:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> GenAiUiConfig:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> GenAiUiConfig:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> GenAiUiConfig:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> GenAiUiConfig:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> GenAiUiConfig:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> GenAiUiConfig:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> GenAiUiConfig:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[GenAiUiConfig]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[GenAiUiConfig]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[GenAiUiConfig]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[GenAiUiConfig]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[GenAiUiConfig]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, GenAiUiConfig]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, GenAiUiConfig]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[GenAiUiConfig]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[GenAiUiConfig]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> GenAiUiConfig:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> GenAiUiConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> GenAiUiConfig:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> GenAiUiConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> GenAiUiConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> GenAiUiConfig:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> GenAiUiConfig:
    """
    ...
    """
        ...
    def afterMake(self) -> GenAiUiConfig:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> GenAiUiConfig:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[GenAiUiConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> GenAiUiConfig:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls) -> Union[Stream[GenAiUiConfig]]:
    """
    @return stream of all available Cached instances.
    """
        ...
    @classmethod
    def find(cls, filter: str=None) -> Union[Stream[GenAiUiConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any) -> Union[Stream[GenAiUiConfig]]:
    """
    @return existing instances of this type that satisfy filter from data cache. Will call `produceAll`
            if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
            Otherwise no population will be performed.
    """
        ...
    def getCached(self) -> Union[GenAiUiConfig]:
    """
    @return cached instance.
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[GenAiUiConfig]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[GenAiUiConfig]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, GenAiUiConfig]]:
    """
    ...
    """
        ...
    def getConfig(self) -> GenAiUiConfig:
    """
    ...
    """
        ...
    def getSecret(self) -> GenAiUiConfig:
    """
    ...
    """
        ...
    def withConfigKey(self, configKey: str) -> GenAiUiConfig:
    """
    ...
    """
        ...
    def withoutConfigKey(self) -> GenAiUiConfig:
    """
    @return copy without config key.
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[GenAiUiConfig]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[GenAiUiConfig]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: GenAiUiConfig, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[GenAiUiConfig]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[GenAiUiConfig]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[GenAiUiConfig]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> GenAiUiConfig:
    """
    ...
    """
        ...
    def getAttributionVisibility(self) -> str:
    """
