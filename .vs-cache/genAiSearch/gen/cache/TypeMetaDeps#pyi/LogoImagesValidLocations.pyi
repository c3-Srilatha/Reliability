...
# Python definitions for the C3 type LogoImagesValidLocations


class LogoImagesValidLocations():
    """
    ...
    """
    def __init__(self, CHAT: Optional[str]=None, HOME: Optional[str]=None, MENU: Optional[str]=None, ALL: Optional[str]=None) -> None: ...
