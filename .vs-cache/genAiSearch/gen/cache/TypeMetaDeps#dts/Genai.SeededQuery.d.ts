// TypeScript definitions for the C3 type Genai.SeededQuery
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.SeededQuery
 */
declare namespace Genai {
  export interface ISeededQuery {
 ...
 */
declare namespace Genai {
  export class SeededQuery extends Obj  {
    ...
    withRawQuery(rawQuery: string | null): Genai.SeededQuery;
    ...
    withBaseQuery(baseQuery: string | null): Genai.SeededQuery;
    ...
    withStandaloneQuery(standaloneQuery: string | null): Genai.SeededQuery;
    ...
    withNonTranslatedQuery(nonTranslatedQuery: string | null): Genai.SeededQuery;
    ...
    withDetectedLanguage(detectedLanguage: string | null): Genai.SeededQuery;
    ...
    withFilters(filters: Map_Type<string, Array_Type<Genai.Query.SourceFilter>> | {[key: string]: Array_Type<Genai.Query.SourceFilter> | Array<IGenai.Query.SourceFilter>} | null): Genai.SeededQuery;
    ...
    withOverrideFilterFromParent(overrideFilterFromParent: boolean): Genai.SeededQuery;
    ...
    withQueryType(queryType: string): Genai.SeededQuery;
    ...
    withTargetTool(targetTool: string | null): Genai.SeededQuery;
    ...
    withToolsOverride(toolsOverride: Array_Type<string> | Array<string> | null): Genai.SeededQuery;

    /**
     * The {@link Genai.Agent.Planner} that should be used to generate and execute the plan.
     */
    readonly planner?: Genai.Agent.Planner;
    withPlanner(planner: IGenai.Agent.Planner | null): Genai.SeededQuery;

    /**
     * The set of parameters that should be used to answer the query.
     */
    readonly executeSpec?: Genai.Query.ExecuteSpec;
    withExecuteSpec(executeSpec: IGenai.Query.ExecuteSpec | null): Genai.SeededQuery;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.SeededQuery;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.SeededQuery;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.SeededQuery;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.SeededQuery;
    ...
    withVersion(version: number | null): Genai.SeededQuery;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.SeededQuery;
    ...
    withCategory(category: string | null): Genai.SeededQuery;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.SeededQuery | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.SeededQuery | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.SeededQuery | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.SeededQuery | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.SeededQuery;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SeededQuery;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.SeededQuery;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SeededQuery>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.SeededQuery>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.SeededQuery;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SeededQuery;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.SeededQuery;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.SeededQuery;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.SeededQuery;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.SeededQuery;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.SeededQuery;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.SeededQuery;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.SeededQuery;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.SeededQuery;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.SeededQuery;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.SeededQuery;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.SeededQuery;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.SeededQuery;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.SeededQuery;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.SeededQuery;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.SeededQuery;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.SeededQuery;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.SeededQuery;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.SeededQuery;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.SeededQuery;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.SeededQuery;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.SeededQuery;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.SeededQuery;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.SeededQuery;

    mergeJson(json: any): Genai.SeededQuery;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.SeededQuery;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.SeededQuery;
     ...
     */
    singletonArray(): Array_Type<Genai.SeededQuery>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.SeededQuery> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.SeededQuery> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.SeededQuery>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.SeededQuery> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.SeededQuery> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.SeededQuery> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.SeededQuery>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.SeededQuery>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.SeededQuery;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.SeededQuery;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.SeededQuery;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.SeededQuery;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.SeededQuery;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.SeededQuery;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.SeededQuery | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.SeededQuery;
     ...
     */
    static cachedEmptyInst(): Genai.SeededQuery;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.SeededQuery> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.SeededQuery;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.SeededQuery | null;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.SeededQuery>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.SeededQuery>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.SeededQuery> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.SeededQuery>> | null;
     ...
     */
    get(include?: string): Genai.SeededQuery | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.SeededQuery | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.SeededQuery;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.SeededQuery | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.SeededQuery;
     ...
     */
    create(spec?: UpsertSpec): Genai.SeededQuery | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.SeededQuery>, spec?: UpsertSpec): ObjList<Genai.SeededQuery> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.SeededQuery>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.SeededQuery> | null;
     ...
     */
    update(srcObj?: Genai.SeededQuery, spec?: UpsertSpec): Genai.SeededQuery | null;
     ...
     */
    upsert(srcObj?: Genai.SeededQuery, spec?: UpsertSpec): Genai.SeededQuery | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.SeededQuery | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.SeededQuery | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.SeededQuery | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.SeededQuery>, srcObjs?: Array_Type<Genai.SeededQuery>, spec?: UpsertSpec): ObjList<Genai.SeededQuery> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.SeededQuery> | null>, spec?: UpsertSpec): ObjList<Genai.SeededQuery> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.SeededQuery>, srcObjs?: Array_Type<Genai.SeededQuery>, spec?: UpsertSpec): ObjList<Genai.SeededQuery> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.SeededQuery> | null>, spec?: UpsertSpec): ObjList<Genai.SeededQuery> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.SeededQuery>, spec?: TouchSpec): ObjList<Genai.SeededQuery> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.SeededQuery>, spec?: MergeSpec): ObjList<Genai.SeededQuery> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.SeededQuery>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.SeededQuery> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.SeededQuery> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.SeededQuery> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.SeededQuery, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.SeededQuery, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.SeededQuery>, spec?: UpsertSpec): ObjList<Genai.SeededQuery> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.SeededQuery>, spec?: UpsertSpec): ObjList<Genai.SeededQuery> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.SeededQuery | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.SeededQuery>): ObjList<Genai.SeededQuery>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.SeededQuery>): ObjList<Genai.SeededQuery>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.SeededQuery>): ObjList<Genai.SeededQuery>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.SeededQuery>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.SeededQuery>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.SeededQuery>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.SeededQuery>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.SeededQuery>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.SeededQuery | null;
     ...
     */
    withoutIdentity(): Genai.SeededQuery | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.SeededQuery>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.SeededQuery, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.SeededQuery>, callback?: λFunction<Genai.SeededQuery | null, Genai.SeededQuery | null>): ObjList<Genai.SeededQuery>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.SeededQuery>, callback?: λFunction<Genai.SeededQuery | null, Genai.SeededQuery | null>): Array_Type<ObjError> | null;
