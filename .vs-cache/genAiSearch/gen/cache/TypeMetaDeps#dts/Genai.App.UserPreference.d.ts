// TypeScript definitions for the C3 type Genai.App.UserPreference

/**
 * Specifies user preferences for the Genai app.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.App.UserPreference
 */
declare namespace Genai.App {
  export interface IUserPreference {
    ...
    /**
     * Whether to skip showing the onboarding modal on load.
     */
 ...
 */
declare namespace Genai.App {
  export class UserPreference extends Obj  {

    readonly configOverride?: string;
    withConfigOverride(configOverride: string | null): Genai.App.UserPreference;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.App.UserPreference;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.App.UserPreference;
     ...
     * Whether to skip showing the onboarding modal on load.
     */
    readonly onboardingModal: string;
    withOnboardingModal(onboardingModal: string): Genai.App.UserPreference;

    /**
     * Whether to skip showing the onboarding modal on load.
     */
    static readonly onboardingModal: string;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.App.UserPreference | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.App.UserPreference | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.App.UserPreference | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.App.UserPreference | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.App.UserPreference;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Genai.App.UserPreference;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.App.UserPreference;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.App.UserPreference;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.App.UserPreference;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.App.UserPreference;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.App.UserPreference>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.App.UserPreference>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.App.UserPreference>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.App.UserPreference>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.App.UserPreference;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.App.UserPreference;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.App.UserPreference;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.App.UserPreference;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.App.UserPreference;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.App.UserPreference;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.App.UserPreference;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Genai.App.UserPreference;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.App.UserPreference;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Genai.App.UserPreference;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.App.UserPreference;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.App.UserPreference;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.App.UserPreference;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.App.UserPreference;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.App.UserPreference;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.App.UserPreference;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.App.UserPreference;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Genai.App.UserPreference;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.App.UserPreference;
     ...
     * @see #removeField
     */
    static withoutField(field: string): Genai.App.UserPreference;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.App.UserPreference;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): Genai.App.UserPreference;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.App.UserPreference;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): Genai.App.UserPreference;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.App.UserPreference;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): Genai.App.UserPreference;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.App.UserPreference;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Genai.App.UserPreference;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.App.UserPreference;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.App.UserPreference;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.App.UserPreference;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Genai.App.UserPreference;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.App.UserPreference;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Genai.App.UserPreference;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.App.UserPreference;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Genai.App.UserPreference;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.App.UserPreference;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Genai.App.UserPreference;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.App.UserPreference;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Genai.App.UserPreference;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.App.UserPreference;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Genai.App.UserPreference;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.App.UserPreference;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.App.UserPreference;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.App.UserPreference;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): Genai.App.UserPreference;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.App.UserPreference;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.App.UserPreference;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.App.UserPreference;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.App.UserPreference;

    mergeJson(json: any): Genai.App.UserPreference;

    static mergeJson(json: any): Genai.App.UserPreference;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.App.UserPreference;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.App.UserPreference;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.App.UserPreference;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): Genai.App.UserPreference;
     ...
     */
    singletonArray(): Array_Type<Genai.App.UserPreference>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<Genai.App.UserPreference>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.App.UserPreference> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.App.UserPreference> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.App.UserPreference>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<Genai.App.UserPreference>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.App.UserPreference> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.App.UserPreference> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.App.UserPreference> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.App.UserPreference>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Genai.App.UserPreference>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.App.UserPreference>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.App.UserPreference;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.App.UserPreference;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.App.UserPreference;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.App.UserPreference;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.App.UserPreference;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.App.UserPreference;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.App.UserPreference;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.App.UserPreference;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Genai.App.UserPreference;
     ...
     */
    static cachedEmptyInst(): Genai.App.UserPreference;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.App.UserPreference> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.App.UserPreference;
     ...
     */
    static allCached(): Stream<Genai.App.UserPreference> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.App.UserPreference> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.App.UserPreference> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.App.UserPreference | null;

    /**
     * @return cached instance.
     */
    static getCached(): Genai.App.UserPreference | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.App.UserPreference | null;
     ...
     */
    static produce(key: string): Genai.App.UserPreference | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.App.UserPreference> | null;
     ...
     */
    getConfig(): Genai.App.UserPreference;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): Genai.App.UserPreference;
     ...
     */
    getSecret(): Genai.App.UserPreference;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): Genai.App.UserPreference;
     ...
     */
    withConfigKey(configKey: string): Genai.App.UserPreference;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): Genai.App.UserPreference;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.App.UserPreference;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): Genai.App.UserPreference;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.App.UserPreference | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.App.UserPreference> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.App.UserPreference, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: Genai.App.UserPreference, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.App.UserPreference | null;
     ...
     */
    removeSecrets(): Genai.App.UserPreference | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): Genai.App.UserPreference | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.App.UserPreference | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): Genai.App.UserPreference | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.App.UserPreference;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): Genai.App.UserPreference;
     ...
     */
    static inst(): Genai.App.UserPreference;
     ...
     */
    static setPreference(preferenceKey: string, preferenceValue: any): Genai.App.UserPreference;
  }
}
