// TypeScript definitions for the C3 type Genai.Query.ChatMessage

/**
 * A specific message inside a chat that a user sent to the generative model.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Query.ChatMessage
 */
declare namespace Genai.Query {
  export interface IChatMessage {
    ...
    /**
     * The original query that the user made and then had a follow-up chat on.
     */
    parentAiResult: IGenai.Query.Result;

    /**
     * The message sent by the user to the generative model.
     */
    message: string;

    /**
     * The time the message was sent in the UI.
     */
    sentTime: DateTime | Date | string;

    /**
     * {@link User} who sent the message.
     */
    user: IUser;

    /**
     * The {@link Genai.Query.Result} response from the model.
     */
    responseAiResult: IGenai.Query.Result;

    /**
     * Result from calling {@link Genai.Query.Result#getForUi}.
     */
 ...
 * A specific message inside a chat that a user sent to the generative model.
 *
 * @remarks this represents a made instance of Genai.Query.ChatMessage
 */
declare namespace Genai.Query {
  export class ChatMessage extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Query.ChatMessage;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Query.ChatMessage;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Query.ChatMessage;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Query.ChatMessage;
    ...
    withVersion(version: number | null): Genai.Query.ChatMessage;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Query.ChatMessage;

    /**
     * The original query that the user made and then had a follow-up chat on.
     */
    readonly parentAiResult: Genai.Query.Result;
    withParentAiResult(parentAiResult: IGenai.Query.Result): Genai.Query.ChatMessage;

    /**
     * The message sent by the user to the generative model.
     */
    readonly message: string;
    withMessage(message: string): Genai.Query.ChatMessage;

    /**
     * The time the message was sent in the UI.
     */
    readonly sentTime: DateTime;
    withSentTime(sentTime: DateTime | Date | string): Genai.Query.ChatMessage;

    /**
     * {@link User} who sent the message.
     */
    readonly user: User;
    withUser(user: IUser): Genai.Query.ChatMessage;

    /**
     * The {@link Genai.Query.Result} response from the model.
     */
    readonly responseAiResult: Genai.Query.Result;
    withResponseAiResult(responseAiResult: IGenai.Query.Result): Genai.Query.ChatMessage;

    /**
     * Result from calling {@link Genai.Query.Result#getForUi}.
     */
    readonly getForUiResult?: Genai.Query.Result.GetForUiResult;
    withGetForUiResult(getForUiResult: IGenai.Query.Result.GetForUiResult | null): Genai.Query.ChatMessage;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Query.ChatMessage | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Query.ChatMessage | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Query.ChatMessage | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Query.ChatMessage | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Query.ChatMessage;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Query.ChatMessage;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Query.ChatMessage;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Query.ChatMessage>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Query.ChatMessage>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Query.ChatMessage;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Query.ChatMessage;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Query.ChatMessage;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Query.ChatMessage;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Query.ChatMessage;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Query.ChatMessage;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Query.ChatMessage;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Query.ChatMessage;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Query.ChatMessage;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Query.ChatMessage;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Query.ChatMessage;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Query.ChatMessage;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Query.ChatMessage;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Query.ChatMessage;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Query.ChatMessage;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Query.ChatMessage;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Query.ChatMessage;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Query.ChatMessage;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Query.ChatMessage;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Query.ChatMessage;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Query.ChatMessage;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Query.ChatMessage;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Query.ChatMessage;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Query.ChatMessage;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Query.ChatMessage;

    mergeJson(json: any): Genai.Query.ChatMessage;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Query.ChatMessage;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Query.ChatMessage;
     ...
     */
    singletonArray(): Array_Type<Genai.Query.ChatMessage>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Query.ChatMessage> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Query.ChatMessage> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Query.ChatMessage>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Query.ChatMessage> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Query.ChatMessage> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Query.ChatMessage> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Query.ChatMessage>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Query.ChatMessage>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Query.ChatMessage;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Query.ChatMessage;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Query.ChatMessage;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Query.ChatMessage;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Query.ChatMessage;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Query.ChatMessage;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Query.ChatMessage | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Query.ChatMessage;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Query.ChatMessage;
     ...
     */
    static cachedEmptyInst(): Genai.Query.ChatMessage;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Query.ChatMessage> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Query.ChatMessage;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Query.ChatMessage>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Query.ChatMessage>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Query.ChatMessage> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Query.ChatMessage>> | null;
     ...
     */
    get(include?: string): Genai.Query.ChatMessage | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Query.ChatMessage | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Query.ChatMessage;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Query.ChatMessage | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Query.ChatMessage;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Query.ChatMessage | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Query.ChatMessage | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Query.ChatMessage>, spec?: UpsertSpec): ObjList<Genai.Query.ChatMessage> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Query.ChatMessage>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Query.ChatMessage> | null;
     ...
     */
    update(srcObj?: Genai.Query.ChatMessage, spec?: UpsertSpec): Genai.Query.ChatMessage | null;
     ...
     */
    upsert(srcObj?: Genai.Query.ChatMessage, spec?: UpsertSpec): Genai.Query.ChatMessage | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Query.ChatMessage | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Query.ChatMessage | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Query.ChatMessage | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Query.ChatMessage>, srcObjs?: Array_Type<Genai.Query.ChatMessage>, spec?: UpsertSpec): ObjList<Genai.Query.ChatMessage> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Query.ChatMessage> | null>, spec?: UpsertSpec): ObjList<Genai.Query.ChatMessage> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Query.ChatMessage>, srcObjs?: Array_Type<Genai.Query.ChatMessage>, spec?: UpsertSpec): ObjList<Genai.Query.ChatMessage> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Query.ChatMessage> | null>, spec?: UpsertSpec): ObjList<Genai.Query.ChatMessage> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Query.ChatMessage>, spec?: TouchSpec): ObjList<Genai.Query.ChatMessage> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Query.ChatMessage>, spec?: MergeSpec): ObjList<Genai.Query.ChatMessage> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Query.ChatMessage>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Query.ChatMessage> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Query.ChatMessage> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Query.ChatMessage> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Query.ChatMessage, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Query.ChatMessage, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Query.ChatMessage>, spec?: UpsertSpec): ObjList<Genai.Query.ChatMessage> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Query.ChatMessage>, spec?: UpsertSpec): ObjList<Genai.Query.ChatMessage> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Query.ChatMessage | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Query.ChatMessage>): ObjList<Genai.Query.ChatMessage>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Query.ChatMessage>): ObjList<Genai.Query.ChatMessage>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Query.ChatMessage>): ObjList<Genai.Query.ChatMessage>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Query.ChatMessage>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Query.ChatMessage>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Query.ChatMessage>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Query.ChatMessage>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Query.ChatMessage>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Query.ChatMessage | null;
     ...
     */
    withoutIdentity(): Genai.Query.ChatMessage | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Query.ChatMessage>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Query.ChatMessage, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Query.ChatMessage>, callback?: λFunction<Genai.Query.ChatMessage | null, Genai.Query.ChatMessage | null>): ObjList<Genai.Query.ChatMessage>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Query.ChatMessage>, callback?: λFunction<Genai.Query.ChatMessage | null, Genai.Query.ChatMessage | null>): Array_Type<ObjError> | null;
