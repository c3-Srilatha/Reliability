// TypeScript definitions for the C3 type Genai.OnboardingGuide

/**
 * An onboarding document for the Enterprise Search application.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.OnboardingGuide
 */
declare namespace Genai {
  export interface IOnboardingGuide {
    ...
    /**
     * Configuration of the onboarding guide to be used in the list of onboarding guides
     */
    menuPreview: any;
    ...
    /**
     * An optional list of roles that should _not_ be able to click a guide in the onboarding modal to view more details.
     * By default, if left empty or null, _all_ roles will be able to click a guide to view more details. For roles in
     * this list, the guide subtitle will be replaced with a link to reach out to admins to request access.
     */
    readOnlyGuideRoles?: Array_Type<string> | Array<string>;

    /**
     * Whether the guide should be appear in the UI
     */
    enabled: boolean;

    /**
     * Index used for sorting the onboarding guides in the UI
     */
    displayIndex?: number;

    /**
     * Id of the Pendo guide that will be triggered from a {@link GenAiUiPendoGuideButton} in the onboarding guide
     * when the user is in a non-tutorial {@link Genai.Project}.
     * No button will be rendered in the default {@link Genai.Project} if this field is not defined.
     */
    pendoGuideId?: string;

    /**
     * Id of the Pendo guide that will be triggered from a {@link GenAiUiPendoGuideButton} in the onboarding guide
     * when the user is in a tutorial {@link Genai.Project}.
     * No button will be rendered in the tutorial {@link Genai.Project} if this field is not defined.
     */
    tutorialModePendoGuideId?: string;

    /**
     * {@link UiSdlRoute} of the feature described by the onboarding guide. The button to "Start Tutorial" will redirect to this route
     * and trigger the onboarding guide defined in #pendoGuideId
     */
    targetPage?: string;

    /**
     * If defined, a link to this video will be displayed in the UI, which will open the video in a new tab
     */
 ...
 * An onboarding document for the Enterprise Search application.
 *
 * @remarks this represents a made instance of Genai.OnboardingGuide
 */
declare namespace Genai {
  export class OnboardingGuide extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Genai.OnboardingGuide;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.OnboardingGuide;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.OnboardingGuide;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.OnboardingGuide;
    ...
    withVersion(version: number | null): Genai.OnboardingGuide;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.OnboardingGuide;

    /**
     * Configuration of the onboarding guide to be used in the list of onboarding guides
     */
    readonly menuPreview: any;
    withMenuPreview(menuPreview: any): Genai.OnboardingGuide;

    /**
     * Onboarding guide content
     */
    readonly guide: any;
    withGuide(guide: any): Genai.OnboardingGuide;
     ...
     * this list, the guide subtitle will be replaced with a link to reach out to admins to request access.
     */
    readonly readOnlyGuideRoles?: Array_Type<string>;
    withReadOnlyGuideRoles(readOnlyGuideRoles: Array_Type<string> | Array<string> | null): Genai.OnboardingGuide;

    /**
     * Whether the guide should be appear in the UI
     */
    readonly enabled: boolean;
    withEnabled(enabled: boolean): Genai.OnboardingGuide;

    /**
     * Index used for sorting the onboarding guides in the UI
     */
    readonly displayIndex?: number;
    withDisplayIndex(displayIndex: number | null): Genai.OnboardingGuide;
     ...
     * No button will be rendered in the default {@link Genai.Project} if this field is not defined.
     */
    readonly pendoGuideId?: string;
    withPendoGuideId(pendoGuideId: string | null): Genai.OnboardingGuide;
     ...
     * No button will be rendered in the tutorial {@link Genai.Project} if this field is not defined.
     */
    readonly tutorialModePendoGuideId?: string;
    withTutorialModePendoGuideId(tutorialModePendoGuideId: string | null): Genai.OnboardingGuide;
    ...
    withTargetPage(targetPage: string | null): Genai.OnboardingGuide;

    /**
     * If defined, a link to this video will be displayed in the UI, which will open the video in a new tab
     */
    readonly videoGuideUrl?: string;
    withVideoGuideUrl(videoGuideUrl: string | null): Genai.OnboardingGuide;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.OnboardingGuide | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.OnboardingGuide | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.OnboardingGuide | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.OnboardingGuide | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.OnboardingGuide;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.OnboardingGuide;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.OnboardingGuide;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.OnboardingGuide>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.OnboardingGuide>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.OnboardingGuide;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.OnboardingGuide;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.OnboardingGuide;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.OnboardingGuide;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.OnboardingGuide;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.OnboardingGuide;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.OnboardingGuide;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.OnboardingGuide;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.OnboardingGuide;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.OnboardingGuide;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.OnboardingGuide;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.OnboardingGuide;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.OnboardingGuide;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.OnboardingGuide;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.OnboardingGuide;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.OnboardingGuide;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.OnboardingGuide;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.OnboardingGuide;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.OnboardingGuide;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.OnboardingGuide;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.OnboardingGuide;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.OnboardingGuide;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.OnboardingGuide;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.OnboardingGuide;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.OnboardingGuide;

    mergeJson(json: any): Genai.OnboardingGuide;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.OnboardingGuide;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.OnboardingGuide;
     ...
     */
    singletonArray(): Array_Type<Genai.OnboardingGuide>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.OnboardingGuide> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.OnboardingGuide> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.OnboardingGuide>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.OnboardingGuide> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.OnboardingGuide> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.OnboardingGuide> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.OnboardingGuide>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.OnboardingGuide>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.OnboardingGuide;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.OnboardingGuide;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.OnboardingGuide;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.OnboardingGuide;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.OnboardingGuide;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.OnboardingGuide;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.OnboardingGuide | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.OnboardingGuide;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.OnboardingGuide;
     ...
     */
    static cachedEmptyInst(): Genai.OnboardingGuide;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.OnboardingGuide> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.OnboardingGuide;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.OnboardingGuide>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.OnboardingGuide>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.OnboardingGuide> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.OnboardingGuide>> | null;
     ...
     */
    get(include?: string): Genai.OnboardingGuide | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.OnboardingGuide | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.OnboardingGuide;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.OnboardingGuide | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.OnboardingGuide;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.OnboardingGuide | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.OnboardingGuide | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.OnboardingGuide>, spec?: UpsertSpec): ObjList<Genai.OnboardingGuide> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.OnboardingGuide>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.OnboardingGuide> | null;
     ...
     */
    update(srcObj?: Genai.OnboardingGuide, spec?: UpsertSpec): Genai.OnboardingGuide | null;
     ...
     */
    upsert(srcObj?: Genai.OnboardingGuide, spec?: UpsertSpec): Genai.OnboardingGuide | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.OnboardingGuide | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.OnboardingGuide | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.OnboardingGuide | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.OnboardingGuide>, srcObjs?: Array_Type<Genai.OnboardingGuide>, spec?: UpsertSpec): ObjList<Genai.OnboardingGuide> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.OnboardingGuide> | null>, spec?: UpsertSpec): ObjList<Genai.OnboardingGuide> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.OnboardingGuide>, srcObjs?: Array_Type<Genai.OnboardingGuide>, spec?: UpsertSpec): ObjList<Genai.OnboardingGuide> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.OnboardingGuide> | null>, spec?: UpsertSpec): ObjList<Genai.OnboardingGuide> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.OnboardingGuide>, spec?: TouchSpec): ObjList<Genai.OnboardingGuide> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.OnboardingGuide>, spec?: MergeSpec): ObjList<Genai.OnboardingGuide> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.OnboardingGuide>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.OnboardingGuide> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.OnboardingGuide> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.OnboardingGuide> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.OnboardingGuide, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.OnboardingGuide, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.OnboardingGuide>, spec?: UpsertSpec): ObjList<Genai.OnboardingGuide> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.OnboardingGuide>, spec?: UpsertSpec): ObjList<Genai.OnboardingGuide> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.OnboardingGuide | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.OnboardingGuide>): ObjList<Genai.OnboardingGuide>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.OnboardingGuide>): ObjList<Genai.OnboardingGuide>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.OnboardingGuide>): ObjList<Genai.OnboardingGuide>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.OnboardingGuide>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.OnboardingGuide>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.OnboardingGuide>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.OnboardingGuide>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.OnboardingGuide>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.OnboardingGuide | null;
     ...
     */
    withoutIdentity(): Genai.OnboardingGuide | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.OnboardingGuide>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.OnboardingGuide, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.OnboardingGuide>, callback?: λFunction<Genai.OnboardingGuide | null, Genai.OnboardingGuide | null>): ObjList<Genai.OnboardingGuide>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.OnboardingGuide>, callback?: λFunction<Genai.OnboardingGuide | null, Genai.OnboardingGuide | null>): Array_Type<ObjError> | null;
