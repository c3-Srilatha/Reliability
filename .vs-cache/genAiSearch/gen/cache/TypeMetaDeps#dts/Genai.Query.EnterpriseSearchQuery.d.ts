// TypeScript definitions for the C3 type Genai.Query.EnterpriseSearchQuery

/**
 * Represents a query a user has input when using the enterpriseSearch package.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Query.EnterpriseSearchQuery
 */
declare namespace Genai.Query {
  export interface IEnterpriseSearchQuery {
    ...
    /**
     * @inheritdoc
     * The id will be the {@link MD5#hashString} hash value of the #query and the {@link User#id}.
     */
    id: string;
    ...
    /**
     * The number of time this query has been asked by the {@link User}. Multiple {@link Genai.Query.EnterpriseSearchQuery} records
     * may exist for a query if multiple users have entered the same query. To get the total number of times a specific
     * query has been entered across _all_ users, sum the `timesQueried` for all records with the desired #query
     * string.
     */
    timesQueried?: number;

    /**
     * The description of what the query is expected to return.
     */
    description?: string;
  }
}
 ...
 * Represents a query a user has input when using the enterpriseSearch package.
 *
 * @remarks this represents a made instance of Genai.Query.EnterpriseSearchQuery
 */
declare namespace Genai.Query {
  export class EnterpriseSearchQuery extends Obj  {

    /**
     * The {@link Genai.Project} this instance is linked to.
     */
    readonly projects?: Array_Type<Genai.Project>;
    withProjects(projects: Array_Type<Genai.Project> | Array<IGenai.Project> | null): Genai.Query.EnterpriseSearchQuery;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Query.EnterpriseSearchQuery;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Query.EnterpriseSearchQuery;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Query.EnterpriseSearchQuery;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Query.EnterpriseSearchQuery;
    ...
    withVersion(version: number | null): Genai.Query.EnterpriseSearchQuery;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Query.EnterpriseSearchQuery;

    /**
     * The query string.
     */
    readonly query: string;
    withQuery(query: string): Genai.Query.EnterpriseSearchQuery;
     ...
     * string.
     */
    readonly timesQueried?: number;
    withTimesQueried(timesQueried: number | null): Genai.Query.EnterpriseSearchQuery;

    /**
     * The description of what the query is expected to return.
     */
    readonly description?: string;
    withDescription(description: string | null): Genai.Query.EnterpriseSearchQuery;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Query.EnterpriseSearchQuery | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Query.EnterpriseSearchQuery | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Query.EnterpriseSearchQuery | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Query.EnterpriseSearchQuery | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Query.EnterpriseSearchQuery;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Query.EnterpriseSearchQuery;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Query.EnterpriseSearchQuery;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Query.EnterpriseSearchQuery>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Query.EnterpriseSearchQuery>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Query.EnterpriseSearchQuery;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Query.EnterpriseSearchQuery;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Query.EnterpriseSearchQuery;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Query.EnterpriseSearchQuery;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Query.EnterpriseSearchQuery;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Query.EnterpriseSearchQuery;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Query.EnterpriseSearchQuery;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Query.EnterpriseSearchQuery;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Query.EnterpriseSearchQuery;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Query.EnterpriseSearchQuery;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Query.EnterpriseSearchQuery;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Query.EnterpriseSearchQuery;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Query.EnterpriseSearchQuery;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Query.EnterpriseSearchQuery;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Query.EnterpriseSearchQuery;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Query.EnterpriseSearchQuery;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Query.EnterpriseSearchQuery;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Query.EnterpriseSearchQuery;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Query.EnterpriseSearchQuery;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Query.EnterpriseSearchQuery;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Query.EnterpriseSearchQuery;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Query.EnterpriseSearchQuery;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Query.EnterpriseSearchQuery;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Query.EnterpriseSearchQuery;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Query.EnterpriseSearchQuery;

    mergeJson(json: any): Genai.Query.EnterpriseSearchQuery;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Query.EnterpriseSearchQuery;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Query.EnterpriseSearchQuery;
     ...
     */
    singletonArray(): Array_Type<Genai.Query.EnterpriseSearchQuery>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Query.EnterpriseSearchQuery> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Query.EnterpriseSearchQuery> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Query.EnterpriseSearchQuery>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Query.EnterpriseSearchQuery> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Query.EnterpriseSearchQuery> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Query.EnterpriseSearchQuery> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Query.EnterpriseSearchQuery>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Query.EnterpriseSearchQuery>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Query.EnterpriseSearchQuery;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Query.EnterpriseSearchQuery;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Query.EnterpriseSearchQuery;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Query.EnterpriseSearchQuery;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Query.EnterpriseSearchQuery;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Query.EnterpriseSearchQuery;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Query.EnterpriseSearchQuery | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Query.EnterpriseSearchQuery;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.Query.EnterpriseSearchQuery;
     ...
     */
    static cachedEmptyInst(): Genai.Query.EnterpriseSearchQuery;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Query.EnterpriseSearchQuery> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Query.EnterpriseSearchQuery;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Query.EnterpriseSearchQuery>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Query.EnterpriseSearchQuery>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Query.EnterpriseSearchQuery> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Query.EnterpriseSearchQuery>> | null;
     ...
     */
    get(include?: string): Genai.Query.EnterpriseSearchQuery | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Query.EnterpriseSearchQuery | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Query.EnterpriseSearchQuery;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Query.EnterpriseSearchQuery | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Query.EnterpriseSearchQuery;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Query.EnterpriseSearchQuery | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Query.EnterpriseSearchQuery | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Query.EnterpriseSearchQuery>, spec?: UpsertSpec): ObjList<Genai.Query.EnterpriseSearchQuery> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Query.EnterpriseSearchQuery>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Query.EnterpriseSearchQuery> | null;
     ...
     */
    update(srcObj?: Genai.Query.EnterpriseSearchQuery, spec?: UpsertSpec): Genai.Query.EnterpriseSearchQuery | null;
     ...
     */
    upsert(srcObj?: Genai.Query.EnterpriseSearchQuery, spec?: UpsertSpec): Genai.Query.EnterpriseSearchQuery | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Query.EnterpriseSearchQuery | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Query.EnterpriseSearchQuery | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Query.EnterpriseSearchQuery | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Query.EnterpriseSearchQuery>, srcObjs?: Array_Type<Genai.Query.EnterpriseSearchQuery>, spec?: UpsertSpec): ObjList<Genai.Query.EnterpriseSearchQuery> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Query.EnterpriseSearchQuery> | null>, spec?: UpsertSpec): ObjList<Genai.Query.EnterpriseSearchQuery> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Query.EnterpriseSearchQuery>, srcObjs?: Array_Type<Genai.Query.EnterpriseSearchQuery>, spec?: UpsertSpec): ObjList<Genai.Query.EnterpriseSearchQuery> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Query.EnterpriseSearchQuery> | null>, spec?: UpsertSpec): ObjList<Genai.Query.EnterpriseSearchQuery> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Query.EnterpriseSearchQuery>, spec?: TouchSpec): ObjList<Genai.Query.EnterpriseSearchQuery> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Query.EnterpriseSearchQuery>, spec?: MergeSpec): ObjList<Genai.Query.EnterpriseSearchQuery> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Query.EnterpriseSearchQuery>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Query.EnterpriseSearchQuery> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Query.EnterpriseSearchQuery> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Query.EnterpriseSearchQuery> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Query.EnterpriseSearchQuery, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Query.EnterpriseSearchQuery, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Query.EnterpriseSearchQuery>, spec?: UpsertSpec): ObjList<Genai.Query.EnterpriseSearchQuery> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Query.EnterpriseSearchQuery>, spec?: UpsertSpec): ObjList<Genai.Query.EnterpriseSearchQuery> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Query.EnterpriseSearchQuery | null;
    ...
    /**
     * Callback to set the `id` of the {@link Genai.Query.EnterpriseSearchQuery} before writing to the database.  The `id` will
     * be set by {@link MD5#hashString} the query.  Query will be downcased `toLowerCase` and trimmed `trim`
     * before being hashed.
     */
    static beforeCreate(objs: Array_Type<Genai.Query.EnterpriseSearchQuery>): ObjList<Genai.Query.EnterpriseSearchQuery>;
     ...
     */
    static beforeUpdate(objs: Array_Type<Genai.Query.EnterpriseSearchQuery>): ObjList<Genai.Query.EnterpriseSearchQuery>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Query.EnterpriseSearchQuery>): ObjList<Genai.Query.EnterpriseSearchQuery>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Query.EnterpriseSearchQuery>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Query.EnterpriseSearchQuery>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Query.EnterpriseSearchQuery>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Query.EnterpriseSearchQuery>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Query.EnterpriseSearchQuery>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Query.EnterpriseSearchQuery | null;
     ...
     */
    withoutIdentity(): Genai.Query.EnterpriseSearchQuery | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Query.EnterpriseSearchQuery>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Query.EnterpriseSearchQuery, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Query.EnterpriseSearchQuery>, callback?: λFunction<Genai.Query.EnterpriseSearchQuery | null, Genai.Query.EnterpriseSearchQuery | null>): ObjList<Genai.Query.EnterpriseSearchQuery>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Query.EnterpriseSearchQuery>, callback?: λFunction<Genai.Query.EnterpriseSearchQuery | null, Genai.Query.EnterpriseSearchQuery | null>): Array_Type<ObjError> | null;
    ...
    /**
     * Function to create a new instance of {@link Genai.Query.EnterpriseSearchQuery} and rank it in relation to other queries.
     * @param query
     *       The user input query
     * @return The newly created {@link Genai.Query.EnterpriseSearchQuery}
     */
    static createAndRankQuery(query: string): Genai.Query.EnterpriseSearchQuery | null;

    /**
     * Function to fetch the query history. Internally checks {@link GenAiUiConfig#queryHistoryVisibility} and updates
     * the filter accordingly.
     *
     * @param spec
     *      The initial fetch spec. This may be modified internally based on {@link GenAiUiConfig#queryHistoryVisibility}.
     * @return The unique Genai.Query.EnterpriseSearchQuery records to render as the query history in the UI
     */
    static fetchQueryHistory(spec?: FetchSpec): Array_Type<Genai.Query.EnterpriseSearchQuery> | null;

    /**
     * Wrapper to invoke #createAndRankQuery in an {@link AsyncAction}.
     * @param query
     *       The user input query
     * @return The {@link AsyncAction async}
     */
    static createAndRankQueryAsync(query: string): AsyncAction | null;
  }
}
