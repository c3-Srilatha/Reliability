// TypeScript definitions for the C3 type Genai.LogoImages.DefaultConfig
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.LogoImages.DefaultConfig
 */
declare namespace Genai.LogoImages {
...
declare namespace Genai.LogoImages {
  export class DefaultConfig extends Obj  {
    ...
    withConfigOverride(configOverride: string | null): Genai.LogoImages.DefaultConfig;

    static readonly configOverride?: string;

    readonly secretOverride?: string;
    withSecretOverride(secretOverride: string | null): Genai.LogoImages.DefaultConfig;
    ...
    withIssues(issues: Array_Type<string> | Array<string> | null): Genai.LogoImages.DefaultConfig;
     ...
     * Sets the images to be used in GenAiUi.SearchPage.
     */
    readonly home?: Genai.LogoImages;
    withHome(home: IGenai.LogoImages | null): Genai.LogoImages.DefaultConfig;

    /**
     * Sets the images to be used in GenAiUi.SearchPage.
     */
    static readonly home?: Genai.LogoImages;

    /**
     * Sets the images to be used in {@link UiSdlNavMenu}.
     */
    readonly menu?: Genai.LogoImages;
    withMenu(menu: IGenai.LogoImages | null): Genai.LogoImages.DefaultConfig;

    /**
     * Sets the images to be used in {@link UiSdlNavMenu}.
     */
    static readonly menu?: Genai.LogoImages;

    /**
     * Sets the images to be used in GenAiUi.ChatBox.
     */
    readonly chat?: Genai.LogoImages;
    withChat(chat: IGenai.LogoImages | null): Genai.LogoImages.DefaultConfig;

    /**
     * Sets the images to be used in GenAiUi.ChatBox.
     */
    static readonly chat?: Genai.LogoImages;

    /**
     * Sets the banner to be used in {@link GenAiUiC3WebpageBanner}
     */
    readonly banner?: Genai.LogoImages;
    withBanner(banner: IGenai.LogoImages | null): Genai.LogoImages.DefaultConfig;

    /**
     * Sets the banner to be used in {@link GenAiUiC3WebpageBanner}
     */
    static readonly banner?: Genai.LogoImages;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.LogoImages.DefaultConfig | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.LogoImages.DefaultConfig | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.LogoImages.DefaultConfig | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.LogoImages.DefaultConfig | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.LogoImages.DefaultConfig;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Genai.LogoImages.DefaultConfig;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.LogoImages.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.LogoImages.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.LogoImages.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.LogoImages.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.LogoImages.DefaultConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.LogoImages.DefaultConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.LogoImages.DefaultConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.LogoImages.DefaultConfig>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.LogoImages.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.LogoImages.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.LogoImages.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.LogoImages.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.LogoImages.DefaultConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.LogoImages.DefaultConfig;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.LogoImages.DefaultConfig;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Genai.LogoImages.DefaultConfig;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.LogoImages.DefaultConfig;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Genai.LogoImages.DefaultConfig;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.LogoImages.DefaultConfig;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.LogoImages.DefaultConfig;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.LogoImages.DefaultConfig;
     ...
     * @return new Obj
     */
    static withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.LogoImages.DefaultConfig;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.LogoImages.DefaultConfig;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.LogoImages.DefaultConfig;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.LogoImages.DefaultConfig;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Genai.LogoImages.DefaultConfig;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.LogoImages.DefaultConfig;
     ...
     * @see #removeField
     */
    static withoutField(field: string): Genai.LogoImages.DefaultConfig;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.LogoImages.DefaultConfig;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType): Genai.LogoImages.DefaultConfig;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.LogoImages.DefaultConfig;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: Array_Type<string>): Genai.LogoImages.DefaultConfig;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.LogoImages.DefaultConfig;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: Array_Type<FieldType>): Genai.LogoImages.DefaultConfig;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.LogoImages.DefaultConfig;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Genai.LogoImages.DefaultConfig;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.LogoImages.DefaultConfig;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.LogoImages.DefaultConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.LogoImages.DefaultConfig;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Genai.LogoImages.DefaultConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.LogoImages.DefaultConfig;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Genai.LogoImages.DefaultConfig;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.LogoImages.DefaultConfig;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Genai.LogoImages.DefaultConfig;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.LogoImages.DefaultConfig;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Genai.LogoImages.DefaultConfig;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.LogoImages.DefaultConfig;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Genai.LogoImages.DefaultConfig;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.LogoImages.DefaultConfig;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Genai.LogoImages.DefaultConfig;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.LogoImages.DefaultConfig;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.LogoImages.DefaultConfig;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.LogoImages.DefaultConfig;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj, otherFieldsFilter: Type): Genai.LogoImages.DefaultConfig;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.LogoImages.DefaultConfig;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.LogoImages.DefaultConfig;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.LogoImages.DefaultConfig;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.LogoImages.DefaultConfig;

    mergeJson(json: any): Genai.LogoImages.DefaultConfig;

    static mergeJson(json: any): Genai.LogoImages.DefaultConfig;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.LogoImages.DefaultConfig;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.LogoImages.DefaultConfig;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.LogoImages.DefaultConfig;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj, deep?: boolean): Genai.LogoImages.DefaultConfig;
     ...
     */
    singletonArray(): Array_Type<Genai.LogoImages.DefaultConfig>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): Array_Type<Genai.LogoImages.DefaultConfig>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.LogoImages.DefaultConfig> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.LogoImages.DefaultConfig> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.LogoImages.DefaultConfig>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): Set_Type<Genai.LogoImages.DefaultConfig>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.LogoImages.DefaultConfig> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.LogoImages.DefaultConfig> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.LogoImages.DefaultConfig> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.LogoImages.DefaultConfig>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Genai.LogoImages.DefaultConfig>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.LogoImages.DefaultConfig>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.LogoImages.DefaultConfig;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.LogoImages.DefaultConfig;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.LogoImages.DefaultConfig;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.LogoImages.DefaultConfig;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.LogoImages.DefaultConfig;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.LogoImages.DefaultConfig;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.LogoImages.DefaultConfig;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.LogoImages.DefaultConfig;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Genai.LogoImages.DefaultConfig;
     ...
     */
    static cachedEmptyInst(): Genai.LogoImages.DefaultConfig;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.LogoImages.DefaultConfig> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.LogoImages.DefaultConfig;
     ...
     */
    static allCached(): Stream<Genai.LogoImages.DefaultConfig> | null;
     ...
     */
    static find(filter?: string): Stream<Genai.LogoImages.DefaultConfig> | null;
     ...
     *         Otherwise no population will be performed.
     */
    static findBy(field: string, value: any): Stream<Genai.LogoImages.DefaultConfig> | null;

    /**
     * @return cached instance.
     */
    getCached(): Genai.LogoImages.DefaultConfig | null;

    /**
     * @return cached instance.
     */
    static getCached(): Genai.LogoImages.DefaultConfig | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string): Genai.LogoImages.DefaultConfig | null;
     ...
     */
    static produce(key: string): Genai.LogoImages.DefaultConfig | null;

    /**
     * Should produces the entire content for the cached data. Will populate the cache with the produced data.
     */
    static produceAll(): Map_Type<string, Genai.LogoImages.DefaultConfig> | null;
     ...
     */
    getConfig(): Genai.LogoImages.DefaultConfig;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): Genai.LogoImages.DefaultConfig;
     ...
     */
    getSecret(): Genai.LogoImages.DefaultConfig;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): Genai.LogoImages.DefaultConfig;
     ...
     */
    withConfigKey(configKey: string): Genai.LogoImages.DefaultConfig;
     ...
     *     config.configKey() => "folder1/abc"
     */
    static withConfigKey(configKey: string): Genai.LogoImages.DefaultConfig;

    /**
     * @return copy without config key.
     */
    withoutConfigKey(): Genai.LogoImages.DefaultConfig;

    /**
     * @return copy without config key.
     */
    static withoutConfigKey(): Genai.LogoImages.DefaultConfig;

    /**
     * @return return cached config instance for provided config key.
     */
    static forConfigKey(configKey: string): Genai.LogoImages.DefaultConfig | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string>): Stream<Genai.LogoImages.DefaultConfig> | null;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Genai.LogoImages.DefaultConfig, override?: string): void;
     ...
     * @see setConfigValue
     */
    static setConfigValues(from: Genai.LogoImages.DefaultConfig, override?: string): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Genai.LogoImages.DefaultConfig | null;
     ...
     */
    removeSecrets(): Genai.LogoImages.DefaultConfig | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): Genai.LogoImages.DefaultConfig | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Genai.LogoImages.DefaultConfig | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): Genai.LogoImages.DefaultConfig | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Genai.LogoImages.DefaultConfig;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): Genai.LogoImages.DefaultConfig;
     ...
     */
    static inst(): Genai.LogoImages.DefaultConfig;
     ...
     */
    static setImageForTheme(imageUrl: string, theme?: string = 'LIGHT', location?: string = 'ALL'): string | null;

    /**
     * Retrieves the image configuration from {@link Genai.LogoImages.Config}
     * and {@link Genai.LogoImages.DefaultConfig}.
     */
    static getAllImages(): any | null;
  }
}
