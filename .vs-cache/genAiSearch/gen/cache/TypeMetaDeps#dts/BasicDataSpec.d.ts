// TypeScript definitions for the C3 type BasicDataSpec

/**
 * Type to represent a very basic data spec.
 *
 * @remarks this represents a value passed to a method that expects an instance of BasicDataSpec
 */
declare interface IBasicDataSpec {
 ...
 */
declare class BasicDataSpec extends Obj  {
  ...
  withContextVars(contextVars: Map_Type<string, UiSdlDynamicValueSpecParam> | {[key: string]: IUiSdlDynamicValueSpecParam} | null): BasicDataSpec;
  ...
  withSendRequestWithFalsyContextVars(sendRequestWithFalsyContextVars: boolean): BasicDataSpec;
  ...
  withTunnelConfiguration(tunnelConfiguration: IUiSdlTunnelConfiguration | null): BasicDataSpec;
  ...
  withDataTransforms(dataTransforms: Array_Type<string> | Array<string> | null): BasicDataSpec;
  ...
  withAdvancedDataSpec(advancedDataSpec: IUiSdlComponentAdvancedDataSpec | null): BasicDataSpec;
  ...
  withDataType(dataType: string): BasicDataSpec;

  /**
   * The action to call
   */
  readonly actionName?: string;
  withActionName(actionName: string | null): BasicDataSpec;

  /**
   * Spec for using {@link Evaluatable#eval}.
   */
  readonly evalSpec?: EvalSpec;
  withEvalSpec(evalSpec: IEvalSpec | null): BasicDataSpec;
  ...
  withDisableDataRequestOnFirstRender(disableDataRequestOnFirstRender: boolean): BasicDataSpec;
  ...
  withIgnoreFirstContextVarResolution(ignoreFirstContextVarResolution: boolean): BasicDataSpec;
  ...
  withIgnoreAllContextVarResolution(ignoreAllContextVarResolution: boolean): BasicDataSpec;
  ...
  withDataSpecDependence(dataSpecDependence: Array_Type<UiSdlCrossTypeDataSpecDependence> | Array<IUiSdlCrossTypeDataSpecDependence> | null): BasicDataSpec;

  /**
   * Mapping between fields that depend on each other. See {@link UiSdlFieldsDependenceMapping} for more.
   */
  readonly fieldsDependenceMapping?: Array_Type<UiSdlFieldsDependenceMapping>;
  withFieldsDependenceMapping(fieldsDependenceMapping: Array_Type<UiSdlFieldsDependenceMapping> | Array<IUiSdlFieldsDependenceMapping> | null): BasicDataSpec;
  ...
  withDisableContextVarsFilter(disableContextVarsFilter: boolean): BasicDataSpec;

  /**
   * The args to be passed to the API
   */
  readonly args?: any;
  withArgs(args: any | null): BasicDataSpec;
   ...
   * @see #toJson
   */
  static fromJson(json: any): BasicDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): BasicDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): BasicDataSpec | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): BasicDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): BasicDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): BasicDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): BasicDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<BasicDataSpec>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<BasicDataSpec>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): BasicDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BasicDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BasicDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): BasicDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): BasicDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): BasicDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): BasicDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BasicDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): BasicDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string): BasicDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): BasicDataSpec;
   ...
   */
  withoutFields(fields: Array_Type<string>): BasicDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): BasicDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): BasicDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): BasicDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): BasicDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): BasicDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): BasicDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): BasicDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): BasicDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): BasicDataSpec;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): BasicDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): BasicDataSpec;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): BasicDataSpec;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): BasicDataSpec;

  mergeJson(json: any): BasicDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): BasicDataSpec;
   ...
   */
  sumObj(other: Obj, deep?: boolean): BasicDataSpec;
   ...
   */
  singletonArray(): Array_Type<BasicDataSpec>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<BasicDataSpec> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BasicDataSpec> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<BasicDataSpec>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BasicDataSpec> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, BasicDataSpec> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BasicDataSpec> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BasicDataSpec>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BasicDataSpec>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): BasicDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): BasicDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): BasicDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): BasicDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): BasicDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): BasicDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): BasicDataSpec;
   ...
   */
  static cachedEmptyInst(): BasicDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<BasicDataSpec> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): BasicDataSpec;
   ...
   */
  static getDataTypeName(dataSpec?: BasicDataSpec): string | null;
