// TypeScript definitions for the C3 type GenAiUiSettingsApplicationState

/**
 * Application state for the settings page.
 *
 * @remarks this represents a value passed to a method that expects an instance of GenAiUiSettingsApplicationState
 */
declare interface IGenAiUiSettingsApplicationState {
  ...
  /**
   * Whether the config detail is on read mode (JSON view), or edit mode.
   */
  configDetailMode?: string;
}

/**
 * Application state for the settings page.
 *
 * @remarks this represents a made instance of GenAiUiSettingsApplicationState
 */
declare class GenAiUiSettingsApplicationState extends Obj  {

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): GenAiUiSettingsApplicationState;

  /**
   * Unique identifier for the logical object that instance of this type represents.
   */
  readonly id?: string;
  withId(id: string | null): GenAiUiSettingsApplicationState;

  /**
   * The name of the component. Optional field for informational purposes only.
   */
  readonly name?: string;
  withName(name: string | null): GenAiUiSettingsApplicationState;
  ...
  withDataSpec(dataSpec: IUiSdlNoData | null): GenAiUiSettingsApplicationState;

  /**
   * Disable if you want to avoid sending any and all requests for this component on first render.
   */
  readonly disableDataRequestOnFirstRender?: boolean;
  withDisableDataRequestOnFirstRender(disableDataRequestOnFirstRender: boolean): GenAiUiSettingsApplicationState;

  /**
   * Whether the effect triggers and epics have been registered
   */
  readonly triggersRegistered?: boolean;
  withTriggersRegistered(triggersRegistered: boolean): GenAiUiSettingsApplicationState;

  /**
   * Whether to wrap the component with a div which has a class name of its metdata id. Useful for targeting with css.
   */
  readonly wrapWithMetadataId?: boolean;
  withWrapWithMetadataId(wrapWithMetadataId: boolean): GenAiUiSettingsApplicationState;

  /**
   * The Redux namespace for the application state to indicate where the application data is stored in the Redux state.
   */
  readonly REDUX_NAMESPACE?: string;
  withREDUX_NAMESPACE(REDUX_NAMESPACE: string | null): GenAiUiSettingsApplicationState;

  /**
   * Collection of extra async {@link UiSdlEffectTrigger}.
   */
  readonly effectTriggers?: Array_Type<UiSdlEffectTrigger>;
  withEffectTriggers(effectTriggers: Array_Type<UiSdlEffectTrigger> | Array<IUiSdlEffectTrigger> | null): GenAiUiSettingsApplicationState;

  /**
   * Whether the config detail is on read mode (JSON view), or edit mode.
   */
  readonly configDetailMode?: string;
  withConfigDetailMode(configDetailMode: string | null): GenAiUiSettingsApplicationState;
   ...
   * @see #toJson
   */
  static fromJson(json: any): GenAiUiSettingsApplicationState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): GenAiUiSettingsApplicationState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): GenAiUiSettingsApplicationState | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): GenAiUiSettingsApplicationState | null;
   ...
   */
  replaceType(old: Type, new_: Type): GenAiUiSettingsApplicationState;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenAiUiSettingsApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenAiUiSettingsApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenAiUiSettingsApplicationState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenAiUiSettingsApplicationState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenAiUiSettingsApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenAiUiSettingsApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenAiUiSettingsApplicationState;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): GenAiUiSettingsApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): GenAiUiSettingsApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): GenAiUiSettingsApplicationState;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenAiUiSettingsApplicationState;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenAiUiSettingsApplicationState;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): GenAiUiSettingsApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: string): GenAiUiSettingsApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): GenAiUiSettingsApplicationState;
   ...
   */
  withoutFields(fields: Array_Type<string>): GenAiUiSettingsApplicationState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): GenAiUiSettingsApplicationState;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): GenAiUiSettingsApplicationState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenAiUiSettingsApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: string): GenAiUiSettingsApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): GenAiUiSettingsApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: string): GenAiUiSettingsApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): GenAiUiSettingsApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: string): GenAiUiSettingsApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): GenAiUiSettingsApplicationState;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenAiUiSettingsApplicationState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): GenAiUiSettingsApplicationState;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenAiUiSettingsApplicationState;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenAiUiSettingsApplicationState;

  mergeJson(json: any): GenAiUiSettingsApplicationState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenAiUiSettingsApplicationState;
   ...
   */
  sumObj(other: Obj, deep?: boolean): GenAiUiSettingsApplicationState;
   ...
   */
  singletonArray(): Array_Type<GenAiUiSettingsApplicationState>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<GenAiUiSettingsApplicationState> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<GenAiUiSettingsApplicationState> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<GenAiUiSettingsApplicationState>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<GenAiUiSettingsApplicationState> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, GenAiUiSettingsApplicationState> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenAiUiSettingsApplicationState> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<GenAiUiSettingsApplicationState>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<GenAiUiSettingsApplicationState>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenAiUiSettingsApplicationState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenAiUiSettingsApplicationState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenAiUiSettingsApplicationState;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): GenAiUiSettingsApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenAiUiSettingsApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): GenAiUiSettingsApplicationState;
   ...
   * @see #fromString
   */
  static make(s: string): GenAiUiSettingsApplicationState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenAiUiSettingsApplicationState;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): GenAiUiSettingsApplicationState;
   ...
   */
  static cachedEmptyInst(): GenAiUiSettingsApplicationState;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<GenAiUiSettingsApplicationState> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): GenAiUiSettingsApplicationState;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<GenAiUiSettingsApplicationState>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<GenAiUiSettingsApplicationState>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<GenAiUiSettingsApplicationState> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenAiUiSettingsApplicationState>> | null;
   ...
   */
  dependencies(): MetadataDeps<GenAiUiSettingsApplicationState>;

  save(subPath?: string, contentType?: string): GenAiUiSettingsApplicationState;
  ...
  update(srcObj?: GenAiUiSettingsApplicationState, spec?: UpsertSpec): GenAiUiSettingsApplicationState | null;

  upsert(srcObj?: GenAiUiSettingsApplicationState, spec?: UpsertSpec): GenAiUiSettingsApplicationState | null;
   ...
   * @see #toString
   */
  static fromString(s: string): GenAiUiSettingsApplicationState | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string, failIfMissing?: boolean): GenAiUiSettingsApplicationState | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: GenAiUiSettingsApplicationState, state: UiSdlReduxState): GenAiUiSettingsApplicationState | null;
  ...
  /**
   * Action to toggle the read/edit mode on the config detail panel.
   * @param id
   *           The id of the {@link GenAiUiFeedApplicationState} for the action.
   * @param configDetailMode
   *           The mode to set the config detail panel to.
   */
  static setConfigDetailModeAction(id: string, configDetailMode: string): UiSdlReduxAction<any>;

  /**
   * Listens for actions of type `SET_CONFIG_DETAIL_MODE` and updates the config detail mode.
   */
  static setConfigDetailModeReducer(state: UiSdlReduxState, action: UiSdlReduxAction<any>): UiSdlReduxAction<any>;
}
