// TypeScript definitions for the C3 type Genai.Query.Result

/**
 * The Generative AI model result
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.Query.Result
 */
declare namespace Genai.Query {
  export interface IResult {
     ...
     */
    chatMemory?: IGenai.ChatMemoryOutput;
     ...
     */
    passages?: Array_Type<Genai.Query.ResultToPassageRelation> | Array<IGenai.Query.ResultToPassageRelation>;

    /**
     * The files were used as part of the #rationale to generate the #answer.
     */
    rationaleSources?: Array_Type<Genai.Query.ResultToSourceFileRelation> | Array<IGenai.Query.ResultToSourceFileRelation>;
     ...
     */
    potentialRationaleSources?: Array_Type<Genai.Query.ResultToSourceFileRelation> | Array<IGenai.Query.ResultToSourceFileRelation>;

    /**
     * The plan used to generate the result - {@link Genai.Agent.Dynamic}.
     */
    plan?: IGenai.Agent.DynamicTrajectory;
     ...
     */
    sourceRelations?: Array_Type<Genai.Query.ResultToSourceRelation> | Array<IGenai.Query.ResultToSourceRelation>;

    /**
     * The chat that the user had with the chat bot related to this original {@link Genai.Query.Result}.
     */
    chatHistory?: Array_Type<Genai.Query.ChatMessage> | Array<IGenai.Query.ChatMessage>;

    /**
     * A field to store intermediate (i.e. while processing) portions of the overall result.
     */
    intermediateResults?: Map_Type<string, any> | {[key: string]: any};

    /**
     * The history of interim statuses for the generation on the result
     */
    statusHistory?: Array_Type<Genai.Query.Result.InterimStatusHistory> | Array<IGenai.Query.Result.InterimStatusHistory>;

    /**
     * The visualization that best suits the structured data answer
     */
    visualization?: IGenAiVisualizationBase;

    /**
     * The steps performed to get to this result
     */
    steps?: Array_Type<Genai.Agent.Step> | Array<IGenai.Agent.Step>;
     ...
     */
    session?: IGenaiCore.Session.Kv;

    /**
     * All the feedback given to the generative model result.
     */
    feedback?: Array_Type<Genai.Query.Result.Feedback> | Array<IGenai.Query.Result.Feedback>;

    /**
     * All child results (if any) for this result. See #parent
     */
    childResults?: Array_Type<Genai.Query.Result> | Array<IGenai.Query.Result>;
     ...
     */
    allToolNames?: Array_Type<string> | Array<string>;
     ...
     */
    getForUiResult?: IGenai.Query.Result.GetForUiResult;
     ...
     */
    suggestedFollowUpQueries?: Array_Type<Genai.Query> | Array<IGenai.Query>;
  }
}
 ...
 * The Generative AI model result
 *
 * @remarks this represents a made instance of Genai.Query.Result
 */
declare namespace Genai.Query {
  export class Result extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): Genai.Query.Result;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.Query.Result;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.Query.Result;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.Query.Result;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.Query.Result;
    ...
    withVersion(version: number | null): Genai.Query.Result;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.Query.Result;

    /**
     * The chat memory (if it was generated)
     */
    readonly chatMemory?: Genai.ChatMemoryOutput;
    withChatMemory(chatMemory: IGenai.ChatMemoryOutput | null): Genai.Query.Result;

    /**
     * A {@link Genai.Query} object representing a user's search query.
     * Contains information about the query string and any filters applied to the query.
     */
    readonly searchQuery?: Genai.Query;
    withSearchQuery(searchQuery: IGenai.Query | null): Genai.Query.Result;

    /**
     * The engine's answer to the query
     */
    readonly answer?: string;
    withAnswer(answer: string | null): Genai.Query.Result;

    /**
     * The reasoning behind the answer
     */
    readonly rationale?: string;
    withRationale(rationale: string | null): Genai.Query.Result;

    /**
     * The log of the {@link Genai.UnstructuredQuery.Engine} chain
     */
    readonly engineLog?: string;
    withEngineLog(engineLog: string | null): Genai.Query.Result;
    ...
    withFailed(failed: boolean): Genai.Query.Result;

    /**
     * If the result was streamed, tracks the state of the streaming.
     */
    readonly streamingState?: string;
    withStreamingState(streamingState: string | null): Genai.Query.Result;

    /**
     * Whether the answer or some of its passages potentially used a translation service
     */
    readonly usedTranslation?: boolean;
    withUsedTranslation(usedTranslation: boolean): Genai.Query.Result;

    /**
     * The service used to translate answer if translation is enabled
     */
    readonly translatorTypeName?: string;
    withTranslatorTypeName(translatorTypeName: string | null): Genai.Query.Result;

    /**
     * The {@link Genai.Project} that will be used to execute the query.
     */
    readonly project?: Genai.Project;
    withProject(project: IGenai.Project | null): Genai.Query.Result;

    /**
     * Information about the user that generated the query
     */
    readonly userEmail?: string;
    withUserEmail(userEmail: string | null): Genai.Query.Result;

    /**
     * The (up to) 100 passages most relevant to the query according to {@link Genai.RetrieverActions#similaritySearch}
     */
    readonly passages?: Array_Type<Genai.Query.ResultToPassageRelation>;
    withPassages(passages: Array_Type<Genai.Query.ResultToPassageRelation> | Array<IGenai.Query.ResultToPassageRelation> | null): Genai.Query.Result;

    /**
     * The files were used as part of the #rationale to generate the #answer.
     */
    readonly rationaleSources?: Array_Type<Genai.Query.ResultToSourceFileRelation>;
    withRationaleSources(rationaleSources: Array_Type<Genai.Query.ResultToSourceFileRelation> | Array<IGenai.Query.ResultToSourceFileRelation> | null): Genai.Query.Result;

    /**
     * All unstructured sources that were presented to the llm to generate the #answer.
     * This includes the #rationaleSources and other sources that were given to the llm but not used.
     */
    readonly potentialRationaleSources?: Array_Type<Genai.Query.ResultToSourceFileRelation>;
    withPotentialRationaleSources(potentialRationaleSources: Array_Type<Genai.Query.ResultToSourceFileRelation> | Array<IGenai.Query.ResultToSourceFileRelation> | null): Genai.Query.Result;

    /**
     * The plan used to generate the result - {@link Genai.Agent.Dynamic}.
     */
    readonly plan?: Genai.Agent.DynamicTrajectory;
    withPlan(plan: IGenai.Agent.DynamicTrajectory | null): Genai.Query.Result;

    /**
     * Relation records that link this result to the sources that were used to generate it. There is a many-to-many
     * relationship, allowing sources to be used in multiple results and results to be generated from multiple sources.
     */
    readonly sourceRelations?: Array_Type<Genai.Query.ResultToSourceRelation>;
    withSourceRelations(sourceRelations: Array_Type<Genai.Query.ResultToSourceRelation> | Array<IGenai.Query.ResultToSourceRelation> | null): Genai.Query.Result;

    /**
     * The chat that the user had with the chat bot related to this original {@link Genai.Query.Result}.
     */
    readonly chatHistory?: Array_Type<Genai.Query.ChatMessage>;
    withChatHistory(chatHistory: Array_Type<Genai.Query.ChatMessage> | Array<IGenai.Query.ChatMessage> | null): Genai.Query.Result;

    /**
     * A field to store intermediate (i.e. while processing) portions of the overall result.
     */
    readonly intermediateResults?: Map_Type<string, any>;
    withIntermediateResults(intermediateResults: Map_Type<string, any> | {[key: string]: any} | null): Genai.Query.Result;

    /**
     * The history of interim statuses for the generation on the result
     */
    readonly statusHistory?: Array_Type<Genai.Query.Result.InterimStatusHistory>;
    withStatusHistory(statusHistory: Array_Type<Genai.Query.Result.InterimStatusHistory> | Array<IGenai.Query.Result.InterimStatusHistory> | null): Genai.Query.Result;

    /**
     * The visualization that best suits the structured data answer
     */
    readonly visualization?: GenAiVisualizationBase;
    withVisualization(visualization: IGenAiVisualizationBase | null): Genai.Query.Result;

    /**
     * The steps performed to get to this result
     */
    readonly steps?: Array_Type<Genai.Agent.Step>;
    withSteps(steps: Array_Type<Genai.Agent.Step> | Array<IGenai.Agent.Step> | null): Genai.Query.Result;
    ...
    withConfigKey(configKey: string | null): Genai.Query.Result;

    /**
     * The unstructured query handler used to initiate the query. Used primarily to handle streaming.
     */
    readonly handlerUsed?: Type;
    withHandlerUsed(handlerUsed: IType | null): Genai.Query.Result;

    /**
     * Whether structured data was used to answer the query
     */
    readonly usedStructuredData?: boolean;
    withUsedStructuredData(usedStructuredData: boolean): Genai.Query.Result;

    /**
     * The type of tool used to generate the result
     */
    readonly toolType?: Type;
    withToolType(toolType: IType | null): Genai.Query.Result;

    /**
     * The {@link GenaiCore.Session.Kv} associated with this query
     */
    readonly session?: GenaiCore.Session.Kv;
    withSession(session: IGenaiCore.Session.Kv | null): Genai.Query.Result;

    /**
     * All the feedback given to the generative model result.
     */
    readonly feedback?: Array_Type<Genai.Query.Result.Feedback>;
    withFeedback(feedback: Array_Type<Genai.Query.Result.Feedback> | Array<IGenai.Query.Result.Feedback> | null): Genai.Query.Result;

    /**
     * All child results (if any) for this result. See #parent
     */
    readonly childResults?: Array_Type<Genai.Query.Result>;
    withChildResults(childResults: Array_Type<Genai.Query.Result> | Array<IGenai.Query.Result> | null): Genai.Query.Result;

    /**
     * When a result is generated as only a step/part of generating another result, the inner/child results
     * will have this field populated with the result as part of which this one was generated.
     */
    readonly parent?: Genai.Query.Result;
    withParent(parent: IGenai.Query.Result | null): Genai.Query.Result;
    ...
    withToolId(toolId: string | null): Genai.Query.Result;

    /**
     * The tools available to use when the result was generated
     */
    readonly allToolNames?: Array_Type<string>;
    withAllToolNames(allToolNames: Array_Type<string> | Array<string> | null): Genai.Query.Result;

    /**
     * Indicates whether the result has been edited by the user
     */
    readonly edited?: boolean;
    withEdited(edited: boolean): Genai.Query.Result;

    /**
     * The {@link Genai.Conversation} that this result is a part of.
     */
    readonly conversation?: Genai.Conversation;
    withConversation(conversation: IGenai.Conversation | null): Genai.Query.Result;

    /**
     * Calculated field for the UI result for this query
     */
    readonly getForUiResult?: Genai.Query.Result.GetForUiResult;
    withGetForUiResult(getForUiResult: IGenai.Query.Result.GetForUiResult | null): Genai.Query.Result;

    /**
     * Returns the time taken to generate the result in milliseconds.
     */
    readonly latency?: number;
    withLatency(latency: number | null): Genai.Query.Result;

    /**
     * The parsed, JSON version of the #engineLog.
     */
    readonly parsedEngineLog?: any;
    withParsedEngineLog(parsedEngineLog: any | null): Genai.Query.Result;

    /**
     * Queries that can be a follow-up of the result, used for chatbot suggestions.
     */
    readonly suggestedFollowUpQueries?: Array_Type<Genai.Query>;
    withSuggestedFollowUpQueries(suggestedFollowUpQueries: Array_Type<Genai.Query> | Array<IGenai.Query> | null): Genai.Query.Result;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.Query.Result | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.Query.Result | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.Query.Result | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.Query.Result | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.Query.Result;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Query.Result;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.Query.Result;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Query.Result>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.Query.Result>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.Query.Result;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Query.Result;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.Query.Result;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.Query.Result;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.Query.Result;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.Query.Result;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.Query.Result;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.Query.Result;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.Query.Result;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.Query.Result;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.Query.Result;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.Query.Result;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.Query.Result;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.Query.Result;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.Query.Result;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.Query.Result;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.Query.Result;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.Query.Result;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.Query.Result;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.Query.Result;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.Query.Result;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.Query.Result;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.Query.Result;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.Query.Result;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.Query.Result;

    mergeJson(json: any): Genai.Query.Result;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.Query.Result;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.Query.Result;
     ...
     */
    singletonArray(): Array_Type<Genai.Query.Result>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.Query.Result> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.Query.Result> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.Query.Result>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.Query.Result> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.Query.Result> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.Query.Result> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.Query.Result>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.Query.Result>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.Query.Result;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.Query.Result;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.Query.Result;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.Query.Result;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.Query.Result;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.Query.Result;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.Query.Result | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.Query.Result;
     ...
     */
    static cachedEmptyInst(): Genai.Query.Result;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.Query.Result> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.Query.Result;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.Query.Result>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.Query.Result>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.Query.Result> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.Query.Result>> | null;
     ...
     */
    static evalFeatureSetBatch(batch: Array_Type<Genai.Query.Result>, featureSet: Feature.Set, spec?: EvalFeatureSpec): Data | null;
     ...
     * ```
     */
    static evalFeaturesBatch(batch: Array_Type<Genai.Query.Result>, features: Array_Type<string>, spec?: EvalFeaturesSpec): Data | null;
     ...
     */
    get(include?: string): Genai.Query.Result | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.Query.Result | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.Query.Result;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.Query.Result | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.Query.Result;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.Query.Result | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.Query.Result | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.Query.Result>, spec?: UpsertSpec): ObjList<Genai.Query.Result> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.Query.Result>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.Query.Result> | null;
     ...
     */
    update(srcObj?: Genai.Query.Result, spec?: UpsertSpec): Genai.Query.Result | null;
     ...
     */
    upsert(srcObj?: Genai.Query.Result, spec?: UpsertSpec): Genai.Query.Result | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.Query.Result | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.Query.Result | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.Query.Result | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.Query.Result>, srcObjs?: Array_Type<Genai.Query.Result>, spec?: UpsertSpec): ObjList<Genai.Query.Result> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.Query.Result> | null>, spec?: UpsertSpec): ObjList<Genai.Query.Result> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.Query.Result>, srcObjs?: Array_Type<Genai.Query.Result>, spec?: UpsertSpec): ObjList<Genai.Query.Result> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.Query.Result> | null>, spec?: UpsertSpec): ObjList<Genai.Query.Result> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.Query.Result>, spec?: TouchSpec): ObjList<Genai.Query.Result> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Query.Result>, spec?: MergeSpec): ObjList<Genai.Query.Result> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.Query.Result>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Query.Result> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.Query.Result> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.Query.Result> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.Query.Result, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.Query.Result, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.Query.Result>, spec?: UpsertSpec): ObjList<Genai.Query.Result> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.Query.Result>, spec?: UpsertSpec): ObjList<Genai.Query.Result> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.Query.Result | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.Query.Result>): ObjList<Genai.Query.Result>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.Query.Result>): ObjList<Genai.Query.Result>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.Query.Result>): ObjList<Genai.Query.Result>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.Query.Result>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.Query.Result>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.Query.Result>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.Query.Result>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.Query.Result>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.Query.Result | null;
     ...
     */
    withoutIdentity(): Genai.Query.Result | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.Query.Result>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.Query.Result, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.Query.Result>, callback?: λFunction<Genai.Query.Result | null, Genai.Query.Result | null>): ObjList<Genai.Query.Result>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.Query.Result>, callback?: λFunction<Genai.Query.Result | null, Genai.Query.Result | null>): Array_Type<ObjError> | null;
     ...
     */
    allRationaleSources(): Array_Type<Genai.Query.ResultToSourceFileRelation> | null;
     ...
     * them to the returned array.
     */
    allPotentialSources(): Array_Type<Genai.Query.ResultToSourceFileRelation> | null;
     ...
     * returned array.
     */
    allSources(): Array_Type<Genai.Query.ResultToSourceRelation> | null;
     ...
     * returned array.
     */
    allStructuredDataSources(): Array_Type<Genai.Query.ResultToStructuredDataSourceRelation> | null;
     ...
     */
    allCitedStructuredDataSources(): Array_Type<Genai.Query.ResultToStructuredDataSourceRelation> | null;
     ...
     */
    updateStatus(status: string, statusParent?: Genai.Query.Result.InterimStatusHistory, inPlace?: boolean): Genai.Query.Result.UpdateStatusResponse;
     ...
     */
    allVisualizations(): Array_Type<GenAiVisualizationBase> | null;
     ...
     */
    generateVisualDebuggingGraphs(mediaType?: string = 'PNG', removeFinalSpecFromGraph?: boolean): Array_Type<Image> | null;
     ...
     *        be combined.
     */
    addLogsToJsonDumpsEngineLog(entryKey: string, logs: any, getInstance?: boolean): Genai.Query.Result;
     ...
     */
    addLogsDictToJsonDumpsEngineLog(logsDict: any, getInstance?: boolean, persist?: boolean, returnInclude?: string): Genai.Query.Result;
     ...
     */
    createChildResult(toolId: string, isStructuredTool?: boolean, queryString?: string): Genai.Query.Result;

    /**
     * Returns a {@link Genai.Conversation} for this result.
     */
    getConversation(): Genai.Conversation;

    /**
     * Leave feedback for a {@link Genai.Query.Result}.
     */
    leaveFeedback(feedback: Genai.Query.Result.BaseFeedback): Genai.Query.Result.Feedback;

    /**
     * Returns the generative AI result with the interim statuses and other fields used to populate the UI (rationale, answer, etc)
     */
    getForUi(): Genai.Query.Result.GetForUiResult;
     ...
     */
    static getChildResultsForUi(genAiQueryResult: Genai.Query.Result): Array_Type<Genai.Query.Result.BaseResultForUi> | null;
     ...
     */
    markQueryCompleted(): Genai.Query.Result;
     ...
     * @return The updated {@link Genai.Query.Result}
     */
    addToolNamesFromToolkit(toolkitName: string): Genai.Query.Result;
     ...
     */
    getSortedStatuses(): Array_Type<Genai.Query.Result.InterimStatusHistory>;

    /**
     * Helper function to set {@link Genai.Query.Result#edited} to true for a given {@link Genai.Query.Result}.
     * @return the updated {@link Genai.Query.Result}
     */
    markAsEdited(): Genai.Query.Result;

    /**
     * The {@link Genai.Query.Result} that this result was generated from.
     */
    static fetchFilteredQueriesCount(spec?: FetchSpec, user?: User): number;

    /**
     * The {@link Genai.Query.Result} that this result was generated from.
     */
    static fetchFilteredQueries(spec?: FetchSpec, user?: User): FetchResult<any> | null;
  }
}
