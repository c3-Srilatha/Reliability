// TypeScript definitions for the C3 type GenAiUiAgentsApplicationState

/**
 * Application state for the Agents page.
 *
 * @remarks this represents a value passed to a method that expects an instance of GenAiUiAgentsApplicationState
 */
declare interface IGenAiUiAgentsApplicationState {
 ...
 */
declare class GenAiUiAgentsApplicationState extends Obj  {

  /**
   * The {@link Genai.Query.Result.GetForUiResult}s of the feed by their ids.
   */
  readonly genAiResultsById?: Map_Type<string, Genai.Query.Result.GetForUiResult>;
  withGenAiResultsById(genAiResultsById: Map_Type<string, Genai.Query.Result.GetForUiResult> | {[key: string]: IGenai.Query.Result.GetForUiResult} | null): GenAiUiAgentsApplicationState;
  ...
  withGenAiResultsOrder(genAiResultsOrder: Array_Type<string> | Array<string> | null): GenAiUiAgentsApplicationState;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): GenAiUiAgentsApplicationState;

  /**
   * Unique identifier for the logical object that instance of this type represents.
   */
  readonly id?: string;
  withId(id: string | null): GenAiUiAgentsApplicationState;

  /**
   * The name of the component. Optional field for informational purposes only.
   */
  readonly name?: string;
  withName(name: string | null): GenAiUiAgentsApplicationState;
  ...
  withDataSpec(dataSpec: IUiSdlNoData | null): GenAiUiAgentsApplicationState;

  /**
   * Disable if you want to avoid sending any and all requests for this component on first render.
   */
  readonly disableDataRequestOnFirstRender?: boolean;
  withDisableDataRequestOnFirstRender(disableDataRequestOnFirstRender: boolean): GenAiUiAgentsApplicationState;

  /**
   * Whether the effect triggers and epics have been registered
   */
  readonly triggersRegistered?: boolean;
  withTriggersRegistered(triggersRegistered: boolean): GenAiUiAgentsApplicationState;

  /**
   * Whether to wrap the component with a div which has a class name of its metdata id. Useful for targeting with css.
   */
  readonly wrapWithMetadataId?: boolean;
  withWrapWithMetadataId(wrapWithMetadataId: boolean): GenAiUiAgentsApplicationState;

  /**
   * The Redux namespace for the application state to indicate where the application data is stored in the Redux state.
   */
  readonly REDUX_NAMESPACE?: string;
  withREDUX_NAMESPACE(REDUX_NAMESPACE: string | null): GenAiUiAgentsApplicationState;

  /**
   * Collection of extra async {@link UiSdlEffectTrigger}.
   */
  readonly effectTriggers?: Array_Type<UiSdlEffectTrigger>;
  withEffectTriggers(effectTriggers: Array_Type<UiSdlEffectTrigger> | Array<IUiSdlEffectTrigger> | null): GenAiUiAgentsApplicationState;
  ...
  withDynamicData(dynamicData: Map_Type<string, any> | {[key: string]: any} | null): GenAiUiAgentsApplicationState;

  /**
   * The visualization data used to populate charts for {@link Genai.Agent.DynamicData} and denoted by their ids.
   */
  readonly visualizationData?: Map_Type<string, any>;
  withVisualizationData(visualizationData: Map_Type<string, any> | {[key: string]: any} | null): GenAiUiAgentsApplicationState;
  ...
  withMaxInStateResults(maxInStateResults: number | null): GenAiUiAgentsApplicationState;
  ...
  withLeastRecentlyUsedResults(leastRecentlyUsedResults: Array_Type<string> | Array<string> | null): GenAiUiAgentsApplicationState;
  ...
  withGenAiResultToResourcesMapping(genAiResultToResourcesMapping: Map_Type<string, Map_Type<string, Array_Type<string>>> | {[key: string]: Map_Type<string, Array_Type<string>> | {[key: string]: Array_Type<string> | Array<string>}} | null): GenAiUiAgentsApplicationState;
  ...
  withFocusedGenAiResult(focusedGenAiResult: string | null): GenAiUiAgentsApplicationState;

  /**
   * Whether the filter bar is expanded or collapsed.
   */
  readonly filterBarExpanded?: boolean;
  withFilterBarExpanded(filterBarExpanded: boolean): GenAiUiAgentsApplicationState;

  /**
   * The progress bar for the feed.
   */
  readonly progressBar?: GenAiUiProgressBarBase;
  withProgressBar(progressBar: IGenAiUiProgressBarBase | null): GenAiUiAgentsApplicationState;

  /**
   * Map of target tool for a query to its corresponding session.
   */
  readonly sessionsByTool?: Map_Type<string, GenaiCore.Session.Kv>;
  withSessionsByTool(sessionsByTool: Map_Type<string, GenaiCore.Session.Kv> | {[key: string]: IGenaiCore.Session.Kv} | null): GenAiUiAgentsApplicationState;
   ...
   * @see #toJson
   */
  static fromJson(json: any): GenAiUiAgentsApplicationState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): GenAiUiAgentsApplicationState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): GenAiUiAgentsApplicationState | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): GenAiUiAgentsApplicationState | null;
   ...
   */
  replaceType(old: Type, new_: Type): GenAiUiAgentsApplicationState;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenAiUiAgentsApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenAiUiAgentsApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenAiUiAgentsApplicationState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenAiUiAgentsApplicationState>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenAiUiAgentsApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenAiUiAgentsApplicationState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenAiUiAgentsApplicationState;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): GenAiUiAgentsApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): GenAiUiAgentsApplicationState;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): GenAiUiAgentsApplicationState;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenAiUiAgentsApplicationState;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenAiUiAgentsApplicationState;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): GenAiUiAgentsApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: string): GenAiUiAgentsApplicationState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): GenAiUiAgentsApplicationState;
   ...
   */
  withoutFields(fields: Array_Type<string>): GenAiUiAgentsApplicationState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): GenAiUiAgentsApplicationState;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): GenAiUiAgentsApplicationState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenAiUiAgentsApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: string): GenAiUiAgentsApplicationState;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): GenAiUiAgentsApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: string): GenAiUiAgentsApplicationState;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): GenAiUiAgentsApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: string): GenAiUiAgentsApplicationState;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): GenAiUiAgentsApplicationState;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenAiUiAgentsApplicationState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): GenAiUiAgentsApplicationState;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenAiUiAgentsApplicationState;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenAiUiAgentsApplicationState;

  mergeJson(json: any): GenAiUiAgentsApplicationState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenAiUiAgentsApplicationState;
   ...
   */
  sumObj(other: Obj, deep?: boolean): GenAiUiAgentsApplicationState;
   ...
   */
  singletonArray(): Array_Type<GenAiUiAgentsApplicationState>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<GenAiUiAgentsApplicationState> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<GenAiUiAgentsApplicationState> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<GenAiUiAgentsApplicationState>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<GenAiUiAgentsApplicationState> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, GenAiUiAgentsApplicationState> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenAiUiAgentsApplicationState> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<GenAiUiAgentsApplicationState>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<GenAiUiAgentsApplicationState>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenAiUiAgentsApplicationState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenAiUiAgentsApplicationState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenAiUiAgentsApplicationState;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): GenAiUiAgentsApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenAiUiAgentsApplicationState;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): GenAiUiAgentsApplicationState;
   ...
   * @see #fromString
   */
  static make(s: string): GenAiUiAgentsApplicationState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenAiUiAgentsApplicationState;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): GenAiUiAgentsApplicationState;
   ...
   */
  static cachedEmptyInst(): GenAiUiAgentsApplicationState;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<GenAiUiAgentsApplicationState> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): GenAiUiAgentsApplicationState;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<GenAiUiAgentsApplicationState>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<GenAiUiAgentsApplicationState>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<GenAiUiAgentsApplicationState> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenAiUiAgentsApplicationState>> | null;
   ...
   */
  dependencies(): MetadataDeps<GenAiUiAgentsApplicationState>;

  save(subPath?: string, contentType?: string): GenAiUiAgentsApplicationState;
  ...
  update(srcObj?: GenAiUiAgentsApplicationState, spec?: UpsertSpec): GenAiUiAgentsApplicationState | null;

  upsert(srcObj?: GenAiUiAgentsApplicationState, spec?: UpsertSpec): GenAiUiAgentsApplicationState | null;
   ...
   * @see #toString
   */
  static fromString(s: string): GenAiUiAgentsApplicationState | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string, failIfMissing?: boolean): GenAiUiAgentsApplicationState | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: GenAiUiAgentsApplicationState, state: UiSdlReduxState): GenAiUiAgentsApplicationState | null;
   ...
   */
  static setSelectedAgentAction(id: string): UiSdlReduxAction<any> | null;
   ...
   */
  static setSelectedAgentReducer(state?: UiSdlReduxState, action?: UiSdlReduxAction<any>): UiSdlReduxState | null;

  /**
   * Action creator for actions of type `REFRESH_AVAILABLE_AGENT_TOOL_OPTIONS`
   */
  static refreshAvailableAgentToolOptionsAction(): UiSdlReduxAction<any>;
   ...
   * @return a Redux action
   */
  static setAvailableAgentToolsAction(tools: Array_Type<string>): UiSdlReduxAction<any> | null;
   ...
   * @return a new Redux state
   */
  static setAvailableAgentToolsReducer(state?: UiSdlReduxState, action?: UiSdlReduxAction<any>): UiSdlReduxState | null;
}
