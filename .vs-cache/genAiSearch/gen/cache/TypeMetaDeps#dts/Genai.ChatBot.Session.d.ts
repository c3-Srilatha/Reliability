// TypeScript definitions for the C3 type Genai.ChatBot.Session
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.ChatBot.Session
 */
declare namespace Genai.ChatBot {
  export interface ISession {
     ...
     */
    latestResult?: IGenai.Query.Result;
 ...
 */
declare namespace Genai.ChatBot {
  export class Session extends Obj  {
     ...
     */
    readonly id: string;
    withId(id: string): Genai.ChatBot.Session;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.ChatBot.Session;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.ChatBot.Session;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.ChatBot.Session;
    ...
    withVersion(version: number | null): Genai.ChatBot.Session;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.ChatBot.Session;

    /**
     * Associated parent for the current chat. Synonymous with the first question of a chat session.
     */
    readonly parentResult?: Genai.Query.Result;
    withParentResult(parentResult: IGenai.Query.Result | null): Genai.ChatBot.Session;

    /**
     * The most recent query result for a chat session.
     */
    readonly latestResult?: Genai.Query.Result;
    withLatestResult(latestResult: IGenai.Query.Result | null): Genai.ChatBot.Session;

    /**
     * The chat history associated with a chat session.
     */
    readonly chatHistory?: Array_Type<Genai.Query.ChatMessage>;
    withChatHistory(chatHistory: Array_Type<Genai.Query.ChatMessage> | Array<IGenai.Query.ChatMessage> | null): Genai.ChatBot.Session;

    /**
     * The user associated with the chat session.
     */
    readonly user?: User;
    withUser(user: IUser | null): Genai.ChatBot.Session;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.ChatBot.Session | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.ChatBot.Session | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.ChatBot.Session | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.ChatBot.Session | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.ChatBot.Session;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.ChatBot.Session;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.ChatBot.Session;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.ChatBot.Session>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.ChatBot.Session>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.ChatBot.Session;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.ChatBot.Session;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.ChatBot.Session;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.ChatBot.Session;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.ChatBot.Session;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.ChatBot.Session;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.ChatBot.Session;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.ChatBot.Session;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.ChatBot.Session;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.ChatBot.Session;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.ChatBot.Session;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.ChatBot.Session;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.ChatBot.Session;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.ChatBot.Session;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.ChatBot.Session;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.ChatBot.Session;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.ChatBot.Session;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.ChatBot.Session;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.ChatBot.Session;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.ChatBot.Session;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.ChatBot.Session;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.ChatBot.Session;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.ChatBot.Session;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.ChatBot.Session;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.ChatBot.Session;

    mergeJson(json: any): Genai.ChatBot.Session;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.ChatBot.Session;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.ChatBot.Session;
     ...
     */
    singletonArray(): Array_Type<Genai.ChatBot.Session>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.ChatBot.Session> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.ChatBot.Session> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.ChatBot.Session>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.ChatBot.Session> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.ChatBot.Session> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.ChatBot.Session> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.ChatBot.Session>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.ChatBot.Session>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.ChatBot.Session;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.ChatBot.Session;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.ChatBot.Session;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.ChatBot.Session;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.ChatBot.Session;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.ChatBot.Session;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.ChatBot.Session | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.ChatBot.Session;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.ChatBot.Session;
     ...
     */
    static cachedEmptyInst(): Genai.ChatBot.Session;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.ChatBot.Session> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.ChatBot.Session;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.ChatBot.Session>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.ChatBot.Session>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.ChatBot.Session> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.ChatBot.Session>> | null;
     ...
     */
    get(include?: string): Genai.ChatBot.Session | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.ChatBot.Session | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.ChatBot.Session;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.ChatBot.Session | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.ChatBot.Session;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.ChatBot.Session | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.ChatBot.Session | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.ChatBot.Session>, spec?: UpsertSpec): ObjList<Genai.ChatBot.Session> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.ChatBot.Session>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.ChatBot.Session> | null;
     ...
     */
    update(srcObj?: Genai.ChatBot.Session, spec?: UpsertSpec): Genai.ChatBot.Session | null;
     ...
     */
    upsert(srcObj?: Genai.ChatBot.Session, spec?: UpsertSpec): Genai.ChatBot.Session | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.ChatBot.Session | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.ChatBot.Session | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.ChatBot.Session | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.ChatBot.Session>, srcObjs?: Array_Type<Genai.ChatBot.Session>, spec?: UpsertSpec): ObjList<Genai.ChatBot.Session> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.ChatBot.Session> | null>, spec?: UpsertSpec): ObjList<Genai.ChatBot.Session> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.ChatBot.Session>, srcObjs?: Array_Type<Genai.ChatBot.Session>, spec?: UpsertSpec): ObjList<Genai.ChatBot.Session> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.ChatBot.Session> | null>, spec?: UpsertSpec): ObjList<Genai.ChatBot.Session> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.ChatBot.Session>, spec?: TouchSpec): ObjList<Genai.ChatBot.Session> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.ChatBot.Session>, spec?: MergeSpec): ObjList<Genai.ChatBot.Session> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.ChatBot.Session>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.ChatBot.Session> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.ChatBot.Session> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.ChatBot.Session> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.ChatBot.Session, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.ChatBot.Session, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.ChatBot.Session>, spec?: UpsertSpec): ObjList<Genai.ChatBot.Session> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.ChatBot.Session>, spec?: UpsertSpec): ObjList<Genai.ChatBot.Session> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.ChatBot.Session | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.ChatBot.Session>): ObjList<Genai.ChatBot.Session>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.ChatBot.Session>): ObjList<Genai.ChatBot.Session>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.ChatBot.Session>): ObjList<Genai.ChatBot.Session>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.ChatBot.Session>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.ChatBot.Session>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.ChatBot.Session>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.ChatBot.Session>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.ChatBot.Session>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.ChatBot.Session | null;
     ...
     */
    withoutIdentity(): Genai.ChatBot.Session | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.ChatBot.Session>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.ChatBot.Session, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.ChatBot.Session>, callback?: λFunction<Genai.ChatBot.Session | null, Genai.ChatBot.Session | null>): ObjList<Genai.ChatBot.Session>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.ChatBot.Session>, callback?: λFunction<Genai.ChatBot.Session | null, Genai.ChatBot.Session | null>): Array_Type<ObjError> | null;
     ...
     */
    startChat(question: string): string;

    /**
     * Private - should not be called directly.
     */
    followupChat(followup_question: string): string;
  }
}
