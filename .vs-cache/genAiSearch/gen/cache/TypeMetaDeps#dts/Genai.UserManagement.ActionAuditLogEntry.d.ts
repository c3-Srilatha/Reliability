// TypeScript definitions for the C3 type Genai.UserManagement.ActionAuditLogEntry

/**
 * A log entry representing an action taken by a {@link User} on another user.
 *
 * @remarks this represents a value passed to a method that expects an instance of Genai.UserManagement.ActionAuditLogEntry
 */
declare namespace Genai.UserManagement {
  export interface IActionAuditLogEntry {
 ...
 */
declare namespace Genai.UserManagement {
  export class ActionAuditLogEntry extends Obj  {
    ...
    withTypeIdent(typeIdent: string | null): Genai.UserManagement.ActionAuditLogEntry;
     ...
     */
    readonly id: string;
    withId(id: string): Genai.UserManagement.ActionAuditLogEntry;
    ...
    withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): Genai.UserManagement.ActionAuditLogEntry;

    /**
     * Name of the Obj instance
     */
    readonly name?: string;
    withName(name: string | null): Genai.UserManagement.ActionAuditLogEntry;

    /**
     * Various system fields.
     */
    readonly meta?: Meta;
    withMeta(meta: IMeta | null): Genai.UserManagement.ActionAuditLogEntry;
    ...
    withVersion(version: number | null): Genai.UserManagement.ActionAuditLogEntry;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type;
    withTypeWithBindings(typeWithBindings: IType | null): Genai.UserManagement.ActionAuditLogEntry;

    /**
     * The user who performed the action
     */
    readonly user?: User;
    withUser(user: IUser | null): Genai.UserManagement.ActionAuditLogEntry;
    ...
    withTargetUserId(targetUserId: string | null): Genai.UserManagement.ActionAuditLogEntry;

    /**
     * The action that was performed
     */
    readonly action?: string;
    withAction(action: string | null): Genai.UserManagement.ActionAuditLogEntry;

    /**
     * The timestamp of the action
     */
    readonly timestamp?: DateTime;
    withTimestamp(timestamp: DateTime | Date | string | null): Genai.UserManagement.ActionAuditLogEntry;
     ...
     * @see #toJson
     */
    static fromJson(json: any): Genai.UserManagement.ActionAuditLogEntry | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string): Genai.UserManagement.ActionAuditLogEntry | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string): Genai.UserManagement.ActionAuditLogEntry | null;
     ...
     */
    static deserialize(contentStr: string, contentType: string): Genai.UserManagement.ActionAuditLogEntry | null;
     ...
     */
    replaceType(old: Type, new_: Type): Genai.UserManagement.ActionAuditLogEntry;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.UserManagement.ActionAuditLogEntry;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): Genai.UserManagement.ActionAuditLogEntry;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.UserManagement.ActionAuditLogEntry>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<Genai.UserManagement.ActionAuditLogEntry>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): Genai.UserManagement.ActionAuditLogEntry;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.UserManagement.ActionAuditLogEntry;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Genai.UserManagement.ActionAuditLogEntry;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Genai.UserManagement.ActionAuditLogEntry;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Genai.UserManagement.ActionAuditLogEntry;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Genai.UserManagement.ActionAuditLogEntry;
     ...
     * @return new Obj
     */
    withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): Genai.UserManagement.ActionAuditLogEntry;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Genai.UserManagement.ActionAuditLogEntry;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Genai.UserManagement.ActionAuditLogEntry;
     ...
     * @see #removeField
     */
    withoutField(field: string): Genai.UserManagement.ActionAuditLogEntry;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType): Genai.UserManagement.ActionAuditLogEntry;
     ...
     */
    withoutFields(fields: Array_Type<string>): Genai.UserManagement.ActionAuditLogEntry;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: Array_Type<FieldType>): Genai.UserManagement.ActionAuditLogEntry;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Genai.UserManagement.ActionAuditLogEntry;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): Genai.UserManagement.ActionAuditLogEntry;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Genai.UserManagement.ActionAuditLogEntry;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Genai.UserManagement.ActionAuditLogEntry;
     ...
     * @see #removeField
     */
    unsetField(field: string): Genai.UserManagement.ActionAuditLogEntry;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Genai.UserManagement.ActionAuditLogEntry;
     ...
     * @see #unsetField
     */
    removeField(field: string): Genai.UserManagement.ActionAuditLogEntry;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Genai.UserManagement.ActionAuditLogEntry;
     ...
     */
    mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): Genai.UserManagement.ActionAuditLogEntry;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj, otherFieldsFilter: Type): Genai.UserManagement.ActionAuditLogEntry;
     ...
     */
    mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): Genai.UserManagement.ActionAuditLogEntry;
     ...
     */
    mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): Genai.UserManagement.ActionAuditLogEntry;

    mergeJson(json: any): Genai.UserManagement.ActionAuditLogEntry;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): Genai.UserManagement.ActionAuditLogEntry;
     ...
     */
    sumObj(other: Obj, deep?: boolean): Genai.UserManagement.ActionAuditLogEntry;
     ...
     */
    singletonArray(): Array_Type<Genai.UserManagement.ActionAuditLogEntry>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: Array_Type<any>[]): Array_Type<Genai.UserManagement.ActionAuditLogEntry> | null;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Genai.UserManagement.ActionAuditLogEntry> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): Set_Type<Genai.UserManagement.ActionAuditLogEntry>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Genai.UserManagement.ActionAuditLogEntry> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string, Genai.UserManagement.ActionAuditLogEntry> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Genai.UserManagement.ActionAuditLogEntry> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Genai.UserManagement.ActionAuditLogEntry>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Genai.UserManagement.ActionAuditLogEntry>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): Genai.UserManagement.ActionAuditLogEntry;
     ...
     * @see withDefaults
     */
    static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): Genai.UserManagement.ActionAuditLogEntry;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): Genai.UserManagement.ActionAuditLogEntry;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Genai.UserManagement.ActionAuditLogEntry;
     ...
     * @see withDefaults
     */
    static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): Genai.UserManagement.ActionAuditLogEntry;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Genai.UserManagement.ActionAuditLogEntry;
     ...
     * @see #fromString
     */
    static make(s: string): Genai.UserManagement.ActionAuditLogEntry | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): Genai.UserManagement.ActionAuditLogEntry;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Genai.UserManagement.ActionAuditLogEntry;
     ...
     */
    static cachedEmptyInst(): Genai.UserManagement.ActionAuditLogEntry;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec): Stream<Genai.UserManagement.ActionAuditLogEntry> | null;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec): Genai.UserManagement.ActionAuditLogEntry;
     ...
     */
    static fetch(spec?: FetchSpec): FetchResult<Genai.UserManagement.ActionAuditLogEntry>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Genai.UserManagement.ActionAuditLogEntry>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec): Stream<Genai.UserManagement.ActionAuditLogEntry> | null;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<Genai.UserManagement.ActionAuditLogEntry>> | null;
     ...
     */
    get(include?: string): Genai.UserManagement.ActionAuditLogEntry | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string): Genai.UserManagement.ActionAuditLogEntry | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Genai.UserManagement.ActionAuditLogEntry;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string): Genai.UserManagement.ActionAuditLogEntry | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Genai.UserManagement.ActionAuditLogEntry;
     ...
     * @see #toString
     */
    static fromString(s: string): Genai.UserManagement.ActionAuditLogEntry | null;
     ...
     */
    create(spec?: UpsertSpec): Genai.UserManagement.ActionAuditLogEntry | null;
     ...
     */
    static createBatch(objs: Array_Type<Genai.UserManagement.ActionAuditLogEntry>, spec?: UpsertSpec): ObjList<Genai.UserManagement.ActionAuditLogEntry> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Genai.UserManagement.ActionAuditLogEntry>, spec?: CreateBatchObjStreamSpec): ObjList<Genai.UserManagement.ActionAuditLogEntry> | null;
     ...
     */
    update(srcObj?: Genai.UserManagement.ActionAuditLogEntry, spec?: UpsertSpec): Genai.UserManagement.ActionAuditLogEntry | null;
     ...
     */
    upsert(srcObj?: Genai.UserManagement.ActionAuditLogEntry, spec?: UpsertSpec): Genai.UserManagement.ActionAuditLogEntry | null;
     ...
     */
    merge(spec?: MergeSpec): Genai.UserManagement.ActionAuditLogEntry | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec): Genai.UserManagement.ActionAuditLogEntry | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec): Genai.UserManagement.ActionAuditLogEntry | null;
     ...
     */
    static updateBatch(objs: Array_Type<Genai.UserManagement.ActionAuditLogEntry>, srcObjs?: Array_Type<Genai.UserManagement.ActionAuditLogEntry>, spec?: UpsertSpec): ObjList<Genai.UserManagement.ActionAuditLogEntry> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<Array_Type<Genai.UserManagement.ActionAuditLogEntry> | null>, spec?: UpsertSpec): ObjList<Genai.UserManagement.ActionAuditLogEntry> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: Array_Type<Genai.UserManagement.ActionAuditLogEntry>, srcObjs?: Array_Type<Genai.UserManagement.ActionAuditLogEntry>, spec?: UpsertSpec): ObjList<Genai.UserManagement.ActionAuditLogEntry> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<Array_Type<Genai.UserManagement.ActionAuditLogEntry> | null>, spec?: UpsertSpec): ObjList<Genai.UserManagement.ActionAuditLogEntry> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: Array_Type<Genai.UserManagement.ActionAuditLogEntry>, spec?: TouchSpec): ObjList<Genai.UserManagement.ActionAuditLogEntry> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.UserManagement.ActionAuditLogEntry>, spec?: MergeSpec): ObjList<Genai.UserManagement.ActionAuditLogEntry> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: Array_Type<Genai.UserManagement.ActionAuditLogEntry>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.UserManagement.ActionAuditLogEntry> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<Array_Type<Genai.UserManagement.ActionAuditLogEntry> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<Genai.UserManagement.ActionAuditLogEntry> | null;
     ...
     */
    static mergeAll(mergeObj: Genai.UserManagement.ActionAuditLogEntry, spec?: MergeAllSpec): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Genai.UserManagement.ActionAuditLogEntry, mergeInclude: string, spec?: MergeAllSpec): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: Array_Type<Genai.UserManagement.ActionAuditLogEntry>, spec?: UpsertSpec): ObjList<Genai.UserManagement.ActionAuditLogEntry> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: Array_Type<Genai.UserManagement.ActionAuditLogEntry>, spec?: UpsertSpec): ObjList<Genai.UserManagement.ActionAuditLogEntry> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Genai.UserManagement.ActionAuditLogEntry | null;
     ...
     */
    static beforeCreate(objs: Array_Type<Genai.UserManagement.ActionAuditLogEntry>): ObjList<Genai.UserManagement.ActionAuditLogEntry>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: Array_Type<Genai.UserManagement.ActionAuditLogEntry>): ObjList<Genai.UserManagement.ActionAuditLogEntry>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: Array_Type<Genai.UserManagement.ActionAuditLogEntry>): ObjList<Genai.UserManagement.ActionAuditLogEntry>;
     ...
     */
    static afterCreate(objs: Array_Type<Genai.UserManagement.ActionAuditLogEntry>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: Array_Type<Genai.UserManagement.ActionAuditLogEntry>): Array_Type<ObjError> | null;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: Array_Type<Genai.UserManagement.ActionAuditLogEntry>): Array_Type<ObjError> | null;
     ...
     */
    static startImportData(spec?: StartImportDataSpec): PushStream<Genai.UserManagement.ActionAuditLogEntry>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<Genai.UserManagement.ActionAuditLogEntry>;
     ...
     */
    static forId(id: string, failIfMissing?: boolean): Genai.UserManagement.ActionAuditLogEntry | null;
     ...
     */
    withoutIdentity(): Genai.UserManagement.ActionAuditLogEntry | null;
     ...
     */
    static typeOfBatch(objs: Array_Type<Genai.UserManagement.ActionAuditLogEntry>): Array_Type<EntityType> | null;
     ...
     */
    static dbEcho(template?: Genai.UserManagement.ActionAuditLogEntry, count?: number, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: Array_Type<Genai.UserManagement.ActionAuditLogEntry>, callback?: λFunction<Genai.UserManagement.ActionAuditLogEntry | null, Genai.UserManagement.ActionAuditLogEntry | null>): ObjList<Genai.UserManagement.ActionAuditLogEntry>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: Array_Type<Genai.UserManagement.ActionAuditLogEntry>, callback?: λFunction<Genai.UserManagement.ActionAuditLogEntry | null, Genai.UserManagement.ActionAuditLogEntry | null>): Array_Type<ObjError> | null;
