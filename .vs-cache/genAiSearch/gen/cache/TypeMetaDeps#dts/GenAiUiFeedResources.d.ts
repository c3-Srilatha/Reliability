// TypeScript definitions for the C3 type GenAiUiFeedResources

/**
 * Represents the Gen AI resources of a feed and the utility functions to manage them through an LRU policy
 *
 * @remarks this represents a value passed to a method that expects an instance of GenAiUiFeedResources
 */
declare interface IGenAiUiFeedResources {
 ...
 */
declare class GenAiUiFeedResources extends Obj  {

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): GenAiUiFeedResources;

  /**
   * Unique identifier for the logical object that instance of this type represents.
   */
  readonly id?: string;
  withId(id: string | null): GenAiUiFeedResources;

  /**
   * The name of the component. Optional field for informational purposes only.
   */
  readonly name?: string;
  withName(name: string | null): GenAiUiFeedResources;
  ...
  withDataSpec(dataSpec: IUiSdlNoData | null): GenAiUiFeedResources;

  /**
   * Disable if you want to avoid sending any and all requests for this component on first render.
   */
  readonly disableDataRequestOnFirstRender?: boolean;
  withDisableDataRequestOnFirstRender(disableDataRequestOnFirstRender: boolean): GenAiUiFeedResources;

  /**
   * Whether the effect triggers and epics have been registered
   */
  readonly triggersRegistered?: boolean;
  withTriggersRegistered(triggersRegistered: boolean): GenAiUiFeedResources;

  /**
   * Whether to wrap the component with a div which has a class name of its metdata id. Useful for targeting with css.
   */
  readonly wrapWithMetadataId?: boolean;
  withWrapWithMetadataId(wrapWithMetadataId: boolean): GenAiUiFeedResources;

  /**
   * The Redux namespace for the application state to indicate where the application data is stored in the Redux state.
   */
  readonly REDUX_NAMESPACE?: string;
  withREDUX_NAMESPACE(REDUX_NAMESPACE: string | null): GenAiUiFeedResources;

  /**
   * Collection of extra async {@link UiSdlEffectTrigger}.
   */
  readonly effectTriggers?: Array_Type<UiSdlEffectTrigger>;
  withEffectTriggers(effectTriggers: Array_Type<UiSdlEffectTrigger> | Array<IUiSdlEffectTrigger> | null): GenAiUiFeedResources;
  ...
  withDynamicData(dynamicData: Map_Type<string, any> | {[key: string]: any} | null): GenAiUiFeedResources;

  /**
   * The visualization data used to populate charts for {@link Genai.Agent.DynamicData} and denoted by their ids.
   */
  readonly visualizationData?: Map_Type<string, any>;
  withVisualizationData(visualizationData: Map_Type<string, any> | {[key: string]: any} | null): GenAiUiFeedResources;
  ...
  withMaxInStateResults(maxInStateResults: number | null): GenAiUiFeedResources;
  ...
  withLeastRecentlyUsedResults(leastRecentlyUsedResults: Array_Type<string> | Array<string> | null): GenAiUiFeedResources;
  ...
  withGenAiResultToResourcesMapping(genAiResultToResourcesMapping: Map_Type<string, Map_Type<string, Array_Type<string>>> | {[key: string]: Map_Type<string, Array_Type<string>> | {[key: string]: Array_Type<string> | Array<string>}} | null): GenAiUiFeedResources;
   ...
   * @see #toJson
   */
  static fromJson(json: any): GenAiUiFeedResources | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): GenAiUiFeedResources | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): GenAiUiFeedResources | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): GenAiUiFeedResources | null;
   ...
   */
  replaceType(old: Type, new_: Type): GenAiUiFeedResources;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenAiUiFeedResources;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): GenAiUiFeedResources;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<GenAiUiFeedResources>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<GenAiUiFeedResources>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): GenAiUiFeedResources;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenAiUiFeedResources;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenAiUiFeedResources;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): GenAiUiFeedResources;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): GenAiUiFeedResources;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): GenAiUiFeedResources;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): GenAiUiFeedResources;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenAiUiFeedResources;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): GenAiUiFeedResources;
   ...
   * @see #removeField
   */
  withoutField(field: string): GenAiUiFeedResources;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): GenAiUiFeedResources;
   ...
   */
  withoutFields(fields: Array_Type<string>): GenAiUiFeedResources;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): GenAiUiFeedResources;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): GenAiUiFeedResources;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): GenAiUiFeedResources;
   ...
   * @see #unsetField
   */
  defaultField(field: string): GenAiUiFeedResources;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): GenAiUiFeedResources;
   ...
   * @see #removeField
   */
  unsetField(field: string): GenAiUiFeedResources;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): GenAiUiFeedResources;
   ...
   * @see #unsetField
   */
  removeField(field: string): GenAiUiFeedResources;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): GenAiUiFeedResources;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): GenAiUiFeedResources;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): GenAiUiFeedResources;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): GenAiUiFeedResources;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): GenAiUiFeedResources;

  mergeJson(json: any): GenAiUiFeedResources;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): GenAiUiFeedResources;
   ...
   */
  sumObj(other: Obj, deep?: boolean): GenAiUiFeedResources;
   ...
   */
  singletonArray(): Array_Type<GenAiUiFeedResources>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<GenAiUiFeedResources> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<GenAiUiFeedResources> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<GenAiUiFeedResources>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<GenAiUiFeedResources> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, GenAiUiFeedResources> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenAiUiFeedResources> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<GenAiUiFeedResources>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<GenAiUiFeedResources>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): GenAiUiFeedResources;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): GenAiUiFeedResources;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): GenAiUiFeedResources;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): GenAiUiFeedResources;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): GenAiUiFeedResources;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): GenAiUiFeedResources;
   ...
   * @see #fromString
   */
  static make(s: string): GenAiUiFeedResources | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): GenAiUiFeedResources;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): GenAiUiFeedResources;
   ...
   */
  static cachedEmptyInst(): GenAiUiFeedResources;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<GenAiUiFeedResources> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): GenAiUiFeedResources;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<GenAiUiFeedResources>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<GenAiUiFeedResources>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<GenAiUiFeedResources> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<GenAiUiFeedResources>> | null;
   ...
   */
  dependencies(): MetadataDeps<GenAiUiFeedResources>;

  save(subPath?: string, contentType?: string): GenAiUiFeedResources;
  ...
  update(srcObj?: GenAiUiFeedResources, spec?: UpsertSpec): GenAiUiFeedResources | null;

  upsert(srcObj?: GenAiUiFeedResources, spec?: UpsertSpec): GenAiUiFeedResources | null;
   ...
   * @see #toString
   */
  static fromString(s: string): GenAiUiFeedResources | null;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string, failIfMissing?: boolean): GenAiUiFeedResources | null;
   ...
   */
  static doDataMerge(componentId: string, dataSpecFieldName: string, dataDestinationFieldName: string, props: GenAiUiFeedResources, state: UiSdlReduxState): GenAiUiFeedResources | null;
