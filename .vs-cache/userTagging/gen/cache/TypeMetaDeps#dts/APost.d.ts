// TypeScript definitions for the C3 type APost

/**
 * Test type to simulate a Value for testing purposes.
 *
 * @remarks this represents a value passed to a method that expects an instance of APost
 */
declare interface IAPost {
 ...
 */
declare class APost extends Obj  {
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): APost;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): APost;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): APost;
  ...
  withVersion(version: number | null): APost;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): APost;
   ...
   * @see #toJson
   */
  static fromJson(json: any): APost | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): APost | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): APost | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): APost | null;
   ...
   */
  replaceType(old: Type, new_: Type): APost;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): APost;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): APost;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<APost>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<APost>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): APost;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): APost;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): APost;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): APost;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): APost;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): APost;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): APost;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): APost;
   ...
   * @see #removeField
   */
  withoutField(field: string): APost;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): APost;
   ...
   */
  withoutFields(fields: Array_Type<string>): APost;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): APost;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): APost;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): APost;
   ...
   * @see #unsetField
   */
  defaultField(field: string): APost;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): APost;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): APost;
   ...
   * @see #unsetField
   */
  removeField(field: string): APost;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): APost;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): APost;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): APost;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): APost;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): APost;

  mergeJson(json: any): APost;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): APost;
   ...
   */
  sumObj(other: Obj, deep?: boolean): APost;
   ...
   */
  singletonArray(): Array_Type<APost>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<APost> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<APost> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<APost>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<APost> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, APost> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, APost> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<APost>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<APost>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): APost;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): APost;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): APost;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): APost;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): APost;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): APost;
   ...
   * @see #fromString
   */
  static make(s: string): APost | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): APost;
   ...
   */
  static cachedEmptyInst(): APost;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<APost> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): APost;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<APost>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<APost>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<APost> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<APost>> | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): APost | null;
   ...
   */
  getMissing(spec: GetMissingSpec): APost;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): APost | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): APost;
   ...
   * @see #toString
   */
  static fromString(s: string): APost | null;
   ...
   */
  create(spec?: UpsertSpec): APost | null;
   ...
   */
  static createBatch(objs: Array_Type<APost>, spec?: UpsertSpec): ObjList<APost> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<APost>, spec?: CreateBatchObjStreamSpec): ObjList<APost> | null;
   ...
   */
  update(srcObj?: APost, spec?: UpsertSpec): APost | null;
   ...
   */
  upsert(srcObj?: APost, spec?: UpsertSpec): APost | null;
   ...
   */
  merge(spec?: MergeSpec): APost | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): APost | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): APost | null;
   ...
   */
  static updateBatch(objs: Array_Type<APost>, srcObjs?: Array_Type<APost>, spec?: UpsertSpec): ObjList<APost> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<APost> | null>, spec?: UpsertSpec): ObjList<APost> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<APost>, srcObjs?: Array_Type<APost>, spec?: UpsertSpec): ObjList<APost> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<APost> | null>, spec?: UpsertSpec): ObjList<APost> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<APost>, spec?: TouchSpec): ObjList<APost> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<APost>, spec?: MergeSpec): ObjList<APost> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<APost>, mergeInclude: string, spec?: MergeSpec): ObjList<APost> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<APost> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<APost> | null;
   ...
   */
  static mergeAll(mergeObj: APost, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: APost, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<APost>, spec?: UpsertSpec): ObjList<APost> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<APost>, spec?: UpsertSpec): ObjList<APost> | null;
   ...
   */
  static beforeCreate(objs: Array_Type<APost>): ObjList<APost>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<APost>): ObjList<APost>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<APost>): ObjList<APost>;
   ...
   */
  static afterCreate(objs: Array_Type<APost>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<APost>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<APost>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<APost>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<APost>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): APost | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<APost>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: APost, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<APost>, callback?: λFunction<APost | null, APost | null>): ObjList<APost>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<APost>, callback?: λFunction<APost | null, APost | null>): Array_Type<ObjError> | null;
