// TypeScript definitions for the C3 type PhysicalAssetRealTimeLocation

/**
 * Timeseries header type
 * @see PhysicalAssetRealTimeLocationMeasurement
 *
 * @remarks this represents a value passed to a method that expects an instance of PhysicalAssetRealTimeLocation
 */
declare interface IPhysicalAssetRealTimeLocation {
   ...
   */
  data?: Array_Type<PhysicalAssetRealTimeLocationMeasurement> | Array<IPhysicalAssetRealTimeLocationMeasurement>;
 ...
 */
declare class PhysicalAssetRealTimeLocation extends Obj  {

  /**
   * Populated on normalization. Indicates the earliest data point across various timeseries fields.
   */
  readonly earliest?: DateTime;
  withEarliest(earliest: DateTime | Date | string | null): PhysicalAssetRealTimeLocation;

  /**
   * Populated on normalization. Indicates the latest data point across various timeseries fields.
   */
  readonly latest?: DateTime;
  withLatest(latest: DateTime | Date | string | null): PhysicalAssetRealTimeLocation;

  /**
   * Populated on normalization. Indicates the earliest data point for each {@link Ann.Ts} fields.
   */
  readonly earliestTsDp?: Map_Type<string, TSDataPoint>;
  withEarliestTsDp(earliestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): PhysicalAssetRealTimeLocation;

  /**
   * Populated on normalization. Indicates the latest data point for each {@link Ann.Ts} fields.
   */
  readonly latestTsDp?: Map_Type<string, TSDataPoint>;
  withLatestTsDp(latestTsDp: Map_Type<string, TSDataPoint> | {[key: string]: ITSDataPoint} | null): PhysicalAssetRealTimeLocation;
  ...
  withInterval(interval: string | null): PhysicalAssetRealTimeLocation;

  /**
   * If set, the time series will be normalized in the specified zone.
   */
  readonly timeZone?: string;
  withTimeZone(timeZone: string | null): PhysicalAssetRealTimeLocation;

  /**
   * If set, disables normalizing this time series. Invalidations will still continue to happen for this series normally.
   */
  readonly doNotNormalize?: boolean;
  withDoNotNormalize(doNotNormalize: boolean): PhysicalAssetRealTimeLocation;

  /**
   * Data points corresponding to this timeseries header
   */
  readonly data?: Array_Type<PhysicalAssetRealTimeLocationMeasurement>;
  withData(data: Array_Type<PhysicalAssetRealTimeLocationMeasurement> | Array<IPhysicalAssetRealTimeLocationMeasurement> | null): PhysicalAssetRealTimeLocation;

  /**
   * Use this field to specify the interpolation mechanism to be applied for gaps in interval timeseries. Default: `ZERO_INTERPOLATOR`.
   */
  readonly interpolator?: string;
  withInterpolator(interpolator: string | null): PhysicalAssetRealTimeLocation;

  /**
   * Use this field to specify how normalization should handle duplicate data points. A duplicate point is one that has the same start, end, value, unit, and {@link TimedDataPointFields#isEstimated} values. Default: `IGNORE`.
   */
  readonly duplicateHandling?: string;
  withDuplicateHandling(duplicateHandling: string | null): PhysicalAssetRealTimeLocation;

  /**
   * Used to specify how normalization should handle overlapping data points. Default: `AVG`.
   */
  readonly overlapHandling?: string;
  withOverlapHandling(overlapHandling: string | null): PhysicalAssetRealTimeLocation;
  ...
  withBucketInterval(bucketInterval: string | null): PhysicalAssetRealTimeLocation;
  ...
  withNormalizationPartitionStrategy(normalizationPartitionStrategy: INormalizationPartitionStrategy | null): PhysicalAssetRealTimeLocation;
   ...
   */
  readonly id: string;
  withId(id: string): PhysicalAssetRealTimeLocation;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): PhysicalAssetRealTimeLocation;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): PhysicalAssetRealTimeLocation;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): PhysicalAssetRealTimeLocation;
  ...
  withVersion(version: number | null): PhysicalAssetRealTimeLocation;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): PhysicalAssetRealTimeLocation;

  /**
   * The "asset" associated with the real time location
   */
  readonly asset?: PhysicalAsset;
  withAsset(asset: IPhysicalAsset | null): PhysicalAssetRealTimeLocation;
   ...
   * @see #toJson
   */
  static fromJson(json: any): PhysicalAssetRealTimeLocation | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): PhysicalAssetRealTimeLocation | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): PhysicalAssetRealTimeLocation | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): PhysicalAssetRealTimeLocation | null;
   ...
   */
  replaceType(old: Type, new_: Type): PhysicalAssetRealTimeLocation;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): PhysicalAssetRealTimeLocation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): PhysicalAssetRealTimeLocation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<PhysicalAssetRealTimeLocation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<PhysicalAssetRealTimeLocation>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): PhysicalAssetRealTimeLocation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PhysicalAssetRealTimeLocation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PhysicalAssetRealTimeLocation;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PhysicalAssetRealTimeLocation;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PhysicalAssetRealTimeLocation;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PhysicalAssetRealTimeLocation;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): PhysicalAssetRealTimeLocation;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PhysicalAssetRealTimeLocation;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PhysicalAssetRealTimeLocation;
   ...
   * @see #removeField
   */
  withoutField(field: string): PhysicalAssetRealTimeLocation;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): PhysicalAssetRealTimeLocation;
   ...
   */
  withoutFields(fields: Array_Type<string>): PhysicalAssetRealTimeLocation;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): PhysicalAssetRealTimeLocation;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PhysicalAssetRealTimeLocation;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): PhysicalAssetRealTimeLocation;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PhysicalAssetRealTimeLocation;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PhysicalAssetRealTimeLocation;
   ...
   * @see #removeField
   */
  unsetField(field: string): PhysicalAssetRealTimeLocation;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PhysicalAssetRealTimeLocation;
   ...
   * @see #unsetField
   */
  removeField(field: string): PhysicalAssetRealTimeLocation;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PhysicalAssetRealTimeLocation;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): PhysicalAssetRealTimeLocation;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): PhysicalAssetRealTimeLocation;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): PhysicalAssetRealTimeLocation;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): PhysicalAssetRealTimeLocation;

  mergeJson(json: any): PhysicalAssetRealTimeLocation;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): PhysicalAssetRealTimeLocation;
   ...
   */
  sumObj(other: Obj, deep?: boolean): PhysicalAssetRealTimeLocation;
   ...
   */
  singletonArray(): Array_Type<PhysicalAssetRealTimeLocation>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<PhysicalAssetRealTimeLocation> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PhysicalAssetRealTimeLocation> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<PhysicalAssetRealTimeLocation>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PhysicalAssetRealTimeLocation> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, PhysicalAssetRealTimeLocation> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PhysicalAssetRealTimeLocation> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PhysicalAssetRealTimeLocation>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PhysicalAssetRealTimeLocation>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): PhysicalAssetRealTimeLocation;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): PhysicalAssetRealTimeLocation;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): PhysicalAssetRealTimeLocation;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PhysicalAssetRealTimeLocation;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): PhysicalAssetRealTimeLocation;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PhysicalAssetRealTimeLocation;
   ...
   * @see #fromString
   */
  static make(s: string): PhysicalAssetRealTimeLocation | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): PhysicalAssetRealTimeLocation;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): PhysicalAssetRealTimeLocation;
   ...
   */
  static cachedEmptyInst(): PhysicalAssetRealTimeLocation;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<PhysicalAssetRealTimeLocation> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): PhysicalAssetRealTimeLocation;
   ...
   */
  static normalizeTimeseries(timeseries?: TimedDataFields<PhysicalAssetRealTimeLocationMeasurement>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean, force?: boolean): void;
   ...
   */
  static normalize(timeseries?: TimedDataFields<PhysicalAssetRealTimeLocationMeasurement>, start?: DateTime, end?: DateTime, overrideGrain?: string, forceGrainDetection?: boolean): NormalizationResult | null;
   ...
   */
  static normalizationUnit(rawHeader: TimedDataFields<PhysicalAssetRealTimeLocationMeasurement>, tsField: string): Unit | null;
   ...
   */
  static normalizationTreatment(rawHeader: TimedDataFields<PhysicalAssetRealTimeLocationMeasurement>, tsField: string): string;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<PhysicalAssetRealTimeLocation>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PhysicalAssetRealTimeLocation>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<PhysicalAssetRealTimeLocation> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<PhysicalAssetRealTimeLocation>> | null;
   ...
   */
  get(include?: string): PhysicalAssetRealTimeLocation | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): PhysicalAssetRealTimeLocation | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PhysicalAssetRealTimeLocation;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): PhysicalAssetRealTimeLocation | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PhysicalAssetRealTimeLocation;
   ...
   * @see #toString
   */
  static fromString(s: string): PhysicalAssetRealTimeLocation | null;
   ...
   */
  create(spec?: UpsertSpec): PhysicalAssetRealTimeLocation | null;
   ...
   */
  static createBatch(objs: Array_Type<PhysicalAssetRealTimeLocation>, spec?: UpsertSpec): ObjList<PhysicalAssetRealTimeLocation> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PhysicalAssetRealTimeLocation>, spec?: CreateBatchObjStreamSpec): ObjList<PhysicalAssetRealTimeLocation> | null;
   ...
   */
  update(srcObj?: PhysicalAssetRealTimeLocation, spec?: UpsertSpec): PhysicalAssetRealTimeLocation | null;
   ...
   */
  upsert(srcObj?: PhysicalAssetRealTimeLocation, spec?: UpsertSpec): PhysicalAssetRealTimeLocation | null;
   ...
   */
  merge(spec?: MergeSpec): PhysicalAssetRealTimeLocation | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): PhysicalAssetRealTimeLocation | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): PhysicalAssetRealTimeLocation | null;
   ...
   */
  static updateBatch(objs: Array_Type<PhysicalAssetRealTimeLocation>, srcObjs?: Array_Type<PhysicalAssetRealTimeLocation>, spec?: UpsertSpec): ObjList<PhysicalAssetRealTimeLocation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<PhysicalAssetRealTimeLocation> | null>, spec?: UpsertSpec): ObjList<PhysicalAssetRealTimeLocation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<PhysicalAssetRealTimeLocation>, srcObjs?: Array_Type<PhysicalAssetRealTimeLocation>, spec?: UpsertSpec): ObjList<PhysicalAssetRealTimeLocation> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<PhysicalAssetRealTimeLocation> | null>, spec?: UpsertSpec): ObjList<PhysicalAssetRealTimeLocation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<PhysicalAssetRealTimeLocation>, spec?: TouchSpec): ObjList<PhysicalAssetRealTimeLocation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<PhysicalAssetRealTimeLocation>, spec?: MergeSpec): ObjList<PhysicalAssetRealTimeLocation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<PhysicalAssetRealTimeLocation>, mergeInclude: string, spec?: MergeSpec): ObjList<PhysicalAssetRealTimeLocation> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<PhysicalAssetRealTimeLocation> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<PhysicalAssetRealTimeLocation> | null;
   ...
   */
  static mergeAll(mergeObj: PhysicalAssetRealTimeLocation, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PhysicalAssetRealTimeLocation, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<PhysicalAssetRealTimeLocation>, spec?: UpsertSpec): ObjList<PhysicalAssetRealTimeLocation> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<PhysicalAssetRealTimeLocation>, spec?: UpsertSpec): ObjList<PhysicalAssetRealTimeLocation> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): PhysicalAssetRealTimeLocation | null;
   ...
   */
  static beforeCreate(objs: Array_Type<PhysicalAssetRealTimeLocation>): ObjList<PhysicalAssetRealTimeLocation>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<PhysicalAssetRealTimeLocation>): ObjList<PhysicalAssetRealTimeLocation>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<PhysicalAssetRealTimeLocation>): ObjList<PhysicalAssetRealTimeLocation>;
   ...
   */
  static afterCreate(objs: Array_Type<PhysicalAssetRealTimeLocation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<PhysicalAssetRealTimeLocation>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<PhysicalAssetRealTimeLocation>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<PhysicalAssetRealTimeLocation>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<PhysicalAssetRealTimeLocation>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): PhysicalAssetRealTimeLocation | null;
   ...
   */
  withoutIdentity(): PhysicalAssetRealTimeLocation | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<PhysicalAssetRealTimeLocation>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: PhysicalAssetRealTimeLocation, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<PhysicalAssetRealTimeLocation>, callback?: λFunction<PhysicalAssetRealTimeLocation | null, PhysicalAssetRealTimeLocation | null>): ObjList<PhysicalAssetRealTimeLocation>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<PhysicalAssetRealTimeLocation>, callback?: λFunction<PhysicalAssetRealTimeLocation | null, PhysicalAssetRealTimeLocation | null>): Array_Type<ObjError> | null;
