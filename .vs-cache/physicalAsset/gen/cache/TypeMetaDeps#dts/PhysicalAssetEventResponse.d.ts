// TypeScript definitions for the C3 type PhysicalAssetEventResponse

/**
 * The base event response type - to be used as a response to a {@link PhysicalAssetEvent}
 *
 * @remarks this represents a value passed to a method that expects an instance of PhysicalAssetEventResponse
 */
declare interface IPhysicalAssetEventResponse {
 ...
 */
declare class PhysicalAssetEventResponse extends Obj  {
  ...
  withTypeIdent(typeIdent: string | null): PhysicalAssetEventResponse;
   ...
   */
  readonly id: string;
  withId(id: string): PhysicalAssetEventResponse;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): PhysicalAssetEventResponse;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): PhysicalAssetEventResponse;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): PhysicalAssetEventResponse;
  ...
  withVersion(version: number | null): PhysicalAssetEventResponse;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): PhysicalAssetEventResponse;

  /**
   * The event for this response
   */
  readonly event?: PhysicalAssetEvent;
  withEvent(event: IPhysicalAssetEvent | null): PhysicalAssetEventResponse;
   ...
   * @see #toJson
   */
  static fromJson(json: any): PhysicalAssetEventResponse | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): PhysicalAssetEventResponse | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): PhysicalAssetEventResponse | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): PhysicalAssetEventResponse | null;
   ...
   */
  replaceType(old: Type, new_: Type): PhysicalAssetEventResponse;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): PhysicalAssetEventResponse;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): PhysicalAssetEventResponse;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<PhysicalAssetEventResponse>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<PhysicalAssetEventResponse>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): PhysicalAssetEventResponse;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PhysicalAssetEventResponse;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PhysicalAssetEventResponse;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PhysicalAssetEventResponse;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PhysicalAssetEventResponse;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PhysicalAssetEventResponse;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): PhysicalAssetEventResponse;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PhysicalAssetEventResponse;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PhysicalAssetEventResponse;
   ...
   * @see #removeField
   */
  withoutField(field: string): PhysicalAssetEventResponse;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): PhysicalAssetEventResponse;
   ...
   */
  withoutFields(fields: Array_Type<string>): PhysicalAssetEventResponse;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): PhysicalAssetEventResponse;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PhysicalAssetEventResponse;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): PhysicalAssetEventResponse;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PhysicalAssetEventResponse;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PhysicalAssetEventResponse;
   ...
   * @see #removeField
   */
  unsetField(field: string): PhysicalAssetEventResponse;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PhysicalAssetEventResponse;
   ...
   * @see #unsetField
   */
  removeField(field: string): PhysicalAssetEventResponse;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PhysicalAssetEventResponse;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): PhysicalAssetEventResponse;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): PhysicalAssetEventResponse;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): PhysicalAssetEventResponse;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): PhysicalAssetEventResponse;

  mergeJson(json: any): PhysicalAssetEventResponse;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): PhysicalAssetEventResponse;
   ...
   */
  sumObj(other: Obj, deep?: boolean): PhysicalAssetEventResponse;
   ...
   */
  singletonArray(): Array_Type<PhysicalAssetEventResponse>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<PhysicalAssetEventResponse> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PhysicalAssetEventResponse> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<PhysicalAssetEventResponse>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PhysicalAssetEventResponse> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, PhysicalAssetEventResponse> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PhysicalAssetEventResponse> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PhysicalAssetEventResponse>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PhysicalAssetEventResponse>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): PhysicalAssetEventResponse;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): PhysicalAssetEventResponse;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): PhysicalAssetEventResponse;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PhysicalAssetEventResponse;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): PhysicalAssetEventResponse;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PhysicalAssetEventResponse;
   ...
   * @see #fromString
   */
  static make(s: string): PhysicalAssetEventResponse | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): PhysicalAssetEventResponse;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): PhysicalAssetEventResponse;
   ...
   */
  static cachedEmptyInst(): PhysicalAssetEventResponse;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<PhysicalAssetEventResponse> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): PhysicalAssetEventResponse;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<PhysicalAssetEventResponse>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PhysicalAssetEventResponse>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<PhysicalAssetEventResponse> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<PhysicalAssetEventResponse>> | null;
   ...
   */
  get(include?: string): PhysicalAssetEventResponse | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): PhysicalAssetEventResponse | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PhysicalAssetEventResponse;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): PhysicalAssetEventResponse | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PhysicalAssetEventResponse;
   ...
   * @see #toString
   */
  static fromString(s: string): PhysicalAssetEventResponse | null;
   ...
   */
  create(spec?: UpsertSpec): PhysicalAssetEventResponse | null;
   ...
   */
  static createBatch(objs: Array_Type<PhysicalAssetEventResponse>, spec?: UpsertSpec): ObjList<PhysicalAssetEventResponse> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PhysicalAssetEventResponse>, spec?: CreateBatchObjStreamSpec): ObjList<PhysicalAssetEventResponse> | null;
   ...
   */
  update(srcObj?: PhysicalAssetEventResponse, spec?: UpsertSpec): PhysicalAssetEventResponse | null;
   ...
   */
  upsert(srcObj?: PhysicalAssetEventResponse, spec?: UpsertSpec): PhysicalAssetEventResponse | null;
   ...
   */
  merge(spec?: MergeSpec): PhysicalAssetEventResponse | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): PhysicalAssetEventResponse | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): PhysicalAssetEventResponse | null;
   ...
   */
  static updateBatch(objs: Array_Type<PhysicalAssetEventResponse>, srcObjs?: Array_Type<PhysicalAssetEventResponse>, spec?: UpsertSpec): ObjList<PhysicalAssetEventResponse> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<PhysicalAssetEventResponse> | null>, spec?: UpsertSpec): ObjList<PhysicalAssetEventResponse> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<PhysicalAssetEventResponse>, srcObjs?: Array_Type<PhysicalAssetEventResponse>, spec?: UpsertSpec): ObjList<PhysicalAssetEventResponse> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<PhysicalAssetEventResponse> | null>, spec?: UpsertSpec): ObjList<PhysicalAssetEventResponse> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<PhysicalAssetEventResponse>, spec?: TouchSpec): ObjList<PhysicalAssetEventResponse> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<PhysicalAssetEventResponse>, spec?: MergeSpec): ObjList<PhysicalAssetEventResponse> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<PhysicalAssetEventResponse>, mergeInclude: string, spec?: MergeSpec): ObjList<PhysicalAssetEventResponse> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<PhysicalAssetEventResponse> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<PhysicalAssetEventResponse> | null;
   ...
   */
  static mergeAll(mergeObj: PhysicalAssetEventResponse, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PhysicalAssetEventResponse, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<PhysicalAssetEventResponse>, spec?: UpsertSpec): ObjList<PhysicalAssetEventResponse> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<PhysicalAssetEventResponse>, spec?: UpsertSpec): ObjList<PhysicalAssetEventResponse> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): PhysicalAssetEventResponse | null;
   ...
   */
  static beforeCreate(objs: Array_Type<PhysicalAssetEventResponse>): ObjList<PhysicalAssetEventResponse>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<PhysicalAssetEventResponse>): ObjList<PhysicalAssetEventResponse>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<PhysicalAssetEventResponse>): ObjList<PhysicalAssetEventResponse>;
   ...
   */
  static afterCreate(objs: Array_Type<PhysicalAssetEventResponse>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<PhysicalAssetEventResponse>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<PhysicalAssetEventResponse>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<PhysicalAssetEventResponse>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<PhysicalAssetEventResponse>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): PhysicalAssetEventResponse | null;
   ...
   */
  withoutIdentity(): PhysicalAssetEventResponse | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<PhysicalAssetEventResponse>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: PhysicalAssetEventResponse, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<PhysicalAssetEventResponse>, callback?: λFunction<PhysicalAssetEventResponse | null, PhysicalAssetEventResponse | null>): ObjList<PhysicalAssetEventResponse>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<PhysicalAssetEventResponse>, callback?: λFunction<PhysicalAssetEventResponse | null, PhysicalAssetEventResponse | null>): Array_Type<ObjError> | null;
