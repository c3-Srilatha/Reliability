// TypeScript definitions for the C3 type PhysicalAssetRealTimeLocationMeasurement

/**
 * Timeseries data type that stores real time location
 *
 * @remarks this represents a value passed to a method that expects an instance of PhysicalAssetRealTimeLocationMeasurement
 */
declare interface IPhysicalAssetRealTimeLocationMeasurement {
  ...
  /**
   * The elevation coordinate of the point (from mean sea level)
   */
  elev?: number;
  ...
  parent: IPhysicalAssetRealTimeLocation;
 ...
 * Timeseries data type that stores real time location
 *
 * @remarks this represents a made instance of PhysicalAssetRealTimeLocationMeasurement
 */
declare class PhysicalAssetRealTimeLocationMeasurement extends Obj  {

  /**
   * The longitude coordinate of the point.
   */
  readonly long?: number;
  withLong(long: number | null): PhysicalAssetRealTimeLocationMeasurement;

  /**
   * The latitude coordinate of the point.
   */
  readonly lat?: number;
  withLat(lat: number | null): PhysicalAssetRealTimeLocationMeasurement;

  /**
   * The elevation coordinate of the point (from mean sea level)
   */
  readonly elev?: number;
  withElev(elev: number | null): PhysicalAssetRealTimeLocationMeasurement;

  /**
   * Unit of the elev
   */
  readonly unit?: Unit;
  withUnit(unit: IUnit | null): PhysicalAssetRealTimeLocationMeasurement;

  /**
   * start date for the data point
   */
  readonly start: DateTime;
  withStart(start: DateTime | Date | string): PhysicalAssetRealTimeLocationMeasurement;
  ...
  withOutlierCode(outlierCode: number | null): PhysicalAssetRealTimeLocationMeasurement;

  /**
   * (Optional) any comments for the data point
   */
  readonly comments?: string;
  withComments(comments: string | null): PhysicalAssetRealTimeLocationMeasurement;

  /**
   * Denotes if the value is an actual value or an estimated value. default = null (actual value)
   */
  readonly isEstimated?: boolean;
  withIsEstimated(isEstimated: boolean): PhysicalAssetRealTimeLocationMeasurement;
  ...
  withDataVersion(dataVersion: number | null): PhysicalAssetRealTimeLocationMeasurement;

  /**
   * Customer specific status code for the data point (may be used to denote data quality)
   */
  readonly statusCode?: string;
  withStatusCode(statusCode: string | null): PhysicalAssetRealTimeLocationMeasurement;

  /**
   * end date for the data point (Only applicable for Interval Timeseries)
   */
  readonly end: DateTime;
  withEnd(end: DateTime | Date | string): PhysicalAssetRealTimeLocationMeasurement;

  /**
   * Partition key Bin separator used to separate partition key from bin id
   */
  readonly PK_BIN_SEPARATOR?: string;
  withPK_BIN_SEPARATOR(PK_BIN_SEPARATOR: string | null): PhysicalAssetRealTimeLocationMeasurement;

  readonly parent: PhysicalAssetRealTimeLocation;
  withParent(parent: IPhysicalAssetRealTimeLocation): PhysicalAssetRealTimeLocationMeasurement;
   ...
   */
  readonly id: string;
  withId(id: string): PhysicalAssetRealTimeLocationMeasurement;
  ...
  withVersionEdits(versionEdits: Array_Type<VersionEdit> | Array<IVersionEdit> | null): PhysicalAssetRealTimeLocationMeasurement;

  /**
   * Name of the Obj instance
   */
  readonly name?: string;
  withName(name: string | null): PhysicalAssetRealTimeLocationMeasurement;

  /**
   * Various system fields.
   */
  readonly meta?: Meta;
  withMeta(meta: IMeta | null): PhysicalAssetRealTimeLocationMeasurement;
  ...
  withVersion(version: number | null): PhysicalAssetRealTimeLocationMeasurement;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type;
  withTypeWithBindings(typeWithBindings: IType | null): PhysicalAssetRealTimeLocationMeasurement;
   ...
   * @see #toJson
   */
  static fromJson(json: any): PhysicalAssetRealTimeLocationMeasurement | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string): PhysicalAssetRealTimeLocationMeasurement | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string): PhysicalAssetRealTimeLocationMeasurement | null;
   ...
   */
  static deserialize(contentStr: string, contentType: string): PhysicalAssetRealTimeLocationMeasurement | null;
   ...
   */
  replaceType(old: Type, new_: Type): PhysicalAssetRealTimeLocationMeasurement;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): PhysicalAssetRealTimeLocationMeasurement;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any | null>, convertValue?: boolean): PhysicalAssetRealTimeLocationMeasurement;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, Promise<any> | null>, convertValue?: boolean): Promise<PhysicalAssetRealTimeLocationMeasurement>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, Promise<any> | null>, convertValue?: boolean): Promise<PhysicalAssetRealTimeLocationMeasurement>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType, includeEmpty?: boolean, mapper: λFunction<any, any | null>, convertValue?: boolean): PhysicalAssetRealTimeLocationMeasurement;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PhysicalAssetRealTimeLocationMeasurement;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PhysicalAssetRealTimeLocationMeasurement;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PhysicalAssetRealTimeLocationMeasurement;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PhysicalAssetRealTimeLocationMeasurement;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PhysicalAssetRealTimeLocationMeasurement;
   ...
   * @return new Obj
   */
  withFields(fields: Map_Type<string, any>, doNotConvert?: boolean): PhysicalAssetRealTimeLocationMeasurement;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PhysicalAssetRealTimeLocationMeasurement;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PhysicalAssetRealTimeLocationMeasurement;
   ...
   * @see #removeField
   */
  withoutField(field: string): PhysicalAssetRealTimeLocationMeasurement;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType): PhysicalAssetRealTimeLocationMeasurement;
   ...
   */
  withoutFields(fields: Array_Type<string>): PhysicalAssetRealTimeLocationMeasurement;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: Array_Type<FieldType>): PhysicalAssetRealTimeLocationMeasurement;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PhysicalAssetRealTimeLocationMeasurement;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: Array_Type<string>): PhysicalAssetRealTimeLocationMeasurement;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PhysicalAssetRealTimeLocationMeasurement;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PhysicalAssetRealTimeLocationMeasurement;
   ...
   * @see #removeField
   */
  unsetField(field: string): PhysicalAssetRealTimeLocationMeasurement;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PhysicalAssetRealTimeLocationMeasurement;
   ...
   * @see #unsetField
   */
  removeField(field: string): PhysicalAssetRealTimeLocationMeasurement;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PhysicalAssetRealTimeLocationMeasurement;
   ...
   */
  mergeObj(other: Obj, fieldPathMergeSpec?: Map_Type<string, string>): PhysicalAssetRealTimeLocationMeasurement;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj, otherFieldsFilter: Type): PhysicalAssetRealTimeLocationMeasurement;
   ...
   */
  mergeObj(other: Obj, deep?: boolean, merger: λQuadFunction<FieldPath | null, any | null, FieldPath | null, any | null, any | null>): PhysicalAssetRealTimeLocationMeasurement;
   ...
   */
  mergeObj(other: Obj, merger: λQuadFunction<FieldType | null, any | null, FieldType | null, any | null, any | null>): PhysicalAssetRealTimeLocationMeasurement;

  mergeJson(json: any): PhysicalAssetRealTimeLocationMeasurement;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any | null>, filter?: λPredicate<string>): PhysicalAssetRealTimeLocationMeasurement;
   ...
   */
  sumObj(other: Obj, deep?: boolean): PhysicalAssetRealTimeLocationMeasurement;
   ...
   */
  singletonArray(): Array_Type<PhysicalAssetRealTimeLocationMeasurement>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: Array_Type<any>[]): Array_Type<PhysicalAssetRealTimeLocationMeasurement> | null;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PhysicalAssetRealTimeLocationMeasurement> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): Set_Type<PhysicalAssetRealTimeLocationMeasurement>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PhysicalAssetRealTimeLocationMeasurement> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string, PhysicalAssetRealTimeLocationMeasurement> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PhysicalAssetRealTimeLocationMeasurement> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PhysicalAssetRealTimeLocationMeasurement>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PhysicalAssetRealTimeLocationMeasurement>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: Map_Type<FieldType, any>, spec: Obj.MakeSpec): PhysicalAssetRealTimeLocationMeasurement;
   ...
   * @see withDefaults
   */
  static fromFields(fields: Map_Type<FieldType, any | any>, withDefaults?: boolean): PhysicalAssetRealTimeLocationMeasurement;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: Map_Type<string, any>, spec: Obj.MakeSpec): PhysicalAssetRealTimeLocationMeasurement;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PhysicalAssetRealTimeLocationMeasurement;
   ...
   * @see withDefaults
   */
  static make(fields: Map_Type<string, any | any>, withDefaults?: boolean): PhysicalAssetRealTimeLocationMeasurement;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PhysicalAssetRealTimeLocationMeasurement;
   ...
   * @see #fromString
   */
  static make(s: string): PhysicalAssetRealTimeLocationMeasurement | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj, failIfExtraOrInvalidFields?: boolean): PhysicalAssetRealTimeLocationMeasurement;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): PhysicalAssetRealTimeLocationMeasurement;
   ...
   */
  static cachedEmptyInst(): PhysicalAssetRealTimeLocationMeasurement;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec): Stream<PhysicalAssetRealTimeLocationMeasurement> | null;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec): PhysicalAssetRealTimeLocationMeasurement;

  /**
   * Extract the partition key from the given obj
   */
  partitionKey(failIfMissing?: boolean): PhysicalAssetRealTimeLocation | null;
   ...
   */
  static partition(objs?: Stream<PhysicalAssetRealTimeLocationMeasurement>, spec?: PartitionBucketStrategy): Map_Type<string, KvDataPartition> | null;
   ...
   */
  static fromPartitions(partitions?: Stream<KvDataPartition>): Stream<PhysicalAssetRealTimeLocationMeasurement> | null;
   ...
   */
  static fetch(spec?: FetchSpec): FetchResult<PhysicalAssetRealTimeLocationMeasurement>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PhysicalAssetRealTimeLocationMeasurement>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec): Stream<PhysicalAssetRealTimeLocationMeasurement> | null;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec): Map_Type<string, FetchResult<PhysicalAssetRealTimeLocationMeasurement>> | null;
   ...
   */
  get(include?: string): PhysicalAssetRealTimeLocationMeasurement | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string): PhysicalAssetRealTimeLocationMeasurement | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PhysicalAssetRealTimeLocationMeasurement;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string): PhysicalAssetRealTimeLocationMeasurement | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PhysicalAssetRealTimeLocationMeasurement;
   ...
   * @see #toString
   */
  static fromString(s: string): PhysicalAssetRealTimeLocationMeasurement | null;
   ...
   */
  create(spec?: UpsertSpec): PhysicalAssetRealTimeLocationMeasurement | null;
   ...
   */
  static createBatch(objs: Array_Type<PhysicalAssetRealTimeLocationMeasurement>, spec?: UpsertSpec): ObjList<PhysicalAssetRealTimeLocationMeasurement> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PhysicalAssetRealTimeLocationMeasurement>, spec?: CreateBatchObjStreamSpec): ObjList<PhysicalAssetRealTimeLocationMeasurement> | null;
   ...
   */
  update(srcObj?: PhysicalAssetRealTimeLocationMeasurement, spec?: UpsertSpec): PhysicalAssetRealTimeLocationMeasurement | null;
   ...
   */
  upsert(srcObj?: PhysicalAssetRealTimeLocationMeasurement, spec?: UpsertSpec): PhysicalAssetRealTimeLocationMeasurement | null;
   ...
   */
  merge(spec?: MergeSpec): PhysicalAssetRealTimeLocationMeasurement | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec): PhysicalAssetRealTimeLocationMeasurement | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec): PhysicalAssetRealTimeLocationMeasurement | null;
   ...
   */
  static updateBatch(objs: Array_Type<PhysicalAssetRealTimeLocationMeasurement>, srcObjs?: Array_Type<PhysicalAssetRealTimeLocationMeasurement>, spec?: UpsertSpec): ObjList<PhysicalAssetRealTimeLocationMeasurement> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<Array_Type<PhysicalAssetRealTimeLocationMeasurement> | null>, spec?: UpsertSpec): ObjList<PhysicalAssetRealTimeLocationMeasurement> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: Array_Type<PhysicalAssetRealTimeLocationMeasurement>, srcObjs?: Array_Type<PhysicalAssetRealTimeLocationMeasurement>, spec?: UpsertSpec): ObjList<PhysicalAssetRealTimeLocationMeasurement> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<Array_Type<PhysicalAssetRealTimeLocationMeasurement> | null>, spec?: UpsertSpec): ObjList<PhysicalAssetRealTimeLocationMeasurement> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: Array_Type<PhysicalAssetRealTimeLocationMeasurement>, spec?: TouchSpec): ObjList<PhysicalAssetRealTimeLocationMeasurement> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<PhysicalAssetRealTimeLocationMeasurement>, spec?: MergeSpec): ObjList<PhysicalAssetRealTimeLocationMeasurement> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: Array_Type<PhysicalAssetRealTimeLocationMeasurement>, mergeInclude: string, spec?: MergeSpec): ObjList<PhysicalAssetRealTimeLocationMeasurement> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<Array_Type<PhysicalAssetRealTimeLocationMeasurement> | null>, mergeInclude: string, spec?: MergeSpec): ObjList<PhysicalAssetRealTimeLocationMeasurement> | null;
   ...
   */
  static mergeAll(mergeObj: PhysicalAssetRealTimeLocationMeasurement, spec?: MergeAllSpec): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PhysicalAssetRealTimeLocationMeasurement, mergeInclude: string, spec?: MergeAllSpec): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: Array_Type<PhysicalAssetRealTimeLocationMeasurement>, spec?: UpsertSpec): ObjList<PhysicalAssetRealTimeLocationMeasurement> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: Array_Type<PhysicalAssetRealTimeLocationMeasurement>, spec?: UpsertSpec): ObjList<PhysicalAssetRealTimeLocationMeasurement> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): PhysicalAssetRealTimeLocationMeasurement | null;
   ...
   */
  static beforeCreate(objs: Array_Type<PhysicalAssetRealTimeLocationMeasurement>): ObjList<PhysicalAssetRealTimeLocationMeasurement>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: Array_Type<PhysicalAssetRealTimeLocationMeasurement>): ObjList<PhysicalAssetRealTimeLocationMeasurement>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: Array_Type<PhysicalAssetRealTimeLocationMeasurement>): ObjList<PhysicalAssetRealTimeLocationMeasurement>;
   ...
   */
  static afterCreate(objs: Array_Type<PhysicalAssetRealTimeLocationMeasurement>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: Array_Type<PhysicalAssetRealTimeLocationMeasurement>): Array_Type<ObjError> | null;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: Array_Type<PhysicalAssetRealTimeLocationMeasurement>): Array_Type<ObjError> | null;
   ...
   */
  static startImportData(spec?: StartImportDataSpec): PushStream<PhysicalAssetRealTimeLocationMeasurement>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec): PushStreamWithStats<PhysicalAssetRealTimeLocationMeasurement>;
   ...
   */
  static forId(id: string, failIfMissing?: boolean): PhysicalAssetRealTimeLocationMeasurement | null;
   ...
   */
  withoutIdentity(): PhysicalAssetRealTimeLocationMeasurement | null;
   ...
   */
  static typeOfBatch(objs: Array_Type<PhysicalAssetRealTimeLocationMeasurement>): Array_Type<EntityType> | null;
   ...
   */
  static dbEcho(template?: PhysicalAssetRealTimeLocationMeasurement, count?: number, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: Array_Type<PhysicalAssetRealTimeLocationMeasurement>, callback?: λFunction<PhysicalAssetRealTimeLocationMeasurement | null, PhysicalAssetRealTimeLocationMeasurement | null>): ObjList<PhysicalAssetRealTimeLocationMeasurement>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: Array_Type<PhysicalAssetRealTimeLocationMeasurement>, callback?: λFunction<PhysicalAssetRealTimeLocationMeasurement | null, PhysicalAssetRealTimeLocationMeasurement | null>): Array_Type<ObjError> | null;
