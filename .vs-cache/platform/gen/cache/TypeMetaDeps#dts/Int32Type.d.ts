// TypeScript definitions for the C3 type Int32Type

/**
 * The numeric half integer (32 bit) value type.
 *
 * There are no fields (other than #modifier), so this is normally accessed with {@link PrimitiveType#ofInt32}.
 *
 * @remarks this represents a value passed to a method that expects an instance of Int32Type
 */
declare interface IInt32Type {
 ...
 * There are no fields (other than #modifier), so this is normally accessed with {@link PrimitiveType#ofInt32}.
 *
 * @remarks this represents a made instance of Int32Type
 */
declare class Int32Type extends Obj {

  /**
   * Source file Pkg.Path a C3 Type declaration [.c3typ].
   */
  readonly declaredPkgPath?: string | null;
  withDeclaredPkgPath(declaredPkgPath: string | null): Int32Type;

  /**
   * Source line number in a C3 Type declaration [.c3typ] file starting with 1 where this metadata element is declared.
   */
  readonly declaredSrcLine?: number | null;
  withDeclaredSrcLine(declaredSrcLine: number | null): Int32Type;
  ...
  withDeclaredSrcCharInLine(declaredSrcCharInLine: number | null): Int32Type;
   ...
   */
  readonly pkg: Pkg;
  withPkg(pkg: IPkg): Int32Type;

  /**
   * SDK json representing instance of this type
   */
  readonly json?: any;
  withJson(json: any): Int32Type;

  /**
   * The set of annotations defined on this element of metadata represented as json value.
   */
  readonly annotationsJson?: any | null;
  withAnnotationsJson(annotationsJson: any | null): Int32Type;
  ...
  withModifier(modifier: string | null): Int32Type;
  ...
  withName(name: string): Int32Type;
  ...
  withSerializedType(serializedType: IValueType | null): Int32Type;
  ...
  withEnumRefType(enumRefType: IReferenceType | null): Int32Type;
  ...
  withDeclaredEnumValues(declaredEnumValues: C3.Array<string | null> | Array<string | null>): Int32Type;
   ...
   */
  replaceType(old: Type, new_: Type): Int32Type;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Int32Type | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Int32Type | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Int32Type | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Int32Type | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Int32Type;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Int32Type;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Int32Type | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Int32Type | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Int32Type;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Int32Type;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Int32Type;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): Int32Type;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Int32Type;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Int32Type;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Int32Type;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Int32Type;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Int32Type;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Int32Type;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Int32Type;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Int32Type;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Int32Type;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Int32Type;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Int32Type;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Int32Type;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Int32Type;
   ...
   * @see #removeField
   */
  unsetField(field: string): Int32Type;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Int32Type;
   ...
   * @see #unsetField
   */
  removeField(field: string): Int32Type;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Int32Type;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Int32Type;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Int32Type;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Int32Type;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Int32Type;

  mergeJson(json: any | null): Int32Type;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Int32Type;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Int32Type;
   ...
   */
  singletonArray(): C3.Array<Int32Type | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Int32Type | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Int32Type | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Int32Type | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Int32Type | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Int32Type | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Int32Type | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Int32Type | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Int32Type | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Int32Type;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Int32Type;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Int32Type;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Int32Type;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Int32Type;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Int32Type;
   ...
   * @see #fromString
   */
  static make(s: string | null): Int32Type | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Int32Type;
   ...
   */
  static cachedEmptyInst(): Int32Type;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Int32Type>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Int32Type;
   ...
   */
  withoutDeclaredSrcPos(recursive?: boolean): Int32Type;
   ...
   */
  withAnnotation(ann: Annotation): Int32Type;
   ...
   *         value for the field
   */
  withAnnotation(ann: string, annField?: string | null, value?: any): Int32Type;
   ...
   * @see #toString
   */
  static fromString(s: string | null): Int32Type | null;
