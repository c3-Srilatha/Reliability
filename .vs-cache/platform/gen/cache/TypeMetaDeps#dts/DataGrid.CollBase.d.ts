// TypeScript definitions for the C3 type DataGrid.CollBase
 ...
 * streams.
 *
 * @remarks this represents a value passed to a method that expects an instance of DataGrid.CollBase
 */
declare namespace DataGrid {
  export interface ICollBase {
 ...
 */
declare namespace DataGrid {
  export class CollBase extends Obj {

    /**
     * The raw data from which the grid was built.
     */
    readonly source?: any;
    withSource(source: any): DataGrid.CollBase;
    ...
    withLabel(label: string | null): DataGrid.CollBase;

    /**
     * A more detailed description of the source of the data. Typically the full value type of the data.
     */
    readonly description?: string | null;
    withDescription(description: string | null): DataGrid.CollBase;
    ...
    withCols(cols: C3.Array<DataGrid.Col> | Array<IDataGrid.Col>): DataGrid.CollBase;

    readonly _coll: Collection<any>;
    with_coll(_coll: ICollection<any>): DataGrid.CollBase;

    readonly _stream?: Stream<any>;
    with_stream(_stream: Stream<any> | Array<any>): DataGrid.CollBase;

    readonly _buffer?: any;
    with_buffer(_buffer: any): DataGrid.CollBase;

    readonly _keys?: C3.Array<any>;
    with_keys(_keys: C3.Array<any> | Array<any>): DataGrid.CollBase;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): DataGrid.CollBase | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): DataGrid.CollBase | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): DataGrid.CollBase | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): DataGrid.CollBase | null;
     ...
     */
    replaceType(old: Type, new_: Type): DataGrid.CollBase;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataGrid.CollBase;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataGrid.CollBase;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataGrid.CollBase | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataGrid.CollBase | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataGrid.CollBase;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataGrid.CollBase;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataGrid.CollBase;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): DataGrid.CollBase;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): DataGrid.CollBase;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): DataGrid.CollBase;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataGrid.CollBase;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataGrid.CollBase;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): DataGrid.CollBase;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): DataGrid.CollBase;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): DataGrid.CollBase;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): DataGrid.CollBase;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataGrid.CollBase;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): DataGrid.CollBase;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataGrid.CollBase;
     ...
     * @see #unsetField
     */
    defaultField(field: string): DataGrid.CollBase;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): DataGrid.CollBase;
     ...
     * @see #removeField
     */
    unsetField(field: string): DataGrid.CollBase;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): DataGrid.CollBase;
     ...
     * @see #unsetField
     */
    removeField(field: string): DataGrid.CollBase;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): DataGrid.CollBase;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataGrid.CollBase;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): DataGrid.CollBase;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataGrid.CollBase;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataGrid.CollBase;

    mergeJson(json: any | null): DataGrid.CollBase;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataGrid.CollBase;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): DataGrid.CollBase;
     ...
     */
    singletonArray(): C3.Array<DataGrid.CollBase | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<DataGrid.CollBase | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<DataGrid.CollBase | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<DataGrid.CollBase | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<DataGrid.CollBase | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, DataGrid.CollBase | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataGrid.CollBase | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<DataGrid.CollBase | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<DataGrid.CollBase | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DataGrid.CollBase;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DataGrid.CollBase;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DataGrid.CollBase;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): DataGrid.CollBase;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DataGrid.CollBase;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): DataGrid.CollBase;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DataGrid.CollBase;
     ...
     */
    static cachedEmptyInst(): DataGrid.CollBase;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DataGrid.CollBase>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): DataGrid.CollBase;
