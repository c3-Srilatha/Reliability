// TypeScript definitions for the C3 type CatBoostPipe
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of CatBoostPipe
 */
declare interface ICatBoostPipe {
 ...
 */
declare class CatBoostPipe extends Obj {

  /**
   * Name for the function on the native model to call to do {@link MlTrainable#train}.
   */
  readonly trainFunc?: string | null;
  withTrainFunc(trainFunc: string | null): CatBoostPipe;
  ...
  withKeepInputColumnIndices(keepInputColumnIndices: boolean): CatBoostPipe;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): CatBoostPipe;

  /**
   * Name of this pipe.
   */
  readonly name?: string | null;
  withName(name: string | null): CatBoostPipe;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): CatBoostPipe;
  ...
  withVersion(version: number | null): CatBoostPipe;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): CatBoostPipe;
  ...
  withUserUpdatedFields(userUpdatedFields: C3.Array<string | null> | Array<string | null>): CatBoostPipe;
  ...
  withHidden(hidden: boolean): CatBoostPipe;
  ...
  withUserOwned(userOwned: boolean): CatBoostPipe;
  ...
  withTypeIdent(typeIdent: string | null): CatBoostPipe;

  /**
   * If true, then the pipe shall not be retrained
   */
  readonly frozen?: boolean;
  withFrozen(frozen: boolean): CatBoostPipe;

  /**
   * True if training has succeeded and false otherwise.
   */
  readonly trained?: boolean;
  withTrained(trained: boolean): CatBoostPipe;

  /**
   * Errors from training.
   */
  readonly trainingErrors?: string | null;
  withTrainingErrors(trainingErrors: string | null): CatBoostPipe;

  /**
   * If true, the underlying model only accepts flattened input.
   */
  readonly flattenInput?: boolean;
  withFlattenInput(flattenInput: boolean): CatBoostPipe;

  /**
   * The hyperparameters overridden of a native model or pipe.
   */
  readonly hyperparamOverrides?: C3.Map<string | null, any>;
  withHyperparamOverrides(hyperparamOverrides: C3.Map<string | null, any> | {[key: string | null]: any}): CatBoostPipe;
  ...
  withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): CatBoostPipe;
  ...
  withHpoSpec(hpoSpec: IHpo.Spec | null): CatBoostPipe;

  /**
   * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
   */
  readonly hpoExperiment?: Hpo.Experiment | null;
  withHpoExperiment(hpoExperiment: IHpo.Experiment | null): CatBoostPipe;

  /**
   * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
   */
  readonly experiment?: any;
  withExperiment(experiment: any): CatBoostPipe;
  ...
  withModelFiles(modelFiles: C3.Map<string | null, Url | null> | {[key: string | null]: IUrl | null}): CatBoostPipe;
  ...
  withCustomModelCode(customModelCode: C3.Map<string | null, any | null> | {[key: string | null]: any | null}): CatBoostPipe;

  /**
   * Name for the function on the native model to call to do {@link MlProcessable#process}.
   */
  readonly processFunc?: string | null;
  withProcessFunc(processFunc: string | null): CatBoostPipe;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): CatBoostPipe | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): CatBoostPipe | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): CatBoostPipe | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): CatBoostPipe | null;
   ...
   */
  replaceType(old: Type, new_: Type): CatBoostPipe;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): CatBoostPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): CatBoostPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<CatBoostPipe | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<CatBoostPipe | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): CatBoostPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CatBoostPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CatBoostPipe;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): CatBoostPipe;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): CatBoostPipe;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): CatBoostPipe;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): CatBoostPipe;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): CatBoostPipe;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): CatBoostPipe;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): CatBoostPipe;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): CatBoostPipe;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): CatBoostPipe;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): CatBoostPipe;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): CatBoostPipe;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): CatBoostPipe;
   ...
   * @see #unsetField
   */
  defaultField(field: string): CatBoostPipe;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): CatBoostPipe;
   ...
   * @see #removeField
   */
  unsetField(field: string): CatBoostPipe;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): CatBoostPipe;
   ...
   * @see #unsetField
   */
  removeField(field: string): CatBoostPipe;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): CatBoostPipe;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): CatBoostPipe;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): CatBoostPipe;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): CatBoostPipe;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): CatBoostPipe;

  mergeJson(json: any | null): CatBoostPipe;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): CatBoostPipe;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): CatBoostPipe;
   ...
   */
  singletonArray(): C3.Array<CatBoostPipe | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<CatBoostPipe | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<CatBoostPipe | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<CatBoostPipe | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<CatBoostPipe | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, CatBoostPipe | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, CatBoostPipe | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<CatBoostPipe | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<CatBoostPipe | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): CatBoostPipe;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): CatBoostPipe;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): CatBoostPipe;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): CatBoostPipe;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): CatBoostPipe;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): CatBoostPipe;
   ...
   * @see #fromString
   */
  static make(s: string | null): CatBoostPipe | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): CatBoostPipe;
   ...
   */
  static cachedEmptyInst(): CatBoostPipe;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<CatBoostPipe>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): CatBoostPipe;
   ...
   */
  afterConvert(model: any, spec?: MlConvertSpec | null): CatBoostPipe;
   ...
   */
  trainSync(x: Data | null, y?: Data | null, spec?: MlOperationSpec | null): CatBoostPipe;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<CatBoostPipe | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<CatBoostPipe | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<CatBoostPipe | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): CatBoostPipe | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string | null): CatBoostPipe | null;
   ...
   * @see findByCacheKey
   */
  getCached(): CatBoostPipe | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): CatBoostPipe | null;
   ...
   */
  static produce(key: string): CatBoostPipe | null;
   ...
   */
  static produceAll(): C3.Map<string | null, CatBoostPipe | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, CatBoostPipe | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<CatBoostPipe | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<CatBoostPipe | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<CatBoostPipe | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<CatBoostPipe | null> | null>;
   ...
   */
  get(include?: string | null): CatBoostPipe | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): CatBoostPipe | null;
   ...
   */
  getMissing(spec: GetMissingSpec): CatBoostPipe;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): CatBoostPipe | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): CatBoostPipe;
   ...
   * @see #toString
   */
  static fromString(s: string | null): CatBoostPipe | null;
   ...
   */
  create(spec?: UpsertSpec | null): CatBoostPipe | null;
   ...
   */
  static createBatch(objs: C3.Array<CatBoostPipe | null> | null, spec?: UpsertSpec | null): ObjList<CatBoostPipe | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<CatBoostPipe | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<CatBoostPipe | null> | null;
   ...
   */
  update(srcObj?: CatBoostPipe | null, spec?: UpsertSpec | null): CatBoostPipe | null;
   ...
   */
  upsert(srcObj?: CatBoostPipe | null, spec?: UpsertSpec | null): CatBoostPipe | null;
   ...
   */
  merge(spec?: MergeSpec | null): CatBoostPipe | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): CatBoostPipe | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): CatBoostPipe | null;
   ...
   */
  static updateBatch(objs: C3.Array<CatBoostPipe | null> | null, srcObjs?: C3.Array<CatBoostPipe | null>, spec?: UpsertSpec | null): ObjList<CatBoostPipe | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<CatBoostPipe | null>>, spec?: UpsertSpec | null): ObjList<CatBoostPipe | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<CatBoostPipe | null> | null, srcObjs?: C3.Array<CatBoostPipe | null>, spec?: UpsertSpec | null): ObjList<CatBoostPipe | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<CatBoostPipe | null>>, spec?: UpsertSpec | null): ObjList<CatBoostPipe | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<CatBoostPipe | null> | null, spec?: TouchSpec | null): ObjList<CatBoostPipe | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<CatBoostPipe | null> | null, spec?: MergeSpec | null): ObjList<CatBoostPipe | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<CatBoostPipe | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<CatBoostPipe | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<CatBoostPipe | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<CatBoostPipe | null> | null;
   ...
   */
  static mergeAll(mergeObj: CatBoostPipe | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: CatBoostPipe | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<CatBoostPipe | null> | null, spec?: UpsertSpec | null): ObjList<CatBoostPipe | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<CatBoostPipe | null> | null, spec?: UpsertSpec | null): ObjList<CatBoostPipe | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<CatBoostPipe | null> | null): ObjList<CatBoostPipe | null>;
   ...
   */
  static beforeUpdate(objs: C3.Array<CatBoostPipe | null> | null): ObjList<CatBoostPipe | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<CatBoostPipe | null> | null): ObjList<CatBoostPipe | null>;
   ...
   */
  static afterCreate(objs: C3.Array<CatBoostPipe | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<CatBoostPipe | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<CatBoostPipe | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<CatBoostPipe | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<CatBoostPipe | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): CatBoostPipe | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<CatBoostPipe | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: CatBoostPipe | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<CatBoostPipe | null> | null, callback?: λFunction<CatBoostPipe | null, CatBoostPipe | null> | null): ObjList<CatBoostPipe | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<CatBoostPipe | null> | null, callback?: λFunction<CatBoostPipe | null, CatBoostPipe | null> | null): C3.Array<ObjError | null>;
   ...
   */
  publish(subPath?: string | null, contentType?: string | null): CatBoostPipe;
   ...
   */
  static removeSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<CatBoostPipe | null> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec | null): CatBoostPipe | null;
   ...
   */
  static createSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<CatBoostPipe | null> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData | null, spec?: UpsertSpec | null): CatBoostPipe | null;
   ...
   */
  static updateSeedDataBatch(objs?: C3.Array<SeedData | null>, srcObjs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<CatBoostPipe | null> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec | null): CatBoostPipe | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: C3.Array<SeedData | null>, spec?: MergeSpec | null): ObjList<CatBoostPipe | null> | null;
  ...
  dependencies(): SeedDataDeps<CatBoostPipe | null> | null;
   ...
   */
  static convert(model: any, spec?: MlConvertSpec | null): CatBoostPipe;
   ...
   */
  updateModelFiles(modelFiles: C3.Map<string | null, Url | null> | null, spec?: MlOperationSpec | null): CatBoostPipe;
   ...
   */
  afterTrain(doTrainOutputs: any, spec?: MlOperationSpec | null): CatBoostPipe;
   ...
   */
  withNewSpec(spec?: MlConvertSpec | null): CatBoostPipe;
   ...
   */
  withHyperparamSpaces(paramSpaces: C3.Map<string | null, Hp.ParamSpace | null>): CatBoostPipe;
