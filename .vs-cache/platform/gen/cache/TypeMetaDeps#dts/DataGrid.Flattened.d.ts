// TypeScript definitions for the C3 type DataGrid.Flattened
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of DataGrid.Flattened
 */
declare namespace DataGrid {
  export interface IFlattened {
 ...
 */
declare namespace DataGrid {
  export class Flattened extends Obj {

    /**
     * The raw data from which the grid was built.
     */
    readonly source?: any;
    withSource(source: any): DataGrid.Flattened;
    ...
    withLabel(label: string | null): DataGrid.Flattened;

    /**
     * A more detailed description of the source of the data. Typically the full value type of the data.
     */
    readonly description?: string | null;
    withDescription(description: string | null): DataGrid.Flattened;
    ...
    withCols(cols: C3.Array<DataGrid.Col> | Array<IDataGrid.Col>): DataGrid.Flattened;

    readonly _buffer?: any;
    with_buffer(_buffer: any): DataGrid.Flattened;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): DataGrid.Flattened | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): DataGrid.Flattened | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): DataGrid.Flattened | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): DataGrid.Flattened | null;
     ...
     */
    replaceType(old: Type, new_: Type): DataGrid.Flattened;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataGrid.Flattened;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataGrid.Flattened;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataGrid.Flattened | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataGrid.Flattened | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataGrid.Flattened;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataGrid.Flattened;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataGrid.Flattened;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): DataGrid.Flattened;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): DataGrid.Flattened;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): DataGrid.Flattened;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataGrid.Flattened;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataGrid.Flattened;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): DataGrid.Flattened;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): DataGrid.Flattened;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): DataGrid.Flattened;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): DataGrid.Flattened;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataGrid.Flattened;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): DataGrid.Flattened;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataGrid.Flattened;
     ...
     * @see #unsetField
     */
    defaultField(field: string): DataGrid.Flattened;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): DataGrid.Flattened;
     ...
     * @see #removeField
     */
    unsetField(field: string): DataGrid.Flattened;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): DataGrid.Flattened;
     ...
     * @see #unsetField
     */
    removeField(field: string): DataGrid.Flattened;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): DataGrid.Flattened;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataGrid.Flattened;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): DataGrid.Flattened;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataGrid.Flattened;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataGrid.Flattened;

    mergeJson(json: any | null): DataGrid.Flattened;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataGrid.Flattened;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): DataGrid.Flattened;
     ...
     */
    singletonArray(): C3.Array<DataGrid.Flattened | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<DataGrid.Flattened | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<DataGrid.Flattened | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<DataGrid.Flattened | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<DataGrid.Flattened | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, DataGrid.Flattened | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataGrid.Flattened | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<DataGrid.Flattened | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<DataGrid.Flattened | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DataGrid.Flattened;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DataGrid.Flattened;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DataGrid.Flattened;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): DataGrid.Flattened;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DataGrid.Flattened;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): DataGrid.Flattened;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DataGrid.Flattened;
     ...
     */
    static cachedEmptyInst(): DataGrid.Flattened;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DataGrid.Flattened>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): DataGrid.Flattened;
     ...
     */
    static fromObj(obj: Obj, spec?: DataGrid.LoadSpec | null): DataGrid.Flattened;

    /**
     * Flatten the specified {@link Tuple tuple} instance. Each field becomes a column and if that field is a collection,
     * each element becomes a row.
     */
    static fromTuple(tuple: Tuple, spec?: DataGrid.LoadSpec | null): DataGrid.Flattened;
     ...
     */
    static canFlatten(obj: Obj | null): boolean;
     ...
     */
    static canFlatten(tuple: Tuple | null): boolean;
  }
}
