// TypeScript definitions for the C3 type InvalidationQueueErrorReviewComment

/**
 * Comments for an {@link InvalidationQueueErrorReview}.
 *
 * @remarks this represents a value passed to a method that expects an instance of InvalidationQueueErrorReviewComment
 */
declare interface IInvalidationQueueErrorReviewComment {
  ...
  /**
   * Review that the comment is for.
   */
  review: IInvalidationQueueErrorReview;
}

/**
 * Comments for an {@link InvalidationQueueErrorReview}.
 *
 * @remarks this represents a made instance of InvalidationQueueErrorReviewComment
 */
declare class InvalidationQueueErrorReviewComment extends Obj {
   ...
   */
  readonly id: string;
  withId(id: string): InvalidationQueueErrorReviewComment;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): InvalidationQueueErrorReviewComment;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): InvalidationQueueErrorReviewComment;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): InvalidationQueueErrorReviewComment;
  ...
  withVersion(version: number | null): InvalidationQueueErrorReviewComment;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): InvalidationQueueErrorReviewComment;

  /**
   * Comment text
   */
  readonly comment: string;
  withComment(comment: string): InvalidationQueueErrorReviewComment;

  /**
   * Review that the comment is for.
   */
  readonly review: InvalidationQueueErrorReview;
  withReview(review: IInvalidationQueueErrorReview): InvalidationQueueErrorReviewComment;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): InvalidationQueueErrorReviewComment | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): InvalidationQueueErrorReviewComment | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): InvalidationQueueErrorReviewComment | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): InvalidationQueueErrorReviewComment | null;
   ...
   */
  replaceType(old: Type, new_: Type): InvalidationQueueErrorReviewComment;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): InvalidationQueueErrorReviewComment;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): InvalidationQueueErrorReviewComment;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<InvalidationQueueErrorReviewComment | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<InvalidationQueueErrorReviewComment | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): InvalidationQueueErrorReviewComment;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): InvalidationQueueErrorReviewComment;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): InvalidationQueueErrorReviewComment;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): InvalidationQueueErrorReviewComment;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): InvalidationQueueErrorReviewComment;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): InvalidationQueueErrorReviewComment;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): InvalidationQueueErrorReviewComment;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): InvalidationQueueErrorReviewComment;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): InvalidationQueueErrorReviewComment;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): InvalidationQueueErrorReviewComment;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): InvalidationQueueErrorReviewComment;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): InvalidationQueueErrorReviewComment;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): InvalidationQueueErrorReviewComment;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): InvalidationQueueErrorReviewComment;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): InvalidationQueueErrorReviewComment;
   ...
   * @see #unsetField
   */
  defaultField(field: string): InvalidationQueueErrorReviewComment;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): InvalidationQueueErrorReviewComment;
   ...
   * @see #removeField
   */
  unsetField(field: string): InvalidationQueueErrorReviewComment;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): InvalidationQueueErrorReviewComment;
   ...
   * @see #unsetField
   */
  removeField(field: string): InvalidationQueueErrorReviewComment;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): InvalidationQueueErrorReviewComment;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): InvalidationQueueErrorReviewComment;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): InvalidationQueueErrorReviewComment;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): InvalidationQueueErrorReviewComment;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): InvalidationQueueErrorReviewComment;

  mergeJson(json: any | null): InvalidationQueueErrorReviewComment;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): InvalidationQueueErrorReviewComment;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): InvalidationQueueErrorReviewComment;
   ...
   */
  singletonArray(): C3.Array<InvalidationQueueErrorReviewComment | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<InvalidationQueueErrorReviewComment | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<InvalidationQueueErrorReviewComment | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<InvalidationQueueErrorReviewComment | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<InvalidationQueueErrorReviewComment | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, InvalidationQueueErrorReviewComment | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, InvalidationQueueErrorReviewComment | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<InvalidationQueueErrorReviewComment | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<InvalidationQueueErrorReviewComment | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): InvalidationQueueErrorReviewComment;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): InvalidationQueueErrorReviewComment;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): InvalidationQueueErrorReviewComment;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): InvalidationQueueErrorReviewComment;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): InvalidationQueueErrorReviewComment;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): InvalidationQueueErrorReviewComment;
   ...
   * @see #fromString
   */
  static make(s: string | null): InvalidationQueueErrorReviewComment | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): InvalidationQueueErrorReviewComment;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): InvalidationQueueErrorReviewComment;
   ...
   */
  static cachedEmptyInst(): InvalidationQueueErrorReviewComment;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<InvalidationQueueErrorReviewComment>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): InvalidationQueueErrorReviewComment;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<InvalidationQueueErrorReviewComment | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<InvalidationQueueErrorReviewComment | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<InvalidationQueueErrorReviewComment | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<InvalidationQueueErrorReviewComment | null> | null>;
   ...
   */
  get(include?: string | null): InvalidationQueueErrorReviewComment | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): InvalidationQueueErrorReviewComment | null;
   ...
   */
  getMissing(spec: GetMissingSpec): InvalidationQueueErrorReviewComment;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): InvalidationQueueErrorReviewComment | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): InvalidationQueueErrorReviewComment;
   ...
   * @see #toString
   */
  static fromString(s: string | null): InvalidationQueueErrorReviewComment | null;
   ...
   */
  create(spec?: UpsertSpec | null): InvalidationQueueErrorReviewComment | null;
   ...
   */
  static createBatch(objs: C3.Array<InvalidationQueueErrorReviewComment | null> | null, spec?: UpsertSpec | null): ObjList<InvalidationQueueErrorReviewComment | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<InvalidationQueueErrorReviewComment | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<InvalidationQueueErrorReviewComment | null> | null;
   ...
   */
  update(srcObj?: InvalidationQueueErrorReviewComment | null, spec?: UpsertSpec | null): InvalidationQueueErrorReviewComment | null;
   ...
   */
  upsert(srcObj?: InvalidationQueueErrorReviewComment | null, spec?: UpsertSpec | null): InvalidationQueueErrorReviewComment | null;
   ...
   */
  merge(spec?: MergeSpec | null): InvalidationQueueErrorReviewComment | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): InvalidationQueueErrorReviewComment | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): InvalidationQueueErrorReviewComment | null;
   ...
   */
  static updateBatch(objs: C3.Array<InvalidationQueueErrorReviewComment | null> | null, srcObjs?: C3.Array<InvalidationQueueErrorReviewComment | null>, spec?: UpsertSpec | null): ObjList<InvalidationQueueErrorReviewComment | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<InvalidationQueueErrorReviewComment | null>>, spec?: UpsertSpec | null): ObjList<InvalidationQueueErrorReviewComment | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<InvalidationQueueErrorReviewComment | null> | null, srcObjs?: C3.Array<InvalidationQueueErrorReviewComment | null>, spec?: UpsertSpec | null): ObjList<InvalidationQueueErrorReviewComment | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<InvalidationQueueErrorReviewComment | null>>, spec?: UpsertSpec | null): ObjList<InvalidationQueueErrorReviewComment | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<InvalidationQueueErrorReviewComment | null> | null, spec?: TouchSpec | null): ObjList<InvalidationQueueErrorReviewComment | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<InvalidationQueueErrorReviewComment | null> | null, spec?: MergeSpec | null): ObjList<InvalidationQueueErrorReviewComment | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<InvalidationQueueErrorReviewComment | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<InvalidationQueueErrorReviewComment | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<InvalidationQueueErrorReviewComment | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<InvalidationQueueErrorReviewComment | null> | null;
   ...
   */
  static mergeAll(mergeObj: InvalidationQueueErrorReviewComment | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: InvalidationQueueErrorReviewComment | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<InvalidationQueueErrorReviewComment | null> | null, spec?: UpsertSpec | null): ObjList<InvalidationQueueErrorReviewComment | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<InvalidationQueueErrorReviewComment | null> | null, spec?: UpsertSpec | null): ObjList<InvalidationQueueErrorReviewComment | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): InvalidationQueueErrorReviewComment | null;
   ...
   */
  static beforeCreate(objs: C3.Array<InvalidationQueueErrorReviewComment | null> | null): ObjList<InvalidationQueueErrorReviewComment | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<InvalidationQueueErrorReviewComment | null> | null): ObjList<InvalidationQueueErrorReviewComment | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<InvalidationQueueErrorReviewComment | null> | null): ObjList<InvalidationQueueErrorReviewComment | null>;
   ...
   */
  static afterCreate(objs: C3.Array<InvalidationQueueErrorReviewComment | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<InvalidationQueueErrorReviewComment | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<InvalidationQueueErrorReviewComment | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<InvalidationQueueErrorReviewComment | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<InvalidationQueueErrorReviewComment | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): InvalidationQueueErrorReviewComment | null;
   ...
   */
  withoutIdentity(): InvalidationQueueErrorReviewComment | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<InvalidationQueueErrorReviewComment | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: InvalidationQueueErrorReviewComment | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<InvalidationQueueErrorReviewComment | null> | null, callback?: λFunction<InvalidationQueueErrorReviewComment | null, InvalidationQueueErrorReviewComment | null> | null): ObjList<InvalidationQueueErrorReviewComment | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<InvalidationQueueErrorReviewComment | null> | null, callback?: λFunction<InvalidationQueueErrorReviewComment | null, InvalidationQueueErrorReviewComment | null> | null): C3.Array<ObjError | null>;
