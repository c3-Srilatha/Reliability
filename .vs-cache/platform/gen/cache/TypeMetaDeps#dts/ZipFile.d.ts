// TypeScript definitions for the C3 type ZipFile

/**
 * Represents single ZIP file.
 *
 * @see FileSystem#zipFiles
 *
 * @remarks this represents a value passed to a method that expects an instance of ZipFile
 */
 ...
 * @see FileSystem#zipFiles
 *
 * @remarks this represents a made instance of ZipFile
 */
declare class ZipFile extends Obj {
  ...
  withContentEncoding(contentEncoding: string | null): ZipFile;
  ...
  withContentLanguage(contentLanguage: string | null): ZipFile;
  ...
  withContentLength(contentLength: number | null): ZipFile;
  ...
  withContentLocation(contentLocation: string | null): ZipFile;
  ...
  withContentType(contentType: string | null): ZipFile;
  ...
  withContentDisposition(contentDisposition: string | null): ZipFile;
  ...
  withETag(eTag: string | null): ZipFile;
  ...
  withLastModified(lastModified: DateTime | Date | string | null): ZipFile;

  /**
   * Id of user / identity who last last modified this content.
   */
  readonly lastModifiedBy?: string | null;
  withLastModifiedBy(lastModifiedBy: string | null): ZipFile;
  ...
  withContentMD5(contentMD5: string | null): ZipFile;
  ...
  withContentSHA1(contentSHA1: string | null): ZipFile;

  /**
   * Field to maintain state whether content metadata was read or not.
   */
  readonly hasMetadata?: boolean;
  withHasMetadata(hasMetadata: boolean): ZipFile;

  /**
   * URL for this file that contains scheme (i.e. file-system) and fully qualified encoded path.
   */
  readonly url?: string | null;
  withUrl(url: string | null): ZipFile;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ZipFile | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ZipFile | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ZipFile | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ZipFile | null;
   ...
   */
  replaceType(old: Type, new_: Type): ZipFile;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ZipFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ZipFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ZipFile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ZipFile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ZipFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ZipFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ZipFile;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ZipFile;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ZipFile;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ZipFile;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ZipFile;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ZipFile;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ZipFile;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ZipFile;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ZipFile;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ZipFile;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ZipFile;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ZipFile;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ZipFile;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ZipFile;
   ...
   * @see #removeField
   */
  unsetField(field: string): ZipFile;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ZipFile;
   ...
   * @see #unsetField
   */
  removeField(field: string): ZipFile;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ZipFile;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ZipFile;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ZipFile;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ZipFile;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ZipFile;

  mergeJson(json: any | null): ZipFile;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ZipFile;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ZipFile;
   ...
   */
  singletonArray(): C3.Array<ZipFile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ZipFile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ZipFile | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ZipFile | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ZipFile | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ZipFile | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ZipFile | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ZipFile | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ZipFile | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ZipFile;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ZipFile;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ZipFile;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ZipFile;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ZipFile;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ZipFile;
   ...
   * @see #fromString
   */
  static make(s: string | null): ZipFile | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ZipFile;
   ...
   */
  static cachedEmptyInst(): ZipFile;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ZipFile>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ZipFile;
   ...
   */
  withFileName(fileName: string | null): ZipFile;

  /**
   * Changes file extension in this instance.
   */
  withFileExt(fileExt: string | null): ZipFile;
   ...
   */
  identify(suffix?: string | null): ZipFile;
   ...
   */
  readMetadata(spec?: FileOperationSpec | null): ZipFile;
   ...
   */
  refreshMetadata(spec?: FileOperationSpec | null): ZipFile;
   ...
   */
  encodedPushStream(spec?: FileOperationSpec | null): Pair<ZipFile | null, BytePushStream | null>;

  /**
   * @return byte push stream to be used for writing un-encoded data into this content object.
   */
  pushStream(spec?: FileOperationSpec | null): Pair<ZipFile | null, BytePushStream | null>;

  /**
   * @return character push stream to be used for writing un-encoded data into this content object.
   */
  charPushStream(spec?: FileOperationSpec | null): Pair<ZipFile | null, CharPushStream | null>;
   ...
   */
  encodedStream(spec?: FileOperationSpec | null): Pair<ZipFile | null, ByteStream | null> | null;
   ...
   */
  writeStream(content: ByteStream | null, spec?: FileOperationSpec | null): ZipFile;

  /**
   * Truncates file and replaces it's content with provided binary content.
   */
  writeInputStream(inputStream: any, spec?: FileOperationSpec | null): ZipFile;

  /**
   * Truncates file and replaces its content with provided binary content from zipInputStream
   */
  writeZipInputStream(zipInputStream: any, spec?: FileOperationSpec | null): ZipFile;
   ...
   */
  writeEncodedStream(encodedContent: ByteStream | null, spec?: FileOperationSpec | null): ZipFile;

  /**
   * Truncates file and replaces it's encoded content with provided binary content.
   */
  writeEncodedInputStream(inputStream: any, spec?: FileOperationSpec | null): ZipFile;
   ...
   *           content that needs to be written
   */
  write(content: any | null, spec?: FileOperationSpec | null): ZipFile;
   ...
   *           encoded content that needs to be written
   */
  writeEncoded(encodedContent: any | null, spec?: FileOperationSpec | null): ZipFile;
   ...
   *           content that needs to be written
   */
  writeString(content: string | null, spec?: FileOperationSpec | null): ZipFile;
   ...
   */
  writeObj(obj: Obj | null, spec?: FileObjsOperSpec | null): ZipFile;
   ...
   * @return pair of update instance of this content and number of objs written
   */
  startWriteObjs(spec?: FileObjsOperSpec | null): Pair<ZipFile | null, PushStream<Obj | null> | null>;
   ...
   */
  compress(contentEncoding?: string | null, spec?: FileCompressSpec | null): ZipFile;

  /**
   * Uncompresses file. Removes compression specific extension.
   */
  uncompress(spec?: FileCompressSpec | null): ZipFile;
   ...
   */
  transcode(contentType: string, contentEncoding: string, spec?: FileCompressSpec | null): ZipFile;

  /**
   * Copies content to a given target.
   */
  copyContentTo(target: ZipFile, spec?: FileOperationSpec | null): void;
   ...
   */
  static fromString(s: string | null): ZipFile | null;
  ...
  /**
   * Adds entry to this ZIP file. Note that it reads whole ZIP file in order to add one entry so it is more efficient
   * to use #addEntries or FileSystem#zip.
   */
  addEntry(content: any, path: string | null): ZipFile;

  /**
   * Adds multiple entries to this ZIP file. Note that it reads whole ZIP file in order to add entries so it is more
   * efficient FileSystem#zip.
   */
  addEntries(entries: C3.Map<string | null, any | null>): ZipFile;
}
