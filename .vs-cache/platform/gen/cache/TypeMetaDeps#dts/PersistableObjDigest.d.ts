// TypeScript definitions for the C3 type PersistableObjDigest

/**
 * Datatype to store ObjDigest in Database.
 * use C3Viz(PersistableObjDigest) to get best results
 * See {@ link ObjDigest} for more information on how to interpret results.
 *
 * @remarks this represents a value passed to a method that expects an instance of PersistableObjDigest
 */
declare interface IPersistableObjDigest {
   ...
   */
  spec?: IDigestSpec | null;

  /**
   * Stores input data in a HyperLogLog structure used for estimating unique count
   */
  hyperLogLog?: IHyperLogLog | null;

  /**
   * Stores input data in a CountMinSketch structure used for estimating frequent elements
   */
  countMinSketch?: ICountMinSketch | null;

  /**
   * Stores hashes of a subset of input data used for approximate inclusion tests
   */
  minHash?: IMinHash | null;

  /**
   * Statistics of field values in arbitrary dataset.
   */
  fieldStats?: C3.Map<string | null, Digest<any, any, any> | null> | {[key: string | null]: IDigest<any, any, any> | null};
  ...
  /**
   * denotes source collection where ObjDigest came from. If the PersistableObjDigest summarizes entire
   * SourceCollection, field will be null, and id of SourceCollection will match id of PersistableObjDigest
   */
 ...
 * See {@ link ObjDigest} for more information on how to interpret results.
 *
 * @remarks this represents a made instance of PersistableObjDigest
 */
declare class PersistableObjDigest extends Obj {

  /**
   * the minimum value of the input stream, for string will return string of minimum length
   */
  readonly min?: Obj | null;
  withMin(min: IObj | null): PersistableObjDigest;

  /**
   * the maximum value of the input stream, for string will return string of maximum length
   */
  readonly max?: Obj | null;
  withMax(max: IObj | null): PersistableObjDigest;

  /**
   * number of elements evaluated
   */
  readonly count: number;
  withCount(count: number): PersistableObjDigest;

  /**
   * number of null elements evaluated
   */
  readonly nullCount: number;
  withNullCount(nullCount: number): PersistableObjDigest;

  /**
   * number of elements that did not match the specified ValueType of this Digest
   */
  readonly invalidCount: number;
  withInvalidCount(invalidCount: number): PersistableObjDigest;

  /**
   * Stores the spec for what statistics were calculated for this Digest
   */
  readonly spec?: DigestSpec | null;
  withSpec(spec: IDigestSpec | null): PersistableObjDigest;

  /**
   * Stores input data in a HyperLogLog structure used for estimating unique count
   */
  readonly hyperLogLog?: HyperLogLog | null;
  withHyperLogLog(hyperLogLog: IHyperLogLog | null): PersistableObjDigest;

  /**
   * Stores input data in a CountMinSketch structure used for estimating frequent elements
   */
  readonly countMinSketch?: CountMinSketch | null;
  withCountMinSketch(countMinSketch: ICountMinSketch | null): PersistableObjDigest;

  /**
   * Stores hashes of a subset of input data used for approximate inclusion tests
   */
  readonly minHash?: MinHash | null;
  withMinHash(minHash: IMinHash | null): PersistableObjDigest;

  /**
   * Statistics of field values in arbitrary dataset.
   */
  readonly fieldStats?: C3.Map<string | null, Digest<any, any, any> | null>;
  withFieldStats(fieldStats: C3.Map<string | null, Digest<any, any, any> | null> | {[key: string | null]: IDigest<any, any, any> | null}): PersistableObjDigest;
   ...
   */
  readonly id: string;
  withId(id: string): PersistableObjDigest;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): PersistableObjDigest;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): PersistableObjDigest;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): PersistableObjDigest;
  ...
  withVersion(version: number | null): PersistableObjDigest;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): PersistableObjDigest;
  ...
  withPartition(partition: string | null): PersistableObjDigest;

  /**
   * merge is a wrapper around doMerge. Each sub type should implement sub type specific merging in doMerge.
   */
  mergeWith(other: ObjDigest | null): ObjDigest;

  /**
   * Merge a collection of T to form a single T
   */
  static mergeAll(elements: Collection<ObjDigest | null> | null): ObjDigest;
   ...
   */
  static mergeAll(mergeObj: PersistableObjDigest | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PersistableObjDigest | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): PersistableObjDigest | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): PersistableObjDigest | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): PersistableObjDigest | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): PersistableObjDigest | null;
   ...
   */
  replaceType(old: Type, new_: Type): PersistableObjDigest;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PersistableObjDigest;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PersistableObjDigest;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PersistableObjDigest | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PersistableObjDigest | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): PersistableObjDigest;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PersistableObjDigest;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PersistableObjDigest;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PersistableObjDigest;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PersistableObjDigest;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PersistableObjDigest;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): PersistableObjDigest;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PersistableObjDigest;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PersistableObjDigest;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): PersistableObjDigest;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): PersistableObjDigest;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): PersistableObjDigest;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): PersistableObjDigest;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PersistableObjDigest;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): PersistableObjDigest;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PersistableObjDigest;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PersistableObjDigest;
   ...
   * @see #removeField
   */
  unsetField(field: string): PersistableObjDigest;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PersistableObjDigest;
   ...
   * @see #unsetField
   */
  removeField(field: string): PersistableObjDigest;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PersistableObjDigest;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): PersistableObjDigest;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): PersistableObjDigest;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): PersistableObjDigest;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): PersistableObjDigest;

  mergeJson(json: any | null): PersistableObjDigest;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): PersistableObjDigest;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): PersistableObjDigest;
   ...
   */
  singletonArray(): C3.Array<PersistableObjDigest | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<PersistableObjDigest | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PersistableObjDigest | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<PersistableObjDigest | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PersistableObjDigest | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, PersistableObjDigest | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PersistableObjDigest | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PersistableObjDigest | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PersistableObjDigest | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): PersistableObjDigest;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): PersistableObjDigest;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): PersistableObjDigest;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PersistableObjDigest;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): PersistableObjDigest;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PersistableObjDigest;
   ...
   * @see #fromString
   */
  static make(s: string | null): PersistableObjDigest | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): PersistableObjDigest;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): PersistableObjDigest;
   ...
   */
  static cachedEmptyInst(): PersistableObjDigest;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<PersistableObjDigest>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): PersistableObjDigest;

  /**
   * Builds stats by invoking consumer lambda with an empty builder
   */
  static buildStats(builder: λConsumer<ObjDigestBuilder | null>): PersistableObjDigest | null;

  /**
   * Instantiates builder of this stats
   */
  static statsBuilder(): ObjDigestBuilder;

  /**
   * Overload of statsBuilder to accept a DigestSpec
   */
  static statsBuilder(spec?: DigestSpec | null): DigestBuilder<Digest | null>;

  /**
   * Retrieve type of specialized stats builder for this stats
   */
  static statsBuilderType(): Type;

  /**
   * Instantiates builder of this stats with initial values based on this instance
   */
  toStatsBuilder(): ObjDigestBuilder;
   ...
   */
  hist(): Histogram<any, any, HistogramBuilder | null> | null;
   ...
   */
  approxMostFrequent(): C3.Map<string | null, number | null>;
   ...
   * @see MinHash
   */
  approxInclusionTest(other: ObjDigest): boolean;
   ...
   */
  approxJaccardIndex(other: ObjDigest): number;

  /**
   * Convert AnyDigest to Digest with the highest count. This method is a no-op for anything but AnyDigest.
   * @see AnyDigest
   */
  toMostPopulatedDigest(): Digest<any, Digest | null, DigestBuilder | null>;

  doMerge(other?: ObjDigest | null): ObjDigest;

  /**
   * If source type is known via Digest#valueType then percentage of invalid field values in the source dataset
   */
  invalidPercent(): number;

  /**
   * Computes an obj digest based on deserialized objects from the given File
   */
  static fromFile(file?: File | null, spec?: FileObjDigestSpec | null): ObjDigest | null;

  /**
   * Computes an obj digest based on deserialized objects from the given Content
   */
  static fromContent(content?: Content | null, spec?: FileObjDigestSpec | null): ObjDigest | null;

  /**
   * Constructs an obj digest from stream of json
   */
  static fromJsonLines(jsonLines?: Stream<any | null>, spec?: DigestSpec | null): ObjDigest;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<PersistableObjDigest | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PersistableObjDigest | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<PersistableObjDigest | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<PersistableObjDigest | null> | null>;
   ...
   */
  get(include?: string | null): PersistableObjDigest | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): PersistableObjDigest | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PersistableObjDigest;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): PersistableObjDigest | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PersistableObjDigest;
   ...
   * @see #toString
   */
  static fromString(s: string | null): PersistableObjDigest | null;
   ...
   */
  create(spec?: UpsertSpec | null): PersistableObjDigest | null;
   ...
   */
  static createBatch(objs: C3.Array<PersistableObjDigest | null> | null, spec?: UpsertSpec | null): ObjList<PersistableObjDigest | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PersistableObjDigest | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<PersistableObjDigest | null> | null;
   ...
   */
  update(srcObj?: PersistableObjDigest | null, spec?: UpsertSpec | null): PersistableObjDigest | null;
   ...
   */
  upsert(srcObj?: PersistableObjDigest | null, spec?: UpsertSpec | null): PersistableObjDigest | null;
   ...
   */
  merge(spec?: MergeSpec | null): PersistableObjDigest | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): PersistableObjDigest | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): PersistableObjDigest | null;
   ...
   */
  static updateBatch(objs: C3.Array<PersistableObjDigest | null> | null, srcObjs?: C3.Array<PersistableObjDigest | null>, spec?: UpsertSpec | null): ObjList<PersistableObjDigest | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<PersistableObjDigest | null>>, spec?: UpsertSpec | null): ObjList<PersistableObjDigest | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<PersistableObjDigest | null> | null, srcObjs?: C3.Array<PersistableObjDigest | null>, spec?: UpsertSpec | null): ObjList<PersistableObjDigest | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<PersistableObjDigest | null>>, spec?: UpsertSpec | null): ObjList<PersistableObjDigest | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<PersistableObjDigest | null> | null, spec?: TouchSpec | null): ObjList<PersistableObjDigest | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PersistableObjDigest | null> | null, spec?: MergeSpec | null): ObjList<PersistableObjDigest | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PersistableObjDigest | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<PersistableObjDigest | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<PersistableObjDigest | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<PersistableObjDigest | null> | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<PersistableObjDigest | null> | null, spec?: UpsertSpec | null): ObjList<PersistableObjDigest | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<PersistableObjDigest | null> | null, spec?: UpsertSpec | null): ObjList<PersistableObjDigest | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): PersistableObjDigest | null;
   ...
   */
  static beforeCreate(objs: C3.Array<PersistableObjDigest | null> | null): ObjList<PersistableObjDigest | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<PersistableObjDigest | null> | null): ObjList<PersistableObjDigest | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<PersistableObjDigest | null> | null): ObjList<PersistableObjDigest | null>;
   ...
   */
  static afterCreate(objs: C3.Array<PersistableObjDigest | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<PersistableObjDigest | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<PersistableObjDigest | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<PersistableObjDigest | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<PersistableObjDigest | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): PersistableObjDigest | null;
   ...
   */
  withoutIdentity(): PersistableObjDigest | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<PersistableObjDigest | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: PersistableObjDigest | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<PersistableObjDigest | null> | null, callback?: λFunction<PersistableObjDigest | null, PersistableObjDigest | null> | null): ObjList<PersistableObjDigest | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<PersistableObjDigest | null> | null, callback?: λFunction<PersistableObjDigest | null, PersistableObjDigest | null> | null): C3.Array<ObjError | null>;
  ...
  /**
   * Generates a PersistableObjDigestBatchJob from URL or encoded path. Job will store PersistableObjDigest
   * in database, which will summarize data at the URL or encoded path.
   */
  static fromUrlOrEncodedPath(urlOrEncodedPath?: string | null, spec?: PersistableObjDigestBatchJobSpec | null): PersistableObjDigestBatchJob | null;
}
