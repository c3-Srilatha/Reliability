// TypeScript definitions for the C3 type TypeSystem
 ...
 * @see Remote
 *
 * @remarks this represents a value passed to a method that expects an instance of TypeSystem
 */
declare interface ITypeSystem {
}
...
declare class TypeSystem {
   ...
   */
  type(name: string, failIfMissing?: boolean): Type | null;
   ...
   */
  callJson(typeName: string, methodName: string, thisArg?: any | null, args?: any | null, kwargs?: any | null): any | null;
   ...
   */
  call(typeName: string, methodName: string, thisArg: any, ...args: any[]): T | null;

  /**
   * Invokes lambda action remotely.
   */
  call(action: λSupplier<T | null>): T | null;
   ...
   */
  callKwargs(typeName: string, methodName: string, kwargs?: C3.Map<string, any>): T | null;
   ...
   */
  typeNames(includeInnerTypes?: boolean): C3.Array<string | null>;
   ...
   */
  importTypes(scope: any): C3.Map<string | null, Type | null>;
