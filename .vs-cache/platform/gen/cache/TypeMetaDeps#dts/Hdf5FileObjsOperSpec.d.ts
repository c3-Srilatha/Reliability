// TypeScript definitions for the C3 type Hdf5FileObjsOperSpec

/**
 * @remarks this represents a value passed to a method that expects an instance of Hdf5FileObjsOperSpec
 */
declare interface IHdf5FileObjsOperSpec {
  ...
  /**
   * If provided, data will be read only for this group. The include will only be applied at the leaf level.
   * Comma separated list of values for groups. By default, information about all the groups will be returned
   */
  leafLevelGroupInclude?: string | null;
}

/**
 * @remarks this represents a made instance of Hdf5FileObjsOperSpec
 */
declare class Hdf5FileObjsOperSpec extends Obj {

  /**
   * Data serialization type. If not provided type will be inferred from source data
   */
  readonly serValueType?: ValueType | null;
  withSerValueType(serValueType: IValueType | null): Hdf5FileObjsOperSpec;

  /**
   * Content Type of the source data
   */
  readonly contentType?: string | null;
  withContentType(contentType: string | null): Hdf5FileObjsOperSpec;

  /**
   * Compression / Content Encoding of this data
   */
  readonly contentEncoding?: string | null;
  withContentEncoding(contentEncoding: string | null): Hdf5FileObjsOperSpec;

  /**
   * Batch size to use during serialization if batch writing is used (Arrow format uses batching).
   */
  readonly batchSize?: number | null;
  withBatchSize(batchSize: number | null): Hdf5FileObjsOperSpec;
  ...
  withNoCsvHeader(noCsvHeader: boolean): Hdf5FileObjsOperSpec;
  ...
  withCsvHeader(csvHeader: string | null): Hdf5FileObjsOperSpec;

  /**
   * Optional format for a csv values. Key should be field path used in a csv header.
   */
  readonly csvFormat?: C3.Map<string | null, Format | null>;
  withCsvFormat(csvFormat: C3.Map<string | null, Format | null> | {[key: string | null]: IFormat | null}): Hdf5FileObjsOperSpec;

  /**
   * Default csv delimiter for target type. Used for text/csv files. Leave this field as null for all other content types.
   */
  readonly defaultCsvDelimiter?: string | null;
  withDefaultCsvDelimiter(defaultCsvDelimiter: string | null): Hdf5FileObjsOperSpec;

  /**
   * Default escape character for target type. Used for text/csv files. Leave this field as null for all other content types.
   */
  readonly defaultCsvEscapeChar?: string | null;
  withDefaultCsvEscapeChar(defaultCsvEscapeChar: string | null): Hdf5FileObjsOperSpec;

  /**
   * Default quote character for target type. Used for text/csv files. Leave this field as null for all other content types.
   */
  readonly defaultCsvQuoteChar?: string | null;
  withDefaultCsvQuoteChar(defaultCsvQuoteChar: string | null): Hdf5FileObjsOperSpec;
  ...
  withAvroSchema(avroSchema: string | null): Hdf5FileObjsOperSpec;
  ...
  withIsObjList(isObjList: boolean): Hdf5FileObjsOperSpec;

  /**
   * Optionally skip extra fields in serialized content instead of failing to serialize.
   */
  readonly skipExtraFields?: boolean;
  withSkipExtraFields(skipExtraFields: boolean): Hdf5FileObjsOperSpec;

  /**
   * If true will silently ignore bad syntax in the content and will return no or partial results.
   */
  readonly ignoreBadContent?: boolean;
  withIgnoreBadContent(ignoreBadContent: boolean): Hdf5FileObjsOperSpec;
  ...
  withMergeXmlNonAdjacentLists(mergeXmlNonAdjacentLists: boolean): Hdf5FileObjsOperSpec;

  /**
   * Specifies various parameters for automatic retry that occurs in upsert due to retryable errors.
   */
  readonly retrySpec?: RetrySpec | null;
  withRetrySpec(retrySpec: IRetrySpec | null): Hdf5FileObjsOperSpec;

  /**
   * If set, stream will be instantiated again on retryable errors and execution will continue from the point of failure
   */
  readonly restartStreamOnRetry?: boolean;
  withRestartStreamOnRetry(restartStreamOnRetry: boolean): Hdf5FileObjsOperSpec;

  /**
   * The index of the first object from a stream that needs to be read.
   */
  readonly offset?: number | null;
  withOffset(offset: number | null): Hdf5FileObjsOperSpec;
  ...
  withLimit(limit: number | null): Hdf5FileObjsOperSpec;
  ...
  withValidateContentType(validateContentType: boolean): Hdf5FileObjsOperSpec;
  ...
  withPeekForMetadata(peekForMetadata: boolean): Hdf5FileObjsOperSpec;
  ...
  withFailIfMissing(failIfMissing: boolean): Hdf5FileObjsOperSpec;
  ...
  withSkipIfUnauthorized(skipIfUnauthorized: boolean): Hdf5FileObjsOperSpec;

  /**
   * If set and if requested file or directory url is under this path then will retrieve content from cache.
   */
  readonly cacheUrlOrEncodedPath?: string | null;
  withCacheUrlOrEncodedPath(cacheUrlOrEncodedPath: string | null): Hdf5FileObjsOperSpec;

  /**
   * Time in seconds that the cached file should live (default 24 hours).
   */
  readonly cacheTtlSec?: number | null;
  withCacheTtlSec(cacheTtlSec: number | null): Hdf5FileObjsOperSpec;
  ...
  withForceMultiPart(forceMultiPart: boolean): Hdf5FileObjsOperSpec;
  ...
  withDisableMultiPart(disableMultiPart: boolean): Hdf5FileObjsOperSpec;

  /**
   * Overrides default maximum file size before MultipartUpload kicks in. Default is 1GB
   */
  readonly maximumSingleUploadsize?: number | null;
  withMaximumSingleUploadsize(maximumSingleUploadsize: number | null): Hdf5FileObjsOperSpec;
  ...
  withMaxThreads(maxThreads: number | null): Hdf5FileObjsOperSpec;
  ...
  withMinThreads(minThreads: number | null): Hdf5FileObjsOperSpec;

  /**
   * If set to true, it will retry reading file when the file is not found.
   */
  readonly retryOnNotFound?: boolean;
  withRetryOnNotFound(retryOnNotFound: boolean): Hdf5FileObjsOperSpec;
  ...
  withLockOnWrite(lockOnWrite: boolean): Hdf5FileObjsOperSpec;

  /**
   * If set will use IoExecutor service.
   */
  readonly useIoExecutor?: boolean;
  withUseIoExecutor(useIoExecutor: boolean): Hdf5FileObjsOperSpec;

  /**
   * If not null, retry logic will be used from CloudClient rather than File
   */
  readonly cloudClient?: any;
  withCloudClient(cloudClient: any): Hdf5FileObjsOperSpec;
  ...
  withSerType(serType: IType | null): Hdf5FileObjsOperSpec;

  /**
   * If true then will not use parent folder of content for target type guess.
   */
  readonly doNotUseParentDirForSerType?: boolean;
  withDoNotUseParentDirForSerType(doNotUseParentDirForSerType: boolean): Hdf5FileObjsOperSpec;
  ...
  withUseBinaryEncodingDecoding(useBinaryEncodingDecoding: boolean): Hdf5FileObjsOperSpec;

  /**
   * Optionally indicating if serialized form should contain C3 type.
   */
  readonly shouldNotWriteType?: boolean;
  withShouldNotWriteType(shouldNotWriteType: boolean): Hdf5FileObjsOperSpec;

  /**
   * Optionally indicating if serialized form should be formatted for ease of reading.
   */
  readonly shouldWritePretty?: boolean;
  withShouldWritePretty(shouldWritePretty: boolean): Hdf5FileObjsOperSpec;
  ...
  withGuessMetadata(guessMetadata: boolean): Hdf5FileObjsOperSpec;

  /**
   * If true, checksum files will be generated when writing files
   */
  readonly createChecksum?: boolean;
  withCreateChecksum(createChecksum: boolean): Hdf5FileObjsOperSpec;

  /**
   * Whether to decrypt content during read
   */
  readonly decrypt?: boolean;
  withDecrypt(decrypt: boolean): Hdf5FileObjsOperSpec;

  /**
   * If provided, data will be read only for this group. The include will only be applied at the leaf level.
   * Comma separated list of values for groups. By default, information about all the groups will be returned
   */
  readonly leafLevelGroupInclude?: string | null;
  withLeafLevelGroupInclude(leafLevelGroupInclude: string | null): Hdf5FileObjsOperSpec;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Hdf5FileObjsOperSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Hdf5FileObjsOperSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Hdf5FileObjsOperSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Hdf5FileObjsOperSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): Hdf5FileObjsOperSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Hdf5FileObjsOperSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Hdf5FileObjsOperSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Hdf5FileObjsOperSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Hdf5FileObjsOperSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Hdf5FileObjsOperSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Hdf5FileObjsOperSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Hdf5FileObjsOperSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): Hdf5FileObjsOperSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Hdf5FileObjsOperSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Hdf5FileObjsOperSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Hdf5FileObjsOperSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Hdf5FileObjsOperSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Hdf5FileObjsOperSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Hdf5FileObjsOperSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Hdf5FileObjsOperSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Hdf5FileObjsOperSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Hdf5FileObjsOperSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Hdf5FileObjsOperSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Hdf5FileObjsOperSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Hdf5FileObjsOperSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Hdf5FileObjsOperSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): Hdf5FileObjsOperSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Hdf5FileObjsOperSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): Hdf5FileObjsOperSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Hdf5FileObjsOperSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Hdf5FileObjsOperSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Hdf5FileObjsOperSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Hdf5FileObjsOperSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Hdf5FileObjsOperSpec;

  mergeJson(json: any | null): Hdf5FileObjsOperSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Hdf5FileObjsOperSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Hdf5FileObjsOperSpec;
   ...
   */
  singletonArray(): C3.Array<Hdf5FileObjsOperSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Hdf5FileObjsOperSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Hdf5FileObjsOperSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Hdf5FileObjsOperSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Hdf5FileObjsOperSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Hdf5FileObjsOperSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Hdf5FileObjsOperSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Hdf5FileObjsOperSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Hdf5FileObjsOperSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Hdf5FileObjsOperSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Hdf5FileObjsOperSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Hdf5FileObjsOperSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Hdf5FileObjsOperSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Hdf5FileObjsOperSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Hdf5FileObjsOperSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Hdf5FileObjsOperSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): Hdf5FileObjsOperSpec;
   ...
   */
  static cachedEmptyInst(): Hdf5FileObjsOperSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Hdf5FileObjsOperSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Hdf5FileObjsOperSpec;

  /**
   * @return new instance of this spec with `retrySpec` set
   */
  withRetry(maxRetries?: number | null, initialSleepMillis?: number | null, exponent?: number | null): Hdf5FileObjsOperSpec | null;

  /**
   * @return instance of this spec with `retrySpec`'s `maxTotalMillis` set
   */
  static timeoutSeconds(secs: number | null): Hdf5FileObjsOperSpec;

  /**
   * @return FileObjsOperSpec with #serType set to provided value.
   */
  static fromType(serType: Type | null): Hdf5FileObjsOperSpec;
   ...
   */
  static toDecrypt(): Hdf5FileObjsOperSpec | null;
}
