// TypeScript definitions for the C3 type SearchStoreConfig

/**
 * Configuration for SearchStore
 *
 * @remarks this represents a value passed to a method that expects an instance of SearchStoreConfig
 */
declare interface ISearchStoreConfig {
  ...
  /**
   * True if the SearchStore is configured, otherwise false
   */
  enabled?: boolean;
}
 ...
 * Configuration for SearchStore
 *
 * @remarks this represents a made instance of SearchStoreConfig
 */
declare class SearchStoreConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): SearchStoreConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): SearchStoreConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): SearchStoreConfig;

  /**
   * True if the SearchStore is configured, otherwise false
   */
  readonly enabled?: boolean;
  withEnabled(enabled: boolean): SearchStoreConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SearchStoreConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SearchStoreConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SearchStoreConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SearchStoreConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): SearchStoreConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SearchStoreConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SearchStoreConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SearchStoreConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SearchStoreConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SearchStoreConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SearchStoreConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SearchStoreConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SearchStoreConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SearchStoreConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SearchStoreConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SearchStoreConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SearchStoreConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SearchStoreConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SearchStoreConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SearchStoreConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SearchStoreConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SearchStoreConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SearchStoreConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SearchStoreConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SearchStoreConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SearchStoreConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): SearchStoreConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SearchStoreConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): SearchStoreConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SearchStoreConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SearchStoreConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SearchStoreConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SearchStoreConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SearchStoreConfig;

  mergeJson(json: any | null): SearchStoreConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SearchStoreConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SearchStoreConfig;
   ...
   */
  singletonArray(): C3.Array<SearchStoreConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SearchStoreConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SearchStoreConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SearchStoreConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SearchStoreConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SearchStoreConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SearchStoreConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SearchStoreConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SearchStoreConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SearchStoreConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SearchStoreConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SearchStoreConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SearchStoreConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SearchStoreConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SearchStoreConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SearchStoreConfig;
   ...
   */
  static cachedEmptyInst(): SearchStoreConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SearchStoreConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SearchStoreConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<SearchStoreConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<SearchStoreConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<SearchStoreConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): SearchStoreConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): SearchStoreConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): SearchStoreConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): SearchStoreConfig | null;
   ...
   */
  static produce(key: string): SearchStoreConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, SearchStoreConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, SearchStoreConfig | null>;
   ...
   */
  static forConfigKey(configKey: string | null): SearchStoreConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<SearchStoreConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: SearchStoreConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: SearchStoreConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): SearchStoreConfig | null;
