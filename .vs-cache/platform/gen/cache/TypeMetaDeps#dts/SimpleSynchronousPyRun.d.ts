// TypeScript definitions for the C3 type SimpleSynchronousPyRun

/**
 * A specific run for a workflow.  It holds all status information about the run.
 *
 * @remarks this represents a value passed to a method that expects an instance of SimpleSynchronousPyRun
 */
declare interface ISimpleSynchronousPyRun {

  /**
   * Id of the action that executes {@link startWorkflow}
   */
  ...
  /**
   * Execution Representation associated with this run.
   */
  er?: ISynchronousPyExecutionRepresentation | null;

  /**
   * The spec that workflow was started with
   */
  spec?: IWorkflowExecutionSpec | null;

  /**
   * Holds the execution outputs (sink vertices) from the synchronous execution
   */
  outputs: C3.Map<string | null, any> | {[key: string | null]: any};

  /**
   * Returned by {@link #executionMetadataByAction}.
   */
  execMetadata?: C3.Map<string | null, Log.Entry.Action | null> | {[key: string | null]: ILog.Entry.Action | null};
   ...
   * The {@link Workflow#finallyVertex} execution starts before {@link SimpleSynchronousPyRun} transitions into completed, failed, or canceled state.
   * The output of the {@link Workflow#finallyVertex} could be retrieved using {@link SimpleSynchronousPyRun#executionResults} keyed
   * by `finallyVertexOutput`.
   */
  finallyVertexWorkflowRun?: ISimpleSynchronousPyRun | null;
}

/**
 * A specific run for a workflow.  It holds all status information about the run.
 *
 * @remarks this represents a made instance of SimpleSynchronousPyRun
 */
declare class SimpleSynchronousPyRun extends Obj {

  /**
   * Id of the action that executes {@link startWorkflow}
   */
  readonly startingActionId?: string | null;
  withStartingActionId(startingActionId: string | null): SimpleSynchronousPyRun;
   ...
   */
  readonly id: string;
  withId(id: string): SimpleSynchronousPyRun;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): SimpleSynchronousPyRun;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): SimpleSynchronousPyRun;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): SimpleSynchronousPyRun;
  ...
  withVersion(version: number | null): SimpleSynchronousPyRun;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): SimpleSynchronousPyRun;

  /**
   * Execution Representation associated with this run.
   */
  readonly er?: SynchronousPyExecutionRepresentation | null;
  withEr(er: ISynchronousPyExecutionRepresentation | null): SimpleSynchronousPyRun;

  /**
   * The spec that workflow was started with
   */
  readonly spec?: WorkflowExecutionSpec | null;
  withSpec(spec: IWorkflowExecutionSpec | null): SimpleSynchronousPyRun;

  /**
   * Holds the execution outputs (sink vertices) from the synchronous execution
   */
  readonly outputs: C3.Map<string | null, any>;
  withOutputs(outputs: C3.Map<string | null, any> | {[key: string | null]: any}): SimpleSynchronousPyRun;

  /**
   * Returned by {@link #executionMetadataByAction}.
   */
  readonly execMetadata?: C3.Map<string | null, Log.Entry.Action | null>;
  withExecMetadata(execMetadata: C3.Map<string | null, Log.Entry.Action | null> | {[key: string | null]: ILog.Entry.Action | null}): SimpleSynchronousPyRun;
   ...
   * by `finallyVertexOutput`.
   */
  readonly finallyVertexWorkflowRun?: SimpleSynchronousPyRun | null;
  withFinallyVertexWorkflowRun(finallyVertexWorkflowRun: ISimpleSynchronousPyRun | null): SimpleSynchronousPyRun;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SimpleSynchronousPyRun | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SimpleSynchronousPyRun | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SimpleSynchronousPyRun | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SimpleSynchronousPyRun | null;
   ...
   */
  replaceType(old: Type, new_: Type): SimpleSynchronousPyRun;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SimpleSynchronousPyRun;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SimpleSynchronousPyRun;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SimpleSynchronousPyRun | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SimpleSynchronousPyRun | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SimpleSynchronousPyRun;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SimpleSynchronousPyRun;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SimpleSynchronousPyRun;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SimpleSynchronousPyRun;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SimpleSynchronousPyRun;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SimpleSynchronousPyRun;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SimpleSynchronousPyRun;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SimpleSynchronousPyRun;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SimpleSynchronousPyRun;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SimpleSynchronousPyRun;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SimpleSynchronousPyRun;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SimpleSynchronousPyRun;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SimpleSynchronousPyRun;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SimpleSynchronousPyRun;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SimpleSynchronousPyRun;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SimpleSynchronousPyRun;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SimpleSynchronousPyRun;
   ...
   * @see #removeField
   */
  unsetField(field: string): SimpleSynchronousPyRun;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SimpleSynchronousPyRun;
   ...
   * @see #unsetField
   */
  removeField(field: string): SimpleSynchronousPyRun;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SimpleSynchronousPyRun;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SimpleSynchronousPyRun;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SimpleSynchronousPyRun;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SimpleSynchronousPyRun;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SimpleSynchronousPyRun;

  mergeJson(json: any | null): SimpleSynchronousPyRun;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SimpleSynchronousPyRun;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SimpleSynchronousPyRun;
   ...
   */
  singletonArray(): C3.Array<SimpleSynchronousPyRun | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SimpleSynchronousPyRun | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SimpleSynchronousPyRun | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SimpleSynchronousPyRun | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SimpleSynchronousPyRun | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SimpleSynchronousPyRun | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SimpleSynchronousPyRun | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SimpleSynchronousPyRun | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SimpleSynchronousPyRun | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SimpleSynchronousPyRun;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SimpleSynchronousPyRun;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SimpleSynchronousPyRun;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SimpleSynchronousPyRun;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SimpleSynchronousPyRun;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SimpleSynchronousPyRun;
   ...
   * @see #fromString
   */
  static make(s: string | null): SimpleSynchronousPyRun | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SimpleSynchronousPyRun;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SimpleSynchronousPyRun;
   ...
   */
  static cachedEmptyInst(): SimpleSynchronousPyRun;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SimpleSynchronousPyRun>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SimpleSynchronousPyRun;
  ...
  /**
   * @return overall status of the execution.
   */
  status(): Workflow.Status | null;

  /**
   * @return map of <k, v> -> <result name, result>.
   */
  executionResults(): C3.Map<string | null, any>;

  /**
   * Waits for this {@link WorkflowExecutorRun} to be completed. If the run is already completed, this method will return immediately.
   ...
   * @return the status for this {@link WorkflowExecutorRun} after completion
   */
  waitForCompletion(timeoutMinutes?: number | null, displayStatus?: boolean, spec?: WaitSpec | null): Workflow.Status;

  /**
   * Create a visualization plotting start and end timestamps for all vertices in {@link #executionMetadataByAction}.
   *
   * @return the native plot object.
   */
  plotExecutionTimestamps(): any;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<SimpleSynchronousPyRun | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SimpleSynchronousPyRun | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<SimpleSynchronousPyRun | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<SimpleSynchronousPyRun | null> | null>;
   ...
   */
  get(include?: string | null): SimpleSynchronousPyRun | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): SimpleSynchronousPyRun | null;
   ...
   */
  getMissing(spec: GetMissingSpec): SimpleSynchronousPyRun;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): SimpleSynchronousPyRun | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): SimpleSynchronousPyRun;
   ...
   * @see #toString
   */
  static fromString(s: string | null): SimpleSynchronousPyRun | null;
   ...
   */
  create(spec?: UpsertSpec | null): SimpleSynchronousPyRun | null;
   ...
   */
  static createBatch(objs: C3.Array<SimpleSynchronousPyRun | null> | null, spec?: UpsertSpec | null): ObjList<SimpleSynchronousPyRun | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<SimpleSynchronousPyRun | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<SimpleSynchronousPyRun | null> | null;
   ...
   */
  update(srcObj?: SimpleSynchronousPyRun | null, spec?: UpsertSpec | null): SimpleSynchronousPyRun | null;
   ...
   */
  upsert(srcObj?: SimpleSynchronousPyRun | null, spec?: UpsertSpec | null): SimpleSynchronousPyRun | null;
   ...
   */
  merge(spec?: MergeSpec | null): SimpleSynchronousPyRun | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): SimpleSynchronousPyRun | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): SimpleSynchronousPyRun | null;
   ...
   */
  static updateBatch(objs: C3.Array<SimpleSynchronousPyRun | null> | null, srcObjs?: C3.Array<SimpleSynchronousPyRun | null>, spec?: UpsertSpec | null): ObjList<SimpleSynchronousPyRun | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<SimpleSynchronousPyRun | null>>, spec?: UpsertSpec | null): ObjList<SimpleSynchronousPyRun | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<SimpleSynchronousPyRun | null> | null, srcObjs?: C3.Array<SimpleSynchronousPyRun | null>, spec?: UpsertSpec | null): ObjList<SimpleSynchronousPyRun | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<SimpleSynchronousPyRun | null>>, spec?: UpsertSpec | null): ObjList<SimpleSynchronousPyRun | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<SimpleSynchronousPyRun | null> | null, spec?: TouchSpec | null): ObjList<SimpleSynchronousPyRun | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SimpleSynchronousPyRun | null> | null, spec?: MergeSpec | null): ObjList<SimpleSynchronousPyRun | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SimpleSynchronousPyRun | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<SimpleSynchronousPyRun | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<SimpleSynchronousPyRun | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<SimpleSynchronousPyRun | null> | null;
   ...
   */
  static mergeAll(mergeObj: SimpleSynchronousPyRun | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: SimpleSynchronousPyRun | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<SimpleSynchronousPyRun | null> | null, spec?: UpsertSpec | null): ObjList<SimpleSynchronousPyRun | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<SimpleSynchronousPyRun | null> | null, spec?: UpsertSpec | null): ObjList<SimpleSynchronousPyRun | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): SimpleSynchronousPyRun | null;
   ...
   */
  static beforeCreate(objs: C3.Array<SimpleSynchronousPyRun | null> | null): ObjList<SimpleSynchronousPyRun | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<SimpleSynchronousPyRun | null> | null): ObjList<SimpleSynchronousPyRun | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<SimpleSynchronousPyRun | null> | null): ObjList<SimpleSynchronousPyRun | null>;
   ...
   */
  static afterCreate(objs: C3.Array<SimpleSynchronousPyRun | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<SimpleSynchronousPyRun | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<SimpleSynchronousPyRun | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<SimpleSynchronousPyRun | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<SimpleSynchronousPyRun | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): SimpleSynchronousPyRun | null;
   ...
   */
  withoutIdentity(): SimpleSynchronousPyRun | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<SimpleSynchronousPyRun | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: SimpleSynchronousPyRun | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<SimpleSynchronousPyRun | null> | null, callback?: λFunction<SimpleSynchronousPyRun | null, SimpleSynchronousPyRun | null> | null): ObjList<SimpleSynchronousPyRun | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<SimpleSynchronousPyRun | null> | null, callback?: λFunction<SimpleSynchronousPyRun | null, SimpleSynchronousPyRun | null> | null): C3.Array<ObjError | null>;
   ...
   *
   * @return map of <k, v> -> <step name, step status>.
   */
  describe(): C3.Map<string | null, JobStatus | null>;

  /**
   * @return link (or copy) to the representation that this run executed.
   */
  executionRepr(): WorkflowExecutionRepresentation;

  /**
   * Aggregate execution profiling results by action.
   *
   * @return a map where the key is the action id of the executed action (or a unique random ID if the action id is not
   *         available) and the value holds the results accumulates by action profiling.
   */
  executionMetadataByAction(): C3.Map<string | null, Log.Entry.Action | null>;
   ...
   *         by action profiling.
   */
  executionMetadataByParentVertex(): C3.Map<string | null, Log.Entry.Action | null>;
}
