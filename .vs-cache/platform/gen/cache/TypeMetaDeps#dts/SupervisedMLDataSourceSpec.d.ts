// TypeScript definitions for the C3 type SupervisedMLDataSourceSpec

/**
 * The base type for all data source specs for supervised training of MLPipelines and MLPipelineTrainingJobs.
 * The parametric bindings `DI` and `DO` refer to the pipeline training input and target types respectively (see
 * {@link MLPipe}.
 *
 * @remarks this represents a value passed to a method that expects an instance of SupervisedMLDataSourceSpec
 */
declare interface ISupervisedMLDataSourceSpec<DI, DO> {
 ...
 * {@link MLPipe}.
 *
 * @remarks this represents a made instance of SupervisedMLDataSourceSpec
 */
declare class SupervisedMLDataSourceSpec<DI, DO> extends Obj {
  ...
  withTypeIdent(typeIdent: string | null): SupervisedMLDataSourceSpec;
   ...
   */
  readonly id: string;
  withId(id: string): SupervisedMLDataSourceSpec;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): SupervisedMLDataSourceSpec;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): SupervisedMLDataSourceSpec;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): SupervisedMLDataSourceSpec;
  ...
  withVersion(version: number | null): SupervisedMLDataSourceSpec;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): SupervisedMLDataSourceSpec;

  /**
   * The source type for this spec (e.g. the type on which `evalMetrics` will be called).
   */
  readonly srcType: Type;
  withSrcType(srcType: IType): SupervisedMLDataSourceSpec;
  ...
  withDataTimestamp(dataTimestamp: DateTime | Date | string | null): SupervisedMLDataSourceSpec;

  /**
   * Identifier for the target to learn
   */
  readonly target?: string | null;
  withTarget(target: string | null): SupervisedMLDataSourceSpec;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SupervisedMLDataSourceSpec<DI, DO> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SupervisedMLDataSourceSpec<DI, DO> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SupervisedMLDataSourceSpec<DI, DO> | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SupervisedMLDataSourceSpec<DI, DO> | null;
   ...
   */
  replaceType(old: Type, new_: Type): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SupervisedMLDataSourceSpec<DI, DO> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SupervisedMLDataSourceSpec<DI, DO> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SupervisedMLDataSourceSpec<DI, DO>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SupervisedMLDataSourceSpec<DI, DO>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   * @see #removeField
   */
  unsetField(field: string): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   * @see #unsetField
   */
  removeField(field: string): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SupervisedMLDataSourceSpec<DI, DO>;

  mergeJson(json: any | null): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   */
  singletonArray(): C3.Array<SupervisedMLDataSourceSpec<DI, DO> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SupervisedMLDataSourceSpec<DI, DO> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SupervisedMLDataSourceSpec<DI, DO> | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SupervisedMLDataSourceSpec<DI, DO> | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SupervisedMLDataSourceSpec<DI, DO> | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SupervisedMLDataSourceSpec<DI, DO> | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SupervisedMLDataSourceSpec<DI, DO> | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SupervisedMLDataSourceSpec<DI, DO> | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SupervisedMLDataSourceSpec<DI, DO> | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SupervisedMLDataSourceSpec<DI, DO>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   * @see #fromString
   */
  static make(s: string | null): SupervisedMLDataSourceSpec<DI, DO> | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   */
  static cachedEmptyInst(): SupervisedMLDataSourceSpec<DI, DO>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SupervisedMLDataSourceSpec<DI, DO>>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<SupervisedMLDataSourceSpec<DI, DO> | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SupervisedMLDataSourceSpec<DI, DO> | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<SupervisedMLDataSourceSpec<DI, DO> | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<SupervisedMLDataSourceSpec<DI, DO> | null> | null>;
   ...
   */
  get(include?: string | null): SupervisedMLDataSourceSpec<DI, DO> | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): SupervisedMLDataSourceSpec<DI, DO> | null;
   ...
   */
  getMissing(spec: GetMissingSpec): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): SupervisedMLDataSourceSpec<DI, DO> | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): SupervisedMLDataSourceSpec<DI, DO>;
   ...
   * @see #toString
   */
  static fromString(s: string | null): SupervisedMLDataSourceSpec<DI, DO> | null;
   ...
   */
  create(spec?: UpsertSpec | null): SupervisedMLDataSourceSpec<DI, DO> | null;
   ...
   */
  static createBatch(objs: C3.Array<SupervisedMLDataSourceSpec<DI, DO> | null> | null, spec?: UpsertSpec | null): ObjList<SupervisedMLDataSourceSpec<DI, DO> | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<SupervisedMLDataSourceSpec<DI, DO> | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<SupervisedMLDataSourceSpec<DI, DO> | null> | null;
   ...
   */
  update(srcObj?: SupervisedMLDataSourceSpec<DI, DO> | null, spec?: UpsertSpec | null): SupervisedMLDataSourceSpec<DI, DO> | null;
   ...
   */
  upsert(srcObj?: SupervisedMLDataSourceSpec<DI, DO> | null, spec?: UpsertSpec | null): SupervisedMLDataSourceSpec<DI, DO> | null;
   ...
   */
  merge(spec?: MergeSpec | null): SupervisedMLDataSourceSpec<DI, DO> | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): SupervisedMLDataSourceSpec<DI, DO> | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): SupervisedMLDataSourceSpec<DI, DO> | null;
   ...
   */
  static updateBatch(objs: C3.Array<SupervisedMLDataSourceSpec<DI, DO> | null> | null, srcObjs?: C3.Array<SupervisedMLDataSourceSpec<DI, DO> | null>, spec?: UpsertSpec | null): ObjList<SupervisedMLDataSourceSpec<DI, DO> | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<SupervisedMLDataSourceSpec<DI, DO> | null>>, spec?: UpsertSpec | null): ObjList<SupervisedMLDataSourceSpec<DI, DO> | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<SupervisedMLDataSourceSpec<DI, DO> | null> | null, srcObjs?: C3.Array<SupervisedMLDataSourceSpec<DI, DO> | null>, spec?: UpsertSpec | null): ObjList<SupervisedMLDataSourceSpec<DI, DO> | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<SupervisedMLDataSourceSpec<DI, DO> | null>>, spec?: UpsertSpec | null): ObjList<SupervisedMLDataSourceSpec<DI, DO> | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<SupervisedMLDataSourceSpec<DI, DO> | null> | null, spec?: TouchSpec | null): ObjList<SupervisedMLDataSourceSpec<DI, DO> | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SupervisedMLDataSourceSpec<DI, DO> | null> | null, spec?: MergeSpec | null): ObjList<SupervisedMLDataSourceSpec<DI, DO> | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SupervisedMLDataSourceSpec<DI, DO> | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<SupervisedMLDataSourceSpec<DI, DO> | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<SupervisedMLDataSourceSpec<DI, DO> | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<SupervisedMLDataSourceSpec<DI, DO> | null> | null;
   ...
   */
  static mergeAll(mergeObj: SupervisedMLDataSourceSpec<DI, DO> | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: SupervisedMLDataSourceSpec<DI, DO> | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<SupervisedMLDataSourceSpec<DI, DO> | null> | null, spec?: UpsertSpec | null): ObjList<SupervisedMLDataSourceSpec<DI, DO> | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<SupervisedMLDataSourceSpec<DI, DO> | null> | null, spec?: UpsertSpec | null): ObjList<SupervisedMLDataSourceSpec<DI, DO> | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): SupervisedMLDataSourceSpec<DI, DO> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<SupervisedMLDataSourceSpec<DI, DO> | null> | null): ObjList<SupervisedMLDataSourceSpec<DI, DO> | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<SupervisedMLDataSourceSpec<DI, DO> | null> | null): ObjList<SupervisedMLDataSourceSpec<DI, DO> | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<SupervisedMLDataSourceSpec<DI, DO> | null> | null): ObjList<SupervisedMLDataSourceSpec<DI, DO> | null>;
   ...
   */
  static afterCreate(objs: C3.Array<SupervisedMLDataSourceSpec<DI, DO> | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<SupervisedMLDataSourceSpec<DI, DO> | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<SupervisedMLDataSourceSpec<DI, DO> | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<SupervisedMLDataSourceSpec<DI, DO> | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<SupervisedMLDataSourceSpec<DI, DO> | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): SupervisedMLDataSourceSpec<DI, DO> | null;
   ...
   */
  withoutIdentity(): SupervisedMLDataSourceSpec<DI, DO> | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<SupervisedMLDataSourceSpec<DI, DO> | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: SupervisedMLDataSourceSpec<DI, DO> | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<SupervisedMLDataSourceSpec<DI, DO> | null> | null, callback?: λFunction<SupervisedMLDataSourceSpec<DI, DO> | null, SupervisedMLDataSourceSpec<DI, DO> | null> | null): ObjList<SupervisedMLDataSourceSpec<DI, DO> | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<SupervisedMLDataSourceSpec<DI, DO> | null> | null, callback?: λFunction<SupervisedMLDataSourceSpec<DI, DO> | null, SupervisedMLDataSourceSpec<DI, DO> | null> | null): C3.Array<ObjError | null>;
