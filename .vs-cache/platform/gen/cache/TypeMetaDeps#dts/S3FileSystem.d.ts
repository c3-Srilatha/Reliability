// TypeScript definitions for the C3 type S3FileSystem
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of S3FileSystem
 */
declare interface IS3FileSystem {
}
 ...
 */
declare class S3FileSystem extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): S3FileSystem | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): S3FileSystem | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): S3FileSystem | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): S3FileSystem | null;
   ...
   */
  replaceType(old: Type, new_: Type): S3FileSystem;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): S3FileSystem;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): S3FileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): S3FileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): S3FileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): S3FileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<S3FileSystem | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<S3FileSystem | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<S3FileSystem | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<S3FileSystem | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): S3FileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): S3FileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): S3FileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): S3FileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): S3FileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): S3FileSystem;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): S3FileSystem;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): S3FileSystem;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): S3FileSystem;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): S3FileSystem;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): S3FileSystem;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): S3FileSystem;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): S3FileSystem;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): S3FileSystem;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): S3FileSystem;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): S3FileSystem;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): S3FileSystem;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): S3FileSystem;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): S3FileSystem;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): S3FileSystem;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): S3FileSystem;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): S3FileSystem;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): S3FileSystem;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): S3FileSystem;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): S3FileSystem;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): S3FileSystem;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): S3FileSystem;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): S3FileSystem;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): S3FileSystem;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): S3FileSystem;
   ...
   * @see #unsetField
   */
  defaultField(field: string): S3FileSystem;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): S3FileSystem;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): S3FileSystem;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): S3FileSystem;
   ...
   * @see #removeField
   */
  unsetField(field: string): S3FileSystem;
   ...
   * @see #removeField
   */
  static unsetField(field: string): S3FileSystem;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): S3FileSystem;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): S3FileSystem;
   ...
   * @see #unsetField
   */
  removeField(field: string): S3FileSystem;
   ...
   * @see #unsetField
   */
  static removeField(field: string): S3FileSystem;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): S3FileSystem;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): S3FileSystem;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): S3FileSystem;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): S3FileSystem;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): S3FileSystem;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): S3FileSystem;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): S3FileSystem;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): S3FileSystem;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): S3FileSystem;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): S3FileSystem;

  mergeJson(json: any | null): S3FileSystem;

  static mergeJson(json: any | null): S3FileSystem;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): S3FileSystem;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): S3FileSystem;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): S3FileSystem;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): S3FileSystem;
   ...
   */
  singletonArray(): C3.Array<S3FileSystem | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<S3FileSystem | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<S3FileSystem | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<S3FileSystem | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<S3FileSystem | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<S3FileSystem | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<S3FileSystem | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, S3FileSystem | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, S3FileSystem | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<S3FileSystem | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<S3FileSystem | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<S3FileSystem | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): S3FileSystem;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): S3FileSystem;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): S3FileSystem;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): S3FileSystem;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): S3FileSystem;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): S3FileSystem;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): S3FileSystem;
   ...
   */
  static cachedEmptyInst(): S3FileSystem;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<S3FileSystem>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): S3FileSystem;
   ...
   */
  makeFile(urlOrEncodedPath: string | null, contentType?: string | null, contentEncoding?: string | null): BlobFile<BlobFileSystem | null>;

  /**
   * @return blob file system specific instance of File.
   */
  static makeFile(urlOrEncodedPath: string | null, contentType?: string | null, contentEncoding?: string | null): BlobFile<BlobFileSystem | null>;
   ...
   */
  containerName(mount?: string | null): string;

  /**
   * Returns just blob container name for a given FileSystem Mount; Note that mount may also contain a path; So it's
   * best to use FileSystem APIs.
   */
  static containerName(mount?: string | null): string;

  /**
   * Returns all blob container  names that this pod and current tenant can access.
   */
  containerNames(): C3.Array<string | null>;

  /**
   * Returns all blob container  names that this pod and current tenant can access.
   */
  static containerNames(): C3.Array<string | null>;
   ...
   */
  upsertContainer(containerName?: string | null, spec?: FileOperationSpec | null): boolean;
   ...
   * @return true if container didn't exist and was just created
   */
  static upsertContainer(containerName?: string | null, spec?: FileOperationSpec | null): boolean;
   ...
   */
  upsertAllContainers(spec?: FileOperationSpec | null): number;
   ...
   * @return count of newly created containers
   */
  static upsertAllContainers(spec?: FileOperationSpec | null): number;
   ...
   */
  containerExists(containerName?: string | null, spec?: FileOperationSpec | null): boolean;
   ...
   * @return true if container exists.
   */
  static containerExists(containerName?: string | null, spec?: FileOperationSpec | null): boolean;
   ...
   * @return number files deleted
   */
  truncateContainer(containerName?: string | null, confirm?: boolean, spec?: FileOperationSpec | null): number;
   ...
   * @return number files deleted
   */
  static truncateContainer(containerName?: string | null, confirm?: boolean, spec?: FileOperationSpec | null): number;

  /**
   * Returns all existing and visible to this pod blob container names.
   */
  listContainers(spec?: ListFilesOperationSpec | null): C3.Array<string | null>;

  /**
   * Returns all existing and visible to this pod blob container names.
   */
  static listContainers(spec?: ListFilesOperationSpec | null): C3.Array<string | null>;

  doCreateContainer(containerName: string, spec?: FileOperationSpec | null): boolean;

  static doCreateContainer(containerName: string, spec?: FileOperationSpec | null): boolean;

  doContainerExists(containerName: string, spec?: FileOperationSpec | null): boolean;

  static doContainerExists(containerName: string, spec?: FileOperationSpec | null): boolean;

  doTruncateContainer(containerName: string, spec?: FileOperationSpec | null): number;

  static doTruncateContainer(containerName: string, spec?: FileOperationSpec | null): number;

  doReadBlobMeta(containerName: string, blobKey: string, spec?: FileOperationSpec | null): S3File | null;

  static doReadBlobMeta(containerName: string, blobKey: string, spec?: FileOperationSpec | null): S3File | null;

  doBlobEncodedStream(containerName: string, blobKey: string, spec?: FileOperationSpec | null): Pair<S3File | null, ByteStream | null> | null;

  static doBlobEncodedStream(containerName: string, blobKey: string, spec?: FileOperationSpec | null): Pair<S3File | null, ByteStream | null> | null;

  doBlobEncodedPushStream(containerName: string, blobKey: string, file?: File | null, spec?: FileOperationSpec | null): BytePushStream | null;

  static doBlobEncodedPushStream(containerName: string, blobKey: string, file?: File | null, spec?: FileOperationSpec | null): BytePushStream | null;

  listBlobsDefaultLimit(): number;

  static listBlobsDefaultLimit(): number;

  listBlobsPerQueryLimit(): number;

  static listBlobsPerQueryLimit(): number;

  doListBlobs(containerName: string, blobKeyPrefix?: string | null, isDirectory?: boolean, limit?: number | null, marker?: string | null, readMetadata?: boolean, spec?: ListFilesOperationSpec | null): ListFilesResult;

  static doListBlobs(containerName: string, blobKeyPrefix?: string | null, isDirectory?: boolean, limit?: number | null, marker?: string | null, readMetadata?: boolean, spec?: ListFilesOperationSpec | null): ListFilesResult;

  doListDirectChildrenBlob(containerName: string, blobKeyPrefix?: string | null, isDirectory?: boolean, limit?: number | null, marker?: string | null, readMetadata?: boolean, spec?: ListFilesOperationSpec | null): ListFilesAndDirsResult;

  static doListDirectChildrenBlob(containerName: string, blobKeyPrefix?: string | null, isDirectory?: boolean, limit?: number | null, marker?: string | null, readMetadata?: boolean, spec?: ListFilesOperationSpec | null): ListFilesAndDirsResult;

  maxDeleteBlobsCount(): number;

  static maxDeleteBlobsCount(): number;

  doDeleteBlobs(containerName: string, blobKeys: C3.Array<string | null>, spec?: FileOperationSpec | null): void;

  static doDeleteBlobs(containerName: string, blobKeys: C3.Array<string | null>, spec?: FileOperationSpec | null): void;

  doCopyBlob(srcContainerName: string, srcBlobKey: string, destContainerName: string, destBlobKey: string, spec?: FileOperationSpec | null): S3File | null;

  static doCopyBlob(srcContainerName: string, srcBlobKey: string, destContainerName: string, destBlobKey: string, spec?: FileOperationSpec | null): S3File | null;
   ...
   */
  doCopyBlobs(srcContainerNames: C3.Array<string | null>, srcBlobKeys: C3.Array<string | null>, destContainerNames: C3.Array<string | null>, destBlobKeys: C3.Array<string | null>, spec?: FileOperationSpec | null): C3.Array<S3File | null>;

  /**
   * Copies blob files using cloud provider APIs. When the source scheme and destination schemes are the same,
   * files are copied by using batch APIs. Otherwise, each file is copied individually.
   */
  static doCopyBlobs(srcContainerNames: C3.Array<string | null>, srcBlobKeys: C3.Array<string | null>, destContainerNames: C3.Array<string | null>, destBlobKeys: C3.Array<string | null>, spec?: FileOperationSpec | null): C3.Array<S3File | null>;

  doReplaceBlobContentTypeAndEncoding(containerName: string, srcBlobKey: string, contentType?: string | null, contentEncoding: string, spec?: FileOperationSpec | null): S3File | null;

  static doReplaceBlobContentTypeAndEncoding(containerName: string, srcBlobKey: string, contentType?: string | null, contentEncoding: string, spec?: FileOperationSpec | null): S3File | null;

  cloudClient(containerName: string): any;

  static cloudClient(containerName: string): any;
   ...
   */
  static upsertBucket(bucketName?: string | null, spec?: FileOperationSpec | null): boolean;
   ...
   */
  static upsertAllBuckets(spec?: FileOperationSpec | null): number;
   ...
   * @return number files deleted
   */
  static truncateBucket(bucketName?: string | null, confirm?: boolean, spec?: FileOperationSpec | null): number;

  /**
   * Returns all existing and visible to this pod S3 bucket names.
   */
  static listBuckets(spec?: ListFilesOperationSpec | null): C3.Array<string | null>;

  /**
   * Converts S3 region name to a shorthand notation used by C3 S3 file-system
   */
  static abbreviateAwsRegion(region: string): string;
}
