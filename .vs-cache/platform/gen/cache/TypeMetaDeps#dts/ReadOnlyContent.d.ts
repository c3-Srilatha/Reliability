// TypeScript definitions for the C3 type ReadOnlyContent

/**
 * Abstract read only content with header.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReadOnlyContent
 */
declare interface IReadOnlyContent {
 ...
 * Abstract read only content with header.
 *
 * @remarks this represents a made instance of ReadOnlyContent
 */
declare class ReadOnlyContent extends Obj {
  ...
  withContentEncoding(contentEncoding: string | null): ReadOnlyContent;
  ...
  withContentLanguage(contentLanguage: string | null): ReadOnlyContent;
  ...
  withContentLength(contentLength: number | null): ReadOnlyContent;
  ...
  withContentLocation(contentLocation: string | null): ReadOnlyContent;
  ...
  withContentType(contentType: string | null): ReadOnlyContent;
  ...
  withContentDisposition(contentDisposition: string | null): ReadOnlyContent;
  ...
  withETag(eTag: string | null): ReadOnlyContent;
  ...
  withLastModified(lastModified: DateTime | Date | string | null): ReadOnlyContent;

  /**
   * Id of user / identity who last last modified this content.
   */
  readonly lastModifiedBy?: string | null;
  withLastModifiedBy(lastModifiedBy: string | null): ReadOnlyContent;
  ...
  withContentMD5(contentMD5: string | null): ReadOnlyContent;
  ...
  withContentSHA1(contentSHA1: string | null): ReadOnlyContent;

  /**
   * Field to maintain state whether content metadata was read or not.
   */
  readonly hasMetadata?: boolean;
  withHasMetadata(hasMetadata: boolean): ReadOnlyContent;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ReadOnlyContent | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ReadOnlyContent | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ReadOnlyContent | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ReadOnlyContent | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReadOnlyContent;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ReadOnlyContent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ReadOnlyContent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ReadOnlyContent | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ReadOnlyContent | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ReadOnlyContent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReadOnlyContent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReadOnlyContent;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReadOnlyContent;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReadOnlyContent;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReadOnlyContent;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ReadOnlyContent;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReadOnlyContent;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReadOnlyContent;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ReadOnlyContent;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ReadOnlyContent;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ReadOnlyContent;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ReadOnlyContent;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReadOnlyContent;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ReadOnlyContent;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReadOnlyContent;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReadOnlyContent;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReadOnlyContent;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReadOnlyContent;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReadOnlyContent;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReadOnlyContent;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ReadOnlyContent;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ReadOnlyContent;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ReadOnlyContent;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ReadOnlyContent;

  mergeJson(json: any | null): ReadOnlyContent;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ReadOnlyContent;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ReadOnlyContent;
   ...
   */
  singletonArray(): C3.Array<ReadOnlyContent | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ReadOnlyContent | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReadOnlyContent | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ReadOnlyContent | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReadOnlyContent | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ReadOnlyContent | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReadOnlyContent | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReadOnlyContent | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReadOnlyContent | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ReadOnlyContent;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ReadOnlyContent;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ReadOnlyContent;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReadOnlyContent;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ReadOnlyContent;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReadOnlyContent;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ReadOnlyContent;
   ...
   */
  static cachedEmptyInst(): ReadOnlyContent;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ReadOnlyContent>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ReadOnlyContent;
   ...
   */
  withFileName(fileName: string | null): ReadOnlyContent;

  /**
   * Changes file extension in this instance.
   */
  withFileExt(fileExt: string | null): ReadOnlyContent;
   ...
   */
  identify(suffix?: string | null): ReadOnlyContent;
   ...
   */
  readMetadata(spec?: FileOperationSpec | null): ReadOnlyContent;
   ...
   */
  refreshMetadata(spec?: FileOperationSpec | null): ReadOnlyContent;
   ...
   * @return abstract content with metadata.
   */
  guessMetadata(spec?: FileOperationSpec | null): ReadOnlyContent;

  /**
   * Clears the content metadata; e.g. if it's known to be invalid.
   */
  clearMetadata(): ReadOnlyContent;

  /**
   * @return clone of this content with metadata from provided input.
   */
  withMetadata(meta?: ContentMeta | null): ReadOnlyContent;
   ...
   */
  encodedPushStream(spec?: FileOperationSpec | null): Pair<ReadOnlyContent | null, BytePushStream | null>;

  /**
   * @return byte push stream to be used for writing un-encoded data into this content object.
   */
  pushStream(spec?: FileOperationSpec | null): Pair<ReadOnlyContent | null, BytePushStream | null>;

  /**
   * @return character push stream to be used for writing un-encoded data into this content object.
   */
  charPushStream(spec?: FileOperationSpec | null): Pair<ReadOnlyContent | null, CharPushStream | null>;
   ...
   */
  encodedStream(spec?: FileOperationSpec | null): Pair<ReadOnlyContent | null, ByteStream | null> | null;
   ...
   */
  writeStream(content: ByteStream | null, spec?: FileOperationSpec | null): ReadOnlyContent;

  /**
   * Truncates file and replaces it's content with provided binary content.
   */
  writeInputStream(inputStream: any, spec?: FileOperationSpec | null): ReadOnlyContent;

  /**
   * Truncates file and replaces its content with provided binary content from zipInputStream
   */
  writeZipInputStream(zipInputStream: any, spec?: FileOperationSpec | null): ReadOnlyContent;
   ...
   */
  writeEncodedStream(encodedContent: ByteStream | null, spec?: FileOperationSpec | null): ReadOnlyContent;

  /**
   * Truncates file and replaces it's encoded content with provided binary content.
   */
  writeEncodedInputStream(inputStream: any, spec?: FileOperationSpec | null): ReadOnlyContent;
   ...
   *           content that needs to be written
   */
  write(content: any | null, spec?: FileOperationSpec | null): ReadOnlyContent;
   ...
   *           encoded content that needs to be written
   */
  writeEncoded(encodedContent: any | null, spec?: FileOperationSpec | null): ReadOnlyContent;
   ...
   *           content that needs to be written
   */
  writeString(content: string | null, spec?: FileOperationSpec | null): ReadOnlyContent;
   ...
   */
  writeObj(obj: Obj | null, spec?: FileObjsOperSpec | null): ReadOnlyContent;
   ...
   * @return pair of update instance of this content and number of objs written
   */
  startWriteObjs(spec?: FileObjsOperSpec | null): Pair<ReadOnlyContent | null, PushStream<Obj | null> | null>;
   ...
   */
  compress(contentEncoding?: string | null, spec?: FileCompressSpec | null): ReadOnlyContent;

  /**
   * Uncompresses content.
   */
  uncompress(spec?: FileCompressSpec | null): ReadOnlyContent;
   ...
   */
  transcode(contentType: string, contentEncoding: string, spec?: FileCompressSpec | null): ReadOnlyContent;

  /**
   * Copies content to a given target.
   */
  copyContentTo(target: ReadOnlyContent, spec?: FileOperationSpec | null): void;
   ...
   */
  concat(other: Content | null): ReadOnlyContent;

  /**
   * Creates a new Content by merging the incoming binary data with current content
   */
  concat(other: any | null): ReadOnlyContent;
