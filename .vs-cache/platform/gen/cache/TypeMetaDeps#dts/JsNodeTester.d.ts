// TypeScript definitions for the C3 type JsNodeTester

/**
 * @remarks this represents a value passed to a method that expects an instance of JsNodeTester
 */
declare interface IJsNodeTester {
...
/**
 * @remarks this represents a made instance of JsNodeTester
 */
declare class JsNodeTester extends Obj {

  testRunner: TestRunner;
  withTestRunner(testRunner: ITestRunner): JsNodeTester;
   ...
   */
  state: string;
  withState(state: string): JsNodeTester;

  /**
   * The collected test results after the test execution.
   */
  results?: C3.Array<TestSuiteResult | null>;
  withResults(results: C3.Array<TestSuiteResult | null> | Array<ITestSuiteResult | null>): JsNodeTester;

  /**
   * The action engine in which tests will execute.
   */
  engine: Action.Engine;
  withEngine(engine: IAction.Engine): JsNodeTester;

  /**
   * Construct an instance with initial state.
   */
  static make(): JsNodeTester;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): JsNodeTester;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): JsNodeTester;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): JsNodeTester;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): JsNodeTester;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): JsNodeTester | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): JsNodeTester | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): JsNodeTester | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): JsNodeTester | null;
   ...
   */
  replaceType(old: Type, new_: Type): JsNodeTester;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JsNodeTester;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JsNodeTester;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JsNodeTester | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JsNodeTester | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): JsNodeTester;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JsNodeTester;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JsNodeTester;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): JsNodeTester;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): JsNodeTester;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): JsNodeTester;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): JsNodeTester;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): JsNodeTester;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): JsNodeTester;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): JsNodeTester;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): JsNodeTester;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): JsNodeTester;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): JsNodeTester;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): JsNodeTester;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): JsNodeTester;
   ...
   * @see #unsetField
   */
  defaultField(field: string): JsNodeTester;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): JsNodeTester;
   ...
   * @see #removeField
   */
  unsetField(field: string): JsNodeTester;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): JsNodeTester;
   ...
   * @see #unsetField
   */
  removeField(field: string): JsNodeTester;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): JsNodeTester;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): JsNodeTester;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): JsNodeTester;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): JsNodeTester;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): JsNodeTester;

  mergeJson(json: any | null): JsNodeTester;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): JsNodeTester;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): JsNodeTester;
   ...
   */
  singletonArray(): C3.Array<JsNodeTester | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<JsNodeTester | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<JsNodeTester | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<JsNodeTester | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<JsNodeTester | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, JsNodeTester | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, JsNodeTester | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<JsNodeTester | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<JsNodeTester | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): JsNodeTester;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): JsNodeTester;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): JsNodeTester;
   ...
   */
  static cachedEmptyInst(): JsNodeTester;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<JsNodeTester>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): JsNodeTester;
   ...
   * @return this Obj
   */
  setField(field: string, value: any, doNotConvert?: boolean): JsNodeTester;
   ...
   * @return this Obj
   */
  setField(field: FieldType, value: any, doNotConvert?: boolean): JsNodeTester;
   ...
   */
  static forPathAndEngine(path: string, engine: string): JsNodeTester;
   ...
   * Note: invoke this API on the desired type of Tester instead of on the Tester type directly.
   */
  static forNameAndEngine(testName: string, engine: string): JsNodeTester;
   ...
   * Note: invoke this API on the desired type of Tester instead of on the Tester type directly.
   */
  static forEngine(engine: string, deep?: boolean): JsNodeTester;
   ...
   */
  run(spec?: TesterRunSpec | null): JsNodeTester;
  ...
  /**
   * See {@link Tester#runTestSuiteCode}
   */
