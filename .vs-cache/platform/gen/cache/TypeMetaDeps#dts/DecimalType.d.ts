// TypeScript definitions for the C3 type DecimalType

/**
 * The decimal number value type. This is an arbitrary precision decimal number that supports only exact arithmetic.
 * It is not available in all languages. Note that `decimal` values will be significantly slower than IEEE floating
 * point values that have hardware support.
 *
 * There are no fields (other than #modifier), so this is normally accessed with {@link PrimitiveType#ofDecimal}.
 *
 * @see DoubleType
 * @see BigIntType
 *
 * @remarks this represents a value passed to a method that expects an instance of DecimalType
 */
declare interface IDecimalType {
 ...
 * @see BigIntType
 *
 * @remarks this represents a made instance of DecimalType
 */
declare class DecimalType extends Obj {

  /**
   * Source file Pkg.Path a C3 Type declaration [.c3typ].
   */
  readonly declaredPkgPath?: string | null;
  withDeclaredPkgPath(declaredPkgPath: string | null): DecimalType;

  /**
   * Source line number in a C3 Type declaration [.c3typ] file starting with 1 where this metadata element is declared.
   */
  readonly declaredSrcLine?: number | null;
  withDeclaredSrcLine(declaredSrcLine: number | null): DecimalType;
  ...
  withDeclaredSrcCharInLine(declaredSrcCharInLine: number | null): DecimalType;
   ...
   */
  readonly pkg: Pkg;
  withPkg(pkg: IPkg): DecimalType;

  /**
   * SDK json representing instance of this type
   */
  readonly json?: any;
  withJson(json: any): DecimalType;

  /**
   * The set of annotations defined on this element of metadata represented as json value.
   */
  readonly annotationsJson?: any | null;
  withAnnotationsJson(annotationsJson: any | null): DecimalType;
  ...
  withModifier(modifier: string | null): DecimalType;
  ...
  withName(name: string): DecimalType;
  ...
  withSerializedType(serializedType: IValueType | null): DecimalType;
  ...
  withEnumRefType(enumRefType: IReferenceType | null): DecimalType;
  ...
  withDeclaredEnumValues(declaredEnumValues: C3.Array<string | null> | Array<string | null>): DecimalType;
   ...
   */
  replaceType(old: Type, new_: Type): DecimalType;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): DecimalType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): DecimalType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): DecimalType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): DecimalType | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DecimalType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DecimalType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DecimalType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DecimalType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DecimalType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DecimalType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DecimalType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DecimalType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DecimalType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DecimalType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DecimalType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DecimalType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DecimalType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): DecimalType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): DecimalType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): DecimalType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DecimalType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DecimalType;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DecimalType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DecimalType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DecimalType;
   ...
   * @see #removeField
   */
  unsetField(field: string): DecimalType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DecimalType;
   ...
   * @see #unsetField
   */
  removeField(field: string): DecimalType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DecimalType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DecimalType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): DecimalType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DecimalType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DecimalType;

  mergeJson(json: any | null): DecimalType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DecimalType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): DecimalType;
   ...
   */
  singletonArray(): C3.Array<DecimalType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<DecimalType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DecimalType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<DecimalType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DecimalType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, DecimalType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DecimalType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DecimalType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DecimalType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DecimalType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DecimalType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DecimalType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DecimalType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DecimalType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DecimalType;
   ...
   * @see #fromString
   */
  static make(s: string | null): DecimalType | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DecimalType;
   ...
   */
  static cachedEmptyInst(): DecimalType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DecimalType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): DecimalType;
   ...
   */
  withoutDeclaredSrcPos(recursive?: boolean): DecimalType;
   ...
   */
  withAnnotation(ann: Annotation): DecimalType;
   ...
   *         value for the field
   */
  withAnnotation(ann: string, annField?: string | null, value?: any): DecimalType;
   ...
   * @see #toString
   */
  static fromString(s: string | null): DecimalType | null;
