// TypeScript definitions for the C3 type Cassandra.Config

/**
 * Spec holding connection details for cassandra
 *
 * @remarks this represents a value passed to a method that expects an instance of Cassandra.Config
 */
declare namespace Cassandra {
  export interface IConfig {
     ...
     */
    connectionPool?: IDatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null;

    /**
     * How to access the data in the datastore.  Override to provide things such as endpoint, username, password,
     * etc. as appropriate.
     */
    credentials?: IKvStore.Credentials | null;
    ...
    shareReadConnection?: boolean;

    sharedReadThreshold: number;

    readConnectionPool?: IDatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null;

    writeConnectionPool?: IDatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null;
     ...
     * value between 0 - 100
     */
    fillBucketsProbabilityOnRead?: number | null;
     ...
     * value between 0 - 100
     */
    fillBucketsProbabilityOnWrite?: number | null;
     ...
     */
    fillBucketsPartitionKeyPercentageOnWrite?: number | null;
     ...
     */
    rangeDeleteTimeDriftInSec?: number | null;
     ...
     */
    multiBinningWriteTimeInterval?: string | null;

    hostPrefix?: string | null;

    knownNode?: string | null;

    nodeDownSuspensionMillis?: number | null;

    maxConnectionWaitMillis?: number | null;

    maxNumOpRetries?: number | null;

    schemaAgreementWaitMillis?: number | null;

    /**
     * INTERNAL - If set, then will bring up Embedded Cassandra - used for internal testing only
     */
    embedded?: boolean;
     ...
     */
    replicationStrategy?: string | null;
    ...
    /**
     * Default consistency level for the overall cluster.
     */
    consistencyLevel?: string | null;

    /**
     * Default serial consistency level for the overall cluster.
     * Ref https://docs.datastax.com/en/drivers/java/2.0/com/datastax/driver/core/Statement.html#setSerialConsistencyLevel-com.datastax.driver.core.ConsistencyLevel-
     */
    serialConsistencyLevel?: string | null;

    /**
     * Overrides for each datacenter by replication factor
     * this is provided if replicationStrategy is NetworkTopologyStrategy and if different datacenters are provided
     */
    replicationFactorByDc?: C3.Map<string | null, number | null> | {[key: string | null]: number | null};

    /**
     * Name of the data center.
     * This field must be provided when Cassandra Cluster is not ensured by C3.
     * For Cassandra Cluster ensured by C3, we will populate the value retrieved from {@link CassandraDB_Config#datacenterName}.
     */
 ...
 * Spec holding connection details for cassandra
 *
 * @remarks this represents a made instance of Cassandra.Config
 */
declare namespace Cassandra {
  export class Config extends Obj {

    readonly configOverride?: string | null;
    withConfigOverride(configOverride: string | null): Cassandra.Config;

    readonly secretOverride?: string | null;
    withSecretOverride(secretOverride: string | null): Cassandra.Config;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: C3.Array<string | null>;
    withIssues(issues: C3.Array<string | null> | Array<string | null>): Cassandra.Config;

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): Cassandra.Config;

    /**
     * Physical pool for connections
     */
    readonly connectionPool?: DatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null;
    withConnectionPool(connectionPool: IDatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null): Cassandra.Config;

    /**
     * How to access the data in the datastore.  Override to provide things such as endpoint, username, password,
     * etc. as appropriate.
     */
    readonly credentials?: KvStore.Credentials | null;
    withCredentials(credentials: IKvStore.Credentials | null): Cassandra.Config;

    /**
     * C3 Cloud Identifier for backing infrastructure that hosts the Datastore ex: {@link PostgresDb#id}, {@link CassandraDb#id}
     */
    readonly cloudId?: string | null;
    withCloudId(cloudId: string | null): Cassandra.Config;

    /**
     * True if the datastore is disabled (e.g. no data access is permitted).
     */
    readonly disabled?: boolean;
    withDisabled(disabled: boolean): Cassandra.Config;

    /**
     * True if the datastore is read only, i.e. can only be queried.
     */
    readonly readOnly?: boolean;
    withReadOnly(readOnly: boolean): Cassandra.Config;

    /**
     * True if the datastore is external, i.e. its database schema can not be altered.
     */
    readonly external?: boolean;
    withExternal(external: boolean): Cassandra.Config;
    ...
    withPerTenant(perTenant: boolean): Cassandra.Config;

    /**
     * Description for the dataStore.
     */
    readonly description?: string | null;
    withDescription(description: string | null): Cassandra.Config;

    /**
     * True if the db is shared with other apps or it is dedicated.
     */
    readonly dedicated?: boolean;
    withDedicated(dedicated: boolean): Cassandra.Config;

    readonly shareReadConnection?: boolean;
    withShareReadConnection(shareReadConnection: boolean): Cassandra.Config;

    readonly sharedReadThreshold: number;
    withSharedReadThreshold(sharedReadThreshold: number): Cassandra.Config;

    readonly readConnectionPool?: DatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null;
    withReadConnectionPool(readConnectionPool: IDatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null): Cassandra.Config;

    readonly writeConnectionPool?: DatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null;
    withWriteConnectionPool(writeConnectionPool: IDatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null): Cassandra.Config;
    ...
    withNewColReadCount(newColReadCount: number | null): Cassandra.Config;
    ...
    withNewColMaxObjCount(newColMaxObjCount: number | null): Cassandra.Config;
    ...
    withRewriteAllIncremental(rewriteAllIncremental: boolean): Cassandra.Config;

    /**
     * Kv store kind for which this config is provided
     */
    readonly kvstore?: Type | null;
    withKvstore(kvstore: IType | null): Cassandra.Config;
     ...
     * value between 0 - 100
     */
    readonly fillBucketsProbabilityOnRead?: number | null;
    withFillBucketsProbabilityOnRead(fillBucketsProbabilityOnRead: number | null): Cassandra.Config;
     ...
     * value between 0 - 100
     */
    readonly fillBucketsProbabilityOnWrite?: number | null;
    withFillBucketsProbabilityOnWrite(fillBucketsProbabilityOnWrite: number | null): Cassandra.Config;
     ...
     * Default is 10% of of random partition keys selected from the batch
     */
    readonly fillBucketsPartitionKeyPercentageOnWrite?: number | null;
    withFillBucketsPartitionKeyPercentageOnWrite(fillBucketsPartitionKeyPercentageOnWrite: number | null): Cassandra.Config;
     ...
     * kv store by not individually deleting columns
     */
    readonly rangeDeleteTimeDriftInSec?: number | null;
    withRangeDeleteTimeDriftInSec(rangeDeleteTimeDriftInSec: number | null): Cassandra.Config;
     ...
     * is created per day, and all new objs inserted on that day will be written to that new obj row.
     */
    readonly multiBinningWriteTimeInterval?: string | null;
    withMultiBinningWriteTimeInterval(multiBinningWriteTimeInterval: string | null): Cassandra.Config;

    readonly hostPrefix?: string | null;
    withHostPrefix(hostPrefix: string | null): Cassandra.Config;

    readonly knownNode?: string | null;
    withKnownNode(knownNode: string | null): Cassandra.Config;

    readonly nodeDownSuspensionMillis?: number | null;
    withNodeDownSuspensionMillis(nodeDownSuspensionMillis: number | null): Cassandra.Config;

    readonly maxConnectionWaitMillis?: number | null;
    withMaxConnectionWaitMillis(maxConnectionWaitMillis: number | null): Cassandra.Config;

    readonly maxNumOpRetries?: number | null;
    withMaxNumOpRetries(maxNumOpRetries: number | null): Cassandra.Config;

    readonly schemaAgreementWaitMillis?: number | null;
    withSchemaAgreementWaitMillis(schemaAgreementWaitMillis: number | null): Cassandra.Config;

    /**
     * INTERNAL - If set, then will bring up Embedded Cassandra - used for internal testing only
     */
    readonly embedded?: boolean;
    withEmbedded(embedded: boolean): Cassandra.Config;

    /**
     * Cassandra keyspace replication strategy.
     */
    readonly replicationStrategy?: string | null;
    withReplicationStrategy(replicationStrategy: string | null): Cassandra.Config;

    /**
     * Replication factor for the keyspace.
     */
    readonly replicationFactor?: number | null;
    withReplicationFactor(replicationFactor: number | null): Cassandra.Config;

    /**
     * Default consistency level for the overall cluster.
     */
    readonly consistencyLevel?: string | null;
    withConsistencyLevel(consistencyLevel: string | null): Cassandra.Config;

    /**
     * Default serial consistency level for the overall cluster.
     * Ref https://docs.datastax.com/en/drivers/java/2.0/com/datastax/driver/core/Statement.html#setSerialConsistencyLevel-com.datastax.driver.core.ConsistencyLevel-
     */
    readonly serialConsistencyLevel?: string | null;
    withSerialConsistencyLevel(serialConsistencyLevel: string | null): Cassandra.Config;

    /**
     * Overrides for each datacenter by replication factor
     * this is provided if replicationStrategy is NetworkTopologyStrategy and if different datacenters are provided
     */
    readonly replicationFactorByDc?: C3.Map<string | null, number | null>;
    withReplicationFactorByDc(replicationFactorByDc: C3.Map<string | null, number | null> | {[key: string | null]: number | null}): Cassandra.Config;
    ...
    withDatacenter(datacenter: string | null): Cassandra.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Cassandra.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Cassandra.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Cassandra.Config | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Cassandra.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Cassandra.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Cassandra.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Cassandra.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Cassandra.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Cassandra.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Cassandra.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Cassandra.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Cassandra.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Cassandra.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Cassandra.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Cassandra.Config;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Cassandra.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Cassandra.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Cassandra.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Cassandra.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Cassandra.Config;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Cassandra.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Cassandra.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Cassandra.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Cassandra.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Cassandra.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Cassandra.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Cassandra.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Cassandra.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Cassandra.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Cassandra.Config;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Cassandra.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Cassandra.Config;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Cassandra.Config;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Cassandra.Config;

    mergeJson(json: any | null): Cassandra.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Cassandra.Config;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Cassandra.Config;
     ...
     */
    singletonArray(): C3.Array<Cassandra.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Cassandra.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Cassandra.Config | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Cassandra.Config | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Cassandra.Config | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Cassandra.Config | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Cassandra.Config | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Cassandra.Config | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Cassandra.Config | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Cassandra.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Cassandra.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Cassandra.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Cassandra.Config;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Cassandra.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Cassandra.Config;
     ...
     * @see #fromString
     */
    static make(s: string | null): Cassandra.Config | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Cassandra.Config;
     ...
     */
    static cachedEmptyInst(): Cassandra.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Cassandra.Config>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Cassandra.Config;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<Cassandra.Config | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<Cassandra.Config | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<Cassandra.Config | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): Cassandra.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string | null): Cassandra.Config | null;
     ...
     * @see findByCacheKey
     */
    getCached(): Cassandra.Config | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): Cassandra.Config | null;
     ...
     */
    static produce(key: string): Cassandra.Config | null;
     ...
     */
    static produceAll(): C3.Map<string | null, Cassandra.Config | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, Cassandra.Config | null>;
     ...
     */
    static forConfigKey(configKey: string | null): Cassandra.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<Cassandra.Config | null>;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Cassandra.Config, override?: string | null): void;
     ...
     * @see setSecretValue
     */
    setSecretValues(from: Cassandra.Config, override?: string | null): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Cassandra.Config | null;
     ...
     * @see #toString
     */
    static fromString(s: string | null): Cassandra.Config | null;
     ...
     */
    static forName(name: string | null, failIfMissing?: boolean): Cassandra.Config | null;
    ...
    /**
     * Member method to return the replication json string
     */
    replicationJsonString(): string | null;
  }
}
