// TypeScript definitions for the C3 type Hpo.Run

/**
 * Results for a single training run of {@link MlPipe}.
 * Upon successful completion, this will contain validation/train scores.
 * Upon failure, this will contain a best-effort error message.
 * Note: a single hyperparameter combination may trigger multiple training runs for cross-validation purposes.
 * The {@link Hpo.Run}s are aggregated in {@link Hpo.Trial}.
 *
 * @remarks this represents a value passed to a method that expects an instance of Hpo.Run
 */
declare namespace Hpo {
  export interface IRun {
     ...
     */
    parentCoordinator: IMlWorkflowCoordinatable<MlWorkflowCoordinatableResult | null>;
     ...
     * result.
     */
    pastRuns?: C3.Array<WorkflowExecutorRun | null> | Array<IWorkflowExecutorRun | null>;

    /**
     * Number of times the {@link #parentCoordinator} has attempted to recover this result.
     */
    attemptedRecoveryCount?: number | null;

    /**
     * A single train and validation split for training and scoring this {@link Hpo.Run}.
     */
    validationSplit?: IMlSplit<any, any> | null;

    /**
     * Validation scores computed from {@link MlPipe#scoringMetrics} in
     * {@link Hpo.Spec#validationTechnique}. The key is the name of the metric, and the value is the score.
     */
    validationScores?: C3.Map<string | null, number | null> | {[key: string | null]: number | null};

    /**
     * Training scores computed from {@link MlPipe#scoringMetrics} in
     * {@link Hpo.Spec#validationTechnique}. The key is the name of the metric, and the value is the score.
     */
    trainingScores?: C3.Map<string | null, number | null> | {[key: string | null]: number | null};

    /**
     * Trained pipe from the training run.
     */
    pipe?: IMlPipe<any, any, any, any, any> | null;

    /**
     * Reference to the {@link MlOperationRun} that executed the actions to execute this
     * result.
     */
    operationRun?: IMlOperationRun<any> | null;

    /**
     * Error returned by a failed training run.
     */
    error?: C3.Array<string | null> | Array<string | null>;

    /**
     * Trained pipe from the training run.
     */
    trainedPipe?: IMlPipe<any, any, any, any, any> | null;

    /**
     * {@link MlOperationRun} that is orchestrating the train and score execution of pending trainings.
     * Only intended for internal use!
     */
    mlOperationRun?: IMlOperationRun<any> | null;

    /**
     * Timestamp of the beginning of the {@link Hpo.Run} that includes training and scoring.
     * Note that startTimestamp may be updated on a different machine compared to endTimestamp
     * whose clocks may not be synchronized.
     */
    startTimestamp?: DateTime | Date | string | null;

    /**
     * Timestamp of the end of the {@link Hpo.Run} that includes training and scoring.
     */
    endTimestamp?: DateTime | Date | string | null;

    /**
     * Shape of the inputs and targets (if any) used for training in an {@link Hpo.Run}
     */
    trainShape?: C3.Map<string | null, any> | {[key: string | null]: any};

    /**
     * Shape of the inputs and targets (if any) used for validation in an {@link Hpo.Run}
     */
    valShape?: C3.Map<string | null, any> | {[key: string | null]: any};
  }
}
 ...
 * The {@link Hpo.Run}s are aggregated in {@link Hpo.Trial}.
 *
 * @remarks this represents a made instance of Hpo.Run
 */
declare namespace Hpo {
  export class Run extends Obj {
    ...
    withTypeIdent(typeIdent: string | null): Hpo.Run;
    ...
    withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Hpo.Run;

    /**
     * Various system fields.
     */
    readonly meta?: Meta | null;
    withMeta(meta: IMeta | null): Hpo.Run;
    ...
    withVersion(version: number | null): Hpo.Run;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type | null;
    withTypeWithBindings(typeWithBindings: IType | null): Hpo.Run;

    /**
     * Parent {@link MlWorkflowCoordinatable} that this result belongs to.
     */
    readonly parentCoordinator: MlWorkflowCoordinatable<MlWorkflowCoordinatableResult | null>;
    withParentCoordinator(parentCoordinator: IMlWorkflowCoordinatable<MlWorkflowCoordinatableResult | null>): Hpo.Run;
    ...
    withStatusForCoordinatable(statusForCoordinatable: string): Hpo.Run;

    /**
     * Number of times the {@link #parentCoordinator} has canceled this result.
     */
    readonly canceledCount?: number | null;
    withCanceledCount(canceledCount: number | null): Hpo.Run;
    ...
    withIsCanceled(isCanceled: boolean): Hpo.Run;
    ...
    withErrorCount(errorCount: number | null): Hpo.Run;

    /**
     * Reference to the {@link WorkflowExecutorRun} that executed the actions to execute this
     * result.
     */
    readonly run?: WorkflowExecutorRun | null;
    withRun(run: IWorkflowExecutorRun | null): Hpo.Run;
    ...
    withDurationSeconds(durationSeconds: number | null): Hpo.Run;

    /**
     * Reference to all past {@link WorkflowExecutorRun}s that executed the actions pertaining to this
     * result.
     */
    readonly pastRuns?: C3.Array<WorkflowExecutorRun | null>;
    withPastRuns(pastRuns: C3.Array<WorkflowExecutorRun | null> | Array<IWorkflowExecutorRun | null>): Hpo.Run;

    /**
     * Number of times the {@link #parentCoordinator} has attempted to recover this result.
     */
    readonly attemptedRecoveryCount?: number | null;
    withAttemptedRecoveryCount(attemptedRecoveryCount: number | null): Hpo.Run;

    /**
     * A single train and validation split for training and scoring this {@link Hpo.Run}.
     */
    readonly validationSplit?: MlSplit<any, any> | null;
    withValidationSplit(validationSplit: IMlSplit<any, any> | null): Hpo.Run;

    /**
     * Validation scores computed from {@link MlPipe#scoringMetrics} in
     * {@link Hpo.Spec#validationTechnique}. The key is the name of the metric, and the value is the score.
     */
    readonly validationScores?: C3.Map<string | null, number | null>;
    withValidationScores(validationScores: C3.Map<string | null, number | null> | {[key: string | null]: number | null}): Hpo.Run;
    ...
    withTrainingScores(trainingScores: C3.Map<string | null, number | null> | {[key: string | null]: number | null}): Hpo.Run;

    /**
     * Trained pipe from the training run.
     */
    readonly pipe?: MlPipe<any, any, any, any, any> | null;
    withPipe(pipe: IMlPipe<any, any, any, any, any> | null): Hpo.Run;

    /**
     * Reference to the {@link MlOperationRun} that executed the actions to execute this
     * result.
     */
    readonly operationRun?: MlOperationRun<any> | null;
    withOperationRun(operationRun: IMlOperationRun<any> | null): Hpo.Run;

    /**
     * Error returned by a failed training run.
     */
    readonly error?: C3.Array<string | null>;
    withError(error: C3.Array<string | null> | Array<string | null>): Hpo.Run;

    /**
     * Trained pipe from the training run.
     */
    readonly trainedPipe?: MlPipe<any, any, any, any, any> | null;
    withTrainedPipe(trainedPipe: IMlPipe<any, any, any, any, any> | null): Hpo.Run;

    /**
     * {@link MlOperationRun} that is orchestrating the train and score execution of pending trainings.
     * Only intended for internal use!
     */
    readonly mlOperationRun?: MlOperationRun<any> | null;
    withMlOperationRun(mlOperationRun: IMlOperationRun<any> | null): Hpo.Run;
    ...
    withStartTimestamp(startTimestamp: DateTime | Date | string | null): Hpo.Run;

    /**
     * Timestamp of the end of the {@link Hpo.Run} that includes training and scoring.
     */
    readonly endTimestamp?: DateTime | null;
    withEndTimestamp(endTimestamp: DateTime | Date | string | null): Hpo.Run;

    /**
     * Shape of the inputs and targets (if any) used for training in an {@link Hpo.Run}
     */
    readonly trainShape?: C3.Map<string | null, any>;
    withTrainShape(trainShape: C3.Map<string | null, any> | {[key: string | null]: any}): Hpo.Run;

    /**
     * Shape of the inputs and targets (if any) used for validation in an {@link Hpo.Run}
     */
    readonly valShape?: C3.Map<string | null, any>;
    withValShape(valShape: C3.Map<string | null, any> | {[key: string | null]: any}): Hpo.Run;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Hpo.Run | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Hpo.Run | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Hpo.Run | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Hpo.Run | null;
     ...
     */
    replaceType(old: Type, new_: Type): Hpo.Run;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Hpo.Run;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Hpo.Run;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Hpo.Run | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Hpo.Run | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Hpo.Run;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Hpo.Run;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Hpo.Run;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Hpo.Run;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Hpo.Run;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Hpo.Run;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Hpo.Run;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Hpo.Run;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Hpo.Run;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Hpo.Run;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Hpo.Run;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Hpo.Run;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Hpo.Run;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Hpo.Run;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Hpo.Run;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Hpo.Run;
     ...
     * @see #removeField
     */
    unsetField(field: string): Hpo.Run;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Hpo.Run;
     ...
     * @see #unsetField
     */
    removeField(field: string): Hpo.Run;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Hpo.Run;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Hpo.Run;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Hpo.Run;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Hpo.Run;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Hpo.Run;

    mergeJson(json: any | null): Hpo.Run;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Hpo.Run;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Hpo.Run;
     ...
     */
    singletonArray(): C3.Array<Hpo.Run | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Hpo.Run | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Hpo.Run | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Hpo.Run | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Hpo.Run | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Hpo.Run | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Hpo.Run | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Hpo.Run | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Hpo.Run | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Hpo.Run;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Hpo.Run;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Hpo.Run;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Hpo.Run;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Hpo.Run;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Hpo.Run;
     ...
     * @see #fromString
     */
    static make(s: string | null): Hpo.Run | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Hpo.Run;
     ...
     */
    static cachedEmptyInst(): Hpo.Run;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Hpo.Run>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Hpo.Run;
     ...
     */
    static fetch(spec?: FetchSpec | null): FetchResult<Hpo.Run | null>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Hpo.Run | null>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Hpo.Run | null>;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Hpo.Run | null> | null>;
     ...
     */
    get(include?: string | null): Hpo.Run | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string | null): Hpo.Run | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Hpo.Run;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string | null): Hpo.Run | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Hpo.Run;
     ...
     * @see #toString
     */
    static fromString(s: string | null): Hpo.Run | null;
     ...
     */
    create(spec?: UpsertSpec | null): Hpo.Run | null;
     ...
     */
    static createBatch(objs: C3.Array<Hpo.Run | null> | null, spec?: UpsertSpec | null): ObjList<Hpo.Run | null> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Hpo.Run | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Hpo.Run | null> | null;
     ...
     */
    update(srcObj?: Hpo.Run | null, spec?: UpsertSpec | null): Hpo.Run | null;
     ...
     */
    upsert(srcObj?: Hpo.Run | null, spec?: UpsertSpec | null): Hpo.Run | null;
     ...
     */
    merge(spec?: MergeSpec | null): Hpo.Run | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec | null): Hpo.Run | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec | null): Hpo.Run | null;
     ...
     */
    static updateBatch(objs: C3.Array<Hpo.Run | null> | null, srcObjs?: C3.Array<Hpo.Run | null>, spec?: UpsertSpec | null): ObjList<Hpo.Run | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<C3.Array<Hpo.Run | null>>, spec?: UpsertSpec | null): ObjList<Hpo.Run | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: C3.Array<Hpo.Run | null> | null, srcObjs?: C3.Array<Hpo.Run | null>, spec?: UpsertSpec | null): ObjList<Hpo.Run | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<C3.Array<Hpo.Run | null>>, spec?: UpsertSpec | null): ObjList<Hpo.Run | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: C3.Array<Hpo.Run | null> | null, spec?: TouchSpec | null): ObjList<Hpo.Run | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<Hpo.Run | null> | null, spec?: MergeSpec | null): ObjList<Hpo.Run | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<Hpo.Run | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Hpo.Run | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<C3.Array<Hpo.Run | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Hpo.Run | null> | null;
     ...
     */
    static mergeAll(mergeObj: Hpo.Run | null, spec?: MergeAllSpec | null): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Hpo.Run | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: C3.Array<Hpo.Run | null> | null, spec?: UpsertSpec | null): ObjList<Hpo.Run | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: C3.Array<Hpo.Run | null> | null, spec?: UpsertSpec | null): ObjList<Hpo.Run | null> | null;
     ...
     */
    static beforeCreate(objs: C3.Array<Hpo.Run | null> | null): ObjList<Hpo.Run | null>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: C3.Array<Hpo.Run | null> | null): ObjList<Hpo.Run | null>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: C3.Array<Hpo.Run | null> | null): ObjList<Hpo.Run | null>;
     ...
     */
    static afterCreate(objs: C3.Array<Hpo.Run | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: C3.Array<Hpo.Run | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: C3.Array<Hpo.Run | null> | null): C3.Array<ObjError | null>;
     ...
     */
    static startImportData(spec?: StartImportDataSpec | null): PushStream<Hpo.Run | null>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Hpo.Run | null>;
     ...
     */
    static forId(id: string | null, failIfMissing?: boolean): Hpo.Run | null;
     ...
     */
    static typeOfBatch(objs: C3.Array<Hpo.Run | null> | null): C3.Array<EntityType | null>;
     ...
     */
    static dbEcho(template?: Hpo.Run | null, count?: number | null, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: C3.Array<Hpo.Run | null> | null, callback?: λFunction<Hpo.Run | null, Hpo.Run | null> | null): ObjList<Hpo.Run | null>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: C3.Array<Hpo.Run | null> | null, callback?: λFunction<Hpo.Run | null, Hpo.Run | null> | null): C3.Array<ObjError | null>;
     ...
     * caller is responsible for persisting the result.
     */
    beforeCancel(): Hpo.Run;

    /**
     * Cancel this {@link Hpo.Run} and set the {@link #statusForCoordinatable} as `completed`.
     */
    cancel(): void;

    /**
     * Update this {@link Hpo.Run} with trained {@link #pipe}, {@link #validationScores} and
     * {@link #trainingScores}.
     */
    beforeComplete(): Hpo.Run | null;

    /**
     * Helper function for creating and starting a workflow to execute the operation for this result.
     * @return a handle to the asynchronous execution.
     */
    startWrapperWorkflow(): MlOperationRun<any>;
  }
}
