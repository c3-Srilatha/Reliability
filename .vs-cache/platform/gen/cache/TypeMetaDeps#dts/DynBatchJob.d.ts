// TypeScript definitions for the C3 type DynBatchJob
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of DynBatchJob
 */
declare interface IDynBatchJob {
 ...
 */
declare class DynBatchJob extends Obj {

  /**
   * Lambda that implements doStart logic. (required)
   */
  readonly doStartLambda: Lambda<λBiConsumer<DynBatchJob | null, DynBatchJobSpec | null> | null>;
  withDoStartLambda(doStartLambda: ILambda<λBiConsumer<DynBatchJob | null, DynBatchJobSpec | null> | null>): DynBatchJob;

  /**
   * Lambda that implements processBatch logic. (required)
   */
  readonly processBatchLambda: Lambda<λTriConsumer<DynBatchJobBatch | null, DynBatchJob | null, DynBatchJobSpec | null> | null>;
  withProcessBatchLambda(processBatchLambda: ILambda<λTriConsumer<DynBatchJobBatch | null, DynBatchJob | null, DynBatchJobSpec | null> | null>): DynBatchJob;

  /**
   * Lambda that implements allComplete logic. (optional)
   */
  readonly allCompleteLambda?: Lambda<λBiFunction<DynBatchJob | null, DynBatchJobSpec | null, string | null> | null> | null;
  withAllCompleteLambda(allCompleteLambda: ILambda<λBiFunction<DynBatchJob | null, DynBatchJobSpec | null, string | null> | null> | null): DynBatchJob;

  /**
   * Optional context object if ad-hoc job needs additional options.
   */
  readonly context?: Obj | null;
  withContext(context: IObj | null): DynBatchJob;

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun | null;
  withRun(run: IBatchJobRun | null): DynBatchJob;

  /**
   * previous job executions for this instance
   */
  readonly runs?: C3.Array<BatchJobRun | null>;
  withRuns(runs: C3.Array<BatchJobRun | null> | Array<IBatchJobRun | null>): DynBatchJob;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj | null;
  withOptions(options: IObj | null): DynBatchJob;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): DynBatchJob;
  ...
  withPriority(priority: number | null): DynBatchJob;
  ...
  withDisabled(disabled: boolean): DynBatchJob;
  ...
  withMaxConcurrency(maxConcurrency: number | null): DynBatchJob;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): DynBatchJob;
  ...
  withRunAsUser(runAsUser: boolean | null): DynBatchJob;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string | null;
  withNodePool(nodePool: string | null): DynBatchJob;
  ...
  withSkipIfRunning(skipIfRunning: boolean | null): DynBatchJob;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number | null;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): DynBatchJob;
  ...
  withPropagateActionContext(propagateActionContext: boolean): DynBatchJob;
  ...
  withTypeIdent(typeIdent: string | null): DynBatchJob;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): DynBatchJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): DynBatchJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): DynBatchJob;
  ...
  withVersion(version: number | null): DynBatchJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): DynBatchJob;
  ...
  withAbortOnError(abortOnError: boolean): DynBatchJob;

  /**
   * Optional object to store an eventual result
   */
  readonly result?: Obj | null;
  withResult(result: IObj | null): DynBatchJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): DynBatchJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): DynBatchJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): DynBatchJob | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): DynBatchJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): DynBatchJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DynBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DynBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DynBatchJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DynBatchJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DynBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DynBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DynBatchJob;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DynBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DynBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DynBatchJob;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DynBatchJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DynBatchJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DynBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): DynBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): DynBatchJob;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): DynBatchJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DynBatchJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DynBatchJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DynBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DynBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DynBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): DynBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DynBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): DynBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DynBatchJob;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DynBatchJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): DynBatchJob;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DynBatchJob;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DynBatchJob;

  mergeJson(json: any | null): DynBatchJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DynBatchJob;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): DynBatchJob;
   ...
   */
  singletonArray(): C3.Array<DynBatchJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<DynBatchJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DynBatchJob | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<DynBatchJob | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DynBatchJob | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, DynBatchJob | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DynBatchJob | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DynBatchJob | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DynBatchJob | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DynBatchJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DynBatchJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DynBatchJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DynBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DynBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DynBatchJob;
   ...
   * @see #fromString
   */
  static make(s: string | null): DynBatchJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DynBatchJob;
   ...
   */
  static cachedEmptyInst(): DynBatchJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DynBatchJob>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): DynBatchJob;
   ...
   */
  start(options?: DynBatchJobSpec | null): BatchJobStatus | null;
   ...
   */
  cleanup(options?: DynBatchJobSpec | null): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun | null, BatchJobStatus | null, DynBatchJobSpec | null> | null;

  failJob(run: JobRun<BatchJobStatusBase | null>): JobBase<BatchJobRun | null, BatchJobStatus | null, DynBatchJobSpec | null> | null;
  ...
  validateStart(options?: DynBatchJobSpec | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<DynBatchJob | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<DynBatchJob | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<DynBatchJob | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<DynBatchJob | null> | null>;
   ...
   */
  get(include?: string | null): DynBatchJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): DynBatchJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): DynBatchJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): DynBatchJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): DynBatchJob;
   ...
   * @see #toString
   */
  static fromString(s: string | null): DynBatchJob | null;
   ...
   */
  create(spec?: UpsertSpec | null): DynBatchJob | null;
   ...
   */
  static createBatch(objs: C3.Array<DynBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<DynBatchJob | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<DynBatchJob | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<DynBatchJob | null> | null;
   ...
   */
  update(srcObj?: DynBatchJob | null, spec?: UpsertSpec | null): DynBatchJob | null;
   ...
   */
  upsert(srcObj?: DynBatchJob | null, spec?: UpsertSpec | null): DynBatchJob | null;
   ...
   */
  merge(spec?: MergeSpec | null): DynBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): DynBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): DynBatchJob | null;
   ...
   */
  static updateBatch(objs: C3.Array<DynBatchJob | null> | null, srcObjs?: C3.Array<DynBatchJob | null>, spec?: UpsertSpec | null): ObjList<DynBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<DynBatchJob | null>>, spec?: UpsertSpec | null): ObjList<DynBatchJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<DynBatchJob | null> | null, srcObjs?: C3.Array<DynBatchJob | null>, spec?: UpsertSpec | null): ObjList<DynBatchJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<DynBatchJob | null>>, spec?: UpsertSpec | null): ObjList<DynBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<DynBatchJob | null> | null, spec?: TouchSpec | null): ObjList<DynBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<DynBatchJob | null> | null, spec?: MergeSpec | null): ObjList<DynBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<DynBatchJob | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<DynBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<DynBatchJob | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<DynBatchJob | null> | null;
   ...
   */
  static mergeAll(mergeObj: DynBatchJob | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: DynBatchJob | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<DynBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<DynBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<DynBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<DynBatchJob | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<DynBatchJob | null> | null): ObjList<DynBatchJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<DynBatchJob | null> | null): ObjList<DynBatchJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<DynBatchJob | null> | null): ObjList<DynBatchJob | null>;
   ...
   */
  static afterCreate(objs: C3.Array<DynBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<DynBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<DynBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<DynBatchJob | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<DynBatchJob | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): DynBatchJob | null;
   ...
   */
  withoutIdentity(): DynBatchJob | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<DynBatchJob | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: DynBatchJob | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<DynBatchJob | null> | null, callback?: λFunction<DynBatchJob | null, DynBatchJob | null> | null): ObjList<DynBatchJob | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<DynBatchJob | null> | null, callback?: λFunction<DynBatchJob | null, DynBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static doStart(job?: DynBatchJob | null, options?: DynBatchJobSpec | null): void;
   ...
   */
  static processBatch(batch?: DynBatchJobBatch | null, job?: DynBatchJob | null, options?: DynBatchJobSpec | null): void;
   ...
   */
  static allComplete(job: DynBatchJob, options?: DynBatchJobSpec | null): string | null;
   ...
   *           Options the job was run with.
   */
  static failed(job: DynBatchJob, status: BatchJobStatus, options?: DynBatchJobSpec | null): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: DynBatchJobBatch | null): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: C3.Array<DynBatchJobBatch | null>): void;
   ...
   */
  static scheduleObjBatch(job?: DynBatchJob | null, objBatch?: ObjBatch | null, logPrefix?: string | null): number | null;
   ...
   */
  static startFromSpec(spec: DynBatchJobSpec): DynBatchJob;
}
