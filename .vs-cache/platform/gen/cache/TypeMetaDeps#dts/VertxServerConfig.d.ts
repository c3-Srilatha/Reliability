// TypeScript definitions for the C3 type VertxServerConfig

/**
 * @remarks this represents a value passed to a method that expects an instance of VertxServerConfig
 */
declare interface IVertxServerConfig {
...
/**
 * @remarks this represents a made instance of VertxServerConfig
 */
declare class VertxServerConfig extends Obj {

  readonly SO_BACKLOG?: number | null;
  withSO_BACKLOG(SO_BACKLOG: number | null): VertxServerConfig;

  readonly SO_BROADCAST?: boolean;
  withSO_BROADCAST(SO_BROADCAST: boolean): VertxServerConfig;

  readonly SO_KEEPALIVE?: boolean;
  withSO_KEEPALIVE(SO_KEEPALIVE: boolean): VertxServerConfig;

  readonly SO_LINGER?: number | null;
  withSO_LINGER(SO_LINGER: number | null): VertxServerConfig;

  readonly SO_RCVBUF?: number | null;
  withSO_RCVBUF(SO_RCVBUF: number | null): VertxServerConfig;

  readonly SO_REUSEADDR?: boolean;
  withSO_REUSEADDR(SO_REUSEADDR: boolean): VertxServerConfig;

  readonly SO_SNDBUF?: number | null;
  withSO_SNDBUF(SO_SNDBUF: number | null): VertxServerConfig;

  readonly SO_TIMEOUT?: number | null;
  withSO_TIMEOUT(SO_TIMEOUT: number | null): VertxServerConfig;

  readonly TCP_NODELAY?: boolean;
  withTCP_NODELAY(TCP_NODELAY: boolean): VertxServerConfig;

  readonly connectionTimeoutMillis?: number | null;
  withConnectionTimeoutMillis(connectionTimeoutMillis: number | null): VertxServerConfig;

  readonly maxMessagesPerRead?: number | null;
  withMaxMessagesPerRead(maxMessagesPerRead: number | null): VertxServerConfig;

  readonly writeBufHighWaterMark?: number | null;
  withWriteBufHighWaterMark(writeBufHighWaterMark: number | null): VertxServerConfig;

  readonly writeBufLowWaterMark?: number | null;
  withWriteBufLowWaterMark(writeBufLowWaterMark: number | null): VertxServerConfig;

  /**
   * The name of this instance.
   */
  readonly name?: string | null;
  withName(name: string | null): VertxServerConfig;

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): VertxServerConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): VertxServerConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): VertxServerConfig;

  readonly ssl?: boolean;
  withSsl(ssl: boolean): VertxServerConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): VertxServerConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): VertxServerConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): VertxServerConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): VertxServerConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): VertxServerConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VertxServerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VertxServerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VertxServerConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VertxServerConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): VertxServerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VertxServerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VertxServerConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): VertxServerConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): VertxServerConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): VertxServerConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): VertxServerConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): VertxServerConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): VertxServerConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): VertxServerConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): VertxServerConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): VertxServerConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): VertxServerConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): VertxServerConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): VertxServerConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): VertxServerConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): VertxServerConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): VertxServerConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): VertxServerConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): VertxServerConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): VertxServerConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): VertxServerConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): VertxServerConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): VertxServerConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): VertxServerConfig;

  mergeJson(json: any | null): VertxServerConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): VertxServerConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): VertxServerConfig;
   ...
   */
  singletonArray(): C3.Array<VertxServerConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<VertxServerConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<VertxServerConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<VertxServerConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<VertxServerConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, VertxServerConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, VertxServerConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<VertxServerConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<VertxServerConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): VertxServerConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): VertxServerConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): VertxServerConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): VertxServerConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): VertxServerConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): VertxServerConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): VertxServerConfig;
   ...
   */
  static cachedEmptyInst(): VertxServerConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<VertxServerConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): VertxServerConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<VertxServerConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<VertxServerConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<VertxServerConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): VertxServerConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): VertxServerConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): VertxServerConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): VertxServerConfig | null;
   ...
   */
  static produce(key: string): VertxServerConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, VertxServerConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, VertxServerConfig | null>;
   ...
   */
  static forConfigKey(configKey: string | null): VertxServerConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<VertxServerConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: VertxServerConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: VertxServerConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): VertxServerConfig | null;
