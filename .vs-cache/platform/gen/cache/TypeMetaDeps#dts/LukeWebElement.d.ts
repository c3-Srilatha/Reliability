// TypeScript definitions for the C3 type LukeWebElement
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of LukeWebElement
 */
declare interface ILukeWebElement<T> {
 ...
 * T is a concrete type that implements {@link LukeWebElement} and that is backed by a specific automation engine
 *
 * @remarks this represents a made instance of LukeWebElement
 */
declare class LukeWebElement<T> extends Obj {
   ...
   */
  timeout?: number | null;
  withTimeout(timeout: number | null): LukeWebElement;

  /**
   * The next node in the chain
   */
  next?: LukeAsyncQueueNode | null;
  withNext(next: ILukeAsyncQueueNode | null): LukeWebElement;

  /**
   * The head of the chain that contains the current node
   */
  head?: LukeAsyncQueueNode | null;
  withHead(head: ILukeAsyncQueueNode | null): LukeWebElement;
  ...
  withCatchChain(catchChain: ILukeAsyncQueueNode | null): LukeWebElement;

  /**
   * When the node started running
   */
  startedAt?: number | null;
  withStartedAt(startedAt: number | null): LukeWebElement;

  /**
   * When the node ended running
   */
  endedAt?: number | null;
  withEndedAt(endedAt: number | null): LukeWebElement;

  /**
   * If the node spawns a nested async queue, its chains (heads) will be stored here.
   */
  asyncQueue?: C3.Array<LukeAsyncQueueNode | null>;
  withAsyncQueue(asyncQueue: C3.Array<LukeAsyncQueueNode | null> | Array<ILukeAsyncQueueNode | null>): LukeWebElement;

  /**
   * Whether to skip the remaining chains in the queue
   */
  skipQueueFlag?: boolean;
  withSkipQueueFlag(skipQueueFlag: boolean): LukeWebElement;

  /**
   * The function that yields a promise
   */
  func: any;
  withFunc(func: any): LukeWebElement;
   ...
   */
  args?: C3.Array<any>;
  withArgs(args: C3.Array<any> | Array<any>): LukeWebElement;

  /**
   * Metadata about what type of node this is.
   */
  label?: string | null;
  withLabel(label: string | null): LukeWebElement;

  /**
   * "Unique" id assigned to each LukeAsyncQueueNode for UI. Uses C3 unique ID generator, but not backed by database
   */
  uuid?: string | null;
  withUuid(uuid: string | null): LukeWebElement;

  /**
   * Whether the node should be resolved only when a web element is found
   */
  resolveOnFound?: boolean;
  withResolveOnFound(resolveOnFound: boolean): LukeWebElement;

  /**
   * Whether smart locators have been used to identify the element
   */
  hasTriedSmartLocator?: boolean;
  withHasTriedSmartLocator(hasTriedSmartLocator: boolean): LukeWebElement;

  /**
   * Construct an instance with initial state.
   */
  static make(): LukeWebElement<T>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LukeWebElement<T>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LukeWebElement<T>;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LukeWebElement<T>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LukeWebElement<T>;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LukeWebElement<T> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LukeWebElement<T> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LukeWebElement<T> | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LukeWebElement<T> | null;
   ...
   */
  replaceType(old: Type, new_: Type): LukeWebElement<T>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeWebElement<T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeWebElement<T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeWebElement<T> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeWebElement<T> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LukeWebElement<T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeWebElement<T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeWebElement<T>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LukeWebElement<T>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LukeWebElement<T>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LukeWebElement<T>;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LukeWebElement<T>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LukeWebElement<T>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LukeWebElement<T>;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LukeWebElement<T>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LukeWebElement<T>;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LukeWebElement<T>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LukeWebElement<T>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LukeWebElement<T>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LukeWebElement<T>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LukeWebElement<T>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LukeWebElement<T>;
   ...
   * @see #removeField
   */
  unsetField(field: string): LukeWebElement<T>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LukeWebElement<T>;
   ...
   * @see #unsetField
   */
  removeField(field: string): LukeWebElement<T>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LukeWebElement<T>;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LukeWebElement<T>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LukeWebElement<T>;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LukeWebElement<T>;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LukeWebElement<T>;

  mergeJson(json: any | null): LukeWebElement<T>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LukeWebElement<T>;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LukeWebElement<T>;
   ...
   */
  singletonArray(): C3.Array<LukeWebElement<T> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LukeWebElement<T> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LukeWebElement<T> | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LukeWebElement<T> | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LukeWebElement<T> | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LukeWebElement<T> | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LukeWebElement<T> | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LukeWebElement<T> | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LukeWebElement<T> | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LukeWebElement<T>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LukeWebElement<T>;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LukeWebElement<T>;
   ...
   */
  static cachedEmptyInst(): LukeWebElement<T>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LukeWebElement<T>>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LukeWebElement<T>;
   ...
   * @return this Obj
   */
  setField(field: string, value: any, doNotConvert?: boolean): LukeWebElement<T>;
   ...
   * @return this Obj
   */
  setField(field: FieldType, value: any, doNotConvert?: boolean): LukeWebElement<T>;
   ...
   */
  scrollTo(xOffset?: number | null, yOffset?: number | null): T | null;
   ...
   * @return a {@link LukeWebElement} that will be resolved when the scrollTo succeeds
   */
  moveTo(xOffset?: number | null, yOffset?: number | null): T | null;
   ...
   */
  search(selector: string, resolveOnFound?: boolean): T | null;
   ...
   */
  searchAll(selector: string, resolveOnFound?: boolean): LukeAsyncQueueCollection<T> | null;
   ...
   * @return a {@link LukeWebElement} that will be resolved with the search result
   */
  searchForElementWithText(selector: string, text: string | null | LukeDynamicValue | null, resolveOnFound?: boolean): T | null;
   ...
   */
  setValue(value?: string | null | number | null | boolean | LukeDynamicValue | null | null): T | null;
   ...
   */
  selectByIndex(index?: number | null): T | null;
   ...
   * @return a {@link LukeWebElement} that will be resolved.
   */
  selectByValue(value?: string | null): T | null;
   ...
   */
  trigger(eventType: string, extraArguments?: Obj | null, eventCategory?: string | null): T;
