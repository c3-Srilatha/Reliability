// TypeScript definitions for the C3 type BinaryType

/**
 * The `binary` value type contains any sequence of bytes (raw data). This should be used only for data that does
 * not have a natural representation as on of the other value types. In particular, text values should always use
 * the {@link StringType string type}.
 *
 * There are no fields (other than #modifier), so this is normally accessed with {@link PrimitiveType#ofBinary}.
 *
 * @remarks this represents a value passed to a method that expects an instance of BinaryType
 */
declare interface IBinaryType {
 ...
 * There are no fields (other than #modifier), so this is normally accessed with {@link PrimitiveType#ofBinary}.
 *
 * @remarks this represents a made instance of BinaryType
 */
declare class BinaryType extends Obj {

  /**
   * Source file Pkg.Path a C3 Type declaration [.c3typ].
   */
  readonly declaredPkgPath?: string | null;
  withDeclaredPkgPath(declaredPkgPath: string | null): BinaryType;

  /**
   * Source line number in a C3 Type declaration [.c3typ] file starting with 1 where this metadata element is declared.
   */
  readonly declaredSrcLine?: number | null;
  withDeclaredSrcLine(declaredSrcLine: number | null): BinaryType;
  ...
  withDeclaredSrcCharInLine(declaredSrcCharInLine: number | null): BinaryType;
   ...
   */
  readonly pkg: Pkg;
  withPkg(pkg: IPkg): BinaryType;

  /**
   * SDK json representing instance of this type
   */
  readonly json?: any;
  withJson(json: any): BinaryType;

  /**
   * The set of annotations defined on this element of metadata represented as json value.
   */
  readonly annotationsJson?: any | null;
  withAnnotationsJson(annotationsJson: any | null): BinaryType;
  ...
  withModifier(modifier: string | null): BinaryType;
  ...
  withName(name: string): BinaryType;
  ...
  withSerializedType(serializedType: IValueType | null): BinaryType;
  ...
  withEnumRefType(enumRefType: IReferenceType | null): BinaryType;
  ...
  withDeclaredEnumValues(declaredEnumValues: C3.Array<string | null> | Array<string | null>): BinaryType;
   ...
   */
  replaceType(old: Type, new_: Type): BinaryType;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): BinaryType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): BinaryType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): BinaryType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): BinaryType | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BinaryType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BinaryType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BinaryType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BinaryType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): BinaryType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BinaryType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BinaryType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): BinaryType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): BinaryType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): BinaryType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): BinaryType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BinaryType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): BinaryType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): BinaryType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): BinaryType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): BinaryType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): BinaryType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): BinaryType;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): BinaryType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): BinaryType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): BinaryType;
   ...
   * @see #removeField
   */
  unsetField(field: string): BinaryType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): BinaryType;
   ...
   * @see #unsetField
   */
  removeField(field: string): BinaryType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): BinaryType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): BinaryType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): BinaryType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): BinaryType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): BinaryType;

  mergeJson(json: any | null): BinaryType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): BinaryType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): BinaryType;
   ...
   */
  singletonArray(): C3.Array<BinaryType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<BinaryType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BinaryType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<BinaryType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BinaryType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, BinaryType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BinaryType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BinaryType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BinaryType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): BinaryType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): BinaryType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): BinaryType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): BinaryType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): BinaryType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): BinaryType;
   ...
   * @see #fromString
   */
  static make(s: string | null): BinaryType | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): BinaryType;
   ...
   */
  static cachedEmptyInst(): BinaryType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<BinaryType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): BinaryType;
   ...
   */
  withoutDeclaredSrcPos(recursive?: boolean): BinaryType;
   ...
   */
  withAnnotation(ann: Annotation): BinaryType;
   ...
   *         value for the field
   */
  withAnnotation(ann: string, annField?: string | null, value?: any): BinaryType;
   ...
   * @see #toString
   */
  static fromString(s: string | null): BinaryType | null;
