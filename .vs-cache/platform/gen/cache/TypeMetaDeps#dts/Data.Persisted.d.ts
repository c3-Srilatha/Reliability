// TypeScript definitions for the C3 type Data.Persisted
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Data.Persisted
 */
 ...
 */
declare namespace Data {
  export class Persisted extends Obj {
    ...
    withSTATELESS_CACHE(STATELESS_CACHE: string | null): Data.Persisted;
     ...
     */
    readonly this: any;
    withThis(this_: any): Data.Persisted;

    /**
     * Target action returning DataImpl
     */
    readonly action: string;
    withAction(action: string): Data.Persisted;

    /**
     * Applied arguments
     */
    readonly args?: C3.Map<string | null, any>;
    withArgs(args: C3.Map<string | null, any> | {[key: string | null]: any}): Data.Persisted;
    ...
    with_inferredOutType(_inferredOutType: C3.Map<string | null, ValueType | null> | {[key: string | null]: IValueType | null}): Data.Persisted;
    ...
    withLOCAL_FOLDER_PREFIX(LOCAL_FOLDER_PREFIX: string | null): Data.Persisted;

    readonly DFLT_TABLE_NAME?: string | null;
    withDFLT_TABLE_NAME(DFLT_TABLE_NAME: string | null): Data.Persisted;

    readonly DFLT_ROW_COUNT?: number | null;
    withDFLT_ROW_COUNT(DFLT_ROW_COUNT: number | null): Data.Persisted;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.Persisted | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.Persisted | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.Persisted | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.Persisted | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.Persisted;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Persisted;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Persisted;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Persisted | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Persisted | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.Persisted;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Persisted;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Persisted;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.Persisted;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.Persisted;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.Persisted;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.Persisted;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.Persisted;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.Persisted;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.Persisted;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.Persisted;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.Persisted;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.Persisted;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.Persisted;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.Persisted;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.Persisted;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.Persisted;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.Persisted;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.Persisted;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.Persisted;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.Persisted;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.Persisted;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.Persisted;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.Persisted;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.Persisted;

    mergeJson(json: any | null): Data.Persisted;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.Persisted;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.Persisted;
     ...
     */
    singletonArray(): C3.Array<Data.Persisted | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.Persisted | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.Persisted | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.Persisted | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.Persisted | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.Persisted | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.Persisted | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.Persisted | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.Persisted | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.Persisted;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.Persisted;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.Persisted;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.Persisted;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.Persisted;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.Persisted;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.Persisted;
     ...
     */
    static cachedEmptyInst(): Data.Persisted;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.Persisted>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.Persisted;
     ...
     */
    static fromPySrc(pySrc: string, dfs?: C3.Set<DataImpl | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): Data.Persisted | null;
     ...
     */
    static _jsDataProxy(inst: any): Data.Persisted;
     ...
     */
    static create(this_: any, action: string, args?: C3.Map<string | null, any>): Data.Persisted;
     ...
     * @return an instance of Data from the provided collection of {@link Obj}s or {@link Tuple}s
     */
    static fromCollection(col: Collection<Obj | null> | null | Collection<Tuple | null> | null, dataset?: Dataset | null, include?: string | null): Data.Persisted | null;
     ...
     * 1       b 2000-01-02    2.0
     */
    static fromTuple(tuple: Tuple, dataset?: Dataset | null): Data.Persisted | null;
