// TypeScript definitions for the C3 type MapReduceQueue

/**
 * Invalidation queue for mapReduce job processing.
 *
 * @see MapReduceQueueEntry
 *
 * @remarks this represents a value passed to a method that expects an instance of MapReduceQueue
 */
declare interface IMapReduceQueue {
}
 ...
 * @see MapReduceQueueEntry
 *
 * @remarks this represents a made instance of MapReduceQueue
 */
declare class MapReduceQueue {
   ...
   */
  static compute(targetType: Type, entries: C3.Array<MapReduceQueueEntry | null> | null): void;
   ...
   */
  static find(spec?: InvalidationQueue.FindSpec | null): C3.Array<MapReduceQueueEntry | null>;
   ...
   * @return the list of requested entries.
   */
  static findStream(spec?: InvalidationQueue.FindStreamSpec | null): Stream<MapReduceQueueEntry | null>;
   ...
   *           Entries to remove.
   */
  static clearEntries(entries: C3.Array<MapReduceQueueEntry | null> | null): void;
