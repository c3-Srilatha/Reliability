// TypeScript definitions for the C3 type MultiLocaleFetchSpec

/**
 * @remarks this represents a value passed to a method that expects an instance of MultiLocaleFetchSpec
 */
declare interface IMultiLocaleFetchSpec {
  ...
  /**
   * In which locales should instances be fetched, null will result in ALL locales
   */
  locales?: C3.Array<MetaLocale | null> | Array<IMetaLocale | null>;
}

/**
 * @remarks this represents a made instance of MultiLocaleFetchSpec
 */
declare class MultiLocaleFetchSpec extends Obj {
  ...
  withOrder(order: string | null): MultiLocaleFetchSpec;

  /**
   * Offset to use for paged reads.
   */
  readonly offset?: number | null;
  withOffset(offset: number | null): MultiLocaleFetchSpec;
  ...
  withLimit(limit: number | null): MultiLocaleFetchSpec;
  ...
  withFilter(filter: string | null): MultiLocaleFetchSpec;

  /**
   * Variables values to substitute in filter expression. CURRENTLY UNDER CONSTRUCTION!
   */
  readonly vars?: C3.Map<string | null, Obj | null>;
  withVars(vars: C3.Map<string | null, Obj | null> | {[key: string | null]: IObj | null}): MultiLocaleFetchSpec;
  ...
  withFetchHiddenSeedData(fetchHiddenSeedData: boolean): MultiLocaleFetchSpec;
  ...
  withExcludeExtensions(excludeExtensions: boolean): MultiLocaleFetchSpec;
  ...
  withAsOf(asOf: DateTime | Date | string | null): MultiLocaleFetchSpec;
  ...
  withAllowLiteralOnBindVariableOverflow(allowLiteralOnBindVariableOverflow: boolean): MultiLocaleFetchSpec;
  ...
  withUseDedicatedConnection(useDedicatedConnection: boolean): MultiLocaleFetchSpec;
  ...
  withStmtTimeoutMs(stmtTimeoutMs: number | null): MultiLocaleFetchSpec;
  ...
  withDontThrowJsonDeserErrors(dontThrowJsonDeserErrors: boolean): MultiLocaleFetchSpec;
  ...
  withTimeRange(timeRange: ITimeRange | null): MultiLocaleFetchSpec;
  ...
  withTimedFetchParentField(timedFetchParentField: string | null): MultiLocaleFetchSpec;

  readonly includeBaseTypes?: boolean;
  withIncludeBaseTypes(includeBaseTypes: boolean): MultiLocaleFetchSpec;
  ...
  withIgnoreViewInclude(ignoreViewInclude: boolean): MultiLocaleFetchSpec;
  ...
  withInclude(include: string | null): MultiLocaleFetchSpec;
  ...
  withExcludeMeta(excludeMeta: boolean): MultiLocaleFetchSpec;
  ...
  withIncludeReadCalcs(includeReadCalcs: boolean): MultiLocaleFetchSpec;
  ...
  withRefreshCalcFields(refreshCalcFields: boolean): MultiLocaleFetchSpec;
  ...
  withCalcFieldsToRefresh(calcFieldsToRefresh: C3.Array<string | null> | Array<string | null>): MultiLocaleFetchSpec;
  ...
  withForceAcl(forceAcl: boolean): MultiLocaleFetchSpec;
  ...
  withExplain(explain: boolean): MultiLocaleFetchSpec;
  ...
  withValidateOnly(validateOnly: boolean): MultiLocaleFetchSpec;
  ...
  withHints(hints: IFetchHints | null): MultiLocaleFetchSpec;
  ...
  withUseSecondaryDatastore(useSecondaryDatastore: boolean): MultiLocaleFetchSpec;
  ...
  withPreserveArrayIndexes(preserveArrayIndexes: boolean): MultiLocaleFetchSpec;
  ...
  withResolveRefTypes(resolveRefTypes: boolean): MultiLocaleFetchSpec;

  /**
   * In which locales should instances be fetched, null will result in ALL locales
   */
  readonly locales?: C3.Array<MetaLocale | null>;
  withLocales(locales: C3.Array<MetaLocale | null> | Array<IMetaLocale | null>): MultiLocaleFetchSpec;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): MultiLocaleFetchSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): MultiLocaleFetchSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): MultiLocaleFetchSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): MultiLocaleFetchSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): MultiLocaleFetchSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MultiLocaleFetchSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MultiLocaleFetchSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MultiLocaleFetchSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MultiLocaleFetchSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): MultiLocaleFetchSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MultiLocaleFetchSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MultiLocaleFetchSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): MultiLocaleFetchSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): MultiLocaleFetchSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): MultiLocaleFetchSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): MultiLocaleFetchSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): MultiLocaleFetchSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): MultiLocaleFetchSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): MultiLocaleFetchSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): MultiLocaleFetchSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): MultiLocaleFetchSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): MultiLocaleFetchSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): MultiLocaleFetchSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): MultiLocaleFetchSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): MultiLocaleFetchSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): MultiLocaleFetchSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): MultiLocaleFetchSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): MultiLocaleFetchSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): MultiLocaleFetchSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): MultiLocaleFetchSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): MultiLocaleFetchSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): MultiLocaleFetchSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): MultiLocaleFetchSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): MultiLocaleFetchSpec;

  mergeJson(json: any | null): MultiLocaleFetchSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): MultiLocaleFetchSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): MultiLocaleFetchSpec;
   ...
   */
  singletonArray(): C3.Array<MultiLocaleFetchSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<MultiLocaleFetchSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<MultiLocaleFetchSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<MultiLocaleFetchSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<MultiLocaleFetchSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, MultiLocaleFetchSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, MultiLocaleFetchSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<MultiLocaleFetchSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<MultiLocaleFetchSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): MultiLocaleFetchSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): MultiLocaleFetchSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): MultiLocaleFetchSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): MultiLocaleFetchSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): MultiLocaleFetchSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): MultiLocaleFetchSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): MultiLocaleFetchSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): MultiLocaleFetchSpec;
   ...
   */
  static cachedEmptyInst(): MultiLocaleFetchSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<MultiLocaleFetchSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): MultiLocaleFetchSpec;
   ...
   */
  withIdFilter(id: string): MultiLocaleFetchSpec | null;
   ...
   * @return updated FetchSpec
   */
  withIdsFilter(ids: C3.Array<string | null> | null): MultiLocaleFetchSpec | null;
   ...
   * @return updated FetchSpec
   */
  withIdRangeFilter(startId?: string | null, endId?: string | null): MultiLocaleFetchSpec | null;
