// TypeScript definitions for the C3 type C3FileSystem

/**
 * Represents a C3 file system (implemented based on local file-system).
 *
 * @remarks this represents a value passed to a method that expects an instance of C3FileSystem
 */
declare interface IC3FileSystem {
 ...
 * Represents a C3 file system (implemented based on local file-system).
 *
 * @remarks this represents a made instance of C3FileSystem
 */
declare class C3FileSystem extends Obj {

  /**
   * Optional root OS folder to limit access to files.
   */
  readonly root?: string | null;
  withRoot(root: string | null): C3FileSystem;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): C3FileSystem | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): C3FileSystem | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): C3FileSystem | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): C3FileSystem | null;
   ...
   */
  replaceType(old: Type, new_: Type): C3FileSystem;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): C3FileSystem;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): C3FileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): C3FileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): C3FileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): C3FileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<C3FileSystem | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<C3FileSystem | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<C3FileSystem | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<C3FileSystem | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): C3FileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): C3FileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): C3FileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): C3FileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): C3FileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): C3FileSystem;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): C3FileSystem;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): C3FileSystem;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): C3FileSystem;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): C3FileSystem;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): C3FileSystem;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): C3FileSystem;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): C3FileSystem;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): C3FileSystem;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): C3FileSystem;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): C3FileSystem;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): C3FileSystem;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): C3FileSystem;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): C3FileSystem;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): C3FileSystem;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): C3FileSystem;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): C3FileSystem;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): C3FileSystem;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): C3FileSystem;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): C3FileSystem;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): C3FileSystem;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): C3FileSystem;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): C3FileSystem;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): C3FileSystem;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): C3FileSystem;
   ...
   * @see #unsetField
   */
  defaultField(field: string): C3FileSystem;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): C3FileSystem;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): C3FileSystem;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): C3FileSystem;
   ...
   * @see #removeField
   */
  unsetField(field: string): C3FileSystem;
   ...
   * @see #removeField
   */
  static unsetField(field: string): C3FileSystem;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): C3FileSystem;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): C3FileSystem;
   ...
   * @see #unsetField
   */
  removeField(field: string): C3FileSystem;
   ...
   * @see #unsetField
   */
  static removeField(field: string): C3FileSystem;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): C3FileSystem;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): C3FileSystem;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): C3FileSystem;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): C3FileSystem;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): C3FileSystem;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): C3FileSystem;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): C3FileSystem;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): C3FileSystem;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): C3FileSystem;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): C3FileSystem;

  mergeJson(json: any | null): C3FileSystem;

  static mergeJson(json: any | null): C3FileSystem;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): C3FileSystem;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): C3FileSystem;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): C3FileSystem;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): C3FileSystem;
   ...
   */
  singletonArray(): C3.Array<C3FileSystem | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<C3FileSystem | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<C3FileSystem | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<C3FileSystem | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<C3FileSystem | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<C3FileSystem | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<C3FileSystem | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, C3FileSystem | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, C3FileSystem | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<C3FileSystem | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<C3FileSystem | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<C3FileSystem | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): C3FileSystem;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): C3FileSystem;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): C3FileSystem;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): C3FileSystem;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): C3FileSystem;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): C3FileSystem;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): C3FileSystem;
   ...
   */
  static cachedEmptyInst(): C3FileSystem;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<C3FileSystem>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): C3FileSystem;

  /**
   * Returns cached configuration object for instance of this file system.
   */
  config(secrets?: boolean): C3FsConfig;

  /**
   * Returns cached configuration object for instance of this file system.
   */
  static config(secrets?: boolean): C3FsConfig;
