// TypeScript definitions for the C3 type DateTimeType

/**
 * The DateTime value type has inner structure (fields):
 *  - precision: seconds / milliseconds / microseconds / nanoseconds
 *  - time zone: arbitrary / force UTC / no time zone
 *  - no time (logical date only)
 *
 * Note that when parsing `datetime` values, excess precision beyond that declared in the value type will be discarded.
 * If sub-second precision is desired for a value, it must be declared that way.
 *
 * Varions methods on **PrimitiveType** produce the most common variants:
 *  - {@link PrimitiveType#ofDateTime ofDateTime}
 *  - {@link PrimitiveType#ofDateOnly ofDateOnly}
 *  - {@link PrimitiveType#ofDateTimeMillis ofDateTimeMillis}
 *  - {@link PrimitiveType#ofDateTimeMicros ofDateTimeMicros}
 *  - {@link PrimitiveType#ofDateTimeNanos ofDateTimeNanos}
 *
 * @remarks this represents a value passed to a method that expects an instance of DateTimeType
 */
declare interface IDateTimeType {
 ...
 *  - {@link PrimitiveType#ofDateTimeNanos ofDateTimeNanos}
 *
 * @remarks this represents a made instance of DateTimeType
 */
declare class DateTimeType extends Obj {

  /**
   * Source file Pkg.Path a C3 Type declaration [.c3typ].
   */
  readonly declaredPkgPath?: string | null;
  withDeclaredPkgPath(declaredPkgPath: string | null): DateTimeType;

  /**
   * Source line number in a C3 Type declaration [.c3typ] file starting with 1 where this metadata element is declared.
   */
  readonly declaredSrcLine?: number | null;
  withDeclaredSrcLine(declaredSrcLine: number | null): DateTimeType;
  ...
  withDeclaredSrcCharInLine(declaredSrcCharInLine: number | null): DateTimeType;
   ...
   */
  readonly pkg: Pkg;
  withPkg(pkg: IPkg): DateTimeType;

  /**
   * SDK json representing instance of this type
   */
  readonly json?: any;
  withJson(json: any): DateTimeType;

  /**
   * The set of annotations defined on this element of metadata represented as json value.
   */
  readonly annotationsJson?: any | null;
  withAnnotationsJson(annotationsJson: any | null): DateTimeType;
  ...
  withModifier(modifier: string | null): DateTimeType;
  ...
  withName(name: string): DateTimeType;
  ...
  withSerializedType(serializedType: IValueType | null): DateTimeType;
  ...
  withEnumRefType(enumRefType: IReferenceType | null): DateTimeType;
  ...
  withDeclaredEnumValues(declaredEnumValues: C3.Array<string | null> | Array<string | null>): DateTimeType;
  ...
  withForceUtc(forceUtc: boolean): DateTimeType;

  /**
   * For datetime fields, ignores any timezone offset information present.
   */
  readonly noTimeZone?: boolean;
  withNoTimeZone(noTimeZone: boolean): DateTimeType;

  /**
   * For datetime values, ignores any time information and persists only the date portion of any input value.
   */
  readonly noTime?: boolean;
  withNoTime(noTime: boolean): DateTimeType;
  ...
  withWithMillis(withMillis: boolean): DateTimeType;
  ...
  withWithMicros(withMicros: boolean): DateTimeType;
  ...
  withWithNanos(withNanos: boolean): DateTimeType;
   ...
   */
  replaceType(old: Type, new_: Type): DateTimeType;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): DateTimeType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): DateTimeType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): DateTimeType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): DateTimeType | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DateTimeType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DateTimeType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DateTimeType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DateTimeType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DateTimeType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DateTimeType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DateTimeType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DateTimeType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DateTimeType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DateTimeType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DateTimeType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DateTimeType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DateTimeType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): DateTimeType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): DateTimeType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): DateTimeType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DateTimeType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DateTimeType;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DateTimeType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DateTimeType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DateTimeType;
   ...
   * @see #removeField
   */
  unsetField(field: string): DateTimeType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DateTimeType;
   ...
   * @see #unsetField
   */
  removeField(field: string): DateTimeType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DateTimeType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DateTimeType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): DateTimeType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DateTimeType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DateTimeType;

  mergeJson(json: any | null): DateTimeType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DateTimeType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): DateTimeType;
   ...
   */
  singletonArray(): C3.Array<DateTimeType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<DateTimeType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DateTimeType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<DateTimeType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DateTimeType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, DateTimeType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DateTimeType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DateTimeType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DateTimeType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DateTimeType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DateTimeType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DateTimeType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DateTimeType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DateTimeType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DateTimeType;
   ...
   * @see #fromString
   */
  static make(s: string | null): DateTimeType | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DateTimeType;
   ...
   */
  static cachedEmptyInst(): DateTimeType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DateTimeType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): DateTimeType;
   ...
   */
  withoutDeclaredSrcPos(recursive?: boolean): DateTimeType;
   ...
   */
  withAnnotation(ann: Annotation): DateTimeType;
   ...
   *         value for the field
   */
  withAnnotation(ann: string, annField?: string | null, value?: any): DateTimeType;
   ...
   * @see #toString
   */
  static fromString(s: string | null): DateTimeType | null;
