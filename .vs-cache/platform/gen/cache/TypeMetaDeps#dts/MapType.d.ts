// TypeScript definitions for the C3 type MapType
 ...
 * @see Map
 *
 * @remarks this represents a value passed to a method that expects an instance of MapType
 */
declare interface IMapType {
 ...
 */
declare class MapType extends Obj {

  /**
   * Source file Pkg.Path a C3 Type declaration [.c3typ].
   */
  readonly declaredPkgPath?: string | null;
  withDeclaredPkgPath(declaredPkgPath: string | null): MapType;

  /**
   * Source line number in a C3 Type declaration [.c3typ] file starting with 1 where this metadata element is declared.
   */
  readonly declaredSrcLine?: number | null;
  withDeclaredSrcLine(declaredSrcLine: number | null): MapType;
  ...
  withDeclaredSrcCharInLine(declaredSrcCharInLine: number | null): MapType;
   ...
   */
  readonly pkg: Pkg;
  withPkg(pkg: IPkg): MapType;

  /**
   * SDK json representing instance of this type
   */
  readonly json?: any;
  withJson(json: any): MapType;

  /**
   * The set of annotations defined on this element of metadata represented as json value.
   */
  readonly annotationsJson?: any | null;
  withAnnotationsJson(annotationsJson: any | null): MapType;
  ...
  withModifier(modifier: string | null): MapType;
   ...
   * For maps, the key can be any primitive type.
   */
  readonly keyType?: ValueType | null;
  withKeyType(keyType: IValueType | null): MapType;

  /**
   * The value type for the elements of the collection.
   */
  readonly elementType: ValueType;
  withElementType(elementType: IValueType): MapType;
   ...
   */
  replaceType(old: Type, new_: Type): MapType;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): MapType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): MapType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): MapType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): MapType | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MapType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MapType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MapType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MapType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): MapType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MapType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MapType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): MapType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): MapType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): MapType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): MapType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): MapType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): MapType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): MapType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): MapType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): MapType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): MapType;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): MapType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): MapType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): MapType;
   ...
   * @see #removeField
   */
  unsetField(field: string): MapType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): MapType;
   ...
   * @see #unsetField
   */
  removeField(field: string): MapType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): MapType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): MapType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): MapType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): MapType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): MapType;

  mergeJson(json: any | null): MapType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): MapType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): MapType;
   ...
   */
  singletonArray(): C3.Array<MapType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<MapType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<MapType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<MapType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<MapType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, MapType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, MapType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<MapType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<MapType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): MapType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): MapType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): MapType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): MapType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): MapType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): MapType;
   ...
   * @see #fromString
   */
  static make(s: string | null): MapType | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): MapType;
   ...
   */
  static cachedEmptyInst(): MapType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<MapType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): MapType;
   ...
   */
  withoutDeclaredSrcPos(recursive?: boolean): MapType;
   ...
   */
  withAnnotation(ann: Annotation): MapType;
   ...
   *         value for the field
   */
  withAnnotation(ann: string, annField?: string | null, value?: any): MapType;
   ...
   * @see #toString
   */
  static fromString(s: string | null): MapType | null;
   ...
   */
  static guessType(value: any, failIfNone?: boolean): CollectionType | null;
   ...
   */
  static guessTypeFromJavaClass(value: any, failIfNone?: boolean): CollectionType | null;

  /**
   * Guess the corresponding C3 CollectionType from Python class
   */
  static guessTypeFromPythonClass(value: any, failIfNone?: boolean): CollectionType | null;
   ...
   * @return the factory method name for this map type (e.g., "ofStrToInt", "ofIntToStr").
   */
  factoryMethodName(instanceType: boolean | null): string;
   ...
   * @return a code expression that instantiates this collection type (e.g., "MapType.ofStrToStr()", "Map.ofIntToAny()").
   */
  factoryMethodExpr(instanceType: boolean | null): string;
   ...
   */
  toArrayType(elementType: ValueType): ArrayType;
   ...
   */
  toSetType(elementType: ValueType): SetType;
