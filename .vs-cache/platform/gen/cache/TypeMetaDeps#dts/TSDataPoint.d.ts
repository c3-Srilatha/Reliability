// TypeScript definitions for the C3 type TSDataPoint

/**
 * Type to hold time series data points
 *
 * @remarks this represents a value passed to a method that expects an instance of TSDataPoint
 */
declare interface ITSDataPoint {
 ...
 * Type to hold time series data points
 *
 * @remarks this represents a made instance of TSDataPoint
 */
declare class TSDataPoint extends Obj {

  /**
   * start date for the data point
   */
  readonly start: DateTime;
  withStart(start: DateTime | Date | string): TSDataPoint;
  ...
  withOutlierCode(outlierCode: number | null): TSDataPoint;

  /**
   * (Optional) any comments for the data point
   */
  readonly comments?: string | null;
  withComments(comments: string | null): TSDataPoint;

  /**
   * Denotes if the value is an actual value or an estimated value. default = null (actual value)
   */
  readonly isEstimated?: boolean;
  withIsEstimated(isEstimated: boolean): TSDataPoint;
  ...
  withDataVersion(dataVersion: number | null): TSDataPoint;

  /**
   * Customer specific status code for the data point (may be used to denote data quality)
   */
  readonly statusCode?: string | null;
  withStatusCode(statusCode: string | null): TSDataPoint;

  /**
   * end date for the data point (Only applicable for Interval Timeseries)
   */
  readonly end: DateTime;
  withEnd(end: DateTime | Date | string): TSDataPoint;

  /**
   * Partition key Bin separator used to separate partition key from bin id
   */
  readonly PK_BIN_SEPARATOR?: string | null;
  withPK_BIN_SEPARATOR(PK_BIN_SEPARATOR: string | null): TSDataPoint;

  readonly parent: Obj;
  withParent(parent: IObj): TSDataPoint;

  /**
   * value for the data point
   */
  readonly value?: number | null;
  withValue(value: number | null): TSDataPoint;

  /**
   * unit of the data point
   */
  readonly unit?: Unit | null;
  withUnit(unit: IUnit | null): TSDataPoint;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TSDataPoint | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TSDataPoint | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TSDataPoint | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TSDataPoint | null;
   ...
   */
  replaceType(old: Type, new_: Type): TSDataPoint;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TSDataPoint;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TSDataPoint;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TSDataPoint | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TSDataPoint | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TSDataPoint;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TSDataPoint;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TSDataPoint;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TSDataPoint;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TSDataPoint;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TSDataPoint;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TSDataPoint;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TSDataPoint;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TSDataPoint;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TSDataPoint;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TSDataPoint;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TSDataPoint;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TSDataPoint;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TSDataPoint;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TSDataPoint;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TSDataPoint;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TSDataPoint;
   ...
   * @see #removeField
   */
  unsetField(field: string): TSDataPoint;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TSDataPoint;
   ...
   * @see #unsetField
   */
  removeField(field: string): TSDataPoint;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TSDataPoint;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TSDataPoint;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TSDataPoint;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TSDataPoint;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TSDataPoint;

  mergeJson(json: any | null): TSDataPoint;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TSDataPoint;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TSDataPoint;
   ...
   */
  singletonArray(): C3.Array<TSDataPoint | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TSDataPoint | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TSDataPoint | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TSDataPoint | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TSDataPoint | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TSDataPoint | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TSDataPoint | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TSDataPoint | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TSDataPoint | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TSDataPoint;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TSDataPoint;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TSDataPoint;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TSDataPoint;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TSDataPoint;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TSDataPoint;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TSDataPoint;
   ...
   */
  static cachedEmptyInst(): TSDataPoint;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TSDataPoint>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TSDataPoint;

  /**
   * Extract the partition key from the given obj
   */
  partitionKey(failIfMissing?: boolean): Obj | null;
   ...
   */
  static partition(objs?: Stream<TSDataPoint | null>, spec?: PartitionBucketStrategy | null): C3.Map<string | null, KvDataPartition | null>;
   ...
   */
  static fromPartitions(partitions?: Stream<KvDataPartition | null>): Stream<TSDataPoint | null>;
