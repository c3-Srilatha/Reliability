// TypeScript definitions for the C3 type DataPartitionBucket

/**
 * Holds information about a specific bucket within a given partition for a {@link Partitionable} type
 *
 * @remarks this represents a value passed to a method that expects an instance of DataPartitionBucket
 */
declare interface IDataPartitionBucket {
 ...
 * Holds information about a specific bucket within a given partition for a {@link Partitionable} type
 *
 * @remarks this represents a made instance of DataPartitionBucket
 */
declare class DataPartitionBucket extends Obj {
  ...
  withId(id: string | null): DataPartitionBucket;
  ...
  withContentEncoding(contentEncoding: string | null): DataPartitionBucket;
  ...
  withContentLanguage(contentLanguage: string | null): DataPartitionBucket;
  ...
  withContentLength(contentLength: number | null): DataPartitionBucket;
  ...
  withContentLocation(contentLocation: string | null): DataPartitionBucket;
  ...
  withContentType(contentType: string | null): DataPartitionBucket;
  ...
  withContentDisposition(contentDisposition: string | null): DataPartitionBucket;
  ...
  withETag(eTag: string | null): DataPartitionBucket;
  ...
  withLastModified(lastModified: DateTime | Date | string | null): DataPartitionBucket;

  /**
   * Id of user / identity who last last modified this content.
   */
  readonly lastModifiedBy?: string | null;
  withLastModifiedBy(lastModifiedBy: string | null): DataPartitionBucket;
  ...
  withContentMD5(contentMD5: string | null): DataPartitionBucket;
  ...
  withContentSHA1(contentSHA1: string | null): DataPartitionBucket;

  /**
   * Partition key for this partition
   */
  readonly partitionKey: string;
  withPartitionKey(partitionKey: string): DataPartitionBucket;
  ...
  withSerType(serType: IType | null): DataPartitionBucket;
  ...
  withMinSortKey(minSortKey: C3.Array<any> | Array<any>): DataPartitionBucket;
  ...
  withMaxSortKey(maxSortKey: C3.Array<any> | Array<any>): DataPartitionBucket;

  /**
   * Count of objs in this partition
   */
  readonly count: number;
  withCount(count: number): DataPartitionBucket;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): DataPartitionBucket | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): DataPartitionBucket | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): DataPartitionBucket | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): DataPartitionBucket | null;
   ...
   */
  replaceType(old: Type, new_: Type): DataPartitionBucket;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataPartitionBucket;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataPartitionBucket;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataPartitionBucket | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataPartitionBucket | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataPartitionBucket;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataPartitionBucket;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataPartitionBucket;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DataPartitionBucket;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DataPartitionBucket;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DataPartitionBucket;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataPartitionBucket;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataPartitionBucket;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DataPartitionBucket;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): DataPartitionBucket;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): DataPartitionBucket;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): DataPartitionBucket;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataPartitionBucket;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DataPartitionBucket;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataPartitionBucket;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DataPartitionBucket;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DataPartitionBucket;
   ...
   * @see #removeField
   */
  unsetField(field: string): DataPartitionBucket;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DataPartitionBucket;
   ...
   * @see #unsetField
   */
  removeField(field: string): DataPartitionBucket;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DataPartitionBucket;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataPartitionBucket;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): DataPartitionBucket;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataPartitionBucket;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataPartitionBucket;

  mergeJson(json: any | null): DataPartitionBucket;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataPartitionBucket;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): DataPartitionBucket;
   ...
   */
  singletonArray(): C3.Array<DataPartitionBucket | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<DataPartitionBucket | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DataPartitionBucket | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<DataPartitionBucket | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DataPartitionBucket | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, DataPartitionBucket | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataPartitionBucket | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DataPartitionBucket | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DataPartitionBucket | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DataPartitionBucket;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DataPartitionBucket;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DataPartitionBucket;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DataPartitionBucket;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DataPartitionBucket;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DataPartitionBucket;
   ...
   * @see #fromString
   */
  static make(s: string | null): DataPartitionBucket | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DataPartitionBucket;
   ...
   */
  static cachedEmptyInst(): DataPartitionBucket;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DataPartitionBucket>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): DataPartitionBucket;
   ...
   * @see #toString
   */
  static fromString(s: string | null): DataPartitionBucket | null;
   ...
   */
  withFileName(fileName: string | null): DataPartitionBucket;

  /**
   * Changes file extension in this instance.
   */
  withFileExt(fileExt: string | null): DataPartitionBucket;
   ...
   */
  identify(suffix?: string | null): DataPartitionBucket;
