// TypeScript definitions for the C3 type FactPopulationLog

/**
 * @remarks this represents a value passed to a method that expects an instance of FactPopulationLog
 */
declare interface IFactPopulationLog {
  ...
  /**
   * timestamp of last fact population
   */
  timestamp?: DateTime | Date | string | null;
}

/**
 * @remarks this represents a made instance of FactPopulationLog
 */
declare class FactPopulationLog extends Obj {
   ...
   */
  readonly id: string;
  withId(id: string): FactPopulationLog;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): FactPopulationLog;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): FactPopulationLog;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): FactPopulationLog;
  ...
  withVersion(version: number | null): FactPopulationLog;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): FactPopulationLog;

  /**
   * timestamp of last fact population
   */
  readonly timestamp?: DateTime | null;
  withTimestamp(timestamp: DateTime | Date | string | null): FactPopulationLog;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): FactPopulationLog | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): FactPopulationLog | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): FactPopulationLog | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): FactPopulationLog | null;
   ...
   */
  replaceType(old: Type, new_: Type): FactPopulationLog;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FactPopulationLog;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FactPopulationLog;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FactPopulationLog | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FactPopulationLog | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): FactPopulationLog;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FactPopulationLog;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FactPopulationLog;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FactPopulationLog;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FactPopulationLog;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FactPopulationLog;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): FactPopulationLog;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FactPopulationLog;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FactPopulationLog;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): FactPopulationLog;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): FactPopulationLog;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): FactPopulationLog;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): FactPopulationLog;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FactPopulationLog;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): FactPopulationLog;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FactPopulationLog;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FactPopulationLog;
   ...
   * @see #removeField
   */
  unsetField(field: string): FactPopulationLog;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FactPopulationLog;
   ...
   * @see #unsetField
   */
  removeField(field: string): FactPopulationLog;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FactPopulationLog;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): FactPopulationLog;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): FactPopulationLog;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): FactPopulationLog;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): FactPopulationLog;

  mergeJson(json: any | null): FactPopulationLog;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): FactPopulationLog;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): FactPopulationLog;
   ...
   */
  singletonArray(): C3.Array<FactPopulationLog | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<FactPopulationLog | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FactPopulationLog | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<FactPopulationLog | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FactPopulationLog | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, FactPopulationLog | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FactPopulationLog | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FactPopulationLog | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FactPopulationLog | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): FactPopulationLog;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): FactPopulationLog;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): FactPopulationLog;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FactPopulationLog;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): FactPopulationLog;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FactPopulationLog;
   ...
   * @see #fromString
   */
  static make(s: string | null): FactPopulationLog | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): FactPopulationLog;
   ...
   */
  static cachedEmptyInst(): FactPopulationLog;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<FactPopulationLog>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): FactPopulationLog;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<FactPopulationLog | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<FactPopulationLog | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<FactPopulationLog | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<FactPopulationLog | null> | null>;
   ...
   */
  get(include?: string | null): FactPopulationLog | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): FactPopulationLog | null;
   ...
   */
  getMissing(spec: GetMissingSpec): FactPopulationLog;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): FactPopulationLog | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): FactPopulationLog;
   ...
   * @see #toString
   */
  static fromString(s: string | null): FactPopulationLog | null;
   ...
   */
  create(spec?: UpsertSpec | null): FactPopulationLog | null;
   ...
   */
  static createBatch(objs: C3.Array<FactPopulationLog | null> | null, spec?: UpsertSpec | null): ObjList<FactPopulationLog | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<FactPopulationLog | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<FactPopulationLog | null> | null;
   ...
   */
  update(srcObj?: FactPopulationLog | null, spec?: UpsertSpec | null): FactPopulationLog | null;
   ...
   */
  upsert(srcObj?: FactPopulationLog | null, spec?: UpsertSpec | null): FactPopulationLog | null;
   ...
   */
  merge(spec?: MergeSpec | null): FactPopulationLog | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): FactPopulationLog | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): FactPopulationLog | null;
   ...
   */
  static updateBatch(objs: C3.Array<FactPopulationLog | null> | null, srcObjs?: C3.Array<FactPopulationLog | null>, spec?: UpsertSpec | null): ObjList<FactPopulationLog | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<FactPopulationLog | null>>, spec?: UpsertSpec | null): ObjList<FactPopulationLog | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<FactPopulationLog | null> | null, srcObjs?: C3.Array<FactPopulationLog | null>, spec?: UpsertSpec | null): ObjList<FactPopulationLog | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<FactPopulationLog | null>>, spec?: UpsertSpec | null): ObjList<FactPopulationLog | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<FactPopulationLog | null> | null, spec?: TouchSpec | null): ObjList<FactPopulationLog | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<FactPopulationLog | null> | null, spec?: MergeSpec | null): ObjList<FactPopulationLog | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<FactPopulationLog | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<FactPopulationLog | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<FactPopulationLog | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<FactPopulationLog | null> | null;
   ...
   */
  static mergeAll(mergeObj: FactPopulationLog | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: FactPopulationLog | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<FactPopulationLog | null> | null, spec?: UpsertSpec | null): ObjList<FactPopulationLog | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<FactPopulationLog | null> | null, spec?: UpsertSpec | null): ObjList<FactPopulationLog | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): FactPopulationLog | null;
   ...
   */
  static beforeCreate(objs: C3.Array<FactPopulationLog | null> | null): ObjList<FactPopulationLog | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<FactPopulationLog | null> | null): ObjList<FactPopulationLog | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<FactPopulationLog | null> | null): ObjList<FactPopulationLog | null>;
   ...
   */
  static afterCreate(objs: C3.Array<FactPopulationLog | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<FactPopulationLog | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<FactPopulationLog | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<FactPopulationLog | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<FactPopulationLog | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): FactPopulationLog | null;
   ...
   */
  withoutIdentity(): FactPopulationLog | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<FactPopulationLog | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: FactPopulationLog | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<FactPopulationLog | null> | null, callback?: λFunction<FactPopulationLog | null, FactPopulationLog | null> | null): ObjList<FactPopulationLog | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<FactPopulationLog | null> | null, callback?: λFunction<FactPopulationLog | null, FactPopulationLog | null> | null): C3.Array<ObjError | null>;
