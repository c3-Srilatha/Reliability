// TypeScript definitions for the C3 type MLDataSourceSpec
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of MLDataSourceSpec
 */
declare interface IMLDataSourceSpec<DI> {
 ...
 * to the data type produced by the spec.
 *
 * @remarks this represents a made instance of MLDataSourceSpec
 */
declare class MLDataSourceSpec<DI> extends Obj {
  ...
  withTypeIdent(typeIdent: string | null): MLDataSourceSpec;
   ...
   */
  readonly id: string;
  withId(id: string): MLDataSourceSpec;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): MLDataSourceSpec;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): MLDataSourceSpec;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): MLDataSourceSpec;
  ...
  withVersion(version: number | null): MLDataSourceSpec;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): MLDataSourceSpec;

  /**
   * The source type for this spec (e.g. the type on which `evalMetrics` will be called).
   */
  readonly srcType: Type;
  withSrcType(srcType: IType): MLDataSourceSpec;
  ...
  withDataTimestamp(dataTimestamp: DateTime | Date | string | null): MLDataSourceSpec;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): MLDataSourceSpec<DI> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): MLDataSourceSpec<DI> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): MLDataSourceSpec<DI> | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): MLDataSourceSpec<DI> | null;
   ...
   */
  replaceType(old: Type, new_: Type): MLDataSourceSpec<DI>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MLDataSourceSpec<DI>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MLDataSourceSpec<DI>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MLDataSourceSpec<DI> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MLDataSourceSpec<DI> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): MLDataSourceSpec<DI>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MLDataSourceSpec<DI>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MLDataSourceSpec<DI>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): MLDataSourceSpec<DI>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): MLDataSourceSpec<DI>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): MLDataSourceSpec<DI>;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): MLDataSourceSpec<DI>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): MLDataSourceSpec<DI>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): MLDataSourceSpec<DI>;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): MLDataSourceSpec<DI>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): MLDataSourceSpec<DI>;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): MLDataSourceSpec<DI>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): MLDataSourceSpec<DI>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): MLDataSourceSpec<DI>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): MLDataSourceSpec<DI>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): MLDataSourceSpec<DI>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): MLDataSourceSpec<DI>;
   ...
   * @see #removeField
   */
  unsetField(field: string): MLDataSourceSpec<DI>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): MLDataSourceSpec<DI>;
   ...
   * @see #unsetField
   */
  removeField(field: string): MLDataSourceSpec<DI>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): MLDataSourceSpec<DI>;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): MLDataSourceSpec<DI>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): MLDataSourceSpec<DI>;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): MLDataSourceSpec<DI>;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): MLDataSourceSpec<DI>;

  mergeJson(json: any | null): MLDataSourceSpec<DI>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): MLDataSourceSpec<DI>;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): MLDataSourceSpec<DI>;
   ...
   */
  singletonArray(): C3.Array<MLDataSourceSpec<DI> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<MLDataSourceSpec<DI> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<MLDataSourceSpec<DI> | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<MLDataSourceSpec<DI> | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<MLDataSourceSpec<DI> | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, MLDataSourceSpec<DI> | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, MLDataSourceSpec<DI> | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<MLDataSourceSpec<DI> | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<MLDataSourceSpec<DI> | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): MLDataSourceSpec<DI>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): MLDataSourceSpec<DI>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): MLDataSourceSpec<DI>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): MLDataSourceSpec<DI>;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): MLDataSourceSpec<DI>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): MLDataSourceSpec<DI>;
   ...
   * @see #fromString
   */
  static make(s: string | null): MLDataSourceSpec<DI> | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): MLDataSourceSpec<DI>;
   ...
   */
  static cachedEmptyInst(): MLDataSourceSpec<DI>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<MLDataSourceSpec<DI>>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): MLDataSourceSpec<DI>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<MLDataSourceSpec<DI> | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<MLDataSourceSpec<DI> | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<MLDataSourceSpec<DI> | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<MLDataSourceSpec<DI> | null> | null>;
   ...
   */
  get(include?: string | null): MLDataSourceSpec<DI> | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): MLDataSourceSpec<DI> | null;
   ...
   */
  getMissing(spec: GetMissingSpec): MLDataSourceSpec<DI>;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): MLDataSourceSpec<DI> | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): MLDataSourceSpec<DI>;
   ...
   * @see #toString
   */
  static fromString(s: string | null): MLDataSourceSpec<DI> | null;
   ...
   */
  create(spec?: UpsertSpec | null): MLDataSourceSpec<DI> | null;
   ...
   */
  static createBatch(objs: C3.Array<MLDataSourceSpec<DI> | null> | null, spec?: UpsertSpec | null): ObjList<MLDataSourceSpec<DI> | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<MLDataSourceSpec<DI> | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<MLDataSourceSpec<DI> | null> | null;
   ...
   */
  update(srcObj?: MLDataSourceSpec<DI> | null, spec?: UpsertSpec | null): MLDataSourceSpec<DI> | null;
   ...
   */
  upsert(srcObj?: MLDataSourceSpec<DI> | null, spec?: UpsertSpec | null): MLDataSourceSpec<DI> | null;
   ...
   */
  merge(spec?: MergeSpec | null): MLDataSourceSpec<DI> | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): MLDataSourceSpec<DI> | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): MLDataSourceSpec<DI> | null;
   ...
   */
  static updateBatch(objs: C3.Array<MLDataSourceSpec<DI> | null> | null, srcObjs?: C3.Array<MLDataSourceSpec<DI> | null>, spec?: UpsertSpec | null): ObjList<MLDataSourceSpec<DI> | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<MLDataSourceSpec<DI> | null>>, spec?: UpsertSpec | null): ObjList<MLDataSourceSpec<DI> | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<MLDataSourceSpec<DI> | null> | null, srcObjs?: C3.Array<MLDataSourceSpec<DI> | null>, spec?: UpsertSpec | null): ObjList<MLDataSourceSpec<DI> | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<MLDataSourceSpec<DI> | null>>, spec?: UpsertSpec | null): ObjList<MLDataSourceSpec<DI> | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<MLDataSourceSpec<DI> | null> | null, spec?: TouchSpec | null): ObjList<MLDataSourceSpec<DI> | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<MLDataSourceSpec<DI> | null> | null, spec?: MergeSpec | null): ObjList<MLDataSourceSpec<DI> | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<MLDataSourceSpec<DI> | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<MLDataSourceSpec<DI> | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<MLDataSourceSpec<DI> | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<MLDataSourceSpec<DI> | null> | null;
   ...
   */
  static mergeAll(mergeObj: MLDataSourceSpec<DI> | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: MLDataSourceSpec<DI> | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<MLDataSourceSpec<DI> | null> | null, spec?: UpsertSpec | null): ObjList<MLDataSourceSpec<DI> | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<MLDataSourceSpec<DI> | null> | null, spec?: UpsertSpec | null): ObjList<MLDataSourceSpec<DI> | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): MLDataSourceSpec<DI> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<MLDataSourceSpec<DI> | null> | null): ObjList<MLDataSourceSpec<DI> | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<MLDataSourceSpec<DI> | null> | null): ObjList<MLDataSourceSpec<DI> | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<MLDataSourceSpec<DI> | null> | null): ObjList<MLDataSourceSpec<DI> | null>;
   ...
   */
  static afterCreate(objs: C3.Array<MLDataSourceSpec<DI> | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<MLDataSourceSpec<DI> | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<MLDataSourceSpec<DI> | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<MLDataSourceSpec<DI> | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<MLDataSourceSpec<DI> | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): MLDataSourceSpec<DI> | null;
   ...
   */
  withoutIdentity(): MLDataSourceSpec<DI> | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<MLDataSourceSpec<DI> | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: MLDataSourceSpec<DI> | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<MLDataSourceSpec<DI> | null> | null, callback?: λFunction<MLDataSourceSpec<DI> | null, MLDataSourceSpec<DI> | null> | null): ObjList<MLDataSourceSpec<DI> | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<MLDataSourceSpec<DI> | null> | null, callback?: λFunction<MLDataSourceSpec<DI> | null, MLDataSourceSpec<DI> | null> | null): C3.Array<ObjError | null>;
