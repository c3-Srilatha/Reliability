// TypeScript definitions for the C3 type FileObjDigestSpec

/**
 * Specification for what statistics are calculated on a {@see Digest} data structure from files
 *
 * @remarks this represents a value passed to a method that expects an instance of FileObjDigestSpec
 */
declare interface IFileObjDigestSpec {
 ...
 * Specification for what statistics are calculated on a {@see Digest} data structure from files
 *
 * @remarks this represents a made instance of FileObjDigestSpec
 */
declare class FileObjDigestSpec extends Obj {

  /**
   * Data serialization type. If not provided type will be inferred from source data
   */
  readonly serValueType?: ValueType | null;
  withSerValueType(serValueType: IValueType | null): FileObjDigestSpec;

  /**
   * Content Type of the source data
   */
  readonly contentType?: string | null;
  withContentType(contentType: string | null): FileObjDigestSpec;

  /**
   * Compression / Content Encoding of this data
   */
  readonly contentEncoding?: string | null;
  withContentEncoding(contentEncoding: string | null): FileObjDigestSpec;

  /**
   * Batch size to use during serialization if batch writing is used (Arrow format uses batching).
   */
  readonly batchSize?: number | null;
  withBatchSize(batchSize: number | null): FileObjDigestSpec;
  ...
  withNoCsvHeader(noCsvHeader: boolean): FileObjDigestSpec;
  ...
  withCsvHeader(csvHeader: string | null): FileObjDigestSpec;

  /**
   * Optional format for a csv values. Key should be field path used in a csv header.
   */
  readonly csvFormat?: C3.Map<string | null, Format | null>;
  withCsvFormat(csvFormat: C3.Map<string | null, Format | null> | {[key: string | null]: IFormat | null}): FileObjDigestSpec;

  /**
   * Default csv delimiter for target type. Used for text/csv files. Leave this field as null for all other content types.
   */
  readonly defaultCsvDelimiter?: string | null;
  withDefaultCsvDelimiter(defaultCsvDelimiter: string | null): FileObjDigestSpec;

  /**
   * Default escape character for target type. Used for text/csv files. Leave this field as null for all other content types.
   */
  readonly defaultCsvEscapeChar?: string | null;
  withDefaultCsvEscapeChar(defaultCsvEscapeChar: string | null): FileObjDigestSpec;

  /**
   * Default quote character for target type. Used for text/csv files. Leave this field as null for all other content types.
   */
  readonly defaultCsvQuoteChar?: string | null;
  withDefaultCsvQuoteChar(defaultCsvQuoteChar: string | null): FileObjDigestSpec;
  ...
  withAvroSchema(avroSchema: string | null): FileObjDigestSpec;
  ...
  withIsObjList(isObjList: boolean): FileObjDigestSpec;

  /**
   * Optionally skip extra fields in serialized content instead of failing to serialize.
   */
  readonly skipExtraFields?: boolean;
  withSkipExtraFields(skipExtraFields: boolean): FileObjDigestSpec;

  /**
   * If true will silently ignore bad syntax in the content and will return no or partial results.
   */
  readonly ignoreBadContent?: boolean;
  withIgnoreBadContent(ignoreBadContent: boolean): FileObjDigestSpec;
  ...
  withMergeXmlNonAdjacentLists(mergeXmlNonAdjacentLists: boolean): FileObjDigestSpec;

  /**
   * Specifies various parameters for automatic retry that occurs in upsert due to retryable errors.
   */
  readonly retrySpec?: RetrySpec | null;
  withRetrySpec(retrySpec: IRetrySpec | null): FileObjDigestSpec;

  /**
   * If set, stream will be instantiated again on retryable errors and execution will continue from the point of failure
   */
  readonly restartStreamOnRetry?: boolean;
  withRestartStreamOnRetry(restartStreamOnRetry: boolean): FileObjDigestSpec;

  /**
   * The index of the first object from a stream that needs to be read.
   */
  readonly offset?: number | null;
  withOffset(offset: number | null): FileObjDigestSpec;
  ...
  withLimit(limit: number | null): FileObjDigestSpec;
  ...
  withValidateContentType(validateContentType: boolean): FileObjDigestSpec;
  ...
  withPeekForMetadata(peekForMetadata: boolean): FileObjDigestSpec;
  ...
  withFailIfMissing(failIfMissing: boolean): FileObjDigestSpec;
  ...
  withSkipIfUnauthorized(skipIfUnauthorized: boolean): FileObjDigestSpec;

  /**
   * If set and if requested file or directory url is under this path then will retrieve content from cache.
   */
  readonly cacheUrlOrEncodedPath?: string | null;
  withCacheUrlOrEncodedPath(cacheUrlOrEncodedPath: string | null): FileObjDigestSpec;

  /**
   * Time in seconds that the cached file should live (default 24 hours).
   */
  readonly cacheTtlSec?: number | null;
  withCacheTtlSec(cacheTtlSec: number | null): FileObjDigestSpec;
  ...
  withForceMultiPart(forceMultiPart: boolean): FileObjDigestSpec;
  ...
  withDisableMultiPart(disableMultiPart: boolean): FileObjDigestSpec;

  /**
   * Overrides default maximum file size before MultipartUpload kicks in. Default is 1GB
   */
  readonly maximumSingleUploadsize?: number | null;
  withMaximumSingleUploadsize(maximumSingleUploadsize: number | null): FileObjDigestSpec;
  ...
  withMaxThreads(maxThreads: number | null): FileObjDigestSpec;
  ...
  withMinThreads(minThreads: number | null): FileObjDigestSpec;

  /**
   * If set to true, it will retry reading file when the file is not found.
   */
  readonly retryOnNotFound?: boolean;
  withRetryOnNotFound(retryOnNotFound: boolean): FileObjDigestSpec;
  ...
  withLockOnWrite(lockOnWrite: boolean): FileObjDigestSpec;

  /**
   * If set will use IoExecutor service.
   */
  readonly useIoExecutor?: boolean;
  withUseIoExecutor(useIoExecutor: boolean): FileObjDigestSpec;

  /**
   * If not null, retry logic will be used from CloudClient rather than File
   */
  readonly cloudClient?: any;
  withCloudClient(cloudClient: any): FileObjDigestSpec;
  ...
  withSerType(serType: IType | null): FileObjDigestSpec;

  /**
   * If true then will not use parent folder of content for target type guess.
   */
  readonly doNotUseParentDirForSerType?: boolean;
  withDoNotUseParentDirForSerType(doNotUseParentDirForSerType: boolean): FileObjDigestSpec;
  ...
  withUseBinaryEncodingDecoding(useBinaryEncodingDecoding: boolean): FileObjDigestSpec;

  /**
   * Optionally indicating if serialized form should contain C3 type.
   */
  readonly shouldNotWriteType?: boolean;
  withShouldNotWriteType(shouldNotWriteType: boolean): FileObjDigestSpec;

  /**
   * Optionally indicating if serialized form should be formatted for ease of reading.
   */
  readonly shouldWritePretty?: boolean;
  withShouldWritePretty(shouldWritePretty: boolean): FileObjDigestSpec;
  ...
  withGuessMetadata(guessMetadata: boolean): FileObjDigestSpec;

  /**
   * If true, checksum files will be generated when writing files
   */
  readonly createChecksum?: boolean;
  withCreateChecksum(createChecksum: boolean): FileObjDigestSpec;

  /**
   * Whether to decrypt content during read
   */
  readonly decrypt?: boolean;
  withDecrypt(decrypt: boolean): FileObjDigestSpec;

  /**
   * disable the creation of a {@link CountMinSketch} data structure for computing the most frequent elements
   */
  readonly disableApproxMostFrequent?: boolean;
  withDisableApproxMostFrequent(disableApproxMostFrequent: boolean): FileObjDigestSpec;

  /**
   * disable the creation of a {@link HyperLogLog} data structure for computing the approximate unique count
   */
  readonly disableApproxUniqueCount?: boolean;
  withDisableApproxUniqueCount(disableApproxUniqueCount: boolean): FileObjDigestSpec;
  ...
  withDisableHistogram(disableHistogram: boolean): FileObjDigestSpec;
  ...
  withEnableMinHash(enableMinHash: boolean): FileObjDigestSpec;
  ...
  withBuildAny(buildAny: boolean): FileObjDigestSpec;
  ...
  withParseFields(parseFields: boolean): FileObjDigestSpec;

  /**
   * Specifies which fields of the Obj instances to run digests on
   */
  readonly include?: string | null;
  withInclude(include: string | null): FileObjDigestSpec;
  ...
  withPercentiles(percentiles: C3.Array<number | null> | Array<number | null>): FileObjDigestSpec;
  ...
  withQuantiles(quantiles: C3.Array<number | null> | Array<number | null>): FileObjDigestSpec;

  /**
   * Filter expression for which Obj instances to collect digests on.
   */
  readonly filter?: string | null;
  withFilter(filter: string | null): FileObjDigestSpec;
  ...
  withGuessValueTypeLimit(guessValueTypeLimit: number | null): FileObjDigestSpec;
  ...
  withValueSpec(valueSpec: IValueSpec | null): FileObjDigestSpec;

  /**
   * @see CountMinSketchSpec
   */
  readonly countMinSketchSpec?: CountMinSketchSpec | null;
  withCountMinSketchSpec(countMinSketchSpec: ICountMinSketchSpec | null): FileObjDigestSpec;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): FileObjDigestSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): FileObjDigestSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): FileObjDigestSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): FileObjDigestSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): FileObjDigestSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FileObjDigestSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FileObjDigestSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FileObjDigestSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FileObjDigestSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): FileObjDigestSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FileObjDigestSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FileObjDigestSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FileObjDigestSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FileObjDigestSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FileObjDigestSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): FileObjDigestSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FileObjDigestSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FileObjDigestSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): FileObjDigestSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): FileObjDigestSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): FileObjDigestSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): FileObjDigestSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FileObjDigestSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): FileObjDigestSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FileObjDigestSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FileObjDigestSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): FileObjDigestSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FileObjDigestSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): FileObjDigestSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FileObjDigestSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): FileObjDigestSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): FileObjDigestSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): FileObjDigestSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): FileObjDigestSpec;

  mergeJson(json: any | null): FileObjDigestSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): FileObjDigestSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): FileObjDigestSpec;
   ...
   */
  singletonArray(): C3.Array<FileObjDigestSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<FileObjDigestSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FileObjDigestSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<FileObjDigestSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FileObjDigestSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, FileObjDigestSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FileObjDigestSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FileObjDigestSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FileObjDigestSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): FileObjDigestSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): FileObjDigestSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): FileObjDigestSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FileObjDigestSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): FileObjDigestSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FileObjDigestSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): FileObjDigestSpec;
   ...
   */
  static cachedEmptyInst(): FileObjDigestSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<FileObjDigestSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): FileObjDigestSpec;

  /**
   * @return new instance of this spec with `retrySpec` set
   */
  withRetry(maxRetries?: number | null, initialSleepMillis?: number | null, exponent?: number | null): FileObjDigestSpec | null;

  /**
   * @return instance of this spec with `retrySpec`'s `maxTotalMillis` set
   */
  static timeoutSeconds(secs: number | null): FileObjDigestSpec;

  /**
   * @return FileObjsOperSpec with #serType set to provided value.
   */
  static fromType(serType: Type | null): FileObjDigestSpec;
   ...
   */
  static toDecrypt(): FileObjDigestSpec | null;
}
