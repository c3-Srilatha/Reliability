// TypeScript definitions for the C3 type MetricsListenerCache

/**
 * Cache for metrics listeners
 *
 * @remarks this represents a value passed to a method that expects an instance of MetricsListenerCache
 */
declare interface IMetricsListenerCache {
}

/**
 * Cache for metrics listeners
 *
 * @remarks this represents a made instance of MetricsListenerCache
 */
declare class MetricsListenerCache {
   ...
   */
  static get(key: string | null): MetricsListenerCacheEntry | null;
   ...
   */
  static require(key: string | null): MetricsListenerCacheEntry;
   ...
   */
  static put(key: string | null, value: MetricsListenerCacheEntry | null): void;
   ...
   */
  static produce(key: string | null): MetricsListenerCacheEntry | null;
   ...
   * should be cleared.
   */
  static produceAll(): C3.Map<string | null, MetricsListenerCacheEntry | null>;

  /**
   * Optional override called when element is released from the cache. Should perform any external resources cleanup if
   * needed.
   */
  static release(key: string | null, value: MetricsListenerCacheEntry | null): void;
   ...
   */
  static validate(value: MetricsListenerCacheEntry | null): boolean;

  /**
   * @return The contents of the cache
   */
  static info(): MetricsListenerCacheEntry;

  /**
   * @return True if there is a listener for the metric
   */
  static hasListener(metricId: string): boolean;

  /**
   * @return A list of all metrics that have listeners.
   */
  static metrics(): C3.Array<string | null>;

  /**
   * Gets the list of ids of metrics for a source type that have listeners.
   *
   * @param srcType
   *        Source type to check.
   *
   * @return A List of ids of metrics for the requested source type that have listeners.
   */
  static metricsForSrcType(srcType: Type): C3.Array<string | null>;
}
