// TypeScript definitions for the C3 type PendingRefreshDefaultFieldsReq

/**
 * Pending newly created/modified fields that have default fields that require refreshing found in provisioning.
 *
 * @remarks this represents a value passed to a method that expects an instance of PendingRefreshDefaultFieldsReq
 */
declare interface IPendingRefreshDefaultFieldsReq {
   ...
   * Type to refresh.
   */
  refreshType?: IType | null;

  /**
   * Calc fields to refresh
   */
  defaultFields?: C3.Array<string | null> | Array<string | null>;
}

/**
 * Pending newly created/modified fields that have default fields that require refreshing found in provisioning.
 *
 * @remarks this represents a made instance of PendingRefreshDefaultFieldsReq
 */
declare class PendingRefreshDefaultFieldsReq extends Obj {
  ...
  withTypeIdent(typeIdent: string | null): PendingRefreshDefaultFieldsReq;
   ...
   */
  readonly id: string;
  withId(id: string): PendingRefreshDefaultFieldsReq;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): PendingRefreshDefaultFieldsReq;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): PendingRefreshDefaultFieldsReq;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): PendingRefreshDefaultFieldsReq;
  ...
  withVersion(version: number | null): PendingRefreshDefaultFieldsReq;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): PendingRefreshDefaultFieldsReq;

  /**
   * Type to refresh.
   */
  readonly refreshType?: Type | null;
  withRefreshType(refreshType: IType | null): PendingRefreshDefaultFieldsReq;

  /**
   * Calc fields to refresh
   */
  readonly defaultFields?: C3.Array<string | null>;
  withDefaultFields(defaultFields: C3.Array<string | null> | Array<string | null>): PendingRefreshDefaultFieldsReq;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): PendingRefreshDefaultFieldsReq | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): PendingRefreshDefaultFieldsReq | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): PendingRefreshDefaultFieldsReq | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): PendingRefreshDefaultFieldsReq | null;
   ...
   */
  replaceType(old: Type, new_: Type): PendingRefreshDefaultFieldsReq;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PendingRefreshDefaultFieldsReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PendingRefreshDefaultFieldsReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PendingRefreshDefaultFieldsReq | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PendingRefreshDefaultFieldsReq | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): PendingRefreshDefaultFieldsReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PendingRefreshDefaultFieldsReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PendingRefreshDefaultFieldsReq;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PendingRefreshDefaultFieldsReq;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PendingRefreshDefaultFieldsReq;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PendingRefreshDefaultFieldsReq;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): PendingRefreshDefaultFieldsReq;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PendingRefreshDefaultFieldsReq;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PendingRefreshDefaultFieldsReq;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): PendingRefreshDefaultFieldsReq;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): PendingRefreshDefaultFieldsReq;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): PendingRefreshDefaultFieldsReq;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): PendingRefreshDefaultFieldsReq;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PendingRefreshDefaultFieldsReq;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): PendingRefreshDefaultFieldsReq;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PendingRefreshDefaultFieldsReq;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PendingRefreshDefaultFieldsReq;
   ...
   * @see #removeField
   */
  unsetField(field: string): PendingRefreshDefaultFieldsReq;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PendingRefreshDefaultFieldsReq;
   ...
   * @see #unsetField
   */
  removeField(field: string): PendingRefreshDefaultFieldsReq;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PendingRefreshDefaultFieldsReq;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): PendingRefreshDefaultFieldsReq;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): PendingRefreshDefaultFieldsReq;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): PendingRefreshDefaultFieldsReq;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): PendingRefreshDefaultFieldsReq;

  mergeJson(json: any | null): PendingRefreshDefaultFieldsReq;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): PendingRefreshDefaultFieldsReq;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): PendingRefreshDefaultFieldsReq;
   ...
   */
  singletonArray(): C3.Array<PendingRefreshDefaultFieldsReq | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<PendingRefreshDefaultFieldsReq | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PendingRefreshDefaultFieldsReq | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<PendingRefreshDefaultFieldsReq | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PendingRefreshDefaultFieldsReq | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, PendingRefreshDefaultFieldsReq | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PendingRefreshDefaultFieldsReq | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PendingRefreshDefaultFieldsReq | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PendingRefreshDefaultFieldsReq | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): PendingRefreshDefaultFieldsReq;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): PendingRefreshDefaultFieldsReq;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): PendingRefreshDefaultFieldsReq;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PendingRefreshDefaultFieldsReq;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): PendingRefreshDefaultFieldsReq;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PendingRefreshDefaultFieldsReq;
   ...
   * @see #fromString
   */
  static make(s: string | null): PendingRefreshDefaultFieldsReq | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): PendingRefreshDefaultFieldsReq;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): PendingRefreshDefaultFieldsReq;
   ...
   */
  static cachedEmptyInst(): PendingRefreshDefaultFieldsReq;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<PendingRefreshDefaultFieldsReq>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): PendingRefreshDefaultFieldsReq;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<PendingRefreshDefaultFieldsReq | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PendingRefreshDefaultFieldsReq | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<PendingRefreshDefaultFieldsReq | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<PendingRefreshDefaultFieldsReq | null> | null>;
   ...
   */
  get(include?: string | null): PendingRefreshDefaultFieldsReq | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): PendingRefreshDefaultFieldsReq | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PendingRefreshDefaultFieldsReq;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): PendingRefreshDefaultFieldsReq | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PendingRefreshDefaultFieldsReq;
   ...
   * @see #toString
   */
  static fromString(s: string | null): PendingRefreshDefaultFieldsReq | null;
   ...
   */
  create(spec?: UpsertSpec | null): PendingRefreshDefaultFieldsReq | null;
   ...
   */
  static createBatch(objs: C3.Array<PendingRefreshDefaultFieldsReq | null> | null, spec?: UpsertSpec | null): ObjList<PendingRefreshDefaultFieldsReq | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PendingRefreshDefaultFieldsReq | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<PendingRefreshDefaultFieldsReq | null> | null;
   ...
   */
  update(srcObj?: PendingRefreshDefaultFieldsReq | null, spec?: UpsertSpec | null): PendingRefreshDefaultFieldsReq | null;
   ...
   */
  upsert(srcObj?: PendingRefreshDefaultFieldsReq | null, spec?: UpsertSpec | null): PendingRefreshDefaultFieldsReq | null;
   ...
   */
  merge(spec?: MergeSpec | null): PendingRefreshDefaultFieldsReq | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): PendingRefreshDefaultFieldsReq | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): PendingRefreshDefaultFieldsReq | null;
   ...
   */
  static updateBatch(objs: C3.Array<PendingRefreshDefaultFieldsReq | null> | null, srcObjs?: C3.Array<PendingRefreshDefaultFieldsReq | null>, spec?: UpsertSpec | null): ObjList<PendingRefreshDefaultFieldsReq | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<PendingRefreshDefaultFieldsReq | null>>, spec?: UpsertSpec | null): ObjList<PendingRefreshDefaultFieldsReq | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<PendingRefreshDefaultFieldsReq | null> | null, srcObjs?: C3.Array<PendingRefreshDefaultFieldsReq | null>, spec?: UpsertSpec | null): ObjList<PendingRefreshDefaultFieldsReq | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<PendingRefreshDefaultFieldsReq | null>>, spec?: UpsertSpec | null): ObjList<PendingRefreshDefaultFieldsReq | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<PendingRefreshDefaultFieldsReq | null> | null, spec?: TouchSpec | null): ObjList<PendingRefreshDefaultFieldsReq | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PendingRefreshDefaultFieldsReq | null> | null, spec?: MergeSpec | null): ObjList<PendingRefreshDefaultFieldsReq | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PendingRefreshDefaultFieldsReq | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<PendingRefreshDefaultFieldsReq | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<PendingRefreshDefaultFieldsReq | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<PendingRefreshDefaultFieldsReq | null> | null;
   ...
   */
  static mergeAll(mergeObj: PendingRefreshDefaultFieldsReq | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PendingRefreshDefaultFieldsReq | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<PendingRefreshDefaultFieldsReq | null> | null, spec?: UpsertSpec | null): ObjList<PendingRefreshDefaultFieldsReq | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<PendingRefreshDefaultFieldsReq | null> | null, spec?: UpsertSpec | null): ObjList<PendingRefreshDefaultFieldsReq | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): PendingRefreshDefaultFieldsReq | null;
   ...
   */
  static beforeCreate(objs: C3.Array<PendingRefreshDefaultFieldsReq | null> | null): ObjList<PendingRefreshDefaultFieldsReq | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<PendingRefreshDefaultFieldsReq | null> | null): ObjList<PendingRefreshDefaultFieldsReq | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<PendingRefreshDefaultFieldsReq | null> | null): ObjList<PendingRefreshDefaultFieldsReq | null>;
   ...
   */
  static afterCreate(objs: C3.Array<PendingRefreshDefaultFieldsReq | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<PendingRefreshDefaultFieldsReq | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<PendingRefreshDefaultFieldsReq | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<PendingRefreshDefaultFieldsReq | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<PendingRefreshDefaultFieldsReq | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): PendingRefreshDefaultFieldsReq | null;
   ...
   */
  withoutIdentity(): PendingRefreshDefaultFieldsReq | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<PendingRefreshDefaultFieldsReq | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: PendingRefreshDefaultFieldsReq | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<PendingRefreshDefaultFieldsReq | null> | null, callback?: λFunction<PendingRefreshDefaultFieldsReq | null, PendingRefreshDefaultFieldsReq | null> | null): ObjList<PendingRefreshDefaultFieldsReq | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<PendingRefreshDefaultFieldsReq | null> | null, callback?: λFunction<PendingRefreshDefaultFieldsReq | null, PendingRefreshDefaultFieldsReq | null> | null): C3.Array<ObjError | null>;
  ...
  /**
   * Processes all pending refresh requests and removes them from the db.  If called on a type that extends this type,
   * then only requests from that type will be refreshed.  Otherwise requests from all extension types will be.
   */
  static refreshAll(): void;

  /**
   * Processes a single pending refresh request and removes it from the db.
   */
  refresh(): void;

  /**
   * Implemented by individual refresh types to perform actual refresh.
   */
  doRefresh(): void;
}
