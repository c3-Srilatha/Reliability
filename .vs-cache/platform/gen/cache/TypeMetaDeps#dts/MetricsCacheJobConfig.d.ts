// TypeScript definitions for the C3 type MetricsCacheJobConfig

/**
 * Type for specifying configuration of MetricsCacheJob
 *
 * @remarks this represents a value passed to a method that expects an instance of MetricsCacheJobConfig
 */
declare interface IMetricsCacheJobConfig {
  ...
  /**
   * The source type for which metrics cache needs to be run
   */
  srcType?: IType | null;

  /**
   * The metrics to be cached. Only metrics specified here will be considered for caching
   */
  metricNames?: C3.Array<string | null> | Array<string | null>;

  /**
   * Interval at which given metrics need to be cached
   */
  interval?: string | null;

  /**
   * Is metric caching enabled
   */
  enabled?: boolean;
}
 ...
 * Type for specifying configuration of MetricsCacheJob
 *
 * @remarks this represents a made instance of MetricsCacheJobConfig
 */
declare class MetricsCacheJobConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): MetricsCacheJobConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): MetricsCacheJobConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): MetricsCacheJobConfig;

  /**
   * The id of this instance.
   */
  readonly id?: string | null;
  withId(id: string | null): MetricsCacheJobConfig;

  /**
   * The source type for which metrics cache needs to be run
   */
  readonly srcType?: Type | null;
  withSrcType(srcType: IType | null): MetricsCacheJobConfig;

  /**
   * The metrics to be cached. Only metrics specified here will be considered for caching
   */
  readonly metricNames?: C3.Array<string | null>;
  withMetricNames(metricNames: C3.Array<string | null> | Array<string | null>): MetricsCacheJobConfig;

  /**
   * Interval at which given metrics need to be cached
   */
  readonly interval?: string | null;
  withInterval(interval: string | null): MetricsCacheJobConfig;

  /**
   * Is metric caching enabled
   */
  readonly enabled?: boolean;
  withEnabled(enabled: boolean): MetricsCacheJobConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): MetricsCacheJobConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): MetricsCacheJobConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): MetricsCacheJobConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): MetricsCacheJobConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): MetricsCacheJobConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MetricsCacheJobConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MetricsCacheJobConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MetricsCacheJobConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MetricsCacheJobConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): MetricsCacheJobConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MetricsCacheJobConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MetricsCacheJobConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): MetricsCacheJobConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): MetricsCacheJobConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): MetricsCacheJobConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): MetricsCacheJobConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): MetricsCacheJobConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): MetricsCacheJobConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): MetricsCacheJobConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): MetricsCacheJobConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): MetricsCacheJobConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): MetricsCacheJobConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): MetricsCacheJobConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): MetricsCacheJobConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): MetricsCacheJobConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): MetricsCacheJobConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): MetricsCacheJobConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): MetricsCacheJobConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): MetricsCacheJobConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): MetricsCacheJobConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): MetricsCacheJobConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): MetricsCacheJobConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): MetricsCacheJobConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): MetricsCacheJobConfig;

  mergeJson(json: any | null): MetricsCacheJobConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): MetricsCacheJobConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): MetricsCacheJobConfig;
   ...
   */
  singletonArray(): C3.Array<MetricsCacheJobConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<MetricsCacheJobConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<MetricsCacheJobConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<MetricsCacheJobConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<MetricsCacheJobConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, MetricsCacheJobConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, MetricsCacheJobConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<MetricsCacheJobConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<MetricsCacheJobConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): MetricsCacheJobConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): MetricsCacheJobConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): MetricsCacheJobConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): MetricsCacheJobConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): MetricsCacheJobConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): MetricsCacheJobConfig;
   ...
   * @see #fromString
   */
  static make(s: string | null): MetricsCacheJobConfig | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): MetricsCacheJobConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): MetricsCacheJobConfig;
   ...
   */
  static cachedEmptyInst(): MetricsCacheJobConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<MetricsCacheJobConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): MetricsCacheJobConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<MetricsCacheJobConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<MetricsCacheJobConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<MetricsCacheJobConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): MetricsCacheJobConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): MetricsCacheJobConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): MetricsCacheJobConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): MetricsCacheJobConfig | null;
   ...
   */
  static produce(key: string): MetricsCacheJobConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, MetricsCacheJobConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, MetricsCacheJobConfig | null>;
   ...
   */
  getConfig(): MetricsCacheJobConfig;
   ...
   */
  getSecret(): MetricsCacheJobConfig;
   ...
   */
  static forConfigKey(configKey: string | null): MetricsCacheJobConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<MetricsCacheJobConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: MetricsCacheJobConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: MetricsCacheJobConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): MetricsCacheJobConfig | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): MetricsCacheJobConfig | null;
}
