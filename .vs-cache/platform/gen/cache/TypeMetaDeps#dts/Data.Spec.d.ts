// TypeScript definitions for the C3 type Data.Spec

/**
 * Wraps instance of {@link Data}, allowing persistence as {@link SeedData}
 *
 * @remarks this represents a value passed to a method that expects an instance of Data.Spec
 */
declare namespace Data {
  export interface ISpec {
    ...
    /**
     * Recipe for retrieving a {@link Data}
     */
    src: IData.Lazy;
  }
}
 ...
 * Wraps instance of {@link Data}, allowing persistence as {@link SeedData}
 *
 * @remarks this represents a made instance of Data.Spec
 */
declare namespace Data {
  export class Spec extends Obj {
    ...
    withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Data.Spec;

    /**
     * Name of the Obj instance
     */
    readonly name?: string | null;
    withName(name: string | null): Data.Spec;

    /**
     * Various system fields.
     */
    readonly meta?: Meta | null;
    withMeta(meta: IMeta | null): Data.Spec;
    ...
    withVersion(version: number | null): Data.Spec;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type | null;
    withTypeWithBindings(typeWithBindings: IType | null): Data.Spec;
    ...
    withUserUpdatedFields(userUpdatedFields: C3.Array<string | null> | Array<string | null>): Data.Spec;
    ...
    withHidden(hidden: boolean): Data.Spec;
    ...
    withUserOwned(userOwned: boolean): Data.Spec;

    /**
     * Recipe for retrieving a {@link Data}
     */
    readonly src: Data.Lazy;
    withSrc(src: IData.Lazy): Data.Spec;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.Spec | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.Spec | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.Spec | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.Spec | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.Spec;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Spec;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Spec;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Spec | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Spec | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.Spec;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Spec;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Spec;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.Spec;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.Spec;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.Spec;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.Spec;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.Spec;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.Spec;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.Spec;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.Spec;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.Spec;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.Spec;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.Spec;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.Spec;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.Spec;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.Spec;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.Spec;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.Spec;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.Spec;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.Spec;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.Spec;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.Spec;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.Spec;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.Spec;

    mergeJson(json: any | null): Data.Spec;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.Spec;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.Spec;
     ...
     */
    singletonArray(): C3.Array<Data.Spec | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.Spec | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.Spec | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.Spec | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.Spec | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.Spec | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.Spec | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.Spec | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.Spec | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.Spec;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.Spec;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.Spec;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.Spec;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.Spec;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.Spec;
     ...
     * @see #fromString
     */
    static make(s: string | null): Data.Spec | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.Spec;
     ...
     */
    static cachedEmptyInst(): Data.Spec;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.Spec>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.Spec;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<Data.Spec | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<Data.Spec | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<Data.Spec | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): Data.Spec | null;
     ...
     * @see findByCacheKey
     */
    static forCacheKey(key: string | null): Data.Spec | null;
     ...
     * @see findByCacheKey
     */
    getCached(): Data.Spec | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): Data.Spec | null;
     ...
     */
    static produce(key: string): Data.Spec | null;
     ...
     */
    static produceAll(): C3.Map<string | null, Data.Spec | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, Data.Spec | null>;
     ...
     */
    static fetch(spec?: FetchSpec | null): FetchResult<Data.Spec | null>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Data.Spec | null>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Data.Spec | null>;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Data.Spec | null> | null>;
     ...
     */
    get(include?: string | null): Data.Spec | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string | null): Data.Spec | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Data.Spec;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string | null): Data.Spec | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Data.Spec;
     ...
     * @see #toString
     */
    static fromString(s: string | null): Data.Spec | null;
     ...
     */
    create(spec?: UpsertSpec | null): Data.Spec | null;
     ...
     */
    static createBatch(objs: C3.Array<Data.Spec | null> | null, spec?: UpsertSpec | null): ObjList<Data.Spec | null> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Data.Spec | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Data.Spec | null> | null;
     ...
     */
    update(srcObj?: Data.Spec | null, spec?: UpsertSpec | null): Data.Spec | null;
     ...
     */
    upsert(srcObj?: Data.Spec | null, spec?: UpsertSpec | null): Data.Spec | null;
     ...
     */
    merge(spec?: MergeSpec | null): Data.Spec | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec | null): Data.Spec | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec | null): Data.Spec | null;
     ...
     */
    static updateBatch(objs: C3.Array<Data.Spec | null> | null, srcObjs?: C3.Array<Data.Spec | null>, spec?: UpsertSpec | null): ObjList<Data.Spec | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<C3.Array<Data.Spec | null>>, spec?: UpsertSpec | null): ObjList<Data.Spec | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: C3.Array<Data.Spec | null> | null, srcObjs?: C3.Array<Data.Spec | null>, spec?: UpsertSpec | null): ObjList<Data.Spec | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<C3.Array<Data.Spec | null>>, spec?: UpsertSpec | null): ObjList<Data.Spec | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: C3.Array<Data.Spec | null> | null, spec?: TouchSpec | null): ObjList<Data.Spec | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<Data.Spec | null> | null, spec?: MergeSpec | null): ObjList<Data.Spec | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<Data.Spec | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Data.Spec | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<C3.Array<Data.Spec | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Data.Spec | null> | null;
     ...
     */
    static mergeAll(mergeObj: Data.Spec | null, spec?: MergeAllSpec | null): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Data.Spec | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: C3.Array<Data.Spec | null> | null, spec?: UpsertSpec | null): ObjList<Data.Spec | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: C3.Array<Data.Spec | null> | null, spec?: UpsertSpec | null): ObjList<Data.Spec | null> | null;
     ...
     */
    static beforeCreate(objs: C3.Array<Data.Spec | null> | null): ObjList<Data.Spec | null>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: C3.Array<Data.Spec | null> | null): ObjList<Data.Spec | null>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: C3.Array<Data.Spec | null> | null): ObjList<Data.Spec | null>;
     ...
     */
    static afterCreate(objs: C3.Array<Data.Spec | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: C3.Array<Data.Spec | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: C3.Array<Data.Spec | null> | null): C3.Array<ObjError | null>;
     ...
     */
    static startImportData(spec?: StartImportDataSpec | null): PushStream<Data.Spec | null>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Data.Spec | null>;
     ...
     */
    static forId(id: string | null, failIfMissing?: boolean): Data.Spec | null;
     ...
     */
    withoutIdentity(): Data.Spec | null;
     ...
     */
    static typeOfBatch(objs: C3.Array<Data.Spec | null> | null): C3.Array<EntityType | null>;
     ...
     */
    static dbEcho(template?: Data.Spec | null, count?: number | null, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: C3.Array<Data.Spec | null> | null, callback?: λFunction<Data.Spec | null, Data.Spec | null> | null): ObjList<Data.Spec | null>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: C3.Array<Data.Spec | null> | null, callback?: λFunction<Data.Spec | null, Data.Spec | null> | null): C3.Array<ObjError | null>;
     ...
     */
    publish(subPath?: string | null, contentType?: string | null): Data.Spec;
     ...
     */
    static removeSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<Data.Spec | null> | null;
     ...
     */
    createSeedData(spec?: UpsertSpec | null): Data.Spec | null;
     ...
     */
    static createSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<Data.Spec | null> | null;
     ...
     */
    updateSeedData(srcObj?: SeedData | null, spec?: UpsertSpec | null): Data.Spec | null;
     ...
     */
    static updateSeedDataBatch(objs?: C3.Array<SeedData | null>, srcObjs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<Data.Spec | null> | null;
     ...
     * @return updated obj instance, same as {@link Persistable#update} return value.
     */
    clearUserUpdates(spec?: MergeSpec | null): Data.Spec | null;
     ...
     *         {@link Persistable#updateBatch}.
     */
    static clearUserUpdatesBatch(objs?: C3.Array<SeedData | null>, spec?: MergeSpec | null): ObjList<Data.Spec | null> | null;
    ...
    dependencies(): SeedDataDeps<Data.Spec | null> | null;
