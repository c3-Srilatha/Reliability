// TypeScript definitions for the C3 type BinaryOp

/**
 * Enumeration of all supported binary operators
 *
 * @remarks this represents a value passed to a method that expects an instance of BinaryOp
 */
declare interface IBinaryOp {
