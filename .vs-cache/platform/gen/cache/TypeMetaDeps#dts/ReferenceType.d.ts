// TypeScript definitions for the C3 type ReferenceType
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ReferenceType
 */
declare interface IReferenceType {
 ...
 * @see DeclaredReferenceType
 *
 * @remarks this represents a made instance of ReferenceType
 */
declare class ReferenceType extends Obj {

  /**
   * Source file Pkg.Path a C3 Type declaration [.c3typ].
   */
  readonly declaredPkgPath?: string | null;
  withDeclaredPkgPath(declaredPkgPath: string | null): ReferenceType;

  /**
   * Source line number in a C3 Type declaration [.c3typ] file starting with 1 where this metadata element is declared.
   */
  readonly declaredSrcLine?: number | null;
  withDeclaredSrcLine(declaredSrcLine: number | null): ReferenceType;
  ...
  withDeclaredSrcCharInLine(declaredSrcCharInLine: number | null): ReferenceType;
   ...
   */
  readonly pkg: Pkg;
  withPkg(pkg: IPkg): ReferenceType;

  /**
   * SDK json representing instance of this type
   */
  readonly json?: any;
  withJson(json: any): ReferenceType;

  /**
   * The set of annotations defined on this element of metadata represented as json value.
   */
  readonly annotationsJson?: any | null;
  withAnnotationsJson(annotationsJson: any | null): ReferenceType;
  ...
  withModifier(modifier: string | null): ReferenceType;
  ...
  withName(name: string): ReferenceType;
  ...
  withMixing(mixing: boolean): ReferenceType;
  ...
  withHadDeclaredVarBindings(hadDeclaredVarBindings: boolean): ReferenceType;
   ...
   */
  replaceType(old: Type, new_: Type): ReferenceType;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ReferenceType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ReferenceType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ReferenceType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ReferenceType | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ReferenceType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ReferenceType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ReferenceType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ReferenceType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ReferenceType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReferenceType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReferenceType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReferenceType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReferenceType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReferenceType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ReferenceType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReferenceType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReferenceType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ReferenceType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ReferenceType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ReferenceType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ReferenceType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReferenceType;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ReferenceType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReferenceType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReferenceType;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReferenceType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReferenceType;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReferenceType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReferenceType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ReferenceType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ReferenceType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ReferenceType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ReferenceType;

  mergeJson(json: any | null): ReferenceType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ReferenceType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ReferenceType;
   ...
   */
  singletonArray(): C3.Array<ReferenceType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ReferenceType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReferenceType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ReferenceType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReferenceType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ReferenceType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReferenceType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReferenceType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReferenceType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ReferenceType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ReferenceType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ReferenceType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReferenceType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ReferenceType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReferenceType;
   ...
   * @see #fromString
   */
  static make(s: string | null): ReferenceType | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ReferenceType;
   ...
   */
  static cachedEmptyInst(): ReferenceType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ReferenceType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ReferenceType;
   ...
   */
  withoutDeclaredSrcPos(recursive?: boolean): ReferenceType;
   ...
   */
  withAnnotation(ann: Annotation): ReferenceType;
   ...
   *         value for the field
   */
  withAnnotation(ann: string, annField?: string | null, value?: any): ReferenceType;
   ...
   * @see #toString
   */
  static fromString(s: string | null): ReferenceType | null;
  ...
  static fromTypeMeta(referencedType: TypeMeta): ReferenceType;
