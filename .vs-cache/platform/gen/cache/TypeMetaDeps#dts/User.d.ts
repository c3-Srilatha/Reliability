// TypeScript definitions for the C3 type User

/**
 * This type represents an unauthenticated user and aids in all admin related activities that can be performed on the user.
 *
 * @remarks this represents a value passed to a method that expects an instance of User
 */
 ...
 */
declare class User extends Obj {
  ...
  withLoginAttempts(loginAttempts: number | null): User;

  /**
   * If this User Identity is managed by an external resource (idp)
   */
  readonly externalSource?: string | null;
  withExternalSource(externalSource: string | null): User;

  /**
   * Id of external resource mapping if this User Identity is managed by an external resource (idp)
   */
  readonly externalSourceId?: string | null;
  withExternalSourceId(externalSourceId: string | null): User;
  ...
  withC3AuthSalt(c3AuthSalt: string | null): User;

  /**
   * Field used to prevent tampering with group membership during impersonation
   */
  readonly sealGroupMembership?: number | null;
  withSealGroupMembership(sealGroupMembership: number | null): User;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): User;
  ...
  withVersion(version: number | null): User;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): User;

  /**
   * Idp userId
   */
  readonly idpUserId?: string | null;
  withIdpUserId(idpUserId: string | null): User;

  /**
   * User's email address.
   */
  readonly email?: string | null;
  withEmail(email: string | null): User;

  /**
   * User's last name.
   */
  readonly lastName?: string | null;
  withLastName(lastName: string | null): User;

  /**
   * User's first name
   */
  readonly firstName?: string | null;
  withFirstName(firstName: string | null): User;

  /**
   * User's public key
   */
  readonly publicKey?: string | null;
  withPublicKey(publicKey: string | null): User;

  /**
   * Okta user id.
   */
  readonly oktaUserId?: string | null;
  withOktaUserId(oktaUserId: string | null): User;

  /**
   * Identity provider which manages this user.
   */
  readonly idp?: IdentityProvider<IdpConfig | null> | null;
  withIdp(idp: IIdentityProvider<IdpConfig | null> | null): User;

  /**
   * List of {@link Env} this user have access to or have logged in
   */
  readonly envs?: C3.Array<Env | null>;
  withEnvs(envs: C3.Array<Env | null> | Array<IEnv | null>): User;

  /**
   * List of {@link App} this user have access to or have logged in
   */
  readonly apps?: C3.Array<App | null>;
  withApps(apps: C3.Array<App | null> | Array<IApp | null>): User;

  /**
   * User's session index for SAML login
   */
  readonly samlSessionIndex?: string | null;
  withSamlSessionIndex(samlSessionIndex: string | null): User;

  /**
   * User's session sequence for C3 login
   */
  readonly sessionSequence: number;
  withSessionSequence(sessionSequence: number): User;

  /**
   * All the {@link UserGroup}s this user is a member of.
   */
  readonly groups?: C3.Array<UserGroup>;
  withGroups(groups: C3.Array<UserGroup> | Array<IUserGroup>): User;
  ...
  withIdpGroups(idpGroups: C3.Array<UserGroup> | Array<IUserGroup>): User;
  ...
  withIdpAssignedGroups(idpAssignedGroups: C3.Map<string | null, C3.Array<string | null> | null> | {[key: string | null]: C3.Array<string | null> | Array<string | null> | null}): User;

  /**
   * All the groups that the user is assigned from c3 server
   */
  readonly c3Groups?: C3.Array<UserGroup>;
  withC3Groups(c3Groups: C3.Array<UserGroup> | Array<IUserGroup>): User;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): User | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): User | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): User | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): User | null;
   ...
   */
  replaceType(old: Type, new_: Type): User;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): User;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): User;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<User | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<User | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): User;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): User;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): User;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): User;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): User;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): User;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): User;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): User;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): User;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): User;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): User;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): User;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): User;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): User;
   ...
   * @see #unsetField
   */
  defaultField(field: string): User;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): User;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): User;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): User;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): User;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): User;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): User;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): User;

  mergeJson(json: any | null): User;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): User;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): User;
   ...
   */
  singletonArray(): C3.Array<User | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<User | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<User | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<User | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<User | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, User | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, User | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<User | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<User | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): User;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): User;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): User;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): User;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): User;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): User;
   ...
   * @see #fromString
   */
  static make(s: string | null): User | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): User;
   ...
   */
  static cachedEmptyInst(): User;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<User>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): User;
   ...
   * @see #toString
   */
  static fromString(s: string | null): User | null;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): User | null;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<User | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<User | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<User | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): User | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string | null): User | null;
   ...
   */
  static produce(key: string): User | null;
   ...
   */
  static produceAll(): C3.Map<string | null, User | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, User | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<User | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<User | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<User | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<User | null> | null>;
   ...
   */
  get(include?: string | null): User | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): User | null;
   ...
   */
  getMissing(spec: GetMissingSpec): User;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): User | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): User;
   ...
   */
  create(spec?: UpsertSpec | null): User | null;
   ...
   */
  static createBatch(objs: C3.Array<User | null> | null, spec?: UpsertSpec | null): ObjList<User | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<User | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<User | null> | null;
   ...
   */
  update(srcObj?: User | null, spec?: UpsertSpec | null): User | null;
   ...
   */
  upsert(srcObj?: User | null, spec?: UpsertSpec | null): User | null;
   ...
   */
  merge(spec?: MergeSpec | null): User | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): User | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): User | null;
   ...
   */
  static updateBatch(objs: C3.Array<User | null> | null, srcObjs?: C3.Array<User | null>, spec?: UpsertSpec | null): ObjList<User | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<User | null>>, spec?: UpsertSpec | null): ObjList<User | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<User | null> | null, srcObjs?: C3.Array<User | null>, spec?: UpsertSpec | null): ObjList<User | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<User | null>>, spec?: UpsertSpec | null): ObjList<User | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<User | null> | null, spec?: TouchSpec | null): ObjList<User | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<User | null> | null, spec?: MergeSpec | null): ObjList<User | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<User | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<User | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<User | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<User | null> | null;
   ...
   */
  static mergeAll(mergeObj: User | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: User | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<User | null> | null, spec?: UpsertSpec | null): ObjList<User | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<User | null> | null, spec?: UpsertSpec | null): ObjList<User | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<User | null> | null): ObjList<User | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<User | null> | null): ObjList<User | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<User | null> | null): ObjList<User | null>;
   ...
   */
  static afterCreate(objs: C3.Array<User | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<User | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<User | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<User | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<User | null>;
   ...
   */
  static typeOfBatch(objs: C3.Array<User | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: User | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<User | null> | null, callback?: λFunction<User | null, User | null> | null): ObjList<User | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<User | null> | null, callback?: λFunction<User | null, User | null> | null): C3.Array<ObjError | null>;
