// TypeScript definitions for the C3 type PrimitiveType
 ...
 * @see StringType
 *
 * @remarks this represents a value passed to a method that expects an instance of PrimitiveType
 */
declare interface IPrimitiveType {
 ...
 * @see StringType
 *
 * @remarks this represents a made instance of PrimitiveType
 */
declare class PrimitiveType extends Obj {

  /**
   * Source file Pkg.Path a C3 Type declaration [.c3typ].
   */
  readonly declaredPkgPath?: string | null;
  withDeclaredPkgPath(declaredPkgPath: string | null): PrimitiveType;

  /**
   * Source line number in a C3 Type declaration [.c3typ] file starting with 1 where this metadata element is declared.
   */
  readonly declaredSrcLine?: number | null;
  withDeclaredSrcLine(declaredSrcLine: number | null): PrimitiveType;
  ...
  withDeclaredSrcCharInLine(declaredSrcCharInLine: number | null): PrimitiveType;
   ...
   */
  readonly pkg: Pkg;
  withPkg(pkg: IPkg): PrimitiveType;

  /**
   * SDK json representing instance of this type
   */
  readonly json?: any;
  withJson(json: any): PrimitiveType;

  /**
   * The set of annotations defined on this element of metadata represented as json value.
   */
  readonly annotationsJson?: any | null;
  withAnnotationsJson(annotationsJson: any | null): PrimitiveType;
  ...
  withModifier(modifier: string | null): PrimitiveType;
  ...
  withName(name: string): PrimitiveType;
  ...
  withSerializedType(serializedType: IValueType | null): PrimitiveType;
  ...
  withEnumRefType(enumRefType: IReferenceType | null): PrimitiveType;
  ...
  withDeclaredEnumValues(declaredEnumValues: C3.Array<string | null> | Array<string | null>): PrimitiveType;
   ...
   */
  replaceType(old: Type, new_: Type): PrimitiveType;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): PrimitiveType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): PrimitiveType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): PrimitiveType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): PrimitiveType | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PrimitiveType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PrimitiveType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PrimitiveType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PrimitiveType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): PrimitiveType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PrimitiveType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PrimitiveType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PrimitiveType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PrimitiveType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PrimitiveType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): PrimitiveType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PrimitiveType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PrimitiveType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): PrimitiveType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): PrimitiveType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): PrimitiveType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): PrimitiveType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PrimitiveType;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): PrimitiveType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PrimitiveType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PrimitiveType;
   ...
   * @see #removeField
   */
  unsetField(field: string): PrimitiveType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PrimitiveType;
   ...
   * @see #unsetField
   */
  removeField(field: string): PrimitiveType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PrimitiveType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): PrimitiveType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): PrimitiveType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): PrimitiveType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): PrimitiveType;

  mergeJson(json: any | null): PrimitiveType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): PrimitiveType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): PrimitiveType;
   ...
   */
  singletonArray(): C3.Array<PrimitiveType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<PrimitiveType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PrimitiveType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<PrimitiveType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PrimitiveType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, PrimitiveType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PrimitiveType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PrimitiveType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PrimitiveType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): PrimitiveType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): PrimitiveType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): PrimitiveType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PrimitiveType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): PrimitiveType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PrimitiveType;
   ...
   * @see #fromString
   */
  static make(s: string | null): PrimitiveType | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): PrimitiveType;
   ...
   */
  static cachedEmptyInst(): PrimitiveType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<PrimitiveType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): PrimitiveType;
   ...
   */
  withoutDeclaredSrcPos(recursive?: boolean): PrimitiveType;
   ...
   */
  withAnnotation(ann: Annotation): PrimitiveType;
   ...
   *         value for the field
   */
  withAnnotation(ann: string, annField?: string | null, value?: any): PrimitiveType;
   ...
   * @see #toString
   */
  static fromString(s: string | null): PrimitiveType | null;
