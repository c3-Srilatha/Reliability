// TypeScript definitions for the C3 type InvalidationQueueErrorReview

/**
 * Invalidation queue error review.  When errors are reviewed via {@link InvalidationQueue.setReviewed}, the reviewed
 * entries are tied to an instance of this type, which can be used for commenting/assigning tickets, etc.
 *
 * @remarks this represents a value passed to a method that expects an instance of InvalidationQueueErrorReview
 */
declare interface IInvalidationQueueErrorReview {
  ...
  /**
   * Queue type that the review is for.
   */
  queueType: string;

  /**
   * Label for hyperlink to ticket (e.g. Jira or Zendesk) created for the review.
   */
  linkLabel?: string | null;

  /**
   * Url for hyperlink to ticket (e.g. Jira or Zendesk) created for the review.
   */
  linkUrl?: string | null;

  /**
   * All comments for the review, ordered by comment creation timestamp.
   */
  comments?: C3.Array<InvalidationQueueErrorReviewComment | null> | Array<IInvalidationQueueErrorReviewComment | null>;
}
 ...
 * entries are tied to an instance of this type, which can be used for commenting/assigning tickets, etc.
 *
 * @remarks this represents a made instance of InvalidationQueueErrorReview
 */
declare class InvalidationQueueErrorReview extends Obj {
   ...
   */
  readonly id: string;
  withId(id: string): InvalidationQueueErrorReview;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): InvalidationQueueErrorReview;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): InvalidationQueueErrorReview;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): InvalidationQueueErrorReview;
  ...
  withVersion(version: number | null): InvalidationQueueErrorReview;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): InvalidationQueueErrorReview;

  /**
   * Queue type that the review is for.
   */
  readonly queueType: string;
  withQueueType(queueType: string): InvalidationQueueErrorReview;

  /**
   * Label for hyperlink to ticket (e.g. Jira or Zendesk) created for the review.
   */
  readonly linkLabel?: string | null;
  withLinkLabel(linkLabel: string | null): InvalidationQueueErrorReview;

  /**
   * Url for hyperlink to ticket (e.g. Jira or Zendesk) created for the review.
   */
  readonly linkUrl?: string | null;
  withLinkUrl(linkUrl: string | null): InvalidationQueueErrorReview;

  /**
   * All comments for the review, ordered by comment creation timestamp.
   */
  readonly comments?: C3.Array<InvalidationQueueErrorReviewComment | null>;
  withComments(comments: C3.Array<InvalidationQueueErrorReviewComment | null> | Array<IInvalidationQueueErrorReviewComment | null>): InvalidationQueueErrorReview;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): InvalidationQueueErrorReview | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): InvalidationQueueErrorReview | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): InvalidationQueueErrorReview | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): InvalidationQueueErrorReview | null;
   ...
   */
  replaceType(old: Type, new_: Type): InvalidationQueueErrorReview;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): InvalidationQueueErrorReview;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): InvalidationQueueErrorReview;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<InvalidationQueueErrorReview | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<InvalidationQueueErrorReview | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): InvalidationQueueErrorReview;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): InvalidationQueueErrorReview;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): InvalidationQueueErrorReview;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): InvalidationQueueErrorReview;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): InvalidationQueueErrorReview;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): InvalidationQueueErrorReview;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): InvalidationQueueErrorReview;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): InvalidationQueueErrorReview;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): InvalidationQueueErrorReview;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): InvalidationQueueErrorReview;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): InvalidationQueueErrorReview;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): InvalidationQueueErrorReview;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): InvalidationQueueErrorReview;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): InvalidationQueueErrorReview;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): InvalidationQueueErrorReview;
   ...
   * @see #unsetField
   */
  defaultField(field: string): InvalidationQueueErrorReview;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): InvalidationQueueErrorReview;
   ...
   * @see #removeField
   */
  unsetField(field: string): InvalidationQueueErrorReview;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): InvalidationQueueErrorReview;
   ...
   * @see #unsetField
   */
  removeField(field: string): InvalidationQueueErrorReview;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): InvalidationQueueErrorReview;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): InvalidationQueueErrorReview;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): InvalidationQueueErrorReview;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): InvalidationQueueErrorReview;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): InvalidationQueueErrorReview;

  mergeJson(json: any | null): InvalidationQueueErrorReview;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): InvalidationQueueErrorReview;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): InvalidationQueueErrorReview;
   ...
   */
  singletonArray(): C3.Array<InvalidationQueueErrorReview | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<InvalidationQueueErrorReview | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<InvalidationQueueErrorReview | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<InvalidationQueueErrorReview | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<InvalidationQueueErrorReview | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, InvalidationQueueErrorReview | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, InvalidationQueueErrorReview | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<InvalidationQueueErrorReview | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<InvalidationQueueErrorReview | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): InvalidationQueueErrorReview;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): InvalidationQueueErrorReview;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): InvalidationQueueErrorReview;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): InvalidationQueueErrorReview;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): InvalidationQueueErrorReview;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): InvalidationQueueErrorReview;
   ...
   * @see #fromString
   */
  static make(s: string | null): InvalidationQueueErrorReview | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): InvalidationQueueErrorReview;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): InvalidationQueueErrorReview;
   ...
   */
  static cachedEmptyInst(): InvalidationQueueErrorReview;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<InvalidationQueueErrorReview>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): InvalidationQueueErrorReview;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<InvalidationQueueErrorReview | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<InvalidationQueueErrorReview | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<InvalidationQueueErrorReview | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<InvalidationQueueErrorReview | null> | null>;
   ...
   */
  get(include?: string | null): InvalidationQueueErrorReview | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): InvalidationQueueErrorReview | null;
   ...
   */
  getMissing(spec: GetMissingSpec): InvalidationQueueErrorReview;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): InvalidationQueueErrorReview | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): InvalidationQueueErrorReview;
   ...
   * @see #toString
   */
  static fromString(s: string | null): InvalidationQueueErrorReview | null;
   ...
   */
  create(spec?: UpsertSpec | null): InvalidationQueueErrorReview | null;
   ...
   */
  static createBatch(objs: C3.Array<InvalidationQueueErrorReview | null> | null, spec?: UpsertSpec | null): ObjList<InvalidationQueueErrorReview | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<InvalidationQueueErrorReview | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<InvalidationQueueErrorReview | null> | null;
   ...
   */
  update(srcObj?: InvalidationQueueErrorReview | null, spec?: UpsertSpec | null): InvalidationQueueErrorReview | null;
   ...
   */
  upsert(srcObj?: InvalidationQueueErrorReview | null, spec?: UpsertSpec | null): InvalidationQueueErrorReview | null;
   ...
   */
  merge(spec?: MergeSpec | null): InvalidationQueueErrorReview | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): InvalidationQueueErrorReview | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): InvalidationQueueErrorReview | null;
   ...
   */
  static updateBatch(objs: C3.Array<InvalidationQueueErrorReview | null> | null, srcObjs?: C3.Array<InvalidationQueueErrorReview | null>, spec?: UpsertSpec | null): ObjList<InvalidationQueueErrorReview | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<InvalidationQueueErrorReview | null>>, spec?: UpsertSpec | null): ObjList<InvalidationQueueErrorReview | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<InvalidationQueueErrorReview | null> | null, srcObjs?: C3.Array<InvalidationQueueErrorReview | null>, spec?: UpsertSpec | null): ObjList<InvalidationQueueErrorReview | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<InvalidationQueueErrorReview | null>>, spec?: UpsertSpec | null): ObjList<InvalidationQueueErrorReview | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<InvalidationQueueErrorReview | null> | null, spec?: TouchSpec | null): ObjList<InvalidationQueueErrorReview | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<InvalidationQueueErrorReview | null> | null, spec?: MergeSpec | null): ObjList<InvalidationQueueErrorReview | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<InvalidationQueueErrorReview | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<InvalidationQueueErrorReview | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<InvalidationQueueErrorReview | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<InvalidationQueueErrorReview | null> | null;
   ...
   */
  static mergeAll(mergeObj: InvalidationQueueErrorReview | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: InvalidationQueueErrorReview | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<InvalidationQueueErrorReview | null> | null, spec?: UpsertSpec | null): ObjList<InvalidationQueueErrorReview | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<InvalidationQueueErrorReview | null> | null, spec?: UpsertSpec | null): ObjList<InvalidationQueueErrorReview | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): InvalidationQueueErrorReview | null;
   ...
   */
  static beforeCreate(objs: C3.Array<InvalidationQueueErrorReview | null> | null): ObjList<InvalidationQueueErrorReview | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<InvalidationQueueErrorReview | null> | null): ObjList<InvalidationQueueErrorReview | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<InvalidationQueueErrorReview | null> | null): ObjList<InvalidationQueueErrorReview | null>;
   ...
   */
  static afterCreate(objs: C3.Array<InvalidationQueueErrorReview | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<InvalidationQueueErrorReview | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<InvalidationQueueErrorReview | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<InvalidationQueueErrorReview | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<InvalidationQueueErrorReview | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): InvalidationQueueErrorReview | null;
   ...
   */
  withoutIdentity(): InvalidationQueueErrorReview | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<InvalidationQueueErrorReview | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: InvalidationQueueErrorReview | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<InvalidationQueueErrorReview | null> | null, callback?: λFunction<InvalidationQueueErrorReview | null, InvalidationQueueErrorReview | null> | null): ObjList<InvalidationQueueErrorReview | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<InvalidationQueueErrorReview | null> | null, callback?: λFunction<InvalidationQueueErrorReview | null, InvalidationQueueErrorReview | null> | null): C3.Array<ObjError | null>;
  ...
  /**
   * Adds a comment to the review.  The timestamp and user who created it will be automatically captured.
   */
  addComment(comment?: string | null): void;

  /**
   * Recovers the queue error entries associated with the review.
   */
  recover(): void;
}
