// TypeScript definitions for the C3 type ListenerAsTsMetricsCache

/**
 * Cache for basic SimpleMetric info
 *
 * @remarks this represents a value passed to a method that expects an instance of ListenerAsTsMetricsCache
 */
declare interface IListenerAsTsMetricsCache {
}

/**
 * Cache for basic SimpleMetric info
 *
 * @remarks this represents a made instance of ListenerAsTsMetricsCache
 */
declare class ListenerAsTsMetricsCache {
   ...
   */
  static get(key: string | null): ListenerAsTsMetricsCacheEntry | null;
   ...
   */
  static require(key: string | null): ListenerAsTsMetricsCacheEntry;
   ...
   */
  static put(key: string | null, value: ListenerAsTsMetricsCacheEntry | null): void;
   ...
   */
  static produce(key: string | null): ListenerAsTsMetricsCacheEntry | null;
   ...
   * should be cleared.
   */
  static produceAll(): C3.Map<string | null, ListenerAsTsMetricsCacheEntry | null>;

  /**
   * Optional override called when element is released from the cache. Should perform any external resources cleanup if
   * needed.
   */
  static release(key: string | null, value: ListenerAsTsMetricsCacheEntry | null): void;
   ...
   */
  static validate(value: ListenerAsTsMetricsCacheEntry | null): boolean;

  /**
   * @return all metrics used by analytics or metrics listener
   */
  static metrics(): ListenerAsTsMetricsCacheEntry;

  /**
   * Determines if a type is used as a logical timeseries header type in any AsTs metric.
   *
   * @param type
   *        Type to check
   *
   * @return True if the type is used as a logical timeseries header type in any AsTs metric.
   */
  static isAsTsHeaderType(type: Type): boolean;
}
