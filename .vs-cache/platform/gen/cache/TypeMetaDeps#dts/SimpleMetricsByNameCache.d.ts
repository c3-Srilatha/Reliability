// TypeScript definitions for the C3 type SimpleMetricsByNameCache

/**
 * Cache for simple metrics.
 *
 * @remarks this represents a value passed to a method that expects an instance of SimpleMetricsByNameCache
 */
declare interface ISimpleMetricsByNameCache {
}

/**
 * Cache for simple metrics.
 *
 * @remarks this represents a made instance of SimpleMetricsByNameCache
 */
declare class SimpleMetricsByNameCache {
   ...
   */
  static get(key: string | null): C3.Map<string | null, C3.Array<string | null>>;
   ...
   */
  static require(key: string | null): C3.Map<string | null, C3.Array<string | null>>;
   ...
   */
  static put(key: string | null, value: C3.Map<string | null, C3.Array<string | null>> | null): void;
   ...
   */
  static produce(key: string | null): C3.Map<string | null, C3.Array<string | null>>;
   ...
   * should be cleared.
   */
  static produceAll(): C3.Map<string | null, C3.Map<string | null, C3.Array<string | null>>>;

  /**
   * Optional override called when element is released from the cache. Should perform any external resources cleanup if
   * needed.
   */
  static release(key: string | null, value: C3.Map<string | null, C3.Array<string | null>> | null): void;
   ...
   */
  static validate(value: C3.Map<string | null, C3.Array<string | null>> | null): boolean;

  static metricsByName(): C3.Map<string | null, C3.Array<string | null>>;
}
