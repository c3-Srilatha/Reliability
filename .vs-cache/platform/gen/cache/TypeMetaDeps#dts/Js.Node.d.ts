// TypeScript definitions for the C3 type Js.Node
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Js.Node
 */
...
declare namespace Js {
  export class Node extends Obj {
    ...
    withJAVA(JAVA: string | null): Js.Node;
    ...
    withJAVASCRIPT(JAVASCRIPT: string | null): Js.Node;
    ...
    withPYTHON(PYTHON: string | null): Js.Node;
    ...
    withTYPESCRIPT(TYPESCRIPT: string | null): Js.Node;
    ...
    withTSX(TSX: string | null): Js.Node;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Js.Node | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Js.Node | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Js.Node | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Js.Node | null;
     ...
     */
    replaceType(old: Type, new_: Type): Js.Node;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Js.Node;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Js.Node;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Js.Node;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Js.Node;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Js.Node;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Js.Node | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Js.Node | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Js.Node | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Js.Node | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Js.Node;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Js.Node;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Js.Node;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Js.Node;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Js.Node;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Js.Node;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Js.Node;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Js.Node;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Js.Node;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Js.Node;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Js.Node;
     ...
     * @return new Obj
     */
    static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Js.Node;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Js.Node;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Js.Node;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Js.Node;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Js.Node;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Js.Node;
     ...
     * @see #removeField
     */
    static withoutField(field: string | null): Js.Node;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Js.Node;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType | null): Js.Node;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Js.Node;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: C3.Array<string | null> | null): Js.Node;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Js.Node;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Js.Node;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Js.Node;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Js.Node;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Js.Node;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Js.Node;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Js.Node;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Js.Node;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Js.Node;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Js.Node;
     ...
     * @see #removeField
     */
    unsetField(field: string): Js.Node;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Js.Node;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Js.Node;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Js.Node;
     ...
     * @see #unsetField
     */
    removeField(field: string): Js.Node;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Js.Node;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Js.Node;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Js.Node;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Js.Node;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Js.Node;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Js.Node;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj | null, otherFieldsFilter: Type): Js.Node;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Js.Node;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Js.Node;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Js.Node;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Js.Node;

    mergeJson(json: any | null): Js.Node;

    static mergeJson(json: any | null): Js.Node;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Js.Node;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Js.Node;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Js.Node;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj | null, deep?: boolean): Js.Node;
     ...
     */
    singletonArray(): C3.Array<Js.Node | null>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): C3.Array<Js.Node | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Js.Node | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Js.Node | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Js.Node | null>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): C3.Set<Js.Node | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Js.Node | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Js.Node | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Js.Node | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Js.Node | null>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Js.Node | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Js.Node | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Js.Node;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Js.Node;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Js.Node;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Js.Node;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Js.Node;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Js.Node;
     ...
     * @see #fromString
     */
    static make(s: string | null): Js.Node | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Js.Node;
     ...
     */
    static cachedEmptyInst(): Js.Node;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Js.Node>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Js.Node;
     ...
     * @see #toString
     */
    static fromString(s: string | null): Js.Node | null;

    /**
     * Return the matching ImplLanguage for the specified string or null. This is case-insensitive and handles common
     * abbreviations.
     */
    static forName(name: string | null, failIfMissing?: boolean): Js.Node | null;
     ...
     */
    static cachedInst(): Js.Node | null;
     ...
     */
    static forFileExt(ext: string | null, failIfNone?: boolean): Js.Node | null;
     ...
     * @return result of the execution
     */
    static exec(typeSystem: boolean, src: string, ...args: any[]): T | null;
     ...
     * @return result of the execution
     */
    static exec(runtime: ImplLanguage.Runtime, typeSystem: boolean, src: string, ...args: any[]): T | null;
     ...
     * @return result of the execution
     */
    static _execBare(src: string, args?: C3.Array<any>): T | null;
     ...
     * @return result of the execution
     */
    static _execTypeSystem(src: string, args?: C3.Array<any>): T | null;
  }
}
