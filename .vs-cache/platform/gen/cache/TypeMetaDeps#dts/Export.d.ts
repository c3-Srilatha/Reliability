// TypeScript definitions for the C3 type Export

/**
 * @remarks this represents a value passed to a method that expects an instance of Export
 */
 ...
 */
declare class Export extends Obj {

  /**
   * The unique and required id of this instance.
   */
  readonly id: string;
  withId(id: string): Export;

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun | null;
  withRun(run: IBatchJobRun | null): Export;

  /**
   * previous job executions for this instance
   */
  readonly runs?: C3.Array<BatchJobRun | null>;
  withRuns(runs: C3.Array<BatchJobRun | null> | Array<IBatchJobRun | null>): Export;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj | null;
  withOptions(options: IObj | null): Export;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): Export;
  ...
  withPriority(priority: number | null): Export;
  ...
  withDisabled(disabled: boolean): Export;
  ...
  withMaxConcurrency(maxConcurrency: number | null): Export;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): Export;
  ...
  withRunAsUser(runAsUser: boolean | null): Export;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string | null;
  withNodePool(nodePool: string | null): Export;
  ...
  withSkipIfRunning(skipIfRunning: boolean | null): Export;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number | null;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): Export;
  ...
  withPropagateActionContext(propagateActionContext: boolean): Export;
  ...
  withTypeIdent(typeIdent: string | null): Export;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Export;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): Export;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): Export;
  ...
  withVersion(version: number | null): Export;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): Export;
  ...
  withAbortOnError(abortOnError: boolean): Export;
  ...
  withFileList(fileList: IFileList | null): Export;
   ...
   * @see #toString
   */
  static fromString(s: string | null): Export | null;
   ...
   * @see #fromString
   */
  static make(s: string | null): Export | null;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Export;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Export;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Export;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Export;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Export | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Export | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Export | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Export | null;
   ...
   */
  replaceType(old: Type, new_: Type): Export;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Export;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Export;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Export | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Export | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Export;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Export;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Export;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Export;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Export;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Export;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Export;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Export;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Export;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Export;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Export;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Export;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Export;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Export;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Export;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Export;
   ...
   * @see #removeField
   */
  unsetField(field: string): Export;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Export;
   ...
   * @see #unsetField
   */
  removeField(field: string): Export;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Export;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Export;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Export;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Export;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Export;

  mergeJson(json: any | null): Export;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Export;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Export;
   ...
   */
  singletonArray(): C3.Array<Export | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Export | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Export | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Export | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Export | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Export | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Export | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Export | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Export | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Export;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Export;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Export;
   ...
   */
  static cachedEmptyInst(): Export;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Export>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Export;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): Export | null;
   ...
   */
  start(options?: BatchExportOptions | null): BatchJobStatus | null;
   ...
   */
  cleanup(options?: BatchExportOptions | null): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun | null, BatchJobStatus | null, BatchExportOptions | null> | null;

  failJob(run: JobRun<BatchJobStatusBase | null>): JobBase<BatchJobRun | null, BatchJobStatus | null, BatchExportOptions | null> | null;
  ...
  validateStart(options?: BatchExportOptions | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<Export | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<Export | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Export | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Export | null> | null>;
   ...
   */
  get(include?: string | null): Export | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): Export | null;
   ...
   */
  getMissing(spec: GetMissingSpec): Export;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): Export | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): Export;
   ...
   */
  create(spec?: UpsertSpec | null): Export | null;
   ...
   */
  static createBatch(objs: C3.Array<Export | null> | null, spec?: UpsertSpec | null): ObjList<Export | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<Export | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Export | null> | null;
   ...
   */
  update(srcObj?: Export | null, spec?: UpsertSpec | null): Export | null;
   ...
   */
  upsert(srcObj?: Export | null, spec?: UpsertSpec | null): Export | null;
   ...
   */
  merge(spec?: MergeSpec | null): Export | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): Export | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): Export | null;
   ...
   */
  static updateBatch(objs: C3.Array<Export | null> | null, srcObjs?: C3.Array<Export | null>, spec?: UpsertSpec | null): ObjList<Export | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<Export | null>>, spec?: UpsertSpec | null): ObjList<Export | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<Export | null> | null, srcObjs?: C3.Array<Export | null>, spec?: UpsertSpec | null): ObjList<Export | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<Export | null>>, spec?: UpsertSpec | null): ObjList<Export | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<Export | null> | null, spec?: TouchSpec | null): ObjList<Export | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Export | null> | null, spec?: MergeSpec | null): ObjList<Export | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Export | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Export | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<Export | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Export | null> | null;
   ...
   */
  static mergeAll(mergeObj: Export | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: Export | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<Export | null> | null, spec?: UpsertSpec | null): ObjList<Export | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<Export | null> | null, spec?: UpsertSpec | null): ObjList<Export | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<Export | null> | null): ObjList<Export | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<Export | null> | null): ObjList<Export | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<Export | null> | null): ObjList<Export | null>;
   ...
   */
  static afterCreate(objs: C3.Array<Export | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<Export | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<Export | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<Export | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Export | null>;
   ...
   */
  static typeOfBatch(objs: C3.Array<Export | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: Export | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<Export | null> | null, callback?: λFunction<Export | null, Export | null> | null): ObjList<Export | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<Export | null> | null, callback?: λFunction<Export | null, Export | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static doStart(job?: Export | null, options?: BatchExportOptions | null): void;
   ...
   */
  static processBatch(batch?: ExportImportChunk | null, job?: Export | null, options?: BatchExportOptions | null): void;
   ...
   */
  static allComplete(job: Export, options?: BatchExportOptions | null): string | null;
   ...
   *           Options the job was run with.
   */
  static failed(job: Export, status: BatchJobStatus, options?: BatchExportOptions | null): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: ExportImportChunk | null): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: C3.Array<ExportImportChunk | null>): void;
   ...
   */
  static scheduleObjBatch(job?: Export | null, objBatch?: ObjBatch | null, logPrefix?: string | null): number | null;
   ...
   */
  files(readObjMetadata?: boolean): Stream<File | null>;
   ...
   */
  fileEndpoints(hostName: string, protocol?: string | null, port?: number | null): Stream<string | null>;

  /**
   * Returns the BatchExportSpec which was used to start the Export
   */
  spec(): BatchExportSpec | null;
   ...
   */
  static updateSpec(spec: BatchExportSpec): BatchExportSpec;
}
