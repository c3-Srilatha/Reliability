// TypeScript definitions for the C3 type ResourceGovernorConfig

/**
 * This type manages configs for {@link ResourceGovernor}
 *
 * @remarks this represents a value passed to a method that expects an instance of ResourceGovernorConfig
 */
declare interface IResourceGovernorConfig {
  ...
  /**
   * If the resource governance feature is enabled
   */
  enabled?: boolean;

  /**
   * How long it looks back for average cpu utilization percentage
   */
  cpuWindowMillis?: number | null;

  /**
   * How long it looks back for average garbage collection counts and time
   */
  fullGcWindowMillis?: number | null;
}

/**
 * This type manages configs for {@link ResourceGovernor}
 *
 * @remarks this represents a made instance of ResourceGovernorConfig
 */
declare class ResourceGovernorConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): ResourceGovernorConfig;

  static readonly configOverride?: string | null;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): ResourceGovernorConfig;
  ...
  withIssues(issues: C3.Array<string | null> | Array<string | null>): ResourceGovernorConfig;
  ...
  withEnabled(enabled: boolean): ResourceGovernorConfig;
   ...
   * How long it looks back for average cpu utilization percentage
   */
  readonly cpuWindowMillis?: number | null;
  withCpuWindowMillis(cpuWindowMillis: number | null): ResourceGovernorConfig;

  /**
   * How long it looks back for average cpu utilization percentage
   */
  static readonly cpuWindowMillis?: number | null;

  /**
   * How long it looks back for average garbage collection counts and time
   */
  readonly fullGcWindowMillis?: number | null;
  withFullGcWindowMillis(fullGcWindowMillis: number | null): ResourceGovernorConfig;

  /**
   * How long it looks back for average garbage collection counts and time
   */
  static readonly fullGcWindowMillis?: number | null;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ResourceGovernorConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ResourceGovernorConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ResourceGovernorConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ResourceGovernorConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): ResourceGovernorConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): ResourceGovernorConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ResourceGovernorConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ResourceGovernorConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ResourceGovernorConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ResourceGovernorConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ResourceGovernorConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ResourceGovernorConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ResourceGovernorConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ResourceGovernorConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ResourceGovernorConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ResourceGovernorConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ResourceGovernorConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ResourceGovernorConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ResourceGovernorConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ResourceGovernorConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ResourceGovernorConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): ResourceGovernorConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ResourceGovernorConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): ResourceGovernorConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ResourceGovernorConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): ResourceGovernorConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ResourceGovernorConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ResourceGovernorConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ResourceGovernorConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ResourceGovernorConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ResourceGovernorConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): ResourceGovernorConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ResourceGovernorConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): ResourceGovernorConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ResourceGovernorConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): ResourceGovernorConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ResourceGovernorConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): ResourceGovernorConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ResourceGovernorConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ResourceGovernorConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ResourceGovernorConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): ResourceGovernorConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ResourceGovernorConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ResourceGovernorConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ResourceGovernorConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): ResourceGovernorConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ResourceGovernorConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): ResourceGovernorConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): ResourceGovernorConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): ResourceGovernorConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ResourceGovernorConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): ResourceGovernorConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): ResourceGovernorConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): ResourceGovernorConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ResourceGovernorConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): ResourceGovernorConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ResourceGovernorConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ResourceGovernorConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ResourceGovernorConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): ResourceGovernorConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ResourceGovernorConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ResourceGovernorConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ResourceGovernorConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ResourceGovernorConfig;

  mergeJson(json: any | null): ResourceGovernorConfig;

  static mergeJson(json: any | null): ResourceGovernorConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ResourceGovernorConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ResourceGovernorConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ResourceGovernorConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): ResourceGovernorConfig;
   ...
   */
  singletonArray(): C3.Array<ResourceGovernorConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<ResourceGovernorConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ResourceGovernorConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ResourceGovernorConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ResourceGovernorConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<ResourceGovernorConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ResourceGovernorConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ResourceGovernorConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ResourceGovernorConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ResourceGovernorConfig | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<ResourceGovernorConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ResourceGovernorConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ResourceGovernorConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ResourceGovernorConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ResourceGovernorConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ResourceGovernorConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ResourceGovernorConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ResourceGovernorConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ResourceGovernorConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ResourceGovernorConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): ResourceGovernorConfig;
   ...
   */
  static cachedEmptyInst(): ResourceGovernorConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ResourceGovernorConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ResourceGovernorConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<ResourceGovernorConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<ResourceGovernorConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ResourceGovernorConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): ResourceGovernorConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): ResourceGovernorConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): ResourceGovernorConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): ResourceGovernorConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): ResourceGovernorConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): ResourceGovernorConfig | null;
   ...
   */
  static produce(key: string): ResourceGovernorConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, ResourceGovernorConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, ResourceGovernorConfig | null>;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): ResourceGovernorConfig;
   ...
   */
  getSecret(): ResourceGovernorConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): ResourceGovernorConfig;
   ...
   */
  static forConfigKey(configKey: string | null): ResourceGovernorConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<ResourceGovernorConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: ResourceGovernorConfig, override?: string | null): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: ResourceGovernorConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: ResourceGovernorConfig, override?: string | null): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: ResourceGovernorConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): ResourceGovernorConfig | null;
   ...
   */
  removeSecrets(): ResourceGovernorConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): ResourceGovernorConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): ResourceGovernorConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): ResourceGovernorConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): ResourceGovernorConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): ResourceGovernorConfig;
