// TypeScript definitions for the C3 type ContentBuffer

/**
 * A dynamic in-memory buffer. Content can be written into it once and then read many times.
 *
 * Since this instance is mutable, care must be taken if used from multiple threads. In particular, writing to it
 * from multiple threads will have non-deterministic behavior because of the way streams work.
 *
 * @see Content
 * @see ContentValue
 * @see ContentStream
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ContentBuffer
 */
declare interface IContentBuffer {
 ...
 * @see ContentPushStream
 *
 * @remarks this represents a made instance of ContentBuffer
 */
declare class ContentBuffer extends Obj {
  ...
  withContentEncoding(contentEncoding: string | null): ContentBuffer;
  ...
  withContentLanguage(contentLanguage: string | null): ContentBuffer;
  ...
  withContentLength(contentLength: number | null): ContentBuffer;
  ...
  withContentLocation(contentLocation: string | null): ContentBuffer;
  ...
  withContentType(contentType: string | null): ContentBuffer;
  ...
  withContentDisposition(contentDisposition: string | null): ContentBuffer;
  ...
  withETag(eTag: string | null): ContentBuffer;
  ...
  withLastModified(lastModified: DateTime | Date | string | null): ContentBuffer;

  /**
   * Id of user / identity who last last modified this content.
   */
  readonly lastModifiedBy?: string | null;
  withLastModifiedBy(lastModifiedBy: string | null): ContentBuffer;
  ...
  withContentMD5(contentMD5: string | null): ContentBuffer;
  ...
  withContentSHA1(contentSHA1: string | null): ContentBuffer;

  /**
   * Field to maintain state whether content metadata was read or not.
   */
  readonly hasMetadata?: boolean;
  withHasMetadata(hasMetadata: boolean): ContentBuffer;

  /**
   * The actual content buffer backed by a native mechanism.
   */
  readonly bytes?: any;
  withBytes(bytes: any): ContentBuffer;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ContentBuffer | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ContentBuffer | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ContentBuffer | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ContentBuffer | null;
   ...
   */
  replaceType(old: Type, new_: Type): ContentBuffer;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ContentBuffer;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ContentBuffer;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ContentBuffer | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ContentBuffer | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ContentBuffer;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ContentBuffer;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ContentBuffer;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ContentBuffer;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ContentBuffer;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ContentBuffer;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ContentBuffer;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ContentBuffer;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ContentBuffer;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ContentBuffer;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ContentBuffer;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ContentBuffer;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ContentBuffer;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ContentBuffer;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ContentBuffer;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ContentBuffer;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ContentBuffer;
   ...
   * @see #removeField
   */
  unsetField(field: string): ContentBuffer;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ContentBuffer;
   ...
   * @see #unsetField
   */
  removeField(field: string): ContentBuffer;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ContentBuffer;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ContentBuffer;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ContentBuffer;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ContentBuffer;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ContentBuffer;

  mergeJson(json: any | null): ContentBuffer;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ContentBuffer;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ContentBuffer;
   ...
   */
  singletonArray(): C3.Array<ContentBuffer | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ContentBuffer | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ContentBuffer | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ContentBuffer | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ContentBuffer | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ContentBuffer | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ContentBuffer | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ContentBuffer | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ContentBuffer | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ContentBuffer;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ContentBuffer;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ContentBuffer;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ContentBuffer;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ContentBuffer;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ContentBuffer;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ContentBuffer;
   ...
   */
  static cachedEmptyInst(): ContentBuffer;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ContentBuffer>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ContentBuffer;
   ...
   */
  withFileName(fileName: string | null): ContentBuffer;

  /**
   * Changes file extension in this instance.
   */
  withFileExt(fileExt: string | null): ContentBuffer;
   ...
   */
  identify(suffix?: string | null): ContentBuffer;
   ...
   */
  readMetadata(spec?: FileOperationSpec | null): ContentBuffer;
   ...
   */
  refreshMetadata(spec?: FileOperationSpec | null): ContentBuffer;
   ...
   * @return abstract content with metadata.
   */
  guessMetadata(spec?: FileOperationSpec | null): ContentBuffer;

  /**
   * Clears the content metadata; e.g. if it's known to be invalid.
   */
  clearMetadata(): ContentBuffer;

  /**
   * @return clone of this content with metadata from provided input.
   */
  withMetadata(meta?: ContentMeta | null): ContentBuffer;
   ...
   */
  encodedPushStream(spec?: FileOperationSpec | null): Pair<ContentBuffer | null, BytePushStream | null>;

  /**
   * @return byte push stream to be used for writing un-encoded data into this content object.
   */
  pushStream(spec?: FileOperationSpec | null): Pair<ContentBuffer | null, BytePushStream | null>;

  /**
   * @return character push stream to be used for writing un-encoded data into this content object.
   */
  charPushStream(spec?: FileOperationSpec | null): Pair<ContentBuffer | null, CharPushStream | null>;
   ...
   */
  encodedStream(spec?: FileOperationSpec | null): Pair<ContentBuffer | null, ByteStream | null> | null;
   ...
   */
  writeStream(content: ByteStream | null, spec?: FileOperationSpec | null): ContentBuffer;

  /**
   * Truncates file and replaces it's content with provided binary content.
   */
  writeInputStream(inputStream: any, spec?: FileOperationSpec | null): ContentBuffer;

  /**
   * Truncates file and replaces its content with provided binary content from zipInputStream
   */
  writeZipInputStream(zipInputStream: any, spec?: FileOperationSpec | null): ContentBuffer;
   ...
   */
  writeEncodedStream(encodedContent: ByteStream | null, spec?: FileOperationSpec | null): ContentBuffer;

  /**
   * Truncates file and replaces it's encoded content with provided binary content.
   */
  writeEncodedInputStream(inputStream: any, spec?: FileOperationSpec | null): ContentBuffer;
   ...
   *           content that needs to be written
   */
  write(content: any | null, spec?: FileOperationSpec | null): ContentBuffer;
   ...
   *           encoded content that needs to be written
   */
  writeEncoded(encodedContent: any | null, spec?: FileOperationSpec | null): ContentBuffer;
   ...
   *           content that needs to be written
   */
  writeString(content: string | null, spec?: FileOperationSpec | null): ContentBuffer;
   ...
   */
  writeObj(obj: Obj | null, spec?: FileObjsOperSpec | null): ContentBuffer;
   ...
   * @return pair of update instance of this content and number of objs written
   */
  startWriteObjs(spec?: FileObjsOperSpec | null): Pair<ContentBuffer | null, PushStream<Obj | null> | null>;
   ...
   */
  compress(contentEncoding?: string | null, spec?: FileCompressSpec | null): ContentBuffer;

  /**
   * Uncompresses content.
   */
  uncompress(spec?: FileCompressSpec | null): ContentBuffer;
   ...
   */
  transcode(contentType: string, contentEncoding: string, spec?: FileCompressSpec | null): ContentBuffer;

  /**
   * Copies content to a given target.
   */
  copyContentTo(target: ContentBuffer, spec?: FileOperationSpec | null): void;
