// TypeScript definitions for the C3 type SchemaMigrationCommon

/**
 * Functions used by SchemaUpgrade and PlatformSchemaMigration
 *
 * @remarks this represents a value passed to a method that expects an instance of SchemaMigrationCommon
 */
declare interface ISchemaMigrationCommon {
}

/**
 * Functions used by SchemaUpgrade and PlatformSchemaMigration
 *
 * @remarks this represents a made instance of SchemaMigrationCommon
 */
declare class SchemaMigrationCommon extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SchemaMigrationCommon | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SchemaMigrationCommon | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SchemaMigrationCommon | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SchemaMigrationCommon | null;
   ...
   */
  replaceType(old: Type, new_: Type): SchemaMigrationCommon;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SchemaMigrationCommon;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SchemaMigrationCommon;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SchemaMigrationCommon | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SchemaMigrationCommon | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SchemaMigrationCommon;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SchemaMigrationCommon;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SchemaMigrationCommon;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SchemaMigrationCommon;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SchemaMigrationCommon;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SchemaMigrationCommon;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SchemaMigrationCommon;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SchemaMigrationCommon;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SchemaMigrationCommon;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SchemaMigrationCommon;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SchemaMigrationCommon;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SchemaMigrationCommon;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SchemaMigrationCommon;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SchemaMigrationCommon;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SchemaMigrationCommon;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SchemaMigrationCommon;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SchemaMigrationCommon;
   ...
   * @see #removeField
   */
  unsetField(field: string): SchemaMigrationCommon;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SchemaMigrationCommon;
   ...
   * @see #unsetField
   */
  removeField(field: string): SchemaMigrationCommon;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SchemaMigrationCommon;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SchemaMigrationCommon;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SchemaMigrationCommon;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SchemaMigrationCommon;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SchemaMigrationCommon;

  mergeJson(json: any | null): SchemaMigrationCommon;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SchemaMigrationCommon;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SchemaMigrationCommon;
   ...
   */
  singletonArray(): C3.Array<SchemaMigrationCommon | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SchemaMigrationCommon | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SchemaMigrationCommon | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SchemaMigrationCommon | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SchemaMigrationCommon | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SchemaMigrationCommon | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SchemaMigrationCommon | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SchemaMigrationCommon | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SchemaMigrationCommon | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SchemaMigrationCommon;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SchemaMigrationCommon;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SchemaMigrationCommon;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SchemaMigrationCommon;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SchemaMigrationCommon;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SchemaMigrationCommon;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SchemaMigrationCommon;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SchemaMigrationCommon;
   ...
   */
  static cachedEmptyInst(): SchemaMigrationCommon;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SchemaMigrationCommon>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SchemaMigrationCommon;
