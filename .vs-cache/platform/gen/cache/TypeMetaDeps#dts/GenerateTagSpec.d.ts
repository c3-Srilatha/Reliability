// TypeScript definitions for the C3 type GenerateTagSpec

/**
 * @remarks this represents a value passed to a method that expects an instance of GenerateTagSpec
 */
declare interface IGenerateTagSpec {
  ...
  /**
   * label for identifying this profile
   */
  name: string;
  ...
  /**
   * the tag from which the profile was produced
   */
  sourceTag?: ITag | null;

  /**
   * all types profiled, Obj is GenerateDataSpec (as XML)
   */
  types?: C3.Map<string | null, Obj | null> | {[key: string | null]: IObj | null};

  /**
   * longer description of the circumstances/source data profiled
   */
  description?: string | null;

  /**
   * multiplier of the profiled data cardinality
   */
  cardinalityScale?: number | null;
}

/**
 * @remarks this represents a made instance of GenerateTagSpec
 */
declare class GenerateTagSpec extends Obj {
   ...
   */
  readonly id: string;
  withId(id: string): GenerateTagSpec;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): GenerateTagSpec;

  /**
   * label for identifying this profile
   */
  readonly name: string;
  withName(name: string): GenerateTagSpec;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): GenerateTagSpec;
  ...
  withVersion(version: number | null): GenerateTagSpec;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): GenerateTagSpec;

  /**
   * the tag from which the profile was produced
   */
  readonly sourceTag?: Tag | null;
  withSourceTag(sourceTag: ITag | null): GenerateTagSpec;

  /**
   * all types profiled, Obj is GenerateDataSpec (as XML)
   */
  readonly types?: C3.Map<string | null, Obj | null>;
  withTypes(types: C3.Map<string | null, Obj | null> | {[key: string | null]: IObj | null}): GenerateTagSpec;

  /**
   * longer description of the circumstances/source data profiled
   */
  readonly description?: string | null;
  withDescription(description: string | null): GenerateTagSpec;

  /**
   * multiplier of the profiled data cardinality
   */
  readonly cardinalityScale?: number | null;
  withCardinalityScale(cardinalityScale: number | null): GenerateTagSpec;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): GenerateTagSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): GenerateTagSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): GenerateTagSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): GenerateTagSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): GenerateTagSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): GenerateTagSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): GenerateTagSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<GenerateTagSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<GenerateTagSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): GenerateTagSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenerateTagSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenerateTagSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): GenerateTagSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): GenerateTagSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): GenerateTagSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): GenerateTagSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenerateTagSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): GenerateTagSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): GenerateTagSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): GenerateTagSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): GenerateTagSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): GenerateTagSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): GenerateTagSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): GenerateTagSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): GenerateTagSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): GenerateTagSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): GenerateTagSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): GenerateTagSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): GenerateTagSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): GenerateTagSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): GenerateTagSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): GenerateTagSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): GenerateTagSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): GenerateTagSpec;

  mergeJson(json: any | null): GenerateTagSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): GenerateTagSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): GenerateTagSpec;
   ...
   */
  singletonArray(): C3.Array<GenerateTagSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<GenerateTagSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<GenerateTagSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<GenerateTagSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<GenerateTagSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, GenerateTagSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenerateTagSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<GenerateTagSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<GenerateTagSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): GenerateTagSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): GenerateTagSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): GenerateTagSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): GenerateTagSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): GenerateTagSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): GenerateTagSpec;
   ...
   * @see #fromString
   */
  static make(s: string | null): GenerateTagSpec | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): GenerateTagSpec;
   ...
   */
  static cachedEmptyInst(): GenerateTagSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<GenerateTagSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): GenerateTagSpec;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<GenerateTagSpec | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<GenerateTagSpec | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<GenerateTagSpec | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<GenerateTagSpec | null> | null>;
   ...
   */
  get(include?: string | null): GenerateTagSpec | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): GenerateTagSpec | null;
   ...
   */
  getMissing(spec: GetMissingSpec): GenerateTagSpec;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): GenerateTagSpec | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): GenerateTagSpec;
   ...
   * @see #toString
   */
  static fromString(s: string | null): GenerateTagSpec | null;
   ...
   */
  create(spec?: UpsertSpec | null): GenerateTagSpec | null;
   ...
   */
  static createBatch(objs: C3.Array<GenerateTagSpec | null> | null, spec?: UpsertSpec | null): ObjList<GenerateTagSpec | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<GenerateTagSpec | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<GenerateTagSpec | null> | null;
   ...
   */
  update(srcObj?: GenerateTagSpec | null, spec?: UpsertSpec | null): GenerateTagSpec | null;
   ...
   */
  upsert(srcObj?: GenerateTagSpec | null, spec?: UpsertSpec | null): GenerateTagSpec | null;
   ...
   */
  merge(spec?: MergeSpec | null): GenerateTagSpec | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): GenerateTagSpec | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): GenerateTagSpec | null;
   ...
   */
  static updateBatch(objs: C3.Array<GenerateTagSpec | null> | null, srcObjs?: C3.Array<GenerateTagSpec | null>, spec?: UpsertSpec | null): ObjList<GenerateTagSpec | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<GenerateTagSpec | null>>, spec?: UpsertSpec | null): ObjList<GenerateTagSpec | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<GenerateTagSpec | null> | null, srcObjs?: C3.Array<GenerateTagSpec | null>, spec?: UpsertSpec | null): ObjList<GenerateTagSpec | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<GenerateTagSpec | null>>, spec?: UpsertSpec | null): ObjList<GenerateTagSpec | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<GenerateTagSpec | null> | null, spec?: TouchSpec | null): ObjList<GenerateTagSpec | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<GenerateTagSpec | null> | null, spec?: MergeSpec | null): ObjList<GenerateTagSpec | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<GenerateTagSpec | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<GenerateTagSpec | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<GenerateTagSpec | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<GenerateTagSpec | null> | null;
   ...
   */
  static mergeAll(mergeObj: GenerateTagSpec | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: GenerateTagSpec | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<GenerateTagSpec | null> | null, spec?: UpsertSpec | null): ObjList<GenerateTagSpec | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<GenerateTagSpec | null> | null, spec?: UpsertSpec | null): ObjList<GenerateTagSpec | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<GenerateTagSpec | null> | null): ObjList<GenerateTagSpec | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<GenerateTagSpec | null> | null): ObjList<GenerateTagSpec | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<GenerateTagSpec | null> | null): ObjList<GenerateTagSpec | null>;
   ...
   */
  static afterCreate(objs: C3.Array<GenerateTagSpec | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<GenerateTagSpec | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<GenerateTagSpec | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<GenerateTagSpec | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<GenerateTagSpec | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): GenerateTagSpec | null;
   ...
   */
  withoutIdentity(): GenerateTagSpec | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<GenerateTagSpec | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: GenerateTagSpec | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<GenerateTagSpec | null> | null, callback?: λFunction<GenerateTagSpec | null, GenerateTagSpec | null> | null): ObjList<GenerateTagSpec | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<GenerateTagSpec | null> | null, callback?: λFunction<GenerateTagSpec | null, GenerateTagSpec | null> | null): C3.Array<ObjError | null>;
