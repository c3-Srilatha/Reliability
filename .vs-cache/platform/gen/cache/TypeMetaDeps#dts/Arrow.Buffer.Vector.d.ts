// TypeScript definitions for the C3 type Arrow.Buffer.Vector

/**
 * Type representing https://arrow.apache.org/docs/index.html value vector
 *
 * @remarks this represents a value passed to a method that expects an instance of Arrow.Buffer.Vector
 */
declare namespace Arrow.Buffer {
...
declare namespace Arrow.Buffer {
  export class Vector {
     ...
     */
    setStr(index: number, value?: string | null): void;

    /**
     * Set string value at index; will fail if this is not a string vector
     */
    setUtf8(index: number, value?: any | null): void;
     ...
     */
    setArray(array: C3.Array<any> | null): void;
  }
}
