// TypeScript definitions for the C3 type Err.JobRecoverFailing

/**
 * @remarks this represents a value passed to a method that expects an instance of Err.JobRecoverFailing
 */
declare namespace Err {
  export interface IJobRecoverFailing {
 ...
 */
declare namespace Err {
  export class JobRecoverFailing extends Obj {

    /**
     * Formatted and localized message.
     */
    readonly message?: string | null;
    withMessage(message: string | null): Err.JobRecoverFailing;

    /**
     * Unlocalized, parameterized error message string.
     */
    readonly template?: string | null;
    withTemplate(template: string | null): Err.JobRecoverFailing;

    /**
     * Parameters applied to {@link template} to produce error message.
     */
    readonly parameters?: C3.Array<string | null>;
    withParameters(parameters: C3.Array<string | null> | Array<string | null>): Err.JobRecoverFailing;

    /**
     * Unique (generated) error id.
     */
    readonly id?: string | null;
    withId(id: string | null): Err.JobRecoverFailing;

    /**
     * Error key.
     */
    readonly key?: string | null;
    withKey(key: string | null): Err.JobRecoverFailing;

    /**
     * Error for nested/causing exception (if any).
     */
    readonly cause?: C3.Error | null;
    withCause(cause: IC3.Error | null): Err.JobRecoverFailing;

    /**
     * http status code for this error
     */
    readonly httpStatusCode: number;
    withHttpStatusCode(httpStatusCode: number): Err.JobRecoverFailing;

    /**
     * Filename for where the error originated from
     */
    readonly filenameOfRootError?: string | null;
    withFilenameOfRootError(filenameOfRootError: string | null): Err.JobRecoverFailing;

    /**
     * Extra debugging information, such as script language stack.
     */
    readonly debugInfo?: C3.Array<string | null>;
    withDebugInfo(debugInfo: C3.Array<string | null> | Array<string | null>): Err.JobRecoverFailing;

    /**
     * Script language (js/py) stacktrace.
     */
    readonly stackTrace?: C3.Array<StackFrame | null>;
    withStackTrace(stackTrace: C3.Array<StackFrame | null> | Array<IStackFrame | null>): Err.JobRecoverFailing;
    ...
    withAction(action: string | null): Err.JobRecoverFailing;

    /**
     * Engine of the action that threw this error
     */
    readonly engine?: string | null;
    withEngine(engine: string | null): Err.JobRecoverFailing;

    /**
     * Timestamp when the error was thrown
     */
    readonly timestamp?: DateTime | null;
    withTimestamp(timestamp: DateTime | Date | string | null): Err.JobRecoverFailing;
    ...
    with_system(_system: any): Err.JobRecoverFailing;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Err.JobRecoverFailing | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Err.JobRecoverFailing | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Err.JobRecoverFailing | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Err.JobRecoverFailing | null;
     ...
     */
    replaceType(old: Type, new_: Type): Err.JobRecoverFailing;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Err.JobRecoverFailing;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Err.JobRecoverFailing;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Err.JobRecoverFailing | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Err.JobRecoverFailing | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Err.JobRecoverFailing;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Err.JobRecoverFailing;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Err.JobRecoverFailing;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Err.JobRecoverFailing;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Err.JobRecoverFailing;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Err.JobRecoverFailing;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Err.JobRecoverFailing;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Err.JobRecoverFailing;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Err.JobRecoverFailing;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Err.JobRecoverFailing;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Err.JobRecoverFailing;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Err.JobRecoverFailing;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Err.JobRecoverFailing;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Err.JobRecoverFailing;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Err.JobRecoverFailing;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Err.JobRecoverFailing;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Err.JobRecoverFailing;
     ...
     * @see #removeField
     */
    unsetField(field: string): Err.JobRecoverFailing;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Err.JobRecoverFailing;
     ...
     * @see #unsetField
     */
    removeField(field: string): Err.JobRecoverFailing;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Err.JobRecoverFailing;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Err.JobRecoverFailing;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Err.JobRecoverFailing;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Err.JobRecoverFailing;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Err.JobRecoverFailing;

    mergeJson(json: any | null): Err.JobRecoverFailing;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Err.JobRecoverFailing;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Err.JobRecoverFailing;
     ...
     */
    singletonArray(): C3.Array<Err.JobRecoverFailing | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Err.JobRecoverFailing | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Err.JobRecoverFailing | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Err.JobRecoverFailing | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Err.JobRecoverFailing | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Err.JobRecoverFailing | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Err.JobRecoverFailing | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Err.JobRecoverFailing | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Err.JobRecoverFailing | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Err.JobRecoverFailing;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Err.JobRecoverFailing;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Err.JobRecoverFailing;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Err.JobRecoverFailing;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Err.JobRecoverFailing;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Err.JobRecoverFailing;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Err.JobRecoverFailing;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Err.JobRecoverFailing;
     ...
     */
    static cachedEmptyInst(): Err.JobRecoverFailing;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Err.JobRecoverFailing>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Err.JobRecoverFailing;
     ...
     */
    withFormattedMessage(): Err.JobRecoverFailing;
     ...
     */
    static formatted(format: string, ...args: any[]): Err.JobRecoverFailing;

    /**
     * Construct an error with just the message.
     */
    static fromMessage(s: string | null): Err.JobRecoverFailing;
     ...
     */
    static fromJavaException(ex: any): Err.JobRecoverFailing;

    /**
     * Construct an error from the system exception.
     */
    static fromJavaException(message: string, ex: any): Err.JobRecoverFailing;
     ...
     */
    static fromTemplate(template: string | null, bindings: C3.Map<string | null, any> | null): Err.JobRecoverFailing;

    /**
     * Construct an error and a system exception around it to throw an error.
     */
    static fromHttpCodeAndTemplate(httpCode: number | null, template: string | null, bindings: C3.Map<string | null, any> | null): Err.JobRecoverFailing;
