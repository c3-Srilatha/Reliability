// TypeScript definitions for the C3 type SourceChunk

/**
 * Represents a chunk of Sources
 *
 * @remarks this represents a value passed to a method that expects an instance of SourceChunk
 */
declare interface ISourceChunk {
 ...
 */
declare class SourceChunk extends Obj {
  ...
  withContentEncoding(contentEncoding: string | null): SourceChunk;
  ...
  withContentLanguage(contentLanguage: string | null): SourceChunk;
  ...
  withContentLength(contentLength: number | null): SourceChunk;
  ...
  withContentLocation(contentLocation: string | null): SourceChunk;
  ...
  withContentType(contentType: string | null): SourceChunk;
  ...
  withContentDisposition(contentDisposition: string | null): SourceChunk;
  ...
  withETag(eTag: string | null): SourceChunk;
  ...
  withLastModified(lastModified: DateTime | Date | string | null): SourceChunk;

  /**
   * Id of user / identity who last last modified this content.
   */
  readonly lastModifiedBy?: string | null;
  withLastModifiedBy(lastModifiedBy: string | null): SourceChunk;
  ...
  withContentMD5(contentMD5: string | null): SourceChunk;
  ...
  withContentSHA1(contentSHA1: string | null): SourceChunk;

  /**
   * Field to maintain state whether content metadata was read or not.
   */
  readonly hasMetadata?: boolean;
  withHasMetadata(hasMetadata: boolean): SourceChunk;

  /**
   * The actual content value.
   */
  readonly content?: any | null;
  withContent(content: any | null): SourceChunk;

  /**
   * The unique and required id of this instance.
   */
  readonly id: string;
  withId(id: string): SourceChunk;

  /**
   * Source collection id for this source is stored.
   */
  readonly sourceCollectionName: string;
  withSourceCollectionName(sourceCollectionName: string): SourceChunk;

  /**
   * Meta information for the processing of the sources
   */
  readonly sourcesMeta?: Obj | null;
  withSourcesMeta(sourcesMeta: IObj | null): SourceChunk;
  ...
  withTypeIdent(typeIdent: string | null): SourceChunk;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): SourceChunk;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): SourceChunk;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): SourceChunk;
  ...
  withVersion(version: number | null): SourceChunk;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): SourceChunk;

  /**
   * if the sources is a chunk this is instantiated with the sources id.
   */
  readonly parentSourcesId?: string | null;
  withParentSourcesId(parentSourcesId: string | null): SourceChunk;

  /**
   * adding id of Sources here instead of id because of improving cassandra create and get speeds.
   */
  readonly sourcesId?: string | null;
  withSourcesId(sourcesId: string | null): SourceChunk;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SourceChunk | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SourceChunk | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SourceChunk | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SourceChunk | null;
   ...
   */
  replaceType(old: Type, new_: Type): SourceChunk;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SourceChunk;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SourceChunk;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SourceChunk | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SourceChunk | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SourceChunk;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SourceChunk;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SourceChunk;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SourceChunk;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SourceChunk;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SourceChunk;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SourceChunk;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SourceChunk;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SourceChunk;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SourceChunk;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SourceChunk;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SourceChunk;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SourceChunk;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SourceChunk;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SourceChunk;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SourceChunk;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SourceChunk;
   ...
   * @see #removeField
   */
  unsetField(field: string): SourceChunk;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SourceChunk;
   ...
   * @see #unsetField
   */
  removeField(field: string): SourceChunk;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SourceChunk;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SourceChunk;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SourceChunk;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SourceChunk;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SourceChunk;

  mergeJson(json: any | null): SourceChunk;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SourceChunk;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SourceChunk;
   ...
   */
  singletonArray(): C3.Array<SourceChunk | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SourceChunk | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SourceChunk | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SourceChunk | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SourceChunk | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SourceChunk | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SourceChunk | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SourceChunk | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SourceChunk | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SourceChunk;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SourceChunk;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SourceChunk;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SourceChunk;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SourceChunk;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SourceChunk;
   ...
   * @see #fromString
   */
  static make(s: string | null): SourceChunk | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SourceChunk;
   ...
   */
  static cachedEmptyInst(): SourceChunk;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SourceChunk>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SourceChunk;
   ...
   */
  withFileName(fileName: string | null): SourceChunk;

  /**
   * Changes file extension in this instance.
   */
  withFileExt(fileExt: string | null): SourceChunk;
   ...
   */
  identify(suffix?: string | null): SourceChunk;
   ...
   */
  readMetadata(spec?: FileOperationSpec | null): SourceChunk;
   ...
   */
  refreshMetadata(spec?: FileOperationSpec | null): SourceChunk;
   ...
   * @return abstract content with metadata.
   */
  guessMetadata(spec?: FileOperationSpec | null): SourceChunk;

  /**
   * Clears the content metadata; e.g. if it's known to be invalid.
   */
  clearMetadata(): SourceChunk;

  /**
   * @return clone of this content with metadata from provided input.
   */
  withMetadata(meta?: ContentMeta | null): SourceChunk;
   ...
   */
  encodedPushStream(spec?: FileOperationSpec | null): Pair<SourceChunk | null, BytePushStream | null>;

  /**
   * @return byte push stream to be used for writing un-encoded data into this content object.
   */
  pushStream(spec?: FileOperationSpec | null): Pair<SourceChunk | null, BytePushStream | null>;

  /**
   * @return character push stream to be used for writing un-encoded data into this content object.
   */
  charPushStream(spec?: FileOperationSpec | null): Pair<SourceChunk | null, CharPushStream | null>;
   ...
   */
  encodedStream(spec?: FileOperationSpec | null): Pair<SourceChunk | null, ByteStream | null> | null;
   ...
   */
  writeStream(content: ByteStream | null, spec?: FileOperationSpec | null): SourceChunk;

  /**
   * Truncates file and replaces it's content with provided binary content.
   */
  writeInputStream(inputStream: any, spec?: FileOperationSpec | null): SourceChunk;

  /**
   * Truncates file and replaces its content with provided binary content from zipInputStream
   */
  writeZipInputStream(zipInputStream: any, spec?: FileOperationSpec | null): SourceChunk;
   ...
   */
  writeEncodedStream(encodedContent: ByteStream | null, spec?: FileOperationSpec | null): SourceChunk;

  /**
   * Truncates file and replaces it's encoded content with provided binary content.
   */
  writeEncodedInputStream(inputStream: any, spec?: FileOperationSpec | null): SourceChunk;
   ...
   *           content that needs to be written
   */
  write(content: any | null, spec?: FileOperationSpec | null): SourceChunk;
   ...
   *           encoded content that needs to be written
   */
  writeEncoded(encodedContent: any | null, spec?: FileOperationSpec | null): SourceChunk;
   ...
   *           content that needs to be written
   */
  writeString(content: string | null, spec?: FileOperationSpec | null): SourceChunk;
   ...
   */
  writeObj(obj: Obj | null, spec?: FileObjsOperSpec | null): SourceChunk;
   ...
   * @return pair of update instance of this content and number of objs written
   */
  startWriteObjs(spec?: FileObjsOperSpec | null): Pair<SourceChunk | null, PushStream<Obj | null> | null>;
   ...
   */
  compress(contentEncoding?: string | null, spec?: FileCompressSpec | null): SourceChunk;

  /**
   * Uncompresses content.
   */
  uncompress(spec?: FileCompressSpec | null): SourceChunk;
   ...
   */
  transcode(contentType: string, contentEncoding: string, spec?: FileCompressSpec | null): SourceChunk;

  /**
   * Copies content to a given target.
   */
  copyContentTo(target: SourceChunk, spec?: FileOperationSpec | null): void;
   ...
   * @see #toString
   */
  static fromString(s: string | null): SourceChunk | null;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): SourceChunk | null;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<SourceChunk | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SourceChunk | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<SourceChunk | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<SourceChunk | null> | null>;
   ...
   */
  get(include?: string | null): SourceChunk | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): SourceChunk | null;
   ...
   */
  getMissing(spec: GetMissingSpec): SourceChunk;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): SourceChunk | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): SourceChunk;
   ...
   */
  create(spec?: UpsertSpec | null): SourceChunk | null;
   ...
   */
  static createBatch(objs: C3.Array<SourceChunk | null> | null, spec?: UpsertSpec | null): ObjList<SourceChunk | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<SourceChunk | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<SourceChunk | null> | null;
   ...
   */
  update(srcObj?: SourceChunk | null, spec?: UpsertSpec | null): SourceChunk | null;
   ...
   */
  upsert(srcObj?: SourceChunk | null, spec?: UpsertSpec | null): SourceChunk | null;
   ...
   */
  merge(spec?: MergeSpec | null): SourceChunk | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): SourceChunk | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): SourceChunk | null;
   ...
   */
  static updateBatch(objs: C3.Array<SourceChunk | null> | null, srcObjs?: C3.Array<SourceChunk | null>, spec?: UpsertSpec | null): ObjList<SourceChunk | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<SourceChunk | null>>, spec?: UpsertSpec | null): ObjList<SourceChunk | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<SourceChunk | null> | null, srcObjs?: C3.Array<SourceChunk | null>, spec?: UpsertSpec | null): ObjList<SourceChunk | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<SourceChunk | null>>, spec?: UpsertSpec | null): ObjList<SourceChunk | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<SourceChunk | null> | null, spec?: TouchSpec | null): ObjList<SourceChunk | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SourceChunk | null> | null, spec?: MergeSpec | null): ObjList<SourceChunk | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SourceChunk | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<SourceChunk | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<SourceChunk | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<SourceChunk | null> | null;
   ...
   */
  static mergeAll(mergeObj: SourceChunk | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: SourceChunk | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<SourceChunk | null> | null, spec?: UpsertSpec | null): ObjList<SourceChunk | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<SourceChunk | null> | null, spec?: UpsertSpec | null): ObjList<SourceChunk | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<SourceChunk | null> | null): ObjList<SourceChunk | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<SourceChunk | null> | null): ObjList<SourceChunk | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<SourceChunk | null> | null): ObjList<SourceChunk | null>;
   ...
   */
  static afterCreate(objs: C3.Array<SourceChunk | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<SourceChunk | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<SourceChunk | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<SourceChunk | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<SourceChunk | null>;
   ...
   */
  withoutIdentity(): SourceChunk | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<SourceChunk | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: SourceChunk | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<SourceChunk | null> | null, callback?: λFunction<SourceChunk | null, SourceChunk | null> | null): ObjList<SourceChunk | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<SourceChunk | null> | null, callback?: λFunction<SourceChunk | null, SourceChunk | null> | null): C3.Array<ObjError | null>;
