// TypeScript definitions for the C3 type NormalizationQueue

/**
 * Invalidation queue for timeseries normalization processing.  Each entry is a request to normalize data for a single
 * timeseries header.
 *
 * @see NormalizationQueueEntry
 *
 * @remarks this represents a value passed to a method that expects an instance of NormalizationQueue
 */
declare interface INormalizationQueue {
}
 ...
 * @see NormalizationQueueEntry
 *
 * @remarks this represents a made instance of NormalizationQueue
 */
declare class NormalizationQueue {
   ...
   */
  static compute(targetType: Type, entries: C3.Array<NormalizationQueueEntry | null> | null): void;
   ...
   */
  static find(spec?: InvalidationQueue.FindSpec | null): C3.Array<NormalizationQueueEntry | null>;
   ...
   * @return the list of requested entries.
   */
  static findStream(spec?: InvalidationQueue.FindStreamSpec | null): Stream<NormalizationQueueEntry | null>;
   ...
   *           Entries to remove.
   */
  static clearEntries(entries: C3.Array<NormalizationQueueEntry | null> | null): void;
   ...
   * This function should be claimed by individual InvalidationQueue types such as CalcFieldsQueue.
   */
  static mergeContexts(targetType?: Type | null, entries?: C3.Array<NormalizationQueueEntry | null>): C3.Array<NormalizationQueueEntry | null>;
}
