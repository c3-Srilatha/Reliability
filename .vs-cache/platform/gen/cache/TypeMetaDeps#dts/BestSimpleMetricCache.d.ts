// TypeScript definitions for the C3 type BestSimpleMetricCache

/**
 * Cache for best simple metric for a src type and metric name
 *
 * @remarks this represents a value passed to a method that expects an instance of BestSimpleMetricCache
 */
declare interface IBestSimpleMetricCache {
}

/**
 * Cache for best simple metric for a src type and metric name
 *
 * @remarks this represents a made instance of BestSimpleMetricCache
 */
declare class BestSimpleMetricCache {
   ...
   */
  static require(key: string | null): string;
   ...
   */
  static put(key: string | null, value: string | null): void;
   ...
   */
  static produce(key: string | null): string | null;
   ...
   * @param metric
   *        Metric name
   * @return the best simple metric for a given source type and metric name
   */
  static metric(srcType: string, metric: string): string | null;
}
