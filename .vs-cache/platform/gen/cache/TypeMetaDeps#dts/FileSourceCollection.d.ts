// TypeScript definitions for the C3 type FileSourceCollection
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of FileSourceCollection
 */
declare interface IFileSourceCollection {
   ...
   */
  lineFilter?: λBiFunction<File, string, string | null> | null;
}
 ...
 *   #inboxUrl is not managed by C3 and files will not be moved. The user has to manually manage inboxUrl location.
 *
 * @remarks this represents a made instance of FileSourceCollection
 */
declare class FileSourceCollection extends Obj {

  /**
   * The description of this instance.
   */
  readonly description?: string | null;
  withDescription(description: string | null): FileSourceCollection;
  ...
  withCdcOrder(cdcOrder: string | null): FileSourceCollection;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): FileSourceCollection;

  /**
   * The unique and required name of this instance.
   */
  readonly name: string;
  withName(name: string): FileSourceCollection;

  /**
   * Structure defined to serialize the content from the SourceCollection {@see Source}
   */
  readonly source?: Type | null;
  withSource(source: IType | null): FileSourceCollection;

  /**
   * Source system for the source collection
   */
  readonly sourceSystem: SourceSystem<SourceSystem.Config | null, any>;
  withSourceSystem(sourceSystem: ISourceSystem<SourceSystem.Config | null, any>): FileSourceCollection;
  ...
  withExternal(external: boolean): FileSourceCollection;
  ...
  withSequential(sequential: boolean): FileSourceCollection;

  /**
   * Indicator of whether this instance is currently being configured
   */
  readonly state?: string | null;
  withState(state: string | null): FileSourceCollection;
  ...
  withAfterProcess(afterProcess: ILambda<λBiConsumer<SourceCollection<SourceCollection.Config | null> | null, Sources | null> | null> | null): FileSourceCollection;

  /**
   * List of transforms to skip for SourceCollection.
   */
  readonly skippedTransforms?: C3.Array<string | null>;
  withSkippedTransforms(skippedTransforms: C3.Array<string | null> | Array<string | null>): FileSourceCollection;
  ...
  withPatchObjsOperSpec(patchObjsOperSpec: λFunction<Content | null, IFileObjsOperSpec | null> | null): FileSourceCollection;
  ...
  withCdcSourcesOverride(cdcSourcesOverride: ILambda<λFunction<SourceCollection.Cdc.Checkpoint | null, Stream<Source | null>> | null> | null): FileSourceCollection;
  ...
  withFileInfoOverride(fileInfoOverride: λFunction<File | null, ISourceFileInfo | null> | null): FileSourceCollection;

  /**
   * Filter a line content in a file
   */
  readonly lineFilter?: λBiFunction<File, string, string | null> | null;
  withLineFilter(lineFilter: λBiFunction<File, string, string | null> | null): FileSourceCollection;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): FileSourceCollection | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): FileSourceCollection | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): FileSourceCollection | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): FileSourceCollection | null;
   ...
   */
  replaceType(old: Type, new_: Type): FileSourceCollection;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FileSourceCollection;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FileSourceCollection;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FileSourceCollection | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FileSourceCollection | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): FileSourceCollection;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FileSourceCollection;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FileSourceCollection;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FileSourceCollection;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FileSourceCollection;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FileSourceCollection;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): FileSourceCollection;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FileSourceCollection;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FileSourceCollection;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): FileSourceCollection;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): FileSourceCollection;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): FileSourceCollection;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): FileSourceCollection;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FileSourceCollection;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): FileSourceCollection;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FileSourceCollection;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FileSourceCollection;
   ...
   * @see #removeField
   */
  unsetField(field: string): FileSourceCollection;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FileSourceCollection;
   ...
   * @see #unsetField
   */
  removeField(field: string): FileSourceCollection;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FileSourceCollection;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): FileSourceCollection;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): FileSourceCollection;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): FileSourceCollection;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): FileSourceCollection;

  mergeJson(json: any | null): FileSourceCollection;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): FileSourceCollection;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): FileSourceCollection;
   ...
   */
  singletonArray(): C3.Array<FileSourceCollection | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<FileSourceCollection | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FileSourceCollection | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<FileSourceCollection | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FileSourceCollection | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, FileSourceCollection | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FileSourceCollection | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FileSourceCollection | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FileSourceCollection | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): FileSourceCollection;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): FileSourceCollection;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): FileSourceCollection;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FileSourceCollection;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): FileSourceCollection;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FileSourceCollection;
   ...
   * @see #fromString
   */
  static make(s: string | null): FileSourceCollection | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): FileSourceCollection;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): FileSourceCollection;
   ...
   */
  static cachedEmptyInst(): FileSourceCollection;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<FileSourceCollection>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): FileSourceCollection;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<FileSourceCollection | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<FileSourceCollection | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<FileSourceCollection | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<FileSourceCollection | null> | null>;
  ...
  save(subPath?: string | null, contentType?: string | null): FileSourceCollection;
  ...
  update(srcObj?: FileSourceCollection | null, spec?: UpsertSpec | null): FileSourceCollection | null;

  upsert(srcObj?: FileSourceCollection | null, spec?: UpsertSpec | null): FileSourceCollection | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): FileSourceCollection | null;
   ...
   */
  static forName(name: string | null, failIfMissing?: boolean): FileSourceCollection | null;
   ...
   */
  static collectionsForSourceType(sourceType: Type, include?: string | null): Stream<FileSourceCollection | null>;
   ...
   */
  setPriority(priority: number): FileSourceCollection;

  /**
   * @return SourceCollection after clearing the priority
   */
  clearPriority(): FileSourceCollection;
   ...
   */
  skipTransform(transformId?: string | null): FileSourceCollection;

  /**
   * skip #transform for the source collection.
   */
  skipTransformBatch(transformIds: C3.Array<string | null> | null): FileSourceCollection;

  /**
   * skip #transform for the source collection.
   */
  clearSkippedTransforms(transformsId: C3.Array<string | null> | null): FileSourceCollection;

  /**
   * skip #transform for the source collection.
   */
  clearAllSkippedTransforms(): FileSourceCollection;
  ...
  /**
   * Call by the underlying file system to notify listeners of file change events.
   */
  static processBatch(events: C3.Array<FileSystemEvent | null> | null): void;
   ...
   * beforeUpdate: ~
   */
  notificationConfig(): FileSystemNotificationConfig | null;
   ...
   */
  summarize(spec?: PersistableObjDigestBatchJobSpec | null): PersistableObjDigestBatchJob | null;

  /**
   * @return a file source collection for urlOrEncodedPath
   */
  static forUrlOrEncodedPath(urlOrEncodedPath: string, failIfMissing?: boolean): FileSourceCollection | null;

  /**
   * @return a file source collection for file
   */
  static forFile(file: File, failIfMissing?: boolean): FileSourceCollection | null;
   ...
   */
  fileInfo(file?: File | null): SourceFileInfo | null;
  ...
  validateUrls(failIfInvalid?: boolean): boolean;
}
