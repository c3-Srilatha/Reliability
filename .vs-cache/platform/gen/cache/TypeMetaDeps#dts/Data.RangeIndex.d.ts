// TypeScript definitions for the C3 type Data.RangeIndex

/**
 * Abstract interface representing the pandas RangeIndex class.
 *
 * @remarks this represents a value passed to a method that expects an instance of Data.RangeIndex
 */
 ...
 */
declare namespace Data {
  export class RangeIndex extends Obj {
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.RangeIndex | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.RangeIndex | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.RangeIndex | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.RangeIndex | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.RangeIndex;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.RangeIndex;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.RangeIndex;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.RangeIndex | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.RangeIndex | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.RangeIndex;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.RangeIndex;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.RangeIndex;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.RangeIndex;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.RangeIndex;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.RangeIndex;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.RangeIndex;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.RangeIndex;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.RangeIndex;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.RangeIndex;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.RangeIndex;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.RangeIndex;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.RangeIndex;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.RangeIndex;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.RangeIndex;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.RangeIndex;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.RangeIndex;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.RangeIndex;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.RangeIndex;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.RangeIndex;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.RangeIndex;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.RangeIndex;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.RangeIndex;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.RangeIndex;

    mergeJson(json: any | null): Data.RangeIndex;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.RangeIndex;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.RangeIndex;
     ...
     */
    singletonArray(): C3.Array<Data.RangeIndex | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.RangeIndex | null>;
     ...
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.RangeIndex | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.RangeIndex | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.RangeIndex | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.RangeIndex | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.RangeIndex | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.RangeIndex | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.RangeIndex | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.RangeIndex;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.RangeIndex;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.RangeIndex;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.RangeIndex;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.RangeIndex;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.RangeIndex;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.RangeIndex;
     ...
     */
    static cachedEmptyInst(): Data.RangeIndex;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.RangeIndex>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.RangeIndex;
     ...
     */
    static fromPySrc(pySrc: string, dfs?: C3.Set<DataImpl | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): Data.RangeIndex | null;
     ...
     */
    static _jsDataProxy(inst: any): Data.RangeIndex;
