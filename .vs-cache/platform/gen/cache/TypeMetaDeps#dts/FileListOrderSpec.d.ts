// TypeScript definitions for the C3 type FileListOrderSpec

/**
 * Spec containing information about how {@link FileList} data needs to be ordered & read
 *
 * @remarks this represents a value passed to a method that expects an instance of FileListOrderSpec
 */
declare interface IFileListOrderSpec {
  ...
  /**
   * If set, will order individual files. If not set (default), no ordering will be performed on the individual files
   * and the assumption is that the files are already ordered. When setting this property be sure to provide the
   * {@link FileListOrderSpec#serType} to indicate what type the order expression is applied to
   */
  filesAreNotOrdered?: boolean;
}

/**
 * Spec containing information about how {@link FileList} data needs to be ordered & read
 *
 * @remarks this represents a made instance of FileListOrderSpec
 */
declare class FileListOrderSpec extends Obj {

  /**
   * Data serialization type. If not provided type will be inferred from source data
   */
  readonly serValueType?: ValueType | null;
  withSerValueType(serValueType: IValueType | null): FileListOrderSpec;

  /**
   * Content Type of the source data
   */
  readonly contentType?: string | null;
  withContentType(contentType: string | null): FileListOrderSpec;

  /**
   * Compression / Content Encoding of this data
   */
  readonly contentEncoding?: string | null;
  withContentEncoding(contentEncoding: string | null): FileListOrderSpec;

  /**
   * Batch size to use during serialization if batch writing is used (Arrow format uses batching).
   */
  readonly batchSize?: number | null;
  withBatchSize(batchSize: number | null): FileListOrderSpec;
  ...
  withNoCsvHeader(noCsvHeader: boolean): FileListOrderSpec;
  ...
  withCsvHeader(csvHeader: string | null): FileListOrderSpec;

  /**
   * Optional format for a csv values. Key should be field path used in a csv header.
   */
  readonly csvFormat?: C3.Map<string | null, Format | null>;
  withCsvFormat(csvFormat: C3.Map<string | null, Format | null> | {[key: string | null]: IFormat | null}): FileListOrderSpec;

  /**
   * Default csv delimiter for target type. Used for text/csv files. Leave this field as null for all other content types.
   */
  readonly defaultCsvDelimiter?: string | null;
  withDefaultCsvDelimiter(defaultCsvDelimiter: string | null): FileListOrderSpec;

  /**
   * Default escape character for target type. Used for text/csv files. Leave this field as null for all other content types.
   */
  readonly defaultCsvEscapeChar?: string | null;
  withDefaultCsvEscapeChar(defaultCsvEscapeChar: string | null): FileListOrderSpec;

  /**
   * Default quote character for target type. Used for text/csv files. Leave this field as null for all other content types.
   */
  readonly defaultCsvQuoteChar?: string | null;
  withDefaultCsvQuoteChar(defaultCsvQuoteChar: string | null): FileListOrderSpec;
  ...
  withAvroSchema(avroSchema: string | null): FileListOrderSpec;
  ...
  withIsObjList(isObjList: boolean): FileListOrderSpec;

  /**
   * Optionally skip extra fields in serialized content instead of failing to serialize.
   */
  readonly skipExtraFields?: boolean;
  withSkipExtraFields(skipExtraFields: boolean): FileListOrderSpec;

  /**
   * If true will silently ignore bad syntax in the content and will return no or partial results.
   */
  readonly ignoreBadContent?: boolean;
  withIgnoreBadContent(ignoreBadContent: boolean): FileListOrderSpec;
  ...
  withMergeXmlNonAdjacentLists(mergeXmlNonAdjacentLists: boolean): FileListOrderSpec;

  /**
   * Specifies various parameters for automatic retry that occurs in upsert due to retryable errors.
   */
  readonly retrySpec?: RetrySpec | null;
  withRetrySpec(retrySpec: IRetrySpec | null): FileListOrderSpec;

  /**
   * If set, stream will be instantiated again on retryable errors and execution will continue from the point of failure
   */
  readonly restartStreamOnRetry?: boolean;
  withRestartStreamOnRetry(restartStreamOnRetry: boolean): FileListOrderSpec;

  /**
   * The index of the first object from a stream that needs to be read.
   */
  readonly offset?: number | null;
  withOffset(offset: number | null): FileListOrderSpec;
  ...
  withLimit(limit: number | null): FileListOrderSpec;
  ...
  withValidateContentType(validateContentType: boolean): FileListOrderSpec;
  ...
  withPeekForMetadata(peekForMetadata: boolean): FileListOrderSpec;
  ...
  withFailIfMissing(failIfMissing: boolean): FileListOrderSpec;
  ...
  withSkipIfUnauthorized(skipIfUnauthorized: boolean): FileListOrderSpec;

  /**
   * If set and if requested file or directory url is under this path then will retrieve content from cache.
   */
  readonly cacheUrlOrEncodedPath?: string | null;
  withCacheUrlOrEncodedPath(cacheUrlOrEncodedPath: string | null): FileListOrderSpec;

  /**
   * Time in seconds that the cached file should live (default 24 hours).
   */
  readonly cacheTtlSec?: number | null;
  withCacheTtlSec(cacheTtlSec: number | null): FileListOrderSpec;
  ...
  withForceMultiPart(forceMultiPart: boolean): FileListOrderSpec;
  ...
  withDisableMultiPart(disableMultiPart: boolean): FileListOrderSpec;

  /**
   * Overrides default maximum file size before MultipartUpload kicks in. Default is 1GB
   */
  readonly maximumSingleUploadsize?: number | null;
  withMaximumSingleUploadsize(maximumSingleUploadsize: number | null): FileListOrderSpec;
  ...
  withMaxThreads(maxThreads: number | null): FileListOrderSpec;
  ...
  withMinThreads(minThreads: number | null): FileListOrderSpec;

  /**
   * If set to true, it will retry reading file when the file is not found.
   */
  readonly retryOnNotFound?: boolean;
  withRetryOnNotFound(retryOnNotFound: boolean): FileListOrderSpec;
  ...
  withLockOnWrite(lockOnWrite: boolean): FileListOrderSpec;

  /**
   * If set will use IoExecutor service.
   */
  readonly useIoExecutor?: boolean;
  withUseIoExecutor(useIoExecutor: boolean): FileListOrderSpec;

  /**
   * If not null, retry logic will be used from CloudClient rather than File
   */
  readonly cloudClient?: any;
  withCloudClient(cloudClient: any): FileListOrderSpec;
  ...
  withSerType(serType: IType | null): FileListOrderSpec;

  /**
   * If true then will not use parent folder of content for target type guess.
   */
  readonly doNotUseParentDirForSerType?: boolean;
  withDoNotUseParentDirForSerType(doNotUseParentDirForSerType: boolean): FileListOrderSpec;
  ...
  withUseBinaryEncodingDecoding(useBinaryEncodingDecoding: boolean): FileListOrderSpec;

  /**
   * Optionally indicating if serialized form should contain C3 type.
   */
  readonly shouldNotWriteType?: boolean;
  withShouldNotWriteType(shouldNotWriteType: boolean): FileListOrderSpec;

  /**
   * Optionally indicating if serialized form should be formatted for ease of reading.
   */
  readonly shouldWritePretty?: boolean;
  withShouldWritePretty(shouldWritePretty: boolean): FileListOrderSpec;
  ...
  withGuessMetadata(guessMetadata: boolean): FileListOrderSpec;

  /**
   * If true, checksum files will be generated when writing files
   */
  readonly createChecksum?: boolean;
  withCreateChecksum(createChecksum: boolean): FileListOrderSpec;

  /**
   * Whether to decrypt content during read
   */
  readonly decrypt?: boolean;
  withDecrypt(decrypt: boolean): FileListOrderSpec;
   ...
   * {@link FileListOrderSpec#serType} to indicate what type the order expression is applied to
   */
  readonly filesAreNotOrdered?: boolean;
  withFilesAreNotOrdered(filesAreNotOrdered: boolean): FileListOrderSpec;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): FileListOrderSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): FileListOrderSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): FileListOrderSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): FileListOrderSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): FileListOrderSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FileListOrderSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FileListOrderSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FileListOrderSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FileListOrderSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): FileListOrderSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FileListOrderSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FileListOrderSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FileListOrderSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FileListOrderSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FileListOrderSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): FileListOrderSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FileListOrderSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FileListOrderSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): FileListOrderSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): FileListOrderSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): FileListOrderSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): FileListOrderSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FileListOrderSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): FileListOrderSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FileListOrderSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FileListOrderSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): FileListOrderSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FileListOrderSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): FileListOrderSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FileListOrderSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): FileListOrderSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): FileListOrderSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): FileListOrderSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): FileListOrderSpec;

  mergeJson(json: any | null): FileListOrderSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): FileListOrderSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): FileListOrderSpec;
   ...
   */
  singletonArray(): C3.Array<FileListOrderSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<FileListOrderSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FileListOrderSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<FileListOrderSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FileListOrderSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, FileListOrderSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FileListOrderSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FileListOrderSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FileListOrderSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): FileListOrderSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): FileListOrderSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): FileListOrderSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FileListOrderSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): FileListOrderSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FileListOrderSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): FileListOrderSpec;
   ...
   */
  static cachedEmptyInst(): FileListOrderSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<FileListOrderSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): FileListOrderSpec;

  /**
   * @return new instance of this spec with `retrySpec` set
   */
  withRetry(maxRetries?: number | null, initialSleepMillis?: number | null, exponent?: number | null): FileListOrderSpec | null;

  /**
   * @return instance of this spec with `retrySpec`'s `maxTotalMillis` set
   */
  static timeoutSeconds(secs: number | null): FileListOrderSpec;

  /**
   * @return FileObjsOperSpec with #serType set to provided value.
   */
  static fromType(serType: Type | null): FileListOrderSpec;
   ...
   */
  static toDecrypt(): FileListOrderSpec | null;
}
