// TypeScript definitions for the C3 type TypeId

/**
 * Mapping of types to numeric ids for more efficient storage of references to types in other objs.  The value of the
 * id field will be the typeId for the type with the specified module/type names.
 *
 * @remarks this represents a value passed to a method that expects an instance of TypeId
 */
 ...
 * id field will be the typeId for the type with the specified module/type names.
 *
 * @remarks this represents a made instance of TypeId
 */
declare class TypeId extends Obj {
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): TypeId;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): TypeId;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): TypeId;
  ...
  withVersion(version: number | null): TypeId;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): TypeId;

  /**
   * Type name
   */
  readonly typeName?: string | null;
  withTypeName(typeName: string | null): TypeId;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TypeId | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TypeId | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TypeId | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TypeId | null;
   ...
   */
  replaceType(old: Type, new_: Type): TypeId;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TypeId;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TypeId;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TypeId | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TypeId | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TypeId;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TypeId;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TypeId;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TypeId;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TypeId;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TypeId;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TypeId;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TypeId;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TypeId;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TypeId;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TypeId;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TypeId;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TypeId;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TypeId;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TypeId;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TypeId;
   ...
   * @see #removeField
   */
  unsetField(field: string): TypeId;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TypeId;
   ...
   * @see #unsetField
   */
  removeField(field: string): TypeId;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TypeId;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TypeId;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TypeId;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TypeId;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TypeId;

  mergeJson(json: any | null): TypeId;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TypeId;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TypeId;
   ...
   */
  singletonArray(): C3.Array<TypeId | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TypeId | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TypeId | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TypeId | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TypeId | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TypeId | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TypeId | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TypeId | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TypeId | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TypeId;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TypeId;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TypeId;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TypeId;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TypeId;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TypeId;
   ...
   * @see #fromString
   */
  static make(s: string | null): TypeId | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TypeId;
   ...
   */
  static cachedEmptyInst(): TypeId;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TypeId>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TypeId;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TypeId | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TypeId | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TypeId | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TypeId | null> | null>;
   ...
   */
  get(include?: string | null): TypeId | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TypeId | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TypeId;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TypeId | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TypeId;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TypeId | null;
   ...
   */
  create(spec?: UpsertSpec | null): TypeId | null;
   ...
   */
  static createBatch(objs: C3.Array<TypeId | null> | null, spec?: UpsertSpec | null): ObjList<TypeId | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TypeId | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TypeId | null> | null;
   ...
   */
  update(srcObj?: TypeId | null, spec?: UpsertSpec | null): TypeId | null;
   ...
   */
  upsert(srcObj?: TypeId | null, spec?: UpsertSpec | null): TypeId | null;
   ...
   */
  merge(spec?: MergeSpec | null): TypeId | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TypeId | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TypeId | null;
   ...
   */
  static updateBatch(objs: C3.Array<TypeId | null> | null, srcObjs?: C3.Array<TypeId | null>, spec?: UpsertSpec | null): ObjList<TypeId | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TypeId | null>>, spec?: UpsertSpec | null): ObjList<TypeId | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TypeId | null> | null, srcObjs?: C3.Array<TypeId | null>, spec?: UpsertSpec | null): ObjList<TypeId | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TypeId | null>>, spec?: UpsertSpec | null): ObjList<TypeId | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TypeId | null> | null, spec?: TouchSpec | null): ObjList<TypeId | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TypeId | null> | null, spec?: MergeSpec | null): ObjList<TypeId | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TypeId | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TypeId | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TypeId | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TypeId | null> | null;
   ...
   */
  static mergeAll(mergeObj: TypeId | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TypeId | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TypeId | null> | null, spec?: UpsertSpec | null): ObjList<TypeId | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TypeId | null> | null, spec?: UpsertSpec | null): ObjList<TypeId | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TypeId | null> | null): ObjList<TypeId | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TypeId | null> | null): ObjList<TypeId | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TypeId | null> | null): ObjList<TypeId | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TypeId | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TypeId | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TypeId | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TypeId | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TypeId | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TypeId | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<TypeId | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TypeId | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TypeId | null> | null, callback?: λFunction<TypeId | null, TypeId | null> | null): ObjList<TypeId | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TypeId | null> | null, callback?: λFunction<TypeId | null, TypeId | null> | null): C3.Array<ObjError | null>;
  ...
  /**
   * Gets the id from a type name.
   *
   * @param typeName
   *           Name of type to get type id for.
   *
   * @return requested type id.
   */
  static idFromTypeName(typeName: string): number;

  /**
   * Gets the name of a type from its id.
   *
   * @param id
   *           Id of the type to get the name for.
   *
   * @return the requested type name.
   */
  static typeNameFromId(id: number): string;
}
