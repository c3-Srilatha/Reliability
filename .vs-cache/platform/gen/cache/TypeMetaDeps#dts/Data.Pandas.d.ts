// TypeScript definitions for the C3 type Data.Pandas
 ...
 * @see Data
 *
 * @remarks this represents a value passed to a method that expects an instance of Data.Pandas
 */
...
declare namespace Data {
  export class Pandas extends Obj {
    ...
    withLOCAL_FOLDER_PREFIX(LOCAL_FOLDER_PREFIX: string | null): Data.Pandas;

    /**
     * Dataset which this Data belongs to
     */
    readonly ds: Dataset;
    withDs(ds: IDataset): Data.Pandas;

    /**
     * Id used to reference this Data within the Dataset to which it belongs
     */
    readonly id: string;
    withId(id: string): Data.Pandas;

    /**
     * PySrc that can be executed to re-create this DataImpl.Pandas
     */
    readonly _pySrc?: string | null;
    with_pySrc(_pySrc: string | null): Data.Pandas;

    readonly _fileName?: string | null;
    with_fileName(_fileName: string | null): Data.Pandas;

    /**
     * Tuple of {columnName:[value]} to create a DataImpl.Pandas from
     */
    readonly _tuple?: any;
    with_tuple(_tuple: any): Data.Pandas;

    /**
     * Whether the {@link #tuple} field value types can be fully supported by arrow.
     */
    readonly _arrowSupport?: boolean;
    with_arrowSupport(_arrowSupport: boolean): Data.Pandas;

    /**
     * All DataImpl.Pandas referenced by the pySrc
     */
    readonly _datas?: C3.Set<DataImpl.Pandas | null>;
    with_datas(_datas: C3.Set<DataImpl.Pandas | null> | Array<IDataImpl.Pandas | null>): Data.Pandas;

    /**
     * Pickled Pandas binary
     */
    readonly _binary?: any | null;
    with_binary(_binary: any | null): Data.Pandas;

    /**
     * List of pickled Pandas segments binaries
     */
    readonly _binaries?: C3.Array<any | null>;
    with_binaries(_binaries: C3.Array<any | null> | Array<any | null>): Data.Pandas;

    readonly _numBinarySegments?: number | null;
    with_numBinarySegments(_numBinarySegments: number | null): Data.Pandas;

    /**
     * Type of binary format for reading {@link Data.Persisted}
     */
    readonly _persistedFormat?: string | null;
    with_persistedFormat(_persistedFormat: string | null): Data.Pandas;

    /**
     * see tableName arg for {@link Feature.Store#readData}.
     */
    readonly _tableName?: string | null;
    with_tableName(_tableName: string | null): Data.Pandas;

    /**
     * see id arg for {@link Feature.Store#readData}.
     */
    readonly _tableEntryId?: string | null;
    with_tableEntryId(_tableEntryId: string | null): Data.Pandas;

    /**
     * Mapping of variable names to their values to be used by the PyAst Executor
     */
    readonly _vars?: C3.Map<string | null, any>;
    with_vars(_vars: C3.Map<string | null, any> | {[key: string | null]: any}): Data.Pandas;
    ...
    withMaxSegmentSizeClient(maxSegmentSizeClient: number | null): Data.Pandas;

    /**
     * Stores data as {@link EvalMetricsResult} only if {@link EvalFeatureSpec#toEmr} is set to true.
     */
    readonly _emr?: EvalMetricsResult | null;
    with_emr(_emr: IEvalMetricsResult | null): Data.Pandas;
    ...
    static _read_sql_query(sql: string, url: string, http_path: string, parse_dates?: any): any;
     ...
     */
    replaceType(old: Type, new_: Type): Data.Pandas;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.Pandas | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.Pandas | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.Pandas | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.Pandas | null;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Pandas;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Pandas;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Pandas | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Pandas | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.Pandas;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Pandas;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Pandas;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.Pandas;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.Pandas;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.Pandas;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.Pandas;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.Pandas;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.Pandas;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.Pandas;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.Pandas;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.Pandas;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.Pandas;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.Pandas;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.Pandas;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.Pandas;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.Pandas;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.Pandas;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.Pandas;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.Pandas;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.Pandas;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.Pandas;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.Pandas;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.Pandas;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.Pandas;

    mergeJson(json: any | null): Data.Pandas;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.Pandas;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.Pandas;
     ...
     */
    singletonArray(): C3.Array<Data.Pandas | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.Pandas | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.Pandas | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.Pandas | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.Pandas | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.Pandas | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.Pandas | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.Pandas | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.Pandas | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.Pandas;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.Pandas;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.Pandas;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.Pandas;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.Pandas;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.Pandas;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.Pandas;
     ...
     */
    static cachedEmptyInst(): Data.Pandas;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.Pandas>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.Pandas;
     ...
     */
    toDataRef(ds?: Dataset | null): DataRef;
     ...
     */
    static fromPySrc(pySrc: string, dfs?: C3.Set<DataImpl | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): Data.Pandas | null;
     ...
     */
    static _jsDataProxy(inst: any): Data.Pandas;
     ...
     * @return an instance of Data from the provided collection of {@link Obj}s or {@link Tuple}s
     */
    static fromCollection(col: Collection<Obj | null> | null | Collection<Tuple | null> | null, dataset?: Dataset | null, include?: string | null): Data.Pandas | null;
     ...
     * 1       b 2000-01-02    2.0
     */
    static fromTuple(tuple: Tuple, dataset?: Dataset | null): Data.Pandas | null;
     ...
     */
    static fromBinary(name: string, data: any, dataset?: Dataset | null): Data.Pandas | null;

    static fromBinary(name: string, data: C3.Array<any | null>, dataset?: Dataset | null): Data.Pandas | null;
     ...
     */
    static fromStore(name: string, tableName: string, tableEntryId: string, dataset?: Dataset | null, persistedFormat?: string | null): Data.Pandas | null;

    /**
     * Create an instance of DataImpl.Pandas with the provided name from a pandas binary
     */
    static fromName(name: string, binary: any, dataset?: Dataset | null): Data.Pandas | null;

    /**
     * Create an instance of DataImpl.Pandas with the provided name and pySrc
     */
    static fromName(name: string, pySrc: string, datas?: C3.Set<DataImpl.Pandas | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): Data.Pandas | null;
     ...
     */
    static fromDatasetBinaries(name: string, dataset?: Dataset | null): Data.Pandas | null;

    /**
     * Create an instance of DataImpl.Pandas with the provided name from a pickled binary file specified by fileName
     */
    static fromBinaryFile(name: string, fileName: string, dataset?: Dataset | null): Data.Pandas | null;

    /**
     * Create a new DataImpl.Pandas from a PyAST visitor context.
     * see @DataToPyAstVisitorCtx
     */
    static fromDataToPyAstVisitorCtx(ctx: DataToPyAstVisitorCtx, dataset?: Dataset | null): Data.Pandas | null;
     ...
     */
    static dispatch(pandas: Data.Pandas, name: string, args?: C3.Array<any>, kwargs?: C3.Map<string | null, any>, doNotConvertData?: boolean): any;
     ...
     *         The native pandas value will be converted to the corresponding {@link DataImpl.Pandas} subtype
     */
    static getAttribute(pandas: Data.Pandas, name: string, doNotConvertData?: boolean): any;
     ...
     */
    static evaluate(pandas: Data.Pandas): void;
     ...
     */
    static toBinary(pandas: Data.Pandas): any | null;
     ...
     */
    static storeBinariesInDataset(pandas: Data.Pandas): void;
     ...
     */
    writeArrowBufferToFile(): string | null;
  }
}
