// TypeScript definitions for the C3 type SourceQueueBase

/**
 * Base class for queue async processing of {@link Sources}
 *
 * @remarks this represents a value passed to a method that expects an instance of SourceQueueBase
 */
declare interface ISourceQueueBase<ET> {
}

/**
 * Base class for queue async processing of {@link Sources}
 *
 * @remarks this represents a made instance of SourceQueueBase
 */
declare class SourceQueueBase<ET> {
   ...
   */
  static compute(targetType: Type, entries: C3.Array<ET | null> | null): void;
   ...
   */
  static find(spec?: InvalidationQueue.FindSpec | null): C3.Array<ET | null>;
   ...
   * @return the list of requested entries.
   */
  static findStream(spec?: InvalidationQueue.FindStreamSpec | null): Stream<ET | null>;
   ...
   *           Entries to remove.
   */
  static clearEntries(entries: C3.Array<ET | null> | null): void;
