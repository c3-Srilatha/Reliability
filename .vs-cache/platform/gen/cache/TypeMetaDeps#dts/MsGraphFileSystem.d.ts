// TypeScript definitions for the C3 type MsGraphFileSystem

/**
 * MsGraph based FileSystem implementation to interact with OneDrive and SharePoint.
 * Avoid using it directly - use {@link FileSystem.msgraph} instead.
 *
 * @remarks this represents a value passed to a method that expects an instance of MsGraphFileSystem
 */
declare interface IMsGraphFileSystem {
}
 ...
 * Avoid using it directly - use {@link FileSystem.msgraph} instead.
 *
 * @remarks this represents a made instance of MsGraphFileSystem
 */
declare class MsGraphFileSystem extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): MsGraphFileSystem | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): MsGraphFileSystem | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): MsGraphFileSystem | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): MsGraphFileSystem | null;
   ...
   */
  replaceType(old: Type, new_: Type): MsGraphFileSystem;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): MsGraphFileSystem;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MsGraphFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MsGraphFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MsGraphFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MsGraphFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MsGraphFileSystem | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MsGraphFileSystem | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MsGraphFileSystem | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MsGraphFileSystem | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): MsGraphFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): MsGraphFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MsGraphFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MsGraphFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MsGraphFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MsGraphFileSystem;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): MsGraphFileSystem;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): MsGraphFileSystem;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): MsGraphFileSystem;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): MsGraphFileSystem;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): MsGraphFileSystem;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): MsGraphFileSystem;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): MsGraphFileSystem;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): MsGraphFileSystem;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): MsGraphFileSystem;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): MsGraphFileSystem;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): MsGraphFileSystem;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): MsGraphFileSystem;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): MsGraphFileSystem;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): MsGraphFileSystem;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): MsGraphFileSystem;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): MsGraphFileSystem;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): MsGraphFileSystem;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): MsGraphFileSystem;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): MsGraphFileSystem;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): MsGraphFileSystem;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): MsGraphFileSystem;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): MsGraphFileSystem;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): MsGraphFileSystem;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): MsGraphFileSystem;
   ...
   * @see #unsetField
   */
  defaultField(field: string): MsGraphFileSystem;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): MsGraphFileSystem;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): MsGraphFileSystem;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): MsGraphFileSystem;
   ...
   * @see #removeField
   */
  unsetField(field: string): MsGraphFileSystem;
   ...
   * @see #removeField
   */
  static unsetField(field: string): MsGraphFileSystem;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): MsGraphFileSystem;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): MsGraphFileSystem;
   ...
   * @see #unsetField
   */
  removeField(field: string): MsGraphFileSystem;
   ...
   * @see #unsetField
   */
  static removeField(field: string): MsGraphFileSystem;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): MsGraphFileSystem;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): MsGraphFileSystem;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): MsGraphFileSystem;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): MsGraphFileSystem;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): MsGraphFileSystem;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): MsGraphFileSystem;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): MsGraphFileSystem;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): MsGraphFileSystem;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): MsGraphFileSystem;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): MsGraphFileSystem;

  mergeJson(json: any | null): MsGraphFileSystem;

  static mergeJson(json: any | null): MsGraphFileSystem;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): MsGraphFileSystem;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): MsGraphFileSystem;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): MsGraphFileSystem;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): MsGraphFileSystem;
   ...
   */
  singletonArray(): C3.Array<MsGraphFileSystem | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<MsGraphFileSystem | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<MsGraphFileSystem | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<MsGraphFileSystem | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<MsGraphFileSystem | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<MsGraphFileSystem | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<MsGraphFileSystem | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, MsGraphFileSystem | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, MsGraphFileSystem | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<MsGraphFileSystem | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<MsGraphFileSystem | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<MsGraphFileSystem | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): MsGraphFileSystem;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): MsGraphFileSystem;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): MsGraphFileSystem;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): MsGraphFileSystem;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): MsGraphFileSystem;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): MsGraphFileSystem;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): MsGraphFileSystem;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): MsGraphFileSystem;
   ...
   */
  static cachedEmptyInst(): MsGraphFileSystem;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<MsGraphFileSystem>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): MsGraphFileSystem;
   ...
   */
  makeFile(urlOrEncodedPath: string | null, contentType?: string | null, contentEncoding?: string | null): DriveFile<DriveFileSystem | null>;

  /**
   * Creates instance of file from url or encoded path. Path can be relative, absolute or fully qualified url.
   * Doesn't read metadata nor checks if file exists or not.
   */
  static makeFile(urlOrEncodedPath: string | null, contentType?: string | null, contentEncoding?: string | null): DriveFile<DriveFileSystem | null>;
  ...
  cloudClient(resourceName: string): any;

  static cloudClient(resourceName: string): any;

  outputStream(file?: DriveFile<DriveFileSystem | null> | null, spec?: FileOperationSpec | null): any;

  static outputStream(file?: DriveFile<DriveFileSystem | null> | null, spec?: FileOperationSpec | null): any;

  /**
   * Returns cached configuration object for instance of this file system.
   */
  config(secrets?: boolean): MsGraphConfig;

  /**
   * Returns cached configuration object for instance of this file system.
   */
  static config(secrets?: boolean): MsGraphConfig;
}
