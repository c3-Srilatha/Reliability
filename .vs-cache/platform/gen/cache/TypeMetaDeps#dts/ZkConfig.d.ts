// TypeScript definitions for the C3 type ZkConfig

/**
 * @remarks this represents a value passed to a method that expects an instance of ZkConfig
 */
declare interface IZkConfig {
  ...
  /**
   * flag to enable or disable Zookeeper.metrics()
   */
  metricLoggingEnabled?: boolean;
}

/**
 * @remarks this represents a made instance of ZkConfig
 */
declare class ZkConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): ZkConfig;

  static readonly configOverride?: string | null;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): ZkConfig;
  ...
  withIssues(issues: C3.Array<string | null> | Array<string | null>): ZkConfig;
   ...
   * flag to enable or disable Zookeeper.metrics()
   */
  readonly metricLoggingEnabled?: boolean;
  withMetricLoggingEnabled(metricLoggingEnabled: boolean): ZkConfig;

  /**
   * flag to enable or disable Zookeeper.metrics()
   */
  static readonly metricLoggingEnabled?: boolean;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ZkConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ZkConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ZkConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ZkConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): ZkConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): ZkConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ZkConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ZkConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ZkConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ZkConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ZkConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ZkConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ZkConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ZkConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ZkConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ZkConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ZkConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ZkConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ZkConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ZkConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ZkConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): ZkConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ZkConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): ZkConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ZkConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): ZkConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ZkConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ZkConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ZkConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ZkConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ZkConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): ZkConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ZkConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): ZkConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ZkConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): ZkConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ZkConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): ZkConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ZkConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ZkConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ZkConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): ZkConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ZkConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ZkConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ZkConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): ZkConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ZkConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): ZkConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): ZkConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): ZkConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ZkConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): ZkConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): ZkConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): ZkConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ZkConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): ZkConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ZkConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ZkConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ZkConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): ZkConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ZkConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ZkConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ZkConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ZkConfig;

  mergeJson(json: any | null): ZkConfig;

  static mergeJson(json: any | null): ZkConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ZkConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ZkConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ZkConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): ZkConfig;
   ...
   */
  singletonArray(): C3.Array<ZkConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<ZkConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ZkConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ZkConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ZkConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<ZkConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ZkConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ZkConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ZkConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ZkConfig | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<ZkConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ZkConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ZkConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ZkConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ZkConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ZkConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ZkConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ZkConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ZkConfig;
   ...
   */
  static cachedEmptyInst(): ZkConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ZkConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ZkConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<ZkConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<ZkConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ZkConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): ZkConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): ZkConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): ZkConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): ZkConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): ZkConfig | null;
   ...
   */
  static produce(key: string): ZkConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, ZkConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, ZkConfig | null>;
   ...
   */
  static forConfigKey(configKey: string | null): ZkConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<ZkConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: ZkConfig, override?: string | null): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: ZkConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: ZkConfig, override?: string | null): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: ZkConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): ZkConfig | null;
   ...
   */
  removeSecrets(): ZkConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): ZkConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): ZkConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): ZkConfig | null;
