// TypeScript definitions for the C3 type Unit

/**
 * A library of units offered for use with calculations
 *
 * @remarks this represents a value passed to a method that expects an instance of Unit
 */
declare interface IUnit {
   ...
   */
  components?: C3.Array<UnitComponent | null> | Array<IUnitComponent | null>;
   ...
   */
  customConverters?: C3.Array<CustomUnitConvertor | null> | Array<ICustomUnitConvertor | null>;
 ...
 * A library of units offered for use with calculations
 *
 * @remarks this represents a made instance of Unit
 */
declare class Unit extends Obj {
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Unit;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): Unit;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): Unit;
  ...
  withVersion(version: number | null): Unit;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): Unit;
  ...
  withUserUpdatedFields(userUpdatedFields: C3.Array<string | null> | Array<string | null>): Unit;
  ...
  withHidden(hidden: boolean): Unit;
  ...
  withUserOwned(userOwned: boolean): Unit;

  /**
   * symbol of the given unit
   */
  readonly symbol?: string | null;
  withSymbol(symbol: string | null): Unit;

  /**
   * Components comprised in the unit
   */
  readonly components?: C3.Array<UnitComponent | null>;
  withComponents(components: C3.Array<UnitComponent | null> | Array<IUnitComponent | null>): Unit;

  /**
   * Custom converters from current Unit to other Unit(s).
   * These converters include custom unit transformation logic in the form of expressions.
   */
  readonly customConverters?: C3.Array<CustomUnitConvertor | null>;
  withCustomConverters(customConverters: C3.Array<CustomUnitConvertor | null> | Array<ICustomUnitConvertor | null>): Unit;

  /**
   * Translated name.
   */
  readonly translatedName?: string | null;
  withTranslatedName(translatedName: string | null): Unit;

  /**
   * Translated symbol.
   */
  readonly translatedSymbol?: string | null;
  withTranslatedSymbol(translatedSymbol: string | null): Unit;
  ...
  withConcept(concept: string | null): Unit;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Unit | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Unit | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Unit | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Unit | null;
   ...
   */
  replaceType(old: Type, new_: Type): Unit;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Unit;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Unit;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Unit | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Unit | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Unit;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Unit;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Unit;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Unit;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Unit;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Unit;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Unit;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Unit;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Unit;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Unit;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Unit;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Unit;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Unit;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Unit;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Unit;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Unit;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Unit;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Unit;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Unit;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Unit;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Unit;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Unit;

  mergeJson(json: any | null): Unit;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Unit;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Unit;
   ...
   */
  singletonArray(): C3.Array<Unit | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Unit | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Unit | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Unit | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Unit | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Unit | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Unit | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Unit | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Unit | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Unit;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Unit;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Unit;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Unit;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Unit;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Unit;
   ...
   * @see #fromString
   */
  static make(s: string | null): Unit | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Unit;
   ...
   */
  static cachedEmptyInst(): Unit;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Unit>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Unit;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<Unit | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<Unit | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<Unit | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): Unit | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string | null): Unit | null;
   ...
   */
  static produce(key: string): Unit | null;
   ...
   */
  static produceAll(): C3.Map<string | null, Unit | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, Unit | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<Unit | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<Unit | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Unit | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Unit | null> | null>;
   ...
   */
  get(include?: string | null): Unit | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): Unit | null;
   ...
   */
  getMissing(spec: GetMissingSpec): Unit;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): Unit | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): Unit;
   ...
   * @see #toString
   */
  static fromString(s: string | null): Unit | null;
   ...
   */
  create(spec?: UpsertSpec | null): Unit | null;
   ...
   */
  static createBatch(objs: C3.Array<Unit | null> | null, spec?: UpsertSpec | null): ObjList<Unit | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<Unit | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Unit | null> | null;
   ...
   */
  update(srcObj?: Unit | null, spec?: UpsertSpec | null): Unit | null;
   ...
   */
  upsert(srcObj?: Unit | null, spec?: UpsertSpec | null): Unit | null;
   ...
   */
  merge(spec?: MergeSpec | null): Unit | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): Unit | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): Unit | null;
   ...
   */
  static updateBatch(objs: C3.Array<Unit | null> | null, srcObjs?: C3.Array<Unit | null>, spec?: UpsertSpec | null): ObjList<Unit | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<Unit | null>>, spec?: UpsertSpec | null): ObjList<Unit | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<Unit | null> | null, srcObjs?: C3.Array<Unit | null>, spec?: UpsertSpec | null): ObjList<Unit | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<Unit | null>>, spec?: UpsertSpec | null): ObjList<Unit | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<Unit | null> | null, spec?: TouchSpec | null): ObjList<Unit | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Unit | null> | null, spec?: MergeSpec | null): ObjList<Unit | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Unit | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Unit | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<Unit | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Unit | null> | null;
   ...
   */
  static mergeAll(mergeObj: Unit | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: Unit | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<Unit | null> | null, spec?: UpsertSpec | null): ObjList<Unit | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<Unit | null> | null, spec?: UpsertSpec | null): ObjList<Unit | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<Unit | null> | null): ObjList<Unit | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<Unit | null> | null): ObjList<Unit | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<Unit | null> | null): ObjList<Unit | null>;
   ...
   */
  static afterCreate(objs: C3.Array<Unit | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<Unit | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<Unit | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<Unit | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Unit | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): Unit | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<Unit | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: Unit | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<Unit | null> | null, callback?: λFunction<Unit | null, Unit | null> | null): ObjList<Unit | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<Unit | null> | null, callback?: λFunction<Unit | null, Unit | null> | null): C3.Array<ObjError | null>;
   ...
   */
  publish(subPath?: string | null, contentType?: string | null): Unit;
   ...
   */
  static removeSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<Unit | null> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec | null): Unit | null;
   ...
   */
  static createSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<Unit | null> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData | null, spec?: UpsertSpec | null): Unit | null;
   ...
   */
  static updateSeedDataBatch(objs?: C3.Array<SeedData | null>, srcObjs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<Unit | null> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec | null): Unit | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: C3.Array<SeedData | null>, spec?: MergeSpec | null): ObjList<Unit | null> | null;
  ...
  dependencies(): SeedDataDeps<Unit | null> | null;
   ...
   */
  static hasCycles(unit: Unit): boolean;

  /**
   * validate the graph
   */
  static validateGraph(): string | null;

  /**
   * Get units that the given unit can be converted to
   */
  static getConvertableUnits(unit: Unit): C3.Array<Unit | null>;

  /**
   * Is the unit convertible to the other unit
   */
  static isConvertable(unit: Unit, desiredUnit: Unit): boolean;

  /**
   * Is the unit convertible to the other unit
   */
  isConvertible(other: Unit): boolean;

  /**
   * Conversion factor in between the two units
   */
  conversionFactor(other: Unit): number | null;

  /**
   * Conversion factor in between the two units
   */
  static getConversionFactor(unit: Unit, desiredUnit: Unit): number | null;

  customConverter(destinationUnit: Unit): λFunction<number | null, number | null> | null;

  hasCustomConverter(destinationUnit: Unit): boolean;
   ...
   */
  relationship(desired: Unit): Unit | null;

  /**
   * Is the given unit equivalent to the other unit
   */
  equivalentTo(other: Unit): boolean;
   ...
   */
  combine(other: Unit): Unit | null;

  /**
   * apply the given power to the unit
   */
  pow(power: number): Unit | null;
   ...
   */
  safeSymbol(): string | null;

  /**
   * Returns null unit
   */
  static nullUnit(): Unit;
}
