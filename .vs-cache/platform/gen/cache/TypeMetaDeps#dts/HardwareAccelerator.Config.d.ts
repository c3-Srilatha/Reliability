// TypeScript definitions for the C3 type HardwareAccelerator.Config

/**
 * Base configuration file for {@link HardwareAccelerator}s.
 *
 * @remarks this represents a value passed to a method that expects an instance of HardwareAccelerator.Config
 */
declare namespace HardwareAccelerator {
...
declare namespace HardwareAccelerator {
  export class Config extends Obj {
    ...
    withName(name: string): HardwareAccelerator.Config;

    readonly configOverride?: string | null;
    withConfigOverride(configOverride: string | null): HardwareAccelerator.Config;

    readonly secretOverride?: string | null;
    withSecretOverride(secretOverride: string | null): HardwareAccelerator.Config;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: C3.Array<string | null>;
    withIssues(issues: C3.Array<string | null> | Array<string | null>): HardwareAccelerator.Config;

    /**
     * Vendor of this {@link HardwareAccelerator}.
     */
    readonly vendor: string;
    withVendor(vendor: string): HardwareAccelerator.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): HardwareAccelerator.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): HardwareAccelerator.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): HardwareAccelerator.Config | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): HardwareAccelerator.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): HardwareAccelerator.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HardwareAccelerator.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HardwareAccelerator.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HardwareAccelerator.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HardwareAccelerator.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): HardwareAccelerator.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HardwareAccelerator.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HardwareAccelerator.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): HardwareAccelerator.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): HardwareAccelerator.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): HardwareAccelerator.Config;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): HardwareAccelerator.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): HardwareAccelerator.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): HardwareAccelerator.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): HardwareAccelerator.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): HardwareAccelerator.Config;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): HardwareAccelerator.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): HardwareAccelerator.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): HardwareAccelerator.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): HardwareAccelerator.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): HardwareAccelerator.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): HardwareAccelerator.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): HardwareAccelerator.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): HardwareAccelerator.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): HardwareAccelerator.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): HardwareAccelerator.Config;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): HardwareAccelerator.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): HardwareAccelerator.Config;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): HardwareAccelerator.Config;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): HardwareAccelerator.Config;

    mergeJson(json: any | null): HardwareAccelerator.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): HardwareAccelerator.Config;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): HardwareAccelerator.Config;
     ...
     */
    singletonArray(): C3.Array<HardwareAccelerator.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<HardwareAccelerator.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<HardwareAccelerator.Config | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<HardwareAccelerator.Config | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<HardwareAccelerator.Config | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, HardwareAccelerator.Config | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, HardwareAccelerator.Config | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<HardwareAccelerator.Config | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<HardwareAccelerator.Config | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): HardwareAccelerator.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): HardwareAccelerator.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): HardwareAccelerator.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): HardwareAccelerator.Config;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): HardwareAccelerator.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): HardwareAccelerator.Config;
     ...
     * @see #fromString
     */
    static make(s: string | null): HardwareAccelerator.Config | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): HardwareAccelerator.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): HardwareAccelerator.Config;
     ...
     */
    static cachedEmptyInst(): HardwareAccelerator.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<HardwareAccelerator.Config>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): HardwareAccelerator.Config;
     ...
     * @see #toString
     */
    static fromString(s: string | null): HardwareAccelerator.Config | null;
     ...
     */
    static forName(name: string | null, failIfMissing?: boolean): HardwareAccelerator.Config | null;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<HardwareAccelerator.Config | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<HardwareAccelerator.Config | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<HardwareAccelerator.Config | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): HardwareAccelerator.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string | null): HardwareAccelerator.Config | null;
     ...
     * @see findByCacheKey
     */
    getCached(): HardwareAccelerator.Config | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): HardwareAccelerator.Config | null;
     ...
     */
    static produce(key: string): HardwareAccelerator.Config | null;
     ...
     */
    static produceAll(): C3.Map<string | null, HardwareAccelerator.Config | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, HardwareAccelerator.Config | null>;
     ...
     */
    getConfig(): HardwareAccelerator.Config;
     ...
     */
    getSecret(): HardwareAccelerator.Config;
     ...
     */
    static forConfigKey(configKey: string | null): HardwareAccelerator.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<HardwareAccelerator.Config | null>;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: HardwareAccelerator.Config, override?: string | null): void;
     ...
     * @see setSecretValue
     */
    setSecretValues(from: HardwareAccelerator.Config, override?: string | null): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): HardwareAccelerator.Config | null;
