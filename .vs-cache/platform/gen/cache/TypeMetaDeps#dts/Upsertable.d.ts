// TypeScript definitions for the C3 type Upsertable

/**
 * Type containing functions for upsert operations (e.g. create/upsert/update/merge and their batch equivalents).
 *
 * @remarks this represents a value passed to a method that expects an instance of Upsertable
 */
declare interface IUpsertable {
 ...
 * Type containing functions for upsert operations (e.g. create/upsert/update/merge and their batch equivalents).
 *
 * @remarks this represents a made instance of Upsertable
 */
declare class Upsertable extends Obj {

  /**
   * The id of this instance.
   */
  readonly id?: string | null;
  withId(id: string | null): Upsertable;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Upsertable | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Upsertable | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Upsertable | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Upsertable | null;
   ...
   */
  replaceType(old: Type, new_: Type): Upsertable;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Upsertable;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Upsertable;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Upsertable | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Upsertable | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Upsertable;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Upsertable;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Upsertable;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): Upsertable;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Upsertable;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Upsertable;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Upsertable;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Upsertable;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Upsertable;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Upsertable;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Upsertable;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Upsertable;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Upsertable;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Upsertable;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Upsertable;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Upsertable;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Upsertable;
   ...
   * @see #removeField
   */
  unsetField(field: string): Upsertable;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Upsertable;
   ...
   * @see #unsetField
   */
  removeField(field: string): Upsertable;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Upsertable;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Upsertable;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Upsertable;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Upsertable;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Upsertable;

  mergeJson(json: any | null): Upsertable;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Upsertable;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Upsertable;
   ...
   */
  singletonArray(): C3.Array<Upsertable | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Upsertable | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Upsertable | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Upsertable | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Upsertable | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Upsertable | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Upsertable | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Upsertable | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Upsertable | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Upsertable;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Upsertable;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Upsertable;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Upsertable;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Upsertable;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Upsertable;
   ...
   * @see #fromString
   */
  static make(s: string | null): Upsertable | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Upsertable;
   ...
   */
  static cachedEmptyInst(): Upsertable;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Upsertable>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Upsertable;
   ...
   * @see #toString
   */
  static fromString(s: string | null): Upsertable | null;
   ...
   */
  create(spec?: UpsertSpec | null): Upsertable | null;
   ...
   */
  static createBatch(objs: C3.Array<Upsertable | null> | null, spec?: UpsertSpec | null): ObjList<Upsertable | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<Upsertable | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Upsertable | null> | null;
   ...
   */
  update(srcObj?: Upsertable | null, spec?: UpsertSpec | null): Upsertable | null;
   ...
   */
  upsert(srcObj?: Upsertable | null, spec?: UpsertSpec | null): Upsertable | null;
   ...
   */
  merge(spec?: MergeSpec | null): Upsertable | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): Upsertable | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): Upsertable | null;
   ...
   */
  static updateBatch(objs: C3.Array<Upsertable | null> | null, srcObjs?: C3.Array<Upsertable | null>, spec?: UpsertSpec | null): ObjList<Upsertable | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<Upsertable | null>>, spec?: UpsertSpec | null): ObjList<Upsertable | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<Upsertable | null> | null, srcObjs?: C3.Array<Upsertable | null>, spec?: UpsertSpec | null): ObjList<Upsertable | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<Upsertable | null>>, spec?: UpsertSpec | null): ObjList<Upsertable | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<Upsertable | null> | null, spec?: TouchSpec | null): ObjList<Upsertable | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Upsertable | null> | null, spec?: MergeSpec | null): ObjList<Upsertable | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Upsertable | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Upsertable | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<Upsertable | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Upsertable | null> | null;
   ...
   */
  static mergeAll(mergeObj: Upsertable | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: Upsertable | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
}
