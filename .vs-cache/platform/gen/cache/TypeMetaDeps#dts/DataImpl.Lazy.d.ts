// TypeScript definitions for the C3 type DataImpl.Lazy

/**
 * Parent type for lazy DataImpl mixins
 *
 * @remarks this represents a value passed to a method that expects an instance of DataImpl.Lazy
 */
...
declare namespace DataImpl {
  export class Lazy extends Obj {
    ...
    withSTATELESS_CACHE(STATELESS_CACHE: string | null): DataImpl.Lazy;
     ...
     */
    readonly this: any;
    withThis(this_: any): DataImpl.Lazy;

    /**
     * Target action returning DataImpl
     */
    readonly action: string;
    withAction(action: string): DataImpl.Lazy;

    /**
     * Applied arguments
     */
    readonly args?: C3.Map<string | null, any>;
    withArgs(args: C3.Map<string | null, any> | {[key: string | null]: any}): DataImpl.Lazy;
    ...
    with_inferredOutType(_inferredOutType: C3.Map<string | null, ValueType | null> | {[key: string | null]: IValueType | null}): DataImpl.Lazy;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): DataImpl.Lazy | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): DataImpl.Lazy | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): DataImpl.Lazy | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): DataImpl.Lazy | null;
     ...
     */
    replaceType(old: Type, new_: Type): DataImpl.Lazy;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataImpl.Lazy;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataImpl.Lazy;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataImpl.Lazy | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataImpl.Lazy | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataImpl.Lazy;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataImpl.Lazy;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataImpl.Lazy;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): DataImpl.Lazy;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): DataImpl.Lazy;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): DataImpl.Lazy;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataImpl.Lazy;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataImpl.Lazy;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): DataImpl.Lazy;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): DataImpl.Lazy;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): DataImpl.Lazy;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): DataImpl.Lazy;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataImpl.Lazy;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): DataImpl.Lazy;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataImpl.Lazy;
     ...
     * @see #unsetField
     */
    defaultField(field: string): DataImpl.Lazy;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): DataImpl.Lazy;
     ...
     * @see #removeField
     */
    unsetField(field: string): DataImpl.Lazy;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): DataImpl.Lazy;
     ...
     * @see #unsetField
     */
    removeField(field: string): DataImpl.Lazy;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): DataImpl.Lazy;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataImpl.Lazy;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): DataImpl.Lazy;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataImpl.Lazy;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataImpl.Lazy;

    mergeJson(json: any | null): DataImpl.Lazy;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataImpl.Lazy;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): DataImpl.Lazy;
     ...
     */
    singletonArray(): C3.Array<DataImpl.Lazy | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<DataImpl.Lazy | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<DataImpl.Lazy | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<DataImpl.Lazy | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<DataImpl.Lazy | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, DataImpl.Lazy | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataImpl.Lazy | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<DataImpl.Lazy | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<DataImpl.Lazy | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DataImpl.Lazy;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DataImpl.Lazy;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DataImpl.Lazy;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): DataImpl.Lazy;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DataImpl.Lazy;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): DataImpl.Lazy;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DataImpl.Lazy;
     ...
     */
    static cachedEmptyInst(): DataImpl.Lazy;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DataImpl.Lazy>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): DataImpl.Lazy;
     ...
     */
    static fromPySrc(pySrc: string, dfs?: C3.Set<DataImpl | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): DataImpl.Lazy | null;
     ...
     */
    static _jsDataProxy(inst: any): DataImpl.Lazy;
     ...
     */
    static create(this_: any, action: string, args?: C3.Map<string | null, any>): DataImpl.Lazy;
