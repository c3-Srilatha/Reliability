// TypeScript definitions for the C3 type GraphConfig

/**
 * Type to specify configuration for {@link Graph} processing per {@link Graph} sub-type.
 *
 * @remarks this represents a value passed to a method that expects an instance of GraphConfig
 */
declare interface IGraphConfig {
  ...
  /**
   * Disable computation of secondary index on graph loading
   */
  disableSecondaryIndex?: boolean;

  /**
   * Setting this configuration indicates the graph engine to cache graph in persistence storage rather than in memory
   */
  persistenceCacheEnabled?: boolean;

  /**
   * If the graph is stored in persistence cache, the location where the files are stored.
   * E.g. s3://c3--env-tenant-tag/myGraphType/
   */
  persistedGraphFilePath?: string | null;

  /**
   * Whether to enable FastGraph implementation.
   */
  fastGraphEnabled?: boolean;
}

/**
 * Type to specify configuration for {@link Graph} processing per {@link Graph} sub-type.
 *
 * @remarks this represents a made instance of GraphConfig
 */
declare class GraphConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): GraphConfig;

  static readonly configOverride?: string | null;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): GraphConfig;
  ...
  withIssues(issues: C3.Array<string | null> | Array<string | null>): GraphConfig;
   ...
   * Disable computation of secondary index on graph loading
   */
  readonly disableSecondaryIndex?: boolean;
  withDisableSecondaryIndex(disableSecondaryIndex: boolean): GraphConfig;

  /**
   * Disable computation of secondary index on graph loading
   */
  static readonly disableSecondaryIndex?: boolean;

  /**
   * Setting this configuration indicates the graph engine to cache graph in persistence storage rather than in memory
   */
  readonly persistenceCacheEnabled?: boolean;
  withPersistenceCacheEnabled(persistenceCacheEnabled: boolean): GraphConfig;

  /**
   * Setting this configuration indicates the graph engine to cache graph in persistence storage rather than in memory
   */
  static readonly persistenceCacheEnabled?: boolean;

  /**
   * If the graph is stored in persistence cache, the location where the files are stored.
   * E.g. s3://c3--env-tenant-tag/myGraphType/
   */
  readonly persistedGraphFilePath?: string | null;
  withPersistedGraphFilePath(persistedGraphFilePath: string | null): GraphConfig;

  /**
   * If the graph is stored in persistence cache, the location where the files are stored.
   * E.g. s3://c3--env-tenant-tag/myGraphType/
   */
  static readonly persistedGraphFilePath?: string | null;

  /**
   * Whether to enable FastGraph implementation.
   */
  readonly fastGraphEnabled?: boolean;
  withFastGraphEnabled(fastGraphEnabled: boolean): GraphConfig;

  /**
   * Whether to enable FastGraph implementation.
   */
  static readonly fastGraphEnabled?: boolean;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): GraphConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): GraphConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): GraphConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): GraphConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): GraphConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): GraphConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): GraphConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): GraphConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): GraphConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): GraphConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<GraphConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<GraphConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<GraphConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<GraphConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): GraphConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): GraphConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GraphConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GraphConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GraphConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GraphConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): GraphConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): GraphConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): GraphConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): GraphConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): GraphConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): GraphConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): GraphConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): GraphConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GraphConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GraphConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): GraphConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): GraphConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): GraphConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): GraphConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): GraphConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): GraphConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): GraphConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): GraphConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): GraphConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): GraphConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): GraphConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): GraphConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): GraphConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): GraphConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): GraphConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): GraphConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): GraphConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): GraphConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): GraphConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): GraphConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): GraphConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): GraphConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): GraphConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): GraphConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): GraphConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): GraphConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): GraphConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): GraphConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): GraphConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): GraphConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): GraphConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): GraphConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): GraphConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): GraphConfig;

  mergeJson(json: any | null): GraphConfig;

  static mergeJson(json: any | null): GraphConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): GraphConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): GraphConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): GraphConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): GraphConfig;
   ...
   */
  singletonArray(): C3.Array<GraphConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<GraphConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<GraphConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<GraphConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<GraphConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<GraphConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<GraphConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, GraphConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, GraphConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<GraphConfig | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<GraphConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<GraphConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): GraphConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): GraphConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): GraphConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): GraphConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): GraphConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): GraphConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): GraphConfig;
   ...
   */
  static cachedEmptyInst(): GraphConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<GraphConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): GraphConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<GraphConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<GraphConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<GraphConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): GraphConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): GraphConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): GraphConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): GraphConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): GraphConfig | null;
   ...
   */
  static produce(key: string): GraphConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, GraphConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, GraphConfig | null>;
   ...
   */
  static forConfigKey(configKey: string | null): GraphConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<GraphConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: GraphConfig, override?: string | null): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: GraphConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: GraphConfig, override?: string | null): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: GraphConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): GraphConfig | null;
   ...
   */
  removeSecrets(): GraphConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): GraphConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): GraphConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): GraphConfig | null;
