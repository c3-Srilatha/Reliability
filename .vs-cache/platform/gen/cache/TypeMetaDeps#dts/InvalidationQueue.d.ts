// TypeScript definitions for the C3 type InvalidationQueue

/**
 * See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
 *
 * @remarks this represents a value passed to a method that expects an instance of InvalidationQueue
 */
declare interface IInvalidationQueue<ET> {
}

/**
 * See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
 *
 * @remarks this represents a made instance of InvalidationQueue
 */
declare class InvalidationQueue<ET> {
