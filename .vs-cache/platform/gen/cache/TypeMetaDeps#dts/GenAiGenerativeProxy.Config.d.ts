// TypeScript definitions for the C3 type GenAiGenerativeProxy.Config
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of GenAiGenerativeProxy.Config
 */
declare namespace GenAiGenerativeProxy {
...
declare namespace GenAiGenerativeProxy {
  export class Config extends Obj {
    ...
    withConfigOverride(configOverride: string | null): GenAiGenerativeProxy.Config;

    readonly secretOverride?: string | null;
    withSecretOverride(secretOverride: string | null): GenAiGenerativeProxy.Config;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: C3.Array<string | null>;
    withIssues(issues: C3.Array<string | null> | Array<string | null>): GenAiGenerativeProxy.Config;

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): GenAiGenerativeProxy.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): GenAiGenerativeProxy.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): GenAiGenerativeProxy.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): GenAiGenerativeProxy.Config | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): GenAiGenerativeProxy.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenAiGenerativeProxy.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): GenAiGenerativeProxy.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): GenAiGenerativeProxy.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<GenAiGenerativeProxy.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<GenAiGenerativeProxy.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): GenAiGenerativeProxy.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenAiGenerativeProxy.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenAiGenerativeProxy.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenAiGenerativeProxy.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenAiGenerativeProxy.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenAiGenerativeProxy.Config;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): GenAiGenerativeProxy.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenAiGenerativeProxy.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenAiGenerativeProxy.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): GenAiGenerativeProxy.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): GenAiGenerativeProxy.Config;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): GenAiGenerativeProxy.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): GenAiGenerativeProxy.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenAiGenerativeProxy.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): GenAiGenerativeProxy.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenAiGenerativeProxy.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenAiGenerativeProxy.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenAiGenerativeProxy.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenAiGenerativeProxy.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenAiGenerativeProxy.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenAiGenerativeProxy.Config;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): GenAiGenerativeProxy.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): GenAiGenerativeProxy.Config;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): GenAiGenerativeProxy.Config;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): GenAiGenerativeProxy.Config;

    mergeJson(json: any | null): GenAiGenerativeProxy.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): GenAiGenerativeProxy.Config;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): GenAiGenerativeProxy.Config;
     ...
     */
    singletonArray(): C3.Array<GenAiGenerativeProxy.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<GenAiGenerativeProxy.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenAiGenerativeProxy.Config | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<GenAiGenerativeProxy.Config | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenAiGenerativeProxy.Config | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, GenAiGenerativeProxy.Config | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenAiGenerativeProxy.Config | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenAiGenerativeProxy.Config | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenAiGenerativeProxy.Config | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): GenAiGenerativeProxy.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): GenAiGenerativeProxy.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): GenAiGenerativeProxy.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenAiGenerativeProxy.Config;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): GenAiGenerativeProxy.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenAiGenerativeProxy.Config;
     ...
     * @see #fromString
     */
    static make(s: string | null): GenAiGenerativeProxy.Config | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): GenAiGenerativeProxy.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenAiGenerativeProxy.Config;
     ...
     */
    static cachedEmptyInst(): GenAiGenerativeProxy.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<GenAiGenerativeProxy.Config>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): GenAiGenerativeProxy.Config;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<GenAiGenerativeProxy.Config | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<GenAiGenerativeProxy.Config | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<GenAiGenerativeProxy.Config | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): GenAiGenerativeProxy.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string | null): GenAiGenerativeProxy.Config | null;
     ...
     * @see findByCacheKey
     */
    getCached(): GenAiGenerativeProxy.Config | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): GenAiGenerativeProxy.Config | null;
     ...
     */
    static produce(key: string): GenAiGenerativeProxy.Config | null;
     ...
     */
    static produceAll(): C3.Map<string | null, GenAiGenerativeProxy.Config | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, GenAiGenerativeProxy.Config | null>;
     ...
     */
    getConfig(): GenAiGenerativeProxy.Config;
     ...
     */
    getSecret(): GenAiGenerativeProxy.Config;
     ...
     */
    static forConfigKey(configKey: string | null): GenAiGenerativeProxy.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<GenAiGenerativeProxy.Config | null>;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: GenAiGenerativeProxy.Config, override?: string | null): void;
     ...
     * @see setSecretValue
     */
    setSecretValues(from: GenAiGenerativeProxy.Config, override?: string | null): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): GenAiGenerativeProxy.Config | null;
     ...
     * @see #toString
     */
    static fromString(s: string | null): GenAiGenerativeProxy.Config | null;

    /**
     * Finds {@link GenerativeProxy.Config config} by name.
     */
    static forName(name: string | null, failIfMissing?: boolean): GenAiGenerativeProxy.Config | null;

    /**
     * Return type of the {@link GenerativeProxy proxy} corresponding to this config.
     */
    get proxyType(): Type | null;
  }
}
