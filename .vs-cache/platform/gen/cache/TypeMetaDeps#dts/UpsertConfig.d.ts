// TypeScript definitions for the C3 type UpsertConfig

/**
 * @remarks this represents a value passed to a method that expects an instance of UpsertConfig
 */
declare interface IUpsertConfig {
  ...
  /**
   * If false, then during updates, if no values have changed, other than `meta.updated`, then the update operation will
   * be a no-op and the new `meta.updated` will not be retained.  If true, then the obj will be updated with the new
   * `meta.updated` value in this case.
   */
  retainLatestTimestamp?: boolean;
}

/**
 * @remarks this represents a made instance of UpsertConfig
 */
declare class UpsertConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): UpsertConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): UpsertConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): UpsertConfig;
   ...
   * `meta.updated` value in this case.
   */
  readonly retainLatestTimestamp?: boolean;
  withRetainLatestTimestamp(retainLatestTimestamp: boolean): UpsertConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UpsertConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UpsertConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UpsertConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UpsertConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): UpsertConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UpsertConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UpsertConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UpsertConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UpsertConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UpsertConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UpsertConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UpsertConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UpsertConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UpsertConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UpsertConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UpsertConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UpsertConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UpsertConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UpsertConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UpsertConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UpsertConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UpsertConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UpsertConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UpsertConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UpsertConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UpsertConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): UpsertConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UpsertConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): UpsertConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UpsertConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UpsertConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UpsertConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UpsertConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UpsertConfig;

  mergeJson(json: any | null): UpsertConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UpsertConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UpsertConfig;
   ...
   */
  singletonArray(): C3.Array<UpsertConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UpsertConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UpsertConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UpsertConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UpsertConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UpsertConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UpsertConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UpsertConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UpsertConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UpsertConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UpsertConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UpsertConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UpsertConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UpsertConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UpsertConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UpsertConfig;
   ...
   */
  static cachedEmptyInst(): UpsertConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UpsertConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UpsertConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<UpsertConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<UpsertConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<UpsertConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): UpsertConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): UpsertConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): UpsertConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): UpsertConfig | null;
   ...
   */
  static produce(key: string): UpsertConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, UpsertConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, UpsertConfig | null>;
   ...
   */
  static forConfigKey(configKey: string | null): UpsertConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<UpsertConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: UpsertConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: UpsertConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): UpsertConfig | null;
