// TypeScript definitions for the C3 type BooleanType

/**
 * The boolean value typically is just `true` or `false`.
 *
 * However using the `?boolean` declaration, the value can be set as `null` (for a tri-state).
 *
 * There are no fields (other than #modifier), so this is normally accessed with {@link PrimitiveType#ofBool}.
 *
 * @remarks this represents a value passed to a method that expects an instance of BooleanType
 */
declare interface IBooleanType {
 ...
 * There are no fields (other than #modifier), so this is normally accessed with {@link PrimitiveType#ofBool}.
 *
 * @remarks this represents a made instance of BooleanType
 */
declare class BooleanType extends Obj {

  /**
   * Source file Pkg.Path a C3 Type declaration [.c3typ].
   */
  readonly declaredPkgPath?: string | null;
  withDeclaredPkgPath(declaredPkgPath: string | null): BooleanType;

  /**
   * Source line number in a C3 Type declaration [.c3typ] file starting with 1 where this metadata element is declared.
   */
  readonly declaredSrcLine?: number | null;
  withDeclaredSrcLine(declaredSrcLine: number | null): BooleanType;
  ...
  withDeclaredSrcCharInLine(declaredSrcCharInLine: number | null): BooleanType;
   ...
   */
  readonly pkg: Pkg;
  withPkg(pkg: IPkg): BooleanType;

  /**
   * SDK json representing instance of this type
   */
  readonly json?: any;
  withJson(json: any): BooleanType;

  /**
   * The set of annotations defined on this element of metadata represented as json value.
   */
  readonly annotationsJson?: any | null;
  withAnnotationsJson(annotationsJson: any | null): BooleanType;
  ...
  withModifier(modifier: string | null): BooleanType;
  ...
  withName(name: string): BooleanType;
  ...
  withSerializedType(serializedType: IValueType | null): BooleanType;
  ...
  withEnumRefType(enumRefType: IReferenceType | null): BooleanType;
  ...
  withDeclaredEnumValues(declaredEnumValues: C3.Array<string | null> | Array<string | null>): BooleanType;
   ...
   */
  replaceType(old: Type, new_: Type): BooleanType;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): BooleanType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): BooleanType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): BooleanType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): BooleanType | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BooleanType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BooleanType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BooleanType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BooleanType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): BooleanType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BooleanType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BooleanType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): BooleanType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): BooleanType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): BooleanType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): BooleanType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BooleanType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): BooleanType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): BooleanType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): BooleanType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): BooleanType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): BooleanType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): BooleanType;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): BooleanType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): BooleanType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): BooleanType;
   ...
   * @see #removeField
   */
  unsetField(field: string): BooleanType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): BooleanType;
   ...
   * @see #unsetField
   */
  removeField(field: string): BooleanType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): BooleanType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): BooleanType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): BooleanType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): BooleanType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): BooleanType;

  mergeJson(json: any | null): BooleanType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): BooleanType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): BooleanType;
   ...
   */
  singletonArray(): C3.Array<BooleanType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<BooleanType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BooleanType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<BooleanType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BooleanType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, BooleanType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BooleanType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BooleanType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BooleanType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): BooleanType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): BooleanType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): BooleanType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): BooleanType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): BooleanType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): BooleanType;
   ...
   * @see #fromString
   */
  static make(s: string | null): BooleanType | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): BooleanType;
   ...
   */
  static cachedEmptyInst(): BooleanType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<BooleanType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): BooleanType;
   ...
   */
  withoutDeclaredSrcPos(recursive?: boolean): BooleanType;
   ...
   */
  withAnnotation(ann: Annotation): BooleanType;
   ...
   *         value for the field
   */
  withAnnotation(ann: string, annField?: string | null, value?: any): BooleanType;
   ...
   * @see #toString
   */
  static fromString(s: string | null): BooleanType | null;
