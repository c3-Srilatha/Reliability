// TypeScript definitions for the C3 type Data.Rolling.Lazy

/**
 * @remarks this represents a value passed to a method that expects an instance of Data.Rolling.Lazy
 */
declare namespace Data.Rolling {
...
declare namespace Data.Rolling {
  export class Lazy extends Obj {
    ...
    withSTATELESS_CACHE(STATELESS_CACHE: string | null): Data.Rolling.Lazy;
     ...
     */
    readonly this: any;
    withThis(this_: any): Data.Rolling.Lazy;

    /**
     * Target action returning DataImpl
     */
    readonly action: string;
    withAction(action: string): Data.Rolling.Lazy;

    /**
     * Applied arguments
     */
    readonly args?: C3.Map<string | null, any>;
    withArgs(args: C3.Map<string | null, any> | {[key: string | null]: any}): Data.Rolling.Lazy;
    ...
    with_inferredOutType(_inferredOutType: C3.Map<string | null, ValueType | null> | {[key: string | null]: IValueType | null}): Data.Rolling.Lazy;

    get win_type(): any;

    aggregate(func?: any): Data | null;

    corr(other?: any, pairwise?: boolean | null, ddof?: number | null): Data | null;

    count(): Data | null;

    cov(other?: any, pairwise?: boolean | null, ddof?: number | null): Data | null;

    kurt(): Data | null;

    max(engine?: string | null, engine_kwargs?: C3.Map<string | null, boolean> | null): Data | null;

    mean(engine?: string | null, engine_kwargs?: C3.Map<string | null, boolean> | null): Data | null;

    median(engine?: string | null, engine_kwargs?: C3.Map<string | null, boolean> | null): Data | null;

    min(engine?: string | null, engine_kwargs?: C3.Map<string | null, boolean> | null): Data | null;

    quantile(quantile?: number | null, interpolation?: string | null): Data | null;
    ...
    sum(engine?: string | null, engine_kwargs?: C3.Map<string | null, boolean> | null): Data | null;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.Rolling.Lazy | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.Rolling.Lazy | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.Rolling.Lazy | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.Rolling.Lazy | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.Rolling.Lazy;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Rolling.Lazy;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Rolling.Lazy;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Rolling.Lazy | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Rolling.Lazy | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.Rolling.Lazy;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Rolling.Lazy;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Rolling.Lazy;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.Rolling.Lazy;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.Rolling.Lazy;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.Rolling.Lazy;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.Rolling.Lazy;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.Rolling.Lazy;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.Rolling.Lazy;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.Rolling.Lazy;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.Rolling.Lazy;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.Rolling.Lazy;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.Rolling.Lazy;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.Rolling.Lazy;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.Rolling.Lazy;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.Rolling.Lazy;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.Rolling.Lazy;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.Rolling.Lazy;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.Rolling.Lazy;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.Rolling.Lazy;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.Rolling.Lazy;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.Rolling.Lazy;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.Rolling.Lazy;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.Rolling.Lazy;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.Rolling.Lazy;

    mergeJson(json: any | null): Data.Rolling.Lazy;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.Rolling.Lazy;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.Rolling.Lazy;
     ...
     */
    singletonArray(): C3.Array<Data.Rolling.Lazy | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.Rolling.Lazy | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.Rolling.Lazy | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.Rolling.Lazy | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.Rolling.Lazy | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.Rolling.Lazy | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.Rolling.Lazy | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.Rolling.Lazy | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.Rolling.Lazy | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.Rolling.Lazy;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.Rolling.Lazy;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.Rolling.Lazy;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.Rolling.Lazy;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.Rolling.Lazy;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.Rolling.Lazy;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.Rolling.Lazy;
     ...
     */
    static cachedEmptyInst(): Data.Rolling.Lazy;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.Rolling.Lazy>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.Rolling.Lazy;
     ...
     */
    static fromPySrc(pySrc: string, dfs?: C3.Set<DataImpl | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): Data.Rolling.Lazy | null;
     ...
     */
    static _jsDataProxy(inst: any): Data.Rolling.Lazy;
     ...
     */
    static create(this_: any, action: string, args?: C3.Map<string | null, any>): Data.Rolling.Lazy;
