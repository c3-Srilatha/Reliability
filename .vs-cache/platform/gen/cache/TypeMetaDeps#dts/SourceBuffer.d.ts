// TypeScript definitions for the C3 type SourceBuffer

/**
 * "writable" or in memory buffer of {@link Sources}
 *
 * @remarks this represents a value passed to a method that expects an instance of SourceBuffer
 */
declare interface ISourceBuffer {
 ...
 */
declare class SourceBuffer extends Obj {
  ...
  withContentEncoding(contentEncoding: string | null): SourceBuffer;
  ...
  withContentLanguage(contentLanguage: string | null): SourceBuffer;
  ...
  withContentLength(contentLength: number | null): SourceBuffer;
  ...
  withContentLocation(contentLocation: string | null): SourceBuffer;
  ...
  withContentType(contentType: string | null): SourceBuffer;
  ...
  withContentDisposition(contentDisposition: string | null): SourceBuffer;
  ...
  withETag(eTag: string | null): SourceBuffer;
  ...
  withLastModified(lastModified: DateTime | Date | string | null): SourceBuffer;

  /**
   * Id of user / identity who last last modified this content.
   */
  readonly lastModifiedBy?: string | null;
  withLastModifiedBy(lastModifiedBy: string | null): SourceBuffer;
  ...
  withContentMD5(contentMD5: string | null): SourceBuffer;
  ...
  withContentSHA1(contentSHA1: string | null): SourceBuffer;

  /**
   * Field to maintain state whether content metadata was read or not.
   */
  readonly hasMetadata?: boolean;
  withHasMetadata(hasMetadata: boolean): SourceBuffer;

  /**
   * The actual content buffer backed by a native mechanism.
   */
  readonly bytes?: any;
  withBytes(bytes: any): SourceBuffer;

  /**
   * The unique and required id of this instance.
   */
  readonly id: string;
  withId(id: string): SourceBuffer;

  /**
   * Source collection id for this source is stored.
   */
  readonly sourceCollectionName: string;
  withSourceCollectionName(sourceCollectionName: string): SourceBuffer;

  /**
   * Meta information for the processing of the sources
   */
  readonly sourcesMeta?: Obj | null;
  withSourcesMeta(sourcesMeta: IObj | null): SourceBuffer;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SourceBuffer | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SourceBuffer | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SourceBuffer | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SourceBuffer | null;
   ...
   */
  replaceType(old: Type, new_: Type): SourceBuffer;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SourceBuffer;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SourceBuffer;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SourceBuffer | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SourceBuffer | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SourceBuffer;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SourceBuffer;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SourceBuffer;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SourceBuffer;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SourceBuffer;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SourceBuffer;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SourceBuffer;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SourceBuffer;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SourceBuffer;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SourceBuffer;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SourceBuffer;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SourceBuffer;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SourceBuffer;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SourceBuffer;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SourceBuffer;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SourceBuffer;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SourceBuffer;
   ...
   * @see #removeField
   */
  unsetField(field: string): SourceBuffer;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SourceBuffer;
   ...
   * @see #unsetField
   */
  removeField(field: string): SourceBuffer;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SourceBuffer;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SourceBuffer;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SourceBuffer;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SourceBuffer;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SourceBuffer;

  mergeJson(json: any | null): SourceBuffer;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SourceBuffer;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SourceBuffer;
   ...
   */
  singletonArray(): C3.Array<SourceBuffer | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SourceBuffer | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SourceBuffer | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SourceBuffer | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SourceBuffer | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SourceBuffer | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SourceBuffer | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SourceBuffer | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SourceBuffer | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SourceBuffer;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SourceBuffer;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SourceBuffer;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SourceBuffer;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SourceBuffer;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SourceBuffer;
   ...
   * @see #fromString
   */
  static make(s: string | null): SourceBuffer | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SourceBuffer;
   ...
   */
  static cachedEmptyInst(): SourceBuffer;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SourceBuffer>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SourceBuffer;
   ...
   */
  withFileName(fileName: string | null): SourceBuffer;

  /**
   * Changes file extension in this instance.
   */
  withFileExt(fileExt: string | null): SourceBuffer;
   ...
   */
  identify(suffix?: string | null): SourceBuffer;
   ...
   */
  readMetadata(spec?: FileOperationSpec | null): SourceBuffer;
   ...
   */
  refreshMetadata(spec?: FileOperationSpec | null): SourceBuffer;
   ...
   * @return abstract content with metadata.
   */
  guessMetadata(spec?: FileOperationSpec | null): SourceBuffer;

  /**
   * Clears the content metadata; e.g. if it's known to be invalid.
   */
  clearMetadata(): SourceBuffer;

  /**
   * @return clone of this content with metadata from provided input.
   */
  withMetadata(meta?: ContentMeta | null): SourceBuffer;
   ...
   */
  encodedPushStream(spec?: FileOperationSpec | null): Pair<SourceBuffer | null, BytePushStream | null>;

  /**
   * @return byte push stream to be used for writing un-encoded data into this content object.
   */
  pushStream(spec?: FileOperationSpec | null): Pair<SourceBuffer | null, BytePushStream | null>;

  /**
   * @return character push stream to be used for writing un-encoded data into this content object.
   */
  charPushStream(spec?: FileOperationSpec | null): Pair<SourceBuffer | null, CharPushStream | null>;
   ...
   */
  encodedStream(spec?: FileOperationSpec | null): Pair<SourceBuffer | null, ByteStream | null> | null;
   ...
   */
  writeStream(content: ByteStream | null, spec?: FileOperationSpec | null): SourceBuffer;

  /**
   * Truncates file and replaces it's content with provided binary content.
   */
  writeInputStream(inputStream: any, spec?: FileOperationSpec | null): SourceBuffer;

  /**
   * Truncates file and replaces its content with provided binary content from zipInputStream
   */
  writeZipInputStream(zipInputStream: any, spec?: FileOperationSpec | null): SourceBuffer;
   ...
   */
  writeEncodedStream(encodedContent: ByteStream | null, spec?: FileOperationSpec | null): SourceBuffer;

  /**
   * Truncates file and replaces it's encoded content with provided binary content.
   */
  writeEncodedInputStream(inputStream: any, spec?: FileOperationSpec | null): SourceBuffer;
   ...
   *           content that needs to be written
   */
  write(content: any | null, spec?: FileOperationSpec | null): SourceBuffer;
   ...
   *           encoded content that needs to be written
   */
  writeEncoded(encodedContent: any | null, spec?: FileOperationSpec | null): SourceBuffer;
   ...
   *           content that needs to be written
   */
  writeString(content: string | null, spec?: FileOperationSpec | null): SourceBuffer;
   ...
   */
  writeObj(obj: Obj | null, spec?: FileObjsOperSpec | null): SourceBuffer;
   ...
   * @return pair of update instance of this content and number of objs written
   */
  startWriteObjs(spec?: FileObjsOperSpec | null): Pair<SourceBuffer | null, PushStream<Obj | null> | null>;
   ...
   */
  compress(contentEncoding?: string | null, spec?: FileCompressSpec | null): SourceBuffer;

  /**
   * Uncompresses content.
   */
  uncompress(spec?: FileCompressSpec | null): SourceBuffer;
   ...
   */
  transcode(contentType: string, contentEncoding: string, spec?: FileCompressSpec | null): SourceBuffer;

  /**
   * Copies content to a given target.
   */
  copyContentTo(target: SourceBuffer, spec?: FileOperationSpec | null): void;
   ...
   */
  static create(initialCapacity?: number | null, contentType?: string | null, contentEncoding?: string | null): ContentBuffer;
   ...
   * @see #toString
   */
  static fromString(s: string | null): SourceBuffer | null;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): SourceBuffer | null;
   ...
   */
  static init(sc: SourceCollection<SourceCollection.Config | null>, contentType?: string | null, contentEncoding?: string | null): SourceBuffer | null;
}
