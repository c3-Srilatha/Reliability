// TypeScript definitions for the C3 type NextId

/**
 * system type used by data engine to generate short ids of the types annotated as @db(shortId=true).
 *
 * id of the object is corresponding type's id (as defined by metadata.TypeId type) and nextId field
 * holds next available sequence number for that type.
 *
 * @remarks this represents a value passed to a method that expects an instance of NextId
 */
declare interface INextId {
 ...
 * holds next available sequence number for that type.
 *
 * @remarks this represents a made instance of NextId
 */
declare class NextId extends Obj {
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): NextId;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): NextId;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): NextId;
  ...
  withVersion(version: number | null): NextId;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): NextId;

  readonly nextId: number;
  withNextId(nextId: number): NextId;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): NextId | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): NextId | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): NextId | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): NextId | null;
   ...
   */
  replaceType(old: Type, new_: Type): NextId;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NextId;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NextId;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NextId | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NextId | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): NextId;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NextId;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NextId;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): NextId;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): NextId;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): NextId;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): NextId;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): NextId;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): NextId;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): NextId;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): NextId;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): NextId;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): NextId;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): NextId;
   ...
   * @see #unsetField
   */
  defaultField(field: string): NextId;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): NextId;
   ...
   * @see #removeField
   */
  unsetField(field: string): NextId;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): NextId;
   ...
   * @see #unsetField
   */
  removeField(field: string): NextId;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): NextId;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): NextId;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): NextId;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): NextId;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): NextId;

  mergeJson(json: any | null): NextId;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): NextId;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): NextId;
   ...
   */
  singletonArray(): C3.Array<NextId | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<NextId | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<NextId | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<NextId | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<NextId | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, NextId | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, NextId | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<NextId | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<NextId | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): NextId;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): NextId;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): NextId;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): NextId;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): NextId;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): NextId;
   ...
   * @see #fromString
   */
  static make(s: string | null): NextId | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): NextId;
   ...
   */
  static cachedEmptyInst(): NextId;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<NextId>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): NextId;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<NextId | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<NextId | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<NextId | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<NextId | null> | null>;
   ...
   */
  get(include?: string | null): NextId | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): NextId | null;
   ...
   */
  getMissing(spec: GetMissingSpec): NextId;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): NextId | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): NextId;
   ...
   * @see #toString
   */
  static fromString(s: string | null): NextId | null;
   ...
   */
  create(spec?: UpsertSpec | null): NextId | null;
   ...
   */
  static createBatch(objs: C3.Array<NextId | null> | null, spec?: UpsertSpec | null): ObjList<NextId | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<NextId | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<NextId | null> | null;
   ...
   */
  update(srcObj?: NextId | null, spec?: UpsertSpec | null): NextId | null;
   ...
   */
  upsert(srcObj?: NextId | null, spec?: UpsertSpec | null): NextId | null;
   ...
   */
  merge(spec?: MergeSpec | null): NextId | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): NextId | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): NextId | null;
   ...
   */
  static updateBatch(objs: C3.Array<NextId | null> | null, srcObjs?: C3.Array<NextId | null>, spec?: UpsertSpec | null): ObjList<NextId | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<NextId | null>>, spec?: UpsertSpec | null): ObjList<NextId | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<NextId | null> | null, srcObjs?: C3.Array<NextId | null>, spec?: UpsertSpec | null): ObjList<NextId | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<NextId | null>>, spec?: UpsertSpec | null): ObjList<NextId | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<NextId | null> | null, spec?: TouchSpec | null): ObjList<NextId | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<NextId | null> | null, spec?: MergeSpec | null): ObjList<NextId | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<NextId | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<NextId | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<NextId | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<NextId | null> | null;
   ...
   */
  static mergeAll(mergeObj: NextId | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: NextId | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<NextId | null> | null, spec?: UpsertSpec | null): ObjList<NextId | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<NextId | null> | null, spec?: UpsertSpec | null): ObjList<NextId | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<NextId | null> | null): ObjList<NextId | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<NextId | null> | null): ObjList<NextId | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<NextId | null> | null): ObjList<NextId | null>;
   ...
   */
  static afterCreate(objs: C3.Array<NextId | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<NextId | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<NextId | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<NextId | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<NextId | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): NextId | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<NextId | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: NextId | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<NextId | null> | null, callback?: λFunction<NextId | null, NextId | null> | null): ObjList<NextId | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<NextId | null> | null, callback?: λFunction<NextId | null, NextId | null> | null): C3.Array<ObjError | null>;
