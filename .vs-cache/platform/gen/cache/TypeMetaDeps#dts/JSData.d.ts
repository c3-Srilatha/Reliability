// TypeScript definitions for the C3 type JSData

/**
 * Helper type for storing generic data for ad-hoc JS jobs. Not intended for production use.
 *
 * @remarks this represents a value passed to a method that expects an instance of JSData
 */
declare interface IJSData {
 ...
 * Helper type for storing generic data for ad-hoc JS jobs. Not intended for production use.
 *
 * @remarks this represents a made instance of JSData
 */
declare class JSData extends Obj {
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): JSData;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): JSData;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): JSData;
  ...
  withVersion(version: number | null): JSData;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): JSData;

  readonly data?: any;
  withData(data: any): JSData;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): JSData | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): JSData | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): JSData | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): JSData | null;
   ...
   */
  replaceType(old: Type, new_: Type): JSData;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JSData;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JSData;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JSData | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JSData | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): JSData;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JSData;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JSData;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): JSData;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): JSData;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): JSData;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): JSData;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): JSData;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): JSData;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): JSData;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): JSData;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): JSData;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): JSData;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): JSData;
   ...
   * @see #unsetField
   */
  defaultField(field: string): JSData;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): JSData;
   ...
   * @see #removeField
   */
  unsetField(field: string): JSData;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): JSData;
   ...
   * @see #unsetField
   */
  removeField(field: string): JSData;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): JSData;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): JSData;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): JSData;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): JSData;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): JSData;

  mergeJson(json: any | null): JSData;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): JSData;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): JSData;
   ...
   */
  singletonArray(): C3.Array<JSData | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<JSData | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<JSData | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<JSData | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<JSData | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, JSData | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, JSData | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<JSData | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<JSData | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): JSData;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): JSData;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): JSData;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): JSData;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): JSData;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): JSData;
   ...
   * @see #fromString
   */
  static make(s: string | null): JSData | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): JSData;
   ...
   */
  static cachedEmptyInst(): JSData;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<JSData>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): JSData;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<JSData | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<JSData | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<JSData | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<JSData | null> | null>;
   ...
   */
  get(include?: string | null): JSData | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): JSData | null;
   ...
   */
  getMissing(spec: GetMissingSpec): JSData;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): JSData | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): JSData;
   ...
   * @see #toString
   */
  static fromString(s: string | null): JSData | null;
   ...
   */
  create(spec?: UpsertSpec | null): JSData | null;
   ...
   */
  static createBatch(objs: C3.Array<JSData | null> | null, spec?: UpsertSpec | null): ObjList<JSData | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<JSData | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<JSData | null> | null;
   ...
   */
  update(srcObj?: JSData | null, spec?: UpsertSpec | null): JSData | null;
   ...
   */
  upsert(srcObj?: JSData | null, spec?: UpsertSpec | null): JSData | null;
   ...
   */
  merge(spec?: MergeSpec | null): JSData | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): JSData | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): JSData | null;
   ...
   */
  static updateBatch(objs: C3.Array<JSData | null> | null, srcObjs?: C3.Array<JSData | null>, spec?: UpsertSpec | null): ObjList<JSData | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<JSData | null>>, spec?: UpsertSpec | null): ObjList<JSData | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<JSData | null> | null, srcObjs?: C3.Array<JSData | null>, spec?: UpsertSpec | null): ObjList<JSData | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<JSData | null>>, spec?: UpsertSpec | null): ObjList<JSData | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<JSData | null> | null, spec?: TouchSpec | null): ObjList<JSData | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<JSData | null> | null, spec?: MergeSpec | null): ObjList<JSData | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<JSData | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<JSData | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<JSData | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<JSData | null> | null;
   ...
   */
  static mergeAll(mergeObj: JSData | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: JSData | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<JSData | null> | null, spec?: UpsertSpec | null): ObjList<JSData | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<JSData | null> | null, spec?: UpsertSpec | null): ObjList<JSData | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<JSData | null> | null): ObjList<JSData | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<JSData | null> | null): ObjList<JSData | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<JSData | null> | null): ObjList<JSData | null>;
   ...
   */
  static afterCreate(objs: C3.Array<JSData | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<JSData | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<JSData | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<JSData | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<JSData | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): JSData | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<JSData | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: JSData | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<JSData | null> | null, callback?: λFunction<JSData | null, JSData | null> | null): ObjList<JSData | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<JSData | null> | null, callback?: λFunction<JSData | null, JSData | null> | null): C3.Array<ObjError | null>;
