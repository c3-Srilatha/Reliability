// TypeScript definitions for the C3 type DoubleType

/**
 * The numeric `double` value type. This represents an IEEE double-precision floating point number in all languages.
 *
 * There are no fields (other than #modifier), so this is normally accessed with {@link PrimitiveType#ofDbl}.
 *
 * @remarks this represents a value passed to a method that expects an instance of DoubleType
 */
declare interface IDoubleType {
 ...
 * There are no fields (other than #modifier), so this is normally accessed with {@link PrimitiveType#ofDbl}.
 *
 * @remarks this represents a made instance of DoubleType
 */
declare class DoubleType extends Obj {

  /**
   * Source file Pkg.Path a C3 Type declaration [.c3typ].
   */
  readonly declaredPkgPath?: string | null;
  withDeclaredPkgPath(declaredPkgPath: string | null): DoubleType;

  /**
   * Source line number in a C3 Type declaration [.c3typ] file starting with 1 where this metadata element is declared.
   */
  readonly declaredSrcLine?: number | null;
  withDeclaredSrcLine(declaredSrcLine: number | null): DoubleType;
  ...
  withDeclaredSrcCharInLine(declaredSrcCharInLine: number | null): DoubleType;
   ...
   */
  readonly pkg: Pkg;
  withPkg(pkg: IPkg): DoubleType;

  /**
   * SDK json representing instance of this type
   */
  readonly json?: any;
  withJson(json: any): DoubleType;

  /**
   * The set of annotations defined on this element of metadata represented as json value.
   */
  readonly annotationsJson?: any | null;
  withAnnotationsJson(annotationsJson: any | null): DoubleType;
  ...
  withModifier(modifier: string | null): DoubleType;
  ...
  withName(name: string): DoubleType;
  ...
  withSerializedType(serializedType: IValueType | null): DoubleType;
  ...
  withEnumRefType(enumRefType: IReferenceType | null): DoubleType;
  ...
  withDeclaredEnumValues(declaredEnumValues: C3.Array<string | null> | Array<string | null>): DoubleType;
   ...
   */
  replaceType(old: Type, new_: Type): DoubleType;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): DoubleType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): DoubleType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): DoubleType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): DoubleType | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DoubleType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DoubleType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DoubleType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DoubleType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DoubleType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DoubleType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DoubleType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DoubleType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DoubleType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DoubleType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DoubleType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DoubleType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DoubleType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): DoubleType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): DoubleType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): DoubleType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DoubleType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DoubleType;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DoubleType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DoubleType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DoubleType;
   ...
   * @see #removeField
   */
  unsetField(field: string): DoubleType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DoubleType;
   ...
   * @see #unsetField
   */
  removeField(field: string): DoubleType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DoubleType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DoubleType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): DoubleType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DoubleType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DoubleType;

  mergeJson(json: any | null): DoubleType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DoubleType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): DoubleType;
   ...
   */
  singletonArray(): C3.Array<DoubleType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<DoubleType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DoubleType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<DoubleType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DoubleType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, DoubleType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DoubleType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DoubleType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DoubleType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DoubleType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DoubleType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DoubleType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DoubleType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DoubleType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DoubleType;
   ...
   * @see #fromString
   */
  static make(s: string | null): DoubleType | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DoubleType;
   ...
   */
  static cachedEmptyInst(): DoubleType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DoubleType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): DoubleType;
   ...
   */
  withoutDeclaredSrcPos(recursive?: boolean): DoubleType;
   ...
   */
  withAnnotation(ann: Annotation): DoubleType;
   ...
   *         value for the field
   */
  withAnnotation(ann: string, annField?: string | null, value?: any): DoubleType;
   ...
   * @see #toString
   */
  static fromString(s: string | null): DoubleType | null;
