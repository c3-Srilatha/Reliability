// TypeScript definitions for the C3 type VertxTcpProxyServerConfig

/**
 * @remarks this represents a value passed to a method that expects an instance of VertxTcpProxyServerConfig
 */
declare interface IVertxTcpProxyServerConfig {
...
/**
 * @remarks this represents a made instance of VertxTcpProxyServerConfig
 */
declare class VertxTcpProxyServerConfig extends Obj {

  readonly SO_BACKLOG?: number | null;
  withSO_BACKLOG(SO_BACKLOG: number | null): VertxTcpProxyServerConfig;

  readonly SO_BROADCAST?: boolean;
  withSO_BROADCAST(SO_BROADCAST: boolean): VertxTcpProxyServerConfig;

  readonly SO_KEEPALIVE?: boolean;
  withSO_KEEPALIVE(SO_KEEPALIVE: boolean): VertxTcpProxyServerConfig;

  readonly SO_LINGER?: number | null;
  withSO_LINGER(SO_LINGER: number | null): VertxTcpProxyServerConfig;

  readonly SO_RCVBUF?: number | null;
  withSO_RCVBUF(SO_RCVBUF: number | null): VertxTcpProxyServerConfig;

  readonly SO_REUSEADDR?: boolean;
  withSO_REUSEADDR(SO_REUSEADDR: boolean): VertxTcpProxyServerConfig;

  readonly SO_SNDBUF?: number | null;
  withSO_SNDBUF(SO_SNDBUF: number | null): VertxTcpProxyServerConfig;

  readonly SO_TIMEOUT?: number | null;
  withSO_TIMEOUT(SO_TIMEOUT: number | null): VertxTcpProxyServerConfig;

  readonly TCP_NODELAY?: boolean;
  withTCP_NODELAY(TCP_NODELAY: boolean): VertxTcpProxyServerConfig;

  readonly connectionTimeoutMillis?: number | null;
  withConnectionTimeoutMillis(connectionTimeoutMillis: number | null): VertxTcpProxyServerConfig;

  readonly maxMessagesPerRead?: number | null;
  withMaxMessagesPerRead(maxMessagesPerRead: number | null): VertxTcpProxyServerConfig;

  readonly writeBufHighWaterMark?: number | null;
  withWriteBufHighWaterMark(writeBufHighWaterMark: number | null): VertxTcpProxyServerConfig;

  readonly writeBufLowWaterMark?: number | null;
  withWriteBufLowWaterMark(writeBufLowWaterMark: number | null): VertxTcpProxyServerConfig;

  /**
   * The name of this instance.
   */
  readonly name?: string | null;
  withName(name: string | null): VertxTcpProxyServerConfig;

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): VertxTcpProxyServerConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): VertxTcpProxyServerConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): VertxTcpProxyServerConfig;

  readonly ssl?: boolean;
  withSsl(ssl: boolean): VertxTcpProxyServerConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): VertxTcpProxyServerConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): VertxTcpProxyServerConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): VertxTcpProxyServerConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): VertxTcpProxyServerConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): VertxTcpProxyServerConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VertxTcpProxyServerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VertxTcpProxyServerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VertxTcpProxyServerConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VertxTcpProxyServerConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): VertxTcpProxyServerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VertxTcpProxyServerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VertxTcpProxyServerConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): VertxTcpProxyServerConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): VertxTcpProxyServerConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): VertxTcpProxyServerConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): VertxTcpProxyServerConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): VertxTcpProxyServerConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): VertxTcpProxyServerConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): VertxTcpProxyServerConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): VertxTcpProxyServerConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): VertxTcpProxyServerConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): VertxTcpProxyServerConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): VertxTcpProxyServerConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): VertxTcpProxyServerConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): VertxTcpProxyServerConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): VertxTcpProxyServerConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): VertxTcpProxyServerConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): VertxTcpProxyServerConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): VertxTcpProxyServerConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): VertxTcpProxyServerConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): VertxTcpProxyServerConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): VertxTcpProxyServerConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): VertxTcpProxyServerConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): VertxTcpProxyServerConfig;

  mergeJson(json: any | null): VertxTcpProxyServerConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): VertxTcpProxyServerConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): VertxTcpProxyServerConfig;
   ...
   */
  singletonArray(): C3.Array<VertxTcpProxyServerConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<VertxTcpProxyServerConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<VertxTcpProxyServerConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<VertxTcpProxyServerConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<VertxTcpProxyServerConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, VertxTcpProxyServerConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, VertxTcpProxyServerConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<VertxTcpProxyServerConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<VertxTcpProxyServerConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): VertxTcpProxyServerConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): VertxTcpProxyServerConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): VertxTcpProxyServerConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): VertxTcpProxyServerConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): VertxTcpProxyServerConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): VertxTcpProxyServerConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): VertxTcpProxyServerConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): VertxTcpProxyServerConfig;
   ...
   */
  static cachedEmptyInst(): VertxTcpProxyServerConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<VertxTcpProxyServerConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): VertxTcpProxyServerConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<VertxTcpProxyServerConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<VertxTcpProxyServerConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<VertxTcpProxyServerConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): VertxTcpProxyServerConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): VertxTcpProxyServerConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): VertxTcpProxyServerConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): VertxTcpProxyServerConfig | null;
   ...
   */
  static produce(key: string): VertxTcpProxyServerConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, VertxTcpProxyServerConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, VertxTcpProxyServerConfig | null>;
   ...
   */
  getConfig(): VertxTcpProxyServerConfig;
   ...
   */
  getSecret(): VertxTcpProxyServerConfig;
   ...
   */
  static forConfigKey(configKey: string | null): VertxTcpProxyServerConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<VertxTcpProxyServerConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: VertxTcpProxyServerConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: VertxTcpProxyServerConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): VertxTcpProxyServerConfig | null;
