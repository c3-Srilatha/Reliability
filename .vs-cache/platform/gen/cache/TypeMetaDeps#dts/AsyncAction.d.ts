// TypeScript definitions for the C3 type AsyncAction

/**
 * Run async action and persist results into results or error field.
 * @see AsyncActionSpec
 *
 * @remarks this represents a value passed to a method that expects an instance of AsyncAction
 */
declare interface IAsyncAction {
   ...
   */
  submittedAt?: DateTime | Date | string | null;
   ...
   */
  completedAt?: DateTime | Date | string | null;
 ...
 * @see AsyncActionSpec
 *
 * @remarks this represents a made instance of AsyncAction
 */
declare class AsyncAction extends Obj {

  /**
   * Type to submit the action for.
   */
  readonly typeName: string;
  withTypeName(typeName: string): AsyncAction;

  /**
   * Actual name of action that will be executed. For internal usage only.
   */
  readonly actionName: string;
  withActionName(actionName: string): AsyncAction;
  ...
  withArgs(args: C3.Map<string | null, any> | {[key: string | null]: any}): AsyncAction;

  /**
   * Name of action to submit.
   */
  readonly action: string;
  withAction(action: string): AsyncAction;

  /**
   * Id for {@link App.NodePool} to run action on.
   */
  readonly nodePool?: string | null;
  withNodePool(nodePool: string | null): AsyncAction;
   ...
   *     `hardwareProfile`.
   */
  readonly runOnlyOnce?: boolean;
  withRunOnlyOnce(runOnlyOnce: boolean): AsyncAction;
  ...
  withActionId(actionId: string | null): AsyncAction;

  /**
   * If set to `true`, then the AsyncAction will be removed if it completes without any errors.
   */
  readonly cleanupOnSuccess?: boolean;
  withCleanupOnSuccess(cleanupOnSuccess: boolean): AsyncAction;
  ...
  withTimeoutMinutes(timeoutMinutes: number | null): AsyncAction;
   ...
   * Note: If no nodePool is specified, the {@link Action} will run in the local JVM of the node that submitted the action, which will consume resources.
   */
  readonly skipQueues?: boolean;
  withSkipQueues(skipQueues: boolean): AsyncAction;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): AsyncAction;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): AsyncAction;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): AsyncAction;
  ...
  withVersion(version: number | null): AsyncAction;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): AsyncAction;

  /**
   * Timestamp when action was last submitted
   */
  readonly submittedAt?: DateTime | null;
  withSubmittedAt(submittedAt: DateTime | Date | string | null): AsyncAction;

  /**
   * If this async action is computed.
   */
  readonly completed?: boolean;
  withCompleted(completed: boolean): AsyncAction;

  /**
   * Timestamp when action was marked completed, regardless of whether or not it failed.
   */
  readonly completedAt?: DateTime | null;
  withCompletedAt(completedAt: DateTime | Date | string | null): AsyncAction;

  /**
   * Result of the action if provided.
   */
  readonly result?: any;
  withResult(result: any): AsyncAction;

  /**
   * Error, if accrued during execution.
   * To pretty-print error message use {@link formatError}.
   */
  readonly error?: C3.Error | null;
  withError(error: IC3.Error | null): AsyncAction;

  /**
   * Used for finding queue entry associated with a {@link submit} for this action during {@link: interrupt operation}.
   */
  readonly submitKey?: string | null;
  withSubmitKey(submitKey: string | null): AsyncAction;

  /**
   * Used to determine if invocation of {@link applyAndPersistResult} is the latest for this action.
   */
  readonly runKey?: string | null;
  withRunKey(runKey: string | null): AsyncAction;
   ...
   * @see #toString
   */
  static fromString(s: string | null): AsyncAction | null;
   ...
   * @see #fromString
   */
  static make(s: string | null): AsyncAction | null;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): AsyncAction;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): AsyncAction;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): AsyncAction;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): AsyncAction;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): AsyncAction | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): AsyncAction | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): AsyncAction | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): AsyncAction | null;
   ...
   */
  replaceType(old: Type, new_: Type): AsyncAction;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): AsyncAction;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): AsyncAction;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<AsyncAction | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<AsyncAction | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): AsyncAction;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AsyncAction;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AsyncAction;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): AsyncAction;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): AsyncAction;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): AsyncAction;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): AsyncAction;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): AsyncAction;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): AsyncAction;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): AsyncAction;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): AsyncAction;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): AsyncAction;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): AsyncAction;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): AsyncAction;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): AsyncAction;
   ...
   * @see #unsetField
   */
  defaultField(field: string): AsyncAction;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): AsyncAction;
   ...
   * @see #removeField
   */
  unsetField(field: string): AsyncAction;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): AsyncAction;
   ...
   * @see #unsetField
   */
  removeField(field: string): AsyncAction;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): AsyncAction;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): AsyncAction;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): AsyncAction;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): AsyncAction;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): AsyncAction;

  mergeJson(json: any | null): AsyncAction;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): AsyncAction;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): AsyncAction;
   ...
   */
  singletonArray(): C3.Array<AsyncAction | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<AsyncAction | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<AsyncAction | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<AsyncAction | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<AsyncAction | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, AsyncAction | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, AsyncAction | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<AsyncAction | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<AsyncAction | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): AsyncAction;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): AsyncAction;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): AsyncAction;
   ...
   */
  static cachedEmptyInst(): AsyncAction;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<AsyncAction>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): AsyncAction;

  /**
   * Constructs reference to C3 Action
   */
  static fromTypeAction(type: Type, action: string): ActionRef;

  /**
   * Calls target C3 Action
   */
  call(args?: C3.Map<string | null, any>): any;

  /**
   * Return value type of a target C3 Action
   */
  returnType(): ValueType | null;

  /**
   * Type of a target C3 Action
   */
  toType(): Type;

  /**
   * Return a new {@link ActionRef} with typeName replaced to the prototypeName of the typeName
   */
  toPrototype(): ActionRef;

  /**
   * Invoke the referenced action, specifying additional parameters if needed.
   * Any parameters specified here override those in {@link #args}.
   */
  apply(extraArgs?: C3.Map<string | null, any>): any;

  /**
   * Return the JavaScript implementation of the partially applied action with args filled. Return value is a JavaScript
   * function declaration code.
   */
  jsImpl(): string;

  /**
   * HTTP request for this action.
   */
  httpRequest(cluster?: string | null, tenant?: string | null, tag?: string | null): HttpRequest;

  /**
   * Curl command for this action.
   */
  curl(cluster?: string | null, tenant?: string | null, tag?: string | null): string;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<AsyncAction | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<AsyncAction | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<AsyncAction | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<AsyncAction | null> | null>;
   ...
   */
  get(include?: string | null): AsyncAction | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): AsyncAction | null;
   ...
   */
  getMissing(spec: GetMissingSpec): AsyncAction;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): AsyncAction | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): AsyncAction;
   ...
   */
  create(spec?: UpsertSpec | null): AsyncAction | null;
   ...
   */
  static createBatch(objs: C3.Array<AsyncAction | null> | null, spec?: UpsertSpec | null): ObjList<AsyncAction | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<AsyncAction | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<AsyncAction | null> | null;
   ...
   */
  update(srcObj?: AsyncAction | null, spec?: UpsertSpec | null): AsyncAction | null;
   ...
   */
  upsert(srcObj?: AsyncAction | null, spec?: UpsertSpec | null): AsyncAction | null;
   ...
   */
  merge(spec?: MergeSpec | null): AsyncAction | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): AsyncAction | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): AsyncAction | null;
   ...
   */
  static updateBatch(objs: C3.Array<AsyncAction | null> | null, srcObjs?: C3.Array<AsyncAction | null>, spec?: UpsertSpec | null): ObjList<AsyncAction | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<AsyncAction | null>>, spec?: UpsertSpec | null): ObjList<AsyncAction | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<AsyncAction | null> | null, srcObjs?: C3.Array<AsyncAction | null>, spec?: UpsertSpec | null): ObjList<AsyncAction | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<AsyncAction | null>>, spec?: UpsertSpec | null): ObjList<AsyncAction | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<AsyncAction | null> | null, spec?: TouchSpec | null): ObjList<AsyncAction | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<AsyncAction | null> | null, spec?: MergeSpec | null): ObjList<AsyncAction | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<AsyncAction | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<AsyncAction | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<AsyncAction | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<AsyncAction | null> | null;
   ...
   */
  static mergeAll(mergeObj: AsyncAction | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: AsyncAction | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<AsyncAction | null> | null, spec?: UpsertSpec | null): ObjList<AsyncAction | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<AsyncAction | null> | null, spec?: UpsertSpec | null): ObjList<AsyncAction | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<AsyncAction | null> | null): ObjList<AsyncAction | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<AsyncAction | null> | null): ObjList<AsyncAction | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<AsyncAction | null> | null): ObjList<AsyncAction | null>;
   ...
   */
  static afterCreate(objs: C3.Array<AsyncAction | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<AsyncAction | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<AsyncAction | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<AsyncAction | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<AsyncAction | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): AsyncAction | null;
   ...
   */
  withoutIdentity(): AsyncAction | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<AsyncAction | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: AsyncAction | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<AsyncAction | null> | null, callback?: λFunction<AsyncAction | null, AsyncAction | null> | null): ObjList<AsyncAction | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<AsyncAction | null> | null, callback?: λFunction<AsyncAction | null, AsyncAction | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static submit(spec: AsyncActionSpec): AsyncAction;
   ...
   */
  static allFailed(spec?: FetchSpec | null): C3.Array<AsyncAction | null>;
