// TypeScript definitions for the C3 type KvContent

/**
 * The content associated to a row in a {@link KvStore}.
 *
 * @remarks this represents a value passed to a method that expects an instance of KvContent
 */
declare interface IKvContent {
 ...
 */
declare class KvContent extends Obj {

  /**
   * table associated with the content
   */
  readonly tableName: string;
  withTableName(tableName: string): KvContent;

  /**
   * rowId associated with the content
   */
  readonly rowId: string;
  withRowId(rowId: string): KvContent;

  /**
   * store associated with the content
   */
  readonly store: KvStore<KvStoreConfig | null>;
  withStore(store: IKvStore<KvStoreConfig | null>): KvContent;
  ...
  withContentEncoding(contentEncoding: string | null): KvContent;
  ...
  withContentLanguage(contentLanguage: string | null): KvContent;
  ...
  withContentLength(contentLength: number | null): KvContent;
  ...
  withContentLocation(contentLocation: string | null): KvContent;
  ...
  withContentType(contentType: string | null): KvContent;
  ...
  withContentDisposition(contentDisposition: string | null): KvContent;
  ...
  withETag(eTag: string | null): KvContent;
  ...
  withLastModified(lastModified: DateTime | Date | string | null): KvContent;

  /**
   * Id of user / identity who last last modified this content.
   */
  readonly lastModifiedBy?: string | null;
  withLastModifiedBy(lastModifiedBy: string | null): KvContent;
  ...
  withContentMD5(contentMD5: string | null): KvContent;
  ...
  withContentSHA1(contentSHA1: string | null): KvContent;

  /**
   * Field to maintain state whether content metadata was read or not.
   */
  readonly hasMetadata?: boolean;
  withHasMetadata(hasMetadata: boolean): KvContent;

  /**
   * The column name of the {@link KvRow} that this KvContent is associated to.
   */
  readonly colName: string;
  withColName(colName: string): KvContent;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): KvContent | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): KvContent | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): KvContent | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): KvContent | null;
   ...
   */
  replaceType(old: Type, new_: Type): KvContent;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): KvContent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): KvContent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<KvContent | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<KvContent | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): KvContent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): KvContent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): KvContent;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): KvContent;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): KvContent;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): KvContent;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): KvContent;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): KvContent;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): KvContent;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): KvContent;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): KvContent;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): KvContent;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): KvContent;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): KvContent;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): KvContent;
   ...
   * @see #unsetField
   */
  defaultField(field: string): KvContent;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): KvContent;
   ...
   * @see #removeField
   */
  unsetField(field: string): KvContent;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): KvContent;
   ...
   * @see #unsetField
   */
  removeField(field: string): KvContent;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): KvContent;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): KvContent;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): KvContent;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): KvContent;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): KvContent;

  mergeJson(json: any | null): KvContent;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): KvContent;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): KvContent;
   ...
   */
  singletonArray(): C3.Array<KvContent | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<KvContent | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<KvContent | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<KvContent | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<KvContent | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, KvContent | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, KvContent | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<KvContent | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<KvContent | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): KvContent;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): KvContent;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): KvContent;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): KvContent;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): KvContent;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): KvContent;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): KvContent;
   ...
   */
  static cachedEmptyInst(): KvContent;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<KvContent>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): KvContent;
   ...
   */
  withFileName(fileName: string | null): KvContent;

  /**
   * Changes file extension in this instance.
   */
  withFileExt(fileExt: string | null): KvContent;
   ...
   */
  identify(suffix?: string | null): KvContent;
   ...
   */
  readMetadata(spec?: FileOperationSpec | null): KvContent;
   ...
   */
  refreshMetadata(spec?: FileOperationSpec | null): KvContent;
   ...
   */
  encodedPushStream(spec?: FileOperationSpec | null): Pair<KvContent | null, BytePushStream | null>;

  /**
   * @return byte push stream to be used for writing un-encoded data into this content object.
   */
  pushStream(spec?: FileOperationSpec | null): Pair<KvContent | null, BytePushStream | null>;

  /**
   * @return character push stream to be used for writing un-encoded data into this content object.
   */
  charPushStream(spec?: FileOperationSpec | null): Pair<KvContent | null, CharPushStream | null>;
   ...
   */
  encodedStream(spec?: FileOperationSpec | null): Pair<KvContent | null, ByteStream | null> | null;
   ...
   */
  writeStream(content: ByteStream | null, spec?: FileOperationSpec | null): KvContent;

  /**
   * Truncates file and replaces it's content with provided binary content.
   */
  writeInputStream(inputStream: any, spec?: FileOperationSpec | null): KvContent;

  /**
   * Truncates file and replaces its content with provided binary content from zipInputStream
   */
  writeZipInputStream(zipInputStream: any, spec?: FileOperationSpec | null): KvContent;
   ...
   */
  writeEncodedStream(encodedContent: ByteStream | null, spec?: FileOperationSpec | null): KvContent;

  /**
   * Truncates file and replaces it's encoded content with provided binary content.
   */
  writeEncodedInputStream(inputStream: any, spec?: FileOperationSpec | null): KvContent;
   ...
   *           content that needs to be written
   */
  write(content: any | null, spec?: FileOperationSpec | null): KvContent;
   ...
   *           encoded content that needs to be written
   */
  writeEncoded(encodedContent: any | null, spec?: FileOperationSpec | null): KvContent;
   ...
   *           content that needs to be written
   */
  writeString(content: string | null, spec?: FileOperationSpec | null): KvContent;
   ...
   */
  writeObj(obj: Obj | null, spec?: FileObjsOperSpec | null): KvContent;
   ...
   * @return pair of update instance of this content and number of objs written
   */
  startWriteObjs(spec?: FileObjsOperSpec | null): Pair<KvContent | null, PushStream<Obj | null> | null>;
   ...
   */
  compress(contentEncoding?: string | null, spec?: FileCompressSpec | null): KvContent;

  /**
   * Uncompresses content.
   */
  uncompress(spec?: FileCompressSpec | null): KvContent;
   ...
   */
  transcode(contentType: string, contentEncoding: string, spec?: FileCompressSpec | null): KvContent;

  /**
   * Copies content to a given target.
   */
  copyContentTo(target: KvContent, spec?: FileOperationSpec | null): void;
