// TypeScript definitions for the C3 type Feature.Store.Block.PackJob

/**
 * BatchJob to pack the {@link Feature.Store.Block}s in a distributed mode.
 *
 * @remarks this represents a value passed to a method that expects an instance of Feature.Store.Block.PackJob
 */
declare namespace Feature.Store.Block {
  export interface IPackJob {
 ...
 */
declare namespace Feature.Store.Block {
  export class PackJob extends Obj {

    /**
     * current or last job execution for this instance
     */
    readonly run?: BatchJobRun | null;
    withRun(run: IBatchJobRun | null): Feature.Store.Block.PackJob;

    /**
     * previous job executions for this instance
     */
    readonly runs?: C3.Array<BatchJobRun | null>;
    withRuns(runs: C3.Array<BatchJobRun | null> | Array<IBatchJobRun | null>): Feature.Store.Block.PackJob;

    /**
     * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
     */
    readonly options?: Obj | null;
    withOptions(options: IObj | null): Feature.Store.Block.PackJob;
    ...
    withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): Feature.Store.Block.PackJob;
    ...
    withPriority(priority: number | null): Feature.Store.Block.PackJob;
    ...
    withDisabled(disabled: boolean): Feature.Store.Block.PackJob;
    ...
    withMaxConcurrency(maxConcurrency: number | null): Feature.Store.Block.PackJob;
    ...
    withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): Feature.Store.Block.PackJob;
    ...
    withRunAsUser(runAsUser: boolean | null): Feature.Store.Block.PackJob;

    /**
     * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
     */
    readonly nodePool?: string | null;
    withNodePool(nodePool: string | null): Feature.Store.Block.PackJob;
    ...
    withSkipIfRunning(skipIfRunning: boolean | null): Feature.Store.Block.PackJob;

    /**
     * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
     */
    readonly numAutoRecoveryAttempts?: number | null;
    withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): Feature.Store.Block.PackJob;
    ...
    withPropagateActionContext(propagateActionContext: boolean): Feature.Store.Block.PackJob;
    ...
    withTypeIdent(typeIdent: string | null): Feature.Store.Block.PackJob;
     ...
     */
    readonly id: string;
    withId(id: string): Feature.Store.Block.PackJob;
    ...
    withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Feature.Store.Block.PackJob;

    /**
     * Name of the Obj instance
     */
    readonly name?: string | null;
    withName(name: string | null): Feature.Store.Block.PackJob;

    /**
     * Various system fields.
     */
    readonly meta?: Meta | null;
    withMeta(meta: IMeta | null): Feature.Store.Block.PackJob;
    ...
    withVersion(version: number | null): Feature.Store.Block.PackJob;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type | null;
    withTypeWithBindings(typeWithBindings: IType | null): Feature.Store.Block.PackJob;
    ...
    withAbortOnError(abortOnError: boolean): Feature.Store.Block.PackJob;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Feature.Store.Block.PackJob | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Feature.Store.Block.PackJob | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Feature.Store.Block.PackJob | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Feature.Store.Block.PackJob | null;
     ...
     */
    replaceType(old: Type, new_: Type): Feature.Store.Block.PackJob;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Feature.Store.Block.PackJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Feature.Store.Block.PackJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Feature.Store.Block.PackJob | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Feature.Store.Block.PackJob | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Feature.Store.Block.PackJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Feature.Store.Block.PackJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Feature.Store.Block.PackJob;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Feature.Store.Block.PackJob;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Feature.Store.Block.PackJob;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Feature.Store.Block.PackJob;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Feature.Store.Block.PackJob;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Feature.Store.Block.PackJob;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Feature.Store.Block.PackJob;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Feature.Store.Block.PackJob;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Feature.Store.Block.PackJob;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Feature.Store.Block.PackJob;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Feature.Store.Block.PackJob;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Feature.Store.Block.PackJob;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Feature.Store.Block.PackJob;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Feature.Store.Block.PackJob;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Feature.Store.Block.PackJob;
     ...
     * @see #removeField
     */
    unsetField(field: string): Feature.Store.Block.PackJob;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Feature.Store.Block.PackJob;
     ...
     * @see #unsetField
     */
    removeField(field: string): Feature.Store.Block.PackJob;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Feature.Store.Block.PackJob;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Feature.Store.Block.PackJob;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Feature.Store.Block.PackJob;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Feature.Store.Block.PackJob;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Feature.Store.Block.PackJob;

    mergeJson(json: any | null): Feature.Store.Block.PackJob;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Feature.Store.Block.PackJob;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Feature.Store.Block.PackJob;
     ...
     */
    singletonArray(): C3.Array<Feature.Store.Block.PackJob | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Feature.Store.Block.PackJob | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Feature.Store.Block.PackJob | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Feature.Store.Block.PackJob | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Feature.Store.Block.PackJob | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Feature.Store.Block.PackJob | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Feature.Store.Block.PackJob | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Feature.Store.Block.PackJob | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Feature.Store.Block.PackJob | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Feature.Store.Block.PackJob;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Feature.Store.Block.PackJob;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Feature.Store.Block.PackJob;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Feature.Store.Block.PackJob;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Feature.Store.Block.PackJob;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Feature.Store.Block.PackJob;
     ...
     * @see #fromString
     */
    static make(s: string | null): Feature.Store.Block.PackJob | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Feature.Store.Block.PackJob;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Feature.Store.Block.PackJob;
     ...
     */
    static cachedEmptyInst(): Feature.Store.Block.PackJob;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Feature.Store.Block.PackJob>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Feature.Store.Block.PackJob;
     ...
     */
    start(options?: Feature.Store.Block.PackOptions | null): BatchJobStatus | null;
     ...
     */
    cleanup(options?: Feature.Store.Block.PackOptions | null): void;
    ...
    cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun | null, BatchJobStatus | null, Feature.Store.Block.PackOptions | null> | null;

    failJob(run: JobRun<BatchJobStatusBase | null>): JobBase<BatchJobRun | null, BatchJobStatus | null, Feature.Store.Block.PackOptions | null> | null;
    ...
    validateStart(options?: Feature.Store.Block.PackOptions | null): void;
     ...
     */
    static fetch(spec?: FetchSpec | null): FetchResult<Feature.Store.Block.PackJob | null>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Feature.Store.Block.PackJob | null>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Feature.Store.Block.PackJob | null>;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Feature.Store.Block.PackJob | null> | null>;
     ...
     */
    get(include?: string | null): Feature.Store.Block.PackJob | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string | null): Feature.Store.Block.PackJob | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Feature.Store.Block.PackJob;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string | null): Feature.Store.Block.PackJob | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Feature.Store.Block.PackJob;
     ...
     * @see #toString
     */
    static fromString(s: string | null): Feature.Store.Block.PackJob | null;
     ...
     */
    create(spec?: UpsertSpec | null): Feature.Store.Block.PackJob | null;
     ...
     */
    static createBatch(objs: C3.Array<Feature.Store.Block.PackJob | null> | null, spec?: UpsertSpec | null): ObjList<Feature.Store.Block.PackJob | null> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Feature.Store.Block.PackJob | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Feature.Store.Block.PackJob | null> | null;
     ...
     */
    update(srcObj?: Feature.Store.Block.PackJob | null, spec?: UpsertSpec | null): Feature.Store.Block.PackJob | null;
     ...
     */
    upsert(srcObj?: Feature.Store.Block.PackJob | null, spec?: UpsertSpec | null): Feature.Store.Block.PackJob | null;
     ...
     */
    merge(spec?: MergeSpec | null): Feature.Store.Block.PackJob | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec | null): Feature.Store.Block.PackJob | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec | null): Feature.Store.Block.PackJob | null;
     ...
     */
    static updateBatch(objs: C3.Array<Feature.Store.Block.PackJob | null> | null, srcObjs?: C3.Array<Feature.Store.Block.PackJob | null>, spec?: UpsertSpec | null): ObjList<Feature.Store.Block.PackJob | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<C3.Array<Feature.Store.Block.PackJob | null>>, spec?: UpsertSpec | null): ObjList<Feature.Store.Block.PackJob | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: C3.Array<Feature.Store.Block.PackJob | null> | null, srcObjs?: C3.Array<Feature.Store.Block.PackJob | null>, spec?: UpsertSpec | null): ObjList<Feature.Store.Block.PackJob | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<C3.Array<Feature.Store.Block.PackJob | null>>, spec?: UpsertSpec | null): ObjList<Feature.Store.Block.PackJob | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: C3.Array<Feature.Store.Block.PackJob | null> | null, spec?: TouchSpec | null): ObjList<Feature.Store.Block.PackJob | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<Feature.Store.Block.PackJob | null> | null, spec?: MergeSpec | null): ObjList<Feature.Store.Block.PackJob | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<Feature.Store.Block.PackJob | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Feature.Store.Block.PackJob | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<C3.Array<Feature.Store.Block.PackJob | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Feature.Store.Block.PackJob | null> | null;
     ...
     */
    static mergeAll(mergeObj: Feature.Store.Block.PackJob | null, spec?: MergeAllSpec | null): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Feature.Store.Block.PackJob | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: C3.Array<Feature.Store.Block.PackJob | null> | null, spec?: UpsertSpec | null): ObjList<Feature.Store.Block.PackJob | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: C3.Array<Feature.Store.Block.PackJob | null> | null, spec?: UpsertSpec | null): ObjList<Feature.Store.Block.PackJob | null> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Feature.Store.Block.PackJob | null;
     ...
     */
    static beforeCreate(objs: C3.Array<Feature.Store.Block.PackJob | null> | null): ObjList<Feature.Store.Block.PackJob | null>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: C3.Array<Feature.Store.Block.PackJob | null> | null): ObjList<Feature.Store.Block.PackJob | null>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: C3.Array<Feature.Store.Block.PackJob | null> | null): ObjList<Feature.Store.Block.PackJob | null>;
     ...
     */
    static afterCreate(objs: C3.Array<Feature.Store.Block.PackJob | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: C3.Array<Feature.Store.Block.PackJob | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: C3.Array<Feature.Store.Block.PackJob | null> | null): C3.Array<ObjError | null>;
     ...
     */
    static startImportData(spec?: StartImportDataSpec | null): PushStream<Feature.Store.Block.PackJob | null>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Feature.Store.Block.PackJob | null>;
     ...
     */
    static forId(id: string | null, failIfMissing?: boolean): Feature.Store.Block.PackJob | null;
     ...
     */
    withoutIdentity(): Feature.Store.Block.PackJob | null;
     ...
     */
    static typeOfBatch(objs: C3.Array<Feature.Store.Block.PackJob | null> | null): C3.Array<EntityType | null>;
     ...
     */
    static dbEcho(template?: Feature.Store.Block.PackJob | null, count?: number | null, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: C3.Array<Feature.Store.Block.PackJob | null> | null, callback?: λFunction<Feature.Store.Block.PackJob | null, Feature.Store.Block.PackJob | null> | null): ObjList<Feature.Store.Block.PackJob | null>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: C3.Array<Feature.Store.Block.PackJob | null> | null, callback?: λFunction<Feature.Store.Block.PackJob | null, Feature.Store.Block.PackJob | null> | null): C3.Array<ObjError | null>;
     ...
     */
    static doStart(job?: Feature.Store.Block.PackJob | null, options?: Feature.Store.Block.PackOptions | null): void;
     ...
     */
    static processBatch(batch?: Feature.Store.Block.PackBatch | null, job?: Feature.Store.Block.PackJob | null, options?: Feature.Store.Block.PackOptions | null): void;
     ...
     */
    static allComplete(job: Feature.Store.Block.PackJob, options?: Feature.Store.Block.PackOptions | null): string | null;
     ...
     *           Options the job was run with.
     */
    static failed(job: Feature.Store.Block.PackJob, status: BatchJobStatus, options?: Feature.Store.Block.PackOptions | null): void;
     ...
     *        Batch to schedule.
     */
    scheduleBatch(batch?: Feature.Store.Block.PackBatch | null): void;
     ...
     *        Batches to schedule.
     */
    scheduleBatches(batches?: C3.Array<Feature.Store.Block.PackBatch | null>): void;
     ...
     */
    static scheduleObjBatch(job?: Feature.Store.Block.PackJob | null, objBatch?: ObjBatch | null, logPrefix?: string | null): number | null;
     ...
     */
    static startPackJobWithOptions(options: Feature.Store.Block.PackOptions): Feature.Store.Block.PackJob | null;
  }
}
