// TypeScript definitions for the C3 type File

/**
 * The following type represents the file in a file-system.
 *
 * @remarks this represents a value passed to a method that expects an instance of File
 */
 ...
 * The following type represents the file in a file-system.
 *
 * @remarks this represents a made instance of File
 */
declare class File extends Obj {
  ...
  withContentEncoding(contentEncoding: string | null): File;
  ...
  withContentLanguage(contentLanguage: string | null): File;
  ...
  withContentLength(contentLength: number | null): File;
  ...
  withContentLocation(contentLocation: string | null): File;
  ...
  withContentType(contentType: string | null): File;
  ...
  withContentDisposition(contentDisposition: string | null): File;
  ...
  withETag(eTag: string | null): File;
  ...
  withLastModified(lastModified: DateTime | Date | string | null): File;

  /**
   * Id of user / identity who last last modified this content.
   */
  readonly lastModifiedBy?: string | null;
  withLastModifiedBy(lastModifiedBy: string | null): File;
  ...
  withContentMD5(contentMD5: string | null): File;
  ...
  withContentSHA1(contentSHA1: string | null): File;

  /**
   * Field to maintain state whether content metadata was read or not.
   */
  readonly hasMetadata?: boolean;
  withHasMetadata(hasMetadata: boolean): File;

  /**
   * URL for this file that contains scheme (i.e. file-system) and fully qualified encoded path.
   */
  readonly url?: string | null;
  withUrl(url: string | null): File;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): File | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): File | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): File | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): File | null;
   ...
   */
  replaceType(old: Type, new_: Type): File;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): File;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): File;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<File | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<File | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): File;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): File;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): File;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): File;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): File;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): File;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): File;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): File;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): File;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): File;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): File;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): File;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): File;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): File;
   ...
   * @see #unsetField
   */
  defaultField(field: string): File;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): File;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): File;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): File;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): File;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): File;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): File;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): File;

  mergeJson(json: any | null): File;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): File;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): File;
   ...
   */
  singletonArray(): C3.Array<File | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<File | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<File | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<File | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<File | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, File | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, File | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<File | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<File | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): File;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): File;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): File;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): File;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): File;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): File;
   ...
   * @see #fromString
   */
  static make(s: string | null): File | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): File;
   ...
   */
  static cachedEmptyInst(): File;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<File>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): File;
   ...
   */
  withFileName(fileName: string | null): File;

  /**
   * Changes file extension in this instance.
   */
  withFileExt(fileExt: string | null): File;
   ...
   */
  identify(suffix?: string | null): File;
   ...
   */
  readMetadata(spec?: FileOperationSpec | null): File;
   ...
   */
  refreshMetadata(spec?: FileOperationSpec | null): File;
   ...
   * @return abstract content with metadata.
   */
  guessMetadata(spec?: FileOperationSpec | null): File;
   ...
   */
  withMetadata(meta?: ContentMeta | null): File;
   ...
   */
  encodedPushStream(spec?: FileOperationSpec | null): Pair<File | null, BytePushStream | null>;

  /**
   * @return byte push stream to be used for writing un-encoded data into this content object.
   */
  pushStream(spec?: FileOperationSpec | null): Pair<File | null, BytePushStream | null>;

  /**
   * @return character push stream to be used for writing un-encoded data into this content object.
   */
  charPushStream(spec?: FileOperationSpec | null): Pair<File | null, CharPushStream | null>;
   ...
   */
  encodedStream(spec?: FileOperationSpec | null): Pair<File | null, ByteStream | null> | null;
   ...
   */
  writeStream(content: ByteStream | null, spec?: FileOperationSpec | null): File;

  /**
   * Truncates file and replaces it's content with provided binary content.
   */
  writeInputStream(inputStream: any, spec?: FileOperationSpec | null): File;

  /**
   * Truncates file and replaces its content with provided binary content from zipInputStream
   */
  writeZipInputStream(zipInputStream: any, spec?: FileOperationSpec | null): File;
   ...
   */
  writeEncodedStream(encodedContent: ByteStream | null, spec?: FileOperationSpec | null): File;

  /**
   * Truncates file and replaces it's encoded content with provided binary content.
   */
  writeEncodedInputStream(inputStream: any, spec?: FileOperationSpec | null): File;
   ...
   *           content that needs to be written
   */
  write(content: any | null, spec?: FileOperationSpec | null): File;
   ...
   *           encoded content that needs to be written
   */
  writeEncoded(encodedContent: any | null, spec?: FileOperationSpec | null): File;
   ...
   *           content that needs to be written
   */
  writeString(content: string | null, spec?: FileOperationSpec | null): File;
   ...
   */
  writeObj(obj: Obj | null, spec?: FileObjsOperSpec | null): File;
   ...
   * @return pair of update instance of this content and number of objs written
   */
  startWriteObjs(spec?: FileObjsOperSpec | null): Pair<File | null, PushStream<Obj | null> | null>;
   ...
   */
  compress(contentEncoding?: string | null, spec?: FileCompressSpec | null): File;

  /**
   * Uncompresses file. Removes compression specific extension.
   */
  uncompress(spec?: FileCompressSpec | null): File;
   ...
   */
  transcode(contentType: string, contentEncoding: string, spec?: FileCompressSpec | null): File;

  /**
   * Copies content to a given target.
   */
  copyContentTo(target: File, spec?: FileOperationSpec | null): void;
   ...
   */
  static fromString(s: string | null): File | null;
