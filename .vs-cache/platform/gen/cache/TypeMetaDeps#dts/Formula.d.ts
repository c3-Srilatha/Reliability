// TypeScript definitions for the C3 type Formula

/**
 * As a feature store concept, analogous to legacy {@link Metric}, a {@link Formula} is an "abstract" feature
 * without data but with expression to construct a concrete feature
 *
 * Formula is seeded and cached data at package provision but also allows for live creation for new instances in db,
 * forming a mathematical expression provided from customers and computing a concrete feature given appropriate
 * subject type and timeseries interval
 *
 * see {@ink Feature}
 * see {@link Metric}
 * see {@link Interval}
 * see {@link FeatureEvaluatable}
 *
 * @remarks this represents a value passed to a method that expects an instance of Formula
 */
declare interface IFormula {
  ...
  /**
   * Formula expression from {@link Metric}, either id of {@link CompoundMetric} or name of {@link SimpleMetric}
   */
  legacyExpression: string;

  /**
   * {@link Interval} of formula
   */
  interval: string;
}
 ...
 * see {@link FeatureEvaluatable}
 *
 * @remarks this represents a made instance of Formula
 */
declare class Formula extends Obj {
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Formula;

  /**
   * Name of the formula
   */
  readonly name: string;
  withName(name: string): Formula;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): Formula;
  ...
  withVersion(version: number | null): Formula;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): Formula;
  ...
  withUserUpdatedFields(userUpdatedFields: C3.Array<string | null> | Array<string | null>): Formula;
  ...
  withHidden(hidden: boolean): Formula;
  ...
  withUserOwned(userOwned: boolean): Formula;

  /**
   * Formula expression from {@link Metric}, either id of {@link CompoundMetric} or name of {@link SimpleMetric}
   */
  readonly legacyExpression: string;
  withLegacyExpression(legacyExpression: string): Formula;

  /**
   * {@link Interval} of formula
   */
  readonly interval: string;
  withInterval(interval: string): Formula;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Formula | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Formula | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Formula | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Formula | null;
   ...
   */
  replaceType(old: Type, new_: Type): Formula;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Formula;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Formula;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Formula | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Formula | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Formula;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Formula;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Formula;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Formula;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Formula;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Formula;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Formula;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Formula;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Formula;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Formula;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Formula;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Formula;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Formula;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Formula;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Formula;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Formula;
   ...
   * @see #removeField
   */
  unsetField(field: string): Formula;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Formula;
   ...
   * @see #unsetField
   */
  removeField(field: string): Formula;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Formula;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Formula;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Formula;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Formula;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Formula;

  mergeJson(json: any | null): Formula;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Formula;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Formula;
   ...
   */
  singletonArray(): C3.Array<Formula | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Formula | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Formula | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Formula | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Formula | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Formula | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Formula | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Formula | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Formula | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Formula;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Formula;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Formula;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Formula;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Formula;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Formula;
   ...
   * @see #fromString
   */
  static make(s: string | null): Formula | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Formula;
   ...
   */
  static cachedEmptyInst(): Formula;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Formula>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Formula;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<Formula | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<Formula | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<Formula | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): Formula | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string | null): Formula | null;
   ...
   * @see findByCacheKey
   */
  getCached(): Formula | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): Formula | null;
   ...
   */
  static produce(key: string): Formula | null;
   ...
   */
  static produceAll(): C3.Map<string | null, Formula | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, Formula | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<Formula | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<Formula | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Formula | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Formula | null> | null>;
   ...
   */
  get(include?: string | null): Formula | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): Formula | null;
   ...
   */
  getMissing(spec: GetMissingSpec): Formula;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): Formula | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): Formula;
   ...
   * @see #toString
   */
  static fromString(s: string | null): Formula | null;
   ...
   */
  create(spec?: UpsertSpec | null): Formula | null;
   ...
   */
  static createBatch(objs: C3.Array<Formula | null> | null, spec?: UpsertSpec | null): ObjList<Formula | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<Formula | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Formula | null> | null;
   ...
   */
  update(srcObj?: Formula | null, spec?: UpsertSpec | null): Formula | null;
   ...
   */
  upsert(srcObj?: Formula | null, spec?: UpsertSpec | null): Formula | null;
   ...
   */
  merge(spec?: MergeSpec | null): Formula | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): Formula | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): Formula | null;
   ...
   */
  static updateBatch(objs: C3.Array<Formula | null> | null, srcObjs?: C3.Array<Formula | null>, spec?: UpsertSpec | null): ObjList<Formula | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<Formula | null>>, spec?: UpsertSpec | null): ObjList<Formula | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<Formula | null> | null, srcObjs?: C3.Array<Formula | null>, spec?: UpsertSpec | null): ObjList<Formula | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<Formula | null>>, spec?: UpsertSpec | null): ObjList<Formula | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<Formula | null> | null, spec?: TouchSpec | null): ObjList<Formula | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Formula | null> | null, spec?: MergeSpec | null): ObjList<Formula | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Formula | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Formula | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<Formula | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Formula | null> | null;
   ...
   */
  static mergeAll(mergeObj: Formula | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: Formula | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<Formula | null> | null, spec?: UpsertSpec | null): ObjList<Formula | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<Formula | null> | null, spec?: UpsertSpec | null): ObjList<Formula | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<Formula | null> | null): ObjList<Formula | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<Formula | null> | null): ObjList<Formula | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<Formula | null> | null): ObjList<Formula | null>;
   ...
   */
  static afterCreate(objs: C3.Array<Formula | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<Formula | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<Formula | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<Formula | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Formula | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): Formula | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<Formula | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: Formula | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<Formula | null> | null, callback?: λFunction<Formula | null, Formula | null> | null): ObjList<Formula | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<Formula | null> | null, callback?: λFunction<Formula | null, Formula | null> | null): C3.Array<ObjError | null>;
   ...
   */
  publish(subPath?: string | null, contentType?: string | null): Formula;
   ...
   */
  static removeSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<Formula | null> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec | null): Formula | null;
   ...
   */
  static createSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<Formula | null> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData | null, spec?: UpsertSpec | null): Formula | null;
   ...
   */
  static updateSeedDataBatch(objs?: C3.Array<SeedData | null>, srcObjs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<Formula | null> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec | null): Formula | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: C3.Array<SeedData | null>, spec?: MergeSpec | null): ObjList<Formula | null> | null;
  ...
  dependencies(): SeedDataDeps<Formula | null> | null;
  ...
  /**
   * Create {@link Formula} from the given metric.
   * If @param interval is not specified, default is DAY
   * If @param name is not specified, default is name of this formula
   */
  createFeature(subjectType: Type, name?: string | null): Feature;
}
