// TypeScript definitions for the C3 type Pkg.Store.Seq

/**
 * @remarks this represents a value passed to a method that expects an instance of Pkg.Store.Seq
 */
declare namespace Pkg.Store {
  export interface ISeq {
    ...
    /**
     * Tracking what the prev sequence number used.
     */
    seq?: number | null;
  }
}
...
/**
 * @remarks this represents a made instance of Pkg.Store.Seq
 */
declare namespace Pkg.Store {
  export class Seq extends Obj {
     ...
     */
    readonly id: string;
    withId(id: string): Pkg.Store.Seq;
    ...
    withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Pkg.Store.Seq;
    ...
    withName(name: string | null): Pkg.Store.Seq;
    ...
    withMeta(meta: IMeta | null): Pkg.Store.Seq;
    ...
    withVersion(version: number | null): Pkg.Store.Seq;
    ...
    withTypeWithBindings(typeWithBindings: IType | null): Pkg.Store.Seq;
    ...
    withSeq(seq: number | null): Pkg.Store.Seq;

    /**
     * Tracking what the prev sequence number used.
     */
    static readonly seq?: number | null;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Pkg.Store.Seq | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Pkg.Store.Seq | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Pkg.Store.Seq | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Pkg.Store.Seq | null;
     ...
     */
    replaceType(old: Type, new_: Type): Pkg.Store.Seq;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Pkg.Store.Seq;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Pkg.Store.Seq;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Pkg.Store.Seq;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Pkg.Store.Seq;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Pkg.Store.Seq;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Pkg.Store.Seq | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Pkg.Store.Seq | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Pkg.Store.Seq | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Pkg.Store.Seq | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Pkg.Store.Seq;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Pkg.Store.Seq;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Pkg.Store.Seq;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Pkg.Store.Seq;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Pkg.Store.Seq;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Pkg.Store.Seq;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Pkg.Store.Seq;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Pkg.Store.Seq;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Pkg.Store.Seq;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Pkg.Store.Seq;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Pkg.Store.Seq;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Pkg.Store.Seq;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Pkg.Store.Seq;
     ...
     * @return new Obj
     */
    static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Pkg.Store.Seq;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Pkg.Store.Seq;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Pkg.Store.Seq;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Pkg.Store.Seq;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Pkg.Store.Seq;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Pkg.Store.Seq;
     ...
     * @see #removeField
     */
    static withoutField(field: string | null): Pkg.Store.Seq;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Pkg.Store.Seq;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType | null): Pkg.Store.Seq;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Pkg.Store.Seq;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: C3.Array<string | null> | null): Pkg.Store.Seq;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Pkg.Store.Seq;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Pkg.Store.Seq;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Pkg.Store.Seq;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Pkg.Store.Seq;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Pkg.Store.Seq;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Pkg.Store.Seq;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Pkg.Store.Seq;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Pkg.Store.Seq;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Pkg.Store.Seq;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Pkg.Store.Seq;
     ...
     * @see #removeField
     */
    unsetField(field: string): Pkg.Store.Seq;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Pkg.Store.Seq;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Pkg.Store.Seq;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Pkg.Store.Seq;
     ...
     * @see #unsetField
     */
    removeField(field: string): Pkg.Store.Seq;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Pkg.Store.Seq;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Pkg.Store.Seq;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Pkg.Store.Seq;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Pkg.Store.Seq;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Pkg.Store.Seq;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Pkg.Store.Seq;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj | null, otherFieldsFilter: Type): Pkg.Store.Seq;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Pkg.Store.Seq;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Pkg.Store.Seq;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Pkg.Store.Seq;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Pkg.Store.Seq;

    mergeJson(json: any | null): Pkg.Store.Seq;

    static mergeJson(json: any | null): Pkg.Store.Seq;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Pkg.Store.Seq;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Pkg.Store.Seq;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Pkg.Store.Seq;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj | null, deep?: boolean): Pkg.Store.Seq;
     ...
     */
    singletonArray(): C3.Array<Pkg.Store.Seq | null>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): C3.Array<Pkg.Store.Seq | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Pkg.Store.Seq | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Pkg.Store.Seq | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Pkg.Store.Seq | null>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): C3.Set<Pkg.Store.Seq | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Pkg.Store.Seq | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Pkg.Store.Seq | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Pkg.Store.Seq | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Pkg.Store.Seq | null>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Pkg.Store.Seq | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Pkg.Store.Seq | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Pkg.Store.Seq;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Pkg.Store.Seq;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Pkg.Store.Seq;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Pkg.Store.Seq;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Pkg.Store.Seq;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Pkg.Store.Seq;
     ...
     * @see #fromString
     */
    static make(s: string | null): Pkg.Store.Seq | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Pkg.Store.Seq;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Pkg.Store.Seq;
     ...
     */
    static cachedEmptyInst(): Pkg.Store.Seq;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Pkg.Store.Seq>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Pkg.Store.Seq;
     ...
     */
    static fetch(spec?: FetchSpec | null): FetchResult<Pkg.Store.Seq | null>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Pkg.Store.Seq | null>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Pkg.Store.Seq | null>;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Pkg.Store.Seq | null> | null>;
     ...
     */
    get(include?: string | null): Pkg.Store.Seq | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    static get(include?: string | null): Pkg.Store.Seq | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string | null): Pkg.Store.Seq | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    static getSpecific(include?: string | null): Pkg.Store.Seq | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Pkg.Store.Seq;
     ...
     * @return instance of the obj with all requested fields.
     */
    static getMissing(spec: GetMissingSpec): Pkg.Store.Seq;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string | null): Pkg.Store.Seq | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    static getDirect(include?: string | null): Pkg.Store.Seq | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Pkg.Store.Seq;
     ...
     * @return The instance after applying the reverse edit.
     */
    static applyReverseEdit(versionEdit: VersionEdit): Pkg.Store.Seq;
     ...
     * @see #toString
     */
    static fromString(s: string | null): Pkg.Store.Seq | null;
     ...
     */
    create(spec?: UpsertSpec | null): Pkg.Store.Seq | null;
     ...
     *         will have only those fields populated. Otherwise only the id field will be populated.
     */
    static create(spec?: UpsertSpec | null): Pkg.Store.Seq | null;
     ...
     */
    static createBatch(objs: C3.Array<Pkg.Store.Seq | null> | null, spec?: UpsertSpec | null): ObjList<Pkg.Store.Seq | null> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Pkg.Store.Seq | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Pkg.Store.Seq | null> | null;
     ...
     */
    update(srcObj?: Pkg.Store.Seq | null, spec?: UpsertSpec | null): Pkg.Store.Seq | null;
     ...
     *         obj will have only those fields populated. Otherwise only the id field will be populated.
     */
    static update(srcObj?: Pkg.Store.Seq | null, spec?: UpsertSpec | null): Pkg.Store.Seq | null;
     ...
     */
    upsert(srcObj?: Pkg.Store.Seq | null, spec?: UpsertSpec | null): Pkg.Store.Seq | null;
     ...
     *         returned obj will have only those fields populated. Otherwise only the id field will be populated.
     */
    static upsert(srcObj?: Pkg.Store.Seq | null, spec?: UpsertSpec | null): Pkg.Store.Seq | null;
     ...
     */
    merge(spec?: MergeSpec | null): Pkg.Store.Seq | null;
     ...
     * @see Mergespec#csvInclude
     */
    static merge(spec?: MergeSpec | null): Pkg.Store.Seq | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec | null): Pkg.Store.Seq | null;
     ...
     * @return The created or updated obj.
     */
    static merge(mergeInclude: string, spec?: MergeSpec | null): Pkg.Store.Seq | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec | null): Pkg.Store.Seq | null;
     ...
     * @return The created or updated obj.
     */
    static touch(spec?: TouchSpec | null): Pkg.Store.Seq | null;
     ...
     */
    static updateBatch(objs: C3.Array<Pkg.Store.Seq | null> | null, srcObjs?: C3.Array<Pkg.Store.Seq | null>, spec?: UpsertSpec | null): ObjList<Pkg.Store.Seq | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<C3.Array<Pkg.Store.Seq | null>>, spec?: UpsertSpec | null): ObjList<Pkg.Store.Seq | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: C3.Array<Pkg.Store.Seq | null> | null, srcObjs?: C3.Array<Pkg.Store.Seq | null>, spec?: UpsertSpec | null): ObjList<Pkg.Store.Seq | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<C3.Array<Pkg.Store.Seq | null>>, spec?: UpsertSpec | null): ObjList<Pkg.Store.Seq | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: C3.Array<Pkg.Store.Seq | null> | null, spec?: TouchSpec | null): ObjList<Pkg.Store.Seq | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<Pkg.Store.Seq | null> | null, spec?: MergeSpec | null): ObjList<Pkg.Store.Seq | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<Pkg.Store.Seq | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Pkg.Store.Seq | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<C3.Array<Pkg.Store.Seq | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Pkg.Store.Seq | null> | null;
     ...
     */
    static mergeAll(mergeObj: Pkg.Store.Seq | null, spec?: MergeAllSpec | null): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Pkg.Store.Seq | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: C3.Array<Pkg.Store.Seq | null> | null, spec?: UpsertSpec | null): ObjList<Pkg.Store.Seq | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: C3.Array<Pkg.Store.Seq | null> | null, spec?: UpsertSpec | null): ObjList<Pkg.Store.Seq | null> | null;
     ...
     * @see Ann.Db#archive
     */
    static unremove(): Pkg.Store.Seq | null;
     ...
     */
    static beforeCreate(objs: C3.Array<Pkg.Store.Seq | null> | null): ObjList<Pkg.Store.Seq | null>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: C3.Array<Pkg.Store.Seq | null> | null): ObjList<Pkg.Store.Seq | null>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: C3.Array<Pkg.Store.Seq | null> | null): ObjList<Pkg.Store.Seq | null>;
     ...
     */
    static afterCreate(objs: C3.Array<Pkg.Store.Seq | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: C3.Array<Pkg.Store.Seq | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: C3.Array<Pkg.Store.Seq | null> | null): C3.Array<ObjError | null>;
     ...
     */
    static startImportData(spec?: StartImportDataSpec | null): PushStream<Pkg.Store.Seq | null>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Pkg.Store.Seq | null>;
     ...
     */
    static forId(id: string | null, failIfMissing?: boolean): Pkg.Store.Seq | null;
     ...
     */
    withoutIdentity(): Pkg.Store.Seq | null;
     ...
     * @return The requested obj without any of its identifying fields.
     */
    static withoutIdentity(): Pkg.Store.Seq | null;
     ...
     */
    static typeOfBatch(objs: C3.Array<Pkg.Store.Seq | null> | null): C3.Array<EntityType | null>;
     ...
     */
    static dbEcho(template?: Pkg.Store.Seq | null, count?: number | null, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: C3.Array<Pkg.Store.Seq | null> | null, callback?: λFunction<Pkg.Store.Seq | null, Pkg.Store.Seq | null> | null): ObjList<Pkg.Store.Seq | null>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: C3.Array<Pkg.Store.Seq | null> | null, callback?: λFunction<Pkg.Store.Seq | null, Pkg.Store.Seq | null> | null): C3.Array<ObjError | null>;
    ...
    /**
     * Get the next sequence number by incrementing the prev used sequence number.
     */
    next(): number | null;
