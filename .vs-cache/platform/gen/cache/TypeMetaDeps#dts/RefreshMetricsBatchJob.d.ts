// TypeScript definitions for the C3 type RefreshMetricsBatchJob

/**
 * Batch job definitions for batch jobs started from RefreshMetricsTask for asynchronous processing.
 *
 * @remarks this represents a value passed to a method that expects an instance of RefreshMetricsBatchJob
 */
declare interface IRefreshMetricsBatchJob {
 ...
 */
declare class RefreshMetricsBatchJob extends Obj {

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun | null;
  withRun(run: IBatchJobRun | null): RefreshMetricsBatchJob;

  /**
   * previous job executions for this instance
   */
  readonly runs?: C3.Array<BatchJobRun | null>;
  withRuns(runs: C3.Array<BatchJobRun | null> | Array<IBatchJobRun | null>): RefreshMetricsBatchJob;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj | null;
  withOptions(options: IObj | null): RefreshMetricsBatchJob;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): RefreshMetricsBatchJob;
  ...
  withPriority(priority: number | null): RefreshMetricsBatchJob;
  ...
  withDisabled(disabled: boolean): RefreshMetricsBatchJob;
  ...
  withMaxConcurrency(maxConcurrency: number | null): RefreshMetricsBatchJob;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): RefreshMetricsBatchJob;
  ...
  withRunAsUser(runAsUser: boolean | null): RefreshMetricsBatchJob;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string | null;
  withNodePool(nodePool: string | null): RefreshMetricsBatchJob;
  ...
  withSkipIfRunning(skipIfRunning: boolean | null): RefreshMetricsBatchJob;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number | null;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): RefreshMetricsBatchJob;
  ...
  withPropagateActionContext(propagateActionContext: boolean): RefreshMetricsBatchJob;
  ...
  withTypeIdent(typeIdent: string | null): RefreshMetricsBatchJob;
   ...
   */
  readonly id: string;
  withId(id: string): RefreshMetricsBatchJob;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): RefreshMetricsBatchJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): RefreshMetricsBatchJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): RefreshMetricsBatchJob;
  ...
  withVersion(version: number | null): RefreshMetricsBatchJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): RefreshMetricsBatchJob;
  ...
  withAbortOnError(abortOnError: boolean): RefreshMetricsBatchJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): RefreshMetricsBatchJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): RefreshMetricsBatchJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): RefreshMetricsBatchJob | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): RefreshMetricsBatchJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): RefreshMetricsBatchJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): RefreshMetricsBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): RefreshMetricsBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<RefreshMetricsBatchJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<RefreshMetricsBatchJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): RefreshMetricsBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RefreshMetricsBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RefreshMetricsBatchJob;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): RefreshMetricsBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): RefreshMetricsBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): RefreshMetricsBatchJob;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): RefreshMetricsBatchJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): RefreshMetricsBatchJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): RefreshMetricsBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): RefreshMetricsBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): RefreshMetricsBatchJob;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): RefreshMetricsBatchJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): RefreshMetricsBatchJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): RefreshMetricsBatchJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): RefreshMetricsBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): RefreshMetricsBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): RefreshMetricsBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): RefreshMetricsBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): RefreshMetricsBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): RefreshMetricsBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): RefreshMetricsBatchJob;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): RefreshMetricsBatchJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): RefreshMetricsBatchJob;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): RefreshMetricsBatchJob;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): RefreshMetricsBatchJob;

  mergeJson(json: any | null): RefreshMetricsBatchJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): RefreshMetricsBatchJob;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): RefreshMetricsBatchJob;
   ...
   */
  singletonArray(): C3.Array<RefreshMetricsBatchJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<RefreshMetricsBatchJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<RefreshMetricsBatchJob | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<RefreshMetricsBatchJob | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<RefreshMetricsBatchJob | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, RefreshMetricsBatchJob | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, RefreshMetricsBatchJob | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<RefreshMetricsBatchJob | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<RefreshMetricsBatchJob | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): RefreshMetricsBatchJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): RefreshMetricsBatchJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): RefreshMetricsBatchJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): RefreshMetricsBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): RefreshMetricsBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): RefreshMetricsBatchJob;
   ...
   * @see #fromString
   */
  static make(s: string | null): RefreshMetricsBatchJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): RefreshMetricsBatchJob;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): RefreshMetricsBatchJob;
   ...
   */
  static cachedEmptyInst(): RefreshMetricsBatchJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<RefreshMetricsBatchJob>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): RefreshMetricsBatchJob;
   ...
   */
  start(options?: RefreshMetricsSpec | null): BatchJobStatus | null;
   ...
   */
  cleanup(options?: RefreshMetricsSpec | null): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun | null, BatchJobStatus | null, RefreshMetricsSpec | null> | null;

  failJob(run: JobRun<BatchJobStatusBase | null>): JobBase<BatchJobRun | null, BatchJobStatus | null, RefreshMetricsSpec | null> | null;
  ...
  validateStart(options?: RefreshMetricsSpec | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<RefreshMetricsBatchJob | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<RefreshMetricsBatchJob | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<RefreshMetricsBatchJob | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<RefreshMetricsBatchJob | null> | null>;
   ...
   */
  get(include?: string | null): RefreshMetricsBatchJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): RefreshMetricsBatchJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): RefreshMetricsBatchJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): RefreshMetricsBatchJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): RefreshMetricsBatchJob;
   ...
   * @see #toString
   */
  static fromString(s: string | null): RefreshMetricsBatchJob | null;
   ...
   */
  create(spec?: UpsertSpec | null): RefreshMetricsBatchJob | null;
   ...
   */
  static createBatch(objs: C3.Array<RefreshMetricsBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<RefreshMetricsBatchJob | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<RefreshMetricsBatchJob | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<RefreshMetricsBatchJob | null> | null;
   ...
   */
  update(srcObj?: RefreshMetricsBatchJob | null, spec?: UpsertSpec | null): RefreshMetricsBatchJob | null;
   ...
   */
  upsert(srcObj?: RefreshMetricsBatchJob | null, spec?: UpsertSpec | null): RefreshMetricsBatchJob | null;
   ...
   */
  merge(spec?: MergeSpec | null): RefreshMetricsBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): RefreshMetricsBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): RefreshMetricsBatchJob | null;
   ...
   */
  static updateBatch(objs: C3.Array<RefreshMetricsBatchJob | null> | null, srcObjs?: C3.Array<RefreshMetricsBatchJob | null>, spec?: UpsertSpec | null): ObjList<RefreshMetricsBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<RefreshMetricsBatchJob | null>>, spec?: UpsertSpec | null): ObjList<RefreshMetricsBatchJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<RefreshMetricsBatchJob | null> | null, srcObjs?: C3.Array<RefreshMetricsBatchJob | null>, spec?: UpsertSpec | null): ObjList<RefreshMetricsBatchJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<RefreshMetricsBatchJob | null>>, spec?: UpsertSpec | null): ObjList<RefreshMetricsBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<RefreshMetricsBatchJob | null> | null, spec?: TouchSpec | null): ObjList<RefreshMetricsBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<RefreshMetricsBatchJob | null> | null, spec?: MergeSpec | null): ObjList<RefreshMetricsBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<RefreshMetricsBatchJob | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<RefreshMetricsBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<RefreshMetricsBatchJob | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<RefreshMetricsBatchJob | null> | null;
   ...
   */
  static mergeAll(mergeObj: RefreshMetricsBatchJob | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: RefreshMetricsBatchJob | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<RefreshMetricsBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<RefreshMetricsBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<RefreshMetricsBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<RefreshMetricsBatchJob | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): RefreshMetricsBatchJob | null;
   ...
   */
  static beforeCreate(objs: C3.Array<RefreshMetricsBatchJob | null> | null): ObjList<RefreshMetricsBatchJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<RefreshMetricsBatchJob | null> | null): ObjList<RefreshMetricsBatchJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<RefreshMetricsBatchJob | null> | null): ObjList<RefreshMetricsBatchJob | null>;
   ...
   */
  static afterCreate(objs: C3.Array<RefreshMetricsBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<RefreshMetricsBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<RefreshMetricsBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<RefreshMetricsBatchJob | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<RefreshMetricsBatchJob | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): RefreshMetricsBatchJob | null;
   ...
   */
  withoutIdentity(): RefreshMetricsBatchJob | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<RefreshMetricsBatchJob | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: RefreshMetricsBatchJob | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<RefreshMetricsBatchJob | null> | null, callback?: λFunction<RefreshMetricsBatchJob | null, RefreshMetricsBatchJob | null> | null): ObjList<RefreshMetricsBatchJob | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<RefreshMetricsBatchJob | null> | null, callback?: λFunction<RefreshMetricsBatchJob | null, RefreshMetricsBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static doStart(job?: RefreshMetricsBatchJob | null, options?: RefreshMetricsSpec | null): void;
   ...
   */
  static processBatch(batch?: RefreshMetricsSpec | null, job?: RefreshMetricsBatchJob | null, options?: RefreshMetricsSpec | null): void;
   ...
   */
  static allComplete(job: RefreshMetricsBatchJob, options?: RefreshMetricsSpec | null): string | null;
   ...
   *           Options the job was run with.
   */
  static failed(job: RefreshMetricsBatchJob, status: BatchJobStatus, options?: RefreshMetricsSpec | null): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: RefreshMetricsSpec | null): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: C3.Array<RefreshMetricsSpec | null>): void;
   ...
   */
  static scheduleObjBatch(job?: RefreshMetricsBatchJob | null, objBatch?: ObjBatch | null, logPrefix?: string | null): number | null;
