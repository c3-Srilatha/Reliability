// TypeScript definitions for the C3 type KvStoreConfig

/**
 * Configuration for the kv stores. Default configuration should be stored under the id: "default"
 *
 * @remarks this represents a value passed to a method that expects an instance of KvStoreConfig
 */
declare interface IKvStoreConfig {
 ...
 * Configuration for the kv stores. Default configuration should be stored under the id: "default"
 *
 * @remarks this represents a made instance of KvStoreConfig
 */
declare class KvStoreConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): KvStoreConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): KvStoreConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): KvStoreConfig;

  /**
   * The unique and required name of this instance.
   */
  readonly name: string;
  withName(name: string): KvStoreConfig;

  /**
   * Physical pool for connections
   */
  readonly connectionPool?: DatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null;
  withConnectionPool(connectionPool: IDatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null): KvStoreConfig;
  ...
  withCredentials(credentials: IKvStore.Credentials | null): KvStoreConfig;

  /**
   * C3 Cloud Identifier for backing infrastructure that hosts the Datastore ex: {@link PostgresDb#id}, {@link CassandraDb#id}
   */
  readonly cloudId?: string | null;
  withCloudId(cloudId: string | null): KvStoreConfig;

  /**
   * True if the datastore is disabled (e.g. no data access is permitted).
   */
  readonly disabled?: boolean;
  withDisabled(disabled: boolean): KvStoreConfig;

  /**
   * True if the datastore is read only, i.e. can only be queried.
   */
  readonly readOnly?: boolean;
  withReadOnly(readOnly: boolean): KvStoreConfig;

  /**
   * True if the datastore is external, i.e. its database schema can not be altered.
   */
  readonly external?: boolean;
  withExternal(external: boolean): KvStoreConfig;
  ...
  withPerTenant(perTenant: boolean): KvStoreConfig;

  /**
   * Description for the dataStore.
   */
  readonly description?: string | null;
  withDescription(description: string | null): KvStoreConfig;

  /**
   * True if the db is shared with other apps or it is dedicated.
   */
  readonly dedicated?: boolean;
  withDedicated(dedicated: boolean): KvStoreConfig;

  readonly shareReadConnection?: boolean;
  withShareReadConnection(shareReadConnection: boolean): KvStoreConfig;

  readonly sharedReadThreshold: number;
  withSharedReadThreshold(sharedReadThreshold: number): KvStoreConfig;

  readonly readConnectionPool?: DatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null;
  withReadConnectionPool(readConnectionPool: IDatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null): KvStoreConfig;

  readonly writeConnectionPool?: DatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null;
  withWriteConnectionPool(writeConnectionPool: IDatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null): KvStoreConfig;
  ...
  withNewColReadCount(newColReadCount: number | null): KvStoreConfig;
  ...
  withNewColMaxObjCount(newColMaxObjCount: number | null): KvStoreConfig;
  ...
  withRewriteAllIncremental(rewriteAllIncremental: boolean): KvStoreConfig;

  /**
   * Kv store kind for which this config is provided
   */
  readonly kvstore?: Type | null;
  withKvstore(kvstore: IType | null): KvStoreConfig;
  ...
  withFillBucketsProbabilityOnRead(fillBucketsProbabilityOnRead: number | null): KvStoreConfig;
  ...
  withFillBucketsProbabilityOnWrite(fillBucketsProbabilityOnWrite: number | null): KvStoreConfig;
  ...
  withFillBucketsPartitionKeyPercentageOnWrite(fillBucketsPartitionKeyPercentageOnWrite: number | null): KvStoreConfig;
  ...
  withRangeDeleteTimeDriftInSec(rangeDeleteTimeDriftInSec: number | null): KvStoreConfig;
  ...
  withMultiBinningWriteTimeInterval(multiBinningWriteTimeInterval: string | null): KvStoreConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): KvStoreConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): KvStoreConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): KvStoreConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): KvStoreConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): KvStoreConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): KvStoreConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): KvStoreConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<KvStoreConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<KvStoreConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): KvStoreConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): KvStoreConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): KvStoreConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): KvStoreConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): KvStoreConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): KvStoreConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): KvStoreConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): KvStoreConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): KvStoreConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): KvStoreConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): KvStoreConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): KvStoreConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): KvStoreConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): KvStoreConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): KvStoreConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): KvStoreConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): KvStoreConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): KvStoreConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): KvStoreConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): KvStoreConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): KvStoreConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): KvStoreConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): KvStoreConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): KvStoreConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): KvStoreConfig;

  mergeJson(json: any | null): KvStoreConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): KvStoreConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): KvStoreConfig;
   ...
   */
  singletonArray(): C3.Array<KvStoreConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<KvStoreConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<KvStoreConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<KvStoreConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<KvStoreConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, KvStoreConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, KvStoreConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<KvStoreConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<KvStoreConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): KvStoreConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): KvStoreConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): KvStoreConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): KvStoreConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): KvStoreConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): KvStoreConfig;
   ...
   * @see #fromString
   */
  static make(s: string | null): KvStoreConfig | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): KvStoreConfig;
   ...
   */
  static cachedEmptyInst(): KvStoreConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<KvStoreConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): KvStoreConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<KvStoreConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<KvStoreConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<KvStoreConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): KvStoreConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): KvStoreConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): KvStoreConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): KvStoreConfig | null;
   ...
   */
  static produce(key: string): KvStoreConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, KvStoreConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, KvStoreConfig | null>;
   ...
   */
  static forConfigKey(configKey: string | null): KvStoreConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<KvStoreConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: KvStoreConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: KvStoreConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): KvStoreConfig | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): KvStoreConfig | null;
   ...
   */
  static forName(name: string | null, failIfMissing?: boolean): KvStoreConfig | null;
