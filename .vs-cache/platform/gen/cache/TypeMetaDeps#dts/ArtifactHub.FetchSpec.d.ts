// TypeScript definitions for the C3 type ArtifactHub.FetchSpec

/**
 * Provides additional information to {@link ArtifactHub} when fetching available {@link ArtifactHub.Artifact}s.
 *
 * @remarks this represents a value passed to a method that expects an instance of ArtifactHub.FetchSpec
 */
declare namespace ArtifactHub {
  export interface IFetchSpec {

    /**
     * A map of {@link WithSemanticVersion.name}s to Semantic Version ranges to filter by.
     * ```
     * {
     *    "platform": "8.1",
     *    "foundation": "8.1"
 ...
 * Provides additional information to {@link ArtifactHub} when fetching available {@link ArtifactHub.Artifact}s.
 *
 * @remarks this represents a made instance of ArtifactHub.FetchSpec
 */
declare namespace ArtifactHub {
  export class FetchSpec extends Obj {
    ...
    withRanges(ranges: C3.Map<string | null, string | null> | {[key: string | null]: string | null}): ArtifactHub.FetchSpec;
    ...
    withOrder(order: string | null): ArtifactHub.FetchSpec;

    /**
     * Offset to use for paged reads.
     */
    readonly offset?: number | null;
    withOffset(offset: number | null): ArtifactHub.FetchSpec;
    ...
    withLimit(limit: number | null): ArtifactHub.FetchSpec;
    ...
    withFilter(filter: string | null): ArtifactHub.FetchSpec;

    /**
     * Variables values to substitute in filter expression. CURRENTLY UNDER CONSTRUCTION!
     */
    readonly vars?: C3.Map<string | null, Obj | null>;
    withVars(vars: C3.Map<string | null, Obj | null> | {[key: string | null]: IObj | null}): ArtifactHub.FetchSpec;
    ...
    withFetchHiddenSeedData(fetchHiddenSeedData: boolean): ArtifactHub.FetchSpec;
    ...
    withExcludeExtensions(excludeExtensions: boolean): ArtifactHub.FetchSpec;
    ...
    withAsOf(asOf: DateTime | Date | string | null): ArtifactHub.FetchSpec;
    ...
    withAllowLiteralOnBindVariableOverflow(allowLiteralOnBindVariableOverflow: boolean): ArtifactHub.FetchSpec;
    ...
    withUseDedicatedConnection(useDedicatedConnection: boolean): ArtifactHub.FetchSpec;
    ...
    withStmtTimeoutMs(stmtTimeoutMs: number | null): ArtifactHub.FetchSpec;
    ...
    withDontThrowJsonDeserErrors(dontThrowJsonDeserErrors: boolean): ArtifactHub.FetchSpec;
    ...
    withTimeRange(timeRange: ITimeRange | null): ArtifactHub.FetchSpec;
    ...
    withTimedFetchParentField(timedFetchParentField: string | null): ArtifactHub.FetchSpec;

    readonly includeBaseTypes?: boolean;
    withIncludeBaseTypes(includeBaseTypes: boolean): ArtifactHub.FetchSpec;
    ...
    withIgnoreViewInclude(ignoreViewInclude: boolean): ArtifactHub.FetchSpec;
    ...
    withInclude(include: string | null): ArtifactHub.FetchSpec;
    ...
    withExcludeMeta(excludeMeta: boolean): ArtifactHub.FetchSpec;
    ...
    withIncludeReadCalcs(includeReadCalcs: boolean): ArtifactHub.FetchSpec;
    ...
    withRefreshCalcFields(refreshCalcFields: boolean): ArtifactHub.FetchSpec;
    ...
    withCalcFieldsToRefresh(calcFieldsToRefresh: C3.Array<string | null> | Array<string | null>): ArtifactHub.FetchSpec;
    ...
    withForceAcl(forceAcl: boolean): ArtifactHub.FetchSpec;
    ...
    withExplain(explain: boolean): ArtifactHub.FetchSpec;
    ...
    withValidateOnly(validateOnly: boolean): ArtifactHub.FetchSpec;
    ...
    withHints(hints: IFetchHints | null): ArtifactHub.FetchSpec;
    ...
    withUseSecondaryDatastore(useSecondaryDatastore: boolean): ArtifactHub.FetchSpec;
    ...
    withPreserveArrayIndexes(preserveArrayIndexes: boolean): ArtifactHub.FetchSpec;
    ...
    withResolveRefTypes(resolveRefTypes: boolean): ArtifactHub.FetchSpec;

    /**
     * Maintains a list of visited {@link ArtifactHub}s that are federated across network hops to prevent infinite loops.
     */
    readonly visited?: C3.Array<string | null>;
    withVisited(visited: C3.Array<string | null> | Array<string | null>): ArtifactHub.FetchSpec;
    ...
    withClientVersion(clientVersion: string | null): ArtifactHub.FetchSpec;

    /**
     * Whether or not this request should go upstream to a central hub.
     */
    readonly doNotGoUpstream?: boolean;
    withDoNotGoUpstream(doNotGoUpstream: boolean): ArtifactHub.FetchSpec;

    /**
     * The subtype of {@link ArtifactHub.Artifact} to filter by if any.
     */
    readonly artifactType?: string | null;
    withArtifactType(artifactType: string | null): ArtifactHub.FetchSpec;

    /**
     * If set to true, only return artifacts for which you can read the backing content.
     */
    readonly filterOnEntitlements?: boolean;
    withFilterOnEntitlements(filterOnEntitlements: boolean): ArtifactHub.FetchSpec;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): ArtifactHub.FetchSpec | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): ArtifactHub.FetchSpec | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): ArtifactHub.FetchSpec | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): ArtifactHub.FetchSpec | null;
     ...
     */
    replaceType(old: Type, new_: Type): ArtifactHub.FetchSpec;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ArtifactHub.FetchSpec;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ArtifactHub.FetchSpec;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ArtifactHub.FetchSpec | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ArtifactHub.FetchSpec | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ArtifactHub.FetchSpec;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ArtifactHub.FetchSpec;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ArtifactHub.FetchSpec;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ArtifactHub.FetchSpec;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ArtifactHub.FetchSpec;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ArtifactHub.FetchSpec;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ArtifactHub.FetchSpec;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ArtifactHub.FetchSpec;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ArtifactHub.FetchSpec;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): ArtifactHub.FetchSpec;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): ArtifactHub.FetchSpec;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): ArtifactHub.FetchSpec;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ArtifactHub.FetchSpec;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ArtifactHub.FetchSpec;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ArtifactHub.FetchSpec;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ArtifactHub.FetchSpec;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ArtifactHub.FetchSpec;
     ...
     * @see #removeField
     */
    unsetField(field: string): ArtifactHub.FetchSpec;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ArtifactHub.FetchSpec;
     ...
     * @see #unsetField
     */
    removeField(field: string): ArtifactHub.FetchSpec;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ArtifactHub.FetchSpec;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ArtifactHub.FetchSpec;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): ArtifactHub.FetchSpec;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ArtifactHub.FetchSpec;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ArtifactHub.FetchSpec;

    mergeJson(json: any | null): ArtifactHub.FetchSpec;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ArtifactHub.FetchSpec;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): ArtifactHub.FetchSpec;
     ...
     */
    singletonArray(): C3.Array<ArtifactHub.FetchSpec | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<ArtifactHub.FetchSpec | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ArtifactHub.FetchSpec | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<ArtifactHub.FetchSpec | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ArtifactHub.FetchSpec | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, ArtifactHub.FetchSpec | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ArtifactHub.FetchSpec | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ArtifactHub.FetchSpec | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ArtifactHub.FetchSpec | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ArtifactHub.FetchSpec;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ArtifactHub.FetchSpec;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ArtifactHub.FetchSpec;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ArtifactHub.FetchSpec;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ArtifactHub.FetchSpec;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ArtifactHub.FetchSpec;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ArtifactHub.FetchSpec;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ArtifactHub.FetchSpec;
     ...
     */
    static cachedEmptyInst(): ArtifactHub.FetchSpec;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ArtifactHub.FetchSpec>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): ArtifactHub.FetchSpec;
     ...
     */
    withIdFilter(id: string): ArtifactHub.FetchSpec | null;
     ...
     * @return updated FetchSpec
     */
    withIdsFilter(ids: C3.Array<string | null> | null): ArtifactHub.FetchSpec | null;
     ...
     * @return updated FetchSpec
     */
    withIdRangeFilter(startId?: string | null, endId?: string | null): ArtifactHub.FetchSpec | null;
