// TypeScript definitions for the C3 type JSBatchJob

/**
 * @remarks this represents a value passed to a method that expects an instance of JSBatchJob
 */
declare interface IJSBatchJob {
 ...
 */
declare class JSBatchJob extends Obj {

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun | null;
  withRun(run: IBatchJobRun | null): JSBatchJob;

  /**
   * previous job executions for this instance
   */
  readonly runs?: C3.Array<BatchJobRun | null>;
  withRuns(runs: C3.Array<BatchJobRun | null> | Array<IBatchJobRun | null>): JSBatchJob;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj | null;
  withOptions(options: IObj | null): JSBatchJob;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): JSBatchJob;
  ...
  withPriority(priority: number | null): JSBatchJob;
  ...
  withDisabled(disabled: boolean): JSBatchJob;
  ...
  withMaxConcurrency(maxConcurrency: number | null): JSBatchJob;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): JSBatchJob;
  ...
  withRunAsUser(runAsUser: boolean | null): JSBatchJob;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string | null;
  withNodePool(nodePool: string | null): JSBatchJob;
  ...
  withSkipIfRunning(skipIfRunning: boolean | null): JSBatchJob;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number | null;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): JSBatchJob;
  ...
  withPropagateActionContext(propagateActionContext: boolean): JSBatchJob;
  ...
  withTypeIdent(typeIdent: string | null): JSBatchJob;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): JSBatchJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): JSBatchJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): JSBatchJob;
  ...
  withVersion(version: number | null): JSBatchJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): JSBatchJob;
  ...
  withAbortOnError(abortOnError: boolean): JSBatchJob;

  readonly result?: Obj | null;
  withResult(result: IObj | null): JSBatchJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): JSBatchJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): JSBatchJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): JSBatchJob | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): JSBatchJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): JSBatchJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JSBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JSBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JSBatchJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JSBatchJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): JSBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JSBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JSBatchJob;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): JSBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): JSBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): JSBatchJob;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): JSBatchJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): JSBatchJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): JSBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): JSBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): JSBatchJob;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): JSBatchJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): JSBatchJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): JSBatchJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): JSBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): JSBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): JSBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): JSBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): JSBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): JSBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): JSBatchJob;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): JSBatchJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): JSBatchJob;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): JSBatchJob;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): JSBatchJob;

  mergeJson(json: any | null): JSBatchJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): JSBatchJob;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): JSBatchJob;
   ...
   */
  singletonArray(): C3.Array<JSBatchJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<JSBatchJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<JSBatchJob | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<JSBatchJob | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<JSBatchJob | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, JSBatchJob | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, JSBatchJob | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<JSBatchJob | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<JSBatchJob | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): JSBatchJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): JSBatchJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): JSBatchJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): JSBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): JSBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): JSBatchJob;
   ...
   * @see #fromString
   */
  static make(s: string | null): JSBatchJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): JSBatchJob;
   ...
   */
  static cachedEmptyInst(): JSBatchJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<JSBatchJob>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): JSBatchJob;
   ...
   */
  start(options?: JSBatchJobSpec | null): BatchJobStatus | null;
   ...
   */
  cleanup(options?: JSBatchJobSpec | null): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun | null, BatchJobStatus | null, JSBatchJobSpec | null> | null;

  failJob(run: JobRun<BatchJobStatusBase | null>): JobBase<BatchJobRun | null, BatchJobStatus | null, JSBatchJobSpec | null> | null;
  ...
  validateStart(options?: JSBatchJobSpec | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<JSBatchJob | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<JSBatchJob | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<JSBatchJob | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<JSBatchJob | null> | null>;
   ...
   */
  get(include?: string | null): JSBatchJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): JSBatchJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): JSBatchJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): JSBatchJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): JSBatchJob;
   ...
   * @see #toString
   */
  static fromString(s: string | null): JSBatchJob | null;
   ...
   */
  create(spec?: UpsertSpec | null): JSBatchJob | null;
   ...
   */
  static createBatch(objs: C3.Array<JSBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<JSBatchJob | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<JSBatchJob | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<JSBatchJob | null> | null;
   ...
   */
  update(srcObj?: JSBatchJob | null, spec?: UpsertSpec | null): JSBatchJob | null;
   ...
   */
  upsert(srcObj?: JSBatchJob | null, spec?: UpsertSpec | null): JSBatchJob | null;
   ...
   */
  merge(spec?: MergeSpec | null): JSBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): JSBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): JSBatchJob | null;
   ...
   */
  static updateBatch(objs: C3.Array<JSBatchJob | null> | null, srcObjs?: C3.Array<JSBatchJob | null>, spec?: UpsertSpec | null): ObjList<JSBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<JSBatchJob | null>>, spec?: UpsertSpec | null): ObjList<JSBatchJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<JSBatchJob | null> | null, srcObjs?: C3.Array<JSBatchJob | null>, spec?: UpsertSpec | null): ObjList<JSBatchJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<JSBatchJob | null>>, spec?: UpsertSpec | null): ObjList<JSBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<JSBatchJob | null> | null, spec?: TouchSpec | null): ObjList<JSBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<JSBatchJob | null> | null, spec?: MergeSpec | null): ObjList<JSBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<JSBatchJob | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<JSBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<JSBatchJob | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<JSBatchJob | null> | null;
   ...
   */
  static mergeAll(mergeObj: JSBatchJob | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: JSBatchJob | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<JSBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<JSBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<JSBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<JSBatchJob | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<JSBatchJob | null> | null): ObjList<JSBatchJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<JSBatchJob | null> | null): ObjList<JSBatchJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<JSBatchJob | null> | null): ObjList<JSBatchJob | null>;
   ...
   */
  static afterCreate(objs: C3.Array<JSBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<JSBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<JSBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<JSBatchJob | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<JSBatchJob | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): JSBatchJob | null;
   ...
   */
  withoutIdentity(): JSBatchJob | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<JSBatchJob | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: JSBatchJob | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<JSBatchJob | null> | null, callback?: λFunction<JSBatchJob | null, JSBatchJob | null> | null): ObjList<JSBatchJob | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<JSBatchJob | null> | null, callback?: λFunction<JSBatchJob | null, JSBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static doStart(job?: JSBatchJob | null, options?: JSBatchJobSpec | null): void;
   ...
   */
  static processBatch(batch?: JSBatchJobBatch | null, job?: JSBatchJob | null, options?: JSBatchJobSpec | null): void;
   ...
   */
  static allComplete(job: JSBatchJob, options?: JSBatchJobSpec | null): string | null;
   ...
   *           Options the job was run with.
   */
  static failed(job: JSBatchJob, status: BatchJobStatus, options?: JSBatchJobSpec | null): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: JSBatchJobBatch | null): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: C3.Array<JSBatchJobBatch | null>): void;
   ...
   */
  static scheduleObjBatch(job?: JSBatchJob | null, objBatch?: ObjBatch | null, logPrefix?: string | null): number | null;
