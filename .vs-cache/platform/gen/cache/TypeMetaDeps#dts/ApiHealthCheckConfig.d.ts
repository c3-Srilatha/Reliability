// TypeScript definitions for the C3 type ApiHealthCheckConfig

/**
 * @remarks this represents a value passed to a method that expects an instance of ApiHealthCheckConfig
 */
declare interface IApiHealthCheckConfig {
  ...
  extraCheckTimeOutSec?: number | null;
}

/**
 * @remarks this represents a made instance of ApiHealthCheckConfig
 */
declare class ApiHealthCheckConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): ApiHealthCheckConfig;

  static readonly configOverride?: string | null;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): ApiHealthCheckConfig;
  ...
  withIssues(issues: C3.Array<string | null> | Array<string | null>): ApiHealthCheckConfig;
  ...
  withExtraCheck(extraCheck: boolean): ApiHealthCheckConfig;

  static readonly extraCheck?: boolean;

  readonly extraCheckTimeOutSec?: number | null;
  withExtraCheckTimeOutSec(extraCheckTimeOutSec: number | null): ApiHealthCheckConfig;

  static readonly extraCheckTimeOutSec?: number | null;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ApiHealthCheckConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ApiHealthCheckConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ApiHealthCheckConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ApiHealthCheckConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): ApiHealthCheckConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): ApiHealthCheckConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ApiHealthCheckConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ApiHealthCheckConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ApiHealthCheckConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ApiHealthCheckConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ApiHealthCheckConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ApiHealthCheckConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ApiHealthCheckConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ApiHealthCheckConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ApiHealthCheckConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ApiHealthCheckConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ApiHealthCheckConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ApiHealthCheckConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ApiHealthCheckConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ApiHealthCheckConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ApiHealthCheckConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): ApiHealthCheckConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ApiHealthCheckConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): ApiHealthCheckConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ApiHealthCheckConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): ApiHealthCheckConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ApiHealthCheckConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ApiHealthCheckConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ApiHealthCheckConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ApiHealthCheckConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ApiHealthCheckConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): ApiHealthCheckConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ApiHealthCheckConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): ApiHealthCheckConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ApiHealthCheckConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): ApiHealthCheckConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ApiHealthCheckConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): ApiHealthCheckConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ApiHealthCheckConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ApiHealthCheckConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ApiHealthCheckConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): ApiHealthCheckConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ApiHealthCheckConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ApiHealthCheckConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ApiHealthCheckConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): ApiHealthCheckConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ApiHealthCheckConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): ApiHealthCheckConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): ApiHealthCheckConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): ApiHealthCheckConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ApiHealthCheckConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): ApiHealthCheckConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): ApiHealthCheckConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): ApiHealthCheckConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ApiHealthCheckConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): ApiHealthCheckConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ApiHealthCheckConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ApiHealthCheckConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ApiHealthCheckConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): ApiHealthCheckConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ApiHealthCheckConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ApiHealthCheckConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ApiHealthCheckConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ApiHealthCheckConfig;

  mergeJson(json: any | null): ApiHealthCheckConfig;

  static mergeJson(json: any | null): ApiHealthCheckConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ApiHealthCheckConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ApiHealthCheckConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ApiHealthCheckConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): ApiHealthCheckConfig;
   ...
   */
  singletonArray(): C3.Array<ApiHealthCheckConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<ApiHealthCheckConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ApiHealthCheckConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ApiHealthCheckConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ApiHealthCheckConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<ApiHealthCheckConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ApiHealthCheckConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ApiHealthCheckConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ApiHealthCheckConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ApiHealthCheckConfig | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<ApiHealthCheckConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ApiHealthCheckConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ApiHealthCheckConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ApiHealthCheckConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ApiHealthCheckConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ApiHealthCheckConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ApiHealthCheckConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ApiHealthCheckConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ApiHealthCheckConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ApiHealthCheckConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): ApiHealthCheckConfig;
   ...
   */
  static cachedEmptyInst(): ApiHealthCheckConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ApiHealthCheckConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ApiHealthCheckConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<ApiHealthCheckConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<ApiHealthCheckConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ApiHealthCheckConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): ApiHealthCheckConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): ApiHealthCheckConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): ApiHealthCheckConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): ApiHealthCheckConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): ApiHealthCheckConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): ApiHealthCheckConfig | null;
   ...
   */
  static produce(key: string): ApiHealthCheckConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, ApiHealthCheckConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, ApiHealthCheckConfig | null>;
   ...
   */
  getConfig(): ApiHealthCheckConfig;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): ApiHealthCheckConfig;
   ...
   */
  getSecret(): ApiHealthCheckConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): ApiHealthCheckConfig;
   ...
   */
  static forConfigKey(configKey: string | null): ApiHealthCheckConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<ApiHealthCheckConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: ApiHealthCheckConfig, override?: string | null): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: ApiHealthCheckConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: ApiHealthCheckConfig, override?: string | null): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: ApiHealthCheckConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): ApiHealthCheckConfig | null;
   ...
   */
  removeSecrets(): ApiHealthCheckConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): ApiHealthCheckConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): ApiHealthCheckConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): ApiHealthCheckConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): ApiHealthCheckConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): ApiHealthCheckConfig;
