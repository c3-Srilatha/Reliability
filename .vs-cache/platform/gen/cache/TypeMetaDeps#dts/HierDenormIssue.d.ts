// TypeScript definitions for the C3 type HierDenormIssue

/**
 * Normalization specific data issue type.
 *
 * @remarks this represents a value passed to a method that expects an instance of HierDenormIssue
 */
declare interface IHierDenormIssue {
 ...
 * Normalization specific data issue type.
 *
 * @remarks this represents a made instance of HierDenormIssue
 */
declare class HierDenormIssue extends Obj {

  /**
   * Target type of the obj with the issue.
   */
  readonly targetType: string;
  withTargetType(targetType: string): HierDenormIssue;

  /**
   * Id of obj with the issue.  If null, the issue applies to all objs for the `targetType`
   */
  readonly targetId?: string | null;
  withTargetId(targetId: string | null): HierDenormIssue;

  /**
   * Field with the issue.  If null, the issue applies to all fields in the `targetType` (where applicable).
   */
  readonly targetField?: string | null;
  withTargetField(targetField: string | null): HierDenormIssue;

  /**
   * DataIssue severity.
   */
  readonly severity: string;
  withSeverity(severity: string): HierDenormIssue;
  ...
  withTypeIdent(typeIdent: string | null): HierDenormIssue;
   ...
   */
  readonly id: string;
  withId(id: string): HierDenormIssue;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): HierDenormIssue;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): HierDenormIssue;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): HierDenormIssue;
  ...
  withVersion(version: number | null): HierDenormIssue;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): HierDenormIssue;

  /**
   * Error message indicating the nature of the issue.
   */
  readonly errorMsg?: string | null;
  withErrorMsg(errorMsg: string | null): HierDenormIssue;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): HierDenormIssue | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): HierDenormIssue | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): HierDenormIssue | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): HierDenormIssue | null;
   ...
   */
  replaceType(old: Type, new_: Type): HierDenormIssue;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HierDenormIssue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HierDenormIssue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HierDenormIssue | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HierDenormIssue | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): HierDenormIssue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HierDenormIssue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HierDenormIssue;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): HierDenormIssue;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): HierDenormIssue;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): HierDenormIssue;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): HierDenormIssue;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): HierDenormIssue;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): HierDenormIssue;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): HierDenormIssue;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): HierDenormIssue;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): HierDenormIssue;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): HierDenormIssue;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): HierDenormIssue;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): HierDenormIssue;
   ...
   * @see #unsetField
   */
  defaultField(field: string): HierDenormIssue;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): HierDenormIssue;
   ...
   * @see #removeField
   */
  unsetField(field: string): HierDenormIssue;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): HierDenormIssue;
   ...
   * @see #unsetField
   */
  removeField(field: string): HierDenormIssue;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): HierDenormIssue;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): HierDenormIssue;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): HierDenormIssue;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): HierDenormIssue;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): HierDenormIssue;

  mergeJson(json: any | null): HierDenormIssue;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): HierDenormIssue;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): HierDenormIssue;
   ...
   */
  singletonArray(): C3.Array<HierDenormIssue | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<HierDenormIssue | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<HierDenormIssue | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<HierDenormIssue | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<HierDenormIssue | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, HierDenormIssue | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, HierDenormIssue | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<HierDenormIssue | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<HierDenormIssue | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): HierDenormIssue;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): HierDenormIssue;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): HierDenormIssue;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): HierDenormIssue;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): HierDenormIssue;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): HierDenormIssue;
   ...
   * @see #fromString
   */
  static make(s: string | null): HierDenormIssue | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): HierDenormIssue;
   ...
   */
  static cachedEmptyInst(): HierDenormIssue;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<HierDenormIssue>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): HierDenormIssue;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<HierDenormIssue | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<HierDenormIssue | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<HierDenormIssue | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<HierDenormIssue | null> | null>;
   ...
   */
  get(include?: string | null): HierDenormIssue | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): HierDenormIssue | null;
   ...
   */
  getMissing(spec: GetMissingSpec): HierDenormIssue;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): HierDenormIssue | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): HierDenormIssue;
   ...
   * @see #toString
   */
  static fromString(s: string | null): HierDenormIssue | null;
   ...
   */
  create(spec?: UpsertSpec | null): HierDenormIssue | null;
   ...
   */
  static createBatch(objs: C3.Array<HierDenormIssue | null> | null, spec?: UpsertSpec | null): ObjList<HierDenormIssue | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<HierDenormIssue | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<HierDenormIssue | null> | null;
   ...
   */
  update(srcObj?: HierDenormIssue | null, spec?: UpsertSpec | null): HierDenormIssue | null;
   ...
   */
  upsert(srcObj?: HierDenormIssue | null, spec?: UpsertSpec | null): HierDenormIssue | null;
   ...
   */
  merge(spec?: MergeSpec | null): HierDenormIssue | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): HierDenormIssue | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): HierDenormIssue | null;
   ...
   */
  static updateBatch(objs: C3.Array<HierDenormIssue | null> | null, srcObjs?: C3.Array<HierDenormIssue | null>, spec?: UpsertSpec | null): ObjList<HierDenormIssue | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<HierDenormIssue | null>>, spec?: UpsertSpec | null): ObjList<HierDenormIssue | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<HierDenormIssue | null> | null, srcObjs?: C3.Array<HierDenormIssue | null>, spec?: UpsertSpec | null): ObjList<HierDenormIssue | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<HierDenormIssue | null>>, spec?: UpsertSpec | null): ObjList<HierDenormIssue | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<HierDenormIssue | null> | null, spec?: TouchSpec | null): ObjList<HierDenormIssue | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<HierDenormIssue | null> | null, spec?: MergeSpec | null): ObjList<HierDenormIssue | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<HierDenormIssue | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<HierDenormIssue | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<HierDenormIssue | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<HierDenormIssue | null> | null;
   ...
   */
  static mergeAll(mergeObj: HierDenormIssue | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: HierDenormIssue | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<HierDenormIssue | null> | null, spec?: UpsertSpec | null): ObjList<HierDenormIssue | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<HierDenormIssue | null> | null, spec?: UpsertSpec | null): ObjList<HierDenormIssue | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<HierDenormIssue | null> | null): ObjList<HierDenormIssue | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<HierDenormIssue | null> | null): ObjList<HierDenormIssue | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<HierDenormIssue | null> | null): ObjList<HierDenormIssue | null>;
   ...
   */
  static afterCreate(objs: C3.Array<HierDenormIssue | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<HierDenormIssue | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<HierDenormIssue | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<HierDenormIssue | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<HierDenormIssue | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): HierDenormIssue | null;
   ...
   */
  withoutIdentity(): HierDenormIssue | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<HierDenormIssue | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: HierDenormIssue | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<HierDenormIssue | null> | null, callback?: λFunction<HierDenormIssue | null, HierDenormIssue | null> | null): ObjList<HierDenormIssue | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<HierDenormIssue | null> | null, callback?: λFunction<HierDenormIssue | null, HierDenormIssue | null> | null): C3.Array<ObjError | null>;
