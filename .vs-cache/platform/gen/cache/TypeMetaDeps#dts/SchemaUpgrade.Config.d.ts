// TypeScript definitions for the C3 type SchemaUpgrade.Config

/**
 * Configuration for C3 managed vacuuming of Postgres tables.
 *
 * @remarks this represents a value passed to a method that expects an instance of SchemaUpgrade.Config
 */
declare namespace SchemaUpgrade {
...
declare namespace SchemaUpgrade {
  export class Config extends Obj {
    ...
    withConfigOverride(configOverride: string | null): SchemaUpgrade.Config;

    static readonly configOverride?: string | null;

    readonly secretOverride?: string | null;
    withSecretOverride(secretOverride: string | null): SchemaUpgrade.Config;
    ...
    withIssues(issues: C3.Array<string | null> | Array<string | null>): SchemaUpgrade.Config;
     ...
     * exception is thrown
     */
    readonly dbLockTimeoutMinutes: number;
    withDbLockTimeoutMinutes(dbLockTimeoutMinutes: number): SchemaUpgrade.Config;

    /**
     * Number of minutes to wait during schema upgrade while starting an app before the operation is aborted and an
     * exception is thrown
     */
    static readonly dbLockTimeoutMinutes: number;
    ...
    withDisabled(disabled: boolean): SchemaUpgrade.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): SchemaUpgrade.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): SchemaUpgrade.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): SchemaUpgrade.Config | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): SchemaUpgrade.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): SchemaUpgrade.Config;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): SchemaUpgrade.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SchemaUpgrade.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SchemaUpgrade.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SchemaUpgrade.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SchemaUpgrade.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SchemaUpgrade.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SchemaUpgrade.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SchemaUpgrade.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SchemaUpgrade.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SchemaUpgrade.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SchemaUpgrade.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SchemaUpgrade.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SchemaUpgrade.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SchemaUpgrade.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SchemaUpgrade.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): SchemaUpgrade.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): SchemaUpgrade.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): SchemaUpgrade.Config;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): SchemaUpgrade.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): SchemaUpgrade.Config;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): SchemaUpgrade.Config;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SchemaUpgrade.Config;
     ...
     * @return new Obj
     */
    static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SchemaUpgrade.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SchemaUpgrade.Config;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SchemaUpgrade.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): SchemaUpgrade.Config;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): SchemaUpgrade.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): SchemaUpgrade.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: string | null): SchemaUpgrade.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): SchemaUpgrade.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType | null): SchemaUpgrade.Config;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): SchemaUpgrade.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: C3.Array<string | null> | null): SchemaUpgrade.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SchemaUpgrade.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SchemaUpgrade.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): SchemaUpgrade.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): SchemaUpgrade.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SchemaUpgrade.Config;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SchemaUpgrade.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): SchemaUpgrade.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): SchemaUpgrade.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): SchemaUpgrade.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): SchemaUpgrade.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): SchemaUpgrade.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: string): SchemaUpgrade.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): SchemaUpgrade.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): SchemaUpgrade.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): SchemaUpgrade.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: string): SchemaUpgrade.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): SchemaUpgrade.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): SchemaUpgrade.Config;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SchemaUpgrade.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SchemaUpgrade.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): SchemaUpgrade.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj | null, otherFieldsFilter: Type): SchemaUpgrade.Config;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SchemaUpgrade.Config;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SchemaUpgrade.Config;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SchemaUpgrade.Config;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SchemaUpgrade.Config;

    mergeJson(json: any | null): SchemaUpgrade.Config;

    static mergeJson(json: any | null): SchemaUpgrade.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SchemaUpgrade.Config;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SchemaUpgrade.Config;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): SchemaUpgrade.Config;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj | null, deep?: boolean): SchemaUpgrade.Config;
     ...
     */
    singletonArray(): C3.Array<SchemaUpgrade.Config | null>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): C3.Array<SchemaUpgrade.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<SchemaUpgrade.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<SchemaUpgrade.Config | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<SchemaUpgrade.Config | null>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): C3.Set<SchemaUpgrade.Config | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<SchemaUpgrade.Config | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, SchemaUpgrade.Config | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, SchemaUpgrade.Config | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<SchemaUpgrade.Config | null>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<SchemaUpgrade.Config | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<SchemaUpgrade.Config | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SchemaUpgrade.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SchemaUpgrade.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SchemaUpgrade.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): SchemaUpgrade.Config;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SchemaUpgrade.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): SchemaUpgrade.Config;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SchemaUpgrade.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): SchemaUpgrade.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): SchemaUpgrade.Config;
     ...
     */
    static cachedEmptyInst(): SchemaUpgrade.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SchemaUpgrade.Config>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): SchemaUpgrade.Config;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<SchemaUpgrade.Config | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<SchemaUpgrade.Config | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<SchemaUpgrade.Config | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): SchemaUpgrade.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string | null): SchemaUpgrade.Config | null;
     ...
     * @see findByCacheKey
     */
    getCached(): SchemaUpgrade.Config | null;
     ...
     * @see findByCacheKey
     */
    static getCached(): SchemaUpgrade.Config | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): SchemaUpgrade.Config | null;

    /**
     * @return newly produced cached instance.
     */
    static refreshCache(): SchemaUpgrade.Config | null;
     ...
     */
    static produce(key: string): SchemaUpgrade.Config | null;
     ...
     */
    static produceAll(): C3.Map<string | null, SchemaUpgrade.Config | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, SchemaUpgrade.Config | null>;
     ...
     */
    getConfig(): SchemaUpgrade.Config;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): SchemaUpgrade.Config;
     ...
     */
    getSecret(): SchemaUpgrade.Config;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): SchemaUpgrade.Config;
     ...
     */
    static forConfigKey(configKey: string | null): SchemaUpgrade.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<SchemaUpgrade.Config | null>;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: SchemaUpgrade.Config, override?: string | null): void;

    /**
     * Sets multiple field values to be the same as the passed instance.
     * @see setConfigValue
     */
    static setConfigValues(from: SchemaUpgrade.Config, override?: string | null): void;
     ...
     * @see setSecretValue
     */
    setSecretValues(from: SchemaUpgrade.Config, override?: string | null): void;

    /**
     * Sets multiple secret field values to be the same as the passed instance.
     * @see setSecretValue
     */
    static setSecretValues(from: SchemaUpgrade.Config, override?: string | null): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): SchemaUpgrade.Config | null;
     ...
     */
    removeSecrets(): SchemaUpgrade.Config | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): SchemaUpgrade.Config | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): SchemaUpgrade.Config | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): SchemaUpgrade.Config | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): SchemaUpgrade.Config;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): SchemaUpgrade.Config;
