// TypeScript definitions for the C3 type EventStreamType

/**
 * An event-stream is a notification mechanism or communication channel that event producer [ e.g. server process ] is
 * using for delivering new events to caller / client.
 *
 * Event Streams are declared in DSL using `event stream<E>` syntax:
 * ```
 *
 * @see EventStream
 *
 * @remarks this represents a value passed to a method that expects an instance of EventStreamType
 */
declare interface IEventStreamType {
  ...
  /**
   * The value type for the events of this event-stream.
   */
  eventType: IValueType;
}
 ...
 * @see EventStream
 *
 * @remarks this represents a made instance of EventStreamType
 */
declare class EventStreamType extends Obj {

  /**
   * Source file Pkg.Path a C3 Type declaration [.c3typ].
   */
  readonly declaredPkgPath?: string | null;
  withDeclaredPkgPath(declaredPkgPath: string | null): EventStreamType;

  /**
   * Source line number in a C3 Type declaration [.c3typ] file starting with 1 where this metadata element is declared.
   */
  readonly declaredSrcLine?: number | null;
  withDeclaredSrcLine(declaredSrcLine: number | null): EventStreamType;
  ...
  withDeclaredSrcCharInLine(declaredSrcCharInLine: number | null): EventStreamType;
   ...
   */
  readonly pkg: Pkg;
  withPkg(pkg: IPkg): EventStreamType;

  /**
   * SDK json representing instance of this type
   */
  readonly json?: any;
  withJson(json: any): EventStreamType;

  /**
   * The set of annotations defined on this element of metadata represented as json value.
   */
  readonly annotationsJson?: any | null;
  withAnnotationsJson(annotationsJson: any | null): EventStreamType;
  ...
  withModifier(modifier: string | null): EventStreamType;

  /**
   * The value type for the events of this event-stream.
   */
  readonly eventType: ValueType;
  withEventType(eventType: IValueType): EventStreamType;
   ...
   */
  replaceType(old: Type, new_: Type): EventStreamType;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): EventStreamType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): EventStreamType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): EventStreamType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): EventStreamType | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): EventStreamType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): EventStreamType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<EventStreamType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<EventStreamType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): EventStreamType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): EventStreamType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): EventStreamType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): EventStreamType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): EventStreamType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): EventStreamType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): EventStreamType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): EventStreamType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): EventStreamType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): EventStreamType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): EventStreamType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): EventStreamType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): EventStreamType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): EventStreamType;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): EventStreamType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): EventStreamType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): EventStreamType;
   ...
   * @see #removeField
   */
  unsetField(field: string): EventStreamType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): EventStreamType;
   ...
   * @see #unsetField
   */
  removeField(field: string): EventStreamType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): EventStreamType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): EventStreamType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): EventStreamType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): EventStreamType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): EventStreamType;

  mergeJson(json: any | null): EventStreamType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): EventStreamType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): EventStreamType;
   ...
   */
  singletonArray(): C3.Array<EventStreamType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<EventStreamType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<EventStreamType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<EventStreamType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<EventStreamType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, EventStreamType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, EventStreamType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<EventStreamType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<EventStreamType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): EventStreamType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): EventStreamType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): EventStreamType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): EventStreamType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): EventStreamType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): EventStreamType;
   ...
   * @see #fromString
   */
  static make(s: string | null): EventStreamType | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): EventStreamType;
   ...
   */
  static cachedEmptyInst(): EventStreamType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<EventStreamType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): EventStreamType;
   ...
   */
  withoutDeclaredSrcPos(recursive?: boolean): EventStreamType;
   ...
   */
  withAnnotation(ann: Annotation): EventStreamType;
   ...
   *         value for the field
   */
  withAnnotation(ann: string, annField?: string | null, value?: any): EventStreamType;
   ...
   * @see #toString
   */
  static fromString(s: string | null): EventStreamType | null;
