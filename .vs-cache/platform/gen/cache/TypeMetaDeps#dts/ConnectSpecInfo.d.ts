// TypeScript definitions for the C3 type ConnectSpecInfo

/**
 * Base type for holding connection info for connections
 *
 * @remarks this represents a value passed to a method that expects an instance of ConnectSpecInfo
 */
declare interface IConnectSpecInfo {
 ...
 * Base type for holding connection info for connections
 *
 * @remarks this represents a made instance of ConnectSpecInfo
 */
declare class ConnectSpecInfo extends Obj {

  /**
   * The username used in basic credentials.
   */
  readonly username?: string | null;
  withUsername(username: string | null): ConnectSpecInfo;

  /**
   * The password used in basic credentials.
   */
  readonly password?: string | null;
  withPassword(password: string | null): ConnectSpecInfo;

  /**
   * For systems that have a secondary secret key that isn't the password (e.g. Salesforce/CosmosDb)
   */
  readonly secretKey?: string | null;
  withSecretKey(secretKey: string | null): ConnectSpecInfo;
  ...
  withProperties(properties: C3.Map<string | null, any> | {[key: string | null]: any}): ConnectSpecInfo;
  ...
  withSecretProperties(secretProperties: C3.Map<string | null, any> | {[key: string | null]: any}): ConnectSpecInfo;

  /**
   * The Url pointing to the database.
   */
  readonly url?: string | null;
  withUrl(url: string | null): ConnectSpecInfo;

  /**
   * Server address: (ex: 'localhost', 'some.company.com')
   */
  readonly serverEndpoint?: string | null;
  withServerEndpoint(serverEndpoint: string | null): ConnectSpecInfo;

  /**
   * Number of the listening port.
   */
  readonly port?: number | null;
  withPort(port: number | null): ConnectSpecInfo;

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): ConnectSpecInfo;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): ConnectSpecInfo;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): ConnectSpecInfo;

  /**
   * The id of this instance.
   */
  readonly id?: string | null;
  withId(id: string | null): ConnectSpecInfo;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ConnectSpecInfo | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ConnectSpecInfo | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ConnectSpecInfo | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ConnectSpecInfo | null;
   ...
   */
  replaceType(old: Type, new_: Type): ConnectSpecInfo;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ConnectSpecInfo;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ConnectSpecInfo;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ConnectSpecInfo | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ConnectSpecInfo | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ConnectSpecInfo;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ConnectSpecInfo;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ConnectSpecInfo;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ConnectSpecInfo;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ConnectSpecInfo;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ConnectSpecInfo;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ConnectSpecInfo;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ConnectSpecInfo;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ConnectSpecInfo;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ConnectSpecInfo;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ConnectSpecInfo;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ConnectSpecInfo;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ConnectSpecInfo;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ConnectSpecInfo;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ConnectSpecInfo;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ConnectSpecInfo;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ConnectSpecInfo;
   ...
   * @see #removeField
   */
  unsetField(field: string): ConnectSpecInfo;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ConnectSpecInfo;
   ...
   * @see #unsetField
   */
  removeField(field: string): ConnectSpecInfo;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ConnectSpecInfo;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ConnectSpecInfo;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ConnectSpecInfo;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ConnectSpecInfo;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ConnectSpecInfo;

  mergeJson(json: any | null): ConnectSpecInfo;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ConnectSpecInfo;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ConnectSpecInfo;
   ...
   */
  singletonArray(): C3.Array<ConnectSpecInfo | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ConnectSpecInfo | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ConnectSpecInfo | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ConnectSpecInfo | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ConnectSpecInfo | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ConnectSpecInfo | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ConnectSpecInfo | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ConnectSpecInfo | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ConnectSpecInfo | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ConnectSpecInfo;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ConnectSpecInfo;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ConnectSpecInfo;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ConnectSpecInfo;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ConnectSpecInfo;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ConnectSpecInfo;
   ...
   * @see #fromString
   */
  static make(s: string | null): ConnectSpecInfo | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ConnectSpecInfo;
   ...
   */
  static cachedEmptyInst(): ConnectSpecInfo;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ConnectSpecInfo>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ConnectSpecInfo;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<ConnectSpecInfo | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<ConnectSpecInfo | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ConnectSpecInfo | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): ConnectSpecInfo | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): ConnectSpecInfo | null;
   ...
   * @see findByCacheKey
   */
  getCached(): ConnectSpecInfo | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): ConnectSpecInfo | null;
   ...
   */
  static produce(key: string): ConnectSpecInfo | null;
   ...
   */
  static produceAll(): C3.Map<string | null, ConnectSpecInfo | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, ConnectSpecInfo | null>;
   ...
   */
  static forConfigKey(configKey: string | null): ConnectSpecInfo | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<ConnectSpecInfo | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: ConnectSpecInfo, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: ConnectSpecInfo, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): ConnectSpecInfo | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): ConnectSpecInfo | null;
