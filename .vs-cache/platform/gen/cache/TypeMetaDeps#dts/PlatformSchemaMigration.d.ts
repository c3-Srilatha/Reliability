// TypeScript definitions for the C3 type PlatformSchemaMigration
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of PlatformSchemaMigration
 */
declare interface IPlatformSchemaMigration {
}
 ...
 */
declare class PlatformSchemaMigration extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): PlatformSchemaMigration | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): PlatformSchemaMigration | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): PlatformSchemaMigration | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): PlatformSchemaMigration | null;
   ...
   */
  replaceType(old: Type, new_: Type): PlatformSchemaMigration;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PlatformSchemaMigration;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PlatformSchemaMigration;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PlatformSchemaMigration | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PlatformSchemaMigration | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): PlatformSchemaMigration;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PlatformSchemaMigration;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PlatformSchemaMigration;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PlatformSchemaMigration;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PlatformSchemaMigration;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PlatformSchemaMigration;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): PlatformSchemaMigration;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PlatformSchemaMigration;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PlatformSchemaMigration;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): PlatformSchemaMigration;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): PlatformSchemaMigration;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): PlatformSchemaMigration;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): PlatformSchemaMigration;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PlatformSchemaMigration;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): PlatformSchemaMigration;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PlatformSchemaMigration;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PlatformSchemaMigration;
   ...
   * @see #removeField
   */
  unsetField(field: string): PlatformSchemaMigration;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PlatformSchemaMigration;
   ...
   * @see #unsetField
   */
  removeField(field: string): PlatformSchemaMigration;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PlatformSchemaMigration;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): PlatformSchemaMigration;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): PlatformSchemaMigration;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): PlatformSchemaMigration;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): PlatformSchemaMigration;

  mergeJson(json: any | null): PlatformSchemaMigration;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): PlatformSchemaMigration;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): PlatformSchemaMigration;
   ...
   */
  singletonArray(): C3.Array<PlatformSchemaMigration | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<PlatformSchemaMigration | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PlatformSchemaMigration | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<PlatformSchemaMigration | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PlatformSchemaMigration | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, PlatformSchemaMigration | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PlatformSchemaMigration | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PlatformSchemaMigration | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PlatformSchemaMigration | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): PlatformSchemaMigration;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): PlatformSchemaMigration;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): PlatformSchemaMigration;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PlatformSchemaMigration;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): PlatformSchemaMigration;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PlatformSchemaMigration;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): PlatformSchemaMigration;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): PlatformSchemaMigration;
   ...
   */
  static cachedEmptyInst(): PlatformSchemaMigration;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<PlatformSchemaMigration>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): PlatformSchemaMigration;
