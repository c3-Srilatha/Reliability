// TypeScript definitions for the C3 type ConfigIdentifiable

/**
 * @remarks this represents a value passed to a method that expects an instance of ConfigIdentifiable
 */
declare interface IConfigIdentifiable {
...
/**
 * @remarks this represents a made instance of ConfigIdentifiable
 */
declare class ConfigIdentifiable extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): ConfigIdentifiable;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): ConfigIdentifiable;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): ConfigIdentifiable;

  /**
   * The id of this instance.
   */
  readonly id?: string | null;
  withId(id: string | null): ConfigIdentifiable;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ConfigIdentifiable | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ConfigIdentifiable | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ConfigIdentifiable | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ConfigIdentifiable | null;
   ...
   */
  replaceType(old: Type, new_: Type): ConfigIdentifiable;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ConfigIdentifiable;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ConfigIdentifiable;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ConfigIdentifiable | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ConfigIdentifiable | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ConfigIdentifiable;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ConfigIdentifiable;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ConfigIdentifiable;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ConfigIdentifiable;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ConfigIdentifiable;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ConfigIdentifiable;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ConfigIdentifiable;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ConfigIdentifiable;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ConfigIdentifiable;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ConfigIdentifiable;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ConfigIdentifiable;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ConfigIdentifiable;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ConfigIdentifiable;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ConfigIdentifiable;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ConfigIdentifiable;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ConfigIdentifiable;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ConfigIdentifiable;
   ...
   * @see #removeField
   */
  unsetField(field: string): ConfigIdentifiable;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ConfigIdentifiable;
   ...
   * @see #unsetField
   */
  removeField(field: string): ConfigIdentifiable;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ConfigIdentifiable;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ConfigIdentifiable;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ConfigIdentifiable;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ConfigIdentifiable;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ConfigIdentifiable;

  mergeJson(json: any | null): ConfigIdentifiable;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ConfigIdentifiable;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ConfigIdentifiable;
   ...
   */
  singletonArray(): C3.Array<ConfigIdentifiable | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ConfigIdentifiable | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ConfigIdentifiable | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ConfigIdentifiable | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ConfigIdentifiable | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ConfigIdentifiable | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ConfigIdentifiable | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ConfigIdentifiable | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ConfigIdentifiable | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ConfigIdentifiable;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ConfigIdentifiable;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ConfigIdentifiable;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ConfigIdentifiable;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ConfigIdentifiable;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ConfigIdentifiable;
   ...
   * @see #fromString
   */
  static make(s: string | null): ConfigIdentifiable | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ConfigIdentifiable;
   ...
   */
  static cachedEmptyInst(): ConfigIdentifiable;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ConfigIdentifiable>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ConfigIdentifiable;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<ConfigIdentifiable | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<ConfigIdentifiable | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ConfigIdentifiable | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): ConfigIdentifiable | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): ConfigIdentifiable | null;
   ...
   * @see findByCacheKey
   */
  getCached(): ConfigIdentifiable | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): ConfigIdentifiable | null;
   ...
   */
  static produce(key: string): ConfigIdentifiable | null;
   ...
   */
  static produceAll(): C3.Map<string | null, ConfigIdentifiable | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, ConfigIdentifiable | null>;
   ...
   */
  static forConfigKey(configKey: string | null): ConfigIdentifiable | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<ConfigIdentifiable | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: ConfigIdentifiable, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: ConfigIdentifiable, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): ConfigIdentifiable | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): ConfigIdentifiable | null;
}
