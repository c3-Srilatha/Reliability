// TypeScript definitions for the C3 type Err.IndexCreation

/**
 * Error type representing index creation error.
 *
 * @remarks this represents a value passed to a method that expects an instance of Err.IndexCreation
 */
 ...
 */
declare namespace Err {
  export class IndexCreation extends Obj {

    /**
     * Formatted and localized message.
     */
    readonly message?: string | null;
    withMessage(message: string | null): Err.IndexCreation;

    /**
     * Unlocalized, parameterized error message string.
     */
    readonly template?: string | null;
    withTemplate(template: string | null): Err.IndexCreation;

    /**
     * Parameters applied to {@link template} to produce error message.
     */
    readonly parameters?: C3.Array<string | null>;
    withParameters(parameters: C3.Array<string | null> | Array<string | null>): Err.IndexCreation;

    /**
     * Unique (generated) error id.
     */
    readonly id?: string | null;
    withId(id: string | null): Err.IndexCreation;

    /**
     * Error key.
     */
    readonly key?: string | null;
    withKey(key: string | null): Err.IndexCreation;

    /**
     * Error for nested/causing exception (if any).
     */
    readonly cause?: C3.Error | null;
    withCause(cause: IC3.Error | null): Err.IndexCreation;

    /**
     * http status code for this error
     */
    readonly httpStatusCode: number;
    withHttpStatusCode(httpStatusCode: number): Err.IndexCreation;

    /**
     * Filename for where the error originated from
     */
    readonly filenameOfRootError?: string | null;
    withFilenameOfRootError(filenameOfRootError: string | null): Err.IndexCreation;

    /**
     * Extra debugging information, such as script language stack.
     */
    readonly debugInfo?: C3.Array<string | null>;
    withDebugInfo(debugInfo: C3.Array<string | null> | Array<string | null>): Err.IndexCreation;

    /**
     * Script language (js/py) stacktrace.
     */
    readonly stackTrace?: C3.Array<StackFrame | null>;
    withStackTrace(stackTrace: C3.Array<StackFrame | null> | Array<IStackFrame | null>): Err.IndexCreation;
    ...
    withAction(action: string | null): Err.IndexCreation;

    /**
     * Engine of the action that threw this error
     */
    readonly engine?: string | null;
    withEngine(engine: string | null): Err.IndexCreation;

    /**
     * Timestamp when the error was thrown
     */
    readonly timestamp?: DateTime | null;
    withTimestamp(timestamp: DateTime | Date | string | null): Err.IndexCreation;
    ...
    with_system(_system: any): Err.IndexCreation;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Err.IndexCreation | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Err.IndexCreation | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Err.IndexCreation | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Err.IndexCreation | null;
     ...
     */
    replaceType(old: Type, new_: Type): Err.IndexCreation;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Err.IndexCreation;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Err.IndexCreation;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Err.IndexCreation | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Err.IndexCreation | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Err.IndexCreation;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Err.IndexCreation;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Err.IndexCreation;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Err.IndexCreation;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Err.IndexCreation;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Err.IndexCreation;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Err.IndexCreation;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Err.IndexCreation;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Err.IndexCreation;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Err.IndexCreation;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Err.IndexCreation;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Err.IndexCreation;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Err.IndexCreation;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Err.IndexCreation;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Err.IndexCreation;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Err.IndexCreation;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Err.IndexCreation;
     ...
     * @see #removeField
     */
    unsetField(field: string): Err.IndexCreation;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Err.IndexCreation;
     ...
     * @see #unsetField
     */
    removeField(field: string): Err.IndexCreation;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Err.IndexCreation;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Err.IndexCreation;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Err.IndexCreation;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Err.IndexCreation;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Err.IndexCreation;

    mergeJson(json: any | null): Err.IndexCreation;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Err.IndexCreation;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Err.IndexCreation;
     ...
     */
    singletonArray(): C3.Array<Err.IndexCreation | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Err.IndexCreation | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Err.IndexCreation | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Err.IndexCreation | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Err.IndexCreation | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Err.IndexCreation | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Err.IndexCreation | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Err.IndexCreation | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Err.IndexCreation | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Err.IndexCreation;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Err.IndexCreation;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Err.IndexCreation;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Err.IndexCreation;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Err.IndexCreation;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Err.IndexCreation;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Err.IndexCreation;
     ...
     */
    static cachedEmptyInst(): Err.IndexCreation;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Err.IndexCreation>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Err.IndexCreation;
     ...
     */
    withFormattedMessage(): Err.IndexCreation;
     ...
     */
    static formatted(format: string, ...args: any[]): Err.IndexCreation;

    /**
     * Construct an error with just the message.
     */
    static fromMessage(s: string | null): Err.IndexCreation;
     ...
     */
    static fromJavaException(ex: any): Err.IndexCreation;

    /**
     * Construct an error from the system exception.
     */
    static fromJavaException(message: string, ex: any): Err.IndexCreation;
     ...
     */
    static fromTemplate(template: string | null, bindings: C3.Map<string | null, any> | null): Err.IndexCreation;

    /**
     * Construct an error and a system exception around it to throw an error.
     */
    static fromHttpCodeAndTemplate(httpCode: number | null, template: string | null, bindings: C3.Map<string | null, any> | null): Err.IndexCreation;
