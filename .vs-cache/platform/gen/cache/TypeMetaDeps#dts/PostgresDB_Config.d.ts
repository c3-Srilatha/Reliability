// TypeScript definitions for the C3 type PostgresDB_Config

/**
 * @remarks this represents a value passed to a method that expects an instance of PostgresDB_Config
 */
declare interface IPostgresDB_Config {
  ...
  /**
   * Use managed Postgres by default
   */
  managed?: boolean;
  ...
  /**
   * Override to preserve storage on termination for PostgresDB.
   */
  doNotCleanupStorageOnTerminate?: boolean;

  /**
   * Fully qualified registry to fetch postgres image
   * NOTE: the value for this field will be dictated by the {@link CloudServiceConfig#logicalImageRegistry},
   * and changing this field directly will have no effect.
   */
  imageRegistry?: string | null;

  /**
   * Tag of the postgres image
   */
  ...
  /**
   * Cpu requests for postgres resources
   */
  resourcesRequestsCpu?: string | null;

  /**
   * Memory requests for postgres resources
   */
  resourcesRequestsMemory?: string | null;

  /**
   * Cpu limits for postgres resources
   */
  resourcesLimitsCpu?: string | null;

  /**
   * Memory limits for postgres resources
   */
  resourcesLimitsMemory?: string | null;

  /**
   * PostgreSQL user password
   */
  postgresqlPassword?: string | null;

  releaseAppendChartName?: boolean;

  secretName?: string | null;

  serviceHeadlessName?: string | null;

  serviceName?: string | null;
}

/**
 * @remarks this represents a made instance of PostgresDB_Config
 */
declare class PostgresDB_Config extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): PostgresDB_Config;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): PostgresDB_Config;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): PostgresDB_Config;

  /**
   * Canonical C3 Identifier for this Cloud Resource in the format of <cluster>-<env>-<app>-<func>[-<role>]-<seq>[-<subseq>].
   */
  readonly id: string;
  withId(id: string): PostgresDB_Config;
  ...
  withCluster(cluster: string | null): PostgresDB_Config;
  ...
  withEnv(env: string | null): PostgresDB_Config;
  ...
  withApp(app: string | null): PostgresDB_Config;
  ...
  withFunc(func: string | null): PostgresDB_Config;
  ...
  withRole(role: string | null): PostgresDB_Config;
  ...
  withSeq(seq: string | null): PostgresDB_Config;
  ...
  withSubseq(subseq: string | null): PostgresDB_Config;

  /**
   * Cloud service provider generated native ID, such as vpcId and securityGroupId.
   */
  readonly resourceId?: string | null;
  withResourceId(resourceId: string | null): PostgresDB_Config;

  /**
   * Cloud service provider generated native secondary ID, such as Amazon Resource Name (ARN).
   */
  readonly resourceSecondaryId?: string | null;
  withResourceSecondaryId(resourceSecondaryId: string | null): PostgresDB_Config;

  /**
   * User defined name attribute managed by cloud service provider.
   */
  readonly resourceName?: string | null;
  withResourceName(resourceName: string | null): PostgresDB_Config;

  /**
   * ResourceGroup for Azure resources and K8s namespaces
   */
  readonly resourceGroupName?: string | null;
  withResourceGroupName(resourceGroupName: string | null): PostgresDB_Config;
  ...
  withFullyConfigured(fullyConfigured: boolean): PostgresDB_Config;

  /**
   * resourceNamespace for K8s Resources (only those which are associated with a namespace)
   */
  readonly resourceNamespace?: string | null;
  withResourceNamespace(resourceNamespace: string | null): PostgresDB_Config;
  ...
  withExternal(external: boolean): PostgresDB_Config;

  /**
   * Cloud Credentials for this resource.
   */
  readonly credentials?: CloudCredentials | null;
  withCredentials(credentials: ICloudCredentials | null): PostgresDB_Config;

  /**
   * `true` if resourceName was set via #generateResourceName.
   */
  readonly hasGeneratedResourceName?: boolean;
  withHasGeneratedResourceName(hasGeneratedResourceName: boolean): PostgresDB_Config;

  /**
   * `true` if resourceName was set via #generateResourceSecondaryId.
   */
  readonly hasGeneratedResourceSecondaryId?: boolean;
  withHasGeneratedResourceSecondaryId(hasGeneratedResourceSecondaryId: boolean): PostgresDB_Config;

  /**
   * Specific version of Cloud Service to use
   */
  readonly version?: string | null;
  withVersion(version: string | null): PostgresDB_Config;

  /**
   * Specific resource to create when creating a cloud service that uses an operator
   */
  readonly operatorResourceKind?: string | null;
  withOperatorResourceKind(operatorResourceKind: string | null): PostgresDB_Config;

  /**
   * Use managed Postgres by default
   */
  readonly managed?: boolean;
  withManaged(managed: boolean): PostgresDB_Config;

  /**
   * Tls Certificate if this Cloud Service needs a secure connection to be accessed
   */
  readonly certs?: TlsCertificate | null;
  withCerts(certs: ITlsCertificate | null): PostgresDB_Config;

  /**
   * Metadata of the CloudService; when started, started by who, etc
   */
  readonly meta?: CloudCluster.Meta | null;
  withMeta(meta: ICloudCluster.Meta | null): PostgresDB_Config;

  /**
   * The cloudServiceUrl of the cloudService
   */
  readonly cloudServiceUrl?: CloudServiceUrl | null;
  withCloudServiceUrl(cloudServiceUrl: ICloudServiceUrl | null): PostgresDB_Config;

  /**
   * Logical registry to fetch CloudServices' Artifacts
   */
  readonly logicalImageRegistry?: string | null;
  withLogicalImageRegistry(logicalImageRegistry: string | null): PostgresDB_Config;

  /**
   * Override to preserve storage on termination for PostgresDB.
   */
  readonly doNotCleanupStorageOnTerminate?: boolean;
  withDoNotCleanupStorageOnTerminate(doNotCleanupStorageOnTerminate: boolean): PostgresDB_Config;
   ...
   * and changing this field directly will have no effect.
   */
  readonly imageRegistry?: string | null;
  withImageRegistry(imageRegistry: string | null): PostgresDB_Config;

  /**
   * Tag of the postgres image
   */
  readonly containerImageTag?: string | null;
  withContainerImageTag(containerImageTag: string | null): PostgresDB_Config;

  /**
   * Size of persistent volume
   */
  readonly persistenceSize?: string | null;
  withPersistenceSize(persistenceSize: string | null): PostgresDB_Config;

  /**
   * Maximum total connections.
   */
  readonly maxConnections?: number | null;
  withMaxConnections(maxConnections: number | null): PostgresDB_Config;

  /**
   * Cpu requests for postgres resources
   */
  readonly resourcesRequestsCpu?: string | null;
  withResourcesRequestsCpu(resourcesRequestsCpu: string | null): PostgresDB_Config;

  /**
   * Memory requests for postgres resources
   */
  readonly resourcesRequestsMemory?: string | null;
  withResourcesRequestsMemory(resourcesRequestsMemory: string | null): PostgresDB_Config;

  /**
   * Cpu limits for postgres resources
   */
  readonly resourcesLimitsCpu?: string | null;
  withResourcesLimitsCpu(resourcesLimitsCpu: string | null): PostgresDB_Config;

  /**
   * Memory limits for postgres resources
   */
  readonly resourcesLimitsMemory?: string | null;
  withResourcesLimitsMemory(resourcesLimitsMemory: string | null): PostgresDB_Config;

  /**
   * PostgreSQL user password
   */
  readonly postgresqlPassword?: string | null;
  withPostgresqlPassword(postgresqlPassword: string | null): PostgresDB_Config;

  readonly releaseAppendChartName?: boolean;
  withReleaseAppendChartName(releaseAppendChartName: boolean): PostgresDB_Config;

  readonly secretName?: string | null;
  withSecretName(secretName: string | null): PostgresDB_Config;

  readonly serviceHeadlessName?: string | null;
  withServiceHeadlessName(serviceHeadlessName: string | null): PostgresDB_Config;

  readonly serviceName?: string | null;
  withServiceName(serviceName: string | null): PostgresDB_Config;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): PostgresDB_Config | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): PostgresDB_Config | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): PostgresDB_Config | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): PostgresDB_Config | null;
   ...
   */
  replaceType(old: Type, new_: Type): PostgresDB_Config;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PostgresDB_Config;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PostgresDB_Config;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PostgresDB_Config | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PostgresDB_Config | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): PostgresDB_Config;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PostgresDB_Config;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PostgresDB_Config;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PostgresDB_Config;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PostgresDB_Config;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PostgresDB_Config;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): PostgresDB_Config;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PostgresDB_Config;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PostgresDB_Config;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): PostgresDB_Config;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): PostgresDB_Config;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): PostgresDB_Config;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): PostgresDB_Config;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PostgresDB_Config;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): PostgresDB_Config;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PostgresDB_Config;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PostgresDB_Config;
   ...
   * @see #removeField
   */
  unsetField(field: string): PostgresDB_Config;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PostgresDB_Config;
   ...
   * @see #unsetField
   */
  removeField(field: string): PostgresDB_Config;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PostgresDB_Config;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): PostgresDB_Config;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): PostgresDB_Config;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): PostgresDB_Config;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): PostgresDB_Config;

  mergeJson(json: any | null): PostgresDB_Config;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): PostgresDB_Config;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): PostgresDB_Config;
   ...
   */
  singletonArray(): C3.Array<PostgresDB_Config | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<PostgresDB_Config | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PostgresDB_Config | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<PostgresDB_Config | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PostgresDB_Config | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, PostgresDB_Config | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PostgresDB_Config | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PostgresDB_Config | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PostgresDB_Config | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): PostgresDB_Config;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): PostgresDB_Config;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): PostgresDB_Config;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PostgresDB_Config;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): PostgresDB_Config;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PostgresDB_Config;
   ...
   * @see #fromString
   */
  static make(s: string | null): PostgresDB_Config | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): PostgresDB_Config;
   ...
   */
  static cachedEmptyInst(): PostgresDB_Config;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<PostgresDB_Config>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): PostgresDB_Config;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<PostgresDB_Config | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<PostgresDB_Config | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<PostgresDB_Config | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): PostgresDB_Config | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): PostgresDB_Config | null;
   ...
   * @see findByCacheKey
   */
  getCached(): PostgresDB_Config | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): PostgresDB_Config | null;
   ...
   */
  static produce(key: string): PostgresDB_Config | null;
   ...
   */
  static produceAll(): C3.Map<string | null, PostgresDB_Config | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, PostgresDB_Config | null>;
   ...
   */
  static forConfigKey(configKey: string | null): PostgresDB_Config | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<PostgresDB_Config | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: PostgresDB_Config, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: PostgresDB_Config, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): PostgresDB_Config | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): PostgresDB_Config | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null, failIfInvalid?: boolean): PostgresDB_Config | null;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): PostgresDB_Config | null;

  /**
   * Construct a cloud ID from a cluster ID
   */
  static fromClusterId(clusterId: string, env: string, app: string, func: string, role?: string | null, seq?: string | null, subseq?: string | null): PostgresDB_Config;
   ...
   */
  static fromEnvId(envId: string, app: string, func: string, role?: string | null, seq?: string | null, subseq?: string | null): PostgresDB_Config;
   ...
   */
  static fromAppId(appId: string, func: string, role?: string | null, seq?: string | null, subseq?: string | null): PostgresDB_Config;
   ...
   */
  static fromId(id: string, failIfInvalid?: boolean): PostgresDB_Config;
   ...
   * @see CloudRef
   */
  static fromReferenceField(fieldName: string, value: string | null, failIfInvalid?: boolean): PostgresDB_Config;
   ...
   * @see CloudRef
   */
  fromConfigTemplate(spec?: CloudResourceOperationSpec | null): PostgresDB_Config;

  /**
   * Populate default values for all uninitialized configurable fields in this Cloud Resource.
   */
  withDefaultConfig(spec?: CloudResourceOperationSpec | null): PostgresDB_Config;
  ...
  operatorResource(): K8sC3Postgres | null;
}
