// TypeScript definitions for the C3 type ArtifactHubIface

/**
 * The interface for interacting with {@link ArtifactHub}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ArtifactHubIface
 */
declare interface IArtifactHubIface {
}
 ...
 */
declare class ArtifactHubIface extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ArtifactHubIface | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ArtifactHubIface | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ArtifactHubIface | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ArtifactHubIface | null;
   ...
   */
  replaceType(old: Type, new_: Type): ArtifactHubIface;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): ArtifactHubIface;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ArtifactHubIface;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ArtifactHubIface;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ArtifactHubIface;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ArtifactHubIface;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ArtifactHubIface | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ArtifactHubIface | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ArtifactHubIface | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ArtifactHubIface | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ArtifactHubIface;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ArtifactHubIface;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ArtifactHubIface;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ArtifactHubIface;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ArtifactHubIface;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ArtifactHubIface;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ArtifactHubIface;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): ArtifactHubIface;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ArtifactHubIface;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): ArtifactHubIface;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ArtifactHubIface;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): ArtifactHubIface;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ArtifactHubIface;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ArtifactHubIface;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ArtifactHubIface;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ArtifactHubIface;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ArtifactHubIface;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): ArtifactHubIface;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ArtifactHubIface;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): ArtifactHubIface;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ArtifactHubIface;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): ArtifactHubIface;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ArtifactHubIface;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): ArtifactHubIface;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ArtifactHubIface;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ArtifactHubIface;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ArtifactHubIface;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): ArtifactHubIface;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ArtifactHubIface;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ArtifactHubIface;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ArtifactHubIface;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): ArtifactHubIface;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ArtifactHubIface;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): ArtifactHubIface;
   ...
   * @see #removeField
   */
  unsetField(field: string): ArtifactHubIface;
   ...
   * @see #removeField
   */
  static unsetField(field: string): ArtifactHubIface;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ArtifactHubIface;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): ArtifactHubIface;
   ...
   * @see #unsetField
   */
  removeField(field: string): ArtifactHubIface;
   ...
   * @see #unsetField
   */
  static removeField(field: string): ArtifactHubIface;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ArtifactHubIface;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): ArtifactHubIface;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ArtifactHubIface;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ArtifactHubIface;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ArtifactHubIface;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): ArtifactHubIface;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ArtifactHubIface;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ArtifactHubIface;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ArtifactHubIface;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ArtifactHubIface;

  mergeJson(json: any | null): ArtifactHubIface;

  static mergeJson(json: any | null): ArtifactHubIface;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ArtifactHubIface;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ArtifactHubIface;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ArtifactHubIface;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): ArtifactHubIface;
   ...
   */
  singletonArray(): C3.Array<ArtifactHubIface | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<ArtifactHubIface | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ArtifactHubIface | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ArtifactHubIface | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ArtifactHubIface | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<ArtifactHubIface | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ArtifactHubIface | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ArtifactHubIface | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ArtifactHubIface | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ArtifactHubIface | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<ArtifactHubIface | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ArtifactHubIface | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ArtifactHubIface;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ArtifactHubIface;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ArtifactHubIface;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ArtifactHubIface;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ArtifactHubIface;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ArtifactHubIface;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ArtifactHubIface;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): ArtifactHubIface;
   ...
   */
  static cachedEmptyInst(): ArtifactHubIface;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ArtifactHubIface>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ArtifactHubIface;
