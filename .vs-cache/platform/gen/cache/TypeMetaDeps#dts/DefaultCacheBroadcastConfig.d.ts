// TypeScript definitions for the C3 type DefaultCacheBroadcastConfig

/**
 * Config used to determine if ENV/APP broadcast level messages will be sent by default.
 *
 * @remarks this represents a value passed to a method that expects an instance of DefaultCacheBroadcastConfig
 */
declare interface IDefaultCacheBroadcastConfig {
  ...
  /**
   * If true, default env/app cache invalidation is not turned on.
   * TODO: PLAT-92970 - Enable DefaultCacheBroadcastConfig
   */
  disabled?: boolean;
}
 ...
 * Config used to determine if ENV/APP broadcast level messages will be sent by default.
 *
 * @remarks this represents a made instance of DefaultCacheBroadcastConfig
 */
declare class DefaultCacheBroadcastConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): DefaultCacheBroadcastConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): DefaultCacheBroadcastConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): DefaultCacheBroadcastConfig;
  ...
  withDisabled(disabled: boolean): DefaultCacheBroadcastConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): DefaultCacheBroadcastConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): DefaultCacheBroadcastConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): DefaultCacheBroadcastConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): DefaultCacheBroadcastConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): DefaultCacheBroadcastConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DefaultCacheBroadcastConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DefaultCacheBroadcastConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DefaultCacheBroadcastConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DefaultCacheBroadcastConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DefaultCacheBroadcastConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DefaultCacheBroadcastConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DefaultCacheBroadcastConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DefaultCacheBroadcastConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DefaultCacheBroadcastConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DefaultCacheBroadcastConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DefaultCacheBroadcastConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DefaultCacheBroadcastConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DefaultCacheBroadcastConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): DefaultCacheBroadcastConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): DefaultCacheBroadcastConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): DefaultCacheBroadcastConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DefaultCacheBroadcastConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DefaultCacheBroadcastConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DefaultCacheBroadcastConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DefaultCacheBroadcastConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DefaultCacheBroadcastConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): DefaultCacheBroadcastConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DefaultCacheBroadcastConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): DefaultCacheBroadcastConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DefaultCacheBroadcastConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DefaultCacheBroadcastConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): DefaultCacheBroadcastConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DefaultCacheBroadcastConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DefaultCacheBroadcastConfig;

  mergeJson(json: any | null): DefaultCacheBroadcastConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DefaultCacheBroadcastConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): DefaultCacheBroadcastConfig;
   ...
   */
  singletonArray(): C3.Array<DefaultCacheBroadcastConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<DefaultCacheBroadcastConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DefaultCacheBroadcastConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<DefaultCacheBroadcastConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DefaultCacheBroadcastConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, DefaultCacheBroadcastConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DefaultCacheBroadcastConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DefaultCacheBroadcastConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DefaultCacheBroadcastConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DefaultCacheBroadcastConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DefaultCacheBroadcastConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DefaultCacheBroadcastConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DefaultCacheBroadcastConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DefaultCacheBroadcastConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DefaultCacheBroadcastConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DefaultCacheBroadcastConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): DefaultCacheBroadcastConfig;
   ...
   */
  static cachedEmptyInst(): DefaultCacheBroadcastConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DefaultCacheBroadcastConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): DefaultCacheBroadcastConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<DefaultCacheBroadcastConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<DefaultCacheBroadcastConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<DefaultCacheBroadcastConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): DefaultCacheBroadcastConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): DefaultCacheBroadcastConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): DefaultCacheBroadcastConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): DefaultCacheBroadcastConfig | null;
   ...
   */
  static produce(key: string): DefaultCacheBroadcastConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, DefaultCacheBroadcastConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, DefaultCacheBroadcastConfig | null>;
   ...
   */
  getConfig(): DefaultCacheBroadcastConfig;
   ...
   */
  getSecret(): DefaultCacheBroadcastConfig;
   ...
   */
  static forConfigKey(configKey: string | null): DefaultCacheBroadcastConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<DefaultCacheBroadcastConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: DefaultCacheBroadcastConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: DefaultCacheBroadcastConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): DefaultCacheBroadcastConfig | null;
  ...
  /**
   * Sets the disabled flag to true and broadcasts to all nodes in the level to evict the DefaultCacheBroadcastConfig.
   *      This will disable all cache invalidation for env/app
   * @param level
   *        Either 'ENV' or 'APP' to enable cache invalidation for the specified level.
   */
  static disable(level: string): void;

  /**
   * Sets the disabled flag to false and broadcasts to all nodes in the level to evict the DefaultCacheBroadcastConfig.
   *
   * @param level
   *        Either 'ENV' or 'APP' to enable cache invalidation for the specified level.
   */
  static enable(level: string): void;

  /**
   * Resets the DefaultCacheBroadcastConfig to its default state. Broadcasting will be determined via higher overrides.
   * This clears the config and broadcasts to all nodes in the level to evict the DefaultCacheBroadcastConfig.
   */
  static reset(level: string): void;
}
