// TypeScript definitions for the C3 type Data.PeriodIndex

/**
 * Abstract interface representing the pandas PeriodIndex class.
 *
 * @remarks this represents a value passed to a method that expects an instance of Data.PeriodIndex
 */
declare namespace Data {
  export interface IPeriodIndex {
  }
}
 ...
 */
declare namespace Data {
  export class PeriodIndex extends Obj {
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.PeriodIndex | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.PeriodIndex | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.PeriodIndex | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.PeriodIndex | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.PeriodIndex;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.PeriodIndex;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.PeriodIndex;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.PeriodIndex | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.PeriodIndex | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.PeriodIndex;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.PeriodIndex;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.PeriodIndex;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.PeriodIndex;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.PeriodIndex;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.PeriodIndex;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.PeriodIndex;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.PeriodIndex;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.PeriodIndex;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.PeriodIndex;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.PeriodIndex;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.PeriodIndex;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.PeriodIndex;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.PeriodIndex;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.PeriodIndex;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.PeriodIndex;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.PeriodIndex;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.PeriodIndex;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.PeriodIndex;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.PeriodIndex;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.PeriodIndex;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.PeriodIndex;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.PeriodIndex;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.PeriodIndex;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.PeriodIndex;

    mergeJson(json: any | null): Data.PeriodIndex;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.PeriodIndex;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.PeriodIndex;
     ...
     */
    singletonArray(): C3.Array<Data.PeriodIndex | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.PeriodIndex | null>;
     ...
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.PeriodIndex | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.PeriodIndex | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.PeriodIndex | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.PeriodIndex | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.PeriodIndex | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.PeriodIndex | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.PeriodIndex | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.PeriodIndex;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.PeriodIndex;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.PeriodIndex;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.PeriodIndex;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.PeriodIndex;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.PeriodIndex;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.PeriodIndex;
     ...
     */
    static cachedEmptyInst(): Data.PeriodIndex;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.PeriodIndex>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.PeriodIndex;
     ...
     */
    static fromPySrc(pySrc: string, dfs?: C3.Set<DataImpl | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): Data.PeriodIndex | null;
     ...
     */
    static _jsDataProxy(inst: any): Data.PeriodIndex;
