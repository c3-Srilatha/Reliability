// TypeScript definitions for the C3 type BatchQueue

/**
 * Invalidation queue for batch job processing.  Each entry is for processing a single batch within a
 * {@link BatchJob}.
 *
 * @see BatchQueueEntry
 *
 * @remarks this represents a value passed to a method that expects an instance of BatchQueue
 */
declare interface IBatchQueue {
}
 ...
 * @see BatchQueueEntry
 *
 * @remarks this represents a made instance of BatchQueue
 */
declare class BatchQueue {
   ...
   */
  static compute(targetType: Type, entries: C3.Array<BatchQueueEntry | null> | null): void;
   ...
   */
  static find(spec?: InvalidationQueue.FindSpec | null): C3.Array<BatchQueueEntry | null>;
   ...
   * @return the list of requested entries.
   */
  static findStream(spec?: InvalidationQueue.FindStreamSpec | null): Stream<BatchQueueEntry | null>;
   ...
   *           Entries to remove.
   */
  static clearEntries(entries: C3.Array<BatchQueueEntry | null> | null): void;
