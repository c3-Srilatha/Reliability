// TypeScript definitions for the C3 type Data.DatetimeIndex.Pandas

/**
 * C3 Interface to a {@link Data.DatetimeIndex} backed by native pandas
 *
 * @remarks this represents a value passed to a method that expects an instance of Data.DatetimeIndex.Pandas
 */
declare namespace Data.DatetimeIndex {
...
declare namespace Data.DatetimeIndex {
  export class Pandas extends Obj {
     ...
     */
    readonly ds: Dataset;
    withDs(ds: IDataset): Data.DatetimeIndex.Pandas;

    /**
     * Id used to reference this Data within the Dataset to which it belongs
     */
    readonly id: string;
    withId(id: string): Data.DatetimeIndex.Pandas;

    /**
     * PySrc that can be executed to re-create this DataImpl.Pandas
     */
    readonly _pySrc?: string | null;
    with_pySrc(_pySrc: string | null): Data.DatetimeIndex.Pandas;

    readonly _fileName?: string | null;
    with_fileName(_fileName: string | null): Data.DatetimeIndex.Pandas;

    /**
     * Tuple of {columnName:[value]} to create a DataImpl.Pandas from
     */
    readonly _tuple?: any;
    with_tuple(_tuple: any): Data.DatetimeIndex.Pandas;

    /**
     * Whether the {@link #tuple} field value types can be fully supported by arrow.
     */
    readonly _arrowSupport?: boolean;
    with_arrowSupport(_arrowSupport: boolean): Data.DatetimeIndex.Pandas;

    /**
     * All DataImpl.Pandas referenced by the pySrc
     */
    readonly _datas?: C3.Set<DataImpl.Pandas | null>;
    with_datas(_datas: C3.Set<DataImpl.Pandas | null> | Array<IDataImpl.Pandas | null>): Data.DatetimeIndex.Pandas;

    /**
     * Pickled Pandas binary
     */
    readonly _binary?: any | null;
    with_binary(_binary: any | null): Data.DatetimeIndex.Pandas;

    /**
     * List of pickled Pandas segments binaries
     */
    readonly _binaries?: C3.Array<any | null>;
    with_binaries(_binaries: C3.Array<any | null> | Array<any | null>): Data.DatetimeIndex.Pandas;

    readonly _numBinarySegments?: number | null;
    with_numBinarySegments(_numBinarySegments: number | null): Data.DatetimeIndex.Pandas;

    /**
     * Type of binary format for reading {@link Data.Persisted}
     */
    readonly _persistedFormat?: string | null;
    with_persistedFormat(_persistedFormat: string | null): Data.DatetimeIndex.Pandas;

    /**
     * see tableName arg for {@link Feature.Store#readData}.
     */
    readonly _tableName?: string | null;
    with_tableName(_tableName: string | null): Data.DatetimeIndex.Pandas;

    /**
     * see id arg for {@link Feature.Store#readData}.
     */
    readonly _tableEntryId?: string | null;
    with_tableEntryId(_tableEntryId: string | null): Data.DatetimeIndex.Pandas;

    /**
     * Mapping of variable names to their values to be used by the PyAst Executor
     */
    readonly _vars?: C3.Map<string | null, any>;
    with_vars(_vars: C3.Map<string | null, any> | {[key: string | null]: any}): Data.DatetimeIndex.Pandas;
    ...
    withMaxSegmentSizeClient(maxSegmentSizeClient: number | null): Data.DatetimeIndex.Pandas;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.DatetimeIndex.Pandas | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.DatetimeIndex.Pandas | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.DatetimeIndex.Pandas | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.DatetimeIndex.Pandas | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.DatetimeIndex.Pandas;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.DatetimeIndex.Pandas;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.DatetimeIndex.Pandas;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.DatetimeIndex.Pandas | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.DatetimeIndex.Pandas | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.DatetimeIndex.Pandas;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.DatetimeIndex.Pandas;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.DatetimeIndex.Pandas;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.DatetimeIndex.Pandas;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.DatetimeIndex.Pandas;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.DatetimeIndex.Pandas;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.DatetimeIndex.Pandas;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.DatetimeIndex.Pandas;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.DatetimeIndex.Pandas;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.DatetimeIndex.Pandas;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.DatetimeIndex.Pandas;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.DatetimeIndex.Pandas;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.DatetimeIndex.Pandas;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.DatetimeIndex.Pandas;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.DatetimeIndex.Pandas;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.DatetimeIndex.Pandas;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.DatetimeIndex.Pandas;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.DatetimeIndex.Pandas;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.DatetimeIndex.Pandas;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.DatetimeIndex.Pandas;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.DatetimeIndex.Pandas;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.DatetimeIndex.Pandas;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.DatetimeIndex.Pandas;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.DatetimeIndex.Pandas;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.DatetimeIndex.Pandas;

    mergeJson(json: any | null): Data.DatetimeIndex.Pandas;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.DatetimeIndex.Pandas;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.DatetimeIndex.Pandas;
     ...
     */
    singletonArray(): C3.Array<Data.DatetimeIndex.Pandas | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.DatetimeIndex.Pandas | null>;
     ...
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.DatetimeIndex.Pandas | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.DatetimeIndex.Pandas | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.DatetimeIndex.Pandas | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.DatetimeIndex.Pandas | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.DatetimeIndex.Pandas | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.DatetimeIndex.Pandas | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.DatetimeIndex.Pandas | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.DatetimeIndex.Pandas;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.DatetimeIndex.Pandas;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.DatetimeIndex.Pandas;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.DatetimeIndex.Pandas;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.DatetimeIndex.Pandas;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.DatetimeIndex.Pandas;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.DatetimeIndex.Pandas;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Data.DatetimeIndex.Pandas;
     ...
     */
    static cachedEmptyInst(): Data.DatetimeIndex.Pandas;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.DatetimeIndex.Pandas>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.DatetimeIndex.Pandas;
     ...
     */
    static fromPySrc(pySrc: string, dfs?: C3.Set<DataImpl | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): Data.DatetimeIndex.Pandas | null;
     ...
     */
    static _jsDataProxy(inst: any): Data.DatetimeIndex.Pandas;
     ...
     */
    static fromBinary(name: string, data: any, dataset?: Dataset | null): Data.DatetimeIndex.Pandas | null;

    static fromBinary(name: string, data: C3.Array<any | null>, dataset?: Dataset | null): Data.DatetimeIndex.Pandas | null;
     ...
     */
    static fromStore(name: string, tableName: string, tableEntryId: string, dataset?: Dataset | null, persistedFormat?: string | null): Data.DatetimeIndex.Pandas | null;

    /**
     * Create an instance of DataImpl.Pandas with the provided name from a pandas binary
     */
    static fromName(name: string, binary: any, dataset?: Dataset | null): Data.DatetimeIndex.Pandas | null;

    /**
     * Create an instance of DataImpl.Pandas with the provided name and pySrc
     */
    static fromName(name: string, pySrc: string, datas?: C3.Set<DataImpl.Pandas | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): Data.DatetimeIndex.Pandas | null;
     ...
     */
    static fromDatasetBinaries(name: string, dataset?: Dataset | null): Data.DatetimeIndex.Pandas | null;

    /**
     * Create an instance of DataImpl.Pandas with the provided name from a pickled binary file specified by fileName
     */
    static fromBinaryFile(name: string, fileName: string, dataset?: Dataset | null): Data.DatetimeIndex.Pandas | null;

    /**
     * Create a new DataImpl.Pandas from a PyAST visitor context.
     * see @DataToPyAstVisitorCtx
     */
    static fromDataToPyAstVisitorCtx(ctx: DataToPyAstVisitorCtx, dataset?: Dataset | null): Data.DatetimeIndex.Pandas | null;
     ...
     */
    static dispatch(pandas: Data.DatetimeIndex.Pandas, name: string, args?: C3.Array<any>, kwargs?: C3.Map<string | null, any>, doNotConvertData?: boolean): any;
     ...
     *         The native pandas value will be converted to the corresponding {@link DataImpl.Pandas} subtype
     */
    static getAttribute(pandas: Data.DatetimeIndex.Pandas, name: string, doNotConvertData?: boolean): any;
     ...
     */
    static evaluate(pandas: Data.DatetimeIndex.Pandas): void;
     ...
     */
    static toBinary(pandas: Data.DatetimeIndex.Pandas): any | null;
     ...
     */
    static storeBinariesInDataset(pandas: Data.DatetimeIndex.Pandas): void;
    ...
    append(other?: any): Data.Index | null | Data.RangeIndex | null | Data.MultiIndex | null | Data.CategoricalIndex | null | Data.IntervalIndex | null | Data.PeriodIndex | null | Data.DatetimeIndex | null | Data.TimedeltaIndex | null | Data.Int64Index | null | Data.UInt64Index | null | Data.Float64Index | null | null;
    ...
    astype(dtype?: any, copy?: any): Data.Index | null | Data.RangeIndex | null | Data.MultiIndex | null | Data.CategoricalIndex | null | Data.IntervalIndex | null | Data.PeriodIndex | null | Data.DatetimeIndex | null | Data.TimedeltaIndex | null | Data.Int64Index | null | Data.UInt64Index | null | Data.Float64Index | null | null;
    ...
    drop_duplicates(keep?: any): Data.DatetimeIndex | null;

    droplevel(level?: any): Data.Index | null | Data.MultiIndex | null | null;

    dropna(how?: any): Data.DatetimeIndex | null;
    ...
    get_loc(key?: any, method?: any, tolerance?: any): number | null;
    ...
    rename(name?: any, inplace?: any): Data.DatetimeIndex | null;

    repeat(repeats?: any, axis?: any): any;

    searchsorted(value?: any, side?: any, sorter?: any): any;

    set_names(names?: any, level?: any, inplace?: any): Data.DatetimeIndex | null;

    set_value(arr?: any, key?: any, value?: any): any;

    shift(periods?: any, freq?: any): Data.DatetimeIndex | null;

    slice_indexer(start?: any, end?: any, step?: number | null, kind?: any): AnySlice | null;

    slice_indexer(start?: any, end?: any, step?: any, kind?: any): any;
    ...
    to_flat_index(): Data.Index | null | Data.RangeIndex | null | Data.MultiIndex | null | Data.CategoricalIndex | null | Data.IntervalIndex | null | Data.PeriodIndex | null | Data.DatetimeIndex | null | Data.TimedeltaIndex | null | Data.Int64Index | null | Data.UInt64Index | null | Data.Float64Index | null | null;
    ...
    to_series(keep_tz?: any, index?: any, name?: any): Data.Series | null;

    transpose(): Data.DatetimeIndex | null;
    ...
    get day_of_week(): Data.Series | null | Data.Index | null | null;

    get day_of_year(): any;

    get dayofweek(): Data.Series | null | Data.Index | null | null;

    get dayofyear(): any;

    get days_in_month(): any;

    get daysinmonth(): any;

    get hour(): any;

    get is_leap_year(): any;

    get is_month_end(): any;

    get is_month_start(): any;

    get is_normalized(): any;

    get is_quarter_end(): any;

    get is_quarter_start(): any;

    get is_year_end(): any;

    get is_year_start(): any;
    ...
    get weekday(): Data.Series | null | Data.Index | null | null;

    get weekofyear(): any;

    get year(): any;

    day_name(): Data.Index | null;

    day_name(locale?: string | null): Data.Index | null;

    indexer_at_time(time?: any, asof?: any): C3.Array<any> | null;

    indexer_between_time(start_time?: any, end_time?: any, include_start?: any, include_end?: any): C3.Array<any> | null;

    isocalendar(): Data | null;

    month_name(): Data.Index | null;

    month_name(locale?: string | null): Data.Index | null;

    normalize(): Data.DatetimeIndex | null;

    snap(freq?: any): Data.DatetimeIndex | null;

    std(): any;

    to_julian_date(): Data.Float64Index | null;

    to_period(): Data.PeriodIndex | null;

    to_period(freq?: any): Data.PeriodIndex | null;

    to_perioddelta(freq?: any): Data.TimedeltaIndex | null;

    to_pydatetime(): C3.Array<any> | null;

    tz_convert(tz?: any): Data.DatetimeIndex | null;

    tz_localize(tz?: any, ambiguous?: any, nonexistent?: any): Data.DatetimeIndex | null;

    union_many(others?: any): any;

    strftime(date_format?: string | null): any;

    round(freq?: any, ambiguous?: any, nonexistent?: any): Data.DatetimeIndex | null | Data.Series | null | null;

    floor(freq?: any, ambiguous?: any, nonexistent?: any): Data.DatetimeIndex | null | Data.Series | null | null;

    ceil(freq?: any, ambiguous?: any, nonexistent?: any): Data.DatetimeIndex | null | Data.Series | null | null;

    mean(skipna?: any, axis?: number | null): any;
  }
}
