// TypeScript definitions for the C3 type Err.DbRetryableForMerge
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Err.DbRetryableForMerge
 */
declare namespace Err {
  export interface IDbRetryableForMerge {
 ...
 */
declare namespace Err {
  export class DbRetryableForMerge extends Obj {

    /**
     * Formatted and localized message.
     */
    readonly message?: string | null;
    withMessage(message: string | null): Err.DbRetryableForMerge;

    /**
     * Unlocalized, parameterized error message string.
     */
    readonly template?: string | null;
    withTemplate(template: string | null): Err.DbRetryableForMerge;

    /**
     * Parameters applied to {@link template} to produce error message.
     */
    readonly parameters?: C3.Array<string | null>;
    withParameters(parameters: C3.Array<string | null> | Array<string | null>): Err.DbRetryableForMerge;

    /**
     * Unique (generated) error id.
     */
    readonly id?: string | null;
    withId(id: string | null): Err.DbRetryableForMerge;

    /**
     * Error key.
     */
    readonly key?: string | null;
    withKey(key: string | null): Err.DbRetryableForMerge;

    /**
     * Error for nested/causing exception (if any).
     */
    readonly cause?: C3.Error | null;
    withCause(cause: IC3.Error | null): Err.DbRetryableForMerge;

    /**
     * http status code for this error
     */
    readonly httpStatusCode: number;
    withHttpStatusCode(httpStatusCode: number): Err.DbRetryableForMerge;

    /**
     * Filename for where the error originated from
     */
    readonly filenameOfRootError?: string | null;
    withFilenameOfRootError(filenameOfRootError: string | null): Err.DbRetryableForMerge;

    /**
     * Extra debugging information, such as script language stack.
     */
    readonly debugInfo?: C3.Array<string | null>;
    withDebugInfo(debugInfo: C3.Array<string | null> | Array<string | null>): Err.DbRetryableForMerge;

    /**
     * Script language (js/py) stacktrace.
     */
    readonly stackTrace?: C3.Array<StackFrame | null>;
    withStackTrace(stackTrace: C3.Array<StackFrame | null> | Array<IStackFrame | null>): Err.DbRetryableForMerge;
    ...
    withAction(action: string | null): Err.DbRetryableForMerge;

    /**
     * Engine of the action that threw this error
     */
    readonly engine?: string | null;
    withEngine(engine: string | null): Err.DbRetryableForMerge;

    /**
     * Timestamp when the error was thrown
     */
    readonly timestamp?: DateTime | null;
    withTimestamp(timestamp: DateTime | Date | string | null): Err.DbRetryableForMerge;
    ...
    with_system(_system: any): Err.DbRetryableForMerge;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Err.DbRetryableForMerge | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Err.DbRetryableForMerge | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Err.DbRetryableForMerge | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Err.DbRetryableForMerge | null;
     ...
     */
    replaceType(old: Type, new_: Type): Err.DbRetryableForMerge;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Err.DbRetryableForMerge;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Err.DbRetryableForMerge;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Err.DbRetryableForMerge | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Err.DbRetryableForMerge | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Err.DbRetryableForMerge;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Err.DbRetryableForMerge;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Err.DbRetryableForMerge;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Err.DbRetryableForMerge;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Err.DbRetryableForMerge;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Err.DbRetryableForMerge;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Err.DbRetryableForMerge;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Err.DbRetryableForMerge;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Err.DbRetryableForMerge;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Err.DbRetryableForMerge;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Err.DbRetryableForMerge;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Err.DbRetryableForMerge;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Err.DbRetryableForMerge;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Err.DbRetryableForMerge;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Err.DbRetryableForMerge;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Err.DbRetryableForMerge;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Err.DbRetryableForMerge;
     ...
     * @see #removeField
     */
    unsetField(field: string): Err.DbRetryableForMerge;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Err.DbRetryableForMerge;
     ...
     * @see #unsetField
     */
    removeField(field: string): Err.DbRetryableForMerge;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Err.DbRetryableForMerge;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Err.DbRetryableForMerge;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Err.DbRetryableForMerge;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Err.DbRetryableForMerge;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Err.DbRetryableForMerge;

    mergeJson(json: any | null): Err.DbRetryableForMerge;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Err.DbRetryableForMerge;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Err.DbRetryableForMerge;
     ...
     */
    singletonArray(): C3.Array<Err.DbRetryableForMerge | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Err.DbRetryableForMerge | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Err.DbRetryableForMerge | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Err.DbRetryableForMerge | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Err.DbRetryableForMerge | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Err.DbRetryableForMerge | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Err.DbRetryableForMerge | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Err.DbRetryableForMerge | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Err.DbRetryableForMerge | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Err.DbRetryableForMerge;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Err.DbRetryableForMerge;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Err.DbRetryableForMerge;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Err.DbRetryableForMerge;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Err.DbRetryableForMerge;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Err.DbRetryableForMerge;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Err.DbRetryableForMerge;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Err.DbRetryableForMerge;
     ...
     */
    static cachedEmptyInst(): Err.DbRetryableForMerge;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Err.DbRetryableForMerge>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Err.DbRetryableForMerge;
     ...
     */
    withFormattedMessage(): Err.DbRetryableForMerge;
     ...
     */
    static formatted(format: string, ...args: any[]): Err.DbRetryableForMerge;

    /**
     * Construct an error with just the message.
     */
    static fromMessage(s: string | null): Err.DbRetryableForMerge;
     ...
     */
    static fromJavaException(ex: any): Err.DbRetryableForMerge;

    /**
     * Construct an error from the system exception.
     */
    static fromJavaException(message: string, ex: any): Err.DbRetryableForMerge;
     ...
     */
    static fromTemplate(template: string | null, bindings: C3.Map<string | null, any> | null): Err.DbRetryableForMerge;

    /**
     * Construct an error and a system exception around it to throw an error.
     */
    static fromHttpCodeAndTemplate(httpCode: number | null, template: string | null, bindings: C3.Map<string | null, any> | null): Err.DbRetryableForMerge;
