// TypeScript definitions for the C3 type LibraryManager.Config

/**
 * Base type for specifying different configurations used by a {@link LibraryManager}.
 *
 * @remarks this represents a value passed to a method that expects an instance of LibraryManager.Config
 */
...
declare namespace LibraryManager {
  export class Config extends Obj {
    ...
    withConfigOverride(configOverride: string | null): LibraryManager.Config;

    static readonly configOverride?: string | null;

    readonly secretOverride?: string | null;
    withSecretOverride(secretOverride: string | null): LibraryManager.Config;
    ...
    withIssues(issues: C3.Array<string | null> | Array<string | null>): LibraryManager.Config;
    ...
    withUseArtifactHub(useArtifactHub: boolean): LibraryManager.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): LibraryManager.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): LibraryManager.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): LibraryManager.Config | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): LibraryManager.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): LibraryManager.Config;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): LibraryManager.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LibraryManager.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LibraryManager.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LibraryManager.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LibraryManager.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LibraryManager.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LibraryManager.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LibraryManager.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LibraryManager.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LibraryManager.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LibraryManager.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LibraryManager.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LibraryManager.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LibraryManager.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LibraryManager.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): LibraryManager.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): LibraryManager.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): LibraryManager.Config;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): LibraryManager.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): LibraryManager.Config;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): LibraryManager.Config;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LibraryManager.Config;
     ...
     * @return new Obj
     */
    static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LibraryManager.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LibraryManager.Config;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LibraryManager.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): LibraryManager.Config;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): LibraryManager.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): LibraryManager.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: string | null): LibraryManager.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): LibraryManager.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType | null): LibraryManager.Config;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): LibraryManager.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: C3.Array<string | null> | null): LibraryManager.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LibraryManager.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LibraryManager.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): LibraryManager.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): LibraryManager.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LibraryManager.Config;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LibraryManager.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): LibraryManager.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): LibraryManager.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): LibraryManager.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): LibraryManager.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): LibraryManager.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: string): LibraryManager.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): LibraryManager.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): LibraryManager.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): LibraryManager.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: string): LibraryManager.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): LibraryManager.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): LibraryManager.Config;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LibraryManager.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LibraryManager.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): LibraryManager.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj | null, otherFieldsFilter: Type): LibraryManager.Config;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LibraryManager.Config;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LibraryManager.Config;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LibraryManager.Config;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LibraryManager.Config;

    mergeJson(json: any | null): LibraryManager.Config;

    static mergeJson(json: any | null): LibraryManager.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LibraryManager.Config;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LibraryManager.Config;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): LibraryManager.Config;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj | null, deep?: boolean): LibraryManager.Config;
     ...
     */
    singletonArray(): C3.Array<LibraryManager.Config | null>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): C3.Array<LibraryManager.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<LibraryManager.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<LibraryManager.Config | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<LibraryManager.Config | null>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): C3.Set<LibraryManager.Config | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<LibraryManager.Config | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, LibraryManager.Config | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, LibraryManager.Config | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<LibraryManager.Config | null>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<LibraryManager.Config | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<LibraryManager.Config | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LibraryManager.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LibraryManager.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LibraryManager.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): LibraryManager.Config;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LibraryManager.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): LibraryManager.Config;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LibraryManager.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): LibraryManager.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): LibraryManager.Config;
     ...
     */
    static cachedEmptyInst(): LibraryManager.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LibraryManager.Config>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): LibraryManager.Config;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<LibraryManager.Config | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<LibraryManager.Config | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<LibraryManager.Config | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): LibraryManager.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string | null): LibraryManager.Config | null;
     ...
     * @see findByCacheKey
     */
    getCached(): LibraryManager.Config | null;
     ...
     * @see findByCacheKey
     */
    static getCached(): LibraryManager.Config | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): LibraryManager.Config | null;

    /**
     * @return newly produced cached instance.
     */
    static refreshCache(): LibraryManager.Config | null;
     ...
     */
    static produce(key: string): LibraryManager.Config | null;
     ...
     */
    static produceAll(): C3.Map<string | null, LibraryManager.Config | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, LibraryManager.Config | null>;
     ...
     */
    getConfig(): LibraryManager.Config;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): LibraryManager.Config;
     ...
     */
    getSecret(): LibraryManager.Config;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): LibraryManager.Config;
     ...
     */
    static forConfigKey(configKey: string | null): LibraryManager.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<LibraryManager.Config | null>;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: LibraryManager.Config, override?: string | null): void;

    /**
     * Sets multiple field values to be the same as the passed instance.
     * @see setConfigValue
     */
    static setConfigValues(from: LibraryManager.Config, override?: string | null): void;
     ...
     * @see setSecretValue
     */
    setSecretValues(from: LibraryManager.Config, override?: string | null): void;

    /**
     * Sets multiple secret field values to be the same as the passed instance.
     * @see setSecretValue
     */
    static setSecretValues(from: LibraryManager.Config, override?: string | null): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): LibraryManager.Config | null;
     ...
     */
    removeSecrets(): LibraryManager.Config | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): LibraryManager.Config | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): LibraryManager.Config | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): LibraryManager.Config | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): LibraryManager.Config;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): LibraryManager.Config;
