// TypeScript definitions for the C3 type EchoMicroservice.Config

/**
 * @remarks this represents a value passed to a method that expects an instance of EchoMicroservice.Config
 */
declare namespace EchoMicroservice {
  export interface IConfig {
     ...
     */
    serviceRetrySpec?: IMicroservice.RetrySpec | null;

    /**
     * Allows the client to configure retry thresholds for certain {@link Microservice} methods.
     */
    actionRetrySpecs?: C3.Map<string | null, Microservice.RetrySpec | null> | {[key: string | null]: IMicroservice.RetrySpec | null};
...
declare namespace EchoMicroservice {
  export class Config extends Obj {
    ...
    withConfigOverride(configOverride: string | null): EchoMicroservice.Config;

    readonly secretOverride?: string | null;
    withSecretOverride(secretOverride: string | null): EchoMicroservice.Config;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: C3.Array<string | null>;
    withIssues(issues: C3.Array<string | null> | Array<string | null>): EchoMicroservice.Config;

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): EchoMicroservice.Config;

    /**
     * The id of the {@link App} the {@link Microservice} is running in.
     */
    readonly serviceAppId?: string | null;
    withServiceAppId(serviceAppId: string | null): EchoMicroservice.Config;

    readonly appId?: string | null;
    withAppId(appId: string | null): EchoMicroservice.Config;

    /**
     * The {@link AppUrl} of the {@link App} the {@link Microservice.Service} is running in.
     */
    readonly serviceAppUrl?: string | null;
    withServiceAppUrl(serviceAppUrl: string | null): EchoMicroservice.Config;

    /**
     * The type name of the service that actions should be redirected to, if exists.
     */
    readonly serviceTypeName?: string | null;
    withServiceTypeName(serviceTypeName: string | null): EchoMicroservice.Config;
     ...
     * - {@link #actionRetrySpecs}
     */
    readonly serviceRetrySpec?: Microservice.RetrySpec | null;
    withServiceRetrySpec(serviceRetrySpec: IMicroservice.RetrySpec | null): EchoMicroservice.Config;

    /**
     * Allows the client to configure retry thresholds for certain {@link Microservice} methods.
     */
    readonly actionRetrySpecs?: C3.Map<string | null, Microservice.RetrySpec | null>;
    withActionRetrySpecs(actionRetrySpecs: C3.Map<string | null, Microservice.RetrySpec | null> | {[key: string | null]: IMicroservice.RetrySpec | null}): EchoMicroservice.Config;

    readonly greetings: string;
    withGreetings(greetings: string): EchoMicroservice.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): EchoMicroservice.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): EchoMicroservice.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): EchoMicroservice.Config | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): EchoMicroservice.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): EchoMicroservice.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): EchoMicroservice.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): EchoMicroservice.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<EchoMicroservice.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<EchoMicroservice.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): EchoMicroservice.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): EchoMicroservice.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): EchoMicroservice.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): EchoMicroservice.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): EchoMicroservice.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): EchoMicroservice.Config;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): EchoMicroservice.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): EchoMicroservice.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): EchoMicroservice.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): EchoMicroservice.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): EchoMicroservice.Config;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): EchoMicroservice.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): EchoMicroservice.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): EchoMicroservice.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): EchoMicroservice.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): EchoMicroservice.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): EchoMicroservice.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): EchoMicroservice.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): EchoMicroservice.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): EchoMicroservice.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): EchoMicroservice.Config;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): EchoMicroservice.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): EchoMicroservice.Config;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): EchoMicroservice.Config;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): EchoMicroservice.Config;

    mergeJson(json: any | null): EchoMicroservice.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): EchoMicroservice.Config;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): EchoMicroservice.Config;
     ...
     */
    singletonArray(): C3.Array<EchoMicroservice.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<EchoMicroservice.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<EchoMicroservice.Config | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<EchoMicroservice.Config | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<EchoMicroservice.Config | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, EchoMicroservice.Config | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, EchoMicroservice.Config | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<EchoMicroservice.Config | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<EchoMicroservice.Config | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): EchoMicroservice.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): EchoMicroservice.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): EchoMicroservice.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): EchoMicroservice.Config;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): EchoMicroservice.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): EchoMicroservice.Config;
     ...
     * @see #fromString
     */
    static make(s: string | null): EchoMicroservice.Config | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): EchoMicroservice.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): EchoMicroservice.Config;
     ...
     */
    static cachedEmptyInst(): EchoMicroservice.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<EchoMicroservice.Config>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): EchoMicroservice.Config;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<EchoMicroservice.Config | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<EchoMicroservice.Config | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<EchoMicroservice.Config | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): EchoMicroservice.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string | null): EchoMicroservice.Config | null;
     ...
     * @see findByCacheKey
     */
    getCached(): EchoMicroservice.Config | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): EchoMicroservice.Config | null;
     ...
     */
    static produce(key: string): EchoMicroservice.Config | null;
     ...
     */
    static produceAll(): C3.Map<string | null, EchoMicroservice.Config | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, EchoMicroservice.Config | null>;
     ...
     */
    getConfig(): EchoMicroservice.Config;
     ...
     */
    getSecret(): EchoMicroservice.Config;
     ...
     */
    static forConfigKey(configKey: string | null): EchoMicroservice.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<EchoMicroservice.Config | null>;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: EchoMicroservice.Config, override?: string | null): void;
     ...
     * @see setSecretValue
     */
    setSecretValues(from: EchoMicroservice.Config, override?: string | null): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): EchoMicroservice.Config | null;
     ...
     * @see #toString
     */
    static fromString(s: string | null): EchoMicroservice.Config | null;
     ...
     */
    static forName(name: string | null, failIfMissing?: boolean): EchoMicroservice.Config | null;
  }
}
