// TypeScript definitions for the C3 type JsBrowserLukeTester

/**
 * This {@link JsBrowserTester} runs {@link LukeBrowser} tests for generic UIs.
 * No specific default content is configured for the tests {@link AppUrl}.
 *
 * @remarks this represents a value passed to a method that expects an instance of JsBrowserLukeTester
 */
declare interface IJsBrowserLukeTester {
   ...
   */
  testerHtmlPagePath?: string | null;
 ...
 * No specific default content is configured for the tests {@link AppUrl}.
 *
 * @remarks this represents a made instance of JsBrowserLukeTester
 */
declare class JsBrowserLukeTester extends Obj {

  /**
   * Whether or not tests should be executed in headless mode.
   */
  headless?: boolean;
  withHeadless(headless: boolean): JsBrowserLukeTester;
   ...
   */
  testerHtmlPagePath?: string | null;
  withTesterHtmlPagePath(testerHtmlPagePath: string | null): JsBrowserLukeTester;

  testRunner: TestRunner;
  withTestRunner(testRunner: ITestRunner): JsBrowserLukeTester;
   ...
   */
  state: string;
  withState(state: string): JsBrowserLukeTester;

  /**
   * The collected test results after the test execution.
   */
  results?: C3.Array<TestSuiteResult | null>;
  withResults(results: C3.Array<TestSuiteResult | null> | Array<ITestSuiteResult | null>): JsBrowserLukeTester;

  /**
   * The action engine in which tests will execute.
   */
  engine: Action.Engine;
  withEngine(engine: IAction.Engine): JsBrowserLukeTester;

  maxRetries?: number | null;
  withMaxRetries(maxRetries: number | null): JsBrowserLukeTester;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): JsBrowserLukeTester | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): JsBrowserLukeTester | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): JsBrowserLukeTester | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): JsBrowserLukeTester | null;
   ...
   */
  replaceType(old: Type, new_: Type): JsBrowserLukeTester;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JsBrowserLukeTester;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JsBrowserLukeTester;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JsBrowserLukeTester | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JsBrowserLukeTester | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): JsBrowserLukeTester;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JsBrowserLukeTester;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JsBrowserLukeTester;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): JsBrowserLukeTester;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): JsBrowserLukeTester;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): JsBrowserLukeTester;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): JsBrowserLukeTester;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): JsBrowserLukeTester;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): JsBrowserLukeTester;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): JsBrowserLukeTester;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): JsBrowserLukeTester;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): JsBrowserLukeTester;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): JsBrowserLukeTester;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): JsBrowserLukeTester;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): JsBrowserLukeTester;
   ...
   * @see #unsetField
   */
  defaultField(field: string): JsBrowserLukeTester;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): JsBrowserLukeTester;
   ...
   * @see #removeField
   */
  unsetField(field: string): JsBrowserLukeTester;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): JsBrowserLukeTester;
   ...
   * @see #unsetField
   */
  removeField(field: string): JsBrowserLukeTester;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): JsBrowserLukeTester;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): JsBrowserLukeTester;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): JsBrowserLukeTester;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): JsBrowserLukeTester;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): JsBrowserLukeTester;

  mergeJson(json: any | null): JsBrowserLukeTester;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): JsBrowserLukeTester;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): JsBrowserLukeTester;
   ...
   */
  singletonArray(): C3.Array<JsBrowserLukeTester | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<JsBrowserLukeTester | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<JsBrowserLukeTester | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<JsBrowserLukeTester | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<JsBrowserLukeTester | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, JsBrowserLukeTester | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, JsBrowserLukeTester | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<JsBrowserLukeTester | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<JsBrowserLukeTester | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): JsBrowserLukeTester;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): JsBrowserLukeTester;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): JsBrowserLukeTester;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): JsBrowserLukeTester;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): JsBrowserLukeTester;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): JsBrowserLukeTester;

  /**
   * Construct an instance with initial state.
   */
  static make(): JsBrowserLukeTester;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): JsBrowserLukeTester;
   ...
   */
  static cachedEmptyInst(): JsBrowserLukeTester;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<JsBrowserLukeTester>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): JsBrowserLukeTester;
   ...
   *          Configuration spec
   */
  generateTestUrl(baseUrl: Url, testSuitePath: string, spec?: TesterRunSpec | null): Url;

  /**
   * List of arguments passed to the browser.
   */
  seleniumArgCapabilities(browser: string): C3.Array<string | null>;
   ...
   */
  runTestSuiteInBrowser(testSuiteCode: string, testSuitePath: string, spec?: TesterRunSpec | null): TestSuiteResult;
   ...
   * @return this Obj
   */
  setField(field: string, value: any, doNotConvert?: boolean): JsBrowserLukeTester;
   ...
   * @return this Obj
   */
  setField(field: FieldType, value: any, doNotConvert?: boolean): JsBrowserLukeTester;
   ...
   */
  static forPathAndEngine(path: string, engine: string): JsBrowserLukeTester;
   ...
   * Note: invoke this API on the desired type of Tester instead of on the Tester type directly.
   */
  static forNameAndEngine(testName: string, engine: string): JsBrowserLukeTester;
   ...
   * Note: invoke this API on the desired type of Tester instead of on the Tester type directly.
   */
  static forEngine(engine: string, deep?: boolean): JsBrowserLukeTester;
   ...
   */
  run(spec?: TesterRunSpec | null): JsBrowserLukeTester;
