// TypeScript definitions for the C3 type NameableType

/**
 * Represents a type system type with name.
 *
 * @remarks this represents a value passed to a method that expects an instance of NameableType
 */
declare interface INameableType {
 ...
 * Represents a type system type with name.
 *
 * @remarks this represents a made instance of NameableType
 */
declare class NameableType extends Obj {

  /**
   * Source file Pkg.Path a C3 Type declaration [.c3typ].
   */
  readonly declaredPkgPath?: string | null;
  withDeclaredPkgPath(declaredPkgPath: string | null): NameableType;

  /**
   * Source line number in a C3 Type declaration [.c3typ] file starting with 1 where this metadata element is declared.
   */
  readonly declaredSrcLine?: number | null;
  withDeclaredSrcLine(declaredSrcLine: number | null): NameableType;
  ...
  withDeclaredSrcCharInLine(declaredSrcCharInLine: number | null): NameableType;
   ...
   */
  readonly pkg: Pkg;
  withPkg(pkg: IPkg): NameableType;

  /**
   * SDK json representing instance of this type
   */
  readonly json?: any;
  withJson(json: any): NameableType;

  /**
   * The set of annotations defined on this element of metadata represented as json value.
   */
  readonly annotationsJson?: any | null;
  withAnnotationsJson(annotationsJson: any | null): NameableType;
  ...
  withDoc(doc: string | null): NameableType;

  readonly docSingleLine?: boolean;
  withDocSingleLine(docSingleLine: boolean): NameableType;

  /**
   * The name of this instance.
   */
  readonly name?: string | null;
  withName(name: string | null): NameableType;
   ...
   */
  replaceType(old: Type, new_: Type): NameableType;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): NameableType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): NameableType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): NameableType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): NameableType | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NameableType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NameableType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NameableType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NameableType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): NameableType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NameableType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NameableType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): NameableType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): NameableType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): NameableType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): NameableType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): NameableType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): NameableType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): NameableType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): NameableType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): NameableType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): NameableType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): NameableType;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): NameableType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): NameableType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): NameableType;
   ...
   * @see #removeField
   */
  unsetField(field: string): NameableType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): NameableType;
   ...
   * @see #unsetField
   */
  removeField(field: string): NameableType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): NameableType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): NameableType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): NameableType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): NameableType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): NameableType;

  mergeJson(json: any | null): NameableType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): NameableType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): NameableType;
   ...
   */
  singletonArray(): C3.Array<NameableType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<NameableType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<NameableType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<NameableType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<NameableType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, NameableType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, NameableType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<NameableType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<NameableType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): NameableType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): NameableType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): NameableType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): NameableType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): NameableType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): NameableType;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): NameableType;
   ...
   */
  static cachedEmptyInst(): NameableType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<NameableType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): NameableType;
   ...
   */
  withoutDeclaredSrcPos(recursive?: boolean): NameableType;
   ...
   */
  withAnnotation(ann: Annotation): NameableType;
   ...
   *         value for the field
   */
  withAnnotation(ann: string, annField?: string | null, value?: any): NameableType;
