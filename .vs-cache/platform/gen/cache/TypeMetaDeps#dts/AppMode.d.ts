// TypeScript definitions for the C3 type AppMode

/**
 * All possible modes a C3 Application can be deployed in.
 *
 * @remarks this represents a value passed to a method that expects an instance of AppMode
 */
...
declare class AppMode {
   ...
   */
  static includesTestOverlay(mode: string): boolean;

  /**
   * Returns true, in this mode, if Pkg needs to be updatable.
   */
  static requiresUpdatablePkg(mode: string): boolean;
}
