// TypeScript definitions for the C3 type Int16Type

/**
 * The numeric quarter integer (16 bit) value type.
 *
 * There are no fields (other than #modifier), so this is normally accessed with {@link PrimitiveType#ofInt16}.
 *
 * @remarks this represents a value passed to a method that expects an instance of Int16Type
 */
declare interface IInt16Type {
 ...
 * There are no fields (other than #modifier), so this is normally accessed with {@link PrimitiveType#ofInt16}.
 *
 * @remarks this represents a made instance of Int16Type
 */
declare class Int16Type extends Obj {

  /**
   * Source file Pkg.Path a C3 Type declaration [.c3typ].
   */
  readonly declaredPkgPath?: string | null;
  withDeclaredPkgPath(declaredPkgPath: string | null): Int16Type;

  /**
   * Source line number in a C3 Type declaration [.c3typ] file starting with 1 where this metadata element is declared.
   */
  readonly declaredSrcLine?: number | null;
  withDeclaredSrcLine(declaredSrcLine: number | null): Int16Type;
  ...
  withDeclaredSrcCharInLine(declaredSrcCharInLine: number | null): Int16Type;
   ...
   */
  readonly pkg: Pkg;
  withPkg(pkg: IPkg): Int16Type;

  /**
   * SDK json representing instance of this type
   */
  readonly json?: any;
  withJson(json: any): Int16Type;

  /**
   * The set of annotations defined on this element of metadata represented as json value.
   */
  readonly annotationsJson?: any | null;
  withAnnotationsJson(annotationsJson: any | null): Int16Type;
  ...
  withModifier(modifier: string | null): Int16Type;
  ...
  withName(name: string): Int16Type;
  ...
  withSerializedType(serializedType: IValueType | null): Int16Type;
  ...
  withEnumRefType(enumRefType: IReferenceType | null): Int16Type;
  ...
  withDeclaredEnumValues(declaredEnumValues: C3.Array<string | null> | Array<string | null>): Int16Type;
   ...
   */
  replaceType(old: Type, new_: Type): Int16Type;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Int16Type | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Int16Type | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Int16Type | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Int16Type | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Int16Type;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Int16Type;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Int16Type | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Int16Type | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Int16Type;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Int16Type;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Int16Type;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): Int16Type;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Int16Type;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Int16Type;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Int16Type;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Int16Type;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Int16Type;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Int16Type;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Int16Type;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Int16Type;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Int16Type;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Int16Type;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Int16Type;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Int16Type;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Int16Type;
   ...
   * @see #removeField
   */
  unsetField(field: string): Int16Type;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Int16Type;
   ...
   * @see #unsetField
   */
  removeField(field: string): Int16Type;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Int16Type;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Int16Type;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Int16Type;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Int16Type;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Int16Type;

  mergeJson(json: any | null): Int16Type;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Int16Type;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Int16Type;
   ...
   */
  singletonArray(): C3.Array<Int16Type | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Int16Type | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Int16Type | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Int16Type | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Int16Type | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Int16Type | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Int16Type | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Int16Type | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Int16Type | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Int16Type;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Int16Type;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Int16Type;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Int16Type;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Int16Type;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Int16Type;
   ...
   * @see #fromString
   */
  static make(s: string | null): Int16Type | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Int16Type;
   ...
   */
  static cachedEmptyInst(): Int16Type;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Int16Type>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Int16Type;
   ...
   */
  withoutDeclaredSrcPos(recursive?: boolean): Int16Type;
   ...
   */
  withAnnotation(ann: Annotation): Int16Type;
   ...
   *         value for the field
   */
  withAnnotation(ann: string, annField?: string | null, value?: any): Int16Type;
   ...
   * @see #toString
   */
  static fromString(s: string | null): Int16Type | null;
