// TypeScript definitions for the C3 type ContentPushStream

/**
 * Write only content wrapping an encoded byte-push-stream.
 *
 * @remarks this represents a value passed to a method that expects an instance of ContentPushStream
 */
declare interface IContentPushStream {
  ...
  wrapped?: IBytePushStream | null;
}

/**
 * Write only content wrapping an encoded byte-push-stream.
 *
 * @remarks this represents a made instance of ContentPushStream
 */
declare class ContentPushStream extends Obj {
  ...
  withContentEncoding(contentEncoding: string | null): ContentPushStream;
  ...
  withContentLanguage(contentLanguage: string | null): ContentPushStream;
  ...
  withContentLength(contentLength: number | null): ContentPushStream;
  ...
  withContentLocation(contentLocation: string | null): ContentPushStream;
  ...
  withContentType(contentType: string | null): ContentPushStream;
  ...
  withContentDisposition(contentDisposition: string | null): ContentPushStream;
  ...
  withETag(eTag: string | null): ContentPushStream;
  ...
  withLastModified(lastModified: DateTime | Date | string | null): ContentPushStream;

  /**
   * Id of user / identity who last last modified this content.
   */
  readonly lastModifiedBy?: string | null;
  withLastModifiedBy(lastModifiedBy: string | null): ContentPushStream;
  ...
  withContentMD5(contentMD5: string | null): ContentPushStream;
  ...
  withContentSHA1(contentSHA1: string | null): ContentPushStream;

  /**
   * Field to maintain state whether content metadata was read or not.
   */
  readonly hasMetadata?: boolean;
  withHasMetadata(hasMetadata: boolean): ContentPushStream;

  readonly wrapped?: BytePushStream | null;
  withWrapped(wrapped: IBytePushStream | null): ContentPushStream;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ContentPushStream | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ContentPushStream | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ContentPushStream | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ContentPushStream | null;
   ...
   */
  replaceType(old: Type, new_: Type): ContentPushStream;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ContentPushStream;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ContentPushStream;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ContentPushStream | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ContentPushStream | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ContentPushStream;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ContentPushStream;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ContentPushStream;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ContentPushStream;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ContentPushStream;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ContentPushStream;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ContentPushStream;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ContentPushStream;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ContentPushStream;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ContentPushStream;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ContentPushStream;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ContentPushStream;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ContentPushStream;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ContentPushStream;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ContentPushStream;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ContentPushStream;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ContentPushStream;
   ...
   * @see #removeField
   */
  unsetField(field: string): ContentPushStream;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ContentPushStream;
   ...
   * @see #unsetField
   */
  removeField(field: string): ContentPushStream;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ContentPushStream;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ContentPushStream;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ContentPushStream;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ContentPushStream;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ContentPushStream;

  mergeJson(json: any | null): ContentPushStream;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ContentPushStream;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ContentPushStream;
   ...
   */
  singletonArray(): C3.Array<ContentPushStream | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ContentPushStream | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ContentPushStream | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ContentPushStream | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ContentPushStream | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ContentPushStream | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ContentPushStream | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ContentPushStream | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ContentPushStream | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ContentPushStream;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ContentPushStream;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ContentPushStream;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ContentPushStream;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ContentPushStream;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ContentPushStream;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ContentPushStream;
   ...
   */
  static cachedEmptyInst(): ContentPushStream;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ContentPushStream>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ContentPushStream;
   ...
   */
  withFileName(fileName: string | null): ContentPushStream;

  /**
   * Changes file extension in this instance.
   */
  withFileExt(fileExt: string | null): ContentPushStream;
   ...
   */
  identify(suffix?: string | null): ContentPushStream;
   ...
   */
  readMetadata(spec?: FileOperationSpec | null): ContentPushStream;
   ...
   */
  refreshMetadata(spec?: FileOperationSpec | null): ContentPushStream;
   ...
   * @return abstract content with metadata.
   */
  guessMetadata(spec?: FileOperationSpec | null): ContentPushStream;

  /**
   * Clears the content metadata; e.g. if it's known to be invalid.
   */
  clearMetadata(): ContentPushStream;

  /**
   * @return clone of this content with metadata from provided input.
   */
  withMetadata(meta?: ContentMeta | null): ContentPushStream;
   ...
   */
  encodedPushStream(spec?: FileOperationSpec | null): Pair<ContentPushStream | null, BytePushStream | null>;

  /**
   * @return byte push stream to be used for writing un-encoded data into this content object.
   */
  pushStream(spec?: FileOperationSpec | null): Pair<ContentPushStream | null, BytePushStream | null>;

  /**
   * @return character push stream to be used for writing un-encoded data into this content object.
   */
  charPushStream(spec?: FileOperationSpec | null): Pair<ContentPushStream | null, CharPushStream | null>;
   ...
   */
  encodedStream(spec?: FileOperationSpec | null): Pair<ContentPushStream | null, ByteStream | null> | null;
   ...
   */
  writeStream(content: ByteStream | null, spec?: FileOperationSpec | null): ContentPushStream;

  /**
   * Truncates file and replaces it's content with provided binary content.
   */
  writeInputStream(inputStream: any, spec?: FileOperationSpec | null): ContentPushStream;

  /**
   * Truncates file and replaces its content with provided binary content from zipInputStream
   */
  writeZipInputStream(zipInputStream: any, spec?: FileOperationSpec | null): ContentPushStream;
   ...
   */
  writeEncodedStream(encodedContent: ByteStream | null, spec?: FileOperationSpec | null): ContentPushStream;

  /**
   * Truncates file and replaces it's encoded content with provided binary content.
   */
  writeEncodedInputStream(inputStream: any, spec?: FileOperationSpec | null): ContentPushStream;
   ...
   *           content that needs to be written
   */
  write(content: any | null, spec?: FileOperationSpec | null): ContentPushStream;
   ...
   *           encoded content that needs to be written
   */
  writeEncoded(encodedContent: any | null, spec?: FileOperationSpec | null): ContentPushStream;
   ...
   *           content that needs to be written
   */
  writeString(content: string | null, spec?: FileOperationSpec | null): ContentPushStream;
   ...
   */
  writeObj(obj: Obj | null, spec?: FileObjsOperSpec | null): ContentPushStream;
   ...
   * @return pair of update instance of this content and number of objs written
   */
  startWriteObjs(spec?: FileObjsOperSpec | null): Pair<ContentPushStream | null, PushStream<Obj | null> | null>;
   ...
   */
  compress(contentEncoding?: string | null, spec?: FileCompressSpec | null): ContentPushStream;

  /**
   * Uncompresses content.
   */
  uncompress(spec?: FileCompressSpec | null): ContentPushStream;
   ...
   */
  transcode(contentType: string, contentEncoding: string, spec?: FileCompressSpec | null): ContentPushStream;

  /**
   * Copies content to a given target.
   */
  copyContentTo(target: ContentPushStream, spec?: FileOperationSpec | null): void;
   ...
   */
  concat(other: Content | null): ContentPushStream;

  /**
   * Creates a new Content by merging the incoming binary data with current content
   */
  concat(other: any | null): ContentPushStream;
