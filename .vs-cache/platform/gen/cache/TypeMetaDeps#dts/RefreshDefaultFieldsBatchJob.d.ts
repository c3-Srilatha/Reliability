// TypeScript definitions for the C3 type RefreshDefaultFieldsBatchJob

/**
 * Batch job definitions for batch jobs started from RefreshDefaultFieldsTask for asynchronous processing.
 *
 * @remarks this represents a value passed to a method that expects an instance of RefreshDefaultFieldsBatchJob
 */
declare interface IRefreshDefaultFieldsBatchJob {
 ...
 */
declare class RefreshDefaultFieldsBatchJob extends Obj {

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun | null;
  withRun(run: IBatchJobRun | null): RefreshDefaultFieldsBatchJob;

  /**
   * previous job executions for this instance
   */
  readonly runs?: C3.Array<BatchJobRun | null>;
  withRuns(runs: C3.Array<BatchJobRun | null> | Array<IBatchJobRun | null>): RefreshDefaultFieldsBatchJob;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj | null;
  withOptions(options: IObj | null): RefreshDefaultFieldsBatchJob;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): RefreshDefaultFieldsBatchJob;
  ...
  withPriority(priority: number | null): RefreshDefaultFieldsBatchJob;
  ...
  withDisabled(disabled: boolean): RefreshDefaultFieldsBatchJob;
  ...
  withMaxConcurrency(maxConcurrency: number | null): RefreshDefaultFieldsBatchJob;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): RefreshDefaultFieldsBatchJob;
  ...
  withRunAsUser(runAsUser: boolean | null): RefreshDefaultFieldsBatchJob;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string | null;
  withNodePool(nodePool: string | null): RefreshDefaultFieldsBatchJob;
  ...
  withSkipIfRunning(skipIfRunning: boolean | null): RefreshDefaultFieldsBatchJob;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number | null;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): RefreshDefaultFieldsBatchJob;
  ...
  withPropagateActionContext(propagateActionContext: boolean): RefreshDefaultFieldsBatchJob;
  ...
  withTypeIdent(typeIdent: string | null): RefreshDefaultFieldsBatchJob;
   ...
   */
  readonly id: string;
  withId(id: string): RefreshDefaultFieldsBatchJob;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): RefreshDefaultFieldsBatchJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): RefreshDefaultFieldsBatchJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): RefreshDefaultFieldsBatchJob;
  ...
  withVersion(version: number | null): RefreshDefaultFieldsBatchJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): RefreshDefaultFieldsBatchJob;
  ...
  withAbortOnError(abortOnError: boolean): RefreshDefaultFieldsBatchJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): RefreshDefaultFieldsBatchJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): RefreshDefaultFieldsBatchJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): RefreshDefaultFieldsBatchJob | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): RefreshDefaultFieldsBatchJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): RefreshDefaultFieldsBatchJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): RefreshDefaultFieldsBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): RefreshDefaultFieldsBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<RefreshDefaultFieldsBatchJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<RefreshDefaultFieldsBatchJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): RefreshDefaultFieldsBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RefreshDefaultFieldsBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RefreshDefaultFieldsBatchJob;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): RefreshDefaultFieldsBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): RefreshDefaultFieldsBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): RefreshDefaultFieldsBatchJob;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): RefreshDefaultFieldsBatchJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): RefreshDefaultFieldsBatchJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): RefreshDefaultFieldsBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): RefreshDefaultFieldsBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): RefreshDefaultFieldsBatchJob;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): RefreshDefaultFieldsBatchJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): RefreshDefaultFieldsBatchJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): RefreshDefaultFieldsBatchJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): RefreshDefaultFieldsBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): RefreshDefaultFieldsBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): RefreshDefaultFieldsBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): RefreshDefaultFieldsBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): RefreshDefaultFieldsBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): RefreshDefaultFieldsBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): RefreshDefaultFieldsBatchJob;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): RefreshDefaultFieldsBatchJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): RefreshDefaultFieldsBatchJob;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): RefreshDefaultFieldsBatchJob;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): RefreshDefaultFieldsBatchJob;

  mergeJson(json: any | null): RefreshDefaultFieldsBatchJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): RefreshDefaultFieldsBatchJob;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): RefreshDefaultFieldsBatchJob;
   ...
   */
  singletonArray(): C3.Array<RefreshDefaultFieldsBatchJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<RefreshDefaultFieldsBatchJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<RefreshDefaultFieldsBatchJob | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<RefreshDefaultFieldsBatchJob | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<RefreshDefaultFieldsBatchJob | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, RefreshDefaultFieldsBatchJob | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, RefreshDefaultFieldsBatchJob | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<RefreshDefaultFieldsBatchJob | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<RefreshDefaultFieldsBatchJob | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): RefreshDefaultFieldsBatchJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): RefreshDefaultFieldsBatchJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): RefreshDefaultFieldsBatchJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): RefreshDefaultFieldsBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): RefreshDefaultFieldsBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): RefreshDefaultFieldsBatchJob;
   ...
   * @see #fromString
   */
  static make(s: string | null): RefreshDefaultFieldsBatchJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): RefreshDefaultFieldsBatchJob;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): RefreshDefaultFieldsBatchJob;
   ...
   */
  static cachedEmptyInst(): RefreshDefaultFieldsBatchJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<RefreshDefaultFieldsBatchJob>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): RefreshDefaultFieldsBatchJob;
   ...
   */
  start(options?: RefreshDefaultFieldsSpec | null): BatchJobStatus | null;
   ...
   */
  cleanup(options?: RefreshDefaultFieldsSpec | null): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun | null, BatchJobStatus | null, RefreshDefaultFieldsSpec | null> | null;

  failJob(run: JobRun<BatchJobStatusBase | null>): JobBase<BatchJobRun | null, BatchJobStatus | null, RefreshDefaultFieldsSpec | null> | null;
  ...
  validateStart(options?: RefreshDefaultFieldsSpec | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<RefreshDefaultFieldsBatchJob | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<RefreshDefaultFieldsBatchJob | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<RefreshDefaultFieldsBatchJob | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<RefreshDefaultFieldsBatchJob | null> | null>;
   ...
   */
  get(include?: string | null): RefreshDefaultFieldsBatchJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): RefreshDefaultFieldsBatchJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): RefreshDefaultFieldsBatchJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): RefreshDefaultFieldsBatchJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): RefreshDefaultFieldsBatchJob;
   ...
   * @see #toString
   */
  static fromString(s: string | null): RefreshDefaultFieldsBatchJob | null;
   ...
   */
  create(spec?: UpsertSpec | null): RefreshDefaultFieldsBatchJob | null;
   ...
   */
  static createBatch(objs: C3.Array<RefreshDefaultFieldsBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<RefreshDefaultFieldsBatchJob | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<RefreshDefaultFieldsBatchJob | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<RefreshDefaultFieldsBatchJob | null> | null;
   ...
   */
  update(srcObj?: RefreshDefaultFieldsBatchJob | null, spec?: UpsertSpec | null): RefreshDefaultFieldsBatchJob | null;
   ...
   */
  upsert(srcObj?: RefreshDefaultFieldsBatchJob | null, spec?: UpsertSpec | null): RefreshDefaultFieldsBatchJob | null;
   ...
   */
  merge(spec?: MergeSpec | null): RefreshDefaultFieldsBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): RefreshDefaultFieldsBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): RefreshDefaultFieldsBatchJob | null;
   ...
   */
  static updateBatch(objs: C3.Array<RefreshDefaultFieldsBatchJob | null> | null, srcObjs?: C3.Array<RefreshDefaultFieldsBatchJob | null>, spec?: UpsertSpec | null): ObjList<RefreshDefaultFieldsBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<RefreshDefaultFieldsBatchJob | null>>, spec?: UpsertSpec | null): ObjList<RefreshDefaultFieldsBatchJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<RefreshDefaultFieldsBatchJob | null> | null, srcObjs?: C3.Array<RefreshDefaultFieldsBatchJob | null>, spec?: UpsertSpec | null): ObjList<RefreshDefaultFieldsBatchJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<RefreshDefaultFieldsBatchJob | null>>, spec?: UpsertSpec | null): ObjList<RefreshDefaultFieldsBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<RefreshDefaultFieldsBatchJob | null> | null, spec?: TouchSpec | null): ObjList<RefreshDefaultFieldsBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<RefreshDefaultFieldsBatchJob | null> | null, spec?: MergeSpec | null): ObjList<RefreshDefaultFieldsBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<RefreshDefaultFieldsBatchJob | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<RefreshDefaultFieldsBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<RefreshDefaultFieldsBatchJob | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<RefreshDefaultFieldsBatchJob | null> | null;
   ...
   */
  static mergeAll(mergeObj: RefreshDefaultFieldsBatchJob | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: RefreshDefaultFieldsBatchJob | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<RefreshDefaultFieldsBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<RefreshDefaultFieldsBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<RefreshDefaultFieldsBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<RefreshDefaultFieldsBatchJob | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): RefreshDefaultFieldsBatchJob | null;
   ...
   */
  static beforeCreate(objs: C3.Array<RefreshDefaultFieldsBatchJob | null> | null): ObjList<RefreshDefaultFieldsBatchJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<RefreshDefaultFieldsBatchJob | null> | null): ObjList<RefreshDefaultFieldsBatchJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<RefreshDefaultFieldsBatchJob | null> | null): ObjList<RefreshDefaultFieldsBatchJob | null>;
   ...
   */
  static afterCreate(objs: C3.Array<RefreshDefaultFieldsBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<RefreshDefaultFieldsBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<RefreshDefaultFieldsBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<RefreshDefaultFieldsBatchJob | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<RefreshDefaultFieldsBatchJob | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): RefreshDefaultFieldsBatchJob | null;
   ...
   */
  withoutIdentity(): RefreshDefaultFieldsBatchJob | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<RefreshDefaultFieldsBatchJob | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: RefreshDefaultFieldsBatchJob | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<RefreshDefaultFieldsBatchJob | null> | null, callback?: λFunction<RefreshDefaultFieldsBatchJob | null, RefreshDefaultFieldsBatchJob | null> | null): ObjList<RefreshDefaultFieldsBatchJob | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<RefreshDefaultFieldsBatchJob | null> | null, callback?: λFunction<RefreshDefaultFieldsBatchJob | null, RefreshDefaultFieldsBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static doStart(job?: RefreshDefaultFieldsBatchJob | null, options?: RefreshDefaultFieldsSpec | null): void;
   ...
   */
  static processBatch(batch?: RefreshDefaultFieldsSpec | null, job?: RefreshDefaultFieldsBatchJob | null, options?: RefreshDefaultFieldsSpec | null): void;
   ...
   */
  static allComplete(job: RefreshDefaultFieldsBatchJob, options?: RefreshDefaultFieldsSpec | null): string | null;
   ...
   *           Options the job was run with.
   */
  static failed(job: RefreshDefaultFieldsBatchJob, status: BatchJobStatus, options?: RefreshDefaultFieldsSpec | null): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: RefreshDefaultFieldsSpec | null): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: C3.Array<RefreshDefaultFieldsSpec | null>): void;
   ...
   */
  static scheduleObjBatch(job?: RefreshDefaultFieldsBatchJob | null, objBatch?: ObjBatch | null, logPrefix?: string | null): number | null;
