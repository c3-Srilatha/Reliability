// TypeScript definitions for the C3 type JSMapReduceJob
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of JSMapReduceJob
 */
declare interface IJSMapReduceJob {
  ...
  mapLambda?: string | null;

  reduceLambda?: string | null;
}
 ...
 */
declare class JSMapReduceJob extends Obj {

  /**
   * current or last job execution for this instance
   */
  readonly run?: MapReduceRun | null;
  withRun(run: IMapReduceRun | null): JSMapReduceJob;

  /**
   * previous job executions for this instance
   */
  readonly runs?: C3.Array<MapReduceRun | null>;
  withRuns(runs: C3.Array<MapReduceRun | null> | Array<IMapReduceRun | null>): JSMapReduceJob;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj | null;
  withOptions(options: IObj | null): JSMapReduceJob;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): JSMapReduceJob;
  ...
  withPriority(priority: number | null): JSMapReduceJob;
  ...
  withDisabled(disabled: boolean): JSMapReduceJob;
  ...
  withMaxConcurrency(maxConcurrency: number | null): JSMapReduceJob;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): JSMapReduceJob;
  ...
  withRunAsUser(runAsUser: boolean | null): JSMapReduceJob;

  /**
   * Don't set this field in the MapReduce job, set it in the MapReduceOptions when calling `start`.
   */
  readonly nodePool?: string | null;
  withNodePool(nodePool: string | null): JSMapReduceJob;
  ...
  withSkipIfRunning(skipIfRunning: boolean | null): JSMapReduceJob;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number | null;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): JSMapReduceJob;
  ...
  withPropagateActionContext(propagateActionContext: boolean): JSMapReduceJob;
  ...
  withTargetType(targetType: IType | null): JSMapReduceJob;
  ...
  withUseFileSystemForInterVals(useFileSystemForInterVals: boolean): JSMapReduceJob;
  ...
  withUseBatchIdsForReadInput(useBatchIdsForReadInput: boolean): JSMapReduceJob;
  ...
  withInclude(include: string | null): JSMapReduceJob;

  /**
   * optional filter spec
   */
  readonly filter?: string | null;
  withFilter(filter: string | null): JSMapReduceJob;
  ...
  withOrder(order: string | null): JSMapReduceJob;
  ...
  withLimit(limit: number | null): JSMapReduceJob;
  ...
  withSamplePct(samplePct: number | null): JSMapReduceJob;
  ...
  withBatchSize(batchSize: number | null): JSMapReduceJob;
  ...
  withSubBatchSize(subBatchSize: number | null): JSMapReduceJob;
  ...
  withNumBatches(numBatches: number | null): JSMapReduceJob;
  ...
  withAbortOnError(abortOnError: boolean): JSMapReduceJob;
  ...
  withTypeIdent(typeIdent: string | null): JSMapReduceJob;
   ...
   */
  readonly id: string;
  withId(id: string): JSMapReduceJob;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): JSMapReduceJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): JSMapReduceJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): JSMapReduceJob;
  ...
  withVersion(version: number | null): JSMapReduceJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): JSMapReduceJob;
  ...
  withTargetFilter(targetFilter: IObj | null): JSMapReduceJob;

  readonly context?: Obj | null;
  withContext(context: IObj | null): JSMapReduceJob;

  readonly mapLambda?: string | null;
  withMapLambda(mapLambda: string | null): JSMapReduceJob;

  readonly reduceLambda?: string | null;
  withReduceLambda(reduceLambda: string | null): JSMapReduceJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): JSMapReduceJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): JSMapReduceJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): JSMapReduceJob | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): JSMapReduceJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): JSMapReduceJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JSMapReduceJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JSMapReduceJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JSMapReduceJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JSMapReduceJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): JSMapReduceJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JSMapReduceJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JSMapReduceJob;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): JSMapReduceJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): JSMapReduceJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): JSMapReduceJob;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): JSMapReduceJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): JSMapReduceJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): JSMapReduceJob;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): JSMapReduceJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): JSMapReduceJob;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): JSMapReduceJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): JSMapReduceJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): JSMapReduceJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): JSMapReduceJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): JSMapReduceJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): JSMapReduceJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): JSMapReduceJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): JSMapReduceJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): JSMapReduceJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): JSMapReduceJob;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): JSMapReduceJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): JSMapReduceJob;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): JSMapReduceJob;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): JSMapReduceJob;

  mergeJson(json: any | null): JSMapReduceJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): JSMapReduceJob;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): JSMapReduceJob;
   ...
   */
  singletonArray(): C3.Array<JSMapReduceJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<JSMapReduceJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<JSMapReduceJob | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<JSMapReduceJob | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<JSMapReduceJob | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, JSMapReduceJob | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, JSMapReduceJob | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<JSMapReduceJob | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<JSMapReduceJob | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): JSMapReduceJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): JSMapReduceJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): JSMapReduceJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): JSMapReduceJob;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): JSMapReduceJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): JSMapReduceJob;
   ...
   * @see #fromString
   */
  static make(s: string | null): JSMapReduceJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): JSMapReduceJob;
   ...
   */
  static cachedEmptyInst(): JSMapReduceJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<JSMapReduceJob>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): JSMapReduceJob;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<JSMapReduceJob | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<JSMapReduceJob | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<JSMapReduceJob | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<JSMapReduceJob | null> | null>;
   ...
   */
  get(include?: string | null): JSMapReduceJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): JSMapReduceJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): JSMapReduceJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): JSMapReduceJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): JSMapReduceJob;
   ...
   * @see #toString
   */
  static fromString(s: string | null): JSMapReduceJob | null;
   ...
   */
  create(spec?: UpsertSpec | null): JSMapReduceJob | null;
   ...
   */
  static createBatch(objs: C3.Array<JSMapReduceJob | null> | null, spec?: UpsertSpec | null): ObjList<JSMapReduceJob | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<JSMapReduceJob | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<JSMapReduceJob | null> | null;
   ...
   */
  update(srcObj?: JSMapReduceJob | null, spec?: UpsertSpec | null): JSMapReduceJob | null;
   ...
   */
  upsert(srcObj?: JSMapReduceJob | null, spec?: UpsertSpec | null): JSMapReduceJob | null;
   ...
   */
  merge(spec?: MergeSpec | null): JSMapReduceJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): JSMapReduceJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): JSMapReduceJob | null;
   ...
   */
  static updateBatch(objs: C3.Array<JSMapReduceJob | null> | null, srcObjs?: C3.Array<JSMapReduceJob | null>, spec?: UpsertSpec | null): ObjList<JSMapReduceJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<JSMapReduceJob | null>>, spec?: UpsertSpec | null): ObjList<JSMapReduceJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<JSMapReduceJob | null> | null, srcObjs?: C3.Array<JSMapReduceJob | null>, spec?: UpsertSpec | null): ObjList<JSMapReduceJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<JSMapReduceJob | null>>, spec?: UpsertSpec | null): ObjList<JSMapReduceJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<JSMapReduceJob | null> | null, spec?: TouchSpec | null): ObjList<JSMapReduceJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<JSMapReduceJob | null> | null, spec?: MergeSpec | null): ObjList<JSMapReduceJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<JSMapReduceJob | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<JSMapReduceJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<JSMapReduceJob | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<JSMapReduceJob | null> | null;
   ...
   */
  static mergeAll(mergeObj: JSMapReduceJob | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: JSMapReduceJob | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<JSMapReduceJob | null> | null, spec?: UpsertSpec | null): ObjList<JSMapReduceJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<JSMapReduceJob | null> | null, spec?: UpsertSpec | null): ObjList<JSMapReduceJob | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<JSMapReduceJob | null> | null): ObjList<JSMapReduceJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<JSMapReduceJob | null> | null): ObjList<JSMapReduceJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<JSMapReduceJob | null> | null): ObjList<JSMapReduceJob | null>;
   ...
   */
  static afterCreate(objs: C3.Array<JSMapReduceJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<JSMapReduceJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<JSMapReduceJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<JSMapReduceJob | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<JSMapReduceJob | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): JSMapReduceJob | null;
   ...
   */
  withoutIdentity(): JSMapReduceJob | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<JSMapReduceJob | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: JSMapReduceJob | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<JSMapReduceJob | null> | null, callback?: λFunction<JSMapReduceJob | null, JSMapReduceJob | null> | null): ObjList<JSMapReduceJob | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<JSMapReduceJob | null> | null, callback?: λFunction<JSMapReduceJob | null, JSMapReduceJob | null> | null): C3.Array<ObjError | null>;
   ...
   *         key type.
   */
  static map(batch?: number | null, objs?: C3.Array<Obj | null>, job?: MapReduce<Obj | null, string | null, Obj | null, Obj | null> | null, subBatch?: number | null): C3.Map<string | null, Obj | null>;
   ...
   */
  static reduce(outKey?: string | null, interValues?: C3.Array<Obj | null>, job?: MapReduce<Obj | null, string | null, Obj | null, Obj | null> | null): Obj | null | C3.Array<Obj | null> | null;
   ...
   */
  static mapCompleted(job?: MapReduce<Obj | null, string | null, Obj | null, Obj | null> | null): void;
   ...
   */
  static completed(job?: MapReduce<Obj | null, string | null, Obj | null, Obj | null> | null): string | null;
   ...
   */
  static failed(job: MapReduce<Obj | null, string | null, Obj | null, Obj | null>, status: MapReduceStatus, options?: MapReduceOptions | null): void;
   ...
   */
  results(limit?: number | null): C3.Map<string | null, Obj | null | C3.Array<Obj | null> | null>;
