// TypeScript definitions for the C3 type Guard

/**
 * @remarks this represents a value passed to a method that expects an instance of Guard
 */
declare interface IGuard {
  ...
  lock?: C3.Array<string | null> | Array<string | null>;

  lockedBy?: C3.Array<string | null> | Array<string | null>;
}

/**
 * @remarks this represents a made instance of Guard
 */
declare class Guard extends Obj {

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): Guard;

  readonly tag?: string | null;
  withTag(tag: string | null): Guard;

  readonly module?: string | null;
  withModule(module: string | null): Guard;

  readonly typp?: string | null;
  withTypp(typp: string | null): Guard;

  readonly action?: string | null;
  withAction(action: string | null): Guard;

  readonly aggregate?: boolean;
  withAggregate(aggregate: boolean): Guard;

  readonly exclusive?: boolean;
  withExclusive(exclusive: boolean): Guard;

  readonly quietPeriod?: number | null;
  withQuietPeriod(quietPeriod: number | null): Guard;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Guard;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): Guard;
  ...
  withVersion(version: number | null): Guard;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): Guard;

  readonly lock?: C3.Array<string | null>;
  withLock(lock: C3.Array<string | null> | Array<string | null>): Guard;

  readonly lockedBy?: C3.Array<string | null>;
  withLockedBy(lockedBy: C3.Array<string | null> | Array<string | null>): Guard;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Guard | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Guard | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Guard | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Guard | null;
   ...
   */
  replaceType(old: Type, new_: Type): Guard;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Guard;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Guard;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Guard | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Guard | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Guard;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Guard;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Guard;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Guard;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Guard;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Guard;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Guard;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Guard;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Guard;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Guard;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Guard;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Guard;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Guard;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Guard;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Guard;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Guard;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Guard;
   ...
   * @see #unsetField
   */
  removeField(field: string): Guard;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Guard;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Guard;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Guard;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Guard;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Guard;

  mergeJson(json: any | null): Guard;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Guard;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Guard;
   ...
   */
  singletonArray(): C3.Array<Guard | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Guard | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Guard | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Guard | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Guard | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Guard | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Guard | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Guard | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Guard | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Guard;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Guard;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Guard;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Guard;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Guard;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Guard;
   ...
   * @see #fromString
   */
  static make(s: string | null): Guard | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Guard;
   ...
   */
  static cachedEmptyInst(): Guard;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Guard>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Guard;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<Guard | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<Guard | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Guard | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Guard | null> | null>;
   ...
   */
  get(include?: string | null): Guard | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): Guard | null;
   ...
   */
  getMissing(spec: GetMissingSpec): Guard;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): Guard | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): Guard;
   ...
   * @see #toString
   */
  static fromString(s: string | null): Guard | null;
   ...
   */
  create(spec?: UpsertSpec | null): Guard | null;
   ...
   */
  static createBatch(objs: C3.Array<Guard | null> | null, spec?: UpsertSpec | null): ObjList<Guard | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<Guard | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Guard | null> | null;
   ...
   */
  update(srcObj?: Guard | null, spec?: UpsertSpec | null): Guard | null;
   ...
   */
  upsert(srcObj?: Guard | null, spec?: UpsertSpec | null): Guard | null;
   ...
   */
  merge(spec?: MergeSpec | null): Guard | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): Guard | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): Guard | null;
   ...
   */
  static updateBatch(objs: C3.Array<Guard | null> | null, srcObjs?: C3.Array<Guard | null>, spec?: UpsertSpec | null): ObjList<Guard | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<Guard | null>>, spec?: UpsertSpec | null): ObjList<Guard | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<Guard | null> | null, srcObjs?: C3.Array<Guard | null>, spec?: UpsertSpec | null): ObjList<Guard | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<Guard | null>>, spec?: UpsertSpec | null): ObjList<Guard | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<Guard | null> | null, spec?: TouchSpec | null): ObjList<Guard | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Guard | null> | null, spec?: MergeSpec | null): ObjList<Guard | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Guard | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Guard | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<Guard | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Guard | null> | null;
   ...
   */
  static mergeAll(mergeObj: Guard | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: Guard | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<Guard | null> | null, spec?: UpsertSpec | null): ObjList<Guard | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<Guard | null> | null, spec?: UpsertSpec | null): ObjList<Guard | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<Guard | null> | null): ObjList<Guard | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<Guard | null> | null): ObjList<Guard | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<Guard | null> | null): ObjList<Guard | null>;
   ...
   */
  static afterCreate(objs: C3.Array<Guard | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<Guard | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<Guard | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<Guard | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Guard | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): Guard | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<Guard | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: Guard | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<Guard | null> | null, callback?: λFunction<Guard | null, Guard | null> | null): ObjList<Guard | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<Guard | null> | null, callback?: λFunction<Guard | null, Guard | null> | null): C3.Array<ObjError | null>;
