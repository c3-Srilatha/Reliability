// TypeScript definitions for the C3 type ChangeLogQueue

/**
 * Invalidation queue for generic invalidation of data changes.  Each entry represents a single change that a
 * {@link ChangeLogListener} reported as being interested in.
 *
 * @see ChangeLogQueueEntry
 *
 * @remarks this represents a value passed to a method that expects an instance of ChangeLogQueue
 */
declare interface IChangeLogQueue {
}
 ...
 * @see ChangeLogQueueEntry
 *
 * @remarks this represents a made instance of ChangeLogQueue
 */
declare class ChangeLogQueue {
   ...
   */
  static compute(targetType: Type, entries: C3.Array<ChangeLogQueueEntry | null> | null): void;
   ...
   */
  static find(spec?: InvalidationQueue.FindSpec | null): C3.Array<ChangeLogQueueEntry | null>;
   ...
   * @return the list of requested entries.
   */
  static findStream(spec?: InvalidationQueue.FindStreamSpec | null): Stream<ChangeLogQueueEntry | null>;
   ...
   *           Entries to remove.
   */
  static clearEntries(entries: C3.Array<ChangeLogQueueEntry | null> | null): void;
   ...
   * This function should be claimed by individual InvalidationQueue types such as CalcFieldsQueue.
   */
  static mergeContexts(targetType?: Type | null, entries?: C3.Array<ChangeLogQueueEntry | null>): C3.Array<ChangeLogQueueEntry | null>;

  /**
   * Provides a summary of the current contents of the ChangeLogQueue.  The summary contains backward dependency
   * information, grouped by targetTypeId.  Note that the backward dependencies returned will
   * be the entire set for the target type, not limited to those that will be specifically triggered by any/all
   * of the entries.
   */
  static summary(): C3.Array<ChangeLogSummaryResult | null>;
}
