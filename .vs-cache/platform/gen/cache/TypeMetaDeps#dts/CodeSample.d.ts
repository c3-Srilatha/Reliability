// TypeScript definitions for the C3 type CodeSample

/**
 * @remarks this represents a value passed to a method that expects an instance of CodeSample
 */
declare interface ICodeSample {
  ...
  /**
   * The content of the code sample.  It is persisted as a metadata file if live metadata is on.
   * Otherwise, it is persisted as a ContentValue.
   *
   * This field should always be set when persisted.  UI uses the {@link codeContent} field
   * instead to avoid having to read the content directly.
   */
  content?: IFile | null | IContentValue | null | null;

  /**
   * The {@link content} as a string, which is easier for the UI to use.  It will be set
   * for objects returned by {@link allCodeSamples} or {@link withNotPersistableFields}.
   * If it is set when the object is upserted, the {@link content} will be updated to
   * this value.
   *
   * This field is not persisted, since {@link content} is the source of truth.  However,
   * it is not marked `not persistable`, since {@link beforeCreate} and {@link beforeUpdate}
   * need it.
   */
  codeContent?: string | null;

  /**
   * The name of the package containing this code sample.
   */
  package?: string | null;
}

/**
 * @remarks this represents a made instance of CodeSample
 */
declare class CodeSample extends Obj {

  /**
   * The name of this instance.
   */
  readonly name?: string | null;
  withName(name: string | null): CodeSample;

  /**
   * List of {@link AclEntry} entries governing who can read/update/remove Objs.
   */
  readonly acl?: C3.Array<AclEntry | null>;
  withAcl(acl: C3.Array<AclEntry | null> | Array<IAclEntry | null>): CodeSample;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): CodeSample;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): CodeSample;
  ...
  withVersion(version: number | null): CodeSample;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): CodeSample;
  ...
  withUserUpdatedFields(userUpdatedFields: C3.Array<string | null> | Array<string | null>): CodeSample;
  ...
  withHidden(hidden: boolean): CodeSample;
  ...
  withUserOwned(userOwned: boolean): CodeSample;
  ...
  withTypeIdent(typeIdent: string | null): CodeSample;

  readonly description?: string | null;
  withDescription(description: string | null): CodeSample;
   ...
   * instead to avoid having to read the content directly.
   */
  readonly content?: File | null | ContentValue | null | null;
  withContent(content: IFile | null | IContentValue | null | null): CodeSample;
   ...
   * need it.
   */
  readonly codeContent?: string | null;
  withCodeContent(codeContent: string | null): CodeSample;

  /**
   * The name of the package containing this code sample.
   */
  readonly package?: string | null;
  withPackage(package_: string | null): CodeSample;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): CodeSample | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): CodeSample | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): CodeSample | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): CodeSample | null;
   ...
   */
  replaceType(old: Type, new_: Type): CodeSample;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): CodeSample;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): CodeSample;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<CodeSample | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<CodeSample | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): CodeSample;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CodeSample;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CodeSample;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): CodeSample;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): CodeSample;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): CodeSample;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): CodeSample;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): CodeSample;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): CodeSample;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): CodeSample;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): CodeSample;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): CodeSample;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): CodeSample;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): CodeSample;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): CodeSample;
   ...
   * @see #unsetField
   */
  defaultField(field: string): CodeSample;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): CodeSample;
   ...
   * @see #removeField
   */
  unsetField(field: string): CodeSample;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): CodeSample;
   ...
   * @see #unsetField
   */
  removeField(field: string): CodeSample;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): CodeSample;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): CodeSample;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): CodeSample;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): CodeSample;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): CodeSample;

  mergeJson(json: any | null): CodeSample;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): CodeSample;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): CodeSample;
   ...
   */
  singletonArray(): C3.Array<CodeSample | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<CodeSample | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<CodeSample | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<CodeSample | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<CodeSample | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, CodeSample | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, CodeSample | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<CodeSample | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<CodeSample | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): CodeSample;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): CodeSample;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): CodeSample;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): CodeSample;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): CodeSample;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): CodeSample;
   ...
   * @see #fromString
   */
  static make(s: string | null): CodeSample | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): CodeSample;
   ...
   */
  static cachedEmptyInst(): CodeSample;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<CodeSample>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): CodeSample;
   ...
   */
  static populateAcl(objs?: C3.Array<CodeSample | null>): number | null;
   ...
   */
  grantMemberReadUpdateRemove(member: AccessControlEntity): CodeSample;
   ...
   */
  mergeAclEntry(entry: AclEntry): CodeSample;
   ...
   * @return the obj with the new acl after merging the indicated entry.
   */
  mergeAclEntries(entries: C3.Array<AclEntry | null> | null): CodeSample;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<CodeSample | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<CodeSample | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<CodeSample | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): CodeSample | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string | null): CodeSample | null;
   ...
   * @see findByCacheKey
   */
  getCached(): CodeSample | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): CodeSample | null;
   ...
   */
  static produce(key: string): CodeSample | null;
   ...
   */
  static produceAll(): C3.Map<string | null, CodeSample | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, CodeSample | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<CodeSample | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<CodeSample | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<CodeSample | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<CodeSample | null> | null>;
   ...
   */
  get(include?: string | null): CodeSample | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): CodeSample | null;
   ...
   */
  getMissing(spec: GetMissingSpec): CodeSample;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): CodeSample | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): CodeSample;
   ...
   * @see #toString
   */
  static fromString(s: string | null): CodeSample | null;
   ...
   */
  create(spec?: UpsertSpec | null): CodeSample | null;
   ...
   */
  static createBatch(objs: C3.Array<CodeSample | null> | null, spec?: UpsertSpec | null): ObjList<CodeSample | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<CodeSample | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<CodeSample | null> | null;
   ...
   */
  update(srcObj?: CodeSample | null, spec?: UpsertSpec | null): CodeSample | null;
   ...
   */
  upsert(srcObj?: CodeSample | null, spec?: UpsertSpec | null): CodeSample | null;
   ...
   */
  merge(spec?: MergeSpec | null): CodeSample | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): CodeSample | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): CodeSample | null;
   ...
   */
  static updateBatch(objs: C3.Array<CodeSample | null> | null, srcObjs?: C3.Array<CodeSample | null>, spec?: UpsertSpec | null): ObjList<CodeSample | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<CodeSample | null>>, spec?: UpsertSpec | null): ObjList<CodeSample | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<CodeSample | null> | null, srcObjs?: C3.Array<CodeSample | null>, spec?: UpsertSpec | null): ObjList<CodeSample | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<CodeSample | null>>, spec?: UpsertSpec | null): ObjList<CodeSample | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<CodeSample | null> | null, spec?: TouchSpec | null): ObjList<CodeSample | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<CodeSample | null> | null, spec?: MergeSpec | null): ObjList<CodeSample | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<CodeSample | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<CodeSample | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<CodeSample | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<CodeSample | null> | null;
   ...
   */
  static mergeAll(mergeObj: CodeSample | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: CodeSample | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<CodeSample | null> | null, spec?: UpsertSpec | null): ObjList<CodeSample | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<CodeSample | null> | null, spec?: UpsertSpec | null): ObjList<CodeSample | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<CodeSample | null> | null): ObjList<CodeSample | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<CodeSample | null> | null): ObjList<CodeSample | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<CodeSample | null> | null): ObjList<CodeSample | null>;
   ...
   */
  static afterCreate(objs: C3.Array<CodeSample | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<CodeSample | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<CodeSample | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<CodeSample | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<CodeSample | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): CodeSample | null;
   ...
   */
  withoutIdentity(): CodeSample | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<CodeSample | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: CodeSample | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<CodeSample | null> | null, callback?: λFunction<CodeSample | null, CodeSample | null> | null): ObjList<CodeSample | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<CodeSample | null> | null, callback?: λFunction<CodeSample | null, CodeSample | null> | null): C3.Array<ObjError | null>;
   ...
   */
  publish(subPath?: string | null, contentType?: string | null): CodeSample;
   ...
   */
  static removeSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<CodeSample | null> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec | null): CodeSample | null;
   ...
   */
  static createSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<CodeSample | null> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData | null, spec?: UpsertSpec | null): CodeSample | null;
   ...
   */
  static updateSeedDataBatch(objs?: C3.Array<SeedData | null>, srcObjs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<CodeSample | null> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec | null): CodeSample | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: C3.Array<SeedData | null>, spec?: MergeSpec | null): ObjList<CodeSample | null> | null;
  ...
  dependencies(): SeedDataDeps<CodeSample | null> | null;
  ...
  /**
   * Fetch all code samples.  Populate the {@link codeContent} and {@link package} fields.
   * Return a list sorted by whether they are from the current package and then alphabetically
   * (case insensitive).
   */
  static allCodeSamples(): C3.Array<CodeSample | null>;

  /**
   * Return this code sample with the {@link codeContent} and {@link package} fields set.
   */
  withNotPersistableFields(): CodeSample;

  /**
   * Reads the seeded {@link CodeSample} python file, passes the data needed to run the script and executes it.
   * Returns the state of execution after executing the script. Used for testing {@link CodeSample}s.
   *
   * @param metadataFilePath
   *            Metadata file path/url of the seeded {@link CodeSample}
   * @param data
   *            Map of data needed for the seeded {@link CodeSample} to run.
   */
  static call(metadataFilePath: string, data?: any): C3.Map<string | null, any>;
}
