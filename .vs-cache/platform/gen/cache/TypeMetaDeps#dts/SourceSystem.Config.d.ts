// TypeScript definitions for the C3 type SourceSystem.Config

/**
 * @remarks this represents a value passed to a method that expects an instance of SourceSystem.Config
 */
declare namespace SourceSystem {
...
declare namespace SourceSystem {
  export class Config extends Obj {
    ...
    withName(name: string): SourceSystem.Config;

    readonly configOverride?: string | null;
    withConfigOverride(configOverride: string | null): SourceSystem.Config;

    readonly secretOverride?: string | null;
    withSecretOverride(secretOverride: string | null): SourceSystem.Config;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: C3.Array<string | null>;
    withIssues(issues: C3.Array<string | null> | Array<string | null>): SourceSystem.Config;

    /**
     * If set, these credentials will be used as default credentials for source collections with a corresponding provider.
     */
    readonly credentials?: CloudCredentials | null;
    withCredentials(credentials: ICloudCredentials | null): SourceSystem.Config;
    ...
    withRootUrlOverride(rootUrlOverride: string | null): SourceSystem.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): SourceSystem.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): SourceSystem.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): SourceSystem.Config | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): SourceSystem.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): SourceSystem.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SourceSystem.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SourceSystem.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SourceSystem.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SourceSystem.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SourceSystem.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SourceSystem.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SourceSystem.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): SourceSystem.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): SourceSystem.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): SourceSystem.Config;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SourceSystem.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SourceSystem.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): SourceSystem.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): SourceSystem.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): SourceSystem.Config;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): SourceSystem.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SourceSystem.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): SourceSystem.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SourceSystem.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): SourceSystem.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): SourceSystem.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): SourceSystem.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): SourceSystem.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): SourceSystem.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): SourceSystem.Config;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SourceSystem.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): SourceSystem.Config;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SourceSystem.Config;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SourceSystem.Config;

    mergeJson(json: any | null): SourceSystem.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SourceSystem.Config;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): SourceSystem.Config;
     ...
     */
    singletonArray(): C3.Array<SourceSystem.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<SourceSystem.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<SourceSystem.Config | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<SourceSystem.Config | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<SourceSystem.Config | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, SourceSystem.Config | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, SourceSystem.Config | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<SourceSystem.Config | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<SourceSystem.Config | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SourceSystem.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SourceSystem.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SourceSystem.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): SourceSystem.Config;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SourceSystem.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): SourceSystem.Config;
     ...
     * @see #fromString
     */
    static make(s: string | null): SourceSystem.Config | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SourceSystem.Config;
     ...
     */
    static cachedEmptyInst(): SourceSystem.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SourceSystem.Config>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): SourceSystem.Config;
     ...
     * @see #toString
     */
    static fromString(s: string | null): SourceSystem.Config | null;
     ...
     */
    static forName(name: string | null, failIfMissing?: boolean): SourceSystem.Config | null;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<SourceSystem.Config | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<SourceSystem.Config | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<SourceSystem.Config | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): SourceSystem.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string | null): SourceSystem.Config | null;
     ...
     * @see findByCacheKey
     */
    getCached(): SourceSystem.Config | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): SourceSystem.Config | null;
     ...
     */
    static produce(key: string): SourceSystem.Config | null;
     ...
     */
    static produceAll(): C3.Map<string | null, SourceSystem.Config | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, SourceSystem.Config | null>;
     ...
     */
    static forConfigKey(configKey: string | null): SourceSystem.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<SourceSystem.Config | null>;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: SourceSystem.Config, override?: string | null): void;
     ...
     * @see setSecretValue
     */
    setSecretValues(from: SourceSystem.Config, override?: string | null): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): SourceSystem.Config | null;
