// TypeScript definitions for the C3 type SchemaUpgrade
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of SchemaUpgrade
 */
declare interface ISchemaUpgrade {
}
 ...
 */
declare class SchemaUpgrade extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SchemaUpgrade | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SchemaUpgrade | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SchemaUpgrade | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SchemaUpgrade | null;
   ...
   */
  replaceType(old: Type, new_: Type): SchemaUpgrade;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SchemaUpgrade;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SchemaUpgrade;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SchemaUpgrade | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SchemaUpgrade | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SchemaUpgrade;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SchemaUpgrade;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SchemaUpgrade;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SchemaUpgrade;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SchemaUpgrade;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SchemaUpgrade;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SchemaUpgrade;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SchemaUpgrade;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SchemaUpgrade;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SchemaUpgrade;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SchemaUpgrade;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SchemaUpgrade;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SchemaUpgrade;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SchemaUpgrade;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SchemaUpgrade;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SchemaUpgrade;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SchemaUpgrade;
   ...
   * @see #removeField
   */
  unsetField(field: string): SchemaUpgrade;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SchemaUpgrade;
   ...
   * @see #unsetField
   */
  removeField(field: string): SchemaUpgrade;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SchemaUpgrade;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SchemaUpgrade;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SchemaUpgrade;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SchemaUpgrade;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SchemaUpgrade;

  mergeJson(json: any | null): SchemaUpgrade;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SchemaUpgrade;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SchemaUpgrade;
   ...
   */
  singletonArray(): C3.Array<SchemaUpgrade | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SchemaUpgrade | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SchemaUpgrade | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SchemaUpgrade | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SchemaUpgrade | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SchemaUpgrade | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SchemaUpgrade | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SchemaUpgrade | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SchemaUpgrade | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SchemaUpgrade;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SchemaUpgrade;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SchemaUpgrade;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SchemaUpgrade;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SchemaUpgrade;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SchemaUpgrade;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SchemaUpgrade;
   ...
   */
  static cachedEmptyInst(): SchemaUpgrade;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SchemaUpgrade>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SchemaUpgrade;
