// TypeScript definitions for the C3 type RpKeyPair

/**
 * @remarks this represents a value passed to a method that expects an instance of RpKeyPair
 */
declare interface IRpKeyPair {
  ...
  expiry?: DateTime | Date | string | null;

  /**
   * out
   */
  generated?: DateTime | Date | string | null;

  expiration?: DateTime | Date | string | null;

  keyStore?: string | null;
}

/**
 * @remarks this represents a made instance of RpKeyPair
 */
declare class RpKeyPair extends Obj {
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): RpKeyPair;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): RpKeyPair;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): RpKeyPair;
  ...
  withVersion(version: number | null): RpKeyPair;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): RpKeyPair;

  /**
   * in
   */
  readonly privateKey?: string | null;
  withPrivateKey(privateKey: string | null): RpKeyPair;

  readonly publicKeyCertificate?: string | null;
  withPublicKeyCertificate(publicKeyCertificate: string | null): RpKeyPair;

  readonly expiry?: DateTime | null;
  withExpiry(expiry: DateTime | Date | string | null): RpKeyPair;

  /**
   * out
   */
  readonly generated?: DateTime | null;
  withGenerated(generated: DateTime | Date | string | null): RpKeyPair;

  readonly expiration?: DateTime | null;
  withExpiration(expiration: DateTime | Date | string | null): RpKeyPair;

  readonly keyStore?: string | null;
  withKeyStore(keyStore: string | null): RpKeyPair;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): RpKeyPair | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): RpKeyPair | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): RpKeyPair | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): RpKeyPair | null;
   ...
   */
  replaceType(old: Type, new_: Type): RpKeyPair;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): RpKeyPair;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): RpKeyPair;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<RpKeyPair | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<RpKeyPair | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): RpKeyPair;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RpKeyPair;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RpKeyPair;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): RpKeyPair;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): RpKeyPair;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): RpKeyPair;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): RpKeyPair;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): RpKeyPair;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): RpKeyPair;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): RpKeyPair;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): RpKeyPair;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): RpKeyPair;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): RpKeyPair;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): RpKeyPair;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): RpKeyPair;
   ...
   * @see #unsetField
   */
  defaultField(field: string): RpKeyPair;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): RpKeyPair;
   ...
   * @see #removeField
   */
  unsetField(field: string): RpKeyPair;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): RpKeyPair;
   ...
   * @see #unsetField
   */
  removeField(field: string): RpKeyPair;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): RpKeyPair;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): RpKeyPair;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): RpKeyPair;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): RpKeyPair;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): RpKeyPair;

  mergeJson(json: any | null): RpKeyPair;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): RpKeyPair;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): RpKeyPair;
   ...
   */
  singletonArray(): C3.Array<RpKeyPair | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<RpKeyPair | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<RpKeyPair | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<RpKeyPair | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<RpKeyPair | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, RpKeyPair | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, RpKeyPair | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<RpKeyPair | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<RpKeyPair | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): RpKeyPair;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): RpKeyPair;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): RpKeyPair;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): RpKeyPair;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): RpKeyPair;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): RpKeyPair;
   ...
   * @see #fromString
   */
  static make(s: string | null): RpKeyPair | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): RpKeyPair;
   ...
   */
  static cachedEmptyInst(): RpKeyPair;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<RpKeyPair>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): RpKeyPair;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<RpKeyPair | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<RpKeyPair | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<RpKeyPair | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<RpKeyPair | null> | null>;
   ...
   */
  get(include?: string | null): RpKeyPair | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): RpKeyPair | null;
   ...
   */
  getMissing(spec: GetMissingSpec): RpKeyPair;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): RpKeyPair | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): RpKeyPair;
   ...
   * @see #toString
   */
  static fromString(s: string | null): RpKeyPair | null;
   ...
   */
  create(spec?: UpsertSpec | null): RpKeyPair | null;
   ...
   */
  static createBatch(objs: C3.Array<RpKeyPair | null> | null, spec?: UpsertSpec | null): ObjList<RpKeyPair | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<RpKeyPair | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<RpKeyPair | null> | null;
   ...
   */
  update(srcObj?: RpKeyPair | null, spec?: UpsertSpec | null): RpKeyPair | null;
   ...
   */
  upsert(srcObj?: RpKeyPair | null, spec?: UpsertSpec | null): RpKeyPair | null;
   ...
   */
  merge(spec?: MergeSpec | null): RpKeyPair | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): RpKeyPair | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): RpKeyPair | null;
   ...
   */
  static updateBatch(objs: C3.Array<RpKeyPair | null> | null, srcObjs?: C3.Array<RpKeyPair | null>, spec?: UpsertSpec | null): ObjList<RpKeyPair | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<RpKeyPair | null>>, spec?: UpsertSpec | null): ObjList<RpKeyPair | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<RpKeyPair | null> | null, srcObjs?: C3.Array<RpKeyPair | null>, spec?: UpsertSpec | null): ObjList<RpKeyPair | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<RpKeyPair | null>>, spec?: UpsertSpec | null): ObjList<RpKeyPair | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<RpKeyPair | null> | null, spec?: TouchSpec | null): ObjList<RpKeyPair | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<RpKeyPair | null> | null, spec?: MergeSpec | null): ObjList<RpKeyPair | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<RpKeyPair | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<RpKeyPair | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<RpKeyPair | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<RpKeyPair | null> | null;
   ...
   */
  static mergeAll(mergeObj: RpKeyPair | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: RpKeyPair | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<RpKeyPair | null> | null, spec?: UpsertSpec | null): ObjList<RpKeyPair | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<RpKeyPair | null> | null, spec?: UpsertSpec | null): ObjList<RpKeyPair | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<RpKeyPair | null> | null): ObjList<RpKeyPair | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<RpKeyPair | null> | null): ObjList<RpKeyPair | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<RpKeyPair | null> | null): ObjList<RpKeyPair | null>;
   ...
   */
  static afterCreate(objs: C3.Array<RpKeyPair | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<RpKeyPair | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<RpKeyPair | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<RpKeyPair | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<RpKeyPair | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): RpKeyPair | null;
   ...
   */
  withoutIdentity(): RpKeyPair | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<RpKeyPair | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: RpKeyPair | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<RpKeyPair | null> | null, callback?: λFunction<RpKeyPair | null, RpKeyPair | null> | null): ObjList<RpKeyPair | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<RpKeyPair | null> | null, callback?: λFunction<RpKeyPair | null, RpKeyPair | null> | null): C3.Array<ObjError | null>;
  ...
  static generate(privateKeyFile?: string | null, publicKeyFile?: string | null, expiration?: DateTime | null): void;
}
