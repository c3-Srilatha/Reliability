// TypeScript definitions for the C3 type TargetStatus

/**
 * The following captures the statistics for targets in the data integration process. Target can either be a Persistable
 * entity type or a Source type.
 *
 * @remarks this represents a value passed to a method that expects an instance of TargetStatus
 */
declare interface ITargetStatus {
  ...
  /**
   * Target type of this status. Note that if this is a SourceStatus then #targetType field will be same as #sourceType.
   */
  targetType: IType;

  /**
   * Database operation statistics if this target is Persistable, otherwise `null`.
   */
  dbStats?: IPersistableTargetStats | null;
}
 ...
 * entity type or a Source type.
 *
 * @remarks this represents a made instance of TargetStatus
 */
declare class TargetStatus extends Obj {
  ...
  withTypeIdent(typeIdent: string | null): TargetStatus;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): TargetStatus;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): TargetStatus;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): TargetStatus;
  ...
  withVersion(version: number | null): TargetStatus;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): TargetStatus;

  /**
   * A reference to {@link SourceStatus} of the initial / root Sources. Will be `null` for root SourceStatus.
   */
  readonly rootSourceStatus?: SourceStatus | null;
  withRootSourceStatus(rootSourceStatus: ISourceStatus | null): TargetStatus;
  ...
  withParentStatus(parentStatus: IDataIntegStatus | null): TargetStatus;

  /**
   * Array of statuses of immediate transforms optionally filtered by provided transform type.
   */
  readonly transforms?: C3.Array<TransformStatus | null>;
  withTransforms(transforms: C3.Array<TransformStatus | null> | Array<ITransformStatus | null>): TargetStatus;

  /**
   * Array of statuses of immediate targets optionally filtered by provided transform type.
   */
  readonly targets?: C3.Array<TargetStatus | null>;
  withTargets(targets: C3.Array<TargetStatus | null> | Array<ITargetStatus | null>): TargetStatus;

  /**
   * The {@see TypeRef} of the Sources for which the stats are being stored
   */
  readonly sourceType: Type;
  withSourceType(sourceType: IType): TargetStatus;

  /**
   * fingerprint id of the {@see DataIntegSpec} for fetching the corresponding merged specs.
   */
  readonly specId?: string | null;
  withSpecId(specId: string | null): TargetStatus;

  /**
   * {@link DataIntegSpec} for the corresponding merged specs.
   */
  readonly spec?: DataIntegSpec | null;
  withSpec(spec: IDataIntegSpec | null): TargetStatus;
  ...
  withState(state: string): TargetStatus;

  /**
   * The number of objects participating at this data integration step.
   */
  readonly count: number;
  withCount(count: number): TargetStatus;

  /**
   * The number of objects successfully processed at this data integration step.
   */
  readonly successful: number;
  withSuccessful(successful: number): TargetStatus;

  /**
   * The number of objects that were skipped at this data integration step.
   */
  readonly skipped: number;
  withSkipped(skipped: number): TargetStatus;

  /**
   * The number of objects that failed to process at this data integration step.
   */
  readonly failed: number;
  withFailed(failed: number): TargetStatus;
  ...
  withTotalErrorCount(totalErrorCount: number): TargetStatus;

  /**
   * List of first 100 errors in this data integration step.
   */
  readonly errors?: C3.Array<FailedSource | null>;
  withErrors(errors: C3.Array<FailedSource | null> | Array<IFailedSource | null>): TargetStatus;
  ...
  withFirstError(firstError: string | null): TargetStatus;

  /**
   * Target type of this status. Note that if this is a SourceStatus then #targetType field will be same as #sourceType.
   */
  readonly targetType: Type;
  withTargetType(targetType: IType): TargetStatus;

  /**
   * Database operation statistics if this target is Persistable, otherwise `null`.
   */
  readonly dbStats?: PersistableTargetStats | null;
  withDbStats(dbStats: IPersistableTargetStats | null): TargetStatus;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TargetStatus | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TargetStatus | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TargetStatus | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TargetStatus | null;
   ...
   */
  replaceType(old: Type, new_: Type): TargetStatus;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TargetStatus;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TargetStatus;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TargetStatus | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TargetStatus | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TargetStatus;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TargetStatus;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TargetStatus;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TargetStatus;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TargetStatus;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TargetStatus;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TargetStatus;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TargetStatus;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TargetStatus;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TargetStatus;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TargetStatus;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TargetStatus;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TargetStatus;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TargetStatus;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TargetStatus;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TargetStatus;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TargetStatus;
   ...
   * @see #removeField
   */
  unsetField(field: string): TargetStatus;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TargetStatus;
   ...
   * @see #unsetField
   */
  removeField(field: string): TargetStatus;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TargetStatus;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TargetStatus;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TargetStatus;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TargetStatus;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TargetStatus;

  mergeJson(json: any | null): TargetStatus;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TargetStatus;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TargetStatus;
   ...
   */
  singletonArray(): C3.Array<TargetStatus | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TargetStatus | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TargetStatus | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TargetStatus | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TargetStatus | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TargetStatus | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TargetStatus | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TargetStatus | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TargetStatus | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TargetStatus;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TargetStatus;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TargetStatus;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TargetStatus;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TargetStatus;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TargetStatus;
   ...
   * @see #fromString
   */
  static make(s: string | null): TargetStatus | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TargetStatus;
   ...
   */
  static cachedEmptyInst(): TargetStatus;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TargetStatus>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TargetStatus;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TargetStatus | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TargetStatus | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TargetStatus | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TargetStatus | null> | null>;
   ...
   */
  get(include?: string | null): TargetStatus | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TargetStatus | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TargetStatus;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TargetStatus | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TargetStatus;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TargetStatus | null;
   ...
   */
  create(spec?: UpsertSpec | null): TargetStatus | null;
   ...
   */
  static createBatch(objs: C3.Array<TargetStatus | null> | null, spec?: UpsertSpec | null): ObjList<TargetStatus | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TargetStatus | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TargetStatus | null> | null;
   ...
   */
  update(srcObj?: TargetStatus | null, spec?: UpsertSpec | null): TargetStatus | null;
   ...
   */
  upsert(srcObj?: TargetStatus | null, spec?: UpsertSpec | null): TargetStatus | null;
   ...
   */
  merge(spec?: MergeSpec | null): TargetStatus | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TargetStatus | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TargetStatus | null;
   ...
   */
  static updateBatch(objs: C3.Array<TargetStatus | null> | null, srcObjs?: C3.Array<TargetStatus | null>, spec?: UpsertSpec | null): ObjList<TargetStatus | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TargetStatus | null>>, spec?: UpsertSpec | null): ObjList<TargetStatus | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TargetStatus | null> | null, srcObjs?: C3.Array<TargetStatus | null>, spec?: UpsertSpec | null): ObjList<TargetStatus | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TargetStatus | null>>, spec?: UpsertSpec | null): ObjList<TargetStatus | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TargetStatus | null> | null, spec?: TouchSpec | null): ObjList<TargetStatus | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TargetStatus | null> | null, spec?: MergeSpec | null): ObjList<TargetStatus | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TargetStatus | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TargetStatus | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TargetStatus | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TargetStatus | null> | null;
   ...
   */
  static mergeAll(mergeObj: TargetStatus | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TargetStatus | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TargetStatus | null> | null, spec?: UpsertSpec | null): ObjList<TargetStatus | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TargetStatus | null> | null, spec?: UpsertSpec | null): ObjList<TargetStatus | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TargetStatus | null> | null): ObjList<TargetStatus | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TargetStatus | null> | null): ObjList<TargetStatus | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TargetStatus | null> | null): ObjList<TargetStatus | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TargetStatus | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TargetStatus | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TargetStatus | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TargetStatus | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TargetStatus | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TargetStatus | null;
   ...
   */
  withoutIdentity(): TargetStatus | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<TargetStatus | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TargetStatus | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TargetStatus | null> | null, callback?: λFunction<TargetStatus | null, TargetStatus | null> | null): ObjList<TargetStatus | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TargetStatus | null> | null, callback?: λFunction<TargetStatus | null, TargetStatus | null> | null): C3.Array<ObjError | null>;
  ...
  /**
   * Creates a TargetStatus object from PersistableTargetStats object
   */
  static fromPersistableTargetStats(stats: PersistableTargetStats): TargetStatus | null;
}
