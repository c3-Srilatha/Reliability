// TypeScript definitions for the C3 type HBaseStore

/**
 * @remarks this represents a value passed to a method that expects an instance of HBaseStore
 */
declare interface IHBaseStore {
...
/**
 * @remarks this represents a made instance of HBaseStore
 */
declare class HBaseStore extends Obj {

  /**
   * The unique and required name of this instance.
   */
  readonly name: string;
  withName(name: string): HBaseStore;
  ...
  withSQL(SQL: string | null): HBaseStore;
  ...
  withKV(KV: string | null): HBaseStore;
  ...
  withDEFAULT_KV_CONFIG(DEFAULT_KV_CONFIG: string | null): HBaseStore;
  ...
  withDEFAULT_COL_NAME(DEFAULT_COL_NAME: string | null): HBaseStore;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): HBaseStore | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): HBaseStore | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): HBaseStore | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): HBaseStore | null;
   ...
   */
  replaceType(old: Type, new_: Type): HBaseStore;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): HBaseStore;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HBaseStore;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HBaseStore;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HBaseStore;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HBaseStore;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HBaseStore | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HBaseStore | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HBaseStore | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HBaseStore | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): HBaseStore;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): HBaseStore;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HBaseStore;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HBaseStore;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HBaseStore;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HBaseStore;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): HBaseStore;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): HBaseStore;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): HBaseStore;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): HBaseStore;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): HBaseStore;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): HBaseStore;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): HBaseStore;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): HBaseStore;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): HBaseStore;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): HBaseStore;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): HBaseStore;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): HBaseStore;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): HBaseStore;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): HBaseStore;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): HBaseStore;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): HBaseStore;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): HBaseStore;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): HBaseStore;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): HBaseStore;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): HBaseStore;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): HBaseStore;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): HBaseStore;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): HBaseStore;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): HBaseStore;
   ...
   * @see #unsetField
   */
  defaultField(field: string): HBaseStore;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): HBaseStore;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): HBaseStore;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): HBaseStore;
   ...
   * @see #removeField
   */
  unsetField(field: string): HBaseStore;
   ...
   * @see #removeField
   */
  static unsetField(field: string): HBaseStore;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): HBaseStore;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): HBaseStore;
   ...
   * @see #unsetField
   */
  removeField(field: string): HBaseStore;
   ...
   * @see #unsetField
   */
  static removeField(field: string): HBaseStore;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): HBaseStore;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): HBaseStore;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): HBaseStore;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): HBaseStore;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): HBaseStore;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): HBaseStore;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): HBaseStore;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): HBaseStore;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): HBaseStore;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): HBaseStore;

  mergeJson(json: any | null): HBaseStore;

  static mergeJson(json: any | null): HBaseStore;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): HBaseStore;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): HBaseStore;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): HBaseStore;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): HBaseStore;
   ...
   */
  singletonArray(): C3.Array<HBaseStore | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<HBaseStore | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<HBaseStore | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<HBaseStore | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<HBaseStore | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<HBaseStore | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<HBaseStore | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, HBaseStore | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, HBaseStore | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<HBaseStore | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<HBaseStore | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<HBaseStore | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): HBaseStore;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): HBaseStore;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): HBaseStore;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): HBaseStore;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): HBaseStore;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): HBaseStore;
   ...
   * @see #fromString
   */
  static make(s: string | null): HBaseStore | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): HBaseStore;
   ...
   */
  static cachedEmptyInst(): HBaseStore;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<HBaseStore>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): HBaseStore;
   ...
   */
  config(secrets?: boolean): HBaseConnectionConfig;
   ...
   * @return instance of configuration - never `null`.
   */
  static config(secrets?: boolean): HBaseConnectionConfig;
   ...
   */
  static typeConfig(): HBaseConnectionConfig;
   ...
   * @see #toString
   */
  static fromString(s: string | null): HBaseStore | null;
   ...
   */
  static forName(name: string | null, failIfMissing?: boolean): HBaseStore | null;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<HBaseStore | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<HBaseStore | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<HBaseStore | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): HBaseStore | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string | null): HBaseStore | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): HBaseStore | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): HBaseStore | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): HBaseStore | null;
   ...
   */
  static produce(key: string): HBaseStore | null;
   ...
   */
  static produceAll(): C3.Map<string | null, HBaseStore | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, HBaseStore | null>;
  ...
  /**
   * Function to put in multiple rows at once
   */
  ...
  /**
   * Function to remove columns in the table for a particular row
   */
