// TypeScript definitions for the C3 type WithInitialState.Engine
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of WithInitialState.Engine
 */
declare namespace WithInitialState {
  export interface IEngine<D, S> {
 ...
 */
declare namespace WithInitialState {
  export class Engine<D, S> extends Obj {

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): WithInitialState.Engine;

    /**
     * The unique and required id of this instance.
     */
    readonly id: string;
    withId(id: string): WithInitialState.Engine;
    ...
    with_deploymentCache(_deploymentCache: any): WithInitialState.Engine;

    /**
     * Errors that are captured during engine start
     */
    readonly _onStartError?: string | null;
    with_onStartError(_onStartError: string | null): WithInitialState.Engine;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): WithInitialState.Engine<D, S> | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): WithInitialState.Engine<D, S> | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): WithInitialState.Engine<D, S> | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): WithInitialState.Engine<D, S> | null;
     ...
     */
    replaceType(old: Type, new_: Type): WithInitialState.Engine<D, S>;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): WithInitialState.Engine<D, S>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): WithInitialState.Engine<D, S>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<WithInitialState.Engine<D, S> | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<WithInitialState.Engine<D, S> | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): WithInitialState.Engine<D, S>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): WithInitialState.Engine<D, S>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): WithInitialState.Engine<D, S>;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): WithInitialState.Engine<D, S>;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): WithInitialState.Engine<D, S>;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): WithInitialState.Engine<D, S>;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): WithInitialState.Engine<D, S>;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): WithInitialState.Engine<D, S>;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): WithInitialState.Engine<D, S>;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): WithInitialState.Engine<D, S>;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): WithInitialState.Engine<D, S>;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): WithInitialState.Engine<D, S>;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): WithInitialState.Engine<D, S>;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): WithInitialState.Engine<D, S>;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): WithInitialState.Engine<D, S>;
     ...
     * @see #unsetField
     */
    defaultField(field: string): WithInitialState.Engine<D, S>;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): WithInitialState.Engine<D, S>;
     ...
     * @see #removeField
     */
    unsetField(field: string): WithInitialState.Engine<D, S>;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): WithInitialState.Engine<D, S>;
     ...
     * @see #unsetField
     */
    removeField(field: string): WithInitialState.Engine<D, S>;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): WithInitialState.Engine<D, S>;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): WithInitialState.Engine<D, S>;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): WithInitialState.Engine<D, S>;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): WithInitialState.Engine<D, S>;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): WithInitialState.Engine<D, S>;

    mergeJson(json: any | null): WithInitialState.Engine<D, S>;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): WithInitialState.Engine<D, S>;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): WithInitialState.Engine<D, S>;
     ...
     */
    singletonArray(): C3.Array<WithInitialState.Engine<D, S> | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<WithInitialState.Engine<D, S> | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<WithInitialState.Engine<D, S> | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<WithInitialState.Engine<D, S> | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<WithInitialState.Engine<D, S> | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, WithInitialState.Engine<D, S> | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, WithInitialState.Engine<D, S> | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<WithInitialState.Engine<D, S> | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<WithInitialState.Engine<D, S> | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): WithInitialState.Engine<D, S>;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): WithInitialState.Engine<D, S>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): WithInitialState.Engine<D, S>;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): WithInitialState.Engine<D, S>;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): WithInitialState.Engine<D, S>;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): WithInitialState.Engine<D, S>;
     ...
     * @see #fromString
     */
    static make(s: string | null): WithInitialState.Engine<D, S> | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): WithInitialState.Engine<D, S>;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): WithInitialState.Engine<D, S>;
     ...
     */
    static cachedEmptyInst(): WithInitialState.Engine<D, S>;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<WithInitialState.Engine<D, S>>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): WithInitialState.Engine<D, S>;
     ...
     * @see #toString
     */
    static fromString(s: string | null): WithInitialState.Engine<D, S> | null;
     ...
     */
    static forName(name: string | null, failIfMissing?: boolean): WithInitialState.Engine<D, S> | null;

    /**
     * @return single instance of this Identified type by id.
     */
    static forId(id: string | null, failIfMissing?: boolean): WithInitialState.Engine<D, S> | null;
     ...
     */
    static deploy(spec: S): WithInitialState.Engine<D, S>;
     ...
     */
    restart(): WithInitialState.Engine<D, S>;
     ...
     */
    start(waitForReady?: boolean, spec?: WaitableSpec | null): WithInitialState.Engine<D, S> | null;

    doStart(): WithInitialState.Engine<D, S>;
     ...
     */
    call(action: Lambda<λFunction<WithInitialState.Engine<D, S>, T | null> | null>): T | null;
     ...
     */
    onStart(): WithInitialState.Engine<D, S>;
     ...
     */
    static specToConfigs(spec: S): C3.Array<Config>;
     ...
     * @see: #terminate
     */
    static list(): C3.Array<WithInitialState.Engine<D, S>>;
     ...
     */
    static onInterpreterStart(spec: S): void;

    /**
     * Instance of {WithInitialState} whose initial state has been precomputed.
     */
    get deployedObjs(): C3.Map<string | null, C3.Array<WithInitialState | null> | null> | null;

    /**
     * Fingerprints associated with the deployed objects.
     */
    get deployedObjFingerprints(): C3.Map<string | null, C3.Array<number | null> | null> | null;

    /**
     * List of runtimes for this engine.
     */
    get runtimes(): C3.Array<string | null> | null;
     ...
     */
    isStateLoaded(obj: WithInitialState, requirement?: string | null): boolean;

    /**
     * Returns the {@link Action.Engine}s for this engine that can satisfy the supplied {@link Action.Requirement}.
     */
    actionEnginesForRequirement(requirement: string): C3.Set<string | null> | null;
  }
}
