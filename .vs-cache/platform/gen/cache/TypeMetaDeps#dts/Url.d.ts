// TypeScript definitions for the C3 type Url
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Url
 */
...
declare class Url extends Obj {
  ...
  withEncodedUser(encodedUser: string | null): Url;

  /**
   * Encoded (raw) raw password of URL, ex. password = 'pwd'.
   */
  readonly encodedPassword?: string | null;
  withEncodedPassword(encodedPassword: string | null): Url;

  /**
   * Host of URL, ex. host = 'ftp.example.com'.
   */
  readonly host?: string | null;
  withHost(host: string | null): Url;
  ...
  withEncodedPath(encodedPath: string | null): Url;

  /**
   * Encoded (raw) query of URL (after the `?` mark), ex. 'ion=1&espv=8'. (This will not include the fragment.)
   */
  readonly encodedQuery?: string | null;
  withEncodedQuery(encodedQuery: string | null): Url;

  /**
   * Encoded (raw) fragment of URL (after the `#` mark), ex. 'chapter1'.
   */
  readonly encodedFragment?: string | null;
  withEncodedFragment(encodedFragment: string | null): Url;
   ...
   */
  static fromString(s: string | null): Url | null;
   ...
   * @see #fromString
   */
  static make(s: string | null): Url | null;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Url;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Url;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Url;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Url;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Url | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Url | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Url | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Url | null;
   ...
   */
  replaceType(old: Type, new_: Type): Url;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Url;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Url;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Url | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Url | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Url;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Url;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Url;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Url;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Url;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Url;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Url;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Url;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Url;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Url;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Url;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Url;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Url;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Url;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Url;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Url;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Url;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Url;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Url;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Url;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Url;

  mergeJson(json: any | null): Url;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Url;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Url;
   ...
   */
  singletonArray(): C3.Array<Url | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Url | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Url | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Url | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Url | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Url | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Url | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Url | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Url | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Url;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Url;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Url;
   ...
   */
  static cachedEmptyInst(): Url;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Url>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Url;
   ...
   */
  withFileName(fileName: string | null): Url;

  /**
   * Changes file extension in this instance.
   */
  withFileExt(fileExt: string | null): Url;

  /**
   * Url encodes and replaces current path.
   */
  withPath(...parts: string | null[]): Url;

  /**
   * Replaces current path with provided encoded path.
   */
  withEncodedPath(...encodedParts: string | null[]): Url;
   ...
   */
  appendPath(...parts: string | null[]): Url;

  /**
   * Appends already URL encoded component to path.
   */
  appendEncodedPath(...encodedParts: string | null[]): Url;
