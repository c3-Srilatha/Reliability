// TypeScript definitions for the C3 type LightGbmPipe
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of LightGbmPipe
 */
declare interface ILightGbmPipe {

  /**
   * Name for the function on the native model to call to do {@link MlTrainable#train}.
   */
  trainFunc?: string | null;
   ...
   */
  keepInputColumnIndices?: boolean;
 ...
 */
declare class LightGbmPipe extends Obj {

  /**
   * Name for the function on the native model to call to do {@link MlTrainable#train}.
   */
  readonly trainFunc?: string | null;
  withTrainFunc(trainFunc: string | null): LightGbmPipe;
   ...
   * {@link SklearnPipe#process}.
   */
  readonly keepInputColumnIndices?: boolean;
  withKeepInputColumnIndices(keepInputColumnIndices: boolean): LightGbmPipe;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): LightGbmPipe;

  /**
   * Name of this pipe.
   */
  readonly name?: string | null;
  withName(name: string | null): LightGbmPipe;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): LightGbmPipe;
  ...
  withVersion(version: number | null): LightGbmPipe;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): LightGbmPipe;
  ...
  withUserUpdatedFields(userUpdatedFields: C3.Array<string | null> | Array<string | null>): LightGbmPipe;
  ...
  withHidden(hidden: boolean): LightGbmPipe;
  ...
  withUserOwned(userOwned: boolean): LightGbmPipe;
  ...
  withTypeIdent(typeIdent: string | null): LightGbmPipe;

  /**
   * If true, then the pipe shall not be retrained
   */
  readonly frozen?: boolean;
  withFrozen(frozen: boolean): LightGbmPipe;

  /**
   * True if training has succeeded and false otherwise.
   */
  readonly trained?: boolean;
  withTrained(trained: boolean): LightGbmPipe;

  /**
   * Errors from training.
   */
  readonly trainingErrors?: string | null;
  withTrainingErrors(trainingErrors: string | null): LightGbmPipe;

  /**
   * If true, the underlying model only accepts flattened input.
   */
  readonly flattenInput?: boolean;
  withFlattenInput(flattenInput: boolean): LightGbmPipe;

  /**
   * The hyperparameters overridden of a native model or pipe.
   */
  readonly hyperparamOverrides?: C3.Map<string | null, any>;
  withHyperparamOverrides(hyperparamOverrides: C3.Map<string | null, any> | {[key: string | null]: any}): LightGbmPipe;
  ...
  withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): LightGbmPipe;
  ...
  withHpoSpec(hpoSpec: IHpo.Spec | null): LightGbmPipe;

  /**
   * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
   */
  readonly hpoExperiment?: Hpo.Experiment | null;
  withHpoExperiment(hpoExperiment: IHpo.Experiment | null): LightGbmPipe;

  /**
   * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
   */
  readonly experiment?: any;
  withExperiment(experiment: any): LightGbmPipe;
  ...
  withModelFiles(modelFiles: C3.Map<string | null, Url | null> | {[key: string | null]: IUrl | null}): LightGbmPipe;
  ...
  withCustomModelCode(customModelCode: C3.Map<string | null, any | null> | {[key: string | null]: any | null}): LightGbmPipe;

  /**
   * Name for the function on the native model to call to do {@link MlProcessable#process}.
   */
  readonly processFunc?: string | null;
  withProcessFunc(processFunc: string | null): LightGbmPipe;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LightGbmPipe | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LightGbmPipe | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LightGbmPipe | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LightGbmPipe | null;
   ...
   */
  replaceType(old: Type, new_: Type): LightGbmPipe;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LightGbmPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LightGbmPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LightGbmPipe | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LightGbmPipe | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LightGbmPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LightGbmPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LightGbmPipe;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LightGbmPipe;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LightGbmPipe;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LightGbmPipe;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LightGbmPipe;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LightGbmPipe;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LightGbmPipe;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LightGbmPipe;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LightGbmPipe;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LightGbmPipe;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LightGbmPipe;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LightGbmPipe;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LightGbmPipe;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LightGbmPipe;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LightGbmPipe;
   ...
   * @see #removeField
   */
  unsetField(field: string): LightGbmPipe;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LightGbmPipe;
   ...
   * @see #unsetField
   */
  removeField(field: string): LightGbmPipe;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LightGbmPipe;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LightGbmPipe;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LightGbmPipe;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LightGbmPipe;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LightGbmPipe;

  mergeJson(json: any | null): LightGbmPipe;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LightGbmPipe;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LightGbmPipe;
   ...
   */
  singletonArray(): C3.Array<LightGbmPipe | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LightGbmPipe | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LightGbmPipe | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LightGbmPipe | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LightGbmPipe | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LightGbmPipe | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LightGbmPipe | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LightGbmPipe | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LightGbmPipe | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LightGbmPipe;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LightGbmPipe;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LightGbmPipe;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LightGbmPipe;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LightGbmPipe;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LightGbmPipe;
   ...
   * @see #fromString
   */
  static make(s: string | null): LightGbmPipe | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LightGbmPipe;
   ...
   */
  static cachedEmptyInst(): LightGbmPipe;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LightGbmPipe>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LightGbmPipe;
   ...
   */
  static findProcessingFunctionName(model: any): string | null;
   ...
   */
  static isFitted(model: any): boolean;
   ...
   */
  afterConvertModelName(model: any, spec?: MlConvertSpec | null): string;
   ...
   */
  afterConvertProcessFunc(model: any, spec?: MlConvertSpec | null): string;
   ...
   */
  afterConvertTrainStatus(model: any, spec?: MlConvertSpec | null): boolean;
   ...
   */
  afterConvertTrainFunc(model: any, spec?: MlConvertSpec | null): string | null;
   ...
   */
  afterConvertKeepInputColumnIndices(model: any, spec?: MlConvertSpec | null): boolean;
   ...
   */
  afterConvertFlattenInput(model: any, spec?: MlConvertSpec | null): boolean;
   ...
   */
  nativeTrainFuncAndKwargs(beforeTrainResults: any): any;
   ...
   */
  afterConvert(model: any, spec?: MlConvertSpec | null): LightGbmPipe;
   ...
   */
  train(x: Data | null, y?: Data | null, spec?: MlOperationSpec | null): MlOperationRun<any>;

  /**
   * Note: This function is dispatched to the runtime that {@link #doTrain} specifies.
   */
  trainSync(x: Data | null, y?: Data | null, spec?: MlOperationSpec | null): LightGbmPipe;
   ...
   *           the operation run object to query status and to get the final result.
   */
  process(x: Data | null, spec?: MlOperationSpec | null): MlOperationRun<Data | null> | null;

  /**
   * Note: This function is dispatched to the runtime that {@link #doProcess} specifies.
   */
  processSync(x: Data | null, spec?: MlOperationSpec | null): Data | null;
   ...
   *           the operation run object to query status and to get the final result.
   */
  score(x: Data | null, y?: Data | null, context?:  | null, spec?: MlOperationSpec | null): MlOperationRun<C3.Map<string | null, number | null>> | null;

  /**
   * Blocking, synchronous version of {@link #score}.
   */
  scoreSync(x: Data | null, y?: Data | null, context?:  | null, spec?: MlOperationSpec | null): C3.Map<string | null, number | null>;
   ...
   *           the operation run object to query status and to get the final result.
   */
  scoreAll(x: Data | null, y?: Data | null, context?:  | null, spec?: MlOperationSpec | null): MlOperationRun<C3.Map<string | null, number | null>> | null;

  /**
   * Blocking, synchronous version of {@link #scoreAll}.
   */
  scoreAllSync(x: Data | null, y?: Data | null, context?:  | null, spec?: MlOperationSpec | null): C3.Map<string | null, number | null>;
   ...
   *           the operation run object to query status and to get the final result.
   */
  interpret(x: Data | null, spec?: MlOperationSpec | null): MlOperationRun< | null> | null;

  /**
   * Blocking, synchronous version of {@link #interpret}.
   */
  interpretSync(x: Data | null, context?: C3.Map<string | null, any>, spec?: MlOperationSpec | null): void;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<LightGbmPipe | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<LightGbmPipe | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<LightGbmPipe | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): LightGbmPipe | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string | null): LightGbmPipe | null;
   ...
   * @see findByCacheKey
   */
  getCached(): LightGbmPipe | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): LightGbmPipe | null;
   ...
   */
  static produce(key: string): LightGbmPipe | null;
   ...
   */
  static produceAll(): C3.Map<string | null, LightGbmPipe | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, LightGbmPipe | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<LightGbmPipe | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<LightGbmPipe | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<LightGbmPipe | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<LightGbmPipe | null> | null>;
   ...
   */
  get(include?: string | null): LightGbmPipe | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): LightGbmPipe | null;
   ...
   */
  getMissing(spec: GetMissingSpec): LightGbmPipe;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): LightGbmPipe | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): LightGbmPipe;
   ...
   * @see #toString
   */
  static fromString(s: string | null): LightGbmPipe | null;
   ...
   */
  create(spec?: UpsertSpec | null): LightGbmPipe | null;
   ...
   */
  static createBatch(objs: C3.Array<LightGbmPipe | null> | null, spec?: UpsertSpec | null): ObjList<LightGbmPipe | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<LightGbmPipe | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<LightGbmPipe | null> | null;
   ...
   */
  update(srcObj?: LightGbmPipe | null, spec?: UpsertSpec | null): LightGbmPipe | null;
   ...
   */
  upsert(srcObj?: LightGbmPipe | null, spec?: UpsertSpec | null): LightGbmPipe | null;
   ...
   */
  merge(spec?: MergeSpec | null): LightGbmPipe | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): LightGbmPipe | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): LightGbmPipe | null;
   ...
   */
  static updateBatch(objs: C3.Array<LightGbmPipe | null> | null, srcObjs?: C3.Array<LightGbmPipe | null>, spec?: UpsertSpec | null): ObjList<LightGbmPipe | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<LightGbmPipe | null>>, spec?: UpsertSpec | null): ObjList<LightGbmPipe | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<LightGbmPipe | null> | null, srcObjs?: C3.Array<LightGbmPipe | null>, spec?: UpsertSpec | null): ObjList<LightGbmPipe | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<LightGbmPipe | null>>, spec?: UpsertSpec | null): ObjList<LightGbmPipe | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<LightGbmPipe | null> | null, spec?: TouchSpec | null): ObjList<LightGbmPipe | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<LightGbmPipe | null> | null, spec?: MergeSpec | null): ObjList<LightGbmPipe | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<LightGbmPipe | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<LightGbmPipe | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<LightGbmPipe | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<LightGbmPipe | null> | null;
   ...
   */
  static mergeAll(mergeObj: LightGbmPipe | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: LightGbmPipe | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<LightGbmPipe | null> | null, spec?: UpsertSpec | null): ObjList<LightGbmPipe | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<LightGbmPipe | null> | null, spec?: UpsertSpec | null): ObjList<LightGbmPipe | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<LightGbmPipe | null> | null): ObjList<LightGbmPipe | null>;
   ...
   */
  static beforeUpdate(objs: C3.Array<LightGbmPipe | null> | null): ObjList<LightGbmPipe | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<LightGbmPipe | null> | null): ObjList<LightGbmPipe | null>;
   ...
   */
  static afterCreate(objs: C3.Array<LightGbmPipe | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<LightGbmPipe | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<LightGbmPipe | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<LightGbmPipe | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<LightGbmPipe | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): LightGbmPipe | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<LightGbmPipe | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: LightGbmPipe | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<LightGbmPipe | null> | null, callback?: λFunction<LightGbmPipe | null, LightGbmPipe | null> | null): ObjList<LightGbmPipe | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<LightGbmPipe | null> | null, callback?: λFunction<LightGbmPipe | null, LightGbmPipe | null> | null): C3.Array<ObjError | null>;
   ...
   */
  publish(subPath?: string | null, contentType?: string | null): LightGbmPipe;
   ...
   */
  static removeSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<LightGbmPipe | null> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec | null): LightGbmPipe | null;
   ...
   */
  static createSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<LightGbmPipe | null> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData | null, spec?: UpsertSpec | null): LightGbmPipe | null;
   ...
   */
  static updateSeedDataBatch(objs?: C3.Array<SeedData | null>, srcObjs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<LightGbmPipe | null> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec | null): LightGbmPipe | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: C3.Array<SeedData | null>, spec?: MergeSpec | null): ObjList<LightGbmPipe | null> | null;
  ...
  dependencies(): SeedDataDeps<LightGbmPipe | null> | null;
   ...
   */
  static convert(model: any, spec?: MlConvertSpec | null): LightGbmPipe;
   ...
   */
  newAuthoringVertex(x?: Data | null, y?: Data | null, context?:  | null, suffix?: string | null, spec?: MlConvertSpec | null): MlPipeline.PipeVertex.Authoring;
   ...
   */
  updateModelFiles(modelFiles: C3.Map<string | null, Url | null> | null, spec?: MlOperationSpec | null): LightGbmPipe;
   ...
   */
  afterTrain(doTrainOutputs: any, spec?: MlOperationSpec | null): LightGbmPipe;
   ...
   */
  convertPipeInputsToNative(x: Data | null, y?: Data | null, spec?: MlOperationSpec | null): any;
   ...
   */
  convertXToNative(x: Data | null, spec?: MlOperationSpec | null): any;
   ...
   * @return converted data.
   */
  convertYToNative(y: Data | null, spec?: MlOperationSpec | null): any;
   ...
   */
  convertNativeToPipeOutputs(output: any, datasetId?: string | null): Data;
   ...
   */
  withNewSpec(spec?: MlConvertSpec | null): LightGbmPipe;
   ...
   */
  static getInputDatasetId(x?: Data | null): string;
   ...
   */
  withHyperparamSpaces(paramSpaces: C3.Map<string | null, Hp.ParamSpace | null>): LightGbmPipe;
