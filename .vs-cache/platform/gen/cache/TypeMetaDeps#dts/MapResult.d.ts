// TypeScript definitions for the C3 type MapResult

/**
 * @remarks this represents a value passed to a method that expects an instance of MapResult
 */
declare interface IMapResult {
   ...
   * = runId + '-' + outKey
   */
  runIdAndOutKey: string;

  interValue?: any;
}

/**
 * @remarks this represents a made instance of MapResult
 */
declare class MapResult extends Obj {

  /**
   * Partition key Bin separator used to separate partition key from bin id
   */
  readonly PK_BIN_SEPARATOR?: string | null;
  withPK_BIN_SEPARATOR(PK_BIN_SEPARATOR: string | null): MapResult;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): MapResult;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): MapResult;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): MapResult;
  ...
  withVersion(version: number | null): MapResult;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): MapResult;

  readonly run?: MapReduceRun | null;
  withRun(run: IMapReduceRun | null): MapResult;

  readonly batch: number;
  withBatch(batch: number): MapResult;

  readonly subBatch: number;
  withSubBatch(subBatch: number): MapResult;

  readonly outKey?: string | null;
  withOutKey(outKey: string | null): MapResult;

  /**
   * = runId + '-' + outKey
   */
  readonly runIdAndOutKey: string;
  withRunIdAndOutKey(runIdAndOutKey: string): MapResult;

  readonly interValue?: any;
  withInterValue(interValue: any): MapResult;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): MapResult | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): MapResult | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): MapResult | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): MapResult | null;
   ...
   */
  replaceType(old: Type, new_: Type): MapResult;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MapResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MapResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MapResult | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MapResult | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): MapResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MapResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MapResult;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): MapResult;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): MapResult;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): MapResult;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): MapResult;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): MapResult;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): MapResult;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): MapResult;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): MapResult;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): MapResult;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): MapResult;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): MapResult;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): MapResult;
   ...
   * @see #unsetField
   */
  defaultField(field: string): MapResult;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): MapResult;
   ...
   * @see #removeField
   */
  unsetField(field: string): MapResult;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): MapResult;
   ...
   * @see #unsetField
   */
  removeField(field: string): MapResult;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): MapResult;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): MapResult;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): MapResult;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): MapResult;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): MapResult;

  mergeJson(json: any | null): MapResult;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): MapResult;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): MapResult;
   ...
   */
  singletonArray(): C3.Array<MapResult | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<MapResult | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<MapResult | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<MapResult | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<MapResult | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, MapResult | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, MapResult | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<MapResult | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<MapResult | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): MapResult;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): MapResult;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): MapResult;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): MapResult;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): MapResult;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): MapResult;
   ...
   * @see #fromString
   */
  static make(s: string | null): MapResult | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): MapResult;
   ...
   */
  static cachedEmptyInst(): MapResult;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<MapResult>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): MapResult;
   ...
   */
  static partition(objs?: Stream<MapResult | null>, spec?: PartitionBucketStrategy | null): C3.Map<string | null, KvDataPartition | null>;
   ...
   */
  static fromPartitions(partitions?: Stream<KvDataPartition | null>): Stream<MapResult | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<MapResult | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<MapResult | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<MapResult | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<MapResult | null> | null>;
   ...
   */
  get(include?: string | null): MapResult | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): MapResult | null;
   ...
   */
  getMissing(spec: GetMissingSpec): MapResult;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): MapResult | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): MapResult;
   ...
   * @see #toString
   */
  static fromString(s: string | null): MapResult | null;
   ...
   */
  create(spec?: UpsertSpec | null): MapResult | null;
   ...
   */
  static createBatch(objs: C3.Array<MapResult | null> | null, spec?: UpsertSpec | null): ObjList<MapResult | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<MapResult | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<MapResult | null> | null;
   ...
   */
  update(srcObj?: MapResult | null, spec?: UpsertSpec | null): MapResult | null;
   ...
   */
  upsert(srcObj?: MapResult | null, spec?: UpsertSpec | null): MapResult | null;
   ...
   */
  merge(spec?: MergeSpec | null): MapResult | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): MapResult | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): MapResult | null;
   ...
   */
  static updateBatch(objs: C3.Array<MapResult | null> | null, srcObjs?: C3.Array<MapResult | null>, spec?: UpsertSpec | null): ObjList<MapResult | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<MapResult | null>>, spec?: UpsertSpec | null): ObjList<MapResult | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<MapResult | null> | null, srcObjs?: C3.Array<MapResult | null>, spec?: UpsertSpec | null): ObjList<MapResult | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<MapResult | null>>, spec?: UpsertSpec | null): ObjList<MapResult | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<MapResult | null> | null, spec?: TouchSpec | null): ObjList<MapResult | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<MapResult | null> | null, spec?: MergeSpec | null): ObjList<MapResult | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<MapResult | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<MapResult | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<MapResult | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<MapResult | null> | null;
   ...
   */
  static mergeAll(mergeObj: MapResult | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: MapResult | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<MapResult | null> | null, spec?: UpsertSpec | null): ObjList<MapResult | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<MapResult | null> | null, spec?: UpsertSpec | null): ObjList<MapResult | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<MapResult | null> | null): ObjList<MapResult | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<MapResult | null> | null): ObjList<MapResult | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<MapResult | null> | null): ObjList<MapResult | null>;
   ...
   */
  static afterCreate(objs: C3.Array<MapResult | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<MapResult | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<MapResult | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<MapResult | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<MapResult | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): MapResult | null;
   ...
   */
  withoutIdentity(): MapResult | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<MapResult | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: MapResult | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<MapResult | null> | null, callback?: λFunction<MapResult | null, MapResult | null> | null): ObjList<MapResult | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<MapResult | null> | null, callback?: λFunction<MapResult | null, MapResult | null> | null): C3.Array<ObjError | null>;
