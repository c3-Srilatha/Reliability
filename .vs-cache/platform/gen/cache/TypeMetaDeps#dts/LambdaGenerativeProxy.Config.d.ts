// TypeScript definitions for the C3 type LambdaGenerativeProxy.Config

/**
 * Configuration for a {@link LambdaGenerativeProxy}.
 *
 * @remarks this represents a value passed to a method that expects an instance of LambdaGenerativeProxy.Config
 */
declare namespace LambdaGenerativeProxy {
  export interface IConfig {
     ...
     */
    _lambda: λFunction<GenerativeProxy.CompletionSpec, IGenerativeProxy.Completion>;
  }
}
...
declare namespace LambdaGenerativeProxy {
  export class Config extends Obj {
    ...
    withConfigOverride(configOverride: string | null): LambdaGenerativeProxy.Config;

    readonly secretOverride?: string | null;
    withSecretOverride(secretOverride: string | null): LambdaGenerativeProxy.Config;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: C3.Array<string | null>;
    withIssues(issues: C3.Array<string | null> | Array<string | null>): LambdaGenerativeProxy.Config;

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): LambdaGenerativeProxy.Config;

    /**
     * Lambda that implements the {@link GenerativeProxy#completion} method.
     */
    readonly _lambda: λFunction<GenerativeProxy.CompletionSpec, GenerativeProxy.Completion>;
    with_lambda(_lambda: λFunction<GenerativeProxy.CompletionSpec, IGenerativeProxy.Completion>): LambdaGenerativeProxy.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): LambdaGenerativeProxy.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): LambdaGenerativeProxy.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): LambdaGenerativeProxy.Config | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): LambdaGenerativeProxy.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): LambdaGenerativeProxy.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LambdaGenerativeProxy.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LambdaGenerativeProxy.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LambdaGenerativeProxy.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LambdaGenerativeProxy.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LambdaGenerativeProxy.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LambdaGenerativeProxy.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LambdaGenerativeProxy.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): LambdaGenerativeProxy.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): LambdaGenerativeProxy.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): LambdaGenerativeProxy.Config;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LambdaGenerativeProxy.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LambdaGenerativeProxy.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): LambdaGenerativeProxy.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): LambdaGenerativeProxy.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): LambdaGenerativeProxy.Config;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): LambdaGenerativeProxy.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LambdaGenerativeProxy.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): LambdaGenerativeProxy.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LambdaGenerativeProxy.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): LambdaGenerativeProxy.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): LambdaGenerativeProxy.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): LambdaGenerativeProxy.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): LambdaGenerativeProxy.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): LambdaGenerativeProxy.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): LambdaGenerativeProxy.Config;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LambdaGenerativeProxy.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): LambdaGenerativeProxy.Config;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LambdaGenerativeProxy.Config;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LambdaGenerativeProxy.Config;

    mergeJson(json: any | null): LambdaGenerativeProxy.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LambdaGenerativeProxy.Config;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): LambdaGenerativeProxy.Config;
     ...
     */
    singletonArray(): C3.Array<LambdaGenerativeProxy.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<LambdaGenerativeProxy.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<LambdaGenerativeProxy.Config | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<LambdaGenerativeProxy.Config | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<LambdaGenerativeProxy.Config | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, LambdaGenerativeProxy.Config | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, LambdaGenerativeProxy.Config | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<LambdaGenerativeProxy.Config | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<LambdaGenerativeProxy.Config | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LambdaGenerativeProxy.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LambdaGenerativeProxy.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LambdaGenerativeProxy.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): LambdaGenerativeProxy.Config;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LambdaGenerativeProxy.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): LambdaGenerativeProxy.Config;
     ...
     * @see #fromString
     */
    static make(s: string | null): LambdaGenerativeProxy.Config | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LambdaGenerativeProxy.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): LambdaGenerativeProxy.Config;
     ...
     */
    static cachedEmptyInst(): LambdaGenerativeProxy.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LambdaGenerativeProxy.Config>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): LambdaGenerativeProxy.Config;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<LambdaGenerativeProxy.Config | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<LambdaGenerativeProxy.Config | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<LambdaGenerativeProxy.Config | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): LambdaGenerativeProxy.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string | null): LambdaGenerativeProxy.Config | null;
     ...
     * @see findByCacheKey
     */
    getCached(): LambdaGenerativeProxy.Config | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): LambdaGenerativeProxy.Config | null;
     ...
     */
    static produce(key: string): LambdaGenerativeProxy.Config | null;
     ...
     */
    static produceAll(): C3.Map<string | null, LambdaGenerativeProxy.Config | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, LambdaGenerativeProxy.Config | null>;
     ...
     */
    getConfig(): LambdaGenerativeProxy.Config;
     ...
     */
    getSecret(): LambdaGenerativeProxy.Config;
     ...
     */
    static forConfigKey(configKey: string | null): LambdaGenerativeProxy.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<LambdaGenerativeProxy.Config | null>;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: LambdaGenerativeProxy.Config, override?: string | null): void;
     ...
     * @see setSecretValue
     */
    setSecretValues(from: LambdaGenerativeProxy.Config, override?: string | null): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): LambdaGenerativeProxy.Config | null;
     ...
     * @see #toString
     */
    static fromString(s: string | null): LambdaGenerativeProxy.Config | null;

    /**
     * Finds {@link GenerativeProxy.Config config} by name.
     */
    static forName(name: string | null, failIfMissing?: boolean): LambdaGenerativeProxy.Config | null;
