// TypeScript definitions for the C3 type CronJob

/**
 * CronJob allows repetitive actions to be scheduled at a given date/time similar to Unix Cron.
 *
 * @remarks this represents a value passed to a method that expects an instance of CronJob
 */
declare interface ICronJob {
   ...
   */
  inputs?: C3.Map<string | null, any> | {[key: string | null]: any};
   ...
   */
  scheduleDef?: ICronSchedule | null;
   ...
   */
  history?: C3.Array<JobHistory | null> | Array<IJobHistory | null>;

  completed?: C3.Array<JobHistory | null> | Array<IJobHistory | null>;
 ...
 * CronJob allows repetitive actions to be scheduled at a given date/time similar to Unix Cron.
 *
 * @remarks this represents a made instance of CronJob
 */
declare class CronJob extends Obj {
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): CronJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): CronJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): CronJob;
  ...
  withVersion(version: number | null): CronJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): CronJob;
  ...
  withUserUpdatedFields(userUpdatedFields: C3.Array<string | null> | Array<string | null>): CronJob;
  ...
  withHidden(hidden: boolean): CronJob;
  ...
  withUserOwned(userOwned: boolean): CronJob;

  readonly description?: string | null;
  withDescription(description: string | null): CronJob;

  /**
   * a user-defined variable that may be used for correlation
   */
  readonly correlationKey?: string | null;
  withCorrelationKey(correlationKey: string | null): CronJob;

  readonly action: ActionRef;
  withAction(action: IActionRef): CronJob;

  /**
   * Input arguments to call the function with
   */
  readonly inputs?: C3.Map<string | null, any>;
  withInputs(inputs: C3.Map<string | null, any> | {[key: string | null]: any}): CronJob;
  ...
  withConcurrent(concurrent: boolean): CronJob;

  /**
   * The schedule of when it will run. This is read by the CronEngine, and items
   * are added to the CronQueue then run when the next scheduled time/date is reached.
   */
  readonly scheduleDef?: CronSchedule | null;
  withScheduleDef(scheduleDef: ICronSchedule | null): CronJob;

  /**
   * If true, the job will be only run on a leader node (i.e. no task nodes will be required for job to run).
   */
  readonly runOnLeader?: boolean;
  withRunOnLeader(runOnLeader: boolean): CronJob;
  ...
  withInactive(inactive: boolean): CronJob;
  ...
  withNoHistory(noHistory: boolean): CronJob;

  /**
   * If {@link noHistory} is false, the history of each invocation of the cron job from the CronQueue.  If true, then
   * only the history for the last invocation.
   */
  readonly history?: C3.Array<JobHistory | null>;
  withHistory(history: C3.Array<JobHistory | null> | Array<IJobHistory | null>): CronJob;

  readonly completed?: C3.Array<JobHistory | null>;
  withCompleted(completed: C3.Array<JobHistory | null> | Array<IJobHistory | null>): CronJob;
   ...
   * 2. Only the creator, root or cluster admin can modify the runAsCreatedBy field
   */
  readonly runAsCreatedBy?: boolean;
  withRunAsCreatedBy(runAsCreatedBy: boolean): CronJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): CronJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): CronJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): CronJob | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): CronJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): CronJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): CronJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): CronJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<CronJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<CronJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): CronJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CronJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CronJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): CronJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): CronJob;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): CronJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): CronJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): CronJob;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): CronJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): CronJob;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): CronJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): CronJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): CronJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): CronJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): CronJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): CronJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): CronJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): CronJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): CronJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): CronJob;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): CronJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): CronJob;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): CronJob;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): CronJob;

  mergeJson(json: any | null): CronJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): CronJob;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): CronJob;
   ...
   */
  singletonArray(): C3.Array<CronJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<CronJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<CronJob | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<CronJob | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<CronJob | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, CronJob | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, CronJob | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<CronJob | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<CronJob | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): CronJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): CronJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): CronJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): CronJob;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): CronJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): CronJob;
   ...
   * @see #fromString
   */
  static make(s: string | null): CronJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): CronJob;
   ...
   */
  static cachedEmptyInst(): CronJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<CronJob>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): CronJob;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<CronJob | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<CronJob | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<CronJob | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): CronJob | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string | null): CronJob | null;
   ...
   * @see findByCacheKey
   */
  getCached(): CronJob | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): CronJob | null;
   ...
   */
  static produce(key: string): CronJob | null;
   ...
   */
  static produceAll(): C3.Map<string | null, CronJob | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, CronJob | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<CronJob | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<CronJob | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<CronJob | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<CronJob | null> | null>;
   ...
   */
  get(include?: string | null): CronJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): CronJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): CronJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): CronJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): CronJob;
   ...
   * @see #toString
   */
  static fromString(s: string | null): CronJob | null;
   ...
   */
  create(spec?: UpsertSpec | null): CronJob | null;
   ...
   */
  static createBatch(objs: C3.Array<CronJob | null> | null, spec?: UpsertSpec | null): ObjList<CronJob | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<CronJob | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<CronJob | null> | null;
   ...
   */
  update(srcObj?: CronJob | null, spec?: UpsertSpec | null): CronJob | null;
   ...
   */
  upsert(srcObj?: CronJob | null, spec?: UpsertSpec | null): CronJob | null;
   ...
   */
  merge(spec?: MergeSpec | null): CronJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): CronJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): CronJob | null;
   ...
   */
  static updateBatch(objs: C3.Array<CronJob | null> | null, srcObjs?: C3.Array<CronJob | null>, spec?: UpsertSpec | null): ObjList<CronJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<CronJob | null>>, spec?: UpsertSpec | null): ObjList<CronJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<CronJob | null> | null, srcObjs?: C3.Array<CronJob | null>, spec?: UpsertSpec | null): ObjList<CronJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<CronJob | null>>, spec?: UpsertSpec | null): ObjList<CronJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<CronJob | null> | null, spec?: TouchSpec | null): ObjList<CronJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<CronJob | null> | null, spec?: MergeSpec | null): ObjList<CronJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<CronJob | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<CronJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<CronJob | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<CronJob | null> | null;
   ...
   */
  static mergeAll(mergeObj: CronJob | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: CronJob | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<CronJob | null> | null, spec?: UpsertSpec | null): ObjList<CronJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<CronJob | null> | null, spec?: UpsertSpec | null): ObjList<CronJob | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<CronJob | null> | null): ObjList<CronJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<CronJob | null> | null): ObjList<CronJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<CronJob | null> | null): ObjList<CronJob | null>;
   ...
   */
  static afterCreate(objs: C3.Array<CronJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<CronJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<CronJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<CronJob | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<CronJob | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): CronJob | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<CronJob | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: CronJob | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<CronJob | null> | null, callback?: λFunction<CronJob | null, CronJob | null> | null): ObjList<CronJob | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<CronJob | null> | null, callback?: λFunction<CronJob | null, CronJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  publish(subPath?: string | null, contentType?: string | null): CronJob;
   ...
   */
  static removeSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<CronJob | null> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec | null): CronJob | null;
   ...
   */
  static createSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<CronJob | null> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData | null, spec?: UpsertSpec | null): CronJob | null;
   ...
   */
  static updateSeedDataBatch(objs?: C3.Array<SeedData | null>, srcObjs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<CronJob | null> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec | null): CronJob | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: C3.Array<SeedData | null>, spec?: MergeSpec | null): ObjList<CronJob | null> | null;
  ...
  dependencies(): SeedDataDeps<CronJob | null> | null;
   ...
   */
  schedule(schedule: CronSchedule): CronJob;
   ...
   */
  executionSchedule(limit?: number | null): C3.Array<DateTime | null>;
   ...
   */
  static executionInfo(): C3.Array<CronExecutionInfo | null>;
   ...
   */
  lastRun(failIfMissing?: boolean): JobHistory | null;
   ...
   */
  lastRuns(count?: number | null): C3.Array<JobHistory | null>;
   ...
   * @return the last {@link JobHistory} entry for the job.
   */
  lastError(failIfMissing?: boolean): JobHistory | null;
   ...
   */
  lastErrors(count?: number | null): C3.Array<JobHistory | null>;
   ...
   */
  validate(numExecutions?: number | null): CronValidation | null;
   ...
   */
  makeQueueEntryInInitial(isFirstTriggerTime?: boolean): CronQueueEntry;
}
