// TypeScript definitions for the C3 type HBaseConnectionConfig

/**
 * Configuration to make hbase point to a remote hbase cluster. There can be multiple instances of
 * HBaseConnectionConfig. Note that zkPort, zkHost, zkParentNode are required for establishing a basic connection to
 * HBase nodes. However, if you need to connect to a Kerberized HBase cluster, please setup additional configs through
 * {@link HadoopSpec}.
 *
 * Here're some common configurations that used in HBase for security related settings:
 * * hadoop.security.authentication: simple/kerberos
 * * hbase.security.authentication: simple/kerberos
 * * hbase.master.kerberos.principal
 * * hbase.regionserver.kerberos.principal
 * * hbase.client.retries.number: setup max retryable times to get in-general faster connection.
 *
 * An overview of the full HBase configurations can be found here at
 * [Apache HBase](https://github.com/apache/hbase/blob/master/hbase-common/src/main/resources/hbase-default.xml).
 *
 * @remarks this represents a value passed to a method that expects an instance of HBaseConnectionConfig
 */
declare interface IHBaseConnectionConfig {
  ...
  /**
   * hbase.zookeeper.property.clientPort configuration for hbase
   */
  zkPort: number;

  /**
   * hbase.zookeeper.quorum configuration for hbase
   */
  zkHost: string;

  /**
   * zookeeper.znode.parent configuration for hbase
   */
  zkParentNode: string;
}
 ...
 * [Apache HBase](https://github.com/apache/hbase/blob/master/hbase-common/src/main/resources/hbase-default.xml).
 *
 * @remarks this represents a made instance of HBaseConnectionConfig
 */
declare class HBaseConnectionConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): HBaseConnectionConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): HBaseConnectionConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): HBaseConnectionConfig;

  /**
   * The unique and required name of this instance.
   */
  readonly name: string;
  withName(name: string): HBaseConnectionConfig;

  /**
   * Physical pool for connections
   */
  readonly connectionPool?: DatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null;
  withConnectionPool(connectionPool: IDatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null): HBaseConnectionConfig;
  ...
  withCredentials(credentials: IKvStore.Credentials | null): HBaseConnectionConfig;

  /**
   * C3 Cloud Identifier for backing infrastructure that hosts the Datastore ex: {@link PostgresDb#id}, {@link CassandraDb#id}
   */
  readonly cloudId?: string | null;
  withCloudId(cloudId: string | null): HBaseConnectionConfig;

  /**
   * True if the datastore is disabled (e.g. no data access is permitted).
   */
  readonly disabled?: boolean;
  withDisabled(disabled: boolean): HBaseConnectionConfig;

  /**
   * True if the datastore is read only, i.e. can only be queried.
   */
  readonly readOnly?: boolean;
  withReadOnly(readOnly: boolean): HBaseConnectionConfig;

  /**
   * True if the datastore is external, i.e. its database schema can not be altered.
   */
  readonly external?: boolean;
  withExternal(external: boolean): HBaseConnectionConfig;
  ...
  withPerTenant(perTenant: boolean): HBaseConnectionConfig;

  /**
   * Description for the dataStore.
   */
  readonly description?: string | null;
  withDescription(description: string | null): HBaseConnectionConfig;

  /**
   * True if the db is shared with other apps or it is dedicated.
   */
  readonly dedicated?: boolean;
  withDedicated(dedicated: boolean): HBaseConnectionConfig;

  readonly shareReadConnection?: boolean;
  withShareReadConnection(shareReadConnection: boolean): HBaseConnectionConfig;

  readonly sharedReadThreshold: number;
  withSharedReadThreshold(sharedReadThreshold: number): HBaseConnectionConfig;

  readonly readConnectionPool?: DatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null;
  withReadConnectionPool(readConnectionPool: IDatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null): HBaseConnectionConfig;

  readonly writeConnectionPool?: DatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null;
  withWriteConnectionPool(writeConnectionPool: IDatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null): HBaseConnectionConfig;
  ...
  withNewColReadCount(newColReadCount: number | null): HBaseConnectionConfig;
  ...
  withNewColMaxObjCount(newColMaxObjCount: number | null): HBaseConnectionConfig;
  ...
  withRewriteAllIncremental(rewriteAllIncremental: boolean): HBaseConnectionConfig;

  /**
   * Kv store kind for which this config is provided
   */
  readonly kvstore?: Type | null;
  withKvstore(kvstore: IType | null): HBaseConnectionConfig;
  ...
  withFillBucketsProbabilityOnRead(fillBucketsProbabilityOnRead: number | null): HBaseConnectionConfig;
  ...
  withFillBucketsProbabilityOnWrite(fillBucketsProbabilityOnWrite: number | null): HBaseConnectionConfig;
  ...
  withFillBucketsPartitionKeyPercentageOnWrite(fillBucketsPartitionKeyPercentageOnWrite: number | null): HBaseConnectionConfig;
  ...
  withRangeDeleteTimeDriftInSec(rangeDeleteTimeDriftInSec: number | null): HBaseConnectionConfig;
  ...
  withMultiBinningWriteTimeInterval(multiBinningWriteTimeInterval: string | null): HBaseConnectionConfig;
  ...
  withPluginId(pluginId: string | null): HBaseConnectionConfig;

  /**
   * The base directory for this plugin. This directory is always on the local file system.
   */
  readonly pluginDir?: string | null;
  withPluginDir(pluginDir: string | null): HBaseConnectionConfig;

  /**
   * During dev, this boolean property will be true.
   */
  readonly isDevPlugin?: boolean;
  withIsDevPlugin(isDevPlugin: boolean): HBaseConnectionConfig;
  ...
  withPluginPaths(pluginPaths: C3.Array<string | null> | Array<string | null>): HBaseConnectionConfig;

  /**
   * hbase.zookeeper.property.clientPort configuration for hbase
   */
  readonly zkPort: number;
  withZkPort(zkPort: number): HBaseConnectionConfig;

  /**
   * hbase.zookeeper.quorum configuration for hbase
   */
  readonly zkHost: string;
  withZkHost(zkHost: string): HBaseConnectionConfig;

  /**
   * zookeeper.znode.parent configuration for hbase
   */
  readonly zkParentNode: string;
  withZkParentNode(zkParentNode: string): HBaseConnectionConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): HBaseConnectionConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): HBaseConnectionConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): HBaseConnectionConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): HBaseConnectionConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): HBaseConnectionConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HBaseConnectionConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HBaseConnectionConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HBaseConnectionConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HBaseConnectionConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): HBaseConnectionConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HBaseConnectionConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HBaseConnectionConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): HBaseConnectionConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): HBaseConnectionConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): HBaseConnectionConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): HBaseConnectionConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): HBaseConnectionConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): HBaseConnectionConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): HBaseConnectionConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): HBaseConnectionConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): HBaseConnectionConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): HBaseConnectionConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): HBaseConnectionConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): HBaseConnectionConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): HBaseConnectionConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): HBaseConnectionConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): HBaseConnectionConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): HBaseConnectionConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): HBaseConnectionConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): HBaseConnectionConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): HBaseConnectionConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): HBaseConnectionConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): HBaseConnectionConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): HBaseConnectionConfig;

  mergeJson(json: any | null): HBaseConnectionConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): HBaseConnectionConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): HBaseConnectionConfig;
   ...
   */
  singletonArray(): C3.Array<HBaseConnectionConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<HBaseConnectionConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<HBaseConnectionConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<HBaseConnectionConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<HBaseConnectionConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, HBaseConnectionConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, HBaseConnectionConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<HBaseConnectionConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<HBaseConnectionConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): HBaseConnectionConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): HBaseConnectionConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): HBaseConnectionConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): HBaseConnectionConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): HBaseConnectionConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): HBaseConnectionConfig;
   ...
   * @see #fromString
   */
  static make(s: string | null): HBaseConnectionConfig | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): HBaseConnectionConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): HBaseConnectionConfig;
   ...
   */
  static cachedEmptyInst(): HBaseConnectionConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<HBaseConnectionConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): HBaseConnectionConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<HBaseConnectionConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<HBaseConnectionConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<HBaseConnectionConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): HBaseConnectionConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): HBaseConnectionConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): HBaseConnectionConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): HBaseConnectionConfig | null;
   ...
   */
  static produce(key: string): HBaseConnectionConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, HBaseConnectionConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, HBaseConnectionConfig | null>;
   ...
   */
  getConfig(): HBaseConnectionConfig;
   ...
   */
  getSecret(): HBaseConnectionConfig;
   ...
   */
  static forConfigKey(configKey: string | null): HBaseConnectionConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<HBaseConnectionConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: HBaseConnectionConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: HBaseConnectionConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): HBaseConnectionConfig | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): HBaseConnectionConfig | null;
   ...
   */
  static forName(name: string | null, failIfMissing?: boolean): HBaseConnectionConfig | null;
  ...
  static hadoopConfig(spec?: HBaseConnectionConfig | null): any;
