// TypeScript definitions for the C3 type DataErDiagramResult

/**
 * @remarks this represents a value passed to a method that expects an instance of DataErDiagramResult
 */
declare interface IDataErDiagramResult {
  ...
  statusUpdated?: DateTime | Date | string | null;
...
/**
 * @remarks this represents a made instance of DataErDiagramResult
 */
declare class DataErDiagramResult extends Obj {
   ...
   */
  readonly id: string;
  withId(id: string): DataErDiagramResult;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): DataErDiagramResult;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): DataErDiagramResult;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): DataErDiagramResult;
  ...
  withVersion(version: number | null): DataErDiagramResult;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): DataErDiagramResult;

  readonly status?: string | null;
  withStatus(status: string | null): DataErDiagramResult;

  readonly statusUpdated?: DateTime | null;
  withStatusUpdated(statusUpdated: DateTime | Date | string | null): DataErDiagramResult;

  readonly errorMsg?: string | null;
  withErrorMsg(errorMsg: string | null): DataErDiagramResult;

  readonly diagram?: string | null;
  withDiagram(diagram: string | null): DataErDiagramResult;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): DataErDiagramResult | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): DataErDiagramResult | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): DataErDiagramResult | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): DataErDiagramResult | null;
   ...
   */
  replaceType(old: Type, new_: Type): DataErDiagramResult;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataErDiagramResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataErDiagramResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataErDiagramResult | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataErDiagramResult | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataErDiagramResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataErDiagramResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataErDiagramResult;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DataErDiagramResult;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DataErDiagramResult;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DataErDiagramResult;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataErDiagramResult;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataErDiagramResult;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DataErDiagramResult;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): DataErDiagramResult;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): DataErDiagramResult;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): DataErDiagramResult;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataErDiagramResult;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DataErDiagramResult;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataErDiagramResult;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DataErDiagramResult;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DataErDiagramResult;
   ...
   * @see #removeField
   */
  unsetField(field: string): DataErDiagramResult;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DataErDiagramResult;
   ...
   * @see #unsetField
   */
  removeField(field: string): DataErDiagramResult;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DataErDiagramResult;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataErDiagramResult;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): DataErDiagramResult;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataErDiagramResult;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataErDiagramResult;

  mergeJson(json: any | null): DataErDiagramResult;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataErDiagramResult;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): DataErDiagramResult;
   ...
   */
  singletonArray(): C3.Array<DataErDiagramResult | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<DataErDiagramResult | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DataErDiagramResult | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<DataErDiagramResult | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DataErDiagramResult | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, DataErDiagramResult | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataErDiagramResult | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DataErDiagramResult | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DataErDiagramResult | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DataErDiagramResult;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DataErDiagramResult;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DataErDiagramResult;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DataErDiagramResult;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DataErDiagramResult;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DataErDiagramResult;
   ...
   * @see #fromString
   */
  static make(s: string | null): DataErDiagramResult | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DataErDiagramResult;
   ...
   */
  static cachedEmptyInst(): DataErDiagramResult;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DataErDiagramResult>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): DataErDiagramResult;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<DataErDiagramResult | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<DataErDiagramResult | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<DataErDiagramResult | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<DataErDiagramResult | null> | null>;
   ...
   */
  get(include?: string | null): DataErDiagramResult | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): DataErDiagramResult | null;
   ...
   */
  getMissing(spec: GetMissingSpec): DataErDiagramResult;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): DataErDiagramResult | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): DataErDiagramResult;
   ...
   * @see #toString
   */
  static fromString(s: string | null): DataErDiagramResult | null;
   ...
   */
  create(spec?: UpsertSpec | null): DataErDiagramResult | null;
   ...
   */
  static createBatch(objs: C3.Array<DataErDiagramResult | null> | null, spec?: UpsertSpec | null): ObjList<DataErDiagramResult | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<DataErDiagramResult | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<DataErDiagramResult | null> | null;
   ...
   */
  update(srcObj?: DataErDiagramResult | null, spec?: UpsertSpec | null): DataErDiagramResult | null;
   ...
   */
  upsert(srcObj?: DataErDiagramResult | null, spec?: UpsertSpec | null): DataErDiagramResult | null;
   ...
   */
  merge(spec?: MergeSpec | null): DataErDiagramResult | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): DataErDiagramResult | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): DataErDiagramResult | null;
   ...
   */
  static updateBatch(objs: C3.Array<DataErDiagramResult | null> | null, srcObjs?: C3.Array<DataErDiagramResult | null>, spec?: UpsertSpec | null): ObjList<DataErDiagramResult | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<DataErDiagramResult | null>>, spec?: UpsertSpec | null): ObjList<DataErDiagramResult | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<DataErDiagramResult | null> | null, srcObjs?: C3.Array<DataErDiagramResult | null>, spec?: UpsertSpec | null): ObjList<DataErDiagramResult | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<DataErDiagramResult | null>>, spec?: UpsertSpec | null): ObjList<DataErDiagramResult | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<DataErDiagramResult | null> | null, spec?: TouchSpec | null): ObjList<DataErDiagramResult | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<DataErDiagramResult | null> | null, spec?: MergeSpec | null): ObjList<DataErDiagramResult | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<DataErDiagramResult | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<DataErDiagramResult | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<DataErDiagramResult | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<DataErDiagramResult | null> | null;
   ...
   */
  static mergeAll(mergeObj: DataErDiagramResult | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: DataErDiagramResult | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<DataErDiagramResult | null> | null, spec?: UpsertSpec | null): ObjList<DataErDiagramResult | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<DataErDiagramResult | null> | null, spec?: UpsertSpec | null): ObjList<DataErDiagramResult | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): DataErDiagramResult | null;
   ...
   */
  static beforeCreate(objs: C3.Array<DataErDiagramResult | null> | null): ObjList<DataErDiagramResult | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<DataErDiagramResult | null> | null): ObjList<DataErDiagramResult | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<DataErDiagramResult | null> | null): ObjList<DataErDiagramResult | null>;
   ...
   */
  static afterCreate(objs: C3.Array<DataErDiagramResult | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<DataErDiagramResult | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<DataErDiagramResult | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<DataErDiagramResult | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<DataErDiagramResult | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): DataErDiagramResult | null;
   ...
   */
  withoutIdentity(): DataErDiagramResult | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<DataErDiagramResult | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: DataErDiagramResult | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<DataErDiagramResult | null> | null, callback?: λFunction<DataErDiagramResult | null, DataErDiagramResult | null> | null): ObjList<DataErDiagramResult | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<DataErDiagramResult | null> | null, callback?: λFunction<DataErDiagramResult | null, DataErDiagramResult | null> | null): C3.Array<ObjError | null>;
