// TypeScript definitions for the C3 type HierarchyDenormConfig

/**
 * Config for HierarchyDenorm type to tune different properties influencing the Hierarchy denormalization.
 *
 * @remarks this represents a value passed to a method that expects an instance of HierarchyDenormConfig
 */
declare interface IHierarchyDenormConfig {
  ...
  /**
   * Disable the Hierarchy De-normalization for the current type.
   */
  disabled?: boolean;

  /**
   * Specify the Invalidation batchsize for the hierarchy Denorm job
   */
  invalidationBatchSize?: number | null;

  /**
   * Max number node (with lineage) in memory per schedule batch for denormalization.
   * @see HierarchyDenormOption
   */
  scheduleBatchSize?: number | null;

  /**
   * Max number nodes allowed in a particular schedule batch for denormalization.
   *
   * @see HierarchyDenormOption
   */
  scheduleBatchWeight?: number | null;
}

/**
 * Config for HierarchyDenorm type to tune different properties influencing the Hierarchy denormalization.
 *
 * @remarks this represents a made instance of HierarchyDenormConfig
 */
declare class HierarchyDenormConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): HierarchyDenormConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): HierarchyDenormConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): HierarchyDenormConfig;

  /**
   * The id of this instance.
   */
  readonly id?: string | null;
  withId(id: string | null): HierarchyDenormConfig;

  /**
   * Disable the Hierarchy De-normalization for the current type.
   */
  readonly disabled?: boolean;
  withDisabled(disabled: boolean): HierarchyDenormConfig;

  /**
   * Specify the Invalidation batchsize for the hierarchy Denorm job
   */
  readonly invalidationBatchSize?: number | null;
  withInvalidationBatchSize(invalidationBatchSize: number | null): HierarchyDenormConfig;
  ...
  withScheduleBatchSize(scheduleBatchSize: number | null): HierarchyDenormConfig;
   ...
   * @see HierarchyDenormOption
   */
  readonly scheduleBatchWeight?: number | null;
  withScheduleBatchWeight(scheduleBatchWeight: number | null): HierarchyDenormConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): HierarchyDenormConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): HierarchyDenormConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): HierarchyDenormConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): HierarchyDenormConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): HierarchyDenormConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HierarchyDenormConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HierarchyDenormConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HierarchyDenormConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HierarchyDenormConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): HierarchyDenormConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HierarchyDenormConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HierarchyDenormConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): HierarchyDenormConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): HierarchyDenormConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): HierarchyDenormConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): HierarchyDenormConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): HierarchyDenormConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): HierarchyDenormConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): HierarchyDenormConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): HierarchyDenormConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): HierarchyDenormConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): HierarchyDenormConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): HierarchyDenormConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): HierarchyDenormConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): HierarchyDenormConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): HierarchyDenormConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): HierarchyDenormConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): HierarchyDenormConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): HierarchyDenormConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): HierarchyDenormConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): HierarchyDenormConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): HierarchyDenormConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): HierarchyDenormConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): HierarchyDenormConfig;

  mergeJson(json: any | null): HierarchyDenormConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): HierarchyDenormConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): HierarchyDenormConfig;
   ...
   */
  singletonArray(): C3.Array<HierarchyDenormConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<HierarchyDenormConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<HierarchyDenormConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<HierarchyDenormConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<HierarchyDenormConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, HierarchyDenormConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, HierarchyDenormConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<HierarchyDenormConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<HierarchyDenormConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): HierarchyDenormConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): HierarchyDenormConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): HierarchyDenormConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): HierarchyDenormConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): HierarchyDenormConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): HierarchyDenormConfig;
   ...
   * @see #fromString
   */
  static make(s: string | null): HierarchyDenormConfig | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): HierarchyDenormConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): HierarchyDenormConfig;
   ...
   */
  static cachedEmptyInst(): HierarchyDenormConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<HierarchyDenormConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): HierarchyDenormConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<HierarchyDenormConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<HierarchyDenormConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<HierarchyDenormConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): HierarchyDenormConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): HierarchyDenormConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): HierarchyDenormConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): HierarchyDenormConfig | null;
   ...
   */
  static produce(key: string): HierarchyDenormConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, HierarchyDenormConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, HierarchyDenormConfig | null>;
   ...
   */
  getConfig(): HierarchyDenormConfig;
   ...
   */
  getSecret(): HierarchyDenormConfig;
   ...
   */
  static forConfigKey(configKey: string | null): HierarchyDenormConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<HierarchyDenormConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: HierarchyDenormConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: HierarchyDenormConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): HierarchyDenormConfig | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): HierarchyDenormConfig | null;
}
