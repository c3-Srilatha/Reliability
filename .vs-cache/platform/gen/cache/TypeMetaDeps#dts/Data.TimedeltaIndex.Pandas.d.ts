// TypeScript definitions for the C3 type Data.TimedeltaIndex.Pandas

/**
 * C3 Interface to a {@link Data.TimedeltaIndex} backed by native pandas
 *
 * @remarks this represents a value passed to a method that expects an instance of Data.TimedeltaIndex.Pandas
 */
declare namespace Data.TimedeltaIndex {
...
declare namespace Data.TimedeltaIndex {
  export class Pandas extends Obj {
     ...
     */
    readonly ds: Dataset;
    withDs(ds: IDataset): Data.TimedeltaIndex.Pandas;

    /**
     * Id used to reference this Data within the Dataset to which it belongs
     */
    readonly id: string;
    withId(id: string): Data.TimedeltaIndex.Pandas;

    /**
     * PySrc that can be executed to re-create this DataImpl.Pandas
     */
    readonly _pySrc?: string | null;
    with_pySrc(_pySrc: string | null): Data.TimedeltaIndex.Pandas;

    readonly _fileName?: string | null;
    with_fileName(_fileName: string | null): Data.TimedeltaIndex.Pandas;

    /**
     * Tuple of {columnName:[value]} to create a DataImpl.Pandas from
     */
    readonly _tuple?: any;
    with_tuple(_tuple: any): Data.TimedeltaIndex.Pandas;

    /**
     * Whether the {@link #tuple} field value types can be fully supported by arrow.
     */
    readonly _arrowSupport?: boolean;
    with_arrowSupport(_arrowSupport: boolean): Data.TimedeltaIndex.Pandas;

    /**
     * All DataImpl.Pandas referenced by the pySrc
     */
    readonly _datas?: C3.Set<DataImpl.Pandas | null>;
    with_datas(_datas: C3.Set<DataImpl.Pandas | null> | Array<IDataImpl.Pandas | null>): Data.TimedeltaIndex.Pandas;

    /**
     * Pickled Pandas binary
     */
    readonly _binary?: any | null;
    with_binary(_binary: any | null): Data.TimedeltaIndex.Pandas;

    /**
     * List of pickled Pandas segments binaries
     */
    readonly _binaries?: C3.Array<any | null>;
    with_binaries(_binaries: C3.Array<any | null> | Array<any | null>): Data.TimedeltaIndex.Pandas;

    readonly _numBinarySegments?: number | null;
    with_numBinarySegments(_numBinarySegments: number | null): Data.TimedeltaIndex.Pandas;

    /**
     * Type of binary format for reading {@link Data.Persisted}
     */
    readonly _persistedFormat?: string | null;
    with_persistedFormat(_persistedFormat: string | null): Data.TimedeltaIndex.Pandas;

    /**
     * see tableName arg for {@link Feature.Store#readData}.
     */
    readonly _tableName?: string | null;
    with_tableName(_tableName: string | null): Data.TimedeltaIndex.Pandas;

    /**
     * see id arg for {@link Feature.Store#readData}.
     */
    readonly _tableEntryId?: string | null;
    with_tableEntryId(_tableEntryId: string | null): Data.TimedeltaIndex.Pandas;

    /**
     * Mapping of variable names to their values to be used by the PyAst Executor
     */
    readonly _vars?: C3.Map<string | null, any>;
    with_vars(_vars: C3.Map<string | null, any> | {[key: string | null]: any}): Data.TimedeltaIndex.Pandas;
    ...
    withMaxSegmentSizeClient(maxSegmentSizeClient: number | null): Data.TimedeltaIndex.Pandas;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.TimedeltaIndex.Pandas | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.TimedeltaIndex.Pandas | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.TimedeltaIndex.Pandas | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.TimedeltaIndex.Pandas | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.TimedeltaIndex.Pandas;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.TimedeltaIndex.Pandas;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.TimedeltaIndex.Pandas;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.TimedeltaIndex.Pandas | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.TimedeltaIndex.Pandas | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.TimedeltaIndex.Pandas;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.TimedeltaIndex.Pandas;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.TimedeltaIndex.Pandas;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.TimedeltaIndex.Pandas;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.TimedeltaIndex.Pandas;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.TimedeltaIndex.Pandas;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.TimedeltaIndex.Pandas;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.TimedeltaIndex.Pandas;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.TimedeltaIndex.Pandas;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.TimedeltaIndex.Pandas;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.TimedeltaIndex.Pandas;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.TimedeltaIndex.Pandas;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.TimedeltaIndex.Pandas;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.TimedeltaIndex.Pandas;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.TimedeltaIndex.Pandas;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.TimedeltaIndex.Pandas;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.TimedeltaIndex.Pandas;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.TimedeltaIndex.Pandas;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.TimedeltaIndex.Pandas;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.TimedeltaIndex.Pandas;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.TimedeltaIndex.Pandas;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.TimedeltaIndex.Pandas;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.TimedeltaIndex.Pandas;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.TimedeltaIndex.Pandas;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.TimedeltaIndex.Pandas;

    mergeJson(json: any | null): Data.TimedeltaIndex.Pandas;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.TimedeltaIndex.Pandas;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.TimedeltaIndex.Pandas;
     ...
     */
    singletonArray(): C3.Array<Data.TimedeltaIndex.Pandas | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.TimedeltaIndex.Pandas | null>;
     ...
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.TimedeltaIndex.Pandas | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.TimedeltaIndex.Pandas | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.TimedeltaIndex.Pandas | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.TimedeltaIndex.Pandas | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.TimedeltaIndex.Pandas | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.TimedeltaIndex.Pandas | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.TimedeltaIndex.Pandas | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.TimedeltaIndex.Pandas;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.TimedeltaIndex.Pandas;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.TimedeltaIndex.Pandas;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.TimedeltaIndex.Pandas;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.TimedeltaIndex.Pandas;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.TimedeltaIndex.Pandas;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.TimedeltaIndex.Pandas;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Data.TimedeltaIndex.Pandas;
     ...
     */
    static cachedEmptyInst(): Data.TimedeltaIndex.Pandas;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.TimedeltaIndex.Pandas>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.TimedeltaIndex.Pandas;
     ...
     */
    static fromPySrc(pySrc: string, dfs?: C3.Set<DataImpl | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): Data.TimedeltaIndex.Pandas | null;
     ...
     */
    static _jsDataProxy(inst: any): Data.TimedeltaIndex.Pandas;
     ...
     */
    static fromBinary(name: string, data: any, dataset?: Dataset | null): Data.TimedeltaIndex.Pandas | null;

    static fromBinary(name: string, data: C3.Array<any | null>, dataset?: Dataset | null): Data.TimedeltaIndex.Pandas | null;
     ...
     */
    static fromStore(name: string, tableName: string, tableEntryId: string, dataset?: Dataset | null, persistedFormat?: string | null): Data.TimedeltaIndex.Pandas | null;

    /**
     * Create an instance of DataImpl.Pandas with the provided name from a pandas binary
     */
    static fromName(name: string, binary: any, dataset?: Dataset | null): Data.TimedeltaIndex.Pandas | null;

    /**
     * Create an instance of DataImpl.Pandas with the provided name and pySrc
     */
    static fromName(name: string, pySrc: string, datas?: C3.Set<DataImpl.Pandas | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): Data.TimedeltaIndex.Pandas | null;
     ...
     */
    static fromDatasetBinaries(name: string, dataset?: Dataset | null): Data.TimedeltaIndex.Pandas | null;

    /**
     * Create an instance of DataImpl.Pandas with the provided name from a pickled binary file specified by fileName
     */
    static fromBinaryFile(name: string, fileName: string, dataset?: Dataset | null): Data.TimedeltaIndex.Pandas | null;

    /**
     * Create a new DataImpl.Pandas from a PyAST visitor context.
     * see @DataToPyAstVisitorCtx
     */
    static fromDataToPyAstVisitorCtx(ctx: DataToPyAstVisitorCtx, dataset?: Dataset | null): Data.TimedeltaIndex.Pandas | null;
     ...
     */
    static dispatch(pandas: Data.TimedeltaIndex.Pandas, name: string, args?: C3.Array<any>, kwargs?: C3.Map<string | null, any>, doNotConvertData?: boolean): any;
     ...
     *         The native pandas value will be converted to the corresponding {@link DataImpl.Pandas} subtype
     */
    static getAttribute(pandas: Data.TimedeltaIndex.Pandas, name: string, doNotConvertData?: boolean): any;
     ...
     */
    static evaluate(pandas: Data.TimedeltaIndex.Pandas): void;
     ...
     */
    static toBinary(pandas: Data.TimedeltaIndex.Pandas): any | null;
     ...
     */
    static storeBinariesInDataset(pandas: Data.TimedeltaIndex.Pandas): void;
    ...
    get T(): Data.TimedeltaIndex | null;
    ...
    drop_duplicates(keep?: any): Data.TimedeltaIndex | null;

    droplevel(level?: any): Data.Index | null | Data.MultiIndex | null | null;

    dropna(how?: any): Data.TimedeltaIndex | null;
    ...
    get_loc(key?: any, method?: any, tolerance?: any): C3.Array<any> | null;
    ...
    rename(name?: any, inplace?: any): Data.TimedeltaIndex | null;

    repeat(repeats?: any, axis?: any): any;

    searchsorted(value?: any, side?: any, sorter?: any): any;

    set_names(names?: any, level?: any, inplace?: any): Data.TimedeltaIndex | null;

    set_value(arr?: any, key?: any, value?: any): any;

    shift(periods?: any, freq?: any): Data.TimedeltaIndex | null;
    ...
    transpose(): Data.TimedeltaIndex | null;
    ...
    get components(): Data | null;

    get days(): any;

    get microseconds(): any;

    get nanoseconds(): any;

    get seconds(): any;

    ceil(): Data.TimedeltaIndex | null;

    ceil(freq?: any, ambiguous?: any, nonexistent?: any): Data.TimedeltaIndex | null | Data.Series | null | null;

    floor(): Data.TimedeltaIndex | null;

    floor(freq?: any, ambiguous?: any, nonexistent?: any): Data.TimedeltaIndex | null | Data.Series | null | null;

    median(): any;

    round(): Data.TimedeltaIndex | null;

    round(freq?: any, ambiguous?: any, nonexistent?: any): Data.TimedeltaIndex | null | Data.Series | null | null;

    std(): any;

    sum(): any;

    to_pytimedelta(): C3.Array<any> | null;

    total_seconds(): Data.Series | null | Data.Float64Index | null | null;
