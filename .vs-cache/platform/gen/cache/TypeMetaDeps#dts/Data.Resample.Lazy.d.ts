// TypeScript definitions for the C3 type Data.Resample.Lazy

/**
 * @remarks this represents a value passed to a method that expects an instance of Data.Resample.Lazy
 */
declare namespace Data.Resample {
...
declare namespace Data.Resample {
  export class Lazy extends Obj {
    ...
    withSTATELESS_CACHE(STATELESS_CACHE: string | null): Data.Resample.Lazy;
     ...
     */
    readonly this: any;
    withThis(this_: any): Data.Resample.Lazy;

    /**
     * Target action returning DataImpl
     */
    readonly action: string;
    withAction(action: string): Data.Resample.Lazy;

    /**
     * Applied arguments
     */
    readonly args?: C3.Map<string | null, any>;
    withArgs(args: C3.Map<string | null, any> | {[key: string | null]: any}): Data.Resample.Lazy;
    ...
    with_inferredOutType(_inferredOutType: C3.Map<string | null, ValueType | null> | {[key: string | null]: IValueType | null}): Data.Resample.Lazy;
    ...
    agg(func?: any): Data | null;

    aggregate(func?: any): Data | null;

    apply(func?: any): Data | null;

    asfreq(fill_value?: any): Data | null;

    backfill(limit?: number | null): Data | null;

    bfill(limit?: number | null): Data | null;

    count(): Data | null;

    ffill(limit?: number | null): Data | null;

    fillna(method?: any, limit?: any): Data | null;

    first(_method?: any, min_count?: any): Data | null;

    get_group(name?: any, obj?: any): Data | null;

    interpolate(method?: any, axis?: any, limit?: any, inplace?: any, limit_direction?: any, limit_area?: any, downcast?: any): Data | null;

    last(_method?: any, min_count?: any): Data | null;

    max(_method?: any, min_count?: any): Data | null;

    mean(_method?: any): Data | null;

    median(_method?: any): Data | null;

    min(_method?: any, min_count?: any): Data | null;

    nearest(limit?: number | null): Data | null;

    nunique(_method?: any): Data | null;

    ohlc(_method?: any): Data | null;

    pad(limit?: number | null): Data | null;

    prod(_method?: any, min_count?: any): Data | null;

    quantile(q?: any): Data | null;

    sem(_method?: any): Data | null;

    size(): Data.Series | null;

    std(ddof?: any): Data | null;

    sum(_method?: any, min_count?: any): Data | null;

    transform(arg?: any): Data.Series | null;

    var(ddof?: any): Data | null;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.Resample.Lazy | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.Resample.Lazy | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.Resample.Lazy | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.Resample.Lazy | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.Resample.Lazy;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Resample.Lazy;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Resample.Lazy;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Resample.Lazy | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Resample.Lazy | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.Resample.Lazy;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Resample.Lazy;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Resample.Lazy;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.Resample.Lazy;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.Resample.Lazy;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.Resample.Lazy;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.Resample.Lazy;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.Resample.Lazy;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.Resample.Lazy;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.Resample.Lazy;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.Resample.Lazy;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.Resample.Lazy;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.Resample.Lazy;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.Resample.Lazy;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.Resample.Lazy;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.Resample.Lazy;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.Resample.Lazy;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.Resample.Lazy;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.Resample.Lazy;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.Resample.Lazy;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.Resample.Lazy;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.Resample.Lazy;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.Resample.Lazy;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.Resample.Lazy;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.Resample.Lazy;

    mergeJson(json: any | null): Data.Resample.Lazy;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.Resample.Lazy;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.Resample.Lazy;
     ...
     */
    singletonArray(): C3.Array<Data.Resample.Lazy | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.Resample.Lazy | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.Resample.Lazy | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.Resample.Lazy | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.Resample.Lazy | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.Resample.Lazy | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.Resample.Lazy | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.Resample.Lazy | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.Resample.Lazy | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.Resample.Lazy;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.Resample.Lazy;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.Resample.Lazy;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.Resample.Lazy;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.Resample.Lazy;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.Resample.Lazy;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.Resample.Lazy;
     ...
     */
    static cachedEmptyInst(): Data.Resample.Lazy;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.Resample.Lazy>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.Resample.Lazy;
     ...
     */
    static fromPySrc(pySrc: string, dfs?: C3.Set<DataImpl | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): Data.Resample.Lazy | null;
     ...
     */
    static _jsDataProxy(inst: any): Data.Resample.Lazy;
     ...
     */
    static create(this_: any, action: string, args?: C3.Map<string | null, any>): Data.Resample.Lazy;
