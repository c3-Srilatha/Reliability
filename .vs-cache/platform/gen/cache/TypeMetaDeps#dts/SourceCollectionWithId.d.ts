// TypeScript definitions for the C3 type SourceCollectionWithId

/**
 * Nested Component of UiSdlDataGrid requires each row to have id. This type
 * contains all the fields of FileSourceCollection with an Id.
 *
 * @remarks this represents a value passed to a method that expects an instance of SourceCollectionWithId
 */
declare interface ISourceCollectionWithId {
 ...
 * contains all the fields of FileSourceCollection with an Id.
 *
 * @remarks this represents a made instance of SourceCollectionWithId
 */
declare class SourceCollectionWithId extends Obj {

  /**
   * The description of this instance.
   */
  readonly description?: string | null;
  withDescription(description: string | null): SourceCollectionWithId;
  ...
  withCdcOrder(cdcOrder: string | null): SourceCollectionWithId;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): SourceCollectionWithId;

  /**
   * The unique and required name of this instance.
   */
  readonly name: string;
  withName(name: string): SourceCollectionWithId;

  /**
   * Structure defined to serialize the content from the SourceCollection {@see Source}
   */
  readonly source?: Type | null;
  withSource(source: IType | null): SourceCollectionWithId;

  /**
   * Source system for the source collection
   */
  readonly sourceSystem: SourceSystem<SourceSystem.Config | null, any>;
  withSourceSystem(sourceSystem: ISourceSystem<SourceSystem.Config | null, any>): SourceCollectionWithId;
  ...
  withExternal(external: boolean): SourceCollectionWithId;
  ...
  withSequential(sequential: boolean): SourceCollectionWithId;

  /**
   * Indicator of whether this instance is currently being configured
   */
  readonly state?: string | null;
  withState(state: string | null): SourceCollectionWithId;
  ...
  withAfterProcess(afterProcess: ILambda<λBiConsumer<SourceCollection<SourceCollection.Config | null> | null, Sources | null> | null> | null): SourceCollectionWithId;

  /**
   * List of transforms to skip for SourceCollection.
   */
  readonly skippedTransforms?: C3.Array<string | null>;
  withSkippedTransforms(skippedTransforms: C3.Array<string | null> | Array<string | null>): SourceCollectionWithId;
  ...
  withPatchObjsOperSpec(patchObjsOperSpec: λFunction<Content | null, IFileObjsOperSpec | null> | null): SourceCollectionWithId;
  ...
  withCdcSourcesOverride(cdcSourcesOverride: ILambda<λFunction<SourceCollection.Cdc.Checkpoint | null, Stream<Source | null>> | null> | null): SourceCollectionWithId;
  ...
  withFileInfoOverride(fileInfoOverride: λFunction<File | null, ISourceFileInfo | null> | null): SourceCollectionWithId;

  /**
   * Filter a line content in a file
   */
  readonly lineFilter?: λBiFunction<File, string, string | null> | null;
  withLineFilter(lineFilter: λBiFunction<File, string, string | null> | null): SourceCollectionWithId;

  /**
   * The id of this instance.
   */
  readonly id?: string | null;
  withId(id: string | null): SourceCollectionWithId;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SourceCollectionWithId | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SourceCollectionWithId | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SourceCollectionWithId | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SourceCollectionWithId | null;
   ...
   */
  replaceType(old: Type, new_: Type): SourceCollectionWithId;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SourceCollectionWithId;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SourceCollectionWithId;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SourceCollectionWithId | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SourceCollectionWithId | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SourceCollectionWithId;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SourceCollectionWithId;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SourceCollectionWithId;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SourceCollectionWithId;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SourceCollectionWithId;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SourceCollectionWithId;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SourceCollectionWithId;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SourceCollectionWithId;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SourceCollectionWithId;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SourceCollectionWithId;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SourceCollectionWithId;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SourceCollectionWithId;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SourceCollectionWithId;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SourceCollectionWithId;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SourceCollectionWithId;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SourceCollectionWithId;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SourceCollectionWithId;
   ...
   * @see #removeField
   */
  unsetField(field: string): SourceCollectionWithId;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SourceCollectionWithId;
   ...
   * @see #unsetField
   */
  removeField(field: string): SourceCollectionWithId;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SourceCollectionWithId;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SourceCollectionWithId;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SourceCollectionWithId;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SourceCollectionWithId;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SourceCollectionWithId;

  mergeJson(json: any | null): SourceCollectionWithId;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SourceCollectionWithId;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SourceCollectionWithId;
   ...
   */
  singletonArray(): C3.Array<SourceCollectionWithId | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SourceCollectionWithId | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SourceCollectionWithId | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SourceCollectionWithId | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SourceCollectionWithId | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SourceCollectionWithId | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SourceCollectionWithId | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SourceCollectionWithId | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SourceCollectionWithId | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SourceCollectionWithId;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SourceCollectionWithId;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SourceCollectionWithId;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SourceCollectionWithId;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SourceCollectionWithId;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SourceCollectionWithId;
   ...
   * @see #fromString
   */
  static make(s: string | null): SourceCollectionWithId | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SourceCollectionWithId;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SourceCollectionWithId;
   ...
   */
  static cachedEmptyInst(): SourceCollectionWithId;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SourceCollectionWithId>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SourceCollectionWithId;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<SourceCollectionWithId | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SourceCollectionWithId | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<SourceCollectionWithId | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<SourceCollectionWithId | null> | null>;
  ...
  save(subPath?: string | null, contentType?: string | null): SourceCollectionWithId;
  ...
  update(srcObj?: SourceCollectionWithId | null, spec?: UpsertSpec | null): SourceCollectionWithId | null;

  upsert(srcObj?: SourceCollectionWithId | null, spec?: UpsertSpec | null): SourceCollectionWithId | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): SourceCollectionWithId | null;
   ...
   */
  static forName(name: string | null, failIfMissing?: boolean): SourceCollectionWithId | null;
   ...
   */
  static collectionsForSourceType(sourceType: Type, include?: string | null): Stream<SourceCollectionWithId | null>;
   ...
   */
  setPriority(priority: number): SourceCollectionWithId;

  /**
   * @return SourceCollection after clearing the priority
   */
  clearPriority(): SourceCollectionWithId;
   ...
   */
  skipTransform(transformId?: string | null): SourceCollectionWithId;

  /**
   * skip #transform for the source collection.
   */
  skipTransformBatch(transformIds: C3.Array<string | null> | null): SourceCollectionWithId;

  /**
   * skip #transform for the source collection.
   */
  clearSkippedTransforms(transformsId: C3.Array<string | null> | null): SourceCollectionWithId;

  /**
   * skip #transform for the source collection.
   */
  clearAllSkippedTransforms(): SourceCollectionWithId;
