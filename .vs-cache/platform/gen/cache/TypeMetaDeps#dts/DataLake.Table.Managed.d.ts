// TypeScript definitions for the C3 type DataLake.Table.Managed

/**
 * @remarks this represents a value passed to a method that expects an instance of DataLake.Table.Managed
 */
declare namespace DataLake.Table {
  export interface IManaged<S> {
     ...
     * Table schema
     */
    dataSchema: ITupleType;

    /**
     * Table's partition spec, each partition definition is concatenated by "|"
     */
    partitionSpec?: C3.Array<string | null> | Array<string | null>;

    /**
     * Table versions
     */
    snapshots?: C3.Array<DataLake.Table.Snapshot | null> | Array<IDataLake.Table.Snapshot | null>;

    /**
     * Points to the latest table version
     */
    currentSnapshot?: IDataLake.Table.Snapshot | null;
     ...
     */
    sharedGroups?: C3.Array<UserGroup | null> | Array<IUserGroup | null>;

    /**
     * The {@link UserGroup}s who will have read access to this entity.
     */
    sharedReadOnlyGroups?: C3.Array<UserGroup | null> | Array<IUserGroup | null>;

    /**
     * The {@link UserGroup}s who will have update and remove access to this entity.
     */
    sharedUpdateRemoveGroups?: C3.Array<UserGroup | null> | Array<IUserGroup | null>;
    ...
    metaFieldsValues?: C3.Array<DataLake.Table.MetaFieldValue | null> | Array<IDataLake.Table.MetaFieldValue | null>;

    /**
     * Current meta fields version. Each time meta fields are updated version is incremented.
     */
    currentMetaFieldsVersion?: number | null;

    /**
     * The current version of metadata fields and values.
     */
    currentMetaFieldValues?: C3.Map<string | null, any> | {[key: string | null]: any};
  }
}
 ...
 */
declare namespace DataLake.Table {
  export class Managed<S> extends Obj {

    /**
     * Catalog where table is stored
     */
    readonly catalog: string;
    withCatalog(catalog: string): DataLake.Table.Managed;

    /**
     * Table namespace
     */
    readonly namespace: string;
    withNamespace(namespace: string): DataLake.Table.Managed;

    /**
     * Table name
     */
    readonly name: string;
    withName(name: string): DataLake.Table.Managed;

    /**
     * Table description
     */
    readonly description?: string | null;
    withDescription(description: string | null): DataLake.Table.Managed;

    /**
     * Table schema
     */
    readonly dataSchema: TupleType;
    withDataSchema(dataSchema: ITupleType): DataLake.Table.Managed;

    /**
     * Table's partition spec, each partition definition is concatenated by "|"
     */
    readonly partitionSpec?: C3.Array<string | null>;
    withPartitionSpec(partitionSpec: C3.Array<string | null> | Array<string | null>): DataLake.Table.Managed;

    /**
     * Table versions
     */
    readonly snapshots?: C3.Array<DataLake.Table.Snapshot | null>;
    withSnapshots(snapshots: C3.Array<DataLake.Table.Snapshot | null> | Array<IDataLake.Table.Snapshot | null>): DataLake.Table.Managed;

    /**
     * Points to the latest table version
     */
    readonly currentSnapshot?: DataLake.Table.Snapshot | null;
    withCurrentSnapshot(currentSnapshot: IDataLake.Table.Snapshot | null): DataLake.Table.Managed;

    /**
     * Indicates if table was deleted
     */
    readonly isDeleted?: boolean;
    withIsDeleted(isDeleted: boolean): DataLake.Table.Managed;

    /**
     * The owner of this entity.
     */
    readonly owner?: User | null;
    withOwner(owner: IUser | null): DataLake.Table.Managed;

    /**
     * The {@link UserGroup}s who will have access to this entity.
     */
    readonly sharedGroups?: C3.Array<UserGroup | null>;
    withSharedGroups(sharedGroups: C3.Array<UserGroup | null> | Array<IUserGroup | null>): DataLake.Table.Managed;

    /**
     * The {@link UserGroup}s who will have read access to this entity.
     */
    readonly sharedReadOnlyGroups?: C3.Array<UserGroup | null>;
    withSharedReadOnlyGroups(sharedReadOnlyGroups: C3.Array<UserGroup | null> | Array<IUserGroup | null>): DataLake.Table.Managed;

    /**
     * The {@link UserGroup}s who will have update and remove access to this entity.
     */
    readonly sharedUpdateRemoveGroups?: C3.Array<UserGroup | null>;
    withSharedUpdateRemoveGroups(sharedUpdateRemoveGroups: C3.Array<UserGroup | null> | Array<IUserGroup | null>): DataLake.Table.Managed;

    /**
     * List of {@link AclEntry} entries governing who can read/update/remove Objs.
     */
    readonly acl?: C3.Array<AclEntry | null>;
    withAcl(acl: C3.Array<AclEntry | null> | Array<IAclEntry | null>): DataLake.Table.Managed;
    ...
    withTypeIdent(typeIdent: string | null): DataLake.Table.Managed;
     ...
     */
    readonly id: string;
    withId(id: string): DataLake.Table.Managed;
    ...
    withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): DataLake.Table.Managed;

    /**
     * Various system fields.
     */
    readonly meta?: Meta | null;
    withMeta(meta: IMeta | null): DataLake.Table.Managed;
    ...
    withVersion(version: number | null): DataLake.Table.Managed;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type | null;
    withTypeWithBindings(typeWithBindings: IType | null): DataLake.Table.Managed;

    readonly metaFieldsValues?: C3.Array<DataLake.Table.MetaFieldValue | null>;
    withMetaFieldsValues(metaFieldsValues: C3.Array<DataLake.Table.MetaFieldValue | null> | Array<IDataLake.Table.MetaFieldValue | null>): DataLake.Table.Managed;

    /**
     * Current meta fields version. Each time meta fields are updated version is incremented.
     */
    readonly currentMetaFieldsVersion?: number | null;
    withCurrentMetaFieldsVersion(currentMetaFieldsVersion: number | null): DataLake.Table.Managed;

    /**
     * The current version of metadata fields and values.
     */
    readonly currentMetaFieldValues?: C3.Map<string | null, any>;
    withCurrentMetaFieldValues(currentMetaFieldValues: C3.Map<string | null, any> | {[key: string | null]: any}): DataLake.Table.Managed;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): DataLake.Table.Managed<S> | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): DataLake.Table.Managed<S> | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): DataLake.Table.Managed<S> | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): DataLake.Table.Managed<S> | null;
     ...
     */
    replaceType(old: Type, new_: Type): DataLake.Table.Managed<S>;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataLake.Table.Managed<S>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataLake.Table.Managed<S>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataLake.Table.Managed<S> | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataLake.Table.Managed<S> | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataLake.Table.Managed<S>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataLake.Table.Managed<S>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataLake.Table.Managed<S>;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): DataLake.Table.Managed<S>;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): DataLake.Table.Managed<S>;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): DataLake.Table.Managed<S>;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataLake.Table.Managed<S>;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataLake.Table.Managed<S>;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): DataLake.Table.Managed<S>;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): DataLake.Table.Managed<S>;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): DataLake.Table.Managed<S>;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): DataLake.Table.Managed<S>;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataLake.Table.Managed<S>;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): DataLake.Table.Managed<S>;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataLake.Table.Managed<S>;
     ...
     * @see #unsetField
     */
    defaultField(field: string): DataLake.Table.Managed<S>;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): DataLake.Table.Managed<S>;
     ...
     * @see #removeField
     */
    unsetField(field: string): DataLake.Table.Managed<S>;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): DataLake.Table.Managed<S>;
     ...
     * @see #unsetField
     */
    removeField(field: string): DataLake.Table.Managed<S>;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): DataLake.Table.Managed<S>;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataLake.Table.Managed<S>;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): DataLake.Table.Managed<S>;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataLake.Table.Managed<S>;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataLake.Table.Managed<S>;

    mergeJson(json: any | null): DataLake.Table.Managed<S>;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataLake.Table.Managed<S>;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): DataLake.Table.Managed<S>;
     ...
     */
    singletonArray(): C3.Array<DataLake.Table.Managed<S> | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<DataLake.Table.Managed<S> | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<DataLake.Table.Managed<S> | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<DataLake.Table.Managed<S> | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<DataLake.Table.Managed<S> | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, DataLake.Table.Managed<S> | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataLake.Table.Managed<S> | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<DataLake.Table.Managed<S> | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<DataLake.Table.Managed<S> | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DataLake.Table.Managed<S>;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DataLake.Table.Managed<S>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DataLake.Table.Managed<S>;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): DataLake.Table.Managed<S>;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DataLake.Table.Managed<S>;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): DataLake.Table.Managed<S>;
     ...
     * @see #fromString
     */
    static make(s: string | null): DataLake.Table.Managed<S> | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DataLake.Table.Managed<S>;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): DataLake.Table.Managed<S>;
     ...
     */
    static cachedEmptyInst(): DataLake.Table.Managed<S>;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DataLake.Table.Managed<S>>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): DataLake.Table.Managed<S>;

    /**
     * Returns content of the table as iterator Arrow column batches.
     */
    readArrowIterator(filter?: string | null, projections?: C3.Array<string | null>, batchSize: number): ArrowIterator | null;

    /**
     * Returns content of the table as iterator Arrow column batches with filter defined over partitions (filter over rows
     * not supported).
     */
    readPartitions(filter?: string | null, projections?: C3.Array<string | null>, batchSize: number): ArrowIterator | null;

    /**
     * Returns first limit rows on tha table in tuple format. This method is used to transfer data to UI for visualization.
     */
    readAsTuples(limit: number, snapshot?: DataLake.Table.Snapshot | null): Stream<Tuple | null>;
     ...
     */
    importCsv(file: string, mode?: string | null, spec?: CsvParsingSpec | null): void;

    /**
     * Asynchronous method for importing csv file records into the table.
     */
    importCsvJob(file: string, mode?: string | null, spec?: CsvParsingSpec | null): DataLake.Table.ImportJob | null;
     ...
     */
    exportCsv(spec?: DataLake.Table.ExportCsvSpec | null): string;

    /**
     * Returns list of data files which contain all the data in latest snapshot.
     */
    dataFiles(): Stream<DataLake.Table.DataFile | null>;
     ...
     */
    moveToCatalog(targetCatalog?: DataLake.Catalog<DataLake.Table | null, DataLake.Catalog.Config | null> | null, confirm?: boolean): void;
     ...
     */
    upsertBatch(objs: Stream<Obj | null> | Stream<Tuple | null>, mode?: string | null): void;
     ...
     */
    static upsertBatch(objs: C3.Array<DataLake.Table.Managed<S> | null> | null, srcObjs?: C3.Array<DataLake.Table.Managed<S> | null>, spec?: UpsertSpec | null): ObjList<DataLake.Table.Managed<S> | null> | null;
     ...
     * in the spec.
     */
    expireSnapshots(spec?: DataLake.Table.ExpireSnapshotSpec | null): void;
     ...
     */
    static populateAcl(objs?: C3.Array<DataLake.Table.Managed<S> | null>): number | null;
     ...
     */
    grantMemberReadUpdateRemove(member: AccessControlEntity): DataLake.Table.Managed<S>;
     ...
     */
    mergeAclEntry(entry: AclEntry): DataLake.Table.Managed<S>;
     ...
     * @return the obj with the new acl after merging the indicated entry.
     */
    mergeAclEntries(entries: C3.Array<AclEntry | null> | null): DataLake.Table.Managed<S>;
     ...
     */
    static fetch(spec?: FetchSpec | null): FetchResult<DataLake.Table.Managed<S> | null>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<DataLake.Table.Managed<S> | null>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec | null): Stream<DataLake.Table.Managed<S> | null>;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<DataLake.Table.Managed<S> | null> | null>;
     ...
     */
    get(include?: string | null): DataLake.Table.Managed<S> | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string | null): DataLake.Table.Managed<S> | null;
     ...
     */
    getMissing(spec: GetMissingSpec): DataLake.Table.Managed<S>;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string | null): DataLake.Table.Managed<S> | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): DataLake.Table.Managed<S>;
     ...
     * @see #toString
     */
    static fromString(s: string | null): DataLake.Table.Managed<S> | null;
     ...
     */
    create(spec?: UpsertSpec | null): DataLake.Table.Managed<S> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static createBatch(objs: C3.Array<DataLake.Table.Managed<S> | null> | null, spec?: UpsertSpec | null): ObjList<DataLake.Table.Managed<S> | null> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<DataLake.Table.Managed<S> | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<DataLake.Table.Managed<S> | null> | null;
     ...
     */
    update(srcObj?: DataLake.Table.Managed<S> | null, spec?: UpsertSpec | null): DataLake.Table.Managed<S> | null;
     ...
     */
    upsert(srcObj?: DataLake.Table.Managed<S> | null, spec?: UpsertSpec | null): DataLake.Table.Managed<S> | null;
     ...
     */
    merge(spec?: MergeSpec | null): DataLake.Table.Managed<S> | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec | null): DataLake.Table.Managed<S> | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec | null): DataLake.Table.Managed<S> | null;
     ...
     */
    static updateBatch(objs: C3.Array<DataLake.Table.Managed<S> | null> | null, srcObjs?: C3.Array<DataLake.Table.Managed<S> | null>, spec?: UpsertSpec | null): ObjList<DataLake.Table.Managed<S> | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<C3.Array<DataLake.Table.Managed<S> | null>>, spec?: UpsertSpec | null): ObjList<DataLake.Table.Managed<S> | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<C3.Array<DataLake.Table.Managed<S> | null>>, spec?: UpsertSpec | null): ObjList<DataLake.Table.Managed<S> | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: C3.Array<DataLake.Table.Managed<S> | null> | null, spec?: TouchSpec | null): ObjList<DataLake.Table.Managed<S> | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<DataLake.Table.Managed<S> | null> | null, spec?: MergeSpec | null): ObjList<DataLake.Table.Managed<S> | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<DataLake.Table.Managed<S> | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<DataLake.Table.Managed<S> | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<C3.Array<DataLake.Table.Managed<S> | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<DataLake.Table.Managed<S> | null> | null;
     ...
     */
    static mergeAll(mergeObj: DataLake.Table.Managed<S> | null, spec?: MergeAllSpec | null): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: DataLake.Table.Managed<S> | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: C3.Array<DataLake.Table.Managed<S> | null> | null, spec?: UpsertSpec | null): ObjList<DataLake.Table.Managed<S> | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: C3.Array<DataLake.Table.Managed<S> | null> | null, spec?: UpsertSpec | null): ObjList<DataLake.Table.Managed<S> | null> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): DataLake.Table.Managed<S> | null;
     ...
     */
    static beforeCreate(objs: C3.Array<DataLake.Table.Managed<S> | null> | null): ObjList<DataLake.Table.Managed<S> | null>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: C3.Array<DataLake.Table.Managed<S> | null> | null): ObjList<DataLake.Table.Managed<S> | null>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: C3.Array<DataLake.Table.Managed<S> | null> | null): ObjList<DataLake.Table.Managed<S> | null>;
     ...
     */
    static afterCreate(objs: C3.Array<DataLake.Table.Managed<S> | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: C3.Array<DataLake.Table.Managed<S> | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: C3.Array<DataLake.Table.Managed<S> | null> | null): C3.Array<ObjError | null>;
     ...
     */
    static startImportData(spec?: StartImportDataSpec | null): PushStream<DataLake.Table.Managed<S> | null>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<DataLake.Table.Managed<S> | null>;
     ...
     */
    static forId(id: string | null, failIfMissing?: boolean): DataLake.Table.Managed<S> | null;
     ...
     */
    withoutIdentity(): DataLake.Table.Managed<S> | null;
     ...
     */
    static typeOfBatch(objs: C3.Array<DataLake.Table.Managed<S> | null> | null): C3.Array<EntityType | null>;
     ...
     */
    static dbEcho(template?: DataLake.Table.Managed<S> | null, count?: number | null, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: C3.Array<DataLake.Table.Managed<S> | null> | null, callback?: λFunction<DataLake.Table.Managed<S> | null, DataLake.Table.Managed<S> | null> | null): ObjList<DataLake.Table.Managed<S> | null>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: C3.Array<DataLake.Table.Managed<S> | null> | null, callback?: λFunction<DataLake.Table.Managed<S> | null, DataLake.Table.Managed<S> | null> | null): C3.Array<ObjError | null>;
     ...
     */
    setMetaFields(metaFieldValues?: C3.Map<string | null, any>): DataLake.Table.Managed<S> | null;

    /**
     * Return values of meta fields for given meta fields version.
     */
    getMetaFields(version?: number | null): C3.Map<string | null, any>;

    /**
     * Sets a new description for the {@link DataLake.Table.Managed.Iceberg}
     */
    setDescription(description?: string | null): DataLake.Table.Managed<S> | null;
  }
}
