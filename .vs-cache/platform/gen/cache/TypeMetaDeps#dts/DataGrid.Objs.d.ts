// TypeScript definitions for the C3 type DataGrid.Objs
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of DataGrid.Objs
 */
declare namespace DataGrid {
  export interface IObjs {
    ...
    _coll: ICollection<Obj | null>;

    _stream?: Stream<Obj | null> | Array<IObj | null>;
 ...
 */
declare namespace DataGrid {
  export class Objs extends Obj {

    /**
     * The raw data from which the grid was built.
     */
    readonly source?: any;
    withSource(source: any): DataGrid.Objs;
    ...
    withLabel(label: string | null): DataGrid.Objs;

    /**
     * A more detailed description of the source of the data. Typically the full value type of the data.
     */
    readonly description?: string | null;
    withDescription(description: string | null): DataGrid.Objs;
    ...
    withCols(cols: C3.Array<DataGrid.Col> | Array<IDataGrid.Col>): DataGrid.Objs;

    readonly _coll: Collection<Obj | null>;
    with_coll(_coll: ICollection<Obj | null>): DataGrid.Objs;

    readonly _stream?: Stream<Obj | null>;
    with_stream(_stream: Stream<Obj | null> | Array<IObj | null>): DataGrid.Objs;

    readonly _buffer?: any;
    with_buffer(_buffer: any): DataGrid.Objs;

    readonly _keys?: C3.Array<any>;
    with_keys(_keys: C3.Array<any> | Array<any>): DataGrid.Objs;
    ...
    withSourceType(sourceType: IType): DataGrid.Objs;

    readonly _access?: any;
    with_access(_access: any): DataGrid.Objs;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): DataGrid.Objs | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): DataGrid.Objs | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): DataGrid.Objs | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): DataGrid.Objs | null;
     ...
     */
    replaceType(old: Type, new_: Type): DataGrid.Objs;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataGrid.Objs;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataGrid.Objs;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataGrid.Objs | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataGrid.Objs | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataGrid.Objs;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataGrid.Objs;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataGrid.Objs;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): DataGrid.Objs;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): DataGrid.Objs;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): DataGrid.Objs;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataGrid.Objs;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataGrid.Objs;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): DataGrid.Objs;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): DataGrid.Objs;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): DataGrid.Objs;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): DataGrid.Objs;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataGrid.Objs;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): DataGrid.Objs;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataGrid.Objs;
     ...
     * @see #unsetField
     */
    defaultField(field: string): DataGrid.Objs;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): DataGrid.Objs;
     ...
     * @see #removeField
     */
    unsetField(field: string): DataGrid.Objs;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): DataGrid.Objs;
     ...
     * @see #unsetField
     */
    removeField(field: string): DataGrid.Objs;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): DataGrid.Objs;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataGrid.Objs;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): DataGrid.Objs;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataGrid.Objs;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataGrid.Objs;

    mergeJson(json: any | null): DataGrid.Objs;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataGrid.Objs;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): DataGrid.Objs;
     ...
     */
    singletonArray(): C3.Array<DataGrid.Objs | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<DataGrid.Objs | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<DataGrid.Objs | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<DataGrid.Objs | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<DataGrid.Objs | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, DataGrid.Objs | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataGrid.Objs | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<DataGrid.Objs | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<DataGrid.Objs | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DataGrid.Objs;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DataGrid.Objs;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DataGrid.Objs;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): DataGrid.Objs;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DataGrid.Objs;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): DataGrid.Objs;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DataGrid.Objs;
     ...
     */
    static cachedEmptyInst(): DataGrid.Objs;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DataGrid.Objs>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): DataGrid.Objs;
     ...
     */
    static fromCollection(coll: Collection<Obj | null>, spec?: DataGrid.LoadSpec | null): DataGrid.Objs;

    /**
     * Get the methods and properties that have an explicit `@dataGrid(show=true)` annotation.
     */
    static showMethods(type: Type): C3.Array<string | null>;

    /**
     * Get the fields that have an explicit `@dataGrid(hide=true)` annotation.
     */
    static hideFields(type: Type): C3.Array<string | null>;

    /**
     * Get both #showMethods and #hideFields in one shot.
     */
    static showHide(type: Type): Pair<C3.Array<string | null>, C3.Array<string | null>>;
  }
}
