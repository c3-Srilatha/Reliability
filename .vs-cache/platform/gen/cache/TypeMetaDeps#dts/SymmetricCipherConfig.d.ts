// TypeScript definitions for the C3 type SymmetricCipherConfig

/**
 * Configuration for SymmetricCipher
 *
 * @remarks this represents a value passed to a method that expects an instance of SymmetricCipherConfig
 */
declare interface ISymmetricCipherConfig {
  ...
  /**
   * Data encryption key validity period in days. if not configured, data encryption key is not refreshed till the node
   * is restarted.
   */
  dekValidity?: string | null;

  /**
   * Data Encryption Key pool size in terms of %. If not specified, it assumes 0.001% of number records that will be
   * ingested by the platform
   */
  dekPoolSize?: number | null;

  /**
   * Long term key used for hashing the data.
   */
  keyForHash?: ISecretKey | null;

  /**
   * Active key encryption key(Kek)
   */
  activeKek?: ISecretKey | null;

  /**
   * Inactive key encryption key(Kek)
   */
  inactiveKek?: ISecretKey | null;

  /**
   * Key encryption key(Kek) which is deleted.
   */
  deletedKek?: ISecretKey | null;
}

/**
 * Configuration for SymmetricCipher
 *
 * @remarks this represents a made instance of SymmetricCipherConfig
 */
declare class SymmetricCipherConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): SymmetricCipherConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): SymmetricCipherConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): SymmetricCipherConfig;

  /**
   * Data encryption key validity period in days. if not configured, data encryption key is not refreshed till the node
   * is restarted.
   */
  readonly dekValidity?: string | null;
  withDekValidity(dekValidity: string | null): SymmetricCipherConfig;

  /**
   * Data Encryption Key pool size in terms of %. If not specified, it assumes 0.001% of number records that will be
   * ingested by the platform
   */
  readonly dekPoolSize?: number | null;
  withDekPoolSize(dekPoolSize: number | null): SymmetricCipherConfig;

  /**
   * Long term key used for hashing the data.
   */
  readonly keyForHash?: SecretKey | null;
  withKeyForHash(keyForHash: ISecretKey | null): SymmetricCipherConfig;

  /**
   * Active key encryption key(Kek)
   */
  readonly activeKek?: SecretKey | null;
  withActiveKek(activeKek: ISecretKey | null): SymmetricCipherConfig;

  /**
   * Inactive key encryption key(Kek)
   */
  readonly inactiveKek?: SecretKey | null;
  withInactiveKek(inactiveKek: ISecretKey | null): SymmetricCipherConfig;

  /**
   * Key encryption key(Kek) which is deleted.
   */
  readonly deletedKek?: SecretKey | null;
  withDeletedKek(deletedKek: ISecretKey | null): SymmetricCipherConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SymmetricCipherConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SymmetricCipherConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SymmetricCipherConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SymmetricCipherConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): SymmetricCipherConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SymmetricCipherConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SymmetricCipherConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SymmetricCipherConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SymmetricCipherConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SymmetricCipherConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SymmetricCipherConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SymmetricCipherConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SymmetricCipherConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SymmetricCipherConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SymmetricCipherConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SymmetricCipherConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SymmetricCipherConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SymmetricCipherConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SymmetricCipherConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SymmetricCipherConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SymmetricCipherConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SymmetricCipherConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SymmetricCipherConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SymmetricCipherConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SymmetricCipherConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SymmetricCipherConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): SymmetricCipherConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SymmetricCipherConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): SymmetricCipherConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SymmetricCipherConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SymmetricCipherConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SymmetricCipherConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SymmetricCipherConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SymmetricCipherConfig;

  mergeJson(json: any | null): SymmetricCipherConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SymmetricCipherConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SymmetricCipherConfig;
   ...
   */
  singletonArray(): C3.Array<SymmetricCipherConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SymmetricCipherConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SymmetricCipherConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SymmetricCipherConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SymmetricCipherConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SymmetricCipherConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SymmetricCipherConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SymmetricCipherConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SymmetricCipherConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SymmetricCipherConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SymmetricCipherConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SymmetricCipherConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SymmetricCipherConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SymmetricCipherConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SymmetricCipherConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SymmetricCipherConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SymmetricCipherConfig;
   ...
   */
  static cachedEmptyInst(): SymmetricCipherConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SymmetricCipherConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SymmetricCipherConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<SymmetricCipherConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<SymmetricCipherConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<SymmetricCipherConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): SymmetricCipherConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): SymmetricCipherConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): SymmetricCipherConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): SymmetricCipherConfig | null;
   ...
   */
  static produce(key: string): SymmetricCipherConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, SymmetricCipherConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, SymmetricCipherConfig | null>;
   ...
   */
  getConfig(): SymmetricCipherConfig;
   ...
   */
  getSecret(): SymmetricCipherConfig;
   ...
   */
  static forConfigKey(configKey: string | null): SymmetricCipherConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<SymmetricCipherConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: SymmetricCipherConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: SymmetricCipherConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): SymmetricCipherConfig | null;
