// TypeScript definitions for the C3 type Mail
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Mail
 */
declare interface IMail {
   ...
   */
  from: string | null | IAccessControlEntity | null;

  /**
   * The list of To addresses to be used in the email. If a Member is given, instead of a string, it will use the email
   * address for the Member record.
   */
  to: C3.Array<string | null | AccessControlEntity | null | null> | Array<string | null | IAccessControlEntity | null | null>;

  /**
   * The list of CC addresses to be used in the email. If a Member is given, instead of a string, it will use the email
   * address for the Member record.
   */
  cc?: C3.Array<string | null | AccessControlEntity | null | null> | Array<string | null | IAccessControlEntity | null | null>;

  /**
   * The list of BCC addresses to be used in the email. If a Member is given, instead of a string, it will use the email
   * address for the Member record.
   */
  bcc?: C3.Array<string | null | AccessControlEntity | null | null> | Array<string | null | IAccessControlEntity | null | null>;
   ...
   */
  vars?: C3.Map<string | null, string | null> | {[key: string | null]: string | null};
   ...
   */
  attachments?: C3.Array<File | null> | Array<IFile | null>;
}
 ...
 * The email sent is recorded in the server logs, so may be searched in Splunk.
 *
 * @remarks this represents a made instance of Mail
 */
declare class Mail extends Obj {
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Mail;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): Mail;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): Mail;
  ...
  withVersion(version: number | null): Mail;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): Mail;

  /**
   * The From address to be used in the email. If a Member is given, instead of a string, it will use the email
   * address for the Member record.
   */
  readonly from: string | null | AccessControlEntity | null;
  withFrom(from: string | null | IAccessControlEntity | null): Mail;

  /**
   * The list of To addresses to be used in the email. If a Member is given, instead of a string, it will use the email
   * address for the Member record.
   */
  readonly to: C3.Array<string | null | AccessControlEntity | null | null>;
  withTo(to: C3.Array<string | null | AccessControlEntity | null | null> | Array<string | null | IAccessControlEntity | null | null>): Mail;

  /**
   * The list of CC addresses to be used in the email. If a Member is given, instead of a string, it will use the email
   * address for the Member record.
   */
  readonly cc?: C3.Array<string | null | AccessControlEntity | null | null>;
  withCc(cc: C3.Array<string | null | AccessControlEntity | null | null> | Array<string | null | IAccessControlEntity | null | null>): Mail;

  /**
   * The list of BCC addresses to be used in the email. If a Member is given, instead of a string, it will use the email
   * address for the Member record.
   */
  readonly bcc?: C3.Array<string | null | AccessControlEntity | null | null>;
  withBcc(bcc: C3.Array<string | null | AccessControlEntity | null | null> | Array<string | null | IAccessControlEntity | null | null>): Mail;
  ...
  withContent(content: string): Mail;
   ...
   * with vars passed as `{"USER": "c3User", "PLACE": "1400SeaPort"}`  =>  `Hi it is nice to meet you c3User at 1400Seaport.`
   */
  readonly vars?: C3.Map<string | null, string | null>;
  withVars(vars: C3.Map<string | null, string | null> | {[key: string | null]: string | null}): Mail;

  /**
   * The content type of the email, default is 'text/plain' if not specified.
   */
  readonly content_type?: string | null;
  withContent_type(content_type: string | null): Mail;

  /**
   * The content type of the email, default is 'text/plain' if not specified.
   */
  readonly contentType?: string | null;
  withContentType(contentType: string | null): Mail;
  ...
  withAttachment(attachment: IFile | null): Mail;

  /**
   * Attach one or more files in an email. Supported by only certain {@link MailConfig.serviceProvider}s.
   */
  readonly attachments?: C3.Array<File | null>;
  withAttachments(attachments: C3.Array<File | null> | Array<IFile | null>): Mail;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Mail | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Mail | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Mail | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Mail | null;
   ...
   */
  replaceType(old: Type, new_: Type): Mail;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Mail;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Mail;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Mail | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Mail | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Mail;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Mail;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Mail;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Mail;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Mail;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Mail;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Mail;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Mail;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Mail;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Mail;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Mail;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Mail;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Mail;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Mail;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Mail;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Mail;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Mail;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Mail;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Mail;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Mail;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Mail;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Mail;

  mergeJson(json: any | null): Mail;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Mail;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Mail;
   ...
   */
  singletonArray(): C3.Array<Mail | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Mail | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Mail | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Mail | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Mail | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Mail | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Mail | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Mail | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Mail | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Mail;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Mail;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Mail;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Mail;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Mail;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Mail;
   ...
   * @see #fromString
   */
  static make(s: string | null): Mail | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Mail;
   ...
   */
  static cachedEmptyInst(): Mail;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Mail>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Mail;
   ...
   */
  config(secrets?: boolean): MailConfig;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<Mail | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<Mail | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Mail | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Mail | null> | null>;
   ...
   */
  get(include?: string | null): Mail | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): Mail | null;
   ...
   */
  getMissing(spec: GetMissingSpec): Mail;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): Mail | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): Mail;
   ...
   * @see #toString
   */
  static fromString(s: string | null): Mail | null;
   ...
   */
  create(spec?: UpsertSpec | null): Mail | null;
   ...
   */
  static createBatch(objs: C3.Array<Mail | null> | null, spec?: UpsertSpec | null): ObjList<Mail | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<Mail | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Mail | null> | null;
   ...
   */
  update(srcObj?: Mail | null, spec?: UpsertSpec | null): Mail | null;
   ...
   */
  upsert(srcObj?: Mail | null, spec?: UpsertSpec | null): Mail | null;
   ...
   */
  merge(spec?: MergeSpec | null): Mail | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): Mail | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): Mail | null;
   ...
   */
  static updateBatch(objs: C3.Array<Mail | null> | null, srcObjs?: C3.Array<Mail | null>, spec?: UpsertSpec | null): ObjList<Mail | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<Mail | null>>, spec?: UpsertSpec | null): ObjList<Mail | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<Mail | null> | null, srcObjs?: C3.Array<Mail | null>, spec?: UpsertSpec | null): ObjList<Mail | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<Mail | null>>, spec?: UpsertSpec | null): ObjList<Mail | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<Mail | null> | null, spec?: TouchSpec | null): ObjList<Mail | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Mail | null> | null, spec?: MergeSpec | null): ObjList<Mail | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Mail | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Mail | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<Mail | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Mail | null> | null;
   ...
   */
  static mergeAll(mergeObj: Mail | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: Mail | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<Mail | null> | null, spec?: UpsertSpec | null): ObjList<Mail | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<Mail | null> | null, spec?: UpsertSpec | null): ObjList<Mail | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<Mail | null> | null): ObjList<Mail | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<Mail | null> | null): ObjList<Mail | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<Mail | null> | null): ObjList<Mail | null>;
   ...
   */
  static afterCreate(objs: C3.Array<Mail | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<Mail | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<Mail | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<Mail | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Mail | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): Mail | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<Mail | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: Mail | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<Mail | null> | null, callback?: λFunction<Mail | null, Mail | null> | null): ObjList<Mail | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<Mail | null> | null, callback?: λFunction<Mail | null, Mail | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static send(email: Mail): Mail | null;
   ...
   */
  static formatEmail(email: string | null, name?: string | null): string | null;
}
