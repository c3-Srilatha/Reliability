// TypeScript definitions for the C3 type TransformStatus

/**
 * Holds statistics for a transformation step in the data integration pipeline
 *
 * @remarks this represents a value passed to a method that expects an instance of TransformStatus
 */
declare interface ITransformStatus {
 ...
 * Holds statistics for a transformation step in the data integration pipeline
 *
 * @remarks this represents a made instance of TransformStatus
 */
declare class TransformStatus extends Obj {
  ...
  withTypeIdent(typeIdent: string | null): TransformStatus;
   ...
   */
  readonly id: string;
  withId(id: string): TransformStatus;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): TransformStatus;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): TransformStatus;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): TransformStatus;
  ...
  withVersion(version: number | null): TransformStatus;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): TransformStatus;

  /**
   * A reference to {@link SourceStatus} of the initial / root Sources. Will be `null` for root SourceStatus.
   */
  readonly rootSourceStatus?: SourceStatus | null;
  withRootSourceStatus(rootSourceStatus: ISourceStatus | null): TransformStatus;
  ...
  withParentStatus(parentStatus: IDataIntegStatus | null): TransformStatus;

  /**
   * Array of statuses of immediate transforms optionally filtered by provided transform type.
   */
  readonly transforms?: C3.Array<TransformStatus | null>;
  withTransforms(transforms: C3.Array<TransformStatus | null> | Array<ITransformStatus | null>): TransformStatus;

  /**
   * Array of statuses of immediate targets optionally filtered by provided transform type.
   */
  readonly targets?: C3.Array<TargetStatus | null>;
  withTargets(targets: C3.Array<TargetStatus | null> | Array<ITargetStatus | null>): TransformStatus;

  /**
   * The {@see TypeRef} of the Sources for which the stats are being stored
   */
  readonly sourceType: Type;
  withSourceType(sourceType: IType): TransformStatus;

  /**
   * fingerprint id of the {@see DataIntegSpec} for fetching the corresponding merged specs.
   */
  readonly specId?: string | null;
  withSpecId(specId: string | null): TransformStatus;

  /**
   * {@link DataIntegSpec} for the corresponding merged specs.
   */
  readonly spec?: DataIntegSpec | null;
  withSpec(spec: IDataIntegSpec | null): TransformStatus;
  ...
  withState(state: string): TransformStatus;

  /**
   * The number of objects participating at this data integration step.
   */
  readonly count: number;
  withCount(count: number): TransformStatus;

  /**
   * The number of objects successfully processed at this data integration step.
   */
  readonly successful: number;
  withSuccessful(successful: number): TransformStatus;

  /**
   * The number of objects that were skipped at this data integration step.
   */
  readonly skipped: number;
  withSkipped(skipped: number): TransformStatus;

  /**
   * The number of objects that failed to process at this data integration step.
   */
  readonly failed: number;
  withFailed(failed: number): TransformStatus;
  ...
  withTotalErrorCount(totalErrorCount: number): TransformStatus;

  /**
   * List of first 100 errors in this data integration step.
   */
  readonly errors?: C3.Array<FailedSource | null>;
  withErrors(errors: C3.Array<FailedSource | null> | Array<IFailedSource | null>): TransformStatus;
  ...
  withFirstError(firstError: string | null): TransformStatus;

  /**
   * The name of the transform.
   */
  readonly transformName: string;
  withTransformName(transformName: string): TransformStatus;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TransformStatus | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TransformStatus | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TransformStatus | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TransformStatus | null;
   ...
   */
  replaceType(old: Type, new_: Type): TransformStatus;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TransformStatus;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TransformStatus;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TransformStatus | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TransformStatus | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TransformStatus;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TransformStatus;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TransformStatus;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TransformStatus;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TransformStatus;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TransformStatus;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TransformStatus;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TransformStatus;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TransformStatus;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TransformStatus;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TransformStatus;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TransformStatus;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TransformStatus;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TransformStatus;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TransformStatus;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TransformStatus;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TransformStatus;
   ...
   * @see #removeField
   */
  unsetField(field: string): TransformStatus;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TransformStatus;
   ...
   * @see #unsetField
   */
  removeField(field: string): TransformStatus;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TransformStatus;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TransformStatus;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TransformStatus;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TransformStatus;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TransformStatus;

  mergeJson(json: any | null): TransformStatus;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TransformStatus;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TransformStatus;
   ...
   */
  singletonArray(): C3.Array<TransformStatus | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TransformStatus | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TransformStatus | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TransformStatus | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TransformStatus | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TransformStatus | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TransformStatus | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TransformStatus | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TransformStatus | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TransformStatus;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TransformStatus;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TransformStatus;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TransformStatus;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TransformStatus;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TransformStatus;
   ...
   * @see #fromString
   */
  static make(s: string | null): TransformStatus | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TransformStatus;
   ...
   */
  static cachedEmptyInst(): TransformStatus;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TransformStatus>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TransformStatus;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TransformStatus | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TransformStatus | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TransformStatus | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TransformStatus | null> | null>;
   ...
   */
  get(include?: string | null): TransformStatus | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TransformStatus | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TransformStatus;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TransformStatus | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TransformStatus;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TransformStatus | null;
   ...
   */
  create(spec?: UpsertSpec | null): TransformStatus | null;
   ...
   */
  static createBatch(objs: C3.Array<TransformStatus | null> | null, spec?: UpsertSpec | null): ObjList<TransformStatus | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TransformStatus | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TransformStatus | null> | null;
   ...
   */
  update(srcObj?: TransformStatus | null, spec?: UpsertSpec | null): TransformStatus | null;
   ...
   */
  upsert(srcObj?: TransformStatus | null, spec?: UpsertSpec | null): TransformStatus | null;
   ...
   */
  merge(spec?: MergeSpec | null): TransformStatus | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TransformStatus | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TransformStatus | null;
   ...
   */
  static updateBatch(objs: C3.Array<TransformStatus | null> | null, srcObjs?: C3.Array<TransformStatus | null>, spec?: UpsertSpec | null): ObjList<TransformStatus | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TransformStatus | null>>, spec?: UpsertSpec | null): ObjList<TransformStatus | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TransformStatus | null> | null, srcObjs?: C3.Array<TransformStatus | null>, spec?: UpsertSpec | null): ObjList<TransformStatus | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TransformStatus | null>>, spec?: UpsertSpec | null): ObjList<TransformStatus | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TransformStatus | null> | null, spec?: TouchSpec | null): ObjList<TransformStatus | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TransformStatus | null> | null, spec?: MergeSpec | null): ObjList<TransformStatus | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TransformStatus | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TransformStatus | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TransformStatus | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TransformStatus | null> | null;
   ...
   */
  static mergeAll(mergeObj: TransformStatus | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TransformStatus | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TransformStatus | null> | null, spec?: UpsertSpec | null): ObjList<TransformStatus | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TransformStatus | null> | null, spec?: UpsertSpec | null): ObjList<TransformStatus | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TransformStatus | null> | null): ObjList<TransformStatus | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TransformStatus | null> | null): ObjList<TransformStatus | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TransformStatus | null> | null): ObjList<TransformStatus | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TransformStatus | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TransformStatus | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TransformStatus | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TransformStatus | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TransformStatus | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TransformStatus | null;
   ...
   */
  withoutIdentity(): TransformStatus | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<TransformStatus | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TransformStatus | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TransformStatus | null> | null, callback?: λFunction<TransformStatus | null, TransformStatus | null> | null): ObjList<TransformStatus | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TransformStatus | null> | null, callback?: λFunction<TransformStatus | null, TransformStatus | null> | null): C3.Array<ObjError | null>;
