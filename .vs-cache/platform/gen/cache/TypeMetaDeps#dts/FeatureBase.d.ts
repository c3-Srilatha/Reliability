// TypeScript definitions for the C3 type FeatureBase

/**
 * Base type for Feature & Feature Set
 *
 * @remarks this represents a value passed to a method that expects an instance of FeatureBase
 */
declare interface IFeatureBase {
   ...
   * @see #srcBatch
   */
  src?: λTriFunction<FeatureEvaluatable, EvalFeatureSpec | null, FeatureBase | null, IFeature.CustomMaterializationResult | null> | null;
   ...
   * @see #src
   */
  srcBatch?: λTriFunction<C3.Array<FeatureEvaluatable>, EvalFeatureSpec | null, FeatureBase | null, IFeature.CustomMaterializationResult | null> | null;
 ...
 */
declare class FeatureBase extends Obj {
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): FeatureBase;

  /**
   * Name of the Obj instance
   */
  readonly name: string;
  withName(name: string): FeatureBase;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): FeatureBase;
  ...
  withVersion(version: number | null): FeatureBase;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): FeatureBase;
  ...
  withUserUpdatedFields(userUpdatedFields: C3.Array<string | null> | Array<string | null>): FeatureBase;
  ...
  withHidden(hidden: boolean): FeatureBase;
  ...
  withUserOwned(userOwned: boolean): FeatureBase;

  /**
   * Subject type of this feature
   */
  readonly subjectType: Type;
  withSubjectType(subjectType: IType): FeatureBase;

  /**
   * User specified tags for ease of discovery and maintenance
   */
  readonly tags?: C3.Array<string | null>;
  withTags(tags: C3.Array<string | null> | Array<string | null>): FeatureBase;

  /**
   * A short description of the {@link Feature} or {@link Feature.Set}
   */
  readonly summary?: string | null;
  withSummary(summary: string | null): FeatureBase;

  /**
   * A long and in-depth description of the {@link Feature} or {@link Feature.Set}
   */
  readonly description?: string | null;
  withDescription(description: string | null): FeatureBase;
  ...
  withFailIfExists(failIfExists: boolean): FeatureBase;
  ...
  withDoNotMaterialize(doNotMaterialize: boolean): FeatureBase;
   ...
   * @see #srcBatch
   */
  readonly src?: λTriFunction<FeatureEvaluatable, EvalFeatureSpec | null, FeatureBase | null, Feature.CustomMaterializationResult | null> | null;
  withSrc(src: λTriFunction<FeatureEvaluatable, EvalFeatureSpec | null, FeatureBase | null, IFeature.CustomMaterializationResult | null> | null): FeatureBase;
   ...
   * @see #src
   */
  readonly srcBatch?: λTriFunction<C3.Array<FeatureEvaluatable>, EvalFeatureSpec | null, FeatureBase | null, Feature.CustomMaterializationResult | null> | null;
  withSrcBatch(srcBatch: λTriFunction<C3.Array<FeatureEvaluatable>, EvalFeatureSpec | null, FeatureBase | null, IFeature.CustomMaterializationResult | null> | null): FeatureBase;
  ...
  withSrcSubjectProjection(srcSubjectProjection: string | null): FeatureBase;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): FeatureBase | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): FeatureBase | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): FeatureBase | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): FeatureBase | null;
   ...
   */
  replaceType(old: Type, new_: Type): FeatureBase;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FeatureBase;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FeatureBase;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FeatureBase | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FeatureBase | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): FeatureBase;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FeatureBase;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FeatureBase;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FeatureBase;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FeatureBase;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FeatureBase;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): FeatureBase;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FeatureBase;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FeatureBase;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): FeatureBase;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): FeatureBase;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): FeatureBase;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): FeatureBase;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FeatureBase;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): FeatureBase;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FeatureBase;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FeatureBase;
   ...
   * @see #removeField
   */
  unsetField(field: string): FeatureBase;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FeatureBase;
   ...
   * @see #unsetField
   */
  removeField(field: string): FeatureBase;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FeatureBase;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): FeatureBase;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): FeatureBase;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): FeatureBase;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): FeatureBase;

  mergeJson(json: any | null): FeatureBase;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): FeatureBase;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): FeatureBase;
   ...
   */
  singletonArray(): C3.Array<FeatureBase | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<FeatureBase | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FeatureBase | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<FeatureBase | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FeatureBase | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, FeatureBase | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FeatureBase | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FeatureBase | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FeatureBase | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): FeatureBase;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): FeatureBase;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): FeatureBase;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FeatureBase;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): FeatureBase;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FeatureBase;
   ...
   * @see #fromString
   */
  static make(s: string | null): FeatureBase | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): FeatureBase;
   ...
   */
  static cachedEmptyInst(): FeatureBase;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<FeatureBase>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): FeatureBase;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<FeatureBase | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<FeatureBase | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<FeatureBase | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): FeatureBase | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string | null): FeatureBase | null;
   ...
   * @see findByCacheKey
   */
  getCached(): FeatureBase | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): FeatureBase | null;
   ...
   */
  static produce(key: string): FeatureBase | null;
   ...
   */
  static produceAll(): C3.Map<string | null, FeatureBase | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, FeatureBase | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<FeatureBase | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<FeatureBase | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<FeatureBase | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<FeatureBase | null> | null>;
   ...
   */
  get(include?: string | null): FeatureBase | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): FeatureBase | null;
   ...
   */
  getMissing(spec: GetMissingSpec): FeatureBase;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): FeatureBase | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): FeatureBase;
   ...
   * @see #toString
   */
  static fromString(s: string | null): FeatureBase | null;
   ...
   */
  create(spec?: UpsertSpec | null): FeatureBase | null;
   ...
   */
  static createBatch(objs: C3.Array<FeatureBase | null> | null, spec?: UpsertSpec | null): ObjList<FeatureBase | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<FeatureBase | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<FeatureBase | null> | null;
   ...
   */
  update(srcObj?: FeatureBase | null, spec?: UpsertSpec | null): FeatureBase | null;
   ...
   */
  upsert(srcObj?: FeatureBase | null, spec?: UpsertSpec | null): FeatureBase | null;
   ...
   */
  merge(spec?: MergeSpec | null): FeatureBase | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): FeatureBase | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): FeatureBase | null;
   ...
   */
  static updateBatch(objs: C3.Array<FeatureBase | null> | null, srcObjs?: C3.Array<FeatureBase | null>, spec?: UpsertSpec | null): ObjList<FeatureBase | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<FeatureBase | null>>, spec?: UpsertSpec | null): ObjList<FeatureBase | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<FeatureBase | null> | null, srcObjs?: C3.Array<FeatureBase | null>, spec?: UpsertSpec | null): ObjList<FeatureBase | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<FeatureBase | null>>, spec?: UpsertSpec | null): ObjList<FeatureBase | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<FeatureBase | null> | null, spec?: TouchSpec | null): ObjList<FeatureBase | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<FeatureBase | null> | null, spec?: MergeSpec | null): ObjList<FeatureBase | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<FeatureBase | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<FeatureBase | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<FeatureBase | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<FeatureBase | null> | null;
   ...
   */
  static mergeAll(mergeObj: FeatureBase | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: FeatureBase | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<FeatureBase | null> | null, spec?: UpsertSpec | null): ObjList<FeatureBase | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<FeatureBase | null> | null, spec?: UpsertSpec | null): ObjList<FeatureBase | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<FeatureBase | null> | null): ObjList<FeatureBase | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<FeatureBase | null> | null): ObjList<FeatureBase | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<FeatureBase | null> | null): ObjList<FeatureBase | null>;
   ...
   */
  static afterCreate(objs: C3.Array<FeatureBase | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<FeatureBase | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<FeatureBase | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<FeatureBase | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<FeatureBase | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): FeatureBase | null;
   ...
   */
  withoutIdentity(): FeatureBase | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<FeatureBase | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: FeatureBase | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<FeatureBase | null> | null, callback?: λFunction<FeatureBase | null, FeatureBase | null> | null): ObjList<FeatureBase | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<FeatureBase | null> | null, callback?: λFunction<FeatureBase | null, FeatureBase | null> | null): C3.Array<ObjError | null>;
   ...
   */
  publish(subPath?: string | null, contentType?: string | null): FeatureBase;
   ...
   */
  static removeSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<FeatureBase | null> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec | null): FeatureBase | null;
   ...
   */
  static createSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<FeatureBase | null> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData | null, spec?: UpsertSpec | null): FeatureBase | null;
   ...
   */
  static updateSeedDataBatch(objs?: C3.Array<SeedData | null>, srcObjs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<FeatureBase | null> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec | null): FeatureBase | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: C3.Array<SeedData | null>, spec?: MergeSpec | null): ObjList<FeatureBase | null> | null;
  ...
  dependencies(): SeedDataDeps<FeatureBase | null> | null;
   ...
   */
  static forName(subjectType: Type, name: string, failIfMissing?: boolean): FeatureBase;
   ...
   */
  static execSrcLambda(src?: λTriFunction<FeatureEvaluatable, EvalFeatureSpec | null, FeatureBase | null, Feature.CustomMaterializationResult> | null, subjects: C3.Array<FeatureEvaluatable>, spec?: EvalFeatureSpec | null, feature?: FeatureBase | null): [path: string | null, kind: string | null] | null;
   ...
   * is deleted after use.
   */
  static execSrcBatchLambda(srcBatch?: λTriFunction<C3.Array<FeatureEvaluatable>, EvalFeatureSpec | null, FeatureBase | null, Feature.CustomMaterializationResult> | null, subjects: C3.Array<FeatureEvaluatable>, spec?: EvalFeatureSpec | null, feature?: FeatureBase | null): [path: string | null, kind: string | null] | null;
   ...
   */
  static allForSubjectType(subjectType?: Type | null): Stream<FeatureBase | null>;
   ...
   */
  static search(spec: SearchFetchQuerySpec): Stream<FeatureBase | null>;
