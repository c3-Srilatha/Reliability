// TypeScript definitions for the C3 type ChangeLogListener

/**
 * Base type for all change log listeners.  Change log listeners determine what data changes require invalidation and
 * provide the information to log in the queue for each data change.  They then handle the processing for queue entries
 * that they own.
 *
 * @see ChangeLogQueue
 *
 * @remarks this represents a value passed to a method that expects an instance of ChangeLogListener
 */
declare interface IChangeLogListener<IT> {
}
 ...
 * @see ChangeLogQueue
 *
 * @remarks this represents a made instance of ChangeLogListener
 */
declare class ChangeLogListener<IT> {
   ...
   */
  static logInfo(typeRef: Type, changes?: C3.Array<DbEditList | null>, sourceOperInfo: DbSourceOperInfo): C3.Map<string | null, IT | null>;
   ...
   *        for that entry
   */
  static process(typeRef: Type, logs: C3.Map<string | null, C3.Array<IT | null>> | null): void;
