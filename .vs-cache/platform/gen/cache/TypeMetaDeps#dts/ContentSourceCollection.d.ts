// TypeScript definitions for the C3 type ContentSourceCollection
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ContentSourceCollection
 */
declare interface IContentSourceCollection {
 ...
 */
declare class ContentSourceCollection extends Obj {

  /**
   * The description of this instance.
   */
  readonly description?: string | null;
  withDescription(description: string | null): ContentSourceCollection;
  ...
  withCdcOrder(cdcOrder: string | null): ContentSourceCollection;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): ContentSourceCollection;

  /**
   * The unique and required name of this instance.
   */
  readonly name: string;
  withName(name: string): ContentSourceCollection;

  /**
   * Structure defined to serialize the content from the SourceCollection {@see Source}
   */
  readonly source?: Type | null;
  withSource(source: IType | null): ContentSourceCollection;

  /**
   * Source system for the source collection
   */
  readonly sourceSystem: SourceSystem<SourceSystem.Config | null, any>;
  withSourceSystem(sourceSystem: ISourceSystem<SourceSystem.Config | null, any>): ContentSourceCollection;
  ...
  withExternal(external: boolean): ContentSourceCollection;
  ...
  withSequential(sequential: boolean): ContentSourceCollection;

  /**
   * Indicator of whether this instance is currently being configured
   */
  readonly state?: string | null;
  withState(state: string | null): ContentSourceCollection;
  ...
  withAfterProcess(afterProcess: ILambda<λBiConsumer<SourceCollection<SourceCollection.Config | null> | null, Sources | null> | null> | null): ContentSourceCollection;

  /**
   * List of transforms to skip for SourceCollection.
   */
  readonly skippedTransforms?: C3.Array<string | null>;
  withSkippedTransforms(skippedTransforms: C3.Array<string | null> | Array<string | null>): ContentSourceCollection;
  ...
  withPatchObjsOperSpec(patchObjsOperSpec: λFunction<Content | null, IFileObjsOperSpec | null> | null): ContentSourceCollection;
  ...
  withCdcSourcesOverride(cdcSourcesOverride: ILambda<λFunction<SourceCollection.Cdc.Checkpoint | null, Stream<Source | null>> | null> | null): ContentSourceCollection;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ContentSourceCollection | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ContentSourceCollection | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ContentSourceCollection | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ContentSourceCollection | null;
   ...
   */
  replaceType(old: Type, new_: Type): ContentSourceCollection;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ContentSourceCollection;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ContentSourceCollection;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ContentSourceCollection | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ContentSourceCollection | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ContentSourceCollection;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ContentSourceCollection;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ContentSourceCollection;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ContentSourceCollection;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ContentSourceCollection;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ContentSourceCollection;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ContentSourceCollection;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ContentSourceCollection;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ContentSourceCollection;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ContentSourceCollection;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ContentSourceCollection;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ContentSourceCollection;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ContentSourceCollection;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ContentSourceCollection;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ContentSourceCollection;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ContentSourceCollection;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ContentSourceCollection;
   ...
   * @see #removeField
   */
  unsetField(field: string): ContentSourceCollection;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ContentSourceCollection;
   ...
   * @see #unsetField
   */
  removeField(field: string): ContentSourceCollection;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ContentSourceCollection;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ContentSourceCollection;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ContentSourceCollection;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ContentSourceCollection;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ContentSourceCollection;

  mergeJson(json: any | null): ContentSourceCollection;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ContentSourceCollection;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ContentSourceCollection;
   ...
   */
  singletonArray(): C3.Array<ContentSourceCollection | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ContentSourceCollection | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ContentSourceCollection | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ContentSourceCollection | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ContentSourceCollection | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ContentSourceCollection | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ContentSourceCollection | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ContentSourceCollection | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ContentSourceCollection | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ContentSourceCollection;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ContentSourceCollection;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ContentSourceCollection;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ContentSourceCollection;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ContentSourceCollection;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ContentSourceCollection;
   ...
   * @see #fromString
   */
  static make(s: string | null): ContentSourceCollection | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ContentSourceCollection;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): ContentSourceCollection;
   ...
   */
  static cachedEmptyInst(): ContentSourceCollection;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ContentSourceCollection>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ContentSourceCollection;
   ...
   */
  config(secrets?: boolean): ContentSourceCollection.Config;
   ...
   */
  static typeConfig(): ContentSourceCollection.Config;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<ContentSourceCollection | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ContentSourceCollection | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<ContentSourceCollection | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<ContentSourceCollection | null> | null>;
  ...
  save(subPath?: string | null, contentType?: string | null): ContentSourceCollection;
  ...
  update(srcObj?: ContentSourceCollection | null, spec?: UpsertSpec | null): ContentSourceCollection | null;

  upsert(srcObj?: ContentSourceCollection | null, spec?: UpsertSpec | null): ContentSourceCollection | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): ContentSourceCollection | null;
   ...
   */
  static forName(name: string | null, failIfMissing?: boolean): ContentSourceCollection | null;
   ...
   */
  static collectionsForSourceType(sourceType: Type, include?: string | null): Stream<ContentSourceCollection | null>;
   ...
   */
  setPriority(priority: number): ContentSourceCollection;

  /**
   * @return SourceCollection after clearing the priority
   */
  clearPriority(): ContentSourceCollection;
   ...
   */
  skipTransform(transformId?: string | null): ContentSourceCollection;

  /**
   * skip #transform for the source collection.
   */
  skipTransformBatch(transformIds: C3.Array<string | null> | null): ContentSourceCollection;

  /**
   * skip #transform for the source collection.
   */
  clearSkippedTransforms(transformsId: C3.Array<string | null> | null): ContentSourceCollection;

  /**
   * skip #transform for the source collection.
   */
  clearAllSkippedTransforms(): ContentSourceCollection;
