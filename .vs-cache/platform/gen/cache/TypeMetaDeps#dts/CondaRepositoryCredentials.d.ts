// TypeScript definitions for the C3 type CondaRepositoryCredentials

/**
 * Credentials to connect to a conda repository. By default we do not use any username or password.
 * This will set the credentials for all conda repositories.
 * ```js
 * CondaRepositoryCredentials.setConfigValue("username", "user", ConfigOverride.ENV);
 * CondaRepositoryCredentials.setSecretValue("password", "password", ConfigOverride.ENV);
 * ```
 * If you want to set the credentials for a specific conda repository (i.e. "conda-forge"), you can use the following which will override the previous settings.
 * id of the config is the name of the conda repository.
 * ```js
 * CondaRepositoryCredentials.forId("conda-forge").setConfigValue("username", "conda-forge-user", ConfigOverride.ENV);
 * CondaRepositoryCredentials.forId("conda-forge").setSecretValue("password", "conda-forge-password", ConfigOverride.ENV);
 * ```
 * In the above examples, we use the override level ENV but you can choose any override level you want {@link ConfigOverride}.
 *
 * @remarks this represents a value passed to a method that expects an instance of CondaRepositoryCredentials
 */
declare interface ICondaRepositoryCredentials {
 ...
 * In the above examples, we use the override level ENV but you can choose any override level you want {@link ConfigOverride}.
 *
 * @remarks this represents a made instance of CondaRepositoryCredentials
 */
declare class CondaRepositoryCredentials extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): CondaRepositoryCredentials;

  static readonly configOverride?: string | null;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): CondaRepositoryCredentials;
  ...
  withIssues(issues: C3.Array<string | null> | Array<string | null>): CondaRepositoryCredentials;
   ...
   */
  readonly id: string;
  withId(id: string): CondaRepositoryCredentials;
  ...
  withUsername(username: string | null): CondaRepositoryCredentials;
  ...
  withPassword(password: string | null): CondaRepositoryCredentials;
  ...
  withSecretKey(secretKey: string | null): CondaRepositoryCredentials;
  ...
  withProperties(properties: C3.Map<string | null, any> | {[key: string | null]: any}): CondaRepositoryCredentials;
   ...
   *          {loginTimeout, 60} specify how long wait for establishment of a database connection in seconds.
   */
  static readonly properties?: C3.Map<string | null, any>;
  ...
  withSecretProperties(secretProperties: C3.Map<string | null, any> | {[key: string | null]: any}): CondaRepositoryCredentials;
   ...
   * Example: {"password", <myPasswword>} specify the password
   */
  static readonly secretProperties?: C3.Map<string | null, any>;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): CondaRepositoryCredentials | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): CondaRepositoryCredentials | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): CondaRepositoryCredentials | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): CondaRepositoryCredentials | null;
   ...
   */
  replaceType(old: Type, new_: Type): CondaRepositoryCredentials;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): CondaRepositoryCredentials;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): CondaRepositoryCredentials;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): CondaRepositoryCredentials;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): CondaRepositoryCredentials;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): CondaRepositoryCredentials;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<CondaRepositoryCredentials | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<CondaRepositoryCredentials | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<CondaRepositoryCredentials | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<CondaRepositoryCredentials | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): CondaRepositoryCredentials;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): CondaRepositoryCredentials;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CondaRepositoryCredentials;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CondaRepositoryCredentials;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CondaRepositoryCredentials;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CondaRepositoryCredentials;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): CondaRepositoryCredentials;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): CondaRepositoryCredentials;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): CondaRepositoryCredentials;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): CondaRepositoryCredentials;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): CondaRepositoryCredentials;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): CondaRepositoryCredentials;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): CondaRepositoryCredentials;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): CondaRepositoryCredentials;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): CondaRepositoryCredentials;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): CondaRepositoryCredentials;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): CondaRepositoryCredentials;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): CondaRepositoryCredentials;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): CondaRepositoryCredentials;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): CondaRepositoryCredentials;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): CondaRepositoryCredentials;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): CondaRepositoryCredentials;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): CondaRepositoryCredentials;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): CondaRepositoryCredentials;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): CondaRepositoryCredentials;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): CondaRepositoryCredentials;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): CondaRepositoryCredentials;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): CondaRepositoryCredentials;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): CondaRepositoryCredentials;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): CondaRepositoryCredentials;
   ...
   * @see #unsetField
   */
  defaultField(field: string): CondaRepositoryCredentials;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): CondaRepositoryCredentials;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): CondaRepositoryCredentials;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): CondaRepositoryCredentials;
   ...
   * @see #removeField
   */
  unsetField(field: string): CondaRepositoryCredentials;
   ...
   * @see #removeField
   */
  static unsetField(field: string): CondaRepositoryCredentials;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): CondaRepositoryCredentials;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): CondaRepositoryCredentials;
   ...
   * @see #unsetField
   */
  removeField(field: string): CondaRepositoryCredentials;
   ...
   * @see #unsetField
   */
  static removeField(field: string): CondaRepositoryCredentials;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): CondaRepositoryCredentials;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): CondaRepositoryCredentials;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): CondaRepositoryCredentials;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): CondaRepositoryCredentials;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): CondaRepositoryCredentials;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): CondaRepositoryCredentials;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): CondaRepositoryCredentials;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): CondaRepositoryCredentials;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): CondaRepositoryCredentials;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): CondaRepositoryCredentials;

  mergeJson(json: any | null): CondaRepositoryCredentials;

  static mergeJson(json: any | null): CondaRepositoryCredentials;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): CondaRepositoryCredentials;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): CondaRepositoryCredentials;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): CondaRepositoryCredentials;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): CondaRepositoryCredentials;
   ...
   */
  singletonArray(): C3.Array<CondaRepositoryCredentials | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<CondaRepositoryCredentials | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<CondaRepositoryCredentials | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<CondaRepositoryCredentials | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<CondaRepositoryCredentials | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<CondaRepositoryCredentials | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<CondaRepositoryCredentials | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, CondaRepositoryCredentials | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, CondaRepositoryCredentials | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<CondaRepositoryCredentials | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<CondaRepositoryCredentials | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<CondaRepositoryCredentials | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): CondaRepositoryCredentials;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): CondaRepositoryCredentials;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): CondaRepositoryCredentials;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): CondaRepositoryCredentials;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): CondaRepositoryCredentials;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): CondaRepositoryCredentials;
   ...
   * @see #fromString
   */
  static make(s: string | null): CondaRepositoryCredentials | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): CondaRepositoryCredentials;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): CondaRepositoryCredentials;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): CondaRepositoryCredentials;
   ...
   */
  static cachedEmptyInst(): CondaRepositoryCredentials;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<CondaRepositoryCredentials>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): CondaRepositoryCredentials;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<CondaRepositoryCredentials | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<CondaRepositoryCredentials | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<CondaRepositoryCredentials | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): CondaRepositoryCredentials | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): CondaRepositoryCredentials | null;
   ...
   * @see findByCacheKey
   */
  getCached(): CondaRepositoryCredentials | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): CondaRepositoryCredentials | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): CondaRepositoryCredentials | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): CondaRepositoryCredentials | null;
   ...
   */
  static produce(key: string): CondaRepositoryCredentials | null;
   ...
   */
  static produceAll(): C3.Map<string | null, CondaRepositoryCredentials | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, CondaRepositoryCredentials | null>;
   ...
   */
  getConfig(): CondaRepositoryCredentials;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): CondaRepositoryCredentials;
   ...
   */
  getSecret(): CondaRepositoryCredentials;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): CondaRepositoryCredentials;
   ...
   */
  static forConfigKey(configKey: string | null): CondaRepositoryCredentials | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<CondaRepositoryCredentials | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: CondaRepositoryCredentials, override?: string | null): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: CondaRepositoryCredentials, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: CondaRepositoryCredentials, override?: string | null): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: CondaRepositoryCredentials, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): CondaRepositoryCredentials | null;
   ...
   */
  removeSecrets(): CondaRepositoryCredentials | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): CondaRepositoryCredentials | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): CondaRepositoryCredentials | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): CondaRepositoryCredentials | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): CondaRepositoryCredentials;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): CondaRepositoryCredentials;
   ...
   * @see #toString
   */
  static fromString(s: string | null): CondaRepositoryCredentials | null;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): CondaRepositoryCredentials | null;
   ...
   */
  static inst(): CondaRepositoryCredentials;
}
