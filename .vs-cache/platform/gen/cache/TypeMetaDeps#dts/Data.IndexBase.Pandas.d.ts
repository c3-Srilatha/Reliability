// TypeScript definitions for the C3 type Data.IndexBase.Pandas

/**
 * Base Index Pandas type that all Data.Index Pandas subtypes inherit from
 *
 * @remarks this represents a value passed to a method that expects an instance of Data.IndexBase.Pandas
 */
declare namespace Data.IndexBase {
...
declare namespace Data.IndexBase {
  export class Pandas extends Obj {
     ...
     */
    readonly ds: Dataset;
    withDs(ds: IDataset): Data.IndexBase.Pandas;

    /**
     * Id used to reference this Data within the Dataset to which it belongs
     */
    readonly id: string;
    withId(id: string): Data.IndexBase.Pandas;

    /**
     * PySrc that can be executed to re-create this DataImpl.Pandas
     */
    readonly _pySrc?: string | null;
    with_pySrc(_pySrc: string | null): Data.IndexBase.Pandas;

    readonly _fileName?: string | null;
    with_fileName(_fileName: string | null): Data.IndexBase.Pandas;

    /**
     * Tuple of {columnName:[value]} to create a DataImpl.Pandas from
     */
    readonly _tuple?: any;
    with_tuple(_tuple: any): Data.IndexBase.Pandas;

    /**
     * Whether the {@link #tuple} field value types can be fully supported by arrow.
     */
    readonly _arrowSupport?: boolean;
    with_arrowSupport(_arrowSupport: boolean): Data.IndexBase.Pandas;

    /**
     * All DataImpl.Pandas referenced by the pySrc
     */
    readonly _datas?: C3.Set<DataImpl.Pandas | null>;
    with_datas(_datas: C3.Set<DataImpl.Pandas | null> | Array<IDataImpl.Pandas | null>): Data.IndexBase.Pandas;

    /**
     * Pickled Pandas binary
     */
    readonly _binary?: any | null;
    with_binary(_binary: any | null): Data.IndexBase.Pandas;

    /**
     * List of pickled Pandas segments binaries
     */
    readonly _binaries?: C3.Array<any | null>;
    with_binaries(_binaries: C3.Array<any | null> | Array<any | null>): Data.IndexBase.Pandas;

    readonly _numBinarySegments?: number | null;
    with_numBinarySegments(_numBinarySegments: number | null): Data.IndexBase.Pandas;

    /**
     * Type of binary format for reading {@link Data.Persisted}
     */
    readonly _persistedFormat?: string | null;
    with_persistedFormat(_persistedFormat: string | null): Data.IndexBase.Pandas;

    /**
     * see tableName arg for {@link Feature.Store#readData}.
     */
    readonly _tableName?: string | null;
    with_tableName(_tableName: string | null): Data.IndexBase.Pandas;

    /**
     * see id arg for {@link Feature.Store#readData}.
     */
    readonly _tableEntryId?: string | null;
    with_tableEntryId(_tableEntryId: string | null): Data.IndexBase.Pandas;

    /**
     * Mapping of variable names to their values to be used by the PyAst Executor
     */
    readonly _vars?: C3.Map<string | null, any>;
    with_vars(_vars: C3.Map<string | null, any> | {[key: string | null]: any}): Data.IndexBase.Pandas;
    ...
    withMaxSegmentSizeClient(maxSegmentSizeClient: number | null): Data.IndexBase.Pandas;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.IndexBase.Pandas | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.IndexBase.Pandas | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.IndexBase.Pandas | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.IndexBase.Pandas | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.IndexBase.Pandas;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.IndexBase.Pandas;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.IndexBase.Pandas;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.IndexBase.Pandas | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.IndexBase.Pandas | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.IndexBase.Pandas;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.IndexBase.Pandas;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.IndexBase.Pandas;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.IndexBase.Pandas;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.IndexBase.Pandas;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.IndexBase.Pandas;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.IndexBase.Pandas;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.IndexBase.Pandas;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.IndexBase.Pandas;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.IndexBase.Pandas;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.IndexBase.Pandas;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.IndexBase.Pandas;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.IndexBase.Pandas;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.IndexBase.Pandas;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.IndexBase.Pandas;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.IndexBase.Pandas;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.IndexBase.Pandas;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.IndexBase.Pandas;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.IndexBase.Pandas;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.IndexBase.Pandas;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.IndexBase.Pandas;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.IndexBase.Pandas;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.IndexBase.Pandas;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.IndexBase.Pandas;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.IndexBase.Pandas;

    mergeJson(json: any | null): Data.IndexBase.Pandas;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.IndexBase.Pandas;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.IndexBase.Pandas;
     ...
     */
    singletonArray(): C3.Array<Data.IndexBase.Pandas | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.IndexBase.Pandas | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.IndexBase.Pandas | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.IndexBase.Pandas | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.IndexBase.Pandas | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.IndexBase.Pandas | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.IndexBase.Pandas | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.IndexBase.Pandas | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.IndexBase.Pandas | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.IndexBase.Pandas;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.IndexBase.Pandas;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.IndexBase.Pandas;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.IndexBase.Pandas;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.IndexBase.Pandas;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.IndexBase.Pandas;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.IndexBase.Pandas;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Data.IndexBase.Pandas;
     ...
     */
    static cachedEmptyInst(): Data.IndexBase.Pandas;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.IndexBase.Pandas>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.IndexBase.Pandas;
     ...
     */
    static fromPySrc(pySrc: string, dfs?: C3.Set<DataImpl | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): Data.IndexBase.Pandas | null;
     ...
     */
    static _jsDataProxy(inst: any): Data.IndexBase.Pandas;
     ...
     */
    static fromBinary(name: string, data: any, dataset?: Dataset | null): Data.IndexBase.Pandas | null;

    static fromBinary(name: string, data: C3.Array<any | null>, dataset?: Dataset | null): Data.IndexBase.Pandas | null;
     ...
     */
    static fromStore(name: string, tableName: string, tableEntryId: string, dataset?: Dataset | null, persistedFormat?: string | null): Data.IndexBase.Pandas | null;

    /**
     * Create an instance of DataImpl.Pandas with the provided name from a pandas binary
     */
    static fromName(name: string, binary: any, dataset?: Dataset | null): Data.IndexBase.Pandas | null;

    /**
     * Create an instance of DataImpl.Pandas with the provided name and pySrc
     */
    static fromName(name: string, pySrc: string, datas?: C3.Set<DataImpl.Pandas | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): Data.IndexBase.Pandas | null;
     ...
     */
    static fromDatasetBinaries(name: string, dataset?: Dataset | null): Data.IndexBase.Pandas | null;

    /**
     * Create an instance of DataImpl.Pandas with the provided name from a pickled binary file specified by fileName
     */
    static fromBinaryFile(name: string, fileName: string, dataset?: Dataset | null): Data.IndexBase.Pandas | null;

    /**
     * Create a new DataImpl.Pandas from a PyAST visitor context.
     * see @DataToPyAstVisitorCtx
     */
    static fromDataToPyAstVisitorCtx(ctx: DataToPyAstVisitorCtx, dataset?: Dataset | null): Data.IndexBase.Pandas | null;
     ...
     */
    static dispatch(pandas: Data.IndexBase.Pandas, name: string, args?: C3.Array<any>, kwargs?: C3.Map<string | null, any>, doNotConvertData?: boolean): any;
     ...
     *         The native pandas value will be converted to the corresponding {@link DataImpl.Pandas} subtype
     */
    static getAttribute(pandas: Data.IndexBase.Pandas, name: string, doNotConvertData?: boolean): any;
     ...
     */
    static evaluate(pandas: Data.IndexBase.Pandas): void;
     ...
     */
    static toBinary(pandas: Data.IndexBase.Pandas): any | null;
     ...
     */
    static storeBinariesInDataset(pandas: Data.IndexBase.Pandas): void;
