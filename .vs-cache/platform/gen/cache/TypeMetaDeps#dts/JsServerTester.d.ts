// TypeScript definitions for the C3 type JsServerTester

/**
 * @remarks this represents a value passed to a method that expects an instance of JsServerTester
 */
declare interface IJsServerTester {
...
/**
 * @remarks this represents a made instance of JsServerTester
 */
declare class JsServerTester extends Obj {

  testRunner: TestRunner;
  withTestRunner(testRunner: ITestRunner): JsServerTester;
   ...
   */
  state: string;
  withState(state: string): JsServerTester;

  /**
   * The collected test results after the test execution.
   */
  results?: C3.Array<TestSuiteResult | null>;
  withResults(results: C3.Array<TestSuiteResult | null> | Array<ITestSuiteResult | null>): JsServerTester;

  /**
   * The action engine in which tests will execute.
   */
  engine: Action.Engine;
  withEngine(engine: IAction.Engine): JsServerTester;

  /**
   * Construct an instance with initial state.
   */
  static make(): JsServerTester;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): JsServerTester;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): JsServerTester;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): JsServerTester;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): JsServerTester;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): JsServerTester | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): JsServerTester | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): JsServerTester | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): JsServerTester | null;
   ...
   */
  replaceType(old: Type, new_: Type): JsServerTester;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JsServerTester;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JsServerTester;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JsServerTester | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JsServerTester | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): JsServerTester;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JsServerTester;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JsServerTester;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): JsServerTester;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): JsServerTester;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): JsServerTester;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): JsServerTester;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): JsServerTester;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): JsServerTester;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): JsServerTester;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): JsServerTester;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): JsServerTester;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): JsServerTester;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): JsServerTester;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): JsServerTester;
   ...
   * @see #unsetField
   */
  defaultField(field: string): JsServerTester;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): JsServerTester;
   ...
   * @see #removeField
   */
  unsetField(field: string): JsServerTester;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): JsServerTester;
   ...
   * @see #unsetField
   */
  removeField(field: string): JsServerTester;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): JsServerTester;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): JsServerTester;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): JsServerTester;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): JsServerTester;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): JsServerTester;

  mergeJson(json: any | null): JsServerTester;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): JsServerTester;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): JsServerTester;
   ...
   */
  singletonArray(): C3.Array<JsServerTester | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<JsServerTester | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<JsServerTester | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<JsServerTester | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<JsServerTester | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, JsServerTester | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, JsServerTester | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<JsServerTester | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<JsServerTester | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): JsServerTester;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): JsServerTester;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): JsServerTester;
   ...
   */
  static cachedEmptyInst(): JsServerTester;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<JsServerTester>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): JsServerTester;
   ...
   * @return this Obj
   */
  setField(field: string, value: any, doNotConvert?: boolean): JsServerTester;
   ...
   * @return this Obj
   */
  setField(field: FieldType, value: any, doNotConvert?: boolean): JsServerTester;
   ...
   */
  static forPathAndEngine(path: string, engine: string): JsServerTester;
   ...
   * Note: invoke this API on the desired type of Tester instead of on the Tester type directly.
   */
  static forNameAndEngine(testName: string, engine: string): JsServerTester;
   ...
   * Note: invoke this API on the desired type of Tester instead of on the Tester type directly.
   */
  static forEngine(engine: string, deep?: boolean): JsServerTester;
   ...
   */
  run(spec?: TesterRunSpec | null): JsServerTester;
  ...
  /**
   * Evaluate test suite into rhino context, transpile code to es5 if necessary
   */
  evaluateTestSuite(code?: string | null, sourceName?: string | null): void;
}
