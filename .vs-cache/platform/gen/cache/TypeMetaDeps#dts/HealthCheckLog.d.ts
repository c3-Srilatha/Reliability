// TypeScript definitions for the C3 type HealthCheckLog

/**
 * Internal type keeping tack of all HealthCheck type polls.
 *
 * @remarks this represents a value passed to a method that expects an instance of HealthCheckLog
 */
declare interface IHealthCheckLog {

  /**
   * Name of the HealthCheck type
   */
  id: string;
  ...
  /**
   * Last health check instances for a HealthCheckType
   */
  last?: C3.Array<HealthCheck | null> | Array<IHealthCheck | null>;

  /**
   * Last health check poll timestamp
   */
  lastPollTimestamp?: DateTime | Date | string | null;

  /**
   * If poll is in flight then it's action's id
   */
  activePollActionId?: string | null;
}

/**
 * Internal type keeping tack of all HealthCheck type polls.
 *
 * @remarks this represents a made instance of HealthCheckLog
 */
declare class HealthCheckLog extends Obj {

  /**
   * Name of the HealthCheck type
   */
  readonly id: string;
  withId(id: string): HealthCheckLog;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): HealthCheckLog;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): HealthCheckLog;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): HealthCheckLog;
  ...
  withVersion(version: number | null): HealthCheckLog;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): HealthCheckLog;

  /**
   * Last health check instances for a HealthCheckType
   */
  readonly last?: C3.Array<HealthCheck | null>;
  withLast(last: C3.Array<HealthCheck | null> | Array<IHealthCheck | null>): HealthCheckLog;

  /**
   * Last health check poll timestamp
   */
  readonly lastPollTimestamp?: DateTime | null;
  withLastPollTimestamp(lastPollTimestamp: DateTime | Date | string | null): HealthCheckLog;

  /**
   * If poll is in flight then it's action's id
   */
  readonly activePollActionId?: string | null;
  withActivePollActionId(activePollActionId: string | null): HealthCheckLog;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): HealthCheckLog | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): HealthCheckLog | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): HealthCheckLog | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): HealthCheckLog | null;
   ...
   */
  replaceType(old: Type, new_: Type): HealthCheckLog;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HealthCheckLog;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HealthCheckLog;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HealthCheckLog | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HealthCheckLog | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): HealthCheckLog;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HealthCheckLog;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HealthCheckLog;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): HealthCheckLog;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): HealthCheckLog;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): HealthCheckLog;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): HealthCheckLog;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): HealthCheckLog;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): HealthCheckLog;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): HealthCheckLog;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): HealthCheckLog;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): HealthCheckLog;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): HealthCheckLog;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): HealthCheckLog;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): HealthCheckLog;
   ...
   * @see #unsetField
   */
  defaultField(field: string): HealthCheckLog;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): HealthCheckLog;
   ...
   * @see #removeField
   */
  unsetField(field: string): HealthCheckLog;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): HealthCheckLog;
   ...
   * @see #unsetField
   */
  removeField(field: string): HealthCheckLog;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): HealthCheckLog;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): HealthCheckLog;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): HealthCheckLog;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): HealthCheckLog;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): HealthCheckLog;

  mergeJson(json: any | null): HealthCheckLog;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): HealthCheckLog;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): HealthCheckLog;
   ...
   */
  singletonArray(): C3.Array<HealthCheckLog | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<HealthCheckLog | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<HealthCheckLog | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<HealthCheckLog | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<HealthCheckLog | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, HealthCheckLog | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, HealthCheckLog | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<HealthCheckLog | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<HealthCheckLog | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): HealthCheckLog;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): HealthCheckLog;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): HealthCheckLog;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): HealthCheckLog;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): HealthCheckLog;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): HealthCheckLog;
   ...
   * @see #fromString
   */
  static make(s: string | null): HealthCheckLog | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): HealthCheckLog;
   ...
   */
  static cachedEmptyInst(): HealthCheckLog;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<HealthCheckLog>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): HealthCheckLog;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<HealthCheckLog | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<HealthCheckLog | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<HealthCheckLog | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<HealthCheckLog | null> | null>;
   ...
   */
  get(include?: string | null): HealthCheckLog | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): HealthCheckLog | null;
   ...
   */
  getMissing(spec: GetMissingSpec): HealthCheckLog;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): HealthCheckLog | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): HealthCheckLog;
   ...
   * @see #toString
   */
  static fromString(s: string | null): HealthCheckLog | null;
   ...
   */
  create(spec?: UpsertSpec | null): HealthCheckLog | null;
   ...
   */
  static createBatch(objs: C3.Array<HealthCheckLog | null> | null, spec?: UpsertSpec | null): ObjList<HealthCheckLog | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<HealthCheckLog | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<HealthCheckLog | null> | null;
   ...
   */
  update(srcObj?: HealthCheckLog | null, spec?: UpsertSpec | null): HealthCheckLog | null;
   ...
   */
  upsert(srcObj?: HealthCheckLog | null, spec?: UpsertSpec | null): HealthCheckLog | null;
   ...
   */
  merge(spec?: MergeSpec | null): HealthCheckLog | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): HealthCheckLog | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): HealthCheckLog | null;
   ...
   */
  static updateBatch(objs: C3.Array<HealthCheckLog | null> | null, srcObjs?: C3.Array<HealthCheckLog | null>, spec?: UpsertSpec | null): ObjList<HealthCheckLog | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<HealthCheckLog | null>>, spec?: UpsertSpec | null): ObjList<HealthCheckLog | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<HealthCheckLog | null> | null, srcObjs?: C3.Array<HealthCheckLog | null>, spec?: UpsertSpec | null): ObjList<HealthCheckLog | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<HealthCheckLog | null>>, spec?: UpsertSpec | null): ObjList<HealthCheckLog | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<HealthCheckLog | null> | null, spec?: TouchSpec | null): ObjList<HealthCheckLog | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<HealthCheckLog | null> | null, spec?: MergeSpec | null): ObjList<HealthCheckLog | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<HealthCheckLog | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<HealthCheckLog | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<HealthCheckLog | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<HealthCheckLog | null> | null;
   ...
   */
  static mergeAll(mergeObj: HealthCheckLog | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: HealthCheckLog | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<HealthCheckLog | null> | null, spec?: UpsertSpec | null): ObjList<HealthCheckLog | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<HealthCheckLog | null> | null, spec?: UpsertSpec | null): ObjList<HealthCheckLog | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<HealthCheckLog | null> | null): ObjList<HealthCheckLog | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<HealthCheckLog | null> | null): ObjList<HealthCheckLog | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<HealthCheckLog | null> | null): ObjList<HealthCheckLog | null>;
   ...
   */
  static afterCreate(objs: C3.Array<HealthCheckLog | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<HealthCheckLog | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<HealthCheckLog | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<HealthCheckLog | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<HealthCheckLog | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): HealthCheckLog | null;
   ...
   */
  withoutIdentity(): HealthCheckLog | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<HealthCheckLog | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: HealthCheckLog | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<HealthCheckLog | null> | null, callback?: λFunction<HealthCheckLog | null, HealthCheckLog | null> | null): ObjList<HealthCheckLog | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<HealthCheckLog | null> | null, callback?: λFunction<HealthCheckLog | null, HealthCheckLog | null> | null): C3.Array<ObjError | null>;
  ...
  /**
   * Polls HealthCheck and updates this instance
   */
  poll(): void;
}
