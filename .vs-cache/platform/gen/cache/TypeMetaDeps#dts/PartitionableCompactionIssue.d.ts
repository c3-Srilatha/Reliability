// TypeScript definitions for the C3 type PartitionableCompactionIssue

/**
 * Partitionable compaction specific data issue type.
 *
 * @remarks this represents a value passed to a method that expects an instance of PartitionableCompactionIssue
 */
declare interface IPartitionableCompactionIssue {
 ...
 * Partitionable compaction specific data issue type.
 *
 * @remarks this represents a made instance of PartitionableCompactionIssue
 */
declare class PartitionableCompactionIssue extends Obj {

  /**
   * Target type of the obj with the issue.
   */
  readonly targetType: string;
  withTargetType(targetType: string): PartitionableCompactionIssue;

  /**
   * Id of obj with the issue.  If null, the issue applies to all objs for the `targetType`
   */
  readonly targetId?: string | null;
  withTargetId(targetId: string | null): PartitionableCompactionIssue;

  /**
   * Field with the issue.  If null, the issue applies to all fields in the `targetType` (where applicable).
   */
  readonly targetField?: string | null;
  withTargetField(targetField: string | null): PartitionableCompactionIssue;

  /**
   * DataIssue severity.
   */
  readonly severity: string;
  withSeverity(severity: string): PartitionableCompactionIssue;
  ...
  withTypeIdent(typeIdent: string | null): PartitionableCompactionIssue;
   ...
   */
  readonly id: string;
  withId(id: string): PartitionableCompactionIssue;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): PartitionableCompactionIssue;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): PartitionableCompactionIssue;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): PartitionableCompactionIssue;
  ...
  withVersion(version: number | null): PartitionableCompactionIssue;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): PartitionableCompactionIssue;

  /**
   * Error message indicating the nature of the issue.
   */
  readonly errorMsg?: string | null;
  withErrorMsg(errorMsg: string | null): PartitionableCompactionIssue;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): PartitionableCompactionIssue | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): PartitionableCompactionIssue | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): PartitionableCompactionIssue | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): PartitionableCompactionIssue | null;
   ...
   */
  replaceType(old: Type, new_: Type): PartitionableCompactionIssue;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PartitionableCompactionIssue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PartitionableCompactionIssue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PartitionableCompactionIssue | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PartitionableCompactionIssue | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): PartitionableCompactionIssue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PartitionableCompactionIssue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PartitionableCompactionIssue;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PartitionableCompactionIssue;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PartitionableCompactionIssue;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PartitionableCompactionIssue;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): PartitionableCompactionIssue;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PartitionableCompactionIssue;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PartitionableCompactionIssue;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): PartitionableCompactionIssue;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): PartitionableCompactionIssue;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): PartitionableCompactionIssue;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): PartitionableCompactionIssue;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PartitionableCompactionIssue;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): PartitionableCompactionIssue;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PartitionableCompactionIssue;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PartitionableCompactionIssue;
   ...
   * @see #removeField
   */
  unsetField(field: string): PartitionableCompactionIssue;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PartitionableCompactionIssue;
   ...
   * @see #unsetField
   */
  removeField(field: string): PartitionableCompactionIssue;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PartitionableCompactionIssue;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): PartitionableCompactionIssue;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): PartitionableCompactionIssue;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): PartitionableCompactionIssue;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): PartitionableCompactionIssue;

  mergeJson(json: any | null): PartitionableCompactionIssue;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): PartitionableCompactionIssue;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): PartitionableCompactionIssue;
   ...
   */
  singletonArray(): C3.Array<PartitionableCompactionIssue | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<PartitionableCompactionIssue | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PartitionableCompactionIssue | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<PartitionableCompactionIssue | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PartitionableCompactionIssue | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, PartitionableCompactionIssue | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PartitionableCompactionIssue | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PartitionableCompactionIssue | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PartitionableCompactionIssue | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): PartitionableCompactionIssue;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): PartitionableCompactionIssue;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): PartitionableCompactionIssue;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PartitionableCompactionIssue;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): PartitionableCompactionIssue;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PartitionableCompactionIssue;
   ...
   * @see #fromString
   */
  static make(s: string | null): PartitionableCompactionIssue | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): PartitionableCompactionIssue;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): PartitionableCompactionIssue;
   ...
   */
  static cachedEmptyInst(): PartitionableCompactionIssue;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<PartitionableCompactionIssue>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): PartitionableCompactionIssue;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<PartitionableCompactionIssue | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PartitionableCompactionIssue | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<PartitionableCompactionIssue | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<PartitionableCompactionIssue | null> | null>;
   ...
   */
  get(include?: string | null): PartitionableCompactionIssue | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): PartitionableCompactionIssue | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PartitionableCompactionIssue;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): PartitionableCompactionIssue | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PartitionableCompactionIssue;
   ...
   * @see #toString
   */
  static fromString(s: string | null): PartitionableCompactionIssue | null;
   ...
   */
  create(spec?: UpsertSpec | null): PartitionableCompactionIssue | null;
   ...
   */
  static createBatch(objs: C3.Array<PartitionableCompactionIssue | null> | null, spec?: UpsertSpec | null): ObjList<PartitionableCompactionIssue | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PartitionableCompactionIssue | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<PartitionableCompactionIssue | null> | null;
   ...
   */
  update(srcObj?: PartitionableCompactionIssue | null, spec?: UpsertSpec | null): PartitionableCompactionIssue | null;
   ...
   */
  upsert(srcObj?: PartitionableCompactionIssue | null, spec?: UpsertSpec | null): PartitionableCompactionIssue | null;
   ...
   */
  merge(spec?: MergeSpec | null): PartitionableCompactionIssue | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): PartitionableCompactionIssue | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): PartitionableCompactionIssue | null;
   ...
   */
  static updateBatch(objs: C3.Array<PartitionableCompactionIssue | null> | null, srcObjs?: C3.Array<PartitionableCompactionIssue | null>, spec?: UpsertSpec | null): ObjList<PartitionableCompactionIssue | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<PartitionableCompactionIssue | null>>, spec?: UpsertSpec | null): ObjList<PartitionableCompactionIssue | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<PartitionableCompactionIssue | null> | null, srcObjs?: C3.Array<PartitionableCompactionIssue | null>, spec?: UpsertSpec | null): ObjList<PartitionableCompactionIssue | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<PartitionableCompactionIssue | null>>, spec?: UpsertSpec | null): ObjList<PartitionableCompactionIssue | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<PartitionableCompactionIssue | null> | null, spec?: TouchSpec | null): ObjList<PartitionableCompactionIssue | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PartitionableCompactionIssue | null> | null, spec?: MergeSpec | null): ObjList<PartitionableCompactionIssue | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PartitionableCompactionIssue | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<PartitionableCompactionIssue | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<PartitionableCompactionIssue | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<PartitionableCompactionIssue | null> | null;
   ...
   */
  static mergeAll(mergeObj: PartitionableCompactionIssue | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PartitionableCompactionIssue | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<PartitionableCompactionIssue | null> | null, spec?: UpsertSpec | null): ObjList<PartitionableCompactionIssue | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<PartitionableCompactionIssue | null> | null, spec?: UpsertSpec | null): ObjList<PartitionableCompactionIssue | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): PartitionableCompactionIssue | null;
   ...
   */
  static beforeCreate(objs: C3.Array<PartitionableCompactionIssue | null> | null): ObjList<PartitionableCompactionIssue | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<PartitionableCompactionIssue | null> | null): ObjList<PartitionableCompactionIssue | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<PartitionableCompactionIssue | null> | null): ObjList<PartitionableCompactionIssue | null>;
   ...
   */
  static afterCreate(objs: C3.Array<PartitionableCompactionIssue | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<PartitionableCompactionIssue | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<PartitionableCompactionIssue | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<PartitionableCompactionIssue | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<PartitionableCompactionIssue | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): PartitionableCompactionIssue | null;
   ...
   */
  withoutIdentity(): PartitionableCompactionIssue | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<PartitionableCompactionIssue | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: PartitionableCompactionIssue | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<PartitionableCompactionIssue | null> | null, callback?: λFunction<PartitionableCompactionIssue | null, PartitionableCompactionIssue | null> | null): ObjList<PartitionableCompactionIssue | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<PartitionableCompactionIssue | null> | null, callback?: λFunction<PartitionableCompactionIssue | null, PartitionableCompactionIssue | null> | null): C3.Array<ObjError | null>;
