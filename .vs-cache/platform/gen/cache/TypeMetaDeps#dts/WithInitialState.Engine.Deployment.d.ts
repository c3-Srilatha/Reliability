// TypeScript definitions for the C3 type WithInitialState.Engine.Deployment

/**
 * Base type for {@link Engine.InitialState.Deployment} and {@link Engine.InitialState.DeploySpec}
 *
 * @remarks this represents a value passed to a method that expects an instance of WithInitialState.Engine.Deployment
 */
declare namespace WithInitialState.Engine {
  export interface IDeployment<E> {
     ...
     * @see nodeRole
     */
    altNodeRoles?: C3.Array<string | null> | Array<string | null>;
     ...
     * @see nodeRole
     */
    nodePools?: C3.Array<string | null> | Array<string | null>;
     ...
     */
    initializingNodeAvoidanceDuration?: string | null;
     ...
     */
    initialStateObjsPerActionEngine?: C3.Map<string | null, C3.Array<WithInitialState>> | {[key: string | null]: C3.Array<WithInitialState> | Array<IWithInitialState>} | null;
  }
}
 ...
 */
declare namespace WithInitialState.Engine {
  export class Deployment<E> extends Obj {

    /**
     * Name of the Engine
     */
    readonly name: string;
    withName(name: string): WithInitialState.Engine.Deployment;
    ...
    withNodeRole(nodeRole: string | null): WithInitialState.Engine.Deployment;
     ...
     * @see nodeRole
     */
    readonly altNodeRoles?: C3.Array<string | null>;
    withAltNodeRoles(altNodeRoles: C3.Array<string | null> | Array<string | null>): WithInitialState.Engine.Deployment;
     ...
     * @see nodeRole
     */
    readonly nodePools?: C3.Array<string | null>;
    withNodePools(nodePools: C3.Array<string | null> | Array<string | null>): WithInitialState.Engine.Deployment;
    ...
    withDedicatedThreadPool(dedicatedThreadPool: boolean): WithInitialState.Engine.Deployment;

    /**
     * If set to `true` then this {@link Engine} will auto start on every node of every target node-pool.
     */
    readonly autoStart?: boolean;
    withAutoStart(autoStart: boolean): WithInitialState.Engine.Deployment;
    ...
    withInactive(inactive: boolean): WithInitialState.Engine.Deployment;
    ...
    withFailActionIfEngineNotReady(failActionIfEngineNotReady: boolean): WithInitialState.Engine.Deployment;
     ...
     * avoid dispatching to {@link App.Node} that started less than 5 minutes ago.
     */
    readonly initializingNodeAvoidanceDuration?: string | null;
    withInitializingNodeAvoidanceDuration(initializingNodeAvoidanceDuration: string | null): WithInitialState.Engine.Deployment;

    readonly configOverride?: string | null;
    withConfigOverride(configOverride: string | null): WithInitialState.Engine.Deployment;

    readonly secretOverride?: string | null;
    withSecretOverride(secretOverride: string | null): WithInitialState.Engine.Deployment;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: C3.Array<string | null>;
    withIssues(issues: C3.Array<string | null> | Array<string | null>): WithInitialState.Engine.Deployment;
     ...
     * value - The list of {@link WithInitialState object}s initialized in the {@link Action.Engine engine}.
     */
    readonly initialStateObjsPerActionEngine?: C3.Map<string | null, C3.Array<WithInitialState>> | null;
    withInitialStateObjsPerActionEngine(initialStateObjsPerActionEngine: C3.Map<string | null, C3.Array<WithInitialState>> | {[key: string | null]: C3.Array<WithInitialState> | Array<IWithInitialState>} | null): WithInitialState.Engine.Deployment;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): WithInitialState.Engine.Deployment<E> | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): WithInitialState.Engine.Deployment<E> | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): WithInitialState.Engine.Deployment<E> | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): WithInitialState.Engine.Deployment<E> | null;
     ...
     */
    replaceType(old: Type, new_: Type): WithInitialState.Engine.Deployment<E>;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): WithInitialState.Engine.Deployment<E>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): WithInitialState.Engine.Deployment<E>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<WithInitialState.Engine.Deployment<E> | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<WithInitialState.Engine.Deployment<E> | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): WithInitialState.Engine.Deployment<E>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): WithInitialState.Engine.Deployment<E>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): WithInitialState.Engine.Deployment<E>;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): WithInitialState.Engine.Deployment<E>;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): WithInitialState.Engine.Deployment<E>;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): WithInitialState.Engine.Deployment<E>;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): WithInitialState.Engine.Deployment<E>;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): WithInitialState.Engine.Deployment<E>;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): WithInitialState.Engine.Deployment<E>;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): WithInitialState.Engine.Deployment<E>;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): WithInitialState.Engine.Deployment<E>;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): WithInitialState.Engine.Deployment<E>;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): WithInitialState.Engine.Deployment<E>;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): WithInitialState.Engine.Deployment<E>;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): WithInitialState.Engine.Deployment<E>;
     ...
     * @see #unsetField
     */
    defaultField(field: string): WithInitialState.Engine.Deployment<E>;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): WithInitialState.Engine.Deployment<E>;
     ...
     * @see #removeField
     */
    unsetField(field: string): WithInitialState.Engine.Deployment<E>;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): WithInitialState.Engine.Deployment<E>;
     ...
     * @see #unsetField
     */
    removeField(field: string): WithInitialState.Engine.Deployment<E>;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): WithInitialState.Engine.Deployment<E>;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): WithInitialState.Engine.Deployment<E>;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): WithInitialState.Engine.Deployment<E>;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): WithInitialState.Engine.Deployment<E>;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): WithInitialState.Engine.Deployment<E>;

    mergeJson(json: any | null): WithInitialState.Engine.Deployment<E>;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): WithInitialState.Engine.Deployment<E>;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): WithInitialState.Engine.Deployment<E>;
     ...
     */
    singletonArray(): C3.Array<WithInitialState.Engine.Deployment<E> | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<WithInitialState.Engine.Deployment<E> | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<WithInitialState.Engine.Deployment<E> | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<WithInitialState.Engine.Deployment<E> | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<WithInitialState.Engine.Deployment<E> | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, WithInitialState.Engine.Deployment<E> | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, WithInitialState.Engine.Deployment<E> | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<WithInitialState.Engine.Deployment<E> | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<WithInitialState.Engine.Deployment<E> | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): WithInitialState.Engine.Deployment<E>;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): WithInitialState.Engine.Deployment<E>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): WithInitialState.Engine.Deployment<E>;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): WithInitialState.Engine.Deployment<E>;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): WithInitialState.Engine.Deployment<E>;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): WithInitialState.Engine.Deployment<E>;
     ...
     * @see #fromString
     */
    static make(s: string | null): WithInitialState.Engine.Deployment<E> | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): WithInitialState.Engine.Deployment<E>;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): WithInitialState.Engine.Deployment<E>;
     ...
     */
    static cachedEmptyInst(): WithInitialState.Engine.Deployment<E>;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<WithInitialState.Engine.Deployment<E>>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): WithInitialState.Engine.Deployment<E>;
     ...
     */
    listNodePools(alwaysConstruct?: boolean): C3.Array<App.NodePool | null>;
     ...
     * @see #toString
     */
    static fromString(s: string | null): WithInitialState.Engine.Deployment<E> | null;
     ...
     */
    static forName(name: string | null, failIfMissing?: boolean): WithInitialState.Engine.Deployment<E> | null;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<WithInitialState.Engine.Deployment<E> | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<WithInitialState.Engine.Deployment<E> | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<WithInitialState.Engine.Deployment<E> | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): WithInitialState.Engine.Deployment<E> | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string | null): WithInitialState.Engine.Deployment<E> | null;
     ...
     * @see findByCacheKey
     */
    getCached(): WithInitialState.Engine.Deployment<E> | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): WithInitialState.Engine.Deployment<E> | null;
     ...
     */
    static produce(key: string): WithInitialState.Engine.Deployment<E> | null;
     ...
     */
    static produceAll(): C3.Map<string | null, WithInitialState.Engine.Deployment<E> | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, WithInitialState.Engine.Deployment<E> | null>;
     ...
     */
    getConfig(): WithInitialState.Engine.Deployment<E>;
     ...
     */
    getSecret(): WithInitialState.Engine.Deployment<E>;
     ...
     */
    static forConfigKey(configKey: string | null): WithInitialState.Engine.Deployment<E> | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<WithInitialState.Engine.Deployment<E> | null>;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: WithInitialState.Engine.Deployment<E>, override?: string | null): void;
     ...
     * @see setSecretValue
     */
    setSecretValues(from: WithInitialState.Engine.Deployment<E>, override?: string | null): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): WithInitialState.Engine.Deployment<E> | null;
     ...
     */
    static fromDeploySpec(spec: Engine.DeploySpec): WithInitialState.Engine.Deployment<any> | null;
  }
}
