// TypeScript definitions for the C3 type Data.FeatureSet

/**
 * A specialization of {@link Data.Lazy} that represents data evaluated from the {@link Feature.Store}.
 *
 * @remarks this represents a value passed to a method that expects an instance of Data.FeatureSet
 */
 ...
 */
declare namespace Data {
  export class FeatureSet extends Obj {
    ...
    withSTATELESS_CACHE(STATELESS_CACHE: string | null): Data.FeatureSet;
     ...
     */
    readonly this: any;
    withThis(this_: any): Data.FeatureSet;

    /**
     * Target action returning DataImpl
     */
    readonly action: string;
    withAction(action: string): Data.FeatureSet;

    /**
     * Applied arguments
     */
    readonly args?: C3.Map<string | null, any>;
    withArgs(args: C3.Map<string | null, any> | {[key: string | null]: any}): Data.FeatureSet;
    ...
    with_inferredOutType(_inferredOutType: C3.Map<string | null, ValueType | null> | {[key: string | null]: IValueType | null}): Data.FeatureSet;
    ...
    withLOCAL_FOLDER_PREFIX(LOCAL_FOLDER_PREFIX: string | null): Data.FeatureSet;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.FeatureSet | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.FeatureSet | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.FeatureSet | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.FeatureSet | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.FeatureSet;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.FeatureSet;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.FeatureSet;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.FeatureSet | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.FeatureSet | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.FeatureSet;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.FeatureSet;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.FeatureSet;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.FeatureSet;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.FeatureSet;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.FeatureSet;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.FeatureSet;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.FeatureSet;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.FeatureSet;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.FeatureSet;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.FeatureSet;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.FeatureSet;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.FeatureSet;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.FeatureSet;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.FeatureSet;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.FeatureSet;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.FeatureSet;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.FeatureSet;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.FeatureSet;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.FeatureSet;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.FeatureSet;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.FeatureSet;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.FeatureSet;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.FeatureSet;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.FeatureSet;

    mergeJson(json: any | null): Data.FeatureSet;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.FeatureSet;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.FeatureSet;
     ...
     */
    singletonArray(): C3.Array<Data.FeatureSet | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.FeatureSet | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.FeatureSet | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.FeatureSet | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.FeatureSet | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.FeatureSet | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.FeatureSet | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.FeatureSet | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.FeatureSet | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.FeatureSet;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.FeatureSet;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.FeatureSet;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.FeatureSet;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.FeatureSet;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.FeatureSet;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.FeatureSet;
     ...
     */
    static cachedEmptyInst(): Data.FeatureSet;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.FeatureSet>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.FeatureSet;
     ...
     */
    static fromPySrc(pySrc: string, dfs?: C3.Set<DataImpl | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): Data.FeatureSet | null;
     ...
     */
    static _jsDataProxy(inst: any): Data.FeatureSet;
     ...
     */
    static create(this_: any, action: string, args?: C3.Map<string | null, any>): Data.FeatureSet;
     ...
     * @return an instance of Data from the provided collection of {@link Obj}s or {@link Tuple}s
     */
    static fromCollection(col: Collection<Obj | null> | null | Collection<Tuple | null> | null, dataset?: Dataset | null, include?: string | null): Data.FeatureSet | null;
     ...
     * 1       b 2000-01-02    2.0
     */
    static fromTuple(tuple: Tuple, dataset?: Dataset | null): Data.FeatureSet | null;
     ...
     */
    streamHelper(spec?: Data.FeatureSet.StreamSpec | null): Data.Stream;
     ...
     * @see EvalFeatureSpec
     */
    subjects(): C3.Array<FeatureEvaluatable | null>;
