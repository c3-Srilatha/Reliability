// TypeScript definitions for the C3 type BigIntType

/**
 * The arbitrary-length integer value type. The semantics in languages other than Python are more or less torturous,
 * but there _is_ support in all languages. Note that `bigint` values will be significantly slower than values stored
 * in machine words that have hardware support.
 *
 * Java (not primitives):
 * ```java
 * BigInteger.TWO.pow(50).equals(new BigInteger("1125899906842624"))
 * BigInteger.TWO.pow(100).equals(new BigInteger("1267650600228229401496703205376"))
 * ```
 *
 * JavaScript (cannot intermix with regular `number` values):
 * ```js
 * 2n ** 50n === 1125899906842624n
 * 2n ** 100n === 1267650600228229401496703205376n
 * ```
 *
 * Python (natural `int` behavior):
 * ```py
 * 2 ** 50 == 1125899906842624
 * 2 ** 100 == 1267650600228229401496703205376
 * ```
 *
 * There are no fields (other than #modifier), so this is normally accessed with {@link PrimitiveType#ofBigInt}.
 *
 * @see IntType
 * @see DecimalType
 *
 * @remarks this represents a value passed to a method that expects an instance of BigIntType
 */
declare interface IBigIntType {
 ...
 * @see DecimalType
 *
 * @remarks this represents a made instance of BigIntType
 */
declare class BigIntType extends Obj {

  /**
   * Source file Pkg.Path a C3 Type declaration [.c3typ].
   */
  readonly declaredPkgPath?: string | null;
  withDeclaredPkgPath(declaredPkgPath: string | null): BigIntType;

  /**
   * Source line number in a C3 Type declaration [.c3typ] file starting with 1 where this metadata element is declared.
   */
  readonly declaredSrcLine?: number | null;
  withDeclaredSrcLine(declaredSrcLine: number | null): BigIntType;
  ...
  withDeclaredSrcCharInLine(declaredSrcCharInLine: number | null): BigIntType;
   ...
   */
  readonly pkg: Pkg;
  withPkg(pkg: IPkg): BigIntType;

  /**
   * SDK json representing instance of this type
   */
  readonly json?: any;
  withJson(json: any): BigIntType;

  /**
   * The set of annotations defined on this element of metadata represented as json value.
   */
  readonly annotationsJson?: any | null;
  withAnnotationsJson(annotationsJson: any | null): BigIntType;
  ...
  withModifier(modifier: string | null): BigIntType;
  ...
  withName(name: string): BigIntType;
  ...
  withSerializedType(serializedType: IValueType | null): BigIntType;
  ...
  withEnumRefType(enumRefType: IReferenceType | null): BigIntType;
  ...
  withDeclaredEnumValues(declaredEnumValues: C3.Array<string | null> | Array<string | null>): BigIntType;
   ...
   */
  replaceType(old: Type, new_: Type): BigIntType;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): BigIntType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): BigIntType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): BigIntType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): BigIntType | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BigIntType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BigIntType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BigIntType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BigIntType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): BigIntType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BigIntType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BigIntType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): BigIntType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): BigIntType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): BigIntType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): BigIntType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BigIntType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): BigIntType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): BigIntType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): BigIntType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): BigIntType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): BigIntType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): BigIntType;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): BigIntType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): BigIntType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): BigIntType;
   ...
   * @see #removeField
   */
  unsetField(field: string): BigIntType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): BigIntType;
   ...
   * @see #unsetField
   */
  removeField(field: string): BigIntType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): BigIntType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): BigIntType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): BigIntType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): BigIntType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): BigIntType;

  mergeJson(json: any | null): BigIntType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): BigIntType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): BigIntType;
   ...
   */
  singletonArray(): C3.Array<BigIntType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<BigIntType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BigIntType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<BigIntType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BigIntType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, BigIntType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BigIntType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BigIntType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BigIntType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): BigIntType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): BigIntType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): BigIntType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): BigIntType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): BigIntType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): BigIntType;
   ...
   * @see #fromString
   */
  static make(s: string | null): BigIntType | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): BigIntType;
   ...
   */
  static cachedEmptyInst(): BigIntType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<BigIntType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): BigIntType;
   ...
   */
  withoutDeclaredSrcPos(recursive?: boolean): BigIntType;
   ...
   */
  withAnnotation(ann: Annotation): BigIntType;
   ...
   *         value for the field
   */
  withAnnotation(ann: string, annField?: string | null, value?: any): BigIntType;
   ...
   * @see #toString
   */
  static fromString(s: string | null): BigIntType | null;
   ...
   */
  static guessType(value: any, failIfNone?: boolean): NumberType | null;
   ...
   */
  static guessConvertibleType(value: any, testContent?: boolean, failIfNone?: boolean): NumberType | null;
  ...
  /**
   * Get a double value which represents the smallest distinguishable difference between values of this numeric type.
   * For integer types, this is `0.5`, representing rounding to an integer. For inexact types, it is the smallest
   * value distinguishable across the entire range of representable values.
   */
  epsilon(): number;

  /**
   * Returns the widest NumberType of all of the passed NumberTypes. NumberTypes are ordered from narrowest to widest
   * as follows: ByteType, Int16Type, Int32Type, IntType, FloatType, DoubleType, DecimalType. Returns null if no args
   * are given or all args are null.
   */
  static widest(...types: NumberType | null[]): NumberType | null;

  /**
   * Returns the narrowest NumberType that the given number could be represented as based on its value (not
   * necessarily its actual type!) NumberTypes are ordered from narrowest to widest as follows: ByteType, Int16Type,
   * Int32Type, IntType, DoubleType. FloatType is omitted due to the complexity of differentiating between floats and
   * doubles. Defaults to double if the number doesn't fit into any other type. This differs from NumberType.guessType
   * in the following sense: NumberType.guessType(5L) -> Long; NumberType.narrowest(5L) -> Byte
   */
  static narrowest(num: number): NumberType;
}
