// TypeScript definitions for the C3 type RefreshAnalyticsBatchJob

/**
 * Batch job definitions for batch jobs started from RefreshAnalyticsTask for asynchronous processing.
 *
 * @remarks this represents a value passed to a method that expects an instance of RefreshAnalyticsBatchJob
 */
declare interface IRefreshAnalyticsBatchJob {
 ...
 */
declare class RefreshAnalyticsBatchJob extends Obj {

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun | null;
  withRun(run: IBatchJobRun | null): RefreshAnalyticsBatchJob;

  /**
   * previous job executions for this instance
   */
  readonly runs?: C3.Array<BatchJobRun | null>;
  withRuns(runs: C3.Array<BatchJobRun | null> | Array<IBatchJobRun | null>): RefreshAnalyticsBatchJob;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj | null;
  withOptions(options: IObj | null): RefreshAnalyticsBatchJob;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): RefreshAnalyticsBatchJob;
  ...
  withPriority(priority: number | null): RefreshAnalyticsBatchJob;
  ...
  withDisabled(disabled: boolean): RefreshAnalyticsBatchJob;
  ...
  withMaxConcurrency(maxConcurrency: number | null): RefreshAnalyticsBatchJob;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): RefreshAnalyticsBatchJob;
  ...
  withRunAsUser(runAsUser: boolean | null): RefreshAnalyticsBatchJob;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string | null;
  withNodePool(nodePool: string | null): RefreshAnalyticsBatchJob;
  ...
  withSkipIfRunning(skipIfRunning: boolean | null): RefreshAnalyticsBatchJob;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number | null;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): RefreshAnalyticsBatchJob;
  ...
  withPropagateActionContext(propagateActionContext: boolean): RefreshAnalyticsBatchJob;
  ...
  withTypeIdent(typeIdent: string | null): RefreshAnalyticsBatchJob;
   ...
   */
  readonly id: string;
  withId(id: string): RefreshAnalyticsBatchJob;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): RefreshAnalyticsBatchJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): RefreshAnalyticsBatchJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): RefreshAnalyticsBatchJob;
  ...
  withVersion(version: number | null): RefreshAnalyticsBatchJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): RefreshAnalyticsBatchJob;
  ...
  withAbortOnError(abortOnError: boolean): RefreshAnalyticsBatchJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): RefreshAnalyticsBatchJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): RefreshAnalyticsBatchJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): RefreshAnalyticsBatchJob | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): RefreshAnalyticsBatchJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): RefreshAnalyticsBatchJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): RefreshAnalyticsBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): RefreshAnalyticsBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<RefreshAnalyticsBatchJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<RefreshAnalyticsBatchJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): RefreshAnalyticsBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RefreshAnalyticsBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RefreshAnalyticsBatchJob;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): RefreshAnalyticsBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): RefreshAnalyticsBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): RefreshAnalyticsBatchJob;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): RefreshAnalyticsBatchJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): RefreshAnalyticsBatchJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): RefreshAnalyticsBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): RefreshAnalyticsBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): RefreshAnalyticsBatchJob;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): RefreshAnalyticsBatchJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): RefreshAnalyticsBatchJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): RefreshAnalyticsBatchJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): RefreshAnalyticsBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): RefreshAnalyticsBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): RefreshAnalyticsBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): RefreshAnalyticsBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): RefreshAnalyticsBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): RefreshAnalyticsBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): RefreshAnalyticsBatchJob;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): RefreshAnalyticsBatchJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): RefreshAnalyticsBatchJob;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): RefreshAnalyticsBatchJob;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): RefreshAnalyticsBatchJob;

  mergeJson(json: any | null): RefreshAnalyticsBatchJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): RefreshAnalyticsBatchJob;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): RefreshAnalyticsBatchJob;
   ...
   */
  singletonArray(): C3.Array<RefreshAnalyticsBatchJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<RefreshAnalyticsBatchJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<RefreshAnalyticsBatchJob | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<RefreshAnalyticsBatchJob | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<RefreshAnalyticsBatchJob | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, RefreshAnalyticsBatchJob | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, RefreshAnalyticsBatchJob | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<RefreshAnalyticsBatchJob | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<RefreshAnalyticsBatchJob | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): RefreshAnalyticsBatchJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): RefreshAnalyticsBatchJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): RefreshAnalyticsBatchJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): RefreshAnalyticsBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): RefreshAnalyticsBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): RefreshAnalyticsBatchJob;
   ...
   * @see #fromString
   */
  static make(s: string | null): RefreshAnalyticsBatchJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): RefreshAnalyticsBatchJob;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): RefreshAnalyticsBatchJob;
   ...
   */
  static cachedEmptyInst(): RefreshAnalyticsBatchJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<RefreshAnalyticsBatchJob>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): RefreshAnalyticsBatchJob;
   ...
   */
  start(options?: RefreshAnalyticsSpec | null): BatchJobStatus | null;
   ...
   */
  cleanup(options?: RefreshAnalyticsSpec | null): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun | null, BatchJobStatus | null, RefreshAnalyticsSpec | null> | null;

  failJob(run: JobRun<BatchJobStatusBase | null>): JobBase<BatchJobRun | null, BatchJobStatus | null, RefreshAnalyticsSpec | null> | null;
  ...
  validateStart(options?: RefreshAnalyticsSpec | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<RefreshAnalyticsBatchJob | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<RefreshAnalyticsBatchJob | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<RefreshAnalyticsBatchJob | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<RefreshAnalyticsBatchJob | null> | null>;
   ...
   */
  get(include?: string | null): RefreshAnalyticsBatchJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): RefreshAnalyticsBatchJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): RefreshAnalyticsBatchJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): RefreshAnalyticsBatchJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): RefreshAnalyticsBatchJob;
   ...
   * @see #toString
   */
  static fromString(s: string | null): RefreshAnalyticsBatchJob | null;
   ...
   */
  create(spec?: UpsertSpec | null): RefreshAnalyticsBatchJob | null;
   ...
   */
  static createBatch(objs: C3.Array<RefreshAnalyticsBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<RefreshAnalyticsBatchJob | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<RefreshAnalyticsBatchJob | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<RefreshAnalyticsBatchJob | null> | null;
   ...
   */
  update(srcObj?: RefreshAnalyticsBatchJob | null, spec?: UpsertSpec | null): RefreshAnalyticsBatchJob | null;
   ...
   */
  upsert(srcObj?: RefreshAnalyticsBatchJob | null, spec?: UpsertSpec | null): RefreshAnalyticsBatchJob | null;
   ...
   */
  merge(spec?: MergeSpec | null): RefreshAnalyticsBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): RefreshAnalyticsBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): RefreshAnalyticsBatchJob | null;
   ...
   */
  static updateBatch(objs: C3.Array<RefreshAnalyticsBatchJob | null> | null, srcObjs?: C3.Array<RefreshAnalyticsBatchJob | null>, spec?: UpsertSpec | null): ObjList<RefreshAnalyticsBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<RefreshAnalyticsBatchJob | null>>, spec?: UpsertSpec | null): ObjList<RefreshAnalyticsBatchJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<RefreshAnalyticsBatchJob | null> | null, srcObjs?: C3.Array<RefreshAnalyticsBatchJob | null>, spec?: UpsertSpec | null): ObjList<RefreshAnalyticsBatchJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<RefreshAnalyticsBatchJob | null>>, spec?: UpsertSpec | null): ObjList<RefreshAnalyticsBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<RefreshAnalyticsBatchJob | null> | null, spec?: TouchSpec | null): ObjList<RefreshAnalyticsBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<RefreshAnalyticsBatchJob | null> | null, spec?: MergeSpec | null): ObjList<RefreshAnalyticsBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<RefreshAnalyticsBatchJob | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<RefreshAnalyticsBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<RefreshAnalyticsBatchJob | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<RefreshAnalyticsBatchJob | null> | null;
   ...
   */
  static mergeAll(mergeObj: RefreshAnalyticsBatchJob | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: RefreshAnalyticsBatchJob | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<RefreshAnalyticsBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<RefreshAnalyticsBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<RefreshAnalyticsBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<RefreshAnalyticsBatchJob | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): RefreshAnalyticsBatchJob | null;
   ...
   */
  static beforeCreate(objs: C3.Array<RefreshAnalyticsBatchJob | null> | null): ObjList<RefreshAnalyticsBatchJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<RefreshAnalyticsBatchJob | null> | null): ObjList<RefreshAnalyticsBatchJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<RefreshAnalyticsBatchJob | null> | null): ObjList<RefreshAnalyticsBatchJob | null>;
   ...
   */
  static afterCreate(objs: C3.Array<RefreshAnalyticsBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<RefreshAnalyticsBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<RefreshAnalyticsBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<RefreshAnalyticsBatchJob | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<RefreshAnalyticsBatchJob | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): RefreshAnalyticsBatchJob | null;
   ...
   */
  withoutIdentity(): RefreshAnalyticsBatchJob | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<RefreshAnalyticsBatchJob | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: RefreshAnalyticsBatchJob | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<RefreshAnalyticsBatchJob | null> | null, callback?: λFunction<RefreshAnalyticsBatchJob | null, RefreshAnalyticsBatchJob | null> | null): ObjList<RefreshAnalyticsBatchJob | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<RefreshAnalyticsBatchJob | null> | null, callback?: λFunction<RefreshAnalyticsBatchJob | null, RefreshAnalyticsBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static doStart(job?: RefreshAnalyticsBatchJob | null, options?: RefreshAnalyticsSpec | null): void;
   ...
   */
  static processBatch(batch?: RefreshAnalyticsSpec | null, job?: RefreshAnalyticsBatchJob | null, options?: RefreshAnalyticsSpec | null): void;
   ...
   */
  static allComplete(job: RefreshAnalyticsBatchJob, options?: RefreshAnalyticsSpec | null): string | null;
   ...
   *           Options the job was run with.
   */
  static failed(job: RefreshAnalyticsBatchJob, status: BatchJobStatus, options?: RefreshAnalyticsSpec | null): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: RefreshAnalyticsSpec | null): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: C3.Array<RefreshAnalyticsSpec | null>): void;
   ...
   */
  static scheduleObjBatch(job?: RefreshAnalyticsBatchJob | null, objBatch?: ObjBatch | null, logPrefix?: string | null): number | null;
