// TypeScript definitions for the C3 type TargetStage

/**
 * @remarks this represents a value passed to a method that expects an instance of TargetStage
 */
declare interface ITargetStage {
  ...
  /**
   * This is going to be objs of type {@link Persistable} which are backed by relational stores.
   */
  obj?: IObj | null;

  /**
   * id of the obj
   * workaround for using partition key and ability to use dedup of partitionable.
   */
  objId: string;
}

/**
 * @remarks this represents a made instance of TargetStage
 */
declare class TargetStage extends Obj {

  /**
   * Partition key Bin separator used to separate partition key from bin id
   */
  readonly PK_BIN_SEPARATOR?: string | null;
  withPK_BIN_SEPARATOR(PK_BIN_SEPARATOR: string | null): TargetStage;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): TargetStage;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): TargetStage;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): TargetStage;
  ...
  withVersion(version: number | null): TargetStage;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): TargetStage;

  /**
   * This is going to be objs of type {@link Persistable} which are backed by relational stores.
   */
  readonly obj?: Obj | null;
  withObj(obj: IObj | null): TargetStage;
  ...
  withObjId(objId: string): TargetStage;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TargetStage | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TargetStage | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TargetStage | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TargetStage | null;
   ...
   */
  replaceType(old: Type, new_: Type): TargetStage;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TargetStage;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TargetStage;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TargetStage | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TargetStage | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TargetStage;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TargetStage;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TargetStage;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TargetStage;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TargetStage;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TargetStage;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TargetStage;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TargetStage;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TargetStage;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TargetStage;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TargetStage;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TargetStage;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TargetStage;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TargetStage;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TargetStage;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TargetStage;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TargetStage;
   ...
   * @see #removeField
   */
  unsetField(field: string): TargetStage;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TargetStage;
   ...
   * @see #unsetField
   */
  removeField(field: string): TargetStage;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TargetStage;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TargetStage;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TargetStage;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TargetStage;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TargetStage;

  mergeJson(json: any | null): TargetStage;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TargetStage;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TargetStage;
   ...
   */
  singletonArray(): C3.Array<TargetStage | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TargetStage | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TargetStage | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TargetStage | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TargetStage | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TargetStage | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TargetStage | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TargetStage | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TargetStage | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TargetStage;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TargetStage;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TargetStage;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TargetStage;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TargetStage;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TargetStage;
   ...
   * @see #fromString
   */
  static make(s: string | null): TargetStage | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TargetStage;
   ...
   */
  static cachedEmptyInst(): TargetStage;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TargetStage>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TargetStage;
   ...
   */
  static partition(objs?: Stream<TargetStage | null>, spec?: PartitionBucketStrategy | null): C3.Map<string | null, KvDataPartition | null>;
   ...
   */
  static fromPartitions(partitions?: Stream<KvDataPartition | null>): Stream<TargetStage | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TargetStage | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TargetStage | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TargetStage | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TargetStage | null> | null>;
   ...
   */
  get(include?: string | null): TargetStage | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TargetStage | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TargetStage;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TargetStage | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TargetStage;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TargetStage | null;
   ...
   */
  create(spec?: UpsertSpec | null): TargetStage | null;
   ...
   */
  static createBatch(objs: C3.Array<TargetStage | null> | null, spec?: UpsertSpec | null): ObjList<TargetStage | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TargetStage | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TargetStage | null> | null;
   ...
   */
  update(srcObj?: TargetStage | null, spec?: UpsertSpec | null): TargetStage | null;
   ...
   */
  upsert(srcObj?: TargetStage | null, spec?: UpsertSpec | null): TargetStage | null;
   ...
   */
  merge(spec?: MergeSpec | null): TargetStage | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TargetStage | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TargetStage | null;
   ...
   */
  static updateBatch(objs: C3.Array<TargetStage | null> | null, srcObjs?: C3.Array<TargetStage | null>, spec?: UpsertSpec | null): ObjList<TargetStage | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TargetStage | null>>, spec?: UpsertSpec | null): ObjList<TargetStage | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TargetStage | null> | null, srcObjs?: C3.Array<TargetStage | null>, spec?: UpsertSpec | null): ObjList<TargetStage | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TargetStage | null>>, spec?: UpsertSpec | null): ObjList<TargetStage | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TargetStage | null> | null, spec?: TouchSpec | null): ObjList<TargetStage | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TargetStage | null> | null, spec?: MergeSpec | null): ObjList<TargetStage | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TargetStage | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TargetStage | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TargetStage | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TargetStage | null> | null;
   ...
   */
  static mergeAll(mergeObj: TargetStage | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TargetStage | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TargetStage | null> | null, spec?: UpsertSpec | null): ObjList<TargetStage | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TargetStage | null> | null, spec?: UpsertSpec | null): ObjList<TargetStage | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TargetStage | null> | null): ObjList<TargetStage | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TargetStage | null> | null): ObjList<TargetStage | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TargetStage | null> | null): ObjList<TargetStage | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TargetStage | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TargetStage | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TargetStage | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TargetStage | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TargetStage | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TargetStage | null;
   ...
   */
  withoutIdentity(): TargetStage | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<TargetStage | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TargetStage | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TargetStage | null> | null, callback?: λFunction<TargetStage | null, TargetStage | null> | null): ObjList<TargetStage | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TargetStage | null> | null, callback?: λFunction<TargetStage | null, TargetStage | null> | null): C3.Array<ObjError | null>;
  ...
  /**
   * This will persist all the objects for the targetName.
   * e.g if TargetStage has id which is the type Id for MeasurementSeries. sweep will merge #objs in
   */
  static sweep(spec?: TargetStageSweepSpec | null): TargetStageSweep | null;

  /**
   * Creates a stream of TargetStage objs from objs.
   */
  static fromObjs(objs?: Stream<Obj | null> | null): Stream<TargetStage | null> | null;

  /**
   * Persist targetStages
   */
  static persistTargetStages(targetStages?: Stream<TargetStage | null> | null, spec?: UpsertSpec | null): void;
}
