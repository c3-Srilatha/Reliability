// TypeScript definitions for the C3 type PendingBatchJobReq

/**
 * Pending batch job scheduled during provisioning.
 *
 * @remarks this represents a value passed to a method that expects an instance of PendingBatchJobReq
 */
declare interface IPendingBatchJobReq {
 ...
 * Pending batch job scheduled during provisioning.
 *
 * @remarks this represents a made instance of PendingBatchJobReq
 */
declare class PendingBatchJobReq extends Obj {
  ...
  withTypeIdent(typeIdent: string | null): PendingBatchJobReq;
   ...
   */
  readonly id: string;
  withId(id: string): PendingBatchJobReq;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): PendingBatchJobReq;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): PendingBatchJobReq;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): PendingBatchJobReq;
  ...
  withVersion(version: number | null): PendingBatchJobReq;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): PendingBatchJobReq;

  /**
   * Type to refresh.
   */
  readonly refreshType?: Type | null;
  withRefreshType(refreshType: IType | null): PendingBatchJobReq;

  /**
   * Id of the pending job.
   */
  readonly jobId: string;
  withJobId(jobId: string): PendingBatchJobReq;

  /**
   * Options to run the job with.
   */
  readonly options?: any;
  withOptions(options: any): PendingBatchJobReq;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): PendingBatchJobReq | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): PendingBatchJobReq | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): PendingBatchJobReq | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): PendingBatchJobReq | null;
   ...
   */
  replaceType(old: Type, new_: Type): PendingBatchJobReq;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PendingBatchJobReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PendingBatchJobReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PendingBatchJobReq | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PendingBatchJobReq | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): PendingBatchJobReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PendingBatchJobReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PendingBatchJobReq;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PendingBatchJobReq;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PendingBatchJobReq;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PendingBatchJobReq;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): PendingBatchJobReq;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PendingBatchJobReq;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PendingBatchJobReq;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): PendingBatchJobReq;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): PendingBatchJobReq;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): PendingBatchJobReq;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): PendingBatchJobReq;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PendingBatchJobReq;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): PendingBatchJobReq;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PendingBatchJobReq;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PendingBatchJobReq;
   ...
   * @see #removeField
   */
  unsetField(field: string): PendingBatchJobReq;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PendingBatchJobReq;
   ...
   * @see #unsetField
   */
  removeField(field: string): PendingBatchJobReq;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PendingBatchJobReq;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): PendingBatchJobReq;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): PendingBatchJobReq;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): PendingBatchJobReq;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): PendingBatchJobReq;

  mergeJson(json: any | null): PendingBatchJobReq;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): PendingBatchJobReq;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): PendingBatchJobReq;
   ...
   */
  singletonArray(): C3.Array<PendingBatchJobReq | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<PendingBatchJobReq | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PendingBatchJobReq | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<PendingBatchJobReq | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PendingBatchJobReq | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, PendingBatchJobReq | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PendingBatchJobReq | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PendingBatchJobReq | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PendingBatchJobReq | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): PendingBatchJobReq;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): PendingBatchJobReq;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): PendingBatchJobReq;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PendingBatchJobReq;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): PendingBatchJobReq;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PendingBatchJobReq;
   ...
   * @see #fromString
   */
  static make(s: string | null): PendingBatchJobReq | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): PendingBatchJobReq;
   ...
   */
  static cachedEmptyInst(): PendingBatchJobReq;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<PendingBatchJobReq>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): PendingBatchJobReq;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<PendingBatchJobReq | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PendingBatchJobReq | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<PendingBatchJobReq | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<PendingBatchJobReq | null> | null>;
   ...
   */
  get(include?: string | null): PendingBatchJobReq | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): PendingBatchJobReq | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PendingBatchJobReq;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): PendingBatchJobReq | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PendingBatchJobReq;
   ...
   * @see #toString
   */
  static fromString(s: string | null): PendingBatchJobReq | null;
   ...
   */
  create(spec?: UpsertSpec | null): PendingBatchJobReq | null;
   ...
   */
  static createBatch(objs: C3.Array<PendingBatchJobReq | null> | null, spec?: UpsertSpec | null): ObjList<PendingBatchJobReq | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PendingBatchJobReq | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<PendingBatchJobReq | null> | null;
   ...
   */
  update(srcObj?: PendingBatchJobReq | null, spec?: UpsertSpec | null): PendingBatchJobReq | null;
   ...
   */
  upsert(srcObj?: PendingBatchJobReq | null, spec?: UpsertSpec | null): PendingBatchJobReq | null;
   ...
   */
  merge(spec?: MergeSpec | null): PendingBatchJobReq | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): PendingBatchJobReq | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): PendingBatchJobReq | null;
   ...
   */
  static updateBatch(objs: C3.Array<PendingBatchJobReq | null> | null, srcObjs?: C3.Array<PendingBatchJobReq | null>, spec?: UpsertSpec | null): ObjList<PendingBatchJobReq | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<PendingBatchJobReq | null>>, spec?: UpsertSpec | null): ObjList<PendingBatchJobReq | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<PendingBatchJobReq | null> | null, srcObjs?: C3.Array<PendingBatchJobReq | null>, spec?: UpsertSpec | null): ObjList<PendingBatchJobReq | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<PendingBatchJobReq | null>>, spec?: UpsertSpec | null): ObjList<PendingBatchJobReq | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<PendingBatchJobReq | null> | null, spec?: TouchSpec | null): ObjList<PendingBatchJobReq | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PendingBatchJobReq | null> | null, spec?: MergeSpec | null): ObjList<PendingBatchJobReq | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PendingBatchJobReq | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<PendingBatchJobReq | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<PendingBatchJobReq | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<PendingBatchJobReq | null> | null;
   ...
   */
  static mergeAll(mergeObj: PendingBatchJobReq | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PendingBatchJobReq | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<PendingBatchJobReq | null> | null, spec?: UpsertSpec | null): ObjList<PendingBatchJobReq | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<PendingBatchJobReq | null> | null, spec?: UpsertSpec | null): ObjList<PendingBatchJobReq | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): PendingBatchJobReq | null;
   ...
   */
  static beforeCreate(objs: C3.Array<PendingBatchJobReq | null> | null): ObjList<PendingBatchJobReq | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<PendingBatchJobReq | null> | null): ObjList<PendingBatchJobReq | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<PendingBatchJobReq | null> | null): ObjList<PendingBatchJobReq | null>;
   ...
   */
  static afterCreate(objs: C3.Array<PendingBatchJobReq | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<PendingBatchJobReq | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<PendingBatchJobReq | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<PendingBatchJobReq | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<PendingBatchJobReq | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): PendingBatchJobReq | null;
   ...
   */
  withoutIdentity(): PendingBatchJobReq | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<PendingBatchJobReq | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: PendingBatchJobReq | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<PendingBatchJobReq | null> | null, callback?: λFunction<PendingBatchJobReq | null, PendingBatchJobReq | null> | null): ObjList<PendingBatchJobReq | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<PendingBatchJobReq | null> | null, callback?: λFunction<PendingBatchJobReq | null, PendingBatchJobReq | null> | null): C3.Array<ObjError | null>;
