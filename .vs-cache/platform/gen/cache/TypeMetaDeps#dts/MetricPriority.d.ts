// TypeScript definitions for the C3 type MetricPriority

/**
 * Computed priorities to use for the priority value in the analytics/metrics queues for specific src objs.
 *
 * @remarks this represents a value passed to a method that expects an instance of MetricPriority
 */
declare interface IMetricPriority {
  ...
  /**
   * Priority for the entry.  The entry can be identified by the id which is composed of <srcTypeId>_<metricGroupOrName>_<srcObjId>
   */
 ...
 * Computed priorities to use for the priority value in the analytics/metrics queues for specific src objs.
 *
 * @remarks this represents a made instance of MetricPriority
 */
declare class MetricPriority extends Obj {
   ...
   */
  readonly id: string;
  withId(id: string): MetricPriority;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): MetricPriority;

  /**
   * Name is not persisted
   */
  readonly name?: string | null;
  withName(name: string | null): MetricPriority;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): MetricPriority;

  /**
   * Version is not persisted
   */
  readonly version?: number | null;
  withVersion(version: number | null): MetricPriority;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): MetricPriority;

  /**
   * Priority for the entry.  The entry can be identified by the id which is composed of <srcTypeId>_<metricGroupOrName>_<srcObjId>
   */
  readonly priority?: number | null;
  withPriority(priority: number | null): MetricPriority;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): MetricPriority | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): MetricPriority | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): MetricPriority | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): MetricPriority | null;
   ...
   */
  replaceType(old: Type, new_: Type): MetricPriority;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MetricPriority;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MetricPriority;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MetricPriority | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MetricPriority | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): MetricPriority;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MetricPriority;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MetricPriority;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): MetricPriority;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): MetricPriority;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): MetricPriority;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): MetricPriority;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): MetricPriority;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): MetricPriority;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): MetricPriority;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): MetricPriority;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): MetricPriority;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): MetricPriority;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): MetricPriority;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): MetricPriority;
   ...
   * @see #unsetField
   */
  defaultField(field: string): MetricPriority;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): MetricPriority;
   ...
   * @see #removeField
   */
  unsetField(field: string): MetricPriority;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): MetricPriority;
   ...
   * @see #unsetField
   */
  removeField(field: string): MetricPriority;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): MetricPriority;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): MetricPriority;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): MetricPriority;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): MetricPriority;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): MetricPriority;

  mergeJson(json: any | null): MetricPriority;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): MetricPriority;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): MetricPriority;
   ...
   */
  singletonArray(): C3.Array<MetricPriority | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<MetricPriority | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<MetricPriority | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<MetricPriority | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<MetricPriority | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, MetricPriority | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, MetricPriority | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<MetricPriority | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<MetricPriority | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): MetricPriority;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): MetricPriority;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): MetricPriority;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): MetricPriority;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): MetricPriority;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): MetricPriority;
   ...
   * @see #fromString
   */
  static make(s: string | null): MetricPriority | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): MetricPriority;
   ...
   */
  static cachedEmptyInst(): MetricPriority;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<MetricPriority>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): MetricPriority;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<MetricPriority | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<MetricPriority | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<MetricPriority | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<MetricPriority | null> | null>;
   ...
   */
  get(include?: string | null): MetricPriority | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): MetricPriority | null;
   ...
   */
  getMissing(spec: GetMissingSpec): MetricPriority;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): MetricPriority | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): MetricPriority;
   ...
   * @see #toString
   */
  static fromString(s: string | null): MetricPriority | null;
   ...
   */
  create(spec?: UpsertSpec | null): MetricPriority | null;
   ...
   */
  static createBatch(objs: C3.Array<MetricPriority | null> | null, spec?: UpsertSpec | null): ObjList<MetricPriority | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<MetricPriority | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<MetricPriority | null> | null;
   ...
   */
  update(srcObj?: MetricPriority | null, spec?: UpsertSpec | null): MetricPriority | null;
   ...
   */
  upsert(srcObj?: MetricPriority | null, spec?: UpsertSpec | null): MetricPriority | null;
   ...
   */
  merge(spec?: MergeSpec | null): MetricPriority | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): MetricPriority | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): MetricPriority | null;
   ...
   */
  static updateBatch(objs: C3.Array<MetricPriority | null> | null, srcObjs?: C3.Array<MetricPriority | null>, spec?: UpsertSpec | null): ObjList<MetricPriority | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<MetricPriority | null>>, spec?: UpsertSpec | null): ObjList<MetricPriority | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<MetricPriority | null> | null, srcObjs?: C3.Array<MetricPriority | null>, spec?: UpsertSpec | null): ObjList<MetricPriority | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<MetricPriority | null>>, spec?: UpsertSpec | null): ObjList<MetricPriority | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<MetricPriority | null> | null, spec?: TouchSpec | null): ObjList<MetricPriority | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<MetricPriority | null> | null, spec?: MergeSpec | null): ObjList<MetricPriority | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<MetricPriority | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<MetricPriority | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<MetricPriority | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<MetricPriority | null> | null;
   ...
   */
  static mergeAll(mergeObj: MetricPriority | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: MetricPriority | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<MetricPriority | null> | null, spec?: UpsertSpec | null): ObjList<MetricPriority | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<MetricPriority | null> | null, spec?: UpsertSpec | null): ObjList<MetricPriority | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<MetricPriority | null> | null): ObjList<MetricPriority | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<MetricPriority | null> | null): ObjList<MetricPriority | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<MetricPriority | null> | null): ObjList<MetricPriority | null>;
   ...
   */
  static afterCreate(objs: C3.Array<MetricPriority | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<MetricPriority | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<MetricPriority | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<MetricPriority | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<MetricPriority | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): MetricPriority | null;
   ...
   */
  withoutIdentity(): MetricPriority | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<MetricPriority | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: MetricPriority | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<MetricPriority | null> | null, callback?: λFunction<MetricPriority | null, MetricPriority | null> | null): ObjList<MetricPriority | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<MetricPriority | null> | null, callback?: λFunction<MetricPriority | null, MetricPriority | null> | null): C3.Array<ObjError | null>;
  ...
  /**
   * Gets the priority to use for creating an analytics or metrics queue entry
   *
   * @param srcTypeId
   *        Source type id.
   * @param metricGroupOrName
   *        Metric group (for analytics queue) or metric name (for metrics queue).
   * @param srcObjId
   *        Source obj id
   *
   * @return Priority for the requested source obj, or max int if no priority is found
   */
  static priorityForSource(srcTypeId: number, metricGroupOrName: string, srcObjId: string): number;
}
