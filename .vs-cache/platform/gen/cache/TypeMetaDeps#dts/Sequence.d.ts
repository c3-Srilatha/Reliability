// TypeScript definitions for the C3 type Sequence

/**
 * To support sequence generation that is consistent in cluster.
 * e.g: Pkg.Store.Seq, ExMachina.Seq
 *
 * @remarks this represents a value passed to a method that expects an instance of Sequence
 */
declare interface ISequence {
 ...
 * e.g: Pkg.Store.Seq, ExMachina.Seq
 *
 * @remarks this represents a made instance of Sequence
 */
declare class Sequence extends Obj {
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Sequence;
  ...
  withName(name: string | null): Sequence;
  ...
  withMeta(meta: IMeta | null): Sequence;
  ...
  withVersion(version: number | null): Sequence;
  ...
  withTypeWithBindings(typeWithBindings: IType | null): Sequence;
  ...
  withSeq(seq: number | null): Sequence;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Sequence | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Sequence | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Sequence | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Sequence | null;
   ...
   */
  replaceType(old: Type, new_: Type): Sequence;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): Sequence;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Sequence;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Sequence;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Sequence;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Sequence;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Sequence | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Sequence | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Sequence | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Sequence | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Sequence;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Sequence;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Sequence;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Sequence;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Sequence;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Sequence;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Sequence;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): Sequence;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Sequence;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): Sequence;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Sequence;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Sequence;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Sequence;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Sequence;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Sequence;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): Sequence;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Sequence;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): Sequence;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Sequence;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): Sequence;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Sequence;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): Sequence;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Sequence;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Sequence;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Sequence;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): Sequence;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Sequence;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Sequence;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Sequence;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): Sequence;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Sequence;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): Sequence;
   ...
   * @see #removeField
   */
  unsetField(field: string): Sequence;
   ...
   * @see #removeField
   */
  static unsetField(field: string): Sequence;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Sequence;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): Sequence;
   ...
   * @see #unsetField
   */
  removeField(field: string): Sequence;
   ...
   * @see #unsetField
   */
  static removeField(field: string): Sequence;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Sequence;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): Sequence;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Sequence;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Sequence;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Sequence;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): Sequence;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Sequence;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Sequence;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Sequence;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Sequence;

  mergeJson(json: any | null): Sequence;

  static mergeJson(json: any | null): Sequence;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Sequence;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Sequence;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Sequence;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): Sequence;
   ...
   */
  singletonArray(): C3.Array<Sequence | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<Sequence | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Sequence | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Sequence | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Sequence | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<Sequence | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Sequence | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Sequence | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Sequence | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Sequence | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<Sequence | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Sequence | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Sequence;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Sequence;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Sequence;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Sequence;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Sequence;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Sequence;
   ...
   * @see #fromString
   */
  static make(s: string | null): Sequence | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Sequence;
   ...
   */
  static cachedEmptyInst(): Sequence;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Sequence>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Sequence;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<Sequence | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<Sequence | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Sequence | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Sequence | null> | null>;
   ...
   */
  get(include?: string | null): Sequence | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  static get(include?: string | null): Sequence | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): Sequence | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  static getSpecific(include?: string | null): Sequence | null;
   ...
   */
  getMissing(spec: GetMissingSpec): Sequence;
   ...
   * @return instance of the obj with all requested fields.
   */
  static getMissing(spec: GetMissingSpec): Sequence;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): Sequence | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  static getDirect(include?: string | null): Sequence | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): Sequence;
   ...
   * @return The instance after applying the reverse edit.
   */
  static applyReverseEdit(versionEdit: VersionEdit): Sequence;
   ...
   * @see #toString
   */
  static fromString(s: string | null): Sequence | null;
   ...
   */
  create(spec?: UpsertSpec | null): Sequence | null;
   ...
   *         will have only those fields populated. Otherwise only the id field will be populated.
   */
  static create(spec?: UpsertSpec | null): Sequence | null;
   ...
   */
  static createBatch(objs: C3.Array<Sequence | null> | null, spec?: UpsertSpec | null): ObjList<Sequence | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<Sequence | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Sequence | null> | null;
   ...
   */
  update(srcObj?: Sequence | null, spec?: UpsertSpec | null): Sequence | null;
   ...
   *         obj will have only those fields populated. Otherwise only the id field will be populated.
   */
  static update(srcObj?: Sequence | null, spec?: UpsertSpec | null): Sequence | null;
   ...
   */
  upsert(srcObj?: Sequence | null, spec?: UpsertSpec | null): Sequence | null;
   ...
   *         returned obj will have only those fields populated. Otherwise only the id field will be populated.
   */
  static upsert(srcObj?: Sequence | null, spec?: UpsertSpec | null): Sequence | null;
   ...
   */
  merge(spec?: MergeSpec | null): Sequence | null;
   ...
   * @see Mergespec#csvInclude
   */
  static merge(spec?: MergeSpec | null): Sequence | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): Sequence | null;
   ...
   * @return The created or updated obj.
   */
  static merge(mergeInclude: string, spec?: MergeSpec | null): Sequence | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): Sequence | null;
   ...
   * @return The created or updated obj.
   */
  static touch(spec?: TouchSpec | null): Sequence | null;
   ...
   */
  static updateBatch(objs: C3.Array<Sequence | null> | null, srcObjs?: C3.Array<Sequence | null>, spec?: UpsertSpec | null): ObjList<Sequence | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<Sequence | null>>, spec?: UpsertSpec | null): ObjList<Sequence | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<Sequence | null> | null, srcObjs?: C3.Array<Sequence | null>, spec?: UpsertSpec | null): ObjList<Sequence | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<Sequence | null>>, spec?: UpsertSpec | null): ObjList<Sequence | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<Sequence | null> | null, spec?: TouchSpec | null): ObjList<Sequence | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Sequence | null> | null, spec?: MergeSpec | null): ObjList<Sequence | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Sequence | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Sequence | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<Sequence | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Sequence | null> | null;
   ...
   */
  static mergeAll(mergeObj: Sequence | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: Sequence | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<Sequence | null> | null, spec?: UpsertSpec | null): ObjList<Sequence | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<Sequence | null> | null, spec?: UpsertSpec | null): ObjList<Sequence | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<Sequence | null> | null): ObjList<Sequence | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<Sequence | null> | null): ObjList<Sequence | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<Sequence | null> | null): ObjList<Sequence | null>;
   ...
   */
  static afterCreate(objs: C3.Array<Sequence | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<Sequence | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<Sequence | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<Sequence | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Sequence | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): Sequence | null;
   ...
   * @return The requested obj without any of its identifying fields.
   */
  static withoutIdentity(): Sequence | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<Sequence | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: Sequence | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<Sequence | null> | null, callback?: λFunction<Sequence | null, Sequence | null> | null): ObjList<Sequence | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<Sequence | null> | null, callback?: λFunction<Sequence | null, Sequence | null> | null): C3.Array<ObjError | null>;
