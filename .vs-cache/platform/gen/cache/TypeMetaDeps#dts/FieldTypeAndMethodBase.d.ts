// TypeScript definitions for the C3 type FieldTypeAndMethodBase

/**
 * Base type for FieldType and Method
 *
 * @remarks this represents a value passed to a method that expects an instance of FieldTypeAndMethodBase
 */
declare interface IFieldTypeAndMethodBase {
 ...
 * Base type for FieldType and Method
 *
 * @remarks this represents a made instance of FieldTypeAndMethodBase
 */
declare class FieldTypeAndMethodBase extends Obj {

  /**
   * Source file Pkg.Path a C3 Type declaration [.c3typ].
   */
  readonly declaredPkgPath?: string | null;
  withDeclaredPkgPath(declaredPkgPath: string | null): FieldTypeAndMethodBase;

  /**
   * Source line number in a C3 Type declaration [.c3typ] file starting with 1 where this metadata element is declared.
   */
  readonly declaredSrcLine?: number | null;
  withDeclaredSrcLine(declaredSrcLine: number | null): FieldTypeAndMethodBase;
  ...
  withDeclaredSrcCharInLine(declaredSrcCharInLine: number | null): FieldTypeAndMethodBase;
   ...
   */
  readonly pkg: Pkg;
  withPkg(pkg: IPkg): FieldTypeAndMethodBase;

  /**
   * SDK json representing instance of this type
   */
  readonly json?: any;
  withJson(json: any): FieldTypeAndMethodBase;

  /**
   * The set of annotations defined on this element of metadata represented as json value.
   */
  readonly annotationsJson?: any | null;
  withAnnotationsJson(annotationsJson: any | null): FieldTypeAndMethodBase;
  ...
  withDoc(doc: string | null): FieldTypeAndMethodBase;

  readonly docSingleLine?: boolean;
  withDocSingleLine(docSingleLine: boolean): FieldTypeAndMethodBase;

  /**
   * The name of this instance.
   */
  readonly name?: string | null;
  withName(name: string | null): FieldTypeAndMethodBase;
   ...
   */
  replaceType(old: Type, new_: Type): FieldTypeAndMethodBase;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): FieldTypeAndMethodBase | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): FieldTypeAndMethodBase | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): FieldTypeAndMethodBase | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): FieldTypeAndMethodBase | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FieldTypeAndMethodBase;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FieldTypeAndMethodBase;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FieldTypeAndMethodBase | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FieldTypeAndMethodBase | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): FieldTypeAndMethodBase;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FieldTypeAndMethodBase;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FieldTypeAndMethodBase;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FieldTypeAndMethodBase;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FieldTypeAndMethodBase;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FieldTypeAndMethodBase;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): FieldTypeAndMethodBase;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FieldTypeAndMethodBase;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FieldTypeAndMethodBase;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): FieldTypeAndMethodBase;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): FieldTypeAndMethodBase;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): FieldTypeAndMethodBase;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): FieldTypeAndMethodBase;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FieldTypeAndMethodBase;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): FieldTypeAndMethodBase;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FieldTypeAndMethodBase;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FieldTypeAndMethodBase;
   ...
   * @see #removeField
   */
  unsetField(field: string): FieldTypeAndMethodBase;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FieldTypeAndMethodBase;
   ...
   * @see #unsetField
   */
  removeField(field: string): FieldTypeAndMethodBase;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FieldTypeAndMethodBase;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): FieldTypeAndMethodBase;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): FieldTypeAndMethodBase;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): FieldTypeAndMethodBase;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): FieldTypeAndMethodBase;

  mergeJson(json: any | null): FieldTypeAndMethodBase;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): FieldTypeAndMethodBase;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): FieldTypeAndMethodBase;
   ...
   */
  singletonArray(): C3.Array<FieldTypeAndMethodBase | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<FieldTypeAndMethodBase | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FieldTypeAndMethodBase | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<FieldTypeAndMethodBase | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FieldTypeAndMethodBase | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, FieldTypeAndMethodBase | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FieldTypeAndMethodBase | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FieldTypeAndMethodBase | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FieldTypeAndMethodBase | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): FieldTypeAndMethodBase;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): FieldTypeAndMethodBase;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): FieldTypeAndMethodBase;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FieldTypeAndMethodBase;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): FieldTypeAndMethodBase;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FieldTypeAndMethodBase;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): FieldTypeAndMethodBase;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): FieldTypeAndMethodBase;
   ...
   */
  static cachedEmptyInst(): FieldTypeAndMethodBase;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<FieldTypeAndMethodBase>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): FieldTypeAndMethodBase;
   ...
   */
  withoutDeclaredSrcPos(recursive?: boolean): FieldTypeAndMethodBase;
   ...
   */
  withAnnotation(ann: Annotation): FieldTypeAndMethodBase;
   ...
   *         value for the field
   */
  withAnnotation(ann: string, annField?: string | null, value?: any): FieldTypeAndMethodBase;
   ...
   */
  static fromRef(ref: Obj, failIfMissing?: boolean): FieldTypeAndMethodBase;
   ...
   */
  build(): FieldTypeAndMethodBase | null;
}
