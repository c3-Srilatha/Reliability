// TypeScript definitions for the C3 type Metric

/**
 * Base type for Simple and Compound Metrics.
 *
 * @remarks this represents a value passed to a method that expects an instance of Metric
 */
declare interface IMetric {
 ...
 */
declare class Metric extends Obj {

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): Metric;

  /**
   * Name of the metric
   */
  readonly name: string;
  withName(name: string): Metric;
  ...
  withUnit(unit: IUnit | null): Metric;
  ...
  withExpression(expression: string | null): Metric;

  /**
   * Translated label (based on name as key).
   */
  readonly label?: string | null;
  withLabel(label: string | null): Metric;

  /**
   * Description of the metric
   */
  readonly description?: string | null;
  withDescription(description: string | null): Metric;
  ...
  withVariables(variables: C3.Array<MetricVariable | null> | Array<IMetricVariable | null>): Metric;
  ...
  withAcronym(acronym: string | null): Metric;

  /**
   * Tags that give information about the categories of a metric
   */
  readonly tags?: C3.Array<string | null>;
  withTags(tags: C3.Array<string | null> | Array<string | null>): Metric;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Metric | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Metric | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Metric | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Metric | null;
   ...
   */
  replaceType(old: Type, new_: Type): Metric;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Metric;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Metric;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Metric | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Metric | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Metric;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Metric;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Metric;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Metric;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Metric;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Metric;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Metric;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Metric;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Metric;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Metric;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Metric;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Metric;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Metric;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Metric;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Metric;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Metric;
   ...
   * @see #removeField
   */
  unsetField(field: string): Metric;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Metric;
   ...
   * @see #unsetField
   */
  removeField(field: string): Metric;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Metric;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Metric;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Metric;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Metric;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Metric;

  mergeJson(json: any | null): Metric;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Metric;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Metric;
   ...
   */
  singletonArray(): C3.Array<Metric | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Metric | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Metric | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Metric | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Metric | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Metric | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Metric | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Metric | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Metric | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Metric;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Metric;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Metric;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Metric;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Metric;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Metric;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Metric;
   ...
   */
  static cachedEmptyInst(): Metric;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Metric>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Metric;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<Metric | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<Metric | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Metric | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Metric | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<Metric | null>;

  save(subPath?: string | null, contentType?: string | null): Metric;
  ...
  update(srcObj?: Metric | null, spec?: UpsertSpec | null): Metric | null;

  upsert(srcObj?: Metric | null, spec?: UpsertSpec | null): Metric | null;
