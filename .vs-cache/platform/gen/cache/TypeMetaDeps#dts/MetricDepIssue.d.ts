// TypeScript definitions for the C3 type MetricDepIssue

/**
 * Metric deps specific data issue type.
 *
 * @remarks this represents a value passed to a method that expects an instance of MetricDepIssue
 */
declare interface IMetricDepIssue {
 ...
 * Metric deps specific data issue type.
 *
 * @remarks this represents a made instance of MetricDepIssue
 */
declare class MetricDepIssue extends Obj {

  /**
   * Target type of the obj with the issue.
   */
  readonly targetType: string;
  withTargetType(targetType: string): MetricDepIssue;

  /**
   * Id of obj with the issue.  If null, the issue applies to all objs for the `targetType`
   */
  readonly targetId?: string | null;
  withTargetId(targetId: string | null): MetricDepIssue;

  /**
   * Field with the issue.  If null, the issue applies to all fields in the `targetType` (where applicable).
   */
  readonly targetField?: string | null;
  withTargetField(targetField: string | null): MetricDepIssue;

  /**
   * DataIssue severity.
   */
  readonly severity: string;
  withSeverity(severity: string): MetricDepIssue;
  ...
  withTypeIdent(typeIdent: string | null): MetricDepIssue;
   ...
   */
  readonly id: string;
  withId(id: string): MetricDepIssue;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): MetricDepIssue;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): MetricDepIssue;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): MetricDepIssue;
  ...
  withVersion(version: number | null): MetricDepIssue;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): MetricDepIssue;

  /**
   * Error message indicating the nature of the issue.
   */
  readonly errorMsg?: string | null;
  withErrorMsg(errorMsg: string | null): MetricDepIssue;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): MetricDepIssue | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): MetricDepIssue | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): MetricDepIssue | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): MetricDepIssue | null;
   ...
   */
  replaceType(old: Type, new_: Type): MetricDepIssue;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MetricDepIssue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MetricDepIssue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MetricDepIssue | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MetricDepIssue | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): MetricDepIssue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MetricDepIssue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MetricDepIssue;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): MetricDepIssue;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): MetricDepIssue;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): MetricDepIssue;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): MetricDepIssue;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): MetricDepIssue;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): MetricDepIssue;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): MetricDepIssue;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): MetricDepIssue;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): MetricDepIssue;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): MetricDepIssue;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): MetricDepIssue;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): MetricDepIssue;
   ...
   * @see #unsetField
   */
  defaultField(field: string): MetricDepIssue;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): MetricDepIssue;
   ...
   * @see #removeField
   */
  unsetField(field: string): MetricDepIssue;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): MetricDepIssue;
   ...
   * @see #unsetField
   */
  removeField(field: string): MetricDepIssue;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): MetricDepIssue;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): MetricDepIssue;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): MetricDepIssue;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): MetricDepIssue;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): MetricDepIssue;

  mergeJson(json: any | null): MetricDepIssue;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): MetricDepIssue;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): MetricDepIssue;
   ...
   */
  singletonArray(): C3.Array<MetricDepIssue | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<MetricDepIssue | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<MetricDepIssue | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<MetricDepIssue | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<MetricDepIssue | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, MetricDepIssue | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, MetricDepIssue | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<MetricDepIssue | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<MetricDepIssue | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): MetricDepIssue;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): MetricDepIssue;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): MetricDepIssue;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): MetricDepIssue;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): MetricDepIssue;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): MetricDepIssue;
   ...
   * @see #fromString
   */
  static make(s: string | null): MetricDepIssue | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): MetricDepIssue;
   ...
   */
  static cachedEmptyInst(): MetricDepIssue;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<MetricDepIssue>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): MetricDepIssue;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<MetricDepIssue | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<MetricDepIssue | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<MetricDepIssue | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<MetricDepIssue | null> | null>;
   ...
   */
  get(include?: string | null): MetricDepIssue | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): MetricDepIssue | null;
   ...
   */
  getMissing(spec: GetMissingSpec): MetricDepIssue;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): MetricDepIssue | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): MetricDepIssue;
   ...
   * @see #toString
   */
  static fromString(s: string | null): MetricDepIssue | null;
   ...
   */
  create(spec?: UpsertSpec | null): MetricDepIssue | null;
   ...
   */
  static createBatch(objs: C3.Array<MetricDepIssue | null> | null, spec?: UpsertSpec | null): ObjList<MetricDepIssue | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<MetricDepIssue | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<MetricDepIssue | null> | null;
   ...
   */
  update(srcObj?: MetricDepIssue | null, spec?: UpsertSpec | null): MetricDepIssue | null;
   ...
   */
  upsert(srcObj?: MetricDepIssue | null, spec?: UpsertSpec | null): MetricDepIssue | null;
   ...
   */
  merge(spec?: MergeSpec | null): MetricDepIssue | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): MetricDepIssue | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): MetricDepIssue | null;
   ...
   */
  static updateBatch(objs: C3.Array<MetricDepIssue | null> | null, srcObjs?: C3.Array<MetricDepIssue | null>, spec?: UpsertSpec | null): ObjList<MetricDepIssue | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<MetricDepIssue | null>>, spec?: UpsertSpec | null): ObjList<MetricDepIssue | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<MetricDepIssue | null> | null, srcObjs?: C3.Array<MetricDepIssue | null>, spec?: UpsertSpec | null): ObjList<MetricDepIssue | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<MetricDepIssue | null>>, spec?: UpsertSpec | null): ObjList<MetricDepIssue | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<MetricDepIssue | null> | null, spec?: TouchSpec | null): ObjList<MetricDepIssue | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<MetricDepIssue | null> | null, spec?: MergeSpec | null): ObjList<MetricDepIssue | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<MetricDepIssue | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<MetricDepIssue | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<MetricDepIssue | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<MetricDepIssue | null> | null;
   ...
   */
  static mergeAll(mergeObj: MetricDepIssue | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: MetricDepIssue | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<MetricDepIssue | null> | null, spec?: UpsertSpec | null): ObjList<MetricDepIssue | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<MetricDepIssue | null> | null, spec?: UpsertSpec | null): ObjList<MetricDepIssue | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<MetricDepIssue | null> | null): ObjList<MetricDepIssue | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<MetricDepIssue | null> | null): ObjList<MetricDepIssue | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<MetricDepIssue | null> | null): ObjList<MetricDepIssue | null>;
   ...
   */
  static afterCreate(objs: C3.Array<MetricDepIssue | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<MetricDepIssue | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<MetricDepIssue | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<MetricDepIssue | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<MetricDepIssue | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): MetricDepIssue | null;
   ...
   */
  withoutIdentity(): MetricDepIssue | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<MetricDepIssue | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: MetricDepIssue | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<MetricDepIssue | null> | null, callback?: λFunction<MetricDepIssue | null, MetricDepIssue | null> | null): ObjList<MetricDepIssue | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<MetricDepIssue | null> | null, callback?: λFunction<MetricDepIssue | null, MetricDepIssue | null> | null): C3.Array<ObjError | null>;
