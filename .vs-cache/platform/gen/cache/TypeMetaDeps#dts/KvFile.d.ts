// TypeScript definitions for the C3 type KvFile

/**
 * This is a KvContent type that can be read and written as a File.
 *
 * @remarks this represents a value passed to a method that expects an instance of KvFile
 */
declare interface IKvFile {
   ...
   */
  store: IKvStore<KvStoreConfig | null>;
 ...
 * This is a KvContent type that can be read and written as a File.
 *
 * @remarks this represents a made instance of KvFile
 */
declare class KvFile extends Obj {
  ...
  withContentEncoding(contentEncoding: string | null): KvFile;
  ...
  withContentLanguage(contentLanguage: string | null): KvFile;
  ...
  withContentLength(contentLength: number | null): KvFile;
  ...
  withContentLocation(contentLocation: string | null): KvFile;
  ...
  withContentType(contentType: string | null): KvFile;
  ...
  withContentDisposition(contentDisposition: string | null): KvFile;
  ...
  withETag(eTag: string | null): KvFile;
  ...
  withLastModified(lastModified: DateTime | Date | string | null): KvFile;

  /**
   * Id of user / identity who last last modified this content.
   */
  readonly lastModifiedBy?: string | null;
  withLastModifiedBy(lastModifiedBy: string | null): KvFile;
  ...
  withContentMD5(contentMD5: string | null): KvFile;
  ...
  withContentSHA1(contentSHA1: string | null): KvFile;

  /**
   * Field to maintain state whether content metadata was read or not.
   */
  readonly hasMetadata?: boolean;
  withHasMetadata(hasMetadata: boolean): KvFile;

  /**
   * URL for this file that contains scheme (i.e. file-system) and fully qualified encoded path.
   */
  readonly url?: string | null;
  withUrl(url: string | null): KvFile;

  /**
   * table associated with the content
   */
  readonly tableName: string;
  withTableName(tableName: string): KvFile;

  /**
   * rowId associated with the content
   */
  readonly rowId: string;
  withRowId(rowId: string): KvFile;

  /**
   * store associated with the content
   */
  readonly store: KvStore<KvStoreConfig | null>;
  withStore(store: IKvStore<KvStoreConfig | null>): KvFile;

  /**
   * The column name of the {@link KvRow} that this KvContent is associated to.
   */
  readonly colName: string;
  withColName(colName: string): KvFile;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): KvFile | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): KvFile | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): KvFile | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): KvFile | null;
   ...
   */
  replaceType(old: Type, new_: Type): KvFile;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): KvFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): KvFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<KvFile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<KvFile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): KvFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): KvFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): KvFile;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): KvFile;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): KvFile;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): KvFile;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): KvFile;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): KvFile;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): KvFile;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): KvFile;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): KvFile;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): KvFile;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): KvFile;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): KvFile;
   ...
   * @see #unsetField
   */
  defaultField(field: string): KvFile;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): KvFile;
   ...
   * @see #removeField
   */
  unsetField(field: string): KvFile;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): KvFile;
   ...
   * @see #unsetField
   */
  removeField(field: string): KvFile;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): KvFile;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): KvFile;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): KvFile;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): KvFile;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): KvFile;

  mergeJson(json: any | null): KvFile;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): KvFile;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): KvFile;
   ...
   */
  singletonArray(): C3.Array<KvFile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<KvFile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<KvFile | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<KvFile | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<KvFile | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, KvFile | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, KvFile | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<KvFile | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<KvFile | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): KvFile;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): KvFile;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): KvFile;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): KvFile;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): KvFile;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): KvFile;
   ...
   * @see #fromString
   */
  static make(s: string | null): KvFile | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): KvFile;
   ...
   */
  static cachedEmptyInst(): KvFile;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<KvFile>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): KvFile;
   ...
   */
  withFileName(fileName: string | null): KvFile;

  /**
   * Changes file extension in this instance.
   */
  withFileExt(fileExt: string | null): KvFile;
   ...
   */
  identify(suffix?: string | null): KvFile;
   ...
   */
  readMetadata(spec?: FileOperationSpec | null): KvFile;
   ...
   */
  refreshMetadata(spec?: FileOperationSpec | null): KvFile;
   ...
   */
  encodedPushStream(spec?: FileOperationSpec | null): Pair<KvFile | null, BytePushStream | null>;

  /**
   * @return byte push stream to be used for writing un-encoded data into this content object.
   */
  pushStream(spec?: FileOperationSpec | null): Pair<KvFile | null, BytePushStream | null>;

  /**
   * @return character push stream to be used for writing un-encoded data into this content object.
   */
  charPushStream(spec?: FileOperationSpec | null): Pair<KvFile | null, CharPushStream | null>;
   ...
   */
  encodedStream(spec?: FileOperationSpec | null): Pair<KvFile | null, ByteStream | null> | null;
   ...
   */
  writeStream(content: ByteStream | null, spec?: FileOperationSpec | null): KvFile;

  /**
   * Truncates file and replaces it's content with provided binary content.
   */
  writeInputStream(inputStream: any, spec?: FileOperationSpec | null): KvFile;

  /**
   * Truncates file and replaces its content with provided binary content from zipInputStream
   */
  writeZipInputStream(zipInputStream: any, spec?: FileOperationSpec | null): KvFile;
   ...
   */
  writeEncodedStream(encodedContent: ByteStream | null, spec?: FileOperationSpec | null): KvFile;

  /**
   * Truncates file and replaces it's encoded content with provided binary content.
   */
  writeEncodedInputStream(inputStream: any, spec?: FileOperationSpec | null): KvFile;
   ...
   *           content that needs to be written
   */
  write(content: any | null, spec?: FileOperationSpec | null): KvFile;
   ...
   *           encoded content that needs to be written
   */
  writeEncoded(encodedContent: any | null, spec?: FileOperationSpec | null): KvFile;
   ...
   *           content that needs to be written
   */
  writeString(content: string | null, spec?: FileOperationSpec | null): KvFile;
   ...
   */
  writeObj(obj: Obj | null, spec?: FileObjsOperSpec | null): KvFile;
   ...
   * @return pair of update instance of this content and number of objs written
   */
  startWriteObjs(spec?: FileObjsOperSpec | null): Pair<KvFile | null, PushStream<Obj | null> | null>;
   ...
   */
  compress(contentEncoding?: string | null, spec?: FileCompressSpec | null): KvFile;

  /**
   * Uncompresses file. Removes compression specific extension.
   */
  uncompress(spec?: FileCompressSpec | null): KvFile;
   ...
   */
  transcode(contentType: string, contentEncoding: string, spec?: FileCompressSpec | null): KvFile;

  /**
   * Copies content to a given target.
   */
  copyContentTo(target: KvFile, spec?: FileOperationSpec | null): void;
   ...
   */
  static fromString(s: string | null): KvFile | null;
   ...
   * @see KvFile
   */
  static fromRow(kvRow: KvRow): KvContent;
   ...
   */
  static fromKvContentUrl(kvContentUrl: string, failIfInvalid?: boolean): KvContent | null;

  /**
   * @return true if the given url is a kvContentUrl of the format: **kv://{kvStoreName}/{tableName}/{rowId}/{columnName}**.
   */
  static isKvContentUrl(url: string): boolean;
}
