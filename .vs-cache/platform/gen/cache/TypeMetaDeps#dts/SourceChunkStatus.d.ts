// TypeScript definitions for the C3 type SourceChunkStatus

/**
 * This type provides the stats and state for each {@link SourcesChunk}
 *
 * @remarks this represents a value passed to a method that expects an instance of SourceChunkStatus
 */
declare interface ISourceChunkStatus {
   ...
   */
  rootSourceStatus?: ISourceStatus | null;
   ...
   */
  errors?: C3.Array<FailedSource | null> | Array<IFailedSource | null>;
  ...
  /**
   * {@see SourceChunkStatus} entries for the {@link Sources}
   */
  chunks?: C3.Array<SourceChunkStatus | null> | Array<ISourceChunkStatus | null>;

  /**
   * The {@link SourceCollection} id for the sources of this status.
   */
  sourceCollectionName: string;

  /**
   * count of the chunks for the Sources
   */
  chunkCount?: number | null;

  /**
   * index of the chunk it is 0 based.
   */
  chunkIndex: number;

  /**
   * offset for the chunk in parent Sources
   * it is 0 based.
   */
  offsetInParentSources: number;
}

/**
 * This type provides the stats and state for each {@link SourcesChunk}
 *
 * @remarks this represents a made instance of SourceChunkStatus
 */
declare class SourceChunkStatus extends Obj {
  ...
  withTypeIdent(typeIdent: string | null): SourceChunkStatus;
   ...
   */
  readonly id: string;
  withId(id: string): SourceChunkStatus;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): SourceChunkStatus;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): SourceChunkStatus;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): SourceChunkStatus;
  ...
  withVersion(version: number | null): SourceChunkStatus;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): SourceChunkStatus;

  /**
   * A reference to {@link SourceStatus} of the initial / root Sources. Will be `null` for root SourceStatus.
   */
  readonly rootSourceStatus?: SourceStatus | null;
  withRootSourceStatus(rootSourceStatus: ISourceStatus | null): SourceChunkStatus;

  /**
   * Returns a reference to the parentStatus object, which is a {@see SourceStatus}, {@see SourceChunkStatus}, or
   * {@see TransformStatus} object.
   */
  readonly parentStatus?: DataIntegStatus | null;
  withParentStatus(parentStatus: IDataIntegStatus | null): SourceChunkStatus;

  /**
   * Array of statuses of immediate transforms optionally filtered by provided transform type.
   */
  readonly transforms?: C3.Array<TransformStatus | null>;
  withTransforms(transforms: C3.Array<TransformStatus | null> | Array<ITransformStatus | null>): SourceChunkStatus;

  /**
   * Array of statuses of immediate targets optionally filtered by provided transform type.
   */
  readonly targets?: C3.Array<TargetStatus | null>;
  withTargets(targets: C3.Array<TargetStatus | null> | Array<ITargetStatus | null>): SourceChunkStatus;

  /**
   * The {@see TypeRef} of the Sources for which the stats are being stored
   */
  readonly sourceType: Type;
  withSourceType(sourceType: IType): SourceChunkStatus;

  /**
   * fingerprint id of the {@see DataIntegSpec} for fetching the corresponding merged specs.
   */
  readonly specId?: string | null;
  withSpecId(specId: string | null): SourceChunkStatus;

  /**
   * {@link DataIntegSpec} for the corresponding merged specs.
   */
  readonly spec?: DataIntegSpec | null;
  withSpec(spec: IDataIntegSpec | null): SourceChunkStatus;
  ...
  withState(state: string): SourceChunkStatus;

  /**
   * The number of objects participating at this data integration step.
   */
  readonly count: number;
  withCount(count: number): SourceChunkStatus;

  /**
   * The number of objects successfully processed at this data integration step.
   */
  readonly successful: number;
  withSuccessful(successful: number): SourceChunkStatus;

  /**
   * The number of objects that were skipped at this data integration step.
   */
  readonly skipped: number;
  withSkipped(skipped: number): SourceChunkStatus;

  /**
   * The number of objects that failed to process at this data integration step.
   */
  readonly failed: number;
  withFailed(failed: number): SourceChunkStatus;
  ...
  withTotalErrorCount(totalErrorCount: number): SourceChunkStatus;

  /**
   * List of first 100 errors in this data integration step.
   */
  readonly errors?: C3.Array<FailedSource | null>;
  withErrors(errors: C3.Array<FailedSource | null> | Array<IFailedSource | null>): SourceChunkStatus;
  ...
  withFirstError(firstError: string | null): SourceChunkStatus;

  /**
   * {@see SourceChunkStatus} entries for the {@link Sources}
   */
  readonly chunks?: C3.Array<SourceChunkStatus | null>;
  withChunks(chunks: C3.Array<SourceChunkStatus | null> | Array<ISourceChunkStatus | null>): SourceChunkStatus;

  /**
   * The {@link SourceCollection} id for the sources of this status.
   */
  readonly sourceCollectionName: string;
  withSourceCollectionName(sourceCollectionName: string): SourceChunkStatus;

  /**
   * count of the chunks for the Sources
   */
  readonly chunkCount?: number | null;
  withChunkCount(chunkCount: number | null): SourceChunkStatus;

  /**
   * index of the chunk it is 0 based.
   */
  readonly chunkIndex: number;
  withChunkIndex(chunkIndex: number): SourceChunkStatus;

  /**
   * offset for the chunk in parent Sources
   * it is 0 based.
   */
  readonly offsetInParentSources: number;
  withOffsetInParentSources(offsetInParentSources: number): SourceChunkStatus;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SourceChunkStatus | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SourceChunkStatus | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SourceChunkStatus | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SourceChunkStatus | null;
   ...
   */
  replaceType(old: Type, new_: Type): SourceChunkStatus;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SourceChunkStatus;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SourceChunkStatus;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SourceChunkStatus | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SourceChunkStatus | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SourceChunkStatus;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SourceChunkStatus;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SourceChunkStatus;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SourceChunkStatus;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SourceChunkStatus;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SourceChunkStatus;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SourceChunkStatus;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SourceChunkStatus;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SourceChunkStatus;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SourceChunkStatus;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SourceChunkStatus;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SourceChunkStatus;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SourceChunkStatus;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SourceChunkStatus;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SourceChunkStatus;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SourceChunkStatus;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SourceChunkStatus;
   ...
   * @see #removeField
   */
  unsetField(field: string): SourceChunkStatus;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SourceChunkStatus;
   ...
   * @see #unsetField
   */
  removeField(field: string): SourceChunkStatus;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SourceChunkStatus;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SourceChunkStatus;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SourceChunkStatus;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SourceChunkStatus;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SourceChunkStatus;

  mergeJson(json: any | null): SourceChunkStatus;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SourceChunkStatus;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SourceChunkStatus;
   ...
   */
  singletonArray(): C3.Array<SourceChunkStatus | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SourceChunkStatus | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SourceChunkStatus | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SourceChunkStatus | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SourceChunkStatus | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SourceChunkStatus | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SourceChunkStatus | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SourceChunkStatus | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SourceChunkStatus | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SourceChunkStatus;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SourceChunkStatus;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SourceChunkStatus;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SourceChunkStatus;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SourceChunkStatus;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SourceChunkStatus;
   ...
   * @see #fromString
   */
  static make(s: string | null): SourceChunkStatus | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SourceChunkStatus;
   ...
   */
  static cachedEmptyInst(): SourceChunkStatus;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SourceChunkStatus>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SourceChunkStatus;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<SourceChunkStatus | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SourceChunkStatus | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<SourceChunkStatus | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<SourceChunkStatus | null> | null>;
   ...
   */
  get(include?: string | null): SourceChunkStatus | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): SourceChunkStatus | null;
   ...
   */
  getMissing(spec: GetMissingSpec): SourceChunkStatus;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): SourceChunkStatus | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): SourceChunkStatus;
   ...
   * @see #toString
   */
  static fromString(s: string | null): SourceChunkStatus | null;
   ...
   */
  create(spec?: UpsertSpec | null): SourceChunkStatus | null;
   ...
   */
  static createBatch(objs: C3.Array<SourceChunkStatus | null> | null, spec?: UpsertSpec | null): ObjList<SourceChunkStatus | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<SourceChunkStatus | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<SourceChunkStatus | null> | null;
   ...
   */
  update(srcObj?: SourceChunkStatus | null, spec?: UpsertSpec | null): SourceChunkStatus | null;
   ...
   */
  upsert(srcObj?: SourceChunkStatus | null, spec?: UpsertSpec | null): SourceChunkStatus | null;
   ...
   */
  merge(spec?: MergeSpec | null): SourceChunkStatus | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): SourceChunkStatus | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): SourceChunkStatus | null;
   ...
   */
  static updateBatch(objs: C3.Array<SourceChunkStatus | null> | null, srcObjs?: C3.Array<SourceChunkStatus | null>, spec?: UpsertSpec | null): ObjList<SourceChunkStatus | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<SourceChunkStatus | null>>, spec?: UpsertSpec | null): ObjList<SourceChunkStatus | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<SourceChunkStatus | null> | null, srcObjs?: C3.Array<SourceChunkStatus | null>, spec?: UpsertSpec | null): ObjList<SourceChunkStatus | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<SourceChunkStatus | null>>, spec?: UpsertSpec | null): ObjList<SourceChunkStatus | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<SourceChunkStatus | null> | null, spec?: TouchSpec | null): ObjList<SourceChunkStatus | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SourceChunkStatus | null> | null, spec?: MergeSpec | null): ObjList<SourceChunkStatus | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SourceChunkStatus | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<SourceChunkStatus | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<SourceChunkStatus | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<SourceChunkStatus | null> | null;
   ...
   */
  static mergeAll(mergeObj: SourceChunkStatus | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: SourceChunkStatus | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<SourceChunkStatus | null> | null, spec?: UpsertSpec | null): ObjList<SourceChunkStatus | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<SourceChunkStatus | null> | null, spec?: UpsertSpec | null): ObjList<SourceChunkStatus | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): SourceChunkStatus | null;
   ...
   */
  static beforeCreate(objs: C3.Array<SourceChunkStatus | null> | null): ObjList<SourceChunkStatus | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<SourceChunkStatus | null> | null): ObjList<SourceChunkStatus | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<SourceChunkStatus | null> | null): ObjList<SourceChunkStatus | null>;
   ...
   */
  static afterCreate(objs: C3.Array<SourceChunkStatus | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<SourceChunkStatus | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<SourceChunkStatus | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<SourceChunkStatus | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<SourceChunkStatus | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): SourceChunkStatus | null;
   ...
   */
  withoutIdentity(): SourceChunkStatus | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<SourceChunkStatus | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: SourceChunkStatus | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<SourceChunkStatus | null> | null, callback?: λFunction<SourceChunkStatus | null, SourceChunkStatus | null> | null): ObjList<SourceChunkStatus | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<SourceChunkStatus | null> | null, callback?: λFunction<SourceChunkStatus | null, SourceChunkStatus | null> | null): C3.Array<ObjError | null>;
   ...
   * SourceStatus.
   */
  parentSourceStatus(): SourceStatus | null;
   ...
   */
  parentChunkStatus(): SourceChunkStatus | null;
   ...
   */
  parentTransformStatus(): TransformStatus | null;
   ...
   */
  safeChunks(): Stream<SourceChunkStatus | null>;

  /**
   * @return an array of statuses of immediate transforms
   */
  safeTransforms(): Stream<TransformStatus | null>;

  /**
   * @return an array of statuses of immediate targets
   */
  safeTargets(): Stream<TargetStatus | null>;
   ...
   */
  allErrors(): Stream<FailedSource | null>;
  ...
  /**
   * construct a SourceStatus object from a sources object with the given state and stats initialized to zero
   */
  static fromSources(sources: Sources, state?: string | null): SourceStatus;

  /**
   * initializes the state, stats, errors, and firstError fields
   */
  initialize(state?: string | null): SourceStatus | null;

  /**
   * updates errors array and the counts to values from the sourceStatus object
   */
  withErrorsAndCount(sourceStatus: SourceStatus): SourceStatus | null;

  /**
   * return the {@link Sources} of this status
   */
  sources(): Sources;

  /**
   * returns the {@link SourceCollection} of the {@link Sources} of this status.
   */
  sourceCollection(): SourceCollection<SourceCollection.Config | null>;

  /**
   * Initializes and creates a SourceChunkStatus given the chunk number and Sources
   * If isCompleted is true, chunk will be initialized in completed state
   */
  static init(chunkNum?: number | null, src?: Sources | null, recordCount?: number | null, offsetInParentSources?: number | null, isCompleted?: boolean): SourceChunkStatus | null;

  /**
   * @returns the id of the SourceChunkStatus given the chunk number and Sources' id and source type
   */
  static chunkId(chunkNum?: number | null, sourcesId?: string | null, srcType?: Type | null): string | null;
}
