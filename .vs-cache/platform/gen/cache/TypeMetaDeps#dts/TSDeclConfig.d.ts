// TypeScript definitions for the C3 type TSDeclConfig

/**
 * @remarks this represents a value passed to a method that expects an instance of TSDeclConfig
 */
declare interface ITSDeclConfig {
  ...
  /**
   * Maximum number of objects that will be fetched during TSDecl evaluation before return empty result
   */
  maxObjsToFetch?: number | null;
}

/**
 * @remarks this represents a made instance of TSDeclConfig
 */
declare class TSDeclConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): TSDeclConfig;

  static readonly configOverride?: string | null;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): TSDeclConfig;
  ...
  withIssues(issues: C3.Array<string | null> | Array<string | null>): TSDeclConfig;
   ...
   * Maximum number of objects that will be fetched during TSDecl evaluation before return empty result
   */
  readonly maxObjsToFetch?: number | null;
  withMaxObjsToFetch(maxObjsToFetch: number | null): TSDeclConfig;

  /**
   * Maximum number of objects that will be fetched during TSDecl evaluation before return empty result
   */
  static readonly maxObjsToFetch?: number | null;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TSDeclConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TSDeclConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TSDeclConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TSDeclConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): TSDeclConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): TSDeclConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TSDeclConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TSDeclConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TSDeclConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TSDeclConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TSDeclConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TSDeclConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TSDeclConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TSDeclConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TSDeclConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TSDeclConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TSDeclConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TSDeclConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TSDeclConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TSDeclConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TSDeclConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): TSDeclConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TSDeclConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): TSDeclConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TSDeclConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): TSDeclConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TSDeclConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TSDeclConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TSDeclConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TSDeclConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TSDeclConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): TSDeclConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TSDeclConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): TSDeclConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TSDeclConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): TSDeclConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TSDeclConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): TSDeclConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TSDeclConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TSDeclConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TSDeclConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): TSDeclConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TSDeclConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TSDeclConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TSDeclConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): TSDeclConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TSDeclConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): TSDeclConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): TSDeclConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): TSDeclConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TSDeclConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): TSDeclConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): TSDeclConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): TSDeclConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TSDeclConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): TSDeclConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TSDeclConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TSDeclConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TSDeclConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): TSDeclConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TSDeclConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TSDeclConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TSDeclConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TSDeclConfig;

  mergeJson(json: any | null): TSDeclConfig;

  static mergeJson(json: any | null): TSDeclConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TSDeclConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TSDeclConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TSDeclConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): TSDeclConfig;
   ...
   */
  singletonArray(): C3.Array<TSDeclConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<TSDeclConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TSDeclConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TSDeclConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TSDeclConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<TSDeclConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TSDeclConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TSDeclConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TSDeclConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TSDeclConfig | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<TSDeclConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TSDeclConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TSDeclConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TSDeclConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TSDeclConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TSDeclConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TSDeclConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TSDeclConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TSDeclConfig;
   ...
   */
  static cachedEmptyInst(): TSDeclConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TSDeclConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TSDeclConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<TSDeclConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<TSDeclConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<TSDeclConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): TSDeclConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): TSDeclConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): TSDeclConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): TSDeclConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): TSDeclConfig | null;
   ...
   */
  static produce(key: string): TSDeclConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, TSDeclConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, TSDeclConfig | null>;
   ...
   */
  static forConfigKey(configKey: string | null): TSDeclConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<TSDeclConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: TSDeclConfig, override?: string | null): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: TSDeclConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: TSDeclConfig, override?: string | null): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: TSDeclConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): TSDeclConfig | null;
   ...
   */
  removeSecrets(): TSDeclConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): TSDeclConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): TSDeclConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): TSDeclConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): TSDeclConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): TSDeclConfig;
