// TypeScript definitions for the C3 type LambdaContent

/**
 * Read only content with metadata and lambda that provides content on demand.
 *
 * @remarks this represents a value passed to a method that expects an instance of LambdaContent
 */
declare interface ILambdaContent {
  ...
  /**
   * The actual content value provider lambda.
   */
  contentProducer?: λSupplier<any | null> | null;
}
 ...
 * Read only content with metadata and lambda that provides content on demand.
 *
 * @remarks this represents a made instance of LambdaContent
 */
declare class LambdaContent extends Obj {
  ...
  withContentEncoding(contentEncoding: string | null): LambdaContent;
  ...
  withContentLanguage(contentLanguage: string | null): LambdaContent;
  ...
  withContentLength(contentLength: number | null): LambdaContent;
  ...
  withContentLocation(contentLocation: string | null): LambdaContent;
  ...
  withContentType(contentType: string | null): LambdaContent;
  ...
  withContentDisposition(contentDisposition: string | null): LambdaContent;
  ...
  withETag(eTag: string | null): LambdaContent;
  ...
  withLastModified(lastModified: DateTime | Date | string | null): LambdaContent;

  /**
   * Id of user / identity who last last modified this content.
   */
  readonly lastModifiedBy?: string | null;
  withLastModifiedBy(lastModifiedBy: string | null): LambdaContent;
  ...
  withContentMD5(contentMD5: string | null): LambdaContent;
  ...
  withContentSHA1(contentSHA1: string | null): LambdaContent;

  /**
   * Field to maintain state whether content metadata was read or not.
   */
  readonly hasMetadata?: boolean;
  withHasMetadata(hasMetadata: boolean): LambdaContent;

  /**
   * The actual content value provider lambda.
   */
  readonly contentProducer?: λSupplier<any | null> | null;
  withContentProducer(contentProducer: λSupplier<any | null> | null): LambdaContent;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LambdaContent | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LambdaContent | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LambdaContent | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LambdaContent | null;
   ...
   */
  replaceType(old: Type, new_: Type): LambdaContent;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LambdaContent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LambdaContent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LambdaContent | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LambdaContent | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LambdaContent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LambdaContent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LambdaContent;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LambdaContent;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LambdaContent;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LambdaContent;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LambdaContent;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LambdaContent;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LambdaContent;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LambdaContent;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LambdaContent;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LambdaContent;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LambdaContent;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LambdaContent;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LambdaContent;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LambdaContent;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LambdaContent;
   ...
   * @see #removeField
   */
  unsetField(field: string): LambdaContent;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LambdaContent;
   ...
   * @see #unsetField
   */
  removeField(field: string): LambdaContent;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LambdaContent;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LambdaContent;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LambdaContent;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LambdaContent;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LambdaContent;

  mergeJson(json: any | null): LambdaContent;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LambdaContent;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LambdaContent;
   ...
   */
  singletonArray(): C3.Array<LambdaContent | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LambdaContent | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LambdaContent | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LambdaContent | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LambdaContent | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LambdaContent | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LambdaContent | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LambdaContent | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LambdaContent | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LambdaContent;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LambdaContent;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LambdaContent;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LambdaContent;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LambdaContent;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LambdaContent;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LambdaContent;
   ...
   */
  static cachedEmptyInst(): LambdaContent;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LambdaContent>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LambdaContent;
   ...
   */
  withFileName(fileName: string | null): LambdaContent;

  /**
   * Changes file extension in this instance.
   */
  withFileExt(fileExt: string | null): LambdaContent;
   ...
   */
  identify(suffix?: string | null): LambdaContent;
   ...
   */
  readMetadata(spec?: FileOperationSpec | null): LambdaContent;
   ...
   */
  refreshMetadata(spec?: FileOperationSpec | null): LambdaContent;
   ...
   * @return abstract content with metadata.
   */
  guessMetadata(spec?: FileOperationSpec | null): LambdaContent;

  /**
   * Clears the content metadata; e.g. if it's known to be invalid.
   */
  clearMetadata(): LambdaContent;

  /**
   * @return clone of this content with metadata from provided input.
   */
  withMetadata(meta?: ContentMeta | null): LambdaContent;
   ...
   */
  encodedPushStream(spec?: FileOperationSpec | null): Pair<LambdaContent | null, BytePushStream | null>;

  /**
   * @return byte push stream to be used for writing un-encoded data into this content object.
   */
  pushStream(spec?: FileOperationSpec | null): Pair<LambdaContent | null, BytePushStream | null>;

  /**
   * @return character push stream to be used for writing un-encoded data into this content object.
   */
  charPushStream(spec?: FileOperationSpec | null): Pair<LambdaContent | null, CharPushStream | null>;
   ...
   */
  encodedStream(spec?: FileOperationSpec | null): Pair<LambdaContent | null, ByteStream | null> | null;
   ...
   */
  writeStream(content: ByteStream | null, spec?: FileOperationSpec | null): LambdaContent;

  /**
   * Truncates file and replaces it's content with provided binary content.
   */
  writeInputStream(inputStream: any, spec?: FileOperationSpec | null): LambdaContent;

  /**
   * Truncates file and replaces its content with provided binary content from zipInputStream
   */
  writeZipInputStream(zipInputStream: any, spec?: FileOperationSpec | null): LambdaContent;
   ...
   */
  writeEncodedStream(encodedContent: ByteStream | null, spec?: FileOperationSpec | null): LambdaContent;

  /**
   * Truncates file and replaces it's encoded content with provided binary content.
   */
  writeEncodedInputStream(inputStream: any, spec?: FileOperationSpec | null): LambdaContent;
   ...
   *           content that needs to be written
   */
  write(content: any | null, spec?: FileOperationSpec | null): LambdaContent;
   ...
   *           encoded content that needs to be written
   */
  writeEncoded(encodedContent: any | null, spec?: FileOperationSpec | null): LambdaContent;
   ...
   *           content that needs to be written
   */
  writeString(content: string | null, spec?: FileOperationSpec | null): LambdaContent;
   ...
   */
  writeObj(obj: Obj | null, spec?: FileObjsOperSpec | null): LambdaContent;
   ...
   * @return pair of update instance of this content and number of objs written
   */
  startWriteObjs(spec?: FileObjsOperSpec | null): Pair<LambdaContent | null, PushStream<Obj | null> | null>;
   ...
   */
  compress(contentEncoding?: string | null, spec?: FileCompressSpec | null): LambdaContent;

  /**
   * Uncompresses content.
   */
  uncompress(spec?: FileCompressSpec | null): LambdaContent;
   ...
   */
  transcode(contentType: string, contentEncoding: string, spec?: FileCompressSpec | null): LambdaContent;

  /**
   * Copies content to a given target.
   */
  copyContentTo(target: LambdaContent, spec?: FileOperationSpec | null): void;
