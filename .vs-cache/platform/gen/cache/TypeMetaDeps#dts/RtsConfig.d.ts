// TypeScript definitions for the C3 type RtsConfig

/**
 * @remarks this represents a value passed to a method that expects an instance of RtsConfig
 */
declare interface IRtsConfig {
 ...
 */
declare class RtsConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): RtsConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): RtsConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): RtsConfig;

  /**
   * Flag to indicate whether Rts is enabled
   */
  readonly enabled?: boolean;
  withEnabled(enabled: boolean): RtsConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): RtsConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): RtsConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): RtsConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): RtsConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): RtsConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): RtsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): RtsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<RtsConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<RtsConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): RtsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RtsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RtsConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): RtsConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): RtsConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): RtsConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): RtsConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): RtsConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): RtsConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): RtsConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): RtsConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): RtsConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): RtsConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): RtsConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): RtsConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): RtsConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): RtsConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): RtsConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): RtsConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): RtsConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): RtsConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): RtsConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): RtsConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): RtsConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): RtsConfig;

  mergeJson(json: any | null): RtsConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): RtsConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): RtsConfig;
   ...
   */
  singletonArray(): C3.Array<RtsConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<RtsConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<RtsConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<RtsConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<RtsConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, RtsConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, RtsConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<RtsConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<RtsConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): RtsConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): RtsConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): RtsConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): RtsConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): RtsConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): RtsConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): RtsConfig;
   ...
   */
  static cachedEmptyInst(): RtsConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<RtsConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): RtsConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<RtsConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<RtsConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<RtsConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): RtsConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): RtsConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): RtsConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): RtsConfig | null;
   ...
   */
  static produce(key: string): RtsConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, RtsConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, RtsConfig | null>;
   ...
   */
  static forConfigKey(configKey: string | null): RtsConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<RtsConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: RtsConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: RtsConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): RtsConfig | null;
   ...
   */
  removeSecrets(): RtsConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): RtsConfig | null;
