// TypeScript definitions for the C3 type Registry

/**
 * Base registry typ to store and retrieve information
 *
 * @remarks this represents a value passed to a method that expects an instance of Registry
 */
 ...
 * Base registry typ to store and retrieve information
 *
 * @remarks this represents a made instance of Registry
 */
declare class Registry extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): Registry;

  static readonly configOverride?: string | null;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): Registry;
  ...
  withIssues(issues: C3.Array<string | null> | Array<string | null>): Registry;
  ...
  withUsername(username: string | null): Registry;
  ...
  withPassword(password: string | null): Registry;
  ...
  withSecretKey(secretKey: string | null): Registry;
  ...
  withProperties(properties: C3.Map<string | null, any> | {[key: string | null]: any}): Registry;
  ...
  withSecretProperties(secretProperties: C3.Map<string | null, any> | {[key: string | null]: any}): Registry;
  ...
  withUrl(url: string | null): Registry;
  ...
  withServerEndpoint(serverEndpoint: string | null): Registry;
  ...
  withPort(port: number | null): Registry;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Registry | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Registry | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Registry | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Registry | null;
   ...
   */
  replaceType(old: Type, new_: Type): Registry;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): Registry;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Registry;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Registry;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Registry;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Registry;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Registry | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Registry | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Registry | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Registry | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Registry;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Registry;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Registry;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Registry;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Registry;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Registry;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): Registry;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): Registry;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Registry;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): Registry;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Registry;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): Registry;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Registry;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Registry;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Registry;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Registry;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Registry;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): Registry;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Registry;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): Registry;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Registry;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): Registry;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Registry;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): Registry;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Registry;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Registry;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Registry;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): Registry;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Registry;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Registry;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Registry;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): Registry;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Registry;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): Registry;
   ...
   * @see #removeField
   */
  unsetField(field: string): Registry;
   ...
   * @see #removeField
   */
  static unsetField(field: string): Registry;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Registry;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): Registry;
   ...
   * @see #unsetField
   */
  removeField(field: string): Registry;
   ...
   * @see #unsetField
   */
  static removeField(field: string): Registry;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Registry;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): Registry;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Registry;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Registry;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Registry;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): Registry;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Registry;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Registry;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Registry;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Registry;

  mergeJson(json: any | null): Registry;

  static mergeJson(json: any | null): Registry;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Registry;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Registry;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Registry;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): Registry;
   ...
   */
  singletonArray(): C3.Array<Registry | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<Registry | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Registry | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Registry | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Registry | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<Registry | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Registry | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Registry | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Registry | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Registry | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<Registry | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Registry | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Registry;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Registry;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Registry;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Registry;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Registry;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Registry;
   ...
   * @see #fromString
   */
  static make(s: string | null): Registry | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Registry;
   ...
   */
  static cachedEmptyInst(): Registry;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Registry>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Registry;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<Registry | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<Registry | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<Registry | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): Registry | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): Registry | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): Registry | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): Registry | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): Registry | null;
   ...
   */
  static produce(key: string): Registry | null;
   ...
   */
  static produceAll(): C3.Map<string | null, Registry | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, Registry | null>;
   ...
   */
  static forConfigKey(configKey: string | null): Registry | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<Registry | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: Registry, override?: string | null): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: Registry, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: Registry, override?: string | null): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: Registry, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): Registry | null;
   ...
   */
  removeSecrets(): Registry | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): Registry | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): Registry | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): Registry | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): Registry | null;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): Registry | null;
