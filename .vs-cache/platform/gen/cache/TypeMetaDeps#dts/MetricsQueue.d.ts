// TypeScript definitions for the C3 type MetricsQueue
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of MetricsQueue
 */
declare interface IMetricsQueue {
}
...
declare class MetricsQueue {
   ...
   */
  static compute(targetType: Type, entries: C3.Array<MetricsQueueEntry | null> | null): void;
   ...
   */
  static find(spec?: InvalidationQueue.FindSpec | null): C3.Array<MetricsQueueEntry | null>;
   ...
   * @return the list of requested entries.
   */
  static findStream(spec?: InvalidationQueue.FindStreamSpec | null): Stream<MetricsQueueEntry | null>;
   ...
   *           Entries to remove.
   */
  static clearEntries(entries: C3.Array<MetricsQueueEntry | null> | null): void;
   ...
   * This function should be claimed by individual InvalidationQueue types such as CalcFieldsQueue.
   */
  static mergeContexts(targetType?: Type | null, entries?: C3.Array<MetricsQueueEntry | null>): C3.Array<MetricsQueueEntry | null>;
}
