// TypeScript definitions for the C3 type TimedDataHeader
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of TimedDataHeader
 */
declare interface ITimedDataHeader<TDP> {
 ...
 */
declare class TimedDataHeader<TDP> extends Obj {

  /**
   * Populated on normalization. Indicates the earliest data point across various timeseries fields.
   */
  readonly earliest?: DateTime | null;
  withEarliest(earliest: DateTime | Date | string | null): TimedDataHeader;

  /**
   * Populated on normalization. Indicates the latest data point across various timeseries fields.
   */
  readonly latest?: DateTime | null;
  withLatest(latest: DateTime | Date | string | null): TimedDataHeader;

  /**
   * Populated on normalization. Indicates the earliest data point for each {@link Ann.Ts} fields.
   */
  readonly earliestTsDp?: C3.Map<string | null, TSDataPoint | null>;
  withEarliestTsDp(earliestTsDp: C3.Map<string | null, TSDataPoint | null> | {[key: string | null]: ITSDataPoint | null}): TimedDataHeader;

  /**
   * Populated on normalization. Indicates the latest data point for each {@link Ann.Ts} fields.
   */
  readonly latestTsDp?: C3.Map<string | null, TSDataPoint | null>;
  withLatestTsDp(latestTsDp: C3.Map<string | null, TSDataPoint | null> | {[key: string | null]: ITSDataPoint | null}): TimedDataHeader;
  ...
  withInterval(interval: string | null): TimedDataHeader;

  /**
   * If set, the time series will be normalized in the specified zone.
   */
  readonly timeZone?: string | null;
  withTimeZone(timeZone: string | null): TimedDataHeader;

  /**
   * If set, disables normalizing this time series. Invalidations will still continue to happen for this series normally.
   */
  readonly doNotNormalize?: boolean;
  withDoNotNormalize(doNotNormalize: boolean): TimedDataHeader;

  /**
   * Data points corresponding to this timeseries header
   */
  readonly data?: C3.Array<TDP | null>;
  withData(data: C3.Array<TDP | null> | Array<TDP | null>): TimedDataHeader;

  /**
   * Use this field to specify the interpolation mechanism to be applied for gaps in interval timeseries. Default: `ZERO_INTERPOLATOR`.
   */
  readonly interpolator?: string | null;
  withInterpolator(interpolator: string | null): TimedDataHeader;

  /**
   * Use this field to specify how normalization should handle duplicate data points. A duplicate point is one that has the same start, end, value, unit, and {@link TimedDataPointFields#isEstimated} values. Default: `IGNORE`.
   */
  readonly duplicateHandling?: string | null;
  withDuplicateHandling(duplicateHandling: string | null): TimedDataHeader;

  /**
   * Used to specify how normalization should handle overlapping data points. Default: `AVG`.
   */
  readonly overlapHandling?: string | null;
  withOverlapHandling(overlapHandling: string | null): TimedDataHeader;
  ...
  withBucketInterval(bucketInterval: string | null): TimedDataHeader;
  ...
  withNormalizationPartitionStrategy(normalizationPartitionStrategy: INormalizationPartitionStrategy | null): TimedDataHeader;

  /**
   * Indicates whether the last data point should be repeated until infinity
   */
  readonly extrapolate?: boolean;
  withExtrapolate(extrapolate: boolean): TimedDataHeader;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TimedDataHeader<TDP> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TimedDataHeader<TDP> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TimedDataHeader<TDP> | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TimedDataHeader<TDP> | null;
   ...
   */
  replaceType(old: Type, new_: Type): TimedDataHeader<TDP>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TimedDataHeader<TDP>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TimedDataHeader<TDP>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TimedDataHeader<TDP> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TimedDataHeader<TDP> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TimedDataHeader<TDP>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TimedDataHeader<TDP>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TimedDataHeader<TDP>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TimedDataHeader<TDP>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TimedDataHeader<TDP>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TimedDataHeader<TDP>;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TimedDataHeader<TDP>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TimedDataHeader<TDP>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TimedDataHeader<TDP>;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TimedDataHeader<TDP>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TimedDataHeader<TDP>;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TimedDataHeader<TDP>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TimedDataHeader<TDP>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TimedDataHeader<TDP>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TimedDataHeader<TDP>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TimedDataHeader<TDP>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TimedDataHeader<TDP>;
   ...
   * @see #removeField
   */
  unsetField(field: string): TimedDataHeader<TDP>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TimedDataHeader<TDP>;
   ...
   * @see #unsetField
   */
  removeField(field: string): TimedDataHeader<TDP>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TimedDataHeader<TDP>;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TimedDataHeader<TDP>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TimedDataHeader<TDP>;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TimedDataHeader<TDP>;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TimedDataHeader<TDP>;

  mergeJson(json: any | null): TimedDataHeader<TDP>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TimedDataHeader<TDP>;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TimedDataHeader<TDP>;
   ...
   */
  singletonArray(): C3.Array<TimedDataHeader<TDP> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TimedDataHeader<TDP> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TimedDataHeader<TDP> | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TimedDataHeader<TDP> | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TimedDataHeader<TDP> | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TimedDataHeader<TDP> | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TimedDataHeader<TDP> | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TimedDataHeader<TDP> | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TimedDataHeader<TDP> | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TimedDataHeader<TDP>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TimedDataHeader<TDP>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TimedDataHeader<TDP>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TimedDataHeader<TDP>;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TimedDataHeader<TDP>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TimedDataHeader<TDP>;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TimedDataHeader<TDP>;
   ...
   */
  static cachedEmptyInst(): TimedDataHeader<TDP>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TimedDataHeader<TDP>>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TimedDataHeader<TDP>;
