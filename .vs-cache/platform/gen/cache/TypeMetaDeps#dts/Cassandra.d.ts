// TypeScript definitions for the C3 type Cassandra

/**
 * @remarks this represents a value passed to a method that expects an instance of Cassandra
 */
declare interface ICassandra {
...
/**
 * @remarks this represents a made instance of Cassandra
 */
declare class Cassandra extends Obj {

  /**
   * The unique and required name of this instance.
   */
  readonly name: string;
  withName(name: string): Cassandra;
  ...
  withSQL(SQL: string | null): Cassandra;
  ...
  withKV(KV: string | null): Cassandra;
  ...
  withDEFAULT_KV_CONFIG(DEFAULT_KV_CONFIG: string | null): Cassandra;
  ...
  withDEFAULT_COL_NAME(DEFAULT_COL_NAME: string | null): Cassandra;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Cassandra | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Cassandra | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Cassandra | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Cassandra | null;
   ...
   */
  replaceType(old: Type, new_: Type): Cassandra;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): Cassandra;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Cassandra;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Cassandra;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Cassandra;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Cassandra;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Cassandra | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Cassandra | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Cassandra | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Cassandra | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Cassandra;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Cassandra;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Cassandra;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Cassandra;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Cassandra;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Cassandra;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): Cassandra;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): Cassandra;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Cassandra;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): Cassandra;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Cassandra;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): Cassandra;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Cassandra;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Cassandra;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Cassandra;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Cassandra;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Cassandra;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): Cassandra;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Cassandra;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): Cassandra;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Cassandra;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): Cassandra;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Cassandra;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): Cassandra;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Cassandra;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Cassandra;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Cassandra;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): Cassandra;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Cassandra;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Cassandra;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Cassandra;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): Cassandra;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Cassandra;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): Cassandra;
   ...
   * @see #removeField
   */
  unsetField(field: string): Cassandra;
   ...
   * @see #removeField
   */
  static unsetField(field: string): Cassandra;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Cassandra;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): Cassandra;
   ...
   * @see #unsetField
   */
  removeField(field: string): Cassandra;
   ...
   * @see #unsetField
   */
  static removeField(field: string): Cassandra;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Cassandra;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): Cassandra;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Cassandra;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Cassandra;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Cassandra;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): Cassandra;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Cassandra;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Cassandra;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Cassandra;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Cassandra;

  mergeJson(json: any | null): Cassandra;

  static mergeJson(json: any | null): Cassandra;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Cassandra;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Cassandra;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Cassandra;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): Cassandra;
   ...
   */
  singletonArray(): C3.Array<Cassandra | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<Cassandra | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Cassandra | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Cassandra | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Cassandra | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<Cassandra | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Cassandra | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Cassandra | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Cassandra | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Cassandra | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<Cassandra | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Cassandra | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Cassandra;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Cassandra;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Cassandra;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Cassandra;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Cassandra;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Cassandra;
   ...
   * @see #fromString
   */
  static make(s: string | null): Cassandra | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Cassandra;
   ...
   */
  static cachedEmptyInst(): Cassandra;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Cassandra>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Cassandra;
   ...
   * @see #toString
   */
  static fromString(s: string | null): Cassandra | null;
   ...
   */
  static forName(name: string | null, failIfMissing?: boolean): Cassandra | null;

  /**
   * Gets all the tables for this keyspace
   * @return [{@link Cassandra.Table}]
   */
  tables(): C3.Array<Cassandra.Table | null>;

  /**
   * Gets all the tables for this keyspace
   * @return [{@link Cassandra.Table}]
   */
  static tables(): C3.Array<Cassandra.Table | null>;

  /**
   * Gets the specified table in this keyspace
   * @param tableName
   *           Name of {@link Cassandra.Table} to return
   * @param failIfMissing
   *           If true and the specified table doesn't exist an error will be thrown.
   * @return {@link Cassandra.Table}
   */
  table(tableName?: string | null, failIfMissing?: boolean): Cassandra.Table;
   ...
   * @return {@link Cassandra.Table}
   */
  static table(tableName?: string | null, failIfMissing?: boolean): Cassandra.Table;

  /**
   * Function to execute logic on all tables in this keyspace.
   * @param action
   *           Lambda expression used to execute logic on each {@link Cassandra.Table}
   * @param filter
   *           String expression to only process {@link Cassandra.Table} objects which evaluate to true.
   *           @see FetchFilterSpec#filter
   * @return stream<E>
   */
  eachTable(action: λFunction<Cassandra.Table | null, E | null>, filter?: string | null): Stream<E | null>;
   ...
   * @return stream<E>
   */
  static eachTable(action: λFunction<Cassandra.Table | null, E | null>, filter?: string | null): Stream<E | null>;

  /**
   * Cluster that this keyspace belongs to
   */
  get cluster(): Cassandra.Cluster;

  /**
   * Cluster that this keyspace belongs to
   */
  static get cluster(): Cassandra.Cluster;
   ...
   */
  config(secrets?: boolean): Cassandra.Config;
   ...
   * @return instance of configuration - never `null`.
   */
  static config(secrets?: boolean): Cassandra.Config;
   ...
   */
  static typeConfig(): Cassandra.Config;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<Cassandra | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<Cassandra | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<Cassandra | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): Cassandra | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string | null): Cassandra | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): Cassandra | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): Cassandra | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): Cassandra | null;
   ...
   */
  static produce(key: string): Cassandra | null;
   ...
   */
  static produceAll(): C3.Map<string | null, Cassandra | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, Cassandra | null>;
  ...
  /**
   * Scan rows in Cassandra table and return a stream of {@link KvRow}s. For Cassandra rows see {@link https://docs.datastax.com/en/cql-oss/3.3/cql/cql_reference/cqlSelect.html}
   *
   * @param tableName
   *            The name of the table to scan
   * @param spec
   *            Optional KvStoreScanSpec for the scan. Only offset and limit are supported.
   *
   *            Example of how scan is working with limit:
   *            ```
   ...
   *               age INT
   *            );
   *            INSERT INTO example_table (id, name, age) VALUES ("id1", 'John', 30);
   *            INSERT INTO example_table (id, name, age) VALUES ("id2", 'Alice', 25);
   *            INSERT INTO example_table (id, name, age) VALUES ("id3", 'Bob', 35);
   *
   *            scan("example_table", KvStoreScanSpec.make().withLimit(3L))  // return 3 KvRows
   *
   *            // then insert 2 more records with "id1"
   *
   *            INSERT INTO example_table (id, name, age) VALUES ("id1", 'Foo', 30);
   *            INSERT INTO example_table (id, name, age) VALUES ("id1", 'Bar', 30);
   *
   *            scan("example_table", KvStoreScanSpec.make().withLimit(3L))  // return 1 KvRow, since it consumed the 3 Cassandra rows associated with "id1"
   *            scan("example_table", KvStoreScanSpec.make().withLimit(4L))  // return 2 KvRows, one with "id1" and one with "id2"
   *            scan("example_table", KvStoreScanSpec.make().withLimit(5L))  // return 3 KvRows
   *            ```
   * @return Stream of KvRows
   */
  ...
  /**
   * Gets a Cassandra keyspace that is a c3-specific datastore.
   * @param keyspaceName
   *           Name of {@link Cassandra.Keyspace} to return
   * @param failIfMissing
   *
   * @return {@link Cassandra.Keyspace}
   */
  static keyspace(keyspaceName: string, failIfMissing?: boolean): Cassandra;
}
