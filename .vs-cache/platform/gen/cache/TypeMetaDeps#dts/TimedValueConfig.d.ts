// TypeScript definitions for the C3 type TimedValueConfig

/**
 * @remarks this represents a value passed to a method that expects an instance of TimedValueConfig
 */
declare interface ITimedValueConfig {
  ...
  /**
   * If false, then during upserts of types that mixin `TimedValueHistory`, entries will be automatically de-duped and
   * new entries won't be created if the current state contains the specified value at the specified time.  If true,
   * no de-duping will be done in this case.
   */
  retainAllTimestamps?: boolean;
}

/**
 * @remarks this represents a made instance of TimedValueConfig
 */
declare class TimedValueConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): TimedValueConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): TimedValueConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): TimedValueConfig;
   ...
   * no de-duping will be done in this case.
   */
  readonly retainAllTimestamps?: boolean;
  withRetainAllTimestamps(retainAllTimestamps: boolean): TimedValueConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TimedValueConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TimedValueConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TimedValueConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TimedValueConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): TimedValueConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TimedValueConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TimedValueConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TimedValueConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TimedValueConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TimedValueConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TimedValueConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TimedValueConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TimedValueConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TimedValueConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TimedValueConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TimedValueConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TimedValueConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TimedValueConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TimedValueConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TimedValueConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TimedValueConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TimedValueConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TimedValueConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TimedValueConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TimedValueConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TimedValueConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): TimedValueConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TimedValueConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): TimedValueConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TimedValueConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TimedValueConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TimedValueConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TimedValueConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TimedValueConfig;

  mergeJson(json: any | null): TimedValueConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TimedValueConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TimedValueConfig;
   ...
   */
  singletonArray(): C3.Array<TimedValueConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TimedValueConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TimedValueConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TimedValueConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TimedValueConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TimedValueConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TimedValueConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TimedValueConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TimedValueConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TimedValueConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TimedValueConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TimedValueConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TimedValueConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TimedValueConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TimedValueConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TimedValueConfig;
   ...
   */
  static cachedEmptyInst(): TimedValueConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TimedValueConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TimedValueConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<TimedValueConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<TimedValueConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<TimedValueConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): TimedValueConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): TimedValueConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): TimedValueConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): TimedValueConfig | null;
   ...
   */
  static produce(key: string): TimedValueConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, TimedValueConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, TimedValueConfig | null>;
   ...
   */
  static forConfigKey(configKey: string | null): TimedValueConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<TimedValueConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: TimedValueConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: TimedValueConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): TimedValueConfig | null;
