// TypeScript definitions for the C3 type Data.SparkEvaluateSpec

/**
 * @remarks this represents a value passed to a method that expects an instance of Data.SparkEvaluateSpec
 */
declare namespace Data {
  export interface ISparkEvaluateSpec {
...
/**
 * @remarks this represents a made instance of Data.SparkEvaluateSpec
 */
declare namespace Data {
  export class SparkEvaluateSpec extends Obj {
    ...
    withProjection(projection: string): Data.SparkEvaluateSpec;
    ...
    withGroup(group: string | null): Data.SparkEvaluateSpec;
    ...
    withHaving(having: string | null): Data.SparkEvaluateSpec;
    ...
    withFilter(filter: string | null): Data.SparkEvaluateSpec;

    /**
     * Variables values to substitute in filter expression. CURRENTLY UNDER CONSTRUCTION!
     */
    readonly vars?: C3.Map<string | null, Obj | null>;
    withVars(vars: C3.Map<string | null, Obj | null> | {[key: string | null]: IObj | null}): Data.SparkEvaluateSpec;
    ...
    withFetchHiddenSeedData(fetchHiddenSeedData: boolean): Data.SparkEvaluateSpec;
    ...
    withExcludeExtensions(excludeExtensions: boolean): Data.SparkEvaluateSpec;
    ...
    withAsOf(asOf: DateTime | Date | string | null): Data.SparkEvaluateSpec;
    ...
    withAllowLiteralOnBindVariableOverflow(allowLiteralOnBindVariableOverflow: boolean): Data.SparkEvaluateSpec;
    ...
    withUseDedicatedConnection(useDedicatedConnection: boolean): Data.SparkEvaluateSpec;
    ...
    withStmtTimeoutMs(stmtTimeoutMs: number | null): Data.SparkEvaluateSpec;
    ...
    withDontThrowJsonDeserErrors(dontThrowJsonDeserErrors: boolean): Data.SparkEvaluateSpec;
    ...
    withTimeRange(timeRange: ITimeRange | null): Data.SparkEvaluateSpec;
    ...
    withTimedFetchParentField(timedFetchParentField: string | null): Data.SparkEvaluateSpec;

    readonly includeBaseTypes?: boolean;
    withIncludeBaseTypes(includeBaseTypes: boolean): Data.SparkEvaluateSpec;
    ...
    withIgnoreViewInclude(ignoreViewInclude: boolean): Data.SparkEvaluateSpec;
    ...
    withOrder(order: string | null): Data.SparkEvaluateSpec;

    /**
     * Offset to use for paged evaluation.  Indicates the first computed result to return. Default is 0 (first).
     */
    readonly offset?: number | null;
    withOffset(offset: number | null): Data.SparkEvaluateSpec;
    ...
    withLimit(limit: number | null): Data.SparkEvaluateSpec;
    ...
    withSqlId(sqlId: number | null): Data.SparkEvaluateSpec;
    ...
    withDisableAuthz(disableAuthz: boolean): Data.SparkEvaluateSpec;
    ...
    withForceExprEval(forceExprEval: boolean): Data.SparkEvaluateSpec;
    ...
    withForceDbEngineEval(forceDbEngineEval: boolean): Data.SparkEvaluateSpec;
    ...
    withTimeRangeStart(timeRangeStart: DateTime | Date | string | null): Data.SparkEvaluateSpec;
    ...
    withTimeRangeEnd(timeRangeEnd: DateTime | Date | string | null): Data.SparkEvaluateSpec;
    ...
    withGrain(grain: string | null): Data.SparkEvaluateSpec;
    ...
    withInterval(interval: string | null): Data.SparkEvaluateSpec;
    ...
    withTimeZone(timeZone: string | null): Data.SparkEvaluateSpec;
    ...
    withExplain(explain: boolean): Data.SparkEvaluateSpec;

    /**
     * Indicates if resulting Spark Dataframe should be exploded and flattened.
     */
    readonly flatten?: boolean;
    withFlatten(flatten: boolean): Data.SparkEvaluateSpec;

    /**
     * Number of rows to retrieve in a single fetch partition.
     */
    readonly partitionSize?: number | null;
    withPartitionSize(partitionSize: number | null): Data.SparkEvaluateSpec;

    /**
     * Number of rows to include in a single batch when sending results to Spark cluster.
     */
    readonly batchSize?: number | null;
    withBatchSize(batchSize: number | null): Data.SparkEvaluateSpec;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.SparkEvaluateSpec | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.SparkEvaluateSpec | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.SparkEvaluateSpec | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.SparkEvaluateSpec | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.SparkEvaluateSpec;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.SparkEvaluateSpec;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.SparkEvaluateSpec;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.SparkEvaluateSpec | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.SparkEvaluateSpec | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.SparkEvaluateSpec;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.SparkEvaluateSpec;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.SparkEvaluateSpec;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.SparkEvaluateSpec;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.SparkEvaluateSpec;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.SparkEvaluateSpec;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.SparkEvaluateSpec;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.SparkEvaluateSpec;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.SparkEvaluateSpec;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.SparkEvaluateSpec;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.SparkEvaluateSpec;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.SparkEvaluateSpec;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.SparkEvaluateSpec;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.SparkEvaluateSpec;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.SparkEvaluateSpec;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.SparkEvaluateSpec;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.SparkEvaluateSpec;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.SparkEvaluateSpec;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.SparkEvaluateSpec;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.SparkEvaluateSpec;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.SparkEvaluateSpec;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.SparkEvaluateSpec;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.SparkEvaluateSpec;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.SparkEvaluateSpec;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.SparkEvaluateSpec;

    mergeJson(json: any | null): Data.SparkEvaluateSpec;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.SparkEvaluateSpec;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.SparkEvaluateSpec;
     ...
     */
    singletonArray(): C3.Array<Data.SparkEvaluateSpec | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.SparkEvaluateSpec | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.SparkEvaluateSpec | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.SparkEvaluateSpec | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.SparkEvaluateSpec | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.SparkEvaluateSpec | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.SparkEvaluateSpec | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.SparkEvaluateSpec | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.SparkEvaluateSpec | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.SparkEvaluateSpec;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.SparkEvaluateSpec;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.SparkEvaluateSpec;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.SparkEvaluateSpec;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.SparkEvaluateSpec;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.SparkEvaluateSpec;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.SparkEvaluateSpec;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Data.SparkEvaluateSpec;
     ...
     */
    static cachedEmptyInst(): Data.SparkEvaluateSpec;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.SparkEvaluateSpec>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.SparkEvaluateSpec;
