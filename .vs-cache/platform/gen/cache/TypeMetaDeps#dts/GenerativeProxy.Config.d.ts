// TypeScript definitions for the C3 type GenerativeProxy.Config

/**
 * Represent generic {@link Config config} for a {@link GenerativeProxy proxy}.
 *
 * @remarks this represents a value passed to a method that expects an instance of GenerativeProxy.Config
 */
declare namespace GenerativeProxy {
 ...
 */
declare namespace GenerativeProxy {
  export class Config<P> extends Obj {

    readonly configOverride?: string | null;
    withConfigOverride(configOverride: string | null): GenerativeProxy.Config;

    readonly secretOverride?: string | null;
    withSecretOverride(secretOverride: string | null): GenerativeProxy.Config;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: C3.Array<string | null>;
    withIssues(issues: C3.Array<string | null> | Array<string | null>): GenerativeProxy.Config;

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): GenerativeProxy.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): GenerativeProxy.Config<P> | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): GenerativeProxy.Config<P> | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): GenerativeProxy.Config<P> | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): GenerativeProxy.Config<P> | null;
     ...
     */
    replaceType(old: Type, new_: Type): GenerativeProxy.Config<P>;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): GenerativeProxy.Config<P>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): GenerativeProxy.Config<P>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<GenerativeProxy.Config<P> | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<GenerativeProxy.Config<P> | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): GenerativeProxy.Config<P>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenerativeProxy.Config<P>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenerativeProxy.Config<P>;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GenerativeProxy.Config<P>;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GenerativeProxy.Config<P>;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GenerativeProxy.Config<P>;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): GenerativeProxy.Config<P>;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenerativeProxy.Config<P>;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GenerativeProxy.Config<P>;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): GenerativeProxy.Config<P>;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): GenerativeProxy.Config<P>;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): GenerativeProxy.Config<P>;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): GenerativeProxy.Config<P>;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GenerativeProxy.Config<P>;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): GenerativeProxy.Config<P>;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GenerativeProxy.Config<P>;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GenerativeProxy.Config<P>;
     ...
     * @see #removeField
     */
    unsetField(field: string): GenerativeProxy.Config<P>;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GenerativeProxy.Config<P>;
     ...
     * @see #unsetField
     */
    removeField(field: string): GenerativeProxy.Config<P>;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GenerativeProxy.Config<P>;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): GenerativeProxy.Config<P>;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): GenerativeProxy.Config<P>;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): GenerativeProxy.Config<P>;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): GenerativeProxy.Config<P>;

    mergeJson(json: any | null): GenerativeProxy.Config<P>;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): GenerativeProxy.Config<P>;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): GenerativeProxy.Config<P>;
     ...
     */
    singletonArray(): C3.Array<GenerativeProxy.Config<P> | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<GenerativeProxy.Config<P> | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GenerativeProxy.Config<P> | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<GenerativeProxy.Config<P> | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GenerativeProxy.Config<P> | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, GenerativeProxy.Config<P> | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenerativeProxy.Config<P> | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GenerativeProxy.Config<P> | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GenerativeProxy.Config<P> | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): GenerativeProxy.Config<P>;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): GenerativeProxy.Config<P>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): GenerativeProxy.Config<P>;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GenerativeProxy.Config<P>;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): GenerativeProxy.Config<P>;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GenerativeProxy.Config<P>;
     ...
     * @see #fromString
     */
    static make(s: string | null): GenerativeProxy.Config<P> | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): GenerativeProxy.Config<P>;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): GenerativeProxy.Config<P>;
     ...
     */
    static cachedEmptyInst(): GenerativeProxy.Config<P>;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<GenerativeProxy.Config<P>>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): GenerativeProxy.Config<P>;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<GenerativeProxy.Config<P> | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<GenerativeProxy.Config<P> | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<GenerativeProxy.Config<P> | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): GenerativeProxy.Config<P> | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string | null): GenerativeProxy.Config<P> | null;
     ...
     * @see findByCacheKey
     */
    getCached(): GenerativeProxy.Config<P> | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): GenerativeProxy.Config<P> | null;
     ...
     */
    static produce(key: string): GenerativeProxy.Config<P> | null;
     ...
     */
    static produceAll(): C3.Map<string | null, GenerativeProxy.Config<P> | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, GenerativeProxy.Config<P> | null>;
     ...
     */
    getConfig(): GenerativeProxy.Config<P>;
     ...
     */
    getSecret(): GenerativeProxy.Config<P>;
     ...
     */
    static forConfigKey(configKey: string | null): GenerativeProxy.Config<P> | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<GenerativeProxy.Config<P> | null>;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: GenerativeProxy.Config<P>, override?: string | null): void;
     ...
     * @see setSecretValue
     */
    setSecretValues(from: GenerativeProxy.Config<P>, override?: string | null): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): GenerativeProxy.Config<P> | null;
     ...
     * @see #toString
     */
    static fromString(s: string | null): GenerativeProxy.Config<P> | null;

    /**
     * Finds {@link GenerativeProxy.Config config} by name.
     */
    static forName(name: string | null, failIfMissing?: boolean): GenerativeProxy.Config<P> | null;
