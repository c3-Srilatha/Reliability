// TypeScript definitions for the C3 type LukeAsyncQueueFile

/**
 * A subtype of {@link LukeAsyncQueueNode} that interacts with files downloaded by the browser
 *
 * @remarks this represents a value passed to a method that expects an instance of LukeAsyncQueueFile
 */
declare interface ILukeAsyncQueueFile {
 ...
 * A subtype of {@link LukeAsyncQueueNode} that interacts with files downloaded by the browser
 *
 * @remarks this represents a made instance of LukeAsyncQueueFile
 */
declare class LukeAsyncQueueFile extends Obj {
   ...
   */
  timeout?: number | null;
  withTimeout(timeout: number | null): LukeAsyncQueueFile;

  /**
   * The next node in the chain
   */
  next?: LukeAsyncQueueNode | null;
  withNext(next: ILukeAsyncQueueNode | null): LukeAsyncQueueFile;

  /**
   * The head of the chain that contains the current node
   */
  head?: LukeAsyncQueueNode | null;
  withHead(head: ILukeAsyncQueueNode | null): LukeAsyncQueueFile;
  ...
  withCatchChain(catchChain: ILukeAsyncQueueNode | null): LukeAsyncQueueFile;

  /**
   * When the node started running
   */
  startedAt?: number | null;
  withStartedAt(startedAt: number | null): LukeAsyncQueueFile;

  /**
   * When the node ended running
   */
  endedAt?: number | null;
  withEndedAt(endedAt: number | null): LukeAsyncQueueFile;

  /**
   * If the node spawns a nested async queue, its chains (heads) will be stored here.
   */
  asyncQueue?: C3.Array<LukeAsyncQueueNode | null>;
  withAsyncQueue(asyncQueue: C3.Array<LukeAsyncQueueNode | null> | Array<ILukeAsyncQueueNode | null>): LukeAsyncQueueFile;

  /**
   * Whether to skip the remaining chains in the queue
   */
  skipQueueFlag?: boolean;
  withSkipQueueFlag(skipQueueFlag: boolean): LukeAsyncQueueFile;

  /**
   * The function that yields a promise
   */
  func: any;
  withFunc(func: any): LukeAsyncQueueFile;
   ...
   */
  args?: C3.Array<any>;
  withArgs(args: C3.Array<any> | Array<any>): LukeAsyncQueueFile;

  /**
   * Metadata about what type of node this is.
   */
  label?: string | null;
  withLabel(label: string | null): LukeAsyncQueueFile;

  /**
   * "Unique" id assigned to each LukeAsyncQueueNode for UI. Uses C3 unique ID generator, but not backed by database
   */
  uuid?: string | null;
  withUuid(uuid: string | null): LukeAsyncQueueFile;

  /**
   * Construct an instance with initial state.
   */
  static make(): LukeAsyncQueueFile;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LukeAsyncQueueFile;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LukeAsyncQueueFile;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LukeAsyncQueueFile;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LukeAsyncQueueFile;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LukeAsyncQueueFile | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LukeAsyncQueueFile | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LukeAsyncQueueFile | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LukeAsyncQueueFile | null;
   ...
   */
  replaceType(old: Type, new_: Type): LukeAsyncQueueFile;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeAsyncQueueFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeAsyncQueueFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeAsyncQueueFile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeAsyncQueueFile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LukeAsyncQueueFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeAsyncQueueFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeAsyncQueueFile;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LukeAsyncQueueFile;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LukeAsyncQueueFile;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LukeAsyncQueueFile;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LukeAsyncQueueFile;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LukeAsyncQueueFile;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LukeAsyncQueueFile;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LukeAsyncQueueFile;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LukeAsyncQueueFile;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LukeAsyncQueueFile;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LukeAsyncQueueFile;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LukeAsyncQueueFile;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LukeAsyncQueueFile;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LukeAsyncQueueFile;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LukeAsyncQueueFile;
   ...
   * @see #removeField
   */
  unsetField(field: string): LukeAsyncQueueFile;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LukeAsyncQueueFile;
   ...
   * @see #unsetField
   */
  removeField(field: string): LukeAsyncQueueFile;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LukeAsyncQueueFile;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LukeAsyncQueueFile;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LukeAsyncQueueFile;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LukeAsyncQueueFile;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LukeAsyncQueueFile;

  mergeJson(json: any | null): LukeAsyncQueueFile;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LukeAsyncQueueFile;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LukeAsyncQueueFile;
   ...
   */
  singletonArray(): C3.Array<LukeAsyncQueueFile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LukeAsyncQueueFile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LukeAsyncQueueFile | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LukeAsyncQueueFile | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LukeAsyncQueueFile | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LukeAsyncQueueFile | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LukeAsyncQueueFile | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LukeAsyncQueueFile | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LukeAsyncQueueFile | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LukeAsyncQueueFile;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LukeAsyncQueueFile;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LukeAsyncQueueFile;
   ...
   */
  static cachedEmptyInst(): LukeAsyncQueueFile;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LukeAsyncQueueFile>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LukeAsyncQueueFile;
   ...
   * @return this Obj
   */
  setField(field: string, value: any, doNotConvert?: boolean): LukeAsyncQueueFile;
   ...
   * @return this Obj
   */
  setField(field: FieldType, value: any, doNotConvert?: boolean): LukeAsyncQueueFile;
  ...
  /**
   * Reads content as text from the downloaded file
   * @return a {@link LukeAsyncQueueNode} that resolves with the file content
   */
  readString(): LukeAsyncQueueNode | null;

  /**
   * Removes a downloaded file
   * @return a {@link LukeAsyncQueueNode} that resolves when the file is removed
   */
  remove(): LukeAsyncQueueNode | null;
}
