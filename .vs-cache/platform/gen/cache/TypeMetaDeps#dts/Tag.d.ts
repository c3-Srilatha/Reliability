// TypeScript definitions for the C3 type Tag

/**
 * Tag definition.
 *
 * @remarks this represents a value passed to a method that expects an instance of Tag
 */
declare interface ITag {
   ...
   */
  packages: C3.Array<string | null> | Array<string | null>;
   ...
   */
  repositories: C3.Map<string | null, string | null> | {[key: string | null]: string | null};

  /**
   * Fingerprints by provisioned packages. see {@link packages} for order of packages.
   */
  packageFingerprints: C3.Map<string | null, number | null> | {[key: string | null]: number | null};

  /**
   * Map containing various administrative info about the last time the tag was provisioned.
   */
  infos?: C3.Map<string | null, string | null> | {[key: string | null]: string | null};
   ...
   */
  hwProfile?: IHardwareProfile | null;

  /**
   * only used for remote tag
   */
  users?: C3.Array<string | null> | Array<string | null>;
 ...
 * Tag definition.
 *
 * @remarks this represents a made instance of Tag
 */
declare class Tag extends Obj {
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Tag;
  ...
  withVersion(version: number | null): Tag;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): Tag;

  /**
   * Unique numeric id assigned during creation of a tag in a tenant.
   */
  readonly tenantTagId: number;
  withTenantTagId(tenantTagId: number): Tag;

  /**
   * Description of the purpose of the tag.
   */
  readonly description?: string | null;
  withDescription(description: string | null): Tag;

  /**
   * Name of the root package.
   */
  readonly rootPackage: string;
  withRootPackage(rootPackage: string): Tag;

  /**
   * Ordered list of all packages provisioned in the tag.
   */
  readonly packages: C3.Array<string | null>;
  withPackages(packages: C3.Array<string | null> | Array<string | null>): Tag;

  /**
   * Name of the root repository.
   */
  readonly rootRepository: string;
  withRootRepository(rootRepository: string): Tag;

  /**
   * Map of all repository names to versions provisioned in the tag.
   */
  readonly repositories: C3.Map<string | null, string | null>;
  withRepositories(repositories: C3.Map<string | null, string | null> | {[key: string | null]: string | null}): Tag;

  /**
   * Fingerprints by provisioned packages. see {@link packages} for order of packages.
   */
  readonly packageFingerprints: C3.Map<string | null, number | null>;
  withPackageFingerprints(packageFingerprints: C3.Map<string | null, number | null> | {[key: string | null]: number | null}): Tag;

  /**
   * Map containing various administrative info about the last time the tag was provisioned.
   */
  readonly infos?: C3.Map<string | null, string | null>;
  withInfos(infos: C3.Map<string | null, string | null> | {[key: string | null]: string | null}): Tag;

  /**
   * If set then tag will monitor respective metadata repositories for changes and will continuously provision them.
   */
  readonly activeMetadata?: boolean;
  withActiveMetadata(activeMetadata: boolean): Tag;

  /**
   * If set then tag will contain test metadata. Only valid for tags in `test` mode.
   */
  readonly testMetadata?: boolean;
  withTestMetadata(testMetadata: boolean): Tag;

  /**
   * If true, Tag metadata file content will be cached in memory, when tag is loaded.
   */
  readonly cacheContent?: boolean;
  withCacheContent(cacheContent: boolean): Tag;

  /**
   * Tag is created on a remote node/container is value is true
   */
  readonly isRemote?: boolean;
  withIsRemote(isRemote: boolean): Tag;

  /**
   * hardware profile to be used for bringing up the compute resource (vm, container). Valid only for bound tag.
   */
  readonly hwProfile?: HardwareProfile | null;
  withHwProfile(hwProfile: IHardwareProfile | null): Tag;

  /**
   * only used for remote tag
   */
  readonly users?: C3.Array<string | null>;
  withUsers(users: C3.Array<string | null> | Array<string | null>): Tag;

  /**
   * server version of the tag
   */
  readonly serverVersion?: string | null;
  withServerVersion(serverVersion: string | null): Tag;

  /**
   * VM use as the compute instance if true, else container instance is used. Valid only for remote tag.
   */
  readonly useVm?: boolean;
  withUseVm(useVm: boolean): Tag;

  /**
   * Creates logically isolated PG and Cassandra datastores. Valid only for remote tag.
   */
  readonly useTenantDatastore?: boolean;
  withUseTenantDatastore(useTenantDatastore: boolean): Tag;

  /**
   * Tag is bound to a c3 server node if value is true
   */
  readonly isBound?: boolean;
  withIsBound(isBound: boolean): Tag;

  readonly tenantId?: string | null;
  withTenantId(tenantId: string | null): Tag;
   ...
   */
  replaceType(old: Type, new_: Type): Tag;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Tag | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Tag | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Tag | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Tag | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Tag;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Tag;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Tag | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Tag | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Tag;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Tag;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Tag;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Tag;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Tag;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Tag;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Tag;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Tag;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Tag;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Tag;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Tag;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Tag;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Tag;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Tag;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Tag;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Tag;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Tag;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Tag;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Tag;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Tag;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Tag;

  mergeJson(json: any | null): Tag;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Tag;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Tag;
   ...
   */
  singletonArray(): C3.Array<Tag | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Tag | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Tag | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Tag | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Tag | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Tag | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Tag | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Tag | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Tag | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Tag;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Tag;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Tag;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Tag;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Tag;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Tag;
   ...
   * @see #fromString
   */
  static make(s: string | null): Tag | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Tag;
   ...
   */
  static cachedEmptyInst(): Tag;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Tag>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Tag;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<Tag | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<Tag | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Tag | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Tag | null> | null>;
   ...
   */
  get(include?: string | null): Tag | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): Tag | null;
   ...
   */
  getMissing(spec: GetMissingSpec): Tag;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): Tag | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): Tag;
   ...
   * @see #toString
   */
  static fromString(s: string | null): Tag | null;
   ...
   */
  create(spec?: UpsertSpec | null): Tag | null;
   ...
   */
  static createBatch(objs: C3.Array<Tag | null> | null, spec?: UpsertSpec | null): ObjList<Tag | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<Tag | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Tag | null> | null;
   ...
   */
  update(srcObj?: Tag | null, spec?: UpsertSpec | null): Tag | null;
   ...
   */
  upsert(srcObj?: Tag | null, spec?: UpsertSpec | null): Tag | null;
   ...
   */
  merge(spec?: MergeSpec | null): Tag | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): Tag | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): Tag | null;
   ...
   */
  static updateBatch(objs: C3.Array<Tag | null> | null, srcObjs?: C3.Array<Tag | null>, spec?: UpsertSpec | null): ObjList<Tag | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<Tag | null>>, spec?: UpsertSpec | null): ObjList<Tag | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<Tag | null> | null, srcObjs?: C3.Array<Tag | null>, spec?: UpsertSpec | null): ObjList<Tag | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<Tag | null>>, spec?: UpsertSpec | null): ObjList<Tag | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<Tag | null> | null, spec?: TouchSpec | null): ObjList<Tag | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Tag | null> | null, spec?: MergeSpec | null): ObjList<Tag | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Tag | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Tag | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<Tag | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Tag | null> | null;
   ...
   */
  static mergeAll(mergeObj: Tag | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: Tag | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<Tag | null> | null, spec?: UpsertSpec | null): ObjList<Tag | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<Tag | null> | null, spec?: UpsertSpec | null): ObjList<Tag | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<Tag | null> | null): ObjList<Tag | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<Tag | null> | null): ObjList<Tag | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<Tag | null> | null): ObjList<Tag | null>;
   ...
   */
  static afterCreate(objs: C3.Array<Tag | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<Tag | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<Tag | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<Tag | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Tag | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): Tag | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<Tag | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: Tag | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<Tag | null> | null, callback?: λFunction<Tag | null, Tag | null> | null): ObjList<Tag | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<Tag | null> | null, callback?: λFunction<Tag | null, Tag | null> | null): C3.Array<ObjError | null>;
   ...
   */
  upgrade(version: string, spec?: WaitSpec | null): void;
   ...
   */
  static upsertWithActiveMetadata(name: string, testMetadata?: boolean): Tag;
   ...
   * Optionally also provisions test data.
   */
  setActiveAndTestMetadata(activeMetadata?: boolean, testMetadata?: boolean): Tag;

  /**
   * Updates types, code, seed and/or other metadata in this tag based on ALL metadata store.
   */
  updateFromAllMetadataStore(test?: boolean): Tag;

  /**
   * Removes all the data from this tag.
   */
  removeData(confirm?: boolean, includeSeedAndMeta?: boolean): void;
   ...
   */
  removeLocalFileData(confirm?: boolean): void;

  /**
   * return a tag Cache, create one if missing by name provided.
   */
  tagCache(name: string, create?: λSupplier<Cache<string | null, any> | null> | null): Cache<string | null, any> | null;

  /**
   * Returns a unique integer tenanatTagId for this tag
   */
  static getTenantTagId(tag?: Tag | null): number | null;

  /**
   * Return unique numeric id for a given type.
   */
  static getTypeId(moduleName?: string | null, typeName?: string | null): number | null;

  /**
   * Return type name for a give type id.
   */
  static getTypeNameFromId(typeId: number): string | null;

  /**
   * Return type for a give type id.
   */
  static getTypeFromId(typeId: number): Type | null;

  /**
   * Return unique numeric id for a given dot separated path (e.g. field path)
   */
  static getPathId(path?: string | null): number | null;
   ...
   */
  static getModules(tag: Tag): C3.Array<Module | null>;
   ...
   */
  static printType(tag?: Tag | null, moduleName?: string | null, typeName?: string | null, options?: DSLPrintTypeSpec | null): C3.Array<DSLPrintResult | null>;
   ...
   */
  static generateTypeDoc(tag?: Tag | null, options?: DSLPrintTypeSpec | null): C3.Array<DSLPrintResult | null>;
   ...
   */
  static printFunction(tag?: Tag | null, moduleName?: string | null, typeName?: string | null, funcName?: string | null, options?: DSLPrintTypeSpec | null): C3.Array<DSLPrintResult | null>;
   ...
   */
  static getModuleMetadata(tag?: Tag | null, modules?: C3.Array<ModuleHash | null>, detail?: string | null): C3.Array<Module | null>;
   ...
   */
  static getTypeMetadata(tag?: Tag | null, modules?: C3.Array<ModuleHash | null>, detail?: string | null): C3.Array<Type | null>;
   ...
   */
  static getFunctionMetadata(tag?: Tag | null, typeRef?: Type | null, functions?: C3.Array<string | null>): C3.Array<FieldType | null>;
   ...
   */
  static generateTag(tag?: Tag | null, spec?: GenerateTagSpec | null): GenerateTagStatus | null;
   ...
   */
  emptyCache(nodeIds?: C3.Array<string | null>, spec?: TimeoutSpec | null): C3.Map<string | null, Pair<any, C3.Error | null> | null>;

  emptyCacheLocal(): void;

  isValid(): boolean;

  ownTypes(): C3.Array<Type | null>;

  allTypes(): C3.Array<Type | null>;

  errors(): C3.Array<Pkg.Issue | null>;
}
