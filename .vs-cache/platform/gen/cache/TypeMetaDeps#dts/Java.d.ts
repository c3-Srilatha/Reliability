// TypeScript definitions for the C3 type Java

/**
 * Interface to Java language.
 *
 * @remarks this represents a value passed to a method that expects an instance of Java
 */
declare interface IJava {
 ...
 */
declare class Java extends Obj {

  /**
   * The unique and required name of this instance.
   */
  readonly name: string;
  withName(name: string): Java;
  ...
  withJAVA(JAVA: string | null): Java;
  ...
  withJAVASCRIPT(JAVASCRIPT: string | null): Java;
  ...
  withPYTHON(PYTHON: string | null): Java;
  ...
  withTYPESCRIPT(TYPESCRIPT: string | null): Java;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Java | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Java | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Java | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Java | null;
   ...
   */
  replaceType(old: Type, new_: Type): Java;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): Java;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Java;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Java;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Java;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Java;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Java | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Java | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Java | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Java | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Java;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Java;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Java;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Java;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Java;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Java;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Java;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): Java;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Java;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): Java;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Java;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Java;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Java;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Java;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Java;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): Java;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Java;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): Java;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Java;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): Java;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Java;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): Java;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Java;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Java;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Java;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): Java;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Java;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Java;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Java;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): Java;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Java;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): Java;
   ...
   * @see #removeField
   */
  static unsetField(field: string): Java;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Java;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): Java;
   ...
   * @see #unsetField
   */
  static removeField(field: string): Java;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Java;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): Java;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Java;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Java;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Java;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): Java;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Java;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Java;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Java;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Java;

  mergeJson(json: any | null): Java;

  static mergeJson(json: any | null): Java;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Java;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Java;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Java;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): Java;
   ...
   */
  singletonArray(): C3.Array<Java | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<Java | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Java | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Java | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<Java | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Java | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Java | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Java | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Java | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<Java | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Java | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Java;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Java;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Java;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Java;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Java;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Java;
   ...
   * @see #fromString
   */
  static make(s: string | null): Java | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Java;
   ...
   */
  static cachedEmptyInst(): Java;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Java>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Java;
   ...
   */
  static forFileExt(ext: string | null, failIfNone?: boolean): Java | null;
   ...
   */
  static apply(action: λSupplier<T | null>): T | null;

  /**
   * Applies given lambda
   */
  static apply(action: λSupplier<T | null>, spec: TimeoutSpec): T | null;

  /**
   * Submits given lambda for asynchronous execution.
   */
  static async(action: λSupplier<T | null>, spec?: TimeoutSpec | null): Promise<T>;
   ...
   */
  static exec(java: string, imports?: string | null): any;
}
