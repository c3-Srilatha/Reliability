// TypeScript definitions for the C3 type Pkg.Store.Zip.Config

/**
 * @remarks this represents a value passed to a method that expects an instance of Pkg.Store.Zip.Config
 */
declare namespace Pkg.Store.Zip {
...
declare namespace Pkg.Store.Zip {
  export class Config extends Obj {
    ...
    withConfigOverride(configOverride: string | null): Pkg.Store.Zip.Config;

    readonly secretOverride?: string | null;
    withSecretOverride(secretOverride: string | null): Pkg.Store.Zip.Config;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: C3.Array<string | null>;
    withIssues(issues: C3.Array<string | null> | Array<string | null>): Pkg.Store.Zip.Config;

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): Pkg.Store.Zip.Config;

    /**
     * url path of a built pkg as zip file.
     */
    readonly url: string;
    withUrl(url: string): Pkg.Store.Zip.Config;

    /**
     * If true, the artifact has source content only.
     */
    readonly sourceOnly?: boolean;
    withSourceOnly(sourceOnly: boolean): Pkg.Store.Zip.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Pkg.Store.Zip.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Pkg.Store.Zip.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Pkg.Store.Zip.Config | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Pkg.Store.Zip.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Pkg.Store.Zip.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Pkg.Store.Zip.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Pkg.Store.Zip.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Pkg.Store.Zip.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Pkg.Store.Zip.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Pkg.Store.Zip.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Pkg.Store.Zip.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Pkg.Store.Zip.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Pkg.Store.Zip.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Pkg.Store.Zip.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Pkg.Store.Zip.Config;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Pkg.Store.Zip.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Pkg.Store.Zip.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Pkg.Store.Zip.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Pkg.Store.Zip.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Pkg.Store.Zip.Config;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Pkg.Store.Zip.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Pkg.Store.Zip.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Pkg.Store.Zip.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Pkg.Store.Zip.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Pkg.Store.Zip.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Pkg.Store.Zip.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Pkg.Store.Zip.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Pkg.Store.Zip.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Pkg.Store.Zip.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Pkg.Store.Zip.Config;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Pkg.Store.Zip.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Pkg.Store.Zip.Config;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Pkg.Store.Zip.Config;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Pkg.Store.Zip.Config;

    mergeJson(json: any | null): Pkg.Store.Zip.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Pkg.Store.Zip.Config;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Pkg.Store.Zip.Config;
     ...
     */
    singletonArray(): C3.Array<Pkg.Store.Zip.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Pkg.Store.Zip.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Pkg.Store.Zip.Config | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Pkg.Store.Zip.Config | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Pkg.Store.Zip.Config | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Pkg.Store.Zip.Config | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Pkg.Store.Zip.Config | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Pkg.Store.Zip.Config | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Pkg.Store.Zip.Config | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Pkg.Store.Zip.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Pkg.Store.Zip.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Pkg.Store.Zip.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Pkg.Store.Zip.Config;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Pkg.Store.Zip.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Pkg.Store.Zip.Config;
     ...
     * @see #fromString
     */
    static make(s: string | null): Pkg.Store.Zip.Config | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Pkg.Store.Zip.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Pkg.Store.Zip.Config;
     ...
     */
    static cachedEmptyInst(): Pkg.Store.Zip.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Pkg.Store.Zip.Config>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Pkg.Store.Zip.Config;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<Pkg.Store.Zip.Config | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<Pkg.Store.Zip.Config | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<Pkg.Store.Zip.Config | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): Pkg.Store.Zip.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string | null): Pkg.Store.Zip.Config | null;
     ...
     * @see findByCacheKey
     */
    getCached(): Pkg.Store.Zip.Config | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): Pkg.Store.Zip.Config | null;
     ...
     */
    static produce(key: string): Pkg.Store.Zip.Config | null;
     ...
     */
    static produceAll(): C3.Map<string | null, Pkg.Store.Zip.Config | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, Pkg.Store.Zip.Config | null>;
     ...
     */
    getConfig(): Pkg.Store.Zip.Config;
     ...
     */
    getSecret(): Pkg.Store.Zip.Config;
     ...
     */
    static forConfigKey(configKey: string | null): Pkg.Store.Zip.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<Pkg.Store.Zip.Config | null>;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Pkg.Store.Zip.Config, override?: string | null): void;
     ...
     * @see setSecretValue
     */
    setSecretValues(from: Pkg.Store.Zip.Config, override?: string | null): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Pkg.Store.Zip.Config | null;
     ...
     * @see #toString
     */
    static fromString(s: string | null): Pkg.Store.Zip.Config | null;
     ...
     */
    static forName(name: string | null, failIfMissing?: boolean): Pkg.Store.Zip.Config | null;
  }
}
