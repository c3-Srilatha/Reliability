// TypeScript definitions for the C3 type QuartileConfidence

/**
 * the data in this type is used for computing object-level confidence and scores
 *
 * @remarks this represents a value passed to a method that expects an instance of QuartileConfidence
 */
declare interface IQuartileConfidence {
 ...
 * the data in this type is used for computing object-level confidence and scores
 *
 * @remarks this represents a made instance of QuartileConfidence
 */
declare class QuartileConfidence extends Obj {
   ...
   */
  readonly id: string;
  withId(id: string): QuartileConfidence;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): QuartileConfidence;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): QuartileConfidence;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): QuartileConfidence;
  ...
  withVersion(version: number | null): QuartileConfidence;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): QuartileConfidence;

  readonly aggregatedMetric: Type;
  withAggregatedMetric(aggregatedMetric: IType): QuartileConfidence;

  readonly q1?: number | null;
  withQ1(q1: number | null): QuartileConfidence;

  readonly q2?: number | null;
  withQ2(q2: number | null): QuartileConfidence;

  readonly q3?: number | null;
  withQ3(q3: number | null): QuartileConfidence;

  readonly q4?: number | null;
  withQ4(q4: number | null): QuartileConfidence;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): QuartileConfidence | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): QuartileConfidence | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): QuartileConfidence | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): QuartileConfidence | null;
   ...
   */
  replaceType(old: Type, new_: Type): QuartileConfidence;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): QuartileConfidence;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): QuartileConfidence;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<QuartileConfidence | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<QuartileConfidence | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): QuartileConfidence;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): QuartileConfidence;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): QuartileConfidence;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): QuartileConfidence;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): QuartileConfidence;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): QuartileConfidence;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): QuartileConfidence;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): QuartileConfidence;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): QuartileConfidence;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): QuartileConfidence;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): QuartileConfidence;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): QuartileConfidence;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): QuartileConfidence;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): QuartileConfidence;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): QuartileConfidence;
   ...
   * @see #unsetField
   */
  defaultField(field: string): QuartileConfidence;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): QuartileConfidence;
   ...
   * @see #removeField
   */
  unsetField(field: string): QuartileConfidence;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): QuartileConfidence;
   ...
   * @see #unsetField
   */
  removeField(field: string): QuartileConfidence;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): QuartileConfidence;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): QuartileConfidence;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): QuartileConfidence;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): QuartileConfidence;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): QuartileConfidence;

  mergeJson(json: any | null): QuartileConfidence;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): QuartileConfidence;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): QuartileConfidence;
   ...
   */
  singletonArray(): C3.Array<QuartileConfidence | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<QuartileConfidence | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<QuartileConfidence | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<QuartileConfidence | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<QuartileConfidence | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, QuartileConfidence | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, QuartileConfidence | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<QuartileConfidence | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<QuartileConfidence | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): QuartileConfidence;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): QuartileConfidence;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): QuartileConfidence;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): QuartileConfidence;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): QuartileConfidence;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): QuartileConfidence;
   ...
   * @see #fromString
   */
  static make(s: string | null): QuartileConfidence | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): QuartileConfidence;
   ...
   */
  static cachedEmptyInst(): QuartileConfidence;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<QuartileConfidence>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): QuartileConfidence;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<QuartileConfidence | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<QuartileConfidence | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<QuartileConfidence | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<QuartileConfidence | null> | null>;
   ...
   */
  get(include?: string | null): QuartileConfidence | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): QuartileConfidence | null;
   ...
   */
  getMissing(spec: GetMissingSpec): QuartileConfidence;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): QuartileConfidence | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): QuartileConfidence;
   ...
   * @see #toString
   */
  static fromString(s: string | null): QuartileConfidence | null;
   ...
   */
  create(spec?: UpsertSpec | null): QuartileConfidence | null;
   ...
   */
  static createBatch(objs: C3.Array<QuartileConfidence | null> | null, spec?: UpsertSpec | null): ObjList<QuartileConfidence | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<QuartileConfidence | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<QuartileConfidence | null> | null;
   ...
   */
  update(srcObj?: QuartileConfidence | null, spec?: UpsertSpec | null): QuartileConfidence | null;
   ...
   */
  upsert(srcObj?: QuartileConfidence | null, spec?: UpsertSpec | null): QuartileConfidence | null;
   ...
   */
  merge(spec?: MergeSpec | null): QuartileConfidence | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): QuartileConfidence | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): QuartileConfidence | null;
   ...
   */
  static updateBatch(objs: C3.Array<QuartileConfidence | null> | null, srcObjs?: C3.Array<QuartileConfidence | null>, spec?: UpsertSpec | null): ObjList<QuartileConfidence | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<QuartileConfidence | null>>, spec?: UpsertSpec | null): ObjList<QuartileConfidence | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<QuartileConfidence | null> | null, srcObjs?: C3.Array<QuartileConfidence | null>, spec?: UpsertSpec | null): ObjList<QuartileConfidence | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<QuartileConfidence | null>>, spec?: UpsertSpec | null): ObjList<QuartileConfidence | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<QuartileConfidence | null> | null, spec?: TouchSpec | null): ObjList<QuartileConfidence | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<QuartileConfidence | null> | null, spec?: MergeSpec | null): ObjList<QuartileConfidence | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<QuartileConfidence | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<QuartileConfidence | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<QuartileConfidence | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<QuartileConfidence | null> | null;
   ...
   */
  static mergeAll(mergeObj: QuartileConfidence | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: QuartileConfidence | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<QuartileConfidence | null> | null, spec?: UpsertSpec | null): ObjList<QuartileConfidence | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<QuartileConfidence | null> | null, spec?: UpsertSpec | null): ObjList<QuartileConfidence | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): QuartileConfidence | null;
   ...
   */
  static beforeCreate(objs: C3.Array<QuartileConfidence | null> | null): ObjList<QuartileConfidence | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<QuartileConfidence | null> | null): ObjList<QuartileConfidence | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<QuartileConfidence | null> | null): ObjList<QuartileConfidence | null>;
   ...
   */
  static afterCreate(objs: C3.Array<QuartileConfidence | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<QuartileConfidence | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<QuartileConfidence | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<QuartileConfidence | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<QuartileConfidence | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): QuartileConfidence | null;
   ...
   */
  withoutIdentity(): QuartileConfidence | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<QuartileConfidence | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: QuartileConfidence | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<QuartileConfidence | null> | null, callback?: λFunction<QuartileConfidence | null, QuartileConfidence | null> | null): ObjList<QuartileConfidence | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<QuartileConfidence | null> | null, callback?: λFunction<QuartileConfidence | null, QuartileConfidence | null> | null): C3.Array<ObjError | null>;
