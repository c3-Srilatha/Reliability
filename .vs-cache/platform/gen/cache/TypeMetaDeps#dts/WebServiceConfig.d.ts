// TypeScript definitions for the C3 type WebServiceConfig

/**
 * @remarks this represents a value passed to a method that expects an instance of WebServiceConfig
 */
declare interface IWebServiceConfig {
  ...
  urls?: C3.Map<string | null, string | null> | {[key: string | null]: string | null};

  activeUrlName: string;

  properties?: C3.Map<string | null, string | null> | {[key: string | null]: string | null};
}

/**
 * @remarks this represents a made instance of WebServiceConfig
 */
declare class WebServiceConfig extends Obj {
   ...
   */
  readonly id: string;
  withId(id: string): WebServiceConfig;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): WebServiceConfig;

  /**
   * Name of the Obj instance
   */
  readonly name: string;
  withName(name: string): WebServiceConfig;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): WebServiceConfig;
  ...
  withVersion(version: number | null): WebServiceConfig;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): WebServiceConfig;
  ...
  withUserUpdatedFields(userUpdatedFields: C3.Array<string | null> | Array<string | null>): WebServiceConfig;
  ...
  withHidden(hidden: boolean): WebServiceConfig;
  ...
  withUserOwned(userOwned: boolean): WebServiceConfig;

  readonly description?: string | null;
  withDescription(description: string | null): WebServiceConfig;

  readonly urls?: C3.Map<string | null, string | null>;
  withUrls(urls: C3.Map<string | null, string | null> | {[key: string | null]: string | null}): WebServiceConfig;

  readonly activeUrlName: string;
  withActiveUrlName(activeUrlName: string): WebServiceConfig;

  readonly properties?: C3.Map<string | null, string | null>;
  withProperties(properties: C3.Map<string | null, string | null> | {[key: string | null]: string | null}): WebServiceConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): WebServiceConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): WebServiceConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): WebServiceConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): WebServiceConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): WebServiceConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): WebServiceConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): WebServiceConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<WebServiceConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<WebServiceConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): WebServiceConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): WebServiceConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): WebServiceConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): WebServiceConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): WebServiceConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): WebServiceConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): WebServiceConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): WebServiceConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): WebServiceConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): WebServiceConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): WebServiceConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): WebServiceConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): WebServiceConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): WebServiceConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): WebServiceConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): WebServiceConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): WebServiceConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): WebServiceConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): WebServiceConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): WebServiceConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): WebServiceConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): WebServiceConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): WebServiceConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): WebServiceConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): WebServiceConfig;

  mergeJson(json: any | null): WebServiceConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): WebServiceConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): WebServiceConfig;
   ...
   */
  singletonArray(): C3.Array<WebServiceConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<WebServiceConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<WebServiceConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<WebServiceConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<WebServiceConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, WebServiceConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, WebServiceConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<WebServiceConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<WebServiceConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): WebServiceConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): WebServiceConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): WebServiceConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): WebServiceConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): WebServiceConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): WebServiceConfig;
   ...
   * @see #fromString
   */
  static make(s: string | null): WebServiceConfig | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): WebServiceConfig;
   ...
   */
  static cachedEmptyInst(): WebServiceConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<WebServiceConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): WebServiceConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<WebServiceConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<WebServiceConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<WebServiceConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): WebServiceConfig | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string | null): WebServiceConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): WebServiceConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): WebServiceConfig | null;
   ...
   */
  static produce(key: string): WebServiceConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, WebServiceConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, WebServiceConfig | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<WebServiceConfig | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<WebServiceConfig | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<WebServiceConfig | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<WebServiceConfig | null> | null>;
   ...
   */
  get(include?: string | null): WebServiceConfig | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): WebServiceConfig | null;
   ...
   */
  getMissing(spec: GetMissingSpec): WebServiceConfig;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): WebServiceConfig | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): WebServiceConfig;
   ...
   * @see #toString
   */
  static fromString(s: string | null): WebServiceConfig | null;
   ...
   */
  create(spec?: UpsertSpec | null): WebServiceConfig | null;
   ...
   */
  static createBatch(objs: C3.Array<WebServiceConfig | null> | null, spec?: UpsertSpec | null): ObjList<WebServiceConfig | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<WebServiceConfig | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<WebServiceConfig | null> | null;
   ...
   */
  update(srcObj?: WebServiceConfig | null, spec?: UpsertSpec | null): WebServiceConfig | null;
   ...
   */
  upsert(srcObj?: WebServiceConfig | null, spec?: UpsertSpec | null): WebServiceConfig | null;
   ...
   */
  merge(spec?: MergeSpec | null): WebServiceConfig | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): WebServiceConfig | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): WebServiceConfig | null;
   ...
   */
  static updateBatch(objs: C3.Array<WebServiceConfig | null> | null, srcObjs?: C3.Array<WebServiceConfig | null>, spec?: UpsertSpec | null): ObjList<WebServiceConfig | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<WebServiceConfig | null>>, spec?: UpsertSpec | null): ObjList<WebServiceConfig | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<WebServiceConfig | null> | null, srcObjs?: C3.Array<WebServiceConfig | null>, spec?: UpsertSpec | null): ObjList<WebServiceConfig | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<WebServiceConfig | null>>, spec?: UpsertSpec | null): ObjList<WebServiceConfig | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<WebServiceConfig | null> | null, spec?: TouchSpec | null): ObjList<WebServiceConfig | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<WebServiceConfig | null> | null, spec?: MergeSpec | null): ObjList<WebServiceConfig | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<WebServiceConfig | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<WebServiceConfig | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<WebServiceConfig | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<WebServiceConfig | null> | null;
   ...
   */
  static mergeAll(mergeObj: WebServiceConfig | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: WebServiceConfig | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<WebServiceConfig | null> | null, spec?: UpsertSpec | null): ObjList<WebServiceConfig | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<WebServiceConfig | null> | null, spec?: UpsertSpec | null): ObjList<WebServiceConfig | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): WebServiceConfig | null;
   ...
   */
  static beforeCreate(objs: C3.Array<WebServiceConfig | null> | null): ObjList<WebServiceConfig | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<WebServiceConfig | null> | null): ObjList<WebServiceConfig | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<WebServiceConfig | null> | null): ObjList<WebServiceConfig | null>;
   ...
   */
  static afterCreate(objs: C3.Array<WebServiceConfig | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<WebServiceConfig | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<WebServiceConfig | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<WebServiceConfig | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<WebServiceConfig | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): WebServiceConfig | null;
   ...
   */
  withoutIdentity(): WebServiceConfig | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<WebServiceConfig | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: WebServiceConfig | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<WebServiceConfig | null> | null, callback?: λFunction<WebServiceConfig | null, WebServiceConfig | null> | null): ObjList<WebServiceConfig | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<WebServiceConfig | null> | null, callback?: λFunction<WebServiceConfig | null, WebServiceConfig | null> | null): C3.Array<ObjError | null>;
   ...
   */
  publish(subPath?: string | null, contentType?: string | null): WebServiceConfig;
   ...
   */
  static removeSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<WebServiceConfig | null> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec | null): WebServiceConfig | null;
   ...
   */
  static createSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<WebServiceConfig | null> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData | null, spec?: UpsertSpec | null): WebServiceConfig | null;
   ...
   */
  static updateSeedDataBatch(objs?: C3.Array<SeedData | null>, srcObjs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<WebServiceConfig | null> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec | null): WebServiceConfig | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: C3.Array<SeedData | null>, spec?: MergeSpec | null): ObjList<WebServiceConfig | null> | null;
  ...
  dependencies(): SeedDataDeps<WebServiceConfig | null> | null;
