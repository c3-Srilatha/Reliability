// TypeScript definitions for the C3 type InvalidationQueueError
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of InvalidationQueueError
 */
declare interface IInvalidationQueueError {
   ...
   */
  context?: string | null | DateTime | Date | string | null | IObj | null | null;
 ...
 * enforced by having a unique index on the queueTypeId/entryId and using a hash of those values as the ID value.
 *
 * @remarks this represents a made instance of InvalidationQueueError
 */
declare class InvalidationQueueError extends Obj {
   ...
   */
  readonly id: string;
  withId(id: string): InvalidationQueueError;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): InvalidationQueueError;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): InvalidationQueueError;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): InvalidationQueueError;
  ...
  withVersion(version: number | null): InvalidationQueueError;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): InvalidationQueueError;

  /**
   * The ID of the queue type where the entry with the errors are located.
   */
  readonly queueTypeId?: number | null;
  withQueueTypeId(queueTypeId: number | null): InvalidationQueueError;

  /**
   * Target type ID for the entry that has the error.
   */
  readonly targetTypeId?: number | null;
  withTargetTypeId(targetTypeId: number | null): InvalidationQueueError;

  /**
   * Target object ID for the entry that has the error.
   */
  readonly targetObjId?: string | null;
  withTargetObjId(targetObjId: string | null): InvalidationQueueError;

  /**
   * Entry type for the entry that has the error.
   */
  readonly entryType?: string | null;
  withEntryType(entryType: string | null): InvalidationQueueError;

  /**
   * Context for the entry that has the error.
   */
  readonly context?: string | null | DateTime | null | Obj | null | null;
  withContext(context: string | null | DateTime | Date | string | null | IObj | null | null): InvalidationQueueError;

  /**
   * Priority for the entry that has the error.
   */
  readonly priority?: number | null;
  withPriority(priority: number | null): InvalidationQueueError;

  /**
   * Node pool for the entry that has the error.
   */
  readonly nodePool?: string | null;
  withNodePool(nodePool: string | null): InvalidationQueueError;

  /**
   * Primary error code for the error.
   */
  readonly errorCode: string;
  withErrorCode(errorCode: string): InvalidationQueueError;

  /**
   * Id of queue entry that has the error.
   */
  readonly entryId?: string | null;
  withEntryId(entryId: string | null): InvalidationQueueError;

  /**
   * Invalidation timestamp for the entry that has the error.
   */
  readonly invalidatedAt?: DateTime | null;
  withInvalidatedAt(invalidatedAt: DateTime | Date | string | null): InvalidationQueueError;

  /**
   * Node where the entry failed.
   */
  readonly computingNodeId?: string | null;
  withComputingNodeId(computingNodeId: string | null): InvalidationQueueError;

  /**
   * Timestamp when the error was added.
   */
  readonly timestamp?: DateTime | null;
  withTimestamp(timestamp: DateTime | Date | string | null): InvalidationQueueError;

  /**
   * Complete queue entry in the state it was in when the error occurred.
   */
  readonly entry?: any | null;
  withEntry(entry: any | null): InvalidationQueueError;

  /**
   * Details of the error that the entry is for.
   */
  readonly detail?: InvalidationQueueErrorDetail | null;
  withDetail(detail: IInvalidationQueueErrorDetail | null): InvalidationQueueError;

  /**
   * If reviewed, the review for the entry and null otherwise.  All entries in a group being reviewed will have the
   * same value.
   */
  readonly review?: InvalidationQueueErrorReview | null;
  withReview(review: IInvalidationQueueErrorReview | null): InvalidationQueueError;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): InvalidationQueueError | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): InvalidationQueueError | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): InvalidationQueueError | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): InvalidationQueueError | null;
   ...
   */
  replaceType(old: Type, new_: Type): InvalidationQueueError;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): InvalidationQueueError;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): InvalidationQueueError;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<InvalidationQueueError | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<InvalidationQueueError | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): InvalidationQueueError;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): InvalidationQueueError;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): InvalidationQueueError;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): InvalidationQueueError;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): InvalidationQueueError;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): InvalidationQueueError;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): InvalidationQueueError;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): InvalidationQueueError;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): InvalidationQueueError;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): InvalidationQueueError;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): InvalidationQueueError;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): InvalidationQueueError;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): InvalidationQueueError;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): InvalidationQueueError;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): InvalidationQueueError;
   ...
   * @see #unsetField
   */
  defaultField(field: string): InvalidationQueueError;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): InvalidationQueueError;
   ...
   * @see #removeField
   */
  unsetField(field: string): InvalidationQueueError;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): InvalidationQueueError;
   ...
   * @see #unsetField
   */
  removeField(field: string): InvalidationQueueError;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): InvalidationQueueError;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): InvalidationQueueError;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): InvalidationQueueError;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): InvalidationQueueError;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): InvalidationQueueError;

  mergeJson(json: any | null): InvalidationQueueError;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): InvalidationQueueError;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): InvalidationQueueError;
   ...
   */
  singletonArray(): C3.Array<InvalidationQueueError | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<InvalidationQueueError | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<InvalidationQueueError | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<InvalidationQueueError | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<InvalidationQueueError | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, InvalidationQueueError | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, InvalidationQueueError | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<InvalidationQueueError | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<InvalidationQueueError | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): InvalidationQueueError;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): InvalidationQueueError;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): InvalidationQueueError;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): InvalidationQueueError;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): InvalidationQueueError;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): InvalidationQueueError;
   ...
   * @see #fromString
   */
  static make(s: string | null): InvalidationQueueError | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): InvalidationQueueError;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): InvalidationQueueError;
   ...
   */
  static cachedEmptyInst(): InvalidationQueueError;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<InvalidationQueueError>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): InvalidationQueueError;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<InvalidationQueueError | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<InvalidationQueueError | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<InvalidationQueueError | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<InvalidationQueueError | null> | null>;
   ...
   */
  get(include?: string | null): InvalidationQueueError | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): InvalidationQueueError | null;
   ...
   */
  getMissing(spec: GetMissingSpec): InvalidationQueueError;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): InvalidationQueueError | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): InvalidationQueueError;
   ...
   * @see #toString
   */
  static fromString(s: string | null): InvalidationQueueError | null;
   ...
   */
  create(spec?: UpsertSpec | null): InvalidationQueueError | null;
   ...
   */
  static createBatch(objs: C3.Array<InvalidationQueueError | null> | null, spec?: UpsertSpec | null): ObjList<InvalidationQueueError | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<InvalidationQueueError | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<InvalidationQueueError | null> | null;
   ...
   */
  update(srcObj?: InvalidationQueueError | null, spec?: UpsertSpec | null): InvalidationQueueError | null;
   ...
   */
  upsert(srcObj?: InvalidationQueueError | null, spec?: UpsertSpec | null): InvalidationQueueError | null;
   ...
   */
  merge(spec?: MergeSpec | null): InvalidationQueueError | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): InvalidationQueueError | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): InvalidationQueueError | null;
   ...
   */
  static updateBatch(objs: C3.Array<InvalidationQueueError | null> | null, srcObjs?: C3.Array<InvalidationQueueError | null>, spec?: UpsertSpec | null): ObjList<InvalidationQueueError | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<InvalidationQueueError | null>>, spec?: UpsertSpec | null): ObjList<InvalidationQueueError | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<InvalidationQueueError | null> | null, srcObjs?: C3.Array<InvalidationQueueError | null>, spec?: UpsertSpec | null): ObjList<InvalidationQueueError | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<InvalidationQueueError | null>>, spec?: UpsertSpec | null): ObjList<InvalidationQueueError | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<InvalidationQueueError | null> | null, spec?: TouchSpec | null): ObjList<InvalidationQueueError | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<InvalidationQueueError | null> | null, spec?: MergeSpec | null): ObjList<InvalidationQueueError | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<InvalidationQueueError | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<InvalidationQueueError | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<InvalidationQueueError | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<InvalidationQueueError | null> | null;
   ...
   */
  static mergeAll(mergeObj: InvalidationQueueError | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: InvalidationQueueError | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<InvalidationQueueError | null> | null, spec?: UpsertSpec | null): ObjList<InvalidationQueueError | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<InvalidationQueueError | null> | null, spec?: UpsertSpec | null): ObjList<InvalidationQueueError | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): InvalidationQueueError | null;
   ...
   */
  static beforeCreate(objs: C3.Array<InvalidationQueueError | null> | null): ObjList<InvalidationQueueError | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<InvalidationQueueError | null> | null): ObjList<InvalidationQueueError | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<InvalidationQueueError | null> | null): ObjList<InvalidationQueueError | null>;
   ...
   */
  static afterCreate(objs: C3.Array<InvalidationQueueError | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<InvalidationQueueError | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<InvalidationQueueError | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<InvalidationQueueError | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<InvalidationQueueError | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): InvalidationQueueError | null;
   ...
   */
  withoutIdentity(): InvalidationQueueError | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<InvalidationQueueError | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: InvalidationQueueError | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<InvalidationQueueError | null> | null, callback?: λFunction<InvalidationQueueError | null, InvalidationQueueError | null> | null): ObjList<InvalidationQueueError | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<InvalidationQueueError | null> | null, callback?: λFunction<InvalidationQueueError | null, InvalidationQueueError | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static reportCount(queueType: Type, filter?: InvalidationQueueFilterSpec | null, group?: InvalidationQueueGroupSpec | null, offset?: number | null, limit?: number | null): C3.Array<InvalidationQueueGroupResult | null>;
}
