// TypeScript definitions for the C3 type TimeInfo

/**
 * @remarks this represents a value passed to a method that expects an instance of TimeInfo
 */
declare interface ITimeInfo {
 ...
 */
declare class TimeInfo extends Obj {
  ...
  withStart(start: DateTime | Date | string | null): TimeInfo;
  ...
  withEnd(end: DateTime | Date | string | null): TimeInfo;

  /**
   * Interval of timeseries.
   */
  readonly interval?: string | null;
  withInterval(interval: string | null): TimeInfo;

  /**
   * Time zone treatment for timeseries.
   */
  readonly timeZone?: TimeZone | null;
  withTimeZone(timeZone: ITimeZone | null): TimeInfo;

  /**
   * length of this time-info in intervals. I.e. size of the timeseries this info represents.
   */
  readonly _size?: number | null;
  with_size(_size: number | null): TimeInfo;

  /**
   * true if time range is aligned with interval.
   */
  readonly _isAligned?: boolean;
  with_isAligned(_isAligned: boolean): TimeInfo;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TimeInfo | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TimeInfo | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TimeInfo | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TimeInfo | null;
   ...
   */
  replaceType(old: Type, new_: Type): TimeInfo;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TimeInfo;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TimeInfo;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TimeInfo | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TimeInfo | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TimeInfo;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TimeInfo;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TimeInfo;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TimeInfo;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TimeInfo;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TimeInfo;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TimeInfo;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TimeInfo;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TimeInfo;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TimeInfo;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TimeInfo;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TimeInfo;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TimeInfo;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TimeInfo;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TimeInfo;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TimeInfo;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TimeInfo;
   ...
   * @see #removeField
   */
  unsetField(field: string): TimeInfo;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TimeInfo;
   ...
   * @see #unsetField
   */
  removeField(field: string): TimeInfo;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TimeInfo;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TimeInfo;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TimeInfo;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TimeInfo;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TimeInfo;

  mergeJson(json: any | null): TimeInfo;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TimeInfo;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TimeInfo;
   ...
   */
  singletonArray(): C3.Array<TimeInfo | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TimeInfo | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TimeInfo | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TimeInfo | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TimeInfo | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TimeInfo | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TimeInfo | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TimeInfo | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TimeInfo | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TimeInfo;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TimeInfo;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TimeInfo;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TimeInfo;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TimeInfo;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TimeInfo;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TimeInfo;
   ...
   */
  static cachedEmptyInst(): TimeInfo;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TimeInfo>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TimeInfo;
   ...
   */
  static last12Months(): TimeInfo | null;
   ...
   */
  static prevLast12Months(): TimeInfo | null;
   ...
   */
  static combineAndSort(timeRanges: C3.Array<TimeRange | null> | null): C3.Array<TimeInfo | null>;

  /**
   * Merge various time ranges into a larger range
   * E.g. ["2014-01-01" -> "2014-02-01"], ["2015-01-01" -> "2016-01-01"] => {"2014-01-01" -> "2016-01-01"}
   */
  static coalesce(timeRanges: C3.Array<TimeRange | null> | null): TimeInfo | null;
   ...
   */
  overlap(othr: TimeRange | null): TimeInfo | null;
   ...
   */
  static fromPrettyPrint(prettyPrint: string): TimeInfo;

  /**
   * Construct array of TimeRange from map<datetime, datetime>
   */
  static fromMap(map: C3.Map<DateTime | null, DateTime | null>): C3.Array<TimeInfo | null>;
   ...
   */
  shift(offset: Duration): TimeInfo;
