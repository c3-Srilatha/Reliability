// TypeScript definitions for the C3 type MethodType
 ...
 * @see methods.c3doc
 *
 * @remarks this represents a value passed to a method that expects an instance of MethodType
 */
declare interface IMethodType {
   ...
   */
  genericVars?: C3.Array<VarReferenceType | null> | Array<IVarReferenceType | null>;

  /**
   * The formal parameters accepted by this function.
   */
  params?: C3.Array<FunctionParam | null> | Array<IFunctionParam | null>;

  /**
   * The return type of the function.
   */
  returnType?: IValueType | null;
   ...
   * ```
   */
  actionRequirementNames?: C3.Array<string | null> | Array<string | null>;
}
 ...
 * @see methods.c3doc
 *
 * @remarks this represents a made instance of MethodType
 */
declare class MethodType extends Obj {

  /**
   * Source file Pkg.Path a C3 Type declaration [.c3typ].
   */
  readonly declaredPkgPath?: string | null;
  withDeclaredPkgPath(declaredPkgPath: string | null): MethodType;

  /**
   * Source line number in a C3 Type declaration [.c3typ] file starting with 1 where this metadata element is declared.
   */
  readonly declaredSrcLine?: number | null;
  withDeclaredSrcLine(declaredSrcLine: number | null): MethodType;
  ...
  withDeclaredSrcCharInLine(declaredSrcCharInLine: number | null): MethodType;
   ...
   */
  readonly pkg: Pkg;
  withPkg(pkg: IPkg): MethodType;

  /**
   * SDK json representing instance of this type
   */
  readonly json?: any;
  withJson(json: any): MethodType;

  /**
   * The set of annotations defined on this element of metadata represented as json value.
   */
  readonly annotationsJson?: any | null;
  withAnnotationsJson(annotationsJson: any | null): MethodType;
  ...
  withDoc(doc: string | null): MethodType;

  readonly docSingleLine?: boolean;
  withDocSingleLine(docSingleLine: boolean): MethodType;

  /**
   * Method types are bound to a type (as a method) and so always have a name.
   */
  readonly name: string;
  withName(name: string): MethodType;
  ...
  withModifier(modifier: string | null): MethodType;
  ...
  withVarBindings(varBindings: C3.Map<string | null, ValueType | null> | {[key: string | null]: IValueType | null}): MethodType;

  /**
   * The list of variable declarations and any restrictions on them.
   */
  readonly genericVars?: C3.Array<VarReferenceType | null>;
  withGenericVars(genericVars: C3.Array<VarReferenceType | null> | Array<IVarReferenceType | null>): MethodType;

  /**
   * The formal parameters accepted by this function.
   */
  readonly params?: C3.Array<FunctionParam | null>;
  withParams(params: C3.Array<FunctionParam | null> | Array<IFunctionParam | null>): MethodType;

  /**
   * The return type of the function.
   */
  readonly returnType?: ValueType | null;
  withReturnType(returnType: IValueType | null): MethodType;
  ...
  withStateful(stateful: boolean): MethodType;
  ...
  withPrivate(private_: boolean): MethodType;
  ...
  withCached(cached: boolean): MethodType;
  ...
  withAbstract(abstract: boolean): MethodType;
  ...
  withOptional(optional: boolean): MethodType;
  ...
  withFinal(final: boolean): MethodType;
  ...
  withInline(inline: boolean): MethodType;
  ...
  withMember(member: boolean): MethodType;
  ...
  withProperty(property: boolean): MethodType;
  ...
  withInheritFrom(inheritFrom: string | null): MethodType;
   ...
   * ```
   */
  readonly actionRequirementNames?: C3.Array<string | null>;
  withActionRequirementNames(actionRequirementNames: C3.Array<string | null> | Array<string | null>): MethodType;
   ...
   */
  replaceType(old: Type, new_: Type): MethodType;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): MethodType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): MethodType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): MethodType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): MethodType | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MethodType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MethodType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MethodType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MethodType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): MethodType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MethodType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MethodType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): MethodType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): MethodType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): MethodType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): MethodType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): MethodType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): MethodType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): MethodType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): MethodType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): MethodType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): MethodType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): MethodType;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): MethodType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): MethodType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): MethodType;
   ...
   * @see #removeField
   */
  unsetField(field: string): MethodType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): MethodType;
   ...
   * @see #unsetField
   */
  removeField(field: string): MethodType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): MethodType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): MethodType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): MethodType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): MethodType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): MethodType;

  mergeJson(json: any | null): MethodType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): MethodType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): MethodType;
   ...
   */
  singletonArray(): C3.Array<MethodType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<MethodType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<MethodType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<MethodType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<MethodType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, MethodType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, MethodType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<MethodType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<MethodType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): MethodType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): MethodType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): MethodType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): MethodType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): MethodType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): MethodType;
   ...
   * @see #fromString
   */
  static make(s: string | null): MethodType | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): MethodType;
   ...
   */
  static cachedEmptyInst(): MethodType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<MethodType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): MethodType;
   ...
   */
  withoutDeclaredSrcPos(recursive?: boolean): MethodType;
   ...
   */
  withAnnotation(ann: Annotation): MethodType;
   ...
   *         value for the field
   */
  withAnnotation(ann: string, annField?: string | null, value?: any): MethodType;
   ...
   */
  docParsed(spec?: DocumentationParserSpec | null): MethodTypeDocumentation;
   ...
   * @see #toString
   */
  static fromString(s: string | null): MethodType | null;
   ...
   */
  paramNames(): C3.Array<string | null>;
   ...
   */
  param(param: string, failIfMissing?: boolean): FunctionParam | null;
   ...
   */
  paramAt(paramIndex: number, failIfMissing?: boolean): FunctionParam | null;
   ...
   */
  paramIndex(param: string, failIfMissing?: boolean): number;
   ...
   * @return 0-based index of parameter
   */
  paramIndex(param: FunctionParam, failIfMissing?: boolean): number;
   ...
   */
  paramType(param: string, failIfMissing?: boolean): ValueType | null;
   ...
   * @return parameter value type
   */
  paramTypeAt(paramIndex: number, failIfMissing?: boolean): ValueType | null;

  /**
   * @return list of parameter value types in the declaration order
   */
  paramTypes(): C3.Array<ValueType | null>;
   ...
   */
  convertArg(param: string, v?: any, failIfInvalid?: boolean, withoutDefault?: boolean): T | null;

  /**
   * @param withoutDefault whether to apply default for parameter {@link FunctionParam#convertAndValidateArg}
   * @return converted value based on parameter type
   */
  convertArgAt(paramIndex: number, v?: any, failIfInvalid?: boolean, withoutDefault?: boolean): T | null;

  /**
   * @return converted values based on parameter types; note if value is not convertible replaces it to `null`
   */
  convertArgs(args?: C3.Array<any>, kwargs?: C3.Map<string | null, any>, failIfInvalid?: boolean): C3.Array<any>;

  /**
   * @return default value of the parameter
   */
  paramDefaultValue(paramName: string): any;

  /**
   * @return default value of the parameter
   */
  paramDefaultValue(paramIndex: number): any;
   ...
   */
  paramHasDefault(param: string): boolean;
   ...
   */
  paramIsNonEmpty(param: string): boolean;
   ...
   * @param name name of the argument
   */
  paramIsOptional(param: string): boolean;
   ...
   */
  nonEmptyParams(): C3.Array<FunctionParam | null>;
   ...
   */
  nonEmptyParamNames(): C3.Array<string | null>;
   ...
   */
  argTypesDistance(argTypes: C3.Array<ValueType | null> | null): number;
   ...
   * @see ValueType#valueDistance
   */
  argTypesDistance(argTypes: C3.Map<string | null, ValueType | null> | null): number;
   ...
   * @see ValueType#valueDistance
   */
  argsDistance(args: C3.Array<any> | null): number;
   ...
   * @see ValueType#valueDistance
   */
  argsDistance(args: C3.Map<string | null, any> | null): number;
   ...
   * @see ValueType#valueDistance
   */
  argsDistance(args: C3.Array<any> | null, kwargs: C3.Map<string | null, any> | null): number;
   ...
   */
  argsMapToArray(args: C3.Map<string | null, any> | null, failOnExtra?: boolean): C3.Array<any> | null;
   ...
   * array size always matches parameter count.
   */
  argTypesMapToArray(args: C3.Map<string | null, ValueType | null> | null): C3.Array<ValueType | null> | null;
   ...
   */
  mergeArgs(args: C3.Array<any> | null, kwargs: C3.Map<string | null, any> | null, failOnExtra?: boolean): C3.Array<any> | null;

  /**
   * Checks if this function shadows i.e. has same parameters not considering all optional ones as provided function.
   */
  shadows(other: FunctionType | null): boolean;

  /**
   * Merge other function type into this one by merging params and return type.
   */
  mergeFunctionType(other: FunctionType | null): FunctionType;
   ...
   */
  static extractSignature(value: any, failIfNot?: boolean): FunctionType | null;
   ...
   */
  isSameParamTypes(other: FunctionType | null): boolean;
   ...
   */
  paramJavaJTypes(spec?: any): C3.Array<any>;
   ...
   */
  static fromRef(ref: Obj, failIfMissing?: boolean): MethodType;
   ...
   */
  get actionRequirements(): C3.Array<Action.Requirement | null>;

  /**
   * The set of all action engines for this MethodType
   */
  get engines(): C3.Array<Action.Engine | null>;
   ...
   */
  mixins(): C3.Array<MethodType | null>;
   ...
   * @see #isImplementedOn
   */
  isImplementedIn(language: string): boolean;
   ...
   * @see #isImplementedIn
   */
  isImplementedOn(type: Type, actionEngine: string | null): boolean;
   ...
   */
  convertPositionalAndKeywordArgs(pargs?: C3.Array<any>, kwargs?: C3.Map<string | null, any>, failIfInvalid?: boolean): C3.Array<any>;
   ...
   */
  isReClaimedIn(actionEngine?: string | null): boolean;
   ...
   * @see implementedOn()
   */
  implementedOn(actionEngine: string): Type | null;

  implementedOnMeta(): TypeMeta | null;

  implementedOnMeta(actionEngine: string): TypeMeta | null;

  /**
   * Get the type on which this method overload is first declared.
   */
  firstDeclaredOn(): Type;

  firstDeclaredOnMeta(): TypeMeta;

  /**
   * Original declaration of this method overload from first declaring type.
   */
  firstDeclaredMethodType(): MethodType;

  /**
   * This method type but with parameters from original declaration.
   */
  withFirstDeclaredParams(): MethodType;
  ...
  parentTypeMeta(): TypeMeta;

  /**
   * @return possible value of the parameter
   */
  paramPossibleValues(paramName: string): C3.Array<any>;

  /**
   * @return possible value of the parameter
   */
  paramPossibleValues(paramIndex: number): C3.Array<any>;

  /**
   * @return implicit `this` parameter for member methods.
   */
  get thisParam(): FunctionParam | null;

  /**
   * @return cached Java thunk for calling corresponding C3 MethodType.
   */
  callThunk(appId: string | null): any;
   ...
   */
  superCallThunk(callingType: Type, mixin?: Type | null): any;
   ...
   */
  dbDomainCallAppInLocalJvm(): boolean;
   ...
   * @see Ann.Db#domain
   */
  targetAppIdFunc(): λFunction<C3.Map<string | null, any>, string> | null;
   ...
   */
  targetNodeRolesFunc(): λFunction<C3.Map<string | null, any>, C3.Array<string | null>> | null;
   ...
   */
  targetNodePoolsFunc(): λFunction<C3.Map<string | null, any>, C3.Array<string | null>> | null;
   ...
   * @see Ann.Call#node
   */
  targetNodeFunc(): λFunction<C3.Map<string | null, any>, string> | null;
   ...
   */
  targetThreadPoolFunc(): λFunction<C3.Map<string | null, any>, string> | null;
