// TypeScript definitions for the C3 type FileSystemBatchJob

/**
 * Batch job to process file system actions on each file in a distributed mode
 *
 * @remarks this represents a value passed to a method that expects an instance of FileSystemBatchJob
 */
declare interface IFileSystemBatchJob {
   ...
   */
  spec?: IBatchFileOperationSpec | null;
   ...
   */
  action: ILambda<λConsumer<File | null | C3.Array<File | null> | null> | null>;
}
 ...
 */
declare class FileSystemBatchJob extends Obj {

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun | null;
  withRun(run: IBatchJobRun | null): FileSystemBatchJob;

  /**
   * previous job executions for this instance
   */
  readonly runs?: C3.Array<BatchJobRun | null>;
  withRuns(runs: C3.Array<BatchJobRun | null> | Array<IBatchJobRun | null>): FileSystemBatchJob;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj | null;
  withOptions(options: IObj | null): FileSystemBatchJob;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): FileSystemBatchJob;
  ...
  withPriority(priority: number | null): FileSystemBatchJob;
  ...
  withDisabled(disabled: boolean): FileSystemBatchJob;
  ...
  withMaxConcurrency(maxConcurrency: number | null): FileSystemBatchJob;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): FileSystemBatchJob;
  ...
  withRunAsUser(runAsUser: boolean | null): FileSystemBatchJob;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string | null;
  withNodePool(nodePool: string | null): FileSystemBatchJob;
  ...
  withSkipIfRunning(skipIfRunning: boolean | null): FileSystemBatchJob;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number | null;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): FileSystemBatchJob;
  ...
  withPropagateActionContext(propagateActionContext: boolean): FileSystemBatchJob;
  ...
  withTypeIdent(typeIdent: string | null): FileSystemBatchJob;
   ...
   */
  readonly id: string;
  withId(id: string): FileSystemBatchJob;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): FileSystemBatchJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): FileSystemBatchJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): FileSystemBatchJob;
  ...
  withVersion(version: number | null): FileSystemBatchJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): FileSystemBatchJob;
  ...
  withAbortOnError(abortOnError: boolean): FileSystemBatchJob;

  /**
   * Url from which files need to be read
   */
  readonly url: string;
  withUrl(url: string): FileSystemBatchJob;

  /**
   * Spec for batch file operation
   */
  readonly spec?: BatchFileOperationSpec | null;
  withSpec(spec: IBatchFileOperationSpec | null): FileSystemBatchJob;

  /**
   * Specify if lambda action is batchAction or not
   */
  readonly isBatchAction?: boolean;
  withIsBatchAction(isBatchAction: boolean): FileSystemBatchJob;

  /**
   * User action to be called for each file
   */
  readonly action: Lambda<λConsumer<File | null | C3.Array<File | null> | null> | null>;
  withAction(action: ILambda<λConsumer<File | null | C3.Array<File | null> | null> | null>): FileSystemBatchJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): FileSystemBatchJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): FileSystemBatchJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): FileSystemBatchJob | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): FileSystemBatchJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): FileSystemBatchJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FileSystemBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FileSystemBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FileSystemBatchJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FileSystemBatchJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): FileSystemBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FileSystemBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FileSystemBatchJob;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FileSystemBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FileSystemBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FileSystemBatchJob;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): FileSystemBatchJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FileSystemBatchJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FileSystemBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): FileSystemBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): FileSystemBatchJob;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): FileSystemBatchJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): FileSystemBatchJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FileSystemBatchJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): FileSystemBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FileSystemBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FileSystemBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): FileSystemBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FileSystemBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): FileSystemBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FileSystemBatchJob;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): FileSystemBatchJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): FileSystemBatchJob;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): FileSystemBatchJob;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): FileSystemBatchJob;

  mergeJson(json: any | null): FileSystemBatchJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): FileSystemBatchJob;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): FileSystemBatchJob;
   ...
   */
  singletonArray(): C3.Array<FileSystemBatchJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<FileSystemBatchJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FileSystemBatchJob | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<FileSystemBatchJob | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FileSystemBatchJob | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, FileSystemBatchJob | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FileSystemBatchJob | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FileSystemBatchJob | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FileSystemBatchJob | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): FileSystemBatchJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): FileSystemBatchJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): FileSystemBatchJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FileSystemBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): FileSystemBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FileSystemBatchJob;
   ...
   * @see #fromString
   */
  static make(s: string | null): FileSystemBatchJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): FileSystemBatchJob;
   ...
   */
  static cachedEmptyInst(): FileSystemBatchJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<FileSystemBatchJob>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): FileSystemBatchJob;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<FileSystemBatchJob | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<FileSystemBatchJob | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<FileSystemBatchJob | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<FileSystemBatchJob | null> | null>;
   ...
   */
  get(include?: string | null): FileSystemBatchJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): FileSystemBatchJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): FileSystemBatchJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): FileSystemBatchJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): FileSystemBatchJob;
   ...
   * @see #toString
   */
  static fromString(s: string | null): FileSystemBatchJob | null;
   ...
   */
  create(spec?: UpsertSpec | null): FileSystemBatchJob | null;
   ...
   */
  static createBatch(objs: C3.Array<FileSystemBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<FileSystemBatchJob | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<FileSystemBatchJob | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<FileSystemBatchJob | null> | null;
   ...
   */
  update(srcObj?: FileSystemBatchJob | null, spec?: UpsertSpec | null): FileSystemBatchJob | null;
   ...
   */
  upsert(srcObj?: FileSystemBatchJob | null, spec?: UpsertSpec | null): FileSystemBatchJob | null;
   ...
   */
  merge(spec?: MergeSpec | null): FileSystemBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): FileSystemBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): FileSystemBatchJob | null;
   ...
   */
  static updateBatch(objs: C3.Array<FileSystemBatchJob | null> | null, srcObjs?: C3.Array<FileSystemBatchJob | null>, spec?: UpsertSpec | null): ObjList<FileSystemBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<FileSystemBatchJob | null>>, spec?: UpsertSpec | null): ObjList<FileSystemBatchJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<FileSystemBatchJob | null> | null, srcObjs?: C3.Array<FileSystemBatchJob | null>, spec?: UpsertSpec | null): ObjList<FileSystemBatchJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<FileSystemBatchJob | null>>, spec?: UpsertSpec | null): ObjList<FileSystemBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<FileSystemBatchJob | null> | null, spec?: TouchSpec | null): ObjList<FileSystemBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<FileSystemBatchJob | null> | null, spec?: MergeSpec | null): ObjList<FileSystemBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<FileSystemBatchJob | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<FileSystemBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<FileSystemBatchJob | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<FileSystemBatchJob | null> | null;
   ...
   */
  static mergeAll(mergeObj: FileSystemBatchJob | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: FileSystemBatchJob | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<FileSystemBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<FileSystemBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<FileSystemBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<FileSystemBatchJob | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): FileSystemBatchJob | null;
   ...
   */
  static beforeCreate(objs: C3.Array<FileSystemBatchJob | null> | null): ObjList<FileSystemBatchJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<FileSystemBatchJob | null> | null): ObjList<FileSystemBatchJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<FileSystemBatchJob | null> | null): ObjList<FileSystemBatchJob | null>;
   ...
   */
  static afterCreate(objs: C3.Array<FileSystemBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<FileSystemBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<FileSystemBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<FileSystemBatchJob | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<FileSystemBatchJob | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): FileSystemBatchJob | null;
   ...
   */
  withoutIdentity(): FileSystemBatchJob | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<FileSystemBatchJob | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: FileSystemBatchJob | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<FileSystemBatchJob | null> | null, callback?: λFunction<FileSystemBatchJob | null, FileSystemBatchJob | null> | null): ObjList<FileSystemBatchJob | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<FileSystemBatchJob | null> | null, callback?: λFunction<FileSystemBatchJob | null, FileSystemBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static doStart(job?: FileSystemBatchJob | null, options?: string | null): void;
   ...
   */
  static processBatch(batch?: FileSystemBatchJobBatch | null, job?: FileSystemBatchJob | null, options?: string | null): void;
   ...
   */
  static allComplete(job: FileSystemBatchJob, options?: string | null): string | null;
   ...
   *           Options the job was run with.
   */
  static failed(job: FileSystemBatchJob, status: BatchJobStatus, options?: string | null): void;
   ...
   */
  static scheduleObjBatch(job?: FileSystemBatchJob | null, objBatch?: ObjBatch | null, logPrefix?: string | null): number | null;
