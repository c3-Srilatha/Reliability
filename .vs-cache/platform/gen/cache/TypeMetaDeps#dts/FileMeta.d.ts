// TypeScript definitions for the C3 type FileMeta
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of FileMeta
 */
 ...
 * of the file itself; #pathMeta method can be used to list all FileMeta instances
 *
 * @remarks this represents a made instance of FileMeta
 */
declare class FileMeta extends Obj {
  ...
  withContentEncoding(contentEncoding: string | null): FileMeta;
  ...
  withContentLanguage(contentLanguage: string | null): FileMeta;
  ...
  withContentLength(contentLength: number | null): FileMeta;
  ...
  withContentLocation(contentLocation: string | null): FileMeta;
  ...
  withContentType(contentType: string | null): FileMeta;
  ...
  withContentDisposition(contentDisposition: string | null): FileMeta;
  ...
  withETag(eTag: string | null): FileMeta;
  ...
  withLastModified(lastModified: DateTime | Date | string | null): FileMeta;

  /**
   * Id of user / identity who last last modified this content.
   */
  readonly lastModifiedBy?: string | null;
  withLastModifiedBy(lastModifiedBy: string | null): FileMeta;
  ...
  withContentMD5(contentMD5: string | null): FileMeta;
  ...
  withContentSHA1(contentSHA1: string | null): FileMeta;

  /**
   * List of {@link AclEntry} entries governing who can read/update/remove Objs.
   */
  readonly acl?: C3.Array<AclEntry | null>;
  withAcl(acl: C3.Array<AclEntry | null> | Array<IAclEntry | null>): FileMeta;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): FileMeta;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): FileMeta;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): FileMeta;
  ...
  withVersion(version: number | null): FileMeta;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): FileMeta;

  /**
   * URL for this file or folder.
   */
  readonly url: string;
  withUrl(url: string): FileMeta;

  /**
   * `true` if file is deleted in the file system.
   */
  readonly deleted?: boolean;
  withDeleted(deleted: boolean): FileMeta;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): FileMeta | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): FileMeta | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): FileMeta | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): FileMeta | null;
   ...
   */
  replaceType(old: Type, new_: Type): FileMeta;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FileMeta;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FileMeta;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FileMeta | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FileMeta | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): FileMeta;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FileMeta;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FileMeta;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FileMeta;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FileMeta;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FileMeta;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): FileMeta;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FileMeta;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FileMeta;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): FileMeta;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): FileMeta;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): FileMeta;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): FileMeta;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FileMeta;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): FileMeta;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FileMeta;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FileMeta;
   ...
   * @see #removeField
   */
  unsetField(field: string): FileMeta;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FileMeta;
   ...
   * @see #unsetField
   */
  removeField(field: string): FileMeta;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FileMeta;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): FileMeta;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): FileMeta;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): FileMeta;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): FileMeta;

  mergeJson(json: any | null): FileMeta;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): FileMeta;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): FileMeta;
   ...
   */
  singletonArray(): C3.Array<FileMeta | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<FileMeta | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FileMeta | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<FileMeta | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FileMeta | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, FileMeta | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FileMeta | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FileMeta | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FileMeta | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): FileMeta;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): FileMeta;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): FileMeta;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FileMeta;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): FileMeta;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FileMeta;
   ...
   * @see #fromString
   */
  static make(s: string | null): FileMeta | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): FileMeta;
   ...
   */
  static cachedEmptyInst(): FileMeta;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<FileMeta>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): FileMeta;
   ...
   */
  withFileName(fileName: string | null): FileMeta;

  /**
   * Changes file extension in this instance.
   */
  withFileExt(fileExt: string | null): FileMeta;
   ...
   */
  identify(suffix?: string | null): FileMeta;
   ...
   */
  static populateAcl(objs?: C3.Array<FileMeta | null>): number | null;
   ...
   */
  grantMemberReadUpdateRemove(member: AccessControlEntity): FileMeta;
   ...
   */
  mergeAclEntry(entry: AclEntry): FileMeta;
   ...
   * @return the obj with the new acl after merging the indicated entry.
   */
  mergeAclEntries(entries: C3.Array<AclEntry | null> | null): FileMeta;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<FileMeta | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<FileMeta | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<FileMeta | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<FileMeta | null> | null>;
   ...
   */
  get(include?: string | null): FileMeta | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): FileMeta | null;
   ...
   */
  getMissing(spec: GetMissingSpec): FileMeta;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): FileMeta | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): FileMeta;
   ...
   * @see #toString
   */
  static fromString(s: string | null): FileMeta | null;
   ...
   */
  create(spec?: UpsertSpec | null): FileMeta | null;
   ...
   */
  static createBatch(objs: C3.Array<FileMeta | null> | null, spec?: UpsertSpec | null): ObjList<FileMeta | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<FileMeta | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<FileMeta | null> | null;
   ...
   */
  update(srcObj?: FileMeta | null, spec?: UpsertSpec | null): FileMeta | null;
   ...
   */
  upsert(srcObj?: FileMeta | null, spec?: UpsertSpec | null): FileMeta | null;
   ...
   */
  merge(spec?: MergeSpec | null): FileMeta | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): FileMeta | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): FileMeta | null;
   ...
   */
  static updateBatch(objs: C3.Array<FileMeta | null> | null, srcObjs?: C3.Array<FileMeta | null>, spec?: UpsertSpec | null): ObjList<FileMeta | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<FileMeta | null>>, spec?: UpsertSpec | null): ObjList<FileMeta | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<FileMeta | null> | null, srcObjs?: C3.Array<FileMeta | null>, spec?: UpsertSpec | null): ObjList<FileMeta | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<FileMeta | null>>, spec?: UpsertSpec | null): ObjList<FileMeta | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<FileMeta | null> | null, spec?: TouchSpec | null): ObjList<FileMeta | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<FileMeta | null> | null, spec?: MergeSpec | null): ObjList<FileMeta | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<FileMeta | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<FileMeta | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<FileMeta | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<FileMeta | null> | null;
   ...
   */
  static mergeAll(mergeObj: FileMeta | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: FileMeta | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<FileMeta | null> | null, spec?: UpsertSpec | null): ObjList<FileMeta | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<FileMeta | null> | null, spec?: UpsertSpec | null): ObjList<FileMeta | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<FileMeta | null> | null): ObjList<FileMeta | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<FileMeta | null> | null): ObjList<FileMeta | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<FileMeta | null> | null): ObjList<FileMeta | null>;
   ...
   */
  static afterCreate(objs: C3.Array<FileMeta | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<FileMeta | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<FileMeta | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<FileMeta | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<FileMeta | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): FileMeta | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<FileMeta | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: FileMeta | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<FileMeta | null> | null, callback?: λFunction<FileMeta | null, FileMeta | null> | null): ObjList<FileMeta | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<FileMeta | null> | null, callback?: λFunction<FileMeta | null, FileMeta | null> | null): C3.Array<ObjError | null>;
   ...
   */
  pathMeta(): C3.Array<FileMeta | null>;
   ...
   */
  myUserCanUpsert(getIfAclIsMissing?: boolean): boolean;
   ...
   */
  static sync(urlOrEncodedPath: string, dirsOnly?: boolean): number;
   ...
   */
  static forFile(file: File, failIfMissingOrNotAuthorized?: boolean): FileMeta | null;
   ...
   */
  static forUrlOrEncodedPath(urlOrEncodedPath: string | null, failIfMissingOrNotAuthorized?: boolean): FileMeta | null;

  /**
   * FileMeta constructor.
   */
  static fromFile(file: File): FileMeta;

  /**
   * FileMeta constructor.
   */
  static fromUrl(url: string | null): FileMeta;

  /**
   * FileMeta constructor.
   */
  static fromUrlOrEncodedPath(urlOrEncodedPath: string | null): FileMeta;

  static generateIdFromUrlOrEncodedPath(urlOrEncodedPath: string): string;
