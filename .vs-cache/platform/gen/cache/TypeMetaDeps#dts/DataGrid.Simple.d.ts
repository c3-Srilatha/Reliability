// TypeScript definitions for the C3 type DataGrid.Simple
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of DataGrid.Simple
 */
declare namespace DataGrid {
  export interface ISimple {
    ...
    _rows?: C3.Array<DataGrid.Row> | Array<IDataGrid.Row>;
  }
}
...
declare namespace DataGrid {
  export class Simple extends Obj {
     ...
     */
    readonly source?: any;
    withSource(source: any): DataGrid.Simple;
    ...
    withLabel(label: string | null): DataGrid.Simple;

    /**
     * A more detailed description of the source of the data. Typically the full value type of the data.
     */
    readonly description?: string | null;
    withDescription(description: string | null): DataGrid.Simple;
    ...
    withCols(cols: C3.Array<DataGrid.Col> | Array<IDataGrid.Col>): DataGrid.Simple;

    readonly _rows?: C3.Array<DataGrid.Row>;
    with_rows(_rows: C3.Array<DataGrid.Row> | Array<IDataGrid.Row>): DataGrid.Simple;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): DataGrid.Simple | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): DataGrid.Simple | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): DataGrid.Simple | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): DataGrid.Simple | null;
     ...
     */
    replaceType(old: Type, new_: Type): DataGrid.Simple;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataGrid.Simple;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataGrid.Simple;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataGrid.Simple | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataGrid.Simple | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataGrid.Simple;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataGrid.Simple;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataGrid.Simple;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): DataGrid.Simple;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): DataGrid.Simple;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): DataGrid.Simple;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataGrid.Simple;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataGrid.Simple;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): DataGrid.Simple;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): DataGrid.Simple;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): DataGrid.Simple;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): DataGrid.Simple;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataGrid.Simple;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): DataGrid.Simple;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataGrid.Simple;
     ...
     * @see #unsetField
     */
    defaultField(field: string): DataGrid.Simple;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): DataGrid.Simple;
     ...
     * @see #removeField
     */
    unsetField(field: string): DataGrid.Simple;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): DataGrid.Simple;
     ...
     * @see #unsetField
     */
    removeField(field: string): DataGrid.Simple;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): DataGrid.Simple;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataGrid.Simple;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): DataGrid.Simple;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataGrid.Simple;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataGrid.Simple;

    mergeJson(json: any | null): DataGrid.Simple;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataGrid.Simple;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): DataGrid.Simple;
     ...
     */
    singletonArray(): C3.Array<DataGrid.Simple | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<DataGrid.Simple | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<DataGrid.Simple | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<DataGrid.Simple | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<DataGrid.Simple | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, DataGrid.Simple | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataGrid.Simple | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<DataGrid.Simple | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<DataGrid.Simple | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DataGrid.Simple;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DataGrid.Simple;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DataGrid.Simple;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): DataGrid.Simple;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DataGrid.Simple;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): DataGrid.Simple;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DataGrid.Simple;
     ...
     */
    static cachedEmptyInst(): DataGrid.Simple;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DataGrid.Simple>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): DataGrid.Simple;
     ...
     */
    static fromColsRows(cols: C3.Array<DataGrid.Col>, rows?: C3.Array<DataGrid.Row>): DataGrid.Simple;
     ...
     */
    static fromRows(rows?: C3.Array<DataGrid.Row>): DataGrid.Simple;
  }
}
