// TypeScript definitions for the C3 type ThinTypeSystemBase

/**
 * Base type for the C3 remote thin type system. These is extend by synchronous and asynchronous versions.
 *
 * The "thin" type system is distinguished from the {@link TypeSystemBase full type system} by the fact that
 * values are plain language objects and declared methods must be called by name (using `call`).
 *
 * @remarks this represents a value passed to a method that expects an instance of ThinTypeSystemBase
 */
declare interface IThinTypeSystemBase {
}
 ...
 * values are plain language objects and declared methods must be called by name (using `call`).
 *
 * @remarks this represents a made instance of ThinTypeSystemBase
 */
declare class ThinTypeSystemBase {

  /**
   * Get a type proxy by name.
   */
