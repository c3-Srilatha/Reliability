// TypeScript definitions for the C3 type MetricsStats

/**
 * Type for holding metrics statistics
 *
 * @remarks this represents a value passed to a method that expects an instance of MetricsStats
 */
declare interface IMetricsStats {

  /**
   * srcId_pathId(srcTypeName)_pathId(interval)_pathId(metricName)
   */
  id?: string | null;
  ...
  /**
   * Timeseries stats for this source / metric combination
   */
  stats?: ITimeseriesStats | null;

  /**
   * hash of all the fields in this type. This can be used to compare metric results when data changes
   */
  valueHash?: number | null;

  /**
   * src id for which the statistic is computed
   */
  srcId?: string | null;

  /**
   * metric id for which the statistic is computed. It is the pathId for the metric that gets stored here.
   */
 ...
 * Type for holding metrics statistics
 *
 * @remarks this represents a made instance of MetricsStats
 */
declare class MetricsStats extends Obj {

  /**
   * srcId_pathId(srcTypeName)_pathId(interval)_pathId(metricName)
   */
  readonly id?: string | null;
  withId(id: string | null): MetricsStats;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): MetricsStats;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): MetricsStats;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): MetricsStats;
  ...
  withVersion(version: number | null): MetricsStats;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): MetricsStats;

  /**
   * Timeseries stats for this source / metric combination
   */
  readonly stats?: TimeseriesStats | null;
  withStats(stats: ITimeseriesStats | null): MetricsStats;

  /**
   * hash of all the fields in this type. This can be used to compare metric results when data changes
   */
  readonly valueHash?: number | null;
  withValueHash(valueHash: number | null): MetricsStats;

  /**
   * src id for which the statistic is computed
   */
  readonly srcId?: string | null;
  withSrcId(srcId: string | null): MetricsStats;

  /**
   * metric id for which the statistic is computed. It is the pathId for the metric that gets stored here.
   */
  readonly metricId?: number | null;
  withMetricId(metricId: number | null): MetricsStats;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): MetricsStats | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): MetricsStats | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): MetricsStats | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): MetricsStats | null;
   ...
   */
  replaceType(old: Type, new_: Type): MetricsStats;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MetricsStats;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MetricsStats;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MetricsStats | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MetricsStats | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): MetricsStats;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MetricsStats;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MetricsStats;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): MetricsStats;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): MetricsStats;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): MetricsStats;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): MetricsStats;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): MetricsStats;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): MetricsStats;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): MetricsStats;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): MetricsStats;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): MetricsStats;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): MetricsStats;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): MetricsStats;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): MetricsStats;
   ...
   * @see #unsetField
   */
  defaultField(field: string): MetricsStats;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): MetricsStats;
   ...
   * @see #removeField
   */
  unsetField(field: string): MetricsStats;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): MetricsStats;
   ...
   * @see #unsetField
   */
  removeField(field: string): MetricsStats;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): MetricsStats;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): MetricsStats;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): MetricsStats;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): MetricsStats;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): MetricsStats;

  mergeJson(json: any | null): MetricsStats;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): MetricsStats;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): MetricsStats;
   ...
   */
  singletonArray(): C3.Array<MetricsStats | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<MetricsStats | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<MetricsStats | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<MetricsStats | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<MetricsStats | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, MetricsStats | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, MetricsStats | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<MetricsStats | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<MetricsStats | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): MetricsStats;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): MetricsStats;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): MetricsStats;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): MetricsStats;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): MetricsStats;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): MetricsStats;
   ...
   * @see #fromString
   */
  static make(s: string | null): MetricsStats | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): MetricsStats;
   ...
   */
  static cachedEmptyInst(): MetricsStats;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<MetricsStats>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): MetricsStats;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<MetricsStats | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<MetricsStats | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<MetricsStats | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<MetricsStats | null> | null>;
   ...
   */
  get(include?: string | null): MetricsStats | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): MetricsStats | null;
   ...
   */
  getMissing(spec: GetMissingSpec): MetricsStats;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): MetricsStats | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): MetricsStats;
   ...
   * @see #toString
   */
  static fromString(s: string | null): MetricsStats | null;
   ...
   */
  create(spec?: UpsertSpec | null): MetricsStats | null;
   ...
   */
  static createBatch(objs: C3.Array<MetricsStats | null> | null, spec?: UpsertSpec | null): ObjList<MetricsStats | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<MetricsStats | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<MetricsStats | null> | null;
   ...
   */
  update(srcObj?: MetricsStats | null, spec?: UpsertSpec | null): MetricsStats | null;
   ...
   */
  upsert(srcObj?: MetricsStats | null, spec?: UpsertSpec | null): MetricsStats | null;
   ...
   */
  merge(spec?: MergeSpec | null): MetricsStats | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): MetricsStats | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): MetricsStats | null;
   ...
   */
  static updateBatch(objs: C3.Array<MetricsStats | null> | null, srcObjs?: C3.Array<MetricsStats | null>, spec?: UpsertSpec | null): ObjList<MetricsStats | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<MetricsStats | null>>, spec?: UpsertSpec | null): ObjList<MetricsStats | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<MetricsStats | null> | null, srcObjs?: C3.Array<MetricsStats | null>, spec?: UpsertSpec | null): ObjList<MetricsStats | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<MetricsStats | null>>, spec?: UpsertSpec | null): ObjList<MetricsStats | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<MetricsStats | null> | null, spec?: TouchSpec | null): ObjList<MetricsStats | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<MetricsStats | null> | null, spec?: MergeSpec | null): ObjList<MetricsStats | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<MetricsStats | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<MetricsStats | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<MetricsStats | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<MetricsStats | null> | null;
   ...
   */
  static mergeAll(mergeObj: MetricsStats | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: MetricsStats | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<MetricsStats | null> | null, spec?: UpsertSpec | null): ObjList<MetricsStats | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<MetricsStats | null> | null, spec?: UpsertSpec | null): ObjList<MetricsStats | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<MetricsStats | null> | null): ObjList<MetricsStats | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<MetricsStats | null> | null): ObjList<MetricsStats | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<MetricsStats | null> | null): ObjList<MetricsStats | null>;
   ...
   */
  static afterCreate(objs: C3.Array<MetricsStats | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<MetricsStats | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<MetricsStats | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<MetricsStats | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<MetricsStats | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): MetricsStats | null;
   ...
   */
  withoutIdentity(): MetricsStats | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<MetricsStats | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: MetricsStats | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<MetricsStats | null> | null, callback?: λFunction<MetricsStats | null, MetricsStats | null> | null): ObjList<MetricsStats | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<MetricsStats | null> | null, callback?: λFunction<MetricsStats | null, MetricsStats | null> | null): C3.Array<ObjError | null>;
