// TypeScript definitions for the C3 type DisclosureReviewRequest

/**
 * Base request type for artifacts that need to go through the disclosure review cycle.
 *
 * @remarks this represents a value passed to a method that expects an instance of DisclosureReviewRequest
 */
declare interface IDisclosureReviewRequest {
 ...
 * Base request type for artifacts that need to go through the disclosure review cycle.
 *
 * @remarks this represents a made instance of DisclosureReviewRequest
 */
declare class DisclosureReviewRequest extends Obj {

  /**
   * List of {@link AclEntry} entries governing who can read/update/remove Objs.
   */
  readonly acl?: C3.Array<AclEntry | null>;
  withAcl(acl: C3.Array<AclEntry | null> | Array<IAclEntry | null>): DisclosureReviewRequest;
  ...
  withTypeIdent(typeIdent: string | null): DisclosureReviewRequest;
   ...
   */
  readonly id: string;
  withId(id: string): DisclosureReviewRequest;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): DisclosureReviewRequest;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): DisclosureReviewRequest;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): DisclosureReviewRequest;
  ...
  withVersion(version: number | null): DisclosureReviewRequest;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): DisclosureReviewRequest;

  /**
   * The status of the request. See {@link DisclosureReviewRequest.Status}.
   */
  readonly status?: string | null;
  withStatus(status: string | null): DisclosureReviewRequest;

  /**
   * The requestor of the request.
   */
  readonly requestedBy?: User | null;
  withRequestedBy(requestedBy: IUser | null): DisclosureReviewRequest;

  /**
   * The description of the request filled by the requestor.
   */
  readonly description?: string | null;
  withDescription(description: string | null): DisclosureReviewRequest;

  /**
   * The expiration timestamp of the request.
   */
  readonly expiresAt?: DateTime | null;
  withExpiresAt(expiresAt: DateTime | Date | string | null): DisclosureReviewRequest;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): DisclosureReviewRequest | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): DisclosureReviewRequest | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): DisclosureReviewRequest | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): DisclosureReviewRequest | null;
   ...
   */
  replaceType(old: Type, new_: Type): DisclosureReviewRequest;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DisclosureReviewRequest;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DisclosureReviewRequest;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DisclosureReviewRequest | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DisclosureReviewRequest | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DisclosureReviewRequest;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DisclosureReviewRequest;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DisclosureReviewRequest;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DisclosureReviewRequest;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DisclosureReviewRequest;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DisclosureReviewRequest;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DisclosureReviewRequest;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DisclosureReviewRequest;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DisclosureReviewRequest;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): DisclosureReviewRequest;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): DisclosureReviewRequest;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): DisclosureReviewRequest;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DisclosureReviewRequest;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DisclosureReviewRequest;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DisclosureReviewRequest;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DisclosureReviewRequest;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DisclosureReviewRequest;
   ...
   * @see #removeField
   */
  unsetField(field: string): DisclosureReviewRequest;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DisclosureReviewRequest;
   ...
   * @see #unsetField
   */
  removeField(field: string): DisclosureReviewRequest;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DisclosureReviewRequest;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DisclosureReviewRequest;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): DisclosureReviewRequest;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DisclosureReviewRequest;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DisclosureReviewRequest;

  mergeJson(json: any | null): DisclosureReviewRequest;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DisclosureReviewRequest;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): DisclosureReviewRequest;
   ...
   */
  singletonArray(): C3.Array<DisclosureReviewRequest | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<DisclosureReviewRequest | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DisclosureReviewRequest | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<DisclosureReviewRequest | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DisclosureReviewRequest | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, DisclosureReviewRequest | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DisclosureReviewRequest | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DisclosureReviewRequest | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DisclosureReviewRequest | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DisclosureReviewRequest;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DisclosureReviewRequest;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DisclosureReviewRequest;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DisclosureReviewRequest;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DisclosureReviewRequest;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DisclosureReviewRequest;
   ...
   * @see #fromString
   */
  static make(s: string | null): DisclosureReviewRequest | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DisclosureReviewRequest;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): DisclosureReviewRequest;
   ...
   */
  static cachedEmptyInst(): DisclosureReviewRequest;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DisclosureReviewRequest>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): DisclosureReviewRequest;
   ...
   */
  static populateAcl(objs?: C3.Array<DisclosureReviewRequest | null>): number | null;
   ...
   */
  grantMemberReadUpdateRemove(member: AccessControlEntity): DisclosureReviewRequest;
   ...
   */
  mergeAclEntry(entry: AclEntry): DisclosureReviewRequest;
   ...
   * @return the obj with the new acl after merging the indicated entry.
   */
  mergeAclEntries(entries: C3.Array<AclEntry | null> | null): DisclosureReviewRequest;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<DisclosureReviewRequest | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<DisclosureReviewRequest | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<DisclosureReviewRequest | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<DisclosureReviewRequest | null> | null>;
   ...
   */
  get(include?: string | null): DisclosureReviewRequest | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): DisclosureReviewRequest | null;
   ...
   */
  getMissing(spec: GetMissingSpec): DisclosureReviewRequest;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): DisclosureReviewRequest | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): DisclosureReviewRequest;
   ...
   * @see #toString
   */
  static fromString(s: string | null): DisclosureReviewRequest | null;
   ...
   */
  create(spec?: UpsertSpec | null): DisclosureReviewRequest | null;
   ...
   */
  static createBatch(objs: C3.Array<DisclosureReviewRequest | null> | null, spec?: UpsertSpec | null): ObjList<DisclosureReviewRequest | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<DisclosureReviewRequest | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<DisclosureReviewRequest | null> | null;
   ...
   */
  update(srcObj?: DisclosureReviewRequest | null, spec?: UpsertSpec | null): DisclosureReviewRequest | null;
   ...
   */
  upsert(srcObj?: DisclosureReviewRequest | null, spec?: UpsertSpec | null): DisclosureReviewRequest | null;
   ...
   */
  merge(spec?: MergeSpec | null): DisclosureReviewRequest | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): DisclosureReviewRequest | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): DisclosureReviewRequest | null;
   ...
   */
  static updateBatch(objs: C3.Array<DisclosureReviewRequest | null> | null, srcObjs?: C3.Array<DisclosureReviewRequest | null>, spec?: UpsertSpec | null): ObjList<DisclosureReviewRequest | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<DisclosureReviewRequest | null>>, spec?: UpsertSpec | null): ObjList<DisclosureReviewRequest | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<DisclosureReviewRequest | null> | null, srcObjs?: C3.Array<DisclosureReviewRequest | null>, spec?: UpsertSpec | null): ObjList<DisclosureReviewRequest | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<DisclosureReviewRequest | null>>, spec?: UpsertSpec | null): ObjList<DisclosureReviewRequest | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<DisclosureReviewRequest | null> | null, spec?: TouchSpec | null): ObjList<DisclosureReviewRequest | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<DisclosureReviewRequest | null> | null, spec?: MergeSpec | null): ObjList<DisclosureReviewRequest | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<DisclosureReviewRequest | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<DisclosureReviewRequest | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<DisclosureReviewRequest | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<DisclosureReviewRequest | null> | null;
   ...
   */
  static mergeAll(mergeObj: DisclosureReviewRequest | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: DisclosureReviewRequest | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<DisclosureReviewRequest | null> | null, spec?: UpsertSpec | null): ObjList<DisclosureReviewRequest | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<DisclosureReviewRequest | null> | null, spec?: UpsertSpec | null): ObjList<DisclosureReviewRequest | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): DisclosureReviewRequest | null;
   ...
   */
  static beforeCreate(objs: C3.Array<DisclosureReviewRequest | null> | null): ObjList<DisclosureReviewRequest | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<DisclosureReviewRequest | null> | null): ObjList<DisclosureReviewRequest | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<DisclosureReviewRequest | null> | null): ObjList<DisclosureReviewRequest | null>;
   ...
   */
  static afterCreate(objs: C3.Array<DisclosureReviewRequest | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<DisclosureReviewRequest | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<DisclosureReviewRequest | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<DisclosureReviewRequest | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<DisclosureReviewRequest | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): DisclosureReviewRequest | null;
   ...
   */
  withoutIdentity(): DisclosureReviewRequest | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<DisclosureReviewRequest | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: DisclosureReviewRequest | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<DisclosureReviewRequest | null> | null, callback?: λFunction<DisclosureReviewRequest | null, DisclosureReviewRequest | null> | null): ObjList<DisclosureReviewRequest | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<DisclosureReviewRequest | null> | null, callback?: λFunction<DisclosureReviewRequest | null, DisclosureReviewRequest | null> | null): C3.Array<ObjError | null>;
