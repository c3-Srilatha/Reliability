// TypeScript definitions for the C3 type SendGridConfig

/**
 * @remarks this represents a value passed to a method that expects an instance of SendGridConfig
 */
declare interface ISendGridConfig {
  ...
  /**
   * {@link SendGrid#isValidEmail} makes an internal API request to
   * {@link SendGridEmailAddressValidationApi#validateEmailAddress}. If the validation verdict is part of these accepted
   * validation verdicts, {@link SendGrid#isValidEmail} returns true. If {@link acceptedEmailValidationScore} is
   * defined, that value overrides the list of accepted verdicts.
   */
  acceptedEmailValidationVerdicts?: C3.Array<string | null> | Array<string | null>;

  /**
   * {@link SendGrid#isValidEmail} makes an internal API request to
   * {@link SendGridEmailAddressValidationApi#validateEmailAddress}. If the validation score is greater than or equal to
   * this value, {@link SendGrid#isValidEmail} returns true. If this value is undefined or null, the list of
   * {@link acceptedEmailValidationVerdicts} is used.
   */
  acceptedEmailValidationScore?: number | null;
}

/**
 * @remarks this represents a made instance of SendGridConfig
 */
declare class SendGridConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): SendGridConfig;

  static readonly configOverride?: string | null;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): SendGridConfig;
  ...
  withIssues(issues: C3.Array<string | null> | Array<string | null>): SendGridConfig;
   ...
   * defined, that value overrides the list of accepted verdicts.
   */
  readonly acceptedEmailValidationVerdicts?: C3.Array<string | null>;
  withAcceptedEmailValidationVerdicts(acceptedEmailValidationVerdicts: C3.Array<string | null> | Array<string | null>): SendGridConfig;
   ...
   * defined, that value overrides the list of accepted verdicts.
   */
  static readonly acceptedEmailValidationVerdicts?: C3.Array<string | null>;
   ...
   * {@link acceptedEmailValidationVerdicts} is used.
   */
  readonly acceptedEmailValidationScore?: number | null;
  withAcceptedEmailValidationScore(acceptedEmailValidationScore: number | null): SendGridConfig;
   ...
   * {@link acceptedEmailValidationVerdicts} is used.
   */
  static readonly acceptedEmailValidationScore?: number | null;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SendGridConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SendGridConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SendGridConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SendGridConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): SendGridConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): SendGridConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SendGridConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SendGridConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SendGridConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SendGridConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SendGridConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SendGridConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SendGridConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SendGridConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SendGridConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SendGridConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SendGridConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SendGridConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SendGridConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SendGridConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SendGridConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): SendGridConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SendGridConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): SendGridConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SendGridConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): SendGridConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SendGridConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SendGridConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SendGridConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SendGridConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SendGridConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): SendGridConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SendGridConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): SendGridConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SendGridConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): SendGridConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SendGridConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): SendGridConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SendGridConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SendGridConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SendGridConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): SendGridConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SendGridConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SendGridConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SendGridConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): SendGridConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SendGridConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): SendGridConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): SendGridConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): SendGridConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SendGridConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): SendGridConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): SendGridConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): SendGridConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SendGridConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): SendGridConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SendGridConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SendGridConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SendGridConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): SendGridConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SendGridConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SendGridConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SendGridConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SendGridConfig;

  mergeJson(json: any | null): SendGridConfig;

  static mergeJson(json: any | null): SendGridConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SendGridConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SendGridConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SendGridConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): SendGridConfig;
   ...
   */
  singletonArray(): C3.Array<SendGridConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<SendGridConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SendGridConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SendGridConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SendGridConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<SendGridConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SendGridConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SendGridConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SendGridConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SendGridConfig | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<SendGridConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SendGridConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SendGridConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SendGridConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SendGridConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SendGridConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SendGridConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SendGridConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SendGridConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): SendGridConfig;
   ...
   */
  static cachedEmptyInst(): SendGridConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SendGridConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SendGridConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<SendGridConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<SendGridConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<SendGridConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): SendGridConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): SendGridConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): SendGridConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): SendGridConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): SendGridConfig | null;
   ...
   */
  static produce(key: string): SendGridConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, SendGridConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, SendGridConfig | null>;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): SendGridConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): SendGridConfig;
   ...
   */
  static forConfigKey(configKey: string | null): SendGridConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<SendGridConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: SendGridConfig, override?: string | null): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: SendGridConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: SendGridConfig, override?: string | null): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: SendGridConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): SendGridConfig | null;
   ...
   */
  removeSecrets(): SendGridConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): SendGridConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): SendGridConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): SendGridConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): SendGridConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): SendGridConfig;
