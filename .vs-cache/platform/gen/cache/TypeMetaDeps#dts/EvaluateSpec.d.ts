// TypeScript definitions for the C3 type EvaluateSpec

/**
 * Specification of which Objs to evaluate and what expressions to evaluate on them for a {@link Persistable#evaluate} call.
 *
 * @remarks this represents a value passed to a method that expects an instance of EvaluateSpec
 */
declare interface IEvaluateSpec {
 ...
 */
declare class EvaluateSpec extends Obj {
  ...
  withProjection(projection: string): EvaluateSpec;
  ...
  withGroup(group: string | null): EvaluateSpec;
  ...
  withHaving(having: string | null): EvaluateSpec;
  ...
  withFilter(filter: string | null): EvaluateSpec;

  /**
   * Variables values to substitute in filter expression. CURRENTLY UNDER CONSTRUCTION!
   */
  readonly vars?: C3.Map<string | null, Obj | null>;
  withVars(vars: C3.Map<string | null, Obj | null> | {[key: string | null]: IObj | null}): EvaluateSpec;
  ...
  withFetchHiddenSeedData(fetchHiddenSeedData: boolean): EvaluateSpec;
  ...
  withExcludeExtensions(excludeExtensions: boolean): EvaluateSpec;
  ...
  withAsOf(asOf: DateTime | Date | string | null): EvaluateSpec;
  ...
  withAllowLiteralOnBindVariableOverflow(allowLiteralOnBindVariableOverflow: boolean): EvaluateSpec;
  ...
  withUseDedicatedConnection(useDedicatedConnection: boolean): EvaluateSpec;
  ...
  withStmtTimeoutMs(stmtTimeoutMs: number | null): EvaluateSpec;
  ...
  withDontThrowJsonDeserErrors(dontThrowJsonDeserErrors: boolean): EvaluateSpec;
  ...
  withTimeRange(timeRange: ITimeRange | null): EvaluateSpec;
  ...
  withTimedFetchParentField(timedFetchParentField: string | null): EvaluateSpec;

  readonly includeBaseTypes?: boolean;
  withIncludeBaseTypes(includeBaseTypes: boolean): EvaluateSpec;
  ...
  withIgnoreViewInclude(ignoreViewInclude: boolean): EvaluateSpec;
  ...
  withOrder(order: string | null): EvaluateSpec;

  /**
   * Offset to use for paged evaluation.  Indicates the first computed result to return. Default is 0 (first).
   */
  readonly offset?: number | null;
  withOffset(offset: number | null): EvaluateSpec;
  ...
  withLimit(limit: number | null): EvaluateSpec;
  ...
  withSqlId(sqlId: number | null): EvaluateSpec;
  ...
  withDisableAuthz(disableAuthz: boolean): EvaluateSpec;
  ...
  withForceExprEval(forceExprEval: boolean): EvaluateSpec;
  ...
  withForceDbEngineEval(forceDbEngineEval: boolean): EvaluateSpec;
  ...
  withTimeRangeStart(timeRangeStart: DateTime | Date | string | null): EvaluateSpec;
  ...
  withTimeRangeEnd(timeRangeEnd: DateTime | Date | string | null): EvaluateSpec;
  ...
  withGrain(grain: string | null): EvaluateSpec;
  ...
  withInterval(interval: string | null): EvaluateSpec;
  ...
  withTimeZone(timeZone: string | null): EvaluateSpec;
  ...
  withExplain(explain: boolean): EvaluateSpec;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): EvaluateSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): EvaluateSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): EvaluateSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): EvaluateSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): EvaluateSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): EvaluateSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): EvaluateSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<EvaluateSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<EvaluateSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): EvaluateSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): EvaluateSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): EvaluateSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): EvaluateSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): EvaluateSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): EvaluateSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): EvaluateSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): EvaluateSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): EvaluateSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): EvaluateSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): EvaluateSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): EvaluateSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): EvaluateSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): EvaluateSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): EvaluateSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): EvaluateSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): EvaluateSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): EvaluateSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): EvaluateSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): EvaluateSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): EvaluateSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): EvaluateSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): EvaluateSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): EvaluateSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): EvaluateSpec;

  mergeJson(json: any | null): EvaluateSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): EvaluateSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): EvaluateSpec;
   ...
   */
  singletonArray(): C3.Array<EvaluateSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<EvaluateSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<EvaluateSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<EvaluateSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<EvaluateSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, EvaluateSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, EvaluateSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<EvaluateSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<EvaluateSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): EvaluateSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): EvaluateSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): EvaluateSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): EvaluateSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): EvaluateSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): EvaluateSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): EvaluateSpec;
   ...
   */
  static cachedEmptyInst(): EvaluateSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<EvaluateSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): EvaluateSpec;
