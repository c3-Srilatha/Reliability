// TypeScript definitions for the C3 type BasicAuthIdpConfig

/**
 * @remarks this represents a value passed to a method that expects an instance of BasicAuthIdpConfig
 */
declare interface IBasicAuthIdpConfig {
...
/**
 * @remarks this represents a made instance of BasicAuthIdpConfig
 */
declare class BasicAuthIdpConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): BasicAuthIdpConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): BasicAuthIdpConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): BasicAuthIdpConfig;

  /**
   * The unique and required id of this instance.
   */
  readonly id: string;
  withId(id: string): BasicAuthIdpConfig;

  /**
   * If present, the user will be redirected to this url instead of the idp login page.
   */
  readonly defaultContentUrl?: string | null;
  withDefaultContentUrl(defaultContentUrl: string | null): BasicAuthIdpConfig;

  /**
   * Which field of the IdpUser to use as the user id
   */
  readonly userIdFormat?: string | null;
  withUserIdFormat(userIdFormat: string | null): BasicAuthIdpConfig;
  ...
  withDefaultGroupId(defaultGroupId: string | null): BasicAuthIdpConfig;

  /**
   * Returns whether we should write back to the Idp
   */
  readonly idpWriteback?: boolean;
  withIdpWriteback(idpWriteback: boolean): BasicAuthIdpConfig;

  /**
   * Returns whether we should write back {@link UserGroup} updates to the Idp
   */
  readonly idpGroupWriteback?: boolean;
  withIdpGroupWriteback(idpGroupWriteback: boolean): BasicAuthIdpConfig;

  /**
   * Returns the identity provider for write-back (if enabled)
   */
  readonly idpType?: string | null;
  withIdpType(idpType: string | null): BasicAuthIdpConfig;
  ...
  withExternalAppId(externalAppId: string | null): BasicAuthIdpConfig;
  ...
  withAllowedEmailDomains(allowedEmailDomains: C3.Array<string | null> | Array<string | null>): BasicAuthIdpConfig;

  /**
   * Applications that are trusted to redirect authenticated user(s)
   */
  readonly trustedApplicationHosts?: C3.Array<string | null>;
  withTrustedApplicationHosts(trustedApplicationHosts: C3.Array<string | null> | Array<string | null>): BasicAuthIdpConfig;

  /**
   * List of relevant groups for the cluster from the IDP. If empty, then no group filtering is done on user login.
   */
  readonly relevantGroups?: C3.Array<string | null>;
  withRelevantGroups(relevantGroups: C3.Array<string | null> | Array<string | null>): BasicAuthIdpConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): BasicAuthIdpConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): BasicAuthIdpConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): BasicAuthIdpConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): BasicAuthIdpConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): BasicAuthIdpConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BasicAuthIdpConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BasicAuthIdpConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BasicAuthIdpConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BasicAuthIdpConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): BasicAuthIdpConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BasicAuthIdpConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BasicAuthIdpConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): BasicAuthIdpConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): BasicAuthIdpConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): BasicAuthIdpConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): BasicAuthIdpConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BasicAuthIdpConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): BasicAuthIdpConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): BasicAuthIdpConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): BasicAuthIdpConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): BasicAuthIdpConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): BasicAuthIdpConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): BasicAuthIdpConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): BasicAuthIdpConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): BasicAuthIdpConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): BasicAuthIdpConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): BasicAuthIdpConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): BasicAuthIdpConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): BasicAuthIdpConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): BasicAuthIdpConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): BasicAuthIdpConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): BasicAuthIdpConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): BasicAuthIdpConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): BasicAuthIdpConfig;

  mergeJson(json: any | null): BasicAuthIdpConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): BasicAuthIdpConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): BasicAuthIdpConfig;
   ...
   */
  singletonArray(): C3.Array<BasicAuthIdpConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<BasicAuthIdpConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BasicAuthIdpConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<BasicAuthIdpConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BasicAuthIdpConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, BasicAuthIdpConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BasicAuthIdpConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BasicAuthIdpConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BasicAuthIdpConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): BasicAuthIdpConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): BasicAuthIdpConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): BasicAuthIdpConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): BasicAuthIdpConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): BasicAuthIdpConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): BasicAuthIdpConfig;
   ...
   * @see #fromString
   */
  static make(s: string | null): BasicAuthIdpConfig | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): BasicAuthIdpConfig;
   ...
   */
  static cachedEmptyInst(): BasicAuthIdpConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<BasicAuthIdpConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): BasicAuthIdpConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<BasicAuthIdpConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<BasicAuthIdpConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<BasicAuthIdpConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): BasicAuthIdpConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): BasicAuthIdpConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): BasicAuthIdpConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): BasicAuthIdpConfig | null;
   ...
   */
  static produce(key: string): BasicAuthIdpConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, BasicAuthIdpConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, BasicAuthIdpConfig | null>;
   ...
   */
  static forConfigKey(configKey: string | null): BasicAuthIdpConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<BasicAuthIdpConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: BasicAuthIdpConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: BasicAuthIdpConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): BasicAuthIdpConfig | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): BasicAuthIdpConfig | null;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): BasicAuthIdpConfig | null;
