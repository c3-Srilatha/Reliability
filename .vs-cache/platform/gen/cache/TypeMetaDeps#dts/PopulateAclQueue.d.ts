// TypeScript definitions for the C3 type PopulateAclQueue

/**
 * Invalidation queue for populateAcl processing.  Each entry is for refreshing the acl list for a single target
 * instance based on the {@link AclPrivilege} entries for that instance's type.
 *
 * @see PopulateAclQueueEntry
 *
 * @remarks this represents a value passed to a method that expects an instance of PopulateAclQueue
 */
declare interface IPopulateAclQueue {
}
 ...
 * @see PopulateAclQueueEntry
 *
 * @remarks this represents a made instance of PopulateAclQueue
 */
declare class PopulateAclQueue {
   ...
   */
  static compute(targetType: Type, entries: C3.Array<PopulateAclQueueEntry | null> | null): void;
   ...
   */
  static find(spec?: InvalidationQueue.FindSpec | null): C3.Array<PopulateAclQueueEntry | null>;
   ...
   * @return the list of requested entries.
   */
  static findStream(spec?: InvalidationQueue.FindStreamSpec | null): Stream<PopulateAclQueueEntry | null>;
   ...
   *           Entries to remove.
   */
  static clearEntries(entries: C3.Array<PopulateAclQueueEntry | null> | null): void;
