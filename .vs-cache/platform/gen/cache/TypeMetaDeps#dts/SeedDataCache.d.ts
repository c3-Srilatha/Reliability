// TypeScript definitions for the C3 type SeedDataCache

/**
 * Base type for ALL seed data based caches.
 *
 * @remarks this represents a value passed to a method that expects an instance of SeedDataCache
 */
declare interface ISeedDataCache<T> {
}

/**
 * Base type for ALL seed data based caches.
 *
 * @remarks this represents a made instance of SeedDataCache
 */
declare class SeedDataCache<T> {
   ...
   */
  static get(key: string | null): T | null;
   ...
   */
  static require(key: string | null): T;
   ...
   */
  static put(key: string | null, value: T | null): void;
   ...
   */
  static produce(key: string | null): T | null;
   ...
   */
  static validate(value: T | null): boolean;
}
