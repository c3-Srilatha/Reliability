// TypeScript definitions for the C3 type DataLake.Table.MetaFieldValue

/**
 * @remarks this represents a value passed to a method that expects an instance of DataLake.Table.MetaFieldValue
 */
declare namespace DataLake.Table {
  export interface IMetaFieldValue {
    ...
    table: IDataLake.Table.Managed<DataLake.Table.Snapshot | null>;
...
/**
 * @remarks this represents a made instance of DataLake.Table.MetaFieldValue
 */
declare namespace DataLake.Table {
  export class MetaFieldValue extends Obj {
     ...
     */
    readonly id: string;
    withId(id: string): DataLake.Table.MetaFieldValue;
    ...
    withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): DataLake.Table.MetaFieldValue;

    /**
     * Name of the Obj instance
     */
    readonly name: string;
    withName(name: string): DataLake.Table.MetaFieldValue;

    /**
     * Various system fields.
     */
    readonly meta?: Meta | null;
    withMeta(meta: IMeta | null): DataLake.Table.MetaFieldValue;
    ...
    withVersion(version: number | null): DataLake.Table.MetaFieldValue;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type | null;
    withTypeWithBindings(typeWithBindings: IType | null): DataLake.Table.MetaFieldValue;

    readonly table: DataLake.Table.Managed<DataLake.Table.Snapshot | null>;
    withTable(table: IDataLake.Table.Managed<DataLake.Table.Snapshot | null>): DataLake.Table.MetaFieldValue;

    readonly metaVersion: number;
    withMetaVersion(metaVersion: number): DataLake.Table.MetaFieldValue;

    readonly value?: string | null;
    withValue(value: string | null): DataLake.Table.MetaFieldValue;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): DataLake.Table.MetaFieldValue | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): DataLake.Table.MetaFieldValue | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): DataLake.Table.MetaFieldValue | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): DataLake.Table.MetaFieldValue | null;
     ...
     */
    replaceType(old: Type, new_: Type): DataLake.Table.MetaFieldValue;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataLake.Table.MetaFieldValue;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataLake.Table.MetaFieldValue;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataLake.Table.MetaFieldValue | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataLake.Table.MetaFieldValue | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataLake.Table.MetaFieldValue;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataLake.Table.MetaFieldValue;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataLake.Table.MetaFieldValue;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): DataLake.Table.MetaFieldValue;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): DataLake.Table.MetaFieldValue;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): DataLake.Table.MetaFieldValue;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataLake.Table.MetaFieldValue;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataLake.Table.MetaFieldValue;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): DataLake.Table.MetaFieldValue;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): DataLake.Table.MetaFieldValue;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): DataLake.Table.MetaFieldValue;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): DataLake.Table.MetaFieldValue;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataLake.Table.MetaFieldValue;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): DataLake.Table.MetaFieldValue;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataLake.Table.MetaFieldValue;
     ...
     * @see #unsetField
     */
    defaultField(field: string): DataLake.Table.MetaFieldValue;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): DataLake.Table.MetaFieldValue;
     ...
     * @see #removeField
     */
    unsetField(field: string): DataLake.Table.MetaFieldValue;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): DataLake.Table.MetaFieldValue;
     ...
     * @see #unsetField
     */
    removeField(field: string): DataLake.Table.MetaFieldValue;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): DataLake.Table.MetaFieldValue;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataLake.Table.MetaFieldValue;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): DataLake.Table.MetaFieldValue;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataLake.Table.MetaFieldValue;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataLake.Table.MetaFieldValue;

    mergeJson(json: any | null): DataLake.Table.MetaFieldValue;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataLake.Table.MetaFieldValue;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): DataLake.Table.MetaFieldValue;
     ...
     */
    singletonArray(): C3.Array<DataLake.Table.MetaFieldValue | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<DataLake.Table.MetaFieldValue | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<DataLake.Table.MetaFieldValue | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<DataLake.Table.MetaFieldValue | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<DataLake.Table.MetaFieldValue | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, DataLake.Table.MetaFieldValue | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataLake.Table.MetaFieldValue | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<DataLake.Table.MetaFieldValue | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<DataLake.Table.MetaFieldValue | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DataLake.Table.MetaFieldValue;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DataLake.Table.MetaFieldValue;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DataLake.Table.MetaFieldValue;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): DataLake.Table.MetaFieldValue;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DataLake.Table.MetaFieldValue;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): DataLake.Table.MetaFieldValue;
     ...
     * @see #fromString
     */
    static make(s: string | null): DataLake.Table.MetaFieldValue | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DataLake.Table.MetaFieldValue;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): DataLake.Table.MetaFieldValue;
     ...
     */
    static cachedEmptyInst(): DataLake.Table.MetaFieldValue;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DataLake.Table.MetaFieldValue>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): DataLake.Table.MetaFieldValue;
     ...
     */
    static fetch(spec?: FetchSpec | null): FetchResult<DataLake.Table.MetaFieldValue | null>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<DataLake.Table.MetaFieldValue | null>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec | null): Stream<DataLake.Table.MetaFieldValue | null>;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<DataLake.Table.MetaFieldValue | null> | null>;
     ...
     */
    get(include?: string | null): DataLake.Table.MetaFieldValue | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string | null): DataLake.Table.MetaFieldValue | null;
     ...
     */
    getMissing(spec: GetMissingSpec): DataLake.Table.MetaFieldValue;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string | null): DataLake.Table.MetaFieldValue | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): DataLake.Table.MetaFieldValue;
     ...
     * @see #toString
     */
    static fromString(s: string | null): DataLake.Table.MetaFieldValue | null;
     ...
     */
    create(spec?: UpsertSpec | null): DataLake.Table.MetaFieldValue | null;
     ...
     */
    static createBatch(objs: C3.Array<DataLake.Table.MetaFieldValue | null> | null, spec?: UpsertSpec | null): ObjList<DataLake.Table.MetaFieldValue | null> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<DataLake.Table.MetaFieldValue | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<DataLake.Table.MetaFieldValue | null> | null;
     ...
     */
    update(srcObj?: DataLake.Table.MetaFieldValue | null, spec?: UpsertSpec | null): DataLake.Table.MetaFieldValue | null;
     ...
     */
    upsert(srcObj?: DataLake.Table.MetaFieldValue | null, spec?: UpsertSpec | null): DataLake.Table.MetaFieldValue | null;
     ...
     */
    merge(spec?: MergeSpec | null): DataLake.Table.MetaFieldValue | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec | null): DataLake.Table.MetaFieldValue | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec | null): DataLake.Table.MetaFieldValue | null;
     ...
     */
    static updateBatch(objs: C3.Array<DataLake.Table.MetaFieldValue | null> | null, srcObjs?: C3.Array<DataLake.Table.MetaFieldValue | null>, spec?: UpsertSpec | null): ObjList<DataLake.Table.MetaFieldValue | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<C3.Array<DataLake.Table.MetaFieldValue | null>>, spec?: UpsertSpec | null): ObjList<DataLake.Table.MetaFieldValue | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: C3.Array<DataLake.Table.MetaFieldValue | null> | null, srcObjs?: C3.Array<DataLake.Table.MetaFieldValue | null>, spec?: UpsertSpec | null): ObjList<DataLake.Table.MetaFieldValue | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<C3.Array<DataLake.Table.MetaFieldValue | null>>, spec?: UpsertSpec | null): ObjList<DataLake.Table.MetaFieldValue | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: C3.Array<DataLake.Table.MetaFieldValue | null> | null, spec?: TouchSpec | null): ObjList<DataLake.Table.MetaFieldValue | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<DataLake.Table.MetaFieldValue | null> | null, spec?: MergeSpec | null): ObjList<DataLake.Table.MetaFieldValue | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<DataLake.Table.MetaFieldValue | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<DataLake.Table.MetaFieldValue | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<C3.Array<DataLake.Table.MetaFieldValue | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<DataLake.Table.MetaFieldValue | null> | null;
     ...
     */
    static mergeAll(mergeObj: DataLake.Table.MetaFieldValue | null, spec?: MergeAllSpec | null): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: DataLake.Table.MetaFieldValue | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: C3.Array<DataLake.Table.MetaFieldValue | null> | null, spec?: UpsertSpec | null): ObjList<DataLake.Table.MetaFieldValue | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: C3.Array<DataLake.Table.MetaFieldValue | null> | null, spec?: UpsertSpec | null): ObjList<DataLake.Table.MetaFieldValue | null> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): DataLake.Table.MetaFieldValue | null;
     ...
     */
    static beforeCreate(objs: C3.Array<DataLake.Table.MetaFieldValue | null> | null): ObjList<DataLake.Table.MetaFieldValue | null>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: C3.Array<DataLake.Table.MetaFieldValue | null> | null): ObjList<DataLake.Table.MetaFieldValue | null>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: C3.Array<DataLake.Table.MetaFieldValue | null> | null): ObjList<DataLake.Table.MetaFieldValue | null>;
     ...
     */
    static afterCreate(objs: C3.Array<DataLake.Table.MetaFieldValue | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: C3.Array<DataLake.Table.MetaFieldValue | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: C3.Array<DataLake.Table.MetaFieldValue | null> | null): C3.Array<ObjError | null>;
     ...
     */
    static startImportData(spec?: StartImportDataSpec | null): PushStream<DataLake.Table.MetaFieldValue | null>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<DataLake.Table.MetaFieldValue | null>;
     ...
     */
    static forId(id: string | null, failIfMissing?: boolean): DataLake.Table.MetaFieldValue | null;
     ...
     */
    withoutIdentity(): DataLake.Table.MetaFieldValue | null;
     ...
     */
    static typeOfBatch(objs: C3.Array<DataLake.Table.MetaFieldValue | null> | null): C3.Array<EntityType | null>;
     ...
     */
    static dbEcho(template?: DataLake.Table.MetaFieldValue | null, count?: number | null, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: C3.Array<DataLake.Table.MetaFieldValue | null> | null, callback?: λFunction<DataLake.Table.MetaFieldValue | null, DataLake.Table.MetaFieldValue | null> | null): ObjList<DataLake.Table.MetaFieldValue | null>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: C3.Array<DataLake.Table.MetaFieldValue | null> | null, callback?: λFunction<DataLake.Table.MetaFieldValue | null, DataLake.Table.MetaFieldValue | null> | null): C3.Array<ObjError | null>;
