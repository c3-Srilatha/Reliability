// TypeScript definitions for the C3 type VmTypeInfo

/**
 * Record of all virtual machine (instance) types we use, with theoretical capacity
 * as well as high watermarks of observed throughput, used to calculate utilization.
 * The name and ID are both the instance type (i.e., "db.m2.xlarge"), which should
 * be unique within a platform (i.e., "AWS").
 *
 * @remarks this represents a value passed to a method that expects an instance of VmTypeInfo
 */
declare interface IVmTypeInfo {
  ...
  /**
   * virtualization platform name (i.e., "AWS")
   */
  platform: string;

  /**
   * additional info about the function of this VM
   */
  ...
  /**
   * attached storage, number and size in Gb (not including EBS volumes)
   */
  ...
  /**
   * observed maximum memory usage, in Gb
   */
  maxMemUsedGb?: number | null;

  /**
   * observed maximum disk I/O, in bytes/second
   */
  maxDiskRate?: number | null;

  /**
   * observed maximum network I/O, in bytes/second
   */
  maxNetworkRate?: number | null;
}
 ...
 * be unique within a platform (i.e., "AWS").
 *
 * @remarks this represents a made instance of VmTypeInfo
 */
declare class VmTypeInfo extends Obj {
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): VmTypeInfo;

  /**
   * name = id
   */
  readonly name: string;
  withName(name: string): VmTypeInfo;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): VmTypeInfo;
  ...
  withVersion(version: number | null): VmTypeInfo;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): VmTypeInfo;
  ...
  withUserUpdatedFields(userUpdatedFields: C3.Array<string | null> | Array<string | null>): VmTypeInfo;
  ...
  withHidden(hidden: boolean): VmTypeInfo;
  ...
  withUserOwned(userOwned: boolean): VmTypeInfo;

  /**
   * virtualization platform name (i.e., "AWS")
   */
  readonly platform: string;
  withPlatform(platform: string): VmTypeInfo;

  /**
   * additional info about the function of this VM
   */
  readonly description?: string | null;
  withDescription(description: string | null): VmTypeInfo;

  /**
   * count of virtual CPUs
   */
  readonly cpuCount?: number | null;
  withCpuCount(cpuCount: number | null): VmTypeInfo;

  /**
   * size of available memory, in Gb
   */
  readonly memoryGb?: number | null;
  withMemoryGb(memoryGb: number | null): VmTypeInfo;

  /**
   * attached storage, number and size in Gb (not including EBS volumes)
   */
  readonly diskCount?: number | null;
  withDiskCount(diskCount: number | null): VmTypeInfo;

  readonly diskSizeGb?: number | null;
  withDiskSizeGb(diskSizeGb: number | null): VmTypeInfo;

  /**
   * observed maximum memory usage, in Gb
   */
  readonly maxMemUsedGb?: number | null;
  withMaxMemUsedGb(maxMemUsedGb: number | null): VmTypeInfo;

  /**
   * observed maximum disk I/O, in bytes/second
   */
  readonly maxDiskRate?: number | null;
  withMaxDiskRate(maxDiskRate: number | null): VmTypeInfo;

  /**
   * observed maximum network I/O, in bytes/second
   */
  readonly maxNetworkRate?: number | null;
  withMaxNetworkRate(maxNetworkRate: number | null): VmTypeInfo;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): VmTypeInfo | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): VmTypeInfo | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): VmTypeInfo | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): VmTypeInfo | null;
   ...
   */
  replaceType(old: Type, new_: Type): VmTypeInfo;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VmTypeInfo;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VmTypeInfo;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VmTypeInfo | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VmTypeInfo | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): VmTypeInfo;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VmTypeInfo;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VmTypeInfo;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): VmTypeInfo;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): VmTypeInfo;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): VmTypeInfo;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): VmTypeInfo;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): VmTypeInfo;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): VmTypeInfo;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): VmTypeInfo;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): VmTypeInfo;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): VmTypeInfo;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): VmTypeInfo;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): VmTypeInfo;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): VmTypeInfo;
   ...
   * @see #unsetField
   */
  defaultField(field: string): VmTypeInfo;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): VmTypeInfo;
   ...
   * @see #removeField
   */
  unsetField(field: string): VmTypeInfo;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): VmTypeInfo;
   ...
   * @see #unsetField
   */
  removeField(field: string): VmTypeInfo;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): VmTypeInfo;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): VmTypeInfo;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): VmTypeInfo;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): VmTypeInfo;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): VmTypeInfo;

  mergeJson(json: any | null): VmTypeInfo;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): VmTypeInfo;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): VmTypeInfo;
   ...
   */
  singletonArray(): C3.Array<VmTypeInfo | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<VmTypeInfo | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<VmTypeInfo | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<VmTypeInfo | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<VmTypeInfo | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, VmTypeInfo | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, VmTypeInfo | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<VmTypeInfo | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<VmTypeInfo | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): VmTypeInfo;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): VmTypeInfo;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): VmTypeInfo;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): VmTypeInfo;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): VmTypeInfo;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): VmTypeInfo;
   ...
   * @see #fromString
   */
  static make(s: string | null): VmTypeInfo | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): VmTypeInfo;
   ...
   */
  static cachedEmptyInst(): VmTypeInfo;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<VmTypeInfo>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): VmTypeInfo;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<VmTypeInfo | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<VmTypeInfo | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<VmTypeInfo | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): VmTypeInfo | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string | null): VmTypeInfo | null;
   ...
   * @see findByCacheKey
   */
  getCached(): VmTypeInfo | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): VmTypeInfo | null;
   ...
   */
  static produce(key: string): VmTypeInfo | null;
   ...
   */
  static produceAll(): C3.Map<string | null, VmTypeInfo | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, VmTypeInfo | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<VmTypeInfo | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<VmTypeInfo | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<VmTypeInfo | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<VmTypeInfo | null> | null>;
   ...
   */
  get(include?: string | null): VmTypeInfo | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): VmTypeInfo | null;
   ...
   */
  getMissing(spec: GetMissingSpec): VmTypeInfo;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): VmTypeInfo | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): VmTypeInfo;
   ...
   * @see #toString
   */
  static fromString(s: string | null): VmTypeInfo | null;
   ...
   */
  create(spec?: UpsertSpec | null): VmTypeInfo | null;
   ...
   */
  static createBatch(objs: C3.Array<VmTypeInfo | null> | null, spec?: UpsertSpec | null): ObjList<VmTypeInfo | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<VmTypeInfo | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<VmTypeInfo | null> | null;
   ...
   */
  update(srcObj?: VmTypeInfo | null, spec?: UpsertSpec | null): VmTypeInfo | null;
   ...
   */
  upsert(srcObj?: VmTypeInfo | null, spec?: UpsertSpec | null): VmTypeInfo | null;
   ...
   */
  merge(spec?: MergeSpec | null): VmTypeInfo | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): VmTypeInfo | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): VmTypeInfo | null;
   ...
   */
  static updateBatch(objs: C3.Array<VmTypeInfo | null> | null, srcObjs?: C3.Array<VmTypeInfo | null>, spec?: UpsertSpec | null): ObjList<VmTypeInfo | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<VmTypeInfo | null>>, spec?: UpsertSpec | null): ObjList<VmTypeInfo | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<VmTypeInfo | null> | null, srcObjs?: C3.Array<VmTypeInfo | null>, spec?: UpsertSpec | null): ObjList<VmTypeInfo | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<VmTypeInfo | null>>, spec?: UpsertSpec | null): ObjList<VmTypeInfo | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<VmTypeInfo | null> | null, spec?: TouchSpec | null): ObjList<VmTypeInfo | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<VmTypeInfo | null> | null, spec?: MergeSpec | null): ObjList<VmTypeInfo | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<VmTypeInfo | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<VmTypeInfo | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<VmTypeInfo | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<VmTypeInfo | null> | null;
   ...
   */
  static mergeAll(mergeObj: VmTypeInfo | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: VmTypeInfo | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<VmTypeInfo | null> | null, spec?: UpsertSpec | null): ObjList<VmTypeInfo | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<VmTypeInfo | null> | null, spec?: UpsertSpec | null): ObjList<VmTypeInfo | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<VmTypeInfo | null> | null): ObjList<VmTypeInfo | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<VmTypeInfo | null> | null): ObjList<VmTypeInfo | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<VmTypeInfo | null> | null): ObjList<VmTypeInfo | null>;
   ...
   */
  static afterCreate(objs: C3.Array<VmTypeInfo | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<VmTypeInfo | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<VmTypeInfo | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<VmTypeInfo | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<VmTypeInfo | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): VmTypeInfo | null;
   ...
   */
  withoutIdentity(): VmTypeInfo | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<VmTypeInfo | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: VmTypeInfo | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<VmTypeInfo | null> | null, callback?: λFunction<VmTypeInfo | null, VmTypeInfo | null> | null): ObjList<VmTypeInfo | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<VmTypeInfo | null> | null, callback?: λFunction<VmTypeInfo | null, VmTypeInfo | null> | null): C3.Array<ObjError | null>;
   ...
   */
  publish(subPath?: string | null, contentType?: string | null): VmTypeInfo;
   ...
   */
  static removeSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<VmTypeInfo | null> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec | null): VmTypeInfo | null;
   ...
   */
  static createSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<VmTypeInfo | null> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData | null, spec?: UpsertSpec | null): VmTypeInfo | null;
   ...
   */
  static updateSeedDataBatch(objs?: C3.Array<SeedData | null>, srcObjs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<VmTypeInfo | null> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec | null): VmTypeInfo | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: C3.Array<SeedData | null>, spec?: MergeSpec | null): ObjList<VmTypeInfo | null> | null;
  ...
  dependencies(): SeedDataDeps<VmTypeInfo | null> | null;
