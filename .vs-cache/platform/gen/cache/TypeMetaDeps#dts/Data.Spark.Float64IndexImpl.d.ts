// TypeScript definitions for the C3 type Data.Spark.Float64IndexImpl
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Data.Spark.Float64IndexImpl
 */
declare namespace Data.Spark {
  export interface IFloat64IndexImpl {
 ...
 * See the interface {@link Data.Spark.Index} for declared APIs
 *
 * @remarks this represents a made instance of Data.Spark.Float64IndexImpl
 */
declare namespace Data.Spark {
  export class Float64IndexImpl extends Obj {
    ...
    withEngine(engine: IData.ExecutionEngine | null): Data.Spark.Float64IndexImpl;

    /**
     * The plan that used to actualize this Data.Spark instance
     */
    pipeline?: PipelineSpec | null;
    withPipeline(pipeline: IPipelineSpec | null): Data.Spark.Float64IndexImpl;

    /**
     * The id number that represent this Data.Spark instance
     */
    nodeId?: string | null;
    withNodeId(nodeId: string | null): Data.Spark.Float64IndexImpl;

    /**
     * The output name of the pipeline
     */
    outputId?: string | null;
    withOutputId(outputId: string | null): Data.Spark.Float64IndexImpl;
     ...
     */
    static make(): Data.Spark.Float64IndexImpl;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.Spark.Float64IndexImpl;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.Spark.Float64IndexImpl;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.Spark.Float64IndexImpl;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.Spark.Float64IndexImpl;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.Spark.Float64IndexImpl | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.Spark.Float64IndexImpl | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.Spark.Float64IndexImpl | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.Spark.Float64IndexImpl | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.Spark.Float64IndexImpl;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Spark.Float64IndexImpl;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Spark.Float64IndexImpl;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Spark.Float64IndexImpl | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Spark.Float64IndexImpl | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.Spark.Float64IndexImpl;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Spark.Float64IndexImpl;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Spark.Float64IndexImpl;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.Spark.Float64IndexImpl;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.Spark.Float64IndexImpl;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.Spark.Float64IndexImpl;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.Spark.Float64IndexImpl;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.Spark.Float64IndexImpl;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.Spark.Float64IndexImpl;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.Spark.Float64IndexImpl;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.Spark.Float64IndexImpl;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.Spark.Float64IndexImpl;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.Spark.Float64IndexImpl;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.Spark.Float64IndexImpl;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.Spark.Float64IndexImpl;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.Spark.Float64IndexImpl;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.Spark.Float64IndexImpl;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.Spark.Float64IndexImpl;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.Spark.Float64IndexImpl;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.Spark.Float64IndexImpl;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.Spark.Float64IndexImpl;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.Spark.Float64IndexImpl;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.Spark.Float64IndexImpl;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.Spark.Float64IndexImpl;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.Spark.Float64IndexImpl;

    mergeJson(json: any | null): Data.Spark.Float64IndexImpl;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.Spark.Float64IndexImpl;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.Spark.Float64IndexImpl;
     ...
     */
    singletonArray(): C3.Array<Data.Spark.Float64IndexImpl | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.Spark.Float64IndexImpl | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.Spark.Float64IndexImpl | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.Spark.Float64IndexImpl | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.Spark.Float64IndexImpl | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.Spark.Float64IndexImpl | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.Spark.Float64IndexImpl | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.Spark.Float64IndexImpl | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.Spark.Float64IndexImpl | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.Spark.Float64IndexImpl;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.Spark.Float64IndexImpl;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.Spark.Float64IndexImpl;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Data.Spark.Float64IndexImpl;
     ...
     */
    static cachedEmptyInst(): Data.Spark.Float64IndexImpl;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.Spark.Float64IndexImpl>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.Spark.Float64IndexImpl;
     ...
     * @return this Obj
     */
    setField(field: string, value: any, doNotConvert?: boolean): Data.Spark.Float64IndexImpl;
     ...
     * @return this Obj
     */
    setField(field: FieldType, value: any, doNotConvert?: boolean): Data.Spark.Float64IndexImpl;
