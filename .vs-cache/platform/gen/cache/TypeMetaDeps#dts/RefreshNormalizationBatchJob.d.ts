// TypeScript definitions for the C3 type RefreshNormalizationBatchJob

/**
 * Batch job definitions for batch jobs started from RefreshNormalizationTask for asynchronous processing.
 *
 * @remarks this represents a value passed to a method that expects an instance of RefreshNormalizationBatchJob
 */
declare interface IRefreshNormalizationBatchJob {
 ...
 */
declare class RefreshNormalizationBatchJob extends Obj {

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun | null;
  withRun(run: IBatchJobRun | null): RefreshNormalizationBatchJob;

  /**
   * previous job executions for this instance
   */
  readonly runs?: C3.Array<BatchJobRun | null>;
  withRuns(runs: C3.Array<BatchJobRun | null> | Array<IBatchJobRun | null>): RefreshNormalizationBatchJob;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj | null;
  withOptions(options: IObj | null): RefreshNormalizationBatchJob;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): RefreshNormalizationBatchJob;
  ...
  withPriority(priority: number | null): RefreshNormalizationBatchJob;
  ...
  withDisabled(disabled: boolean): RefreshNormalizationBatchJob;
  ...
  withMaxConcurrency(maxConcurrency: number | null): RefreshNormalizationBatchJob;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): RefreshNormalizationBatchJob;
  ...
  withRunAsUser(runAsUser: boolean | null): RefreshNormalizationBatchJob;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string | null;
  withNodePool(nodePool: string | null): RefreshNormalizationBatchJob;
  ...
  withSkipIfRunning(skipIfRunning: boolean | null): RefreshNormalizationBatchJob;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number | null;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): RefreshNormalizationBatchJob;
  ...
  withPropagateActionContext(propagateActionContext: boolean): RefreshNormalizationBatchJob;
  ...
  withTypeIdent(typeIdent: string | null): RefreshNormalizationBatchJob;
   ...
   */
  readonly id: string;
  withId(id: string): RefreshNormalizationBatchJob;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): RefreshNormalizationBatchJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): RefreshNormalizationBatchJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): RefreshNormalizationBatchJob;
  ...
  withVersion(version: number | null): RefreshNormalizationBatchJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): RefreshNormalizationBatchJob;
  ...
  withAbortOnError(abortOnError: boolean): RefreshNormalizationBatchJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): RefreshNormalizationBatchJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): RefreshNormalizationBatchJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): RefreshNormalizationBatchJob | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): RefreshNormalizationBatchJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): RefreshNormalizationBatchJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): RefreshNormalizationBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): RefreshNormalizationBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<RefreshNormalizationBatchJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<RefreshNormalizationBatchJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): RefreshNormalizationBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RefreshNormalizationBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RefreshNormalizationBatchJob;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): RefreshNormalizationBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): RefreshNormalizationBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): RefreshNormalizationBatchJob;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): RefreshNormalizationBatchJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): RefreshNormalizationBatchJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): RefreshNormalizationBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): RefreshNormalizationBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): RefreshNormalizationBatchJob;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): RefreshNormalizationBatchJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): RefreshNormalizationBatchJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): RefreshNormalizationBatchJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): RefreshNormalizationBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): RefreshNormalizationBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): RefreshNormalizationBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): RefreshNormalizationBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): RefreshNormalizationBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): RefreshNormalizationBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): RefreshNormalizationBatchJob;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): RefreshNormalizationBatchJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): RefreshNormalizationBatchJob;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): RefreshNormalizationBatchJob;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): RefreshNormalizationBatchJob;

  mergeJson(json: any | null): RefreshNormalizationBatchJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): RefreshNormalizationBatchJob;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): RefreshNormalizationBatchJob;
   ...
   */
  singletonArray(): C3.Array<RefreshNormalizationBatchJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<RefreshNormalizationBatchJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<RefreshNormalizationBatchJob | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<RefreshNormalizationBatchJob | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<RefreshNormalizationBatchJob | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, RefreshNormalizationBatchJob | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, RefreshNormalizationBatchJob | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<RefreshNormalizationBatchJob | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<RefreshNormalizationBatchJob | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): RefreshNormalizationBatchJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): RefreshNormalizationBatchJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): RefreshNormalizationBatchJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): RefreshNormalizationBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): RefreshNormalizationBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): RefreshNormalizationBatchJob;
   ...
   * @see #fromString
   */
  static make(s: string | null): RefreshNormalizationBatchJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): RefreshNormalizationBatchJob;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): RefreshNormalizationBatchJob;
   ...
   */
  static cachedEmptyInst(): RefreshNormalizationBatchJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<RefreshNormalizationBatchJob>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): RefreshNormalizationBatchJob;
   ...
   */
  start(options?: RefreshNormalizationSpec | null): BatchJobStatus | null;
   ...
   */
  cleanup(options?: RefreshNormalizationSpec | null): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun | null, BatchJobStatus | null, RefreshNormalizationSpec | null> | null;

  failJob(run: JobRun<BatchJobStatusBase | null>): JobBase<BatchJobRun | null, BatchJobStatus | null, RefreshNormalizationSpec | null> | null;
  ...
  validateStart(options?: RefreshNormalizationSpec | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<RefreshNormalizationBatchJob | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<RefreshNormalizationBatchJob | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<RefreshNormalizationBatchJob | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<RefreshNormalizationBatchJob | null> | null>;
   ...
   */
  get(include?: string | null): RefreshNormalizationBatchJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): RefreshNormalizationBatchJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): RefreshNormalizationBatchJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): RefreshNormalizationBatchJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): RefreshNormalizationBatchJob;
   ...
   * @see #toString
   */
  static fromString(s: string | null): RefreshNormalizationBatchJob | null;
   ...
   */
  create(spec?: UpsertSpec | null): RefreshNormalizationBatchJob | null;
   ...
   */
  static createBatch(objs: C3.Array<RefreshNormalizationBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<RefreshNormalizationBatchJob | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<RefreshNormalizationBatchJob | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<RefreshNormalizationBatchJob | null> | null;
   ...
   */
  update(srcObj?: RefreshNormalizationBatchJob | null, spec?: UpsertSpec | null): RefreshNormalizationBatchJob | null;
   ...
   */
  upsert(srcObj?: RefreshNormalizationBatchJob | null, spec?: UpsertSpec | null): RefreshNormalizationBatchJob | null;
   ...
   */
  merge(spec?: MergeSpec | null): RefreshNormalizationBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): RefreshNormalizationBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): RefreshNormalizationBatchJob | null;
   ...
   */
  static updateBatch(objs: C3.Array<RefreshNormalizationBatchJob | null> | null, srcObjs?: C3.Array<RefreshNormalizationBatchJob | null>, spec?: UpsertSpec | null): ObjList<RefreshNormalizationBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<RefreshNormalizationBatchJob | null>>, spec?: UpsertSpec | null): ObjList<RefreshNormalizationBatchJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<RefreshNormalizationBatchJob | null> | null, srcObjs?: C3.Array<RefreshNormalizationBatchJob | null>, spec?: UpsertSpec | null): ObjList<RefreshNormalizationBatchJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<RefreshNormalizationBatchJob | null>>, spec?: UpsertSpec | null): ObjList<RefreshNormalizationBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<RefreshNormalizationBatchJob | null> | null, spec?: TouchSpec | null): ObjList<RefreshNormalizationBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<RefreshNormalizationBatchJob | null> | null, spec?: MergeSpec | null): ObjList<RefreshNormalizationBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<RefreshNormalizationBatchJob | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<RefreshNormalizationBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<RefreshNormalizationBatchJob | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<RefreshNormalizationBatchJob | null> | null;
   ...
   */
  static mergeAll(mergeObj: RefreshNormalizationBatchJob | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: RefreshNormalizationBatchJob | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<RefreshNormalizationBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<RefreshNormalizationBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<RefreshNormalizationBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<RefreshNormalizationBatchJob | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): RefreshNormalizationBatchJob | null;
   ...
   */
  static beforeCreate(objs: C3.Array<RefreshNormalizationBatchJob | null> | null): ObjList<RefreshNormalizationBatchJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<RefreshNormalizationBatchJob | null> | null): ObjList<RefreshNormalizationBatchJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<RefreshNormalizationBatchJob | null> | null): ObjList<RefreshNormalizationBatchJob | null>;
   ...
   */
  static afterCreate(objs: C3.Array<RefreshNormalizationBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<RefreshNormalizationBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<RefreshNormalizationBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<RefreshNormalizationBatchJob | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<RefreshNormalizationBatchJob | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): RefreshNormalizationBatchJob | null;
   ...
   */
  withoutIdentity(): RefreshNormalizationBatchJob | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<RefreshNormalizationBatchJob | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: RefreshNormalizationBatchJob | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<RefreshNormalizationBatchJob | null> | null, callback?: λFunction<RefreshNormalizationBatchJob | null, RefreshNormalizationBatchJob | null> | null): ObjList<RefreshNormalizationBatchJob | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<RefreshNormalizationBatchJob | null> | null, callback?: λFunction<RefreshNormalizationBatchJob | null, RefreshNormalizationBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static doStart(job?: RefreshNormalizationBatchJob | null, options?: RefreshNormalizationSpec | null): void;
   ...
   */
  static processBatch(batch?: RefreshNormalizationSpec | null, job?: RefreshNormalizationBatchJob | null, options?: RefreshNormalizationSpec | null): void;
   ...
   */
  static allComplete(job: RefreshNormalizationBatchJob, options?: RefreshNormalizationSpec | null): string | null;
   ...
   *           Options the job was run with.
   */
  static failed(job: RefreshNormalizationBatchJob, status: BatchJobStatus, options?: RefreshNormalizationSpec | null): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: RefreshNormalizationSpec | null): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: C3.Array<RefreshNormalizationSpec | null>): void;
   ...
   */
  static scheduleObjBatch(job?: RefreshNormalizationBatchJob | null, objBatch?: ObjBatch | null, logPrefix?: string | null): number | null;
