// TypeScript definitions for the C3 type BufferedStream
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of BufferedStream
 */
declare interface IBufferedStream<E> {

  /**
   * Callback lambda on close of this stream
   */
  onClose?: λConsumer<BufferedStream<E> | null> | null;
}
 ...
 */
declare class BufferedStream<E> {

  /**
   * Callback lambda on close of this stream
   */
  readonly onClose?: λConsumer<BufferedStream<E> | null> | null;
  withOnClose(onClose: λConsumer<BufferedStream<E> | null> | null): BufferedStream;
   ...
   */
  mapToSame(mapper: λBiFunction<E | null, number | null, E | null>): BufferedStream<E> | null;
   ...
   */
  map(spec: FetchStreamSpec): BufferedStream<E> | null;
   ...
   */
  mapToStr(mapper: λBiFunction<E | null, number, string | null>): BufferedStream<string | null> | null;
   ...
   * such conversion.
   */
  mapTo(elementType: ValueType, mapper: λBiFunction<E | null, number, T | null>): BufferedStream<T> | null;
   ...
   */
  flatMapToSame(mapper: λBiFunction<E | null, number | null, BufferedStream<E> | null>): BufferedStream<E> | null;
   ...
   */
  flatMap(mapper: λBiFunction<E | null, number, BufferedStream<T> | null>): BufferedStream<T> | null;
   ...
   */
  flatMapTo(elementType: ValueType, mapper: λBiFunction<E | null, number, BufferedStream<T> | null>): BufferedStream<T> | null;
   ...
   */
  uniqueBy(key: λBiFunction<E | null, number | null, any>): BufferedStream<E> | null;
   ...
   */
  filter(predicate: λBiPredicate<E | null, number | null>): BufferedStream<E> | null;
   ...
   */
  reject(predicate: λBiPredicate<E | null, number | null>): BufferedStream<E> | null;
   ...
   * provided lambda.
   */
  sortedBy(key: λBiFunction<E | null, number | null, any>): BufferedStream<E> | null;

  /**
   * Maps this collection to another by re-ordering elements based on natural sorting order of a key computed using
   * provided lambda.
   */
  sortedBy(descending: boolean, key: λBiFunction<E | null, number | null, any>): BufferedStream<E> | null;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): BufferedStream<E> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): BufferedStream<E> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): BufferedStream<E> | null;
   ...
   * type and will return an instance of the correct type.
   */
  static deserialize(contentStr: string | null, contentType: string): BufferedStream<E> | null;
   ...
   */
  replaceType(old: Type, new_: Type): BufferedStream<E>;
   ...
   */
  inferType(): BufferedStream<E> | null;
   ...
   * elements.
   */
  toMixingCollection(collectionType: CollectionType, failIfInvalid?: boolean): BufferedStream<T> | null;
   ...
   */
  boxElements(): BufferedStream<Boxed<E> | null> | null;
   ...
   */
  anonymize(spec?: AnonymizationSpec | null): BufferedStream<E> | null;
   ...
   */
  withoutOutliers(spec?: OutliersSpec | null): BufferedStream<E>;
   ...
   * @param spec configuration of the high and low filter criteria
   */
  extractOutliers(spec?: OutliersSpec | null): BufferedStream<E>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): BufferedStream<E>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): BufferedStream<E> | null;
   ...
   *         point in the window starting at "offset" and spanning "span" data points.
   */
  rolling(agg: string, offset: number, span: number, step?: number | null): BufferedStream<E> | null;
   ...
   */
  replace(index: number, e: E | null): BufferedStream<E> | null;

  /**
   * Returns everything but the last N entries of the collection
   */
  initial(exceptLastN?: number): BufferedStream<E>;

  /**
   * Converts this collection into collection of pairs of neighboring elements.
   */
  pairs(): BufferedStream<Pair<E, E> | null> | null;
   ...
   */
  static of(elementType: ValueType, ...elements: T | null[]): BufferedStream<T> | null;

  /**
   * @return collection of any with provided elements.
   */
  static ofAny(...elements: T | null[]): BufferedStream<T> | null;

  /**
   * @return collection of provided booleans.
   */
  static ofBool(...elements: boolean[]): BufferedStream<boolean> | null;

  /**
   * @return collection of provided 64 bit integers.
   */
  static ofInt(...elements: number | null[]): BufferedStream<number | null> | null;

  /**
   * @return collection of provided 32 bit integers.
   */
  static ofInt32(...elements: number | null[]): BufferedStream<number | null> | null;

  /**
   * @return collection of provided 16 bit integers.
   */
  static ofInt16(...elements: number | null[]): BufferedStream<number | null> | null;

  /**
   * @return collection of provided floats.
   */
  static ofFloat(...elements: number | null[]): BufferedStream<number | null> | null;

  /**
   * @return collection of provided doubles.
   */
  static ofDbl(...elements: number | null[]): BufferedStream<number | null> | null;

  /**
   * @return collection of provided doubles.
   */
  static ofByte(...elements: number | null[]): BufferedStream<number | null> | null;

  /**
   * @return stream of bytes from a binary value
   */
  static ofByte(elements?: any | null): BufferedStream<number | null> | null;

  /**
   * @return collection of provided datetime.
   */
  static ofDateTime(...elements: DateTime | null[]): BufferedStream<DateTime | null> | null;

  /**
   * @return collection of provided string.
   */
  static ofStr(...strs: string | null[]): BufferedStream<string | null> | null;

  /**
   * @return collection of generic obj and provided instances.
   */
  static ofObj(...objs: Obj | null[]): BufferedStream<Obj | null> | null;

  /**
   * @return collection of provided C3 type and provided instances.
   */
  static ofObj(type: Type, ...objs: Obj | null[]): BufferedStream<O> | null;

  /**
   * @return collection of provided integers in a range.
   */
  static ofIntInRange(min: number, max: number, step?: number | null): BufferedStream<number> | null;

  /**
   * @return collection of provided integers in a range.
   */
  static ofInt32InRange(min: number, max: number, step?: number | null): BufferedStream<number> | null;
   ...
   */
  static fromHttpRequest(req: HttpRequest): BufferedStream<E>;
   ...
   */
  limit(limit: number | null): BufferedStream<E>;

  /**
   * Creates a new collection from limited number of elements of this collection. Limit is relative to the first
   * element in collection. If limit is not provided or is negative returns same collection.
   */
  limit(limit: number): BufferedStream<E>;

  /**
   * @return a new collection with the specified number of elements removed from the beginning of the stream.
   */
  offset(offset: number | null): BufferedStream<E>;

  /**
   * @return a new collection with the specified number of elements removed from the beginning of the stream.
   */
  offset(offset: number): BufferedStream<E>;
   ...
   */
  shuffle(windowSize?: number): BufferedStream<E>;
   ...
   */
  static make(elementType: ValueType, iter: Iterator<T>): BufferedStream<T> | null;
   ...
   */
  static make(elementType: ValueType, next: λSupplier<T | null>, close?: λNullConsumer | null): BufferedStream<T> | null;
   ...
   */
  static make(elementType: ValueType, initial: T | null, next: λBiFunction<T | null, number, T | null>, close?: λNullConsumer | null): BufferedStream<T> | null;
   ...
   */
  static make(elementType: ValueType, hasNext: λNullPredicate, next: λBiFunction<T | null, number, T | null>, close: λNullConsumer | null): BufferedStream<T> | null;
