// TypeScript definitions for the C3 type RunCreatedOrUpdatedBatchJob

/**
 * Batch job definitions for batch jobs started from RunCreatedOrUpdatedTask for asynchronous processing.
 *
 * @remarks this represents a value passed to a method that expects an instance of RunCreatedOrUpdatedBatchJob
 */
declare interface IRunCreatedOrUpdatedBatchJob {
 ...
 */
declare class RunCreatedOrUpdatedBatchJob extends Obj {

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun | null;
  withRun(run: IBatchJobRun | null): RunCreatedOrUpdatedBatchJob;

  /**
   * previous job executions for this instance
   */
  readonly runs?: C3.Array<BatchJobRun | null>;
  withRuns(runs: C3.Array<BatchJobRun | null> | Array<IBatchJobRun | null>): RunCreatedOrUpdatedBatchJob;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj | null;
  withOptions(options: IObj | null): RunCreatedOrUpdatedBatchJob;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): RunCreatedOrUpdatedBatchJob;
  ...
  withPriority(priority: number | null): RunCreatedOrUpdatedBatchJob;
  ...
  withDisabled(disabled: boolean): RunCreatedOrUpdatedBatchJob;
  ...
  withMaxConcurrency(maxConcurrency: number | null): RunCreatedOrUpdatedBatchJob;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): RunCreatedOrUpdatedBatchJob;
  ...
  withRunAsUser(runAsUser: boolean | null): RunCreatedOrUpdatedBatchJob;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string | null;
  withNodePool(nodePool: string | null): RunCreatedOrUpdatedBatchJob;
  ...
  withSkipIfRunning(skipIfRunning: boolean | null): RunCreatedOrUpdatedBatchJob;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number | null;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): RunCreatedOrUpdatedBatchJob;
  ...
  withPropagateActionContext(propagateActionContext: boolean): RunCreatedOrUpdatedBatchJob;
  ...
  withTypeIdent(typeIdent: string | null): RunCreatedOrUpdatedBatchJob;
   ...
   */
  readonly id: string;
  withId(id: string): RunCreatedOrUpdatedBatchJob;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): RunCreatedOrUpdatedBatchJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): RunCreatedOrUpdatedBatchJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): RunCreatedOrUpdatedBatchJob;
  ...
  withVersion(version: number | null): RunCreatedOrUpdatedBatchJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): RunCreatedOrUpdatedBatchJob;
  ...
  withAbortOnError(abortOnError: boolean): RunCreatedOrUpdatedBatchJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): RunCreatedOrUpdatedBatchJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): RunCreatedOrUpdatedBatchJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): RunCreatedOrUpdatedBatchJob | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): RunCreatedOrUpdatedBatchJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): RunCreatedOrUpdatedBatchJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): RunCreatedOrUpdatedBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): RunCreatedOrUpdatedBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<RunCreatedOrUpdatedBatchJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<RunCreatedOrUpdatedBatchJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): RunCreatedOrUpdatedBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RunCreatedOrUpdatedBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RunCreatedOrUpdatedBatchJob;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): RunCreatedOrUpdatedBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): RunCreatedOrUpdatedBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): RunCreatedOrUpdatedBatchJob;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): RunCreatedOrUpdatedBatchJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): RunCreatedOrUpdatedBatchJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): RunCreatedOrUpdatedBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): RunCreatedOrUpdatedBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): RunCreatedOrUpdatedBatchJob;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): RunCreatedOrUpdatedBatchJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): RunCreatedOrUpdatedBatchJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): RunCreatedOrUpdatedBatchJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): RunCreatedOrUpdatedBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): RunCreatedOrUpdatedBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): RunCreatedOrUpdatedBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): RunCreatedOrUpdatedBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): RunCreatedOrUpdatedBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): RunCreatedOrUpdatedBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): RunCreatedOrUpdatedBatchJob;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): RunCreatedOrUpdatedBatchJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): RunCreatedOrUpdatedBatchJob;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): RunCreatedOrUpdatedBatchJob;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): RunCreatedOrUpdatedBatchJob;

  mergeJson(json: any | null): RunCreatedOrUpdatedBatchJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): RunCreatedOrUpdatedBatchJob;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): RunCreatedOrUpdatedBatchJob;
   ...
   */
  singletonArray(): C3.Array<RunCreatedOrUpdatedBatchJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<RunCreatedOrUpdatedBatchJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<RunCreatedOrUpdatedBatchJob | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<RunCreatedOrUpdatedBatchJob | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<RunCreatedOrUpdatedBatchJob | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, RunCreatedOrUpdatedBatchJob | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, RunCreatedOrUpdatedBatchJob | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<RunCreatedOrUpdatedBatchJob | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<RunCreatedOrUpdatedBatchJob | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): RunCreatedOrUpdatedBatchJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): RunCreatedOrUpdatedBatchJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): RunCreatedOrUpdatedBatchJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): RunCreatedOrUpdatedBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): RunCreatedOrUpdatedBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): RunCreatedOrUpdatedBatchJob;
   ...
   * @see #fromString
   */
  static make(s: string | null): RunCreatedOrUpdatedBatchJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): RunCreatedOrUpdatedBatchJob;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): RunCreatedOrUpdatedBatchJob;
   ...
   */
  static cachedEmptyInst(): RunCreatedOrUpdatedBatchJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<RunCreatedOrUpdatedBatchJob>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): RunCreatedOrUpdatedBatchJob;
   ...
   */
  start(options?: RunCreatedOrUpdatedSpec | null): BatchJobStatus | null;
   ...
   */
  cleanup(options?: RunCreatedOrUpdatedSpec | null): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun | null, BatchJobStatus | null, RunCreatedOrUpdatedSpec | null> | null;

  failJob(run: JobRun<BatchJobStatusBase | null>): JobBase<BatchJobRun | null, BatchJobStatus | null, RunCreatedOrUpdatedSpec | null> | null;
  ...
  validateStart(options?: RunCreatedOrUpdatedSpec | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<RunCreatedOrUpdatedBatchJob | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<RunCreatedOrUpdatedBatchJob | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<RunCreatedOrUpdatedBatchJob | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<RunCreatedOrUpdatedBatchJob | null> | null>;
   ...
   */
  get(include?: string | null): RunCreatedOrUpdatedBatchJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): RunCreatedOrUpdatedBatchJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): RunCreatedOrUpdatedBatchJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): RunCreatedOrUpdatedBatchJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): RunCreatedOrUpdatedBatchJob;
   ...
   * @see #toString
   */
  static fromString(s: string | null): RunCreatedOrUpdatedBatchJob | null;
   ...
   */
  create(spec?: UpsertSpec | null): RunCreatedOrUpdatedBatchJob | null;
   ...
   */
  static createBatch(objs: C3.Array<RunCreatedOrUpdatedBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<RunCreatedOrUpdatedBatchJob | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<RunCreatedOrUpdatedBatchJob | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<RunCreatedOrUpdatedBatchJob | null> | null;
   ...
   */
  update(srcObj?: RunCreatedOrUpdatedBatchJob | null, spec?: UpsertSpec | null): RunCreatedOrUpdatedBatchJob | null;
   ...
   */
  upsert(srcObj?: RunCreatedOrUpdatedBatchJob | null, spec?: UpsertSpec | null): RunCreatedOrUpdatedBatchJob | null;
   ...
   */
  merge(spec?: MergeSpec | null): RunCreatedOrUpdatedBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): RunCreatedOrUpdatedBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): RunCreatedOrUpdatedBatchJob | null;
   ...
   */
  static updateBatch(objs: C3.Array<RunCreatedOrUpdatedBatchJob | null> | null, srcObjs?: C3.Array<RunCreatedOrUpdatedBatchJob | null>, spec?: UpsertSpec | null): ObjList<RunCreatedOrUpdatedBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<RunCreatedOrUpdatedBatchJob | null>>, spec?: UpsertSpec | null): ObjList<RunCreatedOrUpdatedBatchJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<RunCreatedOrUpdatedBatchJob | null> | null, srcObjs?: C3.Array<RunCreatedOrUpdatedBatchJob | null>, spec?: UpsertSpec | null): ObjList<RunCreatedOrUpdatedBatchJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<RunCreatedOrUpdatedBatchJob | null>>, spec?: UpsertSpec | null): ObjList<RunCreatedOrUpdatedBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<RunCreatedOrUpdatedBatchJob | null> | null, spec?: TouchSpec | null): ObjList<RunCreatedOrUpdatedBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<RunCreatedOrUpdatedBatchJob | null> | null, spec?: MergeSpec | null): ObjList<RunCreatedOrUpdatedBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<RunCreatedOrUpdatedBatchJob | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<RunCreatedOrUpdatedBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<RunCreatedOrUpdatedBatchJob | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<RunCreatedOrUpdatedBatchJob | null> | null;
   ...
   */
  static mergeAll(mergeObj: RunCreatedOrUpdatedBatchJob | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: RunCreatedOrUpdatedBatchJob | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<RunCreatedOrUpdatedBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<RunCreatedOrUpdatedBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<RunCreatedOrUpdatedBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<RunCreatedOrUpdatedBatchJob | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): RunCreatedOrUpdatedBatchJob | null;
   ...
   */
  static beforeCreate(objs: C3.Array<RunCreatedOrUpdatedBatchJob | null> | null): ObjList<RunCreatedOrUpdatedBatchJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<RunCreatedOrUpdatedBatchJob | null> | null): ObjList<RunCreatedOrUpdatedBatchJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<RunCreatedOrUpdatedBatchJob | null> | null): ObjList<RunCreatedOrUpdatedBatchJob | null>;
   ...
   */
  static afterCreate(objs: C3.Array<RunCreatedOrUpdatedBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<RunCreatedOrUpdatedBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<RunCreatedOrUpdatedBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<RunCreatedOrUpdatedBatchJob | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<RunCreatedOrUpdatedBatchJob | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): RunCreatedOrUpdatedBatchJob | null;
   ...
   */
  withoutIdentity(): RunCreatedOrUpdatedBatchJob | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<RunCreatedOrUpdatedBatchJob | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: RunCreatedOrUpdatedBatchJob | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<RunCreatedOrUpdatedBatchJob | null> | null, callback?: λFunction<RunCreatedOrUpdatedBatchJob | null, RunCreatedOrUpdatedBatchJob | null> | null): ObjList<RunCreatedOrUpdatedBatchJob | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<RunCreatedOrUpdatedBatchJob | null> | null, callback?: λFunction<RunCreatedOrUpdatedBatchJob | null, RunCreatedOrUpdatedBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static doStart(job?: RunCreatedOrUpdatedBatchJob | null, options?: RunCreatedOrUpdatedSpec | null): void;
   ...
   */
  static processBatch(batch?: RunCreatedOrUpdatedSpec | null, job?: RunCreatedOrUpdatedBatchJob | null, options?: RunCreatedOrUpdatedSpec | null): void;
   ...
   */
  static allComplete(job: RunCreatedOrUpdatedBatchJob, options?: RunCreatedOrUpdatedSpec | null): string | null;
   ...
   *           Options the job was run with.
   */
  static failed(job: RunCreatedOrUpdatedBatchJob, status: BatchJobStatus, options?: RunCreatedOrUpdatedSpec | null): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: RunCreatedOrUpdatedSpec | null): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: C3.Array<RunCreatedOrUpdatedSpec | null>): void;
   ...
   */
  static scheduleObjBatch(job?: RunCreatedOrUpdatedBatchJob | null, objBatch?: ObjBatch | null, logPrefix?: string | null): number | null;
