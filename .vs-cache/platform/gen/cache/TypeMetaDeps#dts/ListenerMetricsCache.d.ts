// TypeScript definitions for the C3 type ListenerMetricsCache

/**
 * Cache for basic SimpleMetric info
 *
 * @remarks this represents a value passed to a method that expects an instance of ListenerMetricsCache
 */
declare interface IListenerMetricsCache {
}
 ...
 */
declare class ListenerMetricsCache {
   ...
   */
  static get(key: string | null): ListenerMetricsCacheEntry | null;
   ...
   */
  static require(key: string | null): ListenerMetricsCacheEntry;
   ...
   */
  static put(key: string | null, value: ListenerMetricsCacheEntry | null): void;
   ...
   */
  static produce(key: string | null): ListenerMetricsCacheEntry | null;
   ...
   * should be cleared.
   */
  static produceAll(): C3.Map<string | null, ListenerMetricsCacheEntry | null>;

  /**
   * Optional override called when element is released from the cache. Should perform any external resources cleanup if
   * needed.
   */
  static release(key: string | null, value: ListenerMetricsCacheEntry | null): void;
   ...
   */
  static validate(value: ListenerMetricsCacheEntry | null): boolean;

  /**
   * @return All metrics used by analytics or metrics listener
   */
  static metrics(): ListenerMetricsCacheEntry;
   ...
   */
  static metricForNameAndSrcType(metricName: string, srcType: string): string | null;
   ...
   * @return Requested metric.
   */
  static metricForNameAndSrcTypeId(metricName: string, srcTypeId: number): string | null;

  /**
   * @return Ids of all metrics that have listeners.
   */
  static metricIds(): C3.Array<string | null>;
   ...
   */
  static metricIdsForSrcType(srcType: string): C3.Array<string | null>;
   ...
   */
  static metricsForSrcType(srcType?: Type | null, metricIds?: C3.Array<string | null>): C3.Array<SimpleMetric | null>;
   ...
   */
  static bwdDepsForType(type: Type): C3.Array<TypeBackwardDep | null>;
}
