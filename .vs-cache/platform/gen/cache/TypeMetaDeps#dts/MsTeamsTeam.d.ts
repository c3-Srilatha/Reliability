// TypeScript definitions for the C3 type MsTeamsTeam

/**
 * Config for teams in MsTeams
 * The incoming webhook connector needs to be created for the team-channel,
 * then create a MsteamsTeam config with team-name as identifier eg. MsTeamsTeam.make({name: "team-name"}) and
 * set config for channels.
 *
 * @remarks this represents a value passed to a method that expects an instance of MsTeamsTeam
 */
declare interface IMsTeamsTeam {
  ...
  /**
   * name of the team is used as the identifier to get MsTeamsteam config
   * eg: MsTeamsTeam.forConfigKey("jarvis-test3") where jarvis-test3 is the team name
   */
  name: string;

  /**
   * map of channel name: webhook
   */
  channels?: C3.Map<string | null, string | null> | {[key: string | null]: string | null};
}
 ...
 * set config for channels.
 *
 * @remarks this represents a made instance of MsTeamsTeam
 */
declare class MsTeamsTeam extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): MsTeamsTeam;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): MsTeamsTeam;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): MsTeamsTeam;
  ...
  withName(name: string): MsTeamsTeam;

  /**
   * map of channel name: webhook
   */
  readonly channels?: C3.Map<string | null, string | null>;
  withChannels(channels: C3.Map<string | null, string | null> | {[key: string | null]: string | null}): MsTeamsTeam;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): MsTeamsTeam | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): MsTeamsTeam | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): MsTeamsTeam | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): MsTeamsTeam | null;
   ...
   */
  replaceType(old: Type, new_: Type): MsTeamsTeam;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MsTeamsTeam;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MsTeamsTeam;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MsTeamsTeam | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MsTeamsTeam | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): MsTeamsTeam;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MsTeamsTeam;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MsTeamsTeam;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): MsTeamsTeam;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): MsTeamsTeam;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): MsTeamsTeam;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): MsTeamsTeam;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): MsTeamsTeam;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): MsTeamsTeam;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): MsTeamsTeam;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): MsTeamsTeam;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): MsTeamsTeam;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): MsTeamsTeam;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): MsTeamsTeam;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): MsTeamsTeam;
   ...
   * @see #unsetField
   */
  defaultField(field: string): MsTeamsTeam;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): MsTeamsTeam;
   ...
   * @see #removeField
   */
  unsetField(field: string): MsTeamsTeam;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): MsTeamsTeam;
   ...
   * @see #unsetField
   */
  removeField(field: string): MsTeamsTeam;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): MsTeamsTeam;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): MsTeamsTeam;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): MsTeamsTeam;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): MsTeamsTeam;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): MsTeamsTeam;

  mergeJson(json: any | null): MsTeamsTeam;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): MsTeamsTeam;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): MsTeamsTeam;
   ...
   */
  singletonArray(): C3.Array<MsTeamsTeam | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<MsTeamsTeam | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<MsTeamsTeam | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<MsTeamsTeam | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<MsTeamsTeam | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, MsTeamsTeam | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, MsTeamsTeam | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<MsTeamsTeam | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<MsTeamsTeam | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): MsTeamsTeam;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): MsTeamsTeam;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): MsTeamsTeam;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): MsTeamsTeam;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): MsTeamsTeam;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): MsTeamsTeam;
   ...
   * @see #fromString
   */
  static make(s: string | null): MsTeamsTeam | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): MsTeamsTeam;
   ...
   */
  static cachedEmptyInst(): MsTeamsTeam;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<MsTeamsTeam>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): MsTeamsTeam;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<MsTeamsTeam | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<MsTeamsTeam | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<MsTeamsTeam | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): MsTeamsTeam | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): MsTeamsTeam | null;
   ...
   * @see findByCacheKey
   */
  getCached(): MsTeamsTeam | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): MsTeamsTeam | null;
   ...
   */
  static produce(key: string): MsTeamsTeam | null;
   ...
   */
  static produceAll(): C3.Map<string | null, MsTeamsTeam | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, MsTeamsTeam | null>;
   ...
   */
  static forConfigKey(configKey: string | null): MsTeamsTeam | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<MsTeamsTeam | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: MsTeamsTeam, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: MsTeamsTeam, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): MsTeamsTeam | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): MsTeamsTeam | null;
   ...
   */
  static forName(name: string | null, failIfMissing?: boolean): MsTeamsTeam | null;
}
