// TypeScript definitions for the C3 type Data.Value

/**
 * @remarks this represents a value passed to a method that expects an instance of Data.Value
 */
...
/**
 * @remarks this represents a made instance of Data.Value
 */
declare namespace Data {
  export class Value extends Obj {
    ...
    withSTATELESS_CACHE(STATELESS_CACHE: string | null): Data.Value;
     ...
     */
    readonly this: any;
    withThis(this_: any): Data.Value;

    /**
     * Target action returning DataImpl
     */
    readonly action: string;
    withAction(action: string): Data.Value;

    /**
     * Applied arguments
     */
    readonly args?: C3.Map<string | null, any>;
    withArgs(args: C3.Map<string | null, any> | {[key: string | null]: any}): Data.Value;
    ...
    with_inferredOutType(_inferredOutType: C3.Map<string | null, ValueType | null> | {[key: string | null]: IValueType | null}): Data.Value;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.Value | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.Value | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.Value | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.Value | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.Value;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Value;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Value;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Value | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Value | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.Value;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Value;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Value;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.Value;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.Value;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.Value;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.Value;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.Value;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.Value;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.Value;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.Value;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.Value;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.Value;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.Value;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.Value;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.Value;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.Value;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.Value;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.Value;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.Value;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.Value;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.Value;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.Value;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.Value;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.Value;

    mergeJson(json: any | null): Data.Value;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.Value;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.Value;
     ...
     */
    singletonArray(): C3.Array<Data.Value | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.Value | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.Value | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.Value | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.Value | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.Value | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.Value | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.Value | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.Value | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.Value;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.Value;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.Value;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.Value;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.Value;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.Value;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.Value;
     ...
     */
    static cachedEmptyInst(): Data.Value;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.Value>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.Value;
     ...
     */
    static fromPySrc(pySrc: string, dfs?: C3.Set<DataImpl | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): Data.Value | null;
     ...
     */
    static _jsDataProxy(inst: any): Data.Value;
     ...
     */
    static create(this_: any, action: string, args?: C3.Map<string | null, any>): Data.Value;
