// TypeScript definitions for the C3 type JdbcConnectSpec

/**
 * Spec for Jdbc connection configuration.
 *
 * @remarks this represents a value passed to a method that expects an instance of JdbcConnectSpec
 */
declare interface IJdbcConnectSpec {
 ...
 */
declare class JdbcConnectSpec extends Obj {

  /**
   * The username used in basic credentials.
   */
  readonly username?: string | null;
  withUsername(username: string | null): JdbcConnectSpec;

  /**
   * The password used in basic credentials.
   */
  readonly password?: string | null;
  withPassword(password: string | null): JdbcConnectSpec;

  /**
   * For systems that have a secondary secret key that isn't the password (e.g. Salesforce/CosmosDb)
   */
  readonly secretKey?: string | null;
  withSecretKey(secretKey: string | null): JdbcConnectSpec;
  ...
  withProperties(properties: C3.Map<string | null, any> | {[key: string | null]: any}): JdbcConnectSpec;
  ...
  withSecretProperties(secretProperties: C3.Map<string | null, any> | {[key: string | null]: any}): JdbcConnectSpec;

  /**
   * The Url pointing to the database.
   */
  readonly url?: string | null;
  withUrl(url: string | null): JdbcConnectSpec;

  /**
   * Server address: (ex: 'localhost', 'some.company.com')
   */
  readonly serverEndpoint?: string | null;
  withServerEndpoint(serverEndpoint: string | null): JdbcConnectSpec;

  /**
   * Number of the listening port.
   */
  readonly port?: number | null;
  withPort(port: number | null): JdbcConnectSpec;

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): JdbcConnectSpec;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): JdbcConnectSpec;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): JdbcConnectSpec;

  /**
   * The id of this instance.
   */
  readonly id?: string | null;
  withId(id: string | null): JdbcConnectSpec;

  /**
   * Kerberos principal. Typical format is primary/instance@REALM. (ie. hive/_HOST/PRINCIPAL.COM)
   */
  readonly principal?: string | null;
  withPrincipal(principal: string | null): JdbcConnectSpec;
  ...
  withAdditionalConfigs(additionalConfigs: C3.Map<string | null, any> | {[key: string | null]: any}): JdbcConnectSpec;
  ...
  withKrbContentOrFileUrl(krbContentOrFileUrl: string | null): JdbcConnectSpec;
  ...
  withKeytabContent(keytabContent: string | null): JdbcConnectSpec;
  ...
  withKeytabFilePath(keytabFilePath: string | null): JdbcConnectSpec;
  ...
  withPluginId(pluginId: string | null): JdbcConnectSpec;

  /**
   * The base directory for this plugin. This directory is always on the local file system.
   */
  readonly pluginDir?: string | null;
  withPluginDir(pluginDir: string | null): JdbcConnectSpec;

  /**
   * During dev, this boolean property will be true.
   */
  readonly isDevPlugin?: boolean;
  withIsDevPlugin(isDevPlugin: boolean): JdbcConnectSpec;
  ...
  withPluginPaths(pluginPaths: C3.Array<string | null> | Array<string | null>): JdbcConnectSpec;

  /**
   * Kind of the {@link Datastore datastore}
   */
  readonly datastore?: string | null;
  withDatastore(datastore: string | null): JdbcConnectSpec;

  /**
   * Name of the database going to be connected. (ex: 'my_database_name')
   */
  readonly database?: string | null;
  withDatabase(database: string | null): JdbcConnectSpec;
  ...
  withSchemaName(schemaName: string | null): JdbcConnectSpec;
  ...
  withDriverClassName(driverClassName: string | null): JdbcConnectSpec;

  /**
   * Role used when auto-creating the db.
   */
  readonly role?: string | null;
  withRole(role: string | null): JdbcConnectSpec;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): JdbcConnectSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): JdbcConnectSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): JdbcConnectSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): JdbcConnectSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): JdbcConnectSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JdbcConnectSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JdbcConnectSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JdbcConnectSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JdbcConnectSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): JdbcConnectSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JdbcConnectSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JdbcConnectSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): JdbcConnectSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): JdbcConnectSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): JdbcConnectSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): JdbcConnectSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): JdbcConnectSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): JdbcConnectSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): JdbcConnectSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): JdbcConnectSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): JdbcConnectSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): JdbcConnectSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): JdbcConnectSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): JdbcConnectSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): JdbcConnectSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): JdbcConnectSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): JdbcConnectSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): JdbcConnectSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): JdbcConnectSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): JdbcConnectSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): JdbcConnectSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): JdbcConnectSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): JdbcConnectSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): JdbcConnectSpec;

  mergeJson(json: any | null): JdbcConnectSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): JdbcConnectSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): JdbcConnectSpec;
   ...
   */
  singletonArray(): C3.Array<JdbcConnectSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<JdbcConnectSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<JdbcConnectSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<JdbcConnectSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<JdbcConnectSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, JdbcConnectSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, JdbcConnectSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<JdbcConnectSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<JdbcConnectSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): JdbcConnectSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): JdbcConnectSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): JdbcConnectSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): JdbcConnectSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): JdbcConnectSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): JdbcConnectSpec;
   ...
   * @see #fromString
   */
  static make(s: string | null): JdbcConnectSpec | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): JdbcConnectSpec;
   ...
   */
  static cachedEmptyInst(): JdbcConnectSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<JdbcConnectSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): JdbcConnectSpec;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<JdbcConnectSpec | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<JdbcConnectSpec | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<JdbcConnectSpec | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): JdbcConnectSpec | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): JdbcConnectSpec | null;
   ...
   * @see findByCacheKey
   */
  getCached(): JdbcConnectSpec | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): JdbcConnectSpec | null;
   ...
   */
  static produce(key: string): JdbcConnectSpec | null;
   ...
   */
  static produceAll(): C3.Map<string | null, JdbcConnectSpec | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, JdbcConnectSpec | null>;
   ...
   */
  static forConfigKey(configKey: string | null): JdbcConnectSpec | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<JdbcConnectSpec | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: JdbcConnectSpec, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: JdbcConnectSpec, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): JdbcConnectSpec | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): JdbcConnectSpec | null;
   ...
   */
  static fromUrl(url: string, username?: string | null, password?: string | null): JdbcConnectSpec;
   ...
   * @return The constructed instance.
   */
  static fromServerEndpoint(serverEndpoint: string, port: number, datastoreType: string, database?: string | null, schemaName?: string | null, username?: string | null, password?: string | null): JdbcConnectSpec | null;
   ...
   */
  static fromCredentials(creds: JdbcCredentials): JdbcConnectSpec;
}
