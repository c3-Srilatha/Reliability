// TypeScript definitions for the C3 type Idp

/**
 * @remarks this represents a value passed to a method that expects an instance of Idp
 */
declare interface IIdp {
  ...
  cert?: IIdpCertificate | null;

  okta?: boolean;
}

/**
 * @remarks this represents a made instance of Idp
 */
declare class Idp extends Obj {
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Idp;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): Idp;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): Idp;
  ...
  withVersion(version: number | null): Idp;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): Idp;

  readonly authScheme?: string | null;
  withAuthScheme(authScheme: string | null): Idp;

  readonly ssoUrl?: string | null;
  withSsoUrl(ssoUrl: string | null): Idp;

  readonly sloUrl?: string | null;
  withSloUrl(sloUrl: string | null): Idp;

  readonly logOutUrl?: string | null;
  withLogOutUrl(logOutUrl: string | null): Idp;

  readonly issuer?: string | null;
  withIssuer(issuer: string | null): Idp;

  readonly cert?: IdpCertificate | null;
  withCert(cert: IIdpCertificate | null): Idp;

  readonly okta?: boolean;
  withOkta(okta: boolean): Idp;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Idp | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Idp | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Idp | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Idp | null;
   ...
   */
  replaceType(old: Type, new_: Type): Idp;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Idp;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Idp;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Idp | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Idp | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Idp;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Idp;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Idp;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Idp;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Idp;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Idp;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Idp;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Idp;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Idp;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Idp;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Idp;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Idp;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Idp;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Idp;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Idp;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Idp;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Idp;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Idp;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Idp;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Idp;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Idp;

  mergeJson(json: any | null): Idp;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Idp;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Idp;
   ...
   */
  singletonArray(): C3.Array<Idp | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Idp | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Idp | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Idp | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Idp | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Idp | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Idp | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Idp | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Idp | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Idp;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Idp;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Idp;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Idp;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Idp;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Idp;
   ...
   * @see #fromString
   */
  static make(s: string | null): Idp | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Idp;
   ...
   */
  static cachedEmptyInst(): Idp;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Idp>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Idp;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<Idp | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<Idp | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Idp | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Idp | null> | null>;
   ...
   */
  get(include?: string | null): Idp | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): Idp | null;
   ...
   */
  getMissing(spec: GetMissingSpec): Idp;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): Idp | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): Idp;
   ...
   * @see #toString
   */
  static fromString(s: string | null): Idp | null;
   ...
   */
  create(spec?: UpsertSpec | null): Idp | null;
   ...
   */
  static createBatch(objs: C3.Array<Idp | null> | null, spec?: UpsertSpec | null): ObjList<Idp | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<Idp | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Idp | null> | null;
   ...
   */
  update(srcObj?: Idp | null, spec?: UpsertSpec | null): Idp | null;
   ...
   */
  upsert(srcObj?: Idp | null, spec?: UpsertSpec | null): Idp | null;
   ...
   */
  merge(spec?: MergeSpec | null): Idp | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): Idp | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): Idp | null;
   ...
   */
  static updateBatch(objs: C3.Array<Idp | null> | null, srcObjs?: C3.Array<Idp | null>, spec?: UpsertSpec | null): ObjList<Idp | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<Idp | null>>, spec?: UpsertSpec | null): ObjList<Idp | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<Idp | null> | null, srcObjs?: C3.Array<Idp | null>, spec?: UpsertSpec | null): ObjList<Idp | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<Idp | null>>, spec?: UpsertSpec | null): ObjList<Idp | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<Idp | null> | null, spec?: TouchSpec | null): ObjList<Idp | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Idp | null> | null, spec?: MergeSpec | null): ObjList<Idp | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Idp | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Idp | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<Idp | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Idp | null> | null;
   ...
   */
  static mergeAll(mergeObj: Idp | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: Idp | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<Idp | null> | null, spec?: UpsertSpec | null): ObjList<Idp | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<Idp | null> | null, spec?: UpsertSpec | null): ObjList<Idp | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<Idp | null> | null): ObjList<Idp | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<Idp | null> | null): ObjList<Idp | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<Idp | null> | null): ObjList<Idp | null>;
   ...
   */
  static afterCreate(objs: C3.Array<Idp | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<Idp | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<Idp | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<Idp | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Idp | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): Idp | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<Idp | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: Idp | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<Idp | null> | null, callback?: λFunction<Idp | null, Idp | null> | null): ObjList<Idp | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<Idp | null> | null, callback?: λFunction<Idp | null, Idp | null> | null): C3.Array<ObjError | null>;
