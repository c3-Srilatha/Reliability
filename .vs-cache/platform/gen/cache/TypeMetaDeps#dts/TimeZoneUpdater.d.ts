// TypeScript definitions for the C3 type TimeZoneUpdater

/**
 * @remarks this represents a value passed to a method that expects an instance of TimeZoneUpdater
 */
declare interface ITimeZoneUpdater {
   ...
   */
  targetFilter?: IWeatherStation | null;
}

/**
 * @remarks this represents a made instance of TimeZoneUpdater
 */
declare class TimeZoneUpdater extends Obj {

  /**
   * current or last job execution for this instance
   */
  readonly run?: MapReduceRun | null;
  withRun(run: IMapReduceRun | null): TimeZoneUpdater;

  /**
   * previous job executions for this instance
   */
  readonly runs?: C3.Array<MapReduceRun | null>;
  withRuns(runs: C3.Array<MapReduceRun | null> | Array<IMapReduceRun | null>): TimeZoneUpdater;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj | null;
  withOptions(options: IObj | null): TimeZoneUpdater;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): TimeZoneUpdater;
  ...
  withPriority(priority: number | null): TimeZoneUpdater;
  ...
  withDisabled(disabled: boolean): TimeZoneUpdater;
  ...
  withMaxConcurrency(maxConcurrency: number | null): TimeZoneUpdater;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): TimeZoneUpdater;
  ...
  withRunAsUser(runAsUser: boolean | null): TimeZoneUpdater;

  /**
   * Don't set this field in the MapReduce job, set it in the MapReduceOptions when calling `start`.
   */
  readonly nodePool?: string | null;
  withNodePool(nodePool: string | null): TimeZoneUpdater;
  ...
  withSkipIfRunning(skipIfRunning: boolean | null): TimeZoneUpdater;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number | null;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): TimeZoneUpdater;
  ...
  withPropagateActionContext(propagateActionContext: boolean): TimeZoneUpdater;
  ...
  withTargetType(targetType: IType | null): TimeZoneUpdater;
  ...
  withUseFileSystemForInterVals(useFileSystemForInterVals: boolean): TimeZoneUpdater;
  ...
  withUseBatchIdsForReadInput(useBatchIdsForReadInput: boolean): TimeZoneUpdater;
  ...
  withInclude(include: string | null): TimeZoneUpdater;

  /**
   * optional filter spec
   */
  readonly filter?: string | null;
  withFilter(filter: string | null): TimeZoneUpdater;
  ...
  withOrder(order: string | null): TimeZoneUpdater;
  ...
  withLimit(limit: number | null): TimeZoneUpdater;
  ...
  withSamplePct(samplePct: number | null): TimeZoneUpdater;
  ...
  withBatchSize(batchSize: number | null): TimeZoneUpdater;
  ...
  withSubBatchSize(subBatchSize: number | null): TimeZoneUpdater;
  ...
  withNumBatches(numBatches: number | null): TimeZoneUpdater;
  ...
  withAbortOnError(abortOnError: boolean): TimeZoneUpdater;
  ...
  withTypeIdent(typeIdent: string | null): TimeZoneUpdater;
   ...
   */
  readonly id: string;
  withId(id: string): TimeZoneUpdater;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): TimeZoneUpdater;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): TimeZoneUpdater;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): TimeZoneUpdater;
  ...
  withVersion(version: number | null): TimeZoneUpdater;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): TimeZoneUpdater;

  /**
   * Optional target type instance to be used as the filter for the job.  When specified, the {~link map} function will
   * only be called for that obj.
   */
  readonly targetFilter?: WeatherStation | null;
  withTargetFilter(targetFilter: IWeatherStation | null): TimeZoneUpdater;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TimeZoneUpdater | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TimeZoneUpdater | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TimeZoneUpdater | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TimeZoneUpdater | null;
   ...
   */
  replaceType(old: Type, new_: Type): TimeZoneUpdater;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TimeZoneUpdater;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TimeZoneUpdater;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TimeZoneUpdater | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TimeZoneUpdater | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TimeZoneUpdater;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TimeZoneUpdater;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TimeZoneUpdater;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TimeZoneUpdater;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TimeZoneUpdater;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TimeZoneUpdater;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TimeZoneUpdater;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TimeZoneUpdater;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TimeZoneUpdater;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TimeZoneUpdater;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TimeZoneUpdater;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TimeZoneUpdater;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TimeZoneUpdater;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TimeZoneUpdater;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TimeZoneUpdater;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TimeZoneUpdater;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TimeZoneUpdater;
   ...
   * @see #removeField
   */
  unsetField(field: string): TimeZoneUpdater;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TimeZoneUpdater;
   ...
   * @see #unsetField
   */
  removeField(field: string): TimeZoneUpdater;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TimeZoneUpdater;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TimeZoneUpdater;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TimeZoneUpdater;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TimeZoneUpdater;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TimeZoneUpdater;

  mergeJson(json: any | null): TimeZoneUpdater;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TimeZoneUpdater;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TimeZoneUpdater;
   ...
   */
  singletonArray(): C3.Array<TimeZoneUpdater | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TimeZoneUpdater | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TimeZoneUpdater | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TimeZoneUpdater | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TimeZoneUpdater | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TimeZoneUpdater | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TimeZoneUpdater | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TimeZoneUpdater | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TimeZoneUpdater | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TimeZoneUpdater;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TimeZoneUpdater;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TimeZoneUpdater;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TimeZoneUpdater;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TimeZoneUpdater;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TimeZoneUpdater;
   ...
   * @see #fromString
   */
  static make(s: string | null): TimeZoneUpdater | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TimeZoneUpdater;
   ...
   */
  static cachedEmptyInst(): TimeZoneUpdater;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TimeZoneUpdater>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TimeZoneUpdater;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TimeZoneUpdater | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TimeZoneUpdater | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TimeZoneUpdater | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TimeZoneUpdater | null> | null>;
   ...
   */
  get(include?: string | null): TimeZoneUpdater | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TimeZoneUpdater | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TimeZoneUpdater;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TimeZoneUpdater | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TimeZoneUpdater;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TimeZoneUpdater | null;
   ...
   */
  create(spec?: UpsertSpec | null): TimeZoneUpdater | null;
   ...
   */
  static createBatch(objs: C3.Array<TimeZoneUpdater | null> | null, spec?: UpsertSpec | null): ObjList<TimeZoneUpdater | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TimeZoneUpdater | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TimeZoneUpdater | null> | null;
   ...
   */
  update(srcObj?: TimeZoneUpdater | null, spec?: UpsertSpec | null): TimeZoneUpdater | null;
   ...
   */
  upsert(srcObj?: TimeZoneUpdater | null, spec?: UpsertSpec | null): TimeZoneUpdater | null;
   ...
   */
  merge(spec?: MergeSpec | null): TimeZoneUpdater | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TimeZoneUpdater | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TimeZoneUpdater | null;
   ...
   */
  static updateBatch(objs: C3.Array<TimeZoneUpdater | null> | null, srcObjs?: C3.Array<TimeZoneUpdater | null>, spec?: UpsertSpec | null): ObjList<TimeZoneUpdater | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TimeZoneUpdater | null>>, spec?: UpsertSpec | null): ObjList<TimeZoneUpdater | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TimeZoneUpdater | null> | null, srcObjs?: C3.Array<TimeZoneUpdater | null>, spec?: UpsertSpec | null): ObjList<TimeZoneUpdater | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TimeZoneUpdater | null>>, spec?: UpsertSpec | null): ObjList<TimeZoneUpdater | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TimeZoneUpdater | null> | null, spec?: TouchSpec | null): ObjList<TimeZoneUpdater | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TimeZoneUpdater | null> | null, spec?: MergeSpec | null): ObjList<TimeZoneUpdater | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TimeZoneUpdater | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TimeZoneUpdater | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TimeZoneUpdater | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TimeZoneUpdater | null> | null;
   ...
   */
  static mergeAll(mergeObj: TimeZoneUpdater | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TimeZoneUpdater | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TimeZoneUpdater | null> | null, spec?: UpsertSpec | null): ObjList<TimeZoneUpdater | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TimeZoneUpdater | null> | null, spec?: UpsertSpec | null): ObjList<TimeZoneUpdater | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TimeZoneUpdater | null> | null): ObjList<TimeZoneUpdater | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TimeZoneUpdater | null> | null): ObjList<TimeZoneUpdater | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TimeZoneUpdater | null> | null): ObjList<TimeZoneUpdater | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TimeZoneUpdater | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TimeZoneUpdater | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TimeZoneUpdater | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TimeZoneUpdater | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TimeZoneUpdater | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TimeZoneUpdater | null;
   ...
   */
  withoutIdentity(): TimeZoneUpdater | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<TimeZoneUpdater | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TimeZoneUpdater | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TimeZoneUpdater | null> | null, callback?: λFunction<TimeZoneUpdater | null, TimeZoneUpdater | null> | null): ObjList<TimeZoneUpdater | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TimeZoneUpdater | null> | null, callback?: λFunction<TimeZoneUpdater | null, TimeZoneUpdater | null> | null): C3.Array<ObjError | null>;
   ...
   *         key type.
   */
  static map(batch?: number | null, objs?: C3.Array<WeatherStation | null>, job?: MapReduce<WeatherStation | null, number | null, number | null, number | null> | null, subBatch?: number | null): C3.Map<number | null, number | null>;
   ...
   */
  static reduce(outKey?: number | null, interValues?: C3.Array<number | null>, job?: MapReduce<WeatherStation | null, number | null, number | null, number | null> | null): number | null | C3.Array<number | null> | null;
   ...
   */
  static mapCompleted(job?: MapReduce<WeatherStation | null, number | null, number | null, number | null> | null): void;
   ...
   */
  static completed(job?: MapReduce<WeatherStation | null, number | null, number | null, number | null> | null): string | null;
   ...
   */
  static failed(job: MapReduce<WeatherStation | null, number | null, number | null, number | null>, status: MapReduceStatus, options?: MapReduceOptions | null): void;
   ...
   */
  static updateTZ(): TimeZoneUpdater | null;
   ...
   * @return The MapReduce job information.
   */
  static updateTZStatus(): MapReduceStatus | null;
}
