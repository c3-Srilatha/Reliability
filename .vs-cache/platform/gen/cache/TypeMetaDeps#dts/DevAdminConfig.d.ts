// TypeScript definitions for the C3 type DevAdminConfig

/**
 * @remarks this represents a value passed to a method that expects an instance of DevAdminConfig
 */
declare interface IDevAdminConfig {
...
/**
 * @remarks this represents a made instance of DevAdminConfig
 */
declare class DevAdminConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): DevAdminConfig;

  static readonly configOverride?: string | null;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): DevAdminConfig;
  ...
  withIssues(issues: C3.Array<string | null> | Array<string | null>): DevAdminConfig;
  ...
  withUrl(url: string | null): DevAdminConfig;

  static readonly url?: string | null;

  readonly auth?: string | null;
  withAuth(auth: string | null): DevAdminConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): DevAdminConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): DevAdminConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): DevAdminConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): DevAdminConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): DevAdminConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): DevAdminConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DevAdminConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DevAdminConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DevAdminConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DevAdminConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DevAdminConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DevAdminConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DevAdminConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DevAdminConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DevAdminConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DevAdminConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DevAdminConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DevAdminConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DevAdminConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DevAdminConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DevAdminConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): DevAdminConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DevAdminConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): DevAdminConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DevAdminConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): DevAdminConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DevAdminConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DevAdminConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DevAdminConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DevAdminConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DevAdminConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): DevAdminConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): DevAdminConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): DevAdminConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): DevAdminConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): DevAdminConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): DevAdminConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): DevAdminConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DevAdminConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DevAdminConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DevAdminConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): DevAdminConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DevAdminConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DevAdminConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DevAdminConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): DevAdminConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DevAdminConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): DevAdminConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): DevAdminConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): DevAdminConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DevAdminConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): DevAdminConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): DevAdminConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): DevAdminConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DevAdminConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): DevAdminConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DevAdminConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DevAdminConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): DevAdminConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): DevAdminConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DevAdminConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DevAdminConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DevAdminConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DevAdminConfig;

  mergeJson(json: any | null): DevAdminConfig;

  static mergeJson(json: any | null): DevAdminConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DevAdminConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DevAdminConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): DevAdminConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): DevAdminConfig;
   ...
   */
  singletonArray(): C3.Array<DevAdminConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<DevAdminConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<DevAdminConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DevAdminConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<DevAdminConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<DevAdminConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DevAdminConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, DevAdminConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DevAdminConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DevAdminConfig | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<DevAdminConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DevAdminConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DevAdminConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DevAdminConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DevAdminConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DevAdminConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DevAdminConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DevAdminConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DevAdminConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): DevAdminConfig;
   ...
   */
  static cachedEmptyInst(): DevAdminConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DevAdminConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): DevAdminConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<DevAdminConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<DevAdminConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<DevAdminConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): DevAdminConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): DevAdminConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): DevAdminConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): DevAdminConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): DevAdminConfig | null;
   ...
   */
  static produce(key: string): DevAdminConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, DevAdminConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, DevAdminConfig | null>;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): DevAdminConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): DevAdminConfig;
   ...
   */
  static forConfigKey(configKey: string | null): DevAdminConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<DevAdminConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: DevAdminConfig, override?: string | null): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: DevAdminConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: DevAdminConfig, override?: string | null): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: DevAdminConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): DevAdminConfig | null;
   ...
   */
  removeSecrets(): DevAdminConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): DevAdminConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): DevAdminConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): DevAdminConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): DevAdminConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): DevAdminConfig;
