// TypeScript definitions for the C3 type DataGen
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of DataGen
 */
declare interface IDataGen<T> {
 ...
 */
declare class DataGen<T> extends Obj {

  /**
   * Value type for generated values.
   */
  valueType?: ValueType | null;
  withValueType(valueType: IValueType | null): DataGen;
   ...
   */
  example?: boolean;
  withExample(example: boolean): DataGen;
   ...
   */
  seed?: number | null;
  withSeed(seed: number | null): DataGen;

  /**
   * Construct an instance with initial state.
   */
  static make(): DataGen<T>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DataGen<T>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DataGen<T>;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DataGen<T>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DataGen<T>;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): DataGen<T> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): DataGen<T> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): DataGen<T> | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): DataGen<T> | null;
   ...
   */
  replaceType(old: Type, new_: Type): DataGen<T>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataGen<T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataGen<T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataGen<T> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataGen<T> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataGen<T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataGen<T>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataGen<T>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DataGen<T>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DataGen<T>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DataGen<T>;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataGen<T>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataGen<T>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DataGen<T>;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): DataGen<T>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): DataGen<T>;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): DataGen<T>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataGen<T>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DataGen<T>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataGen<T>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DataGen<T>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DataGen<T>;
   ...
   * @see #removeField
   */
  unsetField(field: string): DataGen<T>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DataGen<T>;
   ...
   * @see #unsetField
   */
  removeField(field: string): DataGen<T>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DataGen<T>;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataGen<T>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): DataGen<T>;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataGen<T>;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataGen<T>;

  mergeJson(json: any | null): DataGen<T>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataGen<T>;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): DataGen<T>;
   ...
   */
  singletonArray(): C3.Array<DataGen<T> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<DataGen<T> | null>;
   ...
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DataGen<T> | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<DataGen<T> | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DataGen<T> | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, DataGen<T> | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataGen<T> | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DataGen<T> | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DataGen<T> | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DataGen<T>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DataGen<T>;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DataGen<T>;
   ...
   */
  static cachedEmptyInst(): DataGen<T>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DataGen<T>>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): DataGen<T>;
   ...
   * @return this Obj
   */
  setField(field: string, value: any, doNotConvert?: boolean): DataGen<T>;
   ...
   * @return this Obj
   */
  setField(field: FieldType, value: any, doNotConvert?: boolean): DataGen<T>;
   ...
   */
  static forType(valueType: ValueType, parent?: DataGen<any> | null): DataGen<V> | null;
