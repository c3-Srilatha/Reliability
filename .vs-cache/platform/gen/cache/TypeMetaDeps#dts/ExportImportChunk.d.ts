// TypeScript definitions for the C3 type ExportImportChunk

/**
 * @remarks this represents a value passed to a method that expects an instance of ExportImportChunk
 */
declare interface IExportImportChunk {

  /**
   * Set to hash of the path of the file prefixed with the job type name
   */
  id: string;
  ...
  /**
   * Url of the file exported/imported
   */
  url?: string | null;

  /**
   * Id of the parent batch process
   */
  ...
  /**
   * Obj ids of targetType instances that the chunk processes
   * It will be populated if
   */
  ids?: C3.Array<string | null> | Array<string | null>;

  /**
   * obj id of targetType instance that marks the start of chunk (inclusive)
   */
  startId?: string | null;

  /**
   * obj id of targetType instance that marks the end of chunk (exclusive)
   */
  endId?: string | null;

  exportStats?: IActionStats | null;

  importStats?: IActionStats | null;
}

/**
 * @remarks this represents a made instance of ExportImportChunk
 */
declare class ExportImportChunk extends Obj {

  /**
   * Set to hash of the path of the file prefixed with the job type name
   */
  readonly id: string;
  withId(id: string): ExportImportChunk;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): ExportImportChunk;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): ExportImportChunk;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): ExportImportChunk;
  ...
  withVersion(version: number | null): ExportImportChunk;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): ExportImportChunk;

  /**
   * Url of the file exported/imported
   */
  readonly url?: string | null;
  withUrl(url: string | null): ExportImportChunk;

  /**
   * Id of the parent batch process
   */
  readonly parentId?: string | null;
  withParentId(parentId: string | null): ExportImportChunk;

  readonly targetType: Type;
  withTargetType(targetType: IType): ExportImportChunk;
  ...
  withIds(ids: C3.Array<string | null> | Array<string | null>): ExportImportChunk;

  /**
   * obj id of targetType instance that marks the start of chunk (inclusive)
   */
  readonly startId?: string | null;
  withStartId(startId: string | null): ExportImportChunk;

  /**
   * obj id of targetType instance that marks the end of chunk (exclusive)
   */
  readonly endId?: string | null;
  withEndId(endId: string | null): ExportImportChunk;

  readonly exportStats?: ActionStats | null;
  withExportStats(exportStats: IActionStats | null): ExportImportChunk;

  readonly importStats?: ActionStats | null;
  withImportStats(importStats: IActionStats | null): ExportImportChunk;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ExportImportChunk | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ExportImportChunk | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ExportImportChunk | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ExportImportChunk | null;
   ...
   */
  replaceType(old: Type, new_: Type): ExportImportChunk;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ExportImportChunk;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ExportImportChunk;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ExportImportChunk | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ExportImportChunk | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ExportImportChunk;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ExportImportChunk;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ExportImportChunk;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ExportImportChunk;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ExportImportChunk;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ExportImportChunk;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ExportImportChunk;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ExportImportChunk;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ExportImportChunk;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ExportImportChunk;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ExportImportChunk;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ExportImportChunk;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ExportImportChunk;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ExportImportChunk;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ExportImportChunk;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ExportImportChunk;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ExportImportChunk;
   ...
   * @see #removeField
   */
  unsetField(field: string): ExportImportChunk;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ExportImportChunk;
   ...
   * @see #unsetField
   */
  removeField(field: string): ExportImportChunk;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ExportImportChunk;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ExportImportChunk;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ExportImportChunk;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ExportImportChunk;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ExportImportChunk;

  mergeJson(json: any | null): ExportImportChunk;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ExportImportChunk;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ExportImportChunk;
   ...
   */
  singletonArray(): C3.Array<ExportImportChunk | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ExportImportChunk | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ExportImportChunk | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ExportImportChunk | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ExportImportChunk | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ExportImportChunk | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ExportImportChunk | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ExportImportChunk | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ExportImportChunk | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ExportImportChunk;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ExportImportChunk;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ExportImportChunk;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ExportImportChunk;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ExportImportChunk;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ExportImportChunk;
   ...
   * @see #fromString
   */
  static make(s: string | null): ExportImportChunk | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ExportImportChunk;
   ...
   */
  static cachedEmptyInst(): ExportImportChunk;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ExportImportChunk>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ExportImportChunk;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<ExportImportChunk | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ExportImportChunk | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<ExportImportChunk | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<ExportImportChunk | null> | null>;
   ...
   */
  get(include?: string | null): ExportImportChunk | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): ExportImportChunk | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ExportImportChunk;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): ExportImportChunk | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ExportImportChunk;
   ...
   * @see #toString
   */
  static fromString(s: string | null): ExportImportChunk | null;
   ...
   */
  create(spec?: UpsertSpec | null): ExportImportChunk | null;
   ...
   */
  static createBatch(objs: C3.Array<ExportImportChunk | null> | null, spec?: UpsertSpec | null): ObjList<ExportImportChunk | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ExportImportChunk | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<ExportImportChunk | null> | null;
   ...
   */
  update(srcObj?: ExportImportChunk | null, spec?: UpsertSpec | null): ExportImportChunk | null;
   ...
   */
  upsert(srcObj?: ExportImportChunk | null, spec?: UpsertSpec | null): ExportImportChunk | null;
   ...
   */
  merge(spec?: MergeSpec | null): ExportImportChunk | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): ExportImportChunk | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): ExportImportChunk | null;
   ...
   */
  static updateBatch(objs: C3.Array<ExportImportChunk | null> | null, srcObjs?: C3.Array<ExportImportChunk | null>, spec?: UpsertSpec | null): ObjList<ExportImportChunk | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<ExportImportChunk | null>>, spec?: UpsertSpec | null): ObjList<ExportImportChunk | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<ExportImportChunk | null> | null, srcObjs?: C3.Array<ExportImportChunk | null>, spec?: UpsertSpec | null): ObjList<ExportImportChunk | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<ExportImportChunk | null>>, spec?: UpsertSpec | null): ObjList<ExportImportChunk | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<ExportImportChunk | null> | null, spec?: TouchSpec | null): ObjList<ExportImportChunk | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<ExportImportChunk | null> | null, spec?: MergeSpec | null): ObjList<ExportImportChunk | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<ExportImportChunk | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<ExportImportChunk | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<ExportImportChunk | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<ExportImportChunk | null> | null;
   ...
   */
  static mergeAll(mergeObj: ExportImportChunk | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ExportImportChunk | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<ExportImportChunk | null> | null, spec?: UpsertSpec | null): ObjList<ExportImportChunk | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<ExportImportChunk | null> | null, spec?: UpsertSpec | null): ObjList<ExportImportChunk | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): ExportImportChunk | null;
   ...
   */
  static beforeCreate(objs: C3.Array<ExportImportChunk | null> | null): ObjList<ExportImportChunk | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<ExportImportChunk | null> | null): ObjList<ExportImportChunk | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<ExportImportChunk | null> | null): ObjList<ExportImportChunk | null>;
   ...
   */
  static afterCreate(objs: C3.Array<ExportImportChunk | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<ExportImportChunk | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<ExportImportChunk | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<ExportImportChunk | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<ExportImportChunk | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): ExportImportChunk | null;
   ...
   */
  withoutIdentity(): ExportImportChunk | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<ExportImportChunk | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: ExportImportChunk | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<ExportImportChunk | null> | null, callback?: λFunction<ExportImportChunk | null, ExportImportChunk | null> | null): ObjList<ExportImportChunk | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<ExportImportChunk | null> | null, callback?: λFunction<ExportImportChunk | null, ExportImportChunk | null> | null): C3.Array<ObjError | null>;
