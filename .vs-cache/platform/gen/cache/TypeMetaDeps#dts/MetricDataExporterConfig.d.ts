// TypeScript definitions for the C3 type MetricDataExporterConfig

/**
 * Config for V7's TenantConfig data exporter related fields: 'DataExporter-S3Path' and 'DataExporter-IgnoredTypes',
 * respectively.
 *
 * @remarks this represents a value passed to a method that expects an instance of MetricDataExporterConfig
 */
declare interface IMetricDataExporterConfig {
  ...
  /**
   * S3 path to export data to
   */
  path?: string | null;

  /**
   * Array of type names to ignore
   */
  ignoredTypes?: C3.Array<string | null> | Array<string | null>;
}
 ...
 * respectively.
 *
 * @remarks this represents a made instance of MetricDataExporterConfig
 */
declare class MetricDataExporterConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): MetricDataExporterConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): MetricDataExporterConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): MetricDataExporterConfig;

  /**
   * S3 path to export data to
   */
  readonly path?: string | null;
  withPath(path: string | null): MetricDataExporterConfig;

  /**
   * Array of type names to ignore
   */
  readonly ignoredTypes?: C3.Array<string | null>;
  withIgnoredTypes(ignoredTypes: C3.Array<string | null> | Array<string | null>): MetricDataExporterConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): MetricDataExporterConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): MetricDataExporterConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): MetricDataExporterConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): MetricDataExporterConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): MetricDataExporterConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MetricDataExporterConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MetricDataExporterConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MetricDataExporterConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MetricDataExporterConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): MetricDataExporterConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MetricDataExporterConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MetricDataExporterConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): MetricDataExporterConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): MetricDataExporterConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): MetricDataExporterConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): MetricDataExporterConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): MetricDataExporterConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): MetricDataExporterConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): MetricDataExporterConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): MetricDataExporterConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): MetricDataExporterConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): MetricDataExporterConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): MetricDataExporterConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): MetricDataExporterConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): MetricDataExporterConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): MetricDataExporterConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): MetricDataExporterConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): MetricDataExporterConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): MetricDataExporterConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): MetricDataExporterConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): MetricDataExporterConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): MetricDataExporterConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): MetricDataExporterConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): MetricDataExporterConfig;

  mergeJson(json: any | null): MetricDataExporterConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): MetricDataExporterConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): MetricDataExporterConfig;
   ...
   */
  singletonArray(): C3.Array<MetricDataExporterConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<MetricDataExporterConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<MetricDataExporterConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<MetricDataExporterConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<MetricDataExporterConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, MetricDataExporterConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, MetricDataExporterConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<MetricDataExporterConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<MetricDataExporterConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): MetricDataExporterConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): MetricDataExporterConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): MetricDataExporterConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): MetricDataExporterConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): MetricDataExporterConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): MetricDataExporterConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): MetricDataExporterConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): MetricDataExporterConfig;
   ...
   */
  static cachedEmptyInst(): MetricDataExporterConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<MetricDataExporterConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): MetricDataExporterConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<MetricDataExporterConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<MetricDataExporterConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<MetricDataExporterConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): MetricDataExporterConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): MetricDataExporterConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): MetricDataExporterConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): MetricDataExporterConfig | null;
   ...
   */
  static produce(key: string): MetricDataExporterConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, MetricDataExporterConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, MetricDataExporterConfig | null>;
   ...
   */
  getConfig(): MetricDataExporterConfig;
   ...
   */
  getSecret(): MetricDataExporterConfig;
   ...
   */
  static forConfigKey(configKey: string | null): MetricDataExporterConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<MetricDataExporterConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: MetricDataExporterConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: MetricDataExporterConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): MetricDataExporterConfig | null;
