// TypeScript definitions for the C3 type Alert

/**
 * An alert is a single message intended to communicate something that needs investigation to
 * users of the system.
 *
 * @remarks this represents a value passed to a method that expects an instance of Alert
 */
declare interface IAlert {
  ...
  /**
   * analytic category of this alert
   */
  analyticCategory?: string | null;

  /**
   * specific analytic result that triggered this alert
   */
  analyticResult?: IObj | null;

  /**
   * specific source object for which the alert was triggered
   */
  source?: IObj | null;

  /**
   * required importance of the alert
   */
  importance: string;
  ...
  /**
   * user accepting/dismissing the alert
   */
  owner?: IAccessControlEntity | null;
 ...
 * users of the system.
 *
 * @remarks this represents a made instance of Alert
 */
declare class Alert extends Obj {

  /**
   * List of {@link AclEntry} entries governing who can read/update/remove Objs.
   */
  readonly acl?: C3.Array<AclEntry | null>;
  withAcl(acl: C3.Array<AclEntry | null> | Array<IAclEntry | null>): Alert;
  ...
  withTypeIdent(typeIdent: string | null): Alert;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Alert;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): Alert;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): Alert;
  ...
  withVersion(version: number | null): Alert;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): Alert;

  /**
   * analytic category of this alert
   */
  readonly analyticCategory?: string | null;
  withAnalyticCategory(analyticCategory: string | null): Alert;

  /**
   * specific analytic result that triggered this alert
   */
  readonly analyticResult?: Obj | null;
  withAnalyticResult(analyticResult: IObj | null): Alert;

  /**
   * specific source object for which the alert was triggered
   */
  readonly source?: Obj | null;
  withSource(source: IObj | null): Alert;

  /**
   * required importance of the alert
   */
  readonly importance: string;
  withImportance(importance: string): Alert;

  /**
   * required alert message
   */
  readonly message: string;
  withMessage(message: string): Alert;

  /**
   * required current status of the alert
   */
  readonly status: string;
  withStatus(status: string): Alert;

  /**
   * user accepting/dismissing the alert
   */
  readonly owner?: AccessControlEntity | null;
  withOwner(owner: IAccessControlEntity | null): Alert;

  /**
   * reason the alert was dismissed
   */
  readonly dismissReason?: string | null;
  withDismissReason(dismissReason: string | null): Alert;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Alert | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Alert | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Alert | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Alert | null;
   ...
   */
  replaceType(old: Type, new_: Type): Alert;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Alert;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Alert;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Alert | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Alert | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Alert;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Alert;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Alert;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Alert;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Alert;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Alert;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Alert;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Alert;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Alert;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Alert;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Alert;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Alert;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Alert;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Alert;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Alert;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Alert;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Alert;
   ...
   * @see #unsetField
   */
  removeField(field: string): Alert;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Alert;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Alert;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Alert;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Alert;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Alert;

  mergeJson(json: any | null): Alert;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Alert;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Alert;
   ...
   */
  singletonArray(): C3.Array<Alert | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Alert | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Alert | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Alert | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Alert | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Alert | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Alert | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Alert | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Alert | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Alert;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Alert;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Alert;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Alert;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Alert;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Alert;
   ...
   * @see #fromString
   */
  static make(s: string | null): Alert | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Alert;
   ...
   */
  static cachedEmptyInst(): Alert;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Alert>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Alert;
   ...
   */
  static populateAcl(objs?: C3.Array<Alert | null>): number | null;
   ...
   */
  grantMemberReadUpdateRemove(member: AccessControlEntity): Alert;
   ...
   */
  mergeAclEntry(entry: AclEntry): Alert;
   ...
   * @return the obj with the new acl after merging the indicated entry.
   */
  mergeAclEntries(entries: C3.Array<AclEntry | null> | null): Alert;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<Alert | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<Alert | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Alert | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Alert | null> | null>;
   ...
   */
  get(include?: string | null): Alert | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): Alert | null;
   ...
   */
  getMissing(spec: GetMissingSpec): Alert;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): Alert | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): Alert;
   ...
   * @see #toString
   */
  static fromString(s: string | null): Alert | null;
   ...
   */
  create(spec?: UpsertSpec | null): Alert | null;
   ...
   */
  static createBatch(objs: C3.Array<Alert | null> | null, spec?: UpsertSpec | null): ObjList<Alert | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<Alert | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Alert | null> | null;
   ...
   */
  update(srcObj?: Alert | null, spec?: UpsertSpec | null): Alert | null;
   ...
   */
  upsert(srcObj?: Alert | null, spec?: UpsertSpec | null): Alert | null;
   ...
   */
  merge(spec?: MergeSpec | null): Alert | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): Alert | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): Alert | null;
   ...
   */
  static updateBatch(objs: C3.Array<Alert | null> | null, srcObjs?: C3.Array<Alert | null>, spec?: UpsertSpec | null): ObjList<Alert | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<Alert | null>>, spec?: UpsertSpec | null): ObjList<Alert | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<Alert | null> | null, srcObjs?: C3.Array<Alert | null>, spec?: UpsertSpec | null): ObjList<Alert | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<Alert | null>>, spec?: UpsertSpec | null): ObjList<Alert | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<Alert | null> | null, spec?: TouchSpec | null): ObjList<Alert | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Alert | null> | null, spec?: MergeSpec | null): ObjList<Alert | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Alert | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Alert | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<Alert | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Alert | null> | null;
   ...
   */
  static mergeAll(mergeObj: Alert | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: Alert | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<Alert | null> | null, spec?: UpsertSpec | null): ObjList<Alert | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<Alert | null> | null, spec?: UpsertSpec | null): ObjList<Alert | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<Alert | null> | null): ObjList<Alert | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<Alert | null> | null): ObjList<Alert | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<Alert | null> | null): ObjList<Alert | null>;
   ...
   */
  static afterCreate(objs: C3.Array<Alert | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<Alert | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<Alert | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<Alert | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Alert | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): Alert | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<Alert | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: Alert | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<Alert | null> | null, callback?: λFunction<Alert | null, Alert | null> | null): ObjList<Alert | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<Alert | null> | null, callback?: λFunction<Alert | null, Alert | null> | null): C3.Array<ObjError | null>;
