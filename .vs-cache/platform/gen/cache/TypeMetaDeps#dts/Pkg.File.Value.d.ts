// TypeScript definitions for the C3 type Pkg.File.Value
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Pkg.File.Value
 */
 ...
 */
declare namespace Pkg.File {
  export class Value extends Obj {

    /**
     * Glob pattern to determine if a file is a test file.
     */
    readonly TEST_FILE_PATTERN?: string | null;
    withTEST_FILE_PATTERN(TEST_FILE_PATTERN: string | null): Pkg.File.Value;
     ...
     */
    readonly url: string;
    withUrl(url: string): Pkg.File.Value;

    /**
     * scheme of this pkg path url.
     */
    readonly scheme?: string | null;
    withScheme(scheme: string | null): Pkg.File.Value;

    /**
     * The name of package Pkg file belongs to.
     */
    readonly package?: string | null;
    withPackage(package_: string | null): Pkg.File.Value;

    /**
     * Category for Pkg file.
     */
    readonly category?: string | null;
    withCategory(category: string | null): Pkg.File.Value;
    ...
    withEncodedSubPath(encodedSubPath: string | null): Pkg.File.Value;

    /**
     * overlay of the path, if the path is part of one. There can only be one overlay.
     */
    readonly overlay?: string | null;
    withOverlay(overlay: string | null): Pkg.File.Value;
    ...
    withDepPkgName(depPkgName: string | null): Pkg.File.Value;
    ...
    withDepPkgOverlay(depPkgOverlay: string | null): Pkg.File.Value;

    /**
     * Local cache of the #safeTargetType method call.
     */
    readonly targetType?: string | null;
    withTargetType(targetType: string | null): Pkg.File.Value;
    ...
    withContentEncoding(contentEncoding: string | null): Pkg.File.Value;
    ...
    withContentLanguage(contentLanguage: string | null): Pkg.File.Value;
    ...
    withContentLength(contentLength: number | null): Pkg.File.Value;
    ...
    withContentLocation(contentLocation: string | null): Pkg.File.Value;
    ...
    withContentType(contentType: string | null): Pkg.File.Value;
    ...
    withContentDisposition(contentDisposition: string | null): Pkg.File.Value;
    ...
    withETag(eTag: string | null): Pkg.File.Value;
    ...
    withLastModified(lastModified: DateTime | Date | string | null): Pkg.File.Value;

    /**
     * Id of user / identity who last last modified this content.
     */
    readonly lastModifiedBy?: string | null;
    withLastModifiedBy(lastModifiedBy: string | null): Pkg.File.Value;
    ...
    withContentMD5(contentMD5: string | null): Pkg.File.Value;
    ...
    withContentSHA1(contentSHA1: string | null): Pkg.File.Value;

    /**
     * Field to maintain state whether content metadata was read or not.
     */
    readonly hasMetadata?: boolean;
    withHasMetadata(hasMetadata: boolean): Pkg.File.Value;

    readonly encodedContent?: any | null;
    withEncodedContent(encodedContent: any | null): Pkg.File.Value;
     ...
     * @see #toString
     */
    static fromString(s: string | null): Pkg.File.Value | null;
     ...
     * @see #fromString
     */
    static make(s: string | null): Pkg.File.Value | null;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Pkg.File.Value;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Pkg.File.Value;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Pkg.File.Value;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Pkg.File.Value;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Pkg.File.Value | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Pkg.File.Value | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Pkg.File.Value | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Pkg.File.Value | null;
     ...
     */
    replaceType(old: Type, new_: Type): Pkg.File.Value;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Pkg.File.Value;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Pkg.File.Value;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Pkg.File.Value | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Pkg.File.Value | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Pkg.File.Value;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Pkg.File.Value;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Pkg.File.Value;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Pkg.File.Value;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Pkg.File.Value;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Pkg.File.Value;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Pkg.File.Value;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Pkg.File.Value;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Pkg.File.Value;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Pkg.File.Value;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Pkg.File.Value;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Pkg.File.Value;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Pkg.File.Value;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Pkg.File.Value;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Pkg.File.Value;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Pkg.File.Value;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Pkg.File.Value;
     ...
     * @see #removeField
     */
    unsetField(field: string): Pkg.File.Value;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Pkg.File.Value;
     ...
     * @see #unsetField
     */
    removeField(field: string): Pkg.File.Value;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Pkg.File.Value;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Pkg.File.Value;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Pkg.File.Value;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Pkg.File.Value;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Pkg.File.Value;

    mergeJson(json: any | null): Pkg.File.Value;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Pkg.File.Value;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Pkg.File.Value;
     ...
     */
    singletonArray(): C3.Array<Pkg.File.Value | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Pkg.File.Value | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Pkg.File.Value | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Pkg.File.Value | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Pkg.File.Value | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Pkg.File.Value | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Pkg.File.Value | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Pkg.File.Value | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Pkg.File.Value | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Pkg.File.Value;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Pkg.File.Value;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Pkg.File.Value;
     ...
     */
    static cachedEmptyInst(): Pkg.File.Value;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Pkg.File.Value>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Pkg.File.Value;
     ...
     */
    static fromUrlOrPath(urlOrPath: string): Pkg.File;
     ...
     */
    withFileName(fileName: string | null): Pkg.File.Value;

    /**
     * Changes file extension in this instance.
     */
    withFileExt(fileExt: string | null): Pkg.File.Value;
     ...
     */
    identify(suffix?: string | null): Pkg.File.Value;
     ...
     */
    readMetadata(spec?: FileOperationSpec | null): Pkg.File.Value;
     ...
     */
    refreshMetadata(spec?: FileOperationSpec | null): Pkg.File.Value;
     ...
     * @return abstract content with metadata.
     */
    guessMetadata(spec?: FileOperationSpec | null): Pkg.File.Value;

    /**
     * Clears the content metadata; e.g. if it's known to be invalid.
     */
    clearMetadata(): Pkg.File.Value;

    /**
     * @return clone of this content with metadata from provided input.
     */
    withMetadata(meta?: ContentMeta | null): Pkg.File.Value;
     ...
     */
    encodedPushStream(spec?: FileOperationSpec | null): Pair<Pkg.File.Value | null, BytePushStream | null>;

    /**
     * @return byte push stream to be used for writing un-encoded data into this content object.
     */
    pushStream(spec?: FileOperationSpec | null): Pair<Pkg.File.Value | null, BytePushStream | null>;

    /**
     * @return character push stream to be used for writing un-encoded data into this content object.
     */
    charPushStream(spec?: FileOperationSpec | null): Pair<Pkg.File.Value | null, CharPushStream | null>;
     ...
     */
    encodedStream(spec?: FileOperationSpec | null): Pair<Pkg.File.Value | null, ByteStream | null> | null;
     ...
     */
    writeStream(content: ByteStream | null, spec?: FileOperationSpec | null): Pkg.File.Value;

    /**
     * Truncates file and replaces it's content with provided binary content.
     */
    writeInputStream(inputStream: any, spec?: FileOperationSpec | null): Pkg.File.Value;

    /**
     * Truncates file and replaces its content with provided binary content from zipInputStream
     */
    writeZipInputStream(zipInputStream: any, spec?: FileOperationSpec | null): Pkg.File.Value;
     ...
     */
    writeEncodedStream(encodedContent: ByteStream | null, spec?: FileOperationSpec | null): Pkg.File.Value;

    /**
     * Truncates file and replaces it's encoded content with provided binary content.
     */
    writeEncodedInputStream(inputStream: any, spec?: FileOperationSpec | null): Pkg.File.Value;
     ...
     *           content that needs to be written
     */
    write(content: any | null, spec?: FileOperationSpec | null): Pkg.File.Value;
     ...
     *           encoded content that needs to be written
     */
    writeEncoded(encodedContent: any | null, spec?: FileOperationSpec | null): Pkg.File.Value;
     ...
     *           content that needs to be written
     */
    writeString(content: string | null, spec?: FileOperationSpec | null): Pkg.File.Value;
     ...
     */
    writeObj(obj: Obj | null, spec?: FileObjsOperSpec | null): Pkg.File.Value;
     ...
     * @return pair of update instance of this content and number of objs written
     */
    startWriteObjs(spec?: FileObjsOperSpec | null): Pair<Pkg.File.Value | null, PushStream<Obj | null> | null>;
     ...
     */
    compress(contentEncoding?: string | null, spec?: FileCompressSpec | null): Pkg.File.Value;

    /**
     * Uncompresses file. Removes compression specific extension.
     */
    uncompress(spec?: FileCompressSpec | null): Pkg.File.Value;
     ...
     */
    transcode(contentType: string, contentEncoding: string, spec?: FileCompressSpec | null): Pkg.File.Value;

    /**
     * Copies content to a given target.
     */
    copyContentTo(target: Pkg.File.Value, spec?: FileOperationSpec | null): void;
    ...
    static fromBinary(encodedBinary: any | null, contentType: string, contentEncoding: string | null, pathOrUrl: string): Pkg.File.Value | null;
    ...
    static fromText(pathOrUrl: string, contentType: string, text: string | null): Pkg.File.Value | null;

    static fromText(text: string | null, contentType: string, contentEncoding: string | null, pathOrUrl: string): Pkg.File.Value | null;
     ...
     */
    fileMeta(refresh?: boolean): FileMeta;
     ...
     */
    static createFile(urlOrEncodedPath: string, content?: any | null, contentType?: string | null, contentEncoding?: string | null, spec?: FileOperationSpec | null): File;

    /**
     * Check if file exists.
     */
    exists(spec?: FileOperationSpec | null): boolean;

    /**
     * Updates file access and modification times.
     */
    touch(spec?: FileOperationSpec | null): File;

    /**
     * Deletes this file.
     */
    delete(spec?: DeleteFileOperationSpec | null): void;
     ...
     */
    copy(destUrlOrEncodedPath: string, spec?: FileOperationSpec | null): File;
     ...
     *             complete path to destination file. Cannot be a directory path or same path as src file.
     */
    move(destUrlOrEncodedPath: string, spec?: FileOperationSpec | null): File;
     ...
     *            new content type.
     */
    replaceContentType(contentType: string, spec?: FileOperationSpec | null): File;
     ...
     *            new content encoding.
     */
    replaceContentEncoding(contentEncoding: string, spec?: FileOperationSpec | null): File;
     ...
     *            new content encoding.
     */
    replaceContentTypeAndEncoding(contentType: string, contentEncoding: string, spec?: FileOperationSpec | null): File;

    /**
     * Creates a ZIP file from the given file content. Compressed file will have a .zip extension.
     */
    zip(spec?: FileCompressSpec | null): File;

    /**
     * Uncompresses first entry in a ZIP file.
     */
    unzipFirst(rootUrlOrEncodedPath?: string | null, spec?: FileCompressSpec | null): File | null;

    /**
     * Uncompresses all entries in a ZIP file.
     */
    unzip(rootUrlOrEncodedPath?: string | null, spec?: FileCompressSpec | null): C3.Array<File | null>;

    /**
     * @return cached copy i.e. local file with same metadata and content.
     */
    cachedFile(spec?: FileOperationSpec | null): File;
     ...
     */
    static getRetrySpec(spec?: FileOperationSpec | null, scheme?: string | null): RetrySpec;
     ...
     */
    parentDirectories(): C3.Array<string | null>;

    /**
     * @return list of parent directory urls starting from mount URL.
     */
    parentDirectoryUrls(): C3.Array<string | null>;
     ...
     */
    eachParentDirectory(action: λConsumer<string | null>): number;
     ...
     */
    apiEndpoint(httpMethod?: string | null, fullyQualified?: boolean): string;
     ...
     */
    isLocked(spec?: FileOperationSpec | null): boolean;
     ...
     * Throws an exception if FileSystem does not provide file locking capabilities.
     */
    breakLock(spec?: FileOperationSpec | null): void;
     ...
     */
    generatePresignedUrl(httpMethod?: string | null, duration?: string | null, spec?: FileOperationSpec | null): string;

    /**
     * @return True if the current file is a child of the provided url.
     */
    isChildOf(url?: string | null): boolean;

    /**
     * New Pkg.File from a given Pkg.Path.
     */
    static fromMetaPath(path: Pkg.Path): Pkg.File;

    /**
     * New Pkg.File with a given Pkg.Path.
     */
    withMetaPath(path: Pkg.Path): Pkg.File;

    /**
     * @return in memory copy of this Pkg.File with embedded content. This means read* methods don't need to perform
     * any IO.
     */
    inMemoryCopy(): Pkg.File.Value;

    static fromFile(file: File): Pkg.File;

    static fromDb(dbMetaFile: Pkg.File.Db): Pkg.File;

    deps(): PkgFileDeps | null;
    ...
    static fromData(pathOrUrl: string, contentType: string, data: any | null): Pkg.File.Value | null;
  }
}
