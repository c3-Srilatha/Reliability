// TypeScript definitions for the C3 type KvStore.FileSystem.Config

/**
 * Configuration for the file system key value store
 *
 * @remarks this represents a value passed to a method that expects an instance of KvStore.FileSystem.Config
 */
declare namespace KvStore.FileSystem {
...
declare namespace KvStore.FileSystem {
  export class Config extends Obj {
    ...
    withConfigOverride(configOverride: string | null): KvStore.FileSystem.Config;

    readonly secretOverride?: string | null;
    withSecretOverride(secretOverride: string | null): KvStore.FileSystem.Config;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: C3.Array<string | null>;
    withIssues(issues: C3.Array<string | null> | Array<string | null>): KvStore.FileSystem.Config;

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): KvStore.FileSystem.Config;

    /**
     * Physical pool for connections
     */
    readonly connectionPool?: DatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null;
    withConnectionPool(connectionPool: IDatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null): KvStore.FileSystem.Config;
    ...
    withCredentials(credentials: IKvStore.Credentials | null): KvStore.FileSystem.Config;

    /**
     * C3 Cloud Identifier for backing infrastructure that hosts the Datastore ex: {@link PostgresDb#id}, {@link CassandraDb#id}
     */
    readonly cloudId?: string | null;
    withCloudId(cloudId: string | null): KvStore.FileSystem.Config;

    /**
     * True if the datastore is disabled (e.g. no data access is permitted).
     */
    readonly disabled?: boolean;
    withDisabled(disabled: boolean): KvStore.FileSystem.Config;

    /**
     * True if the datastore is read only, i.e. can only be queried.
     */
    readonly readOnly?: boolean;
    withReadOnly(readOnly: boolean): KvStore.FileSystem.Config;

    /**
     * True if the datastore is external, i.e. its database schema can not be altered.
     */
    readonly external?: boolean;
    withExternal(external: boolean): KvStore.FileSystem.Config;
    ...
    withPerTenant(perTenant: boolean): KvStore.FileSystem.Config;

    /**
     * Description for the dataStore.
     */
    readonly description?: string | null;
    withDescription(description: string | null): KvStore.FileSystem.Config;

    /**
     * True if the db is shared with other apps or it is dedicated.
     */
    readonly dedicated?: boolean;
    withDedicated(dedicated: boolean): KvStore.FileSystem.Config;

    readonly shareReadConnection?: boolean;
    withShareReadConnection(shareReadConnection: boolean): KvStore.FileSystem.Config;

    readonly sharedReadThreshold: number;
    withSharedReadThreshold(sharedReadThreshold: number): KvStore.FileSystem.Config;

    readonly readConnectionPool?: DatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null;
    withReadConnectionPool(readConnectionPool: IDatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null): KvStore.FileSystem.Config;

    readonly writeConnectionPool?: DatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null;
    withWriteConnectionPool(writeConnectionPool: IDatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null): KvStore.FileSystem.Config;
    ...
    withNewColReadCount(newColReadCount: number | null): KvStore.FileSystem.Config;
    ...
    withNewColMaxObjCount(newColMaxObjCount: number | null): KvStore.FileSystem.Config;
    ...
    withRewriteAllIncremental(rewriteAllIncremental: boolean): KvStore.FileSystem.Config;

    /**
     * Kv store kind for which this config is provided
     */
    readonly kvstore?: Type | null;
    withKvstore(kvstore: IType | null): KvStore.FileSystem.Config;
    ...
    withFillBucketsProbabilityOnRead(fillBucketsProbabilityOnRead: number | null): KvStore.FileSystem.Config;
    ...
    withFillBucketsProbabilityOnWrite(fillBucketsProbabilityOnWrite: number | null): KvStore.FileSystem.Config;
    ...
    withFillBucketsPartitionKeyPercentageOnWrite(fillBucketsPartitionKeyPercentageOnWrite: number | null): KvStore.FileSystem.Config;
    ...
    withRangeDeleteTimeDriftInSec(rangeDeleteTimeDriftInSec: number | null): KvStore.FileSystem.Config;
    ...
    withMultiBinningWriteTimeInterval(multiBinningWriteTimeInterval: string | null): KvStore.FileSystem.Config;
    ...
    withRootUrl(rootUrl: string | null): KvStore.FileSystem.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): KvStore.FileSystem.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): KvStore.FileSystem.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): KvStore.FileSystem.Config | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): KvStore.FileSystem.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): KvStore.FileSystem.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): KvStore.FileSystem.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): KvStore.FileSystem.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<KvStore.FileSystem.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<KvStore.FileSystem.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): KvStore.FileSystem.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): KvStore.FileSystem.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): KvStore.FileSystem.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): KvStore.FileSystem.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): KvStore.FileSystem.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): KvStore.FileSystem.Config;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): KvStore.FileSystem.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): KvStore.FileSystem.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): KvStore.FileSystem.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): KvStore.FileSystem.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): KvStore.FileSystem.Config;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): KvStore.FileSystem.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): KvStore.FileSystem.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): KvStore.FileSystem.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): KvStore.FileSystem.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): KvStore.FileSystem.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): KvStore.FileSystem.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): KvStore.FileSystem.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): KvStore.FileSystem.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): KvStore.FileSystem.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): KvStore.FileSystem.Config;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): KvStore.FileSystem.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): KvStore.FileSystem.Config;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): KvStore.FileSystem.Config;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): KvStore.FileSystem.Config;

    mergeJson(json: any | null): KvStore.FileSystem.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): KvStore.FileSystem.Config;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): KvStore.FileSystem.Config;
     ...
     */
    singletonArray(): C3.Array<KvStore.FileSystem.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<KvStore.FileSystem.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<KvStore.FileSystem.Config | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<KvStore.FileSystem.Config | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<KvStore.FileSystem.Config | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, KvStore.FileSystem.Config | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, KvStore.FileSystem.Config | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<KvStore.FileSystem.Config | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<KvStore.FileSystem.Config | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): KvStore.FileSystem.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): KvStore.FileSystem.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): KvStore.FileSystem.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): KvStore.FileSystem.Config;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): KvStore.FileSystem.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): KvStore.FileSystem.Config;
     ...
     * @see #fromString
     */
    static make(s: string | null): KvStore.FileSystem.Config | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): KvStore.FileSystem.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): KvStore.FileSystem.Config;
     ...
     */
    static cachedEmptyInst(): KvStore.FileSystem.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<KvStore.FileSystem.Config>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): KvStore.FileSystem.Config;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<KvStore.FileSystem.Config | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<KvStore.FileSystem.Config | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<KvStore.FileSystem.Config | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): KvStore.FileSystem.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string | null): KvStore.FileSystem.Config | null;
     ...
     * @see findByCacheKey
     */
    getCached(): KvStore.FileSystem.Config | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): KvStore.FileSystem.Config | null;
     ...
     */
    static produce(key: string): KvStore.FileSystem.Config | null;
     ...
     */
    static produceAll(): C3.Map<string | null, KvStore.FileSystem.Config | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, KvStore.FileSystem.Config | null>;
     ...
     */
    getConfig(): KvStore.FileSystem.Config;
     ...
     */
    getSecret(): KvStore.FileSystem.Config;
     ...
     */
    static forConfigKey(configKey: string | null): KvStore.FileSystem.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<KvStore.FileSystem.Config | null>;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: KvStore.FileSystem.Config, override?: string | null): void;
     ...
     * @see setSecretValue
     */
    setSecretValues(from: KvStore.FileSystem.Config, override?: string | null): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): KvStore.FileSystem.Config | null;
     ...
     * @see #toString
     */
    static fromString(s: string | null): KvStore.FileSystem.Config | null;
     ...
     */
    static forName(name: string | null, failIfMissing?: boolean): KvStore.FileSystem.Config | null;
