// TypeScript definitions for the C3 type VanityUrl

/**
 * @remarks this represents a value passed to a method that expects an instance of VanityUrl
 */
declare interface IVanityUrl {
   ...
   */
  iFrameUiContentAccessUrl?: string | null;

  /**
   * Endpoint where requests to this vanity url will be proxied to.
   */
  proxiedEndpoint?: IUrl | null;
...
/**
 * @remarks this represents a made instance of VanityUrl
 */
declare class VanityUrl extends Obj {
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): VanityUrl;

  /**
   * Host portion of the URL. The format of the host conforms to RFC 2732.
   */
  readonly name: string;
  withName(name: string): VanityUrl;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): VanityUrl;
  ...
  withVersion(version: number | null): VanityUrl;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): VanityUrl;

  /**
   * Tenant this vanity URL is bound to.
   */
  readonly tenant: string;
  withTenant(tenant: string): VanityUrl;

  /**
   * Tag this vanity URL is bound to.
   */
  readonly tag: string;
  withTag(tag: string): VanityUrl;

  /**
   * If present, it will be appended to the request url path.
   */
  readonly contentRoot?: string | null;
  withContentRoot(contentRoot: string | null): VanityUrl;

  /**
   * If present, it will be appended to the request url path, after contentRoot.
   */
  readonly defaultContent?: string | null;
  withDefaultContent(defaultContent: string | null): VanityUrl;

  /**
   * If TRUE, this Vanity URL is an Okta Sp (will be authenticated through Okta).
   */
  readonly okta?: boolean;
  withOkta(okta: boolean): VanityUrl;

  /**
   * If TRUE, the Vanity URL is upserted/removed only after the DNS record is upserted/removed.
   */
  readonly waitForDns?: boolean;
  withWaitForDns(waitForDns: boolean): VanityUrl;
  ...
  withAnonymousUser(anonymousUser: boolean): VanityUrl;
  ...
  withCsrfProtected(csrfProtected: boolean): VanityUrl;

  /**
   * Optional description.
   */
  readonly description?: string | null;
  withDescription(description: string | null): VanityUrl;
  ...
  withSamlAcsUrl(samlAcsUrl: string | null): VanityUrl;
   ...
   * http request headers.
   */
  readonly iFrameUiContentAccessUrl?: string | null;
  withIFrameUiContentAccessUrl(iFrameUiContentAccessUrl: string | null): VanityUrl;

  /**
   * Endpoint where requests to this vanity url will be proxied to.
   */
  readonly proxiedEndpoint?: Url | null;
  withProxiedEndpoint(proxiedEndpoint: IUrl | null): VanityUrl;

  /**
   * Private field used if type is mapped to an external resource
   */
  readonly externalSource?: string | null;
  withExternalSource(externalSource: string | null): VanityUrl;

  /**
   * Private field used if type is mapped to an external resource
   */
  readonly externalSourceId?: string | null;
  withExternalSourceId(externalSourceId: string | null): VanityUrl;

  /**
   * If csrfProtected is TRUE, this control whether the Origin header should be checked.
   */
  readonly csrfOrigin?: boolean;
  withCsrfOrigin(csrfOrigin: boolean): VanityUrl;

  /**
   * Salt used to generate the CSRF token. Needed only for UI access.
   */
  readonly csrfSalt?: string | null;
  withCsrfSalt(csrfSalt: string | null): VanityUrl;

  /**
   * Set if you want to skip creation of dns entry on dns not managed by underlying cloud services.
   * {@see canRegisterUrl}
   */
  readonly hasExternalDns?: boolean;
  withHasExternalDns(hasExternalDns: boolean): VanityUrl;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): VanityUrl | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): VanityUrl | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): VanityUrl | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): VanityUrl | null;
   ...
   */
  replaceType(old: Type, new_: Type): VanityUrl;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VanityUrl;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VanityUrl;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VanityUrl | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VanityUrl | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): VanityUrl;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VanityUrl;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VanityUrl;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): VanityUrl;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): VanityUrl;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): VanityUrl;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): VanityUrl;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): VanityUrl;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): VanityUrl;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): VanityUrl;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): VanityUrl;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): VanityUrl;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): VanityUrl;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): VanityUrl;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): VanityUrl;
   ...
   * @see #unsetField
   */
  defaultField(field: string): VanityUrl;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): VanityUrl;
   ...
   * @see #removeField
   */
  unsetField(field: string): VanityUrl;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): VanityUrl;
   ...
   * @see #unsetField
   */
  removeField(field: string): VanityUrl;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): VanityUrl;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): VanityUrl;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): VanityUrl;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): VanityUrl;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): VanityUrl;

  mergeJson(json: any | null): VanityUrl;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): VanityUrl;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): VanityUrl;
   ...
   */
  singletonArray(): C3.Array<VanityUrl | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<VanityUrl | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<VanityUrl | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<VanityUrl | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<VanityUrl | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, VanityUrl | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, VanityUrl | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<VanityUrl | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<VanityUrl | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): VanityUrl;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): VanityUrl;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): VanityUrl;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): VanityUrl;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): VanityUrl;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): VanityUrl;
   ...
   * @see #fromString
   */
  static make(s: string | null): VanityUrl | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): VanityUrl;
   ...
   */
  static cachedEmptyInst(): VanityUrl;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<VanityUrl>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): VanityUrl;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<VanityUrl | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<VanityUrl | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<VanityUrl | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<VanityUrl | null> | null>;
   ...
   */
  get(include?: string | null): VanityUrl | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): VanityUrl | null;
   ...
   */
  getMissing(spec: GetMissingSpec): VanityUrl;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): VanityUrl | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): VanityUrl;
   ...
   * @see #toString
   */
  static fromString(s: string | null): VanityUrl | null;
   ...
   */
  create(spec?: UpsertSpec | null): VanityUrl | null;
   ...
   */
  static createBatch(objs: C3.Array<VanityUrl | null> | null, spec?: UpsertSpec | null): ObjList<VanityUrl | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<VanityUrl | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<VanityUrl | null> | null;
   ...
   */
  update(srcObj?: VanityUrl | null, spec?: UpsertSpec | null): VanityUrl | null;
   ...
   */
  upsert(srcObj?: VanityUrl | null, spec?: UpsertSpec | null): VanityUrl | null;
   ...
   */
  merge(spec?: MergeSpec | null): VanityUrl | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): VanityUrl | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): VanityUrl | null;
   ...
   */
  static updateBatch(objs: C3.Array<VanityUrl | null> | null, srcObjs?: C3.Array<VanityUrl | null>, spec?: UpsertSpec | null): ObjList<VanityUrl | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<VanityUrl | null>>, spec?: UpsertSpec | null): ObjList<VanityUrl | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<VanityUrl | null> | null, srcObjs?: C3.Array<VanityUrl | null>, spec?: UpsertSpec | null): ObjList<VanityUrl | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<VanityUrl | null>>, spec?: UpsertSpec | null): ObjList<VanityUrl | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<VanityUrl | null> | null, spec?: TouchSpec | null): ObjList<VanityUrl | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<VanityUrl | null> | null, spec?: MergeSpec | null): ObjList<VanityUrl | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<VanityUrl | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<VanityUrl | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<VanityUrl | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<VanityUrl | null> | null;
   ...
   */
  static mergeAll(mergeObj: VanityUrl | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: VanityUrl | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<VanityUrl | null> | null, spec?: UpsertSpec | null): ObjList<VanityUrl | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<VanityUrl | null> | null, spec?: UpsertSpec | null): ObjList<VanityUrl | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<VanityUrl | null> | null): ObjList<VanityUrl | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<VanityUrl | null> | null): ObjList<VanityUrl | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<VanityUrl | null> | null): ObjList<VanityUrl | null>;
   ...
   */
  static afterCreate(objs: C3.Array<VanityUrl | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<VanityUrl | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<VanityUrl | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<VanityUrl | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<VanityUrl | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): VanityUrl | null;
   ...
   */
  withoutIdentity(): VanityUrl | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<VanityUrl | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: VanityUrl | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<VanityUrl | null> | null, callback?: λFunction<VanityUrl | null, VanityUrl | null> | null): ObjList<VanityUrl | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<VanityUrl | null> | null, callback?: λFunction<VanityUrl | null, VanityUrl | null> | null): C3.Array<ObjError | null>;
   ...
   */
  urlRegistrationStatus(): AwsUrlRegistrationInfo;
   ...
   */
  static forTenantTag(tenant: string, tag: string): C3.Array<VanityUrl | null>;
