// TypeScript definitions for the C3 type Err.VersionConflictForRemove

/**
 * Error type representing db version conflict for remove operation.
 *
 * @remarks this represents a value passed to a method that expects an instance of Err.VersionConflictForRemove
 */
declare namespace Err {
  export interface IVersionConflictForRemove {
 ...
 */
declare namespace Err {
  export class VersionConflictForRemove extends Obj {

    /**
     * Formatted and localized message.
     */
    readonly message?: string | null;
    withMessage(message: string | null): Err.VersionConflictForRemove;

    /**
     * Unlocalized, parameterized error message string.
     */
    readonly template?: string | null;
    withTemplate(template: string | null): Err.VersionConflictForRemove;

    /**
     * Parameters applied to {@link template} to produce error message.
     */
    readonly parameters?: C3.Array<string | null>;
    withParameters(parameters: C3.Array<string | null> | Array<string | null>): Err.VersionConflictForRemove;

    /**
     * Unique (generated) error id.
     */
    readonly id?: string | null;
    withId(id: string | null): Err.VersionConflictForRemove;

    /**
     * Error key.
     */
    readonly key?: string | null;
    withKey(key: string | null): Err.VersionConflictForRemove;

    /**
     * Error for nested/causing exception (if any).
     */
    readonly cause?: C3.Error | null;
    withCause(cause: IC3.Error | null): Err.VersionConflictForRemove;

    /**
     * http status code for this error
     */
    readonly httpStatusCode: number;
    withHttpStatusCode(httpStatusCode: number): Err.VersionConflictForRemove;

    /**
     * Filename for where the error originated from
     */
    readonly filenameOfRootError?: string | null;
    withFilenameOfRootError(filenameOfRootError: string | null): Err.VersionConflictForRemove;

    /**
     * Extra debugging information, such as script language stack.
     */
    readonly debugInfo?: C3.Array<string | null>;
    withDebugInfo(debugInfo: C3.Array<string | null> | Array<string | null>): Err.VersionConflictForRemove;

    /**
     * Script language (js/py) stacktrace.
     */
    readonly stackTrace?: C3.Array<StackFrame | null>;
    withStackTrace(stackTrace: C3.Array<StackFrame | null> | Array<IStackFrame | null>): Err.VersionConflictForRemove;
    ...
    withAction(action: string | null): Err.VersionConflictForRemove;

    /**
     * Engine of the action that threw this error
     */
    readonly engine?: string | null;
    withEngine(engine: string | null): Err.VersionConflictForRemove;

    /**
     * Timestamp when the error was thrown
     */
    readonly timestamp?: DateTime | null;
    withTimestamp(timestamp: DateTime | Date | string | null): Err.VersionConflictForRemove;
    ...
    with_system(_system: any): Err.VersionConflictForRemove;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Err.VersionConflictForRemove | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Err.VersionConflictForRemove | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Err.VersionConflictForRemove | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Err.VersionConflictForRemove | null;
     ...
     */
    replaceType(old: Type, new_: Type): Err.VersionConflictForRemove;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Err.VersionConflictForRemove;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Err.VersionConflictForRemove;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Err.VersionConflictForRemove | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Err.VersionConflictForRemove | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Err.VersionConflictForRemove;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Err.VersionConflictForRemove;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Err.VersionConflictForRemove;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Err.VersionConflictForRemove;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Err.VersionConflictForRemove;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Err.VersionConflictForRemove;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Err.VersionConflictForRemove;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Err.VersionConflictForRemove;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Err.VersionConflictForRemove;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Err.VersionConflictForRemove;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Err.VersionConflictForRemove;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Err.VersionConflictForRemove;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Err.VersionConflictForRemove;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Err.VersionConflictForRemove;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Err.VersionConflictForRemove;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Err.VersionConflictForRemove;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Err.VersionConflictForRemove;
     ...
     * @see #removeField
     */
    unsetField(field: string): Err.VersionConflictForRemove;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Err.VersionConflictForRemove;
     ...
     * @see #unsetField
     */
    removeField(field: string): Err.VersionConflictForRemove;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Err.VersionConflictForRemove;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Err.VersionConflictForRemove;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Err.VersionConflictForRemove;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Err.VersionConflictForRemove;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Err.VersionConflictForRemove;

    mergeJson(json: any | null): Err.VersionConflictForRemove;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Err.VersionConflictForRemove;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Err.VersionConflictForRemove;
     ...
     */
    singletonArray(): C3.Array<Err.VersionConflictForRemove | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Err.VersionConflictForRemove | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Err.VersionConflictForRemove | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Err.VersionConflictForRemove | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Err.VersionConflictForRemove | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Err.VersionConflictForRemove | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Err.VersionConflictForRemove | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Err.VersionConflictForRemove | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Err.VersionConflictForRemove | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Err.VersionConflictForRemove;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Err.VersionConflictForRemove;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Err.VersionConflictForRemove;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Err.VersionConflictForRemove;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Err.VersionConflictForRemove;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Err.VersionConflictForRemove;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Err.VersionConflictForRemove;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Err.VersionConflictForRemove;
     ...
     */
    static cachedEmptyInst(): Err.VersionConflictForRemove;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Err.VersionConflictForRemove>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Err.VersionConflictForRemove;
     ...
     */
    withFormattedMessage(): Err.VersionConflictForRemove;
     ...
     */
    static formatted(format: string, ...args: any[]): Err.VersionConflictForRemove;

    /**
     * Construct an error with just the message.
     */
    static fromMessage(s: string | null): Err.VersionConflictForRemove;
     ...
     */
    static fromJavaException(ex: any): Err.VersionConflictForRemove;

    /**
     * Construct an error from the system exception.
     */
    static fromJavaException(message: string, ex: any): Err.VersionConflictForRemove;
     ...
     */
    static fromTemplate(template: string | null, bindings: C3.Map<string | null, any> | null): Err.VersionConflictForRemove;

    /**
     * Construct an error and a system exception around it to throw an error.
     */
    static fromHttpCodeAndTemplate(httpCode: number | null, template: string | null, bindings: C3.Map<string | null, any> | null): Err.VersionConflictForRemove;
