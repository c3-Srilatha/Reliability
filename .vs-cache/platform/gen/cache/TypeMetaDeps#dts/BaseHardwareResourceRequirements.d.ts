// TypeScript definitions for the C3 type BaseHardwareResourceRequirements

/**
 * Base type for {@link HardwareRequirement} and {@link ResourceRequirement} {@link Config}.
 *
 * This type provides validation logic.
 *
 * @remarks this represents a value passed to a method that expects an instance of BaseHardwareResourceRequirements
 */
declare interface IBaseHardwareResourceRequirements {
 ...
 * This type provides validation logic.
 *
 * @remarks this represents a made instance of BaseHardwareResourceRequirements
 */
declare class BaseHardwareResourceRequirements extends Obj {

  /**
   * The name of this instance.
   */
  readonly name?: string | null;
  withName(name: string | null): BaseHardwareResourceRequirements;

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): BaseHardwareResourceRequirements;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): BaseHardwareResourceRequirements;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): BaseHardwareResourceRequirements;

  /**
   * Cloud Provider Machine Type Name (ex: "n2d-standard-32" on gcp)
   */
  readonly instanceType?: string | null;
  withInstanceType(instanceType: string | null): BaseHardwareResourceRequirements;
  ...
  withGpuVendor(gpuVendor: string | null): BaseHardwareResourceRequirements;
  ...
  withGpuKind(gpuKind: string | null): BaseHardwareResourceRequirements;

  /**
   * Specifies the {@link HardwareAvailability} for a given VM.
   */
  readonly hardwareAvailability: string;
  withHardwareAvailability(hardwareAvailability: string): BaseHardwareResourceRequirements;
   ...
   * This field is required if {@link #acceleratorCount} greater than 0.
   */
  readonly acceleratorKind?: string | null;
  withAcceleratorKind(acceleratorKind: string | null): BaseHardwareResourceRequirements;

  /**
   * The identifier of the Kubernetes node pool that serves as the scheduling target for the C3 node pool.
   */
  readonly computeKind?: string | null;
  withComputeKind(computeKind: string | null): BaseHardwareResourceRequirements;
   ...
   */
  readonly cpu: number;
  withCpu(cpu: number): BaseHardwareResourceRequirements;
  ...
  withMemoryMb(memoryMb: number): BaseHardwareResourceRequirements;
  ...
  withDiskGb(diskGb: number): BaseHardwareResourceRequirements;
   ...
   */
  readonly gpu: number;
  withGpu(gpu: number): BaseHardwareResourceRequirements;
  ...
  withGpuMemoryMb(gpuMemoryMb: number): BaseHardwareResourceRequirements;

  /**
   * The number of GPUs.
   */
  readonly acceleratorCount: number;
  withAcceleratorCount(acceleratorCount: number): BaseHardwareResourceRequirements;
  ...
  withCpuLimit(cpuLimit: number | null): BaseHardwareResourceRequirements;
   ...
   * Set to null to use {@link memoryMb} as {@link memoryMbLimit}.
   */
  readonly memoryMbLimit?: number | null;
  withMemoryMbLimit(memoryMbLimit: number | null): BaseHardwareResourceRequirements;
   ...
   * Set to null to use {@link diskGb} as {@link diskGbLimit}.
   */
  readonly diskGbLimit?: number | null;
  withDiskGbLimit(diskGbLimit: number | null): BaseHardwareResourceRequirements;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): BaseHardwareResourceRequirements | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): BaseHardwareResourceRequirements | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): BaseHardwareResourceRequirements | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): BaseHardwareResourceRequirements | null;
   ...
   */
  replaceType(old: Type, new_: Type): BaseHardwareResourceRequirements;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BaseHardwareResourceRequirements;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BaseHardwareResourceRequirements;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BaseHardwareResourceRequirements | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BaseHardwareResourceRequirements | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): BaseHardwareResourceRequirements;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BaseHardwareResourceRequirements;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BaseHardwareResourceRequirements;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): BaseHardwareResourceRequirements;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): BaseHardwareResourceRequirements;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): BaseHardwareResourceRequirements;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): BaseHardwareResourceRequirements;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BaseHardwareResourceRequirements;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): BaseHardwareResourceRequirements;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): BaseHardwareResourceRequirements;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): BaseHardwareResourceRequirements;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): BaseHardwareResourceRequirements;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): BaseHardwareResourceRequirements;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): BaseHardwareResourceRequirements;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): BaseHardwareResourceRequirements;
   ...
   * @see #unsetField
   */
  defaultField(field: string): BaseHardwareResourceRequirements;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): BaseHardwareResourceRequirements;
   ...
   * @see #removeField
   */
  unsetField(field: string): BaseHardwareResourceRequirements;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): BaseHardwareResourceRequirements;
   ...
   * @see #unsetField
   */
  removeField(field: string): BaseHardwareResourceRequirements;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): BaseHardwareResourceRequirements;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): BaseHardwareResourceRequirements;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): BaseHardwareResourceRequirements;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): BaseHardwareResourceRequirements;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): BaseHardwareResourceRequirements;

  mergeJson(json: any | null): BaseHardwareResourceRequirements;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): BaseHardwareResourceRequirements;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): BaseHardwareResourceRequirements;
   ...
   */
  singletonArray(): C3.Array<BaseHardwareResourceRequirements | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<BaseHardwareResourceRequirements | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BaseHardwareResourceRequirements | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<BaseHardwareResourceRequirements | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BaseHardwareResourceRequirements | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, BaseHardwareResourceRequirements | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BaseHardwareResourceRequirements | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BaseHardwareResourceRequirements | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BaseHardwareResourceRequirements | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): BaseHardwareResourceRequirements;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): BaseHardwareResourceRequirements;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): BaseHardwareResourceRequirements;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): BaseHardwareResourceRequirements;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): BaseHardwareResourceRequirements;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): BaseHardwareResourceRequirements;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): BaseHardwareResourceRequirements;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): BaseHardwareResourceRequirements;
   ...
   */
  static cachedEmptyInst(): BaseHardwareResourceRequirements;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<BaseHardwareResourceRequirements>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): BaseHardwareResourceRequirements;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<BaseHardwareResourceRequirements | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<BaseHardwareResourceRequirements | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<BaseHardwareResourceRequirements | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): BaseHardwareResourceRequirements | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): BaseHardwareResourceRequirements | null;
   ...
   * @see findByCacheKey
   */
  getCached(): BaseHardwareResourceRequirements | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): BaseHardwareResourceRequirements | null;
   ...
   */
  static produce(key: string): BaseHardwareResourceRequirements | null;
   ...
   */
  static produceAll(): C3.Map<string | null, BaseHardwareResourceRequirements | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, BaseHardwareResourceRequirements | null>;
   ...
   */
  getConfig(): BaseHardwareResourceRequirements;
   ...
   */
  getSecret(): BaseHardwareResourceRequirements;
   ...
   */
  static forConfigKey(configKey: string | null): BaseHardwareResourceRequirements | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<BaseHardwareResourceRequirements | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: BaseHardwareResourceRequirements, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: BaseHardwareResourceRequirements, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): BaseHardwareResourceRequirements | null;
   ...
   */
  removeSecrets(): BaseHardwareResourceRequirements | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): BaseHardwareResourceRequirements | null;

  /**
   * Validates that all required fields are set properly.
   */
  validate(): BaseHardwareResourceRequirements;

  validate(validatePartial: boolean | null): BaseHardwareResourceRequirements;
   ...
   * ```
   */
  isValid(validatePartial?: boolean): C3.Map<string | null, C3.Array<string | null>>;
}
