// TypeScript definitions for the C3 type PiiAccessListenerConfig

/**
 * Configuration for {@link PiiAccessListener}.
 *
 * @remarks this represents a value passed to a method that expects an instance of PiiAccessListenerConfig
 */
declare interface IPiiAccessListenerConfig {
  ...
  /**
   * If set then this PiiAccessListener is enabled.
   */
  enabled?: boolean;

  /**
   * If true then known machine users such as `worker` / `root` / `provisioner` will be ignored.
   */
  ignoreMachine?: boolean;
}

/**
 * Configuration for {@link PiiAccessListener}.
 *
 * @remarks this represents a made instance of PiiAccessListenerConfig
 */
declare class PiiAccessListenerConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): PiiAccessListenerConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): PiiAccessListenerConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): PiiAccessListenerConfig;

  /**
   * If set then this PiiAccessListener is enabled.
   */
  readonly enabled?: boolean;
  withEnabled(enabled: boolean): PiiAccessListenerConfig;

  /**
   * If true then known machine users such as `worker` / `root` / `provisioner` will be ignored.
   */
  readonly ignoreMachine?: boolean;
  withIgnoreMachine(ignoreMachine: boolean): PiiAccessListenerConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): PiiAccessListenerConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): PiiAccessListenerConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): PiiAccessListenerConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): PiiAccessListenerConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): PiiAccessListenerConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PiiAccessListenerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PiiAccessListenerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PiiAccessListenerConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PiiAccessListenerConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): PiiAccessListenerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PiiAccessListenerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PiiAccessListenerConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PiiAccessListenerConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PiiAccessListenerConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PiiAccessListenerConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): PiiAccessListenerConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PiiAccessListenerConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PiiAccessListenerConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): PiiAccessListenerConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): PiiAccessListenerConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): PiiAccessListenerConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): PiiAccessListenerConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PiiAccessListenerConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): PiiAccessListenerConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PiiAccessListenerConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PiiAccessListenerConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): PiiAccessListenerConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PiiAccessListenerConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): PiiAccessListenerConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PiiAccessListenerConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): PiiAccessListenerConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): PiiAccessListenerConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): PiiAccessListenerConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): PiiAccessListenerConfig;

  mergeJson(json: any | null): PiiAccessListenerConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): PiiAccessListenerConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): PiiAccessListenerConfig;
   ...
   */
  singletonArray(): C3.Array<PiiAccessListenerConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<PiiAccessListenerConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PiiAccessListenerConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<PiiAccessListenerConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PiiAccessListenerConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, PiiAccessListenerConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PiiAccessListenerConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PiiAccessListenerConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PiiAccessListenerConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): PiiAccessListenerConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): PiiAccessListenerConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): PiiAccessListenerConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PiiAccessListenerConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): PiiAccessListenerConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PiiAccessListenerConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): PiiAccessListenerConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): PiiAccessListenerConfig;
   ...
   */
  static cachedEmptyInst(): PiiAccessListenerConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<PiiAccessListenerConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): PiiAccessListenerConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<PiiAccessListenerConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<PiiAccessListenerConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<PiiAccessListenerConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): PiiAccessListenerConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): PiiAccessListenerConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): PiiAccessListenerConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): PiiAccessListenerConfig | null;
   ...
   */
  static produce(key: string): PiiAccessListenerConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, PiiAccessListenerConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, PiiAccessListenerConfig | null>;
   ...
   */
  getConfig(): PiiAccessListenerConfig;
   ...
   */
  getSecret(): PiiAccessListenerConfig;
   ...
   */
  static forConfigKey(configKey: string | null): PiiAccessListenerConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<PiiAccessListenerConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: PiiAccessListenerConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: PiiAccessListenerConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): PiiAccessListenerConfig | null;
