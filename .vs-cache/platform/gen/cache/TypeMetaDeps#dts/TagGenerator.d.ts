// TypeScript definitions for the C3 type TagGenerator

/**
 * The Tag.generateTag action submits a new batch job each time, with a batch for each type to be generated.
 *
 * @remarks this represents a value passed to a method that expects an instance of TagGenerator
 */
declare interface ITagGenerator {
  ...
  generateStatus?: IGenerateTagStatus | null;
}
 ...
 */
declare class TagGenerator extends Obj {

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun | null;
  withRun(run: IBatchJobRun | null): TagGenerator;

  /**
   * previous job executions for this instance
   */
  readonly runs?: C3.Array<BatchJobRun | null>;
  withRuns(runs: C3.Array<BatchJobRun | null> | Array<IBatchJobRun | null>): TagGenerator;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj | null;
  withOptions(options: IObj | null): TagGenerator;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): TagGenerator;
  ...
  withPriority(priority: number | null): TagGenerator;
  ...
  withDisabled(disabled: boolean): TagGenerator;
  ...
  withMaxConcurrency(maxConcurrency: number | null): TagGenerator;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): TagGenerator;
  ...
  withRunAsUser(runAsUser: boolean | null): TagGenerator;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string | null;
  withNodePool(nodePool: string | null): TagGenerator;
  ...
  withSkipIfRunning(skipIfRunning: boolean | null): TagGenerator;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number | null;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): TagGenerator;
  ...
  withPropagateActionContext(propagateActionContext: boolean): TagGenerator;
  ...
  withTypeIdent(typeIdent: string | null): TagGenerator;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): TagGenerator;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): TagGenerator;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): TagGenerator;
  ...
  withVersion(version: number | null): TagGenerator;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): TagGenerator;
  ...
  withAbortOnError(abortOnError: boolean): TagGenerator;

  readonly generateStatus?: GenerateTagStatus | null;
  withGenerateStatus(generateStatus: IGenerateTagStatus | null): TagGenerator;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TagGenerator | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TagGenerator | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TagGenerator | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TagGenerator | null;
   ...
   */
  replaceType(old: Type, new_: Type): TagGenerator;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TagGenerator;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TagGenerator;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TagGenerator | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TagGenerator | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TagGenerator;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TagGenerator;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TagGenerator;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TagGenerator;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TagGenerator;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TagGenerator;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TagGenerator;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TagGenerator;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TagGenerator;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TagGenerator;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TagGenerator;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TagGenerator;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TagGenerator;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TagGenerator;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TagGenerator;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TagGenerator;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TagGenerator;
   ...
   * @see #removeField
   */
  unsetField(field: string): TagGenerator;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TagGenerator;
   ...
   * @see #unsetField
   */
  removeField(field: string): TagGenerator;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TagGenerator;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TagGenerator;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TagGenerator;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TagGenerator;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TagGenerator;

  mergeJson(json: any | null): TagGenerator;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TagGenerator;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TagGenerator;
   ...
   */
  singletonArray(): C3.Array<TagGenerator | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TagGenerator | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TagGenerator | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TagGenerator | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TagGenerator | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TagGenerator | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TagGenerator | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TagGenerator | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TagGenerator | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TagGenerator;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TagGenerator;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TagGenerator;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TagGenerator;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TagGenerator;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TagGenerator;
   ...
   * @see #fromString
   */
  static make(s: string | null): TagGenerator | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TagGenerator;
   ...
   */
  static cachedEmptyInst(): TagGenerator;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TagGenerator>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TagGenerator;
   ...
   */
  start(options?: GenerateTagSpec | null): BatchJobStatus | null;
   ...
   */
  cleanup(options?: GenerateTagSpec | null): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun | null, BatchJobStatus | null, GenerateTagSpec | null> | null;

  failJob(run: JobRun<BatchJobStatusBase | null>): JobBase<BatchJobRun | null, BatchJobStatus | null, GenerateTagSpec | null> | null;
  ...
  validateStart(options?: GenerateTagSpec | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TagGenerator | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TagGenerator | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TagGenerator | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TagGenerator | null> | null>;
   ...
   */
  get(include?: string | null): TagGenerator | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TagGenerator | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TagGenerator;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TagGenerator | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TagGenerator;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TagGenerator | null;
   ...
   */
  create(spec?: UpsertSpec | null): TagGenerator | null;
   ...
   */
  static createBatch(objs: C3.Array<TagGenerator | null> | null, spec?: UpsertSpec | null): ObjList<TagGenerator | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TagGenerator | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TagGenerator | null> | null;
   ...
   */
  update(srcObj?: TagGenerator | null, spec?: UpsertSpec | null): TagGenerator | null;
   ...
   */
  upsert(srcObj?: TagGenerator | null, spec?: UpsertSpec | null): TagGenerator | null;
   ...
   */
  merge(spec?: MergeSpec | null): TagGenerator | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TagGenerator | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TagGenerator | null;
   ...
   */
  static updateBatch(objs: C3.Array<TagGenerator | null> | null, srcObjs?: C3.Array<TagGenerator | null>, spec?: UpsertSpec | null): ObjList<TagGenerator | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TagGenerator | null>>, spec?: UpsertSpec | null): ObjList<TagGenerator | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TagGenerator | null> | null, srcObjs?: C3.Array<TagGenerator | null>, spec?: UpsertSpec | null): ObjList<TagGenerator | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TagGenerator | null>>, spec?: UpsertSpec | null): ObjList<TagGenerator | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TagGenerator | null> | null, spec?: TouchSpec | null): ObjList<TagGenerator | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TagGenerator | null> | null, spec?: MergeSpec | null): ObjList<TagGenerator | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TagGenerator | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TagGenerator | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TagGenerator | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TagGenerator | null> | null;
   ...
   */
  static mergeAll(mergeObj: TagGenerator | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TagGenerator | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TagGenerator | null> | null, spec?: UpsertSpec | null): ObjList<TagGenerator | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TagGenerator | null> | null, spec?: UpsertSpec | null): ObjList<TagGenerator | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TagGenerator | null> | null): ObjList<TagGenerator | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TagGenerator | null> | null): ObjList<TagGenerator | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TagGenerator | null> | null): ObjList<TagGenerator | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TagGenerator | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TagGenerator | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TagGenerator | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TagGenerator | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TagGenerator | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TagGenerator | null;
   ...
   */
  withoutIdentity(): TagGenerator | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<TagGenerator | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TagGenerator | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TagGenerator | null> | null, callback?: λFunction<TagGenerator | null, TagGenerator | null> | null): ObjList<TagGenerator | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TagGenerator | null> | null, callback?: λFunction<TagGenerator | null, TagGenerator | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static doStart(job?: TagGenerator | null, options?: GenerateTagSpec | null): void;
   ...
   */
  static processBatch(batch?: TypeGeneratorBatch | null, job?: TagGenerator | null, options?: GenerateTagSpec | null): void;
   ...
   */
  static allComplete(job: TagGenerator, options?: GenerateTagSpec | null): string | null;
   ...
   *           Options the job was run with.
   */
  static failed(job: TagGenerator, status: BatchJobStatus, options?: GenerateTagSpec | null): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: TypeGeneratorBatch | null): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: C3.Array<TypeGeneratorBatch | null>): void;
   ...
   */
  static scheduleObjBatch(job?: TagGenerator | null, objBatch?: ObjBatch | null, logPrefix?: string | null): number | null;
