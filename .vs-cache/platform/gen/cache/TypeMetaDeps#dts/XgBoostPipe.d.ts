// TypeScript definitions for the C3 type XgBoostPipe

/**
 * This type represents a trainable and processable python native [XGBoost](https://xgboost.readthedocs.io/en/stable/) object.
 * This pipe supports `XGBClassifier`, `XGBRegressor`, `XGBRFClassifier` and `XGBRFRegressor` estimators but does not
 * support `XGBRanker` estimators.
 *
 * @remarks this represents a value passed to a method that expects an instance of XgBoostPipe
 */
declare interface IXgBoostPipe {
 ...
 * support `XGBRanker` estimators.
 *
 * @remarks this represents a made instance of XgBoostPipe
 */
declare class XgBoostPipe extends Obj {

  /**
   * Name for the function on the native model to call to do {@link MlTrainable#train}.
   */
  readonly trainFunc?: string | null;
  withTrainFunc(trainFunc: string | null): XgBoostPipe;
  ...
  withKeepInputColumnIndices(keepInputColumnIndices: boolean): XgBoostPipe;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): XgBoostPipe;

  /**
   * Name of this pipe.
   */
  readonly name?: string | null;
  withName(name: string | null): XgBoostPipe;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): XgBoostPipe;
  ...
  withVersion(version: number | null): XgBoostPipe;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): XgBoostPipe;
  ...
  withUserUpdatedFields(userUpdatedFields: C3.Array<string | null> | Array<string | null>): XgBoostPipe;
  ...
  withHidden(hidden: boolean): XgBoostPipe;
  ...
  withUserOwned(userOwned: boolean): XgBoostPipe;
  ...
  withTypeIdent(typeIdent: string | null): XgBoostPipe;

  /**
   * If true, then the pipe shall not be retrained
   */
  readonly frozen?: boolean;
  withFrozen(frozen: boolean): XgBoostPipe;

  /**
   * True if training has succeeded and false otherwise.
   */
  readonly trained?: boolean;
  withTrained(trained: boolean): XgBoostPipe;

  /**
   * Errors from training.
   */
  readonly trainingErrors?: string | null;
  withTrainingErrors(trainingErrors: string | null): XgBoostPipe;

  /**
   * If true, the underlying model only accepts flattened input.
   */
  readonly flattenInput?: boolean;
  withFlattenInput(flattenInput: boolean): XgBoostPipe;

  /**
   * The hyperparameters overridden of a native model or pipe.
   */
  readonly hyperparamOverrides?: C3.Map<string | null, any>;
  withHyperparamOverrides(hyperparamOverrides: C3.Map<string | null, any> | {[key: string | null]: any}): XgBoostPipe;
  ...
  withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): XgBoostPipe;
  ...
  withHpoSpec(hpoSpec: IHpo.Spec | null): XgBoostPipe;

  /**
   * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
   */
  readonly hpoExperiment?: Hpo.Experiment | null;
  withHpoExperiment(hpoExperiment: IHpo.Experiment | null): XgBoostPipe;

  /**
   * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
   */
  readonly experiment?: any;
  withExperiment(experiment: any): XgBoostPipe;
  ...
  withModelFiles(modelFiles: C3.Map<string | null, Url | null> | {[key: string | null]: IUrl | null}): XgBoostPipe;
  ...
  withCustomModelCode(customModelCode: C3.Map<string | null, any | null> | {[key: string | null]: any | null}): XgBoostPipe;

  /**
   * Name for the function on the native model to call to do {@link MlProcessable#process}.
   */
  readonly processFunc?: string | null;
  withProcessFunc(processFunc: string | null): XgBoostPipe;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): XgBoostPipe | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): XgBoostPipe | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): XgBoostPipe | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): XgBoostPipe | null;
   ...
   */
  replaceType(old: Type, new_: Type): XgBoostPipe;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): XgBoostPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): XgBoostPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<XgBoostPipe | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<XgBoostPipe | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): XgBoostPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): XgBoostPipe;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): XgBoostPipe;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): XgBoostPipe;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): XgBoostPipe;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): XgBoostPipe;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): XgBoostPipe;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): XgBoostPipe;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): XgBoostPipe;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): XgBoostPipe;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): XgBoostPipe;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): XgBoostPipe;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): XgBoostPipe;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): XgBoostPipe;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): XgBoostPipe;
   ...
   * @see #unsetField
   */
  defaultField(field: string): XgBoostPipe;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): XgBoostPipe;
   ...
   * @see #removeField
   */
  unsetField(field: string): XgBoostPipe;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): XgBoostPipe;
   ...
   * @see #unsetField
   */
  removeField(field: string): XgBoostPipe;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): XgBoostPipe;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): XgBoostPipe;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): XgBoostPipe;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): XgBoostPipe;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): XgBoostPipe;

  mergeJson(json: any | null): XgBoostPipe;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): XgBoostPipe;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): XgBoostPipe;
   ...
   */
  singletonArray(): C3.Array<XgBoostPipe | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<XgBoostPipe | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<XgBoostPipe | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<XgBoostPipe | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<XgBoostPipe | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, XgBoostPipe | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, XgBoostPipe | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<XgBoostPipe | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<XgBoostPipe | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): XgBoostPipe;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): XgBoostPipe;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): XgBoostPipe;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): XgBoostPipe;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): XgBoostPipe;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): XgBoostPipe;
   ...
   * @see #fromString
   */
  static make(s: string | null): XgBoostPipe | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): XgBoostPipe;
   ...
   */
  static cachedEmptyInst(): XgBoostPipe;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<XgBoostPipe>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): XgBoostPipe;
   ...
   */
  afterConvert(model: any, spec?: MlConvertSpec | null): XgBoostPipe;
   ...
   */
  trainSync(x: Data | null, y?: Data | null, spec?: MlOperationSpec | null): XgBoostPipe;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<XgBoostPipe | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<XgBoostPipe | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<XgBoostPipe | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): XgBoostPipe | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string | null): XgBoostPipe | null;
   ...
   * @see findByCacheKey
   */
  getCached(): XgBoostPipe | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): XgBoostPipe | null;
   ...
   */
  static produce(key: string): XgBoostPipe | null;
   ...
   */
  static produceAll(): C3.Map<string | null, XgBoostPipe | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, XgBoostPipe | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<XgBoostPipe | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<XgBoostPipe | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<XgBoostPipe | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<XgBoostPipe | null> | null>;
   ...
   */
  get(include?: string | null): XgBoostPipe | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): XgBoostPipe | null;
   ...
   */
  getMissing(spec: GetMissingSpec): XgBoostPipe;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): XgBoostPipe | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): XgBoostPipe;
   ...
   * @see #toString
   */
  static fromString(s: string | null): XgBoostPipe | null;
   ...
   */
  create(spec?: UpsertSpec | null): XgBoostPipe | null;
   ...
   */
  static createBatch(objs: C3.Array<XgBoostPipe | null> | null, spec?: UpsertSpec | null): ObjList<XgBoostPipe | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<XgBoostPipe | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<XgBoostPipe | null> | null;
   ...
   */
  update(srcObj?: XgBoostPipe | null, spec?: UpsertSpec | null): XgBoostPipe | null;
   ...
   */
  upsert(srcObj?: XgBoostPipe | null, spec?: UpsertSpec | null): XgBoostPipe | null;
   ...
   */
  merge(spec?: MergeSpec | null): XgBoostPipe | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): XgBoostPipe | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): XgBoostPipe | null;
   ...
   */
  static updateBatch(objs: C3.Array<XgBoostPipe | null> | null, srcObjs?: C3.Array<XgBoostPipe | null>, spec?: UpsertSpec | null): ObjList<XgBoostPipe | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<XgBoostPipe | null>>, spec?: UpsertSpec | null): ObjList<XgBoostPipe | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<XgBoostPipe | null> | null, srcObjs?: C3.Array<XgBoostPipe | null>, spec?: UpsertSpec | null): ObjList<XgBoostPipe | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<XgBoostPipe | null>>, spec?: UpsertSpec | null): ObjList<XgBoostPipe | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<XgBoostPipe | null> | null, spec?: TouchSpec | null): ObjList<XgBoostPipe | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<XgBoostPipe | null> | null, spec?: MergeSpec | null): ObjList<XgBoostPipe | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<XgBoostPipe | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<XgBoostPipe | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<XgBoostPipe | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<XgBoostPipe | null> | null;
   ...
   */
  static mergeAll(mergeObj: XgBoostPipe | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: XgBoostPipe | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<XgBoostPipe | null> | null, spec?: UpsertSpec | null): ObjList<XgBoostPipe | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<XgBoostPipe | null> | null, spec?: UpsertSpec | null): ObjList<XgBoostPipe | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<XgBoostPipe | null> | null): ObjList<XgBoostPipe | null>;
   ...
   */
  static beforeUpdate(objs: C3.Array<XgBoostPipe | null> | null): ObjList<XgBoostPipe | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<XgBoostPipe | null> | null): ObjList<XgBoostPipe | null>;
   ...
   */
  static afterCreate(objs: C3.Array<XgBoostPipe | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<XgBoostPipe | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<XgBoostPipe | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<XgBoostPipe | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<XgBoostPipe | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): XgBoostPipe | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<XgBoostPipe | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: XgBoostPipe | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<XgBoostPipe | null> | null, callback?: λFunction<XgBoostPipe | null, XgBoostPipe | null> | null): ObjList<XgBoostPipe | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<XgBoostPipe | null> | null, callback?: λFunction<XgBoostPipe | null, XgBoostPipe | null> | null): C3.Array<ObjError | null>;
   ...
   */
  publish(subPath?: string | null, contentType?: string | null): XgBoostPipe;
   ...
   */
  static removeSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<XgBoostPipe | null> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec | null): XgBoostPipe | null;
   ...
   */
  static createSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<XgBoostPipe | null> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData | null, spec?: UpsertSpec | null): XgBoostPipe | null;
   ...
   */
  static updateSeedDataBatch(objs?: C3.Array<SeedData | null>, srcObjs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<XgBoostPipe | null> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec | null): XgBoostPipe | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: C3.Array<SeedData | null>, spec?: MergeSpec | null): ObjList<XgBoostPipe | null> | null;
  ...
  dependencies(): SeedDataDeps<XgBoostPipe | null> | null;
   ...
   */
  static convert(model: any, spec?: MlConvertSpec | null): XgBoostPipe;
   ...
   */
  updateModelFiles(modelFiles: C3.Map<string | null, Url | null> | null, spec?: MlOperationSpec | null): XgBoostPipe;
   ...
   */
  afterTrain(doTrainOutputs: any, spec?: MlOperationSpec | null): XgBoostPipe;
   ...
   */
  withNewSpec(spec?: MlConvertSpec | null): XgBoostPipe;
   ...
   */
  withHyperparamSpaces(paramSpaces: C3.Map<string | null, Hp.ParamSpace | null>): XgBoostPipe;
