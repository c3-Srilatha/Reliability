// TypeScript definitions for the C3 type Collection
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Collection
 */
declare interface ICollection<E> {
}
...
declare class Collection<E> {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Collection<E> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Collection<E> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Collection<E> | null;
   ...
   * type and will return an instance of the correct type.
   */
  static deserialize(contentStr: string | null, contentType: string): Collection<E> | null;
  ...
  normalize(): Collection<E> | null;

  at(index: number): E | null;

  pluck(fieldPath: string | null, vtOverride?: ValueType | null): Collection<T> | null;
   ...
   * @return first element in this collection.
   */
  first(n: number): Collection<E> | null;
   ...
   * @return last element of this collection.
   */
  last(n: number): Collection<E> | null;
  ...
  round(decimals?: number | null): Collection<E> | null;

  invert(): Collection<E> | null;
   ...
   */
  mapTo(elementType: ValueType, mapper: λFunction<E | null, T | null>): Collection<T> | null;
   ...
   */
  flatMapToSame(mapper: λFunction<E | null, CollectionStdLib<E> | null>): Collection<E> | null;
   ...
   */
  flatMap(mapper: λFunction<E | null, CollectionStdLib<T> | null>): Collection<T> | null;
   ...
   */
  flatMapTo(elementType: ValueType, mapper: λFunction<E | null, CollectionStdLib<T> | null>): Collection<T> | null;
   ...
   */
  flatMapRecursive(toInters: λFunction<E | null, CollectionStdLib<I> | null>, fromInter: λFunction<I | null, E | null>): Collection<E> | null;
   ...
   */
  compact(): Collection<E> | null;

  /**
   * @return new collection with duplicate elements removed.
   */
  unique(): Collection<E> | null;

  /**
   * @return new collection with duplicate elements removed based on provided key supplier.
   */
  uniqueBy(key?: λFunction<E | null, any> | null): Collection<E> | null;

  /**
   * Filters elements from this collection based on evaluation result of the provided filter predicate.
   */
  filter(predicate: λPredicate<E | null>): Collection<E> | null;

  /**
   * Filters elements from this collection based on evaluation result of the provided filter predicate.
   */
  filter(filter: string | null): Collection<E> | null;

  /**
   * Filters elements from this collection based on evaluation result of the provided filter predicate.
   */
  filter(fields: C3.Map<string | null, any> | null): Collection<E> | null;

  fillMissingBy(method?: string | null, spec?: FillMissingSpec | null): Collection<E> | null;

  fillMissing(value: any, spec?: FillMissingSpec | null): Collection<E> | null;
   ...
   */
  reject(predicate: λPredicate<E | null>): Collection<E> | null;
   ...
   */
  include(include: string | null): Collection<E> | null;

  /**
   * Maps this collection to another by removing fields from every element that are not part of the provided include
   * spec. If include spec is not provided then does nothing.
   */
  include(positions: Collection<number | null>): Collection<E> | null;
   ...
   */
  exclude(exclude: string | null): Collection<E> | null;

  replaceByPredicate(e: E | null, predicate: λPredicate<E | null>): Collection<E> | null;
   ...
   */
  sorted(descending?: boolean): Collection<E> | null;
   ...
   * stream, while in descending order, null elements were at the beginning of the returned stream.
   */
  sorted(comparator: λBiFunction<E | null, E | null, number | null>): Collection<E> | null;
   ...
   * stream, while in descending order, null elements were at the beginning of the returned stream.
   */
  sorted(descending: boolean, comparator: λBiFunction<E | null, E | null, number | null>): Collection<E> | null;
   ...
   * stream, while in descending order, null elements were at the beginning of the returned stream.
   */
  sorted(order: string | null): Collection<E> | null;

  /**
   * Maps this collection to another by re-ordering elements based on natural sorting order of a key computed using
   * provided lambda.
   */
  sortedBy(key: λFunction<E | null, any>): Collection<E> | null;

  /**
   * Maps this collection to another by re-ordering elements based on natural sorting order of a key computed using
   * provided lambda.
   */
  sortedBy(descending: boolean, key: λFunction<E | null, any>): Collection<E> | null;
   ...
   */
  batch(batchSize?: number | null): Stream<Collection<E> | null>;
   ...
   */
  flatten(shallow?: boolean): Collection<T> | null;

  /**
   * @return new collection with all nested arrays flattened. The nesting can be to any depth unless `shallow`
   *         parameter is `true` in which case this collection will only be flattened a single level.
   */
  flatten(depth: number, include?: string | null): Collection<T> | null;

  /**
   * Produce a random sample from this collection with `count` number of elements.
   */
  sample(spec?: SampleSpec | null): Collection<E> | null;
   ...
   */
  slice(fromPos: number, toPos?: number | null, stride?: number | null): Collection<E> | null;
   ...
   * If #fromIndex is 0, returns same collection.
   */
  slice(positions: Collection<number | null> | null): Collection<E> | null;

  sliceByKey(keys: Collection<any> | null): Collection<E> | null;

  sliceByKey(secondaryIndex: string, keys: Collection<any> | null): Collection<E> | null;
   ...
   * ```
   */
  downsample(spec: DownsampleSpec): Collection<E> | null;
  ...
  rollingDiff(stride?: number | null): Collection<E> | null;

  pctChange(stride?: number | null): Collection<E> | null;

  unaryOp(op: string): Collection<E> | null;

  shape(): C3.Array<number | null>;

  toObj(): Obj | null;

  fetch(spec?: FetchSpec | null): Collection<E> | null;
  ...
  neg(): Collection<E> | null;

  approxMostFrequent(spec?: CountMinSketchSpec | null): C3.Map<string | null, number | null>;

  timeseries(spec?: DataTimeseriesSpec | null): Collection<R> | null;

  timeseries(tsFieldSpec: C3.Map<string | null, TimeseriesFieldSpec | null>, spec?: TimeseriesSpec | null): Collection<R> | null;
   ...
   */
  replaceType(old: Type, new_: Type): Collection<E>;
   ...
   * elements.
   */
  toMixingCollection(collectionType: CollectionType, failIfInvalid?: boolean): Collection<T> | null;
   ...
   */
  toInMemory(): CollectionInMemory<E> | null;
   ...
   */
  boxElements(): Collection<Boxed<E> | null> | null;
   ...
   */
  anonymize(spec?: AnonymizationSpec | null): Collection<E> | null;
   ...
   */
  withoutOutliers(spec?: OutliersSpec | null): Collection<E>;
   ...
   * @param spec configuration of the high and low filter criteria
   */
  extractOutliers(spec?: OutliersSpec | null): Collection<E>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Collection;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Collection<E> | null;
   ...
   *         point in the window starting at "offset" and spanning "span" data points.
   */
  rolling(agg: string, offset: number, span: number, step?: number | null): Collection<E> | null;
