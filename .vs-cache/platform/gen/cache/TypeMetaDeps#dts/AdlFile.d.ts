// TypeScript definitions for the C3 type AdlFile

/**
 * File containing the metadata and blob content from Azure data lake
 *
 * @remarks this represents a value passed to a method that expects an instance of AdlFile
 */
declare interface IAdlFile {
 ...
 * File containing the metadata and blob content from Azure data lake
 *
 * @remarks this represents a made instance of AdlFile
 */
declare class AdlFile extends Obj {
  ...
  withContentEncoding(contentEncoding: string | null): AdlFile;
  ...
  withContentLanguage(contentLanguage: string | null): AdlFile;
  ...
  withContentLength(contentLength: number | null): AdlFile;
  ...
  withContentLocation(contentLocation: string | null): AdlFile;
  ...
  withContentType(contentType: string | null): AdlFile;
  ...
  withContentDisposition(contentDisposition: string | null): AdlFile;
  ...
  withETag(eTag: string | null): AdlFile;
  ...
  withLastModified(lastModified: DateTime | Date | string | null): AdlFile;

  /**
   * Id of user / identity who last last modified this content.
   */
  readonly lastModifiedBy?: string | null;
  withLastModifiedBy(lastModifiedBy: string | null): AdlFile;
  ...
  withContentMD5(contentMD5: string | null): AdlFile;
  ...
  withContentSHA1(contentSHA1: string | null): AdlFile;

  /**
   * Field to maintain state whether content metadata was read or not.
   */
  readonly hasMetadata?: boolean;
  withHasMetadata(hasMetadata: boolean): AdlFile;

  /**
   * URL for this file that contains scheme (i.e. file-system) and fully qualified encoded path.
   */
  readonly url?: string | null;
  withUrl(url: string | null): AdlFile;

  /**
   * Custom user-metadata.
   */
  readonly userMetadata?: C3.Map<string | null, string | null>;
  withUserMetadata(userMetadata: C3.Map<string | null, string | null> | {[key: string | null]: string | null}): AdlFile;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): AdlFile | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): AdlFile | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): AdlFile | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): AdlFile | null;
   ...
   */
  replaceType(old: Type, new_: Type): AdlFile;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): AdlFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): AdlFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<AdlFile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<AdlFile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): AdlFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AdlFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AdlFile;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): AdlFile;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): AdlFile;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): AdlFile;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): AdlFile;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): AdlFile;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): AdlFile;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): AdlFile;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): AdlFile;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): AdlFile;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): AdlFile;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): AdlFile;
   ...
   * @see #unsetField
   */
  defaultField(field: string): AdlFile;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): AdlFile;
   ...
   * @see #removeField
   */
  unsetField(field: string): AdlFile;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): AdlFile;
   ...
   * @see #unsetField
   */
  removeField(field: string): AdlFile;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): AdlFile;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): AdlFile;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): AdlFile;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): AdlFile;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): AdlFile;

  mergeJson(json: any | null): AdlFile;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): AdlFile;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): AdlFile;
   ...
   */
  singletonArray(): C3.Array<AdlFile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<AdlFile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<AdlFile | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<AdlFile | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<AdlFile | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, AdlFile | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, AdlFile | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<AdlFile | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<AdlFile | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): AdlFile;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): AdlFile;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): AdlFile;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): AdlFile;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): AdlFile;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): AdlFile;
   ...
   * @see #fromString
   */
  static make(s: string | null): AdlFile | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): AdlFile;
   ...
   */
  static cachedEmptyInst(): AdlFile;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<AdlFile>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): AdlFile;
   ...
   */
  withFileName(fileName: string | null): AdlFile;

  /**
   * Changes file extension in this instance.
   */
  withFileExt(fileExt: string | null): AdlFile;
   ...
   */
  identify(suffix?: string | null): AdlFile;
   ...
   */
  readMetadata(spec?: FileOperationSpec | null): AdlFile;
   ...
   */
  refreshMetadata(spec?: FileOperationSpec | null): AdlFile;
   ...
   */
  encodedPushStream(spec?: FileOperationSpec | null): Pair<AdlFile | null, BytePushStream | null>;

  /**
   * @return byte push stream to be used for writing un-encoded data into this content object.
   */
  pushStream(spec?: FileOperationSpec | null): Pair<AdlFile | null, BytePushStream | null>;

  /**
   * @return character push stream to be used for writing un-encoded data into this content object.
   */
  charPushStream(spec?: FileOperationSpec | null): Pair<AdlFile | null, CharPushStream | null>;
   ...
   */
  encodedStream(spec?: FileOperationSpec | null): Pair<AdlFile | null, ByteStream | null> | null;
   ...
   */
  writeStream(content: ByteStream | null, spec?: FileOperationSpec | null): AdlFile;

  /**
   * Truncates file and replaces it's content with provided binary content.
   */
  writeInputStream(inputStream: any, spec?: FileOperationSpec | null): AdlFile;

  /**
   * Truncates file and replaces its content with provided binary content from zipInputStream
   */
  writeZipInputStream(zipInputStream: any, spec?: FileOperationSpec | null): AdlFile;
   ...
   */
  writeEncodedStream(encodedContent: ByteStream | null, spec?: FileOperationSpec | null): AdlFile;

  /**
   * Truncates file and replaces it's encoded content with provided binary content.
   */
  writeEncodedInputStream(inputStream: any, spec?: FileOperationSpec | null): AdlFile;
   ...
   *           content that needs to be written
   */
  write(content: any | null, spec?: FileOperationSpec | null): AdlFile;
   ...
   *           encoded content that needs to be written
   */
  writeEncoded(encodedContent: any | null, spec?: FileOperationSpec | null): AdlFile;
   ...
   *           content that needs to be written
   */
  writeString(content: string | null, spec?: FileOperationSpec | null): AdlFile;
   ...
   */
  writeObj(obj: Obj | null, spec?: FileObjsOperSpec | null): AdlFile;
   ...
   * @return pair of update instance of this content and number of objs written
   */
  startWriteObjs(spec?: FileObjsOperSpec | null): Pair<AdlFile | null, PushStream<Obj | null> | null>;
   ...
   */
  compress(contentEncoding?: string | null, spec?: FileCompressSpec | null): AdlFile;

  /**
   * Uncompresses file. Removes compression specific extension.
   */
  uncompress(spec?: FileCompressSpec | null): AdlFile;
   ...
   */
  transcode(contentType: string, contentEncoding: string, spec?: FileCompressSpec | null): AdlFile;

  /**
   * Copies content to a given target.
   */
  copyContentTo(target: AdlFile, spec?: FileOperationSpec | null): void;
   ...
   */
  static fromString(s: string | null): AdlFile | null;

  /**
   * Retrieves file-system for this file.
   */
  fs(): AdlFileSystem | null;
  ...
  static fsForThisType(): AdlFileSystem | null;
}
