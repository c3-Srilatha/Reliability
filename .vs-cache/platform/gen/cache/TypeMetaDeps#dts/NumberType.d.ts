// TypeScript definitions for the C3 type NumberType

/**
 * Base value type for all numeric value types.
 *
 * @remarks this represents a value passed to a method that expects an instance of NumberType
 */
declare interface INumberType {
 ...
 * Base value type for all numeric value types.
 *
 * @remarks this represents a made instance of NumberType
 */
declare class NumberType extends Obj {

  /**
   * Source file Pkg.Path a C3 Type declaration [.c3typ].
   */
  readonly declaredPkgPath?: string | null;
  withDeclaredPkgPath(declaredPkgPath: string | null): NumberType;

  /**
   * Source line number in a C3 Type declaration [.c3typ] file starting with 1 where this metadata element is declared.
   */
  readonly declaredSrcLine?: number | null;
  withDeclaredSrcLine(declaredSrcLine: number | null): NumberType;
  ...
  withDeclaredSrcCharInLine(declaredSrcCharInLine: number | null): NumberType;
   ...
   */
  readonly pkg: Pkg;
  withPkg(pkg: IPkg): NumberType;

  /**
   * SDK json representing instance of this type
   */
  readonly json?: any;
  withJson(json: any): NumberType;

  /**
   * The set of annotations defined on this element of metadata represented as json value.
   */
  readonly annotationsJson?: any | null;
  withAnnotationsJson(annotationsJson: any | null): NumberType;
  ...
  withModifier(modifier: string | null): NumberType;
  ...
  withName(name: string): NumberType;
  ...
  withSerializedType(serializedType: IValueType | null): NumberType;
  ...
  withEnumRefType(enumRefType: IReferenceType | null): NumberType;
  ...
  withDeclaredEnumValues(declaredEnumValues: C3.Array<string | null> | Array<string | null>): NumberType;
   ...
   */
  replaceType(old: Type, new_: Type): NumberType;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): NumberType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): NumberType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): NumberType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): NumberType | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NumberType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NumberType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NumberType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NumberType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): NumberType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NumberType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NumberType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): NumberType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): NumberType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): NumberType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): NumberType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): NumberType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): NumberType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): NumberType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): NumberType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): NumberType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): NumberType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): NumberType;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): NumberType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): NumberType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): NumberType;
   ...
   * @see #removeField
   */
  unsetField(field: string): NumberType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): NumberType;
   ...
   * @see #unsetField
   */
  removeField(field: string): NumberType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): NumberType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): NumberType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): NumberType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): NumberType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): NumberType;

  mergeJson(json: any | null): NumberType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): NumberType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): NumberType;
   ...
   */
  singletonArray(): C3.Array<NumberType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<NumberType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<NumberType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<NumberType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<NumberType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, NumberType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, NumberType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<NumberType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<NumberType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): NumberType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): NumberType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): NumberType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): NumberType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): NumberType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): NumberType;
   ...
   * @see #fromString
   */
  static make(s: string | null): NumberType | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): NumberType;
   ...
   */
  static cachedEmptyInst(): NumberType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<NumberType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): NumberType;
   ...
   */
  withoutDeclaredSrcPos(recursive?: boolean): NumberType;
   ...
   */
  withAnnotation(ann: Annotation): NumberType;
   ...
   *         value for the field
   */
  withAnnotation(ann: string, annField?: string | null, value?: any): NumberType;
   ...
   * @see #toString
   */
  static fromString(s: string | null): NumberType | null;
