// TypeScript definitions for the C3 type PiiQueue

/**
 * Invalidation queue for PII access audit.
 *
 * @see PiiQueueEntry
 *
 * @remarks this represents a value passed to a method that expects an instance of PiiQueue
 */
declare interface IPiiQueue {
}
 ...
 * @see PiiQueueEntry
 *
 * @remarks this represents a made instance of PiiQueue
 */
declare class PiiQueue {
   ...
   */
  static compute(targetType: Type, entries: C3.Array<PiiQueueEntry | null> | null): void;
   ...
   */
  static find(spec?: InvalidationQueue.FindSpec | null): C3.Array<PiiQueueEntry | null>;
   ...
   * @return the list of requested entries.
   */
  static findStream(spec?: InvalidationQueue.FindStreamSpec | null): Stream<PiiQueueEntry | null>;
   ...
   *           Entries to remove.
   */
  static clearEntries(entries: C3.Array<PiiQueueEntry | null> | null): void;
  ...
  static submitEvents(typeRef: Type, events: C3.Array<PiiAccessEvent | null>, autoCommit?: boolean): void;
}
