// TypeScript definitions for the C3 type ContentSourceCollection.Config

/**
 * @remarks this represents a value passed to a method that expects an instance of ContentSourceCollection.Config
 */
declare namespace ContentSourceCollection {
...
declare namespace ContentSourceCollection {
  export class Config extends Obj {
    ...
    withContentTypeOverride(contentTypeOverride: string | null): ContentSourceCollection.Config;
    ...
    withContentEncodingOverride(contentEncodingOverride: string | null): ContentSourceCollection.Config;
    ...
    withDefaultContentType(defaultContentType: string | null): ContentSourceCollection.Config;
    ...
    withDefaultContentEncoding(defaultContentEncoding: string | null): ContentSourceCollection.Config;

    /**
     * Specifies various parameters for automatic retry that occurs in upsert due to retryable errors.
     */
    readonly retrySpec?: RetrySpec | null;
    withRetrySpec(retrySpec: IRetrySpec | null): ContentSourceCollection.Config;
    ...
    withValidateContentType(validateContentType: boolean): ContentSourceCollection.Config;
    ...
    withPeekForMetadata(peekForMetadata: boolean): ContentSourceCollection.Config;
    ...
    withFailIfMissing(failIfMissing: boolean): ContentSourceCollection.Config;
    ...
    withSkipIfUnauthorized(skipIfUnauthorized: boolean): ContentSourceCollection.Config;

    /**
     * If set and if requested file or directory url is under this path then will retrieve content from cache.
     */
    readonly cacheUrlOrEncodedPath?: string | null;
    withCacheUrlOrEncodedPath(cacheUrlOrEncodedPath: string | null): ContentSourceCollection.Config;

    /**
     * Time in seconds that the cached file should live (default 24 hours).
     */
    readonly cacheTtlSec?: number | null;
    withCacheTtlSec(cacheTtlSec: number | null): ContentSourceCollection.Config;
    ...
    withForceMultiPart(forceMultiPart: boolean): ContentSourceCollection.Config;
    ...
    withDisableMultiPart(disableMultiPart: boolean): ContentSourceCollection.Config;

    /**
     * Overrides default maximum file size before MultipartUpload kicks in. Default is 1GB
     */
    readonly maximumSingleUploadsize?: number | null;
    withMaximumSingleUploadsize(maximumSingleUploadsize: number | null): ContentSourceCollection.Config;
    ...
    withMaxThreads(maxThreads: number | null): ContentSourceCollection.Config;
    ...
    withMinThreads(minThreads: number | null): ContentSourceCollection.Config;

    /**
     * If set to true, it will retry reading file when the file is not found.
     */
    readonly retryOnNotFound?: boolean;
    withRetryOnNotFound(retryOnNotFound: boolean): ContentSourceCollection.Config;
    ...
    withLockOnWrite(lockOnWrite: boolean): ContentSourceCollection.Config;

    /**
     * If set will use IoExecutor service.
     */
    readonly useIoExecutor?: boolean;
    withUseIoExecutor(useIoExecutor: boolean): ContentSourceCollection.Config;

    /**
     * If not null, retry logic will be used from CloudClient rather than File
     */
    readonly cloudClient?: any;
    withCloudClient(cloudClient: any): ContentSourceCollection.Config;

    /**
     * If provided, list files will return only files whose name matches the provided glob.
     */
    readonly globPattern?: string | null;
    withGlobPattern(globPattern: string | null): ContentSourceCollection.Config;

    /**
     * If provided, list files will return only files that end with the provided suffix.
     */
    readonly fileSuffix?: string | null;
    withFileSuffix(fileSuffix: string | null): ContentSourceCollection.Config;

    /**
     * When listing files, set this to true to include directories if the FileSystem supports Files referencing directories
     */
    readonly includeDirs?: boolean;
    withIncludeDirs(includeDirs: boolean): ContentSourceCollection.Config;
    ...
    withHiddenFiles(hiddenFiles: boolean): ContentSourceCollection.Config;
    ...
    withDoNotChunk(doNotChunk: boolean | null): ContentSourceCollection.Config;

    /**
     * If set to true then it will clean existing chunks before chunking
     */
    readonly cleanupPendingChunks?: boolean;
    withCleanupPendingChunks(cleanupPendingChunks: boolean): ContentSourceCollection.Config;

    /**
     * If not set then SourceStatus will be persisted in {@link SourceFile} or in {@link SourceCollection#statsUrl}
     */
    readonly doNotArchiveStatus?: boolean;
    withDoNotArchiveStatus(doNotArchiveStatus: boolean): ContentSourceCollection.Config;
    ...
    withDoNotArchiveSources(doNotArchiveSources: boolean): ContentSourceCollection.Config;
    ...
    withDoNotArchiveFailedSources(doNotArchiveFailedSources: boolean): ContentSourceCollection.Config;

    /**
     * Indicates the threshold of acceptable number of errors
     */
    readonly numErrorsToAbort?: number | null;
    withNumErrorsToAbort(numErrorsToAbort: number | null): ContentSourceCollection.Config;
    ...
    withNumRetries(numRetries: number | null): ContentSourceCollection.Config;
    ...
    withProcessMode(processMode: string): ContentSourceCollection.Config;
    ...
    withProcessSchedule(processSchedule: string | null): ContentSourceCollection.Config;
    ...
    withPriority(priority: number | null): ContentSourceCollection.Config;

    /**
     * User can choose to change the #archiveUrl for the SourceCollection.
     */
    readonly archiveUrlOverride?: string | null;
    withArchiveUrlOverride(archiveUrlOverride: string | null): ContentSourceCollection.Config;
    ...
    withExternalOverride(externalOverride: boolean | null): ContentSourceCollection.Config;
    ...
    withInboxUrlOverride(inboxUrlOverride: string | null): ContentSourceCollection.Config;
    ...
    withTargetCollectionOverrides(targetCollectionOverrides: C3.Map<string | null, TargetCollection<any> | null> | {[key: string | null]: ITargetCollection<any> | null}): ContentSourceCollection.Config;

    /**
     * Overrides the csvHeader specified in the contentType.
     */
    readonly csvHeaderOverride?: string | null;
    withCsvHeaderOverride(csvHeaderOverride: string | null): ContentSourceCollection.Config;

    /**
     * Overrides the csvDelimiter specified contentType.
     */
    readonly csvDelimiterOverride?: string | null;
    withCsvDelimiterOverride(csvDelimiterOverride: string | null): ContentSourceCollection.Config;

    /**
     * Escape character override for CSV file.
     */
    readonly csvEscapeCharOverride?: string | null;
    withCsvEscapeCharOverride(csvEscapeCharOverride: string | null): ContentSourceCollection.Config;

    /**
     * Quote character override for CSV file.
     */
    readonly csvQuoteCharOverride?: string | null;
    withCsvQuoteCharOverride(csvQuoteCharOverride: string | null): ContentSourceCollection.Config;
    ...
    withNoCsvHeader(noCsvHeader: boolean): ContentSourceCollection.Config;

    /**
     * Optional format for a csv values. Key should be field path used in a csv header.
     */
    readonly csvFormat?: C3.Map<string | null, Format | null>;
    withCsvFormat(csvFormat: C3.Map<string | null, Format | null> | {[key: string | null]: IFormat | null}): ContentSourceCollection.Config;
    ...
    withAvroSchemaOverride(avroSchemaOverride: string | null): ContentSourceCollection.Config;
    ...
    withIsObjList(isObjList: boolean): ContentSourceCollection.Config;

    /**
     * Optionally fail to serialize extra fields in serialized content instead of ignoring.
     */
    readonly failOnExtraFields?: boolean;
    withFailOnExtraFields(failOnExtraFields: boolean): ContentSourceCollection.Config;

    /**
     * If true will silently ignore bad syntax in the content and will return no or partial results.
     */
    readonly ignoreBadContent?: boolean;
    withIgnoreBadContent(ignoreBadContent: boolean): ContentSourceCollection.Config;

    /**
     * If set will ignore value conversion errors (e.g. non numeric strings will get converted to null for numeric fields)
     */
    readonly ignoreValueConversionErrors?: boolean;
    withIgnoreValueConversionErrors(ignoreValueConversionErrors: boolean): ContentSourceCollection.Config;
    ...
    withMergeXmlNonAdjacentLists(mergeXmlNonAdjacentLists: boolean): ContentSourceCollection.Config;
    ...
    withMinByteSizeToChunk(minByteSizeToChunk: number | null): ContentSourceCollection.Config;

    /**
     * if set to true then target objs will include {@link Sources#sourcesMeta}
     */
    readonly includeMeta?: boolean;
    withIncludeMeta(includeMeta: boolean): ContentSourceCollection.Config;

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): ContentSourceCollection.Config;

    readonly configOverride?: string | null;
    withConfigOverride(configOverride: string | null): ContentSourceCollection.Config;

    readonly secretOverride?: string | null;
    withSecretOverride(secretOverride: string | null): ContentSourceCollection.Config;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: C3.Array<string | null>;
    withIssues(issues: C3.Array<string | null> | Array<string | null>): ContentSourceCollection.Config;
    ...
    withChunkSize(chunkSize: number | null): ContentSourceCollection.Config;
    ...
    withChunkSizeInMb(chunkSizeInMb: number | null): ContentSourceCollection.Config;

    /**
     * The prefix of the file name which has data for the canonical
     */
    readonly filePrefix?: string | null;
    withFilePrefix(filePrefix: string | null): ContentSourceCollection.Config;

    /**
     * If true, incoming sources are persisted in intermediate data storage before processing
     */
    readonly stage?: boolean;
    withStage(stage: boolean): ContentSourceCollection.Config;
    ...
    withStagingMode(stagingMode: string | null): ContentSourceCollection.Config;

    /**
     * The name of the {@link FileSourceCollection} used to manage staged files, if stagingMode is FILE
     */
    readonly stageFileSourceCollectionName?: string | null;
    withStageFileSourceCollectionName(stageFileSourceCollectionName: string | null): ContentSourceCollection.Config;
    ...
    withSourceFileNameFormat(sourceFileNameFormat: string | null): ContentSourceCollection.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): ContentSourceCollection.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): ContentSourceCollection.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): ContentSourceCollection.Config | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): ContentSourceCollection.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): ContentSourceCollection.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ContentSourceCollection.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ContentSourceCollection.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ContentSourceCollection.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ContentSourceCollection.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ContentSourceCollection.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ContentSourceCollection.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ContentSourceCollection.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ContentSourceCollection.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ContentSourceCollection.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ContentSourceCollection.Config;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ContentSourceCollection.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ContentSourceCollection.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ContentSourceCollection.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): ContentSourceCollection.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): ContentSourceCollection.Config;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): ContentSourceCollection.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ContentSourceCollection.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ContentSourceCollection.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ContentSourceCollection.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ContentSourceCollection.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ContentSourceCollection.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): ContentSourceCollection.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ContentSourceCollection.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): ContentSourceCollection.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ContentSourceCollection.Config;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ContentSourceCollection.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): ContentSourceCollection.Config;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ContentSourceCollection.Config;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ContentSourceCollection.Config;

    mergeJson(json: any | null): ContentSourceCollection.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ContentSourceCollection.Config;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): ContentSourceCollection.Config;
     ...
     */
    singletonArray(): C3.Array<ContentSourceCollection.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<ContentSourceCollection.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ContentSourceCollection.Config | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<ContentSourceCollection.Config | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ContentSourceCollection.Config | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, ContentSourceCollection.Config | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ContentSourceCollection.Config | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ContentSourceCollection.Config | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ContentSourceCollection.Config | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ContentSourceCollection.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ContentSourceCollection.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ContentSourceCollection.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ContentSourceCollection.Config;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ContentSourceCollection.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ContentSourceCollection.Config;
     ...
     * @see #fromString
     */
    static make(s: string | null): ContentSourceCollection.Config | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ContentSourceCollection.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ContentSourceCollection.Config;
     ...
     */
    static cachedEmptyInst(): ContentSourceCollection.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ContentSourceCollection.Config>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): ContentSourceCollection.Config;

    /**
     * @return new instance of this spec with `retrySpec` set
     */
    withRetry(maxRetries?: number | null, initialSleepMillis?: number | null, exponent?: number | null): ContentSourceCollection.Config | null;

    /**
     * @return instance of this spec with `retrySpec`'s `maxTotalMillis` set
     */
    static timeoutSeconds(secs: number | null): ContentSourceCollection.Config;
     ...
     * @see #toString
     */
    static fromString(s: string | null): ContentSourceCollection.Config | null;
     ...
     */
    static forName(name: string | null, failIfMissing?: boolean): ContentSourceCollection.Config | null;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<ContentSourceCollection.Config | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<ContentSourceCollection.Config | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ContentSourceCollection.Config | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): ContentSourceCollection.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string | null): ContentSourceCollection.Config | null;
     ...
     * @see findByCacheKey
     */
    getCached(): ContentSourceCollection.Config | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): ContentSourceCollection.Config | null;
     ...
     */
    static produce(key: string): ContentSourceCollection.Config | null;
     ...
     */
    static produceAll(): C3.Map<string | null, ContentSourceCollection.Config | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, ContentSourceCollection.Config | null>;
     ...
     */
    getConfig(): ContentSourceCollection.Config;
     ...
     */
    getSecret(): ContentSourceCollection.Config;
     ...
     */
    static forConfigKey(configKey: string | null): ContentSourceCollection.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<ContentSourceCollection.Config | null>;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: ContentSourceCollection.Config, override?: string | null): void;
     ...
     * @see setSecretValue
     */
    setSecretValues(from: ContentSourceCollection.Config, override?: string | null): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): ContentSourceCollection.Config | null;
