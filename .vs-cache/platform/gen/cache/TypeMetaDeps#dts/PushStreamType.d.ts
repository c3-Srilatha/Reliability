// TypeScript definitions for the C3 type PushStreamType

/**
 * A push-stream is a notification mechanism or communication channel that data producer [ e.g. server process ] is
 * using for delivering new data to caller / client.
 *
 * Push Streams are declared in DSL using `push stream<E>` syntax:
 * ```type
 * // a push-stream of float values
 * metrics: push stream<float>
 * ```
 *
 * @see Stream
 * Also see [Streams](streams.c3doc).
 *
 * @remarks this represents a value passed to a method that expects an instance of PushStreamType
 */
declare interface IPushStreamType {
  ...
  /**
   * The value type for the elements of this push-stream.
   */
 ...
 * Also see [Streams](streams.c3doc).
 *
 * @remarks this represents a made instance of PushStreamType
 */
declare class PushStreamType extends Obj {

  /**
   * Source file Pkg.Path a C3 Type declaration [.c3typ].
   */
  readonly declaredPkgPath?: string | null;
  withDeclaredPkgPath(declaredPkgPath: string | null): PushStreamType;

  /**
   * Source line number in a C3 Type declaration [.c3typ] file starting with 1 where this metadata element is declared.
   */
  readonly declaredSrcLine?: number | null;
  withDeclaredSrcLine(declaredSrcLine: number | null): PushStreamType;
  ...
  withDeclaredSrcCharInLine(declaredSrcCharInLine: number | null): PushStreamType;
   ...
   */
  readonly pkg: Pkg;
  withPkg(pkg: IPkg): PushStreamType;

  /**
   * SDK json representing instance of this type
   */
  readonly json?: any;
  withJson(json: any): PushStreamType;

  /**
   * The set of annotations defined on this element of metadata represented as json value.
   */
  readonly annotationsJson?: any | null;
  withAnnotationsJson(annotationsJson: any | null): PushStreamType;
  ...
  withModifier(modifier: string | null): PushStreamType;

  /**
   * The value type for the elements of this push-stream.
   */
  readonly elementType: ValueType;
  withElementType(elementType: IValueType): PushStreamType;
   ...
   */
  replaceType(old: Type, new_: Type): PushStreamType;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): PushStreamType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): PushStreamType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): PushStreamType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): PushStreamType | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PushStreamType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PushStreamType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PushStreamType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PushStreamType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): PushStreamType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PushStreamType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PushStreamType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PushStreamType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PushStreamType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PushStreamType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): PushStreamType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PushStreamType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PushStreamType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): PushStreamType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): PushStreamType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): PushStreamType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): PushStreamType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PushStreamType;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): PushStreamType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PushStreamType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PushStreamType;
   ...
   * @see #removeField
   */
  unsetField(field: string): PushStreamType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PushStreamType;
   ...
   * @see #unsetField
   */
  removeField(field: string): PushStreamType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PushStreamType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): PushStreamType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): PushStreamType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): PushStreamType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): PushStreamType;

  mergeJson(json: any | null): PushStreamType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): PushStreamType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): PushStreamType;
   ...
   */
  singletonArray(): C3.Array<PushStreamType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<PushStreamType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PushStreamType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<PushStreamType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PushStreamType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, PushStreamType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PushStreamType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PushStreamType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PushStreamType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): PushStreamType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): PushStreamType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): PushStreamType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PushStreamType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): PushStreamType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PushStreamType;
   ...
   * @see #fromString
   */
  static make(s: string | null): PushStreamType | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): PushStreamType;
   ...
   */
  static cachedEmptyInst(): PushStreamType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<PushStreamType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): PushStreamType;
   ...
   */
  withoutDeclaredSrcPos(recursive?: boolean): PushStreamType;
   ...
   */
  withAnnotation(ann: Annotation): PushStreamType;
   ...
   *         value for the field
   */
  withAnnotation(ann: string, annField?: string | null, value?: any): PushStreamType;
   ...
   * @see #toString
   */
  static fromString(s: string | null): PushStreamType | null;
