// TypeScript definitions for the C3 type DataIssue
 ...
 * by platform.
 *
 * @remarks this represents a value passed to a method that expects an instance of DataIssue
 */
declare interface IDataIssue {
 ...
 */
declare class DataIssue extends Obj {

  /**
   * Target type of the obj with the issue.
   */
  readonly targetType: string;
  withTargetType(targetType: string): DataIssue;

  /**
   * Id of obj with the issue.  If null, the issue applies to all objs for the `targetType`
   */
  readonly targetId?: string | null;
  withTargetId(targetId: string | null): DataIssue;

  /**
   * Field with the issue.  If null, the issue applies to all fields in the `targetType` (where applicable).
   */
  readonly targetField?: string | null;
  withTargetField(targetField: string | null): DataIssue;

  /**
   * DataIssue severity.
   */
  readonly severity: string;
  withSeverity(severity: string): DataIssue;
  ...
  withTypeIdent(typeIdent: string | null): DataIssue;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): DataIssue;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): DataIssue;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): DataIssue;
  ...
  withVersion(version: number | null): DataIssue;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): DataIssue;

  /**
   * Error message indicating the nature of the issue.
   */
  readonly errorMsg?: string | null;
  withErrorMsg(errorMsg: string | null): DataIssue;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): DataIssue | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): DataIssue | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): DataIssue | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): DataIssue | null;
   ...
   */
  replaceType(old: Type, new_: Type): DataIssue;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataIssue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataIssue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataIssue | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataIssue | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataIssue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataIssue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataIssue;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DataIssue;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DataIssue;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DataIssue;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataIssue;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataIssue;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DataIssue;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): DataIssue;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): DataIssue;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): DataIssue;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataIssue;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DataIssue;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataIssue;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DataIssue;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DataIssue;
   ...
   * @see #removeField
   */
  unsetField(field: string): DataIssue;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DataIssue;
   ...
   * @see #unsetField
   */
  removeField(field: string): DataIssue;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DataIssue;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataIssue;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): DataIssue;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataIssue;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataIssue;

  mergeJson(json: any | null): DataIssue;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataIssue;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): DataIssue;
   ...
   */
  singletonArray(): C3.Array<DataIssue | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<DataIssue | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DataIssue | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<DataIssue | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DataIssue | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, DataIssue | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataIssue | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DataIssue | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DataIssue | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DataIssue;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DataIssue;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DataIssue;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DataIssue;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DataIssue;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DataIssue;
   ...
   * @see #fromString
   */
  static make(s: string | null): DataIssue | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DataIssue;
   ...
   */
  static cachedEmptyInst(): DataIssue;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DataIssue>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): DataIssue;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<DataIssue | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<DataIssue | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<DataIssue | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<DataIssue | null> | null>;
   ...
   */
  get(include?: string | null): DataIssue | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): DataIssue | null;
   ...
   */
  getMissing(spec: GetMissingSpec): DataIssue;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): DataIssue | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): DataIssue;
   ...
   * @see #toString
   */
  static fromString(s: string | null): DataIssue | null;
   ...
   */
  create(spec?: UpsertSpec | null): DataIssue | null;
   ...
   */
  static createBatch(objs: C3.Array<DataIssue | null> | null, spec?: UpsertSpec | null): ObjList<DataIssue | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<DataIssue | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<DataIssue | null> | null;
   ...
   */
  update(srcObj?: DataIssue | null, spec?: UpsertSpec | null): DataIssue | null;
   ...
   */
  upsert(srcObj?: DataIssue | null, spec?: UpsertSpec | null): DataIssue | null;
   ...
   */
  merge(spec?: MergeSpec | null): DataIssue | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): DataIssue | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): DataIssue | null;
   ...
   */
  static updateBatch(objs: C3.Array<DataIssue | null> | null, srcObjs?: C3.Array<DataIssue | null>, spec?: UpsertSpec | null): ObjList<DataIssue | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<DataIssue | null>>, spec?: UpsertSpec | null): ObjList<DataIssue | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<DataIssue | null> | null, srcObjs?: C3.Array<DataIssue | null>, spec?: UpsertSpec | null): ObjList<DataIssue | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<DataIssue | null>>, spec?: UpsertSpec | null): ObjList<DataIssue | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<DataIssue | null> | null, spec?: TouchSpec | null): ObjList<DataIssue | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<DataIssue | null> | null, spec?: MergeSpec | null): ObjList<DataIssue | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<DataIssue | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<DataIssue | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<DataIssue | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<DataIssue | null> | null;
   ...
   */
  static mergeAll(mergeObj: DataIssue | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: DataIssue | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<DataIssue | null> | null, spec?: UpsertSpec | null): ObjList<DataIssue | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<DataIssue | null> | null, spec?: UpsertSpec | null): ObjList<DataIssue | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<DataIssue | null> | null): ObjList<DataIssue | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<DataIssue | null> | null): ObjList<DataIssue | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<DataIssue | null> | null): ObjList<DataIssue | null>;
   ...
   */
  static afterCreate(objs: C3.Array<DataIssue | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<DataIssue | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<DataIssue | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<DataIssue | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<DataIssue | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): DataIssue | null;
   ...
   */
  withoutIdentity(): DataIssue | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<DataIssue | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: DataIssue | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<DataIssue | null> | null, callback?: λFunction<DataIssue | null, DataIssue | null> | null): ObjList<DataIssue | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<DataIssue | null> | null, callback?: λFunction<DataIssue | null, DataIssue | null> | null): C3.Array<ObjError | null>;
