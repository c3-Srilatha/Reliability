// TypeScript definitions for the C3 type LukeTestPage
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of LukeTestPage
 */
declare interface ILukeTestPage {
 ...
 * It holds reusable selectors and functions for a page in {@link LukeCore} tests.
 *
 * @remarks this represents a made instance of LukeTestPage
 */
declare class LukeTestPage extends Obj {

  /**
   * The Luke instance attached to this component.
   */
  readonly luke: LukeBrowser;
  withLuke(luke: ILukeBrowser): LukeTestPage;
  ...
  withParentSelector(parentSelector: string | null): LukeTestPage;

  /**
   * The spinner that masks the component when data is loading
   */
  readonly spinner?: string | null;
  withSpinner(spinner: string | null): LukeTestPage;
  ...
  withRenderingSelectors(renderingSelectors: C3.Array<string | null> | Array<string | null>): LukeTestPage;

  /**
   * The maximum amount of time that Luke will retry an action
   */
  readonly timeout?: number | null;
  withTimeout(timeout: number | null): LukeTestPage;
  ...
  withPageComponentId(pageComponentId: string | null): LukeTestPage;

  /**
   * Default user name
   */
  readonly username?: string | null;
  withUsername(username: string | null): LukeTestPage;

  /**
   * Default password
   */
  readonly password?: string | null;
  withPassword(password: string | null): LukeTestPage;
  ...
  withPath(path: string | null): LukeTestPage;

  readonly domain?: string | null;
  withDomain(domain: string | null): LukeTestPage;
  ...
  withBaseUrl(baseUrl: string | null): LukeTestPage;
  ...
  withPathParams(pathParams: C3.Map<string | null, string | null> | {[key: string | null]: string | null}): LukeTestPage;
  ...
  withParamsId(paramsId: string | null): LukeTestPage;
  ...
  withAdditionalParams(additionalParams: any | null): LukeTestPage;
  ...
  withFragment(fragment: string | null): LukeTestPage;

  /**
   * The title of the page
   */
  readonly title?: string | null;
  withTitle(title: string | null): LukeTestPage;

  /**
   * Modal element
   */
  readonly modalElement?: string | null;
  withModalElement(modalElement: string | null): LukeTestPage;

  /**
   * Element of modal title
   */
  readonly modalTitleElement?: string | null;
  withModalTitleElement(modalTitleElement: string | null): LukeTestPage;

  /**
   * Element of modal body
   */
  readonly modalBodyElement?: string | null;
  withModalBodyElement(modalBodyElement: string | null): LukeTestPage;

  /**
   * Element that contains the breadcrumbs on the page
   */
  readonly breadcrumbsEl?: string | null;
  withBreadcrumbsEl(breadcrumbsEl: string | null): LukeTestPage;
  ...
  withSideSubMenuMinimizeButtonEl(sideSubMenuMinimizeButtonEl: string | null): LukeTestPage;

  /**
   * Selector for side sub menu container
   */
  readonly sideSubMenuContainerEl?: string | null;
  withSideSubMenuContainerEl(sideSubMenuContainerEl: string | null): LukeTestPage;

  /**
   * Selector for side sub menu nav container, which are children of {@see sideSubMenuContainerEl}
   */
  readonly sideSubMenuNavContainerEl?: string | null;
  withSideSubMenuNavContainerEl(sideSubMenuNavContainerEl: string | null): LukeTestPage;

  /**
   * Dependency crumbs element
   */
  readonly dependencyCrumbsEl?: string | null;
  withDependencyCrumbsEl(dependencyCrumbsEl: string | null): LukeTestPage;

  /**
   * Selector for items in the side sub menu
   */
  readonly sideSubMenuItemEl?: string | null;
  withSideSubMenuItemEl(sideSubMenuItemEl: string | null): LukeTestPage;

  /**
   * Side menu collapse button
   */
  readonly sideMenuCollapseButton?: string | null;
  withSideMenuCollapseButton(sideMenuCollapseButton: string | null): LukeTestPage;

  /**
   * The id of the {@link PageGroup} for this page
   */
  readonly pageGroup?: string | null;
  withPageGroup(pageGroup: string | null): LukeTestPage;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LukeTestPage | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LukeTestPage | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LukeTestPage | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LukeTestPage | null;
   ...
   */
  replaceType(old: Type, new_: Type): LukeTestPage;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestPage;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeTestPage;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestPage | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeTestPage | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LukeTestPage;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestPage;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeTestPage;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LukeTestPage;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LukeTestPage;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LukeTestPage;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LukeTestPage;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LukeTestPage;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LukeTestPage;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LukeTestPage;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LukeTestPage;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LukeTestPage;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LukeTestPage;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LukeTestPage;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LukeTestPage;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LukeTestPage;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LukeTestPage;
   ...
   * @see #removeField
   */
  unsetField(field: string): LukeTestPage;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LukeTestPage;
   ...
   * @see #unsetField
   */
  removeField(field: string): LukeTestPage;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LukeTestPage;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LukeTestPage;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LukeTestPage;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LukeTestPage;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LukeTestPage;

  mergeJson(json: any | null): LukeTestPage;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LukeTestPage;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LukeTestPage;
   ...
   */
  singletonArray(): C3.Array<LukeTestPage | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LukeTestPage | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LukeTestPage | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LukeTestPage | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LukeTestPage | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LukeTestPage | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LukeTestPage | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LukeTestPage | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LukeTestPage | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LukeTestPage;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LukeTestPage;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LukeTestPage;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LukeTestPage;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LukeTestPage;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LukeTestPage;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LukeTestPage;
   ...
   */
  static cachedEmptyInst(): LukeTestPage;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LukeTestPage>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LukeTestPage;
