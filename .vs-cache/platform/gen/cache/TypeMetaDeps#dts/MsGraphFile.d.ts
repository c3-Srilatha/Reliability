// TypeScript definitions for the C3 type MsGraphFile

/**
 * MsGraphFile represents OneDrive/SharePoint content
 *
 * @remarks this represents a value passed to a method that expects an instance of MsGraphFile
 */
declare interface IMsGraphFile {
   ...
   * Note This property isn't returned if the item is a folder. Read-only.
   */
  cTag?: string | null;

  /**
   * Id of user / identity who created the file.
   */
   ...
   */
  createdDateTime?: DateTime | Date | string | null;
}

/**
 * MsGraphFile represents OneDrive/SharePoint content
 *
 * @remarks this represents a made instance of MsGraphFile
 */
declare class MsGraphFile extends Obj {
  ...
  withContentEncoding(contentEncoding: string | null): MsGraphFile;
  ...
  withContentLanguage(contentLanguage: string | null): MsGraphFile;
  ...
  withContentLength(contentLength: number | null): MsGraphFile;
  ...
  withContentLocation(contentLocation: string | null): MsGraphFile;
  ...
  withContentType(contentType: string | null): MsGraphFile;
  ...
  withContentDisposition(contentDisposition: string | null): MsGraphFile;
  ...
  withETag(eTag: string | null): MsGraphFile;
  ...
  withLastModified(lastModified: DateTime | Date | string | null): MsGraphFile;

  /**
   * Id of user / identity who last last modified this content.
   */
  readonly lastModifiedBy?: string | null;
  withLastModifiedBy(lastModifiedBy: string | null): MsGraphFile;
  ...
  withContentMD5(contentMD5: string | null): MsGraphFile;
  ...
  withContentSHA1(contentSHA1: string | null): MsGraphFile;

  /**
   * Field to maintain state whether content metadata was read or not.
   */
  readonly hasMetadata?: boolean;
  withHasMetadata(hasMetadata: boolean): MsGraphFile;

  /**
   * URL for this file that contains scheme (i.e. file-system) and fully qualified encoded path.
   */
  readonly url?: string | null;
  withUrl(url: string | null): MsGraphFile;

  /**
   * Custom user-metadata.
   */
  readonly userMetadata?: C3.Map<string | null, string | null>;
  withUserMetadata(userMetadata: C3.Map<string | null, string | null> | {[key: string | null]: string | null}): MsGraphFile;

  readonly fileId?: string | null;
  withFileId(fileId: string | null): MsGraphFile;

  /**
   * The ID of the drive where the file is stored
   */
  readonly driveId?: string | null;
  withDriveId(driveId: string | null): MsGraphFile;
  ...
  withCTag(cTag: string | null): MsGraphFile;

  /**
   * Id of user / identity who created the file.
   */
  readonly createdBy?: string | null;
  withCreatedBy(createdBy: string | null): MsGraphFile;

  /**
   * The date and time at which the file was created.
   */
  readonly createdDateTime?: DateTime | null;
  withCreatedDateTime(createdDateTime: DateTime | Date | string | null): MsGraphFile;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): MsGraphFile | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): MsGraphFile | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): MsGraphFile | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): MsGraphFile | null;
   ...
   */
  replaceType(old: Type, new_: Type): MsGraphFile;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MsGraphFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MsGraphFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MsGraphFile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MsGraphFile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): MsGraphFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MsGraphFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MsGraphFile;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): MsGraphFile;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): MsGraphFile;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): MsGraphFile;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): MsGraphFile;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): MsGraphFile;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): MsGraphFile;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): MsGraphFile;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): MsGraphFile;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): MsGraphFile;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): MsGraphFile;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): MsGraphFile;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): MsGraphFile;
   ...
   * @see #unsetField
   */
  defaultField(field: string): MsGraphFile;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): MsGraphFile;
   ...
   * @see #removeField
   */
  unsetField(field: string): MsGraphFile;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): MsGraphFile;
   ...
   * @see #unsetField
   */
  removeField(field: string): MsGraphFile;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): MsGraphFile;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): MsGraphFile;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): MsGraphFile;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): MsGraphFile;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): MsGraphFile;

  mergeJson(json: any | null): MsGraphFile;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): MsGraphFile;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): MsGraphFile;
   ...
   */
  singletonArray(): C3.Array<MsGraphFile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<MsGraphFile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<MsGraphFile | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<MsGraphFile | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<MsGraphFile | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, MsGraphFile | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, MsGraphFile | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<MsGraphFile | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<MsGraphFile | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): MsGraphFile;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): MsGraphFile;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): MsGraphFile;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): MsGraphFile;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): MsGraphFile;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): MsGraphFile;
   ...
   * @see #fromString
   */
  static make(s: string | null): MsGraphFile | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): MsGraphFile;
   ...
   */
  static cachedEmptyInst(): MsGraphFile;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<MsGraphFile>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): MsGraphFile;
   ...
   */
  withFileName(fileName: string | null): MsGraphFile;

  /**
   * Changes file extension in this instance.
   */
  withFileExt(fileExt: string | null): MsGraphFile;
   ...
   */
  identify(suffix?: string | null): MsGraphFile;
   ...
   */
  readMetadata(spec?: FileOperationSpec | null): MsGraphFile;
   ...
   */
  refreshMetadata(spec?: FileOperationSpec | null): MsGraphFile;
   ...
   * @return abstract content with metadata.
   */
  guessMetadata(spec?: FileOperationSpec | null): MsGraphFile;

  /**
   * Clears the content metadata; e.g. if it's known to be invalid.
   */
  clearMetadata(): MsGraphFile;

  /**
   * @return clone of this content with metadata from provided input.
   */
  withMetadata(meta?: ContentMeta | null): MsGraphFile;
   ...
   */
  encodedPushStream(spec?: FileOperationSpec | null): Pair<MsGraphFile | null, BytePushStream | null>;

  /**
   * @return byte push stream to be used for writing un-encoded data into this content object.
   */
  pushStream(spec?: FileOperationSpec | null): Pair<MsGraphFile | null, BytePushStream | null>;

  /**
   * @return character push stream to be used for writing un-encoded data into this content object.
   */
  charPushStream(spec?: FileOperationSpec | null): Pair<MsGraphFile | null, CharPushStream | null>;
   ...
   */
  encodedStream(spec?: FileOperationSpec | null): Pair<MsGraphFile | null, ByteStream | null> | null;
   ...
   */
  writeStream(content: ByteStream | null, spec?: FileOperationSpec | null): MsGraphFile;

  /**
   * Truncates file and replaces it's content with provided binary content.
   */
  writeInputStream(inputStream: any, spec?: FileOperationSpec | null): MsGraphFile;

  /**
   * Truncates file and replaces its content with provided binary content from zipInputStream
   */
  writeZipInputStream(zipInputStream: any, spec?: FileOperationSpec | null): MsGraphFile;
   ...
   */
  writeEncodedStream(encodedContent: ByteStream | null, spec?: FileOperationSpec | null): MsGraphFile;

  /**
   * Truncates file and replaces it's encoded content with provided binary content.
   */
  writeEncodedInputStream(inputStream: any, spec?: FileOperationSpec | null): MsGraphFile;
   ...
   *           content that needs to be written
   */
  write(content: any | null, spec?: FileOperationSpec | null): MsGraphFile;
   ...
   *           encoded content that needs to be written
   */
  writeEncoded(encodedContent: any | null, spec?: FileOperationSpec | null): MsGraphFile;
   ...
   *           content that needs to be written
   */
  writeString(content: string | null, spec?: FileOperationSpec | null): MsGraphFile;
   ...
   */
  writeObj(obj: Obj | null, spec?: FileObjsOperSpec | null): MsGraphFile;
   ...
   * @return pair of update instance of this content and number of objs written
   */
  startWriteObjs(spec?: FileObjsOperSpec | null): Pair<MsGraphFile | null, PushStream<Obj | null> | null>;
   ...
   */
  compress(contentEncoding?: string | null, spec?: FileCompressSpec | null): MsGraphFile;

  /**
   * Uncompresses file. Removes compression specific extension.
   */
  uncompress(spec?: FileCompressSpec | null): MsGraphFile;
   ...
   */
  transcode(contentType: string, contentEncoding: string, spec?: FileCompressSpec | null): MsGraphFile;

  /**
   * Copies content to a given target.
   */
  copyContentTo(target: MsGraphFile, spec?: FileOperationSpec | null): void;
   ...
   */
  static fromString(s: string | null): MsGraphFile | null;
