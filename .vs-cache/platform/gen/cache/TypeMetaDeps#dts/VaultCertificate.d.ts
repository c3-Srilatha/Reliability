// TypeScript definitions for the C3 type VaultCertificate

/**
 * This type represents the Vault Store Data
 *
 * @remarks this represents a value passed to a method that expects an instance of VaultCertificate
 */
declare interface IVaultCertificate {
  ...
  /**
   * the certificate can be of any C3 type. An example used here is the AwsIotCertificate
   */
  certificate?: IObj | null;
}

/**
 * This type represents the Vault Store Data
 *
 * @remarks this represents a made instance of VaultCertificate
 */
declare class VaultCertificate extends Obj {
   ...
   */
  readonly id: string;
  withId(id: string): VaultCertificate;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): VaultCertificate;

  /**
   * the name of a certificate
   */
  readonly name?: string | null;
  withName(name: string | null): VaultCertificate;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): VaultCertificate;
  ...
  withVersion(version: number | null): VaultCertificate;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): VaultCertificate;

  /**
   * the certificate can be of any C3 type. An example used here is the AwsIotCertificate
   */
  readonly certificate?: Obj | null;
  withCertificate(certificate: IObj | null): VaultCertificate;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): VaultCertificate | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): VaultCertificate | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): VaultCertificate | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): VaultCertificate | null;
   ...
   */
  replaceType(old: Type, new_: Type): VaultCertificate;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VaultCertificate;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VaultCertificate;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VaultCertificate | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VaultCertificate | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): VaultCertificate;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VaultCertificate;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VaultCertificate;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): VaultCertificate;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): VaultCertificate;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): VaultCertificate;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): VaultCertificate;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): VaultCertificate;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): VaultCertificate;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): VaultCertificate;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): VaultCertificate;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): VaultCertificate;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): VaultCertificate;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): VaultCertificate;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): VaultCertificate;
   ...
   * @see #unsetField
   */
  defaultField(field: string): VaultCertificate;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): VaultCertificate;
   ...
   * @see #removeField
   */
  unsetField(field: string): VaultCertificate;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): VaultCertificate;
   ...
   * @see #unsetField
   */
  removeField(field: string): VaultCertificate;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): VaultCertificate;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): VaultCertificate;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): VaultCertificate;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): VaultCertificate;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): VaultCertificate;

  mergeJson(json: any | null): VaultCertificate;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): VaultCertificate;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): VaultCertificate;
   ...
   */
  singletonArray(): C3.Array<VaultCertificate | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<VaultCertificate | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<VaultCertificate | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<VaultCertificate | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<VaultCertificate | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, VaultCertificate | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, VaultCertificate | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<VaultCertificate | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<VaultCertificate | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): VaultCertificate;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): VaultCertificate;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): VaultCertificate;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): VaultCertificate;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): VaultCertificate;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): VaultCertificate;
   ...
   * @see #fromString
   */
  static make(s: string | null): VaultCertificate | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): VaultCertificate;
   ...
   */
  static cachedEmptyInst(): VaultCertificate;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<VaultCertificate>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): VaultCertificate;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<VaultCertificate | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<VaultCertificate | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<VaultCertificate | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<VaultCertificate | null> | null>;
   ...
   */
  get(include?: string | null): VaultCertificate | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): VaultCertificate | null;
   ...
   */
  getMissing(spec: GetMissingSpec): VaultCertificate;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): VaultCertificate | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): VaultCertificate;
   ...
   * @see #toString
   */
  static fromString(s: string | null): VaultCertificate | null;
   ...
   */
  create(spec?: UpsertSpec | null): VaultCertificate | null;
   ...
   */
  static createBatch(objs: C3.Array<VaultCertificate | null> | null, spec?: UpsertSpec | null): ObjList<VaultCertificate | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<VaultCertificate | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<VaultCertificate | null> | null;
   ...
   */
  update(srcObj?: VaultCertificate | null, spec?: UpsertSpec | null): VaultCertificate | null;
   ...
   */
  upsert(srcObj?: VaultCertificate | null, spec?: UpsertSpec | null): VaultCertificate | null;
   ...
   */
  merge(spec?: MergeSpec | null): VaultCertificate | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): VaultCertificate | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): VaultCertificate | null;
   ...
   */
  static updateBatch(objs: C3.Array<VaultCertificate | null> | null, srcObjs?: C3.Array<VaultCertificate | null>, spec?: UpsertSpec | null): ObjList<VaultCertificate | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<VaultCertificate | null>>, spec?: UpsertSpec | null): ObjList<VaultCertificate | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<VaultCertificate | null> | null, srcObjs?: C3.Array<VaultCertificate | null>, spec?: UpsertSpec | null): ObjList<VaultCertificate | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<VaultCertificate | null>>, spec?: UpsertSpec | null): ObjList<VaultCertificate | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<VaultCertificate | null> | null, spec?: TouchSpec | null): ObjList<VaultCertificate | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<VaultCertificate | null> | null, spec?: MergeSpec | null): ObjList<VaultCertificate | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<VaultCertificate | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<VaultCertificate | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<VaultCertificate | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<VaultCertificate | null> | null;
   ...
   */
  static mergeAll(mergeObj: VaultCertificate | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: VaultCertificate | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<VaultCertificate | null> | null, spec?: UpsertSpec | null): ObjList<VaultCertificate | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<VaultCertificate | null> | null, spec?: UpsertSpec | null): ObjList<VaultCertificate | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): VaultCertificate | null;
   ...
   */
  static beforeCreate(objs: C3.Array<VaultCertificate | null> | null): ObjList<VaultCertificate | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<VaultCertificate | null> | null): ObjList<VaultCertificate | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<VaultCertificate | null> | null): ObjList<VaultCertificate | null>;
   ...
   */
  static afterCreate(objs: C3.Array<VaultCertificate | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<VaultCertificate | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<VaultCertificate | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<VaultCertificate | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<VaultCertificate | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): VaultCertificate | null;
   ...
   */
  withoutIdentity(): VaultCertificate | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<VaultCertificate | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: VaultCertificate | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<VaultCertificate | null> | null, callback?: λFunction<VaultCertificate | null, VaultCertificate | null> | null): ObjList<VaultCertificate | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<VaultCertificate | null> | null, callback?: λFunction<VaultCertificate | null, VaultCertificate | null> | null): C3.Array<ObjError | null>;
