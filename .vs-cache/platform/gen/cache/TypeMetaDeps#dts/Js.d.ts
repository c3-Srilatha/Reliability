// TypeScript definitions for the C3 type Js
 ...
 * @see Js.Node
 *
 * @remarks this represents a value passed to a method that expects an instance of Js
 */
declare interface IJs {
 ...
 */
declare class Js extends Obj {

  /**
   * The unique and required name of this instance.
   */
  readonly name: string;
  withName(name: string): Js;
  ...
  withJAVASCRIPT(JAVASCRIPT: string | null): Js;
  ...
  withPYTHON(PYTHON: string | null): Js;
  ...
  withTYPESCRIPT(TYPESCRIPT: string | null): Js;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Js | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Js | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Js | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Js | null;
   ...
   */
  replaceType(old: Type, new_: Type): Js;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): Js;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Js;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Js;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Js;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Js;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Js | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Js | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Js | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Js | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Js;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Js;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Js;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Js;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Js;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Js;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Js;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): Js;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Js;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): Js;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Js;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Js;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Js;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Js;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Js;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): Js;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Js;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): Js;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Js;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): Js;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Js;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): Js;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Js;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Js;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Js;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): Js;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Js;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Js;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): Js;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Js;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): Js;
   ...
   * @see #removeField
   */
  static unsetField(field: string): Js;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): Js;
   ...
   * @see #unsetField
   */
  static removeField(field: string): Js;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Js;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): Js;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Js;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Js;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Js;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): Js;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Js;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Js;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Js;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Js;

  mergeJson(json: any | null): Js;

  static mergeJson(json: any | null): Js;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Js;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Js;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Js;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): Js;
   ...
   */
  singletonArray(): C3.Array<Js | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<Js | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Js | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Js | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<Js | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Js | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Js | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Js | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Js | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<Js | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Js | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Js;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Js;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Js;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Js;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Js;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Js;
   ...
   * @see #fromString
   */
  static make(s: string | null): Js | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Js;
   ...
   */
  static cachedEmptyInst(): Js;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Js>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Js;
   ...
   */
  static forFileExt(ext: string | null, failIfNone?: boolean): Js | null;
