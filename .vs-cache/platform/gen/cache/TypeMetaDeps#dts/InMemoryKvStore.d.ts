// TypeScript definitions for the C3 type InMemoryKvStore

/**
 * @remarks this represents a value passed to a method that expects an instance of InMemoryKvStore
 */
declare interface IInMemoryKvStore {
  ...
  caps?: IKvStoreCapabilities | null;
}

/**
 * @remarks this represents a made instance of InMemoryKvStore
 */
declare class InMemoryKvStore extends Obj {

  /**
   * The unique and required name of this instance.
   */
  readonly name: string;
  withName(name: string): InMemoryKvStore;
  ...
  withSQL(SQL: string | null): InMemoryKvStore;
  ...
  withKV(KV: string | null): InMemoryKvStore;
  ...
  withDEFAULT_KV_CONFIG(DEFAULT_KV_CONFIG: string | null): InMemoryKvStore;
  ...
  withDEFAULT_COL_NAME(DEFAULT_COL_NAME: string | null): InMemoryKvStore;
  ...
  readonly caps?: KvStoreCapabilities | null;
  withCaps(caps: IKvStoreCapabilities | null): InMemoryKvStore;

  static readonly caps?: KvStoreCapabilities | null;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): InMemoryKvStore | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): InMemoryKvStore | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): InMemoryKvStore | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): InMemoryKvStore | null;
   ...
   */
  replaceType(old: Type, new_: Type): InMemoryKvStore;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): InMemoryKvStore;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): InMemoryKvStore;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): InMemoryKvStore;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): InMemoryKvStore;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): InMemoryKvStore;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<InMemoryKvStore | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<InMemoryKvStore | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<InMemoryKvStore | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<InMemoryKvStore | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): InMemoryKvStore;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): InMemoryKvStore;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): InMemoryKvStore;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): InMemoryKvStore;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): InMemoryKvStore;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): InMemoryKvStore;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): InMemoryKvStore;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): InMemoryKvStore;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): InMemoryKvStore;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): InMemoryKvStore;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): InMemoryKvStore;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): InMemoryKvStore;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): InMemoryKvStore;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): InMemoryKvStore;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): InMemoryKvStore;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): InMemoryKvStore;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): InMemoryKvStore;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): InMemoryKvStore;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): InMemoryKvStore;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): InMemoryKvStore;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): InMemoryKvStore;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): InMemoryKvStore;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): InMemoryKvStore;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): InMemoryKvStore;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): InMemoryKvStore;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): InMemoryKvStore;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): InMemoryKvStore;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): InMemoryKvStore;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): InMemoryKvStore;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): InMemoryKvStore;
   ...
   * @see #unsetField
   */
  defaultField(field: string): InMemoryKvStore;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): InMemoryKvStore;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): InMemoryKvStore;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): InMemoryKvStore;
   ...
   * @see #removeField
   */
  unsetField(field: string): InMemoryKvStore;
   ...
   * @see #removeField
   */
  static unsetField(field: string): InMemoryKvStore;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): InMemoryKvStore;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): InMemoryKvStore;
   ...
   * @see #unsetField
   */
  removeField(field: string): InMemoryKvStore;
   ...
   * @see #unsetField
   */
  static removeField(field: string): InMemoryKvStore;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): InMemoryKvStore;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): InMemoryKvStore;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): InMemoryKvStore;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): InMemoryKvStore;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): InMemoryKvStore;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): InMemoryKvStore;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): InMemoryKvStore;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): InMemoryKvStore;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): InMemoryKvStore;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): InMemoryKvStore;

  mergeJson(json: any | null): InMemoryKvStore;

  static mergeJson(json: any | null): InMemoryKvStore;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): InMemoryKvStore;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): InMemoryKvStore;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): InMemoryKvStore;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): InMemoryKvStore;
   ...
   */
  singletonArray(): C3.Array<InMemoryKvStore | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<InMemoryKvStore | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<InMemoryKvStore | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<InMemoryKvStore | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<InMemoryKvStore | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<InMemoryKvStore | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<InMemoryKvStore | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, InMemoryKvStore | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, InMemoryKvStore | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<InMemoryKvStore | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<InMemoryKvStore | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<InMemoryKvStore | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): InMemoryKvStore;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): InMemoryKvStore;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): InMemoryKvStore;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): InMemoryKvStore;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): InMemoryKvStore;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): InMemoryKvStore;
   ...
   * @see #fromString
   */
  static make(s: string | null): InMemoryKvStore | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): InMemoryKvStore;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): InMemoryKvStore;
   ...
   */
  static cachedEmptyInst(): InMemoryKvStore;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<InMemoryKvStore>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): InMemoryKvStore;
   ...
   */
  config(secrets?: boolean): KvStoreConfig;
   ...
   * @return instance of configuration - never `null`.
   */
  static config(secrets?: boolean): KvStoreConfig;
   ...
   */
  static typeConfig(): KvStoreConfig;
   ...
   * @see #toString
   */
  static fromString(s: string | null): InMemoryKvStore | null;
   ...
   */
  static forName(name: string | null, failIfMissing?: boolean): InMemoryKvStore | null;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<InMemoryKvStore | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<InMemoryKvStore | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<InMemoryKvStore | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): InMemoryKvStore | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string | null): InMemoryKvStore | null;
   ...
   * @see findByCacheKey
   */
  getCached(): InMemoryKvStore | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): InMemoryKvStore | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): InMemoryKvStore | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): InMemoryKvStore | null;
   ...
   */
  static produce(key: string): InMemoryKvStore | null;
   ...
   */
  static produceAll(): C3.Map<string | null, InMemoryKvStore | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, InMemoryKvStore | null>;
  ...
  fetchObjs(tableName: string): Stream<Obj | null>;

  static fetchObjs(tableName: string): Stream<Obj | null>;

  static validateCapabilities(caps: KvStoreCapabilities | null): KvStoreCapabilities | null;
}
