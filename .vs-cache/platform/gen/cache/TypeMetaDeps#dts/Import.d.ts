// TypeScript definitions for the C3 type Import

/**
 * @remarks this represents a value passed to a method that expects an instance of Import
 */
 ...
 */
declare class Import extends Obj {

  /**
   * The unique and required id of this instance.
   */
  readonly id: string;
  withId(id: string): Import;

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun | null;
  withRun(run: IBatchJobRun | null): Import;

  /**
   * previous job executions for this instance
   */
  readonly runs?: C3.Array<BatchJobRun | null>;
  withRuns(runs: C3.Array<BatchJobRun | null> | Array<IBatchJobRun | null>): Import;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj | null;
  withOptions(options: IObj | null): Import;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): Import;
  ...
  withPriority(priority: number | null): Import;
  ...
  withDisabled(disabled: boolean): Import;
  ...
  withMaxConcurrency(maxConcurrency: number | null): Import;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): Import;
  ...
  withRunAsUser(runAsUser: boolean | null): Import;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string | null;
  withNodePool(nodePool: string | null): Import;
  ...
  withSkipIfRunning(skipIfRunning: boolean | null): Import;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number | null;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): Import;
  ...
  withPropagateActionContext(propagateActionContext: boolean): Import;
  ...
  withTypeIdent(typeIdent: string | null): Import;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Import;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): Import;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): Import;
  ...
  withVersion(version: number | null): Import;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): Import;
  ...
  withAbortOnError(abortOnError: boolean): Import;
   ...
   * @see #toString
   */
  static fromString(s: string | null): Import | null;
   ...
   * @see #fromString
   */
  static make(s: string | null): Import | null;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Import;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Import;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Import;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Import;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Import | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Import | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Import | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Import | null;
   ...
   */
  replaceType(old: Type, new_: Type): Import;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Import;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Import;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Import | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Import | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Import;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Import;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Import;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Import;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Import;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Import;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Import;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Import;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Import;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Import;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Import;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Import;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Import;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Import;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Import;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Import;
   ...
   * @see #removeField
   */
  unsetField(field: string): Import;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Import;
   ...
   * @see #unsetField
   */
  removeField(field: string): Import;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Import;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Import;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Import;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Import;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Import;

  mergeJson(json: any | null): Import;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Import;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Import;
   ...
   */
  singletonArray(): C3.Array<Import | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Import | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Import | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Import | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Import | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Import | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Import | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Import | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Import | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Import;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Import;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Import;
   ...
   */
  static cachedEmptyInst(): Import;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Import>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Import;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): Import | null;
   ...
   */
  start(options?: BatchImportOptions | null): BatchJobStatus | null;
   ...
   */
  cleanup(options?: BatchImportOptions | null): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun | null, BatchJobStatus | null, BatchImportOptions | null> | null;

  failJob(run: JobRun<BatchJobStatusBase | null>): JobBase<BatchJobRun | null, BatchJobStatus | null, BatchImportOptions | null> | null;
  ...
  validateStart(options?: BatchImportOptions | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<Import | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<Import | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Import | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Import | null> | null>;
   ...
   */
  get(include?: string | null): Import | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): Import | null;
   ...
   */
  getMissing(spec: GetMissingSpec): Import;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): Import | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): Import;
   ...
   */
  create(spec?: UpsertSpec | null): Import | null;
   ...
   */
  static createBatch(objs: C3.Array<Import | null> | null, spec?: UpsertSpec | null): ObjList<Import | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<Import | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Import | null> | null;
   ...
   */
  update(srcObj?: Import | null, spec?: UpsertSpec | null): Import | null;
   ...
   */
  upsert(srcObj?: Import | null, spec?: UpsertSpec | null): Import | null;
   ...
   */
  merge(spec?: MergeSpec | null): Import | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): Import | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): Import | null;
   ...
   */
  static updateBatch(objs: C3.Array<Import | null> | null, srcObjs?: C3.Array<Import | null>, spec?: UpsertSpec | null): ObjList<Import | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<Import | null>>, spec?: UpsertSpec | null): ObjList<Import | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<Import | null> | null, srcObjs?: C3.Array<Import | null>, spec?: UpsertSpec | null): ObjList<Import | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<Import | null>>, spec?: UpsertSpec | null): ObjList<Import | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<Import | null> | null, spec?: TouchSpec | null): ObjList<Import | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Import | null> | null, spec?: MergeSpec | null): ObjList<Import | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Import | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Import | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<Import | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Import | null> | null;
   ...
   */
  static mergeAll(mergeObj: Import | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: Import | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<Import | null> | null, spec?: UpsertSpec | null): ObjList<Import | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<Import | null> | null, spec?: UpsertSpec | null): ObjList<Import | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<Import | null> | null): ObjList<Import | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<Import | null> | null): ObjList<Import | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<Import | null> | null): ObjList<Import | null>;
   ...
   */
  static afterCreate(objs: C3.Array<Import | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<Import | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<Import | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<Import | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Import | null>;
   ...
   */
  static typeOfBatch(objs: C3.Array<Import | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: Import | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<Import | null> | null, callback?: λFunction<Import | null, Import | null> | null): ObjList<Import | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<Import | null> | null, callback?: λFunction<Import | null, Import | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static doStart(job?: Import | null, options?: BatchImportOptions | null): void;
   ...
   */
  static processBatch(batch?: ExportImportChunk | null, job?: Import | null, options?: BatchImportOptions | null): void;
   ...
   */
  static allComplete(job: Import, options?: BatchImportOptions | null): string | null;
   ...
   *           Options the job was run with.
   */
  static failed(job: Import, status: BatchJobStatus, options?: BatchImportOptions | null): void;
   ...
   */
  static scheduleObjBatch(job?: Import | null, objBatch?: ObjBatch | null, logPrefix?: string | null): number | null;
   ...
   */
  static startImport(spec: BatchImportSpec): Import | null;

  /**
   * Returns the spec which was used to start the Import
   */
  spec(): BatchImportSpec | null;
   ...
   */
  scheduleImports(fileStream?: Stream<File | null> | null): number | null;
}
