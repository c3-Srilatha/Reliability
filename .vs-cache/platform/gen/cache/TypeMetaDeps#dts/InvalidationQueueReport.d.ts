// TypeScript definitions for the C3 type InvalidationQueueReport

/**
 * Type for storing all histories of a queue.
 *
 * @remarks this represents a value passed to a method that expects an instance of InvalidationQueueReport
 */
declare interface IInvalidationQueueReport {
  ...
  /**
   * An array to store all the histories of a queue.
   */
  histories?: C3.Array<InvalidationQueueHistory | null> | Array<IInvalidationQueueHistory | null>;
}

/**
 * Type for storing all histories of a queue.
 *
 * @remarks this represents a made instance of InvalidationQueueReport
 */
declare class InvalidationQueueReport extends Obj {
   ...
   */
  readonly id: string;
  withId(id: string): InvalidationQueueReport;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): InvalidationQueueReport;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): InvalidationQueueReport;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): InvalidationQueueReport;
  ...
  withVersion(version: number | null): InvalidationQueueReport;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): InvalidationQueueReport;

  /**
   * An array to store all the histories of a queue.
   */
  readonly histories?: C3.Array<InvalidationQueueHistory | null>;
  withHistories(histories: C3.Array<InvalidationQueueHistory | null> | Array<IInvalidationQueueHistory | null>): InvalidationQueueReport;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): InvalidationQueueReport | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): InvalidationQueueReport | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): InvalidationQueueReport | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): InvalidationQueueReport | null;
   ...
   */
  replaceType(old: Type, new_: Type): InvalidationQueueReport;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): InvalidationQueueReport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): InvalidationQueueReport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<InvalidationQueueReport | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<InvalidationQueueReport | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): InvalidationQueueReport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): InvalidationQueueReport;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): InvalidationQueueReport;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): InvalidationQueueReport;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): InvalidationQueueReport;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): InvalidationQueueReport;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): InvalidationQueueReport;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): InvalidationQueueReport;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): InvalidationQueueReport;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): InvalidationQueueReport;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): InvalidationQueueReport;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): InvalidationQueueReport;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): InvalidationQueueReport;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): InvalidationQueueReport;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): InvalidationQueueReport;
   ...
   * @see #unsetField
   */
  defaultField(field: string): InvalidationQueueReport;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): InvalidationQueueReport;
   ...
   * @see #removeField
   */
  unsetField(field: string): InvalidationQueueReport;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): InvalidationQueueReport;
   ...
   * @see #unsetField
   */
  removeField(field: string): InvalidationQueueReport;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): InvalidationQueueReport;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): InvalidationQueueReport;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): InvalidationQueueReport;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): InvalidationQueueReport;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): InvalidationQueueReport;

  mergeJson(json: any | null): InvalidationQueueReport;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): InvalidationQueueReport;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): InvalidationQueueReport;
   ...
   */
  singletonArray(): C3.Array<InvalidationQueueReport | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<InvalidationQueueReport | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<InvalidationQueueReport | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<InvalidationQueueReport | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<InvalidationQueueReport | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, InvalidationQueueReport | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, InvalidationQueueReport | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<InvalidationQueueReport | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<InvalidationQueueReport | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): InvalidationQueueReport;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): InvalidationQueueReport;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): InvalidationQueueReport;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): InvalidationQueueReport;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): InvalidationQueueReport;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): InvalidationQueueReport;
   ...
   * @see #fromString
   */
  static make(s: string | null): InvalidationQueueReport | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): InvalidationQueueReport;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): InvalidationQueueReport;
   ...
   */
  static cachedEmptyInst(): InvalidationQueueReport;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<InvalidationQueueReport>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): InvalidationQueueReport;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<InvalidationQueueReport | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<InvalidationQueueReport | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<InvalidationQueueReport | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<InvalidationQueueReport | null> | null>;
   ...
   */
  get(include?: string | null): InvalidationQueueReport | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): InvalidationQueueReport | null;
   ...
   */
  getMissing(spec: GetMissingSpec): InvalidationQueueReport;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): InvalidationQueueReport | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): InvalidationQueueReport;
   ...
   * @see #toString
   */
  static fromString(s: string | null): InvalidationQueueReport | null;
   ...
   */
  create(spec?: UpsertSpec | null): InvalidationQueueReport | null;
   ...
   */
  static createBatch(objs: C3.Array<InvalidationQueueReport | null> | null, spec?: UpsertSpec | null): ObjList<InvalidationQueueReport | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<InvalidationQueueReport | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<InvalidationQueueReport | null> | null;
   ...
   */
  update(srcObj?: InvalidationQueueReport | null, spec?: UpsertSpec | null): InvalidationQueueReport | null;
   ...
   */
  upsert(srcObj?: InvalidationQueueReport | null, spec?: UpsertSpec | null): InvalidationQueueReport | null;
   ...
   */
  merge(spec?: MergeSpec | null): InvalidationQueueReport | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): InvalidationQueueReport | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): InvalidationQueueReport | null;
   ...
   */
  static updateBatch(objs: C3.Array<InvalidationQueueReport | null> | null, srcObjs?: C3.Array<InvalidationQueueReport | null>, spec?: UpsertSpec | null): ObjList<InvalidationQueueReport | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<InvalidationQueueReport | null>>, spec?: UpsertSpec | null): ObjList<InvalidationQueueReport | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<InvalidationQueueReport | null> | null, srcObjs?: C3.Array<InvalidationQueueReport | null>, spec?: UpsertSpec | null): ObjList<InvalidationQueueReport | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<InvalidationQueueReport | null>>, spec?: UpsertSpec | null): ObjList<InvalidationQueueReport | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<InvalidationQueueReport | null> | null, spec?: TouchSpec | null): ObjList<InvalidationQueueReport | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<InvalidationQueueReport | null> | null, spec?: MergeSpec | null): ObjList<InvalidationQueueReport | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<InvalidationQueueReport | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<InvalidationQueueReport | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<InvalidationQueueReport | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<InvalidationQueueReport | null> | null;
   ...
   */
  static mergeAll(mergeObj: InvalidationQueueReport | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: InvalidationQueueReport | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<InvalidationQueueReport | null> | null, spec?: UpsertSpec | null): ObjList<InvalidationQueueReport | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<InvalidationQueueReport | null> | null, spec?: UpsertSpec | null): ObjList<InvalidationQueueReport | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): InvalidationQueueReport | null;
   ...
   */
  static beforeCreate(objs: C3.Array<InvalidationQueueReport | null> | null): ObjList<InvalidationQueueReport | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<InvalidationQueueReport | null> | null): ObjList<InvalidationQueueReport | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<InvalidationQueueReport | null> | null): ObjList<InvalidationQueueReport | null>;
   ...
   */
  static afterCreate(objs: C3.Array<InvalidationQueueReport | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<InvalidationQueueReport | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<InvalidationQueueReport | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<InvalidationQueueReport | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<InvalidationQueueReport | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): InvalidationQueueReport | null;
   ...
   */
  withoutIdentity(): InvalidationQueueReport | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<InvalidationQueueReport | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: InvalidationQueueReport | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<InvalidationQueueReport | null> | null, callback?: λFunction<InvalidationQueueReport | null, InvalidationQueueReport | null> | null): ObjList<InvalidationQueueReport | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<InvalidationQueueReport | null> | null, callback?: λFunction<InvalidationQueueReport | null, InvalidationQueueReport | null> | null): C3.Array<ObjError | null>;
  ...
  /**
   * Upsert the status of each invalidation queue into database with a timestamp.
   * This function is called by a cron job every 5 minutes to keep tracking the status of invalidation queues.
   */
  static recordStats(): void;

  /**
   * Remove Invalidation Queue Histories where its timestamp is older than 1 year ago.
   */
  static removeOldStats(): void;
}
