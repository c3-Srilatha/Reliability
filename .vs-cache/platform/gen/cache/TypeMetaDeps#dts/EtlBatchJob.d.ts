// TypeScript definitions for the C3 type EtlBatchJob

/**
 * Batch job definitions for batch jobs started from RefreshCalcFieldsTask for asynchronous processing.
 *
 * @remarks this represents a value passed to a method that expects an instance of EtlBatchJob
 */
declare interface IEtlBatchJob {
 ...
 */
declare class EtlBatchJob extends Obj {

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun | null;
  withRun(run: IBatchJobRun | null): EtlBatchJob;

  /**
   * previous job executions for this instance
   */
  readonly runs?: C3.Array<BatchJobRun | null>;
  withRuns(runs: C3.Array<BatchJobRun | null> | Array<IBatchJobRun | null>): EtlBatchJob;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj | null;
  withOptions(options: IObj | null): EtlBatchJob;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): EtlBatchJob;
  ...
  withPriority(priority: number | null): EtlBatchJob;
  ...
  withDisabled(disabled: boolean): EtlBatchJob;
  ...
  withMaxConcurrency(maxConcurrency: number | null): EtlBatchJob;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): EtlBatchJob;
  ...
  withRunAsUser(runAsUser: boolean | null): EtlBatchJob;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string | null;
  withNodePool(nodePool: string | null): EtlBatchJob;
  ...
  withSkipIfRunning(skipIfRunning: boolean | null): EtlBatchJob;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number | null;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): EtlBatchJob;
  ...
  withPropagateActionContext(propagateActionContext: boolean): EtlBatchJob;
  ...
  withTypeIdent(typeIdent: string | null): EtlBatchJob;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): EtlBatchJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): EtlBatchJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): EtlBatchJob;
  ...
  withVersion(version: number | null): EtlBatchJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): EtlBatchJob;
  ...
  withAbortOnError(abortOnError: boolean): EtlBatchJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): EtlBatchJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): EtlBatchJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): EtlBatchJob | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): EtlBatchJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): EtlBatchJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): EtlBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): EtlBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<EtlBatchJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<EtlBatchJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): EtlBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): EtlBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): EtlBatchJob;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): EtlBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): EtlBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): EtlBatchJob;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): EtlBatchJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): EtlBatchJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): EtlBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): EtlBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): EtlBatchJob;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): EtlBatchJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): EtlBatchJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): EtlBatchJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): EtlBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): EtlBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): EtlBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): EtlBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): EtlBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): EtlBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): EtlBatchJob;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): EtlBatchJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): EtlBatchJob;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): EtlBatchJob;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): EtlBatchJob;

  mergeJson(json: any | null): EtlBatchJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): EtlBatchJob;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): EtlBatchJob;
   ...
   */
  singletonArray(): C3.Array<EtlBatchJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<EtlBatchJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<EtlBatchJob | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<EtlBatchJob | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<EtlBatchJob | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, EtlBatchJob | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, EtlBatchJob | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<EtlBatchJob | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<EtlBatchJob | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): EtlBatchJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): EtlBatchJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): EtlBatchJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): EtlBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): EtlBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): EtlBatchJob;
   ...
   * @see #fromString
   */
  static make(s: string | null): EtlBatchJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): EtlBatchJob;
   ...
   */
  static cachedEmptyInst(): EtlBatchJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<EtlBatchJob>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): EtlBatchJob;
   ...
   */
  start(options?: EtlSpec | null): BatchJobStatus | null;
   ...
   */
  cleanup(options?: EtlSpec | null): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun | null, BatchJobStatus | null, EtlSpec | null> | null;

  failJob(run: JobRun<BatchJobStatusBase | null>): JobBase<BatchJobRun | null, BatchJobStatus | null, EtlSpec | null> | null;
  ...
  validateStart(options?: EtlSpec | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<EtlBatchJob | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<EtlBatchJob | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<EtlBatchJob | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<EtlBatchJob | null> | null>;
   ...
   */
  get(include?: string | null): EtlBatchJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): EtlBatchJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): EtlBatchJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): EtlBatchJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): EtlBatchJob;
   ...
   * @see #toString
   */
  static fromString(s: string | null): EtlBatchJob | null;
   ...
   */
  create(spec?: UpsertSpec | null): EtlBatchJob | null;
   ...
   */
  static createBatch(objs: C3.Array<EtlBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<EtlBatchJob | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<EtlBatchJob | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<EtlBatchJob | null> | null;
   ...
   */
  update(srcObj?: EtlBatchJob | null, spec?: UpsertSpec | null): EtlBatchJob | null;
   ...
   */
  upsert(srcObj?: EtlBatchJob | null, spec?: UpsertSpec | null): EtlBatchJob | null;
   ...
   */
  merge(spec?: MergeSpec | null): EtlBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): EtlBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): EtlBatchJob | null;
   ...
   */
  static updateBatch(objs: C3.Array<EtlBatchJob | null> | null, srcObjs?: C3.Array<EtlBatchJob | null>, spec?: UpsertSpec | null): ObjList<EtlBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<EtlBatchJob | null>>, spec?: UpsertSpec | null): ObjList<EtlBatchJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<EtlBatchJob | null> | null, srcObjs?: C3.Array<EtlBatchJob | null>, spec?: UpsertSpec | null): ObjList<EtlBatchJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<EtlBatchJob | null>>, spec?: UpsertSpec | null): ObjList<EtlBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<EtlBatchJob | null> | null, spec?: TouchSpec | null): ObjList<EtlBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<EtlBatchJob | null> | null, spec?: MergeSpec | null): ObjList<EtlBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<EtlBatchJob | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<EtlBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<EtlBatchJob | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<EtlBatchJob | null> | null;
   ...
   */
  static mergeAll(mergeObj: EtlBatchJob | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: EtlBatchJob | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<EtlBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<EtlBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<EtlBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<EtlBatchJob | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<EtlBatchJob | null> | null): ObjList<EtlBatchJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<EtlBatchJob | null> | null): ObjList<EtlBatchJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<EtlBatchJob | null> | null): ObjList<EtlBatchJob | null>;
   ...
   */
  static afterCreate(objs: C3.Array<EtlBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<EtlBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<EtlBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<EtlBatchJob | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<EtlBatchJob | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): EtlBatchJob | null;
   ...
   */
  withoutIdentity(): EtlBatchJob | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<EtlBatchJob | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: EtlBatchJob | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<EtlBatchJob | null> | null, callback?: λFunction<EtlBatchJob | null, EtlBatchJob | null> | null): ObjList<EtlBatchJob | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<EtlBatchJob | null> | null, callback?: λFunction<EtlBatchJob | null, EtlBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static doStart(job?: EtlBatchJob | null, options?: EtlSpec | null): void;
   ...
   */
  static processBatch(batch?: EtlSpec | null, job?: EtlBatchJob | null, options?: EtlSpec | null): void;
   ...
   */
  static allComplete(job: EtlBatchJob, options?: EtlSpec | null): string | null;
   ...
   *           Options the job was run with.
   */
  static failed(job: EtlBatchJob, status: BatchJobStatus, options?: EtlSpec | null): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: EtlSpec | null): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: C3.Array<EtlSpec | null>): void;
   ...
   */
  static scheduleObjBatch(job?: EtlBatchJob | null, objBatch?: ObjBatch | null, logPrefix?: string | null): number | null;
