// TypeScript definitions for the C3 type NetworkRoutePolicyConfig

/**
 * @remarks this represents a value passed to a method that expects an instance of NetworkRoutePolicyConfig
 */
declare interface INetworkRoutePolicyConfig {
...
/**
 * @remarks this represents a made instance of NetworkRoutePolicyConfig
 */
declare class NetworkRoutePolicyConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): NetworkRoutePolicyConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): NetworkRoutePolicyConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): NetworkRoutePolicyConfig;

  /**
   * The name of this instance.
   */
  readonly name?: string | null;
  withName(name: string | null): NetworkRoutePolicyConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): NetworkRoutePolicyConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): NetworkRoutePolicyConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): NetworkRoutePolicyConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): NetworkRoutePolicyConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): NetworkRoutePolicyConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NetworkRoutePolicyConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NetworkRoutePolicyConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NetworkRoutePolicyConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NetworkRoutePolicyConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): NetworkRoutePolicyConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NetworkRoutePolicyConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NetworkRoutePolicyConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): NetworkRoutePolicyConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): NetworkRoutePolicyConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): NetworkRoutePolicyConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): NetworkRoutePolicyConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): NetworkRoutePolicyConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): NetworkRoutePolicyConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): NetworkRoutePolicyConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): NetworkRoutePolicyConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): NetworkRoutePolicyConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): NetworkRoutePolicyConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): NetworkRoutePolicyConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): NetworkRoutePolicyConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): NetworkRoutePolicyConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): NetworkRoutePolicyConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): NetworkRoutePolicyConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): NetworkRoutePolicyConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): NetworkRoutePolicyConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): NetworkRoutePolicyConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): NetworkRoutePolicyConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): NetworkRoutePolicyConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): NetworkRoutePolicyConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): NetworkRoutePolicyConfig;

  mergeJson(json: any | null): NetworkRoutePolicyConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): NetworkRoutePolicyConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): NetworkRoutePolicyConfig;
   ...
   */
  singletonArray(): C3.Array<NetworkRoutePolicyConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<NetworkRoutePolicyConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<NetworkRoutePolicyConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<NetworkRoutePolicyConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<NetworkRoutePolicyConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, NetworkRoutePolicyConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, NetworkRoutePolicyConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<NetworkRoutePolicyConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<NetworkRoutePolicyConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): NetworkRoutePolicyConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): NetworkRoutePolicyConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): NetworkRoutePolicyConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): NetworkRoutePolicyConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): NetworkRoutePolicyConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): NetworkRoutePolicyConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): NetworkRoutePolicyConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): NetworkRoutePolicyConfig;
   ...
   */
  static cachedEmptyInst(): NetworkRoutePolicyConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<NetworkRoutePolicyConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): NetworkRoutePolicyConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<NetworkRoutePolicyConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<NetworkRoutePolicyConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<NetworkRoutePolicyConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): NetworkRoutePolicyConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): NetworkRoutePolicyConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): NetworkRoutePolicyConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): NetworkRoutePolicyConfig | null;
   ...
   */
  static produce(key: string): NetworkRoutePolicyConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, NetworkRoutePolicyConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, NetworkRoutePolicyConfig | null>;
   ...
   */
  getConfig(): NetworkRoutePolicyConfig;
   ...
   */
  getSecret(): NetworkRoutePolicyConfig;
   ...
   */
  static forConfigKey(configKey: string | null): NetworkRoutePolicyConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<NetworkRoutePolicyConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: NetworkRoutePolicyConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: NetworkRoutePolicyConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): NetworkRoutePolicyConfig | null;
