// TypeScript definitions for the C3 type MetadataCacheOld
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of MetadataCacheOld
 */
declare interface IMetadataCacheOld<V> {
}
 ...
 * @see MetadataListener
 *
 * @remarks this represents a made instance of MetadataCacheOld
 */
declare class MetadataCacheOld<V> {
   ...
   */
  static get(key: string | null): V | null;
   ...
   */
  static require(key: string | null): V;
   ...
   */
  static put(key: string | null, value: V | null): void;
   ...
   */
  static produce(key: string | null): V | null;
   ...
   */
  static validate(value: V | null): boolean;
}
