// TypeScript definitions for the C3 type JobInformation

/**
 * @remarks this represents a value passed to a method that expects an instance of JobInformation
 */
declare interface IJobInformation {
  ...
  modules: C3.Array<string | null> | Array<string | null>;
...
/**
 * @remarks this represents a made instance of JobInformation
 */
declare class JobInformation extends Obj {
   ...
   */
  readonly id: string;
  withId(id: string): JobInformation;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): JobInformation;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): JobInformation;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): JobInformation;
  ...
  withVersion(version: number | null): JobInformation;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): JobInformation;
  ...
  withUserUpdatedFields(userUpdatedFields: C3.Array<string | null> | Array<string | null>): JobInformation;
  ...
  withHidden(hidden: boolean): JobInformation;
  ...
  withUserOwned(userOwned: boolean): JobInformation;

  readonly modules: C3.Array<string | null>;
  withModules(modules: C3.Array<string | null> | Array<string | null>): JobInformation;

  readonly typeName: string;
  withTypeName(typeName: string): JobInformation;

  readonly checkMixin: boolean;
  withCheckMixin(checkMixin: boolean): JobInformation;

  readonly actionName: string;
  withActionName(actionName: string): JobInformation;

  readonly executionNumber: number;
  withExecutionNumber(executionNumber: number): JobInformation;

  readonly retries?: number | null;
  withRetries(retries: number | null): JobInformation;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): JobInformation | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): JobInformation | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): JobInformation | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): JobInformation | null;
   ...
   */
  replaceType(old: Type, new_: Type): JobInformation;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JobInformation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JobInformation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JobInformation | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JobInformation | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): JobInformation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JobInformation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JobInformation;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): JobInformation;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): JobInformation;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): JobInformation;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): JobInformation;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): JobInformation;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): JobInformation;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): JobInformation;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): JobInformation;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): JobInformation;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): JobInformation;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): JobInformation;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): JobInformation;
   ...
   * @see #unsetField
   */
  defaultField(field: string): JobInformation;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): JobInformation;
   ...
   * @see #removeField
   */
  unsetField(field: string): JobInformation;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): JobInformation;
   ...
   * @see #unsetField
   */
  removeField(field: string): JobInformation;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): JobInformation;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): JobInformation;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): JobInformation;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): JobInformation;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): JobInformation;

  mergeJson(json: any | null): JobInformation;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): JobInformation;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): JobInformation;
   ...
   */
  singletonArray(): C3.Array<JobInformation | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<JobInformation | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<JobInformation | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<JobInformation | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<JobInformation | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, JobInformation | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, JobInformation | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<JobInformation | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<JobInformation | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): JobInformation;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): JobInformation;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): JobInformation;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): JobInformation;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): JobInformation;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): JobInformation;
   ...
   * @see #fromString
   */
  static make(s: string | null): JobInformation | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): JobInformation;
   ...
   */
  static cachedEmptyInst(): JobInformation;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<JobInformation>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): JobInformation;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<JobInformation | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<JobInformation | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<JobInformation | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): JobInformation | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string | null): JobInformation | null;
   ...
   * @see findByCacheKey
   */
  getCached(): JobInformation | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): JobInformation | null;
   ...
   */
  static produce(key: string): JobInformation | null;
   ...
   */
  static produceAll(): C3.Map<string | null, JobInformation | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, JobInformation | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<JobInformation | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<JobInformation | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<JobInformation | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<JobInformation | null> | null>;
   ...
   */
  get(include?: string | null): JobInformation | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): JobInformation | null;
   ...
   */
  getMissing(spec: GetMissingSpec): JobInformation;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): JobInformation | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): JobInformation;
   ...
   * @see #toString
   */
  static fromString(s: string | null): JobInformation | null;
   ...
   */
  create(spec?: UpsertSpec | null): JobInformation | null;
   ...
   */
  static createBatch(objs: C3.Array<JobInformation | null> | null, spec?: UpsertSpec | null): ObjList<JobInformation | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<JobInformation | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<JobInformation | null> | null;
   ...
   */
  update(srcObj?: JobInformation | null, spec?: UpsertSpec | null): JobInformation | null;
   ...
   */
  upsert(srcObj?: JobInformation | null, spec?: UpsertSpec | null): JobInformation | null;
   ...
   */
  merge(spec?: MergeSpec | null): JobInformation | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): JobInformation | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): JobInformation | null;
   ...
   */
  static updateBatch(objs: C3.Array<JobInformation | null> | null, srcObjs?: C3.Array<JobInformation | null>, spec?: UpsertSpec | null): ObjList<JobInformation | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<JobInformation | null>>, spec?: UpsertSpec | null): ObjList<JobInformation | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<JobInformation | null> | null, srcObjs?: C3.Array<JobInformation | null>, spec?: UpsertSpec | null): ObjList<JobInformation | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<JobInformation | null>>, spec?: UpsertSpec | null): ObjList<JobInformation | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<JobInformation | null> | null, spec?: TouchSpec | null): ObjList<JobInformation | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<JobInformation | null> | null, spec?: MergeSpec | null): ObjList<JobInformation | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<JobInformation | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<JobInformation | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<JobInformation | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<JobInformation | null> | null;
   ...
   */
  static mergeAll(mergeObj: JobInformation | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: JobInformation | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<JobInformation | null> | null, spec?: UpsertSpec | null): ObjList<JobInformation | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<JobInformation | null> | null, spec?: UpsertSpec | null): ObjList<JobInformation | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<JobInformation | null> | null): ObjList<JobInformation | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<JobInformation | null> | null): ObjList<JobInformation | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<JobInformation | null> | null): ObjList<JobInformation | null>;
   ...
   */
  static afterCreate(objs: C3.Array<JobInformation | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<JobInformation | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<JobInformation | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<JobInformation | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<JobInformation | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): JobInformation | null;
   ...
   */
  withoutIdentity(): JobInformation | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<JobInformation | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: JobInformation | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<JobInformation | null> | null, callback?: λFunction<JobInformation | null, JobInformation | null> | null): ObjList<JobInformation | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<JobInformation | null> | null, callback?: λFunction<JobInformation | null, JobInformation | null> | null): C3.Array<ObjError | null>;
   ...
   */
  publish(subPath?: string | null, contentType?: string | null): JobInformation;
   ...
   */
  static removeSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<JobInformation | null> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec | null): JobInformation | null;
   ...
   */
  static createSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<JobInformation | null> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData | null, spec?: UpsertSpec | null): JobInformation | null;
   ...
   */
  static updateSeedDataBatch(objs?: C3.Array<SeedData | null>, srcObjs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<JobInformation | null> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec | null): JobInformation | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: C3.Array<SeedData | null>, spec?: MergeSpec | null): ObjList<JobInformation | null> | null;
  ...
  dependencies(): SeedDataDeps<JobInformation | null> | null;
