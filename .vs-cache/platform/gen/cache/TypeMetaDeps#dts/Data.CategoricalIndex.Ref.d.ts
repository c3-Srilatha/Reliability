// TypeScript definitions for the C3 type Data.CategoricalIndex.Ref

/**
 * Implementation of {@link DataImpl.Ref} for {@link Data.CategoricalIndex}
 *
 * @remarks this represents a value passed to a method that expects an instance of Data.CategoricalIndex.Ref
 */
...
declare namespace Data.CategoricalIndex {
  export class Ref extends Obj {
     ...
     */
    ds: Dataset;
    withDs(ds: IDataset): Data.CategoricalIndex.Ref;

    /**
     * Id used to reference this Data within the Dataset to which it belongs
     */
    id: string;
    withId(id: string): Data.CategoricalIndex.Ref;
    ...
    withRef(ref: string | null | IDataImpl.Lazy | null | null): Data.CategoricalIndex.Ref;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.CategoricalIndex.Ref | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.CategoricalIndex.Ref | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.CategoricalIndex.Ref | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.CategoricalIndex.Ref | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.CategoricalIndex.Ref;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.CategoricalIndex.Ref;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.CategoricalIndex.Ref;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.CategoricalIndex.Ref | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.CategoricalIndex.Ref | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.CategoricalIndex.Ref;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.CategoricalIndex.Ref;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.CategoricalIndex.Ref;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.CategoricalIndex.Ref;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.CategoricalIndex.Ref;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.CategoricalIndex.Ref;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.CategoricalIndex.Ref;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.CategoricalIndex.Ref;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.CategoricalIndex.Ref;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.CategoricalIndex.Ref;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.CategoricalIndex.Ref;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.CategoricalIndex.Ref;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.CategoricalIndex.Ref;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.CategoricalIndex.Ref;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.CategoricalIndex.Ref;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.CategoricalIndex.Ref;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.CategoricalIndex.Ref;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.CategoricalIndex.Ref;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.CategoricalIndex.Ref;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.CategoricalIndex.Ref;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.CategoricalIndex.Ref;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.CategoricalIndex.Ref;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.CategoricalIndex.Ref;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.CategoricalIndex.Ref;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.CategoricalIndex.Ref;

    mergeJson(json: any | null): Data.CategoricalIndex.Ref;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.CategoricalIndex.Ref;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.CategoricalIndex.Ref;
     ...
     */
    singletonArray(): C3.Array<Data.CategoricalIndex.Ref | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.CategoricalIndex.Ref | null>;
     ...
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.CategoricalIndex.Ref | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.CategoricalIndex.Ref | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.CategoricalIndex.Ref | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.CategoricalIndex.Ref | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.CategoricalIndex.Ref | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.CategoricalIndex.Ref | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.CategoricalIndex.Ref | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.CategoricalIndex.Ref;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.CategoricalIndex.Ref;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.CategoricalIndex.Ref;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.CategoricalIndex.Ref;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.CategoricalIndex.Ref;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.CategoricalIndex.Ref;

    /**
     * Construct an instance with initial state.
     */
    static make(): Data.CategoricalIndex.Ref;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.CategoricalIndex.Ref;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Data.CategoricalIndex.Ref;
     ...
     */
    static cachedEmptyInst(): Data.CategoricalIndex.Ref;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.CategoricalIndex.Ref>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.CategoricalIndex.Ref;
     ...
     */
    static fromPySrc(pySrc: string, dfs?: C3.Set<DataImpl | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): Data.CategoricalIndex.Ref | null;
     ...
     */
    static _jsDataProxy(inst: any): Data.CategoricalIndex.Ref;
     ...
     * @return this Obj
     */
    setField(field: string, value: any, doNotConvert?: boolean): Data.CategoricalIndex.Ref;
     ...
     * @return this Obj
     */
    setField(field: FieldType, value: any, doNotConvert?: boolean): Data.CategoricalIndex.Ref;
