// TypeScript definitions for the C3 type InvalidationQueueConfig

/**
 * Configuration for invalidation queues.
 *
 * @remarks this represents a value passed to a method that expects an instance of InvalidationQueueConfig
 */
declare interface IInvalidationQueueConfig {
   ...
   */
  emptyQueueCheckSeconds: number;

  /**
   * Maximum number of parallel processing threads for cloud queues.
   */
  maxConcurrentProcessingThreads: number;
   ...
   */
  queuesToMonitor?: C3.Array<string | null> | Array<string | null>;
   ...
   */
  statsToMonitor?: C3.Array<string | null> | Array<string | null>;

  /**
   * CacheQueue config
   */
  CacheQueue?: IInvalidationQueueConfigChild | null;

  /**
   * ChangeLogQueue config
   */
  ChangeLogQueue?: IInvalidationQueueConfigChild | null;

  /**
   * CalcFieldsQueue config
   */
  CalcFieldsQueue?: IInvalidationQueueConfigChild | null;

  /**
   * NormalizationQueue config
   */
  NormalizationQueue?: IInvalidationQueueConfigChild | null;

  /**
   * PopulateAclQueue config
   */
  PopulateAclQueue?: IInvalidationQueueConfigChild | null;

  /**
   * HierarchyDenormQueue config
   */
  HierarchyDenormQueue?: IInvalidationQueueConfigChild | null;

  /**
   * ActionQueue config
   */
  ActionQueue?: IInvalidationQueueConfigChild | null;

  /**
   * MetricDepsQueue config
   */
  MetricDepsQueue?: IInvalidationQueueConfigChild | null;

  /**
   * MetricsQueue config
   */
  MetricsQueue?: IInvalidationQueueConfigChild | null;

  /**
   * AnalyticsQueue config
   */
  AnalyticsQueue?: IInvalidationQueueConfigChild | null;

  /**
   * JmsDataLoadQueue config
   */
  JmsDataLoadQueue?: IInvalidationQueueConfigChild | null;

  /**
   * SourceQueue config
   */
  SourceQueue?: IInvalidationQueueConfigChild | null;

  /**
   * SourceStatusQueue config
   */
  SourceStatusQueue?: IInvalidationQueueConfigChild | null;

  /**
   * SqsQueue config
   */
  SqsQueue?: IInvalidationQueueConfigChild | null;

  /**
   * KinesisQueue config
   */
  KinesisQueue?: IInvalidationQueueConfigChild | null;

  /**
   * EventHubQueue config
   */
  EventHubQueue?: IInvalidationQueueConfigChild | null;

  /**
   * KafkaQueue config
   */
  KafkaQueue?: IInvalidationQueueConfigChild | null;

  /**
   * CronQueue config
   */
  CronQueue?: IInvalidationQueueConfigChild | null;

  /**
   * WorkflowQueue config
   */
  WorkflowQueue?: IInvalidationQueueConfigChild | null;

  /**
   * Default queue config for any queues not specified above.
   */
  default?: IInvalidationQueueConfigChild | null;
}

/**
 * Configuration for invalidation queues.
 *
 * @remarks this represents a made instance of InvalidationQueueConfig
 */
declare class InvalidationQueueConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): InvalidationQueueConfig;

  static readonly configOverride?: string | null;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): InvalidationQueueConfig;
  ...
  withIssues(issues: C3.Array<string | null> | Array<string | null>): InvalidationQueueConfig;
   ...
   * Delay in milliseconds before a worker will start processing invalidation queue requests.
   */
  readonly initialScheduleDelay: number;
  withInitialScheduleDelay(initialScheduleDelay: number): InvalidationQueueConfig;

  /**
   * Delay in milliseconds before a worker will start processing invalidation queue requests.
   */
  static readonly initialScheduleDelay: number;

  /**
   * Sleep time in milliseconds between invalidation queue sweeps when the last sweep found nothing to process.
   */
  readonly idleSleep: number;
  withIdleSleep(idleSleep: number): InvalidationQueueConfig;

  /**
   * Sleep time in milliseconds between invalidation queue sweeps when the last sweep found nothing to process.
   */
  static readonly idleSleep: number;

  /**
   * Maximum number of attempts to retry compute for queue entries when retryable errors occur.
   */
  readonly retryCount: number;
  withRetryCount(retryCount: number): InvalidationQueueConfig;

  /**
   * Maximum number of attempts to retry compute for queue entries when retryable errors occur.
   */
  static readonly retryCount: number;

  /**
   * Time between sweeps for recovering stuck queue entries.
   */
  readonly recoveryIntervalMinute: number;
  withRecoveryIntervalMinute(recoveryIntervalMinute: number): InvalidationQueueConfig;

  /**
   * Time between sweeps for recovering stuck queue entries.
   */
  static readonly recoveryIntervalMinute: number;

  /**
   * Maximum recursive depth limit for asynchronous processing.
   */
  readonly depthLimit: number;
  withDepthLimit(depthLimit: number): InvalidationQueueConfig;

  /**
   * Maximum recursive depth limit for asynchronous processing.
   */
  static readonly depthLimit: number;

  /**
   * The number of seconds that a queue that has entries will continue to be checked during the lock operation once it
   * no longer has entries.
   */
  readonly emptyQueueCheckSeconds: number;
  withEmptyQueueCheckSeconds(emptyQueueCheckSeconds: number): InvalidationQueueConfig;

  /**
   * The number of seconds that a queue that has entries will continue to be checked during the lock operation once it
   * no longer has entries.
   */
  static readonly emptyQueueCheckSeconds: number;

  /**
   * Maximum number of parallel processing threads for cloud queues.
   */
  readonly maxConcurrentProcessingThreads: number;
  withMaxConcurrentProcessingThreads(maxConcurrentProcessingThreads: number): InvalidationQueueConfig;

  /**
   * Maximum number of parallel processing threads for cloud queues.
   */
  static readonly maxConcurrentProcessingThreads: number;

  /**
   * Backing store (e.g. handles queue entry persistence, locking, etc.) for the invalidation queues.
   */
  readonly store: string;
  withStore(store: string): InvalidationQueueConfig;

  /**
   * Backing store (e.g. handles queue entry persistence, locking, etc.) for the invalidation queues.
   */
  static readonly store: string;

  readonly maxSchedulingThreads: number;
  withMaxSchedulingThreads(maxSchedulingThreads: number): InvalidationQueueConfig;

  static readonly maxSchedulingThreads: number;

  /**
   * Interval for resetting the accumulated time consumed by tags for scheduling "fairness"
   */
  readonly schedQueueTimesResetIntervalMinute: number;
  withSchedQueueTimesResetIntervalMinute(schedQueueTimesResetIntervalMinute: number): InvalidationQueueConfig;

  /**
   * Interval for resetting the accumulated time consumed by tags for scheduling "fairness"
   */
  static readonly schedQueueTimesResetIntervalMinute: number;
   ...
   * ["CronQueue", "CalcFieldsQueue"].
   */
  readonly queuesToMonitor?: C3.Array<string | null>;
  withQueuesToMonitor(queuesToMonitor: C3.Array<string | null> | Array<string | null>): InvalidationQueueConfig;
   ...
   * ["CronQueue", "CalcFieldsQueue"].
   */
  static readonly queuesToMonitor?: C3.Array<string | null>;
   ...
   * example: use ["initial", "awaitingCompute", "failed"]
   */
  readonly statsToMonitor?: C3.Array<string | null>;
  withStatsToMonitor(statsToMonitor: C3.Array<string | null> | Array<string | null>): InvalidationQueueConfig;
   ...
   * example: use ["initial", "awaitingCompute", "failed"]
   */
  static readonly statsToMonitor?: C3.Array<string | null>;

  /**
   * CacheQueue config
   */
  readonly CacheQueue?: InvalidationQueueConfigChild | null;
  withCacheQueue(CacheQueue: IInvalidationQueueConfigChild | null): InvalidationQueueConfig;

  /**
   * CacheQueue config
   */
  static readonly CacheQueue?: InvalidationQueueConfigChild | null;

  /**
   * ChangeLogQueue config
   */
  readonly ChangeLogQueue?: InvalidationQueueConfigChild | null;
  withChangeLogQueue(ChangeLogQueue: IInvalidationQueueConfigChild | null): InvalidationQueueConfig;

  /**
   * ChangeLogQueue config
   */
  static readonly ChangeLogQueue?: InvalidationQueueConfigChild | null;

  /**
   * CalcFieldsQueue config
   */
  readonly CalcFieldsQueue?: InvalidationQueueConfigChild | null;
  withCalcFieldsQueue(CalcFieldsQueue: IInvalidationQueueConfigChild | null): InvalidationQueueConfig;

  /**
   * CalcFieldsQueue config
   */
  static readonly CalcFieldsQueue?: InvalidationQueueConfigChild | null;

  /**
   * NormalizationQueue config
   */
  readonly NormalizationQueue?: InvalidationQueueConfigChild | null;
  withNormalizationQueue(NormalizationQueue: IInvalidationQueueConfigChild | null): InvalidationQueueConfig;

  /**
   * NormalizationQueue config
   */
  static readonly NormalizationQueue?: InvalidationQueueConfigChild | null;

  /**
   * PopulateAclQueue config
   */
  readonly PopulateAclQueue?: InvalidationQueueConfigChild | null;
  withPopulateAclQueue(PopulateAclQueue: IInvalidationQueueConfigChild | null): InvalidationQueueConfig;

  /**
   * PopulateAclQueue config
   */
  static readonly PopulateAclQueue?: InvalidationQueueConfigChild | null;

  /**
   * HierarchyDenormQueue config
   */
  readonly HierarchyDenormQueue?: InvalidationQueueConfigChild | null;
  withHierarchyDenormQueue(HierarchyDenormQueue: IInvalidationQueueConfigChild | null): InvalidationQueueConfig;

  /**
   * HierarchyDenormQueue config
   */
  static readonly HierarchyDenormQueue?: InvalidationQueueConfigChild | null;

  /**
   * ActionQueue config
   */
  readonly ActionQueue?: InvalidationQueueConfigChild | null;
  withActionQueue(ActionQueue: IInvalidationQueueConfigChild | null): InvalidationQueueConfig;

  /**
   * ActionQueue config
   */
  static readonly ActionQueue?: InvalidationQueueConfigChild | null;

  /**
   * MetricDepsQueue config
   */
  readonly MetricDepsQueue?: InvalidationQueueConfigChild | null;
  withMetricDepsQueue(MetricDepsQueue: IInvalidationQueueConfigChild | null): InvalidationQueueConfig;

  /**
   * MetricDepsQueue config
   */
  static readonly MetricDepsQueue?: InvalidationQueueConfigChild | null;

  /**
   * MetricsQueue config
   */
  readonly MetricsQueue?: InvalidationQueueConfigChild | null;
  withMetricsQueue(MetricsQueue: IInvalidationQueueConfigChild | null): InvalidationQueueConfig;

  /**
   * MetricsQueue config
   */
  static readonly MetricsQueue?: InvalidationQueueConfigChild | null;

  /**
   * AnalyticsQueue config
   */
  readonly AnalyticsQueue?: InvalidationQueueConfigChild | null;
  withAnalyticsQueue(AnalyticsQueue: IInvalidationQueueConfigChild | null): InvalidationQueueConfig;

  /**
   * AnalyticsQueue config
   */
  static readonly AnalyticsQueue?: InvalidationQueueConfigChild | null;

  /**
   * JmsDataLoadQueue config
   */
  readonly JmsDataLoadQueue?: InvalidationQueueConfigChild | null;
  withJmsDataLoadQueue(JmsDataLoadQueue: IInvalidationQueueConfigChild | null): InvalidationQueueConfig;

  /**
   * JmsDataLoadQueue config
   */
  static readonly JmsDataLoadQueue?: InvalidationQueueConfigChild | null;

  /**
   * SourceQueue config
   */
  readonly SourceQueue?: InvalidationQueueConfigChild | null;
  withSourceQueue(SourceQueue: IInvalidationQueueConfigChild | null): InvalidationQueueConfig;

  /**
   * SourceQueue config
   */
  static readonly SourceQueue?: InvalidationQueueConfigChild | null;

  /**
   * SourceStatusQueue config
   */
  readonly SourceStatusQueue?: InvalidationQueueConfigChild | null;
  withSourceStatusQueue(SourceStatusQueue: IInvalidationQueueConfigChild | null): InvalidationQueueConfig;

  /**
   * SourceStatusQueue config
   */
  static readonly SourceStatusQueue?: InvalidationQueueConfigChild | null;

  /**
   * SqsQueue config
   */
  readonly SqsQueue?: InvalidationQueueConfigChild | null;
  withSqsQueue(SqsQueue: IInvalidationQueueConfigChild | null): InvalidationQueueConfig;

  /**
   * SqsQueue config
   */
  static readonly SqsQueue?: InvalidationQueueConfigChild | null;

  /**
   * KinesisQueue config
   */
  readonly KinesisQueue?: InvalidationQueueConfigChild | null;
  withKinesisQueue(KinesisQueue: IInvalidationQueueConfigChild | null): InvalidationQueueConfig;

  /**
   * KinesisQueue config
   */
  static readonly KinesisQueue?: InvalidationQueueConfigChild | null;

  /**
   * EventHubQueue config
   */
  readonly EventHubQueue?: InvalidationQueueConfigChild | null;
  withEventHubQueue(EventHubQueue: IInvalidationQueueConfigChild | null): InvalidationQueueConfig;

  /**
   * EventHubQueue config
   */
  static readonly EventHubQueue?: InvalidationQueueConfigChild | null;

  /**
   * KafkaQueue config
   */
  readonly KafkaQueue?: InvalidationQueueConfigChild | null;
  withKafkaQueue(KafkaQueue: IInvalidationQueueConfigChild | null): InvalidationQueueConfig;

  /**
   * KafkaQueue config
   */
  static readonly KafkaQueue?: InvalidationQueueConfigChild | null;

  /**
   * CronQueue config
   */
  readonly CronQueue?: InvalidationQueueConfigChild | null;
  withCronQueue(CronQueue: IInvalidationQueueConfigChild | null): InvalidationQueueConfig;

  /**
   * CronQueue config
   */
  static readonly CronQueue?: InvalidationQueueConfigChild | null;

  /**
   * WorkflowQueue config
   */
  readonly WorkflowQueue?: InvalidationQueueConfigChild | null;
  withWorkflowQueue(WorkflowQueue: IInvalidationQueueConfigChild | null): InvalidationQueueConfig;

  /**
   * WorkflowQueue config
   */
  static readonly WorkflowQueue?: InvalidationQueueConfigChild | null;

  /**
   * Default queue config for any queues not specified above.
   */
  readonly default?: InvalidationQueueConfigChild | null;
  withDefault(default_: IInvalidationQueueConfigChild | null): InvalidationQueueConfig;

  /**
   * Default queue config for any queues not specified above.
   */
  static readonly default?: InvalidationQueueConfigChild | null;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): InvalidationQueueConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): InvalidationQueueConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): InvalidationQueueConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): InvalidationQueueConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): InvalidationQueueConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): InvalidationQueueConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): InvalidationQueueConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): InvalidationQueueConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): InvalidationQueueConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): InvalidationQueueConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<InvalidationQueueConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<InvalidationQueueConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<InvalidationQueueConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<InvalidationQueueConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): InvalidationQueueConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): InvalidationQueueConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): InvalidationQueueConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): InvalidationQueueConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): InvalidationQueueConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): InvalidationQueueConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): InvalidationQueueConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): InvalidationQueueConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): InvalidationQueueConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): InvalidationQueueConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): InvalidationQueueConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): InvalidationQueueConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): InvalidationQueueConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): InvalidationQueueConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): InvalidationQueueConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): InvalidationQueueConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): InvalidationQueueConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): InvalidationQueueConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): InvalidationQueueConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): InvalidationQueueConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): InvalidationQueueConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): InvalidationQueueConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): InvalidationQueueConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): InvalidationQueueConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): InvalidationQueueConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): InvalidationQueueConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): InvalidationQueueConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): InvalidationQueueConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): InvalidationQueueConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): InvalidationQueueConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): InvalidationQueueConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): InvalidationQueueConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): InvalidationQueueConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): InvalidationQueueConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): InvalidationQueueConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): InvalidationQueueConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): InvalidationQueueConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): InvalidationQueueConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): InvalidationQueueConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): InvalidationQueueConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): InvalidationQueueConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): InvalidationQueueConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): InvalidationQueueConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): InvalidationQueueConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): InvalidationQueueConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): InvalidationQueueConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): InvalidationQueueConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): InvalidationQueueConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): InvalidationQueueConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): InvalidationQueueConfig;

  mergeJson(json: any | null): InvalidationQueueConfig;

  static mergeJson(json: any | null): InvalidationQueueConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): InvalidationQueueConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): InvalidationQueueConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): InvalidationQueueConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): InvalidationQueueConfig;
   ...
   */
  singletonArray(): C3.Array<InvalidationQueueConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<InvalidationQueueConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<InvalidationQueueConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<InvalidationQueueConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<InvalidationQueueConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<InvalidationQueueConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<InvalidationQueueConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, InvalidationQueueConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, InvalidationQueueConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<InvalidationQueueConfig | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<InvalidationQueueConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<InvalidationQueueConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): InvalidationQueueConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): InvalidationQueueConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): InvalidationQueueConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): InvalidationQueueConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): InvalidationQueueConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): InvalidationQueueConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): InvalidationQueueConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): InvalidationQueueConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): InvalidationQueueConfig;
   ...
   */
  static cachedEmptyInst(): InvalidationQueueConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<InvalidationQueueConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): InvalidationQueueConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<InvalidationQueueConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<InvalidationQueueConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<InvalidationQueueConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): InvalidationQueueConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): InvalidationQueueConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): InvalidationQueueConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): InvalidationQueueConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): InvalidationQueueConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): InvalidationQueueConfig | null;
   ...
   */
  static produce(key: string): InvalidationQueueConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, InvalidationQueueConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, InvalidationQueueConfig | null>;
   ...
   */
  getConfig(): InvalidationQueueConfig;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): InvalidationQueueConfig;
   ...
   */
  getSecret(): InvalidationQueueConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): InvalidationQueueConfig;
   ...
   */
  static forConfigKey(configKey: string | null): InvalidationQueueConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<InvalidationQueueConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: InvalidationQueueConfig, override?: string | null): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: InvalidationQueueConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: InvalidationQueueConfig, override?: string | null): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: InvalidationQueueConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): InvalidationQueueConfig | null;
   ...
   */
  removeSecrets(): InvalidationQueueConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): InvalidationQueueConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): InvalidationQueueConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): InvalidationQueueConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): InvalidationQueueConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): InvalidationQueueConfig;
   ...
   */
  static inst(): InvalidationQueueConfig;

  /**
   * @return the cached instance if already cached, null otherwise. Does not instantiate if missing.
   */
  static cachedInst(): InvalidationQueueConfig | null;

  /**
   * @return configuration of the specific file system.
   */
  childConfig(queueTypeName: string): InvalidationQueueConfigChild;

  /**
   * @return configuration of the specific file system.
   */
  static childConfig(queueTypeName: string): InvalidationQueueConfigChild;
}
