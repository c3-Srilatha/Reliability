// TypeScript definitions for the C3 type Data.Spark.MultiIndexImpl
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Data.Spark.MultiIndexImpl
 */
declare namespace Data.Spark {
  export interface IMultiIndexImpl {
 ...
 * See the interface {@link Data.Spark.Index} for declared APIs
 *
 * @remarks this represents a made instance of Data.Spark.MultiIndexImpl
 */
declare namespace Data.Spark {
  export class MultiIndexImpl extends Obj {
    ...
    withEngine(engine: IData.ExecutionEngine | null): Data.Spark.MultiIndexImpl;

    /**
     * The plan that used to actualize this Data.Spark instance
     */
    pipeline?: PipelineSpec | null;
    withPipeline(pipeline: IPipelineSpec | null): Data.Spark.MultiIndexImpl;

    /**
     * The id number that represent this Data.Spark instance
     */
    nodeId?: string | null;
    withNodeId(nodeId: string | null): Data.Spark.MultiIndexImpl;

    /**
     * The output name of the pipeline
     */
    outputId?: string | null;
    withOutputId(outputId: string | null): Data.Spark.MultiIndexImpl;
    ...
    copy(deep?: boolean | null): Data.Spark.Index | null | Data.Spark.MultiIndex | null | null;
    ...
    drop(codes?: C3.Array<any> | null, level?: any): Data.Spark.Index | null | Data.Spark.MultiIndex | null | null;

    drop_duplicates(keep?: boolean | string | null | null): Data.Spark.Index | null | Data.Spark.MultiIndex | null | null;
    ...
    intersection(other?: any): Data.Spark.Index | null | Data.Spark.MultiIndex | null | null;
    ...
    symmetric_difference(other?: any, result_name?: C3.Array<any> | null, sort?: boolean | null): Data.Spark.Index | null | Data.Spark.MultiIndex | null | null;

    take(indices?: any): any;

    to_frame(index?: boolean | null, name?: any): Data.Spark.DataFrame | null;

    to_frame(index?: boolean | null, name?: C3.Array<any> | null): Data.Spark.DataFrame | null;

    to_list(): C3.Array<any> | null;

    to_pandas(): Data.Spark.Index | null | Data.Spark.MultiIndex | null | null;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.Spark.MultiIndexImpl | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.Spark.MultiIndexImpl | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.Spark.MultiIndexImpl | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.Spark.MultiIndexImpl | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.Spark.MultiIndexImpl;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Spark.MultiIndexImpl;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Spark.MultiIndexImpl;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Spark.MultiIndexImpl | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Spark.MultiIndexImpl | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.Spark.MultiIndexImpl;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Spark.MultiIndexImpl;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Spark.MultiIndexImpl;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.Spark.MultiIndexImpl;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.Spark.MultiIndexImpl;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.Spark.MultiIndexImpl;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.Spark.MultiIndexImpl;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.Spark.MultiIndexImpl;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.Spark.MultiIndexImpl;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.Spark.MultiIndexImpl;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.Spark.MultiIndexImpl;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.Spark.MultiIndexImpl;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.Spark.MultiIndexImpl;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.Spark.MultiIndexImpl;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.Spark.MultiIndexImpl;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.Spark.MultiIndexImpl;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.Spark.MultiIndexImpl;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.Spark.MultiIndexImpl;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.Spark.MultiIndexImpl;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.Spark.MultiIndexImpl;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.Spark.MultiIndexImpl;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.Spark.MultiIndexImpl;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.Spark.MultiIndexImpl;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.Spark.MultiIndexImpl;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.Spark.MultiIndexImpl;

    mergeJson(json: any | null): Data.Spark.MultiIndexImpl;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.Spark.MultiIndexImpl;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.Spark.MultiIndexImpl;
     ...
     */
    singletonArray(): C3.Array<Data.Spark.MultiIndexImpl | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.Spark.MultiIndexImpl | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.Spark.MultiIndexImpl | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.Spark.MultiIndexImpl | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.Spark.MultiIndexImpl | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.Spark.MultiIndexImpl | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.Spark.MultiIndexImpl | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.Spark.MultiIndexImpl | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.Spark.MultiIndexImpl | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.Spark.MultiIndexImpl;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.Spark.MultiIndexImpl;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.Spark.MultiIndexImpl;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.Spark.MultiIndexImpl;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.Spark.MultiIndexImpl;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.Spark.MultiIndexImpl;

    /**
     * Construct an instance with initial state.
     */
    static make(): Data.Spark.MultiIndexImpl;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.Spark.MultiIndexImpl;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Data.Spark.MultiIndexImpl;
     ...
     */
    static cachedEmptyInst(): Data.Spark.MultiIndexImpl;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.Spark.MultiIndexImpl>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.Spark.MultiIndexImpl;
    ...
    factorize(sort?: boolean | null, na_sentinel?: number | null): Data.Spark.Index | null | Data.Spark.MultiIndex | null | null;

    static from_arrays(arrays?: C3.Array<C3.Array<any>> | null, sortorder?: number | null, names?: C3.Array<any> | null): Data.Spark.Index | null | Data.Spark.MultiIndex | null | null;

    static from_frame(df?: any, names?: C3.Array<any> | null): Data.Spark.Index | null | Data.Spark.MultiIndex | null | null;

    static from_product(iterables?: C3.Array<C3.Array<any>> | null, sortorder?: number | null, names?: C3.Array<any> | null): Data.Spark.Index | null | Data.Spark.MultiIndex | null | null;

    static from_tuples(tuples?: C3.Array<any> | null, sortorder?: number | null, names?: C3.Array<any> | null): Data.Spark.Index | null | Data.Spark.MultiIndex | null | null;

    swaplevel(i?: number | null, j?: number | null): Data.Spark.Index | null | Data.Spark.MultiIndex | null | null;
     ...
     * @return this Obj
     */
    setField(field: string, value: any, doNotConvert?: boolean): Data.Spark.MultiIndexImpl;
     ...
     * @return this Obj
     */
    setField(field: FieldType, value: any, doNotConvert?: boolean): Data.Spark.MultiIndexImpl;
