// TypeScript definitions for the C3 type NettyServerConfig

/**
 * @remarks this represents a value passed to a method that expects an instance of NettyServerConfig
 */
declare interface INettyServerConfig {
...
/**
 * @remarks this represents a made instance of NettyServerConfig
 */
declare class NettyServerConfig extends Obj {

  readonly SO_BACKLOG?: number | null;
  withSO_BACKLOG(SO_BACKLOG: number | null): NettyServerConfig;

  readonly SO_BROADCAST?: boolean;
  withSO_BROADCAST(SO_BROADCAST: boolean): NettyServerConfig;

  readonly SO_KEEPALIVE?: boolean;
  withSO_KEEPALIVE(SO_KEEPALIVE: boolean): NettyServerConfig;

  readonly SO_LINGER?: number | null;
  withSO_LINGER(SO_LINGER: number | null): NettyServerConfig;

  readonly SO_RCVBUF?: number | null;
  withSO_RCVBUF(SO_RCVBUF: number | null): NettyServerConfig;

  readonly SO_REUSEADDR?: boolean;
  withSO_REUSEADDR(SO_REUSEADDR: boolean): NettyServerConfig;

  readonly SO_SNDBUF?: number | null;
  withSO_SNDBUF(SO_SNDBUF: number | null): NettyServerConfig;

  readonly SO_TIMEOUT?: number | null;
  withSO_TIMEOUT(SO_TIMEOUT: number | null): NettyServerConfig;

  readonly TCP_NODELAY?: boolean;
  withTCP_NODELAY(TCP_NODELAY: boolean): NettyServerConfig;

  readonly connectionTimeoutMillis?: number | null;
  withConnectionTimeoutMillis(connectionTimeoutMillis: number | null): NettyServerConfig;

  readonly maxMessagesPerRead?: number | null;
  withMaxMessagesPerRead(maxMessagesPerRead: number | null): NettyServerConfig;

  readonly writeBufHighWaterMark?: number | null;
  withWriteBufHighWaterMark(writeBufHighWaterMark: number | null): NettyServerConfig;

  readonly writeBufLowWaterMark?: number | null;
  withWriteBufLowWaterMark(writeBufLowWaterMark: number | null): NettyServerConfig;

  /**
   * The name of this instance.
   */
  readonly name?: string | null;
  withName(name: string | null): NettyServerConfig;

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): NettyServerConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): NettyServerConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): NettyServerConfig;

  readonly masterThreadCount?: number | null;
  withMasterThreadCount(masterThreadCount: number | null): NettyServerConfig;

  readonly workerThreadCount?: number | null;
  withWorkerThreadCount(workerThreadCount: number | null): NettyServerConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): NettyServerConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): NettyServerConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): NettyServerConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): NettyServerConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): NettyServerConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NettyServerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NettyServerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NettyServerConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NettyServerConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): NettyServerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NettyServerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NettyServerConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): NettyServerConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): NettyServerConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): NettyServerConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): NettyServerConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): NettyServerConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): NettyServerConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): NettyServerConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): NettyServerConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): NettyServerConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): NettyServerConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): NettyServerConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): NettyServerConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): NettyServerConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): NettyServerConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): NettyServerConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): NettyServerConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): NettyServerConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): NettyServerConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): NettyServerConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): NettyServerConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): NettyServerConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): NettyServerConfig;

  mergeJson(json: any | null): NettyServerConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): NettyServerConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): NettyServerConfig;
   ...
   */
  singletonArray(): C3.Array<NettyServerConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<NettyServerConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<NettyServerConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<NettyServerConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<NettyServerConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, NettyServerConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, NettyServerConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<NettyServerConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<NettyServerConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): NettyServerConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): NettyServerConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): NettyServerConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): NettyServerConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): NettyServerConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): NettyServerConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): NettyServerConfig;
   ...
   */
  static cachedEmptyInst(): NettyServerConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<NettyServerConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): NettyServerConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<NettyServerConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<NettyServerConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<NettyServerConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): NettyServerConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): NettyServerConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): NettyServerConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): NettyServerConfig | null;
   ...
   */
  static produce(key: string): NettyServerConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, NettyServerConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, NettyServerConfig | null>;
   ...
   */
  static forConfigKey(configKey: string | null): NettyServerConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<NettyServerConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: NettyServerConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: NettyServerConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): NettyServerConfig | null;
