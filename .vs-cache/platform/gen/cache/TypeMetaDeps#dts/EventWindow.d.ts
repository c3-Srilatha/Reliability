// TypeScript definitions for the C3 type EventWindow
 ...
 * interval of time.
 *
 * @remarks this represents a value passed to a method that expects an instance of EventWindow
 */
declare interface IEventWindow {
 ...
 * interval of time.
 *
 * @remarks this represents a made instance of EventWindow
 */
declare class EventWindow extends Obj {

  /**
   * Start timestamp for the value.  If null, assumed to be beginning-of-time (BOT).
   */
  readonly start?: DateTime | null;
  withStart(start: DateTime | Date | string | null): EventWindow;

  /**
   * End timestamp for the value.  If null, assumed to be end-of-time (EOT).
   */
  readonly end?: DateTime | null;
  withEnd(end: DateTime | Date | string | null): EventWindow;
  ...
  withTypeIdent(typeIdent: string | null): EventWindow;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): EventWindow;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): EventWindow;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): EventWindow;
  ...
  withVersion(version: number | null): EventWindow;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): EventWindow;

  /**
   * Spec that was used to create this {@link EventWindow}.
   */
  readonly spec?: TimeseriesToEventWindowsSpec | null;
  withSpec(spec: ITimeseriesToEventWindowsSpec | null): EventWindow;

  /**
   * "OPEN" or "CLOSED" if {@link EventWindow} is in active monitoring state.
   */
  readonly status?: string | null;
  withStatus(status: string | null): EventWindow;
  ...
  withEvents(events: C3.Array<ObservedEvent | null> | Array<IObservedEvent | null>): EventWindow;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): EventWindow | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): EventWindow | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): EventWindow | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): EventWindow | null;
   ...
   */
  replaceType(old: Type, new_: Type): EventWindow;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): EventWindow;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): EventWindow;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<EventWindow | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<EventWindow | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): EventWindow;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): EventWindow;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): EventWindow;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): EventWindow;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): EventWindow;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): EventWindow;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): EventWindow;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): EventWindow;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): EventWindow;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): EventWindow;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): EventWindow;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): EventWindow;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): EventWindow;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): EventWindow;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): EventWindow;
   ...
   * @see #unsetField
   */
  defaultField(field: string): EventWindow;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): EventWindow;
   ...
   * @see #removeField
   */
  unsetField(field: string): EventWindow;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): EventWindow;
   ...
   * @see #unsetField
   */
  removeField(field: string): EventWindow;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): EventWindow;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): EventWindow;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): EventWindow;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): EventWindow;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): EventWindow;

  mergeJson(json: any | null): EventWindow;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): EventWindow;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): EventWindow;
   ...
   */
  singletonArray(): C3.Array<EventWindow | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<EventWindow | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<EventWindow | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<EventWindow | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<EventWindow | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, EventWindow | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, EventWindow | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<EventWindow | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<EventWindow | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): EventWindow;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): EventWindow;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): EventWindow;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): EventWindow;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): EventWindow;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): EventWindow;
   ...
   * @see #fromString
   */
  static make(s: string | null): EventWindow | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): EventWindow;
   ...
   */
  static cachedEmptyInst(): EventWindow;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<EventWindow>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): EventWindow;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<EventWindow | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<EventWindow | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<EventWindow | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<EventWindow | null> | null>;
   ...
   */
  get(include?: string | null): EventWindow | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): EventWindow | null;
   ...
   */
  getMissing(spec: GetMissingSpec): EventWindow;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): EventWindow | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): EventWindow;
   ...
   * @see #toString
   */
  static fromString(s: string | null): EventWindow | null;
   ...
   */
  create(spec?: UpsertSpec | null): EventWindow | null;
   ...
   */
  static createBatch(objs: C3.Array<EventWindow | null> | null, spec?: UpsertSpec | null): ObjList<EventWindow | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<EventWindow | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<EventWindow | null> | null;
   ...
   */
  update(srcObj?: EventWindow | null, spec?: UpsertSpec | null): EventWindow | null;
   ...
   */
  upsert(srcObj?: EventWindow | null, spec?: UpsertSpec | null): EventWindow | null;
   ...
   */
  merge(spec?: MergeSpec | null): EventWindow | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): EventWindow | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): EventWindow | null;
   ...
   */
  static updateBatch(objs: C3.Array<EventWindow | null> | null, srcObjs?: C3.Array<EventWindow | null>, spec?: UpsertSpec | null): ObjList<EventWindow | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<EventWindow | null>>, spec?: UpsertSpec | null): ObjList<EventWindow | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<EventWindow | null> | null, srcObjs?: C3.Array<EventWindow | null>, spec?: UpsertSpec | null): ObjList<EventWindow | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<EventWindow | null>>, spec?: UpsertSpec | null): ObjList<EventWindow | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<EventWindow | null> | null, spec?: TouchSpec | null): ObjList<EventWindow | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<EventWindow | null> | null, spec?: MergeSpec | null): ObjList<EventWindow | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<EventWindow | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<EventWindow | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<EventWindow | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<EventWindow | null> | null;
   ...
   */
  static mergeAll(mergeObj: EventWindow | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: EventWindow | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<EventWindow | null> | null, spec?: UpsertSpec | null): ObjList<EventWindow | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<EventWindow | null> | null, spec?: UpsertSpec | null): ObjList<EventWindow | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<EventWindow | null> | null): ObjList<EventWindow | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<EventWindow | null> | null): ObjList<EventWindow | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<EventWindow | null> | null): ObjList<EventWindow | null>;
   ...
   */
  static afterCreate(objs: C3.Array<EventWindow | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<EventWindow | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<EventWindow | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<EventWindow | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<EventWindow | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): EventWindow | null;
   ...
   */
  withoutIdentity(): EventWindow | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<EventWindow | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: EventWindow | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<EventWindow | null> | null, callback?: λFunction<EventWindow | null, EventWindow | null> | null): ObjList<EventWindow | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<EventWindow | null> | null, callback?: λFunction<EventWindow | null, EventWindow | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static fromTimeseries(spec?: TimeseriesToEventWindowsSpec | null): C3.Array<EventWindow | null>;
   ...
   * @returns not persisted {@link EventWindow}s.
   */
  static fromEvalMetricsResult(emr: EvalMetricsResult, spec: EvalMetricsResultToEventWindowsSpec): C3.Array<EventWindow | null>;
   ...
   */
  static fromObservedEvents(events?: C3.Array<ObservedEvent | null>, windowDuration: Duration, endsPriorToEvent: Duration): C3.Array<EventWindow | null>;
   ...
   */
  static mergeEventWindows(windows?: C3.Array<C3.Array<EventWindow | null>>, spec?: EventWindowMergeSpec | null): C3.Array<EventWindow | null>;
}
