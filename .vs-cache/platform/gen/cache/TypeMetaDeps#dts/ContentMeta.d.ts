// TypeScript definitions for the C3 type ContentMeta

/**
 * The meta information for document content such as would be served by a web server.
 * See {@link http://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html RFC 2616 §14}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ContentMeta
 */
 ...
 * See {@link http://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html RFC 2616 §14}.
 *
 * @remarks this represents a made instance of ContentMeta
 */
declare class ContentMeta extends Obj {
  ...
  withContentEncoding(contentEncoding: string | null): ContentMeta;
  ...
  withContentLanguage(contentLanguage: string | null): ContentMeta;
  ...
  withContentLength(contentLength: number | null): ContentMeta;
  ...
  withContentLocation(contentLocation: string | null): ContentMeta;
  ...
  withContentType(contentType: string | null): ContentMeta;
  ...
  withContentDisposition(contentDisposition: string | null): ContentMeta;
  ...
  withETag(eTag: string | null): ContentMeta;
  ...
  withLastModified(lastModified: DateTime | Date | string | null): ContentMeta;

  /**
   * Id of user / identity who last last modified this content.
   */
  readonly lastModifiedBy?: string | null;
  withLastModifiedBy(lastModifiedBy: string | null): ContentMeta;
  ...
  withContentMD5(contentMD5: string | null): ContentMeta;
  ...
  withContentSHA1(contentSHA1: string | null): ContentMeta;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ContentMeta | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ContentMeta | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ContentMeta | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ContentMeta | null;
   ...
   */
  replaceType(old: Type, new_: Type): ContentMeta;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ContentMeta;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ContentMeta;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ContentMeta | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ContentMeta | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ContentMeta;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ContentMeta;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ContentMeta;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ContentMeta;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ContentMeta;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ContentMeta;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ContentMeta;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ContentMeta;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ContentMeta;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ContentMeta;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ContentMeta;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ContentMeta;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ContentMeta;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ContentMeta;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ContentMeta;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ContentMeta;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ContentMeta;
   ...
   * @see #removeField
   */
  unsetField(field: string): ContentMeta;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ContentMeta;
   ...
   * @see #unsetField
   */
  removeField(field: string): ContentMeta;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ContentMeta;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ContentMeta;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ContentMeta;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ContentMeta;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ContentMeta;

  mergeJson(json: any | null): ContentMeta;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ContentMeta;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ContentMeta;
   ...
   */
  singletonArray(): C3.Array<ContentMeta | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ContentMeta | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ContentMeta | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ContentMeta | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ContentMeta | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ContentMeta | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ContentMeta | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ContentMeta | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ContentMeta | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ContentMeta;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ContentMeta;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ContentMeta;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ContentMeta;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ContentMeta;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ContentMeta;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ContentMeta;
   ...
   */
  static cachedEmptyInst(): ContentMeta;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ContentMeta>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ContentMeta;
   ...
   */
  withFileName(fileName: string | null): ContentMeta;

  /**
   * Changes file extension in this instance.
   */
  withFileExt(fileExt: string | null): ContentMeta;
   ...
   */
  identify(suffix?: string | null): ContentMeta;
}
