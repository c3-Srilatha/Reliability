// TypeScript definitions for the C3 type JsonType

/**
 * The JavaScript Object Notation (JSON) value type has two variants:
 *  - `json`: JSON data without fixed structure
 *  - `typed json`: JSON for type-aware serialization
 *
 * There are no fields (other than #modifier), so this is normally accessed with {@link PrimitiveType#ofJson}.
 *
 * @see https://www.json.org/json-en.html
 *
 * @remarks this represents a value passed to a method that expects an instance of JsonType
 */
declare interface IJsonType {
  ...
  /**
   * Whether this JSON includes boxing and other structure necessary for maintaining full fidelity communication of
   * made C3 values with a type-aware peer process.
   *
   * @see serdeser.c3doc
   */
  typed?: boolean;
 ...
 * @see https://www.json.org/json-en.html
 *
 * @remarks this represents a made instance of JsonType
 */
declare class JsonType extends Obj {

  /**
   * Source file Pkg.Path a C3 Type declaration [.c3typ].
   */
  readonly declaredPkgPath?: string | null;
  withDeclaredPkgPath(declaredPkgPath: string | null): JsonType;

  /**
   * Source line number in a C3 Type declaration [.c3typ] file starting with 1 where this metadata element is declared.
   */
  readonly declaredSrcLine?: number | null;
  withDeclaredSrcLine(declaredSrcLine: number | null): JsonType;
  ...
  withDeclaredSrcCharInLine(declaredSrcCharInLine: number | null): JsonType;
   ...
   */
  readonly pkg: Pkg;
  withPkg(pkg: IPkg): JsonType;

  /**
   * SDK json representing instance of this type
   */
  readonly json?: any;
  withJson(json: any): JsonType;

  /**
   * The set of annotations defined on this element of metadata represented as json value.
   */
  readonly annotationsJson?: any | null;
  withAnnotationsJson(annotationsJson: any | null): JsonType;
  ...
  withModifier(modifier: string | null): JsonType;
  ...
  withSerializedType(serializedType: IValueType | null): JsonType;
  ...
  withEnumRefType(enumRefType: IReferenceType | null): JsonType;
  ...
  withDeclaredEnumValues(declaredEnumValues: C3.Array<string | null> | Array<string | null>): JsonType;
  ...
  withTyped(typed: boolean): JsonType;
   ...
   */
  replaceType(old: Type, new_: Type): JsonType;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): JsonType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): JsonType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): JsonType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): JsonType | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JsonType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JsonType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JsonType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JsonType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): JsonType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JsonType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JsonType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): JsonType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): JsonType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): JsonType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): JsonType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): JsonType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): JsonType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): JsonType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): JsonType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): JsonType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): JsonType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): JsonType;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): JsonType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): JsonType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): JsonType;
   ...
   * @see #removeField
   */
  unsetField(field: string): JsonType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): JsonType;
   ...
   * @see #unsetField
   */
  removeField(field: string): JsonType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): JsonType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): JsonType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): JsonType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): JsonType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): JsonType;

  mergeJson(json: any | null): JsonType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): JsonType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): JsonType;
   ...
   */
  singletonArray(): C3.Array<JsonType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<JsonType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<JsonType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<JsonType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<JsonType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, JsonType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, JsonType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<JsonType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<JsonType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): JsonType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): JsonType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): JsonType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): JsonType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): JsonType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): JsonType;
   ...
   * @see #fromString
   */
  static make(s: string | null): JsonType | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): JsonType;
   ...
   */
  static cachedEmptyInst(): JsonType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<JsonType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): JsonType;
   ...
   */
  withoutDeclaredSrcPos(recursive?: boolean): JsonType;
   ...
   */
  withAnnotation(ann: Annotation): JsonType;
   ...
   *         value for the field
   */
  withAnnotation(ann: string, annField?: string | null, value?: any): JsonType;
   ...
   * @see #toString
   */
  static fromString(s: string | null): JsonType | null;
