// TypeScript definitions for the C3 type MetricsCache

/**
 * Type for caching metric results.  Each entry is for invalidating the metrics cache for a single source instance.
 *
 * @remarks this represents a value passed to a method that expects an instance of MetricsCache
 */
declare interface IMetricsCache {
 ...
 */
declare class MetricsCache extends Obj {
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): MetricsCache;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): MetricsCache;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): MetricsCache;
  ...
  withVersion(version: number | null): MetricsCache;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): MetricsCache;

  /**
   * id is generated by pathId(METRIC_NAME)-INTERVAL-typeId(SRC_TYPE)-SRC_ID
   */
  readonly result?: Obj | null;
  withResult(result: IObj | null): MetricsCache;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): MetricsCache | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): MetricsCache | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): MetricsCache | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): MetricsCache | null;
   ...
   */
  replaceType(old: Type, new_: Type): MetricsCache;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MetricsCache;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MetricsCache;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MetricsCache | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MetricsCache | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): MetricsCache;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MetricsCache;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MetricsCache;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): MetricsCache;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): MetricsCache;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): MetricsCache;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): MetricsCache;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): MetricsCache;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): MetricsCache;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): MetricsCache;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): MetricsCache;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): MetricsCache;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): MetricsCache;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): MetricsCache;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): MetricsCache;
   ...
   * @see #unsetField
   */
  defaultField(field: string): MetricsCache;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): MetricsCache;
   ...
   * @see #removeField
   */
  unsetField(field: string): MetricsCache;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): MetricsCache;
   ...
   * @see #unsetField
   */
  removeField(field: string): MetricsCache;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): MetricsCache;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): MetricsCache;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): MetricsCache;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): MetricsCache;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): MetricsCache;

  mergeJson(json: any | null): MetricsCache;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): MetricsCache;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): MetricsCache;
   ...
   */
  singletonArray(): C3.Array<MetricsCache | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<MetricsCache | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<MetricsCache | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<MetricsCache | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<MetricsCache | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, MetricsCache | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, MetricsCache | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<MetricsCache | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<MetricsCache | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): MetricsCache;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): MetricsCache;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): MetricsCache;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): MetricsCache;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): MetricsCache;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): MetricsCache;
   ...
   * @see #fromString
   */
  static make(s: string | null): MetricsCache | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): MetricsCache;
   ...
   */
  static cachedEmptyInst(): MetricsCache;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<MetricsCache>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): MetricsCache;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<MetricsCache | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<MetricsCache | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<MetricsCache | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<MetricsCache | null> | null>;
   ...
   */
  get(include?: string | null): MetricsCache | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): MetricsCache | null;
   ...
   */
  getMissing(spec: GetMissingSpec): MetricsCache;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): MetricsCache | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): MetricsCache;
   ...
   * @see #toString
   */
  static fromString(s: string | null): MetricsCache | null;
   ...
   */
  create(spec?: UpsertSpec | null): MetricsCache | null;
   ...
   */
  static createBatch(objs: C3.Array<MetricsCache | null> | null, spec?: UpsertSpec | null): ObjList<MetricsCache | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<MetricsCache | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<MetricsCache | null> | null;
   ...
   */
  update(srcObj?: MetricsCache | null, spec?: UpsertSpec | null): MetricsCache | null;
   ...
   */
  upsert(srcObj?: MetricsCache | null, spec?: UpsertSpec | null): MetricsCache | null;
   ...
   */
  merge(spec?: MergeSpec | null): MetricsCache | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): MetricsCache | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): MetricsCache | null;
   ...
   */
  static updateBatch(objs: C3.Array<MetricsCache | null> | null, srcObjs?: C3.Array<MetricsCache | null>, spec?: UpsertSpec | null): ObjList<MetricsCache | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<MetricsCache | null>>, spec?: UpsertSpec | null): ObjList<MetricsCache | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<MetricsCache | null> | null, srcObjs?: C3.Array<MetricsCache | null>, spec?: UpsertSpec | null): ObjList<MetricsCache | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<MetricsCache | null>>, spec?: UpsertSpec | null): ObjList<MetricsCache | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<MetricsCache | null> | null, spec?: TouchSpec | null): ObjList<MetricsCache | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<MetricsCache | null> | null, spec?: MergeSpec | null): ObjList<MetricsCache | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<MetricsCache | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<MetricsCache | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<MetricsCache | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<MetricsCache | null> | null;
   ...
   */
  static mergeAll(mergeObj: MetricsCache | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: MetricsCache | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<MetricsCache | null> | null, spec?: UpsertSpec | null): ObjList<MetricsCache | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<MetricsCache | null> | null, spec?: UpsertSpec | null): ObjList<MetricsCache | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<MetricsCache | null> | null): ObjList<MetricsCache | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<MetricsCache | null> | null): ObjList<MetricsCache | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<MetricsCache | null> | null): ObjList<MetricsCache | null>;
   ...
   */
  static afterCreate(objs: C3.Array<MetricsCache | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<MetricsCache | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<MetricsCache | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<MetricsCache | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<MetricsCache | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): MetricsCache | null;
   ...
   */
  withoutIdentity(): MetricsCache | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<MetricsCache | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: MetricsCache | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<MetricsCache | null> | null, callback?: λFunction<MetricsCache | null, MetricsCache | null> | null): ObjList<MetricsCache | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<MetricsCache | null> | null, callback?: λFunction<MetricsCache | null, MetricsCache | null> | null): C3.Array<ObjError | null>;
