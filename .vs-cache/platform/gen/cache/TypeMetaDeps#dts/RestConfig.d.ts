// TypeScript definitions for the C3 type RestConfig

/**
 * Configurations to be used by the REST Engine (e.g. auth, url...).
 *
 * @remarks this represents a value passed to a method that expects an instance of RestConfig
 */
declare interface IRestConfig {
   ...
   */
  retryHttpCodes?: C3.Array<number | null> | Array<number | null>;
   ...
   */
  retryApiErrors?: C3.Array<string | null> | Array<string | null>;
   ...
   */
  failOnRedirectResponse?: boolean;
   ...
   */
  oauth2Config?: IRestConfig.OAuth | null;
}
 ...
 */
declare class RestConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): RestConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): RestConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): RestConfig;

  /**
   * The unique and required name of this instance.
   */
  readonly name: string;
  withName(name: string): RestConfig;

  /**
   * Maximum number of times the operation will be retried (not including the initial try).
   */
  readonly maxRetries: number;
  withMaxRetries(maxRetries: number): RestConfig;

  /**
   * Sleep time for first retry (plus randomization). If <= 0 the default will be used.
   */
  readonly initialSleepMillis: number;
  withInitialSleepMillis(initialSleepMillis: number): RestConfig;
  ...
  withExponent(exponent: number): RestConfig;

  /**
   * Maximum wait time allowed for each retry. If <= 0 the default will be used.
   */
  readonly maxSleepMillis?: number | null;
  withMaxSleepMillis(maxSleepMillis: number | null): RestConfig;

  /**
   * Maximum wait time allowed for all retry waits
   */
  readonly maxTotalMillis?: number | null;
  withMaxTotalMillis(maxTotalMillis: number | null): RestConfig;

  /**
   * The minimum sleep time guaranteed each iteration.
   */
  readonly minSleepMillis?: number | null;
  withMinSleepMillis(minSleepMillis: number | null): RestConfig;

  /**
   * If set to true, it will retry when result is empty.
   */
  readonly retryOnEmptyResult?: boolean;
  withRetryOnEmptyResult(retryOnEmptyResult: boolean): RestConfig;

  /**
   * Determines the algorithm used to calculate jitter. See {@link ExponentialBackoff.Jitter}.
   */
  readonly jitter?: string | null;
  withJitter(jitter: string | null): RestConfig;
  ...
  withRetryAllErrors(retryAllErrors: boolean): RestConfig;
  ...
  withTrace(trace: boolean): RestConfig;

  /**
   * DO NOT USE - IGNORED!
   */
  readonly forUpsert?: boolean;
  withForUpsert(forUpsert: boolean): RestConfig;

  /**
   * Url by which to connect to the REST endpoint.
   */
  readonly url?: string | null;
  withUrl(url: string | null): RestConfig;

  /**
   * Secret auth token to use to authenticate to the REST endpoint
   */
  readonly auth?: string | null;
  withAuth(auth: string | null): RestConfig;

  /**
   * If true a ConnectionPool will be created for every maxConn clients
   */
  readonly createPool?: boolean;
  withCreatePool(createPool: boolean): RestConfig;

  /**
   * Maximum Connections.
   *     the maximum number of concurrent connections to a given endpoint
   */
  readonly maxConn?: number | null;
  withMaxConn(maxConn: number | null): RestConfig;
  ...
  withRetries(retries: number | null): RestConfig;
   ...
   * Default is 10 seconds
   */
  readonly retryBaseSleep?: number | null;
  withRetryBaseSleep(retryBaseSleep: number | null): RestConfig;

  /**
   * Http codes that will be used for retry. If apiRetryErrors are specified both conditions need to be met for retry to
   * be done (httpRetryCodes && apiRetryErrors).
   */
  readonly retryHttpCodes?: C3.Array<number | null>;
  withRetryHttpCodes(retryHttpCodes: C3.Array<number | null> | Array<number | null>): RestConfig;

  /**
   * Retry on any of these API specific error strings. The check will look for the given string in the error returned,
   * in the response body if there is one, otherwise in the response status line.
   */
  readonly retryApiErrors?: C3.Array<string | null>;
  withRetryApiErrors(retryApiErrors: C3.Array<string | null> | Array<string | null>): RestConfig;

  /**
   * Treat a 3xx redirect response as an error (as done with 4xx/5xx responses). Useful in cases where redirection is
   * known to indicate unavailability or incorrect routing.
   */
  readonly failOnRedirectResponse?: boolean;
  withFailOnRedirectResponse(failOnRedirectResponse: boolean): RestConfig;

  /**
   * Override the timeout(in seconds). Default is 60s
   */
  readonly timeout?: number | null;
  withTimeout(timeout: number | null): RestConfig;
   ...
   * By default token based auth is selected if oauth2Config is empty
   */
  readonly oauth2Config?: RestConfig.OAuth | null;
  withOauth2Config(oauth2Config: IRestConfig.OAuth | null): RestConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): RestConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): RestConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): RestConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): RestConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): RestConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): RestConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): RestConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<RestConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<RestConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): RestConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RestConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RestConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): RestConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): RestConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): RestConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): RestConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): RestConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): RestConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): RestConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): RestConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): RestConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): RestConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): RestConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): RestConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): RestConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): RestConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): RestConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): RestConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): RestConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): RestConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): RestConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): RestConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): RestConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): RestConfig;

  mergeJson(json: any | null): RestConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): RestConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): RestConfig;
   ...
   */
  singletonArray(): C3.Array<RestConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<RestConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<RestConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<RestConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<RestConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, RestConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, RestConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<RestConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<RestConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): RestConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): RestConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): RestConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): RestConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): RestConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): RestConfig;
   ...
   * @see #fromString
   */
  static make(s: string | null): RestConfig | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): RestConfig;
   ...
   */
  static cachedEmptyInst(): RestConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<RestConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): RestConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<RestConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<RestConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<RestConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): RestConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): RestConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): RestConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): RestConfig | null;
   ...
   */
  static produce(key: string): RestConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, RestConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, RestConfig | null>;
   ...
   */
  static forConfigKey(configKey: string | null): RestConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<RestConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: RestConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: RestConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): RestConfig | null;
   ...
   */
  removeSecrets(): RestConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): RestConfig | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): RestConfig | null;
   ...
   */
  static forName(name: string | null, failIfMissing?: boolean): RestConfig | null;
}
