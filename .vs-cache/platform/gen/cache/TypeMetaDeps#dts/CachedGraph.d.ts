// TypeScript definitions for the C3 type CachedGraph

/**
 * Entity to store load graph object.
 *
 * @remarks this represents a value passed to a method that expects an instance of CachedGraph
 */
declare interface ICachedGraph {
 ...
 * Entity to store load graph object.
 *
 * @remarks this represents a made instance of CachedGraph
 */
declare class CachedGraph extends Obj {
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): CachedGraph;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): CachedGraph;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): CachedGraph;
  ...
  withVersion(version: number | null): CachedGraph;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): CachedGraph;

  /**
   * actual content of graph
   */
  readonly value?: any | null;
  withValue(value: any | null): CachedGraph;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): CachedGraph | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): CachedGraph | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): CachedGraph | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): CachedGraph | null;
   ...
   */
  replaceType(old: Type, new_: Type): CachedGraph;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): CachedGraph;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): CachedGraph;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<CachedGraph | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<CachedGraph | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): CachedGraph;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CachedGraph;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CachedGraph;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): CachedGraph;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): CachedGraph;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): CachedGraph;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): CachedGraph;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): CachedGraph;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): CachedGraph;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): CachedGraph;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): CachedGraph;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): CachedGraph;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): CachedGraph;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): CachedGraph;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): CachedGraph;
   ...
   * @see #unsetField
   */
  defaultField(field: string): CachedGraph;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): CachedGraph;
   ...
   * @see #removeField
   */
  unsetField(field: string): CachedGraph;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): CachedGraph;
   ...
   * @see #unsetField
   */
  removeField(field: string): CachedGraph;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): CachedGraph;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): CachedGraph;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): CachedGraph;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): CachedGraph;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): CachedGraph;

  mergeJson(json: any | null): CachedGraph;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): CachedGraph;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): CachedGraph;
   ...
   */
  singletonArray(): C3.Array<CachedGraph | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<CachedGraph | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<CachedGraph | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<CachedGraph | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<CachedGraph | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, CachedGraph | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, CachedGraph | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<CachedGraph | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<CachedGraph | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): CachedGraph;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): CachedGraph;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): CachedGraph;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): CachedGraph;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): CachedGraph;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): CachedGraph;
   ...
   * @see #fromString
   */
  static make(s: string | null): CachedGraph | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): CachedGraph;
   ...
   */
  static cachedEmptyInst(): CachedGraph;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<CachedGraph>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): CachedGraph;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<CachedGraph | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<CachedGraph | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<CachedGraph | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<CachedGraph | null> | null>;
   ...
   */
  get(include?: string | null): CachedGraph | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): CachedGraph | null;
   ...
   */
  getMissing(spec: GetMissingSpec): CachedGraph;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): CachedGraph | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): CachedGraph;
   ...
   * @see #toString
   */
  static fromString(s: string | null): CachedGraph | null;
   ...
   */
  create(spec?: UpsertSpec | null): CachedGraph | null;
   ...
   */
  static createBatch(objs: C3.Array<CachedGraph | null> | null, spec?: UpsertSpec | null): ObjList<CachedGraph | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<CachedGraph | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<CachedGraph | null> | null;
   ...
   */
  update(srcObj?: CachedGraph | null, spec?: UpsertSpec | null): CachedGraph | null;
   ...
   */
  upsert(srcObj?: CachedGraph | null, spec?: UpsertSpec | null): CachedGraph | null;
   ...
   */
  merge(spec?: MergeSpec | null): CachedGraph | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): CachedGraph | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): CachedGraph | null;
   ...
   */
  static updateBatch(objs: C3.Array<CachedGraph | null> | null, srcObjs?: C3.Array<CachedGraph | null>, spec?: UpsertSpec | null): ObjList<CachedGraph | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<CachedGraph | null>>, spec?: UpsertSpec | null): ObjList<CachedGraph | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<CachedGraph | null> | null, srcObjs?: C3.Array<CachedGraph | null>, spec?: UpsertSpec | null): ObjList<CachedGraph | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<CachedGraph | null>>, spec?: UpsertSpec | null): ObjList<CachedGraph | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<CachedGraph | null> | null, spec?: TouchSpec | null): ObjList<CachedGraph | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<CachedGraph | null> | null, spec?: MergeSpec | null): ObjList<CachedGraph | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<CachedGraph | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<CachedGraph | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<CachedGraph | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<CachedGraph | null> | null;
   ...
   */
  static mergeAll(mergeObj: CachedGraph | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: CachedGraph | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<CachedGraph | null> | null, spec?: UpsertSpec | null): ObjList<CachedGraph | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<CachedGraph | null> | null, spec?: UpsertSpec | null): ObjList<CachedGraph | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<CachedGraph | null> | null): ObjList<CachedGraph | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<CachedGraph | null> | null): ObjList<CachedGraph | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<CachedGraph | null> | null): ObjList<CachedGraph | null>;
   ...
   */
  static afterCreate(objs: C3.Array<CachedGraph | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<CachedGraph | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<CachedGraph | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<CachedGraph | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<CachedGraph | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): CachedGraph | null;
   ...
   */
  withoutIdentity(): CachedGraph | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<CachedGraph | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: CachedGraph | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<CachedGraph | null> | null, callback?: λFunction<CachedGraph | null, CachedGraph | null> | null): ObjList<CachedGraph | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<CachedGraph | null> | null, callback?: λFunction<CachedGraph | null, CachedGraph | null> | null): C3.Array<ObjError | null>;
