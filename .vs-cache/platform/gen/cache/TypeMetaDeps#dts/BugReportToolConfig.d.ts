// TypeScript definitions for the C3 type BugReportToolConfig

/**
 * Handles the configurations for the bug report tool
 *
 * @remarks this represents a value passed to a method that expects an instance of BugReportToolConfig
 */
declare interface IBugReportToolConfig {
  ...
  /**
   * Flag to indicate whether the bug report tool is disabled
   */
  disabled?: boolean;

  /**
   * disable collecting server logs
   */
  logsDisabled?: boolean;

  /**
   * The number of minutes of server log history we want to collect
   */
  logHistoryTimeBoundary?: number | null;

  /**
   * Enable attaching attachments
   */
  attachment?: boolean;

  /**
   * Enable collecting source code
   */
  srcCodeEnabled?: boolean;

  /**
   * Disable collecting C3 notebook
   */
  notebookDisabled?: boolean;

  /**
   * Disable test results
   */
  testResultsDisabled?: boolean;

  /**
   * Enable automatically creating Jira tickets
   */
  jiraEnabled?: boolean;
}
 ...
 * Handles the configurations for the bug report tool
 *
 * @remarks this represents a made instance of BugReportToolConfig
 */
declare class BugReportToolConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): BugReportToolConfig;

  static readonly configOverride?: string | null;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): BugReportToolConfig;
  ...
  withIssues(issues: C3.Array<string | null> | Array<string | null>): BugReportToolConfig;
  ...
  withDisabled(disabled: boolean): BugReportToolConfig;
  ...
  withLogsDisabled(logsDisabled: boolean): BugReportToolConfig;

  /**
   * disable collecting server logs
   */
  static readonly logsDisabled?: boolean;

  /**
   * The number of minutes of server log history we want to collect
   */
  readonly logHistoryTimeBoundary?: number | null;
  withLogHistoryTimeBoundary(logHistoryTimeBoundary: number | null): BugReportToolConfig;

  /**
   * The number of minutes of server log history we want to collect
   */
  static readonly logHistoryTimeBoundary?: number | null;

  /**
   * Enable attaching attachments
   */
  readonly attachment?: boolean;
  withAttachment(attachment: boolean): BugReportToolConfig;

  /**
   * Enable attaching attachments
   */
  static readonly attachment?: boolean;

  /**
   * Enable collecting source code
   */
  readonly srcCodeEnabled?: boolean;
  withSrcCodeEnabled(srcCodeEnabled: boolean): BugReportToolConfig;

  /**
   * Enable collecting source code
   */
  static readonly srcCodeEnabled?: boolean;

  /**
   * Disable collecting C3 notebook
   */
  readonly notebookDisabled?: boolean;
  withNotebookDisabled(notebookDisabled: boolean): BugReportToolConfig;

  /**
   * Disable collecting C3 notebook
   */
  static readonly notebookDisabled?: boolean;

  /**
   * Disable test results
   */
  readonly testResultsDisabled?: boolean;
  withTestResultsDisabled(testResultsDisabled: boolean): BugReportToolConfig;

  /**
   * Disable test results
   */
  static readonly testResultsDisabled?: boolean;

  /**
   * Enable automatically creating Jira tickets
   */
  readonly jiraEnabled?: boolean;
  withJiraEnabled(jiraEnabled: boolean): BugReportToolConfig;

  /**
   * Enable automatically creating Jira tickets
   */
  static readonly jiraEnabled?: boolean;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): BugReportToolConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): BugReportToolConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): BugReportToolConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): BugReportToolConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): BugReportToolConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): BugReportToolConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BugReportToolConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BugReportToolConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BugReportToolConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BugReportToolConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BugReportToolConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BugReportToolConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BugReportToolConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BugReportToolConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): BugReportToolConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): BugReportToolConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BugReportToolConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BugReportToolConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BugReportToolConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BugReportToolConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): BugReportToolConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): BugReportToolConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): BugReportToolConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): BugReportToolConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): BugReportToolConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): BugReportToolConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): BugReportToolConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): BugReportToolConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BugReportToolConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BugReportToolConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): BugReportToolConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): BugReportToolConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): BugReportToolConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): BugReportToolConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): BugReportToolConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): BugReportToolConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): BugReportToolConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): BugReportToolConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): BugReportToolConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): BugReportToolConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): BugReportToolConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): BugReportToolConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): BugReportToolConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): BugReportToolConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): BugReportToolConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): BugReportToolConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): BugReportToolConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): BugReportToolConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): BugReportToolConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): BugReportToolConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): BugReportToolConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): BugReportToolConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): BugReportToolConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): BugReportToolConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): BugReportToolConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): BugReportToolConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): BugReportToolConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): BugReportToolConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): BugReportToolConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): BugReportToolConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): BugReportToolConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): BugReportToolConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): BugReportToolConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): BugReportToolConfig;

  mergeJson(json: any | null): BugReportToolConfig;

  static mergeJson(json: any | null): BugReportToolConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): BugReportToolConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): BugReportToolConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): BugReportToolConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): BugReportToolConfig;
   ...
   */
  singletonArray(): C3.Array<BugReportToolConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<BugReportToolConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<BugReportToolConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BugReportToolConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<BugReportToolConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<BugReportToolConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BugReportToolConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, BugReportToolConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BugReportToolConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BugReportToolConfig | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<BugReportToolConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BugReportToolConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): BugReportToolConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): BugReportToolConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): BugReportToolConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): BugReportToolConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): BugReportToolConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): BugReportToolConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): BugReportToolConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): BugReportToolConfig;
   ...
   */
  static cachedEmptyInst(): BugReportToolConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<BugReportToolConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): BugReportToolConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<BugReportToolConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<BugReportToolConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<BugReportToolConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): BugReportToolConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): BugReportToolConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): BugReportToolConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): BugReportToolConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): BugReportToolConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): BugReportToolConfig | null;
   ...
   */
  static produce(key: string): BugReportToolConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, BugReportToolConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, BugReportToolConfig | null>;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): BugReportToolConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): BugReportToolConfig;
   ...
   */
  static forConfigKey(configKey: string | null): BugReportToolConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<BugReportToolConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: BugReportToolConfig, override?: string | null): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: BugReportToolConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: BugReportToolConfig, override?: string | null): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: BugReportToolConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): BugReportToolConfig | null;
   ...
   */
  removeSecrets(): BugReportToolConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): BugReportToolConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): BugReportToolConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): BugReportToolConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): BugReportToolConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): BugReportToolConfig;
