// TypeScript definitions for the C3 type AnyOfType
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of AnyOfType
 */
declare interface IAnyOfType {
   ...
   */
  restrictions: C3.Array<AnyOfRestriction | null> | Array<IAnyOfRestriction | null>;
   ...
   * @see Union
   */
  unionRefType?: IReferenceType | null;
}
 ...
 * Any-of restrictions can also be declared and reused as {@link Union union types}.
 *
 * @remarks this represents a made instance of AnyOfType
 */
declare class AnyOfType extends Obj {

  /**
   * Source file Pkg.Path a C3 Type declaration [.c3typ].
   */
  readonly declaredPkgPath?: string | null;
  withDeclaredPkgPath(declaredPkgPath: string | null): AnyOfType;

  /**
   * Source line number in a C3 Type declaration [.c3typ] file starting with 1 where this metadata element is declared.
   */
  readonly declaredSrcLine?: number | null;
  withDeclaredSrcLine(declaredSrcLine: number | null): AnyOfType;
  ...
  withDeclaredSrcCharInLine(declaredSrcCharInLine: number | null): AnyOfType;
   ...
   */
  readonly pkg: Pkg;
  withPkg(pkg: IPkg): AnyOfType;

  /**
   * SDK json representing instance of this type
   */
  readonly json?: any;
  withJson(json: any): AnyOfType;

  /**
   * The set of annotations defined on this element of metadata represented as json value.
   */
  readonly annotationsJson?: any | null;
  withAnnotationsJson(annotationsJson: any | null): AnyOfType;
  ...
  withModifier(modifier: string | null): AnyOfType;

  /**
   * The possible value types; cannot be empty nor contain only a single alternate. Note that all but the first
   * restriction may be an "exclude" restriction.
   */
  readonly restrictions: C3.Array<AnyOfRestriction | null>;
  withRestrictions(restrictions: C3.Array<AnyOfRestriction | null> | Array<IAnyOfRestriction | null>): AnyOfType;
   ...
   * @see Union
   */
  readonly unionRefType?: ReferenceType | null;
  withUnionRefType(unionRefType: IReferenceType | null): AnyOfType;
   ...
   */
  replaceType(old: Type, new_: Type): AnyOfType;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): AnyOfType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): AnyOfType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): AnyOfType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): AnyOfType | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): AnyOfType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): AnyOfType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<AnyOfType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<AnyOfType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): AnyOfType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AnyOfType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AnyOfType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): AnyOfType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): AnyOfType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): AnyOfType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): AnyOfType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): AnyOfType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): AnyOfType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): AnyOfType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): AnyOfType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): AnyOfType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): AnyOfType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): AnyOfType;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): AnyOfType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): AnyOfType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): AnyOfType;
   ...
   * @see #removeField
   */
  unsetField(field: string): AnyOfType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): AnyOfType;
   ...
   * @see #unsetField
   */
  removeField(field: string): AnyOfType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): AnyOfType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): AnyOfType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): AnyOfType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): AnyOfType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): AnyOfType;

  mergeJson(json: any | null): AnyOfType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): AnyOfType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): AnyOfType;
   ...
   */
  singletonArray(): C3.Array<AnyOfType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<AnyOfType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<AnyOfType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<AnyOfType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<AnyOfType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, AnyOfType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, AnyOfType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<AnyOfType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<AnyOfType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): AnyOfType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): AnyOfType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): AnyOfType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): AnyOfType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): AnyOfType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): AnyOfType;
   ...
   * @see #fromString
   */
  static make(s: string | null): AnyOfType | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): AnyOfType;
   ...
   */
  static cachedEmptyInst(): AnyOfType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<AnyOfType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): AnyOfType;
   ...
   */
  withoutDeclaredSrcPos(recursive?: boolean): AnyOfType;
   ...
   */
  withAnnotation(ann: Annotation): AnyOfType;
   ...
   *         value for the field
   */
  withAnnotation(ann: string, annField?: string | null, value?: any): AnyOfType;
   ...
   * @see #toString
   */
  static fromString(s: string | null): AnyOfType | null;
   ...
   */
  isRestriction(vt: ValueType | null): boolean;
   ...
   */
  guessPrimitiveRestriction(value: any, failIfNot?: boolean): PrimitiveType | null;
   ...
   */
  guessRestriction(value: any, testContent?: boolean, failIfNone?: boolean): ValueType | null;

  /**
   * The possible acceptable value types - i.e. restrictions without exclusions.
   */
  inclusions(): C3.Array<ValueType | null>;

  /**
   * The exclusion value types.
   */
  exclusions(): C3.Array<ValueType | null>;

  /**
   * Whether this value type is explicitly excluded (#isA any of the listed exclusions).
   */
  isExcluded(vt: ValueType): boolean;

  /**
   * @return new instance from restrictions
   */
  static fromRestrictions(pkg: Pkg, restrictions: C3.Array<ValueType | null>): AnyOfType;
}
