// TypeScript definitions for the C3 type Feature.Store.MaterializationConfig

/**
 * Configuration for Feature Store that is used to specify whether or not materialization or snapshot creation is
 * allowed for any {@link Feature} or {@link Feature.Set}. No additional fields apart from `doNotMaterialize` should
 * be included on this config
 *
 * @remarks this represents a value passed to a method that expects an instance of Feature.Store.MaterializationConfig
 */
declare namespace Feature.Store {
  export interface IMaterializationConfig {
    ...
    /**
     * When doNotMaterialize is set to True any attempts to materialize data will fail. This can be enabled as a
     * security measure to prevent unwanted writing of data to the file system. This will override any `doNotMaterialize`
     * flag on {@link Feature} or {@link Feature.Set}
     */
 ...
 * be included on this config
 *
 * @remarks this represents a made instance of Feature.Store.MaterializationConfig
 */
declare namespace Feature.Store {
  export class MaterializationConfig extends Obj {

    readonly configOverride?: string | null;
    withConfigOverride(configOverride: string | null): Feature.Store.MaterializationConfig;

    static readonly configOverride?: string | null;

    readonly secretOverride?: string | null;
    withSecretOverride(secretOverride: string | null): Feature.Store.MaterializationConfig;
    ...
    withIssues(issues: C3.Array<string | null> | Array<string | null>): Feature.Store.MaterializationConfig;
    ...
    withDoNotMaterialize(doNotMaterialize: boolean): Feature.Store.MaterializationConfig;
     ...
     * flag on {@link Feature} or {@link Feature.Set}
     */
    static readonly doNotMaterialize?: boolean;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Feature.Store.MaterializationConfig | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Feature.Store.MaterializationConfig | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Feature.Store.MaterializationConfig | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Feature.Store.MaterializationConfig | null;
     ...
     */
    replaceType(old: Type, new_: Type): Feature.Store.MaterializationConfig;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Feature.Store.MaterializationConfig;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Feature.Store.MaterializationConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Feature.Store.MaterializationConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Feature.Store.MaterializationConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Feature.Store.MaterializationConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Feature.Store.MaterializationConfig | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Feature.Store.MaterializationConfig | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Feature.Store.MaterializationConfig | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Feature.Store.MaterializationConfig | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Feature.Store.MaterializationConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Feature.Store.MaterializationConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Feature.Store.MaterializationConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Feature.Store.MaterializationConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Feature.Store.MaterializationConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Feature.Store.MaterializationConfig;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Feature.Store.MaterializationConfig;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Feature.Store.MaterializationConfig;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Feature.Store.MaterializationConfig;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Feature.Store.MaterializationConfig;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Feature.Store.MaterializationConfig;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Feature.Store.MaterializationConfig;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Feature.Store.MaterializationConfig;
     ...
     * @return new Obj
     */
    static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Feature.Store.MaterializationConfig;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Feature.Store.MaterializationConfig;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Feature.Store.MaterializationConfig;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Feature.Store.MaterializationConfig;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Feature.Store.MaterializationConfig;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Feature.Store.MaterializationConfig;
     ...
     * @see #removeField
     */
    static withoutField(field: string | null): Feature.Store.MaterializationConfig;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Feature.Store.MaterializationConfig;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType | null): Feature.Store.MaterializationConfig;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Feature.Store.MaterializationConfig;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: C3.Array<string | null> | null): Feature.Store.MaterializationConfig;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Feature.Store.MaterializationConfig;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Feature.Store.MaterializationConfig;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Feature.Store.MaterializationConfig;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Feature.Store.MaterializationConfig;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Feature.Store.MaterializationConfig;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Feature.Store.MaterializationConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Feature.Store.MaterializationConfig;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Feature.Store.MaterializationConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Feature.Store.MaterializationConfig;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Feature.Store.MaterializationConfig;
     ...
     * @see #removeField
     */
    unsetField(field: string): Feature.Store.MaterializationConfig;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Feature.Store.MaterializationConfig;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Feature.Store.MaterializationConfig;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Feature.Store.MaterializationConfig;
     ...
     * @see #unsetField
     */
    removeField(field: string): Feature.Store.MaterializationConfig;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Feature.Store.MaterializationConfig;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Feature.Store.MaterializationConfig;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Feature.Store.MaterializationConfig;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Feature.Store.MaterializationConfig;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Feature.Store.MaterializationConfig;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Feature.Store.MaterializationConfig;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj | null, otherFieldsFilter: Type): Feature.Store.MaterializationConfig;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Feature.Store.MaterializationConfig;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Feature.Store.MaterializationConfig;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Feature.Store.MaterializationConfig;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Feature.Store.MaterializationConfig;

    mergeJson(json: any | null): Feature.Store.MaterializationConfig;

    static mergeJson(json: any | null): Feature.Store.MaterializationConfig;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Feature.Store.MaterializationConfig;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Feature.Store.MaterializationConfig;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Feature.Store.MaterializationConfig;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj | null, deep?: boolean): Feature.Store.MaterializationConfig;
     ...
     */
    singletonArray(): C3.Array<Feature.Store.MaterializationConfig | null>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): C3.Array<Feature.Store.MaterializationConfig | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Feature.Store.MaterializationConfig | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Feature.Store.MaterializationConfig | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Feature.Store.MaterializationConfig | null>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): C3.Set<Feature.Store.MaterializationConfig | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Feature.Store.MaterializationConfig | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Feature.Store.MaterializationConfig | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Feature.Store.MaterializationConfig | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Feature.Store.MaterializationConfig | null>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Feature.Store.MaterializationConfig | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Feature.Store.MaterializationConfig | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Feature.Store.MaterializationConfig;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Feature.Store.MaterializationConfig;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Feature.Store.MaterializationConfig;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Feature.Store.MaterializationConfig;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Feature.Store.MaterializationConfig;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Feature.Store.MaterializationConfig;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Feature.Store.MaterializationConfig;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Feature.Store.MaterializationConfig;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Feature.Store.MaterializationConfig;
     ...
     */
    static cachedEmptyInst(): Feature.Store.MaterializationConfig;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Feature.Store.MaterializationConfig>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Feature.Store.MaterializationConfig;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<Feature.Store.MaterializationConfig | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<Feature.Store.MaterializationConfig | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<Feature.Store.MaterializationConfig | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): Feature.Store.MaterializationConfig | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string | null): Feature.Store.MaterializationConfig | null;
     ...
     * @see findByCacheKey
     */
    getCached(): Feature.Store.MaterializationConfig | null;
     ...
     * @see findByCacheKey
     */
    static getCached(): Feature.Store.MaterializationConfig | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): Feature.Store.MaterializationConfig | null;

    /**
     * @return newly produced cached instance.
     */
    static refreshCache(): Feature.Store.MaterializationConfig | null;
     ...
     */
    static produce(key: string): Feature.Store.MaterializationConfig | null;
     ...
     */
    static produceAll(): C3.Map<string | null, Feature.Store.MaterializationConfig | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, Feature.Store.MaterializationConfig | null>;
     ...
     */
    getConfig(): Feature.Store.MaterializationConfig;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): Feature.Store.MaterializationConfig;
     ...
     */
    getSecret(): Feature.Store.MaterializationConfig;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): Feature.Store.MaterializationConfig;
     ...
     */
    static forConfigKey(configKey: string | null): Feature.Store.MaterializationConfig | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<Feature.Store.MaterializationConfig | null>;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Feature.Store.MaterializationConfig, override?: string | null): void;

    /**
     * Sets multiple field values to be the same as the passed instance.
     * @see setConfigValue
     */
    static setConfigValues(from: Feature.Store.MaterializationConfig, override?: string | null): void;
     ...
     * @see setSecretValue
     */
    setSecretValues(from: Feature.Store.MaterializationConfig, override?: string | null): void;

    /**
     * Sets multiple secret field values to be the same as the passed instance.
     * @see setSecretValue
     */
    static setSecretValues(from: Feature.Store.MaterializationConfig, override?: string | null): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Feature.Store.MaterializationConfig | null;
     ...
     */
    removeSecrets(): Feature.Store.MaterializationConfig | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): Feature.Store.MaterializationConfig | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Feature.Store.MaterializationConfig | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): Feature.Store.MaterializationConfig | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Feature.Store.MaterializationConfig;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): Feature.Store.MaterializationConfig;
     ...
     */
    static inst(): Feature.Store.MaterializationConfig;

    /**
     * @return the cached instance if already cached, null otherwise. Does not instantiate if missing.
     */
    static cachedInst(): Feature.Store.MaterializationConfig | null;
  }
}
