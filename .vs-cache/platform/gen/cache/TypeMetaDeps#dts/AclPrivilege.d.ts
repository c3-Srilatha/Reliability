// TypeScript definitions for the C3 type AclPrivilege

/**
 * Defines access to the object itself, and a path to reference users, roles, or groups.
 * These privileges determine what ACL entries are created via {@link AclEnabled.populateAcl}. If there is an
 * {@link EnableAclPrivilege} object that enables ACL for the specified Type, then ACL entries automatically refresh
 * when any of the ACL expressions dependencies changes. Note that only dependencies that exist in the same tenant/tag
 * are considered for automatic refresh (e.g. not dependencies from facaded tenant/tags). See also:
 * @see AclEnabled
 * @see EnableAclPrivilege
 * @see AclEntry
 * @see AclEnabledTypes
 *
 * @remarks this represents a value passed to a method that expects an instance of AclPrivilege
 */
declare interface IAclPrivilege {
  ...
  /**
   * If true, entries created via this privilege will allow updates.  If false, they will not.  If 'fromSource'
   * the 'canUpdate' for created entries will be set to the value of the ACL returned from the 'ACL' expression.
   */
  canUpdate?: string | null;

  /**
   * If true, entries created via this privilege will allow removes.  If false, they will not.  If 'fromSource'
   * the 'canRemove' for created entries will be set to the value of the ACL returned from the 'ACL' expression.
   */
  canRemove?: string | null;

  /**
   * If true, entries created via this privilege will allow modifying ACL.  If false, they will not.  If 'fromSource'
   * the 'canModifyAcl' for created entries will be set to the value of the ACL returned from the 'ACL' expression.
   */
  canModifyAcl?: string | null;

  /**
   * Expression that should return a member/member id, array of members/member ids, {@link AclEntry} or array of
   * {@link AclEntry}
   */
  acl: IOldExpr<AclEntry | null>;
}
 ...
 * @see AclEnabledTypes
 *
 * @remarks this represents a made instance of AclPrivilege
 */
declare class AclPrivilege extends Obj {
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): AclPrivilege;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): AclPrivilege;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): AclPrivilege;
  ...
  withVersion(version: number | null): AclPrivilege;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): AclPrivilege;
  ...
  withUserUpdatedFields(userUpdatedFields: C3.Array<string | null> | Array<string | null>): AclPrivilege;
  ...
  withHidden(hidden: boolean): AclPrivilege;
  ...
  withUserOwned(userOwned: boolean): AclPrivilege;

  readonly tag?: string | null;
  withTag(tag: string | null): AclPrivilege;

  readonly moduleName?: string | null;
  withModuleName(moduleName: string | null): AclPrivilege;

  readonly typeName?: string | null;
  withTypeName(typeName: string | null): AclPrivilege;

  /**
   * If true, entries created via this privilege will allow updates.  If false, they will not.  If 'fromSource'
   * the 'canUpdate' for created entries will be set to the value of the ACL returned from the 'ACL' expression.
   */
  readonly canUpdate?: string | null;
  withCanUpdate(canUpdate: string | null): AclPrivilege;

  /**
   * If true, entries created via this privilege will allow removes.  If false, they will not.  If 'fromSource'
   * the 'canRemove' for created entries will be set to the value of the ACL returned from the 'ACL' expression.
   */
  readonly canRemove?: string | null;
  withCanRemove(canRemove: string | null): AclPrivilege;

  /**
   * If true, entries created via this privilege will allow modifying ACL.  If false, they will not.  If 'fromSource'
   * the 'canModifyAcl' for created entries will be set to the value of the ACL returned from the 'ACL' expression.
   */
  readonly canModifyAcl?: string | null;
  withCanModifyAcl(canModifyAcl: string | null): AclPrivilege;

  /**
   * Expression that should return a member/member id, array of members/member ids, {@link AclEntry} or array of
   * {@link AclEntry}
   */
  readonly acl: OldExpr<AclEntry | null>;
  withAcl(acl: IOldExpr<AclEntry | null>): AclPrivilege;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): AclPrivilege | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): AclPrivilege | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): AclPrivilege | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): AclPrivilege | null;
   ...
   */
  replaceType(old: Type, new_: Type): AclPrivilege;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): AclPrivilege;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): AclPrivilege;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<AclPrivilege | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<AclPrivilege | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): AclPrivilege;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AclPrivilege;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AclPrivilege;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): AclPrivilege;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): AclPrivilege;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): AclPrivilege;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): AclPrivilege;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): AclPrivilege;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): AclPrivilege;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): AclPrivilege;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): AclPrivilege;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): AclPrivilege;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): AclPrivilege;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): AclPrivilege;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): AclPrivilege;
   ...
   * @see #unsetField
   */
  defaultField(field: string): AclPrivilege;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): AclPrivilege;
   ...
   * @see #removeField
   */
  unsetField(field: string): AclPrivilege;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): AclPrivilege;
   ...
   * @see #unsetField
   */
  removeField(field: string): AclPrivilege;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): AclPrivilege;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): AclPrivilege;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): AclPrivilege;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): AclPrivilege;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): AclPrivilege;

  mergeJson(json: any | null): AclPrivilege;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): AclPrivilege;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): AclPrivilege;
   ...
   */
  singletonArray(): C3.Array<AclPrivilege | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<AclPrivilege | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<AclPrivilege | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<AclPrivilege | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<AclPrivilege | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, AclPrivilege | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, AclPrivilege | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<AclPrivilege | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<AclPrivilege | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): AclPrivilege;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): AclPrivilege;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): AclPrivilege;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): AclPrivilege;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): AclPrivilege;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): AclPrivilege;
   ...
   * @see #fromString
   */
  static make(s: string | null): AclPrivilege | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): AclPrivilege;
   ...
   */
  static cachedEmptyInst(): AclPrivilege;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<AclPrivilege>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): AclPrivilege;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<AclPrivilege | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<AclPrivilege | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<AclPrivilege | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): AclPrivilege | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string | null): AclPrivilege | null;
   ...
   * @see findByCacheKey
   */
  getCached(): AclPrivilege | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): AclPrivilege | null;
   ...
   */
  static produce(key: string): AclPrivilege | null;
   ...
   */
  static produceAll(): C3.Map<string | null, AclPrivilege | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, AclPrivilege | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<AclPrivilege | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<AclPrivilege | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<AclPrivilege | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<AclPrivilege | null> | null>;
   ...
   */
  get(include?: string | null): AclPrivilege | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): AclPrivilege | null;
   ...
   */
  getMissing(spec: GetMissingSpec): AclPrivilege;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): AclPrivilege | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): AclPrivilege;
   ...
   * @see #toString
   */
  static fromString(s: string | null): AclPrivilege | null;
   ...
   */
  create(spec?: UpsertSpec | null): AclPrivilege | null;
   ...
   */
  static createBatch(objs: C3.Array<AclPrivilege | null> | null, spec?: UpsertSpec | null): ObjList<AclPrivilege | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<AclPrivilege | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<AclPrivilege | null> | null;
   ...
   */
  update(srcObj?: AclPrivilege | null, spec?: UpsertSpec | null): AclPrivilege | null;
   ...
   */
  upsert(srcObj?: AclPrivilege | null, spec?: UpsertSpec | null): AclPrivilege | null;
   ...
   */
  merge(spec?: MergeSpec | null): AclPrivilege | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): AclPrivilege | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): AclPrivilege | null;
   ...
   */
  static updateBatch(objs: C3.Array<AclPrivilege | null> | null, srcObjs?: C3.Array<AclPrivilege | null>, spec?: UpsertSpec | null): ObjList<AclPrivilege | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<AclPrivilege | null>>, spec?: UpsertSpec | null): ObjList<AclPrivilege | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<AclPrivilege | null> | null, srcObjs?: C3.Array<AclPrivilege | null>, spec?: UpsertSpec | null): ObjList<AclPrivilege | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<AclPrivilege | null>>, spec?: UpsertSpec | null): ObjList<AclPrivilege | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<AclPrivilege | null> | null, spec?: TouchSpec | null): ObjList<AclPrivilege | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<AclPrivilege | null> | null, spec?: MergeSpec | null): ObjList<AclPrivilege | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<AclPrivilege | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<AclPrivilege | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<AclPrivilege | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<AclPrivilege | null> | null;
   ...
   */
  static mergeAll(mergeObj: AclPrivilege | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: AclPrivilege | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<AclPrivilege | null> | null, spec?: UpsertSpec | null): ObjList<AclPrivilege | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<AclPrivilege | null> | null, spec?: UpsertSpec | null): ObjList<AclPrivilege | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<AclPrivilege | null> | null): ObjList<AclPrivilege | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<AclPrivilege | null> | null): ObjList<AclPrivilege | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<AclPrivilege | null> | null): ObjList<AclPrivilege | null>;
   ...
   */
  static afterCreate(objs: C3.Array<AclPrivilege | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<AclPrivilege | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<AclPrivilege | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<AclPrivilege | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<AclPrivilege | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): AclPrivilege | null;
   ...
   */
  withoutIdentity(): AclPrivilege | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<AclPrivilege | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: AclPrivilege | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<AclPrivilege | null> | null, callback?: λFunction<AclPrivilege | null, AclPrivilege | null> | null): ObjList<AclPrivilege | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<AclPrivilege | null> | null, callback?: λFunction<AclPrivilege | null, AclPrivilege | null> | null): C3.Array<ObjError | null>;
   ...
   */
  publish(subPath?: string | null, contentType?: string | null): AclPrivilege;
   ...
   */
  static removeSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<AclPrivilege | null> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec | null): AclPrivilege | null;
   ...
   */
  static createSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<AclPrivilege | null> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData | null, spec?: UpsertSpec | null): AclPrivilege | null;
   ...
   */
  static updateSeedDataBatch(objs?: C3.Array<SeedData | null>, srcObjs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<AclPrivilege | null> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec | null): AclPrivilege | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: C3.Array<SeedData | null>, spec?: MergeSpec | null): ObjList<AclPrivilege | null> | null;
  ...
  dependencies(): SeedDataDeps<AclPrivilege | null> | null;
