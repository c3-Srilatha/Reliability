// TypeScript definitions for the C3 type SqsQueue

/**
 * @remarks this represents a value passed to a method that expects an instance of SqsQueue
 */
declare interface ISqsQueue {
}

/**
 * @remarks this represents a made instance of SqsQueue
 */
