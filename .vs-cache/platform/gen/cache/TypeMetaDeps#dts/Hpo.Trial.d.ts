// TypeScript definitions for the C3 type Hpo.Trial

/**
 * Results for a single hyperparameter combination of {@link Hpo.Experiment}.
 * Aggregates the results from the individual trainings (may be more than one) for cross-validation
 * purposes. Also contains a single validation summary score that is used to compare different
 * hyperparameter combinations. Should only be used for results of a hyperparameter combination based on
 * {@link Hpo.Experiment}.
 *
 * @remarks this represents a value passed to a method that expects an instance of Hpo.Trial
 */
declare namespace Hpo {
  export interface ITrial {
    ...
    /**
     * Set of hyperparameters used for the trainings within this search trial.
     */
    generatedParams?: IHpo.GeneratedHps | null;

    /**
     * The summary score of all the training scores in {@link #runs} for the
     * {@link MlPipe#scoringMetrics}. Aggregation technique is described by
     * {@link MlSplit.Technique#scoreSummary}.
     */
    trainedScoreSummaries?: C3.Map<string | null, number | null> | {[key: string | null]: number | null};

    /**
     * The summary score of all the validation scores in {@link #runs} for the
     * {@link MlPipe#scoringMetrics}. Aggregation technique is described by
     * {@link MlSplit.Technique#scoreSummary}.
     */
    validationScoreSummaries?: C3.Map<string | null, number | null> | {[key: string | null]: number | null};

    /**
     * Keeps track of the state of the trial.
     * 'pending' - one or more trainings are still ongoing
     * 'succeeded' - all trainings have completed successfully
     * 'failed' - all training completed, at least one of which failed
     * 'interrupted' - trial was prematurely stopped, due to parent {@link Hpo.Experiment} search being stopped
     */
    status?: string | null;

    /**
     * Collection of results from individual training runs. The number of {@link Hpo.Run}s will depend on the number
     * of splits generated by the {@link MlSplit.Technique}.
     */
    runs?: C3.Array<Hpo.Run | null> | Array<IHpo.Run | null>;

    /**
     * Timestamp of the beginning of the trial that includes training and scoring.
    ...
    /**
     * Timestamp of the end of the trial that includes training and scoring.
     */
 ...
 * {@link Hpo.Experiment}.
 *
 * @remarks this represents a made instance of Hpo.Trial
 */
declare namespace Hpo {
  export class Trial extends Obj {

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): Hpo.Trial;
    ...
    withTypeIdent(typeIdent: string | null): Hpo.Trial;
    ...
    withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Hpo.Trial;

    /**
     * Various system fields.
     */
    readonly meta?: Meta | null;
    withMeta(meta: IMeta | null): Hpo.Trial;
    ...
    withVersion(version: number | null): Hpo.Trial;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type | null;
    withTypeWithBindings(typeWithBindings: IType | null): Hpo.Trial;

    /**
     * Parent {@link MlWorkflowCoordinatable} that this result belongs to.
     */
    readonly parentCoordinator: MlWorkflowCoordinatable<MlWorkflowCoordinatableResult | null>;
    withParentCoordinator(parentCoordinator: IMlWorkflowCoordinatable<MlWorkflowCoordinatableResult | null>): Hpo.Trial;
    ...
    withStatusForCoordinatable(statusForCoordinatable: string): Hpo.Trial;

    /**
     * Number of times the {@link #parentCoordinator} has canceled this result.
     */
    readonly canceledCount?: number | null;
    withCanceledCount(canceledCount: number | null): Hpo.Trial;
    ...
    withIsCanceled(isCanceled: boolean): Hpo.Trial;
    ...
    withErrorCount(errorCount: number | null): Hpo.Trial;
    ...
    withRun(run: IWorkflowExecutorRun | null): Hpo.Trial;
    ...
    withDurationSeconds(durationSeconds: number | null): Hpo.Trial;
    ...
    withPastRuns(pastRuns: C3.Array<WorkflowExecutorRun | null> | Array<IWorkflowExecutorRun | null>): Hpo.Trial;

    /**
     * Number of times the {@link #parentCoordinator} has attempted to recover this result.
     */
    readonly attemptedRecoveryCount?: number | null;
    withAttemptedRecoveryCount(attemptedRecoveryCount: number | null): Hpo.Trial;

    /**
     * Set of hyperparameters used for the trainings within this search trial.
     */
    readonly generatedParams?: Hpo.GeneratedHps | null;
    withGeneratedParams(generatedParams: IHpo.GeneratedHps | null): Hpo.Trial;
     ...
     * {@link MlSplit.Technique#scoreSummary}.
     */
    readonly trainedScoreSummaries?: C3.Map<string | null, number | null>;
    withTrainedScoreSummaries(trainedScoreSummaries: C3.Map<string | null, number | null> | {[key: string | null]: number | null}): Hpo.Trial;
     ...
     * {@link MlSplit.Technique#scoreSummary}.
     */
    readonly validationScoreSummaries?: C3.Map<string | null, number | null>;
    withValidationScoreSummaries(validationScoreSummaries: C3.Map<string | null, number | null> | {[key: string | null]: number | null}): Hpo.Trial;
    ...
    withStatus(status: string | null): Hpo.Trial;

    /**
     * Collection of results from individual training runs. The number of {@link Hpo.Run}s will depend on the number
     * of splits generated by the {@link MlSplit.Technique}.
     */
    readonly runs?: C3.Array<Hpo.Run | null>;
    withRuns(runs: C3.Array<Hpo.Run | null> | Array<IHpo.Run | null>): Hpo.Trial;
    ...
    withStartTimestamp(startTimestamp: DateTime | Date | string | null): Hpo.Trial;

    /**
     * Timestamp of the end of the trial that includes training and scoring.
     */
    readonly endTimestamp?: DateTime | null;
    withEndTimestamp(endTimestamp: DateTime | Date | string | null): Hpo.Trial;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Hpo.Trial | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Hpo.Trial | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Hpo.Trial | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Hpo.Trial | null;
     ...
     */
    replaceType(old: Type, new_: Type): Hpo.Trial;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Hpo.Trial;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Hpo.Trial;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Hpo.Trial | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Hpo.Trial | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Hpo.Trial;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Hpo.Trial;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Hpo.Trial;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Hpo.Trial;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Hpo.Trial;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Hpo.Trial;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Hpo.Trial;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Hpo.Trial;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Hpo.Trial;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Hpo.Trial;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Hpo.Trial;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Hpo.Trial;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Hpo.Trial;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Hpo.Trial;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Hpo.Trial;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Hpo.Trial;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Hpo.Trial;
     ...
     * @see #removeField
     */
    unsetField(field: string): Hpo.Trial;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Hpo.Trial;
     ...
     * @see #unsetField
     */
    removeField(field: string): Hpo.Trial;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Hpo.Trial;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Hpo.Trial;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Hpo.Trial;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Hpo.Trial;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Hpo.Trial;

    mergeJson(json: any | null): Hpo.Trial;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Hpo.Trial;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Hpo.Trial;
     ...
     */
    singletonArray(): C3.Array<Hpo.Trial | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Hpo.Trial | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Hpo.Trial | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Hpo.Trial | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Hpo.Trial | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Hpo.Trial | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Hpo.Trial | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Hpo.Trial | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Hpo.Trial | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Hpo.Trial;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Hpo.Trial;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Hpo.Trial;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Hpo.Trial;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Hpo.Trial;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Hpo.Trial;
     ...
     * @see #fromString
     */
    static make(s: string | null): Hpo.Trial | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Hpo.Trial;
     ...
     */
    static cachedEmptyInst(): Hpo.Trial;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Hpo.Trial>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Hpo.Trial;
     ...
     */
    static fetch(spec?: FetchSpec | null): FetchResult<Hpo.Trial | null>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Hpo.Trial | null>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Hpo.Trial | null>;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Hpo.Trial | null> | null>;
     ...
     */
    get(include?: string | null): Hpo.Trial | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string | null): Hpo.Trial | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Hpo.Trial;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string | null): Hpo.Trial | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Hpo.Trial;
     ...
     * @see #toString
     */
    static fromString(s: string | null): Hpo.Trial | null;
     ...
     */
    create(spec?: UpsertSpec | null): Hpo.Trial | null;
     ...
     */
    static createBatch(objs: C3.Array<Hpo.Trial | null> | null, spec?: UpsertSpec | null): ObjList<Hpo.Trial | null> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Hpo.Trial | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Hpo.Trial | null> | null;
     ...
     */
    update(srcObj?: Hpo.Trial | null, spec?: UpsertSpec | null): Hpo.Trial | null;
     ...
     */
    upsert(srcObj?: Hpo.Trial | null, spec?: UpsertSpec | null): Hpo.Trial | null;
     ...
     */
    merge(spec?: MergeSpec | null): Hpo.Trial | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec | null): Hpo.Trial | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec | null): Hpo.Trial | null;
     ...
     */
    static updateBatch(objs: C3.Array<Hpo.Trial | null> | null, srcObjs?: C3.Array<Hpo.Trial | null>, spec?: UpsertSpec | null): ObjList<Hpo.Trial | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<C3.Array<Hpo.Trial | null>>, spec?: UpsertSpec | null): ObjList<Hpo.Trial | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: C3.Array<Hpo.Trial | null> | null, srcObjs?: C3.Array<Hpo.Trial | null>, spec?: UpsertSpec | null): ObjList<Hpo.Trial | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<C3.Array<Hpo.Trial | null>>, spec?: UpsertSpec | null): ObjList<Hpo.Trial | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: C3.Array<Hpo.Trial | null> | null, spec?: TouchSpec | null): ObjList<Hpo.Trial | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<Hpo.Trial | null> | null, spec?: MergeSpec | null): ObjList<Hpo.Trial | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<Hpo.Trial | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Hpo.Trial | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<C3.Array<Hpo.Trial | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Hpo.Trial | null> | null;
     ...
     */
    static mergeAll(mergeObj: Hpo.Trial | null, spec?: MergeAllSpec | null): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Hpo.Trial | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: C3.Array<Hpo.Trial | null> | null, spec?: UpsertSpec | null): ObjList<Hpo.Trial | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: C3.Array<Hpo.Trial | null> | null, spec?: UpsertSpec | null): ObjList<Hpo.Trial | null> | null;
     ...
     */
    static beforeCreate(objs: C3.Array<Hpo.Trial | null> | null): ObjList<Hpo.Trial | null>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: C3.Array<Hpo.Trial | null> | null): ObjList<Hpo.Trial | null>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: C3.Array<Hpo.Trial | null> | null): ObjList<Hpo.Trial | null>;
     ...
     */
    static afterCreate(objs: C3.Array<Hpo.Trial | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: C3.Array<Hpo.Trial | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: C3.Array<Hpo.Trial | null> | null): C3.Array<ObjError | null>;
     ...
     */
    static startImportData(spec?: StartImportDataSpec | null): PushStream<Hpo.Trial | null>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Hpo.Trial | null>;
     ...
     */
    static forId(id: string | null, failIfMissing?: boolean): Hpo.Trial | null;
     ...
     */
    withoutIdentity(): Hpo.Trial | null;
     ...
     */
    static typeOfBatch(objs: C3.Array<Hpo.Trial | null> | null): C3.Array<EntityType | null>;
     ...
     */
    static dbEcho(template?: Hpo.Trial | null, count?: number | null, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: C3.Array<Hpo.Trial | null> | null, callback?: λFunction<Hpo.Trial | null, Hpo.Trial | null> | null): ObjList<Hpo.Trial | null>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: C3.Array<Hpo.Trial | null> | null, callback?: λFunction<Hpo.Trial | null, Hpo.Trial | null> | null): C3.Array<ObjError | null>;
     ...
     * caller is responsible for persisting the result.
     */
    beforeCancel(): Hpo.Trial;

    /**
     * Collection of results from individual training runs. The number of {@link Hpo.Run}s will depend on the number
     * of splits generated by the {@link MlSplit.Technique}.
     */
    hpoRuns(): C3.Array<Hpo.Run | null>;

    /**
     * Cancel this {@link Hpo.Trial} and all the {@link Hpo.Run}s for this trial, and
     * set the {@link #statusForCoordinatable} as `completed`.
     */
    cancel(): void;

    /**
     * Helper function for populating summary of training and validation scores
     * before completion of this {@link Hpo.Trial}.
     */
    beforeComplete(): Hpo.Trial;
  }
}
