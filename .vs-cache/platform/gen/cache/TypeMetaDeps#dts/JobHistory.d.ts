// TypeScript definitions for the C3 type JobHistory

/**
 * DO NOT create/upsert/update from this type.
 *
 * It is OK to remove entries from this type.
 *
 * @remarks this represents a value passed to a method that expects an instance of JobHistory
 */
declare interface IJobHistory {
  ...
  /**
   * Number of times this instance of the job was run. Typically the value will be 1.
   *
   * If the value is > 1, a node executing the job died before the job was marked as completed and job was restarted
   *
   * on a different node
   */
   ...
   */
  scheduledTime: DateTime | Date | string;

  /**
   * The actual time at which the job ran
   */
  actualTime: DateTime | Date | string;

  /**
   * Status will be SKIPPED if another instance of the job was ready to be triggered before this instance was restarted
   *
   * A job is restarted when the node executing the job dies.
   *
   * CANCELLED is not used at this time.
   */
  status: string;

  /**
   * How long the action run
   */
  durationInMSecs?: number | null;

  /**
   * The result produced by the action, if any.
   *
   * result will be null if the action failed or if it did not produce any result
   *
   * If the result was an Arry or Mapp, it will be wrapped in a dynamic type and the field name will be value.
   */
  result?: any;

  /**
   * error will be set if the action failed.
   *
   * error is really C3Error, but due to a bug in the db engine?, this is declared as an Obj
   */
 ...
 * It is OK to remove entries from this type.
 *
 * @remarks this represents a made instance of JobHistory
 */
declare class JobHistory extends Obj {
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): JobHistory;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): JobHistory;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): JobHistory;
  ...
  withVersion(version: number | null): JobHistory;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): JobHistory;

  readonly job: CronJob;
  withJob(job: ICronJob): JobHistory;
  ...
  withExecutionAttempts(executionAttempts: number): JobHistory;

  /**
   * The time the job was scheduled to run
   */
  readonly scheduledTime: DateTime;
  withScheduledTime(scheduledTime: DateTime | Date | string): JobHistory;

  /**
   * The actual time at which the job ran
   */
  readonly actualTime: DateTime;
  withActualTime(actualTime: DateTime | Date | string): JobHistory;
  ...
  withStatus(status: string): JobHistory;

  /**
   * How long the action run
   */
  readonly durationInMSecs?: number | null;
  withDurationInMSecs(durationInMSecs: number | null): JobHistory;
   ...
   */
  readonly result?: any;
  withResult(result: any): JobHistory;
  ...
  withError(error: IC3.Error | null): JobHistory;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): JobHistory | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): JobHistory | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): JobHistory | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): JobHistory | null;
   ...
   */
  replaceType(old: Type, new_: Type): JobHistory;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JobHistory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JobHistory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JobHistory | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JobHistory | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): JobHistory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JobHistory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JobHistory;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): JobHistory;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): JobHistory;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): JobHistory;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): JobHistory;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): JobHistory;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): JobHistory;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): JobHistory;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): JobHistory;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): JobHistory;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): JobHistory;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): JobHistory;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): JobHistory;
   ...
   * @see #unsetField
   */
  defaultField(field: string): JobHistory;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): JobHistory;
   ...
   * @see #removeField
   */
  unsetField(field: string): JobHistory;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): JobHistory;
   ...
   * @see #unsetField
   */
  removeField(field: string): JobHistory;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): JobHistory;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): JobHistory;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): JobHistory;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): JobHistory;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): JobHistory;

  mergeJson(json: any | null): JobHistory;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): JobHistory;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): JobHistory;
   ...
   */
  singletonArray(): C3.Array<JobHistory | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<JobHistory | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<JobHistory | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<JobHistory | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<JobHistory | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, JobHistory | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, JobHistory | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<JobHistory | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<JobHistory | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): JobHistory;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): JobHistory;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): JobHistory;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): JobHistory;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): JobHistory;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): JobHistory;
   ...
   * @see #fromString
   */
  static make(s: string | null): JobHistory | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): JobHistory;
   ...
   */
  static cachedEmptyInst(): JobHistory;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<JobHistory>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): JobHistory;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<JobHistory | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<JobHistory | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<JobHistory | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<JobHistory | null> | null>;
   ...
   */
  get(include?: string | null): JobHistory | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): JobHistory | null;
   ...
   */
  getMissing(spec: GetMissingSpec): JobHistory;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): JobHistory | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): JobHistory;
   ...
   * @see #toString
   */
  static fromString(s: string | null): JobHistory | null;
   ...
   */
  create(spec?: UpsertSpec | null): JobHistory | null;
   ...
   */
  static createBatch(objs: C3.Array<JobHistory | null> | null, spec?: UpsertSpec | null): ObjList<JobHistory | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<JobHistory | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<JobHistory | null> | null;
   ...
   */
  update(srcObj?: JobHistory | null, spec?: UpsertSpec | null): JobHistory | null;
   ...
   */
  upsert(srcObj?: JobHistory | null, spec?: UpsertSpec | null): JobHistory | null;
   ...
   */
  merge(spec?: MergeSpec | null): JobHistory | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): JobHistory | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): JobHistory | null;
   ...
   */
  static updateBatch(objs: C3.Array<JobHistory | null> | null, srcObjs?: C3.Array<JobHistory | null>, spec?: UpsertSpec | null): ObjList<JobHistory | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<JobHistory | null>>, spec?: UpsertSpec | null): ObjList<JobHistory | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<JobHistory | null> | null, srcObjs?: C3.Array<JobHistory | null>, spec?: UpsertSpec | null): ObjList<JobHistory | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<JobHistory | null>>, spec?: UpsertSpec | null): ObjList<JobHistory | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<JobHistory | null> | null, spec?: TouchSpec | null): ObjList<JobHistory | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<JobHistory | null> | null, spec?: MergeSpec | null): ObjList<JobHistory | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<JobHistory | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<JobHistory | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<JobHistory | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<JobHistory | null> | null;
   ...
   */
  static mergeAll(mergeObj: JobHistory | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: JobHistory | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<JobHistory | null> | null, spec?: UpsertSpec | null): ObjList<JobHistory | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<JobHistory | null> | null, spec?: UpsertSpec | null): ObjList<JobHistory | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<JobHistory | null> | null): ObjList<JobHistory | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<JobHistory | null> | null): ObjList<JobHistory | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<JobHistory | null> | null): ObjList<JobHistory | null>;
   ...
   */
  static afterCreate(objs: C3.Array<JobHistory | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<JobHistory | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<JobHistory | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<JobHistory | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<JobHistory | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): JobHistory | null;
   ...
   */
  withoutIdentity(): JobHistory | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<JobHistory | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: JobHistory | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<JobHistory | null> | null, callback?: λFunction<JobHistory | null, JobHistory | null> | null): ObjList<JobHistory | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<JobHistory | null> | null, callback?: λFunction<JobHistory | null, JobHistory | null> | null): C3.Array<ObjError | null>;
