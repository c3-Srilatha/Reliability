// TypeScript definitions for the C3 type NetworkProxyService

/**
 * This is the base type for all network proxies. We can have proxies for various protocols and multiple proxy
 * implementations per protocol (e.g http proxy using netty, jetty)
 *
 * Each proxy service needs to have two components
 * 1. Proxy server: [netty, jetty], [http, tcp]
 * 2. Proxy Policy [Load balancing, routing, filtering]
 *
 * @remarks this represents a value passed to a method that expects an instance of NetworkProxyService
 */
declare interface INetworkProxyService {
  ...
  /**
   * Port where the service is listening to external requests
   */
  port: number;

  /**
   * The rules applied to figure out the destination server. The policy could be either rule-based or ML.
   */
  policy: IType;

  /**
   * The proxy server used by the service. It could be netty, jetty, vertx etc
   */
  server: IType;
 ...
 * 2. Proxy Policy [Load balancing, routing, filtering]
 *
 * @remarks this represents a made instance of NetworkProxyService
 */
declare class NetworkProxyService extends Obj {

  /**
   * The name of this instance.
   */
  readonly name?: string | null;
  withName(name: string | null): NetworkProxyService;
   ...
   */
  readonly id: string;
  withId(id: string): NetworkProxyService;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): NetworkProxyService;
   ...
   * @see Ann.Db#versionHistory
   */
  static readonly versionEdits?: C3.Array<VersionEdit | null>;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): NetworkProxyService;
  ...
  withVersion(version: number | null): NetworkProxyService;
   ...
   * be done with great caution.
   */
  static readonly version?: number | null;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): NetworkProxyService;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  static readonly typeWithBindings?: Type | null;

  /**
   * Port where the service is listening to external requests
   */
  readonly port: number;
  withPort(port: number): NetworkProxyService;
  ...
  withPolicy(policy: IType): NetworkProxyService;

  /**
   * The rules applied to figure out the destination server. The policy could be either rule-based or ML.
   */
  static readonly policy: Type;

  /**
   * The proxy server used by the service. It could be netty, jetty, vertx etc
   */
  readonly server: Type;
  withServer(server: IType): NetworkProxyService;
  ...
  withStatus(status: string | null): NetworkProxyService;

  /**
   * status of the service
   */
  static readonly status?: string | null;
   ...
   */
  static inst(): NetworkProxyService;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): NetworkProxyService | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): NetworkProxyService | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): NetworkProxyService | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): NetworkProxyService | null;
   ...
   */
  replaceType(old: Type, new_: Type): NetworkProxyService;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): NetworkProxyService;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NetworkProxyService;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NetworkProxyService;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NetworkProxyService;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NetworkProxyService;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NetworkProxyService | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NetworkProxyService | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NetworkProxyService | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NetworkProxyService | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): NetworkProxyService;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): NetworkProxyService;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NetworkProxyService;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NetworkProxyService;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NetworkProxyService;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NetworkProxyService;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): NetworkProxyService;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): NetworkProxyService;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): NetworkProxyService;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): NetworkProxyService;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): NetworkProxyService;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): NetworkProxyService;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): NetworkProxyService;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): NetworkProxyService;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): NetworkProxyService;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): NetworkProxyService;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): NetworkProxyService;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): NetworkProxyService;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): NetworkProxyService;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): NetworkProxyService;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): NetworkProxyService;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): NetworkProxyService;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): NetworkProxyService;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): NetworkProxyService;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): NetworkProxyService;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): NetworkProxyService;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): NetworkProxyService;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): NetworkProxyService;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): NetworkProxyService;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): NetworkProxyService;
   ...
   * @see #unsetField
   */
  defaultField(field: string): NetworkProxyService;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): NetworkProxyService;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): NetworkProxyService;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): NetworkProxyService;
   ...
   * @see #removeField
   */
  unsetField(field: string): NetworkProxyService;
   ...
   * @see #removeField
   */
  static unsetField(field: string): NetworkProxyService;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): NetworkProxyService;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): NetworkProxyService;
   ...
   * @see #unsetField
   */
  removeField(field: string): NetworkProxyService;
   ...
   * @see #unsetField
   */
  static removeField(field: string): NetworkProxyService;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): NetworkProxyService;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): NetworkProxyService;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): NetworkProxyService;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): NetworkProxyService;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): NetworkProxyService;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): NetworkProxyService;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): NetworkProxyService;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): NetworkProxyService;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): NetworkProxyService;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): NetworkProxyService;

  mergeJson(json: any | null): NetworkProxyService;

  static mergeJson(json: any | null): NetworkProxyService;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): NetworkProxyService;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): NetworkProxyService;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): NetworkProxyService;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): NetworkProxyService;
   ...
   */
  singletonArray(): C3.Array<NetworkProxyService | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<NetworkProxyService | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<NetworkProxyService | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<NetworkProxyService | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<NetworkProxyService | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<NetworkProxyService | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<NetworkProxyService | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, NetworkProxyService | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, NetworkProxyService | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<NetworkProxyService | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<NetworkProxyService | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<NetworkProxyService | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): NetworkProxyService;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): NetworkProxyService;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): NetworkProxyService;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): NetworkProxyService;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): NetworkProxyService;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): NetworkProxyService;
   ...
   * @see #fromString
   */
  static make(s: string | null): NetworkProxyService | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): NetworkProxyService;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): NetworkProxyService;
   ...
   */
  static cachedEmptyInst(): NetworkProxyService;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<NetworkProxyService>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): NetworkProxyService;
   ...
   * @return true if this is a SingleTenantEngine.
   */
  static isSingleTenant(): boolean;

  /**
   * @return instance of SingleTenantEngine if this is a SingleTenantEngine or `null` or error based on `failIfNot` argument.
   */
  asSingleTenant(failIfNot?: boolean): SingleTenantEngine | null;

  /**
   * @return instance of SingleTenantEngine if this is a SingleTenantEngine or `null` or error based on `failIfNot` argument.
   */
  static asSingleTenant(failIfNot?: boolean): SingleTenantEngine | null;
   ...
   */
  asMultiTenant(failIfNot?: boolean): MultiTenantEngine | null;

  /**
   * @return instance of MultiTenantEngine if this is a MultiTenantEngine or `null` or error based on `failIfNot` argument.
   */
  static asMultiTenant(failIfNot?: boolean): MultiTenantEngine | null;
   ...
   * @return true if this is a SingleUserEngine
   */
  static isSingleUser(): boolean;

  /**
   * @return instance of a single user Engine or `null` or error based on `failIfNot` argument.
   */
  asSingleUser(failIfNot?: boolean): Engine.Deprecated | null;

  /**
   * @return instance of a single user Engine or `null` or error based on `failIfNot` argument.
   */
  static asSingleUser(failIfNot?: boolean): Engine.Deprecated | null;

  /**
   * @return true if this engine is implemented by external action engine (e.g. nodejs or python).
   */
  isExternalEngine(): boolean;

  /**
   * @return true if this engine is implemented by external action engine (e.g. nodejs or python).
   */
  static isExternalEngine(): boolean;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<NetworkProxyService | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<NetworkProxyService | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<NetworkProxyService | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<NetworkProxyService | null> | null>;
   ...
   */
  get(include?: string | null): NetworkProxyService | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  static get(include?: string | null): NetworkProxyService | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): NetworkProxyService | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  static getSpecific(include?: string | null): NetworkProxyService | null;
   ...
   */
  getMissing(spec: GetMissingSpec): NetworkProxyService;
   ...
   * @return instance of the obj with all requested fields.
   */
  static getMissing(spec: GetMissingSpec): NetworkProxyService;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): NetworkProxyService | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  static getDirect(include?: string | null): NetworkProxyService | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): NetworkProxyService;
   ...
   * @return The instance after applying the reverse edit.
   */
  static applyReverseEdit(versionEdit: VersionEdit): NetworkProxyService;
   ...
   * @see #toString
   */
  static fromString(s: string | null): NetworkProxyService | null;
   ...
   */
  create(spec?: UpsertSpec | null): NetworkProxyService | null;
   ...
   *         will have only those fields populated. Otherwise only the id field will be populated.
   */
  static create(spec?: UpsertSpec | null): NetworkProxyService | null;
   ...
   */
  static createBatch(objs: C3.Array<NetworkProxyService | null> | null, spec?: UpsertSpec | null): ObjList<NetworkProxyService | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<NetworkProxyService | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<NetworkProxyService | null> | null;
   ...
   */
  update(srcObj?: NetworkProxyService | null, spec?: UpsertSpec | null): NetworkProxyService | null;
   ...
   *         obj will have only those fields populated. Otherwise only the id field will be populated.
   */
  static update(srcObj?: NetworkProxyService | null, spec?: UpsertSpec | null): NetworkProxyService | null;
   ...
   */
  upsert(srcObj?: NetworkProxyService | null, spec?: UpsertSpec | null): NetworkProxyService | null;
   ...
   *         returned obj will have only those fields populated. Otherwise only the id field will be populated.
   */
  static upsert(srcObj?: NetworkProxyService | null, spec?: UpsertSpec | null): NetworkProxyService | null;
   ...
   */
  merge(spec?: MergeSpec | null): NetworkProxyService | null;
   ...
   * @see Mergespec#csvInclude
   */
  static merge(spec?: MergeSpec | null): NetworkProxyService | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): NetworkProxyService | null;
   ...
   * @return The created or updated obj.
   */
  static merge(mergeInclude: string, spec?: MergeSpec | null): NetworkProxyService | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): NetworkProxyService | null;
   ...
   * @return The created or updated obj.
   */
  static touch(spec?: TouchSpec | null): NetworkProxyService | null;
   ...
   */
  static updateBatch(objs: C3.Array<NetworkProxyService | null> | null, srcObjs?: C3.Array<NetworkProxyService | null>, spec?: UpsertSpec | null): ObjList<NetworkProxyService | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<NetworkProxyService | null>>, spec?: UpsertSpec | null): ObjList<NetworkProxyService | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<NetworkProxyService | null> | null, srcObjs?: C3.Array<NetworkProxyService | null>, spec?: UpsertSpec | null): ObjList<NetworkProxyService | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<NetworkProxyService | null>>, spec?: UpsertSpec | null): ObjList<NetworkProxyService | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<NetworkProxyService | null> | null, spec?: TouchSpec | null): ObjList<NetworkProxyService | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<NetworkProxyService | null> | null, spec?: MergeSpec | null): ObjList<NetworkProxyService | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<NetworkProxyService | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<NetworkProxyService | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<NetworkProxyService | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<NetworkProxyService | null> | null;
   ...
   */
  static mergeAll(mergeObj: NetworkProxyService | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: NetworkProxyService | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<NetworkProxyService | null> | null, spec?: UpsertSpec | null): ObjList<NetworkProxyService | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<NetworkProxyService | null> | null, spec?: UpsertSpec | null): ObjList<NetworkProxyService | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): NetworkProxyService | null;
   ...
   * @see Ann.Db#archive
   */
  static unremove(): NetworkProxyService | null;
   ...
   */
  static beforeCreate(objs: C3.Array<NetworkProxyService | null> | null): ObjList<NetworkProxyService | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<NetworkProxyService | null> | null): ObjList<NetworkProxyService | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<NetworkProxyService | null> | null): ObjList<NetworkProxyService | null>;
   ...
   */
  static afterCreate(objs: C3.Array<NetworkProxyService | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<NetworkProxyService | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<NetworkProxyService | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<NetworkProxyService | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<NetworkProxyService | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): NetworkProxyService | null;
   ...
   */
  withoutIdentity(): NetworkProxyService | null;
   ...
   * @return The requested obj without any of its identifying fields.
   */
  static withoutIdentity(): NetworkProxyService | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<NetworkProxyService | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: NetworkProxyService | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   *        that state until they are either committed or aborted.
   */
  static invalidateTsHeader(range?: TimeRange | null, fields?: C3.Array<string | null>, autoCommit?: boolean): void;
   ...
   */
  static callbackLogic(objs: C3.Array<NetworkProxyService | null> | null, callback?: λFunction<NetworkProxyService | null, NetworkProxyService | null> | null): ObjList<NetworkProxyService | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<NetworkProxyService | null> | null, callback?: λFunction<NetworkProxyService | null, NetworkProxyService | null> | null): C3.Array<ObjError | null>;
  ...
  /**
   * Registers a network proxy. Only registered proxies can direct traffic.
   */
  register(): void;
  ...
  /**
   * lists all the network proxies registered with the control cluster
   */
  static list(limit?: number | null): Stream<NetworkProxyService | null>;

  /**
   * all active sessions
   */
  sessions(): C3.Array<NetworkProxySession<NetworkSession | null> | null>;

  /**
   * all active sessions
   */
  static sessions(): C3.Array<NetworkProxySession<NetworkSession | null> | null>;
}
