// TypeScript definitions for the C3 type SchemaSpreadsheetResult

/**
 * @remarks this represents a value passed to a method that expects an instance of SchemaSpreadsheetResult
 */
declare interface ISchemaSpreadsheetResult {
...
/**
 * @remarks this represents a made instance of SchemaSpreadsheetResult
 */
declare class SchemaSpreadsheetResult extends Obj {
   ...
   */
  readonly id: string;
  withId(id: string): SchemaSpreadsheetResult;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): SchemaSpreadsheetResult;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): SchemaSpreadsheetResult;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): SchemaSpreadsheetResult;
  ...
  withVersion(version: number | null): SchemaSpreadsheetResult;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): SchemaSpreadsheetResult;

  /**
   * document MIME type
   */
  readonly contentType: string;
  withContentType(contentType: string): SchemaSpreadsheetResult;

  /**
   * encoding into a CLOB
   */
  readonly encoding?: string | null;
  withEncoding(encoding: string | null): SchemaSpreadsheetResult;

  /**
   * spreadsheet contents
   */
  readonly content?: string | null;
  withContent(content: string | null): SchemaSpreadsheetResult;

  /**
   * tables produced (on per type)
   */
  readonly moduleCount?: number | null;
  withModuleCount(moduleCount: number | null): SchemaSpreadsheetResult;

  readonly typeCount?: number | null;
  withTypeCount(typeCount: number | null): SchemaSpreadsheetResult;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SchemaSpreadsheetResult | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SchemaSpreadsheetResult | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SchemaSpreadsheetResult | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SchemaSpreadsheetResult | null;
   ...
   */
  replaceType(old: Type, new_: Type): SchemaSpreadsheetResult;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SchemaSpreadsheetResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SchemaSpreadsheetResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SchemaSpreadsheetResult | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SchemaSpreadsheetResult | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SchemaSpreadsheetResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SchemaSpreadsheetResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SchemaSpreadsheetResult;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SchemaSpreadsheetResult;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SchemaSpreadsheetResult;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SchemaSpreadsheetResult;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SchemaSpreadsheetResult;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SchemaSpreadsheetResult;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SchemaSpreadsheetResult;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SchemaSpreadsheetResult;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SchemaSpreadsheetResult;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SchemaSpreadsheetResult;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SchemaSpreadsheetResult;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SchemaSpreadsheetResult;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SchemaSpreadsheetResult;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SchemaSpreadsheetResult;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SchemaSpreadsheetResult;
   ...
   * @see #removeField
   */
  unsetField(field: string): SchemaSpreadsheetResult;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SchemaSpreadsheetResult;
   ...
   * @see #unsetField
   */
  removeField(field: string): SchemaSpreadsheetResult;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SchemaSpreadsheetResult;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SchemaSpreadsheetResult;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SchemaSpreadsheetResult;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SchemaSpreadsheetResult;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SchemaSpreadsheetResult;

  mergeJson(json: any | null): SchemaSpreadsheetResult;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SchemaSpreadsheetResult;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SchemaSpreadsheetResult;
   ...
   */
  singletonArray(): C3.Array<SchemaSpreadsheetResult | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SchemaSpreadsheetResult | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SchemaSpreadsheetResult | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SchemaSpreadsheetResult | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SchemaSpreadsheetResult | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SchemaSpreadsheetResult | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SchemaSpreadsheetResult | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SchemaSpreadsheetResult | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SchemaSpreadsheetResult | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SchemaSpreadsheetResult;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SchemaSpreadsheetResult;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SchemaSpreadsheetResult;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SchemaSpreadsheetResult;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SchemaSpreadsheetResult;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SchemaSpreadsheetResult;
   ...
   * @see #fromString
   */
  static make(s: string | null): SchemaSpreadsheetResult | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SchemaSpreadsheetResult;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SchemaSpreadsheetResult;
   ...
   */
  static cachedEmptyInst(): SchemaSpreadsheetResult;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SchemaSpreadsheetResult>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SchemaSpreadsheetResult;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<SchemaSpreadsheetResult | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SchemaSpreadsheetResult | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<SchemaSpreadsheetResult | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<SchemaSpreadsheetResult | null> | null>;
   ...
   */
  get(include?: string | null): SchemaSpreadsheetResult | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): SchemaSpreadsheetResult | null;
   ...
   */
  getMissing(spec: GetMissingSpec): SchemaSpreadsheetResult;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): SchemaSpreadsheetResult | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): SchemaSpreadsheetResult;
   ...
   * @see #toString
   */
  static fromString(s: string | null): SchemaSpreadsheetResult | null;
   ...
   */
  create(spec?: UpsertSpec | null): SchemaSpreadsheetResult | null;
   ...
   */
  static createBatch(objs: C3.Array<SchemaSpreadsheetResult | null> | null, spec?: UpsertSpec | null): ObjList<SchemaSpreadsheetResult | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<SchemaSpreadsheetResult | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<SchemaSpreadsheetResult | null> | null;
   ...
   */
  update(srcObj?: SchemaSpreadsheetResult | null, spec?: UpsertSpec | null): SchemaSpreadsheetResult | null;
   ...
   */
  upsert(srcObj?: SchemaSpreadsheetResult | null, spec?: UpsertSpec | null): SchemaSpreadsheetResult | null;
   ...
   */
  merge(spec?: MergeSpec | null): SchemaSpreadsheetResult | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): SchemaSpreadsheetResult | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): SchemaSpreadsheetResult | null;
   ...
   */
  static updateBatch(objs: C3.Array<SchemaSpreadsheetResult | null> | null, srcObjs?: C3.Array<SchemaSpreadsheetResult | null>, spec?: UpsertSpec | null): ObjList<SchemaSpreadsheetResult | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<SchemaSpreadsheetResult | null>>, spec?: UpsertSpec | null): ObjList<SchemaSpreadsheetResult | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<SchemaSpreadsheetResult | null> | null, srcObjs?: C3.Array<SchemaSpreadsheetResult | null>, spec?: UpsertSpec | null): ObjList<SchemaSpreadsheetResult | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<SchemaSpreadsheetResult | null>>, spec?: UpsertSpec | null): ObjList<SchemaSpreadsheetResult | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<SchemaSpreadsheetResult | null> | null, spec?: TouchSpec | null): ObjList<SchemaSpreadsheetResult | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SchemaSpreadsheetResult | null> | null, spec?: MergeSpec | null): ObjList<SchemaSpreadsheetResult | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SchemaSpreadsheetResult | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<SchemaSpreadsheetResult | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<SchemaSpreadsheetResult | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<SchemaSpreadsheetResult | null> | null;
   ...
   */
  static mergeAll(mergeObj: SchemaSpreadsheetResult | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: SchemaSpreadsheetResult | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<SchemaSpreadsheetResult | null> | null, spec?: UpsertSpec | null): ObjList<SchemaSpreadsheetResult | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<SchemaSpreadsheetResult | null> | null, spec?: UpsertSpec | null): ObjList<SchemaSpreadsheetResult | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): SchemaSpreadsheetResult | null;
   ...
   */
  static beforeCreate(objs: C3.Array<SchemaSpreadsheetResult | null> | null): ObjList<SchemaSpreadsheetResult | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<SchemaSpreadsheetResult | null> | null): ObjList<SchemaSpreadsheetResult | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<SchemaSpreadsheetResult | null> | null): ObjList<SchemaSpreadsheetResult | null>;
   ...
   */
  static afterCreate(objs: C3.Array<SchemaSpreadsheetResult | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<SchemaSpreadsheetResult | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<SchemaSpreadsheetResult | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<SchemaSpreadsheetResult | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<SchemaSpreadsheetResult | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): SchemaSpreadsheetResult | null;
   ...
   */
  withoutIdentity(): SchemaSpreadsheetResult | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<SchemaSpreadsheetResult | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: SchemaSpreadsheetResult | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<SchemaSpreadsheetResult | null> | null, callback?: λFunction<SchemaSpreadsheetResult | null, SchemaSpreadsheetResult | null> | null): ObjList<SchemaSpreadsheetResult | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<SchemaSpreadsheetResult | null> | null, callback?: λFunction<SchemaSpreadsheetResult | null, SchemaSpreadsheetResult | null> | null): C3.Array<ObjError | null>;
