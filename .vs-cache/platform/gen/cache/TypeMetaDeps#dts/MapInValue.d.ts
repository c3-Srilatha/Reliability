// TypeScript definitions for the C3 type MapInValue

/**
 * id = jobId + '-' + batch
 *
 * @remarks this represents a value passed to a method that expects an instance of MapInValue
 */
declare interface IMapInValue {
  ...
  objs?: C3.Array<any> | Array<any>;
}

/**
 * id = jobId + '-' + batch
 *
 * @remarks this represents a made instance of MapInValue
 */
declare class MapInValue extends Obj {
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): MapInValue;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): MapInValue;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): MapInValue;
  ...
  withVersion(version: number | null): MapInValue;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): MapInValue;

  readonly run?: MapReduceRun | null;
  withRun(run: IMapReduceRun | null): MapInValue;

  readonly batch?: number | null;
  withBatch(batch: number | null): MapInValue;

  readonly objs?: C3.Array<any>;
  withObjs(objs: C3.Array<any> | Array<any>): MapInValue;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): MapInValue | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): MapInValue | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): MapInValue | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): MapInValue | null;
   ...
   */
  replaceType(old: Type, new_: Type): MapInValue;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MapInValue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MapInValue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MapInValue | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MapInValue | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): MapInValue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MapInValue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MapInValue;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): MapInValue;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): MapInValue;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): MapInValue;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): MapInValue;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): MapInValue;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): MapInValue;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): MapInValue;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): MapInValue;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): MapInValue;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): MapInValue;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): MapInValue;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): MapInValue;
   ...
   * @see #unsetField
   */
  defaultField(field: string): MapInValue;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): MapInValue;
   ...
   * @see #removeField
   */
  unsetField(field: string): MapInValue;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): MapInValue;
   ...
   * @see #unsetField
   */
  removeField(field: string): MapInValue;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): MapInValue;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): MapInValue;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): MapInValue;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): MapInValue;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): MapInValue;

  mergeJson(json: any | null): MapInValue;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): MapInValue;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): MapInValue;
   ...
   */
  singletonArray(): C3.Array<MapInValue | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<MapInValue | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<MapInValue | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<MapInValue | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<MapInValue | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, MapInValue | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, MapInValue | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<MapInValue | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<MapInValue | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): MapInValue;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): MapInValue;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): MapInValue;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): MapInValue;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): MapInValue;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): MapInValue;
   ...
   * @see #fromString
   */
  static make(s: string | null): MapInValue | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): MapInValue;
   ...
   */
  static cachedEmptyInst(): MapInValue;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<MapInValue>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): MapInValue;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<MapInValue | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<MapInValue | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<MapInValue | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<MapInValue | null> | null>;
   ...
   */
  get(include?: string | null): MapInValue | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): MapInValue | null;
   ...
   */
  getMissing(spec: GetMissingSpec): MapInValue;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): MapInValue | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): MapInValue;
   ...
   * @see #toString
   */
  static fromString(s: string | null): MapInValue | null;
   ...
   */
  create(spec?: UpsertSpec | null): MapInValue | null;
   ...
   */
  static createBatch(objs: C3.Array<MapInValue | null> | null, spec?: UpsertSpec | null): ObjList<MapInValue | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<MapInValue | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<MapInValue | null> | null;
   ...
   */
  update(srcObj?: MapInValue | null, spec?: UpsertSpec | null): MapInValue | null;
   ...
   */
  upsert(srcObj?: MapInValue | null, spec?: UpsertSpec | null): MapInValue | null;
   ...
   */
  merge(spec?: MergeSpec | null): MapInValue | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): MapInValue | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): MapInValue | null;
   ...
   */
  static updateBatch(objs: C3.Array<MapInValue | null> | null, srcObjs?: C3.Array<MapInValue | null>, spec?: UpsertSpec | null): ObjList<MapInValue | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<MapInValue | null>>, spec?: UpsertSpec | null): ObjList<MapInValue | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<MapInValue | null> | null, srcObjs?: C3.Array<MapInValue | null>, spec?: UpsertSpec | null): ObjList<MapInValue | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<MapInValue | null>>, spec?: UpsertSpec | null): ObjList<MapInValue | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<MapInValue | null> | null, spec?: TouchSpec | null): ObjList<MapInValue | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<MapInValue | null> | null, spec?: MergeSpec | null): ObjList<MapInValue | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<MapInValue | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<MapInValue | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<MapInValue | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<MapInValue | null> | null;
   ...
   */
  static mergeAll(mergeObj: MapInValue | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: MapInValue | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<MapInValue | null> | null, spec?: UpsertSpec | null): ObjList<MapInValue | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<MapInValue | null> | null, spec?: UpsertSpec | null): ObjList<MapInValue | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<MapInValue | null> | null): ObjList<MapInValue | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<MapInValue | null> | null): ObjList<MapInValue | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<MapInValue | null> | null): ObjList<MapInValue | null>;
   ...
   */
  static afterCreate(objs: C3.Array<MapInValue | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<MapInValue | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<MapInValue | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<MapInValue | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<MapInValue | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): MapInValue | null;
   ...
   */
  withoutIdentity(): MapInValue | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<MapInValue | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: MapInValue | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<MapInValue | null> | null, callback?: λFunction<MapInValue | null, MapInValue | null> | null): ObjList<MapInValue | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<MapInValue | null> | null, callback?: λFunction<MapInValue | null, MapInValue | null> | null): C3.Array<ObjError | null>;
