// TypeScript definitions for the C3 type KvStore.BigTable

/**
 * Uses Google BigTable as a KvStore. History of data is not preserved.
 *
 * @remarks this represents a value passed to a method that expects an instance of KvStore.BigTable
 */
declare namespace KvStore {
  export interface IBigTable {
 ...
 */
declare namespace KvStore {
  export class BigTable extends Obj {

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): KvStore.BigTable;
    ...
    withSQL(SQL: string | null): KvStore.BigTable;
    ...
    withKV(KV: string | null): KvStore.BigTable;
    ...
    withDEFAULT_KV_CONFIG(DEFAULT_KV_CONFIG: string | null): KvStore.BigTable;
    ...
    withDEFAULT_COL_NAME(DEFAULT_COL_NAME: string | null): KvStore.BigTable;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): KvStore.BigTable | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): KvStore.BigTable | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): KvStore.BigTable | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): KvStore.BigTable | null;
     ...
     */
    replaceType(old: Type, new_: Type): KvStore.BigTable;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): KvStore.BigTable;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): KvStore.BigTable;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): KvStore.BigTable;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): KvStore.BigTable;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): KvStore.BigTable;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<KvStore.BigTable | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<KvStore.BigTable | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<KvStore.BigTable | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<KvStore.BigTable | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): KvStore.BigTable;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): KvStore.BigTable;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): KvStore.BigTable;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): KvStore.BigTable;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): KvStore.BigTable;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): KvStore.BigTable;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): KvStore.BigTable;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): KvStore.BigTable;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): KvStore.BigTable;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): KvStore.BigTable;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): KvStore.BigTable;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): KvStore.BigTable;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): KvStore.BigTable;
     ...
     * @return new Obj
     */
    static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): KvStore.BigTable;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): KvStore.BigTable;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): KvStore.BigTable;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): KvStore.BigTable;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): KvStore.BigTable;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): KvStore.BigTable;
     ...
     * @see #removeField
     */
    static withoutField(field: string | null): KvStore.BigTable;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): KvStore.BigTable;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType | null): KvStore.BigTable;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): KvStore.BigTable;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: C3.Array<string | null> | null): KvStore.BigTable;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): KvStore.BigTable;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): KvStore.BigTable;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): KvStore.BigTable;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): KvStore.BigTable;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): KvStore.BigTable;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): KvStore.BigTable;
     ...
     * @see #unsetField
     */
    defaultField(field: string): KvStore.BigTable;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): KvStore.BigTable;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): KvStore.BigTable;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): KvStore.BigTable;
     ...
     * @see #removeField
     */
    unsetField(field: string): KvStore.BigTable;
     ...
     * @see #removeField
     */
    static unsetField(field: string): KvStore.BigTable;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): KvStore.BigTable;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): KvStore.BigTable;
     ...
     * @see #unsetField
     */
    removeField(field: string): KvStore.BigTable;
     ...
     * @see #unsetField
     */
    static removeField(field: string): KvStore.BigTable;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): KvStore.BigTable;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): KvStore.BigTable;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): KvStore.BigTable;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): KvStore.BigTable;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): KvStore.BigTable;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj | null, otherFieldsFilter: Type): KvStore.BigTable;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): KvStore.BigTable;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): KvStore.BigTable;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): KvStore.BigTable;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): KvStore.BigTable;

    mergeJson(json: any | null): KvStore.BigTable;

    static mergeJson(json: any | null): KvStore.BigTable;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): KvStore.BigTable;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): KvStore.BigTable;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): KvStore.BigTable;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj | null, deep?: boolean): KvStore.BigTable;
     ...
     */
    singletonArray(): C3.Array<KvStore.BigTable | null>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): C3.Array<KvStore.BigTable | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<KvStore.BigTable | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<KvStore.BigTable | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<KvStore.BigTable | null>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): C3.Set<KvStore.BigTable | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<KvStore.BigTable | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, KvStore.BigTable | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, KvStore.BigTable | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<KvStore.BigTable | null>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<KvStore.BigTable | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<KvStore.BigTable | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): KvStore.BigTable;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): KvStore.BigTable;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): KvStore.BigTable;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): KvStore.BigTable;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): KvStore.BigTable;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): KvStore.BigTable;
     ...
     * @see #fromString
     */
    static make(s: string | null): KvStore.BigTable | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): KvStore.BigTable;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): KvStore.BigTable;
     ...
     */
    static cachedEmptyInst(): KvStore.BigTable;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<KvStore.BigTable>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): KvStore.BigTable;
     ...
     */
    config(secrets?: boolean): BigTableConfig;
     ...
     * @return instance of configuration - never `null`.
     */
    static config(secrets?: boolean): BigTableConfig;
     ...
     */
    static typeConfig(): BigTableConfig;
     ...
     * @see #toString
     */
    static fromString(s: string | null): KvStore.BigTable | null;
     ...
     */
    static forName(name: string | null, failIfMissing?: boolean): KvStore.BigTable | null;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<KvStore.BigTable | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<KvStore.BigTable | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<KvStore.BigTable | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): KvStore.BigTable | null;
     ...
     * @see findByCacheKey
     */
    static forCacheKey(key: string | null): KvStore.BigTable | null;
     ...
     * @see findByCacheKey
     */
    getCached(): KvStore.BigTable | null;
     ...
     * @see findByCacheKey
     */
    static getCached(): KvStore.BigTable | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): KvStore.BigTable | null;

    /**
     * @return newly produced cached instance.
     */
    static refreshCache(): KvStore.BigTable | null;
     ...
     */
    static produce(key: string): KvStore.BigTable | null;
     ...
     */
    static produceAll(): C3.Map<string | null, KvStore.BigTable | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, KvStore.BigTable | null>;
