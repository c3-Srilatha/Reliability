// TypeScript definitions for the C3 type AbstractEvalMetricsMLDataSourceSpec
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of AbstractEvalMetricsMLDataSourceSpec
 */
declare interface IAbstractEvalMetricsMLDataSourceSpec<DI, DO> {
   ...
   */
  dataTimestamp?: DateTime | Date | string | null;

  /**
   * Identifier for the target to learn
   */
  target?: string | null;
   ...
   */
  maskMetric?: string | null;

  /**
   * Simple Metrics not previously defined in the platform
   */
  overrideSimpleMetrics?: C3.Array<any | null> | Array<any | null>;

  /**
   * Compound Metrics not previously defined in the platform
   */
  overrideCompoundMetrics?: C3.Array<any | null> | Array<any | null>;
   ...
   */
  intervalsFromStartToEnd?: number | null;
 ...
 * | Required | Required | Undefined | Undefined | Undefined               | start                             | end                                    |
 *
 * @remarks this represents a made instance of AbstractEvalMetricsMLDataSourceSpec
 */
declare class AbstractEvalMetricsMLDataSourceSpec<DI, DO> extends Obj {
  ...
  withTypeIdent(typeIdent: string | null): AbstractEvalMetricsMLDataSourceSpec;
   ...
   */
  readonly id: string;
  withId(id: string): AbstractEvalMetricsMLDataSourceSpec;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): AbstractEvalMetricsMLDataSourceSpec;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): AbstractEvalMetricsMLDataSourceSpec;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): AbstractEvalMetricsMLDataSourceSpec;
  ...
  withVersion(version: number | null): AbstractEvalMetricsMLDataSourceSpec;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): AbstractEvalMetricsMLDataSourceSpec;

  /**
   * The source type for this spec (e.g. the type on which `evalMetrics` will be called).
   */
  readonly srcType: Type;
  withSrcType(srcType: IType): AbstractEvalMetricsMLDataSourceSpec;
   ...
   * was persisted as part of the training job.
   */
  readonly dataTimestamp?: DateTime | null;
  withDataTimestamp(dataTimestamp: DateTime | Date | string | null): AbstractEvalMetricsMLDataSourceSpec;

  /**
   * Identifier for the target to learn
   */
  readonly target?: string | null;
  withTarget(target: string | null): AbstractEvalMetricsMLDataSourceSpec;

  /**
   * Names of metrics to use in training
   */
  readonly features: C3.Array<string | null>;
  withFeatures(features: C3.Array<string | null> | Array<string | null>): AbstractEvalMetricsMLDataSourceSpec;
   ...
   * this field slightly differently.  See the documentation of this field on those Types.
   */
  readonly maskMetric?: string | null;
  withMaskMetric(maskMetric: string | null): AbstractEvalMetricsMLDataSourceSpec;

  /**
   * Simple Metrics not previously defined in the platform
   */
  readonly overrideSimpleMetrics?: C3.Array<any | null>;
  withOverrideSimpleMetrics(overrideSimpleMetrics: C3.Array<any | null> | Array<any | null>): AbstractEvalMetricsMLDataSourceSpec;

  /**
   * Compound Metrics not previously defined in the platform
   */
  readonly overrideCompoundMetrics?: C3.Array<any | null>;
  withOverrideCompoundMetrics(overrideCompoundMetrics: C3.Array<any | null> | Array<any | null>): AbstractEvalMetricsMLDataSourceSpec;
  ...
  withStartPath(startPath: string | null): AbstractEvalMetricsMLDataSourceSpec;
  ...
  withStart(start: DateTime | Date | string): AbstractEvalMetricsMLDataSourceSpec;

  /**
   * Path from source object to timestamp until which the features need to be extracted.
   * Refer to the type level documentation for how this field affects the evaluated end date.
   */
  readonly endPath?: string | null;
  withEndPath(endPath: string | null): AbstractEvalMetricsMLDataSourceSpec;
  ...
  withEnd(end: DateTime | Date | string): AbstractEvalMetricsMLDataSourceSpec;

  /**
   * Number of intervals between start and end date of the evalMetrics call.
   * Refer to the type level documentation for how this field affects the evaluated start or end date.
   */
  readonly intervalsFromStartToEnd?: number | null;
  withIntervalsFromStartToEnd(intervalsFromStartToEnd: number | null): AbstractEvalMetricsMLDataSourceSpec;

  /**
   * Interval to use to extract data between start and end dates.
   */
  readonly interval: string;
  withInterval(interval: string): AbstractEvalMetricsMLDataSourceSpec;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null;
   ...
   */
  replaceType(old: Type, new_: Type): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   * @see #removeField
   */
  unsetField(field: string): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   * @see #unsetField
   */
  removeField(field: string): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;

  mergeJson(json: any | null): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   */
  singletonArray(): C3.Array<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   * @see #fromString
   */
  static make(s: string | null): AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   */
  static cachedEmptyInst(): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<AbstractEvalMetricsMLDataSourceSpec<DI, DO>>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null>;
   ...
   */
  get(include?: string | null): AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null;
   ...
   */
  getMissing(spec: GetMissingSpec): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): AbstractEvalMetricsMLDataSourceSpec<DI, DO>;
   ...
   * @see #toString
   */
  static fromString(s: string | null): AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null;
   ...
   */
  create(spec?: UpsertSpec | null): AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null;
   ...
   */
  static createBatch(objs: C3.Array<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null, spec?: UpsertSpec | null): ObjList<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null;
   ...
   */
  update(srcObj?: AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null, spec?: UpsertSpec | null): AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null;
   ...
   */
  upsert(srcObj?: AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null, spec?: UpsertSpec | null): AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null;
   ...
   */
  merge(spec?: MergeSpec | null): AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null;
   ...
   */
  static updateBatch(objs: C3.Array<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null, srcObjs?: C3.Array<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null>, spec?: UpsertSpec | null): ObjList<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null>>, spec?: UpsertSpec | null): ObjList<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null, srcObjs?: C3.Array<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null>, spec?: UpsertSpec | null): ObjList<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null>>, spec?: UpsertSpec | null): ObjList<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null, spec?: TouchSpec | null): ObjList<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null, spec?: MergeSpec | null): ObjList<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null;
   ...
   */
  static mergeAll(mergeObj: AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null, spec?: UpsertSpec | null): ObjList<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null, spec?: UpsertSpec | null): ObjList<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null): ObjList<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null): ObjList<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null): ObjList<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null>;
   ...
   */
  static afterCreate(objs: C3.Array<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null;
   ...
   */
  withoutIdentity(): AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null, callback?: λFunction<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null, AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null): ObjList<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null, callback?: λFunction<AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null, AbstractEvalMetricsMLDataSourceSpec<DI, DO> | null> | null): C3.Array<ObjError | null>;
   ...
   */
  getInputDataForSources(srcIds: C3.Set<string | null>): DI;

  /**
   * Retrieves data for the sourceIds specified according to the rest of the spec.
   * Returned as a map of {{ value of groupingField }} -> data for source objects with that value.
   */
  getGroupedInputDataForSources(srcIds: C3.Set<string | null>, groupingField: string): C3.Map<string | null, DI | null>;

  /**
   * Function that combines an arry of the produced data type into a single object.
   */
  combineInputDataObjects(dataObjs: C3.Array<DI | null>): DI | null;

  /**
   * Whether this spec is for supervised training. A convenience function.
   */
  isForSupervisedTraining(): boolean;
   ...
   */
  persistData(data: DI, group?: string | null): void;
  ...
  /**
   * Retrieves target data for the sourceIds specified according to the rest of the spec.
   */
  getTargetDataForSources(srcIds: C3.Set<string | null>): DO;

  /**
   * Retrieves both input and target data for the sourceIds specified according to the rest of the spec.
   */
  getInputAndTargetDataForSources(srcIds: C3.Set<string | null>): Pair<DI, DO>;

  /**
   * Retrieves both input and target data for the sourceIds specified according to the rest of the spec.
   * Returned as a map of {{ value of groupingField }} -> data for source objects with that value.
   */
  getGroupedInputAndTargetDataForSources(srcIds: C3.Set<string | null>, groupingField: string): C3.Map<string | null, Pair<DI, DO> | null>;

  /**
   * Function that combines an arry of the target data type into a single object.
   * Used to do map/reduce.
   */
  combineTargetDataObjects(dataObjs: C3.Array<DO | null>): DO;

  /**
   * Function that combines an arry of the input and target data pairs into a single object.
   * Used to do map/reduce.
   */
  combineInputAndTargetDataObjects(dataObjs: C3.Array<Pair<DI, DO> | null>): Pair<DI, DO>;

  /**
   * Abstract function (to be implemented by classes that extend SupervisedMLDataSourceSpec) to persist
   ...
   *          The group, if any, associated with this dataset. See {@link MLTrainingJob#group}.
   */
  persistInputAndTargetData(data: Pair<DI, DO>, group?: string | null): void;

  /**
   * Gets the data persisted for this spec.
   *
   * @return The persisted data for this spec. Null if no data has been persisted.
   */
  getPersistedInputAndTargetData(): Pair<DI, DO> | null;
}
