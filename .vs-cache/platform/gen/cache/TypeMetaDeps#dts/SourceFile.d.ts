// TypeScript definitions for the C3 type SourceFile
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of SourceFile
 */
declare interface ISourceFile {
  ...
  pipelineStatuses?: C3.Array<Sources.PipelineStatus | null> | Array<ISources.PipelineStatus | null>;
}
 ...
 */
declare class SourceFile extends Obj {

  /**
   * The id of this instance.
   */
  readonly id: string;
  withId(id: string): SourceFile;
  ...
  withSource(source: IType | null): SourceFile;

  /**
   * {@link SourceCollection} associated to the source content.
   */
  readonly sourceCollectionName: string;
  withSourceCollectionName(sourceCollectionName: string): SourceFile;

  /**
   * @returns the relative path from the root directory to the directory in which the file is located
   */
  readonly encodedPath?: string | null;
  withEncodedPath(encodedPath: string | null): SourceFile;
  ...
  withContentEncoding(contentEncoding: string | null): SourceFile;
  ...
  withContentLanguage(contentLanguage: string | null): SourceFile;
  ...
  withContentLength(contentLength: number | null): SourceFile;
  ...
  withContentLocation(contentLocation: string | null): SourceFile;
  ...
  withContentType(contentType: string | null): SourceFile;
  ...
  withContentDisposition(contentDisposition: string | null): SourceFile;
  ...
  withETag(eTag: string | null): SourceFile;
  ...
  withLastModified(lastModified: DateTime | Date | string | null): SourceFile;

  /**
   * Id of user / identity who last last modified this content.
   */
  readonly lastModifiedBy?: string | null;
  withLastModifiedBy(lastModifiedBy: string | null): SourceFile;
  ...
  withContentMD5(contentMD5: string | null): SourceFile;
  ...
  withContentSHA1(contentSHA1: string | null): SourceFile;

  /**
   * Meta information for the processing of the sources
   */
  readonly sourcesMeta?: Obj | null;
  withSourcesMeta(sourcesMeta: IObj | null): SourceFile;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): SourceFile;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): SourceFile;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): SourceFile;
  ...
  withVersion(version: number | null): SourceFile;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): SourceFile;

  /**
   * SourceFileInfo derived from the #contentLocation.
   * {@see Source#parseFileName}
   */
  readonly fileInfo?: SourceFileInfo | null;
  withFileInfo(fileInfo: ISourceFileInfo | null): SourceFile;

  /**
   * A foreign key reference to the {@see SourceStatus} entry in the db for the SourceFile instance
   */
  readonly status?: SourceStatus | null;
  withStatus(status: ISourceStatus | null): SourceFile;

  readonly pipelineStatuses?: C3.Array<Sources.PipelineStatus | null>;
  withPipelineStatuses(pipelineStatuses: C3.Array<Sources.PipelineStatus | null> | Array<ISources.PipelineStatus | null>): SourceFile;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SourceFile | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SourceFile | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SourceFile | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SourceFile | null;
   ...
   */
  replaceType(old: Type, new_: Type): SourceFile;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SourceFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SourceFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SourceFile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SourceFile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SourceFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SourceFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SourceFile;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SourceFile;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SourceFile;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SourceFile;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SourceFile;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SourceFile;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SourceFile;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SourceFile;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SourceFile;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SourceFile;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SourceFile;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SourceFile;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SourceFile;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SourceFile;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SourceFile;
   ...
   * @see #removeField
   */
  unsetField(field: string): SourceFile;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SourceFile;
   ...
   * @see #unsetField
   */
  removeField(field: string): SourceFile;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SourceFile;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SourceFile;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SourceFile;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SourceFile;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SourceFile;

  mergeJson(json: any | null): SourceFile;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SourceFile;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SourceFile;
   ...
   */
  singletonArray(): C3.Array<SourceFile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SourceFile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SourceFile | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SourceFile | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SourceFile | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SourceFile | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SourceFile | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SourceFile | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SourceFile | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SourceFile;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SourceFile;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SourceFile;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SourceFile;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SourceFile;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SourceFile;
   ...
   * @see #fromString
   */
  static make(s: string | null): SourceFile | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SourceFile;
   ...
   */
  static cachedEmptyInst(): SourceFile;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SourceFile>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SourceFile;
   ...
   */
  withFileName(fileName: string | null): SourceFile;

  /**
   * Changes file extension in this instance.
   */
  withFileExt(fileExt: string | null): SourceFile;
   ...
   */
  identify(suffix?: string | null): SourceFile;

  /**
   * @return Sources for id
   */
  static forId(id: string | null, failIfMissing?: boolean): SourceFile | null;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<SourceFile | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SourceFile | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<SourceFile | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<SourceFile | null> | null>;
   ...
   */
  get(include?: string | null): SourceFile | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): SourceFile | null;
   ...
   */
  getMissing(spec: GetMissingSpec): SourceFile;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): SourceFile | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): SourceFile;
   ...
   */
  create(spec?: UpsertSpec | null): SourceFile | null;
   ...
   */
  static createBatch(objs: C3.Array<SourceFile | null> | null, spec?: UpsertSpec | null): ObjList<SourceFile | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<SourceFile | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<SourceFile | null> | null;
   ...
   */
  update(srcObj?: SourceFile | null, spec?: UpsertSpec | null): SourceFile | null;
   ...
   */
  upsert(srcObj?: SourceFile | null, spec?: UpsertSpec | null): SourceFile | null;
   ...
   */
  merge(spec?: MergeSpec | null): SourceFile | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): SourceFile | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): SourceFile | null;
   ...
   */
  static updateBatch(objs: C3.Array<SourceFile | null> | null, srcObjs?: C3.Array<SourceFile | null>, spec?: UpsertSpec | null): ObjList<SourceFile | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<SourceFile | null>>, spec?: UpsertSpec | null): ObjList<SourceFile | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<SourceFile | null> | null, srcObjs?: C3.Array<SourceFile | null>, spec?: UpsertSpec | null): ObjList<SourceFile | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<SourceFile | null>>, spec?: UpsertSpec | null): ObjList<SourceFile | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<SourceFile | null> | null, spec?: TouchSpec | null): ObjList<SourceFile | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SourceFile | null> | null, spec?: MergeSpec | null): ObjList<SourceFile | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SourceFile | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<SourceFile | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<SourceFile | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<SourceFile | null> | null;
   ...
   */
  static mergeAll(mergeObj: SourceFile | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: SourceFile | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<SourceFile | null> | null, spec?: UpsertSpec | null): ObjList<SourceFile | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<SourceFile | null> | null, spec?: UpsertSpec | null): ObjList<SourceFile | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<SourceFile | null> | null): ObjList<SourceFile | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<SourceFile | null> | null): ObjList<SourceFile | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<SourceFile | null> | null): ObjList<SourceFile | null>;
   ...
   */
  static afterCreate(objs: C3.Array<SourceFile | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<SourceFile | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<SourceFile | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<SourceFile | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<SourceFile | null>;
   ...
   */
  withoutIdentity(): SourceFile | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<SourceFile | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: SourceFile | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<SourceFile | null> | null, callback?: λFunction<SourceFile | null, SourceFile | null> | null): ObjList<SourceFile | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<SourceFile | null> | null, callback?: λFunction<SourceFile | null, SourceFile | null> | null): C3.Array<ObjError | null>;
   ...
   */
  sync(spec?: DataIntegSpec | null): SourceFile | null;
   ...
   */
  static syncAll(urlOrEncodedPath?: string | null, spec?: DataIntegSpec | null): C3.Array<FileSystemBatchJob | null>;
   ...
   *        {@see DataIntegSpec#include}
   */
  static syncBatch(files: C3.Array<SourceFile | null>, spec?: DataIntegSpec | null): C3.Array<SourceFile | null>;
   ...
   *        {@see DataIntegSpec#include}
   */
  static syncBatchWithId(fileIds: C3.Array<string | null>, spec?: DataIntegSpec | null): C3.Array<SourceFile | null>;
   ...
   */
  static syncFileMetadataBatch(files: C3.Array<File | null>, spec?: DataIntegSpec | null): C3.Array<SourceFile | null>;
   ...
   *        {@see DataIntegSpec#include}
   */
  static syncFileMetadata(file: File, spec?: DataIntegSpec | null): SourceFile | null;
   ...
   */
  static processAll(spec?: DataIntegSpec | null): void;
   ...
   */
  static processBatch(sources: C3.Array<SourceFile | null> | null, spec?: DataIntegSpec | null): void;
   ...
   * @param spec {@see SourceFileProcessSpec}
   */
  static processBatchWithId(fileIds: C3.Array<string | null>, spec?: DataIntegSpec | null): void;
   ...
   * @param spec {@see SourceFileProcessSpec}
   */
  static processStream(sources?: Stream<SourceFile | null>, spec?: DataIntegSpec | null): void;
   ...
   */
  static stopBatch(files: C3.Array<SourceFile | null> | null): void;
   ...
   */
  resume(spec?: DataIntegSpec | null): SourceFile | null;

  /**
   * Performs #resume on a batch of SourceFiles.
   */
  static resumeBatch(files: C3.Array<SourceFile | null> | null, spec?: DataIntegSpec | null): C3.Array<SourceFile | null>;
   ...
   */
  static forUrl(urlOrEncodedPath: string, include?: string | null, failIfMissing?: boolean): SourceFile | null;
   ...
   */
  static forChunkId(chunkId: string, include?: string | null, failIfMissing?: boolean): SourceFile | null;

  /**
   * Deletes all entries in SourceFile as specified in processSpec.
   * Also creates stats file {@see writeStatsFile}
   */
  static archiveAll(spec?: DataIntegSpec | null): void;
   ...
   */
  removeWithData(spec?: SourceFile.RemoveWithDataSpec | null): boolean;
   ...
   */
  static removeWithDataBatch(sourceFileIds?: C3.Array<string | null>): SourceFile.RemoveWithDataBatchJob | null;

  /**
   * @return stream of SourceFiles for SourceCollection
   * if sc is null it will return all SourceFile
   */
  static sourceFilesForSourceCollection(sc?: SourceCollection<SourceCollection.Config | null> | null): Stream<SourceFile | null>;
   ...
   */
  static parseFileName(fileName?: string | null, fsc?: FileSourceCollection | null): SourceFileInfo | null;
}
