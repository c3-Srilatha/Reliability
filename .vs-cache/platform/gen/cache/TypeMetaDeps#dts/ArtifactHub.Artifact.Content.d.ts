// TypeScript definitions for the C3 type ArtifactHub.Artifact.Content

/**
 * {@link ArtifactHub} type used to distribute and receive content efficiently. Inherited {@link Content} APIs can
 * be used like they normally would for other subtypes (ex. {@link File}).
 *
 * @remarks this represents a value passed to a method that expects an instance of ArtifactHub.Artifact.Content
 */
declare namespace ArtifactHub.Artifact {
  export interface IContent {

    /**
     * A unique identifier used by {@link ArtifactHub} to identify the correct content.
     */
    id: string;
    ...
    /**
     * The name of the content. During {@link ArtifactHub.Artifact#register}, this field will be used as a
     * {@link File#name} by the service.
     */
    name?: string | null;
    ...
    /**
     * The {@link AppId} of ArtifactHub that hosts this content.
     * This field is used to let the ArtifactHub service know if content should be read from an upstream source.
     */
 ...
 * be used like they normally would for other subtypes (ex. {@link File}).
 *
 * @remarks this represents a made instance of ArtifactHub.Artifact.Content
 */
declare namespace ArtifactHub.Artifact {
  export class Content extends Obj {

    /**
     * A unique identifier used by {@link ArtifactHub} to identify the correct content.
     */
    readonly id: string;
    withId(id: string): ArtifactHub.Artifact.Content;
    ...
    withContentEncoding(contentEncoding: string | null): ArtifactHub.Artifact.Content;
    ...
    withContentLanguage(contentLanguage: string | null): ArtifactHub.Artifact.Content;
    ...
    withContentLength(contentLength: number | null): ArtifactHub.Artifact.Content;
    ...
    withContentLocation(contentLocation: string | null): ArtifactHub.Artifact.Content;
    ...
    withContentType(contentType: string | null): ArtifactHub.Artifact.Content;
    ...
    withContentDisposition(contentDisposition: string | null): ArtifactHub.Artifact.Content;
    ...
    withETag(eTag: string | null): ArtifactHub.Artifact.Content;
    ...
    withLastModified(lastModified: DateTime | Date | string | null): ArtifactHub.Artifact.Content;

    /**
     * Id of user / identity who last last modified this content.
     */
    readonly lastModifiedBy?: string | null;
    withLastModifiedBy(lastModifiedBy: string | null): ArtifactHub.Artifact.Content;
    ...
    withContentMD5(contentMD5: string | null): ArtifactHub.Artifact.Content;
    ...
    withContentSHA1(contentSHA1: string | null): ArtifactHub.Artifact.Content;

    /**
     * Field to maintain state whether content metadata was read or not.
     */
    readonly hasMetadata?: boolean;
    withHasMetadata(hasMetadata: boolean): ArtifactHub.Artifact.Content;
    ...
    withName(name: string | null): ArtifactHub.Artifact.Content;

    /**
     * Specifies the {@link Microservice.Proxy} instance to use when fetching the real backing {@link Content}.
     */
    readonly serviceName?: string | null;
    withServiceName(serviceName: string | null): ArtifactHub.Artifact.Content;

    /**
     * The {@link AppId} of ArtifactHub that hosts this content.
     * This field is used to let the ArtifactHub service know if content should be read from an upstream source.
     */
    readonly sourceHub?: string | null;
    withSourceHub(sourceHub: string | null): ArtifactHub.Artifact.Content;

    /**
     * The date at which the artifact expires.
     */
    readonly expiresAt?: DateTime | null;
    withExpiresAt(expiresAt: DateTime | Date | string | null): ArtifactHub.Artifact.Content;

    /**
     * Whether to keep the artifact forever.
     */
    readonly keepForever?: boolean;
    withKeepForever(keepForever: boolean): ArtifactHub.Artifact.Content;
     ...
     * @see #toString
     */
    static fromString(s: string | null): ArtifactHub.Artifact.Content | null;
     ...
     * @see #fromString
     */
    static make(s: string | null): ArtifactHub.Artifact.Content | null;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ArtifactHub.Artifact.Content;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ArtifactHub.Artifact.Content;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ArtifactHub.Artifact.Content;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ArtifactHub.Artifact.Content;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): ArtifactHub.Artifact.Content | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): ArtifactHub.Artifact.Content | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): ArtifactHub.Artifact.Content | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): ArtifactHub.Artifact.Content | null;
     ...
     */
    replaceType(old: Type, new_: Type): ArtifactHub.Artifact.Content;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ArtifactHub.Artifact.Content;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ArtifactHub.Artifact.Content;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ArtifactHub.Artifact.Content | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ArtifactHub.Artifact.Content | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ArtifactHub.Artifact.Content;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ArtifactHub.Artifact.Content;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ArtifactHub.Artifact.Content;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ArtifactHub.Artifact.Content;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ArtifactHub.Artifact.Content;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ArtifactHub.Artifact.Content;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ArtifactHub.Artifact.Content;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ArtifactHub.Artifact.Content;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ArtifactHub.Artifact.Content;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): ArtifactHub.Artifact.Content;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): ArtifactHub.Artifact.Content;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): ArtifactHub.Artifact.Content;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ArtifactHub.Artifact.Content;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ArtifactHub.Artifact.Content;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ArtifactHub.Artifact.Content;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ArtifactHub.Artifact.Content;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ArtifactHub.Artifact.Content;
     ...
     * @see #removeField
     */
    unsetField(field: string): ArtifactHub.Artifact.Content;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ArtifactHub.Artifact.Content;
     ...
     * @see #unsetField
     */
    removeField(field: string): ArtifactHub.Artifact.Content;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ArtifactHub.Artifact.Content;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ArtifactHub.Artifact.Content;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): ArtifactHub.Artifact.Content;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ArtifactHub.Artifact.Content;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ArtifactHub.Artifact.Content;

    mergeJson(json: any | null): ArtifactHub.Artifact.Content;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ArtifactHub.Artifact.Content;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): ArtifactHub.Artifact.Content;
     ...
     */
    singletonArray(): C3.Array<ArtifactHub.Artifact.Content | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<ArtifactHub.Artifact.Content | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ArtifactHub.Artifact.Content | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<ArtifactHub.Artifact.Content | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ArtifactHub.Artifact.Content | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, ArtifactHub.Artifact.Content | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ArtifactHub.Artifact.Content | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ArtifactHub.Artifact.Content | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ArtifactHub.Artifact.Content | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ArtifactHub.Artifact.Content;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ArtifactHub.Artifact.Content;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ArtifactHub.Artifact.Content;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ArtifactHub.Artifact.Content;
     ...
     */
    static cachedEmptyInst(): ArtifactHub.Artifact.Content;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ArtifactHub.Artifact.Content>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): ArtifactHub.Artifact.Content;
     ...
     */
    static forId(id: string | null, failIfMissing?: boolean): ArtifactHub.Artifact.Content | null;
     ...
     */
    withFileName(fileName: string | null): ArtifactHub.Artifact.Content;

    /**
     * Changes file extension in this instance.
     */
    withFileExt(fileExt: string | null): ArtifactHub.Artifact.Content;
     ...
     */
    identify(suffix?: string | null): ArtifactHub.Artifact.Content;
     ...
     */
    readMetadata(spec?: FileOperationSpec | null): ArtifactHub.Artifact.Content;
     ...
     */
    refreshMetadata(spec?: FileOperationSpec | null): ArtifactHub.Artifact.Content;
     ...
     * @return abstract content with metadata.
     */
    guessMetadata(spec?: FileOperationSpec | null): ArtifactHub.Artifact.Content;

    /**
     * Notifies the service automatically when the real backing {@link Content} has been updated.
     */
    clearMetadata(): ArtifactHub.Artifact.Content;

    /**
     * @return clone of this content with metadata from provided input.
     */
    withMetadata(meta?: ContentMeta | null): ArtifactHub.Artifact.Content;
     ...
     */
    encodedPushStream(spec?: FileOperationSpec | null): Pair<ArtifactHub.Artifact.Content | null, BytePushStream | null>;

    /**
     * @return byte push stream to be used for writing un-encoded data into this content object.
     */
    pushStream(spec?: FileOperationSpec | null): Pair<ArtifactHub.Artifact.Content | null, BytePushStream | null>;

    /**
     * @return character push stream to be used for writing un-encoded data into this content object.
     */
    charPushStream(spec?: FileOperationSpec | null): Pair<ArtifactHub.Artifact.Content | null, CharPushStream | null>;
     ...
     */
    encodedStream(spec?: FileOperationSpec | null): Pair<ArtifactHub.Artifact.Content | null, ByteStream | null> | null;
     ...
     */
    writeStream(content: ByteStream | null, spec?: FileOperationSpec | null): ArtifactHub.Artifact.Content;

    /**
     * Truncates file and replaces it's content with provided binary content.
     */
    writeInputStream(inputStream: any, spec?: FileOperationSpec | null): ArtifactHub.Artifact.Content;

    /**
     * Truncates file and replaces its content with provided binary content from zipInputStream
     */
    writeZipInputStream(zipInputStream: any, spec?: FileOperationSpec | null): ArtifactHub.Artifact.Content;
     ...
     */
    writeEncodedStream(encodedContent: ByteStream | null, spec?: FileOperationSpec | null): ArtifactHub.Artifact.Content;

    /**
     * Truncates file and replaces it's encoded content with provided binary content.
     */
    writeEncodedInputStream(inputStream: any, spec?: FileOperationSpec | null): ArtifactHub.Artifact.Content;
     ...
     *           content that needs to be written
     */
    write(content: any | null, spec?: FileOperationSpec | null): ArtifactHub.Artifact.Content;
     ...
     *           encoded content that needs to be written
     */
    writeEncoded(encodedContent: any | null, spec?: FileOperationSpec | null): ArtifactHub.Artifact.Content;
     ...
     *           content that needs to be written
     */
    writeString(content: string | null, spec?: FileOperationSpec | null): ArtifactHub.Artifact.Content;
     ...
     */
    writeObj(obj: Obj | null, spec?: FileObjsOperSpec | null): ArtifactHub.Artifact.Content;
     ...
     * @return pair of update instance of this content and number of objs written
     */
    startWriteObjs(spec?: FileObjsOperSpec | null): Pair<ArtifactHub.Artifact.Content | null, PushStream<Obj | null> | null>;
     ...
     */
    compress(contentEncoding?: string | null, spec?: FileCompressSpec | null): ArtifactHub.Artifact.Content;

    /**
     * Uncompresses content.
     */
    uncompress(spec?: FileCompressSpec | null): ArtifactHub.Artifact.Content;
     ...
     */
    transcode(contentType: string, contentEncoding: string, spec?: FileCompressSpec | null): ArtifactHub.Artifact.Content;

    /**
     * Copies content to a given target.
     */
    copyContentTo(target: ArtifactHub.Artifact.Content, spec?: FileOperationSpec | null): void;
     ...
     */
    concat(other: Content | null): ArtifactHub.Artifact.Content;

    /**
     * Creates a new Content by merging the incoming binary data with current content
     */
    concat(other: any | null): ArtifactHub.Artifact.Content;
