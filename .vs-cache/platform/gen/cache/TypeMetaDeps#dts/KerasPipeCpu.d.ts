// TypeScript definitions for the C3 type KerasPipeCpu

/**
 * This type represents a CPU-only wrapper over {@link KerasPipe} such that users with Mac OSX machines can develop
 * and execute {@link KerasPipe}s. This wrapper can also be used to guarantee execution on only the CPU.
 *
 * @remarks this represents a value passed to a method that expects an instance of KerasPipeCpu
 */
declare interface IKerasPipeCpu<DX, DY, DO> {
   ...
   */
  sanitizedNames?: C3.Map<string | null, string | null> | {[key: string | null]: string | null};
   ...
   */
  processArgs: IKerasPredictArgs;

  /**
   * The keras model's history.
   */
  history?: IKerasPipe.KerasHistory | null;
   ...
   * ```
   */
  generator: IKerasGenerator<DX, DY>;
   ...
   * ```
   */
  processGenerator?: IKerasGenerator<DX, DY> | null;
   ...
   */
  hyperparamOverrides?: C3.Map<string | null, any> | {[key: string | null]: any};
   ...
   */
  hyperparamSearchSpace?: IHp.SearchSpace | null;
   ...
   */
  modelFiles?: C3.Map<string | null, Url | null> | {[key: string | null]: IUrl | null};
   ...
   */
  customModelCode?: C3.Map<string | null, any | null> | {[key: string | null]: any | null};
 ...
 * and execute {@link KerasPipe}s. This wrapper can also be used to guarantee execution on only the CPU.
 *
 * @remarks this represents a made instance of KerasPipeCpu
 */
declare class KerasPipeCpu<DX, DY, DO> extends Obj {
  ...
  withYFromX(yFromX: C3.Map<string | null, string | null> | {[key: string | null]: string | null}): KerasPipeCpu;
   ...
   * names on this {@link KerasPipe} to the names in the native Keras model.
   */
  readonly sanitizedNames?: C3.Map<string | null, string | null>;
  withSanitizedNames(sanitizedNames: C3.Map<string | null, string | null> | {[key: string | null]: string | null}): KerasPipeCpu;
   ...
   * are ignored in favor of the respective fields set on {@link #generator}.
   */
  readonly trainArgs: KerasFitArgs;
  withTrainArgs(trainArgs: IKerasFitArgs): KerasPipeCpu;
   ...
   * {@link #processGenerator}.
   */
  readonly processArgs: KerasPredictArgs;
  withProcessArgs(processArgs: IKerasPredictArgs): KerasPipeCpu;

  /**
   * The keras model's history.
   */
  readonly history?: KerasPipe.KerasHistory | null;
  withHistory(history: IKerasPipe.KerasHistory | null): KerasPipeCpu;
  ...
  withDataType(dataType: string | null): KerasPipeCpu;
   ...
   * ```
   */
  readonly generator: KerasGenerator<DX, DY>;
  withGenerator(generator: IKerasGenerator<DX, DY>): KerasPipeCpu;
   ...
   * ```
   */
  readonly processGenerator?: KerasGenerator<DX, DY> | null;
  withProcessGenerator(processGenerator: IKerasGenerator<DX, DY> | null): KerasPipeCpu;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): KerasPipeCpu;

  /**
   * Name of this pipe.
   */
  readonly name?: string | null;
  withName(name: string | null): KerasPipeCpu;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): KerasPipeCpu;
  ...
  withVersion(version: number | null): KerasPipeCpu;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): KerasPipeCpu;
  ...
  withUserUpdatedFields(userUpdatedFields: C3.Array<string | null> | Array<string | null>): KerasPipeCpu;
  ...
  withHidden(hidden: boolean): KerasPipeCpu;
  ...
  withUserOwned(userOwned: boolean): KerasPipeCpu;
  ...
  withTypeIdent(typeIdent: string | null): KerasPipeCpu;

  /**
   * If true, then the pipe shall not be retrained
   */
  readonly frozen?: boolean;
  withFrozen(frozen: boolean): KerasPipeCpu;

  /**
   * True if training has succeeded and false otherwise.
   */
  readonly trained?: boolean;
  withTrained(trained: boolean): KerasPipeCpu;

  /**
   * Errors from training.
   */
  readonly trainingErrors?: string | null;
  withTrainingErrors(trainingErrors: string | null): KerasPipeCpu;

  /**
   * If true, the underlying model only accepts flattened input.
   */
  readonly flattenInput?: boolean;
  withFlattenInput(flattenInput: boolean): KerasPipeCpu;

  /**
   * The hyperparameters overridden of a native model or pipe.
   */
  readonly hyperparamOverrides?: C3.Map<string | null, any>;
  withHyperparamOverrides(hyperparamOverrides: C3.Map<string | null, any> | {[key: string | null]: any}): KerasPipeCpu;

  /**
   * A collection of {@link Hp.ParamSpace}s for the hyperparameters of this pipe. This search space will be used to
   * perform hyperparameter searches.
   */
  readonly hyperparamSearchSpace?: Hp.SearchSpace | null;
  withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): KerasPipeCpu;

  /**
   * Used to provide configuration for {@link #search}. Some configurations include how to validate results, which
   * search algorithms will be used, and limits on execution iterations.
   */
  readonly hpoSpec?: Hpo.Spec | null;
  withHpoSpec(hpoSpec: IHpo.Spec | null): KerasPipeCpu;

  /**
   * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
   */
  readonly hpoExperiment?: Hpo.Experiment | null;
  withHpoExperiment(hpoExperiment: IHpo.Experiment | null): KerasPipeCpu;

  /**
   * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
   */
  readonly experiment?: any;
  withExperiment(experiment: any): KerasPipeCpu;

  /**
   * Map of urls of saved model files
   * key - model file name, value - {@link Url} corresponding to model file name
   */
  readonly modelFiles?: C3.Map<string | null, Url | null>;
  withModelFiles(modelFiles: C3.Map<string | null, Url | null> | {[key: string | null]: IUrl | null}): KerasPipeCpu;

  /**
   * A map containing {Module Name: Compressed Source Code} key-value pairs. The module name is the name of the
   * module from where the source code was taken from. (i.e. numpy).
   */
  readonly customModelCode?: C3.Map<string | null, any | null>;
  withCustomModelCode(customModelCode: C3.Map<string | null, any | null> | {[key: string | null]: any | null}): KerasPipeCpu;

  /**
   * Name for the function on the native model to call to do {@link MlProcessable#process}.
   */
  readonly processFunc?: string | null;
  withProcessFunc(processFunc: string | null): KerasPipeCpu;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): KerasPipeCpu<DX, DY, DO> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): KerasPipeCpu<DX, DY, DO> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): KerasPipeCpu<DX, DY, DO> | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): KerasPipeCpu<DX, DY, DO> | null;
   ...
   */
  replaceType(old: Type, new_: Type): KerasPipeCpu<DX, DY, DO>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): KerasPipeCpu<DX, DY, DO>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): KerasPipeCpu<DX, DY, DO>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<KerasPipeCpu<DX, DY, DO> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<KerasPipeCpu<DX, DY, DO> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): KerasPipeCpu<DX, DY, DO>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): KerasPipeCpu<DX, DY, DO>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): KerasPipeCpu<DX, DY, DO>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): KerasPipeCpu<DX, DY, DO>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): KerasPipeCpu<DX, DY, DO>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): KerasPipeCpu<DX, DY, DO>;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): KerasPipeCpu<DX, DY, DO>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): KerasPipeCpu<DX, DY, DO>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): KerasPipeCpu<DX, DY, DO>;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): KerasPipeCpu<DX, DY, DO>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): KerasPipeCpu<DX, DY, DO>;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): KerasPipeCpu<DX, DY, DO>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): KerasPipeCpu<DX, DY, DO>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): KerasPipeCpu<DX, DY, DO>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): KerasPipeCpu<DX, DY, DO>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): KerasPipeCpu<DX, DY, DO>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): KerasPipeCpu<DX, DY, DO>;
   ...
   * @see #removeField
   */
  unsetField(field: string): KerasPipeCpu<DX, DY, DO>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): KerasPipeCpu<DX, DY, DO>;
   ...
   * @see #unsetField
   */
  removeField(field: string): KerasPipeCpu<DX, DY, DO>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): KerasPipeCpu<DX, DY, DO>;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): KerasPipeCpu<DX, DY, DO>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): KerasPipeCpu<DX, DY, DO>;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): KerasPipeCpu<DX, DY, DO>;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): KerasPipeCpu<DX, DY, DO>;

  mergeJson(json: any | null): KerasPipeCpu<DX, DY, DO>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): KerasPipeCpu<DX, DY, DO>;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): KerasPipeCpu<DX, DY, DO>;
   ...
   */
  singletonArray(): C3.Array<KerasPipeCpu<DX, DY, DO> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<KerasPipeCpu<DX, DY, DO> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<KerasPipeCpu<DX, DY, DO> | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<KerasPipeCpu<DX, DY, DO> | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<KerasPipeCpu<DX, DY, DO> | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, KerasPipeCpu<DX, DY, DO> | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, KerasPipeCpu<DX, DY, DO> | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<KerasPipeCpu<DX, DY, DO> | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<KerasPipeCpu<DX, DY, DO> | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): KerasPipeCpu<DX, DY, DO>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): KerasPipeCpu<DX, DY, DO>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): KerasPipeCpu<DX, DY, DO>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): KerasPipeCpu<DX, DY, DO>;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): KerasPipeCpu<DX, DY, DO>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): KerasPipeCpu<DX, DY, DO>;
   ...
   * @see #fromString
   */
  static make(s: string | null): KerasPipeCpu<DX, DY, DO> | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): KerasPipeCpu<DX, DY, DO>;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): KerasPipeCpu<DX, DY, DO>;
   ...
   */
  static cachedEmptyInst(): KerasPipeCpu<DX, DY, DO>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<KerasPipeCpu<DX, DY, DO>>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): KerasPipeCpu<DX, DY, DO>;

  /**
   * Create a {@link KerasHistory} using native keras history object.
   */
  static fromKerasHistory(history?: any): KerasPipe.KerasHistory | null;

  /**
   * @return an instance of a {@link KerasGenerator}.
   */
  createGenerator(batch_size?: number | null, prefetchFileCount?: number | null, shuffle?: boolean, dx_name?: string | null, dy_name?: string | null, nativeGenerator?: any): KerasGenerator<DX, DY>;
   ...
   */
  withoutIdentity(): KerasPipeCpu<DX, DY, DO>;
   ...
   */
  get deploymentHardwareConstraint(): HardwareConstraint | null;
   ...
   */
  train(x: DX | null, y?: DY | null, spec?: MlOperationSpec | null): MlOperationRun<any>;

  /**
   * Note: This function is dispatched to the runtime that {@link #doTrain} specifies.
   */
  trainSync(x: DX | null, y?: DY | null, spec?: MlOperationSpec | null): KerasPipeCpu<DX, DY, DO>;
   ...
   *           the operation run object to query status and to get the final result.
   */
  process(x: DX | null, spec?: MlOperationSpec | null): MlOperationRun<DO> | null;

  /**
   * Note: This function is dispatched to the runtime that {@link #doProcess} specifies.
   */
  processSync(x: DX | null, spec?: MlOperationSpec | null): DO | null;
   ...
   *           the operation run object to query status and to get the final result.
   */
  score(x: DX | null, y?: DY | null, context?:  | null, spec?: MlOperationSpec | null): MlOperationRun<C3.Map<string | null, number | null>> | null;

  /**
   * Blocking, synchronous version of {@link #score}.
   */
  scoreSync(x: DX | null, y?: DY | null, context?:  | null, spec?: MlOperationSpec | null): C3.Map<string | null, number | null>;
   ...
   *           the operation run object to query status and to get the final result.
   */
  scoreAll(x: DX | null, y?: DY | null, context?:  | null, spec?: MlOperationSpec | null): MlOperationRun<C3.Map<string | null, number | null>> | null;

  /**
   * Blocking, synchronous version of {@link #scoreAll}.
   */
  scoreAllSync(x: DX | null, y?: DY | null, context?:  | null, spec?: MlOperationSpec | null): C3.Map<string | null, number | null>;
   ...
   *           the operation run object to query status and to get the final result.
   */
  interpret(x: DX | null, spec?: MlOperationSpec | null): MlOperationRun< | null> | null;

  /**
   * Blocking, synchronous version of {@link #interpret}.
   */
  interpretSync(x: DX | null, context?: C3.Map<string | null, any>, spec?: MlOperationSpec | null): void;
   ...
   */
  standardizeInput(args?: C3.Array<any>, kwargs?: C3.Map<string | null, any>): C3.Map<string | null, any>;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<KerasPipeCpu<DX, DY, DO> | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<KerasPipeCpu<DX, DY, DO> | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<KerasPipeCpu<DX, DY, DO> | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): KerasPipeCpu<DX, DY, DO> | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string | null): KerasPipeCpu<DX, DY, DO> | null;
   ...
   * @see findByCacheKey
   */
  getCached(): KerasPipeCpu<DX, DY, DO> | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): KerasPipeCpu<DX, DY, DO> | null;
   ...
   */
  static produce(key: string): KerasPipeCpu<DX, DY, DO> | null;
   ...
   */
  static produceAll(): C3.Map<string | null, KerasPipeCpu<DX, DY, DO> | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, KerasPipeCpu<DX, DY, DO> | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<KerasPipeCpu<DX, DY, DO> | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<KerasPipeCpu<DX, DY, DO> | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<KerasPipeCpu<DX, DY, DO> | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<KerasPipeCpu<DX, DY, DO> | null> | null>;
   ...
   */
  get(include?: string | null): KerasPipeCpu<DX, DY, DO> | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): KerasPipeCpu<DX, DY, DO> | null;
   ...
   */
  getMissing(spec: GetMissingSpec): KerasPipeCpu<DX, DY, DO>;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): KerasPipeCpu<DX, DY, DO> | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): KerasPipeCpu<DX, DY, DO>;
   ...
   * @see #toString
   */
  static fromString(s: string | null): KerasPipeCpu<DX, DY, DO> | null;
   ...
   */
  create(spec?: UpsertSpec | null): KerasPipeCpu<DX, DY, DO> | null;
   ...
   */
  static createBatch(objs: C3.Array<KerasPipeCpu<DX, DY, DO> | null> | null, spec?: UpsertSpec | null): ObjList<KerasPipeCpu<DX, DY, DO> | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<KerasPipeCpu<DX, DY, DO> | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<KerasPipeCpu<DX, DY, DO> | null> | null;
   ...
   */
  update(srcObj?: KerasPipeCpu<DX, DY, DO> | null, spec?: UpsertSpec | null): KerasPipeCpu<DX, DY, DO> | null;
   ...
   */
  upsert(srcObj?: KerasPipeCpu<DX, DY, DO> | null, spec?: UpsertSpec | null): KerasPipeCpu<DX, DY, DO> | null;
   ...
   */
  merge(spec?: MergeSpec | null): KerasPipeCpu<DX, DY, DO> | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): KerasPipeCpu<DX, DY, DO> | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): KerasPipeCpu<DX, DY, DO> | null;
   ...
   */
  static updateBatch(objs: C3.Array<KerasPipeCpu<DX, DY, DO> | null> | null, srcObjs?: C3.Array<KerasPipeCpu<DX, DY, DO> | null>, spec?: UpsertSpec | null): ObjList<KerasPipeCpu<DX, DY, DO> | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<KerasPipeCpu<DX, DY, DO> | null>>, spec?: UpsertSpec | null): ObjList<KerasPipeCpu<DX, DY, DO> | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<KerasPipeCpu<DX, DY, DO> | null> | null, srcObjs?: C3.Array<KerasPipeCpu<DX, DY, DO> | null>, spec?: UpsertSpec | null): ObjList<KerasPipeCpu<DX, DY, DO> | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<KerasPipeCpu<DX, DY, DO> | null>>, spec?: UpsertSpec | null): ObjList<KerasPipeCpu<DX, DY, DO> | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<KerasPipeCpu<DX, DY, DO> | null> | null, spec?: TouchSpec | null): ObjList<KerasPipeCpu<DX, DY, DO> | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<KerasPipeCpu<DX, DY, DO> | null> | null, spec?: MergeSpec | null): ObjList<KerasPipeCpu<DX, DY, DO> | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<KerasPipeCpu<DX, DY, DO> | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<KerasPipeCpu<DX, DY, DO> | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<KerasPipeCpu<DX, DY, DO> | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<KerasPipeCpu<DX, DY, DO> | null> | null;
   ...
   */
  static mergeAll(mergeObj: KerasPipeCpu<DX, DY, DO> | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: KerasPipeCpu<DX, DY, DO> | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<KerasPipeCpu<DX, DY, DO> | null> | null, spec?: UpsertSpec | null): ObjList<KerasPipeCpu<DX, DY, DO> | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<KerasPipeCpu<DX, DY, DO> | null> | null, spec?: UpsertSpec | null): ObjList<KerasPipeCpu<DX, DY, DO> | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): KerasPipeCpu<DX, DY, DO> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<KerasPipeCpu<DX, DY, DO> | null> | null): ObjList<KerasPipeCpu<DX, DY, DO> | null>;
   ...
   */
  static beforeUpdate(objs: C3.Array<KerasPipeCpu<DX, DY, DO> | null> | null): ObjList<KerasPipeCpu<DX, DY, DO> | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<KerasPipeCpu<DX, DY, DO> | null> | null): ObjList<KerasPipeCpu<DX, DY, DO> | null>;
   ...
   */
  static afterCreate(objs: C3.Array<KerasPipeCpu<DX, DY, DO> | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<KerasPipeCpu<DX, DY, DO> | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<KerasPipeCpu<DX, DY, DO> | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<KerasPipeCpu<DX, DY, DO> | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<KerasPipeCpu<DX, DY, DO> | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): KerasPipeCpu<DX, DY, DO> | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<KerasPipeCpu<DX, DY, DO> | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: KerasPipeCpu<DX, DY, DO> | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<KerasPipeCpu<DX, DY, DO> | null> | null, callback?: λFunction<KerasPipeCpu<DX, DY, DO> | null, KerasPipeCpu<DX, DY, DO> | null> | null): ObjList<KerasPipeCpu<DX, DY, DO> | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<KerasPipeCpu<DX, DY, DO> | null> | null, callback?: λFunction<KerasPipeCpu<DX, DY, DO> | null, KerasPipeCpu<DX, DY, DO> | null> | null): C3.Array<ObjError | null>;
   ...
   */
  publish(subPath?: string | null, contentType?: string | null): KerasPipeCpu<DX, DY, DO>;
   ...
   */
  static removeSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<KerasPipeCpu<DX, DY, DO> | null> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec | null): KerasPipeCpu<DX, DY, DO> | null;
   ...
   */
  static createSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<KerasPipeCpu<DX, DY, DO> | null> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData | null, spec?: UpsertSpec | null): KerasPipeCpu<DX, DY, DO> | null;
   ...
   */
  static updateSeedDataBatch(objs?: C3.Array<SeedData | null>, srcObjs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<KerasPipeCpu<DX, DY, DO> | null> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec | null): KerasPipeCpu<DX, DY, DO> | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: C3.Array<SeedData | null>, spec?: MergeSpec | null): ObjList<KerasPipeCpu<DX, DY, DO> | null> | null;
  ...
  dependencies(): SeedDataDeps<KerasPipeCpu<DX, DY, DO> | null> | null;
   ...
   */
  get scoringMetrics(): C3.Map<string | null, MlScoringMetric<any, any, any> | null>;
   ...
   */
  newAuthoringVertex(x?: DX | null, y?: DY | null, context?:  | null, suffix?: string | null, spec?: MlConvertSpec | null): MlPipeline.PipeVertex.Authoring;
   ...
   */
  process_var(x?: any, spec?: MlConvertSpec | null): any;
   ...
   */
  score_var(x?: any, y?: any, context?: any, spec?: MlConvertSpec | null): any;
   ...
   * @return a single {@link MlVar} if single output or a map of {@link MlVar} if multi-output.
   */
  interpret_var(x?: any, spec?: MlConvertSpec | null): any;
   ...
   */
  hyperparams(hps?: string | null | C3.Array<string | null> | null): C3.Map<string | null, any>;
   ...
   */
  validateHyperparams(hps?: C3.Map<string | null, any>): void;
   ...
   */
  withHyperparams(newHps?: C3.Map<string | null, any>): MlPipe<any, any, any, any, any>;
   ...
   */
  hyperparamSpaces(hps?: string | null | C3.Array<string | null> | null): C3.Map<string | null, Hp.ParamSpace | null>;
   ...
   */
  static initializeLoggers(opNames: C3.Array<string | null>, spec?: MlOperationSpec | null): MlOperationSpec | null;

  /**
   * Returns the pipe with just the {@link MlPipe#id} field populated if the pipe has an id. Otherwise, the pipe will
   * be returned as-is.
   */
  byReference(): KerasPipeCpu<DX, DY, DO>;
   ...
   */
  beforeAndDoTrain(x: any, y?: any, model?: any, customCodePath?: string | null, spec?: MlOperationSpec | null): any;
   ...
   */
  updateModelFiles(modelFiles: C3.Map<string | null, Url | null> | null, spec?: MlOperationSpec | null): KerasPipeCpu<DX, DY, DO>;
   ...
   */
  beforeTrain(x: any, y?: any, model?: any, spec?: MlOperationSpec | null): any;
   ...
   * values.
   */
  doTrain(beforeTrainResults: any, spec?: MlOperationSpec | null): any;
   ...
   */
  afterTrain(doTrainOutputs: any, spec?: MlOperationSpec | null): KerasPipeCpu<DX, DY, DO>;

  /**
   * Blocking call to {@link #beforeProcess}, {@link #doProcess}, and {@link #afterProcess} in a single action.
   */
  beforeDoAfterProcess(x: any, model?: any, customCodePath?: string | null, spec?: MlOperationSpec | null): any;
   ...
   */
  beforeProcess(x: any, model?: any, spec?: MlOperationSpec | null): any;
   ...
   */
  doProcess(beforeProcessOutputs: any, spec?: MlOperationSpec | null): any;
   ...
   */
  afterProcess(doProcessOutputs: any, spec?: MlOperationSpec | null): any;
   ...
   */
  saveNativeModel(model?: any): C3.Map<string | null, Url | null> | null;
   ...
   */
  static bundleSourceCode(nativeObject?: any, additionalFiles?: C3.Array<string | null>): C3.Map<string | null, any | null>;
   ...
   */
  convertPipeInputsToNative(x: DX | null, y?: DY | null, spec?: MlOperationSpec | null): any;
   ...
   */
  convertXToNative(x: DX | null, spec?: MlOperationSpec | null): any;
   ...
   * @return converted data.
   */
  convertYToNative(y: DY | null, spec?: MlOperationSpec | null): any;
   ...
   * @return converted data.
   */
  convertInputToNativeFormat(input?: any, spec?: MlOperationSpec | null): any;
   ...
   */
  convertNativeToPipeOutputs(output: any, datasetId?: string | null): DO;
   ...
   */
  static convertNativeToData(out: any, datasetId?: string | null): any | Data | null | C3.Map<string | null, Data | null>;
   ...
   */
  withNewSpec(spec?: MlConvertSpec | null): KerasPipeCpu<DX, DY, DO>;
   ...
   */
  afterConvert(model: any, spec?: MlConvertSpec | null): KerasPipeCpu<DX, DY, DO>;
   ...
   */
  static validateInputOutputBindings(spec?: MlConvertSpec | null, expectedSpec?: MlConvertSpec | null): void;
   ...
   */
  validate(context?: C3.Map<string | null, any>): void;
   ...
   */
  static bindVars(xTypes?: C3.Map<string | null, ValueType | null> | null, yTypes?: C3.Map<string | null, ValueType | null> | null, outTypes?: C3.Map<string | null, ValueType | null> | null): MlPipe.Bindings;
   ...
   */
  static uploadPyNativeClass(name?: string | null, classSource?: any): Url;
   ...
   *           A native Python class.
   */
  static downloadPyNativeClass(nativeClassUrl?: Url | null, doNotCleanUp?: boolean): any;
   ...
   */
  nativeInputFormats(): C3.Array<string | null>;

  /**
   * Dataset id of the input.
   */
  static getInputDatasetId(x?: DX | null): string;
   ...
   */
  convertNativeToNative(x: any, y?: any, spec?: MlOperationSpec | null): any;
   ...
   * the {@link Workflow.MlPipeline.Rdce} optimization is applied.
   */
  convertXNativeToNative(x: any, spec?: MlOperationSpec | null): any;
   ...
   * the {@link Workflow.MlPipeline.Rdce} optimization is applied.
   */
  convertYNativeToNative(y: any, spec?: MlOperationSpec | null): any;
   ...
   */
  withHyperparamSpaces(paramSpaces: C3.Map<string | null, Hp.ParamSpace | null>): KerasPipeCpu<DX, DY, DO>;
   ...
   */
  get processSyncWorkflow(): Workflow;
