// TypeScript definitions for the C3 type KerberosConfig

/**
 * Type to provide system level configuration for Kerberos. There can only be single krb file/content.
 * This config will throw error if neither of krbFilePath or krbContent is set.
 *
 * @remarks this represents a value passed to a method that expects an instance of KerberosConfig
 */
declare interface IKerberosConfig {
  ...
  /**
   * File path to local krb5 configuration file. The file path should end with krb5.conf or krb5.ini.
   * e.g /etc/krb5.conf
   */
  krbFilePath?: string | null;

  /**
   * This will be ignored if krbFilePath is set.
   * The Kerberos configuration content for realms and hostnames.
   * Content can be provided as plain text string, and use "\\n" for line breakers.
   */
  krbContent?: string | null;

  keytabRootDir?: string | null;

  krbConfigsDir?: string | null;
}
 ...
 * This config will throw error if neither of krbFilePath or krbContent is set.
 *
 * @remarks this represents a made instance of KerberosConfig
 */
declare class KerberosConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): KerberosConfig;

  static readonly configOverride?: string | null;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): KerberosConfig;
  ...
  withIssues(issues: C3.Array<string | null> | Array<string | null>): KerberosConfig;
   ...
   * e.g /etc/krb5.conf
   */
  readonly krbFilePath?: string | null;
  withKrbFilePath(krbFilePath: string | null): KerberosConfig;

  /**
   * File path to local krb5 configuration file. The file path should end with krb5.conf or krb5.ini.
   * e.g /etc/krb5.conf
   */
  static readonly krbFilePath?: string | null;
   ...
   * Content can be provided as plain text string, and use "\\n" for line breakers.
   */
  readonly krbContent?: string | null;
  withKrbContent(krbContent: string | null): KerberosConfig;
   ...
   * Content can be provided as plain text string, and use "\\n" for line breakers.
   */
  static readonly krbContent?: string | null;

  readonly keytabRootDir?: string | null;
  withKeytabRootDir(keytabRootDir: string | null): KerberosConfig;

  static readonly keytabRootDir?: string | null;

  readonly krbConfigsDir?: string | null;
  withKrbConfigsDir(krbConfigsDir: string | null): KerberosConfig;

  static readonly krbConfigsDir?: string | null;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): KerberosConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): KerberosConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): KerberosConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): KerberosConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): KerberosConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): KerberosConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): KerberosConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): KerberosConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): KerberosConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): KerberosConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<KerberosConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<KerberosConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<KerberosConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<KerberosConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): KerberosConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): KerberosConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): KerberosConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): KerberosConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): KerberosConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): KerberosConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): KerberosConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): KerberosConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): KerberosConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): KerberosConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): KerberosConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): KerberosConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): KerberosConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): KerberosConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): KerberosConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): KerberosConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): KerberosConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): KerberosConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): KerberosConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): KerberosConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): KerberosConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): KerberosConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): KerberosConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): KerberosConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): KerberosConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): KerberosConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): KerberosConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): KerberosConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): KerberosConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): KerberosConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): KerberosConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): KerberosConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): KerberosConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): KerberosConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): KerberosConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): KerberosConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): KerberosConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): KerberosConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): KerberosConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): KerberosConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): KerberosConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): KerberosConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): KerberosConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): KerberosConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): KerberosConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): KerberosConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): KerberosConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): KerberosConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): KerberosConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): KerberosConfig;

  mergeJson(json: any | null): KerberosConfig;

  static mergeJson(json: any | null): KerberosConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): KerberosConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): KerberosConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): KerberosConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): KerberosConfig;
   ...
   */
  singletonArray(): C3.Array<KerberosConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<KerberosConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<KerberosConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<KerberosConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<KerberosConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<KerberosConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<KerberosConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, KerberosConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, KerberosConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<KerberosConfig | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<KerberosConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<KerberosConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): KerberosConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): KerberosConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): KerberosConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): KerberosConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): KerberosConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): KerberosConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): KerberosConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): KerberosConfig;
   ...
   */
  static cachedEmptyInst(): KerberosConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<KerberosConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): KerberosConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<KerberosConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<KerberosConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<KerberosConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): KerberosConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): KerberosConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): KerberosConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): KerberosConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): KerberosConfig | null;
   ...
   */
  static produce(key: string): KerberosConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, KerberosConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, KerberosConfig | null>;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): KerberosConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): KerberosConfig;
   ...
   */
  static forConfigKey(configKey: string | null): KerberosConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<KerberosConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: KerberosConfig, override?: string | null): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: KerberosConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: KerberosConfig, override?: string | null): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: KerberosConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): KerberosConfig | null;
   ...
   */
  removeSecrets(): KerberosConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): KerberosConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): KerberosConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): KerberosConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): KerberosConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): KerberosConfig;
   ...
   */
  static inst(): KerberosConfig;

  /**
   * @return the cached instance if already cached, null otherwise. Does not instantiate if missing.
   */
  static cachedInst(): KerberosConfig | null;

  /**
   * This will set System property 'java.security.krb5.conf' to krb5.conf.
   * Use {@link KerberosConfig.krbFilePath} or  write {@link KerberosConfig.krbContent}
   * to default krb config file and use that file path to update System property for krb config file.
   *
   *  This will also reload krb5.conf if file contents of file `krbFilePath` are modified.
   * Check to see if the file is modified will be done if the last check was done more than 120 sec. ago.
   */
  static refreshKrbConf(force?: boolean): void;

  /**
   * remove System property 'java.security.krb5.conf' for krb config file, if previously set.
   */
  static clearKrbConf(): void;
}
