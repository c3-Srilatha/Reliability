// TypeScript definitions for the C3 type DataConnectorSharedFileStorageCredential

/**
 * Credential for the shared file storage service.
 *
 * @remarks this represents a value passed to a method that expects an instance of DataConnectorSharedFileStorageCredential
 */
declare interface IDataConnectorSharedFileStorageCredential {

  /**
   * Id of credential. For JdbcCredentials, it will be set based on {@link JdbcStoreConfig.name}. For CloudCredentials,
   * it will be set based on {@link CloudResource.resourceName}
   */
  id?: string | null;

  /**
   * Server address of credential. It will be set based on {@link JdbcCredentials.serverEndpoint} or {@link
   * CloudCredentials.endpoint}
   */
  serverEndpoint?: string | null;

  /**
   *  Display name of credential. It will be set based on displayName property on {@link JdbcStoreConfig.description} or
   * {@link CloudResource.description}.
   */
  displayName?: string | null;

  /**
   * Cloud service native secret Key. This field is available for both  {@link JdbcCredentials} type and {@link
   * CloudCrednetials} type.
   */
  secretKey?: string | null;

  /**
   * The data store type, including both JdbcStore types and FileSystem types.
   */
  datastore?: string | null;

  /**
   * Custom description of the credential.
   */
  description?: string | null;

  /**
   * The file path prefix to the directory storing the shared files.
   * For Azure Data Lake, file path starts with the container name, i.e., `<container-name>/path/to/dir`
   * For AWS S3, file path starts with the bucket name, i.e., `<bucket-name>/path/to/dir
   */
  ...
  /**
   * User name of credential. It will be set based on {@link JdbcCredentials.username}. This field is only set for
   * {@link JdbcCredentials} type.
   */
  username?: string | null;

  /**
   * A hashed password of credential. This field is only set for {@link JdbcCredentials} type.
   */
 ...
 * Credential for the shared file storage service.
 *
 * @remarks this represents a made instance of DataConnectorSharedFileStorageCredential
 */
declare class DataConnectorSharedFileStorageCredential extends Obj {
  ...
  withId(id: string | null): DataConnectorSharedFileStorageCredential;
   ...
   * CloudCredentials.endpoint}
   */
  readonly serverEndpoint?: string | null;
  withServerEndpoint(serverEndpoint: string | null): DataConnectorSharedFileStorageCredential;

  /**
   * Server address of credential. It will be set based on {@link JdbcCredentials.serverEndpoint} or {@link
   * CloudCredentials.endpoint}
   */
  static readonly serverEndpoint?: string | null;
  ...
  withDisplayName(displayName: string | null): DataConnectorSharedFileStorageCredential;

  /**
   *  Display name of credential. It will be set based on displayName property on {@link JdbcStoreConfig.description} or
   * {@link CloudResource.description}.
   */
  static readonly displayName?: string | null;
  ...
  withSecretKey(secretKey: string | null): DataConnectorSharedFileStorageCredential;

  /**
   * Cloud service native secret Key. This field is available for both  {@link JdbcCredentials} type and {@link
   * CloudCrednetials} type.
   */
  static readonly secretKey?: string | null;

  /**
   * The data store type, including both JdbcStore types and FileSystem types.
   */
  readonly datastore?: string | null;
  withDatastore(datastore: string | null): DataConnectorSharedFileStorageCredential;

  /**
   * The data store type, including both JdbcStore types and FileSystem types.
   */
  static readonly datastore?: string | null;

  /**
   * Custom description of the credential.
   */
  readonly description?: string | null;
  withDescription(description: string | null): DataConnectorSharedFileStorageCredential;

  /**
   * Custom description of the credential.
   */
  static readonly description?: string | null;
  ...
  withFilePathPrefix(filePathPrefix: string): DataConnectorSharedFileStorageCredential;
   ...
   * For AWS S3, file path starts with the bucket name, i.e., `<bucket-name>/path/to/dir
   */
  static readonly filePathPrefix: string;

  /**
   * Cloud service native Access Key.
   */
  readonly accessKey?: string | null;
  withAccessKey(accessKey: string | null): DataConnectorSharedFileStorageCredential;

  /**
   * Cloud service native Access Key.
   */
  static readonly accessKey?: string | null;

  /**
   * Cloud account / subscription id.
   */
  readonly accountId?: string | null;
  withAccountId(accountId: string | null): DataConnectorSharedFileStorageCredential;

  /**
   * Cloud account / subscription id.
   */
  static readonly accountId?: string | null;
  ...
  withCloudIdentity(cloudIdentity: string | null): DataConnectorSharedFileStorageCredential;

  /**
   * Cloud service native identity for managing access to Cloud Resources. It is typically associated with compute
   * instance.
   */
  static readonly cloudIdentity?: string | null;

  /**
   * Cloud region for the credentials.
   */
  readonly region?: string | null;
  withRegion(region: string | null): DataConnectorSharedFileStorageCredential;

  /**
   * Cloud region for the credentials.
   */
  static readonly region?: string | null;
  ...
  withUsername(username: string | null): DataConnectorSharedFileStorageCredential;

  /**
   * User name of credential. It will be set based on {@link JdbcCredentials.username}. This field is only set for
   * {@link JdbcCredentials} type.
   */
  static readonly username?: string | null;

  /**
   * A hashed password of credential. This field is only set for {@link JdbcCredentials} type.
   */
  readonly password?: string | null;
  withPassword(password: string | null): DataConnectorSharedFileStorageCredential;

  /**
   * A hashed password of credential. This field is only set for {@link JdbcCredentials} type.
   */
  static readonly password?: string | null;

  readonly content?: any | null;
  withContent(content: any | null): DataConnectorSharedFileStorageCredential;

  static readonly content?: any | null;

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): DataConnectorSharedFileStorageCredential;

  static readonly configOverride?: string | null;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): DataConnectorSharedFileStorageCredential;
  ...
  withIssues(issues: C3.Array<string | null> | Array<string | null>): DataConnectorSharedFileStorageCredential;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): DataConnectorSharedFileStorageCredential | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): DataConnectorSharedFileStorageCredential | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): DataConnectorSharedFileStorageCredential | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): DataConnectorSharedFileStorageCredential | null;
   ...
   */
  replaceType(old: Type, new_: Type): DataConnectorSharedFileStorageCredential;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): DataConnectorSharedFileStorageCredential;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataConnectorSharedFileStorageCredential;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataConnectorSharedFileStorageCredential;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataConnectorSharedFileStorageCredential;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataConnectorSharedFileStorageCredential;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataConnectorSharedFileStorageCredential | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataConnectorSharedFileStorageCredential | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataConnectorSharedFileStorageCredential | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataConnectorSharedFileStorageCredential | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataConnectorSharedFileStorageCredential;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataConnectorSharedFileStorageCredential;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataConnectorSharedFileStorageCredential;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataConnectorSharedFileStorageCredential;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataConnectorSharedFileStorageCredential;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataConnectorSharedFileStorageCredential;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DataConnectorSharedFileStorageCredential;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): DataConnectorSharedFileStorageCredential;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DataConnectorSharedFileStorageCredential;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): DataConnectorSharedFileStorageCredential;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DataConnectorSharedFileStorageCredential;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): DataConnectorSharedFileStorageCredential;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataConnectorSharedFileStorageCredential;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataConnectorSharedFileStorageCredential;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataConnectorSharedFileStorageCredential;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataConnectorSharedFileStorageCredential;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DataConnectorSharedFileStorageCredential;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): DataConnectorSharedFileStorageCredential;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): DataConnectorSharedFileStorageCredential;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): DataConnectorSharedFileStorageCredential;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): DataConnectorSharedFileStorageCredential;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): DataConnectorSharedFileStorageCredential;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): DataConnectorSharedFileStorageCredential;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): DataConnectorSharedFileStorageCredential;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataConnectorSharedFileStorageCredential;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataConnectorSharedFileStorageCredential;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DataConnectorSharedFileStorageCredential;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): DataConnectorSharedFileStorageCredential;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataConnectorSharedFileStorageCredential;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataConnectorSharedFileStorageCredential;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DataConnectorSharedFileStorageCredential;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): DataConnectorSharedFileStorageCredential;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DataConnectorSharedFileStorageCredential;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): DataConnectorSharedFileStorageCredential;
   ...
   * @see #removeField
   */
  unsetField(field: string): DataConnectorSharedFileStorageCredential;
   ...
   * @see #removeField
   */
  static unsetField(field: string): DataConnectorSharedFileStorageCredential;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DataConnectorSharedFileStorageCredential;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): DataConnectorSharedFileStorageCredential;
   ...
   * @see #unsetField
   */
  removeField(field: string): DataConnectorSharedFileStorageCredential;
   ...
   * @see #unsetField
   */
  static removeField(field: string): DataConnectorSharedFileStorageCredential;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DataConnectorSharedFileStorageCredential;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): DataConnectorSharedFileStorageCredential;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataConnectorSharedFileStorageCredential;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataConnectorSharedFileStorageCredential;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): DataConnectorSharedFileStorageCredential;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): DataConnectorSharedFileStorageCredential;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataConnectorSharedFileStorageCredential;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataConnectorSharedFileStorageCredential;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataConnectorSharedFileStorageCredential;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataConnectorSharedFileStorageCredential;

  mergeJson(json: any | null): DataConnectorSharedFileStorageCredential;

  static mergeJson(json: any | null): DataConnectorSharedFileStorageCredential;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataConnectorSharedFileStorageCredential;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataConnectorSharedFileStorageCredential;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): DataConnectorSharedFileStorageCredential;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): DataConnectorSharedFileStorageCredential;
   ...
   */
  singletonArray(): C3.Array<DataConnectorSharedFileStorageCredential | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<DataConnectorSharedFileStorageCredential | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<DataConnectorSharedFileStorageCredential | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DataConnectorSharedFileStorageCredential | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<DataConnectorSharedFileStorageCredential | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<DataConnectorSharedFileStorageCredential | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DataConnectorSharedFileStorageCredential | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, DataConnectorSharedFileStorageCredential | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataConnectorSharedFileStorageCredential | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DataConnectorSharedFileStorageCredential | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<DataConnectorSharedFileStorageCredential | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DataConnectorSharedFileStorageCredential | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DataConnectorSharedFileStorageCredential;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DataConnectorSharedFileStorageCredential;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DataConnectorSharedFileStorageCredential;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DataConnectorSharedFileStorageCredential;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DataConnectorSharedFileStorageCredential;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DataConnectorSharedFileStorageCredential;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DataConnectorSharedFileStorageCredential;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): DataConnectorSharedFileStorageCredential;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): DataConnectorSharedFileStorageCredential;
   ...
   */
  static cachedEmptyInst(): DataConnectorSharedFileStorageCredential;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DataConnectorSharedFileStorageCredential>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): DataConnectorSharedFileStorageCredential;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<DataConnectorSharedFileStorageCredential | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<DataConnectorSharedFileStorageCredential | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<DataConnectorSharedFileStorageCredential | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): DataConnectorSharedFileStorageCredential | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): DataConnectorSharedFileStorageCredential | null;
   ...
   * @see findByCacheKey
   */
  getCached(): DataConnectorSharedFileStorageCredential | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): DataConnectorSharedFileStorageCredential | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): DataConnectorSharedFileStorageCredential | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): DataConnectorSharedFileStorageCredential | null;
   ...
   */
  static produce(key: string): DataConnectorSharedFileStorageCredential | null;
   ...
   */
  static produceAll(): C3.Map<string | null, DataConnectorSharedFileStorageCredential | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, DataConnectorSharedFileStorageCredential | null>;
   ...
   */
  getConfig(): DataConnectorSharedFileStorageCredential;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): DataConnectorSharedFileStorageCredential;
   ...
   */
  getSecret(): DataConnectorSharedFileStorageCredential;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): DataConnectorSharedFileStorageCredential;
   ...
   */
  static forConfigKey(configKey: string | null): DataConnectorSharedFileStorageCredential | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<DataConnectorSharedFileStorageCredential | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: DataConnectorSharedFileStorageCredential, override?: string | null): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: DataConnectorSharedFileStorageCredential, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: DataConnectorSharedFileStorageCredential, override?: string | null): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: DataConnectorSharedFileStorageCredential, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): DataConnectorSharedFileStorageCredential | null;
   ...
   */
  removeSecrets(): DataConnectorSharedFileStorageCredential | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): DataConnectorSharedFileStorageCredential | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): DataConnectorSharedFileStorageCredential | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): DataConnectorSharedFileStorageCredential | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): DataConnectorSharedFileStorageCredential;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): DataConnectorSharedFileStorageCredential;
   ...
   */
  static inst(): DataConnectorSharedFileStorageCredential;

  /**
   * @return the cached instance if already cached, null otherwise. Does not instantiate if missing.
   */
  static cachedInst(): DataConnectorSharedFileStorageCredential | null;
}
