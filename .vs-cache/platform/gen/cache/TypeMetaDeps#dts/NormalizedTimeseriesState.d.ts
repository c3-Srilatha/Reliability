// TypeScript definitions for the C3 type NormalizedTimeseriesState

/**
 * Corresponding to every NormalizedTimeseries object there is a NormalizedTimeseriesState object that gets created.
 * This object gives us information about whether the given timeseries is valid and consumable.
 * Normalization engine relies on this type to figure out if it has to re-normalize the timeseries
 * One object per header-field combination exists for this type
 *
 * @remarks this represents a value passed to a method that expects an instance of NormalizedTimeseriesState
 */
declare interface INormalizedTimeseriesState {
  ...
  /**
   * Any errors occurring during the normalization are stored here. When this timeseries is read, if there exists
   * an error then the error will be thrown to the user
   */
  error?: string | null;

  /**
   * Schema version decides whether the structure of the timeseries are compatible with each other.
   * If the normalization engine expects a different version number, it forces re-normalization
   */
  schemaVersion?: number | null;

  /**
   * Stores the `treatment` used to normalize this timeseries. This information is required during
   * aggregation / disaggregation when the timeseries is being read
   */
  treatment?: string | null;

  /**
   * Stores the unit associated with this timeseries
   */
  unitId?: string | null;

  /**
   * buckets for the existing normalized timeseries
   */
  buckets?: C3.Array<NormalizedTimeseriesBucket | null> | Array<INormalizedTimeseriesBucket | null>;

  /**
   * Last updated time
   */
  lastUpdated?: DateTime | Date | string | null;

  /**
   * Config state when this row was written
   */
  partitionStrategy?: INormalizationPartitionStrategy | null;
}
 ...
 * One object per header-field combination exists for this type
 *
 * @remarks this represents a made instance of NormalizedTimeseriesState
 */
declare class NormalizedTimeseriesState extends Obj {

  /**
   * Id : typeId(rawDataPointType).parentId.pathId(tsField)
   */
  readonly id: string;
  withId(id: string): NormalizedTimeseriesState;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): NormalizedTimeseriesState;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): NormalizedTimeseriesState;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): NormalizedTimeseriesState;
  ...
  withVersion(version: number | null): NormalizedTimeseriesState;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): NormalizedTimeseriesState;
  ...
  withError(error: string | null): NormalizedTimeseriesState;
  ...
  withSchemaVersion(schemaVersion: number | null): NormalizedTimeseriesState;
  ...
  withTreatment(treatment: string | null): NormalizedTimeseriesState;

  /**
   * Stores the unit associated with this timeseries
   */
  readonly unitId?: string | null;
  withUnitId(unitId: string | null): NormalizedTimeseriesState;

  /**
   * buckets for the existing normalized timeseries
   */
  readonly buckets?: C3.Array<NormalizedTimeseriesBucket | null>;
  withBuckets(buckets: C3.Array<NormalizedTimeseriesBucket | null> | Array<INormalizedTimeseriesBucket | null>): NormalizedTimeseriesState;

  /**
   * Last updated time
   */
  readonly lastUpdated?: DateTime | null;
  withLastUpdated(lastUpdated: DateTime | Date | string | null): NormalizedTimeseriesState;

  /**
   * Config state when this row was written
   */
  readonly partitionStrategy?: NormalizationPartitionStrategy | null;
  withPartitionStrategy(partitionStrategy: INormalizationPartitionStrategy | null): NormalizedTimeseriesState;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): NormalizedTimeseriesState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): NormalizedTimeseriesState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): NormalizedTimeseriesState | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): NormalizedTimeseriesState | null;
   ...
   */
  replaceType(old: Type, new_: Type): NormalizedTimeseriesState;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NormalizedTimeseriesState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NormalizedTimeseriesState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NormalizedTimeseriesState | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NormalizedTimeseriesState | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): NormalizedTimeseriesState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NormalizedTimeseriesState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NormalizedTimeseriesState;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): NormalizedTimeseriesState;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): NormalizedTimeseriesState;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): NormalizedTimeseriesState;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): NormalizedTimeseriesState;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): NormalizedTimeseriesState;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): NormalizedTimeseriesState;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): NormalizedTimeseriesState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): NormalizedTimeseriesState;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): NormalizedTimeseriesState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): NormalizedTimeseriesState;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): NormalizedTimeseriesState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): NormalizedTimeseriesState;
   ...
   * @see #unsetField
   */
  defaultField(field: string): NormalizedTimeseriesState;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): NormalizedTimeseriesState;
   ...
   * @see #removeField
   */
  unsetField(field: string): NormalizedTimeseriesState;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): NormalizedTimeseriesState;
   ...
   * @see #unsetField
   */
  removeField(field: string): NormalizedTimeseriesState;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): NormalizedTimeseriesState;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): NormalizedTimeseriesState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): NormalizedTimeseriesState;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): NormalizedTimeseriesState;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): NormalizedTimeseriesState;

  mergeJson(json: any | null): NormalizedTimeseriesState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): NormalizedTimeseriesState;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): NormalizedTimeseriesState;
   ...
   */
  singletonArray(): C3.Array<NormalizedTimeseriesState | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<NormalizedTimeseriesState | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<NormalizedTimeseriesState | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<NormalizedTimeseriesState | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<NormalizedTimeseriesState | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, NormalizedTimeseriesState | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, NormalizedTimeseriesState | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<NormalizedTimeseriesState | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<NormalizedTimeseriesState | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): NormalizedTimeseriesState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): NormalizedTimeseriesState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): NormalizedTimeseriesState;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): NormalizedTimeseriesState;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): NormalizedTimeseriesState;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): NormalizedTimeseriesState;
   ...
   * @see #fromString
   */
  static make(s: string | null): NormalizedTimeseriesState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): NormalizedTimeseriesState;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): NormalizedTimeseriesState;
   ...
   */
  static cachedEmptyInst(): NormalizedTimeseriesState;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<NormalizedTimeseriesState>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): NormalizedTimeseriesState;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<NormalizedTimeseriesState | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<NormalizedTimeseriesState | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<NormalizedTimeseriesState | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<NormalizedTimeseriesState | null> | null>;
   ...
   */
  get(include?: string | null): NormalizedTimeseriesState | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): NormalizedTimeseriesState | null;
   ...
   */
  getMissing(spec: GetMissingSpec): NormalizedTimeseriesState;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): NormalizedTimeseriesState | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): NormalizedTimeseriesState;
   ...
   * @see #toString
   */
  static fromString(s: string | null): NormalizedTimeseriesState | null;
   ...
   */
  create(spec?: UpsertSpec | null): NormalizedTimeseriesState | null;
   ...
   */
  static createBatch(objs: C3.Array<NormalizedTimeseriesState | null> | null, spec?: UpsertSpec | null): ObjList<NormalizedTimeseriesState | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<NormalizedTimeseriesState | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<NormalizedTimeseriesState | null> | null;
   ...
   */
  update(srcObj?: NormalizedTimeseriesState | null, spec?: UpsertSpec | null): NormalizedTimeseriesState | null;
   ...
   */
  upsert(srcObj?: NormalizedTimeseriesState | null, spec?: UpsertSpec | null): NormalizedTimeseriesState | null;
   ...
   */
  merge(spec?: MergeSpec | null): NormalizedTimeseriesState | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): NormalizedTimeseriesState | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): NormalizedTimeseriesState | null;
   ...
   */
  static updateBatch(objs: C3.Array<NormalizedTimeseriesState | null> | null, srcObjs?: C3.Array<NormalizedTimeseriesState | null>, spec?: UpsertSpec | null): ObjList<NormalizedTimeseriesState | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<NormalizedTimeseriesState | null>>, spec?: UpsertSpec | null): ObjList<NormalizedTimeseriesState | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<NormalizedTimeseriesState | null> | null, srcObjs?: C3.Array<NormalizedTimeseriesState | null>, spec?: UpsertSpec | null): ObjList<NormalizedTimeseriesState | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<NormalizedTimeseriesState | null>>, spec?: UpsertSpec | null): ObjList<NormalizedTimeseriesState | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<NormalizedTimeseriesState | null> | null, spec?: TouchSpec | null): ObjList<NormalizedTimeseriesState | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<NormalizedTimeseriesState | null> | null, spec?: MergeSpec | null): ObjList<NormalizedTimeseriesState | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<NormalizedTimeseriesState | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<NormalizedTimeseriesState | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<NormalizedTimeseriesState | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<NormalizedTimeseriesState | null> | null;
   ...
   */
  static mergeAll(mergeObj: NormalizedTimeseriesState | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: NormalizedTimeseriesState | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<NormalizedTimeseriesState | null> | null, spec?: UpsertSpec | null): ObjList<NormalizedTimeseriesState | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<NormalizedTimeseriesState | null> | null, spec?: UpsertSpec | null): ObjList<NormalizedTimeseriesState | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): NormalizedTimeseriesState | null;
   ...
   */
  static beforeCreate(objs: C3.Array<NormalizedTimeseriesState | null> | null): ObjList<NormalizedTimeseriesState | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<NormalizedTimeseriesState | null> | null): ObjList<NormalizedTimeseriesState | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<NormalizedTimeseriesState | null> | null): ObjList<NormalizedTimeseriesState | null>;
   ...
   */
  static afterCreate(objs: C3.Array<NormalizedTimeseriesState | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<NormalizedTimeseriesState | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<NormalizedTimeseriesState | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<NormalizedTimeseriesState | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<NormalizedTimeseriesState | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): NormalizedTimeseriesState | null;
   ...
   */
  withoutIdentity(): NormalizedTimeseriesState | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<NormalizedTimeseriesState | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: NormalizedTimeseriesState | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<NormalizedTimeseriesState | null> | null, callback?: λFunction<NormalizedTimeseriesState | null, NormalizedTimeseriesState | null> | null): ObjList<NormalizedTimeseriesState | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<NormalizedTimeseriesState | null> | null, callback?: λFunction<NormalizedTimeseriesState | null, NormalizedTimeseriesState | null> | null): C3.Array<ObjError | null>;
