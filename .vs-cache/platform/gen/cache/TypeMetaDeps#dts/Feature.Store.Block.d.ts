// TypeScript definitions for the C3 type Feature.Store.Block

/**
 * Meta information about the Storage Block which will be used to referred to first before read and write to
 * Feature.Store.
 *
 * @remarks this represents a value passed to a method that expects an instance of Feature.Store.Block
 */
...
declare namespace Feature.Store {
  export class Block extends Obj {
    ...
    withContentEncoding(contentEncoding: string | null): Feature.Store.Block;
    ...
    withContentLanguage(contentLanguage: string | null): Feature.Store.Block;
    ...
    withContentLength(contentLength: number | null): Feature.Store.Block;
    ...
    withContentLocation(contentLocation: string | null): Feature.Store.Block;
    ...
    withContentType(contentType: string | null): Feature.Store.Block;
    ...
    withContentDisposition(contentDisposition: string | null): Feature.Store.Block;
    ...
    withETag(eTag: string | null): Feature.Store.Block;
    ...
    withLastModified(lastModified: DateTime | Date | string | null): Feature.Store.Block;

    /**
     * Id of user / identity who last last modified this content.
     */
    readonly lastModifiedBy?: string | null;
    withLastModifiedBy(lastModifiedBy: string | null): Feature.Store.Block;
    ...
    withContentMD5(contentMD5: string | null): Feature.Store.Block;
    ...
    withContentSHA1(contentSHA1: string | null): Feature.Store.Block;

    /**
     * Field to maintain state whether content metadata was read or not.
     */
    readonly hasMetadata?: boolean;
    withHasMetadata(hasMetadata: boolean): Feature.Store.Block;
     ...
     */
    readonly id: string;
    withId(id: string): Feature.Store.Block;
    ...
    withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Feature.Store.Block;

    /**
     * Name of the Obj instance
     */
    readonly name?: string | null;
    withName(name: string | null): Feature.Store.Block;

    /**
     * Various system fields.
     */
    readonly meta?: Meta | null;
    withMeta(meta: IMeta | null): Feature.Store.Block;
    ...
    withVersion(version: number | null): Feature.Store.Block;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type | null;
    withTypeWithBindings(typeWithBindings: IType | null): Feature.Store.Block;

    /**
     * @return a filter string for fetching **Feature.Store.Blocks** which are marked to be deleted.
     */
    readonly DELETE_FILTER?: string | null;
    withDELETE_FILTER(DELETE_FILTER: string | null): Feature.Store.Block;
     ...
     */
    readonly bin: number;
    withBin(bin: number): Feature.Store.Block;

    /**
     * id of the {@link FeatureEvaluatable.Bin.Strategy} associated with the current block. This will determine the possible values of {@link #bin}.
     */
    readonly strategyId: string;
    withStrategyId(strategyId: string): Feature.Store.Block;

    /**
     * Foreign key reference to the strategy instance associated to the current instance.
     */
    readonly strategy?: FeatureEvaluatable.Bin.Strategy | null;
    withStrategy(strategy: IFeatureEvaluatable.Bin.Strategy | null): Feature.Store.Block;

    /**
     * Fingerprint of either the Feature or Feature.Set which was used to create the data for the Storage block.
     */
    readonly featureFingerprint: string;
    withFeatureFingerprint(featureFingerprint: string): Feature.Store.Block;
    ...
    withStart(start: DateTime | Date | string | null): Feature.Store.Block;
    ...
    withEnd(end: DateTime | Date | string | null): Feature.Store.Block;
    ...
    withRowCount(rowCount: number): Feature.Store.Block;

    /**
     * In-memory size of the block as data may be stored compressed in the underlying store.
     */
    readonly inMemorySize: number;
    withInMemorySize(inMemorySize: number): Feature.Store.Block;

    /**
     * Binary serialized subjectId hashes array of all subjectIds present into the block. It will be used during **evalFeature*** to further filter out the blocks which doesn't need to be read. This will improve both CPU and Memory profile of the **eval** call.
     */
    readonly subjectIdHashesBinary: any;
    withSubjectIdHashesBinary(subjectIdHashesBinary: any): Feature.Store.Block;

    /**
     * Binary serialized array of rowCount for all subjectIds present into the block. It will be used during pagination (and other features) to efficiently deliver the results.
     */
    readonly subjectRowCountBinary: any;
    withSubjectRowCountBinary(subjectRowCountBinary: any): Feature.Store.Block;

    /**
     * If set to any value, either **true** or **false**, a block is "marked to be deleted". No data will be read from blocks effective immediately and will be cleaned up **eventually** by the platform.
     */
    readonly toDelete?: boolean;
    withToDelete(toDelete: boolean): Feature.Store.Block;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Feature.Store.Block | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Feature.Store.Block | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Feature.Store.Block | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Feature.Store.Block | null;
     ...
     */
    replaceType(old: Type, new_: Type): Feature.Store.Block;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Feature.Store.Block;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Feature.Store.Block;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Feature.Store.Block | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Feature.Store.Block | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Feature.Store.Block;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Feature.Store.Block;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Feature.Store.Block;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Feature.Store.Block;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Feature.Store.Block;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Feature.Store.Block;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Feature.Store.Block;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Feature.Store.Block;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Feature.Store.Block;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Feature.Store.Block;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Feature.Store.Block;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Feature.Store.Block;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Feature.Store.Block;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Feature.Store.Block;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Feature.Store.Block;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Feature.Store.Block;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Feature.Store.Block;
     ...
     * @see #removeField
     */
    unsetField(field: string): Feature.Store.Block;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Feature.Store.Block;
     ...
     * @see #unsetField
     */
    removeField(field: string): Feature.Store.Block;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Feature.Store.Block;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Feature.Store.Block;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Feature.Store.Block;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Feature.Store.Block;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Feature.Store.Block;

    mergeJson(json: any | null): Feature.Store.Block;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Feature.Store.Block;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Feature.Store.Block;
     ...
     */
    singletonArray(): C3.Array<Feature.Store.Block | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Feature.Store.Block | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Feature.Store.Block | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Feature.Store.Block | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Feature.Store.Block | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Feature.Store.Block | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Feature.Store.Block | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Feature.Store.Block | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Feature.Store.Block | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Feature.Store.Block;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Feature.Store.Block;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Feature.Store.Block;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Feature.Store.Block;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Feature.Store.Block;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Feature.Store.Block;
     ...
     * @see #fromString
     */
    static make(s: string | null): Feature.Store.Block | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Feature.Store.Block;
     ...
     */
    static cachedEmptyInst(): Feature.Store.Block;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Feature.Store.Block>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Feature.Store.Block;
     ...
     */
    withFileName(fileName: string | null): Feature.Store.Block;

    /**
     * Changes file extension in this instance.
     */
    withFileExt(fileExt: string | null): Feature.Store.Block;
     ...
     */
    identify(suffix?: string | null): Feature.Store.Block;
     ...
     */
    readMetadata(spec?: FileOperationSpec | null): Feature.Store.Block;
     ...
     */
    refreshMetadata(spec?: FileOperationSpec | null): Feature.Store.Block;
     ...
     * @return abstract content with metadata.
     */
    guessMetadata(spec?: FileOperationSpec | null): Feature.Store.Block;

    /**
     * Clears the content metadata; e.g. if it's known to be invalid.
     */
    clearMetadata(): Feature.Store.Block;

    /**
     * @return clone of this content with metadata from provided input.
     */
    withMetadata(meta?: ContentMeta | null): Feature.Store.Block;
     ...
     */
    encodedPushStream(spec?: FileOperationSpec | null): Pair<Feature.Store.Block | null, BytePushStream | null>;

    /**
     * @return byte push stream to be used for writing un-encoded data into this content object.
     */
    pushStream(spec?: FileOperationSpec | null): Pair<Feature.Store.Block | null, BytePushStream | null>;

    /**
     * @return character push stream to be used for writing un-encoded data into this content object.
     */
    charPushStream(spec?: FileOperationSpec | null): Pair<Feature.Store.Block | null, CharPushStream | null>;
     ...
     */
    encodedStream(spec?: FileOperationSpec | null): Pair<Feature.Store.Block | null, ByteStream | null> | null;
     ...
     */
    writeStream(content: ByteStream | null, spec?: FileOperationSpec | null): Feature.Store.Block;
     ...
     * Truncates file and replaces it's content with provided binary content.
     */
    writeInputStream(inputStream: any, spec?: FileOperationSpec | null): Feature.Store.Block;

    /**
     * Truncates file and replaces its content with provided binary content from zipInputStream
     */
    writeZipInputStream(zipInputStream: any, spec?: FileOperationSpec | null): Feature.Store.Block;
     ...
     */
    writeEncodedStream(encodedContent: ByteStream | null, spec?: FileOperationSpec | null): Feature.Store.Block;

    /**
     * Truncates file and replaces it's encoded content with provided binary content.
     */
    writeEncodedInputStream(inputStream: any, spec?: FileOperationSpec | null): Feature.Store.Block;
     ...
     *           content that needs to be written
     */
    write(content: any | null, spec?: FileOperationSpec | null): Feature.Store.Block;
     ...
     *           encoded content that needs to be written
     */
    writeEncoded(encodedContent: any | null, spec?: FileOperationSpec | null): Feature.Store.Block;
     ...
     *           content that needs to be written
     */
    writeString(content: string | null, spec?: FileOperationSpec | null): Feature.Store.Block;
     ...
     */
    writeObj(obj: Obj | null, spec?: FileObjsOperSpec | null): Feature.Store.Block;
     ...
     * @return pair of update instance of this content and number of objs written
     */
    startWriteObjs(spec?: FileObjsOperSpec | null): Pair<Feature.Store.Block | null, PushStream<Obj | null> | null>;
     ...
     */
    compress(contentEncoding?: string | null, spec?: FileCompressSpec | null): Feature.Store.Block;

    /**
     * Uncompresses content.
     */
    uncompress(spec?: FileCompressSpec | null): Feature.Store.Block;
     ...
     */
    transcode(contentType: string, contentEncoding: string, spec?: FileCompressSpec | null): Feature.Store.Block;

    /**
     * Copies content to a given target.
     */
    copyContentTo(target: Feature.Store.Block, spec?: FileOperationSpec | null): void;
     ...
     */
    concat(other: Content | null): Feature.Store.Block;

    /**
     * Creates a new Content by merging the incoming binary data with current content
     */
    concat(other: any | null): Feature.Store.Block;
     ...
     */
    static fetch(spec?: FetchSpec | null): FetchResult<Feature.Store.Block | null>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Feature.Store.Block | null>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Feature.Store.Block | null>;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Feature.Store.Block | null> | null>;
     ...
     */
    get(include?: string | null): Feature.Store.Block | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string | null): Feature.Store.Block | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Feature.Store.Block;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string | null): Feature.Store.Block | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Feature.Store.Block;
     ...
     * @see #toString
     */
    static fromString(s: string | null): Feature.Store.Block | null;
     ...
     */
    create(spec?: UpsertSpec | null): Feature.Store.Block | null;
     ...
     */
    static createBatch(objs: C3.Array<Feature.Store.Block | null> | null, spec?: UpsertSpec | null): ObjList<Feature.Store.Block | null> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Feature.Store.Block | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Feature.Store.Block | null> | null;
     ...
     */
    update(srcObj?: Feature.Store.Block | null, spec?: UpsertSpec | null): Feature.Store.Block | null;
     ...
     */
    upsert(srcObj?: Feature.Store.Block | null, spec?: UpsertSpec | null): Feature.Store.Block | null;
     ...
     */
    merge(spec?: MergeSpec | null): Feature.Store.Block | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec | null): Feature.Store.Block | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec | null): Feature.Store.Block | null;
     ...
     */
    static updateBatch(objs: C3.Array<Feature.Store.Block | null> | null, srcObjs?: C3.Array<Feature.Store.Block | null>, spec?: UpsertSpec | null): ObjList<Feature.Store.Block | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<C3.Array<Feature.Store.Block | null>>, spec?: UpsertSpec | null): ObjList<Feature.Store.Block | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: C3.Array<Feature.Store.Block | null> | null, srcObjs?: C3.Array<Feature.Store.Block | null>, spec?: UpsertSpec | null): ObjList<Feature.Store.Block | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<C3.Array<Feature.Store.Block | null>>, spec?: UpsertSpec | null): ObjList<Feature.Store.Block | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: C3.Array<Feature.Store.Block | null> | null, spec?: TouchSpec | null): ObjList<Feature.Store.Block | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<Feature.Store.Block | null> | null, spec?: MergeSpec | null): ObjList<Feature.Store.Block | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<Feature.Store.Block | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Feature.Store.Block | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<C3.Array<Feature.Store.Block | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Feature.Store.Block | null> | null;
     ...
     */
    static mergeAll(mergeObj: Feature.Store.Block | null, spec?: MergeAllSpec | null): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Feature.Store.Block | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: C3.Array<Feature.Store.Block | null> | null, spec?: UpsertSpec | null): ObjList<Feature.Store.Block | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: C3.Array<Feature.Store.Block | null> | null, spec?: UpsertSpec | null): ObjList<Feature.Store.Block | null> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Feature.Store.Block | null;
     ...
     */
    static beforeCreate(objs: C3.Array<Feature.Store.Block | null> | null): ObjList<Feature.Store.Block | null>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: C3.Array<Feature.Store.Block | null> | null): ObjList<Feature.Store.Block | null>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: C3.Array<Feature.Store.Block | null> | null): ObjList<Feature.Store.Block | null>;
     ...
     */
    static afterCreate(objs: C3.Array<Feature.Store.Block | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: C3.Array<Feature.Store.Block | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: C3.Array<Feature.Store.Block | null> | null): C3.Array<ObjError | null>;
     ...
     */
    static startImportData(spec?: StartImportDataSpec | null): PushStream<Feature.Store.Block | null>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Feature.Store.Block | null>;
     ...
     */
    static forId(id: string | null, failIfMissing?: boolean): Feature.Store.Block | null;
     ...
     */
    withoutIdentity(): Feature.Store.Block | null;
     ...
     */
    static typeOfBatch(objs: C3.Array<Feature.Store.Block | null> | null): C3.Array<EntityType | null>;
     ...
     */
    static dbEcho(template?: Feature.Store.Block | null, count?: number | null, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: C3.Array<Feature.Store.Block | null> | null, callback?: λFunction<Feature.Store.Block | null, Feature.Store.Block | null> | null): ObjList<Feature.Store.Block | null>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: C3.Array<Feature.Store.Block | null> | null, callback?: λFunction<Feature.Store.Block | null, Feature.Store.Block | null> | null): C3.Array<ObjError | null>;
