// TypeScript definitions for the C3 type BigTableConfig

/**
 * Config for KvStore.BigTable
 *
 * @remarks this represents a value passed to a method that expects an instance of BigTableConfig
 */
declare interface IBigTableConfig {
 ...
 * Config for KvStore.BigTable
 *
 * @remarks this represents a made instance of BigTableConfig
 */
declare class BigTableConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): BigTableConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): BigTableConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): BigTableConfig;

  /**
   * The unique and required name of this instance.
   */
  readonly name: string;
  withName(name: string): BigTableConfig;

  /**
   * Physical pool for connections
   */
  readonly connectionPool?: DatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null;
  withConnectionPool(connectionPool: IDatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null): BigTableConfig;
  ...
  withCredentials(credentials: IKvStore.Credentials | null): BigTableConfig;

  /**
   * C3 Cloud Identifier for backing infrastructure that hosts the Datastore ex: {@link PostgresDb#id}, {@link CassandraDb#id}
   */
  readonly cloudId?: string | null;
  withCloudId(cloudId: string | null): BigTableConfig;

  /**
   * True if the datastore is disabled (e.g. no data access is permitted).
   */
  readonly disabled?: boolean;
  withDisabled(disabled: boolean): BigTableConfig;

  /**
   * True if the datastore is read only, i.e. can only be queried.
   */
  readonly readOnly?: boolean;
  withReadOnly(readOnly: boolean): BigTableConfig;

  /**
   * True if the datastore is external, i.e. its database schema can not be altered.
   */
  readonly external?: boolean;
  withExternal(external: boolean): BigTableConfig;
  ...
  withPerTenant(perTenant: boolean): BigTableConfig;

  /**
   * Description for the dataStore.
   */
  readonly description?: string | null;
  withDescription(description: string | null): BigTableConfig;

  /**
   * True if the db is shared with other apps or it is dedicated.
   */
  readonly dedicated?: boolean;
  withDedicated(dedicated: boolean): BigTableConfig;

  readonly shareReadConnection?: boolean;
  withShareReadConnection(shareReadConnection: boolean): BigTableConfig;

  readonly sharedReadThreshold: number;
  withSharedReadThreshold(sharedReadThreshold: number): BigTableConfig;

  readonly readConnectionPool?: DatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null;
  withReadConnectionPool(readConnectionPool: IDatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null): BigTableConfig;

  readonly writeConnectionPool?: DatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null;
  withWriteConnectionPool(writeConnectionPool: IDatastoreConnectionPoolConfig<DatastoreConfig<KvStore.Credentials | null> | null> | null): BigTableConfig;
  ...
  withNewColReadCount(newColReadCount: number | null): BigTableConfig;
  ...
  withNewColMaxObjCount(newColMaxObjCount: number | null): BigTableConfig;
  ...
  withRewriteAllIncremental(rewriteAllIncremental: boolean): BigTableConfig;

  /**
   * Kv store kind for which this config is provided
   */
  readonly kvstore?: Type | null;
  withKvstore(kvstore: IType | null): BigTableConfig;
  ...
  withFillBucketsProbabilityOnRead(fillBucketsProbabilityOnRead: number | null): BigTableConfig;
  ...
  withFillBucketsProbabilityOnWrite(fillBucketsProbabilityOnWrite: number | null): BigTableConfig;
  ...
  withFillBucketsPartitionKeyPercentageOnWrite(fillBucketsPartitionKeyPercentageOnWrite: number | null): BigTableConfig;
  ...
  withRangeDeleteTimeDriftInSec(rangeDeleteTimeDriftInSec: number | null): BigTableConfig;
  ...
  withMultiBinningWriteTimeInterval(multiBinningWriteTimeInterval: string | null): BigTableConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): BigTableConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): BigTableConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): BigTableConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): BigTableConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): BigTableConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BigTableConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BigTableConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BigTableConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BigTableConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): BigTableConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BigTableConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BigTableConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): BigTableConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): BigTableConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): BigTableConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): BigTableConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BigTableConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): BigTableConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): BigTableConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): BigTableConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): BigTableConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): BigTableConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): BigTableConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): BigTableConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): BigTableConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): BigTableConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): BigTableConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): BigTableConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): BigTableConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): BigTableConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): BigTableConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): BigTableConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): BigTableConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): BigTableConfig;

  mergeJson(json: any | null): BigTableConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): BigTableConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): BigTableConfig;
   ...
   */
  singletonArray(): C3.Array<BigTableConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<BigTableConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BigTableConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<BigTableConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BigTableConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, BigTableConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BigTableConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BigTableConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BigTableConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): BigTableConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): BigTableConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): BigTableConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): BigTableConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): BigTableConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): BigTableConfig;
   ...
   * @see #fromString
   */
  static make(s: string | null): BigTableConfig | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): BigTableConfig;
   ...
   */
  static cachedEmptyInst(): BigTableConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<BigTableConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): BigTableConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<BigTableConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<BigTableConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<BigTableConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): BigTableConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): BigTableConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): BigTableConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): BigTableConfig | null;
   ...
   */
  static produce(key: string): BigTableConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, BigTableConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, BigTableConfig | null>;
   ...
   */
  static forConfigKey(configKey: string | null): BigTableConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<BigTableConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: BigTableConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: BigTableConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): BigTableConfig | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): BigTableConfig | null;
   ...
   */
  static forName(name: string | null, failIfMissing?: boolean): BigTableConfig | null;
