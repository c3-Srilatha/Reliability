// TypeScript definitions for the C3 type SshClientConfig

/**
 * Ssh Client config for {@link SshClient}
 *
 * @remarks this represents a value passed to a method that expects an instance of SshClientConfig
 */
declare interface ISshClientConfig {
 ...
 * Ssh Client config for {@link SshClient}
 *
 * @remarks this represents a made instance of SshClientConfig
 */
declare class SshClientConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): SshClientConfig;

  static readonly configOverride?: string | null;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): SshClientConfig;
  ...
  withIssues(issues: C3.Array<string | null> | Array<string | null>): SshClientConfig;
  ...
  withUsername(username: string | null): SshClientConfig;
   ...
   * If specified, absolute location for the pkfile to use. Defaults to the c3 user c3-kp-01.pem file.
   */
  readonly pkFile?: string | null;
  withPkFile(pkFile: string | null): SshClientConfig;

  /**
   * If specified, absolute location for the pkfile to use. Defaults to the c3 user c3-kp-01.pem file.
   */
  static readonly pkFile?: string | null;

  /**
   * Trace the ssh commands (-vvv) if true.
   */
  readonly debug?: boolean;
  withDebug(debug: boolean): SshClientConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SshClientConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SshClientConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SshClientConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SshClientConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): SshClientConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): SshClientConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SshClientConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SshClientConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SshClientConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SshClientConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SshClientConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SshClientConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SshClientConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SshClientConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SshClientConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SshClientConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SshClientConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SshClientConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SshClientConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SshClientConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SshClientConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): SshClientConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SshClientConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): SshClientConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SshClientConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): SshClientConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SshClientConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SshClientConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SshClientConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SshClientConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SshClientConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): SshClientConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SshClientConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): SshClientConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SshClientConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): SshClientConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SshClientConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): SshClientConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SshClientConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SshClientConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SshClientConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): SshClientConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SshClientConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SshClientConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SshClientConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): SshClientConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SshClientConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): SshClientConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): SshClientConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): SshClientConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SshClientConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): SshClientConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): SshClientConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): SshClientConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SshClientConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): SshClientConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SshClientConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SshClientConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SshClientConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): SshClientConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SshClientConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SshClientConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SshClientConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SshClientConfig;

  mergeJson(json: any | null): SshClientConfig;

  static mergeJson(json: any | null): SshClientConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SshClientConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SshClientConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SshClientConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): SshClientConfig;
   ...
   */
  singletonArray(): C3.Array<SshClientConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<SshClientConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SshClientConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SshClientConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SshClientConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<SshClientConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SshClientConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SshClientConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SshClientConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SshClientConfig | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<SshClientConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SshClientConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SshClientConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SshClientConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SshClientConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SshClientConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SshClientConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SshClientConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SshClientConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): SshClientConfig;
   ...
   */
  static cachedEmptyInst(): SshClientConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SshClientConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SshClientConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<SshClientConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<SshClientConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<SshClientConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): SshClientConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): SshClientConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): SshClientConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): SshClientConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): SshClientConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): SshClientConfig | null;
   ...
   */
  static produce(key: string): SshClientConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, SshClientConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, SshClientConfig | null>;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): SshClientConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): SshClientConfig;
   ...
   */
  static forConfigKey(configKey: string | null): SshClientConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<SshClientConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: SshClientConfig, override?: string | null): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: SshClientConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: SshClientConfig, override?: string | null): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: SshClientConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): SshClientConfig | null;
   ...
   */
  removeSecrets(): SshClientConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): SshClientConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): SshClientConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): SshClientConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): SshClientConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): SshClientConfig;
