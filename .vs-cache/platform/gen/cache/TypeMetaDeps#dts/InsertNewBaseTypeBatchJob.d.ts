// TypeScript definitions for the C3 type InsertNewBaseTypeBatchJob

/**
 * Batch job definitions for batch jobs started from RefreshCalcFieldsTask for asynchronous processing.
 *
 * @remarks this represents a value passed to a method that expects an instance of InsertNewBaseTypeBatchJob
 */
declare interface IInsertNewBaseTypeBatchJob {
 ...
 */
declare class InsertNewBaseTypeBatchJob extends Obj {

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun | null;
  withRun(run: IBatchJobRun | null): InsertNewBaseTypeBatchJob;

  /**
   * previous job executions for this instance
   */
  readonly runs?: C3.Array<BatchJobRun | null>;
  withRuns(runs: C3.Array<BatchJobRun | null> | Array<IBatchJobRun | null>): InsertNewBaseTypeBatchJob;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj | null;
  withOptions(options: IObj | null): InsertNewBaseTypeBatchJob;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): InsertNewBaseTypeBatchJob;
  ...
  withPriority(priority: number | null): InsertNewBaseTypeBatchJob;
  ...
  withDisabled(disabled: boolean): InsertNewBaseTypeBatchJob;
  ...
  withMaxConcurrency(maxConcurrency: number | null): InsertNewBaseTypeBatchJob;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): InsertNewBaseTypeBatchJob;
  ...
  withRunAsUser(runAsUser: boolean | null): InsertNewBaseTypeBatchJob;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string | null;
  withNodePool(nodePool: string | null): InsertNewBaseTypeBatchJob;
  ...
  withSkipIfRunning(skipIfRunning: boolean | null): InsertNewBaseTypeBatchJob;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number | null;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): InsertNewBaseTypeBatchJob;
  ...
  withPropagateActionContext(propagateActionContext: boolean): InsertNewBaseTypeBatchJob;
  ...
  withTypeIdent(typeIdent: string | null): InsertNewBaseTypeBatchJob;
   ...
   */
  readonly id: string;
  withId(id: string): InsertNewBaseTypeBatchJob;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): InsertNewBaseTypeBatchJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): InsertNewBaseTypeBatchJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): InsertNewBaseTypeBatchJob;
  ...
  withVersion(version: number | null): InsertNewBaseTypeBatchJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): InsertNewBaseTypeBatchJob;
  ...
  withAbortOnError(abortOnError: boolean): InsertNewBaseTypeBatchJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): InsertNewBaseTypeBatchJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): InsertNewBaseTypeBatchJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): InsertNewBaseTypeBatchJob | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): InsertNewBaseTypeBatchJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): InsertNewBaseTypeBatchJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): InsertNewBaseTypeBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): InsertNewBaseTypeBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<InsertNewBaseTypeBatchJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<InsertNewBaseTypeBatchJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): InsertNewBaseTypeBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): InsertNewBaseTypeBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): InsertNewBaseTypeBatchJob;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): InsertNewBaseTypeBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): InsertNewBaseTypeBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): InsertNewBaseTypeBatchJob;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): InsertNewBaseTypeBatchJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): InsertNewBaseTypeBatchJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): InsertNewBaseTypeBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): InsertNewBaseTypeBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): InsertNewBaseTypeBatchJob;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): InsertNewBaseTypeBatchJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): InsertNewBaseTypeBatchJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): InsertNewBaseTypeBatchJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): InsertNewBaseTypeBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): InsertNewBaseTypeBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): InsertNewBaseTypeBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): InsertNewBaseTypeBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): InsertNewBaseTypeBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): InsertNewBaseTypeBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): InsertNewBaseTypeBatchJob;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): InsertNewBaseTypeBatchJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): InsertNewBaseTypeBatchJob;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): InsertNewBaseTypeBatchJob;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): InsertNewBaseTypeBatchJob;

  mergeJson(json: any | null): InsertNewBaseTypeBatchJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): InsertNewBaseTypeBatchJob;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): InsertNewBaseTypeBatchJob;
   ...
   */
  singletonArray(): C3.Array<InsertNewBaseTypeBatchJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<InsertNewBaseTypeBatchJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<InsertNewBaseTypeBatchJob | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<InsertNewBaseTypeBatchJob | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<InsertNewBaseTypeBatchJob | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, InsertNewBaseTypeBatchJob | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, InsertNewBaseTypeBatchJob | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<InsertNewBaseTypeBatchJob | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<InsertNewBaseTypeBatchJob | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): InsertNewBaseTypeBatchJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): InsertNewBaseTypeBatchJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): InsertNewBaseTypeBatchJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): InsertNewBaseTypeBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): InsertNewBaseTypeBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): InsertNewBaseTypeBatchJob;
   ...
   * @see #fromString
   */
  static make(s: string | null): InsertNewBaseTypeBatchJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): InsertNewBaseTypeBatchJob;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): InsertNewBaseTypeBatchJob;
   ...
   */
  static cachedEmptyInst(): InsertNewBaseTypeBatchJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<InsertNewBaseTypeBatchJob>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): InsertNewBaseTypeBatchJob;
   ...
   */
  start(options?: InsertNewBaseTypeOptions | null): BatchJobStatus | null;
   ...
   */
  cleanup(options?: InsertNewBaseTypeOptions | null): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun | null, BatchJobStatus | null, InsertNewBaseTypeOptions | null> | null;

  failJob(run: JobRun<BatchJobStatusBase | null>): JobBase<BatchJobRun | null, BatchJobStatus | null, InsertNewBaseTypeOptions | null> | null;
  ...
  validateStart(options?: InsertNewBaseTypeOptions | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<InsertNewBaseTypeBatchJob | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<InsertNewBaseTypeBatchJob | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<InsertNewBaseTypeBatchJob | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<InsertNewBaseTypeBatchJob | null> | null>;
   ...
   */
  get(include?: string | null): InsertNewBaseTypeBatchJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): InsertNewBaseTypeBatchJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): InsertNewBaseTypeBatchJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): InsertNewBaseTypeBatchJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): InsertNewBaseTypeBatchJob;
   ...
   * @see #toString
   */
  static fromString(s: string | null): InsertNewBaseTypeBatchJob | null;
   ...
   */
  create(spec?: UpsertSpec | null): InsertNewBaseTypeBatchJob | null;
   ...
   */
  static createBatch(objs: C3.Array<InsertNewBaseTypeBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<InsertNewBaseTypeBatchJob | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<InsertNewBaseTypeBatchJob | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<InsertNewBaseTypeBatchJob | null> | null;
   ...
   */
  update(srcObj?: InsertNewBaseTypeBatchJob | null, spec?: UpsertSpec | null): InsertNewBaseTypeBatchJob | null;
   ...
   */
  upsert(srcObj?: InsertNewBaseTypeBatchJob | null, spec?: UpsertSpec | null): InsertNewBaseTypeBatchJob | null;
   ...
   */
  merge(spec?: MergeSpec | null): InsertNewBaseTypeBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): InsertNewBaseTypeBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): InsertNewBaseTypeBatchJob | null;
   ...
   */
  static updateBatch(objs: C3.Array<InsertNewBaseTypeBatchJob | null> | null, srcObjs?: C3.Array<InsertNewBaseTypeBatchJob | null>, spec?: UpsertSpec | null): ObjList<InsertNewBaseTypeBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<InsertNewBaseTypeBatchJob | null>>, spec?: UpsertSpec | null): ObjList<InsertNewBaseTypeBatchJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<InsertNewBaseTypeBatchJob | null> | null, srcObjs?: C3.Array<InsertNewBaseTypeBatchJob | null>, spec?: UpsertSpec | null): ObjList<InsertNewBaseTypeBatchJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<InsertNewBaseTypeBatchJob | null>>, spec?: UpsertSpec | null): ObjList<InsertNewBaseTypeBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<InsertNewBaseTypeBatchJob | null> | null, spec?: TouchSpec | null): ObjList<InsertNewBaseTypeBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<InsertNewBaseTypeBatchJob | null> | null, spec?: MergeSpec | null): ObjList<InsertNewBaseTypeBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<InsertNewBaseTypeBatchJob | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<InsertNewBaseTypeBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<InsertNewBaseTypeBatchJob | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<InsertNewBaseTypeBatchJob | null> | null;
   ...
   */
  static mergeAll(mergeObj: InsertNewBaseTypeBatchJob | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: InsertNewBaseTypeBatchJob | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<InsertNewBaseTypeBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<InsertNewBaseTypeBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<InsertNewBaseTypeBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<InsertNewBaseTypeBatchJob | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): InsertNewBaseTypeBatchJob | null;
   ...
   */
  static beforeCreate(objs: C3.Array<InsertNewBaseTypeBatchJob | null> | null): ObjList<InsertNewBaseTypeBatchJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<InsertNewBaseTypeBatchJob | null> | null): ObjList<InsertNewBaseTypeBatchJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<InsertNewBaseTypeBatchJob | null> | null): ObjList<InsertNewBaseTypeBatchJob | null>;
   ...
   */
  static afterCreate(objs: C3.Array<InsertNewBaseTypeBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<InsertNewBaseTypeBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<InsertNewBaseTypeBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<InsertNewBaseTypeBatchJob | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<InsertNewBaseTypeBatchJob | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): InsertNewBaseTypeBatchJob | null;
   ...
   */
  withoutIdentity(): InsertNewBaseTypeBatchJob | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<InsertNewBaseTypeBatchJob | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: InsertNewBaseTypeBatchJob | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<InsertNewBaseTypeBatchJob | null> | null, callback?: λFunction<InsertNewBaseTypeBatchJob | null, InsertNewBaseTypeBatchJob | null> | null): ObjList<InsertNewBaseTypeBatchJob | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<InsertNewBaseTypeBatchJob | null> | null, callback?: λFunction<InsertNewBaseTypeBatchJob | null, InsertNewBaseTypeBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static doStart(job?: InsertNewBaseTypeBatchJob | null, options?: InsertNewBaseTypeOptions | null): void;
   ...
   */
  static processBatch(batch?: InsertNewBaseTypeBatch | null, job?: InsertNewBaseTypeBatchJob | null, options?: InsertNewBaseTypeOptions | null): void;
   ...
   */
  static allComplete(job: InsertNewBaseTypeBatchJob, options?: InsertNewBaseTypeOptions | null): string | null;
   ...
   *           Options the job was run with.
   */
  static failed(job: InsertNewBaseTypeBatchJob, status: BatchJobStatus, options?: InsertNewBaseTypeOptions | null): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: InsertNewBaseTypeBatch | null): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: C3.Array<InsertNewBaseTypeBatch | null>): void;
   ...
   */
  static scheduleObjBatch(job?: InsertNewBaseTypeBatchJob | null, objBatch?: ObjBatch | null, logPrefix?: string | null): number | null;
