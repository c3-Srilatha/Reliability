// TypeScript definitions for the C3 type KvContent.Impl
 ...
 * @see KvFile
 *
 * @remarks this represents a value passed to a method that expects an instance of KvContent.Impl
 */
declare namespace KvContent {
 ...
 */
declare namespace KvContent {
  export class Impl extends Obj {

    /**
     * table associated with the content
     */
    readonly tableName: string;
    withTableName(tableName: string): KvContent.Impl;

    /**
     * rowId associated with the content
     */
    readonly rowId: string;
    withRowId(rowId: string): KvContent.Impl;

    /**
     * store associated with the content
     */
    readonly store: KvStore<KvStoreConfig | null>;
    withStore(store: IKvStore<KvStoreConfig | null>): KvContent.Impl;
    ...
    withContentEncoding(contentEncoding: string | null): KvContent.Impl;
    ...
    withContentLanguage(contentLanguage: string | null): KvContent.Impl;
    ...
    withContentLength(contentLength: number | null): KvContent.Impl;
    ...
    withContentLocation(contentLocation: string | null): KvContent.Impl;
    ...
    withContentType(contentType: string | null): KvContent.Impl;
    ...
    withContentDisposition(contentDisposition: string | null): KvContent.Impl;
    ...
    withETag(eTag: string | null): KvContent.Impl;
    ...
    withLastModified(lastModified: DateTime | Date | string | null): KvContent.Impl;

    /**
     * Id of user / identity who last last modified this content.
     */
    readonly lastModifiedBy?: string | null;
    withLastModifiedBy(lastModifiedBy: string | null): KvContent.Impl;
    ...
    withContentMD5(contentMD5: string | null): KvContent.Impl;
    ...
    withContentSHA1(contentSHA1: string | null): KvContent.Impl;

    /**
     * Field to maintain state whether content metadata was read or not.
     */
    readonly hasMetadata?: boolean;
    withHasMetadata(hasMetadata: boolean): KvContent.Impl;

    /**
     * The column name of the {@link KvRow} that this KvContent is associated to.
     */
    readonly colName: string;
    withColName(colName: string): KvContent.Impl;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): KvContent.Impl | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): KvContent.Impl | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): KvContent.Impl | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): KvContent.Impl | null;
     ...
     */
    replaceType(old: Type, new_: Type): KvContent.Impl;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): KvContent.Impl;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): KvContent.Impl;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<KvContent.Impl | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<KvContent.Impl | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): KvContent.Impl;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): KvContent.Impl;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): KvContent.Impl;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): KvContent.Impl;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): KvContent.Impl;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): KvContent.Impl;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): KvContent.Impl;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): KvContent.Impl;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): KvContent.Impl;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): KvContent.Impl;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): KvContent.Impl;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): KvContent.Impl;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): KvContent.Impl;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): KvContent.Impl;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): KvContent.Impl;
     ...
     * @see #unsetField
     */
    defaultField(field: string): KvContent.Impl;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): KvContent.Impl;
     ...
     * @see #removeField
     */
    unsetField(field: string): KvContent.Impl;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): KvContent.Impl;
     ...
     * @see #unsetField
     */
    removeField(field: string): KvContent.Impl;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): KvContent.Impl;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): KvContent.Impl;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): KvContent.Impl;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): KvContent.Impl;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): KvContent.Impl;

    mergeJson(json: any | null): KvContent.Impl;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): KvContent.Impl;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): KvContent.Impl;
     ...
     */
    singletonArray(): C3.Array<KvContent.Impl | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<KvContent.Impl | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<KvContent.Impl | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<KvContent.Impl | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<KvContent.Impl | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, KvContent.Impl | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, KvContent.Impl | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<KvContent.Impl | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<KvContent.Impl | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): KvContent.Impl;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): KvContent.Impl;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): KvContent.Impl;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): KvContent.Impl;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): KvContent.Impl;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): KvContent.Impl;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): KvContent.Impl;
     ...
     */
    static cachedEmptyInst(): KvContent.Impl;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<KvContent.Impl>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): KvContent.Impl;
     ...
     */
    withFileName(fileName: string | null): KvContent.Impl;

    /**
     * Changes file extension in this instance.
     */
    withFileExt(fileExt: string | null): KvContent.Impl;
     ...
     */
    identify(suffix?: string | null): KvContent.Impl;
     ...
     */
    readMetadata(spec?: FileOperationSpec | null): KvContent.Impl;
     ...
     */
    refreshMetadata(spec?: FileOperationSpec | null): KvContent.Impl;
     ...
     * @return abstract content with metadata.
     */
    guessMetadata(spec?: FileOperationSpec | null): KvContent.Impl;

    /**
     * Clears the content metadata; e.g. if it's known to be invalid.
     */
    clearMetadata(): KvContent.Impl;

    /**
     * @return clone of this content with metadata from provided input.
     */
    withMetadata(meta?: ContentMeta | null): KvContent.Impl;
     ...
     */
    encodedPushStream(spec?: FileOperationSpec | null): Pair<KvContent.Impl | null, BytePushStream | null>;

    /**
     * @return byte push stream to be used for writing un-encoded data into this content object.
     */
    pushStream(spec?: FileOperationSpec | null): Pair<KvContent.Impl | null, BytePushStream | null>;

    /**
     * @return character push stream to be used for writing un-encoded data into this content object.
     */
    charPushStream(spec?: FileOperationSpec | null): Pair<KvContent.Impl | null, CharPushStream | null>;
     ...
     */
    encodedStream(spec?: FileOperationSpec | null): Pair<KvContent.Impl | null, ByteStream | null> | null;
     ...
     */
    writeStream(content: ByteStream | null, spec?: FileOperationSpec | null): KvContent.Impl;

    /**
     * Truncates file and replaces it's content with provided binary content.
     */
    writeInputStream(inputStream: any, spec?: FileOperationSpec | null): KvContent.Impl;

    /**
     * Truncates file and replaces its content with provided binary content from zipInputStream
     */
    writeZipInputStream(zipInputStream: any, spec?: FileOperationSpec | null): KvContent.Impl;
     ...
     */
    writeEncodedStream(encodedContent: ByteStream | null, spec?: FileOperationSpec | null): KvContent.Impl;

    /**
     * Truncates file and replaces it's encoded content with provided binary content.
     */
    writeEncodedInputStream(inputStream: any, spec?: FileOperationSpec | null): KvContent.Impl;
     ...
     *           content that needs to be written
     */
    write(content: any | null, spec?: FileOperationSpec | null): KvContent.Impl;
     ...
     *           encoded content that needs to be written
     */
    writeEncoded(encodedContent: any | null, spec?: FileOperationSpec | null): KvContent.Impl;
     ...
     *           content that needs to be written
     */
    writeString(content: string | null, spec?: FileOperationSpec | null): KvContent.Impl;
     ...
     */
    writeObj(obj: Obj | null, spec?: FileObjsOperSpec | null): KvContent.Impl;
     ...
     * @return pair of update instance of this content and number of objs written
     */
    startWriteObjs(spec?: FileObjsOperSpec | null): Pair<KvContent.Impl | null, PushStream<Obj | null> | null>;
     ...
     */
    compress(contentEncoding?: string | null, spec?: FileCompressSpec | null): KvContent.Impl;

    /**
     * Uncompresses content.
     */
    uncompress(spec?: FileCompressSpec | null): KvContent.Impl;
     ...
     */
    transcode(contentType: string, contentEncoding: string, spec?: FileCompressSpec | null): KvContent.Impl;

    /**
     * Copies content to a given target.
     */
    copyContentTo(target: KvContent.Impl, spec?: FileOperationSpec | null): void;
