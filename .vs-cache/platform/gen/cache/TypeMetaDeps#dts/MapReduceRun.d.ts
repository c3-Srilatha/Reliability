// TypeScript definitions for the C3 type MapReduceRun

/**
 * @remarks this represents a value passed to a method that expects an instance of MapReduceRun
 */
declare interface IMapReduceRun {
   ...
   */
  status: IMapReduceStatus;

  /**
   * Time the run was started
   */
  started: DateTime | Date | string;
  ...
  /**
   * @see MapReduceOptions.useBatchIdsForReadInput
   */
  useBatchIdsForReadInput?: boolean;

  /**
   * Indicates the job is using random ordering (e.g. md5 hash/mod) for reading input
   */
  randomOrder?: boolean;

  /**
   * Value of the job's samplePct at the time the run is started
   */
  samplePct?: number | null;

  /**
   * Number of batches when randomOrder is true
   */
  numBatches?: number | null;

  /**
   * Batch size for the run (either copied from the job or computed if randomOrder is true and samplePct is specified)
   */
   ...
   * Results for the run.
   */
  results?: C3.Array<ReduceResult | null> | Array<IReduceResult | null>;
}

/**
 * @remarks this represents a made instance of MapReduceRun
 */
declare class MapReduceRun extends Obj {

  /**
   * Id of the job that owns the run.
   */
  readonly jobId: string;
  withJobId(jobId: string): MapReduceRun;

  /**
   * The type of job that owns the run.
   */
  readonly jobType?: Type | null;
  withJobType(jobType: IType | null): MapReduceRun;

  /**
   * Status of the current run for the job
   */
  readonly status: MapReduceStatus;
  withStatus(status: IMapReduceStatus): MapReduceRun;

  /**
   * Time the run was started
   */
  readonly started: DateTime;
  withStarted(started: DateTime | Date | string): MapReduceRun;

  /**
   * True if the job is about to be set to 'failed' status and we are calling the 'failed' callback or doing
   * auto recovery.
   */
  readonly handlingFailed?: boolean;
  withHandlingFailed(handlingFailed: boolean): MapReduceRun;

  /**
   * Used to keep track of who is calling 'failed' or performing auto recovery to avoid concurrency issues.
   */
  readonly handleFailedToken?: string | null;
  withHandleFailedToken(handleFailedToken: string | null): MapReduceRun;

  /**
   * If 'numAutoRecoveryAttempts' was set in the options while starting the job, the remaining number of attempts
   * available.
   */
  readonly remainingAutoRecoveryAttempts?: number | null;
  withRemainingAutoRecoveryAttempts(remainingAutoRecoveryAttempts: number | null): MapReduceRun;

  /**
   * Action ID for where the Job Run is defined. In this case, this is the asyncRootId of all actions in the job run.
   */
  readonly startingActionId: string;
  withStartingActionId(startingActionId: string): MapReduceRun;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): MapReduceRun;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): MapReduceRun;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): MapReduceRun;
  ...
  withVersion(version: number | null): MapReduceRun;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): MapReduceRun;
  ...
  withUseFileSystemForInterVals(useFileSystemForInterVals: boolean): MapReduceRun;

  /**
   * @see MapReduceOptions.useBatchIdsForReadInput
   */
  readonly useBatchIdsForReadInput?: boolean;
  withUseBatchIdsForReadInput(useBatchIdsForReadInput: boolean): MapReduceRun;

  /**
   * Indicates the job is using random ordering (e.g. md5 hash/mod) for reading input
   */
  readonly randomOrder?: boolean;
  withRandomOrder(randomOrder: boolean): MapReduceRun;

  /**
   * Value of the job's samplePct at the time the run is started
   */
  readonly samplePct?: number | null;
  withSamplePct(samplePct: number | null): MapReduceRun;

  /**
   * Number of batches when randomOrder is true
   */
  readonly numBatches?: number | null;
  withNumBatches(numBatches: number | null): MapReduceRun;

  /**
   * Batch size for the run (either copied from the job or computed if randomOrder is true and samplePct is specified)
   */
  readonly batchSize?: number | null;
  withBatchSize(batchSize: number | null): MapReduceRun;

  /**
   * Results for the run.
   */
  readonly results?: C3.Array<ReduceResult | null>;
  withResults(results: C3.Array<ReduceResult | null> | Array<IReduceResult | null>): MapReduceRun;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): MapReduceRun | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): MapReduceRun | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): MapReduceRun | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): MapReduceRun | null;
   ...
   */
  replaceType(old: Type, new_: Type): MapReduceRun;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MapReduceRun;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MapReduceRun;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MapReduceRun | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MapReduceRun | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): MapReduceRun;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MapReduceRun;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MapReduceRun;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): MapReduceRun;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): MapReduceRun;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): MapReduceRun;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): MapReduceRun;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): MapReduceRun;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): MapReduceRun;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): MapReduceRun;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): MapReduceRun;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): MapReduceRun;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): MapReduceRun;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): MapReduceRun;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): MapReduceRun;
   ...
   * @see #unsetField
   */
  defaultField(field: string): MapReduceRun;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): MapReduceRun;
   ...
   * @see #removeField
   */
  unsetField(field: string): MapReduceRun;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): MapReduceRun;
   ...
   * @see #unsetField
   */
  removeField(field: string): MapReduceRun;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): MapReduceRun;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): MapReduceRun;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): MapReduceRun;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): MapReduceRun;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): MapReduceRun;

  mergeJson(json: any | null): MapReduceRun;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): MapReduceRun;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): MapReduceRun;
   ...
   */
  singletonArray(): C3.Array<MapReduceRun | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<MapReduceRun | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<MapReduceRun | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<MapReduceRun | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<MapReduceRun | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, MapReduceRun | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, MapReduceRun | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<MapReduceRun | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<MapReduceRun | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): MapReduceRun;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): MapReduceRun;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): MapReduceRun;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): MapReduceRun;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): MapReduceRun;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): MapReduceRun;
   ...
   * @see #fromString
   */
  static make(s: string | null): MapReduceRun | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): MapReduceRun;
   ...
   */
  static cachedEmptyInst(): MapReduceRun;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<MapReduceRun>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): MapReduceRun;
   ...
   */
  isFailComplete(job: JobBase<JobRun | null, BatchJobStatusBase | null, any>): boolean;
   ...
   */
  isCancelComplete(job: JobBase<JobRun | null, BatchJobStatusBase | null, any>): boolean;
   ...
   */
  setStatusFailed(job: JobBase<JobRun | null, BatchJobStatusBase | null, any>): JobRun<MapReduceStatus | null> | null;
   ...
   */
  checkHandlingFailed(job: JobBase<JobRun | null, BatchJobStatusBase | null, any>): JobRun<MapReduceStatus | null> | null;
   ...
   * @return The resulting job run.
   */
  setStatusCanceled(job: JobBase<JobRun | null, BatchJobStatusBase | null, any>): JobRun<MapReduceStatus | null> | null;
   ...
   */
  callFailed(job: JobBase<JobRun | null, BatchJobStatusBase | null, any>): void;
   ...
   */
  callRecover(job: JobBase<JobRun | null, BatchJobStatusBase | null, any>): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<MapReduceRun | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<MapReduceRun | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<MapReduceRun | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<MapReduceRun | null> | null>;
   ...
   */
  get(include?: string | null): MapReduceRun | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): MapReduceRun | null;
   ...
   */
  getMissing(spec: GetMissingSpec): MapReduceRun;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): MapReduceRun | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): MapReduceRun;
   ...
   * @see #toString
   */
  static fromString(s: string | null): MapReduceRun | null;
   ...
   */
  create(spec?: UpsertSpec | null): MapReduceRun | null;
   ...
   */
  static createBatch(objs: C3.Array<MapReduceRun | null> | null, spec?: UpsertSpec | null): ObjList<MapReduceRun | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<MapReduceRun | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<MapReduceRun | null> | null;
   ...
   */
  update(srcObj?: MapReduceRun | null, spec?: UpsertSpec | null): MapReduceRun | null;
   ...
   */
  upsert(srcObj?: MapReduceRun | null, spec?: UpsertSpec | null): MapReduceRun | null;
   ...
   */
  merge(spec?: MergeSpec | null): MapReduceRun | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): MapReduceRun | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): MapReduceRun | null;
   ...
   */
  static updateBatch(objs: C3.Array<MapReduceRun | null> | null, srcObjs?: C3.Array<MapReduceRun | null>, spec?: UpsertSpec | null): ObjList<MapReduceRun | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<MapReduceRun | null>>, spec?: UpsertSpec | null): ObjList<MapReduceRun | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<MapReduceRun | null> | null, srcObjs?: C3.Array<MapReduceRun | null>, spec?: UpsertSpec | null): ObjList<MapReduceRun | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<MapReduceRun | null>>, spec?: UpsertSpec | null): ObjList<MapReduceRun | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<MapReduceRun | null> | null, spec?: TouchSpec | null): ObjList<MapReduceRun | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<MapReduceRun | null> | null, spec?: MergeSpec | null): ObjList<MapReduceRun | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<MapReduceRun | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<MapReduceRun | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<MapReduceRun | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<MapReduceRun | null> | null;
   ...
   */
  static mergeAll(mergeObj: MapReduceRun | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: MapReduceRun | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<MapReduceRun | null> | null, spec?: UpsertSpec | null): ObjList<MapReduceRun | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<MapReduceRun | null> | null, spec?: UpsertSpec | null): ObjList<MapReduceRun | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<MapReduceRun | null> | null): ObjList<MapReduceRun | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<MapReduceRun | null> | null): ObjList<MapReduceRun | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<MapReduceRun | null> | null): ObjList<MapReduceRun | null>;
   ...
   */
  static afterCreate(objs: C3.Array<MapReduceRun | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<MapReduceRun | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<MapReduceRun | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<MapReduceRun | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<MapReduceRun | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): MapReduceRun | null;
   ...
   */
  withoutIdentity(): MapReduceRun | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<MapReduceRun | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: MapReduceRun | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<MapReduceRun | null> | null, callback?: λFunction<MapReduceRun | null, MapReduceRun | null> | null): ObjList<MapReduceRun | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<MapReduceRun | null> | null, callback?: λFunction<MapReduceRun | null, MapReduceRun | null> | null): C3.Array<ObjError | null>;
