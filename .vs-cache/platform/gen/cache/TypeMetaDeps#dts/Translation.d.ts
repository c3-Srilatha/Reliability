// TypeScript definitions for the C3 type Translation

/**
 * Type to hold translations for various objects. {@link Translation.c3doc See instructions for defining translations}
 *
 * @remarks this represents a value passed to a method that expects an instance of Translation
 */
 ...
 * Type to hold translations for various objects. {@link Translation.c3doc See instructions for defining translations}
 *
 * @remarks this represents a made instance of Translation
 */
declare class Translation extends Obj {

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): Translation;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Translation;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): Translation;
  ...
  withVersion(version: number | null): Translation;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): Translation;

  readonly key?: string | null;
  withKey(key: string | null): Translation;

  readonly value?: string | null;
  withValue(value: string | null): Translation;

  readonly locale?: Locale | null;
  withLocale(locale: ILocale | null): Translation;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Translation | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Translation | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Translation | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Translation | null;
   ...
   */
  replaceType(old: Type, new_: Type): Translation;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Translation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Translation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Translation | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Translation | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Translation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Translation;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Translation;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): Translation;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Translation;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Translation;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Translation;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Translation;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Translation;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Translation;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Translation;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Translation;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Translation;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Translation;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Translation;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Translation;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Translation;
   ...
   * @see #removeField
   */
  unsetField(field: string): Translation;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Translation;
   ...
   * @see #unsetField
   */
  removeField(field: string): Translation;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Translation;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Translation;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Translation;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Translation;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Translation;

  mergeJson(json: any | null): Translation;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Translation;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Translation;
   ...
   */
  singletonArray(): C3.Array<Translation | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Translation | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Translation | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Translation | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Translation | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Translation | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Translation | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Translation | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Translation | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Translation;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Translation;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Translation;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Translation;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Translation;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Translation;
   ...
   * @see #fromString
   */
  static make(s: string | null): Translation | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Translation;
   ...
   */
  static cachedEmptyInst(): Translation;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Translation>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Translation;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<Translation | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<Translation | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Translation | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Translation | null> | null>;
   ...
   */
  dependencies(): MetadataDeps<Translation | null>;

  save(subPath?: string | null, contentType?: string | null): Translation;
  ...
  update(srcObj?: Translation | null, spec?: UpsertSpec | null): Translation | null;
  ...
  upsert(srcObj?: Translation | null, spec?: UpsertSpec | null): Translation | null;
   ...
   */
  get(include?: string | null): Translation | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): Translation | null;
   ...
   */
  getMissing(spec: GetMissingSpec): Translation;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): Translation | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): Translation;
   ...
   * @see #toString
   */
  static fromString(s: string | null): Translation | null;
   ...
   */
  create(spec?: UpsertSpec | null): Translation | null;
   ...
   */
  static createBatch(objs: C3.Array<Translation | null> | null, spec?: UpsertSpec | null): ObjList<Translation | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<Translation | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Translation | null> | null;
   ...
   */
  merge(spec?: MergeSpec | null): Translation | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): Translation | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): Translation | null;
   ...
   */
  static updateBatch(objs: C3.Array<Translation | null> | null, srcObjs?: C3.Array<Translation | null>, spec?: UpsertSpec | null): ObjList<Translation | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<Translation | null>>, spec?: UpsertSpec | null): ObjList<Translation | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<Translation | null> | null, srcObjs?: C3.Array<Translation | null>, spec?: UpsertSpec | null): ObjList<Translation | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<Translation | null>>, spec?: UpsertSpec | null): ObjList<Translation | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<Translation | null> | null, spec?: TouchSpec | null): ObjList<Translation | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Translation | null> | null, spec?: MergeSpec | null): ObjList<Translation | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Translation | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Translation | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<Translation | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Translation | null> | null;
   ...
   */
  static mergeAll(mergeObj: Translation | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: Translation | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<Translation | null> | null, spec?: UpsertSpec | null): ObjList<Translation | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<Translation | null> | null, spec?: UpsertSpec | null): ObjList<Translation | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<Translation | null> | null): ObjList<Translation | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<Translation | null> | null): ObjList<Translation | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<Translation | null> | null): ObjList<Translation | null>;
   ...
   */
  static afterCreate(objs: C3.Array<Translation | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<Translation | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<Translation | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<Translation | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Translation | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): Translation | null;
   ...
   */
  withoutIdentity(): Translation | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<Translation | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: Translation | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<Translation | null> | null, callback?: λFunction<Translation | null, Translation | null> | null): ObjList<Translation | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<Translation | null> | null, callback?: λFunction<Translation | null, Translation | null> | null): C3.Array<ObjError | null>;
  ...
  /**
   * Get the translated string for a given key & locale
   * @param key
   *          Key indicating which translation should be looked up. {@see Translation#makeKey}
   * @param locale
   *          Which locale is the translation desired in. If the translation is not found in the locale of your choice
   *          default fall back will be "en" and if not found in "en", then the original value will be returned
   * @return the translated string
   */
  static getTranslationForLocale(key: string, locale?: string | null): string | null;

  /**
   * API to return a translation key for the given params
   * @param typeName
   *              Type for which translation has been defined
   * @param id
   *              Object id on which translation is desired (object id should of type `typeName`)
   * @param fieldName
   *              Filed name on which translation is desired (e.g. `id` or `name` or `description`)
   * @return key to be used to fetch the translation
   */
  static makeKey(typeName: string, id: string, fieldName: string): string;

  /**
   * Replace type name in key of the translation with the base type name
   */
  static keyWithBaseType(key?: string | null): string | null;
}
