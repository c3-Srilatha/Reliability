// TypeScript definitions for the C3 type DataIntegFields

/**
 * @remarks this represents a value passed to a method that expects an instance of DataIntegFields
 */
declare interface IDataIntegFields {
...
/**
 * @remarks this represents a made instance of DataIntegFields
 */
declare class DataIntegFields extends Obj {
  ...
  withContentTypeOverride(contentTypeOverride: string | null): DataIntegFields;
  ...
  withContentEncodingOverride(contentEncodingOverride: string | null): DataIntegFields;
  ...
  withDefaultContentType(defaultContentType: string | null): DataIntegFields;
  ...
  withDefaultContentEncoding(defaultContentEncoding: string | null): DataIntegFields;

  /**
   * Specifies various parameters for automatic retry that occurs in upsert due to retryable errors.
   */
  readonly retrySpec?: RetrySpec | null;
  withRetrySpec(retrySpec: IRetrySpec | null): DataIntegFields;
  ...
  withValidateContentType(validateContentType: boolean): DataIntegFields;
  ...
  withPeekForMetadata(peekForMetadata: boolean): DataIntegFields;
  ...
  withFailIfMissing(failIfMissing: boolean): DataIntegFields;
  ...
  withSkipIfUnauthorized(skipIfUnauthorized: boolean): DataIntegFields;

  /**
   * If set and if requested file or directory url is under this path then will retrieve content from cache.
   */
  readonly cacheUrlOrEncodedPath?: string | null;
  withCacheUrlOrEncodedPath(cacheUrlOrEncodedPath: string | null): DataIntegFields;

  /**
   * Time in seconds that the cached file should live (default 24 hours).
   */
  readonly cacheTtlSec?: number | null;
  withCacheTtlSec(cacheTtlSec: number | null): DataIntegFields;
  ...
  withForceMultiPart(forceMultiPart: boolean): DataIntegFields;
  ...
  withDisableMultiPart(disableMultiPart: boolean): DataIntegFields;

  /**
   * Overrides default maximum file size before MultipartUpload kicks in. Default is 1GB
   */
  readonly maximumSingleUploadsize?: number | null;
  withMaximumSingleUploadsize(maximumSingleUploadsize: number | null): DataIntegFields;
  ...
  withMaxThreads(maxThreads: number | null): DataIntegFields;
  ...
  withMinThreads(minThreads: number | null): DataIntegFields;

  /**
   * If set to true, it will retry reading file when the file is not found.
   */
  readonly retryOnNotFound?: boolean;
  withRetryOnNotFound(retryOnNotFound: boolean): DataIntegFields;
  ...
  withLockOnWrite(lockOnWrite: boolean): DataIntegFields;

  /**
   * If set will use IoExecutor service.
   */
  readonly useIoExecutor?: boolean;
  withUseIoExecutor(useIoExecutor: boolean): DataIntegFields;

  /**
   * If not null, retry logic will be used from CloudClient rather than File
   */
  readonly cloudClient?: any;
  withCloudClient(cloudClient: any): DataIntegFields;

  /**
   * If provided, list files will return only files whose name matches the provided glob.
   */
  readonly globPattern?: string | null;
  withGlobPattern(globPattern: string | null): DataIntegFields;

  /**
   * If provided, list files will return only files that end with the provided suffix.
   */
  readonly fileSuffix?: string | null;
  withFileSuffix(fileSuffix: string | null): DataIntegFields;

  /**
   * When listing files, set this to true to include directories if the FileSystem supports Files referencing directories
   */
  readonly includeDirs?: boolean;
  withIncludeDirs(includeDirs: boolean): DataIntegFields;
  ...
  withHiddenFiles(hiddenFiles: boolean): DataIntegFields;
  ...
  withDoNotChunk(doNotChunk: boolean | null): DataIntegFields;

  /**
   * If set to true then it will clean existing chunks before chunking
   */
  readonly cleanupPendingChunks?: boolean;
  withCleanupPendingChunks(cleanupPendingChunks: boolean): DataIntegFields;

  /**
   * If not set then SourceStatus will be persisted in {@link SourceFile} or in {@link SourceCollection#statsUrl}
   */
  readonly doNotArchiveStatus?: boolean;
  withDoNotArchiveStatus(doNotArchiveStatus: boolean): DataIntegFields;
  ...
  withDoNotArchiveSources(doNotArchiveSources: boolean): DataIntegFields;
  ...
  withDoNotArchiveFailedSources(doNotArchiveFailedSources: boolean): DataIntegFields;

  /**
   * Indicates the threshold of acceptable number of errors
   */
  readonly numErrorsToAbort?: number | null;
  withNumErrorsToAbort(numErrorsToAbort: number | null): DataIntegFields;
  ...
  withNumRetries(numRetries: number | null): DataIntegFields;
  ...
  withProcessMode(processMode: string): DataIntegFields;
  ...
  withProcessSchedule(processSchedule: string | null): DataIntegFields;
  ...
  withPriority(priority: number | null): DataIntegFields;

  /**
   * User can choose to change the #archiveUrl for the SourceCollection.
   */
  readonly archiveUrlOverride?: string | null;
  withArchiveUrlOverride(archiveUrlOverride: string | null): DataIntegFields;
  ...
  withExternalOverride(externalOverride: boolean | null): DataIntegFields;
  ...
  withInboxUrlOverride(inboxUrlOverride: string | null): DataIntegFields;
  ...
  withTargetCollectionOverrides(targetCollectionOverrides: C3.Map<string | null, TargetCollection<any> | null> | {[key: string | null]: ITargetCollection<any> | null}): DataIntegFields;

  /**
   * Overrides the csvHeader specified in the contentType.
   */
  readonly csvHeaderOverride?: string | null;
  withCsvHeaderOverride(csvHeaderOverride: string | null): DataIntegFields;

  /**
   * Overrides the csvDelimiter specified contentType.
   */
  readonly csvDelimiterOverride?: string | null;
  withCsvDelimiterOverride(csvDelimiterOverride: string | null): DataIntegFields;

  /**
   * Escape character override for CSV file.
   */
  readonly csvEscapeCharOverride?: string | null;
  withCsvEscapeCharOverride(csvEscapeCharOverride: string | null): DataIntegFields;

  /**
   * Quote character override for CSV file.
   */
  readonly csvQuoteCharOverride?: string | null;
  withCsvQuoteCharOverride(csvQuoteCharOverride: string | null): DataIntegFields;
  ...
  withNoCsvHeader(noCsvHeader: boolean): DataIntegFields;

  /**
   * Optional format for a csv values. Key should be field path used in a csv header.
   */
  readonly csvFormat?: C3.Map<string | null, Format | null>;
  withCsvFormat(csvFormat: C3.Map<string | null, Format | null> | {[key: string | null]: IFormat | null}): DataIntegFields;
  ...
  withAvroSchemaOverride(avroSchemaOverride: string | null): DataIntegFields;
  ...
  withIsObjList(isObjList: boolean): DataIntegFields;

  /**
   * Optionally fail to serialize extra fields in serialized content instead of ignoring.
   */
  readonly failOnExtraFields?: boolean;
  withFailOnExtraFields(failOnExtraFields: boolean): DataIntegFields;

  /**
   * If true will silently ignore bad syntax in the content and will return no or partial results.
   */
  readonly ignoreBadContent?: boolean;
  withIgnoreBadContent(ignoreBadContent: boolean): DataIntegFields;

  /**
   * If set will ignore value conversion errors (e.g. non numeric strings will get converted to null for numeric fields)
   */
  readonly ignoreValueConversionErrors?: boolean;
  withIgnoreValueConversionErrors(ignoreValueConversionErrors: boolean): DataIntegFields;
  ...
  withMergeXmlNonAdjacentLists(mergeXmlNonAdjacentLists: boolean): DataIntegFields;
  ...
  withMinByteSizeToChunk(minByteSizeToChunk: number | null): DataIntegFields;

  /**
   * if set to true then target objs will include {@link Sources#sourcesMeta}
   */
  readonly includeMeta?: boolean;
  withIncludeMeta(includeMeta: boolean): DataIntegFields;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): DataIntegFields | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): DataIntegFields | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): DataIntegFields | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): DataIntegFields | null;
   ...
   */
  replaceType(old: Type, new_: Type): DataIntegFields;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataIntegFields;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataIntegFields;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataIntegFields | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataIntegFields | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataIntegFields;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataIntegFields;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataIntegFields;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DataIntegFields;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DataIntegFields;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DataIntegFields;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataIntegFields;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataIntegFields;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DataIntegFields;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): DataIntegFields;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): DataIntegFields;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): DataIntegFields;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataIntegFields;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DataIntegFields;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataIntegFields;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DataIntegFields;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DataIntegFields;
   ...
   * @see #removeField
   */
  unsetField(field: string): DataIntegFields;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DataIntegFields;
   ...
   * @see #unsetField
   */
  removeField(field: string): DataIntegFields;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DataIntegFields;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataIntegFields;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): DataIntegFields;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataIntegFields;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataIntegFields;

  mergeJson(json: any | null): DataIntegFields;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataIntegFields;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): DataIntegFields;
   ...
   */
  singletonArray(): C3.Array<DataIntegFields | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<DataIntegFields | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DataIntegFields | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<DataIntegFields | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DataIntegFields | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, DataIntegFields | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataIntegFields | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DataIntegFields | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DataIntegFields | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DataIntegFields;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DataIntegFields;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DataIntegFields;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DataIntegFields;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DataIntegFields;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DataIntegFields;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DataIntegFields;
   ...
   */
  static cachedEmptyInst(): DataIntegFields;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DataIntegFields>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): DataIntegFields;

  /**
   * @return new instance of this spec with `retrySpec` set
   */
  withRetry(maxRetries?: number | null, initialSleepMillis?: number | null, exponent?: number | null): DataIntegFields | null;

  /**
   * @return instance of this spec with `retrySpec`'s `maxTotalMillis` set
   */
  static timeoutSeconds(secs: number | null): DataIntegFields;
}
