// TypeScript definitions for the C3 type SourceQueue

/**
 * Invalidation Queue for async processing {@link Sources}
 *
 * @remarks this represents a value passed to a method that expects an instance of SourceQueue
 */
declare interface ISourceQueue {
}

/**
 * Invalidation Queue for async processing {@link Sources}
 *
 * @remarks this represents a made instance of SourceQueue
 */
declare class SourceQueue {
   ...
   */
  static compute(targetType: Type, entries: C3.Array<SourceQueueEntry | null> | null): void;
   ...
   */
  static find(spec?: InvalidationQueue.FindSpec | null): C3.Array<SourceQueueEntry | null>;
   ...
   * @return the list of requested entries.
   */
  static findStream(spec?: InvalidationQueue.FindStreamSpec | null): Stream<SourceQueueEntry | null>;
   ...
   *           Entries to remove.
   */
  static clearEntries(entries: C3.Array<SourceQueueEntry | null> | null): void;
