// TypeScript definitions for the C3 type VanityUrlConfig

/**
 * @remarks this represents a value passed to a method that expects an instance of VanityUrlConfig
 */
declare interface IVanityUrlConfig {
...
/**
 * @remarks this represents a made instance of VanityUrlConfig
 */
declare class VanityUrlConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): VanityUrlConfig;

  static readonly configOverride?: string | null;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): VanityUrlConfig;
  ...
  withIssues(issues: C3.Array<string | null> | Array<string | null>): VanityUrlConfig;
  ...
  withAutoCreate(autoCreate: boolean): VanityUrlConfig;

  static readonly autoCreate?: boolean;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): VanityUrlConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): VanityUrlConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): VanityUrlConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): VanityUrlConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): VanityUrlConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): VanityUrlConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VanityUrlConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VanityUrlConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VanityUrlConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VanityUrlConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VanityUrlConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VanityUrlConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VanityUrlConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VanityUrlConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): VanityUrlConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): VanityUrlConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VanityUrlConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VanityUrlConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VanityUrlConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VanityUrlConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): VanityUrlConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): VanityUrlConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): VanityUrlConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): VanityUrlConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): VanityUrlConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): VanityUrlConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): VanityUrlConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): VanityUrlConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): VanityUrlConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): VanityUrlConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): VanityUrlConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): VanityUrlConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): VanityUrlConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): VanityUrlConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): VanityUrlConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): VanityUrlConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): VanityUrlConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): VanityUrlConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): VanityUrlConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): VanityUrlConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): VanityUrlConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): VanityUrlConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): VanityUrlConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): VanityUrlConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): VanityUrlConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): VanityUrlConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): VanityUrlConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): VanityUrlConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): VanityUrlConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): VanityUrlConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): VanityUrlConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): VanityUrlConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): VanityUrlConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): VanityUrlConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): VanityUrlConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): VanityUrlConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): VanityUrlConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): VanityUrlConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): VanityUrlConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): VanityUrlConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): VanityUrlConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): VanityUrlConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): VanityUrlConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): VanityUrlConfig;

  mergeJson(json: any | null): VanityUrlConfig;

  static mergeJson(json: any | null): VanityUrlConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): VanityUrlConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): VanityUrlConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): VanityUrlConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): VanityUrlConfig;
   ...
   */
  singletonArray(): C3.Array<VanityUrlConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<VanityUrlConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<VanityUrlConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<VanityUrlConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<VanityUrlConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<VanityUrlConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<VanityUrlConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, VanityUrlConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, VanityUrlConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<VanityUrlConfig | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<VanityUrlConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<VanityUrlConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): VanityUrlConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): VanityUrlConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): VanityUrlConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): VanityUrlConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): VanityUrlConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): VanityUrlConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): VanityUrlConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): VanityUrlConfig;
   ...
   */
  static cachedEmptyInst(): VanityUrlConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<VanityUrlConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): VanityUrlConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<VanityUrlConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<VanityUrlConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<VanityUrlConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): VanityUrlConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): VanityUrlConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): VanityUrlConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): VanityUrlConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): VanityUrlConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): VanityUrlConfig | null;
   ...
   */
  static produce(key: string): VanityUrlConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, VanityUrlConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, VanityUrlConfig | null>;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): VanityUrlConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): VanityUrlConfig;
   ...
   */
  static forConfigKey(configKey: string | null): VanityUrlConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<VanityUrlConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: VanityUrlConfig, override?: string | null): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: VanityUrlConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: VanityUrlConfig, override?: string | null): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: VanityUrlConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): VanityUrlConfig | null;
   ...
   */
  removeSecrets(): VanityUrlConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): VanityUrlConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): VanityUrlConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): VanityUrlConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): VanityUrlConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): VanityUrlConfig;
