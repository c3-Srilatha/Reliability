// TypeScript definitions for the C3 type PartitionableCompactor

/**
 * Map Reduce job to compact the {@link Partitionable} types. {@see DataPartition#compact}
 *
 * @remarks this represents a value passed to a method that expects an instance of PartitionableCompactor
 */
declare interface IPartitionableCompactor {
  ...
  /**
   * The strategy to use in order to compact the partitions. If not set, then will use the strategy from @db(defaultPartitionStrategy)
   */
  spec?: IPartitionBucketStrategy | null;

  /**
   * Type for which this batch job is going run compaction
   */
  typeRef: IType;

  /**
   * Flag indicating if the operation is a compaction or fillBuckets
   */
  compact?: boolean;
}
 ...
 * Map Reduce job to compact the {@link Partitionable} types. {@see DataPartition#compact}
 *
 * @remarks this represents a made instance of PartitionableCompactor
 */
declare class PartitionableCompactor extends Obj {

  /**
   * current or last job execution for this instance
   */
  readonly run?: MapReduceRun | null;
  withRun(run: IMapReduceRun | null): PartitionableCompactor;

  /**
   * previous job executions for this instance
   */
  readonly runs?: C3.Array<MapReduceRun | null>;
  withRuns(runs: C3.Array<MapReduceRun | null> | Array<IMapReduceRun | null>): PartitionableCompactor;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj | null;
  withOptions(options: IObj | null): PartitionableCompactor;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): PartitionableCompactor;

  /**
   * Low priority to not interfere with user jobs
   */
  readonly priority?: number | null;
  withPriority(priority: number | null): PartitionableCompactor;
  ...
  withDisabled(disabled: boolean): PartitionableCompactor;
  ...
  withMaxConcurrency(maxConcurrency: number | null): PartitionableCompactor;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): PartitionableCompactor;
  ...
  withRunAsUser(runAsUser: boolean | null): PartitionableCompactor;

  /**
   * Don't set this field in the MapReduce job, set it in the MapReduceOptions when calling `start`.
   */
  readonly nodePool?: string | null;
  withNodePool(nodePool: string | null): PartitionableCompactor;
  ...
  withSkipIfRunning(skipIfRunning: boolean | null): PartitionableCompactor;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number | null;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): PartitionableCompactor;
  ...
  withPropagateActionContext(propagateActionContext: boolean): PartitionableCompactor;
  ...
  withTargetType(targetType: IType | null): PartitionableCompactor;
  ...
  withUseFileSystemForInterVals(useFileSystemForInterVals: boolean): PartitionableCompactor;
  ...
  withUseBatchIdsForReadInput(useBatchIdsForReadInput: boolean): PartitionableCompactor;
  ...
  withInclude(include: string | null): PartitionableCompactor;

  /**
   * optional filter spec
   */
  readonly filter?: string | null;
  withFilter(filter: string | null): PartitionableCompactor;
  ...
  withOrder(order: string | null): PartitionableCompactor;
  ...
  withLimit(limit: number | null): PartitionableCompactor;
  ...
  withSamplePct(samplePct: number | null): PartitionableCompactor;
  ...
  withBatchSize(batchSize: number | null): PartitionableCompactor;
  ...
  withSubBatchSize(subBatchSize: number | null): PartitionableCompactor;
  ...
  withNumBatches(numBatches: number | null): PartitionableCompactor;
  ...
  withAbortOnError(abortOnError: boolean): PartitionableCompactor;
  ...
  withTypeIdent(typeIdent: string | null): PartitionableCompactor;
   ...
   */
  readonly id: string;
  withId(id: string): PartitionableCompactor;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): PartitionableCompactor;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): PartitionableCompactor;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): PartitionableCompactor;
  ...
  withVersion(version: number | null): PartitionableCompactor;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): PartitionableCompactor;
  ...
  withTargetFilter(targetFilter: IObj | null): PartitionableCompactor;

  /**
   * The strategy to use in order to compact the partitions. If not set, then will use the strategy from @db(defaultPartitionStrategy)
   */
  readonly spec?: PartitionBucketStrategy | null;
  withSpec(spec: IPartitionBucketStrategy | null): PartitionableCompactor;

  /**
   * Type for which this batch job is going run compaction
   */
  readonly typeRef: Type;
  withTypeRef(typeRef: IType): PartitionableCompactor;

  /**
   * Flag indicating if the operation is a compaction or fillBuckets
   */
  readonly compact?: boolean;
  withCompact(compact: boolean): PartitionableCompactor;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): PartitionableCompactor | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): PartitionableCompactor | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): PartitionableCompactor | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): PartitionableCompactor | null;
   ...
   */
  replaceType(old: Type, new_: Type): PartitionableCompactor;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PartitionableCompactor;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PartitionableCompactor;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PartitionableCompactor | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PartitionableCompactor | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): PartitionableCompactor;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PartitionableCompactor;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PartitionableCompactor;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PartitionableCompactor;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PartitionableCompactor;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PartitionableCompactor;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): PartitionableCompactor;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PartitionableCompactor;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PartitionableCompactor;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): PartitionableCompactor;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): PartitionableCompactor;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): PartitionableCompactor;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): PartitionableCompactor;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PartitionableCompactor;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): PartitionableCompactor;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PartitionableCompactor;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PartitionableCompactor;
   ...
   * @see #removeField
   */
  unsetField(field: string): PartitionableCompactor;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PartitionableCompactor;
   ...
   * @see #unsetField
   */
  removeField(field: string): PartitionableCompactor;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PartitionableCompactor;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): PartitionableCompactor;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): PartitionableCompactor;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): PartitionableCompactor;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): PartitionableCompactor;

  mergeJson(json: any | null): PartitionableCompactor;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): PartitionableCompactor;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): PartitionableCompactor;
   ...
   */
  singletonArray(): C3.Array<PartitionableCompactor | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<PartitionableCompactor | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PartitionableCompactor | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<PartitionableCompactor | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PartitionableCompactor | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, PartitionableCompactor | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PartitionableCompactor | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PartitionableCompactor | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PartitionableCompactor | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): PartitionableCompactor;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): PartitionableCompactor;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): PartitionableCompactor;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PartitionableCompactor;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): PartitionableCompactor;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PartitionableCompactor;
   ...
   * @see #fromString
   */
  static make(s: string | null): PartitionableCompactor | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): PartitionableCompactor;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): PartitionableCompactor;
   ...
   */
  static cachedEmptyInst(): PartitionableCompactor;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<PartitionableCompactor>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): PartitionableCompactor;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<PartitionableCompactor | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PartitionableCompactor | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<PartitionableCompactor | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<PartitionableCompactor | null> | null>;
   ...
   */
  get(include?: string | null): PartitionableCompactor | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): PartitionableCompactor | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PartitionableCompactor;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): PartitionableCompactor | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PartitionableCompactor;
   ...
   * @see #toString
   */
  static fromString(s: string | null): PartitionableCompactor | null;
   ...
   */
  create(spec?: UpsertSpec | null): PartitionableCompactor | null;
   ...
   */
  static createBatch(objs: C3.Array<PartitionableCompactor | null> | null, spec?: UpsertSpec | null): ObjList<PartitionableCompactor | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PartitionableCompactor | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<PartitionableCompactor | null> | null;
   ...
   */
  update(srcObj?: PartitionableCompactor | null, spec?: UpsertSpec | null): PartitionableCompactor | null;
   ...
   */
  upsert(srcObj?: PartitionableCompactor | null, spec?: UpsertSpec | null): PartitionableCompactor | null;
   ...
   */
  merge(spec?: MergeSpec | null): PartitionableCompactor | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): PartitionableCompactor | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): PartitionableCompactor | null;
   ...
   */
  static updateBatch(objs: C3.Array<PartitionableCompactor | null> | null, srcObjs?: C3.Array<PartitionableCompactor | null>, spec?: UpsertSpec | null): ObjList<PartitionableCompactor | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<PartitionableCompactor | null>>, spec?: UpsertSpec | null): ObjList<PartitionableCompactor | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<PartitionableCompactor | null> | null, srcObjs?: C3.Array<PartitionableCompactor | null>, spec?: UpsertSpec | null): ObjList<PartitionableCompactor | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<PartitionableCompactor | null>>, spec?: UpsertSpec | null): ObjList<PartitionableCompactor | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<PartitionableCompactor | null> | null, spec?: TouchSpec | null): ObjList<PartitionableCompactor | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PartitionableCompactor | null> | null, spec?: MergeSpec | null): ObjList<PartitionableCompactor | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PartitionableCompactor | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<PartitionableCompactor | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<PartitionableCompactor | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<PartitionableCompactor | null> | null;
   ...
   */
  static mergeAll(mergeObj: PartitionableCompactor | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PartitionableCompactor | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<PartitionableCompactor | null> | null, spec?: UpsertSpec | null): ObjList<PartitionableCompactor | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<PartitionableCompactor | null> | null, spec?: UpsertSpec | null): ObjList<PartitionableCompactor | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): PartitionableCompactor | null;
   ...
   */
  static beforeCreate(objs: C3.Array<PartitionableCompactor | null> | null): ObjList<PartitionableCompactor | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<PartitionableCompactor | null> | null): ObjList<PartitionableCompactor | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<PartitionableCompactor | null> | null): ObjList<PartitionableCompactor | null>;
   ...
   */
  static afterCreate(objs: C3.Array<PartitionableCompactor | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<PartitionableCompactor | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<PartitionableCompactor | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<PartitionableCompactor | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<PartitionableCompactor | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): PartitionableCompactor | null;
   ...
   */
  withoutIdentity(): PartitionableCompactor | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<PartitionableCompactor | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: PartitionableCompactor | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<PartitionableCompactor | null> | null, callback?: λFunction<PartitionableCompactor | null, PartitionableCompactor | null> | null): ObjList<PartitionableCompactor | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<PartitionableCompactor | null> | null, callback?: λFunction<PartitionableCompactor | null, PartitionableCompactor | null> | null): C3.Array<ObjError | null>;
  ...
  /**
   * Starts the compaction job
   * @param targetType
   *            Specific type for which compaction needs to be kicked off
   * @param spec
   *            Override the spec to be used for compaction. If not set, then will use the strategy from @db(defaultPartitionStrategy)
   * @return compactor job instance
   */
  static startCompaction(targetType: Type, spec?: PartitionBucketStrategy | null): PartitionableCompactor;

  /**
   * Starts the fillBuckets job. Calls {@link Partitionable#fillBuckets}
   * @param targetType
   *            Specific type for which fillBuckets needs to be kicked off
   * @param spec
   *            Override the spec to be used for fillBuckets. If not set, then will use the strategy from @db(defaultPartitionStrategy)
   * @return job instance
   */
  static startFillBuckets(targetType: Type, spec?: PartitionBucketStrategy | null): PartitionableCompactor;

  /**
   * Upserts all seed data [ cron jobs ] for {@link Partitionable} types
   */
