// TypeScript definitions for the C3 type SignatureKey

/**
 * @remarks this represents a value passed to a method that expects an instance of SignatureKey
 */
declare interface ISignatureKey {
...
/**
 * @remarks this represents a made instance of SignatureKey
 */
declare class SignatureKey extends Obj {

  /**
   * The id of this instance.
   */
  readonly id: string;
  withId(id: string): SignatureKey;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): SignatureKey;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): SignatureKey;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): SignatureKey;
  ...
  withVersion(version: number | null): SignatureKey;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): SignatureKey;

  readonly publicKey?: string | null;
  withPublicKey(publicKey: string | null): SignatureKey;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SignatureKey | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SignatureKey | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SignatureKey | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SignatureKey | null;
   ...
   */
  replaceType(old: Type, new_: Type): SignatureKey;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SignatureKey;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SignatureKey;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SignatureKey | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SignatureKey | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SignatureKey;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SignatureKey;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SignatureKey;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SignatureKey;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SignatureKey;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SignatureKey;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SignatureKey;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SignatureKey;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SignatureKey;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SignatureKey;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SignatureKey;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SignatureKey;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SignatureKey;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SignatureKey;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SignatureKey;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SignatureKey;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SignatureKey;
   ...
   * @see #removeField
   */
  unsetField(field: string): SignatureKey;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SignatureKey;
   ...
   * @see #unsetField
   */
  removeField(field: string): SignatureKey;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SignatureKey;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SignatureKey;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SignatureKey;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SignatureKey;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SignatureKey;

  mergeJson(json: any | null): SignatureKey;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SignatureKey;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SignatureKey;
   ...
   */
  singletonArray(): C3.Array<SignatureKey | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SignatureKey | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SignatureKey | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SignatureKey | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SignatureKey | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SignatureKey | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SignatureKey | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SignatureKey | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SignatureKey | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SignatureKey;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SignatureKey;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SignatureKey;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SignatureKey;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SignatureKey;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SignatureKey;
   ...
   * @see #fromString
   */
  static make(s: string | null): SignatureKey | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SignatureKey;
   ...
   */
  static cachedEmptyInst(): SignatureKey;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SignatureKey>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SignatureKey;
   ...
   * @see #toString
   */
  static fromString(s: string | null): SignatureKey | null;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<SignatureKey | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SignatureKey | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<SignatureKey | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<SignatureKey | null> | null>;
   ...
   */
  get(include?: string | null): SignatureKey | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): SignatureKey | null;
   ...
   */
  getMissing(spec: GetMissingSpec): SignatureKey;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): SignatureKey | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): SignatureKey;
   ...
   */
  create(spec?: UpsertSpec | null): SignatureKey | null;
   ...
   */
  static createBatch(objs: C3.Array<SignatureKey | null> | null, spec?: UpsertSpec | null): ObjList<SignatureKey | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<SignatureKey | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<SignatureKey | null> | null;
   ...
   */
  update(srcObj?: SignatureKey | null, spec?: UpsertSpec | null): SignatureKey | null;
   ...
   */
  upsert(srcObj?: SignatureKey | null, spec?: UpsertSpec | null): SignatureKey | null;
   ...
   */
  merge(spec?: MergeSpec | null): SignatureKey | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): SignatureKey | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): SignatureKey | null;
   ...
   */
  static updateBatch(objs: C3.Array<SignatureKey | null> | null, srcObjs?: C3.Array<SignatureKey | null>, spec?: UpsertSpec | null): ObjList<SignatureKey | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<SignatureKey | null>>, spec?: UpsertSpec | null): ObjList<SignatureKey | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<SignatureKey | null> | null, srcObjs?: C3.Array<SignatureKey | null>, spec?: UpsertSpec | null): ObjList<SignatureKey | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<SignatureKey | null>>, spec?: UpsertSpec | null): ObjList<SignatureKey | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<SignatureKey | null> | null, spec?: TouchSpec | null): ObjList<SignatureKey | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SignatureKey | null> | null, spec?: MergeSpec | null): ObjList<SignatureKey | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SignatureKey | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<SignatureKey | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<SignatureKey | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<SignatureKey | null> | null;
   ...
   */
  static mergeAll(mergeObj: SignatureKey | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: SignatureKey | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<SignatureKey | null> | null, spec?: UpsertSpec | null): ObjList<SignatureKey | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<SignatureKey | null> | null, spec?: UpsertSpec | null): ObjList<SignatureKey | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<SignatureKey | null> | null): ObjList<SignatureKey | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<SignatureKey | null> | null): ObjList<SignatureKey | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<SignatureKey | null> | null): ObjList<SignatureKey | null>;
   ...
   */
  static afterCreate(objs: C3.Array<SignatureKey | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<SignatureKey | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<SignatureKey | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<SignatureKey | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<SignatureKey | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): SignatureKey | null;
   ...
   */
  withoutIdentity(): SignatureKey | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<SignatureKey | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: SignatureKey | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<SignatureKey | null> | null, callback?: λFunction<SignatureKey | null, SignatureKey | null> | null): ObjList<SignatureKey | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<SignatureKey | null> | null, callback?: λFunction<SignatureKey | null, SignatureKey | null> | null): C3.Array<ObjError | null>;
