// TypeScript definitions for the C3 type PartitionBucketSpec

/**
 * @remarks this represents a value passed to a method that expects an instance of PartitionBucketSpec
 */
declare interface IPartitionBucketSpec {
...
/**
 * @remarks this represents a made instance of PartitionBucketSpec
 */
declare class PartitionBucketSpec extends Obj {
  ...
  withNewColReadCount(newColReadCount: number | null): PartitionBucketSpec;
  ...
  withNewColMaxObjCount(newColMaxObjCount: number | null): PartitionBucketSpec;
  ...
  withRewriteAllIncremental(rewriteAllIncremental: boolean): PartitionBucketSpec;
  ...
  withPriority(priority: number | null): PartitionBucketSpec;
  ...
  withDisabled(disabled: boolean): PartitionBucketSpec;
  ...
  withMaxConcurrency(maxConcurrency: number | null): PartitionBucketSpec;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): PartitionBucketSpec;
  ...
  withRunAsUser(runAsUser: boolean | null): PartitionBucketSpec;
  ...
  withNodePool(nodePool: string | null): PartitionBucketSpec;
  ...
  withSkipIfRunning(skipIfRunning: boolean | null): PartitionBucketSpec;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number | null;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): PartitionBucketSpec;
  ...
  withPropagateActionContext(propagateActionContext: boolean): PartitionBucketSpec;
  ...
  withTargetType(targetType: IType | null): PartitionBucketSpec;
  ...
  withUseFileSystemForInterVals(useFileSystemForInterVals: boolean): PartitionBucketSpec;
  ...
  withUseBatchIdsForReadInput(useBatchIdsForReadInput: boolean): PartitionBucketSpec;
  ...
  withInclude(include: string | null): PartitionBucketSpec;

  /**
   * optional filter spec
   */
  readonly filter?: string | null;
  withFilter(filter: string | null): PartitionBucketSpec;
  ...
  withOrder(order: string | null): PartitionBucketSpec;
  ...
  withLimit(limit: number | null): PartitionBucketSpec;
  ...
  withSamplePct(samplePct: number | null): PartitionBucketSpec;
  ...
  withBatchSize(batchSize: number | null): PartitionBucketSpec;
  ...
  withSubBatchSize(subBatchSize: number | null): PartitionBucketSpec;
  ...
  withNumBatches(numBatches: number | null): PartitionBucketSpec;
  ...
  withAbortOnError(abortOnError: boolean): PartitionBucketSpec;

  /**
   * If set, only places the specified number of objects per hot bucket
   */
  readonly numObjsPerHotBucket?: number | null;
  withNumObjsPerHotBucket(numObjsPerHotBucket: number | null): PartitionBucketSpec;
  ...
  withSizeMbPerHotBucket(sizeMbPerHotBucket: number | null): PartitionBucketSpec;
  ...
  withNumHotBuckets(numHotBuckets: number | null): PartitionBucketSpec;
  ...
  withMaxHotSortKey(maxHotSortKey: string | null): PartitionBucketSpec;
  ...
  withColdBucketMultiplier(coldBucketMultiplier: number | null): PartitionBucketSpec;

  /**
   * Schedule at which compaction needs to run. {@see DataPartition#compact}. Defaults to 1st every month at 00:00
   */
  readonly compactionSchedule?: string | null;
  withCompactionSchedule(compactionSchedule: string | null): PartitionBucketSpec;

  /**
   * If set, no error will be thrown if packing fails and will log an error instead.
   */
  readonly doNotThrowOnFailure?: boolean;
  withDoNotThrowOnFailure(doNotThrowOnFailure: boolean): PartitionBucketSpec;
  ...
  withMaxRetries(maxRetries: number | null): PartitionBucketSpec;
  ...
  withFullCompact(fullCompact: boolean): PartitionBucketSpec;
  ...
  withRepair(repair: boolean): PartitionBucketSpec;
  ...
  withBucketIdSupplier(bucketIdSupplier: λFunction<Partitionable<any> | null, string> | null): PartitionBucketSpec;
  ...
  withForce(force: boolean): PartitionBucketSpec;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): PartitionBucketSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): PartitionBucketSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): PartitionBucketSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): PartitionBucketSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): PartitionBucketSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PartitionBucketSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PartitionBucketSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PartitionBucketSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PartitionBucketSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): PartitionBucketSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PartitionBucketSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PartitionBucketSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PartitionBucketSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PartitionBucketSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PartitionBucketSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): PartitionBucketSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PartitionBucketSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PartitionBucketSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): PartitionBucketSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): PartitionBucketSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): PartitionBucketSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): PartitionBucketSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PartitionBucketSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): PartitionBucketSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PartitionBucketSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PartitionBucketSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): PartitionBucketSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PartitionBucketSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): PartitionBucketSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PartitionBucketSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): PartitionBucketSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): PartitionBucketSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): PartitionBucketSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): PartitionBucketSpec;

  mergeJson(json: any | null): PartitionBucketSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): PartitionBucketSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): PartitionBucketSpec;
   ...
   */
  singletonArray(): C3.Array<PartitionBucketSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<PartitionBucketSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PartitionBucketSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<PartitionBucketSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PartitionBucketSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, PartitionBucketSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PartitionBucketSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PartitionBucketSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PartitionBucketSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): PartitionBucketSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): PartitionBucketSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): PartitionBucketSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PartitionBucketSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): PartitionBucketSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PartitionBucketSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): PartitionBucketSpec;
   ...
   */
  static cachedEmptyInst(): PartitionBucketSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<PartitionBucketSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): PartitionBucketSpec;
}
