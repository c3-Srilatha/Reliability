// TypeScript definitions for the C3 type DataLake.Table.ImportJob

/**
 * @remarks this represents a value passed to a method that expects an instance of DataLake.Table.ImportJob
 */
 ...
 */
declare namespace DataLake.Table {
  export class ImportJob extends Obj {

    /**
     * current or last job execution for this instance
     */
    readonly run?: BatchJobRun | null;
    withRun(run: IBatchJobRun | null): DataLake.Table.ImportJob;

    /**
     * previous job executions for this instance
     */
    readonly runs?: C3.Array<BatchJobRun | null>;
    withRuns(runs: C3.Array<BatchJobRun | null> | Array<IBatchJobRun | null>): DataLake.Table.ImportJob;

    /**
     * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
     */
    readonly options?: Obj | null;
    withOptions(options: IObj | null): DataLake.Table.ImportJob;
    ...
    withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): DataLake.Table.ImportJob;
    ...
    withPriority(priority: number | null): DataLake.Table.ImportJob;
    ...
    withDisabled(disabled: boolean): DataLake.Table.ImportJob;
    ...
    withMaxConcurrency(maxConcurrency: number | null): DataLake.Table.ImportJob;
    ...
    withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): DataLake.Table.ImportJob;
    ...
    withRunAsUser(runAsUser: boolean | null): DataLake.Table.ImportJob;

    /**
     * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
     */
    readonly nodePool?: string | null;
    withNodePool(nodePool: string | null): DataLake.Table.ImportJob;
    ...
    withSkipIfRunning(skipIfRunning: boolean | null): DataLake.Table.ImportJob;

    /**
     * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
     */
    readonly numAutoRecoveryAttempts?: number | null;
    withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): DataLake.Table.ImportJob;
    ...
    withPropagateActionContext(propagateActionContext: boolean): DataLake.Table.ImportJob;
    ...
    withTypeIdent(typeIdent: string | null): DataLake.Table.ImportJob;
     ...
     */
    readonly id: string;
    withId(id: string): DataLake.Table.ImportJob;
    ...
    withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): DataLake.Table.ImportJob;

    /**
     * Name of the Obj instance
     */
    readonly name?: string | null;
    withName(name: string | null): DataLake.Table.ImportJob;

    /**
     * Various system fields.
     */
    readonly meta?: Meta | null;
    withMeta(meta: IMeta | null): DataLake.Table.ImportJob;
    ...
    withVersion(version: number | null): DataLake.Table.ImportJob;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type | null;
    withTypeWithBindings(typeWithBindings: IType | null): DataLake.Table.ImportJob;
    ...
    withAbortOnError(abortOnError: boolean): DataLake.Table.ImportJob;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): DataLake.Table.ImportJob | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): DataLake.Table.ImportJob | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): DataLake.Table.ImportJob | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): DataLake.Table.ImportJob | null;
     ...
     */
    replaceType(old: Type, new_: Type): DataLake.Table.ImportJob;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataLake.Table.ImportJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataLake.Table.ImportJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataLake.Table.ImportJob | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataLake.Table.ImportJob | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataLake.Table.ImportJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataLake.Table.ImportJob;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataLake.Table.ImportJob;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): DataLake.Table.ImportJob;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): DataLake.Table.ImportJob;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): DataLake.Table.ImportJob;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataLake.Table.ImportJob;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataLake.Table.ImportJob;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): DataLake.Table.ImportJob;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): DataLake.Table.ImportJob;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): DataLake.Table.ImportJob;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): DataLake.Table.ImportJob;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataLake.Table.ImportJob;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): DataLake.Table.ImportJob;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataLake.Table.ImportJob;
     ...
     * @see #unsetField
     */
    defaultField(field: string): DataLake.Table.ImportJob;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): DataLake.Table.ImportJob;
     ...
     * @see #removeField
     */
    unsetField(field: string): DataLake.Table.ImportJob;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): DataLake.Table.ImportJob;
     ...
     * @see #unsetField
     */
    removeField(field: string): DataLake.Table.ImportJob;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): DataLake.Table.ImportJob;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataLake.Table.ImportJob;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): DataLake.Table.ImportJob;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataLake.Table.ImportJob;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataLake.Table.ImportJob;

    mergeJson(json: any | null): DataLake.Table.ImportJob;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataLake.Table.ImportJob;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): DataLake.Table.ImportJob;
     ...
     */
    singletonArray(): C3.Array<DataLake.Table.ImportJob | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<DataLake.Table.ImportJob | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<DataLake.Table.ImportJob | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<DataLake.Table.ImportJob | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<DataLake.Table.ImportJob | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, DataLake.Table.ImportJob | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataLake.Table.ImportJob | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<DataLake.Table.ImportJob | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<DataLake.Table.ImportJob | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DataLake.Table.ImportJob;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DataLake.Table.ImportJob;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DataLake.Table.ImportJob;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): DataLake.Table.ImportJob;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DataLake.Table.ImportJob;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): DataLake.Table.ImportJob;
     ...
     * @see #fromString
     */
    static make(s: string | null): DataLake.Table.ImportJob | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DataLake.Table.ImportJob;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): DataLake.Table.ImportJob;
     ...
     */
    static cachedEmptyInst(): DataLake.Table.ImportJob;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DataLake.Table.ImportJob>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): DataLake.Table.ImportJob;
     ...
     */
    start(options?: DataLake.Table.ImportJob.Spec | null): BatchJobStatus | null;
     ...
     */
    cleanup(options?: DataLake.Table.ImportJob.Spec | null): void;
    ...
    cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun | null, BatchJobStatus | null, DataLake.Table.ImportJob.Spec | null> | null;

    failJob(run: JobRun<BatchJobStatusBase | null>): JobBase<BatchJobRun | null, BatchJobStatus | null, DataLake.Table.ImportJob.Spec | null> | null;
    ...
    validateStart(options?: DataLake.Table.ImportJob.Spec | null): void;
     ...
     */
    static fetch(spec?: FetchSpec | null): FetchResult<DataLake.Table.ImportJob | null>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<DataLake.Table.ImportJob | null>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec | null): Stream<DataLake.Table.ImportJob | null>;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<DataLake.Table.ImportJob | null> | null>;
     ...
     */
    get(include?: string | null): DataLake.Table.ImportJob | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string | null): DataLake.Table.ImportJob | null;
     ...
     */
    getMissing(spec: GetMissingSpec): DataLake.Table.ImportJob;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string | null): DataLake.Table.ImportJob | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): DataLake.Table.ImportJob;
     ...
     * @see #toString
     */
    static fromString(s: string | null): DataLake.Table.ImportJob | null;
     ...
     */
    create(spec?: UpsertSpec | null): DataLake.Table.ImportJob | null;
     ...
     */
    static createBatch(objs: C3.Array<DataLake.Table.ImportJob | null> | null, spec?: UpsertSpec | null): ObjList<DataLake.Table.ImportJob | null> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<DataLake.Table.ImportJob | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<DataLake.Table.ImportJob | null> | null;
     ...
     */
    update(srcObj?: DataLake.Table.ImportJob | null, spec?: UpsertSpec | null): DataLake.Table.ImportJob | null;
     ...
     */
    upsert(srcObj?: DataLake.Table.ImportJob | null, spec?: UpsertSpec | null): DataLake.Table.ImportJob | null;
     ...
     */
    merge(spec?: MergeSpec | null): DataLake.Table.ImportJob | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec | null): DataLake.Table.ImportJob | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec | null): DataLake.Table.ImportJob | null;
     ...
     */
    static updateBatch(objs: C3.Array<DataLake.Table.ImportJob | null> | null, srcObjs?: C3.Array<DataLake.Table.ImportJob | null>, spec?: UpsertSpec | null): ObjList<DataLake.Table.ImportJob | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<C3.Array<DataLake.Table.ImportJob | null>>, spec?: UpsertSpec | null): ObjList<DataLake.Table.ImportJob | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: C3.Array<DataLake.Table.ImportJob | null> | null, srcObjs?: C3.Array<DataLake.Table.ImportJob | null>, spec?: UpsertSpec | null): ObjList<DataLake.Table.ImportJob | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<C3.Array<DataLake.Table.ImportJob | null>>, spec?: UpsertSpec | null): ObjList<DataLake.Table.ImportJob | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: C3.Array<DataLake.Table.ImportJob | null> | null, spec?: TouchSpec | null): ObjList<DataLake.Table.ImportJob | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<DataLake.Table.ImportJob | null> | null, spec?: MergeSpec | null): ObjList<DataLake.Table.ImportJob | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<DataLake.Table.ImportJob | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<DataLake.Table.ImportJob | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<C3.Array<DataLake.Table.ImportJob | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<DataLake.Table.ImportJob | null> | null;
     ...
     */
    static mergeAll(mergeObj: DataLake.Table.ImportJob | null, spec?: MergeAllSpec | null): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: DataLake.Table.ImportJob | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: C3.Array<DataLake.Table.ImportJob | null> | null, spec?: UpsertSpec | null): ObjList<DataLake.Table.ImportJob | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: C3.Array<DataLake.Table.ImportJob | null> | null, spec?: UpsertSpec | null): ObjList<DataLake.Table.ImportJob | null> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): DataLake.Table.ImportJob | null;
     ...
     */
    static beforeCreate(objs: C3.Array<DataLake.Table.ImportJob | null> | null): ObjList<DataLake.Table.ImportJob | null>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: C3.Array<DataLake.Table.ImportJob | null> | null): ObjList<DataLake.Table.ImportJob | null>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: C3.Array<DataLake.Table.ImportJob | null> | null): ObjList<DataLake.Table.ImportJob | null>;
     ...
     */
    static afterCreate(objs: C3.Array<DataLake.Table.ImportJob | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: C3.Array<DataLake.Table.ImportJob | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: C3.Array<DataLake.Table.ImportJob | null> | null): C3.Array<ObjError | null>;
     ...
     */
    static startImportData(spec?: StartImportDataSpec | null): PushStream<DataLake.Table.ImportJob | null>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<DataLake.Table.ImportJob | null>;
     ...
     */
    static forId(id: string | null, failIfMissing?: boolean): DataLake.Table.ImportJob | null;
     ...
     */
    withoutIdentity(): DataLake.Table.ImportJob | null;
     ...
     */
    static typeOfBatch(objs: C3.Array<DataLake.Table.ImportJob | null> | null): C3.Array<EntityType | null>;
     ...
     */
    static dbEcho(template?: DataLake.Table.ImportJob | null, count?: number | null, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: C3.Array<DataLake.Table.ImportJob | null> | null, callback?: λFunction<DataLake.Table.ImportJob | null, DataLake.Table.ImportJob | null> | null): ObjList<DataLake.Table.ImportJob | null>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: C3.Array<DataLake.Table.ImportJob | null> | null, callback?: λFunction<DataLake.Table.ImportJob | null, DataLake.Table.ImportJob | null> | null): C3.Array<ObjError | null>;
     ...
     */
    static doStart(job?: DataLake.Table.ImportJob | null, options?: DataLake.Table.ImportJob.Spec | null): void;
     ...
     */
    static processBatch(batch?: DataLake.Table.ImportJob.Spec | null, job?: DataLake.Table.ImportJob | null, options?: DataLake.Table.ImportJob.Spec | null): void;
     ...
     */
    static allComplete(job: DataLake.Table.ImportJob, options?: DataLake.Table.ImportJob.Spec | null): string | null;
     ...
     *           Options the job was run with.
     */
    static failed(job: DataLake.Table.ImportJob, status: BatchJobStatus, options?: DataLake.Table.ImportJob.Spec | null): void;
     ...
     *        Batch to schedule.
     */
    scheduleBatch(batch?: DataLake.Table.ImportJob.Spec | null): void;
     ...
     *        Batches to schedule.
     */
    scheduleBatches(batches?: C3.Array<DataLake.Table.ImportJob.Spec | null>): void;
     ...
     */
    static scheduleObjBatch(job?: DataLake.Table.ImportJob | null, objBatch?: ObjBatch | null, logPrefix?: string | null): number | null;
