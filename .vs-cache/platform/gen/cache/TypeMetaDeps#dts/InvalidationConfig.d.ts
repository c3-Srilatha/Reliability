// TypeScript definitions for the C3 type InvalidationConfig

/**
 * Configuration for handling invalidations.  The most common usage is to override this at the TAG level.
 *
 * @remarks this represents a value passed to a method that expects an instance of InvalidationConfig
 */
declare interface IInvalidationConfig {
  ...
  /**
   * Apps that will be invalidated for operations that support multi-app invalidation (e.g. stored calc).
   */
  appIds?: C3.Array<string | null> | Array<string | null>;

  /**
   * The probability used to determine how often to attempt to merge existing queue entries with existing ones (for
   * mergeable queues only.
   */
  defaultMergeProbability?: number | null;

  /**
   * If true, upserts will not trigger async invalidation/processing (except for the async callbacks).
   */
 ...
 * Configuration for handling invalidations.  The most common usage is to override this at the TAG level.
 *
 * @remarks this represents a made instance of InvalidationConfig
 */
declare class InvalidationConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): InvalidationConfig;

  static readonly configOverride?: string | null;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): InvalidationConfig;
  ...
  withIssues(issues: C3.Array<string | null> | Array<string | null>): InvalidationConfig;
   ...
   * Apps that will be invalidated for operations that support multi-app invalidation (e.g. stored calc).
   */
  readonly appIds?: C3.Array<string | null>;
  withAppIds(appIds: C3.Array<string | null> | Array<string | null>): InvalidationConfig;

  /**
   * Apps that will be invalidated for operations that support multi-app invalidation (e.g. stored calc).
   */
  static readonly appIds?: C3.Array<string | null>;

  /**
   * The probability used to determine how often to attempt to merge existing queue entries with existing ones (for
   * mergeable queues only.
   */
  readonly defaultMergeProbability?: number | null;
  withDefaultMergeProbability(defaultMergeProbability: number | null): InvalidationConfig;

  /**
   * The probability used to determine how often to attempt to merge existing queue entries with existing ones (for
   * mergeable queues only.
   */
  static readonly defaultMergeProbability?: number | null;

  /**
   * If true, upserts will not trigger async invalidation/processing (except for the async callbacks).
   */
  readonly upsertAsyncProcessingDisabled?: boolean;
  withUpsertAsyncProcessingDisabled(upsertAsyncProcessingDisabled: boolean): InvalidationConfig;

  /**
   * If true, upserts will not trigger async invalidation/processing (except for the async callbacks).
   */
  static readonly upsertAsyncProcessingDisabled?: boolean;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): InvalidationConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): InvalidationConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): InvalidationConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): InvalidationConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): InvalidationConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): InvalidationConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): InvalidationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): InvalidationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): InvalidationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): InvalidationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<InvalidationConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<InvalidationConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<InvalidationConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<InvalidationConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): InvalidationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): InvalidationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): InvalidationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): InvalidationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): InvalidationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): InvalidationConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): InvalidationConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): InvalidationConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): InvalidationConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): InvalidationConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): InvalidationConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): InvalidationConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): InvalidationConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): InvalidationConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): InvalidationConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): InvalidationConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): InvalidationConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): InvalidationConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): InvalidationConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): InvalidationConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): InvalidationConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): InvalidationConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): InvalidationConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): InvalidationConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): InvalidationConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): InvalidationConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): InvalidationConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): InvalidationConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): InvalidationConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): InvalidationConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): InvalidationConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): InvalidationConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): InvalidationConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): InvalidationConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): InvalidationConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): InvalidationConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): InvalidationConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): InvalidationConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): InvalidationConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): InvalidationConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): InvalidationConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): InvalidationConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): InvalidationConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): InvalidationConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): InvalidationConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): InvalidationConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): InvalidationConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): InvalidationConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): InvalidationConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): InvalidationConfig;

  mergeJson(json: any | null): InvalidationConfig;

  static mergeJson(json: any | null): InvalidationConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): InvalidationConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): InvalidationConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): InvalidationConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): InvalidationConfig;
   ...
   */
  singletonArray(): C3.Array<InvalidationConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<InvalidationConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<InvalidationConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<InvalidationConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<InvalidationConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<InvalidationConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<InvalidationConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, InvalidationConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, InvalidationConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<InvalidationConfig | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<InvalidationConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<InvalidationConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): InvalidationConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): InvalidationConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): InvalidationConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): InvalidationConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): InvalidationConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): InvalidationConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): InvalidationConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): InvalidationConfig;
   ...
   */
  static cachedEmptyInst(): InvalidationConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<InvalidationConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): InvalidationConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<InvalidationConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<InvalidationConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<InvalidationConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): InvalidationConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): InvalidationConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): InvalidationConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): InvalidationConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): InvalidationConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): InvalidationConfig | null;
   ...
   */
  static produce(key: string): InvalidationConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, InvalidationConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, InvalidationConfig | null>;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): InvalidationConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): InvalidationConfig;
   ...
   */
  static forConfigKey(configKey: string | null): InvalidationConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<InvalidationConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: InvalidationConfig, override?: string | null): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: InvalidationConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: InvalidationConfig, override?: string | null): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: InvalidationConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): InvalidationConfig | null;
   ...
   */
  removeSecrets(): InvalidationConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): InvalidationConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): InvalidationConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): InvalidationConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): InvalidationConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): InvalidationConfig;
   ...
   */
  static inst(): InvalidationConfig;

  /**
   * @return the cached instance if already cached, null otherwise. Does not instantiate if missing.
   */
  static cachedInst(): InvalidationConfig | null;

  static apps(): C3.Array<App | null>;
}
