// TypeScript definitions for the C3 type BlobFileSystem

/**
 * Abstract base type for FileSystems that are based on a blob or object store such as S3 and Azure Data Lake.
 *
 * @remarks this represents a value passed to a method that expects an instance of BlobFileSystem
 */
declare interface IBlobFileSystem<F> {
}

/**
 * Abstract base type for FileSystems that are based on a blob or object store such as S3 and Azure Data Lake.
 *
 * @remarks this represents a made instance of BlobFileSystem
 */
declare class BlobFileSystem<F> extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): BlobFileSystem<F> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): BlobFileSystem<F> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): BlobFileSystem<F> | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): BlobFileSystem<F> | null;
   ...
   */
  replaceType(old: Type, new_: Type): BlobFileSystem<F>;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): BlobFileSystem<F>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BlobFileSystem<F>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BlobFileSystem<F>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BlobFileSystem<F>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BlobFileSystem<F>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BlobFileSystem<F> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BlobFileSystem<F> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BlobFileSystem<F> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BlobFileSystem<F> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): BlobFileSystem<F>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): BlobFileSystem<F>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BlobFileSystem<F>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BlobFileSystem<F>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BlobFileSystem<F>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BlobFileSystem<F>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): BlobFileSystem<F>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): BlobFileSystem<F>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): BlobFileSystem<F>;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): BlobFileSystem<F>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): BlobFileSystem<F>;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): BlobFileSystem<F>;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): BlobFileSystem<F>;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): BlobFileSystem<F>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BlobFileSystem<F>;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BlobFileSystem<F>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): BlobFileSystem<F>;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): BlobFileSystem<F>;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): BlobFileSystem<F>;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): BlobFileSystem<F>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): BlobFileSystem<F>;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): BlobFileSystem<F>;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): BlobFileSystem<F>;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): BlobFileSystem<F>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): BlobFileSystem<F>;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): BlobFileSystem<F>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): BlobFileSystem<F>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): BlobFileSystem<F>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): BlobFileSystem<F>;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): BlobFileSystem<F>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): BlobFileSystem<F>;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): BlobFileSystem<F>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): BlobFileSystem<F>;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): BlobFileSystem<F>;
   ...
   * @see #removeField
   */
  unsetField(field: string): BlobFileSystem<F>;
   ...
   * @see #removeField
   */
  static unsetField(field: string): BlobFileSystem<F>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): BlobFileSystem<F>;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): BlobFileSystem<F>;
   ...
   * @see #unsetField
   */
  removeField(field: string): BlobFileSystem<F>;
   ...
   * @see #unsetField
   */
  static removeField(field: string): BlobFileSystem<F>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): BlobFileSystem<F>;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): BlobFileSystem<F>;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): BlobFileSystem<F>;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): BlobFileSystem<F>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): BlobFileSystem<F>;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): BlobFileSystem<F>;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): BlobFileSystem<F>;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): BlobFileSystem<F>;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): BlobFileSystem<F>;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): BlobFileSystem<F>;

  mergeJson(json: any | null): BlobFileSystem<F>;

  static mergeJson(json: any | null): BlobFileSystem<F>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): BlobFileSystem<F>;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): BlobFileSystem<F>;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): BlobFileSystem<F>;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): BlobFileSystem<F>;
   ...
   */
  singletonArray(): C3.Array<BlobFileSystem<F> | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<BlobFileSystem<F> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<BlobFileSystem<F> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BlobFileSystem<F> | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<BlobFileSystem<F> | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<BlobFileSystem<F> | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BlobFileSystem<F> | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, BlobFileSystem<F> | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BlobFileSystem<F> | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BlobFileSystem<F> | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<BlobFileSystem<F> | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BlobFileSystem<F> | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): BlobFileSystem<F>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): BlobFileSystem<F>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): BlobFileSystem<F>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): BlobFileSystem<F>;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): BlobFileSystem<F>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): BlobFileSystem<F>;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): BlobFileSystem<F>;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): BlobFileSystem<F>;
   ...
   */
  static cachedEmptyInst(): BlobFileSystem<F>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<BlobFileSystem<F>>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): BlobFileSystem<F>;
  ...
  doReadBlobMeta(containerName: string, blobKey: string, spec?: FileOperationSpec | null): F | null;

  static doReadBlobMeta(containerName: string, blobKey: string, spec?: FileOperationSpec | null): F | null;

  doBlobEncodedStream(containerName: string, blobKey: string, spec?: FileOperationSpec | null): Pair<F, ByteStream> | null;

  static doBlobEncodedStream(containerName: string, blobKey: string, spec?: FileOperationSpec | null): Pair<F, ByteStream> | null;
  ...
  doCopyBlob(srcContainerName: string, srcBlobKey: string, destContainerName: string, destBlobKey: string, spec?: FileOperationSpec | null): F | null;

  static doCopyBlob(srcContainerName: string, srcBlobKey: string, destContainerName: string, destBlobKey: string, spec?: FileOperationSpec | null): F | null;
   ...
   */
  doCopyBlobs(srcContainerNames: C3.Array<string | null>, srcBlobKeys: C3.Array<string | null>, destContainerNames: C3.Array<string | null>, destBlobKeys: C3.Array<string | null>, spec?: FileOperationSpec | null): C3.Array<F | null>;

  /**
   * Copies blob files using cloud provider APIs. When the source scheme and destination schemes are the same,
   * files are copied by using batch APIs. Otherwise, each file is copied individually.
   */
  static doCopyBlobs(srcContainerNames: C3.Array<string | null>, srcBlobKeys: C3.Array<string | null>, destContainerNames: C3.Array<string | null>, destBlobKeys: C3.Array<string | null>, spec?: FileOperationSpec | null): C3.Array<F | null>;

  doReplaceBlobContentTypeAndEncoding(containerName: string, srcBlobKey: string, contentType?: string | null, contentEncoding: string, spec?: FileOperationSpec | null): F | null;

  static doReplaceBlobContentTypeAndEncoding(containerName: string, srcBlobKey: string, contentType?: string | null, contentEncoding: string, spec?: FileOperationSpec | null): F | null;
