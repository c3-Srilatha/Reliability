// TypeScript definitions for the C3 type IdpCertificate

/**
 * @remarks this represents a value passed to a method that expects an instance of IdpCertificate
 */
declare interface IIdpCertificate {
...
/**
 * @remarks this represents a made instance of IdpCertificate
 */
declare class IdpCertificate extends Obj {
   ...
   */
  readonly id: string;
  withId(id: string): IdpCertificate;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): IdpCertificate;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): IdpCertificate;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): IdpCertificate;
  ...
  withVersion(version: number | null): IdpCertificate;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): IdpCertificate;

  readonly idpUrl: string;
  withIdpUrl(idpUrl: string): IdpCertificate;

  readonly format?: string | null;
  withFormat(format: string | null): IdpCertificate;

  readonly certificate: string;
  withCertificate(certificate: string): IdpCertificate;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): IdpCertificate | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): IdpCertificate | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): IdpCertificate | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): IdpCertificate | null;
   ...
   */
  replaceType(old: Type, new_: Type): IdpCertificate;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): IdpCertificate;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): IdpCertificate;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<IdpCertificate | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<IdpCertificate | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): IdpCertificate;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): IdpCertificate;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): IdpCertificate;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): IdpCertificate;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): IdpCertificate;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): IdpCertificate;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): IdpCertificate;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): IdpCertificate;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): IdpCertificate;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): IdpCertificate;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): IdpCertificate;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): IdpCertificate;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): IdpCertificate;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): IdpCertificate;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): IdpCertificate;
   ...
   * @see #unsetField
   */
  defaultField(field: string): IdpCertificate;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): IdpCertificate;
   ...
   * @see #removeField
   */
  unsetField(field: string): IdpCertificate;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): IdpCertificate;
   ...
   * @see #unsetField
   */
  removeField(field: string): IdpCertificate;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): IdpCertificate;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): IdpCertificate;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): IdpCertificate;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): IdpCertificate;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): IdpCertificate;

  mergeJson(json: any | null): IdpCertificate;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): IdpCertificate;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): IdpCertificate;
   ...
   */
  singletonArray(): C3.Array<IdpCertificate | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<IdpCertificate | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<IdpCertificate | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<IdpCertificate | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<IdpCertificate | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, IdpCertificate | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, IdpCertificate | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<IdpCertificate | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<IdpCertificate | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): IdpCertificate;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): IdpCertificate;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): IdpCertificate;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): IdpCertificate;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): IdpCertificate;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): IdpCertificate;
   ...
   * @see #fromString
   */
  static make(s: string | null): IdpCertificate | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): IdpCertificate;
   ...
   */
  static cachedEmptyInst(): IdpCertificate;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<IdpCertificate>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): IdpCertificate;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<IdpCertificate | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<IdpCertificate | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<IdpCertificate | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<IdpCertificate | null> | null>;
   ...
   */
  get(include?: string | null): IdpCertificate | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): IdpCertificate | null;
   ...
   */
  getMissing(spec: GetMissingSpec): IdpCertificate;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): IdpCertificate | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): IdpCertificate;
   ...
   * @see #toString
   */
  static fromString(s: string | null): IdpCertificate | null;
   ...
   */
  create(spec?: UpsertSpec | null): IdpCertificate | null;
   ...
   */
  static createBatch(objs: C3.Array<IdpCertificate | null> | null, spec?: UpsertSpec | null): ObjList<IdpCertificate | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<IdpCertificate | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<IdpCertificate | null> | null;
   ...
   */
  update(srcObj?: IdpCertificate | null, spec?: UpsertSpec | null): IdpCertificate | null;
   ...
   */
  upsert(srcObj?: IdpCertificate | null, spec?: UpsertSpec | null): IdpCertificate | null;
   ...
   */
  merge(spec?: MergeSpec | null): IdpCertificate | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): IdpCertificate | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): IdpCertificate | null;
   ...
   */
  static updateBatch(objs: C3.Array<IdpCertificate | null> | null, srcObjs?: C3.Array<IdpCertificate | null>, spec?: UpsertSpec | null): ObjList<IdpCertificate | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<IdpCertificate | null>>, spec?: UpsertSpec | null): ObjList<IdpCertificate | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<IdpCertificate | null> | null, srcObjs?: C3.Array<IdpCertificate | null>, spec?: UpsertSpec | null): ObjList<IdpCertificate | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<IdpCertificate | null>>, spec?: UpsertSpec | null): ObjList<IdpCertificate | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<IdpCertificate | null> | null, spec?: TouchSpec | null): ObjList<IdpCertificate | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<IdpCertificate | null> | null, spec?: MergeSpec | null): ObjList<IdpCertificate | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<IdpCertificate | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<IdpCertificate | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<IdpCertificate | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<IdpCertificate | null> | null;
   ...
   */
  static mergeAll(mergeObj: IdpCertificate | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: IdpCertificate | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<IdpCertificate | null> | null, spec?: UpsertSpec | null): ObjList<IdpCertificate | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<IdpCertificate | null> | null, spec?: UpsertSpec | null): ObjList<IdpCertificate | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<IdpCertificate | null> | null): ObjList<IdpCertificate | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<IdpCertificate | null> | null): ObjList<IdpCertificate | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<IdpCertificate | null> | null): ObjList<IdpCertificate | null>;
   ...
   */
  static afterCreate(objs: C3.Array<IdpCertificate | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<IdpCertificate | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<IdpCertificate | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<IdpCertificate | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<IdpCertificate | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): IdpCertificate | null;
   ...
   */
  withoutIdentity(): IdpCertificate | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<IdpCertificate | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: IdpCertificate | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<IdpCertificate | null> | null, callback?: λFunction<IdpCertificate | null, IdpCertificate | null> | null): ObjList<IdpCertificate | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<IdpCertificate | null> | null, callback?: λFunction<IdpCertificate | null, IdpCertificate | null> | null): C3.Array<ObjError | null>;
