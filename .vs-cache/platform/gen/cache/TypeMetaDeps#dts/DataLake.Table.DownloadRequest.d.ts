// TypeScript definitions for the C3 type DataLake.Table.DownloadRequest

/**
 * A dataset download request that needs to be approved for a {@link Dataset} to be downloaded.
 *
 * @remarks this represents a value passed to a method that expects an instance of DataLake.Table.DownloadRequest
 */
declare namespace DataLake.Table {
  export interface IDownloadRequest {
     ...
     */
    datatable?: IDataLake.Table.Managed<DataLake.Table.Snapshot | null> | null;

    /**
     * The data table snapshot associated with this download request
     */
    snapshot?: IDataLake.Table.Snapshot.Iceberg | null;
  }
}
 ...
 */
declare namespace DataLake.Table {
  export class DownloadRequest extends Obj {

    /**
     * List of {@link AclEntry} entries governing who can read/update/remove Objs.
     */
    readonly acl?: C3.Array<AclEntry | null>;
    withAcl(acl: C3.Array<AclEntry | null> | Array<IAclEntry | null>): DataLake.Table.DownloadRequest;
    ...
    withTypeIdent(typeIdent: string | null): DataLake.Table.DownloadRequest;
     ...
     */
    readonly id: string;
    withId(id: string): DataLake.Table.DownloadRequest;
    ...
    withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): DataLake.Table.DownloadRequest;

    /**
     * Name of the Obj instance
     */
    readonly name?: string | null;
    withName(name: string | null): DataLake.Table.DownloadRequest;

    /**
     * Various system fields.
     */
    readonly meta?: Meta | null;
    withMeta(meta: IMeta | null): DataLake.Table.DownloadRequest;
    ...
    withVersion(version: number | null): DataLake.Table.DownloadRequest;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type | null;
    withTypeWithBindings(typeWithBindings: IType | null): DataLake.Table.DownloadRequest;

    /**
     * The status of the request. See {@link DisclosureReviewRequest.Status}.
     */
    readonly status?: string | null;
    withStatus(status: string | null): DataLake.Table.DownloadRequest;

    /**
     * The requestor of the request.
     */
    readonly requestedBy?: User | null;
    withRequestedBy(requestedBy: IUser | null): DataLake.Table.DownloadRequest;

    /**
     * The description of the request filled by the requestor.
     */
    readonly description?: string | null;
    withDescription(description: string | null): DataLake.Table.DownloadRequest;

    /**
     * The expiration timestamp of the request.
     */
    readonly expiresAt?: DateTime | null;
    withExpiresAt(expiresAt: DateTime | Date | string | null): DataLake.Table.DownloadRequest;

    /**
     * The data table associated with this download request
     */
    readonly datatable?: DataLake.Table.Managed<DataLake.Table.Snapshot | null> | null;
    withDatatable(datatable: IDataLake.Table.Managed<DataLake.Table.Snapshot | null> | null): DataLake.Table.DownloadRequest;

    /**
     * The data table snapshot associated with this download request
     */
    readonly snapshot?: DataLake.Table.Snapshot.Iceberg | null;
    withSnapshot(snapshot: IDataLake.Table.Snapshot.Iceberg | null): DataLake.Table.DownloadRequest;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): DataLake.Table.DownloadRequest | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): DataLake.Table.DownloadRequest | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): DataLake.Table.DownloadRequest | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): DataLake.Table.DownloadRequest | null;
     ...
     */
    replaceType(old: Type, new_: Type): DataLake.Table.DownloadRequest;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataLake.Table.DownloadRequest;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataLake.Table.DownloadRequest;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataLake.Table.DownloadRequest | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataLake.Table.DownloadRequest | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataLake.Table.DownloadRequest;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataLake.Table.DownloadRequest;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataLake.Table.DownloadRequest;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): DataLake.Table.DownloadRequest;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): DataLake.Table.DownloadRequest;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): DataLake.Table.DownloadRequest;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataLake.Table.DownloadRequest;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataLake.Table.DownloadRequest;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): DataLake.Table.DownloadRequest;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): DataLake.Table.DownloadRequest;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): DataLake.Table.DownloadRequest;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): DataLake.Table.DownloadRequest;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataLake.Table.DownloadRequest;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): DataLake.Table.DownloadRequest;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataLake.Table.DownloadRequest;
     ...
     * @see #unsetField
     */
    defaultField(field: string): DataLake.Table.DownloadRequest;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): DataLake.Table.DownloadRequest;
     ...
     * @see #removeField
     */
    unsetField(field: string): DataLake.Table.DownloadRequest;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): DataLake.Table.DownloadRequest;
     ...
     * @see #unsetField
     */
    removeField(field: string): DataLake.Table.DownloadRequest;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): DataLake.Table.DownloadRequest;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataLake.Table.DownloadRequest;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): DataLake.Table.DownloadRequest;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataLake.Table.DownloadRequest;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataLake.Table.DownloadRequest;

    mergeJson(json: any | null): DataLake.Table.DownloadRequest;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataLake.Table.DownloadRequest;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): DataLake.Table.DownloadRequest;
     ...
     */
    singletonArray(): C3.Array<DataLake.Table.DownloadRequest | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<DataLake.Table.DownloadRequest | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<DataLake.Table.DownloadRequest | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<DataLake.Table.DownloadRequest | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<DataLake.Table.DownloadRequest | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, DataLake.Table.DownloadRequest | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataLake.Table.DownloadRequest | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<DataLake.Table.DownloadRequest | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<DataLake.Table.DownloadRequest | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DataLake.Table.DownloadRequest;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DataLake.Table.DownloadRequest;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DataLake.Table.DownloadRequest;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): DataLake.Table.DownloadRequest;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DataLake.Table.DownloadRequest;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): DataLake.Table.DownloadRequest;
     ...
     * @see #fromString
     */
    static make(s: string | null): DataLake.Table.DownloadRequest | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DataLake.Table.DownloadRequest;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): DataLake.Table.DownloadRequest;
     ...
     */
    static cachedEmptyInst(): DataLake.Table.DownloadRequest;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DataLake.Table.DownloadRequest>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): DataLake.Table.DownloadRequest;
     ...
     */
    static populateAcl(objs?: C3.Array<DataLake.Table.DownloadRequest | null>): number | null;
     ...
     */
    grantMemberReadUpdateRemove(member: AccessControlEntity): DataLake.Table.DownloadRequest;
     ...
     */
    mergeAclEntry(entry: AclEntry): DataLake.Table.DownloadRequest;
     ...
     * @return the obj with the new acl after merging the indicated entry.
     */
    mergeAclEntries(entries: C3.Array<AclEntry | null> | null): DataLake.Table.DownloadRequest;
     ...
     */
    static fetch(spec?: FetchSpec | null): FetchResult<DataLake.Table.DownloadRequest | null>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<DataLake.Table.DownloadRequest | null>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec | null): Stream<DataLake.Table.DownloadRequest | null>;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<DataLake.Table.DownloadRequest | null> | null>;
     ...
     */
    get(include?: string | null): DataLake.Table.DownloadRequest | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string | null): DataLake.Table.DownloadRequest | null;
     ...
     */
    getMissing(spec: GetMissingSpec): DataLake.Table.DownloadRequest;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string | null): DataLake.Table.DownloadRequest | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): DataLake.Table.DownloadRequest;
     ...
     * @see #toString
     */
    static fromString(s: string | null): DataLake.Table.DownloadRequest | null;
     ...
     */
    create(spec?: UpsertSpec | null): DataLake.Table.DownloadRequest | null;
     ...
     */
    static createBatch(objs: C3.Array<DataLake.Table.DownloadRequest | null> | null, spec?: UpsertSpec | null): ObjList<DataLake.Table.DownloadRequest | null> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<DataLake.Table.DownloadRequest | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<DataLake.Table.DownloadRequest | null> | null;
     ...
     */
    update(srcObj?: DataLake.Table.DownloadRequest | null, spec?: UpsertSpec | null): DataLake.Table.DownloadRequest | null;
     ...
     */
    upsert(srcObj?: DataLake.Table.DownloadRequest | null, spec?: UpsertSpec | null): DataLake.Table.DownloadRequest | null;
     ...
     */
    merge(spec?: MergeSpec | null): DataLake.Table.DownloadRequest | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec | null): DataLake.Table.DownloadRequest | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec | null): DataLake.Table.DownloadRequest | null;
     ...
     */
    static updateBatch(objs: C3.Array<DataLake.Table.DownloadRequest | null> | null, srcObjs?: C3.Array<DataLake.Table.DownloadRequest | null>, spec?: UpsertSpec | null): ObjList<DataLake.Table.DownloadRequest | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<C3.Array<DataLake.Table.DownloadRequest | null>>, spec?: UpsertSpec | null): ObjList<DataLake.Table.DownloadRequest | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: C3.Array<DataLake.Table.DownloadRequest | null> | null, srcObjs?: C3.Array<DataLake.Table.DownloadRequest | null>, spec?: UpsertSpec | null): ObjList<DataLake.Table.DownloadRequest | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<C3.Array<DataLake.Table.DownloadRequest | null>>, spec?: UpsertSpec | null): ObjList<DataLake.Table.DownloadRequest | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: C3.Array<DataLake.Table.DownloadRequest | null> | null, spec?: TouchSpec | null): ObjList<DataLake.Table.DownloadRequest | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<DataLake.Table.DownloadRequest | null> | null, spec?: MergeSpec | null): ObjList<DataLake.Table.DownloadRequest | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<DataLake.Table.DownloadRequest | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<DataLake.Table.DownloadRequest | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<C3.Array<DataLake.Table.DownloadRequest | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<DataLake.Table.DownloadRequest | null> | null;
     ...
     */
    static mergeAll(mergeObj: DataLake.Table.DownloadRequest | null, spec?: MergeAllSpec | null): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: DataLake.Table.DownloadRequest | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: C3.Array<DataLake.Table.DownloadRequest | null> | null, spec?: UpsertSpec | null): ObjList<DataLake.Table.DownloadRequest | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: C3.Array<DataLake.Table.DownloadRequest | null> | null, spec?: UpsertSpec | null): ObjList<DataLake.Table.DownloadRequest | null> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): DataLake.Table.DownloadRequest | null;
     ...
     */
    static beforeCreate(objs: C3.Array<DataLake.Table.DownloadRequest | null> | null): ObjList<DataLake.Table.DownloadRequest | null>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: C3.Array<DataLake.Table.DownloadRequest | null> | null): ObjList<DataLake.Table.DownloadRequest | null>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: C3.Array<DataLake.Table.DownloadRequest | null> | null): ObjList<DataLake.Table.DownloadRequest | null>;
     ...
     */
    static afterCreate(objs: C3.Array<DataLake.Table.DownloadRequest | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: C3.Array<DataLake.Table.DownloadRequest | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: C3.Array<DataLake.Table.DownloadRequest | null> | null): C3.Array<ObjError | null>;
     ...
     */
    static startImportData(spec?: StartImportDataSpec | null): PushStream<DataLake.Table.DownloadRequest | null>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<DataLake.Table.DownloadRequest | null>;
     ...
     */
    static forId(id: string | null, failIfMissing?: boolean): DataLake.Table.DownloadRequest | null;
     ...
     */
    withoutIdentity(): DataLake.Table.DownloadRequest | null;
     ...
     */
    static typeOfBatch(objs: C3.Array<DataLake.Table.DownloadRequest | null> | null): C3.Array<EntityType | null>;
     ...
     */
    static dbEcho(template?: DataLake.Table.DownloadRequest | null, count?: number | null, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: C3.Array<DataLake.Table.DownloadRequest | null> | null, callback?: λFunction<DataLake.Table.DownloadRequest | null, DataLake.Table.DownloadRequest | null> | null): ObjList<DataLake.Table.DownloadRequest | null>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: C3.Array<DataLake.Table.DownloadRequest | null> | null, callback?: λFunction<DataLake.Table.DownloadRequest | null, DataLake.Table.DownloadRequest | null> | null): C3.Array<ObjError | null>;
     ...
     * Approve a request.
     */
    approveRequest(): DisclosureReviewRequest | null;

    /**
     * Reject a request.
     */
    rejectRequest(): DisclosureReviewRequest | null;

    /**
     * Expire a request.
     */
    expireRequest(): DisclosureReviewRequest | null;

    /**
     * Scan all requests and mark expired if expiration timestamp is in the past.
     */
    static updateExpired(): void;

    /**
     * Whether a user can be auto-approved in the disclosure review process
     */
    static isAutoApproved(user?: User | null): boolean;

    /**
     * Whether a user can review other User's data requests
     */
    static isDisclosureReviewer(user?: User | null): boolean;

    /**
     * Whether a user can review other User's data requests
     */
    static isDisclosureRequestor(user?: User | null): boolean;

    /**
     * Whether the current {@link User} is a Disclosure Reviewer
     */
    static amIDisclosureReviewer(): boolean;

    /**
     * Create a {@link DataLake.Table.DownloadRequest} for a specific datatable snapshot.
     */
    static createRequest(datatable: DataLake.Table.Managed<DataLake.Table.Snapshot | null>, snapshot: DataLake.Table.Snapshot.Iceberg, spec?: DataLake.Table.DownloadRequest.CreateRequestSpec | null): DataLake.Table.DownloadRequest | null;
    ...
    static exportTableWithId(id: string): void;
  }
}
