// TypeScript definitions for the C3 type RollupMetricSpec

/**
 * Specification for rolling up results multiple sources for every metric
 *
 * @remarks this represents a value passed to a method that expects an instance of RollupMetricSpec
 */
declare interface IRollupMetricSpec {
 ...
 */
declare class RollupMetricSpec extends Obj {
  ...
  withStart(start: DateTime | Date | string): RollupMetricSpec;
  ...
  withEnd(end: DateTime | Date | string): RollupMetricSpec;

  /**
   * Interval of timeseries.
   */
  readonly interval: string;
  withInterval(interval: string): RollupMetricSpec;
  ...
  withTimeZone(timeZone: ITimeZone | null): RollupMetricSpec;

  /**
   * length of this time-info in intervals. I.e. size of the timeseries this info represents.
   */
  readonly _size?: number | null;
  with_size(_size: number | null): RollupMetricSpec;

  /**
   * true if time range is aligned with interval.
   */
  readonly _isAligned?: boolean;
  with_isAligned(_isAligned: boolean): RollupMetricSpec;

  /**
   * Desired unit of evaluation. If specified, results will be converted to this unit.
   */
  readonly unitId?: string | null;
  withUnitId(unitId: string | null): RollupMetricSpec;

  /**
   * Include spec.
   */
  readonly include?: string | null;
  withInclude(include: string | null): RollupMetricSpec;
  ...
  withOptions(options: IEvalMetricsOptions | null): RollupMetricSpec;

  /**
   * If specified uses the following as the key field instead of id
   */
  readonly srcKey?: λFunction<Obj | null, string | null> | null;
  withSrcKey(srcKey: λFunction<Obj | null, string | null> | null): RollupMetricSpec;
  ...
  withCache(cache: boolean): RollupMetricSpec;
  ...
  withSources(sources: ICollection<Obj | null> | null): RollupMetricSpec;
  ...
  withIds(ids: C3.Set<string | null> | Array<string | null>): RollupMetricSpec;
  ...
  withFilter(filter: string | null): RollupMetricSpec;
  ...
  withLimit(limit: number | null): RollupMetricSpec;
  ...
  withExpressions(expressions: C3.Set<string | null> | Array<string | null>): RollupMetricSpec;
  ...
  withContinueOnError(continueOnError: boolean): RollupMetricSpec;
  ...
  withExplain(explain: boolean): RollupMetricSpec;
  ...
  withLocale(locale: string | null): RollupMetricSpec;
  ...
  withBindings(bindings: C3.Map<string | null, any> | {[key: string | null]: any} | C3.Array<C3.Map<string | null, any>> | Array<C3.Map<string | null, any> | {[key: string | null]: any}> | null): RollupMetricSpec;
  ...
  withBindingsCartesianProduct(bindingsCartesianProduct: boolean): RollupMetricSpec;
  ...
  withResultKey(resultKey: λBiFunction<string | null, C3.Map<string | null, any>, string> | null): RollupMetricSpec;
  ...
  withSavedSpecId(savedSpecId: string | null): RollupMetricSpec;

  /**
   * Specify the aggregation function that needs to be used to roll up results of all individual sources into 1 timeseries
   */
  readonly rollupFunc?: string | null;
  withRollupFunc(rollupFunc: string | null): RollupMetricSpec;

  /**
   * Specifies the percentileValue to be computed if the rollupFunc is PERCENTILE
   */
  readonly percentileValue?: number | null;
  withPercentileValue(percentileValue: number | null): RollupMetricSpec;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): RollupMetricSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): RollupMetricSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): RollupMetricSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): RollupMetricSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): RollupMetricSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): RollupMetricSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): RollupMetricSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<RollupMetricSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<RollupMetricSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): RollupMetricSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RollupMetricSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RollupMetricSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): RollupMetricSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): RollupMetricSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): RollupMetricSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): RollupMetricSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): RollupMetricSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): RollupMetricSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): RollupMetricSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): RollupMetricSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): RollupMetricSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): RollupMetricSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): RollupMetricSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): RollupMetricSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): RollupMetricSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): RollupMetricSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): RollupMetricSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): RollupMetricSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): RollupMetricSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): RollupMetricSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): RollupMetricSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): RollupMetricSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): RollupMetricSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): RollupMetricSpec;

  mergeJson(json: any | null): RollupMetricSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): RollupMetricSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): RollupMetricSpec;
   ...
   */
  singletonArray(): C3.Array<RollupMetricSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<RollupMetricSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<RollupMetricSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<RollupMetricSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<RollupMetricSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, RollupMetricSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, RollupMetricSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<RollupMetricSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<RollupMetricSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): RollupMetricSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): RollupMetricSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): RollupMetricSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): RollupMetricSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): RollupMetricSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): RollupMetricSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): RollupMetricSpec;
   ...
   */
  static cachedEmptyInst(): RollupMetricSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<RollupMetricSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): RollupMetricSpec;
   ...
   */
  static last12Months(): RollupMetricSpec | null;
   ...
   */
  static prevLast12Months(): RollupMetricSpec | null;
   ...
   */
  static combineAndSort(timeRanges: C3.Array<TimeRange | null> | null): C3.Array<RollupMetricSpec | null>;

  /**
   * Merge various time ranges into a larger range
   * E.g. ["2014-01-01" -> "2014-02-01"], ["2015-01-01" -> "2016-01-01"] => {"2014-01-01" -> "2016-01-01"}
   */
  static coalesce(timeRanges: C3.Array<TimeRange | null> | null): RollupMetricSpec | null;
   ...
   */
  overlap(othr: TimeRange | null): RollupMetricSpec | null;
   ...
   */
  static fromPrettyPrint(prettyPrint: string): RollupMetricSpec;

  /**
   * Construct array of TimeRange from map<datetime, datetime>
   */
  static fromMap(map: C3.Map<DateTime | null, DateTime | null>): C3.Array<RollupMetricSpec | null>;
   ...
   */
  shift(offset: Duration): RollupMetricSpec;
