// TypeScript definitions for the C3 type NativePyRun
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of NativePyRun
 */
declare interface INativePyRun {
   ...
   */
  inputValues?: C3.Map<string | null, any> | {[key: string | null]: any};
}
 ...
 */
declare class NativePyRun extends Obj {

  /**
   * Id of the action that executes {@link startWorkflow}
   */
  readonly startingActionId?: string | null;
  withStartingActionId(startingActionId: string | null): NativePyRun;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): NativePyRun;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): NativePyRun;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): NativePyRun;
  ...
  withVersion(version: number | null): NativePyRun;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): NativePyRun;

  /**
   * Execution Representation associated with this run.
   */
  readonly er?: SynchronousPyExecutionRepresentation | null;
  withEr(er: ISynchronousPyExecutionRepresentation | null): NativePyRun;

  /**
   * The spec that workflow was started with
   */
  readonly spec?: WorkflowExecutionSpec | null;
  withSpec(spec: IWorkflowExecutionSpec | null): NativePyRun;

  /**
   * Holds the execution outputs (sink vertices) from the synchronous execution
   */
  readonly outputs: C3.Map<string | null, any>;
  withOutputs(outputs: C3.Map<string | null, any> | {[key: string | null]: any}): NativePyRun;

  /**
   * Returned by {@link #executionMetadataByAction}.
   */
  readonly execMetadata?: C3.Map<string | null, Log.Entry.Action | null>;
  withExecMetadata(execMetadata: C3.Map<string | null, Log.Entry.Action | null> | {[key: string | null]: ILog.Entry.Action | null}): NativePyRun;
  ...
  withFinallyVertexWorkflowRun(finallyVertexWorkflowRun: ISimpleSynchronousPyRun | null): NativePyRun;

  /**
   * Input values provided to the executor.
   */
  readonly inputValues?: C3.Map<string | null, any>;
  withInputValues(inputValues: C3.Map<string | null, any> | {[key: string | null]: any}): NativePyRun;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): NativePyRun | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): NativePyRun | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): NativePyRun | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): NativePyRun | null;
   ...
   */
  replaceType(old: Type, new_: Type): NativePyRun;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NativePyRun;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NativePyRun;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NativePyRun | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NativePyRun | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): NativePyRun;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NativePyRun;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NativePyRun;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): NativePyRun;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): NativePyRun;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): NativePyRun;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): NativePyRun;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): NativePyRun;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): NativePyRun;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): NativePyRun;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): NativePyRun;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): NativePyRun;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): NativePyRun;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): NativePyRun;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): NativePyRun;
   ...
   * @see #unsetField
   */
  defaultField(field: string): NativePyRun;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): NativePyRun;
   ...
   * @see #removeField
   */
  unsetField(field: string): NativePyRun;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): NativePyRun;
   ...
   * @see #unsetField
   */
  removeField(field: string): NativePyRun;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): NativePyRun;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): NativePyRun;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): NativePyRun;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): NativePyRun;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): NativePyRun;

  mergeJson(json: any | null): NativePyRun;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): NativePyRun;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): NativePyRun;
   ...
   */
  singletonArray(): C3.Array<NativePyRun | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<NativePyRun | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<NativePyRun | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<NativePyRun | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<NativePyRun | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, NativePyRun | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, NativePyRun | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<NativePyRun | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<NativePyRun | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): NativePyRun;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): NativePyRun;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): NativePyRun;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): NativePyRun;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): NativePyRun;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): NativePyRun;
   ...
   * @see #fromString
   */
  static make(s: string | null): NativePyRun | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): NativePyRun;
   ...
   */
  static cachedEmptyInst(): NativePyRun;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<NativePyRun>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): NativePyRun;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<NativePyRun | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<NativePyRun | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<NativePyRun | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<NativePyRun | null> | null>;
   ...
   */
  get(include?: string | null): NativePyRun | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): NativePyRun | null;
   ...
   */
  getMissing(spec: GetMissingSpec): NativePyRun;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): NativePyRun | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): NativePyRun;
   ...
   * @see #toString
   */
  static fromString(s: string | null): NativePyRun | null;
   ...
   */
  create(spec?: UpsertSpec | null): NativePyRun | null;
   ...
   */
  static createBatch(objs: C3.Array<NativePyRun | null> | null, spec?: UpsertSpec | null): ObjList<NativePyRun | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<NativePyRun | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<NativePyRun | null> | null;
   ...
   */
  update(srcObj?: NativePyRun | null, spec?: UpsertSpec | null): NativePyRun | null;
   ...
   */
  upsert(srcObj?: NativePyRun | null, spec?: UpsertSpec | null): NativePyRun | null;
   ...
   */
  merge(spec?: MergeSpec | null): NativePyRun | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): NativePyRun | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): NativePyRun | null;
   ...
   */
  static updateBatch(objs: C3.Array<NativePyRun | null> | null, srcObjs?: C3.Array<NativePyRun | null>, spec?: UpsertSpec | null): ObjList<NativePyRun | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<NativePyRun | null>>, spec?: UpsertSpec | null): ObjList<NativePyRun | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<NativePyRun | null> | null, srcObjs?: C3.Array<NativePyRun | null>, spec?: UpsertSpec | null): ObjList<NativePyRun | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<NativePyRun | null>>, spec?: UpsertSpec | null): ObjList<NativePyRun | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<NativePyRun | null> | null, spec?: TouchSpec | null): ObjList<NativePyRun | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<NativePyRun | null> | null, spec?: MergeSpec | null): ObjList<NativePyRun | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<NativePyRun | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<NativePyRun | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<NativePyRun | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<NativePyRun | null> | null;
   ...
   */
  static mergeAll(mergeObj: NativePyRun | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: NativePyRun | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<NativePyRun | null> | null, spec?: UpsertSpec | null): ObjList<NativePyRun | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<NativePyRun | null> | null, spec?: UpsertSpec | null): ObjList<NativePyRun | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<NativePyRun | null> | null): ObjList<NativePyRun | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<NativePyRun | null> | null): ObjList<NativePyRun | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<NativePyRun | null> | null): ObjList<NativePyRun | null>;
   ...
   */
  static afterCreate(objs: C3.Array<NativePyRun | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<NativePyRun | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<NativePyRun | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<NativePyRun | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<NativePyRun | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): NativePyRun | null;
   ...
   */
  withoutIdentity(): NativePyRun | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<NativePyRun | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: NativePyRun | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<NativePyRun | null> | null, callback?: λFunction<NativePyRun | null, NativePyRun | null> | null): ObjList<NativePyRun | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<NativePyRun | null> | null, callback?: λFunction<NativePyRun | null, NativePyRun | null> | null): C3.Array<ObjError | null>;
