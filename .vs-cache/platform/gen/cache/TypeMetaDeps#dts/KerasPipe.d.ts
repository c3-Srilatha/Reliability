// TypeScript definitions for the C3 type KerasPipe

/**
 * This type represents a trainable and processable python native keras object.
 *
 * @remarks this represents a value passed to a method that expects an instance of KerasPipe
 */
declare interface IKerasPipe<DX, DY, DO> {
 ...
 */
declare class KerasPipe<DX, DY, DO> extends Obj {
  ...
  withYFromX(yFromX: C3.Map<string | null, string | null> | {[key: string | null]: string | null}): KerasPipe;
  ...
  withSanitizedNames(sanitizedNames: C3.Map<string | null, string | null> | {[key: string | null]: string | null}): KerasPipe;
  ...
  withTrainArgs(trainArgs: IKerasFitArgs): KerasPipe;
  ...
  withProcessArgs(processArgs: IKerasPredictArgs): KerasPipe;

  /**
   * The keras model's history.
   */
  readonly history?: KerasPipe.KerasHistory | null;
  withHistory(history: IKerasPipe.KerasHistory | null): KerasPipe;
  ...
  withDataType(dataType: string | null): KerasPipe;
  ...
  withGenerator(generator: IKerasGenerator<DX, DY>): KerasPipe;
  ...
  withProcessGenerator(processGenerator: IKerasGenerator<DX, DY> | null): KerasPipe;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): KerasPipe;

  /**
   * Name of this pipe.
   */
  readonly name?: string | null;
  withName(name: string | null): KerasPipe;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): KerasPipe;
  ...
  withVersion(version: number | null): KerasPipe;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): KerasPipe;
  ...
  withUserUpdatedFields(userUpdatedFields: C3.Array<string | null> | Array<string | null>): KerasPipe;
  ...
  withHidden(hidden: boolean): KerasPipe;
  ...
  withUserOwned(userOwned: boolean): KerasPipe;
  ...
  withTypeIdent(typeIdent: string | null): KerasPipe;

  /**
   * If true, then the pipe shall not be retrained
   */
  readonly frozen?: boolean;
  withFrozen(frozen: boolean): KerasPipe;

  /**
   * True if training has succeeded and false otherwise.
   */
  readonly trained?: boolean;
  withTrained(trained: boolean): KerasPipe;

  /**
   * Errors from training.
   */
  readonly trainingErrors?: string | null;
  withTrainingErrors(trainingErrors: string | null): KerasPipe;

  /**
   * If true, the underlying model only accepts flattened input.
   */
  readonly flattenInput?: boolean;
  withFlattenInput(flattenInput: boolean): KerasPipe;

  /**
   * The hyperparameters overridden of a native model or pipe.
   */
  readonly hyperparamOverrides?: C3.Map<string | null, any>;
  withHyperparamOverrides(hyperparamOverrides: C3.Map<string | null, any> | {[key: string | null]: any}): KerasPipe;
  ...
  withHyperparamSearchSpace(hyperparamSearchSpace: IHp.SearchSpace | null): KerasPipe;
  ...
  withHpoSpec(hpoSpec: IHpo.Spec | null): KerasPipe;

  /**
   * {@link Hpo.Experiment} stores the result of hyperparameter optimization to find the best model/pipeline.
   */
  readonly hpoExperiment?: Hpo.Experiment | null;
  withHpoExperiment(hpoExperiment: IHpo.Experiment | null): KerasPipe;

  /**
   * Reference to the experiment that produced this {@link MlPipe}. For example, this could be a {@link Hpo.ExperimentBase}.
   */
  readonly experiment?: any;
  withExperiment(experiment: any): KerasPipe;
  ...
  withModelFiles(modelFiles: C3.Map<string | null, Url | null> | {[key: string | null]: IUrl | null}): KerasPipe;
  ...
  withCustomModelCode(customModelCode: C3.Map<string | null, any | null> | {[key: string | null]: any | null}): KerasPipe;

  /**
   * Name for the function on the native model to call to do {@link MlProcessable#process}.
   */
  readonly processFunc?: string | null;
  withProcessFunc(processFunc: string | null): KerasPipe;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): KerasPipe<DX, DY, DO> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): KerasPipe<DX, DY, DO> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): KerasPipe<DX, DY, DO> | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): KerasPipe<DX, DY, DO> | null;
   ...
   */
  replaceType(old: Type, new_: Type): KerasPipe<DX, DY, DO>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): KerasPipe<DX, DY, DO>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): KerasPipe<DX, DY, DO>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<KerasPipe<DX, DY, DO> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<KerasPipe<DX, DY, DO> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): KerasPipe<DX, DY, DO>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): KerasPipe<DX, DY, DO>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): KerasPipe<DX, DY, DO>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): KerasPipe<DX, DY, DO>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): KerasPipe<DX, DY, DO>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): KerasPipe<DX, DY, DO>;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): KerasPipe<DX, DY, DO>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): KerasPipe<DX, DY, DO>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): KerasPipe<DX, DY, DO>;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): KerasPipe<DX, DY, DO>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): KerasPipe<DX, DY, DO>;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): KerasPipe<DX, DY, DO>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): KerasPipe<DX, DY, DO>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): KerasPipe<DX, DY, DO>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): KerasPipe<DX, DY, DO>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): KerasPipe<DX, DY, DO>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): KerasPipe<DX, DY, DO>;
   ...
   * @see #removeField
   */
  unsetField(field: string): KerasPipe<DX, DY, DO>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): KerasPipe<DX, DY, DO>;
   ...
   * @see #unsetField
   */
  removeField(field: string): KerasPipe<DX, DY, DO>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): KerasPipe<DX, DY, DO>;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): KerasPipe<DX, DY, DO>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): KerasPipe<DX, DY, DO>;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): KerasPipe<DX, DY, DO>;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): KerasPipe<DX, DY, DO>;

  mergeJson(json: any | null): KerasPipe<DX, DY, DO>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): KerasPipe<DX, DY, DO>;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): KerasPipe<DX, DY, DO>;
   ...
   */
  singletonArray(): C3.Array<KerasPipe<DX, DY, DO> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<KerasPipe<DX, DY, DO> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<KerasPipe<DX, DY, DO> | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<KerasPipe<DX, DY, DO> | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<KerasPipe<DX, DY, DO> | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, KerasPipe<DX, DY, DO> | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, KerasPipe<DX, DY, DO> | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<KerasPipe<DX, DY, DO> | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<KerasPipe<DX, DY, DO> | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): KerasPipe<DX, DY, DO>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): KerasPipe<DX, DY, DO>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): KerasPipe<DX, DY, DO>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): KerasPipe<DX, DY, DO>;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): KerasPipe<DX, DY, DO>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): KerasPipe<DX, DY, DO>;
   ...
   * @see #fromString
   */
  static make(s: string | null): KerasPipe<DX, DY, DO> | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): KerasPipe<DX, DY, DO>;
   ...
   */
  static cachedEmptyInst(): KerasPipe<DX, DY, DO>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<KerasPipe<DX, DY, DO>>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): KerasPipe<DX, DY, DO>;
   ...
   */
  withoutIdentity(): KerasPipe<DX, DY, DO>;
   ...
   */
  trainSync(x: DX | null, y?: DY | null, spec?: MlOperationSpec | null): KerasPipe<DX, DY, DO>;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<KerasPipe<DX, DY, DO> | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<KerasPipe<DX, DY, DO> | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<KerasPipe<DX, DY, DO> | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): KerasPipe<DX, DY, DO> | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string | null): KerasPipe<DX, DY, DO> | null;
   ...
   * @see findByCacheKey
   */
  getCached(): KerasPipe<DX, DY, DO> | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): KerasPipe<DX, DY, DO> | null;
   ...
   */
  static produce(key: string): KerasPipe<DX, DY, DO> | null;
   ...
   */
  static produceAll(): C3.Map<string | null, KerasPipe<DX, DY, DO> | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, KerasPipe<DX, DY, DO> | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<KerasPipe<DX, DY, DO> | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<KerasPipe<DX, DY, DO> | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<KerasPipe<DX, DY, DO> | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<KerasPipe<DX, DY, DO> | null> | null>;
   ...
   */
  get(include?: string | null): KerasPipe<DX, DY, DO> | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): KerasPipe<DX, DY, DO> | null;
   ...
   */
  getMissing(spec: GetMissingSpec): KerasPipe<DX, DY, DO>;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): KerasPipe<DX, DY, DO> | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): KerasPipe<DX, DY, DO>;
   ...
   * @see #toString
   */
  static fromString(s: string | null): KerasPipe<DX, DY, DO> | null;
   ...
   */
  create(spec?: UpsertSpec | null): KerasPipe<DX, DY, DO> | null;
   ...
   */
  static createBatch(objs: C3.Array<KerasPipe<DX, DY, DO> | null> | null, spec?: UpsertSpec | null): ObjList<KerasPipe<DX, DY, DO> | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<KerasPipe<DX, DY, DO> | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<KerasPipe<DX, DY, DO> | null> | null;
   ...
   */
  update(srcObj?: KerasPipe<DX, DY, DO> | null, spec?: UpsertSpec | null): KerasPipe<DX, DY, DO> | null;
   ...
   */
  upsert(srcObj?: KerasPipe<DX, DY, DO> | null, spec?: UpsertSpec | null): KerasPipe<DX, DY, DO> | null;
   ...
   */
  merge(spec?: MergeSpec | null): KerasPipe<DX, DY, DO> | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): KerasPipe<DX, DY, DO> | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): KerasPipe<DX, DY, DO> | null;
   ...
   */
  static updateBatch(objs: C3.Array<KerasPipe<DX, DY, DO> | null> | null, srcObjs?: C3.Array<KerasPipe<DX, DY, DO> | null>, spec?: UpsertSpec | null): ObjList<KerasPipe<DX, DY, DO> | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<KerasPipe<DX, DY, DO> | null>>, spec?: UpsertSpec | null): ObjList<KerasPipe<DX, DY, DO> | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<KerasPipe<DX, DY, DO> | null> | null, srcObjs?: C3.Array<KerasPipe<DX, DY, DO> | null>, spec?: UpsertSpec | null): ObjList<KerasPipe<DX, DY, DO> | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<KerasPipe<DX, DY, DO> | null>>, spec?: UpsertSpec | null): ObjList<KerasPipe<DX, DY, DO> | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<KerasPipe<DX, DY, DO> | null> | null, spec?: TouchSpec | null): ObjList<KerasPipe<DX, DY, DO> | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<KerasPipe<DX, DY, DO> | null> | null, spec?: MergeSpec | null): ObjList<KerasPipe<DX, DY, DO> | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<KerasPipe<DX, DY, DO> | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<KerasPipe<DX, DY, DO> | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<KerasPipe<DX, DY, DO> | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<KerasPipe<DX, DY, DO> | null> | null;
   ...
   */
  static mergeAll(mergeObj: KerasPipe<DX, DY, DO> | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: KerasPipe<DX, DY, DO> | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<KerasPipe<DX, DY, DO> | null> | null, spec?: UpsertSpec | null): ObjList<KerasPipe<DX, DY, DO> | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<KerasPipe<DX, DY, DO> | null> | null, spec?: UpsertSpec | null): ObjList<KerasPipe<DX, DY, DO> | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): KerasPipe<DX, DY, DO> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<KerasPipe<DX, DY, DO> | null> | null): ObjList<KerasPipe<DX, DY, DO> | null>;
   ...
   */
  static beforeUpdate(objs: C3.Array<KerasPipe<DX, DY, DO> | null> | null): ObjList<KerasPipe<DX, DY, DO> | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<KerasPipe<DX, DY, DO> | null> | null): ObjList<KerasPipe<DX, DY, DO> | null>;
   ...
   */
  static afterCreate(objs: C3.Array<KerasPipe<DX, DY, DO> | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<KerasPipe<DX, DY, DO> | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<KerasPipe<DX, DY, DO> | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<KerasPipe<DX, DY, DO> | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<KerasPipe<DX, DY, DO> | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): KerasPipe<DX, DY, DO> | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<KerasPipe<DX, DY, DO> | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: KerasPipe<DX, DY, DO> | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<KerasPipe<DX, DY, DO> | null> | null, callback?: λFunction<KerasPipe<DX, DY, DO> | null, KerasPipe<DX, DY, DO> | null> | null): ObjList<KerasPipe<DX, DY, DO> | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<KerasPipe<DX, DY, DO> | null> | null, callback?: λFunction<KerasPipe<DX, DY, DO> | null, KerasPipe<DX, DY, DO> | null> | null): C3.Array<ObjError | null>;
   ...
   */
  publish(subPath?: string | null, contentType?: string | null): KerasPipe<DX, DY, DO>;
   ...
   */
  static removeSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<KerasPipe<DX, DY, DO> | null> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec | null): KerasPipe<DX, DY, DO> | null;
   ...
   */
  static createSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<KerasPipe<DX, DY, DO> | null> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData | null, spec?: UpsertSpec | null): KerasPipe<DX, DY, DO> | null;
   ...
   */
  static updateSeedDataBatch(objs?: C3.Array<SeedData | null>, srcObjs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<KerasPipe<DX, DY, DO> | null> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec | null): KerasPipe<DX, DY, DO> | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: C3.Array<SeedData | null>, spec?: MergeSpec | null): ObjList<KerasPipe<DX, DY, DO> | null> | null;
  ...
  dependencies(): SeedDataDeps<KerasPipe<DX, DY, DO> | null> | null;
   ...
   * be returned as-is.
   */
  byReference(): KerasPipe<DX, DY, DO>;
   ...
   */
  updateModelFiles(modelFiles: C3.Map<string | null, Url | null> | null, spec?: MlOperationSpec | null): KerasPipe<DX, DY, DO>;
   ...
   */
  afterTrain(doTrainOutputs: any, spec?: MlOperationSpec | null): KerasPipe<DX, DY, DO>;
   ...
   */
  withNewSpec(spec?: MlConvertSpec | null): KerasPipe<DX, DY, DO>;
   ...
   */
  afterConvert(model: any, spec?: MlConvertSpec | null): KerasPipe<DX, DY, DO>;
   ...
   */
  withHyperparamSpaces(paramSpaces: C3.Map<string | null, Hp.ParamSpace | null>): KerasPipe<DX, DY, DO>;
