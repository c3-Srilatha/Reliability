// TypeScript definitions for the C3 type TestTextContentStream

/**
 * @remarks this represents a value passed to a method that expects an instance of TestTextContentStream
 */
declare interface ITestTextContentStream {

  metadata: ITextContentConfiguration;
...
/**
 * @remarks this represents a made instance of TestTextContentStream
 */
declare class TestTextContentStream extends Obj {

  readonly metadata: TextContentConfiguration;
  withMetadata(metadata: ITextContentConfiguration): TestTextContentStream;

  readonly contentType: string;
  withContentType(contentType: string): TestTextContentStream;

  readonly context?: string | null;
  withContext(context: string | null): TestTextContentStream;
  ...
  withFormat(format: string | null): TestTextContentStream;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): TestTextContentStream;

  readonly size?: number | null;
  withSize(size: number | null): TestTextContentStream;

  readonly numLines?: number | null;
  withNumLines(numLines: number | null): TestTextContentStream;

  readonly numBlocks?: number | null;
  withNumBlocks(numBlocks: number | null): TestTextContentStream;

  readonly complete?: boolean;
  withComplete(complete: boolean): TestTextContentStream;
   ...
   */
  readonly id: string;
  withId(id: string): TestTextContentStream;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): TestTextContentStream;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): TestTextContentStream;
  ...
  withVersion(version: number | null): TestTextContentStream;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): TestTextContentStream;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TestTextContentStream | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TestTextContentStream | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TestTextContentStream | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TestTextContentStream | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestTextContentStream;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestTextContentStream;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestTextContentStream;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestTextContentStream | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestTextContentStream | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TestTextContentStream;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestTextContentStream;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestTextContentStream;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestTextContentStream;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestTextContentStream;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestTextContentStream;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TestTextContentStream;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestTextContentStream;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestTextContentStream;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TestTextContentStream;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TestTextContentStream;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TestTextContentStream;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TestTextContentStream;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestTextContentStream;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TestTextContentStream;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestTextContentStream;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestTextContentStream;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestTextContentStream;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestTextContentStream;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestTextContentStream;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestTextContentStream;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TestTextContentStream;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TestTextContentStream;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TestTextContentStream;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TestTextContentStream;

  mergeJson(json: any | null): TestTextContentStream;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TestTextContentStream;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TestTextContentStream;
   ...
   */
  singletonArray(): C3.Array<TestTextContentStream | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TestTextContentStream | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestTextContentStream | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TestTextContentStream | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestTextContentStream | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TestTextContentStream | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestTextContentStream | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestTextContentStream | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestTextContentStream | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TestTextContentStream;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TestTextContentStream;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TestTextContentStream;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestTextContentStream;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TestTextContentStream;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestTextContentStream;
   ...
   * @see #fromString
   */
  static make(s: string | null): TestTextContentStream | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TestTextContentStream;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): TestTextContentStream;
   ...
   */
  static cachedEmptyInst(): TestTextContentStream;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TestTextContentStream>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TestTextContentStream;

  /**
   * event that gets fired when a set of blocks are uploaded
   */
  static blockCreated(txn?: Transaction | null): void;
   ...
   */
  static readBlockString(obj?: TextContentStream | null, blockNumber?: number | null): C3.Array<string | null>;
   ...
   * Blocks can be read in arbitrary order (storage optimized for that)
   */
  static readBlock(obj?: TextContentStream | null, blockNumber?: number | null): C3.Array<Obj | null>;
   ...
   */
  static writeBlockString(obj?: TextContentStream | null, contents?: C3.Array<string | null>, blockNumber?: number | null): number | null;
   ...
   * returns the number of lines written (in this block).
   */
  static writeBlock(obj?: TextContentStream | null, contents?: C3.Array<Obj | null>, blockNumber?: number | null): number | null;

  static removeContents(obj?: TextContentStream | null): boolean;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TestTextContentStream | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestTextContentStream | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TestTextContentStream | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TestTextContentStream | null> | null>;
   ...
   */
  get(include?: string | null): TestTextContentStream | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TestTextContentStream | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestTextContentStream;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TestTextContentStream | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestTextContentStream;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TestTextContentStream | null;
   ...
   */
  create(spec?: UpsertSpec | null): TestTextContentStream | null;
   ...
   */
  static createBatch(objs: C3.Array<TestTextContentStream | null> | null, spec?: UpsertSpec | null): ObjList<TestTextContentStream | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestTextContentStream | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TestTextContentStream | null> | null;
   ...
   */
  update(srcObj?: TestTextContentStream | null, spec?: UpsertSpec | null): TestTextContentStream | null;
   ...
   */
  upsert(srcObj?: TestTextContentStream | null, spec?: UpsertSpec | null): TestTextContentStream | null;
   ...
   */
  merge(spec?: MergeSpec | null): TestTextContentStream | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TestTextContentStream | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TestTextContentStream | null;
   ...
   */
  static updateBatch(objs: C3.Array<TestTextContentStream | null> | null, srcObjs?: C3.Array<TestTextContentStream | null>, spec?: UpsertSpec | null): ObjList<TestTextContentStream | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TestTextContentStream | null>>, spec?: UpsertSpec | null): ObjList<TestTextContentStream | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TestTextContentStream | null> | null, srcObjs?: C3.Array<TestTextContentStream | null>, spec?: UpsertSpec | null): ObjList<TestTextContentStream | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TestTextContentStream | null>>, spec?: UpsertSpec | null): ObjList<TestTextContentStream | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TestTextContentStream | null> | null, spec?: TouchSpec | null): ObjList<TestTextContentStream | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestTextContentStream | null> | null, spec?: MergeSpec | null): ObjList<TestTextContentStream | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestTextContentStream | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestTextContentStream | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TestTextContentStream | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestTextContentStream | null> | null;
   ...
   */
  static mergeAll(mergeObj: TestTextContentStream | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestTextContentStream | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TestTextContentStream | null> | null, spec?: UpsertSpec | null): ObjList<TestTextContentStream | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TestTextContentStream | null> | null, spec?: UpsertSpec | null): ObjList<TestTextContentStream | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TestTextContentStream | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TestTextContentStream | null> | null): ObjList<TestTextContentStream | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TestTextContentStream | null> | null): ObjList<TestTextContentStream | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TestTextContentStream | null> | null): ObjList<TestTextContentStream | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TestTextContentStream | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TestTextContentStream | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TestTextContentStream | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TestTextContentStream | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TestTextContentStream | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TestTextContentStream | null;
   ...
   */
  withoutIdentity(): TestTextContentStream | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<TestTextContentStream | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TestTextContentStream | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TestTextContentStream | null> | null, callback?: λFunction<TestTextContentStream | null, TestTextContentStream | null> | null): ObjList<TestTextContentStream | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TestTextContentStream | null> | null, callback?: λFunction<TestTextContentStream | null, TestTextContentStream | null> | null): C3.Array<ObjError | null>;
