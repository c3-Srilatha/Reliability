// TypeScript definitions for the C3 type Err.IndexFilter

/**
 * Error type representing index creation error due to syntax of filter sql.
 *
 * @remarks this represents a value passed to a method that expects an instance of Err.IndexFilter
 */
 ...
 */
declare namespace Err {
  export class IndexFilter extends Obj {

    /**
     * Formatted and localized message.
     */
    readonly message?: string | null;
    withMessage(message: string | null): Err.IndexFilter;

    /**
     * Unlocalized, parameterized error message string.
     */
    readonly template?: string | null;
    withTemplate(template: string | null): Err.IndexFilter;

    /**
     * Parameters applied to {@link template} to produce error message.
     */
    readonly parameters?: C3.Array<string | null>;
    withParameters(parameters: C3.Array<string | null> | Array<string | null>): Err.IndexFilter;

    /**
     * Unique (generated) error id.
     */
    readonly id?: string | null;
    withId(id: string | null): Err.IndexFilter;

    /**
     * Error key.
     */
    readonly key?: string | null;
    withKey(key: string | null): Err.IndexFilter;

    /**
     * Error for nested/causing exception (if any).
     */
    readonly cause?: C3.Error | null;
    withCause(cause: IC3.Error | null): Err.IndexFilter;

    /**
     * http status code for this error
     */
    readonly httpStatusCode: number;
    withHttpStatusCode(httpStatusCode: number): Err.IndexFilter;

    /**
     * Filename for where the error originated from
     */
    readonly filenameOfRootError?: string | null;
    withFilenameOfRootError(filenameOfRootError: string | null): Err.IndexFilter;

    /**
     * Extra debugging information, such as script language stack.
     */
    readonly debugInfo?: C3.Array<string | null>;
    withDebugInfo(debugInfo: C3.Array<string | null> | Array<string | null>): Err.IndexFilter;

    /**
     * Script language (js/py) stacktrace.
     */
    readonly stackTrace?: C3.Array<StackFrame | null>;
    withStackTrace(stackTrace: C3.Array<StackFrame | null> | Array<IStackFrame | null>): Err.IndexFilter;
    ...
    withAction(action: string | null): Err.IndexFilter;

    /**
     * Engine of the action that threw this error
     */
    readonly engine?: string | null;
    withEngine(engine: string | null): Err.IndexFilter;

    /**
     * Timestamp when the error was thrown
     */
    readonly timestamp?: DateTime | null;
    withTimestamp(timestamp: DateTime | Date | string | null): Err.IndexFilter;
    ...
    with_system(_system: any): Err.IndexFilter;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Err.IndexFilter | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Err.IndexFilter | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Err.IndexFilter | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Err.IndexFilter | null;
     ...
     */
    replaceType(old: Type, new_: Type): Err.IndexFilter;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Err.IndexFilter;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Err.IndexFilter;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Err.IndexFilter | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Err.IndexFilter | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Err.IndexFilter;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Err.IndexFilter;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Err.IndexFilter;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Err.IndexFilter;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Err.IndexFilter;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Err.IndexFilter;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Err.IndexFilter;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Err.IndexFilter;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Err.IndexFilter;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Err.IndexFilter;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Err.IndexFilter;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Err.IndexFilter;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Err.IndexFilter;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Err.IndexFilter;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Err.IndexFilter;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Err.IndexFilter;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Err.IndexFilter;
     ...
     * @see #removeField
     */
    unsetField(field: string): Err.IndexFilter;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Err.IndexFilter;
     ...
     * @see #unsetField
     */
    removeField(field: string): Err.IndexFilter;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Err.IndexFilter;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Err.IndexFilter;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Err.IndexFilter;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Err.IndexFilter;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Err.IndexFilter;

    mergeJson(json: any | null): Err.IndexFilter;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Err.IndexFilter;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Err.IndexFilter;
     ...
     */
    singletonArray(): C3.Array<Err.IndexFilter | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Err.IndexFilter | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Err.IndexFilter | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Err.IndexFilter | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Err.IndexFilter | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Err.IndexFilter | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Err.IndexFilter | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Err.IndexFilter | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Err.IndexFilter | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Err.IndexFilter;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Err.IndexFilter;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Err.IndexFilter;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Err.IndexFilter;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Err.IndexFilter;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Err.IndexFilter;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Err.IndexFilter;
     ...
     */
    static cachedEmptyInst(): Err.IndexFilter;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Err.IndexFilter>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Err.IndexFilter;
     ...
     */
    withFormattedMessage(): Err.IndexFilter;
     ...
     */
    static formatted(format: string, ...args: any[]): Err.IndexFilter;

    /**
     * Construct an error with just the message.
     */
    static fromMessage(s: string | null): Err.IndexFilter;
     ...
     */
    static fromJavaException(ex: any): Err.IndexFilter;

    /**
     * Construct an error from the system exception.
     */
    static fromJavaException(message: string, ex: any): Err.IndexFilter;
     ...
     */
    static fromTemplate(template: string | null, bindings: C3.Map<string | null, any> | null): Err.IndexFilter;

    /**
     * Construct an error and a system exception around it to throw an error.
     */
    static fromHttpCodeAndTemplate(httpCode: number | null, template: string | null, bindings: C3.Map<string | null, any> | null): Err.IndexFilter;
