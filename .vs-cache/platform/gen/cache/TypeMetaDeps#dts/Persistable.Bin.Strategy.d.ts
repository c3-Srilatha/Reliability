// TypeScript definitions for the C3 type Persistable.Bin.Strategy
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Persistable.Bin.Strategy
 */
declare namespace Persistable.Bin {
...
declare namespace Persistable.Bin {
  export class Strategy extends Obj {
    ...
    withTypeIdent(typeIdent: string | null): Persistable.Bin.Strategy;
     ...
     */
    readonly id: string;
    withId(id: string): Persistable.Bin.Strategy;
    ...
    withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Persistable.Bin.Strategy;

    /**
     * Name of the Obj instance
     */
    readonly name?: string | null;
    withName(name: string | null): Persistable.Bin.Strategy;

    /**
     * Various system fields.
     */
    readonly meta?: Meta | null;
    withMeta(meta: IMeta | null): Persistable.Bin.Strategy;
    ...
    withVersion(version: number | null): Persistable.Bin.Strategy;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type | null;
    withTypeWithBindings(typeWithBindings: IType | null): Persistable.Bin.Strategy;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Persistable.Bin.Strategy | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Persistable.Bin.Strategy | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Persistable.Bin.Strategy | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Persistable.Bin.Strategy | null;
     ...
     */
    replaceType(old: Type, new_: Type): Persistable.Bin.Strategy;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Persistable.Bin.Strategy;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Persistable.Bin.Strategy;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Persistable.Bin.Strategy | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Persistable.Bin.Strategy | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Persistable.Bin.Strategy;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Persistable.Bin.Strategy;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Persistable.Bin.Strategy;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Persistable.Bin.Strategy;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Persistable.Bin.Strategy;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Persistable.Bin.Strategy;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Persistable.Bin.Strategy;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Persistable.Bin.Strategy;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Persistable.Bin.Strategy;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Persistable.Bin.Strategy;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Persistable.Bin.Strategy;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Persistable.Bin.Strategy;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Persistable.Bin.Strategy;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Persistable.Bin.Strategy;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Persistable.Bin.Strategy;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Persistable.Bin.Strategy;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Persistable.Bin.Strategy;
     ...
     * @see #removeField
     */
    unsetField(field: string): Persistable.Bin.Strategy;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Persistable.Bin.Strategy;
     ...
     * @see #unsetField
     */
    removeField(field: string): Persistable.Bin.Strategy;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Persistable.Bin.Strategy;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Persistable.Bin.Strategy;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Persistable.Bin.Strategy;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Persistable.Bin.Strategy;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Persistable.Bin.Strategy;

    mergeJson(json: any | null): Persistable.Bin.Strategy;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Persistable.Bin.Strategy;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Persistable.Bin.Strategy;
     ...
     */
    singletonArray(): C3.Array<Persistable.Bin.Strategy | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Persistable.Bin.Strategy | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Persistable.Bin.Strategy | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Persistable.Bin.Strategy | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Persistable.Bin.Strategy | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Persistable.Bin.Strategy | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Persistable.Bin.Strategy | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Persistable.Bin.Strategy | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Persistable.Bin.Strategy | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Persistable.Bin.Strategy;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Persistable.Bin.Strategy;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Persistable.Bin.Strategy;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Persistable.Bin.Strategy;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Persistable.Bin.Strategy;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Persistable.Bin.Strategy;
     ...
     * @see #fromString
     */
    static make(s: string | null): Persistable.Bin.Strategy | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Persistable.Bin.Strategy;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Persistable.Bin.Strategy;
     ...
     */
    static cachedEmptyInst(): Persistable.Bin.Strategy;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Persistable.Bin.Strategy>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Persistable.Bin.Strategy;
     ...
     */
    static fetch(spec?: FetchSpec | null): FetchResult<Persistable.Bin.Strategy | null>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Persistable.Bin.Strategy | null>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Persistable.Bin.Strategy | null>;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Persistable.Bin.Strategy | null> | null>;
     ...
     */
    get(include?: string | null): Persistable.Bin.Strategy | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string | null): Persistable.Bin.Strategy | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Persistable.Bin.Strategy;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string | null): Persistable.Bin.Strategy | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Persistable.Bin.Strategy;
     ...
     * @see #toString
     */
    static fromString(s: string | null): Persistable.Bin.Strategy | null;
     ...
     */
    create(spec?: UpsertSpec | null): Persistable.Bin.Strategy | null;
     ...
     */
    static createBatch(objs: C3.Array<Persistable.Bin.Strategy | null> | null, spec?: UpsertSpec | null): ObjList<Persistable.Bin.Strategy | null> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Persistable.Bin.Strategy | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Persistable.Bin.Strategy | null> | null;
     ...
     */
    update(srcObj?: Persistable.Bin.Strategy | null, spec?: UpsertSpec | null): Persistable.Bin.Strategy | null;
     ...
     */
    upsert(srcObj?: Persistable.Bin.Strategy | null, spec?: UpsertSpec | null): Persistable.Bin.Strategy | null;
     ...
     */
    merge(spec?: MergeSpec | null): Persistable.Bin.Strategy | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec | null): Persistable.Bin.Strategy | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec | null): Persistable.Bin.Strategy | null;
     ...
     */
    static updateBatch(objs: C3.Array<Persistable.Bin.Strategy | null> | null, srcObjs?: C3.Array<Persistable.Bin.Strategy | null>, spec?: UpsertSpec | null): ObjList<Persistable.Bin.Strategy | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<C3.Array<Persistable.Bin.Strategy | null>>, spec?: UpsertSpec | null): ObjList<Persistable.Bin.Strategy | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: C3.Array<Persistable.Bin.Strategy | null> | null, srcObjs?: C3.Array<Persistable.Bin.Strategy | null>, spec?: UpsertSpec | null): ObjList<Persistable.Bin.Strategy | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<C3.Array<Persistable.Bin.Strategy | null>>, spec?: UpsertSpec | null): ObjList<Persistable.Bin.Strategy | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: C3.Array<Persistable.Bin.Strategy | null> | null, spec?: TouchSpec | null): ObjList<Persistable.Bin.Strategy | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<Persistable.Bin.Strategy | null> | null, spec?: MergeSpec | null): ObjList<Persistable.Bin.Strategy | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<Persistable.Bin.Strategy | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Persistable.Bin.Strategy | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<C3.Array<Persistable.Bin.Strategy | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Persistable.Bin.Strategy | null> | null;
     ...
     */
    static mergeAll(mergeObj: Persistable.Bin.Strategy | null, spec?: MergeAllSpec | null): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Persistable.Bin.Strategy | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: C3.Array<Persistable.Bin.Strategy | null> | null, spec?: UpsertSpec | null): ObjList<Persistable.Bin.Strategy | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: C3.Array<Persistable.Bin.Strategy | null> | null, spec?: UpsertSpec | null): ObjList<Persistable.Bin.Strategy | null> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Persistable.Bin.Strategy | null;
     ...
     */
    static beforeCreate(objs: C3.Array<Persistable.Bin.Strategy | null> | null): ObjList<Persistable.Bin.Strategy | null>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: C3.Array<Persistable.Bin.Strategy | null> | null): ObjList<Persistable.Bin.Strategy | null>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: C3.Array<Persistable.Bin.Strategy | null> | null): ObjList<Persistable.Bin.Strategy | null>;
     ...
     */
    static afterCreate(objs: C3.Array<Persistable.Bin.Strategy | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: C3.Array<Persistable.Bin.Strategy | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: C3.Array<Persistable.Bin.Strategy | null> | null): C3.Array<ObjError | null>;
     ...
     */
    static startImportData(spec?: StartImportDataSpec | null): PushStream<Persistable.Bin.Strategy | null>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Persistable.Bin.Strategy | null>;
     ...
     */
    static forId(id: string | null, failIfMissing?: boolean): Persistable.Bin.Strategy | null;
     ...
     */
    withoutIdentity(): Persistable.Bin.Strategy | null;
     ...
     */
    static typeOfBatch(objs: C3.Array<Persistable.Bin.Strategy | null> | null): C3.Array<EntityType | null>;
     ...
     */
    static dbEcho(template?: Persistable.Bin.Strategy | null, count?: number | null, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: C3.Array<Persistable.Bin.Strategy | null> | null, callback?: λFunction<Persistable.Bin.Strategy | null, Persistable.Bin.Strategy | null> | null): ObjList<Persistable.Bin.Strategy | null>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: C3.Array<Persistable.Bin.Strategy | null> | null, callback?: λFunction<Persistable.Bin.Strategy | null, Persistable.Bin.Strategy | null> | null): C3.Array<ObjError | null>;
     ...
     */
    static doRemoveState(objs: C3.Array<Persistable.Bin.Strategy | null> | null): ObjList<Persistable.Bin.Strategy | null>;
  }
}
