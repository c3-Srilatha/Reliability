// TypeScript definitions for the C3 type IntType

/**
 * The natural integer type in each language. Note that `int` does not have precise semantics because it uses a
 * different native type in each language:
 *  - Java: `long` (64-bit 2s complement)
 *  - Python: `int` (arbitrary length integer)
 *  - JavaScript: `number` (53 bits of precision in a `double`)
 *
 * In particular, large `int` values will not be preserved properly when moving through JavaScript; integer values
 * larger than 9,007,199,254,740,991 (2⁵³, 10¹⁵) may lose their least significant digits. Java `long` values can handle
 * up to 922,337,2036,854,775,807 (2⁶³−1).
 *
 * Java:
 * ```java
 * 1L << 60 == 1152921504606846976L
 * 1L << 70 == 64L
 * ```
 *
 * JavaScript:
 ...
 * ```
 *
 * There are no fields (other than #modifier), so this is normally accessed with {@link PrimitiveType#ofInt}.
 *
 * @see Int32Type
 * @see Int16Type
 * @see ByteType
 * @see BigIntType
 *
 * @remarks this represents a value passed to a method that expects an instance of IntType
 */
declare interface IIntType {
 ...
 * @see BigIntType
 *
 * @remarks this represents a made instance of IntType
 */
declare class IntType extends Obj {

  /**
   * Source file Pkg.Path a C3 Type declaration [.c3typ].
   */
  readonly declaredPkgPath?: string | null;
  withDeclaredPkgPath(declaredPkgPath: string | null): IntType;

  /**
   * Source line number in a C3 Type declaration [.c3typ] file starting with 1 where this metadata element is declared.
   */
  readonly declaredSrcLine?: number | null;
  withDeclaredSrcLine(declaredSrcLine: number | null): IntType;
  ...
  withDeclaredSrcCharInLine(declaredSrcCharInLine: number | null): IntType;
   ...
   */
  readonly pkg: Pkg;
  withPkg(pkg: IPkg): IntType;

  /**
   * SDK json representing instance of this type
   */
  readonly json?: any;
  withJson(json: any): IntType;

  /**
   * The set of annotations defined on this element of metadata represented as json value.
   */
  readonly annotationsJson?: any | null;
  withAnnotationsJson(annotationsJson: any | null): IntType;
  ...
  withModifier(modifier: string | null): IntType;
  ...
  withSerializedType(serializedType: IValueType | null): IntType;
  ...
  withEnumRefType(enumRefType: IReferenceType | null): IntType;
  ...
  withDeclaredEnumValues(declaredEnumValues: C3.Array<string | null> | Array<string | null>): IntType;
   ...
   */
  replaceType(old: Type, new_: Type): IntType;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): IntType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): IntType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): IntType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): IntType | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): IntType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): IntType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<IntType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<IntType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): IntType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): IntType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): IntType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): IntType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): IntType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): IntType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): IntType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): IntType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): IntType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): IntType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): IntType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): IntType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): IntType;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): IntType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): IntType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): IntType;
   ...
   * @see #removeField
   */
  unsetField(field: string): IntType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): IntType;
   ...
   * @see #unsetField
   */
  removeField(field: string): IntType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): IntType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): IntType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): IntType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): IntType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): IntType;

  mergeJson(json: any | null): IntType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): IntType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): IntType;
   ...
   */
  singletonArray(): C3.Array<IntType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<IntType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<IntType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<IntType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<IntType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, IntType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, IntType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<IntType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<IntType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): IntType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): IntType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): IntType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): IntType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): IntType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): IntType;
   ...
   * @see #fromString
   */
  static make(s: string | null): IntType | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): IntType;
   ...
   */
  static cachedEmptyInst(): IntType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<IntType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): IntType;
   ...
   */
  withoutDeclaredSrcPos(recursive?: boolean): IntType;
   ...
   */
  withAnnotation(ann: Annotation): IntType;
   ...
   *         value for the field
   */
  withAnnotation(ann: string, annField?: string | null, value?: any): IntType;
   ...
   * @see #toString
   */
  static fromString(s: string | null): IntType | null;
