// TypeScript definitions for the C3 type IntervalDataFields

/**
 * readOnly ==> readOnly for app. its platform generated.
 *
 * @remarks this represents a value passed to a method that expects an instance of IntervalDataFields
 */
declare interface IIntervalDataFields<TDP> {
 ...
 */
declare class IntervalDataFields<TDP> extends Obj {

  /**
   * Populated on normalization. Indicates the earliest data point across various timeseries fields.
   */
  readonly earliest?: DateTime | null;
  withEarliest(earliest: DateTime | Date | string | null): IntervalDataFields;

  /**
   * Populated on normalization. Indicates the latest data point across various timeseries fields.
   */
  readonly latest?: DateTime | null;
  withLatest(latest: DateTime | Date | string | null): IntervalDataFields;

  /**
   * Populated on normalization. Indicates the earliest data point for each {@link Ann.Ts} fields.
   */
  readonly earliestTsDp?: C3.Map<string | null, TSDataPoint | null>;
  withEarliestTsDp(earliestTsDp: C3.Map<string | null, TSDataPoint | null> | {[key: string | null]: ITSDataPoint | null}): IntervalDataFields;

  /**
   * Populated on normalization. Indicates the latest data point for each {@link Ann.Ts} fields.
   */
  readonly latestTsDp?: C3.Map<string | null, TSDataPoint | null>;
  withLatestTsDp(latestTsDp: C3.Map<string | null, TSDataPoint | null> | {[key: string | null]: ITSDataPoint | null}): IntervalDataFields;
  ...
  withInterval(interval: string | null): IntervalDataFields;

  /**
   * If set, the time series will be normalized in the specified zone.
   */
  readonly timeZone?: string | null;
  withTimeZone(timeZone: string | null): IntervalDataFields;

  /**
   * If set, disables normalizing this time series. Invalidations will still continue to happen for this series normally.
   */
  readonly doNotNormalize?: boolean;
  withDoNotNormalize(doNotNormalize: boolean): IntervalDataFields;

  readonly data?: C3.Array<TDP | null>;
  withData(data: C3.Array<TDP | null> | Array<TDP | null>): IntervalDataFields;

  /**
   * Use this field to specify the interpolation mechanism to be applied for gaps in interval timeseries. Default: `ZERO_INTERPOLATOR`.
   */
  readonly interpolator?: string | null;
  withInterpolator(interpolator: string | null): IntervalDataFields;

  /**
   * Use this field to specify how normalization should handle duplicate data points. A duplicate point is one that has the same start, end, value, unit, and {@link TimedDataPointFields#isEstimated} values. Default: `IGNORE`.
   */
  readonly duplicateHandling?: string | null;
  withDuplicateHandling(duplicateHandling: string | null): IntervalDataFields;

  /**
   * Used to specify how normalization should handle overlapping data points. Default: `AVG`.
   */
  readonly overlapHandling?: string | null;
  withOverlapHandling(overlapHandling: string | null): IntervalDataFields;
  ...
  withBucketInterval(bucketInterval: string | null): IntervalDataFields;
  ...
  withNormalizationPartitionStrategy(normalizationPartitionStrategy: INormalizationPartitionStrategy | null): IntervalDataFields;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): IntervalDataFields<TDP> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): IntervalDataFields<TDP> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): IntervalDataFields<TDP> | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): IntervalDataFields<TDP> | null;
   ...
   */
  replaceType(old: Type, new_: Type): IntervalDataFields<TDP>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): IntervalDataFields<TDP>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): IntervalDataFields<TDP>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<IntervalDataFields<TDP> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<IntervalDataFields<TDP> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): IntervalDataFields<TDP>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): IntervalDataFields<TDP>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): IntervalDataFields<TDP>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): IntervalDataFields<TDP>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): IntervalDataFields<TDP>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): IntervalDataFields<TDP>;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): IntervalDataFields<TDP>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): IntervalDataFields<TDP>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): IntervalDataFields<TDP>;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): IntervalDataFields<TDP>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): IntervalDataFields<TDP>;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): IntervalDataFields<TDP>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): IntervalDataFields<TDP>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): IntervalDataFields<TDP>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): IntervalDataFields<TDP>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): IntervalDataFields<TDP>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): IntervalDataFields<TDP>;
   ...
   * @see #removeField
   */
  unsetField(field: string): IntervalDataFields<TDP>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): IntervalDataFields<TDP>;
   ...
   * @see #unsetField
   */
  removeField(field: string): IntervalDataFields<TDP>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): IntervalDataFields<TDP>;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): IntervalDataFields<TDP>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): IntervalDataFields<TDP>;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): IntervalDataFields<TDP>;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): IntervalDataFields<TDP>;

  mergeJson(json: any | null): IntervalDataFields<TDP>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): IntervalDataFields<TDP>;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): IntervalDataFields<TDP>;
   ...
   */
  singletonArray(): C3.Array<IntervalDataFields<TDP> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<IntervalDataFields<TDP> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<IntervalDataFields<TDP> | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<IntervalDataFields<TDP> | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<IntervalDataFields<TDP> | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, IntervalDataFields<TDP> | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, IntervalDataFields<TDP> | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<IntervalDataFields<TDP> | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<IntervalDataFields<TDP> | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): IntervalDataFields<TDP>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): IntervalDataFields<TDP>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): IntervalDataFields<TDP>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): IntervalDataFields<TDP>;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): IntervalDataFields<TDP>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): IntervalDataFields<TDP>;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): IntervalDataFields<TDP>;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): IntervalDataFields<TDP>;
   ...
   */
  static cachedEmptyInst(): IntervalDataFields<TDP>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<IntervalDataFields<TDP>>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): IntervalDataFields<TDP>;
