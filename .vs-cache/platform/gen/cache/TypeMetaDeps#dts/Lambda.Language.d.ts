// TypeScript definitions for the C3 type Lambda.Language
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Lambda.Language
 */
 ...
 */
declare namespace Lambda {
  export class Language extends Obj {

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): Lambda.Language;
    ...
    withJAVA(JAVA: string | null): Lambda.Language;
    ...
    withJAVASCRIPT(JAVASCRIPT: string | null): Lambda.Language;
    ...
    withPYTHON(PYTHON: string | null): Lambda.Language;
    ...
    withTYPESCRIPT(TYPESCRIPT: string | null): Lambda.Language;
    ...
    withTSX(TSX: string | null): Lambda.Language;
    ...
    withACTION(ACTION: string | null): Lambda.Language;

    /**
     * Implementation is the action name as _type_ `#` _method_ ("Duration.fromString"). This can be invoked from any
     * environment.
     */
    static readonly ACTION?: string | null;

    /**
     * Implementation is a Java method name as _class_ `#` _method_ ("java.lang.Math#abs"). This only works within the
     * server environment.
     */
    readonly JAVA_METHOD?: string | null;
    withJAVA_METHOD(JAVA_METHOD: string | null): Lambda.Language;

    /**
     * Implementation is a Java method name as _class_ `#` _method_ ("java.lang.Math#abs"). This only works within the
     * server environment.
     */
    static readonly JAVA_METHOD?: string | null;
     ...
     * @see https://docs.oracle.com/javase/8/docs/api/java/lang/invoke/SerializedLambda.html
     */
    readonly JAVA_LAMBDA?: string | null;
    withJAVA_LAMBDA(JAVA_LAMBDA: string | null): Lambda.Language;
     ...
     * @see https://docs.oracle.com/javase/8/docs/api/java/lang/invoke/SerializedLambda.html
     */
    static readonly JAVA_LAMBDA?: string | null;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Lambda.Language | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Lambda.Language | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Lambda.Language | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Lambda.Language | null;
     ...
     */
    replaceType(old: Type, new_: Type): Lambda.Language;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Lambda.Language;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Lambda.Language;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Lambda.Language;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Lambda.Language;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Lambda.Language;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Lambda.Language | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Lambda.Language | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Lambda.Language | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Lambda.Language | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Lambda.Language;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Lambda.Language;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Lambda.Language;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Lambda.Language;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Lambda.Language;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Lambda.Language;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Lambda.Language;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Lambda.Language;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Lambda.Language;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Lambda.Language;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Lambda.Language;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Lambda.Language;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Lambda.Language;
     ...
     * @return new Obj
     */
    static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Lambda.Language;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Lambda.Language;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Lambda.Language;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Lambda.Language;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Lambda.Language;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Lambda.Language;
     ...
     * @see #removeField
     */
    static withoutField(field: string | null): Lambda.Language;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Lambda.Language;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType | null): Lambda.Language;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Lambda.Language;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: C3.Array<string | null> | null): Lambda.Language;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Lambda.Language;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Lambda.Language;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Lambda.Language;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Lambda.Language;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Lambda.Language;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Lambda.Language;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Lambda.Language;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Lambda.Language;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Lambda.Language;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Lambda.Language;
     ...
     * @see #removeField
     */
    unsetField(field: string): Lambda.Language;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Lambda.Language;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Lambda.Language;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Lambda.Language;
     ...
     * @see #unsetField
     */
    removeField(field: string): Lambda.Language;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Lambda.Language;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Lambda.Language;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Lambda.Language;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Lambda.Language;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Lambda.Language;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Lambda.Language;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj | null, otherFieldsFilter: Type): Lambda.Language;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Lambda.Language;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Lambda.Language;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Lambda.Language;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Lambda.Language;

    mergeJson(json: any | null): Lambda.Language;

    static mergeJson(json: any | null): Lambda.Language;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Lambda.Language;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Lambda.Language;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Lambda.Language;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj | null, deep?: boolean): Lambda.Language;
     ...
     */
    singletonArray(): C3.Array<Lambda.Language | null>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): C3.Array<Lambda.Language | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Lambda.Language | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Lambda.Language | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Lambda.Language | null>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): C3.Set<Lambda.Language | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Lambda.Language | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Lambda.Language | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Lambda.Language | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Lambda.Language | null>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Lambda.Language | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Lambda.Language | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Lambda.Language;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Lambda.Language;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Lambda.Language;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Lambda.Language;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Lambda.Language;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Lambda.Language;
     ...
     * @see #fromString
     */
    static make(s: string | null): Lambda.Language | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Lambda.Language;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Lambda.Language;
     ...
     */
    static cachedEmptyInst(): Lambda.Language;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Lambda.Language>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Lambda.Language;
     ...
     */
    static forFileExt(ext: string | null, failIfNone?: boolean): Lambda.Language | null;
