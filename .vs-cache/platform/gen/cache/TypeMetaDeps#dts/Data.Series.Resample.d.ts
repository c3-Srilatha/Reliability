// TypeScript definitions for the C3 type Data.Series.Resample

/**
 * @remarks this represents a value passed to a method that expects an instance of Data.Series.Resample
 */
declare namespace Data.Series {
  export interface IResample {
 ...
 */
declare namespace Data.Series {
  export class Resample extends Obj {
    ...
    withSTATELESS_CACHE(STATELESS_CACHE: string | null): Data.Series.Resample;
     ...
     */
    readonly this: any;
    withThis(this_: any): Data.Series.Resample;

    /**
     * Target action returning DataImpl
     */
    readonly action: string;
    withAction(action: string): Data.Series.Resample;

    /**
     * Applied arguments
     */
    readonly args?: C3.Map<string | null, any>;
    withArgs(args: C3.Map<string | null, any> | {[key: string | null]: any}): Data.Series.Resample;
    ...
    with_inferredOutType(_inferredOutType: C3.Map<string | null, ValueType | null> | {[key: string | null]: IValueType | null}): Data.Series.Resample;

    get ax(): Data.PeriodIndex | null | Data.DatetimeIndex | null | Data.TimedeltaIndex | null | null;
    ...
    get obj(): Data.Series | null;

    agg(func?: any): Data.Series | null;

    aggregate(func?: any): Data.Series | null;

    apply(func?: any): Data.Series | null;

    asfreq(fill_value?: any): Data.Series | null;

    backfill(limit?: number | null): Data.Series | null;

    bfill(limit?: number | null): Data.Series | null;

    count(): Data.Series | null;

    ffill(limit?: number | null): Data.Series | null;

    fillna(method?: any, limit?: any): Data.Series | null;

    first(_method?: any, min_count?: any): Data.Series | null;

    get_group(name?: any, obj?: any): Data.Series | null;

    interpolate(method?: any, axis?: any, limit?: any, inplace?: any, limit_direction?: any, limit_area?: any, downcast?: any): Data.Series | null;

    last(_method?: any, min_count?: any): Data.Series | null;

    max(_method?: any, min_count?: any): Data.Series | null;

    mean(_method?: any): Data.Series | null;

    median(_method?: any): Data.Series | null;

    min(_method?: any, min_count?: any): Data.Series | null;

    nearest(limit?: number | null): Data.Series | null;

    nunique(_method?: any): Data.Series | null;

    ohlc(_method?: any): Data | null;

    pad(limit?: number | null): Data.Series | null;

    prod(_method?: any, min_count?: any): Data.Series | null;

    quantile(q?: any): Data.Series | null;

    sem(_method?: any): Data.Series | null;

    size(): Data.Series | null;

    std(ddof?: any): Data.Series | null;

    sum(_method?: any, min_count?: any): Data.Series | null;

    transform(arg?: any): Data.Series | null;

    var(ddof?: any): Data.Series | null;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.Series.Resample | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.Series.Resample | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.Series.Resample | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.Series.Resample | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.Series.Resample;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Series.Resample;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Series.Resample;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Series.Resample | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Series.Resample | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.Series.Resample;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Series.Resample;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Series.Resample;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.Series.Resample;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.Series.Resample;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.Series.Resample;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.Series.Resample;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.Series.Resample;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.Series.Resample;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.Series.Resample;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.Series.Resample;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.Series.Resample;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.Series.Resample;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.Series.Resample;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.Series.Resample;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.Series.Resample;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.Series.Resample;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.Series.Resample;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.Series.Resample;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.Series.Resample;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.Series.Resample;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.Series.Resample;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.Series.Resample;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.Series.Resample;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.Series.Resample;

    mergeJson(json: any | null): Data.Series.Resample;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.Series.Resample;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.Series.Resample;
     ...
     */
    singletonArray(): C3.Array<Data.Series.Resample | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.Series.Resample | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.Series.Resample | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.Series.Resample | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.Series.Resample | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.Series.Resample | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.Series.Resample | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.Series.Resample | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.Series.Resample | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.Series.Resample;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.Series.Resample;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.Series.Resample;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.Series.Resample;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.Series.Resample;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.Series.Resample;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.Series.Resample;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Data.Series.Resample;
     ...
     */
    static cachedEmptyInst(): Data.Series.Resample;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.Series.Resample>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.Series.Resample;
     ...
     */
    static fromPySrc(pySrc: string, dfs?: C3.Set<DataImpl | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): Data.Series.Resample | null;
     ...
     */
    static _jsDataProxy(inst: any): Data.Series.Resample;
     ...
     */
    static create(this_: any, action: string, args?: C3.Map<string | null, any>): Data.Series.Resample;
