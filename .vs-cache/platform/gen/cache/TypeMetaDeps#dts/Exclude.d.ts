// TypeScript definitions for the C3 type Exclude

/**
 * @remarks this represents a value passed to a method that expects an instance of Exclude
 */
declare interface IExclude {
}

/**
 * @remarks this represents a made instance of Exclude
 */
declare class Exclude {
   ...
   * @see #toString
   */
  static fromString(s: string | null): Exclude | null;
   ...
   * @see #fromString
   */
  static make(s: string | null): Exclude | null;
   ...
   * @see #children
   */
  get(field: string | null, failIfMissing?: boolean): Exclude | null;
   ...
   * @see #withThis
   */
  with(other: Include | null): Exclude;
   ...
   * @see #fieldPaths
   */
  static parse(typ: Type, include: string | null): Exclude | null;
