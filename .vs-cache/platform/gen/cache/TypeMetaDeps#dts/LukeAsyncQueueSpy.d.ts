// TypeScript definitions for the C3 type LukeAsyncQueueSpy

/**
 * A subtype of {@link LukeAsyncQueueNode} that resolves with a jasmine.Spy
 *
 * @remarks this represents a value passed to a method that expects an instance of LukeAsyncQueueSpy
 */
declare interface ILukeAsyncQueueSpy {
 ...
 * A subtype of {@link LukeAsyncQueueNode} that resolves with a jasmine.Spy
 *
 * @remarks this represents a made instance of LukeAsyncQueueSpy
 */
declare class LukeAsyncQueueSpy extends Obj {
   ...
   */
  timeout?: number | null;
  withTimeout(timeout: number | null): LukeAsyncQueueSpy;

  /**
   * The next node in the chain
   */
  next?: LukeAsyncQueueNode | null;
  withNext(next: ILukeAsyncQueueNode | null): LukeAsyncQueueSpy;

  /**
   * The head of the chain that contains the current node
   */
  head?: LukeAsyncQueueNode | null;
  withHead(head: ILukeAsyncQueueNode | null): LukeAsyncQueueSpy;
  ...
  withCatchChain(catchChain: ILukeAsyncQueueNode | null): LukeAsyncQueueSpy;

  /**
   * When the node started running
   */
  startedAt?: number | null;
  withStartedAt(startedAt: number | null): LukeAsyncQueueSpy;

  /**
   * When the node ended running
   */
  endedAt?: number | null;
  withEndedAt(endedAt: number | null): LukeAsyncQueueSpy;

  /**
   * If the node spawns a nested async queue, its chains (heads) will be stored here.
   */
  asyncQueue?: C3.Array<LukeAsyncQueueNode | null>;
  withAsyncQueue(asyncQueue: C3.Array<LukeAsyncQueueNode | null> | Array<ILukeAsyncQueueNode | null>): LukeAsyncQueueSpy;

  /**
   * Whether to skip the remaining chains in the queue
   */
  skipQueueFlag?: boolean;
  withSkipQueueFlag(skipQueueFlag: boolean): LukeAsyncQueueSpy;

  /**
   * The function that yields a promise
   */
  func: any;
  withFunc(func: any): LukeAsyncQueueSpy;
   ...
   */
  args?: C3.Array<any>;
  withArgs(args: C3.Array<any> | Array<any>): LukeAsyncQueueSpy;

  /**
   * Metadata about what type of node this is.
   */
  label?: string | null;
  withLabel(label: string | null): LukeAsyncQueueSpy;

  /**
   * "Unique" id assigned to each LukeAsyncQueueNode for UI. Uses C3 unique ID generator, but not backed by database
   */
  uuid?: string | null;
  withUuid(uuid: string | null): LukeAsyncQueueSpy;

  /**
   * Construct an instance with initial state.
   */
  static make(): LukeAsyncQueueSpy;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LukeAsyncQueueSpy;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LukeAsyncQueueSpy;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LukeAsyncQueueSpy;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LukeAsyncQueueSpy;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LukeAsyncQueueSpy | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LukeAsyncQueueSpy | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LukeAsyncQueueSpy | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LukeAsyncQueueSpy | null;
   ...
   */
  replaceType(old: Type, new_: Type): LukeAsyncQueueSpy;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeAsyncQueueSpy;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeAsyncQueueSpy;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeAsyncQueueSpy | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeAsyncQueueSpy | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LukeAsyncQueueSpy;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeAsyncQueueSpy;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeAsyncQueueSpy;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LukeAsyncQueueSpy;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LukeAsyncQueueSpy;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LukeAsyncQueueSpy;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LukeAsyncQueueSpy;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LukeAsyncQueueSpy;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LukeAsyncQueueSpy;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LukeAsyncQueueSpy;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LukeAsyncQueueSpy;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LukeAsyncQueueSpy;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LukeAsyncQueueSpy;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LukeAsyncQueueSpy;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LukeAsyncQueueSpy;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LukeAsyncQueueSpy;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LukeAsyncQueueSpy;
   ...
   * @see #removeField
   */
  unsetField(field: string): LukeAsyncQueueSpy;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LukeAsyncQueueSpy;
   ...
   * @see #unsetField
   */
  removeField(field: string): LukeAsyncQueueSpy;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LukeAsyncQueueSpy;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LukeAsyncQueueSpy;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LukeAsyncQueueSpy;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LukeAsyncQueueSpy;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LukeAsyncQueueSpy;

  mergeJson(json: any | null): LukeAsyncQueueSpy;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LukeAsyncQueueSpy;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LukeAsyncQueueSpy;
   ...
   */
  singletonArray(): C3.Array<LukeAsyncQueueSpy | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LukeAsyncQueueSpy | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LukeAsyncQueueSpy | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LukeAsyncQueueSpy | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LukeAsyncQueueSpy | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LukeAsyncQueueSpy | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LukeAsyncQueueSpy | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LukeAsyncQueueSpy | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LukeAsyncQueueSpy | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LukeAsyncQueueSpy;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LukeAsyncQueueSpy;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LukeAsyncQueueSpy;
   ...
   */
  static cachedEmptyInst(): LukeAsyncQueueSpy;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LukeAsyncQueueSpy>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LukeAsyncQueueSpy;
   ...
   * @return this Obj
   */
  setField(field: string, value: any, doNotConvert?: boolean): LukeAsyncQueueSpy;
   ...
   * @return this Obj
   */
  setField(field: FieldType, value: any, doNotConvert?: boolean): LukeAsyncQueueSpy;
   ...
   *          The comparator
   * @param expected
   *          The expected params with which the spy function is called. For example, if the spy function is called
   *          like spy(arg1, arg2, arg3), the expected would be [arg1, arg2, arg3]
   *
   * @param customMessage
   *          Custom message that gets appended to the standard error message
   * @return An async node that resolves or reject based on the assertion result
   */
  assert(comparator: string, expected?: C3.Array<any>, customMessage?: string | null): LukeAsyncQueueNode | null;
  ...
  /**
   * Attaches a negative assertion async node to the current node.
   * When the value from the current node is resolved, it will be used to make an assertion against the expected value and negates the result.
   * @param comparator
   *          The comparator
   * @param expected
   *          The expected params with which the spy function is called. For example, if the spy function is called
   ...
   * @return An async node that resolves or reject based on the assertion result
   */
  assertNot(comparator: string, expected?: C3.Array<any>, customMessage?: string | null): LukeAsyncQueueNode | null;
   ...
   *          Custom message that gets appended to the standard error message
   * @param negate
   *          If the results of evaluation should be negated before making the assertion
   * @return An async node that resolves or rejects based on the assertion result
   */
  makeAssertion(comparator: string, expected?: C3.Array<any>, customMessage?: string | null, negate?: boolean): LukeAsyncQueueNode | null;
