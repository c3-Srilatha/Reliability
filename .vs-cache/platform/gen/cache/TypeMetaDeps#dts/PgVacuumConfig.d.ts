// TypeScript definitions for the C3 type PgVacuumConfig

/**
 * Configuration for C3 managed vacuuming of Postgres tables.
 *
 * @remarks this represents a value passed to a method that expects an instance of PgVacuumConfig
 */
declare interface IPgVacuumConfig {
  ...
  /**
   * Percentage of dead tuples compared to the number of live tuples that will trigger a vacuum for the table.
   */
  deadTuplesPctThreshold: number;
}

/**
 * Configuration for C3 managed vacuuming of Postgres tables.
 *
 * @remarks this represents a made instance of PgVacuumConfig
 */
declare class PgVacuumConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): PgVacuumConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): PgVacuumConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): PgVacuumConfig;

  /**
   * Percentage of dead tuples compared to the number of live tuples that will trigger a vacuum for the table.
   */
  readonly deadTuplesPctThreshold: number;
  withDeadTuplesPctThreshold(deadTuplesPctThreshold: number): PgVacuumConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): PgVacuumConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): PgVacuumConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): PgVacuumConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): PgVacuumConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): PgVacuumConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PgVacuumConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PgVacuumConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PgVacuumConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PgVacuumConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): PgVacuumConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PgVacuumConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PgVacuumConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PgVacuumConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PgVacuumConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PgVacuumConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): PgVacuumConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PgVacuumConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PgVacuumConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): PgVacuumConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): PgVacuumConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): PgVacuumConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): PgVacuumConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PgVacuumConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): PgVacuumConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PgVacuumConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PgVacuumConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): PgVacuumConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PgVacuumConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): PgVacuumConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PgVacuumConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): PgVacuumConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): PgVacuumConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): PgVacuumConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): PgVacuumConfig;

  mergeJson(json: any | null): PgVacuumConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): PgVacuumConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): PgVacuumConfig;
   ...
   */
  singletonArray(): C3.Array<PgVacuumConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<PgVacuumConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PgVacuumConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<PgVacuumConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PgVacuumConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, PgVacuumConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PgVacuumConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PgVacuumConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PgVacuumConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): PgVacuumConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): PgVacuumConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): PgVacuumConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PgVacuumConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): PgVacuumConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PgVacuumConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): PgVacuumConfig;
   ...
   */
  static cachedEmptyInst(): PgVacuumConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<PgVacuumConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): PgVacuumConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<PgVacuumConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<PgVacuumConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<PgVacuumConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): PgVacuumConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): PgVacuumConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): PgVacuumConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): PgVacuumConfig | null;
   ...
   */
  static produce(key: string): PgVacuumConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, PgVacuumConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, PgVacuumConfig | null>;
   ...
   */
  static forConfigKey(configKey: string | null): PgVacuumConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<PgVacuumConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: PgVacuumConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: PgVacuumConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): PgVacuumConfig | null;
