// TypeScript definitions for the C3 type DataIntegTester

/**
 * Performs canonical app test
 *
 * @remarks this represents a value passed to a method that expects an instance of DataIntegTester
 */
declare interface IDataIntegTester {
 ...
 * Performs canonical app test
 *
 * @remarks this represents a made instance of DataIntegTester
 */
declare class DataIntegTester extends Obj {

  testRunner: TestRunner;
  withTestRunner(testRunner: ITestRunner): DataIntegTester;
   ...
   */
  state: string;
  withState(state: string): DataIntegTester;

  /**
   * The collected test results after the test execution.
   */
  results?: C3.Array<TestSuiteResult | null>;
  withResults(results: C3.Array<TestSuiteResult | null> | Array<ITestSuiteResult | null>): DataIntegTester;

  /**
   * The action engine in which tests will execute.
   */
  engine: Action.Engine;
  withEngine(engine: IAction.Engine): DataIntegTester;

  /**
   * Construct an instance with initial state.
   */
  static make(): DataIntegTester;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DataIntegTester;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DataIntegTester;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DataIntegTester;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DataIntegTester;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): DataIntegTester | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): DataIntegTester | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): DataIntegTester | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): DataIntegTester | null;
   ...
   */
  replaceType(old: Type, new_: Type): DataIntegTester;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataIntegTester;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataIntegTester;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataIntegTester | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataIntegTester | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataIntegTester;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataIntegTester;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataIntegTester;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DataIntegTester;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DataIntegTester;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DataIntegTester;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataIntegTester;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataIntegTester;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DataIntegTester;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): DataIntegTester;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): DataIntegTester;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): DataIntegTester;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataIntegTester;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DataIntegTester;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataIntegTester;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DataIntegTester;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DataIntegTester;
   ...
   * @see #removeField
   */
  unsetField(field: string): DataIntegTester;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DataIntegTester;
   ...
   * @see #unsetField
   */
  removeField(field: string): DataIntegTester;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DataIntegTester;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataIntegTester;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): DataIntegTester;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataIntegTester;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataIntegTester;

  mergeJson(json: any | null): DataIntegTester;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataIntegTester;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): DataIntegTester;
   ...
   */
  singletonArray(): C3.Array<DataIntegTester | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<DataIntegTester | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DataIntegTester | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<DataIntegTester | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DataIntegTester | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, DataIntegTester | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataIntegTester | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DataIntegTester | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DataIntegTester | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DataIntegTester;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DataIntegTester;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DataIntegTester;
   ...
   */
  static cachedEmptyInst(): DataIntegTester;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DataIntegTester>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): DataIntegTester;
   ...
   * @return this Obj
   */
  setField(field: string, value: any, doNotConvert?: boolean): DataIntegTester;
   ...
   * @return this Obj
   */
  setField(field: FieldType, value: any, doNotConvert?: boolean): DataIntegTester;
   ...
   */
  static forPathAndEngine(path: string, engine: string): DataIntegTester;
   ...
   * Note: invoke this API on the desired type of Tester instead of on the Tester type directly.
   */
  static forNameAndEngine(testName: string, engine: string): DataIntegTester;
   ...
   * Note: invoke this API on the desired type of Tester instead of on the Tester type directly.
   */
  static forEngine(engine: string, deep?: boolean): DataIntegTester;
   ...
   */
  run(spec?: TesterRunSpec | null): DataIntegTester;
   ...
   *  ```js
   *
   *  var testPath = Pkg.Path.make({ package: testPackage, category: Pkg.Category.OTHER, encodedSubPath: "test/canonical/folder1"});
   *  var res = DataIntegTester.runTestSuiteCode(<testSuiteCode>, testPath);
   *  ```
   * @param path
   *           Path to the folder where the canonical test exists.
   * @return The test result of the canonical test.
   */
  ...
  /**
   * The DataIntegTester does canonical transform based on what is provided in the data folder
   * (A canonical test folder contains two folders named *canonical* and *expected*. E.g. "myTenant/test/canonical/folder1/canonical"
   * and "myTenant/test/canonical/folder1/expected". In this example, "myTenant/test/canonical/folder1" is the canonical test folder,
   * and "myTenant/test/canonical/folder1/canonical" is the data folder) and generates results to compare with what is
   * provided in the expected folder (in the above example, namely, "myTenant/test/canonical/folder1/expected").
   * In case you want to know the generated reference results for debugging purpose, this function will help.
   * 1. Provision the tenant you want to test. E.g. *myTenant*
   * 2. Find an arbitrary location in local file system where you want to export the reference result.
   *    E.g. "/path/myTenant/test/canonical/folder1/referenceResults"
   * 3. Go to workbench, switch to *myTenant*.
   * 4. Execute the following commands, then the reference result will be generated under folder
   *    "/path/myTenant/test/canonical/folder1/referenceResults". You can use it to compare with the expected result you
   *    provide in "myTenant/test/canonical/folder1/expected" and debug.
   *
   * ```js
   * var testPackage = Pkg.Store.pkg("myTenant" true);
   * var testPath = Pkg.Path.make({repository: testPackage.repository, package: "myTenant", category: Pkg.Category.OTHER, encodedSubPath: "test/canonical/folder1"});
   * var resStatus = DataIntegTester.generateExpectedResult(testPath, "/path/myTenant/test/canonical/folder1/referenceResults");
   * ```
   *
   * @param path
   *             Path to the folder where the canonical test exists
   * @param absoluteExportPath
   *             File system absolute path to export the expected result locally
   * @return Information about export result
   */
  static generateExpectedResult(path: Pkg.Path, absoluteExportPath: string): string;
}
