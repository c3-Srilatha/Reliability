// TypeScript definitions for the C3 type JdbcStoreConfig

/**
 * @remarks this represents a value passed to a method that expects an instance of JdbcStoreConfig
 */
declare interface IJdbcStoreConfig {
   ...
   */
  connectionPool?: IDatastoreConnectionPoolConfig<DatastoreConfig<JdbcCredentials | null> | null> | null;

  /**
   * How to access the data in the datastore.  Override to provide things such as endpoint, username, password,
   * etc. as appropriate.
   */
  credentials?: IJdbcCredentials | null;
  ...
  readConnectionPool?: IDatastoreConnectionPoolConfig<DatastoreConfig<JdbcCredentials | null> | null> | null;

  writeConnectionPool?: IDatastoreConnectionPoolConfig<DatastoreConfig<JdbcCredentials | null> | null> | null;

  /**
   * Set to true to validate connections on borrow from the connection pool.
   */
  validateConnections?: boolean;
}

/**
 * @remarks this represents a made instance of JdbcStoreConfig
 */
declare class JdbcStoreConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): JdbcStoreConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): JdbcStoreConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): JdbcStoreConfig;

  /**
   * The unique and required name of this instance.
   */
  readonly name: string;
  withName(name: string): JdbcStoreConfig;

  /**
   * Physical pool for connections
   */
  readonly connectionPool?: DatastoreConnectionPoolConfig<DatastoreConfig<JdbcCredentials | null> | null> | null;
  withConnectionPool(connectionPool: IDatastoreConnectionPoolConfig<DatastoreConfig<JdbcCredentials | null> | null> | null): JdbcStoreConfig;

  /**
   * How to access the data in the datastore.  Override to provide things such as endpoint, username, password,
   * etc. as appropriate.
   */
  readonly credentials?: JdbcCredentials | null;
  withCredentials(credentials: IJdbcCredentials | null): JdbcStoreConfig;

  /**
   * C3 Cloud Identifier for backing infrastructure that hosts the Datastore ex: {@link PostgresDb#id}, {@link CassandraDb#id}
   */
  readonly cloudId?: string | null;
  withCloudId(cloudId: string | null): JdbcStoreConfig;

  /**
   * True if the datastore is disabled (e.g. no data access is permitted).
   */
  readonly disabled?: boolean;
  withDisabled(disabled: boolean): JdbcStoreConfig;

  /**
   * True if the datastore is read only, i.e. can only be queried.
   */
  readonly readOnly?: boolean;
  withReadOnly(readOnly: boolean): JdbcStoreConfig;

  /**
   * True if the datastore is external, i.e. its database schema can not be altered.
   */
  readonly external?: boolean;
  withExternal(external: boolean): JdbcStoreConfig;
  ...
  withPerTenant(perTenant: boolean): JdbcStoreConfig;

  /**
   * Description for the dataStore.
   */
  readonly description?: string | null;
  withDescription(description: string | null): JdbcStoreConfig;

  /**
   * True if the db is shared with other apps or it is dedicated.
   */
  readonly dedicated?: boolean;
  withDedicated(dedicated: boolean): JdbcStoreConfig;

  readonly shareReadConnection?: boolean;
  withShareReadConnection(shareReadConnection: boolean): JdbcStoreConfig;

  readonly sharedReadThreshold: number;
  withSharedReadThreshold(sharedReadThreshold: number): JdbcStoreConfig;

  readonly readConnectionPool?: DatastoreConnectionPoolConfig<DatastoreConfig<JdbcCredentials | null> | null> | null;
  withReadConnectionPool(readConnectionPool: IDatastoreConnectionPoolConfig<DatastoreConfig<JdbcCredentials | null> | null> | null): JdbcStoreConfig;

  readonly writeConnectionPool?: DatastoreConnectionPoolConfig<DatastoreConfig<JdbcCredentials | null> | null> | null;
  withWriteConnectionPool(writeConnectionPool: IDatastoreConnectionPoolConfig<DatastoreConfig<JdbcCredentials | null> | null> | null): JdbcStoreConfig;

  /**
   * Set to true to validate connections on borrow from the connection pool.
   */
  readonly validateConnections?: boolean;
  withValidateConnections(validateConnections: boolean): JdbcStoreConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): JdbcStoreConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): JdbcStoreConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): JdbcStoreConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): JdbcStoreConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): JdbcStoreConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JdbcStoreConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JdbcStoreConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JdbcStoreConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JdbcStoreConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): JdbcStoreConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JdbcStoreConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JdbcStoreConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): JdbcStoreConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): JdbcStoreConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): JdbcStoreConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): JdbcStoreConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): JdbcStoreConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): JdbcStoreConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): JdbcStoreConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): JdbcStoreConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): JdbcStoreConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): JdbcStoreConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): JdbcStoreConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): JdbcStoreConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): JdbcStoreConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): JdbcStoreConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): JdbcStoreConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): JdbcStoreConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): JdbcStoreConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): JdbcStoreConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): JdbcStoreConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): JdbcStoreConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): JdbcStoreConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): JdbcStoreConfig;

  mergeJson(json: any | null): JdbcStoreConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): JdbcStoreConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): JdbcStoreConfig;
   ...
   */
  singletonArray(): C3.Array<JdbcStoreConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<JdbcStoreConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<JdbcStoreConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<JdbcStoreConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<JdbcStoreConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, JdbcStoreConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, JdbcStoreConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<JdbcStoreConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<JdbcStoreConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): JdbcStoreConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): JdbcStoreConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): JdbcStoreConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): JdbcStoreConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): JdbcStoreConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): JdbcStoreConfig;
   ...
   * @see #fromString
   */
  static make(s: string | null): JdbcStoreConfig | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): JdbcStoreConfig;
   ...
   */
  static cachedEmptyInst(): JdbcStoreConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<JdbcStoreConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): JdbcStoreConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<JdbcStoreConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<JdbcStoreConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<JdbcStoreConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): JdbcStoreConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): JdbcStoreConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): JdbcStoreConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): JdbcStoreConfig | null;
   ...
   */
  static produce(key: string): JdbcStoreConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, JdbcStoreConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, JdbcStoreConfig | null>;
   ...
   */
  static forConfigKey(configKey: string | null): JdbcStoreConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<JdbcStoreConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: JdbcStoreConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: JdbcStoreConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): JdbcStoreConfig | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): JdbcStoreConfig | null;
   ...
   */
  static forName(name: string | null, failIfMissing?: boolean): JdbcStoreConfig | null;
  ...
  /**
   * @return The password from the vault.
   */
  secretPassword(): string | null;

  /**
   * @return the adminPassword from the vault.
   */
  secretAdminPassword(): string | null;
}
