// TypeScript definitions for the C3 type Arrow.Buffer

/**
 * Type representing https://arrow.apache.org/docs/index.html buffer
 *
 * @remarks this represents a value passed to a method that expects an instance of Arrow.Buffer
 */
...
declare namespace Arrow {
  export class Buffer {
     ...
     */
    vector(field: string): Arrow.Buffer.Vector;
     ...
     */
    static read(type: Type | null | TupleType | null, arrow: Content | null, failIfInvalid?: boolean): Arrow.Buffer | null;

    /**
     * Reads instance of of Arrow from binary value
     */
    static read(type: Type | null | TupleType | null, arrow: any | null, failIfInvalid?: boolean): Arrow.Buffer | null;

    /**
     * Reads instance of Arrow from binary stream
     */
    static read(type: Type | null | TupleType | null, arrow: ByteStream | null, failIfInvalid?: boolean): Arrow.Buffer | null;

    /**
     * Reads instance of Arrow from binary stream
     */
    static read(type: Type | null | TupleType | null, arrow: Stream<number | null> | null, failIfInvalid?: boolean): Arrow.Buffer | null;
     ...
     */
    static from(value: C3.Array<any> | null): Arrow.Buffer | null;

    /**
     * Makes instance of Arrow from a sequence of columns represented as tuple of arrays.
     */
    static fromColumns(value: Tuple | null): Arrow.Buffer | null;
