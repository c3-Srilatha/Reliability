// TypeScript definitions for the C3 type AutoCreateUser

/**
 * @remarks this represents a value passed to a method that expects an instance of AutoCreateUser
 */
declare interface IAutoCreateUser {
...
/**
 * @remarks this represents a made instance of AutoCreateUser
 */
declare class AutoCreateUser extends Obj {
   ...
   */
  readonly id: string;
  withId(id: string): AutoCreateUser;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): AutoCreateUser;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): AutoCreateUser;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): AutoCreateUser;
  ...
  withVersion(version: number | null): AutoCreateUser;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): AutoCreateUser;

  readonly defaultGroupId?: string | null;
  withDefaultGroupId(defaultGroupId: string | null): AutoCreateUser;

  readonly emailSuffix?: string | null;
  withEmailSuffix(emailSuffix: string | null): AutoCreateUser;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): AutoCreateUser | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): AutoCreateUser | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): AutoCreateUser | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): AutoCreateUser | null;
   ...
   */
  replaceType(old: Type, new_: Type): AutoCreateUser;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): AutoCreateUser;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): AutoCreateUser;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<AutoCreateUser | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<AutoCreateUser | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): AutoCreateUser;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AutoCreateUser;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AutoCreateUser;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): AutoCreateUser;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): AutoCreateUser;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): AutoCreateUser;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): AutoCreateUser;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): AutoCreateUser;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): AutoCreateUser;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): AutoCreateUser;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): AutoCreateUser;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): AutoCreateUser;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): AutoCreateUser;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): AutoCreateUser;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): AutoCreateUser;
   ...
   * @see #unsetField
   */
  defaultField(field: string): AutoCreateUser;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): AutoCreateUser;
   ...
   * @see #removeField
   */
  unsetField(field: string): AutoCreateUser;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): AutoCreateUser;
   ...
   * @see #unsetField
   */
  removeField(field: string): AutoCreateUser;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): AutoCreateUser;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): AutoCreateUser;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): AutoCreateUser;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): AutoCreateUser;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): AutoCreateUser;

  mergeJson(json: any | null): AutoCreateUser;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): AutoCreateUser;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): AutoCreateUser;
   ...
   */
  singletonArray(): C3.Array<AutoCreateUser | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<AutoCreateUser | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<AutoCreateUser | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<AutoCreateUser | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<AutoCreateUser | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, AutoCreateUser | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, AutoCreateUser | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<AutoCreateUser | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<AutoCreateUser | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): AutoCreateUser;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): AutoCreateUser;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): AutoCreateUser;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): AutoCreateUser;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): AutoCreateUser;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): AutoCreateUser;
   ...
   * @see #fromString
   */
  static make(s: string | null): AutoCreateUser | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): AutoCreateUser;
   ...
   */
  static cachedEmptyInst(): AutoCreateUser;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<AutoCreateUser>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): AutoCreateUser;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<AutoCreateUser | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<AutoCreateUser | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<AutoCreateUser | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<AutoCreateUser | null> | null>;
   ...
   */
  get(include?: string | null): AutoCreateUser | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): AutoCreateUser | null;
   ...
   */
  getMissing(spec: GetMissingSpec): AutoCreateUser;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): AutoCreateUser | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): AutoCreateUser;
   ...
   * @see #toString
   */
  static fromString(s: string | null): AutoCreateUser | null;
   ...
   */
  create(spec?: UpsertSpec | null): AutoCreateUser | null;
   ...
   */
  static createBatch(objs: C3.Array<AutoCreateUser | null> | null, spec?: UpsertSpec | null): ObjList<AutoCreateUser | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<AutoCreateUser | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<AutoCreateUser | null> | null;
   ...
   */
  update(srcObj?: AutoCreateUser | null, spec?: UpsertSpec | null): AutoCreateUser | null;
   ...
   */
  upsert(srcObj?: AutoCreateUser | null, spec?: UpsertSpec | null): AutoCreateUser | null;
   ...
   */
  merge(spec?: MergeSpec | null): AutoCreateUser | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): AutoCreateUser | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): AutoCreateUser | null;
   ...
   */
  static updateBatch(objs: C3.Array<AutoCreateUser | null> | null, srcObjs?: C3.Array<AutoCreateUser | null>, spec?: UpsertSpec | null): ObjList<AutoCreateUser | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<AutoCreateUser | null>>, spec?: UpsertSpec | null): ObjList<AutoCreateUser | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<AutoCreateUser | null> | null, srcObjs?: C3.Array<AutoCreateUser | null>, spec?: UpsertSpec | null): ObjList<AutoCreateUser | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<AutoCreateUser | null>>, spec?: UpsertSpec | null): ObjList<AutoCreateUser | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<AutoCreateUser | null> | null, spec?: TouchSpec | null): ObjList<AutoCreateUser | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<AutoCreateUser | null> | null, spec?: MergeSpec | null): ObjList<AutoCreateUser | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<AutoCreateUser | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<AutoCreateUser | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<AutoCreateUser | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<AutoCreateUser | null> | null;
   ...
   */
  static mergeAll(mergeObj: AutoCreateUser | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: AutoCreateUser | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<AutoCreateUser | null> | null, spec?: UpsertSpec | null): ObjList<AutoCreateUser | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<AutoCreateUser | null> | null, spec?: UpsertSpec | null): ObjList<AutoCreateUser | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<AutoCreateUser | null> | null): ObjList<AutoCreateUser | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<AutoCreateUser | null> | null): ObjList<AutoCreateUser | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<AutoCreateUser | null> | null): ObjList<AutoCreateUser | null>;
   ...
   */
  static afterCreate(objs: C3.Array<AutoCreateUser | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<AutoCreateUser | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<AutoCreateUser | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<AutoCreateUser | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<AutoCreateUser | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): AutoCreateUser | null;
   ...
   */
  withoutIdentity(): AutoCreateUser | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<AutoCreateUser | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: AutoCreateUser | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<AutoCreateUser | null> | null, callback?: λFunction<AutoCreateUser | null, AutoCreateUser | null> | null): ObjList<AutoCreateUser | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<AutoCreateUser | null> | null, callback?: λFunction<AutoCreateUser | null, AutoCreateUser | null> | null): C3.Array<ObjError | null>;
