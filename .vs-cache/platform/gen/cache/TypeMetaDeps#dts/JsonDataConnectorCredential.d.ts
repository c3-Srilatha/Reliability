// TypeScript definitions for the C3 type JsonDataConnectorCredential

/**
 * Config type for storing random credentials that cannot be stored as {@link JdbcCredentials} or {@link CloudCredentials}..
 *
 * @remarks this represents a value passed to a method that expects an instance of JsonDataConnectorCredential
 */
declare interface IJsonDataConnectorCredential {
 ...
 * Config type for storing random credentials that cannot be stored as {@link JdbcCredentials} or {@link CloudCredentials}..
 *
 * @remarks this represents a made instance of JsonDataConnectorCredential
 */
declare class JsonDataConnectorCredential extends Obj {
  ...
  withId(id: string | null): JsonDataConnectorCredential;
  ...
  withServerEndpoint(serverEndpoint: string | null): JsonDataConnectorCredential;
  ...
  withDisplayName(displayName: string | null): JsonDataConnectorCredential;
  ...
  withSecretKey(secretKey: string | null): JsonDataConnectorCredential;

  /**
   * The data store type, including both JdbcStore types and FileSystem types.
   */
  readonly datastore?: string | null;
  withDatastore(datastore: string | null): JsonDataConnectorCredential;

  /**
   * Custom description of the credential.
   */
  readonly description?: string | null;
  withDescription(description: string | null): JsonDataConnectorCredential;

  readonly filePathPrefix?: string | null;
  withFilePathPrefix(filePathPrefix: string | null): JsonDataConnectorCredential;

  /**
   * Cloud service native Access Key.
   */
  readonly accessKey?: string | null;
  withAccessKey(accessKey: string | null): JsonDataConnectorCredential;

  /**
   * Cloud account / subscription id.
   */
  readonly accountId?: string | null;
  withAccountId(accountId: string | null): JsonDataConnectorCredential;
  ...
  withCloudIdentity(cloudIdentity: string | null): JsonDataConnectorCredential;

  /**
   * Cloud region for the credentials.
   */
  readonly region?: string | null;
  withRegion(region: string | null): JsonDataConnectorCredential;
  ...
  withUsername(username: string | null): JsonDataConnectorCredential;

  /**
   * A hashed password of credential. This field is only set for {@link JdbcCredentials} type.
   */
  readonly password?: string | null;
  withPassword(password: string | null): JsonDataConnectorCredential;

  readonly content?: any | null;
  withContent(content: any | null): JsonDataConnectorCredential;

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): JsonDataConnectorCredential;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): JsonDataConnectorCredential;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): JsonDataConnectorCredential;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): JsonDataConnectorCredential | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): JsonDataConnectorCredential | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): JsonDataConnectorCredential | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): JsonDataConnectorCredential | null;
   ...
   */
  replaceType(old: Type, new_: Type): JsonDataConnectorCredential;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JsonDataConnectorCredential;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JsonDataConnectorCredential;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JsonDataConnectorCredential | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JsonDataConnectorCredential | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): JsonDataConnectorCredential;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JsonDataConnectorCredential;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JsonDataConnectorCredential;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): JsonDataConnectorCredential;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): JsonDataConnectorCredential;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): JsonDataConnectorCredential;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): JsonDataConnectorCredential;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): JsonDataConnectorCredential;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): JsonDataConnectorCredential;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): JsonDataConnectorCredential;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): JsonDataConnectorCredential;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): JsonDataConnectorCredential;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): JsonDataConnectorCredential;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): JsonDataConnectorCredential;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): JsonDataConnectorCredential;
   ...
   * @see #unsetField
   */
  defaultField(field: string): JsonDataConnectorCredential;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): JsonDataConnectorCredential;
   ...
   * @see #removeField
   */
  unsetField(field: string): JsonDataConnectorCredential;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): JsonDataConnectorCredential;
   ...
   * @see #unsetField
   */
  removeField(field: string): JsonDataConnectorCredential;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): JsonDataConnectorCredential;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): JsonDataConnectorCredential;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): JsonDataConnectorCredential;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): JsonDataConnectorCredential;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): JsonDataConnectorCredential;

  mergeJson(json: any | null): JsonDataConnectorCredential;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): JsonDataConnectorCredential;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): JsonDataConnectorCredential;
   ...
   */
  singletonArray(): C3.Array<JsonDataConnectorCredential | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<JsonDataConnectorCredential | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<JsonDataConnectorCredential | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<JsonDataConnectorCredential | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<JsonDataConnectorCredential | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, JsonDataConnectorCredential | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, JsonDataConnectorCredential | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<JsonDataConnectorCredential | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<JsonDataConnectorCredential | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): JsonDataConnectorCredential;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): JsonDataConnectorCredential;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): JsonDataConnectorCredential;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): JsonDataConnectorCredential;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): JsonDataConnectorCredential;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): JsonDataConnectorCredential;
   ...
   * @see #fromString
   */
  static make(s: string | null): JsonDataConnectorCredential | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): JsonDataConnectorCredential;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): JsonDataConnectorCredential;
   ...
   */
  static cachedEmptyInst(): JsonDataConnectorCredential;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<JsonDataConnectorCredential>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): JsonDataConnectorCredential;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<JsonDataConnectorCredential | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<JsonDataConnectorCredential | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<JsonDataConnectorCredential | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): JsonDataConnectorCredential | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): JsonDataConnectorCredential | null;
   ...
   * @see findByCacheKey
   */
  getCached(): JsonDataConnectorCredential | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): JsonDataConnectorCredential | null;
   ...
   */
  static produce(key: string): JsonDataConnectorCredential | null;
   ...
   */
  static produceAll(): C3.Map<string | null, JsonDataConnectorCredential | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, JsonDataConnectorCredential | null>;
   ...
   */
  getConfig(): JsonDataConnectorCredential;
   ...
   */
  getSecret(): JsonDataConnectorCredential;
   ...
   */
  static forConfigKey(configKey: string | null): JsonDataConnectorCredential | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<JsonDataConnectorCredential | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: JsonDataConnectorCredential, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: JsonDataConnectorCredential, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): JsonDataConnectorCredential | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): JsonDataConnectorCredential | null;

  /**
   * Retrieve all credentials for given datastore
   */
  static retrieveAll(datastore: string): C3.Array<JsonDataConnectorCredential | null>;

  /**
   * Save a new credential.
   */
  static upsert(credentialKey?: string | null, credential?: JsonDataConnectorCredential | null): boolean;

  /**
   * Remove an existent credential.
   */
  static remove(credential?: JsonDataConnectorCredential | null): boolean;

  /**
   * Retrieve an existent credential.
   */
  static get(credentialKey?: string | null, datastore: string): JsonDataConnectorCredential | null;
}
