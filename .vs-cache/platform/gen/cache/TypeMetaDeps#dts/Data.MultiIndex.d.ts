// TypeScript definitions for the C3 type Data.MultiIndex

/**
 * Abstract interface representing the pandas MultiIndex class.
 *
 * @remarks this represents a value passed to a method that expects an instance of Data.MultiIndex
 */
 ...
 */
declare namespace Data {
  export class MultiIndex extends Obj {
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.MultiIndex | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.MultiIndex | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.MultiIndex | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.MultiIndex | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.MultiIndex;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.MultiIndex;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.MultiIndex;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.MultiIndex | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.MultiIndex | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.MultiIndex;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.MultiIndex;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.MultiIndex;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.MultiIndex;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.MultiIndex;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.MultiIndex;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.MultiIndex;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.MultiIndex;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.MultiIndex;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.MultiIndex;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.MultiIndex;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.MultiIndex;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.MultiIndex;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.MultiIndex;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.MultiIndex;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.MultiIndex;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.MultiIndex;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.MultiIndex;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.MultiIndex;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.MultiIndex;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.MultiIndex;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.MultiIndex;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.MultiIndex;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.MultiIndex;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.MultiIndex;

    mergeJson(json: any | null): Data.MultiIndex;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.MultiIndex;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.MultiIndex;
     ...
     */
    singletonArray(): C3.Array<Data.MultiIndex | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.MultiIndex | null>;
     ...
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.MultiIndex | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.MultiIndex | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.MultiIndex | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.MultiIndex | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.MultiIndex | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.MultiIndex | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.MultiIndex | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.MultiIndex;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.MultiIndex;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.MultiIndex;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.MultiIndex;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.MultiIndex;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.MultiIndex;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.MultiIndex;
     ...
     */
    static cachedEmptyInst(): Data.MultiIndex;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.MultiIndex>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.MultiIndex;
     ...
     */
    static fromPySrc(pySrc: string, dfs?: C3.Set<DataImpl | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): Data.MultiIndex | null;
     ...
     */
    static _jsDataProxy(inst: any): Data.MultiIndex;
