// TypeScript definitions for the C3 type Jvm

/**
 * Interface to Java Virtual Machine
 *
 * @remarks this represents a value passed to a method that expects an instance of Jvm
 */
declare interface IJvm {
}
...
declare class Jvm extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Jvm | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Jvm | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Jvm | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Jvm | null;
   ...
   */
  replaceType(old: Type, new_: Type): Jvm;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): Jvm;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Jvm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Jvm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Jvm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Jvm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Jvm | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Jvm | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Jvm | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Jvm | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Jvm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Jvm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Jvm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Jvm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Jvm;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Jvm;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Jvm;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): Jvm;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Jvm;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): Jvm;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Jvm;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Jvm;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Jvm;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Jvm;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Jvm;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): Jvm;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Jvm;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): Jvm;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Jvm;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): Jvm;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Jvm;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): Jvm;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Jvm;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Jvm;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Jvm;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): Jvm;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Jvm;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Jvm;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): Jvm;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Jvm;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): Jvm;
   ...
   * @see #removeField
   */
  static unsetField(field: string): Jvm;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Jvm;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): Jvm;
   ...
   * @see #unsetField
   */
  static removeField(field: string): Jvm;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Jvm;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): Jvm;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Jvm;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Jvm;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Jvm;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): Jvm;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Jvm;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Jvm;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Jvm;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Jvm;

  mergeJson(json: any | null): Jvm;

  static mergeJson(json: any | null): Jvm;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Jvm;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Jvm;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Jvm;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): Jvm;
   ...
   */
  singletonArray(): C3.Array<Jvm | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<Jvm | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Jvm | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Jvm | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<Jvm | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Jvm | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Jvm | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Jvm | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Jvm | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<Jvm | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Jvm | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Jvm;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Jvm;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Jvm;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Jvm;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Jvm;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Jvm;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Jvm;
   ...
   */
  static cachedEmptyInst(): Jvm;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Jvm>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Jvm;
