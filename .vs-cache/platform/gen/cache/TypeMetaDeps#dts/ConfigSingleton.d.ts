// TypeScript definitions for the C3 type ConfigSingleton

/**
 * @remarks this represents a value passed to a method that expects an instance of ConfigSingleton
 */
declare interface IConfigSingleton {
...
/**
 * @remarks this represents a made instance of ConfigSingleton
 */
declare class ConfigSingleton extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): ConfigSingleton;

  static readonly configOverride?: string | null;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): ConfigSingleton;
  ...
  withIssues(issues: C3.Array<string | null> | Array<string | null>): ConfigSingleton;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ConfigSingleton | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ConfigSingleton | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ConfigSingleton | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ConfigSingleton | null;
   ...
   */
  replaceType(old: Type, new_: Type): ConfigSingleton;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): ConfigSingleton;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ConfigSingleton;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ConfigSingleton;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ConfigSingleton;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ConfigSingleton;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ConfigSingleton | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ConfigSingleton | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ConfigSingleton | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ConfigSingleton | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ConfigSingleton;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ConfigSingleton;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ConfigSingleton;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ConfigSingleton;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ConfigSingleton;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ConfigSingleton;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ConfigSingleton;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): ConfigSingleton;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ConfigSingleton;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): ConfigSingleton;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ConfigSingleton;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): ConfigSingleton;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ConfigSingleton;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ConfigSingleton;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ConfigSingleton;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ConfigSingleton;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ConfigSingleton;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): ConfigSingleton;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ConfigSingleton;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): ConfigSingleton;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ConfigSingleton;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): ConfigSingleton;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ConfigSingleton;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): ConfigSingleton;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ConfigSingleton;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ConfigSingleton;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ConfigSingleton;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): ConfigSingleton;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ConfigSingleton;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ConfigSingleton;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ConfigSingleton;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): ConfigSingleton;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ConfigSingleton;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): ConfigSingleton;
   ...
   * @see #removeField
   */
  unsetField(field: string): ConfigSingleton;
   ...
   * @see #removeField
   */
  static unsetField(field: string): ConfigSingleton;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ConfigSingleton;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): ConfigSingleton;
   ...
   * @see #unsetField
   */
  removeField(field: string): ConfigSingleton;
   ...
   * @see #unsetField
   */
  static removeField(field: string): ConfigSingleton;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ConfigSingleton;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): ConfigSingleton;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ConfigSingleton;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ConfigSingleton;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ConfigSingleton;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): ConfigSingleton;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ConfigSingleton;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ConfigSingleton;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ConfigSingleton;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ConfigSingleton;

  mergeJson(json: any | null): ConfigSingleton;

  static mergeJson(json: any | null): ConfigSingleton;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ConfigSingleton;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ConfigSingleton;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ConfigSingleton;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): ConfigSingleton;
   ...
   */
  singletonArray(): C3.Array<ConfigSingleton | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<ConfigSingleton | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ConfigSingleton | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ConfigSingleton | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ConfigSingleton | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<ConfigSingleton | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ConfigSingleton | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ConfigSingleton | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ConfigSingleton | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ConfigSingleton | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<ConfigSingleton | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ConfigSingleton | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ConfigSingleton;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ConfigSingleton;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ConfigSingleton;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ConfigSingleton;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ConfigSingleton;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ConfigSingleton;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ConfigSingleton;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): ConfigSingleton;
   ...
   */
  static cachedEmptyInst(): ConfigSingleton;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ConfigSingleton>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ConfigSingleton;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<ConfigSingleton | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<ConfigSingleton | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ConfigSingleton | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): ConfigSingleton | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): ConfigSingleton | null;
   ...
   * @see findByCacheKey
   */
  getCached(): ConfigSingleton | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): ConfigSingleton | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): ConfigSingleton | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): ConfigSingleton | null;
   ...
   */
  static produce(key: string): ConfigSingleton | null;
   ...
   */
  static produceAll(): C3.Map<string | null, ConfigSingleton | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, ConfigSingleton | null>;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): ConfigSingleton;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): ConfigSingleton;
   ...
   */
  static forConfigKey(configKey: string | null): ConfigSingleton | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<ConfigSingleton | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: ConfigSingleton, override?: string | null): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: ConfigSingleton, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: ConfigSingleton, override?: string | null): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: ConfigSingleton, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): ConfigSingleton | null;
   ...
   */
  removeSecrets(): ConfigSingleton | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): ConfigSingleton | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): ConfigSingleton | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): ConfigSingleton | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): ConfigSingleton;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): ConfigSingleton;
