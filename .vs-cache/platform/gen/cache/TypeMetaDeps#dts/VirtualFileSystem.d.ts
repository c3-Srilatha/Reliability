// TypeScript definitions for the C3 type VirtualFileSystem

/**
 * Represents a virtual file system implemented using Apache Commons VFS.
 *
 * @remarks this represents a value passed to a method that expects an instance of VirtualFileSystem
 */
declare interface IVirtualFileSystem {
 ...
 * Represents a virtual file system implemented using Apache Commons VFS.
 *
 * @remarks this represents a made instance of VirtualFileSystem
 */
declare class VirtualFileSystem extends Obj {

  /**
   * Optional root OS folder to limit access to files.
   */
  readonly root?: string | null;
  withRoot(root: string | null): VirtualFileSystem;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): VirtualFileSystem | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): VirtualFileSystem | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): VirtualFileSystem | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): VirtualFileSystem | null;
   ...
   */
  replaceType(old: Type, new_: Type): VirtualFileSystem;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): VirtualFileSystem;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VirtualFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VirtualFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VirtualFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VirtualFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VirtualFileSystem | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VirtualFileSystem | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VirtualFileSystem | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VirtualFileSystem | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): VirtualFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): VirtualFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VirtualFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VirtualFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VirtualFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VirtualFileSystem;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): VirtualFileSystem;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): VirtualFileSystem;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): VirtualFileSystem;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): VirtualFileSystem;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): VirtualFileSystem;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): VirtualFileSystem;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): VirtualFileSystem;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): VirtualFileSystem;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): VirtualFileSystem;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): VirtualFileSystem;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): VirtualFileSystem;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): VirtualFileSystem;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): VirtualFileSystem;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): VirtualFileSystem;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): VirtualFileSystem;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): VirtualFileSystem;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): VirtualFileSystem;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): VirtualFileSystem;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): VirtualFileSystem;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): VirtualFileSystem;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): VirtualFileSystem;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): VirtualFileSystem;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): VirtualFileSystem;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): VirtualFileSystem;
   ...
   * @see #unsetField
   */
  defaultField(field: string): VirtualFileSystem;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): VirtualFileSystem;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): VirtualFileSystem;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): VirtualFileSystem;
   ...
   * @see #removeField
   */
  unsetField(field: string): VirtualFileSystem;
   ...
   * @see #removeField
   */
  static unsetField(field: string): VirtualFileSystem;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): VirtualFileSystem;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): VirtualFileSystem;
   ...
   * @see #unsetField
   */
  removeField(field: string): VirtualFileSystem;
   ...
   * @see #unsetField
   */
  static removeField(field: string): VirtualFileSystem;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): VirtualFileSystem;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): VirtualFileSystem;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): VirtualFileSystem;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): VirtualFileSystem;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): VirtualFileSystem;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): VirtualFileSystem;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): VirtualFileSystem;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): VirtualFileSystem;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): VirtualFileSystem;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): VirtualFileSystem;

  mergeJson(json: any | null): VirtualFileSystem;

  static mergeJson(json: any | null): VirtualFileSystem;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): VirtualFileSystem;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): VirtualFileSystem;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): VirtualFileSystem;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): VirtualFileSystem;
   ...
   */
  singletonArray(): C3.Array<VirtualFileSystem | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<VirtualFileSystem | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<VirtualFileSystem | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<VirtualFileSystem | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<VirtualFileSystem | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<VirtualFileSystem | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<VirtualFileSystem | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, VirtualFileSystem | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, VirtualFileSystem | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<VirtualFileSystem | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<VirtualFileSystem | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<VirtualFileSystem | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): VirtualFileSystem;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): VirtualFileSystem;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): VirtualFileSystem;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): VirtualFileSystem;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): VirtualFileSystem;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): VirtualFileSystem;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): VirtualFileSystem;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): VirtualFileSystem;
   ...
   */
  static cachedEmptyInst(): VirtualFileSystem;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<VirtualFileSystem>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): VirtualFileSystem;
