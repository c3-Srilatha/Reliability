// TypeScript definitions for the C3 type SecondaryDsUpsert

/**
 * Contains functions for managing a secondary datastore.
 *
 * @remarks this represents a value passed to a method that expects an instance of SecondaryDsUpsert
 */
declare interface ISecondaryDsUpsert {
   ...
   */
  stageTables?: C3.Map<string | null, SecondaryDsStageTable | null> | {[key: string | null]: ISecondaryDsStageTable | null};
}

/**
 * Contains functions for managing a secondary datastore.
 *
 * @remarks this represents a made instance of SecondaryDsUpsert
 */
declare class SecondaryDsUpsert extends Obj {
   ...
   */
  readonly id: string;
  withId(id: string): SecondaryDsUpsert;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): SecondaryDsUpsert;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): SecondaryDsUpsert;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): SecondaryDsUpsert;
  ...
  withVersion(version: number | null): SecondaryDsUpsert;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): SecondaryDsUpsert;

  /**
   * Unique key assigned to the upsert operation in {@link beginUpsert).
   */
  readonly upsertKey: string;
  withUpsertKey(upsertKey: string): SecondaryDsUpsert;

  /**
   * A map of stage tables for each physical table involved in the upsert operation.
   */
  readonly stageTables?: C3.Map<string | null, SecondaryDsStageTable | null>;
  withStageTables(stageTables: C3.Map<string | null, SecondaryDsStageTable | null> | {[key: string | null]: ISecondaryDsStageTable | null}): SecondaryDsUpsert;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SecondaryDsUpsert | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SecondaryDsUpsert | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SecondaryDsUpsert | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SecondaryDsUpsert | null;
   ...
   */
  replaceType(old: Type, new_: Type): SecondaryDsUpsert;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SecondaryDsUpsert;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SecondaryDsUpsert;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SecondaryDsUpsert | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SecondaryDsUpsert | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SecondaryDsUpsert;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SecondaryDsUpsert;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SecondaryDsUpsert;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SecondaryDsUpsert;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SecondaryDsUpsert;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SecondaryDsUpsert;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SecondaryDsUpsert;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SecondaryDsUpsert;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SecondaryDsUpsert;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SecondaryDsUpsert;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SecondaryDsUpsert;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SecondaryDsUpsert;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SecondaryDsUpsert;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SecondaryDsUpsert;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SecondaryDsUpsert;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SecondaryDsUpsert;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SecondaryDsUpsert;
   ...
   * @see #removeField
   */
  unsetField(field: string): SecondaryDsUpsert;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SecondaryDsUpsert;
   ...
   * @see #unsetField
   */
  removeField(field: string): SecondaryDsUpsert;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SecondaryDsUpsert;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SecondaryDsUpsert;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SecondaryDsUpsert;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SecondaryDsUpsert;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SecondaryDsUpsert;

  mergeJson(json: any | null): SecondaryDsUpsert;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SecondaryDsUpsert;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SecondaryDsUpsert;
   ...
   */
  singletonArray(): C3.Array<SecondaryDsUpsert | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SecondaryDsUpsert | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SecondaryDsUpsert | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SecondaryDsUpsert | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SecondaryDsUpsert | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SecondaryDsUpsert | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SecondaryDsUpsert | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SecondaryDsUpsert | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SecondaryDsUpsert | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SecondaryDsUpsert;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SecondaryDsUpsert;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SecondaryDsUpsert;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SecondaryDsUpsert;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SecondaryDsUpsert;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SecondaryDsUpsert;
   ...
   * @see #fromString
   */
  static make(s: string | null): SecondaryDsUpsert | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SecondaryDsUpsert;
   ...
   */
  static cachedEmptyInst(): SecondaryDsUpsert;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SecondaryDsUpsert>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SecondaryDsUpsert;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<SecondaryDsUpsert | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SecondaryDsUpsert | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<SecondaryDsUpsert | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<SecondaryDsUpsert | null> | null>;
   ...
   */
  get(include?: string | null): SecondaryDsUpsert | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): SecondaryDsUpsert | null;
   ...
   */
  getMissing(spec: GetMissingSpec): SecondaryDsUpsert;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): SecondaryDsUpsert | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): SecondaryDsUpsert;
   ...
   * @see #toString
   */
  static fromString(s: string | null): SecondaryDsUpsert | null;
   ...
   */
  create(spec?: UpsertSpec | null): SecondaryDsUpsert | null;
   ...
   */
  static createBatch(objs: C3.Array<SecondaryDsUpsert | null> | null, spec?: UpsertSpec | null): ObjList<SecondaryDsUpsert | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<SecondaryDsUpsert | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<SecondaryDsUpsert | null> | null;
   ...
   */
  update(srcObj?: SecondaryDsUpsert | null, spec?: UpsertSpec | null): SecondaryDsUpsert | null;
   ...
   */
  upsert(srcObj?: SecondaryDsUpsert | null, spec?: UpsertSpec | null): SecondaryDsUpsert | null;
   ...
   */
  merge(spec?: MergeSpec | null): SecondaryDsUpsert | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): SecondaryDsUpsert | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): SecondaryDsUpsert | null;
   ...
   */
  static updateBatch(objs: C3.Array<SecondaryDsUpsert | null> | null, srcObjs?: C3.Array<SecondaryDsUpsert | null>, spec?: UpsertSpec | null): ObjList<SecondaryDsUpsert | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<SecondaryDsUpsert | null>>, spec?: UpsertSpec | null): ObjList<SecondaryDsUpsert | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<SecondaryDsUpsert | null> | null, srcObjs?: C3.Array<SecondaryDsUpsert | null>, spec?: UpsertSpec | null): ObjList<SecondaryDsUpsert | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<SecondaryDsUpsert | null>>, spec?: UpsertSpec | null): ObjList<SecondaryDsUpsert | null> | null;
   ...
   */
  upsertObjs(objs: Stream<Obj | null>, batchNum: number): void;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<SecondaryDsUpsert | null> | null, spec?: TouchSpec | null): ObjList<SecondaryDsUpsert | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SecondaryDsUpsert | null> | null, spec?: MergeSpec | null): ObjList<SecondaryDsUpsert | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SecondaryDsUpsert | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<SecondaryDsUpsert | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<SecondaryDsUpsert | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<SecondaryDsUpsert | null> | null;
   ...
   */
  static mergeAll(mergeObj: SecondaryDsUpsert | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: SecondaryDsUpsert | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<SecondaryDsUpsert | null> | null, spec?: UpsertSpec | null): ObjList<SecondaryDsUpsert | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<SecondaryDsUpsert | null> | null, spec?: UpsertSpec | null): ObjList<SecondaryDsUpsert | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): SecondaryDsUpsert | null;
   ...
   */
  static beforeCreate(objs: C3.Array<SecondaryDsUpsert | null> | null): ObjList<SecondaryDsUpsert | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<SecondaryDsUpsert | null> | null): ObjList<SecondaryDsUpsert | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<SecondaryDsUpsert | null> | null): ObjList<SecondaryDsUpsert | null>;
   ...
   */
  static afterCreate(objs: C3.Array<SecondaryDsUpsert | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<SecondaryDsUpsert | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<SecondaryDsUpsert | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<SecondaryDsUpsert | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<SecondaryDsUpsert | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): SecondaryDsUpsert | null;
   ...
   */
  withoutIdentity(): SecondaryDsUpsert | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<SecondaryDsUpsert | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: SecondaryDsUpsert | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<SecondaryDsUpsert | null> | null, callback?: λFunction<SecondaryDsUpsert | null, SecondaryDsUpsert | null> | null): ObjList<SecondaryDsUpsert | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<SecondaryDsUpsert | null> | null, callback?: λFunction<SecondaryDsUpsert | null, SecondaryDsUpsert | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static beginUpsert(type: Type): SecondaryDsUpsert;
   ...
   */
  static upsertType(upsertKey: string): Type;
   ...
   *          File to remove.
   */
  removeFile(stageTableName: string, fileUrl: string): void;
   ...
   */
  addFile(stageTableName: string, fileUrl: string): File;
}
