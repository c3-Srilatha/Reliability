// TypeScript definitions for the C3 type SimpleMetricCache

/**
 * Cache for simple metrics.
 *
 * @remarks this represents a value passed to a method that expects an instance of SimpleMetricCache
 */
declare interface ISimpleMetricCache {
}

/**
 * Cache for simple metrics.
 *
 * @remarks this represents a made instance of SimpleMetricCache
 */
declare class SimpleMetricCache {
   ...
   */
  static get(key: string | null): C3.Map<string | null, SimpleMetric | null>;
   ...
   */
  static require(key: string | null): C3.Map<string | null, SimpleMetric | null>;
   ...
   */
  static put(key: string | null, value: C3.Map<string | null, SimpleMetric | null> | null): void;
  ...
  /**
   * Reclaimed to clear all SimpleMetric related caches.
   *
   * @inheritdoc
   */
  static clear(): void;
   ...
   */
  static produce(key: string | null): C3.Map<string | null, SimpleMetric | null>;
   ...
   * should be cleared.
   */
  static produceAll(): C3.Map<string | null, C3.Map<string | null, SimpleMetric | null>>;

  /**
   * Optional override called when element is released from the cache. Should perform any external resources cleanup if
   * needed.
   */
  static release(key: string | null, value: C3.Map<string | null, SimpleMetric | null> | null): void;
   ...
   */
  static validate(value: C3.Map<string | null, SimpleMetric | null> | null): boolean;

  /**
   * @return A map of metrics keyed by their id.
   */
  static metrics(): C3.Map<string | null, SimpleMetric | null>;
}
