// TypeScript definitions for the C3 type VaultEncrypterConfig

/**
 * Configuration for {@VaultEncrypter}.
 *
 * @remarks this represents a value passed to a method that expects an instance of VaultEncrypterConfig
 */
declare interface IVaultEncrypterConfig {
  ...
  /**
   * Type of cipher transformation used
   */
  CIPHER_TRANSFORMATION?: string | null;

  /**
   * The json key path at which to store the MEK
   */
  MEK_JSON_KEY?: string | null;

  /**
   * Denotes C3 Vault is un-encrypted (no key)
   */
  KEY_NOT_SET?: string | null;

  /**
   * Temporary directory to store files during migration
   */
  MIGRATION_DIR?: string | null;

  /**
   * Whether C3Vault is enabled and encrypted.
   * Please do NOT set manually. Used internally by {@VaultEncrypter}.
   */
  enabled: boolean;
}
 ...
 * Configuration for {@VaultEncrypter}.
 *
 * @remarks this represents a made instance of VaultEncrypterConfig
 */
declare class VaultEncrypterConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): VaultEncrypterConfig;

  static readonly configOverride?: string | null;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): VaultEncrypterConfig;
  ...
  withIssues(issues: C3.Array<string | null> | Array<string | null>): VaultEncrypterConfig;
  ...
  withCIPHER_ALGORITHM(CIPHER_ALGORITHM: string | null): VaultEncrypterConfig;

  /**
   * Type of encryption algorithm used
   */
  static readonly CIPHER_ALGORITHM?: string | null;

  /**
   * Type of cipher transformation used
   */
  readonly CIPHER_TRANSFORMATION?: string | null;
  withCIPHER_TRANSFORMATION(CIPHER_TRANSFORMATION: string | null): VaultEncrypterConfig;

  /**
   * Type of cipher transformation used
   */
  static readonly CIPHER_TRANSFORMATION?: string | null;

  /**
   * The json key path at which to store the MEK
   */
  readonly MEK_JSON_KEY?: string | null;
  withMEK_JSON_KEY(MEK_JSON_KEY: string | null): VaultEncrypterConfig;

  /**
   * The json key path at which to store the MEK
   */
  static readonly MEK_JSON_KEY?: string | null;

  /**
   * Denotes C3 Vault is un-encrypted (no key)
   */
  readonly KEY_NOT_SET?: string | null;
  withKEY_NOT_SET(KEY_NOT_SET: string | null): VaultEncrypterConfig;

  /**
   * Denotes C3 Vault is un-encrypted (no key)
   */
  static readonly KEY_NOT_SET?: string | null;

  /**
   * Temporary directory to store files during migration
   */
  readonly MIGRATION_DIR?: string | null;
  withMIGRATION_DIR(MIGRATION_DIR: string | null): VaultEncrypterConfig;

  /**
   * Temporary directory to store files during migration
   */
  static readonly MIGRATION_DIR?: string | null;
  ...
  withEnabled(enabled: boolean): VaultEncrypterConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): VaultEncrypterConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): VaultEncrypterConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): VaultEncrypterConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): VaultEncrypterConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): VaultEncrypterConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): VaultEncrypterConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VaultEncrypterConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VaultEncrypterConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VaultEncrypterConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VaultEncrypterConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VaultEncrypterConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VaultEncrypterConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VaultEncrypterConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VaultEncrypterConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): VaultEncrypterConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): VaultEncrypterConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VaultEncrypterConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VaultEncrypterConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VaultEncrypterConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VaultEncrypterConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): VaultEncrypterConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): VaultEncrypterConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): VaultEncrypterConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): VaultEncrypterConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): VaultEncrypterConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): VaultEncrypterConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): VaultEncrypterConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): VaultEncrypterConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): VaultEncrypterConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): VaultEncrypterConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): VaultEncrypterConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): VaultEncrypterConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): VaultEncrypterConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): VaultEncrypterConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): VaultEncrypterConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): VaultEncrypterConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): VaultEncrypterConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): VaultEncrypterConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): VaultEncrypterConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): VaultEncrypterConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): VaultEncrypterConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): VaultEncrypterConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): VaultEncrypterConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): VaultEncrypterConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): VaultEncrypterConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): VaultEncrypterConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): VaultEncrypterConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): VaultEncrypterConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): VaultEncrypterConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): VaultEncrypterConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): VaultEncrypterConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): VaultEncrypterConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): VaultEncrypterConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): VaultEncrypterConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): VaultEncrypterConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): VaultEncrypterConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): VaultEncrypterConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): VaultEncrypterConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): VaultEncrypterConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): VaultEncrypterConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): VaultEncrypterConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): VaultEncrypterConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): VaultEncrypterConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): VaultEncrypterConfig;

  mergeJson(json: any | null): VaultEncrypterConfig;

  static mergeJson(json: any | null): VaultEncrypterConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): VaultEncrypterConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): VaultEncrypterConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): VaultEncrypterConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): VaultEncrypterConfig;
   ...
   */
  singletonArray(): C3.Array<VaultEncrypterConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<VaultEncrypterConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<VaultEncrypterConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<VaultEncrypterConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<VaultEncrypterConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<VaultEncrypterConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<VaultEncrypterConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, VaultEncrypterConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, VaultEncrypterConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<VaultEncrypterConfig | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<VaultEncrypterConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<VaultEncrypterConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): VaultEncrypterConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): VaultEncrypterConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): VaultEncrypterConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): VaultEncrypterConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): VaultEncrypterConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): VaultEncrypterConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): VaultEncrypterConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): VaultEncrypterConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): VaultEncrypterConfig;
   ...
   */
  static cachedEmptyInst(): VaultEncrypterConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<VaultEncrypterConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): VaultEncrypterConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<VaultEncrypterConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<VaultEncrypterConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<VaultEncrypterConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): VaultEncrypterConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): VaultEncrypterConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): VaultEncrypterConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): VaultEncrypterConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): VaultEncrypterConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): VaultEncrypterConfig | null;
   ...
   */
  static produce(key: string): VaultEncrypterConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, VaultEncrypterConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, VaultEncrypterConfig | null>;
   ...
   */
  getConfig(): VaultEncrypterConfig;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): VaultEncrypterConfig;
   ...
   */
  getSecret(): VaultEncrypterConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): VaultEncrypterConfig;
   ...
   */
  static forConfigKey(configKey: string | null): VaultEncrypterConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<VaultEncrypterConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: VaultEncrypterConfig, override?: string | null): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: VaultEncrypterConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: VaultEncrypterConfig, override?: string | null): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: VaultEncrypterConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): VaultEncrypterConfig | null;
   ...
   */
  removeSecrets(): VaultEncrypterConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): VaultEncrypterConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): VaultEncrypterConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): VaultEncrypterConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): VaultEncrypterConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): VaultEncrypterConfig;
