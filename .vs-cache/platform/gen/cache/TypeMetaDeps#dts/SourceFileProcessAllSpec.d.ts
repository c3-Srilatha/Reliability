// TypeScript definitions for the C3 type SourceFileProcessAllSpec

/**
 * @remarks this represents a value passed to a method that expects an instance of SourceFileProcessAllSpec
 */
declare interface ISourceFileProcessAllSpec {
  ...
  /**
   * if true then process the files once they are synced.
   */
  process?: boolean;

  /**
   * if true then #process is done asynchronously.
   */
  async?: boolean;

  /**
   * The specification of fields to get after SourceFile operation
   */
  include?: string | null;
  ...
  /**
   * Batch size determines number of source files that will be processed together.
   */
  sourceFilesBatchSize?: number | null;
}

/**
 * @remarks this represents a made instance of SourceFileProcessAllSpec
 */
declare class SourceFileProcessAllSpec extends Obj {

  /**
   * Specifies various parameters for automatic retry that occurs in upsert due to retryable errors.
   */
  readonly retrySpec?: RetrySpec | null;
  withRetrySpec(retrySpec: IRetrySpec | null): SourceFileProcessAllSpec;
  ...
  withValidateContentType(validateContentType: boolean): SourceFileProcessAllSpec;
  ...
  withPeekForMetadata(peekForMetadata: boolean): SourceFileProcessAllSpec;
  ...
  withFailIfMissing(failIfMissing: boolean): SourceFileProcessAllSpec;
  ...
  withSkipIfUnauthorized(skipIfUnauthorized: boolean): SourceFileProcessAllSpec;

  /**
   * If set and if requested file or directory url is under this path then will retrieve content from cache.
   */
  readonly cacheUrlOrEncodedPath?: string | null;
  withCacheUrlOrEncodedPath(cacheUrlOrEncodedPath: string | null): SourceFileProcessAllSpec;

  /**
   * Time in seconds that the cached file should live (default 24 hours).
   */
  readonly cacheTtlSec?: number | null;
  withCacheTtlSec(cacheTtlSec: number | null): SourceFileProcessAllSpec;
  ...
  withForceMultiPart(forceMultiPart: boolean): SourceFileProcessAllSpec;
  ...
  withDisableMultiPart(disableMultiPart: boolean): SourceFileProcessAllSpec;

  /**
   * Overrides default maximum file size before MultipartUpload kicks in. Default is 1GB
   */
  readonly maximumSingleUploadsize?: number | null;
  withMaximumSingleUploadsize(maximumSingleUploadsize: number | null): SourceFileProcessAllSpec;
  ...
  withMaxThreads(maxThreads: number | null): SourceFileProcessAllSpec;
  ...
  withMinThreads(minThreads: number | null): SourceFileProcessAllSpec;

  /**
   * If set to true, it will retry reading file when the file is not found.
   */
  readonly retryOnNotFound?: boolean;
  withRetryOnNotFound(retryOnNotFound: boolean): SourceFileProcessAllSpec;
  ...
  withLockOnWrite(lockOnWrite: boolean): SourceFileProcessAllSpec;

  /**
   * If set will use IoExecutor service.
   */
  readonly useIoExecutor?: boolean;
  withUseIoExecutor(useIoExecutor: boolean): SourceFileProcessAllSpec;

  /**
   * If not null, retry logic will be used from CloudClient rather than File
   */
  readonly cloudClient?: any;
  withCloudClient(cloudClient: any): SourceFileProcessAllSpec;

  /**
   * if true then process the files once they are synced.
   */
  readonly process?: boolean;
  withProcess(process: boolean): SourceFileProcessAllSpec;

  /**
   * if true then #process is done asynchronously.
   */
  readonly async?: boolean;
  withAsync(async: boolean): SourceFileProcessAllSpec;

  /**
   * The specification of fields to get after SourceFile operation
   */
  readonly include?: string | null;
  withInclude(include: string | null): SourceFileProcessAllSpec;
  ...
  withFilter(filter: string | null): SourceFileProcessAllSpec;

  /**
   * Variables values to substitute in filter expression. CURRENTLY UNDER CONSTRUCTION!
   */
  readonly vars?: C3.Map<string | null, Obj | null>;
  withVars(vars: C3.Map<string | null, Obj | null> | {[key: string | null]: IObj | null}): SourceFileProcessAllSpec;
  ...
  withFetchHiddenSeedData(fetchHiddenSeedData: boolean): SourceFileProcessAllSpec;
  ...
  withExcludeExtensions(excludeExtensions: boolean): SourceFileProcessAllSpec;
  ...
  withAsOf(asOf: DateTime | Date | string | null): SourceFileProcessAllSpec;
  ...
  withAllowLiteralOnBindVariableOverflow(allowLiteralOnBindVariableOverflow: boolean): SourceFileProcessAllSpec;
  ...
  withUseDedicatedConnection(useDedicatedConnection: boolean): SourceFileProcessAllSpec;
  ...
  withStmtTimeoutMs(stmtTimeoutMs: number | null): SourceFileProcessAllSpec;
  ...
  withDontThrowJsonDeserErrors(dontThrowJsonDeserErrors: boolean): SourceFileProcessAllSpec;
  ...
  withTimeRange(timeRange: ITimeRange | null): SourceFileProcessAllSpec;
  ...
  withTimedFetchParentField(timedFetchParentField: string | null): SourceFileProcessAllSpec;

  readonly includeBaseTypes?: boolean;
  withIncludeBaseTypes(includeBaseTypes: boolean): SourceFileProcessAllSpec;
  ...
  withIgnoreViewInclude(ignoreViewInclude: boolean): SourceFileProcessAllSpec;

  /**
   * Batch size determines number of source files that will be processed together.
   */
  readonly sourceFilesBatchSize?: number | null;
  withSourceFilesBatchSize(sourceFilesBatchSize: number | null): SourceFileProcessAllSpec;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SourceFileProcessAllSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SourceFileProcessAllSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SourceFileProcessAllSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SourceFileProcessAllSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): SourceFileProcessAllSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SourceFileProcessAllSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SourceFileProcessAllSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SourceFileProcessAllSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SourceFileProcessAllSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SourceFileProcessAllSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SourceFileProcessAllSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SourceFileProcessAllSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SourceFileProcessAllSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SourceFileProcessAllSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SourceFileProcessAllSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SourceFileProcessAllSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SourceFileProcessAllSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SourceFileProcessAllSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SourceFileProcessAllSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SourceFileProcessAllSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SourceFileProcessAllSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SourceFileProcessAllSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SourceFileProcessAllSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SourceFileProcessAllSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SourceFileProcessAllSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SourceFileProcessAllSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): SourceFileProcessAllSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SourceFileProcessAllSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): SourceFileProcessAllSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SourceFileProcessAllSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SourceFileProcessAllSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SourceFileProcessAllSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SourceFileProcessAllSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SourceFileProcessAllSpec;

  mergeJson(json: any | null): SourceFileProcessAllSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SourceFileProcessAllSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SourceFileProcessAllSpec;
   ...
   */
  singletonArray(): C3.Array<SourceFileProcessAllSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SourceFileProcessAllSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SourceFileProcessAllSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SourceFileProcessAllSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SourceFileProcessAllSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SourceFileProcessAllSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SourceFileProcessAllSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SourceFileProcessAllSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SourceFileProcessAllSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SourceFileProcessAllSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SourceFileProcessAllSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SourceFileProcessAllSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SourceFileProcessAllSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SourceFileProcessAllSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SourceFileProcessAllSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SourceFileProcessAllSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SourceFileProcessAllSpec;
   ...
   */
  static cachedEmptyInst(): SourceFileProcessAllSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SourceFileProcessAllSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SourceFileProcessAllSpec;

  /**
   * @return new instance of this spec with `retrySpec` set
   */
  withRetry(maxRetries?: number | null, initialSleepMillis?: number | null, exponent?: number | null): SourceFileProcessAllSpec | null;

  /**
   * @return instance of this spec with `retrySpec`'s `maxTotalMillis` set
   */
  static timeoutSeconds(secs: number | null): SourceFileProcessAllSpec;
