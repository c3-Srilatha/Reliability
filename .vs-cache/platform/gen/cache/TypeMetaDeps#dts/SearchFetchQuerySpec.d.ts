// TypeScript definitions for the C3 type SearchFetchQuerySpec

/**
 * Spec used to search across {@link Persistable entity} types along with the typical {@link Fetchable.fetch fetch}
 * semantics for further filtering of the searched results.
 *
 * @remarks this represents a value passed to a method that expects an instance of SearchFetchQuerySpec
 */
declare interface ISearchFetchQuerySpec {
  ...
  /**
   * Kind of query
   * "match": full-text search (Word, Phrase, Sentence)
   * "term": term search (Single word)
   */
  queryKind?: string | null;

  /**
   * Searchable fields queried using string serialized expr
   * Ex: "firstName=='Adam' && lastName=='Smith'" Field specific query
   * Note that for the query Expr, only infix equality (==) expressions and (a.matches(b)) function call expressions
   * separated by (&& or ||) are currently supported.
   */
  expr?: string | null;

  /**
   * Searchable fields queried using queryText
   * Ex: "'Adam Smith'" Full text search across all fields.
   */
  query?: string | null;

  /**
   * Allows the score contribution to be boosted when the corresponding field is matched
   */
  fieldBoost?: C3.Map<string | null, number | null> | {[key: string | null]: number | null};

  /**
   * Period for the search query. The data will be searched for the period specified ending at the current time.
   */
  period?: string | null;

  /**
   * https://en.wikipedia.org/wiki/Damerau%E2%80%93Levenshtein_distance
   * Allows the user to specify the maximum Damerau-Levenshtein edit distance for fuzzy queries; defaults to
   * “-1”, which uses the default ElasticSearch behavior (i.e. “Auto” à sets to 0 for strings of 1/2 chars,
   * 1 for strings of 3/4/5 chars, and 2 for strings of 5+ chars)
   */
  fuzziness?: number | null;

  /**
   * The fields on which to execute a search query. If not specified, all fields will be retrieved from the SearchStore.
   */
 ...
 * semantics for further filtering of the searched results.
 *
 * @remarks this represents a made instance of SearchFetchQuerySpec
 */
declare class SearchFetchQuerySpec extends Obj {
  ...
  withOrder(order: string | null): SearchFetchQuerySpec;

  /**
   * Offset to use for paged reads.
   */
  readonly offset?: number | null;
  withOffset(offset: number | null): SearchFetchQuerySpec;
  ...
  withLimit(limit: number | null): SearchFetchQuerySpec;
   ...
   * "term": term search (Single word)
   */
  readonly queryKind?: string | null;
  withQueryKind(queryKind: string | null): SearchFetchQuerySpec;
  ...
  withExpr(expr: string | null): SearchFetchQuerySpec;
  ...
  withQuery(query: string | null): SearchFetchQuerySpec;

  /**
   * Allows the score contribution to be boosted when the corresponding field is matched
   */
  readonly fieldBoost?: C3.Map<string | null, number | null>;
  withFieldBoost(fieldBoost: C3.Map<string | null, number | null> | {[key: string | null]: number | null}): SearchFetchQuerySpec;

  /**
   * Period for the search query. The data will be searched for the period specified ending at the current time.
   */
  readonly period?: string | null;
  withPeriod(period: string | null): SearchFetchQuerySpec;
   ...
   * 1 for strings of 3/4/5 chars, and 2 for strings of 5+ chars)
   */
  readonly fuzziness?: number | null;
  withFuzziness(fuzziness: number | null): SearchFetchQuerySpec;

  /**
   * The fields on which to execute a search query. If not specified, all fields will be retrieved from the SearchStore.
   */
  readonly searchFields?: C3.Array<string | null>;
  withSearchFields(searchFields: C3.Array<string | null> | Array<string | null>): SearchFetchQuerySpec;
  ...
  withFilter(filter: string | null): SearchFetchQuerySpec;

  /**
   * Variables values to substitute in filter expression. CURRENTLY UNDER CONSTRUCTION!
   */
  readonly vars?: C3.Map<string | null, Obj | null>;
  withVars(vars: C3.Map<string | null, Obj | null> | {[key: string | null]: IObj | null}): SearchFetchQuerySpec;
  ...
  withFetchHiddenSeedData(fetchHiddenSeedData: boolean): SearchFetchQuerySpec;
  ...
  withExcludeExtensions(excludeExtensions: boolean): SearchFetchQuerySpec;
  ...
  withAsOf(asOf: DateTime | Date | string | null): SearchFetchQuerySpec;
  ...
  withAllowLiteralOnBindVariableOverflow(allowLiteralOnBindVariableOverflow: boolean): SearchFetchQuerySpec;
  ...
  withUseDedicatedConnection(useDedicatedConnection: boolean): SearchFetchQuerySpec;
  ...
  withStmtTimeoutMs(stmtTimeoutMs: number | null): SearchFetchQuerySpec;
  ...
  withDontThrowJsonDeserErrors(dontThrowJsonDeserErrors: boolean): SearchFetchQuerySpec;
  ...
  withTimeRange(timeRange: ITimeRange | null): SearchFetchQuerySpec;
  ...
  withTimedFetchParentField(timedFetchParentField: string | null): SearchFetchQuerySpec;

  readonly includeBaseTypes?: boolean;
  withIncludeBaseTypes(includeBaseTypes: boolean): SearchFetchQuerySpec;
  ...
  withIgnoreViewInclude(ignoreViewInclude: boolean): SearchFetchQuerySpec;
  ...
  withInclude(include: string | null): SearchFetchQuerySpec;
  ...
  withExcludeMeta(excludeMeta: boolean): SearchFetchQuerySpec;
  ...
  withIncludeReadCalcs(includeReadCalcs: boolean): SearchFetchQuerySpec;
  ...
  withRefreshCalcFields(refreshCalcFields: boolean): SearchFetchQuerySpec;
  ...
  withCalcFieldsToRefresh(calcFieldsToRefresh: C3.Array<string | null> | Array<string | null>): SearchFetchQuerySpec;
  ...
  withForceAcl(forceAcl: boolean): SearchFetchQuerySpec;
  ...
  withExplain(explain: boolean): SearchFetchQuerySpec;
  ...
  withValidateOnly(validateOnly: boolean): SearchFetchQuerySpec;
  ...
  withHints(hints: IFetchHints | null): SearchFetchQuerySpec;
  ...
  withUseSecondaryDatastore(useSecondaryDatastore: boolean): SearchFetchQuerySpec;
  ...
  withPreserveArrayIndexes(preserveArrayIndexes: boolean): SearchFetchQuerySpec;
  ...
  withResolveRefTypes(resolveRefTypes: boolean): SearchFetchQuerySpec;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SearchFetchQuerySpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SearchFetchQuerySpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SearchFetchQuerySpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SearchFetchQuerySpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): SearchFetchQuerySpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SearchFetchQuerySpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SearchFetchQuerySpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SearchFetchQuerySpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SearchFetchQuerySpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SearchFetchQuerySpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SearchFetchQuerySpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SearchFetchQuerySpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SearchFetchQuerySpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SearchFetchQuerySpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SearchFetchQuerySpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SearchFetchQuerySpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SearchFetchQuerySpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SearchFetchQuerySpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SearchFetchQuerySpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SearchFetchQuerySpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SearchFetchQuerySpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SearchFetchQuerySpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SearchFetchQuerySpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SearchFetchQuerySpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SearchFetchQuerySpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SearchFetchQuerySpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): SearchFetchQuerySpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SearchFetchQuerySpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): SearchFetchQuerySpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SearchFetchQuerySpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SearchFetchQuerySpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SearchFetchQuerySpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SearchFetchQuerySpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SearchFetchQuerySpec;

  mergeJson(json: any | null): SearchFetchQuerySpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SearchFetchQuerySpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SearchFetchQuerySpec;
   ...
   */
  singletonArray(): C3.Array<SearchFetchQuerySpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SearchFetchQuerySpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SearchFetchQuerySpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SearchFetchQuerySpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SearchFetchQuerySpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SearchFetchQuerySpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SearchFetchQuerySpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SearchFetchQuerySpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SearchFetchQuerySpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SearchFetchQuerySpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SearchFetchQuerySpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SearchFetchQuerySpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SearchFetchQuerySpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SearchFetchQuerySpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SearchFetchQuerySpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SearchFetchQuerySpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SearchFetchQuerySpec;
   ...
   */
  static cachedEmptyInst(): SearchFetchQuerySpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SearchFetchQuerySpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SearchFetchQuerySpec;
   ...
   */
  withIdFilter(id: string): SearchFetchQuerySpec | null;
   ...
   * @return updated FetchSpec
   */
  withIdsFilter(ids: C3.Array<string | null> | null): SearchFetchQuerySpec | null;
   ...
   * @return updated FetchSpec
   */
  withIdRangeFilter(startId?: string | null, endId?: string | null): SearchFetchQuerySpec | null;
