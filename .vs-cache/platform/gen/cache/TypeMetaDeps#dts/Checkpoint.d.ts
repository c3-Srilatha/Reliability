// TypeScript definitions for the C3 type Checkpoint

/**
 * Convenient checkpoint type for anything that needs to keep a state in DB to extend to
 *
 * @remarks this represents a value passed to a method that expects an instance of Checkpoint
 */
declare interface ICheckpoint<E> {
 ...
 * Convenient checkpoint type for anything that needs to keep a state in DB to extend to
 *
 * @remarks this represents a made instance of Checkpoint
 */
declare class Checkpoint<E> extends Obj {
  ...
  withTypeIdent(typeIdent: string | null): Checkpoint;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Checkpoint;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): Checkpoint;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): Checkpoint;
  ...
  withVersion(version: number | null): Checkpoint;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): Checkpoint;

  /**
   * The checkpoint value
   */
  readonly value?: E | null;
  withValue(value: E | null): Checkpoint;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Checkpoint<E> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Checkpoint<E> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Checkpoint<E> | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Checkpoint<E> | null;
   ...
   */
  replaceType(old: Type, new_: Type): Checkpoint<E>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Checkpoint<E>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Checkpoint<E>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Checkpoint<E> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Checkpoint<E> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Checkpoint<E>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Checkpoint<E>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Checkpoint<E>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): Checkpoint<E>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Checkpoint<E>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Checkpoint<E>;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Checkpoint<E>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Checkpoint<E>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Checkpoint<E>;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Checkpoint<E>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Checkpoint<E>;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Checkpoint<E>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Checkpoint<E>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Checkpoint<E>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Checkpoint<E>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Checkpoint<E>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Checkpoint<E>;
   ...
   * @see #removeField
   */
  unsetField(field: string): Checkpoint<E>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Checkpoint<E>;
   ...
   * @see #unsetField
   */
  removeField(field: string): Checkpoint<E>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Checkpoint<E>;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Checkpoint<E>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Checkpoint<E>;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Checkpoint<E>;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Checkpoint<E>;

  mergeJson(json: any | null): Checkpoint<E>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Checkpoint<E>;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Checkpoint<E>;
   ...
   */
  singletonArray(): C3.Array<Checkpoint<E> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Checkpoint<E> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Checkpoint<E> | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Checkpoint<E> | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Checkpoint<E> | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Checkpoint<E> | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Checkpoint<E> | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Checkpoint<E> | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Checkpoint<E> | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Checkpoint<E>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Checkpoint<E>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Checkpoint<E>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Checkpoint<E>;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Checkpoint<E>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Checkpoint<E>;
   ...
   * @see #fromString
   */
  static make(s: string | null): Checkpoint<E> | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Checkpoint<E>;
   ...
   */
  static cachedEmptyInst(): Checkpoint<E>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Checkpoint<E>>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Checkpoint<E>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<Checkpoint<E> | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<Checkpoint<E> | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Checkpoint<E> | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Checkpoint<E> | null> | null>;
   ...
   */
  get(include?: string | null): Checkpoint<E> | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): Checkpoint<E> | null;
   ...
   */
  getMissing(spec: GetMissingSpec): Checkpoint<E>;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): Checkpoint<E> | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): Checkpoint<E>;
   ...
   * @see #toString
   */
  static fromString(s: string | null): Checkpoint<E> | null;
   ...
   */
  create(spec?: UpsertSpec | null): Checkpoint<E> | null;
   ...
   */
  static createBatch(objs: C3.Array<Checkpoint<E> | null> | null, spec?: UpsertSpec | null): ObjList<Checkpoint<E> | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<Checkpoint<E> | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Checkpoint<E> | null> | null;
   ...
   */
  update(srcObj?: Checkpoint<E> | null, spec?: UpsertSpec | null): Checkpoint<E> | null;
   ...
   */
  upsert(srcObj?: Checkpoint<E> | null, spec?: UpsertSpec | null): Checkpoint<E> | null;
   ...
   */
  merge(spec?: MergeSpec | null): Checkpoint<E> | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): Checkpoint<E> | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): Checkpoint<E> | null;
   ...
   */
  static updateBatch(objs: C3.Array<Checkpoint<E> | null> | null, srcObjs?: C3.Array<Checkpoint<E> | null>, spec?: UpsertSpec | null): ObjList<Checkpoint<E> | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<Checkpoint<E> | null>>, spec?: UpsertSpec | null): ObjList<Checkpoint<E> | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<Checkpoint<E> | null> | null, srcObjs?: C3.Array<Checkpoint<E> | null>, spec?: UpsertSpec | null): ObjList<Checkpoint<E> | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<Checkpoint<E> | null>>, spec?: UpsertSpec | null): ObjList<Checkpoint<E> | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<Checkpoint<E> | null> | null, spec?: TouchSpec | null): ObjList<Checkpoint<E> | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Checkpoint<E> | null> | null, spec?: MergeSpec | null): ObjList<Checkpoint<E> | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Checkpoint<E> | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Checkpoint<E> | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<Checkpoint<E> | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Checkpoint<E> | null> | null;
   ...
   */
  static mergeAll(mergeObj: Checkpoint<E> | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: Checkpoint<E> | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<Checkpoint<E> | null> | null, spec?: UpsertSpec | null): ObjList<Checkpoint<E> | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<Checkpoint<E> | null> | null, spec?: UpsertSpec | null): ObjList<Checkpoint<E> | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<Checkpoint<E> | null> | null): ObjList<Checkpoint<E> | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<Checkpoint<E> | null> | null): ObjList<Checkpoint<E> | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<Checkpoint<E> | null> | null): ObjList<Checkpoint<E> | null>;
   ...
   */
  static afterCreate(objs: C3.Array<Checkpoint<E> | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<Checkpoint<E> | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<Checkpoint<E> | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<Checkpoint<E> | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Checkpoint<E> | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): Checkpoint<E> | null;
   ...
   */
  withoutIdentity(): Checkpoint<E> | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<Checkpoint<E> | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: Checkpoint<E> | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<Checkpoint<E> | null> | null, callback?: λFunction<Checkpoint<E> | null, Checkpoint<E> | null> | null): ObjList<Checkpoint<E> | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<Checkpoint<E> | null> | null, callback?: λFunction<Checkpoint<E> | null, Checkpoint<E> | null> | null): C3.Array<ObjError | null>;
   ...
   */
  applyAndCheckpoint(action: λFunction<Checkpoint | null, Checkpoint | null>): Checkpoint<E> | null;

  /**
   * Return the latest version of this checkpoint
   */
  safeGet(): Checkpoint<E> | null;
