// TypeScript definitions for the C3 type WriteOnlyContent

/**
 * Abstract write only content with header.
 *
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of WriteOnlyContent
 */
declare interface IWriteOnlyContent {
 ...
 * from multiple threads will have non-deterministic behavior because of the way streams work.
 *
 * @remarks this represents a made instance of WriteOnlyContent
 */
declare class WriteOnlyContent extends Obj {
  ...
  withContentEncoding(contentEncoding: string | null): WriteOnlyContent;
  ...
  withContentLanguage(contentLanguage: string | null): WriteOnlyContent;
  ...
  withContentLength(contentLength: number | null): WriteOnlyContent;
  ...
  withContentLocation(contentLocation: string | null): WriteOnlyContent;
  ...
  withContentType(contentType: string | null): WriteOnlyContent;
  ...
  withContentDisposition(contentDisposition: string | null): WriteOnlyContent;
  ...
  withETag(eTag: string | null): WriteOnlyContent;
  ...
  withLastModified(lastModified: DateTime | Date | string | null): WriteOnlyContent;

  /**
   * Id of user / identity who last last modified this content.
   */
  readonly lastModifiedBy?: string | null;
  withLastModifiedBy(lastModifiedBy: string | null): WriteOnlyContent;
  ...
  withContentMD5(contentMD5: string | null): WriteOnlyContent;
  ...
  withContentSHA1(contentSHA1: string | null): WriteOnlyContent;

  /**
   * Field to maintain state whether content metadata was read or not.
   */
  readonly hasMetadata?: boolean;
  withHasMetadata(hasMetadata: boolean): WriteOnlyContent;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): WriteOnlyContent | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): WriteOnlyContent | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): WriteOnlyContent | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): WriteOnlyContent | null;
   ...
   */
  replaceType(old: Type, new_: Type): WriteOnlyContent;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): WriteOnlyContent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): WriteOnlyContent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<WriteOnlyContent | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<WriteOnlyContent | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): WriteOnlyContent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): WriteOnlyContent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): WriteOnlyContent;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): WriteOnlyContent;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): WriteOnlyContent;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): WriteOnlyContent;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): WriteOnlyContent;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): WriteOnlyContent;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): WriteOnlyContent;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): WriteOnlyContent;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): WriteOnlyContent;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): WriteOnlyContent;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): WriteOnlyContent;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): WriteOnlyContent;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): WriteOnlyContent;
   ...
   * @see #unsetField
   */
  defaultField(field: string): WriteOnlyContent;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): WriteOnlyContent;
   ...
   * @see #removeField
   */
  unsetField(field: string): WriteOnlyContent;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): WriteOnlyContent;
   ...
   * @see #unsetField
   */
  removeField(field: string): WriteOnlyContent;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): WriteOnlyContent;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): WriteOnlyContent;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): WriteOnlyContent;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): WriteOnlyContent;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): WriteOnlyContent;

  mergeJson(json: any | null): WriteOnlyContent;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): WriteOnlyContent;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): WriteOnlyContent;
   ...
   */
  singletonArray(): C3.Array<WriteOnlyContent | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<WriteOnlyContent | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<WriteOnlyContent | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<WriteOnlyContent | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<WriteOnlyContent | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, WriteOnlyContent | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, WriteOnlyContent | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<WriteOnlyContent | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<WriteOnlyContent | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): WriteOnlyContent;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): WriteOnlyContent;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): WriteOnlyContent;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): WriteOnlyContent;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): WriteOnlyContent;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): WriteOnlyContent;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): WriteOnlyContent;
   ...
   */
  static cachedEmptyInst(): WriteOnlyContent;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<WriteOnlyContent>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): WriteOnlyContent;
   ...
   */
  withFileName(fileName: string | null): WriteOnlyContent;

  /**
   * Changes file extension in this instance.
   */
  withFileExt(fileExt: string | null): WriteOnlyContent;
   ...
   */
  identify(suffix?: string | null): WriteOnlyContent;
   ...
   */
  readMetadata(spec?: FileOperationSpec | null): WriteOnlyContent;
   ...
   */
  refreshMetadata(spec?: FileOperationSpec | null): WriteOnlyContent;
   ...
   * @return abstract content with metadata.
   */
  guessMetadata(spec?: FileOperationSpec | null): WriteOnlyContent;

  /**
   * Clears the content metadata; e.g. if it's known to be invalid.
   */
  clearMetadata(): WriteOnlyContent;

  /**
   * @return clone of this content with metadata from provided input.
   */
  withMetadata(meta?: ContentMeta | null): WriteOnlyContent;
   ...
   */
  encodedPushStream(spec?: FileOperationSpec | null): Pair<WriteOnlyContent | null, BytePushStream | null>;

  /**
   * @return byte push stream to be used for writing un-encoded data into this content object.
   */
  pushStream(spec?: FileOperationSpec | null): Pair<WriteOnlyContent | null, BytePushStream | null>;

  /**
   * @return character push stream to be used for writing un-encoded data into this content object.
   */
  charPushStream(spec?: FileOperationSpec | null): Pair<WriteOnlyContent | null, CharPushStream | null>;
   ...
   */
  encodedStream(spec?: FileOperationSpec | null): Pair<WriteOnlyContent | null, ByteStream | null> | null;
   ...
   */
  writeStream(content: ByteStream | null, spec?: FileOperationSpec | null): WriteOnlyContent;

  /**
   * Truncates file and replaces it's content with provided binary content.
   */
  writeInputStream(inputStream: any, spec?: FileOperationSpec | null): WriteOnlyContent;

  /**
   * Truncates file and replaces its content with provided binary content from zipInputStream
   */
  writeZipInputStream(zipInputStream: any, spec?: FileOperationSpec | null): WriteOnlyContent;
   ...
   */
  writeEncodedStream(encodedContent: ByteStream | null, spec?: FileOperationSpec | null): WriteOnlyContent;

  /**
   * Truncates file and replaces it's encoded content with provided binary content.
   */
  writeEncodedInputStream(inputStream: any, spec?: FileOperationSpec | null): WriteOnlyContent;
   ...
   *           content that needs to be written
   */
  write(content: any | null, spec?: FileOperationSpec | null): WriteOnlyContent;
   ...
   *           encoded content that needs to be written
   */
  writeEncoded(encodedContent: any | null, spec?: FileOperationSpec | null): WriteOnlyContent;
   ...
   *           content that needs to be written
   */
  writeString(content: string | null, spec?: FileOperationSpec | null): WriteOnlyContent;
   ...
   */
  writeObj(obj: Obj | null, spec?: FileObjsOperSpec | null): WriteOnlyContent;
   ...
   * @return pair of update instance of this content and number of objs written
   */
  startWriteObjs(spec?: FileObjsOperSpec | null): Pair<WriteOnlyContent | null, PushStream<Obj | null> | null>;
   ...
   */
  compress(contentEncoding?: string | null, spec?: FileCompressSpec | null): WriteOnlyContent;

  /**
   * Uncompresses content.
   */
  uncompress(spec?: FileCompressSpec | null): WriteOnlyContent;
   ...
   */
  transcode(contentType: string, contentEncoding: string, spec?: FileCompressSpec | null): WriteOnlyContent;

  /**
   * Copies content to a given target.
   */
  copyContentTo(target: WriteOnlyContent, spec?: FileOperationSpec | null): void;
   ...
   */
  concat(other: Content | null): WriteOnlyContent;

  /**
   * Creates a new Content by merging the incoming binary data with current content
   */
  concat(other: any | null): WriteOnlyContent;
