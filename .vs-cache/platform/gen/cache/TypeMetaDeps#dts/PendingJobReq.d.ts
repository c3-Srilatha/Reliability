// TypeScript definitions for the C3 type PendingJobReq

/**
 * Pending job (e.g. BatchJob/MapReduce/Workflow) scheduled during provisioning.
 *
 * @remarks this represents a value passed to a method that expects an instance of PendingJobReq
 */
declare interface IPendingJobReq {
 ...
 * Pending job (e.g. BatchJob/MapReduce/Workflow) scheduled during provisioning.
 *
 * @remarks this represents a made instance of PendingJobReq
 */
declare class PendingJobReq extends Obj {
  ...
  withTypeIdent(typeIdent: string | null): PendingJobReq;
   ...
   */
  readonly id: string;
  withId(id: string): PendingJobReq;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): PendingJobReq;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): PendingJobReq;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): PendingJobReq;
  ...
  withVersion(version: number | null): PendingJobReq;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): PendingJobReq;

  /**
   * Type to refresh.
   */
  readonly refreshType?: Type | null;
  withRefreshType(refreshType: IType | null): PendingJobReq;

  /**
   * Id of the pending job.
   */
  readonly jobId: string;
  withJobId(jobId: string): PendingJobReq;

  /**
   * Options to run the job with.
   */
  readonly options?: any;
  withOptions(options: any): PendingJobReq;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): PendingJobReq | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): PendingJobReq | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): PendingJobReq | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): PendingJobReq | null;
   ...
   */
  replaceType(old: Type, new_: Type): PendingJobReq;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PendingJobReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PendingJobReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PendingJobReq | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PendingJobReq | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): PendingJobReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PendingJobReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PendingJobReq;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PendingJobReq;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PendingJobReq;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PendingJobReq;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): PendingJobReq;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PendingJobReq;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PendingJobReq;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): PendingJobReq;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): PendingJobReq;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): PendingJobReq;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): PendingJobReq;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PendingJobReq;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): PendingJobReq;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PendingJobReq;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PendingJobReq;
   ...
   * @see #removeField
   */
  unsetField(field: string): PendingJobReq;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PendingJobReq;
   ...
   * @see #unsetField
   */
  removeField(field: string): PendingJobReq;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PendingJobReq;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): PendingJobReq;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): PendingJobReq;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): PendingJobReq;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): PendingJobReq;

  mergeJson(json: any | null): PendingJobReq;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): PendingJobReq;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): PendingJobReq;
   ...
   */
  singletonArray(): C3.Array<PendingJobReq | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<PendingJobReq | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PendingJobReq | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<PendingJobReq | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PendingJobReq | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, PendingJobReq | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PendingJobReq | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PendingJobReq | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PendingJobReq | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): PendingJobReq;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): PendingJobReq;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): PendingJobReq;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PendingJobReq;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): PendingJobReq;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PendingJobReq;
   ...
   * @see #fromString
   */
  static make(s: string | null): PendingJobReq | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): PendingJobReq;
   ...
   */
  static cachedEmptyInst(): PendingJobReq;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<PendingJobReq>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): PendingJobReq;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<PendingJobReq | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PendingJobReq | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<PendingJobReq | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<PendingJobReq | null> | null>;
   ...
   */
  get(include?: string | null): PendingJobReq | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): PendingJobReq | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PendingJobReq;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): PendingJobReq | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PendingJobReq;
   ...
   * @see #toString
   */
  static fromString(s: string | null): PendingJobReq | null;
   ...
   */
  create(spec?: UpsertSpec | null): PendingJobReq | null;
   ...
   */
  static createBatch(objs: C3.Array<PendingJobReq | null> | null, spec?: UpsertSpec | null): ObjList<PendingJobReq | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PendingJobReq | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<PendingJobReq | null> | null;
   ...
   */
  update(srcObj?: PendingJobReq | null, spec?: UpsertSpec | null): PendingJobReq | null;
   ...
   */
  upsert(srcObj?: PendingJobReq | null, spec?: UpsertSpec | null): PendingJobReq | null;
   ...
   */
  merge(spec?: MergeSpec | null): PendingJobReq | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): PendingJobReq | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): PendingJobReq | null;
   ...
   */
  static updateBatch(objs: C3.Array<PendingJobReq | null> | null, srcObjs?: C3.Array<PendingJobReq | null>, spec?: UpsertSpec | null): ObjList<PendingJobReq | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<PendingJobReq | null>>, spec?: UpsertSpec | null): ObjList<PendingJobReq | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<PendingJobReq | null> | null, srcObjs?: C3.Array<PendingJobReq | null>, spec?: UpsertSpec | null): ObjList<PendingJobReq | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<PendingJobReq | null>>, spec?: UpsertSpec | null): ObjList<PendingJobReq | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<PendingJobReq | null> | null, spec?: TouchSpec | null): ObjList<PendingJobReq | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PendingJobReq | null> | null, spec?: MergeSpec | null): ObjList<PendingJobReq | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PendingJobReq | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<PendingJobReq | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<PendingJobReq | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<PendingJobReq | null> | null;
   ...
   */
  static mergeAll(mergeObj: PendingJobReq | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PendingJobReq | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<PendingJobReq | null> | null, spec?: UpsertSpec | null): ObjList<PendingJobReq | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<PendingJobReq | null> | null, spec?: UpsertSpec | null): ObjList<PendingJobReq | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<PendingJobReq | null> | null): ObjList<PendingJobReq | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<PendingJobReq | null> | null): ObjList<PendingJobReq | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<PendingJobReq | null> | null): ObjList<PendingJobReq | null>;
   ...
   */
  static afterCreate(objs: C3.Array<PendingJobReq | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<PendingJobReq | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<PendingJobReq | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<PendingJobReq | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<PendingJobReq | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): PendingJobReq | null;
   ...
   */
  withoutIdentity(): PendingJobReq | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<PendingJobReq | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: PendingJobReq | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<PendingJobReq | null> | null, callback?: λFunction<PendingJobReq | null, PendingJobReq | null> | null): ObjList<PendingJobReq | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<PendingJobReq | null> | null, callback?: λFunction<PendingJobReq | null, PendingJobReq | null> | null): C3.Array<ObjError | null>;
