// TypeScript definitions for the C3 type IstanbulCoverageFileResult

/**
 * IstanbulCoverageFileResult keeps track of which lines were reached in the last test execution.
 *
 * @remarks this represents a value passed to a method that expects an instance of IstanbulCoverageFileResult
 */
declare interface IIstanbulCoverageFileResult {
   ...
   * running tests.
   */
  statementReachedCount?: C3.Map<number | null, number | null> | {[key: number | null]: number | null};
   ...
   */
  branchReachedCount?: C3.Map<number | null, IstanbulBranchReachCounts | null> | {[key: number | null]: IIstanbulBranchReachCounts | null};
   ...
   * running tests.
   */
  functionReachedCount?: C3.Map<number | null, number | null> | {[key: number | null]: number | null};
   ...
   */
  statementMap?: C3.Map<number | null, IstanbulCoverageLocation | null> | {[key: number | null]: IIstanbulCoverageLocation | null};
   ...
   */
  branchMap?: C3.Map<number | null, IstanbulBranchMetadata | null> | {[key: number | null]: IIstanbulBranchMetadata | null};
   ...
   */
  functionMap?: C3.Map<number | null, IstanbulFunctionMetadata | null> | {[key: number | null]: IIstanbulFunctionMetadata | null};

  /**
   * Json map of input sources.
   */
  inputSourceMap?: IIstanbulCoverageInputSourceMap | null;
}
 ...
 */
declare class IstanbulCoverageFileResult extends Obj {
   ...
   */
  readonly id: string;
  withId(id: string): IstanbulCoverageFileResult;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): IstanbulCoverageFileResult;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): IstanbulCoverageFileResult;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): IstanbulCoverageFileResult;
  ...
  withVersion(version: number | null): IstanbulCoverageFileResult;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): IstanbulCoverageFileResult;

  /**
   * File path of the source file
   */
  readonly path?: string | null;
  withPath(path: string | null): IstanbulCoverageFileResult;
   ...
   * running tests.
   */
  readonly statementReachedCount?: C3.Map<number | null, number | null>;
  withStatementReachedCount(statementReachedCount: C3.Map<number | null, number | null> | {[key: number | null]: number | null}): IstanbulCoverageFileResult;
   ...
   * branch is a switch statement, the counts array length would be the number of cases in the switch statement.
   */
  readonly branchReachedCount?: C3.Map<number | null, IstanbulBranchReachCounts | null>;
  withBranchReachedCount(branchReachedCount: C3.Map<number | null, IstanbulBranchReachCounts | null> | {[key: number | null]: IIstanbulBranchReachCounts | null}): IstanbulCoverageFileResult;
   ...
   * running tests.
   */
  readonly functionReachedCount?: C3.Map<number | null, number | null>;
  withFunctionReachedCount(functionReachedCount: C3.Map<number | null, number | null> | {[key: number | null]: number | null}): IstanbulCoverageFileResult;

  /**
   * Statement map used by Istanbul coverage tool to map unique ids that are embedded into instrumented code representing
   * statements, to the file locations in uninstrumented code.
   */
  readonly statementMap?: C3.Map<number | null, IstanbulCoverageLocation | null>;
  withStatementMap(statementMap: C3.Map<number | null, IstanbulCoverageLocation | null> | {[key: number | null]: IIstanbulCoverageLocation | null}): IstanbulCoverageFileResult;

  /**
   * Branch map used by Istanbul coverage tool to map unique ids that are embedded into instrumented code representing
   * branches, to the file locations in uninstrumented code.
   */
  readonly branchMap?: C3.Map<number | null, IstanbulBranchMetadata | null>;
  withBranchMap(branchMap: C3.Map<number | null, IstanbulBranchMetadata | null> | {[key: number | null]: IIstanbulBranchMetadata | null}): IstanbulCoverageFileResult;

  /**
   * Function map used by Istanbul coverage tool to map unique ids that are embedded into instrumented code representing
   * functions, to the file locations in uninstrumented code.
   */
  readonly functionMap?: C3.Map<number | null, IstanbulFunctionMetadata | null>;
  withFunctionMap(functionMap: C3.Map<number | null, IstanbulFunctionMetadata | null> | {[key: number | null]: IIstanbulFunctionMetadata | null}): IstanbulCoverageFileResult;

  /**
   * Json map of input sources.
   */
  readonly inputSourceMap?: IstanbulCoverageInputSourceMap | null;
  withInputSourceMap(inputSourceMap: IIstanbulCoverageInputSourceMap | null): IstanbulCoverageFileResult;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): IstanbulCoverageFileResult | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): IstanbulCoverageFileResult | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): IstanbulCoverageFileResult | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): IstanbulCoverageFileResult | null;
   ...
   */
  replaceType(old: Type, new_: Type): IstanbulCoverageFileResult;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): IstanbulCoverageFileResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): IstanbulCoverageFileResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<IstanbulCoverageFileResult | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<IstanbulCoverageFileResult | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): IstanbulCoverageFileResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): IstanbulCoverageFileResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): IstanbulCoverageFileResult;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): IstanbulCoverageFileResult;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): IstanbulCoverageFileResult;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): IstanbulCoverageFileResult;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): IstanbulCoverageFileResult;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): IstanbulCoverageFileResult;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): IstanbulCoverageFileResult;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): IstanbulCoverageFileResult;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): IstanbulCoverageFileResult;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): IstanbulCoverageFileResult;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): IstanbulCoverageFileResult;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): IstanbulCoverageFileResult;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): IstanbulCoverageFileResult;
   ...
   * @see #unsetField
   */
  defaultField(field: string): IstanbulCoverageFileResult;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): IstanbulCoverageFileResult;
   ...
   * @see #removeField
   */
  unsetField(field: string): IstanbulCoverageFileResult;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): IstanbulCoverageFileResult;
   ...
   * @see #unsetField
   */
  removeField(field: string): IstanbulCoverageFileResult;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): IstanbulCoverageFileResult;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): IstanbulCoverageFileResult;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): IstanbulCoverageFileResult;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): IstanbulCoverageFileResult;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): IstanbulCoverageFileResult;

  mergeJson(json: any | null): IstanbulCoverageFileResult;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): IstanbulCoverageFileResult;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): IstanbulCoverageFileResult;
   ...
   */
  singletonArray(): C3.Array<IstanbulCoverageFileResult | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<IstanbulCoverageFileResult | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<IstanbulCoverageFileResult | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<IstanbulCoverageFileResult | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<IstanbulCoverageFileResult | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, IstanbulCoverageFileResult | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, IstanbulCoverageFileResult | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<IstanbulCoverageFileResult | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<IstanbulCoverageFileResult | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): IstanbulCoverageFileResult;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): IstanbulCoverageFileResult;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): IstanbulCoverageFileResult;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): IstanbulCoverageFileResult;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): IstanbulCoverageFileResult;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): IstanbulCoverageFileResult;
   ...
   * @see #fromString
   */
  static make(s: string | null): IstanbulCoverageFileResult | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): IstanbulCoverageFileResult;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): IstanbulCoverageFileResult;
   ...
   */
  static cachedEmptyInst(): IstanbulCoverageFileResult;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<IstanbulCoverageFileResult>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): IstanbulCoverageFileResult;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<IstanbulCoverageFileResult | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<IstanbulCoverageFileResult | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<IstanbulCoverageFileResult | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<IstanbulCoverageFileResult | null> | null>;
   ...
   */
  get(include?: string | null): IstanbulCoverageFileResult | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): IstanbulCoverageFileResult | null;
   ...
   */
  getMissing(spec: GetMissingSpec): IstanbulCoverageFileResult;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): IstanbulCoverageFileResult | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): IstanbulCoverageFileResult;
   ...
   * @see #toString
   */
  static fromString(s: string | null): IstanbulCoverageFileResult | null;
   ...
   */
  create(spec?: UpsertSpec | null): IstanbulCoverageFileResult | null;
   ...
   */
  static createBatch(objs: C3.Array<IstanbulCoverageFileResult | null> | null, spec?: UpsertSpec | null): ObjList<IstanbulCoverageFileResult | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<IstanbulCoverageFileResult | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<IstanbulCoverageFileResult | null> | null;
   ...
   */
  update(srcObj?: IstanbulCoverageFileResult | null, spec?: UpsertSpec | null): IstanbulCoverageFileResult | null;
   ...
   */
  upsert(srcObj?: IstanbulCoverageFileResult | null, spec?: UpsertSpec | null): IstanbulCoverageFileResult | null;
   ...
   */
  merge(spec?: MergeSpec | null): IstanbulCoverageFileResult | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): IstanbulCoverageFileResult | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): IstanbulCoverageFileResult | null;
   ...
   */
  static updateBatch(objs: C3.Array<IstanbulCoverageFileResult | null> | null, srcObjs?: C3.Array<IstanbulCoverageFileResult | null>, spec?: UpsertSpec | null): ObjList<IstanbulCoverageFileResult | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<IstanbulCoverageFileResult | null>>, spec?: UpsertSpec | null): ObjList<IstanbulCoverageFileResult | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<IstanbulCoverageFileResult | null> | null, srcObjs?: C3.Array<IstanbulCoverageFileResult | null>, spec?: UpsertSpec | null): ObjList<IstanbulCoverageFileResult | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<IstanbulCoverageFileResult | null>>, spec?: UpsertSpec | null): ObjList<IstanbulCoverageFileResult | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<IstanbulCoverageFileResult | null> | null, spec?: TouchSpec | null): ObjList<IstanbulCoverageFileResult | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<IstanbulCoverageFileResult | null> | null, spec?: MergeSpec | null): ObjList<IstanbulCoverageFileResult | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<IstanbulCoverageFileResult | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<IstanbulCoverageFileResult | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<IstanbulCoverageFileResult | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<IstanbulCoverageFileResult | null> | null;
   ...
   */
  static mergeAll(mergeObj: IstanbulCoverageFileResult | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: IstanbulCoverageFileResult | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<IstanbulCoverageFileResult | null> | null, spec?: UpsertSpec | null): ObjList<IstanbulCoverageFileResult | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<IstanbulCoverageFileResult | null> | null, spec?: UpsertSpec | null): ObjList<IstanbulCoverageFileResult | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): IstanbulCoverageFileResult | null;
   ...
   */
  static beforeCreate(objs: C3.Array<IstanbulCoverageFileResult | null> | null): ObjList<IstanbulCoverageFileResult | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<IstanbulCoverageFileResult | null> | null): ObjList<IstanbulCoverageFileResult | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<IstanbulCoverageFileResult | null> | null): ObjList<IstanbulCoverageFileResult | null>;
   ...
   */
  static afterCreate(objs: C3.Array<IstanbulCoverageFileResult | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<IstanbulCoverageFileResult | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<IstanbulCoverageFileResult | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<IstanbulCoverageFileResult | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<IstanbulCoverageFileResult | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): IstanbulCoverageFileResult | null;
   ...
   */
  withoutIdentity(): IstanbulCoverageFileResult | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<IstanbulCoverageFileResult | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: IstanbulCoverageFileResult | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<IstanbulCoverageFileResult | null> | null, callback?: λFunction<IstanbulCoverageFileResult | null, IstanbulCoverageFileResult | null> | null): ObjList<IstanbulCoverageFileResult | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<IstanbulCoverageFileResult | null> | null, callback?: λFunction<IstanbulCoverageFileResult | null, IstanbulCoverageFileResult | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static loadCoverage(coverage?: any | null): void;
   ...
   */
  static generateCoverageJson(): any | null;
   ...
   */
  static fromCodeCoverageCounter(counters?: C3.Array<CodeCoverageCounter | null>): C3.Array<IstanbulCoverageFileResult | null>;
}
