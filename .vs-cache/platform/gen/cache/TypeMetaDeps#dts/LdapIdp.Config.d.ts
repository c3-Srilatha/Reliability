// TypeScript definitions for the C3 type LdapIdp.Config

/**
 * @remarks this represents a value passed to a method that expects an instance of LdapIdp.Config
 */
declare namespace LdapIdp {
  export interface IConfig {
     ...
     */
    allowedEmailDomains?: C3.Array<string | null> | Array<string | null>;

    /**
     * Applications that are trusted to redirect authenticated user(s)
     */
    trustedApplicationHosts?: C3.Array<string | null> | Array<string | null>;

    /**
     * List of relevant groups for the cluster from the IDP. If empty, then no group filtering is done on user login.
     */
    relevantGroups?: C3.Array<string | null> | Array<string | null>;
     ...
     */
    queryParams: ILdapIdp.QueryParams;
  }
}
...
declare namespace LdapIdp {
  export class Config extends Obj {
    ...
    withConfigOverride(configOverride: string | null): LdapIdp.Config;

    readonly secretOverride?: string | null;
    withSecretOverride(secretOverride: string | null): LdapIdp.Config;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: C3.Array<string | null>;
    withIssues(issues: C3.Array<string | null> | Array<string | null>): LdapIdp.Config;

    /**
     * The unique and required id of this instance.
     */
    readonly id: string;
    withId(id: string): LdapIdp.Config;

    /**
     * If present, the user will be redirected to this url instead of the idp login page.
     */
    readonly defaultContentUrl?: string | null;
    withDefaultContentUrl(defaultContentUrl: string | null): LdapIdp.Config;

    /**
     * Which field of the IdpUser to use as the user id
     */
    readonly userIdFormat?: string | null;
    withUserIdFormat(userIdFormat: string | null): LdapIdp.Config;
    ...
    withDefaultGroupId(defaultGroupId: string | null): LdapIdp.Config;

    /**
     * Returns whether we should write back to the Idp
     */
    readonly idpWriteback?: boolean;
    withIdpWriteback(idpWriteback: boolean): LdapIdp.Config;

    /**
     * Returns whether we should write back {@link UserGroup} updates to the Idp
     */
    readonly idpGroupWriteback?: boolean;
    withIdpGroupWriteback(idpGroupWriteback: boolean): LdapIdp.Config;

    /**
     * Returns the identity provider for write-back (if enabled)
     */
    readonly idpType?: string | null;
    withIdpType(idpType: string | null): LdapIdp.Config;
    ...
    withExternalAppId(externalAppId: string | null): LdapIdp.Config;
     ...
     * If empty, then no email domain validation is done on user login.
     */
    readonly allowedEmailDomains?: C3.Array<string | null>;
    withAllowedEmailDomains(allowedEmailDomains: C3.Array<string | null> | Array<string | null>): LdapIdp.Config;

    /**
     * Applications that are trusted to redirect authenticated user(s)
     */
    readonly trustedApplicationHosts?: C3.Array<string | null>;
    withTrustedApplicationHosts(trustedApplicationHosts: C3.Array<string | null> | Array<string | null>): LdapIdp.Config;

    /**
     * List of relevant groups for the cluster from the IDP. If empty, then no group filtering is done on user login.
     */
    readonly relevantGroups?: C3.Array<string | null>;
    withRelevantGroups(relevantGroups: C3.Array<string | null> | Array<string | null>): LdapIdp.Config;

    /**
     * Maximum number of connections that can be created at a time in LDAP server connection pool.
     * If maxLdapConnections is 0, then the connection pool is disabled and a new connection is created for each request.
     */
    readonly maxLdapConnections: number;
    withMaxLdapConnections(maxLdapConnections: number): LdapIdp.Config;

    /**
     * Maximum number of connections that can left idle at a time in LDAP server connection pool
     */
    readonly maxIdleLdapConnections: number;
    withMaxIdleLdapConnections(maxIdleLdapConnections: number): LdapIdp.Config;

    /**
     * Minimum number of connections to be left idle at a time in LDAP server connection pool
     */
    readonly minIdleLdapConnections: number;
    withMinIdleLdapConnections(minIdleLdapConnections: number): LdapIdp.Config;
     ...
     * see {@link TlsCertificate}.
     */
    readonly tlsCert?: TlsCertificate | null;
    withTlsCert(tlsCert: ITlsCertificate | null): LdapIdp.Config;

    /**
     * HostName of the LDAP server
     */
    readonly hostName: string;
    withHostName(hostName: string): LdapIdp.Config;

    /**
     * Port number of the LDAP server
     */
    readonly port: number;
    withPort(port: number): LdapIdp.Config;

    /**
     * Connection will fail if it does not succeed within this given time, in milliseconds
     */
    readonly timeout: number;
    withTimeout(timeout: number): LdapIdp.Config;

    /**
     * Username of the read only admin account
     */
    readonly username: string;
    withUsername(username: string): LdapIdp.Config;

    /**
     * Password of the read only admin account
     */
    readonly password: string;
    withPassword(password: string): LdapIdp.Config;

    /**
     * The {@link LdapIdp.QueryParams} with common query parameters, e.g. location for users in ldap server "ou=people,dc=example,dc=com"
     */
    readonly queryParams: LdapIdp.QueryParams;
    withQueryParams(queryParams: ILdapIdp.QueryParams): LdapIdp.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): LdapIdp.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): LdapIdp.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): LdapIdp.Config | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): LdapIdp.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): LdapIdp.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LdapIdp.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LdapIdp.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LdapIdp.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LdapIdp.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LdapIdp.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LdapIdp.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LdapIdp.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): LdapIdp.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): LdapIdp.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): LdapIdp.Config;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LdapIdp.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LdapIdp.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): LdapIdp.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): LdapIdp.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): LdapIdp.Config;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): LdapIdp.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LdapIdp.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): LdapIdp.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LdapIdp.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): LdapIdp.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): LdapIdp.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): LdapIdp.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): LdapIdp.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): LdapIdp.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): LdapIdp.Config;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LdapIdp.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): LdapIdp.Config;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LdapIdp.Config;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LdapIdp.Config;

    mergeJson(json: any | null): LdapIdp.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LdapIdp.Config;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): LdapIdp.Config;
     ...
     */
    singletonArray(): C3.Array<LdapIdp.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<LdapIdp.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<LdapIdp.Config | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<LdapIdp.Config | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<LdapIdp.Config | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, LdapIdp.Config | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, LdapIdp.Config | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<LdapIdp.Config | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<LdapIdp.Config | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LdapIdp.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LdapIdp.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LdapIdp.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): LdapIdp.Config;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LdapIdp.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): LdapIdp.Config;
     ...
     * @see #fromString
     */
    static make(s: string | null): LdapIdp.Config | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LdapIdp.Config;
     ...
     */
    static cachedEmptyInst(): LdapIdp.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LdapIdp.Config>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): LdapIdp.Config;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<LdapIdp.Config | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<LdapIdp.Config | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<LdapIdp.Config | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): LdapIdp.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string | null): LdapIdp.Config | null;
     ...
     * @see findByCacheKey
     */
    getCached(): LdapIdp.Config | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): LdapIdp.Config | null;
     ...
     */
    static produce(key: string): LdapIdp.Config | null;
     ...
     */
    static produceAll(): C3.Map<string | null, LdapIdp.Config | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, LdapIdp.Config | null>;
     ...
     */
    static forConfigKey(configKey: string | null): LdapIdp.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<LdapIdp.Config | null>;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: LdapIdp.Config, override?: string | null): void;
     ...
     * @see setSecretValue
     */
    setSecretValues(from: LdapIdp.Config, override?: string | null): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): LdapIdp.Config | null;
     ...
     * @see #toString
     */
    static fromString(s: string | null): LdapIdp.Config | null;
     ...
     */
    static forId(id: string | null, failIfMissing?: boolean): LdapIdp.Config | null;
     ...
     */
    validIdpGroups(idpAssignedGroups?: C3.Array<string | null>): Pair<C3.Array<UserGroup | null>, C3.Array<string | null>> | null;
  }
}
