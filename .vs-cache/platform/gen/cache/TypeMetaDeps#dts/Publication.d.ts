// TypeScript definitions for the C3 type Publication

/**
 * @remarks this represents a value passed to a method that expects an instance of Publication
 */
...
/**
 * @remarks this represents a made instance of Publication
 */
declare class Publication extends Obj {

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): Publication;

  readonly tag?: string | null;
  withTag(tag: string | null): Publication;

  readonly module?: string | null;
  withModule(module: string | null): Publication;

  readonly typp?: string | null;
  withTypp(typp: string | null): Publication;

  readonly action?: string | null;
  withAction(action: string | null): Publication;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Publication;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): Publication;
  ...
  withVersion(version: number | null): Publication;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): Publication;

  readonly fire?: string | null;
  withFire(fire: string | null): Publication;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Publication | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Publication | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Publication | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Publication | null;
   ...
   */
  replaceType(old: Type, new_: Type): Publication;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Publication;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Publication;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Publication | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Publication | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Publication;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Publication;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Publication;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): Publication;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Publication;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Publication;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Publication;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Publication;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Publication;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Publication;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Publication;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Publication;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Publication;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Publication;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Publication;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Publication;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Publication;
   ...
   * @see #removeField
   */
  unsetField(field: string): Publication;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Publication;
   ...
   * @see #unsetField
   */
  removeField(field: string): Publication;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Publication;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Publication;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Publication;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Publication;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Publication;

  mergeJson(json: any | null): Publication;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Publication;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Publication;
   ...
   */
  singletonArray(): C3.Array<Publication | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Publication | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Publication | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Publication | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Publication | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Publication | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Publication | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Publication | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Publication | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Publication;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Publication;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Publication;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Publication;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Publication;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Publication;
   ...
   * @see #fromString
   */
  static make(s: string | null): Publication | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Publication;
   ...
   */
  static cachedEmptyInst(): Publication;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Publication>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Publication;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<Publication | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<Publication | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Publication | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Publication | null> | null>;
   ...
   */
  get(include?: string | null): Publication | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): Publication | null;
   ...
   */
  getMissing(spec: GetMissingSpec): Publication;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): Publication | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): Publication;
   ...
   * @see #toString
   */
  static fromString(s: string | null): Publication | null;
   ...
   */
  create(spec?: UpsertSpec | null): Publication | null;
   ...
   */
  static createBatch(objs: C3.Array<Publication | null> | null, spec?: UpsertSpec | null): ObjList<Publication | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<Publication | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Publication | null> | null;
   ...
   */
  update(srcObj?: Publication | null, spec?: UpsertSpec | null): Publication | null;
   ...
   */
  upsert(srcObj?: Publication | null, spec?: UpsertSpec | null): Publication | null;
   ...
   */
  merge(spec?: MergeSpec | null): Publication | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): Publication | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): Publication | null;
   ...
   */
  static updateBatch(objs: C3.Array<Publication | null> | null, srcObjs?: C3.Array<Publication | null>, spec?: UpsertSpec | null): ObjList<Publication | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<Publication | null>>, spec?: UpsertSpec | null): ObjList<Publication | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<Publication | null> | null, srcObjs?: C3.Array<Publication | null>, spec?: UpsertSpec | null): ObjList<Publication | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<Publication | null>>, spec?: UpsertSpec | null): ObjList<Publication | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<Publication | null> | null, spec?: TouchSpec | null): ObjList<Publication | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Publication | null> | null, spec?: MergeSpec | null): ObjList<Publication | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Publication | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Publication | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<Publication | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Publication | null> | null;
   ...
   */
  static mergeAll(mergeObj: Publication | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: Publication | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<Publication | null> | null, spec?: UpsertSpec | null): ObjList<Publication | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<Publication | null> | null, spec?: UpsertSpec | null): ObjList<Publication | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<Publication | null> | null): ObjList<Publication | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<Publication | null> | null): ObjList<Publication | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<Publication | null> | null): ObjList<Publication | null>;
   ...
   */
  static afterCreate(objs: C3.Array<Publication | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<Publication | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<Publication | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<Publication | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Publication | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): Publication | null;
   ...
   */
  withoutIdentity(): Publication | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<Publication | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: Publication | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<Publication | null> | null, callback?: λFunction<Publication | null, Publication | null> | null): ObjList<Publication | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<Publication | null> | null, callback?: λFunction<Publication | null, Publication | null> | null): C3.Array<ObjError | null>;
