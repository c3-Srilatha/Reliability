// TypeScript definitions for the C3 type PendingRefreshAclReq

/**
 * Pending refresh requests to populate acls based on changes to AclPrivilege found during provisioning.
 *
 * @remarks this represents a value passed to a method that expects an instance of PendingRefreshAclReq
 */
declare interface IPendingRefreshAclReq {
 ...
 * Pending refresh requests to populate acls based on changes to AclPrivilege found during provisioning.
 *
 * @remarks this represents a made instance of PendingRefreshAclReq
 */
declare class PendingRefreshAclReq extends Obj {
  ...
  withTypeIdent(typeIdent: string | null): PendingRefreshAclReq;
   ...
   */
  readonly id: string;
  withId(id: string): PendingRefreshAclReq;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): PendingRefreshAclReq;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): PendingRefreshAclReq;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): PendingRefreshAclReq;
  ...
  withVersion(version: number | null): PendingRefreshAclReq;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): PendingRefreshAclReq;

  /**
   * Type to refresh.
   */
  readonly refreshType?: Type | null;
  withRefreshType(refreshType: IType | null): PendingRefreshAclReq;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): PendingRefreshAclReq | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): PendingRefreshAclReq | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): PendingRefreshAclReq | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): PendingRefreshAclReq | null;
   ...
   */
  replaceType(old: Type, new_: Type): PendingRefreshAclReq;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PendingRefreshAclReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PendingRefreshAclReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PendingRefreshAclReq | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PendingRefreshAclReq | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): PendingRefreshAclReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PendingRefreshAclReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PendingRefreshAclReq;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PendingRefreshAclReq;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PendingRefreshAclReq;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PendingRefreshAclReq;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): PendingRefreshAclReq;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PendingRefreshAclReq;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PendingRefreshAclReq;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): PendingRefreshAclReq;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): PendingRefreshAclReq;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): PendingRefreshAclReq;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): PendingRefreshAclReq;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PendingRefreshAclReq;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): PendingRefreshAclReq;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PendingRefreshAclReq;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PendingRefreshAclReq;
   ...
   * @see #removeField
   */
  unsetField(field: string): PendingRefreshAclReq;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PendingRefreshAclReq;
   ...
   * @see #unsetField
   */
  removeField(field: string): PendingRefreshAclReq;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PendingRefreshAclReq;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): PendingRefreshAclReq;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): PendingRefreshAclReq;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): PendingRefreshAclReq;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): PendingRefreshAclReq;

  mergeJson(json: any | null): PendingRefreshAclReq;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): PendingRefreshAclReq;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): PendingRefreshAclReq;
   ...
   */
  singletonArray(): C3.Array<PendingRefreshAclReq | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<PendingRefreshAclReq | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PendingRefreshAclReq | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<PendingRefreshAclReq | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PendingRefreshAclReq | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, PendingRefreshAclReq | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PendingRefreshAclReq | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PendingRefreshAclReq | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PendingRefreshAclReq | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): PendingRefreshAclReq;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): PendingRefreshAclReq;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): PendingRefreshAclReq;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PendingRefreshAclReq;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): PendingRefreshAclReq;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PendingRefreshAclReq;
   ...
   * @see #fromString
   */
  static make(s: string | null): PendingRefreshAclReq | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): PendingRefreshAclReq;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): PendingRefreshAclReq;
   ...
   */
  static cachedEmptyInst(): PendingRefreshAclReq;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<PendingRefreshAclReq>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): PendingRefreshAclReq;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<PendingRefreshAclReq | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PendingRefreshAclReq | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<PendingRefreshAclReq | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<PendingRefreshAclReq | null> | null>;
   ...
   */
  get(include?: string | null): PendingRefreshAclReq | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): PendingRefreshAclReq | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PendingRefreshAclReq;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): PendingRefreshAclReq | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PendingRefreshAclReq;
   ...
   * @see #toString
   */
  static fromString(s: string | null): PendingRefreshAclReq | null;
   ...
   */
  create(spec?: UpsertSpec | null): PendingRefreshAclReq | null;
   ...
   */
  static createBatch(objs: C3.Array<PendingRefreshAclReq | null> | null, spec?: UpsertSpec | null): ObjList<PendingRefreshAclReq | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PendingRefreshAclReq | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<PendingRefreshAclReq | null> | null;
   ...
   */
  update(srcObj?: PendingRefreshAclReq | null, spec?: UpsertSpec | null): PendingRefreshAclReq | null;
   ...
   */
  upsert(srcObj?: PendingRefreshAclReq | null, spec?: UpsertSpec | null): PendingRefreshAclReq | null;
   ...
   */
  merge(spec?: MergeSpec | null): PendingRefreshAclReq | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): PendingRefreshAclReq | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): PendingRefreshAclReq | null;
   ...
   */
  static updateBatch(objs: C3.Array<PendingRefreshAclReq | null> | null, srcObjs?: C3.Array<PendingRefreshAclReq | null>, spec?: UpsertSpec | null): ObjList<PendingRefreshAclReq | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<PendingRefreshAclReq | null>>, spec?: UpsertSpec | null): ObjList<PendingRefreshAclReq | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<PendingRefreshAclReq | null> | null, srcObjs?: C3.Array<PendingRefreshAclReq | null>, spec?: UpsertSpec | null): ObjList<PendingRefreshAclReq | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<PendingRefreshAclReq | null>>, spec?: UpsertSpec | null): ObjList<PendingRefreshAclReq | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<PendingRefreshAclReq | null> | null, spec?: TouchSpec | null): ObjList<PendingRefreshAclReq | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PendingRefreshAclReq | null> | null, spec?: MergeSpec | null): ObjList<PendingRefreshAclReq | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PendingRefreshAclReq | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<PendingRefreshAclReq | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<PendingRefreshAclReq | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<PendingRefreshAclReq | null> | null;
   ...
   */
  static mergeAll(mergeObj: PendingRefreshAclReq | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PendingRefreshAclReq | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<PendingRefreshAclReq | null> | null, spec?: UpsertSpec | null): ObjList<PendingRefreshAclReq | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<PendingRefreshAclReq | null> | null, spec?: UpsertSpec | null): ObjList<PendingRefreshAclReq | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): PendingRefreshAclReq | null;
   ...
   */
  static beforeCreate(objs: C3.Array<PendingRefreshAclReq | null> | null): ObjList<PendingRefreshAclReq | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<PendingRefreshAclReq | null> | null): ObjList<PendingRefreshAclReq | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<PendingRefreshAclReq | null> | null): ObjList<PendingRefreshAclReq | null>;
   ...
   */
  static afterCreate(objs: C3.Array<PendingRefreshAclReq | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<PendingRefreshAclReq | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<PendingRefreshAclReq | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<PendingRefreshAclReq | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<PendingRefreshAclReq | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): PendingRefreshAclReq | null;
   ...
   */
  withoutIdentity(): PendingRefreshAclReq | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<PendingRefreshAclReq | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: PendingRefreshAclReq | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<PendingRefreshAclReq | null> | null, callback?: λFunction<PendingRefreshAclReq | null, PendingRefreshAclReq | null> | null): ObjList<PendingRefreshAclReq | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<PendingRefreshAclReq | null> | null, callback?: λFunction<PendingRefreshAclReq | null, PendingRefreshAclReq | null> | null): C3.Array<ObjError | null>;
