// TypeScript definitions for the C3 type Logger.Config

/**
 * Config holding details for loggers
 *
 * @remarks this represents a value passed to a method that expects an instance of Logger.Config
 */
declare namespace Logger {
  export interface IConfig {
     ...
     */
    appenders?: C3.Array<string | null> | Array<string | null>;

    /**
     * Corresponding appender level
     */
    appendersLevels?: C3.Array<string | null> | Array<string | null>;
  }
}
...
declare namespace Logger {
  export class Config extends Obj {
    ...
    withConfigOverride(configOverride: string | null): Logger.Config;

    readonly secretOverride?: string | null;
    withSecretOverride(secretOverride: string | null): Logger.Config;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: C3.Array<string | null>;
    withIssues(issues: C3.Array<string | null> | Array<string | null>): Logger.Config;

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): Logger.Config;

    /**
     * level of the logger
     */
    readonly level: string;
    withLevel(level: string): Logger.Config;

    /**
     * Should log messages be recursively added from parent to child
     */
    readonly notAdditive?: boolean;
    withNotAdditive(notAdditive: boolean): Logger.Config;
     ...
     * Type of appenders included on the logger
     */
    readonly appenders?: C3.Array<string | null>;
    withAppenders(appenders: C3.Array<string | null> | Array<string | null>): Logger.Config;

    /**
     * Corresponding appender level
     */
    readonly appendersLevels?: C3.Array<string | null>;
    withAppendersLevels(appendersLevels: C3.Array<string | null> | Array<string | null>): Logger.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Logger.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Logger.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Logger.Config | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Logger.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Logger.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Logger.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Logger.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Logger.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Logger.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Logger.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Logger.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Logger.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Logger.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Logger.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Logger.Config;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Logger.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Logger.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Logger.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Logger.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Logger.Config;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Logger.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Logger.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Logger.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Logger.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Logger.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Logger.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Logger.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Logger.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Logger.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Logger.Config;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Logger.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Logger.Config;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Logger.Config;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Logger.Config;

    mergeJson(json: any | null): Logger.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Logger.Config;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Logger.Config;
     ...
     */
    singletonArray(): C3.Array<Logger.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Logger.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Logger.Config | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Logger.Config | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Logger.Config | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Logger.Config | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Logger.Config | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Logger.Config | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Logger.Config | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Logger.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Logger.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Logger.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Logger.Config;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Logger.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Logger.Config;
     ...
     * @see #fromString
     */
    static make(s: string | null): Logger.Config | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Logger.Config;
     ...
     */
    static cachedEmptyInst(): Logger.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Logger.Config>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Logger.Config;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<Logger.Config | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<Logger.Config | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<Logger.Config | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): Logger.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string | null): Logger.Config | null;
     ...
     * @see findByCacheKey
     */
    getCached(): Logger.Config | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): Logger.Config | null;
     ...
     */
    static produce(key: string): Logger.Config | null;
     ...
     */
    static produceAll(): C3.Map<string | null, Logger.Config | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, Logger.Config | null>;
     ...
     */
    static forConfigKey(configKey: string | null): Logger.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<Logger.Config | null>;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Logger.Config, override?: string | null): void;
     ...
     * @see setSecretValue
     */
    setSecretValues(from: Logger.Config, override?: string | null): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Logger.Config | null;
     ...
     */
    removeSecrets(): Logger.Config | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Logger.Config | null;
     ...
     * @see #toString
     */
    static fromString(s: string | null): Logger.Config | null;
     ...
     */
    static forName(name: string | null, failIfMissing?: boolean): Logger.Config | null;
  }
}
