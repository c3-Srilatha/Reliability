// TypeScript definitions for the C3 type Microservice.Content
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Microservice.Content
 */
...
declare namespace Microservice {
  export class Content extends Obj {
     ...
     */
    readonly id: string;
    withId(id: string): Microservice.Content;
    ...
    withContentEncoding(contentEncoding: string | null): Microservice.Content;
    ...
    withContentLanguage(contentLanguage: string | null): Microservice.Content;
    ...
    withContentLength(contentLength: number | null): Microservice.Content;
    ...
    withContentLocation(contentLocation: string | null): Microservice.Content;
    ...
    withContentType(contentType: string | null): Microservice.Content;
    ...
    withContentDisposition(contentDisposition: string | null): Microservice.Content;
    ...
    withETag(eTag: string | null): Microservice.Content;
    ...
    withLastModified(lastModified: DateTime | Date | string | null): Microservice.Content;

    /**
     * Id of user / identity who last last modified this content.
     */
    readonly lastModifiedBy?: string | null;
    withLastModifiedBy(lastModifiedBy: string | null): Microservice.Content;
    ...
    withContentMD5(contentMD5: string | null): Microservice.Content;
    ...
    withContentSHA1(contentSHA1: string | null): Microservice.Content;

    /**
     * Field to maintain state whether content metadata was read or not.
     */
    readonly hasMetadata?: boolean;
    withHasMetadata(hasMetadata: boolean): Microservice.Content;

    /**
     * An optional key that can be used by the service to help retrieve real backing {@link Content}.
     */
    readonly name?: string | null;
    withName(name: string | null): Microservice.Content;

    /**
     * Specifies the {@link Microservice.Proxy} instance to use when fetching the real backing {@link Content}.
     */
    readonly serviceName?: string | null;
    withServiceName(serviceName: string | null): Microservice.Content;
     ...
     * @see #toString
     */
    static fromString(s: string | null): Microservice.Content | null;
     ...
     * @see #fromString
     */
    static make(s: string | null): Microservice.Content | null;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Microservice.Content;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Microservice.Content;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Microservice.Content;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Microservice.Content;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Microservice.Content | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Microservice.Content | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Microservice.Content | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Microservice.Content | null;
     ...
     */
    replaceType(old: Type, new_: Type): Microservice.Content;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Microservice.Content;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Microservice.Content;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Microservice.Content | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Microservice.Content | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Microservice.Content;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Microservice.Content;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Microservice.Content;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Microservice.Content;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Microservice.Content;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Microservice.Content;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Microservice.Content;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Microservice.Content;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Microservice.Content;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Microservice.Content;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Microservice.Content;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Microservice.Content;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Microservice.Content;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Microservice.Content;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Microservice.Content;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Microservice.Content;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Microservice.Content;
     ...
     * @see #removeField
     */
    unsetField(field: string): Microservice.Content;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Microservice.Content;
     ...
     * @see #unsetField
     */
    removeField(field: string): Microservice.Content;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Microservice.Content;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Microservice.Content;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Microservice.Content;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Microservice.Content;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Microservice.Content;

    mergeJson(json: any | null): Microservice.Content;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Microservice.Content;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Microservice.Content;
     ...
     */
    singletonArray(): C3.Array<Microservice.Content | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Microservice.Content | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Microservice.Content | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Microservice.Content | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Microservice.Content | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Microservice.Content | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Microservice.Content | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Microservice.Content | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Microservice.Content | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Microservice.Content;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Microservice.Content;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Microservice.Content;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Microservice.Content;
     ...
     */
    static cachedEmptyInst(): Microservice.Content;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Microservice.Content>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Microservice.Content;
     ...
     */
    static forId(id: string | null, failIfMissing?: boolean): Microservice.Content | null;
     ...
     */
    withFileName(fileName: string | null): Microservice.Content;

    /**
     * Changes file extension in this instance.
     */
    withFileExt(fileExt: string | null): Microservice.Content;
     ...
     */
    identify(suffix?: string | null): Microservice.Content;
     ...
     */
    readMetadata(spec?: FileOperationSpec | null): Microservice.Content;
     ...
     */
    refreshMetadata(spec?: FileOperationSpec | null): Microservice.Content;
     ...
     * @return abstract content with metadata.
     */
    guessMetadata(spec?: FileOperationSpec | null): Microservice.Content;

    /**
     * Notifies the service automatically when the real backing {@link Content} has been updated.
     */
    clearMetadata(): Microservice.Content;

    /**
     * @return clone of this content with metadata from provided input.
     */
    withMetadata(meta?: ContentMeta | null): Microservice.Content;
     ...
     */
    encodedPushStream(spec?: FileOperationSpec | null): Pair<Microservice.Content | null, BytePushStream | null>;

    /**
     * @return byte push stream to be used for writing un-encoded data into this content object.
     */
    pushStream(spec?: FileOperationSpec | null): Pair<Microservice.Content | null, BytePushStream | null>;

    /**
     * @return character push stream to be used for writing un-encoded data into this content object.
     */
    charPushStream(spec?: FileOperationSpec | null): Pair<Microservice.Content | null, CharPushStream | null>;
     ...
     */
    encodedStream(spec?: FileOperationSpec | null): Pair<Microservice.Content | null, ByteStream | null> | null;
     ...
     */
    writeStream(content: ByteStream | null, spec?: FileOperationSpec | null): Microservice.Content;

    /**
     * Truncates file and replaces it's content with provided binary content.
     */
    writeInputStream(inputStream: any, spec?: FileOperationSpec | null): Microservice.Content;

    /**
     * Truncates file and replaces its content with provided binary content from zipInputStream
     */
    writeZipInputStream(zipInputStream: any, spec?: FileOperationSpec | null): Microservice.Content;
     ...
     */
    writeEncodedStream(encodedContent: ByteStream | null, spec?: FileOperationSpec | null): Microservice.Content;

    /**
     * Truncates file and replaces it's encoded content with provided binary content.
     */
    writeEncodedInputStream(inputStream: any, spec?: FileOperationSpec | null): Microservice.Content;
     ...
     *           content that needs to be written
     */
    write(content: any | null, spec?: FileOperationSpec | null): Microservice.Content;
     ...
     *           encoded content that needs to be written
     */
    writeEncoded(encodedContent: any | null, spec?: FileOperationSpec | null): Microservice.Content;
     ...
     *           content that needs to be written
     */
    writeString(content: string | null, spec?: FileOperationSpec | null): Microservice.Content;
     ...
     */
    writeObj(obj: Obj | null, spec?: FileObjsOperSpec | null): Microservice.Content;
     ...
     * @return pair of update instance of this content and number of objs written
     */
    startWriteObjs(spec?: FileObjsOperSpec | null): Pair<Microservice.Content | null, PushStream<Obj | null> | null>;
     ...
     */
    compress(contentEncoding?: string | null, spec?: FileCompressSpec | null): Microservice.Content;

    /**
     * Uncompresses content.
     */
    uncompress(spec?: FileCompressSpec | null): Microservice.Content;
     ...
     */
    transcode(contentType: string, contentEncoding: string, spec?: FileCompressSpec | null): Microservice.Content;

    /**
     * Copies content to a given target.
     */
    copyContentTo(target: Microservice.Content, spec?: FileOperationSpec | null): void;
     ...
     */
    concat(other: Content | null): Microservice.Content;

    /**
     * Creates a new Content by merging the incoming binary data with current content
     */
    concat(other: any | null): Microservice.Content;
