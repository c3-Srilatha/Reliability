// TypeScript definitions for the C3 type ImageContent

/**
 * Immutable representation of images in C3
 *
 * @remarks this represents a value passed to a method that expects an instance of ImageContent
 */
declare interface IImageContent {
 ...
 */
declare class ImageContent extends Obj {
  ...
  withWidth(width: number | null): ImageContent;
  ...
  withHeight(height: number | null): ImageContent;
  ...
  withContentLocation(contentLocation: string | null): ImageContent;
  ...
  withContentEncoding(contentEncoding: string | null): ImageContent;
  ...
  withContentLanguage(contentLanguage: string | null): ImageContent;
  ...
  withContentLength(contentLength: number | null): ImageContent;
  ...
  withContentType(contentType: string | null): ImageContent;
  ...
  withContentDisposition(contentDisposition: string | null): ImageContent;
  ...
  withETag(eTag: string | null): ImageContent;
  ...
  withLastModified(lastModified: DateTime | Date | string | null): ImageContent;

  /**
   * Id of user / identity who last last modified this content.
   */
  readonly lastModifiedBy?: string | null;
  withLastModifiedBy(lastModifiedBy: string | null): ImageContent;
  ...
  withContentMD5(contentMD5: string | null): ImageContent;
  ...
  withContentSHA1(contentSHA1: string | null): ImageContent;

  /**
   * Field to maintain state whether content metadata was read or not.
   */
  readonly hasMetadata?: boolean;
  withHasMetadata(hasMetadata: boolean): ImageContent;

  /**
   * The actual content value.
   */
  readonly content?: any | null;
  withContent(content: any | null): ImageContent;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ImageContent | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ImageContent | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ImageContent | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ImageContent | null;
   ...
   */
  replaceType(old: Type, new_: Type): ImageContent;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ImageContent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ImageContent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ImageContent | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ImageContent | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ImageContent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ImageContent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ImageContent;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ImageContent;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ImageContent;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ImageContent;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ImageContent;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ImageContent;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ImageContent;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ImageContent;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ImageContent;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ImageContent;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ImageContent;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ImageContent;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ImageContent;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ImageContent;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ImageContent;
   ...
   * @see #removeField
   */
  unsetField(field: string): ImageContent;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ImageContent;
   ...
   * @see #unsetField
   */
  removeField(field: string): ImageContent;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ImageContent;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ImageContent;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ImageContent;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ImageContent;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ImageContent;

  mergeJson(json: any | null): ImageContent;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ImageContent;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ImageContent;
   ...
   */
  singletonArray(): C3.Array<ImageContent | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ImageContent | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ImageContent | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ImageContent | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ImageContent | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ImageContent | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ImageContent | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ImageContent | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ImageContent | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ImageContent;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ImageContent;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ImageContent;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ImageContent;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ImageContent;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ImageContent;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ImageContent;
   ...
   */
  static cachedEmptyInst(): ImageContent;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ImageContent>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ImageContent;
   ...
   */
  readMediaMetadata(): ImageContent;

  /**
   * @return instance of the Visual Media from provided content and optionally reads metadata
   */
  static fromContent(content: Content, readMetadata?: boolean): ImageContent;
   ...
   */
  static fromRawBinary(data: any, contentType?: string | null, width?: number | null, height?: number | null): ImageContent;
   ...
   */
  static fromBase64String(data: string, contentType?: string | null, width?: number | null, height?: number | null): ImageContent;
   ...
   */
  withRawBinary(data: any, contentType?: string | null, width?: number | null, height?: number | null): ImageContent;
   ...
   */
  withBase64String(data: string, contentType?: string | null, width?: number | null, height?: number | null): ImageContent;
   ...
   */
  withFileName(fileName: string | null): ImageContent;

  /**
   * Changes file extension in this instance.
   */
  withFileExt(fileExt: string | null): ImageContent;
   ...
   */
  identify(suffix?: string | null): ImageContent;
   ...
   */
  readMetadata(spec?: FileOperationSpec | null): ImageContent;
   ...
   */
  refreshMetadata(spec?: FileOperationSpec | null): ImageContent;
   ...
   * @return abstract content with metadata.
   */
  guessMetadata(spec?: FileOperationSpec | null): ImageContent;

  /**
   * Clears the content metadata; e.g. if it's known to be invalid.
   */
  clearMetadata(): ImageContent;

  /**
   * @return clone of this content with metadata from provided input.
   */
  withMetadata(meta?: ContentMeta | null): ImageContent;
   ...
   */
  encodedPushStream(spec?: FileOperationSpec | null): Pair<ImageContent | null, BytePushStream | null>;

  /**
   * @return byte push stream to be used for writing un-encoded data into this content object.
   */
  pushStream(spec?: FileOperationSpec | null): Pair<ImageContent | null, BytePushStream | null>;

  /**
   * @return character push stream to be used for writing un-encoded data into this content object.
   */
  charPushStream(spec?: FileOperationSpec | null): Pair<ImageContent | null, CharPushStream | null>;
   ...
   */
  encodedStream(spec?: FileOperationSpec | null): Pair<ImageContent | null, ByteStream | null> | null;
   ...
   */
  writeStream(content: ByteStream | null, spec?: FileOperationSpec | null): ImageContent;

  /**
   * Truncates file and replaces it's content with provided binary content.
   */
  writeInputStream(inputStream: any, spec?: FileOperationSpec | null): ImageContent;

  /**
   * Truncates file and replaces its content with provided binary content from zipInputStream
   */
  writeZipInputStream(zipInputStream: any, spec?: FileOperationSpec | null): ImageContent;
   ...
   */
  writeEncodedStream(encodedContent: ByteStream | null, spec?: FileOperationSpec | null): ImageContent;

  /**
   * Truncates file and replaces it's encoded content with provided binary content.
   */
  writeEncodedInputStream(inputStream: any, spec?: FileOperationSpec | null): ImageContent;
   ...
   *           content that needs to be written
   */
  write(content: any | null, spec?: FileOperationSpec | null): ImageContent;
   ...
   *           encoded content that needs to be written
   */
  writeEncoded(encodedContent: any | null, spec?: FileOperationSpec | null): ImageContent;
   ...
   *           content that needs to be written
   */
  writeString(content: string | null, spec?: FileOperationSpec | null): ImageContent;
   ...
   */
  writeObj(obj: Obj | null, spec?: FileObjsOperSpec | null): ImageContent;
   ...
   * @return pair of update instance of this content and number of objs written
   */
  startWriteObjs(spec?: FileObjsOperSpec | null): Pair<ImageContent | null, PushStream<Obj | null> | null>;
   ...
   */
  compress(contentEncoding?: string | null, spec?: FileCompressSpec | null): ImageContent;

  /**
   * Uncompresses content.
   */
  uncompress(spec?: FileCompressSpec | null): ImageContent;
   ...
   */
  transcode(contentType: string, contentEncoding: string, spec?: FileCompressSpec | null): ImageContent;

  /**
   * Copies content to a given target.
   */
  copyContentTo(target: ImageContent, spec?: FileOperationSpec | null): void;
