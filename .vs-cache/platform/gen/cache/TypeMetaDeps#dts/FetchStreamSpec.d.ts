// TypeScript definitions for the C3 type FetchStreamSpec

/**
 * Specification of which Objs to bring back and which fields to bring back in them for a
 * {@link Persistable#fetchObjStream} call.
 *
 * @remarks this represents a value passed to a method that expects an instance of FetchStreamSpec
 */
declare interface IFetchStreamSpec {
  ...
  /**
   * Maximum number of Objs to return (starting from {@link offset}).  If there are fewer rows than were requested, only those will be returned.  If there are
   * additional rows beyond what was requested, then {@link FetchResult.hasMore} will be set to true.
   *
   * -1 returns all.
   */
  limit?: number | null;
  ...
  /**
   * Ids that will be added to the filter.  If {@link idsField} is specified they will be applied as a filter to that
   * field, otherwise they will be applied to the "id" field.
   */
  ids?: Stream<string | null> | Array<string | null>;

  /**
   * If {@link ids} is specified, the field that the ids will be applied to as a filter.  Default is "id".
   */
 ...
 * {@link Persistable#fetchObjStream} call.
 *
 * @remarks this represents a made instance of FetchStreamSpec
 */
declare class FetchStreamSpec extends Obj {
  ...
  withOrder(order: string | null): FetchStreamSpec;

  /**
   * Offset to use for paged reads.
   */
  readonly offset?: number | null;
  withOffset(offset: number | null): FetchStreamSpec;
  ...
  withLimit(limit: number | null): FetchStreamSpec;
  ...
  withFilter(filter: string | null): FetchStreamSpec;

  /**
   * Variables values to substitute in filter expression. CURRENTLY UNDER CONSTRUCTION!
   */
  readonly vars?: C3.Map<string | null, Obj | null>;
  withVars(vars: C3.Map<string | null, Obj | null> | {[key: string | null]: IObj | null}): FetchStreamSpec;
  ...
  withFetchHiddenSeedData(fetchHiddenSeedData: boolean): FetchStreamSpec;
  ...
  withExcludeExtensions(excludeExtensions: boolean): FetchStreamSpec;
  ...
  withAsOf(asOf: DateTime | Date | string | null): FetchStreamSpec;
  ...
  withAllowLiteralOnBindVariableOverflow(allowLiteralOnBindVariableOverflow: boolean): FetchStreamSpec;
  ...
  withUseDedicatedConnection(useDedicatedConnection: boolean): FetchStreamSpec;
  ...
  withStmtTimeoutMs(stmtTimeoutMs: number | null): FetchStreamSpec;
  ...
  withDontThrowJsonDeserErrors(dontThrowJsonDeserErrors: boolean): FetchStreamSpec;
  ...
  withTimeRange(timeRange: ITimeRange | null): FetchStreamSpec;
  ...
  withTimedFetchParentField(timedFetchParentField: string | null): FetchStreamSpec;

  readonly includeBaseTypes?: boolean;
  withIncludeBaseTypes(includeBaseTypes: boolean): FetchStreamSpec;
  ...
  withIgnoreViewInclude(ignoreViewInclude: boolean): FetchStreamSpec;
  ...
  withInclude(include: string | null): FetchStreamSpec;
  ...
  withExcludeMeta(excludeMeta: boolean): FetchStreamSpec;
  ...
  withIncludeReadCalcs(includeReadCalcs: boolean): FetchStreamSpec;
  ...
  withRefreshCalcFields(refreshCalcFields: boolean): FetchStreamSpec;
  ...
  withCalcFieldsToRefresh(calcFieldsToRefresh: C3.Array<string | null> | Array<string | null>): FetchStreamSpec;
  ...
  withForceAcl(forceAcl: boolean): FetchStreamSpec;
  ...
  withExplain(explain: boolean): FetchStreamSpec;
  ...
  withValidateOnly(validateOnly: boolean): FetchStreamSpec;
  ...
  withHints(hints: IFetchHints | null): FetchStreamSpec;
  ...
  withUseSecondaryDatastore(useSecondaryDatastore: boolean): FetchStreamSpec;
  ...
  withPreserveArrayIndexes(preserveArrayIndexes: boolean): FetchStreamSpec;
  ...
  withResolveRefTypes(resolveRefTypes: boolean): FetchStreamSpec;

  /**
   * Ids that will be added to the filter.  If {@link idsField} is specified they will be applied as a filter to that
   * field, otherwise they will be applied to the "id" field.
   */
  readonly ids?: Stream<string | null>;
  withIds(ids: Stream<string | null> | Array<string | null>): FetchStreamSpec;

  /**
   * If {@link ids} is specified, the field that the ids will be applied to as a filter.  Default is "id".
   */
  readonly idsField?: string | null;
  withIdsField(idsField: string | null): FetchStreamSpec;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): FetchStreamSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): FetchStreamSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): FetchStreamSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): FetchStreamSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): FetchStreamSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FetchStreamSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FetchStreamSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FetchStreamSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FetchStreamSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): FetchStreamSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FetchStreamSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FetchStreamSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FetchStreamSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FetchStreamSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FetchStreamSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): FetchStreamSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FetchStreamSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FetchStreamSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): FetchStreamSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): FetchStreamSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): FetchStreamSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): FetchStreamSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FetchStreamSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): FetchStreamSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FetchStreamSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FetchStreamSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): FetchStreamSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FetchStreamSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): FetchStreamSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FetchStreamSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): FetchStreamSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): FetchStreamSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): FetchStreamSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): FetchStreamSpec;

  mergeJson(json: any | null): FetchStreamSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): FetchStreamSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): FetchStreamSpec;
   ...
   */
  singletonArray(): C3.Array<FetchStreamSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<FetchStreamSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FetchStreamSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<FetchStreamSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FetchStreamSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, FetchStreamSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FetchStreamSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FetchStreamSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FetchStreamSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): FetchStreamSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): FetchStreamSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): FetchStreamSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FetchStreamSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): FetchStreamSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FetchStreamSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): FetchStreamSpec;
   ...
   */
  static cachedEmptyInst(): FetchStreamSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<FetchStreamSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): FetchStreamSpec;
   ...
   */
  withIdFilter(id: string): FetchStreamSpec | null;
   ...
   * @return updated FetchSpec
   */
  withIdsFilter(ids: C3.Array<string | null> | null): FetchStreamSpec | null;
   ...
   * @return updated FetchSpec
   */
  withIdRangeFilter(startId?: string | null, endId?: string | null): FetchStreamSpec | null;
