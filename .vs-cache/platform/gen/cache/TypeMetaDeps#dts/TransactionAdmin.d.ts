// TypeScript definitions for the C3 type TransactionAdmin

/**
 * expose the functions to the generic editor
 *
 * @remarks this represents a value passed to a method that expects an instance of TransactionAdmin
 */
declare interface ITransactionAdmin {
 ...
 * expose the functions to the generic editor
 *
 * @remarks this represents a made instance of TransactionAdmin
 */
declare class TransactionAdmin extends Obj {
   ...
   */
  readonly id: string;
  withId(id: string): TransactionAdmin;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): TransactionAdmin;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): TransactionAdmin;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): TransactionAdmin;
  ...
  withVersion(version: number | null): TransactionAdmin;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): TransactionAdmin;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TransactionAdmin | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TransactionAdmin | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TransactionAdmin | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TransactionAdmin | null;
   ...
   */
  replaceType(old: Type, new_: Type): TransactionAdmin;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TransactionAdmin;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TransactionAdmin;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TransactionAdmin | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TransactionAdmin | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TransactionAdmin;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TransactionAdmin;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TransactionAdmin;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TransactionAdmin;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TransactionAdmin;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TransactionAdmin;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TransactionAdmin;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TransactionAdmin;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TransactionAdmin;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TransactionAdmin;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TransactionAdmin;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TransactionAdmin;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TransactionAdmin;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TransactionAdmin;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TransactionAdmin;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TransactionAdmin;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TransactionAdmin;
   ...
   * @see #removeField
   */
  unsetField(field: string): TransactionAdmin;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TransactionAdmin;
   ...
   * @see #unsetField
   */
  removeField(field: string): TransactionAdmin;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TransactionAdmin;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TransactionAdmin;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TransactionAdmin;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TransactionAdmin;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TransactionAdmin;

  mergeJson(json: any | null): TransactionAdmin;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TransactionAdmin;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TransactionAdmin;
   ...
   */
  singletonArray(): C3.Array<TransactionAdmin | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TransactionAdmin | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TransactionAdmin | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TransactionAdmin | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TransactionAdmin | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TransactionAdmin | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TransactionAdmin | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TransactionAdmin | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TransactionAdmin | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TransactionAdmin;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TransactionAdmin;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TransactionAdmin;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TransactionAdmin;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TransactionAdmin;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TransactionAdmin;
   ...
   * @see #fromString
   */
  static make(s: string | null): TransactionAdmin | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TransactionAdmin;
   ...
   */
  static cachedEmptyInst(): TransactionAdmin;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TransactionAdmin>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TransactionAdmin;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TransactionAdmin | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TransactionAdmin | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TransactionAdmin | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TransactionAdmin | null> | null>;
   ...
   */
  get(include?: string | null): TransactionAdmin | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TransactionAdmin | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TransactionAdmin;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TransactionAdmin | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TransactionAdmin;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TransactionAdmin | null;
   ...
   */
  create(spec?: UpsertSpec | null): TransactionAdmin | null;
   ...
   */
  static createBatch(objs: C3.Array<TransactionAdmin | null> | null, spec?: UpsertSpec | null): ObjList<TransactionAdmin | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TransactionAdmin | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TransactionAdmin | null> | null;
   ...
   */
  update(srcObj?: TransactionAdmin | null, spec?: UpsertSpec | null): TransactionAdmin | null;
   ...
   */
  upsert(srcObj?: TransactionAdmin | null, spec?: UpsertSpec | null): TransactionAdmin | null;
   ...
   */
  merge(spec?: MergeSpec | null): TransactionAdmin | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TransactionAdmin | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TransactionAdmin | null;
   ...
   */
  static updateBatch(objs: C3.Array<TransactionAdmin | null> | null, srcObjs?: C3.Array<TransactionAdmin | null>, spec?: UpsertSpec | null): ObjList<TransactionAdmin | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TransactionAdmin | null>>, spec?: UpsertSpec | null): ObjList<TransactionAdmin | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TransactionAdmin | null> | null, srcObjs?: C3.Array<TransactionAdmin | null>, spec?: UpsertSpec | null): ObjList<TransactionAdmin | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TransactionAdmin | null>>, spec?: UpsertSpec | null): ObjList<TransactionAdmin | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TransactionAdmin | null> | null, spec?: TouchSpec | null): ObjList<TransactionAdmin | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TransactionAdmin | null> | null, spec?: MergeSpec | null): ObjList<TransactionAdmin | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TransactionAdmin | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TransactionAdmin | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TransactionAdmin | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TransactionAdmin | null> | null;
   ...
   */
  static mergeAll(mergeObj: TransactionAdmin | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TransactionAdmin | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TransactionAdmin | null> | null, spec?: UpsertSpec | null): ObjList<TransactionAdmin | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TransactionAdmin | null> | null, spec?: UpsertSpec | null): ObjList<TransactionAdmin | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TransactionAdmin | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TransactionAdmin | null> | null): ObjList<TransactionAdmin | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TransactionAdmin | null> | null): ObjList<TransactionAdmin | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TransactionAdmin | null> | null): ObjList<TransactionAdmin | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TransactionAdmin | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TransactionAdmin | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TransactionAdmin | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TransactionAdmin | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TransactionAdmin | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TransactionAdmin | null;
   ...
   */
  withoutIdentity(): TransactionAdmin | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<TransactionAdmin | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TransactionAdmin | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TransactionAdmin | null> | null, callback?: λFunction<TransactionAdmin | null, TransactionAdmin | null> | null): ObjList<TransactionAdmin | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TransactionAdmin | null> | null, callback?: λFunction<TransactionAdmin | null, TransactionAdmin | null> | null): C3.Array<ObjError | null>;
  ...
  static count(): number | null;

  static redo(): number | null;

  static clean(): number | null;
}
