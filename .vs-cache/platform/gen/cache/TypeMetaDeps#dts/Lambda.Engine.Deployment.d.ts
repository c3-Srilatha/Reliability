// TypeScript definitions for the C3 type Lambda.Engine.Deployment

/**
 * @remarks this represents a value passed to a method that expects an instance of Lambda.Engine.Deployment
 */
declare namespace Lambda.Engine {
  export interface IDeployment {
     ...
     */
    exec?: ILambda<FunctionType | null> | null;
     ...
     */
    onThreadStart?: ILambda<FunctionType | null> | null;

    /**
     * Callback when dedicated thread of this Lambda.Engine is stopped.
     */
    onThreadStop?: ILambda<FunctionType | null> | null;
...
declare namespace Lambda.Engine {
  export class Deployment extends Obj {
    ...
    withName(name: string): Lambda.Engine.Deployment;
    ...
    withNodeRole(nodeRole: string | null): Lambda.Engine.Deployment;
    ...
    withAltNodeRoles(altNodeRoles: C3.Array<string | null> | Array<string | null>): Lambda.Engine.Deployment;
    ...
    withNodePools(nodePools: C3.Array<string | null> | Array<string | null>): Lambda.Engine.Deployment;
    ...
    withDedicatedThreadPool(dedicatedThreadPool: boolean): Lambda.Engine.Deployment;

    /**
     * If set to `true` then this {@link Engine} will auto start on every node of every target node-pool.
     */
    readonly autoStart?: boolean;
    withAutoStart(autoStart: boolean): Lambda.Engine.Deployment;
    ...
    withInactive(inactive: boolean): Lambda.Engine.Deployment;
    ...
    withFailActionIfEngineNotReady(failActionIfEngineNotReady: boolean): Lambda.Engine.Deployment;
    ...
    withInitializingNodeAvoidanceDuration(initializingNodeAvoidanceDuration: string | null): Lambda.Engine.Deployment;

    /**
     * Lambda implementing core logic of a Lambda.Engine
     */
    readonly exec?: Lambda<FunctionType | null> | null;
    withExec(exec: ILambda<FunctionType | null> | null): Lambda.Engine.Deployment;
     ...
     * @see Lambda.Engine#get
     */
    readonly onStart?: Lambda<FunctionType | null> | null;
    withOnStart(onStart: ILambda<FunctionType | null> | null): Lambda.Engine.Deployment;

    /**
     * Callback on Lambda.Engine stop; will be called on each node where engine runs
     */
    readonly onStop?: Lambda<FunctionType | null> | null;
    withOnStop(onStop: ILambda<FunctionType | null> | null): Lambda.Engine.Deployment;

    /**
     * Callback on Lambda.Engine deployment update; will be called on each node where engine runs
     */
    readonly onUpdate?: Lambda<FunctionType | null> | null;
    withOnUpdate(onUpdate: ILambda<FunctionType | null> | null): Lambda.Engine.Deployment;
     ...
     * @see App.Node.Thread#get
     */
    readonly onThreadStart?: Lambda<FunctionType | null> | null;
    withOnThreadStart(onThreadStart: ILambda<FunctionType | null> | null): Lambda.Engine.Deployment;

    /**
     * Callback when dedicated thread of this Lambda.Engine is stopped.
     */
    readonly onThreadStop?: Lambda<FunctionType | null> | null;
    withOnThreadStop(onThreadStop: ILambda<FunctionType | null> | null): Lambda.Engine.Deployment;

    readonly configOverride?: string | null;
    withConfigOverride(configOverride: string | null): Lambda.Engine.Deployment;

    readonly secretOverride?: string | null;
    withSecretOverride(secretOverride: string | null): Lambda.Engine.Deployment;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: C3.Array<string | null>;
    withIssues(issues: C3.Array<string | null> | Array<string | null>): Lambda.Engine.Deployment;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Lambda.Engine.Deployment | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Lambda.Engine.Deployment | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Lambda.Engine.Deployment | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Lambda.Engine.Deployment | null;
     ...
     */
    replaceType(old: Type, new_: Type): Lambda.Engine.Deployment;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Lambda.Engine.Deployment;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Lambda.Engine.Deployment;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Lambda.Engine.Deployment | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Lambda.Engine.Deployment | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Lambda.Engine.Deployment;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Lambda.Engine.Deployment;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Lambda.Engine.Deployment;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Lambda.Engine.Deployment;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Lambda.Engine.Deployment;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Lambda.Engine.Deployment;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Lambda.Engine.Deployment;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Lambda.Engine.Deployment;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Lambda.Engine.Deployment;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Lambda.Engine.Deployment;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Lambda.Engine.Deployment;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Lambda.Engine.Deployment;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Lambda.Engine.Deployment;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Lambda.Engine.Deployment;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Lambda.Engine.Deployment;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Lambda.Engine.Deployment;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Lambda.Engine.Deployment;
     ...
     * @see #removeField
     */
    unsetField(field: string): Lambda.Engine.Deployment;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Lambda.Engine.Deployment;
     ...
     * @see #unsetField
     */
    removeField(field: string): Lambda.Engine.Deployment;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Lambda.Engine.Deployment;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Lambda.Engine.Deployment;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Lambda.Engine.Deployment;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Lambda.Engine.Deployment;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Lambda.Engine.Deployment;

    mergeJson(json: any | null): Lambda.Engine.Deployment;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Lambda.Engine.Deployment;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Lambda.Engine.Deployment;
     ...
     */
    singletonArray(): C3.Array<Lambda.Engine.Deployment | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Lambda.Engine.Deployment | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Lambda.Engine.Deployment | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Lambda.Engine.Deployment | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Lambda.Engine.Deployment | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Lambda.Engine.Deployment | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Lambda.Engine.Deployment | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Lambda.Engine.Deployment | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Lambda.Engine.Deployment | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Lambda.Engine.Deployment;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Lambda.Engine.Deployment;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Lambda.Engine.Deployment;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Lambda.Engine.Deployment;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Lambda.Engine.Deployment;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Lambda.Engine.Deployment;
     ...
     * @see #fromString
     */
    static make(s: string | null): Lambda.Engine.Deployment | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Lambda.Engine.Deployment;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Lambda.Engine.Deployment;
     ...
     */
    static cachedEmptyInst(): Lambda.Engine.Deployment;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Lambda.Engine.Deployment>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Lambda.Engine.Deployment;
     ...
     * @see #toString
     */
    static fromString(s: string | null): Lambda.Engine.Deployment | null;
     ...
     */
    static forName(name: string | null, failIfMissing?: boolean): Lambda.Engine.Deployment | null;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<Lambda.Engine.Deployment | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<Lambda.Engine.Deployment | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<Lambda.Engine.Deployment | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): Lambda.Engine.Deployment | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string | null): Lambda.Engine.Deployment | null;
     ...
     * @see findByCacheKey
     */
    getCached(): Lambda.Engine.Deployment | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): Lambda.Engine.Deployment | null;
     ...
     */
    static produce(key: string): Lambda.Engine.Deployment | null;
     ...
     */
    static produceAll(): C3.Map<string | null, Lambda.Engine.Deployment | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, Lambda.Engine.Deployment | null>;
     ...
     */
    getConfig(): Lambda.Engine.Deployment;
     ...
     */
    getSecret(): Lambda.Engine.Deployment;
     ...
     */
    static forConfigKey(configKey: string | null): Lambda.Engine.Deployment | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<Lambda.Engine.Deployment | null>;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Lambda.Engine.Deployment, override?: string | null): void;
     ...
     * @see setSecretValue
     */
    setSecretValues(from: Lambda.Engine.Deployment, override?: string | null): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Lambda.Engine.Deployment | null;
     ...
     */
    static fromDeploySpec(spec: Engine.DeploySpec): Lambda.Engine.Deployment | null;
  }
}
