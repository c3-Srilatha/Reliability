// TypeScript definitions for the C3 type ContainerRegistry

/**
 * Registry to store and retrieve docker images (C3 server and other C3 artifacts).
 *
 * @remarks this represents a value passed to a method that expects an instance of ContainerRegistry
 */
declare interface IContainerRegistry {
 ...
 */
declare class ContainerRegistry extends Obj {

  /**
   * The unique and required name of this instance.
   */
  readonly name: string;
  withName(name: string): ContainerRegistry;
  ...
  withUrl(url: string | null): ContainerRegistry;
  ...
  withAuth(auth: string | null): ContainerRegistry;

  static readonly auth?: string | null;

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): ContainerRegistry;

  static readonly configOverride?: string | null;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): ContainerRegistry;
  ...
  withIssues(issues: C3.Array<string | null> | Array<string | null>): ContainerRegistry;
  ...
  withUsername(username: string | null): ContainerRegistry;
  ...
  withPassword(password: string | null): ContainerRegistry;
  ...
  withSecretKey(secretKey: string | null): ContainerRegistry;
  ...
  withProperties(properties: C3.Map<string | null, any> | {[key: string | null]: any}): ContainerRegistry;
  ...
  withSecretProperties(secretProperties: C3.Map<string | null, any> | {[key: string | null]: any}): ContainerRegistry;
  ...
  withServerEndpoint(serverEndpoint: string | null): ContainerRegistry;
  ...
  withPort(port: number | null): ContainerRegistry;
   ...
   */
  readonly id: string;
  withId(id: string): ContainerRegistry;
  ...
  withDEFAULT_NAME(DEFAULT_NAME: string | null): ContainerRegistry;

  static readonly DEFAULT_NAME?: string | null;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ContainerRegistry | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ContainerRegistry | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ContainerRegistry | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ContainerRegistry | null;
   ...
   */
  replaceType(old: Type, new_: Type): ContainerRegistry;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): ContainerRegistry;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ContainerRegistry;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ContainerRegistry;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ContainerRegistry;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ContainerRegistry;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ContainerRegistry | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ContainerRegistry | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ContainerRegistry | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ContainerRegistry | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ContainerRegistry;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ContainerRegistry;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ContainerRegistry;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ContainerRegistry;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ContainerRegistry;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ContainerRegistry;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ContainerRegistry;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): ContainerRegistry;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ContainerRegistry;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): ContainerRegistry;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ContainerRegistry;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): ContainerRegistry;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ContainerRegistry;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ContainerRegistry;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ContainerRegistry;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ContainerRegistry;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ContainerRegistry;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): ContainerRegistry;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ContainerRegistry;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): ContainerRegistry;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ContainerRegistry;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): ContainerRegistry;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ContainerRegistry;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): ContainerRegistry;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ContainerRegistry;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ContainerRegistry;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ContainerRegistry;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): ContainerRegistry;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ContainerRegistry;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ContainerRegistry;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ContainerRegistry;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): ContainerRegistry;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ContainerRegistry;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): ContainerRegistry;
   ...
   * @see #removeField
   */
  unsetField(field: string): ContainerRegistry;
   ...
   * @see #removeField
   */
  static unsetField(field: string): ContainerRegistry;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ContainerRegistry;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): ContainerRegistry;
   ...
   * @see #unsetField
   */
  removeField(field: string): ContainerRegistry;
   ...
   * @see #unsetField
   */
  static removeField(field: string): ContainerRegistry;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ContainerRegistry;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): ContainerRegistry;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ContainerRegistry;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ContainerRegistry;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ContainerRegistry;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): ContainerRegistry;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ContainerRegistry;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ContainerRegistry;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ContainerRegistry;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ContainerRegistry;

  mergeJson(json: any | null): ContainerRegistry;

  static mergeJson(json: any | null): ContainerRegistry;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ContainerRegistry;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ContainerRegistry;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ContainerRegistry;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): ContainerRegistry;
   ...
   */
  singletonArray(): C3.Array<ContainerRegistry | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<ContainerRegistry | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ContainerRegistry | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ContainerRegistry | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ContainerRegistry | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<ContainerRegistry | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ContainerRegistry | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ContainerRegistry | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ContainerRegistry | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ContainerRegistry | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<ContainerRegistry | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ContainerRegistry | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ContainerRegistry;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ContainerRegistry;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ContainerRegistry;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ContainerRegistry;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ContainerRegistry;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ContainerRegistry;
   ...
   * @see #fromString
   */
  static make(s: string | null): ContainerRegistry | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ContainerRegistry;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): ContainerRegistry;
   ...
   */
  static cachedEmptyInst(): ContainerRegistry;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ContainerRegistry>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ContainerRegistry;
   ...
   * @see #toString
   */
  static fromString(s: string | null): ContainerRegistry | null;
   ...
   */
  static forName(name: string | null, failIfMissing?: boolean): ContainerRegistry | null;
   ...
   */
  config(secrets?: boolean): ContainerRegistry.Config;
   ...
   * @return instance of configuration - never `null`.
   */
  static config(secrets?: boolean): ContainerRegistry.Config;
   ...
   */
  static typeConfig(): ContainerRegistry.Config;
   ...
   * @return raw json response or null (if Content-Type is not application/json) from the api
   */
  static callJson(action: string, ...args: any[]): any | null;
   ...
   * @return raw json response or null (if Content-Type is not application/json) from the api
   */
  static callJsonApi(httpMethod: string, encodedPath: string, request?: any | null, httpHeaders?: C3.Map<string | null, string | null>): any | null;
   ...
   * generate the OAuth 2.0 token for the specified scopes
   */
  static generateOAuthToken(oAuthScope?: C3.Array<string>): string | null;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<ContainerRegistry | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<ContainerRegistry | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ContainerRegistry | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): ContainerRegistry | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): ContainerRegistry | null;
   ...
   * @see findByCacheKey
   */
  getCached(): ContainerRegistry | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): ContainerRegistry | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): ContainerRegistry | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): ContainerRegistry | null;
   ...
   */
  static produce(key: string): ContainerRegistry | null;
   ...
   */
  static produceAll(): C3.Map<string | null, ContainerRegistry | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, ContainerRegistry | null>;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): ContainerRegistry;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): ContainerRegistry;
   ...
   */
  static forConfigKey(configKey: string | null): ContainerRegistry | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<ContainerRegistry | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: ContainerRegistry, override?: string | null): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: ContainerRegistry, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: ContainerRegistry, override?: string | null): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: ContainerRegistry, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): ContainerRegistry | null;
   ...
   */
  removeSecrets(): ContainerRegistry | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): ContainerRegistry | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): ContainerRegistry | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): ContainerRegistry | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): ContainerRegistry;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): ContainerRegistry;
   ...
   * Password of the user.
   */
  static passwordSecret(): string | null;

  /**
   * Password of the user.
   */
  setPasswordSecret(password: string | null): void;

  /**
   * Password of the user.
   */
  static setPasswordSecret(password: string | null): void;

  /**
   * Secret key of the user/account.
   */
  setSecretKey(password: string | null): void;

  /**
   * Secret key of the user/account.
   */
  static setSecretKey(password: string | null): void;

  /**
   * @return single instance of this Identified type by id.
   */
  static forId(id: string | null, failIfMissing?: boolean): ContainerRegistry | null;
   ...
   */
  static inst(): ContainerRegistry;

  tagExist(repository: string, imagetag: string, accessToken: string): HttpResponse | null;

  static tagExist(repository: string, imagetag: string, accessToken: string): HttpResponse | null;
}
