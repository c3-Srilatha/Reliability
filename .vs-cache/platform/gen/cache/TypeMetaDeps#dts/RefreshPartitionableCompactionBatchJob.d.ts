// TypeScript definitions for the C3 type RefreshPartitionableCompactionBatchJob

/**
 * Batch job definitions for batch jobs started for compacting Partitionable types for asynchronous processing.
 *
 * @remarks this represents a value passed to a method that expects an instance of RefreshPartitionableCompactionBatchJob
 */
declare interface IRefreshPartitionableCompactionBatchJob {

  /**
   * current or last job execution for this instance
   */
  run?: IBatchJobRun | null;

  /**
   * previous job executions for this instance
   */
  runs?: C3.Array<BatchJobRun | null> | Array<IBatchJobRun | null>;
 ...
 */
declare class RefreshPartitionableCompactionBatchJob extends Obj {

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun | null;
  withRun(run: IBatchJobRun | null): RefreshPartitionableCompactionBatchJob;

  /**
   * previous job executions for this instance
   */
  readonly runs?: C3.Array<BatchJobRun | null>;
  withRuns(runs: C3.Array<BatchJobRun | null> | Array<IBatchJobRun | null>): RefreshPartitionableCompactionBatchJob;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj | null;
  withOptions(options: IObj | null): RefreshPartitionableCompactionBatchJob;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): RefreshPartitionableCompactionBatchJob;
  ...
  withPriority(priority: number | null): RefreshPartitionableCompactionBatchJob;
  ...
  withDisabled(disabled: boolean): RefreshPartitionableCompactionBatchJob;
  ...
  withMaxConcurrency(maxConcurrency: number | null): RefreshPartitionableCompactionBatchJob;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): RefreshPartitionableCompactionBatchJob;
  ...
  withRunAsUser(runAsUser: boolean | null): RefreshPartitionableCompactionBatchJob;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string | null;
  withNodePool(nodePool: string | null): RefreshPartitionableCompactionBatchJob;
  ...
  withSkipIfRunning(skipIfRunning: boolean | null): RefreshPartitionableCompactionBatchJob;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number | null;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): RefreshPartitionableCompactionBatchJob;
  ...
  withPropagateActionContext(propagateActionContext: boolean): RefreshPartitionableCompactionBatchJob;
  ...
  withTypeIdent(typeIdent: string | null): RefreshPartitionableCompactionBatchJob;
   ...
   */
  readonly id: string;
  withId(id: string): RefreshPartitionableCompactionBatchJob;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): RefreshPartitionableCompactionBatchJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): RefreshPartitionableCompactionBatchJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): RefreshPartitionableCompactionBatchJob;
  ...
  withVersion(version: number | null): RefreshPartitionableCompactionBatchJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): RefreshPartitionableCompactionBatchJob;
  ...
  withAbortOnError(abortOnError: boolean): RefreshPartitionableCompactionBatchJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): RefreshPartitionableCompactionBatchJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): RefreshPartitionableCompactionBatchJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): RefreshPartitionableCompactionBatchJob | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): RefreshPartitionableCompactionBatchJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): RefreshPartitionableCompactionBatchJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): RefreshPartitionableCompactionBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): RefreshPartitionableCompactionBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<RefreshPartitionableCompactionBatchJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<RefreshPartitionableCompactionBatchJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): RefreshPartitionableCompactionBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RefreshPartitionableCompactionBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RefreshPartitionableCompactionBatchJob;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): RefreshPartitionableCompactionBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): RefreshPartitionableCompactionBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): RefreshPartitionableCompactionBatchJob;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): RefreshPartitionableCompactionBatchJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): RefreshPartitionableCompactionBatchJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): RefreshPartitionableCompactionBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): RefreshPartitionableCompactionBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): RefreshPartitionableCompactionBatchJob;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): RefreshPartitionableCompactionBatchJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): RefreshPartitionableCompactionBatchJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): RefreshPartitionableCompactionBatchJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): RefreshPartitionableCompactionBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): RefreshPartitionableCompactionBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): RefreshPartitionableCompactionBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): RefreshPartitionableCompactionBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): RefreshPartitionableCompactionBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): RefreshPartitionableCompactionBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): RefreshPartitionableCompactionBatchJob;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): RefreshPartitionableCompactionBatchJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): RefreshPartitionableCompactionBatchJob;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): RefreshPartitionableCompactionBatchJob;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): RefreshPartitionableCompactionBatchJob;

  mergeJson(json: any | null): RefreshPartitionableCompactionBatchJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): RefreshPartitionableCompactionBatchJob;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): RefreshPartitionableCompactionBatchJob;
   ...
   */
  singletonArray(): C3.Array<RefreshPartitionableCompactionBatchJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<RefreshPartitionableCompactionBatchJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<RefreshPartitionableCompactionBatchJob | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<RefreshPartitionableCompactionBatchJob | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<RefreshPartitionableCompactionBatchJob | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, RefreshPartitionableCompactionBatchJob | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, RefreshPartitionableCompactionBatchJob | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<RefreshPartitionableCompactionBatchJob | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<RefreshPartitionableCompactionBatchJob | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): RefreshPartitionableCompactionBatchJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): RefreshPartitionableCompactionBatchJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): RefreshPartitionableCompactionBatchJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): RefreshPartitionableCompactionBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): RefreshPartitionableCompactionBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): RefreshPartitionableCompactionBatchJob;
   ...
   * @see #fromString
   */
  static make(s: string | null): RefreshPartitionableCompactionBatchJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): RefreshPartitionableCompactionBatchJob;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): RefreshPartitionableCompactionBatchJob;
   ...
   */
  static cachedEmptyInst(): RefreshPartitionableCompactionBatchJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<RefreshPartitionableCompactionBatchJob>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): RefreshPartitionableCompactionBatchJob;
   ...
   */
  start(options?: RefreshPartitionableCompactionSpec | null): BatchJobStatus | null;
   ...
   */
  cleanup(options?: RefreshPartitionableCompactionSpec | null): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun | null, BatchJobStatus | null, RefreshPartitionableCompactionSpec | null> | null;

  failJob(run: JobRun<BatchJobStatusBase | null>): JobBase<BatchJobRun | null, BatchJobStatus | null, RefreshPartitionableCompactionSpec | null> | null;
  ...
  validateStart(options?: RefreshPartitionableCompactionSpec | null): void;

  updateJobState(): boolean;

  removeResults(run: BatchJobRun): void;

  static cancelJobQueueEntry(run?: BatchJobRun | null, entry?: InvalidationQueueEntry<any> | null): void;

  startContext(): string | null;

  startStep(): string | null;

  createRun(status?: BatchJobStatus | null, startingActionId?: string | null): BatchJobRun | null;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<RefreshPartitionableCompactionBatchJob | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<RefreshPartitionableCompactionBatchJob | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<RefreshPartitionableCompactionBatchJob | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<RefreshPartitionableCompactionBatchJob | null> | null>;
   ...
   */
  get(include?: string | null): RefreshPartitionableCompactionBatchJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): RefreshPartitionableCompactionBatchJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): RefreshPartitionableCompactionBatchJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): RefreshPartitionableCompactionBatchJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): RefreshPartitionableCompactionBatchJob;
   ...
   * @see #toString
   */
  static fromString(s: string | null): RefreshPartitionableCompactionBatchJob | null;
   ...
   */
  create(spec?: UpsertSpec | null): RefreshPartitionableCompactionBatchJob | null;
   ...
   */
  static createBatch(objs: C3.Array<RefreshPartitionableCompactionBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<RefreshPartitionableCompactionBatchJob | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<RefreshPartitionableCompactionBatchJob | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<RefreshPartitionableCompactionBatchJob | null> | null;
   ...
   */
  update(srcObj?: RefreshPartitionableCompactionBatchJob | null, spec?: UpsertSpec | null): RefreshPartitionableCompactionBatchJob | null;
   ...
   */
  upsert(srcObj?: RefreshPartitionableCompactionBatchJob | null, spec?: UpsertSpec | null): RefreshPartitionableCompactionBatchJob | null;
   ...
   */
  merge(spec?: MergeSpec | null): RefreshPartitionableCompactionBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): RefreshPartitionableCompactionBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): RefreshPartitionableCompactionBatchJob | null;
   ...
   */
  static updateBatch(objs: C3.Array<RefreshPartitionableCompactionBatchJob | null> | null, srcObjs?: C3.Array<RefreshPartitionableCompactionBatchJob | null>, spec?: UpsertSpec | null): ObjList<RefreshPartitionableCompactionBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<RefreshPartitionableCompactionBatchJob | null>>, spec?: UpsertSpec | null): ObjList<RefreshPartitionableCompactionBatchJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<RefreshPartitionableCompactionBatchJob | null> | null, srcObjs?: C3.Array<RefreshPartitionableCompactionBatchJob | null>, spec?: UpsertSpec | null): ObjList<RefreshPartitionableCompactionBatchJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<RefreshPartitionableCompactionBatchJob | null>>, spec?: UpsertSpec | null): ObjList<RefreshPartitionableCompactionBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<RefreshPartitionableCompactionBatchJob | null> | null, spec?: TouchSpec | null): ObjList<RefreshPartitionableCompactionBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<RefreshPartitionableCompactionBatchJob | null> | null, spec?: MergeSpec | null): ObjList<RefreshPartitionableCompactionBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<RefreshPartitionableCompactionBatchJob | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<RefreshPartitionableCompactionBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<RefreshPartitionableCompactionBatchJob | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<RefreshPartitionableCompactionBatchJob | null> | null;
   ...
   */
  static mergeAll(mergeObj: RefreshPartitionableCompactionBatchJob | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: RefreshPartitionableCompactionBatchJob | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<RefreshPartitionableCompactionBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<RefreshPartitionableCompactionBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<RefreshPartitionableCompactionBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<RefreshPartitionableCompactionBatchJob | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): RefreshPartitionableCompactionBatchJob | null;
   ...
   */
  static beforeCreate(objs: C3.Array<RefreshPartitionableCompactionBatchJob | null> | null): ObjList<RefreshPartitionableCompactionBatchJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<RefreshPartitionableCompactionBatchJob | null> | null): ObjList<RefreshPartitionableCompactionBatchJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<RefreshPartitionableCompactionBatchJob | null> | null): ObjList<RefreshPartitionableCompactionBatchJob | null>;
   ...
   */
  static afterCreate(objs: C3.Array<RefreshPartitionableCompactionBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<RefreshPartitionableCompactionBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<RefreshPartitionableCompactionBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<RefreshPartitionableCompactionBatchJob | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<RefreshPartitionableCompactionBatchJob | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): RefreshPartitionableCompactionBatchJob | null;
   ...
   */
  withoutIdentity(): RefreshPartitionableCompactionBatchJob | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<RefreshPartitionableCompactionBatchJob | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: RefreshPartitionableCompactionBatchJob | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<RefreshPartitionableCompactionBatchJob | null> | null, callback?: λFunction<RefreshPartitionableCompactionBatchJob | null, RefreshPartitionableCompactionBatchJob | null> | null): ObjList<RefreshPartitionableCompactionBatchJob | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<RefreshPartitionableCompactionBatchJob | null> | null, callback?: λFunction<RefreshPartitionableCompactionBatchJob | null, RefreshPartitionableCompactionBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static doStart(job?: RefreshPartitionableCompactionBatchJob | null, options?: RefreshPartitionableCompactionSpec | null): void;
   ...
   */
  static processBatch(batch?: RefreshPartitionableCompactionSpec | null, job?: RefreshPartitionableCompactionBatchJob | null, options?: RefreshPartitionableCompactionSpec | null): void;
   ...
   */
  static allComplete(job: RefreshPartitionableCompactionBatchJob, options?: RefreshPartitionableCompactionSpec | null): string | null;
   ...
   *           Options the job was run with.
   */
  static failed(job: RefreshPartitionableCompactionBatchJob, status: BatchJobStatus, options?: RefreshPartitionableCompactionSpec | null): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: RefreshPartitionableCompactionSpec | null): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: C3.Array<RefreshPartitionableCompactionSpec | null>): void;
   ...
   */
  static scheduleObjBatch(job?: RefreshPartitionableCompactionBatchJob | null, objBatch?: ObjBatch | null, logPrefix?: string | null): number | null;
   ...
   *           New subBatchSize
   */
  setSubBatchSize(subBatchSize?: number | null): void;

  /**
   * BatchJob engine provided internal actions
   */
  static dispatchDoStart(jobId?: string | null): void;

  static dispatchProcessBatch(jobId?: string | null, context?: string | null): void;
   ...
   */
  static refresh(spec: ObjBatch): number;
   ...
   * @return The number of objs refreshed.
   */
  static refreshIds(type: Type, spec: ObjBatch, ids?: C3.Array<string | null>): number;

  /**
   * @return The DataIssue type associated with the batch job, if any.
   */
  static issueType(): Type | null;
   ...
   */
  static clearIssuesForIds(type: Type, issueType: Type, ids: C3.Array<string | null> | null, fields?: C3.Array<string | null>): void;
   ...
   *        DataIssueType to clear.
   */
  static clearIssuesForType(type: Type, issueType: Type): void;
   ...
   *        Spec for batch job.
   */
  static scheduleBatchesForAppRebuilder(appRebuilder: AppRebuilder, spec: ObjBatch): void;
}
