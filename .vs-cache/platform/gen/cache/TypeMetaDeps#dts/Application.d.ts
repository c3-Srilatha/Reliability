// TypeScript definitions for the C3 type Application

/**
 * An application is used to provide access control for a logical application.
 * Note that the application definition itself is in UI metadata (application component).
 *
 * @remarks this represents a value passed to a method that expects an instance of Application
 */
 ...
 * Note that the application definition itself is in UI metadata (application component).
 *
 * @remarks this represents a made instance of Application
 */
declare class Application extends Obj {

  /**
   * List of {@link AclEntry} entries governing who can read/update/remove Objs.
   */
  readonly acl?: C3.Array<AclEntry | null>;
  withAcl(acl: C3.Array<AclEntry | null> | Array<IAclEntry | null>): Application;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Application;

  /**
   * Name of the Obj instance
   */
  readonly name: string;
  withName(name: string): Application;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): Application;
  ...
  withVersion(version: number | null): Application;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): Application;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Application | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Application | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Application | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Application | null;
   ...
   */
  replaceType(old: Type, new_: Type): Application;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Application;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Application;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Application | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Application | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Application;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Application;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Application;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): Application;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Application;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Application;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Application;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Application;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Application;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Application;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Application;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Application;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Application;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Application;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Application;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Application;
   ...
   * @see #removeField
   */
  unsetField(field: string): Application;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Application;
   ...
   * @see #unsetField
   */
  removeField(field: string): Application;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Application;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Application;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Application;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Application;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Application;

  mergeJson(json: any | null): Application;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Application;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Application;
   ...
   */
  singletonArray(): C3.Array<Application | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Application | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Application | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Application | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Application | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Application | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Application | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Application | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Application | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Application;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Application;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Application;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Application;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Application;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Application;
   ...
   * @see #fromString
   */
  static make(s: string | null): Application | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Application;
   ...
   */
  static cachedEmptyInst(): Application;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Application>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Application;
   ...
   */
  static populateAcl(objs?: C3.Array<Application | null>): number | null;
   ...
   */
  grantMemberReadUpdateRemove(member: AccessControlEntity): Application;
   ...
   */
  mergeAclEntry(entry: AclEntry): Application;
   ...
   * @return the obj with the new acl after merging the indicated entry.
   */
  mergeAclEntries(entries: C3.Array<AclEntry | null> | null): Application;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<Application | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<Application | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Application | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Application | null> | null>;
   ...
   */
  get(include?: string | null): Application | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): Application | null;
   ...
   */
  getMissing(spec: GetMissingSpec): Application;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): Application | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): Application;
   ...
   * @see #toString
   */
  static fromString(s: string | null): Application | null;
   ...
   */
  create(spec?: UpsertSpec | null): Application | null;
   ...
   */
  static createBatch(objs: C3.Array<Application | null> | null, spec?: UpsertSpec | null): ObjList<Application | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<Application | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Application | null> | null;
   ...
   */
  update(srcObj?: Application | null, spec?: UpsertSpec | null): Application | null;
   ...
   */
  upsert(srcObj?: Application | null, spec?: UpsertSpec | null): Application | null;
   ...
   */
  merge(spec?: MergeSpec | null): Application | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): Application | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): Application | null;
   ...
   */
  static updateBatch(objs: C3.Array<Application | null> | null, srcObjs?: C3.Array<Application | null>, spec?: UpsertSpec | null): ObjList<Application | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<Application | null>>, spec?: UpsertSpec | null): ObjList<Application | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<Application | null> | null, srcObjs?: C3.Array<Application | null>, spec?: UpsertSpec | null): ObjList<Application | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<Application | null>>, spec?: UpsertSpec | null): ObjList<Application | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<Application | null> | null, spec?: TouchSpec | null): ObjList<Application | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Application | null> | null, spec?: MergeSpec | null): ObjList<Application | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Application | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Application | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<Application | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Application | null> | null;
   ...
   */
  static mergeAll(mergeObj: Application | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: Application | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<Application | null> | null, spec?: UpsertSpec | null): ObjList<Application | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<Application | null> | null, spec?: UpsertSpec | null): ObjList<Application | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<Application | null> | null): ObjList<Application | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<Application | null> | null): ObjList<Application | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<Application | null> | null): ObjList<Application | null>;
   ...
   */
  static afterCreate(objs: C3.Array<Application | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<Application | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<Application | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<Application | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Application | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): Application | null;
   ...
   */
  withoutIdentity(): Application | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<Application | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: Application | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<Application | null> | null, callback?: λFunction<Application | null, Application | null> | null): ObjList<Application | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<Application | null> | null, callback?: λFunction<Application | null, Application | null> | null): C3.Array<ObjError | null>;
