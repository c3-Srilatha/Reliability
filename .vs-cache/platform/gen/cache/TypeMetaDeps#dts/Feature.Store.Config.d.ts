// TypeScript definitions for the C3 type Feature.Store.Config

/**
 * Contains default configurations used by {@link Feature.Store}
 *
 * @remarks this represents a value passed to a method that expects an instance of Feature.Store.Config
 */
declare namespace Feature.Store {
  export interface IConfig {
     ...
     */
    defaultMaterializeTimeRange?: IPair<string | null, string | null> | null;
     ...
     */
    defaultTimeHorizon?: IPair<string | null, string | null> | null;
     ...
     */
    useOldMaterializedTimeRange?: boolean;
     ...
     */
    doNotUseArrowForPyClientDataTransfer?: boolean;
     ...
     */
    allowReferenceTypeColumnsInFeatureSet?: boolean;
 ...
 * Contains default configurations used by {@link Feature.Store}
 *
 * @remarks this represents a made instance of Feature.Store.Config
 */
declare namespace Feature.Store {
  export class Config extends Obj {

    readonly configOverride?: string | null;
    withConfigOverride(configOverride: string | null): Feature.Store.Config;

    readonly secretOverride?: string | null;
    withSecretOverride(secretOverride: string | null): Feature.Store.Config;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: C3.Array<string | null>;
    withIssues(issues: C3.Array<string | null> | Array<string | null>): Feature.Store.Config;

    /**
     * Batch size to be used for grouping the # of subject / features together in a single api call for getting underlying
     * data (e.g. evalMetrics /  eval call)
     */
    readonly materializeBatchSize?: number | null;
    withMaterializeBatchSize(materializeBatchSize: number | null): Feature.Store.Config;

    /**
     * Recommended block size for the Feature Store blocks packing.
     * @see {@link Feature.Store.Block#pack}
     */
    readonly recommendedBlockSizeMb?: number | null;
    withRecommendedBlockSizeMb(recommendedBlockSizeMb: number | null): Feature.Store.Config;

    /**
     * The name of the KvStore that persists materialized features. If this field is empty, the default to {@link KvStore.FileSystem}
     */
    readonly kvStoreName?: string | null;
    withKvStoreName(kvStoreName: string | null): Feature.Store.Config;
     ...
     * 11. <"DaTeTiMe('2020-01-01')", "2020-12-01">
     */
    readonly defaultMaterializeTimeRange?: Pair<string | null, string | null> | null;
    withDefaultMaterializeTimeRange(defaultMaterializeTimeRange: IPair<string | null, string | null> | null): Feature.Store.Config;
     ...
     * If nothing is specified, then the "default" timeHorizon will be taken, which is based on the {@link Feature.Store.Config#defaultTimeHorizon}.
     */
    readonly defaultTimeHorizon?: Pair<string | null, string | null> | null;
    withDefaultTimeHorizon(defaultTimeHorizon: IPair<string | null, string | null> | null): Feature.Store.Config;

    /**
     * If set, {@link Feature.Set#materializeTimeRange}, {@link Feature.Store.Config#defaultMaterializeTimeRange} will be used instead of {@link Feature.Set#timeHorizon} and {@link Feature.Store.Config#defaultTimeHorizon}.
     * Please note that this is already deprecated and will be deleted soon.
     */
    readonly useOldMaterializedTimeRange?: boolean;
    withUseOldMaterializedTimeRange(useOldMaterializedTimeRange: boolean): Feature.Store.Config;
     ...
     * DEVELOPER NOTE: This config field is only for experiment purposes and should not be used by customers.
     */
    readonly doNotUseArrowForPyClientDataTransfer?: boolean;
    withDoNotUseArrowForPyClientDataTransfer(doNotUseArrowForPyClientDataTransfer: boolean): Feature.Store.Config;
     ...
     * have non-primitive column types.
     */
    readonly allowReferenceTypeColumnsInFeatureSet?: boolean;
    withAllowReferenceTypeColumnsInFeatureSet(allowReferenceTypeColumnsInFeatureSet: boolean): Feature.Store.Config;
     ...
     * DEVELOPER NOTE: This config field is only for experiment purposes and should not be used by customers.
     */
    readonly doNotUseNumpyForPy4j?: boolean;
    withDoNotUseNumpyForPy4j(doNotUseNumpyForPy4j: boolean): Feature.Store.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Feature.Store.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Feature.Store.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Feature.Store.Config | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Feature.Store.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Feature.Store.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Feature.Store.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Feature.Store.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Feature.Store.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Feature.Store.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Feature.Store.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Feature.Store.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Feature.Store.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Feature.Store.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Feature.Store.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Feature.Store.Config;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Feature.Store.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Feature.Store.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Feature.Store.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Feature.Store.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Feature.Store.Config;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Feature.Store.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Feature.Store.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Feature.Store.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Feature.Store.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Feature.Store.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Feature.Store.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Feature.Store.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Feature.Store.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Feature.Store.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Feature.Store.Config;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Feature.Store.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Feature.Store.Config;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Feature.Store.Config;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Feature.Store.Config;

    mergeJson(json: any | null): Feature.Store.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Feature.Store.Config;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Feature.Store.Config;
     ...
     */
    singletonArray(): C3.Array<Feature.Store.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Feature.Store.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Feature.Store.Config | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Feature.Store.Config | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Feature.Store.Config | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Feature.Store.Config | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Feature.Store.Config | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Feature.Store.Config | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Feature.Store.Config | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Feature.Store.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Feature.Store.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Feature.Store.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Feature.Store.Config;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Feature.Store.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Feature.Store.Config;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Feature.Store.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Feature.Store.Config;
     ...
     */
    static cachedEmptyInst(): Feature.Store.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Feature.Store.Config>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Feature.Store.Config;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<Feature.Store.Config | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<Feature.Store.Config | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<Feature.Store.Config | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): Feature.Store.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string | null): Feature.Store.Config | null;
     ...
     * @see findByCacheKey
     */
    getCached(): Feature.Store.Config | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): Feature.Store.Config | null;
     ...
     */
    static produce(key: string): Feature.Store.Config | null;
     ...
     */
    static produceAll(): C3.Map<string | null, Feature.Store.Config | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, Feature.Store.Config | null>;
     ...
     */
    getConfig(): Feature.Store.Config;
     ...
     */
    getSecret(): Feature.Store.Config;
     ...
     */
    static forConfigKey(configKey: string | null): Feature.Store.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<Feature.Store.Config | null>;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Feature.Store.Config, override?: string | null): void;
     ...
     * @see setSecretValue
     */
    setSecretValues(from: Feature.Store.Config, override?: string | null): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Feature.Store.Config | null;
     ...
     */
    removeSecrets(): Feature.Store.Config | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Feature.Store.Config | null;
     ...
     */
    evaluatedMaterializeTimeRange(): TimeRange | null;
