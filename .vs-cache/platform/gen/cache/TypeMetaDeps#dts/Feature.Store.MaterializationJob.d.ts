// TypeScript definitions for the C3 type Feature.Store.MaterializationJob
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Feature.Store.MaterializationJob
 */
declare namespace Feature.Store {
  export interface IMaterializationJob<SubjectType> {
 ...
 */
declare namespace Feature.Store {
  export class MaterializationJob<SubjectType> extends Obj {
    ...
    withPriority(priority: number | null): Feature.Store.MaterializationJob;
    ...
    withDisabled(disabled: boolean): Feature.Store.MaterializationJob;
    ...
    withMaxConcurrency(maxConcurrency: number | null): Feature.Store.MaterializationJob;
    ...
    withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): Feature.Store.MaterializationJob;
    ...
    withRunAsUser(runAsUser: boolean | null): Feature.Store.MaterializationJob;
    ...
    withNodePool(nodePool: string | null): Feature.Store.MaterializationJob;
    ...
    withSkipIfRunning(skipIfRunning: boolean | null): Feature.Store.MaterializationJob;

    /**
     * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
     */
    readonly numAutoRecoveryAttempts?: number | null;
    withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): Feature.Store.MaterializationJob;
    ...
    withPropagateActionContext(propagateActionContext: boolean): Feature.Store.MaterializationJob;
    ...
    withTargetType(targetType: IType | null): Feature.Store.MaterializationJob;
    ...
    withUseFileSystemForInterVals(useFileSystemForInterVals: boolean): Feature.Store.MaterializationJob;
    ...
    withUseBatchIdsForReadInput(useBatchIdsForReadInput: boolean): Feature.Store.MaterializationJob;
    ...
    withInclude(include: string | null): Feature.Store.MaterializationJob;

    /**
     * optional filter spec
     */
    readonly filter?: string | null;
    withFilter(filter: string | null): Feature.Store.MaterializationJob;
    ...
    withOrder(order: string | null): Feature.Store.MaterializationJob;
    ...
    withLimit(limit: number | null): Feature.Store.MaterializationJob;
    ...
    withSamplePct(samplePct: number | null): Feature.Store.MaterializationJob;
    ...
    withBatchSize(batchSize: number | null): Feature.Store.MaterializationJob;
    ...
    withSubBatchSize(subBatchSize: number | null): Feature.Store.MaterializationJob;
    ...
    withNumBatches(numBatches: number | null): Feature.Store.MaterializationJob;
    ...
    withAbortOnError(abortOnError: boolean): Feature.Store.MaterializationJob;

    readonly TRIAL_MODE_SNAPSHOT?: string | null;
    withTRIAL_MODE_SNAPSHOT(TRIAL_MODE_SNAPSHOT: string | null): Feature.Store.MaterializationJob;

    /**
     * Subject type for `features`
     */
    readonly subjectType: Type;
    withSubjectType(subjectType: IType): Feature.Store.MaterializationJob;

    /**
     * Feature names, Feature.Set ids to materialize
     */
    readonly features: C3.Array<string | null>;
    withFeatures(features: C3.Array<string | null> | Array<string | null>): Feature.Store.MaterializationJob;

    /**
     * If this app is currently in trial mode
     */
    readonly trialMode?: boolean;
    withTrialMode(trialMode: boolean): Feature.Store.MaterializationJob;

    /**
     * current or last job execution for this instance
     */
    readonly run?: MapReduceRun | null;
    withRun(run: IMapReduceRun | null): Feature.Store.MaterializationJob;

    /**
     * previous job executions for this instance
     */
    readonly runs?: C3.Array<MapReduceRun | null>;
    withRuns(runs: C3.Array<MapReduceRun | null> | Array<IMapReduceRun | null>): Feature.Store.MaterializationJob;

    /**
     * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
     */
    readonly options?: Obj | null;
    withOptions(options: IObj | null): Feature.Store.MaterializationJob;
    ...
    withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): Feature.Store.MaterializationJob;
    ...
    withTypeIdent(typeIdent: string | null): Feature.Store.MaterializationJob;
     ...
     */
    readonly id: string;
    withId(id: string): Feature.Store.MaterializationJob;
    ...
    withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Feature.Store.MaterializationJob;

    /**
     * Name of the Obj instance
     */
    readonly name?: string | null;
    withName(name: string | null): Feature.Store.MaterializationJob;

    /**
     * Various system fields.
     */
    readonly meta?: Meta | null;
    withMeta(meta: IMeta | null): Feature.Store.MaterializationJob;
    ...
    withVersion(version: number | null): Feature.Store.MaterializationJob;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type | null;
    withTypeWithBindings(typeWithBindings: IType | null): Feature.Store.MaterializationJob;

    /**
     * Optional target type instance to be used as the filter for the job.  When specified, the {~link map} function will
     * only be called for that obj.
     */
    readonly targetFilter?: SubjectType | null;
    withTargetFilter(targetFilter: SubjectType | null): Feature.Store.MaterializationJob;

    /**
     * The TimeRange used for materialization. Determined by the start and end fields of {@link Feature.MaterializationSpec}
     */
    readonly timeRange?: TimeRange | null;
    withTimeRange(timeRange: ITimeRange | null): Feature.Store.MaterializationJob;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Feature.Store.MaterializationJob<SubjectType> | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Feature.Store.MaterializationJob<SubjectType> | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Feature.Store.MaterializationJob<SubjectType> | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Feature.Store.MaterializationJob<SubjectType> | null;
     ...
     */
    replaceType(old: Type, new_: Type): Feature.Store.MaterializationJob<SubjectType>;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Feature.Store.MaterializationJob<SubjectType>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Feature.Store.MaterializationJob<SubjectType>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Feature.Store.MaterializationJob<SubjectType> | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Feature.Store.MaterializationJob<SubjectType> | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Feature.Store.MaterializationJob<SubjectType>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Feature.Store.MaterializationJob<SubjectType>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Feature.Store.MaterializationJob<SubjectType>;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Feature.Store.MaterializationJob<SubjectType>;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Feature.Store.MaterializationJob<SubjectType>;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Feature.Store.MaterializationJob<SubjectType>;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Feature.Store.MaterializationJob<SubjectType>;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Feature.Store.MaterializationJob<SubjectType>;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Feature.Store.MaterializationJob<SubjectType>;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Feature.Store.MaterializationJob<SubjectType>;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Feature.Store.MaterializationJob<SubjectType>;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Feature.Store.MaterializationJob<SubjectType>;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Feature.Store.MaterializationJob<SubjectType>;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Feature.Store.MaterializationJob<SubjectType>;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Feature.Store.MaterializationJob<SubjectType>;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Feature.Store.MaterializationJob<SubjectType>;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Feature.Store.MaterializationJob<SubjectType>;
     ...
     * @see #removeField
     */
    unsetField(field: string): Feature.Store.MaterializationJob<SubjectType>;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Feature.Store.MaterializationJob<SubjectType>;
     ...
     * @see #unsetField
     */
    removeField(field: string): Feature.Store.MaterializationJob<SubjectType>;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Feature.Store.MaterializationJob<SubjectType>;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Feature.Store.MaterializationJob<SubjectType>;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Feature.Store.MaterializationJob<SubjectType>;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Feature.Store.MaterializationJob<SubjectType>;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Feature.Store.MaterializationJob<SubjectType>;

    mergeJson(json: any | null): Feature.Store.MaterializationJob<SubjectType>;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Feature.Store.MaterializationJob<SubjectType>;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Feature.Store.MaterializationJob<SubjectType>;
     ...
     */
    singletonArray(): C3.Array<Feature.Store.MaterializationJob<SubjectType> | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Feature.Store.MaterializationJob<SubjectType> | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Feature.Store.MaterializationJob<SubjectType> | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Feature.Store.MaterializationJob<SubjectType> | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Feature.Store.MaterializationJob<SubjectType> | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Feature.Store.MaterializationJob<SubjectType> | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Feature.Store.MaterializationJob<SubjectType> | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Feature.Store.MaterializationJob<SubjectType> | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Feature.Store.MaterializationJob<SubjectType> | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Feature.Store.MaterializationJob<SubjectType>;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Feature.Store.MaterializationJob<SubjectType>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Feature.Store.MaterializationJob<SubjectType>;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Feature.Store.MaterializationJob<SubjectType>;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Feature.Store.MaterializationJob<SubjectType>;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Feature.Store.MaterializationJob<SubjectType>;
     ...
     * @see #fromString
     */
    static make(s: string | null): Feature.Store.MaterializationJob<SubjectType> | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Feature.Store.MaterializationJob<SubjectType>;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Feature.Store.MaterializationJob<SubjectType>;
     ...
     */
    static cachedEmptyInst(): Feature.Store.MaterializationJob<SubjectType>;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Feature.Store.MaterializationJob<SubjectType>>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Feature.Store.MaterializationJob<SubjectType>;
     ...
     */
    static fetch(spec?: FetchSpec | null): FetchResult<Feature.Store.MaterializationJob<SubjectType> | null>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Feature.Store.MaterializationJob<SubjectType> | null>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Feature.Store.MaterializationJob<SubjectType> | null>;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Feature.Store.MaterializationJob<SubjectType> | null> | null>;
     ...
     */
    get(include?: string | null): Feature.Store.MaterializationJob<SubjectType> | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string | null): Feature.Store.MaterializationJob<SubjectType> | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Feature.Store.MaterializationJob<SubjectType>;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string | null): Feature.Store.MaterializationJob<SubjectType> | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Feature.Store.MaterializationJob<SubjectType>;
     ...
     * @see #toString
     */
    static fromString(s: string | null): Feature.Store.MaterializationJob<SubjectType> | null;
     ...
     */
    create(spec?: UpsertSpec | null): Feature.Store.MaterializationJob<SubjectType> | null;
     ...
     */
    static createBatch(objs: C3.Array<Feature.Store.MaterializationJob<SubjectType> | null> | null, spec?: UpsertSpec | null): ObjList<Feature.Store.MaterializationJob<SubjectType> | null> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Feature.Store.MaterializationJob<SubjectType> | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Feature.Store.MaterializationJob<SubjectType> | null> | null;
     ...
     */
    update(srcObj?: Feature.Store.MaterializationJob<SubjectType> | null, spec?: UpsertSpec | null): Feature.Store.MaterializationJob<SubjectType> | null;
     ...
     */
    upsert(srcObj?: Feature.Store.MaterializationJob<SubjectType> | null, spec?: UpsertSpec | null): Feature.Store.MaterializationJob<SubjectType> | null;
     ...
     */
    merge(spec?: MergeSpec | null): Feature.Store.MaterializationJob<SubjectType> | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec | null): Feature.Store.MaterializationJob<SubjectType> | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec | null): Feature.Store.MaterializationJob<SubjectType> | null;
     ...
     */
    static updateBatch(objs: C3.Array<Feature.Store.MaterializationJob<SubjectType> | null> | null, srcObjs?: C3.Array<Feature.Store.MaterializationJob<SubjectType> | null>, spec?: UpsertSpec | null): ObjList<Feature.Store.MaterializationJob<SubjectType> | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<C3.Array<Feature.Store.MaterializationJob<SubjectType> | null>>, spec?: UpsertSpec | null): ObjList<Feature.Store.MaterializationJob<SubjectType> | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: C3.Array<Feature.Store.MaterializationJob<SubjectType> | null> | null, srcObjs?: C3.Array<Feature.Store.MaterializationJob<SubjectType> | null>, spec?: UpsertSpec | null): ObjList<Feature.Store.MaterializationJob<SubjectType> | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<C3.Array<Feature.Store.MaterializationJob<SubjectType> | null>>, spec?: UpsertSpec | null): ObjList<Feature.Store.MaterializationJob<SubjectType> | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: C3.Array<Feature.Store.MaterializationJob<SubjectType> | null> | null, spec?: TouchSpec | null): ObjList<Feature.Store.MaterializationJob<SubjectType> | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<Feature.Store.MaterializationJob<SubjectType> | null> | null, spec?: MergeSpec | null): ObjList<Feature.Store.MaterializationJob<SubjectType> | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<Feature.Store.MaterializationJob<SubjectType> | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Feature.Store.MaterializationJob<SubjectType> | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<C3.Array<Feature.Store.MaterializationJob<SubjectType> | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Feature.Store.MaterializationJob<SubjectType> | null> | null;
     ...
     */
    static mergeAll(mergeObj: Feature.Store.MaterializationJob<SubjectType> | null, spec?: MergeAllSpec | null): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Feature.Store.MaterializationJob<SubjectType> | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: C3.Array<Feature.Store.MaterializationJob<SubjectType> | null> | null, spec?: UpsertSpec | null): ObjList<Feature.Store.MaterializationJob<SubjectType> | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: C3.Array<Feature.Store.MaterializationJob<SubjectType> | null> | null, spec?: UpsertSpec | null): ObjList<Feature.Store.MaterializationJob<SubjectType> | null> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Feature.Store.MaterializationJob<SubjectType> | null;
     ...
     */
    static beforeCreate(objs: C3.Array<Feature.Store.MaterializationJob<SubjectType> | null> | null): ObjList<Feature.Store.MaterializationJob<SubjectType> | null>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: C3.Array<Feature.Store.MaterializationJob<SubjectType> | null> | null): ObjList<Feature.Store.MaterializationJob<SubjectType> | null>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: C3.Array<Feature.Store.MaterializationJob<SubjectType> | null> | null): ObjList<Feature.Store.MaterializationJob<SubjectType> | null>;
     ...
     */
    static afterCreate(objs: C3.Array<Feature.Store.MaterializationJob<SubjectType> | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: C3.Array<Feature.Store.MaterializationJob<SubjectType> | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: C3.Array<Feature.Store.MaterializationJob<SubjectType> | null> | null): C3.Array<ObjError | null>;
     ...
     */
    static startImportData(spec?: StartImportDataSpec | null): PushStream<Feature.Store.MaterializationJob<SubjectType> | null>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Feature.Store.MaterializationJob<SubjectType> | null>;
     ...
     */
    static forId(id: string | null, failIfMissing?: boolean): Feature.Store.MaterializationJob<SubjectType> | null;
     ...
     */
    withoutIdentity(): Feature.Store.MaterializationJob<SubjectType> | null;
     ...
     */
    static typeOfBatch(objs: C3.Array<Feature.Store.MaterializationJob<SubjectType> | null> | null): C3.Array<EntityType | null>;
     ...
     */
    static dbEcho(template?: Feature.Store.MaterializationJob<SubjectType> | null, count?: number | null, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: C3.Array<Feature.Store.MaterializationJob<SubjectType> | null> | null, callback?: λFunction<Feature.Store.MaterializationJob<SubjectType> | null, Feature.Store.MaterializationJob<SubjectType> | null> | null): ObjList<Feature.Store.MaterializationJob<SubjectType> | null>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: C3.Array<Feature.Store.MaterializationJob<SubjectType> | null> | null, callback?: λFunction<Feature.Store.MaterializationJob<SubjectType> | null, Feature.Store.MaterializationJob<SubjectType> | null> | null): C3.Array<ObjError | null>;
     ...
     *         key type.
     */
    static map(batch?: number | null, objs?: C3.Array<SubjectType | null>, job?: MapReduce<SubjectType, void, void, void> | null, subBatch?: number | null): C3.Map< | null,  | null>;
     ...
     */
    static reduce(outKey?:  | null, interValues?: C3.Array< | null>, job?: MapReduce<SubjectType, void, void, void> | null):  | null | C3.Array< | null> | null;
     ...
     */
    static mapCompleted(job?: MapReduce<SubjectType, void, void, void> | null): void;

    /**
     * Overridden to marking the {@link FeatureBase#latestStrategy} as "operationally ready" once the data has been materialized.
     */
    static completed(job?: MapReduce<SubjectType, void, void, void> | null): string | null;
     ...
     */
    static failed(job: MapReduce<SubjectType, void, void, void>, status: MapReduceStatus, options?: MapReduceOptions | null): void;
     ...
     */
    results(limit?: number | null): C3.Map< | null,  | null | C3.Array< | null> | null>;
