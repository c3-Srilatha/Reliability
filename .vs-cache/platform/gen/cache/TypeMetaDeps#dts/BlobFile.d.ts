// TypeScript definitions for the C3 type BlobFile

/**
 * Represents the Blob as a file.
 *
 * @remarks this represents a value passed to a method that expects an instance of BlobFile
 */
declare interface IBlobFile<FS> {
 ...
 * Represents the Blob as a file.
 *
 * @remarks this represents a made instance of BlobFile
 */
declare class BlobFile<FS> extends Obj {
  ...
  withContentEncoding(contentEncoding: string | null): BlobFile;
  ...
  withContentLanguage(contentLanguage: string | null): BlobFile;
  ...
  withContentLength(contentLength: number | null): BlobFile;
  ...
  withContentLocation(contentLocation: string | null): BlobFile;
  ...
  withContentType(contentType: string | null): BlobFile;
  ...
  withContentDisposition(contentDisposition: string | null): BlobFile;
  ...
  withETag(eTag: string | null): BlobFile;
  ...
  withLastModified(lastModified: DateTime | Date | string | null): BlobFile;

  /**
   * Id of user / identity who last last modified this content.
   */
  readonly lastModifiedBy?: string | null;
  withLastModifiedBy(lastModifiedBy: string | null): BlobFile;
  ...
  withContentMD5(contentMD5: string | null): BlobFile;
  ...
  withContentSHA1(contentSHA1: string | null): BlobFile;

  /**
   * Field to maintain state whether content metadata was read or not.
   */
  readonly hasMetadata?: boolean;
  withHasMetadata(hasMetadata: boolean): BlobFile;

  /**
   * URL for this file that contains scheme (i.e. file-system) and fully qualified encoded path.
   */
  readonly url?: string | null;
  withUrl(url: string | null): BlobFile;

  /**
   * Custom user-metadata.
   */
  readonly userMetadata?: C3.Map<string | null, string | null>;
  withUserMetadata(userMetadata: C3.Map<string | null, string | null> | {[key: string | null]: string | null}): BlobFile;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): BlobFile<FS> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): BlobFile<FS> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): BlobFile<FS> | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): BlobFile<FS> | null;
   ...
   */
  replaceType(old: Type, new_: Type): BlobFile<FS>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BlobFile<FS>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BlobFile<FS>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BlobFile<FS> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BlobFile<FS> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): BlobFile<FS>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BlobFile<FS>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BlobFile<FS>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): BlobFile<FS>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): BlobFile<FS>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): BlobFile<FS>;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): BlobFile<FS>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BlobFile<FS>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): BlobFile<FS>;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): BlobFile<FS>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): BlobFile<FS>;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): BlobFile<FS>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): BlobFile<FS>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): BlobFile<FS>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): BlobFile<FS>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): BlobFile<FS>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): BlobFile<FS>;
   ...
   * @see #removeField
   */
  unsetField(field: string): BlobFile<FS>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): BlobFile<FS>;
   ...
   * @see #unsetField
   */
  removeField(field: string): BlobFile<FS>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): BlobFile<FS>;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): BlobFile<FS>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): BlobFile<FS>;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): BlobFile<FS>;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): BlobFile<FS>;

  mergeJson(json: any | null): BlobFile<FS>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): BlobFile<FS>;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): BlobFile<FS>;
   ...
   */
  singletonArray(): C3.Array<BlobFile<FS> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<BlobFile<FS> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BlobFile<FS> | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<BlobFile<FS> | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BlobFile<FS> | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, BlobFile<FS> | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BlobFile<FS> | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BlobFile<FS> | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BlobFile<FS> | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): BlobFile<FS>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): BlobFile<FS>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): BlobFile<FS>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): BlobFile<FS>;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): BlobFile<FS>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): BlobFile<FS>;
   ...
   * @see #fromString
   */
  static make(s: string | null): BlobFile<FS> | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): BlobFile<FS>;
   ...
   */
  static cachedEmptyInst(): BlobFile<FS>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<BlobFile<FS>>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): BlobFile<FS>;
   ...
   */
  withFileName(fileName: string | null): BlobFile<FS>;

  /**
   * Changes file extension in this instance.
   */
  withFileExt(fileExt: string | null): BlobFile<FS>;
   ...
   */
  identify(suffix?: string | null): BlobFile<FS>;
   ...
   */
  readMetadata(spec?: FileOperationSpec | null): BlobFile<FS>;
   ...
   */
  refreshMetadata(spec?: FileOperationSpec | null): BlobFile<FS>;
   ...
   * @return abstract content with metadata.
   */
  guessMetadata(spec?: FileOperationSpec | null): BlobFile<FS>;

  /**
   * Clears the content metadata; e.g. if it's known to be invalid.
   */
  clearMetadata(): BlobFile<FS>;

  /**
   * @return clone of this content with metadata from provided input.
   */
  withMetadata(meta?: ContentMeta | null): BlobFile<FS>;
   ...
   */
  encodedPushStream(spec?: FileOperationSpec | null): Pair<BlobFile<FS> | null, BytePushStream | null>;

  /**
   * @return byte push stream to be used for writing un-encoded data into this content object.
   */
  pushStream(spec?: FileOperationSpec | null): Pair<BlobFile<FS> | null, BytePushStream | null>;

  /**
   * @return character push stream to be used for writing un-encoded data into this content object.
   */
  charPushStream(spec?: FileOperationSpec | null): Pair<BlobFile<FS> | null, CharPushStream | null>;
   ...
   */
  encodedStream(spec?: FileOperationSpec | null): Pair<BlobFile<FS> | null, ByteStream | null> | null;
   ...
   */
  writeStream(content: ByteStream | null, spec?: FileOperationSpec | null): BlobFile<FS>;

  /**
   * Truncates file and replaces it's content with provided binary content.
   */
  writeInputStream(inputStream: any, spec?: FileOperationSpec | null): BlobFile<FS>;

  /**
   * Truncates file and replaces its content with provided binary content from zipInputStream
   */
  writeZipInputStream(zipInputStream: any, spec?: FileOperationSpec | null): BlobFile<FS>;
   ...
   */
  writeEncodedStream(encodedContent: ByteStream | null, spec?: FileOperationSpec | null): BlobFile<FS>;

  /**
   * Truncates file and replaces it's encoded content with provided binary content.
   */
  writeEncodedInputStream(inputStream: any, spec?: FileOperationSpec | null): BlobFile<FS>;
   ...
   *           content that needs to be written
   */
  write(content: any | null, spec?: FileOperationSpec | null): BlobFile<FS>;
   ...
   *           encoded content that needs to be written
   */
  writeEncoded(encodedContent: any | null, spec?: FileOperationSpec | null): BlobFile<FS>;
   ...
   *           content that needs to be written
   */
  writeString(content: string | null, spec?: FileOperationSpec | null): BlobFile<FS>;
   ...
   */
  writeObj(obj: Obj | null, spec?: FileObjsOperSpec | null): BlobFile<FS>;
   ...
   * @return pair of update instance of this content and number of objs written
   */
  startWriteObjs(spec?: FileObjsOperSpec | null): Pair<BlobFile<FS> | null, PushStream<Obj | null> | null>;
   ...
   */
  compress(contentEncoding?: string | null, spec?: FileCompressSpec | null): BlobFile<FS>;

  /**
   * Uncompresses file. Removes compression specific extension.
   */
  uncompress(spec?: FileCompressSpec | null): BlobFile<FS>;
   ...
   */
  transcode(contentType: string, contentEncoding: string, spec?: FileCompressSpec | null): BlobFile<FS>;

  /**
   * Copies content to a given target.
   */
  copyContentTo(target: BlobFile<FS>, spec?: FileOperationSpec | null): void;
   ...
   */
  static fromString(s: string | null): BlobFile<FS> | null;
