// TypeScript definitions for the C3 type StatsConfig

/**
 * @remarks this represents a value passed to a method that expects an instance of StatsConfig
 */
declare interface IStatsConfig {
...
/**
 * @remarks this represents a made instance of StatsConfig
 */
declare class StatsConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): StatsConfig;

  static readonly configOverride?: string | null;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): StatsConfig;
  ...
  withIssues(issues: C3.Array<string | null> | Array<string | null>): StatsConfig;
  ...
  withPollSeconds(pollSeconds: number | null): StatsConfig;

  static readonly pollSeconds?: number | null;

  readonly dbNodes?: boolean;
  withDbNodes(dbNodes: boolean): StatsConfig;

  static readonly dbNodes?: boolean;

  readonly sharedNodes?: boolean;
  withSharedNodes(sharedNodes: boolean): StatsConfig;

  static readonly sharedNodes?: boolean;

  readonly clusterNodes?: boolean;
  withClusterNodes(clusterNodes: boolean): StatsConfig;

  static readonly clusterNodes?: boolean;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): StatsConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): StatsConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): StatsConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): StatsConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): StatsConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): StatsConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): StatsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): StatsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): StatsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): StatsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<StatsConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<StatsConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<StatsConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<StatsConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): StatsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): StatsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): StatsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): StatsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): StatsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): StatsConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): StatsConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): StatsConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): StatsConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): StatsConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): StatsConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): StatsConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): StatsConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): StatsConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): StatsConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): StatsConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): StatsConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): StatsConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): StatsConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): StatsConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): StatsConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): StatsConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): StatsConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): StatsConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): StatsConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): StatsConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): StatsConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): StatsConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): StatsConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): StatsConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): StatsConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): StatsConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): StatsConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): StatsConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): StatsConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): StatsConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): StatsConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): StatsConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): StatsConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): StatsConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): StatsConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): StatsConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): StatsConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): StatsConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): StatsConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): StatsConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): StatsConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): StatsConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): StatsConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): StatsConfig;

  mergeJson(json: any | null): StatsConfig;

  static mergeJson(json: any | null): StatsConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): StatsConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): StatsConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): StatsConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): StatsConfig;
   ...
   */
  singletonArray(): C3.Array<StatsConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<StatsConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<StatsConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<StatsConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<StatsConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<StatsConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<StatsConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, StatsConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, StatsConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<StatsConfig | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<StatsConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<StatsConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): StatsConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): StatsConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): StatsConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): StatsConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): StatsConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): StatsConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): StatsConfig;
   ...
   */
  static cachedEmptyInst(): StatsConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<StatsConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): StatsConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<StatsConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<StatsConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<StatsConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): StatsConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): StatsConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): StatsConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): StatsConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): StatsConfig | null;
   ...
   */
  static produce(key: string): StatsConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, StatsConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, StatsConfig | null>;
   ...
   */
  static forConfigKey(configKey: string | null): StatsConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<StatsConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: StatsConfig, override?: string | null): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: StatsConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: StatsConfig, override?: string | null): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: StatsConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): StatsConfig | null;
   ...
   */
  removeSecrets(): StatsConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): StatsConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): StatsConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): StatsConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): StatsConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): StatsConfig;
