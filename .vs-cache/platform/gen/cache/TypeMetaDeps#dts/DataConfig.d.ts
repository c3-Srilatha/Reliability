// TypeScript definitions for the C3 type DataConfig

/**
 * @remarks this represents a value passed to a method that expects an instance of DataConfig
 */
declare interface IDataConfig {
  ...
  /**
   * Indicates whether operations on Data should be evaluated lazily or eagerly
   */
  lazy?: boolean;

  /**
   * If true, the python methods annotated by the @profile will be profiled.
   */
  cprofileEnabled?: boolean;

  /**
   * The directory to save the cProfile files. This folder should be a temporary folder
   */
  profileFolder?: string | null;
}

/**
 * @remarks this represents a made instance of DataConfig
 */
declare class DataConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): DataConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): DataConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): DataConfig;

  /**
   * Indicates whether operations on Data should be evaluated lazily or eagerly
   */
  readonly lazy?: boolean;
  withLazy(lazy: boolean): DataConfig;

  /**
   * If true, the python methods annotated by the @profile will be profiled.
   */
  readonly cprofileEnabled?: boolean;
  withCprofileEnabled(cprofileEnabled: boolean): DataConfig;

  /**
   * The directory to save the cProfile files. This folder should be a temporary folder
   */
  readonly profileFolder?: string | null;
  withProfileFolder(profileFolder: string | null): DataConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): DataConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): DataConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): DataConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): DataConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): DataConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DataConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DataConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DataConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DataConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): DataConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): DataConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): DataConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DataConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DataConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DataConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): DataConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DataConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): DataConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DataConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): DataConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataConfig;

  mergeJson(json: any | null): DataConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): DataConfig;
   ...
   */
  singletonArray(): C3.Array<DataConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<DataConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DataConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<DataConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DataConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, DataConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DataConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DataConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DataConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DataConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DataConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DataConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DataConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DataConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DataConfig;
   ...
   */
  static cachedEmptyInst(): DataConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DataConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): DataConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<DataConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<DataConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<DataConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): DataConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): DataConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): DataConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): DataConfig | null;
   ...
   */
  static produce(key: string): DataConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, DataConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, DataConfig | null>;
   ...
   */
  static forConfigKey(configKey: string | null): DataConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<DataConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: DataConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: DataConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): DataConfig | null;
   ...
   */
  removeSecrets(): DataConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): DataConfig | null;
