// TypeScript definitions for the C3 type PrivilegedCacheTestConfig

/**
 * @remarks this represents a value passed to a method that expects an instance of PrivilegedCacheTestConfig
 */
declare interface IPrivilegedCacheTestConfig {
...
/**
 * @remarks this represents a made instance of PrivilegedCacheTestConfig
 */
declare class PrivilegedCacheTestConfig extends Obj {

  /**
   * The id of this instance.
   */
  readonly id?: string | null;
  withId(id: string | null): PrivilegedCacheTestConfig;

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): PrivilegedCacheTestConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): PrivilegedCacheTestConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): PrivilegedCacheTestConfig;

  readonly foo?: number | null;
  withFoo(foo: number | null): PrivilegedCacheTestConfig;

  readonly bar?: string | null;
  withBar(bar: string | null): PrivilegedCacheTestConfig;

  readonly pass?: string | null;
  withPass(pass: string | null): PrivilegedCacheTestConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): PrivilegedCacheTestConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): PrivilegedCacheTestConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): PrivilegedCacheTestConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): PrivilegedCacheTestConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): PrivilegedCacheTestConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PrivilegedCacheTestConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PrivilegedCacheTestConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PrivilegedCacheTestConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PrivilegedCacheTestConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): PrivilegedCacheTestConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PrivilegedCacheTestConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PrivilegedCacheTestConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PrivilegedCacheTestConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PrivilegedCacheTestConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PrivilegedCacheTestConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): PrivilegedCacheTestConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PrivilegedCacheTestConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PrivilegedCacheTestConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): PrivilegedCacheTestConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): PrivilegedCacheTestConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): PrivilegedCacheTestConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): PrivilegedCacheTestConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PrivilegedCacheTestConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): PrivilegedCacheTestConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PrivilegedCacheTestConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PrivilegedCacheTestConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): PrivilegedCacheTestConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PrivilegedCacheTestConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): PrivilegedCacheTestConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PrivilegedCacheTestConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): PrivilegedCacheTestConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): PrivilegedCacheTestConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): PrivilegedCacheTestConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): PrivilegedCacheTestConfig;

  mergeJson(json: any | null): PrivilegedCacheTestConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): PrivilegedCacheTestConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): PrivilegedCacheTestConfig;
   ...
   */
  singletonArray(): C3.Array<PrivilegedCacheTestConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<PrivilegedCacheTestConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PrivilegedCacheTestConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<PrivilegedCacheTestConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PrivilegedCacheTestConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, PrivilegedCacheTestConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PrivilegedCacheTestConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PrivilegedCacheTestConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PrivilegedCacheTestConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): PrivilegedCacheTestConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): PrivilegedCacheTestConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): PrivilegedCacheTestConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PrivilegedCacheTestConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): PrivilegedCacheTestConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PrivilegedCacheTestConfig;
   ...
   * @see #fromString
   */
  static make(s: string | null): PrivilegedCacheTestConfig | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): PrivilegedCacheTestConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): PrivilegedCacheTestConfig;
   ...
   */
  static cachedEmptyInst(): PrivilegedCacheTestConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<PrivilegedCacheTestConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): PrivilegedCacheTestConfig;
   ...
   * @see #toString
   */
  static fromString(s: string | null): PrivilegedCacheTestConfig | null;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<PrivilegedCacheTestConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<PrivilegedCacheTestConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<PrivilegedCacheTestConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): PrivilegedCacheTestConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): PrivilegedCacheTestConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): PrivilegedCacheTestConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): PrivilegedCacheTestConfig | null;
   ...
   */
  static produce(key: string): PrivilegedCacheTestConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, PrivilegedCacheTestConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, PrivilegedCacheTestConfig | null>;
   ...
   */
  getConfig(): PrivilegedCacheTestConfig;
   ...
   */
  getSecret(): PrivilegedCacheTestConfig;
   ...
   */
  static forConfigKey(configKey: string | null): PrivilegedCacheTestConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<PrivilegedCacheTestConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: PrivilegedCacheTestConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: PrivilegedCacheTestConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): PrivilegedCacheTestConfig | null;
