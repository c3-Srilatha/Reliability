// TypeScript definitions for the C3 type DatastoreConfig

/**
 * @remarks this represents a value passed to a method that expects an instance of DatastoreConfig
 */
declare interface IDatastoreConfig<CREDS> {
   ...
   */
  connectionPool?: IDatastoreConnectionPoolConfig<DatastoreConfig<CREDS> | null> | null;
  ...
  readConnectionPool?: IDatastoreConnectionPoolConfig<DatastoreConfig<CREDS> | null> | null;

  writeConnectionPool?: IDatastoreConnectionPoolConfig<DatastoreConfig<CREDS> | null> | null;
}

/**
 * @remarks this represents a made instance of DatastoreConfig
 */
declare class DatastoreConfig<CREDS> extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): DatastoreConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): DatastoreConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): DatastoreConfig;

  /**
   * The unique and required name of this instance.
   */
  readonly name: string;
  withName(name: string): DatastoreConfig;

  /**
   * Physical pool for connections
   */
  readonly connectionPool?: DatastoreConnectionPoolConfig<DatastoreConfig<CREDS> | null> | null;
  withConnectionPool(connectionPool: IDatastoreConnectionPoolConfig<DatastoreConfig<CREDS> | null> | null): DatastoreConfig;

  /**
   * How to access the data in the datastore.  Override to provide things such as endpoint, username, password,
   * etc. as appropriate.
   */
  readonly credentials?: CREDS | null;
  withCredentials(credentials: CREDS | null): DatastoreConfig;

  /**
   * C3 Cloud Identifier for backing infrastructure that hosts the Datastore ex: {@link PostgresDb#id}, {@link CassandraDb#id}
   */
  readonly cloudId?: string | null;
  withCloudId(cloudId: string | null): DatastoreConfig;

  /**
   * True if the datastore is disabled (e.g. no data access is permitted).
   */
  readonly disabled?: boolean;
  withDisabled(disabled: boolean): DatastoreConfig;

  /**
   * True if the datastore is read only, i.e. can only be queried.
   */
  readonly readOnly?: boolean;
  withReadOnly(readOnly: boolean): DatastoreConfig;

  /**
   * True if the datastore is external, i.e. its database schema can not be altered.
   */
  readonly external?: boolean;
  withExternal(external: boolean): DatastoreConfig;
  ...
  withPerTenant(perTenant: boolean): DatastoreConfig;

  /**
   * Description for the dataStore.
   */
  readonly description?: string | null;
  withDescription(description: string | null): DatastoreConfig;

  /**
   * True if the db is shared with other apps or it is dedicated.
   */
  readonly dedicated?: boolean;
  withDedicated(dedicated: boolean): DatastoreConfig;

  readonly shareReadConnection?: boolean;
  withShareReadConnection(shareReadConnection: boolean): DatastoreConfig;

  readonly sharedReadThreshold: number;
  withSharedReadThreshold(sharedReadThreshold: number): DatastoreConfig;

  readonly readConnectionPool?: DatastoreConnectionPoolConfig<DatastoreConfig<CREDS> | null> | null;
  withReadConnectionPool(readConnectionPool: IDatastoreConnectionPoolConfig<DatastoreConfig<CREDS> | null> | null): DatastoreConfig;

  readonly writeConnectionPool?: DatastoreConnectionPoolConfig<DatastoreConfig<CREDS> | null> | null;
  withWriteConnectionPool(writeConnectionPool: IDatastoreConnectionPoolConfig<DatastoreConfig<CREDS> | null> | null): DatastoreConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): DatastoreConfig<CREDS> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): DatastoreConfig<CREDS> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): DatastoreConfig<CREDS> | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): DatastoreConfig<CREDS> | null;
   ...
   */
  replaceType(old: Type, new_: Type): DatastoreConfig<CREDS>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DatastoreConfig<CREDS>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DatastoreConfig<CREDS>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DatastoreConfig<CREDS> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DatastoreConfig<CREDS> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DatastoreConfig<CREDS>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DatastoreConfig<CREDS>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DatastoreConfig<CREDS>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DatastoreConfig<CREDS>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DatastoreConfig<CREDS>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DatastoreConfig<CREDS>;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DatastoreConfig<CREDS>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DatastoreConfig<CREDS>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DatastoreConfig<CREDS>;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): DatastoreConfig<CREDS>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): DatastoreConfig<CREDS>;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): DatastoreConfig<CREDS>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DatastoreConfig<CREDS>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DatastoreConfig<CREDS>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DatastoreConfig<CREDS>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DatastoreConfig<CREDS>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DatastoreConfig<CREDS>;
   ...
   * @see #removeField
   */
  unsetField(field: string): DatastoreConfig<CREDS>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DatastoreConfig<CREDS>;
   ...
   * @see #unsetField
   */
  removeField(field: string): DatastoreConfig<CREDS>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DatastoreConfig<CREDS>;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DatastoreConfig<CREDS>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): DatastoreConfig<CREDS>;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DatastoreConfig<CREDS>;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DatastoreConfig<CREDS>;

  mergeJson(json: any | null): DatastoreConfig<CREDS>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DatastoreConfig<CREDS>;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): DatastoreConfig<CREDS>;
   ...
   */
  singletonArray(): C3.Array<DatastoreConfig<CREDS> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<DatastoreConfig<CREDS> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DatastoreConfig<CREDS> | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<DatastoreConfig<CREDS> | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DatastoreConfig<CREDS> | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, DatastoreConfig<CREDS> | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DatastoreConfig<CREDS> | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DatastoreConfig<CREDS> | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DatastoreConfig<CREDS> | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DatastoreConfig<CREDS>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DatastoreConfig<CREDS>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DatastoreConfig<CREDS>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DatastoreConfig<CREDS>;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DatastoreConfig<CREDS>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DatastoreConfig<CREDS>;
   ...
   * @see #fromString
   */
  static make(s: string | null): DatastoreConfig<CREDS> | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DatastoreConfig<CREDS>;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): DatastoreConfig<CREDS>;
   ...
   */
  static cachedEmptyInst(): DatastoreConfig<CREDS>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DatastoreConfig<CREDS>>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): DatastoreConfig<CREDS>;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<DatastoreConfig<CREDS> | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<DatastoreConfig<CREDS> | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<DatastoreConfig<CREDS> | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): DatastoreConfig<CREDS> | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): DatastoreConfig<CREDS> | null;
   ...
   * @see findByCacheKey
   */
  getCached(): DatastoreConfig<CREDS> | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): DatastoreConfig<CREDS> | null;
   ...
   */
  static produce(key: string): DatastoreConfig<CREDS> | null;
   ...
   */
  static produceAll(): C3.Map<string | null, DatastoreConfig<CREDS> | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, DatastoreConfig<CREDS> | null>;
   ...
   */
  getConfig(): DatastoreConfig<CREDS>;
   ...
   */
  getSecret(): DatastoreConfig<CREDS>;
   ...
   */
  static forConfigKey(configKey: string | null): DatastoreConfig<CREDS> | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<DatastoreConfig<CREDS> | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: DatastoreConfig<CREDS>, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: DatastoreConfig<CREDS>, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): DatastoreConfig<CREDS> | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): DatastoreConfig<CREDS> | null;
   ...
   */
  static forName(name: string | null, failIfMissing?: boolean): DatastoreConfig<CREDS> | null;
