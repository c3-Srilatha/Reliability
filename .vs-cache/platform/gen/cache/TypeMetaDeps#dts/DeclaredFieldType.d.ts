// TypeScript definitions for the C3 type DeclaredFieldType

/**
 * Represents field type declaration metadata.
 *
 * @remarks this represents a value passed to a method that expects an instance of DeclaredFieldType
 */
declare interface IDeclaredFieldType {
 ...
 * Represents field type declaration metadata.
 *
 * @remarks this represents a made instance of DeclaredFieldType
 */
declare class DeclaredFieldType extends Obj {

  /**
   * Source file Pkg.Path a C3 Type declaration [.c3typ].
   */
  readonly declaredPkgPath?: string | null;
  withDeclaredPkgPath(declaredPkgPath: string | null): DeclaredFieldType;

  /**
   * Source line number in a C3 Type declaration [.c3typ] file starting with 1 where this metadata element is declared.
   */
  readonly declaredSrcLine?: number | null;
  withDeclaredSrcLine(declaredSrcLine: number | null): DeclaredFieldType;
  ...
  withDeclaredSrcCharInLine(declaredSrcCharInLine: number | null): DeclaredFieldType;
   ...
   */
  readonly pkg: Pkg;
  withPkg(pkg: IPkg): DeclaredFieldType;

  /**
   * SDK json representing instance of this type
   */
  readonly json?: any;
  withJson(json: any): DeclaredFieldType;

  /**
   * The set of annotations defined on this element of metadata represented as json value.
   */
  readonly annotationsJson?: any | null;
  withAnnotationsJson(annotationsJson: any | null): DeclaredFieldType;
  ...
  withDoc(doc: string | null): DeclaredFieldType;

  readonly docSingleLine?: boolean;
  withDocSingleLine(docSingleLine: boolean): DeclaredFieldType;

  /**
   * The name of the field is the unique key for access.
   */
  readonly name?: string | null;
  withName(name: string | null): DeclaredFieldType;
  ...
  withDeclaredDefault(declaredDefault: string | null): DeclaredFieldType;
  ...
  withStoredCalc(storedCalc: boolean): DeclaredFieldType;
  ...
  withCalcExpr(calcExpr: string | null): DeclaredFieldType;
  ...
  withCalcPeriod(calcPeriod: string | null): DeclaredFieldType;
  ...
  withCalcSchedule(calcSchedule: string | null): DeclaredFieldType;
  ...
  withFkey(fkey: string | null): DeclaredFieldType;
  ...
  withKey(key: string | null): DeclaredFieldType;

  readonly schemaName?: string | null;
  withSchemaName(schemaName: string | null): DeclaredFieldType;

  readonly schemaSuffix?: string | null;
  withSchemaSuffix(schemaSuffix: string | null): DeclaredFieldType;

  readonly translatedBy?: string | null;
  withTranslatedBy(translatedBy: string | null): DeclaredFieldType;
  ...
  withNotPersistable(notPersistable: boolean): DeclaredFieldType;
  ...
  withFinal(final: boolean): DeclaredFieldType;
  ...
  withPrivate(private_: boolean): DeclaredFieldType;
  ...
  withConstant(constant: boolean): DeclaredFieldType;

  /**
   * Declared value type of this field type. Could be null or partial if this is an inherited field or method.
   */
  readonly valueType?: ValueType | null;
  withValueType(valueType: IValueType | null): DeclaredFieldType;

  /**
   * All comments associated with this type system element.
   */
  readonly comments?: C3.Array<DslComment | null>;
  withComments(comments: C3.Array<DslComment | null> | Array<IDslComment | null>): DeclaredFieldType;
   ...
   */
  replaceType(old: Type, new_: Type): DeclaredFieldType;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): DeclaredFieldType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): DeclaredFieldType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): DeclaredFieldType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): DeclaredFieldType | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DeclaredFieldType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DeclaredFieldType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DeclaredFieldType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DeclaredFieldType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DeclaredFieldType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DeclaredFieldType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DeclaredFieldType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DeclaredFieldType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DeclaredFieldType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DeclaredFieldType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DeclaredFieldType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DeclaredFieldType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DeclaredFieldType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): DeclaredFieldType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): DeclaredFieldType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): DeclaredFieldType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DeclaredFieldType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DeclaredFieldType;
   ...
   * @see FieldType#defaultValue
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DeclaredFieldType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DeclaredFieldType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DeclaredFieldType;
   ...
   * @see #removeField
   */
  unsetField(field: string): DeclaredFieldType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DeclaredFieldType;
   ...
   * @see #unsetField
   */
  removeField(field: string): DeclaredFieldType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DeclaredFieldType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DeclaredFieldType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): DeclaredFieldType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DeclaredFieldType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DeclaredFieldType;

  mergeJson(json: any | null): DeclaredFieldType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DeclaredFieldType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): DeclaredFieldType;
   ...
   */
  singletonArray(): C3.Array<DeclaredFieldType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<DeclaredFieldType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DeclaredFieldType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<DeclaredFieldType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DeclaredFieldType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, DeclaredFieldType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DeclaredFieldType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DeclaredFieldType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DeclaredFieldType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DeclaredFieldType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DeclaredFieldType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DeclaredFieldType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DeclaredFieldType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DeclaredFieldType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DeclaredFieldType;
   ...
   * @see #fromString
   */
  static make(s: string | null): DeclaredFieldType | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DeclaredFieldType;
   ...
   */
  static cachedEmptyInst(): DeclaredFieldType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DeclaredFieldType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): DeclaredFieldType;
   ...
   */
  withoutDeclaredSrcPos(recursive?: boolean): DeclaredFieldType;
   ...
   */
  withAnnotation(ann: Annotation): DeclaredFieldType;
   ...
   *         value for the field
   */
  withAnnotation(ann: string, annField?: string | null, value?: any): DeclaredFieldType;
   ...
   * @see #toString
   */
  static fromString(s: string | null): DeclaredFieldType | null;
