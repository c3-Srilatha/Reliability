// TypeScript definitions for the C3 type PageGroup

/**
 * A page group is used to provide access control for a set of related pages.
 * Note that the page definition itself is in UI metadata (page component).
 *
 * @remarks this represents a value passed to a method that expects an instance of PageGroup
 */
declare interface IPageGroup {
  ...
  pageNames?: C3.Array<string | null> | Array<string | null>;
}
 ...
 * Note that the page definition itself is in UI metadata (page component).
 *
 * @remarks this represents a made instance of PageGroup
 */
declare class PageGroup extends Obj {

  /**
   * List of {@link AclEntry} entries governing who can read/update/remove Objs.
   */
  readonly acl?: C3.Array<AclEntry | null>;
  withAcl(acl: C3.Array<AclEntry | null> | Array<IAclEntry | null>): PageGroup;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): PageGroup;

  /**
   * Name of the Obj instance
   */
  readonly name: string;
  withName(name: string): PageGroup;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): PageGroup;
  ...
  withVersion(version: number | null): PageGroup;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): PageGroup;

  readonly application?: Application | null;
  withApplication(application: IApplication | null): PageGroup;

  readonly pageNames?: C3.Array<string | null>;
  withPageNames(pageNames: C3.Array<string | null> | Array<string | null>): PageGroup;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): PageGroup | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): PageGroup | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): PageGroup | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): PageGroup | null;
   ...
   */
  replaceType(old: Type, new_: Type): PageGroup;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PageGroup;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PageGroup;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PageGroup | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PageGroup | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): PageGroup;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PageGroup;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PageGroup;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PageGroup;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PageGroup;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PageGroup;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): PageGroup;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PageGroup;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PageGroup;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): PageGroup;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): PageGroup;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): PageGroup;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): PageGroup;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PageGroup;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): PageGroup;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PageGroup;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PageGroup;
   ...
   * @see #removeField
   */
  unsetField(field: string): PageGroup;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PageGroup;
   ...
   * @see #unsetField
   */
  removeField(field: string): PageGroup;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PageGroup;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): PageGroup;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): PageGroup;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): PageGroup;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): PageGroup;

  mergeJson(json: any | null): PageGroup;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): PageGroup;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): PageGroup;
   ...
   */
  singletonArray(): C3.Array<PageGroup | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<PageGroup | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PageGroup | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<PageGroup | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PageGroup | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, PageGroup | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PageGroup | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PageGroup | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PageGroup | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): PageGroup;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): PageGroup;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): PageGroup;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PageGroup;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): PageGroup;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PageGroup;
   ...
   * @see #fromString
   */
  static make(s: string | null): PageGroup | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): PageGroup;
   ...
   */
  static cachedEmptyInst(): PageGroup;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<PageGroup>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): PageGroup;
   ...
   */
  static populateAcl(objs?: C3.Array<PageGroup | null>): number | null;
   ...
   */
  grantMemberReadUpdateRemove(member: AccessControlEntity): PageGroup;
   ...
   */
  mergeAclEntry(entry: AclEntry): PageGroup;
   ...
   * @return the obj with the new acl after merging the indicated entry.
   */
  mergeAclEntries(entries: C3.Array<AclEntry | null> | null): PageGroup;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<PageGroup | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PageGroup | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<PageGroup | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<PageGroup | null> | null>;
   ...
   */
  get(include?: string | null): PageGroup | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): PageGroup | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PageGroup;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): PageGroup | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PageGroup;
   ...
   * @see #toString
   */
  static fromString(s: string | null): PageGroup | null;
   ...
   */
  create(spec?: UpsertSpec | null): PageGroup | null;
   ...
   */
  static createBatch(objs: C3.Array<PageGroup | null> | null, spec?: UpsertSpec | null): ObjList<PageGroup | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PageGroup | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<PageGroup | null> | null;
   ...
   */
  update(srcObj?: PageGroup | null, spec?: UpsertSpec | null): PageGroup | null;
   ...
   */
  upsert(srcObj?: PageGroup | null, spec?: UpsertSpec | null): PageGroup | null;
   ...
   */
  merge(spec?: MergeSpec | null): PageGroup | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): PageGroup | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): PageGroup | null;
   ...
   */
  static updateBatch(objs: C3.Array<PageGroup | null> | null, srcObjs?: C3.Array<PageGroup | null>, spec?: UpsertSpec | null): ObjList<PageGroup | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<PageGroup | null>>, spec?: UpsertSpec | null): ObjList<PageGroup | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<PageGroup | null> | null, srcObjs?: C3.Array<PageGroup | null>, spec?: UpsertSpec | null): ObjList<PageGroup | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<PageGroup | null>>, spec?: UpsertSpec | null): ObjList<PageGroup | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<PageGroup | null> | null, spec?: TouchSpec | null): ObjList<PageGroup | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PageGroup | null> | null, spec?: MergeSpec | null): ObjList<PageGroup | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PageGroup | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<PageGroup | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<PageGroup | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<PageGroup | null> | null;
   ...
   */
  static mergeAll(mergeObj: PageGroup | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PageGroup | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<PageGroup | null> | null, spec?: UpsertSpec | null): ObjList<PageGroup | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<PageGroup | null> | null, spec?: UpsertSpec | null): ObjList<PageGroup | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<PageGroup | null> | null): ObjList<PageGroup | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<PageGroup | null> | null): ObjList<PageGroup | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<PageGroup | null> | null): ObjList<PageGroup | null>;
   ...
   */
  static afterCreate(objs: C3.Array<PageGroup | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<PageGroup | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<PageGroup | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<PageGroup | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<PageGroup | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): PageGroup | null;
   ...
   */
  withoutIdentity(): PageGroup | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<PageGroup | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: PageGroup | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<PageGroup | null> | null, callback?: λFunction<PageGroup | null, PageGroup | null> | null): ObjList<PageGroup | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<PageGroup | null> | null, callback?: λFunction<PageGroup | null, PageGroup | null> | null): C3.Array<ObjError | null>;
  ...
  /**
   * Grant access to a role for given PageGroup.
   *
   * @param pageId
   *           Id of PageGroup for which access will be granted.
   * @param roleId
   *           Id of Role to which access will be granted.
   * @param readOnlyAccess
   *           If true, acl will have read permissions only. Otherwise update access will be granted.
   * @return updated PageGroup.
   */
  static addRole(pageId: string, roleId: string, readOnlyAccess?: boolean): PageGroup | null;
   ...
   *           Id of Role to which access will be granted.
   * @param readOnly
   *           If true, acl will have read permissions only.
   * @return updated PageGroup.
   */
  static removeRole(pageId: string, roleId: string): PageGroup | null;

  /**
   * Get list of Permission for requested PageGroups
   */
  static getPermissions(pages?: C3.Array<PageGroup | null>): C3.Map<string | null, C3.Array<Permission | null>>;

  /**
   * Get list of permission for current pageGroup
   */
  permissions(): C3.Array<Permission | null>;

  /**
   * Get the PageGroups the calling user has access to.
   */
  static forUser(): C3.Array<PageGroup | null>;
}
