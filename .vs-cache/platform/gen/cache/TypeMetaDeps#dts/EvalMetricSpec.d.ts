// TypeScript definitions for the C3 type EvalMetricSpec

/**
 * Specification for evaluating multiple sources / metrics
 *
 * @remarks this represents a value passed to a method that expects an instance of EvalMetricSpec
 */
declare interface IEvalMetricSpec {
 ...
 */
declare class EvalMetricSpec extends Obj {
  ...
  withStart(start: DateTime | Date | string): EvalMetricSpec;
  ...
  withEnd(end: DateTime | Date | string): EvalMetricSpec;

  /**
   * Interval of timeseries.
   */
  readonly interval: string;
  withInterval(interval: string): EvalMetricSpec;
  ...
  withTimeZone(timeZone: ITimeZone | null): EvalMetricSpec;

  /**
   * length of this time-info in intervals. I.e. size of the timeseries this info represents.
   */
  readonly _size?: number | null;
  with_size(_size: number | null): EvalMetricSpec;

  /**
   * true if time range is aligned with interval.
   */
  readonly _isAligned?: boolean;
  with_isAligned(_isAligned: boolean): EvalMetricSpec;

  /**
   * Desired unit of evaluation. If specified, results will be converted to this unit.
   */
  readonly unitId?: string | null;
  withUnitId(unitId: string | null): EvalMetricSpec;

  /**
   * Include spec.
   */
  readonly include?: string | null;
  withInclude(include: string | null): EvalMetricSpec;
  ...
  withOptions(options: IEvalMetricsOptions | null): EvalMetricSpec;

  /**
   * If specified uses the following as the key field instead of id
   */
  readonly srcKey?: λFunction<Obj | null, string | null> | null;
  withSrcKey(srcKey: λFunction<Obj | null, string | null> | null): EvalMetricSpec;
  ...
  withCache(cache: boolean): EvalMetricSpec;
  ...
  withSources(sources: ICollection<Obj | null> | null): EvalMetricSpec;

  /**
   * Id for the source for the source type
   */
  readonly id?: string | null;
  withId(id: string | null): EvalMetricSpec;

  /**
   * Specify the expression that you want to evaluate. Could be a Simple / Compound Metrics or a combination
   */
  readonly expression: string;
  withExpression(expression: string): EvalMetricSpec;
  ...
  withBindings(bindings: C3.Map<string | null, any> | {[key: string | null]: any}): EvalMetricSpec;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): EvalMetricSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): EvalMetricSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): EvalMetricSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): EvalMetricSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): EvalMetricSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): EvalMetricSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): EvalMetricSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<EvalMetricSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<EvalMetricSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): EvalMetricSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): EvalMetricSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): EvalMetricSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): EvalMetricSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): EvalMetricSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): EvalMetricSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): EvalMetricSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): EvalMetricSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): EvalMetricSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): EvalMetricSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): EvalMetricSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): EvalMetricSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): EvalMetricSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): EvalMetricSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): EvalMetricSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): EvalMetricSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): EvalMetricSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): EvalMetricSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): EvalMetricSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): EvalMetricSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): EvalMetricSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): EvalMetricSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): EvalMetricSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): EvalMetricSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): EvalMetricSpec;

  mergeJson(json: any | null): EvalMetricSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): EvalMetricSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): EvalMetricSpec;
   ...
   */
  singletonArray(): C3.Array<EvalMetricSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<EvalMetricSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<EvalMetricSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<EvalMetricSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<EvalMetricSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, EvalMetricSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, EvalMetricSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<EvalMetricSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<EvalMetricSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): EvalMetricSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): EvalMetricSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): EvalMetricSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): EvalMetricSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): EvalMetricSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): EvalMetricSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): EvalMetricSpec;
   ...
   */
  static cachedEmptyInst(): EvalMetricSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<EvalMetricSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): EvalMetricSpec;
   ...
   */
  static last12Months(): EvalMetricSpec | null;
   ...
   */
  static prevLast12Months(): EvalMetricSpec | null;
   ...
   */
  static combineAndSort(timeRanges: C3.Array<TimeRange | null> | null): C3.Array<EvalMetricSpec | null>;

  /**
   * Merge various time ranges into a larger range
   * E.g. ["2014-01-01" -> "2014-02-01"], ["2015-01-01" -> "2016-01-01"] => {"2014-01-01" -> "2016-01-01"}
   */
  static coalesce(timeRanges: C3.Array<TimeRange | null> | null): EvalMetricSpec | null;
   ...
   */
  overlap(othr: TimeRange | null): EvalMetricSpec | null;
   ...
   */
  static fromPrettyPrint(prettyPrint: string): EvalMetricSpec;

  /**
   * Construct array of TimeRange from map<datetime, datetime>
   */
  static fromMap(map: C3.Map<DateTime | null, DateTime | null>): C3.Array<EvalMetricSpec | null>;
   ...
   */
  shift(offset: Duration): EvalMetricSpec;
