// TypeScript definitions for the C3 type PendingRefreshReq

/**
 * Pending refresh requests due to changes found in provisioning.
 *
 * @remarks this represents a value passed to a method that expects an instance of PendingRefreshReq
 */
declare interface IPendingRefreshReq {
 ...
 * Pending refresh requests due to changes found in provisioning.
 *
 * @remarks this represents a made instance of PendingRefreshReq
 */
declare class PendingRefreshReq extends Obj {
  ...
  withTypeIdent(typeIdent: string | null): PendingRefreshReq;
   ...
   */
  readonly id: string;
  withId(id: string): PendingRefreshReq;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): PendingRefreshReq;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): PendingRefreshReq;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): PendingRefreshReq;
  ...
  withVersion(version: number | null): PendingRefreshReq;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): PendingRefreshReq;

  /**
   * Type to refresh.
   */
  readonly refreshType?: Type | null;
  withRefreshType(refreshType: IType | null): PendingRefreshReq;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): PendingRefreshReq | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): PendingRefreshReq | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): PendingRefreshReq | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): PendingRefreshReq | null;
   ...
   */
  replaceType(old: Type, new_: Type): PendingRefreshReq;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PendingRefreshReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PendingRefreshReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PendingRefreshReq | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PendingRefreshReq | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): PendingRefreshReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PendingRefreshReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PendingRefreshReq;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PendingRefreshReq;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PendingRefreshReq;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PendingRefreshReq;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): PendingRefreshReq;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PendingRefreshReq;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PendingRefreshReq;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): PendingRefreshReq;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): PendingRefreshReq;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): PendingRefreshReq;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): PendingRefreshReq;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PendingRefreshReq;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): PendingRefreshReq;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PendingRefreshReq;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PendingRefreshReq;
   ...
   * @see #removeField
   */
  unsetField(field: string): PendingRefreshReq;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PendingRefreshReq;
   ...
   * @see #unsetField
   */
  removeField(field: string): PendingRefreshReq;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PendingRefreshReq;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): PendingRefreshReq;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): PendingRefreshReq;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): PendingRefreshReq;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): PendingRefreshReq;

  mergeJson(json: any | null): PendingRefreshReq;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): PendingRefreshReq;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): PendingRefreshReq;
   ...
   */
  singletonArray(): C3.Array<PendingRefreshReq | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<PendingRefreshReq | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PendingRefreshReq | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<PendingRefreshReq | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PendingRefreshReq | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, PendingRefreshReq | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PendingRefreshReq | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PendingRefreshReq | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PendingRefreshReq | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): PendingRefreshReq;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): PendingRefreshReq;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): PendingRefreshReq;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PendingRefreshReq;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): PendingRefreshReq;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PendingRefreshReq;
   ...
   * @see #fromString
   */
  static make(s: string | null): PendingRefreshReq | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): PendingRefreshReq;
   ...
   */
  static cachedEmptyInst(): PendingRefreshReq;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<PendingRefreshReq>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): PendingRefreshReq;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<PendingRefreshReq | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PendingRefreshReq | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<PendingRefreshReq | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<PendingRefreshReq | null> | null>;
   ...
   */
  get(include?: string | null): PendingRefreshReq | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): PendingRefreshReq | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PendingRefreshReq;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): PendingRefreshReq | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PendingRefreshReq;
   ...
   * @see #toString
   */
  static fromString(s: string | null): PendingRefreshReq | null;
   ...
   */
  create(spec?: UpsertSpec | null): PendingRefreshReq | null;
   ...
   */
  static createBatch(objs: C3.Array<PendingRefreshReq | null> | null, spec?: UpsertSpec | null): ObjList<PendingRefreshReq | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PendingRefreshReq | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<PendingRefreshReq | null> | null;
   ...
   */
  update(srcObj?: PendingRefreshReq | null, spec?: UpsertSpec | null): PendingRefreshReq | null;
   ...
   */
  upsert(srcObj?: PendingRefreshReq | null, spec?: UpsertSpec | null): PendingRefreshReq | null;
   ...
   */
  merge(spec?: MergeSpec | null): PendingRefreshReq | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): PendingRefreshReq | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): PendingRefreshReq | null;
   ...
   */
  static updateBatch(objs: C3.Array<PendingRefreshReq | null> | null, srcObjs?: C3.Array<PendingRefreshReq | null>, spec?: UpsertSpec | null): ObjList<PendingRefreshReq | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<PendingRefreshReq | null>>, spec?: UpsertSpec | null): ObjList<PendingRefreshReq | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<PendingRefreshReq | null> | null, srcObjs?: C3.Array<PendingRefreshReq | null>, spec?: UpsertSpec | null): ObjList<PendingRefreshReq | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<PendingRefreshReq | null>>, spec?: UpsertSpec | null): ObjList<PendingRefreshReq | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<PendingRefreshReq | null> | null, spec?: TouchSpec | null): ObjList<PendingRefreshReq | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PendingRefreshReq | null> | null, spec?: MergeSpec | null): ObjList<PendingRefreshReq | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PendingRefreshReq | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<PendingRefreshReq | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<PendingRefreshReq | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<PendingRefreshReq | null> | null;
   ...
   */
  static mergeAll(mergeObj: PendingRefreshReq | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PendingRefreshReq | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<PendingRefreshReq | null> | null, spec?: UpsertSpec | null): ObjList<PendingRefreshReq | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<PendingRefreshReq | null> | null, spec?: UpsertSpec | null): ObjList<PendingRefreshReq | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): PendingRefreshReq | null;
   ...
   */
  static beforeCreate(objs: C3.Array<PendingRefreshReq | null> | null): ObjList<PendingRefreshReq | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<PendingRefreshReq | null> | null): ObjList<PendingRefreshReq | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<PendingRefreshReq | null> | null): ObjList<PendingRefreshReq | null>;
   ...
   */
  static afterCreate(objs: C3.Array<PendingRefreshReq | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<PendingRefreshReq | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<PendingRefreshReq | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<PendingRefreshReq | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<PendingRefreshReq | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): PendingRefreshReq | null;
   ...
   */
  withoutIdentity(): PendingRefreshReq | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<PendingRefreshReq | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: PendingRefreshReq | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<PendingRefreshReq | null> | null, callback?: λFunction<PendingRefreshReq | null, PendingRefreshReq | null> | null): ObjList<PendingRefreshReq | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<PendingRefreshReq | null> | null, callback?: λFunction<PendingRefreshReq | null, PendingRefreshReq | null> | null): C3.Array<ObjError | null>;
