// TypeScript definitions for the C3 type EncryptedDek

/**
 * Entity type to represent metadata to enable {@link SymmetricCipher} to decrypt data encryption keys during decrypt
 * requests. Upon receiving a decrypt request, {@link SymmetricCipher} queries this table to fetch encrypted
 * data encryption key, decrypts it using active key encryption key and returns decrypted value.
 *
 * @remarks this represents a value passed to a method that expects an instance of EncryptedDek
 */
declare interface IEncryptedDek {
  ...
  /**
   * Data encryption key encrypted under key encryption key
   */
  encryptedDek: ICiphertext;
}
 ...
 * data encryption key, decrypts it using active key encryption key and returns decrypted value.
 *
 * @remarks this represents a made instance of EncryptedDek
 */
declare class EncryptedDek extends Obj {
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): EncryptedDek;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): EncryptedDek;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): EncryptedDek;
  ...
  withVersion(version: number | null): EncryptedDek;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): EncryptedDek;

  /**
   * Data Encryption Key Identifier
   */
  readonly dekId: string;
  withDekId(dekId: string): EncryptedDek;

  /**
   * Key encryption key identifier
   */
  readonly kekId: string;
  withKekId(kekId: string): EncryptedDek;

  /**
   * Data encryption key encrypted under key encryption key
   */
  readonly encryptedDek: Ciphertext;
  withEncryptedDek(encryptedDek: ICiphertext): EncryptedDek;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): EncryptedDek | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): EncryptedDek | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): EncryptedDek | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): EncryptedDek | null;
   ...
   */
  replaceType(old: Type, new_: Type): EncryptedDek;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): EncryptedDek;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): EncryptedDek;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<EncryptedDek | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<EncryptedDek | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): EncryptedDek;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): EncryptedDek;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): EncryptedDek;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): EncryptedDek;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): EncryptedDek;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): EncryptedDek;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): EncryptedDek;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): EncryptedDek;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): EncryptedDek;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): EncryptedDek;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): EncryptedDek;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): EncryptedDek;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): EncryptedDek;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): EncryptedDek;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): EncryptedDek;
   ...
   * @see #unsetField
   */
  defaultField(field: string): EncryptedDek;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): EncryptedDek;
   ...
   * @see #removeField
   */
  unsetField(field: string): EncryptedDek;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): EncryptedDek;
   ...
   * @see #unsetField
   */
  removeField(field: string): EncryptedDek;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): EncryptedDek;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): EncryptedDek;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): EncryptedDek;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): EncryptedDek;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): EncryptedDek;

  mergeJson(json: any | null): EncryptedDek;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): EncryptedDek;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): EncryptedDek;
   ...
   */
  singletonArray(): C3.Array<EncryptedDek | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<EncryptedDek | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<EncryptedDek | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<EncryptedDek | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<EncryptedDek | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, EncryptedDek | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, EncryptedDek | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<EncryptedDek | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<EncryptedDek | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): EncryptedDek;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): EncryptedDek;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): EncryptedDek;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): EncryptedDek;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): EncryptedDek;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): EncryptedDek;
   ...
   * @see #fromString
   */
  static make(s: string | null): EncryptedDek | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): EncryptedDek;
   ...
   */
  static cachedEmptyInst(): EncryptedDek;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<EncryptedDek>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): EncryptedDek;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<EncryptedDek | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<EncryptedDek | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<EncryptedDek | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): EncryptedDek | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string | null): EncryptedDek | null;
   ...
   * @see findByCacheKey
   */
  getCached(): EncryptedDek | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): EncryptedDek | null;
   ...
   */
  static produce(key: string): EncryptedDek | null;
   ...
   */
  static produceAll(): C3.Map<string | null, EncryptedDek | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, EncryptedDek | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<EncryptedDek | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<EncryptedDek | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<EncryptedDek | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<EncryptedDek | null> | null>;
   ...
   */
  get(include?: string | null): EncryptedDek | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): EncryptedDek | null;
   ...
   */
  getMissing(spec: GetMissingSpec): EncryptedDek;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): EncryptedDek | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): EncryptedDek;
   ...
   * @see #toString
   */
  static fromString(s: string | null): EncryptedDek | null;
   ...
   */
  create(spec?: UpsertSpec | null): EncryptedDek | null;
   ...
   */
  static createBatch(objs: C3.Array<EncryptedDek | null> | null, spec?: UpsertSpec | null): ObjList<EncryptedDek | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<EncryptedDek | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<EncryptedDek | null> | null;
   ...
   */
  update(srcObj?: EncryptedDek | null, spec?: UpsertSpec | null): EncryptedDek | null;
   ...
   */
  upsert(srcObj?: EncryptedDek | null, spec?: UpsertSpec | null): EncryptedDek | null;
   ...
   */
  merge(spec?: MergeSpec | null): EncryptedDek | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): EncryptedDek | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): EncryptedDek | null;
   ...
   */
  static updateBatch(objs: C3.Array<EncryptedDek | null> | null, srcObjs?: C3.Array<EncryptedDek | null>, spec?: UpsertSpec | null): ObjList<EncryptedDek | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<EncryptedDek | null>>, spec?: UpsertSpec | null): ObjList<EncryptedDek | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<EncryptedDek | null> | null, srcObjs?: C3.Array<EncryptedDek | null>, spec?: UpsertSpec | null): ObjList<EncryptedDek | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<EncryptedDek | null>>, spec?: UpsertSpec | null): ObjList<EncryptedDek | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<EncryptedDek | null> | null, spec?: TouchSpec | null): ObjList<EncryptedDek | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<EncryptedDek | null> | null, spec?: MergeSpec | null): ObjList<EncryptedDek | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<EncryptedDek | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<EncryptedDek | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<EncryptedDek | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<EncryptedDek | null> | null;
   ...
   */
  static mergeAll(mergeObj: EncryptedDek | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: EncryptedDek | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<EncryptedDek | null> | null, spec?: UpsertSpec | null): ObjList<EncryptedDek | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<EncryptedDek | null> | null, spec?: UpsertSpec | null): ObjList<EncryptedDek | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<EncryptedDek | null> | null): ObjList<EncryptedDek | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<EncryptedDek | null> | null): ObjList<EncryptedDek | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<EncryptedDek | null> | null): ObjList<EncryptedDek | null>;
   ...
   */
  static afterCreate(objs: C3.Array<EncryptedDek | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<EncryptedDek | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<EncryptedDek | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<EncryptedDek | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<EncryptedDek | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): EncryptedDek | null;
   ...
   */
  withoutIdentity(): EncryptedDek | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<EncryptedDek | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: EncryptedDek | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<EncryptedDek | null> | null, callback?: λFunction<EncryptedDek | null, EncryptedDek | null> | null): ObjList<EncryptedDek | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<EncryptedDek | null> | null, callback?: λFunction<EncryptedDek | null, EncryptedDek | null> | null): C3.Array<ObjError | null>;
