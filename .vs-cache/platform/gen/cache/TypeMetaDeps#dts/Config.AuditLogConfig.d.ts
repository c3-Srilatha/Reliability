// TypeScript definitions for the C3 type Config.AuditLogConfig
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Config.AuditLogConfig
 */
 ...
 */
declare namespace Config {
  export class AuditLogConfig extends Obj {

    readonly configOverride?: string | null;
    withConfigOverride(configOverride: string | null): Config.AuditLogConfig;

    static readonly configOverride?: string | null;

    readonly secretOverride?: string | null;
    withSecretOverride(secretOverride: string | null): Config.AuditLogConfig;
    ...
    withIssues(issues: C3.Array<string | null> | Array<string | null>): Config.AuditLogConfig;
    ...
    withDIR_NAME(DIR_NAME: string | null): Config.AuditLogConfig;

    /**
     * Name of the directory in filesystem to write the data
     */
    static readonly DIR_NAME?: string | null;

    /**
     * Name of the {@link KvStore.FileSystem.Config} for this type
     */
    readonly KVFS_CONFIG_NAME?: string | null;
    withKVFS_CONFIG_NAME(KVFS_CONFIG_NAME: string | null): Config.AuditLogConfig;

    /**
     * Name of the {@link KvStore.FileSystem.Config} for this type
     */
    static readonly KVFS_CONFIG_NAME?: string | null;

    /**
     * The string used to replace secret values in the audit log.
     */
    readonly SECRET_REDACTION_REPLACEMENT?: string | null;
    withSECRET_REDACTION_REPLACEMENT(SECRET_REDACTION_REPLACEMENT: string | null): Config.AuditLogConfig;

    /**
     * The string used to replace secret values in the audit log.
     */
    static readonly SECRET_REDACTION_REPLACEMENT?: string | null;

    /**
     * Set of {@link Type} names to exclude from auditing
     */
    readonly excludeTypes?: C3.Set<string | null>;
    withExcludeTypes(excludeTypes: C3.Set<string | null> | Array<string | null>): Config.AuditLogConfig;

    /**
     * Set of {@link Type} names to exclude from auditing
     */
    static readonly excludeTypes?: C3.Set<string | null>;

    /**
     * Whether to exclude all non-platform {@link Config}s from auditing
     */
    readonly excludeAllNonPlatformTypes?: boolean;
    withExcludeAllNonPlatformTypes(excludeAllNonPlatformTypes: boolean): Config.AuditLogConfig;

    /**
     * Whether to exclude all non-platform {@link Config}s from auditing
     */
    static readonly excludeAllNonPlatformTypes?: boolean;

    /**
     * Set of {@link User} ids to exempt from auditing. Configs modified by these users will not audited.
     */
    readonly excludeUserIds?: C3.Set<string | null>;
    withExcludeUserIds(excludeUserIds: C3.Set<string | null> | Array<string | null>): Config.AuditLogConfig;

    /**
     * Set of {@link User} ids to exempt from auditing. Configs modified by these users will not audited.
     */
    static readonly excludeUserIds?: C3.Set<string | null>;

    /**
     * Set of string serialized {@link App} ids to exclude from auditing
     */
    readonly excludeAppIds?: C3.Set<string | null>;
    withExcludeAppIds(excludeAppIds: C3.Set<string | null> | Array<string | null>): Config.AuditLogConfig;

    /**
     * Set of string serialized {@link App} ids to exclude from auditing
     */
    static readonly excludeAppIds?: C3.Set<string | null>;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Config.AuditLogConfig | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Config.AuditLogConfig | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Config.AuditLogConfig | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Config.AuditLogConfig | null;
     ...
     */
    replaceType(old: Type, new_: Type): Config.AuditLogConfig;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Config.AuditLogConfig;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Config.AuditLogConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Config.AuditLogConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Config.AuditLogConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Config.AuditLogConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Config.AuditLogConfig | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Config.AuditLogConfig | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Config.AuditLogConfig | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Config.AuditLogConfig | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Config.AuditLogConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Config.AuditLogConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Config.AuditLogConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Config.AuditLogConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Config.AuditLogConfig;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Config.AuditLogConfig;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Config.AuditLogConfig;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Config.AuditLogConfig;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Config.AuditLogConfig;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Config.AuditLogConfig;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Config.AuditLogConfig;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Config.AuditLogConfig;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Config.AuditLogConfig;
     ...
     * @return new Obj
     */
    static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Config.AuditLogConfig;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Config.AuditLogConfig;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Config.AuditLogConfig;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Config.AuditLogConfig;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Config.AuditLogConfig;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Config.AuditLogConfig;
     ...
     * @see #removeField
     */
    static withoutField(field: string | null): Config.AuditLogConfig;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Config.AuditLogConfig;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType | null): Config.AuditLogConfig;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Config.AuditLogConfig;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: C3.Array<string | null> | null): Config.AuditLogConfig;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Config.AuditLogConfig;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Config.AuditLogConfig;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Config.AuditLogConfig;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Config.AuditLogConfig;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Config.AuditLogConfig;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Config.AuditLogConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Config.AuditLogConfig;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Config.AuditLogConfig;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Config.AuditLogConfig;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Config.AuditLogConfig;
     ...
     * @see #removeField
     */
    unsetField(field: string): Config.AuditLogConfig;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Config.AuditLogConfig;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Config.AuditLogConfig;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Config.AuditLogConfig;
     ...
     * @see #unsetField
     */
    removeField(field: string): Config.AuditLogConfig;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Config.AuditLogConfig;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Config.AuditLogConfig;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Config.AuditLogConfig;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Config.AuditLogConfig;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Config.AuditLogConfig;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Config.AuditLogConfig;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj | null, otherFieldsFilter: Type): Config.AuditLogConfig;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Config.AuditLogConfig;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Config.AuditLogConfig;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Config.AuditLogConfig;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Config.AuditLogConfig;

    mergeJson(json: any | null): Config.AuditLogConfig;

    static mergeJson(json: any | null): Config.AuditLogConfig;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Config.AuditLogConfig;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Config.AuditLogConfig;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Config.AuditLogConfig;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj | null, deep?: boolean): Config.AuditLogConfig;
     ...
     */
    singletonArray(): C3.Array<Config.AuditLogConfig | null>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): C3.Array<Config.AuditLogConfig | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Config.AuditLogConfig | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Config.AuditLogConfig | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Config.AuditLogConfig | null>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): C3.Set<Config.AuditLogConfig | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Config.AuditLogConfig | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Config.AuditLogConfig | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Config.AuditLogConfig | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Config.AuditLogConfig | null>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Config.AuditLogConfig | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Config.AuditLogConfig | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Config.AuditLogConfig;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Config.AuditLogConfig;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Config.AuditLogConfig;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Config.AuditLogConfig;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Config.AuditLogConfig;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Config.AuditLogConfig;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Config.AuditLogConfig;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Config.AuditLogConfig;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): Config.AuditLogConfig;
     ...
     */
    static cachedEmptyInst(): Config.AuditLogConfig;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Config.AuditLogConfig>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Config.AuditLogConfig;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<Config.AuditLogConfig | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<Config.AuditLogConfig | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<Config.AuditLogConfig | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): Config.AuditLogConfig | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string | null): Config.AuditLogConfig | null;
     ...
     * @see findByCacheKey
     */
    getCached(): Config.AuditLogConfig | null;
     ...
     * @see findByCacheKey
     */
    static getCached(): Config.AuditLogConfig | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): Config.AuditLogConfig | null;

    /**
     * @return newly produced cached instance.
     */
    static refreshCache(): Config.AuditLogConfig | null;
     ...
     */
    static produce(key: string): Config.AuditLogConfig | null;
     ...
     */
    static produceAll(): C3.Map<string | null, Config.AuditLogConfig | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, Config.AuditLogConfig | null>;
     ...
     */
    getConfig(): Config.AuditLogConfig;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): Config.AuditLogConfig;
     ...
     */
    getSecret(): Config.AuditLogConfig;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): Config.AuditLogConfig;
     ...
     */
    static forConfigKey(configKey: string | null): Config.AuditLogConfig | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<Config.AuditLogConfig | null>;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Config.AuditLogConfig, override?: string | null): void;

    /**
     * Sets multiple field values to be the same as the passed instance.
     * @see setConfigValue
     */
    static setConfigValues(from: Config.AuditLogConfig, override?: string | null): void;
     ...
     * @see setSecretValue
     */
    setSecretValues(from: Config.AuditLogConfig, override?: string | null): void;

    /**
     * Sets multiple secret field values to be the same as the passed instance.
     * @see setSecretValue
     */
    static setSecretValues(from: Config.AuditLogConfig, override?: string | null): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Config.AuditLogConfig | null;
     ...
     */
    removeSecrets(): Config.AuditLogConfig | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): Config.AuditLogConfig | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Config.AuditLogConfig | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): Config.AuditLogConfig | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): Config.AuditLogConfig;
     ...
     */
    shouldExclude(auditLog: Config.AuditLog): boolean;
     ...
     *           Returns whether a provided {@Config.AuditLog} should be upserted to the database given the exclusion specified on the current instance of the {@link Config.AuditLog.Config}
     */
    static shouldExclude(auditLog: Config.AuditLog): boolean;
  }
}
