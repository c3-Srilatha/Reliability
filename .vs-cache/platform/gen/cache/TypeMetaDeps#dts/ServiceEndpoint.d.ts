// TypeScript definitions for the C3 type ServiceEndpoint

/**
 * @remarks this represents a value passed to a method that expects an instance of ServiceEndpoint
 */
declare interface IServiceEndpoint {
  ...
  /**
   * will be matched against <vanity>;<request-uri>
   */
  addrRegex?: string | null;

  endpoint?: string | null;
}

/**
 * @remarks this represents a made instance of ServiceEndpoint
 */
declare class ServiceEndpoint extends Obj {
   ...
   */
  readonly id: string;
  withId(id: string): ServiceEndpoint;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): ServiceEndpoint;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): ServiceEndpoint;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): ServiceEndpoint;
  ...
  withVersion(version: number | null): ServiceEndpoint;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): ServiceEndpoint;

  /**
   * will be matched against <vanity>;<request-uri>
   */
  readonly addrRegex?: string | null;
  withAddrRegex(addrRegex: string | null): ServiceEndpoint;

  readonly endpoint?: string | null;
  withEndpoint(endpoint: string | null): ServiceEndpoint;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ServiceEndpoint | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ServiceEndpoint | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ServiceEndpoint | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ServiceEndpoint | null;
   ...
   */
  replaceType(old: Type, new_: Type): ServiceEndpoint;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ServiceEndpoint;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ServiceEndpoint;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ServiceEndpoint | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ServiceEndpoint | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ServiceEndpoint;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ServiceEndpoint;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ServiceEndpoint;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ServiceEndpoint;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ServiceEndpoint;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ServiceEndpoint;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ServiceEndpoint;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ServiceEndpoint;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ServiceEndpoint;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ServiceEndpoint;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ServiceEndpoint;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ServiceEndpoint;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ServiceEndpoint;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ServiceEndpoint;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ServiceEndpoint;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ServiceEndpoint;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ServiceEndpoint;
   ...
   * @see #removeField
   */
  unsetField(field: string): ServiceEndpoint;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ServiceEndpoint;
   ...
   * @see #unsetField
   */
  removeField(field: string): ServiceEndpoint;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ServiceEndpoint;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ServiceEndpoint;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ServiceEndpoint;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ServiceEndpoint;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ServiceEndpoint;

  mergeJson(json: any | null): ServiceEndpoint;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ServiceEndpoint;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ServiceEndpoint;
   ...
   */
  singletonArray(): C3.Array<ServiceEndpoint | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ServiceEndpoint | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ServiceEndpoint | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ServiceEndpoint | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ServiceEndpoint | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ServiceEndpoint | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ServiceEndpoint | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ServiceEndpoint | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ServiceEndpoint | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ServiceEndpoint;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ServiceEndpoint;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ServiceEndpoint;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ServiceEndpoint;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ServiceEndpoint;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ServiceEndpoint;
   ...
   * @see #fromString
   */
  static make(s: string | null): ServiceEndpoint | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ServiceEndpoint;
   ...
   */
  static cachedEmptyInst(): ServiceEndpoint;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ServiceEndpoint>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ServiceEndpoint;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<ServiceEndpoint | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ServiceEndpoint | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<ServiceEndpoint | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<ServiceEndpoint | null> | null>;
   ...
   */
  get(include?: string | null): ServiceEndpoint | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): ServiceEndpoint | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ServiceEndpoint;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): ServiceEndpoint | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ServiceEndpoint;
   ...
   * @see #toString
   */
  static fromString(s: string | null): ServiceEndpoint | null;
   ...
   */
  create(spec?: UpsertSpec | null): ServiceEndpoint | null;
   ...
   */
  static createBatch(objs: C3.Array<ServiceEndpoint | null> | null, spec?: UpsertSpec | null): ObjList<ServiceEndpoint | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ServiceEndpoint | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<ServiceEndpoint | null> | null;
   ...
   */
  update(srcObj?: ServiceEndpoint | null, spec?: UpsertSpec | null): ServiceEndpoint | null;
   ...
   */
  upsert(srcObj?: ServiceEndpoint | null, spec?: UpsertSpec | null): ServiceEndpoint | null;
   ...
   */
  merge(spec?: MergeSpec | null): ServiceEndpoint | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): ServiceEndpoint | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): ServiceEndpoint | null;
   ...
   */
  static updateBatch(objs: C3.Array<ServiceEndpoint | null> | null, srcObjs?: C3.Array<ServiceEndpoint | null>, spec?: UpsertSpec | null): ObjList<ServiceEndpoint | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<ServiceEndpoint | null>>, spec?: UpsertSpec | null): ObjList<ServiceEndpoint | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<ServiceEndpoint | null> | null, srcObjs?: C3.Array<ServiceEndpoint | null>, spec?: UpsertSpec | null): ObjList<ServiceEndpoint | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<ServiceEndpoint | null>>, spec?: UpsertSpec | null): ObjList<ServiceEndpoint | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<ServiceEndpoint | null> | null, spec?: TouchSpec | null): ObjList<ServiceEndpoint | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<ServiceEndpoint | null> | null, spec?: MergeSpec | null): ObjList<ServiceEndpoint | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<ServiceEndpoint | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<ServiceEndpoint | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<ServiceEndpoint | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<ServiceEndpoint | null> | null;
   ...
   */
  static mergeAll(mergeObj: ServiceEndpoint | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ServiceEndpoint | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<ServiceEndpoint | null> | null, spec?: UpsertSpec | null): ObjList<ServiceEndpoint | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<ServiceEndpoint | null> | null, spec?: UpsertSpec | null): ObjList<ServiceEndpoint | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<ServiceEndpoint | null> | null): ObjList<ServiceEndpoint | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<ServiceEndpoint | null> | null): ObjList<ServiceEndpoint | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<ServiceEndpoint | null> | null): ObjList<ServiceEndpoint | null>;
   ...
   */
  static afterCreate(objs: C3.Array<ServiceEndpoint | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<ServiceEndpoint | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<ServiceEndpoint | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<ServiceEndpoint | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<ServiceEndpoint | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): ServiceEndpoint | null;
   ...
   */
  withoutIdentity(): ServiceEndpoint | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<ServiceEndpoint | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: ServiceEndpoint | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<ServiceEndpoint | null> | null, callback?: λFunction<ServiceEndpoint | null, ServiceEndpoint | null> | null): ObjList<ServiceEndpoint | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<ServiceEndpoint | null> | null, callback?: λFunction<ServiceEndpoint | null, ServiceEndpoint | null> | null): C3.Array<ObjError | null>;
