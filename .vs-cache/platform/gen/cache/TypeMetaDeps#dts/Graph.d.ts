// TypeScript definitions for the C3 type Graph

/**
 * @remarks this represents a value passed to a method that expects an instance of Graph
 */
declare interface IGraph<V, E> {
}

/**
 * @remarks this represents a made instance of Graph
 */
declare class Graph<V, E> extends Obj {
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Graph<V, E> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Graph<V, E> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Graph<V, E> | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Graph<V, E> | null;
   ...
   */
  replaceType(old: Type, new_: Type): Graph<V, E>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Graph<V, E>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Graph<V, E>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Graph<V, E> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Graph<V, E> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Graph<V, E>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Graph<V, E>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Graph<V, E>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): Graph<V, E>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Graph<V, E>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Graph<V, E>;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Graph<V, E>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Graph<V, E>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Graph<V, E>;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Graph<V, E>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Graph<V, E>;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Graph<V, E>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Graph<V, E>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Graph<V, E>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Graph<V, E>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Graph<V, E>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Graph<V, E>;
   ...
   * @see #removeField
   */
  unsetField(field: string): Graph<V, E>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Graph<V, E>;
   ...
   * @see #unsetField
   */
  removeField(field: string): Graph<V, E>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Graph<V, E>;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Graph<V, E>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Graph<V, E>;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Graph<V, E>;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Graph<V, E>;

  mergeJson(json: any | null): Graph<V, E>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Graph<V, E>;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Graph<V, E>;
   ...
   */
  singletonArray(): C3.Array<Graph<V, E> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Graph<V, E> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Graph<V, E> | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Graph<V, E> | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Graph<V, E> | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Graph<V, E> | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Graph<V, E> | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Graph<V, E> | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Graph<V, E> | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Graph<V, E>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Graph<V, E>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Graph<V, E>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Graph<V, E>;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Graph<V, E>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Graph<V, E>;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Graph<V, E>;
   ...
   */
  static cachedEmptyInst(): Graph<V, E>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Graph<V, E>>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Graph<V, E>;
