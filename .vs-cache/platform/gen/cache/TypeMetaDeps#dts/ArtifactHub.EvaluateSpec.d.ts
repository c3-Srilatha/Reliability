// TypeScript definitions for the C3 type ArtifactHub.EvaluateSpec

/**
 * A spec used to help evaluate projections on {@link ArtifactHub.Artifact}s registered in {@link ArtifactHub}.
 *
 * @remarks this represents a value passed to a method that expects an instance of ArtifactHub.EvaluateSpec
 */
declare namespace ArtifactHub {
  export interface IEvaluateSpec {
 ...
 * A spec used to help evaluate projections on {@link ArtifactHub.Artifact}s registered in {@link ArtifactHub}.
 *
 * @remarks this represents a made instance of ArtifactHub.EvaluateSpec
 */
declare namespace ArtifactHub {
  export class EvaluateSpec extends Obj {

    /**
     * Maintains a list of visited {@link ArtifactHub}s that are federated across network hops to prevent infinite loops.
     */
    readonly visited?: C3.Array<string | null>;
    withVisited(visited: C3.Array<string | null> | Array<string | null>): ArtifactHub.EvaluateSpec;
    ...
    withClientVersion(clientVersion: string | null): ArtifactHub.EvaluateSpec;

    /**
     * Whether or not this request should go upstream to a central hub.
     */
    readonly doNotGoUpstream?: boolean;
    withDoNotGoUpstream(doNotGoUpstream: boolean): ArtifactHub.EvaluateSpec;
    ...
    withProjection(projection: string): ArtifactHub.EvaluateSpec;
    ...
    withGroup(group: string | null): ArtifactHub.EvaluateSpec;
    ...
    withHaving(having: string | null): ArtifactHub.EvaluateSpec;
    ...
    withFilter(filter: string | null): ArtifactHub.EvaluateSpec;

    /**
     * Variables values to substitute in filter expression. CURRENTLY UNDER CONSTRUCTION!
     */
    readonly vars?: C3.Map<string | null, Obj | null>;
    withVars(vars: C3.Map<string | null, Obj | null> | {[key: string | null]: IObj | null}): ArtifactHub.EvaluateSpec;
    ...
    withFetchHiddenSeedData(fetchHiddenSeedData: boolean): ArtifactHub.EvaluateSpec;
    ...
    withExcludeExtensions(excludeExtensions: boolean): ArtifactHub.EvaluateSpec;
    ...
    withAsOf(asOf: DateTime | Date | string | null): ArtifactHub.EvaluateSpec;
    ...
    withAllowLiteralOnBindVariableOverflow(allowLiteralOnBindVariableOverflow: boolean): ArtifactHub.EvaluateSpec;
    ...
    withUseDedicatedConnection(useDedicatedConnection: boolean): ArtifactHub.EvaluateSpec;
    ...
    withStmtTimeoutMs(stmtTimeoutMs: number | null): ArtifactHub.EvaluateSpec;
    ...
    withDontThrowJsonDeserErrors(dontThrowJsonDeserErrors: boolean): ArtifactHub.EvaluateSpec;
    ...
    withTimeRange(timeRange: ITimeRange | null): ArtifactHub.EvaluateSpec;
    ...
    withTimedFetchParentField(timedFetchParentField: string | null): ArtifactHub.EvaluateSpec;

    readonly includeBaseTypes?: boolean;
    withIncludeBaseTypes(includeBaseTypes: boolean): ArtifactHub.EvaluateSpec;
    ...
    withIgnoreViewInclude(ignoreViewInclude: boolean): ArtifactHub.EvaluateSpec;
    ...
    withOrder(order: string | null): ArtifactHub.EvaluateSpec;

    /**
     * Offset to use for paged evaluation.  Indicates the first computed result to return. Default is 0 (first).
     */
    readonly offset?: number | null;
    withOffset(offset: number | null): ArtifactHub.EvaluateSpec;
    ...
    withLimit(limit: number | null): ArtifactHub.EvaluateSpec;
    ...
    withSqlId(sqlId: number | null): ArtifactHub.EvaluateSpec;
    ...
    withDisableAuthz(disableAuthz: boolean): ArtifactHub.EvaluateSpec;
    ...
    withForceExprEval(forceExprEval: boolean): ArtifactHub.EvaluateSpec;
    ...
    withForceDbEngineEval(forceDbEngineEval: boolean): ArtifactHub.EvaluateSpec;
    ...
    withTimeRangeStart(timeRangeStart: DateTime | Date | string | null): ArtifactHub.EvaluateSpec;
    ...
    withTimeRangeEnd(timeRangeEnd: DateTime | Date | string | null): ArtifactHub.EvaluateSpec;
    ...
    withGrain(grain: string | null): ArtifactHub.EvaluateSpec;
    ...
    withInterval(interval: string | null): ArtifactHub.EvaluateSpec;
    ...
    withTimeZone(timeZone: string | null): ArtifactHub.EvaluateSpec;
    ...
    withExplain(explain: boolean): ArtifactHub.EvaluateSpec;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): ArtifactHub.EvaluateSpec | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): ArtifactHub.EvaluateSpec | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): ArtifactHub.EvaluateSpec | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): ArtifactHub.EvaluateSpec | null;
     ...
     */
    replaceType(old: Type, new_: Type): ArtifactHub.EvaluateSpec;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ArtifactHub.EvaluateSpec;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ArtifactHub.EvaluateSpec;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ArtifactHub.EvaluateSpec | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ArtifactHub.EvaluateSpec | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ArtifactHub.EvaluateSpec;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ArtifactHub.EvaluateSpec;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ArtifactHub.EvaluateSpec;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): ArtifactHub.EvaluateSpec;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): ArtifactHub.EvaluateSpec;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): ArtifactHub.EvaluateSpec;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ArtifactHub.EvaluateSpec;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ArtifactHub.EvaluateSpec;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): ArtifactHub.EvaluateSpec;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): ArtifactHub.EvaluateSpec;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): ArtifactHub.EvaluateSpec;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): ArtifactHub.EvaluateSpec;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ArtifactHub.EvaluateSpec;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): ArtifactHub.EvaluateSpec;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ArtifactHub.EvaluateSpec;
     ...
     * @see #unsetField
     */
    defaultField(field: string): ArtifactHub.EvaluateSpec;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): ArtifactHub.EvaluateSpec;
     ...
     * @see #removeField
     */
    unsetField(field: string): ArtifactHub.EvaluateSpec;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): ArtifactHub.EvaluateSpec;
     ...
     * @see #unsetField
     */
    removeField(field: string): ArtifactHub.EvaluateSpec;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): ArtifactHub.EvaluateSpec;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ArtifactHub.EvaluateSpec;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): ArtifactHub.EvaluateSpec;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ArtifactHub.EvaluateSpec;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ArtifactHub.EvaluateSpec;

    mergeJson(json: any | null): ArtifactHub.EvaluateSpec;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ArtifactHub.EvaluateSpec;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): ArtifactHub.EvaluateSpec;
     ...
     */
    singletonArray(): C3.Array<ArtifactHub.EvaluateSpec | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<ArtifactHub.EvaluateSpec | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<ArtifactHub.EvaluateSpec | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<ArtifactHub.EvaluateSpec | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<ArtifactHub.EvaluateSpec | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, ArtifactHub.EvaluateSpec | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, ArtifactHub.EvaluateSpec | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<ArtifactHub.EvaluateSpec | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<ArtifactHub.EvaluateSpec | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ArtifactHub.EvaluateSpec;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ArtifactHub.EvaluateSpec;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ArtifactHub.EvaluateSpec;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): ArtifactHub.EvaluateSpec;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ArtifactHub.EvaluateSpec;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): ArtifactHub.EvaluateSpec;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ArtifactHub.EvaluateSpec;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): ArtifactHub.EvaluateSpec;
     ...
     */
    static cachedEmptyInst(): ArtifactHub.EvaluateSpec;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ArtifactHub.EvaluateSpec>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): ArtifactHub.EvaluateSpec;
