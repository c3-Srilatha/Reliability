// TypeScript definitions for the C3 type HttpSecurityConfig

/**
 * Configuration options for various security features pertaining to an AppUrl.
 *
 * @remarks this represents a value passed to a method that expects an instance of HttpSecurityConfig
 */
declare interface IHttpSecurityConfig {
  ...
  /**
   * Flag to enable csrf token generation and checking
   */
  csrfProtection?: boolean;

  /**
   * Flag to enable origin checks and disallow origins that
   * are not present in the allowedOrigins field
   */
  originFilter?: boolean;

  /**
   * If set to true, the Origin/Referer Header check is performed using a hostname match instead of a complete string match.
   */
  originFilterHostnameMatch?: boolean;

  /**
   * The allowedOrigins are checked against the 'Origin' request header.
   * Or in it's absence, the 'Referer' request header.
   * Note that the entries must be valid and parseable URLs, if originFilterHostnameMatch is set to true.
   */
  allowedOrigins: C3.Array<string | null> | Array<string | null>;

  /**
   * The allowedHeaders are provided in response to the 'Access-Control-Request-Headers' preflight request header.
   * Note that entries must be valid HTTP header names.
   */
  allowedHeaders?: C3.Array<string | null> | Array<string | null>;

  corsEnabled: boolean;

  varyHeader: string;

  xssHeaderEnabled: boolean;

  xssBlockModeEnabled: boolean;

  cacheControlHeaderEnabled: boolean;
 ...
 * Configuration options for various security features pertaining to an AppUrl.
 *
 * @remarks this represents a made instance of HttpSecurityConfig
 */
declare class HttpSecurityConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): HttpSecurityConfig;

  static readonly configOverride?: string | null;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): HttpSecurityConfig;
  ...
  withIssues(issues: C3.Array<string | null> | Array<string | null>): HttpSecurityConfig;
  ...
  withCsrfProtection(csrfProtection: boolean): HttpSecurityConfig;

  /**
   * Flag to enable csrf token generation and checking
   */
  static readonly csrfProtection?: boolean;
  ...
  withOriginFilter(originFilter: boolean): HttpSecurityConfig;

  /**
   * Flag to enable origin checks and disallow origins that
   * are not present in the allowedOrigins field
   */
  static readonly originFilter?: boolean;

  /**
   * If set to true, the Origin/Referer Header check is performed using a hostname match instead of a complete string match.
   */
  readonly originFilterHostnameMatch?: boolean;
  withOriginFilterHostnameMatch(originFilterHostnameMatch: boolean): HttpSecurityConfig;

  /**
   * If set to true, the Origin/Referer Header check is performed using a hostname match instead of a complete string match.
   */
  static readonly originFilterHostnameMatch?: boolean;
   ...
   * Note that the entries must be valid and parseable URLs, if originFilterHostnameMatch is set to true.
   */
  readonly allowedOrigins: C3.Array<string | null>;
  withAllowedOrigins(allowedOrigins: C3.Array<string | null> | Array<string | null>): HttpSecurityConfig;
   ...
   * Note that the entries must be valid and parseable URLs, if originFilterHostnameMatch is set to true.
   */
  static readonly allowedOrigins: C3.Array<string | null>;

  /**
   * The allowedHeaders are provided in response to the 'Access-Control-Request-Headers' preflight request header.
   * Note that entries must be valid HTTP header names.
   */
  readonly allowedHeaders?: C3.Array<string | null>;
  withAllowedHeaders(allowedHeaders: C3.Array<string | null> | Array<string | null>): HttpSecurityConfig;

  /**
   * The allowedHeaders are provided in response to the 'Access-Control-Request-Headers' preflight request header.
   * Note that entries must be valid HTTP header names.
   */
  static readonly allowedHeaders?: C3.Array<string | null>;

  readonly corsEnabled: boolean;
  withCorsEnabled(corsEnabled: boolean): HttpSecurityConfig;

  static readonly corsEnabled: boolean;

  readonly varyHeader: string;
  withVaryHeader(varyHeader: string): HttpSecurityConfig;

  static readonly varyHeader: string;

  readonly xssHeaderEnabled: boolean;
  withXssHeaderEnabled(xssHeaderEnabled: boolean): HttpSecurityConfig;

  static readonly xssHeaderEnabled: boolean;

  readonly xssBlockModeEnabled: boolean;
  withXssBlockModeEnabled(xssBlockModeEnabled: boolean): HttpSecurityConfig;

  static readonly xssBlockModeEnabled: boolean;

  readonly cacheControlHeaderEnabled: boolean;
  withCacheControlHeaderEnabled(cacheControlHeaderEnabled: boolean): HttpSecurityConfig;

  static readonly cacheControlHeaderEnabled: boolean;

  readonly cspHeader: string;
  withCspHeader(cspHeader: string): HttpSecurityConfig;

  static readonly cspHeader: string;

  readonly xFrameOptionsHeader: string;
  withXFrameOptionsHeader(xFrameOptionsHeader: string): HttpSecurityConfig;

  static readonly xFrameOptionsHeader: string;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): HttpSecurityConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): HttpSecurityConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): HttpSecurityConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): HttpSecurityConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): HttpSecurityConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): HttpSecurityConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HttpSecurityConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HttpSecurityConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HttpSecurityConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HttpSecurityConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HttpSecurityConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HttpSecurityConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HttpSecurityConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HttpSecurityConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): HttpSecurityConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): HttpSecurityConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HttpSecurityConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HttpSecurityConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HttpSecurityConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HttpSecurityConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): HttpSecurityConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): HttpSecurityConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): HttpSecurityConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): HttpSecurityConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): HttpSecurityConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): HttpSecurityConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): HttpSecurityConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): HttpSecurityConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): HttpSecurityConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): HttpSecurityConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): HttpSecurityConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): HttpSecurityConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): HttpSecurityConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): HttpSecurityConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): HttpSecurityConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): HttpSecurityConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): HttpSecurityConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): HttpSecurityConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): HttpSecurityConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): HttpSecurityConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): HttpSecurityConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): HttpSecurityConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): HttpSecurityConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): HttpSecurityConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): HttpSecurityConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): HttpSecurityConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): HttpSecurityConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): HttpSecurityConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): HttpSecurityConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): HttpSecurityConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): HttpSecurityConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): HttpSecurityConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): HttpSecurityConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): HttpSecurityConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): HttpSecurityConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): HttpSecurityConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): HttpSecurityConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): HttpSecurityConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): HttpSecurityConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): HttpSecurityConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): HttpSecurityConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): HttpSecurityConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): HttpSecurityConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): HttpSecurityConfig;

  mergeJson(json: any | null): HttpSecurityConfig;

  static mergeJson(json: any | null): HttpSecurityConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): HttpSecurityConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): HttpSecurityConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): HttpSecurityConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): HttpSecurityConfig;
   ...
   */
  singletonArray(): C3.Array<HttpSecurityConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<HttpSecurityConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<HttpSecurityConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<HttpSecurityConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<HttpSecurityConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<HttpSecurityConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<HttpSecurityConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, HttpSecurityConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, HttpSecurityConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<HttpSecurityConfig | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<HttpSecurityConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<HttpSecurityConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): HttpSecurityConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): HttpSecurityConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): HttpSecurityConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): HttpSecurityConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): HttpSecurityConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): HttpSecurityConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): HttpSecurityConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): HttpSecurityConfig;
   ...
   */
  static cachedEmptyInst(): HttpSecurityConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<HttpSecurityConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): HttpSecurityConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<HttpSecurityConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<HttpSecurityConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<HttpSecurityConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): HttpSecurityConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): HttpSecurityConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): HttpSecurityConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): HttpSecurityConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): HttpSecurityConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): HttpSecurityConfig | null;
   ...
   */
  static produce(key: string): HttpSecurityConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, HttpSecurityConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, HttpSecurityConfig | null>;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): HttpSecurityConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): HttpSecurityConfig;
   ...
   */
  static forConfigKey(configKey: string | null): HttpSecurityConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<HttpSecurityConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: HttpSecurityConfig, override?: string | null): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: HttpSecurityConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: HttpSecurityConfig, override?: string | null): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: HttpSecurityConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): HttpSecurityConfig | null;
   ...
   */
  removeSecrets(): HttpSecurityConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): HttpSecurityConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): HttpSecurityConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): HttpSecurityConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): HttpSecurityConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): HttpSecurityConfig;
