// TypeScript definitions for the C3 type FilesObjsOperSpec

/**
 * @remarks this represents a value passed to a method that expects an instance of FilesObjsOperSpec
 */
declare interface IFilesObjsOperSpec {
  ...
  /**
   * A list of string serialized {@link FileUrl} of files. When specified, these files will be used for read.
   */
  fileUrls?: C3.Array<string | null> | Array<string | null>;
}

/**
 * @remarks this represents a made instance of FilesObjsOperSpec
 */
declare class FilesObjsOperSpec extends Obj {

  /**
   * Data serialization type. If not provided type will be inferred from source data
   */
  readonly serValueType?: ValueType | null;
  withSerValueType(serValueType: IValueType | null): FilesObjsOperSpec;

  /**
   * Content Type of the source data
   */
  readonly contentType?: string | null;
  withContentType(contentType: string | null): FilesObjsOperSpec;

  /**
   * Compression / Content Encoding of this data
   */
  readonly contentEncoding?: string | null;
  withContentEncoding(contentEncoding: string | null): FilesObjsOperSpec;

  /**
   * Batch size to use during serialization if batch writing is used (Arrow format uses batching).
   */
  readonly batchSize?: number | null;
  withBatchSize(batchSize: number | null): FilesObjsOperSpec;
  ...
  withNoCsvHeader(noCsvHeader: boolean): FilesObjsOperSpec;
  ...
  withCsvHeader(csvHeader: string | null): FilesObjsOperSpec;

  /**
   * Optional format for a csv values. Key should be field path used in a csv header.
   */
  readonly csvFormat?: C3.Map<string | null, Format | null>;
  withCsvFormat(csvFormat: C3.Map<string | null, Format | null> | {[key: string | null]: IFormat | null}): FilesObjsOperSpec;

  /**
   * Default csv delimiter for target type. Used for text/csv files. Leave this field as null for all other content types.
   */
  readonly defaultCsvDelimiter?: string | null;
  withDefaultCsvDelimiter(defaultCsvDelimiter: string | null): FilesObjsOperSpec;

  /**
   * Default escape character for target type. Used for text/csv files. Leave this field as null for all other content types.
   */
  readonly defaultCsvEscapeChar?: string | null;
  withDefaultCsvEscapeChar(defaultCsvEscapeChar: string | null): FilesObjsOperSpec;

  /**
   * Default quote character for target type. Used for text/csv files. Leave this field as null for all other content types.
   */
  readonly defaultCsvQuoteChar?: string | null;
  withDefaultCsvQuoteChar(defaultCsvQuoteChar: string | null): FilesObjsOperSpec;
  ...
  withAvroSchema(avroSchema: string | null): FilesObjsOperSpec;
  ...
  withIsObjList(isObjList: boolean): FilesObjsOperSpec;

  /**
   * Optionally skip extra fields in serialized content instead of failing to serialize.
   */
  readonly skipExtraFields?: boolean;
  withSkipExtraFields(skipExtraFields: boolean): FilesObjsOperSpec;

  /**
   * If true will silently ignore bad syntax in the content and will return no or partial results.
   */
  readonly ignoreBadContent?: boolean;
  withIgnoreBadContent(ignoreBadContent: boolean): FilesObjsOperSpec;
  ...
  withMergeXmlNonAdjacentLists(mergeXmlNonAdjacentLists: boolean): FilesObjsOperSpec;

  /**
   * Specifies various parameters for automatic retry that occurs in upsert due to retryable errors.
   */
  readonly retrySpec?: RetrySpec | null;
  withRetrySpec(retrySpec: IRetrySpec | null): FilesObjsOperSpec;

  /**
   * If set, stream will be instantiated again on retryable errors and execution will continue from the point of failure
   */
  readonly restartStreamOnRetry?: boolean;
  withRestartStreamOnRetry(restartStreamOnRetry: boolean): FilesObjsOperSpec;

  /**
   * The index of the first object from a stream that needs to be read.
   */
  readonly offset?: number | null;
  withOffset(offset: number | null): FilesObjsOperSpec;
  ...
  withLimit(limit: number | null): FilesObjsOperSpec;
  ...
  withValidateContentType(validateContentType: boolean): FilesObjsOperSpec;
  ...
  withPeekForMetadata(peekForMetadata: boolean): FilesObjsOperSpec;
  ...
  withFailIfMissing(failIfMissing: boolean): FilesObjsOperSpec;
  ...
  withSkipIfUnauthorized(skipIfUnauthorized: boolean): FilesObjsOperSpec;

  /**
   * If set and if requested file or directory url is under this path then will retrieve content from cache.
   */
  readonly cacheUrlOrEncodedPath?: string | null;
  withCacheUrlOrEncodedPath(cacheUrlOrEncodedPath: string | null): FilesObjsOperSpec;

  /**
   * Time in seconds that the cached file should live (default 24 hours).
   */
  readonly cacheTtlSec?: number | null;
  withCacheTtlSec(cacheTtlSec: number | null): FilesObjsOperSpec;
  ...
  withForceMultiPart(forceMultiPart: boolean): FilesObjsOperSpec;
  ...
  withDisableMultiPart(disableMultiPart: boolean): FilesObjsOperSpec;

  /**
   * Overrides default maximum file size before MultipartUpload kicks in. Default is 1GB
   */
  readonly maximumSingleUploadsize?: number | null;
  withMaximumSingleUploadsize(maximumSingleUploadsize: number | null): FilesObjsOperSpec;
  ...
  withMaxThreads(maxThreads: number | null): FilesObjsOperSpec;
  ...
  withMinThreads(minThreads: number | null): FilesObjsOperSpec;

  /**
   * If set to true, it will retry reading file when the file is not found.
   */
  readonly retryOnNotFound?: boolean;
  withRetryOnNotFound(retryOnNotFound: boolean): FilesObjsOperSpec;
  ...
  withLockOnWrite(lockOnWrite: boolean): FilesObjsOperSpec;

  /**
   * If set will use IoExecutor service.
   */
  readonly useIoExecutor?: boolean;
  withUseIoExecutor(useIoExecutor: boolean): FilesObjsOperSpec;

  /**
   * If not null, retry logic will be used from CloudClient rather than File
   */
  readonly cloudClient?: any;
  withCloudClient(cloudClient: any): FilesObjsOperSpec;
  ...
  withSerType(serType: IType | null): FilesObjsOperSpec;

  /**
   * If true then will not use parent folder of content for target type guess.
   */
  readonly doNotUseParentDirForSerType?: boolean;
  withDoNotUseParentDirForSerType(doNotUseParentDirForSerType: boolean): FilesObjsOperSpec;
  ...
  withUseBinaryEncodingDecoding(useBinaryEncodingDecoding: boolean): FilesObjsOperSpec;

  /**
   * Optionally indicating if serialized form should contain C3 type.
   */
  readonly shouldNotWriteType?: boolean;
  withShouldNotWriteType(shouldNotWriteType: boolean): FilesObjsOperSpec;

  /**
   * Optionally indicating if serialized form should be formatted for ease of reading.
   */
  readonly shouldWritePretty?: boolean;
  withShouldWritePretty(shouldWritePretty: boolean): FilesObjsOperSpec;
  ...
  withGuessMetadata(guessMetadata: boolean): FilesObjsOperSpec;

  /**
   * If true, checksum files will be generated when writing files
   */
  readonly createChecksum?: boolean;
  withCreateChecksum(createChecksum: boolean): FilesObjsOperSpec;

  /**
   * Whether to decrypt content during read
   */
  readonly decrypt?: boolean;
  withDecrypt(decrypt: boolean): FilesObjsOperSpec;

  /**
   * A list of string serialized {@link FileUrl} of files. When specified, these files will be used for read.
   */
  readonly fileUrls?: C3.Array<string | null>;
  withFileUrls(fileUrls: C3.Array<string | null> | Array<string | null>): FilesObjsOperSpec;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): FilesObjsOperSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): FilesObjsOperSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): FilesObjsOperSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): FilesObjsOperSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): FilesObjsOperSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FilesObjsOperSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FilesObjsOperSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FilesObjsOperSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FilesObjsOperSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): FilesObjsOperSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FilesObjsOperSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FilesObjsOperSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FilesObjsOperSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FilesObjsOperSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FilesObjsOperSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): FilesObjsOperSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FilesObjsOperSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FilesObjsOperSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): FilesObjsOperSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): FilesObjsOperSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): FilesObjsOperSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): FilesObjsOperSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FilesObjsOperSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): FilesObjsOperSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FilesObjsOperSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FilesObjsOperSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): FilesObjsOperSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FilesObjsOperSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): FilesObjsOperSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FilesObjsOperSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): FilesObjsOperSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): FilesObjsOperSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): FilesObjsOperSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): FilesObjsOperSpec;

  mergeJson(json: any | null): FilesObjsOperSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): FilesObjsOperSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): FilesObjsOperSpec;
   ...
   */
  singletonArray(): C3.Array<FilesObjsOperSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<FilesObjsOperSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FilesObjsOperSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<FilesObjsOperSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FilesObjsOperSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, FilesObjsOperSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FilesObjsOperSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FilesObjsOperSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FilesObjsOperSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): FilesObjsOperSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): FilesObjsOperSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): FilesObjsOperSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FilesObjsOperSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): FilesObjsOperSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FilesObjsOperSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): FilesObjsOperSpec;
   ...
   */
  static cachedEmptyInst(): FilesObjsOperSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<FilesObjsOperSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): FilesObjsOperSpec;

  /**
   * @return new instance of this spec with `retrySpec` set
   */
  withRetry(maxRetries?: number | null, initialSleepMillis?: number | null, exponent?: number | null): FilesObjsOperSpec | null;

  /**
   * @return instance of this spec with `retrySpec`'s `maxTotalMillis` set
   */
  static timeoutSeconds(secs: number | null): FilesObjsOperSpec;

  /**
   * @return FileObjsOperSpec with #serType set to provided value.
   */
  static fromType(serType: Type | null): FilesObjsOperSpec;
   ...
   */
  static toDecrypt(): FilesObjsOperSpec | null;
}
