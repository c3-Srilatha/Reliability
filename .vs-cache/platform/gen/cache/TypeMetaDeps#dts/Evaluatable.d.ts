// TypeScript definitions for the C3 type Evaluatable

/**
 * Type containing functions for all evaluate operations
 *
 * @remarks this represents a value passed to a method that expects an instance of Evaluatable
 */
declare interface IEvaluatable {
}

/**
 * Type containing functions for all evaluate operations
 *
 * @remarks this represents a made instance of Evaluatable
 */
declare class Evaluatable {
