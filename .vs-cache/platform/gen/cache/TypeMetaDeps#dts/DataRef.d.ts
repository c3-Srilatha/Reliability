// TypeScript definitions for the C3 type DataRef

/**
 * Implementation of DataRef for {@link Data}
 *
 * @remarks this represents a value passed to a method that expects an instance of DataRef
 */
declare interface IDataRef {
 ...
 */
declare class DataRef extends Obj {
   ...
   */
  LOCAL_FOLDER_PREFIX?: string | null;
  withLOCAL_FOLDER_PREFIX(LOCAL_FOLDER_PREFIX: string | null): DataRef;

  /**
   * Dataset which this Data belongs to
   */
  ds: Dataset;
  withDs(ds: IDataset): DataRef;

  /**
   * Id used to reference this Data within the Dataset to which it belongs
   */
  id: string;
  withId(id: string): DataRef;
  ...
  withRef(ref: string | null | IDataImpl.Lazy | null | null): DataRef;
   ...
   */
  replaceType(old: Type, new_: Type): DataRef;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): DataRef | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): DataRef | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): DataRef | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): DataRef | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataRef;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataRef;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataRef | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataRef | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataRef;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataRef;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataRef;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DataRef;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DataRef;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataRef;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataRef;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DataRef;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): DataRef;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): DataRef;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): DataRef;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataRef;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DataRef;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataRef;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DataRef;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DataRef;
   ...
   * @see #removeField
   */
  unsetField(field: string): DataRef;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DataRef;
   ...
   * @see #unsetField
   */
  removeField(field: string): DataRef;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DataRef;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataRef;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): DataRef;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataRef;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataRef;

  mergeJson(json: any | null): DataRef;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataRef;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): DataRef;
   ...
   */
  singletonArray(): C3.Array<DataRef | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<DataRef | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DataRef | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<DataRef | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DataRef | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, DataRef | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataRef | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DataRef | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DataRef | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DataRef;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DataRef;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DataRef;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DataRef;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DataRef;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DataRef;
   ...
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DataRef;
   ...
   */
  static cachedEmptyInst(): DataRef;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DataRef>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): DataRef;
   ...
   */
  static fromPySrc(pySrc: string, dfs?: C3.Set<DataImpl | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): DataRef | null;
   ...
   */
  static _jsDataProxy(inst: any): DataRef;
   ...
   * @return an instance of Data from the provided collection of {@link Obj}s or {@link Tuple}s
   */
  static fromCollection(col: Collection<Obj | null> | null | Collection<Tuple | null> | null, dataset?: Dataset | null, include?: string | null): DataRef | null;
   ...
   * 1       b 2000-01-02    2.0
   */
  static fromTuple(tuple: Tuple, dataset?: Dataset | null): DataRef | null;
   ...
   * @return this Obj
   */
  setField(field: string, value: any, doNotConvert?: boolean): DataRef;
   ...
   * @return this Obj
   */
  setField(field: FieldType, value: any, doNotConvert?: boolean): DataRef;
