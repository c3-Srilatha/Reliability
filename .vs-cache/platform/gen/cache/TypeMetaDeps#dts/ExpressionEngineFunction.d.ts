// TypeScript definitions for the C3 type ExpressionEngineFunction

/**
 * This is a documentation type only for all the expression engine functions available in the C3 AI Suite.
 * This type does not support any implementation and {@see Expr#eval} should be used to evaluate the expression.
 *
 * The following describes the functions available in the expression engine. These functions can be used in various layers in the C3 AI Suite, including, and not limited to: stored calcs, read calcs, data integration, metrics, and Expr.eval.
 *
 * **User-defined functions:**`` To add your own user-defined function, see [Custom expression engine function.](custom-expression-engine-function.c3doc)
 *
 * @remarks this represents a value passed to a method that expects an instance of ExpressionEngineFunction
 */
declare interface IExpressionEngineFunction {
}
 ...
 * **User-defined functions:**`` To add your own user-defined function, see [Custom expression engine function.](custom-expression-engine-function.c3doc)
 *
 * @remarks this represents a made instance of ExpressionEngineFunction
 */
declare class ExpressionEngineFunction {
   ...
   */
  static abs(value?: number | null): number | null;
   ...
   */
  static abs(dimension?: Dimension | null): Dimension | null;
   ...
   */
  static abs(timeseries?: Timeseries<any> | null): Timeseries<any> | null;
   ...
   */
  static acos(value?: number | null): number | null;
   ...
   */
  static acos(dimension?: Dimension | null): Dimension | null;
   ...
   */
  static acos(timeseries?: Timeseries<any> | null): Timeseries<any> | null;
   ...
   */
  static and(timeseriesArry: C3.Array<Timeseries<any> | null> | null): Timeseries<any>;
   ...
   */
  static asin(value?: number | null): number | null;
   ...
   */
  static asin(dimension?: Dimension | null): Dimension | null;
   ...
   */
  static asin(timeseries?: Timeseries<any> | null): Timeseries<any> | null;
   ...
   */
  static atan(value?: number | null): number | null;
   ...
   */
  static atan(dimension?: Dimension | null): Dimension | null;
   ...
   */
  static atan(timeseries?: Timeseries<any> | null): Timeseries<any> | null;
   ...
   */
  static avg(value?: C3.Array<number | null>): number | null;
   ...
   */
  static avg(dimension?: C3.Array<Dimension | null>): Dimension | null;
   ...
   */
  static avg(timeserieses?: C3.Array<Timeseries<any> | null>): Timeseries<any> | null;
   ...
   */
  static bool(input?: number | null): boolean;
   ...
   */
  static bool(input?: string | null): boolean;
   ...
   */
  static ceil(value?: number | null | null, scale?: number | null): number | null;
   ...
   * @return The input value that is rounded towards positive infinity.
   */
  static ceil(value?: number | null): number | null;
   ...
   * @return The input value that is rounded towards positive infinity.
   */
  static ceil(value?: number | null, scale?: number | null): number | null;
   ...
   */
  static ceil(dimension?: Dimension | null, scale?: number | null): Dimension | null;
   ...
   */
  static ceil(timeseries?: Timeseries<any> | null, scale?: number | null): Timeseries<any> | null;
   ...
   */
  static compareTo(obj1: string | null | number | null | number | null | number | null | number | null | DateTime | null, obj2: string | null | number | null | number | null | number | null | number | null | DateTime | null): number;
   ...
   */
  static concat(strs?: C3.Array<string | null>): string | null;
   ...
   */
  static concat(objs?: C3.Array<any>): C3.Array<Obj | null>;
   ...
   */
  static contains(str1?: string | null, str2?: string | null): boolean;
   ...
   * @return Boolean - if `str1` contains `str2`.
   */
  static containsIgnoreCase(str1?: string | null, str2?: string | null): boolean;
   ...
   */
  static cos(value?: number | null): number | null;
   ...
   */
  static cos(dimension?: Dimension | null): Dimension | null;
   ...
   */
  static cos(timeseries?: Timeseries<any> | null): Timeseries<any> | null;
   ...
   */
  static count(obj?: C3.Array<any>): number | null;
   ...
   */
  static count(timeserieses?: C3.Array<Timeseries<any> | null>): Timeseries<any> | null;
   ...
   */
  static cuberoot(value?: number | null): number | null;
   ...
   */
  static cuberoot(dimension?: Dimension | null): Dimension | null;
   ...
   */
  static cuberoot(timeseries?: Timeseries<any> | null): Timeseries<any> | null;
   ...
   */
  static cusumDiffScore(measurements: Timeseries<any>, reconstructions: Timeseries<any>, k: number, cusumH?: number | null, memoryLength?: number | null, ignoreMask?: Timeseries<any> | null, resetMask?: Timeseries<any> | null, resetOnResidualDirectionChange?: boolean, resetOnResidualDirectionChangeThreshold?: number | null, percentResetOnResidualDirectionChange?: number | null): Timeseries<any> | null;
   ...
   */
  static dateTime(time: string | null, format?: string | null): DateTime | null;
   ...
   */
  static dimensionCreator(dimensionType: string, value: number, unitId: string | null): Dimension;
   ...
   */
  static binaryQuantize(vector: string, dimension?: number | null): string;
   ...
   */
  static vectorDistance(vectorA: string, vectorB: string, spec?: Expr.DistanceSpec | null): number;
   ...
   */
  static similarity(field: string, text: string, spec?: string | null): number;
   ...
   */
  static earliest(dates: C3.Array<DateTime | null>): DateTime;
   ...
   */
  static embedding(text: string, embedder: string): C3.Array<number>;
   ...
   */
  static isInfinityOrNaN(x?: number | null | Dimension | null | null): boolean;
   ...
   */
  static isInfinityOrNaN(ts?: Timeseries<any> | null): Timeseries<any>;
   ...
   */
  static exp(value?: number | null): number | null;
   ...
   */
  static exp(dimension?: Dimension | null): Dimension | null;
   ...
   */
  static exp(timeseries?: Timeseries<any> | null): Timeseries<any> | null;
   ...
   */
  static fillMissing(timeseries?: Timeseries<any> | null, fillerValue?: number | null): Timeseries<any> | null;
   ...
   */
  static fillMissing(timeseries?: Timeseries<any> | null, fillerValue?: any): Timeseries<any> | null;
   ...
   */
  static withMissing(timeseries: Timeseries<any>, fillerValue?: number | null): Timeseries<any>;
   ...
   * @return Returns time series with missing value replaced on the input {@link timeseries} with the specified {@link fillerValue}
   */
  static withMissing(timeseries: Timeseries<any>, fillerValue?: Timeseries<any> | null): Timeseries<any>;
   ...
   */
  static floor(value?: number | null | null, scale?: number | null): number | null;
   ...
   */
  static floor(value?: number | null): number | null;
   ...
   * @return The input value that is rounded towards negative infinity.
   */
  static floor(value?: number | null, scale?: number | null): number | null;
   ...
   */
  static floor(dimension?: Dimension | null, scale?: number | null): Dimension | null;
   ...
   */
  static floor(timeseries?: Timeseries<any> | null, scale?: number | null): Timeseries<any> | null;
   ...
   */
  static geomBuffer(geometry?: Geom | null, bufferRadius?: number | null): Geom | null;
   ...
   */
  static geomBuffer(geography?: Geo | null, bufferRadius?: number | null): Geo | null;
   ...
   */
  static geomClosestPoint(geometryA?: Geom | null, geometryB?: Geom | null): boolean;
   ...
   */
  static geomContains(geometryA?: Geom | null, geometryB?: Geom | null): boolean;
   ...
   */
  static geomExteriorRing(polygon: GeomPolygon | null | GeomPolygon3D | null): boolean;
   ...
   */
  static geomIntersects(geographyA?: Geo | null, geographyB?: Geo | null): boolean;
   ...
   */
  static geomIntersects(geometryA?: Geom | null, geometryB?: Geom | null): boolean;
   ...
   */
  static geomUnion(geometry?: Geom | null): Geom | null;
   ...
   */
  static geomX(geomPoint?: GeomPoint | null): number | null;
   ...
   */
  static geomY(geomPoint?: GeomPoint | null): number | null;
   ...
   */
  static geomZ(geomPoint?: GeomPoint | null): number | null;
   ...
   */
  static id(): C3.Array<string | null>;
   ...
   */
  static intersects(collection1: any, collections: C3.Array<any>): boolean;
   ...
   */
  static join(strs: C3.Array<string | null>): string;
   ...
   */
  static latest(dates: C3.Array<DateTime | null>): DateTime;
   ...
   */
  static registerReadInterpolator(ts: Timeseries<any>, resetOper: string, resetThreshold: number, rolloverMax?: number | null): Timeseries<any>;
   ...
   */
  static interpolate(ts: Timeseries<any>, interpolatorType?: string | null, performOn?: string | null): Timeseries<any>;
   ...
   */
  static log(value?: number | null): number | null;
   ...
   */
  static log(dimension?: Dimension | null): Dimension | null;
   ...
   */
  static log(timeseries?: Timeseries<any> | null): Timeseries<any> | null;
   ...
   */
  static log10(value?: number | null): number | null;
   ...
   */
  static log10(dimension?: Dimension | null): Dimension | null;
   ...
   */
  static log10(timeseries?: Timeseries<any> | null): Timeseries<any> | null;
   ...
   */
  static makeLineString(points: C3.Array<GeomPoint | null>): GeomLineString | null;
   ...
   */
  static makePoint(x: number, y: number, z?: number | null, m?: number | null): GeomPoint | null | GeomPoint3D | null | GeomPoint3DWithMeasure | null | null;
   ...
   */
  static map(lambdaField: λFunction<any, any>): C3.Array<any>;
   ...
   */
  static matches(str: string | null, regex: string): boolean;
   ...
   * @return `true` if `str` matches the `regex`.
   */
  static matchesRegex(str: string | null, regex: string): boolean;
   ...
   */
  static matchesGlob(str: string | null, glob: string): boolean;
   ...
   */
  static matchesCamelCase(str: string | null, camelCase: string, allowLowerCamelCase?: boolean): boolean;
   ...
   */
  static regexMatch(str: string | null, regex: string): StringPatternMatch;
   ...
   * @return The match details.
   */
  static globMatch(str: string | null, glob: string): StringPatternMatch;
   ...
   */
  static camelCaseMatch(str: string | null, camelCase: string, allowLowerCamelCase?: boolean): StringPatternMatch;
   ...
   */
  static findAll(str: string, regex: string): C3.Array<string | null>;
   ...
   */
  static max(timeserieses?: C3.Array<Timeseries<any> | null>): Timeseries<any> | null;
   ...
   */
  static max(numbers?: C3.Array<number | null>): number | null;
   ...
   */
  static mean(input?: C3.Array<number | null>): number | null;
   ...
   */
  static median(input?: C3.Array<number | null>): number | null;
   ...
   */
  static min(timeseries?: C3.Array<Timeseries<any> | null>): Timeseries<any> | null;
   ...
   */
  static min(numbers?: C3.Array<number | null>): number | null;
   ...
   */
  static modalValue(objs: C3.Array<any> | null): any;
   ...
   */
  static nthroot(value?: number | null, nthRoot?: number | null): number | null;
   ...
   */
  static nthroot(dimension?: Dimension | null, nthRoot?: number | null): Dimension | null;
   ...
   */
  static nthroot(input?: Timeseries<any> | null, nthRoot?: number | null): Timeseries<any> | null;
   ...
   */
  static number(str?: string | null): number | null;
   ...
   */
  static number(dimension?: Dimension | null): number | null;
   ...
   */
  static or(timeserieses: C3.Array<Timeseries<any> | null> | null): Timeseries<any>;
   ...
   */
  static percentile(input: C3.Array<number | null> | null, n: number | null): number | null;
   ...
   */
  static pointInsideCircle(geomPoint: GeomPoint, center_x?: number | null, center_y?: number | null, radius?: number | null): boolean;
   ...
   */
  static pow(value?: number | null, power?: number | null): number | null;
   ...
   */
  static pow(dimension?: Dimension | null, power?: number | null): Dimension | null;
   ...
   */
  static pow(timeseries?: Timeseries<any> | null, power?: number | null): Timeseries<any> | null;
   ...
   */
  static random(start?: number | null, end?: number | null): number;
   ...
   */
  static rolling(aggregationFunction: string, timeseries: Timeseries<any>, resetOn?: any, resetTo?: any, resetAfter?: number | null): Timeseries<any>;
   ...
   */
  static rollup(aggregationFunction?: string | null, nthPercentileValue?: number | null, timeserieses: C3.Array<Timeseries<any> | null>): Timeseries<any>;
   ...
   */
  static round(value?: number | null | null, scale?: number | null): number | null;
   ...
   * @return A value rounded towards the "nearest neighbor".
   */
  static round(value?: number | null): number | null;
   ...
   * @return A value rounded towards the "nearest neighbor".
   */
  static round(value?: number | null, scale?: number | null): number | null;
   ...
   */
  static round(dimension?: Dimension | null, scale?: number | null): Dimension | null;
   ...
   */
  static round(timeseries?: Timeseries<any> | null, scale?: number | null): Timeseries<any> | null;
   ...
   */
  static roundHalfToEven(value?: number | null): number | null;
   ...
   */
  static roundHalfToEven(dimension?: Dimension | null): Dimension | null;
   ...
   */
  static roundHalfToEven(timeseries?: Timeseries<any> | null): Timeseries<any> | null;
   ...
   */
  static scaleMinMax(timeseries: Timeseries<any>, min?: number | null, max?: number | null): Timeseries<any>;
   ...
   */
  static setSrid(geomPoint?: GeomPoint | null, srid?: number | null): GeomPoint | null;
   ...
   */
  static sin(value?: number | null): number | null;
   ...
   */
  static sin(dimension?: Dimension | null): Dimension | null;
   ...
   */
  static sin(timeseries?: Timeseries<any> | null): Timeseries<any> | null;
   ...
   */
  static sqrt(value?: number | null): number | null;
   ...
   */
  static sqrt(dimension?: Dimension | null): Dimension | null;
   ...
   */
  static sqrt(timeseries?: Timeseries<any> | null): Timeseries<any> | null;
   ...
   */
  static stddev(input?: C3.Array<number | null>): number | null;
   ...
   */
  static sum(values?: C3.Array<number | null>): number | null;
   ...
   */
  static sum(dimension?: C3.Array<Dimension | null>): Dimension | null;
   ...
   */
  static sum(timeserieses?: C3.Array<Timeseries<any> | null>): Timeseries<any> | null;
   ...
   */
  static tan(value?: number | null): number | null;
   ...
   */
  static tan(dimension?: Dimension | null): Dimension | null;
   ...
   */
  static tan(timeseries?: Timeseries<any> | null): Timeseries<any> | null;
   ...
   */
  static transformGeom(geom: Geom, srid?: number | null): Geom | null;
   ...
   */
  static union(collection1: C3.Array<any> | null, collection2: C3.Array<any> | null): C3.Array<any>;
   ...
   */
  static unique(collection: C3.Array<any> | null): C3.Array<any>;
   ...
   */
  static variance(input?: C3.Array<number | null>): number | null;
   ...
   */
  static sumOfSquares(input?: C3.Array<number | null>): number | null;
   ...
   */
  static weatherIndependentTimeseries(timeseries: Timeseries<any>, weatherTimeseries: Timeseries<any>, heatingCoolingCoeffs?: C3.Array<number | null>, missingThreshold?: number | null): Timeseries<any>;
   ...
   */
  static window(aggFunc: string, timeseries: Timeseries<any>, inputOffset: number, inputSpan: number, inputStep?: number | null): Timeseries<any>;
   ...
   */
  static operationalWindow(aggFunc: string, dataTs: Timeseries<any>, operationalTs: Timeseries<any>, operationalOffset: number, operationalSpan?: number | null): Timeseries<any>;
   ...
   */
  static withinDistance(geographyA: Geo, geographyB: Geo, distance: number, unit?: string | null): boolean;
   ...
   */
  static identity(number: number, unitId?: string | null): Timeseries<any>;
   ...
   */
  static linearRecurrenceTimeseries(initialValues: C3.Array<number | null> | null, doubleArray: C3.Array<C3.Array<number | null>> | null): Timeseries<any>;
   ...
   */
  static randomTimeseries(origin?: number | null, bound?: number | null): Timeseries<any>;
   ...
   */
  static sineWave(waveStart?: DateTime | null, amplitude?: number | null, frequency?: number | null, phase?: number | null): Timeseries<any>;
   ...
   */
  static squareWave(timeComponent?: string | null, pulseStart?: number | null, pulseEnd?: number | null): Timeseries<any>;
   ...
   */
  static ascending(objs?: C3.Array<any>): C3.Array<any>;
   ...
   */
  static ascending(objs?: C3.Array<any>, path?: string | null): C3.Array<any>;
   ...
   */
  static descending(arry?: C3.Array<any>): C3.Array<any>;
   ...
   */
  static descending(objs?: C3.Array<any>, path?: string | null): C3.Array<any>;
   ...
   */
  static split(str?: string | null, delimiter: string): C3.Array<string | null>;
   ...
   */
  static removeOutliers(timeseries: Timeseries<any>, span?: number | null, threshold?: number | null): Timeseries<any>;
   ...
   */
  static earliestValue(array: C3.Array<any>): any;
   ...
   */
  static latestValue(array: C3.Array<any>): any;
   ...
   */
  static safeId(id: string | null): string;
   ...
   */
  static convertToTimeZone(timeZone: string, dt: DateTime | null): DateTime | null;
   ...
   */
  static treatAsTimeZone(timeZone: string, dt: DateTime | null): DateTime | null;
   ...
   */
  static arrayAgg(expr: string): C3.Array<any>;
   ...
   */
  static arrayAggAsString(expr: string, delimiter?: string | null): string | null;
   ...
   */
  static compact(array?: C3.Array<any>): C3.Array<any>;
   ...
   */
  static flatten(array?: C3.Array<C3.Array<any>>, shallow?: boolean): C3.Array<any>;
}
