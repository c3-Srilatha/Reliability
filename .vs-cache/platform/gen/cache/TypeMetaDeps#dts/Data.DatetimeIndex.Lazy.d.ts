// TypeScript definitions for the C3 type Data.DatetimeIndex.Lazy

/**
 * Internal instance of {@link Data.DatetimeIndex} as partially applied function.
 *
 * @remarks this represents a value passed to a method that expects an instance of Data.DatetimeIndex.Lazy
 */
...
declare namespace Data.DatetimeIndex {
  export class Lazy extends Obj {
    ...
    withSTATELESS_CACHE(STATELESS_CACHE: string | null): Data.DatetimeIndex.Lazy;
     ...
     */
    readonly this: any;
    withThis(this_: any): Data.DatetimeIndex.Lazy;

    /**
     * Target action returning DataImpl
     */
    readonly action: string;
    withAction(action: string): Data.DatetimeIndex.Lazy;

    /**
     * Applied arguments
     */
    readonly args?: C3.Map<string | null, any>;
    withArgs(args: C3.Map<string | null, any> | {[key: string | null]: any}): Data.DatetimeIndex.Lazy;
    ...
    with_inferredOutType(_inferredOutType: C3.Map<string | null, ValueType | null> | {[key: string | null]: IValueType | null}): Data.DatetimeIndex.Lazy;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.DatetimeIndex.Lazy | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.DatetimeIndex.Lazy | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.DatetimeIndex.Lazy | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.DatetimeIndex.Lazy | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.DatetimeIndex.Lazy;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.DatetimeIndex.Lazy;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.DatetimeIndex.Lazy;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.DatetimeIndex.Lazy | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.DatetimeIndex.Lazy | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.DatetimeIndex.Lazy;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.DatetimeIndex.Lazy;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.DatetimeIndex.Lazy;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.DatetimeIndex.Lazy;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.DatetimeIndex.Lazy;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.DatetimeIndex.Lazy;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.DatetimeIndex.Lazy;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.DatetimeIndex.Lazy;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.DatetimeIndex.Lazy;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.DatetimeIndex.Lazy;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.DatetimeIndex.Lazy;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.DatetimeIndex.Lazy;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.DatetimeIndex.Lazy;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.DatetimeIndex.Lazy;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.DatetimeIndex.Lazy;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.DatetimeIndex.Lazy;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.DatetimeIndex.Lazy;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.DatetimeIndex.Lazy;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.DatetimeIndex.Lazy;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.DatetimeIndex.Lazy;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.DatetimeIndex.Lazy;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.DatetimeIndex.Lazy;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.DatetimeIndex.Lazy;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.DatetimeIndex.Lazy;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.DatetimeIndex.Lazy;

    mergeJson(json: any | null): Data.DatetimeIndex.Lazy;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.DatetimeIndex.Lazy;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.DatetimeIndex.Lazy;
     ...
     */
    singletonArray(): C3.Array<Data.DatetimeIndex.Lazy | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.DatetimeIndex.Lazy | null>;
     ...
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.DatetimeIndex.Lazy | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.DatetimeIndex.Lazy | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.DatetimeIndex.Lazy | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.DatetimeIndex.Lazy | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.DatetimeIndex.Lazy | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.DatetimeIndex.Lazy | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.DatetimeIndex.Lazy | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.DatetimeIndex.Lazy;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.DatetimeIndex.Lazy;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.DatetimeIndex.Lazy;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.DatetimeIndex.Lazy;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.DatetimeIndex.Lazy;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.DatetimeIndex.Lazy;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.DatetimeIndex.Lazy;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Data.DatetimeIndex.Lazy;
     ...
     */
    static cachedEmptyInst(): Data.DatetimeIndex.Lazy;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.DatetimeIndex.Lazy>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.DatetimeIndex.Lazy;
     ...
     */
    toDataRef(ds?: Dataset | null): Data.IndexBase.Ref | null;
     ...
     */
    static fromPySrc(pySrc: string, dfs?: C3.Set<DataImpl | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): Data.DatetimeIndex.Lazy | null;
     ...
     */
    static _jsDataProxy(inst: any): Data.DatetimeIndex.Lazy;
     ...
     */
    static create(this_: any, action: string, args?: C3.Map<string | null, any>): Data.DatetimeIndex.Lazy;
    ...
    _toPandas(datasetId: string, returnNullIfNotCached?: boolean): Data.IndexBase.Pandas | null;
