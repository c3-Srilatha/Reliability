// TypeScript definitions for the C3 type Pkg.File.Db

/**
 * Copy of all Pkg files in the database. Should not be used directly use {@link Pkg.Store.Db} instead.
 *
 * @remarks this represents a value passed to a method that expects an instance of Pkg.File.Db
 */
...
declare namespace Pkg.File {
  export class Db extends Obj {
    ...
    withTEST_FILE_PATTERN(TEST_FILE_PATTERN: string | null): Pkg.File.Db;
     ...
     */
    readonly url: string;
    withUrl(url: string): Pkg.File.Db;

    /**
     * scheme of this pkg path url.
     */
    readonly scheme?: string | null;
    withScheme(scheme: string | null): Pkg.File.Db;

    /**
     * The name of package Pkg file belongs to.
     */
    readonly package?: string | null;
    withPackage(package_: string | null): Pkg.File.Db;

    /**
     * Category for Pkg file.
     */
    readonly category?: string | null;
    withCategory(category: string | null): Pkg.File.Db;
    ...
    withEncodedSubPath(encodedSubPath: string | null): Pkg.File.Db;

    /**
     * overlay of the path, if the path is part of one. There can only be one overlay.
     */
    readonly overlay?: string | null;
    withOverlay(overlay: string | null): Pkg.File.Db;
    ...
    withDepPkgName(depPkgName: string | null): Pkg.File.Db;
    ...
    withDepPkgOverlay(depPkgOverlay: string | null): Pkg.File.Db;

    /**
     * Local cache of the corresponding Pkg.File.targetType method call.
     */
    readonly targetType?: string | null;
    withTargetType(targetType: string | null): Pkg.File.Db;
    ...
    withContentEncoding(contentEncoding: string | null): Pkg.File.Db;
    ...
    withContentLanguage(contentLanguage: string | null): Pkg.File.Db;
    ...
    withContentLength(contentLength: number | null): Pkg.File.Db;
    ...
    withContentLocation(contentLocation: string | null): Pkg.File.Db;
    ...
    withContentType(contentType: string | null): Pkg.File.Db;
    ...
    withContentDisposition(contentDisposition: string | null): Pkg.File.Db;
    ...
    withETag(eTag: string | null): Pkg.File.Db;
    ...
    withLastModified(lastModified: DateTime | Date | string | null): Pkg.File.Db;

    /**
     * Id of user / identity who last last modified this content.
     */
    readonly lastModifiedBy?: string | null;
    withLastModifiedBy(lastModifiedBy: string | null): Pkg.File.Db;
    ...
    withContentMD5(contentMD5: string | null): Pkg.File.Db;
    ...
    withContentSHA1(contentSHA1: string | null): Pkg.File.Db;
    ...
    withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Pkg.File.Db;

    /**
     * Name of the Obj instance
     */
    readonly name?: string | null;
    withName(name: string | null): Pkg.File.Db;

    /**
     * Various system fields.
     */
    readonly meta?: Meta | null;
    withMeta(meta: IMeta | null): Pkg.File.Db;
    ...
    withVersion(version: number | null): Pkg.File.Db;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type | null;
    withTypeWithBindings(typeWithBindings: IType | null): Pkg.File.Db;

    /**
     * Name of Pkg.Store.Db, that can access this file. pkgName with version or DEFAULT.
     */
    readonly storeName: string;
    withStoreName(storeName: string): Pkg.File.Db;

    /**
     * The actual binary content of the file.
     */
    readonly encodedContent?: any | null;
    withEncodedContent(encodedContent: any | null): Pkg.File.Db;

    /**
     * Sequence number for the package of this metadata file.
     */
    readonly packageSequence?: number | null;
    withPackageSequence(packageSequence: number | null): Pkg.File.Db;
    ...
    withContentHash(contentHash: string | null): Pkg.File.Db;
     ...
     * @see #toString
     */
    static fromString(s: string | null): Pkg.File.Db | null;
     ...
     * @see #fromString
     */
    static make(s: string | null): Pkg.File.Db | null;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Pkg.File.Db;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Pkg.File.Db;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Pkg.File.Db;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Pkg.File.Db;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Pkg.File.Db | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Pkg.File.Db | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Pkg.File.Db | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Pkg.File.Db | null;
     ...
     */
    replaceType(old: Type, new_: Type): Pkg.File.Db;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Pkg.File.Db;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Pkg.File.Db;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Pkg.File.Db | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Pkg.File.Db | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Pkg.File.Db;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Pkg.File.Db;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Pkg.File.Db;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Pkg.File.Db;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Pkg.File.Db;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Pkg.File.Db;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Pkg.File.Db;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Pkg.File.Db;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Pkg.File.Db;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Pkg.File.Db;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Pkg.File.Db;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Pkg.File.Db;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Pkg.File.Db;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Pkg.File.Db;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Pkg.File.Db;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Pkg.File.Db;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Pkg.File.Db;
     ...
     * @see #removeField
     */
    unsetField(field: string): Pkg.File.Db;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Pkg.File.Db;
     ...
     * @see #unsetField
     */
    removeField(field: string): Pkg.File.Db;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Pkg.File.Db;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Pkg.File.Db;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Pkg.File.Db;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Pkg.File.Db;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Pkg.File.Db;

    mergeJson(json: any | null): Pkg.File.Db;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Pkg.File.Db;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Pkg.File.Db;
     ...
     */
    singletonArray(): C3.Array<Pkg.File.Db | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Pkg.File.Db | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Pkg.File.Db | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Pkg.File.Db | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Pkg.File.Db | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Pkg.File.Db | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Pkg.File.Db | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Pkg.File.Db | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Pkg.File.Db | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Pkg.File.Db;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Pkg.File.Db;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Pkg.File.Db;
     ...
     */
    static cachedEmptyInst(): Pkg.File.Db;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Pkg.File.Db>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Pkg.File.Db;
     ...
     */
    withFileName(fileName: string | null): Pkg.File.Db;

    /**
     * Changes file extension in this instance.
     */
    withFileExt(fileExt: string | null): Pkg.File.Db;
     ...
     */
    identify(suffix?: string | null): Pkg.File.Db;
     ...
     */
    static fetch(spec?: FetchSpec | null): FetchResult<Pkg.File.Db | null>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Pkg.File.Db | null>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Pkg.File.Db | null>;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Pkg.File.Db | null> | null>;
     ...
     */
    get(include?: string | null): Pkg.File.Db | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string | null): Pkg.File.Db | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Pkg.File.Db;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string | null): Pkg.File.Db | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Pkg.File.Db;
     ...
     */
    create(spec?: UpsertSpec | null): Pkg.File.Db | null;
     ...
     */
    static createBatch(objs: C3.Array<Pkg.File.Db | null> | null, spec?: UpsertSpec | null): ObjList<Pkg.File.Db | null> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Pkg.File.Db | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Pkg.File.Db | null> | null;
     ...
     */
    update(srcObj?: Pkg.File.Db | null, spec?: UpsertSpec | null): Pkg.File.Db | null;
     ...
     */
    upsert(srcObj?: Pkg.File.Db | null, spec?: UpsertSpec | null): Pkg.File.Db | null;
     ...
     */
    merge(spec?: MergeSpec | null): Pkg.File.Db | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec | null): Pkg.File.Db | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec | null): Pkg.File.Db | null;
     ...
     */
    static updateBatch(objs: C3.Array<Pkg.File.Db | null> | null, srcObjs?: C3.Array<Pkg.File.Db | null>, spec?: UpsertSpec | null): ObjList<Pkg.File.Db | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<C3.Array<Pkg.File.Db | null>>, spec?: UpsertSpec | null): ObjList<Pkg.File.Db | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: C3.Array<Pkg.File.Db | null> | null, srcObjs?: C3.Array<Pkg.File.Db | null>, spec?: UpsertSpec | null): ObjList<Pkg.File.Db | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<C3.Array<Pkg.File.Db | null>>, spec?: UpsertSpec | null): ObjList<Pkg.File.Db | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: C3.Array<Pkg.File.Db | null> | null, spec?: TouchSpec | null): ObjList<Pkg.File.Db | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<Pkg.File.Db | null> | null, spec?: MergeSpec | null): ObjList<Pkg.File.Db | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<Pkg.File.Db | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Pkg.File.Db | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<C3.Array<Pkg.File.Db | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Pkg.File.Db | null> | null;
     ...
     */
    static mergeAll(mergeObj: Pkg.File.Db | null, spec?: MergeAllSpec | null): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Pkg.File.Db | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: C3.Array<Pkg.File.Db | null> | null, spec?: UpsertSpec | null): ObjList<Pkg.File.Db | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: C3.Array<Pkg.File.Db | null> | null, spec?: UpsertSpec | null): ObjList<Pkg.File.Db | null> | null;
     ...
     */
    static beforeCreate(objs: C3.Array<Pkg.File.Db | null> | null): ObjList<Pkg.File.Db | null>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: C3.Array<Pkg.File.Db | null> | null): ObjList<Pkg.File.Db | null>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: C3.Array<Pkg.File.Db | null> | null): ObjList<Pkg.File.Db | null>;
     ...
     */
    static afterCreate(objs: C3.Array<Pkg.File.Db | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: C3.Array<Pkg.File.Db | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: C3.Array<Pkg.File.Db | null> | null): C3.Array<ObjError | null>;
     ...
     */
    static startImportData(spec?: StartImportDataSpec | null): PushStream<Pkg.File.Db | null>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Pkg.File.Db | null>;
     ...
     */
    static forId(id: string | null, failIfMissing?: boolean): Pkg.File.Db | null;
     ...
     */
    withoutIdentity(): Pkg.File.Db | null;
     ...
     */
    static typeOfBatch(objs: C3.Array<Pkg.File.Db | null> | null): C3.Array<EntityType | null>;
     ...
     */
    static dbEcho(template?: Pkg.File.Db | null, count?: number | null, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: C3.Array<Pkg.File.Db | null> | null, callback?: λFunction<Pkg.File.Db | null, Pkg.File.Db | null> | null): ObjList<Pkg.File.Db | null>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: C3.Array<Pkg.File.Db | null> | null, callback?: λFunction<Pkg.File.Db | null, Pkg.File.Db | null> | null): C3.Array<ObjError | null>;
     ...
     */
    static fromPkgFile(storeName: string, file: Pkg.File): Pkg.File.Db;

    /**
     * @return new Pkg.File.Db for a store, given Pkg.Path and encoded content.
     */
    static fromPkgPathAndEncodedContent(storeName: string, path: Pkg.Path, encodedContent?: any | null): Pkg.File.Db;
