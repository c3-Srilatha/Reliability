// TypeScript definitions for the C3 type EtlCoordinator

/**
 * Etl coordinator.  Every entry is for a specific type that incremental etl is being performed for (e.g. types that
 * specify a secondary datastore.
 *
 * @remarks this represents a value passed to a method that expects an instance of EtlCoordinator
 */
declare interface IEtlCoordinator {
  ...
  /**
   * Type that the entry is for.
   */
  typeName?: string | null;

  /**
   * Workflow that performs incremental etl operation.
   */
  workflow?: IWorkflow | null;

  /**
   * All etl logs for the type.
   */
  logs?: C3.Array<EtlLog | null> | Array<IEtlLog | null>;
}
 ...
 * specify a secondary datastore.
 *
 * @remarks this represents a made instance of EtlCoordinator
 */
declare class EtlCoordinator extends Obj {
   ...
   */
  readonly id: string;
  withId(id: string): EtlCoordinator;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): EtlCoordinator;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): EtlCoordinator;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): EtlCoordinator;
  ...
  withVersion(version: number | null): EtlCoordinator;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): EtlCoordinator;

  /**
   * Type that the entry is for.
   */
  readonly typeName?: string | null;
  withTypeName(typeName: string | null): EtlCoordinator;

  /**
   * Workflow that performs incremental etl operation.
   */
  readonly workflow?: Workflow | null;
  withWorkflow(workflow: IWorkflow | null): EtlCoordinator;

  /**
   * All etl logs for the type.
   */
  readonly logs?: C3.Array<EtlLog | null>;
  withLogs(logs: C3.Array<EtlLog | null> | Array<IEtlLog | null>): EtlCoordinator;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): EtlCoordinator | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): EtlCoordinator | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): EtlCoordinator | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): EtlCoordinator | null;
   ...
   */
  replaceType(old: Type, new_: Type): EtlCoordinator;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): EtlCoordinator;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): EtlCoordinator;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<EtlCoordinator | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<EtlCoordinator | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): EtlCoordinator;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): EtlCoordinator;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): EtlCoordinator;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): EtlCoordinator;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): EtlCoordinator;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): EtlCoordinator;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): EtlCoordinator;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): EtlCoordinator;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): EtlCoordinator;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): EtlCoordinator;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): EtlCoordinator;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): EtlCoordinator;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): EtlCoordinator;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): EtlCoordinator;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): EtlCoordinator;
   ...
   * @see #unsetField
   */
  defaultField(field: string): EtlCoordinator;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): EtlCoordinator;
   ...
   * @see #removeField
   */
  unsetField(field: string): EtlCoordinator;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): EtlCoordinator;
   ...
   * @see #unsetField
   */
  removeField(field: string): EtlCoordinator;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): EtlCoordinator;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): EtlCoordinator;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): EtlCoordinator;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): EtlCoordinator;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): EtlCoordinator;

  mergeJson(json: any | null): EtlCoordinator;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): EtlCoordinator;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): EtlCoordinator;
   ...
   */
  singletonArray(): C3.Array<EtlCoordinator | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<EtlCoordinator | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<EtlCoordinator | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<EtlCoordinator | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<EtlCoordinator | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, EtlCoordinator | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, EtlCoordinator | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<EtlCoordinator | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<EtlCoordinator | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): EtlCoordinator;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): EtlCoordinator;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): EtlCoordinator;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): EtlCoordinator;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): EtlCoordinator;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): EtlCoordinator;
   ...
   * @see #fromString
   */
  static make(s: string | null): EtlCoordinator | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): EtlCoordinator;
   ...
   */
  static cachedEmptyInst(): EtlCoordinator;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<EtlCoordinator>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): EtlCoordinator;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<EtlCoordinator | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<EtlCoordinator | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<EtlCoordinator | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<EtlCoordinator | null> | null>;
   ...
   */
  get(include?: string | null): EtlCoordinator | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): EtlCoordinator | null;
   ...
   */
  getMissing(spec: GetMissingSpec): EtlCoordinator;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): EtlCoordinator | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): EtlCoordinator;
   ...
   * @see #toString
   */
  static fromString(s: string | null): EtlCoordinator | null;
   ...
   */
  create(spec?: UpsertSpec | null): EtlCoordinator | null;
   ...
   */
  static createBatch(objs: C3.Array<EtlCoordinator | null> | null, spec?: UpsertSpec | null): ObjList<EtlCoordinator | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<EtlCoordinator | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<EtlCoordinator | null> | null;
   ...
   */
  update(srcObj?: EtlCoordinator | null, spec?: UpsertSpec | null): EtlCoordinator | null;
   ...
   */
  upsert(srcObj?: EtlCoordinator | null, spec?: UpsertSpec | null): EtlCoordinator | null;
   ...
   */
  merge(spec?: MergeSpec | null): EtlCoordinator | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): EtlCoordinator | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): EtlCoordinator | null;
   ...
   */
  static updateBatch(objs: C3.Array<EtlCoordinator | null> | null, srcObjs?: C3.Array<EtlCoordinator | null>, spec?: UpsertSpec | null): ObjList<EtlCoordinator | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<EtlCoordinator | null>>, spec?: UpsertSpec | null): ObjList<EtlCoordinator | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<EtlCoordinator | null> | null, srcObjs?: C3.Array<EtlCoordinator | null>, spec?: UpsertSpec | null): ObjList<EtlCoordinator | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<EtlCoordinator | null>>, spec?: UpsertSpec | null): ObjList<EtlCoordinator | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<EtlCoordinator | null> | null, spec?: TouchSpec | null): ObjList<EtlCoordinator | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<EtlCoordinator | null> | null, spec?: MergeSpec | null): ObjList<EtlCoordinator | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<EtlCoordinator | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<EtlCoordinator | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<EtlCoordinator | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<EtlCoordinator | null> | null;
   ...
   */
  static mergeAll(mergeObj: EtlCoordinator | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: EtlCoordinator | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<EtlCoordinator | null> | null, spec?: UpsertSpec | null): ObjList<EtlCoordinator | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<EtlCoordinator | null> | null, spec?: UpsertSpec | null): ObjList<EtlCoordinator | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<EtlCoordinator | null> | null): ObjList<EtlCoordinator | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<EtlCoordinator | null> | null): ObjList<EtlCoordinator | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<EtlCoordinator | null> | null): ObjList<EtlCoordinator | null>;
   ...
   */
  static afterCreate(objs: C3.Array<EtlCoordinator | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<EtlCoordinator | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<EtlCoordinator | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<EtlCoordinator | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<EtlCoordinator | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): EtlCoordinator | null;
   ...
   */
  withoutIdentity(): EtlCoordinator | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<EtlCoordinator | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: EtlCoordinator | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<EtlCoordinator | null> | null, callback?: λFunction<EtlCoordinator | null, EtlCoordinator | null> | null): ObjList<EtlCoordinator | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<EtlCoordinator | null> | null, callback?: λFunction<EtlCoordinator | null, EtlCoordinator | null> | null): C3.Array<ObjError | null>;
  ...
  /**
   * Performs incremental etl for all types that support it.
   */
  static synchronizeAll(): void;

  /**
   * Called by {@link synchronizeAll} to perform incremental etl for a specific type/entry.
   */
  synchronize(): void;
}
