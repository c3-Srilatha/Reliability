// TypeScript definitions for the C3 type TextContentConfiguration

/**
 * @remarks this represents a value passed to a method that expects an instance of TextContentConfiguration
 */
declare interface ITextContentConfiguration {
  ...
  /**
   * The entity type that is contained in TextContent
   */
  typeref: IType;

  /**
   * The list of fields in type that each column in the file corresponds to.
   */
  headerFields: C3.Array<string | null> | Array<string | null>;

  /**
   * The (optional) regular expression to apply to fields to transform them. Note that the column number is specified in
   *
   * RegularExpressionReplace.columnNumber and does not correspond to the array index
   */
  dataTransformRegExps?: C3.Array<RegularExpressionReplace | null> | Array<IRegularExpressionReplace | null>;

  /**
   * Controls whether we transform (apply headerFields and dataParseRegExps) to the stream as it arrives
   *
   * If true, the original stream is discarded and the transformed and serialized Objs will be persisted. This means
   */
  eagerTransform?: boolean;

  numLinesPerBlock?: number | null;

  format?: string | null;

  eventBroadcastFrequencyNumBlocks: number;
}

/**
 * @remarks this represents a made instance of TextContentConfiguration
 */
declare class TextContentConfiguration extends Obj {
   ...
   */
  readonly id: string;
  withId(id: string): TextContentConfiguration;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): TextContentConfiguration;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): TextContentConfiguration;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): TextContentConfiguration;
  ...
  withVersion(version: number | null): TextContentConfiguration;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): TextContentConfiguration;

  /**
   * The entity type that is contained in TextContent
   */
  readonly typeref: Type;
  withTyperef(typeref: IType): TextContentConfiguration;

  /**
   * The list of fields in type that each column in the file corresponds to.
   */
  readonly headerFields: C3.Array<string | null>;
  withHeaderFields(headerFields: C3.Array<string | null> | Array<string | null>): TextContentConfiguration;
   ...
   * RegularExpressionReplace.columnNumber and does not correspond to the array index
   */
  readonly dataTransformRegExps?: C3.Array<RegularExpressionReplace | null>;
  withDataTransformRegExps(dataTransformRegExps: C3.Array<RegularExpressionReplace | null> | Array<IRegularExpressionReplace | null>): TextContentConfiguration;
   ...
   * If true, the original stream is discarded and the transformed and serialized Objs will be persisted. This means
   */
  readonly eagerTransform?: boolean;
  withEagerTransform(eagerTransform: boolean): TextContentConfiguration;

  readonly numLinesPerBlock?: number | null;
  withNumLinesPerBlock(numLinesPerBlock: number | null): TextContentConfiguration;

  readonly format?: string | null;
  withFormat(format: string | null): TextContentConfiguration;

  readonly eventBroadcastFrequencyNumBlocks: number;
  withEventBroadcastFrequencyNumBlocks(eventBroadcastFrequencyNumBlocks: number): TextContentConfiguration;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TextContentConfiguration | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TextContentConfiguration | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TextContentConfiguration | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TextContentConfiguration | null;
   ...
   */
  replaceType(old: Type, new_: Type): TextContentConfiguration;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TextContentConfiguration;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TextContentConfiguration;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TextContentConfiguration | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TextContentConfiguration | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TextContentConfiguration;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TextContentConfiguration;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TextContentConfiguration;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TextContentConfiguration;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TextContentConfiguration;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TextContentConfiguration;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TextContentConfiguration;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TextContentConfiguration;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TextContentConfiguration;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TextContentConfiguration;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TextContentConfiguration;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TextContentConfiguration;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TextContentConfiguration;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TextContentConfiguration;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TextContentConfiguration;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TextContentConfiguration;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TextContentConfiguration;
   ...
   * @see #removeField
   */
  unsetField(field: string): TextContentConfiguration;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TextContentConfiguration;
   ...
   * @see #unsetField
   */
  removeField(field: string): TextContentConfiguration;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TextContentConfiguration;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TextContentConfiguration;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TextContentConfiguration;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TextContentConfiguration;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TextContentConfiguration;

  mergeJson(json: any | null): TextContentConfiguration;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TextContentConfiguration;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TextContentConfiguration;
   ...
   */
  singletonArray(): C3.Array<TextContentConfiguration | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TextContentConfiguration | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TextContentConfiguration | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TextContentConfiguration | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TextContentConfiguration | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TextContentConfiguration | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TextContentConfiguration | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TextContentConfiguration | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TextContentConfiguration | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TextContentConfiguration;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TextContentConfiguration;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TextContentConfiguration;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TextContentConfiguration;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TextContentConfiguration;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TextContentConfiguration;
   ...
   * @see #fromString
   */
  static make(s: string | null): TextContentConfiguration | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TextContentConfiguration;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): TextContentConfiguration;
   ...
   */
  static cachedEmptyInst(): TextContentConfiguration;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TextContentConfiguration>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TextContentConfiguration;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TextContentConfiguration | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TextContentConfiguration | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TextContentConfiguration | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TextContentConfiguration | null> | null>;
   ...
   */
  get(include?: string | null): TextContentConfiguration | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TextContentConfiguration | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TextContentConfiguration;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TextContentConfiguration | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TextContentConfiguration;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TextContentConfiguration | null;
   ...
   */
  create(spec?: UpsertSpec | null): TextContentConfiguration | null;
   ...
   */
  static createBatch(objs: C3.Array<TextContentConfiguration | null> | null, spec?: UpsertSpec | null): ObjList<TextContentConfiguration | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TextContentConfiguration | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TextContentConfiguration | null> | null;
   ...
   */
  update(srcObj?: TextContentConfiguration | null, spec?: UpsertSpec | null): TextContentConfiguration | null;
   ...
   */
  upsert(srcObj?: TextContentConfiguration | null, spec?: UpsertSpec | null): TextContentConfiguration | null;
   ...
   */
  merge(spec?: MergeSpec | null): TextContentConfiguration | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TextContentConfiguration | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TextContentConfiguration | null;
   ...
   */
  static updateBatch(objs: C3.Array<TextContentConfiguration | null> | null, srcObjs?: C3.Array<TextContentConfiguration | null>, spec?: UpsertSpec | null): ObjList<TextContentConfiguration | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TextContentConfiguration | null>>, spec?: UpsertSpec | null): ObjList<TextContentConfiguration | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TextContentConfiguration | null> | null, srcObjs?: C3.Array<TextContentConfiguration | null>, spec?: UpsertSpec | null): ObjList<TextContentConfiguration | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TextContentConfiguration | null>>, spec?: UpsertSpec | null): ObjList<TextContentConfiguration | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TextContentConfiguration | null> | null, spec?: TouchSpec | null): ObjList<TextContentConfiguration | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TextContentConfiguration | null> | null, spec?: MergeSpec | null): ObjList<TextContentConfiguration | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TextContentConfiguration | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TextContentConfiguration | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TextContentConfiguration | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TextContentConfiguration | null> | null;
   ...
   */
  static mergeAll(mergeObj: TextContentConfiguration | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TextContentConfiguration | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TextContentConfiguration | null> | null, spec?: UpsertSpec | null): ObjList<TextContentConfiguration | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TextContentConfiguration | null> | null, spec?: UpsertSpec | null): ObjList<TextContentConfiguration | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): TextContentConfiguration | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TextContentConfiguration | null> | null): ObjList<TextContentConfiguration | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TextContentConfiguration | null> | null): ObjList<TextContentConfiguration | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TextContentConfiguration | null> | null): ObjList<TextContentConfiguration | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TextContentConfiguration | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TextContentConfiguration | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TextContentConfiguration | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TextContentConfiguration | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TextContentConfiguration | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TextContentConfiguration | null;
   ...
   */
  withoutIdentity(): TextContentConfiguration | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<TextContentConfiguration | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TextContentConfiguration | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TextContentConfiguration | null> | null, callback?: λFunction<TextContentConfiguration | null, TextContentConfiguration | null> | null): ObjList<TextContentConfiguration | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TextContentConfiguration | null> | null, callback?: λFunction<TextContentConfiguration | null, TextContentConfiguration | null> | null): C3.Array<ObjError | null>;
