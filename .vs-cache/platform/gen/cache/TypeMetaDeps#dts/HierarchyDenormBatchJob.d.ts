// TypeScript definitions for the C3 type HierarchyDenormBatchJob

/**
 * Batch job for running {@see HierarchyDenorm}
 *
 * @remarks this represents a value passed to a method that expects an instance of HierarchyDenormBatchJob
 */
declare interface IHierarchyDenormBatchJob {
 ...
 */
declare class HierarchyDenormBatchJob extends Obj {

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun | null;
  withRun(run: IBatchJobRun | null): HierarchyDenormBatchJob;

  /**
   * previous job executions for this instance
   */
  readonly runs?: C3.Array<BatchJobRun | null>;
  withRuns(runs: C3.Array<BatchJobRun | null> | Array<IBatchJobRun | null>): HierarchyDenormBatchJob;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj | null;
  withOptions(options: IObj | null): HierarchyDenormBatchJob;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): HierarchyDenormBatchJob;
  ...
  withPriority(priority: number | null): HierarchyDenormBatchJob;
  ...
  withDisabled(disabled: boolean): HierarchyDenormBatchJob;
  ...
  withMaxConcurrency(maxConcurrency: number | null): HierarchyDenormBatchJob;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): HierarchyDenormBatchJob;
  ...
  withRunAsUser(runAsUser: boolean | null): HierarchyDenormBatchJob;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string | null;
  withNodePool(nodePool: string | null): HierarchyDenormBatchJob;
  ...
  withSkipIfRunning(skipIfRunning: boolean | null): HierarchyDenormBatchJob;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number | null;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): HierarchyDenormBatchJob;
  ...
  withPropagateActionContext(propagateActionContext: boolean): HierarchyDenormBatchJob;
  ...
  withTypeIdent(typeIdent: string | null): HierarchyDenormBatchJob;
   ...
   */
  readonly id: string;
  withId(id: string): HierarchyDenormBatchJob;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): HierarchyDenormBatchJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): HierarchyDenormBatchJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): HierarchyDenormBatchJob;
  ...
  withVersion(version: number | null): HierarchyDenormBatchJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): HierarchyDenormBatchJob;
  ...
  withAbortOnError(abortOnError: boolean): HierarchyDenormBatchJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): HierarchyDenormBatchJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): HierarchyDenormBatchJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): HierarchyDenormBatchJob | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): HierarchyDenormBatchJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): HierarchyDenormBatchJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HierarchyDenormBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HierarchyDenormBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HierarchyDenormBatchJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HierarchyDenormBatchJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): HierarchyDenormBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HierarchyDenormBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HierarchyDenormBatchJob;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): HierarchyDenormBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): HierarchyDenormBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): HierarchyDenormBatchJob;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): HierarchyDenormBatchJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): HierarchyDenormBatchJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): HierarchyDenormBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): HierarchyDenormBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): HierarchyDenormBatchJob;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): HierarchyDenormBatchJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): HierarchyDenormBatchJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): HierarchyDenormBatchJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): HierarchyDenormBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): HierarchyDenormBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): HierarchyDenormBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): HierarchyDenormBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): HierarchyDenormBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): HierarchyDenormBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): HierarchyDenormBatchJob;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): HierarchyDenormBatchJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): HierarchyDenormBatchJob;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): HierarchyDenormBatchJob;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): HierarchyDenormBatchJob;

  mergeJson(json: any | null): HierarchyDenormBatchJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): HierarchyDenormBatchJob;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): HierarchyDenormBatchJob;
   ...
   */
  singletonArray(): C3.Array<HierarchyDenormBatchJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<HierarchyDenormBatchJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<HierarchyDenormBatchJob | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<HierarchyDenormBatchJob | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<HierarchyDenormBatchJob | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, HierarchyDenormBatchJob | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, HierarchyDenormBatchJob | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<HierarchyDenormBatchJob | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<HierarchyDenormBatchJob | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): HierarchyDenormBatchJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): HierarchyDenormBatchJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): HierarchyDenormBatchJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): HierarchyDenormBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): HierarchyDenormBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): HierarchyDenormBatchJob;
   ...
   * @see #fromString
   */
  static make(s: string | null): HierarchyDenormBatchJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): HierarchyDenormBatchJob;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): HierarchyDenormBatchJob;
   ...
   */
  static cachedEmptyInst(): HierarchyDenormBatchJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<HierarchyDenormBatchJob>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): HierarchyDenormBatchJob;
   ...
   */
  start(options?: HierarchyDenormOption | null): BatchJobStatus | null;
   ...
   */
  cleanup(options?: HierarchyDenormOption | null): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun | null, BatchJobStatus | null, HierarchyDenormOption | null> | null;

  failJob(run: JobRun<BatchJobStatusBase | null>): JobBase<BatchJobRun | null, BatchJobStatus | null, HierarchyDenormOption | null> | null;
  ...
  validateStart(options?: HierarchyDenormOption | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<HierarchyDenormBatchJob | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<HierarchyDenormBatchJob | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<HierarchyDenormBatchJob | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<HierarchyDenormBatchJob | null> | null>;
   ...
   */
  get(include?: string | null): HierarchyDenormBatchJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): HierarchyDenormBatchJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): HierarchyDenormBatchJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): HierarchyDenormBatchJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): HierarchyDenormBatchJob;
   ...
   * @see #toString
   */
  static fromString(s: string | null): HierarchyDenormBatchJob | null;
   ...
   */
  create(spec?: UpsertSpec | null): HierarchyDenormBatchJob | null;
   ...
   */
  static createBatch(objs: C3.Array<HierarchyDenormBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<HierarchyDenormBatchJob | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<HierarchyDenormBatchJob | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<HierarchyDenormBatchJob | null> | null;
   ...
   */
  update(srcObj?: HierarchyDenormBatchJob | null, spec?: UpsertSpec | null): HierarchyDenormBatchJob | null;
   ...
   */
  upsert(srcObj?: HierarchyDenormBatchJob | null, spec?: UpsertSpec | null): HierarchyDenormBatchJob | null;
   ...
   */
  merge(spec?: MergeSpec | null): HierarchyDenormBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): HierarchyDenormBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): HierarchyDenormBatchJob | null;
   ...
   */
  static updateBatch(objs: C3.Array<HierarchyDenormBatchJob | null> | null, srcObjs?: C3.Array<HierarchyDenormBatchJob | null>, spec?: UpsertSpec | null): ObjList<HierarchyDenormBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<HierarchyDenormBatchJob | null>>, spec?: UpsertSpec | null): ObjList<HierarchyDenormBatchJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<HierarchyDenormBatchJob | null> | null, srcObjs?: C3.Array<HierarchyDenormBatchJob | null>, spec?: UpsertSpec | null): ObjList<HierarchyDenormBatchJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<HierarchyDenormBatchJob | null>>, spec?: UpsertSpec | null): ObjList<HierarchyDenormBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<HierarchyDenormBatchJob | null> | null, spec?: TouchSpec | null): ObjList<HierarchyDenormBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<HierarchyDenormBatchJob | null> | null, spec?: MergeSpec | null): ObjList<HierarchyDenormBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<HierarchyDenormBatchJob | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<HierarchyDenormBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<HierarchyDenormBatchJob | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<HierarchyDenormBatchJob | null> | null;
   ...
   */
  static mergeAll(mergeObj: HierarchyDenormBatchJob | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: HierarchyDenormBatchJob | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<HierarchyDenormBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<HierarchyDenormBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<HierarchyDenormBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<HierarchyDenormBatchJob | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): HierarchyDenormBatchJob | null;
   ...
   */
  static beforeCreate(objs: C3.Array<HierarchyDenormBatchJob | null> | null): ObjList<HierarchyDenormBatchJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<HierarchyDenormBatchJob | null> | null): ObjList<HierarchyDenormBatchJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<HierarchyDenormBatchJob | null> | null): ObjList<HierarchyDenormBatchJob | null>;
   ...
   */
  static afterCreate(objs: C3.Array<HierarchyDenormBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<HierarchyDenormBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<HierarchyDenormBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<HierarchyDenormBatchJob | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<HierarchyDenormBatchJob | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): HierarchyDenormBatchJob | null;
   ...
   */
  withoutIdentity(): HierarchyDenormBatchJob | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<HierarchyDenormBatchJob | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: HierarchyDenormBatchJob | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<HierarchyDenormBatchJob | null> | null, callback?: λFunction<HierarchyDenormBatchJob | null, HierarchyDenormBatchJob | null> | null): ObjList<HierarchyDenormBatchJob | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<HierarchyDenormBatchJob | null> | null, callback?: λFunction<HierarchyDenormBatchJob | null, HierarchyDenormBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static doStart(job?: HierarchyDenormBatchJob | null, options?: HierarchyDenormOption | null): void;
   ...
   */
  static processBatch(batch?: HierarchyDenormBatch | null, job?: HierarchyDenormBatchJob | null, options?: HierarchyDenormOption | null): void;
   ...
   */
  static allComplete(job: HierarchyDenormBatchJob, options?: HierarchyDenormOption | null): string | null;
   ...
   *           Options the job was run with.
   */
  static failed(job: HierarchyDenormBatchJob, status: BatchJobStatus, options?: HierarchyDenormOption | null): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: HierarchyDenormBatch | null): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: C3.Array<HierarchyDenormBatch | null>): void;
   ...
   */
  static scheduleObjBatch(job?: HierarchyDenormBatchJob | null, objBatch?: ObjBatch | null, logPrefix?: string | null): number | null;
