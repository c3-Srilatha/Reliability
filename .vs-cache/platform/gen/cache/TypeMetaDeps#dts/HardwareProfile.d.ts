// TypeScript definitions for the C3 type HardwareProfile
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of HardwareProfile
 */
declare interface IHardwareProfile {
   ...
   */
  cpuAllowedRange?: IPair<number | null, number | null> | null;

  /**
   * The permitted range for {@link HardwareProfile#memoryMb}
   */
  memoryMbAllowedRange?: IPair<number | null, number | null> | null;

  /**
   * The permitted range for {@link HardwareProfile#diskGb}
   */
  diskGbAllowedRange?: IPair<number | null, number | null> | null;

  /**
   * The permitted range for {@link HardwareProfile#acceleratorCount}
   */
  acceleratorCountAllowedRange?: IPair<number | null, number | null> | null;
}
 ...
 */
declare class HardwareProfile extends Obj {

  /**
   * The name of this instance.
   */
  readonly name: string;
  withName(name: string): HardwareProfile;

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): HardwareProfile;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): HardwareProfile;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): HardwareProfile;

  /**
   * Cloud Provider Machine Type Name (ex: "n2d-standard-32" on gcp)
   */
  readonly instanceType?: string | null;
  withInstanceType(instanceType: string | null): HardwareProfile;
  ...
  withGpuVendor(gpuVendor: string | null): HardwareProfile;
  ...
  withGpuKind(gpuKind: string | null): HardwareProfile;

  /**
   * Specifies the {@link HardwareAvailability} for a given VM.
   */
  readonly hardwareAvailability: string;
  withHardwareAvailability(hardwareAvailability: string): HardwareProfile;
  ...
  withAcceleratorKind(acceleratorKind: string | null): HardwareProfile;

  /**
   * The identifier of the Kubernetes node pool that serves as the scheduling target for the C3 node pool.
   */
  readonly computeKind?: string | null;
  withComputeKind(computeKind: string | null): HardwareProfile;
   ...
   */
  readonly cpu: number;
  withCpu(cpu: number): HardwareProfile;
  ...
  withMemoryMb(memoryMb: number): HardwareProfile;
  ...
  withDiskGb(diskGb: number): HardwareProfile;
   ...
   */
  readonly gpu: number;
  withGpu(gpu: number): HardwareProfile;
  ...
  withGpuMemoryMb(gpuMemoryMb: number): HardwareProfile;

  /**
   * The number of GPUs.
   */
  readonly acceleratorCount: number;
  withAcceleratorCount(acceleratorCount: number): HardwareProfile;
  ...
  withCpuLimit(cpuLimit: number | null): HardwareProfile;
  ...
  withMemoryMbLimit(memoryMbLimit: number | null): HardwareProfile;
  ...
  withDiskGbLimit(diskGbLimit: number | null): HardwareProfile;

  /**
   * The permitted range for {@link HardwareProfile#cpu}
   */
  readonly cpuAllowedRange?: Pair<number | null, number | null> | null;
  withCpuAllowedRange(cpuAllowedRange: IPair<number | null, number | null> | null): HardwareProfile;

  /**
   * The permitted range for {@link HardwareProfile#memoryMb}
   */
  readonly memoryMbAllowedRange?: Pair<number | null, number | null> | null;
  withMemoryMbAllowedRange(memoryMbAllowedRange: IPair<number | null, number | null> | null): HardwareProfile;

  /**
   * The permitted range for {@link HardwareProfile#diskGb}
   */
  readonly diskGbAllowedRange?: Pair<number | null, number | null> | null;
  withDiskGbAllowedRange(diskGbAllowedRange: IPair<number | null, number | null> | null): HardwareProfile;

  /**
   * The permitted range for {@link HardwareProfile#acceleratorCount}
   */
  readonly acceleratorCountAllowedRange?: Pair<number | null, number | null> | null;
  withAcceleratorCountAllowedRange(acceleratorCountAllowedRange: IPair<number | null, number | null> | null): HardwareProfile;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): HardwareProfile | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): HardwareProfile | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): HardwareProfile | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): HardwareProfile | null;
   ...
   */
  replaceType(old: Type, new_: Type): HardwareProfile;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HardwareProfile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HardwareProfile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HardwareProfile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HardwareProfile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): HardwareProfile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HardwareProfile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HardwareProfile;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): HardwareProfile;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): HardwareProfile;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): HardwareProfile;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): HardwareProfile;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): HardwareProfile;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): HardwareProfile;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): HardwareProfile;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): HardwareProfile;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): HardwareProfile;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): HardwareProfile;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): HardwareProfile;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): HardwareProfile;
   ...
   * @see #unsetField
   */
  defaultField(field: string): HardwareProfile;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): HardwareProfile;
   ...
   * @see #removeField
   */
  unsetField(field: string): HardwareProfile;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): HardwareProfile;
   ...
   * @see #unsetField
   */
  removeField(field: string): HardwareProfile;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): HardwareProfile;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): HardwareProfile;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): HardwareProfile;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): HardwareProfile;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): HardwareProfile;

  mergeJson(json: any | null): HardwareProfile;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): HardwareProfile;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): HardwareProfile;
   ...
   */
  singletonArray(): C3.Array<HardwareProfile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<HardwareProfile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<HardwareProfile | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<HardwareProfile | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<HardwareProfile | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, HardwareProfile | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, HardwareProfile | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<HardwareProfile | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<HardwareProfile | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): HardwareProfile;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): HardwareProfile;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): HardwareProfile;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): HardwareProfile;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): HardwareProfile;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): HardwareProfile;
   ...
   * @see #fromString
   */
  static make(s: string | null): HardwareProfile | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): HardwareProfile;
   ...
   */
  static cachedEmptyInst(): HardwareProfile;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<HardwareProfile>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): HardwareProfile;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<HardwareProfile | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<HardwareProfile | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<HardwareProfile | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): HardwareProfile | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): HardwareProfile | null;
   ...
   * @see findByCacheKey
   */
  getCached(): HardwareProfile | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): HardwareProfile | null;
   ...
   */
  static produce(key: string): HardwareProfile | null;
   ...
   */
  static produceAll(): C3.Map<string | null, HardwareProfile | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, HardwareProfile | null>;
   ...
   */
  static forConfigKey(configKey: string | null): HardwareProfile | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<HardwareProfile | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: HardwareProfile, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: HardwareProfile, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): HardwareProfile | null;
   ...
   */
  removeSecrets(): HardwareProfile | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): HardwareProfile | null;
  ...
  validate(validatePartial: boolean | null): HardwareProfile;
   ...
   * @see #toString
   */
  static fromString(s: string | null): HardwareProfile | null;
   ...
   */
  static forName(name: string | null, failIfMissing?: boolean): HardwareProfile | null;
   ...
   */
  static upsertProfile(spec: HardwareProfile.CreateSpec): HardwareProfile;

  /**
   * Checks if hardware with this {@link HardwareProfile} satisfy given {@link HardwareConstraint}.
   */
  satisfiesConstraint(constraint: HardwareConstraint): boolean;
}
