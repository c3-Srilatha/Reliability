// TypeScript definitions for the C3 type NpmLibraryManager.Config

/**
 * Type for specifying different configurations used by {@link NpmLibraryManager}.
 *
 * @remarks this represents a value passed to a method that expects an instance of NpmLibraryManager.Config
 */
declare namespace NpmLibraryManager {
...
declare namespace NpmLibraryManager {
  export class Config extends Obj {
    ...
    withConfigOverride(configOverride: string | null): NpmLibraryManager.Config;

    static readonly configOverride?: string | null;

    readonly secretOverride?: string | null;
    withSecretOverride(secretOverride: string | null): NpmLibraryManager.Config;
    ...
    withIssues(issues: C3.Array<string | null> | Array<string | null>): NpmLibraryManager.Config;
    ...
    withUseArtifactHub(useArtifactHub: boolean): NpmLibraryManager.Config;
    ...
    withUsername(username: string | null): NpmLibraryManager.Config;

    static readonly username?: string | null;

    readonly password?: string | null;
    withPassword(password: string | null): NpmLibraryManager.Config;

    static readonly password?: string | null;

    readonly registry: string;
    withRegistry(registry: string): NpmLibraryManager.Config;

    static readonly registry: string;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): NpmLibraryManager.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): NpmLibraryManager.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): NpmLibraryManager.Config | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): NpmLibraryManager.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): NpmLibraryManager.Config;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): NpmLibraryManager.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NpmLibraryManager.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NpmLibraryManager.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NpmLibraryManager.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NpmLibraryManager.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NpmLibraryManager.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NpmLibraryManager.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NpmLibraryManager.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NpmLibraryManager.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): NpmLibraryManager.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): NpmLibraryManager.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NpmLibraryManager.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NpmLibraryManager.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NpmLibraryManager.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NpmLibraryManager.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): NpmLibraryManager.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): NpmLibraryManager.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): NpmLibraryManager.Config;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): NpmLibraryManager.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): NpmLibraryManager.Config;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): NpmLibraryManager.Config;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): NpmLibraryManager.Config;
     ...
     * @return new Obj
     */
    static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): NpmLibraryManager.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): NpmLibraryManager.Config;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): NpmLibraryManager.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): NpmLibraryManager.Config;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): NpmLibraryManager.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): NpmLibraryManager.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: string | null): NpmLibraryManager.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): NpmLibraryManager.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType | null): NpmLibraryManager.Config;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): NpmLibraryManager.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: C3.Array<string | null> | null): NpmLibraryManager.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): NpmLibraryManager.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): NpmLibraryManager.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): NpmLibraryManager.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): NpmLibraryManager.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): NpmLibraryManager.Config;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): NpmLibraryManager.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): NpmLibraryManager.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): NpmLibraryManager.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): NpmLibraryManager.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): NpmLibraryManager.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): NpmLibraryManager.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: string): NpmLibraryManager.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): NpmLibraryManager.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): NpmLibraryManager.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): NpmLibraryManager.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: string): NpmLibraryManager.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): NpmLibraryManager.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): NpmLibraryManager.Config;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): NpmLibraryManager.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): NpmLibraryManager.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): NpmLibraryManager.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj | null, otherFieldsFilter: Type): NpmLibraryManager.Config;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): NpmLibraryManager.Config;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): NpmLibraryManager.Config;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): NpmLibraryManager.Config;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): NpmLibraryManager.Config;

    mergeJson(json: any | null): NpmLibraryManager.Config;

    static mergeJson(json: any | null): NpmLibraryManager.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): NpmLibraryManager.Config;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): NpmLibraryManager.Config;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): NpmLibraryManager.Config;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj | null, deep?: boolean): NpmLibraryManager.Config;
     ...
     */
    singletonArray(): C3.Array<NpmLibraryManager.Config | null>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): C3.Array<NpmLibraryManager.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<NpmLibraryManager.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<NpmLibraryManager.Config | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<NpmLibraryManager.Config | null>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): C3.Set<NpmLibraryManager.Config | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<NpmLibraryManager.Config | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, NpmLibraryManager.Config | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, NpmLibraryManager.Config | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<NpmLibraryManager.Config | null>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<NpmLibraryManager.Config | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<NpmLibraryManager.Config | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): NpmLibraryManager.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): NpmLibraryManager.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): NpmLibraryManager.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): NpmLibraryManager.Config;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): NpmLibraryManager.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): NpmLibraryManager.Config;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): NpmLibraryManager.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): NpmLibraryManager.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): NpmLibraryManager.Config;
     ...
     */
    static cachedEmptyInst(): NpmLibraryManager.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<NpmLibraryManager.Config>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): NpmLibraryManager.Config;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<NpmLibraryManager.Config | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<NpmLibraryManager.Config | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<NpmLibraryManager.Config | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): NpmLibraryManager.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string | null): NpmLibraryManager.Config | null;
     ...
     * @see findByCacheKey
     */
    getCached(): NpmLibraryManager.Config | null;
     ...
     * @see findByCacheKey
     */
    static getCached(): NpmLibraryManager.Config | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): NpmLibraryManager.Config | null;

    /**
     * @return newly produced cached instance.
     */
    static refreshCache(): NpmLibraryManager.Config | null;
     ...
     */
    static produce(key: string): NpmLibraryManager.Config | null;
     ...
     */
    static produceAll(): C3.Map<string | null, NpmLibraryManager.Config | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, NpmLibraryManager.Config | null>;
     ...
     */
    getConfig(): NpmLibraryManager.Config;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): NpmLibraryManager.Config;
     ...
     */
    getSecret(): NpmLibraryManager.Config;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): NpmLibraryManager.Config;
     ...
     */
    static forConfigKey(configKey: string | null): NpmLibraryManager.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<NpmLibraryManager.Config | null>;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: NpmLibraryManager.Config, override?: string | null): void;

    /**
     * Sets multiple field values to be the same as the passed instance.
     * @see setConfigValue
     */
    static setConfigValues(from: NpmLibraryManager.Config, override?: string | null): void;
     ...
     * @see setSecretValue
     */
    setSecretValues(from: NpmLibraryManager.Config, override?: string | null): void;

    /**
     * Sets multiple secret field values to be the same as the passed instance.
     * @see setSecretValue
     */
    static setSecretValues(from: NpmLibraryManager.Config, override?: string | null): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): NpmLibraryManager.Config | null;
     ...
     */
    removeSecrets(): NpmLibraryManager.Config | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): NpmLibraryManager.Config | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): NpmLibraryManager.Config | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): NpmLibraryManager.Config | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): NpmLibraryManager.Config;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): NpmLibraryManager.Config;
