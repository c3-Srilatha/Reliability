// TypeScript definitions for the C3 type JobRunErrorDetail

/**
 * Error details accessed via an fkey field from batch/map reduce runs.
 *
 * @remarks this represents a value passed to a method that expects an instance of JobRunErrorDetail
 */
declare interface IJobRunErrorDetail {
   ...
   */
  processedAt?: DateTime | Date | string | null;
  ...
  /**
   * Key made up of <job typeId>#<job id>#<run id>
   */
  key: string;
}
 ...
 * Error details accessed via an fkey field from batch/map reduce runs.
 *
 * @remarks this represents a made instance of JobRunErrorDetail
 */
declare class JobRunErrorDetail extends Obj {

  /**
   * C3 Action id of the failed action. Can be used to lookup logs e.g. in Splunk.
   */
  readonly failedActionId?: string | null;
  withFailedActionId(failedActionId: string | null): JobRunErrorDetail;

  /**
   * Timestamp when this action processing has started.
   */
  readonly processedAt?: DateTime | null;
  withProcessedAt(processedAt: DateTime | Date | string | null): JobRunErrorDetail;

  /**
   * Short error message describing failure.
   */
  readonly errorMsg?: string | null;
  withErrorMsg(errorMsg: string | null): JobRunErrorDetail;

  /**
   * Concatenated error codes describing the error.
   */
  readonly errorCodes?: string | null;
  withErrorCodes(errorCodes: string | null): JobRunErrorDetail;

  /**
   * Detailed error message describing failure.
   */
  readonly errorLog?: string | null;
  withErrorLog(errorLog: string | null): JobRunErrorDetail;
   ...
   */
  readonly id: string;
  withId(id: string): JobRunErrorDetail;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): JobRunErrorDetail;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): JobRunErrorDetail;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): JobRunErrorDetail;
  ...
  withVersion(version: number | null): JobRunErrorDetail;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): JobRunErrorDetail;

  /**
   * Key made up of <job typeId>#<job id>#<run id>
   */
  readonly key: string;
  withKey(key: string): JobRunErrorDetail;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): JobRunErrorDetail | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): JobRunErrorDetail | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): JobRunErrorDetail | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): JobRunErrorDetail | null;
   ...
   */
  replaceType(old: Type, new_: Type): JobRunErrorDetail;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JobRunErrorDetail;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JobRunErrorDetail;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JobRunErrorDetail | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JobRunErrorDetail | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): JobRunErrorDetail;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JobRunErrorDetail;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JobRunErrorDetail;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): JobRunErrorDetail;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): JobRunErrorDetail;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): JobRunErrorDetail;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): JobRunErrorDetail;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): JobRunErrorDetail;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): JobRunErrorDetail;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): JobRunErrorDetail;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): JobRunErrorDetail;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): JobRunErrorDetail;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): JobRunErrorDetail;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): JobRunErrorDetail;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): JobRunErrorDetail;
   ...
   * @see #unsetField
   */
  defaultField(field: string): JobRunErrorDetail;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): JobRunErrorDetail;
   ...
   * @see #removeField
   */
  unsetField(field: string): JobRunErrorDetail;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): JobRunErrorDetail;
   ...
   * @see #unsetField
   */
  removeField(field: string): JobRunErrorDetail;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): JobRunErrorDetail;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): JobRunErrorDetail;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): JobRunErrorDetail;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): JobRunErrorDetail;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): JobRunErrorDetail;

  mergeJson(json: any | null): JobRunErrorDetail;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): JobRunErrorDetail;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): JobRunErrorDetail;
   ...
   */
  singletonArray(): C3.Array<JobRunErrorDetail | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<JobRunErrorDetail | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<JobRunErrorDetail | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<JobRunErrorDetail | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<JobRunErrorDetail | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, JobRunErrorDetail | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, JobRunErrorDetail | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<JobRunErrorDetail | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<JobRunErrorDetail | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): JobRunErrorDetail;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): JobRunErrorDetail;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): JobRunErrorDetail;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): JobRunErrorDetail;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): JobRunErrorDetail;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): JobRunErrorDetail;
   ...
   * @see #fromString
   */
  static make(s: string | null): JobRunErrorDetail | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): JobRunErrorDetail;
   ...
   */
  static cachedEmptyInst(): JobRunErrorDetail;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<JobRunErrorDetail>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): JobRunErrorDetail;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<JobRunErrorDetail | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<JobRunErrorDetail | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<JobRunErrorDetail | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<JobRunErrorDetail | null> | null>;
   ...
   */
  get(include?: string | null): JobRunErrorDetail | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): JobRunErrorDetail | null;
   ...
   */
  getMissing(spec: GetMissingSpec): JobRunErrorDetail;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): JobRunErrorDetail | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): JobRunErrorDetail;
   ...
   * @see #toString
   */
  static fromString(s: string | null): JobRunErrorDetail | null;
   ...
   */
  create(spec?: UpsertSpec | null): JobRunErrorDetail | null;
   ...
   */
  static createBatch(objs: C3.Array<JobRunErrorDetail | null> | null, spec?: UpsertSpec | null): ObjList<JobRunErrorDetail | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<JobRunErrorDetail | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<JobRunErrorDetail | null> | null;
   ...
   */
  update(srcObj?: JobRunErrorDetail | null, spec?: UpsertSpec | null): JobRunErrorDetail | null;
   ...
   */
  upsert(srcObj?: JobRunErrorDetail | null, spec?: UpsertSpec | null): JobRunErrorDetail | null;
   ...
   */
  merge(spec?: MergeSpec | null): JobRunErrorDetail | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): JobRunErrorDetail | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): JobRunErrorDetail | null;
   ...
   */
  static updateBatch(objs: C3.Array<JobRunErrorDetail | null> | null, srcObjs?: C3.Array<JobRunErrorDetail | null>, spec?: UpsertSpec | null): ObjList<JobRunErrorDetail | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<JobRunErrorDetail | null>>, spec?: UpsertSpec | null): ObjList<JobRunErrorDetail | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<JobRunErrorDetail | null> | null, srcObjs?: C3.Array<JobRunErrorDetail | null>, spec?: UpsertSpec | null): ObjList<JobRunErrorDetail | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<JobRunErrorDetail | null>>, spec?: UpsertSpec | null): ObjList<JobRunErrorDetail | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<JobRunErrorDetail | null> | null, spec?: TouchSpec | null): ObjList<JobRunErrorDetail | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<JobRunErrorDetail | null> | null, spec?: MergeSpec | null): ObjList<JobRunErrorDetail | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<JobRunErrorDetail | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<JobRunErrorDetail | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<JobRunErrorDetail | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<JobRunErrorDetail | null> | null;
   ...
   */
  static mergeAll(mergeObj: JobRunErrorDetail | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: JobRunErrorDetail | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<JobRunErrorDetail | null> | null, spec?: UpsertSpec | null): ObjList<JobRunErrorDetail | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<JobRunErrorDetail | null> | null, spec?: UpsertSpec | null): ObjList<JobRunErrorDetail | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): JobRunErrorDetail | null;
   ...
   */
  static beforeCreate(objs: C3.Array<JobRunErrorDetail | null> | null): ObjList<JobRunErrorDetail | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<JobRunErrorDetail | null> | null): ObjList<JobRunErrorDetail | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<JobRunErrorDetail | null> | null): ObjList<JobRunErrorDetail | null>;
   ...
   */
  static afterCreate(objs: C3.Array<JobRunErrorDetail | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<JobRunErrorDetail | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<JobRunErrorDetail | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<JobRunErrorDetail | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<JobRunErrorDetail | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): JobRunErrorDetail | null;
   ...
   */
  withoutIdentity(): JobRunErrorDetail | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<JobRunErrorDetail | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: JobRunErrorDetail | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<JobRunErrorDetail | null> | null, callback?: λFunction<JobRunErrorDetail | null, JobRunErrorDetail | null> | null): ObjList<JobRunErrorDetail | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<JobRunErrorDetail | null> | null, callback?: λFunction<JobRunErrorDetail | null, JobRunErrorDetail | null> | null): C3.Array<ObjError | null>;
