// TypeScript definitions for the C3 type PendingRefreshStoredCalcReq

/**
 * Pending newly created/modified stored calcs that require refreshing found in provisioning.
 *
 * @remarks this represents a value passed to a method that expects an instance of PendingRefreshStoredCalcReq
 */
declare interface IPendingRefreshStoredCalcReq {
   ...
   */
  calcFields?: C3.Array<string | null> | Array<string | null>;
}

/**
 * Pending newly created/modified stored calcs that require refreshing found in provisioning.
 *
 * @remarks this represents a made instance of PendingRefreshStoredCalcReq
 */
declare class PendingRefreshStoredCalcReq extends Obj {
  ...
  withTypeIdent(typeIdent: string | null): PendingRefreshStoredCalcReq;
   ...
   */
  readonly id: string;
  withId(id: string): PendingRefreshStoredCalcReq;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): PendingRefreshStoredCalcReq;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): PendingRefreshStoredCalcReq;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): PendingRefreshStoredCalcReq;
  ...
  withVersion(version: number | null): PendingRefreshStoredCalcReq;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): PendingRefreshStoredCalcReq;

  /**
   * Type to refresh.
   */
  readonly refreshType?: Type | null;
  withRefreshType(refreshType: IType | null): PendingRefreshStoredCalcReq;

  /**
   * Calc fields to refresh
   */
  readonly calcFields?: C3.Array<string | null>;
  withCalcFields(calcFields: C3.Array<string | null> | Array<string | null>): PendingRefreshStoredCalcReq;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): PendingRefreshStoredCalcReq | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): PendingRefreshStoredCalcReq | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): PendingRefreshStoredCalcReq | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): PendingRefreshStoredCalcReq | null;
   ...
   */
  replaceType(old: Type, new_: Type): PendingRefreshStoredCalcReq;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PendingRefreshStoredCalcReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PendingRefreshStoredCalcReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PendingRefreshStoredCalcReq | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PendingRefreshStoredCalcReq | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): PendingRefreshStoredCalcReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PendingRefreshStoredCalcReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PendingRefreshStoredCalcReq;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PendingRefreshStoredCalcReq;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PendingRefreshStoredCalcReq;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PendingRefreshStoredCalcReq;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): PendingRefreshStoredCalcReq;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PendingRefreshStoredCalcReq;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PendingRefreshStoredCalcReq;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): PendingRefreshStoredCalcReq;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): PendingRefreshStoredCalcReq;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): PendingRefreshStoredCalcReq;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): PendingRefreshStoredCalcReq;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PendingRefreshStoredCalcReq;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): PendingRefreshStoredCalcReq;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PendingRefreshStoredCalcReq;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PendingRefreshStoredCalcReq;
   ...
   * @see #removeField
   */
  unsetField(field: string): PendingRefreshStoredCalcReq;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PendingRefreshStoredCalcReq;
   ...
   * @see #unsetField
   */
  removeField(field: string): PendingRefreshStoredCalcReq;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PendingRefreshStoredCalcReq;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): PendingRefreshStoredCalcReq;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): PendingRefreshStoredCalcReq;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): PendingRefreshStoredCalcReq;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): PendingRefreshStoredCalcReq;

  mergeJson(json: any | null): PendingRefreshStoredCalcReq;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): PendingRefreshStoredCalcReq;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): PendingRefreshStoredCalcReq;
   ...
   */
  singletonArray(): C3.Array<PendingRefreshStoredCalcReq | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<PendingRefreshStoredCalcReq | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PendingRefreshStoredCalcReq | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<PendingRefreshStoredCalcReq | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PendingRefreshStoredCalcReq | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, PendingRefreshStoredCalcReq | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PendingRefreshStoredCalcReq | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PendingRefreshStoredCalcReq | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PendingRefreshStoredCalcReq | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): PendingRefreshStoredCalcReq;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): PendingRefreshStoredCalcReq;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): PendingRefreshStoredCalcReq;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PendingRefreshStoredCalcReq;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): PendingRefreshStoredCalcReq;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PendingRefreshStoredCalcReq;
   ...
   * @see #fromString
   */
  static make(s: string | null): PendingRefreshStoredCalcReq | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): PendingRefreshStoredCalcReq;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): PendingRefreshStoredCalcReq;
   ...
   */
  static cachedEmptyInst(): PendingRefreshStoredCalcReq;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<PendingRefreshStoredCalcReq>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): PendingRefreshStoredCalcReq;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<PendingRefreshStoredCalcReq | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PendingRefreshStoredCalcReq | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<PendingRefreshStoredCalcReq | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<PendingRefreshStoredCalcReq | null> | null>;
   ...
   */
  get(include?: string | null): PendingRefreshStoredCalcReq | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): PendingRefreshStoredCalcReq | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PendingRefreshStoredCalcReq;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): PendingRefreshStoredCalcReq | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PendingRefreshStoredCalcReq;
   ...
   * @see #toString
   */
  static fromString(s: string | null): PendingRefreshStoredCalcReq | null;
   ...
   */
  create(spec?: UpsertSpec | null): PendingRefreshStoredCalcReq | null;
   ...
   */
  static createBatch(objs: C3.Array<PendingRefreshStoredCalcReq | null> | null, spec?: UpsertSpec | null): ObjList<PendingRefreshStoredCalcReq | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PendingRefreshStoredCalcReq | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<PendingRefreshStoredCalcReq | null> | null;
   ...
   */
  update(srcObj?: PendingRefreshStoredCalcReq | null, spec?: UpsertSpec | null): PendingRefreshStoredCalcReq | null;
   ...
   */
  upsert(srcObj?: PendingRefreshStoredCalcReq | null, spec?: UpsertSpec | null): PendingRefreshStoredCalcReq | null;
   ...
   */
  merge(spec?: MergeSpec | null): PendingRefreshStoredCalcReq | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): PendingRefreshStoredCalcReq | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): PendingRefreshStoredCalcReq | null;
   ...
   */
  static updateBatch(objs: C3.Array<PendingRefreshStoredCalcReq | null> | null, srcObjs?: C3.Array<PendingRefreshStoredCalcReq | null>, spec?: UpsertSpec | null): ObjList<PendingRefreshStoredCalcReq | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<PendingRefreshStoredCalcReq | null>>, spec?: UpsertSpec | null): ObjList<PendingRefreshStoredCalcReq | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<PendingRefreshStoredCalcReq | null> | null, srcObjs?: C3.Array<PendingRefreshStoredCalcReq | null>, spec?: UpsertSpec | null): ObjList<PendingRefreshStoredCalcReq | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<PendingRefreshStoredCalcReq | null>>, spec?: UpsertSpec | null): ObjList<PendingRefreshStoredCalcReq | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<PendingRefreshStoredCalcReq | null> | null, spec?: TouchSpec | null): ObjList<PendingRefreshStoredCalcReq | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PendingRefreshStoredCalcReq | null> | null, spec?: MergeSpec | null): ObjList<PendingRefreshStoredCalcReq | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PendingRefreshStoredCalcReq | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<PendingRefreshStoredCalcReq | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<PendingRefreshStoredCalcReq | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<PendingRefreshStoredCalcReq | null> | null;
   ...
   */
  static mergeAll(mergeObj: PendingRefreshStoredCalcReq | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PendingRefreshStoredCalcReq | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<PendingRefreshStoredCalcReq | null> | null, spec?: UpsertSpec | null): ObjList<PendingRefreshStoredCalcReq | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<PendingRefreshStoredCalcReq | null> | null, spec?: UpsertSpec | null): ObjList<PendingRefreshStoredCalcReq | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): PendingRefreshStoredCalcReq | null;
   ...
   */
  static beforeCreate(objs: C3.Array<PendingRefreshStoredCalcReq | null> | null): ObjList<PendingRefreshStoredCalcReq | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<PendingRefreshStoredCalcReq | null> | null): ObjList<PendingRefreshStoredCalcReq | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<PendingRefreshStoredCalcReq | null> | null): ObjList<PendingRefreshStoredCalcReq | null>;
   ...
   */
  static afterCreate(objs: C3.Array<PendingRefreshStoredCalcReq | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<PendingRefreshStoredCalcReq | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<PendingRefreshStoredCalcReq | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<PendingRefreshStoredCalcReq | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<PendingRefreshStoredCalcReq | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): PendingRefreshStoredCalcReq | null;
   ...
   */
  withoutIdentity(): PendingRefreshStoredCalcReq | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<PendingRefreshStoredCalcReq | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: PendingRefreshStoredCalcReq | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<PendingRefreshStoredCalcReq | null> | null, callback?: λFunction<PendingRefreshStoredCalcReq | null, PendingRefreshStoredCalcReq | null> | null): ObjList<PendingRefreshStoredCalcReq | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<PendingRefreshStoredCalcReq | null> | null, callback?: λFunction<PendingRefreshStoredCalcReq | null, PendingRefreshStoredCalcReq | null> | null): C3.Array<ObjError | null>;
