// TypeScript definitions for the C3 type BrowserTesterBase.Config
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of BrowserTesterBase.Config
 */
declare namespace BrowserTesterBase {
  export interface IConfig {
     ...
     */
    browsers?: C3.Array<string | null> | Array<string | null>;

    /**
     * Luke test completion timeout in seconds.
     */
    lukeTestTimeout?: number | null;

    /**
     * Timeout for BrowserTesterBase.testerHtmlPageReadyFunc in seconds.
     */
    testerHtmlPageReadyFuncTimeout?: number | null;
...
declare namespace BrowserTesterBase {
  export class Config extends Obj {
    ...
    withConfigOverride(configOverride: string | null): BrowserTesterBase.Config;

    static readonly configOverride?: string | null;

    readonly secretOverride?: string | null;
    withSecretOverride(secretOverride: string | null): BrowserTesterBase.Config;
    ...
    withIssues(issues: C3.Array<string | null> | Array<string | null>): BrowserTesterBase.Config;
     ...
     * List of browsers to test against.
     */
    readonly browsers?: C3.Array<string | null>;
    withBrowsers(browsers: C3.Array<string | null> | Array<string | null>): BrowserTesterBase.Config;

    /**
     * List of browsers to test against.
     */
    static readonly browsers?: C3.Array<string | null>;

    /**
     * Luke test completion timeout in seconds.
     */
    readonly lukeTestTimeout?: number | null;
    withLukeTestTimeout(lukeTestTimeout: number | null): BrowserTesterBase.Config;

    /**
     * Luke test completion timeout in seconds.
     */
    static readonly lukeTestTimeout?: number | null;

    /**
     * Timeout for BrowserTesterBase.testerHtmlPageReadyFunc in seconds.
     */
    readonly testerHtmlPageReadyFuncTimeout?: number | null;
    withTesterHtmlPageReadyFuncTimeout(testerHtmlPageReadyFuncTimeout: number | null): BrowserTesterBase.Config;

    /**
     * Timeout for BrowserTesterBase.testerHtmlPageReadyFunc in seconds.
     */
    static readonly testerHtmlPageReadyFuncTimeout?: number | null;
    ...
    withScriptTimeout(scriptTimeout: number | null): BrowserTesterBase.Config;
     ...
     * This must be less than hardcoded selenium helm value SE_NODE_SESSION_TIMEOUT which is 3600s by default.
     */
    static readonly scriptTimeout?: number | null;

    /**
     * Page load timeout in seconds.
     */
    readonly pageLoadTimeout?: number | null;
    withPageLoadTimeout(pageLoadTimeout: number | null): BrowserTesterBase.Config;

    /**
     * Page load timeout in seconds.
     */
    static readonly pageLoadTimeout?: number | null;

    /**
     * Maximum number of retires.
     */
    readonly maxRetries?: number | null;
    withMaxRetries(maxRetries: number | null): BrowserTesterBase.Config;

    /**
     * Maximum number of retires.
     */
    static readonly maxRetries?: number | null;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): BrowserTesterBase.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): BrowserTesterBase.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): BrowserTesterBase.Config | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): BrowserTesterBase.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): BrowserTesterBase.Config;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): BrowserTesterBase.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BrowserTesterBase.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BrowserTesterBase.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BrowserTesterBase.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BrowserTesterBase.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BrowserTesterBase.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BrowserTesterBase.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BrowserTesterBase.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BrowserTesterBase.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): BrowserTesterBase.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): BrowserTesterBase.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BrowserTesterBase.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BrowserTesterBase.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BrowserTesterBase.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BrowserTesterBase.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): BrowserTesterBase.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): BrowserTesterBase.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): BrowserTesterBase.Config;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): BrowserTesterBase.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): BrowserTesterBase.Config;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): BrowserTesterBase.Config;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): BrowserTesterBase.Config;
     ...
     * @return new Obj
     */
    static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): BrowserTesterBase.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BrowserTesterBase.Config;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BrowserTesterBase.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): BrowserTesterBase.Config;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): BrowserTesterBase.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): BrowserTesterBase.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: string | null): BrowserTesterBase.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): BrowserTesterBase.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType | null): BrowserTesterBase.Config;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): BrowserTesterBase.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: C3.Array<string | null> | null): BrowserTesterBase.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): BrowserTesterBase.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): BrowserTesterBase.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): BrowserTesterBase.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): BrowserTesterBase.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): BrowserTesterBase.Config;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): BrowserTesterBase.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): BrowserTesterBase.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): BrowserTesterBase.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): BrowserTesterBase.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): BrowserTesterBase.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): BrowserTesterBase.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: string): BrowserTesterBase.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): BrowserTesterBase.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): BrowserTesterBase.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): BrowserTesterBase.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: string): BrowserTesterBase.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): BrowserTesterBase.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): BrowserTesterBase.Config;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): BrowserTesterBase.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): BrowserTesterBase.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): BrowserTesterBase.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj | null, otherFieldsFilter: Type): BrowserTesterBase.Config;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): BrowserTesterBase.Config;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): BrowserTesterBase.Config;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): BrowserTesterBase.Config;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): BrowserTesterBase.Config;

    mergeJson(json: any | null): BrowserTesterBase.Config;

    static mergeJson(json: any | null): BrowserTesterBase.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): BrowserTesterBase.Config;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): BrowserTesterBase.Config;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): BrowserTesterBase.Config;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj | null, deep?: boolean): BrowserTesterBase.Config;
     ...
     */
    singletonArray(): C3.Array<BrowserTesterBase.Config | null>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): C3.Array<BrowserTesterBase.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<BrowserTesterBase.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<BrowserTesterBase.Config | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<BrowserTesterBase.Config | null>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): C3.Set<BrowserTesterBase.Config | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<BrowserTesterBase.Config | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, BrowserTesterBase.Config | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, BrowserTesterBase.Config | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<BrowserTesterBase.Config | null>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<BrowserTesterBase.Config | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<BrowserTesterBase.Config | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): BrowserTesterBase.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): BrowserTesterBase.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): BrowserTesterBase.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): BrowserTesterBase.Config;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): BrowserTesterBase.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): BrowserTesterBase.Config;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): BrowserTesterBase.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): BrowserTesterBase.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): BrowserTesterBase.Config;
     ...
     */
    static cachedEmptyInst(): BrowserTesterBase.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<BrowserTesterBase.Config>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): BrowserTesterBase.Config;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<BrowserTesterBase.Config | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<BrowserTesterBase.Config | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<BrowserTesterBase.Config | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): BrowserTesterBase.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string | null): BrowserTesterBase.Config | null;
     ...
     * @see findByCacheKey
     */
    getCached(): BrowserTesterBase.Config | null;
     ...
     * @see findByCacheKey
     */
    static getCached(): BrowserTesterBase.Config | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): BrowserTesterBase.Config | null;

    /**
     * @return newly produced cached instance.
     */
    static refreshCache(): BrowserTesterBase.Config | null;
     ...
     */
    static produce(key: string): BrowserTesterBase.Config | null;
     ...
     */
    static produceAll(): C3.Map<string | null, BrowserTesterBase.Config | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, BrowserTesterBase.Config | null>;
     ...
     */
    getConfig(): BrowserTesterBase.Config;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): BrowserTesterBase.Config;
     ...
     */
    getSecret(): BrowserTesterBase.Config;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): BrowserTesterBase.Config;
     ...
     */
    static forConfigKey(configKey: string | null): BrowserTesterBase.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<BrowserTesterBase.Config | null>;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: BrowserTesterBase.Config, override?: string | null): void;

    /**
     * Sets multiple field values to be the same as the passed instance.
     * @see setConfigValue
     */
    static setConfigValues(from: BrowserTesterBase.Config, override?: string | null): void;
     ...
     * @see setSecretValue
     */
    setSecretValues(from: BrowserTesterBase.Config, override?: string | null): void;

    /**
     * Sets multiple secret field values to be the same as the passed instance.
     * @see setSecretValue
     */
    static setSecretValues(from: BrowserTesterBase.Config, override?: string | null): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): BrowserTesterBase.Config | null;
     ...
     */
    removeSecrets(): BrowserTesterBase.Config | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): BrowserTesterBase.Config | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): BrowserTesterBase.Config | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): BrowserTesterBase.Config | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): BrowserTesterBase.Config;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): BrowserTesterBase.Config;
