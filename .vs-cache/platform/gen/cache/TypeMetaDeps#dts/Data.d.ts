// TypeScript definitions for the C3 type Data

/**
 * Abstract interface representing tabular data of named columns and indexed rows.
 *
 * @remarks this represents a value passed to a method that expects an instance of Data
 */
 ...
 * Abstract interface representing tabular data of named columns and indexed rows.
 *
 * @remarks this represents a made instance of Data
 */
declare class Data extends Obj {
  ...
  withLOCAL_FOLDER_PREFIX(LOCAL_FOLDER_PREFIX: string | null): Data;
   ...
   */
  replaceType(old: Type, new_: Type): Data;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Data | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Data | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Data | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Data | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Data;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Data;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Data;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Data;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Data;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Data;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Data;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Data;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Data;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Data;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Data;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Data;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data;

  mergeJson(json: any | null): Data;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Data;
   ...
   */
  singletonArray(): C3.Array<Data | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Data | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Data | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Data | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Data | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Data | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Data | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Data | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Data;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Data;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data;
   ...
   */
  static cachedEmptyInst(): Data;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Data;
   ...
   */
  static fromPySrc(pySrc: string, dfs?: C3.Set<DataImpl | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): Data | null;
   ...
   */
  static _jsDataProxy(inst: any): Data;
   ...
   * @return an instance of Data from the provided collection of {@link Obj}s or {@link Tuple}s
   */
  static fromCollection(col: Collection<Obj | null> | null | Collection<Tuple | null> | null, dataset?: Dataset | null, include?: string | null): Data | null;
   ...
   * 1       b 2000-01-02    2.0
   */
  static fromTuple(tuple: Tuple, dataset?: Dataset | null): Data | null;
