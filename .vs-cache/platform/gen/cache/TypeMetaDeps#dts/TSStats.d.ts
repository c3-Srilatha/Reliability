// TypeScript definitions for the C3 type TSStats

/**
 * @remarks this represents a value passed to a method that expects an instance of TSStats
 */
declare interface ITSStats {
  ...
  job?: ITSStatsJob | null;

  /**
   * this value is for job.spec.group or null
   */
  group?: string | null;
...
/**
 * @remarks this represents a made instance of TSStats
 */
declare class TSStats extends Obj {
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): TSStats;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): TSStats;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): TSStats;
  ...
  withVersion(version: number | null): TSStats;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): TSStats;

  readonly job?: TSStatsJob | null;
  withJob(job: ITSStatsJob | null): TSStats;

  /**
   * this value is for job.spec.group or null
   */
  readonly group?: string | null;
  withGroup(group: string | null): TSStats;

  readonly start?: DateTime | null;
  withStart(start: DateTime | Date | string | null): TSStats;

  readonly value?: number | null;
  withValue(value: number | null): TSStats;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TSStats | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TSStats | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TSStats | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TSStats | null;
   ...
   */
  replaceType(old: Type, new_: Type): TSStats;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TSStats;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TSStats;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TSStats | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TSStats | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TSStats;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TSStats;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TSStats;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TSStats;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TSStats;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TSStats;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TSStats;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TSStats;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TSStats;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TSStats;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TSStats;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TSStats;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TSStats;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TSStats;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TSStats;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TSStats;
   ...
   * @see #removeField
   */
  unsetField(field: string): TSStats;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TSStats;
   ...
   * @see #unsetField
   */
  removeField(field: string): TSStats;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TSStats;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TSStats;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TSStats;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TSStats;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TSStats;

  mergeJson(json: any | null): TSStats;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TSStats;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TSStats;
   ...
   */
  singletonArray(): C3.Array<TSStats | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TSStats | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TSStats | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TSStats | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TSStats | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TSStats | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TSStats | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TSStats | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TSStats | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TSStats;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TSStats;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TSStats;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TSStats;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TSStats;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TSStats;
   ...
   * @see #fromString
   */
  static make(s: string | null): TSStats | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TSStats;
   ...
   */
  static cachedEmptyInst(): TSStats;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TSStats>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TSStats;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TSStats | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TSStats | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TSStats | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TSStats | null> | null>;
   ...
   */
  get(include?: string | null): TSStats | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TSStats | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TSStats;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TSStats | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TSStats;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TSStats | null;
   ...
   */
  create(spec?: UpsertSpec | null): TSStats | null;
   ...
   */
  static createBatch(objs: C3.Array<TSStats | null> | null, spec?: UpsertSpec | null): ObjList<TSStats | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TSStats | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TSStats | null> | null;
   ...
   */
  update(srcObj?: TSStats | null, spec?: UpsertSpec | null): TSStats | null;
   ...
   */
  upsert(srcObj?: TSStats | null, spec?: UpsertSpec | null): TSStats | null;
   ...
   */
  merge(spec?: MergeSpec | null): TSStats | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TSStats | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TSStats | null;
   ...
   */
  static updateBatch(objs: C3.Array<TSStats | null> | null, srcObjs?: C3.Array<TSStats | null>, spec?: UpsertSpec | null): ObjList<TSStats | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TSStats | null>>, spec?: UpsertSpec | null): ObjList<TSStats | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TSStats | null> | null, srcObjs?: C3.Array<TSStats | null>, spec?: UpsertSpec | null): ObjList<TSStats | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TSStats | null>>, spec?: UpsertSpec | null): ObjList<TSStats | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TSStats | null> | null, spec?: TouchSpec | null): ObjList<TSStats | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TSStats | null> | null, spec?: MergeSpec | null): ObjList<TSStats | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TSStats | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TSStats | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TSStats | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TSStats | null> | null;
   ...
   */
  static mergeAll(mergeObj: TSStats | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TSStats | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TSStats | null> | null, spec?: UpsertSpec | null): ObjList<TSStats | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TSStats | null> | null, spec?: UpsertSpec | null): ObjList<TSStats | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TSStats | null> | null): ObjList<TSStats | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TSStats | null> | null): ObjList<TSStats | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TSStats | null> | null): ObjList<TSStats | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TSStats | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TSStats | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TSStats | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TSStats | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TSStats | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TSStats | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<TSStats | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TSStats | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TSStats | null> | null, callback?: λFunction<TSStats | null, TSStats | null> | null): ObjList<TSStats | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TSStats | null> | null, callback?: λFunction<TSStats | null, TSStats | null> | null): C3.Array<ObjError | null>;
  ...
  static startCalc(spec?: TSStatsCalcSpec | null): TSStatsJob | null;

  static cancelCalc(job?: TSStatsJob | null): TSStatsJob | null;

  static status(job?: TSStatsJob | null): MapReduceStatus | null;

  static read(spec?: TSStatsReadSpec | null): C3.Array<TSStats | null>;
}
