// TypeScript definitions for the C3 type RefreshCalcFieldsBatchJob

/**
 * Batch job definitions for batch jobs started from RefreshCalcFieldsTask for asynchronous processing.
 *
 * @remarks this represents a value passed to a method that expects an instance of RefreshCalcFieldsBatchJob
 */
declare interface IRefreshCalcFieldsBatchJob {
 ...
 */
declare class RefreshCalcFieldsBatchJob extends Obj {

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun | null;
  withRun(run: IBatchJobRun | null): RefreshCalcFieldsBatchJob;

  /**
   * previous job executions for this instance
   */
  readonly runs?: C3.Array<BatchJobRun | null>;
  withRuns(runs: C3.Array<BatchJobRun | null> | Array<IBatchJobRun | null>): RefreshCalcFieldsBatchJob;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj | null;
  withOptions(options: IObj | null): RefreshCalcFieldsBatchJob;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): RefreshCalcFieldsBatchJob;
  ...
  withPriority(priority: number | null): RefreshCalcFieldsBatchJob;
  ...
  withDisabled(disabled: boolean): RefreshCalcFieldsBatchJob;
  ...
  withMaxConcurrency(maxConcurrency: number | null): RefreshCalcFieldsBatchJob;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): RefreshCalcFieldsBatchJob;
  ...
  withRunAsUser(runAsUser: boolean | null): RefreshCalcFieldsBatchJob;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string | null;
  withNodePool(nodePool: string | null): RefreshCalcFieldsBatchJob;
  ...
  withSkipIfRunning(skipIfRunning: boolean | null): RefreshCalcFieldsBatchJob;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number | null;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): RefreshCalcFieldsBatchJob;
  ...
  withPropagateActionContext(propagateActionContext: boolean): RefreshCalcFieldsBatchJob;
  ...
  withTypeIdent(typeIdent: string | null): RefreshCalcFieldsBatchJob;
   ...
   */
  readonly id: string;
  withId(id: string): RefreshCalcFieldsBatchJob;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): RefreshCalcFieldsBatchJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): RefreshCalcFieldsBatchJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): RefreshCalcFieldsBatchJob;
  ...
  withVersion(version: number | null): RefreshCalcFieldsBatchJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): RefreshCalcFieldsBatchJob;
  ...
  withAbortOnError(abortOnError: boolean): RefreshCalcFieldsBatchJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): RefreshCalcFieldsBatchJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): RefreshCalcFieldsBatchJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): RefreshCalcFieldsBatchJob | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): RefreshCalcFieldsBatchJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): RefreshCalcFieldsBatchJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): RefreshCalcFieldsBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): RefreshCalcFieldsBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<RefreshCalcFieldsBatchJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<RefreshCalcFieldsBatchJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): RefreshCalcFieldsBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RefreshCalcFieldsBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RefreshCalcFieldsBatchJob;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): RefreshCalcFieldsBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): RefreshCalcFieldsBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): RefreshCalcFieldsBatchJob;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): RefreshCalcFieldsBatchJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): RefreshCalcFieldsBatchJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): RefreshCalcFieldsBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): RefreshCalcFieldsBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): RefreshCalcFieldsBatchJob;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): RefreshCalcFieldsBatchJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): RefreshCalcFieldsBatchJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): RefreshCalcFieldsBatchJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): RefreshCalcFieldsBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): RefreshCalcFieldsBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): RefreshCalcFieldsBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): RefreshCalcFieldsBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): RefreshCalcFieldsBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): RefreshCalcFieldsBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): RefreshCalcFieldsBatchJob;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): RefreshCalcFieldsBatchJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): RefreshCalcFieldsBatchJob;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): RefreshCalcFieldsBatchJob;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): RefreshCalcFieldsBatchJob;

  mergeJson(json: any | null): RefreshCalcFieldsBatchJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): RefreshCalcFieldsBatchJob;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): RefreshCalcFieldsBatchJob;
   ...
   */
  singletonArray(): C3.Array<RefreshCalcFieldsBatchJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<RefreshCalcFieldsBatchJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<RefreshCalcFieldsBatchJob | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<RefreshCalcFieldsBatchJob | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<RefreshCalcFieldsBatchJob | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, RefreshCalcFieldsBatchJob | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, RefreshCalcFieldsBatchJob | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<RefreshCalcFieldsBatchJob | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<RefreshCalcFieldsBatchJob | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): RefreshCalcFieldsBatchJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): RefreshCalcFieldsBatchJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): RefreshCalcFieldsBatchJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): RefreshCalcFieldsBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): RefreshCalcFieldsBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): RefreshCalcFieldsBatchJob;
   ...
   * @see #fromString
   */
  static make(s: string | null): RefreshCalcFieldsBatchJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): RefreshCalcFieldsBatchJob;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): RefreshCalcFieldsBatchJob;
   ...
   */
  static cachedEmptyInst(): RefreshCalcFieldsBatchJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<RefreshCalcFieldsBatchJob>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): RefreshCalcFieldsBatchJob;
   ...
   */
  start(options?: RefreshCalcFieldsSpec | null): BatchJobStatus | null;
   ...
   */
  cleanup(options?: RefreshCalcFieldsSpec | null): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun | null, BatchJobStatus | null, RefreshCalcFieldsSpec | null> | null;

  failJob(run: JobRun<BatchJobStatusBase | null>): JobBase<BatchJobRun | null, BatchJobStatus | null, RefreshCalcFieldsSpec | null> | null;
  ...
  validateStart(options?: RefreshCalcFieldsSpec | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<RefreshCalcFieldsBatchJob | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<RefreshCalcFieldsBatchJob | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<RefreshCalcFieldsBatchJob | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<RefreshCalcFieldsBatchJob | null> | null>;
   ...
   */
  get(include?: string | null): RefreshCalcFieldsBatchJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): RefreshCalcFieldsBatchJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): RefreshCalcFieldsBatchJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): RefreshCalcFieldsBatchJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): RefreshCalcFieldsBatchJob;
   ...
   * @see #toString
   */
  static fromString(s: string | null): RefreshCalcFieldsBatchJob | null;
   ...
   */
  create(spec?: UpsertSpec | null): RefreshCalcFieldsBatchJob | null;
   ...
   */
  static createBatch(objs: C3.Array<RefreshCalcFieldsBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<RefreshCalcFieldsBatchJob | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<RefreshCalcFieldsBatchJob | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<RefreshCalcFieldsBatchJob | null> | null;
   ...
   */
  update(srcObj?: RefreshCalcFieldsBatchJob | null, spec?: UpsertSpec | null): RefreshCalcFieldsBatchJob | null;
   ...
   */
  upsert(srcObj?: RefreshCalcFieldsBatchJob | null, spec?: UpsertSpec | null): RefreshCalcFieldsBatchJob | null;
   ...
   */
  merge(spec?: MergeSpec | null): RefreshCalcFieldsBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): RefreshCalcFieldsBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): RefreshCalcFieldsBatchJob | null;
   ...
   */
  static updateBatch(objs: C3.Array<RefreshCalcFieldsBatchJob | null> | null, srcObjs?: C3.Array<RefreshCalcFieldsBatchJob | null>, spec?: UpsertSpec | null): ObjList<RefreshCalcFieldsBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<RefreshCalcFieldsBatchJob | null>>, spec?: UpsertSpec | null): ObjList<RefreshCalcFieldsBatchJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<RefreshCalcFieldsBatchJob | null> | null, srcObjs?: C3.Array<RefreshCalcFieldsBatchJob | null>, spec?: UpsertSpec | null): ObjList<RefreshCalcFieldsBatchJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<RefreshCalcFieldsBatchJob | null>>, spec?: UpsertSpec | null): ObjList<RefreshCalcFieldsBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<RefreshCalcFieldsBatchJob | null> | null, spec?: TouchSpec | null): ObjList<RefreshCalcFieldsBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<RefreshCalcFieldsBatchJob | null> | null, spec?: MergeSpec | null): ObjList<RefreshCalcFieldsBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<RefreshCalcFieldsBatchJob | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<RefreshCalcFieldsBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<RefreshCalcFieldsBatchJob | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<RefreshCalcFieldsBatchJob | null> | null;
   ...
   */
  static mergeAll(mergeObj: RefreshCalcFieldsBatchJob | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: RefreshCalcFieldsBatchJob | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<RefreshCalcFieldsBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<RefreshCalcFieldsBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<RefreshCalcFieldsBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<RefreshCalcFieldsBatchJob | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): RefreshCalcFieldsBatchJob | null;
   ...
   */
  static beforeCreate(objs: C3.Array<RefreshCalcFieldsBatchJob | null> | null): ObjList<RefreshCalcFieldsBatchJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<RefreshCalcFieldsBatchJob | null> | null): ObjList<RefreshCalcFieldsBatchJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<RefreshCalcFieldsBatchJob | null> | null): ObjList<RefreshCalcFieldsBatchJob | null>;
   ...
   */
  static afterCreate(objs: C3.Array<RefreshCalcFieldsBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<RefreshCalcFieldsBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<RefreshCalcFieldsBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<RefreshCalcFieldsBatchJob | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<RefreshCalcFieldsBatchJob | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): RefreshCalcFieldsBatchJob | null;
   ...
   */
  withoutIdentity(): RefreshCalcFieldsBatchJob | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<RefreshCalcFieldsBatchJob | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: RefreshCalcFieldsBatchJob | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<RefreshCalcFieldsBatchJob | null> | null, callback?: λFunction<RefreshCalcFieldsBatchJob | null, RefreshCalcFieldsBatchJob | null> | null): ObjList<RefreshCalcFieldsBatchJob | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<RefreshCalcFieldsBatchJob | null> | null, callback?: λFunction<RefreshCalcFieldsBatchJob | null, RefreshCalcFieldsBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static doStart(job?: RefreshCalcFieldsBatchJob | null, options?: RefreshCalcFieldsSpec | null): void;
   ...
   */
  static processBatch(batch?: RefreshCalcFieldsSpec | null, job?: RefreshCalcFieldsBatchJob | null, options?: RefreshCalcFieldsSpec | null): void;
   ...
   */
  static allComplete(job: RefreshCalcFieldsBatchJob, options?: RefreshCalcFieldsSpec | null): string | null;
   ...
   *           Options the job was run with.
   */
  static failed(job: RefreshCalcFieldsBatchJob, status: BatchJobStatus, options?: RefreshCalcFieldsSpec | null): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: RefreshCalcFieldsSpec | null): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: C3.Array<RefreshCalcFieldsSpec | null>): void;
   ...
   */
  static scheduleObjBatch(job?: RefreshCalcFieldsBatchJob | null, objBatch?: ObjBatch | null, logPrefix?: string | null): number | null;
