// TypeScript definitions for the C3 type PathId

/**
 * Mapping of field paths to numeric ids for more efficient storage of references to field paths in other objs.  The value of the
 * id field will be the pathId for the specified field path.
 *
 * @remarks this represents a value passed to a method that expects an instance of PathId
 */
declare interface IPathId {
  ...
  /**
   * PathId mappings are never updated so no need for version field.
   */
  version?: number | null;
 ...
 * id field will be the pathId for the specified field path.
 *
 * @remarks this represents a made instance of PathId
 */
declare class PathId extends Obj {
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): PathId;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): PathId;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): PathId;

  /**
   * PathId mappings are never updated so no need for version field.
   */
  readonly version?: number | null;
  withVersion(version: number | null): PathId;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): PathId;

  /**
   * Path.
   */
  readonly path?: string | null;
  withPath(path: string | null): PathId;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): PathId | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): PathId | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): PathId | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): PathId | null;
   ...
   */
  replaceType(old: Type, new_: Type): PathId;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PathId;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PathId;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PathId | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PathId | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): PathId;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PathId;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PathId;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PathId;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PathId;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): PathId;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PathId;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PathId;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): PathId;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): PathId;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): PathId;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): PathId;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PathId;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): PathId;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PathId;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PathId;
   ...
   * @see #removeField
   */
  unsetField(field: string): PathId;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PathId;
   ...
   * @see #unsetField
   */
  removeField(field: string): PathId;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PathId;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): PathId;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): PathId;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): PathId;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): PathId;

  mergeJson(json: any | null): PathId;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): PathId;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): PathId;
   ...
   */
  singletonArray(): C3.Array<PathId | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<PathId | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PathId | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<PathId | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PathId | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, PathId | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PathId | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PathId | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PathId | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): PathId;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): PathId;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): PathId;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PathId;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): PathId;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PathId;
   ...
   * @see #fromString
   */
  static make(s: string | null): PathId | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): PathId;
   ...
   */
  static cachedEmptyInst(): PathId;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<PathId>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): PathId;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<PathId | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PathId | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<PathId | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<PathId | null> | null>;
   ...
   */
  get(include?: string | null): PathId | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): PathId | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PathId;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): PathId | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PathId;
   ...
   * @see #toString
   */
  static fromString(s: string | null): PathId | null;
   ...
   */
  create(spec?: UpsertSpec | null): PathId | null;
   ...
   */
  static createBatch(objs: C3.Array<PathId | null> | null, spec?: UpsertSpec | null): ObjList<PathId | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PathId | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<PathId | null> | null;
   ...
   */
  update(srcObj?: PathId | null, spec?: UpsertSpec | null): PathId | null;
   ...
   */
  upsert(srcObj?: PathId | null, spec?: UpsertSpec | null): PathId | null;
   ...
   */
  merge(spec?: MergeSpec | null): PathId | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): PathId | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): PathId | null;
   ...
   */
  static updateBatch(objs: C3.Array<PathId | null> | null, srcObjs?: C3.Array<PathId | null>, spec?: UpsertSpec | null): ObjList<PathId | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<PathId | null>>, spec?: UpsertSpec | null): ObjList<PathId | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<PathId | null> | null, srcObjs?: C3.Array<PathId | null>, spec?: UpsertSpec | null): ObjList<PathId | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<PathId | null>>, spec?: UpsertSpec | null): ObjList<PathId | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<PathId | null> | null, spec?: TouchSpec | null): ObjList<PathId | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PathId | null> | null, spec?: MergeSpec | null): ObjList<PathId | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PathId | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<PathId | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<PathId | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<PathId | null> | null;
   ...
   */
  static mergeAll(mergeObj: PathId | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PathId | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<PathId | null> | null, spec?: UpsertSpec | null): ObjList<PathId | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<PathId | null> | null, spec?: UpsertSpec | null): ObjList<PathId | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<PathId | null> | null): ObjList<PathId | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<PathId | null> | null): ObjList<PathId | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<PathId | null> | null): ObjList<PathId | null>;
   ...
   */
  static afterCreate(objs: C3.Array<PathId | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<PathId | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<PathId | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<PathId | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<PathId | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): PathId | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<PathId | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: PathId | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<PathId | null> | null, callback?: λFunction<PathId | null, PathId | null> | null): ObjList<PathId | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<PathId | null> | null, callback?: λFunction<PathId | null, PathId | null> | null): C3.Array<ObjError | null>;
