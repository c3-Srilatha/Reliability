// TypeScript definitions for the C3 type Config
 ...
 * @see Metadata
 *
 * @remarks this represents a value passed to a method that expects an instance of Config
 */
 ...
 */
declare class Config extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): Config;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): Config;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): Config;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Config | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Config | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Config | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Config | null;
   ...
   */
  replaceType(old: Type, new_: Type): Config;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Config;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Config;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Config | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Config | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Config;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Config;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Config;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Config;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Config;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Config;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Config;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Config;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Config;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Config;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Config;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Config;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Config;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Config;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Config;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Config;
   ...
   * @see #removeField
   */
  unsetField(field: string): Config;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Config;
   ...
   * @see #unsetField
   */
  removeField(field: string): Config;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Config;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Config;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Config;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Config;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Config;

  mergeJson(json: any | null): Config;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Config;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Config;
   ...
   */
  singletonArray(): C3.Array<Config | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Config | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Config | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Config | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Config | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Config | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Config | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Config | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Config | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Config;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Config;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Config;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Config;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Config;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Config;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Config;
   ...
   */
  static cachedEmptyInst(): Config;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Config>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Config;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<Config | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<Config | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<Config | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): Config | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): Config | null;
   ...
   */
  static produce(key: string): Config | null;
   ...
   */
  static produceAll(): C3.Map<string | null, Config | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, Config | null>;
   ...
   */
  static forConfigKey(configKey: string | null): Config | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<Config | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: Config, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: Config, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): Config | null;
   ...
   */
  removeSecrets(): Config | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): Config | null;
