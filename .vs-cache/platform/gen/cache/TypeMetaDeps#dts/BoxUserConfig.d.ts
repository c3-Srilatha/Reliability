// TypeScript definitions for the C3 type BoxUserConfig

/**
 * Type to manage Box User credential, belonging to user.
 *
 * @remarks this represents a value passed to a method that expects an instance of BoxUserConfig
 */
declare interface IBoxUserConfig {
  ...
  /**
   * ID of the user associated with this config
   */
  userId?: string | null;
   ...
   * Box user setting
   */
  boxUserSetting?: IBoxUserSetting | null;
}

/**
 * Type to manage Box User credential, belonging to user.
 *
 * @remarks this represents a made instance of BoxUserConfig
 */
declare class BoxUserConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): BoxUserConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): BoxUserConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): BoxUserConfig;

  /**
   * ID of the user associated with this config
   */
  readonly userId?: string | null;
  withUserId(userId: string | null): BoxUserConfig;

  /**
   * Box user setting
   */
  readonly boxUserSetting?: BoxUserSetting | null;
  withBoxUserSetting(boxUserSetting: IBoxUserSetting | null): BoxUserConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): BoxUserConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): BoxUserConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): BoxUserConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): BoxUserConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): BoxUserConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BoxUserConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BoxUserConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BoxUserConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BoxUserConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): BoxUserConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BoxUserConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BoxUserConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): BoxUserConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): BoxUserConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): BoxUserConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): BoxUserConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BoxUserConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): BoxUserConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): BoxUserConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): BoxUserConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): BoxUserConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): BoxUserConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): BoxUserConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): BoxUserConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): BoxUserConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): BoxUserConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): BoxUserConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): BoxUserConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): BoxUserConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): BoxUserConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): BoxUserConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): BoxUserConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): BoxUserConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): BoxUserConfig;

  mergeJson(json: any | null): BoxUserConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): BoxUserConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): BoxUserConfig;
   ...
   */
  singletonArray(): C3.Array<BoxUserConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<BoxUserConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BoxUserConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<BoxUserConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BoxUserConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, BoxUserConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BoxUserConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BoxUserConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BoxUserConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): BoxUserConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): BoxUserConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): BoxUserConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): BoxUserConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): BoxUserConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): BoxUserConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): BoxUserConfig;
   ...
   */
  static cachedEmptyInst(): BoxUserConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<BoxUserConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): BoxUserConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<BoxUserConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<BoxUserConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<BoxUserConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): BoxUserConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): BoxUserConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): BoxUserConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): BoxUserConfig | null;
   ...
   */
  static produce(key: string): BoxUserConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, BoxUserConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, BoxUserConfig | null>;
   ...
   */
  static forConfigKey(configKey: string | null): BoxUserConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<BoxUserConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: BoxUserConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: BoxUserConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): BoxUserConfig | null;
   ...
   */
  static setConfigAndSecret(userId?: string | null, accessToken?: string | null, refreshToken?: string | null, lastRefresh?: number | null, expires?: number | null): void;

  /**
   * A helper function to get public and secret configs
   */
  static getConfigAndSecret(): BoxUserConfig | null;
}
