// TypeScript definitions for the C3 type Err.DuplicateIdForCreate

/**
 * Error type representing duplicate id detected on create.
 *
 * @remarks this represents a value passed to a method that expects an instance of Err.DuplicateIdForCreate
 */
declare namespace Err {
  export interface IDuplicateIdForCreate {
 ...
 */
declare namespace Err {
  export class DuplicateIdForCreate extends Obj {

    /**
     * Formatted and localized message.
     */
    readonly message?: string | null;
    withMessage(message: string | null): Err.DuplicateIdForCreate;

    /**
     * Unlocalized, parameterized error message string.
     */
    readonly template?: string | null;
    withTemplate(template: string | null): Err.DuplicateIdForCreate;

    /**
     * Parameters applied to {@link template} to produce error message.
     */
    readonly parameters?: C3.Array<string | null>;
    withParameters(parameters: C3.Array<string | null> | Array<string | null>): Err.DuplicateIdForCreate;

    /**
     * Unique (generated) error id.
     */
    readonly id?: string | null;
    withId(id: string | null): Err.DuplicateIdForCreate;

    /**
     * Error key.
     */
    readonly key?: string | null;
    withKey(key: string | null): Err.DuplicateIdForCreate;

    /**
     * Error for nested/causing exception (if any).
     */
    readonly cause?: C3.Error | null;
    withCause(cause: IC3.Error | null): Err.DuplicateIdForCreate;

    /**
     * http status code for this error
     */
    readonly httpStatusCode: number;
    withHttpStatusCode(httpStatusCode: number): Err.DuplicateIdForCreate;

    /**
     * Filename for where the error originated from
     */
    readonly filenameOfRootError?: string | null;
    withFilenameOfRootError(filenameOfRootError: string | null): Err.DuplicateIdForCreate;

    /**
     * Extra debugging information, such as script language stack.
     */
    readonly debugInfo?: C3.Array<string | null>;
    withDebugInfo(debugInfo: C3.Array<string | null> | Array<string | null>): Err.DuplicateIdForCreate;

    /**
     * Script language (js/py) stacktrace.
     */
    readonly stackTrace?: C3.Array<StackFrame | null>;
    withStackTrace(stackTrace: C3.Array<StackFrame | null> | Array<IStackFrame | null>): Err.DuplicateIdForCreate;
    ...
    withAction(action: string | null): Err.DuplicateIdForCreate;

    /**
     * Engine of the action that threw this error
     */
    readonly engine?: string | null;
    withEngine(engine: string | null): Err.DuplicateIdForCreate;

    /**
     * Timestamp when the error was thrown
     */
    readonly timestamp?: DateTime | null;
    withTimestamp(timestamp: DateTime | Date | string | null): Err.DuplicateIdForCreate;
    ...
    with_system(_system: any): Err.DuplicateIdForCreate;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Err.DuplicateIdForCreate | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Err.DuplicateIdForCreate | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Err.DuplicateIdForCreate | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Err.DuplicateIdForCreate | null;
     ...
     */
    replaceType(old: Type, new_: Type): Err.DuplicateIdForCreate;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Err.DuplicateIdForCreate;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Err.DuplicateIdForCreate;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Err.DuplicateIdForCreate | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Err.DuplicateIdForCreate | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Err.DuplicateIdForCreate;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Err.DuplicateIdForCreate;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Err.DuplicateIdForCreate;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Err.DuplicateIdForCreate;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Err.DuplicateIdForCreate;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Err.DuplicateIdForCreate;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Err.DuplicateIdForCreate;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Err.DuplicateIdForCreate;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Err.DuplicateIdForCreate;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Err.DuplicateIdForCreate;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Err.DuplicateIdForCreate;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Err.DuplicateIdForCreate;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Err.DuplicateIdForCreate;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Err.DuplicateIdForCreate;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Err.DuplicateIdForCreate;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Err.DuplicateIdForCreate;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Err.DuplicateIdForCreate;
     ...
     * @see #removeField
     */
    unsetField(field: string): Err.DuplicateIdForCreate;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Err.DuplicateIdForCreate;
     ...
     * @see #unsetField
     */
    removeField(field: string): Err.DuplicateIdForCreate;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Err.DuplicateIdForCreate;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Err.DuplicateIdForCreate;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Err.DuplicateIdForCreate;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Err.DuplicateIdForCreate;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Err.DuplicateIdForCreate;

    mergeJson(json: any | null): Err.DuplicateIdForCreate;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Err.DuplicateIdForCreate;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Err.DuplicateIdForCreate;
     ...
     */
    singletonArray(): C3.Array<Err.DuplicateIdForCreate | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Err.DuplicateIdForCreate | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Err.DuplicateIdForCreate | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Err.DuplicateIdForCreate | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Err.DuplicateIdForCreate | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Err.DuplicateIdForCreate | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Err.DuplicateIdForCreate | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Err.DuplicateIdForCreate | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Err.DuplicateIdForCreate | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Err.DuplicateIdForCreate;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Err.DuplicateIdForCreate;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Err.DuplicateIdForCreate;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Err.DuplicateIdForCreate;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Err.DuplicateIdForCreate;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Err.DuplicateIdForCreate;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Err.DuplicateIdForCreate;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Err.DuplicateIdForCreate;
     ...
     */
    static cachedEmptyInst(): Err.DuplicateIdForCreate;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Err.DuplicateIdForCreate>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Err.DuplicateIdForCreate;
     ...
     */
    withFormattedMessage(): Err.DuplicateIdForCreate;
     ...
     */
    static formatted(format: string, ...args: any[]): Err.DuplicateIdForCreate;

    /**
     * Construct an error with just the message.
     */
    static fromMessage(s: string | null): Err.DuplicateIdForCreate;
     ...
     */
    static fromJavaException(ex: any): Err.DuplicateIdForCreate;

    /**
     * Construct an error from the system exception.
     */
    static fromJavaException(message: string, ex: any): Err.DuplicateIdForCreate;
     ...
     */
    static fromTemplate(template: string | null, bindings: C3.Map<string | null, any> | null): Err.DuplicateIdForCreate;

    /**
     * Construct an error and a system exception around it to throw an error.
     */
    static fromHttpCodeAndTemplate(httpCode: number | null, template: string | null, bindings: C3.Map<string | null, any> | null): Err.DuplicateIdForCreate;
