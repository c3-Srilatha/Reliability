// TypeScript definitions for the C3 type FeatureEvaluatable.Bin.Strategy
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of FeatureEvaluatable.Bin.Strategy
 */
 ...
 */
declare namespace FeatureEvaluatable.Bin {
  export class Strategy extends Obj {
    ...
    withTypeIdent(typeIdent: string | null): FeatureEvaluatable.Bin.Strategy;
     ...
     */
    readonly id: string;
    withId(id: string): FeatureEvaluatable.Bin.Strategy;
    ...
    withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): FeatureEvaluatable.Bin.Strategy;

    /**
     * Name of the Obj instance
     */
    readonly name?: string | null;
    withName(name: string | null): FeatureEvaluatable.Bin.Strategy;

    /**
     * Various system fields.
     */
    readonly meta?: Meta | null;
    withMeta(meta: IMeta | null): FeatureEvaluatable.Bin.Strategy;
    ...
    withVersion(version: number | null): FeatureEvaluatable.Bin.Strategy;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type | null;
    withTypeWithBindings(typeWithBindings: IType | null): FeatureEvaluatable.Bin.Strategy;

    /**
     * Type of the {@link FeatureBase} subtype linked to the current strategy as identified by {@link #featureId}
     */
    readonly featureType: Type;
    withFeatureType(featureType: IType): FeatureEvaluatable.Bin.Strategy;

    /**
     * id of the {@link Feature} / {@link Feature.Set} associated with the current strategy.
     */
    readonly featureId: string;
    withFeatureId(featureId: string): FeatureEvaluatable.Bin.Strategy;

    /**
     * {@link Feature.Set.Snapshot#snapshotId} of the {@link Feature.Set.Snapshot snapshot} if this strategy was used when the snapshot was created. Please note that binning strategy for a snapshot cannot be changed once created. So, {@link #init} will fail when invoked on a strategy instances which belong to a snapshot.
     */
    readonly snapshotId?: string | null;
    withSnapshotId(snapshotId: string | null): FeatureEvaluatable.Bin.Strategy;
    ...
    withIsReady(isReady: boolean): FeatureEvaluatable.Bin.Strategy;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): FeatureEvaluatable.Bin.Strategy | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): FeatureEvaluatable.Bin.Strategy | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): FeatureEvaluatable.Bin.Strategy | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): FeatureEvaluatable.Bin.Strategy | null;
     ...
     */
    replaceType(old: Type, new_: Type): FeatureEvaluatable.Bin.Strategy;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FeatureEvaluatable.Bin.Strategy;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FeatureEvaluatable.Bin.Strategy;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FeatureEvaluatable.Bin.Strategy | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FeatureEvaluatable.Bin.Strategy | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): FeatureEvaluatable.Bin.Strategy;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FeatureEvaluatable.Bin.Strategy;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FeatureEvaluatable.Bin.Strategy;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): FeatureEvaluatable.Bin.Strategy;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): FeatureEvaluatable.Bin.Strategy;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): FeatureEvaluatable.Bin.Strategy;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): FeatureEvaluatable.Bin.Strategy;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FeatureEvaluatable.Bin.Strategy;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): FeatureEvaluatable.Bin.Strategy;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): FeatureEvaluatable.Bin.Strategy;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): FeatureEvaluatable.Bin.Strategy;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): FeatureEvaluatable.Bin.Strategy;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): FeatureEvaluatable.Bin.Strategy;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): FeatureEvaluatable.Bin.Strategy;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): FeatureEvaluatable.Bin.Strategy;
     ...
     * @see #unsetField
     */
    defaultField(field: string): FeatureEvaluatable.Bin.Strategy;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): FeatureEvaluatable.Bin.Strategy;
     ...
     * @see #removeField
     */
    unsetField(field: string): FeatureEvaluatable.Bin.Strategy;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): FeatureEvaluatable.Bin.Strategy;
     ...
     * @see #unsetField
     */
    removeField(field: string): FeatureEvaluatable.Bin.Strategy;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): FeatureEvaluatable.Bin.Strategy;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): FeatureEvaluatable.Bin.Strategy;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): FeatureEvaluatable.Bin.Strategy;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): FeatureEvaluatable.Bin.Strategy;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): FeatureEvaluatable.Bin.Strategy;

    mergeJson(json: any | null): FeatureEvaluatable.Bin.Strategy;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): FeatureEvaluatable.Bin.Strategy;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): FeatureEvaluatable.Bin.Strategy;
     ...
     */
    singletonArray(): C3.Array<FeatureEvaluatable.Bin.Strategy | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<FeatureEvaluatable.Bin.Strategy | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<FeatureEvaluatable.Bin.Strategy | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<FeatureEvaluatable.Bin.Strategy | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<FeatureEvaluatable.Bin.Strategy | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, FeatureEvaluatable.Bin.Strategy | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, FeatureEvaluatable.Bin.Strategy | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<FeatureEvaluatable.Bin.Strategy | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<FeatureEvaluatable.Bin.Strategy | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): FeatureEvaluatable.Bin.Strategy;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): FeatureEvaluatable.Bin.Strategy;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): FeatureEvaluatable.Bin.Strategy;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): FeatureEvaluatable.Bin.Strategy;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): FeatureEvaluatable.Bin.Strategy;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): FeatureEvaluatable.Bin.Strategy;
     ...
     * @see #fromString
     */
    static make(s: string | null): FeatureEvaluatable.Bin.Strategy | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): FeatureEvaluatable.Bin.Strategy;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): FeatureEvaluatable.Bin.Strategy;
     ...
     */
    static cachedEmptyInst(): FeatureEvaluatable.Bin.Strategy;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<FeatureEvaluatable.Bin.Strategy>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): FeatureEvaluatable.Bin.Strategy;
     ...
     */
    static fetch(spec?: FetchSpec | null): FetchResult<FeatureEvaluatable.Bin.Strategy | null>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<FeatureEvaluatable.Bin.Strategy | null>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec | null): Stream<FeatureEvaluatable.Bin.Strategy | null>;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<FeatureEvaluatable.Bin.Strategy | null> | null>;
     ...
     */
    get(include?: string | null): FeatureEvaluatable.Bin.Strategy | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string | null): FeatureEvaluatable.Bin.Strategy | null;
     ...
     */
    getMissing(spec: GetMissingSpec): FeatureEvaluatable.Bin.Strategy;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string | null): FeatureEvaluatable.Bin.Strategy | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): FeatureEvaluatable.Bin.Strategy;
     ...
     * @see #toString
     */
    static fromString(s: string | null): FeatureEvaluatable.Bin.Strategy | null;
     ...
     */
    create(spec?: UpsertSpec | null): FeatureEvaluatable.Bin.Strategy | null;
     ...
     */
    static createBatch(objs: C3.Array<FeatureEvaluatable.Bin.Strategy | null> | null, spec?: UpsertSpec | null): ObjList<FeatureEvaluatable.Bin.Strategy | null> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<FeatureEvaluatable.Bin.Strategy | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<FeatureEvaluatable.Bin.Strategy | null> | null;
     ...
     */
    update(srcObj?: FeatureEvaluatable.Bin.Strategy | null, spec?: UpsertSpec | null): FeatureEvaluatable.Bin.Strategy | null;
     ...
     */
    upsert(srcObj?: FeatureEvaluatable.Bin.Strategy | null, spec?: UpsertSpec | null): FeatureEvaluatable.Bin.Strategy | null;
     ...
     */
    merge(spec?: MergeSpec | null): FeatureEvaluatable.Bin.Strategy | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec | null): FeatureEvaluatable.Bin.Strategy | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec | null): FeatureEvaluatable.Bin.Strategy | null;
     ...
     */
    static updateBatch(objs: C3.Array<FeatureEvaluatable.Bin.Strategy | null> | null, srcObjs?: C3.Array<FeatureEvaluatable.Bin.Strategy | null>, spec?: UpsertSpec | null): ObjList<FeatureEvaluatable.Bin.Strategy | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<C3.Array<FeatureEvaluatable.Bin.Strategy | null>>, spec?: UpsertSpec | null): ObjList<FeatureEvaluatable.Bin.Strategy | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: C3.Array<FeatureEvaluatable.Bin.Strategy | null> | null, srcObjs?: C3.Array<FeatureEvaluatable.Bin.Strategy | null>, spec?: UpsertSpec | null): ObjList<FeatureEvaluatable.Bin.Strategy | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<C3.Array<FeatureEvaluatable.Bin.Strategy | null>>, spec?: UpsertSpec | null): ObjList<FeatureEvaluatable.Bin.Strategy | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: C3.Array<FeatureEvaluatable.Bin.Strategy | null> | null, spec?: TouchSpec | null): ObjList<FeatureEvaluatable.Bin.Strategy | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<FeatureEvaluatable.Bin.Strategy | null> | null, spec?: MergeSpec | null): ObjList<FeatureEvaluatable.Bin.Strategy | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<FeatureEvaluatable.Bin.Strategy | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<FeatureEvaluatable.Bin.Strategy | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<C3.Array<FeatureEvaluatable.Bin.Strategy | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<FeatureEvaluatable.Bin.Strategy | null> | null;
     ...
     */
    static mergeAll(mergeObj: FeatureEvaluatable.Bin.Strategy | null, spec?: MergeAllSpec | null): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: FeatureEvaluatable.Bin.Strategy | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: C3.Array<FeatureEvaluatable.Bin.Strategy | null> | null, spec?: UpsertSpec | null): ObjList<FeatureEvaluatable.Bin.Strategy | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: C3.Array<FeatureEvaluatable.Bin.Strategy | null> | null, spec?: UpsertSpec | null): ObjList<FeatureEvaluatable.Bin.Strategy | null> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): FeatureEvaluatable.Bin.Strategy | null;
     ...
     */
    static beforeCreate(objs: C3.Array<FeatureEvaluatable.Bin.Strategy | null> | null): ObjList<FeatureEvaluatable.Bin.Strategy | null>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: C3.Array<FeatureEvaluatable.Bin.Strategy | null> | null): ObjList<FeatureEvaluatable.Bin.Strategy | null>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: C3.Array<FeatureEvaluatable.Bin.Strategy | null> | null): ObjList<FeatureEvaluatable.Bin.Strategy | null>;
     ...
     */
    static afterCreate(objs: C3.Array<FeatureEvaluatable.Bin.Strategy | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: C3.Array<FeatureEvaluatable.Bin.Strategy | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: C3.Array<FeatureEvaluatable.Bin.Strategy | null> | null): C3.Array<ObjError | null>;
     ...
     */
    static startImportData(spec?: StartImportDataSpec | null): PushStream<FeatureEvaluatable.Bin.Strategy | null>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<FeatureEvaluatable.Bin.Strategy | null>;
     ...
     */
    static forId(id: string | null, failIfMissing?: boolean): FeatureEvaluatable.Bin.Strategy | null;
     ...
     */
    withoutIdentity(): FeatureEvaluatable.Bin.Strategy | null;
     ...
     */
    static typeOfBatch(objs: C3.Array<FeatureEvaluatable.Bin.Strategy | null> | null): C3.Array<EntityType | null>;
     ...
     */
    static dbEcho(template?: FeatureEvaluatable.Bin.Strategy | null, count?: number | null, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: C3.Array<FeatureEvaluatable.Bin.Strategy | null> | null, callback?: λFunction<FeatureEvaluatable.Bin.Strategy | null, FeatureEvaluatable.Bin.Strategy | null> | null): ObjList<FeatureEvaluatable.Bin.Strategy | null>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: C3.Array<FeatureEvaluatable.Bin.Strategy | null> | null, callback?: λFunction<FeatureEvaluatable.Bin.Strategy | null, FeatureEvaluatable.Bin.Strategy | null> | null): C3.Array<ObjError | null>;
     ...
     */
    initSame(strategy: Persistable.Bin.Strategy): boolean;
     ...
     */
    init(binMap: C3.Map<string | null, number | null>): boolean;
     ...
     */
    init(recSubjectsPerBin: number): boolean;

    /**
     * @return the state instance of the current strategy if its initialized, null otherwise.
     */
    get state(): Persistable.Bin.Strategy.Custom.State | null;

    /**
     * @return the bin for the provided **id**
     */
    bin(id: string): number | null;

    /**
     * @return a map of id to bin for the given strategy
     */
    bins(subjectIds: C3.Set<string | null>): C3.Map<string | null, number | null>;

    /**
     * @return a map of bin to the set of subjects belonging to that bin.
     */
    groupedBins(subjectIds: C3.Set<string | null>): C3.Map<number | null, C3.Set<string | null>>;

    /**
     * Remove any state associated with the concrete (to be removed) strategy instances.
     */
    static doRemoveState(objs: C3.Array<FeatureEvaluatable.Bin.Strategy | null> | null): ObjList<FeatureEvaluatable.Bin.Strategy | null>;
     ...
     */
    setIsReady(): FeatureEvaluatable.Bin.Strategy;

    /**
     * @return the feature instance for the current strategy
     */
    get feature(): FeatureBase;
     ...
     */
    static filter(feature: FeatureBase, includeNonReady?: boolean, snapshotId?: string | null): Filter;
     ...
     */
    static fetchSpec(feature: FeatureBase, includeNonReady: boolean, limit: number, snapshotId?: string | null): FetchSpec;
     ...
     */
    copy(toMergeOverride: FeatureEvaluatable.Bin.Strategy): FeatureEvaluatable.Bin.Strategy;

    /**
     * @return a filter to fetch the blocks associated with the provided strategies
     */
    static blockFilter(strategyIds: C3.Array<string | null>): Filter;
     ...
     */
    static doRemoveBlocks(objs: C3.Array<FeatureEvaluatable.Bin.Strategy | null> | null): ObjList<FeatureEvaluatable.Bin.Strategy | null>;
  }
}
