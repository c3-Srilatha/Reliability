// TypeScript definitions for the C3 type MessageClaim

/**
 * @remarks this represents a value passed to a method that expects an instance of MessageClaim
 */
declare interface IMessageClaim {
...
/**
 * @remarks this represents a made instance of MessageClaim
 */
declare class MessageClaim extends Obj {

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): MessageClaim;

  readonly tag?: string | null;
  withTag(tag: string | null): MessageClaim;

  readonly module?: string | null;
  withModule(module: string | null): MessageClaim;

  readonly typp?: string | null;
  withTypp(typp: string | null): MessageClaim;

  readonly action?: string | null;
  withAction(action: string | null): MessageClaim;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): MessageClaim;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): MessageClaim;
  ...
  withVersion(version: number | null): MessageClaim;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): MessageClaim;

  readonly tenant?: string | null;
  withTenant(tenant: string | null): MessageClaim;

  readonly msg?: string | null;
  withMsg(msg: string | null): MessageClaim;

  readonly host?: string | null;
  withHost(host: string | null): MessageClaim;

  readonly thread?: string | null;
  withThread(thread: string | null): MessageClaim;

  readonly duration?: number | null;
  withDuration(duration: number | null): MessageClaim;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): MessageClaim | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): MessageClaim | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): MessageClaim | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): MessageClaim | null;
   ...
   */
  replaceType(old: Type, new_: Type): MessageClaim;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MessageClaim;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MessageClaim;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MessageClaim | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MessageClaim | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): MessageClaim;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MessageClaim;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MessageClaim;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): MessageClaim;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): MessageClaim;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): MessageClaim;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): MessageClaim;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): MessageClaim;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): MessageClaim;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): MessageClaim;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): MessageClaim;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): MessageClaim;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): MessageClaim;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): MessageClaim;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): MessageClaim;
   ...
   * @see #unsetField
   */
  defaultField(field: string): MessageClaim;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): MessageClaim;
   ...
   * @see #removeField
   */
  unsetField(field: string): MessageClaim;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): MessageClaim;
   ...
   * @see #unsetField
   */
  removeField(field: string): MessageClaim;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): MessageClaim;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): MessageClaim;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): MessageClaim;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): MessageClaim;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): MessageClaim;

  mergeJson(json: any | null): MessageClaim;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): MessageClaim;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): MessageClaim;
   ...
   */
  singletonArray(): C3.Array<MessageClaim | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<MessageClaim | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<MessageClaim | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<MessageClaim | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<MessageClaim | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, MessageClaim | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, MessageClaim | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<MessageClaim | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<MessageClaim | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): MessageClaim;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): MessageClaim;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): MessageClaim;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): MessageClaim;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): MessageClaim;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): MessageClaim;
   ...
   * @see #fromString
   */
  static make(s: string | null): MessageClaim | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): MessageClaim;
   ...
   */
  static cachedEmptyInst(): MessageClaim;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<MessageClaim>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): MessageClaim;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<MessageClaim | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<MessageClaim | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<MessageClaim | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<MessageClaim | null> | null>;
   ...
   */
  get(include?: string | null): MessageClaim | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): MessageClaim | null;
   ...
   */
  getMissing(spec: GetMissingSpec): MessageClaim;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): MessageClaim | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): MessageClaim;
   ...
   * @see #toString
   */
  static fromString(s: string | null): MessageClaim | null;
   ...
   */
  create(spec?: UpsertSpec | null): MessageClaim | null;
   ...
   */
  static createBatch(objs: C3.Array<MessageClaim | null> | null, spec?: UpsertSpec | null): ObjList<MessageClaim | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<MessageClaim | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<MessageClaim | null> | null;
   ...
   */
  update(srcObj?: MessageClaim | null, spec?: UpsertSpec | null): MessageClaim | null;
   ...
   */
  upsert(srcObj?: MessageClaim | null, spec?: UpsertSpec | null): MessageClaim | null;
   ...
   */
  merge(spec?: MergeSpec | null): MessageClaim | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): MessageClaim | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): MessageClaim | null;
   ...
   */
  static updateBatch(objs: C3.Array<MessageClaim | null> | null, srcObjs?: C3.Array<MessageClaim | null>, spec?: UpsertSpec | null): ObjList<MessageClaim | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<MessageClaim | null>>, spec?: UpsertSpec | null): ObjList<MessageClaim | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<MessageClaim | null> | null, srcObjs?: C3.Array<MessageClaim | null>, spec?: UpsertSpec | null): ObjList<MessageClaim | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<MessageClaim | null>>, spec?: UpsertSpec | null): ObjList<MessageClaim | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<MessageClaim | null> | null, spec?: TouchSpec | null): ObjList<MessageClaim | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<MessageClaim | null> | null, spec?: MergeSpec | null): ObjList<MessageClaim | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<MessageClaim | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<MessageClaim | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<MessageClaim | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<MessageClaim | null> | null;
   ...
   */
  static mergeAll(mergeObj: MessageClaim | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: MessageClaim | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<MessageClaim | null> | null, spec?: UpsertSpec | null): ObjList<MessageClaim | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<MessageClaim | null> | null, spec?: UpsertSpec | null): ObjList<MessageClaim | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<MessageClaim | null> | null): ObjList<MessageClaim | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<MessageClaim | null> | null): ObjList<MessageClaim | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<MessageClaim | null> | null): ObjList<MessageClaim | null>;
   ...
   */
  static afterCreate(objs: C3.Array<MessageClaim | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<MessageClaim | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<MessageClaim | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<MessageClaim | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<MessageClaim | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): MessageClaim | null;
   ...
   */
  withoutIdentity(): MessageClaim | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<MessageClaim | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: MessageClaim | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<MessageClaim | null> | null, callback?: λFunction<MessageClaim | null, MessageClaim | null> | null): ObjList<MessageClaim | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<MessageClaim | null> | null, callback?: λFunction<MessageClaim | null, MessageClaim | null> | null): C3.Array<ObjError | null>;
