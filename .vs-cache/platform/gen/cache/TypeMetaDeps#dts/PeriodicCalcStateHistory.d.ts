// TypeScript definitions for the C3 type PeriodicCalcStateHistory

/**
 * History entries for the {@link PeriodicCalcState} type.  Each entry will contain info about a refresh operation
 * performed for a single periodic or scheduled calc field.
 *
 * @remarks this represents a value passed to a method that expects an instance of PeriodicCalcStateHistory
 */
declare interface IPeriodicCalcStateHistory {
  ...
  /**
   * Periodic or scheduled calc field entry in {@link PeriodicCalcState} that this refresh was performed for.
   */
  parent: IPeriodicCalcState;

  /**
   * When the refresh operation was performed
   */
  refreshedAt: DateTime | Date | string;

  refreshJob: IRefreshCalcFieldsBatchJob;
  ...
  /**
   * If an error occurs launching the `refreshCalcFields` operation, this field will be set with the appropriate error
   * message.  If that occurs, the operation will be tried at the next scheduled time based on the period or schedule
 ...
 * performed for a single periodic or scheduled calc field.
 *
 * @remarks this represents a made instance of PeriodicCalcStateHistory
 */
declare class PeriodicCalcStateHistory extends Obj {
   ...
   */
  readonly id: string;
  withId(id: string): PeriodicCalcStateHistory;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): PeriodicCalcStateHistory;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): PeriodicCalcStateHistory;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): PeriodicCalcStateHistory;
  ...
  withVersion(version: number | null): PeriodicCalcStateHistory;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): PeriodicCalcStateHistory;

  /**
   * Periodic or scheduled calc field entry in {@link PeriodicCalcState} that this refresh was performed for.
   */
  readonly parent: PeriodicCalcState;
  withParent(parent: IPeriodicCalcState): PeriodicCalcStateHistory;

  /**
   * When the refresh operation was performed
   */
  readonly refreshedAt: DateTime;
  withRefreshedAt(refreshedAt: DateTime | Date | string): PeriodicCalcStateHistory;

  readonly refreshJob: RefreshCalcFieldsBatchJob;
  withRefreshJob(refreshJob: IRefreshCalcFieldsBatchJob): PeriodicCalcStateHistory;

  /**
   * If the entry fails validation for any reason, the associated error message.  If this field is not null, processing
   * will be skipped for this entry until it is corrected.
   */
  readonly validationErrorMsg?: string | null;
  withValidationErrorMsg(validationErrorMsg: string | null): PeriodicCalcStateHistory;
  ...
  withRefreshError(refreshError: string | null): PeriodicCalcStateHistory;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): PeriodicCalcStateHistory | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): PeriodicCalcStateHistory | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): PeriodicCalcStateHistory | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): PeriodicCalcStateHistory | null;
   ...
   */
  replaceType(old: Type, new_: Type): PeriodicCalcStateHistory;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PeriodicCalcStateHistory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PeriodicCalcStateHistory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PeriodicCalcStateHistory | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PeriodicCalcStateHistory | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): PeriodicCalcStateHistory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PeriodicCalcStateHistory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PeriodicCalcStateHistory;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PeriodicCalcStateHistory;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PeriodicCalcStateHistory;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PeriodicCalcStateHistory;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): PeriodicCalcStateHistory;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PeriodicCalcStateHistory;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PeriodicCalcStateHistory;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): PeriodicCalcStateHistory;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): PeriodicCalcStateHistory;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): PeriodicCalcStateHistory;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): PeriodicCalcStateHistory;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PeriodicCalcStateHistory;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): PeriodicCalcStateHistory;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PeriodicCalcStateHistory;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PeriodicCalcStateHistory;
   ...
   * @see #removeField
   */
  unsetField(field: string): PeriodicCalcStateHistory;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PeriodicCalcStateHistory;
   ...
   * @see #unsetField
   */
  removeField(field: string): PeriodicCalcStateHistory;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PeriodicCalcStateHistory;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): PeriodicCalcStateHistory;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): PeriodicCalcStateHistory;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): PeriodicCalcStateHistory;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): PeriodicCalcStateHistory;

  mergeJson(json: any | null): PeriodicCalcStateHistory;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): PeriodicCalcStateHistory;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): PeriodicCalcStateHistory;
   ...
   */
  singletonArray(): C3.Array<PeriodicCalcStateHistory | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<PeriodicCalcStateHistory | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PeriodicCalcStateHistory | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<PeriodicCalcStateHistory | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PeriodicCalcStateHistory | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, PeriodicCalcStateHistory | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PeriodicCalcStateHistory | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PeriodicCalcStateHistory | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PeriodicCalcStateHistory | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): PeriodicCalcStateHistory;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): PeriodicCalcStateHistory;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): PeriodicCalcStateHistory;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PeriodicCalcStateHistory;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): PeriodicCalcStateHistory;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PeriodicCalcStateHistory;
   ...
   * @see #fromString
   */
  static make(s: string | null): PeriodicCalcStateHistory | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): PeriodicCalcStateHistory;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): PeriodicCalcStateHistory;
   ...
   */
  static cachedEmptyInst(): PeriodicCalcStateHistory;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<PeriodicCalcStateHistory>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): PeriodicCalcStateHistory;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<PeriodicCalcStateHistory | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PeriodicCalcStateHistory | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<PeriodicCalcStateHistory | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<PeriodicCalcStateHistory | null> | null>;
   ...
   */
  get(include?: string | null): PeriodicCalcStateHistory | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): PeriodicCalcStateHistory | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PeriodicCalcStateHistory;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): PeriodicCalcStateHistory | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PeriodicCalcStateHistory;
   ...
   * @see #toString
   */
  static fromString(s: string | null): PeriodicCalcStateHistory | null;
   ...
   */
  create(spec?: UpsertSpec | null): PeriodicCalcStateHistory | null;
   ...
   */
  static createBatch(objs: C3.Array<PeriodicCalcStateHistory | null> | null, spec?: UpsertSpec | null): ObjList<PeriodicCalcStateHistory | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PeriodicCalcStateHistory | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<PeriodicCalcStateHistory | null> | null;
   ...
   */
  update(srcObj?: PeriodicCalcStateHistory | null, spec?: UpsertSpec | null): PeriodicCalcStateHistory | null;
   ...
   */
  upsert(srcObj?: PeriodicCalcStateHistory | null, spec?: UpsertSpec | null): PeriodicCalcStateHistory | null;
   ...
   */
  merge(spec?: MergeSpec | null): PeriodicCalcStateHistory | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): PeriodicCalcStateHistory | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): PeriodicCalcStateHistory | null;
   ...
   */
  static updateBatch(objs: C3.Array<PeriodicCalcStateHistory | null> | null, srcObjs?: C3.Array<PeriodicCalcStateHistory | null>, spec?: UpsertSpec | null): ObjList<PeriodicCalcStateHistory | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<PeriodicCalcStateHistory | null>>, spec?: UpsertSpec | null): ObjList<PeriodicCalcStateHistory | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<PeriodicCalcStateHistory | null> | null, srcObjs?: C3.Array<PeriodicCalcStateHistory | null>, spec?: UpsertSpec | null): ObjList<PeriodicCalcStateHistory | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<PeriodicCalcStateHistory | null>>, spec?: UpsertSpec | null): ObjList<PeriodicCalcStateHistory | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<PeriodicCalcStateHistory | null> | null, spec?: TouchSpec | null): ObjList<PeriodicCalcStateHistory | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PeriodicCalcStateHistory | null> | null, spec?: MergeSpec | null): ObjList<PeriodicCalcStateHistory | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PeriodicCalcStateHistory | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<PeriodicCalcStateHistory | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<PeriodicCalcStateHistory | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<PeriodicCalcStateHistory | null> | null;
   ...
   */
  static mergeAll(mergeObj: PeriodicCalcStateHistory | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PeriodicCalcStateHistory | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<PeriodicCalcStateHistory | null> | null, spec?: UpsertSpec | null): ObjList<PeriodicCalcStateHistory | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<PeriodicCalcStateHistory | null> | null, spec?: UpsertSpec | null): ObjList<PeriodicCalcStateHistory | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): PeriodicCalcStateHistory | null;
   ...
   */
  static beforeCreate(objs: C3.Array<PeriodicCalcStateHistory | null> | null): ObjList<PeriodicCalcStateHistory | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<PeriodicCalcStateHistory | null> | null): ObjList<PeriodicCalcStateHistory | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<PeriodicCalcStateHistory | null> | null): ObjList<PeriodicCalcStateHistory | null>;
   ...
   */
  static afterCreate(objs: C3.Array<PeriodicCalcStateHistory | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<PeriodicCalcStateHistory | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<PeriodicCalcStateHistory | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<PeriodicCalcStateHistory | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<PeriodicCalcStateHistory | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): PeriodicCalcStateHistory | null;
   ...
   */
  withoutIdentity(): PeriodicCalcStateHistory | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<PeriodicCalcStateHistory | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: PeriodicCalcStateHistory | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<PeriodicCalcStateHistory | null> | null, callback?: λFunction<PeriodicCalcStateHistory | null, PeriodicCalcStateHistory | null> | null): ObjList<PeriodicCalcStateHistory | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<PeriodicCalcStateHistory | null> | null, callback?: λFunction<PeriodicCalcStateHistory | null, PeriodicCalcStateHistory | null> | null): C3.Array<ObjError | null>;
