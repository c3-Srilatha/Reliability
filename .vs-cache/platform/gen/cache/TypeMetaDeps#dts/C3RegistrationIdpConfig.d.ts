// TypeScript definitions for the C3 type C3RegistrationIdpConfig

/**
 * @remarks this represents a value passed to a method that expects an instance of C3RegistrationIdpConfig
 */
declare interface IC3RegistrationIdpConfig {
...
/**
 * @remarks this represents a made instance of C3RegistrationIdpConfig
 */
declare class C3RegistrationIdpConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): C3RegistrationIdpConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): C3RegistrationIdpConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): C3RegistrationIdpConfig;

  /**
   * The unique and required id of this instance.
   */
  readonly id: string;
  withId(id: string): C3RegistrationIdpConfig;

  /**
   * If present, the user will be redirected to this url instead of the idp login page.
   */
  readonly defaultContentUrl?: string | null;
  withDefaultContentUrl(defaultContentUrl: string | null): C3RegistrationIdpConfig;

  /**
   * Which field of the IdpUser to use as the user id
   */
  readonly userIdFormat?: string | null;
  withUserIdFormat(userIdFormat: string | null): C3RegistrationIdpConfig;
  ...
  withDefaultGroupId(defaultGroupId: string | null): C3RegistrationIdpConfig;

  /**
   * Returns whether we should write back to the Idp
   */
  readonly idpWriteback?: boolean;
  withIdpWriteback(idpWriteback: boolean): C3RegistrationIdpConfig;

  /**
   * Returns whether we should write back {@link UserGroup} updates to the Idp
   */
  readonly idpGroupWriteback?: boolean;
  withIdpGroupWriteback(idpGroupWriteback: boolean): C3RegistrationIdpConfig;

  /**
   * Returns the identity provider for write-back (if enabled)
   */
  readonly idpType?: string | null;
  withIdpType(idpType: string | null): C3RegistrationIdpConfig;
  ...
  withExternalAppId(externalAppId: string | null): C3RegistrationIdpConfig;
  ...
  withAllowedEmailDomains(allowedEmailDomains: C3.Array<string | null> | Array<string | null>): C3RegistrationIdpConfig;

  /**
   * Applications that are trusted to redirect authenticated user(s)
   */
  readonly trustedApplicationHosts?: C3.Array<string | null>;
  withTrustedApplicationHosts(trustedApplicationHosts: C3.Array<string | null> | Array<string | null>): C3RegistrationIdpConfig;

  /**
   * List of relevant groups for the cluster from the IDP. If empty, then no group filtering is done on user login.
   */
  readonly relevantGroups?: C3.Array<string | null>;
  withRelevantGroups(relevantGroups: C3.Array<string | null> | Array<string | null>): C3RegistrationIdpConfig;

  readonly enabled: boolean;
  withEnabled(enabled: boolean): C3RegistrationIdpConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): C3RegistrationIdpConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): C3RegistrationIdpConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): C3RegistrationIdpConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): C3RegistrationIdpConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): C3RegistrationIdpConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): C3RegistrationIdpConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): C3RegistrationIdpConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<C3RegistrationIdpConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<C3RegistrationIdpConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): C3RegistrationIdpConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): C3RegistrationIdpConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): C3RegistrationIdpConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): C3RegistrationIdpConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): C3RegistrationIdpConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): C3RegistrationIdpConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): C3RegistrationIdpConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): C3RegistrationIdpConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): C3RegistrationIdpConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): C3RegistrationIdpConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): C3RegistrationIdpConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): C3RegistrationIdpConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): C3RegistrationIdpConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): C3RegistrationIdpConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): C3RegistrationIdpConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): C3RegistrationIdpConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): C3RegistrationIdpConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): C3RegistrationIdpConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): C3RegistrationIdpConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): C3RegistrationIdpConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): C3RegistrationIdpConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): C3RegistrationIdpConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): C3RegistrationIdpConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): C3RegistrationIdpConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): C3RegistrationIdpConfig;

  mergeJson(json: any | null): C3RegistrationIdpConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): C3RegistrationIdpConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): C3RegistrationIdpConfig;
   ...
   */
  singletonArray(): C3.Array<C3RegistrationIdpConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<C3RegistrationIdpConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<C3RegistrationIdpConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<C3RegistrationIdpConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<C3RegistrationIdpConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, C3RegistrationIdpConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, C3RegistrationIdpConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<C3RegistrationIdpConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<C3RegistrationIdpConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): C3RegistrationIdpConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): C3RegistrationIdpConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): C3RegistrationIdpConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): C3RegistrationIdpConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): C3RegistrationIdpConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): C3RegistrationIdpConfig;
   ...
   * @see #fromString
   */
  static make(s: string | null): C3RegistrationIdpConfig | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): C3RegistrationIdpConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): C3RegistrationIdpConfig;
   ...
   */
  static cachedEmptyInst(): C3RegistrationIdpConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<C3RegistrationIdpConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): C3RegistrationIdpConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<C3RegistrationIdpConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<C3RegistrationIdpConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<C3RegistrationIdpConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): C3RegistrationIdpConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): C3RegistrationIdpConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): C3RegistrationIdpConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): C3RegistrationIdpConfig | null;
   ...
   */
  static produce(key: string): C3RegistrationIdpConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, C3RegistrationIdpConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, C3RegistrationIdpConfig | null>;
   ...
   */
  getConfig(): C3RegistrationIdpConfig;
   ...
   */
  getSecret(): C3RegistrationIdpConfig;
   ...
   */
  static forConfigKey(configKey: string | null): C3RegistrationIdpConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<C3RegistrationIdpConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: C3RegistrationIdpConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: C3RegistrationIdpConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): C3RegistrationIdpConfig | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): C3RegistrationIdpConfig | null;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): C3RegistrationIdpConfig | null;
