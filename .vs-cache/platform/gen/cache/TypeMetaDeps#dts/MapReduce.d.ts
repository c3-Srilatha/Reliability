// TypeScript definitions for the C3 type MapReduce

/**
 * See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
 *
 * @remarks this represents a value passed to a method that expects an instance of MapReduce
 */
declare interface IMapReduce<TargetType, OutKeyType, InterValType, OutValType> {
 ...
 */
declare class MapReduce<TargetType, OutKeyType, InterValType, OutValType> extends Obj {

  /**
   * current or last job execution for this instance
   */
  readonly run?: MapReduceRun | null;
  withRun(run: IMapReduceRun | null): MapReduce;

  /**
   * previous job executions for this instance
   */
  readonly runs?: C3.Array<MapReduceRun | null>;
  withRuns(runs: C3.Array<MapReduceRun | null> | Array<IMapReduceRun | null>): MapReduce;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj | null;
  withOptions(options: IObj | null): MapReduce;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): MapReduce;
  ...
  withPriority(priority: number | null): MapReduce;
  ...
  withDisabled(disabled: boolean): MapReduce;
  ...
  withMaxConcurrency(maxConcurrency: number | null): MapReduce;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): MapReduce;
  ...
  withRunAsUser(runAsUser: boolean | null): MapReduce;

  /**
   * Don't set this field in the MapReduce job, set it in the MapReduceOptions when calling `start`.
   */
  readonly nodePool?: string | null;
  withNodePool(nodePool: string | null): MapReduce;
  ...
  withSkipIfRunning(skipIfRunning: boolean | null): MapReduce;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number | null;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): MapReduce;
  ...
  withPropagateActionContext(propagateActionContext: boolean): MapReduce;
  ...
  withTargetType(targetType: IType | null): MapReduce;
  ...
  withUseFileSystemForInterVals(useFileSystemForInterVals: boolean): MapReduce;
  ...
  withUseBatchIdsForReadInput(useBatchIdsForReadInput: boolean): MapReduce;
  ...
  withInclude(include: string | null): MapReduce;

  /**
   * optional filter spec
   */
  readonly filter?: string | null;
  withFilter(filter: string | null): MapReduce;
  ...
  withOrder(order: string | null): MapReduce;
  ...
  withLimit(limit: number | null): MapReduce;
  ...
  withSamplePct(samplePct: number | null): MapReduce;
  ...
  withBatchSize(batchSize: number | null): MapReduce;
  ...
  withSubBatchSize(subBatchSize: number | null): MapReduce;
  ...
  withNumBatches(numBatches: number | null): MapReduce;
  ...
  withAbortOnError(abortOnError: boolean): MapReduce;
  ...
  withTypeIdent(typeIdent: string | null): MapReduce;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): MapReduce;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): MapReduce;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): MapReduce;
  ...
  withVersion(version: number | null): MapReduce;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): MapReduce;

  /**
   * Optional target type instance to be used as the filter for the job.  When specified, the {~link map} function will
   * only be called for that obj.
   */
  readonly targetFilter?: TargetType | null;
  withTargetFilter(targetFilter: TargetType | null): MapReduce;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null;
   ...
   */
  replaceType(old: Type, new_: Type): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   * @see #removeField
   */
  unsetField(field: string): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   * @see #unsetField
   */
  removeField(field: string): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;

  mergeJson(json: any | null): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   */
  singletonArray(): C3.Array<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   * @see #fromString
   */
  static make(s: string | null): MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   */
  static cachedEmptyInst(): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<MapReduce<TargetType, OutKeyType, InterValType, OutValType>>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null>;
   ...
   */
  get(include?: string | null): MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null;
   ...
   */
  getMissing(spec: GetMissingSpec): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): MapReduce<TargetType, OutKeyType, InterValType, OutValType>;
   ...
   * @see #toString
   */
  static fromString(s: string | null): MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null;
   ...
   */
  create(spec?: UpsertSpec | null): MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null;
   ...
   */
  static createBatch(objs: C3.Array<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null, spec?: UpsertSpec | null): ObjList<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null;
   ...
   */
  update(srcObj?: MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null, spec?: UpsertSpec | null): MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null;
   ...
   */
  upsert(srcObj?: MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null, spec?: UpsertSpec | null): MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null;
   ...
   */
  merge(spec?: MergeSpec | null): MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null;
   ...
   */
  static updateBatch(objs: C3.Array<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null, srcObjs?: C3.Array<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null>, spec?: UpsertSpec | null): ObjList<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null>>, spec?: UpsertSpec | null): ObjList<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null, srcObjs?: C3.Array<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null>, spec?: UpsertSpec | null): ObjList<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null>>, spec?: UpsertSpec | null): ObjList<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null, spec?: TouchSpec | null): ObjList<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null, spec?: MergeSpec | null): ObjList<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null;
   ...
   */
  static mergeAll(mergeObj: MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null, spec?: UpsertSpec | null): ObjList<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null, spec?: UpsertSpec | null): ObjList<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null): ObjList<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null): ObjList<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null): ObjList<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null>;
   ...
   */
  static afterCreate(objs: C3.Array<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null;
   ...
   */
  withoutIdentity(): MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null, callback?: λFunction<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null, MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null): ObjList<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null, callback?: λFunction<MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null, MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null> | null): C3.Array<ObjError | null>;
   ...
   *         key type.
   */
  static map(batch?: number | null, objs?: C3.Array<TargetType | null>, job?: MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null, subBatch?: number | null): C3.Map<OutKeyType | null, InterValType | null>;
   ...
   */
  static reduce(outKey?: OutKeyType | null, interValues?: C3.Array<InterValType | null>, job?: MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null): OutValType | null | C3.Array<OutValType | null> | null;
   ...
   */
  static mapCompleted(job?: MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null): void;
   ...
   */
  static completed(job?: MapReduce<TargetType, OutKeyType, InterValType, OutValType> | null): string | null;
   ...
   */
  static failed(job: MapReduce<TargetType, OutKeyType, InterValType, OutValType>, status: MapReduceStatus, options?: MapReduceOptions | null): void;
   ...
   */
  results(limit?: number | null): C3.Map<OutKeyType | null, OutValType | null | C3.Array<OutValType | null> | null>;
