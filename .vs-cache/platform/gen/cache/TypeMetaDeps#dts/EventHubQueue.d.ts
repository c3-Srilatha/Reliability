// TypeScript definitions for the C3 type EventHubQueue

/**
 * @remarks this represents a value passed to a method that expects an instance of EventHubQueue
 */
declare interface IEventHubQueue {
}

/**
 * @remarks this represents a made instance of EventHubQueue
 */
declare class EventHubQueue {
   ...
   */
  static compute(targetType: Type, entries: C3.Array<CloudQueueEntry | null> | null): void;
   ...
   */
  static find(spec?: InvalidationQueue.FindSpec | null): C3.Array<CloudQueueEntry | null>;
   ...
   * @return the list of requested entries.
   */
  static findStream(spec?: InvalidationQueue.FindStreamSpec | null): Stream<CloudQueueEntry | null>;
   ...
   *           Entries to remove.
   */
  static clearEntries(entries: C3.Array<CloudQueueEntry | null> | null): void;
   ...
   */
  static typeForCloudMessageBroker(typeRef: Type): Type | null;
   ...
   */
  static upsertEntries(brokerName: string, cloudConsumer?: string | null): void;
   ...
   */
  static removeEntries(brokerName: string): number | null;
   ...
   */
  static entriesExist(brokerName: string): boolean;
}
