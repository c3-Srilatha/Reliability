// TypeScript definitions for the C3 type Tenant

/**
 * @remarks this represents a value passed to a method that expects an instance of Tenant
 */
...
/**
 * @remarks this represents a made instance of Tenant
 */
declare class Tenant extends Obj {
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Tenant;

  /**
   * Name must match the id (enforced in beforeCreate) and can't be changed.
   */
  readonly name?: string | null;
  withName(name: string | null): Tenant;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): Tenant;
  ...
  withVersion(version: number | null): Tenant;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): Tenant;

  readonly description?: string | null;
  withDescription(description: string | null): Tenant;

  readonly alias?: string | null;
  withAlias(alias: string | null): Tenant;

  readonly defaultTag?: string | null;
  withDefaultTag(defaultTag: string | null): Tenant;
  ...
  withOwner(owner: string | null): Tenant;
   ...
   */
  static cost(spec?: TimeInfo | null): Timeseries<any> | null;
   ...
   *           TSEvalOptions containing interval,start & end
   */
  static amortizedCost(spec?: TimeInfo | null): Timeseries<any> | null;
   ...
   *           TSEvalOptions containing interval,start & end
   */
  static gbs(spec?: TimeInfo | null): Timeseries<any> | null;
   ...
   *           TSEvalOptions containing interval,start & end
   */
  static hours(spec?: TimeInfo | null): Timeseries<any> | null;
   ...
   *           TSEvalOptions containing interval,start & end
   */
  static buildEnvBillEvalSpec(spec?: TimeInfo | null): EnvBillEvalOptions | null;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Tenant | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Tenant | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Tenant | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Tenant | null;
   ...
   */
  replaceType(old: Type, new_: Type): Tenant;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Tenant;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Tenant;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Tenant | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Tenant | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Tenant;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Tenant;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Tenant;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Tenant;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Tenant;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Tenant;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Tenant;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Tenant;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Tenant;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Tenant;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Tenant;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Tenant;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Tenant;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Tenant;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Tenant;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Tenant;
   ...
   * @see #removeField
   */
  unsetField(field: string): Tenant;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Tenant;
   ...
   * @see #unsetField
   */
  removeField(field: string): Tenant;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Tenant;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Tenant;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Tenant;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Tenant;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Tenant;

  mergeJson(json: any | null): Tenant;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Tenant;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Tenant;
   ...
   */
  singletonArray(): C3.Array<Tenant | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Tenant | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Tenant | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Tenant | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Tenant | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Tenant | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Tenant | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Tenant | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Tenant | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Tenant;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Tenant;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Tenant;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Tenant;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Tenant;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Tenant;
   ...
   * @see #fromString
   */
  static make(s: string | null): Tenant | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Tenant;
   ...
   */
  static cachedEmptyInst(): Tenant;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Tenant>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Tenant;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<Tenant | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<Tenant | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Tenant | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Tenant | null> | null>;
   ...
   */
  get(include?: string | null): Tenant | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): Tenant | null;
   ...
   */
  getMissing(spec: GetMissingSpec): Tenant;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): Tenant | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): Tenant;
   ...
   * @see #toString
   */
  static fromString(s: string | null): Tenant | null;
   ...
   */
  create(spec?: UpsertSpec | null): Tenant | null;
   ...
   */
  static createBatch(objs: C3.Array<Tenant | null> | null, spec?: UpsertSpec | null): ObjList<Tenant | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<Tenant | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Tenant | null> | null;
   ...
   */
  update(srcObj?: Tenant | null, spec?: UpsertSpec | null): Tenant | null;
   ...
   */
  upsert(srcObj?: Tenant | null, spec?: UpsertSpec | null): Tenant | null;
   ...
   */
  merge(spec?: MergeSpec | null): Tenant | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): Tenant | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): Tenant | null;
   ...
   */
  static updateBatch(objs: C3.Array<Tenant | null> | null, srcObjs?: C3.Array<Tenant | null>, spec?: UpsertSpec | null): ObjList<Tenant | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<Tenant | null>>, spec?: UpsertSpec | null): ObjList<Tenant | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<Tenant | null> | null, srcObjs?: C3.Array<Tenant | null>, spec?: UpsertSpec | null): ObjList<Tenant | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<Tenant | null>>, spec?: UpsertSpec | null): ObjList<Tenant | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<Tenant | null> | null, spec?: TouchSpec | null): ObjList<Tenant | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Tenant | null> | null, spec?: MergeSpec | null): ObjList<Tenant | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Tenant | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Tenant | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<Tenant | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Tenant | null> | null;
   ...
   */
  static mergeAll(mergeObj: Tenant | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: Tenant | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<Tenant | null> | null, spec?: UpsertSpec | null): ObjList<Tenant | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<Tenant | null> | null, spec?: UpsertSpec | null): ObjList<Tenant | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<Tenant | null> | null): ObjList<Tenant | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<Tenant | null> | null): ObjList<Tenant | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<Tenant | null> | null): ObjList<Tenant | null>;
   ...
   */
  static afterCreate(objs: C3.Array<Tenant | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<Tenant | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<Tenant | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<Tenant | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Tenant | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): Tenant | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<Tenant | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: Tenant | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<Tenant | null> | null, callback?: λFunction<Tenant | null, Tenant | null> | null): ObjList<Tenant | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<Tenant | null> | null, callback?: λFunction<Tenant | null, Tenant | null> | null): C3.Array<ObjError | null>;
   ...
   * name of "prod".
   */
  static upsertWithActiveMetadata(name: string, tag?: string | null): Tag;
   ...
   */
  static verifySharedAuthz(tenantId?: string | null): boolean;

  /**
   * Rename tenant
   */
  static rename(oldId?: string | null, newId?: string | null): void;
   ...
   */
  static tenantExists(tenant: string): boolean;
   ...
   */
  static tenantsTags(tenants: C3.Array<string | null> | null, tagSpec?: FetchSpec | null): C3.Map<string | null, C3.Array<Tag | null>>;
   ...
   *           name of the tenant
   */
  static destoryPerTenantDs(tenantName: string): void;

  /**
   * List of tenants in the server. For a RemoteTag server only c3 and remote tenant is returned
   */
  static tenants(spec?: FetchSpec | null): C3.Array<Tenant | null>;
