// TypeScript definitions for the C3 type EvalMetricsSpec

/**
 * Type for batch evaluation. Used in cases when we have more than 1 metric or more than 1 source
 *
 * @remarks this represents a value passed to a method that expects an instance of EvalMetricsSpec
 */
declare interface IEvalMetricsSpec {
 ...
 */
declare class EvalMetricsSpec extends Obj {
  ...
  withStart(start: DateTime | Date | string): EvalMetricsSpec;
  ...
  withEnd(end: DateTime | Date | string): EvalMetricsSpec;

  /**
   * Interval of timeseries.
   */
  readonly interval: string;
  withInterval(interval: string): EvalMetricsSpec;
  ...
  withTimeZone(timeZone: ITimeZone | null): EvalMetricsSpec;

  /**
   * length of this time-info in intervals. I.e. size of the timeseries this info represents.
   */
  readonly _size?: number | null;
  with_size(_size: number | null): EvalMetricsSpec;

  /**
   * true if time range is aligned with interval.
   */
  readonly _isAligned?: boolean;
  with_isAligned(_isAligned: boolean): EvalMetricsSpec;

  /**
   * Desired unit of evaluation. If specified, results will be converted to this unit.
   */
  readonly unitId?: string | null;
  withUnitId(unitId: string | null): EvalMetricsSpec;

  /**
   * Include spec.
   */
  readonly include?: string | null;
  withInclude(include: string | null): EvalMetricsSpec;
  ...
  withOptions(options: IEvalMetricsOptions | null): EvalMetricsSpec;

  /**
   * If specified uses the following as the key field instead of id
   */
  readonly srcKey?: λFunction<Obj | null, string | null> | null;
  withSrcKey(srcKey: λFunction<Obj | null, string | null> | null): EvalMetricsSpec;
  ...
  withCache(cache: boolean): EvalMetricsSpec;
  ...
  withSources(sources: ICollection<Obj | null> | null): EvalMetricsSpec;
  ...
  withIds(ids: C3.Set<string | null> | Array<string | null>): EvalMetricsSpec;
  ...
  withFilter(filter: string | null): EvalMetricsSpec;
  ...
  withLimit(limit: number | null): EvalMetricsSpec;
  ...
  withExpressions(expressions: C3.Set<string | null> | Array<string | null>): EvalMetricsSpec;
  ...
  withContinueOnError(continueOnError: boolean): EvalMetricsSpec;
  ...
  withExplain(explain: boolean): EvalMetricsSpec;
  ...
  withLocale(locale: string | null): EvalMetricsSpec;
  ...
  withBindings(bindings: C3.Map<string | null, any> | {[key: string | null]: any} | C3.Array<C3.Map<string | null, any>> | Array<C3.Map<string | null, any> | {[key: string | null]: any}> | null): EvalMetricsSpec;
  ...
  withBindingsCartesianProduct(bindingsCartesianProduct: boolean): EvalMetricsSpec;
  ...
  withResultKey(resultKey: λBiFunction<string | null, C3.Map<string | null, any>, string> | null): EvalMetricsSpec;
  ...
  withSavedSpecId(savedSpecId: string | null): EvalMetricsSpec;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): EvalMetricsSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): EvalMetricsSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): EvalMetricsSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): EvalMetricsSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): EvalMetricsSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): EvalMetricsSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): EvalMetricsSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<EvalMetricsSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<EvalMetricsSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): EvalMetricsSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): EvalMetricsSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): EvalMetricsSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): EvalMetricsSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): EvalMetricsSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): EvalMetricsSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): EvalMetricsSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): EvalMetricsSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): EvalMetricsSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): EvalMetricsSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): EvalMetricsSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): EvalMetricsSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): EvalMetricsSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): EvalMetricsSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): EvalMetricsSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): EvalMetricsSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): EvalMetricsSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): EvalMetricsSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): EvalMetricsSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): EvalMetricsSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): EvalMetricsSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): EvalMetricsSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): EvalMetricsSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): EvalMetricsSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): EvalMetricsSpec;

  mergeJson(json: any | null): EvalMetricsSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): EvalMetricsSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): EvalMetricsSpec;
   ...
   */
  singletonArray(): C3.Array<EvalMetricsSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<EvalMetricsSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<EvalMetricsSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<EvalMetricsSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<EvalMetricsSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, EvalMetricsSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, EvalMetricsSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<EvalMetricsSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<EvalMetricsSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): EvalMetricsSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): EvalMetricsSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): EvalMetricsSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): EvalMetricsSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): EvalMetricsSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): EvalMetricsSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): EvalMetricsSpec;
   ...
   */
  static cachedEmptyInst(): EvalMetricsSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<EvalMetricsSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): EvalMetricsSpec;
   ...
   */
  static last12Months(): EvalMetricsSpec | null;
   ...
   */
  static prevLast12Months(): EvalMetricsSpec | null;
   ...
   */
  static combineAndSort(timeRanges: C3.Array<TimeRange | null> | null): C3.Array<EvalMetricsSpec | null>;

  /**
   * Merge various time ranges into a larger range
   * E.g. ["2014-01-01" -> "2014-02-01"], ["2015-01-01" -> "2016-01-01"] => {"2014-01-01" -> "2016-01-01"}
   */
  static coalesce(timeRanges: C3.Array<TimeRange | null> | null): EvalMetricsSpec | null;
   ...
   */
  overlap(othr: TimeRange | null): EvalMetricsSpec | null;
   ...
   */
  static fromPrettyPrint(prettyPrint: string): EvalMetricsSpec;

  /**
   * Construct array of TimeRange from map<datetime, datetime>
   */
  static fromMap(map: C3.Map<DateTime | null, DateTime | null>): C3.Array<EvalMetricsSpec | null>;
   ...
   */
  shift(offset: Duration): EvalMetricsSpec;
