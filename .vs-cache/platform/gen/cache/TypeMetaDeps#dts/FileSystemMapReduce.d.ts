// TypeScript definitions for the C3 type FileSystemMapReduce

/**
 * Map Reduce implementation for File System
 *
 * @remarks this represents a value passed to a method that expects an instance of FileSystemMapReduce
 */
declare interface IFileSystemMapReduce {
   ...
   */
  _mapper: ILambda<λFunction<C3.Array<File | null>, C3.Map<string | null, any>> | null>;

  /**
   * User provided mapper lambda
   */
  _reducer: ILambda<λBiFunction<string | null, C3.Array<any>, any> | null>;
}
 ...
 */
declare class FileSystemMapReduce extends Obj {

  /**
   * current or last job execution for this instance
   */
  readonly run?: MapReduceRun | null;
  withRun(run: IMapReduceRun | null): FileSystemMapReduce;

  /**
   * previous job executions for this instance
   */
  readonly runs?: C3.Array<MapReduceRun | null>;
  withRuns(runs: C3.Array<MapReduceRun | null> | Array<IMapReduceRun | null>): FileSystemMapReduce;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj | null;
  withOptions(options: IObj | null): FileSystemMapReduce;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): FileSystemMapReduce;
  ...
  withPriority(priority: number | null): FileSystemMapReduce;
  ...
  withDisabled(disabled: boolean): FileSystemMapReduce;
  ...
  withMaxConcurrency(maxConcurrency: number | null): FileSystemMapReduce;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): FileSystemMapReduce;
  ...
  withRunAsUser(runAsUser: boolean | null): FileSystemMapReduce;

  /**
   * Don't set this field in the MapReduce job, set it in the MapReduceOptions when calling `start`.
   */
  readonly nodePool?: string | null;
  withNodePool(nodePool: string | null): FileSystemMapReduce;
  ...
  withSkipIfRunning(skipIfRunning: boolean | null): FileSystemMapReduce;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number | null;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): FileSystemMapReduce;
  ...
  withPropagateActionContext(propagateActionContext: boolean): FileSystemMapReduce;
  ...
  withTargetType(targetType: IType | null): FileSystemMapReduce;
  ...
  withUseFileSystemForInterVals(useFileSystemForInterVals: boolean): FileSystemMapReduce;
  ...
  withUseBatchIdsForReadInput(useBatchIdsForReadInput: boolean): FileSystemMapReduce;
  ...
  withInclude(include: string | null): FileSystemMapReduce;

  /**
   * optional filter spec
   */
  readonly filter?: string | null;
  withFilter(filter: string | null): FileSystemMapReduce;
  ...
  withOrder(order: string | null): FileSystemMapReduce;
  ...
  withLimit(limit: number | null): FileSystemMapReduce;
  ...
  withSamplePct(samplePct: number | null): FileSystemMapReduce;
  ...
  withBatchSize(batchSize: number | null): FileSystemMapReduce;
  ...
  withSubBatchSize(subBatchSize: number | null): FileSystemMapReduce;
  ...
  withNumBatches(numBatches: number | null): FileSystemMapReduce;
  ...
  withAbortOnError(abortOnError: boolean): FileSystemMapReduce;
  ...
  withTypeIdent(typeIdent: string | null): FileSystemMapReduce;
   ...
   */
  readonly id: string;
  withId(id: string): FileSystemMapReduce;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): FileSystemMapReduce;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): FileSystemMapReduce;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): FileSystemMapReduce;
  ...
  withVersion(version: number | null): FileSystemMapReduce;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): FileSystemMapReduce;

  /**
   * Optional target type instance to be used as the filter for the job.  When specified, the {~link map} function will
   * only be called for that obj.
   */
  readonly targetFilter?: File | null;
  withTargetFilter(targetFilter: IFile | null): FileSystemMapReduce;

  /**
   * Url from which files need to be read
   */
  readonly url: string;
  withUrl(url: string): FileSystemMapReduce;
  ...
  withContext(context: any): FileSystemMapReduce;

  /**
   * User provided mapper lambda
   */
  readonly _mapper: Lambda<λFunction<C3.Array<File | null>, C3.Map<string | null, any>> | null>;
  with_mapper(_mapper: ILambda<λFunction<C3.Array<File | null>, C3.Map<string | null, any>> | null>): FileSystemMapReduce;

  /**
   * User provided mapper lambda
   */
  readonly _reducer: Lambda<λBiFunction<string | null, C3.Array<any>, any> | null>;
  with_reducer(_reducer: ILambda<λBiFunction<string | null, C3.Array<any>, any> | null>): FileSystemMapReduce;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): FileSystemMapReduce | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): FileSystemMapReduce | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): FileSystemMapReduce | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): FileSystemMapReduce | null;
   ...
   */
  replaceType(old: Type, new_: Type): FileSystemMapReduce;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FileSystemMapReduce;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FileSystemMapReduce;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FileSystemMapReduce | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FileSystemMapReduce | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): FileSystemMapReduce;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FileSystemMapReduce;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FileSystemMapReduce;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FileSystemMapReduce;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FileSystemMapReduce;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FileSystemMapReduce;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): FileSystemMapReduce;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FileSystemMapReduce;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FileSystemMapReduce;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): FileSystemMapReduce;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): FileSystemMapReduce;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): FileSystemMapReduce;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): FileSystemMapReduce;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FileSystemMapReduce;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): FileSystemMapReduce;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FileSystemMapReduce;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FileSystemMapReduce;
   ...
   * @see #removeField
   */
  unsetField(field: string): FileSystemMapReduce;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FileSystemMapReduce;
   ...
   * @see #unsetField
   */
  removeField(field: string): FileSystemMapReduce;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FileSystemMapReduce;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): FileSystemMapReduce;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): FileSystemMapReduce;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): FileSystemMapReduce;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): FileSystemMapReduce;

  mergeJson(json: any | null): FileSystemMapReduce;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): FileSystemMapReduce;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): FileSystemMapReduce;
   ...
   */
  singletonArray(): C3.Array<FileSystemMapReduce | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<FileSystemMapReduce | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FileSystemMapReduce | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<FileSystemMapReduce | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FileSystemMapReduce | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, FileSystemMapReduce | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FileSystemMapReduce | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FileSystemMapReduce | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FileSystemMapReduce | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): FileSystemMapReduce;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): FileSystemMapReduce;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): FileSystemMapReduce;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FileSystemMapReduce;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): FileSystemMapReduce;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FileSystemMapReduce;
   ...
   * @see #fromString
   */
  static make(s: string | null): FileSystemMapReduce | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): FileSystemMapReduce;
   ...
   */
  static cachedEmptyInst(): FileSystemMapReduce;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<FileSystemMapReduce>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): FileSystemMapReduce;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<FileSystemMapReduce | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<FileSystemMapReduce | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<FileSystemMapReduce | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<FileSystemMapReduce | null> | null>;
   ...
   */
  get(include?: string | null): FileSystemMapReduce | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): FileSystemMapReduce | null;
   ...
   */
  getMissing(spec: GetMissingSpec): FileSystemMapReduce;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): FileSystemMapReduce | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): FileSystemMapReduce;
   ...
   * @see #toString
   */
  static fromString(s: string | null): FileSystemMapReduce | null;
   ...
   */
  create(spec?: UpsertSpec | null): FileSystemMapReduce | null;
   ...
   */
  static createBatch(objs: C3.Array<FileSystemMapReduce | null> | null, spec?: UpsertSpec | null): ObjList<FileSystemMapReduce | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<FileSystemMapReduce | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<FileSystemMapReduce | null> | null;
   ...
   */
  update(srcObj?: FileSystemMapReduce | null, spec?: UpsertSpec | null): FileSystemMapReduce | null;
   ...
   */
  upsert(srcObj?: FileSystemMapReduce | null, spec?: UpsertSpec | null): FileSystemMapReduce | null;
   ...
   */
  merge(spec?: MergeSpec | null): FileSystemMapReduce | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): FileSystemMapReduce | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): FileSystemMapReduce | null;
   ...
   */
  static updateBatch(objs: C3.Array<FileSystemMapReduce | null> | null, srcObjs?: C3.Array<FileSystemMapReduce | null>, spec?: UpsertSpec | null): ObjList<FileSystemMapReduce | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<FileSystemMapReduce | null>>, spec?: UpsertSpec | null): ObjList<FileSystemMapReduce | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<FileSystemMapReduce | null> | null, srcObjs?: C3.Array<FileSystemMapReduce | null>, spec?: UpsertSpec | null): ObjList<FileSystemMapReduce | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<FileSystemMapReduce | null>>, spec?: UpsertSpec | null): ObjList<FileSystemMapReduce | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<FileSystemMapReduce | null> | null, spec?: TouchSpec | null): ObjList<FileSystemMapReduce | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<FileSystemMapReduce | null> | null, spec?: MergeSpec | null): ObjList<FileSystemMapReduce | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<FileSystemMapReduce | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<FileSystemMapReduce | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<FileSystemMapReduce | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<FileSystemMapReduce | null> | null;
   ...
   */
  static mergeAll(mergeObj: FileSystemMapReduce | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: FileSystemMapReduce | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<FileSystemMapReduce | null> | null, spec?: UpsertSpec | null): ObjList<FileSystemMapReduce | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<FileSystemMapReduce | null> | null, spec?: UpsertSpec | null): ObjList<FileSystemMapReduce | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): FileSystemMapReduce | null;
   ...
   */
  static beforeCreate(objs: C3.Array<FileSystemMapReduce | null> | null): ObjList<FileSystemMapReduce | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<FileSystemMapReduce | null> | null): ObjList<FileSystemMapReduce | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<FileSystemMapReduce | null> | null): ObjList<FileSystemMapReduce | null>;
   ...
   */
  static afterCreate(objs: C3.Array<FileSystemMapReduce | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<FileSystemMapReduce | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<FileSystemMapReduce | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<FileSystemMapReduce | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<FileSystemMapReduce | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): FileSystemMapReduce | null;
   ...
   */
  withoutIdentity(): FileSystemMapReduce | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<FileSystemMapReduce | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: FileSystemMapReduce | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<FileSystemMapReduce | null> | null, callback?: λFunction<FileSystemMapReduce | null, FileSystemMapReduce | null> | null): ObjList<FileSystemMapReduce | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<FileSystemMapReduce | null> | null, callback?: λFunction<FileSystemMapReduce | null, FileSystemMapReduce | null> | null): C3.Array<ObjError | null>;
   ...
   *         key type.
   */
  static map(batch?: number | null, objs?: C3.Array<File | null>, job?: MapReduce<File | null, string | null, any, any> | null, subBatch?: number | null): C3.Map<string | null, any>;
   ...
   */
  static reduce(outKey?: string | null, interValues?: C3.Array<any>, job?: MapReduce<File | null, string | null, any, any> | null): any | C3.Array<any> | null;
   ...
   */
  static mapCompleted(job?: MapReduce<File | null, string | null, any, any> | null): void;
   ...
   */
  static completed(job?: MapReduce<File | null, string | null, any, any> | null): string | null;
   ...
   */
  static failed(job: MapReduce<File | null, string | null, any, any>, status: MapReduceStatus, options?: MapReduceOptions | null): void;
