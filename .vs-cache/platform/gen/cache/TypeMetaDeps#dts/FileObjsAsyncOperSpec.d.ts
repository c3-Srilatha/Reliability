// TypeScript definitions for the C3 type FileObjsAsyncOperSpec

/**
 * Spec for content operation around serialized C3 types that may have asynchronous nature.
 *
 * @see SourceFile#process
 *
 * @remarks this represents a value passed to a method that expects an instance of FileObjsAsyncOperSpec
 */
declare interface IFileObjsAsyncOperSpec {
  ...
  /**
   * If this property is set to true, then best effort attempt will be made to execute operation asynchronously.
   */
  async?: boolean;
}
 ...
 * @see SourceFile#process
 *
 * @remarks this represents a made instance of FileObjsAsyncOperSpec
 */
declare class FileObjsAsyncOperSpec extends Obj {

  /**
   * Data serialization type. If not provided type will be inferred from source data
   */
  readonly serValueType?: ValueType | null;
  withSerValueType(serValueType: IValueType | null): FileObjsAsyncOperSpec;

  /**
   * Content Type of the source data
   */
  readonly contentType?: string | null;
  withContentType(contentType: string | null): FileObjsAsyncOperSpec;

  /**
   * Compression / Content Encoding of this data
   */
  readonly contentEncoding?: string | null;
  withContentEncoding(contentEncoding: string | null): FileObjsAsyncOperSpec;

  /**
   * Batch size to use during serialization if batch writing is used (Arrow format uses batching).
   */
  readonly batchSize?: number | null;
  withBatchSize(batchSize: number | null): FileObjsAsyncOperSpec;
  ...
  withNoCsvHeader(noCsvHeader: boolean): FileObjsAsyncOperSpec;
  ...
  withCsvHeader(csvHeader: string | null): FileObjsAsyncOperSpec;

  /**
   * Optional format for a csv values. Key should be field path used in a csv header.
   */
  readonly csvFormat?: C3.Map<string | null, Format | null>;
  withCsvFormat(csvFormat: C3.Map<string | null, Format | null> | {[key: string | null]: IFormat | null}): FileObjsAsyncOperSpec;

  /**
   * Default csv delimiter for target type. Used for text/csv files. Leave this field as null for all other content types.
   */
  readonly defaultCsvDelimiter?: string | null;
  withDefaultCsvDelimiter(defaultCsvDelimiter: string | null): FileObjsAsyncOperSpec;

  /**
   * Default escape character for target type. Used for text/csv files. Leave this field as null for all other content types.
   */
  readonly defaultCsvEscapeChar?: string | null;
  withDefaultCsvEscapeChar(defaultCsvEscapeChar: string | null): FileObjsAsyncOperSpec;

  /**
   * Default quote character for target type. Used for text/csv files. Leave this field as null for all other content types.
   */
  readonly defaultCsvQuoteChar?: string | null;
  withDefaultCsvQuoteChar(defaultCsvQuoteChar: string | null): FileObjsAsyncOperSpec;
  ...
  withAvroSchema(avroSchema: string | null): FileObjsAsyncOperSpec;
  ...
  withIsObjList(isObjList: boolean): FileObjsAsyncOperSpec;

  /**
   * Optionally skip extra fields in serialized content instead of failing to serialize.
   */
  readonly skipExtraFields?: boolean;
  withSkipExtraFields(skipExtraFields: boolean): FileObjsAsyncOperSpec;

  /**
   * If true will silently ignore bad syntax in the content and will return no or partial results.
   */
  readonly ignoreBadContent?: boolean;
  withIgnoreBadContent(ignoreBadContent: boolean): FileObjsAsyncOperSpec;
  ...
  withMergeXmlNonAdjacentLists(mergeXmlNonAdjacentLists: boolean): FileObjsAsyncOperSpec;

  /**
   * Specifies various parameters for automatic retry that occurs in upsert due to retryable errors.
   */
  readonly retrySpec?: RetrySpec | null;
  withRetrySpec(retrySpec: IRetrySpec | null): FileObjsAsyncOperSpec;

  /**
   * If set, stream will be instantiated again on retryable errors and execution will continue from the point of failure
   */
  readonly restartStreamOnRetry?: boolean;
  withRestartStreamOnRetry(restartStreamOnRetry: boolean): FileObjsAsyncOperSpec;

  /**
   * The index of the first object from a stream that needs to be read.
   */
  readonly offset?: number | null;
  withOffset(offset: number | null): FileObjsAsyncOperSpec;
  ...
  withLimit(limit: number | null): FileObjsAsyncOperSpec;
  ...
  withValidateContentType(validateContentType: boolean): FileObjsAsyncOperSpec;
  ...
  withPeekForMetadata(peekForMetadata: boolean): FileObjsAsyncOperSpec;
  ...
  withFailIfMissing(failIfMissing: boolean): FileObjsAsyncOperSpec;
  ...
  withSkipIfUnauthorized(skipIfUnauthorized: boolean): FileObjsAsyncOperSpec;

  /**
   * If set and if requested file or directory url is under this path then will retrieve content from cache.
   */
  readonly cacheUrlOrEncodedPath?: string | null;
  withCacheUrlOrEncodedPath(cacheUrlOrEncodedPath: string | null): FileObjsAsyncOperSpec;

  /**
   * Time in seconds that the cached file should live (default 24 hours).
   */
  readonly cacheTtlSec?: number | null;
  withCacheTtlSec(cacheTtlSec: number | null): FileObjsAsyncOperSpec;
  ...
  withForceMultiPart(forceMultiPart: boolean): FileObjsAsyncOperSpec;
  ...
  withDisableMultiPart(disableMultiPart: boolean): FileObjsAsyncOperSpec;

  /**
   * Overrides default maximum file size before MultipartUpload kicks in. Default is 1GB
   */
  readonly maximumSingleUploadsize?: number | null;
  withMaximumSingleUploadsize(maximumSingleUploadsize: number | null): FileObjsAsyncOperSpec;
  ...
  withMaxThreads(maxThreads: number | null): FileObjsAsyncOperSpec;
  ...
  withMinThreads(minThreads: number | null): FileObjsAsyncOperSpec;

  /**
   * If set to true, it will retry reading file when the file is not found.
   */
  readonly retryOnNotFound?: boolean;
  withRetryOnNotFound(retryOnNotFound: boolean): FileObjsAsyncOperSpec;
  ...
  withLockOnWrite(lockOnWrite: boolean): FileObjsAsyncOperSpec;

  /**
   * If set will use IoExecutor service.
   */
  readonly useIoExecutor?: boolean;
  withUseIoExecutor(useIoExecutor: boolean): FileObjsAsyncOperSpec;

  /**
   * If not null, retry logic will be used from CloudClient rather than File
   */
  readonly cloudClient?: any;
  withCloudClient(cloudClient: any): FileObjsAsyncOperSpec;
  ...
  withSerType(serType: IType | null): FileObjsAsyncOperSpec;

  /**
   * If true then will not use parent folder of content for target type guess.
   */
  readonly doNotUseParentDirForSerType?: boolean;
  withDoNotUseParentDirForSerType(doNotUseParentDirForSerType: boolean): FileObjsAsyncOperSpec;
  ...
  withUseBinaryEncodingDecoding(useBinaryEncodingDecoding: boolean): FileObjsAsyncOperSpec;

  /**
   * Optionally indicating if serialized form should contain C3 type.
   */
  readonly shouldNotWriteType?: boolean;
  withShouldNotWriteType(shouldNotWriteType: boolean): FileObjsAsyncOperSpec;

  /**
   * Optionally indicating if serialized form should be formatted for ease of reading.
   */
  readonly shouldWritePretty?: boolean;
  withShouldWritePretty(shouldWritePretty: boolean): FileObjsAsyncOperSpec;
  ...
  withGuessMetadata(guessMetadata: boolean): FileObjsAsyncOperSpec;

  /**
   * If true, checksum files will be generated when writing files
   */
  readonly createChecksum?: boolean;
  withCreateChecksum(createChecksum: boolean): FileObjsAsyncOperSpec;

  /**
   * Whether to decrypt content during read
   */
  readonly decrypt?: boolean;
  withDecrypt(decrypt: boolean): FileObjsAsyncOperSpec;

  /**
   * If this property is set to true, then best effort attempt will be made to execute operation asynchronously.
   */
  readonly async?: boolean;
  withAsync(async: boolean): FileObjsAsyncOperSpec;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): FileObjsAsyncOperSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): FileObjsAsyncOperSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): FileObjsAsyncOperSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): FileObjsAsyncOperSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): FileObjsAsyncOperSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FileObjsAsyncOperSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FileObjsAsyncOperSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FileObjsAsyncOperSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FileObjsAsyncOperSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): FileObjsAsyncOperSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FileObjsAsyncOperSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FileObjsAsyncOperSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FileObjsAsyncOperSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FileObjsAsyncOperSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FileObjsAsyncOperSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): FileObjsAsyncOperSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FileObjsAsyncOperSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FileObjsAsyncOperSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): FileObjsAsyncOperSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): FileObjsAsyncOperSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): FileObjsAsyncOperSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): FileObjsAsyncOperSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FileObjsAsyncOperSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): FileObjsAsyncOperSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FileObjsAsyncOperSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FileObjsAsyncOperSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): FileObjsAsyncOperSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FileObjsAsyncOperSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): FileObjsAsyncOperSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FileObjsAsyncOperSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): FileObjsAsyncOperSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): FileObjsAsyncOperSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): FileObjsAsyncOperSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): FileObjsAsyncOperSpec;

  mergeJson(json: any | null): FileObjsAsyncOperSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): FileObjsAsyncOperSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): FileObjsAsyncOperSpec;
   ...
   */
  singletonArray(): C3.Array<FileObjsAsyncOperSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<FileObjsAsyncOperSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FileObjsAsyncOperSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<FileObjsAsyncOperSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FileObjsAsyncOperSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, FileObjsAsyncOperSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FileObjsAsyncOperSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FileObjsAsyncOperSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FileObjsAsyncOperSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): FileObjsAsyncOperSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): FileObjsAsyncOperSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): FileObjsAsyncOperSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FileObjsAsyncOperSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): FileObjsAsyncOperSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FileObjsAsyncOperSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): FileObjsAsyncOperSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): FileObjsAsyncOperSpec;
   ...
   */
  static cachedEmptyInst(): FileObjsAsyncOperSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<FileObjsAsyncOperSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): FileObjsAsyncOperSpec;

  /**
   * @return new instance of this spec with `retrySpec` set
   */
  withRetry(maxRetries?: number | null, initialSleepMillis?: number | null, exponent?: number | null): FileObjsAsyncOperSpec | null;

  /**
   * @return instance of this spec with `retrySpec`'s `maxTotalMillis` set
   */
  static timeoutSeconds(secs: number | null): FileObjsAsyncOperSpec;

  /**
   * @return FileObjsOperSpec with #serType set to provided value.
   */
  static fromType(serType: Type | null): FileObjsAsyncOperSpec;
   ...
   */
  static toDecrypt(): FileObjsAsyncOperSpec | null;
}
