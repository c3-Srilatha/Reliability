// TypeScript definitions for the C3 type AppIdentity

/**
 * This type represents the App Identity of an App
 *
 * @remarks this represents a value passed to a method that expects an instance of AppIdentity
 */
declare interface IAppIdentity {
  ...
  /**
   * If an AppIdentity with AppIdentity.DEFAULT as id is upserted by the app admin, ALL APPS in the cluster are granted
   * access to the current app via provided roles. This is mainly a use case for Microservices so set it with caution.
   */
  DEFAULT?: string | null;
  ...
  /**
   * The algorithm used for verifying jwt tokens from the app
   */
  jwtAlgorithm?: string | null;

  /**
   * The roles assigned to the app identity for the app.
   */
  roles?: C3.Array<string | null> | Array<string | null>;
}

/**
 * This type represents the App Identity of an App
 *
 * @remarks this represents a made instance of AppIdentity
 */
declare class AppIdentity extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): AppIdentity;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): AppIdentity;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): AppIdentity;

  /**
   * The unique and required id of this instance.
   */
  readonly id: string;
  withId(id: string): AppIdentity;
  ...
  withDEFAULT(DEFAULT: string | null): AppIdentity;

  /**
   * The public key of the app
   */
  readonly publicKey?: string | null;
  withPublicKey(publicKey: string | null): AppIdentity;

  /**
   * The algorithm used for verifying jwt tokens from the app
   */
  readonly jwtAlgorithm?: string | null;
  withJwtAlgorithm(jwtAlgorithm: string | null): AppIdentity;

  /**
   * The roles assigned to the app identity for the app.
   */
  readonly roles?: C3.Array<string | null>;
  withRoles(roles: C3.Array<string | null> | Array<string | null>): AppIdentity;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): AppIdentity | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): AppIdentity | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): AppIdentity | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): AppIdentity | null;
   ...
   */
  replaceType(old: Type, new_: Type): AppIdentity;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): AppIdentity;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): AppIdentity;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<AppIdentity | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<AppIdentity | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): AppIdentity;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AppIdentity;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AppIdentity;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): AppIdentity;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): AppIdentity;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): AppIdentity;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): AppIdentity;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): AppIdentity;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): AppIdentity;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): AppIdentity;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): AppIdentity;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): AppIdentity;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): AppIdentity;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): AppIdentity;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): AppIdentity;
   ...
   * @see #unsetField
   */
  defaultField(field: string): AppIdentity;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): AppIdentity;
   ...
   * @see #removeField
   */
  unsetField(field: string): AppIdentity;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): AppIdentity;
   ...
   * @see #unsetField
   */
  removeField(field: string): AppIdentity;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): AppIdentity;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): AppIdentity;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): AppIdentity;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): AppIdentity;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): AppIdentity;

  mergeJson(json: any | null): AppIdentity;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): AppIdentity;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): AppIdentity;
   ...
   */
  singletonArray(): C3.Array<AppIdentity | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<AppIdentity | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<AppIdentity | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<AppIdentity | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<AppIdentity | null> | null;
   ...
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, AppIdentity | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<AppIdentity | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<AppIdentity | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): AppIdentity;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): AppIdentity;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): AppIdentity;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): AppIdentity;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): AppIdentity;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): AppIdentity;
   ...
   * @see #fromString
   */
  static make(s: string | null): AppIdentity | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): AppIdentity;
   ...
   */
  static cachedEmptyInst(): AppIdentity;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<AppIdentity>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): AppIdentity;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<AppIdentity | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<AppIdentity | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<AppIdentity | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): AppIdentity | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): AppIdentity | null;
   ...
   * @see findByCacheKey
   */
  getCached(): AppIdentity | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): AppIdentity | null;
   ...
   */
  static produce(key: string): AppIdentity | null;
   ...
   */
  static produceAll(): C3.Map<string | null, AppIdentity | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, AppIdentity | null>;
   ...
   */
  static forConfigKey(configKey: string | null): AppIdentity | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<AppIdentity | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: AppIdentity, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: AppIdentity, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): AppIdentity | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): AppIdentity | null;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): AppIdentity | null;
}
