// TypeScript definitions for the C3 type InvalidationQueueHistory

/**
 * History of a queue's status at a certain timestamp.
 *
 * @remarks this represents a value passed to a method that expects an instance of InvalidationQueueHistory
 */
declare interface IInvalidationQueueHistory {
  ...
  /**
   * Initial count of the queue.
   */
  initial: number;

  /**
   * Pending count of the queue.
   */
  pending: number;

  /**
   * Computing Actions count of the queue.
   */
  computingActions: number;

  /**
   * Computing Entries count of the queue.
   */
  computingEntries: number;

  /**
   * Count of entries awaiting compute.
   */
  awaitingCompute: number;

  /**
   * Number of actions required to process all pending entries.
   */
  pendingActions: number;

  /**
   * Failed counts of the queue.
   */
  failed: number;

  /**
   * Unreviewed failed count of the queue.
   */
 ...
 * History of a queue's status at a certain timestamp.
 *
 * @remarks this represents a made instance of InvalidationQueueHistory
 */
declare class InvalidationQueueHistory extends Obj {
   ...
   */
  readonly id: string;
  withId(id: string): InvalidationQueueHistory;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): InvalidationQueueHistory;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): InvalidationQueueHistory;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): InvalidationQueueHistory;
  ...
  withVersion(version: number | null): InvalidationQueueHistory;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): InvalidationQueueHistory;

  /**
   * The timestamp of the history.
   */
  readonly timestamp: DateTime;
  withTimestamp(timestamp: DateTime | Date | string): InvalidationQueueHistory;

  /**
   * Name of the Queue type.
   */
  readonly queueType: string;
  withQueueType(queueType: string): InvalidationQueueHistory;

  /**
   * If the queue is paused
   */
  readonly paused: boolean;
  withPaused(paused: boolean): InvalidationQueueHistory;

  /**
   * Initial count of the queue.
   */
  readonly initial: number;
  withInitial(initial: number): InvalidationQueueHistory;

  /**
   * Pending count of the queue.
   */
  readonly pending: number;
  withPending(pending: number): InvalidationQueueHistory;

  /**
   * Computing Actions count of the queue.
   */
  readonly computingActions: number;
  withComputingActions(computingActions: number): InvalidationQueueHistory;

  /**
   * Computing Entries count of the queue.
   */
  readonly computingEntries: number;
  withComputingEntries(computingEntries: number): InvalidationQueueHistory;

  /**
   * Count of entries awaiting compute.
   */
  readonly awaitingCompute: number;
  withAwaitingCompute(awaitingCompute: number): InvalidationQueueHistory;

  /**
   * Number of actions required to process all pending entries.
   */
  readonly pendingActions: number;
  withPendingActions(pendingActions: number): InvalidationQueueHistory;

  /**
   * Failed counts of the queue.
   */
  readonly failed: number;
  withFailed(failed: number): InvalidationQueueHistory;

  /**
   * Unreviewed failed count of the queue.
   */
  readonly unreviewedFailed: number;
  withUnreviewedFailed(unreviewedFailed: number): InvalidationQueueHistory;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): InvalidationQueueHistory | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): InvalidationQueueHistory | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): InvalidationQueueHistory | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): InvalidationQueueHistory | null;
   ...
   */
  replaceType(old: Type, new_: Type): InvalidationQueueHistory;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): InvalidationQueueHistory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): InvalidationQueueHistory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<InvalidationQueueHistory | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<InvalidationQueueHistory | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): InvalidationQueueHistory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): InvalidationQueueHistory;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): InvalidationQueueHistory;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): InvalidationQueueHistory;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): InvalidationQueueHistory;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): InvalidationQueueHistory;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): InvalidationQueueHistory;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): InvalidationQueueHistory;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): InvalidationQueueHistory;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): InvalidationQueueHistory;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): InvalidationQueueHistory;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): InvalidationQueueHistory;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): InvalidationQueueHistory;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): InvalidationQueueHistory;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): InvalidationQueueHistory;
   ...
   * @see #unsetField
   */
  defaultField(field: string): InvalidationQueueHistory;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): InvalidationQueueHistory;
   ...
   * @see #removeField
   */
  unsetField(field: string): InvalidationQueueHistory;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): InvalidationQueueHistory;
   ...
   * @see #unsetField
   */
  removeField(field: string): InvalidationQueueHistory;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): InvalidationQueueHistory;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): InvalidationQueueHistory;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): InvalidationQueueHistory;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): InvalidationQueueHistory;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): InvalidationQueueHistory;

  mergeJson(json: any | null): InvalidationQueueHistory;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): InvalidationQueueHistory;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): InvalidationQueueHistory;
   ...
   */
  singletonArray(): C3.Array<InvalidationQueueHistory | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<InvalidationQueueHistory | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<InvalidationQueueHistory | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<InvalidationQueueHistory | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<InvalidationQueueHistory | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, InvalidationQueueHistory | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, InvalidationQueueHistory | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<InvalidationQueueHistory | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<InvalidationQueueHistory | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): InvalidationQueueHistory;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): InvalidationQueueHistory;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): InvalidationQueueHistory;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): InvalidationQueueHistory;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): InvalidationQueueHistory;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): InvalidationQueueHistory;
   ...
   * @see #fromString
   */
  static make(s: string | null): InvalidationQueueHistory | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): InvalidationQueueHistory;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): InvalidationQueueHistory;
   ...
   */
  static cachedEmptyInst(): InvalidationQueueHistory;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<InvalidationQueueHistory>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): InvalidationQueueHistory;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<InvalidationQueueHistory | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<InvalidationQueueHistory | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<InvalidationQueueHistory | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<InvalidationQueueHistory | null> | null>;
   ...
   */
  get(include?: string | null): InvalidationQueueHistory | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): InvalidationQueueHistory | null;
   ...
   */
  getMissing(spec: GetMissingSpec): InvalidationQueueHistory;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): InvalidationQueueHistory | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): InvalidationQueueHistory;
   ...
   * @see #toString
   */
  static fromString(s: string | null): InvalidationQueueHistory | null;
   ...
   */
  create(spec?: UpsertSpec | null): InvalidationQueueHistory | null;
   ...
   */
  static createBatch(objs: C3.Array<InvalidationQueueHistory | null> | null, spec?: UpsertSpec | null): ObjList<InvalidationQueueHistory | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<InvalidationQueueHistory | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<InvalidationQueueHistory | null> | null;
   ...
   */
  update(srcObj?: InvalidationQueueHistory | null, spec?: UpsertSpec | null): InvalidationQueueHistory | null;
   ...
   */
  upsert(srcObj?: InvalidationQueueHistory | null, spec?: UpsertSpec | null): InvalidationQueueHistory | null;
   ...
   */
  merge(spec?: MergeSpec | null): InvalidationQueueHistory | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): InvalidationQueueHistory | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): InvalidationQueueHistory | null;
   ...
   */
  static updateBatch(objs: C3.Array<InvalidationQueueHistory | null> | null, srcObjs?: C3.Array<InvalidationQueueHistory | null>, spec?: UpsertSpec | null): ObjList<InvalidationQueueHistory | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<InvalidationQueueHistory | null>>, spec?: UpsertSpec | null): ObjList<InvalidationQueueHistory | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<InvalidationQueueHistory | null> | null, srcObjs?: C3.Array<InvalidationQueueHistory | null>, spec?: UpsertSpec | null): ObjList<InvalidationQueueHistory | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<InvalidationQueueHistory | null>>, spec?: UpsertSpec | null): ObjList<InvalidationQueueHistory | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<InvalidationQueueHistory | null> | null, spec?: TouchSpec | null): ObjList<InvalidationQueueHistory | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<InvalidationQueueHistory | null> | null, spec?: MergeSpec | null): ObjList<InvalidationQueueHistory | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<InvalidationQueueHistory | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<InvalidationQueueHistory | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<InvalidationQueueHistory | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<InvalidationQueueHistory | null> | null;
   ...
   */
  static mergeAll(mergeObj: InvalidationQueueHistory | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: InvalidationQueueHistory | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<InvalidationQueueHistory | null> | null, spec?: UpsertSpec | null): ObjList<InvalidationQueueHistory | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<InvalidationQueueHistory | null> | null, spec?: UpsertSpec | null): ObjList<InvalidationQueueHistory | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): InvalidationQueueHistory | null;
   ...
   */
  static beforeCreate(objs: C3.Array<InvalidationQueueHistory | null> | null): ObjList<InvalidationQueueHistory | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<InvalidationQueueHistory | null> | null): ObjList<InvalidationQueueHistory | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<InvalidationQueueHistory | null> | null): ObjList<InvalidationQueueHistory | null>;
   ...
   */
  static afterCreate(objs: C3.Array<InvalidationQueueHistory | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<InvalidationQueueHistory | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<InvalidationQueueHistory | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<InvalidationQueueHistory | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<InvalidationQueueHistory | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): InvalidationQueueHistory | null;
   ...
   */
  withoutIdentity(): InvalidationQueueHistory | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<InvalidationQueueHistory | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: InvalidationQueueHistory | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<InvalidationQueueHistory | null> | null, callback?: λFunction<InvalidationQueueHistory | null, InvalidationQueueHistory | null> | null): ObjList<InvalidationQueueHistory | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<InvalidationQueueHistory | null> | null, callback?: λFunction<InvalidationQueueHistory | null, InvalidationQueueHistory | null> | null): C3.Array<ObjError | null>;
