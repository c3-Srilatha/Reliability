// TypeScript definitions for the C3 type LoadAnalyzerConfig

/**
 * @remarks this represents a value passed to a method that expects an instance of LoadAnalyzerConfig
 */
declare interface ILoadAnalyzerConfig {
  ...
  /**
   * Used for usage summary based clustering
   *
   * These fields are also required for profiling
   */
  grain?: string | null;

  /**
   * must mixin UsageSummary
   */
  usageSummaryType?: IType | null;

  /**
   * used for clustering and generation of cluster stats
   *
   * used while generating cluster stats - (grain, usageSummaryType, clusterFieldName, clusterStatsType, timeRangeStart, timeRangeEnd
   */
  numberOfClusters?: number | null;

  /**
   * name of the field on the object which references the cluster it belongs to
   */
  clusterFieldName?: string | null;

  /**
   * must mixin ClusterStats
   */
  clusterStatsType?: IType | null;

  /**
   * Used for custom clustering
   *
   * set true if clustering is by type other than by usage summaries
   */
  isCustomClustering?: boolean;

  /**
   * Used for euclidean distance clustering
   * Use case is k-means clustering of buildingProfiles in res
   *
   * set true if euclidean distance clustering desired
   */
  isGeographicDistanceClustering?: boolean;

  /**
   * comma separated categories according to which we want to cluster
   * eg. 'usageData','buildingType,zipCode'
   */
  clusterCategories?: string | null;

  /**
   * comma separated path to category by which we want to cluster. (eg. servicePoint.bldgType, servicePoint.location.postalCode)
   */
  clusterByFieldPaths?: string | null;

  /**
   * These configurations are for target type for the map reduce job
   * target type on which map reduce code needs to start / startingType for clustering to start
   */
  targetTypeRef?: IType | null;

  /**
   * filter for the target type
   */
  targetFilter?: string | null;

  /**
   * include for the target type
   */
  targetInclude?: string | null;

  /**
   * path to get the device (meter) id from target type
   */
  targetDeviceIdPath?: string | null;
...
/**
 * @remarks this represents a made instance of LoadAnalyzerConfig
 */
declare class LoadAnalyzerConfig extends Obj {

  readonly timeRangeStart?: DateTime | null;
  withTimeRangeStart(timeRangeStart: DateTime | Date | string | null): LoadAnalyzerConfig;

  readonly timeRangeEnd?: DateTime | null;
  withTimeRangeEnd(timeRangeEnd: DateTime | Date | string | null): LoadAnalyzerConfig;

  readonly resource: string;
  withResource(resource: string): LoadAnalyzerConfig;
  ...
  withGrain(grain: string | null): LoadAnalyzerConfig;

  /**
   * must mixin UsageSummary
   */
  readonly usageSummaryType?: Type | null;
  withUsageSummaryType(usageSummaryType: IType | null): LoadAnalyzerConfig;
   ...
   * used while generating cluster stats - (grain, usageSummaryType, clusterFieldName, clusterStatsType, timeRangeStart, timeRangeEnd
   */
  readonly numberOfClusters?: number | null;
  withNumberOfClusters(numberOfClusters: number | null): LoadAnalyzerConfig;

  /**
   * name of the field on the object which references the cluster it belongs to
   */
  readonly clusterFieldName?: string | null;
  withClusterFieldName(clusterFieldName: string | null): LoadAnalyzerConfig;

  /**
   * must mixin ClusterStats
   */
  readonly clusterStatsType?: Type | null;
  withClusterStatsType(clusterStatsType: IType | null): LoadAnalyzerConfig;
   ...
   * set true if clustering is by type other than by usage summaries
   */
  readonly isCustomClustering?: boolean;
  withIsCustomClustering(isCustomClustering: boolean): LoadAnalyzerConfig;
   ...
   * set true if euclidean distance clustering desired
   */
  readonly isGeographicDistanceClustering?: boolean;
  withIsGeographicDistanceClustering(isGeographicDistanceClustering: boolean): LoadAnalyzerConfig;

  /**
   * comma separated categories according to which we want to cluster
   * eg. 'usageData','buildingType,zipCode'
   */
  readonly clusterCategories?: string | null;
  withClusterCategories(clusterCategories: string | null): LoadAnalyzerConfig;

  /**
   * comma separated path to category by which we want to cluster. (eg. servicePoint.bldgType, servicePoint.location.postalCode)
   */
  readonly clusterByFieldPaths?: string | null;
  withClusterByFieldPaths(clusterByFieldPaths: string | null): LoadAnalyzerConfig;

  /**
   * These configurations are for target type for the map reduce job
   * target type on which map reduce code needs to start / startingType for clustering to start
   */
  readonly targetTypeRef?: Type | null;
  withTargetTypeRef(targetTypeRef: IType | null): LoadAnalyzerConfig;

  /**
   * filter for the target type
   */
  readonly targetFilter?: string | null;
  withTargetFilter(targetFilter: string | null): LoadAnalyzerConfig;

  /**
   * include for the target type
   */
  readonly targetInclude?: string | null;
  withTargetInclude(targetInclude: string | null): LoadAnalyzerConfig;

  /**
   * path to get the device (meter) id from target type
   */
  readonly targetDeviceIdPath?: string | null;
  withTargetDeviceIdPath(targetDeviceIdPath: string | null): LoadAnalyzerConfig;
   ...
   */
  readonly id: string;
  withId(id: string): LoadAnalyzerConfig;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): LoadAnalyzerConfig;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): LoadAnalyzerConfig;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): LoadAnalyzerConfig;
  ...
  withVersion(version: number | null): LoadAnalyzerConfig;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): LoadAnalyzerConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LoadAnalyzerConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LoadAnalyzerConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LoadAnalyzerConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LoadAnalyzerConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): LoadAnalyzerConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LoadAnalyzerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LoadAnalyzerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LoadAnalyzerConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LoadAnalyzerConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LoadAnalyzerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LoadAnalyzerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LoadAnalyzerConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LoadAnalyzerConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LoadAnalyzerConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LoadAnalyzerConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LoadAnalyzerConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LoadAnalyzerConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LoadAnalyzerConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LoadAnalyzerConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LoadAnalyzerConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LoadAnalyzerConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LoadAnalyzerConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LoadAnalyzerConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LoadAnalyzerConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LoadAnalyzerConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LoadAnalyzerConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): LoadAnalyzerConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LoadAnalyzerConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): LoadAnalyzerConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LoadAnalyzerConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LoadAnalyzerConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LoadAnalyzerConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LoadAnalyzerConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LoadAnalyzerConfig;

  mergeJson(json: any | null): LoadAnalyzerConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LoadAnalyzerConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LoadAnalyzerConfig;
   ...
   */
  singletonArray(): C3.Array<LoadAnalyzerConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LoadAnalyzerConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LoadAnalyzerConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LoadAnalyzerConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LoadAnalyzerConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LoadAnalyzerConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LoadAnalyzerConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LoadAnalyzerConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LoadAnalyzerConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LoadAnalyzerConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LoadAnalyzerConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LoadAnalyzerConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LoadAnalyzerConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LoadAnalyzerConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LoadAnalyzerConfig;
   ...
   * @see #fromString
   */
  static make(s: string | null): LoadAnalyzerConfig | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LoadAnalyzerConfig;
   ...
   */
  static cachedEmptyInst(): LoadAnalyzerConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LoadAnalyzerConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LoadAnalyzerConfig;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<LoadAnalyzerConfig | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<LoadAnalyzerConfig | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<LoadAnalyzerConfig | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<LoadAnalyzerConfig | null> | null>;
   ...
   */
  get(include?: string | null): LoadAnalyzerConfig | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): LoadAnalyzerConfig | null;
   ...
   */
  getMissing(spec: GetMissingSpec): LoadAnalyzerConfig;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): LoadAnalyzerConfig | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): LoadAnalyzerConfig;
   ...
   * @see #toString
   */
  static fromString(s: string | null): LoadAnalyzerConfig | null;
   ...
   */
  create(spec?: UpsertSpec | null): LoadAnalyzerConfig | null;
   ...
   */
  static createBatch(objs: C3.Array<LoadAnalyzerConfig | null> | null, spec?: UpsertSpec | null): ObjList<LoadAnalyzerConfig | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<LoadAnalyzerConfig | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<LoadAnalyzerConfig | null> | null;
   ...
   */
  update(srcObj?: LoadAnalyzerConfig | null, spec?: UpsertSpec | null): LoadAnalyzerConfig | null;
   ...
   */
  upsert(srcObj?: LoadAnalyzerConfig | null, spec?: UpsertSpec | null): LoadAnalyzerConfig | null;
   ...
   */
  merge(spec?: MergeSpec | null): LoadAnalyzerConfig | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): LoadAnalyzerConfig | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): LoadAnalyzerConfig | null;
   ...
   */
  static updateBatch(objs: C3.Array<LoadAnalyzerConfig | null> | null, srcObjs?: C3.Array<LoadAnalyzerConfig | null>, spec?: UpsertSpec | null): ObjList<LoadAnalyzerConfig | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<LoadAnalyzerConfig | null>>, spec?: UpsertSpec | null): ObjList<LoadAnalyzerConfig | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<LoadAnalyzerConfig | null> | null, srcObjs?: C3.Array<LoadAnalyzerConfig | null>, spec?: UpsertSpec | null): ObjList<LoadAnalyzerConfig | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<LoadAnalyzerConfig | null>>, spec?: UpsertSpec | null): ObjList<LoadAnalyzerConfig | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<LoadAnalyzerConfig | null> | null, spec?: TouchSpec | null): ObjList<LoadAnalyzerConfig | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<LoadAnalyzerConfig | null> | null, spec?: MergeSpec | null): ObjList<LoadAnalyzerConfig | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<LoadAnalyzerConfig | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<LoadAnalyzerConfig | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<LoadAnalyzerConfig | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<LoadAnalyzerConfig | null> | null;
   ...
   */
  static mergeAll(mergeObj: LoadAnalyzerConfig | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: LoadAnalyzerConfig | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<LoadAnalyzerConfig | null> | null, spec?: UpsertSpec | null): ObjList<LoadAnalyzerConfig | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<LoadAnalyzerConfig | null> | null, spec?: UpsertSpec | null): ObjList<LoadAnalyzerConfig | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): LoadAnalyzerConfig | null;
   ...
   */
  static beforeCreate(objs: C3.Array<LoadAnalyzerConfig | null> | null): ObjList<LoadAnalyzerConfig | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<LoadAnalyzerConfig | null> | null): ObjList<LoadAnalyzerConfig | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<LoadAnalyzerConfig | null> | null): ObjList<LoadAnalyzerConfig | null>;
   ...
   */
  static afterCreate(objs: C3.Array<LoadAnalyzerConfig | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<LoadAnalyzerConfig | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<LoadAnalyzerConfig | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<LoadAnalyzerConfig | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<LoadAnalyzerConfig | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): LoadAnalyzerConfig | null;
   ...
   */
  withoutIdentity(): LoadAnalyzerConfig | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<LoadAnalyzerConfig | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: LoadAnalyzerConfig | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<LoadAnalyzerConfig | null> | null, callback?: λFunction<LoadAnalyzerConfig | null, LoadAnalyzerConfig | null> | null): ObjList<LoadAnalyzerConfig | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<LoadAnalyzerConfig | null> | null, callback?: λFunction<LoadAnalyzerConfig | null, LoadAnalyzerConfig | null> | null): C3.Array<ObjError | null>;
