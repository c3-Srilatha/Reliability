// TypeScript definitions for the C3 type TsBrowserC3UiTester

/**
 * This {@link TsBrowserTester} is in charge of running uiInfrastructureReact UI unit tests in the browser.
 *
 * @remarks this represents a value passed to a method that expects an instance of TsBrowserC3UiTester
 */
declare interface ITsBrowserC3UiTester {
 ...
 * This {@link TsBrowserTester} is in charge of running uiInfrastructureReact UI unit tests in the browser.
 *
 * @remarks this represents a made instance of TsBrowserC3UiTester
 */
declare class TsBrowserC3UiTester extends Obj {

  /**
   * Whether or not tests should be executed in headless mode.
   */
  headless?: boolean;
  withHeadless(headless: boolean): TsBrowserC3UiTester;
   ...
   */
  testerHtmlPagePath?: string | null;
  withTesterHtmlPagePath(testerHtmlPagePath: string | null): TsBrowserC3UiTester;

  testRunner: TestRunner;
  withTestRunner(testRunner: ITestRunner): TsBrowserC3UiTester;
   ...
   */
  state: string;
  withState(state: string): TsBrowserC3UiTester;

  /**
   * The collected test results after the test execution.
   */
  results?: C3.Array<TestSuiteResult | null>;
  withResults(results: C3.Array<TestSuiteResult | null> | Array<ITestSuiteResult | null>): TsBrowserC3UiTester;

  /**
   * The action engine in which tests will execute.
   */
  engine: Action.Engine;
  withEngine(engine: IAction.Engine): TsBrowserC3UiTester;

  maxRetries?: number | null;
  withMaxRetries(maxRetries: number | null): TsBrowserC3UiTester;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TsBrowserC3UiTester | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TsBrowserC3UiTester | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TsBrowserC3UiTester | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TsBrowserC3UiTester | null;
   ...
   */
  replaceType(old: Type, new_: Type): TsBrowserC3UiTester;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TsBrowserC3UiTester;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TsBrowserC3UiTester;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TsBrowserC3UiTester | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TsBrowserC3UiTester | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TsBrowserC3UiTester;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TsBrowserC3UiTester;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TsBrowserC3UiTester;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TsBrowserC3UiTester;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TsBrowserC3UiTester;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TsBrowserC3UiTester;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TsBrowserC3UiTester;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TsBrowserC3UiTester;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TsBrowserC3UiTester;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TsBrowserC3UiTester;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TsBrowserC3UiTester;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TsBrowserC3UiTester;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TsBrowserC3UiTester;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TsBrowserC3UiTester;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TsBrowserC3UiTester;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TsBrowserC3UiTester;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TsBrowserC3UiTester;
   ...
   * @see #removeField
   */
  unsetField(field: string): TsBrowserC3UiTester;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TsBrowserC3UiTester;
   ...
   * @see #unsetField
   */
  removeField(field: string): TsBrowserC3UiTester;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TsBrowserC3UiTester;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TsBrowserC3UiTester;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TsBrowserC3UiTester;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TsBrowserC3UiTester;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TsBrowserC3UiTester;

  mergeJson(json: any | null): TsBrowserC3UiTester;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TsBrowserC3UiTester;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TsBrowserC3UiTester;
   ...
   */
  singletonArray(): C3.Array<TsBrowserC3UiTester | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TsBrowserC3UiTester | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TsBrowserC3UiTester | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TsBrowserC3UiTester | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TsBrowserC3UiTester | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TsBrowserC3UiTester | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TsBrowserC3UiTester | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TsBrowserC3UiTester | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TsBrowserC3UiTester | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TsBrowserC3UiTester;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TsBrowserC3UiTester;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TsBrowserC3UiTester;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TsBrowserC3UiTester;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TsBrowserC3UiTester;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TsBrowserC3UiTester;

  /**
   * Construct an instance with initial state.
   */
  static make(): TsBrowserC3UiTester;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TsBrowserC3UiTester;
   ...
   */
  static cachedEmptyInst(): TsBrowserC3UiTester;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TsBrowserC3UiTester>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TsBrowserC3UiTester;
   ...
   * @return this Obj
   */
  setField(field: string, value: any, doNotConvert?: boolean): TsBrowserC3UiTester;
   ...
   * @return this Obj
   */
  setField(field: FieldType, value: any, doNotConvert?: boolean): TsBrowserC3UiTester;
   ...
   */
  static forPathAndEngine(path: string, engine: string): TsBrowserC3UiTester;
   ...
   * Note: invoke this API on the desired type of Tester instead of on the Tester type directly.
   */
  static forNameAndEngine(testName: string, engine: string): TsBrowserC3UiTester;
   ...
   * Note: invoke this API on the desired type of Tester instead of on the Tester type directly.
   */
  static forEngine(engine: string, deep?: boolean): TsBrowserC3UiTester;
   ...
   */
  run(spec?: TesterRunSpec | null): TsBrowserC3UiTester;
