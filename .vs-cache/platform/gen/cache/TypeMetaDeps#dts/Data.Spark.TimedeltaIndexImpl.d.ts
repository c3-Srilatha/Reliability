// TypeScript definitions for the C3 type Data.Spark.TimedeltaIndexImpl
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Data.Spark.TimedeltaIndexImpl
 */
declare namespace Data.Spark {
  export interface ITimedeltaIndexImpl {
 ...
 * See the interface {@link Data.Spark.Index} for declared APIs
 *
 * @remarks this represents a made instance of Data.Spark.TimedeltaIndexImpl
 */
declare namespace Data.Spark {
  export class TimedeltaIndexImpl extends Obj {
    ...
    withEngine(engine: IData.ExecutionEngine | null): Data.Spark.TimedeltaIndexImpl;

    /**
     * The plan that used to actualize this Data.Spark instance
     */
    pipeline?: PipelineSpec | null;
    withPipeline(pipeline: IPipelineSpec | null): Data.Spark.TimedeltaIndexImpl;

    /**
     * The id number that represent this Data.Spark instance
     */
    nodeId?: string | null;
    withNodeId(nodeId: string | null): Data.Spark.TimedeltaIndexImpl;

    /**
     * The output name of the pipeline
     */
    outputId?: string | null;
    withOutputId(outputId: string | null): Data.Spark.TimedeltaIndexImpl;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.Spark.TimedeltaIndexImpl | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.Spark.TimedeltaIndexImpl | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.Spark.TimedeltaIndexImpl | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.Spark.TimedeltaIndexImpl | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.Spark.TimedeltaIndexImpl;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Spark.TimedeltaIndexImpl;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Spark.TimedeltaIndexImpl;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Spark.TimedeltaIndexImpl | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Spark.TimedeltaIndexImpl | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.Spark.TimedeltaIndexImpl;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Spark.TimedeltaIndexImpl;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Spark.TimedeltaIndexImpl;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.Spark.TimedeltaIndexImpl;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.Spark.TimedeltaIndexImpl;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.Spark.TimedeltaIndexImpl;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.Spark.TimedeltaIndexImpl;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.Spark.TimedeltaIndexImpl;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.Spark.TimedeltaIndexImpl;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.Spark.TimedeltaIndexImpl;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.Spark.TimedeltaIndexImpl;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.Spark.TimedeltaIndexImpl;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.Spark.TimedeltaIndexImpl;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.Spark.TimedeltaIndexImpl;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.Spark.TimedeltaIndexImpl;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.Spark.TimedeltaIndexImpl;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.Spark.TimedeltaIndexImpl;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.Spark.TimedeltaIndexImpl;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.Spark.TimedeltaIndexImpl;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.Spark.TimedeltaIndexImpl;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.Spark.TimedeltaIndexImpl;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.Spark.TimedeltaIndexImpl;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.Spark.TimedeltaIndexImpl;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.Spark.TimedeltaIndexImpl;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.Spark.TimedeltaIndexImpl;

    mergeJson(json: any | null): Data.Spark.TimedeltaIndexImpl;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.Spark.TimedeltaIndexImpl;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.Spark.TimedeltaIndexImpl;
     ...
     */
    singletonArray(): C3.Array<Data.Spark.TimedeltaIndexImpl | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.Spark.TimedeltaIndexImpl | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.Spark.TimedeltaIndexImpl | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.Spark.TimedeltaIndexImpl | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.Spark.TimedeltaIndexImpl | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.Spark.TimedeltaIndexImpl | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.Spark.TimedeltaIndexImpl | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.Spark.TimedeltaIndexImpl | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.Spark.TimedeltaIndexImpl | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.Spark.TimedeltaIndexImpl;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.Spark.TimedeltaIndexImpl;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.Spark.TimedeltaIndexImpl;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.Spark.TimedeltaIndexImpl;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.Spark.TimedeltaIndexImpl;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.Spark.TimedeltaIndexImpl;

    /**
     * Construct an instance with initial state.
     */
    static make(): Data.Spark.TimedeltaIndexImpl;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.Spark.TimedeltaIndexImpl;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Data.Spark.TimedeltaIndexImpl;
     ...
     */
    static cachedEmptyInst(): Data.Spark.TimedeltaIndexImpl;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.Spark.TimedeltaIndexImpl>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.Spark.TimedeltaIndexImpl;
     ...
     * @return this Obj
     */
    setField(field: string, value: any, doNotConvert?: boolean): Data.Spark.TimedeltaIndexImpl;
     ...
     * @return this Obj
     */
    setField(field: FieldType, value: any, doNotConvert?: boolean): Data.Spark.TimedeltaIndexImpl;
