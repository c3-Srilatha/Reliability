// TypeScript definitions for the C3 type DataPartitionBucketValue

/**
 * Holds in memory encoded content for the given bucket
 *
 * @remarks this represents a value passed to a method that expects an instance of DataPartitionBucketValue
 */
declare interface IDataPartitionBucketValue {
 ...
 * Holds in memory encoded content for the given bucket
 *
 * @remarks this represents a made instance of DataPartitionBucketValue
 */
declare class DataPartitionBucketValue extends Obj {
  ...
  withId(id: string | null): DataPartitionBucketValue;
  ...
  withContentEncoding(contentEncoding: string | null): DataPartitionBucketValue;
  ...
  withContentLanguage(contentLanguage: string | null): DataPartitionBucketValue;
  ...
  withContentLength(contentLength: number | null): DataPartitionBucketValue;
  ...
  withContentLocation(contentLocation: string | null): DataPartitionBucketValue;
  ...
  withContentType(contentType: string | null): DataPartitionBucketValue;
  ...
  withContentDisposition(contentDisposition: string | null): DataPartitionBucketValue;
  ...
  withETag(eTag: string | null): DataPartitionBucketValue;
  ...
  withLastModified(lastModified: DateTime | Date | string | null): DataPartitionBucketValue;

  /**
   * Id of user / identity who last last modified this content.
   */
  readonly lastModifiedBy?: string | null;
  withLastModifiedBy(lastModifiedBy: string | null): DataPartitionBucketValue;
  ...
  withContentMD5(contentMD5: string | null): DataPartitionBucketValue;
  ...
  withContentSHA1(contentSHA1: string | null): DataPartitionBucketValue;

  /**
   * Partition key for this partition
   */
  readonly partitionKey: string;
  withPartitionKey(partitionKey: string): DataPartitionBucketValue;
  ...
  withSerType(serType: IType | null): DataPartitionBucketValue;
  ...
  withMinSortKey(minSortKey: C3.Array<any> | Array<any>): DataPartitionBucketValue;
  ...
  withMaxSortKey(maxSortKey: C3.Array<any> | Array<any>): DataPartitionBucketValue;

  /**
   * Count of objs in this partition
   */
  readonly count: number;
  withCount(count: number): DataPartitionBucketValue;

  /**
   * The actual content value.
   */
  readonly encodedContent?: any | null;
  withEncodedContent(encodedContent: any | null): DataPartitionBucketValue;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): DataPartitionBucketValue | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): DataPartitionBucketValue | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): DataPartitionBucketValue | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): DataPartitionBucketValue | null;
   ...
   */
  replaceType(old: Type, new_: Type): DataPartitionBucketValue;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataPartitionBucketValue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataPartitionBucketValue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataPartitionBucketValue | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataPartitionBucketValue | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataPartitionBucketValue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataPartitionBucketValue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataPartitionBucketValue;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DataPartitionBucketValue;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DataPartitionBucketValue;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DataPartitionBucketValue;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataPartitionBucketValue;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataPartitionBucketValue;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DataPartitionBucketValue;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): DataPartitionBucketValue;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): DataPartitionBucketValue;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): DataPartitionBucketValue;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataPartitionBucketValue;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DataPartitionBucketValue;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataPartitionBucketValue;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DataPartitionBucketValue;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DataPartitionBucketValue;
   ...
   * @see #removeField
   */
  unsetField(field: string): DataPartitionBucketValue;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DataPartitionBucketValue;
   ...
   * @see #unsetField
   */
  removeField(field: string): DataPartitionBucketValue;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DataPartitionBucketValue;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataPartitionBucketValue;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): DataPartitionBucketValue;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataPartitionBucketValue;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataPartitionBucketValue;

  mergeJson(json: any | null): DataPartitionBucketValue;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataPartitionBucketValue;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): DataPartitionBucketValue;
   ...
   */
  singletonArray(): C3.Array<DataPartitionBucketValue | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<DataPartitionBucketValue | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DataPartitionBucketValue | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<DataPartitionBucketValue | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DataPartitionBucketValue | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, DataPartitionBucketValue | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataPartitionBucketValue | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DataPartitionBucketValue | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DataPartitionBucketValue | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DataPartitionBucketValue;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DataPartitionBucketValue;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DataPartitionBucketValue;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DataPartitionBucketValue;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DataPartitionBucketValue;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DataPartitionBucketValue;
   ...
   * @see #fromString
   */
  static make(s: string | null): DataPartitionBucketValue | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DataPartitionBucketValue;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): DataPartitionBucketValue;
   ...
   */
  static cachedEmptyInst(): DataPartitionBucketValue;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DataPartitionBucketValue>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): DataPartitionBucketValue;
   ...
   * @see #toString
   */
  static fromString(s: string | null): DataPartitionBucketValue | null;
   ...
   */
  withFileName(fileName: string | null): DataPartitionBucketValue;

  /**
   * Changes file extension in this instance.
   */
  withFileExt(fileExt: string | null): DataPartitionBucketValue;
   ...
   */
  identify(suffix?: string | null): DataPartitionBucketValue;
