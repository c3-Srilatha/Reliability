// TypeScript definitions for the C3 type HealthCheckConfig

/**
 * Configuration for each HealthCheck implementation type.
 *
 * @see HealthCheck
 *
 * @remarks this represents a value passed to a method that expects an instance of HealthCheckConfig
 */
declare interface IHealthCheckConfig {
  ...
  /**
   * If disabled, the health check result will always have the `DISABLED` status.
   *
  ...
  /**
   * Minimum poling interval in seconds
   */
 ...
 * @see HealthCheck
 *
 * @remarks this represents a made instance of HealthCheckConfig
 */
declare class HealthCheckConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): HealthCheckConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): HealthCheckConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): HealthCheckConfig;
  ...
  withDisabled(disabled: boolean): HealthCheckConfig;

  /**
   * Minimum poling interval in seconds
   */
  readonly pollingIntervalSec?: number | null;
  withPollingIntervalSec(pollingIntervalSec: number | null): HealthCheckConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): HealthCheckConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): HealthCheckConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): HealthCheckConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): HealthCheckConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): HealthCheckConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HealthCheckConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HealthCheckConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HealthCheckConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HealthCheckConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): HealthCheckConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HealthCheckConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HealthCheckConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): HealthCheckConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): HealthCheckConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): HealthCheckConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): HealthCheckConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): HealthCheckConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): HealthCheckConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): HealthCheckConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): HealthCheckConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): HealthCheckConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): HealthCheckConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): HealthCheckConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): HealthCheckConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): HealthCheckConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): HealthCheckConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): HealthCheckConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): HealthCheckConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): HealthCheckConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): HealthCheckConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): HealthCheckConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): HealthCheckConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): HealthCheckConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): HealthCheckConfig;

  mergeJson(json: any | null): HealthCheckConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): HealthCheckConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): HealthCheckConfig;
   ...
   */
  singletonArray(): C3.Array<HealthCheckConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<HealthCheckConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<HealthCheckConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<HealthCheckConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<HealthCheckConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, HealthCheckConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, HealthCheckConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<HealthCheckConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<HealthCheckConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): HealthCheckConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): HealthCheckConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): HealthCheckConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): HealthCheckConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): HealthCheckConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): HealthCheckConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): HealthCheckConfig;
   ...
   */
  static cachedEmptyInst(): HealthCheckConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<HealthCheckConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): HealthCheckConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<HealthCheckConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<HealthCheckConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<HealthCheckConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): HealthCheckConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): HealthCheckConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): HealthCheckConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): HealthCheckConfig | null;
   ...
   */
  static produce(key: string): HealthCheckConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, HealthCheckConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, HealthCheckConfig | null>;
   ...
   */
  static forConfigKey(configKey: string | null): HealthCheckConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<HealthCheckConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: HealthCheckConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: HealthCheckConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): HealthCheckConfig | null;
