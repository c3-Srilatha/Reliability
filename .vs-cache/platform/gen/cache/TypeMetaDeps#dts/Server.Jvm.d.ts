// TypeScript definitions for the C3 type Server.Jvm

/**
 * @remarks this represents a value passed to a method that expects an instance of Server.Jvm
 */
...
/**
 * @remarks this represents a made instance of Server.Jvm
 */
declare namespace Server {
  export class Jvm extends Obj {

    readonly server: Server;
    withServer(server: IServer): Server.Jvm;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Server.Jvm | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Server.Jvm | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Server.Jvm | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Server.Jvm | null;
     ...
     */
    replaceType(old: Type, new_: Type): Server.Jvm;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Server.Jvm;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Server.Jvm;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Server.Jvm;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Server.Jvm;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Server.Jvm;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Server.Jvm | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Server.Jvm | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Server.Jvm | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Server.Jvm | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Server.Jvm;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Server.Jvm;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Server.Jvm;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Server.Jvm;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Server.Jvm;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Server.Jvm;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Server.Jvm;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Server.Jvm;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Server.Jvm;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Server.Jvm;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Server.Jvm;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Server.Jvm;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Server.Jvm;
     ...
     * @return new Obj
     */
    static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Server.Jvm;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Server.Jvm;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Server.Jvm;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Server.Jvm;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Server.Jvm;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Server.Jvm;
     ...
     * @see #removeField
     */
    static withoutField(field: string | null): Server.Jvm;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Server.Jvm;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType | null): Server.Jvm;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Server.Jvm;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: C3.Array<string | null> | null): Server.Jvm;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Server.Jvm;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Server.Jvm;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Server.Jvm;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Server.Jvm;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Server.Jvm;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Server.Jvm;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Server.Jvm;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Server.Jvm;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Server.Jvm;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Server.Jvm;
     ...
     * @see #removeField
     */
    unsetField(field: string): Server.Jvm;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Server.Jvm;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Server.Jvm;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Server.Jvm;
     ...
     * @see #unsetField
     */
    removeField(field: string): Server.Jvm;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Server.Jvm;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Server.Jvm;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Server.Jvm;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Server.Jvm;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Server.Jvm;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Server.Jvm;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj | null, otherFieldsFilter: Type): Server.Jvm;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Server.Jvm;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Server.Jvm;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Server.Jvm;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Server.Jvm;

    mergeJson(json: any | null): Server.Jvm;

    static mergeJson(json: any | null): Server.Jvm;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Server.Jvm;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Server.Jvm;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Server.Jvm;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj | null, deep?: boolean): Server.Jvm;
     ...
     */
    singletonArray(): C3.Array<Server.Jvm | null>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): C3.Array<Server.Jvm | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Server.Jvm | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Server.Jvm | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Server.Jvm | null>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): C3.Set<Server.Jvm | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Server.Jvm | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Server.Jvm | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Server.Jvm | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Server.Jvm | null>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Server.Jvm | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Server.Jvm | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Server.Jvm;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Server.Jvm;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Server.Jvm;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Server.Jvm;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Server.Jvm;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Server.Jvm;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Server.Jvm;
     ...
     */
    static cachedEmptyInst(): Server.Jvm;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Server.Jvm>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Server.Jvm;
