// TypeScript definitions for the C3 type UpsertSpec
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of UpsertSpec
 */
declare interface IUpsertSpec {
 ...
 */
declare class UpsertSpec extends Obj {

  /**
   * Specifies various parameters for automatic retry that occurs in upsert due to retryable errors.
   */
  readonly retrySpec?: RetrySpec | null;
  withRetrySpec(retrySpec: IRetrySpec | null): UpsertSpec;
  ...
  withForceAsyncCalcFieldRefresh(forceAsyncCalcFieldRefresh: boolean): UpsertSpec;
  ...
  withCalcFieldsBeingRefreshed(calcFieldsBeingRefreshed: C3.Array<string | null> | Array<string | null>): UpsertSpec;

  /**
   * For large batches of input obs, they will be committed to the database in batches of this size.
   */
  readonly commitSize?: number | null;
  withCommitSize(commitSize: number | null): UpsertSpec;
  ...
  withMetaOverride(metaOverride: boolean): UpsertSpec;
  ...
  withDisableAsyncProcessing(disableAsyncProcessing: boolean): UpsertSpec;
  ...
  withDisableBeforeCallbacks(disableBeforeCallbacks: boolean): UpsertSpec;
  ...
  withDisableAfterCallbacks(disableAfterCallbacks: boolean): UpsertSpec;
  ...
  withInclude(include: string | null): UpsertSpec;
  ...
  withReturnInclude(returnInclude: string | null): UpsertSpec;
  ...
  withIgnoreDuplicates(ignoreDuplicates: boolean): UpsertSpec;
  ...
  withForceUserUpdate(forceUserUpdate: boolean): UpsertSpec;
  ...
  withIgnoreSeed(ignoreSeed: boolean): UpsertSpec;
  ...
  withDontThrowOnBatchError(dontThrowOnBatchError: boolean): UpsertSpec;
  ...
  withCreateDirect(createDirect: boolean): UpsertSpec;

  /**
   * Indicates that the upsert request should not attempt to dedup incoming input.
   */
  readonly noHistoryDedup?: boolean;
  withNoHistoryDedup(noHistoryDedup: boolean): UpsertSpec;

  /**
   * Indicates which parent field should be used for deduping timed relations.
   */
  readonly timedRelationParentField?: string | null;
  withTimedRelationParentField(timedRelationParentField: string | null): UpsertSpec;
  ...
  withSaveVersion(saveVersion: boolean): UpsertSpec;

  /**
   * If true and the backing datastore supports it, conflicts on create will be ignored.
   */
  readonly ignoreCreateConflicts?: boolean;
  withIgnoreCreateConflicts(ignoreCreateConflicts: boolean): UpsertSpec;
  ...
  withForceTouch(forceTouch: boolean): UpsertSpec;
  ...
  withStmtTimeoutMs(stmtTimeoutMs: number | null): UpsertSpec;
  ...
  withIdempotent(idempotent: boolean): UpsertSpec;
  ...
  withStrictVersionCheck(strictVersionCheck: boolean): UpsertSpec;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): UpsertSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): UpsertSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): UpsertSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): UpsertSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): UpsertSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UpsertSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): UpsertSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UpsertSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<UpsertSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): UpsertSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UpsertSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): UpsertSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): UpsertSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): UpsertSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): UpsertSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): UpsertSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): UpsertSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): UpsertSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): UpsertSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): UpsertSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): UpsertSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): UpsertSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): UpsertSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): UpsertSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): UpsertSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): UpsertSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): UpsertSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): UpsertSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): UpsertSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): UpsertSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): UpsertSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): UpsertSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): UpsertSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): UpsertSpec;

  mergeJson(json: any | null): UpsertSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): UpsertSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): UpsertSpec;
   ...
   */
  singletonArray(): C3.Array<UpsertSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<UpsertSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<UpsertSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<UpsertSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<UpsertSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, UpsertSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, UpsertSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<UpsertSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<UpsertSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): UpsertSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): UpsertSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): UpsertSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): UpsertSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): UpsertSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): UpsertSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): UpsertSpec;
   ...
   */
  static cachedEmptyInst(): UpsertSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<UpsertSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): UpsertSpec;

  /**
   * @return new instance of this spec with `retrySpec` set
   */
  withRetry(maxRetries?: number | null, initialSleepMillis?: number | null, exponent?: number | null): UpsertSpec | null;

  /**
   * @return instance of this spec with `retrySpec`'s `maxTotalMillis` set
   */
  static timeoutSeconds(secs: number | null): UpsertSpec;
}
