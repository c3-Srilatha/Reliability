// TypeScript definitions for the C3 type SourceCollection
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of SourceCollection
 */
declare interface ISourceCollection<C> {
 ...
 */
declare class SourceCollection<C> extends Obj {

  /**
   * The description of this instance.
   */
  readonly description?: string | null;
  withDescription(description: string | null): SourceCollection;
  ...
  withCdcOrder(cdcOrder: string | null): SourceCollection;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): SourceCollection;

  /**
   * The unique and required name of this instance.
   */
  readonly name: string;
  withName(name: string): SourceCollection;

  /**
   * Structure defined to serialize the content from the SourceCollection {@see Source}
   */
  readonly source?: Type | null;
  withSource(source: IType | null): SourceCollection;

  /**
   * Source system for the source collection
   */
  readonly sourceSystem: SourceSystem<SourceSystem.Config | null, any>;
  withSourceSystem(sourceSystem: ISourceSystem<SourceSystem.Config | null, any>): SourceCollection;
  ...
  withExternal(external: boolean): SourceCollection;
  ...
  withSequential(sequential: boolean): SourceCollection;

  /**
   * Indicator of whether this instance is currently being configured
   */
  readonly state?: string | null;
  withState(state: string | null): SourceCollection;
  ...
  withAfterProcess(afterProcess: ILambda<λBiConsumer<SourceCollection<SourceCollection.Config | null> | null, Sources | null> | null> | null): SourceCollection;

  /**
   * List of transforms to skip for SourceCollection.
   */
  readonly skippedTransforms?: C3.Array<string | null>;
  withSkippedTransforms(skippedTransforms: C3.Array<string | null> | Array<string | null>): SourceCollection;
  ...
  withPatchObjsOperSpec(patchObjsOperSpec: λFunction<Content | null, IFileObjsOperSpec | null> | null): SourceCollection;
  ...
  withCdcSourcesOverride(cdcSourcesOverride: ILambda<λFunction<SourceCollection.Cdc.Checkpoint | null, Stream<Source | null>> | null> | null): SourceCollection;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SourceCollection<C> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SourceCollection<C> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SourceCollection<C> | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SourceCollection<C> | null;
   ...
   */
  replaceType(old: Type, new_: Type): SourceCollection<C>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SourceCollection<C>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SourceCollection<C>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SourceCollection<C> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SourceCollection<C> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SourceCollection<C>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SourceCollection<C>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SourceCollection<C>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SourceCollection<C>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SourceCollection<C>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SourceCollection<C>;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SourceCollection<C>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SourceCollection<C>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SourceCollection<C>;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SourceCollection<C>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SourceCollection<C>;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SourceCollection<C>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SourceCollection<C>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SourceCollection<C>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SourceCollection<C>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SourceCollection<C>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SourceCollection<C>;
   ...
   * @see #removeField
   */
  unsetField(field: string): SourceCollection<C>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SourceCollection<C>;
   ...
   * @see #unsetField
   */
  removeField(field: string): SourceCollection<C>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SourceCollection<C>;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SourceCollection<C>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SourceCollection<C>;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SourceCollection<C>;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SourceCollection<C>;

  mergeJson(json: any | null): SourceCollection<C>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SourceCollection<C>;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SourceCollection<C>;
   ...
   */
  singletonArray(): C3.Array<SourceCollection<C> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SourceCollection<C> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SourceCollection<C> | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SourceCollection<C> | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SourceCollection<C> | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SourceCollection<C> | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SourceCollection<C> | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SourceCollection<C> | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SourceCollection<C> | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SourceCollection<C>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SourceCollection<C>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SourceCollection<C>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SourceCollection<C>;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SourceCollection<C>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SourceCollection<C>;
   ...
   * @see #fromString
   */
  static make(s: string | null): SourceCollection<C> | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SourceCollection<C>;
   ...
   */
  static cachedEmptyInst(): SourceCollection<C>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SourceCollection<C>>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SourceCollection<C>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<SourceCollection<C> | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SourceCollection<C> | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<SourceCollection<C> | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<SourceCollection<C> | null> | null>;
  ...
  save(subPath?: string | null, contentType?: string | null): SourceCollection<C>;
  ...
  update(srcObj?: SourceCollection<C> | null, spec?: UpsertSpec | null): SourceCollection<C> | null;

  upsert(srcObj?: SourceCollection<C> | null, spec?: UpsertSpec | null): SourceCollection<C> | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): SourceCollection<C> | null;
   ...
   */
  static forName(name: string | null, failIfMissing?: boolean): SourceCollection<C> | null;
   ...
   */
  static collectionsForSourceType(sourceType: Type, include?: string | null): Stream<SourceCollection<C> | null>;
   ...
   */
  setPriority(priority: number): SourceCollection<C>;

  /**
   * @return SourceCollection after clearing the priority
   */
  clearPriority(): SourceCollection<C>;
   ...
   */
  skipTransform(transformId?: string | null): SourceCollection<C>;

  /**
   * skip #transform for the source collection.
   */
  skipTransformBatch(transformIds: C3.Array<string | null> | null): SourceCollection<C>;

  /**
   * skip #transform for the source collection.
   */
  clearSkippedTransforms(transformsId: C3.Array<string | null> | null): SourceCollection<C>;

  /**
   * skip #transform for the source collection.
   */
  clearAllSkippedTransforms(): SourceCollection<C>;
