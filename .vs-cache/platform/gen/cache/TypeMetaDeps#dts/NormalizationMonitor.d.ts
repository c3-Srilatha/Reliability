// TypeScript definitions for the C3 type NormalizationMonitor

/**
 * @remarks this represents a value passed to a method that expects an instance of NormalizationMonitor
 */
declare interface INormalizationMonitor {

  dequeueFilter?: string | null;
...
/**
 * @remarks this represents a made instance of NormalizationMonitor
 */
declare class NormalizationMonitor extends Obj {

  readonly dequeueFilter?: string | null;
  withDequeueFilter(dequeueFilter: string | null): NormalizationMonitor;

  readonly typeName: string;
  withTypeName(typeName: string): NormalizationMonitor;
   ...
   */
  readonly id: string;
  withId(id: string): NormalizationMonitor;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): NormalizationMonitor;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): NormalizationMonitor;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): NormalizationMonitor;
  ...
  withVersion(version: number | null): NormalizationMonitor;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): NormalizationMonitor;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): NormalizationMonitor | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): NormalizationMonitor | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): NormalizationMonitor | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): NormalizationMonitor | null;
   ...
   */
  replaceType(old: Type, new_: Type): NormalizationMonitor;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NormalizationMonitor;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NormalizationMonitor;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NormalizationMonitor | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NormalizationMonitor | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): NormalizationMonitor;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NormalizationMonitor;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NormalizationMonitor;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): NormalizationMonitor;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): NormalizationMonitor;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): NormalizationMonitor;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): NormalizationMonitor;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): NormalizationMonitor;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): NormalizationMonitor;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): NormalizationMonitor;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): NormalizationMonitor;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): NormalizationMonitor;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): NormalizationMonitor;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): NormalizationMonitor;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): NormalizationMonitor;
   ...
   * @see #unsetField
   */
  defaultField(field: string): NormalizationMonitor;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): NormalizationMonitor;
   ...
   * @see #removeField
   */
  unsetField(field: string): NormalizationMonitor;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): NormalizationMonitor;
   ...
   * @see #unsetField
   */
  removeField(field: string): NormalizationMonitor;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): NormalizationMonitor;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): NormalizationMonitor;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): NormalizationMonitor;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): NormalizationMonitor;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): NormalizationMonitor;

  mergeJson(json: any | null): NormalizationMonitor;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): NormalizationMonitor;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): NormalizationMonitor;
   ...
   */
  singletonArray(): C3.Array<NormalizationMonitor | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<NormalizationMonitor | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<NormalizationMonitor | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<NormalizationMonitor | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<NormalizationMonitor | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, NormalizationMonitor | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, NormalizationMonitor | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<NormalizationMonitor | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<NormalizationMonitor | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): NormalizationMonitor;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): NormalizationMonitor;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): NormalizationMonitor;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): NormalizationMonitor;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): NormalizationMonitor;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): NormalizationMonitor;
   ...
   * @see #fromString
   */
  static make(s: string | null): NormalizationMonitor | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): NormalizationMonitor;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): NormalizationMonitor;
   ...
   */
  static cachedEmptyInst(): NormalizationMonitor;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<NormalizationMonitor>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): NormalizationMonitor;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<NormalizationMonitor | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<NormalizationMonitor | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<NormalizationMonitor | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<NormalizationMonitor | null> | null>;
   ...
   */
  get(include?: string | null): NormalizationMonitor | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): NormalizationMonitor | null;
   ...
   */
  getMissing(spec: GetMissingSpec): NormalizationMonitor;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): NormalizationMonitor | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): NormalizationMonitor;
   ...
   * @see #toString
   */
  static fromString(s: string | null): NormalizationMonitor | null;
   ...
   */
  create(spec?: UpsertSpec | null): NormalizationMonitor | null;
   ...
   */
  static createBatch(objs: C3.Array<NormalizationMonitor | null> | null, spec?: UpsertSpec | null): ObjList<NormalizationMonitor | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<NormalizationMonitor | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<NormalizationMonitor | null> | null;
   ...
   */
  update(srcObj?: NormalizationMonitor | null, spec?: UpsertSpec | null): NormalizationMonitor | null;
   ...
   */
  upsert(srcObj?: NormalizationMonitor | null, spec?: UpsertSpec | null): NormalizationMonitor | null;
   ...
   */
  merge(spec?: MergeSpec | null): NormalizationMonitor | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): NormalizationMonitor | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): NormalizationMonitor | null;
   ...
   */
  static updateBatch(objs: C3.Array<NormalizationMonitor | null> | null, srcObjs?: C3.Array<NormalizationMonitor | null>, spec?: UpsertSpec | null): ObjList<NormalizationMonitor | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<NormalizationMonitor | null>>, spec?: UpsertSpec | null): ObjList<NormalizationMonitor | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<NormalizationMonitor | null> | null, srcObjs?: C3.Array<NormalizationMonitor | null>, spec?: UpsertSpec | null): ObjList<NormalizationMonitor | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<NormalizationMonitor | null>>, spec?: UpsertSpec | null): ObjList<NormalizationMonitor | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<NormalizationMonitor | null> | null, spec?: TouchSpec | null): ObjList<NormalizationMonitor | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<NormalizationMonitor | null> | null, spec?: MergeSpec | null): ObjList<NormalizationMonitor | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<NormalizationMonitor | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<NormalizationMonitor | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<NormalizationMonitor | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<NormalizationMonitor | null> | null;
   ...
   */
  static mergeAll(mergeObj: NormalizationMonitor | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: NormalizationMonitor | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<NormalizationMonitor | null> | null, spec?: UpsertSpec | null): ObjList<NormalizationMonitor | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<NormalizationMonitor | null> | null, spec?: UpsertSpec | null): ObjList<NormalizationMonitor | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): NormalizationMonitor | null;
   ...
   */
  static beforeCreate(objs: C3.Array<NormalizationMonitor | null> | null): ObjList<NormalizationMonitor | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<NormalizationMonitor | null> | null): ObjList<NormalizationMonitor | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<NormalizationMonitor | null> | null): ObjList<NormalizationMonitor | null>;
   ...
   */
  static afterCreate(objs: C3.Array<NormalizationMonitor | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<NormalizationMonitor | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<NormalizationMonitor | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<NormalizationMonitor | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<NormalizationMonitor | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): NormalizationMonitor | null;
   ...
   */
  withoutIdentity(): NormalizationMonitor | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<NormalizationMonitor | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: NormalizationMonitor | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<NormalizationMonitor | null> | null, callback?: λFunction<NormalizationMonitor | null, NormalizationMonitor | null> | null): ObjList<NormalizationMonitor | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<NormalizationMonitor | null> | null, callback?: λFunction<NormalizationMonitor | null, NormalizationMonitor | null> | null): C3.Array<ObjError | null>;
