// TypeScript definitions for the C3 type HttpsFileSystem

/**
 * Represents a HTTP based file system.
 *
 * @remarks this represents a value passed to a method that expects an instance of HttpsFileSystem
 */
declare interface IHttpsFileSystem {
 ...
 * Represents a HTTP based file system.
 *
 * @remarks this represents a made instance of HttpsFileSystem
 */
declare class HttpsFileSystem extends Obj {

  /**
   * Optional root OS folder to limit access to files.
   */
  readonly root?: string | null;
  withRoot(root: string | null): HttpsFileSystem;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): HttpsFileSystem | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): HttpsFileSystem | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): HttpsFileSystem | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): HttpsFileSystem | null;
   ...
   */
  replaceType(old: Type, new_: Type): HttpsFileSystem;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): HttpsFileSystem;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HttpsFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HttpsFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HttpsFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HttpsFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HttpsFileSystem | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HttpsFileSystem | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HttpsFileSystem | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HttpsFileSystem | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): HttpsFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): HttpsFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HttpsFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HttpsFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HttpsFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HttpsFileSystem;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): HttpsFileSystem;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): HttpsFileSystem;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): HttpsFileSystem;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): HttpsFileSystem;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): HttpsFileSystem;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): HttpsFileSystem;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): HttpsFileSystem;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): HttpsFileSystem;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): HttpsFileSystem;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): HttpsFileSystem;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): HttpsFileSystem;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): HttpsFileSystem;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): HttpsFileSystem;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): HttpsFileSystem;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): HttpsFileSystem;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): HttpsFileSystem;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): HttpsFileSystem;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): HttpsFileSystem;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): HttpsFileSystem;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): HttpsFileSystem;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): HttpsFileSystem;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): HttpsFileSystem;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): HttpsFileSystem;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): HttpsFileSystem;
   ...
   * @see #unsetField
   */
  defaultField(field: string): HttpsFileSystem;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): HttpsFileSystem;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): HttpsFileSystem;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): HttpsFileSystem;
   ...
   * @see #removeField
   */
  unsetField(field: string): HttpsFileSystem;
   ...
   * @see #removeField
   */
  static unsetField(field: string): HttpsFileSystem;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): HttpsFileSystem;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): HttpsFileSystem;
   ...
   * @see #unsetField
   */
  removeField(field: string): HttpsFileSystem;
   ...
   * @see #unsetField
   */
  static removeField(field: string): HttpsFileSystem;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): HttpsFileSystem;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): HttpsFileSystem;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): HttpsFileSystem;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): HttpsFileSystem;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): HttpsFileSystem;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): HttpsFileSystem;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): HttpsFileSystem;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): HttpsFileSystem;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): HttpsFileSystem;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): HttpsFileSystem;

  mergeJson(json: any | null): HttpsFileSystem;

  static mergeJson(json: any | null): HttpsFileSystem;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): HttpsFileSystem;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): HttpsFileSystem;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): HttpsFileSystem;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): HttpsFileSystem;
   ...
   */
  singletonArray(): C3.Array<HttpsFileSystem | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<HttpsFileSystem | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<HttpsFileSystem | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<HttpsFileSystem | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<HttpsFileSystem | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<HttpsFileSystem | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<HttpsFileSystem | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, HttpsFileSystem | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, HttpsFileSystem | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<HttpsFileSystem | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<HttpsFileSystem | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<HttpsFileSystem | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): HttpsFileSystem;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): HttpsFileSystem;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): HttpsFileSystem;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): HttpsFileSystem;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): HttpsFileSystem;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): HttpsFileSystem;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): HttpsFileSystem;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): HttpsFileSystem;
   ...
   */
  static cachedEmptyInst(): HttpsFileSystem;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<HttpsFileSystem>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): HttpsFileSystem;
   ...
   */
  config(secrets?: boolean): HttpFsConfig;

  /**
   * Returns cached configuration object for instance of this file system.
   */
  static config(secrets?: boolean): HttpFsConfig;
}
