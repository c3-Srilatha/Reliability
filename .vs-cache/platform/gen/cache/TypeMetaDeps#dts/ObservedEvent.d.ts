// TypeScript definitions for the C3 type ObservedEvent

/**
 * Event that is happened at some point of time.
 *
 * @remarks this represents a value passed to a method that expects an instance of ObservedEvent
 */
declare interface IObservedEvent {
  ...
  /**
   * Event that should be predicted in this window.
   */
 ...
 * Event that is happened at some point of time.
 *
 * @remarks this represents a made instance of ObservedEvent
 */
declare class ObservedEvent extends Obj {
  ...
  withTypeIdent(typeIdent: string | null): ObservedEvent;
   ...
   */
  readonly id: string;
  withId(id: string): ObservedEvent;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): ObservedEvent;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): ObservedEvent;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): ObservedEvent;
  ...
  withVersion(version: number | null): ObservedEvent;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): ObservedEvent;

  /**
   * Type of this event.
   */
  readonly eventType?: string | null;
  withEventType(eventType: string | null): ObservedEvent;

  /**
   * Event that should be predicted in this window.
   */
  readonly timestamp?: DateTime | null;
  withTimestamp(timestamp: DateTime | Date | string | null): ObservedEvent;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ObservedEvent | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ObservedEvent | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ObservedEvent | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ObservedEvent | null;
   ...
   */
  replaceType(old: Type, new_: Type): ObservedEvent;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ObservedEvent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ObservedEvent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ObservedEvent | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ObservedEvent | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ObservedEvent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ObservedEvent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ObservedEvent;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ObservedEvent;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ObservedEvent;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ObservedEvent;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ObservedEvent;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ObservedEvent;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ObservedEvent;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ObservedEvent;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ObservedEvent;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ObservedEvent;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ObservedEvent;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ObservedEvent;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ObservedEvent;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ObservedEvent;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ObservedEvent;
   ...
   * @see #removeField
   */
  unsetField(field: string): ObservedEvent;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ObservedEvent;
   ...
   * @see #unsetField
   */
  removeField(field: string): ObservedEvent;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ObservedEvent;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ObservedEvent;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ObservedEvent;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ObservedEvent;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ObservedEvent;

  mergeJson(json: any | null): ObservedEvent;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ObservedEvent;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ObservedEvent;
   ...
   */
  singletonArray(): C3.Array<ObservedEvent | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ObservedEvent | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ObservedEvent | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ObservedEvent | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ObservedEvent | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ObservedEvent | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ObservedEvent | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ObservedEvent | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ObservedEvent | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ObservedEvent;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ObservedEvent;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ObservedEvent;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ObservedEvent;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ObservedEvent;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ObservedEvent;
   ...
   * @see #fromString
   */
  static make(s: string | null): ObservedEvent | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ObservedEvent;
   ...
   */
  static cachedEmptyInst(): ObservedEvent;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ObservedEvent>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ObservedEvent;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<ObservedEvent | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ObservedEvent | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<ObservedEvent | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<ObservedEvent | null> | null>;
   ...
   */
  get(include?: string | null): ObservedEvent | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): ObservedEvent | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ObservedEvent;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): ObservedEvent | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ObservedEvent;
   ...
   * @see #toString
   */
  static fromString(s: string | null): ObservedEvent | null;
   ...
   */
  create(spec?: UpsertSpec | null): ObservedEvent | null;
   ...
   */
  static createBatch(objs: C3.Array<ObservedEvent | null> | null, spec?: UpsertSpec | null): ObjList<ObservedEvent | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ObservedEvent | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<ObservedEvent | null> | null;
   ...
   */
  update(srcObj?: ObservedEvent | null, spec?: UpsertSpec | null): ObservedEvent | null;
   ...
   */
  upsert(srcObj?: ObservedEvent | null, spec?: UpsertSpec | null): ObservedEvent | null;
   ...
   */
  merge(spec?: MergeSpec | null): ObservedEvent | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): ObservedEvent | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): ObservedEvent | null;
   ...
   */
  static updateBatch(objs: C3.Array<ObservedEvent | null> | null, srcObjs?: C3.Array<ObservedEvent | null>, spec?: UpsertSpec | null): ObjList<ObservedEvent | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<ObservedEvent | null>>, spec?: UpsertSpec | null): ObjList<ObservedEvent | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<ObservedEvent | null> | null, srcObjs?: C3.Array<ObservedEvent | null>, spec?: UpsertSpec | null): ObjList<ObservedEvent | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<ObservedEvent | null>>, spec?: UpsertSpec | null): ObjList<ObservedEvent | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<ObservedEvent | null> | null, spec?: TouchSpec | null): ObjList<ObservedEvent | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<ObservedEvent | null> | null, spec?: MergeSpec | null): ObjList<ObservedEvent | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<ObservedEvent | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<ObservedEvent | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<ObservedEvent | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<ObservedEvent | null> | null;
   ...
   */
  static mergeAll(mergeObj: ObservedEvent | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ObservedEvent | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<ObservedEvent | null> | null, spec?: UpsertSpec | null): ObjList<ObservedEvent | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<ObservedEvent | null> | null, spec?: UpsertSpec | null): ObjList<ObservedEvent | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<ObservedEvent | null> | null): ObjList<ObservedEvent | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<ObservedEvent | null> | null): ObjList<ObservedEvent | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<ObservedEvent | null> | null): ObjList<ObservedEvent | null>;
   ...
   */
  static afterCreate(objs: C3.Array<ObservedEvent | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<ObservedEvent | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<ObservedEvent | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<ObservedEvent | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<ObservedEvent | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): ObservedEvent | null;
   ...
   */
  withoutIdentity(): ObservedEvent | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<ObservedEvent | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: ObservedEvent | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<ObservedEvent | null> | null, callback?: λFunction<ObservedEvent | null, ObservedEvent | null> | null): ObjList<ObservedEvent | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<ObservedEvent | null> | null, callback?: λFunction<ObservedEvent | null, ObservedEvent | null> | null): C3.Array<ObjError | null>;
