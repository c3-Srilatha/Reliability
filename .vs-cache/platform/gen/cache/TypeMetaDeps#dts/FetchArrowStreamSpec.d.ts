// TypeScript definitions for the C3 type FetchArrowStreamSpec

/**
 * Specification of which Objs to bring back and which fields to bring back in them for a
 * {@link Fetchable#fetchArrowStream} call.
 *
 * @remarks this represents a value passed to a method that expects an instance of FetchArrowStreamSpec
 */
declare interface IFetchArrowStreamSpec {
  ...
  /**
   * Maximum number of rows to include when fetching data from storage and sending to Spark.
   * Suppose user is trying to fetch WindTurbine including WindTurbineMeasurementSeries and
   * WindTurbineMeasurement. Partition size in Spark fetch operation determines how many turbines
   * will be processed in single partition (unit of work for Spark cluster). If user specifies
   * partition size of 1000 then first partition will process first 1000 turbines.
   * Instead of bringing data for all 1000 turbines into
   * memory batchSize parameter will determine how many turbines with measurements are going to be
   * fetched into memory from storage layer and sent to Spark for processing.
   */
  batchSize: number;
}
 ...
 * {@link Fetchable#fetchArrowStream} call.
 *
 * @remarks this represents a made instance of FetchArrowStreamSpec
 */
declare class FetchArrowStreamSpec extends Obj {
  ...
  withOrder(order: string | null): FetchArrowStreamSpec;

  /**
   * Offset to use for paged reads.
   */
  readonly offset?: number | null;
  withOffset(offset: number | null): FetchArrowStreamSpec;
  ...
  withLimit(limit: number | null): FetchArrowStreamSpec;
  ...
  withFilter(filter: string | null): FetchArrowStreamSpec;

  /**
   * Variables values to substitute in filter expression. CURRENTLY UNDER CONSTRUCTION!
   */
  readonly vars?: C3.Map<string | null, Obj | null>;
  withVars(vars: C3.Map<string | null, Obj | null> | {[key: string | null]: IObj | null}): FetchArrowStreamSpec;
  ...
  withFetchHiddenSeedData(fetchHiddenSeedData: boolean): FetchArrowStreamSpec;
  ...
  withExcludeExtensions(excludeExtensions: boolean): FetchArrowStreamSpec;
  ...
  withAsOf(asOf: DateTime | Date | string | null): FetchArrowStreamSpec;
  ...
  withAllowLiteralOnBindVariableOverflow(allowLiteralOnBindVariableOverflow: boolean): FetchArrowStreamSpec;
  ...
  withUseDedicatedConnection(useDedicatedConnection: boolean): FetchArrowStreamSpec;
  ...
  withStmtTimeoutMs(stmtTimeoutMs: number | null): FetchArrowStreamSpec;
  ...
  withDontThrowJsonDeserErrors(dontThrowJsonDeserErrors: boolean): FetchArrowStreamSpec;
  ...
  withTimeRange(timeRange: ITimeRange | null): FetchArrowStreamSpec;
  ...
  withTimedFetchParentField(timedFetchParentField: string | null): FetchArrowStreamSpec;

  readonly includeBaseTypes?: boolean;
  withIncludeBaseTypes(includeBaseTypes: boolean): FetchArrowStreamSpec;
  ...
  withIgnoreViewInclude(ignoreViewInclude: boolean): FetchArrowStreamSpec;
  ...
  withInclude(include: string | null): FetchArrowStreamSpec;
  ...
  withExcludeMeta(excludeMeta: boolean): FetchArrowStreamSpec;
  ...
  withIncludeReadCalcs(includeReadCalcs: boolean): FetchArrowStreamSpec;
  ...
  withRefreshCalcFields(refreshCalcFields: boolean): FetchArrowStreamSpec;
  ...
  withCalcFieldsToRefresh(calcFieldsToRefresh: C3.Array<string | null> | Array<string | null>): FetchArrowStreamSpec;
  ...
  withForceAcl(forceAcl: boolean): FetchArrowStreamSpec;
  ...
  withExplain(explain: boolean): FetchArrowStreamSpec;
  ...
  withValidateOnly(validateOnly: boolean): FetchArrowStreamSpec;
  ...
  withHints(hints: IFetchHints | null): FetchArrowStreamSpec;
  ...
  withUseSecondaryDatastore(useSecondaryDatastore: boolean): FetchArrowStreamSpec;
  ...
  withPreserveArrayIndexes(preserveArrayIndexes: boolean): FetchArrowStreamSpec;
  ...
  withResolveRefTypes(resolveRefTypes: boolean): FetchArrowStreamSpec;
  ...
  withBatchSize(batchSize: number): FetchArrowStreamSpec;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): FetchArrowStreamSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): FetchArrowStreamSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): FetchArrowStreamSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): FetchArrowStreamSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): FetchArrowStreamSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FetchArrowStreamSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FetchArrowStreamSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FetchArrowStreamSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FetchArrowStreamSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): FetchArrowStreamSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FetchArrowStreamSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FetchArrowStreamSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FetchArrowStreamSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FetchArrowStreamSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FetchArrowStreamSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): FetchArrowStreamSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FetchArrowStreamSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FetchArrowStreamSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): FetchArrowStreamSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): FetchArrowStreamSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): FetchArrowStreamSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): FetchArrowStreamSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FetchArrowStreamSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): FetchArrowStreamSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FetchArrowStreamSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FetchArrowStreamSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): FetchArrowStreamSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FetchArrowStreamSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): FetchArrowStreamSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FetchArrowStreamSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): FetchArrowStreamSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): FetchArrowStreamSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): FetchArrowStreamSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): FetchArrowStreamSpec;

  mergeJson(json: any | null): FetchArrowStreamSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): FetchArrowStreamSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): FetchArrowStreamSpec;
   ...
   */
  singletonArray(): C3.Array<FetchArrowStreamSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<FetchArrowStreamSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FetchArrowStreamSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<FetchArrowStreamSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FetchArrowStreamSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, FetchArrowStreamSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FetchArrowStreamSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FetchArrowStreamSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FetchArrowStreamSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): FetchArrowStreamSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): FetchArrowStreamSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): FetchArrowStreamSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FetchArrowStreamSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): FetchArrowStreamSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FetchArrowStreamSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): FetchArrowStreamSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): FetchArrowStreamSpec;
   ...
   */
  static cachedEmptyInst(): FetchArrowStreamSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<FetchArrowStreamSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): FetchArrowStreamSpec;
   ...
   */
  withIdFilter(id: string): FetchArrowStreamSpec | null;
   ...
   * @return updated FetchSpec
   */
  withIdsFilter(ids: C3.Array<string | null> | null): FetchArrowStreamSpec | null;
   ...
   * @return updated FetchSpec
   */
  withIdRangeFilter(startId?: string | null, endId?: string | null): FetchArrowStreamSpec | null;
