// TypeScript definitions for the C3 type HdfsFile

/**
 * Represents the Hdfs file.
 *
 * @remarks this represents a value passed to a method that expects an instance of HdfsFile
 */
declare interface IHdfsFile {
 ...
 * Represents the Hdfs file.
 *
 * @remarks this represents a made instance of HdfsFile
 */
declare class HdfsFile extends Obj {
  ...
  withContentEncoding(contentEncoding: string | null): HdfsFile;
  ...
  withContentLanguage(contentLanguage: string | null): HdfsFile;
  ...
  withContentLength(contentLength: number | null): HdfsFile;
  ...
  withContentLocation(contentLocation: string | null): HdfsFile;
  ...
  withContentType(contentType: string | null): HdfsFile;
  ...
  withContentDisposition(contentDisposition: string | null): HdfsFile;
  ...
  withETag(eTag: string | null): HdfsFile;
  ...
  withLastModified(lastModified: DateTime | Date | string | null): HdfsFile;

  /**
   * Id of user / identity who last last modified this content.
   */
  readonly lastModifiedBy?: string | null;
  withLastModifiedBy(lastModifiedBy: string | null): HdfsFile;
  ...
  withContentMD5(contentMD5: string | null): HdfsFile;
  ...
  withContentSHA1(contentSHA1: string | null): HdfsFile;

  /**
   * Field to maintain state whether content metadata was read or not.
   */
  readonly hasMetadata?: boolean;
  withHasMetadata(hasMetadata: boolean): HdfsFile;

  /**
   * URL for this file that contains scheme (i.e. file-system) and fully qualified encoded path.
   */
  readonly url?: string | null;
  withUrl(url: string | null): HdfsFile;

  /**
   * Custom user-metadata.
   */
  readonly userMetadata?: C3.Map<string | null, string | null>;
  withUserMetadata(userMetadata: C3.Map<string | null, string | null> | {[key: string | null]: string | null}): HdfsFile;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): HdfsFile | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): HdfsFile | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): HdfsFile | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): HdfsFile | null;
   ...
   */
  replaceType(old: Type, new_: Type): HdfsFile;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HdfsFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HdfsFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HdfsFile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HdfsFile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): HdfsFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HdfsFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HdfsFile;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): HdfsFile;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): HdfsFile;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): HdfsFile;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): HdfsFile;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): HdfsFile;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): HdfsFile;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): HdfsFile;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): HdfsFile;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): HdfsFile;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): HdfsFile;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): HdfsFile;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): HdfsFile;
   ...
   * @see #unsetField
   */
  defaultField(field: string): HdfsFile;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): HdfsFile;
   ...
   * @see #removeField
   */
  unsetField(field: string): HdfsFile;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): HdfsFile;
   ...
   * @see #unsetField
   */
  removeField(field: string): HdfsFile;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): HdfsFile;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): HdfsFile;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): HdfsFile;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): HdfsFile;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): HdfsFile;

  mergeJson(json: any | null): HdfsFile;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): HdfsFile;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): HdfsFile;
   ...
   */
  singletonArray(): C3.Array<HdfsFile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<HdfsFile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<HdfsFile | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<HdfsFile | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<HdfsFile | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, HdfsFile | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, HdfsFile | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<HdfsFile | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<HdfsFile | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): HdfsFile;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): HdfsFile;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): HdfsFile;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): HdfsFile;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): HdfsFile;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): HdfsFile;
   ...
   * @see #fromString
   */
  static make(s: string | null): HdfsFile | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): HdfsFile;
   ...
   */
  static cachedEmptyInst(): HdfsFile;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<HdfsFile>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): HdfsFile;
   ...
   */
  withFileName(fileName: string | null): HdfsFile;

  /**
   * Changes file extension in this instance.
   */
  withFileExt(fileExt: string | null): HdfsFile;
   ...
   */
  identify(suffix?: string | null): HdfsFile;
   ...
   */
  readMetadata(spec?: FileOperationSpec | null): HdfsFile;
   ...
   */
  refreshMetadata(spec?: FileOperationSpec | null): HdfsFile;
   ...
   */
  encodedPushStream(spec?: FileOperationSpec | null): Pair<HdfsFile | null, BytePushStream | null>;

  /**
   * @return byte push stream to be used for writing un-encoded data into this content object.
   */
  pushStream(spec?: FileOperationSpec | null): Pair<HdfsFile | null, BytePushStream | null>;

  /**
   * @return character push stream to be used for writing un-encoded data into this content object.
   */
  charPushStream(spec?: FileOperationSpec | null): Pair<HdfsFile | null, CharPushStream | null>;
   ...
   */
  encodedStream(spec?: FileOperationSpec | null): Pair<HdfsFile | null, ByteStream | null> | null;
   ...
   */
  writeStream(content: ByteStream | null, spec?: FileOperationSpec | null): HdfsFile;

  /**
   * Truncates file and replaces it's content with provided binary content.
   */
  writeInputStream(inputStream: any, spec?: FileOperationSpec | null): HdfsFile;

  /**
   * Truncates file and replaces its content with provided binary content from zipInputStream
   */
  writeZipInputStream(zipInputStream: any, spec?: FileOperationSpec | null): HdfsFile;
   ...
   */
  writeEncodedStream(encodedContent: ByteStream | null, spec?: FileOperationSpec | null): HdfsFile;

  /**
   * Truncates file and replaces it's encoded content with provided binary content.
   */
  writeEncodedInputStream(inputStream: any, spec?: FileOperationSpec | null): HdfsFile;
   ...
   *           content that needs to be written
   */
  write(content: any | null, spec?: FileOperationSpec | null): HdfsFile;
   ...
   *           encoded content that needs to be written
   */
  writeEncoded(encodedContent: any | null, spec?: FileOperationSpec | null): HdfsFile;
   ...
   *           content that needs to be written
   */
  writeString(content: string | null, spec?: FileOperationSpec | null): HdfsFile;
   ...
   */
  writeObj(obj: Obj | null, spec?: FileObjsOperSpec | null): HdfsFile;
   ...
   * @return pair of update instance of this content and number of objs written
   */
  startWriteObjs(spec?: FileObjsOperSpec | null): Pair<HdfsFile | null, PushStream<Obj | null> | null>;
   ...
   */
  compress(contentEncoding?: string | null, spec?: FileCompressSpec | null): HdfsFile;

  /**
   * Uncompresses file. Removes compression specific extension.
   */
  uncompress(spec?: FileCompressSpec | null): HdfsFile;
   ...
   */
  transcode(contentType: string, contentEncoding: string, spec?: FileCompressSpec | null): HdfsFile;

  /**
   * Copies content to a given target.
   */
  copyContentTo(target: HdfsFile, spec?: FileOperationSpec | null): void;
   ...
   */
  static fromString(s: string | null): HdfsFile | null;
  ...
  static fsForThisType(): Hdfs | null;
}
