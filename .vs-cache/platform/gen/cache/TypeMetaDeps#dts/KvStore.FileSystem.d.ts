// TypeScript definitions for the C3 type KvStore.FileSystem
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of KvStore.FileSystem
 */
 ...
 */
declare namespace KvStore {
  export class FileSystem extends Obj {

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): KvStore.FileSystem;
    ...
    withSQL(SQL: string | null): KvStore.FileSystem;
    ...
    withKV(KV: string | null): KvStore.FileSystem;
    ...
    withDEFAULT_KV_CONFIG(DEFAULT_KV_CONFIG: string | null): KvStore.FileSystem;
    ...
    withDEFAULT_COL_NAME(DEFAULT_COL_NAME: string | null): KvStore.FileSystem;
     ...
     * This will be a file which will be created to flag whether a particular id is present in the KvStore.
     */
    readonly metaFileName?: string | null;
    withMetaFileName(metaFileName: string | null): KvStore.FileSystem;

    /**
     * This will be a file which will be created to flag whether a particular id is present in the KvStore.
     */
    static readonly metaFileName?: string | null;
     ...
     */
    static inst(): KvStore.FileSystem;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): KvStore.FileSystem | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): KvStore.FileSystem | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): KvStore.FileSystem | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): KvStore.FileSystem | null;
     ...
     */
    replaceType(old: Type, new_: Type): KvStore.FileSystem;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): KvStore.FileSystem;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): KvStore.FileSystem;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): KvStore.FileSystem;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): KvStore.FileSystem;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): KvStore.FileSystem;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<KvStore.FileSystem | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<KvStore.FileSystem | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<KvStore.FileSystem | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<KvStore.FileSystem | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): KvStore.FileSystem;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): KvStore.FileSystem;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): KvStore.FileSystem;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): KvStore.FileSystem;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): KvStore.FileSystem;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): KvStore.FileSystem;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): KvStore.FileSystem;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): KvStore.FileSystem;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): KvStore.FileSystem;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): KvStore.FileSystem;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): KvStore.FileSystem;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): KvStore.FileSystem;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): KvStore.FileSystem;
     ...
     * @return new Obj
     */
    static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): KvStore.FileSystem;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): KvStore.FileSystem;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): KvStore.FileSystem;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): KvStore.FileSystem;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): KvStore.FileSystem;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): KvStore.FileSystem;
     ...
     * @see #removeField
     */
    static withoutField(field: string | null): KvStore.FileSystem;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): KvStore.FileSystem;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType | null): KvStore.FileSystem;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): KvStore.FileSystem;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: C3.Array<string | null> | null): KvStore.FileSystem;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): KvStore.FileSystem;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): KvStore.FileSystem;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): KvStore.FileSystem;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): KvStore.FileSystem;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): KvStore.FileSystem;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): KvStore.FileSystem;
     ...
     * @see #unsetField
     */
    defaultField(field: string): KvStore.FileSystem;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): KvStore.FileSystem;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): KvStore.FileSystem;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): KvStore.FileSystem;
     ...
     * @see #removeField
     */
    unsetField(field: string): KvStore.FileSystem;
     ...
     * @see #removeField
     */
    static unsetField(field: string): KvStore.FileSystem;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): KvStore.FileSystem;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): KvStore.FileSystem;
     ...
     * @see #unsetField
     */
    removeField(field: string): KvStore.FileSystem;
     ...
     * @see #unsetField
     */
    static removeField(field: string): KvStore.FileSystem;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): KvStore.FileSystem;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): KvStore.FileSystem;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): KvStore.FileSystem;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): KvStore.FileSystem;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): KvStore.FileSystem;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj | null, otherFieldsFilter: Type): KvStore.FileSystem;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): KvStore.FileSystem;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): KvStore.FileSystem;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): KvStore.FileSystem;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): KvStore.FileSystem;

    mergeJson(json: any | null): KvStore.FileSystem;

    static mergeJson(json: any | null): KvStore.FileSystem;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): KvStore.FileSystem;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): KvStore.FileSystem;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): KvStore.FileSystem;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj | null, deep?: boolean): KvStore.FileSystem;
     ...
     */
    singletonArray(): C3.Array<KvStore.FileSystem | null>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): C3.Array<KvStore.FileSystem | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<KvStore.FileSystem | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<KvStore.FileSystem | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<KvStore.FileSystem | null>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): C3.Set<KvStore.FileSystem | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<KvStore.FileSystem | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, KvStore.FileSystem | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, KvStore.FileSystem | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<KvStore.FileSystem | null>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<KvStore.FileSystem | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<KvStore.FileSystem | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): KvStore.FileSystem;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): KvStore.FileSystem;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): KvStore.FileSystem;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): KvStore.FileSystem;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): KvStore.FileSystem;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): KvStore.FileSystem;
     ...
     * @see #fromString
     */
    static make(s: string | null): KvStore.FileSystem | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): KvStore.FileSystem;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): KvStore.FileSystem;
     ...
     */
    static cachedEmptyInst(): KvStore.FileSystem;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<KvStore.FileSystem>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): KvStore.FileSystem;
     ...
     */
    config(secrets?: boolean): KvStore.FileSystem.Config;
     ...
     * @return instance of configuration - never `null`.
     */
    static config(secrets?: boolean): KvStore.FileSystem.Config;
     ...
     */
    static typeConfig(): KvStore.FileSystem.Config;
     ...
     * @see #toString
     */
    static fromString(s: string | null): KvStore.FileSystem | null;
     ...
     */
    static forName(name: string | null, failIfMissing?: boolean): KvStore.FileSystem | null;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<KvStore.FileSystem | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<KvStore.FileSystem | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<KvStore.FileSystem | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): KvStore.FileSystem | null;
     ...
     * @see findByCacheKey
     */
    static forCacheKey(key: string | null): KvStore.FileSystem | null;
     ...
     * @see findByCacheKey
     */
    getCached(): KvStore.FileSystem | null;
     ...
     * @see findByCacheKey
     */
    static getCached(): KvStore.FileSystem | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): KvStore.FileSystem | null;

    /**
     * @return newly produced cached instance.
     */
    static refreshCache(): KvStore.FileSystem | null;
     ...
     */
    static produce(key: string): KvStore.FileSystem | null;
     ...
     */
    static produceAll(): C3.Map<string | null, KvStore.FileSystem | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, KvStore.FileSystem | null>;
     ...
     */
    encodedDirUrl(tableName: string, id: string): string | null;

    /**
     * @return encoded dir url where the content for this table and id will be stored in the backing FileSystem of this KvStore.
     */
    static encodedDirUrl(tableName: string, id: string): string | null;
     ...
     */
    encodedFileUrl(tableName: string, id: string, columnName: string, fileExt?: string | null): string | null;
     ...
     * @return the encoded column file url stored in the backing FileSystem of this KvStore.
     */
    static encodedFileUrl(tableName: string, id: string, columnName: string, fileExt?: string | null): string | null;
  }
}
