// TypeScript definitions for the C3 type NormalizationConfig

/**
 * Various normalization configurations to affect the runtime
 *
 * @remarks this represents a value passed to a method that expects an instance of NormalizationConfig
 */
declare interface INormalizationConfig {
   ...
   */
  maxNormalizationAttemptsOnRead?: number | null;
   ...
   */
  maxIncrementalNormMonths?: number | null;
   ...
   */
  ntsShardSpec?: INormalizedTimeseriesShardSpec | null;
   ...
   */
  partitionStrategy?: C3.Map<string | null, NormalizationPartitionStrategy | null> | {[key: string | null]: INormalizationPartitionStrategy | null};
}

/**
 * Various normalization configurations to affect the runtime
 *
 * @remarks this represents a made instance of NormalizationConfig
 */
declare class NormalizationConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): NormalizationConfig;

  static readonly configOverride?: string | null;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): NormalizationConfig;
  ...
  withIssues(issues: C3.Array<string | null> | Array<string | null>): NormalizationConfig;
   ...
   * If set, enables incremental write of normalized data. Default for for high freq data
   */
  readonly incrementalWriteEnabled?: boolean;
  withIncrementalWriteEnabled(incrementalWriteEnabled: boolean): NormalizationConfig;

  /**
   * If set, enables incremental write of normalized data. Default for for high freq data
   */
  static readonly incrementalWriteEnabled?: boolean;

  /**
   * If set, disables incremental read for high frequency normalized data
   */
  readonly incrementalReadDisabled?: boolean;
  withIncrementalReadDisabled(incrementalReadDisabled: boolean): NormalizationConfig;

  /**
   * If set, disables incremental read for high frequency normalized data
   */
  static readonly incrementalReadDisabled?: boolean;

  /**
   * Maximum number of attempts to make to acquire lock before giving up
   */
  readonly maxLockAttempts?: number | null;
  withMaxLockAttempts(maxLockAttempts: number | null): NormalizationConfig;

  /**
   * Maximum number of attempts to make to acquire lock before giving up
   */
  static readonly maxLockAttempts?: number | null;
   ...
   * causing a lot of compute to be wasted.
   */
  readonly maxNormalizationAttemptsOnRead?: number | null;
  withMaxNormalizationAttemptsOnRead(maxNormalizationAttemptsOnRead: number | null): NormalizationConfig;
   ...
   * causing a lot of compute to be wasted.
   */
  static readonly maxNormalizationAttemptsOnRead?: number | null;
   ...
   * double values in between 0 and 100 are permitted
   */
  readonly compactInvRangesProbability?: number | null;
  withCompactInvRangesProbability(compactInvRangesProbability: number | null): NormalizationConfig;
   ...
   * double values in between 0 and 100 are permitted
   */
  static readonly compactInvRangesProbability?: number | null;

  /**
   * Max limit on the number of normalized points (4 * 24 * 365 * 20) = 700800 (20 years of 15 minute interval data)
   */
  readonly maxNormalizedPoints?: number | null;
  withMaxNormalizedPoints(maxNormalizedPoints: number | null): NormalizationConfig;

  /**
   * Max limit on the number of normalized points (4 * 24 * 365 * 20) = 700800 (20 years of 15 minute interval data)
   */
  static readonly maxNormalizedPoints?: number | null;

  /**
   * Max number of months to consider for doing incremental normalization, if invalidation period is larger than this
   * threshold then trigger full normalization
   */
  readonly maxIncrementalNormMonths?: number | null;
  withMaxIncrementalNormMonths(maxIncrementalNormMonths: number | null): NormalizationConfig;

  /**
   * Max number of months to consider for doing incremental normalization, if invalidation period is larger than this
   * threshold then trigger full normalization
   */
  static readonly maxIncrementalNormMonths?: number | null;

  /**
   * Mode using which data will be normalized
   */
  readonly mode?: string | null;
  withMode(mode: string | null): NormalizationConfig;
   ...
   * Parallelize reads for normalization
   */
  readonly parallelizeNormalizedReads?: boolean;
  withParallelizeNormalizedReads(parallelizeNormalizedReads: boolean): NormalizationConfig;

  /**
   * Parallelize reads for normalization
   */
  static readonly parallelizeNormalizedReads?: boolean;

  /**
   * Shard Nts table per the given spec
   */
  readonly ntsShardSpec?: NormalizedTimeseriesShardSpec | null;
  withNtsShardSpec(ntsShardSpec: INormalizedTimeseriesShardSpec | null): NormalizationConfig;

  /**
   * Shard Nts table per the given spec
   */
  static readonly ntsShardSpec?: NormalizedTimeseriesShardSpec | null;
   ...
   * If key is ALL, then NormalizationPartitionStrategy will be applied to all types
   */
  readonly partitionStrategy?: C3.Map<string | null, NormalizationPartitionStrategy | null>;
  withPartitionStrategy(partitionStrategy: C3.Map<string | null, NormalizationPartitionStrategy | null> | {[key: string | null]: INormalizationPartitionStrategy | null}): NormalizationConfig;
   ...
   * If key is ALL, then NormalizationPartitionStrategy will be applied to all types
   */
  static readonly partitionStrategy?: C3.Map<string | null, NormalizationPartitionStrategy | null>;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): NormalizationConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): NormalizationConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): NormalizationConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): NormalizationConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): NormalizationConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): NormalizationConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NormalizationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NormalizationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NormalizationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NormalizationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NormalizationConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NormalizationConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NormalizationConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NormalizationConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): NormalizationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): NormalizationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NormalizationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NormalizationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NormalizationConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NormalizationConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): NormalizationConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): NormalizationConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): NormalizationConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): NormalizationConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): NormalizationConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): NormalizationConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): NormalizationConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): NormalizationConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): NormalizationConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): NormalizationConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): NormalizationConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): NormalizationConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): NormalizationConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): NormalizationConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): NormalizationConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): NormalizationConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): NormalizationConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): NormalizationConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): NormalizationConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): NormalizationConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): NormalizationConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): NormalizationConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): NormalizationConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): NormalizationConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): NormalizationConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): NormalizationConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): NormalizationConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): NormalizationConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): NormalizationConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): NormalizationConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): NormalizationConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): NormalizationConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): NormalizationConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): NormalizationConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): NormalizationConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): NormalizationConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): NormalizationConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): NormalizationConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): NormalizationConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): NormalizationConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): NormalizationConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): NormalizationConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): NormalizationConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): NormalizationConfig;

  mergeJson(json: any | null): NormalizationConfig;

  static mergeJson(json: any | null): NormalizationConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): NormalizationConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): NormalizationConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): NormalizationConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): NormalizationConfig;
   ...
   */
  singletonArray(): C3.Array<NormalizationConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<NormalizationConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<NormalizationConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<NormalizationConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<NormalizationConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<NormalizationConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<NormalizationConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, NormalizationConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, NormalizationConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<NormalizationConfig | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<NormalizationConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<NormalizationConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): NormalizationConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): NormalizationConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): NormalizationConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): NormalizationConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): NormalizationConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): NormalizationConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): NormalizationConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): NormalizationConfig;
   ...
   */
  static cachedEmptyInst(): NormalizationConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<NormalizationConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): NormalizationConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<NormalizationConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<NormalizationConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<NormalizationConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): NormalizationConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): NormalizationConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): NormalizationConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): NormalizationConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): NormalizationConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): NormalizationConfig | null;
   ...
   */
  static produce(key: string): NormalizationConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, NormalizationConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, NormalizationConfig | null>;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): NormalizationConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): NormalizationConfig;
   ...
   */
  static forConfigKey(configKey: string | null): NormalizationConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<NormalizationConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: NormalizationConfig, override?: string | null): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: NormalizationConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: NormalizationConfig, override?: string | null): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: NormalizationConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): NormalizationConfig | null;
   ...
   */
  removeSecrets(): NormalizationConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): NormalizationConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): NormalizationConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): NormalizationConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): NormalizationConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): NormalizationConfig;
