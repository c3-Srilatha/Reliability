// TypeScript definitions for the C3 type PendingWorkflowReq

/**
 * Pending workflow scheduled during provisioning.
 *
 * @remarks this represents a value passed to a method that expects an instance of PendingWorkflowReq
 */
declare interface IPendingWorkflowReq {
 ...
 * Pending workflow scheduled during provisioning.
 *
 * @remarks this represents a made instance of PendingWorkflowReq
 */
declare class PendingWorkflowReq extends Obj {
  ...
  withTypeIdent(typeIdent: string | null): PendingWorkflowReq;
   ...
   */
  readonly id: string;
  withId(id: string): PendingWorkflowReq;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): PendingWorkflowReq;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): PendingWorkflowReq;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): PendingWorkflowReq;
  ...
  withVersion(version: number | null): PendingWorkflowReq;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): PendingWorkflowReq;

  /**
   * Type to refresh.
   */
  readonly refreshType?: Type | null;
  withRefreshType(refreshType: IType | null): PendingWorkflowReq;

  /**
   * Id of the pending job.
   */
  readonly jobId: string;
  withJobId(jobId: string): PendingWorkflowReq;

  /**
   * Options to run the job with.
   */
  readonly options?: any;
  withOptions(options: any): PendingWorkflowReq;
  ...
  withInputs(inputs: C3.Map<string | null, any> | {[key: string | null]: any}): PendingWorkflowReq;

  /**
   * An instance of WorkflowExecutionSpec to specify details on how the workflow execution will happen.
   */
  readonly spec?: WorkflowExecutionSpec | null;
  withSpec(spec: IWorkflowExecutionSpec | null): PendingWorkflowReq;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): PendingWorkflowReq | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): PendingWorkflowReq | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): PendingWorkflowReq | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): PendingWorkflowReq | null;
   ...
   */
  replaceType(old: Type, new_: Type): PendingWorkflowReq;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PendingWorkflowReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PendingWorkflowReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PendingWorkflowReq | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PendingWorkflowReq | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): PendingWorkflowReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PendingWorkflowReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PendingWorkflowReq;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PendingWorkflowReq;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PendingWorkflowReq;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PendingWorkflowReq;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): PendingWorkflowReq;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PendingWorkflowReq;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PendingWorkflowReq;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): PendingWorkflowReq;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): PendingWorkflowReq;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): PendingWorkflowReq;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): PendingWorkflowReq;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PendingWorkflowReq;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): PendingWorkflowReq;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PendingWorkflowReq;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PendingWorkflowReq;
   ...
   * @see #removeField
   */
  unsetField(field: string): PendingWorkflowReq;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PendingWorkflowReq;
   ...
   * @see #unsetField
   */
  removeField(field: string): PendingWorkflowReq;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PendingWorkflowReq;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): PendingWorkflowReq;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): PendingWorkflowReq;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): PendingWorkflowReq;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): PendingWorkflowReq;

  mergeJson(json: any | null): PendingWorkflowReq;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): PendingWorkflowReq;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): PendingWorkflowReq;
   ...
   */
  singletonArray(): C3.Array<PendingWorkflowReq | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<PendingWorkflowReq | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PendingWorkflowReq | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<PendingWorkflowReq | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PendingWorkflowReq | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, PendingWorkflowReq | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PendingWorkflowReq | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PendingWorkflowReq | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PendingWorkflowReq | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): PendingWorkflowReq;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): PendingWorkflowReq;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): PendingWorkflowReq;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PendingWorkflowReq;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): PendingWorkflowReq;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PendingWorkflowReq;
   ...
   * @see #fromString
   */
  static make(s: string | null): PendingWorkflowReq | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): PendingWorkflowReq;
   ...
   */
  static cachedEmptyInst(): PendingWorkflowReq;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<PendingWorkflowReq>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): PendingWorkflowReq;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<PendingWorkflowReq | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PendingWorkflowReq | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<PendingWorkflowReq | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<PendingWorkflowReq | null> | null>;
   ...
   */
  get(include?: string | null): PendingWorkflowReq | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): PendingWorkflowReq | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PendingWorkflowReq;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): PendingWorkflowReq | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PendingWorkflowReq;
   ...
   * @see #toString
   */
  static fromString(s: string | null): PendingWorkflowReq | null;
   ...
   */
  create(spec?: UpsertSpec | null): PendingWorkflowReq | null;
   ...
   */
  static createBatch(objs: C3.Array<PendingWorkflowReq | null> | null, spec?: UpsertSpec | null): ObjList<PendingWorkflowReq | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PendingWorkflowReq | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<PendingWorkflowReq | null> | null;
   ...
   */
  update(srcObj?: PendingWorkflowReq | null, spec?: UpsertSpec | null): PendingWorkflowReq | null;
   ...
   */
  upsert(srcObj?: PendingWorkflowReq | null, spec?: UpsertSpec | null): PendingWorkflowReq | null;
   ...
   */
  merge(spec?: MergeSpec | null): PendingWorkflowReq | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): PendingWorkflowReq | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): PendingWorkflowReq | null;
   ...
   */
  static updateBatch(objs: C3.Array<PendingWorkflowReq | null> | null, srcObjs?: C3.Array<PendingWorkflowReq | null>, spec?: UpsertSpec | null): ObjList<PendingWorkflowReq | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<PendingWorkflowReq | null>>, spec?: UpsertSpec | null): ObjList<PendingWorkflowReq | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<PendingWorkflowReq | null> | null, srcObjs?: C3.Array<PendingWorkflowReq | null>, spec?: UpsertSpec | null): ObjList<PendingWorkflowReq | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<PendingWorkflowReq | null>>, spec?: UpsertSpec | null): ObjList<PendingWorkflowReq | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<PendingWorkflowReq | null> | null, spec?: TouchSpec | null): ObjList<PendingWorkflowReq | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PendingWorkflowReq | null> | null, spec?: MergeSpec | null): ObjList<PendingWorkflowReq | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PendingWorkflowReq | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<PendingWorkflowReq | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<PendingWorkflowReq | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<PendingWorkflowReq | null> | null;
   ...
   */
  static mergeAll(mergeObj: PendingWorkflowReq | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PendingWorkflowReq | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<PendingWorkflowReq | null> | null, spec?: UpsertSpec | null): ObjList<PendingWorkflowReq | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<PendingWorkflowReq | null> | null, spec?: UpsertSpec | null): ObjList<PendingWorkflowReq | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): PendingWorkflowReq | null;
   ...
   */
  static beforeCreate(objs: C3.Array<PendingWorkflowReq | null> | null): ObjList<PendingWorkflowReq | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<PendingWorkflowReq | null> | null): ObjList<PendingWorkflowReq | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<PendingWorkflowReq | null> | null): ObjList<PendingWorkflowReq | null>;
   ...
   */
  static afterCreate(objs: C3.Array<PendingWorkflowReq | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<PendingWorkflowReq | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<PendingWorkflowReq | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<PendingWorkflowReq | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<PendingWorkflowReq | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): PendingWorkflowReq | null;
   ...
   */
  withoutIdentity(): PendingWorkflowReq | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<PendingWorkflowReq | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: PendingWorkflowReq | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<PendingWorkflowReq | null> | null, callback?: λFunction<PendingWorkflowReq | null, PendingWorkflowReq | null> | null): ObjList<PendingWorkflowReq | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<PendingWorkflowReq | null> | null, callback?: λFunction<PendingWorkflowReq | null, PendingWorkflowReq | null> | null): C3.Array<ObjError | null>;
