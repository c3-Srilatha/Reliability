// TypeScript definitions for the C3 type DataGrid
 ...
 * @see Data
 *
 * @remarks this represents a value passed to a method that expects an instance of DataGrid
 */
 ...
 * @see Data
 *
 * @remarks this represents a made instance of DataGrid
 */
declare class DataGrid extends Obj {

  /**
   * The raw data from which the grid was built.
   */
  readonly source?: any;
  withSource(source: any): DataGrid;
  ...
  withLabel(label: string | null): DataGrid;

  /**
   * A more detailed description of the source of the data. Typically the full value type of the data.
   */
  readonly description?: string | null;
  withDescription(description: string | null): DataGrid;
  ...
  withCols(cols: C3.Array<DataGrid.Col> | Array<IDataGrid.Col>): DataGrid;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): DataGrid | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): DataGrid | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): DataGrid | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): DataGrid | null;
   ...
   */
  replaceType(old: Type, new_: Type): DataGrid;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataGrid;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataGrid;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataGrid | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataGrid | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataGrid;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataGrid;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataGrid;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DataGrid;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DataGrid;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DataGrid;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataGrid;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataGrid;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DataGrid;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): DataGrid;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): DataGrid;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): DataGrid;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataGrid;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DataGrid;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataGrid;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DataGrid;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DataGrid;
   ...
   * @see #removeField
   */
  unsetField(field: string): DataGrid;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DataGrid;
   ...
   * @see #unsetField
   */
  removeField(field: string): DataGrid;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DataGrid;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataGrid;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): DataGrid;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataGrid;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataGrid;

  mergeJson(json: any | null): DataGrid;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataGrid;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): DataGrid;
   ...
   */
  singletonArray(): C3.Array<DataGrid | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<DataGrid | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DataGrid | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<DataGrid | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DataGrid | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, DataGrid | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataGrid | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DataGrid | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DataGrid | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DataGrid;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DataGrid;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DataGrid;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DataGrid;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DataGrid;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DataGrid;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DataGrid;
   ...
   */
  static cachedEmptyInst(): DataGrid;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DataGrid>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): DataGrid;
