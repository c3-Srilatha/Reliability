// TypeScript definitions for the C3 type Data.Spark.DataFrameGroupByImpl
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Data.Spark.DataFrameGroupByImpl
 */
declare namespace Data.Spark {
  export interface IDataFrameGroupByImpl {
 ...
 */
declare namespace Data.Spark {
  export class DataFrameGroupByImpl extends Obj {
    ...
    withEngine(engine: IData.ExecutionEngine | null): Data.Spark.DataFrameGroupByImpl;

    /**
     * The plan that used to actualize this Data.Spark instance
     */
    pipeline?: PipelineSpec | null;
    withPipeline(pipeline: IPipelineSpec | null): Data.Spark.DataFrameGroupByImpl;

    /**
     * The id number that represent this Data.Spark instance
     */
    nodeId?: string | null;
    withNodeId(nodeId: string | null): Data.Spark.DataFrameGroupByImpl;

    /**
     * The output name of the pipeline
     */
    outputId?: string | null;
    withOutputId(outputId: string | null): Data.Spark.DataFrameGroupByImpl;
     ...
     */
    static make(): Data.Spark.DataFrameGroupByImpl;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.Spark.DataFrameGroupByImpl;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.Spark.DataFrameGroupByImpl;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.Spark.DataFrameGroupByImpl;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.Spark.DataFrameGroupByImpl;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.Spark.DataFrameGroupByImpl | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.Spark.DataFrameGroupByImpl | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.Spark.DataFrameGroupByImpl | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.Spark.DataFrameGroupByImpl | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.Spark.DataFrameGroupByImpl;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Spark.DataFrameGroupByImpl;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Spark.DataFrameGroupByImpl;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Spark.DataFrameGroupByImpl | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Spark.DataFrameGroupByImpl | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.Spark.DataFrameGroupByImpl;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Spark.DataFrameGroupByImpl;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Spark.DataFrameGroupByImpl;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.Spark.DataFrameGroupByImpl;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.Spark.DataFrameGroupByImpl;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.Spark.DataFrameGroupByImpl;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.Spark.DataFrameGroupByImpl;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.Spark.DataFrameGroupByImpl;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.Spark.DataFrameGroupByImpl;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.Spark.DataFrameGroupByImpl;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.Spark.DataFrameGroupByImpl;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.Spark.DataFrameGroupByImpl;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.Spark.DataFrameGroupByImpl;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.Spark.DataFrameGroupByImpl;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.Spark.DataFrameGroupByImpl;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.Spark.DataFrameGroupByImpl;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.Spark.DataFrameGroupByImpl;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.Spark.DataFrameGroupByImpl;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.Spark.DataFrameGroupByImpl;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.Spark.DataFrameGroupByImpl;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.Spark.DataFrameGroupByImpl;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.Spark.DataFrameGroupByImpl;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.Spark.DataFrameGroupByImpl;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.Spark.DataFrameGroupByImpl;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.Spark.DataFrameGroupByImpl;

    mergeJson(json: any | null): Data.Spark.DataFrameGroupByImpl;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.Spark.DataFrameGroupByImpl;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.Spark.DataFrameGroupByImpl;
     ...
     */
    singletonArray(): C3.Array<Data.Spark.DataFrameGroupByImpl | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.Spark.DataFrameGroupByImpl | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.Spark.DataFrameGroupByImpl | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.Spark.DataFrameGroupByImpl | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.Spark.DataFrameGroupByImpl | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.Spark.DataFrameGroupByImpl | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.Spark.DataFrameGroupByImpl | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.Spark.DataFrameGroupByImpl | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.Spark.DataFrameGroupByImpl | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.Spark.DataFrameGroupByImpl;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.Spark.DataFrameGroupByImpl;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.Spark.DataFrameGroupByImpl;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Data.Spark.DataFrameGroupByImpl;
     ...
     */
    static cachedEmptyInst(): Data.Spark.DataFrameGroupByImpl;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.Spark.DataFrameGroupByImpl>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.Spark.DataFrameGroupByImpl;
     ...
     * @return this Obj
     */
    setField(field: string, value: any, doNotConvert?: boolean): Data.Spark.DataFrameGroupByImpl;
     ...
     * @return this Obj
     */
    setField(field: FieldType, value: any, doNotConvert?: boolean): Data.Spark.DataFrameGroupByImpl;
