// TypeScript definitions for the C3 type InvalidationQueueCompactor

/**
 * Batch job for compacting invalidation queue entries.  Only valid for queues that support
 * merging of entries
 *
 * @remarks this represents a value passed to a method that expects an instance of InvalidationQueueCompactor
 */
declare interface IInvalidationQueueCompactor {
 ...
 */
declare class InvalidationQueueCompactor extends Obj {

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun | null;
  withRun(run: IBatchJobRun | null): InvalidationQueueCompactor;

  /**
   * previous job executions for this instance
   */
  readonly runs?: C3.Array<BatchJobRun | null>;
  withRuns(runs: C3.Array<BatchJobRun | null> | Array<IBatchJobRun | null>): InvalidationQueueCompactor;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj | null;
  withOptions(options: IObj | null): InvalidationQueueCompactor;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): InvalidationQueueCompactor;
  ...
  withPriority(priority: number | null): InvalidationQueueCompactor;
  ...
  withDisabled(disabled: boolean): InvalidationQueueCompactor;
  ...
  withMaxConcurrency(maxConcurrency: number | null): InvalidationQueueCompactor;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): InvalidationQueueCompactor;
  ...
  withRunAsUser(runAsUser: boolean | null): InvalidationQueueCompactor;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string | null;
  withNodePool(nodePool: string | null): InvalidationQueueCompactor;
  ...
  withSkipIfRunning(skipIfRunning: boolean | null): InvalidationQueueCompactor;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number | null;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): InvalidationQueueCompactor;
  ...
  withPropagateActionContext(propagateActionContext: boolean): InvalidationQueueCompactor;
  ...
  withTypeIdent(typeIdent: string | null): InvalidationQueueCompactor;
   ...
   */
  readonly id: string;
  withId(id: string): InvalidationQueueCompactor;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): InvalidationQueueCompactor;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): InvalidationQueueCompactor;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): InvalidationQueueCompactor;
  ...
  withVersion(version: number | null): InvalidationQueueCompactor;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): InvalidationQueueCompactor;
  ...
  withAbortOnError(abortOnError: boolean): InvalidationQueueCompactor;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): InvalidationQueueCompactor | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): InvalidationQueueCompactor | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): InvalidationQueueCompactor | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): InvalidationQueueCompactor | null;
   ...
   */
  replaceType(old: Type, new_: Type): InvalidationQueueCompactor;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): InvalidationQueueCompactor;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): InvalidationQueueCompactor;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<InvalidationQueueCompactor | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<InvalidationQueueCompactor | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): InvalidationQueueCompactor;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): InvalidationQueueCompactor;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): InvalidationQueueCompactor;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): InvalidationQueueCompactor;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): InvalidationQueueCompactor;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): InvalidationQueueCompactor;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): InvalidationQueueCompactor;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): InvalidationQueueCompactor;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): InvalidationQueueCompactor;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): InvalidationQueueCompactor;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): InvalidationQueueCompactor;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): InvalidationQueueCompactor;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): InvalidationQueueCompactor;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): InvalidationQueueCompactor;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): InvalidationQueueCompactor;
   ...
   * @see #unsetField
   */
  defaultField(field: string): InvalidationQueueCompactor;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): InvalidationQueueCompactor;
   ...
   * @see #removeField
   */
  unsetField(field: string): InvalidationQueueCompactor;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): InvalidationQueueCompactor;
   ...
   * @see #unsetField
   */
  removeField(field: string): InvalidationQueueCompactor;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): InvalidationQueueCompactor;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): InvalidationQueueCompactor;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): InvalidationQueueCompactor;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): InvalidationQueueCompactor;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): InvalidationQueueCompactor;

  mergeJson(json: any | null): InvalidationQueueCompactor;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): InvalidationQueueCompactor;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): InvalidationQueueCompactor;
   ...
   */
  singletonArray(): C3.Array<InvalidationQueueCompactor | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<InvalidationQueueCompactor | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<InvalidationQueueCompactor | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<InvalidationQueueCompactor | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<InvalidationQueueCompactor | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, InvalidationQueueCompactor | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, InvalidationQueueCompactor | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<InvalidationQueueCompactor | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<InvalidationQueueCompactor | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): InvalidationQueueCompactor;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): InvalidationQueueCompactor;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): InvalidationQueueCompactor;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): InvalidationQueueCompactor;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): InvalidationQueueCompactor;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): InvalidationQueueCompactor;
   ...
   * @see #fromString
   */
  static make(s: string | null): InvalidationQueueCompactor | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): InvalidationQueueCompactor;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): InvalidationQueueCompactor;
   ...
   */
  static cachedEmptyInst(): InvalidationQueueCompactor;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<InvalidationQueueCompactor>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): InvalidationQueueCompactor;
   ...
   */
  start(options?: InvalidationQueueCompactorOptions | null): BatchJobStatus | null;
   ...
   */
  cleanup(options?: InvalidationQueueCompactorOptions | null): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun | null, BatchJobStatus | null, InvalidationQueueCompactorOptions | null> | null;

  failJob(run: JobRun<BatchJobStatusBase | null>): JobBase<BatchJobRun | null, BatchJobStatus | null, InvalidationQueueCompactorOptions | null> | null;
  ...
  validateStart(options?: InvalidationQueueCompactorOptions | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<InvalidationQueueCompactor | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<InvalidationQueueCompactor | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<InvalidationQueueCompactor | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<InvalidationQueueCompactor | null> | null>;
   ...
   */
  get(include?: string | null): InvalidationQueueCompactor | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): InvalidationQueueCompactor | null;
   ...
   */
  getMissing(spec: GetMissingSpec): InvalidationQueueCompactor;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): InvalidationQueueCompactor | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): InvalidationQueueCompactor;
   ...
   * @see #toString
   */
  static fromString(s: string | null): InvalidationQueueCompactor | null;
   ...
   */
  create(spec?: UpsertSpec | null): InvalidationQueueCompactor | null;
   ...
   */
  static createBatch(objs: C3.Array<InvalidationQueueCompactor | null> | null, spec?: UpsertSpec | null): ObjList<InvalidationQueueCompactor | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<InvalidationQueueCompactor | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<InvalidationQueueCompactor | null> | null;
   ...
   */
  update(srcObj?: InvalidationQueueCompactor | null, spec?: UpsertSpec | null): InvalidationQueueCompactor | null;
   ...
   */
  upsert(srcObj?: InvalidationQueueCompactor | null, spec?: UpsertSpec | null): InvalidationQueueCompactor | null;
   ...
   */
  merge(spec?: MergeSpec | null): InvalidationQueueCompactor | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): InvalidationQueueCompactor | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): InvalidationQueueCompactor | null;
   ...
   */
  static updateBatch(objs: C3.Array<InvalidationQueueCompactor | null> | null, srcObjs?: C3.Array<InvalidationQueueCompactor | null>, spec?: UpsertSpec | null): ObjList<InvalidationQueueCompactor | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<InvalidationQueueCompactor | null>>, spec?: UpsertSpec | null): ObjList<InvalidationQueueCompactor | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<InvalidationQueueCompactor | null> | null, srcObjs?: C3.Array<InvalidationQueueCompactor | null>, spec?: UpsertSpec | null): ObjList<InvalidationQueueCompactor | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<InvalidationQueueCompactor | null>>, spec?: UpsertSpec | null): ObjList<InvalidationQueueCompactor | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<InvalidationQueueCompactor | null> | null, spec?: TouchSpec | null): ObjList<InvalidationQueueCompactor | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<InvalidationQueueCompactor | null> | null, spec?: MergeSpec | null): ObjList<InvalidationQueueCompactor | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<InvalidationQueueCompactor | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<InvalidationQueueCompactor | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<InvalidationQueueCompactor | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<InvalidationQueueCompactor | null> | null;
   ...
   */
  static mergeAll(mergeObj: InvalidationQueueCompactor | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: InvalidationQueueCompactor | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<InvalidationQueueCompactor | null> | null, spec?: UpsertSpec | null): ObjList<InvalidationQueueCompactor | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<InvalidationQueueCompactor | null> | null, spec?: UpsertSpec | null): ObjList<InvalidationQueueCompactor | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): InvalidationQueueCompactor | null;
   ...
   */
  static beforeCreate(objs: C3.Array<InvalidationQueueCompactor | null> | null): ObjList<InvalidationQueueCompactor | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<InvalidationQueueCompactor | null> | null): ObjList<InvalidationQueueCompactor | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<InvalidationQueueCompactor | null> | null): ObjList<InvalidationQueueCompactor | null>;
   ...
   */
  static afterCreate(objs: C3.Array<InvalidationQueueCompactor | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<InvalidationQueueCompactor | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<InvalidationQueueCompactor | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<InvalidationQueueCompactor | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<InvalidationQueueCompactor | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): InvalidationQueueCompactor | null;
   ...
   */
  withoutIdentity(): InvalidationQueueCompactor | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<InvalidationQueueCompactor | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: InvalidationQueueCompactor | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<InvalidationQueueCompactor | null> | null, callback?: λFunction<InvalidationQueueCompactor | null, InvalidationQueueCompactor | null> | null): ObjList<InvalidationQueueCompactor | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<InvalidationQueueCompactor | null> | null, callback?: λFunction<InvalidationQueueCompactor | null, InvalidationQueueCompactor | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static doStart(job?: InvalidationQueueCompactor | null, options?: InvalidationQueueCompactorOptions | null): void;
   ...
   */
  static processBatch(batch?: ObjBatch | null, job?: InvalidationQueueCompactor | null, options?: InvalidationQueueCompactorOptions | null): void;
   ...
   */
  static allComplete(job: InvalidationQueueCompactor, options?: InvalidationQueueCompactorOptions | null): string | null;
   ...
   *           Options the job was run with.
   */
  static failed(job: InvalidationQueueCompactor, status: BatchJobStatus, options?: InvalidationQueueCompactorOptions | null): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: ObjBatch | null): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: C3.Array<ObjBatch | null>): void;
   ...
   */
  static scheduleObjBatch(job?: InvalidationQueueCompactor | null, objBatch?: ObjBatch | null, logPrefix?: string | null): number | null;
   ...
   */
  static compact(queueTypeName: string, targetTypeId?: number | null, batchSize?: number | null): C3.Array<InvalidationQueueCompactor | null>;
}
