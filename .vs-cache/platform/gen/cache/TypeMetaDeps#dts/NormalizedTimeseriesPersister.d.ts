// TypeScript definitions for the C3 type NormalizedTimeseriesPersister

/**
 * Type to manage NormalizedTimeseries objects in kv store
 *
 * Type to persist normalized timeseries
 *
 * @remarks this represents a value passed to a method that expects an instance of NormalizedTimeseriesPersister
 */
declare interface INormalizedTimeseriesPersister {
 ...
 * Type to persist normalized timeseries
 *
 * @remarks this represents a made instance of NormalizedTimeseriesPersister
 */
declare class NormalizedTimeseriesPersister extends Obj {
   ...
   */
  readonly id: string;
  withId(id: string): NormalizedTimeseriesPersister;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): NormalizedTimeseriesPersister;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): NormalizedTimeseriesPersister;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): NormalizedTimeseriesPersister;
  ...
  withVersion(version: number | null): NormalizedTimeseriesPersister;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): NormalizedTimeseriesPersister;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): NormalizedTimeseriesPersister | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): NormalizedTimeseriesPersister | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): NormalizedTimeseriesPersister | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): NormalizedTimeseriesPersister | null;
   ...
   */
  replaceType(old: Type, new_: Type): NormalizedTimeseriesPersister;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NormalizedTimeseriesPersister;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NormalizedTimeseriesPersister;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NormalizedTimeseriesPersister | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NormalizedTimeseriesPersister | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): NormalizedTimeseriesPersister;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NormalizedTimeseriesPersister;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NormalizedTimeseriesPersister;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): NormalizedTimeseriesPersister;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): NormalizedTimeseriesPersister;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): NormalizedTimeseriesPersister;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): NormalizedTimeseriesPersister;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): NormalizedTimeseriesPersister;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): NormalizedTimeseriesPersister;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): NormalizedTimeseriesPersister;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): NormalizedTimeseriesPersister;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): NormalizedTimeseriesPersister;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): NormalizedTimeseriesPersister;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): NormalizedTimeseriesPersister;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): NormalizedTimeseriesPersister;
   ...
   * @see #unsetField
   */
  defaultField(field: string): NormalizedTimeseriesPersister;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): NormalizedTimeseriesPersister;
   ...
   * @see #removeField
   */
  unsetField(field: string): NormalizedTimeseriesPersister;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): NormalizedTimeseriesPersister;
   ...
   * @see #unsetField
   */
  removeField(field: string): NormalizedTimeseriesPersister;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): NormalizedTimeseriesPersister;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): NormalizedTimeseriesPersister;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): NormalizedTimeseriesPersister;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): NormalizedTimeseriesPersister;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): NormalizedTimeseriesPersister;

  mergeJson(json: any | null): NormalizedTimeseriesPersister;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): NormalizedTimeseriesPersister;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): NormalizedTimeseriesPersister;
   ...
   */
  singletonArray(): C3.Array<NormalizedTimeseriesPersister | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<NormalizedTimeseriesPersister | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<NormalizedTimeseriesPersister | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<NormalizedTimeseriesPersister | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<NormalizedTimeseriesPersister | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, NormalizedTimeseriesPersister | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, NormalizedTimeseriesPersister | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<NormalizedTimeseriesPersister | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<NormalizedTimeseriesPersister | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): NormalizedTimeseriesPersister;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): NormalizedTimeseriesPersister;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): NormalizedTimeseriesPersister;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): NormalizedTimeseriesPersister;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): NormalizedTimeseriesPersister;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): NormalizedTimeseriesPersister;
   ...
   * @see #fromString
   */
  static make(s: string | null): NormalizedTimeseriesPersister | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): NormalizedTimeseriesPersister;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): NormalizedTimeseriesPersister;
   ...
   */
  static cachedEmptyInst(): NormalizedTimeseriesPersister;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<NormalizedTimeseriesPersister>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): NormalizedTimeseriesPersister;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<NormalizedTimeseriesPersister | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<NormalizedTimeseriesPersister | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<NormalizedTimeseriesPersister | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<NormalizedTimeseriesPersister | null> | null>;
   ...
   */
  get(include?: string | null): NormalizedTimeseriesPersister | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): NormalizedTimeseriesPersister | null;
   ...
   */
  getMissing(spec: GetMissingSpec): NormalizedTimeseriesPersister;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): NormalizedTimeseriesPersister | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): NormalizedTimeseriesPersister;
   ...
   * @see #toString
   */
  static fromString(s: string | null): NormalizedTimeseriesPersister | null;
   ...
   */
  create(spec?: UpsertSpec | null): NormalizedTimeseriesPersister | null;
   ...
   */
  static createBatch(objs: C3.Array<NormalizedTimeseriesPersister | null> | null, spec?: UpsertSpec | null): ObjList<NormalizedTimeseriesPersister | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<NormalizedTimeseriesPersister | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<NormalizedTimeseriesPersister | null> | null;
   ...
   */
  update(srcObj?: NormalizedTimeseriesPersister | null, spec?: UpsertSpec | null): NormalizedTimeseriesPersister | null;
   ...
   */
  upsert(srcObj?: NormalizedTimeseriesPersister | null, spec?: UpsertSpec | null): NormalizedTimeseriesPersister | null;
   ...
   */
  merge(spec?: MergeSpec | null): NormalizedTimeseriesPersister | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): NormalizedTimeseriesPersister | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): NormalizedTimeseriesPersister | null;
   ...
   */
  static updateBatch(objs: C3.Array<NormalizedTimeseriesPersister | null> | null, srcObjs?: C3.Array<NormalizedTimeseriesPersister | null>, spec?: UpsertSpec | null): ObjList<NormalizedTimeseriesPersister | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<NormalizedTimeseriesPersister | null>>, spec?: UpsertSpec | null): ObjList<NormalizedTimeseriesPersister | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<NormalizedTimeseriesPersister | null> | null, srcObjs?: C3.Array<NormalizedTimeseriesPersister | null>, spec?: UpsertSpec | null): ObjList<NormalizedTimeseriesPersister | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<NormalizedTimeseriesPersister | null>>, spec?: UpsertSpec | null): ObjList<NormalizedTimeseriesPersister | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<NormalizedTimeseriesPersister | null> | null, spec?: TouchSpec | null): ObjList<NormalizedTimeseriesPersister | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<NormalizedTimeseriesPersister | null> | null, spec?: MergeSpec | null): ObjList<NormalizedTimeseriesPersister | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<NormalizedTimeseriesPersister | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<NormalizedTimeseriesPersister | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<NormalizedTimeseriesPersister | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<NormalizedTimeseriesPersister | null> | null;
   ...
   */
  static mergeAll(mergeObj: NormalizedTimeseriesPersister | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: NormalizedTimeseriesPersister | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<NormalizedTimeseriesPersister | null> | null, spec?: UpsertSpec | null): ObjList<NormalizedTimeseriesPersister | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<NormalizedTimeseriesPersister | null> | null, spec?: UpsertSpec | null): ObjList<NormalizedTimeseriesPersister | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): NormalizedTimeseriesPersister | null;
   ...
   */
  static beforeCreate(objs: C3.Array<NormalizedTimeseriesPersister | null> | null): ObjList<NormalizedTimeseriesPersister | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<NormalizedTimeseriesPersister | null> | null): ObjList<NormalizedTimeseriesPersister | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<NormalizedTimeseriesPersister | null> | null): ObjList<NormalizedTimeseriesPersister | null>;
   ...
   */
  static afterCreate(objs: C3.Array<NormalizedTimeseriesPersister | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<NormalizedTimeseriesPersister | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<NormalizedTimeseriesPersister | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<NormalizedTimeseriesPersister | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<NormalizedTimeseriesPersister | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): NormalizedTimeseriesPersister | null;
   ...
   */
  withoutIdentity(): NormalizedTimeseriesPersister | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<NormalizedTimeseriesPersister | null> | null): C3.Array<EntityType | null>;
  ...
  /**
   * This is a no-op and does not create any NTS tables
   */
   ...
   */
  static dbEcho(template?: NormalizedTimeseriesPersister | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<NormalizedTimeseriesPersister | null> | null, callback?: λFunction<NormalizedTimeseriesPersister | null, NormalizedTimeseriesPersister | null> | null): ObjList<NormalizedTimeseriesPersister | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<NormalizedTimeseriesPersister | null> | null, callback?: λFunction<NormalizedTimeseriesPersister | null, NormalizedTimeseriesPersister | null> | null): C3.Array<ObjError | null>;
  ...
  /**
   * Delete the given table. See #tableName for obtaining tableName
   */
  static deleteCollection(tableName: string, confirm: boolean): void;

  /**
   * Deletes all the child normalized timeseries tables
   */
  static deleteAllCollections(confirm: boolean): void;

  /**
   * Put normalized timeseries
   * @param nts
   *         Normalized timeseries object
   * @param spec
   *         Indicates how normalized values should be written
   * @return if the put operation was successful or not. If the engine was not able to write, it will return false
   */
  static put(nts: NormalizedTimeseries, spec?: NormalizedTimeseriesPutSpec | null): boolean;

  /**
   * Get the normalized timeseries object.
   * @param id
   *        Id of the normalized time series object
   * @param spec
   *        Indicates how normalized values should be read
   * @return NormalizedTimeseries object with the included fields
   */
  static getId(id: string, spec?: NormalizedTimeseriesGetSpec | null): NormalizedTimeseries | null;

  /**
   * Remove the object from the store
   */
  static removeId(id: string, spec?: NormalizedTimeseriesRemoveSpec | null): void;

  /**
   * NormalizedTimeseries table name for the given data point & normalized timeseries id
   * @param type
   *         Data point type for which normalized data is being stored (stores data in a different table)
   * @param id
   *        Id of the NormalizedTimeseries object to be sharded further by id if needed
   * @return table name where the given data will be stored
   */
  static tableName(type?: Type | null, id?: string | null): string | null;

  /**
   * @return all NormalizedTimeseries tables based on NormalizedTimeseriesShardSpec rules
   */
  static allTableNames(): C3.Array<string | null>;

  /**
   * Creates all NTS tables for all {@link TimedDataPoint} and {@link IntervalDataPoint} types
   */
  static upsertAllCollections(): boolean;

  /**
   * Create NormalizedTimeseries table only for a single raw timeseries data point type
   */
  static upsertSingleCollection(tsDataPointType: Type): void;

  /**
   * Generate includes for the this type for the given time range
   */
  static includes(spec?: NormalizedTimeseriesGetSpec | null): string | null;
}
