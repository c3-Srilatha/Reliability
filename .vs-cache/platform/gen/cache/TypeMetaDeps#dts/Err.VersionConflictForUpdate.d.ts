// TypeScript definitions for the C3 type Err.VersionConflictForUpdate

/**
 * Error type representing db version conflict for update operation.
 *
 * @remarks this represents a value passed to a method that expects an instance of Err.VersionConflictForUpdate
 */
declare namespace Err {
  export interface IVersionConflictForUpdate {
 ...
 */
declare namespace Err {
  export class VersionConflictForUpdate extends Obj {

    /**
     * Formatted and localized message.
     */
    readonly message?: string | null;
    withMessage(message: string | null): Err.VersionConflictForUpdate;

    /**
     * Unlocalized, parameterized error message string.
     */
    readonly template?: string | null;
    withTemplate(template: string | null): Err.VersionConflictForUpdate;

    /**
     * Parameters applied to {@link template} to produce error message.
     */
    readonly parameters?: C3.Array<string | null>;
    withParameters(parameters: C3.Array<string | null> | Array<string | null>): Err.VersionConflictForUpdate;

    /**
     * Unique (generated) error id.
     */
    readonly id?: string | null;
    withId(id: string | null): Err.VersionConflictForUpdate;

    /**
     * Error key.
     */
    readonly key?: string | null;
    withKey(key: string | null): Err.VersionConflictForUpdate;

    /**
     * Error for nested/causing exception (if any).
     */
    readonly cause?: C3.Error | null;
    withCause(cause: IC3.Error | null): Err.VersionConflictForUpdate;

    /**
     * http status code for this error
     */
    readonly httpStatusCode: number;
    withHttpStatusCode(httpStatusCode: number): Err.VersionConflictForUpdate;

    /**
     * Filename for where the error originated from
     */
    readonly filenameOfRootError?: string | null;
    withFilenameOfRootError(filenameOfRootError: string | null): Err.VersionConflictForUpdate;

    /**
     * Extra debugging information, such as script language stack.
     */
    readonly debugInfo?: C3.Array<string | null>;
    withDebugInfo(debugInfo: C3.Array<string | null> | Array<string | null>): Err.VersionConflictForUpdate;

    /**
     * Script language (js/py) stacktrace.
     */
    readonly stackTrace?: C3.Array<StackFrame | null>;
    withStackTrace(stackTrace: C3.Array<StackFrame | null> | Array<IStackFrame | null>): Err.VersionConflictForUpdate;
    ...
    withAction(action: string | null): Err.VersionConflictForUpdate;

    /**
     * Engine of the action that threw this error
     */
    readonly engine?: string | null;
    withEngine(engine: string | null): Err.VersionConflictForUpdate;

    /**
     * Timestamp when the error was thrown
     */
    readonly timestamp?: DateTime | null;
    withTimestamp(timestamp: DateTime | Date | string | null): Err.VersionConflictForUpdate;
    ...
    with_system(_system: any): Err.VersionConflictForUpdate;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Err.VersionConflictForUpdate | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Err.VersionConflictForUpdate | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Err.VersionConflictForUpdate | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Err.VersionConflictForUpdate | null;
     ...
     */
    replaceType(old: Type, new_: Type): Err.VersionConflictForUpdate;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Err.VersionConflictForUpdate;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Err.VersionConflictForUpdate;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Err.VersionConflictForUpdate | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Err.VersionConflictForUpdate | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Err.VersionConflictForUpdate;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Err.VersionConflictForUpdate;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Err.VersionConflictForUpdate;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Err.VersionConflictForUpdate;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Err.VersionConflictForUpdate;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Err.VersionConflictForUpdate;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Err.VersionConflictForUpdate;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Err.VersionConflictForUpdate;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Err.VersionConflictForUpdate;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Err.VersionConflictForUpdate;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Err.VersionConflictForUpdate;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Err.VersionConflictForUpdate;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Err.VersionConflictForUpdate;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Err.VersionConflictForUpdate;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Err.VersionConflictForUpdate;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Err.VersionConflictForUpdate;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Err.VersionConflictForUpdate;
     ...
     * @see #removeField
     */
    unsetField(field: string): Err.VersionConflictForUpdate;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Err.VersionConflictForUpdate;
     ...
     * @see #unsetField
     */
    removeField(field: string): Err.VersionConflictForUpdate;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Err.VersionConflictForUpdate;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Err.VersionConflictForUpdate;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Err.VersionConflictForUpdate;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Err.VersionConflictForUpdate;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Err.VersionConflictForUpdate;

    mergeJson(json: any | null): Err.VersionConflictForUpdate;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Err.VersionConflictForUpdate;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Err.VersionConflictForUpdate;
     ...
     */
    singletonArray(): C3.Array<Err.VersionConflictForUpdate | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Err.VersionConflictForUpdate | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Err.VersionConflictForUpdate | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Err.VersionConflictForUpdate | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Err.VersionConflictForUpdate | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Err.VersionConflictForUpdate | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Err.VersionConflictForUpdate | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Err.VersionConflictForUpdate | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Err.VersionConflictForUpdate | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Err.VersionConflictForUpdate;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Err.VersionConflictForUpdate;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Err.VersionConflictForUpdate;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Err.VersionConflictForUpdate;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Err.VersionConflictForUpdate;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Err.VersionConflictForUpdate;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Err.VersionConflictForUpdate;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Err.VersionConflictForUpdate;
     ...
     */
    static cachedEmptyInst(): Err.VersionConflictForUpdate;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Err.VersionConflictForUpdate>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Err.VersionConflictForUpdate;
     ...
     */
    withFormattedMessage(): Err.VersionConflictForUpdate;
     ...
     */
    static formatted(format: string, ...args: any[]): Err.VersionConflictForUpdate;

    /**
     * Construct an error with just the message.
     */
    static fromMessage(s: string | null): Err.VersionConflictForUpdate;
     ...
     */
    static fromJavaException(ex: any): Err.VersionConflictForUpdate;

    /**
     * Construct an error from the system exception.
     */
    static fromJavaException(message: string, ex: any): Err.VersionConflictForUpdate;
     ...
     */
    static fromTemplate(template: string | null, bindings: C3.Map<string | null, any> | null): Err.VersionConflictForUpdate;

    /**
     * Construct an error and a system exception around it to throw an error.
     */
    static fromHttpCodeAndTemplate(httpCode: number | null, template: string | null, bindings: C3.Map<string | null, any> | null): Err.VersionConflictForUpdate;
