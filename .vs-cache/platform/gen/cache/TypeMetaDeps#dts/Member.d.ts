// TypeScript definitions for the C3 type Member

/**
 * @remarks this represents a value passed to a method that expects an instance of Member
 */
...
/**
 * @remarks this represents a made instance of Member
 */
declare class Member extends Obj {
  ...
  withTypeIdent(typeIdent: string | null): Member;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Member;
  ...
  withMeta(meta: IMeta | null): Member;
  ...
  withVersion(version: number | null): Member;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): Member;

  /**
   * General description.
   */
  readonly description?: string | null;
  withDescription(description: string | null): Member;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Member | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Member | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Member | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Member | null;
   ...
   */
  replaceType(old: Type, new_: Type): Member;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Member;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Member;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Member | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Member | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Member;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Member;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Member;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Member;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Member;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Member;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Member;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Member;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Member;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Member;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Member;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Member;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Member;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Member;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Member;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Member;
   ...
   * @see #removeField
   */
  unsetField(field: string): Member;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Member;
   ...
   * @see #unsetField
   */
  removeField(field: string): Member;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Member;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Member;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Member;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Member;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Member;

  mergeJson(json: any | null): Member;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Member;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Member;
   ...
   */
  singletonArray(): C3.Array<Member | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Member | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Member | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Member | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Member | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Member | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Member | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Member | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Member | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Member;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Member;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Member;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Member;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Member;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Member;
   ...
   * @see #fromString
   */
  static make(s: string | null): Member | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Member;
   ...
   */
  static cachedEmptyInst(): Member;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Member>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Member;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<Member | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<Member | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Member | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Member | null> | null>;
   ...
   */
  get(include?: string | null): Member | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): Member | null;
   ...
   */
  getMissing(spec: GetMissingSpec): Member;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): Member | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): Member;
   ...
   * @see #toString
   */
  static fromString(s: string | null): Member | null;
   ...
   */
  create(spec?: UpsertSpec | null): Member | null;
   ...
   */
  static createBatch(objs: C3.Array<Member | null> | null, spec?: UpsertSpec | null): ObjList<Member | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<Member | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Member | null> | null;
   ...
   */
  update(srcObj?: Member | null, spec?: UpsertSpec | null): Member | null;
   ...
   */
  upsert(srcObj?: Member | null, spec?: UpsertSpec | null): Member | null;
   ...
   */
  merge(spec?: MergeSpec | null): Member | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): Member | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): Member | null;
   ...
   */
  static updateBatch(objs: C3.Array<Member | null> | null, srcObjs?: C3.Array<Member | null>, spec?: UpsertSpec | null): ObjList<Member | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<Member | null>>, spec?: UpsertSpec | null): ObjList<Member | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<Member | null> | null, srcObjs?: C3.Array<Member | null>, spec?: UpsertSpec | null): ObjList<Member | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<Member | null>>, spec?: UpsertSpec | null): ObjList<Member | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<Member | null> | null, spec?: TouchSpec | null): ObjList<Member | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Member | null> | null, spec?: MergeSpec | null): ObjList<Member | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Member | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Member | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<Member | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Member | null> | null;
   ...
   */
  static mergeAll(mergeObj: Member | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: Member | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<Member | null> | null, spec?: UpsertSpec | null): ObjList<Member | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<Member | null> | null, spec?: UpsertSpec | null): ObjList<Member | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<Member | null> | null): ObjList<Member | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<Member | null> | null): ObjList<Member | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<Member | null> | null): ObjList<Member | null>;
   ...
   */
  static afterCreate(objs: C3.Array<Member | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<Member | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<Member | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<Member | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Member | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): Member | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<Member | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: Member | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<Member | null> | null, callback?: λFunction<Member | null, Member | null> | null): ObjList<Member | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<Member | null> | null, callback?: λFunction<Member | null, Member | null> | null): C3.Array<ObjError | null>;
