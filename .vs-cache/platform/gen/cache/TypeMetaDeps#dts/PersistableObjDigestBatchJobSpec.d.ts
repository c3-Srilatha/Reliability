// TypeScript definitions for the C3 type PersistableObjDigestBatchJobSpec

/**
 * Spec for PersistableObjDigestBatchJob
 *
 * @remarks this represents a value passed to a method that expects an instance of PersistableObjDigestBatchJobSpec
 */
declare interface IPersistableObjDigestBatchJobSpec {
  ...
  /**
   * Number of files in each batch job.
   */
  ...
  /**
   * Indicated the type of object being read. Set automatically from FileSourceCollection source field.
   */
  sourceType?: IType | null;

  /**
   * Serves as generic identifier for where the data is coming from. For FileSourceCollection, will be url.
   */
  identifier?: string | null;

  /**
   * Default priority for job.
   */
 ...
 * Spec for PersistableObjDigestBatchJob
 *
 * @remarks this represents a made instance of PersistableObjDigestBatchJobSpec
 */
declare class PersistableObjDigestBatchJobSpec extends Obj {

  /**
   * Data serialization type. If not provided type will be inferred from source data
   */
  readonly serValueType?: ValueType | null;
  withSerValueType(serValueType: IValueType | null): PersistableObjDigestBatchJobSpec;

  /**
   * Content Type of the source data
   */
  readonly contentType?: string | null;
  withContentType(contentType: string | null): PersistableObjDigestBatchJobSpec;

  /**
   * Compression / Content Encoding of this data
   */
  readonly contentEncoding?: string | null;
  withContentEncoding(contentEncoding: string | null): PersistableObjDigestBatchJobSpec;

  /**
   * Number of files in each batch job.
   */
  readonly batchSize?: number | null;
  withBatchSize(batchSize: number | null): PersistableObjDigestBatchJobSpec;
  ...
  withNoCsvHeader(noCsvHeader: boolean): PersistableObjDigestBatchJobSpec;
  ...
  withCsvHeader(csvHeader: string | null): PersistableObjDigestBatchJobSpec;

  /**
   * Optional format for a csv values. Key should be field path used in a csv header.
   */
  readonly csvFormat?: C3.Map<string | null, Format | null>;
  withCsvFormat(csvFormat: C3.Map<string | null, Format | null> | {[key: string | null]: IFormat | null}): PersistableObjDigestBatchJobSpec;

  /**
   * Default csv delimiter for target type. Used for text/csv files. Leave this field as null for all other content types.
   */
  readonly defaultCsvDelimiter?: string | null;
  withDefaultCsvDelimiter(defaultCsvDelimiter: string | null): PersistableObjDigestBatchJobSpec;

  /**
   * Default escape character for target type. Used for text/csv files. Leave this field as null for all other content types.
   */
  readonly defaultCsvEscapeChar?: string | null;
  withDefaultCsvEscapeChar(defaultCsvEscapeChar: string | null): PersistableObjDigestBatchJobSpec;

  /**
   * Default quote character for target type. Used for text/csv files. Leave this field as null for all other content types.
   */
  readonly defaultCsvQuoteChar?: string | null;
  withDefaultCsvQuoteChar(defaultCsvQuoteChar: string | null): PersistableObjDigestBatchJobSpec;
  ...
  withAvroSchema(avroSchema: string | null): PersistableObjDigestBatchJobSpec;
  ...
  withIsObjList(isObjList: boolean): PersistableObjDigestBatchJobSpec;

  /**
   * Optionally skip extra fields in serialized content instead of failing to serialize.
   */
  readonly skipExtraFields?: boolean;
  withSkipExtraFields(skipExtraFields: boolean): PersistableObjDigestBatchJobSpec;

  /**
   * If true will silently ignore bad syntax in the content and will return no or partial results.
   */
  readonly ignoreBadContent?: boolean;
  withIgnoreBadContent(ignoreBadContent: boolean): PersistableObjDigestBatchJobSpec;
  ...
  withMergeXmlNonAdjacentLists(mergeXmlNonAdjacentLists: boolean): PersistableObjDigestBatchJobSpec;

  /**
   * Specifies various parameters for automatic retry that occurs in upsert due to retryable errors.
   */
  readonly retrySpec?: RetrySpec | null;
  withRetrySpec(retrySpec: IRetrySpec | null): PersistableObjDigestBatchJobSpec;

  /**
   * If set, stream will be instantiated again on retryable errors and execution will continue from the point of failure
   */
  readonly restartStreamOnRetry?: boolean;
  withRestartStreamOnRetry(restartStreamOnRetry: boolean): PersistableObjDigestBatchJobSpec;

  /**
   * The index of the first object from a stream that needs to be read.
   */
  readonly offset?: number | null;
  withOffset(offset: number | null): PersistableObjDigestBatchJobSpec;
  ...
  withLimit(limit: number | null): PersistableObjDigestBatchJobSpec;
  ...
  withValidateContentType(validateContentType: boolean): PersistableObjDigestBatchJobSpec;
  ...
  withPeekForMetadata(peekForMetadata: boolean): PersistableObjDigestBatchJobSpec;
  ...
  withFailIfMissing(failIfMissing: boolean): PersistableObjDigestBatchJobSpec;
  ...
  withSkipIfUnauthorized(skipIfUnauthorized: boolean): PersistableObjDigestBatchJobSpec;

  /**
   * If set and if requested file or directory url is under this path then will retrieve content from cache.
   */
  readonly cacheUrlOrEncodedPath?: string | null;
  withCacheUrlOrEncodedPath(cacheUrlOrEncodedPath: string | null): PersistableObjDigestBatchJobSpec;

  /**
   * Time in seconds that the cached file should live (default 24 hours).
   */
  readonly cacheTtlSec?: number | null;
  withCacheTtlSec(cacheTtlSec: number | null): PersistableObjDigestBatchJobSpec;
  ...
  withForceMultiPart(forceMultiPart: boolean): PersistableObjDigestBatchJobSpec;
  ...
  withDisableMultiPart(disableMultiPart: boolean): PersistableObjDigestBatchJobSpec;

  /**
   * Overrides default maximum file size before MultipartUpload kicks in. Default is 1GB
   */
  readonly maximumSingleUploadsize?: number | null;
  withMaximumSingleUploadsize(maximumSingleUploadsize: number | null): PersistableObjDigestBatchJobSpec;
  ...
  withMaxThreads(maxThreads: number | null): PersistableObjDigestBatchJobSpec;
  ...
  withMinThreads(minThreads: number | null): PersistableObjDigestBatchJobSpec;

  /**
   * If set to true, it will retry reading file when the file is not found.
   */
  readonly retryOnNotFound?: boolean;
  withRetryOnNotFound(retryOnNotFound: boolean): PersistableObjDigestBatchJobSpec;
  ...
  withLockOnWrite(lockOnWrite: boolean): PersistableObjDigestBatchJobSpec;

  /**
   * If set will use IoExecutor service.
   */
  readonly useIoExecutor?: boolean;
  withUseIoExecutor(useIoExecutor: boolean): PersistableObjDigestBatchJobSpec;

  /**
   * If not null, retry logic will be used from CloudClient rather than File
   */
  readonly cloudClient?: any;
  withCloudClient(cloudClient: any): PersistableObjDigestBatchJobSpec;
  ...
  withSerType(serType: IType | null): PersistableObjDigestBatchJobSpec;

  /**
   * If true then will not use parent folder of content for target type guess.
   */
  readonly doNotUseParentDirForSerType?: boolean;
  withDoNotUseParentDirForSerType(doNotUseParentDirForSerType: boolean): PersistableObjDigestBatchJobSpec;
  ...
  withUseBinaryEncodingDecoding(useBinaryEncodingDecoding: boolean): PersistableObjDigestBatchJobSpec;

  /**
   * Optionally indicating if serialized form should contain C3 type.
   */
  readonly shouldNotWriteType?: boolean;
  withShouldNotWriteType(shouldNotWriteType: boolean): PersistableObjDigestBatchJobSpec;

  /**
   * Optionally indicating if serialized form should be formatted for ease of reading.
   */
  readonly shouldWritePretty?: boolean;
  withShouldWritePretty(shouldWritePretty: boolean): PersistableObjDigestBatchJobSpec;
  ...
  withGuessMetadata(guessMetadata: boolean): PersistableObjDigestBatchJobSpec;

  /**
   * If true, checksum files will be generated when writing files
   */
  readonly createChecksum?: boolean;
  withCreateChecksum(createChecksum: boolean): PersistableObjDigestBatchJobSpec;

  /**
   * Whether to decrypt content during read
   */
  readonly decrypt?: boolean;
  withDecrypt(decrypt: boolean): PersistableObjDigestBatchJobSpec;

  /**
   * disable the creation of a {@link CountMinSketch} data structure for computing the most frequent elements
   */
  readonly disableApproxMostFrequent?: boolean;
  withDisableApproxMostFrequent(disableApproxMostFrequent: boolean): PersistableObjDigestBatchJobSpec;

  /**
   * disable the creation of a {@link HyperLogLog} data structure for computing the approximate unique count
   */
  readonly disableApproxUniqueCount?: boolean;
  withDisableApproxUniqueCount(disableApproxUniqueCount: boolean): PersistableObjDigestBatchJobSpec;
  ...
  withDisableHistogram(disableHistogram: boolean): PersistableObjDigestBatchJobSpec;
  ...
  withEnableMinHash(enableMinHash: boolean): PersistableObjDigestBatchJobSpec;
  ...
  withBuildAny(buildAny: boolean): PersistableObjDigestBatchJobSpec;
  ...
  withParseFields(parseFields: boolean): PersistableObjDigestBatchJobSpec;

  /**
   * Specifies which fields of the Obj instances to run digests on
   */
  readonly include?: string | null;
  withInclude(include: string | null): PersistableObjDigestBatchJobSpec;
  ...
  withPercentiles(percentiles: C3.Array<number | null> | Array<number | null>): PersistableObjDigestBatchJobSpec;
  ...
  withQuantiles(quantiles: C3.Array<number | null> | Array<number | null>): PersistableObjDigestBatchJobSpec;

  /**
   * Filter expression for which Obj instances to collect digests on.
   */
  readonly filter?: string | null;
  withFilter(filter: string | null): PersistableObjDigestBatchJobSpec;
  ...
  withGuessValueTypeLimit(guessValueTypeLimit: number | null): PersistableObjDigestBatchJobSpec;
  ...
  withValueSpec(valueSpec: IValueSpec | null): PersistableObjDigestBatchJobSpec;

  /**
   * @see CountMinSketchSpec
   */
  readonly countMinSketchSpec?: CountMinSketchSpec | null;
  withCountMinSketchSpec(countMinSketchSpec: ICountMinSketchSpec | null): PersistableObjDigestBatchJobSpec;

  /**
   * Indicated the type of object being read. Set automatically from FileSourceCollection source field.
   */
  readonly sourceType?: Type | null;
  withSourceType(sourceType: IType | null): PersistableObjDigestBatchJobSpec;

  /**
   * Serves as generic identifier for where the data is coming from. For FileSourceCollection, will be url.
   */
  readonly identifier?: string | null;
  withIdentifier(identifier: string | null): PersistableObjDigestBatchJobSpec;

  /**
   * Default priority for job.
   */
  readonly priority?: number | null;
  withPriority(priority: number | null): PersistableObjDigestBatchJobSpec;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): PersistableObjDigestBatchJobSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): PersistableObjDigestBatchJobSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): PersistableObjDigestBatchJobSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): PersistableObjDigestBatchJobSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): PersistableObjDigestBatchJobSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PersistableObjDigestBatchJobSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PersistableObjDigestBatchJobSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PersistableObjDigestBatchJobSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PersistableObjDigestBatchJobSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): PersistableObjDigestBatchJobSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PersistableObjDigestBatchJobSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PersistableObjDigestBatchJobSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PersistableObjDigestBatchJobSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PersistableObjDigestBatchJobSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PersistableObjDigestBatchJobSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): PersistableObjDigestBatchJobSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PersistableObjDigestBatchJobSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PersistableObjDigestBatchJobSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): PersistableObjDigestBatchJobSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): PersistableObjDigestBatchJobSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): PersistableObjDigestBatchJobSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): PersistableObjDigestBatchJobSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PersistableObjDigestBatchJobSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): PersistableObjDigestBatchJobSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PersistableObjDigestBatchJobSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PersistableObjDigestBatchJobSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): PersistableObjDigestBatchJobSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PersistableObjDigestBatchJobSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): PersistableObjDigestBatchJobSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PersistableObjDigestBatchJobSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): PersistableObjDigestBatchJobSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): PersistableObjDigestBatchJobSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): PersistableObjDigestBatchJobSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): PersistableObjDigestBatchJobSpec;

  mergeJson(json: any | null): PersistableObjDigestBatchJobSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): PersistableObjDigestBatchJobSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): PersistableObjDigestBatchJobSpec;
   ...
   */
  singletonArray(): C3.Array<PersistableObjDigestBatchJobSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<PersistableObjDigestBatchJobSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PersistableObjDigestBatchJobSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<PersistableObjDigestBatchJobSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PersistableObjDigestBatchJobSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, PersistableObjDigestBatchJobSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PersistableObjDigestBatchJobSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PersistableObjDigestBatchJobSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PersistableObjDigestBatchJobSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): PersistableObjDigestBatchJobSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): PersistableObjDigestBatchJobSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): PersistableObjDigestBatchJobSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PersistableObjDigestBatchJobSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): PersistableObjDigestBatchJobSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PersistableObjDigestBatchJobSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): PersistableObjDigestBatchJobSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): PersistableObjDigestBatchJobSpec;
   ...
   */
  static cachedEmptyInst(): PersistableObjDigestBatchJobSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<PersistableObjDigestBatchJobSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): PersistableObjDigestBatchJobSpec;

  /**
   * @return new instance of this spec with `retrySpec` set
   */
  withRetry(maxRetries?: number | null, initialSleepMillis?: number | null, exponent?: number | null): PersistableObjDigestBatchJobSpec | null;

  /**
   * @return instance of this spec with `retrySpec`'s `maxTotalMillis` set
   */
  static timeoutSeconds(secs: number | null): PersistableObjDigestBatchJobSpec;

  /**
   * @return FileObjsOperSpec with #serType set to provided value.
   */
  static fromType(serType: Type | null): PersistableObjDigestBatchJobSpec;
   ...
   */
  static toDecrypt(): PersistableObjDigestBatchJobSpec | null;

  /**
   * returns an instance of FileObjDigestSpec
   */
  fileObjDigestSpec(): FileObjDigestSpec | null;
}
