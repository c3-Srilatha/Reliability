// TypeScript definitions for the C3 type StreamType
 ...
 * @see streams.c3doc
 *
 * @remarks this represents a value passed to a method that expects an instance of StreamType
 */
declare interface IStreamType {
 ...
 */
declare class StreamType extends Obj {

  /**
   * Source file Pkg.Path a C3 Type declaration [.c3typ].
   */
  readonly declaredPkgPath?: string | null;
  withDeclaredPkgPath(declaredPkgPath: string | null): StreamType;

  /**
   * Source line number in a C3 Type declaration [.c3typ] file starting with 1 where this metadata element is declared.
   */
  readonly declaredSrcLine?: number | null;
  withDeclaredSrcLine(declaredSrcLine: number | null): StreamType;
  ...
  withDeclaredSrcCharInLine(declaredSrcCharInLine: number | null): StreamType;
   ...
   */
  readonly pkg: Pkg;
  withPkg(pkg: IPkg): StreamType;

  /**
   * SDK json representing instance of this type
   */
  readonly json?: any;
  withJson(json: any): StreamType;

  /**
   * The set of annotations defined on this element of metadata represented as json value.
   */
  readonly annotationsJson?: any | null;
  withAnnotationsJson(annotationsJson: any | null): StreamType;
  ...
  withModifier(modifier: string | null): StreamType;
  ...
  withKeyType(keyType: IValueType | null): StreamType;

  /**
   * The value type for the elements of the collection.
   */
  readonly elementType: ValueType;
  withElementType(elementType: IValueType): StreamType;
   ...
   */
  replaceType(old: Type, new_: Type): StreamType;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): StreamType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): StreamType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): StreamType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): StreamType | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): StreamType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): StreamType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<StreamType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<StreamType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): StreamType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): StreamType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): StreamType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): StreamType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): StreamType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): StreamType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): StreamType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): StreamType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): StreamType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): StreamType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): StreamType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): StreamType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): StreamType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): StreamType;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): StreamType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): StreamType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): StreamType;
   ...
   * @see #removeField
   */
  unsetField(field: string): StreamType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): StreamType;
   ...
   * @see #unsetField
   */
  removeField(field: string): StreamType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): StreamType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): StreamType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): StreamType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): StreamType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): StreamType;

  mergeJson(json: any | null): StreamType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): StreamType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): StreamType;
   ...
   */
  singletonArray(): C3.Array<StreamType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<StreamType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<StreamType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<StreamType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<StreamType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, StreamType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, StreamType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<StreamType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<StreamType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): StreamType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): StreamType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): StreamType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): StreamType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): StreamType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): StreamType;
   ...
   * @see #fromString
   */
  static make(s: string | null): StreamType | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): StreamType;
   ...
   */
  static cachedEmptyInst(): StreamType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<StreamType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): StreamType;
   ...
   */
  withoutDeclaredSrcPos(recursive?: boolean): StreamType;
   ...
   */
  withAnnotation(ann: Annotation): StreamType;
   ...
   *         value for the field
   */
  withAnnotation(ann: string, annField?: string | null, value?: any): StreamType;
   ...
   * @see #toString
   */
  static fromString(s: string | null): StreamType | null;
   ...
   */
  makeStream(iter: Iterator<E>): Stream<E> | null;
   ...
   */
  makeStream(next: λSupplier<E | null>, close?: λNullConsumer | null): Stream<E> | null;
   ...
   */
  makeStream(initial: E | null, next: λBiFunction<E | null, number, E | null>, close?: λNullConsumer | null): Stream<E> | null;
   ...
   */
  makeStream(hasNext: λNullPredicate, next: λBiFunction<E | null, number, E | null>, close: λNullConsumer | null): Stream<E> | null;

  /**
   * @return instance of empty stream of this type.
   */
  emptyStream(): Stream<E | null>;

  /**
   * @return stream built by provided lambda; note that this is not a recommended way to construct large stream. Use
   *         #makeStream instead
   */
  buildStream(builder: λConsumer<CollectionBuilder<E>>): Stream<E | null>;
}
