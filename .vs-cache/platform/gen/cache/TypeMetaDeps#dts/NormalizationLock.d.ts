// TypeScript definitions for the C3 type NormalizationLock

/**
 * Type to hold the lock while normalizing data
 *
 * @remarks this represents a value passed to a method that expects an instance of NormalizationLock
 */
declare interface INormalizationLock {
 ...
 * Type to hold the lock while normalizing data
 *
 * @remarks this represents a made instance of NormalizationLock
 */
declare class NormalizationLock extends Obj {
   ...
   */
  readonly id: string;
  withId(id: string): NormalizationLock;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): NormalizationLock;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): NormalizationLock;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): NormalizationLock;
  ...
  withVersion(version: number | null): NormalizationLock;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): NormalizationLock;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): NormalizationLock | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): NormalizationLock | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): NormalizationLock | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): NormalizationLock | null;
   ...
   */
  replaceType(old: Type, new_: Type): NormalizationLock;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NormalizationLock;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NormalizationLock;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NormalizationLock | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NormalizationLock | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): NormalizationLock;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NormalizationLock;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NormalizationLock;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): NormalizationLock;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): NormalizationLock;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): NormalizationLock;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): NormalizationLock;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): NormalizationLock;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): NormalizationLock;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): NormalizationLock;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): NormalizationLock;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): NormalizationLock;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): NormalizationLock;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): NormalizationLock;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): NormalizationLock;
   ...
   * @see #unsetField
   */
  defaultField(field: string): NormalizationLock;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): NormalizationLock;
   ...
   * @see #removeField
   */
  unsetField(field: string): NormalizationLock;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): NormalizationLock;
   ...
   * @see #unsetField
   */
  removeField(field: string): NormalizationLock;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): NormalizationLock;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): NormalizationLock;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): NormalizationLock;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): NormalizationLock;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): NormalizationLock;

  mergeJson(json: any | null): NormalizationLock;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): NormalizationLock;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): NormalizationLock;
   ...
   */
  singletonArray(): C3.Array<NormalizationLock | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<NormalizationLock | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<NormalizationLock | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<NormalizationLock | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<NormalizationLock | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, NormalizationLock | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, NormalizationLock | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<NormalizationLock | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<NormalizationLock | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): NormalizationLock;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): NormalizationLock;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): NormalizationLock;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): NormalizationLock;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): NormalizationLock;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): NormalizationLock;
   ...
   * @see #fromString
   */
  static make(s: string | null): NormalizationLock | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): NormalizationLock;
   ...
   */
  static cachedEmptyInst(): NormalizationLock;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<NormalizationLock>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): NormalizationLock;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<NormalizationLock | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<NormalizationLock | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<NormalizationLock | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<NormalizationLock | null> | null>;
   ...
   */
  get(include?: string | null): NormalizationLock | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): NormalizationLock | null;
   ...
   */
  getMissing(spec: GetMissingSpec): NormalizationLock;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): NormalizationLock | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): NormalizationLock;
   ...
   * @see #toString
   */
  static fromString(s: string | null): NormalizationLock | null;
   ...
   */
  create(spec?: UpsertSpec | null): NormalizationLock | null;
   ...
   */
  static createBatch(objs: C3.Array<NormalizationLock | null> | null, spec?: UpsertSpec | null): ObjList<NormalizationLock | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<NormalizationLock | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<NormalizationLock | null> | null;
   ...
   */
  update(srcObj?: NormalizationLock | null, spec?: UpsertSpec | null): NormalizationLock | null;
   ...
   */
  upsert(srcObj?: NormalizationLock | null, spec?: UpsertSpec | null): NormalizationLock | null;
   ...
   */
  merge(spec?: MergeSpec | null): NormalizationLock | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): NormalizationLock | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): NormalizationLock | null;
   ...
   */
  static updateBatch(objs: C3.Array<NormalizationLock | null> | null, srcObjs?: C3.Array<NormalizationLock | null>, spec?: UpsertSpec | null): ObjList<NormalizationLock | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<NormalizationLock | null>>, spec?: UpsertSpec | null): ObjList<NormalizationLock | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<NormalizationLock | null> | null, srcObjs?: C3.Array<NormalizationLock | null>, spec?: UpsertSpec | null): ObjList<NormalizationLock | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<NormalizationLock | null>>, spec?: UpsertSpec | null): ObjList<NormalizationLock | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<NormalizationLock | null> | null, spec?: TouchSpec | null): ObjList<NormalizationLock | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<NormalizationLock | null> | null, spec?: MergeSpec | null): ObjList<NormalizationLock | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<NormalizationLock | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<NormalizationLock | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<NormalizationLock | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<NormalizationLock | null> | null;
   ...
   */
  static mergeAll(mergeObj: NormalizationLock | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: NormalizationLock | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<NormalizationLock | null> | null, spec?: UpsertSpec | null): ObjList<NormalizationLock | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<NormalizationLock | null> | null, spec?: UpsertSpec | null): ObjList<NormalizationLock | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): NormalizationLock | null;
   ...
   */
  static beforeCreate(objs: C3.Array<NormalizationLock | null> | null): ObjList<NormalizationLock | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<NormalizationLock | null> | null): ObjList<NormalizationLock | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<NormalizationLock | null> | null): ObjList<NormalizationLock | null>;
   ...
   */
  static afterCreate(objs: C3.Array<NormalizationLock | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<NormalizationLock | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<NormalizationLock | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<NormalizationLock | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<NormalizationLock | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): NormalizationLock | null;
   ...
   */
  withoutIdentity(): NormalizationLock | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<NormalizationLock | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: NormalizationLock | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<NormalizationLock | null> | null, callback?: λFunction<NormalizationLock | null, NormalizationLock | null> | null): ObjList<NormalizationLock | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<NormalizationLock | null> | null, callback?: λFunction<NormalizationLock | null, NormalizationLock | null> | null): C3.Array<ObjError | null>;
