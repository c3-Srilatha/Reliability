// TypeScript definitions for the C3 type Pkg.State

/**
 * To keep track of state of app root pkg deployment.
 *
 * @remarks this represents a value passed to a method that expects an instance of Pkg.State
 */
declare namespace Pkg {
  export interface IState {
    ...
    /**
     * last deployed root pkg fingerprint.
     */
    pkgFingerprint?: number | null;

    /**
     * true indicates, for pkg, all seed has been upserted.
     */
    seeded?: boolean;
  }
}
 ...
 * To keep track of state of app root pkg deployment.
 *
 * @remarks this represents a made instance of Pkg.State
 */
declare namespace Pkg {
  export class State extends Obj {
    ...
    withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Pkg.State;
    ...
    withName(name: string | null): Pkg.State;
    ...
    withMeta(meta: IMeta | null): Pkg.State;
    ...
    withVersion(version: number | null): Pkg.State;
    ...
    withTypeWithBindings(typeWithBindings: IType | null): Pkg.State;
     ...
     * last deployed root pkg fingerprint.
     */
    readonly pkgFingerprint?: number | null;
    withPkgFingerprint(pkgFingerprint: number | null): Pkg.State;

    /**
     * last deployed root pkg fingerprint.
     */
    static readonly pkgFingerprint?: number | null;

    /**
     * true indicates, for pkg, all seed has been upserted.
     */
    readonly seeded?: boolean;
    withSeeded(seeded: boolean): Pkg.State;

    /**
     * true indicates, for pkg, all seed has been upserted.
     */
    static readonly seeded?: boolean;

    /**
     * @return the one and only instance to be used when member functions are called on this type.
     */
    static inst(): Pkg.State;

    /**
     * @return the cached instance if already cached, null otherwise. Does not instantiate if missing.
     */
    static cachedInst(): Pkg.State | null;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Pkg.State | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Pkg.State | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Pkg.State | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Pkg.State | null;
     ...
     */
    replaceType(old: Type, new_: Type): Pkg.State;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): Pkg.State;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Pkg.State;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Pkg.State;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Pkg.State;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Pkg.State;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Pkg.State | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Pkg.State | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Pkg.State | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Pkg.State | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Pkg.State;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Pkg.State;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Pkg.State;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Pkg.State;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Pkg.State;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Pkg.State;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Pkg.State;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): Pkg.State;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Pkg.State;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): Pkg.State;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Pkg.State;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): Pkg.State;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Pkg.State;
     ...
     * @return new Obj
     */
    static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Pkg.State;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Pkg.State;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Pkg.State;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Pkg.State;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): Pkg.State;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Pkg.State;
     ...
     * @see #removeField
     */
    static withoutField(field: string | null): Pkg.State;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Pkg.State;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType | null): Pkg.State;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Pkg.State;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: C3.Array<string | null> | null): Pkg.State;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Pkg.State;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Pkg.State;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Pkg.State;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): Pkg.State;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Pkg.State;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Pkg.State;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Pkg.State;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): Pkg.State;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Pkg.State;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): Pkg.State;
     ...
     * @see #removeField
     */
    unsetField(field: string): Pkg.State;
     ...
     * @see #removeField
     */
    static unsetField(field: string): Pkg.State;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Pkg.State;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): Pkg.State;
     ...
     * @see #unsetField
     */
    removeField(field: string): Pkg.State;
     ...
     * @see #unsetField
     */
    static removeField(field: string): Pkg.State;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Pkg.State;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): Pkg.State;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Pkg.State;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Pkg.State;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Pkg.State;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj | null, otherFieldsFilter: Type): Pkg.State;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Pkg.State;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Pkg.State;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Pkg.State;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Pkg.State;

    mergeJson(json: any | null): Pkg.State;

    static mergeJson(json: any | null): Pkg.State;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Pkg.State;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Pkg.State;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Pkg.State;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj | null, deep?: boolean): Pkg.State;
     ...
     */
    singletonArray(): C3.Array<Pkg.State | null>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): C3.Array<Pkg.State | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Pkg.State | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Pkg.State | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Pkg.State | null>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): C3.Set<Pkg.State | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Pkg.State | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Pkg.State | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Pkg.State | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Pkg.State | null>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<Pkg.State | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Pkg.State | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Pkg.State;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Pkg.State;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Pkg.State;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Pkg.State;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Pkg.State;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Pkg.State;
     ...
     * @see #fromString
     */
    static make(s: string | null): Pkg.State | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Pkg.State;
     ...
     */
    static cachedEmptyInst(): Pkg.State;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Pkg.State>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Pkg.State;
     ...
     */
    static fetch(spec?: FetchSpec | null): FetchResult<Pkg.State | null>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Pkg.State | null>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Pkg.State | null>;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Pkg.State | null> | null>;
     ...
     */
    get(include?: string | null): Pkg.State | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    static get(include?: string | null): Pkg.State | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string | null): Pkg.State | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    static getSpecific(include?: string | null): Pkg.State | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Pkg.State;
     ...
     * @return instance of the obj with all requested fields.
     */
    static getMissing(spec: GetMissingSpec): Pkg.State;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string | null): Pkg.State | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    static getDirect(include?: string | null): Pkg.State | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Pkg.State;
     ...
     * @return The instance after applying the reverse edit.
     */
    static applyReverseEdit(versionEdit: VersionEdit): Pkg.State;
     ...
     * @see #toString
     */
    static fromString(s: string | null): Pkg.State | null;
     ...
     */
    create(spec?: UpsertSpec | null): Pkg.State | null;
     ...
     *         will have only those fields populated. Otherwise only the id field will be populated.
     */
    static create(spec?: UpsertSpec | null): Pkg.State | null;
     ...
     */
    static createBatch(objs: C3.Array<Pkg.State | null> | null, spec?: UpsertSpec | null): ObjList<Pkg.State | null> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Pkg.State | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Pkg.State | null> | null;
     ...
     */
    update(srcObj?: Pkg.State | null, spec?: UpsertSpec | null): Pkg.State | null;
     ...
     *         obj will have only those fields populated. Otherwise only the id field will be populated.
     */
    static update(srcObj?: Pkg.State | null, spec?: UpsertSpec | null): Pkg.State | null;
     ...
     */
    upsert(srcObj?: Pkg.State | null, spec?: UpsertSpec | null): Pkg.State | null;
     ...
     *         returned obj will have only those fields populated. Otherwise only the id field will be populated.
     */
    static upsert(srcObj?: Pkg.State | null, spec?: UpsertSpec | null): Pkg.State | null;
     ...
     */
    merge(spec?: MergeSpec | null): Pkg.State | null;
     ...
     * @see Mergespec#csvInclude
     */
    static merge(spec?: MergeSpec | null): Pkg.State | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec | null): Pkg.State | null;
     ...
     * @return The created or updated obj.
     */
    static merge(mergeInclude: string, spec?: MergeSpec | null): Pkg.State | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec | null): Pkg.State | null;
     ...
     * @return The created or updated obj.
     */
    static touch(spec?: TouchSpec | null): Pkg.State | null;
     ...
     */
    static updateBatch(objs: C3.Array<Pkg.State | null> | null, srcObjs?: C3.Array<Pkg.State | null>, spec?: UpsertSpec | null): ObjList<Pkg.State | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<C3.Array<Pkg.State | null>>, spec?: UpsertSpec | null): ObjList<Pkg.State | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: C3.Array<Pkg.State | null> | null, srcObjs?: C3.Array<Pkg.State | null>, spec?: UpsertSpec | null): ObjList<Pkg.State | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<C3.Array<Pkg.State | null>>, spec?: UpsertSpec | null): ObjList<Pkg.State | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: C3.Array<Pkg.State | null> | null, spec?: TouchSpec | null): ObjList<Pkg.State | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<Pkg.State | null> | null, spec?: MergeSpec | null): ObjList<Pkg.State | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<Pkg.State | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Pkg.State | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<C3.Array<Pkg.State | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Pkg.State | null> | null;
     ...
     */
    static mergeAll(mergeObj: Pkg.State | null, spec?: MergeAllSpec | null): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Pkg.State | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: C3.Array<Pkg.State | null> | null, spec?: UpsertSpec | null): ObjList<Pkg.State | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: C3.Array<Pkg.State | null> | null, spec?: UpsertSpec | null): ObjList<Pkg.State | null> | null;
     ...
     * @see Ann.Db#archive
     */
    static unremove(): Pkg.State | null;
     ...
     */
    static beforeCreate(objs: C3.Array<Pkg.State | null> | null): ObjList<Pkg.State | null>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: C3.Array<Pkg.State | null> | null): ObjList<Pkg.State | null>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: C3.Array<Pkg.State | null> | null): ObjList<Pkg.State | null>;
     ...
     */
    static afterCreate(objs: C3.Array<Pkg.State | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: C3.Array<Pkg.State | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: C3.Array<Pkg.State | null> | null): C3.Array<ObjError | null>;
     ...
     */
    static startImportData(spec?: StartImportDataSpec | null): PushStream<Pkg.State | null>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Pkg.State | null>;
     ...
     */
    static forId(id: string | null, failIfMissing?: boolean): Pkg.State | null;
     ...
     */
    withoutIdentity(): Pkg.State | null;
     ...
     * @return The requested obj without any of its identifying fields.
     */
    static withoutIdentity(): Pkg.State | null;
     ...
     */
    static typeOfBatch(objs: C3.Array<Pkg.State | null> | null): C3.Array<EntityType | null>;
     ...
     */
    static dbEcho(template?: Pkg.State | null, count?: number | null, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: C3.Array<Pkg.State | null> | null, callback?: λFunction<Pkg.State | null, Pkg.State | null> | null): ObjList<Pkg.State | null>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: C3.Array<Pkg.State | null> | null, callback?: λFunction<Pkg.State | null, Pkg.State | null> | null): C3.Array<ObjError | null>;
