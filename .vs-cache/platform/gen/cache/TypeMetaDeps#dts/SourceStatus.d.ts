// TypeScript definitions for the C3 type SourceStatus

/**
 * This type represents the status of the Sources
 *
 * @remarks this represents a value passed to a method that expects an instance of SourceStatus
 */
declare interface ISourceStatus {
 ...
 * This type represents the status of the Sources
 *
 * @remarks this represents a made instance of SourceStatus
 */
declare class SourceStatus extends Obj {
  ...
  withTypeIdent(typeIdent: string | null): SourceStatus;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): SourceStatus;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): SourceStatus;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): SourceStatus;
  ...
  withVersion(version: number | null): SourceStatus;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): SourceStatus;

  /**
   * A reference to {@link SourceStatus} of the initial / root Sources. Will be `null` for root SourceStatus.
   */
  readonly rootSourceStatus?: SourceStatus | null;
  withRootSourceStatus(rootSourceStatus: ISourceStatus | null): SourceStatus;
  ...
  withParentStatus(parentStatus: IDataIntegStatus | null): SourceStatus;

  /**
   * Array of statuses of immediate transforms optionally filtered by provided transform type.
   */
  readonly transforms?: C3.Array<TransformStatus | null>;
  withTransforms(transforms: C3.Array<TransformStatus | null> | Array<ITransformStatus | null>): SourceStatus;

  /**
   * Array of statuses of immediate targets optionally filtered by provided transform type.
   */
  readonly targets?: C3.Array<TargetStatus | null>;
  withTargets(targets: C3.Array<TargetStatus | null> | Array<ITargetStatus | null>): SourceStatus;

  /**
   * The {@see TypeRef} of the Sources for which the stats are being stored
   */
  readonly sourceType: Type;
  withSourceType(sourceType: IType): SourceStatus;

  /**
   * fingerprint id of the {@see DataIntegSpec} for fetching the corresponding merged specs.
   */
  readonly specId?: string | null;
  withSpecId(specId: string | null): SourceStatus;

  /**
   * {@link DataIntegSpec} for the corresponding merged specs.
   */
  readonly spec?: DataIntegSpec | null;
  withSpec(spec: IDataIntegSpec | null): SourceStatus;
  ...
  withState(state: string): SourceStatus;

  /**
   * The number of objects participating at this data integration step.
   */
  readonly count: number;
  withCount(count: number): SourceStatus;

  /**
   * The number of objects successfully processed at this data integration step.
   */
  readonly successful: number;
  withSuccessful(successful: number): SourceStatus;

  /**
   * The number of objects that were skipped at this data integration step.
   */
  readonly skipped: number;
  withSkipped(skipped: number): SourceStatus;

  /**
   * The number of objects that failed to process at this data integration step.
   */
  readonly failed: number;
  withFailed(failed: number): SourceStatus;
  ...
  withTotalErrorCount(totalErrorCount: number): SourceStatus;

  /**
   * List of first 100 errors in this data integration step.
   */
  readonly errors?: C3.Array<FailedSource | null>;
  withErrors(errors: C3.Array<FailedSource | null> | Array<IFailedSource | null>): SourceStatus;
  ...
  withFirstError(firstError: string | null): SourceStatus;

  /**
   * {@see SourceChunkStatus} entries for the {@link Sources}
   */
  readonly chunks?: C3.Array<SourceChunkStatus | null>;
  withChunks(chunks: C3.Array<SourceChunkStatus | null> | Array<ISourceChunkStatus | null>): SourceStatus;

  /**
   * The {@link SourceCollection} id for the sources of this status.
   */
  readonly sourceCollectionName: string;
  withSourceCollectionName(sourceCollectionName: string): SourceStatus;

  /**
   * count of the chunks for the Sources
   */
  readonly chunkCount?: number | null;
  withChunkCount(chunkCount: number | null): SourceStatus;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SourceStatus | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SourceStatus | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SourceStatus | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SourceStatus | null;
   ...
   */
  replaceType(old: Type, new_: Type): SourceStatus;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SourceStatus;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SourceStatus;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SourceStatus | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SourceStatus | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SourceStatus;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SourceStatus;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SourceStatus;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SourceStatus;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SourceStatus;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SourceStatus;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SourceStatus;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SourceStatus;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SourceStatus;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SourceStatus;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SourceStatus;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SourceStatus;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SourceStatus;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SourceStatus;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SourceStatus;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SourceStatus;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SourceStatus;
   ...
   * @see #removeField
   */
  unsetField(field: string): SourceStatus;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SourceStatus;
   ...
   * @see #unsetField
   */
  removeField(field: string): SourceStatus;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SourceStatus;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SourceStatus;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SourceStatus;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SourceStatus;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SourceStatus;

  mergeJson(json: any | null): SourceStatus;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SourceStatus;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SourceStatus;
   ...
   */
  singletonArray(): C3.Array<SourceStatus | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SourceStatus | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SourceStatus | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SourceStatus | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SourceStatus | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SourceStatus | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SourceStatus | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SourceStatus | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SourceStatus | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SourceStatus;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SourceStatus;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SourceStatus;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SourceStatus;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SourceStatus;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SourceStatus;
   ...
   * @see #fromString
   */
  static make(s: string | null): SourceStatus | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SourceStatus;
   ...
   */
  static cachedEmptyInst(): SourceStatus;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SourceStatus>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SourceStatus;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<SourceStatus | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SourceStatus | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<SourceStatus | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<SourceStatus | null> | null>;
   ...
   */
  get(include?: string | null): SourceStatus | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): SourceStatus | null;
   ...
   */
  getMissing(spec: GetMissingSpec): SourceStatus;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): SourceStatus | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): SourceStatus;
   ...
   * @see #toString
   */
  static fromString(s: string | null): SourceStatus | null;
   ...
   */
  create(spec?: UpsertSpec | null): SourceStatus | null;
   ...
   */
  static createBatch(objs: C3.Array<SourceStatus | null> | null, spec?: UpsertSpec | null): ObjList<SourceStatus | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<SourceStatus | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<SourceStatus | null> | null;
   ...
   */
  update(srcObj?: SourceStatus | null, spec?: UpsertSpec | null): SourceStatus | null;
   ...
   */
  upsert(srcObj?: SourceStatus | null, spec?: UpsertSpec | null): SourceStatus | null;
   ...
   */
  merge(spec?: MergeSpec | null): SourceStatus | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): SourceStatus | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): SourceStatus | null;
   ...
   */
  static updateBatch(objs: C3.Array<SourceStatus | null> | null, srcObjs?: C3.Array<SourceStatus | null>, spec?: UpsertSpec | null): ObjList<SourceStatus | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<SourceStatus | null>>, spec?: UpsertSpec | null): ObjList<SourceStatus | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<SourceStatus | null> | null, srcObjs?: C3.Array<SourceStatus | null>, spec?: UpsertSpec | null): ObjList<SourceStatus | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<SourceStatus | null>>, spec?: UpsertSpec | null): ObjList<SourceStatus | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<SourceStatus | null> | null, spec?: TouchSpec | null): ObjList<SourceStatus | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SourceStatus | null> | null, spec?: MergeSpec | null): ObjList<SourceStatus | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SourceStatus | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<SourceStatus | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<SourceStatus | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<SourceStatus | null> | null;
   ...
   */
  static mergeAll(mergeObj: SourceStatus | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: SourceStatus | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<SourceStatus | null> | null, spec?: UpsertSpec | null): ObjList<SourceStatus | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<SourceStatus | null> | null, spec?: UpsertSpec | null): ObjList<SourceStatus | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<SourceStatus | null> | null): ObjList<SourceStatus | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<SourceStatus | null> | null): ObjList<SourceStatus | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<SourceStatus | null> | null): ObjList<SourceStatus | null>;
   ...
   */
  static afterCreate(objs: C3.Array<SourceStatus | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<SourceStatus | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<SourceStatus | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<SourceStatus | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<SourceStatus | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): SourceStatus | null;
   ...
   */
  withoutIdentity(): SourceStatus | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<SourceStatus | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: SourceStatus | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<SourceStatus | null> | null, callback?: λFunction<SourceStatus | null, SourceStatus | null> | null): ObjList<SourceStatus | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<SourceStatus | null> | null, callback?: λFunction<SourceStatus | null, SourceStatus | null> | null): C3.Array<ObjError | null>;
