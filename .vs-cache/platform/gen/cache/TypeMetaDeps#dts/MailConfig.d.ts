// TypeScript definitions for the C3 type MailConfig

/**
 * Configuration The Mail type .
 *
 * @remarks this represents a value passed to a method that expects an instance of MailConfig
 */
declare interface IMailConfig {
  ...
  /**
   * Reference to a type implementing {@link MailServiceProvider}. Optional, useful to send mail with a third party
   * service
   */
  serviceProvider?: IType | null;
  ...
  /**
   * maximum attachment size in Mb, by default set to 2
   */
  attachmentMaxSizeMb?: number | null;

  /**
   * SMTP Host, default instance has host = 'localhost'
   */
  smtpHost: string;

  /**
   * SMTP Port, default instance has port = 25
   */
  smtpPort: number;
}
 ...
 * Configuration The Mail type .
 *
 * @remarks this represents a made instance of MailConfig
 */
declare class MailConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): MailConfig;

  static readonly configOverride?: string | null;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): MailConfig;
  ...
  withIssues(issues: C3.Array<string | null> | Array<string | null>): MailConfig;
   ...
   * service
   */
  readonly serviceProvider?: Type | null;
  withServiceProvider(serviceProvider: IType | null): MailConfig;

  /**
   * Reference to a type implementing {@link MailServiceProvider}. Optional, useful to send mail with a third party
   * service
   */
  static readonly serviceProvider?: Type | null;

  /**
   * Mode to send mail
   */
  readonly sendMode?: string | null;
  withSendMode(sendMode: string | null): MailConfig;

  /**
   * Mode to send mail
   */
  static readonly sendMode?: string | null;

  /**
   * maximum attachment size in Mb, by default set to 2
   */
  readonly attachmentMaxSizeMb?: number | null;
  withAttachmentMaxSizeMb(attachmentMaxSizeMb: number | null): MailConfig;

  /**
   * maximum attachment size in Mb, by default set to 2
   */
  static readonly attachmentMaxSizeMb?: number | null;

  /**
   * SMTP Host, default instance has host = 'localhost'
   */
  readonly smtpHost: string;
  withSmtpHost(smtpHost: string): MailConfig;

  /**
   * SMTP Host, default instance has host = 'localhost'
   */
  static readonly smtpHost: string;

  /**
   * SMTP Port, default instance has port = 25
   */
  readonly smtpPort: number;
  withSmtpPort(smtpPort: number): MailConfig;

  /**
   * SMTP Port, default instance has port = 25
   */
  static readonly smtpPort: number;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): MailConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): MailConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): MailConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): MailConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): MailConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): MailConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MailConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MailConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MailConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MailConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MailConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MailConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MailConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MailConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): MailConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): MailConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MailConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MailConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MailConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MailConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): MailConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): MailConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): MailConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): MailConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): MailConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): MailConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): MailConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): MailConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): MailConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): MailConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): MailConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): MailConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): MailConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): MailConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): MailConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): MailConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): MailConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): MailConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): MailConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): MailConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): MailConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): MailConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): MailConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): MailConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): MailConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): MailConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): MailConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): MailConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): MailConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): MailConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): MailConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): MailConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): MailConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): MailConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): MailConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): MailConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): MailConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): MailConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): MailConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): MailConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): MailConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): MailConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): MailConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): MailConfig;

  mergeJson(json: any | null): MailConfig;

  static mergeJson(json: any | null): MailConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): MailConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): MailConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): MailConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): MailConfig;
   ...
   */
  singletonArray(): C3.Array<MailConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<MailConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<MailConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<MailConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<MailConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<MailConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<MailConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, MailConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, MailConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<MailConfig | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<MailConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<MailConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): MailConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): MailConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): MailConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): MailConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): MailConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): MailConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): MailConfig;
   ...
   */
  static cachedEmptyInst(): MailConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<MailConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): MailConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<MailConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<MailConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<MailConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): MailConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): MailConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): MailConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): MailConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): MailConfig | null;
   ...
   */
  static produce(key: string): MailConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, MailConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, MailConfig | null>;
   ...
   */
  static forConfigKey(configKey: string | null): MailConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<MailConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: MailConfig, override?: string | null): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: MailConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: MailConfig, override?: string | null): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: MailConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): MailConfig | null;
   ...
   */
  removeSecrets(): MailConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): MailConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): MailConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): MailConfig | null;
