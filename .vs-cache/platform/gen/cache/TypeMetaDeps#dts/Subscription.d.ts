// TypeScript definitions for the C3 type Subscription

/**
 * @remarks this represents a value passed to a method that expects an instance of Subscription
 */
...
/**
 * @remarks this represents a made instance of Subscription
 */
declare class Subscription extends Obj {

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): Subscription;

  readonly tag?: string | null;
  withTag(tag: string | null): Subscription;

  readonly module?: string | null;
  withModule(module: string | null): Subscription;

  readonly typp?: string | null;
  withTypp(typp: string | null): Subscription;

  readonly action?: string | null;
  withAction(action: string | null): Subscription;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Subscription;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): Subscription;
  ...
  withVersion(version: number | null): Subscription;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): Subscription;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Subscription | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Subscription | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Subscription | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Subscription | null;
   ...
   */
  replaceType(old: Type, new_: Type): Subscription;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Subscription;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Subscription;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Subscription | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Subscription | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Subscription;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Subscription;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Subscription;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): Subscription;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Subscription;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Subscription;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Subscription;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Subscription;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Subscription;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Subscription;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Subscription;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Subscription;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Subscription;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Subscription;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Subscription;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Subscription;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Subscription;
   ...
   * @see #removeField
   */
  unsetField(field: string): Subscription;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Subscription;
   ...
   * @see #unsetField
   */
  removeField(field: string): Subscription;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Subscription;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Subscription;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Subscription;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Subscription;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Subscription;

  mergeJson(json: any | null): Subscription;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Subscription;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Subscription;
   ...
   */
  singletonArray(): C3.Array<Subscription | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Subscription | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Subscription | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Subscription | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Subscription | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Subscription | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Subscription | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Subscription | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Subscription | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Subscription;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Subscription;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Subscription;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Subscription;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Subscription;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Subscription;
   ...
   * @see #fromString
   */
  static make(s: string | null): Subscription | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Subscription;
   ...
   */
  static cachedEmptyInst(): Subscription;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Subscription>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Subscription;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<Subscription | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<Subscription | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Subscription | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Subscription | null> | null>;
   ...
   */
  get(include?: string | null): Subscription | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): Subscription | null;
   ...
   */
  getMissing(spec: GetMissingSpec): Subscription;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): Subscription | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): Subscription;
   ...
   * @see #toString
   */
  static fromString(s: string | null): Subscription | null;
   ...
   */
  create(spec?: UpsertSpec | null): Subscription | null;
   ...
   */
  static createBatch(objs: C3.Array<Subscription | null> | null, spec?: UpsertSpec | null): ObjList<Subscription | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<Subscription | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Subscription | null> | null;
   ...
   */
  update(srcObj?: Subscription | null, spec?: UpsertSpec | null): Subscription | null;
   ...
   */
  upsert(srcObj?: Subscription | null, spec?: UpsertSpec | null): Subscription | null;
   ...
   */
  merge(spec?: MergeSpec | null): Subscription | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): Subscription | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): Subscription | null;
   ...
   */
  static updateBatch(objs: C3.Array<Subscription | null> | null, srcObjs?: C3.Array<Subscription | null>, spec?: UpsertSpec | null): ObjList<Subscription | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<Subscription | null>>, spec?: UpsertSpec | null): ObjList<Subscription | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<Subscription | null> | null, srcObjs?: C3.Array<Subscription | null>, spec?: UpsertSpec | null): ObjList<Subscription | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<Subscription | null>>, spec?: UpsertSpec | null): ObjList<Subscription | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<Subscription | null> | null, spec?: TouchSpec | null): ObjList<Subscription | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Subscription | null> | null, spec?: MergeSpec | null): ObjList<Subscription | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Subscription | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Subscription | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<Subscription | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Subscription | null> | null;
   ...
   */
  static mergeAll(mergeObj: Subscription | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: Subscription | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<Subscription | null> | null, spec?: UpsertSpec | null): ObjList<Subscription | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<Subscription | null> | null, spec?: UpsertSpec | null): ObjList<Subscription | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<Subscription | null> | null): ObjList<Subscription | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<Subscription | null> | null): ObjList<Subscription | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<Subscription | null> | null): ObjList<Subscription | null>;
   ...
   */
  static afterCreate(objs: C3.Array<Subscription | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<Subscription | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<Subscription | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<Subscription | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Subscription | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): Subscription | null;
   ...
   */
  withoutIdentity(): Subscription | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<Subscription | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: Subscription | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<Subscription | null> | null, callback?: λFunction<Subscription | null, Subscription | null> | null): ObjList<Subscription | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<Subscription | null> | null, callback?: λFunction<Subscription | null, Subscription | null> | null): C3.Array<ObjError | null>;
