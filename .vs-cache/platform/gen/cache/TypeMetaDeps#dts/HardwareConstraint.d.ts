// TypeScript definitions for the C3 type HardwareConstraint

/**
 * Represents minimal requirements for running computation.
 *
 * @remarks this represents a value passed to a method that expects an instance of HardwareConstraint
 */
declare interface IHardwareConstraint {
  ...
  minimum?: IHardwareSpec | null;
}

/**
 * Represents minimal requirements for running computation.
 *
 * @remarks this represents a made instance of HardwareConstraint
 */
declare class HardwareConstraint extends Obj {

  /**
   * The name of this instance.
   */
  readonly name?: string | null;
  withName(name: string | null): HardwareConstraint;

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): HardwareConstraint;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): HardwareConstraint;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): HardwareConstraint;

  /**
   * Cloud Provider Machine Type Name (ex: "n2d-standard-32" on gcp)
   */
  readonly instanceType?: string | null;
  withInstanceType(instanceType: string | null): HardwareConstraint;
  ...
  withGpuVendor(gpuVendor: string | null): HardwareConstraint;
  ...
  withGpuKind(gpuKind: string | null): HardwareConstraint;

  /**
   * Specifies the {@link HardwareAvailability} for a given VM.
   */
  readonly hardwareAvailability: string;
  withHardwareAvailability(hardwareAvailability: string): HardwareConstraint;
  ...
  withAcceleratorKind(acceleratorKind: string | null): HardwareConstraint;

  /**
   * The identifier of the Kubernetes node pool that serves as the scheduling target for the C3 node pool.
   */
  readonly computeKind?: string | null;
  withComputeKind(computeKind: string | null): HardwareConstraint;
   ...
   */
  readonly cpu: number;
  withCpu(cpu: number): HardwareConstraint;
  ...
  withMemoryMb(memoryMb: number): HardwareConstraint;
  ...
  withDiskGb(diskGb: number): HardwareConstraint;
   ...
   */
  readonly gpu: number;
  withGpu(gpu: number): HardwareConstraint;
  ...
  withGpuMemoryMb(gpuMemoryMb: number): HardwareConstraint;

  /**
   * The number of GPUs.
   */
  readonly acceleratorCount: number;
  withAcceleratorCount(acceleratorCount: number): HardwareConstraint;
  ...
  withCpuLimit(cpuLimit: number | null): HardwareConstraint;
  ...
  withMemoryMbLimit(memoryMbLimit: number | null): HardwareConstraint;
  ...
  withDiskGbLimit(diskGbLimit: number | null): HardwareConstraint;

  readonly minimum?: HardwareSpec | null;
  withMinimum(minimum: IHardwareSpec | null): HardwareConstraint;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): HardwareConstraint | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): HardwareConstraint | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): HardwareConstraint | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): HardwareConstraint | null;
   ...
   */
  replaceType(old: Type, new_: Type): HardwareConstraint;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HardwareConstraint;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HardwareConstraint;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HardwareConstraint | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HardwareConstraint | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): HardwareConstraint;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HardwareConstraint;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HardwareConstraint;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): HardwareConstraint;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): HardwareConstraint;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): HardwareConstraint;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): HardwareConstraint;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): HardwareConstraint;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): HardwareConstraint;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): HardwareConstraint;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): HardwareConstraint;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): HardwareConstraint;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): HardwareConstraint;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): HardwareConstraint;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): HardwareConstraint;
   ...
   * @see #unsetField
   */
  defaultField(field: string): HardwareConstraint;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): HardwareConstraint;
   ...
   * @see #removeField
   */
  unsetField(field: string): HardwareConstraint;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): HardwareConstraint;
   ...
   * @see #unsetField
   */
  removeField(field: string): HardwareConstraint;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): HardwareConstraint;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): HardwareConstraint;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): HardwareConstraint;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): HardwareConstraint;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): HardwareConstraint;

  mergeJson(json: any | null): HardwareConstraint;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): HardwareConstraint;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): HardwareConstraint;
   ...
   */
  singletonArray(): C3.Array<HardwareConstraint | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<HardwareConstraint | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<HardwareConstraint | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<HardwareConstraint | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<HardwareConstraint | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, HardwareConstraint | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, HardwareConstraint | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<HardwareConstraint | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<HardwareConstraint | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): HardwareConstraint;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): HardwareConstraint;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): HardwareConstraint;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): HardwareConstraint;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): HardwareConstraint;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): HardwareConstraint;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): HardwareConstraint;
   ...
   */
  static cachedEmptyInst(): HardwareConstraint;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<HardwareConstraint>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): HardwareConstraint;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<HardwareConstraint | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<HardwareConstraint | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<HardwareConstraint | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): HardwareConstraint | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): HardwareConstraint | null;
   ...
   * @see findByCacheKey
   */
  getCached(): HardwareConstraint | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): HardwareConstraint | null;
   ...
   */
  static produce(key: string): HardwareConstraint | null;
   ...
   */
  static produceAll(): C3.Map<string | null, HardwareConstraint | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, HardwareConstraint | null>;
   ...
   */
  static forConfigKey(configKey: string | null): HardwareConstraint | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<HardwareConstraint | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: HardwareConstraint, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: HardwareConstraint, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): HardwareConstraint | null;
   ...
   */
  removeSecrets(): HardwareConstraint | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): HardwareConstraint | null;

  /**
   * Validates that all required fields are set properly.
   */
  validate(): HardwareConstraint;

  validate(validatePartial: boolean | null): HardwareConstraint;
  ...
  /**
   * Aggregate hardware constraints of an input list into a single hardware constraint
   * that meets all requirements of the input.
   *
   * @param list
   *           List of {@link HardwareConstraint} we need to satisfy in aggregate.
   * @return a new instance of {@link HardwareConstraint} that satisfies all requirements of
   *         the constraints in the input list or `None` in case there are no constraints.
   */
  static max(list?: C3.Array<HardwareConstraint | null>): HardwareConstraint | null;

  /**
   * Returns {@link #minimum#acceleratorKind} if {@link #minimum} is specified, or null otherwise.
   */
  get minAcceleratorKind(): string | null;

  /**
   * Returns {@link #minimum#acceleratorCount} if {@link #minimum} is specified, or 0 otherwise.
   */
  get minAcceleratorCount(): number;

  /**
   * Represent minimum constraints for running C3 Server's JVM.
   */
  static jvmMin(): HardwareConstraint;

  /**
   * Resolves {@link HardwareConstraint constraint} to deployable {@link HardwareProfile}.
   *
   * @param available
   *           List of configs to search from [temporarily]
   * @return a new instance of {@link HardwareProfile} that satisfies {@link HardwareConstraint constraint}.
   *         `null` will be returned if no hardware {@link CloudCluster.NodePool#checkAvailable available}.
   */
  resolve(available?: C3.Array<CloudCluster.NodePool.Config | null>): HardwareProfile | null;
}
