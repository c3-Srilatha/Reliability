// TypeScript definitions for the C3 type SourceFileNameFormat

/**
 * Specifies config parameters for Canonical.process
 *
 * @remarks this represents a value passed to a method that expects an instance of SourceFileNameFormat
 */
declare interface ISourceFileNameFormat {
  ...
  /**
   * The format string with keywords in <>. Field names of CanonicalFieldInfo can be specified as keywords.
   * Specific value type of the keyword can be specified using a colon (:). The keywords are picked up automatically
   * from CanonicalFileNameInfo. There is special keyword 'customerFilePrefix' which can be defined on the canonical
   * and be used to determine the value of the field 'canonical'.
   * For e.g. C3_<customer>_Canonical_<canonical>_<timestamp:yyyyMMddHHmmssZ>_<locale>_<sequence>_<hash:md5>
   * timestamp
   *    supports Joda DateTimeFormat (http://joda-time.sourceforge.net/apidocs/org/joda/time/format/DateTimeFormat.html)
   *    default format is ISODateTimeFormat of yyyy-MM-dd'T'HH:mm:ss.SSSZZ
   * hash
   *    supports md5, sha1, cksum
   *    default is md5
   * separator in this example is underscore
   *
   * P.S. It is better to have a separator between keywords else file names might become unparseable.
   * Using special characters like '<', '-', '>' for separators will break the parsing. Having '/' in timestamp
   * will also break the parsing because '/' is used to distinguish file name from the file path.
   * Also, '<' and '>' are special characters, using them in the text or as separators will break the format parsing.
   */
  format: string;
}
 ...
 * Specifies config parameters for Canonical.process
 *
 * @remarks this represents a made instance of SourceFileNameFormat
 */
declare class SourceFileNameFormat extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): SourceFileNameFormat;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): SourceFileNameFormat;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): SourceFileNameFormat;
  ...
  withFormat(format: string): SourceFileNameFormat;

  /**
   * returns the file name format string
   */
  toString(): string | null;

  /**
   * make and return a SourceFileNameFormat object
   */
  static fromString(s: string | null): SourceFileNameFormat | null;
   ...
   * @see #fromString
   */
  static make(s: string | null): SourceFileNameFormat | null;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SourceFileNameFormat;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SourceFileNameFormat;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SourceFileNameFormat;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SourceFileNameFormat;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SourceFileNameFormat | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SourceFileNameFormat | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SourceFileNameFormat | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SourceFileNameFormat | null;
   ...
   */
  replaceType(old: Type, new_: Type): SourceFileNameFormat;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SourceFileNameFormat;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SourceFileNameFormat;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SourceFileNameFormat | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SourceFileNameFormat | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SourceFileNameFormat;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SourceFileNameFormat;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SourceFileNameFormat;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SourceFileNameFormat;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SourceFileNameFormat;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SourceFileNameFormat;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SourceFileNameFormat;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SourceFileNameFormat;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SourceFileNameFormat;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SourceFileNameFormat;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SourceFileNameFormat;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SourceFileNameFormat;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SourceFileNameFormat;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SourceFileNameFormat;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SourceFileNameFormat;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SourceFileNameFormat;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SourceFileNameFormat;
   ...
   * @see #removeField
   */
  unsetField(field: string): SourceFileNameFormat;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SourceFileNameFormat;
   ...
   * @see #unsetField
   */
  removeField(field: string): SourceFileNameFormat;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SourceFileNameFormat;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SourceFileNameFormat;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SourceFileNameFormat;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SourceFileNameFormat;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SourceFileNameFormat;

  mergeJson(json: any | null): SourceFileNameFormat;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SourceFileNameFormat;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SourceFileNameFormat;
   ...
   */
  singletonArray(): C3.Array<SourceFileNameFormat | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SourceFileNameFormat | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SourceFileNameFormat | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SourceFileNameFormat | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SourceFileNameFormat | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SourceFileNameFormat | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SourceFileNameFormat | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SourceFileNameFormat | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SourceFileNameFormat | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SourceFileNameFormat;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SourceFileNameFormat;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SourceFileNameFormat;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SourceFileNameFormat;
   ...
   */
  static cachedEmptyInst(): SourceFileNameFormat;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SourceFileNameFormat>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SourceFileNameFormat;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<SourceFileNameFormat | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<SourceFileNameFormat | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<SourceFileNameFormat | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): SourceFileNameFormat | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): SourceFileNameFormat | null;
   ...
   * @see findByCacheKey
   */
  getCached(): SourceFileNameFormat | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): SourceFileNameFormat | null;
   ...
   */
  static produce(key: string): SourceFileNameFormat | null;
   ...
   */
  static produceAll(): C3.Map<string | null, SourceFileNameFormat | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, SourceFileNameFormat | null>;
   ...
   */
  getConfig(): SourceFileNameFormat;
   ...
   */
  getSecret(): SourceFileNameFormat;
   ...
   */
  static forConfigKey(configKey: string | null): SourceFileNameFormat | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<SourceFileNameFormat | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: SourceFileNameFormat, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: SourceFileNameFormat, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): SourceFileNameFormat | null;
   ...
   */
  removeSecrets(): SourceFileNameFormat | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): SourceFileNameFormat | null;

  /**
   * validates the format; throws exception if it doesn't validate
   */
  validate(): SourceFileNameFormat;
  ...
  /**
   * parses and returns SourceFileInfo with each component
   */
  parseFileName(fileName: string): SourceFileInfo | null;
}
