// TypeScript definitions for the C3 type NotebookTester

/**
 * The {@link Tester} for testing JupyterNotebooks.
 *
 * @remarks this represents a value passed to a method that expects an instance of NotebookTester
 */
declare interface INotebookTester {
 ...
 * The {@link Tester} for testing JupyterNotebooks.
 *
 * @remarks this represents a made instance of NotebookTester
 */
declare class NotebookTester extends Obj {

  testRunner: TestRunner;
  withTestRunner(testRunner: ITestRunner): NotebookTester;
   ...
   */
  state: string;
  withState(state: string): NotebookTester;

  /**
   * The collected test results after the test execution.
   */
  results?: C3.Array<TestSuiteResult | null>;
  withResults(results: C3.Array<TestSuiteResult | null> | Array<ITestSuiteResult | null>): NotebookTester;

  /**
   * The action engine in which tests will execute.
   */
  engine: Action.Engine;
  withEngine(engine: IAction.Engine): NotebookTester;

  /**
   * Construct an instance with initial state.
   */
  static make(): NotebookTester;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): NotebookTester;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): NotebookTester;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): NotebookTester;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): NotebookTester;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): NotebookTester | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): NotebookTester | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): NotebookTester | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): NotebookTester | null;
   ...
   */
  replaceType(old: Type, new_: Type): NotebookTester;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NotebookTester;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NotebookTester;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NotebookTester | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NotebookTester | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): NotebookTester;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NotebookTester;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NotebookTester;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): NotebookTester;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): NotebookTester;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): NotebookTester;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): NotebookTester;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): NotebookTester;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): NotebookTester;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): NotebookTester;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): NotebookTester;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): NotebookTester;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): NotebookTester;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): NotebookTester;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): NotebookTester;
   ...
   * @see #unsetField
   */
  defaultField(field: string): NotebookTester;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): NotebookTester;
   ...
   * @see #removeField
   */
  unsetField(field: string): NotebookTester;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): NotebookTester;
   ...
   * @see #unsetField
   */
  removeField(field: string): NotebookTester;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): NotebookTester;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): NotebookTester;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): NotebookTester;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): NotebookTester;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): NotebookTester;

  mergeJson(json: any | null): NotebookTester;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): NotebookTester;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): NotebookTester;
   ...
   */
  singletonArray(): C3.Array<NotebookTester | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<NotebookTester | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<NotebookTester | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<NotebookTester | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<NotebookTester | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, NotebookTester | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, NotebookTester | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<NotebookTester | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<NotebookTester | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): NotebookTester;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): NotebookTester;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): NotebookTester;
   ...
   */
  static cachedEmptyInst(): NotebookTester;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<NotebookTester>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): NotebookTester;
   ...
   * @return this Obj
   */
  setField(field: string, value: any, doNotConvert?: boolean): NotebookTester;
   ...
   * @return this Obj
   */
  setField(field: FieldType, value: any, doNotConvert?: boolean): NotebookTester;
   ...
   */
  static forPathAndEngine(path: string, engine: string): NotebookTester;
   ...
   * Note: invoke this API on the desired type of Tester instead of on the Tester type directly.
   */
  static forNameAndEngine(testName: string, engine: string): NotebookTester;
   ...
   * Note: invoke this API on the desired type of Tester instead of on the Tester type directly.
   */
  static forEngine(engine: string, deep?: boolean): NotebookTester;
   ...
   */
  run(spec?: TesterRunSpec | null): NotebookTester;
  ...
  /**
   * Helper API for tests running as part of NotebookTester.
   * escalates the privilege for K8sAPIServer#isHealthy call if the original call is
   * originated from NotebookTester#runCellsTest and NotebookTester#runTestSuiteCode
   */
  static isK8sHealthy(): boolean;

  /**
   * Endpoint to use from JupyterLab.
   *
   * @param sessionPath
   *   If set, use this path to create the session used to run the test. It should refer to
   *   a randomized file name in the same directory as the notebook. The test can then be
   *   canceled by terminating the session, which can be looked up by the path.
   *
   *   If not specified, a path will be randomly generated,
   */
  runCellsTest(cells: C3.Array<JupyterNotebook.Cell>, kernelName: string, notebookName?: string | null, notebookPath?: string | null, sessionPath?: string | null, spec?: JupyterLab.Session.CellExecutionSpec | null): TestSuiteResult;
}
