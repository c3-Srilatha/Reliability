// TypeScript definitions for the C3 type Data.Spark.DatetimeIndexImpl
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Data.Spark.DatetimeIndexImpl
 */
declare namespace Data.Spark {
  export interface IDatetimeIndexImpl {
 ...
 */
declare namespace Data.Spark {
  export class DatetimeIndexImpl extends Obj {
    ...
    withEngine(engine: IData.ExecutionEngine | null): Data.Spark.DatetimeIndexImpl;

    /**
     * The plan that used to actualize this Data.Spark instance
     */
    pipeline?: PipelineSpec | null;
    withPipeline(pipeline: IPipelineSpec | null): Data.Spark.DatetimeIndexImpl;

    /**
     * The id number that represent this Data.Spark instance
     */
    nodeId?: string | null;
    withNodeId(nodeId: string | null): Data.Spark.DatetimeIndexImpl;

    /**
     * The output name of the pipeline
     */
    outputId?: string | null;
    withOutputId(outputId: string | null): Data.Spark.DatetimeIndexImpl;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.Spark.DatetimeIndexImpl | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.Spark.DatetimeIndexImpl | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.Spark.DatetimeIndexImpl | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.Spark.DatetimeIndexImpl | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.Spark.DatetimeIndexImpl;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Spark.DatetimeIndexImpl;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Spark.DatetimeIndexImpl;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Spark.DatetimeIndexImpl | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Spark.DatetimeIndexImpl | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.Spark.DatetimeIndexImpl;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Spark.DatetimeIndexImpl;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Spark.DatetimeIndexImpl;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.Spark.DatetimeIndexImpl;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.Spark.DatetimeIndexImpl;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.Spark.DatetimeIndexImpl;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.Spark.DatetimeIndexImpl;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.Spark.DatetimeIndexImpl;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.Spark.DatetimeIndexImpl;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.Spark.DatetimeIndexImpl;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.Spark.DatetimeIndexImpl;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.Spark.DatetimeIndexImpl;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.Spark.DatetimeIndexImpl;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.Spark.DatetimeIndexImpl;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.Spark.DatetimeIndexImpl;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.Spark.DatetimeIndexImpl;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.Spark.DatetimeIndexImpl;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.Spark.DatetimeIndexImpl;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.Spark.DatetimeIndexImpl;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.Spark.DatetimeIndexImpl;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.Spark.DatetimeIndexImpl;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.Spark.DatetimeIndexImpl;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.Spark.DatetimeIndexImpl;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.Spark.DatetimeIndexImpl;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.Spark.DatetimeIndexImpl;

    mergeJson(json: any | null): Data.Spark.DatetimeIndexImpl;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.Spark.DatetimeIndexImpl;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.Spark.DatetimeIndexImpl;
     ...
     */
    singletonArray(): C3.Array<Data.Spark.DatetimeIndexImpl | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.Spark.DatetimeIndexImpl | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.Spark.DatetimeIndexImpl | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.Spark.DatetimeIndexImpl | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.Spark.DatetimeIndexImpl | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.Spark.DatetimeIndexImpl | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.Spark.DatetimeIndexImpl | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.Spark.DatetimeIndexImpl | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.Spark.DatetimeIndexImpl | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.Spark.DatetimeIndexImpl;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.Spark.DatetimeIndexImpl;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.Spark.DatetimeIndexImpl;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.Spark.DatetimeIndexImpl;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.Spark.DatetimeIndexImpl;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.Spark.DatetimeIndexImpl;

    /**
     * Construct an instance with initial state.
     */
    static make(): Data.Spark.DatetimeIndexImpl;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.Spark.DatetimeIndexImpl;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Data.Spark.DatetimeIndexImpl;
     ...
     */
    static cachedEmptyInst(): Data.Spark.DatetimeIndexImpl;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.Spark.DatetimeIndexImpl>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.Spark.DatetimeIndexImpl;

    get day(): any;

    get day_of_week(): Data.Spark.Series | null | Data.Spark.Index | null | null;

    get day_of_year(): any;

    get dayofweek(): Data.Spark.Series | null | Data.Spark.Index | null | null;
    ...
    get is_leap_year(): Data.Spark.Index | null;

    get is_month_end(): Data.Spark.Index | null;

    get is_month_start(): Data.Spark.Index | null;

    get is_quarter_end(): Data.Spark.Index | null;

    get is_quarter_start(): Data.Spark.Index | null;

    get is_year_end(): Data.Spark.Index | null;

    get is_year_start(): Data.Spark.Index | null;
    ...
    get weekday(): Data.Spark.Series | null | Data.Spark.Index | null | null;

    get weekofyear(): any;

    get year(): any;

    ceil(freq?: any): Data.Spark.DatetimeIndex | null;

    day_name(locale?: string | null): Data.Spark.Index | null;

    floor(freq?: any): Data.Spark.DatetimeIndex | null;

    indexer_at_time(time?: any, asof?: boolean | null): Data.Spark.Index | null;

    indexer_between_time(start_time?: any, end_time?: any, include_start?: boolean | null, include_end?: boolean | null): Data.Spark.Index | null;

    month_name(locale?: string | null): Data.Spark.Index | null;

    normalize(): Data.Spark.DatetimeIndex | null;

    round(freq?: any): Data.Spark.DatetimeIndex | null;

    strftime(date_format?: string | null): Data.Spark.Index | null;
     ...
     * @return this Obj
     */
    setField(field: string, value: any, doNotConvert?: boolean): Data.Spark.DatetimeIndexImpl;
     ...
     * @return this Obj
     */
    setField(field: FieldType, value: any, doNotConvert?: boolean): Data.Spark.DatetimeIndexImpl;
