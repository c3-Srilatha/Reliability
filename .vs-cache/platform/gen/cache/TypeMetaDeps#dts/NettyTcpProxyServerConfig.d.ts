// TypeScript definitions for the C3 type NettyTcpProxyServerConfig

/**
 * @remarks this represents a value passed to a method that expects an instance of NettyTcpProxyServerConfig
 */
declare interface INettyTcpProxyServerConfig {

  SO_BACKLOG?: number | null;

  SO_BROADCAST?: boolean;

  SO_KEEPALIVE?: boolean;

  SO_LINGER?: number | null;

  SO_RCVBUF?: number | null;

  SO_REUSEADDR?: boolean;

  SO_SNDBUF?: number | null;

  SO_TIMEOUT?: number | null;

  TCP_NODELAY?: boolean;

  connectionTimeoutMillis?: number | null;

  maxMessagesPerRead?: number | null;

  writeBufHighWaterMark?: number | null;

  writeBufLowWaterMark?: number | null;
  ...
  masterThreadCount?: number | null;

  workerThreadCount?: number | null;
}

/**
 * @remarks this represents a made instance of NettyTcpProxyServerConfig
 */
declare class NettyTcpProxyServerConfig extends Obj {

  readonly SO_BACKLOG?: number | null;
  withSO_BACKLOG(SO_BACKLOG: number | null): NettyTcpProxyServerConfig;

  readonly SO_BROADCAST?: boolean;
  withSO_BROADCAST(SO_BROADCAST: boolean): NettyTcpProxyServerConfig;

  readonly SO_KEEPALIVE?: boolean;
  withSO_KEEPALIVE(SO_KEEPALIVE: boolean): NettyTcpProxyServerConfig;

  readonly SO_LINGER?: number | null;
  withSO_LINGER(SO_LINGER: number | null): NettyTcpProxyServerConfig;

  readonly SO_RCVBUF?: number | null;
  withSO_RCVBUF(SO_RCVBUF: number | null): NettyTcpProxyServerConfig;

  readonly SO_REUSEADDR?: boolean;
  withSO_REUSEADDR(SO_REUSEADDR: boolean): NettyTcpProxyServerConfig;

  readonly SO_SNDBUF?: number | null;
  withSO_SNDBUF(SO_SNDBUF: number | null): NettyTcpProxyServerConfig;

  readonly SO_TIMEOUT?: number | null;
  withSO_TIMEOUT(SO_TIMEOUT: number | null): NettyTcpProxyServerConfig;

  readonly TCP_NODELAY?: boolean;
  withTCP_NODELAY(TCP_NODELAY: boolean): NettyTcpProxyServerConfig;

  readonly connectionTimeoutMillis?: number | null;
  withConnectionTimeoutMillis(connectionTimeoutMillis: number | null): NettyTcpProxyServerConfig;

  readonly maxMessagesPerRead?: number | null;
  withMaxMessagesPerRead(maxMessagesPerRead: number | null): NettyTcpProxyServerConfig;

  readonly writeBufHighWaterMark?: number | null;
  withWriteBufHighWaterMark(writeBufHighWaterMark: number | null): NettyTcpProxyServerConfig;

  readonly writeBufLowWaterMark?: number | null;
  withWriteBufLowWaterMark(writeBufLowWaterMark: number | null): NettyTcpProxyServerConfig;

  /**
   * The name of this instance.
   */
  readonly name?: string | null;
  withName(name: string | null): NettyTcpProxyServerConfig;

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): NettyTcpProxyServerConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): NettyTcpProxyServerConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): NettyTcpProxyServerConfig;

  readonly masterThreadCount?: number | null;
  withMasterThreadCount(masterThreadCount: number | null): NettyTcpProxyServerConfig;

  readonly workerThreadCount?: number | null;
  withWorkerThreadCount(workerThreadCount: number | null): NettyTcpProxyServerConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): NettyTcpProxyServerConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): NettyTcpProxyServerConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): NettyTcpProxyServerConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): NettyTcpProxyServerConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): NettyTcpProxyServerConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NettyTcpProxyServerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NettyTcpProxyServerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NettyTcpProxyServerConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NettyTcpProxyServerConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): NettyTcpProxyServerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NettyTcpProxyServerConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NettyTcpProxyServerConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): NettyTcpProxyServerConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): NettyTcpProxyServerConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): NettyTcpProxyServerConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): NettyTcpProxyServerConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): NettyTcpProxyServerConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): NettyTcpProxyServerConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): NettyTcpProxyServerConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): NettyTcpProxyServerConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): NettyTcpProxyServerConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): NettyTcpProxyServerConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): NettyTcpProxyServerConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): NettyTcpProxyServerConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): NettyTcpProxyServerConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): NettyTcpProxyServerConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): NettyTcpProxyServerConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): NettyTcpProxyServerConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): NettyTcpProxyServerConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): NettyTcpProxyServerConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): NettyTcpProxyServerConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): NettyTcpProxyServerConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): NettyTcpProxyServerConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): NettyTcpProxyServerConfig;

  mergeJson(json: any | null): NettyTcpProxyServerConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): NettyTcpProxyServerConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): NettyTcpProxyServerConfig;
   ...
   */
  singletonArray(): C3.Array<NettyTcpProxyServerConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<NettyTcpProxyServerConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<NettyTcpProxyServerConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<NettyTcpProxyServerConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<NettyTcpProxyServerConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, NettyTcpProxyServerConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, NettyTcpProxyServerConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<NettyTcpProxyServerConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<NettyTcpProxyServerConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): NettyTcpProxyServerConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): NettyTcpProxyServerConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): NettyTcpProxyServerConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): NettyTcpProxyServerConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): NettyTcpProxyServerConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): NettyTcpProxyServerConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): NettyTcpProxyServerConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): NettyTcpProxyServerConfig;
   ...
   */
  static cachedEmptyInst(): NettyTcpProxyServerConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<NettyTcpProxyServerConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): NettyTcpProxyServerConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<NettyTcpProxyServerConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<NettyTcpProxyServerConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<NettyTcpProxyServerConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): NettyTcpProxyServerConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): NettyTcpProxyServerConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): NettyTcpProxyServerConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): NettyTcpProxyServerConfig | null;
   ...
   */
  static produce(key: string): NettyTcpProxyServerConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, NettyTcpProxyServerConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, NettyTcpProxyServerConfig | null>;
   ...
   */
  getConfig(): NettyTcpProxyServerConfig;
   ...
   */
  getSecret(): NettyTcpProxyServerConfig;
   ...
   */
  static forConfigKey(configKey: string | null): NettyTcpProxyServerConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<NettyTcpProxyServerConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: NettyTcpProxyServerConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: NettyTcpProxyServerConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): NettyTcpProxyServerConfig | null;
