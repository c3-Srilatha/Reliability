// TypeScript definitions for the C3 type TestUser

/**
 * @remarks this represents a value passed to a method that expects an instance of TestUser
 */
declare interface ITestUser {
   ...
   */
  groups?: C3.Array<UserGroup> | Array<IUserGroup>;
   ...
   */
  idpGroups?: C3.Array<UserGroup> | Array<IUserGroup>;

  /**
   * List of groups that the user was assigned from the idp.
   * Mapping from string serialized idp to idp-assigned groups
   */
  idpAssignedGroups?: C3.Map<string | null, C3.Array<string | null> | null> | {[key: string | null]: C3.Array<string | null> | Array<string | null> | null};

  /**
   * All the groups that the user is assigned from c3 server
   */
  c3Groups?: C3.Array<UserGroup> | Array<IUserGroup>;
  ...
  /**
   * Determines whether this user is locked or not.
   */
  locked?: boolean;
  ...
  /**
   * Role associated to the TestUser
   */
  testRoles?: C3.Array<Role | null> | Array<IRole | null>;

  /**
   * ObjectId of the User within the OIDC provider
   */
  oidcUserObjectId?: string | null;
}

/**
 * @remarks this represents a made instance of TestUser
 */
declare class TestUser extends Obj {
  ...
  withLoginAttempts(loginAttempts: number | null): TestUser;

  /**
   * If this User Identity is managed by an external resource (idp)
   */
  readonly externalSource?: string | null;
  withExternalSource(externalSource: string | null): TestUser;

  /**
   * Id of external resource mapping if this User Identity is managed by an external resource (idp)
   */
  readonly externalSourceId?: string | null;
  withExternalSourceId(externalSourceId: string | null): TestUser;
   ...
   * Changing it logs-out/revokes the c3Auth of the previous generation
   */
  readonly c3AuthSalt?: string | null;
  withC3AuthSalt(c3AuthSalt: string | null): TestUser;

  /**
   * Field used to prevent tampering with group membership during impersonation
   */
  readonly sealGroupMembership?: number | null;
  withSealGroupMembership(sealGroupMembership: number | null): TestUser;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): TestUser;
  ...
  withMeta(meta: IMeta | null): TestUser;
  ...
  withVersion(version: number | null): TestUser;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): TestUser;

  /**
   * Idp userId
   */
  readonly idpUserId?: string | null;
  withIdpUserId(idpUserId: string | null): TestUser;

  /**
   * User's email address.
   */
  readonly email?: string | null;
  withEmail(email: string | null): TestUser;

  /**
   * User's last name.
   */
  readonly lastName?: string | null;
  withLastName(lastName: string | null): TestUser;

  /**
   * User's first name
   */
  readonly firstName?: string | null;
  withFirstName(firstName: string | null): TestUser;

  /**
   * User's public key
   */
  readonly publicKey?: string | null;
  withPublicKey(publicKey: string | null): TestUser;

  /**
   * Okta user id.
   */
  readonly oktaUserId?: string | null;
  withOktaUserId(oktaUserId: string | null): TestUser;

  /**
   * Identity provider which manages this user.
   */
  readonly idp?: IdentityProvider<IdpConfig | null> | null;
  withIdp(idp: IIdentityProvider<IdpConfig | null> | null): TestUser;

  /**
   * List of {@link Env} this user have access to or have logged in
   */
  readonly envs?: C3.Array<Env | null>;
  withEnvs(envs: C3.Array<Env | null> | Array<IEnv | null>): TestUser;

  /**
   * List of {@link App} this user have access to or have logged in
   */
  readonly apps?: C3.Array<App | null>;
  withApps(apps: C3.Array<App | null> | Array<IApp | null>): TestUser;

  /**
   * User's session index for SAML login
   */
  readonly samlSessionIndex?: string | null;
  withSamlSessionIndex(samlSessionIndex: string | null): TestUser;

  /**
   * User's session sequence for C3 login
   */
  readonly sessionSequence: number;
  withSessionSequence(sessionSequence: number): TestUser;

  /**
   * All the {@link UserGroup}s this user is a member of.
   */
  readonly groups?: C3.Array<UserGroup>;
  withGroups(groups: C3.Array<UserGroup> | Array<IUserGroup>): TestUser;
   ...
   * On login, the newly received idpGroups will be assigned to the User if there are differences between the two.
   */
  readonly idpGroups?: C3.Array<UserGroup>;
  withIdpGroups(idpGroups: C3.Array<UserGroup> | Array<IUserGroup>): TestUser;

  /**
   * List of groups that the user was assigned from the idp.
   * Mapping from string serialized idp to idp-assigned groups
   */
  readonly idpAssignedGroups?: C3.Map<string | null, C3.Array<string | null> | null>;
  withIdpAssignedGroups(idpAssignedGroups: C3.Map<string | null, C3.Array<string | null> | null> | {[key: string | null]: C3.Array<string | null> | Array<string | null> | null}): TestUser;

  /**
   * All the groups that the user is assigned from c3 server
   */
  readonly c3Groups?: C3.Array<UserGroup>;
  withC3Groups(c3Groups: C3.Array<UserGroup> | Array<IUserGroup>): TestUser;

  /**
   * passcode field
   */
  readonly passcode?: string | null;
  withPasscode(passcode: string | null): TestUser;

  /**
   * Determines whether this user is locked or not.
   */
  readonly locked?: boolean;
  withLocked(locked: boolean): TestUser;

  /**
   * Private key for the User
   */
  readonly privateKey?: string | null;
  withPrivateKey(privateKey: string | null): TestUser;

  /**
   * Role associated to the TestUser
   */
  readonly testRoles?: C3.Array<Role | null>;
  withTestRoles(testRoles: C3.Array<Role | null> | Array<IRole | null>): TestUser;

  /**
   * ObjectId of the User within the OIDC provider
   */
  readonly oidcUserObjectId?: string | null;
  withOidcUserObjectId(oidcUserObjectId: string | null): TestUser;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TestUser | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TestUser | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TestUser | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TestUser | null;
   ...
   */
  replaceType(old: Type, new_: Type): TestUser;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestUser;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TestUser;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestUser | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TestUser | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TestUser;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestUser;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TestUser;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TestUser;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TestUser;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TestUser;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TestUser;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TestUser;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TestUser;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TestUser;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TestUser;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TestUser;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TestUser;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TestUser;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TestUser;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TestUser;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TestUser;
   ...
   * @see #removeField
   */
  unsetField(field: string): TestUser;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TestUser;
   ...
   * @see #unsetField
   */
  removeField(field: string): TestUser;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TestUser;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TestUser;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TestUser;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TestUser;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TestUser;

  mergeJson(json: any | null): TestUser;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TestUser;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TestUser;
   ...
   */
  singletonArray(): C3.Array<TestUser | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TestUser | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TestUser | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TestUser | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TestUser | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TestUser | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TestUser | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TestUser | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TestUser | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TestUser;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TestUser;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TestUser;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TestUser;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TestUser;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TestUser;
   ...
   * @see #fromString
   */
  static make(s: string | null): TestUser | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TestUser;
   ...
   */
  static cachedEmptyInst(): TestUser;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TestUser>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TestUser;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TestUser | null;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TestUser | null;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<TestUser | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<TestUser | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<TestUser | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): TestUser | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string | null): TestUser | null;
   ...
   * @see findByCacheKey
   */
  getCached(): TestUser | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): TestUser | null;
   ...
   */
  static produce(key: string): TestUser | null;
   ...
   */
  static produceAll(): C3.Map<string | null, TestUser | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, TestUser | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TestUser | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TestUser | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TestUser | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TestUser | null> | null>;
   ...
   */
  get(include?: string | null): TestUser | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TestUser | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TestUser;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TestUser | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TestUser;
   ...
   */
  create(spec?: UpsertSpec | null): TestUser | null;
   ...
   */
  static createBatch(objs: C3.Array<TestUser | null> | null, spec?: UpsertSpec | null): ObjList<TestUser | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TestUser | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TestUser | null> | null;
   ...
   */
  update(srcObj?: TestUser | null, spec?: UpsertSpec | null): TestUser | null;
   ...
   */
  upsert(srcObj?: TestUser | null, spec?: UpsertSpec | null): TestUser | null;
   ...
   */
  merge(spec?: MergeSpec | null): TestUser | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TestUser | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TestUser | null;
   ...
   */
  static updateBatch(objs: C3.Array<TestUser | null> | null, srcObjs?: C3.Array<TestUser | null>, spec?: UpsertSpec | null): ObjList<TestUser | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TestUser | null>>, spec?: UpsertSpec | null): ObjList<TestUser | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TestUser | null> | null, srcObjs?: C3.Array<TestUser | null>, spec?: UpsertSpec | null): ObjList<TestUser | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TestUser | null>>, spec?: UpsertSpec | null): ObjList<TestUser | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TestUser | null> | null, spec?: TouchSpec | null): ObjList<TestUser | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestUser | null> | null, spec?: MergeSpec | null): ObjList<TestUser | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TestUser | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestUser | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TestUser | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TestUser | null> | null;
   ...
   */
  static mergeAll(mergeObj: TestUser | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TestUser | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TestUser | null> | null, spec?: UpsertSpec | null): ObjList<TestUser | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TestUser | null> | null, spec?: UpsertSpec | null): ObjList<TestUser | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TestUser | null> | null): ObjList<TestUser | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TestUser | null> | null): ObjList<TestUser | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TestUser | null> | null): ObjList<TestUser | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TestUser | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TestUser | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TestUser | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TestUser | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TestUser | null>;
   ...
   */
  static typeOfBatch(objs: C3.Array<TestUser | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TestUser | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TestUser | null> | null, callback?: λFunction<TestUser | null, TestUser | null> | null): ObjList<TestUser | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TestUser | null> | null, callback?: λFunction<TestUser | null, TestUser | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static mySessionToken(): SessionToken;
   ...
   */
  generateSessionToken(expiry?: DateTime | null): SessionToken;
   ...
   * @return the User object.
   */
  static addUsersToGroup(userIds: C3.Array<string | null>, groupId: string): C3.Array<User | null>;
   ...
   *           the c3 UserGroup id.
   */
  static removeUsersFromGroup(userIds: C3.Array<string | null>, groupId: string): C3.Array<User | null>;
   ...
   */
  allGroups(): C3.Array<UserGroup | null>;
   ...
   */
  allPermissions(): C3.Array<Permission | null>;
   ...
   */
  allDataPermissions(): C3.Array<DataPermission | null>;
   ...
   * @return applications
   */
  allApps(consoleAccess?: boolean): C3.Array<App | null>;
   ...
   * @return applications
   */
  allApps(appUrl: AppUrl, consoleAccess?: boolean): C3.Array<App | null>;
   ...
   * @return environments
   */
  allEnvs(consoleAccess?: boolean): C3.Array<Env | null>;
   ...
   */
  lastLogin(): User.Event.Login | null;
   ...
   */
  lastLoginInApp(app: string): DateTime | null;
   ...
   */
  static lastLogins(userIds?: C3.Array<string>): C3.Array<User.Event.Login | null>;
   ...
   */
  static lastLoginsInApp(userIds?: C3.Array<string>, app: string): C3.Array<User.Event.Login | null>;
   ...
   */
  allPageGroups(): C3.Array<PageGroup | null>;
   ...
   */
  static isApp(userId: string): boolean;
   ...
   */
  static provisioner(): User;

  /**
   * @return list of reserved user names.
   */
  static reservedUsers(): C3.Array<string | null>;

  /**
   * @return list of system user names.
   */
  static systemUsers(): C3.Array<string | null>;

  /**
   * @return list of strictly test system user names.
   */
  static systemTestUsers(): C3.Array<string | null>;
   ...
   */
  static upsertUser(user: User): boolean;

  /**
   * Persists a new login event for a specific application
   */
  static newLoginEvent(userId: string, appId: string): User.Event.Login | null;
