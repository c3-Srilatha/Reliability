// TypeScript definitions for the C3 type JsBrowserTester
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of JsBrowserTester
 */
declare interface IJsBrowserTester {
 ...
 */
declare class JsBrowserTester extends Obj {

  /**
   * Whether or not tests should be executed in headless mode.
   */
  headless?: boolean;
  withHeadless(headless: boolean): JsBrowserTester;
   ...
   */
  testerHtmlPagePath?: string | null;
  withTesterHtmlPagePath(testerHtmlPagePath: string | null): JsBrowserTester;

  testRunner: TestRunner;
  withTestRunner(testRunner: ITestRunner): JsBrowserTester;
   ...
   */
  state: string;
  withState(state: string): JsBrowserTester;

  /**
   * The collected test results after the test execution.
   */
  results?: C3.Array<TestSuiteResult | null>;
  withResults(results: C3.Array<TestSuiteResult | null> | Array<ITestSuiteResult | null>): JsBrowserTester;

  /**
   * The action engine in which tests will execute.
   */
  engine: Action.Engine;
  withEngine(engine: IAction.Engine): JsBrowserTester;

  /**
   * If true, loads the type system and "tester" bundle before running the test
   */
  importTypes?: boolean;
  withImportTypes(importTypes: boolean): JsBrowserTester;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): JsBrowserTester | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): JsBrowserTester | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): JsBrowserTester | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): JsBrowserTester | null;
   ...
   */
  replaceType(old: Type, new_: Type): JsBrowserTester;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JsBrowserTester;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): JsBrowserTester;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JsBrowserTester | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<JsBrowserTester | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): JsBrowserTester;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JsBrowserTester;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): JsBrowserTester;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): JsBrowserTester;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): JsBrowserTester;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): JsBrowserTester;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): JsBrowserTester;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): JsBrowserTester;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): JsBrowserTester;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): JsBrowserTester;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): JsBrowserTester;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): JsBrowserTester;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): JsBrowserTester;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): JsBrowserTester;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): JsBrowserTester;
   ...
   * @see #unsetField
   */
  defaultField(field: string): JsBrowserTester;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): JsBrowserTester;
   ...
   * @see #removeField
   */
  unsetField(field: string): JsBrowserTester;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): JsBrowserTester;
   ...
   * @see #unsetField
   */
  removeField(field: string): JsBrowserTester;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): JsBrowserTester;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): JsBrowserTester;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): JsBrowserTester;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): JsBrowserTester;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): JsBrowserTester;

  mergeJson(json: any | null): JsBrowserTester;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): JsBrowserTester;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): JsBrowserTester;
   ...
   */
  singletonArray(): C3.Array<JsBrowserTester | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<JsBrowserTester | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<JsBrowserTester | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<JsBrowserTester | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<JsBrowserTester | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, JsBrowserTester | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, JsBrowserTester | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<JsBrowserTester | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<JsBrowserTester | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): JsBrowserTester;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): JsBrowserTester;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): JsBrowserTester;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): JsBrowserTester;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): JsBrowserTester;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): JsBrowserTester;

  /**
   * Construct an instance with initial state.
   */
  static make(): JsBrowserTester;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): JsBrowserTester;
   ...
   */
  static cachedEmptyInst(): JsBrowserTester;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<JsBrowserTester>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): JsBrowserTester;
   ...
   * @return this Obj
   */
  setField(field: string, value: any, doNotConvert?: boolean): JsBrowserTester;
   ...
   * @return this Obj
   */
  setField(field: FieldType, value: any, doNotConvert?: boolean): JsBrowserTester;
   ...
   */
  static forPathAndEngine(path: string, engine: string): JsBrowserTester;
   ...
   * Note: invoke this API on the desired type of Tester instead of on the Tester type directly.
   */
  static forNameAndEngine(testName: string, engine: string): JsBrowserTester;
   ...
   * Note: invoke this API on the desired type of Tester instead of on the Tester type directly.
   */
  static forEngine(engine: string, deep?: boolean): JsBrowserTester;
   ...
   */
  run(spec?: TesterRunSpec | null): JsBrowserTester;
