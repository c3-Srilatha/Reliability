// TypeScript definitions for the C3 type SourcesValue

/**
 * This type represents the values of {@link Sources}
 * for eg. for [Source]
 *
 * @remarks this represents a value passed to a method that expects an instance of SourcesValue
 */
declare interface ISourcesValue {
   ...
   */
  value: IBufferedStream<Obj | null>;
}
 ...
 */
declare class SourcesValue extends Obj {
  ...
  withContentEncoding(contentEncoding: string | null): SourcesValue;
  ...
  withContentLanguage(contentLanguage: string | null): SourcesValue;
  ...
  withContentLength(contentLength: number | null): SourcesValue;
  ...
  withContentLocation(contentLocation: string | null): SourcesValue;
  ...
  withContentType(contentType: string | null): SourcesValue;
  ...
  withContentDisposition(contentDisposition: string | null): SourcesValue;
  ...
  withETag(eTag: string | null): SourcesValue;
  ...
  withLastModified(lastModified: DateTime | Date | string | null): SourcesValue;

  /**
   * Id of user / identity who last last modified this content.
   */
  readonly lastModifiedBy?: string | null;
  withLastModifiedBy(lastModifiedBy: string | null): SourcesValue;
  ...
  withContentMD5(contentMD5: string | null): SourcesValue;
  ...
  withContentSHA1(contentSHA1: string | null): SourcesValue;

  /**
   * The unique and required id of this instance.
   */
  readonly id: string;
  withId(id: string): SourcesValue;

  /**
   * Source collection id for this source is stored.
   */
  readonly sourceCollectionName: string;
  withSourceCollectionName(sourceCollectionName: string): SourcesValue;

  /**
   * Meta information for the processing of the sources
   */
  readonly sourcesMeta?: Obj | null;
  withSourcesMeta(sourcesMeta: IObj | null): SourcesValue;

  /**
   * value of Source objs
   */
  readonly value: BufferedStream<Obj | null>;
  withValue(value: IBufferedStream<Obj | null>): SourcesValue;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SourcesValue | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SourcesValue | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SourcesValue | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SourcesValue | null;
   ...
   */
  replaceType(old: Type, new_: Type): SourcesValue;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SourcesValue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SourcesValue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SourcesValue | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SourcesValue | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SourcesValue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SourcesValue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SourcesValue;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SourcesValue;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SourcesValue;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SourcesValue;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SourcesValue;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SourcesValue;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SourcesValue;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SourcesValue;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SourcesValue;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SourcesValue;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SourcesValue;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SourcesValue;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SourcesValue;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SourcesValue;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SourcesValue;
   ...
   * @see #removeField
   */
  unsetField(field: string): SourcesValue;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SourcesValue;
   ...
   * @see #unsetField
   */
  removeField(field: string): SourcesValue;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SourcesValue;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SourcesValue;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SourcesValue;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SourcesValue;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SourcesValue;

  mergeJson(json: any | null): SourcesValue;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SourcesValue;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SourcesValue;
   ...
   */
  singletonArray(): C3.Array<SourcesValue | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SourcesValue | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SourcesValue | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SourcesValue | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SourcesValue | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SourcesValue | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SourcesValue | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SourcesValue | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SourcesValue | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SourcesValue;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SourcesValue;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SourcesValue;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SourcesValue;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SourcesValue;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SourcesValue;
   ...
   * @see #fromString
   */
  static make(s: string | null): SourcesValue | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SourcesValue;
   ...
   */
  static cachedEmptyInst(): SourcesValue;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SourcesValue>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SourcesValue;
   ...
   */
  withFileName(fileName: string | null): SourcesValue;

  /**
   * Changes file extension in this instance.
   */
  withFileExt(fileExt: string | null): SourcesValue;
   ...
   */
  identify(suffix?: string | null): SourcesValue;
   ...
   * @see #toString
   */
  static fromString(s: string | null): SourcesValue | null;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): SourcesValue | null;
