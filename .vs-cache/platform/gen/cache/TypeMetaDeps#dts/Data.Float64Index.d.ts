// TypeScript definitions for the C3 type Data.Float64Index

/**
 * Abstract interface representing the pandas Float64Index class.
 *
 * @remarks this represents a value passed to a method that expects an instance of Data.Float64Index
 */
 ...
 */
declare namespace Data {
  export class Float64Index extends Obj {
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.Float64Index | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.Float64Index | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.Float64Index | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.Float64Index | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.Float64Index;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Float64Index;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Float64Index;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Float64Index | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Float64Index | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.Float64Index;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Float64Index;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Float64Index;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.Float64Index;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.Float64Index;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.Float64Index;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.Float64Index;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.Float64Index;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.Float64Index;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.Float64Index;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.Float64Index;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.Float64Index;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.Float64Index;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.Float64Index;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.Float64Index;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.Float64Index;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.Float64Index;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.Float64Index;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.Float64Index;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.Float64Index;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.Float64Index;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.Float64Index;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.Float64Index;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.Float64Index;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.Float64Index;

    mergeJson(json: any | null): Data.Float64Index;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.Float64Index;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.Float64Index;
     ...
     */
    singletonArray(): C3.Array<Data.Float64Index | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.Float64Index | null>;
     ...
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.Float64Index | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.Float64Index | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.Float64Index | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.Float64Index | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.Float64Index | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.Float64Index | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.Float64Index | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.Float64Index;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.Float64Index;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.Float64Index;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.Float64Index;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.Float64Index;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.Float64Index;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.Float64Index;
     ...
     */
    static cachedEmptyInst(): Data.Float64Index;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.Float64Index>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.Float64Index;
     ...
     */
    static fromPySrc(pySrc: string, dfs?: C3.Set<DataImpl | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): Data.Float64Index | null;
     ...
     */
    static _jsDataProxy(inst: any): Data.Float64Index;
