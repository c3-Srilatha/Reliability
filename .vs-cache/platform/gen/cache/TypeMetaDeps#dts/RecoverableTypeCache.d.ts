// TypeScript definitions for the C3 type RecoverableTypeCache

/**
 * Cache holding information about all the types mixing in {@link Recoverable}
 *
 * @remarks this represents a value passed to a method that expects an instance of RecoverableTypeCache
 */
declare interface IRecoverableTypeCache {
}

/**
 * Cache holding information about all the types mixing in {@link Recoverable}
 *
 * @remarks this represents a made instance of RecoverableTypeCache
 */
declare class RecoverableTypeCache {
   ...
   */
  static get(key: string | null): C3.Array<Type | null>;
   ...
   */
  static require(key: string | null): C3.Array<Type | null>;
   ...
   */
  static put(key: string | null, value: C3.Array<Type | null> | null): void;
   ...
   */
  static produce(key: string | null): C3.Array<Type | null>;
   ...
   * should be cleared.
   */
  static produceAll(): C3.Map<string | null, C3.Array<Type | null>>;

  /**
   * Optional override called when element is released from the cache. Should perform any external resources cleanup if
   * needed.
   */
  static release(key: string | null, value: C3.Array<Type | null> | null): void;
   ...
   */
  static validate(value: C3.Array<Type | null> | null): boolean;
}
