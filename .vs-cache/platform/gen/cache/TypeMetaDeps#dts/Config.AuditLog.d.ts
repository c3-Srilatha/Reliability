// TypeScript definitions for the C3 type Config.AuditLog
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Config.AuditLog
 */
 ...
 */
declare namespace Config {
  export class AuditLog extends Obj {

    /**
     * Partition key Bin separator used to separate partition key from bin id
     */
    readonly PK_BIN_SEPARATOR?: string | null;
    withPK_BIN_SEPARATOR(PK_BIN_SEPARATOR: string | null): Config.AuditLog;
     ...
     */
    readonly id: string;
    withId(id: string): Config.AuditLog;
    ...
    withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Config.AuditLog;

    /**
     * Name of the Obj instance
     */
    readonly name?: string | null;
    withName(name: string | null): Config.AuditLog;

    /**
     * Various system fields.
     */
    readonly meta?: Meta | null;
    withMeta(meta: IMeta | null): Config.AuditLog;
    ...
    withVersion(version: number | null): Config.AuditLog;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type | null;
    withTypeWithBindings(typeWithBindings: IType | null): Config.AuditLog;

    /**
     * partition key of the Config.AuditLog. configType + configKey
     */
    readonly auditLogKey: string;
    withAuditLogKey(auditLogKey: string): Config.AuditLog;

    /**
     * Type#name of the config being set
     */
    readonly configType: string;
    withConfigType(configType: string): Config.AuditLog;

    /**
     * The {@link ConfigOverride} of the config
     */
    readonly configOverride: string;
    withConfigOverride(configOverride: string): Config.AuditLog;

    /**
     * The {@link Config#configKey} of the config
     */
    readonly configKey: string;
    withConfigKey(configKey: string): Config.AuditLog;

    /**
     * The id of the {@link App} on which the config action is being performed
     */
    readonly appId: string;
    withAppId(appId: string): Config.AuditLog;

    /**
     * The json of the root {@link Action} being performed
     */
    readonly rootActionJson: any;
    withRootActionJson(rootActionJson: any): Config.AuditLog;

    /**
     * The config action being performed, e.g. "setConfig", "setSecretValue", "clearConfigValue"
     */
    readonly configAction: string;
    withConfigAction(configAction: string): Config.AuditLog;

    /**
     * Whether the config action perform was for secrets
     */
    readonly secret?: boolean;
    withSecret(secret: boolean): Config.AuditLog;

    /**
     * The secret values should be securely hashed, so that they are not stored in plain text but it can still be known if the value has changed.
     */
    readonly configJson: any;
    withConfigJson(configJson: any): Config.AuditLog;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Config.AuditLog | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Config.AuditLog | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Config.AuditLog | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Config.AuditLog | null;
     ...
     */
    replaceType(old: Type, new_: Type): Config.AuditLog;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Config.AuditLog;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Config.AuditLog;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Config.AuditLog | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Config.AuditLog | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Config.AuditLog;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Config.AuditLog;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Config.AuditLog;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Config.AuditLog;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Config.AuditLog;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Config.AuditLog;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Config.AuditLog;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Config.AuditLog;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Config.AuditLog;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Config.AuditLog;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Config.AuditLog;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Config.AuditLog;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Config.AuditLog;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Config.AuditLog;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Config.AuditLog;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Config.AuditLog;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Config.AuditLog;
     ...
     * @see #removeField
     */
    unsetField(field: string): Config.AuditLog;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Config.AuditLog;
     ...
     * @see #unsetField
     */
    removeField(field: string): Config.AuditLog;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Config.AuditLog;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Config.AuditLog;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Config.AuditLog;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Config.AuditLog;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Config.AuditLog;

    mergeJson(json: any | null): Config.AuditLog;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Config.AuditLog;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Config.AuditLog;
     ...
     */
    singletonArray(): C3.Array<Config.AuditLog | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Config.AuditLog | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Config.AuditLog | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Config.AuditLog | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Config.AuditLog | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Config.AuditLog | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Config.AuditLog | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Config.AuditLog | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Config.AuditLog | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Config.AuditLog;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Config.AuditLog;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Config.AuditLog;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Config.AuditLog;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Config.AuditLog;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Config.AuditLog;
     ...
     * @see #fromString
     */
    static make(s: string | null): Config.AuditLog | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Config.AuditLog;
     ...
     */
    static cachedEmptyInst(): Config.AuditLog;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Config.AuditLog>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Config.AuditLog;
     ...
     */
    static partition(objs?: Stream<Config.AuditLog | null>, spec?: PartitionBucketStrategy | null): C3.Map<string | null, KvDataPartition | null>;
     ...
     */
    static fromPartitions(partitions?: Stream<KvDataPartition | null>): Stream<Config.AuditLog | null>;
     ...
     */
    static fetch(spec?: FetchSpec | null): FetchResult<Config.AuditLog | null>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Config.AuditLog | null>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Config.AuditLog | null>;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Config.AuditLog | null> | null>;
     ...
     */
    get(include?: string | null): Config.AuditLog | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string | null): Config.AuditLog | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Config.AuditLog;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string | null): Config.AuditLog | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Config.AuditLog;
     ...
     * @see #toString
     */
    static fromString(s: string | null): Config.AuditLog | null;
     ...
     */
    create(spec?: UpsertSpec | null): Config.AuditLog | null;
     ...
     */
    static createBatch(objs: C3.Array<Config.AuditLog | null> | null, spec?: UpsertSpec | null): ObjList<Config.AuditLog | null> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Config.AuditLog | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Config.AuditLog | null> | null;
     ...
     */
    update(srcObj?: Config.AuditLog | null, spec?: UpsertSpec | null): Config.AuditLog | null;
     ...
     */
    upsert(srcObj?: Config.AuditLog | null, spec?: UpsertSpec | null): Config.AuditLog | null;
     ...
     */
    merge(spec?: MergeSpec | null): Config.AuditLog | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec | null): Config.AuditLog | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec | null): Config.AuditLog | null;
     ...
     */
    static updateBatch(objs: C3.Array<Config.AuditLog | null> | null, srcObjs?: C3.Array<Config.AuditLog | null>, spec?: UpsertSpec | null): ObjList<Config.AuditLog | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<C3.Array<Config.AuditLog | null>>, spec?: UpsertSpec | null): ObjList<Config.AuditLog | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: C3.Array<Config.AuditLog | null> | null, srcObjs?: C3.Array<Config.AuditLog | null>, spec?: UpsertSpec | null): ObjList<Config.AuditLog | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<C3.Array<Config.AuditLog | null>>, spec?: UpsertSpec | null): ObjList<Config.AuditLog | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: C3.Array<Config.AuditLog | null> | null, spec?: TouchSpec | null): ObjList<Config.AuditLog | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<Config.AuditLog | null> | null, spec?: MergeSpec | null): ObjList<Config.AuditLog | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<Config.AuditLog | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Config.AuditLog | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<C3.Array<Config.AuditLog | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Config.AuditLog | null> | null;
     ...
     */
    static mergeAll(mergeObj: Config.AuditLog | null, spec?: MergeAllSpec | null): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Config.AuditLog | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: C3.Array<Config.AuditLog | null> | null, spec?: UpsertSpec | null): ObjList<Config.AuditLog | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: C3.Array<Config.AuditLog | null> | null, spec?: UpsertSpec | null): ObjList<Config.AuditLog | null> | null;
     ...
     */
    static beforeCreate(objs: C3.Array<Config.AuditLog | null> | null): ObjList<Config.AuditLog | null>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: C3.Array<Config.AuditLog | null> | null): ObjList<Config.AuditLog | null>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: C3.Array<Config.AuditLog | null> | null): ObjList<Config.AuditLog | null>;
     ...
     */
    static afterCreate(objs: C3.Array<Config.AuditLog | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: C3.Array<Config.AuditLog | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: C3.Array<Config.AuditLog | null> | null): C3.Array<ObjError | null>;
     ...
     */
    static startImportData(spec?: StartImportDataSpec | null): PushStream<Config.AuditLog | null>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Config.AuditLog | null>;
     ...
     */
    static forId(id: string | null, failIfMissing?: boolean): Config.AuditLog | null;
     ...
     */
    withoutIdentity(): Config.AuditLog | null;
     ...
     */
    static typeOfBatch(objs: C3.Array<Config.AuditLog | null> | null): C3.Array<EntityType | null>;
     ...
     */
    static dbEcho(template?: Config.AuditLog | null, count?: number | null, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: C3.Array<Config.AuditLog | null> | null, callback?: λFunction<Config.AuditLog | null, Config.AuditLog | null> | null): ObjList<Config.AuditLog | null>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: C3.Array<Config.AuditLog | null> | null, callback?: λFunction<Config.AuditLog | null, Config.AuditLog | null> | null): C3.Array<ObjError | null>;
