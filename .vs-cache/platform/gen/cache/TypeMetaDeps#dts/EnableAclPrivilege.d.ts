// TypeScript definitions for the C3 type EnableAclPrivilege

/**
 * Use to enable or disable ACLs for Types that mix in {@link AclEnabled}. See also:
 * @see AclPrivilege
 * @see AclEnabled
 * @see AclEntry
 * @see AclEnabledTypes
 *
 * @remarks this represents a value passed to a method that expects an instance of EnableAclPrivilege
 */
declare interface IEnableAclPrivilege {
  ...
  /**
   * If true, then acl authorization will be enforced for the type and acls will be automatically populated/maintained
   * via {@link AclPrivilege} entries.  If false, acl authorization will not be enforced and acl entries will not
 ...
 * @see AclEnabledTypes
 *
 * @remarks this represents a made instance of EnableAclPrivilege
 */
declare class EnableAclPrivilege extends Obj {
   ...
   */
  readonly id: string;
  withId(id: string): EnableAclPrivilege;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): EnableAclPrivilege;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): EnableAclPrivilege;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): EnableAclPrivilege;
  ...
  withVersion(version: number | null): EnableAclPrivilege;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): EnableAclPrivilege;
  ...
  withUserUpdatedFields(userUpdatedFields: C3.Array<string | null> | Array<string | null>): EnableAclPrivilege;
  ...
  withHidden(hidden: boolean): EnableAclPrivilege;
  ...
  withUserOwned(userOwned: boolean): EnableAclPrivilege;

  readonly tag?: string | null;
  withTag(tag: string | null): EnableAclPrivilege;

  readonly moduleName?: string | null;
  withModuleName(moduleName: string | null): EnableAclPrivilege;

  readonly typeName?: string | null;
  withTypeName(typeName: string | null): EnableAclPrivilege;
  ...
  withEnabled(enabled: boolean): EnableAclPrivilege;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): EnableAclPrivilege | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): EnableAclPrivilege | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): EnableAclPrivilege | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): EnableAclPrivilege | null;
   ...
   */
  replaceType(old: Type, new_: Type): EnableAclPrivilege;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): EnableAclPrivilege;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): EnableAclPrivilege;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<EnableAclPrivilege | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<EnableAclPrivilege | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): EnableAclPrivilege;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): EnableAclPrivilege;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): EnableAclPrivilege;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): EnableAclPrivilege;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): EnableAclPrivilege;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): EnableAclPrivilege;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): EnableAclPrivilege;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): EnableAclPrivilege;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): EnableAclPrivilege;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): EnableAclPrivilege;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): EnableAclPrivilege;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): EnableAclPrivilege;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): EnableAclPrivilege;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): EnableAclPrivilege;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): EnableAclPrivilege;
   ...
   * @see #unsetField
   */
  defaultField(field: string): EnableAclPrivilege;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): EnableAclPrivilege;
   ...
   * @see #removeField
   */
  unsetField(field: string): EnableAclPrivilege;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): EnableAclPrivilege;
   ...
   * @see #unsetField
   */
  removeField(field: string): EnableAclPrivilege;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): EnableAclPrivilege;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): EnableAclPrivilege;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): EnableAclPrivilege;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): EnableAclPrivilege;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): EnableAclPrivilege;

  mergeJson(json: any | null): EnableAclPrivilege;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): EnableAclPrivilege;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): EnableAclPrivilege;
   ...
   */
  singletonArray(): C3.Array<EnableAclPrivilege | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<EnableAclPrivilege | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<EnableAclPrivilege | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<EnableAclPrivilege | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<EnableAclPrivilege | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, EnableAclPrivilege | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, EnableAclPrivilege | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<EnableAclPrivilege | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<EnableAclPrivilege | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): EnableAclPrivilege;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): EnableAclPrivilege;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): EnableAclPrivilege;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): EnableAclPrivilege;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): EnableAclPrivilege;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): EnableAclPrivilege;
   ...
   * @see #fromString
   */
  static make(s: string | null): EnableAclPrivilege | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): EnableAclPrivilege;
   ...
   */
  static cachedEmptyInst(): EnableAclPrivilege;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<EnableAclPrivilege>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): EnableAclPrivilege;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<EnableAclPrivilege | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<EnableAclPrivilege | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<EnableAclPrivilege | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): EnableAclPrivilege | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string | null): EnableAclPrivilege | null;
   ...
   * @see findByCacheKey
   */
  getCached(): EnableAclPrivilege | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): EnableAclPrivilege | null;
   ...
   */
  static produce(key: string): EnableAclPrivilege | null;
   ...
   */
  static produceAll(): C3.Map<string | null, EnableAclPrivilege | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, EnableAclPrivilege | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<EnableAclPrivilege | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<EnableAclPrivilege | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<EnableAclPrivilege | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<EnableAclPrivilege | null> | null>;
   ...
   */
  get(include?: string | null): EnableAclPrivilege | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): EnableAclPrivilege | null;
   ...
   */
  getMissing(spec: GetMissingSpec): EnableAclPrivilege;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): EnableAclPrivilege | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): EnableAclPrivilege;
   ...
   * @see #toString
   */
  static fromString(s: string | null): EnableAclPrivilege | null;
   ...
   */
  create(spec?: UpsertSpec | null): EnableAclPrivilege | null;
   ...
   */
  static createBatch(objs: C3.Array<EnableAclPrivilege | null> | null, spec?: UpsertSpec | null): ObjList<EnableAclPrivilege | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<EnableAclPrivilege | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<EnableAclPrivilege | null> | null;
   ...
   */
  update(srcObj?: EnableAclPrivilege | null, spec?: UpsertSpec | null): EnableAclPrivilege | null;
   ...
   */
  upsert(srcObj?: EnableAclPrivilege | null, spec?: UpsertSpec | null): EnableAclPrivilege | null;
   ...
   */
  merge(spec?: MergeSpec | null): EnableAclPrivilege | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): EnableAclPrivilege | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): EnableAclPrivilege | null;
   ...
   */
  static updateBatch(objs: C3.Array<EnableAclPrivilege | null> | null, srcObjs?: C3.Array<EnableAclPrivilege | null>, spec?: UpsertSpec | null): ObjList<EnableAclPrivilege | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<EnableAclPrivilege | null>>, spec?: UpsertSpec | null): ObjList<EnableAclPrivilege | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<EnableAclPrivilege | null> | null, srcObjs?: C3.Array<EnableAclPrivilege | null>, spec?: UpsertSpec | null): ObjList<EnableAclPrivilege | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<EnableAclPrivilege | null>>, spec?: UpsertSpec | null): ObjList<EnableAclPrivilege | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<EnableAclPrivilege | null> | null, spec?: TouchSpec | null): ObjList<EnableAclPrivilege | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<EnableAclPrivilege | null> | null, spec?: MergeSpec | null): ObjList<EnableAclPrivilege | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<EnableAclPrivilege | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<EnableAclPrivilege | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<EnableAclPrivilege | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<EnableAclPrivilege | null> | null;
   ...
   */
  static mergeAll(mergeObj: EnableAclPrivilege | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: EnableAclPrivilege | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<EnableAclPrivilege | null> | null, spec?: UpsertSpec | null): ObjList<EnableAclPrivilege | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<EnableAclPrivilege | null> | null, spec?: UpsertSpec | null): ObjList<EnableAclPrivilege | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): EnableAclPrivilege | null;
   ...
   */
  static beforeCreate(objs: C3.Array<EnableAclPrivilege | null> | null): ObjList<EnableAclPrivilege | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<EnableAclPrivilege | null> | null): ObjList<EnableAclPrivilege | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<EnableAclPrivilege | null> | null): ObjList<EnableAclPrivilege | null>;
   ...
   */
  static afterCreate(objs: C3.Array<EnableAclPrivilege | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<EnableAclPrivilege | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<EnableAclPrivilege | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<EnableAclPrivilege | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<EnableAclPrivilege | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): EnableAclPrivilege | null;
   ...
   */
  withoutIdentity(): EnableAclPrivilege | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<EnableAclPrivilege | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: EnableAclPrivilege | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<EnableAclPrivilege | null> | null, callback?: λFunction<EnableAclPrivilege | null, EnableAclPrivilege | null> | null): ObjList<EnableAclPrivilege | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<EnableAclPrivilege | null> | null, callback?: λFunction<EnableAclPrivilege | null, EnableAclPrivilege | null> | null): C3.Array<ObjError | null>;
   ...
   */
  publish(subPath?: string | null, contentType?: string | null): EnableAclPrivilege;
   ...
   */
  static removeSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<EnableAclPrivilege | null> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec | null): EnableAclPrivilege | null;
   ...
   */
  static createSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<EnableAclPrivilege | null> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData | null, spec?: UpsertSpec | null): EnableAclPrivilege | null;
   ...
   */
  static updateSeedDataBatch(objs?: C3.Array<SeedData | null>, srcObjs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<EnableAclPrivilege | null> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec | null): EnableAclPrivilege | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: C3.Array<SeedData | null>, spec?: MergeSpec | null): ObjList<EnableAclPrivilege | null> | null;
  ...
  dependencies(): SeedDataDeps<EnableAclPrivilege | null> | null;
