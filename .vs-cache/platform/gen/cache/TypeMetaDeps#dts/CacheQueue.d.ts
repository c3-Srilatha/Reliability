// TypeScript definitions for the C3 type CacheQueue
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of CacheQueue
 */
declare interface ICacheQueue {
}
...
declare class CacheQueue {
   ...
   */
  static compute(targetType: Type, entries: C3.Array<CacheQueueEntry | null> | null): void;
   ...
   */
  static find(spec?: InvalidationQueue.FindSpec | null): C3.Array<CacheQueueEntry | null>;
   ...
   * @return the list of requested entries.
   */
  static findStream(spec?: InvalidationQueue.FindStreamSpec | null): Stream<CacheQueueEntry | null>;
   ...
   *           Entries to remove.
   */
  static clearEntries(entries: C3.Array<CacheQueueEntry | null> | null): void;
   ...
   * This function should be claimed by individual InvalidationQueue types such as CalcFieldsQueue.
   */
  static mergeContexts(targetType?: Type | null, entries?: C3.Array<CacheQueueEntry | null>): C3.Array<CacheQueueEntry | null>;
   ...
   */
  static submitCacheEvent(message: CacheMessage, autoCommit?: boolean): void;
}
