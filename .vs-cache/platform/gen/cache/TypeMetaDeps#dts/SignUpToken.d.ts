// TypeScript definitions for the C3 type SignUpToken

/**
 * @remarks this represents a value passed to a method that expects an instance of SignUpToken
 */
declare interface ISignUpToken {
...
/**
 * @remarks this represents a made instance of SignUpToken
 */
declare class SignUpToken extends Obj {
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): SignUpToken;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): SignUpToken;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): SignUpToken;
  ...
  withVersion(version: number | null): SignUpToken;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): SignUpToken;

  readonly userName: string;
  withUserName(userName: string): SignUpToken;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SignUpToken | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SignUpToken | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SignUpToken | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SignUpToken | null;
   ...
   */
  replaceType(old: Type, new_: Type): SignUpToken;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SignUpToken;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SignUpToken;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SignUpToken | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SignUpToken | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SignUpToken;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SignUpToken;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SignUpToken;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SignUpToken;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SignUpToken;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SignUpToken;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SignUpToken;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SignUpToken;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SignUpToken;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SignUpToken;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SignUpToken;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SignUpToken;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SignUpToken;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SignUpToken;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SignUpToken;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SignUpToken;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SignUpToken;
   ...
   * @see #removeField
   */
  unsetField(field: string): SignUpToken;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SignUpToken;
   ...
   * @see #unsetField
   */
  removeField(field: string): SignUpToken;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SignUpToken;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SignUpToken;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SignUpToken;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SignUpToken;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SignUpToken;

  mergeJson(json: any | null): SignUpToken;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SignUpToken;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SignUpToken;
   ...
   */
  singletonArray(): C3.Array<SignUpToken | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SignUpToken | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SignUpToken | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SignUpToken | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SignUpToken | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SignUpToken | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SignUpToken | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SignUpToken | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SignUpToken | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SignUpToken;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SignUpToken;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SignUpToken;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SignUpToken;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SignUpToken;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SignUpToken;
   ...
   * @see #fromString
   */
  static make(s: string | null): SignUpToken | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SignUpToken;
   ...
   */
  static cachedEmptyInst(): SignUpToken;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SignUpToken>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SignUpToken;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<SignUpToken | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SignUpToken | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<SignUpToken | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<SignUpToken | null> | null>;
   ...
   */
  get(include?: string | null): SignUpToken | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): SignUpToken | null;
   ...
   */
  getMissing(spec: GetMissingSpec): SignUpToken;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): SignUpToken | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): SignUpToken;
   ...
   * @see #toString
   */
  static fromString(s: string | null): SignUpToken | null;
   ...
   */
  create(spec?: UpsertSpec | null): SignUpToken | null;
   ...
   */
  static createBatch(objs: C3.Array<SignUpToken | null> | null, spec?: UpsertSpec | null): ObjList<SignUpToken | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<SignUpToken | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<SignUpToken | null> | null;
   ...
   */
  update(srcObj?: SignUpToken | null, spec?: UpsertSpec | null): SignUpToken | null;
   ...
   */
  upsert(srcObj?: SignUpToken | null, spec?: UpsertSpec | null): SignUpToken | null;
   ...
   */
  merge(spec?: MergeSpec | null): SignUpToken | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): SignUpToken | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): SignUpToken | null;
   ...
   */
  static updateBatch(objs: C3.Array<SignUpToken | null> | null, srcObjs?: C3.Array<SignUpToken | null>, spec?: UpsertSpec | null): ObjList<SignUpToken | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<SignUpToken | null>>, spec?: UpsertSpec | null): ObjList<SignUpToken | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<SignUpToken | null> | null, srcObjs?: C3.Array<SignUpToken | null>, spec?: UpsertSpec | null): ObjList<SignUpToken | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<SignUpToken | null>>, spec?: UpsertSpec | null): ObjList<SignUpToken | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<SignUpToken | null> | null, spec?: TouchSpec | null): ObjList<SignUpToken | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SignUpToken | null> | null, spec?: MergeSpec | null): ObjList<SignUpToken | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SignUpToken | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<SignUpToken | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<SignUpToken | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<SignUpToken | null> | null;
   ...
   */
  static mergeAll(mergeObj: SignUpToken | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: SignUpToken | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<SignUpToken | null> | null, spec?: UpsertSpec | null): ObjList<SignUpToken | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<SignUpToken | null> | null, spec?: UpsertSpec | null): ObjList<SignUpToken | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<SignUpToken | null> | null): ObjList<SignUpToken | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<SignUpToken | null> | null): ObjList<SignUpToken | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<SignUpToken | null> | null): ObjList<SignUpToken | null>;
   ...
   */
  static afterCreate(objs: C3.Array<SignUpToken | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<SignUpToken | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<SignUpToken | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<SignUpToken | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<SignUpToken | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): SignUpToken | null;
   ...
   */
  withoutIdentity(): SignUpToken | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<SignUpToken | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: SignUpToken | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<SignUpToken | null> | null, callback?: λFunction<SignUpToken | null, SignUpToken | null> | null): ObjList<SignUpToken | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<SignUpToken | null> | null, callback?: λFunction<SignUpToken | null, SignUpToken | null> | null): C3.Array<ObjError | null>;
