// TypeScript definitions for the C3 type ConfigAclEnabled

/**
 * @remarks this represents a value passed to a method that expects an instance of ConfigAclEnabled
 */
declare interface IConfigAclEnabled {
...
/**
 * @remarks this represents a made instance of ConfigAclEnabled
 */
declare class ConfigAclEnabled extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): ConfigAclEnabled;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): ConfigAclEnabled;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): ConfigAclEnabled;

  /**
   * List of {@link AclEntry} entries governing who can read/update/remove Objs.
   */
  readonly acl?: C3.Array<AclEntry | null>;
  withAcl(acl: C3.Array<AclEntry | null> | Array<IAclEntry | null>): ConfigAclEnabled;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ConfigAclEnabled | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ConfigAclEnabled | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ConfigAclEnabled | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ConfigAclEnabled | null;
   ...
   */
  replaceType(old: Type, new_: Type): ConfigAclEnabled;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ConfigAclEnabled;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ConfigAclEnabled;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ConfigAclEnabled | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ConfigAclEnabled | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ConfigAclEnabled;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ConfigAclEnabled;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ConfigAclEnabled;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ConfigAclEnabled;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ConfigAclEnabled;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ConfigAclEnabled;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ConfigAclEnabled;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ConfigAclEnabled;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ConfigAclEnabled;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ConfigAclEnabled;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ConfigAclEnabled;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ConfigAclEnabled;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ConfigAclEnabled;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ConfigAclEnabled;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ConfigAclEnabled;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ConfigAclEnabled;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ConfigAclEnabled;
   ...
   * @see #removeField
   */
  unsetField(field: string): ConfigAclEnabled;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ConfigAclEnabled;
   ...
   * @see #unsetField
   */
  removeField(field: string): ConfigAclEnabled;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ConfigAclEnabled;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ConfigAclEnabled;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ConfigAclEnabled;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ConfigAclEnabled;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ConfigAclEnabled;

  mergeJson(json: any | null): ConfigAclEnabled;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ConfigAclEnabled;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ConfigAclEnabled;
   ...
   */
  singletonArray(): C3.Array<ConfigAclEnabled | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ConfigAclEnabled | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ConfigAclEnabled | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ConfigAclEnabled | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ConfigAclEnabled | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ConfigAclEnabled | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ConfigAclEnabled | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ConfigAclEnabled | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ConfigAclEnabled | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ConfigAclEnabled;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ConfigAclEnabled;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ConfigAclEnabled;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ConfigAclEnabled;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ConfigAclEnabled;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ConfigAclEnabled;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ConfigAclEnabled;
   ...
   */
  static cachedEmptyInst(): ConfigAclEnabled;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ConfigAclEnabled>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ConfigAclEnabled;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<ConfigAclEnabled | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<ConfigAclEnabled | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ConfigAclEnabled | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): ConfigAclEnabled | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): ConfigAclEnabled | null;
   ...
   * @see findByCacheKey
   */
  getCached(): ConfigAclEnabled | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): ConfigAclEnabled | null;
   ...
   */
  static produce(key: string): ConfigAclEnabled | null;
   ...
   */
  static produceAll(): C3.Map<string | null, ConfigAclEnabled | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, ConfigAclEnabled | null>;
   ...
   */
  static forConfigKey(configKey: string | null): ConfigAclEnabled | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<ConfigAclEnabled | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: ConfigAclEnabled, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: ConfigAclEnabled, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): ConfigAclEnabled | null;
   ...
   */
  static populateAcl(objs?: C3.Array<ConfigAclEnabled | null>): number | null;
   ...
   */
  grantMemberReadUpdateRemove(member: AccessControlEntity): ConfigAclEnabled;
   ...
   */
  mergeAclEntry(entry: AclEntry): ConfigAclEnabled;
   ...
   * @return the obj with the new acl after merging the indicated entry.
   */
  mergeAclEntries(entries: C3.Array<AclEntry | null> | null): ConfigAclEnabled;
