// TypeScript definitions for the C3 type EtlLog

/**
 * Log of all incremental etl operations.
 *
 * @remarks this represents a value passed to a method that expects an instance of EtlLog
 */
declare interface IEtlLog {
  ...
  started?: DateTime | Date | string | null;

  startedby?: string | null;

  completed?: DateTime | Date | string | null;
  ...
  /**
   * Coordinator the log entry is for.
   */
  coordinator?: IEtlCoordinator | null;
}

/**
 * Log of all incremental etl operations.
 *
 * @remarks this represents a made instance of EtlLog
 */
declare class EtlLog extends Obj {
  ...
  withStart(start: DateTime | Date | string | null): EtlLog;
  ...
  withEnd(end: DateTime | Date | string | null): EtlLog;

  readonly started?: DateTime | null;
  withStarted(started: DateTime | Date | string | null): EtlLog;

  readonly startedby?: string | null;
  withStartedby(startedby: string | null): EtlLog;

  readonly completed?: DateTime | null;
  withCompleted(completed: DateTime | Date | string | null): EtlLog;

  readonly status?: string | null;
  withStatus(status: string | null): EtlLog;

  readonly progress?: string | null;
  withProgress(progress: string | null): EtlLog;

  readonly info?: string | null;
  withInfo(info: string | null): EtlLog;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): EtlLog;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): EtlLog;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): EtlLog;
  ...
  withVersion(version: number | null): EtlLog;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): EtlLog;

  /**
   * Coordinator the log entry is for.
   */
  readonly coordinator?: EtlCoordinator | null;
  withCoordinator(coordinator: IEtlCoordinator | null): EtlLog;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): EtlLog | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): EtlLog | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): EtlLog | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): EtlLog | null;
   ...
   */
  replaceType(old: Type, new_: Type): EtlLog;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): EtlLog;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): EtlLog;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<EtlLog | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<EtlLog | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): EtlLog;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): EtlLog;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): EtlLog;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): EtlLog;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): EtlLog;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): EtlLog;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): EtlLog;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): EtlLog;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): EtlLog;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): EtlLog;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): EtlLog;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): EtlLog;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): EtlLog;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): EtlLog;
   ...
   * @see #unsetField
   */
  defaultField(field: string): EtlLog;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): EtlLog;
   ...
   * @see #removeField
   */
  unsetField(field: string): EtlLog;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): EtlLog;
   ...
   * @see #unsetField
   */
  removeField(field: string): EtlLog;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): EtlLog;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): EtlLog;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): EtlLog;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): EtlLog;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): EtlLog;

  mergeJson(json: any | null): EtlLog;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): EtlLog;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): EtlLog;
   ...
   */
  singletonArray(): C3.Array<EtlLog | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<EtlLog | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<EtlLog | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<EtlLog | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<EtlLog | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, EtlLog | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, EtlLog | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<EtlLog | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<EtlLog | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): EtlLog;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): EtlLog;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): EtlLog;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): EtlLog;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): EtlLog;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): EtlLog;
   ...
   * @see #fromString
   */
  static make(s: string | null): EtlLog | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): EtlLog;
   ...
   */
  static cachedEmptyInst(): EtlLog;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<EtlLog>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): EtlLog;
   ...
   */
  static last12Months(): EtlLog | null;
   ...
   */
  static prevLast12Months(): EtlLog | null;
   ...
   */
  static combineAndSort(timeRanges: C3.Array<TimeRange | null> | null): C3.Array<EtlLog | null>;

  /**
   * Merge various time ranges into a larger range
   * E.g. ["2014-01-01" -> "2014-02-01"], ["2015-01-01" -> "2016-01-01"] => {"2014-01-01" -> "2016-01-01"}
   */
  static coalesce(timeRanges: C3.Array<TimeRange | null> | null): EtlLog | null;
   ...
   */
  overlap(othr: TimeRange | null): EtlLog | null;
   ...
   */
  static fromPrettyPrint(prettyPrint: string): EtlLog;

  /**
   * Construct array of TimeRange from map<datetime, datetime>
   */
  static fromMap(map: C3.Map<DateTime | null, DateTime | null>): C3.Array<EtlLog | null>;
   ...
   */
  shift(offset: Duration): EtlLog;

  /**
   * If job is executing, returns duration since the job has started executing.
   * If the job has been completed/failed/canceled, it returns the duration taken for overall execution.
   */
  get duration(): Duration;

  /**
   * @return true if the job is in the "initial" state.
   */
  isInitial(): boolean;

  /**
   * @return true if the job is in the "running" state.
   */
  isRunning(): boolean;

  /**
   * @return true if the job is in the "completed" state.
   */
  isCompleted(): boolean;

  /**
   * @return true if the job is in the "failing" state.
   */
  isFailing(): boolean;
  ...
  /**
   * @return true if the job is in the "canceling" state.
   */
  isCanceling(): boolean;

  /**
   * @return true if the job is in the "canceled" state.
   */
  isCanceled(): boolean;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<EtlLog | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<EtlLog | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<EtlLog | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<EtlLog | null> | null>;
   ...
   */
  get(include?: string | null): EtlLog | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): EtlLog | null;
   ...
   */
  getMissing(spec: GetMissingSpec): EtlLog;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): EtlLog | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): EtlLog;
   ...
   * @see #toString
   */
  static fromString(s: string | null): EtlLog | null;
   ...
   */
  create(spec?: UpsertSpec | null): EtlLog | null;
   ...
   */
  static createBatch(objs: C3.Array<EtlLog | null> | null, spec?: UpsertSpec | null): ObjList<EtlLog | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<EtlLog | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<EtlLog | null> | null;
   ...
   */
  update(srcObj?: EtlLog | null, spec?: UpsertSpec | null): EtlLog | null;
   ...
   */
  upsert(srcObj?: EtlLog | null, spec?: UpsertSpec | null): EtlLog | null;
   ...
   */
  merge(spec?: MergeSpec | null): EtlLog | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): EtlLog | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): EtlLog | null;
   ...
   */
  static updateBatch(objs: C3.Array<EtlLog | null> | null, srcObjs?: C3.Array<EtlLog | null>, spec?: UpsertSpec | null): ObjList<EtlLog | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<EtlLog | null>>, spec?: UpsertSpec | null): ObjList<EtlLog | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<EtlLog | null> | null, srcObjs?: C3.Array<EtlLog | null>, spec?: UpsertSpec | null): ObjList<EtlLog | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<EtlLog | null>>, spec?: UpsertSpec | null): ObjList<EtlLog | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<EtlLog | null> | null, spec?: TouchSpec | null): ObjList<EtlLog | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<EtlLog | null> | null, spec?: MergeSpec | null): ObjList<EtlLog | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<EtlLog | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<EtlLog | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<EtlLog | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<EtlLog | null> | null;
   ...
   */
  static mergeAll(mergeObj: EtlLog | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: EtlLog | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<EtlLog | null> | null, spec?: UpsertSpec | null): ObjList<EtlLog | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<EtlLog | null> | null, spec?: UpsertSpec | null): ObjList<EtlLog | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<EtlLog | null> | null): ObjList<EtlLog | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<EtlLog | null> | null): ObjList<EtlLog | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<EtlLog | null> | null): ObjList<EtlLog | null>;
   ...
   */
  static afterCreate(objs: C3.Array<EtlLog | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<EtlLog | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<EtlLog | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<EtlLog | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<EtlLog | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): EtlLog | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<EtlLog | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: EtlLog | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<EtlLog | null> | null, callback?: λFunction<EtlLog | null, EtlLog | null> | null): ObjList<EtlLog | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<EtlLog | null> | null, callback?: λFunction<EtlLog | null, EtlLog | null> | null): C3.Array<ObjError | null>;
  ...
  /**
   * Updates the etl log status.
   */
  static updateStatus(coordinator: EtlCoordinator, status: string): void;
}
