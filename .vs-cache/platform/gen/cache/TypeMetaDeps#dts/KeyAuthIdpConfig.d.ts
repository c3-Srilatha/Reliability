// TypeScript definitions for the C3 type KeyAuthIdpConfig

/**
 * @remarks this represents a value passed to a method that expects an instance of KeyAuthIdpConfig
 */
declare interface IKeyAuthIdpConfig {
...
/**
 * @remarks this represents a made instance of KeyAuthIdpConfig
 */
declare class KeyAuthIdpConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): KeyAuthIdpConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): KeyAuthIdpConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): KeyAuthIdpConfig;

  /**
   * The unique and required id of this instance.
   */
  readonly id: string;
  withId(id: string): KeyAuthIdpConfig;

  /**
   * If present, the user will be redirected to this url instead of the idp login page.
   */
  readonly defaultContentUrl?: string | null;
  withDefaultContentUrl(defaultContentUrl: string | null): KeyAuthIdpConfig;

  /**
   * Which field of the IdpUser to use as the user id
   */
  readonly userIdFormat?: string | null;
  withUserIdFormat(userIdFormat: string | null): KeyAuthIdpConfig;
  ...
  withDefaultGroupId(defaultGroupId: string | null): KeyAuthIdpConfig;

  /**
   * Returns whether we should write back to the Idp
   */
  readonly idpWriteback?: boolean;
  withIdpWriteback(idpWriteback: boolean): KeyAuthIdpConfig;

  /**
   * Returns whether we should write back {@link UserGroup} updates to the Idp
   */
  readonly idpGroupWriteback?: boolean;
  withIdpGroupWriteback(idpGroupWriteback: boolean): KeyAuthIdpConfig;

  /**
   * Returns the identity provider for write-back (if enabled)
   */
  readonly idpType?: string | null;
  withIdpType(idpType: string | null): KeyAuthIdpConfig;
  ...
  withExternalAppId(externalAppId: string | null): KeyAuthIdpConfig;
  ...
  withAllowedEmailDomains(allowedEmailDomains: C3.Array<string | null> | Array<string | null>): KeyAuthIdpConfig;

  /**
   * Applications that are trusted to redirect authenticated user(s)
   */
  readonly trustedApplicationHosts?: C3.Array<string | null>;
  withTrustedApplicationHosts(trustedApplicationHosts: C3.Array<string | null> | Array<string | null>): KeyAuthIdpConfig;

  /**
   * List of relevant groups for the cluster from the IDP. If empty, then no group filtering is done on user login.
   */
  readonly relevantGroups?: C3.Array<string | null>;
  withRelevantGroups(relevantGroups: C3.Array<string | null> | Array<string | null>): KeyAuthIdpConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): KeyAuthIdpConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): KeyAuthIdpConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): KeyAuthIdpConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): KeyAuthIdpConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): KeyAuthIdpConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): KeyAuthIdpConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): KeyAuthIdpConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<KeyAuthIdpConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<KeyAuthIdpConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): KeyAuthIdpConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): KeyAuthIdpConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): KeyAuthIdpConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): KeyAuthIdpConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): KeyAuthIdpConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): KeyAuthIdpConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): KeyAuthIdpConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): KeyAuthIdpConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): KeyAuthIdpConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): KeyAuthIdpConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): KeyAuthIdpConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): KeyAuthIdpConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): KeyAuthIdpConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): KeyAuthIdpConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): KeyAuthIdpConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): KeyAuthIdpConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): KeyAuthIdpConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): KeyAuthIdpConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): KeyAuthIdpConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): KeyAuthIdpConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): KeyAuthIdpConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): KeyAuthIdpConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): KeyAuthIdpConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): KeyAuthIdpConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): KeyAuthIdpConfig;

  mergeJson(json: any | null): KeyAuthIdpConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): KeyAuthIdpConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): KeyAuthIdpConfig;
   ...
   */
  singletonArray(): C3.Array<KeyAuthIdpConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<KeyAuthIdpConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<KeyAuthIdpConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<KeyAuthIdpConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<KeyAuthIdpConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, KeyAuthIdpConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, KeyAuthIdpConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<KeyAuthIdpConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<KeyAuthIdpConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): KeyAuthIdpConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): KeyAuthIdpConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): KeyAuthIdpConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): KeyAuthIdpConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): KeyAuthIdpConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): KeyAuthIdpConfig;
   ...
   * @see #fromString
   */
  static make(s: string | null): KeyAuthIdpConfig | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): KeyAuthIdpConfig;
   ...
   */
  static cachedEmptyInst(): KeyAuthIdpConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<KeyAuthIdpConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): KeyAuthIdpConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<KeyAuthIdpConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<KeyAuthIdpConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<KeyAuthIdpConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): KeyAuthIdpConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): KeyAuthIdpConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): KeyAuthIdpConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): KeyAuthIdpConfig | null;
   ...
   */
  static produce(key: string): KeyAuthIdpConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, KeyAuthIdpConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, KeyAuthIdpConfig | null>;
   ...
   */
  static forConfigKey(configKey: string | null): KeyAuthIdpConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<KeyAuthIdpConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: KeyAuthIdpConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: KeyAuthIdpConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): KeyAuthIdpConfig | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): KeyAuthIdpConfig | null;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): KeyAuthIdpConfig | null;
