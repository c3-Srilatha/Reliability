// TypeScript definitions for the C3 type LukeAsyncQueueCollection

/**
 * @remarks this represents a value passed to a method that expects an instance of LukeAsyncQueueCollection
 */
declare interface ILukeAsyncQueueCollection<E> {
...
/**
 * @remarks this represents a made instance of LukeAsyncQueueCollection
 */
declare class LukeAsyncQueueCollection<E> extends Obj {
   ...
   */
  timeout?: number | null;
  withTimeout(timeout: number | null): LukeAsyncQueueCollection;

  /**
   * The next node in the chain
   */
  next?: LukeAsyncQueueNode | null;
  withNext(next: ILukeAsyncQueueNode | null): LukeAsyncQueueCollection;

  /**
   * The head of the chain that contains the current node
   */
  head?: LukeAsyncQueueNode | null;
  withHead(head: ILukeAsyncQueueNode | null): LukeAsyncQueueCollection;
  ...
  withCatchChain(catchChain: ILukeAsyncQueueNode | null): LukeAsyncQueueCollection;

  /**
   * When the node started running
   */
  startedAt?: number | null;
  withStartedAt(startedAt: number | null): LukeAsyncQueueCollection;

  /**
   * When the node ended running
   */
  endedAt?: number | null;
  withEndedAt(endedAt: number | null): LukeAsyncQueueCollection;

  /**
   * If the node spawns a nested async queue, its chains (heads) will be stored here.
   */
  asyncQueue?: C3.Array<LukeAsyncQueueNode | null>;
  withAsyncQueue(asyncQueue: C3.Array<LukeAsyncQueueNode | null> | Array<ILukeAsyncQueueNode | null>): LukeAsyncQueueCollection;

  /**
   * Whether to skip the remaining chains in the queue
   */
  skipQueueFlag?: boolean;
  withSkipQueueFlag(skipQueueFlag: boolean): LukeAsyncQueueCollection;

  /**
   * The function that yields a promise
   */
  func: any;
  withFunc(func: any): LukeAsyncQueueCollection;
   ...
   */
  args?: C3.Array<any>;
  withArgs(args: C3.Array<any> | Array<any>): LukeAsyncQueueCollection;

  /**
   * Metadata about what type of node this is.
   */
  label?: string | null;
  withLabel(label: string | null): LukeAsyncQueueCollection;

  /**
   * "Unique" id assigned to each LukeAsyncQueueNode for UI. Uses C3 unique ID generator, but not backed by database
   */
  uuid?: string | null;
  withUuid(uuid: string | null): LukeAsyncQueueCollection;

  /**
   * Construct an instance with initial state.
   */
  static make(): LukeAsyncQueueCollection<E>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LukeAsyncQueueCollection<E>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LukeAsyncQueueCollection<E>;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LukeAsyncQueueCollection<E>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LukeAsyncQueueCollection<E>;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LukeAsyncQueueCollection<E> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LukeAsyncQueueCollection<E> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LukeAsyncQueueCollection<E> | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LukeAsyncQueueCollection<E> | null;
   ...
   */
  replaceType(old: Type, new_: Type): LukeAsyncQueueCollection<E>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeAsyncQueueCollection<E>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeAsyncQueueCollection<E>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeAsyncQueueCollection<E> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeAsyncQueueCollection<E> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LukeAsyncQueueCollection<E>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeAsyncQueueCollection<E>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeAsyncQueueCollection<E>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LukeAsyncQueueCollection<E>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LukeAsyncQueueCollection<E>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LukeAsyncQueueCollection<E>;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LukeAsyncQueueCollection<E>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LukeAsyncQueueCollection<E>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LukeAsyncQueueCollection<E>;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LukeAsyncQueueCollection<E>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LukeAsyncQueueCollection<E>;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LukeAsyncQueueCollection<E>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LukeAsyncQueueCollection<E>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LukeAsyncQueueCollection<E>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LukeAsyncQueueCollection<E>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LukeAsyncQueueCollection<E>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LukeAsyncQueueCollection<E>;
   ...
   * @see #removeField
   */
  unsetField(field: string): LukeAsyncQueueCollection<E>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LukeAsyncQueueCollection<E>;
   ...
   * @see #unsetField
   */
  removeField(field: string): LukeAsyncQueueCollection<E>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LukeAsyncQueueCollection<E>;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LukeAsyncQueueCollection<E>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LukeAsyncQueueCollection<E>;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LukeAsyncQueueCollection<E>;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LukeAsyncQueueCollection<E>;

  mergeJson(json: any | null): LukeAsyncQueueCollection<E>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LukeAsyncQueueCollection<E>;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LukeAsyncQueueCollection<E>;
   ...
   */
  singletonArray(): C3.Array<LukeAsyncQueueCollection<E> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LukeAsyncQueueCollection<E> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LukeAsyncQueueCollection<E> | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LukeAsyncQueueCollection<E> | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LukeAsyncQueueCollection<E> | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LukeAsyncQueueCollection<E> | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LukeAsyncQueueCollection<E> | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LukeAsyncQueueCollection<E> | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LukeAsyncQueueCollection<E> | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LukeAsyncQueueCollection<E>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LukeAsyncQueueCollection<E>;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LukeAsyncQueueCollection<E>;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): LukeAsyncQueueCollection<E>;
   ...
   */
  static cachedEmptyInst(): LukeAsyncQueueCollection<E>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LukeAsyncQueueCollection<E>>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LukeAsyncQueueCollection<E>;
   ...
   * @return this Obj
   */
  setField(field: string, value: any, doNotConvert?: boolean): LukeAsyncQueueCollection<E>;
   ...
   * @return this Obj
   */
  setField(field: FieldType, value: any, doNotConvert?: boolean): LukeAsyncQueueCollection<E>;
   ...
   * ```
   */
  find(funk?: any, args?: C3.Array<any>, resolveOnFound?: boolean): E | null;
   ...
   * ```
   */
  findIndex(funk?: any, args?: C3.Array<any>, resolveOnFound?: boolean): number | null;
   ...
   * ```
   */
  reduce(funk?: any, accumulator?: any, args?: C3.Array<any>): LukeAsyncQueueNode | null;
   ...
   * ```
   */
  mapToSame(funk?: any, args?: C3.Array<any>): LukeAsyncQueueCollection<E> | null;
   ...
   * ```
   */
  mapToAny(funk?: any, args?: C3.Array<any>): LukeAsyncQueueCollection<LukeAsyncQueueNode | null> | null;
   ...
   * ```
   */
  filter(funk?: any, args?: C3.Array<any>): LukeAsyncQueueCollection<E> | null;
   ...
   * ```
   */
  each(funk?: any, args?: C3.Array<any>): LukeAsyncQueueNode | null;

  /**
   * Reverses the order of the elements
   * @return An async collection of the same elements in the reverse order
   */
  reverse(): LukeAsyncQueueCollection<E> | null;
}
