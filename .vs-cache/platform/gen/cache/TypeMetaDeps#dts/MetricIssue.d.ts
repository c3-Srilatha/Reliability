// TypeScript definitions for the C3 type MetricIssue

/**
 * Metric specific data issue type.
 *
 * @remarks this represents a value passed to a method that expects an instance of MetricIssue
 */
declare interface IMetricIssue {
 ...
 * Metric specific data issue type.
 *
 * @remarks this represents a made instance of MetricIssue
 */
declare class MetricIssue extends Obj {

  /**
   * Target type of the obj with the issue.
   */
  readonly targetType: string;
  withTargetType(targetType: string): MetricIssue;

  /**
   * Id of obj with the issue.  If null, the issue applies to all objs for the `targetType`
   */
  readonly targetId?: string | null;
  withTargetId(targetId: string | null): MetricIssue;

  /**
   * Field with the issue.  If null, the issue applies to all fields in the `targetType` (where applicable).
   */
  readonly targetField?: string | null;
  withTargetField(targetField: string | null): MetricIssue;

  /**
   * DataIssue severity.
   */
  readonly severity: string;
  withSeverity(severity: string): MetricIssue;
  ...
  withTypeIdent(typeIdent: string | null): MetricIssue;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): MetricIssue;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): MetricIssue;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): MetricIssue;
  ...
  withVersion(version: number | null): MetricIssue;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): MetricIssue;

  /**
   * Error message indicating the nature of the issue.
   */
  readonly errorMsg?: string | null;
  withErrorMsg(errorMsg: string | null): MetricIssue;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): MetricIssue | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): MetricIssue | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): MetricIssue | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): MetricIssue | null;
   ...
   */
  replaceType(old: Type, new_: Type): MetricIssue;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MetricIssue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MetricIssue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MetricIssue | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MetricIssue | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): MetricIssue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MetricIssue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MetricIssue;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): MetricIssue;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): MetricIssue;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): MetricIssue;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): MetricIssue;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): MetricIssue;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): MetricIssue;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): MetricIssue;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): MetricIssue;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): MetricIssue;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): MetricIssue;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): MetricIssue;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): MetricIssue;
   ...
   * @see #unsetField
   */
  defaultField(field: string): MetricIssue;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): MetricIssue;
   ...
   * @see #removeField
   */
  unsetField(field: string): MetricIssue;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): MetricIssue;
   ...
   * @see #unsetField
   */
  removeField(field: string): MetricIssue;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): MetricIssue;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): MetricIssue;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): MetricIssue;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): MetricIssue;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): MetricIssue;

  mergeJson(json: any | null): MetricIssue;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): MetricIssue;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): MetricIssue;
   ...
   */
  singletonArray(): C3.Array<MetricIssue | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<MetricIssue | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<MetricIssue | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<MetricIssue | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<MetricIssue | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, MetricIssue | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, MetricIssue | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<MetricIssue | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<MetricIssue | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): MetricIssue;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): MetricIssue;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): MetricIssue;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): MetricIssue;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): MetricIssue;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): MetricIssue;
   ...
   * @see #fromString
   */
  static make(s: string | null): MetricIssue | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): MetricIssue;
   ...
   */
  static cachedEmptyInst(): MetricIssue;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<MetricIssue>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): MetricIssue;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<MetricIssue | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<MetricIssue | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<MetricIssue | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<MetricIssue | null> | null>;
   ...
   */
  get(include?: string | null): MetricIssue | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): MetricIssue | null;
   ...
   */
  getMissing(spec: GetMissingSpec): MetricIssue;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): MetricIssue | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): MetricIssue;
   ...
   * @see #toString
   */
  static fromString(s: string | null): MetricIssue | null;
   ...
   */
  create(spec?: UpsertSpec | null): MetricIssue | null;
   ...
   */
  static createBatch(objs: C3.Array<MetricIssue | null> | null, spec?: UpsertSpec | null): ObjList<MetricIssue | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<MetricIssue | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<MetricIssue | null> | null;
   ...
   */
  update(srcObj?: MetricIssue | null, spec?: UpsertSpec | null): MetricIssue | null;
   ...
   */
  upsert(srcObj?: MetricIssue | null, spec?: UpsertSpec | null): MetricIssue | null;
   ...
   */
  merge(spec?: MergeSpec | null): MetricIssue | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): MetricIssue | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): MetricIssue | null;
   ...
   */
  static updateBatch(objs: C3.Array<MetricIssue | null> | null, srcObjs?: C3.Array<MetricIssue | null>, spec?: UpsertSpec | null): ObjList<MetricIssue | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<MetricIssue | null>>, spec?: UpsertSpec | null): ObjList<MetricIssue | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<MetricIssue | null> | null, srcObjs?: C3.Array<MetricIssue | null>, spec?: UpsertSpec | null): ObjList<MetricIssue | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<MetricIssue | null>>, spec?: UpsertSpec | null): ObjList<MetricIssue | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<MetricIssue | null> | null, spec?: TouchSpec | null): ObjList<MetricIssue | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<MetricIssue | null> | null, spec?: MergeSpec | null): ObjList<MetricIssue | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<MetricIssue | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<MetricIssue | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<MetricIssue | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<MetricIssue | null> | null;
   ...
   */
  static mergeAll(mergeObj: MetricIssue | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: MetricIssue | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<MetricIssue | null> | null, spec?: UpsertSpec | null): ObjList<MetricIssue | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<MetricIssue | null> | null, spec?: UpsertSpec | null): ObjList<MetricIssue | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<MetricIssue | null> | null): ObjList<MetricIssue | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<MetricIssue | null> | null): ObjList<MetricIssue | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<MetricIssue | null> | null): ObjList<MetricIssue | null>;
   ...
   */
  static afterCreate(objs: C3.Array<MetricIssue | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<MetricIssue | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<MetricIssue | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<MetricIssue | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<MetricIssue | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): MetricIssue | null;
   ...
   */
  withoutIdentity(): MetricIssue | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<MetricIssue | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: MetricIssue | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<MetricIssue | null> | null, callback?: λFunction<MetricIssue | null, MetricIssue | null> | null): ObjList<MetricIssue | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<MetricIssue | null> | null, callback?: λFunction<MetricIssue | null, MetricIssue | null> | null): C3.Array<ObjError | null>;
