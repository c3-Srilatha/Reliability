// TypeScript definitions for the C3 type AuthnConfig

/**
 * @remarks this represents a value passed to a method that expects an instance of AuthnConfig
 */
declare interface IAuthnConfig {
...
/**
 * @remarks this represents a made instance of AuthnConfig
 */
declare class AuthnConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): AuthnConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): AuthnConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): AuthnConfig;

  readonly enabled?: boolean;
  withEnabled(enabled: boolean): AuthnConfig;

  readonly salted?: boolean;
  withSalted(salted: boolean): AuthnConfig;

  readonly maxLoginAttempts?: number | null;
  withMaxLoginAttempts(maxLoginAttempts: number | null): AuthnConfig;

  readonly idpKind?: string | null;
  withIdpKind(idpKind: string | null): AuthnConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): AuthnConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): AuthnConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): AuthnConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): AuthnConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): AuthnConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): AuthnConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): AuthnConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<AuthnConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<AuthnConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): AuthnConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AuthnConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): AuthnConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): AuthnConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): AuthnConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): AuthnConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): AuthnConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): AuthnConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): AuthnConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): AuthnConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): AuthnConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): AuthnConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): AuthnConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): AuthnConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): AuthnConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): AuthnConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): AuthnConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): AuthnConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): AuthnConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): AuthnConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): AuthnConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): AuthnConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): AuthnConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): AuthnConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): AuthnConfig;

  mergeJson(json: any | null): AuthnConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): AuthnConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): AuthnConfig;
   ...
   */
  singletonArray(): C3.Array<AuthnConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<AuthnConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<AuthnConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<AuthnConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<AuthnConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, AuthnConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, AuthnConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<AuthnConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<AuthnConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): AuthnConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): AuthnConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): AuthnConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): AuthnConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): AuthnConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): AuthnConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): AuthnConfig;
   ...
   */
  static cachedEmptyInst(): AuthnConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<AuthnConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): AuthnConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<AuthnConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<AuthnConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<AuthnConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): AuthnConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): AuthnConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): AuthnConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): AuthnConfig | null;
   ...
   */
  static produce(key: string): AuthnConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, AuthnConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, AuthnConfig | null>;
   ...
   */
  static forConfigKey(configKey: string | null): AuthnConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<AuthnConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: AuthnConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: AuthnConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): AuthnConfig | null;
