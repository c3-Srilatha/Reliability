// TypeScript definitions for the C3 type BatchInValue

/**
 * @remarks this represents a value passed to a method that expects an instance of BatchInValue
 */
declare interface IBatchInValue {
...
/**
 * @remarks this represents a made instance of BatchInValue
 */
declare class BatchInValue extends Obj {
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): BatchInValue;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): BatchInValue;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): BatchInValue;
  ...
  withVersion(version: number | null): BatchInValue;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): BatchInValue;

  readonly batch?: any;
  withBatch(batch: any): BatchInValue;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): BatchInValue | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): BatchInValue | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): BatchInValue | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): BatchInValue | null;
   ...
   */
  replaceType(old: Type, new_: Type): BatchInValue;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BatchInValue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BatchInValue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BatchInValue | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BatchInValue | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): BatchInValue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BatchInValue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BatchInValue;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): BatchInValue;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): BatchInValue;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): BatchInValue;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): BatchInValue;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BatchInValue;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): BatchInValue;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): BatchInValue;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): BatchInValue;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): BatchInValue;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): BatchInValue;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): BatchInValue;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): BatchInValue;
   ...
   * @see #unsetField
   */
  defaultField(field: string): BatchInValue;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): BatchInValue;
   ...
   * @see #removeField
   */
  unsetField(field: string): BatchInValue;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): BatchInValue;
   ...
   * @see #unsetField
   */
  removeField(field: string): BatchInValue;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): BatchInValue;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): BatchInValue;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): BatchInValue;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): BatchInValue;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): BatchInValue;

  mergeJson(json: any | null): BatchInValue;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): BatchInValue;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): BatchInValue;
   ...
   */
  singletonArray(): C3.Array<BatchInValue | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<BatchInValue | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BatchInValue | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<BatchInValue | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BatchInValue | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, BatchInValue | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BatchInValue | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BatchInValue | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BatchInValue | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): BatchInValue;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): BatchInValue;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): BatchInValue;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): BatchInValue;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): BatchInValue;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): BatchInValue;
   ...
   * @see #fromString
   */
  static make(s: string | null): BatchInValue | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): BatchInValue;
   ...
   */
  static cachedEmptyInst(): BatchInValue;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<BatchInValue>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): BatchInValue;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<BatchInValue | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<BatchInValue | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<BatchInValue | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<BatchInValue | null> | null>;
   ...
   */
  get(include?: string | null): BatchInValue | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): BatchInValue | null;
   ...
   */
  getMissing(spec: GetMissingSpec): BatchInValue;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): BatchInValue | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): BatchInValue;
   ...
   * @see #toString
   */
  static fromString(s: string | null): BatchInValue | null;
   ...
   */
  create(spec?: UpsertSpec | null): BatchInValue | null;
   ...
   */
  static createBatch(objs: C3.Array<BatchInValue | null> | null, spec?: UpsertSpec | null): ObjList<BatchInValue | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<BatchInValue | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<BatchInValue | null> | null;
   ...
   */
  update(srcObj?: BatchInValue | null, spec?: UpsertSpec | null): BatchInValue | null;
   ...
   */
  upsert(srcObj?: BatchInValue | null, spec?: UpsertSpec | null): BatchInValue | null;
   ...
   */
  merge(spec?: MergeSpec | null): BatchInValue | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): BatchInValue | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): BatchInValue | null;
   ...
   */
  static updateBatch(objs: C3.Array<BatchInValue | null> | null, srcObjs?: C3.Array<BatchInValue | null>, spec?: UpsertSpec | null): ObjList<BatchInValue | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<BatchInValue | null>>, spec?: UpsertSpec | null): ObjList<BatchInValue | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<BatchInValue | null> | null, srcObjs?: C3.Array<BatchInValue | null>, spec?: UpsertSpec | null): ObjList<BatchInValue | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<BatchInValue | null>>, spec?: UpsertSpec | null): ObjList<BatchInValue | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<BatchInValue | null> | null, spec?: TouchSpec | null): ObjList<BatchInValue | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<BatchInValue | null> | null, spec?: MergeSpec | null): ObjList<BatchInValue | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<BatchInValue | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<BatchInValue | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<BatchInValue | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<BatchInValue | null> | null;
   ...
   */
  static mergeAll(mergeObj: BatchInValue | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: BatchInValue | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<BatchInValue | null> | null, spec?: UpsertSpec | null): ObjList<BatchInValue | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<BatchInValue | null> | null, spec?: UpsertSpec | null): ObjList<BatchInValue | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<BatchInValue | null> | null): ObjList<BatchInValue | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<BatchInValue | null> | null): ObjList<BatchInValue | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<BatchInValue | null> | null): ObjList<BatchInValue | null>;
   ...
   */
  static afterCreate(objs: C3.Array<BatchInValue | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<BatchInValue | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<BatchInValue | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<BatchInValue | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<BatchInValue | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): BatchInValue | null;
   ...
   */
  withoutIdentity(): BatchInValue | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<BatchInValue | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: BatchInValue | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<BatchInValue | null> | null, callback?: λFunction<BatchInValue | null, BatchInValue | null> | null): ObjList<BatchInValue | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<BatchInValue | null> | null, callback?: λFunction<BatchInValue | null, BatchInValue | null> | null): C3.Array<ObjError | null>;
