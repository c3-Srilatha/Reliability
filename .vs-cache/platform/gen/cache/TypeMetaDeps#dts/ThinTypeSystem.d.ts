// TypeScript definitions for the C3 type ThinTypeSystem
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ThinTypeSystem
 */
declare interface IThinTypeSystem {
}
 ...
 */
declare class ThinTypeSystem {

  /**
   * Get a proxy to a type by name.
   */
  type(name: string, failIfMissing?: boolean): TypeProxy | null;
