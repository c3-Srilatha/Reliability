// TypeScript definitions for the C3 type DynMapReduce
 ...
 * ```
 *
 * @remarks this represents a value passed to a method that expects an instance of DynMapReduce
 */
declare interface IDynMapReduce {
 ...
 */
declare class DynMapReduce extends Obj {
  ...
  withTargetType(targetType: IType): DynMapReduce;

  /**
   * Context on the job that can be used in the functions {@link #map} and {@link #reduce}.
   */
  readonly context?: Obj | null;
  withContext(context: IObj | null): DynMapReduce;
  ...
  withMapLambda(mapLambda: ILambda<λQuadFunction<number | null, C3.Array<any>, DynMapReduce | null, number | null, C3.Map<string | null, any>> | null>): DynMapReduce;
  ...
  withMapCompletedLambda(mapCompletedLambda: ILambda<λConsumer<DynMapReduce | null> | null> | null): DynMapReduce;
  ...
  withReduceLambda(reduceLambda: ILambda<λTriFunction<string | null, C3.Array<any>, DynMapReduce | null, C3.Array<any>> | null> | null): DynMapReduce;
  ...
  withCompletedLambda(completedLambda: ILambda<λFunction<DynMapReduce | null, string | null> | null> | null): DynMapReduce;
  ...
  withFailedLambda(failedLambda: ILambda<λTriConsumer<DynMapReduce | null, MapReduceStatus | null, MapReduceOptions | null> | null> | null): DynMapReduce;

  /**
   * current or last job execution for this instance
   */
  readonly run?: MapReduceRun | null;
  withRun(run: IMapReduceRun | null): DynMapReduce;

  /**
   * previous job executions for this instance
   */
  readonly runs?: C3.Array<MapReduceRun | null>;
  withRuns(runs: C3.Array<MapReduceRun | null> | Array<IMapReduceRun | null>): DynMapReduce;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj | null;
  withOptions(options: IObj | null): DynMapReduce;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): DynMapReduce;
  ...
  withPriority(priority: number | null): DynMapReduce;
  ...
  withDisabled(disabled: boolean): DynMapReduce;
  ...
  withMaxConcurrency(maxConcurrency: number | null): DynMapReduce;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): DynMapReduce;
  ...
  withRunAsUser(runAsUser: boolean | null): DynMapReduce;

  /**
   * Don't set this field in the MapReduce job, set it in the MapReduceOptions when calling `start`.
   */
  readonly nodePool?: string | null;
  withNodePool(nodePool: string | null): DynMapReduce;
  ...
  withSkipIfRunning(skipIfRunning: boolean | null): DynMapReduce;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number | null;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): DynMapReduce;
  ...
  withPropagateActionContext(propagateActionContext: boolean): DynMapReduce;
  ...
  withUseFileSystemForInterVals(useFileSystemForInterVals: boolean): DynMapReduce;
  ...
  withUseBatchIdsForReadInput(useBatchIdsForReadInput: boolean): DynMapReduce;
  ...
  withInclude(include: string | null): DynMapReduce;

  /**
   * optional filter spec
   */
  readonly filter?: string | null;
  withFilter(filter: string | null): DynMapReduce;
  ...
  withOrder(order: string | null): DynMapReduce;
  ...
  withLimit(limit: number | null): DynMapReduce;
  ...
  withSamplePct(samplePct: number | null): DynMapReduce;
  ...
  withBatchSize(batchSize: number | null): DynMapReduce;
  ...
  withSubBatchSize(subBatchSize: number | null): DynMapReduce;
  ...
  withNumBatches(numBatches: number | null): DynMapReduce;
  ...
  withAbortOnError(abortOnError: boolean): DynMapReduce;
  ...
  withTypeIdent(typeIdent: string | null): DynMapReduce;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): DynMapReduce;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): DynMapReduce;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): DynMapReduce;
  ...
  withVersion(version: number | null): DynMapReduce;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): DynMapReduce;

  /**
   * Optional target type instance to be used as the filter for the job.  When specified, the {~link map} function will
   * only be called for that obj.
   */
  readonly targetFilter?: any;
  withTargetFilter(targetFilter: any): DynMapReduce;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): DynMapReduce | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): DynMapReduce | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): DynMapReduce | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): DynMapReduce | null;
   ...
   */
  replaceType(old: Type, new_: Type): DynMapReduce;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DynMapReduce;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DynMapReduce;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DynMapReduce | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DynMapReduce | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DynMapReduce;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DynMapReduce;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DynMapReduce;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DynMapReduce;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DynMapReduce;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DynMapReduce;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DynMapReduce;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DynMapReduce;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DynMapReduce;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): DynMapReduce;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): DynMapReduce;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): DynMapReduce;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DynMapReduce;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DynMapReduce;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DynMapReduce;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DynMapReduce;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DynMapReduce;
   ...
   * @see #removeField
   */
  unsetField(field: string): DynMapReduce;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DynMapReduce;
   ...
   * @see #unsetField
   */
  removeField(field: string): DynMapReduce;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DynMapReduce;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DynMapReduce;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): DynMapReduce;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DynMapReduce;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DynMapReduce;

  mergeJson(json: any | null): DynMapReduce;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DynMapReduce;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): DynMapReduce;
   ...
   */
  singletonArray(): C3.Array<DynMapReduce | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<DynMapReduce | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DynMapReduce | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<DynMapReduce | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DynMapReduce | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, DynMapReduce | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DynMapReduce | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DynMapReduce | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DynMapReduce | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DynMapReduce;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DynMapReduce;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DynMapReduce;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DynMapReduce;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DynMapReduce;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DynMapReduce;
   ...
   * @see #fromString
   */
  static make(s: string | null): DynMapReduce | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DynMapReduce;
   ...
   */
  static cachedEmptyInst(): DynMapReduce;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DynMapReduce>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): DynMapReduce;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<DynMapReduce | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<DynMapReduce | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<DynMapReduce | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<DynMapReduce | null> | null>;
   ...
   */
  get(include?: string | null): DynMapReduce | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): DynMapReduce | null;
   ...
   */
  getMissing(spec: GetMissingSpec): DynMapReduce;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): DynMapReduce | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): DynMapReduce;
   ...
   * @see #toString
   */
  static fromString(s: string | null): DynMapReduce | null;
   ...
   */
  create(spec?: UpsertSpec | null): DynMapReduce | null;
   ...
   */
  static createBatch(objs: C3.Array<DynMapReduce | null> | null, spec?: UpsertSpec | null): ObjList<DynMapReduce | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<DynMapReduce | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<DynMapReduce | null> | null;
   ...
   */
  update(srcObj?: DynMapReduce | null, spec?: UpsertSpec | null): DynMapReduce | null;
   ...
   */
  upsert(srcObj?: DynMapReduce | null, spec?: UpsertSpec | null): DynMapReduce | null;
   ...
   */
  merge(spec?: MergeSpec | null): DynMapReduce | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): DynMapReduce | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): DynMapReduce | null;
   ...
   */
  static updateBatch(objs: C3.Array<DynMapReduce | null> | null, srcObjs?: C3.Array<DynMapReduce | null>, spec?: UpsertSpec | null): ObjList<DynMapReduce | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<DynMapReduce | null>>, spec?: UpsertSpec | null): ObjList<DynMapReduce | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<DynMapReduce | null> | null, srcObjs?: C3.Array<DynMapReduce | null>, spec?: UpsertSpec | null): ObjList<DynMapReduce | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<DynMapReduce | null>>, spec?: UpsertSpec | null): ObjList<DynMapReduce | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<DynMapReduce | null> | null, spec?: TouchSpec | null): ObjList<DynMapReduce | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<DynMapReduce | null> | null, spec?: MergeSpec | null): ObjList<DynMapReduce | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<DynMapReduce | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<DynMapReduce | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<DynMapReduce | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<DynMapReduce | null> | null;
   ...
   */
  static mergeAll(mergeObj: DynMapReduce | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: DynMapReduce | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<DynMapReduce | null> | null, spec?: UpsertSpec | null): ObjList<DynMapReduce | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<DynMapReduce | null> | null, spec?: UpsertSpec | null): ObjList<DynMapReduce | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<DynMapReduce | null> | null): ObjList<DynMapReduce | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<DynMapReduce | null> | null): ObjList<DynMapReduce | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<DynMapReduce | null> | null): ObjList<DynMapReduce | null>;
   ...
   */
  static afterCreate(objs: C3.Array<DynMapReduce | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<DynMapReduce | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<DynMapReduce | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<DynMapReduce | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<DynMapReduce | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): DynMapReduce | null;
   ...
   */
  withoutIdentity(): DynMapReduce | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<DynMapReduce | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: DynMapReduce | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<DynMapReduce | null> | null, callback?: λFunction<DynMapReduce | null, DynMapReduce | null> | null): ObjList<DynMapReduce | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<DynMapReduce | null> | null, callback?: λFunction<DynMapReduce | null, DynMapReduce | null> | null): C3.Array<ObjError | null>;
   ...
   *         key type.
   */
  static map(batch?: number | null, objs?: C3.Array<any>, job?: MapReduce<any, string | null, any, any> | null, subBatch?: number | null): C3.Map<string | null, any>;
   ...
   */
  static reduce(outKey?: string | null, interValues?: C3.Array<any>, job?: MapReduce<any, string | null, any, any> | null): any | C3.Array<any> | null;
   ...
   */
  static mapCompleted(job?: MapReduce<any, string | null, any, any> | null): void;
   ...
   */
  static completed(job?: MapReduce<any, string | null, any, any> | null): string | null;
   ...
   */
  static failed(job: MapReduce<any, string | null, any, any>, status: MapReduceStatus, options?: MapReduceOptions | null): void;
   ...
   */
  results(limit?: number | null): C3.Map<string | null, any | C3.Array<any> | null>;
   ...
   */
  static startFromSpec(spec: DynMapReduceSpec): DynMapReduce;
}
