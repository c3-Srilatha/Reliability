// TypeScript definitions for the C3 type OnClose

/**
 * Lambda for Closable onClose callback.
 *
 * @remarks this represents a value passed to a method that expects an instance of OnClose
 */
declare interface IOnClose {
 ...
 * Lambda for Closable onClose callback.
 *
 * @remarks this represents a made instance of OnClose
 */
declare class OnClose extends Obj {

  /**
   * Partially applied arguments.
   */
  readonly appliedArgs?: C3.Map<string | null, any>;
  withAppliedArgs(appliedArgs: C3.Map<string | null, any> | {[key: string | null]: any}): OnClose;

  /**
   * The original function signature before arguments were partially applied.
   */
  readonly baseSignature?: string | null;
  withBaseSignature(baseSignature: string | null): OnClose;
  ...
  withLanguage(language: string): OnClose;

  /**
   * An implementation of this this lambda. Depends on #language.
   */
  readonly implementation: string;
  withImplementation(implementation: string): OnClose;

  /**
   * Extra settings to establish in the target execution environment before execution.
   */
  readonly environment?: C3.Map<string | null, any>;
  withEnvironment(environment: C3.Map<string | null, any> | {[key: string | null]: any}): OnClose;
  ...
  withActionRequirement(actionRequirement: string | null): OnClose;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): OnClose | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): OnClose | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): OnClose | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): OnClose | null;
   ...
   */
  replaceType(old: Type, new_: Type): OnClose;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): OnClose;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): OnClose;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<OnClose | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<OnClose | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): OnClose;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): OnClose;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): OnClose;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): OnClose;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): OnClose;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): OnClose;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): OnClose;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): OnClose;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): OnClose;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): OnClose;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): OnClose;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): OnClose;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): OnClose;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): OnClose;
   ...
   * @see #unsetField
   */
  defaultField(field: string): OnClose;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): OnClose;
   ...
   * @see #removeField
   */
  unsetField(field: string): OnClose;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): OnClose;
   ...
   * @see #unsetField
   */
  removeField(field: string): OnClose;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): OnClose;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): OnClose;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): OnClose;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): OnClose;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): OnClose;

  mergeJson(json: any | null): OnClose;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): OnClose;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): OnClose;
   ...
   */
  singletonArray(): C3.Array<OnClose | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<OnClose | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<OnClose | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<OnClose | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<OnClose | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, OnClose | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, OnClose | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<OnClose | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<OnClose | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): OnClose;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): OnClose;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): OnClose;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): OnClose;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): OnClose;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): OnClose;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): OnClose;
   ...
   */
  static cachedEmptyInst(): OnClose;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<OnClose>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): OnClose;
   ...
   */
  withSignature(signature?: FunctionType | null): OnClose;
   ...
   *           name of the method
   */
  static fromAction(type: Type, action: string): OnClose;
   ...
   */
  static fromJavaMethod(class_: string, method: string, functionType?: string | null): OnClose;
   ...
   */
  static fromJavaSrc(javaCode: string): OnClose;
   ...
   */
  static fromJavaSerializableSupplier(javaSerializableSupplier: λSupplier<any>): OnClose;
   ...
   */
  static fromJavaSerializableFunction(javaSerializableFunction: λFunction<any, any>): OnClose;
   ...
   */
  static fromJavaSerializableBiFunction(javaSerializableBiFunction: λBiFunction<any, any, any>): OnClose;
   ...
   */
  static fromJavaSerializableRunnable(javaSerializableRunnable: λNullConsumer): OnClose;
   ...
   * @see #fromJsFunc
   */
  static fromJsSrc(functionCode: string): OnClose;
   ...
   * @see #fromJsSrc
   */
  static fromJsFunc(func: any): OnClose;
   ...
   */
  static fromPySrc(functionCode: string, actionRequirement?: string | null): OnClose;
   ...
   *           Lambda function implemented in python
   */
  static fromPyFunc(func: any, actionRequirement?: string | null): OnClose;
   ...
   * @see #fromPySrc
   */
  static fromSrc(signature: FunctionType, src: Content | null): OnClose;
   ...
   * @see #fromJsFunc
   */
  static fromSrc(signature: FunctionType, language: string, impl: string, actionRequirement?: string | null): OnClose;
   ...
   */
  static fromString(s: string | null): OnClose | null;
   ...
   * @see #fromString
   */
  static convertFromString(s: string | null, failIfInvalid?: boolean): OnClose | null;
