// TypeScript definitions for the C3 type PackageFile

/**
 * A deployment package file is a zip file containing the files requirement by an application.
 * Following file types are accepted:
 *  - *.c3typ; *.c3app; *.c3ui: module definitions. Module definition files in the .zip must be in the sub folder
 *       with the same name as package where this module belongs.
 *  - *.js : the action implementations associated with the module definitions.
 *      The javascript files must be in a directory named after the module name.
 *  - *.json : the data that should be upserted as part of this deployment.
 *      There are two ways to package the json files:
 *         1. ${package}/${module}/${type}.json: a directory named after the module name contains a file named
 *             after the type name.
 *         2. ${package}/${module}/${type}/data1.json: if you have multiple data files for the same type,
 *             you can package them up in a directory named after the module name containing a directory named
 *              after the type name.
 *  - binary attachments: an 'attachments' directory might contains random binary files.
 *     These files might be used if you provide data for BundleAttachment type.
 *
 *
 * Example:
 *   +- attachments
 ...
 *      |- baz.c3ui
 *
 * @remarks this represents a value passed to a method that expects an instance of PackageFile
 */
declare interface IPackageFile {
  ...
  numContentRevisions?: number | null;
 ...
 *      |- baz.c3ui
 *
 * @remarks this represents a made instance of PackageFile
 */
declare class PackageFile extends Obj {

  readonly estimatedSize?: number | null;
  withEstimatedSize(estimatedSize: number | null): PackageFile;

  readonly layout?: string | null;
  withLayout(layout: string | null): PackageFile;

  readonly chunkSize?: number | null;
  withChunkSize(chunkSize: number | null): PackageFile;

  readonly numChunks?: number | null;
  withNumChunks(numChunks: number | null): PackageFile;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): PackageFile;

  readonly size?: number | null;
  withSize(size: number | null): PackageFile;

  readonly contentType?: string | null;
  withContentType(contentType: string | null): PackageFile;

  readonly checksum?: string | null;
  withChecksum(checksum: string | null): PackageFile;

  readonly tag?: string | null;
  withTag(tag: string | null): PackageFile;

  readonly context?: string | null;
  withContext(context: string | null): PackageFile;

  readonly numContentRevisions?: number | null;
  withNumContentRevisions(numContentRevisions: number | null): PackageFile;

  readonly fileSystem?: string | null;
  withFileSystem(fileSystem: string | null): PackageFile;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): PackageFile;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): PackageFile;
  ...
  withVersion(version: number | null): PackageFile;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): PackageFile;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): PackageFile | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): PackageFile | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): PackageFile | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): PackageFile | null;
   ...
   */
  replaceType(old: Type, new_: Type): PackageFile;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PackageFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PackageFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PackageFile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PackageFile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): PackageFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PackageFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PackageFile;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PackageFile;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PackageFile;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PackageFile;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): PackageFile;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PackageFile;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PackageFile;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): PackageFile;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): PackageFile;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): PackageFile;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): PackageFile;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PackageFile;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): PackageFile;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PackageFile;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PackageFile;
   ...
   * @see #removeField
   */
  unsetField(field: string): PackageFile;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PackageFile;
   ...
   * @see #unsetField
   */
  removeField(field: string): PackageFile;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PackageFile;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): PackageFile;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): PackageFile;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): PackageFile;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): PackageFile;

  mergeJson(json: any | null): PackageFile;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): PackageFile;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): PackageFile;
   ...
   */
  singletonArray(): C3.Array<PackageFile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<PackageFile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PackageFile | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<PackageFile | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PackageFile | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, PackageFile | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PackageFile | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PackageFile | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PackageFile | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): PackageFile;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): PackageFile;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): PackageFile;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PackageFile;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): PackageFile;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PackageFile;
   ...
   * @see #fromString
   */
  static make(s: string | null): PackageFile | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): PackageFile;
   ...
   */
  static cachedEmptyInst(): PackageFile;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<PackageFile>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): PackageFile;

  /**
   * not implemented yet
   * zipped : string enum ("none", "gzip", "bzip2")
   * Placeholder methods for streaming implementation of File.openWrite() and File.openRead() within 1 JVM
   * write(OldContent obj, boolean trimAfterWrite, decimal offset)
   * read(OldContent obj, decimal offset, int numBytesToRead) : Obj
   * trimAfterWrite = true means that the file will be truncate after writing content at offset.
   * So, the size of the file after this operation will be offset content.length. trimAfterWrite defaults to false
   * offset defaults to 0
   * characterSet defaults to UTF-8
   * Returns the new length of the file
   */
  static writeString(obj?: OldContent | null, content?: string | null, trimAfterWrite?: boolean, offset?: number | null, characterSet?: string | null): number | null;

  /**
   * offset defaults to 0
   * numBytesToRead defaults to min(content size, 1000) bytes
   * characterSet defaults to UTF-8
   */
  static readString(obj?: OldContent | null, offset?: number | null, numBytesToRead?: number | null, characterSet?: string | null): string | null;

  /**
   * Returns the new length of the file
   */
  static truncate(obj?: OldContent | null, offset?: number | null): number | null;

  /**
   * gzip compresses content; newId and newName is optional and if not provided .gz will be appended to an existing value
   */
  static gzip(obj?: OldContent | null, newId?: string | null, newName?: string | null): Obj | null;

  /**
   * gzip de-compresses content; newId and newName is optional and if not provided .gz will be removed from an existing value
   */
  static gunzip(obj?: OldContent | null, newId?: string | null, newName?: string | null): Obj | null;

  /**
   * mutate the headers from app
   */
  static headers(obj?: OldContent | null, op?: string | null, headers?: C3.Map<string | null, string | null>): C3.Map<string | null, string | null>;

  static contentCreated(txn?: Transaction | null): void;

  static contentUpdated(txn?: Transaction | null): void;

  static contentRemoved(txn?: Transaction | null): void;

  /**
   * Writes content to a temporary system file and returns its path
   * Writes file named tmpName+tmpExtension (tmpExtension should start with .)
   */
  static writeToTmpFile(obj?: OldContent | null, tmpName?: string | null, tmpExtension?: string | null): string | null;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<PackageFile | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PackageFile | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<PackageFile | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<PackageFile | null> | null>;
   ...
   */
  get(include?: string | null): PackageFile | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): PackageFile | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PackageFile;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): PackageFile | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PackageFile;
   ...
   * @see #toString
   */
  static fromString(s: string | null): PackageFile | null;
   ...
   */
  create(spec?: UpsertSpec | null): PackageFile | null;
   ...
   */
  static createBatch(objs: C3.Array<PackageFile | null> | null, spec?: UpsertSpec | null): ObjList<PackageFile | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PackageFile | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<PackageFile | null> | null;
   ...
   */
  update(srcObj?: PackageFile | null, spec?: UpsertSpec | null): PackageFile | null;
   ...
   */
  upsert(srcObj?: PackageFile | null, spec?: UpsertSpec | null): PackageFile | null;
   ...
   */
  merge(spec?: MergeSpec | null): PackageFile | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): PackageFile | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): PackageFile | null;
   ...
   */
  static updateBatch(objs: C3.Array<PackageFile | null> | null, srcObjs?: C3.Array<PackageFile | null>, spec?: UpsertSpec | null): ObjList<PackageFile | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<PackageFile | null>>, spec?: UpsertSpec | null): ObjList<PackageFile | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<PackageFile | null> | null, srcObjs?: C3.Array<PackageFile | null>, spec?: UpsertSpec | null): ObjList<PackageFile | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<PackageFile | null>>, spec?: UpsertSpec | null): ObjList<PackageFile | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<PackageFile | null> | null, spec?: TouchSpec | null): ObjList<PackageFile | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PackageFile | null> | null, spec?: MergeSpec | null): ObjList<PackageFile | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PackageFile | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<PackageFile | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<PackageFile | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<PackageFile | null> | null;
   ...
   */
  static mergeAll(mergeObj: PackageFile | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PackageFile | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<PackageFile | null> | null, spec?: UpsertSpec | null): ObjList<PackageFile | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<PackageFile | null> | null, spec?: UpsertSpec | null): ObjList<PackageFile | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<PackageFile | null> | null): ObjList<PackageFile | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<PackageFile | null> | null): ObjList<PackageFile | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<PackageFile | null> | null): ObjList<PackageFile | null>;
   ...
   */
  static afterCreate(objs: C3.Array<PackageFile | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<PackageFile | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<PackageFile | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<PackageFile | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<PackageFile | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): PackageFile | null;
   ...
   */
  withoutIdentity(): PackageFile | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<PackageFile | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: PackageFile | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<PackageFile | null> | null, callback?: λFunction<PackageFile | null, PackageFile | null> | null): ObjList<PackageFile | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<PackageFile | null> | null, callback?: λFunction<PackageFile | null, PackageFile | null> | null): C3.Array<ObjError | null>;
