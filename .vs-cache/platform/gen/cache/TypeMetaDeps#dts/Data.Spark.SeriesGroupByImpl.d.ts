// TypeScript definitions for the C3 type Data.Spark.SeriesGroupByImpl
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Data.Spark.SeriesGroupByImpl
 */
declare namespace Data.Spark {
  export interface ISeriesGroupByImpl {
 ...
 */
declare namespace Data.Spark {
  export class SeriesGroupByImpl extends Obj {
    ...
    withEngine(engine: IData.ExecutionEngine | null): Data.Spark.SeriesGroupByImpl;

    /**
     * The plan that used to actualize this Data.Spark instance
     */
    pipeline?: PipelineSpec | null;
    withPipeline(pipeline: IPipelineSpec | null): Data.Spark.SeriesGroupByImpl;

    /**
     * The id number that represent this Data.Spark instance
     */
    nodeId?: string | null;
    withNodeId(nodeId: string | null): Data.Spark.SeriesGroupByImpl;

    /**
     * The output name of the pipeline
     */
    outputId?: string | null;
    withOutputId(outputId: string | null): Data.Spark.SeriesGroupByImpl;
     ...
     */
    static make(): Data.Spark.SeriesGroupByImpl;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.Spark.SeriesGroupByImpl;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.Spark.SeriesGroupByImpl;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.Spark.SeriesGroupByImpl;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.Spark.SeriesGroupByImpl;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.Spark.SeriesGroupByImpl | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.Spark.SeriesGroupByImpl | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.Spark.SeriesGroupByImpl | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.Spark.SeriesGroupByImpl | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.Spark.SeriesGroupByImpl;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Spark.SeriesGroupByImpl;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Spark.SeriesGroupByImpl;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Spark.SeriesGroupByImpl | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Spark.SeriesGroupByImpl | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.Spark.SeriesGroupByImpl;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Spark.SeriesGroupByImpl;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Spark.SeriesGroupByImpl;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.Spark.SeriesGroupByImpl;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.Spark.SeriesGroupByImpl;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.Spark.SeriesGroupByImpl;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.Spark.SeriesGroupByImpl;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.Spark.SeriesGroupByImpl;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.Spark.SeriesGroupByImpl;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.Spark.SeriesGroupByImpl;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.Spark.SeriesGroupByImpl;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.Spark.SeriesGroupByImpl;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.Spark.SeriesGroupByImpl;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.Spark.SeriesGroupByImpl;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.Spark.SeriesGroupByImpl;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.Spark.SeriesGroupByImpl;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.Spark.SeriesGroupByImpl;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.Spark.SeriesGroupByImpl;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.Spark.SeriesGroupByImpl;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.Spark.SeriesGroupByImpl;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.Spark.SeriesGroupByImpl;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.Spark.SeriesGroupByImpl;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.Spark.SeriesGroupByImpl;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.Spark.SeriesGroupByImpl;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.Spark.SeriesGroupByImpl;

    mergeJson(json: any | null): Data.Spark.SeriesGroupByImpl;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.Spark.SeriesGroupByImpl;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.Spark.SeriesGroupByImpl;
     ...
     */
    singletonArray(): C3.Array<Data.Spark.SeriesGroupByImpl | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.Spark.SeriesGroupByImpl | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.Spark.SeriesGroupByImpl | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.Spark.SeriesGroupByImpl | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.Spark.SeriesGroupByImpl | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.Spark.SeriesGroupByImpl | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.Spark.SeriesGroupByImpl | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.Spark.SeriesGroupByImpl | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.Spark.SeriesGroupByImpl | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.Spark.SeriesGroupByImpl;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.Spark.SeriesGroupByImpl;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.Spark.SeriesGroupByImpl;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Data.Spark.SeriesGroupByImpl;
     ...
     */
    static cachedEmptyInst(): Data.Spark.SeriesGroupByImpl;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.Spark.SeriesGroupByImpl>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.Spark.SeriesGroupByImpl;
     ...
     * @return this Obj
     */
    setField(field: string, value: any, doNotConvert?: boolean): Data.Spark.SeriesGroupByImpl;
     ...
     * @return this Obj
     */
    setField(field: FieldType, value: any, doNotConvert?: boolean): Data.Spark.SeriesGroupByImpl;
