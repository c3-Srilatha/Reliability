// TypeScript definitions for the C3 type ValueType
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of ValueType
 */
 ...
 * For general type system information, see {@link typesys.c3doc Type System}.
 *
 * @remarks this represents a made instance of ValueType
 */
declare class ValueType extends Obj {

  /**
   * Source file Pkg.Path a C3 Type declaration [.c3typ].
   */
  readonly declaredPkgPath?: string | null;
  withDeclaredPkgPath(declaredPkgPath: string | null): ValueType;

  /**
   * Source line number in a C3 Type declaration [.c3typ] file starting with 1 where this metadata element is declared.
   */
  readonly declaredSrcLine?: number | null;
  withDeclaredSrcLine(declaredSrcLine: number | null): ValueType;
  ...
  withDeclaredSrcCharInLine(declaredSrcCharInLine: number | null): ValueType;
   ...
   */
  readonly pkg: Pkg;
  withPkg(pkg: IPkg): ValueType;

  /**
   * SDK json representing instance of this type
   */
  readonly json?: any;
  withJson(json: any): ValueType;

  /**
   * The set of annotations defined on this element of metadata represented as json value.
   */
  readonly annotationsJson?: any | null;
  withAnnotationsJson(annotationsJson: any | null): ValueType;
  ...
  withModifier(modifier: string | null): ValueType;
   ...
   */
  replaceType(old: Type, new_: Type): ValueType;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ValueType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ValueType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ValueType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ValueType | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ValueType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ValueType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ValueType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ValueType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ValueType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ValueType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ValueType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ValueType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ValueType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ValueType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ValueType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ValueType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ValueType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ValueType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ValueType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ValueType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ValueType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ValueType;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ValueType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ValueType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ValueType;
   ...
   * @see #removeField
   */
  unsetField(field: string): ValueType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ValueType;
   ...
   * @see #unsetField
   */
  removeField(field: string): ValueType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ValueType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ValueType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ValueType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ValueType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ValueType;

  mergeJson(json: any | null): ValueType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ValueType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ValueType;
   ...
   */
  singletonArray(): C3.Array<ValueType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ValueType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ValueType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ValueType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ValueType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ValueType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ValueType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ValueType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ValueType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ValueType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ValueType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ValueType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ValueType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ValueType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ValueType;
   ...
   * @see #fromString
   */
  static make(s: string | null): ValueType | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ValueType;
   ...
   */
  static cachedEmptyInst(): ValueType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ValueType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ValueType;
   ...
   */
  withoutDeclaredSrcPos(recursive?: boolean): ValueType;
   ...
   */
  withAnnotation(ann: Annotation): ValueType;
   ...
   *         value for the field
   */
  withAnnotation(ann: string, annField?: string | null, value?: any): ValueType;
   ...
   * @see #toString
   */
  static fromString(s: string | null): ValueType | null;
