// TypeScript definitions for the C3 type NormalizationIssue

/**
 * Normalization specific data issue type.
 *
 * @remarks this represents a value passed to a method that expects an instance of NormalizationIssue
 */
declare interface INormalizationIssue {
 ...
 * Normalization specific data issue type.
 *
 * @remarks this represents a made instance of NormalizationIssue
 */
declare class NormalizationIssue extends Obj {

  /**
   * Target type of the obj with the issue.
   */
  readonly targetType: string;
  withTargetType(targetType: string): NormalizationIssue;

  /**
   * Id of obj with the issue.  If null, the issue applies to all objs for the `targetType`
   */
  readonly targetId?: string | null;
  withTargetId(targetId: string | null): NormalizationIssue;

  /**
   * Field with the issue.  If null, the issue applies to all fields in the `targetType` (where applicable).
   */
  readonly targetField?: string | null;
  withTargetField(targetField: string | null): NormalizationIssue;

  /**
   * DataIssue severity.
   */
  readonly severity: string;
  withSeverity(severity: string): NormalizationIssue;
  ...
  withTypeIdent(typeIdent: string | null): NormalizationIssue;
   ...
   */
  readonly id: string;
  withId(id: string): NormalizationIssue;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): NormalizationIssue;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): NormalizationIssue;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): NormalizationIssue;
  ...
  withVersion(version: number | null): NormalizationIssue;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): NormalizationIssue;

  /**
   * Error message indicating the nature of the issue.
   */
  readonly errorMsg?: string | null;
  withErrorMsg(errorMsg: string | null): NormalizationIssue;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): NormalizationIssue | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): NormalizationIssue | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): NormalizationIssue | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): NormalizationIssue | null;
   ...
   */
  replaceType(old: Type, new_: Type): NormalizationIssue;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NormalizationIssue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NormalizationIssue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NormalizationIssue | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NormalizationIssue | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): NormalizationIssue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NormalizationIssue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NormalizationIssue;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): NormalizationIssue;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): NormalizationIssue;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): NormalizationIssue;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): NormalizationIssue;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): NormalizationIssue;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): NormalizationIssue;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): NormalizationIssue;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): NormalizationIssue;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): NormalizationIssue;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): NormalizationIssue;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): NormalizationIssue;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): NormalizationIssue;
   ...
   * @see #unsetField
   */
  defaultField(field: string): NormalizationIssue;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): NormalizationIssue;
   ...
   * @see #removeField
   */
  unsetField(field: string): NormalizationIssue;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): NormalizationIssue;
   ...
   * @see #unsetField
   */
  removeField(field: string): NormalizationIssue;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): NormalizationIssue;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): NormalizationIssue;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): NormalizationIssue;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): NormalizationIssue;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): NormalizationIssue;

  mergeJson(json: any | null): NormalizationIssue;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): NormalizationIssue;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): NormalizationIssue;
   ...
   */
  singletonArray(): C3.Array<NormalizationIssue | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<NormalizationIssue | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<NormalizationIssue | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<NormalizationIssue | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<NormalizationIssue | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, NormalizationIssue | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, NormalizationIssue | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<NormalizationIssue | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<NormalizationIssue | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): NormalizationIssue;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): NormalizationIssue;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): NormalizationIssue;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): NormalizationIssue;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): NormalizationIssue;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): NormalizationIssue;
   ...
   * @see #fromString
   */
  static make(s: string | null): NormalizationIssue | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): NormalizationIssue;
   ...
   */
  static cachedEmptyInst(): NormalizationIssue;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<NormalizationIssue>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): NormalizationIssue;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<NormalizationIssue | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<NormalizationIssue | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<NormalizationIssue | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<NormalizationIssue | null> | null>;
   ...
   */
  get(include?: string | null): NormalizationIssue | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): NormalizationIssue | null;
   ...
   */
  getMissing(spec: GetMissingSpec): NormalizationIssue;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): NormalizationIssue | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): NormalizationIssue;
   ...
   * @see #toString
   */
  static fromString(s: string | null): NormalizationIssue | null;
   ...
   */
  create(spec?: UpsertSpec | null): NormalizationIssue | null;
   ...
   */
  static createBatch(objs: C3.Array<NormalizationIssue | null> | null, spec?: UpsertSpec | null): ObjList<NormalizationIssue | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<NormalizationIssue | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<NormalizationIssue | null> | null;
   ...
   */
  update(srcObj?: NormalizationIssue | null, spec?: UpsertSpec | null): NormalizationIssue | null;
   ...
   */
  upsert(srcObj?: NormalizationIssue | null, spec?: UpsertSpec | null): NormalizationIssue | null;
   ...
   */
  merge(spec?: MergeSpec | null): NormalizationIssue | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): NormalizationIssue | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): NormalizationIssue | null;
   ...
   */
  static updateBatch(objs: C3.Array<NormalizationIssue | null> | null, srcObjs?: C3.Array<NormalizationIssue | null>, spec?: UpsertSpec | null): ObjList<NormalizationIssue | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<NormalizationIssue | null>>, spec?: UpsertSpec | null): ObjList<NormalizationIssue | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<NormalizationIssue | null> | null, srcObjs?: C3.Array<NormalizationIssue | null>, spec?: UpsertSpec | null): ObjList<NormalizationIssue | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<NormalizationIssue | null>>, spec?: UpsertSpec | null): ObjList<NormalizationIssue | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<NormalizationIssue | null> | null, spec?: TouchSpec | null): ObjList<NormalizationIssue | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<NormalizationIssue | null> | null, spec?: MergeSpec | null): ObjList<NormalizationIssue | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<NormalizationIssue | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<NormalizationIssue | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<NormalizationIssue | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<NormalizationIssue | null> | null;
   ...
   */
  static mergeAll(mergeObj: NormalizationIssue | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: NormalizationIssue | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<NormalizationIssue | null> | null, spec?: UpsertSpec | null): ObjList<NormalizationIssue | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<NormalizationIssue | null> | null, spec?: UpsertSpec | null): ObjList<NormalizationIssue | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): NormalizationIssue | null;
   ...
   */
  static beforeCreate(objs: C3.Array<NormalizationIssue | null> | null): ObjList<NormalizationIssue | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<NormalizationIssue | null> | null): ObjList<NormalizationIssue | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<NormalizationIssue | null> | null): ObjList<NormalizationIssue | null>;
   ...
   */
  static afterCreate(objs: C3.Array<NormalizationIssue | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<NormalizationIssue | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<NormalizationIssue | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<NormalizationIssue | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<NormalizationIssue | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): NormalizationIssue | null;
   ...
   */
  withoutIdentity(): NormalizationIssue | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<NormalizationIssue | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: NormalizationIssue | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<NormalizationIssue | null> | null, callback?: λFunction<NormalizationIssue | null, NormalizationIssue | null> | null): ObjList<NormalizationIssue | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<NormalizationIssue | null> | null, callback?: λFunction<NormalizationIssue | null, NormalizationIssue | null> | null): C3.Array<ObjError | null>;
