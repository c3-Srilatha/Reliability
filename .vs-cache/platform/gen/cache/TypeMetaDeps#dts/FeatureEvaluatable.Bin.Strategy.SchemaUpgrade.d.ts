// TypeScript definitions for the C3 type FeatureEvaluatable.Bin.Strategy.SchemaUpgrade
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of FeatureEvaluatable.Bin.Strategy.SchemaUpgrade
 */
declare namespace FeatureEvaluatable.Bin.Strategy {
  export interface ISchemaUpgrade {
  }
}
 ...
 */
declare namespace FeatureEvaluatable.Bin.Strategy {
  export class SchemaUpgrade extends Obj {
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade | null;
     ...
     */
    replaceType(old: Type, new_: Type): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FeatureEvaluatable.Bin.Strategy.SchemaUpgrade | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FeatureEvaluatable.Bin.Strategy.SchemaUpgrade | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     * @see #unsetField
     */
    defaultField(field: string): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     * @see #removeField
     */
    unsetField(field: string): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     * @see #unsetField
     */
    removeField(field: string): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;

    mergeJson(json: any | null): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     */
    singletonArray(): C3.Array<FeatureEvaluatable.Bin.Strategy.SchemaUpgrade | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<FeatureEvaluatable.Bin.Strategy.SchemaUpgrade | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<FeatureEvaluatable.Bin.Strategy.SchemaUpgrade | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<FeatureEvaluatable.Bin.Strategy.SchemaUpgrade | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<FeatureEvaluatable.Bin.Strategy.SchemaUpgrade | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, FeatureEvaluatable.Bin.Strategy.SchemaUpgrade | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, FeatureEvaluatable.Bin.Strategy.SchemaUpgrade | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<FeatureEvaluatable.Bin.Strategy.SchemaUpgrade | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<FeatureEvaluatable.Bin.Strategy.SchemaUpgrade | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     */
    static cachedEmptyInst(): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<FeatureEvaluatable.Bin.Strategy.SchemaUpgrade>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): FeatureEvaluatable.Bin.Strategy.SchemaUpgrade;
     ...
     */
    static resetVersion(version?: number | null): number | null;
     ...
     */
    static addVarcharColumn(tableName: string, colName: string, length?: number | null, onlyIfMissing?: boolean): void;
     ...
     *           if true, the column will only be created if it doesn't already exist.
     */
    static addNumericColumn(tableName: string, colName: string, scale: number, precision?: number | null, onlyIfMissing?: boolean): void;
     ...
     */
    static deleteTableRows(tableName: string, sqlCondition?: string | null): number;
     ...
     */
    static batchIds(tableName: string, suggestedNumBatches?: number | null, batchSize?: number | null, filter?: string | null): C3.Array<string | null>;
     ...
     */
    static copyFromOldSchemaToExtendableType(oldRootSchemaName: string, type: Type, oldRootTypeKey: string | null, spec?: CopyFromOldSchemaToExtendableTypeSpec | null): void;
     ...
     */
    static updateReferences(type: Type, valueMapping: C3.Map<string | null, string | null>): void;
     ...
     */
    static updateIds(type: Type, valueMapping: C3.Map<string | null, string | null>, ignoreIfAlreadyExists?: boolean): void;
     ...
     *        Options to run the job with.
     */
    static scheduleMapReduce(job: MapReduce<any, any, any, any>, options?: MapReduceOptions | null): void;
     ...
     */
    static migrations(): C3.Array<string | null>;
     ...
     */
    static migrateTypeIdentifier_1(): void;
  }
}
