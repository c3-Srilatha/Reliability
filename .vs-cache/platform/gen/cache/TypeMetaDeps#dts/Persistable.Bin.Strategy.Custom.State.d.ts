// TypeScript definitions for the C3 type Persistable.Bin.Strategy.Custom.State

/**
 * @remarks this represents a value passed to a method that expects an instance of Persistable.Bin.Strategy.Custom.State
 */
declare namespace Persistable.Bin.Strategy.Custom {
  export interface IState {
    ...
    parent: IPersistable.Bin.Strategy;
 ...
 */
declare namespace Persistable.Bin.Strategy.Custom {
  export class State extends Obj {

    /**
     * Partition key Bin separator used to separate partition key from bin id
     */
    readonly PK_BIN_SEPARATOR?: string | null;
    withPK_BIN_SEPARATOR(PK_BIN_SEPARATOR: string | null): Persistable.Bin.Strategy.Custom.State;

    readonly parent: Persistable.Bin.Strategy;
    withParent(parent: IPersistable.Bin.Strategy): Persistable.Bin.Strategy.Custom.State;
     ...
     */
    readonly id: string;
    withId(id: string): Persistable.Bin.Strategy.Custom.State;
    ...
    withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Persistable.Bin.Strategy.Custom.State;

    /**
     * Name of the Obj instance
     */
    readonly name?: string | null;
    withName(name: string | null): Persistable.Bin.Strategy.Custom.State;

    /**
     * Various system fields.
     */
    readonly meta?: Meta | null;
    withMeta(meta: IMeta | null): Persistable.Bin.Strategy.Custom.State;
    ...
    withVersion(version: number | null): Persistable.Bin.Strategy.Custom.State;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type | null;
    withTypeWithBindings(typeWithBindings: IType | null): Persistable.Bin.Strategy.Custom.State;
     ...
     */
    readonly binMap: any;
    withBinMap(binMap: any): Persistable.Bin.Strategy.Custom.State;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Persistable.Bin.Strategy.Custom.State | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Persistable.Bin.Strategy.Custom.State | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Persistable.Bin.Strategy.Custom.State | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Persistable.Bin.Strategy.Custom.State | null;
     ...
     */
    replaceType(old: Type, new_: Type): Persistable.Bin.Strategy.Custom.State;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Persistable.Bin.Strategy.Custom.State;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Persistable.Bin.Strategy.Custom.State;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Persistable.Bin.Strategy.Custom.State | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Persistable.Bin.Strategy.Custom.State | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Persistable.Bin.Strategy.Custom.State;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Persistable.Bin.Strategy.Custom.State;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Persistable.Bin.Strategy.Custom.State;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Persistable.Bin.Strategy.Custom.State;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Persistable.Bin.Strategy.Custom.State;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Persistable.Bin.Strategy.Custom.State;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Persistable.Bin.Strategy.Custom.State;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Persistable.Bin.Strategy.Custom.State;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Persistable.Bin.Strategy.Custom.State;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Persistable.Bin.Strategy.Custom.State;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Persistable.Bin.Strategy.Custom.State;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Persistable.Bin.Strategy.Custom.State;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Persistable.Bin.Strategy.Custom.State;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Persistable.Bin.Strategy.Custom.State;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Persistable.Bin.Strategy.Custom.State;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Persistable.Bin.Strategy.Custom.State;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Persistable.Bin.Strategy.Custom.State;
     ...
     * @see #removeField
     */
    unsetField(field: string): Persistable.Bin.Strategy.Custom.State;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Persistable.Bin.Strategy.Custom.State;
     ...
     * @see #unsetField
     */
    removeField(field: string): Persistable.Bin.Strategy.Custom.State;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Persistable.Bin.Strategy.Custom.State;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Persistable.Bin.Strategy.Custom.State;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Persistable.Bin.Strategy.Custom.State;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Persistable.Bin.Strategy.Custom.State;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Persistable.Bin.Strategy.Custom.State;

    mergeJson(json: any | null): Persistable.Bin.Strategy.Custom.State;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Persistable.Bin.Strategy.Custom.State;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Persistable.Bin.Strategy.Custom.State;
     ...
     */
    singletonArray(): C3.Array<Persistable.Bin.Strategy.Custom.State | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Persistable.Bin.Strategy.Custom.State | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Persistable.Bin.Strategy.Custom.State | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Persistable.Bin.Strategy.Custom.State | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Persistable.Bin.Strategy.Custom.State | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Persistable.Bin.Strategy.Custom.State | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Persistable.Bin.Strategy.Custom.State | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Persistable.Bin.Strategy.Custom.State | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Persistable.Bin.Strategy.Custom.State | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Persistable.Bin.Strategy.Custom.State;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Persistable.Bin.Strategy.Custom.State;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Persistable.Bin.Strategy.Custom.State;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Persistable.Bin.Strategy.Custom.State;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Persistable.Bin.Strategy.Custom.State;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Persistable.Bin.Strategy.Custom.State;
     ...
     * @see #fromString
     */
    static make(s: string | null): Persistable.Bin.Strategy.Custom.State | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Persistable.Bin.Strategy.Custom.State;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Persistable.Bin.Strategy.Custom.State;
     ...
     */
    static cachedEmptyInst(): Persistable.Bin.Strategy.Custom.State;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Persistable.Bin.Strategy.Custom.State>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Persistable.Bin.Strategy.Custom.State;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<Persistable.Bin.Strategy.Custom.State | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<Persistable.Bin.Strategy.Custom.State | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<Persistable.Bin.Strategy.Custom.State | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): Persistable.Bin.Strategy.Custom.State | null;
     ...
     * @see findByCacheKey
     */
    static forCacheKey(key: string | null): Persistable.Bin.Strategy.Custom.State | null;
     ...
     * @see findByCacheKey
     */
    getCached(): Persistable.Bin.Strategy.Custom.State | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): Persistable.Bin.Strategy.Custom.State | null;
     ...
     */
    static produce(key: string): Persistable.Bin.Strategy.Custom.State | null;
     ...
     */
    static produceAll(): C3.Map<string | null, Persistable.Bin.Strategy.Custom.State | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, Persistable.Bin.Strategy.Custom.State | null>;
     ...
     */
    partitionKey(failIfMissing?: boolean): Persistable.Bin.Strategy | null;
     ...
     */
    static partition(objs?: Stream<Persistable.Bin.Strategy.Custom.State | null>, spec?: PartitionBucketStrategy | null): C3.Map<string | null, KvDataPartition | null>;
     ...
     */
    static fromPartitions(partitions?: Stream<KvDataPartition | null>): Stream<Persistable.Bin.Strategy.Custom.State | null>;
     ...
     */
    static fetch(spec?: FetchSpec | null): FetchResult<Persistable.Bin.Strategy.Custom.State | null>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Persistable.Bin.Strategy.Custom.State | null>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Persistable.Bin.Strategy.Custom.State | null>;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Persistable.Bin.Strategy.Custom.State | null> | null>;
     ...
     */
    get(include?: string | null): Persistable.Bin.Strategy.Custom.State | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string | null): Persistable.Bin.Strategy.Custom.State | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Persistable.Bin.Strategy.Custom.State;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string | null): Persistable.Bin.Strategy.Custom.State | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Persistable.Bin.Strategy.Custom.State;
     ...
     * @see #toString
     */
    static fromString(s: string | null): Persistable.Bin.Strategy.Custom.State | null;
     ...
     */
    create(spec?: UpsertSpec | null): Persistable.Bin.Strategy.Custom.State | null;
     ...
     */
    static createBatch(objs: C3.Array<Persistable.Bin.Strategy.Custom.State | null> | null, spec?: UpsertSpec | null): ObjList<Persistable.Bin.Strategy.Custom.State | null> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Persistable.Bin.Strategy.Custom.State | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Persistable.Bin.Strategy.Custom.State | null> | null;
     ...
     */
    update(srcObj?: Persistable.Bin.Strategy.Custom.State | null, spec?: UpsertSpec | null): Persistable.Bin.Strategy.Custom.State | null;
     ...
     */
    upsert(srcObj?: Persistable.Bin.Strategy.Custom.State | null, spec?: UpsertSpec | null): Persistable.Bin.Strategy.Custom.State | null;
     ...
     */
    merge(spec?: MergeSpec | null): Persistable.Bin.Strategy.Custom.State | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec | null): Persistable.Bin.Strategy.Custom.State | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec | null): Persistable.Bin.Strategy.Custom.State | null;
     ...
     */
    static updateBatch(objs: C3.Array<Persistable.Bin.Strategy.Custom.State | null> | null, srcObjs?: C3.Array<Persistable.Bin.Strategy.Custom.State | null>, spec?: UpsertSpec | null): ObjList<Persistable.Bin.Strategy.Custom.State | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<C3.Array<Persistable.Bin.Strategy.Custom.State | null>>, spec?: UpsertSpec | null): ObjList<Persistable.Bin.Strategy.Custom.State | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: C3.Array<Persistable.Bin.Strategy.Custom.State | null> | null, srcObjs?: C3.Array<Persistable.Bin.Strategy.Custom.State | null>, spec?: UpsertSpec | null): ObjList<Persistable.Bin.Strategy.Custom.State | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<C3.Array<Persistable.Bin.Strategy.Custom.State | null>>, spec?: UpsertSpec | null): ObjList<Persistable.Bin.Strategy.Custom.State | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: C3.Array<Persistable.Bin.Strategy.Custom.State | null> | null, spec?: TouchSpec | null): ObjList<Persistable.Bin.Strategy.Custom.State | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<Persistable.Bin.Strategy.Custom.State | null> | null, spec?: MergeSpec | null): ObjList<Persistable.Bin.Strategy.Custom.State | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<Persistable.Bin.Strategy.Custom.State | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Persistable.Bin.Strategy.Custom.State | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<C3.Array<Persistable.Bin.Strategy.Custom.State | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Persistable.Bin.Strategy.Custom.State | null> | null;
     ...
     */
    static mergeAll(mergeObj: Persistable.Bin.Strategy.Custom.State | null, spec?: MergeAllSpec | null): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Persistable.Bin.Strategy.Custom.State | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: C3.Array<Persistable.Bin.Strategy.Custom.State | null> | null, spec?: UpsertSpec | null): ObjList<Persistable.Bin.Strategy.Custom.State | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: C3.Array<Persistable.Bin.Strategy.Custom.State | null> | null, spec?: UpsertSpec | null): ObjList<Persistable.Bin.Strategy.Custom.State | null> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Persistable.Bin.Strategy.Custom.State | null;
     ...
     */
    static beforeCreate(objs: C3.Array<Persistable.Bin.Strategy.Custom.State | null> | null): ObjList<Persistable.Bin.Strategy.Custom.State | null>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: C3.Array<Persistable.Bin.Strategy.Custom.State | null> | null): ObjList<Persistable.Bin.Strategy.Custom.State | null>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: C3.Array<Persistable.Bin.Strategy.Custom.State | null> | null): ObjList<Persistable.Bin.Strategy.Custom.State | null>;
     ...
     */
    static afterCreate(objs: C3.Array<Persistable.Bin.Strategy.Custom.State | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: C3.Array<Persistable.Bin.Strategy.Custom.State | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: C3.Array<Persistable.Bin.Strategy.Custom.State | null> | null): C3.Array<ObjError | null>;
     ...
     */
    static startImportData(spec?: StartImportDataSpec | null): PushStream<Persistable.Bin.Strategy.Custom.State | null>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Persistable.Bin.Strategy.Custom.State | null>;
     ...
     */
    static forId(id: string | null, failIfMissing?: boolean): Persistable.Bin.Strategy.Custom.State | null;
     ...
     */
    withoutIdentity(): Persistable.Bin.Strategy.Custom.State | null;
     ...
     */
    static typeOfBatch(objs: C3.Array<Persistable.Bin.Strategy.Custom.State | null> | null): C3.Array<EntityType | null>;
     ...
     */
    static dbEcho(template?: Persistable.Bin.Strategy.Custom.State | null, count?: number | null, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: C3.Array<Persistable.Bin.Strategy.Custom.State | null> | null, callback?: λFunction<Persistable.Bin.Strategy.Custom.State | null, Persistable.Bin.Strategy.Custom.State | null> | null): ObjList<Persistable.Bin.Strategy.Custom.State | null>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: C3.Array<Persistable.Bin.Strategy.Custom.State | null> | null, callback?: λFunction<Persistable.Bin.Strategy.Custom.State | null, Persistable.Bin.Strategy.Custom.State | null> | null): C3.Array<ObjError | null>;
     ...
     */
    static binHashs(strategyId: string, subjectHashes?: C3.Set<number | null>): C3.Map<number | null, number | null>;
     ...
     * super low.)
     */
    static bins(strategyId: string, subjects: C3.Set<string | null>, hashFunc?: λFunction<string | null, number | null> | null): C3.Map<string | null, number | null>;
     ...
     */
    static upsertBinHashs(strategyId: string, binMap: C3.Map<number | null, number | null>): void;
     ...
     */
    static upsertBins(strategyId: string, binMap: C3.Map<string | null, number | null>, hashFunc?: λFunction<string | null, number | null> | null): void;
  }
}
