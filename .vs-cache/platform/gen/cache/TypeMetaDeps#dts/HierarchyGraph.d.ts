// TypeScript definitions for the C3 type HierarchyGraph

/**
 * Type to serialize a graph and store in a datastore
 *
 * @remarks this represents a value passed to a method that expects an instance of HierarchyGraph
 */
declare interface IHierarchyGraph {
 ...
 * Type to serialize a graph and store in a datastore
 *
 * @remarks this represents a made instance of HierarchyGraph
 */
declare class HierarchyGraph extends Obj {

  readonly estimatedSize?: number | null;
  withEstimatedSize(estimatedSize: number | null): HierarchyGraph;

  readonly layout?: string | null;
  withLayout(layout: string | null): HierarchyGraph;

  readonly chunkSize?: number | null;
  withChunkSize(chunkSize: number | null): HierarchyGraph;

  readonly numChunks?: number | null;
  withNumChunks(numChunks: number | null): HierarchyGraph;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): HierarchyGraph;

  readonly size?: number | null;
  withSize(size: number | null): HierarchyGraph;

  readonly contentType?: string | null;
  withContentType(contentType: string | null): HierarchyGraph;

  readonly checksum?: string | null;
  withChecksum(checksum: string | null): HierarchyGraph;

  readonly tag?: string | null;
  withTag(tag: string | null): HierarchyGraph;

  readonly context?: string | null;
  withContext(context: string | null): HierarchyGraph;

  readonly numContentRevisions?: number | null;
  withNumContentRevisions(numContentRevisions: number | null): HierarchyGraph;

  readonly fileSystem?: string | null;
  withFileSystem(fileSystem: string | null): HierarchyGraph;
   ...
   */
  readonly id: string;
  withId(id: string): HierarchyGraph;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): HierarchyGraph;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): HierarchyGraph;
  ...
  withVersion(version: number | null): HierarchyGraph;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): HierarchyGraph;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): HierarchyGraph | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): HierarchyGraph | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): HierarchyGraph | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): HierarchyGraph | null;
   ...
   */
  replaceType(old: Type, new_: Type): HierarchyGraph;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HierarchyGraph;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HierarchyGraph;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HierarchyGraph | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HierarchyGraph | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): HierarchyGraph;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HierarchyGraph;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HierarchyGraph;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): HierarchyGraph;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): HierarchyGraph;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): HierarchyGraph;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): HierarchyGraph;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): HierarchyGraph;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): HierarchyGraph;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): HierarchyGraph;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): HierarchyGraph;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): HierarchyGraph;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): HierarchyGraph;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): HierarchyGraph;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): HierarchyGraph;
   ...
   * @see #unsetField
   */
  defaultField(field: string): HierarchyGraph;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): HierarchyGraph;
   ...
   * @see #removeField
   */
  unsetField(field: string): HierarchyGraph;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): HierarchyGraph;
   ...
   * @see #unsetField
   */
  removeField(field: string): HierarchyGraph;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): HierarchyGraph;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): HierarchyGraph;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): HierarchyGraph;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): HierarchyGraph;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): HierarchyGraph;

  mergeJson(json: any | null): HierarchyGraph;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): HierarchyGraph;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): HierarchyGraph;
   ...
   */
  singletonArray(): C3.Array<HierarchyGraph | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<HierarchyGraph | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<HierarchyGraph | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<HierarchyGraph | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<HierarchyGraph | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, HierarchyGraph | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, HierarchyGraph | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<HierarchyGraph | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<HierarchyGraph | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): HierarchyGraph;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): HierarchyGraph;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): HierarchyGraph;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): HierarchyGraph;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): HierarchyGraph;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): HierarchyGraph;
   ...
   * @see #fromString
   */
  static make(s: string | null): HierarchyGraph | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): HierarchyGraph;
   ...
   */
  static cachedEmptyInst(): HierarchyGraph;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<HierarchyGraph>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): HierarchyGraph;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<HierarchyGraph | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<HierarchyGraph | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<HierarchyGraph | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<HierarchyGraph | null> | null>;
   ...
   */
  get(include?: string | null): HierarchyGraph | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): HierarchyGraph | null;
   ...
   */
  getMissing(spec: GetMissingSpec): HierarchyGraph;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): HierarchyGraph | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): HierarchyGraph;
   ...
   * @see #toString
   */
  static fromString(s: string | null): HierarchyGraph | null;
   ...
   */
  create(spec?: UpsertSpec | null): HierarchyGraph | null;
   ...
   */
  static createBatch(objs: C3.Array<HierarchyGraph | null> | null, spec?: UpsertSpec | null): ObjList<HierarchyGraph | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<HierarchyGraph | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<HierarchyGraph | null> | null;
   ...
   */
  update(srcObj?: HierarchyGraph | null, spec?: UpsertSpec | null): HierarchyGraph | null;
   ...
   */
  upsert(srcObj?: HierarchyGraph | null, spec?: UpsertSpec | null): HierarchyGraph | null;
   ...
   */
  merge(spec?: MergeSpec | null): HierarchyGraph | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): HierarchyGraph | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): HierarchyGraph | null;
   ...
   */
  static updateBatch(objs: C3.Array<HierarchyGraph | null> | null, srcObjs?: C3.Array<HierarchyGraph | null>, spec?: UpsertSpec | null): ObjList<HierarchyGraph | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<HierarchyGraph | null>>, spec?: UpsertSpec | null): ObjList<HierarchyGraph | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<HierarchyGraph | null> | null, srcObjs?: C3.Array<HierarchyGraph | null>, spec?: UpsertSpec | null): ObjList<HierarchyGraph | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<HierarchyGraph | null>>, spec?: UpsertSpec | null): ObjList<HierarchyGraph | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<HierarchyGraph | null> | null, spec?: TouchSpec | null): ObjList<HierarchyGraph | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<HierarchyGraph | null> | null, spec?: MergeSpec | null): ObjList<HierarchyGraph | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<HierarchyGraph | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<HierarchyGraph | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<HierarchyGraph | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<HierarchyGraph | null> | null;
   ...
   */
  static mergeAll(mergeObj: HierarchyGraph | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: HierarchyGraph | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<HierarchyGraph | null> | null, spec?: UpsertSpec | null): ObjList<HierarchyGraph | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<HierarchyGraph | null> | null, spec?: UpsertSpec | null): ObjList<HierarchyGraph | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<HierarchyGraph | null> | null): ObjList<HierarchyGraph | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<HierarchyGraph | null> | null): ObjList<HierarchyGraph | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<HierarchyGraph | null> | null): ObjList<HierarchyGraph | null>;
   ...
   */
  static afterCreate(objs: C3.Array<HierarchyGraph | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<HierarchyGraph | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<HierarchyGraph | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<HierarchyGraph | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<HierarchyGraph | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): HierarchyGraph | null;
   ...
   */
  withoutIdentity(): HierarchyGraph | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<HierarchyGraph | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: HierarchyGraph | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<HierarchyGraph | null> | null, callback?: λFunction<HierarchyGraph | null, HierarchyGraph | null> | null): ObjList<HierarchyGraph | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<HierarchyGraph | null> | null, callback?: λFunction<HierarchyGraph | null, HierarchyGraph | null> | null): C3.Array<ObjError | null>;
