// TypeScript definitions for the C3 type TupleType
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of TupleType
 */
declare interface ITupleType {
   ...
   */
  fieldTypes?: C3.Array<TupleFieldType | null> | Array<ITupleFieldType | null>;
}
 ...
 * that suggests a type might be preferable.
 *
 * @remarks this represents a made instance of TupleType
 */
declare class TupleType extends Obj {

  /**
   * Source file Pkg.Path a C3 Type declaration [.c3typ].
   */
  readonly declaredPkgPath?: string | null;
  withDeclaredPkgPath(declaredPkgPath: string | null): TupleType;

  /**
   * Source line number in a C3 Type declaration [.c3typ] file starting with 1 where this metadata element is declared.
   */
  readonly declaredSrcLine?: number | null;
  withDeclaredSrcLine(declaredSrcLine: number | null): TupleType;
  ...
  withDeclaredSrcCharInLine(declaredSrcCharInLine: number | null): TupleType;
   ...
   */
  readonly pkg: Pkg;
  withPkg(pkg: IPkg): TupleType;

  /**
   * SDK json representing instance of this type
   */
  readonly json?: any;
  withJson(json: any): TupleType;

  /**
   * The set of annotations defined on this element of metadata represented as json value.
   */
  readonly annotationsJson?: any | null;
  withAnnotationsJson(annotationsJson: any | null): TupleType;
  ...
  withModifier(modifier: string | null): TupleType;

  /**
   * Whether or not the tuple has names for each field or whether they can only be indexed.
   */
  readonly named?: boolean;
  withNamed(named: boolean): TupleType;

  /**
   * The declared field types. For simple tuples, this will never be empty but for named tuples with mixins it may be.
   */
  readonly fieldTypes?: C3.Array<TupleFieldType | null>;
  withFieldTypes(fieldTypes: C3.Array<TupleFieldType | null> | Array<ITupleFieldType | null>): TupleType;
   ...
   */
  replaceType(old: Type, new_: Type): TupleType;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TupleType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TupleType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TupleType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TupleType | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TupleType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TupleType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TupleType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TupleType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TupleType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TupleType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TupleType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TupleType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TupleType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TupleType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TupleType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TupleType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TupleType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TupleType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TupleType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TupleType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TupleType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TupleType;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TupleType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TupleType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TupleType;
   ...
   * @see #removeField
   */
  unsetField(field: string): TupleType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TupleType;
   ...
   * @see #unsetField
   */
  removeField(field: string): TupleType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TupleType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TupleType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TupleType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TupleType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TupleType;

  mergeJson(json: any | null): TupleType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TupleType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TupleType;
   ...
   */
  singletonArray(): C3.Array<TupleType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TupleType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TupleType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TupleType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TupleType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TupleType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TupleType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TupleType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TupleType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TupleType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TupleType;

  /**
   * Create a named tuple type from the specified type's fields.
   */
  static fromFields(type: Type): TupleType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TupleType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TupleType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TupleType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TupleType;
   ...
   * @see #fromString
   */
  static make(s: string | null): TupleType | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TupleType;
   ...
   */
  static cachedEmptyInst(): TupleType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TupleType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TupleType;
   ...
   */
  withoutDeclaredSrcPos(recursive?: boolean): TupleType;
   ...
   */
  withAnnotation(ann: Annotation): TupleType;
   ...
   *         value for the field
   */
  withAnnotation(ann: string, annField?: string | null, value?: any): TupleType;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TupleType | null;
   ...
   */
  static guessType(value: any, failIfNone?: boolean): TupleType | null;
   ...
   */
  fieldType(name: string, failIfMissing?: boolean): TupleFieldType | null;

  /**
   * Get a field type by index (declaration order).
   */
  fieldType(index: number, failIfMissing?: boolean): TupleFieldType | null;
   ...
   * tuple type.
   */
  convertFields(fields: C3.Map<string | null, any> | null, failIfInvalid?: boolean): C3.Map<string | null, any>;
   ...
   */
  convertFields(fields: C3.Array<any> | null, failIfInvalid?: boolean): C3.Map<string | null, any>;
   ...
   */
  toCollectionType(): CollectionType | null;
   ...
   */
  static ofTuple(v: any, failIfInvalid?: boolean): TupleType | null;
}
