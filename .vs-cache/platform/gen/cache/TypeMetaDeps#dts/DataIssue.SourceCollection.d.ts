// TypeScript definitions for the C3 type DataIssue.SourceCollection
 ...
 * change in schema.
 *
 * @remarks this represents a value passed to a method that expects an instance of DataIssue.SourceCollection
 */
declare namespace DataIssue {
  export interface ISourceCollection {
    ...
    sourceCollection: ISourceCollection<SourceCollection.Config | null>;
  }
}
...
declare namespace DataIssue {
  export class SourceCollection extends Obj {
    ...
    withTargetType(targetType: string): DataIssue.SourceCollection;

    /**
     * Id of obj with the issue.  If null, the issue applies to all objs for the `targetType`
     */
    readonly targetId?: string | null;
    withTargetId(targetId: string | null): DataIssue.SourceCollection;

    /**
     * Field with the issue.  If null, the issue applies to all fields in the `targetType` (where applicable).
     */
    readonly targetField?: string | null;
    withTargetField(targetField: string | null): DataIssue.SourceCollection;

    /**
     * DataIssue severity.
     */
    readonly severity: string;
    withSeverity(severity: string): DataIssue.SourceCollection;
    ...
    withTypeIdent(typeIdent: string | null): DataIssue.SourceCollection;
     ...
     */
    readonly id: string;
    withId(id: string): DataIssue.SourceCollection;
    ...
    withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): DataIssue.SourceCollection;

    /**
     * Name of the Obj instance
     */
    readonly name?: string | null;
    withName(name: string | null): DataIssue.SourceCollection;

    /**
     * Various system fields.
     */
    readonly meta?: Meta | null;
    withMeta(meta: IMeta | null): DataIssue.SourceCollection;
    ...
    withVersion(version: number | null): DataIssue.SourceCollection;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type | null;
    withTypeWithBindings(typeWithBindings: IType | null): DataIssue.SourceCollection;

    /**
     * Error message indicating the nature of the issue.
     */
    readonly errorMsg?: string | null;
    withErrorMsg(errorMsg: string | null): DataIssue.SourceCollection;

    readonly sourceCollection: SourceCollection<SourceCollection.Config | null>;
    withSourceCollection(sourceCollection: ISourceCollection<SourceCollection.Config | null>): DataIssue.SourceCollection;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): DataIssue.SourceCollection | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): DataIssue.SourceCollection | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): DataIssue.SourceCollection | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): DataIssue.SourceCollection | null;
     ...
     */
    replaceType(old: Type, new_: Type): DataIssue.SourceCollection;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataIssue.SourceCollection;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataIssue.SourceCollection;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataIssue.SourceCollection | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataIssue.SourceCollection | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataIssue.SourceCollection;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataIssue.SourceCollection;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataIssue.SourceCollection;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): DataIssue.SourceCollection;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): DataIssue.SourceCollection;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): DataIssue.SourceCollection;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataIssue.SourceCollection;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataIssue.SourceCollection;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): DataIssue.SourceCollection;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): DataIssue.SourceCollection;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): DataIssue.SourceCollection;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): DataIssue.SourceCollection;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataIssue.SourceCollection;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): DataIssue.SourceCollection;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataIssue.SourceCollection;
     ...
     * @see #unsetField
     */
    defaultField(field: string): DataIssue.SourceCollection;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): DataIssue.SourceCollection;
     ...
     * @see #removeField
     */
    unsetField(field: string): DataIssue.SourceCollection;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): DataIssue.SourceCollection;
     ...
     * @see #unsetField
     */
    removeField(field: string): DataIssue.SourceCollection;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): DataIssue.SourceCollection;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataIssue.SourceCollection;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): DataIssue.SourceCollection;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataIssue.SourceCollection;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataIssue.SourceCollection;

    mergeJson(json: any | null): DataIssue.SourceCollection;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataIssue.SourceCollection;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): DataIssue.SourceCollection;
     ...
     */
    singletonArray(): C3.Array<DataIssue.SourceCollection | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<DataIssue.SourceCollection | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<DataIssue.SourceCollection | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<DataIssue.SourceCollection | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<DataIssue.SourceCollection | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, DataIssue.SourceCollection | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataIssue.SourceCollection | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<DataIssue.SourceCollection | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<DataIssue.SourceCollection | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DataIssue.SourceCollection;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DataIssue.SourceCollection;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DataIssue.SourceCollection;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): DataIssue.SourceCollection;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DataIssue.SourceCollection;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): DataIssue.SourceCollection;
     ...
     * @see #fromString
     */
    static make(s: string | null): DataIssue.SourceCollection | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DataIssue.SourceCollection;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): DataIssue.SourceCollection;
     ...
     */
    static cachedEmptyInst(): DataIssue.SourceCollection;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DataIssue.SourceCollection>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): DataIssue.SourceCollection;
     ...
     */
    static fetch(spec?: FetchSpec | null): FetchResult<DataIssue.SourceCollection | null>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<DataIssue.SourceCollection | null>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec | null): Stream<DataIssue.SourceCollection | null>;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<DataIssue.SourceCollection | null> | null>;
     ...
     */
    get(include?: string | null): DataIssue.SourceCollection | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string | null): DataIssue.SourceCollection | null;
     ...
     */
    getMissing(spec: GetMissingSpec): DataIssue.SourceCollection;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string | null): DataIssue.SourceCollection | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): DataIssue.SourceCollection;
     ...
     * @see #toString
     */
    static fromString(s: string | null): DataIssue.SourceCollection | null;
     ...
     */
    create(spec?: UpsertSpec | null): DataIssue.SourceCollection | null;
     ...
     */
    static createBatch(objs: C3.Array<DataIssue.SourceCollection | null> | null, spec?: UpsertSpec | null): ObjList<DataIssue.SourceCollection | null> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<DataIssue.SourceCollection | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<DataIssue.SourceCollection | null> | null;
     ...
     */
    update(srcObj?: DataIssue.SourceCollection | null, spec?: UpsertSpec | null): DataIssue.SourceCollection | null;
     ...
     */
    upsert(srcObj?: DataIssue.SourceCollection | null, spec?: UpsertSpec | null): DataIssue.SourceCollection | null;
     ...
     */
    merge(spec?: MergeSpec | null): DataIssue.SourceCollection | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec | null): DataIssue.SourceCollection | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec | null): DataIssue.SourceCollection | null;
     ...
     */
    static updateBatch(objs: C3.Array<DataIssue.SourceCollection | null> | null, srcObjs?: C3.Array<DataIssue.SourceCollection | null>, spec?: UpsertSpec | null): ObjList<DataIssue.SourceCollection | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<C3.Array<DataIssue.SourceCollection | null>>, spec?: UpsertSpec | null): ObjList<DataIssue.SourceCollection | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: C3.Array<DataIssue.SourceCollection | null> | null, srcObjs?: C3.Array<DataIssue.SourceCollection | null>, spec?: UpsertSpec | null): ObjList<DataIssue.SourceCollection | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<C3.Array<DataIssue.SourceCollection | null>>, spec?: UpsertSpec | null): ObjList<DataIssue.SourceCollection | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: C3.Array<DataIssue.SourceCollection | null> | null, spec?: TouchSpec | null): ObjList<DataIssue.SourceCollection | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<DataIssue.SourceCollection | null> | null, spec?: MergeSpec | null): ObjList<DataIssue.SourceCollection | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<DataIssue.SourceCollection | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<DataIssue.SourceCollection | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<C3.Array<DataIssue.SourceCollection | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<DataIssue.SourceCollection | null> | null;
     ...
     */
    static mergeAll(mergeObj: DataIssue.SourceCollection | null, spec?: MergeAllSpec | null): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: DataIssue.SourceCollection | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: C3.Array<DataIssue.SourceCollection | null> | null, spec?: UpsertSpec | null): ObjList<DataIssue.SourceCollection | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: C3.Array<DataIssue.SourceCollection | null> | null, spec?: UpsertSpec | null): ObjList<DataIssue.SourceCollection | null> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): DataIssue.SourceCollection | null;
     ...
     */
    static beforeCreate(objs: C3.Array<DataIssue.SourceCollection | null> | null): ObjList<DataIssue.SourceCollection | null>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: C3.Array<DataIssue.SourceCollection | null> | null): ObjList<DataIssue.SourceCollection | null>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: C3.Array<DataIssue.SourceCollection | null> | null): ObjList<DataIssue.SourceCollection | null>;
     ...
     */
    static afterCreate(objs: C3.Array<DataIssue.SourceCollection | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: C3.Array<DataIssue.SourceCollection | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: C3.Array<DataIssue.SourceCollection | null> | null): C3.Array<ObjError | null>;
     ...
     */
    static startImportData(spec?: StartImportDataSpec | null): PushStream<DataIssue.SourceCollection | null>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<DataIssue.SourceCollection | null>;
     ...
     */
    static forId(id: string | null, failIfMissing?: boolean): DataIssue.SourceCollection | null;
     ...
     */
    withoutIdentity(): DataIssue.SourceCollection | null;
     ...
     */
    static typeOfBatch(objs: C3.Array<DataIssue.SourceCollection | null> | null): C3.Array<EntityType | null>;
     ...
     */
    static dbEcho(template?: DataIssue.SourceCollection | null, count?: number | null, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: C3.Array<DataIssue.SourceCollection | null> | null, callback?: λFunction<DataIssue.SourceCollection | null, DataIssue.SourceCollection | null> | null): ObjList<DataIssue.SourceCollection | null>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: C3.Array<DataIssue.SourceCollection | null> | null, callback?: λFunction<DataIssue.SourceCollection | null, DataIssue.SourceCollection | null> | null): C3.Array<ObjError | null>;
     ...
     */
    static summary(include?: string | null): C3.Array<DataIssueSummary | null>;
     ...
     */
    static validateAll(targetType?: Type | null): void;
     ...
     */
    static clearAll(targetType: Type, targetId?: string | null, targetField?: string | null): void;
     ...
     */
    static addIssue(targetType: Type, errorMsg: string, targetId?: string | null, targetField?: string | null): void;
     ...
     *           Issues to add.
     */
    static addIssues(issues: C3.Array<DataIssue | null> | null): void;
