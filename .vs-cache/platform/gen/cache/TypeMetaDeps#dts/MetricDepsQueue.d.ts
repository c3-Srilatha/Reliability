// TypeScript definitions for the C3 type MetricDepsQueue

/**
 * Invalidation queue for metric dependency processing.
 *
 * @see MetricDepsQueueEntry
 *
 * @remarks this represents a value passed to a method that expects an instance of MetricDepsQueue
 */
declare interface IMetricDepsQueue {
}
 ...
 * @see MetricDepsQueueEntry
 *
 * @remarks this represents a made instance of MetricDepsQueue
 */
declare class MetricDepsQueue {
   ...
   */
  static compute(targetType: Type, entries: C3.Array<MetricDepsQueueEntry | null> | null): void;
   ...
   */
  static find(spec?: InvalidationQueue.FindSpec | null): C3.Array<MetricDepsQueueEntry | null>;
   ...
   * @return the list of requested entries.
   */
  static findStream(spec?: InvalidationQueue.FindStreamSpec | null): Stream<MetricDepsQueueEntry | null>;
   ...
   *           Entries to remove.
   */
  static clearEntries(entries: C3.Array<MetricDepsQueueEntry | null> | null): void;
   ...
   * This function should be claimed by individual InvalidationQueue types such as CalcFieldsQueue.
   */
  static mergeContexts(targetType?: Type | null, entries?: C3.Array<MetricDepsQueueEntry | null>): C3.Array<MetricDepsQueueEntry | null>;
}
