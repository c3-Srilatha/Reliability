// TypeScript definitions for the C3 type OrganizationBaseConfigurableAclEnabled

/**
 * @remarks this represents a value passed to a method that expects an instance of OrganizationBaseConfigurableAclEnabled
 */
declare interface IOrganizationBaseConfigurableAclEnabled<C> {
...
/**
 * @remarks this represents a made instance of OrganizationBaseConfigurableAclEnabled
 */
declare class OrganizationBaseConfigurableAclEnabled<C> extends Obj {

  /**
   * List of {@link AclEntry} entries governing who can read/update/remove Objs.
   */
  readonly acl?: C3.Array<AclEntry | null>;
  withAcl(acl: C3.Array<AclEntry | null> | Array<IAclEntry | null>): OrganizationBaseConfigurableAclEnabled;
   ...
   */
  readonly id: string;
  withId(id: string): OrganizationBaseConfigurableAclEnabled;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): OrganizationBaseConfigurableAclEnabled;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): OrganizationBaseConfigurableAclEnabled;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): OrganizationBaseConfigurableAclEnabled;
  ...
  withVersion(version: number | null): OrganizationBaseConfigurableAclEnabled;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): OrganizationBaseConfigurableAclEnabled;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): OrganizationBaseConfigurableAclEnabled<C> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): OrganizationBaseConfigurableAclEnabled<C> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): OrganizationBaseConfigurableAclEnabled<C> | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): OrganizationBaseConfigurableAclEnabled<C> | null;
   ...
   */
  replaceType(old: Type, new_: Type): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<OrganizationBaseConfigurableAclEnabled<C> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<OrganizationBaseConfigurableAclEnabled<C> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): OrganizationBaseConfigurableAclEnabled<C>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): OrganizationBaseConfigurableAclEnabled<C>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   * @see #removeField
   */
  unsetField(field: string): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   * @see #unsetField
   */
  removeField(field: string): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): OrganizationBaseConfigurableAclEnabled<C>;

  mergeJson(json: any | null): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   */
  singletonArray(): C3.Array<OrganizationBaseConfigurableAclEnabled<C> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<OrganizationBaseConfigurableAclEnabled<C> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<OrganizationBaseConfigurableAclEnabled<C> | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<OrganizationBaseConfigurableAclEnabled<C> | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<OrganizationBaseConfigurableAclEnabled<C> | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, OrganizationBaseConfigurableAclEnabled<C> | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, OrganizationBaseConfigurableAclEnabled<C> | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<OrganizationBaseConfigurableAclEnabled<C> | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<OrganizationBaseConfigurableAclEnabled<C> | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): OrganizationBaseConfigurableAclEnabled<C>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   * @see #fromString
   */
  static make(s: string | null): OrganizationBaseConfigurableAclEnabled<C> | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   */
  static cachedEmptyInst(): OrganizationBaseConfigurableAclEnabled<C>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<OrganizationBaseConfigurableAclEnabled<C>>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   */
  static populateAcl(objs?: C3.Array<OrganizationBaseConfigurableAclEnabled<C> | null>): number | null;
   ...
   */
  grantMemberReadUpdateRemove(member: AccessControlEntity): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   */
  mergeAclEntry(entry: AclEntry): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   * @return the obj with the new acl after merging the indicated entry.
   */
  mergeAclEntries(entries: C3.Array<AclEntry | null> | null): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<OrganizationBaseConfigurableAclEnabled<C> | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<OrganizationBaseConfigurableAclEnabled<C> | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<OrganizationBaseConfigurableAclEnabled<C> | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<OrganizationBaseConfigurableAclEnabled<C> | null> | null>;
   ...
   */
  get(include?: string | null): OrganizationBaseConfigurableAclEnabled<C> | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): OrganizationBaseConfigurableAclEnabled<C> | null;
   ...
   */
  getMissing(spec: GetMissingSpec): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): OrganizationBaseConfigurableAclEnabled<C> | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): OrganizationBaseConfigurableAclEnabled<C>;
   ...
   * @see #toString
   */
  static fromString(s: string | null): OrganizationBaseConfigurableAclEnabled<C> | null;
   ...
   */
  create(spec?: UpsertSpec | null): OrganizationBaseConfigurableAclEnabled<C> | null;
   ...
   */
  static createBatch(objs: C3.Array<OrganizationBaseConfigurableAclEnabled<C> | null> | null, spec?: UpsertSpec | null): ObjList<OrganizationBaseConfigurableAclEnabled<C> | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<OrganizationBaseConfigurableAclEnabled<C> | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<OrganizationBaseConfigurableAclEnabled<C> | null> | null;
   ...
   */
  update(srcObj?: OrganizationBaseConfigurableAclEnabled<C> | null, spec?: UpsertSpec | null): OrganizationBaseConfigurableAclEnabled<C> | null;
   ...
   */
  upsert(srcObj?: OrganizationBaseConfigurableAclEnabled<C> | null, spec?: UpsertSpec | null): OrganizationBaseConfigurableAclEnabled<C> | null;
   ...
   */
  merge(spec?: MergeSpec | null): OrganizationBaseConfigurableAclEnabled<C> | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): OrganizationBaseConfigurableAclEnabled<C> | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): OrganizationBaseConfigurableAclEnabled<C> | null;
   ...
   */
  static updateBatch(objs: C3.Array<OrganizationBaseConfigurableAclEnabled<C> | null> | null, srcObjs?: C3.Array<OrganizationBaseConfigurableAclEnabled<C> | null>, spec?: UpsertSpec | null): ObjList<OrganizationBaseConfigurableAclEnabled<C> | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<OrganizationBaseConfigurableAclEnabled<C> | null>>, spec?: UpsertSpec | null): ObjList<OrganizationBaseConfigurableAclEnabled<C> | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<OrganizationBaseConfigurableAclEnabled<C> | null> | null, srcObjs?: C3.Array<OrganizationBaseConfigurableAclEnabled<C> | null>, spec?: UpsertSpec | null): ObjList<OrganizationBaseConfigurableAclEnabled<C> | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<OrganizationBaseConfigurableAclEnabled<C> | null>>, spec?: UpsertSpec | null): ObjList<OrganizationBaseConfigurableAclEnabled<C> | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<OrganizationBaseConfigurableAclEnabled<C> | null> | null, spec?: TouchSpec | null): ObjList<OrganizationBaseConfigurableAclEnabled<C> | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<OrganizationBaseConfigurableAclEnabled<C> | null> | null, spec?: MergeSpec | null): ObjList<OrganizationBaseConfigurableAclEnabled<C> | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<OrganizationBaseConfigurableAclEnabled<C> | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<OrganizationBaseConfigurableAclEnabled<C> | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<OrganizationBaseConfigurableAclEnabled<C> | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<OrganizationBaseConfigurableAclEnabled<C> | null> | null;
   ...
   */
  static mergeAll(mergeObj: OrganizationBaseConfigurableAclEnabled<C> | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: OrganizationBaseConfigurableAclEnabled<C> | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<OrganizationBaseConfigurableAclEnabled<C> | null> | null, spec?: UpsertSpec | null): ObjList<OrganizationBaseConfigurableAclEnabled<C> | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<OrganizationBaseConfigurableAclEnabled<C> | null> | null, spec?: UpsertSpec | null): ObjList<OrganizationBaseConfigurableAclEnabled<C> | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): OrganizationBaseConfigurableAclEnabled<C> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<OrganizationBaseConfigurableAclEnabled<C> | null> | null): ObjList<OrganizationBaseConfigurableAclEnabled<C> | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<OrganizationBaseConfigurableAclEnabled<C> | null> | null): ObjList<OrganizationBaseConfigurableAclEnabled<C> | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<OrganizationBaseConfigurableAclEnabled<C> | null> | null): ObjList<OrganizationBaseConfigurableAclEnabled<C> | null>;
   ...
   */
  static afterCreate(objs: C3.Array<OrganizationBaseConfigurableAclEnabled<C> | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<OrganizationBaseConfigurableAclEnabled<C> | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<OrganizationBaseConfigurableAclEnabled<C> | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<OrganizationBaseConfigurableAclEnabled<C> | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<OrganizationBaseConfigurableAclEnabled<C> | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): OrganizationBaseConfigurableAclEnabled<C> | null;
   ...
   */
  withoutIdentity(): OrganizationBaseConfigurableAclEnabled<C> | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<OrganizationBaseConfigurableAclEnabled<C> | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: OrganizationBaseConfigurableAclEnabled<C> | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<OrganizationBaseConfigurableAclEnabled<C> | null> | null, callback?: λFunction<OrganizationBaseConfigurableAclEnabled<C> | null, OrganizationBaseConfigurableAclEnabled<C> | null> | null): ObjList<OrganizationBaseConfigurableAclEnabled<C> | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<OrganizationBaseConfigurableAclEnabled<C> | null> | null, callback?: λFunction<OrganizationBaseConfigurableAclEnabled<C> | null, OrganizationBaseConfigurableAclEnabled<C> | null> | null): C3.Array<ObjError | null>;
