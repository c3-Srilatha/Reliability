// TypeScript definitions for the C3 type GpuDevice.Config
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of GpuDevice.Config
 */
declare namespace GpuDevice {
...
declare namespace GpuDevice {
  export class Config extends Obj {
    ...
    withName(name: string): GpuDevice.Config;

    readonly configOverride?: string | null;
    withConfigOverride(configOverride: string | null): GpuDevice.Config;

    readonly secretOverride?: string | null;
    withSecretOverride(secretOverride: string | null): GpuDevice.Config;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: C3.Array<string | null>;
    withIssues(issues: C3.Array<string | null> | Array<string | null>): GpuDevice.Config;

    /**
     * Vendor of this {@link HardwareAccelerator}.
     */
    readonly vendor: string;
    withVendor(vendor: string): GpuDevice.Config;

    /**
     * Memory available on this {@link GpuDevice}.
     */
    readonly memoryMb: number;
    withMemoryMb(memoryMb: number): GpuDevice.Config;

    /**
     * Higher rating, gives better (i.e., more powerful) {@link GpuDevice}.
     */
    readonly rating: number;
    withRating(rating: number): GpuDevice.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): GpuDevice.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): GpuDevice.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): GpuDevice.Config | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): GpuDevice.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): GpuDevice.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): GpuDevice.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): GpuDevice.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<GpuDevice.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<GpuDevice.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): GpuDevice.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GpuDevice.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GpuDevice.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): GpuDevice.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): GpuDevice.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): GpuDevice.Config;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): GpuDevice.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GpuDevice.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): GpuDevice.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): GpuDevice.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): GpuDevice.Config;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): GpuDevice.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): GpuDevice.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): GpuDevice.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): GpuDevice.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): GpuDevice.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): GpuDevice.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): GpuDevice.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): GpuDevice.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): GpuDevice.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): GpuDevice.Config;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): GpuDevice.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): GpuDevice.Config;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): GpuDevice.Config;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): GpuDevice.Config;

    mergeJson(json: any | null): GpuDevice.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): GpuDevice.Config;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): GpuDevice.Config;
     ...
     */
    singletonArray(): C3.Array<GpuDevice.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<GpuDevice.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<GpuDevice.Config | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<GpuDevice.Config | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<GpuDevice.Config | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, GpuDevice.Config | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, GpuDevice.Config | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<GpuDevice.Config | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<GpuDevice.Config | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): GpuDevice.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): GpuDevice.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): GpuDevice.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): GpuDevice.Config;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): GpuDevice.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): GpuDevice.Config;
     ...
     * @see #fromString
     */
    static make(s: string | null): GpuDevice.Config | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): GpuDevice.Config;
     ...
     */
    static cachedEmptyInst(): GpuDevice.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<GpuDevice.Config>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): GpuDevice.Config;
     ...
     * @see #toString
     */
    static fromString(s: string | null): GpuDevice.Config | null;
     ...
     */
    static forName(name: string | null, failIfMissing?: boolean): GpuDevice.Config | null;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<GpuDevice.Config | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<GpuDevice.Config | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<GpuDevice.Config | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): GpuDevice.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string | null): GpuDevice.Config | null;
     ...
     * @see findByCacheKey
     */
    getCached(): GpuDevice.Config | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): GpuDevice.Config | null;
     ...
     */
    static produce(key: string): GpuDevice.Config | null;
     ...
     */
    static produceAll(): C3.Map<string | null, GpuDevice.Config | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, GpuDevice.Config | null>;
     ...
     */
    static forConfigKey(configKey: string | null): GpuDevice.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<GpuDevice.Config | null>;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: GpuDevice.Config, override?: string | null): void;
     ...
     * @see setSecretValue
     */
    setSecretValues(from: GpuDevice.Config, override?: string | null): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): GpuDevice.Config | null;
