// TypeScript definitions for the C3 type TypeMeta.Db
 ...
 * @see TypeMeta#db
 *
 * @remarks this represents a value passed to a method that expects an instance of TypeMeta.Db
 */
...
declare namespace TypeMeta {
  export class Db extends Obj {
     ...
     * Parent entity type.
     */
    readonly parentType: TypeMeta;
    withParentType(parentType: ITypeMeta): TypeMeta.Db;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): TypeMeta.Db | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): TypeMeta.Db | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): TypeMeta.Db | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): TypeMeta.Db | null;
     ...
     */
    replaceType(old: Type, new_: Type): TypeMeta.Db;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TypeMeta.Db;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TypeMeta.Db;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TypeMeta.Db | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TypeMeta.Db | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TypeMeta.Db;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TypeMeta.Db;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TypeMeta.Db;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): TypeMeta.Db;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): TypeMeta.Db;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): TypeMeta.Db;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TypeMeta.Db;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TypeMeta.Db;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): TypeMeta.Db;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): TypeMeta.Db;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): TypeMeta.Db;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): TypeMeta.Db;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TypeMeta.Db;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): TypeMeta.Db;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TypeMeta.Db;
     ...
     * @see #unsetField
     */
    defaultField(field: string): TypeMeta.Db;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): TypeMeta.Db;
     ...
     * @see #removeField
     */
    unsetField(field: string): TypeMeta.Db;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): TypeMeta.Db;
     ...
     * @see #unsetField
     */
    removeField(field: string): TypeMeta.Db;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): TypeMeta.Db;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TypeMeta.Db;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): TypeMeta.Db;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TypeMeta.Db;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TypeMeta.Db;

    mergeJson(json: any | null): TypeMeta.Db;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TypeMeta.Db;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): TypeMeta.Db;
     ...
     */
    singletonArray(): C3.Array<TypeMeta.Db | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<TypeMeta.Db | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<TypeMeta.Db | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<TypeMeta.Db | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<TypeMeta.Db | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, TypeMeta.Db | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, TypeMeta.Db | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<TypeMeta.Db | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<TypeMeta.Db | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TypeMeta.Db;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TypeMeta.Db;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TypeMeta.Db;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): TypeMeta.Db;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TypeMeta.Db;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): TypeMeta.Db;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TypeMeta.Db;
     ...
     */
    static cachedEmptyInst(): TypeMeta.Db;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TypeMeta.Db>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): TypeMeta.Db;
