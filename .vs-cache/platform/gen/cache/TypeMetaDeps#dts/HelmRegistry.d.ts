// TypeScript definitions for the C3 type HelmRegistry

/**
 * Registry to store and retrieve helm charts (Cloud Services).
 *
 * @remarks this represents a value passed to a method that expects an instance of HelmRegistry
 */
declare interface IHelmRegistry {
 ...
 * Registry to store and retrieve helm charts (Cloud Services).
 *
 * @remarks this represents a made instance of HelmRegistry
 */
declare class HelmRegistry extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): HelmRegistry;

  static readonly configOverride?: string | null;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): HelmRegistry;
  ...
  withIssues(issues: C3.Array<string | null> | Array<string | null>): HelmRegistry;
  ...
  withUsername(username: string | null): HelmRegistry;
  ...
  withPassword(password: string | null): HelmRegistry;
  ...
  withSecretKey(secretKey: string | null): HelmRegistry;
  ...
  withProperties(properties: C3.Map<string | null, any> | {[key: string | null]: any}): HelmRegistry;
  ...
  withSecretProperties(secretProperties: C3.Map<string | null, any> | {[key: string | null]: any}): HelmRegistry;
  ...
  withUrl(url: string | null): HelmRegistry;
  ...
  withServerEndpoint(serverEndpoint: string | null): HelmRegistry;
  ...
  withPort(port: number | null): HelmRegistry;
  ...
  withDEFAULT_NAME(DEFAULT_NAME: string | null): HelmRegistry;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): HelmRegistry | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): HelmRegistry | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): HelmRegistry | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): HelmRegistry | null;
   ...
   */
  replaceType(old: Type, new_: Type): HelmRegistry;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): HelmRegistry;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HelmRegistry;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HelmRegistry;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HelmRegistry;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HelmRegistry;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HelmRegistry | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HelmRegistry | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HelmRegistry | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HelmRegistry | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): HelmRegistry;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): HelmRegistry;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HelmRegistry;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HelmRegistry;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HelmRegistry;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HelmRegistry;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): HelmRegistry;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): HelmRegistry;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): HelmRegistry;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): HelmRegistry;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): HelmRegistry;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): HelmRegistry;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): HelmRegistry;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): HelmRegistry;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): HelmRegistry;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): HelmRegistry;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): HelmRegistry;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): HelmRegistry;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): HelmRegistry;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): HelmRegistry;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): HelmRegistry;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): HelmRegistry;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): HelmRegistry;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): HelmRegistry;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): HelmRegistry;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): HelmRegistry;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): HelmRegistry;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): HelmRegistry;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): HelmRegistry;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): HelmRegistry;
   ...
   * @see #unsetField
   */
  defaultField(field: string): HelmRegistry;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): HelmRegistry;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): HelmRegistry;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): HelmRegistry;
   ...
   * @see #removeField
   */
  unsetField(field: string): HelmRegistry;
   ...
   * @see #removeField
   */
  static unsetField(field: string): HelmRegistry;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): HelmRegistry;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): HelmRegistry;
   ...
   * @see #unsetField
   */
  removeField(field: string): HelmRegistry;
   ...
   * @see #unsetField
   */
  static removeField(field: string): HelmRegistry;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): HelmRegistry;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): HelmRegistry;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): HelmRegistry;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): HelmRegistry;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): HelmRegistry;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): HelmRegistry;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): HelmRegistry;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): HelmRegistry;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): HelmRegistry;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): HelmRegistry;

  mergeJson(json: any | null): HelmRegistry;

  static mergeJson(json: any | null): HelmRegistry;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): HelmRegistry;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): HelmRegistry;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): HelmRegistry;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): HelmRegistry;
   ...
   */
  singletonArray(): C3.Array<HelmRegistry | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<HelmRegistry | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<HelmRegistry | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<HelmRegistry | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<HelmRegistry | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<HelmRegistry | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<HelmRegistry | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, HelmRegistry | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, HelmRegistry | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<HelmRegistry | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<HelmRegistry | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<HelmRegistry | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): HelmRegistry;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): HelmRegistry;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): HelmRegistry;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): HelmRegistry;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): HelmRegistry;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): HelmRegistry;
   ...
   * @see #fromString
   */
  static make(s: string | null): HelmRegistry | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): HelmRegistry;
   ...
   */
  static cachedEmptyInst(): HelmRegistry;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<HelmRegistry>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): HelmRegistry;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<HelmRegistry | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<HelmRegistry | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<HelmRegistry | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): HelmRegistry | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): HelmRegistry | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): HelmRegistry | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): HelmRegistry | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): HelmRegistry | null;
   ...
   */
  static produce(key: string): HelmRegistry | null;
   ...
   */
  static produceAll(): C3.Map<string | null, HelmRegistry | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, HelmRegistry | null>;
   ...
   */
  static forConfigKey(configKey: string | null): HelmRegistry | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<HelmRegistry | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: HelmRegistry, override?: string | null): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: HelmRegistry, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: HelmRegistry, override?: string | null): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: HelmRegistry, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): HelmRegistry | null;
   ...
   */
  removeSecrets(): HelmRegistry | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): HelmRegistry | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): HelmRegistry | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): HelmRegistry | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): HelmRegistry;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): HelmRegistry;
   ...
   * @see #toString
   */
  static fromString(s: string | null): HelmRegistry | null;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): HelmRegistry | null;
   ...
   */
  static inst(): HelmRegistry;

  /**
   * Fetches helm chart from remote repository and stores it in a specific location
   *
   * @param location
   *         Location of the helm chart in remote repository
   * @param version
   *         Version of the helm chart
   * @return Temporary file that points to helm chart.
   */
  fetchAndStoreChart(location: string, version: string): File;
   ...
   * @return Temporary file that points to helm chart.
   */
  static fetchAndStoreChart(location: string, version: string): File;
}
