// TypeScript definitions for the C3 type PeriodicCalcState

/**
 * Maintains the state of all calc fields designated as either `periodic` or `scheduled`.  Each entry will represent
 * a single periodic or scheduled calc field and its id will be a "safeId" based on the qualified field path for the
 * field.
 *
 * @remarks this represents a value passed to a method that expects an instance of PeriodicCalcState
 */
declare interface IPeriodicCalcState {
  ...
  /**
   * Field path for the calc field represented by this entry
   */
  calcFieldPath: string;

  /**
   * The calc period specified if the field is a periodic calc
   */
  calcPeriod?: string | null;

  /**
   * True if the specified calc period for the field is invalid.  Refresh will be skipped.
   */
  calcPeriodInvalid?: boolean;

  /**
   * The calc schedule specified if the field is a scheduled calc
   */
  calcSchedule?: string | null;

  /**
   * True if the specified calc schedule for the field is invalid.  Refresh will be skipped.
   */
  calcScheduleInvalid?: boolean;

  /**
   * True if the specified calc schedule doesn't indicate any further refreshes.  Refresh will be skipped.
   */
  calcScheduleComplete?: boolean;

  /**
   * History entry for the last time the field was refreshed
   */
  lastRefresh?: IPeriodicCalcStateHistory | null;

  /**
   * The next time the field will be refreshed based on when it was last refreshed and its defined period or schedule
   */
  nextRefresh?: DateTime | Date | string | null;

  /**
   * If the entry fails validation for any reason, the associated error message.  If this field is not null, processing
   * will be skipped for this entry until it is corrected.
   */
  validationError?: string | null;

  /**
   * Refresh history for the calc field
   */
  history?: C3.Array<PeriodicCalcStateHistory | null> | Array<IPeriodicCalcStateHistory | null>;
}
 ...
 * field.
 *
 * @remarks this represents a made instance of PeriodicCalcState
 */
declare class PeriodicCalcState extends Obj {
   ...
   */
  readonly id: string;
  withId(id: string): PeriodicCalcState;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): PeriodicCalcState;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): PeriodicCalcState;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): PeriodicCalcState;
  ...
  withVersion(version: number | null): PeriodicCalcState;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): PeriodicCalcState;

  /**
   * Field path for the calc field represented by this entry
   */
  readonly calcFieldPath: string;
  withCalcFieldPath(calcFieldPath: string): PeriodicCalcState;

  /**
   * The calc period specified if the field is a periodic calc
   */
  readonly calcPeriod?: string | null;
  withCalcPeriod(calcPeriod: string | null): PeriodicCalcState;

  /**
   * True if the specified calc period for the field is invalid.  Refresh will be skipped.
   */
  readonly calcPeriodInvalid?: boolean;
  withCalcPeriodInvalid(calcPeriodInvalid: boolean): PeriodicCalcState;

  /**
   * The calc schedule specified if the field is a scheduled calc
   */
  readonly calcSchedule?: string | null;
  withCalcSchedule(calcSchedule: string | null): PeriodicCalcState;

  /**
   * True if the specified calc schedule for the field is invalid.  Refresh will be skipped.
   */
  readonly calcScheduleInvalid?: boolean;
  withCalcScheduleInvalid(calcScheduleInvalid: boolean): PeriodicCalcState;

  /**
   * True if the specified calc schedule doesn't indicate any further refreshes.  Refresh will be skipped.
   */
  readonly calcScheduleComplete?: boolean;
  withCalcScheduleComplete(calcScheduleComplete: boolean): PeriodicCalcState;

  /**
   * History entry for the last time the field was refreshed
   */
  readonly lastRefresh?: PeriodicCalcStateHistory | null;
  withLastRefresh(lastRefresh: IPeriodicCalcStateHistory | null): PeriodicCalcState;

  /**
   * The next time the field will be refreshed based on when it was last refreshed and its defined period or schedule
   */
  readonly nextRefresh?: DateTime | null;
  withNextRefresh(nextRefresh: DateTime | Date | string | null): PeriodicCalcState;
  ...
  withValidationError(validationError: string | null): PeriodicCalcState;

  /**
   * Refresh history for the calc field
   */
  readonly history?: C3.Array<PeriodicCalcStateHistory | null>;
  withHistory(history: C3.Array<PeriodicCalcStateHistory | null> | Array<IPeriodicCalcStateHistory | null>): PeriodicCalcState;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): PeriodicCalcState | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): PeriodicCalcState | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): PeriodicCalcState | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): PeriodicCalcState | null;
   ...
   */
  replaceType(old: Type, new_: Type): PeriodicCalcState;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PeriodicCalcState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PeriodicCalcState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PeriodicCalcState | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PeriodicCalcState | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): PeriodicCalcState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PeriodicCalcState;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PeriodicCalcState;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PeriodicCalcState;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PeriodicCalcState;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PeriodicCalcState;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): PeriodicCalcState;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PeriodicCalcState;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PeriodicCalcState;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): PeriodicCalcState;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): PeriodicCalcState;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): PeriodicCalcState;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): PeriodicCalcState;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PeriodicCalcState;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): PeriodicCalcState;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PeriodicCalcState;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PeriodicCalcState;
   ...
   * @see #removeField
   */
  unsetField(field: string): PeriodicCalcState;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PeriodicCalcState;
   ...
   * @see #unsetField
   */
  removeField(field: string): PeriodicCalcState;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PeriodicCalcState;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): PeriodicCalcState;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): PeriodicCalcState;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): PeriodicCalcState;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): PeriodicCalcState;

  mergeJson(json: any | null): PeriodicCalcState;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): PeriodicCalcState;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): PeriodicCalcState;
   ...
   */
  singletonArray(): C3.Array<PeriodicCalcState | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<PeriodicCalcState | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PeriodicCalcState | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<PeriodicCalcState | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PeriodicCalcState | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, PeriodicCalcState | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PeriodicCalcState | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PeriodicCalcState | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PeriodicCalcState | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): PeriodicCalcState;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): PeriodicCalcState;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): PeriodicCalcState;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PeriodicCalcState;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): PeriodicCalcState;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PeriodicCalcState;
   ...
   * @see #fromString
   */
  static make(s: string | null): PeriodicCalcState | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): PeriodicCalcState;
   ...
   */
  static cachedEmptyInst(): PeriodicCalcState;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<PeriodicCalcState>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): PeriodicCalcState;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<PeriodicCalcState | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<PeriodicCalcState | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<PeriodicCalcState | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): PeriodicCalcState | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string | null): PeriodicCalcState | null;
   ...
   * @see findByCacheKey
   */
  getCached(): PeriodicCalcState | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): PeriodicCalcState | null;
   ...
   */
  static produce(key: string): PeriodicCalcState | null;
   ...
   */
  static produceAll(): C3.Map<string | null, PeriodicCalcState | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, PeriodicCalcState | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<PeriodicCalcState | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PeriodicCalcState | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<PeriodicCalcState | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<PeriodicCalcState | null> | null>;
   ...
   */
  get(include?: string | null): PeriodicCalcState | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): PeriodicCalcState | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PeriodicCalcState;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): PeriodicCalcState | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PeriodicCalcState;
   ...
   * @see #toString
   */
  static fromString(s: string | null): PeriodicCalcState | null;
   ...
   */
  create(spec?: UpsertSpec | null): PeriodicCalcState | null;
   ...
   */
  static createBatch(objs: C3.Array<PeriodicCalcState | null> | null, spec?: UpsertSpec | null): ObjList<PeriodicCalcState | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PeriodicCalcState | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<PeriodicCalcState | null> | null;
   ...
   */
  update(srcObj?: PeriodicCalcState | null, spec?: UpsertSpec | null): PeriodicCalcState | null;
   ...
   */
  upsert(srcObj?: PeriodicCalcState | null, spec?: UpsertSpec | null): PeriodicCalcState | null;
   ...
   */
  merge(spec?: MergeSpec | null): PeriodicCalcState | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): PeriodicCalcState | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): PeriodicCalcState | null;
   ...
   */
  static updateBatch(objs: C3.Array<PeriodicCalcState | null> | null, srcObjs?: C3.Array<PeriodicCalcState | null>, spec?: UpsertSpec | null): ObjList<PeriodicCalcState | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<PeriodicCalcState | null>>, spec?: UpsertSpec | null): ObjList<PeriodicCalcState | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<PeriodicCalcState | null> | null, srcObjs?: C3.Array<PeriodicCalcState | null>, spec?: UpsertSpec | null): ObjList<PeriodicCalcState | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<PeriodicCalcState | null>>, spec?: UpsertSpec | null): ObjList<PeriodicCalcState | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<PeriodicCalcState | null> | null, spec?: TouchSpec | null): ObjList<PeriodicCalcState | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PeriodicCalcState | null> | null, spec?: MergeSpec | null): ObjList<PeriodicCalcState | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PeriodicCalcState | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<PeriodicCalcState | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<PeriodicCalcState | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<PeriodicCalcState | null> | null;
   ...
   */
  static mergeAll(mergeObj: PeriodicCalcState | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PeriodicCalcState | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<PeriodicCalcState | null> | null, spec?: UpsertSpec | null): ObjList<PeriodicCalcState | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<PeriodicCalcState | null> | null, spec?: UpsertSpec | null): ObjList<PeriodicCalcState | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): PeriodicCalcState | null;
   ...
   */
  static beforeCreate(objs: C3.Array<PeriodicCalcState | null> | null): ObjList<PeriodicCalcState | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<PeriodicCalcState | null> | null): ObjList<PeriodicCalcState | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<PeriodicCalcState | null> | null): ObjList<PeriodicCalcState | null>;
   ...
   */
  static afterCreate(objs: C3.Array<PeriodicCalcState | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<PeriodicCalcState | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<PeriodicCalcState | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<PeriodicCalcState | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<PeriodicCalcState | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): PeriodicCalcState | null;
   ...
   */
  withoutIdentity(): PeriodicCalcState | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<PeriodicCalcState | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: PeriodicCalcState | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<PeriodicCalcState | null> | null, callback?: λFunction<PeriodicCalcState | null, PeriodicCalcState | null> | null): ObjList<PeriodicCalcState | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<PeriodicCalcState | null> | null, callback?: λFunction<PeriodicCalcState | null, PeriodicCalcState | null> | null): C3.Array<ObjError | null>;
  ...
  /**
   * @return all calc fields that are designated to be refreshed with a fixed period
   */
  static periodicCalcs(): C3.Set<FieldPath | null>;

  /**
   * @return all calc fields that are designated to refreshed on a fixed schedule
   */
  static scheduledCalcs(): C3.Set<FieldPath | null>;

  /**
   * Function periodically called by a cron job to perform any necessary refreshes base on the last refresh time and
   * the period of schedule for each calc field.
   */
  static refresh(): void;

  /**
   * @return true if the app currently has any periodic calcs
   */
  static hasPeriodicCalcs(): boolean;

  /**
   * @return true if the app currently has any scheduled calcs
   */
  static hasScheduledCalcs(): boolean;

  /**
   * @return true if the app currently has any periodic or scheduled calcs
   */
  static hasPeriodicOrScheduledCalcs(): boolean;

  /**
   * @return true if the system cron job for processing periodic calcs exists and is active.
   */
  static isCronJobActive(): boolean;

  /**
   * Creates the system cron job for processing periodic calcs if it doesn't already exists and makes sure it is active.
   */
  static activateCronJob(): void;
}
