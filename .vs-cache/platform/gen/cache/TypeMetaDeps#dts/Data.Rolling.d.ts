// TypeScript definitions for the C3 type Data.Rolling

/**
 * @remarks this represents a value passed to a method that expects an instance of Data.Rolling
 */
...
declare namespace Data {
  export class Rolling extends Obj {
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.Rolling | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.Rolling | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.Rolling | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.Rolling | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.Rolling;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Rolling;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Rolling;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Rolling | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Rolling | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.Rolling;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Rolling;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Rolling;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.Rolling;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.Rolling;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.Rolling;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.Rolling;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.Rolling;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.Rolling;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.Rolling;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.Rolling;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.Rolling;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.Rolling;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.Rolling;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.Rolling;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.Rolling;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.Rolling;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.Rolling;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.Rolling;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.Rolling;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.Rolling;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.Rolling;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.Rolling;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.Rolling;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.Rolling;

    mergeJson(json: any | null): Data.Rolling;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.Rolling;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.Rolling;
     ...
     */
    singletonArray(): C3.Array<Data.Rolling | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.Rolling | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.Rolling | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.Rolling | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.Rolling | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.Rolling | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.Rolling | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.Rolling | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.Rolling | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.Rolling;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.Rolling;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.Rolling;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.Rolling;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.Rolling;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.Rolling;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.Rolling;
     ...
     */
    static cachedEmptyInst(): Data.Rolling;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.Rolling>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.Rolling;
     ...
     */
    static fromPySrc(pySrc: string, dfs?: C3.Set<DataImpl | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): Data.Rolling | null;
     ...
     */
    static _jsDataProxy(inst: any): Data.Rolling;
