// TypeScript definitions for the C3 type Locale

/**
 * Locale is defined by language and region.
 *
 * @remarks this represents a value passed to a method that expects an instance of Locale
 */
 ...
 * Locale is defined by language and region.
 *
 * @remarks this represents a made instance of Locale
 */
declare class Locale extends Obj {
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Locale;

  /**
   * e.g. en_US, zh_CN, fr, ja
   */
  readonly name: string;
  withName(name: string): Locale;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): Locale;
  ...
  withVersion(version: number | null): Locale;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): Locale;
  ...
  withUserUpdatedFields(userUpdatedFields: C3.Array<string | null> | Array<string | null>): Locale;
  ...
  withHidden(hidden: boolean): Locale;
  ...
  withUserOwned(userOwned: boolean): Locale;

  /**
   * e.g. en, zh, fr, ja
   */
  readonly language: string;
  withLanguage(language: string): Locale;

  /**
   * e.g. US, CN or leave it empty
   */
  readonly region?: string | null;
  withRegion(region: string | null): Locale;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Locale | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Locale | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Locale | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Locale | null;
   ...
   */
  replaceType(old: Type, new_: Type): Locale;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Locale;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Locale;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Locale | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Locale | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Locale;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Locale;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Locale;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Locale;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Locale;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Locale;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Locale;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Locale;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Locale;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Locale;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Locale;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Locale;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Locale;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Locale;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Locale;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Locale;
   ...
   * @see #removeField
   */
  unsetField(field: string): Locale;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Locale;
   ...
   * @see #unsetField
   */
  removeField(field: string): Locale;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Locale;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Locale;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Locale;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Locale;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Locale;

  mergeJson(json: any | null): Locale;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Locale;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Locale;
   ...
   */
  singletonArray(): C3.Array<Locale | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Locale | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Locale | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Locale | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Locale | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Locale | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Locale | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Locale | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Locale | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Locale;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Locale;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Locale;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Locale;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Locale;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Locale;
   ...
   * @see #fromString
   */
  static make(s: string | null): Locale | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Locale;
   ...
   */
  static cachedEmptyInst(): Locale;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Locale>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Locale;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<Locale | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<Locale | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<Locale | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): Locale | null;
   ...
   * @see findByCacheKey
   */
  static forCacheKey(key: string | null): Locale | null;
   ...
   */
  static produce(key: string): Locale | null;
   ...
   */
  static produceAll(): C3.Map<string | null, Locale | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, Locale | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<Locale | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<Locale | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Locale | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Locale | null> | null>;
   ...
   */
  get(include?: string | null): Locale | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): Locale | null;
   ...
   */
  getMissing(spec: GetMissingSpec): Locale;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): Locale | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): Locale;
   ...
   * @see #toString
   */
  static fromString(s: string | null): Locale | null;
   ...
   */
  create(spec?: UpsertSpec | null): Locale | null;
   ...
   */
  static createBatch(objs: C3.Array<Locale | null> | null, spec?: UpsertSpec | null): ObjList<Locale | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<Locale | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Locale | null> | null;
   ...
   */
  update(srcObj?: Locale | null, spec?: UpsertSpec | null): Locale | null;
   ...
   */
  upsert(srcObj?: Locale | null, spec?: UpsertSpec | null): Locale | null;
   ...
   */
  merge(spec?: MergeSpec | null): Locale | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): Locale | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): Locale | null;
   ...
   */
  static updateBatch(objs: C3.Array<Locale | null> | null, srcObjs?: C3.Array<Locale | null>, spec?: UpsertSpec | null): ObjList<Locale | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<Locale | null>>, spec?: UpsertSpec | null): ObjList<Locale | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<Locale | null> | null, srcObjs?: C3.Array<Locale | null>, spec?: UpsertSpec | null): ObjList<Locale | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<Locale | null>>, spec?: UpsertSpec | null): ObjList<Locale | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<Locale | null> | null, spec?: TouchSpec | null): ObjList<Locale | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Locale | null> | null, spec?: MergeSpec | null): ObjList<Locale | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Locale | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Locale | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<Locale | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Locale | null> | null;
   ...
   */
  static mergeAll(mergeObj: Locale | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: Locale | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<Locale | null> | null, spec?: UpsertSpec | null): ObjList<Locale | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<Locale | null> | null, spec?: UpsertSpec | null): ObjList<Locale | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<Locale | null> | null): ObjList<Locale | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<Locale | null> | null): ObjList<Locale | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<Locale | null> | null): ObjList<Locale | null>;
   ...
   */
  static afterCreate(objs: C3.Array<Locale | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<Locale | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<Locale | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<Locale | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Locale | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): Locale | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<Locale | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: Locale | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<Locale | null> | null, callback?: λFunction<Locale | null, Locale | null> | null): ObjList<Locale | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<Locale | null> | null, callback?: λFunction<Locale | null, Locale | null> | null): C3.Array<ObjError | null>;
   ...
   */
  publish(subPath?: string | null, contentType?: string | null): Locale;
   ...
   */
  static removeSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<Locale | null> | null;
   ...
   */
  createSeedData(spec?: UpsertSpec | null): Locale | null;
   ...
   */
  static createSeedDataBatch(objs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<Locale | null> | null;
   ...
   */
  updateSeedData(srcObj?: SeedData | null, spec?: UpsertSpec | null): Locale | null;
   ...
   */
  static updateSeedDataBatch(objs?: C3.Array<SeedData | null>, srcObjs?: C3.Array<SeedData | null>, spec?: UpsertSpec | null): ObjList<Locale | null> | null;
   ...
   * @return updated obj instance, same as {@link Persistable#update} return value.
   */
  clearUserUpdates(spec?: MergeSpec | null): Locale | null;
   ...
   *         {@link Persistable#updateBatch}.
   */
  static clearUserUpdatesBatch(objs?: C3.Array<SeedData | null>, spec?: MergeSpec | null): ObjList<Locale | null> | null;
  ...
  dependencies(): SeedDataDeps<Locale | null> | null;
  ...
  /**
   * Returns the user's locale as set in http request header.
   * If not available, the default locale string, 'en_US' is returned.
   */
  static getUserLocaleString(): string | null;

  /**
   * Generate translations for a module within the passed in locale.
   * If moduleName is omitted, then translations for all modules will be generated
   * Returns number of translations created/updated
   * Note: This is a proxy for L10Utility.generateTranslations() -- see below.
   *
   * @param locale - the locale for which to generate translations
   * @param tenantName - the tenant
   * @param tagName - the tag
   * @param moduleName - the module name (optional)
   *
   * @return count of translations created or updated.
   */
  static generateTranslationsForLocale(locale?: Locale | null, tenantName?: string | null, tagName?: string | null, moduleName?: string | null): number | null;

  /**
   * Generate translations for a module. Values will be automatically translated by making a call to Google Translate.
   * If moduleName is omitted, then translations for all modules will be generated.
   * Returns number of translations created/updated
   * Note: This is a proxy for L10Utility.generateTranslationsWithAutoTranslate() -- see below.
   *
   * @param locale - the locale for which to generate translations
   * @param tenantName - the tenant
   * @param tagName - the tag
   ...
   * @return count of translations created or updated.
   */
  static generateTranslationsForLocaleWithAutoTranslate(locale?: Locale | null, tenantName?: string | null, tagName?: string | null, moduleName?: string | null): number | null;

  /**
   * Returns an id for a give Locale which would match its language and region
   */
  static idFromLocale(locale: Locale): string;
}
