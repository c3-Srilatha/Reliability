// TypeScript definitions for the C3 type ConfigNamed

/**
 * @remarks this represents a value passed to a method that expects an instance of ConfigNamed
 */
declare interface IConfigNamed {
...
/**
 * @remarks this represents a made instance of ConfigNamed
 */
declare class ConfigNamed extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): ConfigNamed;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): ConfigNamed;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): ConfigNamed;

  /**
   * The unique and required name of this instance.
   */
  readonly name: string;
  withName(name: string): ConfigNamed;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ConfigNamed | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ConfigNamed | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ConfigNamed | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ConfigNamed | null;
   ...
   */
  replaceType(old: Type, new_: Type): ConfigNamed;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ConfigNamed;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ConfigNamed;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ConfigNamed | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ConfigNamed | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ConfigNamed;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ConfigNamed;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ConfigNamed;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ConfigNamed;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ConfigNamed;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ConfigNamed;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ConfigNamed;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ConfigNamed;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ConfigNamed;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ConfigNamed;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ConfigNamed;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ConfigNamed;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ConfigNamed;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ConfigNamed;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ConfigNamed;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ConfigNamed;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ConfigNamed;
   ...
   * @see #removeField
   */
  unsetField(field: string): ConfigNamed;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ConfigNamed;
   ...
   * @see #unsetField
   */
  removeField(field: string): ConfigNamed;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ConfigNamed;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ConfigNamed;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ConfigNamed;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ConfigNamed;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ConfigNamed;

  mergeJson(json: any | null): ConfigNamed;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ConfigNamed;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ConfigNamed;
   ...
   */
  singletonArray(): C3.Array<ConfigNamed | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ConfigNamed | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ConfigNamed | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ConfigNamed | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ConfigNamed | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ConfigNamed | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ConfigNamed | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ConfigNamed | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ConfigNamed | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ConfigNamed;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ConfigNamed;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ConfigNamed;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ConfigNamed;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ConfigNamed;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ConfigNamed;
   ...
   * @see #fromString
   */
  static make(s: string | null): ConfigNamed | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ConfigNamed;
   ...
   */
  static cachedEmptyInst(): ConfigNamed;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ConfigNamed>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ConfigNamed;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<ConfigNamed | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<ConfigNamed | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<ConfigNamed | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): ConfigNamed | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): ConfigNamed | null;
   ...
   * @see findByCacheKey
   */
  getCached(): ConfigNamed | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): ConfigNamed | null;
   ...
   */
  static produce(key: string): ConfigNamed | null;
   ...
   */
  static produceAll(): C3.Map<string | null, ConfigNamed | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, ConfigNamed | null>;
   ...
   */
  static forConfigKey(configKey: string | null): ConfigNamed | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<ConfigNamed | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: ConfigNamed, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: ConfigNamed, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): ConfigNamed | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): ConfigNamed | null;
   ...
   */
  static forName(name: string | null, failIfMissing?: boolean): ConfigNamed | null;
}
