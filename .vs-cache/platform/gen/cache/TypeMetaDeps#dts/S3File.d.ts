// TypeScript definitions for the C3 type S3File

/**
 * Represents the S3FileSystem file.
 *
 * @remarks this represents a value passed to a method that expects an instance of S3File
 */
declare interface IS3File {
  ...
  /**
   * Physical physical length of the entire content.
   */
  instanceLength?: number | null;

  /**
   * Server-side encryption algorithm when encrypting the object using AWS-managed keys.
   */
  ...
  /**
   * Server-side encryption algorithm if the object is encrypted using customer-provided keys.
   */
  sseCustomerAlgorithm?: string | null;

  /**
   * Base64-encoded MD5 digest of the encryption key for server-side encryption,
   * if the object is encrypted using customer-provided keys.
   */
 ...
 * Represents the S3FileSystem file.
 *
 * @remarks this represents a made instance of S3File
 */
declare class S3File extends Obj {
  ...
  withContentEncoding(contentEncoding: string | null): S3File;
  ...
  withContentLanguage(contentLanguage: string | null): S3File;
  ...
  withContentLength(contentLength: number | null): S3File;
  ...
  withContentLocation(contentLocation: string | null): S3File;
  ...
  withContentType(contentType: string | null): S3File;
  ...
  withContentDisposition(contentDisposition: string | null): S3File;
  ...
  withETag(eTag: string | null): S3File;
  ...
  withLastModified(lastModified: DateTime | Date | string | null): S3File;

  /**
   * Id of user / identity who last last modified this content.
   */
  readonly lastModifiedBy?: string | null;
  withLastModifiedBy(lastModifiedBy: string | null): S3File;
  ...
  withContentMD5(contentMD5: string | null): S3File;
  ...
  withContentSHA1(contentSHA1: string | null): S3File;

  /**
   * Field to maintain state whether content metadata was read or not.
   */
  readonly hasMetadata?: boolean;
  withHasMetadata(hasMetadata: boolean): S3File;

  /**
   * URL for this file that contains scheme (i.e. file-system) and fully qualified encoded path.
   */
  readonly url?: string | null;
  withUrl(url: string | null): S3File;

  /**
   * Custom user-metadata.
   */
  readonly userMetadata?: C3.Map<string | null, string | null>;
  withUserMetadata(userMetadata: C3.Map<string | null, string | null> | {[key: string | null]: string | null}): S3File;

  /**
   * Physical physical length of the entire content.
   */
  readonly instanceLength?: number | null;
  withInstanceLength(instanceLength: number | null): S3File;

  /**
   * Server-side encryption algorithm when encrypting the object using AWS-managed keys.
   */
  readonly sseAlgorithm?: string | null;
  withSseAlgorithm(sseAlgorithm: string | null): S3File;

  /**
   * AWS Key Management System key id used for Server Side Encryption of the Amazon S3 object.
   */
  readonly sseAwsKmsKeyId?: string | null;
  withSseAwsKmsKeyId(sseAwsKmsKeyId: string | null): S3File;

  /**
   * Server-side encryption algorithm if the object is encrypted using customer-provided keys.
   */
  readonly sseCustomerAlgorithm?: string | null;
  withSseCustomerAlgorithm(sseCustomerAlgorithm: string | null): S3File;

  /**
   * Base64-encoded MD5 digest of the encryption key for server-side encryption,
   * if the object is encrypted using customer-provided keys.
   */
  readonly sseCustomerKeyMd5?: string | null;
  withSseCustomerKeyMd5(sseCustomerKeyMd5: string | null): S3File;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): S3File | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): S3File | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): S3File | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): S3File | null;
   ...
   */
  replaceType(old: Type, new_: Type): S3File;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): S3File;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): S3File;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<S3File | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<S3File | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): S3File;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): S3File;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): S3File;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): S3File;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): S3File;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): S3File;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): S3File;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): S3File;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): S3File;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): S3File;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): S3File;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): S3File;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): S3File;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): S3File;
   ...
   * @see #unsetField
   */
  defaultField(field: string): S3File;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): S3File;
   ...
   * @see #removeField
   */
  unsetField(field: string): S3File;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): S3File;
   ...
   * @see #unsetField
   */
  removeField(field: string): S3File;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): S3File;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): S3File;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): S3File;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): S3File;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): S3File;

  mergeJson(json: any | null): S3File;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): S3File;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): S3File;
   ...
   */
  singletonArray(): C3.Array<S3File | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<S3File | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<S3File | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<S3File | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<S3File | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, S3File | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, S3File | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<S3File | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<S3File | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): S3File;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): S3File;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): S3File;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): S3File;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): S3File;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): S3File;
   ...
   * @see #fromString
   */
  static make(s: string | null): S3File | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): S3File;
   ...
   */
  static cachedEmptyInst(): S3File;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<S3File>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): S3File;
   ...
   */
  withFileName(fileName: string | null): S3File;

  /**
   * Changes file extension in this instance.
   */
  withFileExt(fileExt: string | null): S3File;
   ...
   */
  identify(suffix?: string | null): S3File;
   ...
   */
  readMetadata(spec?: FileOperationSpec | null): S3File;
   ...
   */
  refreshMetadata(spec?: FileOperationSpec | null): S3File;
   ...
   */
  encodedPushStream(spec?: FileOperationSpec | null): Pair<S3File | null, BytePushStream | null>;

  /**
   * @return byte push stream to be used for writing un-encoded data into this content object.
   */
  pushStream(spec?: FileOperationSpec | null): Pair<S3File | null, BytePushStream | null>;

  /**
   * @return character push stream to be used for writing un-encoded data into this content object.
   */
  charPushStream(spec?: FileOperationSpec | null): Pair<S3File | null, CharPushStream | null>;
   ...
   */
  encodedStream(spec?: FileOperationSpec | null): Pair<S3File | null, ByteStream | null> | null;
   ...
   */
  writeStream(content: ByteStream | null, spec?: FileOperationSpec | null): S3File;

  /**
   * Truncates file and replaces it's content with provided binary content.
   */
  writeInputStream(inputStream: any, spec?: FileOperationSpec | null): S3File;

  /**
   * Truncates file and replaces its content with provided binary content from zipInputStream
   */
  writeZipInputStream(zipInputStream: any, spec?: FileOperationSpec | null): S3File;
   ...
   */
  writeEncodedStream(encodedContent: ByteStream | null, spec?: FileOperationSpec | null): S3File;

  /**
   * Truncates file and replaces it's encoded content with provided binary content.
   */
  writeEncodedInputStream(inputStream: any, spec?: FileOperationSpec | null): S3File;
   ...
   *           content that needs to be written
   */
  write(content: any | null, spec?: FileOperationSpec | null): S3File;
   ...
   *           encoded content that needs to be written
   */
  writeEncoded(encodedContent: any | null, spec?: FileOperationSpec | null): S3File;
   ...
   *           content that needs to be written
   */
  writeString(content: string | null, spec?: FileOperationSpec | null): S3File;
   ...
   */
  writeObj(obj: Obj | null, spec?: FileObjsOperSpec | null): S3File;
   ...
   * @return pair of update instance of this content and number of objs written
   */
  startWriteObjs(spec?: FileObjsOperSpec | null): Pair<S3File | null, PushStream<Obj | null> | null>;
   ...
   */
  compress(contentEncoding?: string | null, spec?: FileCompressSpec | null): S3File;

  /**
   * Uncompresses file. Removes compression specific extension.
   */
  uncompress(spec?: FileCompressSpec | null): S3File;
   ...
   */
  transcode(contentType: string, contentEncoding: string, spec?: FileCompressSpec | null): S3File;

  /**
   * Copies content to a given target.
   */
  copyContentTo(target: S3File, spec?: FileOperationSpec | null): void;
   ...
   */
  static fromString(s: string | null): S3File | null;

  /**
   * @return grants of the s3 file.
   */
  fs(): S3FileSystem | null;
  ...
  /**
   * @return the container / bucket name of the file
   */
  containerName(): string | null;

  /**
   * @return blob key of the file.
   */
  blobKey(): string | null;

  static fsForThisType(): S3FileSystem | null;

  /**
   * Return the public url for this file.
   * @param failIfNotPublic
   *            A flag indicates whether an exception will be thrown if the file is not publicly accessible.
   */
  publicEndpoint(failIfNotPublic?: boolean): string | null;
}
