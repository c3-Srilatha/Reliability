// TypeScript definitions for the C3 type S3FsConfig

/**
 * S3 based C3 file system configuration.
 *
 * @remarks this represents a value passed to a method that expects an instance of S3FsConfig
 */
declare interface IS3FsConfig {
   ...
   */
  connectionMaxIdleMillis?: number | null;
   ...
   */
  responseMetadataCacheSize?: number | null;
 ...
 */
declare class S3FsConfig extends Obj {

  /**
   * Config type instance that contains this config child.
   */
  readonly parent?: FileSystemConfig | null;
  withParent(parent: IFileSystemConfig | null): S3FsConfig;

  /**
   * Number of retries due to rate limiting
   */
  readonly maxRetries: number;
  withMaxRetries(maxRetries: number): S3FsConfig;

  /**
   * Initial Sleep time for first retry
   */
  readonly initialSleepMillis: number;
  withInitialSleepMillis(initialSleepMillis: number): S3FsConfig;

  /**
   * The exponent to multiply the prior wait time in generating the next
   */
  readonly exponent: number;
  withExponent(exponent: number): S3FsConfig;

  /**
   * Maximum wait time allowed for each retry. If <= 0 the default will be used.
   */
  readonly maxSleepMillis?: number | null;
  withMaxSleepMillis(maxSleepMillis: number | null): S3FsConfig;

  /**
   * Maximum wait time allowed for all retry waits
   */
  readonly maxTotalMillis?: number | null;
  withMaxTotalMillis(maxTotalMillis: number | null): S3FsConfig;

  /**
   * The minimum sleep time guaranteed each iteration.
   */
  readonly minSleepMillis?: number | null;
  withMinSleepMillis(minSleepMillis: number | null): S3FsConfig;

  /**
   * If set to true, it will retry when result is empty.
   */
  readonly retryOnEmptyResult?: boolean;
  withRetryOnEmptyResult(retryOnEmptyResult: boolean): S3FsConfig;

  /**
   * Determines the algorithm used to calculate jitter. See {@link ExponentialBackoff.Jitter}.
   */
  readonly jitter?: string | null;
  withJitter(jitter: string | null): S3FsConfig;
  ...
  withRetryAllErrors(retryAllErrors: boolean): S3FsConfig;
  ...
  withTrace(trace: boolean): S3FsConfig;

  /**
   * DO NOT USE - IGNORED!
   */
  readonly forUpsert?: boolean;
  withForUpsert(forUpsert: boolean): S3FsConfig;

  /**
   * @return `true` if this file system is enabled.
   */
  readonly enabled?: boolean;
  withEnabled(enabled: boolean): S3FsConfig;
  ...
  withMounts(mounts: C3.Map<string | null, string | null> | {[key: string | null]: string | null}): S3FsConfig;

  /**
   * List of mounts that are read only.
   */
  readonly readOnlyMounts?: C3.Set<string | null>;
  withReadOnlyMounts(readOnlyMounts: C3.Set<string | null> | Array<string | null>): S3FsConfig;
  ...
  withAclEnabledMounts(aclEnabledMounts: C3.Set<string | null> | Array<string | null>): S3FsConfig;

  /**
   * The maximum number of allowed open HTTP connections.
   */
  readonly maxConnections?: number | null;
  withMaxConnections(maxConnections: number | null): S3FsConfig;

  /**
   * The amount of time to wait (in milliseconds) when initially establishing a connection before giving up and timing out.
   */
  readonly connectionTimeout?: number | null;
  withConnectionTimeout(connectionTimeout: number | null): S3FsConfig;

  /**
   * Returns the amount of time to wait (in milliseconds) for data to be transferred over an established, open connection before the connection times out and is closed. A value of 0 means infinity, and isn't recommended.
   */
  readonly socketTimeout?: number | null;
  withSocketTimeout(socketTimeout: number | null): S3FsConfig;

  /**
   * The expiration time (in milliseconds) for a connection in the connection pool. When retrieving a connection from the pool to make a request, the total time that the connection has been open is compared against this value. Connections which have been open for longer are discarded, and if needed a new connection is created.
   * Tuning this setting down (together with an appropriately-low setting for Java's DNS cache TTL) ensures that your application will quickly rotate over to new IP addresses when the service begins announcing them through DNS, at the cost of having to re-establish new connections more frequently.
   */
  readonly connectionTTL?: number | null;
  withConnectionTTL(connectionTTL: number | null): S3FsConfig;

  /**
   * The maximum amount of time that an idle connection may sit in the connection pool and still be eligible for reuse. When retrieving a connection from the pool to make a request, the amount of time the connection has been idle is compared against this value. Connections which have been idle for longer are discarded, and if needed a new connection is created.
   * Tuning this setting down reduces the likelihood of a race condition (wherein you begin sending a request down a connection which appears to be healthy, but before it arrives the service decides the connection has been idle for too long and closes it) at the cost of having to re-establish new connections more frequently.
   */
  readonly connectionMaxIdleMillis?: number | null;
  withConnectionMaxIdleMillis(connectionMaxIdleMillis: number | null): S3FsConfig;
   ...
   * This class closes idle connections before they can move into the CLOSE_WAIT state.
   */
  readonly connectionReaper?: boolean;
  withConnectionReaper(connectionReaper: boolean): S3FsConfig;

  /**
   * Enables TCP KeepAlive support at the socket level.
   */
  readonly tcpKeepAlive?: boolean;
  withTcpKeepAlive(tcpKeepAlive: boolean): S3FsConfig;

  /**
   * Sets the response metadata cache size. By default, it is set to 50.
   */
  readonly responseMetadataCacheSize?: number | null;
  withResponseMetadataCacheSize(responseMetadataCacheSize: number | null): S3FsConfig;
   ...
   * This is only a hint, and the operating system may choose not to honor it. When using this option, users should always check the operating system's configured limits and defaults. Most OS's have a maximum TCP buffer size limit configured, and won't let you go beyond that limit unless you explicitly raise the max TCP buffer size limit.
   */
  readonly socketBufferSize?: number | null;
  withSocketBufferSize(socketBufferSize: number | null): S3FsConfig;

  readonly fsDefaultName?: string | null;
  withFsDefaultName(fsDefaultName: string | null): S3FsConfig;

  readonly pathPrefix?: string | null;
  withPathPrefix(pathPrefix: string | null): S3FsConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): S3FsConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): S3FsConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): S3FsConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): S3FsConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): S3FsConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): S3FsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): S3FsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<S3FsConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<S3FsConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): S3FsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): S3FsConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): S3FsConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): S3FsConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): S3FsConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): S3FsConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): S3FsConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): S3FsConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): S3FsConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): S3FsConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): S3FsConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): S3FsConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): S3FsConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): S3FsConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): S3FsConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): S3FsConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): S3FsConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): S3FsConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): S3FsConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): S3FsConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): S3FsConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): S3FsConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): S3FsConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): S3FsConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): S3FsConfig;

  mergeJson(json: any | null): S3FsConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): S3FsConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): S3FsConfig;
   ...
   */
  singletonArray(): C3.Array<S3FsConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<S3FsConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<S3FsConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<S3FsConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<S3FsConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, S3FsConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, S3FsConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<S3FsConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<S3FsConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): S3FsConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): S3FsConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): S3FsConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): S3FsConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): S3FsConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): S3FsConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): S3FsConfig;
   ...
   */
  static cachedEmptyInst(): S3FsConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<S3FsConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): S3FsConfig;

  /**
   * @return this child config without any secret values.
   */
  removeSecrets(): S3FsConfig | null;

  /**
   * @return this child config with only secret values.
   */
  removeNonSecrets(): S3FsConfig | null;
