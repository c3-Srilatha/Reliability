// TypeScript definitions for the C3 type HzConfig

/**
 * @remarks this represents a value passed to a method that expects an instance of HzConfig
 */
declare interface IHzConfig {
 ...
 */
declare class HzConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): HzConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): HzConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): HzConfig;

  readonly replication?: number | null;
  withReplication(replication: number | null): HzConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): HzConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): HzConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): HzConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): HzConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): HzConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HzConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HzConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HzConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HzConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): HzConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HzConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HzConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): HzConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): HzConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): HzConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): HzConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): HzConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): HzConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): HzConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): HzConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): HzConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): HzConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): HzConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): HzConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): HzConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): HzConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): HzConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): HzConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): HzConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): HzConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): HzConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): HzConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): HzConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): HzConfig;

  mergeJson(json: any | null): HzConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): HzConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): HzConfig;
   ...
   */
  singletonArray(): C3.Array<HzConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<HzConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<HzConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<HzConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<HzConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, HzConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, HzConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<HzConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<HzConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): HzConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): HzConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): HzConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): HzConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): HzConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): HzConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): HzConfig;
   ...
   */
  static cachedEmptyInst(): HzConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<HzConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): HzConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<HzConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<HzConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<HzConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): HzConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): HzConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): HzConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): HzConfig | null;
   ...
   */
  static produce(key: string): HzConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, HzConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, HzConfig | null>;
   ...
   */
  static forConfigKey(configKey: string | null): HzConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<HzConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: HzConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: HzConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): HzConfig | null;
   ...
   */
  removeSecrets(): HzConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): HzConfig | null;
