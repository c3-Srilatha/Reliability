// TypeScript definitions for the C3 type Set
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Set
 */
...
declare namespace C3 {
  export class Set<E> {
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Set<E> | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Set<E> | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Set<E> | null;
     ...
     * type and will return an instance of the correct type.
     */
    static deserialize(contentStr: string | null, contentType: string): Set<E> | null;
    ...
    normalize(): Set<E> | null;

    at(index: number): E | null;

    pluck(fieldPath: string | null, vtOverride?: ValueType | null): Set<T> | null;
    ...
    round(decimals?: number | null): Set<E> | null;
     ...
     */
    mapToSame(mapper: λFunction<E | null, E | null>): Set<E> | null;

    /**
     * @return new collection for all elements of this collection transformed by applying provided lambda function.
     */
    mapToSame(mapper: λBiFunction<E | null, number | null, E | null>): Set<E> | null;

    /**
     * @return new collection of any with all elements of this collection transformed by applying provided lambda function.
     */
    map(mapper: λFunction<E | null, T | null>): Set<T> | null;

    /**
     * @return new collection based on all elements of this collection by applying provided mapping specification.
     */
    map(spec: FetchStreamSpec): Set<E> | null;

    /**
     * @return new set by evaluating provided expression over each element.
     */
    map(expr: string): C3.Set<T | null>;

    /**
     * @return new collection of any with all elements of this collection transformed by applying provided lambda function.
     */
    map(mapper: λBiFunction<E | null, number, T | null>): Set<T> | null;

    /**
     * @return new collection of string with all elements of this collection transformed by applying provided lambda function.
     */
    mapToStr(mapper: λFunction<E | null, string | null>): C3.Set<string | null> | null;

    /**
     * @return new collection of string with all elements of this collection transformed by applying provided lambda function.
     */
    mapToStr(mapper: λBiFunction<E | null, number, string | null>): C3.Set<string | null> | null;
     ...
     */
    mapTo(elementType: ValueType, mapper: λFunction<E | null, T | null>): Set<T> | null;
     ...
     * such conversion.
     */
    mapTo(elementType: ValueType, mapper: λBiFunction<E | null, number, T | null>): Set<T> | null;
     ...
     */
    flatMapToSame(mapper: λFunction<E | null, CollectionStdLib<E> | null>): Set<E> | null;
     ...
     */
    flatMapToSame(mapper: λBiFunction<E | null, number | null, Set<E> | null>): Set<E> | null;
     ...
     */
    flatMap(mapper: λFunction<E | null, CollectionStdLib<T> | null>): Set<T> | null;

    /**
     * @return returns a collection of any consisting of the results of replacing each element of this collection with mapped array elements.
     */
    flatMap(mapper: λBiFunction<E | null, number, Set<T> | null>): Set<T> | null;
     ...
     */
    flatMapTo(elementType: ValueType, mapper: λFunction<E | null, CollectionStdLib<T> | null>): Set<T> | null;

    /**
     * @return returns a collection of provided element type consisting of the results of replacing each element of this collection with mapped array elements.
     */
    flatMapTo(elementType: ValueType, mapper: λBiFunction<E | null, number, Set<T> | null>): Set<T> | null;
     ...
     */
    flatMapRecursive(toInters: λFunction<E | null, CollectionStdLib<I> | null>, fromInter: λFunction<I | null, E | null>): Set<E> | null;
     ...
     */
    uniqueBy(key?: λFunction<E | null, any> | null): Set<E> | null;

    /**
     * @return new collection with duplicate elements removed based on provided key supplier.
     */
    uniqueBy(key: λBiFunction<E | null, number | null, any>): Set<E> | null;

    /**
     * Filters elements from this collection based on evaluation result of the provided filter predicate.
     */
    filter(predicate: λPredicate<E | null>): Set<E> | null;

    /**
     * Filters elements from this collection based on evaluation result of the provided filter predicate.
     */
    filter(filter: string | null): Set<E> | null;

    /**
     * Filters elements from this collection based on evaluation result of the provided filter predicate.
     */
    filter(fields: C3.Map<string | null, any> | null): Set<E> | null;

    /**
     * Filters elements from this collection based on evaluation result of the provided filter predicate.
     */
    filter(predicate: λBiPredicate<E | null, number | null>): Set<E> | null;

    fillMissingBy(method?: string | null, spec?: FillMissingSpec | null): Set<E> | null;

    fillMissing(value: any, spec?: FillMissingSpec | null): Set<E> | null;
     ...
     */
    reject(predicate: λPredicate<E | null>): Set<E> | null;

    /**
     * Rejects elements from this collection based on evaluation result of the provided filter expression.
     */
    reject(predicate: λBiPredicate<E | null, number | null>): Set<E> | null;
     ...
     */
    include(include: string | null): Set<E> | null;

    /**
     * Maps this collection to another by removing fields from every element that are not part of the provided include
     * spec. If include spec is not provided then does nothing.
     */
    include(positions: Collection<number | null>): Set<E> | null;
     ...
     */
    exclude(exclude: string | null): Set<E> | null;

    replaceByPredicate(e: E | null, predicate: λPredicate<E | null>): Set<E> | null;
     ...
     */
    sorted(descending?: boolean): Set<E> | null;
     ...
     * stream, while in descending order, null elements were at the beginning of the returned stream.
     */
    sorted(comparator: λBiFunction<E | null, E | null, number | null>): Set<E> | null;
     ...
     * stream, while in descending order, null elements were at the beginning of the returned stream.
     */
    sorted(descending: boolean, comparator: λBiFunction<E | null, E | null, number | null>): Set<E> | null;
     ...
     * stream, while in descending order, null elements were at the beginning of the returned stream.
     */
    sorted(order: string | null): Set<E> | null;

    /**
     * Maps this collection to another by re-ordering elements based on natural sorting order of a key computed using
     * provided lambda.
     */
    sortedBy(key: λFunction<E | null, any>): Set<E> | null;

    /**
     * Maps this collection to another by re-ordering elements based on natural sorting order of a key computed using
     * provided lambda.
     */
    sortedBy(descending: boolean, key: λFunction<E | null, any>): Set<E> | null;

    /**
     * Maps this collection to another by re-ordering elements based on natural sorting order of a key computed using
     * provided lambda.
     */
    sortedBy(key: λBiFunction<E | null, number | null, any>): Set<E> | null;

    /**
     * Maps this collection to another by re-ordering elements based on natural sorting order of a key computed using
     * provided lambda.
     */
    sortedBy(descending: boolean, key: λBiFunction<E | null, number | null, any>): Set<E> | null;
     ...
     */
    batch(batchSize?: number | null): Stream<Set<E> | null>;
     ...
     */
    flatten(shallow?: boolean): Set<T> | null;

    /**
     * @return new collection with all nested arrays flattened. The nesting can be to any depth unless `shallow`
     *         parameter is `true` in which case this collection will only be flattened a single level.
     */
    flatten(depth: number, include?: string | null): Set<T> | null;

    /**
     * Produce a random sample from this collection with `count` number of elements.
     */
    sample(spec?: SampleSpec | null): Set<E> | null;
     ...
     */
    slice(fromPos: number, toPos?: number | null, stride?: number | null): Set<E> | null;
     ...
     * If #fromIndex is 0, returns same collection.
     */
    slice(positions: Collection<number | null> | null): Set<E> | null;

    sliceByKey(keys: Collection<any> | null): Set<E> | null;

    sliceByKey(secondaryIndex: string, keys: Collection<any> | null): Set<E> | null;
     ...
     * ```
     */
    downsample(spec: DownsampleSpec): Set<E> | null;
    ...
    rollingDiff(stride?: number | null): Set<E> | null;

    pctChange(stride?: number | null): Set<E> | null;

    unaryOp(op: string): Set<E> | null;

    shape(): C3.Array<number | null>;

    toObj(): Obj | null;

    fetch(spec?: FetchSpec | null): Set<E> | null;
    ...
    timeseries(spec?: DataTimeseriesSpec | null): Set<R> | null;

    timeseries(tsFieldSpec: C3.Map<string | null, TimeseriesFieldSpec | null>, spec?: TimeseriesSpec | null): Set<R> | null;
     ...
     */
    replaceType(old: Type, new_: Type): Set<E>;
     ...
     * elements.
     */
    toMixingCollection(collectionType: CollectionType, failIfInvalid?: boolean): Set<T> | null;
     ...
     */
    boxElements(): C3.Set<Boxed<E> | null> | null;
     ...
     */
    anonymize(spec?: AnonymizationSpec | null): Set<E> | null;
     ...
     */
    withoutOutliers(spec?: OutliersSpec | null): Set<E>;
     ...
     * @param spec configuration of the high and low filter criteria
     */
    extractOutliers(spec?: OutliersSpec | null): Set<E>;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Set<E>;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Set<E> | null;
     ...
     *         point in the window starting at "offset" and spanning "span" data points.
     */
    rolling(agg: string, offset: number, span: number, step?: number | null): Set<E> | null;
     ...
     */
    static of(elementType: ValueType, ...elements: T | null[]): Set<T> | null;

    /**
     * @return collection of any with provided elements.
     */
    static ofAny(...elements: T | null[]): Set<T> | null;

    /**
     * @return collection of provided booleans.
     */
    static ofBool(...elements: boolean[]): C3.Set<boolean> | null;

    /**
     * @return collection of provided 64 bit integers.
     */
    static ofInt(...elements: number | null[]): C3.Set<number | null> | null;

    /**
     * @return collection of provided 32 bit integers.
     */
    static ofInt32(...elements: number | null[]): C3.Set<number | null> | null;

    /**
     * @return collection of provided 16 bit integers.
     */
    static ofInt16(...elements: number | null[]): C3.Set<number | null> | null;

    /**
     * @return collection of provided floats.
     */
    static ofFloat(...elements: number | null[]): C3.Set<number | null> | null;

    /**
     * @return collection of provided doubles.
     */
    static ofDbl(...elements: number | null[]): C3.Set<number | null> | null;

    /**
     * @return collection of provided doubles.
     */
    static ofByte(...elements: number | null[]): C3.Set<number | null> | null;

    /**
     * @return collection of provided datetime.
     */
    static ofDateTime(...elements: DateTime | null[]): C3.Set<DateTime | null> | null;

    /**
     * @return collection of provided string.
     */
    static ofStr(...strs: string | null[]): C3.Set<string | null> | null;

    /**
     * @return collection of generic obj and provided instances.
     */
    static ofObj(...objs: Obj | null[]): C3.Set<Obj | null> | null;

    /**
     * @return collection of provided C3 type and provided instances.
     */
    static ofObj(type: Type, ...objs: Obj | null[]): Set<O> | null;

    /**
     * @return collection of provided integers in a range.
     */
    static ofIntInRange(min: number, max: number, step?: number | null): C3.Set<number> | null;

    /**
     * @return collection of provided integers in a range.
     */
    static ofInt32InRange(min: number, max: number, step?: number | null): C3.Set<number> | null;

    /**
     * @return collection of provided element type and values.
     */
    static builderOf(elementType: ValueType, ...elements: T | null[]): SetBuilder<T>;

    /**
     * @return collection of any with provided elements.
     */
    static builderOfAny(...elements: T | null[]): SetBuilder<T>;

    /**
     * @return collection of provided 64 bit integers.
     */
    static builderOfInt(...elements: number | null[]): SetBuilder<number>;

    /**
     * @return collection of provided 32 bit integers.
     */
    static builderOfInt32(...elements: number | null[]): SetBuilder<number>;

    /**
     * @return collection of provided 16 bit integers.
     */
    static builderOfInt16(...elements: number | null[]): SetBuilder<number>;

    /**
     * @return collection of provided floats.
     */
    static builderOfFloat(...elements: number | null[]): SetBuilder<number>;

    /**
     * @return collection of provided doubles.
     */
    static builderOfDbl(...elements: number | null[]): SetBuilder<number>;

    /**
     * @return collection of provided string.
     */
    static builderOfStr(...strs: string | null[]): SetBuilder<string | null>;

    /**
     * @return collection of provided byte.
     */
    static builderOfByte(...bytes: number | null[]): SetBuilder<number | null>;

    /**
     * @return collection of provided booleans.
     */
    static builderOfBool(...bools: boolean[]): SetBuilder<boolean>;

    /**
     * @return collection of provided byte.
     */
    static builderOfDateTime(...datetimes: DateTime | null[]): SetBuilder<DateTime | null>;

    /**
     * @return collection of generic obj and provided instances.
     */
    static builderOfObj(...objs: Obj | null[]): SetBuilder<Obj | null>;

    /**
     * @return collection of provided C3 type and provided instances.
     */
    static builderOfObj(type: Type, ...objs: Obj | null[]): SetBuilder<O>;
     ...
     */
    static union(...collections: Collection<T> | null[]): C3.Set<T | null>;

    /**
     * @return new instance of set of provided element type by applying builder lambda.
     */
    static build(elementType: ValueType, builder: λConsumer<SetBuilder<T>>): C3.Set<T | null>;

    /**
     * @return new instance of set of any by applying builder lambda.
     */
    static buildAny(builder: λConsumer<SetBuilder<T>>): C3.Set<T | null>;

    /**
     * @return new instance of set of ints by applying builder lambda.
     */
    static buildInts(builder: λConsumer<SetBuilder<number | null>>): C3.Set<number | null>;

    /**
     * @return new instance of set of int16s by applying builder lambda.
     */
    static buildInt16s(builder: λConsumer<SetBuilder<number | null>>): C3.Set<number | null>;

    /**
     * @return new instance of set of int32s by applying builder lambda.
     */
    static buildInt32s(builder: λConsumer<SetBuilder<number | null>>): C3.Set<number | null>;

    /**
     * @return new instance of set of floats by applying builder lambda.
     */
    static buildFloats(builder: λConsumer<SetBuilder<number | null>>): C3.Set<number>;

    /**
     * @return new instance of set of doubles by applying builder lambda.
     */
    static buildDbls(builder: λConsumer<SetBuilder<number | null>>): C3.Set<number>;

    /**
     * @return new instance of set of string by applying builder lambda.
     */
    static buildStrs(builder: λConsumer<SetBuilder<string | null>>): C3.Set<string | null>;

    /**
     * @return new instance of set of provided C3 type by applying builder lambda.
     */
    static buildObjs(type: Type, builder: λConsumer<SetBuilder<O>>): C3.Set<O | null>;

    /**
     * @return new instance of SetBuilder with current set's content as initial content.
     */
    toBuilder(): SetBuilder<E> | null;
  }
}
