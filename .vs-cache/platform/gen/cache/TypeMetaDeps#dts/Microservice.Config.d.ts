// TypeScript definitions for the C3 type Microservice.Config

/**
 * Configuration for Microservice
 *
 * @remarks this represents a value passed to a method that expects an instance of Microservice.Config
 */
 ...
 * Configuration for Microservice
 *
 * @remarks this represents a made instance of Microservice.Config
 */
declare namespace Microservice {
  export class Config extends Obj {

    readonly configOverride?: string | null;
    withConfigOverride(configOverride: string | null): Microservice.Config;

    readonly secretOverride?: string | null;
    withSecretOverride(secretOverride: string | null): Microservice.Config;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: C3.Array<string | null>;
    withIssues(issues: C3.Array<string | null> | Array<string | null>): Microservice.Config;

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): Microservice.Config;

    /**
     * The id of the {@link App} the {@link Microservice} is running in.
     */
    readonly serviceAppId?: string | null;
    withServiceAppId(serviceAppId: string | null): Microservice.Config;

    readonly appId?: string | null;
    withAppId(appId: string | null): Microservice.Config;

    /**
     * The {@link AppUrl} of the {@link App} the {@link Microservice.Service} is running in.
     */
    readonly serviceAppUrl?: string | null;
    withServiceAppUrl(serviceAppUrl: string | null): Microservice.Config;

    /**
     * The type name of the service that actions should be redirected to, if exists.
     */
    readonly serviceTypeName?: string | null;
    withServiceTypeName(serviceTypeName: string | null): Microservice.Config;
    ...
    withServiceRetrySpec(serviceRetrySpec: IMicroservice.RetrySpec | null): Microservice.Config;

    /**
     * Allows the client to configure retry thresholds for certain {@link Microservice} methods.
     */
    readonly actionRetrySpecs?: C3.Map<string | null, Microservice.RetrySpec | null>;
    withActionRetrySpecs(actionRetrySpecs: C3.Map<string | null, Microservice.RetrySpec | null> | {[key: string | null]: IMicroservice.RetrySpec | null}): Microservice.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Microservice.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Microservice.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Microservice.Config | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Microservice.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Microservice.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Microservice.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Microservice.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Microservice.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Microservice.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Microservice.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Microservice.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Microservice.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Microservice.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Microservice.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Microservice.Config;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Microservice.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Microservice.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Microservice.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Microservice.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Microservice.Config;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Microservice.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Microservice.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Microservice.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Microservice.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Microservice.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Microservice.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Microservice.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Microservice.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Microservice.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Microservice.Config;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Microservice.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Microservice.Config;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Microservice.Config;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Microservice.Config;

    mergeJson(json: any | null): Microservice.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Microservice.Config;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Microservice.Config;
     ...
     */
    singletonArray(): C3.Array<Microservice.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Microservice.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Microservice.Config | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Microservice.Config | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Microservice.Config | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Microservice.Config | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Microservice.Config | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Microservice.Config | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Microservice.Config | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Microservice.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Microservice.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Microservice.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Microservice.Config;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Microservice.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Microservice.Config;
     ...
     * @see #fromString
     */
    static make(s: string | null): Microservice.Config | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Microservice.Config;
     ...
     */
    static cachedEmptyInst(): Microservice.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Microservice.Config>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Microservice.Config;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<Microservice.Config | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<Microservice.Config | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<Microservice.Config | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): Microservice.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string | null): Microservice.Config | null;
     ...
     * @see findByCacheKey
     */
    getCached(): Microservice.Config | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): Microservice.Config | null;
     ...
     */
    static produce(key: string): Microservice.Config | null;
     ...
     */
    static produceAll(): C3.Map<string | null, Microservice.Config | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, Microservice.Config | null>;
     ...
     */
    static forConfigKey(configKey: string | null): Microservice.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<Microservice.Config | null>;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Microservice.Config, override?: string | null): void;
     ...
     * @see setSecretValue
     */
    setSecretValues(from: Microservice.Config, override?: string | null): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Microservice.Config | null;
     ...
     */
    removeSecrets(): Microservice.Config | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Microservice.Config | null;
     ...
     * @see #toString
     */
    static fromString(s: string | null): Microservice.Config | null;
     ...
     */
    static forName(name: string | null, failIfMissing?: boolean): Microservice.Config | null;
  }
}
