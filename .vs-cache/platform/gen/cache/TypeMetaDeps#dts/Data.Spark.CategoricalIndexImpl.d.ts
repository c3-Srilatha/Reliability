// TypeScript definitions for the C3 type Data.Spark.CategoricalIndexImpl
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Data.Spark.CategoricalIndexImpl
 */
declare namespace Data.Spark {
  export interface ICategoricalIndexImpl {
 ...
 * See the interface {@link Data.Spark.Index} for declared APIs
 *
 * @remarks this represents a made instance of Data.Spark.CategoricalIndexImpl
 */
declare namespace Data.Spark {
  export class CategoricalIndexImpl extends Obj {
    ...
    withEngine(engine: IData.ExecutionEngine | null): Data.Spark.CategoricalIndexImpl;

    /**
     * The plan that used to actualize this Data.Spark instance
     */
    pipeline?: PipelineSpec | null;
    withPipeline(pipeline: IPipelineSpec | null): Data.Spark.CategoricalIndexImpl;

    /**
     * The id number that represent this Data.Spark instance
     */
    nodeId?: string | null;
    withNodeId(nodeId: string | null): Data.Spark.CategoricalIndexImpl;

    /**
     * The output name of the pipeline
     */
    outputId?: string | null;
    withOutputId(outputId: string | null): Data.Spark.CategoricalIndexImpl;
    ...
    map(mapper?: any): Data.Spark.Index | null;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.Spark.CategoricalIndexImpl | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.Spark.CategoricalIndexImpl | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.Spark.CategoricalIndexImpl | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.Spark.CategoricalIndexImpl | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.Spark.CategoricalIndexImpl;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Spark.CategoricalIndexImpl;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Spark.CategoricalIndexImpl;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Spark.CategoricalIndexImpl | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Spark.CategoricalIndexImpl | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.Spark.CategoricalIndexImpl;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Spark.CategoricalIndexImpl;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Spark.CategoricalIndexImpl;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.Spark.CategoricalIndexImpl;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.Spark.CategoricalIndexImpl;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.Spark.CategoricalIndexImpl;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.Spark.CategoricalIndexImpl;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.Spark.CategoricalIndexImpl;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.Spark.CategoricalIndexImpl;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.Spark.CategoricalIndexImpl;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.Spark.CategoricalIndexImpl;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.Spark.CategoricalIndexImpl;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.Spark.CategoricalIndexImpl;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.Spark.CategoricalIndexImpl;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.Spark.CategoricalIndexImpl;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.Spark.CategoricalIndexImpl;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.Spark.CategoricalIndexImpl;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.Spark.CategoricalIndexImpl;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.Spark.CategoricalIndexImpl;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.Spark.CategoricalIndexImpl;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.Spark.CategoricalIndexImpl;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.Spark.CategoricalIndexImpl;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.Spark.CategoricalIndexImpl;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.Spark.CategoricalIndexImpl;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.Spark.CategoricalIndexImpl;

    mergeJson(json: any | null): Data.Spark.CategoricalIndexImpl;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.Spark.CategoricalIndexImpl;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.Spark.CategoricalIndexImpl;
     ...
     */
    singletonArray(): C3.Array<Data.Spark.CategoricalIndexImpl | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.Spark.CategoricalIndexImpl | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.Spark.CategoricalIndexImpl | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.Spark.CategoricalIndexImpl | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.Spark.CategoricalIndexImpl | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.Spark.CategoricalIndexImpl | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.Spark.CategoricalIndexImpl | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.Spark.CategoricalIndexImpl | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.Spark.CategoricalIndexImpl | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.Spark.CategoricalIndexImpl;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.Spark.CategoricalIndexImpl;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.Spark.CategoricalIndexImpl;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.Spark.CategoricalIndexImpl;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.Spark.CategoricalIndexImpl;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.Spark.CategoricalIndexImpl;

    /**
     * Construct an instance with initial state.
     */
    static make(): Data.Spark.CategoricalIndexImpl;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.Spark.CategoricalIndexImpl;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Data.Spark.CategoricalIndexImpl;
     ...
     */
    static cachedEmptyInst(): Data.Spark.CategoricalIndexImpl;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.Spark.CategoricalIndexImpl>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.Spark.CategoricalIndexImpl;

    get categories(): any;

    get codes(): Data.Spark.Index | null;

    get ordered(): boolean | null;
     ...
     * @return this Obj
     */
    setField(field: string, value: any, doNotConvert?: boolean): Data.Spark.CategoricalIndexImpl;
     ...
     * @return this Obj
     */
    setField(field: FieldType, value: any, doNotConvert?: boolean): Data.Spark.CategoricalIndexImpl;
