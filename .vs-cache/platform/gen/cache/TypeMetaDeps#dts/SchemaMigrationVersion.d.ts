// TypeScript definitions for the C3 type SchemaMigrationVersion

/**
 * Keeps track of which schema migrations have been performed for each app
 *
 * @remarks this represents a value passed to a method that expects an instance of SchemaMigrationVersion
 */
declare interface ISchemaMigrationVersion {

  /**
   * Id will be the name of the migration type.
   */
  id: string;
  ...
  /**
   * Name of last migration function that was successfully applied for the migration type.
   */
 ...
 * Keeps track of which schema migrations have been performed for each app
 *
 * @remarks this represents a made instance of SchemaMigrationVersion
 */
declare class SchemaMigrationVersion extends Obj {

  /**
   * Id will be the name of the migration type.
   */
  readonly id: string;
  withId(id: string): SchemaMigrationVersion;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): SchemaMigrationVersion;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): SchemaMigrationVersion;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): SchemaMigrationVersion;
  ...
  withVersion(version: number | null): SchemaMigrationVersion;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): SchemaMigrationVersion;

  /**
   * Name of last migration function that was successfully applied for the migration type.
   */
  readonly lastMigration: string;
  withLastMigration(lastMigration: string): SchemaMigrationVersion;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): SchemaMigrationVersion | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): SchemaMigrationVersion | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): SchemaMigrationVersion | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): SchemaMigrationVersion | null;
   ...
   */
  replaceType(old: Type, new_: Type): SchemaMigrationVersion;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SchemaMigrationVersion;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): SchemaMigrationVersion;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SchemaMigrationVersion | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<SchemaMigrationVersion | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): SchemaMigrationVersion;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SchemaMigrationVersion;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): SchemaMigrationVersion;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): SchemaMigrationVersion;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): SchemaMigrationVersion;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): SchemaMigrationVersion;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): SchemaMigrationVersion;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): SchemaMigrationVersion;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): SchemaMigrationVersion;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): SchemaMigrationVersion;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): SchemaMigrationVersion;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): SchemaMigrationVersion;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): SchemaMigrationVersion;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): SchemaMigrationVersion;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): SchemaMigrationVersion;
   ...
   * @see #unsetField
   */
  defaultField(field: string): SchemaMigrationVersion;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): SchemaMigrationVersion;
   ...
   * @see #removeField
   */
  unsetField(field: string): SchemaMigrationVersion;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): SchemaMigrationVersion;
   ...
   * @see #unsetField
   */
  removeField(field: string): SchemaMigrationVersion;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): SchemaMigrationVersion;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): SchemaMigrationVersion;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): SchemaMigrationVersion;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): SchemaMigrationVersion;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): SchemaMigrationVersion;

  mergeJson(json: any | null): SchemaMigrationVersion;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): SchemaMigrationVersion;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): SchemaMigrationVersion;
   ...
   */
  singletonArray(): C3.Array<SchemaMigrationVersion | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<SchemaMigrationVersion | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<SchemaMigrationVersion | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<SchemaMigrationVersion | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<SchemaMigrationVersion | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, SchemaMigrationVersion | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, SchemaMigrationVersion | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<SchemaMigrationVersion | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<SchemaMigrationVersion | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): SchemaMigrationVersion;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): SchemaMigrationVersion;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): SchemaMigrationVersion;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): SchemaMigrationVersion;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): SchemaMigrationVersion;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): SchemaMigrationVersion;
   ...
   * @see #fromString
   */
  static make(s: string | null): SchemaMigrationVersion | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): SchemaMigrationVersion;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): SchemaMigrationVersion;
   ...
   */
  static cachedEmptyInst(): SchemaMigrationVersion;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<SchemaMigrationVersion>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): SchemaMigrationVersion;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<SchemaMigrationVersion | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<SchemaMigrationVersion | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<SchemaMigrationVersion | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<SchemaMigrationVersion | null> | null>;
   ...
   */
  get(include?: string | null): SchemaMigrationVersion | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): SchemaMigrationVersion | null;
   ...
   */
  getMissing(spec: GetMissingSpec): SchemaMigrationVersion;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): SchemaMigrationVersion | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): SchemaMigrationVersion;
   ...
   * @see #toString
   */
  static fromString(s: string | null): SchemaMigrationVersion | null;
   ...
   */
  create(spec?: UpsertSpec | null): SchemaMigrationVersion | null;
   ...
   */
  static createBatch(objs: C3.Array<SchemaMigrationVersion | null> | null, spec?: UpsertSpec | null): ObjList<SchemaMigrationVersion | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<SchemaMigrationVersion | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<SchemaMigrationVersion | null> | null;
   ...
   */
  update(srcObj?: SchemaMigrationVersion | null, spec?: UpsertSpec | null): SchemaMigrationVersion | null;
   ...
   */
  upsert(srcObj?: SchemaMigrationVersion | null, spec?: UpsertSpec | null): SchemaMigrationVersion | null;
   ...
   */
  merge(spec?: MergeSpec | null): SchemaMigrationVersion | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): SchemaMigrationVersion | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): SchemaMigrationVersion | null;
   ...
   */
  static updateBatch(objs: C3.Array<SchemaMigrationVersion | null> | null, srcObjs?: C3.Array<SchemaMigrationVersion | null>, spec?: UpsertSpec | null): ObjList<SchemaMigrationVersion | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<SchemaMigrationVersion | null>>, spec?: UpsertSpec | null): ObjList<SchemaMigrationVersion | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<SchemaMigrationVersion | null> | null, srcObjs?: C3.Array<SchemaMigrationVersion | null>, spec?: UpsertSpec | null): ObjList<SchemaMigrationVersion | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<SchemaMigrationVersion | null>>, spec?: UpsertSpec | null): ObjList<SchemaMigrationVersion | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<SchemaMigrationVersion | null> | null, spec?: TouchSpec | null): ObjList<SchemaMigrationVersion | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SchemaMigrationVersion | null> | null, spec?: MergeSpec | null): ObjList<SchemaMigrationVersion | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<SchemaMigrationVersion | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<SchemaMigrationVersion | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<SchemaMigrationVersion | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<SchemaMigrationVersion | null> | null;
   ...
   */
  static mergeAll(mergeObj: SchemaMigrationVersion | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: SchemaMigrationVersion | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<SchemaMigrationVersion | null> | null, spec?: UpsertSpec | null): ObjList<SchemaMigrationVersion | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<SchemaMigrationVersion | null> | null, spec?: UpsertSpec | null): ObjList<SchemaMigrationVersion | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): SchemaMigrationVersion | null;
   ...
   */
  static beforeCreate(objs: C3.Array<SchemaMigrationVersion | null> | null): ObjList<SchemaMigrationVersion | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<SchemaMigrationVersion | null> | null): ObjList<SchemaMigrationVersion | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<SchemaMigrationVersion | null> | null): ObjList<SchemaMigrationVersion | null>;
   ...
   */
  static afterCreate(objs: C3.Array<SchemaMigrationVersion | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<SchemaMigrationVersion | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<SchemaMigrationVersion | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<SchemaMigrationVersion | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<SchemaMigrationVersion | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): SchemaMigrationVersion | null;
   ...
   */
  withoutIdentity(): SchemaMigrationVersion | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<SchemaMigrationVersion | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: SchemaMigrationVersion | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<SchemaMigrationVersion | null> | null, callback?: λFunction<SchemaMigrationVersion | null, SchemaMigrationVersion | null> | null): ObjList<SchemaMigrationVersion | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<SchemaMigrationVersion | null> | null, callback?: λFunction<SchemaMigrationVersion | null, SchemaMigrationVersion | null> | null): C3.Array<ObjError | null>;
  ...
  /**
   * Gets the next migration function that needs to be applied (if any) for an migration type.
   *
   * @param type
   *        Migration type to check
   *
   * @return the next migration function that needs to be applied (if any) for a migration type.
   */
  static nextMigration(type: Type): string | null;

  /**
   * Gets the next migration version number that needs to be applied (if any) for an migration type.
   *
   * @param type
   *        Migration type to check
   *
   * @return the next migration version number that needs to be applied (if any) for a migration type.  If no
   *         migration is pending, -1 will be returned.
   */
  static nextMigrationVersion(type: Type): number;

  /**
   * Sets the migration state as completed for a migration function.
   *
   * @param type
   *        Migration type to set the status for
   *
   * @param func
   *        Migration function that was completed
   *
   * @return the next migration step that needs to be applied (if any) for the migration type.
   */
  static migrationCompleted(type: Type, func: string): string | null;

  /**
   * Called during first start of an app.  Sets all of the migration functions as completed to avoid applying them.
   */
  static initialize(): void;

  /**
   * @return true if the app has been initialized for schema migrations.  False means that the app is being
   *         deployed/started for the first time and no schema migrations are required.
   */
  static isInitialized(): boolean;

  /**
   * @return true if any {@link PlatformSchemaMigration} functions need to be applied.
   */
  static needsPlatformSchemaMigration(): boolean;

  /**
   * @return true if any {@link SchemaUpgrade} functions need to be applied.
   */
  static needsAppMigration(): boolean;

  /**
   * Applies all pending app level {@link SchemaUpgrade} functions.
   */
  static applyAppMigrations(): void;
}
