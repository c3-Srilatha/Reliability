// TypeScript definitions for the C3 type FunctionType
 ...
 * @see FunctionParam
 *
 * @remarks this represents a value passed to a method that expects an instance of FunctionType
 */
declare interface IFunctionType {
 ...
 * @see FunctionParam
 *
 * @remarks this represents a made instance of FunctionType
 */
declare class FunctionType extends Obj {

  /**
   * Source file Pkg.Path a C3 Type declaration [.c3typ].
   */
  readonly declaredPkgPath?: string | null;
  withDeclaredPkgPath(declaredPkgPath: string | null): FunctionType;

  /**
   * Source line number in a C3 Type declaration [.c3typ] file starting with 1 where this metadata element is declared.
   */
  readonly declaredSrcLine?: number | null;
  withDeclaredSrcLine(declaredSrcLine: number | null): FunctionType;
  ...
  withDeclaredSrcCharInLine(declaredSrcCharInLine: number | null): FunctionType;
   ...
   */
  readonly pkg: Pkg;
  withPkg(pkg: IPkg): FunctionType;

  /**
   * SDK json representing instance of this type
   */
  readonly json?: any;
  withJson(json: any): FunctionType;

  /**
   * The set of annotations defined on this element of metadata represented as json value.
   */
  readonly annotationsJson?: any | null;
  withAnnotationsJson(annotationsJson: any | null): FunctionType;
  ...
  withModifier(modifier: string | null): FunctionType;

  readonly name?: string | null;
  withName(name: string | null): FunctionType;
  ...
  withVarBindings(varBindings: C3.Map<string | null, ValueType | null> | {[key: string | null]: IValueType | null}): FunctionType;

  /**
   * The list of variable declarations and any restrictions on them.
   */
  readonly genericVars?: C3.Array<VarReferenceType | null>;
  withGenericVars(genericVars: C3.Array<VarReferenceType | null> | Array<IVarReferenceType | null>): FunctionType;

  /**
   * The formal parameters accepted by this function.
   */
  readonly params?: C3.Array<FunctionParam | null>;
  withParams(params: C3.Array<FunctionParam | null> | Array<IFunctionParam | null>): FunctionType;

  /**
   * The return type of the function.
   */
  readonly returnType?: ValueType | null;
  withReturnType(returnType: IValueType | null): FunctionType;
  ...
  withStateful(stateful: boolean): FunctionType;
   ...
   */
  replaceType(old: Type, new_: Type): FunctionType;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): FunctionType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): FunctionType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): FunctionType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): FunctionType | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FunctionType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FunctionType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FunctionType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FunctionType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): FunctionType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FunctionType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FunctionType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FunctionType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FunctionType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FunctionType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): FunctionType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FunctionType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FunctionType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): FunctionType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): FunctionType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): FunctionType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): FunctionType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FunctionType;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): FunctionType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FunctionType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FunctionType;
   ...
   * @see #removeField
   */
  unsetField(field: string): FunctionType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FunctionType;
   ...
   * @see #unsetField
   */
  removeField(field: string): FunctionType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FunctionType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): FunctionType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): FunctionType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): FunctionType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): FunctionType;

  mergeJson(json: any | null): FunctionType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): FunctionType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): FunctionType;
   ...
   */
  singletonArray(): C3.Array<FunctionType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<FunctionType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FunctionType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<FunctionType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FunctionType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, FunctionType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FunctionType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FunctionType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FunctionType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): FunctionType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): FunctionType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): FunctionType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FunctionType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): FunctionType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FunctionType;
   ...
   * @see #fromString
   */
  static make(s: string | null): FunctionType | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): FunctionType;
   ...
   */
  static cachedEmptyInst(): FunctionType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<FunctionType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): FunctionType;
   ...
   */
  withoutDeclaredSrcPos(recursive?: boolean): FunctionType;
   ...
   */
  withAnnotation(ann: Annotation): FunctionType;
   ...
   *         value for the field
   */
  withAnnotation(ann: string, annField?: string | null, value?: any): FunctionType;
   ...
   * @see #toString
   */
  static fromString(s: string | null): FunctionType | null;
