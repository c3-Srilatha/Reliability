// TypeScript definitions for the C3 type Pkg.File

/**
 * @remarks this represents a value passed to a method that expects an instance of Pkg.File
 */
...
declare namespace Pkg {
  export class File extends Obj {
    ...
    withTEST_FILE_PATTERN(TEST_FILE_PATTERN: string | null): Pkg.File;
     ...
     */
    readonly url: string;
    withUrl(url: string): Pkg.File;

    /**
     * scheme of this pkg path url.
     */
    readonly scheme?: string | null;
    withScheme(scheme: string | null): Pkg.File;

    /**
     * The name of package Pkg file belongs to.
     */
    readonly package?: string | null;
    withPackage(package_: string | null): Pkg.File;

    /**
     * Category for Pkg file.
     */
    readonly category?: string | null;
    withCategory(category: string | null): Pkg.File;
    ...
    withEncodedSubPath(encodedSubPath: string | null): Pkg.File;

    /**
     * overlay of the path, if the path is part of one. There can only be one overlay.
     */
    readonly overlay?: string | null;
    withOverlay(overlay: string | null): Pkg.File;
    ...
    withDepPkgName(depPkgName: string | null): Pkg.File;
    ...
    withDepPkgOverlay(depPkgOverlay: string | null): Pkg.File;

    /**
     * Local cache of the #safeTargetType method call.
     */
    readonly targetType?: string | null;
    withTargetType(targetType: string | null): Pkg.File;
    ...
    withContentEncoding(contentEncoding: string | null): Pkg.File;
    ...
    withContentLanguage(contentLanguage: string | null): Pkg.File;
    ...
    withContentLength(contentLength: number | null): Pkg.File;
    ...
    withContentLocation(contentLocation: string | null): Pkg.File;
    ...
    withContentType(contentType: string | null): Pkg.File;
    ...
    withContentDisposition(contentDisposition: string | null): Pkg.File;
    ...
    withETag(eTag: string | null): Pkg.File;
    ...
    withLastModified(lastModified: DateTime | Date | string | null): Pkg.File;

    /**
     * Id of user / identity who last last modified this content.
     */
    readonly lastModifiedBy?: string | null;
    withLastModifiedBy(lastModifiedBy: string | null): Pkg.File;
    ...
    withContentMD5(contentMD5: string | null): Pkg.File;
    ...
    withContentSHA1(contentSHA1: string | null): Pkg.File;

    /**
     * Field to maintain state whether content metadata was read or not.
     */
    readonly hasMetadata?: boolean;
    withHasMetadata(hasMetadata: boolean): Pkg.File;
     ...
     * @see #toString
     */
    static fromString(s: string | null): Pkg.File | null;
     ...
     * @see #fromString
     */
    static make(s: string | null): Pkg.File | null;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Pkg.File;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Pkg.File;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Pkg.File;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Pkg.File;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Pkg.File | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Pkg.File | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Pkg.File | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Pkg.File | null;
     ...
     */
    replaceType(old: Type, new_: Type): Pkg.File;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Pkg.File;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Pkg.File;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Pkg.File | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Pkg.File | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Pkg.File;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Pkg.File;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Pkg.File;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Pkg.File;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Pkg.File;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Pkg.File;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Pkg.File;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Pkg.File;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Pkg.File;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Pkg.File;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Pkg.File;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Pkg.File;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Pkg.File;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Pkg.File;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Pkg.File;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Pkg.File;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Pkg.File;
     ...
     * @see #removeField
     */
    unsetField(field: string): Pkg.File;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Pkg.File;
     ...
     * @see #unsetField
     */
    removeField(field: string): Pkg.File;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Pkg.File;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Pkg.File;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Pkg.File;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Pkg.File;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Pkg.File;

    mergeJson(json: any | null): Pkg.File;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Pkg.File;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Pkg.File;
     ...
     */
    singletonArray(): C3.Array<Pkg.File | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Pkg.File | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Pkg.File | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Pkg.File | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Pkg.File | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Pkg.File | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Pkg.File | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Pkg.File | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Pkg.File | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Pkg.File;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Pkg.File;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Pkg.File;
     ...
     */
    static cachedEmptyInst(): Pkg.File;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Pkg.File>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Pkg.File;
     ...
     */
    withFileName(fileName: string | null): Pkg.File;

    /**
     * Changes file extension in this instance.
     */
    withFileExt(fileExt: string | null): Pkg.File;
     ...
     */
    identify(suffix?: string | null): Pkg.File;
     ...
     */
    readMetadata(spec?: FileOperationSpec | null): Pkg.File;
     ...
     */
    refreshMetadata(spec?: FileOperationSpec | null): Pkg.File;
     ...
     */
    encodedPushStream(spec?: FileOperationSpec | null): Pair<Pkg.File | null, BytePushStream | null>;

    /**
     * @return byte push stream to be used for writing un-encoded data into this content object.
     */
    pushStream(spec?: FileOperationSpec | null): Pair<Pkg.File | null, BytePushStream | null>;

    /**
     * @return character push stream to be used for writing un-encoded data into this content object.
     */
    charPushStream(spec?: FileOperationSpec | null): Pair<Pkg.File | null, CharPushStream | null>;
     ...
     */
    encodedStream(spec?: FileOperationSpec | null): Pair<Pkg.File | null, ByteStream | null> | null;
     ...
     */
    writeStream(content: ByteStream | null, spec?: FileOperationSpec | null): Pkg.File;

    /**
     * Truncates file and replaces it's content with provided binary content.
     */
    writeInputStream(inputStream: any, spec?: FileOperationSpec | null): Pkg.File;

    /**
     * Truncates file and replaces its content with provided binary content from zipInputStream
     */
    writeZipInputStream(zipInputStream: any, spec?: FileOperationSpec | null): Pkg.File;
     ...
     */
    writeEncodedStream(encodedContent: ByteStream | null, spec?: FileOperationSpec | null): Pkg.File;

    /**
     * Truncates file and replaces it's encoded content with provided binary content.
     */
    writeEncodedInputStream(inputStream: any, spec?: FileOperationSpec | null): Pkg.File;
     ...
     *           content that needs to be written
     */
    write(content: any | null, spec?: FileOperationSpec | null): Pkg.File;
     ...
     *           encoded content that needs to be written
     */
    writeEncoded(encodedContent: any | null, spec?: FileOperationSpec | null): Pkg.File;
     ...
     *           content that needs to be written
     */
    writeString(content: string | null, spec?: FileOperationSpec | null): Pkg.File;
     ...
     */
    writeObj(obj: Obj | null, spec?: FileObjsOperSpec | null): Pkg.File;
     ...
     * @return pair of update instance of this content and number of objs written
     */
    startWriteObjs(spec?: FileObjsOperSpec | null): Pair<Pkg.File | null, PushStream<Obj | null> | null>;
     ...
     */
    compress(contentEncoding?: string | null, spec?: FileCompressSpec | null): Pkg.File;

    /**
     * Uncompresses file. Removes compression specific extension.
     */
    uncompress(spec?: FileCompressSpec | null): Pkg.File;
     ...
     */
    transcode(contentType: string, contentEncoding: string, spec?: FileCompressSpec | null): Pkg.File;

    /**
     * Copies content to a given target.
     */
    copyContentTo(target: Pkg.File, spec?: FileOperationSpec | null): void;
