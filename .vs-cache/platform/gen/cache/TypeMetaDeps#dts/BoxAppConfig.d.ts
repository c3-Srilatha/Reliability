// TypeScript definitions for the C3 type BoxAppConfig

/**
 * Type to manage Box App credential, belonging to C3.
 *
 * @remarks this represents a value passed to a method that expects an instance of BoxAppConfig
 */
declare interface IBoxAppConfig {
  ...
  /**
   * The Box account settings
   */
  boxAppSettings?: IBoxAppSetting | null;
}

/**
 * Type to manage Box App credential, belonging to C3.
 *
 * @remarks this represents a made instance of BoxAppConfig
 */
declare class BoxAppConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): BoxAppConfig;

  static readonly configOverride?: string | null;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): BoxAppConfig;
  ...
  withIssues(issues: C3.Array<string | null> | Array<string | null>): BoxAppConfig;
  ...
  withEnterpriseId(enterpriseId: string | null): BoxAppConfig;

  /**
   * The enterprise ID of the Box account
   */
  static readonly enterpriseId?: string | null;

  /**
   * The Box account settings
   */
  readonly boxAppSettings?: BoxAppSetting | null;
  withBoxAppSettings(boxAppSettings: IBoxAppSetting | null): BoxAppConfig;

  /**
   * The Box account settings
   */
  static readonly boxAppSettings?: BoxAppSetting | null;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): BoxAppConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): BoxAppConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): BoxAppConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): BoxAppConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): BoxAppConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): BoxAppConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BoxAppConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BoxAppConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BoxAppConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): BoxAppConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BoxAppConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BoxAppConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BoxAppConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<BoxAppConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): BoxAppConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): BoxAppConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BoxAppConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BoxAppConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BoxAppConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): BoxAppConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): BoxAppConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): BoxAppConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): BoxAppConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): BoxAppConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): BoxAppConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): BoxAppConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): BoxAppConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): BoxAppConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BoxAppConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): BoxAppConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): BoxAppConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): BoxAppConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): BoxAppConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): BoxAppConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): BoxAppConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): BoxAppConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): BoxAppConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): BoxAppConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): BoxAppConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): BoxAppConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): BoxAppConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): BoxAppConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): BoxAppConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): BoxAppConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): BoxAppConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): BoxAppConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): BoxAppConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): BoxAppConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): BoxAppConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): BoxAppConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): BoxAppConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): BoxAppConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): BoxAppConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): BoxAppConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): BoxAppConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): BoxAppConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): BoxAppConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): BoxAppConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): BoxAppConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): BoxAppConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): BoxAppConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): BoxAppConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): BoxAppConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): BoxAppConfig;

  mergeJson(json: any | null): BoxAppConfig;

  static mergeJson(json: any | null): BoxAppConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): BoxAppConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): BoxAppConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): BoxAppConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): BoxAppConfig;
   ...
   */
  singletonArray(): C3.Array<BoxAppConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<BoxAppConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<BoxAppConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<BoxAppConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<BoxAppConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<BoxAppConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<BoxAppConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, BoxAppConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, BoxAppConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<BoxAppConfig | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<BoxAppConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<BoxAppConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): BoxAppConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): BoxAppConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): BoxAppConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): BoxAppConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): BoxAppConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): BoxAppConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): BoxAppConfig;
   ...
   */
  static cachedEmptyInst(): BoxAppConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<BoxAppConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): BoxAppConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<BoxAppConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<BoxAppConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<BoxAppConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): BoxAppConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): BoxAppConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): BoxAppConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): BoxAppConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): BoxAppConfig | null;
   ...
   */
  static produce(key: string): BoxAppConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, BoxAppConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, BoxAppConfig | null>;
   ...
   */
  static forConfigKey(configKey: string | null): BoxAppConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<BoxAppConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: BoxAppConfig, override?: string | null): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: BoxAppConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: BoxAppConfig, override?: string | null): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: BoxAppConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): BoxAppConfig | null;
   ...
   */
  removeSecrets(): BoxAppConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): BoxAppConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): BoxAppConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): BoxAppConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): BoxAppConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): BoxAppConfig;
   ...
   */
  static inst(): BoxAppConfig;

  /**
   * @return the cached instance if already cached, null otherwise. Does not instantiate if missing.
   */
  static cachedInst(): BoxAppConfig | null;

  /**
   * A helper function to set public and secret configs
   */
  static setConfigAndSecret(clientId?: string | null, clientSecret?: string | null, publicKeyId?: string | null, privateKey?: string | null, passphrase?: string | null, enterpriseId?: string | null, redirectUri?: string | null): void;
}
