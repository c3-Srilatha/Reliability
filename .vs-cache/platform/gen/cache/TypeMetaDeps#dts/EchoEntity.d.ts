// TypeScript definitions for the C3 type EchoEntity

/**
 * @remarks this represents a value passed to a method that expects an instance of EchoEntity
 */
declare interface IEchoEntity {
...
/**
 * @remarks this represents a made instance of EchoEntity
 */
declare class EchoEntity extends Obj {
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): EchoEntity;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): EchoEntity;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): EchoEntity;
  ...
  withVersion(version: number | null): EchoEntity;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): EchoEntity;

  readonly msg: string;
  withMsg(msg: string): EchoEntity;

  readonly msgSuffix: string;
  withMsgSuffix(msgSuffix: string): EchoEntity;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): EchoEntity | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): EchoEntity | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): EchoEntity | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): EchoEntity | null;
   ...
   */
  replaceType(old: Type, new_: Type): EchoEntity;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): EchoEntity;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): EchoEntity;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<EchoEntity | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<EchoEntity | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): EchoEntity;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): EchoEntity;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): EchoEntity;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): EchoEntity;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): EchoEntity;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): EchoEntity;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): EchoEntity;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): EchoEntity;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): EchoEntity;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): EchoEntity;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): EchoEntity;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): EchoEntity;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): EchoEntity;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): EchoEntity;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): EchoEntity;
   ...
   * @see #unsetField
   */
  defaultField(field: string): EchoEntity;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): EchoEntity;
   ...
   * @see #removeField
   */
  unsetField(field: string): EchoEntity;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): EchoEntity;
   ...
   * @see #unsetField
   */
  removeField(field: string): EchoEntity;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): EchoEntity;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): EchoEntity;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): EchoEntity;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): EchoEntity;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): EchoEntity;

  mergeJson(json: any | null): EchoEntity;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): EchoEntity;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): EchoEntity;
   ...
   */
  singletonArray(): C3.Array<EchoEntity | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<EchoEntity | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<EchoEntity | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<EchoEntity | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<EchoEntity | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, EchoEntity | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, EchoEntity | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<EchoEntity | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<EchoEntity | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): EchoEntity;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): EchoEntity;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): EchoEntity;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): EchoEntity;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): EchoEntity;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): EchoEntity;
   ...
   * @see #fromString
   */
  static make(s: string | null): EchoEntity | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): EchoEntity;
   ...
   */
  static cachedEmptyInst(): EchoEntity;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<EchoEntity>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): EchoEntity;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<EchoEntity | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<EchoEntity | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<EchoEntity | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<EchoEntity | null> | null>;
   ...
   */
  get(include?: string | null): EchoEntity | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): EchoEntity | null;
   ...
   */
  getMissing(spec: GetMissingSpec): EchoEntity;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): EchoEntity | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): EchoEntity;
   ...
   * @see #toString
   */
  static fromString(s: string | null): EchoEntity | null;
   ...
   */
  create(spec?: UpsertSpec | null): EchoEntity | null;
   ...
   */
  static createBatch(objs: C3.Array<EchoEntity | null> | null, spec?: UpsertSpec | null): ObjList<EchoEntity | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<EchoEntity | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<EchoEntity | null> | null;
   ...
   */
  update(srcObj?: EchoEntity | null, spec?: UpsertSpec | null): EchoEntity | null;
   ...
   */
  upsert(srcObj?: EchoEntity | null, spec?: UpsertSpec | null): EchoEntity | null;
   ...
   */
  merge(spec?: MergeSpec | null): EchoEntity | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): EchoEntity | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): EchoEntity | null;
   ...
   */
  static updateBatch(objs: C3.Array<EchoEntity | null> | null, srcObjs?: C3.Array<EchoEntity | null>, spec?: UpsertSpec | null): ObjList<EchoEntity | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<EchoEntity | null>>, spec?: UpsertSpec | null): ObjList<EchoEntity | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<EchoEntity | null> | null, srcObjs?: C3.Array<EchoEntity | null>, spec?: UpsertSpec | null): ObjList<EchoEntity | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<EchoEntity | null>>, spec?: UpsertSpec | null): ObjList<EchoEntity | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<EchoEntity | null> | null, spec?: TouchSpec | null): ObjList<EchoEntity | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<EchoEntity | null> | null, spec?: MergeSpec | null): ObjList<EchoEntity | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<EchoEntity | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<EchoEntity | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<EchoEntity | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<EchoEntity | null> | null;
   ...
   */
  static mergeAll(mergeObj: EchoEntity | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: EchoEntity | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<EchoEntity | null> | null, spec?: UpsertSpec | null): ObjList<EchoEntity | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<EchoEntity | null> | null, spec?: UpsertSpec | null): ObjList<EchoEntity | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<EchoEntity | null> | null): ObjList<EchoEntity | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<EchoEntity | null> | null): ObjList<EchoEntity | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<EchoEntity | null> | null): ObjList<EchoEntity | null>;
   ...
   */
  static afterCreate(objs: C3.Array<EchoEntity | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<EchoEntity | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<EchoEntity | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<EchoEntity | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<EchoEntity | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): EchoEntity | null;
   ...
   */
  withoutIdentity(): EchoEntity | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<EchoEntity | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: EchoEntity | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<EchoEntity | null> | null, callback?: λFunction<EchoEntity | null, EchoEntity | null> | null): ObjList<EchoEntity | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<EchoEntity | null> | null, callback?: λFunction<EchoEntity | null, EchoEntity | null> | null): C3.Array<ObjError | null>;
  ...
  echoJava(): string | null;

  echoNoMethodDependency(): string | null;

  echoNoMethodDependencyJava(): string | null;
}
