// TypeScript definitions for the C3 type RefreshUniqueIndexesBatchJob

/**
 * Batch job definitions for batch jobs started from RefreshUniqueIndexesTask for asynchronous processing.
 *
 * @remarks this represents a value passed to a method that expects an instance of RefreshUniqueIndexesBatchJob
 */
declare interface IRefreshUniqueIndexesBatchJob {
 ...
 */
declare class RefreshUniqueIndexesBatchJob extends Obj {

  /**
   * current or last job execution for this instance
   */
  readonly run?: BatchJobRun | null;
  withRun(run: IBatchJobRun | null): RefreshUniqueIndexesBatchJob;

  /**
   * previous job executions for this instance
   */
  readonly runs?: C3.Array<BatchJobRun | null>;
  withRuns(runs: C3.Array<BatchJobRun | null> | Array<IBatchJobRun | null>): RefreshUniqueIndexesBatchJob;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj | null;
  withOptions(options: IObj | null): RefreshUniqueIndexesBatchJob;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): RefreshUniqueIndexesBatchJob;
  ...
  withPriority(priority: number | null): RefreshUniqueIndexesBatchJob;
  ...
  withDisabled(disabled: boolean): RefreshUniqueIndexesBatchJob;
  ...
  withMaxConcurrency(maxConcurrency: number | null): RefreshUniqueIndexesBatchJob;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): RefreshUniqueIndexesBatchJob;
  ...
  withRunAsUser(runAsUser: boolean | null): RefreshUniqueIndexesBatchJob;

  /**
   * Don't set this field in the BatchJob, set it in the BatchJobOptions when calling `start`
   */
  readonly nodePool?: string | null;
  withNodePool(nodePool: string | null): RefreshUniqueIndexesBatchJob;
  ...
  withSkipIfRunning(skipIfRunning: boolean | null): RefreshUniqueIndexesBatchJob;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number | null;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): RefreshUniqueIndexesBatchJob;
  ...
  withPropagateActionContext(propagateActionContext: boolean): RefreshUniqueIndexesBatchJob;
  ...
  withTypeIdent(typeIdent: string | null): RefreshUniqueIndexesBatchJob;
   ...
   */
  readonly id: string;
  withId(id: string): RefreshUniqueIndexesBatchJob;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): RefreshUniqueIndexesBatchJob;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): RefreshUniqueIndexesBatchJob;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): RefreshUniqueIndexesBatchJob;
  ...
  withVersion(version: number | null): RefreshUniqueIndexesBatchJob;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): RefreshUniqueIndexesBatchJob;
  ...
  withAbortOnError(abortOnError: boolean): RefreshUniqueIndexesBatchJob;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): RefreshUniqueIndexesBatchJob | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): RefreshUniqueIndexesBatchJob | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): RefreshUniqueIndexesBatchJob | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): RefreshUniqueIndexesBatchJob | null;
   ...
   */
  replaceType(old: Type, new_: Type): RefreshUniqueIndexesBatchJob;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): RefreshUniqueIndexesBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): RefreshUniqueIndexesBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<RefreshUniqueIndexesBatchJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<RefreshUniqueIndexesBatchJob | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): RefreshUniqueIndexesBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RefreshUniqueIndexesBatchJob;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): RefreshUniqueIndexesBatchJob;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): RefreshUniqueIndexesBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): RefreshUniqueIndexesBatchJob;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): RefreshUniqueIndexesBatchJob;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): RefreshUniqueIndexesBatchJob;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): RefreshUniqueIndexesBatchJob;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): RefreshUniqueIndexesBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): RefreshUniqueIndexesBatchJob;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): RefreshUniqueIndexesBatchJob;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): RefreshUniqueIndexesBatchJob;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): RefreshUniqueIndexesBatchJob;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): RefreshUniqueIndexesBatchJob;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): RefreshUniqueIndexesBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: string): RefreshUniqueIndexesBatchJob;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): RefreshUniqueIndexesBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: string): RefreshUniqueIndexesBatchJob;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): RefreshUniqueIndexesBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: string): RefreshUniqueIndexesBatchJob;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): RefreshUniqueIndexesBatchJob;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): RefreshUniqueIndexesBatchJob;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): RefreshUniqueIndexesBatchJob;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): RefreshUniqueIndexesBatchJob;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): RefreshUniqueIndexesBatchJob;

  mergeJson(json: any | null): RefreshUniqueIndexesBatchJob;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): RefreshUniqueIndexesBatchJob;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): RefreshUniqueIndexesBatchJob;
   ...
   */
  singletonArray(): C3.Array<RefreshUniqueIndexesBatchJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<RefreshUniqueIndexesBatchJob | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<RefreshUniqueIndexesBatchJob | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<RefreshUniqueIndexesBatchJob | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<RefreshUniqueIndexesBatchJob | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, RefreshUniqueIndexesBatchJob | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, RefreshUniqueIndexesBatchJob | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<RefreshUniqueIndexesBatchJob | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<RefreshUniqueIndexesBatchJob | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): RefreshUniqueIndexesBatchJob;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): RefreshUniqueIndexesBatchJob;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): RefreshUniqueIndexesBatchJob;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): RefreshUniqueIndexesBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): RefreshUniqueIndexesBatchJob;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): RefreshUniqueIndexesBatchJob;
   ...
   * @see #fromString
   */
  static make(s: string | null): RefreshUniqueIndexesBatchJob | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): RefreshUniqueIndexesBatchJob;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): RefreshUniqueIndexesBatchJob;
   ...
   */
  static cachedEmptyInst(): RefreshUniqueIndexesBatchJob;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<RefreshUniqueIndexesBatchJob>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): RefreshUniqueIndexesBatchJob;
   ...
   */
  start(options?: RefreshUniqueIndexesSpec | null): BatchJobStatus | null;
   ...
   */
  cleanup(options?: RefreshUniqueIndexesSpec | null): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<BatchJobRun | null, BatchJobStatus | null, RefreshUniqueIndexesSpec | null> | null;

  failJob(run: JobRun<BatchJobStatusBase | null>): JobBase<BatchJobRun | null, BatchJobStatus | null, RefreshUniqueIndexesSpec | null> | null;
  ...
  validateStart(options?: RefreshUniqueIndexesSpec | null): void;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<RefreshUniqueIndexesBatchJob | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<RefreshUniqueIndexesBatchJob | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<RefreshUniqueIndexesBatchJob | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<RefreshUniqueIndexesBatchJob | null> | null>;
   ...
   */
  get(include?: string | null): RefreshUniqueIndexesBatchJob | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): RefreshUniqueIndexesBatchJob | null;
   ...
   */
  getMissing(spec: GetMissingSpec): RefreshUniqueIndexesBatchJob;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): RefreshUniqueIndexesBatchJob | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): RefreshUniqueIndexesBatchJob;
   ...
   * @see #toString
   */
  static fromString(s: string | null): RefreshUniqueIndexesBatchJob | null;
   ...
   */
  create(spec?: UpsertSpec | null): RefreshUniqueIndexesBatchJob | null;
   ...
   */
  static createBatch(objs: C3.Array<RefreshUniqueIndexesBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<RefreshUniqueIndexesBatchJob | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<RefreshUniqueIndexesBatchJob | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<RefreshUniqueIndexesBatchJob | null> | null;
   ...
   */
  update(srcObj?: RefreshUniqueIndexesBatchJob | null, spec?: UpsertSpec | null): RefreshUniqueIndexesBatchJob | null;
   ...
   */
  upsert(srcObj?: RefreshUniqueIndexesBatchJob | null, spec?: UpsertSpec | null): RefreshUniqueIndexesBatchJob | null;
   ...
   */
  merge(spec?: MergeSpec | null): RefreshUniqueIndexesBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): RefreshUniqueIndexesBatchJob | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): RefreshUniqueIndexesBatchJob | null;
   ...
   */
  static updateBatch(objs: C3.Array<RefreshUniqueIndexesBatchJob | null> | null, srcObjs?: C3.Array<RefreshUniqueIndexesBatchJob | null>, spec?: UpsertSpec | null): ObjList<RefreshUniqueIndexesBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<RefreshUniqueIndexesBatchJob | null>>, spec?: UpsertSpec | null): ObjList<RefreshUniqueIndexesBatchJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<RefreshUniqueIndexesBatchJob | null> | null, srcObjs?: C3.Array<RefreshUniqueIndexesBatchJob | null>, spec?: UpsertSpec | null): ObjList<RefreshUniqueIndexesBatchJob | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<RefreshUniqueIndexesBatchJob | null>>, spec?: UpsertSpec | null): ObjList<RefreshUniqueIndexesBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<RefreshUniqueIndexesBatchJob | null> | null, spec?: TouchSpec | null): ObjList<RefreshUniqueIndexesBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<RefreshUniqueIndexesBatchJob | null> | null, spec?: MergeSpec | null): ObjList<RefreshUniqueIndexesBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<RefreshUniqueIndexesBatchJob | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<RefreshUniqueIndexesBatchJob | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<RefreshUniqueIndexesBatchJob | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<RefreshUniqueIndexesBatchJob | null> | null;
   ...
   */
  static mergeAll(mergeObj: RefreshUniqueIndexesBatchJob | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: RefreshUniqueIndexesBatchJob | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<RefreshUniqueIndexesBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<RefreshUniqueIndexesBatchJob | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<RefreshUniqueIndexesBatchJob | null> | null, spec?: UpsertSpec | null): ObjList<RefreshUniqueIndexesBatchJob | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): RefreshUniqueIndexesBatchJob | null;
   ...
   */
  static beforeCreate(objs: C3.Array<RefreshUniqueIndexesBatchJob | null> | null): ObjList<RefreshUniqueIndexesBatchJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<RefreshUniqueIndexesBatchJob | null> | null): ObjList<RefreshUniqueIndexesBatchJob | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<RefreshUniqueIndexesBatchJob | null> | null): ObjList<RefreshUniqueIndexesBatchJob | null>;
   ...
   */
  static afterCreate(objs: C3.Array<RefreshUniqueIndexesBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<RefreshUniqueIndexesBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<RefreshUniqueIndexesBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<RefreshUniqueIndexesBatchJob | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<RefreshUniqueIndexesBatchJob | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): RefreshUniqueIndexesBatchJob | null;
   ...
   */
  withoutIdentity(): RefreshUniqueIndexesBatchJob | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<RefreshUniqueIndexesBatchJob | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: RefreshUniqueIndexesBatchJob | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<RefreshUniqueIndexesBatchJob | null> | null, callback?: λFunction<RefreshUniqueIndexesBatchJob | null, RefreshUniqueIndexesBatchJob | null> | null): ObjList<RefreshUniqueIndexesBatchJob | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<RefreshUniqueIndexesBatchJob | null> | null, callback?: λFunction<RefreshUniqueIndexesBatchJob | null, RefreshUniqueIndexesBatchJob | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static doStart(job?: RefreshUniqueIndexesBatchJob | null, options?: RefreshUniqueIndexesSpec | null): void;
   ...
   */
  static processBatch(batch?: RefreshUniqueIndexesSpec | null, job?: RefreshUniqueIndexesBatchJob | null, options?: RefreshUniqueIndexesSpec | null): void;
   ...
   */
  static allComplete(job: RefreshUniqueIndexesBatchJob, options?: RefreshUniqueIndexesSpec | null): string | null;
   ...
   *           Options the job was run with.
   */
  static failed(job: RefreshUniqueIndexesBatchJob, status: BatchJobStatus, options?: RefreshUniqueIndexesSpec | null): void;
   ...
   *        Batch to schedule.
   */
  scheduleBatch(batch?: RefreshUniqueIndexesSpec | null): void;
   ...
   *        Batches to schedule.
   */
  scheduleBatches(batches?: C3.Array<RefreshUniqueIndexesSpec | null>): void;
   ...
   */
  static scheduleObjBatch(job?: RefreshUniqueIndexesBatchJob | null, objBatch?: ObjBatch | null, logPrefix?: string | null): number | null;
