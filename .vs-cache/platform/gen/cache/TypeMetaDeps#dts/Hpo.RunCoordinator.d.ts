// TypeScript definitions for the C3 type Hpo.RunCoordinator
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Hpo.RunCoordinator
 */
declare namespace Hpo {
  export interface IRunCoordinator {
 ...
 */
declare namespace Hpo {
  export class RunCoordinator extends Obj {
    ...
    withTypeIdent(typeIdent: string | null): Hpo.RunCoordinator;
     ...
     */
    readonly id: string;
    withId(id: string): Hpo.RunCoordinator;
    ...
    withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Hpo.RunCoordinator;

    /**
     * Name of the Obj instance
     */
    readonly name?: string | null;
    withName(name: string | null): Hpo.RunCoordinator;

    /**
     * Various system fields.
     */
    readonly meta?: Meta | null;
    withMeta(meta: IMeta | null): Hpo.RunCoordinator;
    ...
    withVersion(version: number | null): Hpo.RunCoordinator;

    /**
     * Persists concrete type with bindings for generic types where instance has parameter bindings
     */
    readonly typeWithBindings?: Type | null;
    withTypeWithBindings(typeWithBindings: IType | null): Hpo.RunCoordinator;

    /**
     * {@link JobOptions} for executing this coordinator.
     */
    readonly jobOptions?: JobOptions | null;
    withJobOptions(jobOptions: IJobOptions | null): Hpo.RunCoordinator;

    /**
     * {@link Hpo.Trial} that this coordinator belongs to.
     */
    readonly hpoTrial: Hpo.Trial;
    withHpoTrial(hpoTrial: IHpo.Trial): Hpo.RunCoordinator;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Hpo.RunCoordinator | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Hpo.RunCoordinator | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Hpo.RunCoordinator | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Hpo.RunCoordinator | null;
     ...
     */
    replaceType(old: Type, new_: Type): Hpo.RunCoordinator;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Hpo.RunCoordinator;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Hpo.RunCoordinator;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Hpo.RunCoordinator | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Hpo.RunCoordinator | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Hpo.RunCoordinator;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Hpo.RunCoordinator;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Hpo.RunCoordinator;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Hpo.RunCoordinator;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Hpo.RunCoordinator;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Hpo.RunCoordinator;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Hpo.RunCoordinator;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Hpo.RunCoordinator;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Hpo.RunCoordinator;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Hpo.RunCoordinator;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Hpo.RunCoordinator;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Hpo.RunCoordinator;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Hpo.RunCoordinator;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Hpo.RunCoordinator;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Hpo.RunCoordinator;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Hpo.RunCoordinator;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Hpo.RunCoordinator;
     ...
     * @see #removeField
     */
    unsetField(field: string): Hpo.RunCoordinator;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Hpo.RunCoordinator;
     ...
     * @see #unsetField
     */
    removeField(field: string): Hpo.RunCoordinator;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Hpo.RunCoordinator;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Hpo.RunCoordinator;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Hpo.RunCoordinator;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Hpo.RunCoordinator;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Hpo.RunCoordinator;

    mergeJson(json: any | null): Hpo.RunCoordinator;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Hpo.RunCoordinator;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Hpo.RunCoordinator;
     ...
     */
    singletonArray(): C3.Array<Hpo.RunCoordinator | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Hpo.RunCoordinator | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Hpo.RunCoordinator | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Hpo.RunCoordinator | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Hpo.RunCoordinator | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Hpo.RunCoordinator | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Hpo.RunCoordinator | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Hpo.RunCoordinator | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Hpo.RunCoordinator | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Hpo.RunCoordinator;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Hpo.RunCoordinator;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Hpo.RunCoordinator;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Hpo.RunCoordinator;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Hpo.RunCoordinator;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Hpo.RunCoordinator;
     ...
     * @see #fromString
     */
    static make(s: string | null): Hpo.RunCoordinator | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Hpo.RunCoordinator;
     ...
     */
    static cachedEmptyInst(): Hpo.RunCoordinator;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Hpo.RunCoordinator>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Hpo.RunCoordinator;
     ...
     */
    static fetch(spec?: FetchSpec | null): FetchResult<Hpo.RunCoordinator | null>;
     ...
     * @return Requested objs.
     */
    static fetch(filter: Filter): FetchResult<Hpo.RunCoordinator | null>;
     ...
     */
    static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Hpo.RunCoordinator | null>;
     ...
     */
    static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Hpo.RunCoordinator | null> | null>;
     ...
     */
    get(include?: string | null): Hpo.RunCoordinator | null;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getSpecific(include?: string | null): Hpo.RunCoordinator | null;
     ...
     */
    getMissing(spec: GetMissingSpec): Hpo.RunCoordinator;
     ...
     *         those fields will be returned. Otherwise the entire obj will be returned.
     */
    getDirect(include?: string | null): Hpo.RunCoordinator | null;
     ...
     */
    applyReverseEdit(versionEdit: VersionEdit): Hpo.RunCoordinator;
     ...
     * @see #toString
     */
    static fromString(s: string | null): Hpo.RunCoordinator | null;
     ...
     */
    create(spec?: UpsertSpec | null): Hpo.RunCoordinator | null;
     ...
     */
    static createBatch(objs: C3.Array<Hpo.RunCoordinator | null> | null, spec?: UpsertSpec | null): ObjList<Hpo.RunCoordinator | null> | null;
     ...
     */
    static createBatchObjStream(objs: Stream<Hpo.RunCoordinator | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Hpo.RunCoordinator | null> | null;
     ...
     */
    update(srcObj?: Hpo.RunCoordinator | null, spec?: UpsertSpec | null): Hpo.RunCoordinator | null;
     ...
     */
    upsert(srcObj?: Hpo.RunCoordinator | null, spec?: UpsertSpec | null): Hpo.RunCoordinator | null;
     ...
     */
    merge(spec?: MergeSpec | null): Hpo.RunCoordinator | null;
     ...
     * @return The created or updated obj.
     */
    merge(mergeInclude: string, spec?: MergeSpec | null): Hpo.RunCoordinator | null;
     ...
     * @return The created or updated obj.
     */
    touch(spec?: TouchSpec | null): Hpo.RunCoordinator | null;
     ...
     */
    static updateBatch(objs: C3.Array<Hpo.RunCoordinator | null> | null, srcObjs?: C3.Array<Hpo.RunCoordinator | null>, spec?: UpsertSpec | null): ObjList<Hpo.RunCoordinator | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static updateObjs(objs: λSupplier<C3.Array<Hpo.RunCoordinator | null>>, spec?: UpsertSpec | null): ObjList<Hpo.RunCoordinator | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertBatch(objs: C3.Array<Hpo.RunCoordinator | null> | null, srcObjs?: C3.Array<Hpo.RunCoordinator | null>, spec?: UpsertSpec | null): ObjList<Hpo.RunCoordinator | null> | null;
     ...
     *         fields populated. Otherwise only the id field will be populated.
     */
    static upsertObjs(objs: λSupplier<C3.Array<Hpo.RunCoordinator | null>>, spec?: UpsertSpec | null): ObjList<Hpo.RunCoordinator | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static touchBatch(objs: C3.Array<Hpo.RunCoordinator | null> | null, spec?: TouchSpec | null): ObjList<Hpo.RunCoordinator | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<Hpo.RunCoordinator | null> | null, spec?: MergeSpec | null): ObjList<Hpo.RunCoordinator | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeBatch(objs: C3.Array<Hpo.RunCoordinator | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Hpo.RunCoordinator | null> | null;
     ...
     * @see Mergespec#csvInclude
     */
    static mergeObjs(objs: λSupplier<C3.Array<Hpo.RunCoordinator | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Hpo.RunCoordinator | null> | null;
     ...
     */
    static mergeAll(mergeObj: Hpo.RunCoordinator | null, spec?: MergeAllSpec | null): number | null;
     ...
     * @return The number of objs that were merged.
     */
    static mergeAll(mergeObj: Hpo.RunCoordinator | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
     ...
     * @see Ann.Db#archive
     */
    static removeBatch(objs: C3.Array<Hpo.RunCoordinator | null> | null, spec?: UpsertSpec | null): ObjList<Hpo.RunCoordinator | null> | null;
     ...
     *         populated. Otherwise only the id field will be populated.
     */
    static replace(objs: C3.Array<Hpo.RunCoordinator | null> | null, spec?: UpsertSpec | null): ObjList<Hpo.RunCoordinator | null> | null;
     ...
     * @see Ann.Db#archive
     */
    unremove(): Hpo.RunCoordinator | null;
     ...
     */
    static beforeCreate(objs: C3.Array<Hpo.RunCoordinator | null> | null): ObjList<Hpo.RunCoordinator | null>;
     ...
     *         of objs must match the input.
     */
    static beforeUpdate(objs: C3.Array<Hpo.RunCoordinator | null> | null): ObjList<Hpo.RunCoordinator | null>;
     ...
     *         of objs must match the input.
     */
    static beforeRemove(objs: C3.Array<Hpo.RunCoordinator | null> | null): ObjList<Hpo.RunCoordinator | null>;
     ...
     */
    static afterCreate(objs: C3.Array<Hpo.RunCoordinator | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterUpdate(objs: C3.Array<Hpo.RunCoordinator | null> | null): C3.Array<ObjError | null>;
     ...
     * @return List of any errors that were encountered.
     */
    static afterRemove(objs: C3.Array<Hpo.RunCoordinator | null> | null): C3.Array<ObjError | null>;
     ...
     */
    static startImportData(spec?: StartImportDataSpec | null): PushStream<Hpo.RunCoordinator | null>;

    /**
     * @return a push stream to import instances of this type.
     */
    static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Hpo.RunCoordinator | null>;
     ...
     */
    static forId(id: string | null, failIfMissing?: boolean): Hpo.RunCoordinator | null;
     ...
     */
    withoutIdentity(): Hpo.RunCoordinator | null;
     ...
     */
    static typeOfBatch(objs: C3.Array<Hpo.RunCoordinator | null> | null): C3.Array<EntityType | null>;
     ...
     */
    static dbEcho(template?: Hpo.RunCoordinator | null, count?: number | null, sendBack?: boolean): number | null;
     ...
     */
    static callbackLogic(objs: C3.Array<Hpo.RunCoordinator | null> | null, callback?: λFunction<Hpo.RunCoordinator | null, Hpo.RunCoordinator | null> | null): ObjList<Hpo.RunCoordinator | null>;

    /**
     * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
     * calling a transform for it.
     */
    static afterCallbackLogic(objs: C3.Array<Hpo.RunCoordinator | null> | null, callback?: λFunction<Hpo.RunCoordinator | null, Hpo.RunCoordinator | null> | null): C3.Array<ObjError | null>;
     ...
     */
    generateNextResults(completed?: Stream<Hpo.Run | null>): number;
     ...
     */
    startResult(result: Hpo.Run): Hpo.Run;
     ...
     */
    afterStart(results: Stream<Hpo.Run | null> | null): Stream<Hpo.Run | null> | null;
     ...
     * @return the result instance, as acknowledgement, even if unmodified.
     */
    completeResult(result: Hpo.Run): Hpo.Run;
     ...
     */
    updateRunningResults(spec?: FetchStreamSpec | null): Stream<Hpo.Run | null> | null;
     ...
     */
    afterComplete(results: Stream<Hpo.Run | null> | null): Stream<Hpo.Run | null> | null;
     ...
     */
    runFromResult(result: Hpo.Run): WorkflowExecutorRun | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    pendingResults(spec?: FetchStreamSpec | null): Stream<Hpo.Run | null> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    runningResults(spec?: FetchStreamSpec | null): Stream<Hpo.Run | null> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    completedResults(spec?: FetchStreamSpec | null): Stream<Hpo.Run | null> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    canceledResults(spec?: FetchStreamSpec | null): Stream<Hpo.Run | null> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    erroredResults(spec?: FetchStreamSpec | null): Stream<Hpo.Run | null> | null;
     ...
     *    Optional {@link FetchStreamSpec} for customizing fetching of RT objects.
     */
    allResults(spec?: FetchStreamSpec | null): Stream<Hpo.Run | null> | null;
     ...
     */
    customSummaryFieldsForResult(result: Hpo.Run): C3.Map<string | null, any>;
     ...
     * @return a table with a row for each step and the corresponding execution metadata.
     */
    summaryForResults(results: C3.Array<Hpo.Run | null> | null, spec?: Workflow.Monitorable.SummarySpec | null): Data;
     ...
     * @return a table with a row for each step and the corresponding execution metadata.
     */
    summaryForResultsPd(results: C3.Array<Hpo.Run | null> | null, spec?: Workflow.Monitorable.SummarySpec | null): any;
     ...
     */
    resultsForSummary(spec?: FetchSpec | null): FetchResult<Hpo.Run | null> | null;
  }
}
