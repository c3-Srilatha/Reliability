// TypeScript definitions for the C3 type Data.CategoricalIndex

/**
 * Abstract interface representing the pandas CategoricalIndex class.
 *
 * @remarks this represents a value passed to a method that expects an instance of Data.CategoricalIndex
 */
declare namespace Data {
  export interface ICategoricalIndex {
  }
}
 ...
 */
declare namespace Data {
  export class CategoricalIndex extends Obj {
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.CategoricalIndex | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.CategoricalIndex | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.CategoricalIndex | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.CategoricalIndex | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.CategoricalIndex;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.CategoricalIndex;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.CategoricalIndex;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.CategoricalIndex | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.CategoricalIndex | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.CategoricalIndex;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.CategoricalIndex;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.CategoricalIndex;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.CategoricalIndex;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.CategoricalIndex;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.CategoricalIndex;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.CategoricalIndex;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.CategoricalIndex;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.CategoricalIndex;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.CategoricalIndex;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.CategoricalIndex;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.CategoricalIndex;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.CategoricalIndex;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.CategoricalIndex;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.CategoricalIndex;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.CategoricalIndex;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.CategoricalIndex;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.CategoricalIndex;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.CategoricalIndex;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.CategoricalIndex;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.CategoricalIndex;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.CategoricalIndex;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.CategoricalIndex;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.CategoricalIndex;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.CategoricalIndex;

    mergeJson(json: any | null): Data.CategoricalIndex;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.CategoricalIndex;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.CategoricalIndex;
     ...
     */
    singletonArray(): C3.Array<Data.CategoricalIndex | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.CategoricalIndex | null>;
     ...
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.CategoricalIndex | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.CategoricalIndex | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.CategoricalIndex | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.CategoricalIndex | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.CategoricalIndex | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.CategoricalIndex | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.CategoricalIndex | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.CategoricalIndex;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.CategoricalIndex;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.CategoricalIndex;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.CategoricalIndex;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.CategoricalIndex;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.CategoricalIndex;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.CategoricalIndex;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Data.CategoricalIndex;
     ...
     */
    static cachedEmptyInst(): Data.CategoricalIndex;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.CategoricalIndex>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.CategoricalIndex;
     ...
     */
    static fromPySrc(pySrc: string, dfs?: C3.Set<DataImpl | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): Data.CategoricalIndex | null;
     ...
     */
    static _jsDataProxy(inst: any): Data.CategoricalIndex;
