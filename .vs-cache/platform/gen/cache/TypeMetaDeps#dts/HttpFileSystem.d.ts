// TypeScript definitions for the C3 type HttpFileSystem

/**
 * Represents a HTTP based file system.
 *
 * @remarks this represents a value passed to a method that expects an instance of HttpFileSystem
 */
declare interface IHttpFileSystem {
 ...
 * Represents a HTTP based file system.
 *
 * @remarks this represents a made instance of HttpFileSystem
 */
declare class HttpFileSystem extends Obj {

  /**
   * Optional root OS folder to limit access to files.
   */
  readonly root?: string | null;
  withRoot(root: string | null): HttpFileSystem;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): HttpFileSystem | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): HttpFileSystem | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): HttpFileSystem | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): HttpFileSystem | null;
   ...
   */
  replaceType(old: Type, new_: Type): HttpFileSystem;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): HttpFileSystem;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HttpFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HttpFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HttpFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): HttpFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HttpFileSystem | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HttpFileSystem | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HttpFileSystem | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<HttpFileSystem | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): HttpFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): HttpFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HttpFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HttpFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HttpFileSystem;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): HttpFileSystem;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): HttpFileSystem;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): HttpFileSystem;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): HttpFileSystem;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): HttpFileSystem;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): HttpFileSystem;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): HttpFileSystem;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): HttpFileSystem;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): HttpFileSystem;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): HttpFileSystem;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): HttpFileSystem;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): HttpFileSystem;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): HttpFileSystem;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): HttpFileSystem;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): HttpFileSystem;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): HttpFileSystem;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): HttpFileSystem;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): HttpFileSystem;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): HttpFileSystem;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): HttpFileSystem;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): HttpFileSystem;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): HttpFileSystem;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): HttpFileSystem;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): HttpFileSystem;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): HttpFileSystem;
   ...
   * @see #unsetField
   */
  defaultField(field: string): HttpFileSystem;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): HttpFileSystem;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): HttpFileSystem;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): HttpFileSystem;
   ...
   * @see #removeField
   */
  unsetField(field: string): HttpFileSystem;
   ...
   * @see #removeField
   */
  static unsetField(field: string): HttpFileSystem;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): HttpFileSystem;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): HttpFileSystem;
   ...
   * @see #unsetField
   */
  removeField(field: string): HttpFileSystem;
   ...
   * @see #unsetField
   */
  static removeField(field: string): HttpFileSystem;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): HttpFileSystem;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): HttpFileSystem;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): HttpFileSystem;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): HttpFileSystem;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): HttpFileSystem;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): HttpFileSystem;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): HttpFileSystem;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): HttpFileSystem;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): HttpFileSystem;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): HttpFileSystem;

  mergeJson(json: any | null): HttpFileSystem;

  static mergeJson(json: any | null): HttpFileSystem;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): HttpFileSystem;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): HttpFileSystem;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): HttpFileSystem;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): HttpFileSystem;
   ...
   */
  singletonArray(): C3.Array<HttpFileSystem | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<HttpFileSystem | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<HttpFileSystem | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<HttpFileSystem | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<HttpFileSystem | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<HttpFileSystem | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<HttpFileSystem | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, HttpFileSystem | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, HttpFileSystem | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<HttpFileSystem | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<HttpFileSystem | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<HttpFileSystem | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): HttpFileSystem;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): HttpFileSystem;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): HttpFileSystem;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): HttpFileSystem;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): HttpFileSystem;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): HttpFileSystem;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): HttpFileSystem;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): HttpFileSystem;
   ...
   */
  static cachedEmptyInst(): HttpFileSystem;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<HttpFileSystem>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): HttpFileSystem;
