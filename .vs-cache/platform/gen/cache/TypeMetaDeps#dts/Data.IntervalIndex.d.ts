// TypeScript definitions for the C3 type Data.IntervalIndex

/**
 * Abstract interface representing the pandas IntervalIndex class.
 *
 * @remarks this represents a value passed to a method that expects an instance of Data.IntervalIndex
 */
declare namespace Data {
  export interface IIntervalIndex {
  }
}
 ...
 */
declare namespace Data {
  export class IntervalIndex extends Obj {
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.IntervalIndex | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.IntervalIndex | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.IntervalIndex | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.IntervalIndex | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.IntervalIndex;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.IntervalIndex;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.IntervalIndex;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.IntervalIndex | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.IntervalIndex | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.IntervalIndex;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.IntervalIndex;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.IntervalIndex;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.IntervalIndex;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.IntervalIndex;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.IntervalIndex;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.IntervalIndex;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.IntervalIndex;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.IntervalIndex;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.IntervalIndex;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.IntervalIndex;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.IntervalIndex;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.IntervalIndex;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.IntervalIndex;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.IntervalIndex;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.IntervalIndex;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.IntervalIndex;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.IntervalIndex;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.IntervalIndex;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.IntervalIndex;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.IntervalIndex;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.IntervalIndex;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.IntervalIndex;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.IntervalIndex;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.IntervalIndex;

    mergeJson(json: any | null): Data.IntervalIndex;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.IntervalIndex;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.IntervalIndex;
     ...
     */
    singletonArray(): C3.Array<Data.IntervalIndex | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.IntervalIndex | null>;
     ...
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.IntervalIndex | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.IntervalIndex | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.IntervalIndex | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.IntervalIndex | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.IntervalIndex | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.IntervalIndex | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.IntervalIndex | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.IntervalIndex;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.IntervalIndex;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.IntervalIndex;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.IntervalIndex;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.IntervalIndex;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.IntervalIndex;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.IntervalIndex;
     ...
     */
    static cachedEmptyInst(): Data.IntervalIndex;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.IntervalIndex>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.IntervalIndex;
     ...
     */
    static fromPySrc(pySrc: string, dfs?: C3.Set<DataImpl | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): Data.IntervalIndex | null;
     ...
     */
    static _jsDataProxy(inst: any): Data.IntervalIndex;
