// TypeScript definitions for the C3 type OldImageWithInfo

/**
 * @remarks this represents a value passed to a method that expects an instance of OldImageWithInfo
 */
declare interface IOldImageWithInfo<I> {
 ...
 */
declare class OldImageWithInfo<I> extends Obj {
  ...
  withWidth(width: number | null): OldImageWithInfo;
  ...
  withHeight(height: number | null): OldImageWithInfo;
  ...
  withContentLocation(contentLocation: string | null): OldImageWithInfo;
  ...
  withContentEncoding(contentEncoding: string | null): OldImageWithInfo;
  ...
  withContentLanguage(contentLanguage: string | null): OldImageWithInfo;
  ...
  withContentLength(contentLength: number | null): OldImageWithInfo;
  ...
  withContentType(contentType: string | null): OldImageWithInfo;
  ...
  withContentDisposition(contentDisposition: string | null): OldImageWithInfo;
  ...
  withETag(eTag: string | null): OldImageWithInfo;
  ...
  withLastModified(lastModified: DateTime | Date | string | null): OldImageWithInfo;

  /**
   * Id of user / identity who last last modified this content.
   */
  readonly lastModifiedBy?: string | null;
  withLastModifiedBy(lastModifiedBy: string | null): OldImageWithInfo;
  ...
  withContentMD5(contentMD5: string | null): OldImageWithInfo;
  ...
  withContentSHA1(contentSHA1: string | null): OldImageWithInfo;

  /**
   * Field to maintain state whether content metadata was read or not.
   */
  readonly hasMetadata?: boolean;
  withHasMetadata(hasMetadata: boolean): OldImageWithInfo;

  /**
   * The actual content value.
   */
  readonly content?: any | null;
  withContent(content: any | null): OldImageWithInfo;

  readonly info?: I | null;
  withInfo(info: I | null): OldImageWithInfo;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): OldImageWithInfo<I> | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): OldImageWithInfo<I> | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): OldImageWithInfo<I> | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): OldImageWithInfo<I> | null;
   ...
   */
  replaceType(old: Type, new_: Type): OldImageWithInfo<I>;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): OldImageWithInfo<I>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): OldImageWithInfo<I>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<OldImageWithInfo<I> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<OldImageWithInfo<I> | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): OldImageWithInfo<I>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): OldImageWithInfo<I>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): OldImageWithInfo<I>;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): OldImageWithInfo<I>;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): OldImageWithInfo<I>;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): OldImageWithInfo<I>;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): OldImageWithInfo<I>;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): OldImageWithInfo<I>;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): OldImageWithInfo<I>;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): OldImageWithInfo<I>;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): OldImageWithInfo<I>;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): OldImageWithInfo<I>;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): OldImageWithInfo<I>;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): OldImageWithInfo<I>;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): OldImageWithInfo<I>;
   ...
   * @see #unsetField
   */
  defaultField(field: string): OldImageWithInfo<I>;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): OldImageWithInfo<I>;
   ...
   * @see #removeField
   */
  unsetField(field: string): OldImageWithInfo<I>;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): OldImageWithInfo<I>;
   ...
   * @see #unsetField
   */
  removeField(field: string): OldImageWithInfo<I>;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): OldImageWithInfo<I>;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): OldImageWithInfo<I>;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): OldImageWithInfo<I>;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): OldImageWithInfo<I>;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): OldImageWithInfo<I>;

  mergeJson(json: any | null): OldImageWithInfo<I>;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): OldImageWithInfo<I>;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): OldImageWithInfo<I>;
   ...
   */
  singletonArray(): C3.Array<OldImageWithInfo<I> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<OldImageWithInfo<I> | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<OldImageWithInfo<I> | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<OldImageWithInfo<I> | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<OldImageWithInfo<I> | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, OldImageWithInfo<I> | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, OldImageWithInfo<I> | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<OldImageWithInfo<I> | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<OldImageWithInfo<I> | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): OldImageWithInfo<I>;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): OldImageWithInfo<I>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): OldImageWithInfo<I>;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): OldImageWithInfo<I>;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): OldImageWithInfo<I>;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): OldImageWithInfo<I>;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): OldImageWithInfo<I>;
   ...
   */
  static cachedEmptyInst(): OldImageWithInfo<I>;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<OldImageWithInfo<I>>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): OldImageWithInfo<I>;
   ...
   */
  readMediaMetadata(): OldImageWithInfo<I>;

  /**
   * @return instance of the Visual Media from provided content and optionally reads metadata
   */
  static fromContent(content: Content, readMetadata?: boolean): OldImageWithInfo<I>;
   ...
   */
  static fromRawBinary(data: any, contentType?: string | null, width?: number | null, height?: number | null): OldImageWithInfo<I>;
   ...
   */
  static fromBase64String(data: string, contentType?: string | null, width?: number | null, height?: number | null): OldImageWithInfo<I>;
   ...
   */
  withRawBinary(data: any, contentType?: string | null, width?: number | null, height?: number | null): OldImageWithInfo<I>;
   ...
   */
  withBase64String(data: string, contentType?: string | null, width?: number | null, height?: number | null): OldImageWithInfo<I>;
   ...
   */
  withFileName(fileName: string | null): OldImageWithInfo<I>;

  /**
   * Changes file extension in this instance.
   */
  withFileExt(fileExt: string | null): OldImageWithInfo<I>;
   ...
   */
  identify(suffix?: string | null): OldImageWithInfo<I>;
   ...
   */
  readMetadata(spec?: FileOperationSpec | null): OldImageWithInfo<I>;
   ...
   */
  refreshMetadata(spec?: FileOperationSpec | null): OldImageWithInfo<I>;
   ...
   * @return abstract content with metadata.
   */
  guessMetadata(spec?: FileOperationSpec | null): OldImageWithInfo<I>;

  /**
   * Clears the content metadata; e.g. if it's known to be invalid.
   */
  clearMetadata(): OldImageWithInfo<I>;

  /**
   * @return clone of this content with metadata from provided input.
   */
  withMetadata(meta?: ContentMeta | null): OldImageWithInfo<I>;
   ...
   */
  encodedPushStream(spec?: FileOperationSpec | null): Pair<OldImageWithInfo<I> | null, BytePushStream | null>;

  /**
   * @return byte push stream to be used for writing un-encoded data into this content object.
   */
  pushStream(spec?: FileOperationSpec | null): Pair<OldImageWithInfo<I> | null, BytePushStream | null>;

  /**
   * @return character push stream to be used for writing un-encoded data into this content object.
   */
  charPushStream(spec?: FileOperationSpec | null): Pair<OldImageWithInfo<I> | null, CharPushStream | null>;
   ...
   */
  encodedStream(spec?: FileOperationSpec | null): Pair<OldImageWithInfo<I> | null, ByteStream | null> | null;
   ...
   */
  writeStream(content: ByteStream | null, spec?: FileOperationSpec | null): OldImageWithInfo<I>;

  /**
   * Truncates file and replaces it's content with provided binary content.
   */
  writeInputStream(inputStream: any, spec?: FileOperationSpec | null): OldImageWithInfo<I>;

  /**
   * Truncates file and replaces its content with provided binary content from zipInputStream
   */
  writeZipInputStream(zipInputStream: any, spec?: FileOperationSpec | null): OldImageWithInfo<I>;
   ...
   */
  writeEncodedStream(encodedContent: ByteStream | null, spec?: FileOperationSpec | null): OldImageWithInfo<I>;

  /**
   * Truncates file and replaces it's encoded content with provided binary content.
   */
  writeEncodedInputStream(inputStream: any, spec?: FileOperationSpec | null): OldImageWithInfo<I>;
   ...
   *           content that needs to be written
   */
  write(content: any | null, spec?: FileOperationSpec | null): OldImageWithInfo<I>;
   ...
   *           encoded content that needs to be written
   */
  writeEncoded(encodedContent: any | null, spec?: FileOperationSpec | null): OldImageWithInfo<I>;
   ...
   *           content that needs to be written
   */
  writeString(content: string | null, spec?: FileOperationSpec | null): OldImageWithInfo<I>;
   ...
   */
  writeObj(obj: Obj | null, spec?: FileObjsOperSpec | null): OldImageWithInfo<I>;
   ...
   * @return pair of update instance of this content and number of objs written
   */
  startWriteObjs(spec?: FileObjsOperSpec | null): Pair<OldImageWithInfo<I> | null, PushStream<Obj | null> | null>;
   ...
   */
  compress(contentEncoding?: string | null, spec?: FileCompressSpec | null): OldImageWithInfo<I>;

  /**
   * Uncompresses content.
   */
  uncompress(spec?: FileCompressSpec | null): OldImageWithInfo<I>;
   ...
   */
  transcode(contentType: string, contentEncoding: string, spec?: FileCompressSpec | null): OldImageWithInfo<I>;

  /**
   * Copies content to a given target.
   */
  copyContentTo(target: OldImageWithInfo<I>, spec?: FileOperationSpec | null): void;
   ...
   */
  concat(other: Content | null): OldImageWithInfo<I>;

  /**
   * Creates a new Content by merging the incoming binary data with current content
   */
  concat(other: any | null): OldImageWithInfo<I>;
