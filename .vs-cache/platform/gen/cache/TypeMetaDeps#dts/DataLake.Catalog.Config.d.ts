// TypeScript definitions for the C3 type DataLake.Catalog.Config

/**
 * @remarks this represents a value passed to a method that expects an instance of DataLake.Catalog.Config
 */
...
declare namespace DataLake.Catalog {
  export class Config extends Obj {
    ...
    withConfigOverride(configOverride: string | null): DataLake.Catalog.Config;

    readonly secretOverride?: string | null;
    withSecretOverride(secretOverride: string | null): DataLake.Catalog.Config;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: C3.Array<string | null>;
    withIssues(issues: C3.Array<string | null> | Array<string | null>): DataLake.Catalog.Config;

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): DataLake.Catalog.Config;

    /**
     * Specifies table meta-fields which will be recorded for each table in Catalog.
     */
    readonly metaFields?: C3.Array<DataLake.Table.MetaField | null>;
    withMetaFields(metaFields: C3.Array<DataLake.Table.MetaField | null> | Array<IDataLake.Table.MetaField | null>): DataLake.Catalog.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): DataLake.Catalog.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): DataLake.Catalog.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): DataLake.Catalog.Config | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): DataLake.Catalog.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): DataLake.Catalog.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataLake.Catalog.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataLake.Catalog.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataLake.Catalog.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataLake.Catalog.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataLake.Catalog.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataLake.Catalog.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataLake.Catalog.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): DataLake.Catalog.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): DataLake.Catalog.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): DataLake.Catalog.Config;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataLake.Catalog.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataLake.Catalog.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): DataLake.Catalog.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): DataLake.Catalog.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): DataLake.Catalog.Config;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): DataLake.Catalog.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataLake.Catalog.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): DataLake.Catalog.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataLake.Catalog.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): DataLake.Catalog.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): DataLake.Catalog.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): DataLake.Catalog.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): DataLake.Catalog.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): DataLake.Catalog.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): DataLake.Catalog.Config;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataLake.Catalog.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): DataLake.Catalog.Config;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataLake.Catalog.Config;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataLake.Catalog.Config;

    mergeJson(json: any | null): DataLake.Catalog.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataLake.Catalog.Config;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): DataLake.Catalog.Config;
     ...
     */
    singletonArray(): C3.Array<DataLake.Catalog.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<DataLake.Catalog.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<DataLake.Catalog.Config | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<DataLake.Catalog.Config | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<DataLake.Catalog.Config | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, DataLake.Catalog.Config | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataLake.Catalog.Config | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<DataLake.Catalog.Config | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<DataLake.Catalog.Config | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DataLake.Catalog.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DataLake.Catalog.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DataLake.Catalog.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): DataLake.Catalog.Config;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DataLake.Catalog.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): DataLake.Catalog.Config;
     ...
     * @see #fromString
     */
    static make(s: string | null): DataLake.Catalog.Config | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DataLake.Catalog.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): DataLake.Catalog.Config;
     ...
     */
    static cachedEmptyInst(): DataLake.Catalog.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DataLake.Catalog.Config>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): DataLake.Catalog.Config;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<DataLake.Catalog.Config | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<DataLake.Catalog.Config | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<DataLake.Catalog.Config | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): DataLake.Catalog.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string | null): DataLake.Catalog.Config | null;
     ...
     * @see findByCacheKey
     */
    getCached(): DataLake.Catalog.Config | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): DataLake.Catalog.Config | null;
     ...
     */
    static produce(key: string): DataLake.Catalog.Config | null;
     ...
     */
    static produceAll(): C3.Map<string | null, DataLake.Catalog.Config | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, DataLake.Catalog.Config | null>;
     ...
     */
    getConfig(): DataLake.Catalog.Config;
     ...
     */
    getSecret(): DataLake.Catalog.Config;
     ...
     */
    static forConfigKey(configKey: string | null): DataLake.Catalog.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<DataLake.Catalog.Config | null>;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: DataLake.Catalog.Config, override?: string | null): void;
     ...
     * @see setSecretValue
     */
    setSecretValues(from: DataLake.Catalog.Config, override?: string | null): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): DataLake.Catalog.Config | null;
     ...
     * @see #toString
     */
    static fromString(s: string | null): DataLake.Catalog.Config | null;
     ...
     */
    static forName(name: string | null, failIfMissing?: boolean): DataLake.Catalog.Config | null;
