// TypeScript definitions for the C3 type TargetStageKey

/**
 * @remarks this represents a value passed to a method that expects an instance of TargetStageKey
 */
declare interface ITargetStageKey {
...
/**
 * @remarks this represents a made instance of TargetStageKey
 */
declare class TargetStageKey extends Obj {

  /**
   * Partition key Bin separator used to separate partition key from bin id
   */
  readonly PK_BIN_SEPARATOR?: string | null;
  withPK_BIN_SEPARATOR(PK_BIN_SEPARATOR: string | null): TargetStageKey;
   ...
   */
  readonly id: string;
  withId(id: string): TargetStageKey;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): TargetStageKey;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): TargetStageKey;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): TargetStageKey;
  ...
  withVersion(version: number | null): TargetStageKey;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): TargetStageKey;

  readonly objId: string;
  withObjId(objId: string): TargetStageKey;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): TargetStageKey | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): TargetStageKey | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): TargetStageKey | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): TargetStageKey | null;
   ...
   */
  replaceType(old: Type, new_: Type): TargetStageKey;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TargetStageKey;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TargetStageKey;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TargetStageKey | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TargetStageKey | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TargetStageKey;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TargetStageKey;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TargetStageKey;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): TargetStageKey;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): TargetStageKey;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): TargetStageKey;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TargetStageKey;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TargetStageKey;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): TargetStageKey;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): TargetStageKey;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): TargetStageKey;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): TargetStageKey;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TargetStageKey;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): TargetStageKey;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TargetStageKey;
   ...
   * @see #unsetField
   */
  defaultField(field: string): TargetStageKey;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): TargetStageKey;
   ...
   * @see #removeField
   */
  unsetField(field: string): TargetStageKey;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): TargetStageKey;
   ...
   * @see #unsetField
   */
  removeField(field: string): TargetStageKey;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): TargetStageKey;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TargetStageKey;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): TargetStageKey;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TargetStageKey;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TargetStageKey;

  mergeJson(json: any | null): TargetStageKey;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TargetStageKey;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): TargetStageKey;
   ...
   */
  singletonArray(): C3.Array<TargetStageKey | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<TargetStageKey | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<TargetStageKey | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<TargetStageKey | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<TargetStageKey | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, TargetStageKey | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, TargetStageKey | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<TargetStageKey | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<TargetStageKey | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TargetStageKey;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TargetStageKey;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TargetStageKey;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): TargetStageKey;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TargetStageKey;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): TargetStageKey;
   ...
   * @see #fromString
   */
  static make(s: string | null): TargetStageKey | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TargetStageKey;
   ...
   */
  static cachedEmptyInst(): TargetStageKey;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TargetStageKey>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): TargetStageKey;
   ...
   */
  static partition(objs?: Stream<TargetStageKey | null>, spec?: PartitionBucketStrategy | null): C3.Map<string | null, KvDataPartition | null>;
   ...
   */
  static fromPartitions(partitions?: Stream<KvDataPartition | null>): Stream<TargetStageKey | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<TargetStageKey | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<TargetStageKey | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<TargetStageKey | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<TargetStageKey | null> | null>;
   ...
   */
  get(include?: string | null): TargetStageKey | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): TargetStageKey | null;
   ...
   */
  getMissing(spec: GetMissingSpec): TargetStageKey;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): TargetStageKey | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): TargetStageKey;
   ...
   * @see #toString
   */
  static fromString(s: string | null): TargetStageKey | null;
   ...
   */
  create(spec?: UpsertSpec | null): TargetStageKey | null;
   ...
   */
  static createBatch(objs: C3.Array<TargetStageKey | null> | null, spec?: UpsertSpec | null): ObjList<TargetStageKey | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<TargetStageKey | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<TargetStageKey | null> | null;
   ...
   */
  update(srcObj?: TargetStageKey | null, spec?: UpsertSpec | null): TargetStageKey | null;
   ...
   */
  upsert(srcObj?: TargetStageKey | null, spec?: UpsertSpec | null): TargetStageKey | null;
   ...
   */
  merge(spec?: MergeSpec | null): TargetStageKey | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): TargetStageKey | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): TargetStageKey | null;
   ...
   */
  static updateBatch(objs: C3.Array<TargetStageKey | null> | null, srcObjs?: C3.Array<TargetStageKey | null>, spec?: UpsertSpec | null): ObjList<TargetStageKey | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<TargetStageKey | null>>, spec?: UpsertSpec | null): ObjList<TargetStageKey | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<TargetStageKey | null> | null, srcObjs?: C3.Array<TargetStageKey | null>, spec?: UpsertSpec | null): ObjList<TargetStageKey | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<TargetStageKey | null>>, spec?: UpsertSpec | null): ObjList<TargetStageKey | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<TargetStageKey | null> | null, spec?: TouchSpec | null): ObjList<TargetStageKey | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TargetStageKey | null> | null, spec?: MergeSpec | null): ObjList<TargetStageKey | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<TargetStageKey | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<TargetStageKey | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<TargetStageKey | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<TargetStageKey | null> | null;
   ...
   */
  static mergeAll(mergeObj: TargetStageKey | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: TargetStageKey | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<TargetStageKey | null> | null, spec?: UpsertSpec | null): ObjList<TargetStageKey | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<TargetStageKey | null> | null, spec?: UpsertSpec | null): ObjList<TargetStageKey | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<TargetStageKey | null> | null): ObjList<TargetStageKey | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<TargetStageKey | null> | null): ObjList<TargetStageKey | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<TargetStageKey | null> | null): ObjList<TargetStageKey | null>;
   ...
   */
  static afterCreate(objs: C3.Array<TargetStageKey | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<TargetStageKey | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<TargetStageKey | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<TargetStageKey | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<TargetStageKey | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): TargetStageKey | null;
   ...
   */
  withoutIdentity(): TargetStageKey | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<TargetStageKey | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: TargetStageKey | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<TargetStageKey | null> | null, callback?: λFunction<TargetStageKey | null, TargetStageKey | null> | null): ObjList<TargetStageKey | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<TargetStageKey | null> | null, callback?: λFunction<TargetStageKey | null, TargetStageKey | null> | null): C3.Array<ObjError | null>;
