// TypeScript definitions for the C3 type Data.CategoricalIndex.Pandas

/**
 * C3 Interface to a {@link Data.CategoricalIndex} backed by native pandas
 *
 * @remarks this represents a value passed to a method that expects an instance of Data.CategoricalIndex.Pandas
 */
declare namespace Data.CategoricalIndex {
...
declare namespace Data.CategoricalIndex {
  export class Pandas extends Obj {
     ...
     */
    readonly ds: Dataset;
    withDs(ds: IDataset): Data.CategoricalIndex.Pandas;

    /**
     * Id used to reference this Data within the Dataset to which it belongs
     */
    readonly id: string;
    withId(id: string): Data.CategoricalIndex.Pandas;

    /**
     * PySrc that can be executed to re-create this DataImpl.Pandas
     */
    readonly _pySrc?: string | null;
    with_pySrc(_pySrc: string | null): Data.CategoricalIndex.Pandas;

    readonly _fileName?: string | null;
    with_fileName(_fileName: string | null): Data.CategoricalIndex.Pandas;

    /**
     * Tuple of {columnName:[value]} to create a DataImpl.Pandas from
     */
    readonly _tuple?: any;
    with_tuple(_tuple: any): Data.CategoricalIndex.Pandas;

    /**
     * Whether the {@link #tuple} field value types can be fully supported by arrow.
     */
    readonly _arrowSupport?: boolean;
    with_arrowSupport(_arrowSupport: boolean): Data.CategoricalIndex.Pandas;

    /**
     * All DataImpl.Pandas referenced by the pySrc
     */
    readonly _datas?: C3.Set<DataImpl.Pandas | null>;
    with_datas(_datas: C3.Set<DataImpl.Pandas | null> | Array<IDataImpl.Pandas | null>): Data.CategoricalIndex.Pandas;

    /**
     * Pickled Pandas binary
     */
    readonly _binary?: any | null;
    with_binary(_binary: any | null): Data.CategoricalIndex.Pandas;

    /**
     * List of pickled Pandas segments binaries
     */
    readonly _binaries?: C3.Array<any | null>;
    with_binaries(_binaries: C3.Array<any | null> | Array<any | null>): Data.CategoricalIndex.Pandas;

    readonly _numBinarySegments?: number | null;
    with_numBinarySegments(_numBinarySegments: number | null): Data.CategoricalIndex.Pandas;

    /**
     * Type of binary format for reading {@link Data.Persisted}
     */
    readonly _persistedFormat?: string | null;
    with_persistedFormat(_persistedFormat: string | null): Data.CategoricalIndex.Pandas;

    /**
     * see tableName arg for {@link Feature.Store#readData}.
     */
    readonly _tableName?: string | null;
    with_tableName(_tableName: string | null): Data.CategoricalIndex.Pandas;

    /**
     * see id arg for {@link Feature.Store#readData}.
     */
    readonly _tableEntryId?: string | null;
    with_tableEntryId(_tableEntryId: string | null): Data.CategoricalIndex.Pandas;

    /**
     * Mapping of variable names to their values to be used by the PyAst Executor
     */
    readonly _vars?: C3.Map<string | null, any>;
    with_vars(_vars: C3.Map<string | null, any> | {[key: string | null]: any}): Data.CategoricalIndex.Pandas;
    ...
    withMaxSegmentSizeClient(maxSegmentSizeClient: number | null): Data.CategoricalIndex.Pandas;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.CategoricalIndex.Pandas | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.CategoricalIndex.Pandas | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.CategoricalIndex.Pandas | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.CategoricalIndex.Pandas | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.CategoricalIndex.Pandas;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.CategoricalIndex.Pandas;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.CategoricalIndex.Pandas;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.CategoricalIndex.Pandas | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.CategoricalIndex.Pandas | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.CategoricalIndex.Pandas;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.CategoricalIndex.Pandas;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.CategoricalIndex.Pandas;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.CategoricalIndex.Pandas;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.CategoricalIndex.Pandas;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.CategoricalIndex.Pandas;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.CategoricalIndex.Pandas;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.CategoricalIndex.Pandas;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.CategoricalIndex.Pandas;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.CategoricalIndex.Pandas;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.CategoricalIndex.Pandas;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.CategoricalIndex.Pandas;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.CategoricalIndex.Pandas;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.CategoricalIndex.Pandas;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.CategoricalIndex.Pandas;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.CategoricalIndex.Pandas;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.CategoricalIndex.Pandas;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.CategoricalIndex.Pandas;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.CategoricalIndex.Pandas;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.CategoricalIndex.Pandas;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.CategoricalIndex.Pandas;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.CategoricalIndex.Pandas;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.CategoricalIndex.Pandas;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.CategoricalIndex.Pandas;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.CategoricalIndex.Pandas;

    mergeJson(json: any | null): Data.CategoricalIndex.Pandas;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.CategoricalIndex.Pandas;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.CategoricalIndex.Pandas;
     ...
     */
    singletonArray(): C3.Array<Data.CategoricalIndex.Pandas | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.CategoricalIndex.Pandas | null>;
     ...
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.CategoricalIndex.Pandas | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.CategoricalIndex.Pandas | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.CategoricalIndex.Pandas | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.CategoricalIndex.Pandas | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.CategoricalIndex.Pandas | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.CategoricalIndex.Pandas | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.CategoricalIndex.Pandas | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.CategoricalIndex.Pandas;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.CategoricalIndex.Pandas;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.CategoricalIndex.Pandas;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.CategoricalIndex.Pandas;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.CategoricalIndex.Pandas;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.CategoricalIndex.Pandas;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.CategoricalIndex.Pandas;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Data.CategoricalIndex.Pandas;
     ...
     */
    static cachedEmptyInst(): Data.CategoricalIndex.Pandas;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.CategoricalIndex.Pandas>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.CategoricalIndex.Pandas;
     ...
     */
    static fromPySrc(pySrc: string, dfs?: C3.Set<DataImpl | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): Data.CategoricalIndex.Pandas | null;
     ...
     */
    static _jsDataProxy(inst: any): Data.CategoricalIndex.Pandas;
     ...
     */
    static fromBinary(name: string, data: any, dataset?: Dataset | null): Data.CategoricalIndex.Pandas | null;

    static fromBinary(name: string, data: C3.Array<any | null>, dataset?: Dataset | null): Data.CategoricalIndex.Pandas | null;
     ...
     */
    static fromStore(name: string, tableName: string, tableEntryId: string, dataset?: Dataset | null, persistedFormat?: string | null): Data.CategoricalIndex.Pandas | null;

    /**
     * Create an instance of DataImpl.Pandas with the provided name from a pandas binary
     */
    static fromName(name: string, binary: any, dataset?: Dataset | null): Data.CategoricalIndex.Pandas | null;

    /**
     * Create an instance of DataImpl.Pandas with the provided name and pySrc
     */
    static fromName(name: string, pySrc: string, datas?: C3.Set<DataImpl.Pandas | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): Data.CategoricalIndex.Pandas | null;
     ...
     */
    static fromDatasetBinaries(name: string, dataset?: Dataset | null): Data.CategoricalIndex.Pandas | null;

    /**
     * Create an instance of DataImpl.Pandas with the provided name from a pickled binary file specified by fileName
     */
    static fromBinaryFile(name: string, fileName: string, dataset?: Dataset | null): Data.CategoricalIndex.Pandas | null;

    /**
     * Create a new DataImpl.Pandas from a PyAST visitor context.
     * see @DataToPyAstVisitorCtx
     */
    static fromDataToPyAstVisitorCtx(ctx: DataToPyAstVisitorCtx, dataset?: Dataset | null): Data.CategoricalIndex.Pandas | null;
     ...
     */
    static dispatch(pandas: Data.CategoricalIndex.Pandas, name: string, args?: C3.Array<any>, kwargs?: C3.Map<string | null, any>, doNotConvertData?: boolean): any;
     ...
     *         The native pandas value will be converted to the corresponding {@link DataImpl.Pandas} subtype
     */
    static getAttribute(pandas: Data.CategoricalIndex.Pandas, name: string, doNotConvertData?: boolean): any;
     ...
     */
    static evaluate(pandas: Data.CategoricalIndex.Pandas): void;
     ...
     */
    static toBinary(pandas: Data.CategoricalIndex.Pandas): any | null;
     ...
     */
    static storeBinariesInDataset(pandas: Data.CategoricalIndex.Pandas): void;
    ...
    get T(): Data.CategoricalIndex | null;
    ...
    drop_duplicates(keep?: any): Data.CategoricalIndex | null;

    droplevel(level?: any): Data.Index | null | Data.MultiIndex | null | null;

    dropna(how?: any): Data.CategoricalIndex | null;

    duplicated(keep?: any): C3.Array<boolean> | null;

    equals(other?: any): boolean | null;

    fillna(value?: any, downcast?: any): Data.CategoricalIndex | null;
    ...
    map(mapper?: any): Data.Index | null;
    ...
    rename(name?: any, inplace?: any): Data.CategoricalIndex | null;

    repeat(repeats?: any, axis?: any): any;

    searchsorted(value?: any, side?: any, sorter?: any): any;

    set_names(names?: any, level?: any, inplace?: any): Data.CategoricalIndex | null;

    set_value(arr?: any, key?: any, value?: any): any;

    shift(periods?: any, freq?: any): Data.CategoricalIndex | null;
    ...
    transpose(): Data.CategoricalIndex | null;
    ...
    get categories(): Data.Index | null | Data.RangeIndex | null | Data.MultiIndex | null | Data.CategoricalIndex | null | Data.IntervalIndex | null | Data.PeriodIndex | null | Data.DatetimeIndex | null | Data.TimedeltaIndex | null | Data.Int64Index | null | Data.UInt64Index | null | Data.Float64Index | null | null;

    get codes(): C3.Array<any> | null;

    get ordered(): any;

    add_categories(new_categories?: any): Data.CategoricalIndex | null;

    as_ordered(): Data.CategoricalIndex | null;

    as_unordered(): Data.CategoricalIndex | null;

    is_dtype_equal(other?: any): any;

    remove_categories(removals?: any): Data.CategoricalIndex | null;

    remove_unused_categories(): Data.CategoricalIndex | null;

    rename_categories(new_categories?: any): Data.CategoricalIndex | null;

    reorder_categories(new_categories?: any, ordered?: boolean): Data.CategoricalIndex | null;

    set_categories(new_categories?: any, ordered?: boolean, rename?: boolean): Data.CategoricalIndex | null;

    take_nd(indices?: C3.Array<any>, axis?: number | null, allow_fill?: boolean, fill_value?: any): any;
  }
}
