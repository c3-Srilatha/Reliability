// TypeScript definitions for the C3 type NormalizedTimeseries

/**
 * Data type for storing normalized timeseries data. One NormalizedTimeseries object is created
 * per header-field combination
 *
 * @remarks this represents a value passed to a method that expects an instance of NormalizedTimeseries
 */
declare interface INormalizedTimeseries {
   ...
   * @db(storage="column")
   */
  estimates?: C3.Map<string | null, DateTimeMapp | null> | {[key: string | null]: IDateTimeMapp | null};

  /**
   * Value indicating if the interval is missing or not. null value represents all available
   * Key is the same as counts / values
   */
  missing?: C3.Map<string | null, Boxed<C3.Array<boolean>> | null> | {[key: string | null]: IBoxed<C3.Array<boolean>> | null};
   ...
   */
  values?: C3.Map<string | null, DecimalArry | null> | {[key: string | null]: IDecimalArry | null};

  /**
   * Contains the range of this timeseries. start, end, finest-grain at which the timeseries is normalized
   */
  range?: INormalizedTimeseriesRange | null;
   ...
   */
  state?: INormalizedTimeseriesState | null;
   ...
   */
  earliestLatestValue?: IDimensionPair | null;
   ...
   * @db(storage="columnPerKey")
   */
  counts?: C3.Map<string | null, DecimalArry | null> | {[key: string | null]: IDecimalArry | null};
   ...
   */
  invalidatedRanges?: C3.Array<NormalizedTimeseriesInvalidationRange | null> | Array<INormalizedTimeseriesInvalidationRange | null>;
}
 ...
 * per header-field combination
 *
 * @remarks this represents a made instance of NormalizedTimeseries
 */
declare class NormalizedTimeseries extends Obj {

  /**
   * Id : typeId(rawDataPointType).parentId.pathId(tsField)
   */
  readonly id: string;
  withId(id: string): NormalizedTimeseries;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): NormalizedTimeseries;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): NormalizedTimeseries;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): NormalizedTimeseries;
  ...
  withVersion(version: number | null): NormalizedTimeseries;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): NormalizedTimeseries;
   ...
   * @db(storage="column")
   */
  readonly estimates?: C3.Map<string | null, DateTimeMapp | null>;
  withEstimates(estimates: C3.Map<string | null, DateTimeMapp | null> | {[key: string | null]: IDateTimeMapp | null}): NormalizedTimeseries;

  /**
   * Value indicating if the interval is missing or not. null value represents all available
   * Key is the same as counts / values
   */
  readonly missing?: C3.Map<string | null, Boxed<C3.Array<boolean>> | null>;
  withMissing(missing: C3.Map<string | null, Boxed<C3.Array<boolean>> | null> | {[key: string | null]: IBoxed<C3.Array<boolean>> | null}): NormalizedTimeseries;
   ...
   * @db(storage="columnPerKey")
   */
  readonly values?: C3.Map<string | null, DecimalArry | null>;
  withValues(values: C3.Map<string | null, DecimalArry | null> | {[key: string | null]: IDecimalArry | null}): NormalizedTimeseries;

  /**
   * Contains the range of this timeseries. start, end, finest-grain at which the timeseries is normalized
   */
  readonly range?: NormalizedTimeseriesRange | null;
  withRange(range: INormalizedTimeseriesRange | null): NormalizedTimeseries;

  /**
   * This object contains meta information about how the timeseries was normalized and if there
   * were any errors during normalization.
   */
  readonly state?: NormalizedTimeseriesState | null;
  withState(state: INormalizedTimeseriesState | null): NormalizedTimeseries;

  /**
   * Denotes whether the given timeseries is valid and ready for consumption
   */
  readonly valid?: boolean | null;
  withValid(valid: boolean | null): NormalizedTimeseries;
   ...
   * Pair contains -> <Earliest Value, Latest Value>
   */
  readonly earliestLatestValue?: DimensionPair | null;
  withEarliestLatestValue(earliestLatestValue: IDimensionPair | null): NormalizedTimeseries;
   ...
   * @db(storage="columnPerKey")
   */
  readonly counts?: C3.Map<string | null, DecimalArry | null>;
  withCounts(counts: C3.Map<string | null, DecimalArry | null> | {[key: string | null]: IDecimalArry | null}): NormalizedTimeseries;

  /**
   * Time range indicating the period that is invalidated. The presence of this field means that the state is invalid
   * This field will be stored a they arrive and will only be gettable by it self without using include with other fields
   */
  readonly invalidatedRanges?: C3.Array<NormalizedTimeseriesInvalidationRange | null>;
  withInvalidatedRanges(invalidatedRanges: C3.Array<NormalizedTimeseriesInvalidationRange | null> | Array<INormalizedTimeseriesInvalidationRange | null>): NormalizedTimeseries;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): NormalizedTimeseries | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): NormalizedTimeseries | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): NormalizedTimeseries | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): NormalizedTimeseries | null;
   ...
   */
  replaceType(old: Type, new_: Type): NormalizedTimeseries;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NormalizedTimeseries;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NormalizedTimeseries;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NormalizedTimeseries | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NormalizedTimeseries | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): NormalizedTimeseries;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NormalizedTimeseries;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NormalizedTimeseries;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): NormalizedTimeseries;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): NormalizedTimeseries;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): NormalizedTimeseries;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): NormalizedTimeseries;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): NormalizedTimeseries;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): NormalizedTimeseries;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): NormalizedTimeseries;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): NormalizedTimeseries;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): NormalizedTimeseries;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): NormalizedTimeseries;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): NormalizedTimeseries;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): NormalizedTimeseries;
   ...
   * @see #unsetField
   */
  defaultField(field: string): NormalizedTimeseries;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): NormalizedTimeseries;
   ...
   * @see #removeField
   */
  unsetField(field: string): NormalizedTimeseries;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): NormalizedTimeseries;
   ...
   * @see #unsetField
   */
  removeField(field: string): NormalizedTimeseries;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): NormalizedTimeseries;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): NormalizedTimeseries;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): NormalizedTimeseries;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): NormalizedTimeseries;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): NormalizedTimeseries;

  mergeJson(json: any | null): NormalizedTimeseries;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): NormalizedTimeseries;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): NormalizedTimeseries;
   ...
   */
  singletonArray(): C3.Array<NormalizedTimeseries | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<NormalizedTimeseries | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<NormalizedTimeseries | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<NormalizedTimeseries | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<NormalizedTimeseries | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, NormalizedTimeseries | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, NormalizedTimeseries | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<NormalizedTimeseries | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<NormalizedTimeseries | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): NormalizedTimeseries;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): NormalizedTimeseries;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): NormalizedTimeseries;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): NormalizedTimeseries;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): NormalizedTimeseries;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): NormalizedTimeseries;
   ...
   * @see #fromString
   */
  static make(s: string | null): NormalizedTimeseries | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): NormalizedTimeseries;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): NormalizedTimeseries;
   ...
   */
  static cachedEmptyInst(): NormalizedTimeseries;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<NormalizedTimeseries>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): NormalizedTimeseries;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<NormalizedTimeseries | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<NormalizedTimeseries | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<NormalizedTimeseries | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<NormalizedTimeseries | null> | null>;
   ...
   */
  get(include?: string | null): NormalizedTimeseries | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): NormalizedTimeseries | null;
   ...
   */
  getMissing(spec: GetMissingSpec): NormalizedTimeseries;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): NormalizedTimeseries | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): NormalizedTimeseries;
   ...
   * @see #toString
   */
  static fromString(s: string | null): NormalizedTimeseries | null;
   ...
   */
  create(spec?: UpsertSpec | null): NormalizedTimeseries | null;
   ...
   */
  static createBatch(objs: C3.Array<NormalizedTimeseries | null> | null, spec?: UpsertSpec | null): ObjList<NormalizedTimeseries | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<NormalizedTimeseries | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<NormalizedTimeseries | null> | null;
   ...
   */
  update(srcObj?: NormalizedTimeseries | null, spec?: UpsertSpec | null): NormalizedTimeseries | null;
   ...
   */
  upsert(srcObj?: NormalizedTimeseries | null, spec?: UpsertSpec | null): NormalizedTimeseries | null;
   ...
   */
  merge(spec?: MergeSpec | null): NormalizedTimeseries | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): NormalizedTimeseries | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): NormalizedTimeseries | null;
   ...
   */
  static updateBatch(objs: C3.Array<NormalizedTimeseries | null> | null, srcObjs?: C3.Array<NormalizedTimeseries | null>, spec?: UpsertSpec | null): ObjList<NormalizedTimeseries | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<NormalizedTimeseries | null>>, spec?: UpsertSpec | null): ObjList<NormalizedTimeseries | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<NormalizedTimeseries | null> | null, srcObjs?: C3.Array<NormalizedTimeseries | null>, spec?: UpsertSpec | null): ObjList<NormalizedTimeseries | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<NormalizedTimeseries | null>>, spec?: UpsertSpec | null): ObjList<NormalizedTimeseries | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<NormalizedTimeseries | null> | null, spec?: TouchSpec | null): ObjList<NormalizedTimeseries | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<NormalizedTimeseries | null> | null, spec?: MergeSpec | null): ObjList<NormalizedTimeseries | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<NormalizedTimeseries | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<NormalizedTimeseries | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<NormalizedTimeseries | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<NormalizedTimeseries | null> | null;
   ...
   */
  static mergeAll(mergeObj: NormalizedTimeseries | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: NormalizedTimeseries | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<NormalizedTimeseries | null> | null, spec?: UpsertSpec | null): ObjList<NormalizedTimeseries | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<NormalizedTimeseries | null> | null, spec?: UpsertSpec | null): ObjList<NormalizedTimeseries | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): NormalizedTimeseries | null;
   ...
   */
  static beforeCreate(objs: C3.Array<NormalizedTimeseries | null> | null): ObjList<NormalizedTimeseries | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<NormalizedTimeseries | null> | null): ObjList<NormalizedTimeseries | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<NormalizedTimeseries | null> | null): ObjList<NormalizedTimeseries | null>;
   ...
   */
  static afterCreate(objs: C3.Array<NormalizedTimeseries | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<NormalizedTimeseries | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<NormalizedTimeseries | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<NormalizedTimeseries | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<NormalizedTimeseries | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): NormalizedTimeseries | null;
   ...
   */
  withoutIdentity(): NormalizedTimeseries | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<NormalizedTimeseries | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: NormalizedTimeseries | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<NormalizedTimeseries | null> | null, callback?: λFunction<NormalizedTimeseries | null, NormalizedTimeseries | null> | null): ObjList<NormalizedTimeseries | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<NormalizedTimeseries | null> | null, callback?: λFunction<NormalizedTimeseries | null, NormalizedTimeseries | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static persistTimeseries(timeseries: Timeseries<any>, id: string): void;

  /**
   * Purges the given timeseries id from cassandra
   * @param ids Timeseries ids to purge
   */
  static purgeTimeseries(ids: C3.Array<string | null>): void;
   ...
   */
  static computeTimeRange(spec?: TSEvalSpec | null, id: string): TimeRange | null;
   ...
   */
  static fetchNormalizedData(spec?: TSEvalSpec | null, id: string): Timeseries<any> | null;

  /**
   * Computes in memory Pair of [hot, <coldBucketUrl : cold buckets content>] from the given instance of NormalizedTimeseries
   */
  hotColdBuckets(): Pair<NormalizedTimeseries | null, C3.Map<string | null, NormalizedTimeseries | null>> | null;

  /**
   * @return the end point where the cold data will be persisted
   */
  coldDataEndpoint(): string;
   ...
   */
  compactInMemory(): Triple<NormalizedTimeseries | null, C3.Map<string | null, NormalizedTimeseries | null>, C3.Array<string | null>> | null;
}
