// TypeScript definitions for the C3 type Workflow
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Workflow
 */
declare interface IWorkflow {
   ...
   */
  vertices?: C3.Array<Workflow.Vertex | null> | Array<IWorkflow.Vertex | null>;

  /**
   * List of all edges in this graph.
   */
  edges?: C3.Array<FlowGraph.Edge<Workflow.Vertex | null> | null> | Array<IFlowGraph.Edge<Workflow.Vertex | null> | null>;
   ...
   * {@link FlowGraph}.
   */
  finallyVertex?: IWorkflow.Action | null;

  /**
   * Previous asynchronous executions for this workflow
   */
  asyncRuns?: C3.Array<Workflow.Run | null> | Array<IWorkflow.Run | null>;
}
 ...
 * @see workflow.c3doc.md
 *
 * @remarks this represents a made instance of Workflow
 */
declare class Workflow extends Obj {

  /**
   * List of all vertices in this graph.
   */
  readonly vertices?: C3.Array<Workflow.Vertex | null>;
  withVertices(vertices: C3.Array<Workflow.Vertex | null> | Array<IWorkflow.Vertex | null>): Workflow;

  /**
   * List of all edges in this graph.
   */
  readonly edges?: C3.Array<FlowGraph.Edge<Workflow.Vertex | null> | null>;
  withEdges(edges: C3.Array<FlowGraph.Edge<Workflow.Vertex | null> | null> | Array<IFlowGraph.Edge<Workflow.Vertex | null> | null>): Workflow;
  ...
  withVertexConnections(vertexConnections: C3.Map<string | null, C3.Map<string | null, any>> | {[key: string | null]: C3.Map<string | null, any> | {[key: string | null]: any}}): Workflow;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Workflow;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): Workflow;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): Workflow;
  ...
  withVersion(version: number | null): Workflow;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): Workflow;
   ...
   * {@link FlowGraph}.
   */
  readonly finallyVertex?: Workflow.Action | null;
  withFinallyVertex(finallyVertex: IWorkflow.Action | null): Workflow;

  /**
   * Previous asynchronous executions for this workflow
   */
  readonly asyncRuns?: C3.Array<Workflow.Run | null>;
  withAsyncRuns(asyncRuns: C3.Array<Workflow.Run | null> | Array<IWorkflow.Run | null>): Workflow;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Workflow | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Workflow | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Workflow | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Workflow | null;
   ...
   */
  replaceType(old: Type, new_: Type): Workflow;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Workflow;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Workflow;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Workflow | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Workflow | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Workflow;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Workflow;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Workflow;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): Workflow;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Workflow;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Workflow;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Workflow;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Workflow;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Workflow;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Workflow;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Workflow;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Workflow;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Workflow;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Workflow;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Workflow;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Workflow;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Workflow;
   ...
   * @see #removeField
   */
  unsetField(field: string): Workflow;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Workflow;
   ...
   * @see #unsetField
   */
  removeField(field: string): Workflow;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Workflow;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Workflow;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Workflow;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Workflow;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Workflow;

  mergeJson(json: any | null): Workflow;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Workflow;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Workflow;
   ...
   */
  singletonArray(): C3.Array<Workflow | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Workflow | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Workflow | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Workflow | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Workflow | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Workflow | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Workflow | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Workflow | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Workflow | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Workflow;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Workflow;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Workflow;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Workflow;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Workflow;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Workflow;
   ...
   * @see #fromString
   */
  static make(s: string | null): Workflow | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Workflow;
   ...
   */
  static cachedEmptyInst(): Workflow;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Workflow>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Workflow;
   ...
   */
  nextEdgesFor(port: FlowGraph.Port): C3.Array<FlowGraph.Edge<Workflow.Vertex | null> | null>;

  /**
   * Overload for {@link #nextEdgesFor}, except with a vertex arg.
   */
  nextEdgesFor(vertex: Workflow.Vertex): C3.Array<FlowGraph.Edge<Workflow.Vertex | null> | null>;

  nextEdgesForPort(port: FlowGraph.Port): C3.Array<FlowGraph.Edge<Workflow.Vertex | null> | null>;

  nextEdgesForVertex(vertex: Workflow.Vertex): C3.Array<FlowGraph.Edge<Workflow.Vertex | null> | null>;
   ...
   */
  prevEdgeFor(port: FlowGraph.Port): FlowGraph.Edge<Workflow.Vertex | null> | null;

  /**
   * Same as {@link #prevEdgeFor}, except with a vertex arg.
   */
  prevEdgesFor(vertex: Workflow.Vertex): C3.Array<FlowGraph.Edge<Workflow.Vertex | null> | null>;
   ...
   */
  nextPortsFor(vertex: Workflow.Vertex): C3.Array<FlowGraph.Port | null>;

  nextPortsForPort(port: FlowGraph.Port): C3.Array<FlowGraph.Port | null>;

  nextPortsForVertex(vertex: Workflow.Vertex): C3.Array<FlowGraph.Port | null>;
   ...
   */
  prevPortsFor(vertex: Workflow.Vertex): C3.Array<FlowGraph.Port | null>;
   ...
   */
  nextVerticesFor(port: FlowGraph.Port): C3.Array<Workflow.Vertex | null>;

  /**
   * Override for {@link #nextVerticesFor}, except with a vertex arg.
   */
  nextVerticesFor(vertex: Workflow.Vertex): C3.Array<Workflow.Vertex | null>;

  nextVerticesForPort(port: FlowGraph.Port): C3.Array<Workflow.Vertex | null>;

  nextVerticesForVertex(vertex: Workflow.Vertex): C3.Array<Workflow.Vertex | null>;
   ...
   */
  prevVertexFor(port: FlowGraph.Port): Workflow.Vertex | null;

  /**
   * Same as {@link #prevVertexFor}, except with a vertex arg.
   */
  prevVerticesFor(vertex: Workflow.Vertex): C3.Array<Workflow.Vertex | null>;
   ...
   */
  static makeEdge(fromPort: FlowGraph.Port, toPort: FlowGraph.Port): FlowGraph.Edge<Workflow.Vertex | null>;
   ...
   */
  vertexForId(id: string): Workflow.Vertex | null;
   ...
   */
  vertexForName(name: string): Workflow.Vertex | null;
   ...
   */
  eachVertex(action: λConsumer<Workflow.Vertex | null>): void;

  /**
   * Transforms each vertex in this FlowGraph by applying provided lambda function.
   */
  mapVertices(mapper: λFunction<Workflow.Vertex | null, T | null>): Workflow;

  /**
   * @return value that is a result of aggregation of all vertices by provided lambda and initial value.
   */
  foldVertices(initial: T | null, folder: λBiFunction<Workflow.Vertex | null, T | null, T | null>): T | null;
   ...
   */
  _visit(type: Type, ctx: C, unknownVertexAction?: λBiFunction<Workflow.Vertex | null, C | null, C | null> | null): C | null;
   ...
   */
  topologicalSort(reverse?: boolean): Workflow;
   ...
   */
  ancestorGraph(sink: FlowGraph.Vertex): Workflow;
   ...
   */
  replaceVertex(oldVertex: FlowGraph.Vertex, newVertex: FlowGraph.Vertex, doNotMerge?: boolean, removeDisconnectedEdges?: boolean): Workflow;
   ...
   */
  replaceVertices(oldVertices: C3.Array<FlowGraph.Vertex | null>, newVertex: FlowGraph.Vertex, spec?: FlowGraphReplaceSpec | null): Workflow;
   ...
   * @return
   */
  replaceVertices(oldVertices: C3.Array<FlowGraph.Vertex | null>, newVertices: C3.Array<FlowGraph.Vertex | null>, newEdges?: C3.Array<FlowGraph.Edge<FlowGraph.Vertex | null> | null>, spec?: FlowGraphReplaceSpec | null): Workflow;
   ...
   * connected.
   */
  removeVertex(toRemove: FlowGraph.Vertex): Workflow;

  removeVertex(idToRemove: string): Workflow;
   ...
   */
  removeVertices(toRemove?: C3.Array<FlowGraph.Vertex | null>): Workflow;
   ...
   *  ```
   */
  mergeWith(other: Workflow): Workflow;
   ...
   */
  static pruneUnusedVertices(vertices?: C3.Array<Workflow.Vertex | null>, edges?: C3.Array<FlowGraph.Edge<FlowGraph.Vertex | null> | null>): C3.Array<Workflow.Vertex | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<Workflow | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<Workflow | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Workflow | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Workflow | null> | null>;
   ...
   */
  get(include?: string | null): Workflow | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): Workflow | null;
   ...
   */
  getMissing(spec: GetMissingSpec): Workflow;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): Workflow | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): Workflow;
   ...
   * @see #toString
   */
  static fromString(s: string | null): Workflow | null;
   ...
   */
  create(spec?: UpsertSpec | null): Workflow | null;
   ...
   */
  static createBatch(objs: C3.Array<Workflow | null> | null, spec?: UpsertSpec | null): ObjList<Workflow | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<Workflow | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Workflow | null> | null;
   ...
   */
  update(srcObj?: Workflow | null, spec?: UpsertSpec | null): Workflow | null;
   ...
   */
  upsert(srcObj?: Workflow | null, spec?: UpsertSpec | null): Workflow | null;
   ...
   */
  merge(spec?: MergeSpec | null): Workflow | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): Workflow | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): Workflow | null;
   ...
   */
  static updateBatch(objs: C3.Array<Workflow | null> | null, srcObjs?: C3.Array<Workflow | null>, spec?: UpsertSpec | null): ObjList<Workflow | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<Workflow | null>>, spec?: UpsertSpec | null): ObjList<Workflow | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<Workflow | null> | null, srcObjs?: C3.Array<Workflow | null>, spec?: UpsertSpec | null): ObjList<Workflow | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<Workflow | null>>, spec?: UpsertSpec | null): ObjList<Workflow | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<Workflow | null> | null, spec?: TouchSpec | null): ObjList<Workflow | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Workflow | null> | null, spec?: MergeSpec | null): ObjList<Workflow | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Workflow | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Workflow | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<Workflow | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Workflow | null> | null;
   ...
   */
  static mergeAll(mergeObj: Workflow | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: Workflow | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<Workflow | null> | null, spec?: UpsertSpec | null): ObjList<Workflow | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<Workflow | null> | null, spec?: UpsertSpec | null): ObjList<Workflow | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<Workflow | null> | null): ObjList<Workflow | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<Workflow | null> | null): ObjList<Workflow | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<Workflow | null> | null): ObjList<Workflow | null>;
   ...
   */
  static afterCreate(objs: C3.Array<Workflow | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<Workflow | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<Workflow | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<Workflow | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Workflow | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): Workflow | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<Workflow | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: Workflow | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<Workflow | null> | null, callback?: λFunction<Workflow | null, Workflow | null> | null): ObjList<Workflow | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<Workflow | null> | null, callback?: λFunction<Workflow | null, Workflow | null> | null): C3.Array<ObjError | null>;
   ...
   */
  optimize(strategy?: Workflow.OptimizationStrategy | null): Workflow;
   ...
   *         by action profiling.
   */
  executionMetadataByVertex(run: WorkflowExecutorRun): C3.Map<string | null, Log.Entry.Action | null>;
   ...
   *         by action profiling.
   */
  executionMetadataByParentVertex(run: WorkflowExecutorRun): C3.Map<string | null, Log.Entry.Action | null>;
   ...
   */
  plotExecutionTimestamps(run: WorkflowExecutorRun): any;
   ...
   * @return the subgraph.
   */
  subGraph(sub: C3.Array<Workflow.Vertex | null>): Workflow;
   ...
   */
  start(inputs?: C3.Map<string | null, any>, spec?: WorkflowExecutionSpec | null): WorkflowExecutorRun | null;

  /**
   * @return the last asynchronous run for the workflow.
   */
  lastAsyncRun(): Workflow.Run | null;
   ...
   */
  static removeStaleInstances(): void;
   ...
   */
  extractWithInitialStateObjsPerRequirement(inputs?: C3.Map<string | null, any>): C3.Map<string | null, C3.Array<WithInitialState> | null> | null;
}
