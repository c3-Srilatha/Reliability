// TypeScript definitions for the C3 type SourceStatusQueue

/**
 * Invalidation Queue for async processing {@link SourceStatus}
 *
 * @remarks this represents a value passed to a method that expects an instance of SourceStatusQueue
 */
declare interface ISourceStatusQueue {
}
 ...
 */
declare class SourceStatusQueue {
   ...
   */
  static compute(targetType: Type, entries: C3.Array<SourceStatusQueueEntry | null> | null): void;
   ...
   */
  static find(spec?: InvalidationQueue.FindSpec | null): C3.Array<SourceStatusQueueEntry | null>;
   ...
   * @return the list of requested entries.
   */
  static findStream(spec?: InvalidationQueue.FindStreamSpec | null): Stream<SourceStatusQueueEntry | null>;
   ...
   *           Entries to remove.
   */
  static clearEntries(entries: C3.Array<SourceStatusQueueEntry | null> | null): void;
   ...
   */
  static submit(obj: Obj, spec?: DataIntegSpec | null, doNotAutoCommit?: boolean): void;
   ...
   * This function should be claimed by individual InvalidationQueue types such as CalcFieldsQueue.
   */
  static mergeContexts(targetType?: Type | null, entries?: C3.Array<SourceStatusQueueEntry | null>): C3.Array<SourceStatusQueueEntry | null>;
}
