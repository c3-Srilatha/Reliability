// TypeScript definitions for the C3 type FieldType
 ...
 * @see Method
 *
 * @remarks this represents a value passed to a method that expects an instance of FieldType
 */
declare interface IFieldType {
 ...
 */
declare class FieldType extends Obj {

  /**
   * Source file Pkg.Path a C3 Type declaration [.c3typ].
   */
  readonly declaredPkgPath?: string | null;
  withDeclaredPkgPath(declaredPkgPath: string | null): FieldType;

  /**
   * Source line number in a C3 Type declaration [.c3typ] file starting with 1 where this metadata element is declared.
   */
  readonly declaredSrcLine?: number | null;
  withDeclaredSrcLine(declaredSrcLine: number | null): FieldType;
  ...
  withDeclaredSrcCharInLine(declaredSrcCharInLine: number | null): FieldType;
   ...
   */
  readonly pkg: Pkg;
  withPkg(pkg: IPkg): FieldType;

  /**
   * SDK json representing instance of this type
   */
  readonly json?: any;
  withJson(json: any): FieldType;

  /**
   * The set of annotations defined on this element of metadata represented as json value.
   */
  readonly annotationsJson?: any | null;
  withAnnotationsJson(annotationsJson: any | null): FieldType;
  ...
  withDoc(doc: string | null): FieldType;

  readonly docSingleLine?: boolean;
  withDocSingleLine(docSingleLine: boolean): FieldType;

  /**
   * The name of the field is the unique key for access.
   */
  readonly name?: string | null;
  withName(name: string | null): FieldType;
  ...
  withDeclaredDefault(declaredDefault: string | null): FieldType;
  ...
  withStoredCalc(storedCalc: boolean): FieldType;
  ...
  withCalcExpr(calcExpr: string | null): FieldType;
  ...
  withCalcPeriod(calcPeriod: string | null): FieldType;
  ...
  withCalcSchedule(calcSchedule: string | null): FieldType;
  ...
  withFkey(fkey: string | null): FieldType;
  ...
  withKey(key: string | null): FieldType;

  readonly schemaName?: string | null;
  withSchemaName(schemaName: string | null): FieldType;

  readonly schemaSuffix?: string | null;
  withSchemaSuffix(schemaSuffix: string | null): FieldType;

  readonly translatedBy?: string | null;
  withTranslatedBy(translatedBy: string | null): FieldType;
  ...
  withNotPersistable(notPersistable: boolean): FieldType;
  ...
  withFinal(final: boolean): FieldType;
  ...
  withPrivate(private_: boolean): FieldType;
  ...
  withConstant(constant: boolean): FieldType;
   ...
   */
  replaceType(old: Type, new_: Type): FieldType;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): FieldType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): FieldType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): FieldType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): FieldType | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FieldType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FieldType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FieldType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FieldType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): FieldType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FieldType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FieldType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FieldType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FieldType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FieldType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): FieldType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FieldType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FieldType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): FieldType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): FieldType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): FieldType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): FieldType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FieldType;
   ...
   * @see FieldType#defaultValue
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): FieldType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FieldType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FieldType;
   ...
   * @see #removeField
   */
  unsetField(field: string): FieldType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FieldType;
   ...
   * @see #unsetField
   */
  removeField(field: string): FieldType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FieldType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): FieldType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): FieldType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): FieldType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): FieldType;

  mergeJson(json: any | null): FieldType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): FieldType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): FieldType;
   ...
   */
  singletonArray(): C3.Array<FieldType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<FieldType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FieldType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<FieldType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FieldType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, FieldType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FieldType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FieldType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FieldType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): FieldType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): FieldType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): FieldType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FieldType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): FieldType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FieldType;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): FieldType;
   ...
   */
  static cachedEmptyInst(): FieldType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<FieldType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): FieldType;
   ...
   */
  withoutDeclaredSrcPos(recursive?: boolean): FieldType;
   ...
   */
  withAnnotation(ann: Annotation): FieldType;
   ...
   *         value for the field
   */
  withAnnotation(ann: string, annField?: string | null, value?: any): FieldType;
   ...
   */
  docParsed(spec?: DocumentationParserSpec | null): FieldTypeDocumentation;
   ...
   */
  static fromRef(ref: Obj, failIfMissing?: boolean): FieldType;
   ...
   */
  mixins(): C3.Array<FieldType | null>;
   ...
   */
  firstDeclaredFieldType(): FieldType;
   ...
   */
  defaultValue(inst: Obj | null): any;
   ...
   */
  parsedCalculatedExpr(): Expr | null;
   ...
   */
  vectorAnnotation(): Ann.Vector | null;
   ...
   * @see Ann.Db#timedHistoryField
   */
  isTimedCharacteristicWithHistory(): boolean;

  /**
   * @return True if this field is the history field for a timed characteristic field that has a linked history field.
   */
  isTimedCharacteristicHistory(): boolean;

  isLatestCharacteristics(): boolean;

  /**
   * @return the associated timed value history field for a timed value field
   */
  timedCharacteristicHistoryField(): string | null;

  /**
   * @return true if the field is a heterogeneous reference.
   */
  isHeterogeneousRef(): boolean;
   ...
   */
  isPersistSerialized(checkCollection?: boolean): boolean;

  /**
   * @return The serialized value type for this value type if {@link persistSerialized} returns true.
   */
  serializedValueType(checkCollection: boolean): ValueType | null;
   ...
   */
  colName(failIfMissing?: boolean): string | null;
   ...
   */
  configSecretAnnotation(): boolean;
