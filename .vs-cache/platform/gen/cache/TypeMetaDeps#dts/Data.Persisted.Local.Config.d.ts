// TypeScript definitions for the C3 type Data.Persisted.Local.Config

/**
 * Configuration options for {@link Data.Persisted.Local}.
 *
 * @remarks this represents a value passed to a method that expects an instance of Data.Persisted.Local.Config
 */
declare namespace Data.Persisted.Local {
...
declare namespace Data.Persisted.Local {
  export class Config extends Obj {
    ...
    withConfigOverride(configOverride: string | null): Data.Persisted.Local.Config;

    readonly secretOverride?: string | null;
    withSecretOverride(secretOverride: string | null): Data.Persisted.Local.Config;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: C3.Array<string | null>;
    withIssues(issues: C3.Array<string | null> | Array<string | null>): Data.Persisted.Local.Config;

    /**
     * If true, disables removal of {@link Data.Persisted.Local} that are GC'ed by Java.
     */
    readonly disableAutoCleanUp?: boolean;
    withDisableAutoCleanUp(disableAutoCleanUp: boolean): Data.Persisted.Local.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.Persisted.Local.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.Persisted.Local.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.Persisted.Local.Config | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.Persisted.Local.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.Persisted.Local.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Persisted.Local.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Persisted.Local.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Persisted.Local.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Persisted.Local.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.Persisted.Local.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Persisted.Local.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Persisted.Local.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.Persisted.Local.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.Persisted.Local.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.Persisted.Local.Config;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.Persisted.Local.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.Persisted.Local.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.Persisted.Local.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.Persisted.Local.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.Persisted.Local.Config;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.Persisted.Local.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.Persisted.Local.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.Persisted.Local.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.Persisted.Local.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.Persisted.Local.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.Persisted.Local.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.Persisted.Local.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.Persisted.Local.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.Persisted.Local.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.Persisted.Local.Config;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.Persisted.Local.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.Persisted.Local.Config;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.Persisted.Local.Config;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.Persisted.Local.Config;

    mergeJson(json: any | null): Data.Persisted.Local.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.Persisted.Local.Config;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.Persisted.Local.Config;
     ...
     */
    singletonArray(): C3.Array<Data.Persisted.Local.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.Persisted.Local.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.Persisted.Local.Config | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.Persisted.Local.Config | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.Persisted.Local.Config | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.Persisted.Local.Config | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.Persisted.Local.Config | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.Persisted.Local.Config | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.Persisted.Local.Config | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.Persisted.Local.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.Persisted.Local.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.Persisted.Local.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.Persisted.Local.Config;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.Persisted.Local.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.Persisted.Local.Config;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.Persisted.Local.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Data.Persisted.Local.Config;
     ...
     */
    static cachedEmptyInst(): Data.Persisted.Local.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.Persisted.Local.Config>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.Persisted.Local.Config;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<Data.Persisted.Local.Config | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<Data.Persisted.Local.Config | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<Data.Persisted.Local.Config | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): Data.Persisted.Local.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string | null): Data.Persisted.Local.Config | null;
     ...
     * @see findByCacheKey
     */
    getCached(): Data.Persisted.Local.Config | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): Data.Persisted.Local.Config | null;
     ...
     */
    static produce(key: string): Data.Persisted.Local.Config | null;
     ...
     */
    static produceAll(): C3.Map<string | null, Data.Persisted.Local.Config | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, Data.Persisted.Local.Config | null>;
     ...
     */
    getConfig(): Data.Persisted.Local.Config;
     ...
     */
    getSecret(): Data.Persisted.Local.Config;
     ...
     */
    static forConfigKey(configKey: string | null): Data.Persisted.Local.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<Data.Persisted.Local.Config | null>;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Data.Persisted.Local.Config, override?: string | null): void;
     ...
     * @see setSecretValue
     */
    setSecretValues(from: Data.Persisted.Local.Config, override?: string | null): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Data.Persisted.Local.Config | null;
