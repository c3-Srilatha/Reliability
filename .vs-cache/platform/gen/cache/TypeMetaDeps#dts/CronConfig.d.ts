// TypeScript definitions for the C3 type CronConfig

/**
 * Configuration for CronEngine
 *
 * @remarks this represents a value passed to a method that expects an instance of CronConfig
 */
declare interface ICronConfig {
   ...
   */
  pollDelayInSeconds?: number | null;
}

/**
 * Configuration for CronEngine
 *
 * @remarks this represents a made instance of CronConfig
 */
declare class CronConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): CronConfig;

  static readonly configOverride?: string | null;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): CronConfig;
  ...
  withIssues(issues: C3.Array<string | null> | Array<string | null>): CronConfig;
   ...
   * Time interval between polls
   */
  readonly pollDelayInSeconds?: number | null;
  withPollDelayInSeconds(pollDelayInSeconds: number | null): CronConfig;

  /**
   * Time interval between polls
   */
  static readonly pollDelayInSeconds?: number | null;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): CronConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): CronConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): CronConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): CronConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): CronConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): CronConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): CronConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): CronConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): CronConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): CronConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<CronConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<CronConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<CronConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<CronConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): CronConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): CronConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CronConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CronConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CronConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CronConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): CronConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): CronConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): CronConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): CronConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): CronConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): CronConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): CronConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): CronConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): CronConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): CronConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): CronConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): CronConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): CronConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): CronConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): CronConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): CronConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): CronConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): CronConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): CronConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): CronConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): CronConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): CronConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): CronConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): CronConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): CronConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): CronConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): CronConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): CronConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): CronConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): CronConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): CronConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): CronConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): CronConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): CronConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): CronConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): CronConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): CronConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): CronConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): CronConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): CronConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): CronConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): CronConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): CronConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): CronConfig;

  mergeJson(json: any | null): CronConfig;

  static mergeJson(json: any | null): CronConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): CronConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): CronConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): CronConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): CronConfig;
   ...
   */
  singletonArray(): C3.Array<CronConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<CronConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<CronConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<CronConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<CronConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<CronConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<CronConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, CronConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, CronConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<CronConfig | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<CronConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<CronConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): CronConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): CronConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): CronConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): CronConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): CronConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): CronConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): CronConfig;
   ...
   */
  static cachedEmptyInst(): CronConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<CronConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): CronConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<CronConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<CronConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<CronConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): CronConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): CronConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): CronConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): CronConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): CronConfig | null;
   ...
   */
  static produce(key: string): CronConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, CronConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, CronConfig | null>;
   ...
   */
  static forConfigKey(configKey: string | null): CronConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<CronConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: CronConfig, override?: string | null): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: CronConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: CronConfig, override?: string | null): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: CronConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): CronConfig | null;
   ...
   */
  removeSecrets(): CronConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): CronConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): CronConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): CronConfig | null;
