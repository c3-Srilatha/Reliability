// TypeScript definitions for the C3 type GenerateDataSpec

/**
 * Specification of the options/parameters for the {@link Persistable#generateData} function.
 *
 * @remarks this represents a value passed to a method that expects an instance of GenerateDataSpec
 */
declare interface IGenerateDataSpec {
   ...
   */
  randomData?: IRandomDataSpec | null | IRandomTimeseriesDataSpec | null | null;
 ...
 */
declare class GenerateDataSpec extends Obj {

  /**
   * Specifies various parameters for automatic retry that occurs in upsert due to retryable errors.
   */
  readonly retrySpec?: RetrySpec | null;
  withRetrySpec(retrySpec: IRetrySpec | null): GenerateDataSpec;
  ...
  withForceAsyncCalcFieldRefresh(forceAsyncCalcFieldRefresh: boolean): GenerateDataSpec;
  ...
  withCalcFieldsBeingRefreshed(calcFieldsBeingRefreshed: C3.Array<string | null> | Array<string | null>): GenerateDataSpec;

  /**
   * For large batches of input obs, they will be committed to the database in batches of this size.
   */
  readonly commitSize?: number | null;
  withCommitSize(commitSize: number | null): GenerateDataSpec;
  ...
  withMetaOverride(metaOverride: boolean): GenerateDataSpec;
  ...
  withDisableAsyncProcessing(disableAsyncProcessing: boolean): GenerateDataSpec;
  ...
  withDisableBeforeCallbacks(disableBeforeCallbacks: boolean): GenerateDataSpec;
  ...
  withDisableAfterCallbacks(disableAfterCallbacks: boolean): GenerateDataSpec;
  ...
  withInclude(include: string | null): GenerateDataSpec;
  ...
  withReturnInclude(returnInclude: string | null): GenerateDataSpec;
  ...
  withIgnoreDuplicates(ignoreDuplicates: boolean): GenerateDataSpec;
  ...
  withForceUserUpdate(forceUserUpdate: boolean): GenerateDataSpec;
  ...
  withIgnoreSeed(ignoreSeed: boolean): GenerateDataSpec;
  ...
  withDontThrowOnBatchError(dontThrowOnBatchError: boolean): GenerateDataSpec;
  ...
  withCreateDirect(createDirect: boolean): GenerateDataSpec;

  /**
   * Indicates that the upsert request should not attempt to dedup incoming input.
   */
  readonly noHistoryDedup?: boolean;
  withNoHistoryDedup(noHistoryDedup: boolean): GenerateDataSpec;

  /**
   * Indicates which parent field should be used for deduping timed relations.
   */
  readonly timedRelationParentField?: string | null;
  withTimedRelationParentField(timedRelationParentField: string | null): GenerateDataSpec;
  ...
  withSaveVersion(saveVersion: boolean): GenerateDataSpec;

  /**
   * If true and the backing datastore supports it, conflicts on create will be ignored.
   */
  readonly ignoreCreateConflicts?: boolean;
  withIgnoreCreateConflicts(ignoreCreateConflicts: boolean): GenerateDataSpec;
  ...
  withForceTouch(forceTouch: boolean): GenerateDataSpec;
  ...
  withStmtTimeoutMs(stmtTimeoutMs: number | null): GenerateDataSpec;
  ...
  withIdempotent(idempotent: boolean): GenerateDataSpec;
  ...
  withStrictVersionCheck(strictVersionCheck: boolean): GenerateDataSpec;

  /**
   * Relative number of objects to generate.
   */
  readonly cardinality?: number | null;
  withCardinality(cardinality: number | null): GenerateDataSpec;

  /**
   * Spec describing random data generation options; only one of randomData or carbon parameters can be present.
   */
  readonly randomData?: RandomDataSpec | null | RandomTimeseriesDataSpec | null | null;
  withRandomData(randomData: IRandomDataSpec | null | IRandomTimeseriesDataSpec | null | null): GenerateDataSpec;

  /**
   * Carbon code that generates data; only one of randomData or carbon parameters can be present.
   */
  readonly carbon?: string | null;
  withCarbon(carbon: string | null): GenerateDataSpec;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): GenerateDataSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): GenerateDataSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): GenerateDataSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): GenerateDataSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): GenerateDataSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): GenerateDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): GenerateDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<GenerateDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<GenerateDataSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): GenerateDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenerateDataSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): GenerateDataSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): GenerateDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): GenerateDataSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): GenerateDataSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): GenerateDataSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): GenerateDataSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): GenerateDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): GenerateDataSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): GenerateDataSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): GenerateDataSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): GenerateDataSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): GenerateDataSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): GenerateDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): GenerateDataSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): GenerateDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): GenerateDataSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): GenerateDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): GenerateDataSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): GenerateDataSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): GenerateDataSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): GenerateDataSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): GenerateDataSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): GenerateDataSpec;

  mergeJson(json: any | null): GenerateDataSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): GenerateDataSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): GenerateDataSpec;
   ...
   */
  singletonArray(): C3.Array<GenerateDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<GenerateDataSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<GenerateDataSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<GenerateDataSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<GenerateDataSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, GenerateDataSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, GenerateDataSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<GenerateDataSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<GenerateDataSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): GenerateDataSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): GenerateDataSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): GenerateDataSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): GenerateDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): GenerateDataSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): GenerateDataSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): GenerateDataSpec;
   ...
   */
  static cachedEmptyInst(): GenerateDataSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<GenerateDataSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): GenerateDataSpec;

  /**
   * @return new instance of this spec with `retrySpec` set
   */
  withRetry(maxRetries?: number | null, initialSleepMillis?: number | null, exponent?: number | null): GenerateDataSpec | null;

  /**
   * @return instance of this spec with `retrySpec`'s `maxTotalMillis` set
   */
  static timeoutSeconds(secs: number | null): GenerateDataSpec;
}
