// TypeScript definitions for the C3 type CompoundMetricCache

/**
 * Cache for compound metrics.
 *
 * @remarks this represents a value passed to a method that expects an instance of CompoundMetricCache
 */
declare interface ICompoundMetricCache {
}

/**
 * Cache for compound metrics.
 *
 * @remarks this represents a made instance of CompoundMetricCache
 */
declare class CompoundMetricCache {
   ...
   */
  static get(key: string | null): C3.Map<string | null, CompoundMetric | null>;
   ...
   */
  static require(key: string | null): C3.Map<string | null, CompoundMetric | null>;
   ...
   */
  static put(key: string | null, value: C3.Map<string | null, CompoundMetric | null> | null): void;
   ...
   */
  static produce(key: string | null): C3.Map<string | null, CompoundMetric | null>;
   ...
   * should be cleared.
   */
  static produceAll(): C3.Map<string | null, C3.Map<string | null, CompoundMetric | null>>;

  /**
   * Optional override called when element is released from the cache. Should perform any external resources cleanup if
   * needed.
   */
  static release(key: string | null, value: C3.Map<string | null, CompoundMetric | null> | null): void;
   ...
   */
  static validate(value: C3.Map<string | null, CompoundMetric | null> | null): boolean;

  /**
   * @return all compound metrics
   */
  static metrics(): C3.Map<string | null, CompoundMetric | null>;
}
