// TypeScript definitions for the C3 type ListenerAsTsMetricExprsCache

/**
 * Various expressions for as timeseries metrics
 *
 * @remarks this represents a value passed to a method that expects an instance of ListenerAsTsMetricExprsCache
 */
declare interface IListenerAsTsMetricExprsCache {
}
 ...
 */
declare class ListenerAsTsMetricExprsCache {
   ...
   */
  static get(key: string | null): AsTsMetricExprs | null;
   ...
   */
  static require(key: string | null): AsTsMetricExprs;
   ...
   */
  static put(key: string | null, value: AsTsMetricExprs | null): void;
   ...
   */
  static produce(key: string | null): AsTsMetricExprs | null;
   ...
   * should be cleared.
   */
  static produceAll(): C3.Map<string | null, AsTsMetricExprs | null>;

  /**
   * Optional override called when element is released from the cache. Should perform any external resources cleanup if
   * needed.
   */
  static release(key: string | null, value: AsTsMetricExprs | null): void;
   ...
   */
  static validate(value: AsTsMetricExprs | null): boolean;
}
