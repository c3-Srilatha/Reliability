// TypeScript definitions for the C3 type CondaLibraryManager.Config

/**
 * Type for specifying different configurations used by {@link CondaLibraryManager}.
 *
 * @remarks this represents a value passed to a method that expects an instance of CondaLibraryManager.Config
 */
declare namespace CondaLibraryManager {
  export interface IConfig {
     ...
     */
    defaultChannels?: C3.Array<string | null> | Array<string | null>;
     ...
     */
    customChannels?: C3.Map<string | null, string | null> | {[key: string | null]: string | null};
     ...
     */
    trustedHostsPPI?: C3.Array<string | null> | Array<string | null>;
     ...
     */
    installRuntimeTimeouts?: C3.Map<string, Duration> | {[key: string]: IDuration};
     ...
     */
    resolveRuntimeTimeouts?: C3.Map<string, Duration> | {[key: string]: IDuration};
     ...
     * ```
     */
    otherOptions?: C3.Map<string, string> | {[key: string]: string};
  }
}
...
declare namespace CondaLibraryManager {
  export class Config extends Obj {
    ...
    withConfigOverride(configOverride: string | null): CondaLibraryManager.Config;

    static readonly configOverride?: string | null;

    readonly secretOverride?: string | null;
    withSecretOverride(secretOverride: string | null): CondaLibraryManager.Config;
    ...
    withIssues(issues: C3.Array<string | null> | Array<string | null>): CondaLibraryManager.Config;
     ...
     * from the Conda and PyPI repositories declared in the {@link CondaLibraryManager.Config}.
     */
    readonly useArtifactHub?: boolean;
    withUseArtifactHub(useArtifactHub: boolean): CondaLibraryManager.Config;
     ...
     * from the Conda and PyPI repositories declared in the {@link CondaLibraryManager.Config}.
     */
    static readonly useArtifactHub?: boolean;
    ...
    withChannelAlias(channelAlias: string): CondaLibraryManager.Config;
     ...
     * "conda-forge" will be https://conda.anaconda.org/conda-forge.
     */
    static readonly channelAlias: string;
     ...
     * C3 Conda library manager will use every Conda channel specified in the default channels to search for a package.
     */
    readonly defaultChannels?: C3.Array<string | null>;
    withDefaultChannels(defaultChannels: C3.Array<string | null> | Array<string | null>): CondaLibraryManager.Config;
     ...
     * C3 Conda library manager will use every Conda channel specified in the default channels to search for a package.
     */
    static readonly defaultChannels?: C3.Array<string | null>;
     ...
     * add an entry 'pkgs/main: https://my-local-repo.org/packages/pkgs/main'.
     */
    readonly customChannels?: C3.Map<string | null, string | null>;
    withCustomChannels(customChannels: C3.Map<string | null, string | null> | {[key: string | null]: string | null}): CondaLibraryManager.Config;
     ...
     * add an entry 'pkgs/main: https://my-local-repo.org/packages/pkgs/main'.
     */
    static readonly customChannels?: C3.Map<string | null, string | null>;
     ...
     * {@link https://pip.pypa.io/en/stable/cli/pip_install/#cmdoption-0 More information about Python Package Index}
     */
    readonly baseUrlPPI: string;
    withBaseUrlPPI(baseUrlPPI: string): CondaLibraryManager.Config;
     ...
     * {@link https://pip.pypa.io/en/stable/cli/pip_install/#cmdoption-0 More information about Python Package Index}
     */
    static readonly baseUrlPPI: string;

    /**
     * List of hosts or host:port pairs which will be marked as trusted by Python Package Index, even though it does not have valid or any HTTPS.
     * More information about {@link https://pip.pypa.io/en/stable/cli/pip/#cmdoption-trusted-host trusted host} in Python Package Index.
     */
    readonly trustedHostsPPI?: C3.Array<string | null>;
    withTrustedHostsPPI(trustedHostsPPI: C3.Array<string | null> | Array<string | null>): CondaLibraryManager.Config;

    /**
     * List of hosts or host:port pairs which will be marked as trusted by Python Package Index, even though it does not have valid or any HTTPS.
     * More information about {@link https://pip.pypa.io/en/stable/cli/pip/#cmdoption-trusted-host trusted host} in Python Package Index.
     */
    static readonly trustedHostsPPI?: C3.Array<string | null>;

    /**
     * This represents the socket timeout in seconds for pip commands. See parameter --timeout at
     * {@link https://pip.pypa.io/en/stable/cli/pip/ pip usage}.
     */
    readonly pipSocketTimeout?: number | null;
    withPipSocketTimeout(pipSocketTimeout: number | null): CondaLibraryManager.Config;

    /**
     * This represents the socket timeout in seconds for pip commands. See parameter --timeout at
     * {@link https://pip.pypa.io/en/stable/cli/pip/ pip usage}.
     */
    static readonly pipSocketTimeout?: number | null;

    /**
     * Override the default location of the {@link https://docs.conda.io/projects/conda/en/23.1.x/user-guide/configuration/use-condarc.html#specify-pkg-directories conda packages directory}.
     */
    readonly packageCachePath?: string | null;
    withPackageCachePath(packageCachePath: string | null): CondaLibraryManager.Config;

    /**
     * Override the default location of the {@link https://docs.conda.io/projects/conda/en/23.1.x/user-guide/configuration/use-condarc.html#specify-pkg-directories conda packages directory}.
     */
    static readonly packageCachePath?: string | null;

    readonly disableExtraSafetyChecks?: boolean;
    withDisableExtraSafetyChecks(disableExtraSafetyChecks: boolean): CondaLibraryManager.Config;

    static readonly disableExtraSafetyChecks?: boolean;

    /**
     * Timeout duration for install runtime process. The default seeded value is an hour.
     */
    readonly defaultInstallRuntimeTimeout: Duration;
    withDefaultInstallRuntimeTimeout(defaultInstallRuntimeTimeout: IDuration): CondaLibraryManager.Config;

    /**
     * Timeout duration for install runtime process. The default seeded value is an hour.
     */
    static readonly defaultInstallRuntimeTimeout: Duration;

    /**
     * Timeout duration for resolve runtime process. The default seeded value is an hour.
     */
    readonly defaultResolveRuntimeTimeout: Duration;
    withDefaultResolveRuntimeTimeout(defaultResolveRuntimeTimeout: IDuration): CondaLibraryManager.Config;

    /**
     * Timeout duration for resolve runtime process. The default seeded value is an hour.
     */
    static readonly defaultResolveRuntimeTimeout: Duration;
     ...
     * Value is timeout duration. Install runtime will fail if not completed within the specified duration. Retry installing or increasing the timeout duration if it repeats.
     */
    readonly installRuntimeTimeouts?: C3.Map<string, Duration>;
    withInstallRuntimeTimeouts(installRuntimeTimeouts: C3.Map<string, Duration> | {[key: string]: IDuration}): CondaLibraryManager.Config;
     ...
     * Value is timeout duration. Install runtime will fail if not completed within the specified duration. Retry installing or increasing the timeout duration if it repeats.
     */
    static readonly installRuntimeTimeouts?: C3.Map<string, Duration>;
     ...
     * Value is timeout duration. Resolve runtime will fail if not completed within the specified duration. Retry resolving or increasing the timeout duration if it repeats.
     */
    readonly resolveRuntimeTimeouts?: C3.Map<string, Duration>;
    withResolveRuntimeTimeouts(resolveRuntimeTimeouts: C3.Map<string, Duration> | {[key: string]: IDuration}): CondaLibraryManager.Config;
     ...
     * Value is timeout duration. Resolve runtime will fail if not completed within the specified duration. Retry resolving or increasing the timeout duration if it repeats.
     */
    static readonly resolveRuntimeTimeouts?: C3.Map<string, Duration>;
     ...
     * ```
     */
    readonly otherOptions?: C3.Map<string, string>;
    withOtherOptions(otherOptions: C3.Map<string, string> | {[key: string]: string}): CondaLibraryManager.Config;
     ...
     * ```
     */
    static readonly otherOptions?: C3.Map<string, string>;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): CondaLibraryManager.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): CondaLibraryManager.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): CondaLibraryManager.Config | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): CondaLibraryManager.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): CondaLibraryManager.Config;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): CondaLibraryManager.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): CondaLibraryManager.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): CondaLibraryManager.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): CondaLibraryManager.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): CondaLibraryManager.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<CondaLibraryManager.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<CondaLibraryManager.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<CondaLibraryManager.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<CondaLibraryManager.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): CondaLibraryManager.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): CondaLibraryManager.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CondaLibraryManager.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CondaLibraryManager.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CondaLibraryManager.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CondaLibraryManager.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): CondaLibraryManager.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): CondaLibraryManager.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): CondaLibraryManager.Config;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): CondaLibraryManager.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): CondaLibraryManager.Config;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): CondaLibraryManager.Config;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): CondaLibraryManager.Config;
     ...
     * @return new Obj
     */
    static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): CondaLibraryManager.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): CondaLibraryManager.Config;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): CondaLibraryManager.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): CondaLibraryManager.Config;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): CondaLibraryManager.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): CondaLibraryManager.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: string | null): CondaLibraryManager.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): CondaLibraryManager.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType | null): CondaLibraryManager.Config;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): CondaLibraryManager.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: C3.Array<string | null> | null): CondaLibraryManager.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): CondaLibraryManager.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): CondaLibraryManager.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): CondaLibraryManager.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): CondaLibraryManager.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): CondaLibraryManager.Config;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): CondaLibraryManager.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): CondaLibraryManager.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): CondaLibraryManager.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): CondaLibraryManager.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): CondaLibraryManager.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): CondaLibraryManager.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: string): CondaLibraryManager.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): CondaLibraryManager.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): CondaLibraryManager.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): CondaLibraryManager.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: string): CondaLibraryManager.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): CondaLibraryManager.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): CondaLibraryManager.Config;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): CondaLibraryManager.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): CondaLibraryManager.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): CondaLibraryManager.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj | null, otherFieldsFilter: Type): CondaLibraryManager.Config;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): CondaLibraryManager.Config;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): CondaLibraryManager.Config;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): CondaLibraryManager.Config;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): CondaLibraryManager.Config;

    mergeJson(json: any | null): CondaLibraryManager.Config;

    static mergeJson(json: any | null): CondaLibraryManager.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): CondaLibraryManager.Config;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): CondaLibraryManager.Config;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): CondaLibraryManager.Config;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj | null, deep?: boolean): CondaLibraryManager.Config;
     ...
     */
    singletonArray(): C3.Array<CondaLibraryManager.Config | null>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): C3.Array<CondaLibraryManager.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<CondaLibraryManager.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<CondaLibraryManager.Config | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<CondaLibraryManager.Config | null>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): C3.Set<CondaLibraryManager.Config | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<CondaLibraryManager.Config | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, CondaLibraryManager.Config | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, CondaLibraryManager.Config | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<CondaLibraryManager.Config | null>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<CondaLibraryManager.Config | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<CondaLibraryManager.Config | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): CondaLibraryManager.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): CondaLibraryManager.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): CondaLibraryManager.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): CondaLibraryManager.Config;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): CondaLibraryManager.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): CondaLibraryManager.Config;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): CondaLibraryManager.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): CondaLibraryManager.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): CondaLibraryManager.Config;
     ...
     */
    static cachedEmptyInst(): CondaLibraryManager.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<CondaLibraryManager.Config>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): CondaLibraryManager.Config;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<CondaLibraryManager.Config | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<CondaLibraryManager.Config | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<CondaLibraryManager.Config | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): CondaLibraryManager.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string | null): CondaLibraryManager.Config | null;
     ...
     * @see findByCacheKey
     */
    getCached(): CondaLibraryManager.Config | null;
     ...
     * @see findByCacheKey
     */
    static getCached(): CondaLibraryManager.Config | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): CondaLibraryManager.Config | null;

    /**
     * @return newly produced cached instance.
     */
    static refreshCache(): CondaLibraryManager.Config | null;
     ...
     */
    static produce(key: string): CondaLibraryManager.Config | null;
     ...
     */
    static produceAll(): C3.Map<string | null, CondaLibraryManager.Config | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, CondaLibraryManager.Config | null>;
     ...
     */
    getConfig(): CondaLibraryManager.Config;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): CondaLibraryManager.Config;
     ...
     */
    getSecret(): CondaLibraryManager.Config;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): CondaLibraryManager.Config;
     ...
     */
    static forConfigKey(configKey: string | null): CondaLibraryManager.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<CondaLibraryManager.Config | null>;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: CondaLibraryManager.Config, override?: string | null): void;

    /**
     * Sets multiple field values to be the same as the passed instance.
     * @see setConfigValue
     */
    static setConfigValues(from: CondaLibraryManager.Config, override?: string | null): void;
     ...
     * @see setSecretValue
     */
    setSecretValues(from: CondaLibraryManager.Config, override?: string | null): void;

    /**
     * Sets multiple secret field values to be the same as the passed instance.
     * @see setSecretValue
     */
    static setSecretValues(from: CondaLibraryManager.Config, override?: string | null): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): CondaLibraryManager.Config | null;
     ...
     */
    removeSecrets(): CondaLibraryManager.Config | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): CondaLibraryManager.Config | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): CondaLibraryManager.Config | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): CondaLibraryManager.Config | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): CondaLibraryManager.Config;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): CondaLibraryManager.Config;
