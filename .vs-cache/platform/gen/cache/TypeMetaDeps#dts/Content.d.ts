// TypeScript definitions for the C3 type Content
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Content
 */
 ...
 */
declare class Content extends Obj {
  ...
  withContentEncoding(contentEncoding: string | null): Content;
  ...
  withContentLanguage(contentLanguage: string | null): Content;
  ...
  withContentLength(contentLength: number | null): Content;
  ...
  withContentLocation(contentLocation: string | null): Content;
  ...
  withContentType(contentType: string | null): Content;
  ...
  withContentDisposition(contentDisposition: string | null): Content;
  ...
  withETag(eTag: string | null): Content;
  ...
  withLastModified(lastModified: DateTime | Date | string | null): Content;

  /**
   * Id of user / identity who last last modified this content.
   */
  readonly lastModifiedBy?: string | null;
  withLastModifiedBy(lastModifiedBy: string | null): Content;
  ...
  withContentMD5(contentMD5: string | null): Content;
  ...
  withContentSHA1(contentSHA1: string | null): Content;

  /**
   * Field to maintain state whether content metadata was read or not.
   */
  readonly hasMetadata?: boolean;
  withHasMetadata(hasMetadata: boolean): Content;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Content | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Content | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Content | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Content | null;
   ...
   */
  replaceType(old: Type, new_: Type): Content;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Content;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Content;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Content | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Content | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Content;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Content;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Content;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Content;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Content;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Content;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Content;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Content;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Content;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Content;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Content;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Content;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Content;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Content;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Content;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Content;
   ...
   * @see #removeField
   */
  unsetField(field: string): Content;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Content;
   ...
   * @see #unsetField
   */
  removeField(field: string): Content;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Content;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Content;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Content;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Content;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Content;

  mergeJson(json: any | null): Content;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Content;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Content;
   ...
   */
  singletonArray(): C3.Array<Content | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Content | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Content | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Content | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Content | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Content | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Content | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Content | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Content | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Content;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Content;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Content;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Content;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Content;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Content;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Content;
   ...
   */
  static cachedEmptyInst(): Content;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Content>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Content;
   ...
   */
  withFileName(fileName: string | null): Content;

  /**
   * Changes file extension in this instance.
   */
  withFileExt(fileExt: string | null): Content;
   ...
   */
  identify(suffix?: string | null): Content;
   ...
   */
  readMetadata(spec?: FileOperationSpec | null): Content;
   ...
   */
  refreshMetadata(spec?: FileOperationSpec | null): Content;
   ...
   */
  encodedPushStream(spec?: FileOperationSpec | null): Pair<Content | null, BytePushStream | null>;

  /**
   * @return byte push stream to be used for writing un-encoded data into this content object.
   */
  pushStream(spec?: FileOperationSpec | null): Pair<Content | null, BytePushStream | null>;

  /**
   * @return character push stream to be used for writing un-encoded data into this content object.
   */
  charPushStream(spec?: FileOperationSpec | null): Pair<Content | null, CharPushStream | null>;
   ...
   */
  encodedStream(spec?: FileOperationSpec | null): Pair<Content | null, ByteStream | null> | null;
   ...
   */
  writeStream(content: ByteStream | null, spec?: FileOperationSpec | null): Content;

  /**
   * Truncates file and replaces it's content with provided binary content.
   */
  writeInputStream(inputStream: any, spec?: FileOperationSpec | null): Content;

  /**
   * Truncates file and replaces its content with provided binary content from zipInputStream
   */
  writeZipInputStream(zipInputStream: any, spec?: FileOperationSpec | null): Content;
   ...
   */
  writeEncodedStream(encodedContent: ByteStream | null, spec?: FileOperationSpec | null): Content;

  /**
   * Truncates file and replaces it's encoded content with provided binary content.
   */
  writeEncodedInputStream(inputStream: any, spec?: FileOperationSpec | null): Content;
   ...
   *           content that needs to be written
   */
  write(content: any | null, spec?: FileOperationSpec | null): Content;
   ...
   *           encoded content that needs to be written
   */
  writeEncoded(encodedContent: any | null, spec?: FileOperationSpec | null): Content;
   ...
   *           content that needs to be written
   */
  writeString(content: string | null, spec?: FileOperationSpec | null): Content;
   ...
   */
  writeObj(obj: Obj | null, spec?: FileObjsOperSpec | null): Content;
   ...
   * @return pair of update instance of this content and number of objs written
   */
  startWriteObjs(spec?: FileObjsOperSpec | null): Pair<Content | null, PushStream<Obj | null> | null>;
   ...
   */
  compress(contentEncoding?: string | null, spec?: FileCompressSpec | null): Content;

  /**
   * Uncompresses content.
   */
  uncompress(spec?: FileCompressSpec | null): Content;
   ...
   */
  transcode(contentType: string, contentEncoding: string, spec?: FileCompressSpec | null): Content;

  /**
   * Copies content to a given target.
   */
  copyContentTo(target: Content, spec?: FileOperationSpec | null): void;
