// TypeScript definitions for the C3 type PendingRefreshUniqueIndexesReq

/**
 * Pending newly created/modified unique indexes that require refreshing found in provisioning.
 *
 * @remarks this represents a value passed to a method that expects an instance of PendingRefreshUniqueIndexesReq
 */
declare interface IPendingRefreshUniqueIndexesReq {
 ...
 * Pending newly created/modified unique indexes that require refreshing found in provisioning.
 *
 * @remarks this represents a made instance of PendingRefreshUniqueIndexesReq
 */
declare class PendingRefreshUniqueIndexesReq extends Obj {
  ...
  withTypeIdent(typeIdent: string | null): PendingRefreshUniqueIndexesReq;
   ...
   */
  readonly id: string;
  withId(id: string): PendingRefreshUniqueIndexesReq;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): PendingRefreshUniqueIndexesReq;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): PendingRefreshUniqueIndexesReq;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): PendingRefreshUniqueIndexesReq;
  ...
  withVersion(version: number | null): PendingRefreshUniqueIndexesReq;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): PendingRefreshUniqueIndexesReq;

  /**
   * Type to refresh.
   */
  readonly refreshType?: Type | null;
  withRefreshType(refreshType: IType | null): PendingRefreshUniqueIndexesReq;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): PendingRefreshUniqueIndexesReq | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): PendingRefreshUniqueIndexesReq | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): PendingRefreshUniqueIndexesReq | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): PendingRefreshUniqueIndexesReq | null;
   ...
   */
  replaceType(old: Type, new_: Type): PendingRefreshUniqueIndexesReq;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PendingRefreshUniqueIndexesReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PendingRefreshUniqueIndexesReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PendingRefreshUniqueIndexesReq | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PendingRefreshUniqueIndexesReq | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): PendingRefreshUniqueIndexesReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PendingRefreshUniqueIndexesReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PendingRefreshUniqueIndexesReq;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PendingRefreshUniqueIndexesReq;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PendingRefreshUniqueIndexesReq;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PendingRefreshUniqueIndexesReq;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): PendingRefreshUniqueIndexesReq;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PendingRefreshUniqueIndexesReq;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PendingRefreshUniqueIndexesReq;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): PendingRefreshUniqueIndexesReq;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): PendingRefreshUniqueIndexesReq;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): PendingRefreshUniqueIndexesReq;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): PendingRefreshUniqueIndexesReq;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PendingRefreshUniqueIndexesReq;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): PendingRefreshUniqueIndexesReq;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PendingRefreshUniqueIndexesReq;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PendingRefreshUniqueIndexesReq;
   ...
   * @see #removeField
   */
  unsetField(field: string): PendingRefreshUniqueIndexesReq;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PendingRefreshUniqueIndexesReq;
   ...
   * @see #unsetField
   */
  removeField(field: string): PendingRefreshUniqueIndexesReq;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PendingRefreshUniqueIndexesReq;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): PendingRefreshUniqueIndexesReq;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): PendingRefreshUniqueIndexesReq;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): PendingRefreshUniqueIndexesReq;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): PendingRefreshUniqueIndexesReq;

  mergeJson(json: any | null): PendingRefreshUniqueIndexesReq;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): PendingRefreshUniqueIndexesReq;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): PendingRefreshUniqueIndexesReq;
   ...
   */
  singletonArray(): C3.Array<PendingRefreshUniqueIndexesReq | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<PendingRefreshUniqueIndexesReq | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PendingRefreshUniqueIndexesReq | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<PendingRefreshUniqueIndexesReq | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PendingRefreshUniqueIndexesReq | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, PendingRefreshUniqueIndexesReq | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PendingRefreshUniqueIndexesReq | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PendingRefreshUniqueIndexesReq | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PendingRefreshUniqueIndexesReq | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): PendingRefreshUniqueIndexesReq;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): PendingRefreshUniqueIndexesReq;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): PendingRefreshUniqueIndexesReq;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PendingRefreshUniqueIndexesReq;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): PendingRefreshUniqueIndexesReq;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PendingRefreshUniqueIndexesReq;
   ...
   * @see #fromString
   */
  static make(s: string | null): PendingRefreshUniqueIndexesReq | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): PendingRefreshUniqueIndexesReq;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): PendingRefreshUniqueIndexesReq;
   ...
   */
  static cachedEmptyInst(): PendingRefreshUniqueIndexesReq;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<PendingRefreshUniqueIndexesReq>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): PendingRefreshUniqueIndexesReq;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<PendingRefreshUniqueIndexesReq | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PendingRefreshUniqueIndexesReq | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<PendingRefreshUniqueIndexesReq | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<PendingRefreshUniqueIndexesReq | null> | null>;
   ...
   */
  get(include?: string | null): PendingRefreshUniqueIndexesReq | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): PendingRefreshUniqueIndexesReq | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PendingRefreshUniqueIndexesReq;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): PendingRefreshUniqueIndexesReq | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PendingRefreshUniqueIndexesReq;
   ...
   * @see #toString
   */
  static fromString(s: string | null): PendingRefreshUniqueIndexesReq | null;
   ...
   */
  create(spec?: UpsertSpec | null): PendingRefreshUniqueIndexesReq | null;
   ...
   */
  static createBatch(objs: C3.Array<PendingRefreshUniqueIndexesReq | null> | null, spec?: UpsertSpec | null): ObjList<PendingRefreshUniqueIndexesReq | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PendingRefreshUniqueIndexesReq | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<PendingRefreshUniqueIndexesReq | null> | null;
   ...
   */
  update(srcObj?: PendingRefreshUniqueIndexesReq | null, spec?: UpsertSpec | null): PendingRefreshUniqueIndexesReq | null;
   ...
   */
  upsert(srcObj?: PendingRefreshUniqueIndexesReq | null, spec?: UpsertSpec | null): PendingRefreshUniqueIndexesReq | null;
   ...
   */
  merge(spec?: MergeSpec | null): PendingRefreshUniqueIndexesReq | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): PendingRefreshUniqueIndexesReq | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): PendingRefreshUniqueIndexesReq | null;
   ...
   */
  static updateBatch(objs: C3.Array<PendingRefreshUniqueIndexesReq | null> | null, srcObjs?: C3.Array<PendingRefreshUniqueIndexesReq | null>, spec?: UpsertSpec | null): ObjList<PendingRefreshUniqueIndexesReq | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<PendingRefreshUniqueIndexesReq | null>>, spec?: UpsertSpec | null): ObjList<PendingRefreshUniqueIndexesReq | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<PendingRefreshUniqueIndexesReq | null> | null, srcObjs?: C3.Array<PendingRefreshUniqueIndexesReq | null>, spec?: UpsertSpec | null): ObjList<PendingRefreshUniqueIndexesReq | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<PendingRefreshUniqueIndexesReq | null>>, spec?: UpsertSpec | null): ObjList<PendingRefreshUniqueIndexesReq | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<PendingRefreshUniqueIndexesReq | null> | null, spec?: TouchSpec | null): ObjList<PendingRefreshUniqueIndexesReq | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PendingRefreshUniqueIndexesReq | null> | null, spec?: MergeSpec | null): ObjList<PendingRefreshUniqueIndexesReq | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PendingRefreshUniqueIndexesReq | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<PendingRefreshUniqueIndexesReq | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<PendingRefreshUniqueIndexesReq | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<PendingRefreshUniqueIndexesReq | null> | null;
   ...
   */
  static mergeAll(mergeObj: PendingRefreshUniqueIndexesReq | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PendingRefreshUniqueIndexesReq | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<PendingRefreshUniqueIndexesReq | null> | null, spec?: UpsertSpec | null): ObjList<PendingRefreshUniqueIndexesReq | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<PendingRefreshUniqueIndexesReq | null> | null, spec?: UpsertSpec | null): ObjList<PendingRefreshUniqueIndexesReq | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): PendingRefreshUniqueIndexesReq | null;
   ...
   */
  static beforeCreate(objs: C3.Array<PendingRefreshUniqueIndexesReq | null> | null): ObjList<PendingRefreshUniqueIndexesReq | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<PendingRefreshUniqueIndexesReq | null> | null): ObjList<PendingRefreshUniqueIndexesReq | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<PendingRefreshUniqueIndexesReq | null> | null): ObjList<PendingRefreshUniqueIndexesReq | null>;
   ...
   */
  static afterCreate(objs: C3.Array<PendingRefreshUniqueIndexesReq | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<PendingRefreshUniqueIndexesReq | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<PendingRefreshUniqueIndexesReq | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<PendingRefreshUniqueIndexesReq | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<PendingRefreshUniqueIndexesReq | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): PendingRefreshUniqueIndexesReq | null;
   ...
   */
  withoutIdentity(): PendingRefreshUniqueIndexesReq | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<PendingRefreshUniqueIndexesReq | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: PendingRefreshUniqueIndexesReq | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<PendingRefreshUniqueIndexesReq | null> | null, callback?: λFunction<PendingRefreshUniqueIndexesReq | null, PendingRefreshUniqueIndexesReq | null> | null): ObjList<PendingRefreshUniqueIndexesReq | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<PendingRefreshUniqueIndexesReq | null> | null, callback?: λFunction<PendingRefreshUniqueIndexesReq | null, PendingRefreshUniqueIndexesReq | null> | null): C3.Array<ObjError | null>;
