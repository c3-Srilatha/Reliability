// TypeScript definitions for the C3 type Persistable
 ...
 * effectively.
 *
 * @remarks this represents a value passed to a method that expects an instance of Persistable
 */
declare interface IPersistable {
 ...
 */
declare class Persistable extends Obj {
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): Persistable;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): Persistable;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): Persistable;
  ...
  withVersion(version: number | null): Persistable;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): Persistable;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): Persistable | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): Persistable | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): Persistable | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): Persistable | null;
   ...
   */
  replaceType(old: Type, new_: Type): Persistable;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Persistable;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Persistable;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Persistable | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Persistable | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Persistable;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Persistable;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Persistable;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): Persistable;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): Persistable;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): Persistable;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Persistable;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Persistable;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): Persistable;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): Persistable;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): Persistable;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): Persistable;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Persistable;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): Persistable;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Persistable;
   ...
   * @see #unsetField
   */
  defaultField(field: string): Persistable;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): Persistable;
   ...
   * @see #removeField
   */
  unsetField(field: string): Persistable;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): Persistable;
   ...
   * @see #unsetField
   */
  removeField(field: string): Persistable;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): Persistable;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Persistable;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): Persistable;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Persistable;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Persistable;

  mergeJson(json: any | null): Persistable;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Persistable;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): Persistable;
   ...
   */
  singletonArray(): C3.Array<Persistable | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<Persistable | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<Persistable | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<Persistable | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<Persistable | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, Persistable | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, Persistable | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<Persistable | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<Persistable | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Persistable;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Persistable;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Persistable;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): Persistable;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Persistable;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): Persistable;
   ...
   * @see #fromString
   */
  static make(s: string | null): Persistable | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Persistable;
   ...
   */
  static cachedEmptyInst(): Persistable;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Persistable>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): Persistable;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<Persistable | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<Persistable | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<Persistable | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<Persistable | null> | null>;
   ...
   */
  get(include?: string | null): Persistable | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): Persistable | null;
   ...
   */
  getMissing(spec: GetMissingSpec): Persistable;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): Persistable | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): Persistable;
   ...
   * @see #toString
   */
  static fromString(s: string | null): Persistable | null;
   ...
   */
  create(spec?: UpsertSpec | null): Persistable | null;
   ...
   */
  static createBatch(objs: C3.Array<Persistable | null> | null, spec?: UpsertSpec | null): ObjList<Persistable | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<Persistable | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<Persistable | null> | null;
   ...
   */
  update(srcObj?: Persistable | null, spec?: UpsertSpec | null): Persistable | null;
   ...
   */
  upsert(srcObj?: Persistable | null, spec?: UpsertSpec | null): Persistable | null;
   ...
   */
  merge(spec?: MergeSpec | null): Persistable | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): Persistable | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): Persistable | null;
   ...
   */
  static updateBatch(objs: C3.Array<Persistable | null> | null, srcObjs?: C3.Array<Persistable | null>, spec?: UpsertSpec | null): ObjList<Persistable | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<Persistable | null>>, spec?: UpsertSpec | null): ObjList<Persistable | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<Persistable | null> | null, srcObjs?: C3.Array<Persistable | null>, spec?: UpsertSpec | null): ObjList<Persistable | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<Persistable | null>>, spec?: UpsertSpec | null): ObjList<Persistable | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<Persistable | null> | null, spec?: TouchSpec | null): ObjList<Persistable | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Persistable | null> | null, spec?: MergeSpec | null): ObjList<Persistable | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<Persistable | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<Persistable | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<Persistable | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<Persistable | null> | null;
   ...
   */
  static mergeAll(mergeObj: Persistable | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: Persistable | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<Persistable | null> | null, spec?: UpsertSpec | null): ObjList<Persistable | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<Persistable | null> | null, spec?: UpsertSpec | null): ObjList<Persistable | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<Persistable | null> | null): ObjList<Persistable | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<Persistable | null> | null): ObjList<Persistable | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<Persistable | null> | null): ObjList<Persistable | null>;
   ...
   */
  static afterCreate(objs: C3.Array<Persistable | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<Persistable | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<Persistable | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<Persistable | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<Persistable | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): Persistable | null;
   ...
   */
  withoutIdentity(): Persistable | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<Persistable | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: Persistable | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<Persistable | null> | null, callback?: λFunction<Persistable | null, Persistable | null> | null): ObjList<Persistable | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<Persistable | null> | null, callback?: λFunction<Persistable | null, Persistable | null> | null): C3.Array<ObjError | null>;
