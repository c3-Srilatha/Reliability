// TypeScript definitions for the C3 type DeclaredReferenceType

/**
 * @remarks this represents a value passed to a method that expects an instance of DeclaredReferenceType
 */
declare interface IDeclaredReferenceType {
  ...
  /**
   * The list of type variable bindings associated with the named type if it is parametric.
   * Reference bindings are expected to be in the same order as the variables declared on the parametric type.
   */
  refVarBindings?: C3.Array<ValueType | null> | Array<IValueType | null>;

  /**
   * If the variable reference has a restriction, that will limit the types that can be bound.
   * For example: `type Foo<X: Mammal>` can only be bound to a type that `isA(Mammal)`.
   *
   * @see VarReferenceType#restriction
   */
  restriction?: IValueType | null;

  /**
   * If the reference has a _meta_ restriction, that will limit the type of values to which it can be set.
   * Note that this sort of restriction is on the type of the value itself, not on its generic bindings.
   * For example: `Type<<Mammal>>` reference instances can only be sub types of `Mammal`.
   *
   * @see TypeMeta#metaRestriction
   */
  metaRestriction?: IValueType | null;
}

/**
 * @remarks this represents a made instance of DeclaredReferenceType
 */
declare class DeclaredReferenceType extends Obj {

  /**
   * Source file Pkg.Path a C3 Type declaration [.c3typ].
   */
  readonly declaredPkgPath?: string | null;
  withDeclaredPkgPath(declaredPkgPath: string | null): DeclaredReferenceType;

  /**
   * Source line number in a C3 Type declaration [.c3typ] file starting with 1 where this metadata element is declared.
   */
  readonly declaredSrcLine?: number | null;
  withDeclaredSrcLine(declaredSrcLine: number | null): DeclaredReferenceType;
  ...
  withDeclaredSrcCharInLine(declaredSrcCharInLine: number | null): DeclaredReferenceType;
   ...
   */
  readonly pkg: Pkg;
  withPkg(pkg: IPkg): DeclaredReferenceType;

  /**
   * SDK json representing instance of this type
   */
  readonly json?: any;
  withJson(json: any): DeclaredReferenceType;

  /**
   * The set of annotations defined on this element of metadata represented as json value.
   */
  readonly annotationsJson?: any | null;
  withAnnotationsJson(annotationsJson: any | null): DeclaredReferenceType;
  ...
  withModifier(modifier: string | null): DeclaredReferenceType;
  ...
  withName(name: string): DeclaredReferenceType;
  ...
  withMixing(mixing: boolean): DeclaredReferenceType;
   ...
   * ```
   */
  readonly hadDeclaredVarBindings?: boolean;
  withHadDeclaredVarBindings(hadDeclaredVarBindings: boolean): DeclaredReferenceType;

  /**
   * The list of type variable bindings associated with the named type if it is parametric.
   * Reference bindings are expected to be in the same order as the variables declared on the parametric type.
   */
  readonly refVarBindings?: C3.Array<ValueType | null>;
  withRefVarBindings(refVarBindings: C3.Array<ValueType | null> | Array<IValueType | null>): DeclaredReferenceType;
   ...
   * @see VarReferenceType#restriction
   */
  readonly restriction?: ValueType | null;
  withRestriction(restriction: IValueType | null): DeclaredReferenceType;
   ...
   * @see TypeMeta#metaRestriction
   */
  readonly metaRestriction?: ValueType | null;
  withMetaRestriction(metaRestriction: IValueType | null): DeclaredReferenceType;
   ...
   */
  replaceType(old: Type, new_: Type): DeclaredReferenceType;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): DeclaredReferenceType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): DeclaredReferenceType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): DeclaredReferenceType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): DeclaredReferenceType | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DeclaredReferenceType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DeclaredReferenceType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DeclaredReferenceType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DeclaredReferenceType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DeclaredReferenceType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DeclaredReferenceType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DeclaredReferenceType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DeclaredReferenceType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DeclaredReferenceType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DeclaredReferenceType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DeclaredReferenceType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DeclaredReferenceType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DeclaredReferenceType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): DeclaredReferenceType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): DeclaredReferenceType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): DeclaredReferenceType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DeclaredReferenceType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DeclaredReferenceType;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DeclaredReferenceType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DeclaredReferenceType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DeclaredReferenceType;
   ...
   * @see #removeField
   */
  unsetField(field: string): DeclaredReferenceType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DeclaredReferenceType;
   ...
   * @see #unsetField
   */
  removeField(field: string): DeclaredReferenceType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DeclaredReferenceType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DeclaredReferenceType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): DeclaredReferenceType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DeclaredReferenceType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DeclaredReferenceType;

  mergeJson(json: any | null): DeclaredReferenceType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DeclaredReferenceType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): DeclaredReferenceType;
   ...
   */
  singletonArray(): C3.Array<DeclaredReferenceType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<DeclaredReferenceType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DeclaredReferenceType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<DeclaredReferenceType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DeclaredReferenceType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, DeclaredReferenceType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DeclaredReferenceType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DeclaredReferenceType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DeclaredReferenceType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DeclaredReferenceType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DeclaredReferenceType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DeclaredReferenceType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DeclaredReferenceType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DeclaredReferenceType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DeclaredReferenceType;
   ...
   * @see #fromString
   */
  static make(s: string | null): DeclaredReferenceType | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DeclaredReferenceType;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): DeclaredReferenceType;
   ...
   */
  static cachedEmptyInst(): DeclaredReferenceType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DeclaredReferenceType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): DeclaredReferenceType;
   ...
   */
  withoutDeclaredSrcPos(recursive?: boolean): DeclaredReferenceType;
   ...
   */
  withAnnotation(ann: Annotation): DeclaredReferenceType;
   ...
   *         value for the field
   */
  withAnnotation(ann: string, annField?: string | null, value?: any): DeclaredReferenceType;
   ...
   * @see #toString
   */
  static fromString(s: string | null): DeclaredReferenceType | null;
   ...
   * @return loaded type
   */
  dereferenceMeta(scope: TypesysScope, bindAll: boolean, failIfMissing: boolean): TypeMeta | null;
   ...
   */
  static guessType(value: any, failIfNone?: boolean): ReferenceType | null;

  /**
   * Guess the corresponding ReferenceType from Java class.
   */
  static guessTypeFromJavaClass(value: any, failIfNone?: boolean): ReferenceType | null;
   ...
   * @see #guessType
   */
  static guessConvertibleType(value: any, testContent?: boolean, failIfNone?: boolean): ReferenceType | null;
   ...
   */
  unboxValueType(failIfNot?: boolean): ValueType | null;

  /**
   * Returns array type that this type boxes or null.
   */
  unboxArrayType(failIfNot?: boolean): ArrayType | null;

  /**
   * Returns map type that this type boxes or null.
   */
  unboxMapType(failIfNot?: boolean): MapType | null;

  /**
   * @return builder of array of Objs of referenced type.
   */
  makeBuilder(initial?: O | null): ObjBuilder<O>;

  convertObj(obj: Obj | null, failIfInvalid?: boolean): Obj | null;

  /**
   * @return built reference type based on scope of provided parent C3 type.
   */
  buildReferenceType(scope: TypesysScope, nonEmpty: boolean, bindAll: boolean, context: λSupplier<string>): ReferenceType | null;

  /**
   * @return built variable reference type based on scope of provided parent C3 type.
   */
  buildVarReferenceType(scope: TypesysScope, nonEmpty: boolean, context: λSupplier<string>): VarReferenceType | null;

  static fromTypeMeta(referencedType: TypeMeta): DeclaredReferenceType;

  toDeclared(): DeclaredReferenceType;

  /**
   * Whether this reference has generic variable bindings. This may not make the reference type fully bound if some of
   * the bindings are to variables.
   */
  hasRefVarBindings(): boolean;
}
