// TypeScript definitions for the C3 type VoidType

/**
 * The "void" value type represents that _no_ value is expected. It is declared in DSL simply as `void`.
 *
 * The only legal value for this type is `null`, but more importantly its use indicates that there will never be a
 * meaningful value in this context.
 *
 * This type may be used in the DSL to indicate no value is expected, for example in declaring that a generic binding
 * will never have a value:
 * ```type
 * type Pipeline.Step<In, Out>
 *
 * type Pipeline.Sink<In> mixes Pipeline.Step<In, void>
 * ```
 *
 * Note that {@link ValueType#guessType} will never return this type; it returns `null` instead. Similarly,
 * {@link FunctionType#returnType} returns `null` if there is no return value type declared.
 *
 * This is also not a data type (more of a special marker), so it cannot explicitly be used for a field,
 * method parameter or return value. These can _implicitly_ become `void` through a generic binding. For example
 * **Foo** is generic:
 *
 * ```c3typ
 * type Foo<T> {
 *   f: T
 *   getF: member function(): T
 *   compareToF: member function(v: T): @comparator int32
 * }
 * ```
 *
 * A binding of `T` to `void` means the field, `getF` return value, and `compareTo` parameter will all be of void type:
 *
 * ```c3typ
 * type VoidFoo mixes Foo<void>
 * ```
 *
 * @remarks this represents a value passed to a method that expects an instance of VoidType
 */
declare interface IVoidType {
 ...
 * ```
 *
 * @remarks this represents a made instance of VoidType
 */
declare class VoidType extends Obj {

  /**
   * Source file Pkg.Path a C3 Type declaration [.c3typ].
   */
  readonly declaredPkgPath?: string | null;
  withDeclaredPkgPath(declaredPkgPath: string | null): VoidType;

  /**
   * Source file Pkg.Path a C3 Type declaration [.c3typ].
   */
  static readonly declaredPkgPath?: string | null;

  /**
   * Source line number in a C3 Type declaration [.c3typ] file starting with 1 where this metadata element is declared.
   */
  readonly declaredSrcLine?: number | null;
  withDeclaredSrcLine(declaredSrcLine: number | null): VoidType;

  /**
   * Source line number in a C3 Type declaration [.c3typ] file starting with 1 where this metadata element is declared.
   */
  static readonly declaredSrcLine?: number | null;
  ...
  withDeclaredSrcCharInLine(declaredSrcCharInLine: number | null): VoidType;

  /**
   * Source character position in a line in a C3 Type declaration [.c3typ] file starting with 1 where this metadata
   * element is declared.
   */
  static readonly declaredSrcCharInLine?: number | null;
   ...
   */
  readonly json?: any;
  withJson(json: any): VoidType;

  /**
   * SDK json representing instance of this type
   */
  static readonly json?: any;

  /**
   * The set of annotations defined on this element of metadata represented as json value.
   */
  readonly annotationsJson?: any | null;
  withAnnotationsJson(annotationsJson: any | null): VoidType;

  /**
   * The set of annotations defined on this element of metadata represented as json value.
   */
  static readonly annotationsJson?: any | null;
  ...
  withModifier(modifier: string | null): VoidType;
   ...
   * @see FunctionParam#isNonOptional
   */
  static readonly modifier?: string | null;
   ...
   */
  replaceType(old: Type, new_: Type): VoidType;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): VoidType;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): VoidType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): VoidType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): VoidType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): VoidType | null;
   ...
   * Whether the specified instance represents exactly the same object as this instance.
   */
  static isSame(other: Obj | null): boolean;
   ...
   * @see #isConvertibleFrom
   */
  static isSame(other: ValueType): boolean;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VoidType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VoidType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VoidType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VoidType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VoidType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VoidType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VoidType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VoidType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): VoidType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): VoidType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VoidType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VoidType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VoidType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VoidType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): VoidType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): VoidType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): VoidType;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): VoidType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): VoidType;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): VoidType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): VoidType;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): VoidType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): VoidType;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): VoidType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): VoidType;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): VoidType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): VoidType;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): VoidType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): VoidType;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): VoidType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): VoidType;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): VoidType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): VoidType;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): VoidType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): VoidType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): VoidType;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): VoidType;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): VoidType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): VoidType;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): VoidType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): VoidType;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): VoidType;
   ...
   * @see #removeField
   */
  unsetField(field: string): VoidType;
   ...
   * @see #removeField
   */
  static unsetField(field: string): VoidType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): VoidType;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): VoidType;
   ...
   * @see #unsetField
   */
  removeField(field: string): VoidType;
   ...
   * @see #unsetField
   */
  static removeField(field: string): VoidType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): VoidType;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): VoidType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): VoidType;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): VoidType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): VoidType;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): VoidType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): VoidType;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): VoidType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): VoidType;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): VoidType;

  mergeJson(json: any | null): VoidType;

  static mergeJson(json: any | null): VoidType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): VoidType;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): VoidType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): VoidType;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): VoidType;
   ...
   */
  singletonArray(): C3.Array<VoidType | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<VoidType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<VoidType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<VoidType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<VoidType | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<VoidType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<VoidType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, VoidType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, VoidType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<VoidType | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<VoidType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<VoidType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): VoidType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): VoidType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): VoidType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): VoidType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): VoidType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): VoidType;
   ...
   * @see #fromString
   */
  static make(s: string | null): VoidType | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): VoidType;
   ...
   */
  static cachedEmptyInst(): VoidType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<VoidType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): VoidType;
   ...
   * The version of the package where this type was declared.
   */
  static get packageVersionMajorMinor(): SemanticVersion.MajorMinor;
   ...
   * Pkg where this type was declared, note could be different then #pkg.
   */
  static get declaredPkg(): Pkg;

  get metadataPath(): string | null;

  static get metadataPath(): string | null;
   ...
   * execution time.
   */
  static toTypesysJson(): Typesys.Json;
   ...
   */
  withoutDeclaredSrcPos(recursive?: boolean): VoidType;

  /**
   * @return an instance with the #declaredSrcLine and #declaredSrcCharInLine fields unset.
   */
  static withoutDeclaredSrcPos(recursive?: boolean): VoidType;
   ...
   * If not overridden, by default this returns #annotationJson
   */
  static mergedAnnotationsJson(): any | null;
   ...
   * The declared annotations for this metadata element.
   */
  static declaredAnnotations(): Annotations;
   ...
   * Whether this metadata element has annotation with provided name.
   */
  static hasAnnotation(ann: string | null): boolean;
   ...
   * Whether this metadata element has annotation field value.
   */
  static hasAnnotationValue(ann: string | null, annField: string | null): boolean;
   ...
   * @return annotation with provided name
   */
  static annotation(ann: string | null, failIfMissing?: boolean): Annotation | null;
   ...
   * @return annotation value for provided annotation name and annotation field
   */
  static annotationValue(ann: string | null, annField: string | null): any;

  /**
   * Add an annotation to the given metadata
   */
  withAnnotation(ann: Annotation): VoidType;

  /**
   * Add an annotation to the given metadata
   */
  static withAnnotation(ann: Annotation): VoidType;
   ...
   *         value for the field
   */
  withAnnotation(ann: string, annField?: string | null, value?: any): VoidType;
   ...
   *         value for the field
   */
  static withAnnotation(ann: string, annField?: string | null, value?: any): VoidType;
   ...
   * normally inherited, but ones marked with {@link Annotation#noInherit} will not be.
   */
  static inheritableAnnotationsJson(): any | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): VoidType | null;
  ...
  static cachedFingerprint(): number;
   ...
   * Whether this value type can be streamed as C3 action argument, e.g. over HTTP.
   */
  static isStreamableArg(): boolean;
   ...
   * Whether this value type can be streamed as C3 action result, e.g. over HTTP.
   */
  static isStreamableResult(): boolean;
   ...
   * Whether this value type is a declared reference to a type or method generic variable.
   */
  static isDeclaredReference(): boolean;
   ...
   * @see BigIntType
   */
  static isIntegralNumber(): boolean;
   ...
   * serialization.
   */
  static isBoxedForSerialization(): boolean;
   ...
   * Whether this value type is a reference to a primitive value boxed in an instance of Boxed C3 type.
   */
  static isBoxedPrimitive(): boolean;
   ...
   * @see Boxed
   */
  static isBoxedCollection(): boolean;
   ...
   * @see ReferenceType
   */
  static isRefCollection(): boolean;
   ...
   * @see #isNonEmpty
   */
  static isNonOptionalParam(): boolean;
   ...
   * @see NumberType
   */
  static isNumCollection(): boolean;
   ...
   * @see StringType
   */
  static isStrCollection(): boolean;
   ...
   * compares the exact type.
   */
  static isReferenceTo(type: Type | null | string | null): boolean;
   ...
   * @return primitive type or null
   */
  static asPrimitiveType(failIfNot?: boolean, source?: λSupplier<string | null> | null): PrimitiveType | null;
   ...
   * @return native type or null
   */
  static asNumberType(failIfNot?: boolean, source?: λSupplier<string | null> | null): NumberType | null;
   ...
   * @return native type or null
   */
  static asDateTimeType(failIfNot?: boolean, source?: λSupplier<string | null> | null): DateTimeType | null;
   ...
   * @return native type or null
   */
  static asStringType(failIfNot?: boolean, source?: λSupplier<string | null> | null): StringType | null;
   ...
   * @return reference type or null
   */
  static asReferenceType(failIfNot?: boolean, source?: λSupplier<string | null> | null): ReferenceType | null;
   ...
   * @return var reference type or null
   */
  static asVarReferenceType(failIfNot?: boolean, source?: λSupplier<string | null> | null): VarReferenceType | null;
   ...
   * @return declared reference type or null
   */
  static asDeclaredReferenceType(failIfNot?: boolean, source?: λSupplier<string | null> | null): DeclaredReferenceType | null;
   ...
   * @return collection type or null
   */
  static asCollectionType(failIfNot?: boolean, source?: λSupplier<string | null> | null): CollectionType | null;
   ...
   * @return array type or null
   */
  static asArrayType(failIfNot?: boolean, source?: λSupplier<string | null> | null): ArrayType | null;
   ...
   * @return set type or null
   */
  static asSetType(failIfNot?: boolean, source?: λSupplier<string | null> | null): SetType | null;
   ...
   * @return map type or null
   */
  static asMapType(failIfNot?: boolean, source?: λSupplier<string | null> | null): MapType | null;
   ...
   * @return stream type or null
   */
  static asStreamType(failIfNot?: boolean, source?: λSupplier<string | null> | null): StreamType | null;
   ...
   * @return push stream type or null
   */
  static asPushStreamType(failIfNot?: boolean, source?: λSupplier<string | null> | null): PushStreamType | null;
   ...
   * @return event stream type or null
   */
  static asEventStreamType(failIfNot?: boolean, source?: λSupplier<string | null> | null): EventStreamType | null;
   ...
   * @return tuple type or null
   */
  static asTupleType(failIfNot?: boolean, source?: λSupplier<string | null> | null): TupleType | null;
   ...
   * @return function type or null
   */
  static asFunctionType(failIfNot?: boolean, source?: λSupplier<string | null> | null): FunctionType | null;
   ...
   * @return method type or null
   */
  static asMethodType(failIfNot?: boolean, source?: λSupplier<string | null> | null): MethodType | null;
   ...
   * @return anyof type or null
   */
  static asAnyOfType(failIfNot?: boolean, source?: λSupplier<string | null> | null): AnyOfType | null;
   ...
   * @return any type or null
   */
  static asAnyType(failIfNot?: boolean, source?: λSupplier<string | null> | null): AnyType | null;
   ...
   * @return native type or null
   */
  static asNativeType(failIfNot?: boolean, source?: λSupplier<string | null> | null): NativeType | null;
   ...
   * @return lambda type or null
   */
  static asLambdaType(failIfNot?: boolean, source?: λSupplier<string | null> | null): LambdaType | null;
   ...
   * @return vector type or null
   */
  static asVectorType(failIfNot?: boolean, source?: λSupplier<string | null> | null): VectorType | null;
   ...
   * Returns true if there are no `mixing` reference types or if all `mixing` declarations matches the given type Name
   */
  static hasValidMixing(typeName: string): boolean;
   ...
   * @see #possibleValues
   */
  static hasPossibleValues(): boolean;
   ...
   * @see VarReferenceType
   */
  static hasVarReference(): boolean;
   ...
   * @see #instanceType
   */
  static dereference(failIfMissing?: boolean): Type | null;
   ...
   * @see #dereference
   */
  static dereferenceMeta(failIfMissing?: boolean): TypeMeta | null;
   ...
   * @see #dereference
   */
  static instanceType(failIfMissing?: boolean): Type | null;
   ...
   * @see #instanceType
   */
  static instanceValueType(failIfNot?: boolean): ValueType | null;
   ...
   * @see Boxed
   */
  static boxTypeRefType(): ReferenceType;
   ...
   * @see #boxType
   */
  static unboxType(): ValueType | null;
   ...
   * @return primitive type or null
   */
  static unboxPrimitiveType(failIfNot?: boolean): PrimitiveType | null;
   ...
   * @return collection type or null
   */
  static unboxCollectionType(failIfNot?: boolean): CollectionType | null;
   ...
   * @return Boxed object
   */
  static boxValue(value: any): WithType | null;
   ...
   * @return unboxed primitive
   */
  static unboxValue(obj: Obj | null): any;
   ...
   * strongly typed semantic. Similarly `[any]` will required boxing of elements.
   */
  static needsValueBoxing(): boolean;
   ...
   */
  static guessType(value: any, failIfNone?: boolean): ValueType | null;
   ...
   * @return guessed type or null if specific type cannot be determined
   */
  static guessTypeFromJavaClass(value: any, failIfNone?: boolean): ValueType | null;
   ...
   * @return guessed type or null if specific type cannot be determined
   */
  static guessTypeFromPythonClass(value: any, failIfNone?: boolean): ValueType | null;
   ...
   * @see #guessType
   */
  static guessConvertibleType(value: any, testContent?: boolean, failIfNone?: boolean): ValueType | null;
   ...
   * @see #isSame
   */
  static isSameValue(value: any): boolean;
   ...
   * @deprecated(details="Use `#isAssignableTo` for acceptability of assignment or `TypeMeta#isA` to test type hierarchy.")
   */
  static isA(other: ValueType): boolean;
   ...
   * @deprecated(details="Use `#IsAssignableTo` for acceptability of assignment or `TypeMeta#isA` to test type hierarchy.")
   */
  static isA(decl: string): boolean;
   ...
   * @see #isSame
   */
  static isAssignableTo(other: ValueType): boolean;
   ...
   * @see #isSame
   */
  static isAssignableTo(decl: string): boolean;
   ...
   * @see #isAssignableTo
   */
  static isAssignableFrom(other: ValueType): boolean;
   ...
   * @see #guessType
   */
  static isAssignableValue(value: any): boolean;
   ...
   * @see #convertValue
   */
  static isConvertibleFrom(other: ValueType): boolean;
   ...
   * @see #convertValue
   */
  static isConvertibleValue(value: any, testContent?: boolean): boolean;
   ...
   *  - PrimitiveType.ofInt().maxValue() - means that other is not even convertible to this value type
   */
  static distance(other: ValueType): number;
   ...
   *  - -1 - means that value is not even convertible to this value type.
   */
  static valueDistance(value: any, testContent?: boolean): number;
   ...
   * @see #isConvertibleFrom
   */
  static convertValue(value: any, failIfInvalid?: boolean): any;
   ...
   * @see #convertValue
   */
  static convertValueWithDflt(value: any, dfltConversion: λFunction<any, any>): any;
   ...
   * @see {@link Ann.Java#runtimeClassName}
   */
  static convertToJavaRuntime(value: any, failIfInvalid?: boolean): T | null;
   ...
   * @see StringSerializable#toString
   */
  static valueToString(value: any, failIfNone?: boolean): string | null;
   ...
   * @see StringSerializable#fromString
   */
  static valueFromString(s: string | null, failIfInvalid?: boolean): any;
   ...
   * @return the json serialization of the value
   */
  static valueToTypedJson(value: any): any | null;
   ...
   * Produce a json string serialization of the value for this type.
   */
  static valueToTypedJsonString(value: any): string | null;
   ...
   * @return the json serialization of the value
   */
  static valueToJson(value: any): any | null;
   ...
   * pure json is not converted and to pass C3 value instances to external (non-type-aware) libraries.
   */
  static valueToJsonString(value: any): string | null;
   ...
   * Instantiate a value of this type from the serialized json. If the json is null, the produced value is null.
   */
  static valueFromJson(json: any | null, failIfInvalid?: boolean): any;
   ...
   * null.
   */
  static valueFromJsonString(json: string | null, failIfInvalid?: boolean): any;
   ...
   * See {@link documentation-features.c3doc} for the formal documentation for "boxed json".
   */
  static valueFromJsonWithType(json: any | null, failIfInvalid?: boolean): any;
   ...
   * @return the HttpResponse serialization of the value
   */
  static valueToHttpResponse(value: any, req: HttpRequest): HttpResponse;
   ...
   * @return the value represented by HttpRequest
   */
  static valueFromHttpRequest(req: HttpRequest): T;
   ...
   * @return true if provided value is valid i.e. #isSameValue and satisfies all constraints.
   */
  static validateValueWithDefaults(value: T | null, asFunctionArg: boolean | null, forJava: boolean | null, failIfInvalid?: boolean): T | null;
   ...
   * @return true if provided value is valid i.e. #isSameValue and satisfies all constraints.
   */
  static validateValue(value: any, failIfInvalid?: boolean): boolean;
   ...
   * @return predicate that tests if value is valid i.e. #isAssignableValue and satisfies all constraints.
   */
  static valueValidator(): λPredicate<T | null>;
   ...
   *         form of validation i.e. reason to use `#validateValueWithDefaults`
   */
  static hasValidation(asFunctionArg?: boolean): boolean;
   ...
   * @return 0 if provided values are equal; -1 if v1 < v2 and 1 if v1 > v2. Note that null == null and null > non null
   */
  static compareValues(v1: any, v2: any): number;
   ...
   * @return value comparator lambda as described in #compareValues.
   */
  static valueComparator(): λBiFunction<T | null, T | null, number> | null;
   ...
   * @return value comparator lambda in a descending order as described in #compareValues.
   */
  static valueComparator(descending: boolean): λBiFunction<T | null, T | null, number> | null;
   ...
   * @return the appropriate `ValueConverter` for values of the given class.
   */
  static valueConverter(valueClass: any): any;
   ...
   * @return value comparator lambda returning if the values are same
   */
  static isSamePredicate(kind?: string | null): λBiPredicate<T | null, T | null> | null;
   ...
   * @return `true` if this value type has #defaultEmptyValue that is not null
   */
  static hasDefaultEmptyValue(): boolean;
   ...
   * @see hasEnum
   */
  static enumValues(): C3.Array<any>;
   ...
   * @return all possible values if known; e.g. all boolean values or all enum values
   */
  static possibleValues(scope?: Tuple | null | TypeMeta | null | Obj | null | null, failIfUnknown?: boolean): C3.Array<any>;
   ...
   * @return cached parsed expression for @value(possibles) annotation
   */
  static possibleValuesExpr(): Expr | null;
   ...
   * @return map type with provided type and this as element type.
   */
  static mapTypeOf(keyType: ValueType): MapType;
   ...
   * @see DeclaredReferenceType
   */
  static build(scope: TypesysScope, required: boolean, context: λSupplier<string>): ValueType | null;
   ...
   * Calls specific method on visitor based on instance of this ValueType.
   */
  static visit(visitor: any): T | null;
   ...
   *         primitive is required
   */
  static javaClass(box: boolean): any;
   ...
   * @return cache key prefix containing modifiers like `!`, '?', '!?'
   */
  static cacheKeyPrefix(): string | null;
   ...
   * Uses {@link ReferenceType#hadDeclaredVarBindings} to decide if refVarBindings were declared.
   */
  static bindAllGenericVars(scope: TypesysScope): ValueType;
   ...
   * @return True if the value type should be persisted as a serialized value
   */
  static isPersistSerialized(): boolean;
   ...
   * @return The serialized value type for this value type if {@link isPersistSerialized} returns true.
   */
  static serializedValueType(): ValueType | null;
   ...
   * @return a list of field names.
   */
  static dataFieldTypeNames(): C3.Array<string | null>;
   ...
   *       an {@link ArrayType}'s {@link ArrayType#elementType}, etc.
   */
  static eachReferencedValueType(action: λConsumer<ValueType | null>): void;
   ...
   * The following value types should json object conversion to extract type / value if json is object structure
   */
  static skipJsonObjectConversion(): boolean;

  makeValue(from: any): any;

  static makeValue(from: any): any;

  emptyValue(): any;

  static emptyValue(): any;
   ...
   *         default returns "inst" for types without specific factory methods.
   */
  static factoryMethodName(): string;
