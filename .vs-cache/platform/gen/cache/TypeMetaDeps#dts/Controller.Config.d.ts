// TypeScript definitions for the C3 type Controller.Config
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Controller.Config
 */
...
declare namespace Controller {
  export class Config extends Obj {
    ...
    withConfigOverride(configOverride: string | null): Controller.Config;

    readonly secretOverride?: string | null;
    withSecretOverride(secretOverride: string | null): Controller.Config;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: C3.Array<string | null>;
    withIssues(issues: C3.Array<string | null> | Array<string | null>): Controller.Config;

    /**
     * The unique and required name of this instance.
     */
    readonly name: string;
    withName(name: string): Controller.Config;
     ...
     * More frequent calls will result in faster synchronization, but will increase load on the c3 cluster.
     */
    readonly syncIntervalMilliSeconds?: number | null;
    withSyncIntervalMilliSeconds(syncIntervalMilliSeconds: number | null): Controller.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Controller.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Controller.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Controller.Config | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Controller.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Controller.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Controller.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Controller.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Controller.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Controller.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Controller.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Controller.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Controller.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Controller.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Controller.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Controller.Config;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Controller.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Controller.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Controller.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Controller.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Controller.Config;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Controller.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Controller.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Controller.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Controller.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Controller.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Controller.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Controller.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Controller.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Controller.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Controller.Config;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Controller.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Controller.Config;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Controller.Config;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Controller.Config;

    mergeJson(json: any | null): Controller.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Controller.Config;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Controller.Config;
     ...
     */
    singletonArray(): C3.Array<Controller.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Controller.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Controller.Config | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Controller.Config | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Controller.Config | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Controller.Config | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Controller.Config | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Controller.Config | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Controller.Config | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Controller.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Controller.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Controller.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Controller.Config;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Controller.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Controller.Config;
     ...
     * @see #fromString
     */
    static make(s: string | null): Controller.Config | null;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Controller.Config;
     ...
     */
    static cachedEmptyInst(): Controller.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Controller.Config>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Controller.Config;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<Controller.Config | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<Controller.Config | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<Controller.Config | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): Controller.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string | null): Controller.Config | null;
     ...
     * @see findByCacheKey
     */
    getCached(): Controller.Config | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): Controller.Config | null;
     ...
     */
    static produce(key: string): Controller.Config | null;
     ...
     */
    static produceAll(): C3.Map<string | null, Controller.Config | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, Controller.Config | null>;
     ...
     */
    static forConfigKey(configKey: string | null): Controller.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<Controller.Config | null>;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Controller.Config, override?: string | null): void;
     ...
     * @see setSecretValue
     */
    setSecretValues(from: Controller.Config, override?: string | null): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Controller.Config | null;
     ...
     */
    removeSecrets(): Controller.Config | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): Controller.Config | null;
     ...
     * @see #toString
     */
    static fromString(s: string | null): Controller.Config | null;
     ...
     */
    static forName(name: string | null, failIfMissing?: boolean): Controller.Config | null;
  }
}
