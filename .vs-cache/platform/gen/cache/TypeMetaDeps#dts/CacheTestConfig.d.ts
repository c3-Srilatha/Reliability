// TypeScript definitions for the C3 type CacheTestConfig

/**
 * @remarks this represents a value passed to a method that expects an instance of CacheTestConfig
 */
declare interface ICacheTestConfig {
...
/**
 * @remarks this represents a made instance of CacheTestConfig
 */
declare class CacheTestConfig extends Obj {

  /**
   * The id of this instance.
   */
  readonly id?: string | null;
  withId(id: string | null): CacheTestConfig;

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): CacheTestConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): CacheTestConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): CacheTestConfig;

  readonly foo?: number | null;
  withFoo(foo: number | null): CacheTestConfig;

  readonly bar?: string | null;
  withBar(bar: string | null): CacheTestConfig;

  readonly pass?: string | null;
  withPass(pass: string | null): CacheTestConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): CacheTestConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): CacheTestConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): CacheTestConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): CacheTestConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): CacheTestConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): CacheTestConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): CacheTestConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<CacheTestConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<CacheTestConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): CacheTestConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CacheTestConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CacheTestConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): CacheTestConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): CacheTestConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): CacheTestConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): CacheTestConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): CacheTestConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): CacheTestConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): CacheTestConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): CacheTestConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): CacheTestConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): CacheTestConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): CacheTestConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): CacheTestConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): CacheTestConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): CacheTestConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): CacheTestConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): CacheTestConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): CacheTestConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): CacheTestConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): CacheTestConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): CacheTestConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): CacheTestConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): CacheTestConfig;

  mergeJson(json: any | null): CacheTestConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): CacheTestConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): CacheTestConfig;
   ...
   */
  singletonArray(): C3.Array<CacheTestConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<CacheTestConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<CacheTestConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<CacheTestConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<CacheTestConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, CacheTestConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, CacheTestConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<CacheTestConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<CacheTestConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): CacheTestConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): CacheTestConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): CacheTestConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): CacheTestConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): CacheTestConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): CacheTestConfig;
   ...
   * @see #fromString
   */
  static make(s: string | null): CacheTestConfig | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): CacheTestConfig;
   ...
   */
  static cachedEmptyInst(): CacheTestConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<CacheTestConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): CacheTestConfig;
   ...
   * @see #toString
   */
  static fromString(s: string | null): CacheTestConfig | null;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<CacheTestConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<CacheTestConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<CacheTestConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): CacheTestConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): CacheTestConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): CacheTestConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): CacheTestConfig | null;
   ...
   */
  static produce(key: string): CacheTestConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, CacheTestConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, CacheTestConfig | null>;
   ...
   */
  static forConfigKey(configKey: string | null): CacheTestConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<CacheTestConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: CacheTestConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: CacheTestConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): CacheTestConfig | null;
