// TypeScript definitions for the C3 type MonitoredEventWindow

/**
 * Represents monitored event window for an ongoing event prediction, typically created from {@link Timeseries}
 * using {@link EventWindow#fromTimeseries}.
 *
 * @remarks this represents a value passed to a method that expects an instance of MonitoredEventWindow
 */
declare interface IMonitoredEventWindow {
   ...
   */
  spec?: ITimeseriesToEventWindowsSpec | null;
   ...
   * {@link EventWindow}.
   */
  events?: C3.Array<ObservedEvent | null> | Array<IObservedEvent | null>;

  /**
   * "MONITORING" status if the {@link MonitoredEventWindow} is open but no {@link ObservedEvent} has occurred yet.
   * "EVENT-VERIFIED" if the {@link MonitoredEventWindow} is open and at least one {@link ObservedEvent} has occurred.
   * "FALSE-POSITIVE" if the {@link MonitoredEventWindow} is closed and there were no {@link ObservedEvent}s.
   */
 ...
 * using {@link EventWindow#fromTimeseries}.
 *
 * @remarks this represents a made instance of MonitoredEventWindow
 */
declare class MonitoredEventWindow extends Obj {

  /**
   * Start timestamp for the value.  If null, assumed to be beginning-of-time (BOT).
   */
  readonly start?: DateTime | null;
  withStart(start: DateTime | Date | string | null): MonitoredEventWindow;

  /**
   * End timestamp for the value.  If null, assumed to be end-of-time (EOT).
   */
  readonly end?: DateTime | null;
  withEnd(end: DateTime | Date | string | null): MonitoredEventWindow;
  ...
  withTypeIdent(typeIdent: string | null): MonitoredEventWindow;
   ...
   */
  readonly id: string;
  withId(id: string): MonitoredEventWindow;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): MonitoredEventWindow;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): MonitoredEventWindow;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): MonitoredEventWindow;
  ...
  withVersion(version: number | null): MonitoredEventWindow;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): MonitoredEventWindow;

  /**
   * Spec that was used to create this {@link EventWindow}.
   */
  readonly spec?: TimeseriesToEventWindowsSpec | null;
  withSpec(spec: ITimeseriesToEventWindowsSpec | null): MonitoredEventWindow;

  /**
   * "OPEN" or "CLOSED" if {@link EventWindow} is in active monitoring state.
   */
  readonly status?: string | null;
  withStatus(status: string | null): MonitoredEventWindow;
   ...
   * {@link EventWindow}.
   */
  readonly events?: C3.Array<ObservedEvent | null>;
  withEvents(events: C3.Array<ObservedEvent | null> | Array<IObservedEvent | null>): MonitoredEventWindow;
   ...
   * "FALSE-POSITIVE" if the {@link MonitoredEventWindow} is closed and there were no {@link ObservedEvent}s.
   */
  readonly monitoringStatus?: string | null;
  withMonitoringStatus(monitoringStatus: string | null): MonitoredEventWindow;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): MonitoredEventWindow | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): MonitoredEventWindow | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): MonitoredEventWindow | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): MonitoredEventWindow | null;
   ...
   */
  replaceType(old: Type, new_: Type): MonitoredEventWindow;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MonitoredEventWindow;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): MonitoredEventWindow;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MonitoredEventWindow | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<MonitoredEventWindow | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): MonitoredEventWindow;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MonitoredEventWindow;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): MonitoredEventWindow;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): MonitoredEventWindow;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): MonitoredEventWindow;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): MonitoredEventWindow;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): MonitoredEventWindow;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): MonitoredEventWindow;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): MonitoredEventWindow;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): MonitoredEventWindow;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): MonitoredEventWindow;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): MonitoredEventWindow;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): MonitoredEventWindow;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): MonitoredEventWindow;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): MonitoredEventWindow;
   ...
   * @see #unsetField
   */
  defaultField(field: string): MonitoredEventWindow;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): MonitoredEventWindow;
   ...
   * @see #removeField
   */
  unsetField(field: string): MonitoredEventWindow;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): MonitoredEventWindow;
   ...
   * @see #unsetField
   */
  removeField(field: string): MonitoredEventWindow;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): MonitoredEventWindow;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): MonitoredEventWindow;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): MonitoredEventWindow;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): MonitoredEventWindow;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): MonitoredEventWindow;

  mergeJson(json: any | null): MonitoredEventWindow;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): MonitoredEventWindow;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): MonitoredEventWindow;
   ...
   */
  singletonArray(): C3.Array<MonitoredEventWindow | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<MonitoredEventWindow | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<MonitoredEventWindow | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<MonitoredEventWindow | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<MonitoredEventWindow | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, MonitoredEventWindow | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, MonitoredEventWindow | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<MonitoredEventWindow | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<MonitoredEventWindow | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): MonitoredEventWindow;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): MonitoredEventWindow;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): MonitoredEventWindow;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): MonitoredEventWindow;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): MonitoredEventWindow;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): MonitoredEventWindow;
   ...
   * @see #fromString
   */
  static make(s: string | null): MonitoredEventWindow | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): MonitoredEventWindow;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): MonitoredEventWindow;
   ...
   */
  static cachedEmptyInst(): MonitoredEventWindow;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<MonitoredEventWindow>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): MonitoredEventWindow;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<MonitoredEventWindow | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<MonitoredEventWindow | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<MonitoredEventWindow | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<MonitoredEventWindow | null> | null>;
   ...
   */
  get(include?: string | null): MonitoredEventWindow | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): MonitoredEventWindow | null;
   ...
   */
  getMissing(spec: GetMissingSpec): MonitoredEventWindow;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): MonitoredEventWindow | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): MonitoredEventWindow;
   ...
   * @see #toString
   */
  static fromString(s: string | null): MonitoredEventWindow | null;
   ...
   */
  create(spec?: UpsertSpec | null): MonitoredEventWindow | null;
   ...
   */
  static createBatch(objs: C3.Array<MonitoredEventWindow | null> | null, spec?: UpsertSpec | null): ObjList<MonitoredEventWindow | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<MonitoredEventWindow | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<MonitoredEventWindow | null> | null;
   ...
   */
  update(srcObj?: MonitoredEventWindow | null, spec?: UpsertSpec | null): MonitoredEventWindow | null;
   ...
   */
  upsert(srcObj?: MonitoredEventWindow | null, spec?: UpsertSpec | null): MonitoredEventWindow | null;
   ...
   */
  merge(spec?: MergeSpec | null): MonitoredEventWindow | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): MonitoredEventWindow | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): MonitoredEventWindow | null;
   ...
   */
  static updateBatch(objs: C3.Array<MonitoredEventWindow | null> | null, srcObjs?: C3.Array<MonitoredEventWindow | null>, spec?: UpsertSpec | null): ObjList<MonitoredEventWindow | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<MonitoredEventWindow | null>>, spec?: UpsertSpec | null): ObjList<MonitoredEventWindow | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<MonitoredEventWindow | null> | null, srcObjs?: C3.Array<MonitoredEventWindow | null>, spec?: UpsertSpec | null): ObjList<MonitoredEventWindow | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<MonitoredEventWindow | null>>, spec?: UpsertSpec | null): ObjList<MonitoredEventWindow | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<MonitoredEventWindow | null> | null, spec?: TouchSpec | null): ObjList<MonitoredEventWindow | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<MonitoredEventWindow | null> | null, spec?: MergeSpec | null): ObjList<MonitoredEventWindow | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<MonitoredEventWindow | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<MonitoredEventWindow | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<MonitoredEventWindow | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<MonitoredEventWindow | null> | null;
   ...
   */
  static mergeAll(mergeObj: MonitoredEventWindow | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: MonitoredEventWindow | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<MonitoredEventWindow | null> | null, spec?: UpsertSpec | null): ObjList<MonitoredEventWindow | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<MonitoredEventWindow | null> | null, spec?: UpsertSpec | null): ObjList<MonitoredEventWindow | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): MonitoredEventWindow | null;
   ...
   */
  static beforeCreate(objs: C3.Array<MonitoredEventWindow | null> | null): ObjList<MonitoredEventWindow | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<MonitoredEventWindow | null> | null): ObjList<MonitoredEventWindow | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<MonitoredEventWindow | null> | null): ObjList<MonitoredEventWindow | null>;
   ...
   */
  static afterCreate(objs: C3.Array<MonitoredEventWindow | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<MonitoredEventWindow | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<MonitoredEventWindow | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<MonitoredEventWindow | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<MonitoredEventWindow | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): MonitoredEventWindow | null;
   ...
   */
  withoutIdentity(): MonitoredEventWindow | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<MonitoredEventWindow | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: MonitoredEventWindow | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<MonitoredEventWindow | null> | null, callback?: λFunction<MonitoredEventWindow | null, MonitoredEventWindow | null> | null): ObjList<MonitoredEventWindow | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<MonitoredEventWindow | null> | null, callback?: λFunction<MonitoredEventWindow | null, MonitoredEventWindow | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static fromTimeseries(spec?: TimeseriesToEventWindowsSpec | null): C3.Array<MonitoredEventWindow | null>;
   ...
   * @returns not persisted {@link EventWindow}s.
   */
  static fromEvalMetricsResult(emr: EvalMetricsResult, spec: EvalMetricsResultToEventWindowsSpec): C3.Array<MonitoredEventWindow | null>;
   ...
   */
  static fromObservedEvents(events?: C3.Array<ObservedEvent | null>, windowDuration: Duration, endsPriorToEvent: Duration): C3.Array<MonitoredEventWindow | null>;

  static eventWindowsToTimeseries(eventWindows?: C3.Array<EventWindow | null>): C3.Array<Timeseries<any> | null>;
   ...
   */
  static mergeEventWindows(windows?: C3.Array<C3.Array<MonitoredEventWindow | null>>, spec?: EventWindowMergeSpec | null): C3.Array<MonitoredEventWindow | null>;
}
