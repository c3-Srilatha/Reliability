// TypeScript definitions for the C3 type VarReferenceType

/**
 * A variable reference is an unbound generic variable associated with a type or function parameter.
 *
 * Within the declaration of `type Foo<X>`, references to `X` are variables, since they have not
 * yet been bound.
 *
 * When another type binds the parameter: `type Bar mixes Foo<Cat>`, the references within
 * the Foo type to the "X" variable become bound to the Cat type.
 *
 * ```
 * type Foo<X> {
 *   herd: [X]
 * }
 *
 * type Bar mixes Foo<Cat>
 * ```
 *
 * Bar.herd will be `[Cat]` because all references to the parametric variable "X" in Foo (and
 * any mixins) will be bound to "Cat" within Bar.
 *
 * @remarks this represents a value passed to a method that expects an instance of VarReferenceType
 */
declare interface IVarReferenceType {
 ...
 * any mixins) will be bound to "Cat" within Bar.
 *
 * @remarks this represents a made instance of VarReferenceType
 */
declare class VarReferenceType extends Obj {

  /**
   * Source file Pkg.Path a C3 Type declaration [.c3typ].
   */
  readonly declaredPkgPath?: string | null;
  withDeclaredPkgPath(declaredPkgPath: string | null): VarReferenceType;

  /**
   * Source line number in a C3 Type declaration [.c3typ] file starting with 1 where this metadata element is declared.
   */
  readonly declaredSrcLine?: number | null;
  withDeclaredSrcLine(declaredSrcLine: number | null): VarReferenceType;
  ...
  withDeclaredSrcCharInLine(declaredSrcCharInLine: number | null): VarReferenceType;
   ...
   */
  readonly pkg: Pkg;
  withPkg(pkg: IPkg): VarReferenceType;

  /**
   * SDK json representing instance of this type
   */
  readonly json?: any;
  withJson(json: any): VarReferenceType;

  /**
   * The set of annotations defined on this element of metadata represented as json value.
   */
  readonly annotationsJson?: any | null;
  withAnnotationsJson(annotationsJson: any | null): VarReferenceType;
  ...
  withModifier(modifier: string | null): VarReferenceType;

  /**
   * The name of this instance.
   */
  readonly name: string;
  withName(name: string): VarReferenceType;
  ...
  withRestriction(restriction: IValueType | null): VarReferenceType;
   ...
   */
  replaceType(old: Type, new_: Type): VarReferenceType;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): VarReferenceType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): VarReferenceType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): VarReferenceType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): VarReferenceType | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VarReferenceType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VarReferenceType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VarReferenceType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VarReferenceType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): VarReferenceType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VarReferenceType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VarReferenceType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): VarReferenceType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): VarReferenceType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): VarReferenceType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): VarReferenceType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): VarReferenceType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): VarReferenceType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): VarReferenceType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): VarReferenceType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): VarReferenceType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): VarReferenceType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): VarReferenceType;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): VarReferenceType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): VarReferenceType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): VarReferenceType;
   ...
   * @see #removeField
   */
  unsetField(field: string): VarReferenceType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): VarReferenceType;
   ...
   * @see #unsetField
   */
  removeField(field: string): VarReferenceType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): VarReferenceType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): VarReferenceType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): VarReferenceType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): VarReferenceType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): VarReferenceType;

  mergeJson(json: any | null): VarReferenceType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): VarReferenceType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): VarReferenceType;
   ...
   */
  singletonArray(): C3.Array<VarReferenceType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<VarReferenceType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<VarReferenceType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<VarReferenceType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<VarReferenceType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, VarReferenceType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, VarReferenceType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<VarReferenceType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<VarReferenceType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): VarReferenceType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): VarReferenceType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): VarReferenceType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): VarReferenceType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): VarReferenceType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): VarReferenceType;
   ...
   * @see #fromString
   */
  static make(s: string | null): VarReferenceType | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): VarReferenceType;
   ...
   */
  static cachedEmptyInst(): VarReferenceType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<VarReferenceType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): VarReferenceType;
   ...
   */
  withoutDeclaredSrcPos(recursive?: boolean): VarReferenceType;
   ...
   */
  withAnnotation(ann: Annotation): VarReferenceType;
   ...
   *         value for the field
   */
  withAnnotation(ann: string, annField?: string | null, value?: any): VarReferenceType;
   ...
   * @see #toString
   */
  static fromString(s: string | null): VarReferenceType | null;
  ...
  /**
   * @return `true` is this variable reference has a restriction, that will limit the types that can be bound.
   */
  hasRestriction(): boolean;

  /**
   * @return restriction of this variable reference type or {@link AnyType}
   */
  get restrictionOrAny(): ValueType;
}
