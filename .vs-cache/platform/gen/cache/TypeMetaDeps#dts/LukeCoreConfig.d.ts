// TypeScript definitions for the C3 type LukeCoreConfig

/**
 * Configurations for {@link LukeCore}.
 *
 * @remarks this represents a value passed to a method that expects an instance of LukeCoreConfig
 */
declare interface ILukeCoreConfig {
  ...
  /**
   * The directory path for the downloaded files by Luke
   */
  downloadPath?: string | null;

  /**
   * Whether to print browser logs if an error occurs
   */
  printBrowserLogsOnError?: boolean;

  /**
   * Whether to save a screen shot if an error occurs
   */
  saveScreenShot?: boolean;

  /**
   * The directory path for the saved screen shot files
   */
  screenShotPath?: string | null;

  /**
   * The directory path for the saved accessibility HTML reports
   */
 ...
 * Configurations for {@link LukeCore}.
 *
 * @remarks this represents a made instance of LukeCoreConfig
 */
declare class LukeCoreConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): LukeCoreConfig;

  static readonly configOverride?: string | null;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): LukeCoreConfig;
  ...
  withIssues(issues: C3.Array<string | null> | Array<string | null>): LukeCoreConfig;
  ...
  withDownloadPath(downloadPath: string | null): LukeCoreConfig;

  /**
   * The directory path for the downloaded files by Luke
   */
  static readonly downloadPath?: string | null;

  /**
   * Whether to print browser logs if an error occurs
   */
  readonly printBrowserLogsOnError?: boolean;
  withPrintBrowserLogsOnError(printBrowserLogsOnError: boolean): LukeCoreConfig;

  /**
   * Whether to print browser logs if an error occurs
   */
  static readonly printBrowserLogsOnError?: boolean;

  /**
   * Whether to save a screen shot if an error occurs
   */
  readonly saveScreenShot?: boolean;
  withSaveScreenShot(saveScreenShot: boolean): LukeCoreConfig;

  /**
   * Whether to save a screen shot if an error occurs
   */
  static readonly saveScreenShot?: boolean;

  /**
   * The directory path for the saved screen shot files
   */
  readonly screenShotPath?: string | null;
  withScreenShotPath(screenShotPath: string | null): LukeCoreConfig;

  /**
   * The directory path for the saved screen shot files
   */
  static readonly screenShotPath?: string | null;

  /**
   * The directory path for the saved accessibility HTML reports
   */
  readonly reportPath?: string | null;
  withReportPath(reportPath: string | null): LukeCoreConfig;

  /**
   * The directory path for the saved accessibility HTML reports
   */
  static readonly reportPath?: string | null;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): LukeCoreConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): LukeCoreConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): LukeCoreConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): LukeCoreConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): LukeCoreConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): LukeCoreConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeCoreConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeCoreConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeCoreConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): LukeCoreConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeCoreConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeCoreConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeCoreConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<LukeCoreConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LukeCoreConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): LukeCoreConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeCoreConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeCoreConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeCoreConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): LukeCoreConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): LukeCoreConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): LukeCoreConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): LukeCoreConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): LukeCoreConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): LukeCoreConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): LukeCoreConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LukeCoreConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): LukeCoreConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LukeCoreConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): LukeCoreConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): LukeCoreConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): LukeCoreConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): LukeCoreConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): LukeCoreConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): LukeCoreConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): LukeCoreConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): LukeCoreConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): LukeCoreConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LukeCoreConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): LukeCoreConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): LukeCoreConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): LukeCoreConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LukeCoreConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): LukeCoreConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): LukeCoreConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): LukeCoreConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): LukeCoreConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): LukeCoreConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): LukeCoreConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): LukeCoreConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): LukeCoreConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): LukeCoreConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): LukeCoreConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): LukeCoreConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): LukeCoreConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): LukeCoreConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LukeCoreConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): LukeCoreConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): LukeCoreConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): LukeCoreConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LukeCoreConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): LukeCoreConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LukeCoreConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): LukeCoreConfig;

  mergeJson(json: any | null): LukeCoreConfig;

  static mergeJson(json: any | null): LukeCoreConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LukeCoreConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): LukeCoreConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): LukeCoreConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): LukeCoreConfig;
   ...
   */
  singletonArray(): C3.Array<LukeCoreConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<LukeCoreConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<LukeCoreConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<LukeCoreConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<LukeCoreConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<LukeCoreConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<LukeCoreConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, LukeCoreConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, LukeCoreConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<LukeCoreConfig | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<LukeCoreConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<LukeCoreConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): LukeCoreConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): LukeCoreConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): LukeCoreConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): LukeCoreConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): LukeCoreConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): LukeCoreConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): LukeCoreConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): LukeCoreConfig;
   ...
   */
  static cachedEmptyInst(): LukeCoreConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<LukeCoreConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): LukeCoreConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<LukeCoreConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<LukeCoreConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<LukeCoreConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): LukeCoreConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): LukeCoreConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): LukeCoreConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): LukeCoreConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): LukeCoreConfig | null;
   ...
   */
  static produce(key: string): LukeCoreConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, LukeCoreConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, LukeCoreConfig | null>;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): LukeCoreConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): LukeCoreConfig;
   ...
   */
  static forConfigKey(configKey: string | null): LukeCoreConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<LukeCoreConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: LukeCoreConfig, override?: string | null): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: LukeCoreConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: LukeCoreConfig, override?: string | null): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: LukeCoreConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): LukeCoreConfig | null;
   ...
   */
  removeSecrets(): LukeCoreConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): LukeCoreConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): LukeCoreConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): LukeCoreConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): LukeCoreConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): LukeCoreConfig;
