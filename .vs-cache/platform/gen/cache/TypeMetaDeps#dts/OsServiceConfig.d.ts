// TypeScript definitions for the C3 type OsServiceConfig

/**
 * Default configurations for the Os Service.
 *
 * @remarks this represents a value passed to a method that expects an instance of OsServiceConfig
 */
declare interface IOsServiceConfig {
 ...
 * Default configurations for the Os Service.
 *
 * @remarks this represents a made instance of OsServiceConfig
 */
declare class OsServiceConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): OsServiceConfig;

  static readonly configOverride?: string | null;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): OsServiceConfig;
  ...
  withIssues(issues: C3.Array<string | null> | Array<string | null>): OsServiceConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): OsServiceConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): OsServiceConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): OsServiceConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): OsServiceConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): OsServiceConfig;
   ...
   * This method is used during live metadata update
   */
  static replaceType(old: Type, new_: Type): OsServiceConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): OsServiceConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): OsServiceConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): OsServiceConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): OsServiceConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<OsServiceConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<OsServiceConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<OsServiceConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<OsServiceConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): OsServiceConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): OsServiceConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): OsServiceConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): OsServiceConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): OsServiceConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): OsServiceConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): OsServiceConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  static validateObj(): OsServiceConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): OsServiceConfig;
   ...
   * @see #defaultField
   */
  static withField(field: string, value: any, doNotConvert?: boolean): OsServiceConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): OsServiceConfig;
   ...
   * @see #defaultField
   */
  static withField(field: FieldType, value: any, doNotConvert?: boolean): OsServiceConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): OsServiceConfig;
   ...
   * @return new Obj
   */
  static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): OsServiceConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): OsServiceConfig;
   ...
   * @return new Obj
   */
  static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): OsServiceConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): OsServiceConfig;
   ...
   * @see #withoutField
   */
  static withoutFieldAtPath(path: string): OsServiceConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): OsServiceConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: string | null): OsServiceConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): OsServiceConfig;
   ...
   * @see #removeField
   */
  static withoutField(field: FieldType | null): OsServiceConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): OsServiceConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFields(fields: C3.Array<string | null> | null): OsServiceConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): OsServiceConfig;
   ...
   * @return new Obj with removed fields
   */
  static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): OsServiceConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): OsServiceConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  static withoutSecretFields(): OsServiceConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): OsServiceConfig;
   ...
   * @see FieldType#defaultValue
   */
  static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): OsServiceConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): OsServiceConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: string): OsServiceConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): OsServiceConfig;
   ...
   * @see #unsetField
   */
  static defaultField(field: FieldType): OsServiceConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): OsServiceConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: string): OsServiceConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): OsServiceConfig;
   ...
   * @see #removeField
   */
  static unsetField(field: FieldType): OsServiceConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): OsServiceConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: string): OsServiceConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): OsServiceConfig;
   ...
   * @see #unsetField
   */
  static removeField(field: FieldType): OsServiceConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): OsServiceConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): OsServiceConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): OsServiceConfig;
   ...
   * @return the new merged Obj
   */
  static mergeObj(other: Obj | null, otherFieldsFilter: Type): OsServiceConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): OsServiceConfig;
   ...
   *        the same key or index.
   */
  static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): OsServiceConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): OsServiceConfig;
   ...
   * traverse child reference and collection fields.
   */
  static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): OsServiceConfig;

  mergeJson(json: any | null): OsServiceConfig;

  static mergeJson(json: any | null): OsServiceConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): OsServiceConfig;
   ...
   * @return Obj with child references merged
   */
  static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): OsServiceConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): OsServiceConfig;
   ...
   * references with same name and collection elements at same index or key.
   */
  static sumObj(other: Obj | null, deep?: boolean): OsServiceConfig;
   ...
   */
  singletonArray(): C3.Array<OsServiceConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonArray(): C3.Array<OsServiceConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<OsServiceConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<OsServiceConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<OsServiceConfig | null>;
   ...
   * @return new array instance with this as only element.
   */
  static singletonSet(): C3.Set<OsServiceConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<OsServiceConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, OsServiceConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, OsServiceConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<OsServiceConfig | null>;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  static toBuilder(): ObjBuilder<OsServiceConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<OsServiceConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): OsServiceConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): OsServiceConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): OsServiceConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): OsServiceConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): OsServiceConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): OsServiceConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): OsServiceConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  static afterMake(): OsServiceConfig;
   ...
   */
  static cachedEmptyInst(): OsServiceConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<OsServiceConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): OsServiceConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<OsServiceConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<OsServiceConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<OsServiceConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): OsServiceConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): OsServiceConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): OsServiceConfig | null;
   ...
   * @see findByCacheKey
   */
  static getCached(): OsServiceConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): OsServiceConfig | null;

  /**
   * @return newly produced cached instance.
   */
  static refreshCache(): OsServiceConfig | null;
   ...
   */
  static produce(key: string): OsServiceConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, OsServiceConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, OsServiceConfig | null>;
   ...
   * Note that typical pattern is to use Configurable#config instead of this method.
   */
  static getConfig(): OsServiceConfig;
   ...
   * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
   */
  static getSecret(): OsServiceConfig;
   ...
   */
  static forConfigKey(configKey: string | null): OsServiceConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<OsServiceConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: OsServiceConfig, override?: string | null): void;

  /**
   * Sets multiple field values to be the same as the passed instance.
   * @see setConfigValue
   */
  static setConfigValues(from: OsServiceConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: OsServiceConfig, override?: string | null): void;

  /**
   * Sets multiple secret field values to be the same as the passed instance.
   * @see setSecretValue
   */
  static setSecretValues(from: OsServiceConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): OsServiceConfig | null;
   ...
   */
  removeSecrets(): OsServiceConfig | null;

  /**
   * @return this config without any secret values.
   */
  static removeSecrets(): OsServiceConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): OsServiceConfig | null;

  /**
   * @return this config with only secret values.
   */
  static removeNonSecrets(): OsServiceConfig | null;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  validate(): OsServiceConfig;

  /**
   * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
   * validation and setup.
   */
  static validate(): OsServiceConfig;
