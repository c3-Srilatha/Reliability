// TypeScript definitions for the C3 type Tester.Config

/**
 * Test state configuration applied from outside.
 *
 * @remarks this represents a value passed to a method that expects an instance of Tester.Config
 */
declare namespace Tester {
  export interface IConfig {
     ...
     */
    hardwareAvailability?: string | null;
  }
}
...
declare namespace Tester {
  export class Config extends Obj {
    ...
    withConfigOverride(configOverride: string | null): Tester.Config;

    readonly secretOverride?: string | null;
    withSecretOverride(secretOverride: string | null): Tester.Config;

    /**
     * Captures any issues that occurred while deserializing from filesystem
     */
    readonly issues?: C3.Array<string | null>;
    withIssues(issues: C3.Array<string | null> | Array<string | null>): Tester.Config;
    ...
    withCurrentBranch(currentBranch: string | null): Tester.Config;
    ...
    withBaseBranch(baseBranch: string | null): Tester.Config;

    /**
     * The availability to use for hardware to start up for tests.
     */
    readonly hardwareAvailability?: string | null;
    withHardwareAvailability(hardwareAvailability: string | null): Tester.Config;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Tester.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Tester.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Tester.Config | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Tester.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): Tester.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Tester.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Tester.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Tester.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Tester.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Tester.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Tester.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Tester.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Tester.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Tester.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Tester.Config;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Tester.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Tester.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Tester.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Tester.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Tester.Config;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Tester.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Tester.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Tester.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Tester.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Tester.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Tester.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): Tester.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Tester.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): Tester.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Tester.Config;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Tester.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Tester.Config;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Tester.Config;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Tester.Config;

    mergeJson(json: any | null): Tester.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Tester.Config;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Tester.Config;
     ...
     */
    singletonArray(): C3.Array<Tester.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Tester.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Tester.Config | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Tester.Config | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Tester.Config | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Tester.Config | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Tester.Config | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Tester.Config | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Tester.Config | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Tester.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Tester.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Tester.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Tester.Config;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Tester.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Tester.Config;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Tester.Config;
     ...
     */
    static cachedEmptyInst(): Tester.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Tester.Config>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Tester.Config;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<Tester.Config | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<Tester.Config | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<Tester.Config | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): Tester.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string | null): Tester.Config | null;
     ...
     * @see findByCacheKey
     */
    getCached(): Tester.Config | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): Tester.Config | null;
     ...
     */
    static produce(key: string): Tester.Config | null;
     ...
     */
    static produceAll(): C3.Map<string | null, Tester.Config | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, Tester.Config | null>;
     ...
     */
    static forConfigKey(configKey: string | null): Tester.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<Tester.Config | null>;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: Tester.Config, override?: string | null): void;
     ...
     * @see setSecretValue
     */
    setSecretValues(from: Tester.Config, override?: string | null): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): Tester.Config | null;
