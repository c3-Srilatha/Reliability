// TypeScript definitions for the C3 type X509Certificate
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of X509Certificate
 */
declare interface IX509Certificate {
 ...
 */
declare class X509Certificate extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): X509Certificate;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): X509Certificate;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): X509Certificate;

  /**
   * The id of this instance.
   */
  readonly id?: string | null;
  withId(id: string | null): X509Certificate;

  /**
   * A cached instance of native java X509Certificate class.
   */
  readonly cert?: any;
  withCert(cert: any): X509Certificate;
  ...
  withContent(content: string | null): X509Certificate;
  ...
  withFileUrl(fileUrl: string | null): X509Certificate;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): X509Certificate | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): X509Certificate | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): X509Certificate | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): X509Certificate | null;
   ...
   */
  replaceType(old: Type, new_: Type): X509Certificate;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): X509Certificate;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): X509Certificate;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<X509Certificate | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<X509Certificate | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): X509Certificate;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): X509Certificate;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): X509Certificate;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): X509Certificate;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): X509Certificate;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): X509Certificate;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): X509Certificate;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): X509Certificate;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): X509Certificate;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): X509Certificate;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): X509Certificate;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): X509Certificate;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): X509Certificate;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): X509Certificate;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): X509Certificate;
   ...
   * @see #unsetField
   */
  defaultField(field: string): X509Certificate;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): X509Certificate;
   ...
   * @see #removeField
   */
  unsetField(field: string): X509Certificate;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): X509Certificate;
   ...
   * @see #unsetField
   */
  removeField(field: string): X509Certificate;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): X509Certificate;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): X509Certificate;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): X509Certificate;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): X509Certificate;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): X509Certificate;

  mergeJson(json: any | null): X509Certificate;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): X509Certificate;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): X509Certificate;
   ...
   */
  singletonArray(): C3.Array<X509Certificate | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<X509Certificate | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<X509Certificate | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<X509Certificate | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<X509Certificate | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, X509Certificate | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, X509Certificate | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<X509Certificate | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<X509Certificate | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): X509Certificate;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): X509Certificate;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): X509Certificate;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): X509Certificate;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): X509Certificate;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): X509Certificate;
   ...
   * @see #fromString
   */
  static make(s: string | null): X509Certificate | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): X509Certificate;
   ...
   */
  static cachedEmptyInst(): X509Certificate;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<X509Certificate>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): X509Certificate;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<X509Certificate | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<X509Certificate | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<X509Certificate | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): X509Certificate | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): X509Certificate | null;
   ...
   * @see findByCacheKey
   */
  getCached(): X509Certificate | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): X509Certificate | null;
   ...
   */
  static produce(key: string): X509Certificate | null;
   ...
   */
  static produceAll(): C3.Map<string | null, X509Certificate | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, X509Certificate | null>;
   ...
   */
  static forConfigKey(configKey: string | null): X509Certificate | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<X509Certificate | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: X509Certificate, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: X509Certificate, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): X509Certificate | null;
   ...
   */
  removeSecrets(): X509Certificate | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): X509Certificate | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): X509Certificate | null;

  /**
   * Get the {@link CryptoPublicKey CryptoPublicKey} of this certificate.
   */
  cryptoPublicKey(): CryptoPublicKey | null;
