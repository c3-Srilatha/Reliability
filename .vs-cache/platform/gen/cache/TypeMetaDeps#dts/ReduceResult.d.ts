// TypeScript definitions for the C3 type ReduceResult

/**
 * Result of a singe reduce step in the MapReduce job.
 *
 * @remarks this represents a value passed to a method that expects an instance of ReduceResult
 */
declare interface IReduceResult {
 ...
 * Result of a singe reduce step in the MapReduce job.
 *
 * @remarks this represents a made instance of ReduceResult
 */
declare class ReduceResult extends Obj {

  /**
   * Partition key Bin separator used to separate partition key from bin id
   */
  readonly PK_BIN_SEPARATOR?: string | null;
  withPK_BIN_SEPARATOR(PK_BIN_SEPARATOR: string | null): ReduceResult;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): ReduceResult;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): ReduceResult;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): ReduceResult;
  ...
  withVersion(version: number | null): ReduceResult;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): ReduceResult;

  readonly run: MapReduceRun;
  withRun(run: IMapReduceRun): ReduceResult;

  readonly outKey: string;
  withOutKey(outKey: string): ReduceResult;

  readonly outValue?: any;
  withOutValue(outValue: any): ReduceResult;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ReduceResult | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ReduceResult | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ReduceResult | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ReduceResult | null;
   ...
   */
  replaceType(old: Type, new_: Type): ReduceResult;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ReduceResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ReduceResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ReduceResult | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ReduceResult | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ReduceResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReduceResult;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ReduceResult;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ReduceResult;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ReduceResult;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ReduceResult;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ReduceResult;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ReduceResult;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ReduceResult;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ReduceResult;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ReduceResult;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ReduceResult;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ReduceResult;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ReduceResult;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ReduceResult;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ReduceResult;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ReduceResult;
   ...
   * @see #removeField
   */
  unsetField(field: string): ReduceResult;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ReduceResult;
   ...
   * @see #unsetField
   */
  removeField(field: string): ReduceResult;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ReduceResult;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ReduceResult;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ReduceResult;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ReduceResult;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ReduceResult;

  mergeJson(json: any | null): ReduceResult;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ReduceResult;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ReduceResult;
   ...
   */
  singletonArray(): C3.Array<ReduceResult | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ReduceResult | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ReduceResult | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ReduceResult | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ReduceResult | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ReduceResult | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ReduceResult | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ReduceResult | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ReduceResult | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ReduceResult;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ReduceResult;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ReduceResult;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ReduceResult;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ReduceResult;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ReduceResult;
   ...
   * @see #fromString
   */
  static make(s: string | null): ReduceResult | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ReduceResult;
   ...
   */
  static cachedEmptyInst(): ReduceResult;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ReduceResult>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ReduceResult;

  /**
   * Extract the partition key from the given obj
   */
  partitionKey(failIfMissing?: boolean): MapReduceRun | null;
   ...
   */
  static partition(objs?: Stream<ReduceResult | null>, spec?: PartitionBucketStrategy | null): C3.Map<string | null, KvDataPartition | null>;
   ...
   */
  static fromPartitions(partitions?: Stream<KvDataPartition | null>): Stream<ReduceResult | null>;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<ReduceResult | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ReduceResult | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<ReduceResult | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<ReduceResult | null> | null>;
   ...
   */
  get(include?: string | null): ReduceResult | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): ReduceResult | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ReduceResult;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): ReduceResult | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ReduceResult;
   ...
   * @see #toString
   */
  static fromString(s: string | null): ReduceResult | null;
   ...
   */
  create(spec?: UpsertSpec | null): ReduceResult | null;
   ...
   */
  static createBatch(objs: C3.Array<ReduceResult | null> | null, spec?: UpsertSpec | null): ObjList<ReduceResult | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ReduceResult | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<ReduceResult | null> | null;
   ...
   */
  update(srcObj?: ReduceResult | null, spec?: UpsertSpec | null): ReduceResult | null;
   ...
   */
  upsert(srcObj?: ReduceResult | null, spec?: UpsertSpec | null): ReduceResult | null;
   ...
   */
  merge(spec?: MergeSpec | null): ReduceResult | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): ReduceResult | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): ReduceResult | null;
   ...
   */
  static updateBatch(objs: C3.Array<ReduceResult | null> | null, srcObjs?: C3.Array<ReduceResult | null>, spec?: UpsertSpec | null): ObjList<ReduceResult | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<ReduceResult | null>>, spec?: UpsertSpec | null): ObjList<ReduceResult | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<ReduceResult | null> | null, srcObjs?: C3.Array<ReduceResult | null>, spec?: UpsertSpec | null): ObjList<ReduceResult | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<ReduceResult | null>>, spec?: UpsertSpec | null): ObjList<ReduceResult | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<ReduceResult | null> | null, spec?: TouchSpec | null): ObjList<ReduceResult | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<ReduceResult | null> | null, spec?: MergeSpec | null): ObjList<ReduceResult | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<ReduceResult | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<ReduceResult | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<ReduceResult | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<ReduceResult | null> | null;
   ...
   */
  static mergeAll(mergeObj: ReduceResult | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ReduceResult | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<ReduceResult | null> | null, spec?: UpsertSpec | null): ObjList<ReduceResult | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<ReduceResult | null> | null, spec?: UpsertSpec | null): ObjList<ReduceResult | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<ReduceResult | null> | null): ObjList<ReduceResult | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<ReduceResult | null> | null): ObjList<ReduceResult | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<ReduceResult | null> | null): ObjList<ReduceResult | null>;
   ...
   */
  static afterCreate(objs: C3.Array<ReduceResult | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<ReduceResult | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<ReduceResult | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<ReduceResult | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<ReduceResult | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): ReduceResult | null;
   ...
   */
  withoutIdentity(): ReduceResult | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<ReduceResult | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: ReduceResult | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<ReduceResult | null> | null, callback?: λFunction<ReduceResult | null, ReduceResult | null> | null): ObjList<ReduceResult | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<ReduceResult | null> | null, callback?: λFunction<ReduceResult | null, ReduceResult | null> | null): C3.Array<ObjError | null>;
