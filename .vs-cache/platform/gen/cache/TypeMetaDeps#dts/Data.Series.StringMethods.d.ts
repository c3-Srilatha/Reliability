// TypeScript definitions for the C3 type Data.Series.StringMethods

/**
 * @remarks this represents a value passed to a method that expects an instance of Data.Series.StringMethods
 */
 ...
 */
declare namespace Data.Series {
  export class StringMethods extends Obj {
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.Series.StringMethods | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.Series.StringMethods | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.Series.StringMethods | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.Series.StringMethods | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.Series.StringMethods;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Series.StringMethods;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Series.StringMethods;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Series.StringMethods | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Series.StringMethods | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.Series.StringMethods;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Series.StringMethods;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Series.StringMethods;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.Series.StringMethods;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.Series.StringMethods;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.Series.StringMethods;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.Series.StringMethods;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.Series.StringMethods;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.Series.StringMethods;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.Series.StringMethods;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.Series.StringMethods;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.Series.StringMethods;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.Series.StringMethods;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.Series.StringMethods;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.Series.StringMethods;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.Series.StringMethods;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.Series.StringMethods;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.Series.StringMethods;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.Series.StringMethods;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.Series.StringMethods;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.Series.StringMethods;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.Series.StringMethods;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.Series.StringMethods;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.Series.StringMethods;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.Series.StringMethods;

    mergeJson(json: any | null): Data.Series.StringMethods;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.Series.StringMethods;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.Series.StringMethods;
     ...
     */
    singletonArray(): C3.Array<Data.Series.StringMethods | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.Series.StringMethods | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.Series.StringMethods | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.Series.StringMethods | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.Series.StringMethods | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.Series.StringMethods | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.Series.StringMethods | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.Series.StringMethods | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.Series.StringMethods | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.Series.StringMethods;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.Series.StringMethods;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.Series.StringMethods;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.Series.StringMethods;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.Series.StringMethods;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.Series.StringMethods;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.Series.StringMethods;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Data.Series.StringMethods;
     ...
     */
    static cachedEmptyInst(): Data.Series.StringMethods;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.Series.StringMethods>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.Series.StringMethods;
     ...
     */
    static fromPySrc(pySrc: string, dfs?: C3.Set<DataImpl | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): Data.Series.StringMethods | null;
     ...
     */
    static _jsDataProxy(inst: any): Data.Series.StringMethods;
