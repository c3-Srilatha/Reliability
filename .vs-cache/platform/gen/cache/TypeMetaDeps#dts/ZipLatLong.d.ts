// TypeScript definitions for the C3 type ZipLatLong

/**
 * Stored in reference/prod
 *
 * @remarks this represents a value passed to a method that expects an instance of ZipLatLong
 */
declare interface IZipLatLong {
 ...
 * Stored in reference/prod
 *
 * @remarks this represents a made instance of ZipLatLong
 */
declare class ZipLatLong extends Obj {
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): ZipLatLong;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): ZipLatLong;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): ZipLatLong;
  ...
  withVersion(version: number | null): ZipLatLong;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): ZipLatLong;

  /**
   * id is the zipCode
   */
  readonly latitude?: string | null;
  withLatitude(latitude: string | null): ZipLatLong;

  readonly longitude?: string | null;
  withLongitude(longitude: string | null): ZipLatLong;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ZipLatLong | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ZipLatLong | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ZipLatLong | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ZipLatLong | null;
   ...
   */
  replaceType(old: Type, new_: Type): ZipLatLong;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ZipLatLong;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ZipLatLong;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ZipLatLong | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ZipLatLong | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ZipLatLong;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ZipLatLong;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ZipLatLong;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ZipLatLong;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ZipLatLong;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ZipLatLong;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ZipLatLong;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ZipLatLong;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ZipLatLong;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ZipLatLong;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ZipLatLong;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ZipLatLong;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ZipLatLong;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ZipLatLong;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ZipLatLong;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ZipLatLong;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ZipLatLong;
   ...
   * @see #removeField
   */
  unsetField(field: string): ZipLatLong;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ZipLatLong;
   ...
   * @see #unsetField
   */
  removeField(field: string): ZipLatLong;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ZipLatLong;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ZipLatLong;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ZipLatLong;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ZipLatLong;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ZipLatLong;

  mergeJson(json: any | null): ZipLatLong;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ZipLatLong;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ZipLatLong;
   ...
   */
  singletonArray(): C3.Array<ZipLatLong | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ZipLatLong | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ZipLatLong | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ZipLatLong | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ZipLatLong | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ZipLatLong | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ZipLatLong | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ZipLatLong | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ZipLatLong | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ZipLatLong;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ZipLatLong;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ZipLatLong;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ZipLatLong;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ZipLatLong;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ZipLatLong;
   ...
   * @see #fromString
   */
  static make(s: string | null): ZipLatLong | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ZipLatLong;
   ...
   */
  static cachedEmptyInst(): ZipLatLong;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ZipLatLong>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ZipLatLong;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<ZipLatLong | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ZipLatLong | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<ZipLatLong | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<ZipLatLong | null> | null>;
   ...
   */
  get(include?: string | null): ZipLatLong | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): ZipLatLong | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ZipLatLong;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): ZipLatLong | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ZipLatLong;
   ...
   * @see #toString
   */
  static fromString(s: string | null): ZipLatLong | null;
   ...
   */
  create(spec?: UpsertSpec | null): ZipLatLong | null;
   ...
   */
  static createBatch(objs: C3.Array<ZipLatLong | null> | null, spec?: UpsertSpec | null): ObjList<ZipLatLong | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ZipLatLong | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<ZipLatLong | null> | null;
   ...
   */
  update(srcObj?: ZipLatLong | null, spec?: UpsertSpec | null): ZipLatLong | null;
   ...
   */
  upsert(srcObj?: ZipLatLong | null, spec?: UpsertSpec | null): ZipLatLong | null;
   ...
   */
  merge(spec?: MergeSpec | null): ZipLatLong | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): ZipLatLong | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): ZipLatLong | null;
   ...
   */
  static updateBatch(objs: C3.Array<ZipLatLong | null> | null, srcObjs?: C3.Array<ZipLatLong | null>, spec?: UpsertSpec | null): ObjList<ZipLatLong | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<ZipLatLong | null>>, spec?: UpsertSpec | null): ObjList<ZipLatLong | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<ZipLatLong | null> | null, srcObjs?: C3.Array<ZipLatLong | null>, spec?: UpsertSpec | null): ObjList<ZipLatLong | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<ZipLatLong | null>>, spec?: UpsertSpec | null): ObjList<ZipLatLong | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<ZipLatLong | null> | null, spec?: TouchSpec | null): ObjList<ZipLatLong | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<ZipLatLong | null> | null, spec?: MergeSpec | null): ObjList<ZipLatLong | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<ZipLatLong | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<ZipLatLong | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<ZipLatLong | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<ZipLatLong | null> | null;
   ...
   */
  static mergeAll(mergeObj: ZipLatLong | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ZipLatLong | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<ZipLatLong | null> | null, spec?: UpsertSpec | null): ObjList<ZipLatLong | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<ZipLatLong | null> | null, spec?: UpsertSpec | null): ObjList<ZipLatLong | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<ZipLatLong | null> | null): ObjList<ZipLatLong | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<ZipLatLong | null> | null): ObjList<ZipLatLong | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<ZipLatLong | null> | null): ObjList<ZipLatLong | null>;
   ...
   */
  static afterCreate(objs: C3.Array<ZipLatLong | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<ZipLatLong | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<ZipLatLong | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<ZipLatLong | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<ZipLatLong | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): ZipLatLong | null;
   ...
   */
  withoutIdentity(): ZipLatLong | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<ZipLatLong | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: ZipLatLong | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<ZipLatLong | null> | null, callback?: λFunction<ZipLatLong | null, ZipLatLong | null> | null): ObjList<ZipLatLong | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<ZipLatLong | null> | null, callback?: λFunction<ZipLatLong | null, ZipLatLong | null> | null): C3.Array<ObjError | null>;
