// TypeScript definitions for the C3 type ExportFile

/**
 * OBSOLETE! Do not use!
 *
 * @remarks this represents a value passed to a method that expects an instance of ExportFile
 */
declare interface IExportFile {
  ...
  kpisFieldPath?: string | null;

  kpis?: C3.Array<string | null> | Array<string | null>;
}

/**
 * OBSOLETE! Do not use!
 *
 * @remarks this represents a made instance of ExportFile
 */
declare class ExportFile extends Obj {

  readonly estimatedSize?: number | null;
  withEstimatedSize(estimatedSize: number | null): ExportFile;

  readonly layout?: string | null;
  withLayout(layout: string | null): ExportFile;

  readonly chunkSize?: number | null;
  withChunkSize(chunkSize: number | null): ExportFile;

  readonly numChunks?: number | null;
  withNumChunks(numChunks: number | null): ExportFile;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): ExportFile;

  readonly size?: number | null;
  withSize(size: number | null): ExportFile;

  readonly contentType?: string | null;
  withContentType(contentType: string | null): ExportFile;

  readonly checksum?: string | null;
  withChecksum(checksum: string | null): ExportFile;

  readonly tag?: string | null;
  withTag(tag: string | null): ExportFile;

  readonly context?: string | null;
  withContext(context: string | null): ExportFile;

  readonly numContentRevisions?: number | null;
  withNumContentRevisions(numContentRevisions: number | null): ExportFile;

  readonly fileSystem?: string | null;
  withFileSystem(fileSystem: string | null): ExportFile;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): ExportFile;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): ExportFile;
  ...
  withVersion(version: number | null): ExportFile;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): ExportFile;

  readonly srcTag?: string | null;
  withSrcTag(srcTag: string | null): ExportFile;

  readonly srcModule?: string | null;
  withSrcModule(srcModule: string | null): ExportFile;

  readonly srcType?: string | null;
  withSrcType(srcType: string | null): ExportFile;

  readonly kpisFieldPath?: string | null;
  withKpisFieldPath(kpisFieldPath: string | null): ExportFile;

  readonly kpis?: C3.Array<string | null>;
  withKpis(kpis: C3.Array<string | null> | Array<string | null>): ExportFile;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): ExportFile | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): ExportFile | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): ExportFile | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): ExportFile | null;
   ...
   */
  replaceType(old: Type, new_: Type): ExportFile;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ExportFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): ExportFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ExportFile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<ExportFile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): ExportFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ExportFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): ExportFile;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): ExportFile;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): ExportFile;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): ExportFile;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): ExportFile;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): ExportFile;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): ExportFile;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): ExportFile;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): ExportFile;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): ExportFile;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): ExportFile;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): ExportFile;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): ExportFile;
   ...
   * @see #unsetField
   */
  defaultField(field: string): ExportFile;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): ExportFile;
   ...
   * @see #removeField
   */
  unsetField(field: string): ExportFile;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): ExportFile;
   ...
   * @see #unsetField
   */
  removeField(field: string): ExportFile;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): ExportFile;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): ExportFile;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): ExportFile;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): ExportFile;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): ExportFile;

  mergeJson(json: any | null): ExportFile;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): ExportFile;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): ExportFile;
   ...
   */
  singletonArray(): C3.Array<ExportFile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<ExportFile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<ExportFile | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<ExportFile | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<ExportFile | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, ExportFile | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, ExportFile | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<ExportFile | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<ExportFile | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): ExportFile;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): ExportFile;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): ExportFile;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): ExportFile;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): ExportFile;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): ExportFile;
   ...
   * @see #fromString
   */
  static make(s: string | null): ExportFile | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): ExportFile;
   ...
   */
  static cachedEmptyInst(): ExportFile;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<ExportFile>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): ExportFile;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<ExportFile | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<ExportFile | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<ExportFile | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<ExportFile | null> | null>;
   ...
   */
  get(include?: string | null): ExportFile | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): ExportFile | null;
   ...
   */
  getMissing(spec: GetMissingSpec): ExportFile;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): ExportFile | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): ExportFile;
   ...
   * @see #toString
   */
  static fromString(s: string | null): ExportFile | null;
   ...
   */
  create(spec?: UpsertSpec | null): ExportFile | null;
   ...
   */
  static createBatch(objs: C3.Array<ExportFile | null> | null, spec?: UpsertSpec | null): ObjList<ExportFile | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<ExportFile | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<ExportFile | null> | null;
   ...
   */
  update(srcObj?: ExportFile | null, spec?: UpsertSpec | null): ExportFile | null;
   ...
   */
  upsert(srcObj?: ExportFile | null, spec?: UpsertSpec | null): ExportFile | null;
   ...
   */
  merge(spec?: MergeSpec | null): ExportFile | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): ExportFile | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): ExportFile | null;
   ...
   */
  static updateBatch(objs: C3.Array<ExportFile | null> | null, srcObjs?: C3.Array<ExportFile | null>, spec?: UpsertSpec | null): ObjList<ExportFile | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<ExportFile | null>>, spec?: UpsertSpec | null): ObjList<ExportFile | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<ExportFile | null> | null, srcObjs?: C3.Array<ExportFile | null>, spec?: UpsertSpec | null): ObjList<ExportFile | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<ExportFile | null>>, spec?: UpsertSpec | null): ObjList<ExportFile | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<ExportFile | null> | null, spec?: TouchSpec | null): ObjList<ExportFile | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<ExportFile | null> | null, spec?: MergeSpec | null): ObjList<ExportFile | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<ExportFile | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<ExportFile | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<ExportFile | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<ExportFile | null> | null;
   ...
   */
  static mergeAll(mergeObj: ExportFile | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: ExportFile | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<ExportFile | null> | null, spec?: UpsertSpec | null): ObjList<ExportFile | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<ExportFile | null> | null, spec?: UpsertSpec | null): ObjList<ExportFile | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<ExportFile | null> | null): ObjList<ExportFile | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<ExportFile | null> | null): ObjList<ExportFile | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<ExportFile | null> | null): ObjList<ExportFile | null>;
   ...
   */
  static afterCreate(objs: C3.Array<ExportFile | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<ExportFile | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<ExportFile | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<ExportFile | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<ExportFile | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): ExportFile | null;
   ...
   */
  withoutIdentity(): ExportFile | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<ExportFile | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: ExportFile | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<ExportFile | null> | null, callback?: λFunction<ExportFile | null, ExportFile | null> | null): ObjList<ExportFile | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<ExportFile | null> | null, callback?: λFunction<ExportFile | null, ExportFile | null> | null): C3.Array<ObjError | null>;
