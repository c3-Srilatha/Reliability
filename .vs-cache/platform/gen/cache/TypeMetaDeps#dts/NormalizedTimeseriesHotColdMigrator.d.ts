// TypeScript definitions for the C3 type NormalizedTimeseriesHotColdMigrator

/**
 * Map Reduce job to trigger hot/cold migration for NormalizedTimeseries
 *
 * {@see NormalizationConfig#partitionStrategy}
 * {@see TimedDataFields#partitionStrategy}
 * {@see NormalizationPartitionStrategy}
 *
 * @remarks this represents a value passed to a method that expects an instance of NormalizedTimeseriesHotColdMigrator
 */
declare interface INormalizedTimeseriesHotColdMigrator {

  /**
   * current or last job execution for this instance
   */
  run?: IMapReduceRun | null;

  /**
   * previous job executions for this instance
   */
  runs?: C3.Array<MapReduceRun | null> | Array<IMapReduceRun | null>;
   ...
   */
  onCompleteCallback?: IJobBase.Callback | null;

  /**
   * Low priority to not interfere with user jobs
   */
   ...
   */
  targetFilter?: IObj | null;

  /**
   * If set, reads the entire NormalizedTimeseries object in memory and performs the hot/cold migration
   */
  force?: boolean;
}
 ...
 * {@see NormalizationPartitionStrategy}
 *
 * @remarks this represents a made instance of NormalizedTimeseriesHotColdMigrator
 */
declare class NormalizedTimeseriesHotColdMigrator extends Obj {

  /**
   * current or last job execution for this instance
   */
  readonly run?: MapReduceRun | null;
  withRun(run: IMapReduceRun | null): NormalizedTimeseriesHotColdMigrator;

  /**
   * previous job executions for this instance
   */
  readonly runs?: C3.Array<MapReduceRun | null>;
  withRuns(runs: C3.Array<MapReduceRun | null> | Array<IMapReduceRun | null>): NormalizedTimeseriesHotColdMigrator;

  /**
   * FOR INTERNAL USE ONLY - Specify options in call to {@link start}.
   */
  readonly options?: Obj | null;
  withOptions(options: IObj | null): NormalizedTimeseriesHotColdMigrator;
  ...
  withOnCompleteCallback(onCompleteCallback: IJobBase.Callback | null): NormalizedTimeseriesHotColdMigrator;

  /**
   * Low priority to not interfere with user jobs
   */
  readonly priority?: number | null;
  withPriority(priority: number | null): NormalizedTimeseriesHotColdMigrator;
  ...
  withDisabled(disabled: boolean): NormalizedTimeseriesHotColdMigrator;
  ...
  withMaxConcurrency(maxConcurrency: number | null): NormalizedTimeseriesHotColdMigrator;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): NormalizedTimeseriesHotColdMigrator;
  ...
  withRunAsUser(runAsUser: boolean | null): NormalizedTimeseriesHotColdMigrator;

  /**
   * Don't set this field in the MapReduce job, set it in the MapReduceOptions when calling `start`.
   */
  readonly nodePool?: string | null;
  withNodePool(nodePool: string | null): NormalizedTimeseriesHotColdMigrator;
  ...
  withSkipIfRunning(skipIfRunning: boolean | null): NormalizedTimeseriesHotColdMigrator;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number | null;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): NormalizedTimeseriesHotColdMigrator;
  ...
  withPropagateActionContext(propagateActionContext: boolean): NormalizedTimeseriesHotColdMigrator;
  ...
  withTargetType(targetType: IType | null): NormalizedTimeseriesHotColdMigrator;
  ...
  withUseFileSystemForInterVals(useFileSystemForInterVals: boolean): NormalizedTimeseriesHotColdMigrator;
  ...
  withUseBatchIdsForReadInput(useBatchIdsForReadInput: boolean): NormalizedTimeseriesHotColdMigrator;
  ...
  withInclude(include: string | null): NormalizedTimeseriesHotColdMigrator;

  /**
   * optional filter spec
   */
  readonly filter?: string | null;
  withFilter(filter: string | null): NormalizedTimeseriesHotColdMigrator;
  ...
  withOrder(order: string | null): NormalizedTimeseriesHotColdMigrator;
  ...
  withLimit(limit: number | null): NormalizedTimeseriesHotColdMigrator;
  ...
  withSamplePct(samplePct: number | null): NormalizedTimeseriesHotColdMigrator;
  ...
  withBatchSize(batchSize: number | null): NormalizedTimeseriesHotColdMigrator;
  ...
  withSubBatchSize(subBatchSize: number | null): NormalizedTimeseriesHotColdMigrator;
  ...
  withNumBatches(numBatches: number | null): NormalizedTimeseriesHotColdMigrator;
  ...
  withAbortOnError(abortOnError: boolean): NormalizedTimeseriesHotColdMigrator;
  ...
  withTypeIdent(typeIdent: string | null): NormalizedTimeseriesHotColdMigrator;
   ...
   */
  readonly id: string;
  withId(id: string): NormalizedTimeseriesHotColdMigrator;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): NormalizedTimeseriesHotColdMigrator;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): NormalizedTimeseriesHotColdMigrator;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): NormalizedTimeseriesHotColdMigrator;
  ...
  withVersion(version: number | null): NormalizedTimeseriesHotColdMigrator;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): NormalizedTimeseriesHotColdMigrator;

  /**
   * Optional target type instance to be used as the filter for the job.  When specified, the {~link map} function will
   * only be called for that obj.
   */
  readonly targetFilter?: Obj | null;
  withTargetFilter(targetFilter: IObj | null): NormalizedTimeseriesHotColdMigrator;

  /**
   * If set, reads the entire NormalizedTimeseries object in memory and performs the hot/cold migration
   */
  readonly force?: boolean;
  withForce(force: boolean): NormalizedTimeseriesHotColdMigrator;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): NormalizedTimeseriesHotColdMigrator | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): NormalizedTimeseriesHotColdMigrator | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): NormalizedTimeseriesHotColdMigrator | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): NormalizedTimeseriesHotColdMigrator | null;
   ...
   */
  replaceType(old: Type, new_: Type): NormalizedTimeseriesHotColdMigrator;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NormalizedTimeseriesHotColdMigrator;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): NormalizedTimeseriesHotColdMigrator;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NormalizedTimeseriesHotColdMigrator | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<NormalizedTimeseriesHotColdMigrator | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): NormalizedTimeseriesHotColdMigrator;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NormalizedTimeseriesHotColdMigrator;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): NormalizedTimeseriesHotColdMigrator;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): NormalizedTimeseriesHotColdMigrator;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): NormalizedTimeseriesHotColdMigrator;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): NormalizedTimeseriesHotColdMigrator;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): NormalizedTimeseriesHotColdMigrator;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): NormalizedTimeseriesHotColdMigrator;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): NormalizedTimeseriesHotColdMigrator;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): NormalizedTimeseriesHotColdMigrator;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): NormalizedTimeseriesHotColdMigrator;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): NormalizedTimeseriesHotColdMigrator;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): NormalizedTimeseriesHotColdMigrator;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): NormalizedTimeseriesHotColdMigrator;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): NormalizedTimeseriesHotColdMigrator;
   ...
   * @see #unsetField
   */
  defaultField(field: string): NormalizedTimeseriesHotColdMigrator;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): NormalizedTimeseriesHotColdMigrator;
   ...
   * @see #removeField
   */
  unsetField(field: string): NormalizedTimeseriesHotColdMigrator;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): NormalizedTimeseriesHotColdMigrator;
   ...
   * @see #unsetField
   */
  removeField(field: string): NormalizedTimeseriesHotColdMigrator;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): NormalizedTimeseriesHotColdMigrator;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): NormalizedTimeseriesHotColdMigrator;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): NormalizedTimeseriesHotColdMigrator;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): NormalizedTimeseriesHotColdMigrator;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): NormalizedTimeseriesHotColdMigrator;

  mergeJson(json: any | null): NormalizedTimeseriesHotColdMigrator;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): NormalizedTimeseriesHotColdMigrator;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): NormalizedTimeseriesHotColdMigrator;
   ...
   */
  singletonArray(): C3.Array<NormalizedTimeseriesHotColdMigrator | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<NormalizedTimeseriesHotColdMigrator | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<NormalizedTimeseriesHotColdMigrator | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<NormalizedTimeseriesHotColdMigrator | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<NormalizedTimeseriesHotColdMigrator | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, NormalizedTimeseriesHotColdMigrator | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, NormalizedTimeseriesHotColdMigrator | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<NormalizedTimeseriesHotColdMigrator | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<NormalizedTimeseriesHotColdMigrator | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): NormalizedTimeseriesHotColdMigrator;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): NormalizedTimeseriesHotColdMigrator;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): NormalizedTimeseriesHotColdMigrator;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): NormalizedTimeseriesHotColdMigrator;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): NormalizedTimeseriesHotColdMigrator;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): NormalizedTimeseriesHotColdMigrator;
   ...
   * @see #fromString
   */
  static make(s: string | null): NormalizedTimeseriesHotColdMigrator | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): NormalizedTimeseriesHotColdMigrator;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): NormalizedTimeseriesHotColdMigrator;
   ...
   */
  static cachedEmptyInst(): NormalizedTimeseriesHotColdMigrator;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<NormalizedTimeseriesHotColdMigrator>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): NormalizedTimeseriesHotColdMigrator;
   ...
   */
  start(options?: MapReduceOptions | null): MapReduceStatus | null;
   ...
   */
  waitForCompletion(timeout?: Duration | null, dontFailOnError?: boolean): BatchJobStatusBase;
   ...
   */
  setPriority(priority?: number | null): number | null;
   ...
   */
  setNodePool(nodePool?: string | null): number | null;
  ...
  setMaxConcurrency(maxConcurrency?: number | null): void;

  setMaxConcurrencyPerNode(maxConcurrencyPerNode?: number | null): void;
   ...
   */
  cleanup(options?: MapReduceOptions | null): void;
  ...
  cancelJob(removeResults?: boolean, force?: boolean): JobBase<MapReduceRun | null, MapReduceStatus | null, MapReduceOptions | null> | null;

  failJob(run: JobRun<BatchJobStatusBase | null>): JobBase<MapReduceRun | null, MapReduceStatus | null, MapReduceOptions | null> | null;

  static updateStatus(jobId: string, runId: string, context: string): void;

  invalidate(context?: string | null, entryType?: string | null, autoCommit?: boolean, checkForDuplicates?: boolean): void;

  hasErrors(): boolean;

  validateStart(options?: MapReduceOptions | null): void;

  updateJobState(): boolean;

  removeResults(run: MapReduceRun): void;

  static cancelJobQueueEntry(run?: MapReduceRun | null, entry?: InvalidationQueueEntry<any> | null): void;

  startContext(): string | null;

  startStep(): string | null;

  createRun(status?: MapReduceStatus | null, startingActionId?: string | null): MapReduceRun | null;

  currentProgress(): string | null;

  static stripRunIdFromContext(context: string): Pair<string | null, string | null> | null;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<NormalizedTimeseriesHotColdMigrator | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<NormalizedTimeseriesHotColdMigrator | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<NormalizedTimeseriesHotColdMigrator | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<NormalizedTimeseriesHotColdMigrator | null> | null>;
   ...
   */
  get(include?: string | null): NormalizedTimeseriesHotColdMigrator | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): NormalizedTimeseriesHotColdMigrator | null;
   ...
   */
  getMissing(spec: GetMissingSpec): NormalizedTimeseriesHotColdMigrator;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): NormalizedTimeseriesHotColdMigrator | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): NormalizedTimeseriesHotColdMigrator;
   ...
   * @see #toString
   */
  static fromString(s: string | null): NormalizedTimeseriesHotColdMigrator | null;
   ...
   */
  create(spec?: UpsertSpec | null): NormalizedTimeseriesHotColdMigrator | null;
   ...
   */
  static createBatch(objs: C3.Array<NormalizedTimeseriesHotColdMigrator | null> | null, spec?: UpsertSpec | null): ObjList<NormalizedTimeseriesHotColdMigrator | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<NormalizedTimeseriesHotColdMigrator | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<NormalizedTimeseriesHotColdMigrator | null> | null;
   ...
   */
  update(srcObj?: NormalizedTimeseriesHotColdMigrator | null, spec?: UpsertSpec | null): NormalizedTimeseriesHotColdMigrator | null;
   ...
   */
  upsert(srcObj?: NormalizedTimeseriesHotColdMigrator | null, spec?: UpsertSpec | null): NormalizedTimeseriesHotColdMigrator | null;
   ...
   */
  merge(spec?: MergeSpec | null): NormalizedTimeseriesHotColdMigrator | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): NormalizedTimeseriesHotColdMigrator | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): NormalizedTimeseriesHotColdMigrator | null;
   ...
   */
  static updateBatch(objs: C3.Array<NormalizedTimeseriesHotColdMigrator | null> | null, srcObjs?: C3.Array<NormalizedTimeseriesHotColdMigrator | null>, spec?: UpsertSpec | null): ObjList<NormalizedTimeseriesHotColdMigrator | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<NormalizedTimeseriesHotColdMigrator | null>>, spec?: UpsertSpec | null): ObjList<NormalizedTimeseriesHotColdMigrator | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<NormalizedTimeseriesHotColdMigrator | null> | null, srcObjs?: C3.Array<NormalizedTimeseriesHotColdMigrator | null>, spec?: UpsertSpec | null): ObjList<NormalizedTimeseriesHotColdMigrator | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<NormalizedTimeseriesHotColdMigrator | null>>, spec?: UpsertSpec | null): ObjList<NormalizedTimeseriesHotColdMigrator | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<NormalizedTimeseriesHotColdMigrator | null> | null, spec?: TouchSpec | null): ObjList<NormalizedTimeseriesHotColdMigrator | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<NormalizedTimeseriesHotColdMigrator | null> | null, spec?: MergeSpec | null): ObjList<NormalizedTimeseriesHotColdMigrator | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<NormalizedTimeseriesHotColdMigrator | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<NormalizedTimeseriesHotColdMigrator | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<NormalizedTimeseriesHotColdMigrator | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<NormalizedTimeseriesHotColdMigrator | null> | null;
   ...
   */
  static mergeAll(mergeObj: NormalizedTimeseriesHotColdMigrator | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: NormalizedTimeseriesHotColdMigrator | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<NormalizedTimeseriesHotColdMigrator | null> | null, spec?: UpsertSpec | null): ObjList<NormalizedTimeseriesHotColdMigrator | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<NormalizedTimeseriesHotColdMigrator | null> | null, spec?: UpsertSpec | null): ObjList<NormalizedTimeseriesHotColdMigrator | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): NormalizedTimeseriesHotColdMigrator | null;
   ...
   */
  static beforeCreate(objs: C3.Array<NormalizedTimeseriesHotColdMigrator | null> | null): ObjList<NormalizedTimeseriesHotColdMigrator | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<NormalizedTimeseriesHotColdMigrator | null> | null): ObjList<NormalizedTimeseriesHotColdMigrator | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<NormalizedTimeseriesHotColdMigrator | null> | null): ObjList<NormalizedTimeseriesHotColdMigrator | null>;
   ...
   */
  static afterCreate(objs: C3.Array<NormalizedTimeseriesHotColdMigrator | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<NormalizedTimeseriesHotColdMigrator | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<NormalizedTimeseriesHotColdMigrator | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<NormalizedTimeseriesHotColdMigrator | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<NormalizedTimeseriesHotColdMigrator | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): NormalizedTimeseriesHotColdMigrator | null;
   ...
   */
  withoutIdentity(): NormalizedTimeseriesHotColdMigrator | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<NormalizedTimeseriesHotColdMigrator | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: NormalizedTimeseriesHotColdMigrator | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<NormalizedTimeseriesHotColdMigrator | null> | null, callback?: λFunction<NormalizedTimeseriesHotColdMigrator | null, NormalizedTimeseriesHotColdMigrator | null> | null): ObjList<NormalizedTimeseriesHotColdMigrator | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<NormalizedTimeseriesHotColdMigrator | null> | null, callback?: λFunction<NormalizedTimeseriesHotColdMigrator | null, NormalizedTimeseriesHotColdMigrator | null> | null): C3.Array<ObjError | null>;
   ...
   *         key type.
   */
  static map(batch?: number | null, objs?: C3.Array<Obj | null>, job?: MapReduce<Obj | null, number | null, number | null, number | null> | null, subBatch?: number | null): C3.Map<number | null, number | null>;
   ...
   */
  static reduce(outKey?: number | null, interValues?: C3.Array<number | null>, job?: MapReduce<Obj | null, number | null, number | null, number | null> | null): number | null | C3.Array<number | null> | null;
   ...
   */
  static mapCompleted(job?: MapReduce<Obj | null, number | null, number | null, number | null> | null): void;
   ...
   */
  static completed(job?: MapReduce<Obj | null, number | null, number | null, number | null> | null): string | null;
   ...
   */
  static failed(job: MapReduce<Obj | null, number | null, number | null, number | null>, status: MapReduceStatus, options?: MapReduceOptions | null): void;
   ...
   */
  results(limit?: number | null): C3.Map<number | null, number | null | C3.Array<number | null> | null>;

  /**
   * MapReduce engine provided internal actions
   */
  static readInput(jobId?: string | null): void;

  scanTargetType(): Stream<Obj | null>;

  shouldProcessBlocks(): boolean;

  getMapObjs(map: MapInValue): C3.Array<any>;

  static dispatchMap(jobId?: string | null, context?: string | null): void;

  static dispatchReduce(jobId?: string | null, context?: string | null): void;
  ...
  /**
   * Starts the NormalizedTimeseries hot/cold migrator job. If no dataPointType is specified, then it will trigger
   * multiple map reduce jobs one for each data point type where hot/cold migration needs to be invoked
   *
   * @param dataPointType
   *            Specific type for which
   * @param options
   *            Options for underlying map reduce job, e.g. setting nodePool, maxConcurrencyPerNode
   * @param force
   *            If set, reads the entire NormalizedTimeseries object in memory and performs the hot/cold migration
   * @return job instances per data point type
   */
  static trigger(dataPointType?: Type | null, options?: JobOptions | null, force?: boolean): C3.Array<NormalizedTimeseriesHotColdMigrator | null>;

  /**
   * Perform hot/cold compaction for NormalizedTimeseries for a given Timeseries header. Optionally if the tsField is set,
   * it will perform hot/cold migration only for the provided tsField
   * @param header
   *            Header on which the hot/cold migration needs to be performed
   * @param tsField
   *            If set, only performs hot/cold migration for the provided tsField
   * @param force
   *            If set, reads the entire NormalizedTimeseries object in memory and performs the hot/cold migration
   */
  static compact(header: TimedDataFields<any>, tsField?: string | null, force?: boolean): void;
}
