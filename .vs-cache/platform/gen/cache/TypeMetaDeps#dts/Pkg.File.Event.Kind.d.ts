// TypeScript definitions for the C3 type Pkg.File.Event.Kind

/**
 * type of change done to a Pkg.File
 *
 * @remarks this represents a value passed to a method that expects an instance of Pkg.File.Event.Kind
 */
declare namespace Pkg.File.Event {
