// TypeScript definitions for the C3 type VectorType
 ...
 * @see ArrayType
 *
 * @remarks this represents a value passed to a method that expects an instance of VectorType
 */
declare interface IVectorType {
 ...
 */
declare class VectorType extends Obj {

  /**
   * Source file Pkg.Path a C3 Type declaration [.c3typ].
   */
  readonly declaredPkgPath?: string | null;
  withDeclaredPkgPath(declaredPkgPath: string | null): VectorType;

  /**
   * Source line number in a C3 Type declaration [.c3typ] file starting with 1 where this metadata element is declared.
   */
  readonly declaredSrcLine?: number | null;
  withDeclaredSrcLine(declaredSrcLine: number | null): VectorType;
  ...
  withDeclaredSrcCharInLine(declaredSrcCharInLine: number | null): VectorType;
   ...
   */
  readonly pkg: Pkg;
  withPkg(pkg: IPkg): VectorType;

  /**
   * SDK json representing instance of this type
   */
  readonly json?: any;
  withJson(json: any): VectorType;

  /**
   * The set of annotations defined on this element of metadata represented as json value.
   */
  readonly annotationsJson?: any | null;
  withAnnotationsJson(annotationsJson: any | null): VectorType;
  ...
  withModifier(modifier: string | null): VectorType;
  ...
  withKeyType(keyType: IValueType | null): VectorType;

  /**
   * The value type for the elements of the collection.
   */
  readonly elementType: ValueType;
  withElementType(elementType: IValueType): VectorType;

  /**
   * The declared size of the vector.
   */
  readonly size: number;
  withSize(size: number): VectorType;
   ...
   */
  replaceType(old: Type, new_: Type): VectorType;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): VectorType | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): VectorType | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): VectorType | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): VectorType | null;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VectorType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VectorType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VectorType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VectorType | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): VectorType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VectorType;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VectorType;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): VectorType;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): VectorType;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): VectorType;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): VectorType;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): VectorType;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): VectorType;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): VectorType;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): VectorType;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): VectorType;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): VectorType;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): VectorType;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): VectorType;
   ...
   * @see #unsetField
   */
  defaultField(field: string): VectorType;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): VectorType;
   ...
   * @see #removeField
   */
  unsetField(field: string): VectorType;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): VectorType;
   ...
   * @see #unsetField
   */
  removeField(field: string): VectorType;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): VectorType;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): VectorType;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): VectorType;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): VectorType;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): VectorType;

  mergeJson(json: any | null): VectorType;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): VectorType;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): VectorType;
   ...
   */
  singletonArray(): C3.Array<VectorType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<VectorType | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<VectorType | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<VectorType | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<VectorType | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, VectorType | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, VectorType | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<VectorType | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<VectorType | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): VectorType;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): VectorType;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): VectorType;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): VectorType;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): VectorType;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): VectorType;
   ...
   * @see #fromString
   */
  static make(s: string | null): VectorType | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): VectorType;
   ...
   */
  static cachedEmptyInst(): VectorType;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<VectorType>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): VectorType;
   ...
   */
  withoutDeclaredSrcPos(recursive?: boolean): VectorType;
   ...
   */
  withAnnotation(ann: Annotation): VectorType;
   ...
   *         value for the field
   */
  withAnnotation(ann: string, annField?: string | null, value?: any): VectorType;
   ...
   * @see #toString
   */
  static fromString(s: string | null): VectorType | null;
