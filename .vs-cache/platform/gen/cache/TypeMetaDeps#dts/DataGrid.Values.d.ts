// TypeScript definitions for the C3 type DataGrid.Values
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of DataGrid.Values
 */
declare namespace DataGrid {
  export interface IValues {
    ...
    _coll: ICollection<any>;

    _stream?: Stream<any> | Array<any>;
     ...
     */
    sourceType: IValueType;

    /**
     * For a JSON array of objects/arrays, break out properties as columns.
     */
    _jsonProps?: C3.Map<string | null, ValueType | null> | {[key: string | null]: IValueType | null};
  }
}
 ...
 */
declare namespace DataGrid {
  export class Values extends Obj {

    /**
     * The raw data from which the grid was built.
     */
    readonly source?: any;
    withSource(source: any): DataGrid.Values;
    ...
    withLabel(label: string | null): DataGrid.Values;

    /**
     * A more detailed description of the source of the data. Typically the full value type of the data.
     */
    readonly description?: string | null;
    withDescription(description: string | null): DataGrid.Values;
    ...
    withCols(cols: C3.Array<DataGrid.Col> | Array<IDataGrid.Col>): DataGrid.Values;

    readonly _coll: Collection<any>;
    with_coll(_coll: ICollection<any>): DataGrid.Values;

    readonly _stream?: Stream<any>;
    with_stream(_stream: Stream<any> | Array<any>): DataGrid.Values;

    readonly _buffer?: any;
    with_buffer(_buffer: any): DataGrid.Values;

    readonly _keys?: C3.Array<any>;
    with_keys(_keys: C3.Array<any> | Array<any>): DataGrid.Values;

    /**
     * The type of the values. In most cases, this will be a more specific type than `any`, If the collection is of
     * heterogenous value types, it will be a shared type of them all (which may end up being `any`).
     */
    readonly sourceType: ValueType;
    withSourceType(sourceType: IValueType): DataGrid.Values;

    /**
     * For a JSON array of objects/arrays, break out properties as columns.
     */
    readonly _jsonProps?: C3.Map<string | null, ValueType | null>;
    with_jsonProps(_jsonProps: C3.Map<string | null, ValueType | null> | {[key: string | null]: IValueType | null}): DataGrid.Values;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): DataGrid.Values | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): DataGrid.Values | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): DataGrid.Values | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): DataGrid.Values | null;
     ...
     */
    replaceType(old: Type, new_: Type): DataGrid.Values;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataGrid.Values;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataGrid.Values;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataGrid.Values | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataGrid.Values | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataGrid.Values;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataGrid.Values;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataGrid.Values;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): DataGrid.Values;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): DataGrid.Values;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): DataGrid.Values;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataGrid.Values;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataGrid.Values;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): DataGrid.Values;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): DataGrid.Values;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): DataGrid.Values;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): DataGrid.Values;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataGrid.Values;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): DataGrid.Values;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataGrid.Values;
     ...
     * @see #unsetField
     */
    defaultField(field: string): DataGrid.Values;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): DataGrid.Values;
     ...
     * @see #removeField
     */
    unsetField(field: string): DataGrid.Values;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): DataGrid.Values;
     ...
     * @see #unsetField
     */
    removeField(field: string): DataGrid.Values;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): DataGrid.Values;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataGrid.Values;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): DataGrid.Values;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataGrid.Values;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataGrid.Values;

    mergeJson(json: any | null): DataGrid.Values;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataGrid.Values;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): DataGrid.Values;
     ...
     */
    singletonArray(): C3.Array<DataGrid.Values | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<DataGrid.Values | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<DataGrid.Values | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<DataGrid.Values | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<DataGrid.Values | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, DataGrid.Values | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataGrid.Values | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<DataGrid.Values | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<DataGrid.Values | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DataGrid.Values;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DataGrid.Values;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DataGrid.Values;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): DataGrid.Values;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DataGrid.Values;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): DataGrid.Values;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DataGrid.Values;
     ...
     */
    static cachedEmptyInst(): DataGrid.Values;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DataGrid.Values>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): DataGrid.Values;
     ...
     */
    static fromCollection(coll: Collection<any>, spec?: DataGrid.LoadSpec | null): DataGrid.Values;
  }
}
