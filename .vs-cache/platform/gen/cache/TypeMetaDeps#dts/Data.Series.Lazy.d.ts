// TypeScript definitions for the C3 type Data.Series.Lazy

/**
 * Internal instance of {@link Data.Series} as partially applied function.
 *
 * @remarks this represents a value passed to a method that expects an instance of Data.Series.Lazy
 */
...
declare namespace Data.Series {
  export class Lazy extends Obj {
    ...
    withSTATELESS_CACHE(STATELESS_CACHE: string | null): Data.Series.Lazy;
     ...
     */
    readonly this: any;
    withThis(this_: any): Data.Series.Lazy;

    /**
     * Target action returning DataImpl
     */
    readonly action: string;
    withAction(action: string): Data.Series.Lazy;

    /**
     * Applied arguments
     */
    readonly args?: C3.Map<string | null, any>;
    withArgs(args: C3.Map<string | null, any> | {[key: string | null]: any}): Data.Series.Lazy;
    ...
    with_inferredOutType(_inferredOutType: C3.Map<string | null, ValueType | null> | {[key: string | null]: IValueType | null}): Data.Series.Lazy;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.Series.Lazy | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.Series.Lazy | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.Series.Lazy | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.Series.Lazy | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.Series.Lazy;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Series.Lazy;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Series.Lazy;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Series.Lazy | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Series.Lazy | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.Series.Lazy;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Series.Lazy;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Series.Lazy;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.Series.Lazy;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.Series.Lazy;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.Series.Lazy;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.Series.Lazy;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.Series.Lazy;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.Series.Lazy;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.Series.Lazy;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.Series.Lazy;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.Series.Lazy;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.Series.Lazy;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.Series.Lazy;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.Series.Lazy;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.Series.Lazy;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.Series.Lazy;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.Series.Lazy;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.Series.Lazy;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.Series.Lazy;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.Series.Lazy;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.Series.Lazy;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.Series.Lazy;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.Series.Lazy;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.Series.Lazy;

    mergeJson(json: any | null): Data.Series.Lazy;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.Series.Lazy;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.Series.Lazy;
     ...
     */
    singletonArray(): C3.Array<Data.Series.Lazy | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.Series.Lazy | null>;
     ...
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.Series.Lazy | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.Series.Lazy | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.Series.Lazy | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.Series.Lazy | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.Series.Lazy | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.Series.Lazy | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.Series.Lazy | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.Series.Lazy;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.Series.Lazy;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.Series.Lazy;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.Series.Lazy;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.Series.Lazy;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.Series.Lazy;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.Series.Lazy;
     ...
     */
    static cachedEmptyInst(): Data.Series.Lazy;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.Series.Lazy>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.Series.Lazy;
     ...
     */
    toDataRef(ds?: Dataset | null): Data.Series.Ref | null;
     ...
     */
    static fromPySrc(pySrc: string, dfs?: C3.Set<DataImpl | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): Data.Series.Lazy | null;
     ...
     */
    static _jsDataProxy(inst: any): Data.Series.Lazy;
     ...
     */
    static create(this_: any, action: string, args?: C3.Map<string | null, any>): Data.Series.Lazy;
    ...
    _toPandas(datasetId: string, returnNullIfNotCached?: boolean): Data.Series.Pandas | null;
  }
}
