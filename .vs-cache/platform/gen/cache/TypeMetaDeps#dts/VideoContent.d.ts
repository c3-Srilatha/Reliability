// TypeScript definitions for the C3 type VideoContent

/**
 * C3 type holding a Video in memory.
 *
 * @remarks this represents a value passed to a method that expects an instance of VideoContent
 */
declare interface IVideoContent {
 ...
 * C3 type holding a Video in memory.
 *
 * @remarks this represents a made instance of VideoContent
 */
declare class VideoContent extends Obj {
  ...
  withWidth(width: number | null): VideoContent;
  ...
  withHeight(height: number | null): VideoContent;
  ...
  withContentEncoding(contentEncoding: string | null): VideoContent;
  ...
  withContentLanguage(contentLanguage: string | null): VideoContent;
  ...
  withContentLength(contentLength: number | null): VideoContent;
  ...
  withContentLocation(contentLocation: string | null): VideoContent;
  ...
  withContentType(contentType: string | null): VideoContent;
  ...
  withContentDisposition(contentDisposition: string | null): VideoContent;
  ...
  withETag(eTag: string | null): VideoContent;
  ...
  withLastModified(lastModified: DateTime | Date | string | null): VideoContent;

  /**
   * Id of user / identity who last last modified this content.
   */
  readonly lastModifiedBy?: string | null;
  withLastModifiedBy(lastModifiedBy: string | null): VideoContent;
  ...
  withContentMD5(contentMD5: string | null): VideoContent;
  ...
  withContentSHA1(contentSHA1: string | null): VideoContent;

  /**
   * Field to maintain state whether content metadata was read or not.
   */
  readonly hasMetadata?: boolean;
  withHasMetadata(hasMetadata: boolean): VideoContent;

  /**
   * The actual content value.
   */
  readonly content?: any | null;
  withContent(content: any | null): VideoContent;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): VideoContent | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): VideoContent | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): VideoContent | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): VideoContent | null;
   ...
   */
  replaceType(old: Type, new_: Type): VideoContent;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VideoContent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VideoContent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VideoContent | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VideoContent | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): VideoContent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VideoContent;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VideoContent;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): VideoContent;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): VideoContent;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): VideoContent;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): VideoContent;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): VideoContent;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): VideoContent;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): VideoContent;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): VideoContent;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): VideoContent;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): VideoContent;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): VideoContent;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): VideoContent;
   ...
   * @see #unsetField
   */
  defaultField(field: string): VideoContent;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): VideoContent;
   ...
   * @see #removeField
   */
  unsetField(field: string): VideoContent;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): VideoContent;
   ...
   * @see #unsetField
   */
  removeField(field: string): VideoContent;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): VideoContent;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): VideoContent;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): VideoContent;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): VideoContent;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): VideoContent;

  mergeJson(json: any | null): VideoContent;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): VideoContent;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): VideoContent;
   ...
   */
  singletonArray(): C3.Array<VideoContent | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<VideoContent | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<VideoContent | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<VideoContent | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<VideoContent | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, VideoContent | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, VideoContent | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<VideoContent | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<VideoContent | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): VideoContent;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): VideoContent;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): VideoContent;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): VideoContent;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): VideoContent;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): VideoContent;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): VideoContent;
   ...
   */
  static cachedEmptyInst(): VideoContent;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<VideoContent>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): VideoContent;
   ...
   */
  readMediaMetadata(): VideoContent;

  /**
   * @return instance of the Visual Media from provided content and optionally reads metadata
   */
  static fromContent(content: Content, readMetadata?: boolean): VideoContent;
   ...
   */
  static fromRawBinary(data: any, contentType?: string | null, width?: number | null, height?: number | null): VideoContent;
   ...
   */
  static fromBase64String(data: string, contentType?: string | null, width?: number | null, height?: number | null): VideoContent;
   ...
   */
  withRawBinary(data: any, contentType?: string | null, width?: number | null, height?: number | null): VideoContent;
   ...
   */
  withBase64String(data: string, contentType?: string | null, width?: number | null, height?: number | null): VideoContent;
   ...
   */
  withFileName(fileName: string | null): VideoContent;

  /**
   * Changes file extension in this instance.
   */
  withFileExt(fileExt: string | null): VideoContent;
   ...
   */
  identify(suffix?: string | null): VideoContent;
   ...
   */
  readMetadata(spec?: FileOperationSpec | null): VideoContent;
   ...
   */
  refreshMetadata(spec?: FileOperationSpec | null): VideoContent;
   ...
   * @return abstract content with metadata.
   */
  guessMetadata(spec?: FileOperationSpec | null): VideoContent;

  /**
   * Clears the content metadata; e.g. if it's known to be invalid.
   */
  clearMetadata(): VideoContent;

  /**
   * @return clone of this content with metadata from provided input.
   */
  withMetadata(meta?: ContentMeta | null): VideoContent;
   ...
   */
  encodedPushStream(spec?: FileOperationSpec | null): Pair<VideoContent | null, BytePushStream | null>;

  /**
   * @return byte push stream to be used for writing un-encoded data into this content object.
   */
  pushStream(spec?: FileOperationSpec | null): Pair<VideoContent | null, BytePushStream | null>;

  /**
   * @return character push stream to be used for writing un-encoded data into this content object.
   */
  charPushStream(spec?: FileOperationSpec | null): Pair<VideoContent | null, CharPushStream | null>;
   ...
   */
  encodedStream(spec?: FileOperationSpec | null): Pair<VideoContent | null, ByteStream | null> | null;
   ...
   */
  writeStream(content: ByteStream | null, spec?: FileOperationSpec | null): VideoContent;

  /**
   * Truncates file and replaces it's content with provided binary content.
   */
  writeInputStream(inputStream: any, spec?: FileOperationSpec | null): VideoContent;

  /**
   * Truncates file and replaces its content with provided binary content from zipInputStream
   */
  writeZipInputStream(zipInputStream: any, spec?: FileOperationSpec | null): VideoContent;
   ...
   */
  writeEncodedStream(encodedContent: ByteStream | null, spec?: FileOperationSpec | null): VideoContent;

  /**
   * Truncates file and replaces it's encoded content with provided binary content.
   */
  writeEncodedInputStream(inputStream: any, spec?: FileOperationSpec | null): VideoContent;
   ...
   *           content that needs to be written
   */
  write(content: any | null, spec?: FileOperationSpec | null): VideoContent;
   ...
   *           encoded content that needs to be written
   */
  writeEncoded(encodedContent: any | null, spec?: FileOperationSpec | null): VideoContent;
   ...
   *           content that needs to be written
   */
  writeString(content: string | null, spec?: FileOperationSpec | null): VideoContent;
   ...
   */
  writeObj(obj: Obj | null, spec?: FileObjsOperSpec | null): VideoContent;
   ...
   * @return pair of update instance of this content and number of objs written
   */
  startWriteObjs(spec?: FileObjsOperSpec | null): Pair<VideoContent | null, PushStream<Obj | null> | null>;
   ...
   */
  compress(contentEncoding?: string | null, spec?: FileCompressSpec | null): VideoContent;

  /**
   * Uncompresses content.
   */
  uncompress(spec?: FileCompressSpec | null): VideoContent;
   ...
   */
  transcode(contentType: string, contentEncoding: string, spec?: FileCompressSpec | null): VideoContent;

  /**
   * Copies content to a given target.
   */
  copyContentTo(target: VideoContent, spec?: FileOperationSpec | null): void;
