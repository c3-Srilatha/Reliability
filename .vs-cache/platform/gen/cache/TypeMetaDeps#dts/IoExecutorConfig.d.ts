// TypeScript definitions for the C3 type IoExecutorConfig

/**
 * @remarks this represents a value passed to a method that expects an instance of IoExecutorConfig
 */
declare interface IIoExecutorConfig {
...
/**
 * @remarks this represents a made instance of IoExecutorConfig
 */
declare class IoExecutorConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): IoExecutorConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): IoExecutorConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): IoExecutorConfig;

  readonly threads?: number | null;
  withThreads(threads: number | null): IoExecutorConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): IoExecutorConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): IoExecutorConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): IoExecutorConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): IoExecutorConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): IoExecutorConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): IoExecutorConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): IoExecutorConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<IoExecutorConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<IoExecutorConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): IoExecutorConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): IoExecutorConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): IoExecutorConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): IoExecutorConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): IoExecutorConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): IoExecutorConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): IoExecutorConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): IoExecutorConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): IoExecutorConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): IoExecutorConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): IoExecutorConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): IoExecutorConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): IoExecutorConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): IoExecutorConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): IoExecutorConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): IoExecutorConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): IoExecutorConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): IoExecutorConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): IoExecutorConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): IoExecutorConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): IoExecutorConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): IoExecutorConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): IoExecutorConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): IoExecutorConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): IoExecutorConfig;

  mergeJson(json: any | null): IoExecutorConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): IoExecutorConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): IoExecutorConfig;
   ...
   */
  singletonArray(): C3.Array<IoExecutorConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<IoExecutorConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<IoExecutorConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<IoExecutorConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<IoExecutorConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, IoExecutorConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, IoExecutorConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<IoExecutorConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<IoExecutorConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): IoExecutorConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): IoExecutorConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): IoExecutorConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): IoExecutorConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): IoExecutorConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): IoExecutorConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): IoExecutorConfig;
   ...
   */
  static cachedEmptyInst(): IoExecutorConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<IoExecutorConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): IoExecutorConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<IoExecutorConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<IoExecutorConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<IoExecutorConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): IoExecutorConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): IoExecutorConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): IoExecutorConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): IoExecutorConfig | null;
   ...
   */
  static produce(key: string): IoExecutorConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, IoExecutorConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, IoExecutorConfig | null>;
   ...
   */
  static forConfigKey(configKey: string | null): IoExecutorConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<IoExecutorConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: IoExecutorConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: IoExecutorConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): IoExecutorConfig | null;
