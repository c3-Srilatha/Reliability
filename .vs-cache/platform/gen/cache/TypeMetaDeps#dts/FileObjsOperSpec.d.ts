// TypeScript definitions for the C3 type FileObjsOperSpec

/**
 * Spec for content operation around serialized C3 types.
 *
 * @see Content#readObjs
 * @see Content#writeObjs
 *
 * @remarks this represents a value passed to a method that expects an instance of FileObjsOperSpec
 */
declare interface IFileObjsOperSpec {
 ...
 * @see Content#writeObjs
 *
 * @remarks this represents a made instance of FileObjsOperSpec
 */
declare class FileObjsOperSpec extends Obj {

  /**
   * Data serialization type. If not provided type will be inferred from source data
   */
  readonly serValueType?: ValueType | null;
  withSerValueType(serValueType: IValueType | null): FileObjsOperSpec;

  /**
   * Content Type of the source data
   */
  readonly contentType?: string | null;
  withContentType(contentType: string | null): FileObjsOperSpec;

  /**
   * Compression / Content Encoding of this data
   */
  readonly contentEncoding?: string | null;
  withContentEncoding(contentEncoding: string | null): FileObjsOperSpec;

  /**
   * Batch size to use during serialization if batch writing is used (Arrow format uses batching).
   */
  readonly batchSize?: number | null;
  withBatchSize(batchSize: number | null): FileObjsOperSpec;
  ...
  withNoCsvHeader(noCsvHeader: boolean): FileObjsOperSpec;
  ...
  withCsvHeader(csvHeader: string | null): FileObjsOperSpec;

  /**
   * Optional format for a csv values. Key should be field path used in a csv header.
   */
  readonly csvFormat?: C3.Map<string | null, Format | null>;
  withCsvFormat(csvFormat: C3.Map<string | null, Format | null> | {[key: string | null]: IFormat | null}): FileObjsOperSpec;

  /**
   * Default csv delimiter for target type. Used for text/csv files. Leave this field as null for all other content types.
   */
  readonly defaultCsvDelimiter?: string | null;
  withDefaultCsvDelimiter(defaultCsvDelimiter: string | null): FileObjsOperSpec;

  /**
   * Default escape character for target type. Used for text/csv files. Leave this field as null for all other content types.
   */
  readonly defaultCsvEscapeChar?: string | null;
  withDefaultCsvEscapeChar(defaultCsvEscapeChar: string | null): FileObjsOperSpec;

  /**
   * Default quote character for target type. Used for text/csv files. Leave this field as null for all other content types.
   */
  readonly defaultCsvQuoteChar?: string | null;
  withDefaultCsvQuoteChar(defaultCsvQuoteChar: string | null): FileObjsOperSpec;
  ...
  withAvroSchema(avroSchema: string | null): FileObjsOperSpec;
  ...
  withIsObjList(isObjList: boolean): FileObjsOperSpec;

  /**
   * Optionally skip extra fields in serialized content instead of failing to serialize.
   */
  readonly skipExtraFields?: boolean;
  withSkipExtraFields(skipExtraFields: boolean): FileObjsOperSpec;

  /**
   * If true will silently ignore bad syntax in the content and will return no or partial results.
   */
  readonly ignoreBadContent?: boolean;
  withIgnoreBadContent(ignoreBadContent: boolean): FileObjsOperSpec;
  ...
  withMergeXmlNonAdjacentLists(mergeXmlNonAdjacentLists: boolean): FileObjsOperSpec;

  /**
   * Specifies various parameters for automatic retry that occurs in upsert due to retryable errors.
   */
  readonly retrySpec?: RetrySpec | null;
  withRetrySpec(retrySpec: IRetrySpec | null): FileObjsOperSpec;

  /**
   * If set, stream will be instantiated again on retryable errors and execution will continue from the point of failure
   */
  readonly restartStreamOnRetry?: boolean;
  withRestartStreamOnRetry(restartStreamOnRetry: boolean): FileObjsOperSpec;

  /**
   * The index of the first object from a stream that needs to be read.
   */
  readonly offset?: number | null;
  withOffset(offset: number | null): FileObjsOperSpec;
  ...
  withLimit(limit: number | null): FileObjsOperSpec;
  ...
  withValidateContentType(validateContentType: boolean): FileObjsOperSpec;
  ...
  withPeekForMetadata(peekForMetadata: boolean): FileObjsOperSpec;
  ...
  withFailIfMissing(failIfMissing: boolean): FileObjsOperSpec;
  ...
  withSkipIfUnauthorized(skipIfUnauthorized: boolean): FileObjsOperSpec;

  /**
   * If set and if requested file or directory url is under this path then will retrieve content from cache.
   */
  readonly cacheUrlOrEncodedPath?: string | null;
  withCacheUrlOrEncodedPath(cacheUrlOrEncodedPath: string | null): FileObjsOperSpec;

  /**
   * Time in seconds that the cached file should live (default 24 hours).
   */
  readonly cacheTtlSec?: number | null;
  withCacheTtlSec(cacheTtlSec: number | null): FileObjsOperSpec;
  ...
  withForceMultiPart(forceMultiPart: boolean): FileObjsOperSpec;
  ...
  withDisableMultiPart(disableMultiPart: boolean): FileObjsOperSpec;

  /**
   * Overrides default maximum file size before MultipartUpload kicks in. Default is 1GB
   */
  readonly maximumSingleUploadsize?: number | null;
  withMaximumSingleUploadsize(maximumSingleUploadsize: number | null): FileObjsOperSpec;
  ...
  withMaxThreads(maxThreads: number | null): FileObjsOperSpec;
  ...
  withMinThreads(minThreads: number | null): FileObjsOperSpec;

  /**
   * If set to true, it will retry reading file when the file is not found.
   */
  readonly retryOnNotFound?: boolean;
  withRetryOnNotFound(retryOnNotFound: boolean): FileObjsOperSpec;
  ...
  withLockOnWrite(lockOnWrite: boolean): FileObjsOperSpec;

  /**
   * If set will use IoExecutor service.
   */
  readonly useIoExecutor?: boolean;
  withUseIoExecutor(useIoExecutor: boolean): FileObjsOperSpec;

  /**
   * If not null, retry logic will be used from CloudClient rather than File
   */
  readonly cloudClient?: any;
  withCloudClient(cloudClient: any): FileObjsOperSpec;
  ...
  withSerType(serType: IType | null): FileObjsOperSpec;

  /**
   * If true then will not use parent folder of content for target type guess.
   */
  readonly doNotUseParentDirForSerType?: boolean;
  withDoNotUseParentDirForSerType(doNotUseParentDirForSerType: boolean): FileObjsOperSpec;
  ...
  withUseBinaryEncodingDecoding(useBinaryEncodingDecoding: boolean): FileObjsOperSpec;

  /**
   * Optionally indicating if serialized form should contain C3 type.
   */
  readonly shouldNotWriteType?: boolean;
  withShouldNotWriteType(shouldNotWriteType: boolean): FileObjsOperSpec;

  /**
   * Optionally indicating if serialized form should be formatted for ease of reading.
   */
  readonly shouldWritePretty?: boolean;
  withShouldWritePretty(shouldWritePretty: boolean): FileObjsOperSpec;
  ...
  withGuessMetadata(guessMetadata: boolean): FileObjsOperSpec;

  /**
   * If true, checksum files will be generated when writing files
   */
  readonly createChecksum?: boolean;
  withCreateChecksum(createChecksum: boolean): FileObjsOperSpec;

  /**
   * Whether to decrypt content during read
   */
  readonly decrypt?: boolean;
  withDecrypt(decrypt: boolean): FileObjsOperSpec;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): FileObjsOperSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): FileObjsOperSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): FileObjsOperSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): FileObjsOperSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): FileObjsOperSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FileObjsOperSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FileObjsOperSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FileObjsOperSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FileObjsOperSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): FileObjsOperSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FileObjsOperSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FileObjsOperSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FileObjsOperSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FileObjsOperSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FileObjsOperSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): FileObjsOperSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FileObjsOperSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FileObjsOperSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): FileObjsOperSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): FileObjsOperSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): FileObjsOperSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): FileObjsOperSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FileObjsOperSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): FileObjsOperSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FileObjsOperSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FileObjsOperSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): FileObjsOperSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FileObjsOperSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): FileObjsOperSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FileObjsOperSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): FileObjsOperSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): FileObjsOperSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): FileObjsOperSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): FileObjsOperSpec;

  mergeJson(json: any | null): FileObjsOperSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): FileObjsOperSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): FileObjsOperSpec;
   ...
   */
  singletonArray(): C3.Array<FileObjsOperSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<FileObjsOperSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FileObjsOperSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<FileObjsOperSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FileObjsOperSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, FileObjsOperSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FileObjsOperSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FileObjsOperSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FileObjsOperSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): FileObjsOperSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): FileObjsOperSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): FileObjsOperSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FileObjsOperSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): FileObjsOperSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FileObjsOperSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): FileObjsOperSpec;
   ...
   */
  static cachedEmptyInst(): FileObjsOperSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<FileObjsOperSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): FileObjsOperSpec;

  /**
   * @return new instance of this spec with `retrySpec` set
   */
  withRetry(maxRetries?: number | null, initialSleepMillis?: number | null, exponent?: number | null): FileObjsOperSpec | null;

  /**
   * @return instance of this spec with `retrySpec`'s `maxTotalMillis` set
   */
  static timeoutSeconds(secs: number | null): FileObjsOperSpec;

  /**
   * @return FileObjsOperSpec with #serType set to provided value.
   */
  static fromType(serType: Type | null): FileObjsOperSpec;
   ...
   */
  static toDecrypt(): FileObjsOperSpec | null;
}
