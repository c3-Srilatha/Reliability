// TypeScript definitions for the C3 type IdpConfig

/**
 * @remarks this represents a value passed to a method that expects an instance of IdpConfig
 */
declare interface IIdpConfig {
...
/**
 * @remarks this represents a made instance of IdpConfig
 */
declare class IdpConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): IdpConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): IdpConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): IdpConfig;

  /**
   * The unique and required id of this instance.
   */
  readonly id: string;
  withId(id: string): IdpConfig;

  /**
   * If present, the user will be redirected to this url instead of the idp login page.
   */
  readonly defaultContentUrl?: string | null;
  withDefaultContentUrl(defaultContentUrl: string | null): IdpConfig;

  /**
   * Which field of the IdpUser to use as the user id
   */
  readonly userIdFormat?: string | null;
  withUserIdFormat(userIdFormat: string | null): IdpConfig;
  ...
  withDefaultGroupId(defaultGroupId: string | null): IdpConfig;

  /**
   * Returns whether we should write back to the Idp
   */
  readonly idpWriteback?: boolean;
  withIdpWriteback(idpWriteback: boolean): IdpConfig;

  /**
   * Returns whether we should write back {@link UserGroup} updates to the Idp
   */
  readonly idpGroupWriteback?: boolean;
  withIdpGroupWriteback(idpGroupWriteback: boolean): IdpConfig;

  /**
   * Returns the identity provider for write-back (if enabled)
   */
  readonly idpType?: string | null;
  withIdpType(idpType: string | null): IdpConfig;
  ...
  withExternalAppId(externalAppId: string | null): IdpConfig;
  ...
  withAllowedEmailDomains(allowedEmailDomains: C3.Array<string | null> | Array<string | null>): IdpConfig;

  /**
   * Applications that are trusted to redirect authenticated user(s)
   */
  readonly trustedApplicationHosts?: C3.Array<string | null>;
  withTrustedApplicationHosts(trustedApplicationHosts: C3.Array<string | null> | Array<string | null>): IdpConfig;

  /**
   * List of relevant groups for the cluster from the IDP. If empty, then no group filtering is done on user login.
   */
  readonly relevantGroups?: C3.Array<string | null>;
  withRelevantGroups(relevantGroups: C3.Array<string | null> | Array<string | null>): IdpConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): IdpConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): IdpConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): IdpConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): IdpConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): IdpConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): IdpConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): IdpConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<IdpConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<IdpConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): IdpConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): IdpConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): IdpConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): IdpConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): IdpConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): IdpConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): IdpConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): IdpConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): IdpConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): IdpConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): IdpConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): IdpConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): IdpConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): IdpConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): IdpConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): IdpConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): IdpConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): IdpConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): IdpConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): IdpConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): IdpConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): IdpConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): IdpConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): IdpConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): IdpConfig;

  mergeJson(json: any | null): IdpConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): IdpConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): IdpConfig;
   ...
   */
  singletonArray(): C3.Array<IdpConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<IdpConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<IdpConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<IdpConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<IdpConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, IdpConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, IdpConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<IdpConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<IdpConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): IdpConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): IdpConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): IdpConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): IdpConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): IdpConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): IdpConfig;
   ...
   * @see #fromString
   */
  static make(s: string | null): IdpConfig | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): IdpConfig;
   ...
   */
  static cachedEmptyInst(): IdpConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<IdpConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): IdpConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<IdpConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<IdpConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<IdpConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): IdpConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): IdpConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): IdpConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): IdpConfig | null;
   ...
   */
  static produce(key: string): IdpConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, IdpConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, IdpConfig | null>;
   ...
   */
  static forConfigKey(configKey: string | null): IdpConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<IdpConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: IdpConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: IdpConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): IdpConfig | null;
   ...
   */
  removeSecrets(): IdpConfig | null;

  /**
   * @return this config with only secret values.
   */
  removeNonSecrets(): IdpConfig | null;
   ...
   * @see #toString
   */
  static fromString(s: string | null): IdpConfig | null;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): IdpConfig | null;
