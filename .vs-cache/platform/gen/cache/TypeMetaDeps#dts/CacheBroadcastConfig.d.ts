// TypeScript definitions for the C3 type CacheBroadcastConfig

/**
 * Config used to determine what broadcast level messages will be sent. {@link CacheMessage#Level}
 *
 * @remarks this represents a value passed to a method that expects an instance of CacheBroadcastConfig
 */
declare interface ICacheBroadcastConfig {
   ...
   *    If set to 'http', will use http connections to broadcast messages.
   *    If set to 'db', will use {@link CacheQueue}
   */
  kind?: string | null;

  /**
   * If true, remote cache invalidation is turned on for app level {@link CacheMessage#Level}
   */
  app?: boolean;

  /**
   * If true, remote cache invalidation is turned on for env level {@link CacheMessage#Level}
   */
  env?: boolean;

  /**
   * If true, remote cache invalidation is turned on for cluster level {@link CacheMessage#Level}
   */
  cluster?: boolean;

  /**
   * If true, remote cache invalidation is not turned on. If false, will default to http unless specified otherwise.
   */
  disabled?: boolean;

  /**
   * If true, performs cache invalidation through {@link CacheQueue}
   */
  db?: boolean;

  /**
   * If true, performs cache invalidation solely through http connections
   */
  http?: boolean;
}
 ...
 * Config used to determine what broadcast level messages will be sent. {@link CacheMessage#Level}
 *
 * @remarks this represents a made instance of CacheBroadcastConfig
 */
declare class CacheBroadcastConfig extends Obj {

  readonly configOverride?: string | null;
  withConfigOverride(configOverride: string | null): CacheBroadcastConfig;

  readonly secretOverride?: string | null;
  withSecretOverride(secretOverride: string | null): CacheBroadcastConfig;

  /**
   * Captures any issues that occurred while deserializing from filesystem
   */
  readonly issues?: C3.Array<string | null>;
  withIssues(issues: C3.Array<string | null> | Array<string | null>): CacheBroadcastConfig;
  ...
  withKind(kind: string | null): CacheBroadcastConfig;

  /**
   * If true, remote cache invalidation is turned on for app level {@link CacheMessage#Level}
   */
  readonly app?: boolean;
  withApp(app: boolean): CacheBroadcastConfig;

  /**
   * If true, remote cache invalidation is turned on for env level {@link CacheMessage#Level}
   */
  readonly env?: boolean;
  withEnv(env: boolean): CacheBroadcastConfig;

  /**
   * If true, remote cache invalidation is turned on for cluster level {@link CacheMessage#Level}
   */
  readonly cluster?: boolean;
  withCluster(cluster: boolean): CacheBroadcastConfig;

  /**
   * If true, remote cache invalidation is not turned on. If false, will default to http unless specified otherwise.
   */
  readonly disabled?: boolean;
  withDisabled(disabled: boolean): CacheBroadcastConfig;

  /**
   * If true, performs cache invalidation through {@link CacheQueue}
   */
  readonly db?: boolean;
  withDb(db: boolean): CacheBroadcastConfig;

  /**
   * If true, performs cache invalidation solely through http connections
   */
  readonly http?: boolean;
  withHttp(http: boolean): CacheBroadcastConfig;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): CacheBroadcastConfig | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): CacheBroadcastConfig | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): CacheBroadcastConfig | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): CacheBroadcastConfig | null;
   ...
   */
  replaceType(old: Type, new_: Type): CacheBroadcastConfig;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): CacheBroadcastConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): CacheBroadcastConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<CacheBroadcastConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<CacheBroadcastConfig | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): CacheBroadcastConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CacheBroadcastConfig;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CacheBroadcastConfig;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): CacheBroadcastConfig;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): CacheBroadcastConfig;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): CacheBroadcastConfig;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): CacheBroadcastConfig;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): CacheBroadcastConfig;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): CacheBroadcastConfig;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): CacheBroadcastConfig;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): CacheBroadcastConfig;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): CacheBroadcastConfig;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): CacheBroadcastConfig;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): CacheBroadcastConfig;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): CacheBroadcastConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: string): CacheBroadcastConfig;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): CacheBroadcastConfig;
   ...
   * @see #removeField
   */
  unsetField(field: string): CacheBroadcastConfig;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): CacheBroadcastConfig;
   ...
   * @see #unsetField
   */
  removeField(field: string): CacheBroadcastConfig;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): CacheBroadcastConfig;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): CacheBroadcastConfig;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): CacheBroadcastConfig;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): CacheBroadcastConfig;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): CacheBroadcastConfig;

  mergeJson(json: any | null): CacheBroadcastConfig;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): CacheBroadcastConfig;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): CacheBroadcastConfig;
   ...
   */
  singletonArray(): C3.Array<CacheBroadcastConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<CacheBroadcastConfig | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<CacheBroadcastConfig | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<CacheBroadcastConfig | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<CacheBroadcastConfig | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, CacheBroadcastConfig | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, CacheBroadcastConfig | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<CacheBroadcastConfig | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<CacheBroadcastConfig | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): CacheBroadcastConfig;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): CacheBroadcastConfig;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): CacheBroadcastConfig;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): CacheBroadcastConfig;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): CacheBroadcastConfig;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): CacheBroadcastConfig;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): CacheBroadcastConfig;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): CacheBroadcastConfig;
   ...
   */
  static cachedEmptyInst(): CacheBroadcastConfig;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<CacheBroadcastConfig>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): CacheBroadcastConfig;
   ...
   */
  static allCached(doNotProduceAll?: boolean): Stream<CacheBroadcastConfig | null>;
   ...
   */
  static find(filter?: string | null, doNotProduceAll?: boolean): Stream<CacheBroadcastConfig | null>;
   ...
   * @return existing instances of this type that satisfy filter from data cache.
   */
  static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<CacheBroadcastConfig | null>;
   ...
   * @see getCached
   */
  static findByCacheKey(key: string): CacheBroadcastConfig | null;

  /**
   * Returns cached instance by key, with secrets removed.
   */
  static forCacheKey(key: string | null): CacheBroadcastConfig | null;
   ...
   * @see findByCacheKey
   */
  getCached(): CacheBroadcastConfig | null;

  /**
   * @return newly produced cached instance.
   */
  refreshCache(): CacheBroadcastConfig | null;
   ...
   */
  static produce(key: string): CacheBroadcastConfig | null;
   ...
   */
  static produceAll(): C3.Map<string | null, CacheBroadcastConfig | null>;

  /**
   * Override for sub-types to produce all values.
   */
  static doProduceAll(): C3.Map<string | null, CacheBroadcastConfig | null>;
   ...
   */
  getConfig(): CacheBroadcastConfig;
   ...
   */
  getSecret(): CacheBroadcastConfig;
   ...
   */
  static forConfigKey(configKey: string | null): CacheBroadcastConfig | null;
   ...
   */
  static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<CacheBroadcastConfig | null>;
   ...
   * @see setConfigValue
   */
  setConfigValues(from: CacheBroadcastConfig, override?: string | null): void;
   ...
   * @see setSecretValue
   */
  setSecretValues(from: CacheBroadcastConfig, override?: string | null): void;
   ...
   */
  static loadConfigAndSecret(configKey: string): CacheBroadcastConfig | null;
  ...
  /**
   * Sets the broadcastLevel flag to false and broadcasts to all nodes at the broadcastLevel to evict the CacheBroadcastConfig.
   *
   * @param broadcastLevel
   *        The level of cache broadcast that you want to be disable {@link Cache.Invalidator.Level}
   * @param override
   *        The override that you want to be disabled across the cluster {@link ConfigOverride}
   */
  static disable(broadcastLevel?: string | null, override?: string | null): void;

  /**
   * Sets the broadcastLevel flag to true and broadcasts to all nodes at the broadcastLevel to evict the CacheBroadcastConfig.
   *
   * @param broadcastLevel
   *        The level of cache broadcast that you want to be enabled {@link Cache.Invalidator.Level}
   * @param override
   *        The override that you want to be disabled across the cluster {@link ConfigOverride}
   */
  static enable(broadcastLevel?: string | null, override?: string | null): void;

  /**
   * Resets the CacheBroadcastConfig to its default state. Broadcasting will be determined via higher overrides.
   * This clears the config and broadcasts to all nodes in the Cluster to evict the CacheBroadcastConfig.
   */
  static reset(override?: string): void;

  /**
   * Sets the broadcastKind that will be used to broadcast messages.
   *
   * @param kind
   *        The kind of broadcast that you want to be set {@link CacheBroadcastKind}
   */
  static setKind(kind: string, override: string): void;
}
