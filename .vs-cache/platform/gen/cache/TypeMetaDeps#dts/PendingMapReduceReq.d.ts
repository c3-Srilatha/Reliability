// TypeScript definitions for the C3 type PendingMapReduceReq

/**
 * Pending mapReduce job scheduled during provisioning.
 *
 * @remarks this represents a value passed to a method that expects an instance of PendingMapReduceReq
 */
declare interface IPendingMapReduceReq {
 ...
 * Pending mapReduce job scheduled during provisioning.
 *
 * @remarks this represents a made instance of PendingMapReduceReq
 */
declare class PendingMapReduceReq extends Obj {
  ...
  withTypeIdent(typeIdent: string | null): PendingMapReduceReq;
   ...
   */
  readonly id: string;
  withId(id: string): PendingMapReduceReq;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): PendingMapReduceReq;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): PendingMapReduceReq;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): PendingMapReduceReq;
  ...
  withVersion(version: number | null): PendingMapReduceReq;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): PendingMapReduceReq;

  /**
   * Type to refresh.
   */
  readonly refreshType?: Type | null;
  withRefreshType(refreshType: IType | null): PendingMapReduceReq;

  /**
   * Id of the pending job.
   */
  readonly jobId: string;
  withJobId(jobId: string): PendingMapReduceReq;

  /**
   * Options to run the job with.
   */
  readonly options?: any;
  withOptions(options: any): PendingMapReduceReq;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): PendingMapReduceReq | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): PendingMapReduceReq | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): PendingMapReduceReq | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): PendingMapReduceReq | null;
   ...
   */
  replaceType(old: Type, new_: Type): PendingMapReduceReq;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PendingMapReduceReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PendingMapReduceReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PendingMapReduceReq | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PendingMapReduceReq | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): PendingMapReduceReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PendingMapReduceReq;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PendingMapReduceReq;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PendingMapReduceReq;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PendingMapReduceReq;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PendingMapReduceReq;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): PendingMapReduceReq;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PendingMapReduceReq;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PendingMapReduceReq;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): PendingMapReduceReq;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): PendingMapReduceReq;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): PendingMapReduceReq;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): PendingMapReduceReq;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PendingMapReduceReq;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): PendingMapReduceReq;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PendingMapReduceReq;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PendingMapReduceReq;
   ...
   * @see #removeField
   */
  unsetField(field: string): PendingMapReduceReq;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PendingMapReduceReq;
   ...
   * @see #unsetField
   */
  removeField(field: string): PendingMapReduceReq;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PendingMapReduceReq;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): PendingMapReduceReq;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): PendingMapReduceReq;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): PendingMapReduceReq;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): PendingMapReduceReq;

  mergeJson(json: any | null): PendingMapReduceReq;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): PendingMapReduceReq;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): PendingMapReduceReq;
   ...
   */
  singletonArray(): C3.Array<PendingMapReduceReq | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<PendingMapReduceReq | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PendingMapReduceReq | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<PendingMapReduceReq | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PendingMapReduceReq | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, PendingMapReduceReq | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PendingMapReduceReq | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PendingMapReduceReq | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PendingMapReduceReq | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): PendingMapReduceReq;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): PendingMapReduceReq;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): PendingMapReduceReq;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PendingMapReduceReq;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): PendingMapReduceReq;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PendingMapReduceReq;
   ...
   * @see #fromString
   */
  static make(s: string | null): PendingMapReduceReq | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): PendingMapReduceReq;
   ...
   */
  static cachedEmptyInst(): PendingMapReduceReq;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<PendingMapReduceReq>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): PendingMapReduceReq;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<PendingMapReduceReq | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PendingMapReduceReq | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<PendingMapReduceReq | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<PendingMapReduceReq | null> | null>;
   ...
   */
  get(include?: string | null): PendingMapReduceReq | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): PendingMapReduceReq | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PendingMapReduceReq;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): PendingMapReduceReq | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PendingMapReduceReq;
   ...
   * @see #toString
   */
  static fromString(s: string | null): PendingMapReduceReq | null;
   ...
   */
  create(spec?: UpsertSpec | null): PendingMapReduceReq | null;
   ...
   */
  static createBatch(objs: C3.Array<PendingMapReduceReq | null> | null, spec?: UpsertSpec | null): ObjList<PendingMapReduceReq | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PendingMapReduceReq | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<PendingMapReduceReq | null> | null;
   ...
   */
  update(srcObj?: PendingMapReduceReq | null, spec?: UpsertSpec | null): PendingMapReduceReq | null;
   ...
   */
  upsert(srcObj?: PendingMapReduceReq | null, spec?: UpsertSpec | null): PendingMapReduceReq | null;
   ...
   */
  merge(spec?: MergeSpec | null): PendingMapReduceReq | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): PendingMapReduceReq | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): PendingMapReduceReq | null;
   ...
   */
  static updateBatch(objs: C3.Array<PendingMapReduceReq | null> | null, srcObjs?: C3.Array<PendingMapReduceReq | null>, spec?: UpsertSpec | null): ObjList<PendingMapReduceReq | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<PendingMapReduceReq | null>>, spec?: UpsertSpec | null): ObjList<PendingMapReduceReq | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<PendingMapReduceReq | null> | null, srcObjs?: C3.Array<PendingMapReduceReq | null>, spec?: UpsertSpec | null): ObjList<PendingMapReduceReq | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<PendingMapReduceReq | null>>, spec?: UpsertSpec | null): ObjList<PendingMapReduceReq | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<PendingMapReduceReq | null> | null, spec?: TouchSpec | null): ObjList<PendingMapReduceReq | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PendingMapReduceReq | null> | null, spec?: MergeSpec | null): ObjList<PendingMapReduceReq | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PendingMapReduceReq | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<PendingMapReduceReq | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<PendingMapReduceReq | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<PendingMapReduceReq | null> | null;
   ...
   */
  static mergeAll(mergeObj: PendingMapReduceReq | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PendingMapReduceReq | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<PendingMapReduceReq | null> | null, spec?: UpsertSpec | null): ObjList<PendingMapReduceReq | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<PendingMapReduceReq | null> | null, spec?: UpsertSpec | null): ObjList<PendingMapReduceReq | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): PendingMapReduceReq | null;
   ...
   */
  static beforeCreate(objs: C3.Array<PendingMapReduceReq | null> | null): ObjList<PendingMapReduceReq | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<PendingMapReduceReq | null> | null): ObjList<PendingMapReduceReq | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<PendingMapReduceReq | null> | null): ObjList<PendingMapReduceReq | null>;
   ...
   */
  static afterCreate(objs: C3.Array<PendingMapReduceReq | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<PendingMapReduceReq | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<PendingMapReduceReq | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<PendingMapReduceReq | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<PendingMapReduceReq | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): PendingMapReduceReq | null;
   ...
   */
  withoutIdentity(): PendingMapReduceReq | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<PendingMapReduceReq | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: PendingMapReduceReq | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<PendingMapReduceReq | null> | null, callback?: λFunction<PendingMapReduceReq | null, PendingMapReduceReq | null> | null): ObjList<PendingMapReduceReq | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<PendingMapReduceReq | null> | null, callback?: λFunction<PendingMapReduceReq | null, PendingMapReduceReq | null> | null): C3.Array<ObjError | null>;
