// TypeScript definitions for the C3 type FetchSpec

/**
 * Specification of which Objs to bring back and which fields to bring back in them for a {@link Persistable#fetch} call.
 *
 * @remarks this represents a value passed to a method that expects an instance of FetchSpec
 */
declare interface IFetchSpec {
 ...
 */
declare class FetchSpec extends Obj {
  ...
  withOrder(order: string | null): FetchSpec;

  /**
   * Offset to use for paged reads.
   */
  readonly offset?: number | null;
  withOffset(offset: number | null): FetchSpec;
  ...
  withLimit(limit: number | null): FetchSpec;
  ...
  withFilter(filter: string | null): FetchSpec;

  /**
   * Variables values to substitute in filter expression. CURRENTLY UNDER CONSTRUCTION!
   */
  readonly vars?: C3.Map<string | null, Obj | null>;
  withVars(vars: C3.Map<string | null, Obj | null> | {[key: string | null]: IObj | null}): FetchSpec;
  ...
  withFetchHiddenSeedData(fetchHiddenSeedData: boolean): FetchSpec;
  ...
  withExcludeExtensions(excludeExtensions: boolean): FetchSpec;
  ...
  withAsOf(asOf: DateTime | Date | string | null): FetchSpec;
  ...
  withAllowLiteralOnBindVariableOverflow(allowLiteralOnBindVariableOverflow: boolean): FetchSpec;
  ...
  withUseDedicatedConnection(useDedicatedConnection: boolean): FetchSpec;
  ...
  withStmtTimeoutMs(stmtTimeoutMs: number | null): FetchSpec;
  ...
  withDontThrowJsonDeserErrors(dontThrowJsonDeserErrors: boolean): FetchSpec;
  ...
  withTimeRange(timeRange: ITimeRange | null): FetchSpec;
  ...
  withTimedFetchParentField(timedFetchParentField: string | null): FetchSpec;

  readonly includeBaseTypes?: boolean;
  withIncludeBaseTypes(includeBaseTypes: boolean): FetchSpec;
  ...
  withIgnoreViewInclude(ignoreViewInclude: boolean): FetchSpec;
  ...
  withInclude(include: string | null): FetchSpec;
  ...
  withExcludeMeta(excludeMeta: boolean): FetchSpec;
  ...
  withIncludeReadCalcs(includeReadCalcs: boolean): FetchSpec;
  ...
  withRefreshCalcFields(refreshCalcFields: boolean): FetchSpec;
  ...
  withCalcFieldsToRefresh(calcFieldsToRefresh: C3.Array<string | null> | Array<string | null>): FetchSpec;
  ...
  withForceAcl(forceAcl: boolean): FetchSpec;
  ...
  withExplain(explain: boolean): FetchSpec;
  ...
  withValidateOnly(validateOnly: boolean): FetchSpec;
  ...
  withHints(hints: IFetchHints | null): FetchSpec;
  ...
  withUseSecondaryDatastore(useSecondaryDatastore: boolean): FetchSpec;
  ...
  withPreserveArrayIndexes(preserveArrayIndexes: boolean): FetchSpec;
  ...
  withResolveRefTypes(resolveRefTypes: boolean): FetchSpec;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): FetchSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): FetchSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): FetchSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): FetchSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): FetchSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FetchSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): FetchSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FetchSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<FetchSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): FetchSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FetchSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): FetchSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): FetchSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): FetchSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): FetchSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): FetchSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): FetchSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): FetchSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): FetchSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): FetchSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): FetchSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): FetchSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): FetchSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): FetchSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): FetchSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): FetchSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): FetchSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): FetchSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): FetchSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): FetchSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): FetchSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): FetchSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): FetchSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): FetchSpec;

  mergeJson(json: any | null): FetchSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): FetchSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): FetchSpec;
   ...
   */
  singletonArray(): C3.Array<FetchSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<FetchSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<FetchSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<FetchSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<FetchSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, FetchSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, FetchSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<FetchSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<FetchSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): FetchSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): FetchSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): FetchSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): FetchSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): FetchSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): FetchSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): FetchSpec;
   ...
   */
  static cachedEmptyInst(): FetchSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<FetchSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): FetchSpec;
   ...
   */
  withIdFilter(id: string): FetchSpec | null;
   ...
   * @return updated FetchSpec
   */
  withIdsFilter(ids: C3.Array<string | null> | null): FetchSpec | null;
   ...
   * @return updated FetchSpec
   */
  withIdRangeFilter(startId?: string | null, endId?: string | null): FetchSpec | null;
