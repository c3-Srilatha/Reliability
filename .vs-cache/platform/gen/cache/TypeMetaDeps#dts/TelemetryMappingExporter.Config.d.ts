// TypeScript definitions for the C3 type TelemetryMappingExporter.Config

/**
 * This type provides config related to Telemetry Mapping
 *
 * @remarks this represents a value passed to a method that expects an instance of TelemetryMappingExporter.Config
 */
declare namespace TelemetryMappingExporter {
  export interface IConfig {
     ...
     */
    destPaths?: C3.Array<string | null> | Array<string | null>;
...
declare namespace TelemetryMappingExporter {
  export class Config extends Obj {
    ...
    withConfigOverride(configOverride: string | null): TelemetryMappingExporter.Config;

    static readonly configOverride?: string | null;

    readonly secretOverride?: string | null;
    withSecretOverride(secretOverride: string | null): TelemetryMappingExporter.Config;
    ...
    withIssues(issues: C3.Array<string | null> | Array<string | null>): TelemetryMappingExporter.Config;
     ...
     * Indicates the intermediate file path, where the telemetry mapping per app csv will be published,
     */
    readonly intermediatePath?: string | null;
    withIntermediatePath(intermediatePath: string | null): TelemetryMappingExporter.Config;

    /**
     * Indicates the intermediate file path, where the telemetry mapping per app csv will be published,
     */
    static readonly intermediatePath?: string | null;

    /**
     * Indicates the list of paths where the combined telemetry mapping csv will be published,
     */
    readonly destPaths?: C3.Array<string | null>;
    withDestPaths(destPaths: C3.Array<string | null> | Array<string | null>): TelemetryMappingExporter.Config;

    /**
     * Indicates the list of paths where the combined telemetry mapping csv will be published,
     */
    static readonly destPaths?: C3.Array<string | null>;

    /**
     * Flag to control the enablement of the telemetry label mapping export feature.
     */
    readonly enabled?: boolean;
    withEnabled(enabled: boolean): TelemetryMappingExporter.Config;
     ...
     * Final file structure will be {link @TelemetryMappingExporter.Config#baseDirPath}_<Time stamp>
     */
    readonly clusterMappingExportPrefix?: string | null;
    withClusterMappingExportPrefix(clusterMappingExportPrefix: string | null): TelemetryMappingExporter.Config;

    /**
     * Indicates the file name to which the combined csv data is published.
     * Final file structure will be {link @TelemetryMappingExporter.Config#baseDirPath}_<Time stamp>
     */
    static readonly clusterMappingExportPrefix?: string | null;

    /**
     * Indicates the most recent date suffixed file name to which the combined csv data is published.
     * Final file structure will be {link @TelemetryMappingExporter.Config#baseDirPath}_<Time stamp>
     */
    readonly latestPublishedClusterMappingFileName?: string | null;
    withLatestPublishedClusterMappingFileName(latestPublishedClusterMappingFileName: string | null): TelemetryMappingExporter.Config;

    /**
     * Indicates the most recent date suffixed file name to which the combined csv data is published.
     * Final file structure will be {link @TelemetryMappingExporter.Config#baseDirPath}_<Time stamp>
     */
    static readonly latestPublishedClusterMappingFileName?: string | null;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): TelemetryMappingExporter.Config | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): TelemetryMappingExporter.Config | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): TelemetryMappingExporter.Config | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): TelemetryMappingExporter.Config | null;
     ...
     */
    replaceType(old: Type, new_: Type): TelemetryMappingExporter.Config;
     ...
     * This method is used during live metadata update
     */
    static replaceType(old: Type, new_: Type): TelemetryMappingExporter.Config;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TelemetryMappingExporter.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TelemetryMappingExporter.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TelemetryMappingExporter.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): TelemetryMappingExporter.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TelemetryMappingExporter.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TelemetryMappingExporter.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TelemetryMappingExporter.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<TelemetryMappingExporter.Config | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TelemetryMappingExporter.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): TelemetryMappingExporter.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TelemetryMappingExporter.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TelemetryMappingExporter.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TelemetryMappingExporter.Config;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    static mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): TelemetryMappingExporter.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): TelemetryMappingExporter.Config;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    static validateObj(): TelemetryMappingExporter.Config;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): TelemetryMappingExporter.Config;
     ...
     * @see #defaultField
     */
    static withField(field: string, value: any, doNotConvert?: boolean): TelemetryMappingExporter.Config;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): TelemetryMappingExporter.Config;
     ...
     * @see #defaultField
     */
    static withField(field: FieldType, value: any, doNotConvert?: boolean): TelemetryMappingExporter.Config;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TelemetryMappingExporter.Config;
     ...
     * @return new Obj
     */
    static withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): TelemetryMappingExporter.Config;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TelemetryMappingExporter.Config;
     ...
     * @return new Obj
     */
    static withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): TelemetryMappingExporter.Config;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): TelemetryMappingExporter.Config;
     ...
     * @see #withoutField
     */
    static withoutFieldAtPath(path: string): TelemetryMappingExporter.Config;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): TelemetryMappingExporter.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: string | null): TelemetryMappingExporter.Config;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): TelemetryMappingExporter.Config;
     ...
     * @see #removeField
     */
    static withoutField(field: FieldType | null): TelemetryMappingExporter.Config;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): TelemetryMappingExporter.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFields(fields: C3.Array<string | null> | null): TelemetryMappingExporter.Config;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TelemetryMappingExporter.Config;
     ...
     * @return new Obj with removed fields
     */
    static withoutFieldsByType(fields: C3.Array<FieldType | null> | null): TelemetryMappingExporter.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): TelemetryMappingExporter.Config;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    static withoutSecretFields(): TelemetryMappingExporter.Config;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TelemetryMappingExporter.Config;
     ...
     * @see FieldType#defaultValue
     */
    static withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): TelemetryMappingExporter.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: string): TelemetryMappingExporter.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: string): TelemetryMappingExporter.Config;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): TelemetryMappingExporter.Config;
     ...
     * @see #unsetField
     */
    static defaultField(field: FieldType): TelemetryMappingExporter.Config;
     ...
     * @see #removeField
     */
    unsetField(field: string): TelemetryMappingExporter.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: string): TelemetryMappingExporter.Config;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): TelemetryMappingExporter.Config;
     ...
     * @see #removeField
     */
    static unsetField(field: FieldType): TelemetryMappingExporter.Config;
     ...
     * @see #unsetField
     */
    removeField(field: string): TelemetryMappingExporter.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: string): TelemetryMappingExporter.Config;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): TelemetryMappingExporter.Config;
     ...
     * @see #unsetField
     */
    static removeField(field: FieldType): TelemetryMappingExporter.Config;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TelemetryMappingExporter.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): TelemetryMappingExporter.Config;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): TelemetryMappingExporter.Config;
     ...
     * @return the new merged Obj
     */
    static mergeObj(other: Obj | null, otherFieldsFilter: Type): TelemetryMappingExporter.Config;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TelemetryMappingExporter.Config;
     ...
     *        the same key or index.
     */
    static mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): TelemetryMappingExporter.Config;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TelemetryMappingExporter.Config;
     ...
     * traverse child reference and collection fields.
     */
    static mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): TelemetryMappingExporter.Config;

    mergeJson(json: any | null): TelemetryMappingExporter.Config;

    static mergeJson(json: any | null): TelemetryMappingExporter.Config;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TelemetryMappingExporter.Config;
     ...
     * @return Obj with child references merged
     */
    static mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): TelemetryMappingExporter.Config;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): TelemetryMappingExporter.Config;
     ...
     * references with same name and collection elements at same index or key.
     */
    static sumObj(other: Obj | null, deep?: boolean): TelemetryMappingExporter.Config;
     ...
     */
    singletonArray(): C3.Array<TelemetryMappingExporter.Config | null>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonArray(): C3.Array<TelemetryMappingExporter.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<TelemetryMappingExporter.Config | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<TelemetryMappingExporter.Config | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<TelemetryMappingExporter.Config | null>;
     ...
     * @return new array instance with this as only element.
     */
    static singletonSet(): C3.Set<TelemetryMappingExporter.Config | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<TelemetryMappingExporter.Config | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, TelemetryMappingExporter.Config | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, TelemetryMappingExporter.Config | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<TelemetryMappingExporter.Config | null>;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    static toBuilder(): ObjBuilder<TelemetryMappingExporter.Config | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<TelemetryMappingExporter.Config | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): TelemetryMappingExporter.Config;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): TelemetryMappingExporter.Config;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): TelemetryMappingExporter.Config;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): TelemetryMappingExporter.Config;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): TelemetryMappingExporter.Config;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): TelemetryMappingExporter.Config;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): TelemetryMappingExporter.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): TelemetryMappingExporter.Config;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    static afterMake(): TelemetryMappingExporter.Config;
     ...
     */
    static cachedEmptyInst(): TelemetryMappingExporter.Config;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<TelemetryMappingExporter.Config>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): TelemetryMappingExporter.Config;
     ...
     */
    static allCached(doNotProduceAll?: boolean): Stream<TelemetryMappingExporter.Config | null>;
     ...
     */
    static find(filter?: string | null, doNotProduceAll?: boolean): Stream<TelemetryMappingExporter.Config | null>;
     ...
     * @return existing instances of this type that satisfy filter from data cache.
     */
    static findBy(field: string, value: any, doNotProduceAll?: boolean): Stream<TelemetryMappingExporter.Config | null>;
     ...
     * @see getCached
     */
    static findByCacheKey(key: string): TelemetryMappingExporter.Config | null;

    /**
     * Returns cached instance by key, with secrets removed.
     */
    static forCacheKey(key: string | null): TelemetryMappingExporter.Config | null;
     ...
     * @see findByCacheKey
     */
    getCached(): TelemetryMappingExporter.Config | null;
     ...
     * @see findByCacheKey
     */
    static getCached(): TelemetryMappingExporter.Config | null;

    /**
     * @return newly produced cached instance.
     */
    refreshCache(): TelemetryMappingExporter.Config | null;

    /**
     * @return newly produced cached instance.
     */
    static refreshCache(): TelemetryMappingExporter.Config | null;
     ...
     */
    static produce(key: string): TelemetryMappingExporter.Config | null;
     ...
     */
    static produceAll(): C3.Map<string | null, TelemetryMappingExporter.Config | null>;

    /**
     * Override for sub-types to produce all values.
     */
    static doProduceAll(): C3.Map<string | null, TelemetryMappingExporter.Config | null>;
     ...
     */
    getConfig(): TelemetryMappingExporter.Config;
     ...
     * Note that typical pattern is to use Configurable#config instead of this method.
     */
    static getConfig(): TelemetryMappingExporter.Config;
     ...
     */
    getSecret(): TelemetryMappingExporter.Config;
     ...
     * Note that typical pattern is to use Configurable#configWithSecrets instead of this method.
     */
    static getSecret(): TelemetryMappingExporter.Config;
     ...
     */
    static forConfigKey(configKey: string | null): TelemetryMappingExporter.Config | null;
     ...
     */
    static listConfigs(parallel?: boolean, filter?: λPredicate<string> | null): Stream<TelemetryMappingExporter.Config | null>;
     ...
     * @see setConfigValue
     */
    setConfigValues(from: TelemetryMappingExporter.Config, override?: string | null): void;

    /**
     * Sets multiple field values to be the same as the passed instance.
     * @see setConfigValue
     */
    static setConfigValues(from: TelemetryMappingExporter.Config, override?: string | null): void;
     ...
     * @see setSecretValue
     */
    setSecretValues(from: TelemetryMappingExporter.Config, override?: string | null): void;

    /**
     * Sets multiple secret field values to be the same as the passed instance.
     * @see setSecretValue
     */
    static setSecretValues(from: TelemetryMappingExporter.Config, override?: string | null): void;
     ...
     */
    static loadConfigAndSecret(configKey: string): TelemetryMappingExporter.Config | null;
     ...
     */
    removeSecrets(): TelemetryMappingExporter.Config | null;

    /**
     * @return this config without any secret values.
     */
    static removeSecrets(): TelemetryMappingExporter.Config | null;

    /**
     * @return this config with only secret values.
     */
    removeNonSecrets(): TelemetryMappingExporter.Config | null;

    /**
     * @return this config with only secret values.
     */
    static removeNonSecrets(): TelemetryMappingExporter.Config | null;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    validate(): TelemetryMappingExporter.Config;

    /**
     * Validates and alters fields in the configuration to fit specific requirements. sub-types can override to add custom
     * validation and setup.
     */
    static validate(): TelemetryMappingExporter.Config;
     ...
     */
    static inst(): TelemetryMappingExporter.Config;

    /**
     * @return the cached instance if already cached, null otherwise. Does not instantiate if missing.
     */
    static cachedInst(): TelemetryMappingExporter.Config | null;
  }
}
