// TypeScript definitions for the C3 type DataPartitionWriteSpec

/**
 * Holds properties to determine how to write objs for a given {@link DataPartition}
 *
 * @remarks this represents a value passed to a method that expects an instance of DataPartitionWriteSpec
 */
declare interface IDataPartitionWriteSpec {
  ...
  /**
   * If set, default merge strategy is applied while merging objects. In order to specify a custom merge strategy, set
   * {@link mergeLambda}
   */
  merge?: boolean;

  /**
   * If specified, uses this lambda function to merge existing objects in partition with the new objects. If not specified,
   * default merge strategy will be chosen
   */
  mergeLambda?: λBiFunction<Stream<Partitionable<any> | null>, Stream<Partitionable<any> | null>, Stream<Partitionable<any> | null> | Array<IPartitionable<any> | null>> | null;
}
 ...
 * Holds properties to determine how to write objs for a given {@link DataPartition}
 *
 * @remarks this represents a made instance of DataPartitionWriteSpec
 */
declare class DataPartitionWriteSpec extends Obj {
  ...
  withNewColReadCount(newColReadCount: number | null): DataPartitionWriteSpec;
  ...
  withNewColMaxObjCount(newColMaxObjCount: number | null): DataPartitionWriteSpec;
  ...
  withRewriteAllIncremental(rewriteAllIncremental: boolean): DataPartitionWriteSpec;
  ...
  withPriority(priority: number | null): DataPartitionWriteSpec;
  ...
  withDisabled(disabled: boolean): DataPartitionWriteSpec;
  ...
  withMaxConcurrency(maxConcurrency: number | null): DataPartitionWriteSpec;
  ...
  withMaxConcurrencyPerNode(maxConcurrencyPerNode: number | null): DataPartitionWriteSpec;
  ...
  withRunAsUser(runAsUser: boolean | null): DataPartitionWriteSpec;
  ...
  withNodePool(nodePool: string | null): DataPartitionWriteSpec;
  ...
  withSkipIfRunning(skipIfRunning: boolean | null): DataPartitionWriteSpec;

  /**
   * Set to between 1 and 5 to enable auto recovery. See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
   */
  readonly numAutoRecoveryAttempts?: number | null;
  withNumAutoRecoveryAttempts(numAutoRecoveryAttempts: number | null): DataPartitionWriteSpec;
  ...
  withPropagateActionContext(propagateActionContext: boolean): DataPartitionWriteSpec;
  ...
  withTargetType(targetType: IType | null): DataPartitionWriteSpec;
  ...
  withUseFileSystemForInterVals(useFileSystemForInterVals: boolean): DataPartitionWriteSpec;
  ...
  withUseBatchIdsForReadInput(useBatchIdsForReadInput: boolean): DataPartitionWriteSpec;
  ...
  withInclude(include: string | null): DataPartitionWriteSpec;

  /**
   * optional filter spec
   */
  readonly filter?: string | null;
  withFilter(filter: string | null): DataPartitionWriteSpec;
  ...
  withOrder(order: string | null): DataPartitionWriteSpec;
  ...
  withLimit(limit: number | null): DataPartitionWriteSpec;
  ...
  withSamplePct(samplePct: number | null): DataPartitionWriteSpec;
  ...
  withBatchSize(batchSize: number | null): DataPartitionWriteSpec;
  ...
  withSubBatchSize(subBatchSize: number | null): DataPartitionWriteSpec;
  ...
  withNumBatches(numBatches: number | null): DataPartitionWriteSpec;
  ...
  withAbortOnError(abortOnError: boolean): DataPartitionWriteSpec;

  /**
   * If set, only places the specified number of objects per hot bucket
   */
  readonly numObjsPerHotBucket?: number | null;
  withNumObjsPerHotBucket(numObjsPerHotBucket: number | null): DataPartitionWriteSpec;
  ...
  withSizeMbPerHotBucket(sizeMbPerHotBucket: number | null): DataPartitionWriteSpec;
  ...
  withNumHotBuckets(numHotBuckets: number | null): DataPartitionWriteSpec;
  ...
  withMaxHotSortKey(maxHotSortKey: string | null): DataPartitionWriteSpec;
  ...
  withColdBucketMultiplier(coldBucketMultiplier: number | null): DataPartitionWriteSpec;

  /**
   * Schedule at which compaction needs to run. {@see DataPartition#compact}. Defaults to 1st every month at 00:00
   */
  readonly compactionSchedule?: string | null;
  withCompactionSchedule(compactionSchedule: string | null): DataPartitionWriteSpec;

  /**
   * If set, no error will be thrown if packing fails and will log an error instead.
   */
  readonly doNotThrowOnFailure?: boolean;
  withDoNotThrowOnFailure(doNotThrowOnFailure: boolean): DataPartitionWriteSpec;
  ...
  withMaxRetries(maxRetries: number | null): DataPartitionWriteSpec;
  ...
  withFullCompact(fullCompact: boolean): DataPartitionWriteSpec;
  ...
  withRepair(repair: boolean): DataPartitionWriteSpec;
  ...
  withMerge(merge: boolean): DataPartitionWriteSpec;

  /**
   * If specified, uses this lambda function to merge existing objects in partition with the new objects. If not specified,
   * default merge strategy will be chosen
   */
  readonly mergeLambda?: λBiFunction<Stream<Partitionable<any> | null>, Stream<Partitionable<any> | null>, Stream<Partitionable<any> | null>> | null;
  withMergeLambda(mergeLambda: λBiFunction<Stream<Partitionable<any> | null>, Stream<Partitionable<any> | null>, Stream<Partitionable<any> | null> | Array<IPartitionable<any> | null>> | null): DataPartitionWriteSpec;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): DataPartitionWriteSpec | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): DataPartitionWriteSpec | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): DataPartitionWriteSpec | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): DataPartitionWriteSpec | null;
   ...
   */
  replaceType(old: Type, new_: Type): DataPartitionWriteSpec;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataPartitionWriteSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataPartitionWriteSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataPartitionWriteSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataPartitionWriteSpec | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataPartitionWriteSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataPartitionWriteSpec;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataPartitionWriteSpec;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): DataPartitionWriteSpec;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): DataPartitionWriteSpec;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): DataPartitionWriteSpec;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataPartitionWriteSpec;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataPartitionWriteSpec;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): DataPartitionWriteSpec;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): DataPartitionWriteSpec;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): DataPartitionWriteSpec;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): DataPartitionWriteSpec;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataPartitionWriteSpec;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): DataPartitionWriteSpec;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataPartitionWriteSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: string): DataPartitionWriteSpec;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): DataPartitionWriteSpec;
   ...
   * @see #removeField
   */
  unsetField(field: string): DataPartitionWriteSpec;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): DataPartitionWriteSpec;
   ...
   * @see #unsetField
   */
  removeField(field: string): DataPartitionWriteSpec;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): DataPartitionWriteSpec;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataPartitionWriteSpec;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): DataPartitionWriteSpec;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataPartitionWriteSpec;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataPartitionWriteSpec;

  mergeJson(json: any | null): DataPartitionWriteSpec;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataPartitionWriteSpec;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): DataPartitionWriteSpec;
   ...
   */
  singletonArray(): C3.Array<DataPartitionWriteSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<DataPartitionWriteSpec | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<DataPartitionWriteSpec | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<DataPartitionWriteSpec | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<DataPartitionWriteSpec | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, DataPartitionWriteSpec | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataPartitionWriteSpec | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<DataPartitionWriteSpec | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<DataPartitionWriteSpec | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DataPartitionWriteSpec;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DataPartitionWriteSpec;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DataPartitionWriteSpec;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): DataPartitionWriteSpec;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DataPartitionWriteSpec;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): DataPartitionWriteSpec;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DataPartitionWriteSpec;
   ...
   * Note that it introduces additional overhead so should only be implemented for low volume data.
   */
  afterMake(): DataPartitionWriteSpec;
   ...
   */
  static cachedEmptyInst(): DataPartitionWriteSpec;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DataPartitionWriteSpec>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): DataPartitionWriteSpec;
}
