// TypeScript definitions for the C3 type VideoFile

/**
 * C3 type holding an Video persisted in a file.
 *
 * @remarks this represents a value passed to a method that expects an instance of VideoFile
 */
declare interface IVideoFile {
 ...
 * C3 type holding an Video persisted in a file.
 *
 * @remarks this represents a made instance of VideoFile
 */
declare class VideoFile extends Obj {
  ...
  withWidth(width: number | null): VideoFile;
  ...
  withHeight(height: number | null): VideoFile;
  ...
  withContentEncoding(contentEncoding: string | null): VideoFile;
  ...
  withContentLanguage(contentLanguage: string | null): VideoFile;
  ...
  withContentLength(contentLength: number | null): VideoFile;
  ...
  withContentLocation(contentLocation: string | null): VideoFile;
  ...
  withContentType(contentType: string | null): VideoFile;
  ...
  withContentDisposition(contentDisposition: string | null): VideoFile;
  ...
  withETag(eTag: string | null): VideoFile;
  ...
  withLastModified(lastModified: DateTime | Date | string | null): VideoFile;

  /**
   * Id of user / identity who last last modified this content.
   */
  readonly lastModifiedBy?: string | null;
  withLastModifiedBy(lastModifiedBy: string | null): VideoFile;
  ...
  withContentMD5(contentMD5: string | null): VideoFile;
  ...
  withContentSHA1(contentSHA1: string | null): VideoFile;

  /**
   * Field to maintain state whether content metadata was read or not.
   */
  readonly hasMetadata?: boolean;
  withHasMetadata(hasMetadata: boolean): VideoFile;

  /**
   * URL for this file that contains scheme (i.e. file-system) and fully qualified encoded path.
   */
  readonly url?: string | null;
  withUrl(url: string | null): VideoFile;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): VideoFile | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): VideoFile | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): VideoFile | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): VideoFile | null;
   ...
   */
  replaceType(old: Type, new_: Type): VideoFile;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VideoFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): VideoFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VideoFile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<VideoFile | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): VideoFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VideoFile;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): VideoFile;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): VideoFile;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): VideoFile;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): VideoFile;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): VideoFile;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): VideoFile;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): VideoFile;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): VideoFile;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): VideoFile;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): VideoFile;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): VideoFile;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): VideoFile;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): VideoFile;
   ...
   * @see #unsetField
   */
  defaultField(field: string): VideoFile;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): VideoFile;
   ...
   * @see #removeField
   */
  unsetField(field: string): VideoFile;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): VideoFile;
   ...
   * @see #unsetField
   */
  removeField(field: string): VideoFile;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): VideoFile;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): VideoFile;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): VideoFile;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): VideoFile;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): VideoFile;

  mergeJson(json: any | null): VideoFile;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): VideoFile;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): VideoFile;
   ...
   */
  singletonArray(): C3.Array<VideoFile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<VideoFile | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<VideoFile | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<VideoFile | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<VideoFile | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, VideoFile | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, VideoFile | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<VideoFile | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<VideoFile | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): VideoFile;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): VideoFile;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): VideoFile;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): VideoFile;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): VideoFile;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): VideoFile;
   ...
   * @see #fromString
   */
  static make(s: string | null): VideoFile | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): VideoFile;
   ...
   */
  static cachedEmptyInst(): VideoFile;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<VideoFile>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): VideoFile;
   ...
   */
  readMediaMetadata(): VideoFile;

  /**
   * @return instance of the Visual Media from provided content and optionally reads metadata
   */
  static fromContent(content: Content, readMetadata?: boolean): VideoFile;
   ...
   */
  static fromRawBinary(data: any, contentType?: string | null, width?: number | null, height?: number | null): VideoFile;
   ...
   */
  static fromBase64String(data: string, contentType?: string | null, width?: number | null, height?: number | null): VideoFile;
   ...
   */
  withRawBinary(data: any, contentType?: string | null, width?: number | null, height?: number | null): VideoFile;
   ...
   */
  withBase64String(data: string, contentType?: string | null, width?: number | null, height?: number | null): VideoFile;
  ...
  /**
   * convert a video to stream of frames images.
   */
  frames(spec?: VideoOperSpec | null): Stream<VideoFrame | null>;
   ...
   */
  withFileName(fileName: string | null): VideoFile;

  /**
   * Changes file extension in this instance.
   */
  withFileExt(fileExt: string | null): VideoFile;
   ...
   */
  identify(suffix?: string | null): VideoFile;
   ...
   */
  readMetadata(spec?: FileOperationSpec | null): VideoFile;
   ...
   */
  refreshMetadata(spec?: FileOperationSpec | null): VideoFile;
   ...
   */
  encodedPushStream(spec?: FileOperationSpec | null): Pair<VideoFile | null, BytePushStream | null>;

  /**
   * @return byte push stream to be used for writing un-encoded data into this content object.
   */
  pushStream(spec?: FileOperationSpec | null): Pair<VideoFile | null, BytePushStream | null>;

  /**
   * @return character push stream to be used for writing un-encoded data into this content object.
   */
  charPushStream(spec?: FileOperationSpec | null): Pair<VideoFile | null, CharPushStream | null>;
   ...
   */
  encodedStream(spec?: FileOperationSpec | null): Pair<VideoFile | null, ByteStream | null> | null;
   ...
   */
  writeStream(content: ByteStream | null, spec?: FileOperationSpec | null): VideoFile;

  /**
   * Truncates file and replaces it's content with provided binary content.
   */
  writeInputStream(inputStream: any, spec?: FileOperationSpec | null): VideoFile;

  /**
   * Truncates file and replaces its content with provided binary content from zipInputStream
   */
  writeZipInputStream(zipInputStream: any, spec?: FileOperationSpec | null): VideoFile;
   ...
   */
  writeEncodedStream(encodedContent: ByteStream | null, spec?: FileOperationSpec | null): VideoFile;

  /**
   * Truncates file and replaces it's encoded content with provided binary content.
   */
  writeEncodedInputStream(inputStream: any, spec?: FileOperationSpec | null): VideoFile;
   ...
   *           content that needs to be written
   */
  write(content: any | null, spec?: FileOperationSpec | null): VideoFile;
   ...
   *           encoded content that needs to be written
   */
  writeEncoded(encodedContent: any | null, spec?: FileOperationSpec | null): VideoFile;
   ...
   *           content that needs to be written
   */
  writeString(content: string | null, spec?: FileOperationSpec | null): VideoFile;
   ...
   */
  writeObj(obj: Obj | null, spec?: FileObjsOperSpec | null): VideoFile;
   ...
   * @return pair of update instance of this content and number of objs written
   */
  startWriteObjs(spec?: FileObjsOperSpec | null): Pair<VideoFile | null, PushStream<Obj | null> | null>;
   ...
   */
  compress(contentEncoding?: string | null, spec?: FileCompressSpec | null): VideoFile;

  /**
   * Uncompresses file. Removes compression specific extension.
   */
  uncompress(spec?: FileCompressSpec | null): VideoFile;
   ...
   */
  transcode(contentType: string, contentEncoding: string, spec?: FileCompressSpec | null): VideoFile;

  /**
   * Copies content to a given target.
   */
  copyContentTo(target: VideoFile, spec?: FileOperationSpec | null): void;
   ...
   */
  static fromString(s: string | null): VideoFile | null;
