// TypeScript definitions for the C3 type Data.Series.Rolling.Lazy

/**
 * @remarks this represents a value passed to a method that expects an instance of Data.Series.Rolling.Lazy
 */
declare namespace Data.Series.Rolling {
...
declare namespace Data.Series.Rolling {
  export class Lazy extends Obj {
    ...
    withSTATELESS_CACHE(STATELESS_CACHE: string | null): Data.Series.Rolling.Lazy;
     ...
     */
    readonly this: any;
    withThis(this_: any): Data.Series.Rolling.Lazy;

    /**
     * Target action returning DataImpl
     */
    readonly action: string;
    withAction(action: string): Data.Series.Rolling.Lazy;

    /**
     * Applied arguments
     */
    readonly args?: C3.Map<string | null, any>;
    withArgs(args: C3.Map<string | null, any> | {[key: string | null]: any}): Data.Series.Rolling.Lazy;
    ...
    with_inferredOutType(_inferredOutType: C3.Map<string | null, ValueType | null> | {[key: string | null]: IValueType | null}): Data.Series.Rolling.Lazy;

    get win_type(): any;

    aggregate(func?: any): Data.Series | null;

    corr(other?: any, pairwise?: boolean | null, ddof?: number | null): Data.Series | null;

    count(): Data.Series | null;

    cov(other?: any, pairwise?: boolean | null, ddof?: number | null): Data.Series | null;

    kurt(): Data.Series | null;

    max(engine?: string | null, engine_kwargs?: C3.Map<string | null, boolean> | null): Data.Series | null;

    mean(engine?: string | null, engine_kwargs?: C3.Map<string | null, boolean> | null): Data.Series | null;

    median(engine?: string | null, engine_kwargs?: C3.Map<string | null, boolean> | null): Data.Series | null;

    min(engine?: string | null, engine_kwargs?: C3.Map<string | null, boolean> | null): Data.Series | null;

    quantile(quantile?: number | null, interpolation?: string | null): Data.Series | null;

    sem(ddof?: number | null): Data.Series | null;

    skew(): Data.Series | null;

    std(ddof?: number | null): Data.Series | null;

    sum(engine?: string | null, engine_kwargs?: C3.Map<string | null, boolean> | null): Data.Series | null;

    var(ddof?: number | null): Data.Series | null;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.Series.Rolling.Lazy | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.Series.Rolling.Lazy | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.Series.Rolling.Lazy | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.Series.Rolling.Lazy | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.Series.Rolling.Lazy;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Series.Rolling.Lazy;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Series.Rolling.Lazy;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Series.Rolling.Lazy | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Series.Rolling.Lazy | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.Series.Rolling.Lazy;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Series.Rolling.Lazy;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Series.Rolling.Lazy;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.Series.Rolling.Lazy;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.Series.Rolling.Lazy;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.Series.Rolling.Lazy;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.Series.Rolling.Lazy;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.Series.Rolling.Lazy;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.Series.Rolling.Lazy;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.Series.Rolling.Lazy;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.Series.Rolling.Lazy;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.Series.Rolling.Lazy;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.Series.Rolling.Lazy;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.Series.Rolling.Lazy;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.Series.Rolling.Lazy;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.Series.Rolling.Lazy;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.Series.Rolling.Lazy;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.Series.Rolling.Lazy;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.Series.Rolling.Lazy;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.Series.Rolling.Lazy;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.Series.Rolling.Lazy;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.Series.Rolling.Lazy;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.Series.Rolling.Lazy;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.Series.Rolling.Lazy;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.Series.Rolling.Lazy;

    mergeJson(json: any | null): Data.Series.Rolling.Lazy;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.Series.Rolling.Lazy;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.Series.Rolling.Lazy;
     ...
     */
    singletonArray(): C3.Array<Data.Series.Rolling.Lazy | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.Series.Rolling.Lazy | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.Series.Rolling.Lazy | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.Series.Rolling.Lazy | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.Series.Rolling.Lazy | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.Series.Rolling.Lazy | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.Series.Rolling.Lazy | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.Series.Rolling.Lazy | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.Series.Rolling.Lazy | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.Series.Rolling.Lazy;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.Series.Rolling.Lazy;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.Series.Rolling.Lazy;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.Series.Rolling.Lazy;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.Series.Rolling.Lazy;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.Series.Rolling.Lazy;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.Series.Rolling.Lazy;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Data.Series.Rolling.Lazy;
     ...
     */
    static cachedEmptyInst(): Data.Series.Rolling.Lazy;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.Series.Rolling.Lazy>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.Series.Rolling.Lazy;
     ...
     */
    static fromPySrc(pySrc: string, dfs?: C3.Set<DataImpl | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): Data.Series.Rolling.Lazy | null;
     ...
     */
    static _jsDataProxy(inst: any): Data.Series.Rolling.Lazy;
     ...
     */
    static create(this_: any, action: string, args?: C3.Map<string | null, any>): Data.Series.Rolling.Lazy;
