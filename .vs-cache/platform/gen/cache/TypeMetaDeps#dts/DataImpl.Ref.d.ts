// TypeScript definitions for the C3 type DataImpl.Ref
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of DataImpl.Ref
 */
...
declare namespace DataImpl {
  export class Ref extends Obj {
     ...
     */
    ds: Dataset;
    withDs(ds: IDataset): DataImpl.Ref;

    /**
     * Id used to reference this Data within the Dataset to which it belongs
     */
    id: string;
    withId(id: string): DataImpl.Ref;
    ...
    withRef(ref: string | null | IDataImpl.Lazy | null | null): DataImpl.Ref;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): DataImpl.Ref | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): DataImpl.Ref | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): DataImpl.Ref | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): DataImpl.Ref | null;
     ...
     */
    replaceType(old: Type, new_: Type): DataImpl.Ref;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataImpl.Ref;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): DataImpl.Ref;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataImpl.Ref | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<DataImpl.Ref | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): DataImpl.Ref;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataImpl.Ref;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): DataImpl.Ref;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): DataImpl.Ref;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): DataImpl.Ref;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): DataImpl.Ref;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): DataImpl.Ref;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): DataImpl.Ref;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): DataImpl.Ref;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): DataImpl.Ref;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): DataImpl.Ref;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): DataImpl.Ref;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): DataImpl.Ref;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): DataImpl.Ref;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): DataImpl.Ref;
     ...
     * @see #unsetField
     */
    defaultField(field: string): DataImpl.Ref;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): DataImpl.Ref;
     ...
     * @see #removeField
     */
    unsetField(field: string): DataImpl.Ref;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): DataImpl.Ref;
     ...
     * @see #unsetField
     */
    removeField(field: string): DataImpl.Ref;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): DataImpl.Ref;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): DataImpl.Ref;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): DataImpl.Ref;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): DataImpl.Ref;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): DataImpl.Ref;

    mergeJson(json: any | null): DataImpl.Ref;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): DataImpl.Ref;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): DataImpl.Ref;
     ...
     */
    singletonArray(): C3.Array<DataImpl.Ref | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<DataImpl.Ref | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<DataImpl.Ref | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<DataImpl.Ref | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<DataImpl.Ref | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, DataImpl.Ref | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, DataImpl.Ref | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<DataImpl.Ref | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<DataImpl.Ref | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): DataImpl.Ref;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): DataImpl.Ref;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): DataImpl.Ref;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): DataImpl.Ref;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): DataImpl.Ref;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): DataImpl.Ref;

    /**
     * Construct an instance with initial state.
     */
    static make(): DataImpl.Ref;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): DataImpl.Ref;
     ...
     */
    static cachedEmptyInst(): DataImpl.Ref;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<DataImpl.Ref>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): DataImpl.Ref;
     ...
     */
    static fromPySrc(pySrc: string, dfs?: C3.Set<DataImpl | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): DataImpl.Ref | null;
     ...
     */
    static _jsDataProxy(inst: any): DataImpl.Ref;
     ...
     * @return this Obj
     */
    setField(field: string, value: any, doNotConvert?: boolean): DataImpl.Ref;
     ...
     * @return this Obj
     */
    setField(field: FieldType, value: any, doNotConvert?: boolean): DataImpl.Ref;
