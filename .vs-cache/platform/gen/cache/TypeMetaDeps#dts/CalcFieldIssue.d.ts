// TypeScript definitions for the C3 type CalcFieldIssue

/**
 * Calc fields specific data issue type.
 *
 * @remarks this represents a value passed to a method that expects an instance of CalcFieldIssue
 */
declare interface ICalcFieldIssue {
 ...
 * Calc fields specific data issue type.
 *
 * @remarks this represents a made instance of CalcFieldIssue
 */
declare class CalcFieldIssue extends Obj {

  /**
   * Target type of the obj with the issue.
   */
  readonly targetType: string;
  withTargetType(targetType: string): CalcFieldIssue;

  /**
   * Id of obj with the issue.  If null, the issue applies to all objs for the `targetType`
   */
  readonly targetId?: string | null;
  withTargetId(targetId: string | null): CalcFieldIssue;

  /**
   * Field with the issue.  If null, the issue applies to all fields in the `targetType` (where applicable).
   */
  readonly targetField?: string | null;
  withTargetField(targetField: string | null): CalcFieldIssue;

  /**
   * DataIssue severity.
   */
  readonly severity: string;
  withSeverity(severity: string): CalcFieldIssue;
  ...
  withTypeIdent(typeIdent: string | null): CalcFieldIssue;
   ...
   */
  readonly id: string;
  withId(id: string): CalcFieldIssue;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): CalcFieldIssue;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): CalcFieldIssue;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): CalcFieldIssue;
  ...
  withVersion(version: number | null): CalcFieldIssue;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): CalcFieldIssue;

  /**
   * Error message indicating the nature of the issue.
   */
  readonly errorMsg?: string | null;
  withErrorMsg(errorMsg: string | null): CalcFieldIssue;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): CalcFieldIssue | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): CalcFieldIssue | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): CalcFieldIssue | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): CalcFieldIssue | null;
   ...
   */
  replaceType(old: Type, new_: Type): CalcFieldIssue;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): CalcFieldIssue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): CalcFieldIssue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<CalcFieldIssue | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<CalcFieldIssue | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): CalcFieldIssue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CalcFieldIssue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): CalcFieldIssue;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): CalcFieldIssue;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): CalcFieldIssue;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): CalcFieldIssue;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): CalcFieldIssue;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): CalcFieldIssue;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): CalcFieldIssue;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): CalcFieldIssue;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): CalcFieldIssue;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): CalcFieldIssue;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): CalcFieldIssue;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): CalcFieldIssue;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): CalcFieldIssue;
   ...
   * @see #unsetField
   */
  defaultField(field: string): CalcFieldIssue;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): CalcFieldIssue;
   ...
   * @see #removeField
   */
  unsetField(field: string): CalcFieldIssue;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): CalcFieldIssue;
   ...
   * @see #unsetField
   */
  removeField(field: string): CalcFieldIssue;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): CalcFieldIssue;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): CalcFieldIssue;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): CalcFieldIssue;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): CalcFieldIssue;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): CalcFieldIssue;

  mergeJson(json: any | null): CalcFieldIssue;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): CalcFieldIssue;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): CalcFieldIssue;
   ...
   */
  singletonArray(): C3.Array<CalcFieldIssue | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<CalcFieldIssue | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<CalcFieldIssue | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<CalcFieldIssue | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<CalcFieldIssue | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, CalcFieldIssue | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, CalcFieldIssue | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<CalcFieldIssue | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<CalcFieldIssue | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): CalcFieldIssue;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): CalcFieldIssue;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): CalcFieldIssue;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): CalcFieldIssue;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): CalcFieldIssue;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): CalcFieldIssue;
   ...
   * @see #fromString
   */
  static make(s: string | null): CalcFieldIssue | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): CalcFieldIssue;
   ...
   */
  static cachedEmptyInst(): CalcFieldIssue;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<CalcFieldIssue>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): CalcFieldIssue;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<CalcFieldIssue | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<CalcFieldIssue | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<CalcFieldIssue | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<CalcFieldIssue | null> | null>;
   ...
   */
  get(include?: string | null): CalcFieldIssue | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): CalcFieldIssue | null;
   ...
   */
  getMissing(spec: GetMissingSpec): CalcFieldIssue;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): CalcFieldIssue | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): CalcFieldIssue;
   ...
   * @see #toString
   */
  static fromString(s: string | null): CalcFieldIssue | null;
   ...
   */
  create(spec?: UpsertSpec | null): CalcFieldIssue | null;
   ...
   */
  static createBatch(objs: C3.Array<CalcFieldIssue | null> | null, spec?: UpsertSpec | null): ObjList<CalcFieldIssue | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<CalcFieldIssue | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<CalcFieldIssue | null> | null;
   ...
   */
  update(srcObj?: CalcFieldIssue | null, spec?: UpsertSpec | null): CalcFieldIssue | null;
   ...
   */
  upsert(srcObj?: CalcFieldIssue | null, spec?: UpsertSpec | null): CalcFieldIssue | null;
   ...
   */
  merge(spec?: MergeSpec | null): CalcFieldIssue | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): CalcFieldIssue | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): CalcFieldIssue | null;
   ...
   */
  static updateBatch(objs: C3.Array<CalcFieldIssue | null> | null, srcObjs?: C3.Array<CalcFieldIssue | null>, spec?: UpsertSpec | null): ObjList<CalcFieldIssue | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<CalcFieldIssue | null>>, spec?: UpsertSpec | null): ObjList<CalcFieldIssue | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<CalcFieldIssue | null> | null, srcObjs?: C3.Array<CalcFieldIssue | null>, spec?: UpsertSpec | null): ObjList<CalcFieldIssue | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<CalcFieldIssue | null>>, spec?: UpsertSpec | null): ObjList<CalcFieldIssue | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<CalcFieldIssue | null> | null, spec?: TouchSpec | null): ObjList<CalcFieldIssue | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<CalcFieldIssue | null> | null, spec?: MergeSpec | null): ObjList<CalcFieldIssue | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<CalcFieldIssue | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<CalcFieldIssue | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<CalcFieldIssue | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<CalcFieldIssue | null> | null;
   ...
   */
  static mergeAll(mergeObj: CalcFieldIssue | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: CalcFieldIssue | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<CalcFieldIssue | null> | null, spec?: UpsertSpec | null): ObjList<CalcFieldIssue | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<CalcFieldIssue | null> | null, spec?: UpsertSpec | null): ObjList<CalcFieldIssue | null> | null;
   ...
   */
  static beforeCreate(objs: C3.Array<CalcFieldIssue | null> | null): ObjList<CalcFieldIssue | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<CalcFieldIssue | null> | null): ObjList<CalcFieldIssue | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<CalcFieldIssue | null> | null): ObjList<CalcFieldIssue | null>;
   ...
   */
  static afterCreate(objs: C3.Array<CalcFieldIssue | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<CalcFieldIssue | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<CalcFieldIssue | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<CalcFieldIssue | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<CalcFieldIssue | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): CalcFieldIssue | null;
   ...
   */
  withoutIdentity(): CalcFieldIssue | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<CalcFieldIssue | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: CalcFieldIssue | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<CalcFieldIssue | null> | null, callback?: λFunction<CalcFieldIssue | null, CalcFieldIssue | null> | null): ObjList<CalcFieldIssue | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<CalcFieldIssue | null> | null, callback?: λFunction<CalcFieldIssue | null, CalcFieldIssue | null> | null): C3.Array<ObjError | null>;
