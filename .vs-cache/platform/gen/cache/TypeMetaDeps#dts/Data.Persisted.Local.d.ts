// TypeScript definitions for the C3 type Data.Persisted.Local
 ...
 *
 * @remarks this represents a value passed to a method that expects an instance of Data.Persisted.Local
 */
declare namespace Data.Persisted {
  export interface ILocal {
    ...
    DFLT_TABLE_NAME?: string | null;

    DFLT_ROW_COUNT?: number | null;

    DFLT_LOCAL_TABLE_NAME?: string | null;
  }
}
 ...
 */
declare namespace Data.Persisted {
  export class Local extends Obj {
    ...
    withSTATELESS_CACHE(STATELESS_CACHE: string | null): Data.Persisted.Local;
     ...
     */
    readonly this: any;
    withThis(this_: any): Data.Persisted.Local;

    /**
     * Target action returning DataImpl
     */
    readonly action: string;
    withAction(action: string): Data.Persisted.Local;

    /**
     * Applied arguments
     */
    readonly args?: C3.Map<string | null, any>;
    withArgs(args: C3.Map<string | null, any> | {[key: string | null]: any}): Data.Persisted.Local;
    ...
    with_inferredOutType(_inferredOutType: C3.Map<string | null, ValueType | null> | {[key: string | null]: IValueType | null}): Data.Persisted.Local;
    ...
    withLOCAL_FOLDER_PREFIX(LOCAL_FOLDER_PREFIX: string | null): Data.Persisted.Local;

    readonly DFLT_TABLE_NAME?: string | null;
    withDFLT_TABLE_NAME(DFLT_TABLE_NAME: string | null): Data.Persisted.Local;

    readonly DFLT_ROW_COUNT?: number | null;
    withDFLT_ROW_COUNT(DFLT_ROW_COUNT: number | null): Data.Persisted.Local;

    readonly DFLT_LOCAL_TABLE_NAME?: string | null;
    withDFLT_LOCAL_TABLE_NAME(DFLT_LOCAL_TABLE_NAME: string | null): Data.Persisted.Local;
     ...
     * @see #toJson
     */
    static fromJson(json: any | null): Data.Persisted.Local | null;
     ...
     * @see #toJsonString
     */
    static fromJsonString(json: string | null): Data.Persisted.Local | null;
     ...
     * @see #toXmlString
     */
    static fromXmlString(xml: string | null): Data.Persisted.Local | null;
     ...
     */
    static deserialize(contentStr: string | null, contentType: string): Data.Persisted.Local | null;
     ...
     */
    replaceType(old: Type, new_: Type): Data.Persisted.Local;
     ...
     */
    mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Persisted.Local;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): Data.Persisted.Local;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Persisted.Local | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<Data.Persisted.Local | null>;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): Data.Persisted.Local;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Persisted.Local;
     ...
     *           if true, attempt to convert the value to match the field's type
     */
    mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): Data.Persisted.Local;

    /**
     * Populates all missing default values and throws error if any constraint is violated.
     */
    validateObj(): Data.Persisted.Local;
     ...
     * @see #defaultField
     */
    withField(field: string, value: any, doNotConvert?: boolean): Data.Persisted.Local;
     ...
     * @see #defaultField
     */
    withField(field: FieldType, value: any, doNotConvert?: boolean): Data.Persisted.Local;
     ...
     * @return new Obj
     */
    withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): Data.Persisted.Local;
     ...
     * @return new Obj
     */
    withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): Data.Persisted.Local;
     ...
     * @see #withoutField
     */
    withoutFieldAtPath(path: string): Data.Persisted.Local;
     ...
     * @see #removeField
     */
    withoutField(field: string | null): Data.Persisted.Local;
     ...
     * @see #removeField
     */
    withoutField(field: FieldType | null): Data.Persisted.Local;
     ...
     */
    withoutFields(fields: C3.Array<string | null> | null): Data.Persisted.Local;
     ...
     * @return new Obj with removed fields
     */
    withoutFieldsByType(fields: C3.Array<FieldType | null> | null): Data.Persisted.Local;

    /**
     * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
     */
    withoutSecretFields(): Data.Persisted.Local;
     ...
     */
    withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): Data.Persisted.Local;
     ...
     * @see #unsetField
     */
    defaultField(field: string): Data.Persisted.Local;
     ...
     * @see #unsetField
     */
    defaultField(field: FieldType): Data.Persisted.Local;
     ...
     * @see #removeField
     */
    unsetField(field: string): Data.Persisted.Local;
     ...
     * @see #removeField
     */
    unsetField(field: FieldType): Data.Persisted.Local;
     ...
     * @see #unsetField
     */
    removeField(field: string): Data.Persisted.Local;
     ...
     * @see #unsetField
     */
    removeField(field: FieldType): Data.Persisted.Local;
     ...
     */
    mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): Data.Persisted.Local;
     ...
     * @return the new merged Obj
     */
    mergeObj(other: Obj | null, otherFieldsFilter: Type): Data.Persisted.Local;
     ...
     */
    mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): Data.Persisted.Local;
     ...
     */
    mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): Data.Persisted.Local;

    mergeJson(json: any | null): Data.Persisted.Local;
     ...
     */
    mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): Data.Persisted.Local;
     ...
     */
    sumObj(other: Obj | null, deep?: boolean): Data.Persisted.Local;
     ...
     */
    singletonArray(): C3.Array<Data.Persisted.Local | null>;

    /**
     * Creates an array of instances of this type.
     */
    static array(...elements: any[]): C3.Array<Data.Persisted.Local | null>;

    /**
     * Creates an array of instances of this type.
     */
    static arrayBuilder(): ArrayBuilder<Data.Persisted.Local | null> | null;
     ...
     * @return new array instance with this as only element.
     */
    singletonSet(): C3.Set<Data.Persisted.Local | null>;

    /**
     * Creates a set of instances of this type.
     */
    static setBuilder(): SetBuilder<Data.Persisted.Local | null> | null;

    /**
     * Create a map of string to elements of this type.
     */
    static mapBuilder(): MapBuilder<string | null, Data.Persisted.Local | null> | null;

    /**
     * Create a map with the given key type and elements of this type.
     */
    static mapBuilderOf(keyType: ValueType): MapBuilder<any, Data.Persisted.Local | null> | null;

    /**
     * @return new ObjBuilder with initial state set to fields of this instance.
     */
    toBuilder(): ObjBuilder<Data.Persisted.Local | null>;

    /**
     * @return new ObjBuilder of this instance.
     */
    static builder(): ObjBuilder<Data.Persisted.Local | null>;

    /**
     * Construct instance of this type from provided field values and options
     */
    static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): Data.Persisted.Local;
     ...
     * @see withDefaults
     */
    static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): Data.Persisted.Local;

    /**
     * Construct instance of this type from provided field values and options
     */
    static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): Data.Persisted.Local;
     ...
     * @see withDefaults
     */
    static make(withDefaults?: boolean): Data.Persisted.Local;
     ...
     * @see withDefaults
     */
    static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): Data.Persisted.Local;
     ...
     * @see withDefaults
     */
    static make(fields: any, withDefaults?: boolean): Data.Persisted.Local;

    /**
     * Construct an instance of this type from provided instance of a subtype or a "duck type".
     */
    static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): Data.Persisted.Local;
     ...
     * Note that it introduces additional overhead so should only be implemented for low volume data.
     */
    afterMake(): Data.Persisted.Local;
     ...
     */
    static cachedEmptyInst(): Data.Persisted.Local;

    /**
     * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
     * value is read.
     */
    static generateObjs(spec?: Obj.GenerateSpec | null): Stream<Data.Persisted.Local>;
     ...
     */
    static generateObj(spec?: Obj.GenerateSpec | null): Data.Persisted.Local;
     ...
     */
    static fromPySrc(pySrc: string, dfs?: C3.Set<DataImpl | null>, vars?: C3.Map<string | null, any>, dataset?: Dataset | null): Data.Persisted.Local | null;
     ...
     */
    static _jsDataProxy(inst: any): Data.Persisted.Local;
     ...
     */
    static create(this_: any, action: string, args?: C3.Map<string | null, any>): Data.Persisted.Local;
     ...
     * @return an instance of Data from the provided collection of {@link Obj}s or {@link Tuple}s
     */
    static fromCollection(col: Collection<Obj | null> | null | Collection<Tuple | null> | null, dataset?: Dataset | null, include?: string | null): Data.Persisted.Local | null;
     ...
     * 1       b 2000-01-02    2.0
     */
    static fromTuple(tuple: Tuple, dataset?: Dataset | null): Data.Persisted.Local | null;
     ...
     */
    static pushStream(spec?: Data.PushStreamSpec | null): Data.PushStream;

    /**
     * Holds Metadata on this {@link Data.Persisted}
     */
    get metadata(): Data.Persisted.Metadata;

    /**
     * Sets default values for a {@link Data.Persisted.PushStreamSpec} based on the given spec.
     */
    static setDefaultsForPushStreamSpec(spec: Data.PushStreamSpec): Data.Persisted.PushStreamSpec;

    /**
     * Returns the filename for the given index and extension.
     */
    static filenameForIdx(idx: string, ext: string): string;
     ...
     */
    static combinePersisted(data: C3.Array<Data.Persisted | null>, tableName?: string | null, id?: string | null, copy?: boolean): Data.Persisted | null;

    static _setDefaultsForStreamSpec(spec?: Data.StreamSpec | null): Data.Persisted.StreamSpec | null;
     ...
     */
    static numFilesForBaseDir(baseDir: string): number;
     ...
     */
    upsertToDb(serType: Type, batchSize?: number | null, pyRuntime?: string | null, spec?: UpsertSpec | null): void;
