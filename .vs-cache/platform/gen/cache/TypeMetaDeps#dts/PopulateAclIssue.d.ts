// TypeScript definitions for the C3 type PopulateAclIssue

/**
 * PopulateAcl specific data issue type.
 *
 * @remarks this represents a value passed to a method that expects an instance of PopulateAclIssue
 */
declare interface IPopulateAclIssue {
 ...
 * PopulateAcl specific data issue type.
 *
 * @remarks this represents a made instance of PopulateAclIssue
 */
declare class PopulateAclIssue extends Obj {

  /**
   * Target type of the obj with the issue.
   */
  readonly targetType: string;
  withTargetType(targetType: string): PopulateAclIssue;

  /**
   * Id of obj with the issue.  If null, the issue applies to all objs for the `targetType`
   */
  readonly targetId?: string | null;
  withTargetId(targetId: string | null): PopulateAclIssue;

  /**
   * Field with the issue.  If null, the issue applies to all fields in the `targetType` (where applicable).
   */
  readonly targetField?: string | null;
  withTargetField(targetField: string | null): PopulateAclIssue;

  /**
   * DataIssue severity.
   */
  readonly severity: string;
  withSeverity(severity: string): PopulateAclIssue;
  ...
  withTypeIdent(typeIdent: string | null): PopulateAclIssue;
   ...
   */
  readonly id: string;
  withId(id: string): PopulateAclIssue;
  ...
  withVersionEdits(versionEdits: C3.Array<VersionEdit | null> | Array<IVersionEdit | null>): PopulateAclIssue;

  /**
   * Name of the Obj instance
   */
  readonly name?: string | null;
  withName(name: string | null): PopulateAclIssue;

  /**
   * Various system fields.
   */
  readonly meta?: Meta | null;
  withMeta(meta: IMeta | null): PopulateAclIssue;
  ...
  withVersion(version: number | null): PopulateAclIssue;

  /**
   * Persists concrete type with bindings for generic types where instance has parameter bindings
   */
  readonly typeWithBindings?: Type | null;
  withTypeWithBindings(typeWithBindings: IType | null): PopulateAclIssue;

  /**
   * Error message indicating the nature of the issue.
   */
  readonly errorMsg?: string | null;
  withErrorMsg(errorMsg: string | null): PopulateAclIssue;
   ...
   * @see #toJson
   */
  static fromJson(json: any | null): PopulateAclIssue | null;
   ...
   * @see #toJsonString
   */
  static fromJsonString(json: string | null): PopulateAclIssue | null;
   ...
   * @see #toXmlString
   */
  static fromXmlString(xml: string | null): PopulateAclIssue | null;
   ...
   */
  static deserialize(contentStr: string | null, contentType: string): PopulateAclIssue | null;
   ...
   */
  replaceType(old: Type, new_: Type): PopulateAclIssue;
   ...
   */
  mapFieldValues(mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PopulateAclIssue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValues(spec: ValueSpec, mapper: λBiFunction<FieldType, any, any>, convertValue?: boolean): PopulateAclIssue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(mapper: λBiFunction<FieldType, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PopulateAclIssue | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValuesAsync(spec: ValueSpec, mapper: λBiFunction<FieldType | null, any, C3.Promise<any> | null>, convertValue?: boolean): C3.Promise<PopulateAclIssue | null>;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapFieldValue(field?: FieldType | null, includeEmpty?: boolean, mapper: λFunction<any, any>, convertValue?: boolean): PopulateAclIssue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PopulateAclIssue;
   ...
   *           if true, attempt to convert the value to match the field's type
   */
  mapRefs(includeEmpty: boolean, mapper: λBiFunction<FieldType, Obj, Obj | null>, convertValue?: boolean): PopulateAclIssue;

  /**
   * Populates all missing default values and throws error if any constraint is violated.
   */
  validateObj(): PopulateAclIssue;
   ...
   * @see #defaultField
   */
  withField(field: string, value: any, doNotConvert?: boolean): PopulateAclIssue;
   ...
   * @see #defaultField
   */
  withField(field: FieldType, value: any, doNotConvert?: boolean): PopulateAclIssue;
   ...
   * @return new Obj
   */
  withFields(fields: C3.Map<string | null, any> | null, doNotConvert?: boolean): PopulateAclIssue;
   ...
   * @return new Obj
   */
  withFieldAtPath(path: string, value: any, doNotConvert?: boolean, doNotCreateIfMissing?: boolean): PopulateAclIssue;
   ...
   * @see #withoutField
   */
  withoutFieldAtPath(path: string): PopulateAclIssue;
   ...
   * @see #removeField
   */
  withoutField(field: string | null): PopulateAclIssue;
   ...
   * @see #removeField
   */
  withoutField(field: FieldType | null): PopulateAclIssue;
   ...
   */
  withoutFields(fields: C3.Array<string | null> | null): PopulateAclIssue;
   ...
   * @return new Obj with removed fields
   */
  withoutFieldsByType(fields: C3.Array<FieldType | null> | null): PopulateAclIssue;

  /**
   * @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
   */
  withoutSecretFields(): PopulateAclIssue;
   ...
   */
  withDefaults(includeEmptyRefsWithDefaults?: boolean, defaultFields?: C3.Array<string | null>): PopulateAclIssue;
   ...
   * @see #unsetField
   */
  defaultField(field: string): PopulateAclIssue;
   ...
   * @see #unsetField
   */
  defaultField(field: FieldType): PopulateAclIssue;
   ...
   * @see #removeField
   */
  unsetField(field: string): PopulateAclIssue;
   ...
   * @see #removeField
   */
  unsetField(field: FieldType): PopulateAclIssue;
   ...
   * @see #unsetField
   */
  removeField(field: string): PopulateAclIssue;
   ...
   * @see #unsetField
   */
  removeField(field: FieldType): PopulateAclIssue;
   ...
   */
  mergeObj(other: Obj | null, fieldPathMergeSpec?: C3.Map<string | null, string | null>): PopulateAclIssue;
   ...
   * @return the new merged Obj
   */
  mergeObj(other: Obj | null, otherFieldsFilter: Type): PopulateAclIssue;
   ...
   */
  mergeObj(other: Obj | null, deep?: boolean, merger: λQuadFunction<FieldPath | null, any, FieldPath | null, any, any>): PopulateAclIssue;
   ...
   */
  mergeObj(other: Obj | null, merger: λQuadFunction<FieldType | null, any, FieldType | null, any, any>): PopulateAclIssue;

  mergeJson(json: any | null): PopulateAclIssue;
   ...
   */
  mergeChildren(deep?: boolean, objKey?: λFunction<Obj | null, any> | null, filter?: λPredicate<string> | null): PopulateAclIssue;
   ...
   */
  sumObj(other: Obj | null, deep?: boolean): PopulateAclIssue;
   ...
   */
  singletonArray(): C3.Array<PopulateAclIssue | null>;

  /**
   * Creates an array of instances of this type.
   */
  static array(...elements: any[]): C3.Array<PopulateAclIssue | null>;

  /**
   * Creates an array of instances of this type.
   */
  static arrayBuilder(): ArrayBuilder<PopulateAclIssue | null> | null;
   ...
   * @return new array instance with this as only element.
   */
  singletonSet(): C3.Set<PopulateAclIssue | null>;

  /**
   * Creates a set of instances of this type.
   */
  static setBuilder(): SetBuilder<PopulateAclIssue | null> | null;

  /**
   * Create a map of string to elements of this type.
   */
  static mapBuilder(): MapBuilder<string | null, PopulateAclIssue | null> | null;

  /**
   * Create a map with the given key type and elements of this type.
   */
  static mapBuilderOf(keyType: ValueType): MapBuilder<any, PopulateAclIssue | null> | null;

  /**
   * @return new ObjBuilder with initial state set to fields of this instance.
   */
  toBuilder(): ObjBuilder<PopulateAclIssue | null>;

  /**
   * @return new ObjBuilder of this instance.
   */
  static builder(): ObjBuilder<PopulateAclIssue | null>;

  /**
   * Construct instance of this type from provided field values and options
   */
  static fromFields(fields: C3.Map<FieldType | null, any> | null, spec: Obj.MakeSpec | null): PopulateAclIssue;
   ...
   * @see withDefaults
   */
  static fromFields(fields: C3.Map<FieldType | null, any | any | null> | null, withDefaults?: boolean): PopulateAclIssue;

  /**
   * Construct instance of this type from provided field values and options
   */
  static make(fields: C3.Map<string | null, any> | null, spec: Obj.MakeSpec | null): PopulateAclIssue;
   ...
   * @see withDefaults
   */
  static make(withDefaults?: boolean): PopulateAclIssue;
   ...
   * @see withDefaults
   */
  static make(fields: C3.Map<string | null, any | any | null> | null, withDefaults?: boolean): PopulateAclIssue;
   ...
   * @see withDefaults
   */
  static make(fields: any, withDefaults?: boolean): PopulateAclIssue;
   ...
   * @see #fromString
   */
  static make(s: string | null): PopulateAclIssue | null;

  /**
   * Construct an instance of this type from provided instance of a subtype or a "duck type".
   */
  static remake(other: Obj | null, failIfExtraOrInvalidFields?: boolean): PopulateAclIssue;
   ...
   */
  static cachedEmptyInst(): PopulateAclIssue;

  /**
   * Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
   * value is read.
   */
  static generateObjs(spec?: Obj.GenerateSpec | null): Stream<PopulateAclIssue>;
   ...
   */
  static generateObj(spec?: Obj.GenerateSpec | null): PopulateAclIssue;
   ...
   */
  static fetch(spec?: FetchSpec | null): FetchResult<PopulateAclIssue | null>;
   ...
   * @return Requested objs.
   */
  static fetch(filter: Filter): FetchResult<PopulateAclIssue | null>;
   ...
   */
  static fetchObjStream(spec?: FetchStreamSpec | null): Stream<PopulateAclIssue | null>;
   ...
   */
  static fetchMultiLocale(spec?: MultiLocaleFetchSpec | null): C3.Map<string | null, FetchResult<PopulateAclIssue | null> | null>;
   ...
   */
  get(include?: string | null): PopulateAclIssue | null;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getSpecific(include?: string | null): PopulateAclIssue | null;
   ...
   */
  getMissing(spec: GetMissingSpec): PopulateAclIssue;
   ...
   *         those fields will be returned. Otherwise the entire obj will be returned.
   */
  getDirect(include?: string | null): PopulateAclIssue | null;
   ...
   */
  applyReverseEdit(versionEdit: VersionEdit): PopulateAclIssue;
   ...
   * @see #toString
   */
  static fromString(s: string | null): PopulateAclIssue | null;
   ...
   */
  create(spec?: UpsertSpec | null): PopulateAclIssue | null;
   ...
   */
  static createBatch(objs: C3.Array<PopulateAclIssue | null> | null, spec?: UpsertSpec | null): ObjList<PopulateAclIssue | null> | null;
   ...
   */
  static createBatchObjStream(objs: Stream<PopulateAclIssue | null> | null, spec?: CreateBatchObjStreamSpec | null): ObjList<PopulateAclIssue | null> | null;
   ...
   */
  update(srcObj?: PopulateAclIssue | null, spec?: UpsertSpec | null): PopulateAclIssue | null;
   ...
   */
  upsert(srcObj?: PopulateAclIssue | null, spec?: UpsertSpec | null): PopulateAclIssue | null;
   ...
   */
  merge(spec?: MergeSpec | null): PopulateAclIssue | null;
   ...
   * @return The created or updated obj.
   */
  merge(mergeInclude: string, spec?: MergeSpec | null): PopulateAclIssue | null;
   ...
   * @return The created or updated obj.
   */
  touch(spec?: TouchSpec | null): PopulateAclIssue | null;
   ...
   */
  static updateBatch(objs: C3.Array<PopulateAclIssue | null> | null, srcObjs?: C3.Array<PopulateAclIssue | null>, spec?: UpsertSpec | null): ObjList<PopulateAclIssue | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static updateObjs(objs: λSupplier<C3.Array<PopulateAclIssue | null>>, spec?: UpsertSpec | null): ObjList<PopulateAclIssue | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertBatch(objs: C3.Array<PopulateAclIssue | null> | null, srcObjs?: C3.Array<PopulateAclIssue | null>, spec?: UpsertSpec | null): ObjList<PopulateAclIssue | null> | null;
   ...
   *         fields populated. Otherwise only the id field will be populated.
   */
  static upsertObjs(objs: λSupplier<C3.Array<PopulateAclIssue | null>>, spec?: UpsertSpec | null): ObjList<PopulateAclIssue | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static touchBatch(objs: C3.Array<PopulateAclIssue | null> | null, spec?: TouchSpec | null): ObjList<PopulateAclIssue | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PopulateAclIssue | null> | null, spec?: MergeSpec | null): ObjList<PopulateAclIssue | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeBatch(objs: C3.Array<PopulateAclIssue | null> | null, mergeInclude: string, spec?: MergeSpec | null): ObjList<PopulateAclIssue | null> | null;
   ...
   * @see Mergespec#csvInclude
   */
  static mergeObjs(objs: λSupplier<C3.Array<PopulateAclIssue | null>>, mergeInclude: string, spec?: MergeSpec | null): ObjList<PopulateAclIssue | null> | null;
   ...
   */
  static mergeAll(mergeObj: PopulateAclIssue | null, spec?: MergeAllSpec | null): number | null;
   ...
   * @return The number of objs that were merged.
   */
  static mergeAll(mergeObj: PopulateAclIssue | null, mergeInclude: string, spec?: MergeAllSpec | null): number | null;
   ...
   * @see Ann.Db#archive
   */
  static removeBatch(objs: C3.Array<PopulateAclIssue | null> | null, spec?: UpsertSpec | null): ObjList<PopulateAclIssue | null> | null;
   ...
   *         populated. Otherwise only the id field will be populated.
   */
  static replace(objs: C3.Array<PopulateAclIssue | null> | null, spec?: UpsertSpec | null): ObjList<PopulateAclIssue | null> | null;
   ...
   * @see Ann.Db#archive
   */
  unremove(): PopulateAclIssue | null;
   ...
   */
  static beforeCreate(objs: C3.Array<PopulateAclIssue | null> | null): ObjList<PopulateAclIssue | null>;
   ...
   *         of objs must match the input.
   */
  static beforeUpdate(objs: C3.Array<PopulateAclIssue | null> | null): ObjList<PopulateAclIssue | null>;
   ...
   *         of objs must match the input.
   */
  static beforeRemove(objs: C3.Array<PopulateAclIssue | null> | null): ObjList<PopulateAclIssue | null>;
   ...
   */
  static afterCreate(objs: C3.Array<PopulateAclIssue | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterUpdate(objs: C3.Array<PopulateAclIssue | null> | null): C3.Array<ObjError | null>;
   ...
   * @return List of any errors that were encountered.
   */
  static afterRemove(objs: C3.Array<PopulateAclIssue | null> | null): C3.Array<ObjError | null>;
   ...
   */
  static startImportData(spec?: StartImportDataSpec | null): PushStream<PopulateAclIssue | null>;

  /**
   * @return a push stream to import instances of this type.
   */
  static startImportDataWithStats(spec?: StartImportDataSpec | null): PushStreamWithStats<PopulateAclIssue | null>;
   ...
   */
  static forId(id: string | null, failIfMissing?: boolean): PopulateAclIssue | null;
   ...
   */
  withoutIdentity(): PopulateAclIssue | null;
   ...
   */
  static typeOfBatch(objs: C3.Array<PopulateAclIssue | null> | null): C3.Array<EntityType | null>;
   ...
   */
  static dbEcho(template?: PopulateAclIssue | null, count?: number | null, sendBack?: boolean): number | null;
   ...
   */
  static callbackLogic(objs: C3.Array<PopulateAclIssue | null> | null, callback?: λFunction<PopulateAclIssue | null, PopulateAclIssue | null> | null): ObjList<PopulateAclIssue | null>;

  /**
   * Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
   * calling a transform for it.
   */
  static afterCallbackLogic(objs: C3.Array<PopulateAclIssue | null> | null, callback?: λFunction<PopulateAclIssue | null, PopulateAclIssue | null> | null): C3.Array<ObjError | null>;
