...
from c3.platform.AwsElbListener import AwsElbListener
from c3.platform.CloudComputeInstance import CloudComputeInstance
...
from c3.platform.AwsVpnSecurityGroupReport import AwsVpnSecurityGroupReport
from c3.platform.WithKey import WithKey
from c3.platform.AwsElbHealthCheck import AwsElbHealthCheck
...
# Python definitions for the C3 type AwsElb


class AwsElb(AwsLoadBalancer, AwsEc2InstancesMember):
    """
    AWS Elastic Load Balancer
    
    @remarks this represents a made instance of AwsElb
    """
    ...
    """
    Auto-generated DNS name of the ELB
    """

    scheme: Optional[str]=None
    """
    Scheme of the ELB, choose between "AwsElbScheme.INTERNET_FACING" and "AwsElbScheme.INTERNAL"
    """

    listeners: Optional[Array[AwsElbListener]]=None
    """
    The listeners for the ELB.
    """

    healthCheck: Optional[AwsElbHealthCheck]=None
    """
    Information about the health checks conducted on the ELB
    """

    idleTimeOut: Optional[int]=None
    """
    idleTimeOut specifies the maximum period of time that the load balancer keeps the connection open when no data has
    been sent over the period. By default, the idle timeout is set to 60 seconds by aws.
    """

    defaultWhitelistCidrBlocks: Optional[Array[str]]=None
    def __init__(self, id: Optional[str]=None, cluster: Optional[str]=None, env: Optional[str]=None, app: Optional[str]=None, func: Optional[str]=None, role: Optional[str]=None, seq: Optional[str]=None, subseq: Optional[str]=None, resourceId: Optional[str]=None, resourceSecondaryId: Optional[str]=None, resourceName: Optional[str]=None, resourceGroupName: Optional[str]=None, fullyConfigured: Optional[bool]=None, resourceNamespace: Optional[str]=None, external: Optional[bool]=None, credentials: Optional[AwsCredentials]=None, hasGeneratedResourceName: Optional[bool]=None, hasGeneratedResourceSecondaryId: Optional[bool]=None, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, nativeMetricByName: Optional[Map[str, str]]=None, tags: Optional[Array[CloudTag]]=None, description: Optional[str]=None, parentResource: Optional[CloudResource]=None, securityGroups: Optional[Array[AwsSecurityGroup]]=None, subnets: Optional[Array[AwsSubnet]]=None, type_: Optional[str]=None, ec2Instances: Optional[Array[AwsEc2Instance]]=None, dnsName: Optional[str]=None, scheme: Optional[str]=None, listeners: Optional[Array[AwsElbListener]]=None, healthCheck: Optional[AwsElbHealthCheck]=None, idleTimeOut: Optional[int]=None, defaultWhitelistCidrBlocks: Optional[Array[str]]=None) -> None: ...
    ...
    @overload
    @classmethod
    def fromString(cls, s: str) -> Union[AwsElb]:
    """
    ...
    @overload
    @classmethod
    def fromString(cls, s: str, failIfInvalid: bool=None) -> Union[AwsElb]:
    """
    Constructs Cloud Resource instance with reference fields and credentials based on provided Cloud Reference string.
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[AwsElb]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> AwsElb:
    """
    ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> AwsElb:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> AwsElb:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> AwsElb:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[AwsElb]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[AwsElb]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[AwsElb]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[AwsElb]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> AwsElb:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AwsElb:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AwsElb:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AwsElb]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AwsElb]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> AwsElb:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AwsElb:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AwsElb:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> AwsElb:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> AwsElb:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> AwsElb:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> AwsElb:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> AwsElb:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> AwsElb:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> AwsElb:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> AwsElb:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> AwsElb:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> AwsElb:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> AwsElb:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> AwsElb:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> AwsElb:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> AwsElb:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> AwsElb:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> AwsElb:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> AwsElb:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> AwsElb:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> AwsElb:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> AwsElb:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> AwsElb:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> AwsElb:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> AwsElb:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> AwsElb:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[AwsElb]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[AwsElb]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[AwsElb]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[AwsElb]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[AwsElb]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, AwsElb]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, AwsElb]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[AwsElb]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[AwsElb]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> AwsElb:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> AwsElb:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> AwsElb:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> AwsElb:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[AwsElb]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> AwsElb:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[AwsElb]:
    """
    Find Cloud Resource in Cloud Provider based on provided C3 canonical identifier.
    """
        ...
    @classmethod
    def fromClusterId(cls, clusterId: str, env: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AwsElb:
    """
    Construct a cloud ID from a cluster ID
    """
        ...
    @classmethod
    def fromEnvId(cls, envId: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AwsElb:
    """
    ...
    """
        ...
    @classmethod
    def fromAppId(cls, appId: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AwsElb:
    """
    ...
    """
        ...
    @classmethod
    def fromId(cls, id: str, failIfInvalid: bool=None) -> AwsElb:
    """
    ...
    """
        ...
    @classmethod
    def fromCloudId(cls, id: CloudId, failIfInvalid: bool=None) -> AwsElb:
    """
    ...
    """
        ...
    def fromConfigTemplate(self, spec: CloudResourceOperationSpec=None) -> AwsElb:
    """
    ...
    """
        ...
    def withDefaultConfig(self, spec: CloudResourceOperationSpec=None) -> AwsElb:
    """
    ...
    """
        ...
    def upsertResource(self, spec: CloudResourceOperationSpec=None) -> AwsElb:
    """
    Create or update Cloud Resource.
    """
        ...
    def upsertWithDependencies(self, spec: CloudResourceOperationSpec=None) -> AwsElb:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[AwsElb]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[AwsElb]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[AwsElb]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[AwsElb]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, AwsElb]]:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[AwsElb]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[AwsElb]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: AwsElb, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: AwsElb, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[AwsElb]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[AwsElb]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[AwsElb]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> AwsElb:
    """
    ...
    """
        ...
    def withIdentity(self, resource: CloudResource=None, spec: CloudResourceOperationSpec=None) -> AwsElb:
    """
    ...
    """
        ...
    def mergeId(self, other: CloudResource=None) -> AwsElb:
    """
    ...
    """
        ...
    @classmethod
    def forCloudId(cls, id: CloudId, failIfMissing: bool=None) -> Union[AwsElb]:
    """
    ...
    """
        ...
    @classmethod
    def forCloudFunc(cls, func: str, role: str=None, failIfMissing: bool=None) -> AwsElb:
    """
    Find Cloud Resource based on provided cloud func component and optional role.
    """
        ...
    @classmethod
    def forCloudRole(cls, role: str, failIfMissing: bool=None) -> AwsElb:
    """
    Find Cloud Resource of this type based on provided cloud role component.
    """
        ...
    @classmethod
    def forResourceId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AwsElb]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def forResourceSecondaryId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AwsElb]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forResourceName(cls, resourceName: str, failIfMissing: bool=None) -> Union[AwsElb]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def findResource(cls, reference: str, failIfMissing: bool=None) -> Union[AwsElb]:
    """
    Find Cloud Resource in the Cloud Provider by provided {@link CloudRef} string.
    """
        ...
    def getResource(self) -> Union[AwsElb]:
    """
    Find Cloud Resource in the Cloud Provider by provided #resourceId, #resourceSecondaryId, #resourceName or #tags
    (in that order).
    """
        ...
    def ensureResource(self) -> AwsElb:
    """
    Checks that the resource is persisted. If not, upserts the resource, to ensure that the resource exists.
    """
        ...
    @classmethod
    def listResourcesBySubtype(cls, spec: CloudListResourcesSpec=None) -> Map[str, CloudListResourcesResult[AwsElb]]:
    """
    ...
    """
        ...
    @classmethod
    def listResources(cls, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AwsElb]:
    """
    ...
    """
        ...
    @classmethod
    def listResourcesForTags(cls, *keyValuePairs: Array[str]) -> CloudListResourcesResult[AwsElb]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForClusterId(cls, clusterId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AwsElb]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForEnvId(cls, envId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AwsElb]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForAppId(cls, appId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AwsElb]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    def upsertDependencies(self, spec: CloudResourceOperationSpec=None) -> AwsElb:
    """
    ...
    """
        ...
    def waitForCreate(self, spec: WaitSpec=None) -> Union[AwsElb]:
    """
    ...
    """
        ...
    @classmethod
    def tagResourcesBatch(cls, resources: Array[AwsElb], tags: Array[CloudTag]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    @classmethod
    def untagResourcesBatch(cls, resources: Array[AwsElb], tagKeys: Array[str]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    def waitForOk(self, spec: WaitSpec=None) -> Union[AwsElb]:
    """
    ...
    """
        ...
    def waitForState(self, state: str='AVAILABLE', spec: WaitSpec=None) -> Union[AwsElb]:
    """
    ...
    """
        ...
    def setFullyConfigured(self, fullyConfigured: bool=None, override: str=None) -> AwsElb:
    """
    ...
    """
        ...
    def afterCreate(self, input: AwsElb=None) -> AwsElb:
    """
    ...
    """
        ...
    def withoutNonModifiableFields(self) -> AwsElb:
    """
    ...
    """
        ...
    def withResourceArn(self, resourceArn: str) -> Union[AwsElb]:
    """
    ...
    def inst(cls) -> AwsElb:
    """
    @return compute instance where this action gets executed.
    """
        ...
    def registerInstance(self, instance: CloudComputeInstance, port: int) -> None:
    """
    To register a cloud {@link CloudComputeInstance} into a load balancer.
    
    @param instance
             The {@link CloudComputeInstance} to be registered.
    @param port
             The listening port of the compute instance. If not specified
    """
        ...
    def deregisterInstance(self, instance: CloudComputeInstance, port: int) -> None:
    """
    To deregister/remove a cloud {@link CloudComputeInstance} from a load balancer.
    
    @param instance
             The {@link CloudComputeInstance} to be registered.
    @param port
             The listening port of the compute instance.
    """
        ...
    ...
    """
        ...
    def reportVpnSecurityGroups(self) -> AwsVpnSecurityGroupReport:
    """
    The security groups for the ELB.
    """
        ...
