...
# Python definitions for the C3 type SimpleMetricCache


class SimpleMetricCache(MetadataCacheOld[map[string, SimpleMetric]], Value):
    """
    ...
    @classmethod
    def get(cls, key: str) -> Union[Map[str, SimpleMetric]]:
    """
    ...
    """
        ...
    @classmethod
    def require(cls, key: str) -> Map[str, SimpleMetric]:
    """
    ...
    """
        ...
    @classmethod
    def put(cls, key: str, value: Map[str, SimpleMetric]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[Map[str, SimpleMetric]]:
    """
    ...
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, Map[str, SimpleMetric]]]:
    """
    ...
    """
        ...
    @classmethod
    def release(cls, key: str, value: Map[str, SimpleMetric]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def validate(cls, value: Map[str, SimpleMetric]) -> bool:
    """
    ...
    """
        ...
    @classmethod
    def metrics(cls) -> Union[Map[str, SimpleMetric]]:
    """
