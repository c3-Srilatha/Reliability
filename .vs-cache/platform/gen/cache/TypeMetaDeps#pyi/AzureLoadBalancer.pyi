...
from c3.platform.AzureNetworkOutboundRuleInner import AzureNetworkOutboundRuleInner
from c3.platform.WaitSpec import WaitSpec
from c3.platform.AzureBackendAddressPoolFields import AzureBackendAddressPoolFields
from c3.platform.WithKey import WithKey
from c3.platform.FieldType import FieldType
from c3.platform.AzureInboundNatRuleFields import AzureInboundNatRuleFields
...
from c3.platform.MapBuilder import MapBuilder
from c3.platform.AzureProbeFields import AzureProbeFields
from c3.platform.ArrayBuilder import ArrayBuilder
from c3.platform.Error import Error
from c3.platform.AzureLoadBalancerSku import AzureLoadBalancerSku
from c3.platform.ReferenceType import ReferenceType
from c3.platform.ArrayType import ArrayType
from c3.platform.AzureLoadBalancingRuleFields import AzureLoadBalancingRuleFields
from c3.platform.CloudTag import CloudTag
from c3.platform.ValidateObjSpec import ValidateObjSpec
from c3.platform.CloudCredentials import CloudCredentials
from c3.platform.AzureNetworkInboundNatPool import AzureNetworkInboundNatPool
from c3.platform.ValidateObjResult import ValidateObjResult
from c3.platform.CloudRef import CloudRef
from c3.platform.Promise import Promise
from c3.platform.AzureLoadBalancerFields import AzureLoadBalancerFields
...
from c3.platform.AzureFrontendIPConfigurationFields import AzureFrontendIPConfigurationFields
...
# Python definitions for the C3 type AzureLoadBalancer


class AzureLoadBalancer(AzureGenericResource, AzureLoadBalancerFields):
    """
    @remarks this represents a made instance of AzureLoadBalancer
    """
    ...
    inboundNatPools: Optional[Array[AzureNetworkInboundNatPool]]=None

    inboundNatRules: Optional[Array[AzureInboundNatRuleFields]]=None

    loadBalancingRules: Optional[Array[AzureLoadBalancingRuleFields]]=None

    resourceGuid: Optional[str]=None

    outboundRules: Optional[Array[AzureNetworkOutboundRuleInner]]=None
    ...
    probes: Optional[Array[AzureProbeFields]]=None

    etag: Optional[str]=None

    location: Optional[str]=None

    frontendIPConfigurations: Optional[Array[AzureFrontendIPConfigurationFields]]=None

    id_: Optional[str]=None

    sku: Optional[AzureLoadBalancerSku]=None

    backendAddressPools: Optional[Array[AzureBackendAddressPoolFields]]=None
    def __init__(self, id: Optional[str]=None, cluster: Optional[str]=None, env: Optional[str]=None, app: Optional[str]=None, func: Optional[str]=None, role: Optional[str]=None, seq: Optional[str]=None, subseq: Optional[str]=None, resourceId: Optional[str]=None, resourceSecondaryId: Optional[str]=None, resourceName: Optional[str]=None, resourceGroupName: Optional[str]=None, fullyConfigured: Optional[bool]=None, resourceNamespace: Optional[str]=None, external: Optional[bool]=None, credentials: Optional[AzureCredentials]=None, hasGeneratedResourceName: Optional[bool]=None, hasGeneratedResourceSecondaryId: Optional[bool]=None, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, nativeMetricByName: Optional[Map[str, str]]=None, tags: Optional[Array[CloudTag]]=None, description: Optional[str]=None, parentResource: Optional[CloudResource]=None, resourceGroup: Optional[AzureResourceGroup]=None, state: Optional[str]=None, inboundNatPools: Optional[Array[AzureNetworkInboundNatPool]]=None, inboundNatRules: Optional[Array[AzureInboundNatRuleFields]]=None, loadBalancingRules: Optional[Array[AzureLoadBalancingRuleFields]]=None, resourceGuid: Optional[str]=None, outboundRules: Optional[Array[AzureNetworkOutboundRuleInner]]=None, provisioningState: Optional[str]=None, type_: Optional[str]=None, tags_: Optional[Map[str, str]]=None, name_: Optional[str]=None, probes: Optional[Array[AzureProbeFields]]=None, etag: Optional[str]=None, location: Optional[str]=None, frontendIPConfigurations: Optional[Array[AzureFrontendIPConfigurationFields]]=None, id_: Optional[str]=None, sku: Optional[AzureLoadBalancerSku]=None, backendAddressPools: Optional[Array[AzureBackendAddressPoolFields]]=None) -> None: ...
    ...
    @overload
    @classmethod
    def fromString(cls, s: str) -> Union[AzureLoadBalancer]:
    """
    ...
    @overload
    @classmethod
    def fromString(cls, s: str, failIfInvalid: bool=None) -> Union[AzureLoadBalancer]:
    """
    Constructs Cloud Resource instance with reference fields and credentials based on provided Cloud Reference string.
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[AzureLoadBalancer]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> AzureLoadBalancer:
    """
    ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> AzureLoadBalancer:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> AzureLoadBalancer:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[AzureLoadBalancer]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[AzureLoadBalancer]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[AzureLoadBalancer]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[AzureLoadBalancer]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AzureLoadBalancer]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AzureLoadBalancer]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AzureLoadBalancer:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> AzureLoadBalancer:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> AzureLoadBalancer:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> AzureLoadBalancer:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> AzureLoadBalancer:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> AzureLoadBalancer:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> AzureLoadBalancer:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[AzureLoadBalancer]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[AzureLoadBalancer]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[AzureLoadBalancer]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[AzureLoadBalancer]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[AzureLoadBalancer]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, AzureLoadBalancer]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, AzureLoadBalancer]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[AzureLoadBalancer]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[AzureLoadBalancer]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> AzureLoadBalancer:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    def afterMake(self) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[AzureLoadBalancer]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[AzureLoadBalancer]:
    """
    Find Cloud Resource in Cloud Provider based on provided C3 canonical identifier.
    """
        ...
    @classmethod
    def fromClusterId(cls, clusterId: str, env: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AzureLoadBalancer:
    """
    Construct a cloud ID from a cluster ID
    """
        ...
    @classmethod
    def fromEnvId(cls, envId: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    @classmethod
    def fromAppId(cls, appId: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    @classmethod
    def fromId(cls, id: str, failIfInvalid: bool=None) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    @classmethod
    def fromCloudId(cls, id: CloudId, failIfInvalid: bool=None) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    def fromConfigTemplate(self, spec: CloudResourceOperationSpec=None) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    def withDefaultConfig(self, spec: CloudResourceOperationSpec=None) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    def upsertResource(self, spec: CloudResourceOperationSpec=None) -> AzureLoadBalancer:
    """
    Create or update Cloud Resource.
    """
        ...
    def upsertWithDependencies(self, spec: CloudResourceOperationSpec=None) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[AzureLoadBalancer]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[AzureLoadBalancer]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[AzureLoadBalancer]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[AzureLoadBalancer]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[AzureLoadBalancer]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, AzureLoadBalancer]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, AzureLoadBalancer]]:
    """
    ...
    """
        ...
    def getConfig(self) -> AzureLoadBalancer:
    """
    This method on any CloudResource is not supported! Use CloudResource.for* or other methods instead.
    """
        ...
    ...
    """
        ...
    def getSecret(self) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[AzureLoadBalancer]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[AzureLoadBalancer]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: AzureLoadBalancer, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: AzureLoadBalancer, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[AzureLoadBalancer]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[AzureLoadBalancer]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[AzureLoadBalancer]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    def withIdentity(self, resource: CloudResource=None, spec: CloudResourceOperationSpec=None) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    def mergeId(self, other: CloudResource=None) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    @classmethod
    def forCloudId(cls, id: CloudId, failIfMissing: bool=None) -> Union[AzureLoadBalancer]:
    """
    ...
    """
        ...
    @classmethod
    def forCloudFunc(cls, func: str, role: str=None, failIfMissing: bool=None) -> AzureLoadBalancer:
    """
    Find Cloud Resource based on provided cloud func component and optional role.
    """
        ...
    @classmethod
    def forCloudRole(cls, role: str, failIfMissing: bool=None) -> AzureLoadBalancer:
    """
    Find Cloud Resource of this type based on provided cloud role component.
    """
        ...
    @classmethod
    def forResourceId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AzureLoadBalancer]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def forResourceSecondaryId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AzureLoadBalancer]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forResourceName(cls, resourceName: str, failIfMissing: bool=None) -> Union[AzureLoadBalancer]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def findResource(cls, reference: str, failIfMissing: bool=None) -> Union[AzureLoadBalancer]:
    """
    Find Cloud Resource in the Cloud Provider by provided {@link CloudRef} string.
    """
        ...
    def getResource(self) -> Union[AzureLoadBalancer]:
    """
    Find Cloud Resource in the Cloud Provider by provided #resourceId, #resourceSecondaryId, #resourceName or #tags
    (in that order).
    """
        ...
    def ensureResource(self) -> AzureLoadBalancer:
    """
    Checks that the resource is persisted. If not, upserts the resource, to ensure that the resource exists.
    """
        ...
    @classmethod
    def listResourcesBySubtype(cls, spec: CloudListResourcesSpec=None) -> Map[str, CloudListResourcesResult[AzureLoadBalancer]]:
    """
    ...
    """
        ...
    @classmethod
    def listResources(cls, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureLoadBalancer]:
    """
    ...
    """
        ...
    @classmethod
    def listResourcesForTags(cls, *keyValuePairs: Array[str]) -> CloudListResourcesResult[AzureLoadBalancer]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForClusterId(cls, clusterId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureLoadBalancer]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForEnvId(cls, envId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureLoadBalancer]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForAppId(cls, appId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureLoadBalancer]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    def upsertDependencies(self, spec: CloudResourceOperationSpec=None) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    def waitForCreate(self, spec: WaitSpec=None) -> Union[AzureLoadBalancer]:
    """
    ...
    """
        ...
    @classmethod
    def tagResourcesBatch(cls, resources: Array[AzureLoadBalancer], tags: Array[CloudTag]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    @classmethod
    def untagResourcesBatch(cls, resources: Array[AzureLoadBalancer], tagKeys: Array[str]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    def waitForOk(self, spec: WaitSpec=None) -> Union[AzureLoadBalancer]:
    """
    ...
    """
        ...
    def waitForState(self, state: str='AVAILABLE', spec: WaitSpec=None) -> Union[AzureLoadBalancer]:
    """
    ...
    """
        ...
    def setFullyConfigured(self, fullyConfigured: bool=None, override: str=None) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    def afterCreate(self, input: AzureLoadBalancer=None) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    def beforeCreate(self) -> AzureLoadBalancer:
    """
    Optional callback to alter resource before creating it.
    """
        ...
    def beforeUpdate(self) -> AzureLoadBalancer:
    """
    Optional callback to alter resource before updating it.
    """
        ...
    def beforeDestroy(self) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    def withoutNonModifiableFields(self) -> AzureLoadBalancer:
    """
    ...
    """
        ...
    @classmethod
    def fromImpl(cls, impl: Any=None) -> Union[AzureLoadBalancer]:
    """
    ...
    """
        ...
    @classmethod
    def fromJava(cls, javaObj: Any) -> Union[AzureLoadBalancerFields]:
        ...
