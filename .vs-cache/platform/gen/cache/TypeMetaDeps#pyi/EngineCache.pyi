...
from c3.platform.EngineCacheEntry import EngineCacheEntry
...
# Python definitions for the C3 type EngineCache


class EngineCache(MetadataCacheOld[EngineCacheEntry], Value):
    """
    This cache contains running Engines. MultiTenantEngines are always cached under c3/c3 (only) while
    SingleTenantEngines are cached under the tag in which they are defined.
    
    This means that MultiTenantEngines can only be provisioned once, but likely we will restrict them to platform types.
    
    @see Engine.Deprecated
    
    @remarks this represents a made instance of EngineCache
    """
    def __init__(self) -> None: ...

    @classmethod
    def get(cls, key: str) -> Union[EngineCacheEntry]:
    """
    ...
    """
        ...
    @classmethod
    def require(cls, key: str) -> EngineCacheEntry:
    """
    ...
    """
        ...
    @classmethod
    def put(cls, key: str, value: EngineCacheEntry) -> None:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[EngineCacheEntry]:
    """
    ...
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, EngineCacheEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def release(cls, key: str, value: EngineCacheEntry) -> None:
    """
    ...
    """
        ...
    @classmethod
    def validate(cls, value: EngineCacheEntry) -> bool:
    """
    ...
    """
        ...
    @classmethod
    def entry(cls, typeName: str) -> Union[EngineCacheEntry]:
    """
    @return information about instance for a given Engine type if running.
    """
        ...
    @classmethod
    def inst(cls, typeName: str) -> Union[Engine.Deprecated]:
    """
    @return instance for a given Engine type (even if it's an external engine) if running.
    """
        ...
    @classmethod
    def externalEngineSession(cls, typeName: str) -> Union[ExternalEngineSession]:
    """
    @return running ExternalEngineSession for a given Engine type if it is an external engine and it's running.
    """
        ...
    @classmethod
    def startEngine(cls, typeName: str) -> Engine.Deprecated:
    """
    Instantiates Engine, places it in the cache and starts it.
    """
        ...
    @classmethod
    def evictEngine(cls, typeName: str) -> bool:
    """
    Evict instance of the engine if running.
    """
        ...
