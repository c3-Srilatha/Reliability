...
# Python definitions for the C3 type CachedGraph
...
class CachedGraph():
    ...
    """
    def __init__(self, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, value: Optional[any]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[CachedGraph]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[CachedGraph]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[CachedGraph]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[CachedGraph]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> CachedGraph:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> CachedGraph:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> CachedGraph:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[CachedGraph]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[CachedGraph]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> CachedGraph:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> CachedGraph:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> CachedGraph:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> CachedGraph:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> CachedGraph:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> CachedGraph:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> CachedGraph:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> CachedGraph:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> CachedGraph:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> CachedGraph:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> CachedGraph:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> CachedGraph:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> CachedGraph:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> CachedGraph:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> CachedGraph:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> CachedGraph:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> CachedGraph:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> CachedGraph:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> CachedGraph:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> CachedGraph:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> CachedGraph:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> CachedGraph:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> CachedGraph:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> CachedGraph:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> CachedGraph:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> CachedGraph:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> CachedGraph:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> CachedGraph:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[CachedGraph]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[CachedGraph]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[CachedGraph]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[CachedGraph]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[CachedGraph]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, CachedGraph]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, CachedGraph]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[CachedGraph]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[CachedGraph]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> CachedGraph:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> CachedGraph:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> CachedGraph:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> CachedGraph:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> CachedGraph:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> CachedGraph:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[CachedGraph]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> CachedGraph:
    """
    ...
    """
        ...
    def afterMake(self) -> CachedGraph:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> CachedGraph:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[CachedGraph]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> CachedGraph:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[CachedGraph]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[CachedGraph]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[CachedGraph]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[CachedGraph]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[CachedGraph]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[CachedGraph]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> CachedGraph:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[CachedGraph]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> CachedGraph:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[CachedGraph]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[CachedGraph]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[CachedGraph], spec: UpsertSpec=None) -> Union[ObjList[CachedGraph]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[CachedGraph], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[CachedGraph]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: CachedGraph=None, spec: UpsertSpec=None) -> Union[CachedGraph]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: CachedGraph=None, spec: UpsertSpec=None) -> Union[CachedGraph]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[CachedGraph]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[CachedGraph]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[CachedGraph]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[CachedGraph], srcObjs: Array[CachedGraph]=None, spec: UpsertSpec=None) -> Union[ObjList[CachedGraph]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[CachedGraph]]], spec: UpsertSpec=None) -> Union[ObjList[CachedGraph]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[CachedGraph], srcObjs: Array[CachedGraph]=None, spec: UpsertSpec=None) -> Union[ObjList[CachedGraph]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[CachedGraph]]], spec: UpsertSpec=None) -> Union[ObjList[CachedGraph]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[CachedGraph], spec: TouchSpec=None) -> Union[ObjList[CachedGraph]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[CachedGraph], spec: MergeSpec=None) -> Union[ObjList[CachedGraph]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[CachedGraph], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[CachedGraph]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[CachedGraph]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[CachedGraph]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: CachedGraph, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: CachedGraph, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[CachedGraph], spec: UpsertSpec=None) -> Union[ObjList[CachedGraph]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[CachedGraph], spec: UpsertSpec=None) -> Union[ObjList[CachedGraph]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[CachedGraph]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[CachedGraph]) -> ObjList[CachedGraph]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[CachedGraph]) -> ObjList[CachedGraph]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[CachedGraph]) -> ObjList[CachedGraph]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[CachedGraph]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[CachedGraph]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[CachedGraph]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[CachedGraph]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[CachedGraph]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[CachedGraph]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[CachedGraph]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[CachedGraph]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: CachedGraph=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[CachedGraph], callback: Callable[[Union[CachedGraph]], Union[CachedGraph]]=None) -> ObjList[CachedGraph]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[CachedGraph], callback: Callable[[Union[CachedGraph]], Union[CachedGraph]]=None) -> Union[Array[ObjError]]:
    """
