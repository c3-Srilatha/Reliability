...
# Python definitions for the C3 type SetBuilder

E = TypeVar('E')

class SetBuilder(Generic[E], CollectionBuilder[E], Value):
    """
    Builder of sets.
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> SetBuilder[E]:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[SetBuilder[E]]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[SetBuilder[E]]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[SetBuilder[E]]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[SetBuilder[E]]:
    """
    ...
    """
        ...
    @overload
    def e(self, e: E) -> SetBuilder[E]:
    """
    Adds new element to this builder.
    """
        ...
    @overload
    def e(self, e: Any, doNotConvert: bool) -> SetBuilder[E]:
    """
    Adds new generic element to this builder specifying if the given value should be converted or not
    """
        ...
    def add(self, e: E) -> SetBuilder[E]:
    """
    Adds new element to this builder.
    """
        ...
    def addConvertValue(self, e: Any) -> SetBuilder[E]:
    """
    Adds new element to this builder converting value to element type.
    """
        ...
    def addCollection(self, elemBuilder: Callable[[Union[CollectionBuilder[Any]]]]) -> SetBuilder[E]:
    """
    Puts new element collection builder in this map builder. Assumes this a builder of map of collections
    """
        ...
    def addRef(self, elemBuilder: Callable[[Union[ObjBuilder[Obj]]]]) -> SetBuilder[E]:
    """
    ...
    """
        ...
    @overload
    def addAll(self, *elements: Array[E]) -> SetBuilder[E]:
    """
    Adds new elements to this builder.
    """
        ...
    @overload
    def addAll(self, elements: Collection[E]) -> SetBuilder[E]:
    """
    Adds all elements from provided collection to this builder.
    """
        ...
    @overload
    def addAll(self, elements: Data) -> SetBuilder[E]:
    """
    Adds all elements from provided collection of Data to this builder.
    """
        ...
    def addAllConvertValue(self, elements: Collection[Any]) -> SetBuilder[E]:
    """
    ...
    """
        ...
    def clear(self) -> SetBuilder[E]:
    """
    Clears contents of this builder.
    """
        ...
    def unique(self) -> SetBuilder[E]:
    """
    Enforce uniqueness of elements in this builder.
    """
        ...
    def index(self) -> SetBuilder[E]:
    """
    ...
    """
        ...
    @overload
    def sort(self, descending: bool=None) -> SetBuilder[E]:
    """
    Insert elements in opposite of natural sorted order in this builder.
    """
        ...
    @overload
    def sort(self, comparator: Callable[[Union[E], Union[E]], Union[int]]) -> SetBuilder[E]:
    """
    Insert elements in order based on provided comparator.
    """
        ...
    @overload
    def sort(self, descending: bool, comparator: Callable[[Union[E], Union[E]], Union[int]]) -> SetBuilder[E]:
    """
    Insert elements in order based on provided comparator.
    """
        ...
    def constrain(self) -> SetBuilder[E]:
    """
    Enforce constraints when inserting element in this builder.
    """
        ...
    def synchronize(self) -> SetBuilder[E]:
    """
    Ensure this builder can be used concurrently from multiple threads.
    """
        ...
    def current(self) -> Union[Set[E]]:
    """
