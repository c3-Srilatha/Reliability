...
# Python definitions for the C3 type MsTeamsTeam


class MsTeamsTeam(ConfigNamed):
    """
    ...
    channels: Optional[Map[str, str]]=None
    """
    map of channel name: webhook
    """
    def __init__(self, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, name: Optional[str]=None, channels: Optional[Map[str, str]]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[MsTeamsTeam]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[MsTeamsTeam]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[MsTeamsTeam]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[MsTeamsTeam]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> MsTeamsTeam:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> MsTeamsTeam:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> MsTeamsTeam:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[MsTeamsTeam]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[MsTeamsTeam]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> MsTeamsTeam:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> MsTeamsTeam:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> MsTeamsTeam:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> MsTeamsTeam:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> MsTeamsTeam:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> MsTeamsTeam:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> MsTeamsTeam:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> MsTeamsTeam:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> MsTeamsTeam:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> MsTeamsTeam:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> MsTeamsTeam:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> MsTeamsTeam:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> MsTeamsTeam:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> MsTeamsTeam:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> MsTeamsTeam:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> MsTeamsTeam:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> MsTeamsTeam:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> MsTeamsTeam:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> MsTeamsTeam:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> MsTeamsTeam:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> MsTeamsTeam:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> MsTeamsTeam:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> MsTeamsTeam:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> MsTeamsTeam:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> MsTeamsTeam:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> MsTeamsTeam:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> MsTeamsTeam:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> MsTeamsTeam:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[MsTeamsTeam]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[MsTeamsTeam]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[MsTeamsTeam]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[MsTeamsTeam]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[MsTeamsTeam]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, MsTeamsTeam]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, MsTeamsTeam]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[MsTeamsTeam]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[MsTeamsTeam]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> MsTeamsTeam:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> MsTeamsTeam:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> MsTeamsTeam:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> MsTeamsTeam:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> MsTeamsTeam:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> MsTeamsTeam:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[MsTeamsTeam]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> MsTeamsTeam:
    """
    ...
    """
        ...
    def afterMake(self) -> MsTeamsTeam:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> MsTeamsTeam:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[MsTeamsTeam]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> MsTeamsTeam:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[MsTeamsTeam]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[MsTeamsTeam]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[MsTeamsTeam]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[MsTeamsTeam]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[MsTeamsTeam]:
    """
    Returns cached instance by key, with secrets removed.
    """
        ...
    def getCached(self) -> Union[MsTeamsTeam]:
    """
    ...
    """
        ...
    def refreshCache(self) -> Union[MsTeamsTeam]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[MsTeamsTeam]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, MsTeamsTeam]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, MsTeamsTeam]]:
    """
    ...
    """
        ...
    def getConfig(self) -> MsTeamsTeam:
    """
    ...
    """
        ...
    def getSecret(self) -> MsTeamsTeam:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[MsTeamsTeam]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[MsTeamsTeam]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: MsTeamsTeam, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: MsTeamsTeam, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[MsTeamsTeam]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[MsTeamsTeam]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[MsTeamsTeam]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> MsTeamsTeam:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[MsTeamsTeam]:
    """
    ...
    """
        ...
    @classmethod
    def forName(cls, name: str, failIfMissing: bool=None) -> Union[MsTeamsTeam]:
    """
