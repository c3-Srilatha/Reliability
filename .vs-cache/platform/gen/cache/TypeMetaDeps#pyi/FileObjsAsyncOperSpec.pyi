...
# Python definitions for the C3 type FileObjsAsyncOperSpec


class FileObjsAsyncOperSpec(FileObjsOperSpec, AsyncOperSpec):
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[FileObjsAsyncOperSpec]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[FileObjsAsyncOperSpec]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[FileObjsAsyncOperSpec]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[FileObjsAsyncOperSpec]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> FileObjsAsyncOperSpec:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> FileObjsAsyncOperSpec:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> FileObjsAsyncOperSpec:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[FileObjsAsyncOperSpec]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[FileObjsAsyncOperSpec]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> FileObjsAsyncOperSpec:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> FileObjsAsyncOperSpec:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> FileObjsAsyncOperSpec:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> FileObjsAsyncOperSpec:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> FileObjsAsyncOperSpec:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> FileObjsAsyncOperSpec:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> FileObjsAsyncOperSpec:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> FileObjsAsyncOperSpec:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> FileObjsAsyncOperSpec:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> FileObjsAsyncOperSpec:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> FileObjsAsyncOperSpec:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> FileObjsAsyncOperSpec:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> FileObjsAsyncOperSpec:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> FileObjsAsyncOperSpec:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> FileObjsAsyncOperSpec:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> FileObjsAsyncOperSpec:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> FileObjsAsyncOperSpec:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> FileObjsAsyncOperSpec:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> FileObjsAsyncOperSpec:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> FileObjsAsyncOperSpec:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> FileObjsAsyncOperSpec:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> FileObjsAsyncOperSpec:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> FileObjsAsyncOperSpec:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> FileObjsAsyncOperSpec:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> FileObjsAsyncOperSpec:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> FileObjsAsyncOperSpec:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> FileObjsAsyncOperSpec:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> FileObjsAsyncOperSpec:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[FileObjsAsyncOperSpec]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[FileObjsAsyncOperSpec]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[FileObjsAsyncOperSpec]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[FileObjsAsyncOperSpec]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[FileObjsAsyncOperSpec]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, FileObjsAsyncOperSpec]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, FileObjsAsyncOperSpec]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[FileObjsAsyncOperSpec]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[FileObjsAsyncOperSpec]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> FileObjsAsyncOperSpec:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> FileObjsAsyncOperSpec:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> FileObjsAsyncOperSpec:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> FileObjsAsyncOperSpec:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> FileObjsAsyncOperSpec:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> FileObjsAsyncOperSpec:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> FileObjsAsyncOperSpec:
    """
    ...
    """
        ...
    def afterMake(self) -> FileObjsAsyncOperSpec:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> FileObjsAsyncOperSpec:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[FileObjsAsyncOperSpec]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> FileObjsAsyncOperSpec:
    """
    ...
    """
        ...
    def withRetry(self, maxRetries: int=None, initialSleepMillis: int=None, exponent: float=None) -> Union[FileObjsAsyncOperSpec]:
    """
    @return new instance of this spec with `retrySpec` set
    """
        ...
    @classmethod
    def timeoutSeconds(cls, secs: float) -> FileObjsAsyncOperSpec:
    """
    @return instance of this spec with `retrySpec`'s `maxTotalMillis` set
    """
        ...
    @classmethod
    def fromType(cls, serType: Type) -> FileObjsAsyncOperSpec:
    """
    ...
    """
        ...
    @classmethod
    def toDecrypt(cls) -> Union[FileObjsAsyncOperSpec]:
    """
