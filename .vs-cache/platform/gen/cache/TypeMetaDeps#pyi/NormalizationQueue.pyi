...
from c3.platform.NormalizationQueueEntry import NormalizationQueueEntry
...
# Python definitions for the C3 type NormalizationQueue


class NormalizationQueue(InvalidationQueue[NormalizationQueueEntry], MergeableInvalidationQueue[NormalizationQueueEntry], Value):
    """
    ...
    @classmethod
    def compute(cls, targetType: Type, entries: Array[NormalizationQueueEntry]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, spec: InvalidationQueue.FindSpec=None) -> Union[Array[NormalizationQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def findStream(cls, spec: InvalidationQueue.FindStreamSpec=None) -> Union[Stream[NormalizationQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def clearEntries(cls, entries: Array[NormalizationQueueEntry]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def mergeContexts(cls, targetType: Type=None, entries: Array[NormalizationQueueEntry]=None) -> Union[Array[NormalizationQueueEntry]]:
    """
