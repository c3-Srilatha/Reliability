...
from c3.platform.MetricsQueueEntry import MetricsQueueEntry
...
# Python definitions for the C3 type MetricsQueue


class MetricsQueue(InvalidationQueue[MetricsQueueEntry], MergeableInvalidationQueue[MetricsQueueEntry], Value):
    """
    Invalidation queue for metric invalidation processing.
    
    @see MetricsQueueEntry
    
    @remarks this represents a made instance of MetricsQueue
    """
    def __init__(self) -> None: ...

    @classmethod
    def compute(cls, targetType: Type, entries: Array[MetricsQueueEntry]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, spec: InvalidationQueue.FindSpec=None) -> Union[Array[MetricsQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def findStream(cls, spec: InvalidationQueue.FindStreamSpec=None) -> Union[Stream[MetricsQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def clearEntries(cls, entries: Array[MetricsQueueEntry]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def mergeContexts(cls, targetType: Type=None, entries: Array[MetricsQueueEntry]=None) -> Union[Array[MetricsQueueEntry]]:
    """
