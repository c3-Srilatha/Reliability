...
# Python definitions for the C3 type SamlSpCertificate


class SamlSpCertificate(Config, Singleton):
    """
    Type for storing symmetricKey for SAML communication
    
    @remarks this represents a made instance of SamlSpCertificate
    """
    ...
    cert: Optional[str]
    """
    Certificate in pm format.
    """
    def __init__(self, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, key: Optional[str]=None, cert: Optional[str]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[SamlSpCertificate]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[SamlSpCertificate]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[SamlSpCertificate]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[SamlSpCertificate]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> SamlSpCertificate:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> SamlSpCertificate:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> SamlSpCertificate:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[SamlSpCertificate]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[SamlSpCertificate]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> SamlSpCertificate:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> SamlSpCertificate:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> SamlSpCertificate:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> SamlSpCertificate:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> SamlSpCertificate:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> SamlSpCertificate:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> SamlSpCertificate:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> SamlSpCertificate:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> SamlSpCertificate:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> SamlSpCertificate:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> SamlSpCertificate:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> SamlSpCertificate:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> SamlSpCertificate:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> SamlSpCertificate:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> SamlSpCertificate:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> SamlSpCertificate:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> SamlSpCertificate:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> SamlSpCertificate:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> SamlSpCertificate:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> SamlSpCertificate:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> SamlSpCertificate:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> SamlSpCertificate:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> SamlSpCertificate:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> SamlSpCertificate:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> SamlSpCertificate:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> SamlSpCertificate:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> SamlSpCertificate:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> SamlSpCertificate:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[SamlSpCertificate]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[SamlSpCertificate]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[SamlSpCertificate]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[SamlSpCertificate]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[SamlSpCertificate]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, SamlSpCertificate]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, SamlSpCertificate]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[SamlSpCertificate]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[SamlSpCertificate]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> SamlSpCertificate:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> SamlSpCertificate:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> SamlSpCertificate:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> SamlSpCertificate:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> SamlSpCertificate:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> SamlSpCertificate:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> SamlSpCertificate:
    """
    ...
    """
        ...
    def afterMake(self) -> SamlSpCertificate:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> SamlSpCertificate:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[SamlSpCertificate]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> SamlSpCertificate:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[SamlSpCertificate]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[SamlSpCertificate]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[SamlSpCertificate]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[SamlSpCertificate]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[SamlSpCertificate]:
    """
    Returns cached instance by key, with secrets removed.
    """
        ...
    def getCached(self) -> Union[SamlSpCertificate]:
    """
    ...
    """
        ...
    def refreshCache(self) -> Union[SamlSpCertificate]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[SamlSpCertificate]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, SamlSpCertificate]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, SamlSpCertificate]]:
    """
    ...
    """
        ...
    def getConfig(self) -> SamlSpCertificate:
    """
    ...
    """
        ...
    def getSecret(self) -> SamlSpCertificate:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[SamlSpCertificate]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[SamlSpCertificate]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: SamlSpCertificate, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: SamlSpCertificate, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[SamlSpCertificate]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[SamlSpCertificate]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[SamlSpCertificate]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> SamlSpCertificate:
    """
