...
# Python definitions for the C3 type DnsRecordSetType


class DnsRecordSetType():
    """
    ...
    """
    def __init__(self, A: Optional[str]=None, AAAA: Optional[str]=None, CNAME: Optional[str]=None, MX: Optional[str]=None, NS: Optional[str]=None, SOA: Optional[str]=None, SRV: Optional[str]=None, TXT: Optional[str]=None) -> None: ...
