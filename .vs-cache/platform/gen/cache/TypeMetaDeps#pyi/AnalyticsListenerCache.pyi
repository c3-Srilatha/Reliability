...
from c3.platform.AnalyticsListenerCacheEntry import AnalyticsListenerCacheEntry
from c3.platform.Type import Type

# Python definitions for the C3 type AnalyticsListenerCache


class AnalyticsListenerCache(MetadataCacheOld[AnalyticsListenerCacheEntry], Value):
    """
    Cache for analytics listeners
    
    @remarks this represents a made instance of AnalyticsListenerCache
    """
    def __init__(self) -> None: ...

    @classmethod
    def get(cls, key: str) -> Union[AnalyticsListenerCacheEntry]:
    """
    ...
    """
        ...
    @classmethod
    def require(cls, key: str) -> AnalyticsListenerCacheEntry:
    """
    ...
    """
        ...
    @classmethod
    def put(cls, key: str, value: AnalyticsListenerCacheEntry) -> None:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[AnalyticsListenerCacheEntry]:
    """
    ...
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, AnalyticsListenerCacheEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def release(cls, key: str, value: AnalyticsListenerCacheEntry) -> None:
    """
    ...
    """
        ...
    @classmethod
    def validate(cls, value: AnalyticsListenerCacheEntry) -> bool:
    """
    ...
    """
        ...
    @classmethod
    def info(cls) -> AnalyticsListenerCacheEntry:
    """
    ...
    """
        ...
    @classmethod
    def srcTypesForListener(cls, listenerType: str) -> Union[Array[Type]]:
    """
    Gets the source types handled by a listener.
    
    @param listenerType
           Listener type to get the source types for.
    
    @return List of source types handled by the listener.
    """
        ...
