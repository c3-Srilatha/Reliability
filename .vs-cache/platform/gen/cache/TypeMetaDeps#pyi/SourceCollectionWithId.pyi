...
# Python definitions for the C3 type SourceCollectionWithId


class SourceCollectionWithId(FileSourceCollection, WithId):
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[SourceCollectionWithId]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[SourceCollectionWithId]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[SourceCollectionWithId]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[SourceCollectionWithId]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> SourceCollectionWithId:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> SourceCollectionWithId:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> SourceCollectionWithId:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[SourceCollectionWithId]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[SourceCollectionWithId]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> SourceCollectionWithId:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> SourceCollectionWithId:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> SourceCollectionWithId:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> SourceCollectionWithId:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> SourceCollectionWithId:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> SourceCollectionWithId:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> SourceCollectionWithId:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> SourceCollectionWithId:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> SourceCollectionWithId:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> SourceCollectionWithId:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> SourceCollectionWithId:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> SourceCollectionWithId:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> SourceCollectionWithId:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> SourceCollectionWithId:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> SourceCollectionWithId:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> SourceCollectionWithId:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> SourceCollectionWithId:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> SourceCollectionWithId:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> SourceCollectionWithId:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> SourceCollectionWithId:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> SourceCollectionWithId:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> SourceCollectionWithId:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> SourceCollectionWithId:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> SourceCollectionWithId:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> SourceCollectionWithId:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> SourceCollectionWithId:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> SourceCollectionWithId:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> SourceCollectionWithId:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[SourceCollectionWithId]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[SourceCollectionWithId]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[SourceCollectionWithId]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[SourceCollectionWithId]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[SourceCollectionWithId]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, SourceCollectionWithId]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, SourceCollectionWithId]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[SourceCollectionWithId]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[SourceCollectionWithId]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> SourceCollectionWithId:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> SourceCollectionWithId:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> SourceCollectionWithId:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> SourceCollectionWithId:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> SourceCollectionWithId:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> SourceCollectionWithId:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[SourceCollectionWithId]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> SourceCollectionWithId:
    """
    ...
    """
        ...
    def afterMake(self) -> SourceCollectionWithId:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> SourceCollectionWithId:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[SourceCollectionWithId]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> SourceCollectionWithId:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[SourceCollectionWithId]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[SourceCollectionWithId]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[SourceCollectionWithId]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[SourceCollectionWithId]]]:
    """
    ...
    """
        ...
    def save(self, subPath: str=None, contentType: str=None) -> SourceCollectionWithId:
        ...
    ...
    def removeAll(cls, removeFilter: str=None) -> int:
        ...
    def update(self, srcObj: SourceCollectionWithId=None, spec: UpsertSpec=None) -> Union[SourceCollectionWithId]:
        ...
    def upsert(self, srcObj: SourceCollectionWithId=None, spec: UpsertSpec=None) -> Union[SourceCollectionWithId]:
        ...
    @classmethod
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[SourceCollectionWithId]:
    """
    ...
    """
        ...
    @classmethod
    def forName(cls, name: str, failIfMissing: bool=None) -> Union[SourceCollectionWithId]:
    """
    ...
    """
        ...
    @classmethod
    def collectionsForSourceType(cls, sourceType: Type, include: str=None) -> Union[Stream[SourceCollectionWithId]]:
    """
    ...
    """
        ...
    def setPriority(self, priority: int) -> SourceCollectionWithId:
    """
    @return SourceCollection after setting the priority
    """
        ...
    def clearPriority(self) -> SourceCollectionWithId:
    """
    ...
    """
        ...
    def skipTransform(self, transformId: str=None) -> SourceCollectionWithId:
    """
    skip #transform for the source collection.
    """
        ...
    def skipTransformBatch(self, transformIds: Array[str]) -> SourceCollectionWithId:
    """
    skip #transform for the source collection.
    """
        ...
    def clearSkippedTransforms(self, transformsId: Array[str]) -> SourceCollectionWithId:
    """
    skip #transform for the source collection.
    """
        ...
    def clearAllSkippedTransforms(self) -> SourceCollectionWithId:
    """
    skip #transform for the source collection.
    """
        ...
