...
# Python definitions for the C3 type TimedDataFields

TDP = TypeVar('TDP')

class TimedDataFields(Generic[TDP]):
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[TimedDataFields[TDP]]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[TimedDataFields[TDP]]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[TimedDataFields[TDP]]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[TimedDataFields[TDP]]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> TimedDataFields[TDP]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> TimedDataFields[TDP]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> TimedDataFields[TDP]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[TimedDataFields[TDP]]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[TimedDataFields[TDP]]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> TimedDataFields[TDP]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> TimedDataFields[TDP]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> TimedDataFields[TDP]:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> TimedDataFields[TDP]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> TimedDataFields[TDP]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> TimedDataFields[TDP]:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> TimedDataFields[TDP]:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> TimedDataFields[TDP]:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> TimedDataFields[TDP]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> TimedDataFields[TDP]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> TimedDataFields[TDP]:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> TimedDataFields[TDP]:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> TimedDataFields[TDP]:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> TimedDataFields[TDP]:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> TimedDataFields[TDP]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> TimedDataFields[TDP]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> TimedDataFields[TDP]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> TimedDataFields[TDP]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> TimedDataFields[TDP]:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> TimedDataFields[TDP]:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> TimedDataFields[TDP]:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> TimedDataFields[TDP]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> TimedDataFields[TDP]:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> TimedDataFields[TDP]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> TimedDataFields[TDP]:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> TimedDataFields[TDP]:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> TimedDataFields[TDP]:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> TimedDataFields[TDP]:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[TimedDataFields[TDP]]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[TimedDataFields[TDP]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[TimedDataFields[TDP]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[TimedDataFields[TDP]]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[TimedDataFields[TDP]]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, TimedDataFields[TDP]]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, TimedDataFields[TDP]]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[TimedDataFields[TDP]]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[TimedDataFields[TDP]]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> TimedDataFields[TDP]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> TimedDataFields[TDP]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> TimedDataFields[TDP]:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> TimedDataFields[TDP]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> TimedDataFields[TDP]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> TimedDataFields[TDP]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> TimedDataFields[TDP]:
    """
    ...
    """
        ...
    def afterMake(self) -> TimedDataFields[TDP]:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> TimedDataFields[TDP]:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[TimedDataFields[TDP]]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> TimedDataFields[TDP]:
    """
