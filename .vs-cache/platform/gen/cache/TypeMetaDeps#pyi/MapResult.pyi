...
# Python definitions for the C3 type MapResult


class MapResult(Partitionable[string]):
    """
    ...
    subBatch: Optional[int]

    outKey: Optional[str]=None

    runIdAndOutKey: Optional[str]
    """
    = runId + '-' + outKey
    """

    interValue: Optional[Any]=None
    def __init__(self, PK_BIN_SEPARATOR: Optional[str]=None, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, run: Optional[MapReduceRun]=None, batch: Optional[int]=None, subBatch: Optional[int]=None, outKey: Optional[str]=None, runIdAndOutKey: Optional[str]=None, interValue: Optional[Any]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[MapResult]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[MapResult]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[MapResult]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[MapResult]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> MapResult:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> MapResult:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> MapResult:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[MapResult]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[MapResult]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> MapResult:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> MapResult:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> MapResult:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> MapResult:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> MapResult:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> MapResult:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> MapResult:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> MapResult:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> MapResult:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> MapResult:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> MapResult:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> MapResult:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> MapResult:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> MapResult:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> MapResult:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> MapResult:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> MapResult:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> MapResult:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> MapResult:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> MapResult:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> MapResult:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> MapResult:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> MapResult:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> MapResult:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> MapResult:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> MapResult:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> MapResult:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> MapResult:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[MapResult]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[MapResult]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[MapResult]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[MapResult]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[MapResult]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, MapResult]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, MapResult]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[MapResult]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[MapResult]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> MapResult:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> MapResult:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> MapResult:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> MapResult:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> MapResult:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> MapResult:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[MapResult]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> MapResult:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> MapResult:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[MapResult]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> MapResult:
    """
    ...
    """
        ...
    @classmethod
    def partition(cls, objs: Stream[MapResult]=None, spec: PartitionBucketStrategy=None) -> Union[Map[str, KvDataPartition]]:
    """
    ...
    """
        ...
    @classmethod
    def fromPartitions(cls, partitions: Stream[KvDataPartition]=None) -> Union[Stream[MapResult]]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[MapResult]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[MapResult]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[MapResult]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[MapResult]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[MapResult]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[MapResult]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> MapResult:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[MapResult]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> MapResult:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[MapResult]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[MapResult]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[MapResult], spec: UpsertSpec=None) -> Union[ObjList[MapResult]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[MapResult], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[MapResult]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: MapResult=None, spec: UpsertSpec=None) -> Union[MapResult]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: MapResult=None, spec: UpsertSpec=None) -> Union[MapResult]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[MapResult]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[MapResult]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[MapResult]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[MapResult], srcObjs: Array[MapResult]=None, spec: UpsertSpec=None) -> Union[ObjList[MapResult]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[MapResult]]], spec: UpsertSpec=None) -> Union[ObjList[MapResult]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[MapResult], srcObjs: Array[MapResult]=None, spec: UpsertSpec=None) -> Union[ObjList[MapResult]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[MapResult]]], spec: UpsertSpec=None) -> Union[ObjList[MapResult]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[MapResult], spec: TouchSpec=None) -> Union[ObjList[MapResult]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[MapResult], spec: MergeSpec=None) -> Union[ObjList[MapResult]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[MapResult], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[MapResult]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[MapResult]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[MapResult]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: MapResult, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: MapResult, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[MapResult], spec: UpsertSpec=None) -> Union[ObjList[MapResult]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[MapResult], spec: UpsertSpec=None) -> Union[ObjList[MapResult]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[MapResult]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[MapResult]) -> ObjList[MapResult]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[MapResult]) -> ObjList[MapResult]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[MapResult]) -> ObjList[MapResult]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[MapResult]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[MapResult]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[MapResult]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[MapResult]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[MapResult]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[MapResult]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[MapResult]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[MapResult]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: MapResult=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[MapResult], callback: Callable[[Union[MapResult]], Union[MapResult]]=None) -> ObjList[MapResult]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[MapResult], callback: Callable[[Union[MapResult]], Union[MapResult]]=None) -> Union[Array[ObjError]]:
    """
