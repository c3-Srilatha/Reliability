...
from c3.platform.Pair import Pair
from c3.platform.ContentBuffer import ContentBuffer
from c3.platform.File import File
from c3.platform.SourceTransformResult import SourceTransformResult

# Python definitions for the C3 type SourceBuffer


class SourceBuffer(ContentBuffer, Sources):
    """
    "writable" or in memory buffer of {@link Sources}
    
    @remarks this represents a made instance of SourceBuffer
    """
    ...
    """
    The actual content buffer backed by a native mechanism.
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[SourceBuffer]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[SourceBuffer]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[SourceBuffer]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[SourceBuffer]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> SourceBuffer:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> SourceBuffer:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> SourceBuffer:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[SourceBuffer]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[SourceBuffer]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> SourceBuffer:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> SourceBuffer:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> SourceBuffer:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> SourceBuffer:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> SourceBuffer:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> SourceBuffer:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> SourceBuffer:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> SourceBuffer:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> SourceBuffer:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> SourceBuffer:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> SourceBuffer:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> SourceBuffer:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> SourceBuffer:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> SourceBuffer:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> SourceBuffer:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> SourceBuffer:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> SourceBuffer:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> SourceBuffer:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> SourceBuffer:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> SourceBuffer:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> SourceBuffer:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> SourceBuffer:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> SourceBuffer:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> SourceBuffer:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> SourceBuffer:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> SourceBuffer:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> SourceBuffer:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> SourceBuffer:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[SourceBuffer]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[SourceBuffer]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[SourceBuffer]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[SourceBuffer]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[SourceBuffer]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, SourceBuffer]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, SourceBuffer]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[SourceBuffer]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[SourceBuffer]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> SourceBuffer:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> SourceBuffer:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> SourceBuffer:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> SourceBuffer:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> SourceBuffer:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> SourceBuffer:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[SourceBuffer]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> SourceBuffer:
    """
    ...
    """
        ...
    def afterMake(self) -> SourceBuffer:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> SourceBuffer:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[SourceBuffer]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> SourceBuffer:
    """
    ...
    """
        ...
    def withFileName(self, fileName: str) -> SourceBuffer:
    """
    Changes file name in this instance.
    """
        ...
    def withFileExt(self, fileExt: str) -> SourceBuffer:
    """
    ...
    """
        ...
    def identify(self, suffix: str=None) -> SourceBuffer:
    """
    ...
    """
        ...
    def readMetadata(self, spec: FileOperationSpec=None) -> SourceBuffer:
    """
    ...
    """
        ...
    def refreshMetadata(self, spec: FileOperationSpec=None) -> SourceBuffer:
    """
    ...
    """
        ...
    def guessMetadata(self, spec: FileOperationSpec=None) -> SourceBuffer:
    """
    ...
    """
        ...
    def clearMetadata(self) -> SourceBuffer:
    """
    Clears the content metadata; e.g. if it's known to be invalid.
    """
        ...
    def withMetadata(self, meta: ContentMeta=None) -> SourceBuffer:
    """
    ...
    """
        ...
    def encodedPushStream(self, spec: FileOperationSpec=None) -> Pair[SourceBuffer, BytePushStream]:
    """
    ...
    """
        ...
    def pushStream(self, spec: FileOperationSpec=None) -> Pair[SourceBuffer, BytePushStream]:
    """
    @return byte push stream to be used for writing un-encoded data into this content object.
    """
        ...
    def charPushStream(self, spec: FileOperationSpec=None) -> Pair[SourceBuffer, CharPushStream]:
    """
    @return character push stream to be used for writing un-encoded data into this content object.
    """
        ...
    def encodedStream(self, spec: FileOperationSpec=None) -> Union[Pair[SourceBuffer, ByteStream]]:
    """
    ...
    """
        ...
    def writeStream(self, content: ByteStream, spec: FileOperationSpec=None) -> SourceBuffer:
    """
    ...
    """
        ...
    def writeInputStream(self, inputStream: Any, spec: FileOperationSpec=None) -> SourceBuffer:
    """
    Truncates file and replaces it's content with provided binary content.
    """
        ...
    def writeZipInputStream(self, zipInputStream: Any, spec: FileOperationSpec=None) -> SourceBuffer:
    """
    Truncates file and replaces its content with provided binary content from zipInputStream
    """
        ...
    def writeEncodedStream(self, encodedContent: ByteStream, spec: FileOperationSpec=None) -> SourceBuffer:
    """
    ...
    """
        ...
    def writeEncodedInputStream(self, inputStream: Any, spec: FileOperationSpec=None) -> SourceBuffer:
    """
    Truncates file and replaces it's encoded content with provided binary content.
    """
        ...
    def write(self, content: any, spec: FileOperationSpec=None) -> SourceBuffer:
    """
    Truncates file and replaces it's content with provided binary content.
    ...
    """
        ...
    def writeEncoded(self, encodedContent: any, spec: FileOperationSpec=None) -> SourceBuffer:
    """
    Truncates file and replaces it's encoded content with provided binary content.
    ...
    """
        ...
    def writeString(self, content: str, spec: FileOperationSpec=None) -> SourceBuffer:
    """
    ...
    """
        ...
    def writeObj(self, obj: Obj, spec: FileObjsOperSpec=None) -> SourceBuffer:
    """
    ...
    """
        ...
    def startWriteObjs(self, spec: FileObjsOperSpec=None) -> Pair[SourceBuffer, PushStream[Obj]]:
    """
    Serializes content from a list of c3 objects into a file.
    ...
    """
        ...
    def compress(self, contentEncoding: str=None, spec: FileCompressSpec=None) -> SourceBuffer:
    """
    ...
    """
        ...
    def uncompress(self, spec: FileCompressSpec=None) -> SourceBuffer:
    """
    Uncompresses content.
    """
        ...
    def transcode(self, contentType: str, contentEncoding: str, spec: FileCompressSpec=None) -> SourceBuffer:
    """
    ...
    """
        ...
    def copyContentTo(self, target: SourceBuffer, spec: FileOperationSpec=None) -> None:
    """
    ...
    """
        ...
    @overload
    def concat(self, other: Content) -> SourceBuffer:
    """
    Creates a new Content by merging the two contents
    """
        ...
    @overload
    def concat(self, other: any) -> SourceBuffer:
    """
    ...
    """
        ...
    @classmethod
    def create(cls, initialCapacity: int=None, contentType: str=None, contentEncoding: str=None) -> ContentBuffer:
    """
    Creates a new content buffer with a given initial capacity and content type and encoding.
    """
        ...
    def truncate(self) -> None:
    """
    Truncates the given buffer and makes it empty.
    """
        ...
    def currentContentLength(self) -> Union[int]:
    """
    @return current bytes accumulated in the buffer
    """
        ...
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[SourceBuffer]:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[SourceBuffer]:
    """
    ...
    """
        ...
    @classmethod
    def init(cls, sc: SourceCollection[SourceCollection.Config], contentType: str='\'application/json\'', contentEncoding: str='\'snappy\'') -> Union[SourceBuffer]:
    """
    @return an empty SourceBuffer
    """
        ...
