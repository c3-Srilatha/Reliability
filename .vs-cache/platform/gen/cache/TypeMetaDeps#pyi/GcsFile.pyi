...
# Python definitions for the C3 type GcsFile


class GcsFile(BlobFile[GcsFileSystem]):
    """
    Represents the GcsFileSystem file.
    
    @remarks this represents a made instance of GcsFile
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[GcsFile]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[GcsFile]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[GcsFile]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[GcsFile]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> GcsFile:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> GcsFile:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> GcsFile:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[GcsFile]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[GcsFile]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> GcsFile:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> GcsFile:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> GcsFile:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> GcsFile:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> GcsFile:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> GcsFile:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> GcsFile:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> GcsFile:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> GcsFile:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> GcsFile:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> GcsFile:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> GcsFile:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> GcsFile:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> GcsFile:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> GcsFile:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> GcsFile:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> GcsFile:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> GcsFile:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> GcsFile:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> GcsFile:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> GcsFile:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> GcsFile:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> GcsFile:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> GcsFile:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> GcsFile:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> GcsFile:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> GcsFile:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[GcsFile]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[GcsFile]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[GcsFile]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[GcsFile]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[GcsFile]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, GcsFile]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, GcsFile]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[GcsFile]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[GcsFile]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> GcsFile:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> GcsFile:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> GcsFile:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> GcsFile:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> GcsFile:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> GcsFile:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[GcsFile]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> GcsFile:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> GcsFile:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[GcsFile]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> GcsFile:
    """
    ...
    """
        ...
    def withFileName(self, fileName: str) -> GcsFile:
    """
    Changes file name in this instance.
    """
        ...
    def withFileExt(self, fileExt: str) -> GcsFile:
    """
    ...
    """
        ...
    def identify(self, suffix: str=None) -> GcsFile:
    """
    ...
    """
        ...
    def readMetadata(self, spec: FileOperationSpec=None) -> GcsFile:
    """
    ...
    """
        ...
    def refreshMetadata(self, spec: FileOperationSpec=None) -> GcsFile:
    """
    ...
    """
        ...
    def guessMetadata(self, spec: FileOperationSpec=None) -> GcsFile:
    """
    ...
    """
        ...
    def clearMetadata(self) -> GcsFile:
    """
    Clears the content metadata; e.g. if it's known to be invalid.
    """
        ...
    def withMetadata(self, meta: ContentMeta=None) -> GcsFile:
    """
    ...
    """
        ...
    def encodedPushStream(self, spec: FileOperationSpec=None) -> Pair[GcsFile, BytePushStream]:
    """
    ...
    """
        ...
    def pushStream(self, spec: FileOperationSpec=None) -> Pair[GcsFile, BytePushStream]:
    """
    @return byte push stream to be used for writing un-encoded data into this content object.
    """
        ...
    def charPushStream(self, spec: FileOperationSpec=None) -> Pair[GcsFile, CharPushStream]:
    """
    @return character push stream to be used for writing un-encoded data into this content object.
    """
        ...
    def encodedStream(self, spec: FileOperationSpec=None) -> Union[Pair[GcsFile, ByteStream]]:
    """
    ...
    """
        ...
    def writeStream(self, content: ByteStream, spec: FileOperationSpec=None) -> GcsFile:
    """
    ...
    """
        ...
    def writeInputStream(self, inputStream: Any, spec: FileOperationSpec=None) -> GcsFile:
    """
    Truncates file and replaces it's content with provided binary content.
    """
        ...
    def writeZipInputStream(self, zipInputStream: Any, spec: FileOperationSpec=None) -> GcsFile:
    """
    Truncates file and replaces its content with provided binary content from zipInputStream
    """
        ...
    def writeEncodedStream(self, encodedContent: ByteStream, spec: FileOperationSpec=None) -> GcsFile:
    """
    ...
    """
        ...
    def writeEncodedInputStream(self, inputStream: Any, spec: FileOperationSpec=None) -> GcsFile:
    """
    Truncates file and replaces it's encoded content with provided binary content.
    """
        ...
    def write(self, content: any, spec: FileOperationSpec=None) -> GcsFile:
    """
    Truncates file and replaces it's content with provided binary content.
    ...
    """
        ...
    def writeEncoded(self, encodedContent: any, spec: FileOperationSpec=None) -> GcsFile:
    """
    Truncates file and replaces it's encoded content with provided binary content.
    ...
    """
        ...
    def writeString(self, content: str, spec: FileOperationSpec=None) -> GcsFile:
    """
    ...
    """
        ...
    def writeObj(self, obj: Obj, spec: FileObjsOperSpec=None) -> GcsFile:
    """
    ...
    """
        ...
    def startWriteObjs(self, spec: FileObjsOperSpec=None) -> Pair[GcsFile, PushStream[Obj]]:
    """
    Serializes content from a list of c3 objects into a file.
    ...
    """
        ...
    def compress(self, contentEncoding: str=None, spec: FileCompressSpec=None) -> GcsFile:
    """
    ...
    """
        ...
    def uncompress(self, spec: FileCompressSpec=None) -> GcsFile:
    """
    Uncompresses file. Removes compression specific extension.
    """
        ...
    def transcode(self, contentType: str, contentEncoding: str, spec: FileCompressSpec=None) -> GcsFile:
    """
    ...
    """
        ...
    def copyContentTo(self, target: GcsFile, spec: FileOperationSpec=None) -> None:
    """
    ...
    """
        ...
    @overload
    def concat(self, other: Content) -> GcsFile:
    """
    Creates a new Content by merging the two contents
    """
        ...
    @overload
    def concat(self, other: any) -> GcsFile:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[GcsFile]:
    """
    ...
    """
        ...
    @classmethod
    def fsForThisType(cls) -> Union[GcsFileSystem]:
        ...
