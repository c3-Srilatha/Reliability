...
from c3.platform.CloudQueueEntry import CloudQueueEntry
...
# Python definitions for the C3 type CloudInvalidationQueue

Q = TypeVar('Q')
S = TypeVar('S')

class CloudInvalidationQueue(Generic[Q, S], InvalidationQueue[CloudQueueEntry], Value):
    """
    ...
    * If type mixes {@link CloudInboundMessage}, then implement {@link CloudInboundMessage#process}.
    ...
    @remarks this represents a made instance of CloudInvalidationQueue
    """
    def __init__(self) -> None: ...

    @classmethod
    def compute(cls, targetType: Type, entries: Array[CloudQueueEntry]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, spec: InvalidationQueue.FindSpec=None) -> Union[Array[CloudQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def findStream(cls, spec: InvalidationQueue.FindStreamSpec=None) -> Union[Stream[CloudQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def clearEntries(cls, entries: Array[CloudQueueEntry]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def typeForCloudMessageBroker(cls, typeRef: Type) -> Union[Type]:
    """
    ...
    """
        ...
    @classmethod
    def upsertEntries(cls, brokerName: str, cloudConsumer: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def removeEntries(cls, brokerName: str) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def entriesExist(cls, brokerName: str) -> bool:
    """
