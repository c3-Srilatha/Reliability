...
# Python definitions for the C3 type Log.AppProfile.ActionField


class ActionField(Log.AppProfile.GroupByField, Log.AppProfile.MetricField):
    """
    A list of action fields used in profiling of the actions.
    
    @remarks this represents a made instance of Log.AppProfile.ActionField
    """
    ...
    ACTION_ROOT_ID: Optional[str]=None
    """
    Unique identifier of the action's root action.
    """

    ACTION_PARENT_ID: Optional[str]=None
    """
    Unique identifier of the action's parent action.
    """
    def __init__(self, ACTION_NAME: Optional[str]=None, ACTION_TYPE: Optional[str]=None, STATUS: Optional[str]=None, ACTION_FUNCTION: Optional[str]=None, PARENT_ACTION_FUNCTIONS: Optional[str]=None, ACTION_ID: Optional[str]=None, PARENT_ACTION_IDS: Optional[str]=None, TOTAL_TIME: Optional[str]=None, SELF_TIME: Optional[str]=None, TOTAL_CPU: Optional[str]=None, SELF_CPU: Optional[str]=None, TOTAL_SQL: Optional[str]=None, SELF_SQL: Optional[str]=None, TOTAL_IO: Optional[str]=None, SELF_IO: Optional[str]=None, TOTAL_KV: Optional[str]=None, SELF_KV: Optional[str]=None, TIMESTAMP: Optional[str]=None, ACTION_ROOT_ID: Optional[str]=None, ACTION_PARENT_ID: Optional[str]=None) -> None: ...
