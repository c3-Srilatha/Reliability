...
from c3.platform.TSNormalizationSpec import TSNormalizationSpec
from c3.platform.TSDataPoint import TSDataPoint
from c3.platform.Timeseries import Timeseries

# Python definitions for the C3 type RegisterNormalizer


class RegisterNormalizer(Normalizer, Value):
    """
    ...
    @classmethod
    def normalize(cls, objs: Stream[TSDataPoint]=None, spec: TSNormalizationSpec=None) -> Union[Array[Timeseries[Any]]]:
    """
