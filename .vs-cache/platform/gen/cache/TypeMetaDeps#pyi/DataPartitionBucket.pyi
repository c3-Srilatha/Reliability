...
# Python definitions for the C3 type DataPartitionBucket


class DataPartitionBucket(Identifiable, ContentMeta):
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[DataPartitionBucket]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[DataPartitionBucket]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[DataPartitionBucket]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[DataPartitionBucket]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> DataPartitionBucket:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataPartitionBucket:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataPartitionBucket:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataPartitionBucket]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataPartitionBucket]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> DataPartitionBucket:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataPartitionBucket:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataPartitionBucket:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> DataPartitionBucket:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> DataPartitionBucket:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> DataPartitionBucket:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> DataPartitionBucket:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> DataPartitionBucket:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> DataPartitionBucket:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> DataPartitionBucket:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> DataPartitionBucket:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> DataPartitionBucket:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> DataPartitionBucket:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> DataPartitionBucket:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> DataPartitionBucket:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> DataPartitionBucket:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> DataPartitionBucket:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> DataPartitionBucket:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> DataPartitionBucket:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> DataPartitionBucket:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> DataPartitionBucket:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> DataPartitionBucket:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> DataPartitionBucket:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> DataPartitionBucket:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> DataPartitionBucket:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> DataPartitionBucket:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> DataPartitionBucket:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> DataPartitionBucket:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[DataPartitionBucket]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[DataPartitionBucket]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[DataPartitionBucket]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[DataPartitionBucket]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[DataPartitionBucket]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, DataPartitionBucket]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, DataPartitionBucket]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[DataPartitionBucket]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[DataPartitionBucket]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> DataPartitionBucket:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> DataPartitionBucket:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> DataPartitionBucket:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> DataPartitionBucket:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> DataPartitionBucket:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> DataPartitionBucket:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[DataPartitionBucket]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> DataPartitionBucket:
    """
    ...
    """
        ...
    def afterMake(self) -> DataPartitionBucket:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> DataPartitionBucket:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[DataPartitionBucket]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> DataPartitionBucket:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[DataPartitionBucket]:
    """
    ...
    """
        ...
    def withFileName(self, fileName: str) -> DataPartitionBucket:
    """
    Changes file name in this instance.
    """
        ...
    def withFileExt(self, fileExt: str) -> DataPartitionBucket:
    """
    ...
    """
        ...
    def identify(self, suffix: str=None) -> DataPartitionBucket:
    """
