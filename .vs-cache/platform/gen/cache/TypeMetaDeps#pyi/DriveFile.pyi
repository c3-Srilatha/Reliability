...
from c3.platform.DriveFile import DriveFile
...
# Python definitions for the C3 type DriveFile

FS = TypeVar('FS')

class DriveFile(Generic[FS], FileWithUserMetadata):
    """
    @remarks this represents a made instance of DriveFile
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[DriveFile[FS]]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[DriveFile[FS]]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[DriveFile[FS]]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[DriveFile[FS]]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> DriveFile[FS]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DriveFile[FS]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DriveFile[FS]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DriveFile[FS]]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DriveFile[FS]]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> DriveFile[FS]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DriveFile[FS]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DriveFile[FS]:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> DriveFile[FS]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> DriveFile[FS]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> DriveFile[FS]:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> DriveFile[FS]:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> DriveFile[FS]:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> DriveFile[FS]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> DriveFile[FS]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> DriveFile[FS]:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> DriveFile[FS]:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> DriveFile[FS]:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> DriveFile[FS]:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> DriveFile[FS]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> DriveFile[FS]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> DriveFile[FS]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> DriveFile[FS]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> DriveFile[FS]:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> DriveFile[FS]:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> DriveFile[FS]:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> DriveFile[FS]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> DriveFile[FS]:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> DriveFile[FS]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> DriveFile[FS]:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> DriveFile[FS]:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> DriveFile[FS]:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> DriveFile[FS]:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[DriveFile[FS]]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[DriveFile[FS]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[DriveFile[FS]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[DriveFile[FS]]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[DriveFile[FS]]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, DriveFile[FS]]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, DriveFile[FS]]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[DriveFile[FS]]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[DriveFile[FS]]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> DriveFile[FS]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> DriveFile[FS]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> DriveFile[FS]:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> DriveFile[FS]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> DriveFile[FS]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> DriveFile[FS]:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[DriveFile[FS]]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> DriveFile[FS]:
    """
    ...
    """
        ...
    def afterMake(self) -> DriveFile[FS]:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> DriveFile[FS]:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[DriveFile[FS]]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> DriveFile[FS]:
    """
    ...
    """
        ...
    def withFileName(self, fileName: str) -> DriveFile[FS]:
    """
    Changes file name in this instance.
    """
        ...
    def withFileExt(self, fileExt: str) -> DriveFile[FS]:
    """
    ...
    """
        ...
    def identify(self, suffix: str=None) -> DriveFile[FS]:
    """
    ...
    """
        ...
    def readMetadata(self, spec: FileOperationSpec=None) -> DriveFile[FS]:
    """
    ...
    """
        ...
    def refreshMetadata(self, spec: FileOperationSpec=None) -> DriveFile[FS]:
    """
    ...
    """
        ...
    def guessMetadata(self, spec: FileOperationSpec=None) -> DriveFile[FS]:
    """
    ...
    """
        ...
    def clearMetadata(self) -> DriveFile[FS]:
    """
    Clears the content metadata; e.g. if it's known to be invalid.
    """
        ...
    def withMetadata(self, meta: ContentMeta=None) -> DriveFile[FS]:
    """
    ...
    """
        ...
    def encodedPushStream(self, spec: FileOperationSpec=None) -> Pair[DriveFile[FS], BytePushStream]:
    """
    ...
    """
        ...
    def pushStream(self, spec: FileOperationSpec=None) -> Pair[DriveFile[FS], BytePushStream]:
    """
    @return byte push stream to be used for writing un-encoded data into this content object.
    """
        ...
    def charPushStream(self, spec: FileOperationSpec=None) -> Pair[DriveFile[FS], CharPushStream]:
    """
    @return character push stream to be used for writing un-encoded data into this content object.
    """
        ...
    def encodedStream(self, spec: FileOperationSpec=None) -> Union[Pair[DriveFile[FS], ByteStream]]:
    """
    ...
    """
        ...
    def writeStream(self, content: ByteStream, spec: FileOperationSpec=None) -> DriveFile[FS]:
    """
    ...
    """
        ...
    def writeInputStream(self, inputStream: Any, spec: FileOperationSpec=None) -> DriveFile[FS]:
    """
    Truncates file and replaces it's content with provided binary content.
    """
        ...
    def writeZipInputStream(self, zipInputStream: Any, spec: FileOperationSpec=None) -> DriveFile[FS]:
    """
    Truncates file and replaces its content with provided binary content from zipInputStream
    """
        ...
    def writeEncodedStream(self, encodedContent: ByteStream, spec: FileOperationSpec=None) -> DriveFile[FS]:
    """
    ...
    """
        ...
    def writeEncodedInputStream(self, inputStream: Any, spec: FileOperationSpec=None) -> DriveFile[FS]:
    """
    Truncates file and replaces it's encoded content with provided binary content.
    """
        ...
    def write(self, content: any, spec: FileOperationSpec=None) -> DriveFile[FS]:
    """
    Truncates file and replaces it's content with provided binary content.
    ...
    """
        ...
    def writeEncoded(self, encodedContent: any, spec: FileOperationSpec=None) -> DriveFile[FS]:
    """
    Truncates file and replaces it's encoded content with provided binary content.
    ...
    """
        ...
    def writeString(self, content: str, spec: FileOperationSpec=None) -> DriveFile[FS]:
    """
    ...
    """
        ...
    def writeObj(self, obj: Obj, spec: FileObjsOperSpec=None) -> DriveFile[FS]:
    """
    ...
    """
        ...
    def startWriteObjs(self, spec: FileObjsOperSpec=None) -> Pair[DriveFile[FS], PushStream[Obj]]:
    """
    Serializes content from a list of c3 objects into a file.
    ...
    """
        ...
    def compress(self, contentEncoding: str=None, spec: FileCompressSpec=None) -> DriveFile[FS]:
    """
    ...
    """
        ...
    def uncompress(self, spec: FileCompressSpec=None) -> DriveFile[FS]:
    """
    Uncompresses file. Removes compression specific extension.
    """
        ...
    def transcode(self, contentType: str, contentEncoding: str, spec: FileCompressSpec=None) -> DriveFile[FS]:
    """
    ...
    """
        ...
    def copyContentTo(self, target: DriveFile[FS], spec: FileOperationSpec=None) -> None:
    """
    ...
    """
        ...
    @overload
    def concat(self, other: Content) -> DriveFile[FS]:
    """
    Creates a new Content by merging the two contents
    """
        ...
    @overload
    def concat(self, other: any) -> DriveFile[FS]:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[DriveFile[FS]]:
    """
