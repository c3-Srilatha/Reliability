...
from c3.platform.CacheQueueEntry import CacheQueueEntry
...
# Python definitions for the C3 type CacheQueue


class CacheQueue(InvalidationQueue[CacheQueueEntry], MergeableInvalidationQueue[CacheQueueEntry], Value):
    """
    Invalidation queue for cache invalidation processing.  Each entry is for processing a single invalidation entry
    {@link CacheQueueEntry}.
    
    @remarks this represents a made instance of CacheQueue
    """
    def __init__(self) -> None: ...

    @classmethod
    def compute(cls, targetType: Type, entries: Array[CacheQueueEntry]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, spec: InvalidationQueue.FindSpec=None) -> Union[Array[CacheQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def findStream(cls, spec: InvalidationQueue.FindStreamSpec=None) -> Union[Stream[CacheQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def clearEntries(cls, entries: Array[CacheQueueEntry]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def mergeContexts(cls, targetType: Type=None, entries: Array[CacheQueueEntry]=None) -> Union[Array[CacheQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def submitCacheEvent(cls, message: CacheMessage, autoCommit: bool='true') -> None:
    """
    Submits an event to the cache queue for invalidation processing.
    
    @param message
              Message for submitting cache invalidation event with specific argument values {@see CacheMessage.arguments}.
    @param autoCommit
