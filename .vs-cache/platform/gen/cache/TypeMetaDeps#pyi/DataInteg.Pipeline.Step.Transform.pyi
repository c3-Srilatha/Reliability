...
from c3.platform.DataInteg.Pipeline.Step.Config import DataInteg.Pipeline.Step.Config
...
# Python definitions for the C3 type DataInteg.Pipeline.Step.Transform


class Transform(DataInteg.Pipeline.Step[DataInteg.Pipeline.Step.Config]):
    """
    This step is responsible for transforming data using a {@link Transform}
    
    @remarks this represents a made instance of DataInteg.Pipeline.Step.Transform
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[DataInteg.Pipeline.Step.Transform]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataInteg.Pipeline.Step.Transform]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataInteg.Pipeline.Step.Transform]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataInteg.Pipeline.Step.Transform:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> DataInteg.Pipeline.Step.Transform:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> DataInteg.Pipeline.Step.Transform:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> DataInteg.Pipeline.Step.Transform:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> DataInteg.Pipeline.Step.Transform:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> DataInteg.Pipeline.Step.Transform:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> DataInteg.Pipeline.Step.Transform:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[DataInteg.Pipeline.Step.Transform]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[DataInteg.Pipeline.Step.Transform]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[DataInteg.Pipeline.Step.Transform]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, DataInteg.Pipeline.Step.Transform]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, DataInteg.Pipeline.Step.Transform]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[DataInteg.Pipeline.Step.Transform]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> DataInteg.Pipeline.Step.Transform:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    """
        ...
    def afterMake(self) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[DataInteg.Pipeline.Step.Transform]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    """
        ...
    def config(self, secrets: bool=None) -> DataInteg.Pipeline.Step.Config:
    """
    ...
    """
        ...
    @classmethod
    def typeConfig(cls) -> DataInteg.Pipeline.Step.Config:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[DataInteg.Pipeline.Step.Transform]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[DataInteg.Pipeline.Step.Transform]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[DataInteg.Pipeline.Step.Transform]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    """
        ...
    def getCached(self) -> Union[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    """
        ...
    def refreshCache(self) -> Union[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[DataInteg.Pipeline.Step.Transform]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, DataInteg.Pipeline.Step.Transform]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, DataInteg.Pipeline.Step.Transform]]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[DataInteg.Pipeline.Step.Transform]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[DataInteg.Pipeline.Step.Transform]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[DataInteg.Pipeline.Step.Transform], spec: UpsertSpec=None) -> Union[ObjList[DataInteg.Pipeline.Step.Transform]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[DataInteg.Pipeline.Step.Transform], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[DataInteg.Pipeline.Step.Transform]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: DataInteg.Pipeline.Step.Transform=None, spec: UpsertSpec=None) -> Union[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: DataInteg.Pipeline.Step.Transform=None, spec: UpsertSpec=None) -> Union[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[DataInteg.Pipeline.Step.Transform], srcObjs: Array[DataInteg.Pipeline.Step.Transform]=None, spec: UpsertSpec=None) -> Union[ObjList[DataInteg.Pipeline.Step.Transform]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[DataInteg.Pipeline.Step.Transform]]], spec: UpsertSpec=None) -> Union[ObjList[DataInteg.Pipeline.Step.Transform]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[DataInteg.Pipeline.Step.Transform], srcObjs: Array[DataInteg.Pipeline.Step.Transform]=None, spec: UpsertSpec=None) -> Union[ObjList[DataInteg.Pipeline.Step.Transform]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[DataInteg.Pipeline.Step.Transform]]], spec: UpsertSpec=None) -> Union[ObjList[DataInteg.Pipeline.Step.Transform]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[DataInteg.Pipeline.Step.Transform], spec: TouchSpec=None) -> Union[ObjList[DataInteg.Pipeline.Step.Transform]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[DataInteg.Pipeline.Step.Transform], spec: MergeSpec=None) -> Union[ObjList[DataInteg.Pipeline.Step.Transform]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[DataInteg.Pipeline.Step.Transform], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[DataInteg.Pipeline.Step.Transform]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[DataInteg.Pipeline.Step.Transform]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[DataInteg.Pipeline.Step.Transform]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: DataInteg.Pipeline.Step.Transform, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: DataInteg.Pipeline.Step.Transform, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[DataInteg.Pipeline.Step.Transform], spec: UpsertSpec=None) -> Union[ObjList[DataInteg.Pipeline.Step.Transform]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[DataInteg.Pipeline.Step.Transform], spec: UpsertSpec=None) -> Union[ObjList[DataInteg.Pipeline.Step.Transform]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[DataInteg.Pipeline.Step.Transform]) -> ObjList[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[DataInteg.Pipeline.Step.Transform]) -> ObjList[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[DataInteg.Pipeline.Step.Transform]) -> ObjList[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[DataInteg.Pipeline.Step.Transform]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[DataInteg.Pipeline.Step.Transform]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[DataInteg.Pipeline.Step.Transform]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[DataInteg.Pipeline.Step.Transform]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[DataInteg.Pipeline.Step.Transform]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[DataInteg.Pipeline.Step.Transform]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: DataInteg.Pipeline.Step.Transform=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[DataInteg.Pipeline.Step.Transform], callback: Callable[[Union[DataInteg.Pipeline.Step.Transform]], Union[DataInteg.Pipeline.Step.Transform]]=None) -> ObjList[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[DataInteg.Pipeline.Step.Transform], callback: Callable[[Union[DataInteg.Pipeline.Step.Transform]], Union[DataInteg.Pipeline.Step.Transform]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    def publish(self, subPath: str=None, contentType: str=None) -> DataInteg.Pipeline.Step.Transform:
    """
    ...
    """
        ...
    @classmethod
    def removeSeedDataBatch(cls, objs: Array[SeedData]=None, spec: UpsertSpec=None) -> Union[ObjList[DataInteg.Pipeline.Step.Transform]]:
    """
    ...
    """
        ...
    def createSeedData(self, spec: UpsertSpec=None) -> Union[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    """
        ...
    @classmethod
    def createSeedDataBatch(cls, objs: Array[SeedData]=None, spec: UpsertSpec=None) -> Union[ObjList[DataInteg.Pipeline.Step.Transform]]:
    """
    ...
    """
        ...
    def updateSeedData(self, srcObj: SeedData=None, spec: UpsertSpec=None) -> Union[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    """
        ...
    @classmethod
    def updateSeedDataBatch(cls, objs: Array[SeedData]=None, srcObjs: Array[SeedData]=None, spec: UpsertSpec=None) -> Union[ObjList[DataInteg.Pipeline.Step.Transform]]:
    """
    ...
    """
        ...
    def clearUserUpdates(self, spec: MergeSpec=None) -> Union[DataInteg.Pipeline.Step.Transform]:
    """
    ...
    """
        ...
    @classmethod
    def clearUserUpdatesBatch(cls, objs: Array[SeedData]=None, spec: MergeSpec=None) -> Union[ObjList[DataInteg.Pipeline.Step.Transform]]:
    """
    ...
    """
        ...
    def dependencies(self) -> Union[SeedDataDeps[DataInteg.Pipeline.Step.Transform]]:
        ...
