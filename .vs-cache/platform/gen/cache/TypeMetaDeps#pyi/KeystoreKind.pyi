...
# Python definitions for the C3 type KeystoreKind
...
class KeystoreKind():
    ...
    JKS: Optional[str]=None
    """
    Java KeyStore
    """

    JCEKS: Optional[str]=None
    """
    ...
    BKS: Optional[str]=None
    """
    Bouncy Castle KeyStore
    """

    BKS_V1: Optional[str]=None
    """
    ...
    """
    def __init__(self, JKS: Optional[str]=None, JCEKS: Optional[str]=None, PKCS12: Optional[str]=None, BKS: Optional[str]=None, BKS_V1: Optional[str]=None, UBER: Optional[str]=None) -> None: ...
