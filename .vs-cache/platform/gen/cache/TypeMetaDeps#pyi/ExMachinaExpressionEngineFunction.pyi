...
# Python definitions for the C3 type ExMachinaExpressionEngineFunction


class ExMachinaExpressionEngineFunction(ExpressionEngineFunction, Value):
    """
    This type includes all expression engine functions used by any ExMachina types
    to calculate fields at runtime - provides a functional parallel to calc fields.
    
    @remarks this represents a made instance of ExMachinaExpressionEngineFunction
    """
    ...
    **Note on ML applications**
    ...
    """
        ...
    @classmethod
    def isCurrentUser(cls, userId: str=None) -> bool:
    """
    Custom expression engine function to calculate whether a given {@link User}
    is the currently logged in {@link User}
    @param userId
             The current owner of the shared entity
    """
        ...
