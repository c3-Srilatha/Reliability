...
# Python definitions for the C3 type JsServerTester


class JsServerTester(Tester):
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> JsServerTester:
    """
    ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> JsServerTester:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> JsServerTester:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> JsServerTester:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[JsServerTester]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[JsServerTester]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[JsServerTester]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[JsServerTester]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> JsServerTester:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> JsServerTester:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> JsServerTester:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[JsServerTester]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[JsServerTester]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> JsServerTester:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> JsServerTester:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> JsServerTester:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> JsServerTester:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> JsServerTester:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> JsServerTester:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> JsServerTester:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> JsServerTester:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> JsServerTester:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> JsServerTester:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> JsServerTester:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> JsServerTester:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> JsServerTester:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> JsServerTester:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> JsServerTester:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> JsServerTester:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> JsServerTester:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> JsServerTester:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> JsServerTester:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> JsServerTester:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> JsServerTester:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> JsServerTester:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> JsServerTester:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> JsServerTester:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> JsServerTester:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> JsServerTester:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> JsServerTester:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> JsServerTester:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[JsServerTester]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[JsServerTester]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[JsServerTester]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[JsServerTester]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[JsServerTester]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, JsServerTester]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, JsServerTester]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[JsServerTester]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[JsServerTester]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> JsServerTester:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> JsServerTester:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> JsServerTester:
    """
    ...
    """
        ...
    def afterMake(self) -> JsServerTester:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> JsServerTester:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[JsServerTester]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> JsServerTester:
    """
    ...
    """
        ...
    @overload
    def setField(self, field: str, value: Any, doNotConvert: bool=None) -> JsServerTester:
    """
    ...
    """
        ...
    @overload
    def setField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> JsServerTester:
    """
    Sets the mutable field value. The name must correspond to an existing field defined on this type or its mixins.
    The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    @classmethod
    def forPathAndEngine(cls, path: str, engine: str) -> JsServerTester:
    """
    ...
    """
        ...
    @classmethod
    def forNameAndEngine(cls, testName: str, engine: str) -> JsServerTester:
    """
    ...
    """
        ...
    @classmethod
    def forEngine(cls, engine: str, deep: bool=None) -> JsServerTester:
    """
    ...
    """
        ...
    def run(self, spec: TesterRunSpec=None) -> JsServerTester:
    """
    ...
    """
        ...
    def cancel(self) -> JsServerTester:
    """
    ...
    """
        ...
    def evaluateTestSuite(self, code: str=None, sourceName: str=None) -> None:
    """
