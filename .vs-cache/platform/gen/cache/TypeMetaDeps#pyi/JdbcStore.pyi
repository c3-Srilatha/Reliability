...
from c3.platform.JdbcConnectionPool import JdbcConnectionPool
...
from c3.platform.UserJdbcCredentials import UserJdbcCredentials

# Python definitions for the C3 type JdbcStore


class JdbcStore(SqlStore[JdbcConnectionPool, JdbcStoreConfig, JdbcCredentials]):
    """
    ...
    connectionPool: Optional[JdbcConnectionPool]
    """
    ...
    def __init__(self, name: Optional[str]=None, SQL: Optional[str]=None, KV: Optional[str]=None, sqlEngineName: Optional[str]=None, connectionPool: Optional[JdbcConnectionPool]=None, maxSharableAgeMinutes: Optional[int]=None, readOnlyConns: Optional[Any]=None, invalidReadOnlyConns: Optional[Any]=None, invalidConns: Optional[Any]=None, nextReadOnlyConnIndex: Optional[Any]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[JdbcStore]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[JdbcStore]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[JdbcStore]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[JdbcStore]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> JdbcStore:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> JdbcStore:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> JdbcStore:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[JdbcStore]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[JdbcStore]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> JdbcStore:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> JdbcStore:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> JdbcStore:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> JdbcStore:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> JdbcStore:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> JdbcStore:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> JdbcStore:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> JdbcStore:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> JdbcStore:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> JdbcStore:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> JdbcStore:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> JdbcStore:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> JdbcStore:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> JdbcStore:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> JdbcStore:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> JdbcStore:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> JdbcStore:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> JdbcStore:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> JdbcStore:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> JdbcStore:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> JdbcStore:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> JdbcStore:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> JdbcStore:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> JdbcStore:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> JdbcStore:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> JdbcStore:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> JdbcStore:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> JdbcStore:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[JdbcStore]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[JdbcStore]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[JdbcStore]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[JdbcStore]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[JdbcStore]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, JdbcStore]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, JdbcStore]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[JdbcStore]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[JdbcStore]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> JdbcStore:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> JdbcStore:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> JdbcStore:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> JdbcStore:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> JdbcStore:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> JdbcStore:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[JdbcStore]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> JdbcStore:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> JdbcStore:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[JdbcStore]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> JdbcStore:
    """
    ...
    """
        ...
    def config(self, secrets: bool=None) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    @classmethod
    def typeConfig(cls) -> JdbcStoreConfig:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[JdbcStore]:
    """
    ...
    """
        ...
    @classmethod
    def forName(cls, name: str, failIfMissing: bool=None) -> Union[JdbcStore]:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[JdbcStore]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[JdbcStore]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[JdbcStore]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[JdbcStore]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[JdbcStore]:
    """
    ...
    """
        ...
    def getCached(self) -> Union[JdbcStore]:
    """
    ...
    """
        ...
    def refreshCache(self) -> Union[JdbcStore]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, JdbcStore]]:
    """
    ...
    """
        ...
    def setCredentials(self, cred: JdbcCredentials, override: str=None, failIfMissing: bool=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def init(cls, name: str) -> JdbcStore:
    """
    ...
    """
        ...
    def initPools(self, cfg: JdbcStoreConfig, creds: JdbcCredentials) -> JdbcStore:
    """
    ...
    """
        ...
    def poolKey(self, cfg: JdbcStoreConfig, creds: JdbcCredentials) -> str:
    """
