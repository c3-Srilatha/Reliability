...
# Python definitions for the C3 type CryptoPublicKey


class CryptoPublicKey(CryptoKey):
    """
    The public key of an asymmetric key pair.
    
    @remarks this represents a made instance of CryptoPublicKey
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[CryptoPublicKey]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[CryptoPublicKey]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[CryptoPublicKey]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[CryptoPublicKey]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> CryptoPublicKey:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> CryptoPublicKey:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> CryptoPublicKey:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[CryptoPublicKey]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[CryptoPublicKey]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> CryptoPublicKey:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> CryptoPublicKey:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> CryptoPublicKey:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> CryptoPublicKey:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> CryptoPublicKey:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> CryptoPublicKey:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> CryptoPublicKey:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> CryptoPublicKey:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> CryptoPublicKey:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> CryptoPublicKey:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> CryptoPublicKey:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> CryptoPublicKey:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> CryptoPublicKey:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> CryptoPublicKey:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> CryptoPublicKey:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> CryptoPublicKey:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> CryptoPublicKey:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> CryptoPublicKey:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> CryptoPublicKey:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> CryptoPublicKey:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> CryptoPublicKey:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> CryptoPublicKey:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> CryptoPublicKey:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> CryptoPublicKey:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> CryptoPublicKey:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> CryptoPublicKey:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> CryptoPublicKey:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> CryptoPublicKey:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[CryptoPublicKey]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[CryptoPublicKey]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[CryptoPublicKey]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[CryptoPublicKey]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[CryptoPublicKey]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, CryptoPublicKey]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, CryptoPublicKey]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[CryptoPublicKey]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[CryptoPublicKey]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> CryptoPublicKey:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> CryptoPublicKey:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> CryptoPublicKey:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> CryptoPublicKey:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> CryptoPublicKey:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> CryptoPublicKey:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[CryptoPublicKey]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> CryptoPublicKey:
    """
    ...
    """
        ...
    def afterMake(self) -> CryptoPublicKey:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> CryptoPublicKey:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[CryptoPublicKey]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> CryptoPublicKey:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[CryptoPublicKey]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[CryptoPublicKey]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[CryptoPublicKey]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[CryptoPublicKey]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[CryptoPublicKey]:
    """
    Returns cached instance by key, with secrets removed.
    """
        ...
    def getCached(self) -> Union[CryptoPublicKey]:
    """
    ...
    """
        ...
    def refreshCache(self) -> Union[CryptoPublicKey]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[CryptoPublicKey]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, CryptoPublicKey]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, CryptoPublicKey]]:
    """
    ...
    """
        ...
    def getConfig(self) -> CryptoPublicKey:
    """
    ...
    """
        ...
    def getSecret(self) -> CryptoPublicKey:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[CryptoPublicKey]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[CryptoPublicKey]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: CryptoPublicKey, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: CryptoPublicKey, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[CryptoPublicKey]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[CryptoPublicKey]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[CryptoPublicKey]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> CryptoPublicKey:
        ...
    @classmethod
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[CryptoPublicKey]:
    """
    ...
    """
        ...
    @classmethod
    def fromJwk(cls, jwk: str, failIfInvalid: bool=None) -> CryptoPublicKey:
    """
