...
from c3.platform.AzureDataLakeAnalyticsStorageAccountInformation import AzureDataLakeAnalyticsStorageAccountInformation
from c3.platform.WaitSpec import WaitSpec
from c3.platform.AzureDataLakeAnalyticsDataLakeStoreAccountInformation import AzureDataLakeAnalyticsDataLakeStoreAccountInformation
...
from c3.platform.AzureDataLakeAnalyticsAccountFields import AzureDataLakeAnalyticsAccountFields
...
from c3.platform.AzureDataLakeAnalyticsComputePolicy import AzureDataLakeAnalyticsComputePolicy
from c3.platform.AzureDataLakeAnalyticsFirewallRule import AzureDataLakeAnalyticsFirewallRule
...
# Python definitions for the C3 type AzureDataLakeAnalyticsAccount


class AzureDataLakeAnalyticsAccount(AzureGenericResource, AzureDataLakeAnalyticsAccountFields):
    """
    @remarks this represents a made instance of AzureDataLakeAnalyticsAccount
    """
    ...
    systemMaxJobCount: Optional[int]=None

    maxJobCount: Optional[int]=None

    queryStoreRetention: Optional[int]=None

    firewallState: Optional[str]=None

    dataLakeStoreAccounts: Optional[Array[AzureDataLakeAnalyticsDataLakeStoreAccountInformation]]=None

    defaultDataLakeStoreAccount: Optional[str]=None

    type_: Optional[str]=None

    systemMaxDegreeOfParallelism: Optional[int]=None

    endpoint: Optional[str]=None

    minPriorityPerJob: Optional[int]=None

    maxDegreeOfParallelismPerJob: Optional[int]=None

    newTier: Optional[str]=None

    id_: Optional[str]=None

    firewallAllowAzureIps: Optional[str]=None

    computePolicies: Optional[Array[AzureDataLakeAnalyticsComputePolicy]]=None

    storageAccounts: Optional[Array[AzureDataLakeAnalyticsStorageAccountInformation]]=None
    ...
    maxDegreeOfParallelism: Optional[int]=None

    name_: Optional[str]=None

    location: Optional[str]=None

    firewallRules: Optional[Array[AzureDataLakeAnalyticsFirewallRule]]=None
    def __init__(self, id: Optional[str]=None, cluster: Optional[str]=None, env: Optional[str]=None, app: Optional[str]=None, func: Optional[str]=None, role: Optional[str]=None, seq: Optional[str]=None, subseq: Optional[str]=None, resourceId: Optional[str]=None, resourceSecondaryId: Optional[str]=None, resourceName: Optional[str]=None, resourceGroupName: Optional[str]=None, fullyConfigured: Optional[bool]=None, resourceNamespace: Optional[str]=None, external: Optional[bool]=None, credentials: Optional[AzureCredentials]=None, hasGeneratedResourceName: Optional[bool]=None, hasGeneratedResourceSecondaryId: Optional[bool]=None, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, nativeMetricByName: Optional[Map[str, str]]=None, tags: Optional[Array[CloudTag]]=None, description: Optional[str]=None, parentResource: Optional[CloudResource]=None, resourceGroup: Optional[AzureResourceGroup]=None, state: Optional[str]=None, lastModifiedTime: Optional[datetime]=None, creationTime: Optional[datetime]=None, systemMaxJobCount: Optional[int]=None, maxJobCount: Optional[int]=None, queryStoreRetention: Optional[int]=None, firewallState: Optional[str]=None, dataLakeStoreAccounts: Optional[Array[AzureDataLakeAnalyticsDataLakeStoreAccountInformation]]=None, defaultDataLakeStoreAccount: Optional[str]=None, type_: Optional[str]=None, systemMaxDegreeOfParallelism: Optional[int]=None, endpoint: Optional[str]=None, minPriorityPerJob: Optional[int]=None, maxDegreeOfParallelismPerJob: Optional[int]=None, newTier: Optional[str]=None, id_: Optional[str]=None, firewallAllowAzureIps: Optional[str]=None, computePolicies: Optional[Array[AzureDataLakeAnalyticsComputePolicy]]=None, storageAccounts: Optional[Array[AzureDataLakeAnalyticsStorageAccountInformation]]=None, provisioningState: Optional[str]=None, currentTier: Optional[str]=None, tags_: Optional[Map[str, str]]=None, accountId: Optional[str]=None, maxDegreeOfParallelism: Optional[int]=None, name_: Optional[str]=None, location: Optional[str]=None, firewallRules: Optional[Array[AzureDataLakeAnalyticsFirewallRule]]=None) -> None: ...
    ...
    @overload
    @classmethod
    def fromString(cls, s: str) -> Union[AzureDataLakeAnalyticsAccount]:
    """
    ...
    @overload
    @classmethod
    def fromString(cls, s: str, failIfInvalid: bool=None) -> Union[AzureDataLakeAnalyticsAccount]:
    """
    Constructs Cloud Resource instance with reference fields and credentials based on provided Cloud Reference string.
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[AzureDataLakeAnalyticsAccount]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[AzureDataLakeAnalyticsAccount]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[AzureDataLakeAnalyticsAccount]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[AzureDataLakeAnalyticsAccount]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[AzureDataLakeAnalyticsAccount]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AzureDataLakeAnalyticsAccount]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AzureDataLakeAnalyticsAccount]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AzureDataLakeAnalyticsAccount:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> AzureDataLakeAnalyticsAccount:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> AzureDataLakeAnalyticsAccount:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> AzureDataLakeAnalyticsAccount:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> AzureDataLakeAnalyticsAccount:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> AzureDataLakeAnalyticsAccount:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> AzureDataLakeAnalyticsAccount:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[AzureDataLakeAnalyticsAccount]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[AzureDataLakeAnalyticsAccount]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[AzureDataLakeAnalyticsAccount]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[AzureDataLakeAnalyticsAccount]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[AzureDataLakeAnalyticsAccount]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, AzureDataLakeAnalyticsAccount]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, AzureDataLakeAnalyticsAccount]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[AzureDataLakeAnalyticsAccount]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[AzureDataLakeAnalyticsAccount]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> AzureDataLakeAnalyticsAccount:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    def afterMake(self) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[AzureDataLakeAnalyticsAccount]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[AzureDataLakeAnalyticsAccount]:
    """
    Find Cloud Resource in Cloud Provider based on provided C3 canonical identifier.
    """
        ...
    @classmethod
    def fromClusterId(cls, clusterId: str, env: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AzureDataLakeAnalyticsAccount:
    """
    Construct a cloud ID from a cluster ID
    """
        ...
    @classmethod
    def fromEnvId(cls, envId: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    @classmethod
    def fromAppId(cls, appId: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    def withDefaultId(self) -> AzureDataLakeAnalyticsAccount:
    """
    Populate default values for all uninitialized Cloud Identifier fields in this Cloud Resource.
    """
        ...
    def sanitize(self) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    @classmethod
    def fromId(cls, id: str, failIfInvalid: bool=None) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    @classmethod
    def fromCloudId(cls, id: CloudId, failIfInvalid: bool=None) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    @classmethod
    def fromCloudRef(cls, ref: CloudRef, failIfInvalid: bool=None) -> AzureDataLakeAnalyticsAccount:
    """
    Constructs Cloud Resource instance with reference fields and credentials based on provided Cloud Reference.
    """
        ...
    @classmethod
    def fromCloudFunc(cls, func: str, role: str=None, seq: str=None) -> AzureDataLakeAnalyticsAccount:
    """
    Constructs Cloud Resource instance based on provided Cloud Func component and optional role.
    """
        ...
    @classmethod
    def fromResourceId(cls, resourceId: str) -> AzureDataLakeAnalyticsAccount:
    """
    Constructs Cloud Resource instance based on provided Cloud Resource Id.
    """
        ...
    @classmethod
    def fromResourceSecondaryId(cls, resourceSecondaryId: str) -> AzureDataLakeAnalyticsAccount:
    """
    Constructs Cloud Resource instance based on provided Cloud Resource Secondary Id and available Cloud Configuration.
    """
        ...
    @classmethod
    def fromResourceName(cls, name: str) -> AzureDataLakeAnalyticsAccount:
    """
    Constructs Cloud Resource instance based on provided Cloud Resource Name and available Cloud Configuration.
    """
        ...
    @classmethod
    def fromReferenceField(cls, fieldName: str, value: str, failIfInvalid: bool=None) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    def fromConfigTemplate(self, spec: CloudResourceOperationSpec=None) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    def withDefaultConfig(self, spec: CloudResourceOperationSpec=None) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    def upsertResource(self, spec: CloudResourceOperationSpec=None) -> AzureDataLakeAnalyticsAccount:
    """
    Create or update Cloud Resource.
    """
        ...
    def upsertWithDependencies(self, spec: CloudResourceOperationSpec=None) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[AzureDataLakeAnalyticsAccount]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[AzureDataLakeAnalyticsAccount]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[AzureDataLakeAnalyticsAccount]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[AzureDataLakeAnalyticsAccount]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[AzureDataLakeAnalyticsAccount]:
    """
    Returns cached instance by key, with secrets removed.
    """
        ...
    def getCached(self) -> Union[AzureDataLakeAnalyticsAccount]:
    """
    This method on any CloudResource is not supported! Use CloudResource.for* or other methods instead.
    """
        ...
    def refreshCache(self) -> Union[AzureDataLakeAnalyticsAccount]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[AzureDataLakeAnalyticsAccount]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, AzureDataLakeAnalyticsAccount]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, AzureDataLakeAnalyticsAccount]]:
    """
    ...
    """
        ...
    def getConfig(self) -> AzureDataLakeAnalyticsAccount:
    """
    This method on any CloudResource is not supported! Use CloudResource.for* or other methods instead.
    """
        ...
    ...
    """
        ...
    def getSecret(self) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[AzureDataLakeAnalyticsAccount]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[AzureDataLakeAnalyticsAccount]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: AzureDataLakeAnalyticsAccount, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: AzureDataLakeAnalyticsAccount, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[AzureDataLakeAnalyticsAccount]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[AzureDataLakeAnalyticsAccount]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[AzureDataLakeAnalyticsAccount]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    def withIdentity(self, resource: CloudResource=None, spec: CloudResourceOperationSpec=None) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    def mergeId(self, other: CloudResource=None) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    @classmethod
    def forCloudId(cls, id: CloudId, failIfMissing: bool=None) -> Union[AzureDataLakeAnalyticsAccount]:
    """
    ...
    """
        ...
    @classmethod
    def forCloudFunc(cls, func: str, role: str=None, failIfMissing: bool=None) -> AzureDataLakeAnalyticsAccount:
    """
    Find Cloud Resource based on provided cloud func component and optional role.
    """
        ...
    @classmethod
    def forCloudRole(cls, role: str, failIfMissing: bool=None) -> AzureDataLakeAnalyticsAccount:
    """
    Find Cloud Resource of this type based on provided cloud role component.
    """
        ...
    @classmethod
    def forResourceId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AzureDataLakeAnalyticsAccount]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def forResourceSecondaryId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AzureDataLakeAnalyticsAccount]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forResourceName(cls, resourceName: str, failIfMissing: bool=None) -> Union[AzureDataLakeAnalyticsAccount]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def findResource(cls, reference: str, failIfMissing: bool=None) -> Union[AzureDataLakeAnalyticsAccount]:
    """
    Find Cloud Resource in the Cloud Provider by provided {@link CloudRef} string.
    """
        ...
    def getResource(self) -> Union[AzureDataLakeAnalyticsAccount]:
    """
    Find Cloud Resource in the Cloud Provider by provided #resourceId, #resourceSecondaryId, #resourceName or #tags
    (in that order).
    """
        ...
    def ensureResource(self) -> AzureDataLakeAnalyticsAccount:
    """
    Checks that the resource is persisted. If not, upserts the resource, to ensure that the resource exists.
    """
        ...
    @classmethod
    def listResourcesBySubtype(cls, spec: CloudListResourcesSpec=None) -> Map[str, CloudListResourcesResult[AzureDataLakeAnalyticsAccount]]:
    """
    ...
    """
        ...
    @classmethod
    def listResources(cls, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureDataLakeAnalyticsAccount]:
    """
    ...
    """
        ...
    @classmethod
    def listResourcesForTags(cls, *keyValuePairs: Array[str]) -> CloudListResourcesResult[AzureDataLakeAnalyticsAccount]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForClusterId(cls, clusterId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureDataLakeAnalyticsAccount]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForEnvId(cls, envId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureDataLakeAnalyticsAccount]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForAppId(cls, appId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureDataLakeAnalyticsAccount]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    def upsertDependencies(self, spec: CloudResourceOperationSpec=None) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    def waitForCreate(self, spec: WaitSpec=None) -> Union[AzureDataLakeAnalyticsAccount]:
    """
    ...
    """
        ...
    @classmethod
    def tagResourcesBatch(cls, resources: Array[AzureDataLakeAnalyticsAccount], tags: Array[CloudTag]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    @classmethod
    def untagResourcesBatch(cls, resources: Array[AzureDataLakeAnalyticsAccount], tagKeys: Array[str]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    def waitForOk(self, spec: WaitSpec=None) -> Union[AzureDataLakeAnalyticsAccount]:
    """
    ...
    """
        ...
    def waitForState(self, state: str='AVAILABLE', spec: WaitSpec=None) -> Union[AzureDataLakeAnalyticsAccount]:
    """
    ...
    """
        ...
    def setFullyConfigured(self, fullyConfigured: bool=None, override: str=None) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    def afterCreate(self, input: AzureDataLakeAnalyticsAccount=None) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    def beforeCreate(self) -> AzureDataLakeAnalyticsAccount:
    """
    Optional callback to alter resource before creating it.
    """
        ...
    def beforeUpdate(self) -> AzureDataLakeAnalyticsAccount:
    """
    Optional callback to alter resource before updating it.
    """
        ...
    def beforeDestroy(self) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    def withoutNonModifiableFields(self) -> AzureDataLakeAnalyticsAccount:
    """
    ...
    """
        ...
    @classmethod
    def fromImpl(cls, impl: Any=None) -> Union[AzureDataLakeAnalyticsAccount]:
    """
    ...
    """
        ...
    @classmethod
    def fromJava(cls, javaObj: Any) -> Union[AzureDataLakeAnalyticsAccountFields]:
        ...
