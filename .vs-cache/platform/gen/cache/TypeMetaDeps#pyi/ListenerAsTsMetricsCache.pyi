...
# Python definitions for the C3 type ListenerAsTsMetricsCache


class ListenerAsTsMetricsCache(MetadataCacheOld[ListenerAsTsMetricsCacheEntry], Value):
    """
    ...
    @classmethod
    def get(cls, key: str) -> Union[ListenerAsTsMetricsCacheEntry]:
    """
    ...
    """
        ...
    @classmethod
    def require(cls, key: str) -> ListenerAsTsMetricsCacheEntry:
    """
    ...
    """
        ...
    @classmethod
    def put(cls, key: str, value: ListenerAsTsMetricsCacheEntry) -> None:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[ListenerAsTsMetricsCacheEntry]:
    """
    ...
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, ListenerAsTsMetricsCacheEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def release(cls, key: str, value: ListenerAsTsMetricsCacheEntry) -> None:
    """
    ...
    """
        ...
    @classmethod
    def validate(cls, value: ListenerAsTsMetricsCacheEntry) -> bool:
    """
    ...
    """
        ...
    @classmethod
    def metrics(cls) -> ListenerAsTsMetricsCacheEntry:
    """
    @return all metrics used by analytics or metrics listener
    """
        ...
    @classmethod
    def isAsTsHeaderType(cls, type: Type) -> bool:
    """
