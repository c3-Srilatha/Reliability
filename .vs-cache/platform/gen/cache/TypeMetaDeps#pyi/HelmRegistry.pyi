...
# Python definitions for the C3 type HelmRegistry
...
class HelmRegistry(Registry):
    ...
    def __init__(self, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, username: Optional[str]=None, password: Optional[str]=None, secretKey: Optional[str]=None, properties: Optional[Map[str, Any]]=None, secretProperties: Optional[Map[str, Any]]=None, url: Optional[str]=None, serverEndpoint: Optional[str]=None, port: Optional[int]=None, id: Optional[str]=None, DEFAULT_NAME: Optional[str]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[HelmRegistry]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[HelmRegistry]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[HelmRegistry]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[HelmRegistry]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> HelmRegistry:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> HelmRegistry:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> HelmRegistry:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[HelmRegistry]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[HelmRegistry]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> HelmRegistry:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> HelmRegistry:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> HelmRegistry:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> HelmRegistry:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> HelmRegistry:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> HelmRegistry:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> HelmRegistry:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> HelmRegistry:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> HelmRegistry:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> HelmRegistry:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> HelmRegistry:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> HelmRegistry:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> HelmRegistry:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> HelmRegistry:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> HelmRegistry:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> HelmRegistry:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> HelmRegistry:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> HelmRegistry:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> HelmRegistry:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> HelmRegistry:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> HelmRegistry:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> HelmRegistry:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> HelmRegistry:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> HelmRegistry:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> HelmRegistry:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> HelmRegistry:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> HelmRegistry:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> HelmRegistry:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[HelmRegistry]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[HelmRegistry]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[HelmRegistry]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[HelmRegistry]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[HelmRegistry]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, HelmRegistry]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, HelmRegistry]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[HelmRegistry]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[HelmRegistry]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> HelmRegistry:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> HelmRegistry:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> HelmRegistry:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> HelmRegistry:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> HelmRegistry:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> HelmRegistry:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[HelmRegistry]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> HelmRegistry:
    """
    ...
    """
        ...
    def afterMake(self) -> HelmRegistry:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> HelmRegistry:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[HelmRegistry]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> HelmRegistry:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[HelmRegistry]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[HelmRegistry]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[HelmRegistry]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[HelmRegistry]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[HelmRegistry]:
    """
    Returns cached instance by key, with secrets removed.
    """
        ...
    def getCached(self) -> Union[HelmRegistry]:
    """
    ...
    """
        ...
    def refreshCache(self) -> Union[HelmRegistry]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[HelmRegistry]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, HelmRegistry]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, HelmRegistry]]:
    """
    ...
    """
        ...
    def getConfig(self) -> HelmRegistry:
    """
    ...
    """
        ...
    def getSecret(self) -> HelmRegistry:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[HelmRegistry]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[HelmRegistry]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: HelmRegistry, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: HelmRegistry, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[HelmRegistry]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[HelmRegistry]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[HelmRegistry]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> HelmRegistry:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[HelmRegistry]:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[HelmRegistry]:
    """
    @return single instance of this Identified type by id.
    """
        ...
    @classmethod
    def inst(cls) -> HelmRegistry:
    """
    ...
    """
        ...
    def fetchAndStoreChart(self, location: str, version: str) -> File:
    """
