...
# Python definitions for the C3 type DataGrid.NumberStyle
...
class NumberStyle():
    ...
    """
    def __init__(self, SIGNIFICANT: Optional[str]=None, FIXED: Optional[str]=None, EXPONENTIAL: Optional[str]=None, NATURAL: Optional[str]=None) -> None: ...
