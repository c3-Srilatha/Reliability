...
from c3.platform.BatchQueueEntry import BatchQueueEntry
...
# Python definitions for the C3 type BatchQueue


class BatchQueue(InvalidationQueue[BatchQueueEntry], CancelableInvalidationQueue, Value):
    """
    ...
    @classmethod
    def compute(cls, targetType: Type, entries: Array[BatchQueueEntry]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, spec: InvalidationQueue.FindSpec=None) -> Union[Array[BatchQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def findStream(cls, spec: InvalidationQueue.FindStreamSpec=None) -> Union[Stream[BatchQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def clearEntries(cls, entries: Array[BatchQueueEntry]) -> None:
    """
