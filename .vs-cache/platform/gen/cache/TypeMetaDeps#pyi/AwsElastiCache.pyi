...
from c3.platform.AwsElastiCacheNode import AwsElastiCacheNode
...
# Python definitions for the C3 type AwsElastiCache


class AwsElastiCache(AwsResource):
    """
    ...
    @remarks this represents a made instance of AwsElastiCache
    """
    ...
    readReplicasPerShard: Optional[int]=None
    """
    This is a Redis only parameter and will be ignored for Memcached cluster operations.
    ...
    securityGroupIds: Optional[Array[str]]=None
    """
    A list of VPC Security Groups to be associated with the cluster.
    """

    isMultiAz: Optional[bool]=None
    """
    ...
    @overload
    @classmethod
    def fromString(cls, s: str) -> Union[AwsElastiCache]:
    """
    ...
    @overload
    @classmethod
    def fromString(cls, s: str, failIfInvalid: bool=None) -> Union[AwsElastiCache]:
    """
    Constructs Cloud Resource instance with reference fields and credentials based on provided Cloud Reference string.
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[AwsElastiCache]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> AwsElastiCache:
    """
    ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> AwsElastiCache:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> AwsElastiCache:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> AwsElastiCache:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[AwsElastiCache]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[AwsElastiCache]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[AwsElastiCache]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[AwsElastiCache]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> AwsElastiCache:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AwsElastiCache:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AwsElastiCache:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AwsElastiCache]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AwsElastiCache]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> AwsElastiCache:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AwsElastiCache:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AwsElastiCache:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> AwsElastiCache:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> AwsElastiCache:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> AwsElastiCache:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> AwsElastiCache:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> AwsElastiCache:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> AwsElastiCache:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> AwsElastiCache:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> AwsElastiCache:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> AwsElastiCache:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> AwsElastiCache:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> AwsElastiCache:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> AwsElastiCache:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> AwsElastiCache:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> AwsElastiCache:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> AwsElastiCache:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> AwsElastiCache:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> AwsElastiCache:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> AwsElastiCache:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> AwsElastiCache:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> AwsElastiCache:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> AwsElastiCache:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> AwsElastiCache:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> AwsElastiCache:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> AwsElastiCache:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> AwsElastiCache:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[AwsElastiCache]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[AwsElastiCache]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[AwsElastiCache]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[AwsElastiCache]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[AwsElastiCache]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, AwsElastiCache]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, AwsElastiCache]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[AwsElastiCache]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[AwsElastiCache]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> AwsElastiCache:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> AwsElastiCache:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> AwsElastiCache:
    """
    ...
    """
        ...
    def afterMake(self) -> AwsElastiCache:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> AwsElastiCache:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[AwsElastiCache]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> AwsElastiCache:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[AwsElastiCache]:
    """
    Find Cloud Resource in Cloud Provider based on provided C3 canonical identifier.
    """
        ...
    @classmethod
    def fromClusterId(cls, clusterId: str, env: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AwsElastiCache:
    """
    Construct a cloud ID from a cluster ID
    """
        ...
    @classmethod
    def fromEnvId(cls, envId: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AwsElastiCache:
    """
    ...
    """
        ...
    @classmethod
    def fromAppId(cls, appId: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AwsElastiCache:
    """
    ...
    """
        ...
    @classmethod
    def fromId(cls, id: str, failIfInvalid: bool=None) -> AwsElastiCache:
    """
    ...
    """
        ...
    @classmethod
    def fromCloudId(cls, id: CloudId, failIfInvalid: bool=None) -> AwsElastiCache:
    """
    ...
    """
        ...
    def fromConfigTemplate(self, spec: CloudResourceOperationSpec=None) -> AwsElastiCache:
    """
    ...
    """
        ...
    def withDefaultConfig(self, spec: CloudResourceOperationSpec=None) -> AwsElastiCache:
    """
    ...
    """
        ...
    def upsertResource(self, spec: CloudResourceOperationSpec=None) -> AwsElastiCache:
    """
    Create or update Cloud Resource.
    """
        ...
    def upsertWithDependencies(self, spec: CloudResourceOperationSpec=None) -> AwsElastiCache:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[AwsElastiCache]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[AwsElastiCache]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[AwsElastiCache]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[AwsElastiCache]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[AwsElastiCache]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, AwsElastiCache]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, AwsElastiCache]]:
    """
    ...
    """
        ...
    def getConfig(self) -> AwsElastiCache:
    """
    This method on any CloudResource is not supported! Use CloudResource.for* or other methods instead.
    """
        ...
    ...
    """
        ...
    def getSecret(self) -> AwsElastiCache:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[AwsElastiCache]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[AwsElastiCache]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: AwsElastiCache, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: AwsElastiCache, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[AwsElastiCache]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[AwsElastiCache]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[AwsElastiCache]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> AwsElastiCache:
    """
    ...
    """
        ...
    def withIdentity(self, resource: CloudResource=None, spec: CloudResourceOperationSpec=None) -> AwsElastiCache:
    """
    ...
    """
        ...
    def mergeId(self, other: CloudResource=None) -> AwsElastiCache:
    """
    ...
    """
        ...
    @classmethod
    def forCloudId(cls, id: CloudId, failIfMissing: bool=None) -> Union[AwsElastiCache]:
    """
    ...
    """
        ...
    @classmethod
    def forCloudFunc(cls, func: str, role: str=None, failIfMissing: bool=None) -> AwsElastiCache:
    """
    Find Cloud Resource based on provided cloud func component and optional role.
    """
        ...
    @classmethod
    def forCloudRole(cls, role: str, failIfMissing: bool=None) -> AwsElastiCache:
    """
    Find Cloud Resource of this type based on provided cloud role component.
    """
        ...
    @classmethod
    def forResourceId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AwsElastiCache]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def forResourceSecondaryId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AwsElastiCache]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forResourceName(cls, resourceName: str, failIfMissing: bool=None) -> Union[AwsElastiCache]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def findResource(cls, reference: str, failIfMissing: bool=None) -> Union[AwsElastiCache]:
    """
    Find Cloud Resource in the Cloud Provider by provided {@link CloudRef} string.
    """
        ...
    def getResource(self) -> Union[AwsElastiCache]:
    """
    Find Cloud Resource in the Cloud Provider by provided #resourceId, #resourceSecondaryId, #resourceName or #tags
    (in that order).
    """
        ...
    def ensureResource(self) -> AwsElastiCache:
    """
    Checks that the resource is persisted. If not, upserts the resource, to ensure that the resource exists.
    """
        ...
    @classmethod
    def listResourcesBySubtype(cls, spec: CloudListResourcesSpec=None) -> Map[str, CloudListResourcesResult[AwsElastiCache]]:
    """
    ...
    """
        ...
    @classmethod
    def listResources(cls, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AwsElastiCache]:
    """
    ...
    """
        ...
    @classmethod
    def listResourcesForTags(cls, *keyValuePairs: Array[str]) -> CloudListResourcesResult[AwsElastiCache]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForClusterId(cls, clusterId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AwsElastiCache]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForEnvId(cls, envId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AwsElastiCache]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForAppId(cls, appId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AwsElastiCache]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    def upsertDependencies(self, spec: CloudResourceOperationSpec=None) -> AwsElastiCache:
    """
    ...
    """
        ...
    def waitForCreate(self, spec: WaitSpec=None) -> Union[AwsElastiCache]:
    """
    ...
    """
        ...
    @classmethod
    def tagResourcesBatch(cls, resources: Array[AwsElastiCache], tags: Array[CloudTag]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    @classmethod
    def untagResourcesBatch(cls, resources: Array[AwsElastiCache], tagKeys: Array[str]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    def waitForOk(self, spec: WaitSpec=None) -> Union[AwsElastiCache]:
    """
    ...
    """
        ...
    def waitForState(self, state: str='AVAILABLE', spec: WaitSpec=None) -> Union[AwsElastiCache]:
    """
    ...
    """
        ...
    def setFullyConfigured(self, fullyConfigured: bool=None, override: str=None) -> AwsElastiCache:
    """
    ...
    """
        ...
    def afterCreate(self, input: AwsElastiCache=None) -> AwsElastiCache:
    """
    ...
    """
        ...
    def beforeCreate(self) -> AwsElastiCache:
    """
    Optional callback to alter resource before creating it.
    """
        ...
    def beforeUpdate(self) -> AwsElastiCache:
    """
    Optional callback to alter resource before updating it.
    """
        ...
    def beforeDestroy(self) -> AwsElastiCache:
    """
    ...
    """
        ...
    def withoutNonModifiableFields(self) -> AwsElastiCache:
    """
    ...
    """
        ...
    def withResourceArn(self, resourceArn: str) -> Union[AwsElastiCache]:
    """
    ...
    """
        ...
    def nodes(self) -> Union[Array[AwsElastiCacheNode]]:
    """
    The current state of the nodes.
    """
        ...
    def created(self) -> Union[datetime]:
    """
    The date and time when the cluster was created.
    """
        ...
    def rebootNode(self, nodeId: str) -> None:
    """
    ...
    """
        ...
    def createReplicatedCluster(self) -> AwsElastiCache:
    """
    Internal method to create replicated cluster
    """
        ...
    def createNonReplicatedCluster(self) -> AwsElastiCache:
    """
    Internal method to create replicated cluster
    """
        ...
    def listReplicatedClusters(self) -> Union[Array[AwsElastiCache]]:
    """
    Internal method to list all replicated cluster
    """
        ...
    def listNonReplicatedClusters(self) -> Union[Array[AwsElastiCache]]:
    """
    Internal method to list all replicated cluster
    """
        ...
    def rebootReplicatedCluster(self) -> None:
    """
    Internal method to reboot replicated cluster
    """
        ...
    def rebootNonReplicatedCluster(self) -> None:
    """
    Internal method to reboot non replicated cluster
    """
        ...
    def replicatedClusterStatus(self) -> str:
    """
    Internal method to get status of  replicated cluster
    """
        ...
    def nonReplicatedClusterStatus(self) -> str:
    """
    Internal method to get status of non replicated cluster
    """
        ...
    def replicatedCluster(self) -> Union[AwsElastiCache]:
    """
    Internal method to get replicated cluster info
    """
        ...
    def nonReplicatedCluster(self) -> Union[AwsElastiCache]:
    """
    Internal method to get non replicated cluster info
    """
        ...
    def rebootReplicatedClusterNode(self, nodeId: str) -> None:
    """
    Internal method to reboot replicated cluster node
    """
        ...
    def rebootNonReplicatedClusterNode(self, nodeId: str) -> None:
    """
    Internal method to get reboot non replicated cluster node
    """
        ...
    def replicatedClusterNodes(self) -> Union[Array[AwsElastiCacheNode]]:
    """
    Get node info for a replicated cluster
    """
        ...
    def nonReplicatedClusterNodes(self) -> Union[Array[AwsElastiCacheNode]]:
    """
    Get node info for a non replicated cluster
    """
        ...
    def replicatedClusterCreatedTime(self) -> Union[datetime]:
    """
    Get creation time of a replicated cluster
    """
        ...
    def nonReplicatedClusterCreatedTime(self) -> Union[datetime]:
    """
    Get creation time of a non replicated cluster
    """
        ...
    def deleteReplicatedCluster(self, deletePrimary: bool='true') -> None:
    """
    Delete replicated cluster
    """
        ...
    def deleteNonReplicatedCluster(self) -> None:
    """
