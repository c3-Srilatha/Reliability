...
from c3.platform.AwsOpsWorksRecipes import AwsOpsWorksRecipes
...
# Python definitions for the C3 type AwsOpsWorksLayer


class AwsOpsWorksLayer(AwsResource, AwsSecurityGroupsMember, AwsEc2InstancesMember):
    """
    This type provides an interface to the AWS *OpsWorks Layer* service;
    see the [AWS documentation](http://docs.aws.amazon.com/opsworks/latest/userguide/workinglayers.html).
    
    @remarks this represents a made instance of AwsOpsWorksLayer
    """
    ...
    isAutoAssignElasticIps: Optional[bool]=None
    """
    Whether to automatically assign an Elastic IP address to the layer's instances.
    """

    isAutoAssignPublicIps: Optional[bool]=None
    """
    ...
    customRecipes: Optional[AwsOpsWorksRecipes]=None
    """
    A LayerCustomRecipes object that specifies the layer custom recipes.
    """

    isEnableAutoHealing: Optional[bool]=None
    """
    Whether to disable auto healing for the layer.
    """

    isInstallUpdatesOnBoot: Optional[bool]=None
    """
    Whether to install operating system and package updates when the instance boots.
    """

    pkgs: Optional[Array[str]]=None
    """
    ...
    """
    For custom layers only, use this parameter to specify the layer's short name, which is used internally by AWS OpsWorks and by Chef recipes.
    """
    ...
    @overload
    @classmethod
    def fromString(cls, s: str) -> Union[AwsOpsWorksLayer]:
    """
    ...
    @overload
    @classmethod
    def fromString(cls, s: str, failIfInvalid: bool=None) -> Union[AwsOpsWorksLayer]:
    """
    Constructs Cloud Resource instance with reference fields and credentials based on provided Cloud Reference string.
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[AwsOpsWorksLayer]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> AwsOpsWorksLayer:
    """
    ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> AwsOpsWorksLayer:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> AwsOpsWorksLayer:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[AwsOpsWorksLayer]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[AwsOpsWorksLayer]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[AwsOpsWorksLayer]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[AwsOpsWorksLayer]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AwsOpsWorksLayer]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AwsOpsWorksLayer]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AwsOpsWorksLayer:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> AwsOpsWorksLayer:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> AwsOpsWorksLayer:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> AwsOpsWorksLayer:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> AwsOpsWorksLayer:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> AwsOpsWorksLayer:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> AwsOpsWorksLayer:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[AwsOpsWorksLayer]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[AwsOpsWorksLayer]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[AwsOpsWorksLayer]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[AwsOpsWorksLayer]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[AwsOpsWorksLayer]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, AwsOpsWorksLayer]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, AwsOpsWorksLayer]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[AwsOpsWorksLayer]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[AwsOpsWorksLayer]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> AwsOpsWorksLayer:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    def afterMake(self) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[AwsOpsWorksLayer]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[AwsOpsWorksLayer]:
    """
    Find Cloud Resource in Cloud Provider based on provided C3 canonical identifier.
    """
        ...
    @classmethod
    def fromClusterId(cls, clusterId: str, env: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AwsOpsWorksLayer:
    """
    Construct a cloud ID from a cluster ID
    """
        ...
    @classmethod
    def fromEnvId(cls, envId: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    @classmethod
    def fromAppId(cls, appId: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    @classmethod
    def fromId(cls, id: str, failIfInvalid: bool=None) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    @classmethod
    def fromCloudId(cls, id: CloudId, failIfInvalid: bool=None) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    def fromConfigTemplate(self, spec: CloudResourceOperationSpec=None) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    def withDefaultConfig(self, spec: CloudResourceOperationSpec=None) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    def upsertResource(self, spec: CloudResourceOperationSpec=None) -> AwsOpsWorksLayer:
    """
    Create or update Cloud Resource.
    """
        ...
    def upsertWithDependencies(self, spec: CloudResourceOperationSpec=None) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[AwsOpsWorksLayer]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[AwsOpsWorksLayer]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[AwsOpsWorksLayer]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[AwsOpsWorksLayer]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[AwsOpsWorksLayer]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, AwsOpsWorksLayer]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, AwsOpsWorksLayer]]:
    """
    ...
    """
        ...
    def getConfig(self) -> AwsOpsWorksLayer:
    """
    This method on any CloudResource is not supported! Use CloudResource.for* or other methods instead.
    """
        ...
    ...
    """
        ...
    def getSecret(self) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[AwsOpsWorksLayer]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[AwsOpsWorksLayer]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: AwsOpsWorksLayer, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: AwsOpsWorksLayer, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[AwsOpsWorksLayer]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[AwsOpsWorksLayer]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[AwsOpsWorksLayer]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    def withIdentity(self, resource: CloudResource=None, spec: CloudResourceOperationSpec=None) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    def mergeId(self, other: CloudResource=None) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    @classmethod
    def forCloudId(cls, id: CloudId, failIfMissing: bool=None) -> Union[AwsOpsWorksLayer]:
    """
    ...
    """
        ...
    @classmethod
    def forCloudFunc(cls, func: str, role: str=None, failIfMissing: bool=None) -> AwsOpsWorksLayer:
    """
    Find Cloud Resource based on provided cloud func component and optional role.
    """
        ...
    @classmethod
    def forCloudRole(cls, role: str, failIfMissing: bool=None) -> AwsOpsWorksLayer:
    """
    Find Cloud Resource of this type based on provided cloud role component.
    """
        ...
    @classmethod
    def forResourceId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AwsOpsWorksLayer]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def forResourceSecondaryId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AwsOpsWorksLayer]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forResourceName(cls, resourceName: str, failIfMissing: bool=None) -> Union[AwsOpsWorksLayer]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def findResource(cls, reference: str, failIfMissing: bool=None) -> Union[AwsOpsWorksLayer]:
    """
    Find Cloud Resource in the Cloud Provider by provided {@link CloudRef} string.
    """
        ...
    def getResource(self) -> Union[AwsOpsWorksLayer]:
    """
    Find Cloud Resource in the Cloud Provider by provided #resourceId, #resourceSecondaryId, #resourceName or #tags
    (in that order).
    """
        ...
    def ensureResource(self) -> AwsOpsWorksLayer:
    """
    Checks that the resource is persisted. If not, upserts the resource, to ensure that the resource exists.
    """
        ...
    @classmethod
    def listResourcesBySubtype(cls, spec: CloudListResourcesSpec=None) -> Map[str, CloudListResourcesResult[AwsOpsWorksLayer]]:
    """
    ...
    """
        ...
    @classmethod
    def listResources(cls, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AwsOpsWorksLayer]:
    """
    ...
    """
        ...
    @classmethod
    def listResourcesForTags(cls, *keyValuePairs: Array[str]) -> CloudListResourcesResult[AwsOpsWorksLayer]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForClusterId(cls, clusterId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AwsOpsWorksLayer]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForEnvId(cls, envId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AwsOpsWorksLayer]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForAppId(cls, appId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AwsOpsWorksLayer]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    def upsertDependencies(self, spec: CloudResourceOperationSpec=None) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    def waitForCreate(self, spec: WaitSpec=None) -> Union[AwsOpsWorksLayer]:
    """
    ...
    """
        ...
    @classmethod
    def tagResourcesBatch(cls, resources: Array[AwsOpsWorksLayer], tags: Array[CloudTag]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    @classmethod
    def untagResourcesBatch(cls, resources: Array[AwsOpsWorksLayer], tagKeys: Array[str]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    def waitForOk(self, spec: WaitSpec=None) -> Union[AwsOpsWorksLayer]:
    """
    ...
    """
        ...
    def waitForState(self, state: str='AVAILABLE', spec: WaitSpec=None) -> Union[AwsOpsWorksLayer]:
    """
    ...
    """
        ...
    def setFullyConfigured(self, fullyConfigured: bool=None, override: str=None) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    def afterCreate(self, input: AwsOpsWorksLayer=None) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    def beforeCreate(self) -> AwsOpsWorksLayer:
    """
    Optional callback to alter resource before creating it.
    """
        ...
    def beforeUpdate(self) -> AwsOpsWorksLayer:
    """
    Optional callback to alter resource before updating it.
    """
        ...
    def beforeDestroy(self) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    def withoutNonModifiableFields(self) -> AwsOpsWorksLayer:
    """
    ...
    """
        ...
    def withResourceArn(self, resourceArn: str) -> Union[AwsOpsWorksLayer]:
    """
    ...
    """
    Get the status of a specific instance in the layer, eg. "assigning", "running_setup", and "setup_failed"
    @param ec2InstanceId
