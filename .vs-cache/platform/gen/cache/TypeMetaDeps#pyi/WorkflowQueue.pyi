...
from c3.platform.WorkflowQueueEntry import WorkflowQueueEntry
...
# Python definitions for the C3 type WorkflowQueue


class WorkflowQueue(InvalidationQueue[WorkflowQueueEntry], Value):
    """
    Invalidation queue for workflow processing.  Each entry is for processing a single {@link WorkflowV7}.
    
    @see WorkflowQueueEntry
    
    @remarks this represents a made instance of WorkflowQueue
    """
    def __init__(self) -> None: ...

    @classmethod
    def compute(cls, targetType: Type, entries: Array[WorkflowQueueEntry]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, spec: InvalidationQueue.FindSpec=None) -> Union[Array[WorkflowQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def findStream(cls, spec: InvalidationQueue.FindStreamSpec=None) -> Union[Stream[WorkflowQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def clearEntries(cls, entries: Array[WorkflowQueueEntry]) -> None:
    """
