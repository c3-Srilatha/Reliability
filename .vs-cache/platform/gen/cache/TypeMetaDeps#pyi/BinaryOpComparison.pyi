...
# Python definitions for the C3 type BinaryOpComparison


class BinaryOpComparison():
    """
    Operator grouping of binary operators which perform arithmetic operations. These operators all share the same
    parameters within each {@link StdLib} subtype.
    
    @remarks this represents a made instance of BinaryOpComparison
    """
    ...
    """
    def __init__(self, EQ: Optional[str]=None, GT: Optional[str]=None, GE: Optional[str]=None, LT: Optional[str]=None, LE: Optional[str]=None, NE: Optional[str]=None) -> None: ...
