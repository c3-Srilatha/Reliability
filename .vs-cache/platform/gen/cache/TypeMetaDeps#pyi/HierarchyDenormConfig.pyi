...
# Python definitions for the C3 type HierarchyDenormConfig


class HierarchyDenormConfig(Config, Identifiable):
    """
    ...
    invalidationBatchSize: Optional[int]=None
    """
    ...
    scheduleBatchWeight: Optional[int]=None
    """
    Max number nodes allowed in a particular schedule batch for denormalization.
    
    @see HierarchyDenormOption
    """
    def __init__(self, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, id: Optional[str]=None, disabled: Optional[bool]=None, invalidationBatchSize: Optional[int]=None, scheduleBatchSize: Optional[int]=None, scheduleBatchWeight: Optional[int]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[HierarchyDenormConfig]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[HierarchyDenormConfig]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[HierarchyDenormConfig]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[HierarchyDenormConfig]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> HierarchyDenormConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> HierarchyDenormConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> HierarchyDenormConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[HierarchyDenormConfig]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[HierarchyDenormConfig]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> HierarchyDenormConfig:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> HierarchyDenormConfig:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> HierarchyDenormConfig:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> HierarchyDenormConfig:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> HierarchyDenormConfig:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> HierarchyDenormConfig:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> HierarchyDenormConfig:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> HierarchyDenormConfig:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> HierarchyDenormConfig:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> HierarchyDenormConfig:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> HierarchyDenormConfig:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> HierarchyDenormConfig:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> HierarchyDenormConfig:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> HierarchyDenormConfig:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> HierarchyDenormConfig:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> HierarchyDenormConfig:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> HierarchyDenormConfig:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> HierarchyDenormConfig:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> HierarchyDenormConfig:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> HierarchyDenormConfig:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> HierarchyDenormConfig:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> HierarchyDenormConfig:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> HierarchyDenormConfig:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> HierarchyDenormConfig:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> HierarchyDenormConfig:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> HierarchyDenormConfig:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> HierarchyDenormConfig:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> HierarchyDenormConfig:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[HierarchyDenormConfig]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[HierarchyDenormConfig]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[HierarchyDenormConfig]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[HierarchyDenormConfig]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[HierarchyDenormConfig]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, HierarchyDenormConfig]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, HierarchyDenormConfig]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[HierarchyDenormConfig]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[HierarchyDenormConfig]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> HierarchyDenormConfig:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> HierarchyDenormConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> HierarchyDenormConfig:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> HierarchyDenormConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> HierarchyDenormConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> HierarchyDenormConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[HierarchyDenormConfig]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> HierarchyDenormConfig:
    """
    ...
    """
        ...
    def afterMake(self) -> HierarchyDenormConfig:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> HierarchyDenormConfig:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[HierarchyDenormConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> HierarchyDenormConfig:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[HierarchyDenormConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[HierarchyDenormConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[HierarchyDenormConfig]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[HierarchyDenormConfig]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[HierarchyDenormConfig]:
    """
    Returns cached instance by key, with secrets removed.
    """
        ...
    def getCached(self) -> Union[HierarchyDenormConfig]:
    """
    ...
    """
        ...
    def refreshCache(self) -> Union[HierarchyDenormConfig]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[HierarchyDenormConfig]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, HierarchyDenormConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, HierarchyDenormConfig]]:
    """
    ...
    """
        ...
    def getConfig(self) -> HierarchyDenormConfig:
    """
    ...
    """
        ...
    def getSecret(self) -> HierarchyDenormConfig:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[HierarchyDenormConfig]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[HierarchyDenormConfig]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: HierarchyDenormConfig, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: HierarchyDenormConfig, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[HierarchyDenormConfig]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[HierarchyDenormConfig]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[HierarchyDenormConfig]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> HierarchyDenormConfig:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[HierarchyDenormConfig]:
    """
