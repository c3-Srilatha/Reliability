...
from c3.platform.ChangeLogSummaryResult import ChangeLogSummaryResult
...
# Python definitions for the C3 type ChangeLogQueue


class ChangeLogQueue(InvalidationQueue[ChangeLogQueueEntry], MergeableInvalidationQueue[ChangeLogQueueEntry], Value):
    """
    ...
    @classmethod
    def compute(cls, targetType: Type, entries: Array[ChangeLogQueueEntry]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, spec: InvalidationQueue.FindSpec=None) -> Union[Array[ChangeLogQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def findStream(cls, spec: InvalidationQueue.FindStreamSpec=None) -> Union[Stream[ChangeLogQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def clearEntries(cls, entries: Array[ChangeLogQueueEntry]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def mergeContexts(cls, targetType: Type=None, entries: Array[ChangeLogQueueEntry]=None) -> Union[Array[ChangeLogQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def summary(cls) -> Union[Array[ChangeLogSummaryResult]]:
    """
