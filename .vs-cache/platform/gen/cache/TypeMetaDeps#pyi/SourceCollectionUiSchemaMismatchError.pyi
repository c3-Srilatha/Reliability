...
# Python definitions for the C3 type SourceCollectionUiSchemaMismatchError


class SourceCollectionUiSchemaMismatchError():
    """
    ...
    FIELD_LOCAL_ONLY: Optional[str]=None
    """
    Whether the field's name only exists in the local source collection
    """

    FIELD_REMOTE_ONLY: Optional[str]=None
    """
    Whether the field's name only exists in the remote source collection
    """

    FIELD_DATA_TYPE_MISMATCH: Optional[str]=None
    """
    Whether the field's data type differs between the local and remote source collection
    """
    def __init__(self, FIELD_LOCAL_ONLY: Optional[str]=None, FIELD_REMOTE_ONLY: Optional[str]=None, FIELD_DATA_TYPE_MISMATCH: Optional[str]=None) -> None: ...
