...
from c3.platform.SecretKey import SecretKey
...
# Python definitions for the C3 type SymmetricCipherConfig


class SymmetricCipherConfig(Config):
    """
    ...
    keyForHash: Optional[SecretKey]=None
    """
    Long term key used for hashing the data.
    """

    activeKek: Optional[SecretKey]=None
    """
    Active key encryption key(Kek)
    """

    inactiveKek: Optional[SecretKey]=None
    """
    Inactive key encryption key(Kek)
    """

    deletedKek: Optional[SecretKey]=None
    """
    Key encryption key(Kek) which is deleted.
    """
    def __init__(self, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, dekValidity: Optional[str]=None, dekPoolSize: Optional[float]=None, keyForHash: Optional[SecretKey]=None, activeKek: Optional[SecretKey]=None, inactiveKek: Optional[SecretKey]=None, deletedKek: Optional[SecretKey]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[SymmetricCipherConfig]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[SymmetricCipherConfig]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[SymmetricCipherConfig]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[SymmetricCipherConfig]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> SymmetricCipherConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> SymmetricCipherConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> SymmetricCipherConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[SymmetricCipherConfig]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[SymmetricCipherConfig]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> SymmetricCipherConfig:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> SymmetricCipherConfig:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> SymmetricCipherConfig:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> SymmetricCipherConfig:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> SymmetricCipherConfig:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> SymmetricCipherConfig:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> SymmetricCipherConfig:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> SymmetricCipherConfig:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> SymmetricCipherConfig:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> SymmetricCipherConfig:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> SymmetricCipherConfig:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> SymmetricCipherConfig:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> SymmetricCipherConfig:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> SymmetricCipherConfig:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> SymmetricCipherConfig:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> SymmetricCipherConfig:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> SymmetricCipherConfig:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> SymmetricCipherConfig:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> SymmetricCipherConfig:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> SymmetricCipherConfig:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> SymmetricCipherConfig:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> SymmetricCipherConfig:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> SymmetricCipherConfig:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> SymmetricCipherConfig:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> SymmetricCipherConfig:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> SymmetricCipherConfig:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> SymmetricCipherConfig:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> SymmetricCipherConfig:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[SymmetricCipherConfig]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[SymmetricCipherConfig]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[SymmetricCipherConfig]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[SymmetricCipherConfig]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[SymmetricCipherConfig]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, SymmetricCipherConfig]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, SymmetricCipherConfig]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[SymmetricCipherConfig]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[SymmetricCipherConfig]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> SymmetricCipherConfig:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> SymmetricCipherConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> SymmetricCipherConfig:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> SymmetricCipherConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> SymmetricCipherConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> SymmetricCipherConfig:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> SymmetricCipherConfig:
    """
    ...
    """
        ...
    def afterMake(self) -> SymmetricCipherConfig:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> SymmetricCipherConfig:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[SymmetricCipherConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> SymmetricCipherConfig:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[SymmetricCipherConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[SymmetricCipherConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[SymmetricCipherConfig]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[SymmetricCipherConfig]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[SymmetricCipherConfig]:
    """
    Returns cached instance by key, with secrets removed.
    """
        ...
    def getCached(self) -> Union[SymmetricCipherConfig]:
    """
    ...
    """
        ...
    def refreshCache(self) -> Union[SymmetricCipherConfig]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[SymmetricCipherConfig]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, SymmetricCipherConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, SymmetricCipherConfig]]:
    """
    ...
    """
        ...
    def getConfig(self) -> SymmetricCipherConfig:
    """
    ...
    """
        ...
    def getSecret(self) -> SymmetricCipherConfig:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[SymmetricCipherConfig]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[SymmetricCipherConfig]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: SymmetricCipherConfig, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: SymmetricCipherConfig, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[SymmetricCipherConfig]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[SymmetricCipherConfig]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[SymmetricCipherConfig]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> SymmetricCipherConfig:
    """
