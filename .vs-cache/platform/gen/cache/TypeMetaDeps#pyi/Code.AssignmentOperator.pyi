...
# Python definitions for the C3 type Code.AssignmentOperator


class AssignmentOperator(Code.Operator):
    """
    A "assignment expression" represents setting a variable or field to an expression. Assignments can update the
    current value using operators like `+` (add to the current value). This enum list all possible assignment operators.
    
    @see Code.Assignment
    @see https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Expressions_and_Operators#assignment_operators
    
    @remarks this represents a made instance of Code.AssignmentOperator
    """
    ...
    WALRUS: Optional[str]=None
    def __init__(self, NEG: Optional[str]=None, POS: Optional[str]=None, NOT: Optional[str]=None, INVERT: Optional[str]=None, INC: Optional[str]=None, DEC: Optional[str]=None, PARENS: Optional[str]=None, DELETE: Optional[str]=None, TYPEOF: Optional[str]=None, VOID: Optional[str]=None, ADD: Optional[str]=None, SUB: Optional[str]=None, MUL: Optional[str]=None, DIV: Optional[str]=None, MOD: Optional[str]=None, LSHIFT: Optional[str]=None, RSHIFT: Optional[str]=None, LRSHIFT: Optional[str]=None, BITAND: Optional[str]=None, BITOR: Optional[str]=None, BITXOR: Optional[str]=None, LOGAND: Optional[str]=None, LOGOR: Optional[str]=None, EQ: Optional[str]=None, NE: Optional[str]=None, LT: Optional[str]=None, LE: Optional[str]=None, GT: Optional[str]=None, GE: Optional[str]=None, EXP: Optional[str]=None, NULL: Optional[str]=None, FLOOR: Optional[str]=None, MATMUL: Optional[str]=None, EQSTRICT: Optional[str]=None, NESTRICT: Optional[str]=None, IS: Optional[str]=None, ISNOT: Optional[str]=None, IN: Optional[str]=None, NOTIN: Optional[str]=None, ASSIGN: Optional[str]=None, WALRUS: Optional[str]=None) -> None: ...
