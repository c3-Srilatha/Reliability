...
from c3.platform.MapReduceQueueEntry import MapReduceQueueEntry
...
# Python definitions for the C3 type MapReduceQueue


class MapReduceQueue(InvalidationQueue[MapReduceQueueEntry], CancelableInvalidationQueue, Value):
    """
    ...
    @classmethod
    def compute(cls, targetType: Type, entries: Array[MapReduceQueueEntry]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, spec: InvalidationQueue.FindSpec=None) -> Union[Array[MapReduceQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def findStream(cls, spec: InvalidationQueue.FindStreamSpec=None) -> Union[Stream[MapReduceQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def clearEntries(cls, entries: Array[MapReduceQueueEntry]) -> None:
    """
