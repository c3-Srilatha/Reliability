...
# Python definitions for the C3 type SqlMapReduceQueue


class SqlMapReduceQueue(MapReduceQueue, Value):
    """
    Invalidation queue for mapReduce job processing.
    
    @remarks this represents a made instance of SqlMapReduceQueue
    """
