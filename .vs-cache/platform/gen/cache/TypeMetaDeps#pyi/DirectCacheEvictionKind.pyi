...
# Python definitions for the C3 type DirectCacheEvictionKind


class DirectCacheEvictionKind():
    """
    @remarks this represents a made instance of DirectCacheEvictionKind
    """
    
    evictEntry: Optional[str]=None
    """
    Evict one entry matching a key
    """

    evictRegex: Optional[str]=None
    """
    ...
    emptyAll: Optional[str]=None
    """
    EmptyAll. Empty all contents without considering the context. For tenantTagAware caches, the whole cache in emptied.
    """
    def __init__(self, evictEntry: Optional[str]=None, evictRegex: Optional[str]=None, empty: Optional[str]=None, emptyAll: Optional[str]=None) -> None: ...
