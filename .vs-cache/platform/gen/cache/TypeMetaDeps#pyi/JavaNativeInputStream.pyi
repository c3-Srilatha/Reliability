...
# Python definitions for the C3 type JavaNativeInputStream


class JavaNativeInputStream(ByteStream, Value):
    """
    Native byte stream based on a Java input stream.
    
    @remarks this represents a made instance of JavaNativeInputStream
    """
    
    onClose: Optional[Callable[[Union[JavaNativeInputStream]]]]=None
    """
    Callback lambda on close of this stream
    """

    inputStream: Optional[Any]=None
    def __init__(self, onClose: Optional[Callable[[Union[JavaNativeInputStream]]]]=None, inputStream: Optional[Any]=None) -> None: ...

    @classmethod
    def fromHttpRequest(cls, req: HttpRequest) -> JavaNativeInputStream:
    """
    ...
    """
        ...
    def mapToSame(self, mapper: Callable[[Union[int]], Union[int]]) -> JavaNativeInputStream:
    """
    ...
    """
        ...
    @overload
    def mapBlocksToSame(self, mapper: Callable[[any], Union[any]]) -> JavaNativeInputStream:
    """
    ...
    """
        ...
    @overload
    def mapBlocksToSame(self, blockSize: int, mapper: Callable[[any], Union[any]]) -> JavaNativeInputStream:
    """
    Return another stream on top of this one that allows modification of each block via a lambda and returns a new
    stream of those modified blocks. The current stream will be closed once the returned stream is consumed.
    ...
    """
        ...
    def concat(self, other: BlockStream[int, any]) -> JavaNativeInputStream:
    """
    ...
    """
        ...
    @classmethod
    def make(cls, inputStream: Any, onClose: Callable[[Union[JavaNativeInputStream]]]=None) -> JavaNativeInputStream:
        ...
