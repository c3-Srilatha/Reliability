...
# Python definitions for the C3 type App.PublicKey


class PublicKey(CryptoPublicKey):
    """
    Type to represent an app's public key, which is used to verify signed tokens.
    
    @remarks this represents a made instance of App.PublicKey
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[App.PublicKey]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[App.PublicKey]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[App.PublicKey]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[App.PublicKey]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> App.PublicKey:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> App.PublicKey:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> App.PublicKey:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[App.PublicKey]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[App.PublicKey]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> App.PublicKey:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> App.PublicKey:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> App.PublicKey:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> App.PublicKey:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> App.PublicKey:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> App.PublicKey:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> App.PublicKey:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> App.PublicKey:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> App.PublicKey:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> App.PublicKey:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> App.PublicKey:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> App.PublicKey:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> App.PublicKey:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> App.PublicKey:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> App.PublicKey:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> App.PublicKey:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> App.PublicKey:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> App.PublicKey:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> App.PublicKey:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> App.PublicKey:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> App.PublicKey:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> App.PublicKey:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> App.PublicKey:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> App.PublicKey:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> App.PublicKey:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> App.PublicKey:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> App.PublicKey:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> App.PublicKey:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[App.PublicKey]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[App.PublicKey]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[App.PublicKey]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[App.PublicKey]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[App.PublicKey]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, App.PublicKey]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, App.PublicKey]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[App.PublicKey]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[App.PublicKey]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> App.PublicKey:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> App.PublicKey:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> App.PublicKey:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> App.PublicKey:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> App.PublicKey:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> App.PublicKey:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[App.PublicKey]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> App.PublicKey:
    """
    ...
    """
        ...
    def afterMake(self) -> App.PublicKey:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> App.PublicKey:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[App.PublicKey]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> App.PublicKey:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[App.PublicKey]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[App.PublicKey]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[App.PublicKey]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[App.PublicKey]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[App.PublicKey]:
    """
    Returns cached instance by key, with secrets removed.
    """
        ...
    def getCached(self) -> Union[App.PublicKey]:
    """
    ...
    """
        ...
    def refreshCache(self) -> Union[App.PublicKey]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[App.PublicKey]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, App.PublicKey]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, App.PublicKey]]:
    """
    ...
    """
        ...
    def getConfig(self) -> App.PublicKey:
    """
    ...
    """
        ...
    def getSecret(self) -> App.PublicKey:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[App.PublicKey]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[App.PublicKey]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: App.PublicKey, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: App.PublicKey, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[App.PublicKey]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[App.PublicKey]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[App.PublicKey]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> App.PublicKey:
        ...
    @classmethod
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[App.PublicKey]:
    """
    ...
    """
        ...
    @classmethod
    def fromJwk(cls, jwk: str, failIfInvalid: bool=None) -> App.PublicKey:
    """
