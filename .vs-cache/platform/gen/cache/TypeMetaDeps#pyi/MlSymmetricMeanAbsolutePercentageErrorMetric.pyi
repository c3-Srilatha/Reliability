...
# Python definitions for the C3 type MlSymmetricMeanAbsolutePercentageErrorMetric


class MlSymmetricMeanAbsolutePercentageErrorMetric(MlScoringMetricSupportingPd[Data, Data, { sampleWeights: Data }]):
    """
    {@link MlSymmetricMeanAbsolutePercentageErrorMetric Symmetric Mean Absolute Percentage Error (sMAPE)} metric
    computes the average absolute percentage error between the predicted value and target value relative to the sum of
    absolute values of predicted and target values. It is defined as follows:
    
    $\text{SMAPE} = \frac{1}{n}\sum_{t=1}^n \frac{\left\vert y_t - \hat{y}_t \right\vert}{\left\vert y_t \right\vert + \left\vert \hat{y}_t \right\vert}$
    
    This metric is primarily used in regression, specifically for forecasting problems, where under-forecasting and
    over-forecasting are equally damaging. In such cases {@link MlMeanAbsolutePercentageErrorMetric MAPE} does not
    provide an accurate assessment of the error. This reformulation caps both under-forecasting and over-forecasting
    to 100% and adjusts the metric to be symmetric.
    
    The `modelOutput` and `targetOutput` are expected to have the same shape.
    This metric supports `sampleWeights` as `context`. `sampleWeights` is single-dimensional with same number of samples
    as the `modelOutput`. It represents a per-sample weighting when aggregating for sMAPE calculation.
    
    @remarks this represents a made instance of MlSymmetricMeanAbsolutePercentageErrorMetric
    """
    ...
    """
    def __init__(self, name: Optional[str]=None, useIndex: Optional[bool]=None, batchSize: Optional[int]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[MlSymmetricMeanAbsolutePercentageErrorMetric]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[MlSymmetricMeanAbsolutePercentageErrorMetric]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[MlSymmetricMeanAbsolutePercentageErrorMetric]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[MlSymmetricMeanAbsolutePercentageErrorMetric]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[MlSymmetricMeanAbsolutePercentageErrorMetric]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[MlSymmetricMeanAbsolutePercentageErrorMetric]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[MlSymmetricMeanAbsolutePercentageErrorMetric]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[MlSymmetricMeanAbsolutePercentageErrorMetric]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[MlSymmetricMeanAbsolutePercentageErrorMetric]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[MlSymmetricMeanAbsolutePercentageErrorMetric]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[MlSymmetricMeanAbsolutePercentageErrorMetric]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, MlSymmetricMeanAbsolutePercentageErrorMetric]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, MlSymmetricMeanAbsolutePercentageErrorMetric]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[MlSymmetricMeanAbsolutePercentageErrorMetric]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[MlSymmetricMeanAbsolutePercentageErrorMetric]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    """
        ...
    def afterMake(self) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[MlSymmetricMeanAbsolutePercentageErrorMetric]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> MlSymmetricMeanAbsolutePercentageErrorMetric:
    """
    ...
    """
        ...
    def scoreSync(self, targetOutput: Data=None, modelOutput: Data=None, context: =None, spec: MlOperationSpec=None) -> float:
    """
    ...
    """
        ...
    def convertModelOutputToNative(self, modelOutput: Data) -> Any:
    """
    Converts `modelOutput` from `DO` type to a Python native format. The default implementation does not convert the
    input.
    """
        ...
    def convertTargetOutputToNative(self, targetOutput: Data) -> Any:
    """
    ...
    """
        ...
    def convertInputsToNative(self, targetOutput: Data, modelOutput: Data, context: =None) -> Any:
    """
    ...
    """
        ...
    def sampleWeightsPd(self, context: =None) -> Any:
    """
    Helper function to convert context to native and extract the sample weights. Note, this will only work if DS is a
    {@link Tuple} containing the `sampleWeights` key.
    """
        ...
