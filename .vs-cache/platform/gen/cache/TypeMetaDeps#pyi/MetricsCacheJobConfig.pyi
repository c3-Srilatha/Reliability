...
# Python definitions for the C3 type MetricsCacheJobConfig


class MetricsCacheJobConfig(Config, Identifiable):
    """
    ...
    """
    def __init__(self, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, id: Optional[str]=None, srcType: Optional[Type]=None, metricNames: Optional[Array[str]]=None, interval: Optional[str]=None, enabled: Optional[bool]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[MetricsCacheJobConfig]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[MetricsCacheJobConfig]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[MetricsCacheJobConfig]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[MetricsCacheJobConfig]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> MetricsCacheJobConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> MetricsCacheJobConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> MetricsCacheJobConfig:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[MetricsCacheJobConfig]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[MetricsCacheJobConfig]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> MetricsCacheJobConfig:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> MetricsCacheJobConfig:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> MetricsCacheJobConfig:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> MetricsCacheJobConfig:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> MetricsCacheJobConfig:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> MetricsCacheJobConfig:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> MetricsCacheJobConfig:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> MetricsCacheJobConfig:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> MetricsCacheJobConfig:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> MetricsCacheJobConfig:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> MetricsCacheJobConfig:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> MetricsCacheJobConfig:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> MetricsCacheJobConfig:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> MetricsCacheJobConfig:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> MetricsCacheJobConfig:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> MetricsCacheJobConfig:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> MetricsCacheJobConfig:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> MetricsCacheJobConfig:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> MetricsCacheJobConfig:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> MetricsCacheJobConfig:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> MetricsCacheJobConfig:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> MetricsCacheJobConfig:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> MetricsCacheJobConfig:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> MetricsCacheJobConfig:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> MetricsCacheJobConfig:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> MetricsCacheJobConfig:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> MetricsCacheJobConfig:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> MetricsCacheJobConfig:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[MetricsCacheJobConfig]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[MetricsCacheJobConfig]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[MetricsCacheJobConfig]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[MetricsCacheJobConfig]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[MetricsCacheJobConfig]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, MetricsCacheJobConfig]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, MetricsCacheJobConfig]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[MetricsCacheJobConfig]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[MetricsCacheJobConfig]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> MetricsCacheJobConfig:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> MetricsCacheJobConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> MetricsCacheJobConfig:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> MetricsCacheJobConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> MetricsCacheJobConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> MetricsCacheJobConfig:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[MetricsCacheJobConfig]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> MetricsCacheJobConfig:
    """
    ...
    """
        ...
    def afterMake(self) -> MetricsCacheJobConfig:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> MetricsCacheJobConfig:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[MetricsCacheJobConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> MetricsCacheJobConfig:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[MetricsCacheJobConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[MetricsCacheJobConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[MetricsCacheJobConfig]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[MetricsCacheJobConfig]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[MetricsCacheJobConfig]:
    """
    Returns cached instance by key, with secrets removed.
    """
        ...
    def getCached(self) -> Union[MetricsCacheJobConfig]:
    """
    ...
    """
        ...
    def refreshCache(self) -> Union[MetricsCacheJobConfig]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[MetricsCacheJobConfig]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, MetricsCacheJobConfig]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, MetricsCacheJobConfig]]:
    """
    ...
    """
        ...
    def getConfig(self) -> MetricsCacheJobConfig:
    """
    ...
    """
        ...
    def getSecret(self) -> MetricsCacheJobConfig:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[MetricsCacheJobConfig]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[MetricsCacheJobConfig]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: MetricsCacheJobConfig, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: MetricsCacheJobConfig, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[MetricsCacheJobConfig]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[MetricsCacheJobConfig]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[MetricsCacheJobConfig]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> MetricsCacheJobConfig:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[MetricsCacheJobConfig]:
    """
