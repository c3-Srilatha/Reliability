...
# Python definitions for the C3 type BestSimpleMetricCache


class BestSimpleMetricCache(MetadataCacheOld[string], Value):
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[str]:
    """
    ...
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, str]]:
    """
    ...
    """
        ...
    @classmethod
    def release(cls, key: str, value: str) -> None:
    """
    ...
    """
        ...
    @classmethod
    def metric(cls, srcType: str, metric: str) -> Union[str]:
    """
    @param srcType
           Source type
    @param metric
