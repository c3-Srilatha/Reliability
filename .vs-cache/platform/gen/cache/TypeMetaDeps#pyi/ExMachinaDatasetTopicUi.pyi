...
from c3.platform.ExMachinaDatasetMetadata import ExMachinaDatasetMetadata
from c3.platform.ValueType import ValueType
from c3.platform.Obj.GenerateSpec import Obj.GenerateSpec
from c3.platform.EvaluateResult import EvaluateResult
from c3.platform.ExMachinaDatasetTopicShareHistory import ExMachinaDatasetTopicShareHistory
from c3.platform.SetBuilder import SetBuilder
from c3.platform.RefreshDepsSpec import RefreshDepsSpec
from c3.platform.FetchResult import FetchResult
from c3.platform.ExMachinaDatasetTopic import ExMachinaDatasetTopic
...
from c3.platform.ExMachinaDatasetTopicOwnership import ExMachinaDatasetTopicOwnership
from c3.platform.FetchResult import FetchResult
...
# Python definitions for the C3 type ExMachinaDatasetTopicUi


class ExMachinaDatasetTopicUi(ExMachinaDatasetTopic, ExMachinaUserGroupShareableUi[ExMachinaDatasetTopic, ExMachinaDatasetTopicUi]):
    """
    A wrapper around {@link ExMachinaDatasetTopic} to provide additional fields that will change depending on the user
    accessing the records. These additional fields drive logic to show/hide certain buttons on the Datasets page in the
    UI.
    
    @remarks this represents a made instance of ExMachinaDatasetTopicUi
    """
    
    typeName: Optional[ExMachinaDatasetTopic]=None
    """
    ...
    ownershipType: Optional[ExMachinaDatasetTopicOwnership]=None
    """
    Used internally to derive the ownership type from the type that mixes ExMachinaUserGroupShareable
    """

    shareHistoryType: Optional[ExMachinaDatasetTopicShareHistory]=None
    """
    ...
    """
    The last user to modify the dataset topic by creating a new {@link ExMachinaDatasetMetadata}. For a publicly
    available dataset, uses "C3 AI" as the updater.
    """

    ownershipHistory: Optional[Array[ExMachinaDatasetTopicOwnership]]=None
    """
    History of all owners of the shareable entity
    """

    activelyShared: Optional[Array[ExMachinaDatasetTopicShareHistory]]=None
    """
    Current groups with which the shareable entity has been shared
    """

    sharedHistory: Optional[Array[ExMachinaDatasetTopicShareHistory]]=None
    """
    ...
    """
    Dataset Topic description
    """

    latestMetadata: Optional[ExMachinaDatasetMetadata]=None
    """
    The most recently saved configuration for the dataset topic
    """

    datasetMetadataHistory: Optional[Array[ExMachinaDatasetMetadata]]=None
    """
    All previously saved configurations of the dataset topic
    """

    lastUpdatedDate: Optional[datetime]=None
    """
    When the last user modified the dataset topic by creating a new {@link ExMachinaDatasetMetadata}
    """
    def __init__(self, typeName: Optional[ExMachinaDatasetTopic]=None, allowViewDetails: Optional[bool]=None, allowShare: Optional[bool]=None, allowDelete: Optional[bool]=None, allowDisable: Optional[bool]=None, allowEnable: Optional[bool]=None, allowEdit: Optional[bool]=None, acl: Optional[Array[AclEntry]]=None, isPubliclyAccessible: Optional[bool]=None, disabled: Optional[bool]=None, ownershipType: Optional[ExMachinaDatasetTopicOwnership]=None, shareHistoryType: Optional[ExMachinaDatasetTopicShareHistory]=None, currentOwner: Optional[User]=None, displayOwner: Optional[str]=None, lastUpdatedBy: Optional[str]=None, ownershipHistory: Optional[Array[ExMachinaDatasetTopicOwnership]]=None, activelyShared: Optional[Array[ExMachinaDatasetTopicShareHistory]]=None, sharedHistory: Optional[Array[ExMachinaDatasetTopicShareHistory]]=None, isOwned: Optional[bool]=None, typeIdent: Optional[str]=None, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, description: Optional[str]=None, latestMetadata: Optional[ExMachinaDatasetMetadata]=None, datasetMetadataHistory: Optional[Array[ExMachinaDatasetMetadata]]=None, lastUpdatedDate: Optional[datetime]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ExMachinaDatasetTopicUi]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ExMachinaDatasetTopicUi]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ExMachinaDatasetTopicUi]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ExMachinaDatasetTopicUi]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ExMachinaDatasetTopicUi:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ExMachinaDatasetTopicUi:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ExMachinaDatasetTopicUi:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ExMachinaDatasetTopicUi]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ExMachinaDatasetTopicUi]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ExMachinaDatasetTopicUi:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ExMachinaDatasetTopicUi:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ExMachinaDatasetTopicUi:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ExMachinaDatasetTopicUi:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ExMachinaDatasetTopicUi:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ExMachinaDatasetTopicUi:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ExMachinaDatasetTopicUi:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ExMachinaDatasetTopicUi:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ExMachinaDatasetTopicUi:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ExMachinaDatasetTopicUi:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ExMachinaDatasetTopicUi:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ExMachinaDatasetTopicUi:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ExMachinaDatasetTopicUi:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ExMachinaDatasetTopicUi:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ExMachinaDatasetTopicUi:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ExMachinaDatasetTopicUi:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ExMachinaDatasetTopicUi:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ExMachinaDatasetTopicUi:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ExMachinaDatasetTopicUi:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ExMachinaDatasetTopicUi:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ExMachinaDatasetTopicUi:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ExMachinaDatasetTopicUi:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ExMachinaDatasetTopicUi:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ExMachinaDatasetTopicUi:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ExMachinaDatasetTopicUi:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ExMachinaDatasetTopicUi:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ExMachinaDatasetTopicUi:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ExMachinaDatasetTopicUi:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ExMachinaDatasetTopicUi]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ExMachinaDatasetTopicUi]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ExMachinaDatasetTopicUi]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ExMachinaDatasetTopicUi]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ExMachinaDatasetTopicUi]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ExMachinaDatasetTopicUi]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ExMachinaDatasetTopicUi]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ExMachinaDatasetTopicUi]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ExMachinaDatasetTopicUi]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ExMachinaDatasetTopicUi:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ExMachinaDatasetTopicUi:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ExMachinaDatasetTopicUi:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ExMachinaDatasetTopicUi:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ExMachinaDatasetTopicUi:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ExMachinaDatasetTopicUi:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[ExMachinaDatasetTopicUi]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ExMachinaDatasetTopicUi:
    """
    ...
    """
        ...
    def afterMake(self) -> ExMachinaDatasetTopicUi:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ExMachinaDatasetTopicUi:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ExMachinaDatasetTopicUi]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ExMachinaDatasetTopicUi:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> Union[FetchResult[ExMachinaDatasetTopicUi]]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[ExMachinaDatasetTopicUi]:
    """
    ...
    """
        ...
    @classmethod
    def processFetchResult(cls, shareableEntityFetchResult: FetchResult[ExMachinaDatasetTopic]=None, uiWrapperType: Type=None) -> Union[FetchResult[ExMachinaDatasetTopicUi]]:
    """
    Utility function to process the fetch results of the shareable entity.
    """
        ...
    @classmethod
    def processShareableEntities(cls, shareableEntities: Array[ExMachinaDatasetTopic]=None, uiWrapperType: Type=None) -> Union[Array[ExMachinaDatasetTopicUi]]:
    """
    ...
    """
        ...
    @classmethod
    def populateAcl(cls, objs: Array[ExMachinaDatasetTopicUi]=None) -> Union[int]:
    """
    ...
    """
        ...
    def grantMemberReadUpdateRemove(self, member: AccessControlEntity) -> ExMachinaDatasetTopicUi:
    """
    Creates (or updates existing) entry with all but modify ACL permissions.
    """
        ...
    def mergeAclEntry(self, entry: AclEntry) -> ExMachinaDatasetTopicUi:
    """
    ...
    """
        ...
    def mergeAclEntries(self, entries: Array[AclEntry]) -> ExMachinaDatasetTopicUi:
    """
    ...
    """
        ...
    @classmethod
    def refreshData(cls, shareHistoryObjs: Array[ExMachinaDatasetTopicShareHistory]=None, shareableEntityObjs: Array[ExMachinaDatasetTopic]=None) -> None:
    """
    Refreshes ACLs for the given share history objects and shareable entity objects.
    """
        ...
    def endShares(self, shares: Array[ExMachinaDatasetTopicShareHistory]=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def postCreate(cls, objs: Array[ExMachinaDatasetTopic]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[ExMachinaDatasetTopicUi]]:
    """
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[ExMachinaDatasetTopicUi]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[ExMachinaDatasetTopicUi]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[ExMachinaDatasetTopicUi]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> ExMachinaDatasetTopicUi:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[ExMachinaDatasetTopicUi]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> ExMachinaDatasetTopicUi:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[ExMachinaDatasetTopicUi]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[ExMachinaDatasetTopicUi]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[ExMachinaDatasetTopicUi], spec: UpsertSpec=None) -> Union[ObjList[ExMachinaDatasetTopicUi]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[ExMachinaDatasetTopicUi], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[ExMachinaDatasetTopicUi]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: ExMachinaDatasetTopicUi=None, spec: UpsertSpec=None) -> Union[ExMachinaDatasetTopicUi]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: ExMachinaDatasetTopicUi=None, spec: UpsertSpec=None) -> Union[ExMachinaDatasetTopicUi]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[ExMachinaDatasetTopicUi]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[ExMachinaDatasetTopicUi]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[ExMachinaDatasetTopicUi]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[ExMachinaDatasetTopicUi], srcObjs: Array[ExMachinaDatasetTopicUi]=None, spec: UpsertSpec=None) -> Union[ObjList[ExMachinaDatasetTopicUi]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[ExMachinaDatasetTopicUi]]], spec: UpsertSpec=None) -> Union[ObjList[ExMachinaDatasetTopicUi]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[ExMachinaDatasetTopicUi], srcObjs: Array[ExMachinaDatasetTopicUi]=None, spec: UpsertSpec=None) -> Union[ObjList[ExMachinaDatasetTopicUi]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[ExMachinaDatasetTopicUi]]], spec: UpsertSpec=None) -> Union[ObjList[ExMachinaDatasetTopicUi]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[ExMachinaDatasetTopicUi], spec: TouchSpec=None) -> Union[ObjList[ExMachinaDatasetTopicUi]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ExMachinaDatasetTopicUi], spec: MergeSpec=None) -> Union[ObjList[ExMachinaDatasetTopicUi]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[ExMachinaDatasetTopicUi], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ExMachinaDatasetTopicUi]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[ExMachinaDatasetTopicUi]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[ExMachinaDatasetTopicUi]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ExMachinaDatasetTopicUi, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: ExMachinaDatasetTopicUi, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[ExMachinaDatasetTopicUi], spec: UpsertSpec=None) -> Union[ObjList[ExMachinaDatasetTopicUi]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[ExMachinaDatasetTopicUi], spec: UpsertSpec=None) -> Union[ObjList[ExMachinaDatasetTopicUi]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[ExMachinaDatasetTopicUi]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[ExMachinaDatasetTopicUi]) -> ObjList[ExMachinaDatasetTopicUi]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[ExMachinaDatasetTopicUi]) -> ObjList[ExMachinaDatasetTopicUi]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[ExMachinaDatasetTopicUi]) -> ObjList[ExMachinaDatasetTopicUi]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[ExMachinaDatasetTopicUi]) -> Union[Array[ObjError]]:
    """
    TODO: VAD-16871 - Add a common afterCreate for all shareable types after PLAT-51996 fix
    Common logic to run after creation of any types that mixin {@link ExMachinaUserGroupShareable}
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[ExMachinaDatasetTopicUi]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[ExMachinaDatasetTopicUi]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[ExMachinaDatasetTopicUi]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[ExMachinaDatasetTopicUi]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[ExMachinaDatasetTopicUi]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[ExMachinaDatasetTopicUi]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[ExMachinaDatasetTopicUi]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: ExMachinaDatasetTopicUi=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[ExMachinaDatasetTopicUi], callback: Callable[[Union[ExMachinaDatasetTopicUi]], Union[ExMachinaDatasetTopicUi]]=None) -> ObjList[ExMachinaDatasetTopicUi]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[ExMachinaDatasetTopicUi], callback: Callable[[Union[ExMachinaDatasetTopicUi]], Union[ExMachinaDatasetTopicUi]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def createDatasetTopic(cls, name: str) -> Union[ExMachinaDatasetTopic]:
    """
    Creates a new {@link ExMachinaDatasetTopic} for the given name
    @param name
               Dataset Topic name
    @return {@link ExMachinaDatasetTopic}
    """
        ...
