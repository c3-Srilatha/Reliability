...
# Python definitions for the C3 type SqlActionQueue


class SqlActionQueue(ActionQueue, Value):
    """
    Invalidation queue for asynchronous action invocation processing.
    
    @remarks this represents a made instance of SqlActionQueue
    """
