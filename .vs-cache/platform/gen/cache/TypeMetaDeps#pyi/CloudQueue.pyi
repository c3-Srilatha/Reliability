...
from c3.platform.CloudQueue import CloudQueue
...
# Python definitions for the C3 type CloudQueue

M = TypeVar('M')

class CloudQueue(Generic[M], CloudMessageBroker[M, CloudReceiveMessagesSpec]):
    """
    Base type for cloud queue resources (TibcoJsmQueue, AwsSqs etc.), providing fields and interfaces
    
    @remarks this represents a made instance of CloudQueue
    """
    ...
    @overload
    @classmethod
    def fromString(cls, s: str) -> Union[CloudQueue[M]]:
    """
    ...
    @overload
    @classmethod
    def fromString(cls, s: str, failIfInvalid: bool=None) -> Union[CloudQueue[M]]:
    """
    Constructs Cloud Resource instance with reference fields and credentials based on provided Cloud Reference string.
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[CloudQueue[M]]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> CloudQueue[M]:
    """
    ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> CloudQueue[M]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> CloudQueue[M]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> CloudQueue[M]:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[CloudQueue[M]]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[CloudQueue[M]]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[CloudQueue[M]]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[CloudQueue[M]]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> CloudQueue[M]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> CloudQueue[M]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> CloudQueue[M]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[CloudQueue[M]]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[CloudQueue[M]]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> CloudQueue[M]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> CloudQueue[M]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> CloudQueue[M]:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> CloudQueue[M]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> CloudQueue[M]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> CloudQueue[M]:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> CloudQueue[M]:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> CloudQueue[M]:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> CloudQueue[M]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> CloudQueue[M]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> CloudQueue[M]:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> CloudQueue[M]:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> CloudQueue[M]:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> CloudQueue[M]:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> CloudQueue[M]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> CloudQueue[M]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> CloudQueue[M]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> CloudQueue[M]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> CloudQueue[M]:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> CloudQueue[M]:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> CloudQueue[M]:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> CloudQueue[M]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> CloudQueue[M]:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> CloudQueue[M]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> CloudQueue[M]:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> CloudQueue[M]:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> CloudQueue[M]:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> CloudQueue[M]:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[CloudQueue[M]]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[CloudQueue[M]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[CloudQueue[M]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[CloudQueue[M]]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[CloudQueue[M]]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, CloudQueue[M]]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, CloudQueue[M]]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[CloudQueue[M]]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[CloudQueue[M]]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> CloudQueue[M]:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> CloudQueue[M]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> CloudQueue[M]:
    """
    ...
    """
        ...
    def afterMake(self) -> CloudQueue[M]:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> CloudQueue[M]:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[CloudQueue[M]]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> CloudQueue[M]:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[CloudQueue[M]]:
    """
    Find Cloud Resource in Cloud Provider based on provided C3 canonical identifier.
    """
        ...
    @classmethod
    def fromClusterId(cls, clusterId: str, env: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> CloudQueue[M]:
    """
    Construct a cloud ID from a cluster ID
    """
        ...
    @classmethod
    def fromEnvId(cls, envId: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> CloudQueue[M]:
    """
    ...
    """
        ...
    @classmethod
    def fromAppId(cls, appId: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> CloudQueue[M]:
    """
    ...
    """
        ...
    @classmethod
    def fromId(cls, id: str, failIfInvalid: bool=None) -> CloudQueue[M]:
    """
    ...
    """
        ...
    @classmethod
    def fromCloudId(cls, id: CloudId, failIfInvalid: bool=None) -> CloudQueue[M]:
    """
    ...
    """
        ...
    def fromConfigTemplate(self, spec: CloudResourceOperationSpec=None) -> CloudQueue[M]:
    """
    ...
    """
        ...
    def withDefaultConfig(self, spec: CloudResourceOperationSpec=None) -> CloudQueue[M]:
    """
    ...
    """
        ...
    def upsertResource(self, spec: CloudResourceOperationSpec=None) -> CloudQueue[M]:
    """
    Create or update Cloud Resource.
    """
        ...
    def upsertWithDependencies(self, spec: CloudResourceOperationSpec=None) -> CloudQueue[M]:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[CloudQueue[M]]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[CloudQueue[M]]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[CloudQueue[M]]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[CloudQueue[M]]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[CloudQueue[M]]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, CloudQueue[M]]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, CloudQueue[M]]]:
    """
    ...
    """
        ...
    def getConfig(self) -> CloudQueue[M]:
    """
    This method on any CloudResource is not supported! Use CloudResource.for* or other methods instead.
    """
        ...
    ...
    """
        ...
    def getSecret(self) -> CloudQueue[M]:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[CloudQueue[M]]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[CloudQueue[M]]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: CloudQueue[M], override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: CloudQueue[M], override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[CloudQueue[M]]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[CloudQueue[M]]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[CloudQueue[M]]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> CloudQueue[M]:
    """
    ...
    """
        ...
    def withIdentity(self, resource: CloudResource=None, spec: CloudResourceOperationSpec=None) -> CloudQueue[M]:
    """
    ...
    """
        ...
    def mergeId(self, other: CloudResource=None) -> CloudQueue[M]:
    """
    ...
    """
        ...
    @classmethod
    def forCloudId(cls, id: CloudId, failIfMissing: bool=None) -> Union[CloudQueue[M]]:
    """
    ...
    """
        ...
    @classmethod
    def forCloudFunc(cls, func: str, role: str=None, failIfMissing: bool=None) -> CloudQueue[M]:
    """
    Find Cloud Resource based on provided cloud func component and optional role.
    """
        ...
    @classmethod
    def forCloudRole(cls, role: str, failIfMissing: bool=None) -> CloudQueue[M]:
    """
    Find Cloud Resource of this type based on provided cloud role component.
    """
        ...
    @classmethod
    def forResourceId(cls, resourceId: str, failIfMissing: bool=None) -> Union[CloudQueue[M]]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def forResourceSecondaryId(cls, resourceId: str, failIfMissing: bool=None) -> Union[CloudQueue[M]]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forResourceName(cls, resourceName: str, failIfMissing: bool=None) -> Union[CloudQueue[M]]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def findResource(cls, reference: str, failIfMissing: bool=None) -> Union[CloudQueue[M]]:
    """
    Find Cloud Resource in the Cloud Provider by provided {@link CloudRef} string.
    """
        ...
    def getResource(self) -> Union[CloudQueue[M]]:
    """
    Find Cloud Resource in the Cloud Provider by provided #resourceId, #resourceSecondaryId, #resourceName or #tags
    (in that order).
    """
        ...
    def ensureResource(self) -> CloudQueue[M]:
    """
    Checks that the resource is persisted. If not, upserts the resource, to ensure that the resource exists.
    """
        ...
    @classmethod
    def listResourcesBySubtype(cls, spec: CloudListResourcesSpec=None) -> Map[str, CloudListResourcesResult[CloudQueue[M]]]:
    """
    ...
    """
        ...
    @classmethod
    def listResources(cls, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[CloudQueue[M]]:
    """
    ...
    """
        ...
    @classmethod
    def listResourcesForTags(cls, *keyValuePairs: Array[str]) -> CloudListResourcesResult[CloudQueue[M]]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForClusterId(cls, clusterId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[CloudQueue[M]]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForEnvId(cls, envId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[CloudQueue[M]]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForAppId(cls, appId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[CloudQueue[M]]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    def upsertDependencies(self, spec: CloudResourceOperationSpec=None) -> CloudQueue[M]:
    """
    ...
    """
        ...
    def waitForCreate(self, spec: WaitSpec=None) -> Union[CloudQueue[M]]:
    """
    ...
    """
        ...
    @classmethod
    def tagResourcesBatch(cls, resources: Array[CloudQueue[M]], tags: Array[CloudTag]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    @classmethod
    def untagResourcesBatch(cls, resources: Array[CloudQueue[M]], tagKeys: Array[str]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    def waitForOk(self, spec: WaitSpec=None) -> Union[CloudQueue[M]]:
    """
    ...
    """
        ...
    def waitForState(self, state: str='AVAILABLE', spec: WaitSpec=None) -> Union[CloudQueue[M]]:
    """
    ...
    """
        ...
    def setFullyConfigured(self, fullyConfigured: bool=None, override: str=None) -> CloudQueue[M]:
    """
    ...
    """
        ...
    def afterCreate(self, input: CloudQueue[M]=None) -> CloudQueue[M]:
    """
    ...
    """
        ...
    def withoutNonModifiableFields(self) -> CloudQueue[M]:
    """
    ...
    """
        ...
    def receiveMessages(self, spec: CloudReceiveMessagesSpec=None) -> Union[Array[M]]:
    """
    ...
    """
        ...
    def processor(self) -> Union[CloudMessageProcessor[M, CloudReceiveMessagesSpec]]:
    """
    ...
    """
        ...
    def destroyMessages(self, messages: Array[M]=None) -> Union[Map[str, Error]]:
    """
    Destroy an array of CloudMessage from the cloud queue
    """
        ...
    def releaseMessages(self, messages: Array[M]=None) -> Union[Map[str, Error]]:
    """
    Release the lock of an array of CloudMessage from the cloud queue
    """
        ...
    def peekMessages(self, spec: CloudReceiveMessagesSpec=None) -> Union[Array[M]]:
    """
