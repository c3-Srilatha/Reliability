...
# Python definitions for the C3 type C3Request


class C3Request(Identified, C3RequestFields):
    """
    ...
    @remarks this represents a made instance of C3Request
    """
    ...
    """
    The status of processing a request.
    """

    result: Optional[str]=None
    """
    A generic string field that can hold information regarding the request's processing.
    The lambda can set this field to arbitrary values.
    Could be serialized data structures, or just a basic message.
    """
    ...
    topic: Optional[str]
    """
    For structured requests, requests which have a defined structure and additional fields beyond those on
    {@link C3RequestFields}, this is the name of a {@link Type}.
    For unstructured requests, this is a human readable name for a particular type of request.
    
    In both cases, this field is used to find the {@link C3Request.Processor} that is in charge of processing the
    approval or denial of this request.
    """

    data: Optional[str]=None
    """
    Data used by the {@link C3Request.Processor} to perform it's processing.
    More complex structures of data can done by creating a subtype of {@link C3Request} or as
    json serialized data in this field.
    """

    state: Optional[str]
    """
    The current state of this request.
    The state changes upon approval or denial and when processing has completed.
    """

    received: Optional[datetime]
    """
    The timestamp when this request was received.
    """

    requestedBy: Optional[str]
    """
    The {@link User} who made the request. This generally will be the human user
    who made the request.
    """

    requesterComment: Optional[str]=None
    """
    Comment left by the user who is requesting.
    """

    decided: Optional[datetime]=None
    """
    The timestamp when this request was approved or denied.
    """

    decidedBy: Optional[str]=None
    """
    The user who approved or denied the request. This generally will to be the human user
    who made the decision.
    """

    deciderComment: Optional[str]=None
    """
    Comment left by the user who decided the request (either by approve, cancel, or deny).
    """

    deciderData: Optional[any]=None
    """
    Data associated with the decision.
    {@link C3Request.DeciderSpec#data}
    """

    processed: Optional[bool]=None
    """
    Whether or not this request has been fully processed.
    If true, the outcome of the requests {@link C3Request.Processor} is guarenteed to have been applied.
    """

    processStart: Optional[datetime]=None
    """
    The timestamp when the async action for processing this request was started. Can be used alongside
    {@link #processEnd} to determine how long processing took.
    This does not include the time it took for the request to be decided upon, or the time it took the async
    processor to pick up this action. This only includes the time at which the async processor began
    processing this request.
    """

    processEnd: Optional[datetime]=None
    """
    The timestamp when the async action for processing this request was finished. Can be used alongside
    {@link #processStart} to determine how long processing took.
    """
    ...
    actionQueueEntryObjId: Optional[str]=None
    """
    ...
    processSubmitted: Optional[datetime]=None
    """
    The timestamp at which the most recent {@link ActionQueue} entry attempting to process this request was submitted.
    This field can be inaccurate at any point in time. Request processors must be idempotent, and it is possible
    for two or more {@link ActionQueue} entries to exist at the same time for any request.
    """
    def __init__(self, id: Optional[str]=None, status: Optional[str]=None, result: Optional[str]=None, error: Optional[str]=None, topic: Optional[str]=None, data: Optional[str]=None, state: Optional[str]=None, received: Optional[datetime]=None, requestedBy: Optional[str]=None, requesterComment: Optional[str]=None, decided: Optional[datetime]=None, decidedBy: Optional[str]=None, deciderComment: Optional[str]=None, deciderData: Optional[any]=None, processed: Optional[bool]=None, processStart: Optional[datetime]=None, processEnd: Optional[datetime]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, actionQueueEntryObjId: Optional[str]=None, processSubmitted: Optional[datetime]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[C3Request]:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[C3Request]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> C3Request:
    """
    ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> C3Request:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> C3Request:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> C3Request:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[C3Request]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[C3Request]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[C3Request]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[C3Request]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> C3Request:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> C3Request:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> C3Request:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[C3Request]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[C3Request]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> C3Request:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> C3Request:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> C3Request:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> C3Request:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> C3Request:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> C3Request:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> C3Request:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> C3Request:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> C3Request:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> C3Request:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> C3Request:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> C3Request:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> C3Request:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> C3Request:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> C3Request:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> C3Request:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> C3Request:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> C3Request:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> C3Request:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> C3Request:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> C3Request:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> C3Request:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> C3Request:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> C3Request:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> C3Request:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> C3Request:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> C3Request:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> C3Request:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[C3Request]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[C3Request]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[C3Request]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[C3Request]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[C3Request]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, C3Request]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, C3Request]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[C3Request]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[C3Request]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> C3Request:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> C3Request:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> C3Request:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> C3Request:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[C3Request]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> C3Request:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[C3Request]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[C3Request]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[C3Request]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[C3Request]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[C3Request]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[C3Request]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[C3Request]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> C3Request:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[C3Request]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> C3Request:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[C3Request]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[C3Request], spec: UpsertSpec=None) -> Union[ObjList[C3Request]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[C3Request], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[C3Request]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: C3Request=None, spec: UpsertSpec=None) -> Union[C3Request]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: C3Request=None, spec: UpsertSpec=None) -> Union[C3Request]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[C3Request]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[C3Request]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[C3Request]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[C3Request], srcObjs: Array[C3Request]=None, spec: UpsertSpec=None) -> Union[ObjList[C3Request]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[C3Request]]], spec: UpsertSpec=None) -> Union[ObjList[C3Request]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[C3Request], srcObjs: Array[C3Request]=None, spec: UpsertSpec=None) -> Union[ObjList[C3Request]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[C3Request]]], spec: UpsertSpec=None) -> Union[ObjList[C3Request]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[C3Request], spec: TouchSpec=None) -> Union[ObjList[C3Request]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[C3Request], spec: MergeSpec=None) -> Union[ObjList[C3Request]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[C3Request], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[C3Request]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[C3Request]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[C3Request]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: C3Request, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: C3Request, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[C3Request], spec: UpsertSpec=None) -> Union[ObjList[C3Request]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[C3Request], spec: UpsertSpec=None) -> Union[ObjList[C3Request]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[C3Request]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[C3Request]) -> ObjList[C3Request]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[C3Request]) -> ObjList[C3Request]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[C3Request]) -> ObjList[C3Request]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[C3Request]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[C3Request]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[C3Request]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[C3Request]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[C3Request]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    def withoutIdentity(self) -> Union[C3Request]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[C3Request]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: C3Request=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[C3Request], callback: Callable[[Union[C3Request]], Union[C3Request]]=None) -> ObjList[C3Request]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[C3Request], callback: Callable[[Union[C3Request]], Union[C3Request]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    def approve(self, deciderSpec: C3Request.DeciderSpec=None) -> None:
    """
    ...
    """
        ...
    def deny(self, deciderSpec: C3Request.DeciderSpec=None) -> None:
    """
    Transitions {@link #state} from PENDING to DENYING and submits an action to the {@link ActionQueue}
    to process this request using {@link #process}.
    """
        ...
    def cancel(self, deciderSpec: C3Request.DeciderSpec=None) -> None:
    """
    ...
    """
        ...
    def submitActionQueueEntry(self) -> None:
    """
    ...
    class Processor():
        """
        An entity in charge of processing {@link C3Request}s once they have been approved or denied.
        Used to run an idempotent and eventually consistent lambda upon decision.
        
        The appropriate lambda is guaranteed to be run from start to finish at least once.
        If provided, the @{link #onApprove} and {@link #onDeny} lambdas must be idempotent and eventually consistent.
        This is to make request processing resilient to resource re-allocations, network failures, and the like.
        There is a small chance that 2 threads might be processing the same request at the same time in case of a network outage.
        
        By default, if no appropriate lambda is provided, the default behavior will be to return a "SUCCESS" result.
        
        @remarks this represents a made instance of C3Request.Processor
        """
        ...
        topic: Optional[str]
        """
        The {@link C3Request#topic} which this processor is in charge of processing.
        Only 1 processor per topic is allowed.
        """

        onApprove: Optional[Callable[[Union[C3Request]], Union[C3Request.Processor.Result]]]=None
        """
        The lambda to run upon request approval.
        """

        onDeny: Optional[Callable[[Union[C3Request]], Union[C3Request.Processor.Result]]]=None
        """
        The lambda to run upon request denial.
        """

        onCancel: Optional[Callable[[Union[C3Request]], Union[C3Request.Processor.Result]]]=None
        """
        The lambda to run upon request cancellation.
        """
        def __init__(self, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, topic: Optional[str]=None, onApprove: Optional[Callable[[Union[C3Request]], Union[C3Request.Processor.Result]]]=None, onDeny: Optional[Callable[[Union[C3Request]], Union[C3Request.Processor.Result]]]=None, onCancel: Optional[Callable[[Union[C3Request]], Union[C3Request.Processor.Result]]]=None) -> None: ...
        ...
        """
            ...
        @classmethod
        def fromJson(cls, json: any) -> Union[C3Request.Processor]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromJsonString(cls, json: str) -> Union[C3Request.Processor]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromXmlString(cls, xml: str) -> Union[C3Request.Processor]:
        """
        Load the XML-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def deserialize(cls, contentStr: str, contentType: str) -> Union[C3Request.Processor]:
        """
        Load from contentType representation and reconstruct the corresponding object.
        ...
        """
            ...
        def replaceType(self, old: Type, new: Type) -> C3Request.Processor:
        """
        Returns new instance with all references to old type, including result of #type, replaced with new type. If new
        type does not contain fields from old or field value types are not convertable then drops the field.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> C3Request.Processor:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> C3Request.Processor:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[C3Request.Processor]:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the asynchronous `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[C3Request.Processor]:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        asynchronous `mapper` invocation.
        ...
        """
            ...
        def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> C3Request.Processor:
        """
        Result of this function call is a copy of current instance with specified field value replaced based on result of
        the `mapper` invocation.
        @param field
        ...
        """
            ...
        @overload
        def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> C3Request.Processor:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> C3Request.Processor:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def validateObj(self) -> C3Request.Processor:
        """
        Populates all missing default values and throws error if any constraint is violated.
        """
            ...
        ...
        """
            ...
        @overload
        def withField(self, field: str, value: Any, doNotConvert: bool=None) -> C3Request.Processor:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        @overload
        def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> C3Request.Processor:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> C3Request.Processor:
        """
        Builds a new Obj instance by adding the provided fields in it. The name must correspond to an existing fields
        defined on this type or its mixins. The values must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> C3Request.Processor:
        """
        Builds a new Obj with the value at the specified path field. If the field is null, the field #isFieldSet to null.
        If you would like to #unsetField, you should call #withoutFieldAtPath instead.
        ...
        """
            ...
        def withoutFieldAtPath(self, path: str) -> C3Request.Processor:
        """
        Builds a new Obj without the specified path field.
        ...
        """
            ...
        @overload
        def withoutField(self, field: str) -> C3Request.Processor:
        """
        Builds a new Obj, removing the field with the provided name.
        ...
        """
            ...
        @overload
        def withoutField(self, field: FieldType) -> C3Request.Processor:
        """
        Builds a new Obj, removing the field with the provided field type.
        ...
        """
            ...
        def withoutFields(self, fields: Array[str]) -> C3Request.Processor:
        """
        Builds a new Obj, removing the fields with the provided names.
        ...
        """
            ...
        def withoutFieldsByType(self, fields: Array[FieldType]) -> C3Request.Processor:
        """
        Builds a new Obj, removing the fields with the provided field types. Be sure to use the FieldType instance for the
        exact same type as the type of the obj to respect the "ordinal" of the field type
        ...
        """
            ...
        def withoutSecretFields(self) -> C3Request.Processor:
        """
        @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
        """
            ...
        ...
        """
            ...
        def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> C3Request.Processor:
        """
        Builds a new Obj instance by adding the default values (if defined) for all unset fields. This is implemented by
        calling {@link FieldType#defaultValue defaultValue} for a field if it is not already set and
        {@link FieldType#hasDefault has a default}. It will also set {@see ValueType#initialValue initial values} for
        ...
        """
            ...
        @overload
        def defaultField(self, field: str) -> C3Request.Processor:
        """
        Builds a new Obj, by setting a field on this `Obj` to the field's default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def defaultField(self, field: FieldType) -> C3Request.Processor:
        """
        Builds a new Obj, by setting a field on this `Obj` to the fields default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def unsetField(self, field: str) -> C3Request.Processor:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def unsetField(self, field: FieldType) -> C3Request.Processor:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def removeField(self, field: str) -> C3Request.Processor:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def removeField(self, field: FieldType) -> C3Request.Processor:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> C3Request.Processor:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence unless otherwise specified by the fieldPathMergeSpec
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> C3Request.Processor:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence.
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> C3Request.Processor:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist on other Obj and do not exist on this Obj will not be added to final Obj.
        @param deep
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> C3Request.Processor:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist other Obj and do not exist on this Obj will not be added to final Obj or evaluated. Does not
        traverse child reference and collection fields.
        ...
        """
            ...
        def mergeJson(self, json: any) -> C3Request.Processor:
            ...
        def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> C3Request.Processor:
        """
        Merge the obj references within the current obj
        @param deep
               If set, traverses the reference fields within the obj as well for a deep merge
        ...
        """
            ...
        def sumObj(self, other: Obj, deep: bool=None) -> C3Request.Processor:
        """
        Adds the numeric Obj fields with the other Objs respective fields.
        If deep is set it will traverse reference and collection fields and sum corresponding numeric fields in
        references with same name and collection elements at same index or key.
        """
            ...
        def singletonArray(self) -> Array[C3Request.Processor]:
        """
        Build an array of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def array(cls, *elements: Array[Any]) -> Union[Array[C3Request.Processor]]:
        """
        Creates an array of instances of this type.
        """
            ...
        @classmethod
        def arrayBuilder(cls) -> Union[ArrayBuilder[C3Request.Processor]]:
        """
        Creates an array of instances of this type.
        """
            ...
        def singletonSet(self) -> Set[C3Request.Processor]:
        """
        Build an set of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def setBuilder(cls) -> Union[SetBuilder[C3Request.Processor]]:
        """
        Creates a set of instances of this type.
        """
            ...
        @classmethod
        def mapBuilder(cls) -> Union[MapBuilder[str, C3Request.Processor]]:
        """
        Create a map of string to elements of this type.
        """
            ...
        @classmethod
        def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, C3Request.Processor]]:
        """
        Create a map with the given key type and elements of this type.
        """
            ...
        ...
        def myStreamType(cls) -> StreamType:
            ...
        def toBuilder(self) -> ObjBuilder[C3Request.Processor]:
        """
        @return new ObjBuilder with initial state set to fields of this instance.
        """
            ...
        @classmethod
        def builder(cls) -> ObjBuilder[C3Request.Processor]:
        """
        @return new ObjBuilder of this instance.
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> C3Request.Processor:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> C3Request.Processor:
        """
        Construct an instance of this type from provided fields
        @param fields
                   Fields to construct the instance of the obj with
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> C3Request.Processor:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def make(cls, withDefaults: bool=None) -> C3Request.Processor:
        """
        Construct an instance of this type with no non-default field values unless explicitly specified by passing param true
        @param withDefaults
                   If set, then the Obj is made with default & initial values (required primitive fields e.g. !int32 -> 0)
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> C3Request.Processor:
        """
        Construct an instance from provided fields
        @param fields
                   Fields (in the format <field_name, value>) to construct an instance of the obj. Note that "type" as a
        ...
        @overload
        @classmethod
        def make(cls, fields: Any, withDefaults: bool=None) -> C3Request.Processor:
        """
        Construct an instance of this type from provided fields. Note it is more efficient to use #fromFields and other overloads
        ...
        @overload
        @classmethod
        def make(cls, s: str) -> Union[C3Request.Processor]:
        """
        Construct an instance of this type from the string. This is an alias for #fromString, as a specific overload
        when the argument is a known string.
        ...
        """
            ...
        @classmethod
        def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> C3Request.Processor:
        """
        Construct an instance of this type from provided instance of a subtype or a "duck type".
        """
            ...
        ...
        """
            ...
        def afterMake(self) -> C3Request.Processor:
        """
        Optional override that will be called after every instance creation.
        ...
        """
            ...
        @classmethod
        def cachedEmptyInst(cls) -> C3Request.Processor:
        """
        Creates an empty inst using `MyType.make()` and caches it. Avoid recreating multiple copies of the spec for
        every action dispatch. The cached inst can also be used for comparing whether the object is an empty or not
        Will only create empty instance for immutable Obj e.g. if an Obj is Mutable, this method will throw an error
        ...
        """
            ...
        @classmethod
        def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[C3Request.Processor]]:
        """
        Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
        value is read.
        """
            ...
        @classmethod
        def generateObj(cls, spec: Obj.GenerateSpec=None) -> C3Request.Processor:
        """
        Generate a single instance of this type. The base implementation uses {@link DataGenObj} to generate uniform
        random (gibberish) values for all fields, but it may be overridden by specific types with custom logic that
        populates fields in a more realistic way.
        ...
        @overload
        @classmethod
        def fetch(cls, spec: FetchSpec=None) -> FetchResult[C3Request.Processor]:
        """
        Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
        returned.
        ...
        @overload
        @classmethod
        def fetch(cls, filter: Filter) -> FetchResult[C3Request.Processor]:
        """
        Fetches multiple obj instances based on a filter.  Only objs that the caller is authorized to fetch will be
        returned.
        ...
        """
            ...
        @classmethod
        def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[C3Request.Processor]]:
        """
        Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
        returned.
        ...
        """
            ...
        @classmethod
        def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[C3Request.Processor]]]:
        """
        Fetched multiple obj instances in multiple locales based on specification.
        ...
        """
            ...
        def get(self, include: str=None) -> Union[C3Request.Processor]:
        """
        Gets an instance of a single obj.  If the caller is not authorized to fetch the obj, it will not be returned.
        ...
        """
            ...
        def getSpecific(self, include: str=None) -> Union[C3Request.Processor]:
        """
        Gets an instance of a single obj in it's leaf type if the type is extendable.  If the caller is not authorized
        to fetch the obj, it will not be returned.
        ...
        """
            ...
        def getMissing(self, spec: GetMissingSpec) -> C3Request.Processor:
        """
        Function to check if an obj was already fetched with an include that contains at least the fields of a specified
        include and fetches the missing data if it wasn't.  The returned instance, by default will be the original instance
        if it included at least the data for the requested include spec.  Otherwise it will perform a fetch with the
        ...
        """
            ...
        def getDirect(self, include: str=None) -> Union[C3Request.Processor]:
        """
        Gets an obj instance directly from Cassandra, bypassing the normal fetch framework.  It is only valid for C3 types
        that are stored in Cassandra.
        ...
        """
            ...
        def applyReverseEdit(self, versionEdit: VersionEdit) -> C3Request.Processor:
        """
        Applies a reverse edit (e.g. VersionEdit) to an instance.
        ...
        """
            ...
        @classmethod
        def fromString(cls, s: str) -> Union[C3Request.Processor]:
        """
        Parse the string-based representation and reconstruct the corresponding instance. This must be implemented to
        provide deserialization.
        ...
        """
            ...
        def create(self, spec: UpsertSpec=None) -> Union[C3Request.Processor]:
        """
        Creates an instance of a C3 type. If the operation fails an exception will be thrown.  This will fail if the
        instance already exist.
        ...
        """
            ...
        @classmethod
        def createBatch(cls, objs: Array[C3Request.Processor], spec: UpsertSpec=None) -> Union[ObjList[C3Request.Processor]]:
        """
        Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
        specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
        returned {@link ObjList}.  This will fail if any of the instances already exist.
        ...
        """
            ...
        @classmethod
        def createBatchObjStream(cls, objs: Stream[C3Request.Processor], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[C3Request.Processor]]:
        """
        Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
        specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
        returned {@link ObjList}.  This will fail if any of the instances already exist.
        ...
        """
            ...
        def update(self, srcObj: C3Request.Processor=None, spec: UpsertSpec=None) -> Union[C3Request.Processor]:
        """
        Updates an instance of a C3 type. If the operation fails an exception will be thrown.  This will fail if the
        instance does not already exist.
        ...
        """
            ...
        def upsert(self, srcObj: C3Request.Processor=None, spec: UpsertSpec=None) -> Union[C3Request.Processor]:
        """
        Creates an instance of a C3 type if it doesn't exist or updates it if it does. If the operation fails an
        exception will be thrown.
        ...
        """
            ...
        @overload
        def merge(self, spec: MergeSpec=None) -> Union[C3Request.Processor]:
        """
        Merges an instance of a C3 type if it exists and creates it if it doesn't. Merging an obj instance by default only
        updates the non-null field values in the input obj.  Null field values are ignored.  Nullness of field values
        is honored at every level for fields that have an included type (e.g. non-entity type) as their value type. To
        ...
        """
            ...
        @overload
        def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[C3Request.Processor]:
        """
        Merges an instance of a C3 type if it exists and creates it if it doesn't.
        ...
        """
            ...
        def touch(self, spec: TouchSpec=None) -> Union[C3Request.Processor]:
        """
        Updates the 'meta.updated' field to the current time.  If the obj doesn't exist an error will be returned.
        ...
        """
            ...
        @classmethod
        def updateBatch(cls, objs: Array[C3Request.Processor], srcObjs: Array[C3Request.Processor]=None, spec: UpsertSpec=None) -> Union[ObjList[C3Request.Processor]]:
        """
        Updates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
        specified (the default), then a C3BatchException will be thrown.  Otherwise {@linkerrors will be reported in the
        returned {@link ObjList}.  This will fail if any of the instances don't already exist.
        ...
        """
            ...
        @classmethod
        def updateObjs(cls, objs: Callable[[], Union[Array[C3Request.Processor]]], spec: UpsertSpec=None) -> Union[ObjList[C3Request.Processor]]:
        """
        Updates multiple instances of a C3 type. If the operation fails due to a version conflict error, the lambda will be
        called again to provide updated instances to be updated. If the operation fails for other reasons and
        {@link UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
        ...
        """
            ...
        @classmethod
        def upsertBatch(cls, objs: Array[C3Request.Processor], srcObjs: Array[C3Request.Processor]=None, spec: UpsertSpec=None) -> Union[ObjList[C3Request.Processor]]:
        """
        Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
        fails errors will be reported in the returned {@link ObjList}.
        ...
        """
            ...
        @classmethod
        def upsertObjs(cls, objs: Callable[[], Union[Array[C3Request.Processor]]], spec: UpsertSpec=None) -> Union[ObjList[C3Request.Processor]]:
        """
        Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
        fails due to a version conflict error, the lambda will be called again to provide updated instances to be upserted.
        If the operation fails for other reasons and {@link UpsertSpec#dontThrowOnBatchError} is not specified (the
        ...
        """
            ...
        @classmethod
        def touchBatch(cls, objs: Array[C3Request.Processor], spec: TouchSpec=None) -> Union[ObjList[C3Request.Processor]]:
        """
        Updates the 'meta.updated' field to the current time for a batch of objs.  Attempts to touch non-existing
        objs will be considered an error.
        ...
        @overload
        @classmethod
        def mergeBatch(cls, objs: Array[C3Request.Processor], spec: MergeSpec=None) -> Union[ObjList[C3Request.Processor]]:
        """
        Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
        UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
        Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
        ...
        @overload
        @classmethod
        def mergeBatch(cls, objs: Array[C3Request.Processor], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[C3Request.Processor]]:
        """
        Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
        UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
        Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
        ...
        """
            ...
        @classmethod
        def mergeObjs(cls, objs: Callable[[], Union[Array[C3Request.Processor]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[C3Request.Processor]]:
        """
        Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails due to a version
        conflict error, the lambda will be called again to provide updated instances to be upserted. If the operation
        fails for other reasons and {@link UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a
        ...
        @overload
        @classmethod
        def mergeAll(cls, mergeObj: C3Request.Processor, spec: MergeAllSpec=None) -> Union[int]:
        """
        Merges an obj into multiple instances of a C3 type (e.g. mass merge). Like the {@link merge} and {@link mergeBatch}
        functions, the set of fields to be merged can be controlled by specifying an include spec in either
        {@link Mergespec#mergeInclude} or {@link Mergespec#csvInclude}.  Additionally, the objs to perform the operation on
        ...
        @overload
        @classmethod
        def mergeAll(cls, mergeObj: C3Request.Processor, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
        """
        Merges an obj into multiple instances of a C3 type (e.g. mass merge). The objs to perform the operation on can be
        controlled by specifying the {@link MergeAllSpec#filter}.  Valid filter expressions follow the same rules as in
        {@link FetchSpec#filter}.  If not specified, all instances will be merged.
        ...
        """
            ...
        @classmethod
        def removeBatch(cls, objs: Array[C3Request.Processor], spec: UpsertSpec=None) -> Union[ObjList[C3Request.Processor]]:
        """
        Removes multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
        specified (the default), then a C3BatchException will be thrown.  Otherwise {@link ObjList#errors errors} will be
        reported in the returned {@link ObjList}.
        ...
        """
            ...
        @classmethod
        def replace(cls, objs: Array[C3Request.Processor], spec: UpsertSpec=None) -> Union[ObjList[C3Request.Processor]]:
        """
        Replaces all instances of a C3 type. If the operation fails errors will be reported in the returned {@link ObjList}.
        ...
        """
            ...
        def unremove(self) -> Union[C3Request.Processor]:
        """
        Recovers archived instances of a C3 type (e.g. those removed via the {@link remove}, {@link removeAll} and
        {@link removeBatch} functions). If the operation fails an exception will be thrown.
        ...
        """
            ...
        @classmethod
        def beforeCreate(cls, objs: Array[C3Request.Processor]) -> ObjList[C3Request.Processor]:
        """
        ...
        """
            ...
        @classmethod
        def beforeUpdate(cls, objs: Array[C3Request.Processor]) -> ObjList[C3Request.Processor]:
        """
        Callback that is called synchronously during an operation that updates objs before those objs are updated.  The
        implementer can perform validation or additional logic.
        ...
        """
            ...
        @classmethod
        def beforeRemove(cls, objs: Array[C3Request.Processor]) -> ObjList[C3Request.Processor]:
        """
        Callback that is called synchronously during an operation that removes objs before those objs are removed.  The
        implementer can perform validation or additional logic.
        ...
        """
            ...
        @classmethod
        def afterCreate(cls, objs: Array[C3Request.Processor]) -> Union[Array[ObjError]]:
        """
        Callback that is called synchronously during a request that creates objs after those objs are created.  The
        implementer can perform additional logic.
        ...
        """
            ...
        @classmethod
        def afterUpdate(cls, objs: Array[C3Request.Processor]) -> Union[Array[ObjError]]:
        """
        Callback that is called synchronously during a request that updates objs after those objs are updated.  The
        implementer can perform additional logic.
        ...
        """
            ...
        @classmethod
        def afterRemove(cls, objs: Array[C3Request.Processor]) -> Union[Array[ObjError]]:
        """
        Callback that is called synchronously during a request that removes objs after those objs are removed.  The
        implementer can perform additional logic.
        ...
        """
            ...
        @classmethod
        def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[C3Request.Processor]:
        """
        @return a push stream to import instances of this type.
        """
            ...
        @classmethod
        def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[C3Request.Processor]:
        """
        @return a push stream to import instances of this type.
        """
            ...
        ...
        """
            ...
        @classmethod
        def forId(cls, id: str, failIfMissing: bool=None) -> Union[C3Request.Processor]:
        """
        @return single instance of this Identified type by id.
        """
            ...
        ...
        """
            ...
        def withoutIdentity(self) -> Union[C3Request.Processor]:
        """
        Removes the identifying fields {@link #id}, {@link #meta}, and {@link #version} of the instance it's called on,
        such that a subsequent upsert will create a new instance.
        ...
        """
            ...
        @classmethod
        def typeOfBatch(cls, objs: Array[C3Request.Processor]) -> Union[Array[EntityType]]:
        """
        Gets the specific C3 type hierarchy for multiple obj instances.  For a non-extendable type the hierarchy will be the
        C3 type of the input obj.  For extendable types it will contain the concrete extension type for the instance as well
        as that type's base type chain.
        ...
        """
            ...
        @classmethod
        def dbEcho(cls, template: C3Request.Processor=None, count: int=None, sendBack: bool=None) -> Union[int]:
        """
        Used only by DatabaseTestEngine
        """
            ...
        ...
        """
            ...
        @classmethod
        def callbackLogic(cls, objs: Array[C3Request.Processor], callback: Callable[[Union[C3Request.Processor]], Union[C3Request.Processor]]=None) -> ObjList[C3Request.Processor]:
        """
        Implements a simple logic for Persistable call-backs like before create by looping each input obj and
        calling a transform for it.
        ...
        """
            ...
        @classmethod
        def afterCallbackLogic(cls, objs: Array[C3Request.Processor], callback: Callable[[Union[C3Request.Processor]], Union[C3Request.Processor]]=None) -> Union[Array[ObjError]]:
        """
        Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
        calling a transform for it.
        """
        ...
        class Result():
            """
            The return value of {@link C3Request.Processor} lambdas which process approvals and denials.
            These fields live on {@link C3Request}, and will be merged into the processed request.
            
            @remarks this represents a made instance of C3Request.Processor.Result
            """
            ...
            Could be serialized data structures, or just a basic message.
            """
            def __init__(self, status: Optional[str]=None, result: Optional[str]=None, error: Optional[str]=None) -> None: ...
            ...
            """
                ...
            @classmethod
            def fromJson(cls, json: any) -> Union[C3Request.Processor.Result]:
            """
            Load the JSON-based representation and reconstruct the corresponding object.
            ...
            """
                ...
            @classmethod
            def fromJsonString(cls, json: str) -> Union[C3Request.Processor.Result]:
            """
            Load the JSON-based representation and reconstruct the corresponding object.
            ...
            """
                ...
            @classmethod
            def fromXmlString(cls, xml: str) -> Union[C3Request.Processor.Result]:
            """
            Load the XML-based representation and reconstruct the corresponding object.
            ...
            """
                ...
            @classmethod
            def deserialize(cls, contentStr: str, contentType: str) -> Union[C3Request.Processor.Result]:
            """
            Load from contentType representation and reconstruct the corresponding object.
            ...
            """
                ...
            def replaceType(self, old: Type, new: Type) -> C3Request.Processor.Result:
            """
            Returns new instance with all references to old type, including result of #type, replaced with new type. If new
            type does not contain fields from old or field value types are not convertable then drops the field.
            ...
            """
                ...
            @overload
            def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> C3Request.Processor.Result:
            """
            Result of this function call is a copy of current instance with all non empty fields replaced based on results of
            the `mapper` invocation.
            ...
            """
                ...
            @overload
            def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> C3Request.Processor.Result:
            """
            Result of this function call is a copy of current instance with all fields replaced based on results of the
            `mapper` invocation.
            ...
            """
                ...
            @overload
            def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[C3Request.Processor.Result]:
            """
            Result of this function call is a copy of current instance with all non empty fields replaced based on results of
            the asynchronous `mapper` invocation.
            ...
            """
                ...
            @overload
            def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[C3Request.Processor.Result]:
            """
            Result of this function call is a copy of current instance with all fields replaced based on results of the
            asynchronous `mapper` invocation.
            ...
            """
                ...
            def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> C3Request.Processor.Result:
            """
            Result of this function call is a copy of current instance with specified field value replaced based on result of
            the `mapper` invocation.
            @param field
            ...
            """
                ...
            @overload
            def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> C3Request.Processor.Result:
            """
            Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
            lambda application.
            ...
            """
                ...
            @overload
            def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> C3Request.Processor.Result:
            """
            Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
            lambda application.
            ...
            """
                ...
            @overload
            def validateObj(self) -> C3Request.Processor.Result:
            """
            Populates all missing default values and throws error if any constraint is violated.
            """
                ...
            ...
            """
                ...
            @overload
            def withField(self, field: str, value: Any, doNotConvert: bool=None) -> C3Request.Processor.Result:
            """
            Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
            defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
            ...
            """
                ...
            @overload
            def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> C3Request.Processor.Result:
            """
            Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
            defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
            ...
            """
                ...
            def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> C3Request.Processor.Result:
            """
            Builds a new Obj instance by adding the provided fields in it. The name must correspond to an existing fields
            defined on this type or its mixins. The values must be of the correct type if doNotConvert flag is true.
            ...
            """
                ...
            def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> C3Request.Processor.Result:
            """
            Builds a new Obj with the value at the specified path field. If the field is null, the field #isFieldSet to null.
            If you would like to #unsetField, you should call #withoutFieldAtPath instead.
            ...
            """
                ...
            def withoutFieldAtPath(self, path: str) -> C3Request.Processor.Result:
            """
            Builds a new Obj without the specified path field.
            ...
            """
                ...
            @overload
            def withoutField(self, field: str) -> C3Request.Processor.Result:
            """
            Builds a new Obj, removing the field with the provided name.
            ...
            """
                ...
            @overload
            def withoutField(self, field: FieldType) -> C3Request.Processor.Result:
            """
            Builds a new Obj, removing the field with the provided field type.
            ...
            """
                ...
            def withoutFields(self, fields: Array[str]) -> C3Request.Processor.Result:
            """
            Builds a new Obj, removing the fields with the provided names.
            ...
            """
                ...
            def withoutFieldsByType(self, fields: Array[FieldType]) -> C3Request.Processor.Result:
            """
            Builds a new Obj, removing the fields with the provided field types. Be sure to use the FieldType instance for the
            exact same type as the type of the obj to respect the "ordinal" of the field type
            ...
            """
                ...
            def withoutSecretFields(self) -> C3Request.Processor.Result:
            """
            @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
            """
                ...
            ...
            """
                ...
            def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> C3Request.Processor.Result:
            """
            Builds a new Obj instance by adding the default values (if defined) for all unset fields. This is implemented by
            calling {@link FieldType#defaultValue defaultValue} for a field if it is not already set and
            {@link FieldType#hasDefault has a default}. It will also set {@see ValueType#initialValue initial values} for
            ...
            """
                ...
            @overload
            def defaultField(self, field: str) -> C3Request.Processor.Result:
            """
            Builds a new Obj, by setting a field on this `Obj` to the field's default value. If the field has no default, this
            method will behave the same as {@link #unsetField}.
            ...
            """
                ...
            @overload
            def defaultField(self, field: FieldType) -> C3Request.Processor.Result:
            """
            Builds a new Obj, by setting a field on this `Obj` to the fields default value. If the field has no default, this
            method will behave the same as {@link #unsetField}.
            ...
            """
                ...
            @overload
            def unsetField(self, field: str) -> C3Request.Processor.Result:
            """
            Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
            is different from {@link removeField}
            ...
            """
                ...
            @overload
            def unsetField(self, field: FieldType) -> C3Request.Processor.Result:
            """
            Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
            is different from {@link removeField}
            ...
            """
                ...
            @overload
            def removeField(self, field: str) -> C3Request.Processor.Result:
            """
            Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
            is different from {@link #unsetField}
            ...
            """
                ...
            @overload
            def removeField(self, field: FieldType) -> C3Request.Processor.Result:
            """
            Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
            is different from {@link #unsetField}
            ...
            """
                ...
            @overload
            def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> C3Request.Processor.Result:
            """
            Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
            In case of conflicts, fields of other instance take precedence unless otherwise specified by the fieldPathMergeSpec
            ...
            """
                ...
            @overload
            def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> C3Request.Processor.Result:
            """
            Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
            In case of conflicts, fields of other instance take precedence.
            ...
            """
                ...
            @overload
            def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> C3Request.Processor.Result:
            """
            Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
            fields that exist on other Obj and do not exist on this Obj will not be added to final Obj.
            @param deep
            ...
            """
                ...
            @overload
            def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> C3Request.Processor.Result:
            """
            Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
            fields that exist other Obj and do not exist on this Obj will not be added to final Obj or evaluated. Does not
            traverse child reference and collection fields.
            ...
            """
                ...
            def mergeJson(self, json: any) -> C3Request.Processor.Result:
                ...
            def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> C3Request.Processor.Result:
            """
            Merge the obj references within the current obj
            @param deep
                   If set, traverses the reference fields within the obj as well for a deep merge
            ...
            """
                ...
            def sumObj(self, other: Obj, deep: bool=None) -> C3Request.Processor.Result:
            """
            Adds the numeric Obj fields with the other Objs respective fields.
            If deep is set it will traverse reference and collection fields and sum corresponding numeric fields in
            references with same name and collection elements at same index or key.
            """
                ...
            def singletonArray(self) -> Array[C3Request.Processor.Result]:
            """
            Build an array of the correct type with a single element which is this instance.
            ...
            """
                ...
            @classmethod
            def array(cls, *elements: Array[Any]) -> Union[Array[C3Request.Processor.Result]]:
            """
            Creates an array of instances of this type.
            """
                ...
            @classmethod
            def arrayBuilder(cls) -> Union[ArrayBuilder[C3Request.Processor.Result]]:
            """
            Creates an array of instances of this type.
            """
                ...
            def singletonSet(self) -> Set[C3Request.Processor.Result]:
            """
            Build an set of the correct type with a single element which is this instance.
            ...
            """
                ...
            @classmethod
            def setBuilder(cls) -> Union[SetBuilder[C3Request.Processor.Result]]:
            """
            Creates a set of instances of this type.
            """
                ...
            @classmethod
            def mapBuilder(cls) -> Union[MapBuilder[str, C3Request.Processor.Result]]:
            """
            Create a map of string to elements of this type.
            """
                ...
            @classmethod
            def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, C3Request.Processor.Result]]:
            """
            Create a map with the given key type and elements of this type.
            """
                ...
            ...
            def myStreamType(cls) -> StreamType:
                ...
            def toBuilder(self) -> ObjBuilder[C3Request.Processor.Result]:
            """
            @return new ObjBuilder with initial state set to fields of this instance.
            """
                ...
            @classmethod
            def builder(cls) -> ObjBuilder[C3Request.Processor.Result]:
            """
            @return new ObjBuilder of this instance.
            """
                ...
            @overload
            @classmethod
            def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> C3Request.Processor.Result:
            """
            Construct instance of this type from provided field values and options
            """
                ...
            @overload
            @classmethod
            def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> C3Request.Processor.Result:
            """
            Construct an instance of this type from provided fields
            @param fields
                       Fields to construct the instance of the obj with
            ...
            @overload
            @classmethod
            def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> C3Request.Processor.Result:
            """
            Construct instance of this type from provided field values and options
            """
                ...
            @overload
            @classmethod
            def make(cls, withDefaults: bool=None) -> C3Request.Processor.Result:
            """
            Construct an instance of this type with no non-default field values unless explicitly specified by passing param true
            @param withDefaults
                       If set, then the Obj is made with default & initial values (required primitive fields e.g. !int32 -> 0)
            ...
            @overload
            @classmethod
            def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> C3Request.Processor.Result:
            """
            Construct an instance from provided fields
            @param fields
                       Fields (in the format <field_name, value>) to construct an instance of the obj. Note that "type" as a
            ...
            @overload
            @classmethod
            def make(cls, fields: Any, withDefaults: bool=None) -> C3Request.Processor.Result:
            """
            Construct an instance of this type from provided fields. Note it is more efficient to use #fromFields and other overloads
            ...
            """
                ...
            @classmethod
            def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> C3Request.Processor.Result:
            """
            Construct an instance of this type from provided instance of a subtype or a "duck type".
            """
                ...
            ...
            """
                ...
            def afterMake(self) -> C3Request.Processor.Result:
            """
            Optional override that will be called after every instance creation.
            ...
            """
                ...
            @classmethod
            def cachedEmptyInst(cls) -> C3Request.Processor.Result:
            """
            Creates an empty inst using `MyType.make()` and caches it. Avoid recreating multiple copies of the spec for
            every action dispatch. The cached inst can also be used for comparing whether the object is an empty or not
            Will only create empty instance for immutable Obj e.g. if an Obj is Mutable, this method will throw an error
            ...
            """
                ...
            @classmethod
            def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[C3Request.Processor.Result]]:
            """
            Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
            value is read.
            """
                ...
            @classmethod
            def generateObj(cls, spec: Obj.GenerateSpec=None) -> C3Request.Processor.Result:
            """
            Generate a single instance of this type. The base implementation uses {@link DataGenObj} to generate uniform
            random (gibberish) values for all fields, but it may be overridden by specific types with custom logic that
            populates fields in a more realistic way.
    ...
    class DeciderSpec():
        """
        Spec for the decider of a {@link C3Request}.
        
        @remarks this represents a made instance of C3Request.DeciderSpec
        """
        
        comment: Optional[str]=None
        """
        Comment left by the decider about the decision
        """

        data: Optional[any]=None
        """
        Arbitrary data from the decider. Can be used to influence {@link C3Request.Processor}.
        """
        def __init__(self, comment: Optional[str]=None, data: Optional[any]=None) -> None: ...
        ...
        """
            ...
        @classmethod
        def fromJson(cls, json: any) -> Union[C3Request.DeciderSpec]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromJsonString(cls, json: str) -> Union[C3Request.DeciderSpec]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromXmlString(cls, xml: str) -> Union[C3Request.DeciderSpec]:
        """
        Load the XML-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def deserialize(cls, contentStr: str, contentType: str) -> Union[C3Request.DeciderSpec]:
        """
        Load from contentType representation and reconstruct the corresponding object.
        ...
        """
            ...
        def replaceType(self, old: Type, new: Type) -> C3Request.DeciderSpec:
        """
        Returns new instance with all references to old type, including result of #type, replaced with new type. If new
        type does not contain fields from old or field value types are not convertable then drops the field.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> C3Request.DeciderSpec:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> C3Request.DeciderSpec:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[C3Request.DeciderSpec]:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the asynchronous `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[C3Request.DeciderSpec]:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        asynchronous `mapper` invocation.
        ...
        """
            ...
        def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> C3Request.DeciderSpec:
        """
        Result of this function call is a copy of current instance with specified field value replaced based on result of
        the `mapper` invocation.
        @param field
        ...
        """
            ...
        @overload
        def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> C3Request.DeciderSpec:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> C3Request.DeciderSpec:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def validateObj(self) -> C3Request.DeciderSpec:
        """
        Populates all missing default values and throws error if any constraint is violated.
        """
            ...
        ...
        """
            ...
        @overload
        def withField(self, field: str, value: Any, doNotConvert: bool=None) -> C3Request.DeciderSpec:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        @overload
        def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> C3Request.DeciderSpec:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> C3Request.DeciderSpec:
        """
        Builds a new Obj instance by adding the provided fields in it. The name must correspond to an existing fields
        defined on this type or its mixins. The values must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> C3Request.DeciderSpec:
        """
        Builds a new Obj with the value at the specified path field. If the field is null, the field #isFieldSet to null.
        If you would like to #unsetField, you should call #withoutFieldAtPath instead.
        ...
        """
            ...
        def withoutFieldAtPath(self, path: str) -> C3Request.DeciderSpec:
        """
        Builds a new Obj without the specified path field.
        ...
        """
            ...
        @overload
        def withoutField(self, field: str) -> C3Request.DeciderSpec:
        """
        Builds a new Obj, removing the field with the provided name.
        ...
        """
            ...
        @overload
        def withoutField(self, field: FieldType) -> C3Request.DeciderSpec:
        """
        Builds a new Obj, removing the field with the provided field type.
        ...
        """
            ...
        def withoutFields(self, fields: Array[str]) -> C3Request.DeciderSpec:
        """
        Builds a new Obj, removing the fields with the provided names.
        ...
        """
            ...
        def withoutFieldsByType(self, fields: Array[FieldType]) -> C3Request.DeciderSpec:
        """
        Builds a new Obj, removing the fields with the provided field types. Be sure to use the FieldType instance for the
        exact same type as the type of the obj to respect the "ordinal" of the field type
        ...
        """
            ...
        def withoutSecretFields(self) -> C3Request.DeciderSpec:
        """
        @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
        """
            ...
        ...
        """
            ...
        def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> C3Request.DeciderSpec:
        """
        Builds a new Obj instance by adding the default values (if defined) for all unset fields. This is implemented by
        calling {@link FieldType#defaultValue defaultValue} for a field if it is not already set and
        {@link FieldType#hasDefault has a default}. It will also set {@see ValueType#initialValue initial values} for
        ...
        """
            ...
        @overload
        def defaultField(self, field: str) -> C3Request.DeciderSpec:
        """
        Builds a new Obj, by setting a field on this `Obj` to the field's default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def defaultField(self, field: FieldType) -> C3Request.DeciderSpec:
        """
        Builds a new Obj, by setting a field on this `Obj` to the fields default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def unsetField(self, field: str) -> C3Request.DeciderSpec:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def unsetField(self, field: FieldType) -> C3Request.DeciderSpec:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def removeField(self, field: str) -> C3Request.DeciderSpec:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def removeField(self, field: FieldType) -> C3Request.DeciderSpec:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> C3Request.DeciderSpec:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence unless otherwise specified by the fieldPathMergeSpec
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> C3Request.DeciderSpec:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence.
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> C3Request.DeciderSpec:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist on other Obj and do not exist on this Obj will not be added to final Obj.
        @param deep
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> C3Request.DeciderSpec:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist other Obj and do not exist on this Obj will not be added to final Obj or evaluated. Does not
        traverse child reference and collection fields.
        ...
        """
            ...
        def mergeJson(self, json: any) -> C3Request.DeciderSpec:
            ...
        def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> C3Request.DeciderSpec:
        """
        Merge the obj references within the current obj
        @param deep
               If set, traverses the reference fields within the obj as well for a deep merge
        ...
        """
            ...
        def sumObj(self, other: Obj, deep: bool=None) -> C3Request.DeciderSpec:
        """
        Adds the numeric Obj fields with the other Objs respective fields.
        If deep is set it will traverse reference and collection fields and sum corresponding numeric fields in
        references with same name and collection elements at same index or key.
        """
            ...
        def singletonArray(self) -> Array[C3Request.DeciderSpec]:
        """
        Build an array of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def array(cls, *elements: Array[Any]) -> Union[Array[C3Request.DeciderSpec]]:
        """
        Creates an array of instances of this type.
        """
            ...
        @classmethod
        def arrayBuilder(cls) -> Union[ArrayBuilder[C3Request.DeciderSpec]]:
        """
        Creates an array of instances of this type.
        """
            ...
        def singletonSet(self) -> Set[C3Request.DeciderSpec]:
        """
        Build an set of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def setBuilder(cls) -> Union[SetBuilder[C3Request.DeciderSpec]]:
        """
        Creates a set of instances of this type.
        """
            ...
        @classmethod
        def mapBuilder(cls) -> Union[MapBuilder[str, C3Request.DeciderSpec]]:
        """
        Create a map of string to elements of this type.
        """
            ...
        @classmethod
        def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, C3Request.DeciderSpec]]:
        """
        Create a map with the given key type and elements of this type.
        """
            ...
        ...
        def myStreamType(cls) -> StreamType:
            ...
        def toBuilder(self) -> ObjBuilder[C3Request.DeciderSpec]:
        """
        @return new ObjBuilder with initial state set to fields of this instance.
        """
            ...
        @classmethod
        def builder(cls) -> ObjBuilder[C3Request.DeciderSpec]:
        """
        @return new ObjBuilder of this instance.
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> C3Request.DeciderSpec:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> C3Request.DeciderSpec:
        """
        Construct an instance of this type from provided fields
        @param fields
                   Fields to construct the instance of the obj with
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> C3Request.DeciderSpec:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def make(cls, withDefaults: bool=None) -> C3Request.DeciderSpec:
        """
        Construct an instance of this type with no non-default field values unless explicitly specified by passing param true
        @param withDefaults
                   If set, then the Obj is made with default & initial values (required primitive fields e.g. !int32 -> 0)
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> C3Request.DeciderSpec:
        """
        Construct an instance from provided fields
        @param fields
                   Fields (in the format <field_name, value>) to construct an instance of the obj. Note that "type" as a
        ...
        @overload
        @classmethod
        def make(cls, fields: Any, withDefaults: bool=None) -> C3Request.DeciderSpec:
        """
        Construct an instance of this type from provided fields. Note it is more efficient to use #fromFields and other overloads
        ...
        """
            ...
        @classmethod
        def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> C3Request.DeciderSpec:
        """
        Construct an instance of this type from provided instance of a subtype or a "duck type".
        """
            ...
        ...
        """
            ...
        def afterMake(self) -> C3Request.DeciderSpec:
        """
        Optional override that will be called after every instance creation.
        ...
        """
            ...
        @classmethod
        def cachedEmptyInst(cls) -> C3Request.DeciderSpec:
        """
        Creates an empty inst using `MyType.make()` and caches it. Avoid recreating multiple copies of the spec for
        every action dispatch. The cached inst can also be used for comparing whether the object is an empty or not
        Will only create empty instance for immutable Obj e.g. if an Obj is Mutable, this method will throw an error
        ...
        """
            ...
        @classmethod
        def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[C3Request.DeciderSpec]]:
        """
        Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
        value is read.
        """
            ...
        @classmethod
        def generateObj(cls, spec: Obj.GenerateSpec=None) -> C3Request.DeciderSpec:
        """
        Generate a single instance of this type. The base implementation uses {@link DataGenObj} to generate uniform
        random (gibberish) values for all fields, but it may be overridden by specific types with custom logic that
        populates fields in a more realistic way.
    ...
    class Status():
        ...
        @remarks this represents a made instance of C3Request.Status
        """
        
        SUCCESS: Optional[str]=None
        """
        The request was processed without any errors bubbling beyond the lambda, and the lambda reporting success.
        """

        ERROR: Optional[str]=None
        """
        The request was processed with either an error bubbling beyond the lambda, or the lambda reported an error.
        """
        def __init__(self, SUCCESS: Optional[str]=None, ERROR: Optional[str]=None) -> None: ...
