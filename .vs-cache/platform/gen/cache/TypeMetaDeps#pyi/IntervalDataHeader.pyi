...
from c3.platform.IntervalDataHeader import IntervalDataHeader
...
# Python definitions for the C3 type IntervalDataHeader

TDP = TypeVar('TDP')

class IntervalDataHeader(Generic[TDP], IntervalDataFields[TDP]):
    """
    Header type is used as a pointer to the actual Timeseries data points and contains meta information about the series
    itself e.g. interval at which series needs to be normalized, unit for the series, how to deal with overlaps, etc.
    
    Mixin this type to provide meta information about the Timeseries being stored in {@link IntervalDataPoint}
    
    This type participates in normalization process (@see normalization.c3doc) which performs data cleansing on these points
    Since this object contains the meta information about the Timeseries, normalization is triggered on this type
    ...
    DO NOT mixin this type if you do not want to participate in the normalization process
    
    @see normalization#how-it-works
    @see IntervalDataPoint
    @see TimedDataHeader
    
    @remarks this represents a made instance of IntervalDataHeader
    """
    ...
    """
    def __init__(self, earliest: Optional[datetime]=None, latest: Optional[datetime]=None, earliestTsDp: Optional[Map[str, TSDataPoint]]=None, latestTsDp: Optional[Map[str, TSDataPoint]]=None, interval: Optional[str]=None, timeZone: Optional[str]=None, doNotNormalize: Optional[bool]=None, data: Optional[Array[TDP]]=None, interpolator: Optional[str]=None, duplicateHandling: Optional[str]=None, overlapHandling: Optional[str]=None, bucketInterval: Optional[str]=None, normalizationPartitionStrategy: Optional[NormalizationPartitionStrategy]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[IntervalDataHeader[TDP]]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[IntervalDataHeader[TDP]]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[IntervalDataHeader[TDP]]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[IntervalDataHeader[TDP]]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> IntervalDataHeader[TDP]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> IntervalDataHeader[TDP]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> IntervalDataHeader[TDP]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[IntervalDataHeader[TDP]]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[IntervalDataHeader[TDP]]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> IntervalDataHeader[TDP]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> IntervalDataHeader[TDP]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> IntervalDataHeader[TDP]:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> IntervalDataHeader[TDP]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> IntervalDataHeader[TDP]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> IntervalDataHeader[TDP]:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> IntervalDataHeader[TDP]:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> IntervalDataHeader[TDP]:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> IntervalDataHeader[TDP]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> IntervalDataHeader[TDP]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> IntervalDataHeader[TDP]:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> IntervalDataHeader[TDP]:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> IntervalDataHeader[TDP]:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> IntervalDataHeader[TDP]:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> IntervalDataHeader[TDP]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> IntervalDataHeader[TDP]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> IntervalDataHeader[TDP]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> IntervalDataHeader[TDP]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> IntervalDataHeader[TDP]:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> IntervalDataHeader[TDP]:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> IntervalDataHeader[TDP]:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> IntervalDataHeader[TDP]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> IntervalDataHeader[TDP]:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> IntervalDataHeader[TDP]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> IntervalDataHeader[TDP]:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> IntervalDataHeader[TDP]:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> IntervalDataHeader[TDP]:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> IntervalDataHeader[TDP]:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[IntervalDataHeader[TDP]]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[IntervalDataHeader[TDP]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[IntervalDataHeader[TDP]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[IntervalDataHeader[TDP]]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[IntervalDataHeader[TDP]]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, IntervalDataHeader[TDP]]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, IntervalDataHeader[TDP]]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[IntervalDataHeader[TDP]]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[IntervalDataHeader[TDP]]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> IntervalDataHeader[TDP]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> IntervalDataHeader[TDP]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> IntervalDataHeader[TDP]:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> IntervalDataHeader[TDP]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> IntervalDataHeader[TDP]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> IntervalDataHeader[TDP]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> IntervalDataHeader[TDP]:
    """
    ...
    """
        ...
    def afterMake(self) -> IntervalDataHeader[TDP]:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> IntervalDataHeader[TDP]:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[IntervalDataHeader[TDP]]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> IntervalDataHeader[TDP]:
    """
    ...
    """
        ...
    @classmethod
    def normalizeTimeseries(cls, timeseries: TimedDataFields[TDP]=None, start: datetime=None, end: datetime=None, overrideGrain: str=None, forceGrainDetection: bool=None, force: bool=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def normalize(cls, timeseries: TimedDataFields[TDP]=None, start: datetime=None, end: datetime=None, overrideGrain: str=None, forceGrainDetection: bool=None) -> Union[NormalizationResult]:
    """
    ...
    **Note:**`` If data is removed, there will be no incremental normalization, but the series will be fully normalized at the appropriate time as defined in the {@link NormalizationMode}.
    ...
    """
        ...
    @classmethod
    def normalizationUnit(cls, rawHeader: TimedDataFields[TDP], tsField: str) -> Union[Unit]:
    """
    ...
    """
        ...
    @classmethod
    def normalizationTreatment(cls, rawHeader: TimedDataFields[TDP], tsField: str) -> str:
    """
