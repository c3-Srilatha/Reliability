...
# Python definitions for the C3 type JettyCryptoPrivateKey


class JettyCryptoPrivateKey(CryptoPrivateKey, Singleton):
    """
    The private key of an asymmetric key pair for Jetty SSL support
    
    @remarks this represents a made instance of JettyCryptoPrivateKey
    """
    ...
    """
    A cached instance of native java Key class.
    """

    algorithm: Optional[str]
    """
    The {@link CryptoKeyAlgorithm algorithm} of the key.
    """

    pkcs: Optional[str]
    """
    Supported {@link PublicKeyCryptographyStandards pubic key cryptography standard} of the key.
    Now {@link CryptoPrivateKey CryptoPrivateKey} supports both PKCS1 and PKCS8 standards while
    {@link CryptoPublicKey CryptoPublicKey} only support PKCS8
    """

    jwtAlgorithm: Optional[str]=None
    """
    The algorithm used to verify jwt tokens using the key pair.
    """

    content: Optional[str]=None
    """
    The string representation of the key in PEM extension. The key could either be constructed with this content field
    populated or sourcing from the specified the {@link fileUrl} pointing to the key file in PEM extension.
    """

    fileUrl: Optional[str]=None
    """
    The url of the file storing the key in PEM extension on a Cloud FileSystem (ex: {@link S3 Se} or
    {@link AzureFileSystem AzureFileSystem}). The url should contains scheme (i.e. file-system) and fully qualified encoded path.
    """

    signAlgorithm: Optional[str]=None
    """
    The {@link CryptoSignatureAlgorithm} the keys will be used for.
    This is for use with the java.security.signature library
    """

    keyLength: Optional[int]=None
    """
    Key size in bits, what this represents depends on the public key crypto scheme used.
    For example, for RSA, this is the bit-length of the modulus.
    """

    daysValid: Optional[int]=None
    """
    Number of days the keys are valid since the key was generated
    """

    expiration: Optional[datetime]=None
    """
    Time the keys expire
    """

    passphrase: Optional[str]=None
    def __init__(self, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, id: Optional[str]=None, key: Optional[Any]=None, algorithm: Optional[str]=None, pkcs: Optional[str]=None, jwtAlgorithm: Optional[str]=None, content: Optional[str]=None, fileUrl: Optional[str]=None, signAlgorithm: Optional[str]=None, keyLength: Optional[int]=None, daysValid: Optional[int]=None, expiration: Optional[datetime]=None, passphrase: Optional[str]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[JettyCryptoPrivateKey]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[JettyCryptoPrivateKey]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[JettyCryptoPrivateKey]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[JettyCryptoPrivateKey]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> JettyCryptoPrivateKey:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> JettyCryptoPrivateKey:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> JettyCryptoPrivateKey:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[JettyCryptoPrivateKey]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[JettyCryptoPrivateKey]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> JettyCryptoPrivateKey:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> JettyCryptoPrivateKey:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> JettyCryptoPrivateKey:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> JettyCryptoPrivateKey:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> JettyCryptoPrivateKey:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> JettyCryptoPrivateKey:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> JettyCryptoPrivateKey:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> JettyCryptoPrivateKey:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> JettyCryptoPrivateKey:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> JettyCryptoPrivateKey:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> JettyCryptoPrivateKey:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> JettyCryptoPrivateKey:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> JettyCryptoPrivateKey:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> JettyCryptoPrivateKey:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> JettyCryptoPrivateKey:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> JettyCryptoPrivateKey:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> JettyCryptoPrivateKey:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> JettyCryptoPrivateKey:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> JettyCryptoPrivateKey:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> JettyCryptoPrivateKey:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> JettyCryptoPrivateKey:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> JettyCryptoPrivateKey:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> JettyCryptoPrivateKey:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> JettyCryptoPrivateKey:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> JettyCryptoPrivateKey:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> JettyCryptoPrivateKey:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> JettyCryptoPrivateKey:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> JettyCryptoPrivateKey:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[JettyCryptoPrivateKey]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[JettyCryptoPrivateKey]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[JettyCryptoPrivateKey]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[JettyCryptoPrivateKey]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[JettyCryptoPrivateKey]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, JettyCryptoPrivateKey]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, JettyCryptoPrivateKey]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[JettyCryptoPrivateKey]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[JettyCryptoPrivateKey]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> JettyCryptoPrivateKey:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> JettyCryptoPrivateKey:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> JettyCryptoPrivateKey:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> JettyCryptoPrivateKey:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> JettyCryptoPrivateKey:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> JettyCryptoPrivateKey:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[JettyCryptoPrivateKey]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> JettyCryptoPrivateKey:
    """
    ...
    """
        ...
    def afterMake(self) -> JettyCryptoPrivateKey:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> JettyCryptoPrivateKey:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[JettyCryptoPrivateKey]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> JettyCryptoPrivateKey:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[JettyCryptoPrivateKey]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[JettyCryptoPrivateKey]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[JettyCryptoPrivateKey]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[JettyCryptoPrivateKey]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[JettyCryptoPrivateKey]:
    """
    Returns cached instance by key, with secrets removed.
    """
        ...
    def getCached(self) -> Union[JettyCryptoPrivateKey]:
    """
    ...
    """
        ...
    def refreshCache(self) -> Union[JettyCryptoPrivateKey]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[JettyCryptoPrivateKey]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, JettyCryptoPrivateKey]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, JettyCryptoPrivateKey]]:
    """
    ...
    """
        ...
    def getConfig(self) -> JettyCryptoPrivateKey:
    """
    ...
    """
        ...
    def getSecret(self) -> JettyCryptoPrivateKey:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[JettyCryptoPrivateKey]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[JettyCryptoPrivateKey]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: JettyCryptoPrivateKey, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: JettyCryptoPrivateKey, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[JettyCryptoPrivateKey]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[JettyCryptoPrivateKey]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[JettyCryptoPrivateKey]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> JettyCryptoPrivateKey:
        ...
    @classmethod
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[JettyCryptoPrivateKey]:
    """
    ...
    """
        ...
    def nativeKey(self) -> Union[Any]:
    """
    Return an instance of native java Key class.
    """
        ...
    @classmethod
    def fromJwk(cls, jwk: str, failIfInvalid: bool=None) -> JettyCryptoPrivateKey:
    """
    Creates a new CryptoKey object from a JWK (JSON Web Key) string. The id of the CryptoKey is set to the value of
    the "kid" (key ID) field in the JWK.
    The JWK must be a valid JSON string with the required fields for the desired key.
    Currently only RSA keys are supported.
    @param jwk
       A string representing the JWK (JSON Web Key) of the public key.
    @param failIfInvalid
       If true, the function will throw an error if the JWK is invalid or cannot be parsed. Else, it will return null.
    @return
       A CryptoKey object representing the jwk.
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[CryptoPrivateKey]:
        ...
    @classmethod
    def inst(cls) -> JettyCryptoPrivateKey:
    """
    @return the one and only instance to be used when member functions are called on this type.
    """
        ...
    @classmethod
    def cachedInst(cls) -> Union[JettyCryptoPrivateKey]:
    """
