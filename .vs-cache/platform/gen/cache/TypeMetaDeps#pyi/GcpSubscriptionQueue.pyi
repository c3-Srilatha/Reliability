...
# Python definitions for the C3 type GcpSubscriptionQueue


class GcpSubscriptionQueue(CloudInvalidationQueue[GcpSubscription, SqlGcpSubscriptionQueueEntry], Value):
    """
    @remarks this represents a made instance of GcpSubscriptionQueue
    """
