...
# Python definitions for the C3 type FunctionType


class FunctionType(ValueType, Generic):
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> FunctionType:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[FunctionType]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[FunctionType]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[FunctionType]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[FunctionType]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> FunctionType:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> FunctionType:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[FunctionType]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[FunctionType]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> FunctionType:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> FunctionType:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> FunctionType:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> FunctionType:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> FunctionType:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> FunctionType:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> FunctionType:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> FunctionType:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> FunctionType:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> FunctionType:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> FunctionType:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> FunctionType:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> FunctionType:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> FunctionType:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> FunctionType:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> FunctionType:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> FunctionType:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> FunctionType:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> FunctionType:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> FunctionType:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> FunctionType:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> FunctionType:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> FunctionType:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> FunctionType:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> FunctionType:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> FunctionType:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> FunctionType:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> FunctionType:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[FunctionType]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[FunctionType]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[FunctionType]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[FunctionType]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[FunctionType]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, FunctionType]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, FunctionType]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[FunctionType]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[FunctionType]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> FunctionType:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> FunctionType:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> FunctionType:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> FunctionType:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> FunctionType:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> FunctionType:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[FunctionType]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> FunctionType:
    """
    ...
    """
        ...
    def afterMake(self) -> FunctionType:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> FunctionType:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[FunctionType]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> FunctionType:
    """
    ...
    """
        ...
    def withoutDeclaredSrcPos(self, recursive: bool=None) -> FunctionType:
    """
    ...
    """
        ...
    @overload
    def withAnnotation(self, ann: Annotation) -> FunctionType:
    """
    Add an annotation to the given metadata
    """
        ...
    @overload
    def withAnnotation(self, ann: str, annField: str=None, value: Any=None) -> FunctionType:
    """
    Add an annotation to the given metadata
    @param ann
            annotation to add
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[FunctionType]:
    """
    ...
    """
        ...
    def prototype(self) -> FunctionType:
    """
    ...
    """
        ...
    @overload
    def bindVar(self, var: str, binding: ValueType) -> FunctionType:
    """
    ...
    """
        ...
    @overload
    def bindVar(self, binding: ValueType, *bindings: Array[ValueType]) -> FunctionType:
    """
    ...
    """
        ...
    @overload
    def bindVar(self, serializedBinding: str) -> FunctionType:
        ...
    def bindVars(self, bindings: Array[ValueType]) -> FunctionType:
    """
    Bind all variables to the specified value types and return a new instance. Bindings are applied in the declaration
    / mixin order
    """
        ...
    def bindAll(self) -> FunctionType:
    """
