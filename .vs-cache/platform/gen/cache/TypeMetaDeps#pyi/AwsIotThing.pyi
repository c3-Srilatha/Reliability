...
from c3.platform.AwsIotCertificate import AwsIotCertificate
...
from c3.platform.AwsIotThingPolicy import AwsIotThingPolicy
from c3.platform.File import File

# Python definitions for the C3 type AwsIotThing


class AwsIotThing(AwsResource):
    """
    @remarks this represents a made instance of AwsIotThing
    """
    ...
    attributes: Optional[Array[StrPair]]=None
    """
    Attributes of the thing. It is optional for a thing.
    attribute1 = StrPair.make({fst: "Model", snd: "Focus"})
    attribute2 = StrPair.make({fst: "Year", snd: "2016"})
    attributes = {attribute1, attribute2}
    """

    endpoint: Optional[str]=None
    """
    The endpoint will be used as the common part for different types of Url in communication. For example,
    
    1) a device that connects with Aws Iot over the Secure Socket will use the Url as
                      "ssl://<endpoint>:8883"
    2) a device that connects with Aws Iot over the Web Socket will use the Url as
                      "wss://<endpoint>:443"
    3) a device that publishes a topic over the restful api will use the Url as
                      "https://<endpoint>/topics/<topic_name>?qos=1"
    """

    certificate: Optional[AwsIotCertificate]=None
    """
    Each thing has its own security certificate. This information will be required when you link up the device
    with Aws Iot for secure communication.
    """

    policy: Optional[AwsIotThingPolicy]=None
    def __init__(self, id: Optional[str]=None, cluster: Optional[str]=None, env: Optional[str]=None, app: Optional[str]=None, func: Optional[str]=None, role: Optional[str]=None, seq: Optional[str]=None, subseq: Optional[str]=None, resourceId: Optional[str]=None, resourceSecondaryId: Optional[str]=None, resourceName: Optional[str]=None, resourceGroupName: Optional[str]=None, fullyConfigured: Optional[bool]=None, resourceNamespace: Optional[str]=None, external: Optional[bool]=None, credentials: Optional[AwsCredentials]=None, hasGeneratedResourceName: Optional[bool]=None, hasGeneratedResourceSecondaryId: Optional[bool]=None, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, nativeMetricByName: Optional[Map[str, str]]=None, tags: Optional[Array[CloudTag]]=None, description: Optional[str]=None, parentResource: Optional[CloudResource]=None, attributes: Optional[Array[StrPair]]=None, endpoint: Optional[str]=None, certificate: Optional[AwsIotCertificate]=None, policy: Optional[AwsIotThingPolicy]=None) -> None: ...
    ...
    @overload
    @classmethod
    def fromString(cls, s: str) -> Union[AwsIotThing]:
    """
    ...
    @overload
    @classmethod
    def fromString(cls, s: str, failIfInvalid: bool=None) -> Union[AwsIotThing]:
    """
    Constructs Cloud Resource instance with reference fields and credentials based on provided Cloud Reference string.
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[AwsIotThing]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> AwsIotThing:
    """
    ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> AwsIotThing:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> AwsIotThing:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> AwsIotThing:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[AwsIotThing]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[AwsIotThing]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[AwsIotThing]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[AwsIotThing]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> AwsIotThing:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AwsIotThing:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AwsIotThing:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AwsIotThing]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AwsIotThing]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> AwsIotThing:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AwsIotThing:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AwsIotThing:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> AwsIotThing:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> AwsIotThing:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> AwsIotThing:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> AwsIotThing:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> AwsIotThing:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> AwsIotThing:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> AwsIotThing:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> AwsIotThing:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> AwsIotThing:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> AwsIotThing:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> AwsIotThing:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> AwsIotThing:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> AwsIotThing:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> AwsIotThing:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> AwsIotThing:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> AwsIotThing:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> AwsIotThing:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> AwsIotThing:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> AwsIotThing:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> AwsIotThing:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> AwsIotThing:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> AwsIotThing:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> AwsIotThing:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> AwsIotThing:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> AwsIotThing:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[AwsIotThing]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[AwsIotThing]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[AwsIotThing]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[AwsIotThing]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[AwsIotThing]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, AwsIotThing]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, AwsIotThing]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[AwsIotThing]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[AwsIotThing]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> AwsIotThing:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> AwsIotThing:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> AwsIotThing:
    """
    ...
    """
        ...
    def afterMake(self) -> AwsIotThing:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> AwsIotThing:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[AwsIotThing]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> AwsIotThing:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[AwsIotThing]:
    """
    Find Cloud Resource in Cloud Provider based on provided C3 canonical identifier.
    """
        ...
    @classmethod
    def fromClusterId(cls, clusterId: str, env: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AwsIotThing:
    """
    Construct a cloud ID from a cluster ID
    """
        ...
    @classmethod
    def fromEnvId(cls, envId: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AwsIotThing:
    """
    ...
    """
        ...
    @classmethod
    def fromAppId(cls, appId: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AwsIotThing:
    """
    ...
    """
        ...
    @classmethod
    def fromId(cls, id: str, failIfInvalid: bool=None) -> AwsIotThing:
    """
    ...
    """
        ...
    @classmethod
    def fromCloudId(cls, id: CloudId, failIfInvalid: bool=None) -> AwsIotThing:
    """
    ...
    """
        ...
    def fromConfigTemplate(self, spec: CloudResourceOperationSpec=None) -> AwsIotThing:
    """
    ...
    """
        ...
    def withDefaultConfig(self, spec: CloudResourceOperationSpec=None) -> AwsIotThing:
    """
    ...
    """
        ...
    def upsertResource(self, spec: CloudResourceOperationSpec=None) -> AwsIotThing:
    """
    Create or update Cloud Resource.
    """
        ...
    def upsertWithDependencies(self, spec: CloudResourceOperationSpec=None) -> AwsIotThing:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[AwsIotThing]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[AwsIotThing]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[AwsIotThing]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[AwsIotThing]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[AwsIotThing]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, AwsIotThing]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, AwsIotThing]]:
    """
    ...
    """
        ...
    def getConfig(self) -> AwsIotThing:
    """
    This method on any CloudResource is not supported! Use CloudResource.for* or other methods instead.
    """
        ...
    ...
    """
        ...
    def getSecret(self) -> AwsIotThing:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[AwsIotThing]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[AwsIotThing]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: AwsIotThing, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: AwsIotThing, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[AwsIotThing]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[AwsIotThing]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[AwsIotThing]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> AwsIotThing:
    """
    ...
    """
        ...
    def withIdentity(self, resource: CloudResource=None, spec: CloudResourceOperationSpec=None) -> AwsIotThing:
    """
    ...
    """
        ...
    def mergeId(self, other: CloudResource=None) -> AwsIotThing:
    """
    ...
    """
        ...
    @classmethod
    def forCloudId(cls, id: CloudId, failIfMissing: bool=None) -> Union[AwsIotThing]:
    """
    ...
    """
        ...
    @classmethod
    def forCloudFunc(cls, func: str, role: str=None, failIfMissing: bool=None) -> AwsIotThing:
    """
    Find Cloud Resource based on provided cloud func component and optional role.
    """
        ...
    @classmethod
    def forCloudRole(cls, role: str, failIfMissing: bool=None) -> AwsIotThing:
    """
    Find Cloud Resource of this type based on provided cloud role component.
    """
        ...
    @classmethod
    def forResourceId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AwsIotThing]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def forResourceSecondaryId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AwsIotThing]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forResourceName(cls, resourceName: str, failIfMissing: bool=None) -> Union[AwsIotThing]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def findResource(cls, reference: str, failIfMissing: bool=None) -> Union[AwsIotThing]:
    """
    Find Cloud Resource in the Cloud Provider by provided {@link CloudRef} string.
    """
        ...
    def getResource(self) -> Union[AwsIotThing]:
    """
    Find Cloud Resource in the Cloud Provider by provided #resourceId, #resourceSecondaryId, #resourceName or #tags
    (in that order).
    """
        ...
    def ensureResource(self) -> AwsIotThing:
    """
    Checks that the resource is persisted. If not, upserts the resource, to ensure that the resource exists.
    """
        ...
    @classmethod
    def listResourcesBySubtype(cls, spec: CloudListResourcesSpec=None) -> Map[str, CloudListResourcesResult[AwsIotThing]]:
    """
    ...
    """
        ...
    @classmethod
    def listResources(cls, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AwsIotThing]:
    """
    ...
    """
        ...
    @classmethod
    def listResourcesForTags(cls, *keyValuePairs: Array[str]) -> CloudListResourcesResult[AwsIotThing]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForClusterId(cls, clusterId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AwsIotThing]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForEnvId(cls, envId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AwsIotThing]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForAppId(cls, appId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AwsIotThing]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    def upsertDependencies(self, spec: CloudResourceOperationSpec=None) -> AwsIotThing:
    """
    ...
    """
        ...
    def waitForCreate(self, spec: WaitSpec=None) -> Union[AwsIotThing]:
    """
    ...
    """
        ...
    @classmethod
    def tagResourcesBatch(cls, resources: Array[AwsIotThing], tags: Array[CloudTag]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    @classmethod
    def untagResourcesBatch(cls, resources: Array[AwsIotThing], tagKeys: Array[str]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    def waitForOk(self, spec: WaitSpec=None) -> Union[AwsIotThing]:
    """
    ...
    """
        ...
    def waitForState(self, state: str='AVAILABLE', spec: WaitSpec=None) -> Union[AwsIotThing]:
    """
    ...
    """
        ...
    def setFullyConfigured(self, fullyConfigured: bool=None, override: str=None) -> AwsIotThing:
    """
    ...
    """
        ...
    def afterCreate(self, input: AwsIotThing=None) -> AwsIotThing:
    """
    ...
    """
        ...
    def withoutNonModifiableFields(self) -> AwsIotThing:
    """
    ...
    """
        ...
    def withResourceArn(self, resourceArn: str) -> Union[AwsIotThing]:
    """
    ...
    """
    Publish messages to an arbitrary topic. Example: vehicle.publish('status', {speed: '60mph', route: 'Shortest Time'})
    ...
    """
        ...
    def updateShadow(self, thingShadow: any) -> any:
    """
    Update the shadow of the thing. Example: vehicle.updateShadow({"speed": "80mph", "temp": "90"})
    
    @param thingShadow
               The state of thing in JSON format. Check the following link for more information
               http://docs.aws.amazon.com/iot/latest/developerguide/thing-shadow-document.html
    """
        ...
    def checkShadow(self) -> any:
    """
    Check the shadow of the thing. Example: vehicle.checkShadow()
    
    @return The thing shadow in JSON format. Check the following link for more information
            http://docs.aws.amazon.com/iot/latest/developerguide/thing-shadow-document.html
    """
        ...
    def deleteShadow(self) -> None:
    """
    Delete the shadow of the thing. Example: vehicle.deleteShadow()
    """
        ...
