...
# Python definitions for the C3 type Array

E = TypeVar('E')

class Array(Generic[E], Collection[E], CollectionWithIndex[E], CollectionConstructors[E], CollectionBuilderConstructors[ArrayBuilder[E]], CollectionInMemory[E], Value):
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[Array[E]]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[Array[E]]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[Array[E]]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[Array[E]]:
    """
    ...
    """
        ...
    def normalize(self) -> Union[Array[E]]:
        ...
    def at(self, index: int) -> Union[E]:
        ...
    def pluck(self, fieldPath: str, vtOverride: ValueType=None) -> Union[Array[T]]:
        ...
    @overload
    ...
    """
        ...
    @overload
    def first(self, n: int) -> Union[Array[E]]:
    """
    @return first element in this collection.
    """
        ...
    ...
    """
        ...
    @overload
    def last(self, n: int) -> Union[Array[E]]:
    """
    @return last element of this collection.
    """
        ...
    ...
    """
        ...
    def round(self, decimals: int=None) -> Union[Array[E]]:
        ...
    def invert(self) -> Union[Array[E]]:
        ...
    ...
    """
        ...
    @overload
    def mapToSame(self, mapper: Callable[[Union[E]], Union[E]]) -> Union[Array[E]]:
    """
    @return new collection for all elements of this collection transformed by applying provided lambda function.
    """
        ...
    @overload
    def mapToSame(self, mapper: Callable[[Union[E], Union[int]], Union[E]]) -> Union[Array[E]]:
    """
    @return new collection for all elements of this collection transformed by applying provided lambda function.
    """
        ...
    @overload
    def map(self, mapper: Callable[[Union[E]], Union[T]]) -> Union[Array[T]]:
    """
    @return new collection of any with all elements of this collection transformed by applying provided lambda function.
    """
        ...
    @overload
    def map(self, spec: FetchStreamSpec) -> Union[Array[E]]:
    """
    @return new collection based on all elements of this collection by applying provided mapping specification.
    """
        ...
    @overload
    def map(self, expr: str) -> Union[Array[T]]:
    """
    @return new array by evaluating provided expression over each element.
    """
        ...
    @overload
    def map(self, mapper: Callable[[Union[E], int], Union[T]]) -> Union[Array[T]]:
    """
    @return new collection of any with all elements of this collection transformed by applying provided lambda function.
    """
        ...
    @overload
    def mapToStr(self, mapper: Callable[[Union[E]], Union[str]]) -> Union[Array[str]]:
    """
    @return new collection of string with all elements of this collection transformed by applying provided lambda function.
    """
        ...
    @overload
    def mapToStr(self, mapper: Callable[[Union[E], int], Union[str]]) -> Union[Array[str]]:
    """
    @return new collection of string with all elements of this collection transformed by applying provided lambda function.
    """
        ...
    @overload
    def mapTo(self, elementType: ValueType, mapper: Callable[[Union[E]], Union[T]]) -> Union[Array[T]]:
    """
    ...
    """
        ...
    @overload
    def mapTo(self, elementType: ValueType, mapper: Callable[[Union[E], int], Union[T]]) -> Union[Array[T]]:
    """
    @return new collection of provided type with all elements of this collection transformed by applying provided lambda function.
    ...
    """
        ...
    @overload
    def flatMapToSame(self, mapper: Callable[[Union[E]], Union[CollectionStdLib[E]]]) -> Union[Array[E]]:
    """
    ...
    """
        ...
    @overload
    def flatMapToSame(self, mapper: Callable[[Union[E], Union[int]], Union[Array[E]]]) -> Union[Array[E]]:
    """
    ...
    """
        ...
    @overload
    def flatMap(self, mapper: Callable[[Union[E]], Union[CollectionStdLib[T]]]) -> Union[Array[T]]:
    """
    ...
    """
        ...
    @overload
    def flatMap(self, mapper: Callable[[Union[E], int], Union[Array[T]]]) -> Union[Array[T]]:
    """
    @return returns a collection of any consisting of the results of replacing each element of this collection with mapped array elements.
    """
        ...
    @overload
    def flatMapTo(self, elementType: ValueType, mapper: Callable[[Union[E]], Union[CollectionStdLib[T]]]) -> Union[Array[T]]:
    """
    ...
    """
        ...
    @overload
    def flatMapTo(self, elementType: ValueType, mapper: Callable[[Union[E], int], Union[Array[T]]]) -> Union[Array[T]]:
    """
    @return returns a collection of provided element type consisting of the results of replacing each element of this collection with mapped array elements.
    """
        ...
    def flatMapRecursive(self, toInters: Callable[[Union[E]], Union[CollectionStdLib[I]]], fromInter: Callable[[Union[I]], Union[E]]) -> Union[Array[E]]:
    """
    ...
    """
        ...
    def compact(self) -> Union[Array[E]]:
    """
    @return new collection with empty elements removed.
    """
        ...
    def unique(self) -> Union[Array[E]]:
    """
    @return new collection with duplicate elements removed.
    """
        ...
    @overload
    def uniqueBy(self, key: Callable[[Union[E]], Union[Any]]=None) -> Union[Array[E]]:
    """
    @return new collection with duplicate elements removed based on provided key supplier.
    """
        ...
    @overload
    def uniqueBy(self, key: Callable[[Union[E], Union[int]], Union[Any]]) -> Union[Array[E]]:
    """
    @return new collection with duplicate elements removed based on provided key supplier.
    """
        ...
    @overload
    def filter(self, predicate: Callable[[Union[E]], bool]) -> Union[Array[E]]:
    """
    Filters elements from this collection based on evaluation result of the provided filter predicate.
    """
        ...
    @overload
    def filter(self, filter: str) -> Union[Array[E]]:
    """
    Filters elements from this collection based on evaluation result of the provided filter predicate.
    """
        ...
    @overload
    def filter(self, fields: Map[str, Any]) -> Union[Array[E]]:
    """
    Filters elements from this collection based on evaluation result of the provided filter predicate.
    """
        ...
    @overload
    def filter(self, predicate: Callable[[Union[E], Union[int]], bool]) -> Union[Array[E]]:
    """
    Filters elements from this collection based on evaluation result of the provided filter predicate.
    """
        ...
    def fillMissingBy(self, method: str='PREVIOUS', spec: FillMissingSpec=None) -> Union[Array[E]]:
        ...
    def fillMissing(self, value: Any, spec: FillMissingSpec=None) -> Union[Array[E]]:
        ...
    ...
    def fieldValueType(self, field: str) -> Union[ValueType]:
        ...
    @overload
    def reject(self, predicate: Callable[[Union[E]], bool]) -> Union[Array[E]]:
    """
    Rejects elements from this collection based on evaluation result of the provided filter expression.
    """
        ...
    @overload
    def reject(self, predicate: Callable[[Union[E], Union[int]], bool]) -> Union[Array[E]]:
    """
    Rejects elements from this collection based on evaluation result of the provided filter expression.
    """
        ...
    @overload
    def include(self, include: str) -> Union[Array[E]]:
    """
    ...
    """
        ...
    @overload
    def include(self, positions: Collection[int]) -> Union[Array[E]]:
    """
    Maps this collection to another by removing fields from every element that are not part of the provided include
    spec. If include spec is not provided then does nothing.
    """
        ...
    def exclude(self, exclude: str) -> Union[Array[E]]:
    """
    ...
    """
        ...
    def replaceByPredicate(self, e: E, predicate: Callable[[Union[E]], bool]) -> Union[Array[E]]:
        ...
    @overload
    def sorted(self, descending: bool=None) -> Union[Array[E]]:
    """
    ...
    """
        ...
    @overload
    def sorted(self, comparator: Callable[[Union[E], Union[E]], Union[int]]) -> Union[Array[E]]:
    """
    Maps this collection to another by re-ordering elements based on natural sorting order.
    ...
    """
        ...
    @overload
    def sorted(self, descending: bool, comparator: Callable[[Union[E], Union[E]], Union[int]]) -> Union[Array[E]]:
    """
    Maps this collection to another by re-ordering elements based on natural sorting order.
    ...
    """
        ...
    @overload
    def sorted(self, order: str) -> Union[Array[E]]:
    """
    Maps this collection to another by re-ordering elements based on natural sorting order.
    ...
    """
        ...
    @overload
    def sortedBy(self, key: Callable[[Union[E]], Union[Any]]) -> Union[Array[E]]:
    """
    ...
    """
        ...
    @overload
    def sortedBy(self, descending: bool, key: Callable[[Union[E]], Union[Any]]) -> Union[Array[E]]:
    """
    Maps this collection to another by re-ordering elements based on natural sorting order of a key computed using
    provided lambda.
    """
        ...
    @overload
    def sortedBy(self, key: Callable[[Union[E], Union[int]], Union[Any]]) -> Union[Array[E]]:
    """
    Maps this collection to another by re-ordering elements based on natural sorting order of a key computed using
    provided lambda.
    """
        ...
    @overload
    def sortedBy(self, descending: bool, key: Callable[[Union[E], Union[int]], Union[Any]]) -> Union[Array[E]]:
    """
    Maps this collection to another by re-ordering elements based on natural sorting order of a key computed using
    provided lambda.
    """
    ...
    """
        ...
    def batch(self, batchSize: int=None) -> Union[Stream[Array[E]]]:
    """
    ...
    def elementCartesianProduct(self) -> Union[Array[Array[T]]]:
        ...
    @overload
    def flatten(self, shallow: bool=None) -> Union[Array[T]]:
    """
    ...
    """
        ...
    @overload
    def flatten(self, depth: int, include: str=None) -> Union[Array[T]]:
    """
    @return new collection with all nested arrays flattened. The nesting can be to any depth unless `shallow`
            parameter is `true` in which case this collection will only be flattened a single level.
    """
        ...
    def sample(self, spec: SampleSpec=None) -> Union[Array[E]]:
    """
    Produce a random sample from this collection with `count` number of elements.
    """
        ...
    @overload
    def slice(self, fromPos: int, toPos: int=None, stride: int=None) -> Union[Array[E]]:
    """
    ...
    """
        ...
    @overload
    def slice(self, positions: Collection[int]) -> Union[Array[E]]:
    """
    Creates a new collection from elements starting at #fromIndex. Positive value of index is relative to the first
    position in the collection. Negative value of the index is relative to last position in the collection.
    If #fromIndex is 0, returns same collection.
    """
        ...
    @overload
    def sliceByKey(self, keys: Collection[Any]) -> Union[Array[E]]:
        ...
    @overload
    def sliceByKey(self, secondaryIndex: str, keys: Collection[Any]) -> Union[Array[E]]:
        ...
    ...
    """
        ...
    def downsample(self, spec: DownsampleSpec) -> Union[Array[E]]:
    """
    ...
    """
        ...
    def rollingDiff(self, stride: int='1') -> Union[Array[E]]:
        ...
    def pctChange(self, stride: int='1') -> Union[Array[E]]:
        ...
    def unaryOp(self, op: str) -> Union[Array[E]]:
        ...
    def shape(self) -> Union[Array[int]]:
        ...
    def toObj(self) -> Union[Obj]:
        ...
    def fetch(self, spec: FetchSpec=None) -> Union[Array[E]]:
        ...
    ...
    def histogram(self, spec: HistogramSpec=None) -> Histogram[Any, Any, HistogramBuilder]:
        ...
    def neg(self) -> Union[Array[E]]:
        ...
    def approxMostFrequent(self, spec: CountMinSketchSpec=None) -> Union[Map[str, int]]:
        ...
    @overload
    def timeseries(self, spec: DataTimeseriesSpec=None) -> Union[Array[R]]:
        ...
    @overload
    def timeseries(self, tsFieldSpec: Map[str, TimeseriesFieldSpec], spec: TimeseriesSpec=None) -> Union[Array[R]]:
        ...
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> Array[E]:
    """
    ...
    """
        ...
    def inferType(self) -> Union[Array[E]]:
    """
    ...
    **within and across chunk/partition**, this method allows for different lambdas to be applied in each case.
    ...
    """
        ...
    def toMixingCollection(self, collectionType: CollectionType, failIfInvalid: bool=None) -> Union[Array[T]]:
    """
    ...
    """
        ...
    def boxElements(self) -> Union[Array[Boxed[E]]]:
    """
    @return copy of this collection with all elements Boxed.
    """
        ...
    def anonymize(self, spec: AnonymizationSpec=None) -> Union[Array[E]]:
    """
    ...
    """
        ...
    def withoutOutliers(self, spec: OutliersSpec='{ stddev: 2 }') -> Array[E]:
    """
    ...
    """
        ...
    def extractOutliers(self, spec: OutliersSpec='{ stddev: 2 }') -> Array[E]:
    """
    ...
    """
        ...
    @classmethod
    def intersection(cls, *collections: Array[Collection[E]]) -> Union[Array[E]]:
    """
    ...
    """
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Array[E]:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Union[Array[E]]:
    """
    ...
    """
        ...
    @overload
    def rolling(self, agg: str, offset: int, span: int, step: int=None) -> Union[Array[E]]:
    """
    ...
    """
        ...
    @classmethod
    def of(cls, elementType: ValueType, *elements: Array[T]) -> Union[Array[T]]:
    """
    @return collection of provided element type and values.
    """
        ...
    @classmethod
    def ofAny(cls, *elements: Array[T]) -> Union[Array[T]]:
    """
    @return collection of any with provided elements.
    """
        ...
    @classmethod
    def ofBool(cls, *elements: Array[bool]) -> Union[Array[bool]]:
    """
    @return collection of provided booleans.
    """
        ...
    @classmethod
    def ofInt(cls, *elements: Array[int]) -> Union[Array[int]]:
    """
    @return collection of provided 64 bit integers.
    """
        ...
    @classmethod
    def ofInt32(cls, *elements: Array[int]) -> Union[Array[int]]:
    """
    @return collection of provided 32 bit integers.
    """
        ...
    @classmethod
    def ofInt16(cls, *elements: Array[int]) -> Union[Array[int]]:
    """
    @return collection of provided 16 bit integers.
    """
        ...
    @classmethod
    def ofFloat(cls, *elements: Array[float]) -> Union[Array[float]]:
    """
    @return collection of provided floats.
    """
        ...
    @classmethod
    def ofDbl(cls, *elements: Array[float]) -> Union[Array[float]]:
    """
    @return collection of provided doubles.
    """
        ...
    @classmethod
    def ofByte(cls, *elements: Array[int]) -> Union[Array[int]]:
    """
    @return collection of provided doubles.
    """
        ...
    @classmethod
    def ofDateTime(cls, *elements: Array[datetime]) -> Union[Array[datetime]]:
    """
    @return collection of provided datetime.
    """
        ...
    @classmethod
    def ofStr(cls, *strs: Array[str]) -> Union[Array[str]]:
    """
    ...
    @overload
    @classmethod
    def ofObj(cls, *objs: Array[Obj]) -> Union[Array[Obj]]:
    """
    ...
    @overload
    @classmethod
    def ofObj(cls, type: Type, *objs: Array[Obj]) -> Union[Array[O]]:
    """
    @return collection of provided C3 type and provided instances.
    """
        ...
    @classmethod
    def ofIntInRange(cls, min: int, max: int, step: int=None) -> Union[Array[int]]:
    """
    @return collection of provided integers in a range.
    """
        ...
    @classmethod
    def ofInt32InRange(cls, min: int, max: int, step: int=None) -> Union[Array[int]]:
    """
    @return collection of provided integers in a range.
    """
        ...
    @classmethod
    def builderOf(cls, elementType: ValueType, *elements: Array[T]) -> ArrayBuilder[T]:
    """
    @return collection of provided element type and values.
    """
        ...
    @classmethod
    def builderOfAny(cls, *elements: Array[T]) -> ArrayBuilder[T]:
    """
    @return collection of any with provided elements.
    """
        ...
    @classmethod
    def builderOfInt(cls, *elements: Array[int]) -> ArrayBuilder[int]:
    """
    @return collection of provided 64 bit integers.
    """
        ...
    @classmethod
    def builderOfInt32(cls, *elements: Array[int]) -> ArrayBuilder[int]:
    """
    @return collection of provided 32 bit integers.
    """
        ...
    @classmethod
    def builderOfInt16(cls, *elements: Array[int]) -> ArrayBuilder[int]:
    """
    @return collection of provided 16 bit integers.
    """
        ...
    @classmethod
    def builderOfFloat(cls, *elements: Array[float]) -> ArrayBuilder[float]:
    """
    @return collection of provided floats.
    """
        ...
    @classmethod
    def builderOfDbl(cls, *elements: Array[float]) -> ArrayBuilder[float]:
    """
    @return collection of provided doubles.
    """
        ...
    @classmethod
    def builderOfStr(cls, *strs: Array[str]) -> ArrayBuilder[str]:
    """
    @return collection of provided string.
    """
        ...
    @classmethod
    def builderOfByte(cls, *bytes: Array[int]) -> ArrayBuilder[int]:
    """
    @return collection of provided byte.
    """
        ...
    @classmethod
    def builderOfBool(cls, *bools: Array[bool]) -> ArrayBuilder[bool]:
    """
    @return collection of provided booleans.
    """
        ...
    @classmethod
    def builderOfDateTime(cls, *datetimes: Array[datetime]) -> ArrayBuilder[datetime]:
    """
    @return collection of provided byte.
    """
        ...
    @overload
    @classmethod
    def builderOfObj(cls, *objs: Array[Obj]) -> ArrayBuilder[Obj]:
    """
    @return collection of generic obj and provided instances.
    """
        ...
    @overload
    @classmethod
    def builderOfObj(cls, type: Type, *objs: Array[Obj]) -> ArrayBuilder[O]:
    """
    @return collection of provided C3 type and provided instances.
    """
        ...
    ...
    """
        ...
    def reversed(self) -> Union[Array[E]]:
    """
    ...
    """
        ...
    @overload
    def withIfMissing(self, e: E) -> Array[E]:
    """
    @return new collection with new element added to it if it is not already present.
    """
        ...
    @overload
    def withIfMissing(self, e: E, predicate: Callable[[Union[E]], bool]) -> Array[E]:
    """
    ...
    """
        ...
    @classmethod
    def union(cls, *collections: Array[Collection[T]]) -> Union[Array[T]]:
    """
    @return new array of unique items, in order, that are present in one or more of the input collections.
    """
        ...
    def toBuilder(self) -> Union[ArrayBuilder[E]]:
    """
    @return new instance of ArrayBuilder with current array's content as initial content.
    """
        ...
    @classmethod
    def build(cls, elementType: ValueType, builder: Callable[[ArrayBuilder[T]]]) -> Union[Array[T]]:
    """
    @return new instance of array of provided element type by applying builder lambda.
    """
        ...
    @classmethod
    def buildAny(cls, builder: Callable[[ArrayBuilder[T]]]) -> Union[Array[T]]:
    """
    @return new instance of array of any by applying builder lambda.
    """
        ...
    @classmethod
    def buildInts(cls, builder: Callable[[ArrayBuilder[int]]]) -> Union[Array[int]]:
    """
    @return new instance of array of ints by applying builder lambda.
    """
        ...
    @classmethod
    def buildInt32s(cls, builder: Callable[[ArrayBuilder[int]]]) -> Union[Array[int]]:
    """
    @return new instance of array of ints by applying builder lambda.
    """
        ...
    @classmethod
    def buildFloats(cls, builder: Callable[[ArrayBuilder[float]]]) -> Union[Array[float]]:
    """
    @return new instance of array of floats by applying builder lambda.
    """
        ...
    @classmethod
    def buildDbls(cls, builder: Callable[[ArrayBuilder[float]]]) -> Union[Array[float]]:
    """
    @return new instance of array of doubles by applying builder lambda.
    """
        ...
    @classmethod
    def buildStrs(cls, builder: Callable[[ArrayBuilder[str]]]) -> Union[Array[str]]:
    """
    @return new instance of array of string by applying builder lambda.
    """
        ...
    @classmethod
    def buildBool(cls, builder: Callable[[ArrayBuilder[bool]]]) -> Union[Array[bool]]:
    """
    @return new instance of array of booleans by applying builder lambda.
    """
        ...
    @classmethod
    def buildObjs(cls, type: Type, builder: Callable[[ArrayBuilder[O]]]) -> Union[Array[O]]:
    """
    ...
    @overload
    @classmethod
    def repeat(cls, elementType: ValueType, size: int, element: T=None) -> Union[Array[T]]:
    """
    ...
    @overload
    @classmethod
    def repeat(cls, elementType: ValueType, counts: Array[int], elements: Array[T]) -> Union[Array[T]]:
    """
    Optimized implementation of a repeated Array that consumes minimal memory and is fast to instantiate. Use this
    ...
    """
        ...
    @classmethod
    def pattern(cls, elementType: ValueType, size: int, element: Callable[[Union[int]], Union[T]]) -> Union[Array[T]]:
    """
    ...
    """
        ...
    @classmethod
    def patternOfInt(cls, size: int, element: Callable[[Union[int]], Union[int]]) -> Union[Array[int]]:
    """
    ...
    """
        ...
    @classmethod
    def patternOfDbl(cls, size: int, element: Callable[[Union[int]], Union[float]]) -> Union[Array[float]]:
    """
    ...
    """
        ...
    def withFirst(self, *values: Array[E]) -> Array[E]:
    """
    ...
    """
        ...
    def withFill(self, value: E, start: int=None, end: int=None) -> Union[Array[E]]:
    """
    ...
    """
        ...
    @overload
    def withSplice(self, start: int) -> Union[Array[E]]:
    """
    ...
    """
        ...
    @overload
    def withSplice(self, start: int, *items: Array[E], count: int=None) -> Union[Array[E]]:
    """
    ...
    """
        ...
    def atOf(self, index: int, vt: ValueType) -> T:
    """
