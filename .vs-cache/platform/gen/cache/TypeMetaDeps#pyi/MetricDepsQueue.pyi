...
from c3.platform.MetricDepsQueueEntry import MetricDepsQueueEntry
...
# Python definitions for the C3 type MetricDepsQueue


class MetricDepsQueue(InvalidationQueue[MetricDepsQueueEntry], MergeableInvalidationQueue[MetricDepsQueueEntry], Value):
    """
    ...
    @classmethod
    def compute(cls, targetType: Type, entries: Array[MetricDepsQueueEntry]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, spec: InvalidationQueue.FindSpec=None) -> Union[Array[MetricDepsQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def findStream(cls, spec: InvalidationQueue.FindStreamSpec=None) -> Union[Stream[MetricDepsQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def clearEntries(cls, entries: Array[MetricDepsQueueEntry]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def mergeContexts(cls, targetType: Type=None, entries: Array[MetricDepsQueueEntry]=None) -> Union[Array[MetricDepsQueueEntry]]:
    """
