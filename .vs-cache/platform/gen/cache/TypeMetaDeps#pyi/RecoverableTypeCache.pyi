...
# Python definitions for the C3 type RecoverableTypeCache


class RecoverableTypeCache(MetadataCacheOld[[Type]], Value):
    """
    ...
    @classmethod
    def get(cls, key: str) -> Union[Array[Type]]:
    """
    ...
    """
        ...
    @classmethod
    def require(cls, key: str) -> Array[Type]:
    """
    ...
    """
        ...
    @classmethod
    def put(cls, key: str, value: Array[Type]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[Array[Type]]:
    """
    ...
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, Array[Type]]]:
    """
    ...
    """
        ...
    @classmethod
    def release(cls, key: str, value: Array[Type]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def validate(cls, value: Array[Type]) -> bool:
    """
