...
# Python definitions for the C3 type Client
...
class Client(Value):
    ...
    @classmethod
    def init(cls, validMinutes: int=None) -> Union[ClientContext]:
    """
    ...
    """
        ...
    @classmethod
    def getTag(cls, tagId: str) -> Union[Tag]:
    """
    Retrieves client context.
    ...
    """
        ...
    @classmethod
    def copyFilesToLocalClient(cls, srcUrlOrEncodedPath: str, localPath: str, spec: FileOperationSpec=None) -> int:
    """
    ...
    """
        ...
    @classmethod
    def downloadFiles(cls, destFilesAndSrcPaths: Array[Pair[Any, str]], spec: FileOperationSpec=None) -> int:
    """
    ...
    """
        ...
    @classmethod
    def downloadFile(cls, destFile: Any, srcPath: str, spec: FileOperationSpec=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def uploadLocalClientFiles(cls, localPath: str, dstUrlOrEncodedPath: str, spec: FileOperationSpec=None) -> int:
    """
    ...
    """
        ...
    @classmethod
    def uploadFiles(cls, filesAndDestPaths: Array[Pair[Any, str]], spec: FileOperationSpec=None) -> int:
    """
    ...
    """
        ...
    @classmethod
    def uploadFile(cls, srcFile: Any, dstPath: str, spec: FileOperationSpec=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def executeConcurrently(cls, func: Any, args: Array[Any], maxConcurrency: int=None) -> Union[Array[Any]]:
    """
    ...
    """
        ...
    @classmethod
    def retry(cls, func: Callable[[]], spec: RetrySpec=None) -> None:
    """
    ...
    class Singleton(Singleton):
        ...
        """
            ...
        @classmethod
        def fromJson(cls, json: any) -> Union[Client.Singleton]:
        """
        ...
        """
            ...
        @classmethod
        def fromJsonString(cls, json: str) -> Union[Client.Singleton]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromXmlString(cls, xml: str) -> Union[Client.Singleton]:
        """
        ...
        """
            ...
        @classmethod
        def deserialize(cls, contentStr: str, contentType: str) -> Union[Client.Singleton]:
        """
        ...
        """
            ...
        def replaceType(self, old: Type, new: Type) -> Client.Singleton:
        """
        ...
        """
            ...
        @overload
        def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Client.Singleton:
        """
        ...
        """
            ...
        @overload
        def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Client.Singleton:
        """
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Client.Singleton]:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Client.Singleton]:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        ...
        """
            ...
        def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> Client.Singleton:
        """
        ...
        """
            ...
        @overload
        def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Client.Singleton:
        """
        ...
        """
            ...
        @overload
        def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Client.Singleton:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def validateObj(self) -> Client.Singleton:
        """
        ...
        """
            ...
        @overload
        def withField(self, field: str, value: Any, doNotConvert: bool=None) -> Client.Singleton:
        """
        ...
        """
            ...
        @overload
        def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> Client.Singleton:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> Client.Singleton:
        """
        ...
        """
            ...
        def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> Client.Singleton:
        """
        ...
        """
            ...
        def withoutFieldAtPath(self, path: str) -> Client.Singleton:
        """
        ...
        """
            ...
        @overload
        def withoutField(self, field: str) -> Client.Singleton:
        """
        ...
        """
            ...
        @overload
        def withoutField(self, field: FieldType) -> Client.Singleton:
        """
        ...
        """
            ...
        def withoutFields(self, fields: Array[str]) -> Client.Singleton:
        """
        ...
        """
            ...
        def withoutFieldsByType(self, fields: Array[FieldType]) -> Client.Singleton:
        """
        ...
        """
            ...
        def withoutSecretFields(self) -> Client.Singleton:
        """
        ...
        """
            ...
        def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Client.Singleton:
        """
        ...
        """
            ...
        @overload
        def defaultField(self, field: str) -> Client.Singleton:
        """
        ...
        """
            ...
        @overload
        def defaultField(self, field: FieldType) -> Client.Singleton:
        """
        ...
        """
            ...
        @overload
        def unsetField(self, field: str) -> Client.Singleton:
        """
        ...
        """
            ...
        @overload
        def unsetField(self, field: FieldType) -> Client.Singleton:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def removeField(self, field: str) -> Client.Singleton:
        """
        ...
        """
            ...
        @overload
        def removeField(self, field: FieldType) -> Client.Singleton:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> Client.Singleton:
        """
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> Client.Singleton:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> Client.Singleton:
        """
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> Client.Singleton:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        ...
        """
            ...
        def mergeJson(self, json: any) -> Client.Singleton:
            ...
        def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Client.Singleton:
        """
        ...
        """
            ...
        def sumObj(self, other: Obj, deep: bool=None) -> Client.Singleton:
        """
        ...
        """
            ...
        def singletonArray(self) -> Array[Client.Singleton]:
        """
        ...
        """
            ...
        @classmethod
        def array(cls, *elements: Array[Any]) -> Union[Array[Client.Singleton]]:
        """
        Creates an array of instances of this type.
        """
            ...
        @classmethod
        def arrayBuilder(cls) -> Union[ArrayBuilder[Client.Singleton]]:
        """
        Creates an array of instances of this type.
        """
            ...
        def singletonSet(self) -> Set[Client.Singleton]:
        """
        ...
        """
            ...
        @classmethod
        def setBuilder(cls) -> Union[SetBuilder[Client.Singleton]]:
        """
        Creates a set of instances of this type.
        """
            ...
        @classmethod
        def mapBuilder(cls) -> Union[MapBuilder[str, Client.Singleton]]:
        """
        Create a map of string to elements of this type.
        """
            ...
        @classmethod
        def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, Client.Singleton]]:
        """
        ...
        def myStreamType(cls) -> StreamType:
            ...
        def toBuilder(self) -> ObjBuilder[Client.Singleton]:
        """
        @return new ObjBuilder with initial state set to fields of this instance.
        """
            ...
        @classmethod
        def builder(cls) -> ObjBuilder[Client.Singleton]:
        """
        ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> Client.Singleton:
        """
        ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> Client.Singleton:
        """
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> Client.Singleton:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def make(cls, withDefaults: bool=None) -> Client.Singleton:
        """
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> Client.Singleton:
        """
        ...
        @overload
        @classmethod
        def make(cls, fields: Any, withDefaults: bool=None) -> Client.Singleton:
        """
        ...
        """
            ...
        @classmethod
        def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> Client.Singleton:
        """
        ...
        """
            ...
        def afterMake(self) -> Client.Singleton:
        """
        ...
        """
            ...
        @classmethod
        def cachedEmptyInst(cls) -> Client.Singleton:
        """
        ...
        """
            ...
        @classmethod
        def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[Client.Singleton]]:
        """
        ...
        """
            ...
        @classmethod
        def generateObj(cls, spec: Obj.GenerateSpec=None) -> Client.Singleton:
        """
