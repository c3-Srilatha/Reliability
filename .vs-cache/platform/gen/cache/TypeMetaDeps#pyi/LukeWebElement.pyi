...
# Python definitions for the C3 type LukeWebElement

T = TypeVar('T')

class LukeWebElement(Generic[T], LukeAsyncQueueNode):
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> LukeWebElement[T]:
    """
    ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> LukeWebElement[T]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> LukeWebElement[T]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> LukeWebElement[T]:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[LukeWebElement[T]]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[LukeWebElement[T]]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[LukeWebElement[T]]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[LukeWebElement[T]]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> LukeWebElement[T]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> LukeWebElement[T]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> LukeWebElement[T]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[LukeWebElement[T]]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[LukeWebElement[T]]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> LukeWebElement[T]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> LukeWebElement[T]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> LukeWebElement[T]:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> LukeWebElement[T]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> LukeWebElement[T]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> LukeWebElement[T]:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> LukeWebElement[T]:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> LukeWebElement[T]:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> LukeWebElement[T]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> LukeWebElement[T]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> LukeWebElement[T]:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> LukeWebElement[T]:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> LukeWebElement[T]:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> LukeWebElement[T]:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> LukeWebElement[T]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> LukeWebElement[T]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> LukeWebElement[T]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> LukeWebElement[T]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> LukeWebElement[T]:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> LukeWebElement[T]:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> LukeWebElement[T]:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> LukeWebElement[T]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> LukeWebElement[T]:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> LukeWebElement[T]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> LukeWebElement[T]:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> LukeWebElement[T]:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> LukeWebElement[T]:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> LukeWebElement[T]:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[LukeWebElement[T]]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[LukeWebElement[T]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[LukeWebElement[T]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[LukeWebElement[T]]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[LukeWebElement[T]]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, LukeWebElement[T]]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, LukeWebElement[T]]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[LukeWebElement[T]]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[LukeWebElement[T]]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> LukeWebElement[T]:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> LukeWebElement[T]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> LukeWebElement[T]:
    """
    ...
    """
        ...
    def afterMake(self) -> LukeWebElement[T]:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> LukeWebElement[T]:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[LukeWebElement[T]]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> LukeWebElement[T]:
    """
    ...
    """
        ...
    @overload
    def setField(self, field: str, value: Any, doNotConvert: bool=None) -> LukeWebElement[T]:
    """
    ...
    """
        ...
    @overload
    def setField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> LukeWebElement[T]:
    """
    Sets the mutable field value. The name must correspond to an existing field defined on this type or its mixins.
    The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def scrollIntoView(self) -> Union[T]:
    """
    ...
    """
        ...
    def moveTo(self, xOffset: int='0', yOffset: int='0') -> Union[T]:
    """
    ...
    """
        ...
    def search(self, selector: str, resolveOnFound: bool=None) -> Union[T]:
    """
    ...
    """
        ...
    def searchAll(self, selector: str, resolveOnFound: bool=None) -> Union[LukeAsyncQueueCollection[T]]:
    """
    ...
    """
        ...
    def searchForElementWithText(self, selector: str, text: Union[str,LukeDynamicValue], resolveOnFound: bool=None) -> Union[T]:
    """
    ...
    """
        ...
    def setValue(self, value: Union[str,int,bool,LukeDynamicValue]=None) -> Union[T]:
    """
    ...
    """
        ...
    def selectByIndex(self, index: int=None) -> Union[T]:
    """
    ...
    """
        ...
    def selectByValue(self, value: str=None) -> Union[T]:
    """
    ...
    """
        ...
    def trigger(self, eventType: str, extraArguments: Obj=None, eventCategory: str=None) -> T:
    """
    ...
    """
        ...
    def parentElement(self) -> Union[T]:
    """
    ...
    """
        ...
    def pressEnterKey(self) -> Union[T]:
    """
    Triggers the event of pressing the enter key on the element.
    @return The {@link LukeWebElement} that will resolve the same dom element
    """
        ...
    def toggle(self, checked: bool=None) -> Union[T]:
    """
