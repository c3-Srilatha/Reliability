...
# Python definitions for the C3 type SqlThrottlingOptions


class SqlThrottlingOptions(Config, Singleton):
    """
    @remarks this represents a made instance of SqlThrottlingOptions
    """
    ...
    maxActiveStmts: Optional[int]=None
    """
    target for maximum concurrent active sql sessions; -1 disables throttling
    """

    throttleOnlySelects: Optional[bool]=None
    """
    only throttle SELECT statements
    """

    throttleStmtMinLatency: Optional[int]=None
    """
    minimum expected latency to start statement throttling
    """

    sampleStmtMinLatency: Optional[int]=None
    """
    minimum sql statement latency in ms that is considered an active session
    """

    samplingPeriod: Optional[int]=None
    """
    period to check my sql active sessions in ms
    """

    broadcastPeriod: Optional[int]=None
    """
    period to notify others about cluster sql active sessions in ms
    """

    busySleep: Optional[int]=None
    """
    if db active sessions is high then sleep for this interval in ms
    """

    maxBusyWaitMinute: Optional[int]=None
    """
    even if db active sessions is high do not sleep more then this many
    minutes
    """
    def __init__(self, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, maxActiveStmts: Optional[int]=None, throttleOnlySelects: Optional[bool]=None, throttleStmtMinLatency: Optional[int]=None, sampleStmtMinLatency: Optional[int]=None, samplingPeriod: Optional[int]=None, broadcastPeriod: Optional[int]=None, busySleep: Optional[int]=None, maxBusyWaitMinute: Optional[int]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[SqlThrottlingOptions]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[SqlThrottlingOptions]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[SqlThrottlingOptions]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[SqlThrottlingOptions]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> SqlThrottlingOptions:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> SqlThrottlingOptions:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> SqlThrottlingOptions:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[SqlThrottlingOptions]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[SqlThrottlingOptions]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> SqlThrottlingOptions:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> SqlThrottlingOptions:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> SqlThrottlingOptions:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> SqlThrottlingOptions:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> SqlThrottlingOptions:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> SqlThrottlingOptions:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> SqlThrottlingOptions:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> SqlThrottlingOptions:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> SqlThrottlingOptions:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> SqlThrottlingOptions:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> SqlThrottlingOptions:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> SqlThrottlingOptions:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> SqlThrottlingOptions:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> SqlThrottlingOptions:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> SqlThrottlingOptions:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> SqlThrottlingOptions:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> SqlThrottlingOptions:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> SqlThrottlingOptions:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> SqlThrottlingOptions:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> SqlThrottlingOptions:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> SqlThrottlingOptions:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> SqlThrottlingOptions:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> SqlThrottlingOptions:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> SqlThrottlingOptions:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> SqlThrottlingOptions:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> SqlThrottlingOptions:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> SqlThrottlingOptions:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> SqlThrottlingOptions:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[SqlThrottlingOptions]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[SqlThrottlingOptions]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[SqlThrottlingOptions]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[SqlThrottlingOptions]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[SqlThrottlingOptions]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, SqlThrottlingOptions]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, SqlThrottlingOptions]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[SqlThrottlingOptions]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[SqlThrottlingOptions]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> SqlThrottlingOptions:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> SqlThrottlingOptions:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> SqlThrottlingOptions:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> SqlThrottlingOptions:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> SqlThrottlingOptions:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> SqlThrottlingOptions:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> SqlThrottlingOptions:
    """
    ...
    """
        ...
    def afterMake(self) -> SqlThrottlingOptions:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> SqlThrottlingOptions:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[SqlThrottlingOptions]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> SqlThrottlingOptions:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[SqlThrottlingOptions]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[SqlThrottlingOptions]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[SqlThrottlingOptions]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[SqlThrottlingOptions]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[SqlThrottlingOptions]:
    """
    Returns cached instance by key, with secrets removed.
    """
        ...
    def getCached(self) -> Union[SqlThrottlingOptions]:
    """
    ...
    """
        ...
    def refreshCache(self) -> Union[SqlThrottlingOptions]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[SqlThrottlingOptions]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, SqlThrottlingOptions]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, SqlThrottlingOptions]]:
    """
    ...
    """
        ...
    def getConfig(self) -> SqlThrottlingOptions:
    """
    ...
    """
        ...
    def getSecret(self) -> SqlThrottlingOptions:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[SqlThrottlingOptions]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[SqlThrottlingOptions]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: SqlThrottlingOptions, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: SqlThrottlingOptions, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[SqlThrottlingOptions]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[SqlThrottlingOptions]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[SqlThrottlingOptions]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> SqlThrottlingOptions:
    """
