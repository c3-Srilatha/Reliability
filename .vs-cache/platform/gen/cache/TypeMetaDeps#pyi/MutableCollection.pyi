...
from c3.platform.MutableCollection import MutableCollection
...
# Python definitions for the C3 type MutableCollection

E = TypeVar('E')

class MutableCollection(Generic[E], Collection[E], Mutable, Value):
    """
    Mutable Collection instances allow their content to be changed.
    
    @remarks this represents a made instance of MutableCollection
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[MutableCollection[E]]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[MutableCollection[E]]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[MutableCollection[E]]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[MutableCollection[E]]:
    """
    ...
    """
        ...
    def abs(self) -> Union[MutableCollection[E]]:
        ...
    @overload
    ...
    """
        ...
    def normalize(self) -> Union[MutableCollection[E]]:
        ...
    def at(self, index: int) -> Union[E]:
        ...
    def pluck(self, fieldPath: str, vtOverride: ValueType=None) -> Union[MutableCollection[T]]:
        ...
    @overload
    ...
    """
        ...
    @overload
    def first(self, n: int) -> Union[MutableCollection[E]]:
    """
    @return first element in this collection.
    """
        ...
    ...
    """
        ...
    @overload
    def last(self, n: int) -> Union[MutableCollection[E]]:
    """
    @return last element of this collection.
    """
        ...
    ...
    """
        ...
    def round(self, decimals: int=None) -> Union[MutableCollection[E]]:
        ...
    def invert(self) -> Union[MutableCollection[E]]:
        ...
    ...
    """
        ...
    def flatMapToSame(self, mapper: Callable[[Union[E]], Union[CollectionStdLib[E]]]) -> Union[MutableCollection[E]]:
    """
    ...
    """
        ...
    def flatMap(self, mapper: Callable[[Union[E]], Union[CollectionStdLib[T]]]) -> Union[MutableCollection[T]]:
    """
    ...
    """
        ...
    def flatMapTo(self, elementType: ValueType, mapper: Callable[[Union[E]], Union[CollectionStdLib[T]]]) -> Union[MutableCollection[T]]:
    """
    ...
    """
        ...
    def flatMapRecursive(self, toInters: Callable[[Union[E]], Union[CollectionStdLib[I]]], fromInter: Callable[[Union[I]], Union[E]]) -> Union[MutableCollection[E]]:
    """
    ...
    """
        ...
    def compact(self) -> Union[MutableCollection[E]]:
    """
    @return new collection with empty elements removed.
    """
        ...
    def unique(self) -> Union[MutableCollection[E]]:
    """
    @return new collection with duplicate elements removed.
    """
        ...
    def uniqueBy(self, key: Callable[[Union[E]], Union[Any]]=None) -> Union[MutableCollection[E]]:
    """
    @return new collection with duplicate elements removed based on provided key supplier.
    """
        ...
    @overload
    def filter(self, predicate: Callable[[Union[E]], bool]) -> Union[MutableCollection[E]]:
    """
    Filters elements from this collection based on evaluation result of the provided filter predicate.
    """
        ...
    @overload
    def filter(self, filter: str) -> Union[MutableCollection[E]]:
    """
    Filters elements from this collection based on evaluation result of the provided filter predicate.
    """
        ...
    @overload
    def filter(self, fields: Map[str, Any]) -> Union[MutableCollection[E]]:
    """
    Filters elements from this collection based on evaluation result of the provided filter predicate.
    """
        ...
    def fillMissingBy(self, method: str='PREVIOUS', spec: FillMissingSpec=None) -> Union[MutableCollection[E]]:
        ...
    def fillMissing(self, value: Any, spec: FillMissingSpec=None) -> Union[MutableCollection[E]]:
        ...
    def fieldNames(self) -> Union[Array[str]]:
        ...
    def fieldValueType(self, field: str) -> Union[ValueType]:
        ...
    def reject(self, predicate: Callable[[Union[E]], bool]) -> Union[MutableCollection[E]]:
    """
    Rejects elements from this collection based on evaluation result of the provided filter expression.
    """
        ...
    @overload
    def include(self, include: str) -> Union[MutableCollection[E]]:
    """
    ...
    """
        ...
    @overload
    def include(self, positions: Collection[int]) -> Union[MutableCollection[E]]:
    """
    Maps this collection to another by removing fields from every element that are not part of the provided include
    spec. If include spec is not provided then does nothing.
    """
        ...
    def exclude(self, exclude: str) -> Union[MutableCollection[E]]:
    """
    ...
    """
        ...
    def replaceByPredicate(self, e: E, predicate: Callable[[Union[E]], bool]) -> Union[MutableCollection[E]]:
        ...
    @overload
    def sorted(self, descending: bool=None) -> Union[MutableCollection[E]]:
    """
    ...
    """
        ...
    @overload
    def sorted(self, comparator: Callable[[Union[E], Union[E]], Union[int]]) -> Union[MutableCollection[E]]:
    """
    Maps this collection to another by re-ordering elements based on natural sorting order.
    ...
    """
        ...
    @overload
    def sorted(self, descending: bool, comparator: Callable[[Union[E], Union[E]], Union[int]]) -> Union[MutableCollection[E]]:
    """
    Maps this collection to another by re-ordering elements based on natural sorting order.
    ...
    """
        ...
    @overload
    def sorted(self, order: str) -> Union[MutableCollection[E]]:
    """
    Maps this collection to another by re-ordering elements based on natural sorting order.
    ...
    """
        ...
    @overload
    def sortedBy(self, key: Callable[[Union[E]], Union[Any]]) -> Union[MutableCollection[E]]:
    """
    ...
    """
        ...
    @overload
    def sortedBy(self, descending: bool, key: Callable[[Union[E]], Union[Any]]) -> Union[MutableCollection[E]]:
    """
    Maps this collection to another by re-ordering elements based on natural sorting order of a key computed using
    provided lambda.
    """
    ...
    """
        ...
    def batch(self, batchSize: int=None) -> Union[Stream[MutableCollection[E]]]:
    """
    ...
    def elementCartesianProduct(self) -> Union[Array[Array[T]]]:
        ...
    @overload
    def flatten(self, shallow: bool=None) -> Union[MutableCollection[T]]:
    """
    ...
    """
        ...
    @overload
    def flatten(self, depth: int, include: str=None) -> Union[MutableCollection[T]]:
    """
    @return new collection with all nested arrays flattened. The nesting can be to any depth unless `shallow`
            parameter is `true` in which case this collection will only be flattened a single level.
    """
        ...
    def sample(self, spec: SampleSpec=None) -> Union[MutableCollection[E]]:
    """
    Produce a random sample from this collection with `count` number of elements.
    """
        ...
    @overload
    def slice(self, fromPos: int, toPos: int=None, stride: int=None) -> Union[MutableCollection[E]]:
    """
    ...
    """
        ...
    @overload
    def slice(self, positions: Collection[int]) -> Union[MutableCollection[E]]:
    """
    Creates a new collection from elements starting at #fromIndex. Positive value of index is relative to the first
    position in the collection. Negative value of the index is relative to last position in the collection.
    If #fromIndex is 0, returns same collection.
    """
        ...
    @overload
    def sliceByKey(self, keys: Collection[Any]) -> Union[MutableCollection[E]]:
        ...
    @overload
    def sliceByKey(self, secondaryIndex: str, keys: Collection[Any]) -> Union[MutableCollection[E]]:
        ...
    ...
    """
        ...
    def downsample(self, spec: DownsampleSpec) -> Union[MutableCollection[E]]:
    """
    ...
    """
        ...
    def rollingDiff(self, stride: int='1') -> Union[MutableCollection[E]]:
        ...
    def pctChange(self, stride: int='1') -> Union[MutableCollection[E]]:
        ...
    def unaryOp(self, op: str) -> Union[MutableCollection[E]]:
        ...
    def shape(self) -> Union[Array[int]]:
        ...
    def toObj(self) -> Union[Obj]:
        ...
    def fetch(self, spec: FetchSpec=None) -> Union[MutableCollection[E]]:
        ...
    ...
    def histogram(self, spec: HistogramSpec=None) -> Histogram[Any, Any, HistogramBuilder]:
        ...
    def neg(self) -> Union[MutableCollection[E]]:
        ...
    def approxMostFrequent(self, spec: CountMinSketchSpec=None) -> Union[Map[str, int]]:
        ...
    @overload
    def timeseries(self, spec: DataTimeseriesSpec=None) -> Union[MutableCollection[R]]:
        ...
    @overload
    def timeseries(self, tsFieldSpec: Map[str, TimeseriesFieldSpec], spec: TimeseriesSpec=None) -> Union[MutableCollection[R]]:
        ...
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> MutableCollection[E]:
    """
    ...
    """
        ...
    def inferType(self) -> Union[MutableCollection[E]]:
    """
    ...
    **within and across chunk/partition**, this method allows for different lambdas to be applied in each case.
    ...
    """
        ...
    def toMixingCollection(self, collectionType: CollectionType, failIfInvalid: bool=None) -> Union[MutableCollection[T]]:
    """
    ...
    """
        ...
    def boxElements(self) -> Union[MutableCollection[Boxed[E]]]:
    """
    @return copy of this collection with all elements Boxed.
    """
        ...
    def anonymize(self, spec: AnonymizationSpec=None) -> Union[MutableCollection[E]]:
    """
    ...
    """
        ...
    def withoutOutliers(self, spec: OutliersSpec='{ stddev: 2 }') -> MutableCollection[E]:
    """
    ...
    """
        ...
    def extractOutliers(self, spec: OutliersSpec='{ stddev: 2 }') -> MutableCollection[E]:
    """
    ...
    """
        ...
    def with(self, e: E) -> MutableCollection[E]:
    """
    @return new collection with a new element added to it.
    """
        ...
    def withSome(self, e: E, *more: Array[E]) -> MutableCollection[E]:
    """
    @return new collection with a new elements added to it.
    """
        ...
    def withAll(self, elements: Collection[E]) -> Union[MutableCollection[E]]:
    """
    @return new collection with the provided elements added to it.
    """
        ...
    def without(self, e: E) -> Union[MutableCollection[E]]:
    """
    @return new collection without the provided element.
    """
        ...
    def withoutSome(self, e: E, *more: Array[E]) -> Union[MutableCollection[E]]:
    """
    @return new collection without the provided elements.
    """
        ...
    def withoutAny(self, predicate: Callable[[Union[E]], bool]) -> Union[MutableCollection[E]]:
    """
    @return new collection without elements satisfying provided predicate.
    """
        ...
    def withoutAll(self, elements: Array[E]) -> Union[MutableCollection[E]]:
    """
    @return new collection with the provided elements removed.
    """
        ...
    def difference(self, other: Collection[E]) -> Union[MutableCollection[E]]:
    """
    @return new collection with elements that are not present in provided collection.
    """
        ...
    @classmethod
    def intersection(cls, *collections: Array[Collection[E]]) -> Union[MutableCollection[E]]:
    """
    ...
    """
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> MutableCollection[E]:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Union[MutableCollection[E]]:
    """
    ...
    """
        ...
    @overload
    def rolling(self, agg: str, offset: int, span: int, step: int=None) -> Union[MutableCollection[E]]:
    """
    ...
    """
        ...
    @classmethod
    def make(cls) -> MutableCollection[E]:
    """
    Construct an instance with initial state.
    """
        ...
    def addAll(self, elements: Collection[E]) -> Union[MutableCollection[E]]:
    """
    Add provided elements to this collection
    """
        ...
