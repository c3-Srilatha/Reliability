...
# Python definitions for the C3 type PersistableGettable


class PersistableGettable(Gettable, Value):
    """
    Type containing functions for all get operations
    
    @remarks this represents a made instance of PersistableGettable
    """
    def __init__(self) -> None: ...

    def get(self, include: str=None) -> Union[PersistableGettable]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[PersistableGettable]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> PersistableGettable:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[PersistableGettable]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> PersistableGettable:
    """
