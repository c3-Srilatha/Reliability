...
# Python definitions for the C3 type JsNodeTester


class JsNodeTester(Tester):
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> JsNodeTester:
    """
    ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> JsNodeTester:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> JsNodeTester:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> JsNodeTester:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[JsNodeTester]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[JsNodeTester]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[JsNodeTester]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[JsNodeTester]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> JsNodeTester:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> JsNodeTester:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> JsNodeTester:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[JsNodeTester]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[JsNodeTester]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> JsNodeTester:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> JsNodeTester:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> JsNodeTester:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> JsNodeTester:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> JsNodeTester:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> JsNodeTester:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> JsNodeTester:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> JsNodeTester:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> JsNodeTester:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> JsNodeTester:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> JsNodeTester:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> JsNodeTester:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> JsNodeTester:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> JsNodeTester:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> JsNodeTester:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> JsNodeTester:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> JsNodeTester:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> JsNodeTester:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> JsNodeTester:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> JsNodeTester:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> JsNodeTester:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> JsNodeTester:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> JsNodeTester:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> JsNodeTester:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> JsNodeTester:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> JsNodeTester:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> JsNodeTester:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> JsNodeTester:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[JsNodeTester]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[JsNodeTester]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[JsNodeTester]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[JsNodeTester]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[JsNodeTester]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, JsNodeTester]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, JsNodeTester]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[JsNodeTester]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[JsNodeTester]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> JsNodeTester:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> JsNodeTester:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> JsNodeTester:
    """
    ...
    """
        ...
    def afterMake(self) -> JsNodeTester:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> JsNodeTester:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[JsNodeTester]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> JsNodeTester:
    """
    ...
    """
        ...
    @overload
    def setField(self, field: str, value: Any, doNotConvert: bool=None) -> JsNodeTester:
    """
    ...
    """
        ...
    @overload
    def setField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> JsNodeTester:
    """
    Sets the mutable field value. The name must correspond to an existing field defined on this type or its mixins.
    The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    @classmethod
    def forPathAndEngine(cls, path: str, engine: str) -> JsNodeTester:
    """
    ...
    """
        ...
    @classmethod
    def forNameAndEngine(cls, testName: str, engine: str) -> JsNodeTester:
    """
    ...
    """
        ...
    @classmethod
    def forEngine(cls, engine: str, deep: bool=None) -> JsNodeTester:
    """
    ...
    """
        ...
    def run(self, spec: TesterRunSpec=None) -> JsNodeTester:
    """
