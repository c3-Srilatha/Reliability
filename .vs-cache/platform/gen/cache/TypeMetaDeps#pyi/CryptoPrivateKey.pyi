...
# Python definitions for the C3 type CryptoPrivateKey


class CryptoPrivateKey(CryptoKey):
    """
    The private key of an asymmetric key pair.
    
    @remarks this represents a made instance of CryptoPrivateKey
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[CryptoPrivateKey]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[CryptoPrivateKey]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[CryptoPrivateKey]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[CryptoPrivateKey]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> CryptoPrivateKey:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> CryptoPrivateKey:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> CryptoPrivateKey:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[CryptoPrivateKey]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[CryptoPrivateKey]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> CryptoPrivateKey:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> CryptoPrivateKey:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> CryptoPrivateKey:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> CryptoPrivateKey:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> CryptoPrivateKey:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> CryptoPrivateKey:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> CryptoPrivateKey:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> CryptoPrivateKey:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> CryptoPrivateKey:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> CryptoPrivateKey:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> CryptoPrivateKey:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> CryptoPrivateKey:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> CryptoPrivateKey:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> CryptoPrivateKey:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> CryptoPrivateKey:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> CryptoPrivateKey:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> CryptoPrivateKey:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> CryptoPrivateKey:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> CryptoPrivateKey:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> CryptoPrivateKey:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> CryptoPrivateKey:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> CryptoPrivateKey:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> CryptoPrivateKey:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> CryptoPrivateKey:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> CryptoPrivateKey:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> CryptoPrivateKey:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> CryptoPrivateKey:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> CryptoPrivateKey:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[CryptoPrivateKey]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[CryptoPrivateKey]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[CryptoPrivateKey]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[CryptoPrivateKey]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[CryptoPrivateKey]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, CryptoPrivateKey]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, CryptoPrivateKey]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[CryptoPrivateKey]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[CryptoPrivateKey]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> CryptoPrivateKey:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> CryptoPrivateKey:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> CryptoPrivateKey:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> CryptoPrivateKey:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> CryptoPrivateKey:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> CryptoPrivateKey:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[CryptoPrivateKey]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> CryptoPrivateKey:
    """
    ...
    """
        ...
    def afterMake(self) -> CryptoPrivateKey:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> CryptoPrivateKey:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[CryptoPrivateKey]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> CryptoPrivateKey:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[CryptoPrivateKey]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[CryptoPrivateKey]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[CryptoPrivateKey]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[CryptoPrivateKey]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[CryptoPrivateKey]:
    """
    Returns cached instance by key, with secrets removed.
    """
        ...
    def getCached(self) -> Union[CryptoPrivateKey]:
    """
    ...
    """
        ...
    def refreshCache(self) -> Union[CryptoPrivateKey]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[CryptoPrivateKey]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, CryptoPrivateKey]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, CryptoPrivateKey]]:
    """
    ...
    """
        ...
    def getConfig(self) -> CryptoPrivateKey:
    """
    ...
    """
        ...
    def getSecret(self) -> CryptoPrivateKey:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[CryptoPrivateKey]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[CryptoPrivateKey]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: CryptoPrivateKey, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: CryptoPrivateKey, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[CryptoPrivateKey]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[CryptoPrivateKey]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[CryptoPrivateKey]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> CryptoPrivateKey:
        ...
    @classmethod
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[CryptoPrivateKey]:
    """
    ...
    """
        ...
    @classmethod
    def fromJwk(cls, jwk: str, failIfInvalid: bool=None) -> CryptoPrivateKey:
    """
