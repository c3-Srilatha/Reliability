...
from c3.platform.Promise import Promise
from c3.platform.JavaPromise import JavaPromise
from c3.platform.Duration import Duration
from c3.platform.Future import Future

# Python definitions for the C3 type JavaPromise

V = TypeVar('V')

class JavaPromise(Generic[V], Promise[V], Value):
    """
    @remarks this represents a made instance of JavaPromise
    """
    ...
    """
        ...
    @classmethod
    def create(cls, resultType: ValueType=None) -> JavaPromise[V]:
        ...
    def fulfill(self, value: Any=None) -> JavaPromise[V]:
        ...
    def reject(self, reason: Error) -> JavaPromise[V]:
        ...
