...
# Python definitions for the C3 type ContentPushStream


class ContentPushStream(WriteOnlyContent):
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ContentPushStream]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ContentPushStream]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ContentPushStream]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ContentPushStream]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ContentPushStream:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ContentPushStream:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ContentPushStream:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ContentPushStream]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ContentPushStream]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ContentPushStream:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ContentPushStream:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ContentPushStream:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ContentPushStream:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ContentPushStream:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ContentPushStream:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ContentPushStream:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ContentPushStream:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ContentPushStream:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ContentPushStream:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ContentPushStream:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ContentPushStream:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ContentPushStream:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ContentPushStream:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ContentPushStream:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ContentPushStream:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ContentPushStream:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ContentPushStream:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ContentPushStream:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ContentPushStream:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ContentPushStream:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ContentPushStream:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ContentPushStream:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ContentPushStream:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ContentPushStream:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ContentPushStream:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ContentPushStream:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ContentPushStream:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ContentPushStream]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ContentPushStream]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ContentPushStream]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ContentPushStream]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ContentPushStream]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ContentPushStream]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ContentPushStream]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ContentPushStream]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ContentPushStream]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ContentPushStream:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ContentPushStream:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ContentPushStream:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ContentPushStream:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ContentPushStream:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ContentPushStream:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ContentPushStream:
    """
    ...
    """
        ...
    def afterMake(self) -> ContentPushStream:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ContentPushStream:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ContentPushStream]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ContentPushStream:
    """
    ...
    """
        ...
    def withFileName(self, fileName: str) -> ContentPushStream:
    """
    Changes file name in this instance.
    """
        ...
    def withFileExt(self, fileExt: str) -> ContentPushStream:
    """
    ...
    """
        ...
    def identify(self, suffix: str=None) -> ContentPushStream:
    """
    ...
    """
        ...
    def readMetadata(self, spec: FileOperationSpec=None) -> ContentPushStream:
    """
    ...
    """
        ...
    def refreshMetadata(self, spec: FileOperationSpec=None) -> ContentPushStream:
    """
    ...
    """
        ...
    def guessMetadata(self, spec: FileOperationSpec=None) -> ContentPushStream:
    """
    ...
    """
        ...
    def clearMetadata(self) -> ContentPushStream:
    """
    Clears the content metadata; e.g. if it's known to be invalid.
    """
        ...
    def withMetadata(self, meta: ContentMeta=None) -> ContentPushStream:
    """
    ...
    """
        ...
    def encodedPushStream(self, spec: FileOperationSpec=None) -> Pair[ContentPushStream, BytePushStream]:
    """
    ...
    """
        ...
    def pushStream(self, spec: FileOperationSpec=None) -> Pair[ContentPushStream, BytePushStream]:
    """
    @return byte push stream to be used for writing un-encoded data into this content object.
    """
        ...
    def charPushStream(self, spec: FileOperationSpec=None) -> Pair[ContentPushStream, CharPushStream]:
    """
    @return character push stream to be used for writing un-encoded data into this content object.
    """
        ...
    def encodedStream(self, spec: FileOperationSpec=None) -> Union[Pair[ContentPushStream, ByteStream]]:
    """
    ...
    """
        ...
    def writeStream(self, content: ByteStream, spec: FileOperationSpec=None) -> ContentPushStream:
    """
    ...
    """
        ...
    def writeInputStream(self, inputStream: Any, spec: FileOperationSpec=None) -> ContentPushStream:
    """
    Truncates file and replaces it's content with provided binary content.
    """
        ...
    def writeZipInputStream(self, zipInputStream: Any, spec: FileOperationSpec=None) -> ContentPushStream:
    """
    Truncates file and replaces its content with provided binary content from zipInputStream
    """
        ...
    def writeEncodedStream(self, encodedContent: ByteStream, spec: FileOperationSpec=None) -> ContentPushStream:
    """
    ...
    """
        ...
    def writeEncodedInputStream(self, inputStream: Any, spec: FileOperationSpec=None) -> ContentPushStream:
    """
    Truncates file and replaces it's encoded content with provided binary content.
    """
        ...
    def write(self, content: any, spec: FileOperationSpec=None) -> ContentPushStream:
    """
    Truncates file and replaces it's content with provided binary content.
    ...
    """
        ...
    def writeEncoded(self, encodedContent: any, spec: FileOperationSpec=None) -> ContentPushStream:
    """
    Truncates file and replaces it's encoded content with provided binary content.
    ...
    """
        ...
    def writeString(self, content: str, spec: FileOperationSpec=None) -> ContentPushStream:
    """
    ...
    """
        ...
    def writeObj(self, obj: Obj, spec: FileObjsOperSpec=None) -> ContentPushStream:
    """
    ...
    """
        ...
    def startWriteObjs(self, spec: FileObjsOperSpec=None) -> Pair[ContentPushStream, PushStream[Obj]]:
    """
    Serializes content from a list of c3 objects into a file.
    ...
    """
        ...
    def compress(self, contentEncoding: str=None, spec: FileCompressSpec=None) -> ContentPushStream:
    """
    ...
    """
        ...
    def uncompress(self, spec: FileCompressSpec=None) -> ContentPushStream:
    """
    Uncompresses content.
    """
        ...
    def transcode(self, contentType: str, contentEncoding: str, spec: FileCompressSpec=None) -> ContentPushStream:
    """
    ...
    """
        ...
    def copyContentTo(self, target: ContentPushStream, spec: FileOperationSpec=None) -> None:
    """
    ...
    """
        ...
    @overload
    def concat(self, other: Content) -> ContentPushStream:
    """
    Creates a new Content by merging the two contents
    """
        ...
    @overload
    def concat(self, other: any) -> ContentPushStream:
    """
