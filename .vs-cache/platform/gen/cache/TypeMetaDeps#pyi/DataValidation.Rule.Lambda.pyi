...
from c3.platform.ObjBuilder import ObjBuilder
from c3.platform.DataValidation.Rule import DataValidation.Rule
...
from c3.platform.DataValidation.Rule.Draft.DeploySpec import DataValidation.Rule.Draft.DeploySpec
from c3.platform.DataValidation.Rule.MapResult import DataValidation.Rule.MapResult
from c3.platform.DataValidation.Rule.SummaryResult import DataValidation.Rule.SummaryResult
...
from c3.platform.MapBuilder import MapBuilder
from c3.platform.DataValidation.Rule.WithLambda.SaveResult import DataValidation.Rule.WithLambda.SaveResult
from c3.platform.PushStreamWithStats import PushStreamWithStats
from c3.platform.DataValidation.Rule.WithLambda import DataValidation.Rule.WithLambda
...
# Python definitions for the C3 type DataValidation.Rule.Lambda


class Lambda(DataValidation.Rule, DataValidation.Rule.WithLambda):
    """
    **DataValidation.Rule.Lambda** allows a rule to be defined by providing **Lambda** for custom validation rules.
    
    @remarks this represents a made instance of DataValidation.Rule.Lambda
    """
    ...
    map: Optional[Callable[[Array[Obj], DataValidation.Run], Union[DataValidation.Rule.MapResult]]]=None
    """
    ...
    summarize: Optional[Callable[[DataValidation.Run], DataValidation.Rule.SummaryResult]]=None
    """
    ...
    """
    def __init__(self, lastSavedTimestamp: Optional[datetime]=None, numSavedVersions: Optional[int]=None, savedVersion: Optional[int]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, id: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, targetType: Optional[Type]=None, description: Optional[str]=None, detailsType: Optional[TupleType]=None, args: Optional[Map[str, Any]]=None, kind: Optional[str]=None, runs: Optional[Array[DataValidation.Run]]=None, lastRun: Optional[DataValidation.Run]=None, runIdempotencyArgsKeys: Optional[Array[str]]=None, SRC: Optional[str]=None, DATA: Optional[str]=None, _SRC: Optional[str]=None, language: Optional[str]=None, actionRequirement: Optional[str]=None, map: Optional[Callable[[Array[Obj], DataValidation.Run], Union[DataValidation.Rule.MapResult]]]=None, summarize: Optional[Callable[[DataValidation.Run], DataValidation.Rule.SummaryResult]]=None, userCode: Optional[str]=None, schedule: Optional[CronSchedule]=None, enableUserNotifications: Optional[bool]=None, notifyUserIds: Optional[Array[str]]=None, notifyUserGroups: Optional[Array[str]]=None, userUpdatedFields: Optional[Array[str]]=None, hidden: Optional[bool]=None, userOwned: Optional[bool]=None, disabled: Optional[bool]=None, disabledReason: Optional[str]=None, disabledBy: Optional[str]=None, disabledAt: Optional[DateTime]=None, typeIdent: Optional[str]=None, status: Optional[str]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[DataValidation.Rule.Lambda]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[DataValidation.Rule.Lambda]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[DataValidation.Rule.Lambda]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[DataValidation.Rule.Lambda]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> DataValidation.Rule.Lambda:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataValidation.Rule.Lambda:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataValidation.Rule.Lambda:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataValidation.Rule.Lambda]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataValidation.Rule.Lambda]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> DataValidation.Rule.Lambda:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataValidation.Rule.Lambda:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataValidation.Rule.Lambda:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> DataValidation.Rule.Lambda:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> DataValidation.Rule.Lambda:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> DataValidation.Rule.Lambda:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> DataValidation.Rule.Lambda:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> DataValidation.Rule.Lambda:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> DataValidation.Rule.Lambda:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> DataValidation.Rule.Lambda:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> DataValidation.Rule.Lambda:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> DataValidation.Rule.Lambda:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> DataValidation.Rule.Lambda:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> DataValidation.Rule.Lambda:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> DataValidation.Rule.Lambda:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> DataValidation.Rule.Lambda:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> DataValidation.Rule.Lambda:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> DataValidation.Rule.Lambda:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> DataValidation.Rule.Lambda:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> DataValidation.Rule.Lambda:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> DataValidation.Rule.Lambda:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> DataValidation.Rule.Lambda:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> DataValidation.Rule.Lambda:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> DataValidation.Rule.Lambda:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> DataValidation.Rule.Lambda:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> DataValidation.Rule.Lambda:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> DataValidation.Rule.Lambda:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> DataValidation.Rule.Lambda:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[DataValidation.Rule.Lambda]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[DataValidation.Rule.Lambda]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[DataValidation.Rule.Lambda]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[DataValidation.Rule.Lambda]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[DataValidation.Rule.Lambda]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, DataValidation.Rule.Lambda]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, DataValidation.Rule.Lambda]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[DataValidation.Rule.Lambda]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[DataValidation.Rule.Lambda]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> DataValidation.Rule.Lambda:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> DataValidation.Rule.Lambda:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> DataValidation.Rule.Lambda:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> DataValidation.Rule.Lambda:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> DataValidation.Rule.Lambda:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> DataValidation.Rule.Lambda:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[DataValidation.Rule.Lambda]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> DataValidation.Rule.Lambda:
    """
    ...
    """
        ...
    def afterMake(self) -> DataValidation.Rule.Lambda:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> DataValidation.Rule.Lambda:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[DataValidation.Rule.Lambda]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> DataValidation.Rule.Lambda:
    """
    ...
    """
        ...
    def processObj(self, srcObj: Versionable, spec: UpsertSpec) -> DataValidation.Rule.Lambda:
    """
    ...
    """
        ...
    def allVersions(self, spec: FetchSpec=None) -> Union[Stream[DataValidation.Rule.Lambda]]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[DataValidation.Rule.Lambda]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[DataValidation.Rule.Lambda]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[DataValidation.Rule.Lambda]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[DataValidation.Rule.Lambda]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[DataValidation.Rule.Lambda]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[DataValidation.Rule.Lambda]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> DataValidation.Rule.Lambda:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[DataValidation.Rule.Lambda]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> DataValidation.Rule.Lambda:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[DataValidation.Rule.Lambda]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[DataValidation.Rule.Lambda]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[DataValidation.Rule.Lambda], spec: UpsertSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[DataValidation.Rule.Lambda], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: DataValidation.Rule.Lambda=None, spec: UpsertSpec=None) -> Union[DataValidation.Rule.Lambda]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: DataValidation.Rule.Lambda=None, spec: UpsertSpec=None) -> Union[DataValidation.Rule.Lambda]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[DataValidation.Rule.Lambda]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[DataValidation.Rule.Lambda]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[DataValidation.Rule.Lambda]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[DataValidation.Rule.Lambda], srcObjs: Array[DataValidation.Rule.Lambda]=None, spec: UpsertSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[DataValidation.Rule.Lambda]]], spec: UpsertSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[DataValidation.Rule.Lambda], srcObjs: Array[DataValidation.Rule.Lambda]=None, spec: UpsertSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[DataValidation.Rule.Lambda]]], spec: UpsertSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[DataValidation.Rule.Lambda], spec: TouchSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[DataValidation.Rule.Lambda], spec: MergeSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[DataValidation.Rule.Lambda], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[DataValidation.Rule.Lambda]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: DataValidation.Rule.Lambda, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: DataValidation.Rule.Lambda, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[DataValidation.Rule.Lambda], spec: UpsertSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[DataValidation.Rule.Lambda], spec: UpsertSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[DataValidation.Rule.Lambda]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[DataValidation.Rule.Lambda]) -> ObjList[DataValidation.Rule.Lambda]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[DataValidation.Rule.Lambda]) -> ObjList[DataValidation.Rule.Lambda]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[DataValidation.Rule.Lambda]) -> ObjList[DataValidation.Rule.Lambda]:
    """
    ...
    @overload
    @classmethod
    def afterCreate(cls, objs: Array[DataValidation.Rule.Lambda]) -> Union[Array[ObjError]]:
    """
    ...
    @overload
    @classmethod
    def afterUpdate(cls, objs: Array[DataValidation.Rule.Lambda]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[DataValidation.Rule.Lambda]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[DataValidation.Rule.Lambda]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[DataValidation.Rule.Lambda]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[DataValidation.Rule.Lambda]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[DataValidation.Rule.Lambda]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[DataValidation.Rule.Lambda]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: DataValidation.Rule.Lambda=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[DataValidation.Rule.Lambda], callback: Callable[[Union[DataValidation.Rule.Lambda]], Union[DataValidation.Rule.Lambda]]=None) -> ObjList[DataValidation.Rule.Lambda]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[DataValidation.Rule.Lambda], callback: Callable[[Union[DataValidation.Rule.Lambda]], Union[DataValidation.Rule.Lambda]]=None) -> Union[Array[ObjError]]:
    """
    ...
    **overriddenArgs** are final (most probably extracted from {@link overiddenArgs}) and {@link #args} will not be looked up for any additional manipulation.
    ...
    """
        ...
    def toJsSource(self, src: DataValidation.Rule.Lambda=None) -> str:
    """
    Build the canonical JavaScript source code representation of this instance.  After running the produced JavaScript
    source code, the `data` variable in JavaScript should point to the instance.
    
    Simple example of the returned JavaScript source code that does not use `$src` variable (See {@link #toJsSource}):
    ```js
    ...
    src.withEmail('john@doe.com').toJsSource(src)
    ```
    ...
    """
        ...
    @classmethod
    def fromJsSource(cls, js: str, src: DataValidation.Rule.Lambda=None) -> Union[DataValidation.Rule.Lambda]:
    """
    Parse and evaluate the JavaScript source code representation and reconstruct the corresponding instance.
    
    @param js
        JavaScript source code used to reconstruct this instance.
    @param src
    ...
    """
        ...
    def toPySource(self, src: DataValidation.Rule.Lambda=None) -> str:
    """
    ...
    """
        ...
    @classmethod
    def fromPySource(cls, py: str, src: DataValidation.Rule.Lambda=None) -> Union[DataValidation.Rule.Lambda]:
    """
    ...
    """
        ...
    @classmethod
    def fromCode(cls, code: str, language: str) -> Union[DataValidation.Rule.WithLambda.SaveResult]:
    """
    ...
    """
        ...
    def doExecMap(self, objs: Array[Obj], run: DataValidation.Run) -> None:
    """
    ...
    """
        ...
    @classmethod
    def fromPySrc(cls, userCode: str) -> Union[Union[DataValidation.Rule.WithLambda,DataValidation.Rule.Lambda.Issue]]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsSrc(cls, userCode: str) -> Union[Union[DataValidation.Rule.WithLambda,DataValidation.Rule.Lambda.Issue]]:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[DataValidation.Rule.Lambda]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[DataValidation.Rule.Lambda]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[DataValidation.Rule.Lambda]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[DataValidation.Rule.Lambda]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[DataValidation.Rule.Lambda]:
    """
    ...
    """
        ...
    def getCached(self) -> Union[DataValidation.Rule.Lambda]:
    """
    ...
    """
        ...
    def refreshCache(self) -> Union[DataValidation.Rule.Lambda]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[DataValidation.Rule.Lambda]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, DataValidation.Rule.Lambda]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, DataValidation.Rule.Lambda]]:
    """
    ...
    """
        ...
    def publish(self, subPath: str=None, contentType: str=None) -> DataValidation.Rule.Lambda:
    """
    ...
    """
        ...
    @classmethod
    def removeSeedDataBatch(cls, objs: Array[SeedData]=None, spec: UpsertSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda]]:
    """
    ...
    """
        ...
    def createSeedData(self, spec: UpsertSpec=None) -> Union[DataValidation.Rule.Lambda]:
    """
    ...
    """
        ...
    @classmethod
    def createSeedDataBatch(cls, objs: Array[SeedData]=None, spec: UpsertSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda]]:
    """
    ...
    """
        ...
    def updateSeedData(self, srcObj: SeedData=None, spec: UpsertSpec=None) -> Union[DataValidation.Rule.Lambda]:
    """
    ...
    """
        ...
    @classmethod
    def updateSeedDataBatch(cls, objs: Array[SeedData]=None, srcObjs: Array[SeedData]=None, spec: UpsertSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda]]:
    """
    ...
    """
        ...
    def clearUserUpdates(self, spec: MergeSpec=None) -> Union[DataValidation.Rule.Lambda]:
    """
    ...
    """
        ...
    @classmethod
    def clearUserUpdatesBatch(cls, objs: Array[SeedData]=None, spec: MergeSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda]]:
    """
    ...
    """
        ...
    def dependencies(self) -> Union[SeedDataDeps[DataValidation.Rule.Lambda]]:
        ...
    ...
    """
        ...
    @classmethod
    def ensureSchedule(cls, rule: DataValidation.Rule.Lambda, isRemove: bool=None) -> DataValidation.Rule.Lambda:
    """
    ...
    class Issue():
        """
        The type to show the user code error with the line number.
        
        @remarks this represents a made instance of DataValidation.Rule.Lambda.Issue
        """
        
        offset: Optional[int]=None
        """
        The column number of the line that causes the user code error. If offset can't be extracted from the exception, the
        default offset is 0.
        """

        lineno: Optional[int]=None
        """
        The line number causing {@link #error} in the user code. If the line number can't be extracted from the exception,
        the default offset is 0.
        """

        error: Optional[str]
        """
        The error message when saving the user code
        """
        def __init__(self, offset: Optional[int]=None, lineno: Optional[int]=None, error: Optional[str]=None) -> None: ...
        ...
        """
            ...
        @classmethod
        def fromJson(cls, json: any) -> Union[DataValidation.Rule.Lambda.Issue]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromJsonString(cls, json: str) -> Union[DataValidation.Rule.Lambda.Issue]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromXmlString(cls, xml: str) -> Union[DataValidation.Rule.Lambda.Issue]:
        """
        Load the XML-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def deserialize(cls, contentStr: str, contentType: str) -> Union[DataValidation.Rule.Lambda.Issue]:
        """
        Load from contentType representation and reconstruct the corresponding object.
        ...
        """
            ...
        def replaceType(self, old: Type, new: Type) -> DataValidation.Rule.Lambda.Issue:
        """
        Returns new instance with all references to old type, including result of #type, replaced with new type. If new
        type does not contain fields from old or field value types are not convertable then drops the field.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataValidation.Rule.Lambda.Issue:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataValidation.Rule.Lambda.Issue:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataValidation.Rule.Lambda.Issue]:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the asynchronous `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataValidation.Rule.Lambda.Issue]:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        asynchronous `mapper` invocation.
        ...
        """
            ...
        def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> DataValidation.Rule.Lambda.Issue:
        """
        Result of this function call is a copy of current instance with specified field value replaced based on result of
        the `mapper` invocation.
        @param field
        ...
        """
            ...
        @overload
        def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataValidation.Rule.Lambda.Issue:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataValidation.Rule.Lambda.Issue:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def validateObj(self) -> DataValidation.Rule.Lambda.Issue:
        """
        Populates all missing default values and throws error if any constraint is violated.
        """
            ...
        ...
        """
            ...
        @overload
        def withField(self, field: str, value: Any, doNotConvert: bool=None) -> DataValidation.Rule.Lambda.Issue:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        @overload
        def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> DataValidation.Rule.Lambda.Issue:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> DataValidation.Rule.Lambda.Issue:
        """
        Builds a new Obj instance by adding the provided fields in it. The name must correspond to an existing fields
        defined on this type or its mixins. The values must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> DataValidation.Rule.Lambda.Issue:
        """
        Builds a new Obj with the value at the specified path field. If the field is null, the field #isFieldSet to null.
        If you would like to #unsetField, you should call #withoutFieldAtPath instead.
        ...
        """
            ...
        def withoutFieldAtPath(self, path: str) -> DataValidation.Rule.Lambda.Issue:
        """
        Builds a new Obj without the specified path field.
        ...
        """
            ...
        @overload
        def withoutField(self, field: str) -> DataValidation.Rule.Lambda.Issue:
        """
        Builds a new Obj, removing the field with the provided name.
        ...
        """
            ...
        @overload
        def withoutField(self, field: FieldType) -> DataValidation.Rule.Lambda.Issue:
        """
        Builds a new Obj, removing the field with the provided field type.
        ...
        """
            ...
        def withoutFields(self, fields: Array[str]) -> DataValidation.Rule.Lambda.Issue:
        """
        Builds a new Obj, removing the fields with the provided names.
        ...
        """
            ...
        def withoutFieldsByType(self, fields: Array[FieldType]) -> DataValidation.Rule.Lambda.Issue:
        """
        Builds a new Obj, removing the fields with the provided field types. Be sure to use the FieldType instance for the
        exact same type as the type of the obj to respect the "ordinal" of the field type
        ...
        """
            ...
        def withoutSecretFields(self) -> DataValidation.Rule.Lambda.Issue:
        """
        @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
        """
            ...
        ...
        """
            ...
        def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> DataValidation.Rule.Lambda.Issue:
        """
        Builds a new Obj instance by adding the default values (if defined) for all unset fields. This is implemented by
        calling {@link FieldType#defaultValue defaultValue} for a field if it is not already set and
        {@link FieldType#hasDefault has a default}. It will also set {@see ValueType#initialValue initial values} for
        ...
        """
            ...
        @overload
        def defaultField(self, field: str) -> DataValidation.Rule.Lambda.Issue:
        """
        Builds a new Obj, by setting a field on this `Obj` to the field's default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def defaultField(self, field: FieldType) -> DataValidation.Rule.Lambda.Issue:
        """
        Builds a new Obj, by setting a field on this `Obj` to the fields default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def unsetField(self, field: str) -> DataValidation.Rule.Lambda.Issue:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def unsetField(self, field: FieldType) -> DataValidation.Rule.Lambda.Issue:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def removeField(self, field: str) -> DataValidation.Rule.Lambda.Issue:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def removeField(self, field: FieldType) -> DataValidation.Rule.Lambda.Issue:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> DataValidation.Rule.Lambda.Issue:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence unless otherwise specified by the fieldPathMergeSpec
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> DataValidation.Rule.Lambda.Issue:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence.
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> DataValidation.Rule.Lambda.Issue:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist on other Obj and do not exist on this Obj will not be added to final Obj.
        @param deep
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> DataValidation.Rule.Lambda.Issue:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist other Obj and do not exist on this Obj will not be added to final Obj or evaluated. Does not
        traverse child reference and collection fields.
        ...
        """
            ...
        def mergeJson(self, json: any) -> DataValidation.Rule.Lambda.Issue:
            ...
        def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> DataValidation.Rule.Lambda.Issue:
        """
        Merge the obj references within the current obj
        @param deep
               If set, traverses the reference fields within the obj as well for a deep merge
        ...
        """
            ...
        def sumObj(self, other: Obj, deep: bool=None) -> DataValidation.Rule.Lambda.Issue:
        """
        Adds the numeric Obj fields with the other Objs respective fields.
        If deep is set it will traverse reference and collection fields and sum corresponding numeric fields in
        references with same name and collection elements at same index or key.
        """
            ...
        def singletonArray(self) -> Array[DataValidation.Rule.Lambda.Issue]:
        """
        Build an array of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def array(cls, *elements: Array[Any]) -> Union[Array[DataValidation.Rule.Lambda.Issue]]:
        """
        Creates an array of instances of this type.
        """
            ...
        @classmethod
        def arrayBuilder(cls) -> Union[ArrayBuilder[DataValidation.Rule.Lambda.Issue]]:
        """
        Creates an array of instances of this type.
        """
            ...
        def singletonSet(self) -> Set[DataValidation.Rule.Lambda.Issue]:
        """
        Build an set of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def setBuilder(cls) -> Union[SetBuilder[DataValidation.Rule.Lambda.Issue]]:
        """
        Creates a set of instances of this type.
        """
            ...
        @classmethod
        def mapBuilder(cls) -> Union[MapBuilder[str, DataValidation.Rule.Lambda.Issue]]:
        """
        Create a map of string to elements of this type.
        """
            ...
        @classmethod
        def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, DataValidation.Rule.Lambda.Issue]]:
        """
        Create a map with the given key type and elements of this type.
        """
            ...
        ...
        def myStreamType(cls) -> StreamType:
            ...
        def toBuilder(self) -> ObjBuilder[DataValidation.Rule.Lambda.Issue]:
        """
        @return new ObjBuilder with initial state set to fields of this instance.
        """
            ...
        @classmethod
        def builder(cls) -> ObjBuilder[DataValidation.Rule.Lambda.Issue]:
        """
        @return new ObjBuilder of this instance.
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> DataValidation.Rule.Lambda.Issue:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> DataValidation.Rule.Lambda.Issue:
        """
        Construct an instance of this type from provided fields
        @param fields
                   Fields to construct the instance of the obj with
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> DataValidation.Rule.Lambda.Issue:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def make(cls, withDefaults: bool=None) -> DataValidation.Rule.Lambda.Issue:
        """
        Construct an instance of this type with no non-default field values unless explicitly specified by passing param true
        @param withDefaults
                   If set, then the Obj is made with default & initial values (required primitive fields e.g. !int32 -> 0)
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> DataValidation.Rule.Lambda.Issue:
        """
        Construct an instance from provided fields
        @param fields
                   Fields (in the format <field_name, value>) to construct an instance of the obj. Note that "type" as a
        ...
        @overload
        @classmethod
        def make(cls, fields: Any, withDefaults: bool=None) -> DataValidation.Rule.Lambda.Issue:
        """
        Construct an instance of this type from provided fields. Note it is more efficient to use #fromFields and other overloads
        ...
        """
            ...
        @classmethod
        def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> DataValidation.Rule.Lambda.Issue:
        """
        Construct an instance of this type from provided instance of a subtype or a "duck type".
        """
            ...
        ...
        """
            ...
        def afterMake(self) -> DataValidation.Rule.Lambda.Issue:
        """
        Optional override that will be called after every instance creation.
        ...
        """
            ...
        @classmethod
        def cachedEmptyInst(cls) -> DataValidation.Rule.Lambda.Issue:
        """
        Creates an empty inst using `MyType.make()` and caches it. Avoid recreating multiple copies of the spec for
        every action dispatch. The cached inst can also be used for comparing whether the object is an empty or not
        Will only create empty instance for immutable Obj e.g. if an Obj is Mutable, this method will throw an error
        ...
        """
            ...
        @classmethod
        def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[DataValidation.Rule.Lambda.Issue]]:
        """
        Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
        value is read.
        """
            ...
        @classmethod
        def generateObj(cls, spec: Obj.GenerateSpec=None) -> DataValidation.Rule.Lambda.Issue:
        """
        Generate a single instance of this type. The base implementation uses {@link DataGenObj} to generate uniform
        random (gibberish) values for all fields, but it may be overridden by specific types with custom logic that
        populates fields in a more realistic way.
    ...
    class Draft(DataValidation.Rule.Draft, DataValidation.Rule.WithLambda):
        """
        **DataValidation.Rule.Lambda.Draft** allows a Lambda "Draft" rule to be created for development.
        @see DataValidation.Rule.Lambda
        
        @remarks this represents a made instance of DataValidation.Rule.Lambda.Draft
        """
        ...
        of its base type's typeIdent
        """
        def __init__(self, lastSavedTimestamp: Optional[datetime]=None, numSavedVersions: Optional[int]=None, savedVersion: Optional[int]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, id: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, targetType: Optional[Type]=None, description: Optional[str]=None, detailsType: Optional[TupleType]=None, args: Optional[Map[str, Any]]=None, kind: Optional[str]=None, runs: Optional[Array[DataValidation.Run]]=None, lastRun: Optional[DataValidation.Run]=None, runIdempotencyArgsKeys: Optional[Array[str]]=None, SRC: Optional[str]=None, DATA: Optional[str]=None, _SRC: Optional[str]=None, language: Optional[str]=None, actionRequirement: Optional[str]=None, map: Optional[Callable[[Array[Obj], DataValidation.Run], Union[DataValidation.Rule.MapResult]]]=None, summarize: Optional[Callable[[DataValidation.Run], DataValidation.Rule.SummaryResult]]=None, userCode: Optional[str]=None, typeIdent: Optional[str]=None) -> None: ...
        ...
        """
            ...
        @classmethod
        def fromJson(cls, json: any) -> Union[DataValidation.Rule.Lambda.Draft]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromJsonString(cls, json: str) -> Union[DataValidation.Rule.Lambda.Draft]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromXmlString(cls, xml: str) -> Union[DataValidation.Rule.Lambda.Draft]:
        """
        Load the XML-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def deserialize(cls, contentStr: str, contentType: str) -> Union[DataValidation.Rule.Lambda.Draft]:
        """
        Load from contentType representation and reconstruct the corresponding object.
        ...
        """
            ...
        def replaceType(self, old: Type, new: Type) -> DataValidation.Rule.Lambda.Draft:
        """
        Returns new instance with all references to old type, including result of #type, replaced with new type. If new
        type does not contain fields from old or field value types are not convertable then drops the field.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataValidation.Rule.Lambda.Draft:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataValidation.Rule.Lambda.Draft:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataValidation.Rule.Lambda.Draft]:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the asynchronous `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataValidation.Rule.Lambda.Draft]:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        asynchronous `mapper` invocation.
        ...
        """
            ...
        def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> DataValidation.Rule.Lambda.Draft:
        """
        Result of this function call is a copy of current instance with specified field value replaced based on result of
        the `mapper` invocation.
        @param field
        ...
        """
            ...
        @overload
        def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataValidation.Rule.Lambda.Draft:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataValidation.Rule.Lambda.Draft:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def validateObj(self) -> DataValidation.Rule.Lambda.Draft:
        """
        Populates all missing default values and throws error if any constraint is violated.
        """
            ...
        ...
        """
            ...
        @overload
        def withField(self, field: str, value: Any, doNotConvert: bool=None) -> DataValidation.Rule.Lambda.Draft:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        @overload
        def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> DataValidation.Rule.Lambda.Draft:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> DataValidation.Rule.Lambda.Draft:
        """
        Builds a new Obj instance by adding the provided fields in it. The name must correspond to an existing fields
        defined on this type or its mixins. The values must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> DataValidation.Rule.Lambda.Draft:
        """
        Builds a new Obj with the value at the specified path field. If the field is null, the field #isFieldSet to null.
        If you would like to #unsetField, you should call #withoutFieldAtPath instead.
        ...
        """
            ...
        def withoutFieldAtPath(self, path: str) -> DataValidation.Rule.Lambda.Draft:
        """
        Builds a new Obj without the specified path field.
        ...
        """
            ...
        @overload
        def withoutField(self, field: str) -> DataValidation.Rule.Lambda.Draft:
        """
        Builds a new Obj, removing the field with the provided name.
        ...
        """
            ...
        @overload
        def withoutField(self, field: FieldType) -> DataValidation.Rule.Lambda.Draft:
        """
        Builds a new Obj, removing the field with the provided field type.
        ...
        """
            ...
        def withoutFields(self, fields: Array[str]) -> DataValidation.Rule.Lambda.Draft:
        """
        Builds a new Obj, removing the fields with the provided names.
        ...
        """
            ...
        def withoutFieldsByType(self, fields: Array[FieldType]) -> DataValidation.Rule.Lambda.Draft:
        """
        Builds a new Obj, removing the fields with the provided field types. Be sure to use the FieldType instance for the
        exact same type as the type of the obj to respect the "ordinal" of the field type
        ...
        """
            ...
        def withoutSecretFields(self) -> DataValidation.Rule.Lambda.Draft:
        """
        @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
        """
            ...
        ...
        """
            ...
        def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> DataValidation.Rule.Lambda.Draft:
        """
        Builds a new Obj instance by adding the default values (if defined) for all unset fields. This is implemented by
        calling {@link FieldType#defaultValue defaultValue} for a field if it is not already set and
        {@link FieldType#hasDefault has a default}. It will also set {@see ValueType#initialValue initial values} for
        ...
        """
            ...
        @overload
        def defaultField(self, field: str) -> DataValidation.Rule.Lambda.Draft:
        """
        Builds a new Obj, by setting a field on this `Obj` to the field's default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def defaultField(self, field: FieldType) -> DataValidation.Rule.Lambda.Draft:
        """
        Builds a new Obj, by setting a field on this `Obj` to the fields default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def unsetField(self, field: str) -> DataValidation.Rule.Lambda.Draft:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def unsetField(self, field: FieldType) -> DataValidation.Rule.Lambda.Draft:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def removeField(self, field: str) -> DataValidation.Rule.Lambda.Draft:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def removeField(self, field: FieldType) -> DataValidation.Rule.Lambda.Draft:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> DataValidation.Rule.Lambda.Draft:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence unless otherwise specified by the fieldPathMergeSpec
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> DataValidation.Rule.Lambda.Draft:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence.
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> DataValidation.Rule.Lambda.Draft:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist on other Obj and do not exist on this Obj will not be added to final Obj.
        @param deep
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> DataValidation.Rule.Lambda.Draft:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist other Obj and do not exist on this Obj will not be added to final Obj or evaluated. Does not
        traverse child reference and collection fields.
        ...
        """
            ...
        def mergeJson(self, json: any) -> DataValidation.Rule.Lambda.Draft:
            ...
        def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> DataValidation.Rule.Lambda.Draft:
        """
        Merge the obj references within the current obj
        @param deep
               If set, traverses the reference fields within the obj as well for a deep merge
        ...
        """
            ...
        def sumObj(self, other: Obj, deep: bool=None) -> DataValidation.Rule.Lambda.Draft:
        """
        Adds the numeric Obj fields with the other Objs respective fields.
        If deep is set it will traverse reference and collection fields and sum corresponding numeric fields in
        references with same name and collection elements at same index or key.
        """
            ...
        def singletonArray(self) -> Array[DataValidation.Rule.Lambda.Draft]:
        """
        Build an array of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def array(cls, *elements: Array[Any]) -> Union[Array[DataValidation.Rule.Lambda.Draft]]:
        """
        Creates an array of instances of this type.
        """
            ...
        @classmethod
        def arrayBuilder(cls) -> Union[ArrayBuilder[DataValidation.Rule.Lambda.Draft]]:
        """
        Creates an array of instances of this type.
        """
            ...
        def singletonSet(self) -> Set[DataValidation.Rule.Lambda.Draft]:
        """
        Build an set of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def setBuilder(cls) -> Union[SetBuilder[DataValidation.Rule.Lambda.Draft]]:
        """
        Creates a set of instances of this type.
        """
            ...
        @classmethod
        def mapBuilder(cls) -> Union[MapBuilder[str, DataValidation.Rule.Lambda.Draft]]:
        """
        Create a map of string to elements of this type.
        """
            ...
        @classmethod
        def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, DataValidation.Rule.Lambda.Draft]]:
        """
        Create a map with the given key type and elements of this type.
        """
            ...
        ...
        def myStreamType(cls) -> StreamType:
            ...
        def toBuilder(self) -> ObjBuilder[DataValidation.Rule.Lambda.Draft]:
        """
        @return new ObjBuilder with initial state set to fields of this instance.
        """
            ...
        @classmethod
        def builder(cls) -> ObjBuilder[DataValidation.Rule.Lambda.Draft]:
        """
        @return new ObjBuilder of this instance.
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> DataValidation.Rule.Lambda.Draft:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> DataValidation.Rule.Lambda.Draft:
        """
        Construct an instance of this type from provided fields
        @param fields
                   Fields to construct the instance of the obj with
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> DataValidation.Rule.Lambda.Draft:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def make(cls, withDefaults: bool=None) -> DataValidation.Rule.Lambda.Draft:
        """
        Construct an instance of this type with no non-default field values unless explicitly specified by passing param true
        @param withDefaults
                   If set, then the Obj is made with default & initial values (required primitive fields e.g. !int32 -> 0)
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> DataValidation.Rule.Lambda.Draft:
        """
        Construct an instance from provided fields
        @param fields
                   Fields (in the format <field_name, value>) to construct an instance of the obj. Note that "type" as a
        ...
        @overload
        @classmethod
        def make(cls, fields: Any, withDefaults: bool=None) -> DataValidation.Rule.Lambda.Draft:
        """
        Construct an instance of this type from provided fields. Note it is more efficient to use #fromFields and other overloads
        ...
        @overload
        @classmethod
        def make(cls, s: str) -> Union[DataValidation.Rule.Lambda.Draft]:
        """
        Construct an instance of this type from the string. This is an alias for #fromString, as a specific overload
        when the argument is a known string.
        ...
        """
            ...
        @classmethod
        def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> DataValidation.Rule.Lambda.Draft:
        """
        Construct an instance of this type from provided instance of a subtype or a "duck type".
        """
            ...
        ...
        """
            ...
        def afterMake(self) -> DataValidation.Rule.Lambda.Draft:
        """
        Optional override that will be called after every instance creation.
        ...
        """
            ...
        @classmethod
        def cachedEmptyInst(cls) -> DataValidation.Rule.Lambda.Draft:
        """
        Creates an empty inst using `MyType.make()` and caches it. Avoid recreating multiple copies of the spec for
        every action dispatch. The cached inst can also be used for comparing whether the object is an empty or not
        Will only create empty instance for immutable Obj e.g. if an Obj is Mutable, this method will throw an error
        ...
        """
            ...
        @classmethod
        def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[DataValidation.Rule.Lambda.Draft]]:
        """
        Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
        value is read.
        """
            ...
        @classmethod
        def generateObj(cls, spec: Obj.GenerateSpec=None) -> DataValidation.Rule.Lambda.Draft:
        """
        Generate a single instance of this type. The base implementation uses {@link DataGenObj} to generate uniform
        random (gibberish) values for all fields, but it may be overridden by specific types with custom logic that
        populates fields in a more realistic way.
        ...
        """
            ...
        def processObj(self, srcObj: Versionable, spec: UpsertSpec) -> DataValidation.Rule.Lambda.Draft:
        """
        Called by upsert operation.  Updates the obj with new `lastSavedTimestamp`, `numSavedVersions` and `versionEdits`
        entries. The `ths` instance is assumed to be fully populated.
        ...
        """
            ...
        def allVersions(self, spec: FetchSpec=None) -> Union[Stream[DataValidation.Rule.Lambda.Draft]]:
        """
        Gets all saved versions of an object
        ...
        @overload
        @classmethod
        def fetch(cls, spec: FetchSpec=None) -> FetchResult[DataValidation.Rule.Lambda.Draft]:
        """
        Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
        returned.
        ...
        @overload
        @classmethod
        def fetch(cls, filter: Filter) -> FetchResult[DataValidation.Rule.Lambda.Draft]:
        """
        Fetches multiple obj instances based on a filter.  Only objs that the caller is authorized to fetch will be
        returned.
        ...
        """
            ...
        @classmethod
        def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[DataValidation.Rule.Lambda.Draft]]:
        """
        Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
        returned.
        ...
        """
            ...
        @classmethod
        def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[DataValidation.Rule.Lambda.Draft]]]:
        """
        Fetched multiple obj instances in multiple locales based on specification.
        ...
        """
            ...
        def get(self, include: str=None) -> Union[DataValidation.Rule.Lambda.Draft]:
        """
        Gets an instance of a single obj.  If the caller is not authorized to fetch the obj, it will not be returned.
        ...
        """
            ...
        def getSpecific(self, include: str=None) -> Union[DataValidation.Rule.Lambda.Draft]:
        """
        Gets an instance of a single obj in it's leaf type if the type is extendable.  If the caller is not authorized
        to fetch the obj, it will not be returned.
        ...
        """
            ...
        def getMissing(self, spec: GetMissingSpec) -> DataValidation.Rule.Lambda.Draft:
        """
        Function to check if an obj was already fetched with an include that contains at least the fields of a specified
        include and fetches the missing data if it wasn't.  The returned instance, by default will be the original instance
        if it included at least the data for the requested include spec.  Otherwise it will perform a fetch with the
        ...
        """
            ...
        def getDirect(self, include: str=None) -> Union[DataValidation.Rule.Lambda.Draft]:
        """
        Gets an obj instance directly from Cassandra, bypassing the normal fetch framework.  It is only valid for C3 types
        that are stored in Cassandra.
        ...
        """
            ...
        def applyReverseEdit(self, versionEdit: VersionEdit) -> DataValidation.Rule.Lambda.Draft:
        """
        Applies a reverse edit (e.g. VersionEdit) to an instance.
        ...
        """
            ...
        @classmethod
        def fromString(cls, s: str) -> Union[DataValidation.Rule.Lambda.Draft]:
        """
        Parse the string-based representation and reconstruct the corresponding instance. This must be implemented to
        provide deserialization.
        ...
        """
            ...
        def create(self, spec: UpsertSpec=None) -> Union[DataValidation.Rule.Lambda.Draft]:
        """
        Creates an instance of a C3 type. If the operation fails an exception will be thrown.  This will fail if the
        instance already exist.
        ...
        """
            ...
        @classmethod
        def createBatch(cls, objs: Array[DataValidation.Rule.Lambda.Draft], spec: UpsertSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda.Draft]]:
        """
        Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
        specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
        returned {@link ObjList}.  This will fail if any of the instances already exist.
        ...
        """
            ...
        @classmethod
        def createBatchObjStream(cls, objs: Stream[DataValidation.Rule.Lambda.Draft], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda.Draft]]:
        """
        Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
        specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
        returned {@link ObjList}.  This will fail if any of the instances already exist.
        ...
        """
            ...
        def update(self, srcObj: DataValidation.Rule.Lambda.Draft=None, spec: UpsertSpec=None) -> Union[DataValidation.Rule.Lambda.Draft]:
        """
        Updates an instance of a C3 type. If the operation fails an exception will be thrown.  This will fail if the
        instance does not already exist.
        ...
        """
            ...
        def upsert(self, srcObj: DataValidation.Rule.Lambda.Draft=None, spec: UpsertSpec=None) -> Union[DataValidation.Rule.Lambda.Draft]:
        """
        Creates an instance of a C3 type if it doesn't exist or updates it if it does. If the operation fails an
        exception will be thrown.
        ...
        """
            ...
        @overload
        def merge(self, spec: MergeSpec=None) -> Union[DataValidation.Rule.Lambda.Draft]:
        """
        Merges an instance of a C3 type if it exists and creates it if it doesn't. Merging an obj instance by default only
        updates the non-null field values in the input obj.  Null field values are ignored.  Nullness of field values
        is honored at every level for fields that have an included type (e.g. non-entity type) as their value type. To
        ...
        """
            ...
        @overload
        def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[DataValidation.Rule.Lambda.Draft]:
        """
        Merges an instance of a C3 type if it exists and creates it if it doesn't.
        ...
        """
            ...
        def touch(self, spec: TouchSpec=None) -> Union[DataValidation.Rule.Lambda.Draft]:
        """
        Updates the 'meta.updated' field to the current time.  If the obj doesn't exist an error will be returned.
        ...
        """
            ...
        @classmethod
        def updateBatch(cls, objs: Array[DataValidation.Rule.Lambda.Draft], srcObjs: Array[DataValidation.Rule.Lambda.Draft]=None, spec: UpsertSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda.Draft]]:
        """
        Updates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
        specified (the default), then a C3BatchException will be thrown.  Otherwise {@linkerrors will be reported in the
        returned {@link ObjList}.  This will fail if any of the instances don't already exist.
        ...
        """
            ...
        @classmethod
        def updateObjs(cls, objs: Callable[[], Union[Array[DataValidation.Rule.Lambda.Draft]]], spec: UpsertSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda.Draft]]:
        """
        Updates multiple instances of a C3 type. If the operation fails due to a version conflict error, the lambda will be
        called again to provide updated instances to be updated. If the operation fails for other reasons and
        {@link UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
        ...
        """
            ...
        @classmethod
        def upsertBatch(cls, objs: Array[DataValidation.Rule.Lambda.Draft], srcObjs: Array[DataValidation.Rule.Lambda.Draft]=None, spec: UpsertSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda.Draft]]:
        """
        Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
        fails errors will be reported in the returned {@link ObjList}.
        ...
        """
            ...
        @classmethod
        def upsertObjs(cls, objs: Callable[[], Union[Array[DataValidation.Rule.Lambda.Draft]]], spec: UpsertSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda.Draft]]:
        """
        Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
        fails due to a version conflict error, the lambda will be called again to provide updated instances to be upserted.
        If the operation fails for other reasons and {@link UpsertSpec#dontThrowOnBatchError} is not specified (the
        ...
        """
            ...
        @classmethod
        def touchBatch(cls, objs: Array[DataValidation.Rule.Lambda.Draft], spec: TouchSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda.Draft]]:
        """
        Updates the 'meta.updated' field to the current time for a batch of objs.  Attempts to touch non-existing
        objs will be considered an error.
        ...
        @overload
        @classmethod
        def mergeBatch(cls, objs: Array[DataValidation.Rule.Lambda.Draft], spec: MergeSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda.Draft]]:
        """
        Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
        UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
        Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
        ...
        @overload
        @classmethod
        def mergeBatch(cls, objs: Array[DataValidation.Rule.Lambda.Draft], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda.Draft]]:
        """
        Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
        UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
        Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
        ...
        """
            ...
        @classmethod
        def mergeObjs(cls, objs: Callable[[], Union[Array[DataValidation.Rule.Lambda.Draft]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda.Draft]]:
        """
        Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails due to a version
        conflict error, the lambda will be called again to provide updated instances to be upserted. If the operation
        fails for other reasons and {@link UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a
        ...
        @overload
        @classmethod
        def mergeAll(cls, mergeObj: DataValidation.Rule.Lambda.Draft, spec: MergeAllSpec=None) -> Union[int]:
        """
        Merges an obj into multiple instances of a C3 type (e.g. mass merge). Like the {@link merge} and {@link mergeBatch}
        functions, the set of fields to be merged can be controlled by specifying an include spec in either
        {@link Mergespec#mergeInclude} or {@link Mergespec#csvInclude}.  Additionally, the objs to perform the operation on
        ...
        @overload
        @classmethod
        def mergeAll(cls, mergeObj: DataValidation.Rule.Lambda.Draft, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
        """
        Merges an obj into multiple instances of a C3 type (e.g. mass merge). The objs to perform the operation on can be
        controlled by specifying the {@link MergeAllSpec#filter}.  Valid filter expressions follow the same rules as in
        {@link FetchSpec#filter}.  If not specified, all instances will be merged.
        ...
        """
            ...
        @classmethod
        def removeBatch(cls, objs: Array[DataValidation.Rule.Lambda.Draft], spec: UpsertSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda.Draft]]:
        """
        Removes multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
        specified (the default), then a C3BatchException will be thrown.  Otherwise {@link ObjList#errors errors} will be
        reported in the returned {@link ObjList}.
        ...
        """
            ...
        @classmethod
        def replace(cls, objs: Array[DataValidation.Rule.Lambda.Draft], spec: UpsertSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda.Draft]]:
        """
        Replaces all instances of a C3 type. If the operation fails errors will be reported in the returned {@link ObjList}.
        ...
        """
            ...
        def unremove(self) -> Union[DataValidation.Rule.Lambda.Draft]:
        """
        Recovers archived instances of a C3 type (e.g. those removed via the {@link remove}, {@link removeAll} and
        {@link removeBatch} functions). If the operation fails an exception will be thrown.
        ...
        """
            ...
        @classmethod
        def beforeCreate(cls, objs: Array[DataValidation.Rule.Lambda.Draft]) -> ObjList[DataValidation.Rule.Lambda.Draft]:
        """
        Callback that is called synchronously during an operation that creates objs before those objs are created.  The
        implementer can perform validation or additional logic.
        ...
        """
            ...
        @classmethod
        def beforeUpdate(cls, objs: Array[DataValidation.Rule.Lambda.Draft]) -> ObjList[DataValidation.Rule.Lambda.Draft]:
        """
        Callback that is called synchronously during an operation that updates objs before those objs are updated.  The
        implementer can perform validation or additional logic.
        ...
        """
            ...
        @classmethod
        def beforeRemove(cls, objs: Array[DataValidation.Rule.Lambda.Draft]) -> ObjList[DataValidation.Rule.Lambda.Draft]:
        """
        Callback that is called synchronously during an operation that removes objs before those objs are removed.  The
        implementer can perform validation or additional logic.
        ...
        """
            ...
        @classmethod
        def afterCreate(cls, objs: Array[DataValidation.Rule.Lambda.Draft]) -> Union[Array[ObjError]]:
        """
        Callback that is called synchronously during a request that creates objs after those objs are created.  The
        implementer can perform additional logic.
        ...
        """
            ...
        @classmethod
        def afterUpdate(cls, objs: Array[DataValidation.Rule.Lambda.Draft]) -> Union[Array[ObjError]]:
        """
        Callback that is called synchronously during a request that updates objs after those objs are updated.  The
        implementer can perform additional logic.
        ...
        """
            ...
        @classmethod
        def afterRemove(cls, objs: Array[DataValidation.Rule.Lambda.Draft]) -> Union[Array[ObjError]]:
        """
        Callback that is called synchronously during a request that removes objs after those objs are removed.  The
        implementer can perform additional logic.
        ...
        """
            ...
        @classmethod
        def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[DataValidation.Rule.Lambda.Draft]:
        """
        @return a push stream to import instances of this type.
        """
            ...
        @classmethod
        def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[DataValidation.Rule.Lambda.Draft]:
        """
        @return a push stream to import instances of this type.
        """
            ...
        ...
        """
            ...
        @classmethod
        def forId(cls, id: str, failIfMissing: bool=None) -> Union[DataValidation.Rule.Lambda.Draft]:
        """
        @return single instance of this Identified type by id.
        """
            ...
        ...
        """
            ...
        def withoutIdentity(self) -> Union[DataValidation.Rule.Lambda.Draft]:
        """
        Removes the identifying fields {@link #id}, {@link #meta}, and {@link #version} of the instance it's called on,
        such that a subsequent upsert will create a new instance.
        ...
        """
            ...
        @classmethod
        def typeOfBatch(cls, objs: Array[DataValidation.Rule.Lambda.Draft]) -> Union[Array[EntityType]]:
        """
        Gets the specific C3 type hierarchy for multiple obj instances.  For a non-extendable type the hierarchy will be the
        C3 type of the input obj.  For extendable types it will contain the concrete extension type for the instance as well
        as that type's base type chain.
        ...
        """
            ...
        @classmethod
        def dbEcho(cls, template: DataValidation.Rule.Lambda.Draft=None, count: int=None, sendBack: bool=None) -> Union[int]:
        """
        Used only by DatabaseTestEngine
        """
            ...
        ...
        """
            ...
        @classmethod
        def callbackLogic(cls, objs: Array[DataValidation.Rule.Lambda.Draft], callback: Callable[[Union[DataValidation.Rule.Lambda.Draft]], Union[DataValidation.Rule.Lambda.Draft]]=None) -> ObjList[DataValidation.Rule.Lambda.Draft]:
        """
        Implements a simple logic for Persistable call-backs like before create by looping each input obj and
        calling a transform for it.
        ...
        """
            ...
        @classmethod
        def afterCallbackLogic(cls, objs: Array[DataValidation.Rule.Lambda.Draft], callback: Callable[[Union[DataValidation.Rule.Lambda.Draft]], Union[DataValidation.Rule.Lambda.Draft]]=None) -> Union[Array[ObjError]]:
        """
        Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
        calling a transform for it.
        """
        ...
        **overriddenArgs** are final (most probably extracted from {@link overiddenArgs}) and {@link #args} will not be looked up for any additional manipulation.
        ...
        """
            ...
        def toJsSource(self, src: DataValidation.Rule.Lambda.Draft=None) -> str:
        """
        Build the canonical JavaScript source code representation of this instance.  After running the produced JavaScript
        source code, the `data` variable in JavaScript should point to the instance.
        ...
        """
            ...
        @classmethod
        def fromJsSource(cls, js: str, src: DataValidation.Rule.Lambda.Draft=None) -> Union[DataValidation.Rule.Lambda.Draft]:
        """
        Parse and evaluate the JavaScript source code representation and reconstruct the corresponding instance.
        ...
        """
            ...
        def toPySource(self, src: DataValidation.Rule.Lambda.Draft=None) -> str:
        """
        Build the canonical Python source code representation of this instance.  After running the produced Python source
        code, the `data` identifier in Python should point to the instance.
        ...
        """
            ...
        @classmethod
        def fromPySource(cls, py: str, src: DataValidation.Rule.Lambda.Draft=None) -> Union[DataValidation.Rule.Lambda.Draft]:
        """
        Parse and evaluate the Python source code representation and reconstruct the corresponding instance.
        ...
        """
            ...
        @classmethod
        def deployRuleType(cls) -> Type[[DataValidation.Rule]]:
        """
        The Non Draft rule type associated to the current Draft type
        """
            ...
        def deploy(self, spec: DataValidation.Rule.Draft.DeploySpec=None) -> Union[DataValidation.Rule]:
        """
        Create (or merge into, if an existing rule with the same name exists) a "deployed" / non draft rule.
        """
            ...
        @classmethod
        def templates(cls) -> Array[str]:
        """
        Templates available for the lambda rule to help start the development process from a better state than a blank canvas.
        """
            ...
        @classmethod
        def template(cls, name: str) -> str:
        """
        @return a template for the provided name. This will populate the "userCode" in the Draft Lambda.
        """
            ...
        @classmethod
        def save(cls, rule: DataValidation.Rule.Lambda.Draft, spec: UpsertSpec=None) -> Union[DataValidation.Rule.WithLambda.SaveResult]:
        """
        An explicit save API to:
        1. Take the userCode and extract into the appropriate fields.
        2. Merge (along with the remaining fields). All the fields extracted from user code will be included in the merge.
           Note that if the extracted fields from user code are nulls, then the merged draft rule will also set those fields to nulls.
        3. If the id doesn't exist, then it will be assumed to be create().
        4. An **upsertSpec** is provided to influence any of the upsert related nuances.
        @param rule
               The Draft rule to be saved
        @param spec
               This spec is used to control the operation of persisting the Draft rule and what fields to return in the persisted rule
        @return
               The {@link DataValidation.Rule.WithLambda.SaveResult} containing the saved Draft rule and issues that are produced
               when parsing the user code.
        """
            ...
        @classmethod
        def issues(cls, rule: DataValidation.Rule.Lambda.Draft) -> Union[Array[DataValidation.Rule.Lambda.Issue]]:
        """
        Validate the provided Draft rule's userCode WITHOUT persisting any changes or advancing version.
        This parses the user code and returns the issues only.
        
        @param rule
               The Draft rule to be validated
        @return
               The list of issues detected when parsing the user code.
        """
            ...
        @classmethod
        def typeNames(cls) -> Set[str]:
        """
        Get the type names that are supported by this lambda rule.
        @return the type names that are supported by this lambda rule.
                Maintains insertion order to preserve the sort order of the types.
        """
            ...
    
    class MapReduceJob(MapReduce[Obj, void, void, void]):
        """
        Type powering the MapReduce execution model of LAMBDA rule.
        
        @remarks this represents a made instance of DataValidation.Rule.Lambda.MapReduceJob
        """
        ...
        rule: Optional[DataValidation.Rule.WithLambda]
        """
        Rule running as part of the current job.
        """

        ruleRun: Optional[DataValidation.Run]
        """
        {@link DataValidation.Run Run} for the rule which will be used by the job for posting details, debug or errors.
        """
        def __init__(self, run: Optional[MapReduceRun]=None, runs: Optional[Array[MapReduceRun]]=None, options: Optional[Obj]=None, onCompleteCallback: Optional[JobBase.Callback]=None, priority: Optional[int]=None, disabled: Optional[bool]=None, maxConcurrency: Optional[int]=None, maxConcurrencyPerNode: Optional[int]=None, runAsUser: Optional[bool]=None, nodePool: Optional[str]=None, skipIfRunning: Optional[bool]=None, numAutoRecoveryAttempts: Optional[int]=None, propagateActionContext: Optional[bool]=None, targetType: Optional[Type]=None, useFileSystemForInterVals: Optional[bool]=None, useBatchIdsForReadInput: Optional[bool]=None, include: Optional[str]=None, filter: Optional[str]=None, order: Optional[str]=None, limit: Optional[int]=None, samplePct: Optional[int]=None, batchSize: Optional[int]=None, subBatchSize: Optional[int]=None, numBatches: Optional[int]=None, abortOnError: Optional[bool]=None, typeIdent: Optional[str]=None, id: Optional[str]=None, versionEdits: Optional[Array[VersionEdit]]=None, name: Optional[str]=None, meta: Optional[Meta]=None, version: Optional[int]=None, typeWithBindings: Optional[Type]=None, targetFilter: Optional[Obj]=None, rule: Optional[DataValidation.Rule.WithLambda]=None, ruleRun: Optional[DataValidation.Run]=None) -> None: ...
        ...
        """
            ...
        @classmethod
        def fromJson(cls, json: any) -> Union[DataValidation.Rule.Lambda.MapReduceJob]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromJsonString(cls, json: str) -> Union[DataValidation.Rule.Lambda.MapReduceJob]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromXmlString(cls, xml: str) -> Union[DataValidation.Rule.Lambda.MapReduceJob]:
        """
        Load the XML-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def deserialize(cls, contentStr: str, contentType: str) -> Union[DataValidation.Rule.Lambda.MapReduceJob]:
        """
        Load from contentType representation and reconstruct the corresponding object.
        ...
        """
            ...
        def replaceType(self, old: Type, new: Type) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Returns new instance with all references to old type, including result of #type, replaced with new type. If new
        type does not contain fields from old or field value types are not convertable then drops the field.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataValidation.Rule.Lambda.MapReduceJob]:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the asynchronous `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[DataValidation.Rule.Lambda.MapReduceJob]:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        asynchronous `mapper` invocation.
        ...
        """
            ...
        def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Result of this function call is a copy of current instance with specified field value replaced based on result of
        the `mapper` invocation.
        @param field
        ...
        """
            ...
        @overload
        def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def validateObj(self) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Populates all missing default values and throws error if any constraint is violated.
        """
            ...
        ...
        """
            ...
        @overload
        def withField(self, field: str, value: Any, doNotConvert: bool=None) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        @overload
        def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Builds a new Obj instance by adding the provided fields in it. The name must correspond to an existing fields
        defined on this type or its mixins. The values must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Builds a new Obj with the value at the specified path field. If the field is null, the field #isFieldSet to null.
        If you would like to #unsetField, you should call #withoutFieldAtPath instead.
        ...
        """
            ...
        def withoutFieldAtPath(self, path: str) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Builds a new Obj without the specified path field.
        ...
        """
            ...
        @overload
        def withoutField(self, field: str) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Builds a new Obj, removing the field with the provided name.
        ...
        """
            ...
        @overload
        def withoutField(self, field: FieldType) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Builds a new Obj, removing the field with the provided field type.
        ...
        """
            ...
        def withoutFields(self, fields: Array[str]) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Builds a new Obj, removing the fields with the provided names.
        ...
        """
            ...
        def withoutFieldsByType(self, fields: Array[FieldType]) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Builds a new Obj, removing the fields with the provided field types. Be sure to use the FieldType instance for the
        exact same type as the type of the obj to respect the "ordinal" of the field type
        ...
        """
            ...
        def withoutSecretFields(self) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
        """
            ...
        ...
        """
            ...
        def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Builds a new Obj instance by adding the default values (if defined) for all unset fields. This is implemented by
        calling {@link FieldType#defaultValue defaultValue} for a field if it is not already set and
        {@link FieldType#hasDefault has a default}. It will also set {@see ValueType#initialValue initial values} for
        ...
        """
            ...
        @overload
        def defaultField(self, field: str) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Builds a new Obj, by setting a field on this `Obj` to the field's default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def defaultField(self, field: FieldType) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Builds a new Obj, by setting a field on this `Obj` to the fields default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def unsetField(self, field: str) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def unsetField(self, field: FieldType) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def removeField(self, field: str) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def removeField(self, field: FieldType) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence unless otherwise specified by the fieldPathMergeSpec
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence.
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist on other Obj and do not exist on this Obj will not be added to final Obj.
        @param deep
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist other Obj and do not exist on this Obj will not be added to final Obj or evaluated. Does not
        traverse child reference and collection fields.
        ...
        """
            ...
        def mergeJson(self, json: any) -> DataValidation.Rule.Lambda.MapReduceJob:
            ...
        def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Merge the obj references within the current obj
        @param deep
               If set, traverses the reference fields within the obj as well for a deep merge
        ...
        """
            ...
        def sumObj(self, other: Obj, deep: bool=None) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Adds the numeric Obj fields with the other Objs respective fields.
        If deep is set it will traverse reference and collection fields and sum corresponding numeric fields in
        references with same name and collection elements at same index or key.
        """
            ...
        def singletonArray(self) -> Array[DataValidation.Rule.Lambda.MapReduceJob]:
        """
        Build an array of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def array(cls, *elements: Array[Any]) -> Union[Array[DataValidation.Rule.Lambda.MapReduceJob]]:
        """
        Creates an array of instances of this type.
        """
            ...
        @classmethod
        def arrayBuilder(cls) -> Union[ArrayBuilder[DataValidation.Rule.Lambda.MapReduceJob]]:
        """
        Creates an array of instances of this type.
        """
            ...
        def singletonSet(self) -> Set[DataValidation.Rule.Lambda.MapReduceJob]:
        """
        Build an set of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def setBuilder(cls) -> Union[SetBuilder[DataValidation.Rule.Lambda.MapReduceJob]]:
        """
        Creates a set of instances of this type.
        """
            ...
        @classmethod
        def mapBuilder(cls) -> Union[MapBuilder[str, DataValidation.Rule.Lambda.MapReduceJob]]:
        """
        Create a map of string to elements of this type.
        """
            ...
        @classmethod
        def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, DataValidation.Rule.Lambda.MapReduceJob]]:
        """
        Create a map with the given key type and elements of this type.
        """
            ...
        ...
        def myStreamType(cls) -> StreamType:
            ...
        def toBuilder(self) -> ObjBuilder[DataValidation.Rule.Lambda.MapReduceJob]:
        """
        @return new ObjBuilder with initial state set to fields of this instance.
        """
            ...
        @classmethod
        def builder(cls) -> ObjBuilder[DataValidation.Rule.Lambda.MapReduceJob]:
        """
        @return new ObjBuilder of this instance.
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Construct an instance of this type from provided fields
        @param fields
                   Fields to construct the instance of the obj with
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def make(cls, withDefaults: bool=None) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Construct an instance of this type with no non-default field values unless explicitly specified by passing param true
        @param withDefaults
                   If set, then the Obj is made with default & initial values (required primitive fields e.g. !int32 -> 0)
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Construct an instance from provided fields
        @param fields
                   Fields (in the format <field_name, value>) to construct an instance of the obj. Note that "type" as a
        ...
        @overload
        @classmethod
        def make(cls, fields: Any, withDefaults: bool=None) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Construct an instance of this type from provided fields. Note it is more efficient to use #fromFields and other overloads
        ...
        @overload
        @classmethod
        def make(cls, s: str) -> Union[DataValidation.Rule.Lambda.MapReduceJob]:
        """
        Construct an instance of this type from the string. This is an alias for #fromString, as a specific overload
        when the argument is a known string.
        ...
        """
            ...
        @classmethod
        def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Construct an instance of this type from provided instance of a subtype or a "duck type".
        """
            ...
        ...
        """
            ...
        def afterMake(self) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Optional override that will be called after every instance creation.
        ...
        """
            ...
        @classmethod
        def cachedEmptyInst(cls) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Creates an empty inst using `MyType.make()` and caches it. Avoid recreating multiple copies of the spec for
        every action dispatch. The cached inst can also be used for comparing whether the object is an empty or not
        Will only create empty instance for immutable Obj e.g. if an Obj is Mutable, this method will throw an error
        ...
        """
            ...
        @classmethod
        def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[DataValidation.Rule.Lambda.MapReduceJob]]:
        """
        Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
        value is read.
        """
            ...
        @classmethod
        def generateObj(cls, spec: Obj.GenerateSpec=None) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Generate a single instance of this type. The base implementation uses {@link DataGenObj} to generate uniform
        random (gibberish) values for all fields, but it may be overridden by specific types with custom logic that
        populates fields in a more realistic way.
        ...
        @overload
        @classmethod
        def fetch(cls, spec: FetchSpec=None) -> FetchResult[DataValidation.Rule.Lambda.MapReduceJob]:
        """
        Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
        returned.
        ...
        @overload
        @classmethod
        def fetch(cls, filter: Filter) -> FetchResult[DataValidation.Rule.Lambda.MapReduceJob]:
        """
        Fetches multiple obj instances based on a filter.  Only objs that the caller is authorized to fetch will be
        returned.
        ...
        """
            ...
        @classmethod
        def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[DataValidation.Rule.Lambda.MapReduceJob]]:
        """
        Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
        returned.
        ...
        """
            ...
        @classmethod
        def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[DataValidation.Rule.Lambda.MapReduceJob]]]:
        """
        Fetched multiple obj instances in multiple locales based on specification.
        ...
        """
            ...
        def get(self, include: str=None) -> Union[DataValidation.Rule.Lambda.MapReduceJob]:
        """
        Gets an instance of a single obj.  If the caller is not authorized to fetch the obj, it will not be returned.
        ...
        """
            ...
        def getSpecific(self, include: str=None) -> Union[DataValidation.Rule.Lambda.MapReduceJob]:
        """
        Gets an instance of a single obj in it's leaf type if the type is extendable.  If the caller is not authorized
        to fetch the obj, it will not be returned.
        ...
        """
            ...
        def getMissing(self, spec: GetMissingSpec) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Function to check if an obj was already fetched with an include that contains at least the fields of a specified
        include and fetches the missing data if it wasn't.  The returned instance, by default will be the original instance
        if it included at least the data for the requested include spec.  Otherwise it will perform a fetch with the
        ...
        """
            ...
        def getDirect(self, include: str=None) -> Union[DataValidation.Rule.Lambda.MapReduceJob]:
        """
        Gets an obj instance directly from Cassandra, bypassing the normal fetch framework.  It is only valid for C3 types
        that are stored in Cassandra.
        ...
        """
            ...
        def applyReverseEdit(self, versionEdit: VersionEdit) -> DataValidation.Rule.Lambda.MapReduceJob:
        """
        Applies a reverse edit (e.g. VersionEdit) to an instance.
        ...
        """
            ...
        @classmethod
        def fromString(cls, s: str) -> Union[DataValidation.Rule.Lambda.MapReduceJob]:
        """
        Parse the string-based representation and reconstruct the corresponding instance. This must be implemented to
        provide deserialization.
        ...
        """
            ...
        def create(self, spec: UpsertSpec=None) -> Union[DataValidation.Rule.Lambda.MapReduceJob]:
        """
        Creates an instance of a C3 type. If the operation fails an exception will be thrown.  This will fail if the
        instance already exist.
        ...
        """
            ...
        @classmethod
        def createBatch(cls, objs: Array[DataValidation.Rule.Lambda.MapReduceJob], spec: UpsertSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda.MapReduceJob]]:
        """
        Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
        specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
        returned {@link ObjList}.  This will fail if any of the instances already exist.
        ...
        """
            ...
        @classmethod
        def createBatchObjStream(cls, objs: Stream[DataValidation.Rule.Lambda.MapReduceJob], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda.MapReduceJob]]:
        """
        Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
        specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
        returned {@link ObjList}.  This will fail if any of the instances already exist.
        ...
        """
            ...
        def update(self, srcObj: DataValidation.Rule.Lambda.MapReduceJob=None, spec: UpsertSpec=None) -> Union[DataValidation.Rule.Lambda.MapReduceJob]:
        """
        Updates an instance of a C3 type. If the operation fails an exception will be thrown.  This will fail if the
        instance does not already exist.
        ...
        """
            ...
        def upsert(self, srcObj: DataValidation.Rule.Lambda.MapReduceJob=None, spec: UpsertSpec=None) -> Union[DataValidation.Rule.Lambda.MapReduceJob]:
        """
        Creates an instance of a C3 type if it doesn't exist or updates it if it does. If the operation fails an
        exception will be thrown.
        ...
        """
            ...
        @overload
        def merge(self, spec: MergeSpec=None) -> Union[DataValidation.Rule.Lambda.MapReduceJob]:
        """
        Merges an instance of a C3 type if it exists and creates it if it doesn't. Merging an obj instance by default only
        updates the non-null field values in the input obj.  Null field values are ignored.  Nullness of field values
        is honored at every level for fields that have an included type (e.g. non-entity type) as their value type. To
        ...
        """
            ...
        @overload
        def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[DataValidation.Rule.Lambda.MapReduceJob]:
        """
        Merges an instance of a C3 type if it exists and creates it if it doesn't.
        ...
        """
            ...
        def touch(self, spec: TouchSpec=None) -> Union[DataValidation.Rule.Lambda.MapReduceJob]:
        """
        Updates the 'meta.updated' field to the current time.  If the obj doesn't exist an error will be returned.
        ...
        """
            ...
        @classmethod
        def updateBatch(cls, objs: Array[DataValidation.Rule.Lambda.MapReduceJob], srcObjs: Array[DataValidation.Rule.Lambda.MapReduceJob]=None, spec: UpsertSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda.MapReduceJob]]:
        """
        Updates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
        specified (the default), then a C3BatchException will be thrown.  Otherwise {@linkerrors will be reported in the
        returned {@link ObjList}.  This will fail if any of the instances don't already exist.
        ...
        """
            ...
        @classmethod
        def updateObjs(cls, objs: Callable[[], Union[Array[DataValidation.Rule.Lambda.MapReduceJob]]], spec: UpsertSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda.MapReduceJob]]:
        """
        Updates multiple instances of a C3 type. If the operation fails due to a version conflict error, the lambda will be
        called again to provide updated instances to be updated. If the operation fails for other reasons and
        {@link UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
        ...
        """
            ...
        @classmethod
        def upsertBatch(cls, objs: Array[DataValidation.Rule.Lambda.MapReduceJob], srcObjs: Array[DataValidation.Rule.Lambda.MapReduceJob]=None, spec: UpsertSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda.MapReduceJob]]:
        """
        Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
        fails errors will be reported in the returned {@link ObjList}.
        ...
        """
            ...
        @classmethod
        def upsertObjs(cls, objs: Callable[[], Union[Array[DataValidation.Rule.Lambda.MapReduceJob]]], spec: UpsertSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda.MapReduceJob]]:
        """
        Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
        fails due to a version conflict error, the lambda will be called again to provide updated instances to be upserted.
        If the operation fails for other reasons and {@link UpsertSpec#dontThrowOnBatchError} is not specified (the
        ...
        """
            ...
        @classmethod
        def touchBatch(cls, objs: Array[DataValidation.Rule.Lambda.MapReduceJob], spec: TouchSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda.MapReduceJob]]:
        """
        Updates the 'meta.updated' field to the current time for a batch of objs.  Attempts to touch non-existing
        objs will be considered an error.
        ...
        @overload
        @classmethod
        def mergeBatch(cls, objs: Array[DataValidation.Rule.Lambda.MapReduceJob], spec: MergeSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda.MapReduceJob]]:
        """
        Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
        UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
        Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
        ...
        @overload
        @classmethod
        def mergeBatch(cls, objs: Array[DataValidation.Rule.Lambda.MapReduceJob], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda.MapReduceJob]]:
        """
        Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
        UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
        Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
        ...
        """
            ...
        @classmethod
        def mergeObjs(cls, objs: Callable[[], Union[Array[DataValidation.Rule.Lambda.MapReduceJob]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda.MapReduceJob]]:
        """
        Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails due to a version
        conflict error, the lambda will be called again to provide updated instances to be upserted. If the operation
        fails for other reasons and {@link UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a
        ...
        @overload
        @classmethod
        def mergeAll(cls, mergeObj: DataValidation.Rule.Lambda.MapReduceJob, spec: MergeAllSpec=None) -> Union[int]:
        """
        Merges an obj into multiple instances of a C3 type (e.g. mass merge). Like the {@link merge} and {@link mergeBatch}
        functions, the set of fields to be merged can be controlled by specifying an include spec in either
        {@link Mergespec#mergeInclude} or {@link Mergespec#csvInclude}.  Additionally, the objs to perform the operation on
        ...
        @overload
        @classmethod
        def mergeAll(cls, mergeObj: DataValidation.Rule.Lambda.MapReduceJob, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
        """
        Merges an obj into multiple instances of a C3 type (e.g. mass merge). The objs to perform the operation on can be
        controlled by specifying the {@link MergeAllSpec#filter}.  Valid filter expressions follow the same rules as in
        {@link FetchSpec#filter}.  If not specified, all instances will be merged.
        ...
        """
            ...
        @classmethod
        def removeBatch(cls, objs: Array[DataValidation.Rule.Lambda.MapReduceJob], spec: UpsertSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda.MapReduceJob]]:
        """
        Removes multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
        specified (the default), then a C3BatchException will be thrown.  Otherwise {@link ObjList#errors errors} will be
        reported in the returned {@link ObjList}.
        ...
        """
            ...
        @classmethod
        def replace(cls, objs: Array[DataValidation.Rule.Lambda.MapReduceJob], spec: UpsertSpec=None) -> Union[ObjList[DataValidation.Rule.Lambda.MapReduceJob]]:
        """
        Replaces all instances of a C3 type. If the operation fails errors will be reported in the returned {@link ObjList}.
        ...
        """
            ...
        def unremove(self) -> Union[DataValidation.Rule.Lambda.MapReduceJob]:
        """
        Recovers archived instances of a C3 type (e.g. those removed via the {@link remove}, {@link removeAll} and
        {@link removeBatch} functions). If the operation fails an exception will be thrown.
        ...
        """
            ...
        @classmethod
        def beforeCreate(cls, objs: Array[DataValidation.Rule.Lambda.MapReduceJob]) -> ObjList[DataValidation.Rule.Lambda.MapReduceJob]:
        """
        Callback that is called synchronously during an operation that creates objs before those objs are created.  The
        implementer can perform validation or additional logic.
        ...
        """
            ...
        @classmethod
        def beforeUpdate(cls, objs: Array[DataValidation.Rule.Lambda.MapReduceJob]) -> ObjList[DataValidation.Rule.Lambda.MapReduceJob]:
        """
        Callback that is called synchronously during an operation that updates objs before those objs are updated.  The
        implementer can perform validation or additional logic.
        ...
        """
            ...
        @classmethod
        def beforeRemove(cls, objs: Array[DataValidation.Rule.Lambda.MapReduceJob]) -> ObjList[DataValidation.Rule.Lambda.MapReduceJob]:
        """
        Callback that is called synchronously during an operation that removes objs before those objs are removed.  The
        implementer can perform validation or additional logic.
        ...
        """
            ...
        @classmethod
        def afterCreate(cls, objs: Array[DataValidation.Rule.Lambda.MapReduceJob]) -> Union[Array[ObjError]]:
        """
        Callback that is called synchronously during a request that creates objs after those objs are created.  The
        implementer can perform additional logic.
        ...
        """
            ...
        @classmethod
        def afterUpdate(cls, objs: Array[DataValidation.Rule.Lambda.MapReduceJob]) -> Union[Array[ObjError]]:
        """
        Callback that is called synchronously during a request that updates objs after those objs are updated.  The
        implementer can perform additional logic.
        ...
        """
            ...
        @classmethod
        def afterRemove(cls, objs: Array[DataValidation.Rule.Lambda.MapReduceJob]) -> Union[Array[ObjError]]:
        """
        Callback that is called synchronously during a request that removes objs after those objs are removed.  The
        implementer can perform additional logic.
        ...
        """
            ...
        @classmethod
        def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[DataValidation.Rule.Lambda.MapReduceJob]:
        """
        @return a push stream to import instances of this type.
        """
            ...
        @classmethod
        def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[DataValidation.Rule.Lambda.MapReduceJob]:
        """
        @return a push stream to import instances of this type.
        """
            ...
        ...
        """
            ...
        @classmethod
        def forId(cls, id: str, failIfMissing: bool=None) -> Union[DataValidation.Rule.Lambda.MapReduceJob]:
        """
        @return single instance of this Identified type by id.
        """
            ...
        ...
        """
            ...
        def withoutIdentity(self) -> Union[DataValidation.Rule.Lambda.MapReduceJob]:
        """
        Removes the identifying fields {@link #id}, {@link #meta}, and {@link #version} of the instance it's called on,
        such that a subsequent upsert will create a new instance.
        ...
        """
            ...
        @classmethod
        def typeOfBatch(cls, objs: Array[DataValidation.Rule.Lambda.MapReduceJob]) -> Union[Array[EntityType]]:
        """
        Gets the specific C3 type hierarchy for multiple obj instances.  For a non-extendable type the hierarchy will be the
        C3 type of the input obj.  For extendable types it will contain the concrete extension type for the instance as well
        as that type's base type chain.
        ...
        """
            ...
        @classmethod
        def dbEcho(cls, template: DataValidation.Rule.Lambda.MapReduceJob=None, count: int=None, sendBack: bool=None) -> Union[int]:
        """
        Used only by DatabaseTestEngine
        """
            ...
        ...
        """
            ...
        @classmethod
        def callbackLogic(cls, objs: Array[DataValidation.Rule.Lambda.MapReduceJob], callback: Callable[[Union[DataValidation.Rule.Lambda.MapReduceJob]], Union[DataValidation.Rule.Lambda.MapReduceJob]]=None) -> ObjList[DataValidation.Rule.Lambda.MapReduceJob]:
        """
        Implements a simple logic for Persistable call-backs like before create by looping each input obj and
        calling a transform for it.
        ...
        """
            ...
        @classmethod
        def afterCallbackLogic(cls, objs: Array[DataValidation.Rule.Lambda.MapReduceJob], callback: Callable[[Union[DataValidation.Rule.Lambda.MapReduceJob]], Union[DataValidation.Rule.Lambda.MapReduceJob]]=None) -> Union[Array[ObjError]]:
        """
        Implements a simple logic for Persistable "after" call-backs like after create by looping each input obj and
        calling a transform for it.
        """
        ...
        """
            ...
        @classmethod
        def map(cls, batch: int=None, objs: Array[Obj]=None, job: MapReduce[Obj, , , ]=None, subBatch: int=None) -> Union[Map[, ]]:
        """
        {@inheritDoc}
        
        Please note that {@link DataValidation.Rule#map} of the rule will be executed as part of this run.
        """
            ...
        @classmethod
        def reduce(cls, outKey: =None, interValues: Array[]=None, job: MapReduce[Obj, , , ]=None) -> Union[Union[,Array[]]]:
        """
        ...
        """
            ...
        @classmethod
        def mapCompleted(cls, job: MapReduce[Obj, , , ]=None) -> None:
        """
        ...
        """
            ...
        @classmethod
        def completed(cls, job: MapReduce[Obj, , , ]=None) -> Union[str]:
        """
        If there are no map tasks, then reduce will not be invoked. Therefore, **completed** is chosen to execute the finalization.
        Please note that any error encountered during execution in **completed** will not cause {@link DataValidation.Run#waitForCompletion} to fail.However, an {@link DataValidation.Run.Error} will still be generated.
        """
            ...
        @classmethod
        def failed(cls, job: MapReduce[Obj, , , ], status: MapReduceStatus, options: MapReduceOptions=None) -> None:
        """
        ...
        """
            ...
        def results(self, limit: int='10000') -> Union[Map[, Union[,Array[]]]]:
        """
        ...
        """
        Override the scanTargetType to handle that error that occurs in it
        """
            ...
