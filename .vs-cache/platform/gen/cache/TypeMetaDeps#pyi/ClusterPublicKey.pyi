...
# Python definitions for the C3 type ClusterPublicKey


class ClusterPublicKey(Config, Identifiable):
    """
    Type that persists public key for all pod's in an env. All pods in an env can read each other's public key.
    
    @remarks this represents a made instance of ClusterPublicKey
    """
    ...
    """
    public key of a cluster
    """
    def __init__(self, configOverride: Optional[str]=None, secretOverride: Optional[str]=None, issues: Optional[Array[str]]=None, id: Optional[str]=None, key: Optional[str]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[ClusterPublicKey]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[ClusterPublicKey]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[ClusterPublicKey]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[ClusterPublicKey]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ClusterPublicKey:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ClusterPublicKey:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> ClusterPublicKey:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ClusterPublicKey]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[ClusterPublicKey]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> ClusterPublicKey:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ClusterPublicKey:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> ClusterPublicKey:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> ClusterPublicKey:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> ClusterPublicKey:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> ClusterPublicKey:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> ClusterPublicKey:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> ClusterPublicKey:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> ClusterPublicKey:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> ClusterPublicKey:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> ClusterPublicKey:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> ClusterPublicKey:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> ClusterPublicKey:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> ClusterPublicKey:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> ClusterPublicKey:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> ClusterPublicKey:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> ClusterPublicKey:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> ClusterPublicKey:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> ClusterPublicKey:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> ClusterPublicKey:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> ClusterPublicKey:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> ClusterPublicKey:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> ClusterPublicKey:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> ClusterPublicKey:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> ClusterPublicKey:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> ClusterPublicKey:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> ClusterPublicKey:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> ClusterPublicKey:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[ClusterPublicKey]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[ClusterPublicKey]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[ClusterPublicKey]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[ClusterPublicKey]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[ClusterPublicKey]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, ClusterPublicKey]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, ClusterPublicKey]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[ClusterPublicKey]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[ClusterPublicKey]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> ClusterPublicKey:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> ClusterPublicKey:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> ClusterPublicKey:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> ClusterPublicKey:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> ClusterPublicKey:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> ClusterPublicKey:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[ClusterPublicKey]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> ClusterPublicKey:
    """
    ...
    """
        ...
    def afterMake(self) -> ClusterPublicKey:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> ClusterPublicKey:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[ClusterPublicKey]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> ClusterPublicKey:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[ClusterPublicKey]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[ClusterPublicKey]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[ClusterPublicKey]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[ClusterPublicKey]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[ClusterPublicKey]:
    """
    Returns cached instance by key, with secrets removed.
    """
        ...
    def getCached(self) -> Union[ClusterPublicKey]:
    """
    ...
    """
        ...
    def refreshCache(self) -> Union[ClusterPublicKey]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[ClusterPublicKey]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, ClusterPublicKey]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, ClusterPublicKey]]:
    """
    ...
    """
        ...
    def getConfig(self) -> ClusterPublicKey:
    """
    ...
    """
        ...
    def getSecret(self) -> ClusterPublicKey:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[ClusterPublicKey]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[ClusterPublicKey]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: ClusterPublicKey, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: ClusterPublicKey, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[ClusterPublicKey]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[ClusterPublicKey]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[ClusterPublicKey]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> ClusterPublicKey:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[ClusterPublicKey]:
    """
