...
# Python definitions for the C3 type CompoundMetricCache


class CompoundMetricCache(MetadataCacheOld[map[string, CompoundMetric]], Value):
    """
    ...
    @classmethod
    def get(cls, key: str) -> Union[Map[str, CompoundMetric]]:
    """
    ...
    """
        ...
    @classmethod
    def require(cls, key: str) -> Map[str, CompoundMetric]:
    """
    ...
    """
        ...
    @classmethod
    def put(cls, key: str, value: Map[str, CompoundMetric]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[Map[str, CompoundMetric]]:
    """
    ...
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, Map[str, CompoundMetric]]]:
    """
    ...
    """
        ...
    @classmethod
    def release(cls, key: str, value: Map[str, CompoundMetric]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def validate(cls, value: Map[str, CompoundMetric]) -> bool:
    """
    ...
    """
        ...
    @classmethod
    def metrics(cls) -> Union[Map[str, CompoundMetric]]:
    """
