...
# Python definitions for the C3 type SimpleMetricsByNameCache


class SimpleMetricsByNameCache(MetadataCacheOld[map[string, [string]]], Value):
    """
    ...
    @classmethod
    def get(cls, key: str) -> Union[Map[str, Array[str]]]:
    """
    ...
    """
        ...
    @classmethod
    def require(cls, key: str) -> Map[str, Array[str]]:
    """
    ...
    """
        ...
    @classmethod
    def put(cls, key: str, value: Map[str, Array[str]]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[Map[str, Array[str]]]:
    """
    ...
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, Map[str, Array[str]]]]:
    """
    ...
    """
        ...
    @classmethod
    def release(cls, key: str, value: Map[str, Array[str]]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def validate(cls, value: Map[str, Array[str]]) -> bool:
    """
    ...
    """
        ...
    @classmethod
    def metricsByName(cls) -> Union[Map[str, Array[str]]]:
        ...
