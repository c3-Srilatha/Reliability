...
from c3.platform.AzurePostgreSqlServerProperties import AzurePostgreSqlServerProperties
...
from c3.platform.AzurePostgreSqlServerResponseFields import AzurePostgreSqlServerResponseFields
...
from c3.platform.AzurePostgreSqlServerApi import AzurePostgreSqlServerApi
from c3.platform.ArrayBuilder import ArrayBuilder
from c3.platform.AzurePostgreSqlServerCreateFields import AzurePostgreSqlServerCreateFields
from c3.platform.Error import Error
from c3.platform.ReferenceType import ReferenceType
from c3.platform.ArrayType import ArrayType
from c3.platform.AzurePostgreSqlServerSku import AzurePostgreSqlServerSku
...
from c3.platform.AzurePostgreSqlServerUpdateFields import AzurePostgreSqlServerUpdateFields
...
# Python definitions for the C3 type AzurePostgreSqlServer


class AzurePostgreSqlServer(AzureGenericResource, AzurePostgreSqlServerFields):
    """
    This represents Azure PostgreSql Server.
    
    @remarks this represents a made instance of AzurePostgreSqlServer
    """
    ...
    @overload
    @classmethod
    def fromString(cls, s: str) -> Union[AzurePostgreSqlServer]:
    """
    ...
    @overload
    @classmethod
    def fromString(cls, s: str, failIfInvalid: bool=None) -> Union[AzurePostgreSqlServer]:
    """
    Constructs Cloud Resource instance with reference fields and credentials based on provided Cloud Reference string.
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[AzurePostgreSqlServer]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> AzurePostgreSqlServer:
    """
    ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> AzurePostgreSqlServer:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> AzurePostgreSqlServer:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[AzurePostgreSqlServer]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[AzurePostgreSqlServer]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[AzurePostgreSqlServer]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[AzurePostgreSqlServer]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AzurePostgreSqlServer]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AzurePostgreSqlServer]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AzurePostgreSqlServer:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> AzurePostgreSqlServer:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> AzurePostgreSqlServer:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> AzurePostgreSqlServer:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> AzurePostgreSqlServer:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> AzurePostgreSqlServer:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> AzurePostgreSqlServer:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[AzurePostgreSqlServer]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[AzurePostgreSqlServer]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[AzurePostgreSqlServer]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[AzurePostgreSqlServer]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[AzurePostgreSqlServer]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, AzurePostgreSqlServer]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, AzurePostgreSqlServer]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[AzurePostgreSqlServer]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[AzurePostgreSqlServer]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> AzurePostgreSqlServer:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    def afterMake(self) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[AzurePostgreSqlServer]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[AzurePostgreSqlServer]:
    """
    Find Cloud Resource in Cloud Provider based on provided C3 canonical identifier.
    """
        ...
    @classmethod
    def fromClusterId(cls, clusterId: str, env: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AzurePostgreSqlServer:
    """
    Construct a cloud ID from a cluster ID
    """
        ...
    @classmethod
    def fromEnvId(cls, envId: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    @classmethod
    def fromAppId(cls, appId: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    @classmethod
    def fromId(cls, id: str, failIfInvalid: bool=None) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    @classmethod
    def fromCloudId(cls, id: CloudId, failIfInvalid: bool=None) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    def fromConfigTemplate(self, spec: CloudResourceOperationSpec=None) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    def withDefaultConfig(self, spec: CloudResourceOperationSpec=None) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    def upsertResource(self, spec: CloudResourceOperationSpec=None) -> AzurePostgreSqlServer:
    """
    Create or update Cloud Resource.
    """
        ...
    def upsertWithDependencies(self, spec: CloudResourceOperationSpec=None) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[AzurePostgreSqlServer]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[AzurePostgreSqlServer]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[AzurePostgreSqlServer]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[AzurePostgreSqlServer]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[AzurePostgreSqlServer]:
    """
    Returns cached instance by key, with secrets removed.
    """
        ...
    def getCached(self) -> Union[AzurePostgreSqlServer]:
    """
    This method on any CloudResource is not supported! Use CloudResource.for* or other methods instead.
    """
        ...
    def refreshCache(self) -> Union[AzurePostgreSqlServer]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[AzurePostgreSqlServer]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, AzurePostgreSqlServer]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, AzurePostgreSqlServer]]:
    """
    ...
    """
        ...
    def getConfig(self) -> AzurePostgreSqlServer:
    """
    This method on any CloudResource is not supported! Use CloudResource.for* or other methods instead.
    """
        ...
    ...
    """
        ...
    def getSecret(self) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[AzurePostgreSqlServer]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[AzurePostgreSqlServer]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: AzurePostgreSqlServer, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: AzurePostgreSqlServer, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[AzurePostgreSqlServer]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[AzurePostgreSqlServer]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[AzurePostgreSqlServer]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    def withIdentity(self, resource: CloudResource=None, spec: CloudResourceOperationSpec=None) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    def mergeId(self, other: CloudResource=None) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    @classmethod
    def forCloudId(cls, id: CloudId, failIfMissing: bool=None) -> Union[AzurePostgreSqlServer]:
    """
    ...
    """
        ...
    @classmethod
    def forCloudFunc(cls, func: str, role: str=None, failIfMissing: bool=None) -> AzurePostgreSqlServer:
    """
    Find Cloud Resource based on provided cloud func component and optional role.
    """
        ...
    @classmethod
    def forCloudRole(cls, role: str, failIfMissing: bool=None) -> AzurePostgreSqlServer:
    """
    Find Cloud Resource of this type based on provided cloud role component.
    """
        ...
    @classmethod
    def forResourceId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AzurePostgreSqlServer]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def forResourceSecondaryId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AzurePostgreSqlServer]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forResourceName(cls, resourceName: str, failIfMissing: bool=None) -> Union[AzurePostgreSqlServer]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def findResource(cls, reference: str, failIfMissing: bool=None) -> Union[AzurePostgreSqlServer]:
    """
    Find Cloud Resource in the Cloud Provider by provided {@link CloudRef} string.
    """
        ...
    def getResource(self) -> Union[AzurePostgreSqlServer]:
    """
    Find Cloud Resource in the Cloud Provider by provided #resourceId, #resourceSecondaryId, #resourceName or #tags
    (in that order).
    """
        ...
    def ensureResource(self) -> AzurePostgreSqlServer:
    """
    Checks that the resource is persisted. If not, upserts the resource, to ensure that the resource exists.
    """
        ...
    @classmethod
    def listResourcesBySubtype(cls, spec: CloudListResourcesSpec=None) -> Map[str, CloudListResourcesResult[AzurePostgreSqlServer]]:
    """
    ...
    """
        ...
    @classmethod
    def listResources(cls, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzurePostgreSqlServer]:
    """
    ...
    """
        ...
    @classmethod
    def listResourcesForTags(cls, *keyValuePairs: Array[str]) -> CloudListResourcesResult[AzurePostgreSqlServer]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForClusterId(cls, clusterId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzurePostgreSqlServer]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForEnvId(cls, envId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzurePostgreSqlServer]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForAppId(cls, appId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzurePostgreSqlServer]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    def upsertDependencies(self, spec: CloudResourceOperationSpec=None) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    def waitForCreate(self, spec: WaitSpec=None) -> Union[AzurePostgreSqlServer]:
    """
    ...
    """
        ...
    @classmethod
    def tagResourcesBatch(cls, resources: Array[AzurePostgreSqlServer], tags: Array[CloudTag]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    @classmethod
    def untagResourcesBatch(cls, resources: Array[AzurePostgreSqlServer], tagKeys: Array[str]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    def waitForOk(self, spec: WaitSpec=None) -> Union[AzurePostgreSqlServer]:
    """
    ...
    """
        ...
    def waitForState(self, state: str='AVAILABLE', spec: WaitSpec=None) -> Union[AzurePostgreSqlServer]:
    """
    ...
    """
        ...
    def setFullyConfigured(self, fullyConfigured: bool=None, override: str=None) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    def afterCreate(self, input: AzurePostgreSqlServer=None) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    def beforeCreate(self) -> AzurePostgreSqlServer:
    """
    Optional callback to alter resource before creating it.
    """
        ...
    def beforeUpdate(self) -> AzurePostgreSqlServer:
    """
    Optional callback to alter resource before updating it.
    """
        ...
    def beforeDestroy(self) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    def withoutNonModifiableFields(self) -> AzurePostgreSqlServer:
    """
    ...
    """
        ...
    @classmethod
    def fromImpl(cls, impl: Any=None) -> Union[AzurePostgreSqlServer]:
    """
    ...
    """
        ...
    def api(self) -> Union[AzurePostgreSqlServerApi]:
    """
    Return rest client to access this container
    """
        ...
    @classmethod
    def fromApiResponse(cls, apiResponse: AzurePostgreSqlServerResponseFields) -> Union[AzurePostgreSqlServer]:
    """
    Generate new instances from the response of get request.
    """
        ...
    def creationRequestBody(self) -> Union[AzurePostgreSqlServerCreateFields]:
    """
    Generate creation request body.
    """
        ...
    def updateRequestBody(self) -> Union[AzurePostgreSqlServerUpdateFields]:
    """
    Generate creation request body.
    """
        ...
