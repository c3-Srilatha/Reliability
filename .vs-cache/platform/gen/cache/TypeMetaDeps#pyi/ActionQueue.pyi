...
from c3.platform.ActionQueueEntry import ActionQueueEntry
...
# Python definitions for the C3 type ActionQueue


class ActionQueue(InvalidationQueue[ActionQueueEntry], CancelableInvalidationQueue, Value):
    """
    ...
    @remarks this represents a made instance of ActionQueue
    """
    def __init__(self) -> None: ...

    @classmethod
    def compute(cls, targetType: Type, entries: Array[ActionQueueEntry]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, spec: InvalidationQueue.FindSpec=None) -> Union[Array[ActionQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def findStream(cls, spec: InvalidationQueue.FindStreamSpec=None) -> Union[Stream[ActionQueueEntry]]:
    """
    ...
    @overload
    @classmethod
    def recoverFailed(cls, type: Type, action: str) -> None:
    """
    ...
    @overload
    @classmethod
    def setPriority(cls, type: Type, action: str, priority: int) -> int:
    """
    ...
    @overload
    @classmethod
    def clear(cls, type: Type, action: str) -> None:
    """
    ...
    @overload
    @classmethod
    def errors(cls, type: Type, action: str=None, limit: int='10') -> Union[Array[InvalidationQueueError]]:
    """
    ...
    """
        ...
    @classmethod
    def clearEntries(cls, entries: Array[ActionQueueEntry]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def submitAction(cls, typeRef: Type, action: str, context: ActionQueueContext=None, autoCommit: bool='true', nodePool: str='\'\'') -> str:
    """
    ...
    """
        ...
    @classmethod
    def entries(cls, type: Type, action: str=None, status: str=None, limit: int='10') -> Union[Array[ActionQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def pending(cls, type: Type, action: str=None, limit: int='10') -> Union[Array[ActionQueueEntry]]:
    """
    ...
    """
        ...
    @classmethod
    def computing(cls, type: Type, action: str=None, limit: int='10') -> Union[Array[ActionQueueEntry]]:
    """
