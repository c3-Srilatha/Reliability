...
# Python definitions for the C3 type InMemoryGraph

E = TypeVar('E')
V = TypeVar('V')

class InMemoryGraph(Generic[E, V], Graph[V, E]):
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[InMemoryGraph[V, E]]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[InMemoryGraph[V, E]]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[InMemoryGraph[V, E]]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[InMemoryGraph[V, E]]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> InMemoryGraph[V, E]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> InMemoryGraph[V, E]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> InMemoryGraph[V, E]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[InMemoryGraph[V, E]]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[InMemoryGraph[V, E]]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> InMemoryGraph[V, E]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> InMemoryGraph[V, E]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> InMemoryGraph[V, E]:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> InMemoryGraph[V, E]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> InMemoryGraph[V, E]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> InMemoryGraph[V, E]:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> InMemoryGraph[V, E]:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> InMemoryGraph[V, E]:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> InMemoryGraph[V, E]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> InMemoryGraph[V, E]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> InMemoryGraph[V, E]:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> InMemoryGraph[V, E]:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> InMemoryGraph[V, E]:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> InMemoryGraph[V, E]:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> InMemoryGraph[V, E]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> InMemoryGraph[V, E]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> InMemoryGraph[V, E]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> InMemoryGraph[V, E]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> InMemoryGraph[V, E]:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> InMemoryGraph[V, E]:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> InMemoryGraph[V, E]:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> InMemoryGraph[V, E]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> InMemoryGraph[V, E]:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> InMemoryGraph[V, E]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> InMemoryGraph[V, E]:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> InMemoryGraph[V, E]:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> InMemoryGraph[V, E]:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> InMemoryGraph[V, E]:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[InMemoryGraph[V, E]]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[InMemoryGraph[V, E]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[InMemoryGraph[V, E]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[InMemoryGraph[V, E]]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[InMemoryGraph[V, E]]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, InMemoryGraph[V, E]]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, InMemoryGraph[V, E]]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[InMemoryGraph[V, E]]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[InMemoryGraph[V, E]]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> InMemoryGraph[V, E]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> InMemoryGraph[V, E]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> InMemoryGraph[V, E]:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> InMemoryGraph[V, E]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> InMemoryGraph[V, E]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> InMemoryGraph[V, E]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> InMemoryGraph[V, E]:
    """
    ...
    """
        ...
    def afterMake(self) -> InMemoryGraph[V, E]:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> InMemoryGraph[V, E]:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[InMemoryGraph[V, E]]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> InMemoryGraph[V, E]:
    """
