...
# Python definitions for the C3 type TimeseriesValueMappingCache


class TimeseriesValueMappingCache(MetadataCacheOld[Pair[map[string, int], map[int, string]]], Value):
    """
    ...
    @classmethod
    def get(cls, key: str) -> Union[Pair[Map[str, int], Map[int, str]]]:
    """
    ...
    """
        ...
    @classmethod
    def require(cls, key: str) -> Pair[Map[str, int], Map[int, str]]:
    """
    ...
    """
        ...
    @classmethod
    def put(cls, key: str, value: Pair[Map[str, int], Map[int, str]]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[Pair[Map[str, int], Map[int, str]]]:
    """
    ...
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, Pair[Map[str, int], Map[int, str]]]]:
    """
    ...
    """
        ...
    @classmethod
    def release(cls, key: str, value: Pair[Map[str, int], Map[int, str]]) -> None:
    """
    ...
    """
        ...
    @classmethod
    def validate(cls, value: Pair[Map[str, int], Map[int, str]]) -> bool:
    """
