...
# Python definitions for the C3 type Exclude


class Exclude(Include, Value):
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[Exclude]:
    """
    ...
    """
        ...
    @classmethod
    def make(cls, s: str) -> Union[Exclude]:
    """
    ...
    """
        ...
    def get(self, field: str, failIfMissing: bool=None) -> Union[Exclude]:
    """
    ...
    """
        ...
    def with(self, other: Include) -> Exclude:
    """
    ...
    """
        ...
    @classmethod
    def parse(cls, typ: Type, include: str) -> Union[Exclude]:
    """
