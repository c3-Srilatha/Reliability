...
# Python definitions for the C3 type JavaNativeReader


class JavaNativeReader(CharStream, Value):
    """
    Native character stream based on a Java Reader.
    
    @remarks this represents a made instance of JavaNativeReader
    """
    
    onClose: Optional[Callable[[Union[JavaNativeReader]]]]=None
    """
    Callback lambda on close of this stream
    """

    reader: Optional[Any]=None
    def __init__(self, onClose: Optional[Callable[[Union[JavaNativeReader]]]]=None, reader: Optional[Any]=None) -> None: ...

    @classmethod
    def fromHttpRequest(cls, req: HttpRequest) -> JavaNativeReader:
    """
    ...
    """
        ...
    def mapToSame(self, mapper: Callable[[Union[int]], Union[int]]) -> JavaNativeReader:
    """
    ...
    """
        ...
    @overload
    def mapBlocksToSame(self, mapper: Callable[[str], Union[str]]) -> JavaNativeReader:
    """
    ...
    """
        ...
    @overload
    def mapBlocksToSame(self, blockSize: int, mapper: Callable[[str], Union[str]]) -> JavaNativeReader:
    """
    Return another stream on top of this one that allows modification of each block via a lambda and returns a new
    stream of those modified blocks. The current stream will be closed once the returned stream is consumed.
    ...
    """
        ...
    def concat(self, other: BlockStream[int, str]) -> JavaNativeReader:
    """
    ...
    """
        ...
    @classmethod
    def make(cls, reader: Any, onClose: Callable[[Union[JavaNativeReader]]]=None) -> JavaNativeReader:
        ...
