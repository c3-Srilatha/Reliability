...
# Python definitions for the C3 type Env.Proxy


class Proxy(Server):
    """
    Represents a proxy node for connection pooling of SQL dbs or external services.
    
    @remarks this represents a made instance of Env.Proxy
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[Env.Proxy]:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[Env.Proxy]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> Env.Proxy:
    """
    ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> Env.Proxy:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> Env.Proxy:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> Env.Proxy:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[Env.Proxy]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[Env.Proxy]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[Env.Proxy]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[Env.Proxy]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> Env.Proxy:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Env.Proxy:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Env.Proxy:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Env.Proxy]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Env.Proxy]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> Env.Proxy:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Env.Proxy:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Env.Proxy:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> Env.Proxy:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> Env.Proxy:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> Env.Proxy:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> Env.Proxy:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> Env.Proxy:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> Env.Proxy:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> Env.Proxy:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> Env.Proxy:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> Env.Proxy:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> Env.Proxy:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> Env.Proxy:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Env.Proxy:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> Env.Proxy:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> Env.Proxy:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> Env.Proxy:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> Env.Proxy:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> Env.Proxy:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> Env.Proxy:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> Env.Proxy:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> Env.Proxy:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> Env.Proxy:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> Env.Proxy:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> Env.Proxy:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Env.Proxy:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> Env.Proxy:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[Env.Proxy]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[Env.Proxy]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[Env.Proxy]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[Env.Proxy]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[Env.Proxy]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, Env.Proxy]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, Env.Proxy]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[Env.Proxy]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[Env.Proxy]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> Env.Proxy:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> Env.Proxy:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> Env.Proxy:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> Env.Proxy:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[Env.Proxy]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> Env.Proxy:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[Env.Proxy]:
    """
    ...
    """
        ...
    @classmethod
    def fromId(cls, id: Server.Id) -> Env.Proxy:
    """
