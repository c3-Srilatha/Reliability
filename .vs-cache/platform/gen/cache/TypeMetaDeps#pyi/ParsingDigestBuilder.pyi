...
# Python definitions for the C3 type ParsingDigestBuilder


class ParsingDigestBuilder(DigestBuilder[Digest[any, any, any]], Value):
    """
    ...
    @overload
    @classmethod
    def make(cls) -> ParsingDigestBuilder:
    """
    ...
    @overload
    @classmethod
    def make(cls, initial: Any) -> Union[DigestBuilder[Digest[Any, Any, Any]]]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> ParsingDigestBuilder:
    """
    ...
    """
        ...
    @overload
    def add(self, value: Any) -> DigestBuilder[Digest[Any, Any, Any]]:
    """
    Updates statistics based on a given value
    """
        ...
    @overload
    def add(self, str: str) -> DigestBuilder[Digest[Any, Any, Any]]:
    """
    Updates statistics based on a given string value
    """
        ...
    @overload
    def add(self, dt: datetime) -> DigestBuilder[Digest[Any, Any, Any]]:
    """
    Updates statistics based on a given datetime value
    """
        ...
    @overload
    def add(self, num: float) -> DigestBuilder[Digest[Any, Any, Any]]:
    """
    Updates statistics based on a given numeric value
    """
        ...
    @overload
    def add(self, bool: bool) -> DigestBuilder[Digest[Any, Any, Any]]:
    """
    Updates statistics based on a given boolean value
    """
        ...
    @overload
    def add(self, jsn: any) -> DigestBuilder[Digest[Any, Any, Any]]:
    """
    Updates statistics based on a given json value
    """
        ...
    @overload
    def add(self, obj: Obj) -> DigestBuilder[Digest[Any, Any, Any]]:
    """
    Updates statistics based on a given Obj value
    """
        ...
    @overload
    def add(self, obj: Collection[Any]) -> DigestBuilder[Digest[Any, Any, Any]]:
    """
    Updates statistics based on a given Collection value
    """
        ...
    def addAll(self, e: Collection[Any]) -> DigestBuilder[Digest[Any, Any, Any]]:
    """
    Update statistics based on all elements from a given collection
    """
        ...
    def addNull(self) -> DigestBuilder[Digest[Any, Any, Any]]:
    """
    Updates statistics based on a null value
    """
        ...
    def build(self) -> Digest[Any, Any, Any]:
    """
    Builds an AnyDigest
    @see AnyDigest
    """
    ...
    """
        ...
    def buildMajority(self, hasIngestedReal: bool=None) -> Digest[Any, Any, Any]:
    """
    ...
    """
        ...
    def field(self, name: str) -> DigestBuilder[Digest[Any, Any, Any]]:
    """
    @return digest builder for a given field
    """
        ...
    def withSpec(self, spec: DigestSpec) -> ParsingDigestBuilder:
    """
