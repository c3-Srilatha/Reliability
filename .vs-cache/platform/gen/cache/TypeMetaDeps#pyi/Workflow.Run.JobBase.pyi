...
# Python definitions for the C3 type Workflow.Run.JobBase


class JobBase(Workflow.Run.Vertex):
    """
    Base type for a workflow vertex run for a Workflow.MapReduce or Workflow.Batch vertex.
    
    @remarks this represents a made instance of Workflow.Run.JobBase
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[Workflow.Run.JobBase]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[Workflow.Run.JobBase]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[Workflow.Run.JobBase]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[Workflow.Run.JobBase]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> Workflow.Run.JobBase:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Workflow.Run.JobBase:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Workflow.Run.JobBase:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Workflow.Run.JobBase]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Workflow.Run.JobBase]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> Workflow.Run.JobBase:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Workflow.Run.JobBase:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Workflow.Run.JobBase:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> Workflow.Run.JobBase:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> Workflow.Run.JobBase:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> Workflow.Run.JobBase:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> Workflow.Run.JobBase:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> Workflow.Run.JobBase:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> Workflow.Run.JobBase:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> Workflow.Run.JobBase:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> Workflow.Run.JobBase:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> Workflow.Run.JobBase:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> Workflow.Run.JobBase:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> Workflow.Run.JobBase:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Workflow.Run.JobBase:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> Workflow.Run.JobBase:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> Workflow.Run.JobBase:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> Workflow.Run.JobBase:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> Workflow.Run.JobBase:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> Workflow.Run.JobBase:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> Workflow.Run.JobBase:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> Workflow.Run.JobBase:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> Workflow.Run.JobBase:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> Workflow.Run.JobBase:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> Workflow.Run.JobBase:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> Workflow.Run.JobBase:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Workflow.Run.JobBase:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> Workflow.Run.JobBase:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[Workflow.Run.JobBase]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[Workflow.Run.JobBase]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[Workflow.Run.JobBase]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[Workflow.Run.JobBase]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[Workflow.Run.JobBase]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, Workflow.Run.JobBase]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, Workflow.Run.JobBase]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[Workflow.Run.JobBase]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[Workflow.Run.JobBase]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> Workflow.Run.JobBase:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> Workflow.Run.JobBase:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> Workflow.Run.JobBase:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> Workflow.Run.JobBase:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> Workflow.Run.JobBase:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> Workflow.Run.JobBase:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[Workflow.Run.JobBase]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> Workflow.Run.JobBase:
    """
    ...
    """
        ...
    def afterMake(self) -> Workflow.Run.JobBase:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> Workflow.Run.JobBase:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[Workflow.Run.JobBase]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> Workflow.Run.JobBase:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[Workflow.Run.JobBase]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[Workflow.Run.JobBase]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[Workflow.Run.JobBase]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[Workflow.Run.JobBase]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[Workflow.Run.JobBase]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[Workflow.Run.JobBase]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> Workflow.Run.JobBase:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[Workflow.Run.JobBase]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> Workflow.Run.JobBase:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[Workflow.Run.JobBase]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[Workflow.Run.JobBase]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[Workflow.Run.JobBase], spec: UpsertSpec=None) -> Union[ObjList[Workflow.Run.JobBase]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[Workflow.Run.JobBase], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[Workflow.Run.JobBase]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: Workflow.Run.JobBase=None, spec: UpsertSpec=None) -> Union[Workflow.Run.JobBase]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: Workflow.Run.JobBase=None, spec: UpsertSpec=None) -> Union[Workflow.Run.JobBase]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[Workflow.Run.JobBase]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[Workflow.Run.JobBase]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[Workflow.Run.JobBase]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[Workflow.Run.JobBase], srcObjs: Array[Workflow.Run.JobBase]=None, spec: UpsertSpec=None) -> Union[ObjList[Workflow.Run.JobBase]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[Workflow.Run.JobBase]]], spec: UpsertSpec=None) -> Union[ObjList[Workflow.Run.JobBase]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[Workflow.Run.JobBase], srcObjs: Array[Workflow.Run.JobBase]=None, spec: UpsertSpec=None) -> Union[ObjList[Workflow.Run.JobBase]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[Workflow.Run.JobBase]]], spec: UpsertSpec=None) -> Union[ObjList[Workflow.Run.JobBase]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[Workflow.Run.JobBase], spec: TouchSpec=None) -> Union[ObjList[Workflow.Run.JobBase]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[Workflow.Run.JobBase], spec: MergeSpec=None) -> Union[ObjList[Workflow.Run.JobBase]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[Workflow.Run.JobBase], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[Workflow.Run.JobBase]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[Workflow.Run.JobBase]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[Workflow.Run.JobBase]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: Workflow.Run.JobBase, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: Workflow.Run.JobBase, mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[Workflow.Run.JobBase], spec: UpsertSpec=None) -> Union[ObjList[Workflow.Run.JobBase]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[Workflow.Run.JobBase], spec: UpsertSpec=None) -> Union[ObjList[Workflow.Run.JobBase]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[Workflow.Run.JobBase]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[Workflow.Run.JobBase]) -> ObjList[Workflow.Run.JobBase]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[Workflow.Run.JobBase]) -> ObjList[Workflow.Run.JobBase]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[Workflow.Run.JobBase]) -> ObjList[Workflow.Run.JobBase]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[Workflow.Run.JobBase]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[Workflow.Run.JobBase]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[Workflow.Run.JobBase]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[Workflow.Run.JobBase]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[Workflow.Run.JobBase]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[Workflow.Run.JobBase]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[Workflow.Run.JobBase]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[Workflow.Run.JobBase]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: Workflow.Run.JobBase=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[Workflow.Run.JobBase], callback: Callable[[Union[Workflow.Run.JobBase]], Union[Workflow.Run.JobBase]]=None) -> ObjList[Workflow.Run.JobBase]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[Workflow.Run.JobBase], callback: Callable[[Union[Workflow.Run.JobBase]], Union[Workflow.Run.JobBase]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    def getSpecificRun(self, failIfNotExists: bool=None) -> Union[Workflow.Run.JobBase]:
    """
    ...
    """
        ...
    @classmethod
    def createRun(cls, vertex: Workflow.Vertex, workflowRun: Workflow.Run) -> Workflow.Run.JobBase:
    """
    ...
    """
        ...
    def start(self) -> Workflow.Run.JobBase:
    """
    ...
    """
        ...
    def doStart(self) -> Workflow.Run.JobBase:
    """
    Override to perform vertex specific start logic (if any).
    """
        ...
    def jobRun(self) -> Union[JobRun[BatchJobStatusBase]]:
    """
    @return the job run of the correct type from the type that extends this type.
    """
        ...
    def job(self, failIfMissing: bool=None) -> Union[JobBase[JobRun, BatchJobStatusBase, Any]]:
    """
    @return the job of the correct type from the type that extends this type.
    """
        ...
    
    class Callback(JobBase.Callback):
        """
        This callback will invalidate {@link #parentWorkflowRun} in the {@link WorkflowQueue} when invoked.
        
        @remarks this represents a made instance of Workflow.Run.JobBase.Callback
        """
        
        parentWorkflowRun: Optional[Workflow.Run]
        """
        {@link Workflow.Run} to invalidate upon execution of callback.
        """
        def __init__(self, parentWorkflowRun: Optional[Workflow.Run]=None) -> None: ...
        ...
        """
            ...
        @classmethod
        def fromJson(cls, json: any) -> Union[Workflow.Run.JobBase.Callback]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromJsonString(cls, json: str) -> Union[Workflow.Run.JobBase.Callback]:
        """
        Load the JSON-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def fromXmlString(cls, xml: str) -> Union[Workflow.Run.JobBase.Callback]:
        """
        Load the XML-based representation and reconstruct the corresponding object.
        ...
        """
            ...
        @classmethod
        def deserialize(cls, contentStr: str, contentType: str) -> Union[Workflow.Run.JobBase.Callback]:
        """
        Load from contentType representation and reconstruct the corresponding object.
        ...
        """
            ...
        def replaceType(self, old: Type, new: Type) -> Workflow.Run.JobBase.Callback:
        """
        Returns new instance with all references to old type, including result of #type, replaced with new type. If new
        type does not contain fields from old or field value types are not convertable then drops the field.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Workflow.Run.JobBase.Callback:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> Workflow.Run.JobBase.Callback:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Workflow.Run.JobBase.Callback]:
        """
        Result of this function call is a copy of current instance with all non empty fields replaced based on results of
        the asynchronous `mapper` invocation.
        ...
        """
            ...
        @overload
        def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[Workflow.Run.JobBase.Callback]:
        """
        Result of this function call is a copy of current instance with all fields replaced based on results of the
        asynchronous `mapper` invocation.
        ...
        """
            ...
        def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> Workflow.Run.JobBase.Callback:
        """
        Result of this function call is a copy of current instance with specified field value replaced based on result of
        the `mapper` invocation.
        @param field
        ...
        """
            ...
        @overload
        def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Workflow.Run.JobBase.Callback:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> Workflow.Run.JobBase.Callback:
        """
        Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
        lambda application.
        ...
        """
            ...
        @overload
        def validateObj(self) -> Workflow.Run.JobBase.Callback:
        """
        Populates all missing default values and throws error if any constraint is violated.
        """
            ...
        ...
        """
            ...
        @overload
        def withField(self, field: str, value: Any, doNotConvert: bool=None) -> Workflow.Run.JobBase.Callback:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        @overload
        def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> Workflow.Run.JobBase.Callback:
        """
        Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
        defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> Workflow.Run.JobBase.Callback:
        """
        Builds a new Obj instance by adding the provided fields in it. The name must correspond to an existing fields
        defined on this type or its mixins. The values must be of the correct type if doNotConvert flag is true.
        ...
        """
            ...
        def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> Workflow.Run.JobBase.Callback:
        """
        Builds a new Obj with the value at the specified path field. If the field is null, the field #isFieldSet to null.
        If you would like to #unsetField, you should call #withoutFieldAtPath instead.
        ...
        """
            ...
        def withoutFieldAtPath(self, path: str) -> Workflow.Run.JobBase.Callback:
        """
        Builds a new Obj without the specified path field.
        ...
        """
            ...
        @overload
        def withoutField(self, field: str) -> Workflow.Run.JobBase.Callback:
        """
        Builds a new Obj, removing the field with the provided name.
        ...
        """
            ...
        @overload
        def withoutField(self, field: FieldType) -> Workflow.Run.JobBase.Callback:
        """
        Builds a new Obj, removing the field with the provided field type.
        ...
        """
            ...
        def withoutFields(self, fields: Array[str]) -> Workflow.Run.JobBase.Callback:
        """
        Builds a new Obj, removing the fields with the provided names.
        ...
        """
            ...
        def withoutFieldsByType(self, fields: Array[FieldType]) -> Workflow.Run.JobBase.Callback:
        """
        Builds a new Obj, removing the fields with the provided field types. Be sure to use the FieldType instance for the
        exact same type as the type of the obj to respect the "ordinal" of the field type
        ...
        """
            ...
        def withoutSecretFields(self) -> Workflow.Run.JobBase.Callback:
        """
        @return a new Obj, removing the field types marked with annotation @config(secret=true) recursively
        """
            ...
        ...
        """
            ...
        def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> Workflow.Run.JobBase.Callback:
        """
        Builds a new Obj instance by adding the default values (if defined) for all unset fields. This is implemented by
        calling {@link FieldType#defaultValue defaultValue} for a field if it is not already set and
        {@link FieldType#hasDefault has a default}. It will also set {@see ValueType#initialValue initial values} for
        ...
        """
            ...
        @overload
        def defaultField(self, field: str) -> Workflow.Run.JobBase.Callback:
        """
        Builds a new Obj, by setting a field on this `Obj` to the field's default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def defaultField(self, field: FieldType) -> Workflow.Run.JobBase.Callback:
        """
        Builds a new Obj, by setting a field on this `Obj` to the fields default value. If the field has no default, this
        method will behave the same as {@link #unsetField}.
        ...
        """
            ...
        @overload
        def unsetField(self, field: str) -> Workflow.Run.JobBase.Callback:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def unsetField(self, field: FieldType) -> Workflow.Run.JobBase.Callback:
        """
        Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
        is different from {@link removeField}
        ...
        """
            ...
        @overload
        def removeField(self, field: str) -> Workflow.Run.JobBase.Callback:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def removeField(self, field: FieldType) -> Workflow.Run.JobBase.Callback:
        """
        Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
        is different from {@link #unsetField}
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> Workflow.Run.JobBase.Callback:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence unless otherwise specified by the fieldPathMergeSpec
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> Workflow.Run.JobBase.Callback:
        """
        Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
        In case of conflicts, fields of other instance take precedence.
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> Workflow.Run.JobBase.Callback:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist on other Obj and do not exist on this Obj will not be added to final Obj.
        @param deep
        ...
        """
            ...
        @overload
        def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> Workflow.Run.JobBase.Callback:
        """
        Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
        fields that exist other Obj and do not exist on this Obj will not be added to final Obj or evaluated. Does not
        traverse child reference and collection fields.
        ...
        """
            ...
        def mergeJson(self, json: any) -> Workflow.Run.JobBase.Callback:
            ...
        def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> Workflow.Run.JobBase.Callback:
        """
        Merge the obj references within the current obj
        @param deep
               If set, traverses the reference fields within the obj as well for a deep merge
        ...
        """
            ...
        def sumObj(self, other: Obj, deep: bool=None) -> Workflow.Run.JobBase.Callback:
        """
        Adds the numeric Obj fields with the other Objs respective fields.
        If deep is set it will traverse reference and collection fields and sum corresponding numeric fields in
        references with same name and collection elements at same index or key.
        """
            ...
        def singletonArray(self) -> Array[Workflow.Run.JobBase.Callback]:
        """
        Build an array of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def array(cls, *elements: Array[Any]) -> Union[Array[Workflow.Run.JobBase.Callback]]:
        """
        Creates an array of instances of this type.
        """
            ...
        @classmethod
        def arrayBuilder(cls) -> Union[ArrayBuilder[Workflow.Run.JobBase.Callback]]:
        """
        Creates an array of instances of this type.
        """
            ...
        def singletonSet(self) -> Set[Workflow.Run.JobBase.Callback]:
        """
        Build an set of the correct type with a single element which is this instance.
        ...
        """
            ...
        @classmethod
        def setBuilder(cls) -> Union[SetBuilder[Workflow.Run.JobBase.Callback]]:
        """
        Creates a set of instances of this type.
        """
            ...
        @classmethod
        def mapBuilder(cls) -> Union[MapBuilder[str, Workflow.Run.JobBase.Callback]]:
        """
        Create a map of string to elements of this type.
        """
            ...
        @classmethod
        def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, Workflow.Run.JobBase.Callback]]:
        """
        Create a map with the given key type and elements of this type.
        """
            ...
        ...
        def myStreamType(cls) -> StreamType:
            ...
        def toBuilder(self) -> ObjBuilder[Workflow.Run.JobBase.Callback]:
        """
        @return new ObjBuilder with initial state set to fields of this instance.
        """
            ...
        @classmethod
        def builder(cls) -> ObjBuilder[Workflow.Run.JobBase.Callback]:
        """
        @return new ObjBuilder of this instance.
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> Workflow.Run.JobBase.Callback:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> Workflow.Run.JobBase.Callback:
        """
        Construct an instance of this type from provided fields
        @param fields
                   Fields to construct the instance of the obj with
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> Workflow.Run.JobBase.Callback:
        """
        Construct instance of this type from provided field values and options
        """
            ...
        @overload
        @classmethod
        def make(cls, withDefaults: bool=None) -> Workflow.Run.JobBase.Callback:
        """
        Construct an instance of this type with no non-default field values unless explicitly specified by passing param true
        @param withDefaults
                   If set, then the Obj is made with default & initial values (required primitive fields e.g. !int32 -> 0)
        ...
        @overload
        @classmethod
        def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> Workflow.Run.JobBase.Callback:
        """
        Construct an instance from provided fields
        @param fields
                   Fields (in the format <field_name, value>) to construct an instance of the obj. Note that "type" as a
        ...
        @overload
        @classmethod
        def make(cls, fields: Any, withDefaults: bool=None) -> Workflow.Run.JobBase.Callback:
        """
        Construct an instance of this type from provided fields. Note it is more efficient to use #fromFields and other overloads
        ...
        """
            ...
        @classmethod
        def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> Workflow.Run.JobBase.Callback:
        """
        Construct an instance of this type from provided instance of a subtype or a "duck type".
        """
            ...
        ...
        """
            ...
        def afterMake(self) -> Workflow.Run.JobBase.Callback:
        """
        Optional override that will be called after every instance creation.
        ...
        """
            ...
        @classmethod
        def cachedEmptyInst(cls) -> Workflow.Run.JobBase.Callback:
        """
        Creates an empty inst using `MyType.make()` and caches it. Avoid recreating multiple copies of the spec for
        every action dispatch. The cached inst can also be used for comparing whether the object is an empty or not
        Will only create empty instance for immutable Obj e.g. if an Obj is Mutable, this method will throw an error
        ...
        """
            ...
        @classmethod
        def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[Workflow.Run.JobBase.Callback]]:
        """
        Generate a stream of instances of this type. The stream is endless and will call #generateObj each time a new
        value is read.
        """
            ...
        @classmethod
        def generateObj(cls, spec: Obj.GenerateSpec=None) -> Workflow.Run.JobBase.Callback:
        """
        Generate a single instance of this type. The base implementation uses {@link DataGenObj} to generate uniform
        random (gibberish) values for all fields, but it may be overridden by specific types with custom logic that
        populates fields in a more realistic way.
        """
            ...
        def callback(self, job: JobBase[JobRun, BatchJobStatusBase, Any]=None) -> None:
        """
        Callback to call.
        """
            ...
