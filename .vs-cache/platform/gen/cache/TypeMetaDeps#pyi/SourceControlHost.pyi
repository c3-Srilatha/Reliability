...
# Python definitions for the C3 type SourceControlHost


class SourceControlHost():
    """
    ...
    AZURE_DEVOPS: Optional[str]=None
    """
    ...
    the application development cycle like build pipelines, project management, etc.
    """
    def __init__(self, GITHUB: Optional[str]=None, BITBUCKET: Optional[str]=None, AZURE_DEVOPS: Optional[str]=None, GITLAB: Optional[str]=None) -> None: ...
