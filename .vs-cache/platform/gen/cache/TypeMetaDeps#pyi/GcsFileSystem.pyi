...
from c3.platform.GcsFile import GcsFile
from c3.platform.SetBuilder import SetBuilder
...
# Python definitions for the C3 type GcsFileSystem


class GcsFileSystem(BlobFileSystem[GcsFile], FileSystemConfigurable[GcsFsConfig]):
    """
    Google Cloud Storage based FileSystem implementation. Avoid using it directly - use {@link FileSystem.gcs} instead.
    
    @remarks this represents a made instance of GcsFileSystem
    """
    def __init__(self) -> None: ...

    @classmethod
    def inst(cls) -> GcsFileSystem:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[GcsFileSystem]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[GcsFileSystem]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[GcsFileSystem]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[GcsFileSystem]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> GcsFileSystem:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> GcsFileSystem:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> GcsFileSystem:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[GcsFileSystem]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[GcsFileSystem]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> GcsFileSystem:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> GcsFileSystem:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> GcsFileSystem:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> GcsFileSystem:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> GcsFileSystem:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> GcsFileSystem:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> GcsFileSystem:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> GcsFileSystem:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> GcsFileSystem:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> GcsFileSystem:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> GcsFileSystem:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> GcsFileSystem:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> GcsFileSystem:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> GcsFileSystem:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> GcsFileSystem:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> GcsFileSystem:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> GcsFileSystem:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> GcsFileSystem:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> GcsFileSystem:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> GcsFileSystem:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> GcsFileSystem:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> GcsFileSystem:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> GcsFileSystem:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> GcsFileSystem:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> GcsFileSystem:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> GcsFileSystem:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> GcsFileSystem:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> GcsFileSystem:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[GcsFileSystem]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[GcsFileSystem]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[GcsFileSystem]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[GcsFileSystem]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[GcsFileSystem]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, GcsFileSystem]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, GcsFileSystem]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[GcsFileSystem]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[GcsFileSystem]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> GcsFileSystem:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> GcsFileSystem:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> GcsFileSystem:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> GcsFileSystem:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> GcsFileSystem:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> GcsFileSystem:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> GcsFileSystem:
    """
    ...
    """
        ...
    def afterMake(self) -> GcsFileSystem:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> GcsFileSystem:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[GcsFileSystem]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> GcsFileSystem:
    """
    ...
    def doTruncateContainer(self, containerName: str, spec: FileOperationSpec=None) -> int:
        ...
    def doReadBlobMeta(self, containerName: str, blobKey: str, spec: FileOperationSpec=None) -> Union[GcsFile]:
        ...
    def doBlobEncodedStream(self, containerName: str, blobKey: str, spec: FileOperationSpec=None) -> Union[Pair[GcsFile, ByteStream]]:
        ...
    ...
    def doDeleteBlobs(self, containerName: str, blobKeys: Array[str], spec: FileOperationSpec=None) -> None:
        ...
    def doCopyBlob(self, srcContainerName: str, srcBlobKey: str, destContainerName: str, destBlobKey: str, spec: FileOperationSpec=None) -> Union[GcsFile]:
        ...
    def doCopyBlobs(self, srcContainerNames: Array[str], srcBlobKeys: Array[str], destContainerNames: Array[str], destBlobKeys: Array[str], spec: FileOperationSpec=None) -> Union[Array[GcsFile]]:
    """
    ...
    """
        ...
    def doReplaceBlobContentTypeAndEncoding(self, containerName: str, srcBlobKey: str, contentEncoding: str, contentType: str=None, spec: FileOperationSpec=None) -> Union[GcsFile]:
        ...
    def cloudClient(self, containerName: str) -> Any:
        ...
    def fileType(self) -> Type:
        ...
    def config(self, secrets: bool=None) -> GcsFsConfig:
    """
