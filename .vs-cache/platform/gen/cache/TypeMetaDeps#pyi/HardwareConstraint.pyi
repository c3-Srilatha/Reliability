...
from c3.platform.HardwareSpec import HardwareSpec
...
from c3.platform.CloudCluster.NodePool.Config import CloudCluster.NodePool.Config
from c3.platform.Pair import Pair
from c3.platform.Exclude import Exclude
from c3.platform.File import File

# Python definitions for the C3 type HardwareConstraint


class HardwareConstraint(BaseHardwareResourceRequirements):
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[HardwareConstraint]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[HardwareConstraint]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[HardwareConstraint]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[HardwareConstraint]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> HardwareConstraint:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> HardwareConstraint:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> HardwareConstraint:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[HardwareConstraint]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[HardwareConstraint]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> HardwareConstraint:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> HardwareConstraint:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> HardwareConstraint:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> HardwareConstraint:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> HardwareConstraint:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> HardwareConstraint:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> HardwareConstraint:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> HardwareConstraint:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> HardwareConstraint:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> HardwareConstraint:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> HardwareConstraint:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> HardwareConstraint:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> HardwareConstraint:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> HardwareConstraint:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> HardwareConstraint:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> HardwareConstraint:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> HardwareConstraint:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> HardwareConstraint:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> HardwareConstraint:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> HardwareConstraint:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> HardwareConstraint:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> HardwareConstraint:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> HardwareConstraint:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> HardwareConstraint:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> HardwareConstraint:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> HardwareConstraint:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> HardwareConstraint:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> HardwareConstraint:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[HardwareConstraint]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[HardwareConstraint]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[HardwareConstraint]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[HardwareConstraint]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[HardwareConstraint]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, HardwareConstraint]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, HardwareConstraint]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[HardwareConstraint]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[HardwareConstraint]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> HardwareConstraint:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> HardwareConstraint:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> HardwareConstraint:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> HardwareConstraint:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> HardwareConstraint:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> HardwareConstraint:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> HardwareConstraint:
    """
    ...
    """
        ...
    def afterMake(self) -> HardwareConstraint:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> HardwareConstraint:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[HardwareConstraint]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> HardwareConstraint:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[HardwareConstraint]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[HardwareConstraint]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[HardwareConstraint]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[HardwareConstraint]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[HardwareConstraint]:
    """
    Returns cached instance by key, with secrets removed.
    """
        ...
    def getCached(self) -> Union[HardwareConstraint]:
    """
    ...
    """
        ...
    def refreshCache(self) -> Union[HardwareConstraint]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[HardwareConstraint]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, HardwareConstraint]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, HardwareConstraint]]:
    """
    ...
    """
        ...
    def getConfig(self) -> HardwareConstraint:
    """
    ...
    """
        ...
    def getSecret(self) -> HardwareConstraint:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[HardwareConstraint]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[HardwareConstraint]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: HardwareConstraint, override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: HardwareConstraint, override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[HardwareConstraint]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[HardwareConstraint]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[HardwareConstraint]:
    """
    @return this config with only secret values.
    """
        ...
    @overload
    def validate(self) -> HardwareConstraint:
    """
    Validates that all required fields are set properly.
    """
        ...
    @overload
    def validate(self, validatePartial: bool) -> HardwareConstraint:
        ...
    @classmethod
    ...
    """
        ...
    @classmethod
    def max(cls, list: Array[HardwareConstraint]=None) -> Union[HardwareConstraint]:
    """
