...
from c3.platform.RandomTimeseriesDataSpec import RandomTimeseriesDataSpec
...
from c3.platform.RandomDataSpec import RandomDataSpec
...
# Python definitions for the C3 type GenerateDataSpec


class GenerateDataSpec(UpsertSpec):
    """
    Specification of the options/parameters for the {@link Persistable#generateData} function.
    
    @remarks this represents a made instance of GenerateDataSpec
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[GenerateDataSpec]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[GenerateDataSpec]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[GenerateDataSpec]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[GenerateDataSpec]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> GenerateDataSpec:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> GenerateDataSpec:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> GenerateDataSpec:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[GenerateDataSpec]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[GenerateDataSpec]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> GenerateDataSpec:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> GenerateDataSpec:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> GenerateDataSpec:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> GenerateDataSpec:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> GenerateDataSpec:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> GenerateDataSpec:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> GenerateDataSpec:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> GenerateDataSpec:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> GenerateDataSpec:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> GenerateDataSpec:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> GenerateDataSpec:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> GenerateDataSpec:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> GenerateDataSpec:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> GenerateDataSpec:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> GenerateDataSpec:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> GenerateDataSpec:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> GenerateDataSpec:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> GenerateDataSpec:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> GenerateDataSpec:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> GenerateDataSpec:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> GenerateDataSpec:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> GenerateDataSpec:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> GenerateDataSpec:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> GenerateDataSpec:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> GenerateDataSpec:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> GenerateDataSpec:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> GenerateDataSpec:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> GenerateDataSpec:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[GenerateDataSpec]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[GenerateDataSpec]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[GenerateDataSpec]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[GenerateDataSpec]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[GenerateDataSpec]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, GenerateDataSpec]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, GenerateDataSpec]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[GenerateDataSpec]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[GenerateDataSpec]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> GenerateDataSpec:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> GenerateDataSpec:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> GenerateDataSpec:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> GenerateDataSpec:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> GenerateDataSpec:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> GenerateDataSpec:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> GenerateDataSpec:
    """
    ...
    """
        ...
    def afterMake(self) -> GenerateDataSpec:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> GenerateDataSpec:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[GenerateDataSpec]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> GenerateDataSpec:
    """
    ...
    """
        ...
    def withRetry(self, maxRetries: int=None, initialSleepMillis: int=None, exponent: float=None) -> Union[GenerateDataSpec]:
    """
    @return new instance of this spec with `retrySpec` set
    """
        ...
    @classmethod
    def timeoutSeconds(cls, secs: float) -> GenerateDataSpec:
    """
