...
# Python definitions for the C3 type MapReduce

TargetType = TypeVar('TargetType')
OutKeyType = TypeVar('OutKeyType')
OutValType = TypeVar('OutValType')
InterValType = TypeVar('InterValType')

class MapReduce(Generic[TargetType, OutKeyType, OutValType, InterValType], JobBase[MapReduceRun, MapReduceStatus, MapReduceOptions], MapReduceOptions):
    """
    See {@link invalidation-queues.c3doc Invalidation Queues} for detailed documentation.
    
    @remarks this represents a made instance of MapReduce
    """
    ...
    targetFilter: Optional[TargetType]=None
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, MapReduce[TargetType, OutKeyType, InterValType, OutValType]]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, MapReduce[TargetType, OutKeyType, InterValType, OutValType]]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    """
        ...
    def afterMake(self) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, spec: FetchSpec=None) -> FetchResult[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]:
    """
    ...
    @overload
    @classmethod
    def fetch(cls, filter: Filter) -> FetchResult[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]:
    """
    ...
    """
        ...
    @classmethod
    def fetchObjStream(cls, spec: FetchStreamSpec=None) -> Union[Stream[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]]:
    """
    Fetches multiple obj instances based on a specification.  Only objs that the caller is authorized to fetch will be
    returned.
    ...
    """
        ...
    @classmethod
    def fetchMultiLocale(cls, spec: MultiLocaleFetchSpec=None) -> Union[Map[str, FetchResult[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]]]:
    """
    ...
    """
        ...
    def get(self, include: str=None) -> Union[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]:
    """
    ...
    """
        ...
    def getSpecific(self, include: str=None) -> Union[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]:
    """
    ...
    """
        ...
    def getMissing(self, spec: GetMissingSpec) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    """
        ...
    def getDirect(self, include: str=None) -> Union[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]:
    """
    ...
    """
        ...
    def applyReverseEdit(self, versionEdit: VersionEdit) -> MapReduce[TargetType, OutKeyType, InterValType, OutValType]:
    """
    ...
    """
        ...
    @classmethod
    def fromString(cls, s: str) -> Union[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]:
    """
    ...
    """
        ...
    def create(self, spec: UpsertSpec=None) -> Union[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatch(cls, objs: Array[MapReduce[TargetType, OutKeyType, InterValType, OutValType]], spec: UpsertSpec=None) -> Union[ObjList[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]]:
    """
    ...
    """
        ...
    @classmethod
    def createBatchObjStream(cls, objs: Stream[MapReduce[TargetType, OutKeyType, InterValType, OutValType]], spec: CreateBatchObjStreamSpec=None) -> Union[ObjList[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]]:
    """
    Creates multiple instances of a C3 type. If the operation fails and {@link UpsertSpec#dontThrowOnBatchError} is not
    specified (the default), then a C3BatchException will be thrown.  Otherwise {@link errors will be reported in the
    returned {@link ObjList}.  This will fail if any of the instances already exist.
    ...
    """
        ...
    def update(self, srcObj: MapReduce[TargetType, OutKeyType, InterValType, OutValType]=None, spec: UpsertSpec=None) -> Union[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]:
    """
    ...
    """
        ...
    def upsert(self, srcObj: MapReduce[TargetType, OutKeyType, InterValType, OutValType]=None, spec: UpsertSpec=None) -> Union[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]:
    """
    ...
    """
        ...
    @overload
    def merge(self, spec: MergeSpec=None) -> Union[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]:
    """
    ...
    """
        ...
    @overload
    def merge(self, mergeInclude: str, spec: MergeSpec=None) -> Union[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]:
    """
    ...
    """
        ...
    def touch(self, spec: TouchSpec=None) -> Union[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]:
    """
    ...
    """
        ...
    @classmethod
    def updateBatch(cls, objs: Array[MapReduce[TargetType, OutKeyType, InterValType, OutValType]], srcObjs: Array[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]=None, spec: UpsertSpec=None) -> Union[ObjList[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]]:
    """
    ...
    """
        ...
    @classmethod
    def updateObjs(cls, objs: Callable[[], Union[Array[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]]], spec: UpsertSpec=None) -> Union[ObjList[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertBatch(cls, objs: Array[MapReduce[TargetType, OutKeyType, InterValType, OutValType]], srcObjs: Array[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]=None, spec: UpsertSpec=None) -> Union[ObjList[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]]:
    """
    ...
    """
        ...
    @classmethod
    def upsertObjs(cls, objs: Callable[[], Union[Array[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]]], spec: UpsertSpec=None) -> Union[ObjList[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]]:
    """
    Creates instances of a C3 type if they don't already exist and updates them if they do exist. If the operation
    ...
    """
        ...
    @classmethod
    def touchBatch(cls, objs: Array[MapReduce[TargetType, OutKeyType, InterValType, OutValType]], spec: TouchSpec=None) -> Union[ObjList[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[MapReduce[TargetType, OutKeyType, InterValType, OutValType]], spec: MergeSpec=None) -> Union[ObjList[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]]:
    """
    ...
    @overload
    @classmethod
    def mergeBatch(cls, objs: Array[MapReduce[TargetType, OutKeyType, InterValType, OutValType]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]]:
    """
    Merges multiple instances of a C3 type or creates them if they don't exist. If the operation fails and {@link
    UpsertSpec#dontThrowOnBatchError} is not specified (the default), then a C3BatchException will be thrown.
    Otherwise errors will be reported in the returned {@link ObjList}.  The merge operation is described in the {@link
    ...
    """
        ...
    @classmethod
    def mergeObjs(cls, objs: Callable[[], Union[Array[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]]], mergeInclude: str, spec: MergeSpec=None) -> Union[ObjList[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: MapReduce[TargetType, OutKeyType, InterValType, OutValType], spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    @overload
    @classmethod
    def mergeAll(cls, mergeObj: MapReduce[TargetType, OutKeyType, InterValType, OutValType], mergeInclude: str, spec: MergeAllSpec=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def removeBatch(cls, objs: Array[MapReduce[TargetType, OutKeyType, InterValType, OutValType]], spec: UpsertSpec=None) -> Union[ObjList[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]]:
    """
    ...
    """
        ...
    @classmethod
    def replace(cls, objs: Array[MapReduce[TargetType, OutKeyType, InterValType, OutValType]], spec: UpsertSpec=None) -> Union[ObjList[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]]:
    """
    ...
    """
        ...
    def unremove(self) -> Union[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]:
    """
    ...
    """
        ...
    @classmethod
    def beforeCreate(cls, objs: Array[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]) -> ObjList[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]:
    """
    ...
    """
        ...
    @classmethod
    def beforeUpdate(cls, objs: Array[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]) -> ObjList[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]:
    """
    ...
    """
        ...
    @classmethod
    def beforeRemove(cls, objs: Array[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]) -> ObjList[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]:
    """
    ...
    """
        ...
    @classmethod
    def afterCreate(cls, objs: Array[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterUpdate(cls, objs: Array[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def afterRemove(cls, objs: Array[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def startImportData(cls, spec: StartImportDataSpec=None) -> PushStream[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    @classmethod
    def startImportDataWithStats(cls, spec: StartImportDataSpec=None) -> PushStreamWithStats[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]:
    """
    @return a push stream to import instances of this type.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]:
    """
    ...
    """
        ...
    def withoutIdentity(self) -> Union[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]:
    """
    ...
    """
        ...
    @classmethod
    def typeOfBatch(cls, objs: Array[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]) -> Union[Array[EntityType]]:
    """
    ...
    """
        ...
    @classmethod
    def dbEcho(cls, template: MapReduce[TargetType, OutKeyType, InterValType, OutValType]=None, count: int=None, sendBack: bool=None) -> Union[int]:
    """
    ...
    """
        ...
    @classmethod
    def callbackLogic(cls, objs: Array[MapReduce[TargetType, OutKeyType, InterValType, OutValType]], callback: Callable[[Union[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]], Union[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]]=None) -> ObjList[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]:
    """
    ...
    """
        ...
    @classmethod
    def afterCallbackLogic(cls, objs: Array[MapReduce[TargetType, OutKeyType, InterValType, OutValType]], callback: Callable[[Union[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]], Union[MapReduce[TargetType, OutKeyType, InterValType, OutValType]]]=None) -> Union[Array[ObjError]]:
    """
    ...
    """
        ...
    @classmethod
    def map(cls, batch: int=None, objs: Array[TargetType]=None, job: MapReduce[TargetType, OutKeyType, InterValType, OutValType]=None, subBatch: int=None) -> Union[Map[OutKeyType, InterValType]]:
    """
    ...
    """
        ...
    @classmethod
    def reduce(cls, outKey: OutKeyType=None, interValues: Array[InterValType]=None, job: MapReduce[TargetType, OutKeyType, InterValType, OutValType]=None) -> Union[Union[OutValType,Array[OutValType]]]:
    """
    ...
    """
        ...
    @classmethod
    def mapCompleted(cls, job: MapReduce[TargetType, OutKeyType, InterValType, OutValType]=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def completed(cls, job: MapReduce[TargetType, OutKeyType, InterValType, OutValType]=None) -> Union[str]:
    """
    ...
    """
        ...
    @classmethod
    def failed(cls, job: MapReduce[TargetType, OutKeyType, InterValType, OutValType], status: MapReduceStatus, options: MapReduceOptions=None) -> None:
    """
    ...
    """
        ...
    def results(self, limit: int='10000') -> Union[Map[OutKeyType, Union[OutValType,Array[OutValType]]]]:
    """
