...
# Python definitions for the C3 type FileChecksum
...
class FileChecksum():
    ...
    """
    def __init__(self, CRC32: Optional[str]=None, CKSUM: Optional[str]=None, MD5: Optional[str]=None) -> None: ...
    ...
    """
        ...
    @classmethod
    def fileExtFor(cls, fileChecksum: str=None) -> str:
    """
