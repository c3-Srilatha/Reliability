...
from c3.platform.AzureSharedAccessAuthorizationRuleResource import AzureSharedAccessAuthorizationRuleResource
...
# Python definitions for the C3 type AzureSharedAccessAuthorizationRuleResource

T = TypeVar('T')
K = TypeVar('K')

class AzureSharedAccessAuthorizationRuleResource(Generic[T, K], AzureGenericChildResource[T]):
    """
    @remarks this represents a made instance of AzureSharedAccessAuthorizationRuleResource
    """
    ...
    @overload
    @classmethod
    def fromString(cls, s: str) -> Union[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    ...
    @overload
    @classmethod
    def fromString(cls, s: str, failIfInvalid: bool=None) -> Union[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    Constructs Cloud Resource instance with reference fields and credentials based on provided Cloud Reference string.
    ...
    @overload
    @classmethod
    def make(cls, s: str) -> Union[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Any], spec: Obj.MakeSpec) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    @overload
    @classmethod
    def make(cls, withDefaults: bool=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Map[str, Union[Any,Any]], withDefaults: bool=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    @overload
    @classmethod
    def make(cls, fields: Any, withDefaults: bool=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    @classmethod
    def fromJson(cls, json: any) -> Union[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    ...
    """
        ...
    @classmethod
    def fromJsonString(cls, json: str) -> Union[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    Load the JSON-based representation and reconstruct the corresponding object.
    ...
    """
        ...
    @classmethod
    def fromXmlString(cls, xml: str) -> Union[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    ...
    """
        ...
    @classmethod
    def deserialize(cls, contentStr: str, contentType: str) -> Union[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    ...
    """
        ...
    def replaceType(self, old: Type, new: Type) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValues(self, spec: ValueSpec, mapper: Callable[[FieldType, Any], Union[Any]], convertValue: bool=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, mapper: Callable[[FieldType, Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    Result of this function call is a copy of current instance with all non empty fields replaced based on results of
    ...
    """
        ...
    @overload
    def mapFieldValuesAsync(self, spec: ValueSpec, mapper: Callable[[Union[FieldType], Any], Union[Promise[Any]]], convertValue: bool=None) -> Promise[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    Result of this function call is a copy of current instance with all fields replaced based on results of the
    ...
    """
        ...
    def mapFieldValue(self, mapper: Callable[[Any], Union[Any]], field: FieldType=None, includeEmpty: bool=None, convertValue: bool=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    @overload
    def mapRefs(self, includeEmpty: bool, mapper: Callable[[FieldType, Obj], Union[Obj]], convertValue: bool=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    Executes the specified lambda against each referenced Obj instance and replaces it's value with result of this
    lambda application.
    ...
    """
        ...
    @overload
    def validateObj(self) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: str, value: Any, doNotConvert: bool=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    @overload
    def withField(self, field: FieldType, value: Any, doNotConvert: bool=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    Builds a new Obj instance by adding the provided field in it. The name must correspond to an existing field
    defined on this type or its mixins. The value must be of the correct type if doNotConvert flag is true.
    ...
    """
        ...
    def withFields(self, fields: Map[str, Any], doNotConvert: bool=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    def withFieldAtPath(self, path: str, value: Any, doNotConvert: bool=None, doNotCreateIfMissing: bool=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    def withoutFieldAtPath(self, path: str) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: str) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    @overload
    def withoutField(self, field: FieldType) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    def withoutFields(self, fields: Array[str]) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    def withoutFieldsByType(self, fields: Array[FieldType]) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    def withoutSecretFields(self) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    def withDefaults(self, includeEmptyRefsWithDefaults: bool=None, defaultFields: Array[str]=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: str) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    @overload
    def defaultField(self, field: FieldType) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: str) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    @overload
    def unsetField(self, field: FieldType) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    Unsets a field from this `Obj`, meaning that the field will become not {@link #isFieldSet set}. Note that this
    is different from {@link removeField}
    ...
    """
        ...
    @overload
    def removeField(self, field: str) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    @overload
    def removeField(self, field: FieldType) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    Removes a field from this `Obj`, meaning that the field will become {@link isFieldMissing missing}. Note that this
    is different from {@link #unsetField}
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, fieldPathMergeSpec: Map[str, str]=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, otherFieldsFilter: Type) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    Merges all the fields of the provided Obj into this instance, producing a new Obj of the same type as this one.
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldPath], Union[Any], Union[FieldPath], Union[Any]], Union[Any]], deep: bool=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    @overload
    def mergeObj(self, other: Obj, merger: Callable[[Union[FieldType], Union[Any], Union[FieldType], Union[Any]], Union[Any]]) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    Merge the fields of this Obj with corresponding fields on other Obj using the provided lambda. This means that
    ...
    """
        ...
    def mergeJson(self, json: any) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
        ...
    def mergeChildren(self, deep: bool=None, objKey: Callable[[Union[Obj]], Union[Any]]=None, filter: Callable[[str], bool]=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    def sumObj(self, other: Obj, deep: bool=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    def singletonArray(self) -> Array[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    ...
    """
        ...
    @classmethod
    def array(cls, *elements: Array[Any]) -> Union[Array[AzureSharedAccessAuthorizationRuleResource[T, K]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    @classmethod
    def arrayBuilder(cls) -> Union[ArrayBuilder[AzureSharedAccessAuthorizationRuleResource[T, K]]]:
    """
    Creates an array of instances of this type.
    """
        ...
    def singletonSet(self) -> Set[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    ...
    """
        ...
    @classmethod
    def setBuilder(cls) -> Union[SetBuilder[AzureSharedAccessAuthorizationRuleResource[T, K]]]:
    """
    Creates a set of instances of this type.
    """
        ...
    @classmethod
    def mapBuilder(cls) -> Union[MapBuilder[str, AzureSharedAccessAuthorizationRuleResource[T, K]]]:
    """
    Create a map of string to elements of this type.
    """
        ...
    @classmethod
    def mapBuilderOf(cls, keyType: ValueType) -> Union[MapBuilder[Any, AzureSharedAccessAuthorizationRuleResource[T, K]]]:
    """
    ...
    def myStreamType(cls) -> StreamType:
        ...
    def toBuilder(self) -> ObjBuilder[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    @return new ObjBuilder with initial state set to fields of this instance.
    """
        ...
    @classmethod
    def builder(cls) -> ObjBuilder[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Any], spec: Obj.MakeSpec) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    Construct instance of this type from provided field values and options
    """
        ...
    @overload
    @classmethod
    def fromFields(cls, fields: Map[FieldType, Union[Any,Any]], withDefaults: bool=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    @classmethod
    def remake(cls, other: Obj, failIfExtraOrInvalidFields: bool=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    def afterMake(self) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    @classmethod
    def cachedEmptyInst(cls) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    @classmethod
    def generateObjs(cls, spec: Obj.GenerateSpec=None) -> Union[Stream[AzureSharedAccessAuthorizationRuleResource[T, K]]]:
    """
    ...
    """
        ...
    @classmethod
    def generateObj(cls, spec: Obj.GenerateSpec=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    @classmethod
    def forId(cls, id: str, failIfMissing: bool=None) -> Union[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    Find Cloud Resource in Cloud Provider based on provided C3 canonical identifier.
    """
        ...
    @classmethod
    def fromClusterId(cls, clusterId: str, env: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    Construct a cloud ID from a cluster ID
    """
        ...
    @classmethod
    def fromEnvId(cls, envId: str, app: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    @classmethod
    def fromAppId(cls, appId: str, func: str, role: str=None, seq: str=None, subseq: str=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    def withDefaultId(self) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    Populate default values for all uninitialized Cloud Identifier fields in this Cloud Resource.
    """
        ...
    def sanitize(self) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    @classmethod
    def fromId(cls, id: str, failIfInvalid: bool=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    @classmethod
    def fromCloudId(cls, id: CloudId, failIfInvalid: bool=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    @classmethod
    def fromCloudRef(cls, ref: CloudRef, failIfInvalid: bool=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    Constructs Cloud Resource instance with reference fields and credentials based on provided Cloud Reference.
    """
        ...
    @classmethod
    def fromCloudFunc(cls, func: str, role: str=None, seq: str=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    Constructs Cloud Resource instance based on provided Cloud Func component and optional role.
    """
        ...
    @classmethod
    def fromResourceId(cls, resourceId: str) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    Constructs Cloud Resource instance based on provided Cloud Resource Id.
    """
        ...
    @classmethod
    def fromResourceSecondaryId(cls, resourceSecondaryId: str) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    Constructs Cloud Resource instance based on provided Cloud Resource Secondary Id and available Cloud Configuration.
    """
        ...
    @classmethod
    def fromResourceName(cls, name: str) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    Constructs Cloud Resource instance based on provided Cloud Resource Name and available Cloud Configuration.
    """
        ...
    @classmethod
    def fromReferenceField(cls, fieldName: str, value: str, failIfInvalid: bool=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    def fromConfigTemplate(self, spec: CloudResourceOperationSpec=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    def withDefaultConfig(self, spec: CloudResourceOperationSpec=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    def upsertResource(self, spec: CloudResourceOperationSpec=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    Create or update Cloud Resource.
    """
        ...
    def upsertWithDependencies(self, spec: CloudResourceOperationSpec=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    @classmethod
    def allCached(cls, doNotProduceAll: bool=None) -> Union[Stream[AzureSharedAccessAuthorizationRuleResource[T, K]]]:
    """
    ...
    """
        ...
    @classmethod
    def find(cls, filter: str=None, doNotProduceAll: bool=None) -> Union[Stream[AzureSharedAccessAuthorizationRuleResource[T, K]]]:
    """
    ...
    """
        ...
    @classmethod
    def findBy(cls, field: str, value: Any, doNotProduceAll: bool=None) -> Union[Stream[AzureSharedAccessAuthorizationRuleResource[T, K]]]:
    """
    @param doNotProduceAll if true, will not populate cache and only return available cached instances. Will call
           `produceAll` if cache is empty or if Ann.cache.all is true & data has not previously been fetched.
    @return existing instances of this type that satisfy filter from data cache.
    """
        ...
    @classmethod
    def findByCacheKey(cls, key: str) -> Union[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    ...
    """
        ...
    @classmethod
    def forCacheKey(cls, key: str) -> Union[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    Returns cached instance by key, with secrets removed.
    """
        ...
    def getCached(self) -> Union[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    This method on any CloudResource is not supported! Use CloudResource.for* or other methods instead.
    """
        ...
    def refreshCache(self) -> Union[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    ...
    """
        ...
    @classmethod
    def produce(cls, key: str) -> Union[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    Should produce an entry for the cache key. This method should not be called directly.
    """
        ...
    @classmethod
    def produceAll(cls) -> Union[Map[str, AzureSharedAccessAuthorizationRuleResource[T, K]]]:
    """
    ...
    """
        ...
    @classmethod
    def doProduceAll(cls) -> Union[Map[str, AzureSharedAccessAuthorizationRuleResource[T, K]]]:
    """
    ...
    """
        ...
    def getConfig(self) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    This method on any CloudResource is not supported! Use CloudResource.for* or other methods instead.
    """
        ...
    ...
    """
        ...
    def getSecret(self) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    @classmethod
    def forConfigKey(cls, configKey: str) -> Union[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    ...
    """
        ...
    @classmethod
    def listConfigs(cls, parallel: bool=None, filter: Callable[[str], bool]=None) -> Union[Stream[AzureSharedAccessAuthorizationRuleResource[T, K]]]:
    """
    @param
    ...
    """
        ...
    @overload
    def setConfigValues(self, from_: AzureSharedAccessAuthorizationRuleResource[T, K], override: str=None) -> None:
    """
    ...
    """
        ...
    @overload
    def setSecretValues(self, from_: AzureSharedAccessAuthorizationRuleResource[T, K], override: str=None) -> None:
    """
    ...
    """
        ...
    @classmethod
    def loadConfigAndSecret(cls, configKey: str) -> Union[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    ...
    """
        ...
    def removeSecrets(self) -> Union[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    @return this config without any secret values.
    """
        ...
    def removeNonSecrets(self) -> Union[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    @return this config with only secret values.
    """
        ...
    def validate(self) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    def withIdentity(self, resource: CloudResource=None, spec: CloudResourceOperationSpec=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    def mergeId(self, other: CloudResource=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    @classmethod
    def fromCloudRole(cls, role: str, seq: str=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    Constructs Cloud Resource instance of this type with reference fields and credentials based on provided cloud role.
    """
        ...
    @classmethod
    def fromCloudSeq(cls, seq: str) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    Constructs Cloud Resource instance of this type with reference fields and credentials based on provided cloud seq.
    """
        ...
    @classmethod
    def fromTags(cls, tags: Array[CloudTag]) -> Union[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    ...
    """
        ...
    @classmethod
    def forCloudId(cls, id: CloudId, failIfMissing: bool=None) -> Union[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    ...
    """
        ...
    @classmethod
    def forCloudFunc(cls, func: str, role: str=None, failIfMissing: bool=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    Find Cloud Resource based on provided cloud func component and optional role.
    """
        ...
    @classmethod
    def forCloudRole(cls, role: str, failIfMissing: bool=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    Find Cloud Resource of this type based on provided cloud role component.
    """
        ...
    @classmethod
    def forResourceId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def forResourceSecondaryId(cls, resourceId: str, failIfMissing: bool=None) -> Union[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    ...
    """
        ...
    @classmethod
    def forResourceName(cls, resourceName: str, failIfMissing: bool=None) -> Union[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    Find Cloud Resource in the Cloud Provider by provided resource name.
    """
        ...
    @classmethod
    def findResource(cls, reference: str, failIfMissing: bool=None) -> Union[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    Find Cloud Resource in the Cloud Provider by provided {@link CloudRef} string.
    """
        ...
    def getResource(self) -> Union[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    Find Cloud Resource in the Cloud Provider by provided #resourceId, #resourceSecondaryId, #resourceName or #tags
    (in that order).
    """
        ...
    def ensureResource(self) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    Checks that the resource is persisted. If not, upserts the resource, to ensure that the resource exists.
    """
        ...
    @classmethod
    def listResourcesBySubtype(cls, spec: CloudListResourcesSpec=None) -> Map[str, CloudListResourcesResult[AzureSharedAccessAuthorizationRuleResource[T, K]]]:
    """
    ...
    """
        ...
    @classmethod
    def listResources(cls, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    ...
    """
        ...
    @classmethod
    def listResourcesForTags(cls, *keyValuePairs: Array[str]) -> CloudListResourcesResult[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForClusterId(cls, clusterId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForEnvId(cls, envId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    @classmethod
    def listResourcesForAppId(cls, appId: str, cloudIdRole: str=None, spec: CloudListResourcesSpec=None) -> CloudListResourcesResult[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    List all Cloud Resources that satisfies the given spec.
    ...
    """
        ...
    def upsertDependencies(self, spec: CloudResourceOperationSpec=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    def waitForCreate(self, spec: WaitSpec=None) -> Union[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    ...
    """
        ...
    @classmethod
    def tagResourcesBatch(cls, resources: Array[AzureSharedAccessAuthorizationRuleResource[T, K]], tags: Array[CloudTag]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    @classmethod
    def untagResourcesBatch(cls, resources: Array[AzureSharedAccessAuthorizationRuleResource[T, K]], tagKeys: Array[str]) -> Union[Map[str, Error]]:
    """
    ...
    """
        ...
    def waitForOk(self, spec: WaitSpec=None) -> Union[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    ...
    """
        ...
    def waitForState(self, state: str='AVAILABLE', spec: WaitSpec=None) -> Union[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    ...
    """
        ...
    def setFullyConfigured(self, fullyConfigured: bool=None, override: str=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    def afterCreate(self, input: AzureSharedAccessAuthorizationRuleResource[T, K]=None) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    def beforeCreate(self) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    Optional callback to alter resource before creating it.
    """
        ...
    def beforeUpdate(self) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    Optional callback to alter resource before updating it.
    """
        ...
    def beforeDestroy(self) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    def withoutNonModifiableFields(self) -> AzureSharedAccessAuthorizationRuleResource[T, K]:
    """
    ...
    """
        ...
    @classmethod
    def fromImpl(cls, impl: Any=None) -> Union[AzureSharedAccessAuthorizationRuleResource[T, K]]:
    """
    ...
    """
        ...
    def keys(self) -> Union[K]:
    """
    Retrieves the key for this authorization rule.
    """
        ...
    def regenerateKey(self, keyType: str=None) -> Union[K]:
    """
